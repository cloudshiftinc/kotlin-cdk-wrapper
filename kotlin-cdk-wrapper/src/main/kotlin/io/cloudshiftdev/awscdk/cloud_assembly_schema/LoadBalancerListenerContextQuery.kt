...
public interface LoadBalancerListenerContextQuery : LoadBalancerFilter {
  ...
  private class BuilderImpl : Builder {
    private val cdkBuilder:
        software.amazon.awscdk.cloud_assembly_schema.LoadBalancerListenerContextQuery.Builder =
        software.amazon.awscdk.cloud_assembly_schema.LoadBalancerListenerContextQuery.builder()
    ...
    public fun build():
        software.amazon.awscdk.cloud_assembly_schema.LoadBalancerListenerContextQuery =
        cdkBuilder.build()
  }

  private class Wrapper(
    cdkObject: software.amazon.awscdk.cloud_assembly_schema.LoadBalancerListenerContextQuery,
  ) : CdkObject(cdkObject),
  ...
  public companion object {
    ...
    internal
        fun wrap(cdkObject: software.amazon.awscdk.cloud_assembly_schema.LoadBalancerListenerContextQuery):
    ...
    internal fun unwrap(wrapped: LoadBalancerListenerContextQuery):
        software.amazon.awscdk.cloud_assembly_schema.LoadBalancerListenerContextQuery = (wrapped as
