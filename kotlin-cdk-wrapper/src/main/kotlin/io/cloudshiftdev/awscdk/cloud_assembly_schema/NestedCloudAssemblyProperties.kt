...
public interface NestedCloudAssemblyProperties {
  ...
  private class BuilderImpl : Builder {
    private val cdkBuilder:
        software.amazon.awscdk.cloud_assembly_schema.NestedCloudAssemblyProperties.Builder =
        software.amazon.awscdk.cloud_assembly_schema.NestedCloudAssemblyProperties.builder()
    ...
    public fun build(): software.amazon.awscdk.cloud_assembly_schema.NestedCloudAssemblyProperties =
        cdkBuilder.build()
  }

  private class Wrapper(
    cdkObject: software.amazon.awscdk.cloud_assembly_schema.NestedCloudAssemblyProperties,
  ) : CdkObject(cdkObject),
  ...
  public companion object {
    ...
    internal
        fun wrap(cdkObject: software.amazon.awscdk.cloud_assembly_schema.NestedCloudAssemblyProperties):
    ...
    internal fun unwrap(wrapped: NestedCloudAssemblyProperties):
        software.amazon.awscdk.cloud_assembly_schema.NestedCloudAssemblyProperties = (wrapped as
        CdkObject).cdkObject as
        software.amazon.awscdk.cloud_assembly_schema.NestedCloudAssemblyProperties
  }
}
