...
public interface DestroyOptions : DefaultCdkOptions {
  ...
  private class BuilderImpl : Builder {
    private val cdkBuilder: software.amazon.awscdk.cloud_assembly_schema.DestroyOptions.Builder =
    ...
    public fun build(): software.amazon.awscdk.cloud_assembly_schema.DestroyOptions =
        cdkBuilder.build()
  }

  private class Wrapper(
    cdkObject: software.amazon.awscdk.cloud_assembly_schema.DestroyOptions,
  ) : CdkObject(cdkObject),
      DestroyOptions {
    /**
     * Deploy all stacks.
  ...
  public companion object {
    ...
    internal fun wrap(cdkObject: software.amazon.awscdk.cloud_assembly_schema.DestroyOptions):
    ...
    internal fun unwrap(wrapped: DestroyOptions):
        software.amazon.awscdk.cloud_assembly_schema.DestroyOptions = (wrapped as
        CdkObject).cdkObject as software.amazon.awscdk.cloud_assembly_schema.DestroyOptions
  }
}
