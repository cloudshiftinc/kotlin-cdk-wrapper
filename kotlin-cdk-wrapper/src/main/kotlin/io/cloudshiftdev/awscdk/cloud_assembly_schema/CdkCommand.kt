...
public interface CdkCommand {
  ...
  private class BuilderImpl : Builder {
    private val cdkBuilder: software.amazon.awscdk.cloud_assembly_schema.CdkCommand.Builder =
    ...
    public fun build(): software.amazon.awscdk.cloud_assembly_schema.CdkCommand = cdkBuilder.build()
  }

  private class Wrapper(
    cdkObject: software.amazon.awscdk.cloud_assembly_schema.CdkCommand,
  ) : CdkObject(cdkObject),
      CdkCommand {
    /**
  ...
  public companion object {
    ...
    internal fun wrap(cdkObject: software.amazon.awscdk.cloud_assembly_schema.CdkCommand):
        CdkCommand = CdkObjectWrappers.wrap(cdkObject) as? CdkCommand ?: Wrapper(cdkObject)

    internal fun unwrap(wrapped: CdkCommand):
        software.amazon.awscdk.cloud_assembly_schema.CdkCommand = (wrapped as CdkObject).cdkObject
        as software.amazon.awscdk.cloud_assembly_schema.CdkCommand
  }
}
