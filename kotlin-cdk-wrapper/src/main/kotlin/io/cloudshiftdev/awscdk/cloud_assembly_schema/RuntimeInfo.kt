...
public interface RuntimeInfo {
  ...
  private class BuilderImpl : Builder {
    private val cdkBuilder: software.amazon.awscdk.cloud_assembly_schema.RuntimeInfo.Builder =
        software.amazon.awscdk.cloud_assembly_schema.RuntimeInfo.builder()
    ...
    public fun build(): software.amazon.awscdk.cloud_assembly_schema.RuntimeInfo =
        cdkBuilder.build()
  }

  private class Wrapper(
    cdkObject: software.amazon.awscdk.cloud_assembly_schema.RuntimeInfo,
  ) : CdkObject(cdkObject),
      RuntimeInfo {
    /**
     * The list of libraries loaded in the application, associated with their versions.
  ...
  public companion object {
    ...
    internal fun wrap(cdkObject: software.amazon.awscdk.cloud_assembly_schema.RuntimeInfo):
        RuntimeInfo = CdkObjectWrappers.wrap(cdkObject) as? RuntimeInfo ?: Wrapper(cdkObject)

    internal fun unwrap(wrapped: RuntimeInfo):
        software.amazon.awscdk.cloud_assembly_schema.RuntimeInfo = (wrapped as CdkObject).cdkObject
        as software.amazon.awscdk.cloud_assembly_schema.RuntimeInfo
  }
}
