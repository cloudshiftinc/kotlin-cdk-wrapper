...
public interface LoadBalancerContextQuery : LoadBalancerFilter {
  ...
  private class BuilderImpl : Builder {
    private val cdkBuilder:
        software.amazon.awscdk.cloud_assembly_schema.LoadBalancerContextQuery.Builder =
        software.amazon.awscdk.cloud_assembly_schema.LoadBalancerContextQuery.builder()
    ...
    public fun build(): software.amazon.awscdk.cloud_assembly_schema.LoadBalancerContextQuery =
        cdkBuilder.build()
  }

  private class Wrapper(
    cdkObject: software.amazon.awscdk.cloud_assembly_schema.LoadBalancerContextQuery,
  ) : CdkObject(cdkObject),
  ...
  public companion object {
    ...
    internal
        fun wrap(cdkObject: software.amazon.awscdk.cloud_assembly_schema.LoadBalancerContextQuery):
    ...
    internal fun unwrap(wrapped: LoadBalancerContextQuery):
        software.amazon.awscdk.cloud_assembly_schema.LoadBalancerContextQuery = (wrapped as
        CdkObject).cdkObject as
        software.amazon.awscdk.cloud_assembly_schema.LoadBalancerContextQuery
  }
}
