...
public interface ContainerImageAssetMetadataEntry {
  ...
  public interface Builder {
    ...
    @JvmName("1f0356b6d36a0114955e359f408de9ccef111d352b712da3df2a9a71a7fdacf9")
  ...
  private class BuilderImpl : Builder {
    ...
    public fun build():
        software.amazon.awscdk.cloud_assembly_schema.ContainerImageAssetMetadataEntry =
        cdkBuilder.build()
  }

  private class Wrapper(
    cdkObject: software.amazon.awscdk.cloud_assembly_schema.ContainerImageAssetMetadataEntry,
  ) : CdkObject(cdkObject),
  ...
  public companion object {
    ...
    internal
        fun wrap(cdkObject: software.amazon.awscdk.cloud_assembly_schema.ContainerImageAssetMetadataEntry):
    ...
    internal fun unwrap(wrapped: ContainerImageAssetMetadataEntry):
        software.amazon.awscdk.cloud_assembly_schema.ContainerImageAssetMetadataEntry = (wrapped as
