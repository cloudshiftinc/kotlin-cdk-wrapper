...
public interface AssetManifestProperties : AssetManifestOptions {
  ...
  private class BuilderImpl : Builder {
    private val cdkBuilder:
        software.amazon.awscdk.cloud_assembly_schema.AssetManifestProperties.Builder =
        software.amazon.awscdk.cloud_assembly_schema.AssetManifestProperties.builder()
    ...
    public fun build(): software.amazon.awscdk.cloud_assembly_schema.AssetManifestProperties =
        cdkBuilder.build()
  }

  private class Wrapper(
    cdkObject: software.amazon.awscdk.cloud_assembly_schema.AssetManifestProperties,
  ) : CdkObject(cdkObject),
  ...
  public companion object {
    ...
    internal
        fun wrap(cdkObject: software.amazon.awscdk.cloud_assembly_schema.AssetManifestProperties):
    ...
    internal fun unwrap(wrapped: AssetManifestProperties):
        software.amazon.awscdk.cloud_assembly_schema.AssetManifestProperties = (wrapped as
        CdkObject).cdkObject as software.amazon.awscdk.cloud_assembly_schema.AssetManifestProperties
  }
}
