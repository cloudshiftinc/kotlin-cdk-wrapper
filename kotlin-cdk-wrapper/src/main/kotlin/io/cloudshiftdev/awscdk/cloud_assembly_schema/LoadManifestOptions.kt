...
public interface LoadManifestOptions {
  ...
  private class BuilderImpl : Builder {
    private val cdkBuilder: software.amazon.awscdk.cloud_assembly_schema.LoadManifestOptions.Builder
    ...
    public fun build(): software.amazon.awscdk.cloud_assembly_schema.LoadManifestOptions =
        cdkBuilder.build()
  }

  private class Wrapper(
    cdkObject: software.amazon.awscdk.cloud_assembly_schema.LoadManifestOptions,
  ) : CdkObject(cdkObject),
      LoadManifestOptions {
    /**
     * Skip enum checks.
  ...
  public companion object {
    ...
    internal fun wrap(cdkObject: software.amazon.awscdk.cloud_assembly_schema.LoadManifestOptions):
    ...
    internal fun unwrap(wrapped: LoadManifestOptions):
        software.amazon.awscdk.cloud_assembly_schema.LoadManifestOptions = (wrapped as
        CdkObject).cdkObject as software.amazon.awscdk.cloud_assembly_schema.LoadManifestOptions
  }
}
