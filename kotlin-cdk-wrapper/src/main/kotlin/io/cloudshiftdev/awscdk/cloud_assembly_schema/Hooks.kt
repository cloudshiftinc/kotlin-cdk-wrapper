...
public interface Hooks {
  ...
  private class BuilderImpl : Builder {
    private val cdkBuilder: software.amazon.awscdk.cloud_assembly_schema.Hooks.Builder =
    ...
    public fun build(): software.amazon.awscdk.cloud_assembly_schema.Hooks = cdkBuilder.build()
  }

  private class Wrapper(
    cdkObject: software.amazon.awscdk.cloud_assembly_schema.Hooks,
  ) : CdkObject(cdkObject),
      Hooks {
    /**
     * Commands to run prior after deploying the cdk stacks in the integration test.
  ...
  public companion object {
    ...
    internal fun wrap(cdkObject: software.amazon.awscdk.cloud_assembly_schema.Hooks): Hooks =
        CdkObjectWrappers.wrap(cdkObject) as? Hooks ?: Wrapper(cdkObject)

    internal fun unwrap(wrapped: Hooks): software.amazon.awscdk.cloud_assembly_schema.Hooks =
        (wrapped as CdkObject).cdkObject as software.amazon.awscdk.cloud_assembly_schema.Hooks
  }
}
