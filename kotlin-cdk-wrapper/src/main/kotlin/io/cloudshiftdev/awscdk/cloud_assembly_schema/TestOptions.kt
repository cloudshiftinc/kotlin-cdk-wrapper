...
public interface TestOptions {
  ...
  public interface Builder {
    ...
    @JvmName("9086cd76246946debdec833c9dc73289eff21d21babfa5cde6c766fb310dfe6c")
     ...
     */
    @kotlin.Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("a84ba96c46a45d3b641e36b210d49ece01c6073e935b063ee6a435f37087992c")
  ...
  private class BuilderImpl : Builder {
    private val cdkBuilder: software.amazon.awscdk.cloud_assembly_schema.TestOptions.Builder =
        software.amazon.awscdk.cloud_assembly_schema.TestOptions.builder()
    ...
    public fun build(): software.amazon.awscdk.cloud_assembly_schema.TestOptions =
        cdkBuilder.build()
  }

  private class Wrapper(
    cdkObject: software.amazon.awscdk.cloud_assembly_schema.TestOptions,
  ) : CdkObject(cdkObject),
      TestOptions {
    /**
  ...
  public companion object {
    ...
    internal fun wrap(cdkObject: software.amazon.awscdk.cloud_assembly_schema.TestOptions):
        TestOptions = CdkObjectWrappers.wrap(cdkObject) as? TestOptions ?: Wrapper(cdkObject)

    internal fun unwrap(wrapped: TestOptions):
        software.amazon.awscdk.cloud_assembly_schema.TestOptions = (wrapped as CdkObject).cdkObject
        as software.amazon.awscdk.cloud_assembly_schema.TestOptions
  }
}
