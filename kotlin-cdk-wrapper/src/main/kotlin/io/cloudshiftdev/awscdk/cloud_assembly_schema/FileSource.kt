...
public interface FileSource {
  ...
  private class BuilderImpl : Builder {
    private val cdkBuilder: software.amazon.awscdk.cloud_assembly_schema.FileSource.Builder =
    ...
    public fun build(): software.amazon.awscdk.cloud_assembly_schema.FileSource = cdkBuilder.build()
  }

  private class Wrapper(
    cdkObject: software.amazon.awscdk.cloud_assembly_schema.FileSource,
  ) : CdkObject(cdkObject),
      FileSource {
    /**
     * External command which will produce the file asset to upload.
  ...
  public companion object {
    ...
    internal fun wrap(cdkObject: software.amazon.awscdk.cloud_assembly_schema.FileSource):
        FileSource = CdkObjectWrappers.wrap(cdkObject) as? FileSource ?: Wrapper(cdkObject)

    internal fun unwrap(wrapped: FileSource):
        software.amazon.awscdk.cloud_assembly_schema.FileSource = (wrapped as CdkObject).cdkObject
        as software.amazon.awscdk.cloud_assembly_schema.FileSource
  }
}
