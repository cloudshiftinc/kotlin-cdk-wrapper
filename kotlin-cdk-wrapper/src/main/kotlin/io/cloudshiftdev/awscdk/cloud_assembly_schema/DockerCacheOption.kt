...
public interface DockerCacheOption {
  ...
  private class BuilderImpl : Builder {
    private val cdkBuilder: software.amazon.awscdk.cloud_assembly_schema.DockerCacheOption.Builder =
    ...
    public fun build(): software.amazon.awscdk.cloud_assembly_schema.DockerCacheOption =
        cdkBuilder.build()
  }

  private class Wrapper(
    cdkObject: software.amazon.awscdk.cloud_assembly_schema.DockerCacheOption,
  ) : CdkObject(cdkObject),
      DockerCacheOption {
    /**
     * Any parameters to pass into the docker cache backend configuration.
  ...
  public companion object {
    ...
    internal fun wrap(cdkObject: software.amazon.awscdk.cloud_assembly_schema.DockerCacheOption):
        DockerCacheOption = CdkObjectWrappers.wrap(cdkObject) as? DockerCacheOption ?:
        Wrapper(cdkObject)

    internal fun unwrap(wrapped: DockerCacheOption):
        software.amazon.awscdk.cloud_assembly_schema.DockerCacheOption = (wrapped as
        CdkObject).cdkObject as software.amazon.awscdk.cloud_assembly_schema.DockerCacheOption
  }
}
