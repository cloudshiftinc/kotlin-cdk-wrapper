...
public open class CfnDatabase(
  ...
  public constructor(
    ...
    props: CfnDatabaseProps,
      ...
      this(software.amazon.awscdk.services.lightsail.CfnDatabase(scope.let(CloudshiftdevConstructsConstruct.Companion::unwrap),
  ...
  public open fun backupRetention(`value`: IResolvable) {
    unwrap(this).setBackupRetention(`value`.let(IResolvable.Companion::unwrap))
  }
  ...
  public open fun relationalDatabaseParameters(`value`: IResolvable) {
    unwrap(this).setRelationalDatabaseParameters(`value`.let(IResolvable.Companion::unwrap))
  }
  ...
  public companion object {
    public val CFN_RESOURCE_TYPE_NAME: String =
        software.amazon.awscdk.services.lightsail.CfnDatabase.CFN_RESOURCE_TYPE_NAME
  ...
  public interface RelationalDatabaseParameterProperty {
    ...
    private class BuilderImpl : Builder {
      ...
      override fun isModifiable(isModifiable: IResolvable) {
        cdkBuilder.isModifiable(isModifiable.let(IResolvable.Companion::unwrap))
      }
