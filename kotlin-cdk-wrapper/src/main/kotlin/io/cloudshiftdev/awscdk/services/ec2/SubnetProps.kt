...
public interface SubnetProps {
   ...
   * Default: false
   */
  public fun assignIpv6AddressOnCreation(): Boolean? = unwrap(this).getAssignIpv6AddressOnCreation()
  ...
  private class BuilderImpl : Builder {
    private val cdkBuilder: software.amazon.awscdk.services.ec2.SubnetProps.Builder =
    ...
    public fun build(): software.amazon.awscdk.services.ec2.SubnetProps = cdkBuilder.build()
  }

  private class Wrapper(
    override val cdkObject: software.amazon.awscdk.services.ec2.SubnetProps,
  ) : CdkObject(cdkObject), SubnetProps {
    /**
     * Indicates whether a network interface created in this subnet receives an IPv6 address.
     *
     * If you specify AssignIpv6AddressOnCreation, you must also specify Ipv6CidrBlock.
  ...
  public companion object {
    public operator fun invoke(block: Builder.() -> Unit = {}): SubnetProps {
      val builderImpl = BuilderImpl()
      return Wrapper(builderImpl.apply(block).build())
    }

    internal fun wrap(cdkObject: software.amazon.awscdk.services.ec2.SubnetProps): SubnetProps =
        CdkObjectWrappers.wrap(cdkObject) as? SubnetProps ?: Wrapper(cdkObject)

    internal fun unwrap(wrapped: SubnetProps): software.amazon.awscdk.services.ec2.SubnetProps =
        (wrapped as CdkObject).cdkObject as software.amazon.awscdk.services.ec2.SubnetProps
  }
}
