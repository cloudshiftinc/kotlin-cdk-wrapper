...
public enum class ParamsAndSecretsLogLevel(
  ...
  public companion object {
    internal fun wrap(cdkObject: software.amazon.awscdk.services.lambda.ParamsAndSecretsLogLevel):
        ParamsAndSecretsLogLevel = when (cdkObject) {
    ...
    internal fun unwrap(wrapped: ParamsAndSecretsLogLevel):
