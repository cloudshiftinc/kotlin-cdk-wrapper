 ...
 * TaskRole taskRole;
 * Timeout timeout;
 * EmrModifyInstanceFleetByNameJsonPathProps emrModifyInstanceFleetByNameJsonPathProps =
 ...
 * ```
 */
public interface EmrModifyInstanceFleetByNameJsonPathProps : TaskStateJsonPathBaseProps {
  /**
  ...
  /**
   * A builder for [EmrModifyInstanceFleetByNameJsonPathProps]
   */
  @CdkDslMarker
  public interface Builder {
    ...
    @JvmName("69b7e5d08d15dc6d30fb21577493d6f9a62f05d0f7dd27e423ca825a95bfc8da")
  ...
  private class BuilderImpl : Builder {
    ...
    public fun build():
        software.amazon.awscdk.services.stepfunctions.tasks.EmrModifyInstanceFleetByNameJsonPathProps
        = cdkBuilder.build()
  }

  private class Wrapper(
    cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.EmrModifyInstanceFleetByNameJsonPathProps,
  ) : CdkObject(cdkObject),
  ...
  public companion object {
    ...
    internal
        fun wrap(cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.EmrModifyInstanceFleetByNameJsonPathProps):
        EmrModifyInstanceFleetByNameJsonPathProps = CdkObjectWrappers.wrap(cdkObject) as?
        EmrModifyInstanceFleetByNameJsonPathProps ?: Wrapper(cdkObject)

    internal fun unwrap(wrapped: EmrModifyInstanceFleetByNameJsonPathProps):
        software.amazon.awscdk.services.stepfunctions.tasks.EmrModifyInstanceFleetByNameJsonPathProps
