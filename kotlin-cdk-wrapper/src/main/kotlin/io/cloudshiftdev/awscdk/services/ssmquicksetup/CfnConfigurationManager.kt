...
public open class CfnConfigurationManager(
  ...
  public interface ConfigurationDefinitionProperty {
     ...
     *
     *
     * Although this element is listed as "Required: No", a value can be omitted only for
     * organizational deployments of types other than `AWSQuickSetupType-PatchPolicy` . A value must be
     * provided when you are running an organizational deployment for a patch policy or running any
     * type of deployment for a single account.
     *
     *
     ...
     * lists outline the parameters for each configuration type.
     *
     ...
     * deploy the configuration to.
     * * `TargetRegions`
     * * Description: (Required) The AWS Regions to deploy the configuration to. For this type, the
     * parameter only accepts a value of `AllRegions` .
     ...
     * * `CollectInventory`
     * * Description: (Optional) A boolean value that determines whether instance metadata is
     * collected on the target instances every 30 minutes. The default value is " `true` ".
     * * `ScanInstances`
     ...
     * * Description: (Optional) A value that determines whether the selected patch baselines are
     * all AWS provided. Supported values are `default` and `custom` .
     * * `PatchBaselineRegion`
     ...
     * sent to Amazon S3.
     * * `OutputS3Location`
     * * Description: (Optional) Information about the Amazon S3 bucket where you want to store the
     * output details of the request.
     * * `OutputBucketRegion`
     * * Description: (Optional) The AWS Region where the Amazon S3 bucket you want to deliver
     * command output to is located.
     * * `OutputS3BucketName`
     * * Description: (Optional) The name of the Amazon S3 bucket you want to deliver command output
     * to.
     * * `OutputS3KeyPrefix`
     * * Description: (Optional) The key prefix you want to use in the custom Amazon S3 bucket.
     * * `TargetType`
    ...
    public interface Builder {
       ...
       *
       * Although this element is listed as "Required: No", a value can be omitted only for
       * organizational deployments of types other than `AWSQuickSetupType-PatchPolicy` . A value must
       * be provided when you are running an organizational deployment for a patch policy or running
       * any type of deployment for a single account.
       */
       ...
       * deploy the configuration to.
       * * `TargetRegions`
       * * Description: (Required) The AWS Regions to deploy the configuration to. For this type,
       * the parameter only accepts a value of `AllRegions` .
       * * **DevOps Guru (Type: AWS QuickSetupType-DevOpsGuru)** - - `AnalyseAllResources`
       * * Description: (Optional) A boolean value that determines whether DevOps Guru analyzes all
       * AWS CloudFormation stacks in the account. The default value is " `false` ".
       * * `EnableSnsNotifications`
       ...
       * sent to Amazon S3.
       * * `OutputS3Location`
       * * Description: (Optional) Information about the Amazon S3 bucket where you want to store
       * the output details of the request.
       * * `OutputBucketRegion`
       * * Description: (Optional) The AWS Region where the Amazon S3 bucket you want to deliver
       * command output to is located.
       * * `OutputS3BucketName`
       * * Description: (Optional) The name of the Amazon S3 bucket you want to deliver command
       * output to.
       * * `OutputS3KeyPrefix`
       * * Description: (Optional) The key prefix you want to use in the custom Amazon S3 bucket.
       * * `TargetType`
