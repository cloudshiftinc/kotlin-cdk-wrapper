 ...
 * CallApiGatewayEndpointJsonataBaseProps.builder()
 ...
 * ```
 */
public interface CallApiGatewayEndpointJsonataBaseProps : TaskStateJsonataBaseProps,
    CallApiGatewayEndpointBaseOptions {
  /**
   * A builder for [CallApiGatewayEndpointJsonataBaseProps]
   */
  @CdkDslMarker
  public interface Builder {
    ...
    @JvmName("02984a2a15ceb0a830dc25e1e75664d209b219c31822977e54cd8a30161d7e82")
  ...
  private class BuilderImpl : Builder {
    private val cdkBuilder:
        software.amazon.awscdk.services.stepfunctions.tasks.CallApiGatewayEndpointJsonataBaseProps.Builder
        =
        software.amazon.awscdk.services.stepfunctions.tasks.CallApiGatewayEndpointJsonataBaseProps.builder()
  ...
  private class Wrapper(
    cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.CallApiGatewayEndpointJsonataBaseProps,
  ) : CdkObject(cdkObject),
  ...
  public companion object {
    ...
    internal
        fun wrap(cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.CallApiGatewayEndpointJsonataBaseProps):
        CallApiGatewayEndpointJsonataBaseProps = CdkObjectWrappers.wrap(cdkObject) as?
        CallApiGatewayEndpointJsonataBaseProps ?: Wrapper(cdkObject)

    internal fun unwrap(wrapped: CallApiGatewayEndpointJsonataBaseProps):
        software.amazon.awscdk.services.stepfunctions.tasks.CallApiGatewayEndpointJsonataBaseProps =
