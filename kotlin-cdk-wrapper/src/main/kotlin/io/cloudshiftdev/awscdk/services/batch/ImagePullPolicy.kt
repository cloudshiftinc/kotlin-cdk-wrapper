...
public enum class ImagePullPolicy(
  ...
  public companion object {
    internal fun wrap(cdkObject: software.amazon.awscdk.services.batch.ImagePullPolicy):
        ImagePullPolicy = when (cdkObject) {
      software.amazon.awscdk.services.batch.ImagePullPolicy.ALWAYS -> ImagePullPolicy.ALWAYS
    ...
    internal fun unwrap(wrapped: ImagePullPolicy):
