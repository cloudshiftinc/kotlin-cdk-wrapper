 ...
 *
 * This can include inference code, artifacts, and metadata. The model package type can be one of
 * the following.
 *
...
public open class CfnModelPackage(
  ...
  public interface ModelPackageContainerDefinitionProperty {
    ...
    public interface Builder {
      ...
      /**
       * @param image The Amazon Elastic Container Registry (Amazon ECR) path where inference code
       * is stored. 
