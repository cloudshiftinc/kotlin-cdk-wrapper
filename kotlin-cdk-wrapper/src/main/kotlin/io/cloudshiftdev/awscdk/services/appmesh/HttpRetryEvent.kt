...
public enum class HttpRetryEvent(
  ...
  public companion object {
    internal fun wrap(cdkObject: software.amazon.awscdk.services.appmesh.HttpRetryEvent):
        HttpRetryEvent = when (cdkObject) {
    ...
    internal fun unwrap(wrapped: HttpRetryEvent):
