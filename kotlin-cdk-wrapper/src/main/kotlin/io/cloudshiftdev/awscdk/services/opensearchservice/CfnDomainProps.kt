...
public interface CfnDomainProps {
  ...
  private class BuilderImpl : Builder {
    ...
    override fun clusterConfig(clusterConfig: CfnDomain.ClusterConfigProperty) {
      cdkBuilder.clusterConfig(clusterConfig.let(CfnDomain.ClusterConfigProperty.Companion::unwrap))
    }
    ...
    override
      ...
      cdkBuilder.offPeakWindowOptions(offPeakWindowOptions.let(CfnDomain.OffPeakWindowOptionsProperty.Companion::unwrap))
    }
    ...
    override
      ...
      cdkBuilder.softwareUpdateOptions(softwareUpdateOptions.let(CfnDomain.SoftwareUpdateOptionsProperty.Companion::unwrap))
    }
