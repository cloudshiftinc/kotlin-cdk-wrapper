...
public enum class HttpVersion(
  ...
  public companion object {
    internal fun wrap(cdkObject: software.amazon.awscdk.services.cloudfront.HttpVersion):
        HttpVersion = when (cdkObject) {
      software.amazon.awscdk.services.cloudfront.HttpVersion.HTTP1_1 -> HttpVersion.HTTP1_1
      software.amazon.awscdk.services.cloudfront.HttpVersion.HTTP2 -> HttpVersion.HTTP2
      software.amazon.awscdk.services.cloudfront.HttpVersion.HTTP2_AND_3 -> HttpVersion.HTTP2_AND_3
      software.amazon.awscdk.services.cloudfront.HttpVersion.HTTP3 -> HttpVersion.HTTP3
    }

    internal fun unwrap(wrapped: HttpVersion):
