 ...
 * ```
 */
public interface CloudFormationDeleteStackActionProps : CommonAwsActionProps {
  /**
  ...
  /**
   * A builder for [CloudFormationDeleteStackActionProps]
   */
  @CdkDslMarker
  ...
  private class BuilderImpl : Builder {
    private val cdkBuilder:
        software.amazon.awscdk.services.codepipeline.actions.CloudFormationDeleteStackActionProps.Builder
        =
        software.amazon.awscdk.services.codepipeline.actions.CloudFormationDeleteStackActionProps.builder()
