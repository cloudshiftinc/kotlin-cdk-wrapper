 ...
 * EmrModifyInstanceGroupByNameJsonataProps.builder()
 * .clusterId("clusterId")
 ...
 * ```
 */
public interface EmrModifyInstanceGroupByNameJsonataProps : TaskStateJsonataBaseProps {
  /**
  ...
  /**
   * A builder for [EmrModifyInstanceGroupByNameJsonataProps]
   */
  @CdkDslMarker
  public interface Builder {
    ...
    @JvmName("a0cc8af5592cd79bd8edd9ea2b6a2e66546715822d0f3288b6049767ec4edfba")
     ...
     */
    @kotlin.Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("b2758dbd1c548fe7a87d6c33bb28947420257d0de985f68cd9058246e37f972b")
    public
  ...
  private class BuilderImpl : Builder {
    private val cdkBuilder:
        software.amazon.awscdk.services.stepfunctions.tasks.EmrModifyInstanceGroupByNameJsonataProps.Builder
        =
        software.amazon.awscdk.services.stepfunctions.tasks.EmrModifyInstanceGroupByNameJsonataProps.builder()
    ...
    public fun build():
        software.amazon.awscdk.services.stepfunctions.tasks.EmrModifyInstanceGroupByNameJsonataProps
        = cdkBuilder.build()
  }

  private class Wrapper(
    cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.EmrModifyInstanceGroupByNameJsonataProps,
  ) : CdkObject(cdkObject),
  ...
  public companion object {
    ...
    internal
        fun wrap(cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.EmrModifyInstanceGroupByNameJsonataProps):
        EmrModifyInstanceGroupByNameJsonataProps = CdkObjectWrappers.wrap(cdkObject) as?
        EmrModifyInstanceGroupByNameJsonataProps ?: Wrapper(cdkObject)

    internal fun unwrap(wrapped: EmrModifyInstanceGroupByNameJsonataProps):
        software.amazon.awscdk.services.stepfunctions.tasks.EmrModifyInstanceGroupByNameJsonataProps
