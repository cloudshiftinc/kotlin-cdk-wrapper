...
public open class CfnScheduledQuery(
  ...
  public companion object {
    ...
    internal fun unwrap(wrapped: CfnScheduledQuery):
        software.amazon.awscdk.services.timestream.CfnScheduledQuery = wrapped.cdkObject as
  ...
  public interface TimestreamConfigurationProperty {
    ...
    /**
     * This is to allow mapping column(s) from the query result to the dimension in the destination
     * table.
     *
    ...
    public interface Builder {
       ...
       * Also see `MultiMeasureMappings` and `MixedMeasureMappings` for how measure name properties
       * on those relate to `MeasureNameColumn` .
       */
