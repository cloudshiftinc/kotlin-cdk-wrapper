 ...
 * ```
 */
public interface AthenaStopQueryExecutionJsonataProps : TaskStateJsonataBaseProps {
  /**
  ...
  /**
   * A builder for [AthenaStopQueryExecutionJsonataProps]
   */
  @CdkDslMarker
  public interface Builder {
    ...
    @JvmName("8455883885b0c36877e91664407ff3c2b959afdb6849ebdfcb89adc129e8f429")
  ...
  private class Wrapper(
    cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.AthenaStopQueryExecutionJsonataProps,
  ) : CdkObject(cdkObject),
  ...
  public companion object {
    ...
    internal
        fun wrap(cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.AthenaStopQueryExecutionJsonataProps):
        AthenaStopQueryExecutionJsonataProps = CdkObjectWrappers.wrap(cdkObject) as?
        AthenaStopQueryExecutionJsonataProps ?: Wrapper(cdkObject)

    internal fun unwrap(wrapped: AthenaStopQueryExecutionJsonataProps):
        software.amazon.awscdk.services.stepfunctions.tasks.AthenaStopQueryExecutionJsonataProps =
