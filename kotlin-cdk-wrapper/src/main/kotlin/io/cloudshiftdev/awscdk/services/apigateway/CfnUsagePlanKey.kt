...
public open class CfnUsagePlanKey(
  ...
  public constructor(
    ...
    props: CfnUsagePlanKeyProps,
      ...
      this(software.amazon.awscdk.services.apigateway.CfnUsagePlanKey(scope.let(CloudshiftdevConstructsConstruct.Companion::unwrap),
      id, props.let(CfnUsagePlanKeyProps.Companion::unwrap))
  )
