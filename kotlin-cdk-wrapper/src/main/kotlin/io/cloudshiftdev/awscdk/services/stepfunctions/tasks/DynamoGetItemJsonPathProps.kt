 ...
 * TaskRole taskRole;
 * Timeout timeout;
 * DynamoGetItemJsonPathProps dynamoGetItemJsonPathProps = DynamoGetItemJsonPathProps.builder()
 * .key(Map.of(
 ...
 * ```
 */
public interface DynamoGetItemJsonPathProps : TaskStateJsonPathBaseProps {
  /**
  ...
  /**
   * A builder for [DynamoGetItemJsonPathProps]
   */
  @CdkDslMarker
  public interface Builder {
    ...
    @JvmName("1368325f9fd4c91b00ae6f18e8ce4e0f806a56ec84b85173085b760a51553eca")
  ...
  private class Wrapper(
    cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.DynamoGetItemJsonPathProps,
  ) : CdkObject(cdkObject),
  ...
  public companion object {
    public operator fun invoke(block: Builder.() -> Unit = {}): DynamoGetItemJsonPathProps {
      val builderImpl = BuilderImpl()
      return Wrapper(builderImpl.apply(block).build())
    }

    internal
        fun wrap(cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.DynamoGetItemJsonPathProps):
        DynamoGetItemJsonPathProps = CdkObjectWrappers.wrap(cdkObject) as?
        DynamoGetItemJsonPathProps ?: Wrapper(cdkObject)

    internal fun unwrap(wrapped: DynamoGetItemJsonPathProps):
        software.amazon.awscdk.services.stepfunctions.tasks.DynamoGetItemJsonPathProps = (wrapped as
