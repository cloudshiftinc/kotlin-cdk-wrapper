...
public open class CfnDelegatedAdmin(
  ...
  public constructor(
    ...
    props: CfnDelegatedAdminProps,
      ...
      this(software.amazon.awscdk.services.securityhub.CfnDelegatedAdmin(scope.let(CloudshiftdevConstructsConstruct::unwrap),
      id, props.let(CfnDelegatedAdminProps::unwrap))
  )
