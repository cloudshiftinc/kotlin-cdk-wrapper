 ...
 */
public open class LinuxLambdaBuildImage(
  cdkObject: software.amazon.awscdk.services.codebuild.LinuxLambdaBuildImage,
) : CdkObject(cdkObject),
    IBuildImage {
  /**
  ...
  public companion object {
    ...
    public val AMAZON_LINUX_2023_DOTNET_8: IBuildImage =
        IBuildImage.wrap(software.amazon.awscdk.services.codebuild.LinuxLambdaBuildImage.AMAZON_LINUX_2023_DOTNET_8)

    public val AMAZON_LINUX_2023_GO_1_24: IBuildImage =
        IBuildImage.wrap(software.amazon.awscdk.services.codebuild.LinuxLambdaBuildImage.AMAZON_LINUX_2023_GO_1_24)
    ...
    public val AMAZON_LINUX_2023_NODE_22: IBuildImage =
        IBuildImage.wrap(software.amazon.awscdk.services.codebuild.LinuxLambdaBuildImage.AMAZON_LINUX_2023_NODE_22)
    ...
    public val AMAZON_LINUX_2023_PYTHON_3_13: IBuildImage =
        IBuildImage.wrap(software.amazon.awscdk.services.codebuild.LinuxLambdaBuildImage.AMAZON_LINUX_2023_PYTHON_3_13)

    public val AMAZON_LINUX_2023_RUBY_3_4: IBuildImage =
        IBuildImage.wrap(software.amazon.awscdk.services.codebuild.LinuxLambdaBuildImage.AMAZON_LINUX_2023_RUBY_3_4)
    ...
    internal fun unwrap(wrapped: LinuxLambdaBuildImage):
        software.amazon.awscdk.services.codebuild.LinuxLambdaBuildImage = wrapped.cdkObject as
