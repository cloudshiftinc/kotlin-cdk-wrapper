...
public abstract class MachineImage(
  ...
  public companion object {
    ...
    public fun fromSsmParameter(parameterName: String, options: SsmParameterImageOptions):
        ...
        options.let(SsmParameterImageOptions.Companion::unwrap)).let(IMachineImage::wrap)
    ...
    public fun genericLinux(amiMap: Map<String, String>, props: GenericLinuxImageProps):
        ...
        props.let(GenericLinuxImageProps.Companion::unwrap)).let(IMachineImage::wrap)
    ...
    public fun genericWindows(amiMap: Map<String, String>, props: GenericWindowsImageProps):
        ...
        props.let(GenericWindowsImageProps.Companion::unwrap)).let(IMachineImage::wrap)
    ...
    public fun latestAmazonLinux(props: AmazonLinuxImageProps): IMachineImage =
        software.amazon.awscdk.services.ec2.MachineImage.latestAmazonLinux(props.let(AmazonLinuxImageProps.Companion::unwrap)).let(IMachineImage::wrap)
    ...
    public fun latestAmazonLinux2(props: AmazonLinux2ImageSsmParameterProps): IMachineImage =
        software.amazon.awscdk.services.ec2.MachineImage.latestAmazonLinux2(props.let(AmazonLinux2ImageSsmParameterProps.Companion::unwrap)).let(IMachineImage::wrap)
    ...
    public fun latestAmazonLinux2022(props: AmazonLinux2022ImageSsmParameterProps): IMachineImage =
        software.amazon.awscdk.services.ec2.MachineImage.latestAmazonLinux2022(props.let(AmazonLinux2022ImageSsmParameterProps.Companion::unwrap)).let(IMachineImage::wrap)
    ...
    public fun latestAmazonLinux2023(props: AmazonLinux2023ImageSsmParameterProps): IMachineImage =
        software.amazon.awscdk.services.ec2.MachineImage.latestAmazonLinux2023(props.let(AmazonLinux2023ImageSsmParameterProps.Companion::unwrap)).let(IMachineImage::wrap)
    ...
    public fun latestWindows(version: WindowsVersion): IMachineImage =
        software.amazon.awscdk.services.ec2.MachineImage.latestWindows(version.let(WindowsVersion.Companion::unwrap)).let(IMachineImage::wrap)

    public fun latestWindows(version: WindowsVersion, props: WindowsImageProps): IMachineImage =
        software.amazon.awscdk.services.ec2.MachineImage.latestWindows(version.let(WindowsVersion.Companion::unwrap),
        props.let(WindowsImageProps.Companion::unwrap)).let(IMachineImage::wrap)
    ...
    public fun lookup(props: LookupMachineImageProps): IMachineImage =
        software.amazon.awscdk.services.ec2.MachineImage.lookup(props.let(LookupMachineImageProps.Companion::unwrap)).let(IMachineImage::wrap)
    ...
    internal fun wrap(cdkObject: software.amazon.awscdk.services.ec2.MachineImage): MachineImage =
        CdkObjectWrappers.wrap(cdkObject) as? MachineImage ?: Wrapper(cdkObject)
