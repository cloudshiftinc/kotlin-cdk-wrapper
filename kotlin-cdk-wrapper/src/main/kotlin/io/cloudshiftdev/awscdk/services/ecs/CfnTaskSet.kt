...
public open class CfnTaskSet internal constructor(
  ...
  public interface ScaleProperty {
    ...
    public companion object {
      ...
      internal fun wrap(cdkObject: software.amazon.awscdk.services.ecs.CfnTaskSet.ScaleProperty):
          ScaleProperty = CdkObjectWrappers.wrap(cdkObject) as ScaleProperty
   ...
   * deployment with the updated Elastic Load Balancing configuration. This causes tasks to register to
   * and deregister from load balancers.
   *
