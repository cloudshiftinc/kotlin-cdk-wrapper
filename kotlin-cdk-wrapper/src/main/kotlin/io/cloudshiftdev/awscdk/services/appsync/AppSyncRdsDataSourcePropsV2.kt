 ...
 * ```
 */
public interface AppSyncRdsDataSourcePropsV2 : AppSyncBackedDataSourceProps {
  /**
  ...
  /**
   * A builder for [AppSyncRdsDataSourcePropsV2]
   */
  @CdkDslMarker
  ...
  private class BuilderImpl : Builder {
    ...
    public fun build(): software.amazon.awscdk.services.appsync.AppSyncRdsDataSourcePropsV2 =
        cdkBuilder.build()
  }

  private class Wrapper(
    cdkObject: software.amazon.awscdk.services.appsync.AppSyncRdsDataSourcePropsV2,
  ) : CdkObject(cdkObject),
  ...
  public companion object {
    public operator fun invoke(block: Builder.() -> Unit = {}): AppSyncRdsDataSourcePropsV2 {
      val builderImpl = BuilderImpl()
      return Wrapper(builderImpl.apply(block).build())
    }

    internal
        fun wrap(cdkObject: software.amazon.awscdk.services.appsync.AppSyncRdsDataSourcePropsV2):
        AppSyncRdsDataSourcePropsV2 = CdkObjectWrappers.wrap(cdkObject) as?
        AppSyncRdsDataSourcePropsV2 ?: Wrapper(cdkObject)

    internal fun unwrap(wrapped: AppSyncRdsDataSourcePropsV2):
        software.amazon.awscdk.services.appsync.AppSyncRdsDataSourcePropsV2 = (wrapped as
        CdkObject).cdkObject as software.amazon.awscdk.services.appsync.AppSyncRdsDataSourcePropsV2
  }
}
