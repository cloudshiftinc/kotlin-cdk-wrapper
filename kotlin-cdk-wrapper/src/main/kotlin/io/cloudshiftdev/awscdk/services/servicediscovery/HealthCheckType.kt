...
public enum class HealthCheckType(
  ...
  public companion object {
    internal fun wrap(cdkObject: software.amazon.awscdk.services.servicediscovery.HealthCheckType):
        HealthCheckType = when (cdkObject) {
      software.amazon.awscdk.services.servicediscovery.HealthCheckType.HTTP -> HealthCheckType.HTTP
      software.amazon.awscdk.services.servicediscovery.HealthCheckType.HTTPS ->
          HealthCheckType.HTTPS
      software.amazon.awscdk.services.servicediscovery.HealthCheckType.TCP -> HealthCheckType.TCP
    }
