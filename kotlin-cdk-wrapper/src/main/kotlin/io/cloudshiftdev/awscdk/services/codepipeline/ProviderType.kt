...
public enum class ProviderType(
  ...
  CODE_STAR_SOURCE_CONNECTION(software.amazon.awscdk.services.codepipeline.ProviderType.CODE_STAR_SOURCE_CONNECTION),
  ;

  public companion object {
    internal fun wrap(cdkObject: software.amazon.awscdk.services.codepipeline.ProviderType):
        ProviderType = when (cdkObject) {
    ...
    internal fun unwrap(wrapped: ProviderType):
