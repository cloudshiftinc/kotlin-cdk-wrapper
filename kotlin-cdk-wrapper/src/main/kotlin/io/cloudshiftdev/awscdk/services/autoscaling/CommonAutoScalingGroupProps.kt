...
public interface CommonAutoScalingGroupProps {
   ...
   * Default: None
   */
  public fun azCapacityDistributionStrategy(): CapacityDistributionStrategy? =
   ...
   */
  public fun healthChecks(): HealthChecks? = unwrap(this).getHealthChecks()?.let(HealthChecks::wrap)
