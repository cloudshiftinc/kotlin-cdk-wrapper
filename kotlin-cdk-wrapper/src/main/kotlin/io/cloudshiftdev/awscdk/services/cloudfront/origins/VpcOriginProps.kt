 ...
 * ```
 */
public interface VpcOriginProps : OriginProps {
  /**
  ...
  private class BuilderImpl : Builder {
    ...
    public fun build(): software.amazon.awscdk.services.cloudfront.origins.VpcOriginProps =
        cdkBuilder.build()
  }

  private class Wrapper(
    cdkObject: software.amazon.awscdk.services.cloudfront.origins.VpcOriginProps,
  ) : CdkObject(cdkObject),
      VpcOriginProps {
    /**
  ...
  public companion object {
    ...
    internal fun wrap(cdkObject: software.amazon.awscdk.services.cloudfront.origins.VpcOriginProps):
    ...
    internal fun unwrap(wrapped: VpcOriginProps):
        software.amazon.awscdk.services.cloudfront.origins.VpcOriginProps = (wrapped as
        CdkObject).cdkObject as software.amazon.awscdk.services.cloudfront.origins.VpcOriginProps
  }
}
