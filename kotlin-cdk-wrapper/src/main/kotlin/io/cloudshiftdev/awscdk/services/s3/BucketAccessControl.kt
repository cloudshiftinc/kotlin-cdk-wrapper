...
public enum class BucketAccessControl(
  ...
  BUCKET_OWNER_FULL_CONTROL(software.amazon.awscdk.services.s3.BucketAccessControl.BUCKET_OWNER_FULL_CONTROL),
  AWS_EXEC_READ(software.amazon.awscdk.services.s3.BucketAccessControl.AWS_EXEC_READ),
  ;

  public companion object {
    internal fun wrap(cdkObject: software.amazon.awscdk.services.s3.BucketAccessControl):
        BucketAccessControl = when (cdkObject) {
      software.amazon.awscdk.services.s3.BucketAccessControl.PRIVATE -> BucketAccessControl.PRIVATE
    ...
    internal fun unwrap(wrapped: BucketAccessControl):
