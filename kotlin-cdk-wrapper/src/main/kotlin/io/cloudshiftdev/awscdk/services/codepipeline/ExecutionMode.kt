...
public enum class ExecutionMode(
  ...
  public companion object {
    internal fun wrap(cdkObject: software.amazon.awscdk.services.codepipeline.ExecutionMode):
        ExecutionMode = when (cdkObject) {
      software.amazon.awscdk.services.codepipeline.ExecutionMode.QUEUED -> ExecutionMode.QUEUED
      software.amazon.awscdk.services.codepipeline.ExecutionMode.SUPERSEDED ->
          ExecutionMode.SUPERSEDED
      software.amazon.awscdk.services.codepipeline.ExecutionMode.PARALLEL -> ExecutionMode.PARALLEL
    }

    internal fun unwrap(wrapped: ExecutionMode):
