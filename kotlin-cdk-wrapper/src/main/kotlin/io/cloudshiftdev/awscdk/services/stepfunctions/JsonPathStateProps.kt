 ...
 * JsonPathStateProps jsonPathStateProps = JsonPathStateProps.builder()
 * .assign(Map.of(
 * "assignKey", assign))
 * .comment("comment")
 * .inputPath("inputPath")
 ...
 * ```
 */
public interface JsonPathStateProps : StateBaseProps, JsonPathCommonOptions, AssignableStateOptions
    {
  /**
  ...
  private class BuilderImpl : Builder {
    private val cdkBuilder: software.amazon.awscdk.services.stepfunctions.JsonPathStateProps.Builder
    ...
    public fun build(): software.amazon.awscdk.services.stepfunctions.JsonPathStateProps =
        cdkBuilder.build()
  }

  private class Wrapper(
    cdkObject: software.amazon.awscdk.services.stepfunctions.JsonPathStateProps,
  ) : CdkObject(cdkObject),
      JsonPathStateProps {
    /**
  ...
  public companion object {
    public operator fun invoke(block: Builder.() -> Unit = {}): JsonPathStateProps {
      val builderImpl = BuilderImpl()
      return Wrapper(builderImpl.apply(block).build())
    }

    internal fun wrap(cdkObject: software.amazon.awscdk.services.stepfunctions.JsonPathStateProps):
        JsonPathStateProps = CdkObjectWrappers.wrap(cdkObject) as? JsonPathStateProps ?:
        Wrapper(cdkObject)

    internal fun unwrap(wrapped: JsonPathStateProps):
        software.amazon.awscdk.services.stepfunctions.JsonPathStateProps = (wrapped as
        CdkObject).cdkObject as software.amazon.awscdk.services.stepfunctions.JsonPathStateProps
  }
}
