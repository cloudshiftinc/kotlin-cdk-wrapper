 ...
 * TaskRole taskRole;
 * Timeout timeout;
 * AthenaGetQueryResultsJsonPathProps athenaGetQueryResultsJsonPathProps =
 ...
 * ```
 */
public interface AthenaGetQueryResultsJsonPathProps : TaskStateJsonPathBaseProps {
  /**
  ...
  /**
   * A builder for [AthenaGetQueryResultsJsonPathProps]
   */
  @CdkDslMarker
  public interface Builder {
    ...
    @JvmName("09ad1474f3f9003a790f1383593954778d0c5372a44c14f8d5b4664e10c25021")
  ...
  private class Wrapper(
    cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.AthenaGetQueryResultsJsonPathProps,
  ) : CdkObject(cdkObject),
  ...
  public companion object {
    public operator fun invoke(block: Builder.() -> Unit = {}): AthenaGetQueryResultsJsonPathProps {
      val builderImpl = BuilderImpl()
      return Wrapper(builderImpl.apply(block).build())
    }

    internal
        fun wrap(cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.AthenaGetQueryResultsJsonPathProps):
        AthenaGetQueryResultsJsonPathProps = CdkObjectWrappers.wrap(cdkObject) as?
        AthenaGetQueryResultsJsonPathProps ?: Wrapper(cdkObject)

    internal fun unwrap(wrapped: AthenaGetQueryResultsJsonPathProps):
        software.amazon.awscdk.services.stepfunctions.tasks.AthenaGetQueryResultsJsonPathProps =
