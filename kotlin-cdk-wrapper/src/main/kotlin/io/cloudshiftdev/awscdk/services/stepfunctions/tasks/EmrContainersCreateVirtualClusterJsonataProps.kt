 ...
 * Object assign;
 * EksClusterInput eksClusterInput;
 * Object outputs;
 * TaskRole taskRole;
 * Timeout timeout;
 * EmrContainersCreateVirtualClusterJsonataProps emrContainersCreateVirtualClusterJsonataProps =
 * EmrContainersCreateVirtualClusterJsonataProps.builder()
 ...
 * ```
 */
public interface EmrContainersCreateVirtualClusterJsonataProps : TaskStateJsonataBaseProps {
  /**
  ...
  /**
   * A builder for [EmrContainersCreateVirtualClusterJsonataProps]
   */
  @CdkDslMarker
  public interface Builder {
    ...
    @JvmName("65a21937cd040595ca2f3958cd909f69ec386e8cd354de062a4866c2b97601c7")
  ...
  private class BuilderImpl : Builder {
    private val cdkBuilder:
        software.amazon.awscdk.services.stepfunctions.tasks.EmrContainersCreateVirtualClusterJsonataProps.Builder
        =
        software.amazon.awscdk.services.stepfunctions.tasks.EmrContainersCreateVirtualClusterJsonataProps.builder()
    ...
    public fun build():
        software.amazon.awscdk.services.stepfunctions.tasks.EmrContainersCreateVirtualClusterJsonataProps
        = cdkBuilder.build()
  }

  private class Wrapper(
    cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.EmrContainersCreateVirtualClusterJsonataProps,
  ) : CdkObject(cdkObject),
  ...
  public companion object {
    ...
    internal
        fun wrap(cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.EmrContainersCreateVirtualClusterJsonataProps):
        EmrContainersCreateVirtualClusterJsonataProps = CdkObjectWrappers.wrap(cdkObject) as?
        EmrContainersCreateVirtualClusterJsonataProps ?: Wrapper(cdkObject)

    internal fun unwrap(wrapped: EmrContainersCreateVirtualClusterJsonataProps):
        software.amazon.awscdk.services.stepfunctions.tasks.EmrContainersCreateVirtualClusterJsonataProps
