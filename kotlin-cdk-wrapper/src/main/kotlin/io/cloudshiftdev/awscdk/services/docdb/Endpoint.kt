...
public open class Endpoint(
  cdkObject: software.amazon.awscdk.services.docdb.Endpoint,
) : CdkObject(cdkObject) {
  public constructor(address: String, port: Number) :
      this(software.amazon.awscdk.services.docdb.Endpoint(address, port)
  )
  ...
  public companion object {
    ...
    internal fun unwrap(wrapped: Endpoint): software.amazon.awscdk.services.docdb.Endpoint =
        wrapped.cdkObject as software.amazon.awscdk.services.docdb.Endpoint
  }
}
