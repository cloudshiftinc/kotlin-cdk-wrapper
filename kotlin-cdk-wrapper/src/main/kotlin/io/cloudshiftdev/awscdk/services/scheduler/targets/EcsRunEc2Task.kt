 ...
 * ```
 */
public open class EcsRunEc2Task(
  cdkObject: software.amazon.awscdk.services.scheduler.targets.EcsRunEc2Task,
) : EcsRunTask(cdkObject) {
  public constructor(cluster: CloudshiftdevAwscdkServicesEcsICluster, props: Ec2TaskProps) :
      this(software.amazon.awscdk.services.scheduler.targets.EcsRunEc2Task(cluster.let(CloudshiftdevAwscdkServicesEcsICluster.Companion::unwrap),
      props.let(Ec2TaskProps.Companion::unwrap))
  )

  public constructor(cluster: CloudshiftdevAwscdkServicesEcsICluster,
      props: Ec2TaskProps.Builder.() -> Unit) : this(cluster, Ec2TaskProps(props)
  )

  /**
   * A fluent builder for [io.cloudshiftdev.awscdk.services.scheduler.targets.EcsRunEc2Task].
   */
  @CdkDslMarker
  public interface Builder {
    ...
    @JvmName("835b3225855526eb6d9082678382664dc1f0d0816c5612c645c581f79ba19cbe")
  ...
  private class BuilderImpl(
    ...
    private val cdkBuilder: software.amazon.awscdk.services.scheduler.targets.EcsRunEc2Task.Builder
        = software.amazon.awscdk.services.scheduler.targets.EcsRunEc2Task.Builder.create(cluster)
    ...
    public fun build(): software.amazon.awscdk.services.scheduler.targets.EcsRunEc2Task =
        cdkBuilder.build()
  }

  public companion object {
    public operator fun invoke(cluster: CloudshiftdevAwscdkServicesEcsICluster,
        block: Builder.() -> Unit = {}): EcsRunEc2Task {
      val builderImpl = BuilderImpl(CloudshiftdevAwscdkServicesEcsICluster.unwrap(cluster))
      return EcsRunEc2Task(builderImpl.apply(block).build())
    }

    internal fun wrap(cdkObject: software.amazon.awscdk.services.scheduler.targets.EcsRunEc2Task):
        EcsRunEc2Task = EcsRunEc2Task(cdkObject)

    internal fun unwrap(wrapped: EcsRunEc2Task):
        software.amazon.awscdk.services.scheduler.targets.EcsRunEc2Task = wrapped.cdkObject as
        software.amazon.awscdk.services.scheduler.targets.EcsRunEc2Task
  }
}
