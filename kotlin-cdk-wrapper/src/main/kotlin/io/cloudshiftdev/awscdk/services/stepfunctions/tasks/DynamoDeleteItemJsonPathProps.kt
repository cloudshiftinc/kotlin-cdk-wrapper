 ...
 * ```
 */
public interface DynamoDeleteItemJsonPathProps : TaskStateJsonPathBaseProps {
  /**
  ...
  /**
   * A builder for [DynamoDeleteItemJsonPathProps]
   */
  @CdkDslMarker
  public interface Builder {
    ...
    @JvmName("f6b1460a8c0d5789fe1f1534bb9fa644709cfeea2dc0f94166684d03e79d0e65")
  ...
  private class Wrapper(
    cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.DynamoDeleteItemJsonPathProps,
  ) : CdkObject(cdkObject),
  ...
  public companion object {
    public operator fun invoke(block: Builder.() -> Unit = {}): DynamoDeleteItemJsonPathProps {
      val builderImpl = BuilderImpl()
      return Wrapper(builderImpl.apply(block).build())
    }

    internal
        fun wrap(cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.DynamoDeleteItemJsonPathProps):
        DynamoDeleteItemJsonPathProps = CdkObjectWrappers.wrap(cdkObject) as?
        DynamoDeleteItemJsonPathProps ?: Wrapper(cdkObject)

    internal fun unwrap(wrapped: DynamoDeleteItemJsonPathProps):
        software.amazon.awscdk.services.stepfunctions.tasks.DynamoDeleteItemJsonPathProps = (wrapped
