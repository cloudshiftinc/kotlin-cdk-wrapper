...
public enum class EndpointType(
  ...
  public companion object {
    internal fun wrap(cdkObject: software.amazon.awscdk.services.apigatewayv2.EndpointType):
        EndpointType = when (cdkObject) {
      software.amazon.awscdk.services.apigatewayv2.EndpointType.EDGE -> EndpointType.EDGE
      software.amazon.awscdk.services.apigatewayv2.EndpointType.REGIONAL -> EndpointType.REGIONAL
    }
