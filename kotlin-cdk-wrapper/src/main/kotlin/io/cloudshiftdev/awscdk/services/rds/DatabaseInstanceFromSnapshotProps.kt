 ...
 * ```
 */
public interface DatabaseInstanceFromSnapshotProps : DatabaseInstanceSourceProps {
  /**
   ...
   */
  public fun clusterSnapshotIdentifier(): String? = unwrap(this).getClusterSnapshotIdentifier()
  ...
  /**
   * A builder for [DatabaseInstanceFromSnapshotProps]
   */
  @CdkDslMarker
  public interface Builder {
    ...
    @JvmName("3241b22e08c6a892bf036f53a1a29a70fb351cc779b544d7412f96cd8b1c94b3")
     ...
     */
    @kotlin.Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("fc309964663741013c0f8b9138a70d26470c550da93a477b82406e9847a3e875")
  ...
  private class BuilderImpl : Builder {
    ...
    public fun build(): software.amazon.awscdk.services.rds.DatabaseInstanceFromSnapshotProps =
        cdkBuilder.build()
  }

  private class Wrapper(
    cdkObject: software.amazon.awscdk.services.rds.DatabaseInstanceFromSnapshotProps,
  ) : CdkObject(cdkObject),
     ...
     * [Documentation](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_RestoreFromMultiAZDBClusterSnapshot.html)
     */
    override fun clusterSnapshotIdentifier(): String? = unwrap(this).getClusterSnapshotIdentifier()
  ...
  public companion object {
    public operator fun invoke(block: Builder.() -> Unit = {}): DatabaseInstanceFromSnapshotProps {
