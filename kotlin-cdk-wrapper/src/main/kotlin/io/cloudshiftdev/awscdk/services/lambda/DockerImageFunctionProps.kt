 ...
 * ```
 */
public interface DockerImageFunctionProps : FunctionOptions {
  /**
   ...
   * code as inline text.
   */
  public fun code(): DockerImageCode

  /**
   * A builder for [DockerImageFunctionProps]
   */
  @CdkDslMarker
  public interface Builder {
    ...
    @JvmName("0ed336ddda4aa377667c204d7b86e25262770cdaa3689648b140e7c9f00d2032")
    public
     ...
     */
    @kotlin.Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("3b2d25aa028a4617bbdef4a1aa015a76eca34452f591fb640b07c057bc510e1a")
     ...
     */
    @kotlin.Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("f294018b756c85b7cd138b0a53f76647aa1c84ed8e1439ee290700ceb49623dd")
    public
     ...
     */
    @kotlin.Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("f6664a3ad793c01b8b9996d324b77ff8d897d9ced4b144252fc7261179f9a5f9")
    public fun vpcSubnets(vpcSubnets: SubnetSelection.Builder.() -> Unit)
  }

  private class BuilderImpl : Builder {
    private val cdkBuilder: software.amazon.awscdk.services.lambda.DockerImageFunctionProps.Builder
    ...
    public fun build(): software.amazon.awscdk.services.lambda.DockerImageFunctionProps =
        cdkBuilder.build()
  }
  ...
  private class Wrapper(
     ...
     * code as inline text.
     */
    override fun code(): DockerImageCode = unwrap(this).getCode().let(DockerImageCode::wrap)
  ...
  public companion object {
    public operator fun invoke(block: Builder.() -> Unit = {}): DockerImageFunctionProps {
    ...
    internal fun unwrap(wrapped: DockerImageFunctionProps):
        ...
        CdkObject).cdkObject as software.amazon.awscdk.services.lambda.DockerImageFunctionProps
  }
}
