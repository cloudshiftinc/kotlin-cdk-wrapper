 ...
 * Topic topic;
 * Object value;
 * SnsPublishJsonPathProps snsPublishJsonPathProps = SnsPublishJsonPathProps.builder()
 * .message(taskInput)
 * .topic(topic)
 ...
 * ```
 */
public interface SnsPublishJsonPathProps : TaskStateJsonPathBaseProps {
  /**
  ...
  /**
   * A builder for [SnsPublishJsonPathProps]
   */
  @CdkDslMarker
  public interface Builder {
    ...
    @JvmName("229b094e23b7a1bc9c9ee82346d4ba0e1b3520a1608251bd130ec2d5554fe506")
  ...
  private class BuilderImpl : Builder {
    ...
    public fun build(): software.amazon.awscdk.services.stepfunctions.tasks.SnsPublishJsonPathProps
        = cdkBuilder.build()
  }

  private class Wrapper(
    cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.SnsPublishJsonPathProps,
  ) : CdkObject(cdkObject),
  ...
  public companion object {
    public operator fun invoke(block: Builder.() -> Unit = {}): SnsPublishJsonPathProps {
      val builderImpl = BuilderImpl()
      return Wrapper(builderImpl.apply(block).build())
    }

    internal
        fun wrap(cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.SnsPublishJsonPathProps):
        SnsPublishJsonPathProps = CdkObjectWrappers.wrap(cdkObject) as? SnsPublishJsonPathProps ?:
        Wrapper(cdkObject)

    internal fun unwrap(wrapped: SnsPublishJsonPathProps):
        software.amazon.awscdk.services.stepfunctions.tasks.SnsPublishJsonPathProps = (wrapped as
