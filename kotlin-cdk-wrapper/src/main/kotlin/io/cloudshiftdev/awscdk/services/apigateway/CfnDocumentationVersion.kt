...
public open class CfnDocumentationVersion(
  ...
  public constructor(
    ...
    props: CfnDocumentationVersionProps,
      ...
      this(software.amazon.awscdk.services.apigateway.CfnDocumentationVersion(scope.let(CloudshiftdevConstructsConstruct.Companion::unwrap),
      id, props.let(CfnDocumentationVersionProps.Companion::unwrap))
  )
