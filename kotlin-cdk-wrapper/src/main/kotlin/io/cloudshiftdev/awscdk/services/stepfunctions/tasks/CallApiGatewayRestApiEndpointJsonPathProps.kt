 ...
 * RestApi api;
 * CallApiGatewayRestApiEndpoint.jsonPath(this, "Endpoint",
...
public interface CallApiGatewayRestApiEndpointJsonPathProps :
    CallApiGatewayEndpointJsonPathBaseProps, CallApiGatewayRestApiEndpointOptions {
  /**
   * A builder for [CallApiGatewayRestApiEndpointJsonPathProps]
   */
  @CdkDslMarker
  public interface Builder {
    ...
    @JvmName("1e777be6c36b769340e3a51873b4472b3406c1cfc901188811de4efcbe771a85")
  ...
  private class Wrapper(
    cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.CallApiGatewayRestApiEndpointJsonPathProps,
  ) : CdkObject(cdkObject),
  ...
  public companion object {
    ...
    internal
        fun wrap(cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.CallApiGatewayRestApiEndpointJsonPathProps):
        CallApiGatewayRestApiEndpointJsonPathProps = CdkObjectWrappers.wrap(cdkObject) as?
        CallApiGatewayRestApiEndpointJsonPathProps ?: Wrapper(cdkObject)

    internal fun unwrap(wrapped: CallApiGatewayRestApiEndpointJsonPathProps):
        software.amazon.awscdk.services.stepfunctions.tasks.CallApiGatewayRestApiEndpointJsonPathProps
