 ...
 * ```
 */
public interface OutputBucketConfiguration : DataBucketConfiguration {
  /**
   * A builder for [OutputBucketConfiguration]
   */
  @CdkDslMarker
  ...
  private class BuilderImpl : Builder {
    private val cdkBuilder:
        software.amazon.awscdk.services.stepfunctions.tasks.OutputBucketConfiguration.Builder =
        software.amazon.awscdk.services.stepfunctions.tasks.OutputBucketConfiguration.builder()
  ...
  private class Wrapper(
    cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.OutputBucketConfiguration,
  ) : CdkObject(cdkObject),
  ...
  public companion object {
    public operator fun invoke(block: Builder.() -> Unit = {}): OutputBucketConfiguration {
      val builderImpl = BuilderImpl()
      return Wrapper(builderImpl.apply(block).build())
    }

    internal
        fun wrap(cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.OutputBucketConfiguration):
        OutputBucketConfiguration = CdkObjectWrappers.wrap(cdkObject) as? OutputBucketConfiguration
        ?: Wrapper(cdkObject)

    internal fun unwrap(wrapped: OutputBucketConfiguration):
        software.amazon.awscdk.services.stepfunctions.tasks.OutputBucketConfiguration = (wrapped as
