...
public open class CfnRobot(
  ...
  public constructor(
    ...
    props: CfnRobotProps,
      ...
      this(software.amazon.awscdk.services.robomaker.CfnRobot(scope.let(CloudshiftdevConstructsConstruct.Companion::unwrap),
      id, props.let(CfnRobotProps.Companion::unwrap))
  )
