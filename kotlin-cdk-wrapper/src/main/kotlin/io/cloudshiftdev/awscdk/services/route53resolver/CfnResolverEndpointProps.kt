...
public interface CfnResolverEndpointProps {
   ...
   * * `INBOUND_DELEGATION` : Resolver delegates queries to Route 53 private hosted zones from your
   * network.
   *
  ...
  public companion object {
    ...
    internal
        ...
        CfnResolverEndpointProps = CdkObjectWrappers.wrap(cdkObject) as? CfnResolverEndpointProps ?:
        Wrapper(cdkObject)
