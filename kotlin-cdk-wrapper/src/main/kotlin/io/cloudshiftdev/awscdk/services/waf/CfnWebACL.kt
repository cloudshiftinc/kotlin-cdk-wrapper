...
public open class CfnWebACL(
  ...
  public constructor(
    ...
    props: CfnWebACLProps,
      ...
      this(software.amazon.awscdk.services.waf.CfnWebACL(scope.let(CloudshiftdevConstructsConstruct.Companion::unwrap),
  ...
  public open fun defaultAction(`value`: WafActionProperty) {
    unwrap(this).setDefaultAction(`value`.let(WafActionProperty.Companion::unwrap))
  }
  ...
  private class BuilderImpl(
    ...
    override fun defaultAction(defaultAction: WafActionProperty) {
      cdkBuilder.defaultAction(defaultAction.let(WafActionProperty.Companion::unwrap))
    }
  ...
  public interface ActivatedRuleProperty {
    ...
    private class BuilderImpl : Builder {
      ...
      override fun action(action: WafActionProperty) {
        cdkBuilder.action(action.let(WafActionProperty.Companion::unwrap))
      }
