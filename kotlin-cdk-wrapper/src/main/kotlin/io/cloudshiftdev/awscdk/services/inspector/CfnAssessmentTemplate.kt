...
public open class CfnAssessmentTemplate internal constructor(
   ...
   * assessment run that uses this assessment template.
   */
  public open fun userAttributesForFindings(_idx_ac66f0: List<Any>) {
    unwrap(this).setUserAttributesForFindings(_idx_ac66f0)
  }
   ...
   * assessment run that uses this assessment template.
   */
  public open fun userAttributesForFindings(vararg _idx_ac66f0: Any): Unit =
      userAttributesForFindings(_idx_ac66f0.toList())
