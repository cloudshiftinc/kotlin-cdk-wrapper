...
public enum class NatTrafficDirection(
  ...
  INBOUND_AND_OUTBOUND(software.amazon.awscdk.services.ec2.NatTrafficDirection.INBOUND_AND_OUTBOUND),
  NONE(software.amazon.awscdk.services.ec2.NatTrafficDirection.NONE),
  ;

  public companion object {
    internal fun wrap(cdkObject: software.amazon.awscdk.services.ec2.NatTrafficDirection):
        NatTrafficDirection = when (cdkObject) {
      ...
      software.amazon.awscdk.services.ec2.NatTrafficDirection.NONE -> NatTrafficDirection.NONE
    }

    internal fun unwrap(wrapped: NatTrafficDirection):
