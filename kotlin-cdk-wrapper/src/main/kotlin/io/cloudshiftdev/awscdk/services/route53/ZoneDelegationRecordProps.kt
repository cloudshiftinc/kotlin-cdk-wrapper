 ...
 * ```
 */
public interface ZoneDelegationRecordProps : RecordSetOptions {
  /**
   * The name servers to report in the delegation records.
   */
  public fun nameServers(): List<String>

  /**
   * A builder for [ZoneDelegationRecordProps]
   */
  @CdkDslMarker
  ...
  private class BuilderImpl : Builder {
    ...
    public fun build(): software.amazon.awscdk.services.route53.ZoneDelegationRecordProps =
        cdkBuilder.build()
  }
  ...
  private class Wrapper(
     ...
     * The name servers to report in the delegation records.
     */
    override fun nameServers(): List<String> = unwrap(this).getNameServers()
  ...
  public companion object {
    public operator fun invoke(block: Builder.() -> Unit = {}): ZoneDelegationRecordProps {
    ...
    internal fun unwrap(wrapped: ZoneDelegationRecordProps):
        ...
        CdkObject).cdkObject as software.amazon.awscdk.services.route53.ZoneDelegationRecordProps
  }
}
