 ...
 * TaskRole taskRole;
 * Timeout timeout;
 * SageMakerCreateEndpointConfigJsonataProps sageMakerCreateEndpointConfigJsonataProps =
 ...
 */
public interface SageMakerCreateEndpointConfigJsonataProps : TaskStateJsonataBaseProps {
  /**
  ...
  /**
   * A builder for [SageMakerCreateEndpointConfigJsonataProps]
   */
  @CdkDslMarker
  public interface Builder {
    ...
    @JvmName("fd5357ced0ece49efc2c497f3484d86ee161ab128eee9d483428a28820294dec")
  ...
  private class Wrapper(
    cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.SageMakerCreateEndpointConfigJsonataProps,
  ) : CdkObject(cdkObject),
  ...
  public companion object {
    ...
    internal
        fun wrap(cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.SageMakerCreateEndpointConfigJsonataProps):
        SageMakerCreateEndpointConfigJsonataProps = CdkObjectWrappers.wrap(cdkObject) as?
        SageMakerCreateEndpointConfigJsonataProps ?: Wrapper(cdkObject)

    internal fun unwrap(wrapped: SageMakerCreateEndpointConfigJsonataProps):
        software.amazon.awscdk.services.stepfunctions.tasks.SageMakerCreateEndpointConfigJsonataProps
