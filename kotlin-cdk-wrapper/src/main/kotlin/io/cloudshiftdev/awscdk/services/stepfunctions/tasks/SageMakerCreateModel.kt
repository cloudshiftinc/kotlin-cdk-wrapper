...
public open class SageMakerCreateModel(
  ...
  public companion object {
    public val PROPERTY_INJECTION_ID: String =
        software.amazon.awscdk.services.stepfunctions.tasks.SageMakerCreateModel.PROPERTY_INJECTION_ID

    public fun jsonPath(
      scope: CloudshiftdevConstructsConstruct,
      id: String,
      props: SageMakerCreateModelJsonPathProps,
    ): SageMakerCreateModel =
        software.amazon.awscdk.services.stepfunctions.tasks.SageMakerCreateModel.jsonPath(scope.let(CloudshiftdevConstructsConstruct.Companion::unwrap),
        id,
        props.let(SageMakerCreateModelJsonPathProps.Companion::unwrap)).let(SageMakerCreateModel::wrap)

    @kotlin.Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("54fc385d42fb7ff08a67e09c77f42f36a89ea05c54aa27b7c7739b3aceaa5faa")
    public fun jsonPath(
      scope: CloudshiftdevConstructsConstruct,
      id: String,
      props: SageMakerCreateModelJsonPathProps.Builder.() -> Unit,
    ): SageMakerCreateModel = jsonPath(scope, id, SageMakerCreateModelJsonPathProps(props))

    public fun jsonata(
      scope: CloudshiftdevConstructsConstruct,
      id: String,
      props: SageMakerCreateModelJsonataProps,
    ): SageMakerCreateModel =
        software.amazon.awscdk.services.stepfunctions.tasks.SageMakerCreateModel.jsonata(scope.let(CloudshiftdevConstructsConstruct.Companion::unwrap),
        id,
        props.let(SageMakerCreateModelJsonataProps.Companion::unwrap)).let(SageMakerCreateModel::wrap)

    @kotlin.Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("49b0704deb9c5acd74f11c44b1bd6faf74730e865307ff65428ea8baf8bf2968")
    public fun jsonata(
      scope: CloudshiftdevConstructsConstruct,
      id: String,
      props: SageMakerCreateModelJsonataProps.Builder.() -> Unit,
    ): SageMakerCreateModel = jsonata(scope, id, SageMakerCreateModelJsonataProps(props))
