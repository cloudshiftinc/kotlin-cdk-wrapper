...
public enum class FifoThroughputLimit(
  ...
  PER_MESSAGE_GROUP_ID(software.amazon.awscdk.services.sqs.FifoThroughputLimit.PER_MESSAGE_GROUP_ID),
  ;

  public companion object {
    internal fun wrap(cdkObject: software.amazon.awscdk.services.sqs.FifoThroughputLimit):
        FifoThroughputLimit = when (cdkObject) {
    ...
    internal fun unwrap(wrapped: FifoThroughputLimit):
