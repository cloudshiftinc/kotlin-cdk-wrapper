 ...
 * TaskRole taskRole;
 * Timeout timeout;
 * CallApiGatewayEndpointJsonPathBaseProps callApiGatewayEndpointJsonPathBaseProps =
 ...
 * ```
 */
public interface CallApiGatewayEndpointJsonPathBaseProps : TaskStateJsonPathBaseProps,
    CallApiGatewayEndpointBaseOptions {
  /**
   * A builder for [CallApiGatewayEndpointJsonPathBaseProps]
   */
  @CdkDslMarker
  public interface Builder {
    ...
    @JvmName("4e1e4ff632dd3a53ded97719acf60bad7aab84df4fab3170566e4f7a375084a0")
  ...
  private class Wrapper(
    cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.CallApiGatewayEndpointJsonPathBaseProps,
  ) : CdkObject(cdkObject),
  ...
  public companion object {
    ...
    internal
        fun wrap(cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.CallApiGatewayEndpointJsonPathBaseProps):
        CallApiGatewayEndpointJsonPathBaseProps = CdkObjectWrappers.wrap(cdkObject) as?
        CallApiGatewayEndpointJsonPathBaseProps ?: Wrapper(cdkObject)

    internal fun unwrap(wrapped: CallApiGatewayEndpointJsonPathBaseProps):
        software.amazon.awscdk.services.stepfunctions.tasks.CallApiGatewayEndpointJsonPathBaseProps
