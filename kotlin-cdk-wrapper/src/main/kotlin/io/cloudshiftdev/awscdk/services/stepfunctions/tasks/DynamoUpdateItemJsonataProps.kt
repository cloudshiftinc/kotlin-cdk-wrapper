 ...
 * TaskRole taskRole;
 * Timeout timeout;
 * DynamoUpdateItemJsonataProps dynamoUpdateItemJsonataProps =
 ...
 * ```
 */
public interface DynamoUpdateItemJsonataProps : TaskStateJsonataBaseProps {
  /**
  ...
  /**
   * A builder for [DynamoUpdateItemJsonataProps]
   */
  @CdkDslMarker
  public interface Builder {
    ...
    @JvmName("d27f3eb0c7be65ba903b3f1d1b06d4d542a65688969ed7a7b88bb9a13b3342e1")
  ...
  private class Wrapper(
    cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.DynamoUpdateItemJsonataProps,
  ) : CdkObject(cdkObject),
  ...
  public companion object {
    public operator fun invoke(block: Builder.() -> Unit = {}): DynamoUpdateItemJsonataProps {
      val builderImpl = BuilderImpl()
      return Wrapper(builderImpl.apply(block).build())
    }

    internal
        fun wrap(cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.DynamoUpdateItemJsonataProps):
        DynamoUpdateItemJsonataProps = CdkObjectWrappers.wrap(cdkObject) as?
        DynamoUpdateItemJsonataProps ?: Wrapper(cdkObject)

    internal fun unwrap(wrapped: DynamoUpdateItemJsonataProps):
        software.amazon.awscdk.services.stepfunctions.tasks.DynamoUpdateItemJsonataProps = (wrapped
