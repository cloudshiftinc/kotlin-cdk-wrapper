 ...
 * SageMakerCreateEndpointJsonPathProps.builder()
 ...
 */
public interface SageMakerCreateEndpointJsonPathProps : TaskStateJsonPathBaseProps {
  /**
  ...
  /**
   * A builder for [SageMakerCreateEndpointJsonPathProps]
   */
  @CdkDslMarker
  public interface Builder {
    ...
    @JvmName("015caaa1ee8531879104ba31b998267ed705f1094eef97a385713e4ffe627072")
  ...
  private class BuilderImpl : Builder {
    private val cdkBuilder:
        software.amazon.awscdk.services.stepfunctions.tasks.SageMakerCreateEndpointJsonPathProps.Builder
        =
        software.amazon.awscdk.services.stepfunctions.tasks.SageMakerCreateEndpointJsonPathProps.builder()
  ...
  private class Wrapper(
    cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.SageMakerCreateEndpointJsonPathProps,
  ) : CdkObject(cdkObject),
  ...
  public companion object {
    ...
    internal
        fun wrap(cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.SageMakerCreateEndpointJsonPathProps):
        SageMakerCreateEndpointJsonPathProps = CdkObjectWrappers.wrap(cdkObject) as?
        SageMakerCreateEndpointJsonPathProps ?: Wrapper(cdkObject)

    internal fun unwrap(wrapped: SageMakerCreateEndpointJsonPathProps):
        software.amazon.awscdk.services.stepfunctions.tasks.SageMakerCreateEndpointJsonPathProps =
