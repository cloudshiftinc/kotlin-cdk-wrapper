 ...
 * TaskRole taskRole;
 * Timeout timeout;
 * SageMakerUpdateEndpointJsonPathProps sageMakerUpdateEndpointJsonPathProps =
 * SageMakerUpdateEndpointJsonPathProps.builder()
 ...
 */
public interface SageMakerUpdateEndpointJsonPathProps : TaskStateJsonPathBaseProps {
  /**
  ...
  /**
   * A builder for [SageMakerUpdateEndpointJsonPathProps]
   */
  @CdkDslMarker
  public interface Builder {
    ...
    @JvmName("506b521d5ac339108e14dc0b1b038516d16c3212856bd0b8237d852fd14951c1")
  ...
  private class BuilderImpl : Builder {
    private val cdkBuilder:
        software.amazon.awscdk.services.stepfunctions.tasks.SageMakerUpdateEndpointJsonPathProps.Builder
        =
        software.amazon.awscdk.services.stepfunctions.tasks.SageMakerUpdateEndpointJsonPathProps.builder()
  ...
  private class Wrapper(
    cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.SageMakerUpdateEndpointJsonPathProps,
  ) : CdkObject(cdkObject),
  ...
  public companion object {
    ...
    internal
        fun wrap(cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.SageMakerUpdateEndpointJsonPathProps):
        SageMakerUpdateEndpointJsonPathProps = CdkObjectWrappers.wrap(cdkObject) as?
        SageMakerUpdateEndpointJsonPathProps ?: Wrapper(cdkObject)

    internal fun unwrap(wrapped: SageMakerUpdateEndpointJsonPathProps):
        software.amazon.awscdk.services.stepfunctions.tasks.SageMakerUpdateEndpointJsonPathProps =
