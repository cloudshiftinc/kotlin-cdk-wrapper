...
public enum class ConfigurationSourceType(
  ...
  SECRETS_MANAGER(software.amazon.awscdk.services.appconfig.ConfigurationSourceType.SECRETS_MANAGER),
  ...
  public companion object {
    internal fun wrap(cdkObject: software.amazon.awscdk.services.appconfig.ConfigurationSourceType):
        ConfigurationSourceType = when (cdkObject) {
    ...
    internal fun unwrap(wrapped: ConfigurationSourceType):
