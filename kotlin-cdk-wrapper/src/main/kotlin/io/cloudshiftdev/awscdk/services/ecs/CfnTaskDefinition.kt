...
public open class CfnTaskDefinition(
  ...
  public interface ContainerDefinitionProperty {
     ...
     * Amazon ECS will not resolve the provided container image tag to a digest and will use the
     * original image URI specified in the container definition for deployment. For more information
     * about container image resolution, see [Container image
     ...
     */
    public fun versionConsistency(): String? = unwrap(this).getVersionConsistency()
    ...
    public interface Builder {
       ...
       * in the *Amazon ECS Developer Guide* .
       */
      public fun versionConsistency(versionConsistency: String)
    ...
    private class BuilderImpl : Builder {
       ...
       * in the *Amazon ECS Developer Guide* .
       */
      override fun versionConsistency(versionConsistency: String) {
        cdkBuilder.versionConsistency(versionConsistency)
      }
    ...
    private class Wrapper(
       ...
       * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ecs-taskdefinition-containerdefinition.html#cfn-ecs-taskdefinition-containerdefinition-versionconsistency)
       */
      override fun versionConsistency(): String? = unwrap(this).getVersionConsistency()
  ...
  public interface PortMappingProperty {
     ...
     *
     * This parameter is the name that you use in the `serviceConnectConfiguration` and the
     * `vpcLatticeConfigurations` of a service. The name can include up to 64 characters. The
