...
public abstract class AclTraffic(
  ...
  public companion object {
    ...
    public fun icmp(props: AclIcmp): AclTraffic =
        software.amazon.awscdk.services.ec2.AclTraffic.icmp(props.let(AclIcmp.Companion::unwrap)).let(AclTraffic::wrap)
    ...
    public fun icmpv6(props: AclIcmp): AclTraffic =
        software.amazon.awscdk.services.ec2.AclTraffic.icmpv6(props.let(AclIcmp.Companion::unwrap)).let(AclTraffic::wrap)
