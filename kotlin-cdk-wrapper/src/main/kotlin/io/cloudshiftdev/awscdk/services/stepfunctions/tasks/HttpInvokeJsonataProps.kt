 ...
 * ```
 */
public interface HttpInvokeJsonataProps : TaskStateJsonataBaseProps {
  /**
  ...
  /**
   * A builder for [HttpInvokeJsonataProps]
   */
  @CdkDslMarker
  public interface Builder {
    ...
    @JvmName("afe18787c9b72024f82882bd0964162f4f17f9a59150896801bf849769f41e49")
  ...
  private class BuilderImpl : Builder {
    ...
    public fun build(): software.amazon.awscdk.services.stepfunctions.tasks.HttpInvokeJsonataProps =
        cdkBuilder.build()
  }

  private class Wrapper(
    cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.HttpInvokeJsonataProps,
  ) : CdkObject(cdkObject),
  ...
  public companion object {
    public operator fun invoke(block: Builder.() -> Unit = {}): HttpInvokeJsonataProps {
      val builderImpl = BuilderImpl()
      return Wrapper(builderImpl.apply(block).build())
    }

    internal
        fun wrap(cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.HttpInvokeJsonataProps):
        HttpInvokeJsonataProps = CdkObjectWrappers.wrap(cdkObject) as? HttpInvokeJsonataProps ?:
        Wrapper(cdkObject)

    internal fun unwrap(wrapped: HttpInvokeJsonataProps):
        software.amazon.awscdk.services.stepfunctions.tasks.HttpInvokeJsonataProps = (wrapped as
