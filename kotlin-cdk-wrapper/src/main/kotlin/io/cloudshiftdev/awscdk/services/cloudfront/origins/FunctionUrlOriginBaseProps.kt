 ...
 * ```
 */
public interface FunctionUrlOriginBaseProps : OriginProps {
  /**
   * A builder for [FunctionUrlOriginBaseProps]
   */
  @CdkDslMarker
  ...
  private class BuilderImpl : Builder {
    ...
    public fun build():
        software.amazon.awscdk.services.cloudfront.origins.FunctionUrlOriginBaseProps =
        cdkBuilder.build()
  }

  private class Wrapper(
    cdkObject: software.amazon.awscdk.services.cloudfront.origins.FunctionUrlOriginBaseProps,
  ) : CdkObject(cdkObject),
  ...
  public companion object {
    public operator fun invoke(block: Builder.() -> Unit = {}): FunctionUrlOriginBaseProps {
      val builderImpl = BuilderImpl()
      return Wrapper(builderImpl.apply(block).build())
    }

    internal
        fun wrap(cdkObject: software.amazon.awscdk.services.cloudfront.origins.FunctionUrlOriginBaseProps):
        FunctionUrlOriginBaseProps = CdkObjectWrappers.wrap(cdkObject) as?
        FunctionUrlOriginBaseProps ?: Wrapper(cdkObject)

    internal fun unwrap(wrapped: FunctionUrlOriginBaseProps):
        software.amazon.awscdk.services.cloudfront.origins.FunctionUrlOriginBaseProps = (wrapped as
