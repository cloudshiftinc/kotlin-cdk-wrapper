  ...
  public companion object {
    public fun jsonPath(
      ...
      props: AthenaStopQueryExecutionJsonPathProps,
        ...
        software.amazon.awscdk.services.stepfunctions.tasks.AthenaStopQueryExecution.jsonPath(scope.let(CloudshiftdevConstructsConstruct.Companion::unwrap),
        id,
        props.let(AthenaStopQueryExecutionJsonPathProps.Companion::unwrap)).let(AthenaStopQueryExecution::wrap)

    @kotlin.Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("fb24696728376eb6120bd9afc750b4406f8ccb39a1ca8a0a5c6a8a8096b52d76")
    public fun jsonPath(
      scope: CloudshiftdevConstructsConstruct,
      id: String,
      props: AthenaStopQueryExecutionJsonPathProps.Builder.() -> Unit,
    ): AthenaStopQueryExecution = jsonPath(scope, id, AthenaStopQueryExecutionJsonPathProps(props))
    ...
    public fun jsonata(
      ...
      props: AthenaStopQueryExecutionJsonataProps,
        ...
        software.amazon.awscdk.services.stepfunctions.tasks.AthenaStopQueryExecution.jsonata(scope.let(CloudshiftdevConstructsConstruct.Companion::unwrap),
        id,
        props.let(AthenaStopQueryExecutionJsonataProps.Companion::unwrap)).let(AthenaStopQueryExecution::wrap)

    @kotlin.Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("50cd269fbfbc98f88ef3ce82497aa31d08026f214d6a213873f7a0326222ec11")
    public fun jsonata(
      scope: CloudshiftdevConstructsConstruct,
      id: String,
      props: AthenaStopQueryExecutionJsonataProps.Builder.() -> Unit,
    ): AthenaStopQueryExecution = jsonata(scope, id, AthenaStopQueryExecutionJsonataProps(props))
