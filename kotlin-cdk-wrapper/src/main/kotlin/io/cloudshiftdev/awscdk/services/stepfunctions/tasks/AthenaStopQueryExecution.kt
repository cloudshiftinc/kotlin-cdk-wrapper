 ...
 */
public open class AthenaStopQueryExecution(
  cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.AthenaStopQueryExecution,
  ...
  public constructor(
    ...
    props: AthenaStopQueryExecutionProps,
      ...
      this(software.amazon.awscdk.services.stepfunctions.tasks.AthenaStopQueryExecution(scope.let(CloudshiftdevConstructsConstruct.Companion::unwrap),
      id, props.let(AthenaStopQueryExecutionProps.Companion::unwrap))
  )
