...
public interface CfnBranchProps {
   ...
   *
   * This field is available to Amplify Gen 2 apps only. When you deploy an application with Amplify
   * Gen 2, you provision the app's backend infrastructure using Typescript code.
   *
