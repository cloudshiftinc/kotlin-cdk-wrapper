...
public enum class OidcAttributeRequestMethod(
  ...
  public companion object {
    internal
        fun wrap(cdkObject: software.amazon.awscdk.services.cognito.OidcAttributeRequestMethod):
        OidcAttributeRequestMethod = when (cdkObject) {
    ...
    internal fun unwrap(wrapped: OidcAttributeRequestMethod):
