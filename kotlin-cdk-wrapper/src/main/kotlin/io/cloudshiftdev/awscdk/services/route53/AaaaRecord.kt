...
public open class AaaaRecord(
  ...
  public constructor(
    ...
    props: AaaaRecordProps,
      ...
      this(software.amazon.awscdk.services.route53.AaaaRecord(scope.let(CloudshiftdevConstructsConstruct.Companion::unwrap),
      id, props.let(AaaaRecordProps.Companion::unwrap))
  )

  public constructor(
    scope: CloudshiftdevConstructsConstruct,
    id: String,
    props: AaaaRecordProps.Builder.() -> Unit,
  ) : this(scope, id, AaaaRecordProps(props)
  )
  ...
  public companion object {
    public val PROPERTY_INJECTION_ID: String =
        software.amazon.awscdk.services.route53.AaaaRecord.PROPERTY_INJECTION_ID
    ...
    internal fun unwrap(wrapped: AaaaRecord): software.amazon.awscdk.services.route53.AaaaRecord =
        wrapped.cdkObject as software.amazon.awscdk.services.route53.AaaaRecord
  }
}
