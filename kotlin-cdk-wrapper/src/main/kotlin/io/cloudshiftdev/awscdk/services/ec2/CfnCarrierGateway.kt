...
public open class CfnCarrierGateway(
  ...
  public constructor(
    ...
    props: CfnCarrierGatewayProps,
      ...
      this(software.amazon.awscdk.services.ec2.CfnCarrierGateway(scope.let(CloudshiftdevConstructsConstruct.Companion::unwrap),
      id, props.let(CfnCarrierGatewayProps.Companion::unwrap))
  )

  public constructor(
    scope: CloudshiftdevConstructsConstruct,
    id: String,
    props: CfnCarrierGatewayProps.Builder.() -> Unit,
  ) : this(scope, id, CfnCarrierGatewayProps(props)
  )
