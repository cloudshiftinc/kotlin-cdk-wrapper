...
public open class SageMakerCreateEndpoint(
  ...
  public constructor(
    ...
    props: SageMakerCreateEndpointProps,
      ...
      this(software.amazon.awscdk.services.stepfunctions.tasks.SageMakerCreateEndpoint(scope.let(CloudshiftdevConstructsConstruct.Companion::unwrap),
      id, props.let(SageMakerCreateEndpointProps.Companion::unwrap))
  )

  public constructor(
    scope: CloudshiftdevConstructsConstruct,
    id: String,
    props: SageMakerCreateEndpointProps.Builder.() -> Unit,
  ) : this(scope, id, SageMakerCreateEndpointProps(props)
  )

  /**
   * A fluent builder for
   * [io.cloudshiftdev.awscdk.services.stepfunctions.tasks.SageMakerCreateEndpoint].
   */
  @CdkDslMarker
  public interface Builder {
     ...
     *
     * @param endpointConfigName The name of an endpoint configuration. 
     */
     ...
     * Default: - No tags
     *
     * @param tags Tags to be applied to the endpoint. 
     */
  ...
  public companion object {
    public fun jsonPath(
      scope: CloudshiftdevConstructsConstruct,
      id: String,
      props: SageMakerCreateEndpointJsonPathProps,
    ): SageMakerCreateEndpoint =
        software.amazon.awscdk.services.stepfunctions.tasks.SageMakerCreateEndpoint.jsonPath(scope.let(CloudshiftdevConstructsConstruct.Companion::unwrap),
        id,
        props.let(SageMakerCreateEndpointJsonPathProps.Companion::unwrap)).let(SageMakerCreateEndpoint::wrap)

    @kotlin.Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("950274f6668553f767dfa9aa35e203645bc0491c47a5bc239b5dcfe29379046f")
    public fun jsonPath(
      scope: CloudshiftdevConstructsConstruct,
      id: String,
      props: SageMakerCreateEndpointJsonPathProps.Builder.() -> Unit,
    ): SageMakerCreateEndpoint = jsonPath(scope, id, SageMakerCreateEndpointJsonPathProps(props))

    public fun jsonata(
      scope: CloudshiftdevConstructsConstruct,
      id: String,
      props: SageMakerCreateEndpointJsonataProps,
    ): SageMakerCreateEndpoint =
        software.amazon.awscdk.services.stepfunctions.tasks.SageMakerCreateEndpoint.jsonata(scope.let(CloudshiftdevConstructsConstruct.Companion::unwrap),
        id,
        props.let(SageMakerCreateEndpointJsonataProps.Companion::unwrap)).let(SageMakerCreateEndpoint::wrap)

    @kotlin.Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("b3040d1d0e805367ce52092e558d678017eaefd696d6dd478ebd456d81fa4bbc")
    public fun jsonata(
      scope: CloudshiftdevConstructsConstruct,
      id: String,
      props: SageMakerCreateEndpointJsonataProps.Builder.() -> Unit,
    ): SageMakerCreateEndpoint = jsonata(scope, id, SageMakerCreateEndpointJsonataProps(props))
