 ...
 * from an Availability Zone during events, on your behalf, to help reduce time to recovery. Traffic is
 * also shifted away for the required weekly practice runs.
 *
 * Example:
 *
 * ```
