...
public enum class DataResourceType(
  ...
  public companion object {
    internal fun wrap(cdkObject: software.amazon.awscdk.services.cloudtrail.DataResourceType):
        DataResourceType = when (cdkObject) {
    ...
    internal fun unwrap(wrapped: DataResourceType):
