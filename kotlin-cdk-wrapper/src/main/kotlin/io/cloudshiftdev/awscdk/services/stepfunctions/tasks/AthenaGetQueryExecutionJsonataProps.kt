 ...
 * AthenaGetQueryExecutionJsonataProps.builder()
 ...
 * ```
 */
public interface AthenaGetQueryExecutionJsonataProps : TaskStateJsonataBaseProps {
  /**
  ...
  /**
   * A builder for [AthenaGetQueryExecutionJsonataProps]
   */
  @CdkDslMarker
  public interface Builder {
    ...
    @JvmName("505bbd77732e1c3c07864ceb51f8f36c361334acfe2109f77e5ac0957186eb5c")
  ...
  private class Wrapper(
    cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.AthenaGetQueryExecutionJsonataProps,
  ) : CdkObject(cdkObject),
  ...
  public companion object {
    ...
    internal
        fun wrap(cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.AthenaGetQueryExecutionJsonataProps):
        AthenaGetQueryExecutionJsonataProps = CdkObjectWrappers.wrap(cdkObject) as?
        AthenaGetQueryExecutionJsonataProps ?: Wrapper(cdkObject)

    internal fun unwrap(wrapped: AthenaGetQueryExecutionJsonataProps):
        software.amazon.awscdk.services.stepfunctions.tasks.AthenaGetQueryExecutionJsonataProps =
