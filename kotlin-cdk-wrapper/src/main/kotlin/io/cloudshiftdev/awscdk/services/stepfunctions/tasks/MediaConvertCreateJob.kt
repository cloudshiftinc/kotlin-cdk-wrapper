...
public open class MediaConvertCreateJob(
  ...
  public companion object {
    public fun jsonPath(
      scope: CloudshiftdevConstructsConstruct,
      id: String,
      props: MediaConvertCreateJobJsonPathProps,
    ): MediaConvertCreateJob =
        software.amazon.awscdk.services.stepfunctions.tasks.MediaConvertCreateJob.jsonPath(scope.let(CloudshiftdevConstructsConstruct.Companion::unwrap),
        id,
        props.let(MediaConvertCreateJobJsonPathProps.Companion::unwrap)).let(MediaConvertCreateJob::wrap)

    @kotlin.Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("02ee4a27e18b1c4636c980b04f6783da7cb143bfa2847fbc7f2b67e833d923ec")
    public fun jsonPath(
      scope: CloudshiftdevConstructsConstruct,
      id: String,
      props: MediaConvertCreateJobJsonPathProps.Builder.() -> Unit,
    ): MediaConvertCreateJob = jsonPath(scope, id, MediaConvertCreateJobJsonPathProps(props))

    public fun jsonata(
      scope: CloudshiftdevConstructsConstruct,
      id: String,
      props: MediaConvertCreateJobJsonataProps,
    ): MediaConvertCreateJob =
        software.amazon.awscdk.services.stepfunctions.tasks.MediaConvertCreateJob.jsonata(scope.let(CloudshiftdevConstructsConstruct.Companion::unwrap),
        id,
        props.let(MediaConvertCreateJobJsonataProps.Companion::unwrap)).let(MediaConvertCreateJob::wrap)

    @kotlin.Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("eeb888c8fc13ad0b85c06b371f657bd99536e0b2836c1acdff18567e96c27cb7")
    public fun jsonata(
      scope: CloudshiftdevConstructsConstruct,
      id: String,
      props: MediaConvertCreateJobJsonataProps.Builder.() -> Unit,
    ): MediaConvertCreateJob = jsonata(scope, id, MediaConvertCreateJobJsonataProps(props))
