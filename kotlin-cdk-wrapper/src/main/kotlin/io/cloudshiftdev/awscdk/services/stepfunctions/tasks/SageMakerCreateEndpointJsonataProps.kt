 ...
 * TaskRole taskRole;
 * Timeout timeout;
 * SageMakerCreateEndpointJsonataProps sageMakerCreateEndpointJsonataProps =
 ...
 */
public interface SageMakerCreateEndpointJsonataProps : TaskStateJsonataBaseProps {
  /**
  ...
  /**
   * A builder for [SageMakerCreateEndpointJsonataProps]
   */
  @CdkDslMarker
  public interface Builder {
    ...
    @JvmName("3f94d24054aeb9ed5141923de1328a069ef896d0cbd08bcf78634185ee0c3d3b")
  ...
  private class Wrapper(
    cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.SageMakerCreateEndpointJsonataProps,
  ) : CdkObject(cdkObject),
  ...
  public companion object {
    ...
    internal
        fun wrap(cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.SageMakerCreateEndpointJsonataProps):
        SageMakerCreateEndpointJsonataProps = CdkObjectWrappers.wrap(cdkObject) as?
        SageMakerCreateEndpointJsonataProps ?: Wrapper(cdkObject)

    internal fun unwrap(wrapped: SageMakerCreateEndpointJsonataProps):
        software.amazon.awscdk.services.stepfunctions.tasks.SageMakerCreateEndpointJsonataProps =
