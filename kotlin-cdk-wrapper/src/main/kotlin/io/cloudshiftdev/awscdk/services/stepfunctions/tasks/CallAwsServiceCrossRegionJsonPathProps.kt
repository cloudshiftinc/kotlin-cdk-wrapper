 ...
 * CallAwsServiceCrossRegionJsonPathProps.builder()
 * .action("action")
 ...
 * ```
 */
public interface CallAwsServiceCrossRegionJsonPathProps : TaskStateJsonPathBaseProps {
  /**
  ...
  /**
   * A builder for [CallAwsServiceCrossRegionJsonPathProps]
   */
  @CdkDslMarker
  public interface Builder {
    ...
    @JvmName("2252911e6aacd40149a88ca0ba445115eb98078e38443b3393082bc33eeb26db")
  ...
  private class Wrapper(
    cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.CallAwsServiceCrossRegionJsonPathProps,
  ) : CdkObject(cdkObject),
  ...
  public companion object {
    ...
    internal
        fun wrap(cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.CallAwsServiceCrossRegionJsonPathProps):
        CallAwsServiceCrossRegionJsonPathProps = CdkObjectWrappers.wrap(cdkObject) as?
        CallAwsServiceCrossRegionJsonPathProps ?: Wrapper(cdkObject)

    internal fun unwrap(wrapped: CallAwsServiceCrossRegionJsonPathProps):
        software.amazon.awscdk.services.stepfunctions.tasks.CallAwsServiceCrossRegionJsonPathProps =
