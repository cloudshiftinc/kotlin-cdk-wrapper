...
public open class CfnComponent(
  ...
  public constructor(
    ...
    props: CfnComponentProps,
      ...
      this(software.amazon.awscdk.services.imagebuilder.CfnComponent(scope.let(CloudshiftdevConstructsConstruct.Companion::unwrap),
  ...
  public constructor(
    scope: CloudshiftdevConstructsConstruct,
    id: String,
    props: CfnComponentProps.Builder.() -> Unit,
  ) : this(scope, id, CfnComponentProps(props)
  )
