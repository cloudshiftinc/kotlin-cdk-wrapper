 ...
 * ```
 */
public interface BatchSubmitJobJsonPathProps : TaskStateJsonPathBaseProps {
  /**
  ...
  /**
   * A builder for [BatchSubmitJobJsonPathProps]
   */
  @CdkDslMarker
  public interface Builder {
    ...
    @JvmName("400198a2702d244a75b9d191183e806df47b44b0768c54fb2f8f11919c815387")
     ...
     */
    @kotlin.Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("ed83df9cb5938017951f6b929ad3443ca6843ef91f5b54909392249f54480809")
  ...
  private class Wrapper(
    cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.BatchSubmitJobJsonPathProps,
  ) : CdkObject(cdkObject),
  ...
  public companion object {
    public operator fun invoke(block: Builder.() -> Unit = {}): BatchSubmitJobJsonPathProps {
      val builderImpl = BuilderImpl()
      return Wrapper(builderImpl.apply(block).build())
    }

    internal
        fun wrap(cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.BatchSubmitJobJsonPathProps):
        BatchSubmitJobJsonPathProps = CdkObjectWrappers.wrap(cdkObject) as?
        BatchSubmitJobJsonPathProps ?: Wrapper(cdkObject)

    internal fun unwrap(wrapped: BatchSubmitJobJsonPathProps):
        software.amazon.awscdk.services.stepfunctions.tasks.BatchSubmitJobJsonPathProps = (wrapped
