 ...
 * ```
 */
public open class S3StaticWebsiteOrigin(
  cdkObject: software.amazon.awscdk.services.cloudfront.origins.S3StaticWebsiteOrigin,
) : HttpOrigin(cdkObject) {
  public constructor(bucket: CloudshiftdevAwscdkServicesS3IBucket) :
      this(software.amazon.awscdk.services.cloudfront.origins.S3StaticWebsiteOrigin(bucket.let(CloudshiftdevAwscdkServicesS3IBucket.Companion::unwrap))
  )

  public constructor(bucket: CloudshiftdevAwscdkServicesS3IBucket,
      props: S3StaticWebsiteOriginProps) :
      this(software.amazon.awscdk.services.cloudfront.origins.S3StaticWebsiteOrigin(bucket.let(CloudshiftdevAwscdkServicesS3IBucket.Companion::unwrap),
      props.let(S3StaticWebsiteOriginProps.Companion::unwrap))
  )

  public constructor(bucket: CloudshiftdevAwscdkServicesS3IBucket,
      props: S3StaticWebsiteOriginProps.Builder.() -> Unit) : this(bucket,
      S3StaticWebsiteOriginProps(props)
  )

  /**
   * A fluent builder for
   * [io.cloudshiftdev.awscdk.services.cloudfront.origins.S3StaticWebsiteOrigin].
   */
  @CdkDslMarker
  ...
  private class BuilderImpl(
    ...
    private val cdkBuilder:
        ...
        software.amazon.awscdk.services.cloudfront.origins.S3StaticWebsiteOrigin.Builder.create(bucket)
    ...
    public fun build(): software.amazon.awscdk.services.cloudfront.origins.S3StaticWebsiteOrigin =
        cdkBuilder.build()
  }

  public companion object {
    public operator fun invoke(bucket: CloudshiftdevAwscdkServicesS3IBucket,
        block: Builder.() -> Unit = {}): S3StaticWebsiteOrigin {
      val builderImpl = BuilderImpl(CloudshiftdevAwscdkServicesS3IBucket.unwrap(bucket))
      return S3StaticWebsiteOrigin(builderImpl.apply(block).build())
    }

    internal
        fun wrap(cdkObject: software.amazon.awscdk.services.cloudfront.origins.S3StaticWebsiteOrigin):
        S3StaticWebsiteOrigin = S3StaticWebsiteOrigin(cdkObject)

    internal fun unwrap(wrapped: S3StaticWebsiteOrigin):
        software.amazon.awscdk.services.cloudfront.origins.S3StaticWebsiteOrigin = wrapped.cdkObject
        as software.amazon.awscdk.services.cloudfront.origins.S3StaticWebsiteOrigin
  }
}
