...
public interface AccessLogDestinationConfig {
  ...
  private class BuilderImpl : Builder {
    ...
    public fun build(): software.amazon.awscdk.services.apigatewayv2.AccessLogDestinationConfig =
        cdkBuilder.build()
  }

  private class Wrapper(
    cdkObject: software.amazon.awscdk.services.apigatewayv2.AccessLogDestinationConfig,
  ) : CdkObject(cdkObject),
  ...
  public companion object {
    ...
    internal
        fun wrap(cdkObject: software.amazon.awscdk.services.apigatewayv2.AccessLogDestinationConfig):
    ...
    internal fun unwrap(wrapped: AccessLogDestinationConfig):
        software.amazon.awscdk.services.apigatewayv2.AccessLogDestinationConfig = (wrapped as
