...
public open class CfnWorkspace(
   ...
   *
   * You can specify the metadata either by providing a URL to its location in the `url` parameter,
   * or by specifying the full metadata in XML format in the `xml` parameter. Specifying both will
   * cause an error.
   *
   * Example:
   *
