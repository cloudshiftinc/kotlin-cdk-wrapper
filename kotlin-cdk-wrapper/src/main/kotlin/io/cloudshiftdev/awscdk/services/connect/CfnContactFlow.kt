...
public open class CfnContactFlow(
  ...
  public constructor(
    ...
    props: CfnContactFlowProps,
      ...
      this(software.amazon.awscdk.services.connect.CfnContactFlow(scope.let(CloudshiftdevConstructsConstruct.Companion::unwrap),
      id, props.let(CfnContactFlowProps.Companion::unwrap))
  )
