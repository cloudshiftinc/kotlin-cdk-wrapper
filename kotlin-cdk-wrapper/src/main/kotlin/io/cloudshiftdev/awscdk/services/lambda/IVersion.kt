...
public interface IVersion : IFunction {
  ...
  private class Wrapper(
    ...
    @Deprecated(message = "deprecated in CDK")
    override fun addAlias(arg0: String, arg1: AliasOptions): Alias = unwrap(this).addAlias(arg0,
        arg1.let(AliasOptions::unwrap)).let(Alias::wrap)

    @Deprecated(message = "deprecated in CDK")
    @kotlin.Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("6ff57343b4e1566ac76515fa826125e96564152d30ba0ef3d24569a9cf452484")
    override fun addAlias(arg0: String, arg1: AliasOptions.Builder.() -> Unit): Alias =
