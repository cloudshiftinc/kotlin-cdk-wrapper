 ...
 * ```
 */
public interface HttpInvokeJsonPathProps : TaskStateJsonPathBaseProps {
  /**
  ...
  /**
   * A builder for [HttpInvokeJsonPathProps]
   */
  @CdkDslMarker
  public interface Builder {
    ...
    @JvmName("c399935551f55f1132df814f784b89e6ffb27a565bc3ee743b118dd2da2331d7")
  ...
  private class BuilderImpl : Builder {
    ...
    public fun build(): software.amazon.awscdk.services.stepfunctions.tasks.HttpInvokeJsonPathProps
        = cdkBuilder.build()
  }

  private class Wrapper(
    cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.HttpInvokeJsonPathProps,
  ) : CdkObject(cdkObject),
  ...
  public companion object {
    public operator fun invoke(block: Builder.() -> Unit = {}): HttpInvokeJsonPathProps {
      val builderImpl = BuilderImpl()
      return Wrapper(builderImpl.apply(block).build())
    }

    internal
        fun wrap(cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.HttpInvokeJsonPathProps):
        HttpInvokeJsonPathProps = CdkObjectWrappers.wrap(cdkObject) as? HttpInvokeJsonPathProps ?:
        Wrapper(cdkObject)

    internal fun unwrap(wrapped: HttpInvokeJsonPathProps):
        software.amazon.awscdk.services.stepfunctions.tasks.HttpInvokeJsonPathProps = (wrapped as
        CdkObject).cdkObject as
        software.amazon.awscdk.services.stepfunctions.tasks.HttpInvokeJsonPathProps
  }
}
