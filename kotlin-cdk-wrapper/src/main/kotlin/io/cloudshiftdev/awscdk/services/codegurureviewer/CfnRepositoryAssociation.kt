 ...
 * types:
 *
 * * AWS CodeCommit - For more information, see [Create an AWS CodeCommit repository
 * association](https://docs.aws.amazon.com/codeguru/latest/reviewer-ug/create-codecommit-association.html)
 * in the *Amazon CodeGuru Reviewer User Guide* .
 * * Bitbucket - For more information, see [Create a Bitbucket repository
 * association](https://docs.aws.amazon.com/codeguru/latest/reviewer-ug/create-bitbucket-association.html)
 * in the *Amazon CodeGuru Reviewer User Guide* .
 * * GitHub Enterprise Server - For more information, see [Create a GitHub Enterprise Server
 * repository
 * association](https://docs.aws.amazon.com/codeguru/latest/reviewer-ug/create-github-enterprise-association.html)
 * in the *Amazon CodeGuru Reviewer User Guide* .
 * * S3Bucket - For more information, see [Create code reviews with GitHub
 * Actions](https://docs.aws.amazon.com/codeguru/latest/reviewer-ug/working-with-cicd.html) in the
 ...
 */
public open class CfnRepositoryAssociation(
  cdkObject: software.amazon.awscdk.services.codegurureviewer.CfnRepositoryAssociation,
  ...
  public constructor(
    ...
    props: CfnRepositoryAssociationProps,
      ...
      this(software.amazon.awscdk.services.codegurureviewer.CfnRepositoryAssociation(scope.let(CloudshiftdevConstructsConstruct.Companion::unwrap),
      id, props.let(CfnRepositoryAssociationProps.Companion::unwrap))
  )
  ...
  public companion object {
    public val CFN_RESOURCE_TYPE_NAME: String =
        software.amazon.awscdk.services.codegurureviewer.CfnRepositoryAssociation.CFN_RESOURCE_TYPE_NAME
