...
public enum class MaximumExecutionFrequency(
  ...
  TWENTY_FOUR_HOURS(software.amazon.awscdk.services.config.MaximumExecutionFrequency.TWENTY_FOUR_HOURS),
  ;

  public companion object {
    internal fun wrap(cdkObject: software.amazon.awscdk.services.config.MaximumExecutionFrequency):
        MaximumExecutionFrequency = when (cdkObject) {
    ...
    internal fun unwrap(wrapped: MaximumExecutionFrequency):
