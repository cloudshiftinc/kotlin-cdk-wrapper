...
public open class CfnFirewallRuleGroup(
  ...
  public constructor(
    scope: CloudshiftdevConstructsConstruct,
    id: String,
    props: CfnFirewallRuleGroupProps.Builder.() -> Unit,
  ) : this(scope, id, CfnFirewallRuleGroupProps(props)
  )
   ...
   * A list of the rules that you have defined.
   */
  public open fun firewallRules(vararg `value`: Any): Unit = firewallRules(`value`.toList())
