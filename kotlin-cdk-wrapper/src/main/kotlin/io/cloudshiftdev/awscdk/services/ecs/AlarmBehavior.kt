...
public enum class AlarmBehavior(
  ...
  public companion object {
    internal fun wrap(cdkObject: software.amazon.awscdk.services.ecs.AlarmBehavior): AlarmBehavior =
        when (cdkObject) {
      software.amazon.awscdk.services.ecs.AlarmBehavior.ROLLBACK_ON_ALARM ->
          AlarmBehavior.ROLLBACK_ON_ALARM
      software.amazon.awscdk.services.ecs.AlarmBehavior.FAIL_ON_ALARM -> AlarmBehavior.FAIL_ON_ALARM
    }

    internal fun unwrap(wrapped: AlarmBehavior): software.amazon.awscdk.services.ecs.AlarmBehavior =
        wrapped.cdkObject
  }
}
