 ...
 * Bucket bucket;
 * S3JsonLItemReader s3JsonLItemReader = S3JsonLItemReader.Builder.create()
 * .key("key")
 ...
 * ```
 */
public open class S3JsonLItemReader(
  cdkObject: software.amazon.awscdk.services.stepfunctions.S3JsonLItemReader,
) : CdkObject(cdkObject),
    IItemReader {
  public constructor(props: S3FileItemReaderProps) :
      this(software.amazon.awscdk.services.stepfunctions.S3JsonLItemReader(props.let(S3FileItemReaderProps.Companion::unwrap))
  )
  ...
  /**
   * A fluent builder for [io.cloudshiftdev.awscdk.services.stepfunctions.S3JsonLItemReader].
   */
  @CdkDslMarker
  ...
  private class BuilderImpl : Builder {
    private val cdkBuilder: software.amazon.awscdk.services.stepfunctions.S3JsonLItemReader.Builder
        = software.amazon.awscdk.services.stepfunctions.S3JsonLItemReader.Builder.create()
    ...
    public fun build(): software.amazon.awscdk.services.stepfunctions.S3JsonLItemReader =
        cdkBuilder.build()
  }

  public companion object {
    public operator fun invoke(block: Builder.() -> Unit = {}): S3JsonLItemReader {
      val builderImpl = BuilderImpl()
      return S3JsonLItemReader(builderImpl.apply(block).build())
    }

    internal fun wrap(cdkObject: software.amazon.awscdk.services.stepfunctions.S3JsonLItemReader):
        S3JsonLItemReader = S3JsonLItemReader(cdkObject)

    internal fun unwrap(wrapped: S3JsonLItemReader):
        software.amazon.awscdk.services.stepfunctions.S3JsonLItemReader = wrapped.cdkObject as
        software.amazon.awscdk.services.stepfunctions.S3JsonLItemReader
  }
}
