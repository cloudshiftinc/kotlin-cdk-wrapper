...
public open class CfnFeature(
  ...
  public companion object {
    public val CFN_RESOURCE_TYPE_NAME: String =
        software.amazon.awscdk.services.evidently.CfnFeature.CFN_RESOURCE_TYPE_NAME
  ...
  /**
   * A set of key-value pairs that specify users who should always be served a specific variation of
   * a feature.
   *
