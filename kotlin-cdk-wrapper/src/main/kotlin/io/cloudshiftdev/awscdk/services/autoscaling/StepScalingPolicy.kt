...
public open class StepScalingPolicy(
  ...
  public constructor(
    ...
    props: StepScalingPolicyProps,
      ...
      this(software.amazon.awscdk.services.autoscaling.StepScalingPolicy(scope.let(CloudshiftdevConstructsConstruct.Companion::unwrap),
  ...
  public companion object {
    ...
    internal fun unwrap(wrapped: StepScalingPolicy):
        software.amazon.awscdk.services.autoscaling.StepScalingPolicy = wrapped.cdkObject as
