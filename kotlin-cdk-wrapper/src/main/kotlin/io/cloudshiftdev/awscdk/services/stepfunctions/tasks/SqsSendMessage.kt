...
public open class SqsSendMessage(
  ...
  public companion object {
    public fun jsonPath(
      scope: CloudshiftdevConstructsConstruct,
      id: String,
      props: SqsSendMessageJsonPathProps,
    ): SqsSendMessage =
        software.amazon.awscdk.services.stepfunctions.tasks.SqsSendMessage.jsonPath(scope.let(CloudshiftdevConstructsConstruct.Companion::unwrap),
        id, props.let(SqsSendMessageJsonPathProps.Companion::unwrap)).let(SqsSendMessage::wrap)

    @kotlin.Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("856ed844d323cb9754f12234056bd769cd3269c266a23c5c5d77614253769196")
    public fun jsonPath(
      scope: CloudshiftdevConstructsConstruct,
      id: String,
      props: SqsSendMessageJsonPathProps.Builder.() -> Unit,
    ): SqsSendMessage = jsonPath(scope, id, SqsSendMessageJsonPathProps(props))

    public fun jsonata(
      scope: CloudshiftdevConstructsConstruct,
      id: String,
      props: SqsSendMessageJsonataProps,
    ): SqsSendMessage =
        software.amazon.awscdk.services.stepfunctions.tasks.SqsSendMessage.jsonata(scope.let(CloudshiftdevConstructsConstruct.Companion::unwrap),
        id, props.let(SqsSendMessageJsonataProps.Companion::unwrap)).let(SqsSendMessage::wrap)

    @kotlin.Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("24223561d589b778193098a24414b0959edddbd07da6d1bf8554a971efe7a269")
    public fun jsonata(
      scope: CloudshiftdevConstructsConstruct,
      id: String,
      props: SqsSendMessageJsonataProps.Builder.() -> Unit,
    ): SqsSendMessage = jsonata(scope, id, SqsSendMessageJsonataProps(props))
