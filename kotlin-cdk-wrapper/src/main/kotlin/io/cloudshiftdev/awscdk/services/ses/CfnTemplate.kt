...
public open class CfnTemplate(
   ...
   *
   * An *email template* is a type of message template that contains content that you want to reuse
   * in email messages that you send. You can specifiy the email template by providing the name or ARN
   * of an *email template* previously saved in your Amazon SES account or by providing the full
   * template content.
   *
   * Example:
   *
