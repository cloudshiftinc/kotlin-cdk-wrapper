...
public enum class HeadersReferrerPolicy(
  ...
  NO_REFERRER_WHEN_DOWNGRADE(software.amazon.awscdk.services.cloudfront.HeadersReferrerPolicy.NO_REFERRER_WHEN_DOWNGRADE),
  ORIGIN(software.amazon.awscdk.services.cloudfront.HeadersReferrerPolicy.ORIGIN),
  ORIGIN_WHEN_CROSS_ORIGIN(software.amazon.awscdk.services.cloudfront.HeadersReferrerPolicy.ORIGIN_WHEN_CROSS_ORIGIN),
  ...
  STRICT_ORIGIN_WHEN_CROSS_ORIGIN(software.amazon.awscdk.services.cloudfront.HeadersReferrerPolicy.STRICT_ORIGIN_WHEN_CROSS_ORIGIN),
  UNSAFE_URL(software.amazon.awscdk.services.cloudfront.HeadersReferrerPolicy.UNSAFE_URL),
  ;

  public companion object {
    internal fun wrap(cdkObject: software.amazon.awscdk.services.cloudfront.HeadersReferrerPolicy):
        HeadersReferrerPolicy = when (cdkObject) {
      ...
      software.amazon.awscdk.services.cloudfront.HeadersReferrerPolicy.STRICT_ORIGIN_WHEN_CROSS_ORIGIN ->
    ...
    internal fun unwrap(wrapped: HeadersReferrerPolicy):
