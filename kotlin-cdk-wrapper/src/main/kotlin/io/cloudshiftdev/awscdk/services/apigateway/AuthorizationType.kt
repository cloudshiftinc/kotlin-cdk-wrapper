...
public enum class AuthorizationType(
  ...
  public companion object {
    internal fun wrap(cdkObject: software.amazon.awscdk.services.apigateway.AuthorizationType):
        AuthorizationType = when (cdkObject) {
      software.amazon.awscdk.services.apigateway.AuthorizationType.NONE -> AuthorizationType.NONE
      software.amazon.awscdk.services.apigateway.AuthorizationType.IAM -> AuthorizationType.IAM
