...
public enum class BackupVaultEvents(
  ...
  BACKUP_JOB_COMPLETED(software.amazon.awscdk.services.backup.BackupVaultEvents.BACKUP_JOB_COMPLETED),
  BACKUP_JOB_SUCCESSFUL(software.amazon.awscdk.services.backup.BackupVaultEvents.BACKUP_JOB_SUCCESSFUL),
  ...
  RESTORE_JOB_STARTED(software.amazon.awscdk.services.backup.BackupVaultEvents.RESTORE_JOB_STARTED),
  RESTORE_JOB_COMPLETED(software.amazon.awscdk.services.backup.BackupVaultEvents.RESTORE_JOB_COMPLETED),
  RESTORE_JOB_SUCCESSFUL(software.amazon.awscdk.services.backup.BackupVaultEvents.RESTORE_JOB_SUCCESSFUL),
  ...
  COPY_JOB_SUCCESSFUL(software.amazon.awscdk.services.backup.BackupVaultEvents.COPY_JOB_SUCCESSFUL),
  COPY_JOB_FAILED(software.amazon.awscdk.services.backup.BackupVaultEvents.COPY_JOB_FAILED),
  RECOVERY_POINT_MODIFIED(software.amazon.awscdk.services.backup.BackupVaultEvents.RECOVERY_POINT_MODIFIED),
  BACKUP_PLAN_CREATED(software.amazon.awscdk.services.backup.BackupVaultEvents.BACKUP_PLAN_CREATED),
  BACKUP_PLAN_MODIFIED(software.amazon.awscdk.services.backup.BackupVaultEvents.BACKUP_PLAN_MODIFIED),
  S3_BACKUP_OBJECT_FAILED(software.amazon.awscdk.services.backup.BackupVaultEvents.S3_BACKUP_OBJECT_FAILED),
  S3_RESTORE_OBJECT_FAILED(software.amazon.awscdk.services.backup.BackupVaultEvents.S3_RESTORE_OBJECT_FAILED),
  ;

  public companion object {
    internal fun wrap(cdkObject: software.amazon.awscdk.services.backup.BackupVaultEvents):
        BackupVaultEvents = when (cdkObject) {
    ...
    internal fun unwrap(wrapped: BackupVaultEvents):
