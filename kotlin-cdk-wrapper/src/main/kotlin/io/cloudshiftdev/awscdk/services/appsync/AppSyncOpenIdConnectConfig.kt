...
public interface AppSyncOpenIdConnectConfig {
  ...
  /**
   * A builder for [AppSyncOpenIdConnectConfig]
   */
  @CdkDslMarker
  ...
  private class BuilderImpl : Builder {
    ...
    public fun build(): software.amazon.awscdk.services.appsync.AppSyncOpenIdConnectConfig =
        cdkBuilder.build()
  }

  private class Wrapper(
    cdkObject: software.amazon.awscdk.services.appsync.AppSyncOpenIdConnectConfig,
  ) : CdkObject(cdkObject),
  ...
  public companion object {
    public operator fun invoke(block: Builder.() -> Unit = {}): AppSyncOpenIdConnectConfig {
      val builderImpl = BuilderImpl()
      return Wrapper(builderImpl.apply(block).build())
    }

    internal
        fun wrap(cdkObject: software.amazon.awscdk.services.appsync.AppSyncOpenIdConnectConfig):
        AppSyncOpenIdConnectConfig = CdkObjectWrappers.wrap(cdkObject) as?
        AppSyncOpenIdConnectConfig ?: Wrapper(cdkObject)

    internal fun unwrap(wrapped: AppSyncOpenIdConnectConfig):
        software.amazon.awscdk.services.appsync.AppSyncOpenIdConnectConfig = (wrapped as
        CdkObject).cdkObject as software.amazon.awscdk.services.appsync.AppSyncOpenIdConnectConfig
  }
}
