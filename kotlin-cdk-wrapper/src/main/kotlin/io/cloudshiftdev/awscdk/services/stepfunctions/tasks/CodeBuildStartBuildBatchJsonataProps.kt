 ...
 * ```
 */
public interface CodeBuildStartBuildBatchJsonataProps : TaskStateJsonataBaseProps {
  /**
  ...
  /**
   * A builder for [CodeBuildStartBuildBatchJsonataProps]
   */
  @CdkDslMarker
  public interface Builder {
    ...
    @JvmName("f1eb4d93a8376bb49adbfd8a8abf35a2463bd57024344eeef0984397efdac684")
  ...
  private class Wrapper(
    cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.CodeBuildStartBuildBatchJsonataProps,
  ) : CdkObject(cdkObject),
  ...
  public companion object {
    ...
    internal
        fun wrap(cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.CodeBuildStartBuildBatchJsonataProps):
        CodeBuildStartBuildBatchJsonataProps = CdkObjectWrappers.wrap(cdkObject) as?
        CodeBuildStartBuildBatchJsonataProps ?: Wrapper(cdkObject)

    internal fun unwrap(wrapped: CodeBuildStartBuildBatchJsonataProps):
        software.amazon.awscdk.services.stepfunctions.tasks.CodeBuildStartBuildBatchJsonataProps =
