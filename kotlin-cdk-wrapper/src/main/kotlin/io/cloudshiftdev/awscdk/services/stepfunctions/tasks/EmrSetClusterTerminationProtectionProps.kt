...
public interface EmrSetClusterTerminationProtectionProps : TaskStateBaseProps {
  ...
  /**
   * A builder for [EmrSetClusterTerminationProtectionProps]
   */
  @CdkDslMarker
  ...
  private class Wrapper(
    cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.EmrSetClusterTerminationProtectionProps,
