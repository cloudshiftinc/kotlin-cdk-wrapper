...
public enum class DiscoveryType(
  ...
  public companion object {
    internal fun wrap(cdkObject: software.amazon.awscdk.services.servicediscovery.DiscoveryType):
        DiscoveryType = when (cdkObject) {
      software.amazon.awscdk.services.servicediscovery.DiscoveryType.API -> DiscoveryType.API
      software.amazon.awscdk.services.servicediscovery.DiscoveryType.DNS_AND_API ->
          DiscoveryType.DNS_AND_API
    }

    internal fun unwrap(wrapped: DiscoveryType):
