 ...
 * eventBridgeSchedulerCreateScheduleTaskJsonataProps =
 * EventBridgeSchedulerCreateScheduleTaskJsonataProps.builder()
 * .schedule(schedule)
 ...
 * ```
 */
public interface EventBridgeSchedulerCreateScheduleTaskJsonataProps : TaskStateJsonataBaseProps {
  /**
  ...
  /**
   * A builder for [EventBridgeSchedulerCreateScheduleTaskJsonataProps]
   */
  @CdkDslMarker
  public interface Builder {
    ...
    @JvmName("76599d26656062f6e854a79e6ec72427065c6391b7560bda72b64a2b0d20acbb")
     ...
     */
    @kotlin.Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("58fa5874d36b93f9f15fdd59af8f571acb2ac00d936e05a2700ee6f67d5eca92")
  ...
  private class Wrapper(
    cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.EventBridgeSchedulerCreateScheduleTaskJsonataProps,
  ) : CdkObject(cdkObject),
      EventBridgeSchedulerCreateScheduleTaskJsonataProps {
    /**
     * Specifies the action that EventBridge Scheduler applies to the schedule after the schedule
  ...
  public companion object {
    ...
    internal
        fun wrap(cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.EventBridgeSchedulerCreateScheduleTaskJsonataProps):
        EventBridgeSchedulerCreateScheduleTaskJsonataProps = CdkObjectWrappers.wrap(cdkObject) as?
        EventBridgeSchedulerCreateScheduleTaskJsonataProps ?: Wrapper(cdkObject)

    internal fun unwrap(wrapped: EventBridgeSchedulerCreateScheduleTaskJsonataProps):
        software.amazon.awscdk.services.stepfunctions.tasks.EventBridgeSchedulerCreateScheduleTaskJsonataProps
