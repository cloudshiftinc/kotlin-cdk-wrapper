...
public enum class TableClass(
  ...
  STANDARD_INFREQUENT_ACCESS(software.amazon.awscdk.services.dynamodb.TableClass.STANDARD_INFREQUENT_ACCESS),
  ;

  public companion object {
    internal fun wrap(cdkObject: software.amazon.awscdk.services.dynamodb.TableClass): TableClass =
        when (cdkObject) {
    ...
    internal fun unwrap(wrapped: TableClass): software.amazon.awscdk.services.dynamodb.TableClass =
        wrapped.cdkObject
  }
}
