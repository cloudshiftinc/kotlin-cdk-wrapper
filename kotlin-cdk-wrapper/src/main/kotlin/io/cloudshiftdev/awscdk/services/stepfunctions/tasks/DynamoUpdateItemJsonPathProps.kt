 ...
 * ```
 */
public interface DynamoUpdateItemJsonPathProps : TaskStateJsonPathBaseProps {
  /**
  ...
  /**
   * A builder for [DynamoUpdateItemJsonPathProps]
   */
  @CdkDslMarker
  public interface Builder {
    ...
    @JvmName("5e60a1423d66549bea3a9779e52bbc9de4ff9b63cb7f8da105bfc005939c87fb")
  ...
  private class Wrapper(
    cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.DynamoUpdateItemJsonPathProps,
  ) : CdkObject(cdkObject),
  ...
  public companion object {
    public operator fun invoke(block: Builder.() -> Unit = {}): DynamoUpdateItemJsonPathProps {
      val builderImpl = BuilderImpl()
      return Wrapper(builderImpl.apply(block).build())
    }

    internal
        fun wrap(cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.DynamoUpdateItemJsonPathProps):
        DynamoUpdateItemJsonPathProps = CdkObjectWrappers.wrap(cdkObject) as?
        DynamoUpdateItemJsonPathProps ?: Wrapper(cdkObject)

    internal fun unwrap(wrapped: DynamoUpdateItemJsonPathProps):
        software.amazon.awscdk.services.stepfunctions.tasks.DynamoUpdateItemJsonPathProps = (wrapped
