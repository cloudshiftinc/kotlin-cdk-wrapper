...
public enum class EksMachineImageType(
  ...
  public companion object {
    internal fun wrap(cdkObject: software.amazon.awscdk.services.batch.EksMachineImageType):
        EksMachineImageType = when (cdkObject) {
    ...
    internal fun unwrap(wrapped: EksMachineImageType):
