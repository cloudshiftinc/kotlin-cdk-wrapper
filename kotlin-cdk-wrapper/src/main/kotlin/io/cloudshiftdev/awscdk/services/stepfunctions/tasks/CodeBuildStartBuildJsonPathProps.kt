 ...
 * CodeBuildStartBuildJsonPathProps.builder()
 * .project(project)
 ...
 * "environmentVariablesOverrideKey", BuildEnvironmentVariable.builder()
 * .value(value)
 * // the properties below are optional
 ...
 * ```
 */
public interface CodeBuildStartBuildJsonPathProps : TaskStateJsonPathBaseProps {
  /**
  ...
  /**
   * A builder for [CodeBuildStartBuildJsonPathProps]
   */
  @CdkDslMarker
  public interface Builder {
    ...
    @JvmName("c08fcafa9888888519b6237c1315bf68b35d18d001dcf63b6c85b485b31a3b65")
  ...
  private class BuilderImpl : Builder {
    private val cdkBuilder:
        software.amazon.awscdk.services.stepfunctions.tasks.CodeBuildStartBuildJsonPathProps.Builder
        =
        software.amazon.awscdk.services.stepfunctions.tasks.CodeBuildStartBuildJsonPathProps.builder()
  ...
  private class Wrapper(
    cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.CodeBuildStartBuildJsonPathProps,
  ) : CdkObject(cdkObject),
  ...
  public companion object {
    public operator fun invoke(block: Builder.() -> Unit = {}): CodeBuildStartBuildJsonPathProps {
      val builderImpl = BuilderImpl()
      return Wrapper(builderImpl.apply(block).build())
    }

    internal
        fun wrap(cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.CodeBuildStartBuildJsonPathProps):
        CodeBuildStartBuildJsonPathProps = CdkObjectWrappers.wrap(cdkObject) as?
        CodeBuildStartBuildJsonPathProps ?: Wrapper(cdkObject)

    internal fun unwrap(wrapped: CodeBuildStartBuildJsonPathProps):
        software.amazon.awscdk.services.stepfunctions.tasks.CodeBuildStartBuildJsonPathProps =
