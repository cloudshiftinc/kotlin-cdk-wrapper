 ...
 * EmrModifyInstanceFleetByNameJsonataProps.builder()
 * .clusterId("clusterId")
 ...
 * ```
 */
public interface EmrModifyInstanceFleetByNameJsonataProps : TaskStateJsonataBaseProps {
  /**
  ...
  /**
   * A builder for [EmrModifyInstanceFleetByNameJsonataProps]
   */
  @CdkDslMarker
  public interface Builder {
    ...
    @JvmName("20ab19ee384cf8f6b1715bb2304e3ed4e4ed4fa45abbece027f3954e3077053e")
  ...
  private class BuilderImpl : Builder {
    private val cdkBuilder:
        software.amazon.awscdk.services.stepfunctions.tasks.EmrModifyInstanceFleetByNameJsonataProps.Builder
        =
        software.amazon.awscdk.services.stepfunctions.tasks.EmrModifyInstanceFleetByNameJsonataProps.builder()
    ...
    public fun build():
        software.amazon.awscdk.services.stepfunctions.tasks.EmrModifyInstanceFleetByNameJsonataProps
        = cdkBuilder.build()
  }

  private class Wrapper(
    cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.EmrModifyInstanceFleetByNameJsonataProps,
  ) : CdkObject(cdkObject),
  ...
  public companion object {
    ...
    internal
        fun wrap(cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.EmrModifyInstanceFleetByNameJsonataProps):
        EmrModifyInstanceFleetByNameJsonataProps = CdkObjectWrappers.wrap(cdkObject) as?
        EmrModifyInstanceFleetByNameJsonataProps ?: Wrapper(cdkObject)

    internal fun unwrap(wrapped: EmrModifyInstanceFleetByNameJsonataProps):
        software.amazon.awscdk.services.stepfunctions.tasks.EmrModifyInstanceFleetByNameJsonataProps
