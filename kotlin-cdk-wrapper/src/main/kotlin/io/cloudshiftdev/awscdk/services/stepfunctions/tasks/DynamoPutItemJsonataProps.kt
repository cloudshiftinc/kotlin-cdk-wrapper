 ...
 * TaskRole taskRole;
 * Timeout timeout;
 * DynamoPutItemJsonataProps dynamoPutItemJsonataProps = DynamoPutItemJsonataProps.builder()
 * .item(Map.of(
 ...
 * ```
 */
public interface DynamoPutItemJsonataProps : TaskStateJsonataBaseProps {
  /**
  ...
  /**
   * A builder for [DynamoPutItemJsonataProps]
   */
  @CdkDslMarker
  public interface Builder {
    ...
    @JvmName("edf37cf28bceedd816e9af7f23b43447f0f1d547faf92f1165f1136a132d4f2a")
  ...
  private class Wrapper(
    cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.DynamoPutItemJsonataProps,
  ) : CdkObject(cdkObject),
  ...
  public companion object {
    public operator fun invoke(block: Builder.() -> Unit = {}): DynamoPutItemJsonataProps {
      val builderImpl = BuilderImpl()
      return Wrapper(builderImpl.apply(block).build())
    }

    internal
        fun wrap(cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.DynamoPutItemJsonataProps):
        DynamoPutItemJsonataProps = CdkObjectWrappers.wrap(cdkObject) as? DynamoPutItemJsonataProps
        ?: Wrapper(cdkObject)

    internal fun unwrap(wrapped: DynamoPutItemJsonataProps):
        software.amazon.awscdk.services.stepfunctions.tasks.DynamoPutItemJsonataProps = (wrapped as
