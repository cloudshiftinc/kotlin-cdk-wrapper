...
public enum class Charset(
  ...
  public companion object {
    internal fun wrap(cdkObject: software.amazon.awscdk.services.lambda.nodejs.Charset): Charset =
        when (cdkObject) {
    ...
    internal fun unwrap(wrapped: Charset): software.amazon.awscdk.services.lambda.nodejs.Charset =
        wrapped.cdkObject
  }
}
