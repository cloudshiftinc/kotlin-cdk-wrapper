 ...
 * when entering or exiting a state and, optionally, when a condition is met. For more information, see
 * [How to Use AWS IoT
  ...
  public interface EventProperty {
    ...
    public companion object {
      ...
      internal
          ...
          EventProperty = CdkObjectWrappers.wrap(cdkObject) as EventProperty
  ...
  public interface OnEnterProperty {
    ...
    public companion object {
      ...
      internal
          ...
          OnEnterProperty = CdkObjectWrappers.wrap(cdkObject) as OnEnterProperty
