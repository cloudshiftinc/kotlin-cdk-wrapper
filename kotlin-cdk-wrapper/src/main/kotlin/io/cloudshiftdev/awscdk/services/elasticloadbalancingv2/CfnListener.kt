...
public open class CfnListener internal constructor(
   ...
   * You cannot define a condition for a default rule.
   */
  public open fun defaultActions(vararg `value`: Any): Unit = defaultActions(`value`.toList())
  ...
  public companion object {
    public val CFN_RESOURCE_TYPE_NAME: String =
        software.amazon.awscdk.services.elasticloadbalancingv2.CfnListener.CFN_RESOURCE_TYPE_NAME
