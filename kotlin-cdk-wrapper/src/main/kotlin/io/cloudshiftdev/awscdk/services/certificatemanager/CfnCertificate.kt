...
public open class CfnCertificate(
  ...
  public constructor(
    ...
    props: CfnCertificateProps,
      ...
      this(software.amazon.awscdk.services.certificatemanager.CfnCertificate(scope.let(CloudshiftdevConstructsConstruct.Companion::unwrap),
   ...
   */
  public open fun certificateExport(): String? = unwrap(this).getCertificateExport()

  /**
   * You can opt out of allowing export of your certificate by specifying the `DISABLED` option.
   */
  public open fun certificateExport(`value`: String) {
    unwrap(this).setCertificateExport(`value`)
  }
  ...
  public open fun domainValidationOptions(`value`: IResolvable) {
    unwrap(this).setDomainValidationOptions(`value`.let(IResolvable.Companion::unwrap))
  }
