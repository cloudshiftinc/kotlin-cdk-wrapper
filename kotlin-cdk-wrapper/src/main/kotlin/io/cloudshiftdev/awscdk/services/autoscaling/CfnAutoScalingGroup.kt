...
public open class CfnAutoScalingGroup internal constructor(
   ...
   * One or more lifecycle hooks to add to the Auto Scaling group before instances are launched.
   */
  public open fun lifecycleHookSpecificationList(vararg `value`: Any): Unit =
      lifecycleHookSpecificationList(`value`.toList())
   ...
   * Enables the monitoring of group metrics of an Auto Scaling group.
   */
  public open fun metricsCollection(vararg `value`: Any): Unit = metricsCollection(`value`.toList())
   ...
   * Configures an Auto Scaling group to send notifications when specified events take place.
   */
  public open fun notificationConfigurations(vararg `value`: Any): Unit =
      notificationConfigurations(`value`.toList())
   ...
   * EC2 Auto Scaling User Guide* . You can find a sample template snippet in the
   ...
   * instances and help optimize your costs. For more information, see [Auto Scaling groups with
   * multiple instance types and purchase
   * options](https://docs.aws.amazon.com/autoscaling/ec2/userguide/ec2-auto-scaling-mixed-instances-groups.html)
   * in the *Amazon EC2 Auto Scaling User Guide* .
   *
   * You can create a mixed instances policy for new and existing Auto Scaling groups. You must use
   * a launch template to configure the policy. You cannot use a launch configuration.
   *
