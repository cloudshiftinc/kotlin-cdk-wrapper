...
public open class CfnAPNSSandboxChannel(
  ...
  public constructor(
    scope: CloudshiftdevConstructsConstruct,
    id: String,
    props: CfnAPNSSandboxChannelProps.Builder.() -> Unit,
  ) : this(scope, id, CfnAPNSSandboxChannelProps(props)
  )
  ...
  private class BuilderImpl(
    ...
    private val cdkBuilder: software.amazon.awscdk.services.pinpoint.CfnAPNSSandboxChannel.Builder =
  ...
  public companion object {
    public val CFN_RESOURCE_TYPE_NAME: String =
        software.amazon.awscdk.services.pinpoint.CfnAPNSSandboxChannel.CFN_RESOURCE_TYPE_NAME
    ...
    internal fun wrap(cdkObject: software.amazon.awscdk.services.pinpoint.CfnAPNSSandboxChannel):
