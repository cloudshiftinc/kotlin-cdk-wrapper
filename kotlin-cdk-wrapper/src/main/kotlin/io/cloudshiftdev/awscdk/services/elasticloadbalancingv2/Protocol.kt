...
public enum class Protocol(
  ...
  public companion object {
    internal fun wrap(cdkObject: software.amazon.awscdk.services.elasticloadbalancingv2.Protocol):
        Protocol = when (cdkObject) {
      software.amazon.awscdk.services.elasticloadbalancingv2.Protocol.HTTP -> Protocol.HTTP
      software.amazon.awscdk.services.elasticloadbalancingv2.Protocol.HTTPS -> Protocol.HTTPS
      ...
      software.amazon.awscdk.services.elasticloadbalancingv2.Protocol.TCP_UDP -> Protocol.TCP_UDP
    }

    internal fun unwrap(wrapped: Protocol):
