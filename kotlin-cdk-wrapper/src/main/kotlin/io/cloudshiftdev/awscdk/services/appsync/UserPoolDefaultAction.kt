...
public enum class UserPoolDefaultAction(
  ...
  public companion object {
    internal fun wrap(cdkObject: software.amazon.awscdk.services.appsync.UserPoolDefaultAction):
        UserPoolDefaultAction = when (cdkObject) {
    ...
    internal fun unwrap(wrapped: UserPoolDefaultAction):
