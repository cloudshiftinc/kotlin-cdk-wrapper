 ...
 * S3StaticWebsiteOriginProps s3StaticWebsiteOriginProps = S3StaticWebsiteOriginProps.builder()
 ...
 * ```
 */
public interface S3StaticWebsiteOriginProps : HttpOriginProps {
  /**
   * A builder for [S3StaticWebsiteOriginProps]
   */
  @CdkDslMarker
  ...
  private class BuilderImpl : Builder {
    private val cdkBuilder:
        software.amazon.awscdk.services.cloudfront.origins.S3StaticWebsiteOriginProps.Builder =
        software.amazon.awscdk.services.cloudfront.origins.S3StaticWebsiteOriginProps.builder()
  ...
  private class Wrapper(
    cdkObject: software.amazon.awscdk.services.cloudfront.origins.S3StaticWebsiteOriginProps,
  ) : CdkObject(cdkObject),
  ...
  public companion object {
    public operator fun invoke(block: Builder.() -> Unit = {}): S3StaticWebsiteOriginProps {
      val builderImpl = BuilderImpl()
      return Wrapper(builderImpl.apply(block).build())
    }

    internal
        fun wrap(cdkObject: software.amazon.awscdk.services.cloudfront.origins.S3StaticWebsiteOriginProps):
        S3StaticWebsiteOriginProps = CdkObjectWrappers.wrap(cdkObject) as?
        S3StaticWebsiteOriginProps ?: Wrapper(cdkObject)

    internal fun unwrap(wrapped: S3StaticWebsiteOriginProps):
        software.amazon.awscdk.services.cloudfront.origins.S3StaticWebsiteOriginProps = (wrapped as
