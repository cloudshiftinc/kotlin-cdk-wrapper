...
public open class SageMakerUpdateEndpoint(
  ...
  public constructor(
    scope: CloudshiftdevConstructsConstruct,
    id: String,
    props: SageMakerUpdateEndpointProps.Builder.() -> Unit,
  ) : this(scope, id, SageMakerUpdateEndpointProps(props)
  )
  ...
  public companion object {
    public fun jsonPath(
      scope: CloudshiftdevConstructsConstruct,
      id: String,
      props: SageMakerUpdateEndpointJsonPathProps,
    ): SageMakerUpdateEndpoint =
        software.amazon.awscdk.services.stepfunctions.tasks.SageMakerUpdateEndpoint.jsonPath(scope.let(CloudshiftdevConstructsConstruct.Companion::unwrap),
        id,
        props.let(SageMakerUpdateEndpointJsonPathProps.Companion::unwrap)).let(SageMakerUpdateEndpoint::wrap)

    @kotlin.Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("7076a18590dff2df346920ad5700d36637e92b99d20a00cc6c2300883d6f309d")
    public fun jsonPath(
      scope: CloudshiftdevConstructsConstruct,
      id: String,
      props: SageMakerUpdateEndpointJsonPathProps.Builder.() -> Unit,
    ): SageMakerUpdateEndpoint = jsonPath(scope, id, SageMakerUpdateEndpointJsonPathProps(props))

    public fun jsonata(
      scope: CloudshiftdevConstructsConstruct,
      id: String,
      props: SageMakerUpdateEndpointJsonataProps,
    ): SageMakerUpdateEndpoint =
        software.amazon.awscdk.services.stepfunctions.tasks.SageMakerUpdateEndpoint.jsonata(scope.let(CloudshiftdevConstructsConstruct.Companion::unwrap),
        id,
        props.let(SageMakerUpdateEndpointJsonataProps.Companion::unwrap)).let(SageMakerUpdateEndpoint::wrap)

    @kotlin.Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("834dd7a9f9a2f39afe93421be473210d1be906e12276825f4b94217e725ee436")
    public fun jsonata(
      scope: CloudshiftdevConstructsConstruct,
      id: String,
      props: SageMakerUpdateEndpointJsonataProps.Builder.() -> Unit,
    ): SageMakerUpdateEndpoint = jsonata(scope, id, SageMakerUpdateEndpointJsonataProps(props))
