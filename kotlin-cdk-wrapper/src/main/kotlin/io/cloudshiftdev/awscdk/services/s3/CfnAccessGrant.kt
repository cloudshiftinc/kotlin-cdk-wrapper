 ...
 * grant, you must have an S3 Access Grants instance in the same Region as the S3 data. You can create
 * an S3 Access Grants instance using the
...
public open class CfnAccessGrant internal constructor(
   ...
   * access, is the result of appending the `Subprefix` field to the scope of the registered location.
   *
   * Example:
   *
   * ```
