...
public enum class DesyncMitigationMode(
  ...
  DEFENSIVE(software.amazon.awscdk.services.elasticloadbalancingv2.DesyncMitigationMode.DEFENSIVE),
  STRICTEST(software.amazon.awscdk.services.elasticloadbalancingv2.DesyncMitigationMode.STRICTEST),
  ;

  public companion object {
    internal
        fun wrap(cdkObject: software.amazon.awscdk.services.elasticloadbalancingv2.DesyncMitigationMode):
        DesyncMitigationMode = when (cdkObject) {
      software.amazon.awscdk.services.elasticloadbalancingv2.DesyncMitigationMode.MONITOR ->
    ...
    internal fun unwrap(wrapped: DesyncMitigationMode):
        software.amazon.awscdk.services.elasticloadbalancingv2.DesyncMitigationMode =
        wrapped.cdkObject
  }
}
