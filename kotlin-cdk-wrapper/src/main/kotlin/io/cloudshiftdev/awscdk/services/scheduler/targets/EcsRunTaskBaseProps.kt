 ...
 * ```
 */
public interface EcsRunTaskBaseProps : ScheduleTargetBaseProps {
  /**
  ...
  public interface Builder {
    ...
    @JvmName("1f885647278bbf70627064d9d998699a80cab6d8249f9dbd70d2f19c9cd67892")
  ...
  private class BuilderImpl : Builder {
    ...
    public fun build(): software.amazon.awscdk.services.scheduler.targets.EcsRunTaskBaseProps =
        cdkBuilder.build()
  }

  private class Wrapper(
    cdkObject: software.amazon.awscdk.services.scheduler.targets.EcsRunTaskBaseProps,
  ) : CdkObject(cdkObject),
      EcsRunTaskBaseProps {
    /**
     * The capacity provider strategy to use for the task.
  ...
  public companion object {
    public operator fun invoke(block: Builder.() -> Unit = {}): EcsRunTaskBaseProps {
      val builderImpl = BuilderImpl()
      return Wrapper(builderImpl.apply(block).build())
    }

    internal
        fun wrap(cdkObject: software.amazon.awscdk.services.scheduler.targets.EcsRunTaskBaseProps):
        EcsRunTaskBaseProps = CdkObjectWrappers.wrap(cdkObject) as? EcsRunTaskBaseProps ?:
        Wrapper(cdkObject)

    internal fun unwrap(wrapped: EcsRunTaskBaseProps):
        software.amazon.awscdk.services.scheduler.targets.EcsRunTaskBaseProps = (wrapped as
