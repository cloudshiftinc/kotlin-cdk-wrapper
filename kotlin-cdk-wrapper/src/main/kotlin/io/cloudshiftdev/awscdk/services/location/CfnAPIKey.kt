...
public open class CfnAPIKey(
  ...
  public interface ApiKeyRestrictionsProperty {
     ...
     * * `geo:SearchPlaceIndexForSuggestions` - Allows suggestions based on an incomplete or
     * misspelled query.
     ...
     * `["geo:GetTile"]` is not. Similarly, you cannot use `["geo:SearchPlaceIndexFor*"]` - you must
