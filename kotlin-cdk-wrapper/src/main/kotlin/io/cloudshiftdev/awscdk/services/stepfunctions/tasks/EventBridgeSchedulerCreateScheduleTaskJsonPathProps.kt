 ...
 * eventBridgeSchedulerCreateScheduleTaskJsonPathProps =
 * EventBridgeSchedulerCreateScheduleTaskJsonPathProps.builder()
 * .schedule(schedule)
 ...
 * ```
 */
public interface EventBridgeSchedulerCreateScheduleTaskJsonPathProps : TaskStateJsonPathBaseProps {
  /**
  ...
  /**
   * A builder for [EventBridgeSchedulerCreateScheduleTaskJsonPathProps]
   */
  @CdkDslMarker
  public interface Builder {
    ...
    @JvmName("05c791addac5d6d8ab791da6de4def73207b5ea1153a7e30269eaf2c89be3e69")
     ...
     */
    @kotlin.Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("e83b4078b7da8c57f20b790ad1b5071e5afa5e9c5a9ed9eed355077cb8a60922")
  ...
  private class Wrapper(
    cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.EventBridgeSchedulerCreateScheduleTaskJsonPathProps,
  ) : CdkObject(cdkObject),
      EventBridgeSchedulerCreateScheduleTaskJsonPathProps {
    /**
     * Specifies the action that EventBridge Scheduler applies to the schedule after the schedule
  ...
  public companion object {
    ...
    internal
        fun wrap(cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.EventBridgeSchedulerCreateScheduleTaskJsonPathProps):
        EventBridgeSchedulerCreateScheduleTaskJsonPathProps = CdkObjectWrappers.wrap(cdkObject) as?
        EventBridgeSchedulerCreateScheduleTaskJsonPathProps ?: Wrapper(cdkObject)

    internal fun unwrap(wrapped: EventBridgeSchedulerCreateScheduleTaskJsonPathProps):
        software.amazon.awscdk.services.stepfunctions.tasks.EventBridgeSchedulerCreateScheduleTaskJsonPathProps
