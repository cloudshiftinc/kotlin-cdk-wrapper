 ...
 * TaskRole taskRole;
 * Timeout timeout;
 * CallAwsServiceJsonPathProps callAwsServiceJsonPathProps = CallAwsServiceJsonPathProps.builder()
 * .action("action")
 ...
 */
public interface CallAwsServiceJsonPathProps : TaskStateJsonPathBaseProps {
  /**
  ...
  /**
   * A builder for [CallAwsServiceJsonPathProps]
   */
  @CdkDslMarker
  public interface Builder {
    ...
    @JvmName("07203b4a8f54b352253db97a160ac47690d73d01ffc97b24af78438c98f35e9e")
  ...
  private class Wrapper(
    cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.CallAwsServiceJsonPathProps,
  ) : CdkObject(cdkObject),
  ...
  public companion object {
    public operator fun invoke(block: Builder.() -> Unit = {}): CallAwsServiceJsonPathProps {
      val builderImpl = BuilderImpl()
      return Wrapper(builderImpl.apply(block).build())
    }

    internal
        fun wrap(cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.CallAwsServiceJsonPathProps):
        CallAwsServiceJsonPathProps = CdkObjectWrappers.wrap(cdkObject) as?
        CallAwsServiceJsonPathProps ?: Wrapper(cdkObject)

    internal fun unwrap(wrapped: CallAwsServiceJsonPathProps):
        software.amazon.awscdk.services.stepfunctions.tasks.CallAwsServiceJsonPathProps = (wrapped
