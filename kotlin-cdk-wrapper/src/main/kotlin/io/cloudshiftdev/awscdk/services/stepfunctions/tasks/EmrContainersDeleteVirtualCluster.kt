...
public open class EmrContainersDeleteVirtualCluster(
  ...
  public companion object {
    public fun jsonPath(
      scope: CloudshiftdevConstructsConstruct,
      id: String,
      props: EmrContainersDeleteVirtualClusterJsonPathProps,
    ): EmrContainersDeleteVirtualCluster =
        software.amazon.awscdk.services.stepfunctions.tasks.EmrContainersDeleteVirtualCluster.jsonPath(scope.let(CloudshiftdevConstructsConstruct.Companion::unwrap),
        id,
        props.let(EmrContainersDeleteVirtualClusterJsonPathProps.Companion::unwrap)).let(EmrContainersDeleteVirtualCluster::wrap)

    @kotlin.Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("c2ab7304a8ab8905826140d75c46dc7b7e6a6c01e0c6bf0b0791fe1d5b3effbf")
    public fun jsonPath(
      scope: CloudshiftdevConstructsConstruct,
      id: String,
      props: EmrContainersDeleteVirtualClusterJsonPathProps.Builder.() -> Unit,
    ): EmrContainersDeleteVirtualCluster = jsonPath(scope, id,
        EmrContainersDeleteVirtualClusterJsonPathProps(props))

    public fun jsonata(
      scope: CloudshiftdevConstructsConstruct,
      id: String,
      props: EmrContainersDeleteVirtualClusterJsonataProps,
    ): EmrContainersDeleteVirtualCluster =
        software.amazon.awscdk.services.stepfunctions.tasks.EmrContainersDeleteVirtualCluster.jsonata(scope.let(CloudshiftdevConstructsConstruct.Companion::unwrap),
        id,
        props.let(EmrContainersDeleteVirtualClusterJsonataProps.Companion::unwrap)).let(EmrContainersDeleteVirtualCluster::wrap)

    @kotlin.Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("cab7cd0a5c0347c505b7b4f20a9b4a5f57d75be36407962ccf795ef45b13bcd0")
    public fun jsonata(
      scope: CloudshiftdevConstructsConstruct,
      id: String,
      props: EmrContainersDeleteVirtualClusterJsonataProps.Builder.() -> Unit,
    ): EmrContainersDeleteVirtualCluster = jsonata(scope, id,
        EmrContainersDeleteVirtualClusterJsonataProps(props))
