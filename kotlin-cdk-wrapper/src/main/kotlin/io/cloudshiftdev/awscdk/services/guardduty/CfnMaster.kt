...
public open class CfnMaster(
  ...
  public constructor(
    ...
    props: CfnMasterProps,
      ...
      this(software.amazon.awscdk.services.guardduty.CfnMaster(scope.let(CloudshiftdevConstructsConstruct.Companion::unwrap),
      id, props.let(CfnMasterProps.Companion::unwrap))
  )
