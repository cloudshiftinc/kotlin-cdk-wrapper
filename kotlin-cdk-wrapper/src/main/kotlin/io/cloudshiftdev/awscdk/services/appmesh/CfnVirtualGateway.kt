 ...
 * Kubernetes service, or on an Amazon EC2 instance. Unlike a virtual node, which represents an Envoy
 * running with an application, a virtual gateway represents Envoy deployed by itself.
 *
...
public open class CfnVirtualGateway internal constructor(
  ...
  public companion object {
    public val CFN_RESOURCE_TYPE_NAME: String =
        software.amazon.awscdk.services.appmesh.CfnVirtualGateway.CFN_RESOURCE_TYPE_NAME
  ...
  public interface VirtualGatewayTlsValidationContextTrustProperty {
    ...
    /**
     * A reference to an object that represents a virtual gateway's Transport Layer Security (TLS)
