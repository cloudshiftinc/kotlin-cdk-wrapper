...
public interface CfnProjectProps {
  ...
  private class BuilderImpl : Builder {
    ...
    override fun artifacts(artifacts: CfnProject.ArtifactsProperty) {
      cdkBuilder.artifacts(artifacts.let(CfnProject.ArtifactsProperty.Companion::unwrap))
    }
    ...
    override fun buildBatchConfig(buildBatchConfig: CfnProject.ProjectBuildBatchConfigProperty) {
      cdkBuilder.buildBatchConfig(buildBatchConfig.let(CfnProject.ProjectBuildBatchConfigProperty.Companion::unwrap))
    }
    ...
    override fun cache(cache: CfnProject.ProjectCacheProperty) {
      cdkBuilder.cache(cache.let(CfnProject.ProjectCacheProperty.Companion::unwrap))
    }
    ...
    override fun environment(environment: CfnProject.EnvironmentProperty) {
      cdkBuilder.environment(environment.let(CfnProject.EnvironmentProperty.Companion::unwrap))
    }
    ...
    override fun logsConfig(logsConfig: CfnProject.LogsConfigProperty) {
      cdkBuilder.logsConfig(logsConfig.let(CfnProject.LogsConfigProperty.Companion::unwrap))
    }
    ...
    override fun source(source: CfnProject.SourceProperty) {
      cdkBuilder.source(source.let(CfnProject.SourceProperty.Companion::unwrap))
    }
    ...
    override fun triggers(triggers: CfnProject.ProjectTriggersProperty) {
      cdkBuilder.triggers(triggers.let(CfnProject.ProjectTriggersProperty.Companion::unwrap))
    }
