...
public interface ScalingInterval {
  ...
  private class Wrapper(
    override val cdkObject: software.amazon.awscdk.services.autoscaling.ScalingInterval,
  ...
  public companion object {
    ...
    internal fun unwrap(wrapped: ScalingInterval):
        software.amazon.awscdk.services.autoscaling.ScalingInterval = (wrapped as
        CdkObject).cdkObject as software.amazon.awscdk.services.autoscaling.ScalingInterval
  }
}
