...
public open class NetworkMultipleTargetGroupsEc2Service(
  cdkObject: software.amazon.awscdk.services.ecs.patterns.NetworkMultipleTargetGroupsEc2Service,
) : NetworkMultipleTargetGroupsServiceBase(cdkObject) {
  public constructor(scope: CloudshiftdevConstructsConstruct, id: String) :
      this(software.amazon.awscdk.services.ecs.patterns.NetworkMultipleTargetGroupsEc2Service(scope.let(CloudshiftdevConstructsConstruct.Companion::unwrap),
      id)
  )
  ...
  public constructor(
    ...
    props: NetworkMultipleTargetGroupsEc2ServiceProps,
      ...
      this(software.amazon.awscdk.services.ecs.patterns.NetworkMultipleTargetGroupsEc2Service(scope.let(CloudshiftdevConstructsConstruct.Companion::unwrap),
      id, props.let(NetworkMultipleTargetGroupsEc2ServiceProps.Companion::unwrap))
  )
