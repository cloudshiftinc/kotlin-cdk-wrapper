 ...
 * ```
 */
public interface EksCallJsonataProps : TaskStateJsonataBaseProps {
  /**
   * The EKS cluster.
   */
  ...
  public interface Builder {
    ...
    @JvmName("d5846457f4443ba4488434906e626eb311e86e3449e7fea4f875a340f418db39")
  ...
  private class BuilderImpl : Builder {
    ...
    public fun build(): software.amazon.awscdk.services.stepfunctions.tasks.EksCallJsonataProps =
        cdkBuilder.build()
  }

  private class Wrapper(
    cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.EksCallJsonataProps,
  ) : CdkObject(cdkObject),
      EksCallJsonataProps {
    /**
  ...
  public companion object {
    public operator fun invoke(block: Builder.() -> Unit = {}): EksCallJsonataProps {
      val builderImpl = BuilderImpl()
      return Wrapper(builderImpl.apply(block).build())
    }

    internal
        fun wrap(cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.EksCallJsonataProps):
        EksCallJsonataProps = CdkObjectWrappers.wrap(cdkObject) as? EksCallJsonataProps ?:
        Wrapper(cdkObject)

    internal fun unwrap(wrapped: EksCallJsonataProps):
        software.amazon.awscdk.services.stepfunctions.tasks.EksCallJsonataProps = (wrapped as
