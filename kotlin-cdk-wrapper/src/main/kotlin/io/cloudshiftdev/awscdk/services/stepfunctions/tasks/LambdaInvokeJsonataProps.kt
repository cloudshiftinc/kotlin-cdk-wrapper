 ...
 * ```
 */
public interface LambdaInvokeJsonataProps : TaskStateJsonataBaseProps {
  /**
  ...
  /**
   * A builder for [LambdaInvokeJsonataProps]
   */
  @CdkDslMarker
  public interface Builder {
    ...
    @JvmName("92c93248dbf9a318122a8ec118da5598c580c13d2a3b22f2dbbd6cef75cde995")
  ...
  private class BuilderImpl : Builder {
    ...
    public fun build(): software.amazon.awscdk.services.stepfunctions.tasks.LambdaInvokeJsonataProps
        = cdkBuilder.build()
  }

  private class Wrapper(
    cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.LambdaInvokeJsonataProps,
  ) : CdkObject(cdkObject),
  ...
  public companion object {
    public operator fun invoke(block: Builder.() -> Unit = {}): LambdaInvokeJsonataProps {
      val builderImpl = BuilderImpl()
      return Wrapper(builderImpl.apply(block).build())
    }

    internal
        fun wrap(cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.LambdaInvokeJsonataProps):
        LambdaInvokeJsonataProps = CdkObjectWrappers.wrap(cdkObject) as? LambdaInvokeJsonataProps ?:
        Wrapper(cdkObject)

    internal fun unwrap(wrapped: LambdaInvokeJsonataProps):
        software.amazon.awscdk.services.stepfunctions.tasks.LambdaInvokeJsonataProps = (wrapped as
        CdkObject).cdkObject as
        software.amazon.awscdk.services.stepfunctions.tasks.LambdaInvokeJsonataProps
  }
}
