 ...
 * ```
 */
public interface S3BucketOriginBaseProps : OriginProps {
  /**
   * A builder for [S3BucketOriginBaseProps]
   */
  @CdkDslMarker
  ...
  private class BuilderImpl : Builder {
    private val cdkBuilder:
        software.amazon.awscdk.services.cloudfront.origins.S3BucketOriginBaseProps.Builder =
        software.amazon.awscdk.services.cloudfront.origins.S3BucketOriginBaseProps.builder()
    ...
    public fun build(): software.amazon.awscdk.services.cloudfront.origins.S3BucketOriginBaseProps =
        cdkBuilder.build()
  }

  private class Wrapper(
    cdkObject: software.amazon.awscdk.services.cloudfront.origins.S3BucketOriginBaseProps,
  ) : CdkObject(cdkObject),
  ...
  public companion object {
    public operator fun invoke(block: Builder.() -> Unit = {}): S3BucketOriginBaseProps {
      val builderImpl = BuilderImpl()
      return Wrapper(builderImpl.apply(block).build())
    }

    internal
        fun wrap(cdkObject: software.amazon.awscdk.services.cloudfront.origins.S3BucketOriginBaseProps):
        S3BucketOriginBaseProps = CdkObjectWrappers.wrap(cdkObject) as? S3BucketOriginBaseProps ?:
        Wrapper(cdkObject)

    internal fun unwrap(wrapped: S3BucketOriginBaseProps):
        software.amazon.awscdk.services.cloudfront.origins.S3BucketOriginBaseProps = (wrapped as
        CdkObject).cdkObject as
        software.amazon.awscdk.services.cloudfront.origins.S3BucketOriginBaseProps
  }
}
