...
public open class CodeBuildStartBuild(
  cdkObject: software.amazon.awscdk.services.scheduler.targets.CodeBuildStartBuild,
) : ScheduleTargetBase(cdkObject),
    IScheduleTarget {
  public constructor(project: CloudshiftdevAwscdkServicesCodebuildIProject) :
      this(software.amazon.awscdk.services.scheduler.targets.CodeBuildStartBuild(project.let(CloudshiftdevAwscdkServicesCodebuildIProject.Companion::unwrap))
  )
  ...
  public constructor(project: CloudshiftdevAwscdkServicesCodebuildIProject,
      props: ScheduleTargetBaseProps.Builder.() -> Unit) : this(project,
      ScheduleTargetBaseProps(props)
  )

  /**
   * A fluent builder for [io.cloudshiftdev.awscdk.services.scheduler.targets.CodeBuildStartBuild].
   */
  @CdkDslMarker
  ...
  private class BuilderImpl(
    ...
    private val cdkBuilder:
        software.amazon.awscdk.services.scheduler.targets.CodeBuildStartBuild.Builder =
        software.amazon.awscdk.services.scheduler.targets.CodeBuildStartBuild.Builder.create(project)
    ...
    public fun build(): software.amazon.awscdk.services.scheduler.targets.CodeBuildStartBuild =
        cdkBuilder.build()
  }

  public companion object {
    public operator fun invoke(project: CloudshiftdevAwscdkServicesCodebuildIProject,
        block: Builder.() -> Unit = {}): CodeBuildStartBuild {
    ...
    internal
        fun wrap(cdkObject: software.amazon.awscdk.services.scheduler.targets.CodeBuildStartBuild):
        CodeBuildStartBuild = CodeBuildStartBuild(cdkObject)

    internal fun unwrap(wrapped: CodeBuildStartBuild):
        software.amazon.awscdk.services.scheduler.targets.CodeBuildStartBuild = wrapped.cdkObject as
        software.amazon.awscdk.services.scheduler.targets.CodeBuildStartBuild
  }
}
