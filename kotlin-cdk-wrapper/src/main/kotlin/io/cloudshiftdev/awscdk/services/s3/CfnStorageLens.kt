...
public open class CfnStorageLens(
  ...
  public constructor(
    scope: CloudshiftdevConstructsConstruct,
    id: String,
    props: CfnStorageLensProps.Builder.() -> Unit,
  ) : this(scope, id, CfnStorageLensProps(props)
  )
  ...
  public interface AccountLevelProperty {
    ...
    /**
     * This property contains the details of account-level advanced cost optimization metrics for S3
     * Storage Lens.
     *
    ...
    /**
     * This property contains the details of account-level advanced data protection metrics for S3
     * Storage Lens.
     *
   ...
   * CloudWatch](https://docs.aws.amazon.com/AmazonS3/latest/userguide/storage_lens_view_metrics_cloudwatch.html)
   * in the *Amazon S3 User Guide* .
   *
   * Example:
   *
  ...
  public interface S3BucketDestinationProperty {
    ...
    /**
     * This property contains the details of the encryption of the bucket destination of the Amazon
    ...
    /**
     * This property contains the details of the output schema version of the S3 Storage Lens export
     * bucket destination.
     *
    ...
    /**
     * This property contains the details of the prefix of the bucket destination of the S3 Storage
     * Lens export .
     *
    ...
    public interface Builder {
      ...
      /**
       * @param arn This property contains the details of the ARN of the bucket destination of the
      ...
      /**
       * @param outputSchemaVersion This property contains the details of the output schema version
