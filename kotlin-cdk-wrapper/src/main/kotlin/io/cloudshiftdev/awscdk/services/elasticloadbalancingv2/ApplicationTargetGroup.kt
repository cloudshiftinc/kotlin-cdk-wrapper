...
public open class ApplicationTargetGroup(
  ...
  public constructor(
    ...
    props: ApplicationTargetGroupProps,
      ...
      this(software.amazon.awscdk.services.elasticloadbalancingv2.ApplicationTargetGroup(scope.let(CloudshiftdevConstructsConstruct.Companion::unwrap),
      id, props.let(ApplicationTargetGroupProps.Companion::unwrap))
  )
  ...
  public open fun enableCookieStickiness(duration: Duration) {
    unwrap(this).enableCookieStickiness(duration.let(Duration.Companion::unwrap))
  }
  ...
  public open fun enableCookieStickiness(duration: Duration, cookieName: String) {
    unwrap(this).enableCookieStickiness(duration.let(Duration.Companion::unwrap), cookieName)
  }
  ...
  public open fun metricRequestCountPerTarget(props: MetricOptions): Metric =
      unwrap(this).metricRequestCountPerTarget(props.let(MetricOptions.Companion::unwrap)).let(Metric::wrap)
  ...
  public companion object {
    public fun fromTargetGroupAttributes(
      ...
      attrs: TargetGroupAttributes,
        ...
        software.amazon.awscdk.services.elasticloadbalancingv2.ApplicationTargetGroup.fromTargetGroupAttributes(scope.let(CloudshiftdevConstructsConstruct.Companion::unwrap),
        id, attrs.let(TargetGroupAttributes.Companion::unwrap)).let(IApplicationTargetGroup::wrap)
