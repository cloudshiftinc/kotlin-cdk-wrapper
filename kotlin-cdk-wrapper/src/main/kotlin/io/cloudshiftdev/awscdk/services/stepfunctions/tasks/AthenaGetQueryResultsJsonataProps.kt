 ...
 * ```
 */
public interface AthenaGetQueryResultsJsonataProps : TaskStateJsonataBaseProps {
  /**
  ...
  /**
   * A builder for [AthenaGetQueryResultsJsonataProps]
   */
  @CdkDslMarker
  public interface Builder {
    ...
    @JvmName("c58669549386fe0ae643f1ca300aceb5089e9e96b0797610162d4121d547cf46")
  ...
  private class Wrapper(
    cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.AthenaGetQueryResultsJsonataProps,
  ) : CdkObject(cdkObject),
  ...
  public companion object {
    public operator fun invoke(block: Builder.() -> Unit = {}): AthenaGetQueryResultsJsonataProps {
      val builderImpl = BuilderImpl()
      return Wrapper(builderImpl.apply(block).build())
    }

    internal
        fun wrap(cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.AthenaGetQueryResultsJsonataProps):
        AthenaGetQueryResultsJsonataProps = CdkObjectWrappers.wrap(cdkObject) as?
        AthenaGetQueryResultsJsonataProps ?: Wrapper(cdkObject)

    internal fun unwrap(wrapped: AthenaGetQueryResultsJsonataProps):
        software.amazon.awscdk.services.stepfunctions.tasks.AthenaGetQueryResultsJsonataProps =
