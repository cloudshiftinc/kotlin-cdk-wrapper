...
public open class CfnGuardHook(
  cdkObject: software.amazon.awscdk.services.cloudformation.CfnGuardHook,
  ...
  public constructor(
    ...
    props: CfnGuardHookProps,
      ...
      this(software.amazon.awscdk.services.cloudformation.CfnGuardHook(scope.let(CloudshiftdevConstructsConstruct.Companion::unwrap),
  ...
  @JvmName("0271a1201eb472b5a5bfdb81a382c730239219ef6c45490dee04d967ffe58dba")
   ...
   */
  @kotlin.Suppress("INAPPLICABLE_JVM_NAME")
  @JvmName("30b4fad0909ab776ee3d540976f89953ed72ee23e5a12b3419f01aa12e363866")
   ...
   */
  @kotlin.Suppress("INAPPLICABLE_JVM_NAME")
  @JvmName("833bead3ddd4deab2bf77d096f5c9d7645f13001542e07549fb2c670e0e88459")
   ...
   */
  @kotlin.Suppress("INAPPLICABLE_JVM_NAME")
  @JvmName("7141fe179490f6086ddad722e44a2f7611de63589fca49fa4c5b15af5b524268")
  ...
  /**
   * A fluent builder for [io.cloudshiftdev.awscdk.services.cloudformation.CfnGuardHook].
   */
  @CdkDslMarker
  public interface Builder {
     ...
     */
    @kotlin.Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("04e34dfd700a29a99453454bb16f457658ffe6c05198382ac90e538e72124eae")
     ...
     */
    @kotlin.Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("ad6b9aee603d77534d6ba5ec986fe7687a00b3d630afd631b1a3ef83f35740b7")
     ...
     */
    @kotlin.Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("6405938cd012f870cda1508a0a400ed1a3c9fb4248d2496b8ffe66a2b53d6987")
     ...
     */
    @kotlin.Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("a546e3d8ce9f027ba3673ee98a384b6626e4d8c5efd85f8aa0fa919a9556e7a9")
  ...
  private class BuilderImpl(
    ...
    private val cdkBuilder: software.amazon.awscdk.services.cloudformation.CfnGuardHook.Builder =
        software.amazon.awscdk.services.cloudformation.CfnGuardHook.Builder.create(scope, id)
    ...
    public fun build(): software.amazon.awscdk.services.cloudformation.CfnGuardHook =
        cdkBuilder.build()
  }

  public companion object {
    public val CFN_RESOURCE_TYPE_NAME: String =
        software.amazon.awscdk.services.cloudformation.CfnGuardHook.CFN_RESOURCE_TYPE_NAME
    ...
    internal fun wrap(cdkObject: software.amazon.awscdk.services.cloudformation.CfnGuardHook):
        CfnGuardHook = CfnGuardHook(cdkObject)
  ...
  public interface OptionsProperty {
    ...
    public interface Builder {
       ...
       */
      @kotlin.Suppress("INAPPLICABLE_JVM_NAME")
      @JvmName("1d2d6ee1e354036b4536c76fcc94366f1c645b0ff1cd43200ffc6849ed9ac01f")
    ...
    private class Wrapper(
      cdkObject: software.amazon.awscdk.services.cloudformation.CfnGuardHook.OptionsProperty,
    ) : CdkObject(cdkObject),
        OptionsProperty {
      /**
       * Specifies the S3 location where your input parameters are located.
    ...
    public companion object {
      ...
      internal
          fun wrap(cdkObject: software.amazon.awscdk.services.cloudformation.CfnGuardHook.OptionsProperty):
          OptionsProperty = CdkObjectWrappers.wrap(cdkObject) as? OptionsProperty ?:
          Wrapper(cdkObject)

      internal fun unwrap(wrapped: OptionsProperty):
          software.amazon.awscdk.services.cloudformation.CfnGuardHook.OptionsProperty = (wrapped as
  ...
  public interface S3LocationProperty {
    ...
    private class BuilderImpl : Builder {
      ...
      public fun build():
          software.amazon.awscdk.services.cloudformation.CfnGuardHook.S3LocationProperty =
          cdkBuilder.build()
    }

    private class Wrapper(
      cdkObject: software.amazon.awscdk.services.cloudformation.CfnGuardHook.S3LocationProperty,
    ) : CdkObject(cdkObject),
        S3LocationProperty {
      /**
       * Specifies the S3 path to the file containing your Guard rules or input parameters (in the
    ...
    public companion object {
      ...
      internal
          fun wrap(cdkObject: software.amazon.awscdk.services.cloudformation.CfnGuardHook.S3LocationProperty):
          S3LocationProperty = CdkObjectWrappers.wrap(cdkObject) as? S3LocationProperty ?:
          Wrapper(cdkObject)

      internal fun unwrap(wrapped: S3LocationProperty):
          software.amazon.awscdk.services.cloudformation.CfnGuardHook.S3LocationProperty = (wrapped
  ...
  public interface StackFiltersProperty {
    ...
    public interface Builder {
       ...
       */
      @kotlin.Suppress("INAPPLICABLE_JVM_NAME")
      @JvmName("657f30e39506964eb691de405f1813d678e8a217e190748e57e889d25aa8e1e3")
       ...
       */
      @kotlin.Suppress("INAPPLICABLE_JVM_NAME")
      @JvmName("19218ef601452b91279ff076b8dbb5cf3764083ef8f8a412faa80452434e7e43")
    ...
    private class BuilderImpl : Builder {
      ...
      public fun build():
          software.amazon.awscdk.services.cloudformation.CfnGuardHook.StackFiltersProperty =
          cdkBuilder.build()
    }

    private class Wrapper(
      cdkObject: software.amazon.awscdk.services.cloudformation.CfnGuardHook.StackFiltersProperty,
    ) : CdkObject(cdkObject),
    ...
    public companion object {
      ...
      internal
          fun wrap(cdkObject: software.amazon.awscdk.services.cloudformation.CfnGuardHook.StackFiltersProperty):
  ...
  public interface StackNamesProperty {
    ...
    private class BuilderImpl : Builder {
      private val cdkBuilder:
          software.amazon.awscdk.services.cloudformation.CfnGuardHook.StackNamesProperty.Builder =
          software.amazon.awscdk.services.cloudformation.CfnGuardHook.StackNamesProperty.builder()
      ...
      public fun build():
          software.amazon.awscdk.services.cloudformation.CfnGuardHook.StackNamesProperty =
          cdkBuilder.build()
    }

    private class Wrapper(
      cdkObject: software.amazon.awscdk.services.cloudformation.CfnGuardHook.StackNamesProperty,
    ) : CdkObject(cdkObject),
        StackNamesProperty {
      /**
       * The stack names to exclude.
    ...
    public companion object {
      ...
      internal
          fun wrap(cdkObject: software.amazon.awscdk.services.cloudformation.CfnGuardHook.StackNamesProperty):
          StackNamesProperty = CdkObjectWrappers.wrap(cdkObject) as? StackNamesProperty ?:
          Wrapper(cdkObject)

      internal fun unwrap(wrapped: StackNamesProperty):
          software.amazon.awscdk.services.cloudformation.CfnGuardHook.StackNamesProperty = (wrapped
          as CdkObject).cdkObject as
          software.amazon.awscdk.services.cloudformation.CfnGuardHook.StackNamesProperty
    }
  }
  ...
  public interface StackRolesProperty {
    ...
    private class BuilderImpl : Builder {
      private val cdkBuilder:
          software.amazon.awscdk.services.cloudformation.CfnGuardHook.StackRolesProperty.Builder =
          software.amazon.awscdk.services.cloudformation.CfnGuardHook.StackRolesProperty.builder()
      ...
      public fun build():
          software.amazon.awscdk.services.cloudformation.CfnGuardHook.StackRolesProperty =
          cdkBuilder.build()
    }

    private class Wrapper(
      cdkObject: software.amazon.awscdk.services.cloudformation.CfnGuardHook.StackRolesProperty,
    ) : CdkObject(cdkObject),
        StackRolesProperty {
      /**
       * The IAM role ARNs for stacks you want to exclude.
    ...
    public companion object {
      ...
      internal
          fun wrap(cdkObject: software.amazon.awscdk.services.cloudformation.CfnGuardHook.StackRolesProperty):
          StackRolesProperty = CdkObjectWrappers.wrap(cdkObject) as? StackRolesProperty ?:
          Wrapper(cdkObject)

      internal fun unwrap(wrapped: StackRolesProperty):
          software.amazon.awscdk.services.cloudformation.CfnGuardHook.StackRolesProperty = (wrapped
          as CdkObject).cdkObject as
          software.amazon.awscdk.services.cloudformation.CfnGuardHook.StackRolesProperty
    }
  }
  ...
  public interface TargetFiltersProperty {
    ...
    private class BuilderImpl : Builder {
      private val cdkBuilder:
          software.amazon.awscdk.services.cloudformation.CfnGuardHook.TargetFiltersProperty.Builder
          =
          software.amazon.awscdk.services.cloudformation.CfnGuardHook.TargetFiltersProperty.builder()
    ...
    private class Wrapper(
      cdkObject: software.amazon.awscdk.services.cloudformation.CfnGuardHook.TargetFiltersProperty,
    ) : CdkObject(cdkObject),
    ...
    public companion object {
      ...
      internal
          fun wrap(cdkObject: software.amazon.awscdk.services.cloudformation.CfnGuardHook.TargetFiltersProperty):
