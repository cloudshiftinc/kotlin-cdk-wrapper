...
public open class DatabaseInstanceEngine(
  ...
  public companion object {
    ...
    public fun mariaDb(props: MariaDbInstanceEngineProps): IInstanceEngine =
        software.amazon.awscdk.services.rds.DatabaseInstanceEngine.mariaDb(props.let(MariaDbInstanceEngineProps.Companion::unwrap)).let(IInstanceEngine::wrap)
    ...
    public fun mysql(props: MySqlInstanceEngineProps): IInstanceEngine =
        software.amazon.awscdk.services.rds.DatabaseInstanceEngine.mysql(props.let(MySqlInstanceEngineProps.Companion::unwrap)).let(IInstanceEngine::wrap)
    ...
    public fun oracleEe(props: OracleEeInstanceEngineProps): IInstanceEngine =
        software.amazon.awscdk.services.rds.DatabaseInstanceEngine.oracleEe(props.let(OracleEeInstanceEngineProps.Companion::unwrap)).let(IInstanceEngine::wrap)
    ...
    public fun oracleEeCdb(props: OracleEeCdbInstanceEngineProps): IInstanceEngine =
        software.amazon.awscdk.services.rds.DatabaseInstanceEngine.oracleEeCdb(props.let(OracleEeCdbInstanceEngineProps.Companion::unwrap)).let(IInstanceEngine::wrap)
    ...
    public fun oracleSe2(props: OracleSe2InstanceEngineProps): IInstanceEngine =
        software.amazon.awscdk.services.rds.DatabaseInstanceEngine.oracleSe2(props.let(OracleSe2InstanceEngineProps.Companion::unwrap)).let(IInstanceEngine::wrap)
    ...
    public fun oracleSe2Cdb(props: OracleSe2CdbInstanceEngineProps): IInstanceEngine =
        software.amazon.awscdk.services.rds.DatabaseInstanceEngine.oracleSe2Cdb(props.let(OracleSe2CdbInstanceEngineProps.Companion::unwrap)).let(IInstanceEngine::wrap)
    ...
    public fun postgres(props: PostgresInstanceEngineProps): IInstanceEngine =
        software.amazon.awscdk.services.rds.DatabaseInstanceEngine.postgres(props.let(PostgresInstanceEngineProps.Companion::unwrap)).let(IInstanceEngine::wrap)
    ...
    public fun sqlServerEe(props: SqlServerEeInstanceEngineProps): IInstanceEngine =
        software.amazon.awscdk.services.rds.DatabaseInstanceEngine.sqlServerEe(props.let(SqlServerEeInstanceEngineProps.Companion::unwrap)).let(IInstanceEngine::wrap)
    ...
    public fun sqlServerEx(props: SqlServerExInstanceEngineProps): IInstanceEngine =
        software.amazon.awscdk.services.rds.DatabaseInstanceEngine.sqlServerEx(props.let(SqlServerExInstanceEngineProps.Companion::unwrap)).let(IInstanceEngine::wrap)
    ...
    public fun sqlServerSe(props: SqlServerSeInstanceEngineProps): IInstanceEngine =
        software.amazon.awscdk.services.rds.DatabaseInstanceEngine.sqlServerSe(props.let(SqlServerSeInstanceEngineProps.Companion::unwrap)).let(IInstanceEngine::wrap)
    ...
    public fun sqlServerWeb(props: SqlServerWebInstanceEngineProps): IInstanceEngine =
        software.amazon.awscdk.services.rds.DatabaseInstanceEngine.sqlServerWeb(props.let(SqlServerWebInstanceEngineProps.Companion::unwrap)).let(IInstanceEngine::wrap)
