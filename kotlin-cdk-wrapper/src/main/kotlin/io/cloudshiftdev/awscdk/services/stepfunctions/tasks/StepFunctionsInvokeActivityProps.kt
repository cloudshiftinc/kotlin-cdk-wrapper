...
import io.cloudshiftdev.awscdk.services.stepfunctions.JsonataStateOptions
 ...
 * ```
 */
public interface StepFunctionsInvokeActivityProps : TaskStateBaseProps, JsonataStateOptions {
  /**
