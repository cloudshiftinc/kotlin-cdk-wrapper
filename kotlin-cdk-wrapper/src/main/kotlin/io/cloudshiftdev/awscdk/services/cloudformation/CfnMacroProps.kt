...
public interface CfnMacroProps {
  ...
  private class BuilderImpl : Builder {
    private val cdkBuilder: software.amazon.awscdk.services.cloudformation.CfnMacroProps.Builder =
    ...
    public fun build(): software.amazon.awscdk.services.cloudformation.CfnMacroProps =
        cdkBuilder.build()
  }
  ...
  public companion object {
    ...
    internal fun wrap(cdkObject: software.amazon.awscdk.services.cloudformation.CfnMacroProps):
        CfnMacroProps = CdkObjectWrappers.wrap(cdkObject) as? CfnMacroProps ?: Wrapper(cdkObject)

    internal fun unwrap(wrapped: CfnMacroProps):
        software.amazon.awscdk.services.cloudformation.CfnMacroProps = (wrapped as
        CdkObject).cdkObject as software.amazon.awscdk.services.cloudformation.CfnMacroProps
  }
}
