...
public enum class HealthCheckProtocol(
  ...
  public companion object {
    internal
        fun wrap(cdkObject: software.amazon.awscdk.services.globalaccelerator.HealthCheckProtocol):
        HealthCheckProtocol = when (cdkObject) {
    ...
    internal fun unwrap(wrapped: HealthCheckProtocol):
