...
public enum class SuppressionReasons(
  ...
  BOUNCES_AND_COMPLAINTS(software.amazon.awscdk.services.ses.SuppressionReasons.BOUNCES_AND_COMPLAINTS),
  ...
  public companion object {
    internal fun wrap(cdkObject: software.amazon.awscdk.services.ses.SuppressionReasons):
        SuppressionReasons = when (cdkObject) {
    ...
    internal fun unwrap(wrapped: SuppressionReasons):
