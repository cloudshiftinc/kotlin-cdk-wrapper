...
public enum class AccessKeyStatus(
  ...
  public companion object {
    internal fun wrap(cdkObject: software.amazon.awscdk.services.iam.AccessKeyStatus):
        AccessKeyStatus = when (cdkObject) {
      software.amazon.awscdk.services.iam.AccessKeyStatus.ACTIVE -> AccessKeyStatus.ACTIVE
      software.amazon.awscdk.services.iam.AccessKeyStatus.INACTIVE -> AccessKeyStatus.INACTIVE
    }

    internal fun unwrap(wrapped: AccessKeyStatus):
