 ...
 * ```
 */
public interface CodeBuildStartBuildJsonataProps : TaskStateJsonataBaseProps {
  /**
  ...
  /**
   * A builder for [CodeBuildStartBuildJsonataProps]
   */
  @CdkDslMarker
  public interface Builder {
    ...
    @JvmName("06e372c612125c8c7187efbeb85ccf546037cd707bd51424bbbe134b1bccb8b6")
  ...
  private class BuilderImpl : Builder {
    ...
    public fun build():
        software.amazon.awscdk.services.stepfunctions.tasks.CodeBuildStartBuildJsonataProps =
        cdkBuilder.build()
  }

  private class Wrapper(
    cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.CodeBuildStartBuildJsonataProps,
  ) : CdkObject(cdkObject),
  ...
  public companion object {
    public operator fun invoke(block: Builder.() -> Unit = {}): CodeBuildStartBuildJsonataProps {
      val builderImpl = BuilderImpl()
      return Wrapper(builderImpl.apply(block).build())
    }

    internal
        fun wrap(cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.CodeBuildStartBuildJsonataProps):
        CodeBuildStartBuildJsonataProps = CdkObjectWrappers.wrap(cdkObject) as?
        CodeBuildStartBuildJsonataProps ?: Wrapper(cdkObject)

    internal fun unwrap(wrapped: CodeBuildStartBuildJsonataProps):
        software.amazon.awscdk.services.stepfunctions.tasks.CodeBuildStartBuildJsonataProps =
