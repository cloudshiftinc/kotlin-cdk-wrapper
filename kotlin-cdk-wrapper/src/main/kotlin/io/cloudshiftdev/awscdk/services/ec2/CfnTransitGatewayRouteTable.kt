...
public open class CfnTransitGatewayRouteTable(
  ...
  public constructor(
    ...
    props: CfnTransitGatewayRouteTableProps,
      ...
      this(software.amazon.awscdk.services.ec2.CfnTransitGatewayRouteTable(scope.let(CloudshiftdevConstructsConstruct.Companion::unwrap),
      id, props.let(CfnTransitGatewayRouteTableProps.Companion::unwrap))
  )
