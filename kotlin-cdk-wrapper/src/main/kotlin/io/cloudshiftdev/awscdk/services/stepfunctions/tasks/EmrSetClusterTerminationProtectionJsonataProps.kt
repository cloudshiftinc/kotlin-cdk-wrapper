 ...
 * EmrSetClusterTerminationProtectionJsonataProps.builder()
 * .clusterId("clusterId")
 ...
 * ```
 */
public interface EmrSetClusterTerminationProtectionJsonataProps : TaskStateJsonataBaseProps {
  /**
  ...
  /**
   * A builder for [EmrSetClusterTerminationProtectionJsonataProps]
   */
  @CdkDslMarker
  public interface Builder {
    ...
    @JvmName("d612bf0a724ab46fa89c6fb6c7e3f22d32a2d09cb31d3899af5e4afb221053c7")
  ...
  private class Wrapper(
    cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.EmrSetClusterTerminationProtectionJsonataProps,
  ) : CdkObject(cdkObject),
  ...
  public companion object {
    ...
    internal
        fun wrap(cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.EmrSetClusterTerminationProtectionJsonataProps):
        EmrSetClusterTerminationProtectionJsonataProps = CdkObjectWrappers.wrap(cdkObject) as?
        EmrSetClusterTerminationProtectionJsonataProps ?: Wrapper(cdkObject)

    internal fun unwrap(wrapped: EmrSetClusterTerminationProtectionJsonataProps):
        software.amazon.awscdk.services.stepfunctions.tasks.EmrSetClusterTerminationProtectionJsonataProps
