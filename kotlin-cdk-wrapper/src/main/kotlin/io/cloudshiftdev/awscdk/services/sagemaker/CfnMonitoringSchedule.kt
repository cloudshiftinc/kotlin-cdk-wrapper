 ...
 * regularly starts SageMaker processing Jobs to monitor the data captured for a SageMaker endpoint.
 *
 * Example:
 *
 * ```
...
public open class CfnMonitoringSchedule internal constructor(
  ...
  public companion object {
    public val CFN_RESOURCE_TYPE_NAME: String =
        software.amazon.awscdk.services.sagemaker.CfnMonitoringSchedule.CFN_RESOURCE_TYPE_NAME
