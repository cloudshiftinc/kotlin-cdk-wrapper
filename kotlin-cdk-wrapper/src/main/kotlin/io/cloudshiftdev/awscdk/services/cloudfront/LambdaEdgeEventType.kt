...
public enum class LambdaEdgeEventType(
  ...
  public companion object {
    internal fun wrap(cdkObject: software.amazon.awscdk.services.cloudfront.LambdaEdgeEventType):
        LambdaEdgeEventType = when (cdkObject) {
    ...
    internal fun unwrap(wrapped: LambdaEdgeEventType):
