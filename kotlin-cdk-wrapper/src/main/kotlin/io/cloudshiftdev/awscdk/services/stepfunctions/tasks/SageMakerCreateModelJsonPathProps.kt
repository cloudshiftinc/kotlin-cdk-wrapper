 ...
 * SageMakerCreateModelJsonPathProps.builder()
 * .modelName("modelName")
 ...
 */
public interface SageMakerCreateModelJsonPathProps : TaskStateJsonPathBaseProps {
  /**
  ...
  /**
   * A builder for [SageMakerCreateModelJsonPathProps]
   */
  @CdkDslMarker
  public interface Builder {
    ...
    @JvmName("c54ce13bd16d6ba3e9d4f19c9c89be76cfb9eb1c60472bd10669a524e85fa738")
     ...
     */
    @kotlin.Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("0973770bc43a7d0e24f9f959e345400110a1e4f1bb3d686c6b637ab803bb98ea")
  ...
  private class BuilderImpl : Builder {
    private val cdkBuilder:
        software.amazon.awscdk.services.stepfunctions.tasks.SageMakerCreateModelJsonPathProps.Builder
        =
        software.amazon.awscdk.services.stepfunctions.tasks.SageMakerCreateModelJsonPathProps.builder()
  ...
  private class Wrapper(
    cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.SageMakerCreateModelJsonPathProps,
  ) : CdkObject(cdkObject),
  ...
  public companion object {
    public operator fun invoke(block: Builder.() -> Unit = {}): SageMakerCreateModelJsonPathProps {
      val builderImpl = BuilderImpl()
      return Wrapper(builderImpl.apply(block).build())
    }

    internal
        fun wrap(cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.SageMakerCreateModelJsonPathProps):
        SageMakerCreateModelJsonPathProps = CdkObjectWrappers.wrap(cdkObject) as?
        SageMakerCreateModelJsonPathProps ?: Wrapper(cdkObject)

    internal fun unwrap(wrapped: SageMakerCreateModelJsonPathProps):
        software.amazon.awscdk.services.stepfunctions.tasks.SageMakerCreateModelJsonPathProps =
