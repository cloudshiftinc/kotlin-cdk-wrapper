...
public enum class Visibility(
  ...
  public companion object {
    internal fun wrap(cdkObject: software.amazon.awscdk.services.appsync.Visibility): Visibility =
        when (cdkObject) {
    ...
    internal fun unwrap(wrapped: Visibility): software.amazon.awscdk.services.appsync.Visibility =
        wrapped.cdkObject
  }
}
