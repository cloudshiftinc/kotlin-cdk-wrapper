...
public open class CfnRecordSetGroup internal constructor(
   ...
   * A complex type that contains one `RecordSet` element for each record that you want to create.
   */
  public open fun recordSets(vararg `value`: Any): Unit = recordSets(`value`.toList())
  ...
  public interface CidrRoutingConfigProperty {
    ...
    public companion object {
      ...
      internal
          ...
          CidrRoutingConfigProperty = CdkObjectWrappers.wrap(cdkObject) as CidrRoutingConfigProperty
  ...
  public interface RecordSetProperty {
    ...
    public companion object {
      ...
      internal
          ...
          RecordSetProperty = CdkObjectWrappers.wrap(cdkObject) as RecordSetProperty
