...
/**
 * Properties for calling an AWS service's API action using JSONata from your state machine across
 * regions.
 *
 * Example:
 *
 ...
 * ```
 */
public interface EmrCreateClusterJsonataProps : TaskStateJsonataBaseProps {
  /**
  ...
  /**
   * A builder for [EmrCreateClusterJsonataProps]
   */
  @CdkDslMarker
  public interface Builder {
    ...
    @JvmName("08c0298e499703b78ba5c42f3f7038b49dce40fdf9c631d2811db675f78f4605")
     ...
     */
    @kotlin.Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("10a4984565f0dac1ee77afa9d0e1dd91fa3375047fdf8178d6b592a20aa01d93")
     ...
     */
    @kotlin.Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("cff1640923e86a81047aac7ddbca86f728ad4ad920a4b0305d8268de0a9cc341")
    public
  ...
  private class Wrapper(
    cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.EmrCreateClusterJsonataProps,
  ) : CdkObject(cdkObject),
  ...
  public companion object {
    public operator fun invoke(block: Builder.() -> Unit = {}): EmrCreateClusterJsonataProps {
      val builderImpl = BuilderImpl()
      return Wrapper(builderImpl.apply(block).build())
    }

    internal
        fun wrap(cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.EmrCreateClusterJsonataProps):
        EmrCreateClusterJsonataProps = CdkObjectWrappers.wrap(cdkObject) as?
        EmrCreateClusterJsonataProps ?: Wrapper(cdkObject)

    internal fun unwrap(wrapped: EmrCreateClusterJsonataProps):
        software.amazon.awscdk.services.stepfunctions.tasks.EmrCreateClusterJsonataProps = (wrapped
