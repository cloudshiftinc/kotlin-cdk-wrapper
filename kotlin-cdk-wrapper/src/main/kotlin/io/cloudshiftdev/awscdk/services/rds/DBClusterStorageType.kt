...
public enum class DBClusterStorageType(
  ...
  public companion object {
    internal fun wrap(cdkObject: software.amazon.awscdk.services.rds.DBClusterStorageType):
        DBClusterStorageType = when (cdkObject) {
      software.amazon.awscdk.services.rds.DBClusterStorageType.AURORA -> DBClusterStorageType.AURORA
      software.amazon.awscdk.services.rds.DBClusterStorageType.AURORA_IOPT1 ->
          DBClusterStorageType.AURORA_IOPT1
    }

    internal fun unwrap(wrapped: DBClusterStorageType):
