...
public enum class DynamoConsumedCapacity(
  private val cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.DynamoConsumedCapacity,
) {
  ...
  public companion object {
    internal
        fun wrap(cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.DynamoConsumedCapacity):
        DynamoConsumedCapacity = when (cdkObject) {
      software.amazon.awscdk.services.stepfunctions.tasks.DynamoConsumedCapacity.INDEXES ->
    ...
    internal fun unwrap(wrapped: DynamoConsumedCapacity):
