...
public open class CodeBuildStartBuild(
  ...
  public constructor(
    ...
    props: CodeBuildStartBuildProps,
      ...
      this(software.amazon.awscdk.services.stepfunctions.tasks.CodeBuildStartBuild(scope.let(CloudshiftdevConstructsConstruct.Companion::unwrap),
      id, props.let(CodeBuildStartBuildProps.Companion::unwrap))
  )
  ...
  public companion object {
    public fun jsonPath(
      ...
      props: CodeBuildStartBuildJsonPathProps,
        ...
        software.amazon.awscdk.services.stepfunctions.tasks.CodeBuildStartBuild.jsonPath(scope.let(CloudshiftdevConstructsConstruct.Companion::unwrap),
        id,
        props.let(CodeBuildStartBuildJsonPathProps.Companion::unwrap)).let(CodeBuildStartBuild::wrap)

    @kotlin.Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("c64819535284b4b4022f2b6820c8853ea824c6fd0426d5a9a80cba31cd1e393a")
    public fun jsonPath(
      scope: CloudshiftdevConstructsConstruct,
      id: String,
      props: CodeBuildStartBuildJsonPathProps.Builder.() -> Unit,
    ): CodeBuildStartBuild = jsonPath(scope, id, CodeBuildStartBuildJsonPathProps(props))
    ...
    public fun jsonata(
      ...
      props: CodeBuildStartBuildJsonataProps,
        ...
        software.amazon.awscdk.services.stepfunctions.tasks.CodeBuildStartBuild.jsonata(scope.let(CloudshiftdevConstructsConstruct.Companion::unwrap),
        id,
        props.let(CodeBuildStartBuildJsonataProps.Companion::unwrap)).let(CodeBuildStartBuild::wrap)

    @kotlin.Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("27ab5de7e178a76220bef733aafa0574093990d5a513cbc0e3fdd856f5a81413")
    public fun jsonata(
      scope: CloudshiftdevConstructsConstruct,
      id: String,
      props: CodeBuildStartBuildJsonataProps.Builder.() -> Unit,
    ): CodeBuildStartBuild = jsonata(scope, id, CodeBuildStartBuildJsonataProps(props))
