 ...
 * ```
 */
public interface SageMakerStartPipelineExecutionProps : ScheduleTargetBaseProps {
  /**
   ...
   */
  public fun pipelineParameterList(): List<SageMakerPipelineParameter> =
      unwrap(this).getPipelineParameterList()?.map(SageMakerPipelineParameter::wrap) ?: emptyList()

  /**
   * A builder for [SageMakerStartPipelineExecutionProps]
   */
  @CdkDslMarker
  ...
  private class Wrapper(
    cdkObject: software.amazon.awscdk.services.scheduler.targets.SageMakerStartPipelineExecutionProps,
  ) : CdkObject(cdkObject),
     ...
     * [Documentation](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-scheduler-schedule-sagemakerpipelineparameters.html#cfn-scheduler-schedule-sagemakerpipelineparameters-pipelineparameterlist)
     */
    override fun pipelineParameterList(): List<SageMakerPipelineParameter> =
        unwrap(this).getPipelineParameterList()?.map(SageMakerPipelineParameter::wrap) ?:
        emptyList()
  ...
  public companion object {
    ...
    internal
        fun wrap(cdkObject: software.amazon.awscdk.services.scheduler.targets.SageMakerStartPipelineExecutionProps):
        SageMakerStartPipelineExecutionProps = CdkObjectWrappers.wrap(cdkObject) as?
        SageMakerStartPipelineExecutionProps ?: Wrapper(cdkObject)

    internal fun unwrap(wrapped: SageMakerStartPipelineExecutionProps):
        software.amazon.awscdk.services.scheduler.targets.SageMakerStartPipelineExecutionProps =
