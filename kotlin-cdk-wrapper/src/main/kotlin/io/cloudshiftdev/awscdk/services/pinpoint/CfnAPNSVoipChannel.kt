 ...
 */
public open class CfnAPNSVoipChannel(
  cdkObject: software.amazon.awscdk.services.pinpoint.CfnAPNSVoipChannel,
  ...
  public constructor(
    ...
    props: CfnAPNSVoipChannelProps,
      ...
      this(software.amazon.awscdk.services.pinpoint.CfnAPNSVoipChannel(scope.let(CloudshiftdevConstructsConstruct.Companion::unwrap),
      id, props.let(CfnAPNSVoipChannelProps.Companion::unwrap))
  )

  public constructor(
    scope: CloudshiftdevConstructsConstruct,
    id: String,
    props: CfnAPNSVoipChannelProps.Builder.() -> Unit,
  ) : this(scope, id, CfnAPNSVoipChannelProps(props)
  )
  ...
  /**
   * A fluent builder for [io.cloudshiftdev.awscdk.services.pinpoint.CfnAPNSVoipChannel].
   */
  @CdkDslMarker
  ...
  private class BuilderImpl(
    ...
    public fun build(): software.amazon.awscdk.services.pinpoint.CfnAPNSVoipChannel =
        cdkBuilder.build()
  }

  public companion object {
    public val CFN_RESOURCE_TYPE_NAME: String =
        software.amazon.awscdk.services.pinpoint.CfnAPNSVoipChannel.CFN_RESOURCE_TYPE_NAME
    ...
    public operator fun invoke(
      ...
      return CfnAPNSVoipChannel(builderImpl.apply(block).build())
    }

    internal fun wrap(cdkObject: software.amazon.awscdk.services.pinpoint.CfnAPNSVoipChannel):
        CfnAPNSVoipChannel = CfnAPNSVoipChannel(cdkObject)

    internal fun unwrap(wrapped: CfnAPNSVoipChannel):
        software.amazon.awscdk.services.pinpoint.CfnAPNSVoipChannel = wrapped.cdkObject as
        software.amazon.awscdk.services.pinpoint.CfnAPNSVoipChannel
  }
}
