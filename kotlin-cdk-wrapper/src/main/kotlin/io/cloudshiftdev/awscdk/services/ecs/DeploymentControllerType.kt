...
public enum class DeploymentControllerType(
  ...
  public companion object {
    internal fun wrap(cdkObject: software.amazon.awscdk.services.ecs.DeploymentControllerType):
        DeploymentControllerType = when (cdkObject) {
    ...
    internal fun unwrap(wrapped: DeploymentControllerType):
