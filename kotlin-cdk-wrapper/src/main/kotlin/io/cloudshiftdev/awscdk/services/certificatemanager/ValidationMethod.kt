...
public enum class ValidationMethod(
  ...
  public companion object {
    internal
        fun wrap(cdkObject: software.amazon.awscdk.services.certificatemanager.ValidationMethod):
        ValidationMethod = when (cdkObject) {
    ...
    internal fun unwrap(wrapped: ValidationMethod):
