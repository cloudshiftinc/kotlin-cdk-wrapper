 ...
 * ```
 */
public interface EcsRunTaskJsonPathProps : TaskStateJsonPathBaseProps {
  /**
  ...
  /**
   * A builder for [EcsRunTaskJsonPathProps]
   */
  @CdkDslMarker
  public interface Builder {
    ...
    @JvmName("cc1e35f0c2c67825349a0a1ed82df5caecc22e050cc505f6cc1feb8a6ebba35f")
     ...
     */
    @kotlin.Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("13dbe78da3df31d716febcd8dd184ae4dd53c9c686e9832f68524524c69115f3")
  ...
  private class BuilderImpl : Builder {
    ...
    public fun build(): software.amazon.awscdk.services.stepfunctions.tasks.EcsRunTaskJsonPathProps
        = cdkBuilder.build()
  }

  private class Wrapper(
    cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.EcsRunTaskJsonPathProps,
  ) : CdkObject(cdkObject),
  ...
  public companion object {
    public operator fun invoke(block: Builder.() -> Unit = {}): EcsRunTaskJsonPathProps {
      val builderImpl = BuilderImpl()
      return Wrapper(builderImpl.apply(block).build())
    }

    internal
        fun wrap(cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.EcsRunTaskJsonPathProps):
        EcsRunTaskJsonPathProps = CdkObjectWrappers.wrap(cdkObject) as? EcsRunTaskJsonPathProps ?:
        Wrapper(cdkObject)

    internal fun unwrap(wrapped: EcsRunTaskJsonPathProps):
        software.amazon.awscdk.services.stepfunctions.tasks.EcsRunTaskJsonPathProps = (wrapped as
