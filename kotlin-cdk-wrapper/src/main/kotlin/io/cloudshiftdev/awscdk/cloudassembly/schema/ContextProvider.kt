...
public enum class ContextProvider(
  ...
  CC_API_PROVIDER(software.amazon.awscdk.cloudassembly.schema.ContextProvider.CC_API_PROVIDER),
  ...
  public companion object {
    internal fun wrap(cdkObject: software.amazon.awscdk.cloudassembly.schema.ContextProvider):
      ...
      software.amazon.awscdk.cloudassembly.schema.ContextProvider.CC_API_PROVIDER ->
