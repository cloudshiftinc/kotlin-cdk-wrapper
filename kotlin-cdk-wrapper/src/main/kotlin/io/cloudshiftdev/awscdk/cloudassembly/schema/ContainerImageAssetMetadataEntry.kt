...
public interface ContainerImageAssetMetadataEntry {
  ...
  public fun imageNameParameter(): String? = unwrap(this).getImageNameParameter()
  ...
  public interface Builder {
    ...
    @Deprecated(message = "deprecated in CDK")
    public fun imageNameParameter(imageNameParameter: String)
  ...
  private class BuilderImpl : Builder {
    ...
    @Deprecated(message = "deprecated in CDK")
    override fun imageNameParameter(imageNameParameter: String) {
      cdkBuilder.imageNameParameter(imageNameParameter)
    }
  ...
  private class Wrapper(
    ...
    @Deprecated(message = "deprecated in CDK")
    override fun imageNameParameter(): String? = unwrap(this).getImageNameParameter()
