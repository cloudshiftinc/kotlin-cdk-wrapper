...
public enum class DockerCredentialUsage(
  ...
  public companion object {
    internal fun wrap(cdkObject: software.amazon.awscdk.pipelines.DockerCredentialUsage):
        DockerCredentialUsage = when (cdkObject) {
      software.amazon.awscdk.pipelines.DockerCredentialUsage.SYNTH -> DockerCredentialUsage.SYNTH
    ...
    internal fun unwrap(wrapped: DockerCredentialUsage):
