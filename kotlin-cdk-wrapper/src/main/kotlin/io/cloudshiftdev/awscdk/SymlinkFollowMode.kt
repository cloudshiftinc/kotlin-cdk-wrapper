...
public enum class SymlinkFollowMode(
  ...
  public companion object {
    internal fun wrap(cdkObject: software.amazon.awscdk.SymlinkFollowMode): SymlinkFollowMode = when
        (cdkObject) {
      ...
      software.amazon.awscdk.SymlinkFollowMode.BLOCK_EXTERNAL -> SymlinkFollowMode.BLOCK_EXTERNAL
    }
