...
public interface CfnGuardHookProps {
  ...
  public interface Builder {
    ...
    @JvmName("6a1bb434509cec6736ff66ebcb4b10d62e59ead40c06f02cfb1fad0f59beb36a")
     ...
     */
    @kotlin.Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("12c4f5d5fb8b7092498e757237e26dfcbeca6d36f1e83072cdf7c7c7e88efcf1")
  ...
  private class BuilderImpl : Builder {
    private val cdkBuilder: software.amazon.awscdk.CfnGuardHookProps.Builder =
    ...
    public fun build(): software.amazon.awscdk.CfnGuardHookProps = cdkBuilder.build()
  }

  private class Wrapper(
    cdkObject: software.amazon.awscdk.CfnGuardHookProps,
  ) : CdkObject(cdkObject),
      CfnGuardHookProps {
    /**
     * The type name alias for the Hook. This alias must be unique per account and Region.
  ...
  public companion object {
    ...
    internal fun wrap(cdkObject: software.amazon.awscdk.CfnGuardHookProps): CfnGuardHookProps =
        CdkObjectWrappers.wrap(cdkObject) as? CfnGuardHookProps ?: Wrapper(cdkObject)

    internal fun unwrap(wrapped: CfnGuardHookProps): software.amazon.awscdk.CfnGuardHookProps =
        (wrapped as CdkObject).cdkObject as software.amazon.awscdk.CfnGuardHookProps
  }
}
