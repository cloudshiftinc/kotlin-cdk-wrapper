...
public open class CfnResourceDefaultVersion(
  ...
  public constructor(scope: CloudshiftdevConstructsConstruct, id: String) :
      this(software.amazon.awscdk.CfnResourceDefaultVersion(scope.let(CloudshiftdevConstructsConstruct.Companion::unwrap),
      id)
  )
  ...
  public constructor(
    ...
    props: CfnResourceDefaultVersionProps,
      ...
      this(software.amazon.awscdk.CfnResourceDefaultVersion(scope.let(CloudshiftdevConstructsConstruct.Companion::unwrap),
      id, props.let(CfnResourceDefaultVersionProps.Companion::unwrap))
  )
  ...
  /**
   * A fluent builder for [io.cloudshiftdev.awscdk.CfnResourceDefaultVersion].
   */
  @CdkDslMarker
