...
public enum class CfnTrafficRoutingType(
  ...
  public companion object {
    internal fun wrap(cdkObject: software.amazon.awscdk.CfnTrafficRoutingType):
        CfnTrafficRoutingType = when (cdkObject) {
      software.amazon.awscdk.CfnTrafficRoutingType.ALL_AT_ONCE -> CfnTrafficRoutingType.ALL_AT_ONCE
    ...
    internal fun unwrap(wrapped: CfnTrafficRoutingType):
