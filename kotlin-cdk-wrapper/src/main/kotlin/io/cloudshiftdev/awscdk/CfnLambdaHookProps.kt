...
public interface CfnLambdaHookProps {
  ...
  private class BuilderImpl : Builder {
    private val cdkBuilder: software.amazon.awscdk.CfnLambdaHookProps.Builder =
    ...
    public fun build(): software.amazon.awscdk.CfnLambdaHookProps = cdkBuilder.build()
  }

  private class Wrapper(
    cdkObject: software.amazon.awscdk.CfnLambdaHookProps,
  ) : CdkObject(cdkObject),
      CfnLambdaHookProps {
    /**
     * The type name alias for the Hook. This alias must be unique per account and Region.
  ...
  public companion object {
    ...
    internal fun wrap(cdkObject: software.amazon.awscdk.CfnLambdaHookProps): CfnLambdaHookProps =
        CdkObjectWrappers.wrap(cdkObject) as? CfnLambdaHookProps ?: Wrapper(cdkObject)

    internal fun unwrap(wrapped: CfnLambdaHookProps): software.amazon.awscdk.CfnLambdaHookProps =
        (wrapped as CdkObject).cdkObject as software.amazon.awscdk.CfnLambdaHookProps
  }
}
