...
public class FileAssetLocationDsl {
    ...
    /**
     * @param httpUrl The HTTP URL of this asset on Amazon S3. This value suitable for inclusion in
     *   a CloudFormation template, and may be an encoded token.
     *
    ...
    /**
     * @param kmsKeyArn The ARN of the KMS key used to encrypt the file asset bucket, if any. The
     *   CDK bootstrap stack comes with a key policy that does not require setting this property, so
     *   you only need to set this property if you have customized the bootstrap stack to require
     *   it.
     */
    ...
    /**
     * @param s3ObjectUrl The S3 URL of this asset on Amazon S3. This value suitable for inclusion
     ...
     *   consumption. If there are placeholders in the S3 URL, they will be returned un-replaced and
     *   un-evaluated.
     */
