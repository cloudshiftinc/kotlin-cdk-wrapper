...
public class CfnStackSetOperationPreferencesPropertyDsl {
     ...
     *   fail before AWS CloudFormation stops the operation in that Region. If the operation is
     *   stopped in a Region, AWS CloudFormation doesn't attempt the operation in any subsequent
     *   Regions.
     *
     ...
     *   stack operation can fail before AWS CloudFormation stops the operation in that Region. If
     ...
     *   at one time. This is dependent on the value of `FailureToleranceCount` .
     ...
     *   operation at one time. When calculating the number of accounts based on the specified
     *   percentage, AWS CloudFormation rounds down to the next whole number. This is true except in
     *   cases where rounding down would result is zero. In this case, CloudFormation sets the
