...
public class CfnSkillPropsDsl {
     ...
     *   with the Alexa service. Only Login with Amazon clients created through the are supported.
     ...
     *   Alexa skill. Skill packages are retrieved from an Amazon S3 bucket and key and used to
     *   create and update the skill. For more information about the skill package format, see the .
     */
     ...
     *   skill. Details for retrieving the vendor ID are in . The provided LWA credentials must be
