...
public object awscdk {
    ...
    public inline fun assetStagingProps(block: AssetStagingPropsDsl.() -> Unit = {}): AssetStagingProps {
        val builder = AssetStagingPropsDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun bootstraplessSynthesizer(block: BootstraplessSynthesizerDsl.() -> Unit = {}): BootstraplessSynthesizer {
    ...
    public inline fun cfnCodeDeployLambdaAliasUpdate(block: CfnCodeDeployLambdaAliasUpdateDsl.() -> Unit = {}): CfnCodeDeployLambdaAliasUpdate {
    ...
    public inline fun cfnConditionProps(block: CfnConditionPropsDsl.() -> Unit = {}): CfnConditionProps {
        val builder = CfnConditionPropsDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun cfnCreationPolicy(block: CfnCreationPolicyDsl.() -> Unit = {}): CfnCreationPolicy {
    ...
    public inline fun cfnCustomResourceProps(block: CfnCustomResourcePropsDsl.() -> Unit = {}): CfnCustomResourceProps {
        val builder = CfnCustomResourcePropsDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun cfnDynamicReferenceProps(block: CfnDynamicReferencePropsDsl.() -> Unit = {}): CfnDynamicReferenceProps {
    ...
    public inline fun cfnHookTypeConfigProps(block: CfnHookTypeConfigPropsDsl.() -> Unit = {}): CfnHookTypeConfigProps {
    ...
    public inline fun cfnHookVersionProps(block: CfnHookVersionPropsDsl.() -> Unit = {}): CfnHookVersionProps {
    ...
    public inline fun cfnModuleVersionProps(block: CfnModuleVersionPropsDsl.() -> Unit = {}): CfnModuleVersionProps {
    ...
    public inline fun cfnPublicTypeVersionProps(block: CfnPublicTypeVersionPropsDsl.() -> Unit = {}): CfnPublicTypeVersionProps {
    ...
    public inline fun cfnPublisherProps(block: CfnPublisherPropsDsl.() -> Unit = {}): CfnPublisherProps {
    ...
    public inline fun cfnResourceDefaultVersionProps(block: CfnResourceDefaultVersionPropsDsl.() -> Unit = {}): CfnResourceDefaultVersionProps {
    ...
    public inline fun cfnResourceSignal(block: CfnResourceSignalDsl.() -> Unit = {}): CfnResourceSignal {
    ...
    public inline fun cfnResourceVersionProps(block: CfnResourceVersionPropsDsl.() -> Unit = {}): CfnResourceVersionProps {
    ...
    public inline fun cfnTrafficRouting(block: CfnTrafficRoutingDsl.() -> Unit = {}): CfnTrafficRouting {
        val builder = CfnTrafficRoutingDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun cfnTrafficRoutingConfig(block: CfnTrafficRoutingConfigDsl.() -> Unit = {}): CfnTrafficRoutingConfig {
    ...
    public inline fun cfnTypeActivationProps(block: CfnTypeActivationPropsDsl.() -> Unit = {}): CfnTypeActivationProps {
    ...
    public inline fun cfnWaitConditionProps(block: CfnWaitConditionPropsDsl.() -> Unit = {}): CfnWaitConditionProps {
        val builder = CfnWaitConditionPropsDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun cliCredentialsStackSynthesizer(block: CliCredentialsStackSynthesizerDsl.() -> Unit = {}): CliCredentialsStackSynthesizer {
    ...
    public inline fun customResourceProps(block: CustomResourcePropsDsl.() -> Unit = {}): CustomResourceProps {
    ...
    public inline fun defaultStackSynthesizer(block: DefaultStackSynthesizerDsl.() -> Unit = {}): DefaultStackSynthesizer {
    ...
    public inline fun dockerBuildOptions(block: DockerBuildOptionsDsl.() -> Unit = {}): DockerBuildOptions {
    ...
    public inline fun dockerImageAssetLocation(block: DockerImageAssetLocationDsl.() -> Unit = {}): DockerImageAssetLocation {
        val builder = DockerImageAssetLocationDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun dockerImageAssetSource(block: DockerImageAssetSourceDsl.() -> Unit = {}): DockerImageAssetSource {
    ...
    public inline fun exportValueOptions(block: ExportValueOptionsDsl.() -> Unit = {}): ExportValueOptions {
        val builder = ExportValueOptionsDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun fileAssetLocation(block: FileAssetLocationDsl.() -> Unit = {}): FileAssetLocation {
    ...
    public inline fun fileFingerprintOptions(block: FileFingerprintOptionsDsl.() -> Unit = {}): FileFingerprintOptions {
        val builder = FileFingerprintOptionsDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun fingerprintOptions(block: FingerprintOptionsDsl.() -> Unit = {}): FingerprintOptions {
        val builder = FingerprintOptionsDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun getContextKeyOptions(block: GetContextKeyOptionsDsl.() -> Unit = {}): GetContextKeyOptions {
        val builder = GetContextKeyOptionsDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun getContextKeyResult(block: GetContextKeyResultDsl.() -> Unit = {}): GetContextKeyResult {
        val builder = GetContextKeyResultDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun getContextValueOptions(block: GetContextValueOptionsDsl.() -> Unit = {}): GetContextValueOptions {
        val builder = GetContextValueOptionsDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun getContextValueResult(block: GetContextValueResultDsl.() -> Unit = {}): GetContextValueResult {
    ...
    public inline fun lazyAnyValueOptions(block: LazyAnyValueOptionsDsl.() -> Unit = {}): LazyAnyValueOptions {
        val builder = LazyAnyValueOptionsDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun lazyListValueOptions(block: LazyListValueOptionsDsl.() -> Unit = {}): LazyListValueOptions {
        val builder = LazyListValueOptionsDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun lazyStringValueOptions(block: LazyStringValueOptionsDsl.() -> Unit = {}): LazyStringValueOptions {
    ...
    public inline fun permissionsBoundaryBindOptions(block: PermissionsBoundaryBindOptionsDsl.() -> Unit = {}): PermissionsBoundaryBindOptions {
    ...
    public inline fun policyViolationBeta1(block: PolicyViolationBeta1Dsl.() -> Unit = {}): PolicyViolationBeta1 {
        val builder = PolicyViolationBeta1Dsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun removalPolicyOptions(block: RemovalPolicyOptionsDsl.() -> Unit = {}): RemovalPolicyOptions {
    ...
    public inline fun resourceEnvironment(block: ResourceEnvironmentDsl.() -> Unit = {}): ResourceEnvironment {
    ...
    public inline fun secretValue(protectedValue: Any, block: SecretValueDsl.() -> Unit = {}): SecretValue {
    ...
    public inline fun sizeConversionOptions(block: SizeConversionOptionsDsl.() -> Unit = {}): SizeConversionOptions {
    ...
    public inline fun stageSynthesisOptions(block: StageSynthesisOptionsDsl.() -> Unit = {}): StageSynthesisOptions {
        val builder = StageSynthesisOptionsDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun synthesizeStackArtifactOptions(block: SynthesizeStackArtifactOptionsDsl.() -> Unit = {}): SynthesizeStackArtifactOptions {
    ...
    public inline fun tagManagerOptions(block: TagManagerOptionsDsl.() -> Unit = {}): TagManagerOptions {
    ...
    public inline fun timeConversionOptions(block: TimeConversionOptionsDsl.() -> Unit = {}): TimeConversionOptions {
        val builder = TimeConversionOptionsDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun uniqueResourceNameOptions(block: UniqueResourceNameOptionsDsl.() -> Unit = {}): UniqueResourceNameOptions {
