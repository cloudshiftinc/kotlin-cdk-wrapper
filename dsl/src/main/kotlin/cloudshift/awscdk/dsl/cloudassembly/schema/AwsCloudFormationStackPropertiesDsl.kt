...
public class AwsCloudFormationStackPropertiesDsl {
  ...
  /**
   * @param cloudFormationExecutionRoleArn The role that is passed to CloudFormation to execute the
   * change set.
   */
  ...
  /**
   * @param stackTemplateAssetObjectUrl If the stack template has already been included in the asset
   * manifest, its asset URL.
   */
