...
public class ArnComponentsDsl {
  ...
  /**
   * @param resourceName Resource name or path within the resource (i.e. S3 bucket object key) or a
   * wildcard such as `"*"`. This is service-dependent.
   */
  ...
  /**
   * @param service The service namespace that identifies the AWS product (for example, 's3', 'iam',
   * 'codepipline'). 
   */
