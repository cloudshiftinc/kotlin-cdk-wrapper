...
public object customresources {
  ...
  public inline fun awsCustomResourceProps(block: AwsCustomResourcePropsDsl.() -> Unit = {}):
  ...
  public inline fun sdkCallsPolicyOptions(block: SdkCallsPolicyOptionsDsl.() -> Unit = {}):
