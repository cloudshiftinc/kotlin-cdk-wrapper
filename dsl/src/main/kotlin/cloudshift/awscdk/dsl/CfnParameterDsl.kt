...
public class CfnParameterDsl(
   ...
   * Default: - None.
   *
   * @param maxLength An integer value that determines the largest number of characters you want to
   ...
   * Default: - None.
   *
   * @param maxValue A numeric value that determines the largest numeric value you want to allow for
   * Number types. 
   */
   ...
   * Default: - None.
   *
   * @param minLength An integer value that determines the smallest number of characters you want to
   * allow for String types. 
   */
