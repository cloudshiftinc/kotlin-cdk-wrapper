 ...
 */
@CdkDslMarker
public class TreeCloudArtifactDsl(
    assembly: CloudAssembly,
    name: String,
) {
    private val cdkBuilder: TreeCloudArtifact.Builder =
        TreeCloudArtifact.Builder.create(assembly, name)
    ...
    public fun build(): TreeCloudArtifact {
