...
public class VpcContextResponseDsl {
    ...
    /**
     * @param isolatedSubnetIds IDs of all isolated subnets. Element
     *   count: #(availabilityZones) #(isolatedGroups)
     */
    ...
    /**
     * @param isolatedSubnetNames Name of isolated subnet groups. Element count: #(isolatedGroups)
     */
    ...
    /**
     * @param isolatedSubnetRouteTableIds Route Table IDs of isolated subnet groups. Element
     *   count: #(availabilityZones) #(isolatedGroups)
     */
    ...
    /**
     * @param privateSubnetIds IDs of all private subnets. Element
     *   count: #(availabilityZones) #(privateGroups)
     */
    ...
    /** @param privateSubnetNames Name of private subnet groups. Element count: #(privateGroups) */
    ...
    /**
     * @param privateSubnetRouteTableIds Route Table IDs of private subnet groups. Element
     *   count: #(availabilityZones) #(privateGroups)
     */
    ...
    /**
     * @param publicSubnetIds IDs of all public subnets. Element
     *   count: #(availabilityZones) #(publicGroups)
     */
    ...
    /** @param publicSubnetNames Name of public subnet groups. Element count: #(publicGroups) */
    ...
    /**
     * @param publicSubnetRouteTableIds Route Table IDs of public subnet groups. Element
     *   count: #(availabilityZones) #(publicGroups)
     */
    ...
    /**
     * @param subnetGroups The subnet groups discovered for the given VPC. Unlike the above
     *   properties, this will include asymmetric subnets, if the VPC has any. This property will
     *   only be populated if `VpcContextQuery.returnAsymmetricSubnets` is true.
     */
