 ...
 * using intrinsic functions as dictionary keys (because dictionary keys in JSON must be strings).
 * Specifically this is common in IAM conditions such as `StringEquals: { lhs: "rhs" }` where you
 * want "lhs" to be a reference.
 *
