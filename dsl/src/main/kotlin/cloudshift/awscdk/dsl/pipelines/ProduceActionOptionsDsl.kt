...
public class ProduceActionOptionsDsl {
    ...
    /**
     * @param beforeSelfMutation Whether or not this action is inserted before self mutation. If it
     *   is, the action should take care to reflect some part of its own definition in the pipeline
     *   action definition, to trigger a restart after self-mutation (if necessary).
     */
     ...
     *   input artifact can use. CodeBuild Projects MUST have an input artifact in order to be added
     *   to the Pipeline. If the Project doesn't actually care about its input (it can be anything),
     *   it can use the Artifact passed here.
     */
    ...
    /**
     * @param stackOutputsMap Helper object to produce variables exported from stack deployments. If
     *   your step references outputs from a stack deployment, use this to map the output references
     *   to Codepipeline variable names.
     *
     ...
     *   to it. Pass this on to the Action you are creating.
     */
