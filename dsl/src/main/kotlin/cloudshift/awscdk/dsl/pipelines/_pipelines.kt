...
public object pipelines {
  ...
  public inline fun codeBuildStepProps(block: CodeBuildStepPropsDsl.() -> Unit = {}):
      CodeBuildStepProps {
  ...
  public inline fun codeCommitSourceOptions(block: CodeCommitSourceOptionsDsl.() -> Unit = {}):
  ...
  public inline
      fun codePipelineActionFactoryResult(block: CodePipelineActionFactoryResultDsl.() -> Unit =
  ...
  public inline fun codePipelineProps(block: CodePipelinePropsDsl.() -> Unit = {}):
      CodePipelineProps {
  ...
  public inline fun connectionSourceOptions(block: ConnectionSourceOptionsDsl.() -> Unit = {}):
  ...
  public inline fun ecrDockerCredentialOptions(block: EcrDockerCredentialOptionsDsl.() -> Unit =
  ...
  public inline
      fun externalDockerCredentialOptions(block: ExternalDockerCredentialOptionsDsl.() -> Unit =
  ...
  public inline fun gitHubSourceOptions(block: GitHubSourceOptionsDsl.() -> Unit = {}):
      GitHubSourceOptions {
  ...
  public inline fun manualApprovalStepProps(block: ManualApprovalStepPropsDsl.() -> Unit = {}):
  ...
  public inline
      fun permissionsBroadeningCheckProps(block: PermissionsBroadeningCheckPropsDsl.() -> Unit =
  ...
  public inline fun pipelineBaseProps(block: PipelineBasePropsDsl.() -> Unit = {}):
      PipelineBaseProps {
  ...
  public inline fun produceActionOptions(block: ProduceActionOptionsDsl.() -> Unit = {}):
  ...
  public inline fun stackDeploymentProps(block: StackDeploymentPropsDsl.() -> Unit = {}):
  ...
  public inline fun stageDeploymentProps(block: StageDeploymentPropsDsl.() -> Unit = {}):
