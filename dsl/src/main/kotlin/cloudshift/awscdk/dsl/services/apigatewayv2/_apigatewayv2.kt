...
public object apigatewayv2 {
    ...
    public inline fun cfnApiCorsProperty(block: CfnApiCorsPropertyDsl.() -> Unit = {}): CfnApi.CorsProperty {
    ...
    public inline fun cfnApiMappingProps(block: CfnApiMappingPropsDsl.() -> Unit = {}): CfnApiMappingProps {
    ...
    public inline fun cfnRouteResponseProps(block: CfnRouteResponsePropsDsl.() -> Unit = {}): CfnRouteResponseProps {
