...
public class CfnRuleGroupRuleDefinitionPropertyDsl {
   ...
   * stateless rule and you specify `aws:forward_to_sfe` for the `StatelessDefaultActions` setting for
   * the `FirewallPolicy` .
   *
   *
  ...
  /**
   * @param matchAttributes Criteria for Network Firewall to use to inspect an individual packet in
