...
public class TablePropsDsl {
     ...
     *   enabled. This property cannot be set if `serverSideEncryption` is set.
     *
    ...
    /**
     * @param encryptionKey External KMS key to use for table encryption. This property can only be
     *   set if `encryption` is set to `TableEncryption.CUSTOMER_MANAGED`.
     */
    ...
    /**
     * @param readCapacity The read capacity for the table. Careful if you add Global Secondary
     *   Indexes, as those will share the table's provisioned throughput.
     *
     ...
     *   replication to finish. If set to false, the CloudFormation resource will mark the resource
     *   as created and replication will be completed asynchronously. This property is ignored if
    ...
    /**
     * @param writeCapacity The write capacity for the table. Careful if you add Global Secondary
     *   Indexes, as those will share the table's provisioned throughput.
     *
     * Can only be provided if billingMode is Provisioned.
     */
