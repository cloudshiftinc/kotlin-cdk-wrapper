 ...
 * schedules. For more information about different schedule types, see
 * [Schedule types](https://docs.aws.amazon.com/scheduler/latest/UserGuide/schedule-types.html) in
 ...
 * operation that EventBridge Scheduler calls on your behalf every time your schedule runs.
 * EventBridge Scheduler supports two types of targets: *templated* targets invoke common API
 * operations across a core groups of services, and customizeable *universal* targets that you can
 * use to call more than 6,000 operations across over 270 services. For more information about
 * configuring targets, see
 ...
 * time windows, and configuring a dead-letter queue for a schedule, see
...
public class CfnScheduleDsl(
     ...
     * `StartDate` you specify. EventBridge Scheduler ignores `StartDate` for one-time schedules.
     *
