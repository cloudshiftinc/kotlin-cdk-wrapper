...
public object gamelift {
     ...
     * points to an active fleet. A terminal alias displays a message instead of routing players to
     * an active fleet. For example, a terminal alias might display a URL link that directs players
     * to an upgrade site. You can use aliases to define destinations in a game session queue or
     * when requesting new game sessions.
     *
     * Example:
     * ```
     ...
     */
    public inline fun cfnAliasRoutingStrategyProperty(
     ...
     */
    public inline fun cfnBuildStorageLocationProperty(
     ...
     * custom game server or Realtime Servers.
     *
     ...
     */
    public inline fun cfnFleetAnywhereConfigurationProperty(
     ...
     */
    public inline fun cfnFleetCertificateConfigurationProperty(
     ...
     *
     * New game sessions are assigned an IP address/port number combination, which must fall into
     * the fleet's allowed ranges. Fleets with custom game builds must have permissions explicitly
     * set. For Realtime Servers fleets, GameLift automatically opens two port ranges, one for TCP
     ...
     */
    public inline fun cfnFleetIpPermissionProperty(
        block: CfnFleetIpPermissionPropertyDsl.() -> Unit = {}
     ...
     */
    public inline fun cfnFleetLocationCapacityProperty(
        block: CfnFleetLocationCapacityPropertyDsl.() -> Unit = {}
     ...
     */
    public inline fun cfnFleetLocationConfigurationProperty(
        block: CfnFleetLocationConfigurationPropertyDsl.() -> Unit = {}
     ...
     * player can create a maximum number of new game sessions within a specified time period".
     *
     ...
     */
    public inline fun cfnFleetResourceCreationLimitPolicyProperty(
    ...
    /**
     * A collection of server process configurations that describe the set of processes to run on
     * each instance in a fleet.
     *
     * Server processes run either an executable in a custom game build or a Realtime Servers
     * script. GameLift launches the configured processes, manages their life cycle, and replaces
     * them as needed. Each instance checks regularly for an updated runtime configuration.
     *
     ...
     */
    public inline fun cfnFleetRuntimeConfigurationProperty(
     ...
     */
    public inline fun cfnFleetServerProcessProperty(
     ...
     * Amazon EC2 instances for game hosting. This operation creates the game server group, creates
     * an Auto Scaling group in your AWS account , and establishes a link between the two groups.
     * You can view the status of your game server groups in the GameLift console. Game server group
     ...
     *   game server build. For more information, see
     ...
     * launch template, and provide a list of instance types that can be used in the group. You must
     * also set initial maximum and minimum limits on the group's instance count. You can optionally
     * set an Auto Scaling policy with target tracking based on a GameLift FleetIQ metric.
     *
     ...
     * Auto Scaling group properties are periodically updated by GameLift FleetIQ as part of its
     ...
     */
    public inline fun cfnGameServerGroupAutoScalingPolicyProperty(
     ...
     * two instance types defined for it. GameLift FleetIQ periodically evaluates each defined
     * instance type for viability. It then updates the Auto Scaling group with the list of viable
     * instance types.
     *
     * Example:
     * ```
     ...
     */
    public inline fun cfnGameServerGroupInstanceDefinitionProperty(
        block: CfnGameServerGroupInstanceDefinitionPropertyDsl.() -> Unit = {}
     ...
     * deployed to all instances in a game server group. The launch template is specified when
     * creating a new game server group with `GameServerGroup` .
     *
     * Example:
     * ```
     * // The code below shows an example of how to instantiate this type.
     ...
     */
    public inline fun cfnGameServerGroupLaunchTemplateProperty(
     ...
     * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-gamelift-gameservergroup.html)
     */
    public inline fun cfnGameServerGroupProps(
        block: CfnGameServerGroupPropsDsl.() -> Unit = {}
     ...
     */
    public inline fun cfnGameServerGroupTargetTrackingConfigurationProperty(
        block: CfnGameServerGroupTargetTrackingConfigurationPropertyDsl.() -> Unit = {}
     ...
     *
     * A queue uses FleetIQ algorithms to determine the best placement locations and find an
     * available game server, then prompts the game server to start a new game session. Queues can
     * have destinations (GameLift fleets or aliases), which determine where the queue can place new
     * game sessions. A queue can have destinations with varied fleet type (Spot and On-Demand),
     ...
     */
    public inline fun cfnGameSessionQueueDestinationProperty(
        block: CfnGameSessionQueueDestinationPropertyDsl.() -> Unit = {}
     ...
     *
     * You can use a filter to temporarily turn off placements for specific locations. For queues
     ...
     */
    public inline fun cfnGameSessionQueueFilterConfigurationProperty(
     ...
     * where a player reports latency higher than the cap. Latency policies are only enforced when
     ...
     */
    public inline fun cfnGameSessionQueuePlayerLatencyPolicyProperty(
        block: CfnGameSessionQueuePlayerLatencyPolicyPropertyDsl.() -> Unit = {}
     ...
     *
     * When defined, this configuration replaces the default FleetIQ prioritization process, which
     * is as follows:
     * * If player latency data is included in a game session request, destinations and locations
     *   are prioritized first based on lowest average latency (1), then on lowest hosting cost (2),
     *   then on destination list order (3), and finally on location (alphabetical) (4). This
     *   approach ensures that the queue's top priority is to place game sessions where average
     *   player latency is lowest, and--if latency is the same--where the hosting cost is less, etc.
     * * If player latency data is not included, destinations and locations are prioritized first on
     *   destination list order (1), and then on location (alphabetical) (2). This approach ensures
     *   that the queue's top priority is to place game sessions on the first destination fleet
     *   listed. If that fleet has multiple locations, the game session is placed on the first
     ...
     */
    public inline fun cfnGameSessionQueuePriorityConfigurationProperty(
     ...
     * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-gamelift-gamesessionqueue.html)
     */
    public inline fun cfnGameSessionQueueProps(
        block: CfnGameSessionQueuePropsDsl.() -> Unit = {}
     ...
     * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-gamelift-location.html)
     */
    public inline fun cfnLocationProps(
        block: CfnLocationPropsDsl.() -> Unit = {}
    ): CfnLocationProps {
     ...
     * configuration for use with FlexMatch.
     *
     * Whether you're using FlexMatch with GameLift hosting or as a standalone matchmaking service,
     * the matchmaking configuration sets out rules for matching players and forming teams. If
     * you're using GameLift hosting, it also defines how to start game sessions for each match.
     ...
     * attributes that are consistent with that configuration.
     *
     * Example:
     * ```
     * // The code below shows an example of how to instantiate this type.
     ...
     */
    public inline fun cfnMatchmakingConfigurationGamePropertyProperty(
        block: CfnMatchmakingConfigurationGamePropertyPropertyDsl.() -> Unit = {}
     ...
     * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-gamelift-matchmakingconfiguration.html)
     */
    public inline fun cfnMatchmakingConfigurationProps(
        block: CfnMatchmakingConfigurationPropsDsl.() -> Unit = {}
     ...
     *
     * A rule set describes the type of match to create, such as the number and size of teams. It
     * also sets the parameters for acceptable player matches, such as minimum skill level or
     * character type.
     *
     ...
     * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-gamelift-matchmakingruleset.html)
     */
    public inline fun cfnMatchmakingRuleSetProps(
        block: CfnMatchmakingRuleSetPropsDsl.() -> Unit = {}
     ...
     * logic for your game. The script is deployed when you create a Realtime Servers fleet to host
     ...
     */
    public inline fun cfnScriptS3LocationProperty(
