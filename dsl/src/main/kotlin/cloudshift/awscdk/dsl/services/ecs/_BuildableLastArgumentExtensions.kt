...
public inline fun ExternalService.autoScaleTaskCount(block: EnableScalingPropsDsl.() -> Unit = {}): ScalableTaskCount {
    val builder = EnableScalingPropsDsl()
    builder.apply(block)
    return autoScaleTaskCount(builder.build())
}

public inline fun ExternalService.enableCloudMap(block: CloudMapOptionsDsl.() -> Unit = {}): Service {
...
public inline fun Cluster.addCapacity(id: String, block: AddCapacityOptionsDsl.() -> Unit = {}): AutoScalingGroup {
...
public inline fun Cluster.metric(metricName: String, block: MetricOptionsDsl.() -> Unit = {}): Metric {
...
public inline fun BaseService.autoScaleTaskCount(block: EnableScalingPropsDsl.() -> Unit = {}): ScalableTaskCount {
    val builder = EnableScalingPropsDsl()
    builder.apply(block)
    return autoScaleTaskCount(builder.build())
}
...
public inline fun BaseService.metric(metricName: String, block: MetricOptionsDsl.() -> Unit = {}): Metric {
    val builder = MetricOptionsDsl()
    builder.apply(block)
    return metric(metricName, builder.build())
}

public inline fun BaseService.metricCpuUtilization(block: MetricOptionsDsl.() -> Unit = {}): Metric {
    val builder = MetricOptionsDsl()
    builder.apply(block)
    return metricCpuUtilization(builder.build())
}

public inline fun BaseService.metricMemoryUtilization(block: MetricOptionsDsl.() -> Unit = {}): Metric {
    val builder = MetricOptionsDsl()
    builder.apply(block)
    return metricMemoryUtilization(builder.build())
}
