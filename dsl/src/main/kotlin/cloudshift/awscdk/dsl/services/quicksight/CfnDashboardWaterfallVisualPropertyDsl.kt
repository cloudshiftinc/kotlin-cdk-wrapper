 ...
 */
@CdkDslMarker
public class CfnDashboardWaterfallVisualPropertyDsl {
    private val cdkBuilder: CfnDashboard.WaterfallVisualProperty.Builder =
     ...
     * @param chartConfiguration The configuration for a waterfall visual.
     */
    public fun chartConfiguration(chartConfiguration: CfnDashboard.WaterfallChartConfigurationProperty) {
        cdkBuilder.chartConfiguration(chartConfiguration)
    }
    ...
    public fun build(): CfnDashboard.WaterfallVisualProperty {
