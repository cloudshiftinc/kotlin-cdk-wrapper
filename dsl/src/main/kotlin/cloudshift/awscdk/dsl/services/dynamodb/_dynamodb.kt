...
public object dynamodb {
    ...
    public inline fun cfnGlobalTableProps(block: CfnGlobalTablePropsDsl.() -> Unit = {}): CfnGlobalTableProps {
    ...
    public inline fun cfnTableCsvProperty(block: CfnTableCsvPropertyDsl.() -> Unit = {}): CfnTable.CsvProperty {
    ...
    public inline fun cfnTableKeySchemaProperty(block: CfnTableKeySchemaPropertyDsl.() -> Unit = {}): CfnTable.KeySchemaProperty {
    ...
    public inline fun globalSecondaryIndexProps(block: GlobalSecondaryIndexPropsDsl.() -> Unit = {}): GlobalSecondaryIndexProps {
        val builder = GlobalSecondaryIndexPropsDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun localSecondaryIndexProps(block: LocalSecondaryIndexPropsDsl.() -> Unit = {}): LocalSecondaryIndexProps {
        val builder = LocalSecondaryIndexPropsDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun operationsMetricOptions(block: OperationsMetricOptionsDsl.() -> Unit = {}): OperationsMetricOptions {
    ...
    public inline fun secondaryIndexProps(block: SecondaryIndexPropsDsl.() -> Unit = {}): SecondaryIndexProps {
    ...
    public inline fun utilizationScalingProps(block: UtilizationScalingPropsDsl.() -> Unit = {}): UtilizationScalingProps {
