...
@CdkDslMarker
public class CfnTemplateBoxPlotAggregatedFieldWellsPropertyDsl {
  private val cdkBuilder: CfnTemplate.BoxPlotAggregatedFieldWellsProperty.Builder =
  ...
  public fun build(): CfnTemplate.BoxPlotAggregatedFieldWellsProperty {
