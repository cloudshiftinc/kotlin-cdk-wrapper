...
public class CfnComponentVersionLambdaFunctionRecipeSourcePropertyDsl {
    ...
    public fun componentLambdaParameters(
        componentLambdaParameters: CfnComponentVersion.LambdaExecutionParametersProperty
    ) {
        cdkBuilder.componentLambdaParameters(componentLambdaParameters)
    }

    /**
     * @param componentName The name of the component. Defaults to the name of the Lambda function.
     */
    ...
    /**
     * @param componentVersion The version of the component. Defaults to the version of the Lambda
     *   function as a semantic version. For example, if your function version is `3` , the
    ...
    /**
     * @param lambdaArn The ARN of the Lambda function. The ARN must include the version of the
