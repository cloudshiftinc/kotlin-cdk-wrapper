...
public object destinations {
    ...
    public inline fun kinesisDestinationProps(block: KinesisDestinationPropsDsl.() -> Unit = {}): KinesisDestinationProps {
        val builder = KinesisDestinationPropsDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun lambdaDestination(fn: IFunction, block: LambdaDestinationDsl.() -> Unit = {}): LambdaDestination {
        val builder = LambdaDestinationDsl(fn)
        builder.apply(block)
        return builder.build()
    }

    public inline fun lambdaDestinationOptions(block: LambdaDestinationOptionsDsl.() -> Unit = {}): LambdaDestinationOptions {
