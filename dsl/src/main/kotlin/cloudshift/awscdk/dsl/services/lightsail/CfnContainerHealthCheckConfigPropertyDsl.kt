...
public class CfnContainerHealthCheckConfigPropertyDsl {
  ...
  /**
   * @param healthyThreshold The number of consecutive health check successes required before moving
   ...
   * container.
   * You can specify values between `200` and `499` . You can specify multiple values (for example,
