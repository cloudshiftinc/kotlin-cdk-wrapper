 ...
 */
@CdkDslMarker
public class CfnAnalysisScatterPlotVisualPropertyDsl {
    private val cdkBuilder: CfnAnalysis.ScatterPlotVisualProperty.Builder =
    ...
    public fun chartConfiguration(
        chartConfiguration: CfnAnalysis.ScatterPlotConfigurationProperty
    ) {
        cdkBuilder.chartConfiguration(chartConfiguration)
    }
    ...
    public fun build(): CfnAnalysis.ScatterPlotVisualProperty {
