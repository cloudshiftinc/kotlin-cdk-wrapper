...
public class CfnNetworkAclEntryPropsDsl {
     ...
     *   ingress traffic to the subnet ( `false` ). By default, AWS CloudFormation specifies `false`
     *   .
     */
    ...
    /**
     * @param protocol The IP protocol that the rule applies to. You must specify -1 or a protocol
     *   number. You can specify -1 for all protocols.
     *
