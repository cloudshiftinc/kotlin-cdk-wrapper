...
public class CfnGroupResourceQueryPropertyDsl {
   ...
   * * When the `Type` is `CLOUDFORMATION_STACK_1_0` then this field is required only when you must
   * specify a CloudFormation stack other than the one you are defining. To do this, the `Query`
  ...
  /**
   * @param type Specifies the type of resource query that determines this group's membership. There
