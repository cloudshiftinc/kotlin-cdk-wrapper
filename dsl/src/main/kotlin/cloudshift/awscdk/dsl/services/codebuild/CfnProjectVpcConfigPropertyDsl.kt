 ...
 * resource that enable AWS CodeBuild to access resources in an Amazon VPC. For more information,
 * see
...
public class CfnProjectVpcConfigPropertyDsl {
    ...
    /**
     * @param securityGroupIds A list of one or more security groups IDs in your Amazon VPC. The
     *   maximum count is 5.
     */
