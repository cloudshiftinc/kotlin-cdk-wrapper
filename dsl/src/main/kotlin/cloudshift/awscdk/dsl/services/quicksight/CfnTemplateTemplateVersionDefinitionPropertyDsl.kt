...
public class CfnTemplateTemplateVersionDefinitionPropertyDsl {
  ...
  /**
   * @param columnConfigurations An array of template-level column configurations.
   * Column configurations are used to set default formatting for a column that's used throughout a
   * template.
   */
  ...
  /**
   * @param dataSetConfigurations An array of dataset configurations. 
  ...
  /**
   * @param filterGroups Filter definitions for a template.
   * For more information, see [Filtering
   * Data](https://docs.aws.amazon.com/quicksight/latest/user/filtering-visual-data.html) in the
  ...
  /**
   * @param parameterDeclarations An array of parameter declarations for a template.
