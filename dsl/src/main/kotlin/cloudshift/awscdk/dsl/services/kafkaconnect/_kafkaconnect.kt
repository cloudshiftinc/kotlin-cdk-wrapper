...
public object kafkaconnect {
    ...
    public inline fun cfnConnectorApacheKafkaClusterProperty(
        block: CfnConnectorApacheKafkaClusterPropertyDsl.() -> Unit =
            {},
    ...
    public inline fun cfnConnectorAutoScalingProperty(
        block: CfnConnectorAutoScalingPropertyDsl.() -> Unit =
            {},
    ...
    public inline fun cfnConnectorCapacityProperty(
        block: CfnConnectorCapacityPropertyDsl.() -> Unit =
            {},
    ...
    public inline fun cfnConnectorCloudWatchLogsLogDeliveryProperty(
        block: CfnConnectorCloudWatchLogsLogDeliveryPropertyDsl.() -> Unit =
            {},
    ...
    public inline fun cfnConnectorCustomPluginProperty(
        block: CfnConnectorCustomPluginPropertyDsl.() -> Unit =
            {},
    ...
    public inline fun cfnConnectorFirehoseLogDeliveryProperty(
        block: CfnConnectorFirehoseLogDeliveryPropertyDsl.() -> Unit =
            {},
    ...
    public inline fun cfnConnectorKafkaClusterClientAuthenticationProperty(
    ...
    public inline fun cfnConnectorKafkaClusterEncryptionInTransitProperty(
    ...
    public inline fun cfnConnectorKafkaClusterProperty(
    ...
    public inline fun cfnConnectorLogDeliveryProperty(
    ...
    public inline fun cfnConnectorPluginProperty(
        block: CfnConnectorPluginPropertyDsl.() -> Unit =
            {},
    ...
    public inline fun cfnConnectorProvisionedCapacityProperty(
        block: CfnConnectorProvisionedCapacityPropertyDsl.() -> Unit =
            {},
    ...
    public inline fun cfnConnectorS3LogDeliveryProperty(
        block: CfnConnectorS3LogDeliveryPropertyDsl.() -> Unit =
            {},
    ...
    public inline fun cfnConnectorScaleInPolicyProperty(
        block: CfnConnectorScaleInPolicyPropertyDsl.() -> Unit =
            {},
    ...
    public inline fun cfnConnectorScaleOutPolicyProperty(
        block: CfnConnectorScaleOutPolicyPropertyDsl.() -> Unit =
            {},
    ...
    public inline fun cfnConnectorVpcProperty(block: CfnConnectorVpcPropertyDsl.() -> Unit = {}): CfnConnector.VpcProperty {
        val builder = CfnConnectorVpcPropertyDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun cfnConnectorWorkerConfigurationProperty(
    ...
    public inline fun cfnConnectorWorkerLogDeliveryProperty(
        block: CfnConnectorWorkerLogDeliveryPropertyDsl.() -> Unit =
            {},
