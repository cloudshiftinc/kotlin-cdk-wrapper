...
public class CfnListenerRuleRuleConditionPropertyDsl {
   ...
   */
  public
      fun httpRequestMethodConfig(httpRequestMethodConfig: CfnListenerRule.HttpRequestMethodConfigProperty) {
    cdkBuilder.httpRequestMethodConfig(httpRequestMethodConfig)
  }
   ...
   *
   * If `Field` is `host-header` and you're not using `HostHeaderConfig` , you can specify a single
   * host name (for example, my.example.com). A host name is case insensitive, can be up to 128
