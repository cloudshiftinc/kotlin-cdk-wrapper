...
public class CfnTaskDefinitionPropsDsl {
     ...
     *   different containers that make up your task. For more information about container
    ...
    /**
     * @param cpu The number of `cpu` units used by the task. If you use the EC2 launch type, this
     *   field is optional. Any value can be used. If you use the Fargate launch type, this field is
     ...
     *   the Amazon ECS container agent permission to make AWS API calls on your behalf. The task
     *   execution IAM role is required depending on the requirements of your task. For more
     *   information, see
    ...
    /**
     * @param family The name of a family that this task definition is registered to. Up to 255
    ...
    /**
     * @param ipcMode The IPC resource namespace to use for the containers in the task. The valid
    ...
    /**
     * @param memory The amount (in MiB) of memory used by the task. If your tasks runs on Amazon
     *   EC2 instances, you must specify either a task-level memory value or a container-level
     *   memory value. This field is optional and any value can be used. If a task-level memory
     *   value is specified, the container-level memory value is optional. For more information
     ...
     *   valid values are `none` , `bridge` , `awsvpc` , and `host` . If no network mode is
    ...
    /**
     * @param pidMode The process namespace to use for the containers in the task. The valid values
     *   are `host` or `task` . If `host` is specified, then all containers within the tasks that
    ...
    /**
     * @param proxyConfiguration The configuration details for the App Mesh proxy. Your Amazon ECS
     *   container instances require at least version 1.26.0 of the container agent and at least
    ...
    /**
     * @param volumes The list of data volume definitions for the task. For more information, see
