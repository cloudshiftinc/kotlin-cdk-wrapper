...
public class CfnResourceSharePropsDsl {
     ...
     *   with individual AWS accounts that are *not* in your organization. A value of `false` only
     *   has meaning if your account is a member of an AWS Organization. The default value is `true`
     *   .
     */
