...
public class CfnNetworkInterfacePropsDsl {
     ...
     *   address. Enable this option to automatically assign an IPv6 associated with the ENI
     *   attached to your instance to be the primary IPv6 address. When you enable an IPv6 address
     *   to be a primary IPv6, you cannot disable it. Traffic will be routed to the primary IPv6
     *   address until the instance is terminated or the ENI is detached. If you have multiple IPv6
     *   addresses associated with an ENI and you enable a primary IPv6 address, the first IPv6
