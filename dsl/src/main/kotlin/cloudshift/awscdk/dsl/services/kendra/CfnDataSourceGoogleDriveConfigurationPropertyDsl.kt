...
public class CfnDataSourceGoogleDriveConfigurationPropertyDsl {
    ...
    /**
     * @param excludeUserAccounts A list of email addresses of the users. Documents owned by these
     *   users are excluded from the index. Documents shared with excluded users are indexed unless
     ...
     *   your Google Drive, including shared drives and users' My Drives. Items that match the
     *   patterns are excluded from the index. Items that don't match the patterns are included in
     *   the index. If an item matches both an inclusion and exclusion pattern, the exclusion
     ...
     *   Google Drive fields. For more information, see
     ...
     *   your Google Drive, including shared drives and users' My Drives. Items that match the
     *   patterns are included in the index. Items that don't match the patterns are excluded from
     *   the index. If an item matches both an inclusion and exclusion pattern, the exclusion
     *   pattern takes precedence and the item isn't included in the index.
     */
