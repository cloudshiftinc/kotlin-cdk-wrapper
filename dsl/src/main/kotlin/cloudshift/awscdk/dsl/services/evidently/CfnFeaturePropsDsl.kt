...
public class CfnFeaturePropsDsl {
     ...
     *   different variations. Each `VariationObject` in the `Variations` array for a feature must
     *   have the same type of value ( `BooleanValue` , `DoubleValue` , `LongValue` or `StringValue`
     *   ).
     */
