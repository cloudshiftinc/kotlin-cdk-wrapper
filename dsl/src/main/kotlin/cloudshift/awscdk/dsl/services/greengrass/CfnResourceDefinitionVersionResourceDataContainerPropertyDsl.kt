...
public class CfnResourceDefinitionVersionResourceDataContainerPropertyDsl {
    ...
    public fun localDeviceResourceData(
        localDeviceResourceData: CfnResourceDefinitionVersion.LocalDeviceResourceDataProperty
    ) {
        cdkBuilder.localDeviceResourceData(localDeviceResourceData)
    }
    ...
    public fun localVolumeResourceData(
        localVolumeResourceData: CfnResourceDefinitionVersion.LocalVolumeResourceDataProperty
    ) {
        cdkBuilder.localVolumeResourceData(localVolumeResourceData)
    }
