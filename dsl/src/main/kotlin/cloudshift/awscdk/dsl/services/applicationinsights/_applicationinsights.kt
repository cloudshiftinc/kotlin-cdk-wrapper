...
public object applicationinsights {
  ...
  public inline
      fun cfnApplicationAlarmMetricProperty(block: CfnApplicationAlarmMetricPropertyDsl.() -> Unit =
  ...
  public inline fun cfnApplicationAlarmProperty(block: CfnApplicationAlarmPropertyDsl.() -> Unit =
  ...
  public inline
      fun cfnApplicationComponentConfigurationProperty(block: CfnApplicationComponentConfigurationPropertyDsl.() -> Unit
  ...
  public inline
      fun cfnApplicationComponentMonitoringSettingProperty(block: CfnApplicationComponentMonitoringSettingPropertyDsl.() -> Unit
  ...
  public inline
      fun cfnApplicationConfigurationDetailsProperty(block: CfnApplicationConfigurationDetailsPropertyDsl.() -> Unit
  ...
  public inline
      fun cfnApplicationCustomComponentProperty(block: CfnApplicationCustomComponentPropertyDsl.() -> Unit
  ...
  public inline
      fun cfnApplicationHAClusterPrometheusExporterProperty(block: CfnApplicationHAClusterPrometheusExporterPropertyDsl.() -> Unit
  ...
  public inline
      fun cfnApplicationHANAPrometheusExporterProperty(block: CfnApplicationHANAPrometheusExporterPropertyDsl.() -> Unit
  ...
  public inline
      fun cfnApplicationJMXPrometheusExporterProperty(block: CfnApplicationJMXPrometheusExporterPropertyDsl.() -> Unit
  ...
  public inline
      fun cfnApplicationLogPatternProperty(block: CfnApplicationLogPatternPropertyDsl.() -> Unit =
  ...
  public inline
      fun cfnApplicationLogPatternSetProperty(block: CfnApplicationLogPatternSetPropertyDsl.() -> Unit
  ...
  public inline fun cfnApplicationLogProperty(block: CfnApplicationLogPropertyDsl.() -> Unit = {}):
  ...
  public inline
      fun cfnApplicationSubComponentConfigurationDetailsProperty(block: CfnApplicationSubComponentConfigurationDetailsPropertyDsl.() -> Unit
  ...
  public inline
      fun cfnApplicationSubComponentTypeConfigurationProperty(block: CfnApplicationSubComponentTypeConfigurationPropertyDsl.() -> Unit
  ...
  public inline
      fun cfnApplicationWindowsEventProperty(block: CfnApplicationWindowsEventPropertyDsl.() -> Unit
