...
public class CfnDeliveryStreamOrcSerDePropertyDsl {
   ...
   * To turn off dictionary encoding, set this fraction to a number that is less than the number of
   * distinct keys in a dictionary. To always use dictionary encoding, set this threshold to 1.
   */
