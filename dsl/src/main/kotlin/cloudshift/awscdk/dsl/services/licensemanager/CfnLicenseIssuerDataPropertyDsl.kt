...
public class CfnLicenseIssuerDataPropertyDsl {
    ...
    /**
     * @param signKey Asymmetric KMS key from AWS Key Management Service . The KMS key must have a
     *   key usage of sign and verify, and support the RSASSA-PSS SHA-256 signing algorithm.
     */
