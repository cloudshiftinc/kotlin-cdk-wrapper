...
public class CfnPermissionsTableResourcePropertyDsl {
    ...
    /**
     * @param tableWildcard An empty object representing all tables under a database. If this field
     *   is specified instead of the `Name` field, all tables under `DatabaseName` will have
