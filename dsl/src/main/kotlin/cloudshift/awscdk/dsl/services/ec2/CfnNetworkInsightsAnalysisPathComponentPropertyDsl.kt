...
public class CfnNetworkInsightsAnalysisPathComponentPropertyDsl {
    ...
    /** @param inboundHeader The inbound header. */
    public fun inboundHeader(
        inboundHeader: CfnNetworkInsightsAnalysis.AnalysisPacketHeaderProperty
    ) {
        cdkBuilder.inboundHeader(inboundHeader)
    }
    ...
    public fun outboundHeader(
        outboundHeader: CfnNetworkInsightsAnalysis.AnalysisPacketHeaderProperty
    ) {
        cdkBuilder.outboundHeader(outboundHeader)
    }
