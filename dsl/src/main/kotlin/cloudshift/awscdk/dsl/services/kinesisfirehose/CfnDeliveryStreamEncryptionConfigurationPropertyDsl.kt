...
public class CfnDeliveryStreamEncryptionConfigurationPropertyDsl {
    ...
    public fun kmsEncryptionConfig(
        kmsEncryptionConfig: CfnDeliveryStream.KMSEncryptionConfigProperty
    ) {
        cdkBuilder.kmsEncryptionConfig(kmsEncryptionConfig)
    }

    /**
     * @param noEncryptionConfig Disables encryption. For valid values, see the `NoEncryptionConfig`
     *   content for the
