...
public class CfnFileSystemOntapConfigurationPropertyDsl {
  ...
  /**
   * @param routeTableIds (Multi-AZ only) Specifies the virtual private cloud (VPC) route tables in
   * which your file system's endpoints will be created.
   * You should specify all VPC route tables associated with the subnets in which your clients are
