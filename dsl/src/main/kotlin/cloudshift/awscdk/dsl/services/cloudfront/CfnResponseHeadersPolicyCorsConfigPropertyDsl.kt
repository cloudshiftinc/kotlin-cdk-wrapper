...
public class CfnResponseHeadersPolicyCorsConfigPropertyDsl {
    ...
    public fun accessControlAllowHeaders(accessControlAllowHeaders: CfnResponseHeadersPolicy.AccessControlAllowHeadersProperty) {
        cdkBuilder.accessControlAllowHeaders(accessControlAllowHeaders)
    }
    ...
    public fun accessControlAllowMethods(accessControlAllowMethods: CfnResponseHeadersPolicy.AccessControlAllowMethodsProperty) {
        cdkBuilder.accessControlAllowMethods(accessControlAllowMethods)
    }
    ...
    public fun accessControlAllowOrigins(accessControlAllowOrigins: CfnResponseHeadersPolicy.AccessControlAllowOriginsProperty) {
        cdkBuilder.accessControlAllowOrigins(accessControlAllowOrigins)
    }
    ...
    public fun accessControlExposeHeaders(accessControlExposeHeaders: CfnResponseHeadersPolicy.AccessControlExposeHeadersProperty) {
        cdkBuilder.accessControlExposeHeaders(accessControlExposeHeaders)
    }
