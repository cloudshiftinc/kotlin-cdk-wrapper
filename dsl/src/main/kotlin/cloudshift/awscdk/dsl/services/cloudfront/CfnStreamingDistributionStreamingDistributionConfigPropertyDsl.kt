...
public class CfnStreamingDistributionStreamingDistributionConfigPropertyDsl {
  ...
  /**
   * @param priceClass A complex type that contains information about price class for this streaming
   * distribution.
   */
  ...
  /**
   * @param s3Origin A complex type that contains information about the Amazon S3 bucket from which
  ...
  /**
   * @param trustedSigners A complex type that specifies any AWS accounts that you want to permit to
