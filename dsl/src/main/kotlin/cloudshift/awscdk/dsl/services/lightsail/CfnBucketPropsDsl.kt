...
public class CfnBucketPropsDsl {
    ...
    /**
     * @param bundleId The bundle ID for the bucket (for example, `small_1_0` ). A bucket bundle
    ...
    /**
     * @param objectVersioning Indicates whether object versioning is enabled for the bucket. The
