...
public class CfnNetworkInsightsAnalysisExplanationPropertyDsl {
  ...
  public
      fun classicLoadBalancerListener(classicLoadBalancerListener: CfnNetworkInsightsAnalysis.AnalysisLoadBalancerListenerProperty) {
    cdkBuilder.classicLoadBalancerListener(classicLoadBalancerListener)
  }
  ...
  public
      fun customerGateway(customerGateway: CfnNetworkInsightsAnalysis.AnalysisComponentProperty) {
    cdkBuilder.customerGateway(customerGateway)
  }
  ...
  public
      fun ingressRouteTable(ingressRouteTable: CfnNetworkInsightsAnalysis.AnalysisComponentProperty) {
    cdkBuilder.ingressRouteTable(ingressRouteTable)
  }
  ...
  public
      fun internetGateway(internetGateway: CfnNetworkInsightsAnalysis.AnalysisComponentProperty) {
    cdkBuilder.internetGateway(internetGateway)
  }
  ...
  public
      fun loadBalancerTarget(loadBalancerTarget: CfnNetworkInsightsAnalysis.AnalysisLoadBalancerTargetProperty) {
    cdkBuilder.loadBalancerTarget(loadBalancerTarget)
  }
  ...
  public
      fun loadBalancerTargetGroup(loadBalancerTargetGroup: CfnNetworkInsightsAnalysis.AnalysisComponentProperty) {
    cdkBuilder.loadBalancerTargetGroup(loadBalancerTargetGroup)
  }
  ...
  public
      fun networkInterface(networkInterface: CfnNetworkInsightsAnalysis.AnalysisComponentProperty) {
    cdkBuilder.networkInterface(networkInterface)
  }
  ...
  public
      fun subnetRouteTable(subnetRouteTable: CfnNetworkInsightsAnalysis.AnalysisComponentProperty) {
    cdkBuilder.subnetRouteTable(subnetRouteTable)
  }
  ...
  public
      fun transitGatewayAttachment(transitGatewayAttachment: CfnNetworkInsightsAnalysis.AnalysisComponentProperty) {
    cdkBuilder.transitGatewayAttachment(transitGatewayAttachment)
  }
  ...
  public
      fun transitGatewayRouteTable(transitGatewayRouteTable: CfnNetworkInsightsAnalysis.AnalysisComponentProperty) {
    cdkBuilder.transitGatewayRouteTable(transitGatewayRouteTable)
  }
  ...
  public
      fun vpcPeeringConnection(vpcPeeringConnection: CfnNetworkInsightsAnalysis.AnalysisComponentProperty) {
    cdkBuilder.vpcPeeringConnection(vpcPeeringConnection)
  }
