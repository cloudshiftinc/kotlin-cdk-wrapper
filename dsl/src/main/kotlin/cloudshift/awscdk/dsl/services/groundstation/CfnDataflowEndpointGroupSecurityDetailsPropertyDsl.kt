...
public class CfnDataflowEndpointGroupSecurityDetailsPropertyDsl {
     ...
     *   `arn:aws:iam::1234567890:role/DataDeliveryServiceRole` . Ground Station will assume this
     *   role and create an ENI in your VPC on the specified subnet upon creation of a dataflow
     *   endpoint group. This ENI is used as the ingress/egress point for data streamed during a
     *   satellite contact.
     */
