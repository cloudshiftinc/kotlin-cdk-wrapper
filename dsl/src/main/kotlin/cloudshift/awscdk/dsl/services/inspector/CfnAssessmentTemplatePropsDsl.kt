...
public class CfnAssessmentTemplatePropsDsl {
    private val cdkBuilder: CfnAssessmentTemplateProps.Builder =
     ...
     *   that you want to create. You can create several assessment templates for the same
     *   assessment target. The names of the assessment templates that correspond to a particular
     ...
     *   finding that is generated by the assessment run that uses this assessment template. Within
     *   an assessment template, each key must be unique.
     */
