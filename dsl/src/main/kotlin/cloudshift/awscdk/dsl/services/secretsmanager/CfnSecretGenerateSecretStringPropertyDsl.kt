...
public class CfnSecretGenerateSecretStringPropertyDsl {
    ...
    /**
     * @param excludeLowercase Specifies whether to exclude lowercase letters from the password. If
    ...
    /**
     * @param excludeUppercase Specifies whether to exclude uppercase letters from the password. If
     ...
     *   generated password. This pair is added to the JSON structure specified by the
     ...
     *   letter, one number, and one punctuation. If you don't include this switch, the password
    ...
    /**
     * @param secretStringTemplate A template that the generated string must match. When you make a
