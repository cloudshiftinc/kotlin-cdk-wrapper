...
@CdkDslMarker
public class CfnDashboardBarChartVisualPropertyDsl {
  private val cdkBuilder: CfnDashboard.BarChartVisualProperty.Builder =
  ...
  public fun build(): CfnDashboard.BarChartVisualProperty {
