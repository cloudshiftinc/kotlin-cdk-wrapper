...
public class CfnVirtualNodeAwsCloudMapServiceDiscoveryPropertyDsl {
     ...
     *   filter instances by any custom attribute that you specified when you registered the
     *   instance. Only instances that match all of the specified key/value pairs will be returned.
     */
