...
public object evidently {
  ...
  public inline
      fun cfnExperimentMetricGoalObjectProperty(block: CfnExperimentMetricGoalObjectPropertyDsl.() -> Unit
  ...
  public inline
      fun cfnExperimentOnlineAbConfigObjectProperty(block: CfnExperimentOnlineAbConfigObjectPropertyDsl.() -> Unit
  ...
  public inline fun cfnExperimentProps(block: CfnExperimentPropsDsl.() -> Unit = {}):
      CfnExperimentProps {
  ...
  public inline
      fun cfnExperimentRunningStatusObjectProperty(block: CfnExperimentRunningStatusObjectPropertyDsl.() -> Unit
  ...
  public inline
      fun cfnExperimentTreatmentObjectProperty(block: CfnExperimentTreatmentObjectPropertyDsl.() -> Unit
  ...
  public inline
      fun cfnExperimentTreatmentToWeightProperty(block: CfnExperimentTreatmentToWeightPropertyDsl.() -> Unit
  ...
  public inline
      fun cfnFeatureEntityOverrideProperty(block: CfnFeatureEntityOverridePropertyDsl.() -> Unit =
  ...
  public inline
      fun cfnFeatureVariationObjectProperty(block: CfnFeatureVariationObjectPropertyDsl.() -> Unit =
  ...
  public inline
      fun cfnLaunchExecutionStatusObjectProperty(block: CfnLaunchExecutionStatusObjectPropertyDsl.() -> Unit
  ...
  public inline
      fun cfnLaunchGroupToWeightProperty(block: CfnLaunchGroupToWeightPropertyDsl.() -> Unit = {}):
  ...
  public inline
      fun cfnLaunchLaunchGroupObjectProperty(block: CfnLaunchLaunchGroupObjectPropertyDsl.() -> Unit
  ...
  public inline
      fun cfnLaunchMetricDefinitionObjectProperty(block: CfnLaunchMetricDefinitionObjectPropertyDsl.() -> Unit
  ...
  public inline
      fun cfnLaunchSegmentOverrideProperty(block: CfnLaunchSegmentOverridePropertyDsl.() -> Unit =
  ...
  public inline fun cfnLaunchStepConfigProperty(block: CfnLaunchStepConfigPropertyDsl.() -> Unit =
  ...
  public inline
      fun cfnProjectAppConfigResourceObjectProperty(block: CfnProjectAppConfigResourceObjectPropertyDsl.() -> Unit
  ...
  public inline
      fun cfnProjectDataDeliveryObjectProperty(block: CfnProjectDataDeliveryObjectPropertyDsl.() -> Unit
  ...
  public inline
      fun cfnProjectS3DestinationProperty(block: CfnProjectS3DestinationPropertyDsl.() -> Unit =
