...
public class CfnCachePolicyCachePolicyConfigPropertyDsl {
  ...
  /**
   * @param defaultTtl The default amount of time, in seconds, that you want objects to stay in the
   * CloudFront cache before CloudFront sends another request to the origin to see if the object has
   * been updated. 
   * CloudFront uses this value as the object's time to live (TTL) only when the origin does *not*
   * send `Cache-Control` or `Expires` headers with the object. For more information, see [Managing How
  ...
  /**
   * @param maxTtl The maximum amount of time, in seconds, that objects stay in the CloudFront cache
   ...
   * the object. For more information, see [Managing How Long Content Stays in an Edge Cache
   * (Expiration)](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/Expiration.html)
   * in the *Amazon CloudFront Developer Guide* .
   *
   ...
   * The values included in the cache key are also included in requests that CloudFront sends to the
   * origin.
   */
  public
   ...
   */
  public
      fun parametersInCacheKeyAndForwardedToOrigin(parametersInCacheKeyAndForwardedToOrigin: CfnCachePolicy.ParametersInCacheKeyAndForwardedToOriginProperty) {
    cdkBuilder.parametersInCacheKeyAndForwardedToOrigin(parametersInCacheKeyAndForwardedToOrigin)
  }
