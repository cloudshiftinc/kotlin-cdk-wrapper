...
public class CfnChannelVpcOutputSettingsPropertyDsl {
     ...
     *   ENIs that will be created in Output VPC. Must specify one for SINGLE_PIPELINE, two for
     *   STANDARD channels
     */
     ...
     *   VPC network interfaces. If none are specified then the VPC default security group will be
     *   used
     */
    ...
    /**
     * @param subnetIds A list of VPC subnet IDs from the same VPC. If STANDARD channel, subnet IDs
