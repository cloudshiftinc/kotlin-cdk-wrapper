...
public class CfnWorkspaceDsl(
   ...
   * Single Sign-On) , or both to authenticate users for using the Grafana console within a workspace.
   * For more information, see [User authentication in Amazon Managed
