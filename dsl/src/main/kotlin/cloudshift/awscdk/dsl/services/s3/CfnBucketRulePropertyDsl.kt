...
public class CfnBucketRulePropertyDsl {
    ...
    public fun abortIncompleteMultipartUpload(abortIncompleteMultipartUpload: CfnBucket.AbortIncompleteMultipartUploadProperty) {
        cdkBuilder.abortIncompleteMultipartUpload(abortIncompleteMultipartUpload)
    }
    ...
    public fun noncurrentVersionExpiration(noncurrentVersionExpiration: CfnBucket.NoncurrentVersionExpirationProperty) {
        cdkBuilder.noncurrentVersionExpiration(noncurrentVersionExpiration)
    }
    ...
    public fun noncurrentVersionTransition(noncurrentVersionTransition: CfnBucket.NoncurrentVersionTransitionProperty) {
        cdkBuilder.noncurrentVersionTransition(noncurrentVersionTransition)
    }
