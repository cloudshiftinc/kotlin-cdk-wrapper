...
public object cloudwatch {
    ...
    public inline fun alarmActionConfig(block: AlarmActionConfigDsl.() -> Unit = {}): AlarmActionConfig {
    ...
    public inline fun alarmStatusWidget(block: AlarmStatusWidgetDsl.() -> Unit = {}): AlarmStatusWidget {
        val builder = AlarmStatusWidgetDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun alarmStatusWidgetProps(block: AlarmStatusWidgetPropsDsl.() -> Unit = {}): AlarmStatusWidgetProps {
    ...
    public inline fun cfnAlarmDimensionProperty(block: CfnAlarmDimensionPropertyDsl.() -> Unit = {}): CfnAlarm.DimensionProperty {
    ...
    public inline fun cfnAlarmMetricProperty(block: CfnAlarmMetricPropertyDsl.() -> Unit = {}): CfnAlarm.MetricProperty {
    ...
    public inline fun cfnAnomalyDetectorProps(block: CfnAnomalyDetectorPropsDsl.() -> Unit = {}): CfnAnomalyDetectorProps {
    ...
    public inline fun cfnCompositeAlarmProps(block: CfnCompositeAlarmPropsDsl.() -> Unit = {}): CfnCompositeAlarmProps {
    ...
    public inline fun cfnDashboardProps(block: CfnDashboardPropsDsl.() -> Unit = {}): CfnDashboardProps {
    ...
    public inline fun cfnInsightRuleProps(block: CfnInsightRulePropsDsl.() -> Unit = {}): CfnInsightRuleProps {
    ...
    public inline fun cfnMetricStreamProps(block: CfnMetricStreamPropsDsl.() -> Unit = {}): CfnMetricStreamProps {
        val builder = CfnMetricStreamPropsDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun commonMetricOptions(block: CommonMetricOptionsDsl.() -> Unit = {}): CommonMetricOptions {
    ...
    public inline fun compositeAlarmProps(block: CompositeAlarmPropsDsl.() -> Unit = {}): CompositeAlarmProps {
        val builder = CompositeAlarmPropsDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun createAlarmOptions(block: CreateAlarmOptionsDsl.() -> Unit = {}): CreateAlarmOptions {
    ...
    public inline fun customWidgetProps(block: CustomWidgetPropsDsl.() -> Unit = {}): CustomWidgetProps {
    ...
    public inline fun dashboardVariable(block: DashboardVariableDsl.() -> Unit = {}): DashboardVariable {
        val builder = DashboardVariableDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun dashboardVariableOptions(block: DashboardVariableOptionsDsl.() -> Unit = {}): DashboardVariableOptions {
    ...
    public inline fun horizontalAnnotation(block: HorizontalAnnotationDsl.() -> Unit = {}): HorizontalAnnotation {
    ...
    public inline fun logQueryWidgetProps(block: LogQueryWidgetPropsDsl.() -> Unit = {}): LogQueryWidgetProps {
    ...
    public inline fun mathExpressionOptions(block: MathExpressionOptionsDsl.() -> Unit = {}): MathExpressionOptions {
        val builder = MathExpressionOptionsDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun mathExpressionProps(block: MathExpressionPropsDsl.() -> Unit = {}): MathExpressionProps {
    ...
    public inline fun metricExpressionConfig(block: MetricExpressionConfigDsl.() -> Unit = {}): MetricExpressionConfig {
    ...
    public inline fun metricWidgetProps(block: MetricWidgetPropsDsl.() -> Unit = {}): MetricWidgetProps {
    ...
    public inline fun singleValueWidget(block: SingleValueWidgetDsl.() -> Unit = {}): SingleValueWidget {
        val builder = SingleValueWidgetDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun singleValueWidgetProps(block: SingleValueWidgetPropsDsl.() -> Unit = {}): SingleValueWidgetProps {
