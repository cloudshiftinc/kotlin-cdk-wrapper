...
public class CfnStackDsl(
   ...
   * of available agent version numbers, call
   ...
   * Berkshelf and the Berkshelf version on Chef 11.10 stacks. For more information, see [Create a New
   * Stack](https://docs.aws.amazon.com/opsworks/latest/userguide/workingstacks-creating.html) . 
   */
   ...
   * @param cloneAppIds If you're cloning an AWS OpsWorks stack, a list of AWS OpsWorks application
   * stack IDs from the source stack to include in the cloned stack. 
   */
   ...
   * @param clonePermissions If you're cloning an AWS OpsWorks stack, indicates whether to clone the
   ...
   * @param useOpsworksSecurityGroups Whether to associate the AWS OpsWorks Stacks built-in security
