...
public object origins {
    public inline fun httpOrigin(domainName: String, block: HttpOriginDsl.() -> Unit = {}): HttpOrigin {
    ...
    public inline fun loadBalancerV2OriginProps(block: LoadBalancerV2OriginPropsDsl.() -> Unit = {}): LoadBalancerV2OriginProps {
    ...
    public inline fun restApiOrigin(restApi: RestApi, block: RestApiOriginDsl.() -> Unit = {}): RestApiOrigin {
        val builder = RestApiOriginDsl(restApi)
        builder.apply(block)
        return builder.build()
    }

    public inline fun restApiOriginProps(block: RestApiOriginPropsDsl.() -> Unit = {}): RestApiOriginProps {
