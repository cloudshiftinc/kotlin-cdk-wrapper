...
public class CfnComputeEnvironmentLaunchTemplateSpecificationPropertyDsl {
    ...
    /**
     * @param version The version number of the launch template, `$Latest` , or `$Default` . If the
     *   value is `$Latest` , the latest version of the launch template is used. If the value is
     ...
     * updating a compute environment, changing the launch template requires an infrastructure
    ...
    public fun build(): CfnComputeEnvironment.LaunchTemplateSpecificationProperty =
        cdkBuilder.build()
}
