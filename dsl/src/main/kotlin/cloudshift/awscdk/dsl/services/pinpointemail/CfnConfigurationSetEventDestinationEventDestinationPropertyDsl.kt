...
public class CfnConfigurationSetEventDestinationEventDestinationPropertyDsl {
     ...
     *   email events. You can use Amazon CloudWatch to monitor and gain insights on your email
     *   sending metrics.
     */
    ...
    /**
     * @param enabled If `true` , the event destination is enabled. When the event destination is
     ...
     *   destination for email events. You can use Amazon Kinesis Data Firehose to stream data to
    ...
    /**
     * @param matchingEventTypes The types of events that Amazon Pinpoint sends to the specified
     *   event destinations. Acceptable values: `SEND` , `REJECT` , `BOUNCE` , `COMPLAINT` ,
     ...
     *   events. You can use Amazon Pinpoint events to create attributes in Amazon Pinpoint
     *   projects. You can use these attributes to create segments for your campaigns.
     */
    ...
    public fun pinpointDestination(
        pinpointDestination: CfnConfigurationSetEventDestination.PinpointDestinationProperty
    ) {
        cdkBuilder.pinpointDestination(pinpointDestination)
    }

    /**
     * @param snsDestination An object that defines an Amazon SNS destination for email events. You
