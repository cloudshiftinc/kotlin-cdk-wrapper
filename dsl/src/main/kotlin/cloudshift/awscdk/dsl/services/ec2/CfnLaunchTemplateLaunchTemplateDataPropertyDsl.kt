...
public class CfnLaunchTemplateLaunchTemplateDataPropertyDsl {
    ...
    public fun capacityReservationSpecification(capacityReservationSpecification: CfnLaunchTemplate.CapacityReservationSpecificationProperty) {
        cdkBuilder.capacityReservationSpecification(capacityReservationSpecification)
    }
    ...
    public fun creditSpecification(creditSpecification: CfnLaunchTemplate.CreditSpecificationProperty) {
        cdkBuilder.creditSpecification(creditSpecification)
    }
    ...
    public fun instanceMarketOptions(instanceMarketOptions: CfnLaunchTemplate.InstanceMarketOptionsProperty) {
        cdkBuilder.instanceMarketOptions(instanceMarketOptions)
    }
    ...
    public fun instanceRequirements(instanceRequirements: CfnLaunchTemplate.InstanceRequirementsProperty) {
        cdkBuilder.instanceRequirements(instanceRequirements)
    }
    ...
    public fun privateDnsNameOptions(privateDnsNameOptions: CfnLaunchTemplate.PrivateDnsNameOptionsProperty) {
        cdkBuilder.privateDnsNameOptions(privateDnsNameOptions)
    }
