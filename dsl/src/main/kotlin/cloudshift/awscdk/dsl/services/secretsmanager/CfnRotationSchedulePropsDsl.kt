...
public class CfnRotationSchedulePropsDsl {
     ...
     *   . To use a rotation function that already exists, specify `RotationLambdaARN` instead. For
     *   Amazon RDS master user credentials, see
     ...
     *   until the next scheduled rotation window. The rotation schedule is defined in
     *   `RotationRules` .
     *
    ...
    /**
     * @param rotationLambdaArn The ARN of an existing Lambda rotation function. To specify a
    ...
    /**
     * @param secretId The ARN or name of the secret to rotate. To reference a secret also created
