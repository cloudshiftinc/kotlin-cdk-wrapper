...
public class CfnTemplateReferenceLineLabelConfigurationPropertyDsl {
    ...
    public fun customLabelConfiguration(
        customLabelConfiguration: CfnTemplate.ReferenceLineCustomLabelConfigurationProperty
    ) {
        cdkBuilder.customLabelConfiguration(customLabelConfiguration)
    }
    ...
    public fun valueLabelConfiguration(
        valueLabelConfiguration: CfnTemplate.ReferenceLineValueLabelConfigurationProperty
    ) {
        cdkBuilder.valueLabelConfiguration(valueLabelConfiguration)
    }
