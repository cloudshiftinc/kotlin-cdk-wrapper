...
public class CfnEnvironmentFederationParametersPropertyDsl {
  ...
  /**
   * @param applicationCallBackUrl The redirect or sign-in URL that should be entered into the SAML
  ...
  /**
   * @param samlMetadataUrl Provide the metadata URL from your SAML 2.0 compliant identity provider
   * (IdP).
   */
