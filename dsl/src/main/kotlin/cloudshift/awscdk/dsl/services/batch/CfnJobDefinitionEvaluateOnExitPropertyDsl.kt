...
public class CfnJobDefinitionEvaluateOnExitPropertyDsl {
   ...
   * `ExitCode` returned for a job.
   * The pattern can be up to 512 characters long. It can contain only numbers, and can end with an
  ...
  /**
   * @param onStatusReason Contains a glob pattern to match against the `StatusReason` returned for
   * a job.
   * The pattern can contain up to 512 characters. It can contain letters, numbers, periods (.),
