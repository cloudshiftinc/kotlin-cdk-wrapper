...
public class CfnNotebookInstancePropsDsl {
     ...
     *   with the notebook instance. Currently, only one instance type can be associated with a
     ...
     *   the notebook instance. These can be either the names of Git repositories stored as
     ...
     *   in any other Git repository. These repositories are cloned at the same level as the default
     ...
     *   default code repository. This can be either the name of a Git repository stored as a
     ...
     *   notebook instance. For information about lifecycle configurations, see
     ...
     *   necessary permissions so SageMaker can perform these tasks. The policy must allow the
    ...
    /**
     * @param securityGroupIds The VPC security group IDs, in the form sg-xxxxxxxx. The security
