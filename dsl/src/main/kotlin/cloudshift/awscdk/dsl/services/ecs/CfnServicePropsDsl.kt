...
public class CfnServicePropsDsl {
  ...
  /**
   * @param desiredCount The number of instantiations of the specified task definition to place and
  ...
  /**
   * @param role The name or full Amazon Resource Name (ARN) of the IAM role that allows Amazon ECS
   * to make calls to your load balancer on your behalf.
   ...
   * see [Services](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/ecs_services.html) .
