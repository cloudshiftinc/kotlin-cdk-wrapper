 ...
 */
public inline fun CfnLocationFSxONTAP.setProtocol(
...
public inline fun CfnLocationFSxOpenZFS.setProtocol(
 ...
 */
public inline fun CfnLocationHDFS.setQopConfiguration(
 ...
 */
public inline fun CfnLocationS3.setS3Config(
...
public inline fun CfnLocationSMB.setMountOptions(
 ...
 */
public inline fun CfnStorageSystem.setServerConfiguration(
 ...
 * interface.
 */
public inline fun CfnStorageSystem.setServerCredentials(
