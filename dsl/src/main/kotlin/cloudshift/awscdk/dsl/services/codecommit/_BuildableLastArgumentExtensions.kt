...
public inline fun IRepository.onCommit(arg0: String, block: OnCommitOptionsDsl.() -> Unit = {}): Rule {
...
public inline fun IRepository.onStateChange(arg0: String, block: OnEventOptionsDsl.() -> Unit = {}): Rule {
    val builder = OnEventOptionsDsl()
    builder.apply(block)
...
public inline fun Repository.onStateChange(id: String, block: OnEventOptionsDsl.() -> Unit = {}): Rule {
    val builder = OnEventOptionsDsl()
    builder.apply(block)
