...
public object appintegrations {
    ...
    public inline fun cfnDataIntegrationFileConfigurationProperty(
    ...
    public inline fun cfnDataIntegrationProps(block: CfnDataIntegrationPropsDsl.() -> Unit = {}): CfnDataIntegrationProps {
        val builder = CfnDataIntegrationPropsDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun cfnDataIntegrationScheduleConfigProperty(
    ...
    public inline fun cfnEventIntegrationEventFilterProperty(
    ...
    public inline fun cfnEventIntegrationProps(block: CfnEventIntegrationPropsDsl.() -> Unit = {}): CfnEventIntegrationProps {
