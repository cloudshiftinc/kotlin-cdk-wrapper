...
public class CfnComputeEnvironmentPropsDsl {
    private val cdkBuilder: CfnComputeEnvironmentProps.Builder =
        CfnComputeEnvironmentProps.builder()

    /**
     * @param computeEnvironmentName The name for your compute environment. It can be up to 128
     ...
     *   compute environments. For more information, see
     ...
     *   update is made that requires replacing the instances in the compute environment. The
     *   default value is `true` . To enable more properties to be updated, set this property to
     ...
     *   to make calls to other AWS services on your behalf. For more information, see
    ...
    /**
     * @param state The state of the compute environment. If the state is `ENABLED` , then the
    ...
    /**
     * @param type The type of the compute environment: `MANAGED` or `UNMANAGED` . For more
     *   information, see
     *   [Compute Environments](https://docs.aws.amazon.com/batch/latest/userguide/compute_environments.html)
     *   in the *AWS Batch User Guide* .
     */
