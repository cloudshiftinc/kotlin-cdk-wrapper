...
public class CfnPipePipeTargetParametersPropertyDsl {
    ...
    public fun cloudWatchLogsParameters(cloudWatchLogsParameters: CfnPipe.PipeTargetCloudWatchLogsParametersProperty) {
        cdkBuilder.cloudWatchLogsParameters(cloudWatchLogsParameters)
    }
    ...
    public fun eventBridgeEventBusParameters(eventBridgeEventBusParameters: CfnPipe.PipeTargetEventBridgeEventBusParametersProperty) {
        cdkBuilder.eventBridgeEventBusParameters(eventBridgeEventBusParameters)
    }
    ...
    public fun kinesisStreamParameters(kinesisStreamParameters: CfnPipe.PipeTargetKinesisStreamParametersProperty) {
        cdkBuilder.kinesisStreamParameters(kinesisStreamParameters)
    }
    ...
    public fun lambdaFunctionParameters(lambdaFunctionParameters: CfnPipe.PipeTargetLambdaFunctionParametersProperty) {
        cdkBuilder.lambdaFunctionParameters(lambdaFunctionParameters)
    }
    ...
    public fun redshiftDataParameters(redshiftDataParameters: CfnPipe.PipeTargetRedshiftDataParametersProperty) {
        cdkBuilder.redshiftDataParameters(redshiftDataParameters)
    }
    ...
    public fun sageMakerPipelineParameters(sageMakerPipelineParameters: CfnPipe.PipeTargetSageMakerPipelineParametersProperty) {
        cdkBuilder.sageMakerPipelineParameters(sageMakerPipelineParameters)
    }
    ...
    public fun stepFunctionStateMachineParameters(stepFunctionStateMachineParameters: CfnPipe.PipeTargetStateMachineParametersProperty) {
        cdkBuilder.stepFunctionStateMachineParameters(stepFunctionStateMachineParameters)
    }
