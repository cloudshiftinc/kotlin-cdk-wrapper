...
public class CfnDomainPropsDsl {
     ...
     *   specifies who can access the OpenSearch Service domain and their permissions. For more
     *   information, see
    ...
    /**
     * @param advancedOptions Additional options to specify for the OpenSearch Service domain. For
     ...
     *   authentication. If you specify advanced security options, you must also enable node-to-node
     *   encryption (
    ...
    /**
     * @param domainName A name for the OpenSearch Service domain. The name must have a minimum
     *   length of 3 and a maximum length of 28. If you don't specify a name, AWS CloudFormation
     *   generates a unique physical ID and uses that ID for the domain name. For more information,
     *   see
     ...
     *   are attached to data nodes in the OpenSearch Service domain. For more information, see
    ...
    /**
     * @param engineVersion The version of OpenSearch to use. The value must be in the format
     *   `OpenSearch_X.Y` or `Elasticsearch_X.Y` . If not specified, the latest version of
     *   OpenSearch is used. For information about the versions that OpenSearch Service supports,
     *   see
     ...
     *   on the types of logs you want to publish. Each key needs a valid `LogPublishingOption`
     *   value. For the full syntax, see the
    ...
    /**
     * @param nodeToNodeEncryptionOptions Specifies whether node-to-node encryption is enabled. See
    ...
    /**
     * @param snapshotOptions *DEPRECATED* . The automated snapshot configuration for the OpenSearch
     *   Service domain indexes.
     */
