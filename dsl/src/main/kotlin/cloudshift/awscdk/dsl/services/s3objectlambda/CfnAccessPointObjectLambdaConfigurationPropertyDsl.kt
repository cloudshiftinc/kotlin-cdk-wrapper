...
public class CfnAccessPointObjectLambdaConfigurationPropertyDsl {
    ...
    /**
     * @param allowedFeatures A container for allowed features. Valid inputs are `GetObject-Range` ,
    ...
    /**
     * @param cloudWatchMetricsEnabled A container for whether the CloudWatch metrics configuration
     *   is enabled.
     */
