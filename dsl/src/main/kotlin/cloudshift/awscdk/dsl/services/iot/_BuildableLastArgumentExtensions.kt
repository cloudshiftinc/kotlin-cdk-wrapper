...
public inline fun CfnAccountAuditConfiguration.setAuditNotificationTargetConfigurations(
...
public inline fun CfnDomainConfiguration.setAuthorizerConfig(
...
public inline fun CfnMitigationAction.setActionParams(
...
public inline fun CfnProvisioningTemplate.setPreProvisioningHook(
