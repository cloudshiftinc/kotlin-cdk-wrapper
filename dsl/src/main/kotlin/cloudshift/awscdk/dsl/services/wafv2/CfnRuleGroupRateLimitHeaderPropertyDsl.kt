 ...
 */
@CdkDslMarker
public class CfnRuleGroupRateLimitHeaderPropertyDsl {
    private val cdkBuilder: CfnRuleGroup.RateLimitHeaderProperty.Builder =
    ...
    public fun build(): CfnRuleGroup.RateLimitHeaderProperty {
