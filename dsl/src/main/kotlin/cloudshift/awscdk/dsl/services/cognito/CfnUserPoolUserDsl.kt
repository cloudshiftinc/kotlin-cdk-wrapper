...
public class CfnUserPoolUserDsl(
     ...
     * invokes the function that is assigned to the *pre sign-up* trigger. When Amazon Cognito
     ...
     * the ClientMetadata property. In your function code in AWS Lambda , you can process the
     ...
     *
     * Must be unique within the user pool. Must be a UTF-8 string between 1 and 128 characters.
     ...
     *
     * This is an array of name-value pairs that contain user attributes and attribute values that
     * you can use for custom validation, such as restricting the types of user accounts that can be
     * registered. For example, you might choose to allow or disallow user sign-up based on the
     * user's domain.
     *
