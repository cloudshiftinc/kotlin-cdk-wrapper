...
public class CfnApplicationDsl(
     ...
     * configuration, you map this streaming source to an in-application stream that is created.
     * Your application code can then query the in-application stream like a table (you can think of
     * it as a constantly updating table).
     *
