...
public class CfnPackagingConfigurationHlsManifestPropertyDsl {
    ...
    /**
     * @param adMarkers This setting controls ad markers in the packaged content. Valid values:
     ...
     *   enabled, the output includes an additional I-frame only stream, along with the other
     *   tracks.
     */
    ...
    /**
     * @param repeatExtXKey Repeat the `EXT-X-KEY` directive for every media segment. This might
     *   result in an increase in client requests to the DRM server.
     */
