...
public object networkmanager {
    ...
    public inline fun cfnConnectAttachmentProps(block: CfnConnectAttachmentPropsDsl.() -> Unit = {}): CfnConnectAttachmentProps {
    ...
    public inline fun cfnConnectPeerProps(block: CfnConnectPeerPropsDsl.() -> Unit = {}): CfnConnectPeerProps {
    ...
    public inline fun cfnCoreNetworkProps(block: CfnCoreNetworkPropsDsl.() -> Unit = {}): CfnCoreNetworkProps {
    ...
    public inline fun cfnDeviceLocationProperty(block: CfnDeviceLocationPropertyDsl.() -> Unit = {}): CfnDevice.LocationProperty {
    ...
    public inline fun cfnGlobalNetworkProps(block: CfnGlobalNetworkPropsDsl.() -> Unit = {}): CfnGlobalNetworkProps {
    ...
    public inline fun cfnLinkAssociationProps(block: CfnLinkAssociationPropsDsl.() -> Unit = {}): CfnLinkAssociationProps {
        val builder = CfnLinkAssociationPropsDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun cfnLinkBandwidthProperty(block: CfnLinkBandwidthPropertyDsl.() -> Unit = {}): CfnLink.BandwidthProperty {
    ...
    public inline fun cfnSiteLocationProperty(block: CfnSiteLocationPropertyDsl.() -> Unit = {}): CfnSite.LocationProperty {
    ...
    public inline fun cfnVpcAttachmentProps(block: CfnVpcAttachmentPropsDsl.() -> Unit = {}): CfnVpcAttachmentProps {
