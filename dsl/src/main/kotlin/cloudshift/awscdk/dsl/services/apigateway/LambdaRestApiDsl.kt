 ...
 * specified path. If not defined, you will need to explicity add resources and methods to the API.
 *
 * Example:
 * ```
 * Function backend;
...
public class LambdaRestApiDsl(
     ...
     *
     * This handler will be used as a the default integration for all methods in this API, unless
