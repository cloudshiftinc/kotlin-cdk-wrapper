 ...
 */
@CdkDslMarker
public class CfnDataQualityJobDefinitionVpcConfigPropertyDsl {
    private val cdkBuilder: CfnDataQualityJobDefinition.VpcConfigProperty.Builder =
    ...
    public fun build(): CfnDataQualityJobDefinition.VpcConfigProperty {
