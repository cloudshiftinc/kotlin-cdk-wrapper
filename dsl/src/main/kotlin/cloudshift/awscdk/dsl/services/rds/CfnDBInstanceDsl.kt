 ...
 * configuration of the DB instance, AWS CloudFormation applies the changes in the template during
 ...
 * references from other dependent resources to point to the replacement DB instance, and finally
 * deletes the old DB instance.
 *
...
public class CfnDBInstanceDsl(
     ...
     * in the *Amazon RDS User Guide.* For more information about DB instance class pricing and AWS
     * Region support for DB instance classes, see
     ...
     * name, which resolves to a public IP address. If you specify false, AWS CloudFormation creates
     * an internal instance with a DNS name that resolves to a private IP address.
     *
