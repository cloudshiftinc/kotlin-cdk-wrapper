...
public object lightsail {
  ...
  public inline fun cfnBucketAccessRulesProperty(block: CfnBucketAccessRulesPropertyDsl.() -> Unit =
  ...
  public inline fun cfnContainerContainerProperty(block: CfnContainerContainerPropertyDsl.() -> Unit
  ...
  public inline
      fun cfnContainerContainerServiceDeploymentProperty(block: CfnContainerContainerServiceDeploymentPropertyDsl.() -> Unit
  ...
  public inline
      fun cfnContainerEnvironmentVariableProperty(block: CfnContainerEnvironmentVariablePropertyDsl.() -> Unit
  ...
  public inline
      fun cfnContainerHealthCheckConfigProperty(block: CfnContainerHealthCheckConfigPropertyDsl.() -> Unit
  ...
  public inline fun cfnContainerPortInfoProperty(block: CfnContainerPortInfoPropertyDsl.() -> Unit =
  ...
  public inline fun cfnContainerProps(block: CfnContainerPropsDsl.() -> Unit = {}):
      CfnContainerProps {
  ...
  public inline
      fun cfnContainerPublicDomainNameProperty(block: CfnContainerPublicDomainNamePropertyDsl.() -> Unit
  ...
  public inline
      fun cfnContainerPublicEndpointProperty(block: CfnContainerPublicEndpointPropertyDsl.() -> Unit
  ...
  public inline
      fun cfnDatabaseRelationalDatabaseParameterProperty(block: CfnDatabaseRelationalDatabaseParameterPropertyDsl.() -> Unit
  ...
  public inline fun cfnDiskAddOnProperty(block: CfnDiskAddOnPropertyDsl.() -> Unit = {}):
  ...
  public inline
      fun cfnDiskAutoSnapshotAddOnProperty(block: CfnDiskAutoSnapshotAddOnPropertyDsl.() -> Unit =
  ...
  public inline fun cfnDiskLocationProperty(block: CfnDiskLocationPropertyDsl.() -> Unit = {}):
  ...
  public inline
      fun cfnDistributionCacheBehaviorPerPathProperty(block: CfnDistributionCacheBehaviorPerPathPropertyDsl.() -> Unit
  ...
  public inline
      fun cfnDistributionCacheSettingsProperty(block: CfnDistributionCacheSettingsPropertyDsl.() -> Unit
  ...
  public inline
      fun cfnDistributionCookieObjectProperty(block: CfnDistributionCookieObjectPropertyDsl.() -> Unit
  ...
  public inline
      fun cfnDistributionHeaderObjectProperty(block: CfnDistributionHeaderObjectPropertyDsl.() -> Unit
  ...
  public inline
      fun cfnDistributionInputOriginProperty(block: CfnDistributionInputOriginPropertyDsl.() -> Unit
  ...
  public inline
      fun cfnDistributionQueryStringObjectProperty(block: CfnDistributionQueryStringObjectPropertyDsl.() -> Unit
  ...
  public inline fun cfnInstanceAddOnProperty(block: CfnInstanceAddOnPropertyDsl.() -> Unit = {}):
  ...
  public inline
      fun cfnInstanceAutoSnapshotAddOnProperty(block: CfnInstanceAutoSnapshotAddOnPropertyDsl.() -> Unit
  ...
  public inline fun cfnInstanceDiskProperty(block: CfnInstanceDiskPropertyDsl.() -> Unit = {}):
  ...
  public inline fun cfnInstanceHardwareProperty(block: CfnInstanceHardwarePropertyDsl.() -> Unit =
  ...
  public inline fun cfnInstanceLocationProperty(block: CfnInstanceLocationPropertyDsl.() -> Unit =
  ...
  public inline
      fun cfnInstanceMonthlyTransferProperty(block: CfnInstanceMonthlyTransferPropertyDsl.() -> Unit
  ...
  public inline fun cfnInstanceNetworkingProperty(block: CfnInstanceNetworkingPropertyDsl.() -> Unit
  ...
  public inline fun cfnInstancePortProperty(block: CfnInstancePortPropertyDsl.() -> Unit = {}):
  ...
  public inline fun cfnInstanceStateProperty(block: CfnInstanceStatePropertyDsl.() -> Unit = {}):
  ...
  public inline
      fun cfnLoadBalancerTlsCertificateProps(block: CfnLoadBalancerTlsCertificatePropsDsl.() -> Unit
