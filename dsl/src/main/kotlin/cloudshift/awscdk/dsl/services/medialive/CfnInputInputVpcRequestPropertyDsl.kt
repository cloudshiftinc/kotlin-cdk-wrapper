...
public class CfnInputInputVpcRequestPropertyDsl {
     ...
     *   VPC network interfaces. The security groups require subnet IDs. If none are specified,
     *   MediaLive uses the VPC default security group.
     */
    ...
    /**
     * @param subnetIds The list of two VPC subnet IDs from the same VPC. You must associate subnet
     *   IDs to two unique Availability Zones.
     */
