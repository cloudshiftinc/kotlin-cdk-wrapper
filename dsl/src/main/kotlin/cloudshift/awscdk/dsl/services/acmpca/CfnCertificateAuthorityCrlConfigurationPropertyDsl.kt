 ...
 * certificate is revoked. When a certificate is revoked, it appears in the CRL until the
...
public class CfnCertificateAuthorityCrlConfigurationPropertyDsl {
     ...
     *   that enables the use of an alias for the CRL distribution point. Use this value if you
     ...
     * the use of special characters in URIs. Additionally, the value of the CNAME must not include
     * a protocol prefix such as "http://" or "https://".
     */
     ...
     *   enabled. You can use this value to enable certificate revocation for a new CA when you call
    ...
    /**
     * @param s3BucketName Name of the S3 bucket that contains the CRL. If you do not provide a
     *   value for the *CustomCname* argument, the name of your S3 bucket is placed into the *CRL
     *   Distribution Points* extension of the issued certificate. You can change the name of your
     *   bucket by calling the
     ...
     *   the CRL Amazon S3 bucket. If you choose PUBLIC_READ, the CRL will be accessible over the
     *   public internet. If you choose BUCKET_OWNER_FULL_CONTROL, only the owner of the CRL S3
     *   bucket can access the CRL, and your PKI clients may need an alternative method of access.
     *
     ...
     * value of this parameter as `BUCKET_OWNER_FULL_CONTROL` , and not doing so results in an
