...
public object iotanalytics {
    ...
    public inline fun cfnDatasetActionProperty(block: CfnDatasetActionPropertyDsl.() -> Unit = {}): CfnDataset.ActionProperty {
    ...
    public inline fun cfnDatasetFilterProperty(block: CfnDatasetFilterPropertyDsl.() -> Unit = {}): CfnDataset.FilterProperty {
    ...
    public inline fun cfnDatasetTriggerProperty(block: CfnDatasetTriggerPropertyDsl.() -> Unit = {}): CfnDataset.TriggerProperty {
    ...
    public inline fun cfnDatastoreProps(block: CfnDatastorePropsDsl.() -> Unit = {}): CfnDatastoreProps {
    ...
    public inline fun cfnPipelineFilterProperty(block: CfnPipelineFilterPropertyDsl.() -> Unit = {}): CfnPipeline.FilterProperty {
        val builder = CfnPipelineFilterPropertyDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun cfnPipelineLambdaProperty(block: CfnPipelineLambdaPropertyDsl.() -> Unit = {}): CfnPipeline.LambdaProperty {
        val builder = CfnPipelineLambdaPropertyDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun cfnPipelineMathProperty(block: CfnPipelineMathPropertyDsl.() -> Unit = {}): CfnPipeline.MathProperty {
