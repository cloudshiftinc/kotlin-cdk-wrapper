...
@CdkDslMarker
public class CfnAnalysisWaterfallVisualPropertyDsl {
    private val cdkBuilder: CfnAnalysis.WaterfallVisualProperty.Builder =
    ...
    public fun chartConfiguration(chartConfiguration: CfnAnalysis.WaterfallChartConfigurationProperty) {
        cdkBuilder.chartConfiguration(chartConfiguration)
    }
    ...
    public fun build(): CfnAnalysis.WaterfallVisualProperty {
