...
public class CfnEC2FleetPlacementPropertyDsl {
    ...
    /**
     * @param affinity The affinity setting for the instance on the Dedicated Host. This parameter
    ...
    /**
     * @param groupName The name of the placement group that the instance is in. If you specify
    ...
    /**
     * @param hostId The ID of the Dedicated Host on which the instance resides. This parameter is
     *   not supported for
     *   [CreateFleet](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_CreateFleet) or
     *   [ImportInstance](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_ImportInstance.html)
     *   .
     ...
     *   instances. If you specify this parameter, either omit the *Tenancy* parameter or set it to
     *   `host` .
     *
     * This parameter is not supported for
     * [CreateFleet](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_CreateFleet) .
    ...
    /**
     * @param partitionNumber The number of the partition that the instance is in. Valid only if the
     ...
     *   single-tenant hardware. This parameter is not supported for
