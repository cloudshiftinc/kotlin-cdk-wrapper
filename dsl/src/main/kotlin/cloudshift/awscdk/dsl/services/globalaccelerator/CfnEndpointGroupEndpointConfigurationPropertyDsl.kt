...
public class CfnEndpointGroupEndpointConfigurationPropertyDsl {
  ...
  /**
   * @param clientIpPreservationEnabled Indicates whether client IP address preservation is enabled
   * for an Application Load Balancer endpoint.
   ...
   * Resource Name (ARN) of the resource. If the endpoint is an Elastic IP address, this is the Elastic
   * IP address allocation ID. For Amazon EC2 instances, this is the EC2 instance ID. A resource must
