...
public class CfnFlowOutputPropsDsl {
     ...
     *   to this flow. Format the IP addresses as a Classless Inter-Domain Routing (CIDR) block; for
     *   example, 10.0.0.0/16.
     */
    ...
    /**
     * @param description A description of the output. This description is not visible outside of
     *   the current AWS account even if the account grants entitlements to other accounts.
     */
    ...
    /**
     * @param remoteId The identifier that is assigned to the Zixi receiver. This parameter applies
     *   only to outputs that use Zixi pull.
     */
    ...
    /**
     * @param streamId The stream ID that you want to use for this transport. This parameter applies
