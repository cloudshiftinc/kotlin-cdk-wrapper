...
public object lex {
    ...
    public inline fun cfnBotBotLocaleProperty(block: CfnBotBotLocalePropertyDsl.() -> Unit = {}): CfnBot.BotLocaleProperty {
        val builder = CfnBotBotLocalePropertyDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun cfnBotButtonProperty(block: CfnBotButtonPropertyDsl.() -> Unit = {}): CfnBot.ButtonProperty {
    ...
    public inline fun cfnBotConditionProperty(block: CfnBotConditionPropertyDsl.() -> Unit = {}): CfnBot.ConditionProperty {
    ...
    public inline fun cfnBotDataPrivacyProperty(block: CfnBotDataPrivacyPropertyDsl.() -> Unit = {}): CfnBot.DataPrivacyProperty {
    ...
    public inline fun cfnBotDialogStateProperty(block: CfnBotDialogStatePropertyDsl.() -> Unit = {}): CfnBot.DialogStateProperty {
    ...
    public inline fun cfnBotIntentProperty(block: CfnBotIntentPropertyDsl.() -> Unit = {}): CfnBot.IntentProperty {
    ...
    public inline fun cfnBotMessageProperty(block: CfnBotMessagePropertyDsl.() -> Unit = {}): CfnBot.MessageProperty {
    ...
    public inline fun cfnBotS3LocationProperty(block: CfnBotS3LocationPropertyDsl.() -> Unit = {}): CfnBot.S3LocationProperty {
        val builder = CfnBotS3LocationPropertyDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun cfnBotSSMLMessageProperty(block: CfnBotSSMLMessagePropertyDsl.() -> Unit = {}): CfnBot.SSMLMessageProperty {
    ...
    public inline fun cfnBotSampleValueProperty(block: CfnBotSampleValuePropertyDsl.() -> Unit = {}): CfnBot.SampleValueProperty {
    ...
    public inline fun cfnBotSlotProperty(block: CfnBotSlotPropertyDsl.() -> Unit = {}): CfnBot.SlotProperty {
        val builder = CfnBotSlotPropertyDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun cfnBotSlotTypeProperty(block: CfnBotSlotTypePropertyDsl.() -> Unit = {}): CfnBot.SlotTypeProperty {
    ...
    public inline fun cfnBotSlotValueProperty(block: CfnBotSlotValuePropertyDsl.() -> Unit = {}): CfnBot.SlotValueProperty {
    ...
    public inline fun cfnBotVersionProps(block: CfnBotVersionPropsDsl.() -> Unit = {}): CfnBotVersionProps {
