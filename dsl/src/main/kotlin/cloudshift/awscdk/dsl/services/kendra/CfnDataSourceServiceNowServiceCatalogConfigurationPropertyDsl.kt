...
public class CfnDataSourceServiceNowServiceCatalogConfigurationPropertyDsl {
     ...
     *   attachments of catalogs in your ServiceNow. Item that match the patterns are excluded from
     *   the index. Items that don't match the patterns are included in the index. If an item
     ...
     *   names. To create custom fields, use the `UpdateIndex` API before you map to ServiceNow
     ...
     *   attachments of catalogs in your ServiceNow. Item that match the patterns are included in
     *   the index. Items that don't match the patterns are excluded from the index. If an item
     *   matches both an inclusion and exclusion pattern, the exclusion pattern takes precedence and
     *   the item isn't included in the index.
     *
     * The regex is applied to the file name of the attachment.
