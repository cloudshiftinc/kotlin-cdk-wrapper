 ...
 * action in a `WebACL` , specifies the action that you want AWS WAF to take when a web request
...
public class CfnWebACLWafActionPropertyDsl {
    ...
    /**
     * @param type Specifies how you want AWS WAF to respond to requests that match the settings in
