...
public object stepfunctions {
    ...
    public inline fun afterwardsOptions(block: AfterwardsOptionsDsl.() -> Unit = {}): AfterwardsOptions {
    ...
    public inline fun cfnStateMachineAliasProps(block: CfnStateMachineAliasPropsDsl.() -> Unit = {}): CfnStateMachineAliasProps {
    ...
    public inline fun cfnStateMachineProps(block: CfnStateMachinePropsDsl.() -> Unit = {}): CfnStateMachineProps {
    ...
    public inline fun fileDefinitionBody(path: String, block: FileDefinitionBodyDsl.() -> Unit = {}): FileDefinitionBody {
    ...
    public inline fun singleStateOptions(block: SingleStateOptionsDsl.() -> Unit = {}): SingleStateOptions {
    ...
    public inline fun stateMachineProps(block: StateMachinePropsDsl.() -> Unit = {}): StateMachineProps {
    ...
    public inline fun taskMetricsConfig(block: TaskMetricsConfigDsl.() -> Unit = {}): TaskMetricsConfig {
        val builder = TaskMetricsConfigDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun taskStateBaseProps(block: TaskStateBasePropsDsl.() -> Unit = {}): TaskStateBaseProps {
