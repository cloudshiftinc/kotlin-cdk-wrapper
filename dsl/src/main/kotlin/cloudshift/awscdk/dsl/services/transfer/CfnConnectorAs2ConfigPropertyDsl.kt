...
public class CfnConnectorAs2ConfigPropertyDsl {
  ...
  /**
   * @param mdnResponse Used for outbound requests (from an AWS Transfer Family server to a partner
   * AS2 server) to determine whether the partner response for transfers is synchronous or
   * asynchronous.
