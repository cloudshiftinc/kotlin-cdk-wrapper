...
public class CfnApplicationV2ZeppelinApplicationConfigurationPropertyDsl {
    ...
    public fun catalogConfiguration(catalogConfiguration: CfnApplicationV2.CatalogConfigurationProperty) {
        cdkBuilder.catalogConfiguration(catalogConfiguration)
    }
    ...
    public fun deployAsApplicationConfiguration(deployAsApplicationConfiguration: CfnApplicationV2.DeployAsApplicationConfigurationProperty) {
        cdkBuilder.deployAsApplicationConfiguration(deployAsApplicationConfiguration)
    }
    ...
    public fun monitoringConfiguration(monitoringConfiguration: CfnApplicationV2.ZeppelinMonitoringConfigurationProperty) {
        cdkBuilder.monitoringConfiguration(monitoringConfiguration)
    }
