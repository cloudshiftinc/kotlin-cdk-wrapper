...
public class CfnServerPropsDsl {
    ...
    /**
     * @param endpointType The type of endpoint that you want your server to use. You can choose to
     ...
     *   `AWS_DIRECTORY_SERVICE` , `AWS _LAMBDA` or `API_GATEWAY` . Accepts an array containing all
     *   of the information required to use a directory in `AWS_DIRECTORY_SERVICE` or invoke a
    ...
    /**
     * @param identityProviderType The mode of authentication for a server. The default value is
     ...
     *   role that's used for executing the workflow. In addition to a workflow to execute when a
     *   file is uploaded completely, `WorkflowDetails` can also contain a workflow ID (and
