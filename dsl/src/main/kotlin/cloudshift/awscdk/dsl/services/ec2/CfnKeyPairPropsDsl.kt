...
public class CfnKeyPairPropsDsl {
    ...
    /** @param keyFormat The format of the key pair. Default: `pem` */
    public fun keyFormat(keyFormat: String) {
        cdkBuilder.keyFormat(keyFormat)
    }

    /** @param keyName A unique name for the key pair. Constraints: Up to 255 ASCII characters */
     ...
     *   instances. If the `PublicKeyMaterial` property is specified, the `KeyType` property is
     *   ignored, and the key type is inferred from the `PublicKeyMaterial` value.
     *
     * Default: `rsa`
     */
    ...
    /**
     * @param publicKeyMaterial The public key material. The `PublicKeyMaterial` property is used to
     *   import a key pair. If this property is not specified, then a new key pair will be created.
     */
