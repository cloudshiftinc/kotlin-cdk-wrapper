...
public object sagemaker {
    ...
    public inline fun cfnAppImageConfigProps(block: CfnAppImageConfigPropsDsl.() -> Unit = {}): CfnAppImageConfigProps {
    ...
    public inline fun cfnCodeRepositoryProps(block: CfnCodeRepositoryPropsDsl.() -> Unit = {}): CfnCodeRepositoryProps {
    ...
    public inline fun cfnDeviceDeviceProperty(block: CfnDeviceDevicePropertyDsl.() -> Unit = {}): CfnDevice.DeviceProperty {
    ...
    public inline fun cfnDeviceFleetProps(block: CfnDeviceFleetPropsDsl.() -> Unit = {}): CfnDeviceFleetProps {
    ...
    public inline fun cfnEndpointAlarmProperty(block: CfnEndpointAlarmPropertyDsl.() -> Unit = {}): CfnEndpoint.AlarmProperty {
    ...
    public inline fun cfnEndpointConfigProps(block: CfnEndpointConfigPropsDsl.() -> Unit = {}): CfnEndpointConfigProps {
    ...
    public inline fun cfnFeatureGroupProps(block: CfnFeatureGroupPropsDsl.() -> Unit = {}): CfnFeatureGroupProps {
    ...
    public inline fun cfnImageVersionProps(block: CfnImageVersionPropsDsl.() -> Unit = {}): CfnImageVersionProps {
    ...
    public inline fun cfnModelBiasJobDefinitionProps(block: CfnModelBiasJobDefinitionPropsDsl.() -> Unit = {}): CfnModelBiasJobDefinitionProps {
    ...
    public inline fun cfnModelCardProps(block: CfnModelCardPropsDsl.() -> Unit = {}): CfnModelCardProps {
    ...
    public inline fun cfnModelPackageGroupProps(block: CfnModelPackageGroupPropsDsl.() -> Unit = {}): CfnModelPackageGroupProps {
    ...
    public inline fun cfnModelPackageProps(block: CfnModelPackagePropsDsl.() -> Unit = {}): CfnModelPackageProps {
    ...
    public inline fun cfnModelVpcConfigProperty(block: CfnModelVpcConfigPropertyDsl.() -> Unit = {}): CfnModel.VpcConfigProperty {
    ...
    public inline fun cfnNotebookInstanceLifecycleConfigNotebookInstanceLifecycleHookProperty(
        block: CfnNotebookInstanceLifecycleConfigNotebookInstanceLifecycleHookPropertyDsl.() -> Unit =
            {},
    ...
    public inline fun cfnNotebookInstanceProps(block: CfnNotebookInstancePropsDsl.() -> Unit = {}): CfnNotebookInstanceProps {
