...
public class EcsDeployActionPropsDsl {
    ...
    /**
     * @param deploymentTimeout Timeout for the ECS deployment in minutes. Value must be between
     *   1-60.
     */
    ...
    /**
     * @param imageFile The name of the JSON image definitions file to use for deployments. The JSON
     *   file is a list of objects, each with 2 keys: `name` is the name of the container in the
     *   Task Definition, and `imageUri` is the Docker image URI you want to update your service
     ...
     *   deployments. The JSON file is a list of objects, each with 2 keys: `name` is the name of
     *   the container in the Task Definition, and `imageUri` is the Docker image URI you want to
     *   update your service with. If you use this property, it's assumed the file is called
     *   'imagedefinitions.json'. If your build uses a different file, leave this property empty,
