...
public class CfnConnectionPhysicalConnectionRequirementsPropertyDsl {
    ...
    /**
     * @param availabilityZone The connection's Availability Zone. This field is redundant because
     *   the specified subnet implies the Availability Zone to be used. Currently the field must be
