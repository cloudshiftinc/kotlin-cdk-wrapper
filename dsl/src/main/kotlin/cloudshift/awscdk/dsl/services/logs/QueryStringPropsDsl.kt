...
public class QueryStringPropsDsl {
     ...
     *   query based on a boolean expression. Each provided statement generates a separate filter
     *   line in the query string.
     *
     ...
     *   and creating ephemeral fields that can be processed further in the query. Each provided
     *   statement generates a separate parse line in the query string.
     *
