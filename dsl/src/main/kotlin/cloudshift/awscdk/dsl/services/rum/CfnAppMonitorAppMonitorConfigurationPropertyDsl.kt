...
public class CfnAppMonitorAppMonitorConfigurationPropertyDsl {
  ...
  /**
   * @param allowCookies If you set this to `true` , the CloudWatch RUM web client sets two cookies,
   * a session cookie and a user cookie.
   * The cookies allow the CloudWatch RUM web client to collect data relating to the number of users
  ...
  /**
   * @param enableXRay If you set this to `true` , CloudWatch RUM sends client-side traces to X-Ray
  ...
  /**
   * @param identityPoolId The ID of the Amazon Cognito identity pool that is used to authorize the
   * sending of data to CloudWatch RUM.
   */
  ...
  /**
   * @param sessionSampleRate Specifies the portion of user sessions to use for CloudWatch RUM data
   * collection.
  ...
  /**
   * @param telemetries An array that lists the types of telemetry data that this app monitor is to
   * collect.
