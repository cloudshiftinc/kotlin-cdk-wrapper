 ...
 */
@CdkDslMarker
public class CfnTemplateTreeMapVisualPropertyDsl {
  private val cdkBuilder: CfnTemplate.TreeMapVisualProperty.Builder =
   ...
   * @param chartConfiguration The configuration settings of the visual.
   */
  public fun chartConfiguration(chartConfiguration: CfnTemplate.TreeMapConfigurationProperty) {
    cdkBuilder.chartConfiguration(chartConfiguration)
  }
  ...
  public fun build(): CfnTemplate.TreeMapVisualProperty {
