...
public object athena {
    ...
    public inline fun cfnDataCatalogProps(block: CfnDataCatalogPropsDsl.() -> Unit = {}): CfnDataCatalogProps {
    ...
    public inline fun cfnNamedQueryProps(block: CfnNamedQueryPropsDsl.() -> Unit = {}): CfnNamedQueryProps {
    ...
    public inline fun cfnPreparedStatementProps(block: CfnPreparedStatementPropsDsl.() -> Unit = {}): CfnPreparedStatementProps {
