...
public object athena {
     ...
     */
    public inline fun cfnCapacityReservationCapacityAssignmentConfigurationProperty(
     ...
     */
    public inline fun cfnCapacityReservationCapacityAssignmentProperty(
        block: CfnCapacityReservationCapacityAssignmentPropertyDsl.() -> Unit = {}
    ...
    /**
     * The AWS::Athena::DataCatalog resource specifies an Amazon Athena data catalog, which contains
     * a name, description, type, parameters, and tags.
     *
     * For more information, see
     * [DataCatalog](https://docs.aws.amazon.com/athena/latest/APIReference/API_DataCatalog.html) in
     ...
     * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-athena-datacatalog.html)
     */
    public inline fun cfnDataCatalogProps(
        block: CfnDataCatalogPropsDsl.() -> Unit = {}
    ): CfnDataCatalogProps {
     ...
     * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-athena-namedquery.html)
     */
    public inline fun cfnNamedQueryProps(
        block: CfnNamedQueryPropsDsl.() -> Unit = {}
    ): CfnNamedQueryProps {
     ...
     * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-athena-preparedstatement.html)
     */
    public inline fun cfnPreparedStatementProps(
        block: CfnPreparedStatementPropsDsl.() -> Unit = {}
     ...
     * request header. For more information about S3 Object Ownership, see
     ...
     */
    public inline fun cfnWorkGroupAclConfigurationProperty(
        block: CfnWorkGroupAclConfigurationPropertyDsl.() -> Unit = {}
     ...
     */
    public inline fun cfnWorkGroupCustomerContentEncryptionConfigurationProperty(
        block: CfnWorkGroupCustomerContentEncryptionConfigurationPropertyDsl.() -> Unit = {}
     ...
     */
    public inline fun cfnWorkGroupEncryptionConfigurationProperty(
        block: CfnWorkGroupEncryptionConfigurationPropertyDsl.() -> Unit = {}
     ...
     */
    public inline fun cfnWorkGroupEngineVersionProperty(
        block: CfnWorkGroupEngineVersionPropertyDsl.() -> Unit = {}
     ...
     * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-athena-workgroup.html)
     */
    public inline fun cfnWorkGroupProps(
        block: CfnWorkGroupPropsDsl.() -> Unit = {}
    ): CfnWorkGroupProps {
     ...
     */
    public inline fun cfnWorkGroupResultConfigurationProperty(
        block: CfnWorkGroupResultConfigurationPropertyDsl.() -> Unit = {}
     ...
     */
    public inline fun cfnWorkGroupResultConfigurationUpdatesProperty(
        block: CfnWorkGroupResultConfigurationUpdatesPropertyDsl.() -> Unit = {}
     ...
     */
    public inline fun cfnWorkGroupWorkGroupConfigurationProperty(
     ...
     * query results, whether the Amazon CloudWatch Metrics are enabled for the workgroup, whether
     * the workgroup settings override the client-side settings, and the data usage limit for the
     ...
     */
    public inline fun cfnWorkGroupWorkGroupConfigurationUpdatesProperty(
