...
public class CfnLoadBalancerAccessLoggingPolicyPropertyDsl {
  ...
  /**
   * @param emitInterval The interval for publishing the access logs. You can specify an interval of
  ...
  /**
   * @param s3BucketPrefix The logical hierarchy you created for your Amazon S3 bucket, for example
