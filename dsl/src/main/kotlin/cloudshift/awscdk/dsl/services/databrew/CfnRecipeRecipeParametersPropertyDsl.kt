...
public class CfnRecipeRecipeParametersPropertyDsl {
  ...
  /**
   * @param customCharacters One or more characters that can be substituted or removed, depending on
   * the context.
   */
  ...
  /**
   * @param dateAddValue A value that specifies how many units of time to add or subtract for a date
   * math operation.
   */
  ...
  /**
   * @param modeType Determines the manner in which mode value is calculated, in case there is more
   * than one mode value.
  ...
  /**
   * @param removeLeadingAndTrailingPunctuation If `true` , removes the following characters if they
   * occur at the start or end of the value: `.` `!` `,` `?`.
   */
  ...
  /**
   * @param removeLeadingAndTrailingQuotes If `true` , removes single quotes and double quotes from
