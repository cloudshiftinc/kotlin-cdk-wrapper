...
public class AppMeshProxyConfigurationPropsDsl {
    ...
    /**
     * @param appPorts The list of ports that the application uses. Network traffic to these ports
     *   is forwarded to the ProxyIngressPort and ProxyEgressPort.
     */
     ...
     *   in a container definition. This is used to ensure the proxy ignores its own traffic. If
