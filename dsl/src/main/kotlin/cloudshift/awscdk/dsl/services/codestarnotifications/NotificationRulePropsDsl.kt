...
public class NotificationRulePropsDsl {
    ...
    /**
     * @param events A list of event types associated with this notification rule. For a complete
     *   list of event types and IDs, see Notification concepts in the Developer Tools Console User
     *   Guide.
     */
     ...
     *   notification rule. Currently, Supported sources include pipelines in AWS CodePipeline,
     *   build projects in AWS CodeBuild, and repositories in AWS CodeCommit in this L2 constructor.
     */
