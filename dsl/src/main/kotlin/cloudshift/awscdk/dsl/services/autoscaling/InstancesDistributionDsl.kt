 ...
 *
 * The instances distribution specifies the distribution of On-Demand Instances and Spot Instances,
 * the maximum price to pay for Spot Instances, and how the Auto Scaling group allocates instance
 * types to fulfill On-Demand and Spot capacities.
 *
...
public class InstancesDistributionDsl {
     ...
     *   On-Demand capacity. The only valid value is prioritized, which is also the default value.
     */
     ...
     *   be fulfilled by On-Demand Instances. This base portion is provisioned first as your group
     *   scales. Defaults to 0 if not specified. If you specify weights for the instance types in
     *   the overrides, set the value of OnDemandBaseCapacity in terms of the number of capacity
     ...
     *   and Spot Instances for your additional capacity beyond OnDemandBaseCapacity. Expressed as a
     *   number (for example, 20 specifies 20% On-Demand Instances, 80% Spot Instances). Defaults to
     ...
     *   your instances across the number of Spot pools that you specify. Defaults to lowest-price
     *   if not specified.
     *
     ...
     *   capacity. The Spot pools are determined from the different instance types in the overrides.
     *   Valid only when the Spot allocation strategy is lowest-price. Value must be in the range of
     *   1 to 20. Defaults to 2 if not specified.
     */
     ...
     *   Instance. If you leave the value at its default (empty), Amazon EC2 Auto Scaling uses the
