...
public class CfnDistributionOriginShieldPropertyDsl {
    ...
    /**
     * @param enabled A flag that specifies whether Origin Shield is enabled. When it's enabled,
     *   CloudFront routes all requests through Origin Shield, which can help protect your origin.
     *   When it's disabled, CloudFront might send requests directly to your origin from multiple
    ...
    /**
     * @param originShieldRegion The AWS Region for Origin Shield. Specify the AWS Region that has
     *   the lowest latency to your origin. To specify a region, use the region code, not the region
     ...
     * For the list of AWS Regions that you can specify, and for help choosing the best Region for
     * your origin, see
