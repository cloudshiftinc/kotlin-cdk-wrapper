...
public class CfnLaunchTemplateEbsPropertyDsl {
   ...
   * Encrypted volumes can only be attached to instances that support Amazon EBS encryption. If you
   * are creating a volume from a snapshot, you can't specify an encryption value.
   */
   ...
   * You must specify either a snapshot ID or a volume size. The following are the supported volumes
