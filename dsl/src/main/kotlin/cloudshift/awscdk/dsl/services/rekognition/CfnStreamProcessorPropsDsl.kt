...
public class CfnStreamProcessorPropsDsl {
  ...
  /**
   * @param boundingBoxRegionsOfInterest List of BoundingBox objects, each of which denotes a region
  ...
  /**
   * @param dataSharingPreference Allows you to opt in or opt out to share data with Rekognition to
  ...
  /**
   * @param name The Name attribute specifies the name of the stream processor and it must be within
   * the constraints described in the Name section of
