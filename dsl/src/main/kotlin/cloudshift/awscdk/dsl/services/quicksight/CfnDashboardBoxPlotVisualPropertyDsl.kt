...
@CdkDslMarker
public class CfnDashboardBoxPlotVisualPropertyDsl {
    private val cdkBuilder: CfnDashboard.BoxPlotVisualProperty.Builder =
    ...
    public fun chartConfiguration(chartConfiguration: CfnDashboard.BoxPlotChartConfigurationProperty) {
        cdkBuilder.chartConfiguration(chartConfiguration)
    }
    ...
    public fun build(): CfnDashboard.BoxPlotVisualProperty {
