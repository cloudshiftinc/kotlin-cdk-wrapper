...
public object ivs {
    ...
    public inline fun cfnPlaybackKeyPairProps(block: CfnPlaybackKeyPairPropsDsl.() -> Unit = {}): CfnPlaybackKeyPairProps {
    ...
    public inline fun cfnRecordingConfigurationProps(block: CfnRecordingConfigurationPropsDsl.() -> Unit = {}): CfnRecordingConfigurationProps {
    ...
    public inline fun cfnStreamKeyProps(block: CfnStreamKeyPropsDsl.() -> Unit = {}): CfnStreamKeyProps {
