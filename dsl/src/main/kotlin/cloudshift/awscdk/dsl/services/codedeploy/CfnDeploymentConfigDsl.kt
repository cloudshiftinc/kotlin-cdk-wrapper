...
public class CfnDeploymentConfigDsl(
    ...
    private val cdkBuilder: CfnDeploymentConfig.Builder = CfnDeploymentConfig.Builder.create(
        scope,
        id,
    )
    ...
    public fun minimumHealthyHosts(minimumHealthyHosts: CfnDeploymentConfig.MinimumHealthyHostsProperty) {
        cdkBuilder.minimumHealthyHosts(minimumHealthyHosts)
    }
    ...
    public fun trafficRoutingConfig(trafficRoutingConfig: CfnDeploymentConfig.TrafficRoutingConfigProperty) {
        cdkBuilder.trafficRoutingConfig(trafficRoutingConfig)
    }
