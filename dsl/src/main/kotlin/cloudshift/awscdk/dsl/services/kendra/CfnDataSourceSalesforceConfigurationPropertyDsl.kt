...
public class CfnDataSourceSalesforceConfigurationPropertyDsl {
    ...
    public fun chatterFeedConfiguration(chatterFeedConfiguration: CfnDataSource.SalesforceChatterFeedConfigurationProperty) {
        cdkBuilder.chatterFeedConfiguration(chatterFeedConfiguration)
    }
    ...
    public fun knowledgeArticleConfiguration(knowledgeArticleConfiguration: CfnDataSource.SalesforceKnowledgeArticleConfigurationProperty) {
        cdkBuilder.knowledgeArticleConfiguration(knowledgeArticleConfiguration)
    }
    ...
    public fun standardObjectAttachmentConfiguration(standardObjectAttachmentConfiguration: IResolvable) {
        cdkBuilder.standardObjectAttachmentConfiguration(standardObjectAttachmentConfiguration)
    }

    public fun standardObjectAttachmentConfiguration(standardObjectAttachmentConfiguration: CfnDataSource.SalesforceStandardObjectAttachmentConfigurationProperty) {
        cdkBuilder.standardObjectAttachmentConfiguration(standardObjectAttachmentConfiguration)
    }
