...
public inline fun DatabaseClusterBase.metricCPUUtilization(block: MetricOptionsDsl.() -> Unit = {}): Metric {
    val builder = MetricOptionsDsl()
    builder.apply(block)
...
public inline fun DatabaseClusterBase.metricDeadlocks(block: MetricOptionsDsl.() -> Unit = {}): Metric {
    val builder = MetricOptionsDsl()
    builder.apply(block)
    return metricDeadlocks(builder.build())
}

public inline fun DatabaseClusterBase.metricEngineUptime(block: MetricOptionsDsl.() -> Unit = {}): Metric {
    val builder = MetricOptionsDsl()
    builder.apply(block)
    return metricEngineUptime(builder.build())
}

public inline fun DatabaseClusterBase.metricFreeableMemory(block: MetricOptionsDsl.() -> Unit = {}): Metric {
    val builder = MetricOptionsDsl()
    builder.apply(block)
...
public inline fun DatabaseClusterBase.metricNetworkReceiveThroughput(block: MetricOptionsDsl.() -> Unit = {}): Metric {
    val builder = MetricOptionsDsl()
    builder.apply(block)
...
public inline fun DatabaseClusterBase.metricTotalBackupStorageBilled(block: MetricOptionsDsl.() -> Unit = {}): Metric {
    val builder = MetricOptionsDsl()
    builder.apply(block)
...
public inline fun DatabaseClusterBase.metricVolumeReadIOPs(block: MetricOptionsDsl.() -> Unit = {}): Metric {
    val builder = MetricOptionsDsl()
    builder.apply(block)
...
public inline fun IDatabaseCluster.metric(arg0: String, block: MetricOptionsDsl.() -> Unit = {}): Metric {
    val builder = MetricOptionsDsl()
    builder.apply(block)
    return metric(arg0, builder.build())
}

public inline fun IDatabaseCluster.metricCPUUtilization(block: MetricOptionsDsl.() -> Unit = {}): Metric {
    val builder = MetricOptionsDsl()
    builder.apply(block)
    return metricCPUUtilization(builder.build())
}
...
public inline fun IDatabaseCluster.metricDeadlocks(block: MetricOptionsDsl.() -> Unit = {}): Metric {
    val builder = MetricOptionsDsl()
    builder.apply(block)
    return metricDeadlocks(builder.build())
}

public inline fun IDatabaseCluster.metricEngineUptime(block: MetricOptionsDsl.() -> Unit = {}): Metric {
    val builder = MetricOptionsDsl()
    builder.apply(block)
    return metricEngineUptime(builder.build())
}

public inline fun IDatabaseCluster.metricFreeableMemory(block: MetricOptionsDsl.() -> Unit = {}): Metric {
    val builder = MetricOptionsDsl()
    builder.apply(block)
    return metricFreeableMemory(builder.build())
}

public inline fun IDatabaseCluster.metricFreeLocalStorage(block: MetricOptionsDsl.() -> Unit = {}): Metric {
    val builder = MetricOptionsDsl()
    builder.apply(block)
    return metricFreeLocalStorage(builder.build())
}
...
public inline fun IDatabaseCluster.metricNetworkThroughput(block: MetricOptionsDsl.() -> Unit = {}): Metric {
    val builder = MetricOptionsDsl()
    builder.apply(block)
    return metricNetworkThroughput(builder.build())
}

public inline fun IDatabaseCluster.metricNetworkTransmitThroughput(block: MetricOptionsDsl.() -> Unit = {}): Metric {
    val builder = MetricOptionsDsl()
    builder.apply(block)
    return metricNetworkTransmitThroughput(builder.build())
}
...
public inline fun IDatabaseCluster.metricVolumeBytesUsed(block: MetricOptionsDsl.() -> Unit = {}): Metric {
    val builder = MetricOptionsDsl()
    builder.apply(block)
    return metricVolumeBytesUsed(builder.build())
}

public inline fun IDatabaseCluster.metricVolumeReadIOPs(block: MetricOptionsDsl.() -> Unit = {}): Metric {
    val builder = MetricOptionsDsl()
    builder.apply(block)
    return metricVolumeReadIOPs(builder.build())
}

public inline fun IDatabaseCluster.metricVolumeWriteIOPs(block: MetricOptionsDsl.() -> Unit = {}): Metric {
    val builder = MetricOptionsDsl()
    builder.apply(block)
    return metricVolumeWriteIOPs(builder.build())
}
...
public inline fun IDatabaseInstance.metric(arg0: String, block: MetricOptionsDsl.() -> Unit = {}): Metric {
    val builder = MetricOptionsDsl()
    builder.apply(block)
    return metric(arg0, builder.build())
}

public inline fun IDatabaseInstance.metricCPUUtilization(block: MetricOptionsDsl.() -> Unit = {}): Metric {
    val builder = MetricOptionsDsl()
    builder.apply(block)
    return metricCPUUtilization(builder.build())
}
...
public inline fun IDatabaseInstance.metricFreeableMemory(block: MetricOptionsDsl.() -> Unit = {}): Metric {
    val builder = MetricOptionsDsl()
    builder.apply(block)
    return metricFreeableMemory(builder.build())
}

public inline fun IDatabaseInstance.metricFreeStorageSpace(block: MetricOptionsDsl.() -> Unit = {}): Metric {
    val builder = MetricOptionsDsl()
    builder.apply(block)
    return metricFreeStorageSpace(builder.build())
}

public inline fun IDatabaseInstance.metricReadIOPS(block: MetricOptionsDsl.() -> Unit = {}): Metric {
    val builder = MetricOptionsDsl()
    builder.apply(block)
    return metricReadIOPS(builder.build())
}

public inline fun IDatabaseInstance.metricWriteIOPS(block: MetricOptionsDsl.() -> Unit = {}): Metric {
    val builder = MetricOptionsDsl()
    builder.apply(block)
    return metricWriteIOPS(builder.build())
}

public inline fun IDatabaseInstance.onEvent(arg0: String, block: OnEventOptionsDsl.() -> Unit = {}): Rule {
...
public inline fun OptionGroup.addConfiguration(block: OptionConfigurationDsl.() -> Unit = {}): Boolean {
    val builder = OptionConfigurationDsl()
    builder.apply(block)
    return addConfiguration(builder.build())
}

public inline fun IOptionGroup.addConfiguration(block: OptionConfigurationDsl.() -> Unit = {}): Boolean {
    val builder = OptionConfigurationDsl()
    builder.apply(block)
    return addConfiguration(builder.build())
}
...
public inline fun DatabaseClusterFromSnapshot.metricACUUtilization(block: MetricOptionsDsl.() -> Unit = {}): Metric {
    val builder = MetricOptionsDsl()
    builder.apply(block)
...
public inline fun DatabaseCluster.addRotationSingleUser(block: RotationSingleUserOptionsDsl.() -> Unit = {}): SecretRotation {
    val builder = RotationSingleUserOptionsDsl()
    builder.apply(block)
    return addRotationSingleUser(builder.build())
}

public inline fun DatabaseCluster.metricACUUtilization(block: MetricOptionsDsl.() -> Unit = {}): Metric {
    val builder = MetricOptionsDsl()
    builder.apply(block)
    return metricACUUtilization(builder.build())
}

public inline fun DatabaseCluster.metricServerlessDatabaseCapacity(block: MetricOptionsDsl.() -> Unit = {}): Metric {
    val builder = MetricOptionsDsl()
    builder.apply(block)
    return metricServerlessDatabaseCapacity(builder.build())
}
...
public inline fun IParameterGroup.bindToCluster(block: ParameterGroupClusterBindOptionsDsl.() -> Unit = {}): ParameterGroupClusterConfig {
...
public inline fun ParameterGroup.bindToInstance(block: ParameterGroupInstanceBindOptionsDsl.() -> Unit = {}): ParameterGroupInstanceConfig {
    val builder = ParameterGroupInstanceBindOptionsDsl()
    builder.apply(block)
    return bindToInstance(builder.build())
}
...
public inline fun DatabaseInstanceBase.metricReadIOPS(block: MetricOptionsDsl.() -> Unit = {}): Metric {
    val builder = MetricOptionsDsl()
    builder.apply(block)
    return metricReadIOPS(builder.build())
}

public inline fun DatabaseInstanceBase.metricWriteIOPS(block: MetricOptionsDsl.() -> Unit = {}): Metric {
    val builder = MetricOptionsDsl()
    builder.apply(block)
    return metricWriteIOPS(builder.build())
}
...
public inline fun DatabaseInstance.addRotationSingleUser(block: RotationSingleUserOptionsDsl.() -> Unit = {}): SecretRotation {
    val builder = RotationSingleUserOptionsDsl()
    builder.apply(block)
    return addRotationSingleUser(builder.build())
}
