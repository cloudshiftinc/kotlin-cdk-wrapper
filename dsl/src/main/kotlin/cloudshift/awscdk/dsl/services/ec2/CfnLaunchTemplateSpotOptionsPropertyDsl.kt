...
public class CfnLaunchTemplateSpotOptionsPropertyDsl {
    ...
    /**
     * @param maxPrice The maximum hourly price you're willing to pay for the Spot Instances. We do
     *   not recommend using this parameter because it can lead to increased interruptions. If you
    ...
    /**
     * @param spotInstanceType The Spot Instance request type. If you are using Spot Instances with
