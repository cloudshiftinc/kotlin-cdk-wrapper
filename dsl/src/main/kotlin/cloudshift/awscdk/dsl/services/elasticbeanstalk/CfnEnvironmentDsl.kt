...
public class CfnEnvironmentDsl(
     ...
     * downstream services during this call and during subsequent calls acting on this environment.
     * To specify an operations role, you must have the `iam:PassRole` permission for the role.
     *
