...
public class CfnBucketCorsRulePropertyDsl {
    private val cdkBuilder: CfnBucket.CorsRuleProperty.Builder =
    ...
    /**
     * @param allowedMethods An HTTP method that you allow the origin to run. *Allowed values* :
     ...
     *   to access from their applications (for example, from a JavaScript `XMLHttpRequest` object).
     */
