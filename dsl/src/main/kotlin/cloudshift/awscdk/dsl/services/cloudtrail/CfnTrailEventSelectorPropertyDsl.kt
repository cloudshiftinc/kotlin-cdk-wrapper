...
public class CfnTrailEventSelectorPropertyDsl {
    ...
    /**
     * @param dataResources In AWS CloudFormation , CloudTrail supports data event logging for
     *   Amazon S3 objects, Amazon DynamoDB tables, and AWS Lambda functions. Currently, advanced
     *   event selectors for data events are not supported in AWS CloudFormation templates. You can
