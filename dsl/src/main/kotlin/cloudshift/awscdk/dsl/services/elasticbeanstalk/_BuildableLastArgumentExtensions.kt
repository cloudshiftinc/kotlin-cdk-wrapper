 ...
 */
public inline fun CfnApplication.setResourceLifecycleConfig(
 ...
 */
public inline fun CfnApplicationVersion.setSourceBundle(
...
public inline fun CfnConfigurationTemplate.setSourceConfiguration(
