...
public class CfnUserPoolRiskConfigurationAttachmentNotifyConfigurationTypePropertyDsl {
    ...
    public fun blockEmail(blockEmail: CfnUserPoolRiskConfigurationAttachment.NotifyEmailTypeProperty) {
        cdkBuilder.blockEmail(blockEmail)
    }
    ...
    public fun noActionEmail(noActionEmail: CfnUserPoolRiskConfigurationAttachment.NotifyEmailTypeProperty) {
        cdkBuilder.noActionEmail(noActionEmail)
    }
