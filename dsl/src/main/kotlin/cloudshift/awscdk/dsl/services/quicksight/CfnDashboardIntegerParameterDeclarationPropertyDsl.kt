...
public class CfnDashboardIntegerParameterDeclarationPropertyDsl {
    ...
    public fun defaultValues(defaultValues: CfnDashboard.IntegerDefaultValuesProperty) {
        cdkBuilder.defaultValues(defaultValues)
    }
    ...
    public fun valueWhenUnset(valueWhenUnset: CfnDashboard.IntegerValueWhenUnsetConfigurationProperty) {
        cdkBuilder.valueWhenUnset(valueWhenUnset)
    }

    public fun build(): CfnDashboard.IntegerParameterDeclarationProperty {
