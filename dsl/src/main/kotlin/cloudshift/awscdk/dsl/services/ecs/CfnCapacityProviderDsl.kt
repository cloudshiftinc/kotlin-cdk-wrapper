...
public class CfnCapacityProviderDsl(
    ...
    private val cdkBuilder: CfnCapacityProvider.Builder = CfnCapacityProvider.Builder.create(
        scope,
        id,
    )
    ...
    public fun autoScalingGroupProvider(autoScalingGroupProvider: CfnCapacityProvider.AutoScalingGroupProviderProperty) {
        cdkBuilder.autoScalingGroupProvider(autoScalingGroupProvider)
    }
