...
public class CfnChannelFrameCaptureGroupSettingsPropertyDsl {
   ...
   * mediastoressl://sportsDelivery/20180820/curling_). The final file names consist of the prefix from
   * the destination field (for example, "curling_") + name modifier + the counter (5 digits, starting
   * from 00001) + extension (which is always .jpg). For example, curlingLow.00001.jpg.
   */
