...
public object cloudtrail {
  public inline fun addEventSelectorOptions(block: AddEventSelectorOptionsDsl.() -> Unit = {}):
  ...
  public inline fun cfnChannelDestinationProperty(block: CfnChannelDestinationPropertyDsl.() -> Unit
  ...
  public inline
      fun cfnEventDataStoreAdvancedEventSelectorProperty(block: CfnEventDataStoreAdvancedEventSelectorPropertyDsl.() -> Unit
  ...
  public inline
      fun cfnEventDataStoreAdvancedFieldSelectorProperty(block: CfnEventDataStoreAdvancedFieldSelectorPropertyDsl.() -> Unit
  ...
  public inline fun cfnEventDataStoreProps(block: CfnEventDataStorePropsDsl.() -> Unit = {}):
  ...
  public inline
      fun cfnTrailAdvancedEventSelectorProperty(block: CfnTrailAdvancedEventSelectorPropertyDsl.() -> Unit
  ...
  public inline
      fun cfnTrailAdvancedFieldSelectorProperty(block: CfnTrailAdvancedFieldSelectorPropertyDsl.() -> Unit
  ...
  public inline fun cfnTrailDataResourceProperty(block: CfnTrailDataResourcePropertyDsl.() -> Unit =
  ...
  public inline fun cfnTrailEventSelectorProperty(block: CfnTrailEventSelectorPropertyDsl.() -> Unit
  ...
  public inline
      fun cfnTrailInsightSelectorProperty(block: CfnTrailInsightSelectorPropertyDsl.() -> Unit =
