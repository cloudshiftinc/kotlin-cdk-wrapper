...
public class CfnDataQualityJobDefinitionDataQualityBaselineConfigPropertyDsl {
    ...
    public fun constraintsResource(constraintsResource: CfnDataQualityJobDefinition.ConstraintsResourceProperty) {
        cdkBuilder.constraintsResource(constraintsResource)
    }
    ...
    public fun statisticsResource(statisticsResource: CfnDataQualityJobDefinition.StatisticsResourceProperty) {
        cdkBuilder.statisticsResource(statisticsResource)
    }
