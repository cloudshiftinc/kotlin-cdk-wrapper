...
public object servicecatalog {
  ...
  public inline
      fun cfnAcceptedPortfolioShareProps(block: CfnAcceptedPortfolioSharePropsDsl.() -> Unit = {}):
  ...
  public inline
      fun cfnCloudFormationProductCodeStarParametersProperty(block: CfnCloudFormationProductCodeStarParametersPropertyDsl.() -> Unit
  ...
  public inline
      fun cfnCloudFormationProductConnectionParametersProperty(block: CfnCloudFormationProductConnectionParametersPropertyDsl.() -> Unit
  ...
  public inline fun cfnCloudFormationProductProps(block: CfnCloudFormationProductPropsDsl.() -> Unit
  ...
  public inline
      fun cfnCloudFormationProductProvisioningArtifactPropertiesProperty(block: CfnCloudFormationProductProvisioningArtifactPropertiesPropertyDsl.() -> Unit
  ...
  public inline
      fun cfnCloudFormationProductSourceConnectionProperty(block: CfnCloudFormationProductSourceConnectionPropertyDsl.() -> Unit
  ...
  public inline
      fun cfnCloudFormationProvisionedProductProps(block: CfnCloudFormationProvisionedProductPropsDsl.() -> Unit
  ...
  public inline
      fun cfnCloudFormationProvisionedProductProvisioningParameterProperty(block: CfnCloudFormationProvisionedProductProvisioningParameterPropertyDsl.() -> Unit
  ...
  public inline
      fun cfnCloudFormationProvisionedProductProvisioningPreferencesProperty(block: CfnCloudFormationProvisionedProductProvisioningPreferencesPropertyDsl.() -> Unit
  ...
  public inline
      fun cfnLaunchNotificationConstraintProps(block: CfnLaunchNotificationConstraintPropsDsl.() -> Unit
  ...
  public inline fun cfnLaunchRoleConstraintProps(block: CfnLaunchRoleConstraintPropsDsl.() -> Unit =
  ...
  public inline
      fun cfnLaunchTemplateConstraintProps(block: CfnLaunchTemplateConstraintPropsDsl.() -> Unit =
  ...
  public inline
      fun cfnPortfolioPrincipalAssociationProps(block: CfnPortfolioPrincipalAssociationPropsDsl.() -> Unit
  ...
  public inline
      fun cfnPortfolioProductAssociationProps(block: CfnPortfolioProductAssociationPropsDsl.() -> Unit
  ...
  public inline fun cfnPortfolioProps(block: CfnPortfolioPropsDsl.() -> Unit = {}):
      CfnPortfolioProps {
  ...
  public inline fun cfnPortfolioShareProps(block: CfnPortfolioSharePropsDsl.() -> Unit = {}):
  ...
  public inline
      fun cfnResourceUpdateConstraintProps(block: CfnResourceUpdateConstraintPropsDsl.() -> Unit =
  ...
  public inline
      fun cfnServiceActionAssociationProps(block: CfnServiceActionAssociationPropsDsl.() -> Unit =
  ...
  public inline
      fun cfnServiceActionDefinitionParameterProperty(block: CfnServiceActionDefinitionParameterPropertyDsl.() -> Unit
  ...
  public inline fun cfnServiceActionProps(block: CfnServiceActionPropsDsl.() -> Unit = {}):
  ...
  public inline fun cfnStackSetConstraintProps(block: CfnStackSetConstraintPropsDsl.() -> Unit =
  ...
  public inline fun cfnTagOptionAssociationProps(block: CfnTagOptionAssociationPropsDsl.() -> Unit =
  ...
  public inline fun cfnTagOptionProps(block: CfnTagOptionPropsDsl.() -> Unit = {}):
      CfnTagOptionProps {
  ...
  public inline fun cloudFormationProductProps(block: CloudFormationProductPropsDsl.() -> Unit =
  ...
  public inline fun cloudFormationProductVersion(block: CloudFormationProductVersionDsl.() -> Unit =
  ...
  public inline
      fun cloudFormationRuleConstraintOptions(block: CloudFormationRuleConstraintOptionsDsl.() -> Unit
  ...
  public inline fun cloudFormationTemplateConfig(block: CloudFormationTemplateConfigDsl.() -> Unit =
  ...
  public inline fun commonConstraintOptions(block: CommonConstraintOptionsDsl.() -> Unit = {}):
  ...
  public inline fun portfolioShareOptions(block: PortfolioShareOptionsDsl.() -> Unit = {}):
  ...
  public inline fun productStackHistoryProps(block: ProductStackHistoryPropsDsl.() -> Unit = {}):
  ...
  public inline fun productStackProps(block: ProductStackPropsDsl.() -> Unit = {}):
      ProductStackProps {
  ...
  public inline fun stackSetsConstraintOptions(block: StackSetsConstraintOptionsDsl.() -> Unit =
  ...
  public inline fun tagUpdateConstraintOptions(block: TagUpdateConstraintOptionsDsl.() -> Unit =
  ...
  public inline fun templateRuleAssertion(block: TemplateRuleAssertionDsl.() -> Unit = {}):
