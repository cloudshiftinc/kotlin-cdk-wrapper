...
public class CfnBotPostFulfillmentStatusSpecificationPropertyDsl {
  ...
  /**
   * @param failureConditional A list of conditional branches to evaluate after the fulfillment code
   * hook throws an exception or returns with the `State` field of the `Intent` object set to `Failed`
   * .
   */
  ...
  /**
   * @param failureResponse Specifies a list of message groups that Amazon Lex uses to respond when
   * fulfillment isn't successful.
   */
  ...
  /**
   * @param successConditional A list of conditional branches to evaluate after the fulfillment code
  ...
  /**
   * @param successNextStep Specifies the next step in the conversation that Amazon Lex invokes when
  ...
  /**
   * @param successResponse Specifies a list of message groups that Amazon Lex uses to respond when
   * the fulfillment is successful.
   */
  ...
  /**
   * @param timeoutNextStep Specifies the next step that the bot runs when the fulfillment code hook
   * times out.
   */
  ...
  /**
   * @param timeoutResponse Specifies a list of message groups that Amazon Lex uses to respond when
   * fulfillment isn't completed within the timeout period.
   */
