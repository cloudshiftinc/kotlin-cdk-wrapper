 ...
 * or delete a stack. For more information, see
 * [Custom resources](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/template-custom-resources.html)
 * .
 *
 * If you use the
 * [VPC endpoints](https://docs.aws.amazon.com/vpc/latest/userguide/vpc-endpoints.html) feature,
 * custom resources in the VPC must have access to CloudFormation -specific Amazon Simple Storage
 * Service ( Amazon S3 ) buckets. Custom resources must send responses to a presigned Amazon S3 URL.
 * If they can't send responses to Amazon S3 , CloudFormation won't receive a response and the stack
 * operation fails. For more information, see
