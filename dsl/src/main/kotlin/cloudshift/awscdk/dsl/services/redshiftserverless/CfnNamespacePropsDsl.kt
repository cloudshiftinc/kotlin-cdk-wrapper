...
public class CfnNamespacePropsDsl {
  ...
  /**
   * @param adminUserPassword The password of the administrator for the primary database created in
   * the namespace.
   */
  ...
  /**
   * @param adminUsername The username of the administrator for the primary database created in the
   * namespace.
   */
