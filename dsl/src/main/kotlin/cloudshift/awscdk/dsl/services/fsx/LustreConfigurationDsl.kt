...
public class LustreConfigurationDsl {
    ...
    /**
     * @param autoImportPolicy Available with `Scratch` and `Persistent_1` deployment types. When
     *   you create your file system, your existing S3 objects appear as file and directory
     *   listings. Use this property to choose how Amazon FSx keeps your file and directory listings
     *   up to date as you add or modify objects in your linked S3 bucket. `AutoImportPolicy` can
    ...
    /**
     * @param dataCompressionType Sets the data compression configuration for the file system. For
     ...
     *   exported. The path must use the same Amazon S3 bucket as specified in ImportPath. If you
     *   only specify a bucket name, such as s3://import-bucket, you get a 1:1 mapping of file
     *   system objects to S3 bucket objects. This mapping means that the input data in S3 is
     ...
     *   you're using as the data repository for your Amazon FSx for Lustre file system. Must be of
     *   the format "s3://{bucketName}/optional-prefix" and cannot exceed 900 characters.
     */
     ...
     *   physical disk. Allowed values are between 1 and 512,000.
     */
     ...
     *   amount of read and write throughput for each 1 tebibyte of storage, in MB/s/TiB. Valid
    ...
    public fun weeklyMaintenanceStartTime(
        weeklyMaintenanceStartTime: LustreMaintenanceTimeDsl.() -> Unit = {}
    ) {
