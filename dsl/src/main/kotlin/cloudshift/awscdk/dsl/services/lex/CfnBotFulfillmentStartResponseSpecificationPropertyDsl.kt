...
public class CfnBotFulfillmentStartResponseSpecificationPropertyDsl {
     ...
     *   and the start message is played. If the Lambda function returns before the delay is over,
     *   the start message isn't played.
     */
    ...
    /**
     * @param messageGroups 1 - 5 message groups that contain start messages. Amazon Lex chooses one
