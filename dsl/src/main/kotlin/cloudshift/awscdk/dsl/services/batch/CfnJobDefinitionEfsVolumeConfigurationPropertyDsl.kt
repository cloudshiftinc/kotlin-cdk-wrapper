...
public class CfnJobDefinitionEfsVolumeConfigurationPropertyDsl {
  ...
  /**
   * @param transitEncryption Determines whether to enable encryption for Amazon EFS data in transit
   ...
   * is omitted, the default value of `DISABLED` is used. For more information, see [Encrypting data in
  ...
  /**
   * @param transitEncryptionPort The port to use when sending encrypted data between the Amazon ECS
   ...
   * [EFS mount helper](https://docs.aws.amazon.com/efs/latest/ug/efs-mount-helper.html) in the *Amazon
   * Elastic File System User Guide* .
   */
