...
public class CfnLinkPropsDsl {
     ...
     *   account when you are viewing data from it in the monitoring account. You can include the
    ...
    /**
     * @param tags An array of key-value pairs to apply to the link. For more information, see
