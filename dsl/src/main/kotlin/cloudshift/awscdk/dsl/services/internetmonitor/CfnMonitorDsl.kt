...
public class CfnMonitorDsl(
   ...
   * city-networks (up to the 500,000 service limit) to another location, such as an Amazon S3 bucket. 
   */
   ...
   *
   * You can add a combination of Virtual Private Clouds (VPCs) and Amazon CloudFront distributions,
   * or you can add WorkSpaces directories. You can't add all three types of resources.
   *
   *
