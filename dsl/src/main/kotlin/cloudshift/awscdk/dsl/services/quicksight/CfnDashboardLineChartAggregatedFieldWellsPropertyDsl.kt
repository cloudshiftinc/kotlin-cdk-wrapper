 ...
 */
@CdkDslMarker
public class CfnDashboardLineChartAggregatedFieldWellsPropertyDsl {
    private val cdkBuilder: CfnDashboard.LineChartAggregatedFieldWellsProperty.Builder =
    ...
    public fun build(): CfnDashboard.LineChartAggregatedFieldWellsProperty {
