...
public class CfnTemplateTemplateVersionPropertyDsl {
    ...
    /**
     * @param dataSetConfigurations Schema of the dataset identified by the placeholder. Any
     *   dashboard created from this template should be bound to new datasets matching the same
    ...
    /**
     * @param sourceEntityArn The Amazon Resource Name (ARN) of an analysis or template that was
