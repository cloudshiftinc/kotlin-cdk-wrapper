...
public class CfnBucketInventoryConfigurationPropertyDsl {
    ...
    /**
     * @param enabled Specifies whether the inventory is enabled or disabled. If set to `True` , an
    ...
    /**
     * @param includedObjectVersions Object versions to include in the inventory list. If set to
     *   `All` , the list includes all the object versions, which adds the version-related fields
