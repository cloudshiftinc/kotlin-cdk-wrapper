...
public class SageMakerCreateEndpointDsl(
    ...
    private val cdkBuilder: SageMakerCreateEndpoint.Builder =
        SageMakerCreateEndpoint.Builder.create(scope, id)
    ...
    public fun build(): SageMakerCreateEndpoint = cdkBuilder.build()
}
