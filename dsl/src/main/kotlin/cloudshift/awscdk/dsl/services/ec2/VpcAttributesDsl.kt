...
public class VpcAttributesDsl {
    ...
    /**
     * @param isolatedSubnetIpv4CidrBlocks List of IPv4 CIDR blocks for the isolated subnets. Must
     *   be undefined or have an entry for every isolated subnet group.
     */
    ...
    /**
     * @param isolatedSubnetNames List of names for the isolated subnets. Must be undefined or have
     *   a name for every isolated subnet group.
     */
    ...
    /**
     * @param isolatedSubnetRouteTableIds List of IDs of route tables for the isolated subnets. Must
     *   be undefined or have a name for every isolated subnet group.
     */
    ...
    /**
     * @param privateSubnetIpv4CidrBlocks List of IPv4 CIDR blocks for the private subnets. Must be
     *   undefined or have an entry for every private subnet group.
     */
    ...
    /**
     * @param privateSubnetNames List of names for the private subnets. Must be undefined or have a
     *   name for every private subnet group.
     */
    ...
    /**
     * @param privateSubnetRouteTableIds List of IDs of route tables for the private subnets. Must
     *   be undefined or have a name for every private subnet group.
     */
    ...
    /**
     * @param publicSubnetIds List of public subnet IDs. Must be undefined or match the availability
     *   zones in length and order.
     */
    ...
    /**
     * @param publicSubnetIpv4CidrBlocks List of IPv4 CIDR blocks for the public subnets. Must be
     *   undefined or have an entry for every public subnet group.
     */
    ...
    /**
     * @param publicSubnetNames List of names for the public subnets. Must be undefined or have a
     *   name for every public subnet group.
     */
    ...
    /**
     * @param publicSubnetRouteTableIds List of IDs of route tables for the public subnets. Must be
     *   undefined or have a name for every public subnet group.
     */
