...
public object lookoutmetrics {
    ...
    public inline fun cfnAlertActionProperty(block: CfnAlertActionPropertyDsl.() -> Unit = {}): CfnAlert.ActionProperty {
        val builder = CfnAlertActionPropertyDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun cfnAlertLambdaConfigurationProperty(
        block: CfnAlertLambdaConfigurationPropertyDsl.() -> Unit =
            {},
    ...
    public inline fun cfnAlertSNSConfigurationProperty(
        block: CfnAlertSNSConfigurationPropertyDsl.() -> Unit =
            {},
    ...
    public inline fun cfnAnomalyDetectorAnomalyDetectorConfigProperty(
    ...
    public inline fun cfnAnomalyDetectorAppFlowConfigProperty(
        block: CfnAnomalyDetectorAppFlowConfigPropertyDsl.() -> Unit =
            {},
    ...
    public inline fun cfnAnomalyDetectorCloudwatchConfigProperty(
        block: CfnAnomalyDetectorCloudwatchConfigPropertyDsl.() -> Unit =
            {},
    ...
    public inline fun cfnAnomalyDetectorCsvFormatDescriptorProperty(
        block: CfnAnomalyDetectorCsvFormatDescriptorPropertyDsl.() -> Unit =
            {},
    ...
    public inline fun cfnAnomalyDetectorFileFormatDescriptorProperty(
        block: CfnAnomalyDetectorFileFormatDescriptorPropertyDsl.() -> Unit =
            {},
    ...
    public inline fun cfnAnomalyDetectorJsonFormatDescriptorProperty(
        block: CfnAnomalyDetectorJsonFormatDescriptorPropertyDsl.() -> Unit =
            {},
    ...
    public inline fun cfnAnomalyDetectorMetricSetProperty(
        block: CfnAnomalyDetectorMetricSetPropertyDsl.() -> Unit =
            {},
    ...
    public inline fun cfnAnomalyDetectorMetricSourceProperty(
        block: CfnAnomalyDetectorMetricSourcePropertyDsl.() -> Unit =
            {},
    ...
    public inline fun cfnAnomalyDetectorRDSSourceConfigProperty(
        block: CfnAnomalyDetectorRDSSourceConfigPropertyDsl.() -> Unit =
            {},
    ...
    public inline fun cfnAnomalyDetectorRedshiftSourceConfigProperty(
        block: CfnAnomalyDetectorRedshiftSourceConfigPropertyDsl.() -> Unit =
            {},
    ...
    public inline fun cfnAnomalyDetectorS3SourceConfigProperty(
        block: CfnAnomalyDetectorS3SourceConfigPropertyDsl.() -> Unit =
            {},
    ...
    public inline fun cfnAnomalyDetectorTimestampColumnProperty(
        block: CfnAnomalyDetectorTimestampColumnPropertyDsl.() -> Unit =
            {},
    ...
    public inline fun cfnAnomalyDetectorVpcConfigurationProperty(
        block: CfnAnomalyDetectorVpcConfigurationPropertyDsl.() -> Unit =
            {},
