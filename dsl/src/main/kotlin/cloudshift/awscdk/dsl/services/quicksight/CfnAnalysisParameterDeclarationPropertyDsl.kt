...
public class CfnAnalysisParameterDeclarationPropertyDsl {
    ...
    public fun dateTimeParameterDeclaration(dateTimeParameterDeclaration: CfnAnalysis.DateTimeParameterDeclarationProperty) {
        cdkBuilder.dateTimeParameterDeclaration(dateTimeParameterDeclaration)
    }
    ...
    public fun decimalParameterDeclaration(decimalParameterDeclaration: CfnAnalysis.DecimalParameterDeclarationProperty) {
        cdkBuilder.decimalParameterDeclaration(decimalParameterDeclaration)
    }
    ...
    public fun integerParameterDeclaration(integerParameterDeclaration: CfnAnalysis.IntegerParameterDeclarationProperty) {
        cdkBuilder.integerParameterDeclaration(integerParameterDeclaration)
    }
    ...
    public fun stringParameterDeclaration(stringParameterDeclaration: CfnAnalysis.StringParameterDeclarationProperty) {
        cdkBuilder.stringParameterDeclaration(stringParameterDeclaration)
    }
