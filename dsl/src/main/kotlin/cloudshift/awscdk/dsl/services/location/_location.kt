...
public object location {
    ...
    public inline fun cfnPlaceIndexProps(block: CfnPlaceIndexPropsDsl.() -> Unit = {}): CfnPlaceIndexProps {
    ...
    public inline fun cfnRouteCalculatorProps(block: CfnRouteCalculatorPropsDsl.() -> Unit = {}): CfnRouteCalculatorProps {
    ...
    public inline fun cfnTrackerConsumerProps(block: CfnTrackerConsumerPropsDsl.() -> Unit = {}): CfnTrackerConsumerProps {
