 ...
 *   health check request about every two seconds. However, health checkers don't coordinate with
 *   one another. Therefore, you might sometimes see several requests in one second that's followed
 *   by a few seconds with no health checks at all.
 ...
 *   AWS endpoint. For information about pricing for health checks, see
 *   [Amazon Route 53 Pricing](https://docs.aws.amazon.com/route53/pricing/) .
 *
 * Example:
 * ```
