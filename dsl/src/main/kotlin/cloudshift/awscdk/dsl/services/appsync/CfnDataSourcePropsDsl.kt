...
public class CfnDataSourcePropsDsl {
     ...
     *   in your account. As of September 2021, Amazon Elasticsearch Service is Amazon OpenSearch
     *   Service . This property is deprecated. For new data sources, use *OpenSearchServiceConfig*
     *   to specify an OpenSearch Service data source.
     */
    ...
    /**
     * @param lambdaConfig An ARN of a Lambda function in valid ARN format. This can be the ARN of a
     *   Lambda function that exists in the current account or in another account.
     */
