...
public class CfnChannelCaptionRectanglePropertyDsl {
   ...
   * topOffset and rectangleHeight must add up to 100% or less. This field corresponds to tts:extent -
  ...
  /**
   * @param leftOffset Applies only if you plan to convert these source captions to EBU-TT-D or TTML
   * in an output.
   ...
   * right edge of the rectangle, all within the underlying video frame. The units for the measurements
   * are percentages. If you specify a value for one of these fields, you must specify a value for all
   * of them.
   *
   ...
   * leftOffset and rectangleWidth must add up to 100% or less. This field corresponds to tts:extent -
