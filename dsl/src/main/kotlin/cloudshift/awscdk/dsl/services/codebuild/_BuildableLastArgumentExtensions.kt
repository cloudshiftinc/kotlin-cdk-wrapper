 ...
 */
public inline fun Project.bindToCodePipeline(_scope: Construct,
 ...
 */
public inline fun Project.metric(metricName: String, block: MetricOptionsDsl.() -> Unit = {}):
    Metric {
 ...
 * @param options
 */
public inline fun Project.onBuildFailed(id: String, block: OnEventOptionsDsl.() -> Unit = {}):
    Rule {
 ...
 * @param options
 */
public inline fun Project.onBuildStarted(id: String, block: OnEventOptionsDsl.() -> Unit = {}):
    Rule {
  val builder = OnEventOptionsDsl()
  builder.apply(block)
 ...
 * @param options
 */
public inline fun Project.onBuildSucceeded(id: String, block: OnEventOptionsDsl.() -> Unit = {}):
    Rule {
  val builder = OnEventOptionsDsl()
  builder.apply(block)
 ...
 * @param options
 */
public inline fun Project.onPhaseChange(id: String, block: OnEventOptionsDsl.() -> Unit = {}):
    Rule {
  val builder = OnEventOptionsDsl()
  builder.apply(block)
 ...
 * @param options
 */
public inline fun Project.onStateChange(id: String, block: OnEventOptionsDsl.() -> Unit = {}):
    Rule {
  val builder = OnEventOptionsDsl()
  builder.apply(block)
 ...
 * @param options
 */
public inline fun IProject.onBuildFailed(arg0: String, block: OnEventOptionsDsl.() -> Unit = {}):
    Rule {
  val builder = OnEventOptionsDsl()
  builder.apply(block)
 ...
 * @param options
 */
public inline fun IProject.onBuildStarted(arg0: String, block: OnEventOptionsDsl.() -> Unit = {}):
    Rule {
  val builder = OnEventOptionsDsl()
  builder.apply(block)
 ...
 * @param options
 */
public inline fun IProject.onBuildSucceeded(arg0: String, block: OnEventOptionsDsl.() -> Unit = {}):
    Rule {
  val builder = OnEventOptionsDsl()
  builder.apply(block)
 ...
 * @param options
 */
public inline fun IProject.onPhaseChange(arg0: String, block: OnEventOptionsDsl.() -> Unit = {}):
    Rule {
  val builder = OnEventOptionsDsl()
  builder.apply(block)
 ...
 * @param options
 */
public inline fun IProject.onStateChange(arg0: String, block: OnEventOptionsDsl.() -> Unit = {}):
    Rule {
  val builder = OnEventOptionsDsl()
  builder.apply(block)
