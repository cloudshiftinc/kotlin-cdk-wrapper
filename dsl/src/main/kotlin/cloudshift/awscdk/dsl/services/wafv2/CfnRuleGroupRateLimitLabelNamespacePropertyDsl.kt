 ...
 */
@CdkDslMarker
public class CfnRuleGroupRateLimitLabelNamespacePropertyDsl {
    private val cdkBuilder: CfnRuleGroup.RateLimitLabelNamespaceProperty.Builder =
    ...
    public fun build(): CfnRuleGroup.RateLimitLabelNamespaceProperty = cdkBuilder.build()
}
