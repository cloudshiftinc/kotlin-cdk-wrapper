 ...
 * `UserVolumeEncryptionEnabled` , or `VolumeEncryptionKey` properties. To update these properties,
 * you must also update a property that triggers a replacement, such as the `UserName` property.
 *
 * Example:
 * ```
