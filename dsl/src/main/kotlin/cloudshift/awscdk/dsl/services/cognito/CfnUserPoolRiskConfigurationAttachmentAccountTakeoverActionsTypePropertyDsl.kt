...
public class CfnUserPoolRiskConfigurationAttachmentAccountTakeoverActionsTypePropertyDsl {
    ...
    /** @param highAction Action to take for a high risk. */
    public fun highAction(
        highAction: CfnUserPoolRiskConfigurationAttachment.AccountTakeoverActionTypeProperty
    ) {
        cdkBuilder.highAction(highAction)
    }
    ...
    /** @param lowAction Action to take for a low risk. */
    public fun lowAction(
        lowAction: CfnUserPoolRiskConfigurationAttachment.AccountTakeoverActionTypeProperty
    ) {
        cdkBuilder.lowAction(lowAction)
    }
    ...
    public fun mediumAction(
        mediumAction: CfnUserPoolRiskConfigurationAttachment.AccountTakeoverActionTypeProperty
    ) {
        cdkBuilder.mediumAction(mediumAction)
    }
