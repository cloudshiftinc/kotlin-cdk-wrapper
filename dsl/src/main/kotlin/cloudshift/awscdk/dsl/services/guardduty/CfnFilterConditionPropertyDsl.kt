...
public class CfnFilterConditionPropertyDsl {
  ...
  /**
   * @param equalTo Represents an *equal* ** condition to be applied to a single field when querying
   * for findings.
   */
  ...
  /**
   * @param lte Represents the less than or equal condition to apply to a single field when querying
   * for findings.
   */
