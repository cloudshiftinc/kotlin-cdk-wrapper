 ...
 */
@CdkDslMarker
public class CfnDashboardScatterPlotUnaggregatedFieldWellsPropertyDsl {
    private val cdkBuilder: CfnDashboard.ScatterPlotUnaggregatedFieldWellsProperty.Builder =
    ...
    /**
     * @param xAxis The x-axis field well of a scatter plot. The x-axis is a dimension field and
    ...
    /**
     * @param yAxis The y-axis field well of a scatter plot. The y-axis is a dimension field and
     *   cannot be aggregated.
     */
    ...
    public fun build(): CfnDashboard.ScatterPlotUnaggregatedFieldWellsProperty {
