...
public class CfnDashboardPivotTableConfigurationPropertyDsl {
   ...
   */
  public
      fun paginatedReportOptions(paginatedReportOptions: CfnDashboard.PivotTablePaginatedReportOptionsProperty) {
    cdkBuilder.paginatedReportOptions(paginatedReportOptions)
  }
   ...
   */
  public
      fun sortConfiguration(sortConfiguration: CfnDashboard.PivotTableSortConfigurationProperty) {
    cdkBuilder.sortConfiguration(sortConfiguration)
  }
