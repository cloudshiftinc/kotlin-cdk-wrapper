...
public class CfnInstanceProfilePropsDsl {
    ...
    /**
     * @param instanceProfileName The name of the instance profile to create. This parameter allows
    ...
    /**
     * @param roles The name of the role to associate with the instance profile. Only one role can
     *   be assigned to an EC2 instance at a time, and all applications on the instance share the
