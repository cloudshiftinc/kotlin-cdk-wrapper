 ...
 */
@CdkDslMarker
public class CfnDashboardParametersPropertyDsl {
    private val cdkBuilder: CfnDashboard.ParametersProperty.Builder =
    ...
    public fun build(): CfnDashboard.ParametersProperty {
