...
public class CfnSpotFleetSpotPlacementPropertyDsl {
    ...
    /**
     * @param availabilityZone The Availability Zone. To specify multiple Availability Zones,
    ...
    /**
     * @param tenancy The tenancy of the instance (if the instance is running in a VPC). An instance
