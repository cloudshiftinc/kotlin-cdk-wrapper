...
public class CfnTemplateConditionalFormattingCustomIconConditionPropertyDsl {
     ...
     * @param displayConfiguration Determines the icon display configuration.
     */
    public fun displayConfiguration(displayConfiguration: CfnTemplate.ConditionalFormattingIconDisplayConfigurationProperty) {
        cdkBuilder.displayConfiguration(displayConfiguration)
    }
    ...
    public fun build(): CfnTemplate.ConditionalFormattingCustomIconConditionProperty = cdkBuilder.build()
}
