...
public class CfnFlowSalesforceSourcePropertiesPropertyDsl {
   ...
   * the next. For example, if a flow runs daily, it might use REST API on one day to transfer 900,000
   * records, and it might use Bulk API 2.0 on the next day to transfer 1,100,000 records. For each of
