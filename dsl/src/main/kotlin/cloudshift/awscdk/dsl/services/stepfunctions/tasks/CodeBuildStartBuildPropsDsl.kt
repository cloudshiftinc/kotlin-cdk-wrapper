...
@CdkDslMarker
public class CodeBuildStartBuildPropsDsl {
    private val cdkBuilder: CodeBuildStartBuildProps.Builder = CodeBuildStartBuildProps.builder()
    ...
    public fun environmentVariablesOverride(environmentVariablesOverride: Map<String, BuildEnvironmentVariable>) {
    ...
    public fun build(): CodeBuildStartBuildProps = cdkBuilder.build()
}
