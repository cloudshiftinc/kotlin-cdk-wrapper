...
public class CfnScheduledActionPropsDsl {
     ...
     *   after the scheduled action runs and the capacity it attempts to maintain. It can scale
    ...
    /**
     * @param endTime The date and time for the recurring schedule to end, in UTC. For example,
    ...
    /**
     * @param recurrence The recurring schedule for this action. This format consists of five fields
     ...
     *   this format, see [Crontab](https://docs.aws.amazon.com/http://crontab.org) .
     *
     ...
     *   `Recurrence` and `StartTime` , Amazon EC2 Auto Scaling performs the action at this time,
