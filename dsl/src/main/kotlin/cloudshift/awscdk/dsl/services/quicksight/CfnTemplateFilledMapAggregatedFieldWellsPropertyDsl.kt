...
@CdkDslMarker
public class CfnTemplateFilledMapAggregatedFieldWellsPropertyDsl {
  private val cdkBuilder: CfnTemplate.FilledMapAggregatedFieldWellsProperty.Builder =
  ...
  public fun build(): CfnTemplate.FilledMapAggregatedFieldWellsProperty {
