...
public class CfnChannelEbuTtDDestinationSettingsPropertyDsl {
  ...
  /**
   * @param copyrightHolder Applies only if you plan to convert these source captions to EBU-TT-D or
   * TTML in an output.
  ...
  /**
   * @param fontFamily Specifies the font family to include in the font data attached to the EBU-TT
   * captions.
   * Valid only if styleControl is set to include. If you leave this field empty, the font family is
   * set to "monospaced". (If styleControl is set to exclude, the font family is always set to
   ...
   * downstream player to choose the size. - Enter a list of font families, as a comma-separated list
   * of font names, in order of preference. The name can be a font family (such as “Arial”), or a
   * generic font family (such as “serif”), or “default” (to let the downstream player choose the
   * font).
   *
