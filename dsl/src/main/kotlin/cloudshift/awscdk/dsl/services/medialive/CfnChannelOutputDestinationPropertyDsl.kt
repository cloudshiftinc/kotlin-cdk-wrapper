...
public class CfnChannelOutputDestinationPropertyDsl {
    ...
    /**
     * @param multiplexSettings Destination settings for a Multiplex output;. one destination for
     *   both encoders.
     */
    ...
    public fun multiplexSettings(
        multiplexSettings: CfnChannel.MultiplexProgramChannelDestinationSettingsProperty
    ) {
        cdkBuilder.multiplexSettings(multiplexSettings)
    }
    ...
    public fun build(): CfnChannel.OutputDestinationProperty {
        if (_mediaPackageSettings.isNotEmpty())
            cdkBuilder.mediaPackageSettings(_mediaPackageSettings)
