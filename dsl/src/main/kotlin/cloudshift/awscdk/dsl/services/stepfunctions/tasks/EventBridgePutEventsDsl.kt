...
public class EventBridgePutEventsDsl(
    ...
    private val cdkBuilder: EventBridgePutEvents.Builder =
        EventBridgePutEvents.Builder.create(scope, id)
     ...
     *
     * Minimum number of entries is 1 and maximum is 10, unless
    ...
    public fun build(): EventBridgePutEvents {
