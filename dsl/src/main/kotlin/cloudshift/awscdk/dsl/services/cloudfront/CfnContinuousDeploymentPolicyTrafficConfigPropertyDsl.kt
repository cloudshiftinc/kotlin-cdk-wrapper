...
public class CfnContinuousDeploymentPolicyTrafficConfigPropertyDsl {
    ...
    public fun singleHeaderConfig(singleHeaderConfig: CfnContinuousDeploymentPolicy.SingleHeaderConfigProperty) {
        cdkBuilder.singleHeaderConfig(singleHeaderConfig)
    }
    ...
    public fun singleWeightConfig(singleWeightConfig: CfnContinuousDeploymentPolicy.SingleWeightConfigProperty) {
        cdkBuilder.singleWeightConfig(singleWeightConfig)
    }
