...
public class CfnApplicationV2CheckpointConfigurationPropertyDsl {
     ...
     * `CheckpointInterval` value of 60000, even if this value is set to another value using this
     ...
     *   checkpoint operation completes that a new checkpoint operation can start. If a checkpoint
     *   operation takes longer than the `CheckpointInterval` , the application otherwise performs
     *   continual checkpoint operations. For more information, see
