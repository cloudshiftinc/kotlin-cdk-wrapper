...
public class CfnJobDefinitionContainerPropertiesPropertyDsl {
    ...
    public fun fargatePlatformConfiguration(fargatePlatformConfiguration: CfnJobDefinition.FargatePlatformConfigurationProperty) {
        cdkBuilder.fargatePlatformConfiguration(fargatePlatformConfiguration)
    }
    ...
    public fun networkConfiguration(networkConfiguration: CfnJobDefinition.NetworkConfigurationProperty) {
        cdkBuilder.networkConfiguration(networkConfiguration)
    }
