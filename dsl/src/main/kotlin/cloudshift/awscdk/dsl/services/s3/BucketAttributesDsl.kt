...
public class BucketAttributesDsl {
     ...
     *   name will be parsed from the ARN. Otherwise, the name is optional, but some features that
     *   require the bucket name such as auto-creating a bucket policy, won't work.
     */
    ...
    /**
     * @param region The region this existing bucket is in. Features that require the region (e.g.
     *   `bucketWebsiteUrl`) won't fully work if the region cannot be correctly inferred.
     */
