 ...
 * list, Macie doesn’t report the data in sensitive data findings or sensitive data discovery
 ...
 *   Storage Service ( Amazon S3 ) bucket. You then configure settings for Macie to access the list
 *   in the bucket.
 *
 ...
 *   defines a text pattern to ignore. Unlike an allow list with predefined text, you store the
