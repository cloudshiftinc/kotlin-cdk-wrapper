...
public class CfnPolicyPropsDsl {
     ...
     *   performs cleanup according to the policy type. For AWS WAF and Shield Advanced policies,
     *   Firewall Manager does the following:
     ...
     *   in the policy scope or explicitly exclude them. If this isn't set, then tags aren't used to
     *   modify policy scope. See also `ExcludeResourceTags` .
     */
    ...
    /**
     * @param resourceType The type of resource protected by or in scope of the policy. This is in
    ...
    /**
     * @param resourceTypeList An array of `ResourceType` objects. Use this only to specify multiple
     ...
     *   Manager is managing for accounts when those accounts leave policy scope. For example,
     *   Firewall Manager will disassociate a Firewall Manager managed web ACL from a protected
     ...
     *   protect the resources. This contains the following settings:
    ...
    /**
     * @param tags A collection of key:value pairs associated with an AWS resource. The key:value
