...
public class CfnQueueDsl(
   ...
   * @param delaySeconds The time in seconds for which the delivery of all messages in the queue is
   * delayed. 
   */
   ...
   * @param maximumMessageSize The limit of how many bytes that a message can contain before Amazon
   * SQS rejects it. 
   */
   ...
   * @param visibilityTimeout The length of time during which a message will be unavailable after a
   * message is delivered from the queue. 
   */
