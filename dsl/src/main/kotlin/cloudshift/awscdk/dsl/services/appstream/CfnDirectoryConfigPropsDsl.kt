...
public class CfnDirectoryConfigPropsDsl {
     ...
     *   streaming instance to connect to the directory. Do not use this parameter directly. Use
     *   `ServiceAccountCredentials` as an input parameter with `noEcho` as shown in the
