 ...
 */
@CdkDslMarker
public class CfnAnalysisKPIVisualPropertyDsl {
    private val cdkBuilder: CfnAnalysis.KPIVisualProperty.Builder =
     ...
     * @param chartConfiguration The configuration of a KPI visual.
     */
    public fun chartConfiguration(chartConfiguration: CfnAnalysis.KPIConfigurationProperty) {
        cdkBuilder.chartConfiguration(chartConfiguration)
    }
     ...
     * @param conditionalFormatting The conditional formatting of a KPI visual.
     */
    public fun conditionalFormatting(conditionalFormatting: CfnAnalysis.KPIConditionalFormattingProperty) {
        cdkBuilder.conditionalFormatting(conditionalFormatting)
    }
    ...
    public fun build(): CfnAnalysis.KPIVisualProperty {
