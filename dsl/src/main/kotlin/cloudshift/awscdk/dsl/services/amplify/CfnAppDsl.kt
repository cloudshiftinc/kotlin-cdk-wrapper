...
public class CfnAppDsl(
  ...
  /**
   * The AWS Identity and Access Management (IAM) service role for the Amazon Resource Name (ARN) of
   * the Amplify app.
   *
   ...
   * @param iamServiceRole The AWS Identity and Access Management (IAM) service role for the Amazon
