...
public class CfnEnvironmentEC2PropsDsl {
     ...
     *   valid AWS Systems Manager path.
     *
    ...
    /**
     * @param ownerArn The Amazon Resource Name (ARN) of the environment owner. This ARN can be the
     *   ARN of any AWS Identity and Access Management principal. If this value is not specified,
