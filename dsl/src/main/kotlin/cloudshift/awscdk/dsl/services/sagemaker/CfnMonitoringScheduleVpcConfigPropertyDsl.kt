 ...
 */
@CdkDslMarker
public class CfnMonitoringScheduleVpcConfigPropertyDsl {
  private val cdkBuilder: CfnMonitoringSchedule.VpcConfigProperty.Builder =
  ...
  public fun build(): CfnMonitoringSchedule.VpcConfigProperty {
