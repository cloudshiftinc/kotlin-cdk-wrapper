...
public class CfnPipeEcsContainerOverridePropertyDsl {
     ...
     *   existing environment variables from the Docker image or the task definition. You must also
     ...
     *   default value from the task definition. If your container attempts to exceed the memory
     ...
     *   instead of the default value from the task definition. You must also specify a container
     *   name.
     */
    ...
    /**
     * @param name The name of the container that receives the override. This parameter is required
     ...
     *   instead of the default value from the task definition. The only supported resource is a
     *   GPU.
     */
