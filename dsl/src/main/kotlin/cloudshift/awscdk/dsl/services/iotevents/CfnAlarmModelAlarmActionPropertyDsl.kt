...
public class CfnAlarmModelAlarmActionPropertyDsl {
  ...
  /**
   * @param iotEvents Sends an AWS IoT Events input, passing in information about the detector model
  ...
  /**
   * @param sqs Sends information about the detector model instance and the event that triggered the
