...
public class ServerlessClusterFromSnapshotDsl(
     ...
     *
     * Automatic backup retention cannot be disabled on serverless clusters. Must be a value from 1
     * day to 35 days.
     *
     ...
     *
     * Default: - Serverless cluster is automatically paused after 5 minutes of being idle. minimum
     * capacity: 2 ACU maximum capacity: 16 ACU
     *
     ...
     * Security group.
     *
     * Default: - a new security group is created if `vpc` was provided. If the `vpc` property was
     * not provided, no VPC security groups will be associated with the DB cluster.
     *
     ...
     *
     * Default: - a new subnet group is created if `vpc` was provided. If the `vpc` property was not
     * provided, no subnet group will be associated with the DB cluster
     *
