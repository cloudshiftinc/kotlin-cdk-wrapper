...
public class CfnAppAutoBranchCreationConfigPropertyDsl {
    ...
    /**
     * @param buildSpec The build specification (build spec) for the autocreated branch. *Length
     ...
     *   branch that Amplify Hosting automatically creates for your app. Amplify creates previews by
     *   deploying your app to a unique URL whenever a pull request is opened for the branch.
     *   Development and QA teams can use this preview to test the pull request before it's merged
     *   into a production or integration branch.
     *
     ...
     *   property to specify a dedicated backend environment for your previews. For example, you
     *   could specify an environment named `prod` , `test` , or `dev` that you initialized with the
     *   Amplify CLI.
     *
