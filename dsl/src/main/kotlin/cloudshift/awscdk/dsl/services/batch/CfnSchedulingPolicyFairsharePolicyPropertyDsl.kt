...
public class CfnSchedulingPolicyFairsharePolicyPropertyDsl {
     ...
     *   share identifiers that aren't already used. The reserved ratio is `( *computeReservation*
     *   /100)^ *ActiveFairShares*` where `*ActiveFairShares*` is the number of active fair share
     *   identifiers.
     *
     ...
     *   percentage for each fair share identifier in use. A value of zero (0) indicates that only
     *   current usage is measured. The decay allows for more recently run jobs to have more weight
     *   than jobs that ran earlier. The maximum supported value is 604800 (1 week).
     */
     ...
     *   the fair share identifiers for the fair share policy. Fair share identifiers that aren't
