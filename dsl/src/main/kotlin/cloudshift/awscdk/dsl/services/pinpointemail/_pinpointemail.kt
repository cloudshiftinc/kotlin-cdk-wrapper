...
public object pinpointemail {
  ...
  public inline
      fun cfnConfigurationSetEventDestinationPinpointDestinationProperty(block: CfnConfigurationSetEventDestinationPinpointDestinationPropertyDsl.() -> Unit
  ...
  public inline
      fun cfnConfigurationSetTagsProperty(block: CfnConfigurationSetTagsPropertyDsl.() -> Unit =
  ...
  public inline
      fun cfnDedicatedIpPoolTagsProperty(block: CfnDedicatedIpPoolTagsPropertyDsl.() -> Unit = {}):
  ...
  public inline
      fun cfnIdentityMailFromAttributesProperty(block: CfnIdentityMailFromAttributesPropertyDsl.() -> Unit
  ...
  public inline fun cfnIdentityTagsProperty(block: CfnIdentityTagsPropertyDsl.() -> Unit = {}):
