...
public class ClusterAttributesDsl {
  ...
  /**
   * @param clusterEncryptionConfigKeyArn Amazon Resource Name (ARN) or alias of the customer master
   * key (CMK).
   */
  ...
  /**
   * @param clusterSecurityGroupId The cluster security group that was created by Amazon EKS for the
   * cluster.
   */
