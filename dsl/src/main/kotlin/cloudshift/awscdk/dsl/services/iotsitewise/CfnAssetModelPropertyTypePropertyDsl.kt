...
public class CfnAssetModelPropertyTypePropertyDsl {
    ...
    /**
     * @param attribute Specifies an asset attribute property. An attribute generally contains
    ...
    /**
     * @param metric Specifies an asset metric property. A metric contains a mathematical expression
     *   that uses aggregate functions to process all input data points over a time interval and
    ...
    /**
     * @param transform Specifies an asset transform property. A transform contains a mathematical
     *   expression that maps a property's data points from one form to another, such as a unit
