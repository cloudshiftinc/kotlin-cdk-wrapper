...
public class CfnBotPostDialogCodeHookInvocationSpecificationPropertyDsl {
  ...
  /**
   * @param failureConditional A list of conditional branches to evaluate after the dialog code hook
  ...
  /**
   * @param successConditional A list of conditional branches to evaluate after the dialog code hook
  ...
  /**
   * @param successNextStep Specifics the next step the bot runs after the dialog code hook finishes
   * successfully.
   */
