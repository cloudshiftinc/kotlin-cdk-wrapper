...
public object amazonmq {
  ...
  public inline
      fun cfnBrokerConfigurationIdProperty(block: CfnBrokerConfigurationIdPropertyDsl.() -> Unit =
  ...
  public inline
      fun cfnBrokerEncryptionOptionsProperty(block: CfnBrokerEncryptionOptionsPropertyDsl.() -> Unit
  ...
  public inline
      fun cfnBrokerLdapServerMetadataProperty(block: CfnBrokerLdapServerMetadataPropertyDsl.() -> Unit
  ...
  public inline fun cfnBrokerLogListProperty(block: CfnBrokerLogListPropertyDsl.() -> Unit = {}):
  ...
  public inline
      fun cfnBrokerMaintenanceWindowProperty(block: CfnBrokerMaintenanceWindowPropertyDsl.() -> Unit
  ...
  public inline fun cfnBrokerTagsEntryProperty(block: CfnBrokerTagsEntryPropertyDsl.() -> Unit =
  ...
  public inline fun cfnBrokerUserProperty(block: CfnBrokerUserPropertyDsl.() -> Unit = {}):
  ...
  public inline
      fun cfnConfigurationAssociationConfigurationIdProperty(block: CfnConfigurationAssociationConfigurationIdPropertyDsl.() -> Unit
  ...
  public inline
      fun cfnConfigurationAssociationProps(block: CfnConfigurationAssociationPropsDsl.() -> Unit =
  ...
  public inline
      fun cfnConfigurationTagsEntryProperty(block: CfnConfigurationTagsEntryPropertyDsl.() -> Unit =
