...
public object codestar {
     ...
     *
     * You must provide a location for the source code ZIP file in the AWS CloudFormation template,
     * so the code can be uploaded to the created repository. You must have created a personal
     * access token in GitHub to provide in the AWS CloudFormation template. AWS uses this token to
     * connect to GitHub on your behalf. For more information about using a GitHub source repository
     * with AWS CodeStar projects, see
     * [AWS CodeStar Project Files and Resources](https://docs.aws.amazon.com/codestar/latest/userguide/templates.html#templates-whatis)
     * .
     *
     * Example:
     * ```
     ...
     */
    public inline fun cfnGitHubRepositoryCodeProperty(
     ...
     * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-codestar-githubrepository.html)
     */
    public inline fun cfnGitHubRepositoryProps(
        block: CfnGitHubRepositoryPropsDsl.() -> Unit = {}
    ...
    /**
     * The `S3` property type specifies information about the Amazon S3 bucket that contains the
     * code to be committed to the new repository.
     *
     ...
     */
    public inline fun cfnGitHubRepositoryS3Property(
        block: CfnGitHubRepositoryS3PropertyDsl.() -> Unit = {}
