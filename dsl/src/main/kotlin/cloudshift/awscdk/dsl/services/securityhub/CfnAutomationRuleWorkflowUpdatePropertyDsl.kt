...
public class CfnAutomationRuleWorkflowUpdatePropertyDsl {
   ...
   * The workflow status is specific to an individual finding. It does not affect the generation of
   * new findings. For example, setting the workflow status to `SUPPRESSED` or `RESOLVED` does not
