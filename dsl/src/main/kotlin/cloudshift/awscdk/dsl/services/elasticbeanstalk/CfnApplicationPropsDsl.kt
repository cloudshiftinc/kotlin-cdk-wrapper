...
public class CfnApplicationPropsDsl {
    ...
    /**
     * @param applicationName A name for the Elastic Beanstalk application. If you don't specify a
     *   name, AWS CloudFormation generates a unique physical ID and uses that ID for the
     *   application name. For more information, see
