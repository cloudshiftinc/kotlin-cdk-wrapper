...
public class PolicyDocumentPropsDsl {
    ...
    /**
     * @param minimize Try to minimize the policy by merging statements. To avoid overrunning the
     *   maximum policy size, combine statements if they produce the same result. Merging happens
