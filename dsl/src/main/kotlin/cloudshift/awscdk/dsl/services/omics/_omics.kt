...
public object omics {
    ...
    public inline fun cfnAnnotationStoreProps(block: CfnAnnotationStorePropsDsl.() -> Unit = {}): CfnAnnotationStoreProps {
        val builder = CfnAnnotationStorePropsDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun cfnAnnotationStoreReferenceItemProperty(
    ...
    public inline fun cfnAnnotationStoreSseConfigProperty(
        block: CfnAnnotationStoreSseConfigPropertyDsl.() -> Unit =
            {},
    ...
    public inline fun cfnAnnotationStoreStoreOptionsProperty(
        block: CfnAnnotationStoreStoreOptionsPropertyDsl.() -> Unit =
            {},
    ...
    public inline fun cfnAnnotationStoreTsvStoreOptionsProperty(
        block: CfnAnnotationStoreTsvStoreOptionsPropertyDsl.() -> Unit =
            {},
    ...
    public inline fun cfnReferenceStoreProps(block: CfnReferenceStorePropsDsl.() -> Unit = {}): CfnReferenceStoreProps {
        val builder = CfnReferenceStorePropsDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun cfnReferenceStoreSseConfigProperty(
    ...
    public inline fun cfnSequenceStoreProps(block: CfnSequenceStorePropsDsl.() -> Unit = {}): CfnSequenceStoreProps {
        val builder = CfnSequenceStorePropsDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun cfnSequenceStoreSseConfigProperty(
        block: CfnSequenceStoreSseConfigPropertyDsl.() -> Unit =
            {},
    ...
    public inline fun cfnVariantStoreProps(block: CfnVariantStorePropsDsl.() -> Unit = {}): CfnVariantStoreProps {
        val builder = CfnVariantStorePropsDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun cfnVariantStoreReferenceItemProperty(
        block: CfnVariantStoreReferenceItemPropertyDsl.() -> Unit =
            {},
    ...
    public inline fun cfnVariantStoreSseConfigProperty(
        block: CfnVariantStoreSseConfigPropertyDsl.() -> Unit =
            {},
    ...
    public inline fun cfnWorkflowWorkflowParameterProperty(
        block: CfnWorkflowWorkflowParameterPropertyDsl.() -> Unit =
            {},
