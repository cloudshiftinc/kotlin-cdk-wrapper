...
public object elasticloadbalancingv2 {
    public inline fun addApplicationActionProps(block: AddApplicationActionPropsDsl.() -> Unit = {}): AddApplicationActionProps {
    ...
    public inline fun addNetworkActionProps(block: AddNetworkActionPropsDsl.() -> Unit = {}): AddNetworkActionProps {
        val builder = AddNetworkActionPropsDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun addNetworkTargetsProps(block: AddNetworkTargetsPropsDsl.() -> Unit = {}): AddNetworkTargetsProps {
    ...
    public inline fun applicationListenerProps(block: ApplicationListenerPropsDsl.() -> Unit = {}): ApplicationListenerProps {
    ...
    public inline fun authenticateOidcOptions(block: AuthenticateOidcOptionsDsl.() -> Unit = {}): AuthenticateOidcOptions {
    ...
    public inline fun baseListenerLookupOptions(block: BaseListenerLookupOptionsDsl.() -> Unit = {}): BaseListenerLookupOptions {
    ...
    public inline fun baseLoadBalancerProps(block: BaseLoadBalancerPropsDsl.() -> Unit = {}): BaseLoadBalancerProps {
        val builder = BaseLoadBalancerPropsDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun baseNetworkListenerProps(block: BaseNetworkListenerPropsDsl.() -> Unit = {}): BaseNetworkListenerProps {
        val builder = BaseNetworkListenerPropsDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun baseTargetGroupProps(block: BaseTargetGroupPropsDsl.() -> Unit = {}): BaseTargetGroupProps {
    ...
    public inline fun cfnListenerActionProperty(block: CfnListenerActionPropertyDsl.() -> Unit = {}): CfnListener.ActionProperty {
    ...
    public inline fun cfnListenerRuleProps(block: CfnListenerRulePropsDsl.() -> Unit = {}): CfnListenerRuleProps {
    ...
    public inline fun cfnTargetGroupProps(block: CfnTargetGroupPropsDsl.() -> Unit = {}): CfnTargetGroupProps {
    ...
    public inline fun fixedResponseOptions(block: FixedResponseOptionsDsl.() -> Unit = {}): FixedResponseOptions {
    ...
    public inline fun loadBalancerTargetProps(block: LoadBalancerTargetPropsDsl.() -> Unit = {}): LoadBalancerTargetProps {
        val builder = LoadBalancerTargetPropsDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun networkForwardOptions(block: NetworkForwardOptionsDsl.() -> Unit = {}): NetworkForwardOptions {
    ...
    public inline fun networkListenerProps(block: NetworkListenerPropsDsl.() -> Unit = {}): NetworkListenerProps {
    ...
    public inline fun networkLoadBalancerProps(block: NetworkLoadBalancerPropsDsl.() -> Unit = {}): NetworkLoadBalancerProps {
    ...
    public inline fun networkTargetGroupProps(block: NetworkTargetGroupPropsDsl.() -> Unit = {}): NetworkTargetGroupProps {
    ...
    public inline fun queryStringCondition(block: QueryStringConditionDsl.() -> Unit = {}): QueryStringCondition {
    ...
    public inline fun targetGroupAttributes(block: TargetGroupAttributesDsl.() -> Unit = {}): TargetGroupAttributes {
        val builder = TargetGroupAttributesDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun weightedTargetGroup(block: WeightedTargetGroupDsl.() -> Unit = {}): WeightedTargetGroup {
