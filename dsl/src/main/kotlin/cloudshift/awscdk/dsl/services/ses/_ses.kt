...
public object ses {
    public inline fun addHeaderActionConfig(block: AddHeaderActionConfigDsl.() -> Unit = {}): AddHeaderActionConfig {
    ...
    public inline fun bounceActionConfig(block: BounceActionConfigDsl.() -> Unit = {}): BounceActionConfig {
    ...
    public inline fun cfnContactListProps(block: CfnContactListPropsDsl.() -> Unit = {}): CfnContactListProps {
    ...
    public inline fun cfnEmailIdentityProps(block: CfnEmailIdentityPropsDsl.() -> Unit = {}): CfnEmailIdentityProps {
    ...
    public inline fun cfnReceiptFilterProps(block: CfnReceiptFilterPropsDsl.() -> Unit = {}): CfnReceiptFilterProps {
    ...
    public inline fun cfnReceiptRuleProps(block: CfnReceiptRulePropsDsl.() -> Unit = {}): CfnReceiptRuleProps {
    ...
    public inline fun cfnReceiptRuleSetProps(block: CfnReceiptRuleSetPropsDsl.() -> Unit = {}): CfnReceiptRuleSetProps {
    ...
    public inline fun cfnVdmAttributesProps(block: CfnVdmAttributesPropsDsl.() -> Unit = {}): CfnVdmAttributesProps {
        val builder = CfnVdmAttributesPropsDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun cloudWatchDimension(block: CloudWatchDimensionDsl.() -> Unit = {}): CloudWatchDimension {
    ...
    public inline fun configurationSetProps(block: ConfigurationSetPropsDsl.() -> Unit = {}): ConfigurationSetProps {
    ...
    public inline fun dedicatedIpPoolProps(block: DedicatedIpPoolPropsDsl.() -> Unit = {}): DedicatedIpPoolProps {
        val builder = DedicatedIpPoolPropsDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun dkimIdentityConfig(block: DkimIdentityConfigDsl.() -> Unit = {}): DkimIdentityConfig {
    ...
    public inline fun dropSpamReceiptRuleProps(block: DropSpamReceiptRulePropsDsl.() -> Unit = {}): DropSpamReceiptRuleProps {
    ...
    public inline fun emailIdentityProps(block: EmailIdentityPropsDsl.() -> Unit = {}): EmailIdentityProps {
        val builder = EmailIdentityPropsDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun lambdaActionConfig(block: LambdaActionConfigDsl.() -> Unit = {}): LambdaActionConfig {
    ...
    public inline fun receiptFilterProps(block: ReceiptFilterPropsDsl.() -> Unit = {}): ReceiptFilterProps {
    ...
    public inline fun receiptRuleActionConfig(block: ReceiptRuleActionConfigDsl.() -> Unit = {}): ReceiptRuleActionConfig {
        val builder = ReceiptRuleActionConfigDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun receiptRuleOptions(block: ReceiptRuleOptionsDsl.() -> Unit = {}): ReceiptRuleOptions {
    ...
    public inline fun receiptRuleSetProps(block: ReceiptRuleSetPropsDsl.() -> Unit = {}): ReceiptRuleSetProps {
    ...
    public inline fun vdmAttributesProps(block: VdmAttributesPropsDsl.() -> Unit = {}): VdmAttributesProps {
        val builder = VdmAttributesPropsDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun workmailActionConfig(block: WorkmailActionConfigDsl.() -> Unit = {}): WorkmailActionConfig {
