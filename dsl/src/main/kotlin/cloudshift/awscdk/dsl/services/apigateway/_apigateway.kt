...
public object apigateway {
    ...
    public inline fun apiDefinitionConfig(block: ApiDefinitionConfigDsl.() -> Unit = {}): ApiDefinitionConfig {
        val builder = ApiDefinitionConfigDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun apiDefinitionS3Location(block: ApiDefinitionS3LocationDsl.() -> Unit = {}): ApiDefinitionS3Location {
    ...
    public inline fun apiMappingOptions(block: ApiMappingOptionsDsl.() -> Unit = {}): ApiMappingOptions {
        val builder = ApiMappingOptionsDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun assetApiDefinition(path: String, block: AssetApiDefinitionDsl.() -> Unit = {}): AssetApiDefinition {
    ...
    public inline fun awsIntegrationProps(block: AwsIntegrationPropsDsl.() -> Unit = {}): AwsIntegrationProps {
    ...
    public inline fun basePathMappingOptions(block: BasePathMappingOptionsDsl.() -> Unit = {}): BasePathMappingOptions {
        val builder = BasePathMappingOptionsDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun basePathMappingProps(block: BasePathMappingPropsDsl.() -> Unit = {}): BasePathMappingProps {
    ...
    public inline fun cfnApiKeyStageKeyProperty(block: CfnApiKeyStageKeyPropertyDsl.() -> Unit = {}): CfnApiKey.StageKeyProperty {
    ...
    public inline fun cfnBasePathMappingProps(block: CfnBasePathMappingPropsDsl.() -> Unit = {}): CfnBasePathMappingProps {
    ...
    public inline fun cfnClientCertificateProps(block: CfnClientCertificatePropsDsl.() -> Unit = {}): CfnClientCertificateProps {
    ...
    public inline fun cfnDocumentationPartProps(block: CfnDocumentationPartPropsDsl.() -> Unit = {}): CfnDocumentationPartProps {
    ...
    public inline fun cfnDomainNameProps(block: CfnDomainNamePropsDsl.() -> Unit = {}): CfnDomainNameProps {
    ...
    public inline fun cfnGatewayResponseProps(block: CfnGatewayResponsePropsDsl.() -> Unit = {}): CfnGatewayResponseProps {
    ...
    public inline fun cfnRequestValidatorProps(block: CfnRequestValidatorPropsDsl.() -> Unit = {}): CfnRequestValidatorProps {
    ...
    public inline fun cfnUsagePlanKeyProps(block: CfnUsagePlanKeyPropsDsl.() -> Unit = {}): CfnUsagePlanKeyProps {
        val builder = CfnUsagePlanKeyPropsDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun cfnUsagePlanProps(block: CfnUsagePlanPropsDsl.() -> Unit = {}): CfnUsagePlanProps {
    ...
    public inline fun domainNameAttributes(block: DomainNameAttributesDsl.() -> Unit = {}): DomainNameAttributes {
        val builder = DomainNameAttributesDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun domainNameOptions(block: DomainNameOptionsDsl.() -> Unit = {}): DomainNameOptions {
    ...
    public inline fun endpointConfiguration(block: EndpointConfigurationDsl.() -> Unit = {}): EndpointConfiguration {
    ...
    public inline fun gatewayResponseOptions(block: GatewayResponseOptionsDsl.() -> Unit = {}): GatewayResponseOptions {
        val builder = GatewayResponseOptionsDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun gatewayResponseProps(block: GatewayResponsePropsDsl.() -> Unit = {}): GatewayResponseProps {
        val builder = GatewayResponsePropsDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun httpIntegration(url: String, block: HttpIntegrationDsl.() -> Unit = {}): HttpIntegration {
        val builder = HttpIntegrationDsl(url)
        builder.apply(block)
        return builder.build()
    }

    public inline fun httpIntegrationProps(block: HttpIntegrationPropsDsl.() -> Unit = {}): HttpIntegrationProps {
    ...
    public inline fun integrationConfig(block: IntegrationConfigDsl.() -> Unit = {}): IntegrationConfig {
        val builder = IntegrationConfigDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun integrationOptions(block: IntegrationOptionsDsl.() -> Unit = {}): IntegrationOptions {
    ...
    public inline fun integrationResponse(block: IntegrationResponseDsl.() -> Unit = {}): IntegrationResponse {
    ...
    public inline fun lambdaAuthorizerProps(block: LambdaAuthorizerPropsDsl.() -> Unit = {}): LambdaAuthorizerProps {
    ...
    public inline fun lambdaIntegrationOptions(block: LambdaIntegrationOptionsDsl.() -> Unit = {}): LambdaIntegrationOptions {
    ...
    public inline fun lambdaRestApiProps(block: LambdaRestApiPropsDsl.() -> Unit = {}): LambdaRestApiProps {
    ...
    public inline fun methodDeploymentOptions(block: MethodDeploymentOptionsDsl.() -> Unit = {}): MethodDeploymentOptions {
    ...
    public inline fun proxyResourceOptions(block: ProxyResourceOptionsDsl.() -> Unit = {}): ProxyResourceOptions {
        val builder = ProxyResourceOptionsDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun proxyResourceProps(block: ProxyResourcePropsDsl.() -> Unit = {}): ProxyResourceProps {
    ...
    public inline fun rateLimitedApiKeyProps(block: RateLimitedApiKeyPropsDsl.() -> Unit = {}): RateLimitedApiKeyProps {
    ...
    public inline fun requestAuthorizerProps(block: RequestAuthorizerPropsDsl.() -> Unit = {}): RequestAuthorizerProps {
    ...
    public inline fun requestValidatorOptions(block: RequestValidatorOptionsDsl.() -> Unit = {}): RequestValidatorOptions {
        val builder = RequestValidatorOptionsDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun requestValidatorProps(block: RequestValidatorPropsDsl.() -> Unit = {}): RequestValidatorProps {
    ...
    public inline fun resourceAttributes(block: ResourceAttributesDsl.() -> Unit = {}): ResourceAttributes {
    ...
    public inline fun restApiAttributes(block: RestApiAttributesDsl.() -> Unit = {}): RestApiAttributes {
    ...
    public inline fun stepFunctionsRestApiProps(block: StepFunctionsRestApiPropsDsl.() -> Unit = {}): StepFunctionsRestApiProps {
    ...
    public inline fun throttlingPerMethod(block: ThrottlingPerMethodDsl.() -> Unit = {}): ThrottlingPerMethod {
    ...
    public inline fun tokenAuthorizerProps(block: TokenAuthorizerPropsDsl.() -> Unit = {}): TokenAuthorizerProps {
    ...
    public inline fun usagePlanPerApiStage(block: UsagePlanPerApiStageDsl.() -> Unit = {}): UsagePlanPerApiStage {
