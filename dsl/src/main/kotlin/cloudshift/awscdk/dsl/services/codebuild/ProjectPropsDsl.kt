...
public class ProjectPropsDsl {
    ...
    /**
     * @param artifacts Defines where build artifacts will be stored. Could be:
     *   PipelineBuildArtifacts, NoArtifacts and S3Artifacts.
     */
    ...
    /**
     * @param secondaryArtifacts The secondary artifacts for the Project. Can also be added after
     *   the Project has been created by using the `Project#addSecondaryArtifact` method.
     */
    ...
    /**
     * @param secondarySources The secondary sources for the Project. Can be also added after the
     *   Project has been created by using the `Project#addSecondarySource` method.
     */
    ...
    /**
     * @param source The source of the build. *Note*: if `NoSource` is given as the source, then you
     *   need to provide an explicit `buildSpec`.
     */
