...
public class CfnDataSourceOneDriveUsersPropertyDsl {
    ...
    /**
     * @param oneDriveUserList A list of users whose documents should be indexed. Specify the user
     *   names in email format, for example, `username&#64;tenantdomain` . If you need to index the
     *   documents of more than 100 users, use the `OneDriveUserS3Path` field to specify the
