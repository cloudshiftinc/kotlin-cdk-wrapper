...
public class CfnDataSourceS3DataSourceConfigurationPropertyDsl {
    ...
    /**
     * @param exclusionPatterns A list of glob patterns for documents that should not be indexed. If
     *   a document that matches an inclusion prefix or inclusion pattern also matches an exclusion
     ...
     * * **internal** will exclude all files in a directory that contain 'internal' in the file
    ...
    /**
     * @param inclusionPatterns A list of glob patterns for documents that should be indexed. If a
     *   document that matches an inclusion pattern also matches an exclusion pattern, the document
     *   is not indexed.
     *
     * Some
     * [examples](https://docs.aws.amazon.com/cli/latest/reference/s3/#use-of-exclude-and-include-filters)
