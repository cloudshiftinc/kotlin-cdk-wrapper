...
public class CfnDataSourceS3DataSourceConfigurationPropertyDsl {
    ...
    public fun accessControlListConfiguration(accessControlListConfiguration: CfnDataSource.AccessControlListConfigurationProperty) {
        cdkBuilder.accessControlListConfiguration(accessControlListConfiguration)
    }
    ...
    public fun documentsMetadataConfiguration(documentsMetadataConfiguration: CfnDataSource.DocumentsMetadataConfigurationProperty) {
        cdkBuilder.documentsMetadataConfiguration(documentsMetadataConfiguration)
    }
