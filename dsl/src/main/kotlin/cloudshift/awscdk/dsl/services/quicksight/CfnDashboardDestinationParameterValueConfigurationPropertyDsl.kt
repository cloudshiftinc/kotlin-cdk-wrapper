...
public class CfnDashboardDestinationParameterValueConfigurationPropertyDsl {
     ...
     * in `DestinationParameterValueConfiguration` .
     */
    public fun customValuesConfiguration(customValuesConfiguration: CfnDashboard.CustomValuesConfigurationProperty) {
        cdkBuilder.customValuesConfiguration(customValuesConfiguration)
    }
    ...
    public fun build(): CfnDashboard.DestinationParameterValueConfigurationProperty = cdkBuilder.build()
}
