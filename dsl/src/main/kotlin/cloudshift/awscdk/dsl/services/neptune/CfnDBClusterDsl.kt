...
public class CfnDBClusterDsl(
     ...
     * `SourceDBInstanceIdentifier` property, don't specify this property. The value is inherited
     * from the cluster, snapshot, or source DB instance. If you specify the `KmsKeyId` property,
