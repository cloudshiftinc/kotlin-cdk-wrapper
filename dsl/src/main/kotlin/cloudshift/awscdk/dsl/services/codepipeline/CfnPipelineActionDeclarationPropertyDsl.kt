...
public class CfnPipelineActionDeclarationPropertyDsl {
   ...
   * . For the list of configuration properties for the AWS CloudFormation action type in CodePipeline,
   ...
   * in the *AWS CloudFormation User Guide* . For template snippets with examples, see [Using Parameter
  ...
  /**
   * @param inputArtifacts The name or ID of the artifact consumed by the action, such as a test or
   * build artifact.
   ...
   * reference](https://docs.aws.amazon.com/codepipeline/latest/userguide/action-reference.html) in the
