...
public class CfnDashboardReferenceLinePropertyDsl {
    ...
    public fun dataConfiguration(dataConfiguration: CfnDashboard.ReferenceLineDataConfigurationProperty) {
        cdkBuilder.dataConfiguration(dataConfiguration)
    }
    ...
    public fun labelConfiguration(labelConfiguration: CfnDashboard.ReferenceLineLabelConfigurationProperty) {
        cdkBuilder.labelConfiguration(labelConfiguration)
    }
    ...
    public fun styleConfiguration(styleConfiguration: CfnDashboard.ReferenceLineStyleConfigurationProperty) {
        cdkBuilder.styleConfiguration(styleConfiguration)
    }
