...
public class CfnDashboardParameterDeclarationPropertyDsl {
    ...
    public fun dateTimeParameterDeclaration(dateTimeParameterDeclaration: CfnDashboard.DateTimeParameterDeclarationProperty) {
        cdkBuilder.dateTimeParameterDeclaration(dateTimeParameterDeclaration)
    }
    ...
    public fun decimalParameterDeclaration(decimalParameterDeclaration: CfnDashboard.DecimalParameterDeclarationProperty) {
        cdkBuilder.decimalParameterDeclaration(decimalParameterDeclaration)
    }
    ...
    public fun integerParameterDeclaration(integerParameterDeclaration: CfnDashboard.IntegerParameterDeclarationProperty) {
        cdkBuilder.integerParameterDeclaration(integerParameterDeclaration)
    }
    ...
    public fun stringParameterDeclaration(stringParameterDeclaration: CfnDashboard.StringParameterDeclarationProperty) {
        cdkBuilder.stringParameterDeclaration(stringParameterDeclaration)
    }
