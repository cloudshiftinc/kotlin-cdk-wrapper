...
public class CfnDistributionDefaultCacheBehaviorPropertyDsl {
  ...
  /**
   * @param cachePolicyId The unique identifier of the cache policy that is attached to the default
   * cache behavior.
   ...
   * that you want CloudFront to use for encrypting specific fields of data for the default cache
   * behavior.
   */
