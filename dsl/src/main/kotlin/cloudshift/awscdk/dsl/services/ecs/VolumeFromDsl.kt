...
public class VolumeFromDsl {
    ...
    /**
     * @param readOnly Specifies whether the container has read-only access to the volume. If this
     *   value is true, the container has read-only access to the volume. If this value is false,
