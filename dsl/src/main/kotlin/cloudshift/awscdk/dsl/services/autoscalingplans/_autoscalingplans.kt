...
public object autoscalingplans {
  ...
  public inline
      fun cfnScalingPlanApplicationSourceProperty(block: CfnScalingPlanApplicationSourcePropertyDsl.() -> Unit
  ...
  public inline
      fun cfnScalingPlanCustomizedLoadMetricSpecificationProperty(block: CfnScalingPlanCustomizedLoadMetricSpecificationPropertyDsl.() -> Unit
  ...
  public inline
      fun cfnScalingPlanCustomizedScalingMetricSpecificationProperty(block: CfnScalingPlanCustomizedScalingMetricSpecificationPropertyDsl.() -> Unit
  ...
  public inline
      fun cfnScalingPlanMetricDimensionProperty(block: CfnScalingPlanMetricDimensionPropertyDsl.() -> Unit
  ...
  public inline
      fun cfnScalingPlanPredefinedLoadMetricSpecificationProperty(block: CfnScalingPlanPredefinedLoadMetricSpecificationPropertyDsl.() -> Unit
  ...
  public inline
      fun cfnScalingPlanPredefinedScalingMetricSpecificationProperty(block: CfnScalingPlanPredefinedScalingMetricSpecificationPropertyDsl.() -> Unit
  ...
  public inline fun cfnScalingPlanProps(block: CfnScalingPlanPropsDsl.() -> Unit = {}):
      CfnScalingPlanProps {
  ...
  public inline
      fun cfnScalingPlanScalingInstructionProperty(block: CfnScalingPlanScalingInstructionPropertyDsl.() -> Unit
  ...
  public inline
      fun cfnScalingPlanTagFilterProperty(block: CfnScalingPlanTagFilterPropertyDsl.() -> Unit =
  ...
  public inline
      fun cfnScalingPlanTargetTrackingConfigurationProperty(block: CfnScalingPlanTargetTrackingConfigurationPropertyDsl.() -> Unit
