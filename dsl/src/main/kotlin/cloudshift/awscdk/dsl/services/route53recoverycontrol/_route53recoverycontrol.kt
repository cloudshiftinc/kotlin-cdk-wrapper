...
public object route53recoverycontrol {
  ...
  public inline
      fun cfnClusterClusterEndpointProperty(block: CfnClusterClusterEndpointPropertyDsl.() -> Unit =
  ...
  public inline fun cfnControlPanelProps(block: CfnControlPanelPropsDsl.() -> Unit = {}):
  ...
  public inline fun cfnRoutingControlProps(block: CfnRoutingControlPropsDsl.() -> Unit = {}):
  ...
  public inline
      fun cfnSafetyRuleAssertionRuleProperty(block: CfnSafetyRuleAssertionRulePropertyDsl.() -> Unit
  ...
  public inline
      fun cfnSafetyRuleGatingRuleProperty(block: CfnSafetyRuleGatingRulePropertyDsl.() -> Unit =
  ...
  public inline fun cfnSafetyRuleProps(block: CfnSafetyRulePropsDsl.() -> Unit = {}):
      CfnSafetyRuleProps {
  ...
  public inline
      fun cfnSafetyRuleRuleConfigProperty(block: CfnSafetyRuleRuleConfigPropertyDsl.() -> Unit =
