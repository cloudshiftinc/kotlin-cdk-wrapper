...
public class VirtualServiceProviderConfigDsl {
  ...
  public
      fun virtualNodeProvider(block: CfnVirtualServiceVirtualNodeServiceProviderPropertyDsl.() -> Unit
      = {}) {
  ...
  public
      fun virtualRouterProvider(block: CfnVirtualServiceVirtualRouterServiceProviderPropertyDsl.() -> Unit
      = {}) {
