...
public class VirtualServiceProviderConfigDsl {
    ...
    public fun virtualNodeProvider(
        virtualNodeProvider: CfnVirtualServiceVirtualNodeServiceProviderPropertyDsl.() -> Unit = {}
    ) {
    ...
    public fun virtualRouterProvider(
        virtualRouterProvider: CfnVirtualServiceVirtualRouterServiceProviderPropertyDsl.() -> Unit =
            {}
    ) {
