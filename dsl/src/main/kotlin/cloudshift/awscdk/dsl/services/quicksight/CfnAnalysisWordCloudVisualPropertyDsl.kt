 ...
 */
@CdkDslMarker
public class CfnAnalysisWordCloudVisualPropertyDsl {
    private val cdkBuilder: CfnAnalysis.WordCloudVisualProperty.Builder =
    ...
    public fun chartConfiguration(
        chartConfiguration: CfnAnalysis.WordCloudChartConfigurationProperty
    ) {
        cdkBuilder.chartConfiguration(chartConfiguration)
    }
    ...
    public fun build(): CfnAnalysis.WordCloudVisualProperty {
