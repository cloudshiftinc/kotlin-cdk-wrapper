...
public class CfnCertificateAuthorityOcspConfigurationPropertyDsl {
     ...
     *   being validated by the Online Certificate Status Protocol (OCSP). A customer can
     *   alternatively use this object to define a CNAME specifying a customized OCSP domain.
     *
