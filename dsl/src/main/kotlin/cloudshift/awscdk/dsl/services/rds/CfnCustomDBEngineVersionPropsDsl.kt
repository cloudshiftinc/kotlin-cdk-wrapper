...
public class CfnCustomDBEngineVersionPropsDsl {
     ...
     *   installation files for your CEV. For example, a valid bucket name is `123456789012/cev1` .
    ...
    /**
     * @param engine The database engine to use for your custom engine version (CEV). Valid values:
     * * `custom-oracle-ee`
    ...
    /**
     * @param engineVersion The name of your CEV. The name format is `major
     *   version.customized_string` . For example, a valid CEV name is `19.my_cev1` . This setting
     *   is required for RDS Custom for Oracle, but optional for Amazon RDS. The combination of
    ...
    /**
     * @param kmsKeyId The AWS KMS key identifier for an encrypted CEV. A symmetric encryption KMS
     *   key is required for RDS Custom, but optional for Amazon RDS.
     *
     * If you have an existing symmetric encryption KMS key in your account, you can use it with RDS
     * Custom. No further action is necessary. If you don't already have a symmetric encryption KMS
     * key in your account, follow the instructions in
