...
public inline fun CfnPipe.setSourceParameters(block: CfnPipePipeSourceParametersPropertyDsl.() -> Unit = {}) {
    val builder = CfnPipePipeSourceParametersPropertyDsl()
    builder.apply(block)
    return setSourceParameters(builder.build())
}

public inline fun CfnPipe.setTargetParameters(block: CfnPipePipeTargetParametersPropertyDsl.() -> Unit = {}) {
