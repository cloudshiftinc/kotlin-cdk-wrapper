...
public class CfnWebACLStatementPropertyDsl {
   ...
   */
  public
      fun ipSetReferenceStatement(ipSetReferenceStatement: CfnWebACL.IPSetReferenceStatementProperty) {
    cdkBuilder.ipSetReferenceStatement(ipSetReferenceStatement)
  }
   ...
   */
  public
      fun managedRuleGroupStatement(managedRuleGroupStatement: CfnWebACL.ManagedRuleGroupStatementProperty) {
    cdkBuilder.managedRuleGroupStatement(managedRuleGroupStatement)
  }
   ...
   */
  public
      fun regexPatternSetReferenceStatement(regexPatternSetReferenceStatement: CfnWebACL.RegexPatternSetReferenceStatementProperty) {
    cdkBuilder.regexPatternSetReferenceStatement(regexPatternSetReferenceStatement)
  }

  /**
   * @param ruleGroupReferenceStatement A rule statement used to run the rules that are defined in a
   * `RuleGroup` .
   ...
   * or `OrStatement` . You can only use a rule group reference statement at the top level inside a web
   * ACL.
   */
   ...
   */
  public
      fun ruleGroupReferenceStatement(ruleGroupReferenceStatement: CfnWebACL.RuleGroupReferenceStatementProperty) {
    cdkBuilder.ruleGroupReferenceStatement(ruleGroupReferenceStatement)
  }
   ...
   */
  public
      fun sizeConstraintStatement(sizeConstraintStatement: CfnWebACL.SizeConstraintStatementProperty) {
    cdkBuilder.sizeConstraintStatement(sizeConstraintStatement)
  }
