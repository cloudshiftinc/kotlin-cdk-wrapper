...
public class CfnAssetModelAttributePropertyDsl {
    ...
    /**
     * @param defaultValue The default value of the asset model property attribute. All assets that
     *   you create from the asset model contain this attribute value. You can update an attribute's
     *   value after you create an asset. For more information, see
