...
public class CfnDataSourceOneDriveConfigurationPropertyDsl {
     ...
     *   in your OneDrive. Documents that match the patterns are excluded from the index. Documents
     *   that don't match the patterns are included in the index. If a document matches both an
     ...
     *   fields, use the `UpdateIndex` API before you map to OneDrive fields. For more information,
     *   see
     ...
     *   in your OneDrive. Documents that match the patterns are included in the index. Documents
