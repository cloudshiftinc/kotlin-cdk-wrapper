...
public class CfnTopicRuleIotEventsActionPropertyDsl {
     ...
     *   `false` . When `batchMode` is `true` , you can't specify a `messageId` .
     *
    ...
    /**
     * @param messageId The ID of the message. The default `messageId` is a new UUID value. When
     *   `batchMode` is `true` , you can't specify a `messageId` --a new UUID value will be
     *   assigned.
     *
