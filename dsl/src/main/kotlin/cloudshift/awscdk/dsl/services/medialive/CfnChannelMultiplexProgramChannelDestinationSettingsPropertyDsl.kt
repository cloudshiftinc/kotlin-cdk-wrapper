...
public class CfnChannelMultiplexProgramChannelDestinationSettingsPropertyDsl {
    ...
    /**
     * @param multiplexId The ID of the Multiplex that the encoder is providing output to. You do
     *   not need to specify the individual inputs to the Multiplex; MediaLive will handle the
     *   connection of the two MediaLive pipelines to the two Multiplex instances. The Multiplex
