...
public class CfnJobPropsDsl {
     ...
     *   rows on which the profile job is run. If a `JobSample` value isn't provided, the default
     *   value is used. The default value is CUSTOM_ROWS for the mode parameter and 20,000 for the
     *   size parameter.
     */
    ...
    /**
     * @param profileConfiguration Configuration for profile jobs. Configuration can be used to
     *   select columns, do evaluations, and override default parameters of evaluations. When
     *   configuration is undefined, the profile job will apply default settings to all supported
     *   columns.
     */
    ...
    /**
     * @param timeout The job's timeout in minutes. A job that attempts to run longer than this
