...
public class CfnCacheClusterDsl(
     ...
     * instance is currently not supported. If you need to scale using Memcached, we recommend
     * forcing a replacement update by changing the `LogicalResourceId` of the resource.
     * * General purpose:
     * * Current generation:
     *
