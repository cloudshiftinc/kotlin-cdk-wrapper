...
public class EmrModifyInstanceGroupByNamePropsDsl {
     ...
     *   input. This uses the same syntax as the ModifyInstanceGroups API.
     */
    public fun instanceGroup(
        instanceGroup: EmrModifyInstanceGroupByNameInstanceGroupModifyConfigPropertyDsl.() -> Unit =
            {}
    ) {
     ...
     */
    public fun instanceGroup(
        instanceGroup: EmrModifyInstanceGroupByName.InstanceGroupModifyConfigProperty
    ) {
