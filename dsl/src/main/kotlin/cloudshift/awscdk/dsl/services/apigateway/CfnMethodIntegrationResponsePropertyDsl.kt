...
public class CfnMethodIntegrationResponsePropertyDsl {
   ...
   * method response from the back end.
   ...
   * Lambda function, the AWS Lambda function error header is matched. For all other HTTP and AWS back
  ...
  /**
   * @param statusCode Specifies the status code that is used to map the integration response to an
