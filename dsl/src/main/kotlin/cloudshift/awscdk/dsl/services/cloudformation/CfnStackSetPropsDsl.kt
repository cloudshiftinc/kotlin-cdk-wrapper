...
public class CfnStackSetPropsDsl {
  ...
  /**
   * @param administrationRoleArn The Amazon Resource Number (ARN) of the IAM role to use to create
   * this stack set.
   ...
   * administrator in the organization's management account or as a delegated administrator in a member
   * account.
  ...
  /**
   * @param operationPreferences The user-specified preferences for how AWS CloudFormation performs
   ...
   * deploy to accounts managed by AWS Organizations . For more information, see [Grant Service-Managed
   * Stack Set
  ...
  /**
   * @param stackInstancesGroup A group of stack instances with parameters in some specific accounts
   * and Regions.
   */
