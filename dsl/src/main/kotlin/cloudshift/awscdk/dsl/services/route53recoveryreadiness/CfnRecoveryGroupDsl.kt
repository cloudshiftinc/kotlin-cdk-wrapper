 ...
 * replicas of each other in terms of resources and functionality, so that you can fail over from
 * one to the other, for example, from one Region to another. You create recovery groups so you can
 * use readiness checks to audit resources in your application.
 *
