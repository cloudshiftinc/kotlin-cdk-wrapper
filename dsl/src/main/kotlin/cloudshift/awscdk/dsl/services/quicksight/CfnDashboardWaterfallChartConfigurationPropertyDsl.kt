...
public class CfnDashboardWaterfallChartConfigurationPropertyDsl {
   ...
   */
  public
      fun categoryAxisDisplayOptions(categoryAxisDisplayOptions: CfnDashboard.AxisDisplayOptionsProperty) {
    cdkBuilder.categoryAxisDisplayOptions(categoryAxisDisplayOptions)
  }
   ...
   */
  public
      fun categoryAxisLabelOptions(categoryAxisLabelOptions: CfnDashboard.ChartAxisLabelOptionsProperty) {
    cdkBuilder.categoryAxisLabelOptions(categoryAxisLabelOptions)
  }
   ...
   */
  public
      fun sortConfiguration(sortConfiguration: CfnDashboard.WaterfallChartSortConfigurationProperty) {
    cdkBuilder.sortConfiguration(sortConfiguration)
  }
   ...
   */
  public
      fun waterfallChartOptions(waterfallChartOptions: CfnDashboard.WaterfallChartOptionsProperty) {
    cdkBuilder.waterfallChartOptions(waterfallChartOptions)
  }
