...
public class CfnTaskDefinitionDockerVolumeConfigurationPropertyDsl {
    ...
    /**
     * @param driver The Docker volume driver to use. The driver value must match the driver name
     *   provided by Docker because it is used for task placement. If the driver was installed using
     *   the Docker plugin CLI, use `docker plugin ls` to retrieve the driver name from your
     *   container instance. If the driver was installed using another method, use Docker plugin
     *   discovery to retrieve the driver name. For more information, see
    ...
    /**
     * @param driverOpts A map of Docker driver-specific options passed through. This parameter maps
     *   to `DriverOpts` in the
     *   [Create a volume](https://docs.aws.amazon.com/https://docs.docker.com/engine/api/v1.35/#operation/VolumeCreate)
     *   section of the
     *   [Docker Remote API](https://docs.aws.amazon.com/https://docs.docker.com/engine/api/v1.35/)
    ...
    /**
     * @param labels Custom metadata to add to your Docker volume. This parameter maps to `Labels`
     *   in the
     *   [Create a volume](https://docs.aws.amazon.com/https://docs.docker.com/engine/api/v1.35/#operation/VolumeCreate)
     *   section of the
     *   [Docker Remote API](https://docs.aws.amazon.com/https://docs.docker.com/engine/api/v1.35/)
    ...
    /**
     * @param scope The scope for the Docker volume that determines its lifecycle. Docker volumes
     *   that are scoped to a `task` are automatically provisioned when the task starts and
     *   destroyed when the task stops. Docker volumes that are scoped as `shared` persist after the
     *   task stops.
     */
