...
public class CfnRecordSetGeoLocationPropertyDsl {
    ...
    /**
     * @param subdivisionCode For geolocation resource record sets, the two-letter code for a state
     *   of the United States. Route 53 doesn't support any other values for `SubdivisionCode` . For
     *   a list of state abbreviations, see
