...
public class CfnSchedulePlacementStrategyPropertyDsl {
   ...
   * amount of the resource that is specified with the field parameter. For example, if you binpack on
   * memory, a task is placed on the instance with the least amount of remaining memory (but still
