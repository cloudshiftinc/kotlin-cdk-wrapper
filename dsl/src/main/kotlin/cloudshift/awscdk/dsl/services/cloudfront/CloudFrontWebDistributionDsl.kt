...
public class CloudFrontWebDistributionDsl(
   ...
   */
  public
      fun errorConfigurations(errorConfigurations: CfnDistributionCustomErrorResponsePropertyDsl.() -> Unit) {
   ...
   */
  public
      fun errorConfigurations(errorConfigurations: Collection<CfnDistribution.CustomErrorResponseProperty>) {
   ...
   * your objects, whether you're using an alternate domain name with HTTPS, and if so, if you're using
   * AWS Certificate Manager (ACM) or a third-party certificate authority. 
   */
