...
public object greengrass {
    ...
    public inline fun cfnCoreDefinitionProps(block: CfnCoreDefinitionPropsDsl.() -> Unit = {}): CfnCoreDefinitionProps {
    ...
    public inline fun cfnDeviceDefinitionProps(block: CfnDeviceDefinitionPropsDsl.() -> Unit = {}): CfnDeviceDefinitionProps {
    ...
    public inline fun cfnGroupVersionProps(block: CfnGroupVersionPropsDsl.() -> Unit = {}): CfnGroupVersionProps {
    ...
    public inline fun cfnLoggerDefinitionProps(block: CfnLoggerDefinitionPropsDsl.() -> Unit = {}): CfnLoggerDefinitionProps {
    ...
    public inline fun cfnResourceDefinitionSageMakerMachineLearningModelResourceDataProperty(
        block: CfnResourceDefinitionSageMakerMachineLearningModelResourceDataPropertyDsl.() -> Unit =
            {},
    ...
    public inline fun cfnResourceDefinitionVersionS3MachineLearningModelResourceDataProperty(
        block: CfnResourceDefinitionVersionS3MachineLearningModelResourceDataPropertyDsl.() -> Unit =
            {},
    ...
    public inline fun cfnResourceDefinitionVersionSageMakerMachineLearningModelResourceDataProperty(
        block: CfnResourceDefinitionVersionSageMakerMachineLearningModelResourceDataPropertyDsl.() -> Unit =
            {},
    ...
    public inline fun cfnSubscriptionDefinitionProps(block: CfnSubscriptionDefinitionPropsDsl.() -> Unit = {}): CfnSubscriptionDefinitionProps {
