...
public class CfnResourcePolicyPropsDsl {
    ...
    /**
     * @param policy A resource policy to add to the resource. The policy is a JSON structure that
     *   contains one or more statements that define the policy. The policy must follow IAM syntax.
