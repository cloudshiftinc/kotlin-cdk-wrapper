...
public class BaseApplicationListenerRulePropsDsl {
    ...
    /**
     * @param action Action to perform when requests are received. Only one of `action`,
     *   `fixedResponse`, `redirectResponse` or `targetGroups` can be specified.
     */
    ...
    /**
     * @param priority Priority of the rule. The rule with the lowest priority will be used for
     *   every request.
     *
    ...
    /**
     * @param targetGroups Target groups to forward requests to. Only one of `action`,
     *   `fixedResponse`, `redirectResponse` or `targetGroups` can be specified.
     *
