...
public class ZoneAwarenessConfigDsl {
    ...
    /**
     * @param enabled Indicates whether to enable zone awareness for the Amazon ES domain. When you
     *   enable zone awareness, Amazon ES allocates the nodes and replica index shards that belong
     *   to a cluster across two Availability Zones (AZs) in the same region to prevent data loss
     *   and minimize downtime in the event of node or data center failure. Don't enable zone
