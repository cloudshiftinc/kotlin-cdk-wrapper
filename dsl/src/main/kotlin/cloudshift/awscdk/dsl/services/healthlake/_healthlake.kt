...
public object healthlake {
     ...
     *
     * Please note that when a user tries to do an Update operation via CloudFormation, changes to
     * the Data Store name, Type Version, PreloadDataConfig, or SSEConfiguration will delete their
     * existing Data Store for the stack and create a new one. This will lead to potential loss of
     * data.
     *
     * Example:
     * ```
     ...
     */
    public inline fun cfnFHIRDatastoreCreatedAtProperty(
        block: CfnFHIRDatastoreCreatedAtPropertyDsl.() -> Unit = {}
     ...
     */
    public inline fun cfnFHIRDatastoreIdentityProviderConfigurationProperty(
     ...
     */
    public inline fun cfnFHIRDatastoreKmsEncryptionConfigProperty(
        block: CfnFHIRDatastoreKmsEncryptionConfigPropertyDsl.() -> Unit = {}
     ...
     */
    public inline fun cfnFHIRDatastorePreloadDataConfigProperty(
     ...
     * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-healthlake-fhirdatastore.html)
     */
    public inline fun cfnFHIRDatastoreProps(
        block: CfnFHIRDatastorePropsDsl.() -> Unit = {}
     ...
     */
    public inline fun cfnFHIRDatastoreSseConfigurationProperty(
