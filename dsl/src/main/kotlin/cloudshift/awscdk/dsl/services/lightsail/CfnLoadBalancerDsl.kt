 ...
 * resource type. Instead, use the `AWS::Lightsail::LoadBalancerTlsCertificate` resource type to
 * create a certificate and attach it to a load balancer.
 *
 * Example:
 * ```
...
public class CfnLoadBalancerDsl(
     ...
     * specific instance. This ensures that all requests from the user during the session are sent
