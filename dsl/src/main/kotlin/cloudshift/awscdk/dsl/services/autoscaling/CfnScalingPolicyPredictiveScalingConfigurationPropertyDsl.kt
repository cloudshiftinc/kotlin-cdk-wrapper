...
public class CfnScalingPolicyPredictiveScalingConfigurationPropertyDsl {
   ...
   * capacity approaches or exceeds the maximum capacity of the Auto Scaling group.
   ...
   * limit is determined by the forecasted capacity and the value for `MaxCapacityBuffer` .
   */
   ...
   * close to or exceeds the maximum capacity.
   ...
   * instances by 5 minutes. In that case, the instances will be launched at 9:55 AM. The intention is
   * to give resources time to be provisioned. It can take a few minutes to launch an EC2 instance. The
