 ...
 * `config-multiaccountsetup.amazonaws.com` through the `EnableAWSServiceAccess` action and creates
 * a service linked role in the master account of your organization. The service linked role is
 * created only when the role does not exist in the master account.
 *
 * Example:
 * ```
