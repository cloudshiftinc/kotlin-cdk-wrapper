...
public class CfnChannelAudioSelectorSettingsPropertyDsl {
    ...
    public fun audioHlsRenditionSelection(audioHlsRenditionSelection: CfnChannel.AudioHlsRenditionSelectionProperty) {
        cdkBuilder.audioHlsRenditionSelection(audioHlsRenditionSelection)
    }
    ...
    public fun audioLanguageSelection(audioLanguageSelection: CfnChannel.AudioLanguageSelectionProperty) {
        cdkBuilder.audioLanguageSelection(audioLanguageSelection)
    }
