...
public class CfnCertificatePolicyInformationPropertyDsl {
     ...
     *   which the certificate was issued. For more information, see NIST's definition of
    ...
    /**
     * @param policyQualifiers Modifies the given `CertPolicyId` with a qualifier. AWS Private CA
