...
public class CfnAnalysisLineChartConfigurationPropertyDsl {
   ...
   */
  public
      fun defaultSeriesSettings(defaultSeriesSettings: CfnAnalysis.LineChartDefaultSeriesSettingsProperty) {
    cdkBuilder.defaultSeriesSettings(defaultSeriesSettings)
  }
   ...
   */
  public
      fun primaryYAxisDisplayOptions(primaryYAxisDisplayOptions: CfnAnalysis.LineSeriesAxisDisplayOptionsProperty) {
    cdkBuilder.primaryYAxisDisplayOptions(primaryYAxisDisplayOptions)
  }
   ...
   */
  public
      fun secondaryYAxisDisplayOptions(secondaryYAxisDisplayOptions: CfnAnalysis.LineSeriesAxisDisplayOptionsProperty) {
    cdkBuilder.secondaryYAxisDisplayOptions(secondaryYAxisDisplayOptions)
  }
   ...
   */
  public
      fun secondaryYAxisLabelOptions(secondaryYAxisLabelOptions: CfnAnalysis.ChartAxisLabelOptionsProperty) {
    cdkBuilder.secondaryYAxisLabelOptions(secondaryYAxisLabelOptions)
  }
   ...
   */
  public
      fun smallMultiplesOptions(smallMultiplesOptions: CfnAnalysis.SmallMultiplesOptionsProperty) {
    cdkBuilder.smallMultiplesOptions(smallMultiplesOptions)
  }
