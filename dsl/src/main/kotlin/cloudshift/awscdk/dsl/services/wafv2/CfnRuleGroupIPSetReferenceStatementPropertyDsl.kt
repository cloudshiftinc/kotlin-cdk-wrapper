...
public class CfnRuleGroupIPSetReferenceStatementPropertyDsl {
     ...
     *   origin. Commonly, this is the X-Forwarded-For (XFF) header, but you can specify any header
     *   name.
     *
    ...
    public fun ipSetForwardedIpConfig(
        ipSetForwardedIpConfig: CfnRuleGroup.IPSetForwardedIPConfigurationProperty
    ) {
        cdkBuilder.ipSetForwardedIpConfig(ipSetForwardedIpConfig)
    }
