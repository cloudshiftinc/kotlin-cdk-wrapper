...
public class CfnEC2FleetPropsDsl {
     ...
     *   Instances. Supported only for fleets of type `maintain` . For more information, see
     ...
     *   *MM* - *DD* T *HH* : *MM* : *SS* Z). At this point, no new EC2 Fleet requests are placed or
     *   able to fulfill the request. If no value is specified, the request remains until you cancel
     *   it.
     */
