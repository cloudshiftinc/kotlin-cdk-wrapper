...
public class CfnOriginEndpointCmafEncryptionPropertyDsl {
     ...
     *   32-character string, used in conjunction with the key for encrypting blocks. If you don't
     *   specify a value, then AWS Elemental MediaPackage creates the constant initialization vector
     *   (IV).
     */
