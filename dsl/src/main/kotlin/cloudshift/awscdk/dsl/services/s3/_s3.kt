...
public object s3 {
    public inline fun blockPublicAccess(block: BlockPublicAccessDsl.() -> Unit = {}): BlockPublicAccess {
        val builder = BlockPublicAccessDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun blockPublicAccessOptions(block: BlockPublicAccessOptionsDsl.() -> Unit = {}): BlockPublicAccessOptions {
    ...
    public inline fun bucketPolicyProps(block: BucketPolicyPropsDsl.() -> Unit = {}): BucketPolicyProps {
    ...
    public inline fun cfnBucketCorsRuleProperty(block: CfnBucketCorsRulePropertyDsl.() -> Unit = {}): CfnBucket.CorsRuleProperty {
    ...
    public inline fun cfnBucketMetricsProperty(block: CfnBucketMetricsPropertyDsl.() -> Unit = {}): CfnBucket.MetricsProperty {
    ...
    public inline fun cfnBucketPolicyProps(block: CfnBucketPolicyPropsDsl.() -> Unit = {}): CfnBucketPolicyProps {
    ...
    public inline fun cfnBucketRuleProperty(block: CfnBucketRulePropertyDsl.() -> Unit = {}): CfnBucket.RuleProperty {
    ...
    public inline fun cfnBucketTieringProperty(block: CfnBucketTieringPropertyDsl.() -> Unit = {}): CfnBucket.TieringProperty {
    ...
    public inline fun cfnMultiRegionAccessPointProps(block: CfnMultiRegionAccessPointPropsDsl.() -> Unit = {}): CfnMultiRegionAccessPointProps {
    ...
    public inline fun cfnStorageLensProps(block: CfnStorageLensPropsDsl.() -> Unit = {}): CfnStorageLensProps {
    ...
    public inline fun inventoryDestination(block: InventoryDestinationDsl.() -> Unit = {}): InventoryDestination {
    ...
    public inline fun notificationKeyFilter(block: NotificationKeyFilterDsl.() -> Unit = {}): NotificationKeyFilter {
        val builder = NotificationKeyFilterDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun onCloudTrailBucketEventOptions(block: OnCloudTrailBucketEventOptionsDsl.() -> Unit = {}): OnCloudTrailBucketEventOptions {
    ...
    public inline fun routingRuleCondition(block: RoutingRuleConditionDsl.() -> Unit = {}): RoutingRuleCondition {
    ...
    public inline fun transferAccelerationUrlOptions(block: TransferAccelerationUrlOptionsDsl.() -> Unit = {}): TransferAccelerationUrlOptions {
