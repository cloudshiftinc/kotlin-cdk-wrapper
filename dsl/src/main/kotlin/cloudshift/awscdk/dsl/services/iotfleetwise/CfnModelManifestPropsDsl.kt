...
public class CfnModelManifestPropsDsl {
    ...
    /**
     * @param status (Optional) The state of the vehicle model. If the status is `ACTIVE` , the
     *   vehicle model can't be edited. If the status is `DRAFT` , you can edit the vehicle model.
     */
