...
public class CfnTrailPropsDsl {
    ...
    /**
     * @param advancedEventSelectors Specifies the settings for advanced event selectors. You can
     ...
     *   write to a user's log group. You must use a role that exists in your account.
     */
     ...
     *   settings for your trail. By default, trails created without specific event selectors will
     *   be configured to log all read and write management events, and no data events. When an
     *   event occurs in your account, CloudTrail evaluates the event selector for all trails. For
     *   each trail, if the event matches any event selector, the trail processes and logs the
     *   event. If the event doesn't match any event selector, the trail doesn't log the event.
     *
