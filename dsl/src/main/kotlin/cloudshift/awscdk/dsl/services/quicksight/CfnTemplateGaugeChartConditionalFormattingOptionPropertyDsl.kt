...
public class CfnTemplateGaugeChartConditionalFormattingOptionPropertyDsl {
    ...
    public fun primaryValue(
        primaryValue: CfnTemplate.GaugeChartPrimaryValueConditionalFormattingProperty
    ) {
        cdkBuilder.primaryValue(primaryValue)
    }

    public fun build(): CfnTemplate.GaugeChartConditionalFormattingOptionProperty =
        cdkBuilder.build()
}
