...
public class CfnBucketNotificationConfigurationPropertyDsl {
    ...
    public fun eventBridgeConfiguration(
        eventBridgeConfiguration: CfnBucket.EventBridgeConfigurationProperty
    ) {
        cdkBuilder.eventBridgeConfiguration(eventBridgeConfiguration)
    }
    ...
    public fun build(): CfnBucket.NotificationConfigurationProperty {
        if (_lambdaConfigurations.isNotEmpty())
            cdkBuilder.lambdaConfigurations(_lambdaConfigurations)
