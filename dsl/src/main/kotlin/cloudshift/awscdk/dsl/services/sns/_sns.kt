...
public object sns {
    ...
    public inline fun cfnSubscriptionProps(block: CfnSubscriptionPropsDsl.() -> Unit = {}): CfnSubscriptionProps {
    ...
    public inline fun cfnTopicPolicyProps(block: CfnTopicPolicyPropsDsl.() -> Unit = {}): CfnTopicPolicyProps {
    ...
    public inline fun numericConditions(block: NumericConditionsDsl.() -> Unit = {}): NumericConditions {
    ...
    public inline fun subscriptionOptions(block: SubscriptionOptionsDsl.() -> Unit = {}): SubscriptionOptions {
    ...
    public inline fun topicSubscriptionConfig(block: TopicSubscriptionConfigDsl.() -> Unit = {}): TopicSubscriptionConfig {
