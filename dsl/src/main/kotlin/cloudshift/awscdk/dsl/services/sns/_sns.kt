...
public object sns {
     ...
     * ```
     */
    public inline fun betweenCondition(
        block: BetweenConditionDsl.() -> Unit = {}
    ): BetweenCondition {
     ...
     * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-sns-subscription.html)
     */
    public inline fun cfnSubscriptionProps(
        block: CfnSubscriptionPropsDsl.() -> Unit = {}
     ...
     * information, see
     * [Amazon SNS endpoints and quotas](https://docs.aws.amazon.com/general/latest/gr/sns.html) in
     ...
     * [Declaring an Amazon SNS policy](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/quickref-iam.html#scenario-sns-policy)
     ...
     * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-sns-topicpolicy.html)
     */
    public inline fun cfnTopicPolicyProps(
        block: CfnTopicPolicyPropsDsl.() -> Unit = {}
    ): CfnTopicPolicyProps {
     ...
     */
    public inline fun cfnTopicSubscriptionProperty(
        block: CfnTopicSubscriptionPropertyDsl.() -> Unit = {}
     ...
     * ```
     */
    public inline fun numericConditions(
     ...
     * ```
     */
    public inline fun stringConditions(
     ...
     * ```
     */
    public inline fun subscriptionOptions(
        block: SubscriptionOptionsDsl.() -> Unit = {}
    ): SubscriptionOptions {
    ...
    public inline fun topicPolicyProps(
        block: TopicPolicyPropsDsl.() -> Unit = {}
    ): TopicPolicyProps {
     ...
     * ```
     */
    public inline fun topicSubscriptionConfig(
        block: TopicSubscriptionConfigDsl.() -> Unit = {}
