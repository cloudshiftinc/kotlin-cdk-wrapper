...
public class CfnFileSystemWindowsConfigurationPropertyDsl {
  ...
  /**
   * @param auditLogConfiguration The configuration that Amazon FSx for Windows File Server uses to
   * audit and log user accesses of files, folders, and file shares on the Amazon FSx for Windows File
   * Server file system.
   */
   ...
   * Multi-AZ file system in AWS Regions that have a minimum of three Availability Zones. Also supports
   * HDD storage type
   ...
   * AWS applications, we recommend that you launch your clients in the same availability zone as your
   * preferred file server to reduce cross-availability zone data transfer costs and minimize latency.
   */
  ...
  /**
   * @param selfManagedActiveDirectoryConfiguration The configuration that Amazon FSx uses to join a
   * FSx for Windows File Server file system or an FSx for ONTAP storage virtual machine (SVM) to a
   ...
   * in megabytes per second (MB/s), in 2 to the *n* th increments, between 2^3 (8) and 2^11 (2048). 
   *
