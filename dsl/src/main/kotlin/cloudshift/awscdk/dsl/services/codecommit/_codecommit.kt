...
public object codecommit {
    ...
    public inline fun cfnRepositoryCodeProperty(block: CfnRepositoryCodePropertyDsl.() -> Unit = {}): CfnRepository.CodeProperty {
    ...
    public inline fun cfnRepositoryRepositoryTriggerProperty(
        block: CfnRepositoryRepositoryTriggerPropertyDsl.() -> Unit =
            {},
    ...
    public inline fun cfnRepositoryS3Property(block: CfnRepositoryS3PropertyDsl.() -> Unit = {}): CfnRepository.S3Property {
    ...
    public inline fun repositoryNotifyOnOptions(block: RepositoryNotifyOnOptionsDsl.() -> Unit = {}): RepositoryNotifyOnOptions {
    ...
    public inline fun repositoryTriggerOptions(block: RepositoryTriggerOptionsDsl.() -> Unit = {}): RepositoryTriggerOptions {
