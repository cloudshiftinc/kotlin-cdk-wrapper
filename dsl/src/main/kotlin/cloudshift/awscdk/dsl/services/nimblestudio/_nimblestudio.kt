...
public object nimblestudio {
    ...
    public inline fun cfnLaunchProfileProps(block: CfnLaunchProfilePropsDsl.() -> Unit = {}): CfnLaunchProfileProps {
    ...
    public inline fun cfnStreamingImageProps(block: CfnStreamingImagePropsDsl.() -> Unit = {}): CfnStreamingImageProps {
    ...
    public inline fun cfnStudioComponentProps(block: CfnStudioComponentPropsDsl.() -> Unit = {}): CfnStudioComponentProps {
