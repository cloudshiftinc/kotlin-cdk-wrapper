...
public class CfnAutoScalingGroupInstanceRequirementsPropertyDsl {
  ...
  /**
   * @param acceleratorTotalMemoryMiB The minimum and maximum total memory size for the accelerators
   * on an instance type, in MiB.
   * Default: No minimum or maximum limits
   */
   ...
   *
   *
   * Don't confuse the CPU hardware manufacturer with the CPU hardware architecture. Instances will
  ...
  /**
   * @param memoryGiBPerVCpu The minimum and maximum amount of memory per vCPU for an instance type,
   * in GiB.
   * Default: No minimum or maximum limits
   */
   ...
   * Instances.
   * This is the maximum you’ll pay for an On-Demand Instance, expressed as a percentage higher than
   * the least expensive current generation M, C, or R instance type with your specified attributes.
   * When Amazon EC2 Auto Scaling selects instance types with your attributes, we will exclude instance
   * types whose price is higher than your threshold. The parameter accepts an integer, which Amazon
   * EC2 Auto Scaling interprets as a percentage. To turn off price protection, specify a high value,
   * such as `999999` .
   *
  ...
  /**
   * @param requireHibernateSupport Indicates whether instance types must provide On-Demand Instance
   * hibernation support.
   * Default: `false`
   */
   ...
   * This is the maximum you’ll pay for a Spot Instance, expressed as a percentage higher than the
   * least expensive current generation M, C, or R instance type with your specified attributes. When
   * Amazon EC2 Auto Scaling selects instance types with your attributes, we will exclude instance
   * types whose price is higher than your threshold. The parameter accepts an integer, which Amazon
   * EC2 Auto Scaling interprets as a percentage. To turn off price protection, specify a high value,
   * such as `999999` .
   *
