...
public class CfnAutoScalingGroupInstanceRequirementsPropertyDsl {
    ...
    public fun acceleratorCount(acceleratorCount: CfnAutoScalingGroup.AcceleratorCountRequestProperty) {
        cdkBuilder.acceleratorCount(acceleratorCount)
    }
    ...
    public fun acceleratorTotalMemoryMiB(acceleratorTotalMemoryMiB: CfnAutoScalingGroup.AcceleratorTotalMemoryMiBRequestProperty) {
        cdkBuilder.acceleratorTotalMemoryMiB(acceleratorTotalMemoryMiB)
    }
    ...
    public fun baselineEbsBandwidthMbps(baselineEbsBandwidthMbps: CfnAutoScalingGroup.BaselineEbsBandwidthMbpsRequestProperty) {
        cdkBuilder.baselineEbsBandwidthMbps(baselineEbsBandwidthMbps)
    }
    ...
    public fun memoryGiBPerVCpu(memoryGiBPerVCpu: CfnAutoScalingGroup.MemoryGiBPerVCpuRequestProperty) {
        cdkBuilder.memoryGiBPerVCpu(memoryGiBPerVCpu)
    }
    ...
    public fun networkBandwidthGbps(networkBandwidthGbps: CfnAutoScalingGroup.NetworkBandwidthGbpsRequestProperty) {
        cdkBuilder.networkBandwidthGbps(networkBandwidthGbps)
    }
    ...
    public fun networkInterfaceCount(networkInterfaceCount: CfnAutoScalingGroup.NetworkInterfaceCountRequestProperty) {
        cdkBuilder.networkInterfaceCount(networkInterfaceCount)
    }
    ...
    public fun totalLocalStorageGb(totalLocalStorageGb: CfnAutoScalingGroup.TotalLocalStorageGBRequestProperty) {
        cdkBuilder.totalLocalStorageGb(totalLocalStorageGb)
    }
