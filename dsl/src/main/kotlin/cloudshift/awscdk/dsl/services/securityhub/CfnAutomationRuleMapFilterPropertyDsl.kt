...
public class CfnAutomationRuleMapFilterPropertyDsl {
     ...
     *   findings with a map filter. To search for values that have the filter value, use one of the
     ...
     * it matches any one of those filters. For example, the filters `Department CONTAINS Security
     * OR Department CONTAINS Finance` match a finding that includes either `Security` , `Finance` ,
     * or both values.
     *
     ...
     *   provide `security` as the filter value, then there's no match.
     */
