 ...
 * @param props
 */
public inline fun IVpnConnection.metric(
    arg0: String,
 ...
 * @param props
 */
public inline fun IVpnConnection.metricTunnelDataIn(
    block: MetricOptionsDsl.() -> Unit = {}
): Metric {
    val builder = MetricOptionsDsl()
    builder.apply(block)
 ...
 * @param props
 */
public inline fun IVpnConnection.metricTunnelDataOut(
    block: MetricOptionsDsl.() -> Unit = {}
): Metric {
    val builder = MetricOptionsDsl()
    builder.apply(block)
 ...
 * @param props
 */
public inline fun IVpnConnection.metricTunnelState(
    block: MetricOptionsDsl.() -> Unit = {}
): Metric {
    val builder = MetricOptionsDsl()
    builder.apply(block)
 ...
 */
public inline fun UserData.addS3DownloadCommand(
 ...
 * @param options
 */
public inline fun Vpc.addVpnConnection(
    id: String,
 ...
 * * Renders the `AWS::CloudFormation::Init` object to the given resource's metadata, potentially
 *   adding a `AWS::CloudFormation::Authentication` object next to it if required.
 * * Updates the instance role policy to be able to call the APIs required for `cfn-init` and
 *   `cfn-signal` to work, and potentially add permissions to download referenced asset and bucket
 *   resources.
 ...
 *
 * `remoteRule` controls where the Rule object is created if the peer is also a securityGroup and
 * they are in different stack. If false (default) the rule object is created under the current
 * SecurityGroup object. If true and the peer is also a SecurityGroup, the rule object is created
 * under the remote SecurityGroup object.
 *
 * @param peer
 * @param connection
 * @param description
 ...
 * @param props
 */
public inline fun VpnConnectionBase.metricTunnelDataIn(
    block: MetricOptionsDsl.() -> Unit = {}
): Metric {
    val builder = MetricOptionsDsl()
    builder.apply(block)
 ...
 * @param props
 */
public inline fun VpnConnectionBase.metricTunnelDataOut(
    block: MetricOptionsDsl.() -> Unit = {}
): Metric {
    val builder = MetricOptionsDsl()
    builder.apply(block)
 ...
 * @param props
 */
public inline fun VpnConnectionBase.metricTunnelState(
    block: MetricOptionsDsl.() -> Unit = {}
): Metric {
    val builder = MetricOptionsDsl()
    builder.apply(block)
...
public inline fun CfnInstance.setEnclaveOptions(
 ...
 * @param input
 */
public inline fun IIpAddresses.allocateSubnetsCidr(
