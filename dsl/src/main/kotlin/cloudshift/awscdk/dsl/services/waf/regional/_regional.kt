...
public object regional {
     ...
     *
     * The `AWS::WAFRegional::ByteMatchSet` resource creates an AWS WAF `ByteMatchSet` that
     * identifies a part of a web request that you want to inspect.
     *
     * Example:
     * ```
     ...
     * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-wafregional-geomatchset.html)
     */
    public inline fun cfnGeoMatchSetProps(
        block: CfnGeoMatchSetPropsDsl.() -> Unit = {}
    ): CfnGeoMatchSetProps {
     ...
     * rate-based rules created through AWS CloudFormation to a web ACL, use the AWS WAF console,
     ...
     * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-wafregional-ratebasedrule.html)
     */
    public inline fun cfnRateBasedRuleProps(
        block: CfnRateBasedRulePropsDsl.() -> Unit = {}
    ...
    /**
     * The `RegexPatternSet` specifies the regular expression (regex) pattern that you want AWS WAF
     ...
     * or block requests from specified referrers. If you add more than one `Rule` to a `WebACL` , a
     * request needs to match only one of the specifications to be allowed, blocked, or counted.
     *
     ...
     */
    public inline fun cfnWebACLActionProperty(
        block: CfnWebACLActionPropertyDsl.() -> Unit = {}
