...
public class CfnUserProfilePropsDsl {
     ...
     *   UserProfile. If the Domain's AuthMode is IAM Identity Center , this field is required, and
     *   must match a valid username of a user in your directory. If the Domain's AuthMode is not
     *   IAM Identity Center , this field cannot be specified.
     */
    ...
    /**
     * @param tags An array of key-value pairs to apply to this resource. Tags that you specify for
     *   the User Profile are also added to all apps that the User Profile launches.
     *
