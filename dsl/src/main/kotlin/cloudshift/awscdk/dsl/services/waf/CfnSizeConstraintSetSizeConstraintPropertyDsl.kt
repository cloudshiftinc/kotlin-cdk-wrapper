...
public class CfnSizeConstraintSetSizeConstraintPropertyDsl {
   ...
   * expression in the form of " `Size` `ComparisonOperator` size in bytes of `FieldToMatch` ". If that
   ...
   *
   * If you specify `URI` for the value of `Type` , the / in the URI path that you specify counts as
   ...
   * `TextTransformation` because Amazon CloudFront forwards only the first 8192 bytes for inspection.
   *
   * *NONE*
   *
