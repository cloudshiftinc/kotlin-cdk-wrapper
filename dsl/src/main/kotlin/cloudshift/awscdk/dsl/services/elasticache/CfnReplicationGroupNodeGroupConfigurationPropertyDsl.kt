...
public class CfnReplicationGroupNodeGroupConfigurationPropertyDsl {
  ...
  /**
   * @param primaryAvailabilityZone The Availability Zone where the primary node of this node group
   * (shard) is launched.
   */
   ...
   * should remove the value specified for the `Slots` property of each `NodeGroupConfiguration` from
   * the stack template, as it no longer reflects the actual values in each node group. For more
   * information, see [UseOnlineResharding
