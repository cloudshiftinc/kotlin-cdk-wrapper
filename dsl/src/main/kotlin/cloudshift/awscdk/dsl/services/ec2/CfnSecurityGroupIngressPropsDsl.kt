...
public class CfnSecurityGroupIngressPropsDsl {
     ...
     *   number. A value of `-1` indicates all ICMP/ICMPv6 types. If you specify all ICMP/ICMPv6
    ...
    /**
     * @param toPort The end of port range for the TCP and UDP protocols, or an ICMP/ICMPv6 code. A
     *   value of `-1` indicates all ICMP/ICMPv6 codes for the specified ICMP type. If you specify
