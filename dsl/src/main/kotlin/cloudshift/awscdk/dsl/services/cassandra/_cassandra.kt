...
public object cassandra {
  ...
  public inline
      fun cfnKeyspaceReplicationSpecificationProperty(block: CfnKeyspaceReplicationSpecificationPropertyDsl.() -> Unit
  ...
  public inline fun cfnTableBillingModeProperty(block: CfnTableBillingModePropertyDsl.() -> Unit =
  ...
  public inline
      fun cfnTableClusteringKeyColumnProperty(block: CfnTableClusteringKeyColumnPropertyDsl.() -> Unit
  ...
  public inline
      fun cfnTableEncryptionSpecificationProperty(block: CfnTableEncryptionSpecificationPropertyDsl.() -> Unit
