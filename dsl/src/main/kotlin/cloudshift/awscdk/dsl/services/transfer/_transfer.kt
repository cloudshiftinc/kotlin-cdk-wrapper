...
public object transfer {
    ...
    public inline fun cfnAgreementProps(block: CfnAgreementPropsDsl.() -> Unit = {}): CfnAgreementProps {
    ...
    public inline fun cfnServerProtocolProperty(block: CfnServerProtocolPropertyDsl.() -> Unit = {}): CfnServer.ProtocolProperty {
    ...
    public inline fun cfnWorkflowS3TagProperty(block: CfnWorkflowS3TagPropertyDsl.() -> Unit = {}): CfnWorkflow.S3TagProperty {
