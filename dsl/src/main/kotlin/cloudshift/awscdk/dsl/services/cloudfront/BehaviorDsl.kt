...
public class BehaviorDsl {
    ...
    public fun lambdaFunctionAssociations(lambdaFunctionAssociations: LambdaFunctionAssociationDsl.() -> Unit) {
        _lambdaFunctionAssociations.add(LambdaFunctionAssociationDsl().apply(lambdaFunctionAssociations).build())
    }

    public fun lambdaFunctionAssociations(lambdaFunctionAssociations: Collection<LambdaFunctionAssociation>) {
