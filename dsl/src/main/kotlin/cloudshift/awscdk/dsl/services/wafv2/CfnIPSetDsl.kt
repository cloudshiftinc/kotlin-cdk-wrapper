 ...
 * addresses. For example, if you're receiving a lot of requests from a ranges of IP addresses, you
 * can configure AWS WAF to block them using an IP set that lists those IP addresses.
 *
