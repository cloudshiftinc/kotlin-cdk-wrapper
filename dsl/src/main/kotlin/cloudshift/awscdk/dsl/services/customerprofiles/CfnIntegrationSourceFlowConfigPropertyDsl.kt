...
public class CfnIntegrationSourceFlowConfigPropertyDsl {
    ...
    public fun incrementalPullConfig(incrementalPullConfig: CfnIntegration.IncrementalPullConfigProperty) {
        cdkBuilder.incrementalPullConfig(incrementalPullConfig)
    }
    ...
    public fun sourceConnectorProperties(sourceConnectorProperties: CfnIntegration.SourceConnectorPropertiesProperty) {
        cdkBuilder.sourceConnectorProperties(sourceConnectorProperties)
    }
