...
public object config {
    ...
    public inline fun accessKeysRotatedProps(block: AccessKeysRotatedPropsDsl.() -> Unit = {}): AccessKeysRotatedProps {
    ...
    public inline fun cfnConfigRuleProps(block: CfnConfigRulePropsDsl.() -> Unit = {}): CfnConfigRuleProps {
    ...
    public inline fun cfnConformancePackProps(block: CfnConformancePackPropsDsl.() -> Unit = {}): CfnConformancePackProps {
    ...
    public inline fun cfnDeliveryChannelProps(block: CfnDeliveryChannelPropsDsl.() -> Unit = {}): CfnDeliveryChannelProps {
    ...
    public inline fun cfnOrganizationConfigRuleProps(block: CfnOrganizationConfigRulePropsDsl.() -> Unit = {}): CfnOrganizationConfigRuleProps {
    ...
    public inline fun cfnStoredQueryProps(block: CfnStoredQueryPropsDsl.() -> Unit = {}): CfnStoredQueryProps {
    ...
    public inline fun customPolicyProps(block: CustomPolicyPropsDsl.() -> Unit = {}): CustomPolicyProps {
