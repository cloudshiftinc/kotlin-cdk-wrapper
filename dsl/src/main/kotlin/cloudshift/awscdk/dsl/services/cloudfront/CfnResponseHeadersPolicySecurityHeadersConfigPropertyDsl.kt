...
public class CfnResponseHeadersPolicySecurityHeadersConfigPropertyDsl {
    ...
    public fun contentSecurityPolicy(contentSecurityPolicy: CfnResponseHeadersPolicy.ContentSecurityPolicyProperty) {
        cdkBuilder.contentSecurityPolicy(contentSecurityPolicy)
    }
    ...
    public fun contentTypeOptions(contentTypeOptions: CfnResponseHeadersPolicy.ContentTypeOptionsProperty) {
        cdkBuilder.contentTypeOptions(contentTypeOptions)
    }
    ...
    public fun strictTransportSecurity(strictTransportSecurity: CfnResponseHeadersPolicy.StrictTransportSecurityProperty) {
        cdkBuilder.strictTransportSecurity(strictTransportSecurity)
    }
