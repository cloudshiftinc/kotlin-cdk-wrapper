...
public class CfnNotificationRulePropsDsl {
    ...
    /**
     * @param name The name for the notification rule. Notification rule names must be unique in
     *   your AWS account .
     */
    ...
    /**
     * @param status The status of the notification rule. The default value is `ENABLED` . If the
    ...
    /**
     * @param tags A list of tags to apply to this notification rule. Key names cannot start with "
     *   `aws` ".
     */
