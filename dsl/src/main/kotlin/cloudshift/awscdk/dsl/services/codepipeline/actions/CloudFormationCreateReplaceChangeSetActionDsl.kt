 ...
 */
@CdkDslMarker
public class CloudFormationCreateReplaceChangeSetActionDsl {
  private val cdkBuilder: CloudFormationCreateReplaceChangeSetAction.Builder =
      CloudFormationCreateReplaceChangeSetAction.Builder.create()
  ...
  public fun build(): CloudFormationCreateReplaceChangeSetAction {
