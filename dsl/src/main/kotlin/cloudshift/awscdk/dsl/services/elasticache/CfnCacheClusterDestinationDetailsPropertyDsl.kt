...
public class CfnCacheClusterDestinationDetailsPropertyDsl {
   ...
   */
  public
      fun cloudWatchLogsDetails(cloudWatchLogsDetails: CfnCacheCluster.CloudWatchLogsDestinationDetailsProperty) {
    cdkBuilder.cloudWatchLogsDetails(cloudWatchLogsDetails)
  }
   ...
   */
  public
      fun kinesisFirehoseDetails(kinesisFirehoseDetails: CfnCacheCluster.KinesisFirehoseDestinationDetailsProperty) {
    cdkBuilder.kinesisFirehoseDetails(kinesisFirehoseDetails)
  }
