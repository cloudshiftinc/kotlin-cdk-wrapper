...
public class CfnPipePipeTargetBatchJobParametersPropertyDsl {
    ...
    /**
     * @param jobDefinition The job definition used by this job. This value can be one of `name` ,
    ...
    /**
     * @param jobName The name of the job. It can be up to 128 letters long. The first character
     ...
     *   value pair mapping. Parameters included here override any corresponding parameter defaults
    ...
    /**
     * @param retryStrategy The retry strategy to use for failed jobs. When a retry strategy is
