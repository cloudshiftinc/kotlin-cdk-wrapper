...
public class CfnTableTableInputPropertyDsl {
  ...
  /**
   * @param partitionKeys A list of columns by which the table is partitioned. Only primitive types
  ...
  /**
   * @param storageDescriptor A storage descriptor containing information about the physical storage
   * of this table.
   */
   ...
   * AWS Glue will create tables with the `EXTERNAL_TABLE` type. Other services, such as Athena, may
