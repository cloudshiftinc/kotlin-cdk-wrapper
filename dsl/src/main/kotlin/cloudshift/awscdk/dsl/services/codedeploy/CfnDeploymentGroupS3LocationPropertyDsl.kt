...
public class CfnDeploymentGroupS3LocationPropertyDsl {
     ...
     *   application revision. If the ETag is not specified as an input parameter, ETag validation
     ...
     *   artifacts for the application revision. If the version is not specified, the system uses
