...
public class CfnResourcePolicyPropsDsl {
     ...
     *   resource policy content as a JSON object or a JSON string.
     *
    ...
    /**
     * @param tags A list of tags that you want to attach to the newly created resource policy. For
     *   each tag in the list, you must specify both a tag key and a value. You can set the value to
     *   an empty string, but you can't set it to `null` . For more information about tagging, see
