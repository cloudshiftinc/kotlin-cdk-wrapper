...
public class LambdaRestApiPropsDsl {
    ...
    /**
     * @param handler The default Lambda function that handles all requests from this API. This
     *   handler will be used as a the default integration for all methods in this API, unless
    ...
    public fun integrationOptions(integrationOptions: LambdaIntegrationOptionsDsl.() -> Unit = {}) {
        val builder = LambdaIntegrationOptionsDsl()
        builder.apply(integrationOptions)
    ...
    /**
     * @param proxy If true, route all requests to the Lambda Function. If set to false, you will
     *   need to explicitly define the API model using `addResource` and `addMethod` (or
     *   `addProxy`).
     */
    ...
    public fun build(): LambdaRestApiProps {
