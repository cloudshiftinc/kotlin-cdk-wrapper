...
public class ClientVpnEndpointPropsDsl {
    ...
    /**
     * @param clientCertificateArn The ARN of the client certificate for mutual authentication. The
     *   certificate must be signed by a certificate authority (CA) and it must be provisioned in
    ...
    /**
     * @param clientConnectionHandler The AWS Lambda function used for connection authorization. The
     *   name of the Lambda function must begin with the `AWSClientVPN-` prefix
     */
    ...
    public fun build(): ClientVpnEndpointProps {
