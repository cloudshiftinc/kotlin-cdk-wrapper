...
public class CfnClusterPropsDsl {
    ...
    /**
     * @param dataTiering Enables data tiering. Data tiering is only supported for replication
     *   groups using the r6gd node type. This parameter must be set to true when using r6gd nodes.
    ...
    /**
     * @param finalSnapshotName The user-supplied name of a final cluster snapshot. This is the
    ...
    /**
     * @param numReplicasPerShard The number of replicas to apply to each shard. *Default value* :
     *   `1`
     *
     * *Maximum value* : `5`
     */
     ...
     *   snapshot files stored in Amazon S3. The snapshot files are used to populate the new cluster
