...
public class LoadBalancerListenerDsl {
     ...
     *   empty list to deny connections, or supply a custom list of peers to allow connections from
    ...
    /**
     * @param externalProtocol What public protocol to use for load balancing. Either 'tcp', 'ssl',
     *   'http' or 'https'.
     *
    ...
    /**
     * @param internalProtocol What public protocol to use for load balancing. Either 'tcp', 'ssl',
     *   'http' or 'https'.
     *
    ...
    public fun build(): LoadBalancerListener {
        if (_allowConnectionsFrom.isNotEmpty())
            cdkBuilder.allowConnectionsFrom(_allowConnectionsFrom)
