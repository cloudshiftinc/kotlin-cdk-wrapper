 ...
 */
@CdkDslMarker
public class CfnAnalysisSheetDefinitionPropertyDsl {
    private val cdkBuilder: CfnAnalysis.SheetDefinitionProperty.Builder =
    ...
    /**
     * @param filterControls The list of filter controls that are on a sheet. For more information,
     *   see
    ...
    /**
     * @param layouts Layouts define how the components of a sheet are arranged. For more
     *   information, see
    ...
    /**
     * @param name The name of the sheet. This name is displayed on the sheet's tab in the Amazon
     *   QuickSight console.
     */
    ...
    /**
     * @param parameterControls The list of parameter controls that are on a sheet. For more
     *   information, see
    ...
    /**
     * @param visuals A list of the visuals that are on a sheet. Visual placement is determined by
    ...
    public fun build(): CfnAnalysis.SheetDefinitionProperty {
