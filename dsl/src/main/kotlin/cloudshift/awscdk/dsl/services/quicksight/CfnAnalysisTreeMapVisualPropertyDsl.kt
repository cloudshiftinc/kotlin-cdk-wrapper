 ...
 */
@CdkDslMarker
public class CfnAnalysisTreeMapVisualPropertyDsl {
  private val cdkBuilder: CfnAnalysis.TreeMapVisualProperty.Builder =
   ...
   * @param chartConfiguration The configuration settings of the visual.
   */
  public fun chartConfiguration(chartConfiguration: CfnAnalysis.TreeMapConfigurationProperty) {
    cdkBuilder.chartConfiguration(chartConfiguration)
  }
  ...
  public fun build(): CfnAnalysis.TreeMapVisualProperty {
