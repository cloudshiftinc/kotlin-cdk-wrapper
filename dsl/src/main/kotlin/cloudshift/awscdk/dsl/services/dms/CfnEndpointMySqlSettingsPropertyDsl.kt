...
public class CfnEndpointMySqlSettingsPropertyDsl {
     ...
     *   replication instance when a mismatch occurs. For example, in a situation where running an
     *   alter DDL on the table could result in different information about the table cached in the
     ...
     *   single database or multiple databases. If you specify `SPECIFIC_DATABASE` , specify the
