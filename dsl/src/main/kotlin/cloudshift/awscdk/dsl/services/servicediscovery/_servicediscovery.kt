...
public object servicediscovery {
  ...
  public inline fun aliasTargetInstanceProps(block: AliasTargetInstancePropsDsl.() -> Unit = {}):
  ...
  public inline fun baseInstanceProps(block: BaseInstancePropsDsl.() -> Unit = {}):
      BaseInstanceProps {
  ...
  public inline fun baseNamespaceProps(block: BaseNamespacePropsDsl.() -> Unit = {}):
      BaseNamespaceProps {
  ...
  public inline fun cfnHttpNamespaceProps(block: CfnHttpNamespacePropsDsl.() -> Unit = {}):
  ...
  public inline
      fun cfnPrivateDnsNamespacePrivateDnsPropertiesMutableProperty(block: CfnPrivateDnsNamespacePrivateDnsPropertiesMutablePropertyDsl.() -> Unit
  ...
  public inline
      fun cfnPrivateDnsNamespacePropertiesProperty(block: CfnPrivateDnsNamespacePropertiesPropertyDsl.() -> Unit
  ...
  public inline fun cfnPrivateDnsNamespaceProps(block: CfnPrivateDnsNamespacePropsDsl.() -> Unit =
  ...
  public inline
      fun cfnPrivateDnsNamespaceSOAProperty(block: CfnPrivateDnsNamespaceSOAPropertyDsl.() -> Unit =
  ...
  public inline
      fun cfnPublicDnsNamespacePropertiesProperty(block: CfnPublicDnsNamespacePropertiesPropertyDsl.() -> Unit
  ...
  public inline fun cfnPublicDnsNamespaceProps(block: CfnPublicDnsNamespacePropsDsl.() -> Unit =
  ...
  public inline
      fun cfnPublicDnsNamespacePublicDnsPropertiesMutableProperty(block: CfnPublicDnsNamespacePublicDnsPropertiesMutablePropertyDsl.() -> Unit
  ...
  public inline
      fun cfnPublicDnsNamespaceSOAProperty(block: CfnPublicDnsNamespaceSOAPropertyDsl.() -> Unit =
  ...
  public inline fun cfnServiceDnsConfigProperty(block: CfnServiceDnsConfigPropertyDsl.() -> Unit =
  ...
  public inline fun cfnServiceDnsRecordProperty(block: CfnServiceDnsRecordPropertyDsl.() -> Unit =
  ...
  public inline
      fun cfnServiceHealthCheckConfigProperty(block: CfnServiceHealthCheckConfigPropertyDsl.() -> Unit
  ...
  public inline
      fun cfnServiceHealthCheckCustomConfigProperty(block: CfnServiceHealthCheckCustomConfigPropertyDsl.() -> Unit
  ...
  public inline fun cnameInstanceBaseProps(block: CnameInstanceBasePropsDsl.() -> Unit = {}):
  ...
  public inline fun cnameInstanceProps(block: CnameInstancePropsDsl.() -> Unit = {}):
      CnameInstanceProps {
  ...
  public inline fun healthCheckCustomConfig(block: HealthCheckCustomConfigDsl.() -> Unit = {}):
  ...
  public inline fun httpNamespaceAttributes(block: HttpNamespaceAttributesDsl.() -> Unit = {}):
  ...
  public inline fun httpNamespaceProps(block: HttpNamespacePropsDsl.() -> Unit = {}):
      HttpNamespaceProps {
  ...
  public inline fun ipInstanceBaseProps(block: IpInstanceBasePropsDsl.() -> Unit = {}):
      IpInstanceBaseProps {
  ...
  public inline fun nonIpInstanceBaseProps(block: NonIpInstanceBasePropsDsl.() -> Unit = {}):
  ...
  public inline fun nonIpInstanceProps(block: NonIpInstancePropsDsl.() -> Unit = {}):
      NonIpInstanceProps {
  ...
  public inline fun privateDnsNamespaceAttributes(block: PrivateDnsNamespaceAttributesDsl.() -> Unit
  ...
  public inline fun privateDnsNamespaceProps(block: PrivateDnsNamespacePropsDsl.() -> Unit = {}):
  ...
  public inline fun publicDnsNamespaceAttributes(block: PublicDnsNamespaceAttributesDsl.() -> Unit =
  ...
  public inline fun publicDnsNamespaceProps(block: PublicDnsNamespacePropsDsl.() -> Unit = {}):
  ...
  public inline fun serviceAttributes(block: ServiceAttributesDsl.() -> Unit = {}):
      ServiceAttributes {
