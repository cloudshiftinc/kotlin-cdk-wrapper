...
public class CfnBudgetTimePeriodPropertyDsl {
   ...
   * If you didn't specify an end date, AWS set your end date to `06/15/87 00:00 UTC` . The defaults
   ...
   * start of the chosen time period (MONTHLY, QUARTERLY, or ANNUALLY). For example, if you create your
   * budget on January 24, 2019, choose `MONTHLY` , and don't set a start date, the start date defaults
   * to `01/01/19 00:00 UTC` . The defaults are the same for the AWS Billing and Cost Management
   * console and the API.
   *
