...
public class CfnAutomationRulePropsDsl {
     ...
     *   to `true` for a rule, Security Hub applies the rule action to a finding that matches the
     *   rule criteria and doesn't evaluate other rules for the finding. The default value of this
     *   field is `false` .
     */
    ...
    /**
     * @param ruleStatus Whether the rule is active after it is created. If this parameter is equal
     *   to `ENABLED` , Security Hub applies the rule to findings and finding updates after the rule
     *   is created.
     */
