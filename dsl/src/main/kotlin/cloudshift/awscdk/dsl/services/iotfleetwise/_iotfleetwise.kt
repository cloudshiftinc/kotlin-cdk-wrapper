...
public object iotfleetwise {
    ...
    public inline fun cfnDecoderManifestProps(block: CfnDecoderManifestPropsDsl.() -> Unit = {}): CfnDecoderManifestProps {
    ...
    public inline fun cfnModelManifestProps(block: CfnModelManifestPropsDsl.() -> Unit = {}): CfnModelManifestProps {
    ...
    public inline fun cfnSignalCatalogProps(block: CfnSignalCatalogPropsDsl.() -> Unit = {}): CfnSignalCatalogProps {
