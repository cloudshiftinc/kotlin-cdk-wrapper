...
public object ivschat {
  ...
  public inline
      fun cfnLoggingConfigurationCloudWatchLogsDestinationConfigurationProperty(block: CfnLoggingConfigurationCloudWatchLogsDestinationConfigurationPropertyDsl.() -> Unit
  ...
  public inline
      fun cfnLoggingConfigurationDestinationConfigurationProperty(block: CfnLoggingConfigurationDestinationConfigurationPropertyDsl.() -> Unit
  ...
  public inline
      fun cfnLoggingConfigurationFirehoseDestinationConfigurationProperty(block: CfnLoggingConfigurationFirehoseDestinationConfigurationPropertyDsl.() -> Unit
  ...
  public inline
      fun cfnLoggingConfigurationS3DestinationConfigurationProperty(block: CfnLoggingConfigurationS3DestinationConfigurationPropertyDsl.() -> Unit
  ...
  public inline
      fun cfnRoomMessageReviewHandlerProperty(block: CfnRoomMessageReviewHandlerPropertyDsl.() -> Unit
