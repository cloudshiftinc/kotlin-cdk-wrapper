 ...
 */
@CdkDslMarker
public class CfnDashboardKPIVisualPropertyDsl {
    private val cdkBuilder: CfnDashboard.KPIVisualProperty.Builder =
     ...
     * @param chartConfiguration The configuration of a KPI visual.
     */
    public fun chartConfiguration(chartConfiguration: CfnDashboard.KPIConfigurationProperty) {
        cdkBuilder.chartConfiguration(chartConfiguration)
    }
     ...
     * @param conditionalFormatting The conditional formatting of a KPI visual.
     */
    public fun conditionalFormatting(conditionalFormatting: CfnDashboard.KPIConditionalFormattingProperty) {
        cdkBuilder.conditionalFormatting(conditionalFormatting)
    }
    ...
    public fun build(): CfnDashboard.KPIVisualProperty {
