...
public class CfnMemberMemberFabricConfigurationPropertyDsl {
     ...
     *   `AdminPassword` must be at least 8 characters long and no more than 32 characters. It must
     *   contain at least one uppercase letter, one lowercase letter, and one digit. It cannot have
