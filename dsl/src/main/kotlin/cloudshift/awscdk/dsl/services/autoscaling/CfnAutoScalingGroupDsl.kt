...
public class CfnAutoScalingGroupDsl(
    ...
    private val cdkBuilder: CfnAutoScalingGroup.Builder = CfnAutoScalingGroup.Builder.create(
        scope,
        id,
    )
    ...
    public fun launchTemplate(launchTemplate: CfnAutoScalingGroup.LaunchTemplateSpecificationProperty) {
        cdkBuilder.launchTemplate(launchTemplate)
    }
    ...
    public fun mixedInstancesPolicy(mixedInstancesPolicy: CfnAutoScalingGroup.MixedInstancesPolicyProperty) {
        cdkBuilder.mixedInstancesPolicy(mixedInstancesPolicy)
    }
