...
public object mediapackage {
     ...
     * packaging configurations associated with it. When ingest is complete, downstream devices use
     * the appropriate URL to request VOD content from AWS Elemental MediaPackage .
     *
     * Example:
     * ```
     ...
     * handling through various components, such as packaging protocols, DRM and encryption
     * integration, and more.
     *
     * After it's created, an endpoint provides a fixed public URL. This URL remains the same
     * throughout the lifetime of the endpoint, regardless of any failures or upgrades that might
     * occur. Integrate the URL with a downstream CDN (such as Amazon CloudFront) or playback
     * device.
     *
     * Example:
     * ```
    ...
    /**
     * Holds encryption information so that access to the content can be controlled by a DRM
     * solution.
     *
     * Example:
     * ```
     ...
     * your endpoints that use SPEKE Version 2.0. The encryption contract defines the content keys
     * used to encrypt the audio and video tracks in your stream. To configure the encryption
     * contract, specify which audio and video encryption presets to use. For more information about
     * these presets, see
     * [SPEKE Version 2.0 Presets](https://docs.aws.amazon.com/mediapackage/latest/ug/drm-content-speke-v2-presets.html)
     * .
     *
     * Note the following considerations when using `encryptionContractConfiguration` :
     * * You can use `encryptionContractConfiguration` for DASH endpoints that use SPEKE Version
     *   2.0. SPEKE Version 2.0 relies on the CPIX Version 2.3 specification.
     ...
     *
     * The packaging configuration represents a single delivery point for an asset. It determines
     * the format and setting for the egressing content. Specify only one package format per
     * configuration, such as `HlsPackage` .
     *
     * Example:
     * ```
     * // The code below shows an example of how to instantiate this type.
    ...
    /**
     * Parameters for a packaging configuration that uses Dynamic Adaptive Streaming over HTTP
     * (DASH) packaging.
     *
     * Example:
     * ```
    ...
    /**
     * Parameters for a packaging configuration that uses Microsoft Smooth Streaming (MSS)
     * packaging.
     *
     * Example:
     * ```
     ...
     * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-mediapackage-packagingconfiguration.html)
     */
    public inline fun cfnPackagingConfigurationProps(
        block: CfnPackagingConfigurationPropsDsl.() -> Unit = {}
     ...
     * specify the packaging group associated with the asset. The asset has playback endpoints for
     * each packaging configuration within the group.
     *
     * Example:
     * ```
     * // The code below shows an example of how to instantiate this type.
     ...
     * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-mediapackage-packaginggroup.html)
     */
    public inline fun cfnPackagingGroupProps(
        block: CfnPackagingGroupPropsDsl.() -> Unit = {}
