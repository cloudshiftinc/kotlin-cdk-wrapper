...
public class CfnScheduledQueryTimestreamConfigurationPropertyDsl {
    ...
    /**
     * @param measureNameColumn Name of the measure column. Also see `MultiMeasureMappings` and
    ...
    public fun multiMeasureMappings(
        multiMeasureMappings: CfnScheduledQuery.MultiMeasureMappingsProperty
    ) {
        cdkBuilder.multiMeasureMappings(multiMeasureMappings)
    }

    /**
     * @param tableName Name of Timestream table that the query result will be written to. The table
    ...
    public fun build(): CfnScheduledQuery.TimestreamConfigurationProperty {
        ...
        if (_mixedMeasureMappings.isNotEmpty())
            cdkBuilder.mixedMeasureMappings(_mixedMeasureMappings)
