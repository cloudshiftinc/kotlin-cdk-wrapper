...
public class GlueDataBrewStartJobRunDsl(
    ...
    private val cdkBuilder: GlueDataBrewStartJobRun.Builder =
        GlueDataBrewStartJobRun.Builder.create(scope, id)
    ...
    public fun build(): GlueDataBrewStartJobRun = cdkBuilder.build()
}
