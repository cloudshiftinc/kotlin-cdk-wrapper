...
public object amplifyuibuilder {
    ...
    public inline fun cfnFormFormButtonProperty(block: CfnFormFormButtonPropertyDsl.() -> Unit = {}): CfnForm.FormButtonProperty {
        val builder = CfnFormFormButtonPropertyDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun cfnFormFormCTAProperty(block: CfnFormFormCTAPropertyDsl.() -> Unit = {}): CfnForm.FormCTAProperty {
    ...
    public inline fun cfnFormFormStyleProperty(block: CfnFormFormStylePropertyDsl.() -> Unit = {}): CfnForm.FormStyleProperty {
