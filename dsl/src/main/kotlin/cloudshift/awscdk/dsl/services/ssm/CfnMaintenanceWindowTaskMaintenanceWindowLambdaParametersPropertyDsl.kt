...
public class CfnMaintenanceWindowTaskMaintenanceWindowLambdaParametersPropertyDsl {
     ...
     *   you're invoking. You can then use the `context` variable to process the client information
    ...
    /**
     * @param qualifier An AWS Lambda function version or alias name. If you specify a function
     *   version, the action uses the qualified function Amazon Resource Name (ARN) to invoke a
     *   specific Lambda function. If you specify an alias name, the action uses the alias ARN to
     *   invoke the Lambda function version that the alias points to.
     */
