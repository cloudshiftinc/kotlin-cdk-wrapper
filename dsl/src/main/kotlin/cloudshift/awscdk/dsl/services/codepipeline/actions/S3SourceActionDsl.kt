...
public class S3SourceActionDsl {
     ...
     *
     * If you import an encrypted bucket in your stack, please specify the encryption key at import
     * time by using `Bucket.fromBucketAttributes()` method.
     *
     ...
     * a CloudTrail Trail, as otherwise the CloudWatch Events will not be emitted.
     *
