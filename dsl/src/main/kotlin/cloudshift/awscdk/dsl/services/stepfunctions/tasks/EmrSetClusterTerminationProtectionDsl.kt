...
public class EmrSetClusterTerminationProtectionDsl(
  ...
  private val cdkBuilder: EmrSetClusterTerminationProtection.Builder =
      EmrSetClusterTerminationProtection.Builder.create(scope, id)
  ...
  public fun build(): EmrSetClusterTerminationProtection = cdkBuilder.build()
}
