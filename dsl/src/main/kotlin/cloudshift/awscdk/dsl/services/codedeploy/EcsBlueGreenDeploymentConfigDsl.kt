...
public class EcsBlueGreenDeploymentConfigDsl {
  ...
  /**
   * @param deploymentApprovalWaitTime Specify how long CodeDeploy waits for approval to continue a
   * blue-green deployment before it stops the deployment.
  ...
  /**
   * @param greenTargetGroup The target group that will be associated with the 'green' ECS task set
   * during a blue-green deployment. 
   */
  ...
  /**
   * @param terminationWaitTime Specify how long CodeDeploy waits before it terminates the original
   * 'blue' ECS task set when a blue-green deployment is complete.
