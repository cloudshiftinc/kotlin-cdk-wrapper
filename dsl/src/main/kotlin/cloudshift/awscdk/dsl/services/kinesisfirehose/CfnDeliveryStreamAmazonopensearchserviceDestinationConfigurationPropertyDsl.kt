...
public class CfnDeliveryStreamAmazonopensearchserviceDestinationConfigurationPropertyDsl {
    ...
    public fun bufferingHints(bufferingHints: CfnDeliveryStream.AmazonopensearchserviceBufferingHintsProperty) {
        cdkBuilder.bufferingHints(bufferingHints)
    }
    ...
    public fun retryOptions(retryOptions: CfnDeliveryStream.AmazonopensearchserviceRetryOptionsProperty) {
        cdkBuilder.retryOptions(retryOptions)
    }
