...
public class CfnDeliveryStreamAmazonopensearchserviceDestinationConfigurationPropertyDsl {
   ...
   */
  public
      fun bufferingHints(bufferingHints: CfnDeliveryStream.AmazonopensearchserviceBufferingHintsProperty) {
    cdkBuilder.bufferingHints(bufferingHints)
  }
   ...
   */
  public
      fun retryOptions(retryOptions: CfnDeliveryStream.AmazonopensearchserviceRetryOptionsProperty) {
    cdkBuilder.retryOptions(retryOptions)
  }

  /**
   * @param roleArn The Amazon Resource Name (ARN) of the IAM role to be assumed by Kinesis Data
   * Firehose for calling the Amazon OpenSearch Service Configuration API and for indexing documents. 
   */
