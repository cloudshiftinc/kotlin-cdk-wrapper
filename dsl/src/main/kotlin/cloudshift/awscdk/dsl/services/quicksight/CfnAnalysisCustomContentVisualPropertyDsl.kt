 ...
 */
@CdkDslMarker
public class CfnAnalysisCustomContentVisualPropertyDsl {
    private val cdkBuilder: CfnAnalysis.CustomContentVisualProperty.Builder =
     ...
     * @param chartConfiguration The configuration of a `CustomContentVisual` .
     */
    public fun chartConfiguration(chartConfiguration: CfnAnalysis.CustomContentConfigurationProperty) {
        cdkBuilder.chartConfiguration(chartConfiguration)
    }
    ...
    public fun build(): CfnAnalysis.CustomContentVisualProperty {
