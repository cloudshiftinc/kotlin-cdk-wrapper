...
public object frauddetector {
    ...
    public inline fun cfnDetectorLabelProperty(block: CfnDetectorLabelPropertyDsl.() -> Unit = {}): CfnDetector.LabelProperty {
        val builder = CfnDetectorLabelPropertyDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun cfnDetectorModelProperty(block: CfnDetectorModelPropertyDsl.() -> Unit = {}): CfnDetector.ModelProperty {
    ...
    public inline fun cfnDetectorRuleProperty(block: CfnDetectorRulePropertyDsl.() -> Unit = {}): CfnDetector.RuleProperty {
    ...
    public inline fun cfnEntityTypeProps(block: CfnEntityTypePropsDsl.() -> Unit = {}): CfnEntityTypeProps {
    ...
    public inline fun cfnEventTypeLabelProperty(block: CfnEventTypeLabelPropertyDsl.() -> Unit = {}): CfnEventType.LabelProperty {
        val builder = CfnEventTypeLabelPropertyDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun cfnEventTypeProps(block: CfnEventTypePropsDsl.() -> Unit = {}): CfnEventTypeProps {
