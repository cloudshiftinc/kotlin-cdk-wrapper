 ...
 */
@CdkDslMarker
public class CfnTemplateFunnelChartVisualPropertyDsl {
    private val cdkBuilder: CfnTemplate.FunnelChartVisualProperty.Builder =
     ...
     * @param chartConfiguration The configuration of a `FunnelChartVisual` .
     */
    public fun chartConfiguration(chartConfiguration: CfnTemplate.FunnelChartConfigurationProperty) {
        cdkBuilder.chartConfiguration(chartConfiguration)
    }
    ...
    public fun build(): CfnTemplate.FunnelChartVisualProperty {
