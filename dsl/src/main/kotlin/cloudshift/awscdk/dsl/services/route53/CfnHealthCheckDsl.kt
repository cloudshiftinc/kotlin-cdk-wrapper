 ...
 * create Amazon Route 53 health checks for the EC2 instances. When you register an EC2 instance
 * with a load balancer, you configure settings for an ELB health check, which performs a similar
 ...
 *   CloudWatch metric that checks the status of the Amazon EC2 `StatusCheckFailed` metric, add an
 *   alarm to the metric, and then create a health check that is based on the state of the alarm.
 *   For information about creating CloudWatch metrics and alarms by using the CloudWatch console,
 *   see the
