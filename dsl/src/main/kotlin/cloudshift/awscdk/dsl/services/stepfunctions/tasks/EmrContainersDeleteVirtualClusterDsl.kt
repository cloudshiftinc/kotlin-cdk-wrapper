...
public class EmrContainersDeleteVirtualClusterDsl(
  ...
  private val cdkBuilder: EmrContainersDeleteVirtualCluster.Builder =
      EmrContainersDeleteVirtualCluster.Builder.create(scope, id)
  ...
  public fun build(): EmrContainersDeleteVirtualCluster = cdkBuilder.build()
}
