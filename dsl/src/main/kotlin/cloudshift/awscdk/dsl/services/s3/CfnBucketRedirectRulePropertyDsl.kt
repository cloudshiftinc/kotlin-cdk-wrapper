...
public class CfnBucketRedirectRulePropertyDsl {
   ...
   * folder) to `documents/` , you can set a condition block with `KeyPrefixEquals` set to `docs/` and
   * in the Redirect set `ReplaceKeyPrefixWith` to `/documents` . Not required if one of the siblings
   ...
   * For example, redirect request to `error.html` . Not required if one of the siblings is present.
