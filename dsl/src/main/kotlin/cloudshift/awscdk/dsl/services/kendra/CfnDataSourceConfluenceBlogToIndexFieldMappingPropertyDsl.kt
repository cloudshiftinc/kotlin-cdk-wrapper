...
@CdkDslMarker
public class CfnDataSourceConfluenceBlogToIndexFieldMappingPropertyDsl {
    private val cdkBuilder: CfnDataSource.ConfluenceBlogToIndexFieldMappingProperty.Builder =
    ...
    public fun build(): CfnDataSource.ConfluenceBlogToIndexFieldMappingProperty = cdkBuilder.build()
}
