...
public class CfnFunctionDefinitionVersionResourceAccessPolicyPropertyDsl {
    ...
    /**
     * @param resourceId The ID of the resource. This ID is assigned to the resource when you create
    ...
    public fun build(): CfnFunctionDefinitionVersion.ResourceAccessPolicyProperty =
        cdkBuilder.build()
}
