...
public class CfnDistributionDistributionConfigPropertyDsl {
    ...
    /**
     * @param comment A comment to describe the distribution. The comment cannot be longer than 128
     *   characters.
     */
    ...
    /**
     * @param continuousDeploymentPolicyId The identifier of a continuous deployment policy. For
    ...
    public fun defaultCacheBehavior(
        defaultCacheBehavior: CfnDistribution.DefaultCacheBehaviorProperty
    ) {
        cdkBuilder.defaultCacheBehavior(defaultCacheBehavior)
    }
     ...
     *   avoids exposing the contents of your distribution. Specify only the object name, for
     *   example, `index.html` . Don't add a `/` before the object name.
     *
     ...
     *   use to communicate with CloudFront . The default value for new distributions is `http1.1` .
     *
     ...
     *   address for your distribution, specify `true` . If you specify `false` , CloudFront
     *   responds to IPv6 DNS requests with the DNS response code `NOERROR` and with no IP
     *   addresses. This allows viewers to submit a second request, for an IPv4 address for your
     *   distribution.
     *
     ...
     * content, and if you're using a custom policy that includes the `IpAddress` parameter to
     ...
     * to your CloudFront distribution, you need to create a second alias resource record set when
     ...
     *   pay for CloudFront service. If you specify `PriceClass_All` , CloudFront responds to
    ...
    /**
     * @param staging A Boolean that indicates whether this is a staging distribution. When this
     *   value is `true` , this is a staging distribution. When this value is `false` , this is not
     ...
     * that you specify, such as the IP addresses that requests originate from or the values of
     * query strings, CloudFront responds to requests either with the requested content or with an
     * HTTP 403 status code (Forbidden). You can also configure CloudFront to return a custom error
    ...
    public fun build(): CfnDistribution.DistributionConfigProperty {
        ...
        if (_customErrorResponses.isNotEmpty())
            cdkBuilder.customErrorResponses(_customErrorResponses)
