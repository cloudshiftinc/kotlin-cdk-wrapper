...
public class CfnTemplateWaterfallChartConfigurationPropertyDsl {
    ...
    public fun categoryAxisDisplayOptions(
        categoryAxisDisplayOptions: CfnTemplate.AxisDisplayOptionsProperty
    ) {
        cdkBuilder.categoryAxisDisplayOptions(categoryAxisDisplayOptions)
    }
    ...
    public fun categoryAxisLabelOptions(
        categoryAxisLabelOptions: CfnTemplate.ChartAxisLabelOptionsProperty
    ) {
        cdkBuilder.categoryAxisLabelOptions(categoryAxisLabelOptions)
    }
    ...
    public fun sortConfiguration(
        sortConfiguration: CfnTemplate.WaterfallChartSortConfigurationProperty
    ) {
        cdkBuilder.sortConfiguration(sortConfiguration)
    }
    ...
    public fun waterfallChartOptions(
        waterfallChartOptions: CfnTemplate.WaterfallChartOptionsProperty
    ) {
        cdkBuilder.waterfallChartOptions(waterfallChartOptions)
    }
