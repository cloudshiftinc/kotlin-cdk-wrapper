...
public class CfnInstanceFleetConfigInstanceTypeConfigPropertyDsl {
   ...
   * can include configurations for applications and software bundled with Amazon EMR. A configuration
   * consists of a classification, properties, and optional nested configurations. A classification
   * refers to an application-specific configuration file. Properties are the settings you want to
