...
public object ce {
  ...
  public inline fun cfnAnomalyMonitorProps(block: CfnAnomalyMonitorPropsDsl.() -> Unit = {}):
  ...
  public inline
      fun cfnAnomalyMonitorResourceTagProperty(block: CfnAnomalyMonitorResourceTagPropertyDsl.() -> Unit
  ...
  public inline fun cfnAnomalySubscriptionProps(block: CfnAnomalySubscriptionPropsDsl.() -> Unit =
  ...
  public inline
      fun cfnAnomalySubscriptionResourceTagProperty(block: CfnAnomalySubscriptionResourceTagPropertyDsl.() -> Unit
  ...
  public inline
      fun cfnAnomalySubscriptionSubscriberProperty(block: CfnAnomalySubscriptionSubscriberPropertyDsl.() -> Unit
  ...
  public inline fun cfnCostCategoryProps(block: CfnCostCategoryPropsDsl.() -> Unit = {}):
