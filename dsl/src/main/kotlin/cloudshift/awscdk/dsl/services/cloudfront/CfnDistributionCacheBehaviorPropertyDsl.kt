...
public class CfnDistributionCacheBehaviorPropertyDsl {
  ...
  /**
   * @param allowedMethods A complex type that controls which HTTP methods CloudFront processes and
   ...
   * your custom origin so users can't perform operations that you don't want them to. For example, you
  ...
  /**
   * @param cachePolicyId The unique identifier of the cache policy that is attached to this cache
   * behavior.
   ...
   * that you want CloudFront to use for encrypting specific fields of data for this cache behavior.
   */
   ...
   * We recommend that you use a cache policy or an origin request policy instead of this field. For
  ...
  /**
   * @param functionAssociations A list of CloudFront functions that are associated with this cache
   * behavior.
   ...
   * We recommend that you use the `MaxTTL` field in a cache policy instead of this field. For more
   ...
   * We recommend that you use the `MinTTL` field in a cache policy instead of this field. For more
   * information, see [Creating cache
   * policies](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/controlling-the-cache-key.html#cache-key-create-cache-policy)
   * or [Using the managed cache
   * policies](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/using-managed-cache-policies.html)
  ...
  /**
   * @param pathPattern The pattern (for example, `images/ *.jpg` ) that specifies which requests to
   ...
   * Smooth Streaming format using the origin that is associated with this cache behavior.
   * If so, specify `true` ; if not, specify `false` . If you specify `true` for `SmoothStreaming` ,
   * you can still distribute other content using this cache behavior if the content matches the value
   * of `PathPattern` .
   */
  ...
  /**
   * @param viewerProtocolPolicy The protocol that viewers can use to access the files in the origin
   ...
   * information, see [Managing Cache
