...
public class CfnDistributionCacheBehaviorPropertyDsl {
     ...
     *   that you want CloudFront to use for encrypting specific fields of data for this cache
     *   behavior.
     */
     ...
     *   attached to this cache behavior. For more information, see
     *   [Creating origin request policies](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/controlling-origin-requests.html#origin-request-create-origin-request-policy)
     *   or
     *   [Using the managed origin request policies](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/using-managed-origin-request-policies.html)
     *   in the *Amazon CloudFront Developer Guide* .
     ...
     *   to apply the behavior to. When CloudFront receives a viewer request, the requested path is
     ...
     * with the private key of a CloudFront key pair in the trusted signer's AWS account . The
