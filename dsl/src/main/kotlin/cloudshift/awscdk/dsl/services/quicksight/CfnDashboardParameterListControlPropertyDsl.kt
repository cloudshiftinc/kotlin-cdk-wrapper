 ...
 */
@CdkDslMarker
public class CfnDashboardParameterListControlPropertyDsl {
    private val cdkBuilder: CfnDashboard.ParameterListControlProperty.Builder =
    ...
    public fun build(): CfnDashboard.ParameterListControlProperty = cdkBuilder.build()
}
