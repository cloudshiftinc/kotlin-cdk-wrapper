...
public class CfnAnalysisCustomActionFilterOperationPropertyDsl {
  ...
  public
      fun selectedFieldsConfiguration(selectedFieldsConfiguration: CfnAnalysis.FilterOperationSelectedFieldsConfigurationProperty) {
    cdkBuilder.selectedFieldsConfiguration(selectedFieldsConfiguration)
  }
  ...
  public
      fun targetVisualsConfiguration(targetVisualsConfiguration: CfnAnalysis.FilterOperationTargetVisualsConfigurationProperty) {
    cdkBuilder.targetVisualsConfiguration(targetVisualsConfiguration)
  }
