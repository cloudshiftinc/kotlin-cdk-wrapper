...
public class CfnAnalysisVisualCustomActionOperationPropertyDsl {
     ...
     * the same analysis.
     */
    public fun navigationOperation(navigationOperation: CfnAnalysis.CustomActionNavigationOperationProperty) {
        cdkBuilder.navigationOperation(navigationOperation)
    }
     ...
     * action.
     */
    public fun setParametersOperation(setParametersOperation: CfnAnalysis.CustomActionSetParametersOperationProperty) {
        cdkBuilder.setParametersOperation(setParametersOperation)
    }
