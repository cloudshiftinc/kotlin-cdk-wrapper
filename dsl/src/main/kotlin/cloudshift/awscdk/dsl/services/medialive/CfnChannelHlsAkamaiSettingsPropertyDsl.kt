...
public class CfnChannelHlsAkamaiSettingsPropertyDsl {
    ...
    /**
     * @param httpTransferMode Specifies whether to use chunked transfer encoding to Akamai. To
    ...
    /**
     * @param token The token parameter for authenticated Akamai. If this is not specified, *gda* is
     *   used.
     */
