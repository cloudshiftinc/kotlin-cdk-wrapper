...
public class CfnLocationFSxWindowsDsl(
   ...
   * @param password Specifies the password of the user who has the permissions to access files and
   ...
   * @param securityGroupArns The Amazon Resource Names (ARNs) of the security groups that are used
   ...
   * @param user The user who has the permissions to access files and folders in the FSx for Windows
