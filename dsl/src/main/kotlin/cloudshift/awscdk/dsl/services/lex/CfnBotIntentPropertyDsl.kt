...
public class CfnBotIntentPropertyDsl {
     ...
     *   user input. You can invoke this Lambda function to personalize user interaction.
     */
    ...
    public fun initialResponseSetting(
        initialResponseSetting: CfnBot.InitialResponseSettingProperty
    ) {
        cdkBuilder.initialResponseSetting(initialResponseSetting)
    }
    ...
    public fun intentConfirmationSetting(
        intentConfirmationSetting: CfnBot.IntentConfirmationSettingProperty
    ) {
        cdkBuilder.intentConfirmationSetting(intentConfirmationSetting)
    }
    ...
    /**
     * @param name The name of the intent. Intent names must be unique within the locale that
     *   contains the intent and can't match the name of any built-in intent.
     */
    ...
    /**
     * @param slotPriorities Indicates the priority for slots. Amazon Lex prompts the user for slot
