...
public class CfnListenerActionPropertyDsl {
    ...
    public fun authenticateCognitoConfig(authenticateCognitoConfig: CfnListener.AuthenticateCognitoConfigProperty) {
        cdkBuilder.authenticateCognitoConfig(authenticateCognitoConfig)
    }
    ...
    public fun authenticateOidcConfig(authenticateOidcConfig: CfnListener.AuthenticateOidcConfigProperty) {
        cdkBuilder.authenticateOidcConfig(authenticateOidcConfig)
    }
