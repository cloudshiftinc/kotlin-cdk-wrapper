...
public class CfnScalingPlanTargetTrackingConfigurationPropertyDsl {
   ...
   * remove capacity from the scalable resource. Otherwise, scale in is enabled and the target tracking
  ...
  /**
   * @param estimatedInstanceWarmup The estimated time, in seconds, until a newly launched instance
