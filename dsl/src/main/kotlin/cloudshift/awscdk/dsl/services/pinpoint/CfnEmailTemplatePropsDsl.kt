...
public class CfnEmailTemplatePropsDsl {
     ...
     *   the message template. We recommend using HTML format for email clients that render HTML
     ...
     *   based on the message template. We recommend using plain text format for email clients that
     *   don't render HTML content and clients that are connected to high-latency networks, such as
     *   mobile devices.
     */
