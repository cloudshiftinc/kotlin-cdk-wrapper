 ...
 * setting that tells Amazon Cognito how to handle changes to the value of your users' email address
 * and phone number attributes. For more information, see
...
public class CfnUserPoolUserAttributeUpdateSettingsPropertyDsl {
     ...
     *   change the value of the attribute until your user responds to the verification message and
    ...
    public fun attributesRequireVerificationBeforeUpdate(
        ...
        _attributesRequireVerificationBeforeUpdate.addAll(
            listOf(*attributesRequireVerificationBeforeUpdate)
        )
    }
     ...
     */
    public fun attributesRequireVerificationBeforeUpdate(
        attributesRequireVerificationBeforeUpdate: Collection<String>
    ) {
    ...
    public fun build(): CfnUserPool.UserAttributeUpdateSettingsProperty {
        if (_attributesRequireVerificationBeforeUpdate.isNotEmpty())
            cdkBuilder.attributesRequireVerificationBeforeUpdate(
                _attributesRequireVerificationBeforeUpdate
            )
