...
public class CfnDevEndpointPropsDsl {
    ...
    /**
     * @param arguments A map of arguments used to configure the `DevEndpoint` . Valid arguments
     *   are:
     ...
     *   that should be loaded in your `DevEndpoint` . Multiple values must be complete paths
     ...
     *   that AWS Glue supports. The Python version indicates the version supported for running your
