...
public class CfnApiCachePropsDsl {
    ...
    /**
     * @param atRestEncryptionEnabled At-rest encryption flag for cache. You cannot update this
    ...
    /**
     * @param transitEncryptionEnabled Transit encryption flag when connecting to cache. You cannot
