...
public class CfnDataSourceDataSourceParametersPropertyDsl {
    ...
    public fun amazonElasticsearchParameters(amazonElasticsearchParameters: CfnDataSource.AmazonElasticsearchParametersProperty) {
        cdkBuilder.amazonElasticsearchParameters(amazonElasticsearchParameters)
    }
    ...
    public fun amazonOpenSearchParameters(amazonOpenSearchParameters: CfnDataSource.AmazonOpenSearchParametersProperty) {
        cdkBuilder.amazonOpenSearchParameters(amazonOpenSearchParameters)
    }
    ...
    public fun auroraPostgreSqlParameters(auroraPostgreSqlParameters: CfnDataSource.AuroraPostgreSqlParametersProperty) {
        cdkBuilder.auroraPostgreSqlParameters(auroraPostgreSqlParameters)
    }
    ...
    public fun databricksParameters(databricksParameters: CfnDataSource.DatabricksParametersProperty) {
        cdkBuilder.databricksParameters(databricksParameters)
    }
    ...
    public fun postgreSqlParameters(postgreSqlParameters: CfnDataSource.PostgreSqlParametersProperty) {
        cdkBuilder.postgreSqlParameters(postgreSqlParameters)
    }
