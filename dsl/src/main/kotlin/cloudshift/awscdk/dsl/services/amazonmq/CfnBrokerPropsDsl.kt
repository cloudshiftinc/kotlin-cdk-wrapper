...
public class CfnBrokerPropsDsl {
    ...
    /**
     * @param authenticationStrategy Optional. The authentication strategy used to secure the
     ...
     *   as new broker engine versions are released and supported by Amazon MQ. Automatic upgrades
     *   occur during the scheduled maintenance window of the broker or after a manual broker
     *   reboot.
     */
    ...
    /**
     * @param brokerName The name of the broker. This value must be unique in your AWS account ,
     *   1-50 characters long, must contain only letters, numbers, dashes, and underscores, and must
    ...
    /**
     * @param configuration A list of information about the configuration. Does not apply to
     *   RabbitMQ brokers.
     */
    ...
    /**
     * @param encryptionOptions Encryption options for the broker. Does not apply to RabbitMQ
     *   brokers.
     */
    ...
    /**
     * @param engineType The type of broker engine. Currently, Amazon MQ supports `ACTIVEMQ` and
     *   `RABBITMQ` .
     */
     ...
     *   ACTIVE_STANDBY_MULTI_AZ deployment (ACTIVEMQ) requires two subnets. A CLUSTER_MULTI_AZ
    ...
    /**
     * @param tags An array of key-value pairs. For more information, see
     ...
     *   accepted and created when a broker is first provisioned. All subsequent RabbitMQ users are
     *   created by via the RabbitMQ web console or by using the RabbitMQ management API.
     */
