...
public class CfnApplicationReferenceDataSourceV2ReferenceDataSourcePropertyDsl {
    ...
    public fun referenceSchema(
        referenceSchema: CfnApplicationReferenceDataSourceV2.ReferenceSchemaProperty
    ) {
        cdkBuilder.referenceSchema(referenceSchema)
    }
    ...
    public fun s3ReferenceDataSource(
        s3ReferenceDataSource: CfnApplicationReferenceDataSourceV2.S3ReferenceDataSourceProperty
    ) {
        cdkBuilder.s3ReferenceDataSource(s3ReferenceDataSource)
    }
