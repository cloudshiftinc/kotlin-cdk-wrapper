...
public class VpcEndpointServiceDsl(
    ...
    private val cdkBuilder: VpcEndpointService.Builder =
        VpcEndpointService.Builder.create(scope, id)
     ...
     *
     * These principals can connect to your service using VPC endpoints. Takes a list of one or more
     * ArnPrincipal.
     *
