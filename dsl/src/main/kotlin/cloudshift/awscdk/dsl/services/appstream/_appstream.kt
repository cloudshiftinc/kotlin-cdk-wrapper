...
public object appstream {
  ...
  public inline
      fun cfnAppBlockBuilderAccessEndpointProperty(block: CfnAppBlockBuilderAccessEndpointPropertyDsl.() -> Unit
  ...
  public inline fun cfnAppBlockBuilderProps(block: CfnAppBlockBuilderPropsDsl.() -> Unit = {}):
  ...
  public inline
      fun cfnAppBlockBuilderVpcConfigProperty(block: CfnAppBlockBuilderVpcConfigPropertyDsl.() -> Unit
  ...
  public inline fun cfnAppBlockS3LocationProperty(block: CfnAppBlockS3LocationPropertyDsl.() -> Unit
  ...
  public inline
      fun cfnAppBlockScriptDetailsProperty(block: CfnAppBlockScriptDetailsPropertyDsl.() -> Unit =
  ...
  public inline
      fun cfnApplicationEntitlementAssociationProps(block: CfnApplicationEntitlementAssociationPropsDsl.() -> Unit
  ...
  public inline
      fun cfnApplicationFleetAssociationProps(block: CfnApplicationFleetAssociationPropsDsl.() -> Unit
  ...
  public inline
      fun cfnApplicationS3LocationProperty(block: CfnApplicationS3LocationPropertyDsl.() -> Unit =
  ...
  public inline
      fun cfnDirectoryConfigCertificateBasedAuthPropertiesProperty(block: CfnDirectoryConfigCertificateBasedAuthPropertiesPropertyDsl.() -> Unit
  ...
  public inline fun cfnDirectoryConfigProps(block: CfnDirectoryConfigPropsDsl.() -> Unit = {}):
  ...
  public inline
      fun cfnDirectoryConfigServiceAccountCredentialsProperty(block: CfnDirectoryConfigServiceAccountCredentialsPropertyDsl.() -> Unit
  ...
  public inline
      fun cfnEntitlementAttributeProperty(block: CfnEntitlementAttributePropertyDsl.() -> Unit =
  ...
  public inline fun cfnEntitlementProps(block: CfnEntitlementPropsDsl.() -> Unit = {}):
      CfnEntitlementProps {
  ...
  public inline
      fun cfnFleetComputeCapacityProperty(block: CfnFleetComputeCapacityPropertyDsl.() -> Unit =
  ...
  public inline
      fun cfnFleetDomainJoinInfoProperty(block: CfnFleetDomainJoinInfoPropertyDsl.() -> Unit = {}):
  ...
  public inline fun cfnFleetS3LocationProperty(block: CfnFleetS3LocationPropertyDsl.() -> Unit =
  ...
  public inline fun cfnFleetVpcConfigProperty(block: CfnFleetVpcConfigPropertyDsl.() -> Unit = {}):
  ...
  public inline
      fun cfnImageBuilderAccessEndpointProperty(block: CfnImageBuilderAccessEndpointPropertyDsl.() -> Unit
  ...
  public inline
      fun cfnImageBuilderDomainJoinInfoProperty(block: CfnImageBuilderDomainJoinInfoPropertyDsl.() -> Unit
  ...
  public inline fun cfnImageBuilderProps(block: CfnImageBuilderPropsDsl.() -> Unit = {}):
  ...
  public inline
      fun cfnImageBuilderVpcConfigProperty(block: CfnImageBuilderVpcConfigPropertyDsl.() -> Unit =
  ...
  public inline
      fun cfnStackAccessEndpointProperty(block: CfnStackAccessEndpointPropertyDsl.() -> Unit = {}):
  ...
  public inline
      fun cfnStackApplicationSettingsProperty(block: CfnStackApplicationSettingsPropertyDsl.() -> Unit
  ...
  public inline fun cfnStackFleetAssociationProps(block: CfnStackFleetAssociationPropsDsl.() -> Unit
  ...
  public inline
      fun cfnStackStorageConnectorProperty(block: CfnStackStorageConnectorPropertyDsl.() -> Unit =
  ...
  public inline
      fun cfnStackStreamingExperienceSettingsProperty(block: CfnStackStreamingExperienceSettingsPropertyDsl.() -> Unit
  ...
  public inline fun cfnStackUserAssociationProps(block: CfnStackUserAssociationPropsDsl.() -> Unit =
  ...
  public inline fun cfnStackUserSettingProperty(block: CfnStackUserSettingPropertyDsl.() -> Unit =
