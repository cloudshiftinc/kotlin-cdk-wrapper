...
public inline fun CfnEndpoint.setIbmDb2Settings(block: CfnEndpointIbmDb2SettingsPropertyDsl.() -> Unit = {}) {
...
public inline fun CfnEndpoint.setOracleSettings(block: CfnEndpointOracleSettingsPropertyDsl.() -> Unit = {}) {
...
public inline fun CfnEndpoint.setSybaseSettings(block: CfnEndpointSybaseSettingsPropertyDsl.() -> Unit = {}) {
