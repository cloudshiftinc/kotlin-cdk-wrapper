 ...
 * cooldown period, and the number of EC2 instances that will be added each time the CloudWatch
...
public class EmrCreateClusterSimpleScalingPolicyConfigurationPropertyDsl {
     ...
     *   AdjustmentType. A positive value adds to the instance group's EC2 instance count while a
     *   negative number removes instances. If AdjustmentType is set to EXACT_CAPACITY, the number
    ...
    public fun build(): EmrCreateCluster.SimpleScalingPolicyConfigurationProperty =
        cdkBuilder.build()
}
