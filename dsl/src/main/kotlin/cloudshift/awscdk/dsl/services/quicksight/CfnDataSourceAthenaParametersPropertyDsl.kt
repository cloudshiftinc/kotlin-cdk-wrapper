...
public class CfnDataSourceAthenaParametersPropertyDsl {
     ...
     *   access with an account-wide role. The administrator can then use `RoleArn` to bypass the
     *   account-wide role and allow Athena access for the single Athena data source that is
     *   specified in the structure, even if the account-wide role forbidding Athena access is still
     *   active.
     */
