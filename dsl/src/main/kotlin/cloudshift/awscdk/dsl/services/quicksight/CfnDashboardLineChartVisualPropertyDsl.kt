 ...
 * [Using line charts](https://docs.aws.amazon.com/quicksight/latest/user/line-charts.html) in the
 ...
 */
@CdkDslMarker
public class CfnDashboardLineChartVisualPropertyDsl {
    private val cdkBuilder: CfnDashboard.LineChartVisualProperty.Builder =
    ...
    /** @param chartConfiguration The configuration of a line chart. */
    public fun chartConfiguration(chartConfiguration: CfnDashboard.LineChartConfigurationProperty) {
        cdkBuilder.chartConfiguration(chartConfiguration)
    }
    ...
    public fun build(): CfnDashboard.LineChartVisualProperty {
