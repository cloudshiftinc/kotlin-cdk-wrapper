...
public class CfnServiceProfileLoRaWANServiceProfilePropertyDsl {
    ...
    /**
     * @param channelMask The ChannelMask value. This property is `ReadOnly` and can't be inputted
     *   for create. It's returned with `Fn::GetAtt`
     */
    ...
    /**
     * @param devStatusReqFreq The DevStatusReqFreq value. This property is `ReadOnly` and can't be
    ...
    /**
     * @param dlBucketSize The DLBucketSize value. This property is `ReadOnly` and can't be inputted
     *   for create. It's returned with `Fn::GetAtt`
     */
    ...
    /**
     * @param dlRate The DLRate value. This property is `ReadOnly` and can't be inputted for create.
     *   It's returned with `Fn::GetAtt`
     */
    ...
    /**
     * @param dlRatePolicy The DLRatePolicy value. This property is `ReadOnly` and can't be inputted
     *   for create. It's returned with `Fn::GetAtt`
     */
    ...
    /**
     * @param drMax The DRMax value. This property is `ReadOnly` and can't be inputted for create.
     *   It's returned with `Fn::GetAtt`
     */
    ...
    /**
     * @param drMin The DRMin value. This property is `ReadOnly` and can't be inputted for create.
     *   It's returned with `Fn::GetAtt`
     */
    ...
    /**
     * @param hrAllowed The HRAllowed value that describes whether handover roaming is allowed. This
     *   property is `ReadOnly` and can't be inputted for create. It's returned with `Fn::GetAtt`
     */
    ...
    /**
     * @param minGwDiversity The MinGwDiversity value. This property is `ReadOnly` and can't be
     *   inputted for create. It's returned with `Fn::GetAtt`
     */
    ...
    /**
     * @param nwkGeoLoc The NwkGeoLoc value. This property is `ReadOnly` and can't be inputted for
    ...
    /**
     * @param prAllowed The PRAllowed value that describes whether passive roaming is allowed. This
     *   property is `ReadOnly` and can't be inputted for create. It's returned with `Fn::GetAtt`
     */
    ...
    /**
     * @param reportDevStatusBattery The ReportDevStatusBattery value. This property is `ReadOnly`
    ...
    /**
     * @param reportDevStatusMargin The ReportDevStatusMargin value. This property is `ReadOnly` and
    ...
    /**
     * @param targetPer The TargetPer value. This property is `ReadOnly` and can't be inputted for
     *   create. It's returned with `Fn::GetAtt`
     */
    ...
    /**
     * @param ulBucketSize The UlBucketSize value. This property is `ReadOnly` and can't be inputted
     *   for create. It's returned with `Fn::GetAtt`
     */
    ...
    /**
     * @param ulRate The ULRate value. This property is `ReadOnly` and can't be inputted for create.
     *   It's returned with `Fn::GetAtt`
     */
    ...
    /**
     * @param ulRatePolicy The ULRatePolicy value. This property is `ReadOnly` and can't be inputted
     *   for create. It's returned with `Fn::GetAtt`
     */
