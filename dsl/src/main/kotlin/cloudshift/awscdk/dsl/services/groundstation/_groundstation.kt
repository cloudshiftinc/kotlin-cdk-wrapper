...
public object groundstation {
    ...
    /**
     * Config objects provide information to Ground Station about how to configure the antenna and
     * how data flows during a contact.
     *
     * Example:
     * ```
     * // The code below shows an example of how to instantiate this type.
     ...
     */
    public inline fun cfnConfigEirpProperty(
        block: CfnConfigEirpPropertyDsl.() -> Unit = {}
     ...
     * group is specified in a mission profile, the Ground Station service will connect to the
     * endpoints and flow data during a contact.
     *
     ...
     * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-groundstation-missionprofile.html)
     */
    public inline fun cfnMissionProfileProps(
        block: CfnMissionProfilePropsDsl.() -> Unit = {}
