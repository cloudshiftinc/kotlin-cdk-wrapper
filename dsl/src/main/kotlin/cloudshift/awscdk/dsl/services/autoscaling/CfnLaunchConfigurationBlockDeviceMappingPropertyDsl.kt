...
public class CfnLaunchConfigurationBlockDeviceMappingPropertyDsl {
   ...
   * instances](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/device_naming.html) in the *Amazon
   ...
   * If `NoDevice` is `true` for the root device, instances might fail the EC2 health check. In that
