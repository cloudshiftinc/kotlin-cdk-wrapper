...
public class ServerlessClusterFromSnapshotPropsDsl {
     ...
     *   Automatic backup retention cannot be disabled on serverless clusters. Must be a value from
     *   1 day to 35 days.
     */
    ...
    /**
     * @param credentials Master user credentials. Note - It is not possible to change the master
     *   username for a snapshot; however, it is possible to provide (or generate) a new password.
     */
    ...
    /**
     * @param vpcSubnets Where to place the instances within the VPC. If provided, the `vpc`
