...
public class CfnDataSourceWebCrawlerConfigurationPropertyDsl {
   ...
   */
  public
      fun authenticationConfiguration(authenticationConfiguration: CfnDataSource.WebCrawlerAuthenticationConfigurationProperty) {
    cdkBuilder.authenticationConfiguration(authenticationConfiguration)
  }

  /**
   * @param crawlDepth The 'depth' or number of levels from the seed level to crawl.
   * For example, the seed URL page is depth 1 and any hyperlinks on this page that are also crawled
   * are depth 2.
   */
  ...
  /**
   * @param maxContentSizePerPageInMegaBytes The maximum size (in MB) of a web page or attachment to
   * crawl.
   ...
   *
   * As a website’s web pages are crawled, any URLs the web pages link to are also crawled. URLs on
   * a web page are crawled in order of appearance.
   *
   ...
   * are included in the index. If a URL matches both an inclusion and exclusion pattern, the exclusion
   ...
   * crawl.
   * URLs that match the patterns are included in the index. URLs that don't match the patterns are
   * excluded from the index. If a URL matches both an inclusion and exclusion pattern, the exclusion
   * pattern takes precedence and the URL file isn't included in the index.
   */
   ...
   * the websites you want to crawl. 
   ...
   * use Amazon Kendra Web Crawler to index your own webpages, or webpages that you have authorization
   * to index.*
   */
