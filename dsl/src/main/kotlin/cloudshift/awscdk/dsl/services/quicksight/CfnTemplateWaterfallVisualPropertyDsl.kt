 ...
 */
@CdkDslMarker
public class CfnTemplateWaterfallVisualPropertyDsl {
    private val cdkBuilder: CfnTemplate.WaterfallVisualProperty.Builder =
     ...
     * @param chartConfiguration The configuration for a waterfall visual.
     */
    public fun chartConfiguration(chartConfiguration: CfnTemplate.WaterfallChartConfigurationProperty) {
        cdkBuilder.chartConfiguration(chartConfiguration)
    }
    ...
    public fun build(): CfnTemplate.WaterfallVisualProperty {
