...
public inline fun CfnComponentVersion.setLambdaFunction(
...
public inline fun CfnDeployment.setDeploymentPolicies(
...
public inline fun CfnDeployment.setIotJobConfiguration(
