...
public class CfnOriginEndpointSpekeKeyProviderPropertyDsl {
   ...
   * AWS Certificate Manager to add content key encryption to this endpoint.
  ...
  /**
   * @param resourceId Unique identifier for this endpoint, as it is configured in the key provider
   * service. 
   */
