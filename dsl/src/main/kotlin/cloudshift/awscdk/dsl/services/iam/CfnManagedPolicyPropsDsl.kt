...
public class CfnManagedPolicyPropsDsl {
    ...
    /**
     * @param description A friendly description of the policy. Typically used to store information
    ...
    /**
     * @param groups The name (friendly name, not ARN) of the group to attach the policy to. This
     *   parameter allows (through its
    ...
    /**
     * @param path The path for the policy. For more information about paths, see
     ...
     * whitespaces, see
     * [IAM and AWS STS character quotas](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_iam-quotas.html#reference_iam-quotas-entity-length)
     * .
     *
    ...
    /**
     * @param roles The name (friendly name, not ARN) of the role to attach the policy to. This
    ...
    /**
     * @param users The name (friendly name, not ARN) of the IAM user to attach the policy to. This
     *   parameter allows (through its
     *   [regex pattern](https://docs.aws.amazon.com/http://wikipedia.org/wiki/regex) ) a string of
     *   characters consisting of upper and lowercase alphanumeric characters with no spaces. You
     *   can also include any of the following characters: _+=,.&#64;-
    ...
    public fun build(): CfnManagedPolicyProps {
