...
public class BundlingOptionsDsl {
  ...
  /**
   * @param bundlingFileAccess Which option to use to copy the source files to the docker container
   * and output files back.
   */
  ...
  /**
   * @param inject This option allows you to automatically replace a global variable with an import
   * from another file.
   */
  ...
  /**
   * @param metafile This option tells esbuild to write out a JSON file relative to output directory
   * with metadata about the build.
