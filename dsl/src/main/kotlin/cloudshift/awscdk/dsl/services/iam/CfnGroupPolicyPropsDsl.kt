 ...
 */
@CdkDslMarker
public class CfnGroupPolicyPropsDsl {
    private val cdkBuilder: CfnGroupPolicyProps.Builder = CfnGroupPolicyProps.builder()

    /**
     * @param groupName The name of the group to associate the policy with. This parameter allows
    ...
    public fun build(): CfnGroupPolicyProps = cdkBuilder.build()
}
