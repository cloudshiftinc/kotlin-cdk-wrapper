...
public class CfnDistributionS3OriginConfigPropertyDsl {
     ...
     *   origin. Use an origin access identity to configure the origin so that viewers can *only*
     *   access objects in an Amazon S3 bucket through CloudFront. The format of the value is:
     *
