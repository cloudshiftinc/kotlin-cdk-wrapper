...
public class CfnTopicPropsDsl {
     ...
     *   to `PassThrough` , and the topic passes through the tracing header it receives from an SNS
     *   publisher to its subscriptions. If set to `Active` , SNS will vend X-Ray segment data to
     *   topic owner account if the sampled flag in the tracing header is true. Only supported on
     *   standard topics.
     */
