...
public class EmrCreateClusterPropsDsl {
   ...
   */
  public
      fun bootstrapActions(bootstrapActions: EmrCreateClusterBootstrapActionConfigPropertyDsl.() -> Unit) {
   ...
   */
  public
      fun bootstrapActions(bootstrapActions: Collection<EmrCreateCluster.BootstrapActionConfigProperty>) {
   ...
   */
  public
      fun kerberosAttributes(kerberosAttributes: EmrCreateClusterKerberosAttributesPropertyDsl.() -> Unit
      = {}) {
  ...
  /**
   * @param scaleDownBehavior Specifies the way that individual Amazon EC2 instances terminate when
  ...
  /**
   * @param stepConcurrencyLevel Specifies the step concurrency level to allow multiple steps to run
   * in parallel.
