...
public class CfnAppMonitorPropsDsl {
     ...
     *   your own authorization method. For more information, see
     ...
     *   send custom events. If you omit this parameter, custom events are `DISABLED` .
     */
     ...
     *   deleted. This parameter specifies whether CloudWatch RUM sends a copy of this telemetry
     *   data to Amazon CloudWatch Logs in your account. This enables you to keep the telemetry data
     *   for more than 30 days, but it does incur Amazon CloudWatch Logs charges.
     *
    ...
    /**
     * @param tags Assigns one or more tags (key-value pairs) to the app monitor. Tags can help you
