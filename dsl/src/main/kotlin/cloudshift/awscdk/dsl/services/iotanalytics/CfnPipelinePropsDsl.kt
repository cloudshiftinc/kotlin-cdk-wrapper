...
public class CfnPipelinePropsDsl {
    ...
    /**
     * @param pipelineActivities A list of "PipelineActivity" objects. Activities perform
    ...
    /**
     * @param tags Metadata which can be used to manage the pipeline. For more information, see
