...
public class CfnPlaybackConfigurationManifestProcessingRulesPropertyDsl {
     ...
     *   manifest to the MediaTailor personalized manifest. No logic is applied to these ad markers.
     *   For example, if EXT-X-CUE-OUT has a value of 60, but no ads are filled for that ad break,
