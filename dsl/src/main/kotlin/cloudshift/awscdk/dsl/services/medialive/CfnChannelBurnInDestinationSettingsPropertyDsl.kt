...
public class CfnChannelBurnInDestinationSettingsPropertyDsl {
     ...
     *   live subtitles and center-justifies pre-recorded subtitles. All burn-in and DVB-Sub font
     *   settings must match.
     */
    ...
    /**
     * @param outlineSize Specifies font outline size in pixels. This option is not valid for source
     *   captions that are either 608/embedded or Teletext. These source settings are already
     *   pre-defined by the captions stream. All burn-in and DVB-Sub font settings must match.
     */
    ...
    /**
     * @param shadowColor Specifies the color of the shadow cast by the captions. All burn-in and
     *   DVB-Sub font settings must match.
     */
     ...
     *   captions in pixels. A value of -2 would result in a shadow offset 2 pixels to the left. All
     *   burn-in and DVB-Sub font settings must match.
     */
     ...
     *   captions in pixels. A value of -2 would result in a shadow offset 2 pixels above the text.
     *   All burn-in and DVB-Sub font settings must match.
     */
     ...
     *   subtitles bitmap. This applies only to Teletext inputs and DVB-Sub/Burn-in outputs.
     */
     ...
     *   position is determined by the alignment parameter. All burn-in and DVB-Sub font settings
     *   must match.
     */
     ...
     *   towards the bottom of the output. All burn-in and DVB-Sub font settings must match.
     */
