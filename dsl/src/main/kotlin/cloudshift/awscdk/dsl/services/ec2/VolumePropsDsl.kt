...
public class VolumePropsDsl {
    ...
    /**
     * @param enableMultiAttach Indicates whether Amazon EBS Multi-Attach is enabled. See
    ...
    /**
     * @param encrypted Specifies whether the volume should be encrypted. The effect of setting the
    ...
    /**
     * @param volumeType The type of the volume;. what type of storage to use to form the EBS
     *   Volume.
     */
