...
public class CfnDataSourceServiceNowConfigurationPropertyDsl {
    ...
    public fun knowledgeArticleConfiguration(knowledgeArticleConfiguration: CfnDataSource.ServiceNowKnowledgeArticleConfigurationProperty) {
        cdkBuilder.knowledgeArticleConfiguration(knowledgeArticleConfiguration)
    }
    ...
    public fun serviceCatalogConfiguration(serviceCatalogConfiguration: CfnDataSource.ServiceNowServiceCatalogConfigurationProperty) {
        cdkBuilder.serviceCatalogConfiguration(serviceCatalogConfiguration)
    }
