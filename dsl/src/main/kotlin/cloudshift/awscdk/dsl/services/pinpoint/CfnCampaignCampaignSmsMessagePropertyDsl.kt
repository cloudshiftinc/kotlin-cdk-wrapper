...
public class CfnCampaignCampaignSmsMessagePropertyDsl {
    ...
    /**
     * @param messageType The SMS message type. Valid values are `TRANSACTIONAL` (for messages that
     *   are critical or time-sensitive, such as a one-time passwords) and `PROMOTIONAL` (for
    ...
    /**
     * @param originationNumber The long code to send the SMS message from. This value should be one
     *   of the dedicated long codes that's assigned to your AWS account. Although it isn't
     ...
     *   recipient's device. Support for sender IDs varies by country or region. To specify a phone
     *   number as the sender, omit this parameter and use `OriginationNumber` instead. For more
     *   information about support for Sender ID by country, see the
