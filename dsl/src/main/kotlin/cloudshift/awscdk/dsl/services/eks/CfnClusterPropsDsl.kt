...
public class CfnClusterPropsDsl {
     ...
     *   cluster on an AWS Outpost. This object isn't available for clusters on the AWS cloud.
     */
     ...
     *   Cluster tags don't propagate to any other resources associated with the cluster.
     *
    ...
    /**
     * @param version The desired Kubernetes version for your cluster. If you don't specify a value
