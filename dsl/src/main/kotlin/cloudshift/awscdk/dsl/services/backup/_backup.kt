...
public object backup {
    ...
    public inline fun backupPlanCopyActionProps(block: BackupPlanCopyActionPropsDsl.() -> Unit = {}): BackupPlanCopyActionProps {
    ...
    public inline fun backupPlanRuleProps(block: BackupPlanRulePropsDsl.() -> Unit = {}): BackupPlanRuleProps {
    ...
    public inline fun backupSelectionOptions(block: BackupSelectionOptionsDsl.() -> Unit = {}): BackupSelectionOptions {
        val builder = BackupSelectionOptionsDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun backupSelectionProps(block: BackupSelectionPropsDsl.() -> Unit = {}): BackupSelectionProps {
    ...
    public inline fun cfnBackupPlanProps(block: CfnBackupPlanPropsDsl.() -> Unit = {}): CfnBackupPlanProps {
    ...
    public inline fun cfnBackupSelectionProps(block: CfnBackupSelectionPropsDsl.() -> Unit = {}): CfnBackupSelectionProps {
    ...
    public inline fun cfnBackupVaultProps(block: CfnBackupVaultPropsDsl.() -> Unit = {}): CfnBackupVaultProps {
    ...
    public inline fun cfnFrameworkProps(block: CfnFrameworkPropsDsl.() -> Unit = {}): CfnFrameworkProps {
    ...
    public inline fun cfnReportPlanProps(block: CfnReportPlanPropsDsl.() -> Unit = {}): CfnReportPlanProps {
    ...
    public inline fun lockConfiguration(block: LockConfigurationDsl.() -> Unit = {}): LockConfiguration {
