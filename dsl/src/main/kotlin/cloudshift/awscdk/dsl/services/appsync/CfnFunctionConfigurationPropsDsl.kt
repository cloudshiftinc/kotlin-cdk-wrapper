...
public class CfnFunctionConfigurationPropsDsl {
    ...
    /**
     * @param code The `resolver` code that contains the request and response functions. When code
    ...
    /**
     * @param functionVersion The version of the request mapping template. Currently, only the
    ...
    /**
     * @param requestMappingTemplate The `Function` request mapping template. Functions support only
     ...
     *   Amazon S3 bucket. Use this if you want to provision with a template file in Amazon S3
    ...
    /**
     * @param syncConfig Describes a Sync configuration for a resolver. Specifies which Conflict
