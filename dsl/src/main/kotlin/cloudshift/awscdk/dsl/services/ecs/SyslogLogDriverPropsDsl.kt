...
public class SyslogLogDriverPropsDsl {
    ...
    /**
     * @param address The address of an external syslog server. The URI specifier may be
    ...
    /**
     * @param facility The syslog facility to use. Can be the number or name for any valid syslog
     *   facility. See the syslog documentation: https://tools.ietf.org/html/rfc5424#section-6.2.1.
     */
    ...
    /**
     * @param format The syslog message format to use. If not specified the local UNIX syslog format
     *   is used, without a specified hostname. Specify rfc3164 for the RFC-3164 compatible format,
     *   rfc5424 for RFC-5424 compatible format, or rfc5424micro for RFC-5424 compatible format with
    ...
    /**
     * @param tlsCaCert The absolute path to the trust certificates signed by the CA. Ignored if the
     *   address protocol is not tcp+tls.
     */
    ...
    /**
     * @param tlsCert The absolute path to the TLS certificate file. Ignored if the address protocol
     *   is not tcp+tls.
     */
    ...
    /**
     * @param tlsKey The absolute path to the TLS key file. Ignored if the address protocol is not
     *   tcp+tls.
     */
     ...
     *   syslog daemon. Ignored if the address protocol is not tcp+tls.
     */
