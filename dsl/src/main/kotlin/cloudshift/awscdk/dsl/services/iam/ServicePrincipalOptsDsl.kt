...
public class ServicePrincipalOptsDsl {
    ...
    /**
     * @param region The region in which you want to reference the service. This is only necessary
     *   for *cross-region* references to *opt-in* regions. In those cases, the region name needs to
     *   be included to reference the correct service principal. In all other cases, the global
     *   service principal name is sufficient.
     *
