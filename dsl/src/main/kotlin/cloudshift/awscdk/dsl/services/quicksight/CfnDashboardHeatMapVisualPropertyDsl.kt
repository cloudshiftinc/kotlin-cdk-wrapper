...
@CdkDslMarker
public class CfnDashboardHeatMapVisualPropertyDsl {
    private val cdkBuilder: CfnDashboard.HeatMapVisualProperty.Builder =
    ...
    public fun chartConfiguration(chartConfiguration: CfnDashboard.HeatMapConfigurationProperty) {
        cdkBuilder.chartConfiguration(chartConfiguration)
    }
    ...
    public fun build(): CfnDashboard.HeatMapVisualProperty {
