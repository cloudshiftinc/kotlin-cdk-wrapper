...
public class CfnJobDefinitionLogConfigurationPropertyDsl {
    ...
    /**
     * @param logDriver The log driver to use for the container. The valid values that are listed
     *   for this parameter are log drivers that the Amazon ECS container agent can communicate with
     *   by default.
     *
