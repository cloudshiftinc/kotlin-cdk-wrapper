...
public class RepositoryPropsDsl {
    ...
    /**
     * @param description A description of the repository. Use the description to identify the
    ...
    /**
     * @param repositoryName Name of the repository. This property is required for all CodeCommit
     *   repositories.
     */
