...
public class CfnIdentityPoolRoleAttachmentMappingRulePropertyDsl {
    ...
    /**
     * @param claim The claim name that must be present in the token. For example: "isAdmin" or
     *   "paid".
     */
     ...
     *   token must match `Value` . Valid values are: `Equals` , `Contains` , `StartsWith` , and
     *   `NotEqual` .
     */
