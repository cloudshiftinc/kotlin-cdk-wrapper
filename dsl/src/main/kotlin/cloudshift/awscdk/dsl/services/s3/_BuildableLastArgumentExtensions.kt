...
public inline fun CfnBucket.setBucketEncryption(block: CfnBucketBucketEncryptionPropertyDsl.() -> Unit = {}) {
...
public inline fun IBucket.addToResourcePolicy(block: PolicyStatementDsl.() -> Unit = {}): AddToResourcePolicyResult {
...
public inline fun BucketBase.addToResourcePolicy(block: PolicyStatementDsl.() -> Unit = {}): AddToResourcePolicyResult {
    val builder = PolicyStatementDsl()
    builder.apply(block)
    return addToResourcePolicy(builder.build())
}
