...
public class CfnEndpointConfigDataCaptureConfigPropertyDsl {
    ...
    public fun captureContentTypeHeader(
        captureContentTypeHeader: CfnEndpointConfig.CaptureContentTypeHeaderProperty
    ) {
        cdkBuilder.captureContentTypeHeader(captureContentTypeHeader)
    }
     ...
     *   encrypt the captured data at rest using Amazon S3 server-side encryption. The KmsKeyId can
     *   be any of the following formats: Key ID: 1234abcd-12ab-34cd-56ef-1234567890ab Key ARN:
