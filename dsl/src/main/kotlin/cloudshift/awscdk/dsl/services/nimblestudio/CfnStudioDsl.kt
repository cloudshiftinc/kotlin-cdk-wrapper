 ...
 * AmazonNimbleStudio-StudioUser managed policy attached for the portal to function properly. The
 * Admin Role must have the AmazonNimbleStudio-StudioAdmin managed policy attached for the portal to
 * function properly.
 *
 ...
 * your own AWS Key Management Service key when calling CreateStudio to encrypt this data using a
 * key that you own and manage. When providing an AWS Key Management Service key during studio
 * creation, creates AWS Key Management Service grants in your account to provide your studio user
 * and admin roles access to these AWS Key Management Service keys. If you delete this grant, the
 * studio will no longer be accessible to your portal users. If you delete the studio AWS Key
 * Management Service key, your studio will no longer be accessible.
 *
 * Example:
 * ```
