...
public class CfnClusterBrokerNodeGroupInfoPropertyDsl {
   ...
   * (VPC). 
   * Amazon creates elastic network interfaces inside these subnets. Client applications use elastic
   * network interfaces to produce and consume data.
   *
   ...
   * kafka.m5.4xlarge, kafka.m5.8xlarge, kafka.m5.12xlarge, kafka.m5.16xlarge, and kafka.m5.24xlarge,
   * and kafka.t3.small.
   */
