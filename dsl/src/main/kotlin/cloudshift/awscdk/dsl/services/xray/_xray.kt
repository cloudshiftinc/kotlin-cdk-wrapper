...
public object xray {
     ...
     *
     * Groups enable the collection of traces that match the filter expression, can be used to
     * filter service graphs and traces, and to supply Amazon CloudWatch metrics.
     *
     * Example:
     * ```
     ...
     */
    public inline fun cfnGroupInsightsConfigurationProperty(
        block: CfnGroupInsightsConfigurationPropertyDsl.() -> Unit = {}
    ...
    /**
     * Use `AWS::XRay::ResourcePolicy` to specify an X-Ray resource-based policy, which grants one
     * or more AWS services and accounts permissions to access X-Ray .
     *
    ...
    /**
     * Use the `AWS::XRay::SamplingRule` resource to specify a sampling rule, which controls
     * sampling behavior for instrumented applications.
     *
     ...
     * service reports back to X-Ray with
     * [GetSamplingTargets](https://docs.aws.amazon.com//xray/latest/api/API_GetSamplingTargets.html)
     * to get updated versions of each in-use rule. The updated rule contains a trace quota that the
     ...
     * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-xray-samplingrule.html)
     */
    public inline fun cfnSamplingRuleProps(
        block: CfnSamplingRulePropsDsl.() -> Unit = {}
     ...
     */
    public inline fun cfnSamplingRuleSamplingRuleProperty(
        block: CfnSamplingRuleSamplingRulePropertyDsl.() -> Unit = {}
     ...
     */
    public inline fun cfnSamplingRuleSamplingRuleRecordProperty(
        block: CfnSamplingRuleSamplingRuleRecordPropertyDsl.() -> Unit = {}
     ...
     */
    public inline fun cfnSamplingRuleSamplingRuleUpdateProperty(
        block: CfnSamplingRuleSamplingRuleUpdatePropertyDsl.() -> Unit = {}
