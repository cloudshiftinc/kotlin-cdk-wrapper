...
public class CfnStagePropsDsl {
    ...
    /**
     * @param clientCertificateId The identifier of a client certificate for a `Stage` . Supported
    ...
    /**
     * @param stageName The stage name. Stage names can contain only alphanumeric characters,
