...
public class CfnRecordSetGroupAliasTargetPropertyDsl {
     ...
     *   `EvaluateTargetHealth` is `true` , an alias record inherits the health of the referenced
     *   AWS resource, such as an ELB load balancer or another record in the hosted zone. Note the
     *   following:
