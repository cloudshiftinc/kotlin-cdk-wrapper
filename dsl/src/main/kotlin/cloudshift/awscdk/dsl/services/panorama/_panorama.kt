...
public object panorama {
     ...
     */
    public inline fun cfnApplicationInstanceManifestOverridesPayloadProperty(
     ...
     *
     * This is a JSON document that has a single key ( `PayloadData` ) where the value is an escaped
     * string representation of the application manifest ( `graph.json` ). This file is located in
     * the `graphs` folder in your application source.
     *
     * Example:
     * ```
     * // The code below shows an example of how to instantiate this type.
     ...
     */
    public inline fun cfnApplicationInstanceManifestPayloadProperty(
     ...
     * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-panorama-applicationinstance.html)
     */
    public inline fun cfnApplicationInstanceProps(
        block: CfnApplicationInstancePropsDsl.() -> Unit = {}
     ...
     */
    public inline fun cfnPackageStorageLocationProperty(
     ...
     * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-panorama-packageversion.html)
     */
    public inline fun cfnPackageVersionProps(
        block: CfnPackageVersionPropsDsl.() -> Unit = {}
