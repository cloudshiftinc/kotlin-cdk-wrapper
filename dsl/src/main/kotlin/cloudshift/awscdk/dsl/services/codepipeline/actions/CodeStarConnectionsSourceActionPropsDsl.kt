...
public class CodeStarConnectionsSourceActionPropsDsl {
    ...
    /**
     * @param output The output artifact that this action produces. Can be used as input for further
     *   pipeline actions.
     */
     ...
     *   on the configured repository and branch. If unspecified, the default value is true, and the
     *   field does not display by default.
     */
