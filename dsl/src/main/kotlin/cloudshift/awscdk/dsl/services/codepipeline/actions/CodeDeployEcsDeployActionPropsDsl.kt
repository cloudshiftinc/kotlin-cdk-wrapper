...
public class CodeDeployEcsDeployActionPropsDsl {
    ...
    private val _containerImageInputs: MutableList<CodeDeployEcsContainerImageInput> =
        mutableListOf()
    ...
    /**
     * @param appSpecTemplateFile The name of the CodeDeploy AppSpec file. During deployment, a new
     *   task definition will be registered with ECS, and the new task definition ID will be
     *   inserted into the CodeDeploy AppSpec file. The AppSpec file contents will be provided to
     *   CodeDeploy for the deployment.
     *
     * Use this property if you want to use a different name for this file than the default
     * 'appspec.yaml'. If you use this property, you don't need to specify the
     * `appSpecTemplateInput` property.
     */
    ...
    /**
     * @param appSpecTemplateInput The artifact containing the CodeDeploy AppSpec file. During
     *   deployment, a new task definition will be registered with ECS, and the new task definition
     *   ID will be inserted into the CodeDeploy AppSpec file. The AppSpec file contents will be
     *   provided to CodeDeploy for the deployment.
     *
     * If you use this property, it's assumed the file is called 'appspec.yaml'. If your AppSpec
     * file uses a different filename, leave this property empty, and use the `appSpecTemplateFile`
     * property instead.
     */
     ...
     *   definition. Provide pairs of an image details input artifact and a placeholder string that
     *   will be used to dynamically update the ECS task definition template file prior to
     *   deployment. A maximum of 4 images can be given.
     */
    public fun containerImageInputs(
        containerImageInputs: CodeDeployEcsContainerImageInputDsl.() -> Unit
    ) {
        _containerImageInputs.add(
            CodeDeployEcsContainerImageInputDsl().apply(containerImageInputs).build()
        )
    }
     ...
     */
    public fun containerImageInputs(
        containerImageInputs: Collection<CodeDeployEcsContainerImageInput>
    ) {
    ...
    /**
     * @param taskDefinitionTemplateFile The name of the ECS task definition template file. During
     *   deployment, the task definition template file contents will be registered with ECS.
     *
     * Use this property if you want to use a different name for this file than the default
     * 'taskdef.json'. If you use this property, you don't need to specify the
     * `taskDefinitionTemplateInput` property.
     */
     ...
     *   file. During deployment, the task definition template file contents will be registered with
     *   ECS.
     *
     * If you use this property, it's assumed the file is called 'taskdef.json'. If your task
     * definition template uses a different filename, leave this property empty, and use the
     * `taskDefinitionTemplateFile` property instead.
     */
    ...
    public fun build(): CodeDeployEcsDeployActionProps {
        if (_containerImageInputs.isNotEmpty())
            cdkBuilder.containerImageInputs(_containerImageInputs)
