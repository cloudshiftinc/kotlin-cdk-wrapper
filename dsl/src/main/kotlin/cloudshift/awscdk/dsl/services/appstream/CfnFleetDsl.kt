...
public class CfnFleetDsl(
   ...
   * @param maxUserDurationInSeconds The maximum amount of time that a streaming session can remain
   * active, in seconds. 
   */
   ...
   * @param streamView The AppStream 2.0 view that is displayed to your users when they stream from
   * the fleet. When `APP` is specified, only the windows of applications opened by users display. When
