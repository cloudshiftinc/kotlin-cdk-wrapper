...
public class CfnAppPropsDsl {
    ...
    /**
     * @param accessToken The personal access token for a GitHub repository for an Amplify app. The
    ...
    /**
     * @param basicAuthConfig The credentials for basic authorization for an Amplify app. You must
    ...
    /**
     * @param buildSpec The build specification (build spec) for an Amplify app. *Length
    ...
    /**
     * @param customHeaders The custom HTTP headers for an Amplify app. *Length Constraints:*
     *   Minimum length of 0. Maximum length of 25000.
     *
     * *Pattern:* (?s).*
     */
    ...
    /**
     * @param description The description for an Amplify app. *Length Constraints:* Maximum length
     *   of 1000.
     *
     * *Pattern:* (?s).*
     */
    ...
    /**
     * @param environmentVariables The environment variables map for an Amplify app. For a list of
     *   the environment variables that are accessible to Amplify by default, see
     ...
     *   Amazon Resource Name (ARN) of the Amplify app. *Length Constraints:* Minimum length of 0.
    ...
    /**
     * @param name The name for an Amplify app. *Length Constraints:* Minimum length of 1. Maximum
     *   length of 255.
     *
     * *Pattern:* (?s).+
     */
    ...
    /**
     * @param platform The platform for the Amplify app. For a static app, set the platform type to
