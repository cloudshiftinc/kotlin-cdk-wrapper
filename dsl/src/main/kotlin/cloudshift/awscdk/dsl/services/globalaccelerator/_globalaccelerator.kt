...
public object globalaccelerator {
  ...
  public inline fun acceleratorAttributes(block: AcceleratorAttributesDsl.() -> Unit = {}):
  ...
  public inline fun cfnAcceleratorProps(block: CfnAcceleratorPropsDsl.() -> Unit = {}):
      CfnAcceleratorProps {
  ...
  public inline
      fun cfnEndpointGroupEndpointConfigurationProperty(block: CfnEndpointGroupEndpointConfigurationPropertyDsl.() -> Unit
  ...
  public inline
      fun cfnEndpointGroupPortOverrideProperty(block: CfnEndpointGroupPortOverridePropertyDsl.() -> Unit
  ...
  public inline fun cfnEndpointGroupProps(block: CfnEndpointGroupPropsDsl.() -> Unit = {}):
  ...
  public inline fun cfnListenerPortRangeProperty(block: CfnListenerPortRangePropertyDsl.() -> Unit =
  ...
  public inline fun endpointGroupOptions(block: EndpointGroupOptionsDsl.() -> Unit = {}):
  ...
  public inline fun endpointGroupProps(block: EndpointGroupPropsDsl.() -> Unit = {}):
      EndpointGroupProps {
