...
public class CfnDataSourceSharePointConfigurationPropertyDsl {
  ...
  /**
   * @param documentTitleFieldName The Microsoft SharePoint attribute field that contains the title
   * of the document.
   */
   ...
   * [UpdateIndex](https://docs.aws.amazon.com/kendra/latest/dg/API_UpdateIndex.html) operation before
   * you map SharePoint attributes. For more information, see [Mapping Data Source
