...
public object opensearchserverless {
    ...
    public inline fun cfnAccessPolicyProps(block: CfnAccessPolicyPropsDsl.() -> Unit = {}): CfnAccessPolicyProps {
    ...
    public inline fun cfnCollectionProps(block: CfnCollectionPropsDsl.() -> Unit = {}): CfnCollectionProps {
    ...
    public inline fun cfnSecurityConfigProps(block: CfnSecurityConfigPropsDsl.() -> Unit = {}): CfnSecurityConfigProps {
    ...
    public inline fun cfnSecurityPolicyProps(block: CfnSecurityPolicyPropsDsl.() -> Unit = {}): CfnSecurityPolicyProps {
