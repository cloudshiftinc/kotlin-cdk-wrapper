...
public class CfnUserPoolGroupDsl(
     ...
     * over groups with higher or null `Precedence` values. If a user belongs to two or more groups,
     * it is the group with the lowest precedence value whose role ARN is given in the user's tokens
