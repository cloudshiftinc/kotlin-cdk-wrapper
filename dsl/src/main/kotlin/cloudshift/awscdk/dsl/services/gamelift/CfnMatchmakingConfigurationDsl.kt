...
public class CfnMatchmakingConfigurationDsl(
   ...
   * @param acceptanceTimeoutSeconds The length of time (in seconds) to wait for players to accept a
   ...
   * @param flexMatchMode Indicates whether this matchmaking configuration is being used with Amazon
