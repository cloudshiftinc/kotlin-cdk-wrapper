...
public class CfnProjectProjectFileSystemLocationPropertyDsl {
   ...
   * CodeBuild creates an environment variable by appending the `identifier` in all capital letters
  ...
  /**
   * @param location A string that specifies the location of the file system created by Amazon EFS. 
