...
public inline fun CfnCoreDefinition.setInitialVersion(
...
public inline fun CfnFunctionDefinitionVersion.setDefaultConfig(
...
public inline fun CfnLoggerDefinition.setInitialVersion(
