...
public class CfnChannelEac3SettingsPropertyDsl {
     ...
     *   surround channels. Used only for the 3/2 coding mode.
     */
    ...
    /**
     * @param bitstreamMode Specifies the bitstream mode (bsmod) for the emitted E-AC-3 stream. For
     *   more information, see ATSC A/52-2012 (Annex E).
     */
    ...
    /**
     * @param codingMode The Dolby Digital Plus coding mode. This mode determines the number of
     *   channels.
     */
    ...
    /**
     * @param dialnorm Sets the dialnorm for the output. If blank and the input audio is Dolby
     ...
     *   to encoding. Valid only with a codingMode32 coding mode.
     */
    ...
    /**
     * @param loRoCenterMixLevel The Left only/Right only center mix level. Used only for the 3/2
     *   coding mode.
     */
    ...
    /**
     * @param loRoSurroundMixLevel The Left only/Right only surround mix level. Used only for a 3/2
     *   coding mode.
     */
    ...
    /**
     * @param ltRtCenterMixLevel The Left total/Right total center mix level. Used only for a 3/2
     *   coding mode.
     */
    ...
    /**
     * @param ltRtSurroundMixLevel The Left total/Right total surround mix level. Used only for the
     *   3/2 coding mode.
     */
     ...
     *   or DolbyE decoder that supplies this audio data. If the audio is not supplied from one of
     *   these streams, then the static metadata settings are used.
     */
     ...
     *   it is present on the input. This detection is dynamic over the life of the transcode.
     *   Inputs that alternate between DD+ and non-DD+ content will have a consistent DD+ output as
     *   the system alternates between passthrough and encoding.
     */
     ...
     *   surround channels. Used only for a 3/2 coding mode.
     */
    public fun phaseControl(phaseControl: String) {
        cdkBuilder.phaseControl(phaseControl)
    }

    /** @param stereoDownmix A stereo downmix preference. Used only for the 3/2 coding mode. */
