...
public class CfnVPCEndpointServicePermissionsPropsDsl {
     ...
     *   example, users, IAM roles, and AWS accounts ). Permissions are granted to the principals in
     *   this list. To grant permissions to all principals, specify an asterisk (*). Permissions are
