...
public class CfnInstanceFleetConfigSpotProvisioningSpecificationPropertyDsl {
   ...
   * 360. The duration period starts as soon as a Spot Instance receives its instance ID. At the end of
   * the duration, Amazon EC2 marks the Spot Instance for termination and provides a Spot Instance
   ...
   * that is, when all Spot Instances could not be provisioned within the Spot provisioning timeout.
   * Valid values are `TERMINATE_CLUSTER` and `SWITCH_TO_ON_DEMAND` . SWITCH_TO_ON_DEMAND specifies
