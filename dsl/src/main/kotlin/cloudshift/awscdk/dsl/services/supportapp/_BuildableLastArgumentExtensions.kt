...
public inline fun CfnAccountAlias.applyRemovalPolicy(arg0: RemovalPolicy,
...
public inline fun CfnSlackWorkspaceConfiguration.applyRemovalPolicy(arg0: RemovalPolicy,
    block: RemovalPolicyOptionsDsl.() -> Unit = {}) {
  val builder = RemovalPolicyOptionsDsl()
  builder.apply(block)
  return applyRemovalPolicy(arg0,builder.build())
