...
public class SageMakerUpdateEndpointDsl(
  ...
  private val cdkBuilder: SageMakerUpdateEndpoint.Builder =
      SageMakerUpdateEndpoint.Builder.create(scope, id)
  ...
  public fun build(): SageMakerUpdateEndpoint = cdkBuilder.build()
}
