...
public class CfnSegmentRecencyPropertyDsl {
    private val cdkBuilder: CfnSegment.RecencyProperty.Builder =
     ...
     *   with your app. Possible values: `HR_24` | `DAY_7` | `DAY_14` | `DAY_30` .
     */
    ...
    /**
     * @param recencyType The type of recency dimension to use for the segment. Valid values are:
     *   `ACTIVE` and `INACTIVE` . If the value is `ACTIVE` , the segment includes users who have
     *   used your app within the specified duration are included in the segment. If the value is
     *   `INACTIVE` , the segment includes users who haven't used your app within the specified
