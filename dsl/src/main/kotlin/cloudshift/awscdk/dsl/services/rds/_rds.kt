...
public object rds {
  public inline fun auroraClusterEngineProps(block: AuroraClusterEnginePropsDsl.() -> Unit = {}):
  ...
  public inline fun auroraMysqlClusterEngineProps(block: AuroraMysqlClusterEnginePropsDsl.() -> Unit
  ...
  public inline
      fun auroraPostgresClusterEngineProps(block: AuroraPostgresClusterEnginePropsDsl.() -> Unit =
  ...
  public inline fun auroraPostgresEngineFeatures(block: AuroraPostgresEngineFeaturesDsl.() -> Unit =
  ...
  public inline fun cfnCustomDBEngineVersionProps(block: CfnCustomDBEngineVersionPropsDsl.() -> Unit
  ...
  public inline fun cfnDBClusterEndpointProperty(block: CfnDBClusterEndpointPropertyDsl.() -> Unit =
  ...
  public inline
      fun cfnDBClusterMasterUserSecretProperty(block: CfnDBClusterMasterUserSecretPropertyDsl.() -> Unit
  ...
  public inline
      fun cfnDBClusterReadEndpointProperty(block: CfnDBClusterReadEndpointPropertyDsl.() -> Unit =
  ...
  public inline
      fun cfnDBClusterScalingConfigurationProperty(block: CfnDBClusterScalingConfigurationPropertyDsl.() -> Unit
  ...
  public inline
      fun cfnDBClusterServerlessV2ScalingConfigurationProperty(block: CfnDBClusterServerlessV2ScalingConfigurationPropertyDsl.() -> Unit
  ...
  public inline
      fun cfnDBInstanceCertificateDetailsProperty(block: CfnDBInstanceCertificateDetailsPropertyDsl.() -> Unit
  ...
  public inline
      fun cfnDBInstanceDBInstanceRoleProperty(block: CfnDBInstanceDBInstanceRolePropertyDsl.() -> Unit
  ...
  public inline fun cfnDBInstanceEndpointProperty(block: CfnDBInstanceEndpointPropertyDsl.() -> Unit
  ...
  public inline
      fun cfnDBInstanceMasterUserSecretProperty(block: CfnDBInstanceMasterUserSecretPropertyDsl.() -> Unit
  ...
  public inline
      fun cfnDBInstanceProcessorFeatureProperty(block: CfnDBInstanceProcessorFeaturePropertyDsl.() -> Unit
  ...
  public inline fun cfnDBProxyAuthFormatProperty(block: CfnDBProxyAuthFormatPropertyDsl.() -> Unit =
  ...
  public inline fun cfnDBProxyEndpointProps(block: CfnDBProxyEndpointPropsDsl.() -> Unit = {}):
  ...
  public inline
      fun cfnDBProxyEndpointTagFormatProperty(block: CfnDBProxyEndpointTagFormatPropertyDsl.() -> Unit
  ...
  public inline fun cfnDBProxyTagFormatProperty(block: CfnDBProxyTagFormatPropertyDsl.() -> Unit =
  ...
  public inline
      fun cfnDBProxyTargetGroupConnectionPoolConfigurationInfoFormatProperty(block: CfnDBProxyTargetGroupConnectionPoolConfigurationInfoFormatPropertyDsl.() -> Unit
  ...
  public inline fun cfnDBProxyTargetGroupProps(block: CfnDBProxyTargetGroupPropsDsl.() -> Unit =
  ...
  public inline
      fun cfnDBSecurityGroupIngressProperty(block: CfnDBSecurityGroupIngressPropertyDsl.() -> Unit =
  ...
  public inline
      fun cfnDBSecurityGroupIngressProps(block: CfnDBSecurityGroupIngressPropsDsl.() -> Unit = {}):
  ...
  public inline fun cfnDBSecurityGroupProps(block: CfnDBSecurityGroupPropsDsl.() -> Unit = {}):
  ...
  public inline fun cfnGlobalClusterProps(block: CfnGlobalClusterPropsDsl.() -> Unit = {}):
  ...
  public inline
      fun cfnOptionGroupOptionConfigurationProperty(block: CfnOptionGroupOptionConfigurationPropertyDsl.() -> Unit
  ...
  public inline
      fun cfnOptionGroupOptionSettingProperty(block: CfnOptionGroupOptionSettingPropertyDsl.() -> Unit
  ...
  public inline fun cfnOptionGroupProps(block: CfnOptionGroupPropsDsl.() -> Unit = {}):
      CfnOptionGroupProps {
  ...
  public inline fun clusterEngineBindOptions(block: ClusterEngineBindOptionsDsl.() -> Unit = {}):
  ...
  public inline fun clusterEngineConfig(block: ClusterEngineConfigDsl.() -> Unit = {}):
      ClusterEngineConfig {
  ...
  public inline fun clusterEngineFeatures(block: ClusterEngineFeaturesDsl.() -> Unit = {}):
  ...
  public inline fun clusterInstanceBindOptions(block: ClusterInstanceBindOptionsDsl.() -> Unit =
  ...
  public inline fun clusterInstanceOptions(block: ClusterInstanceOptionsDsl.() -> Unit = {}):
  ...
  public inline fun clusterInstanceProps(block: ClusterInstancePropsDsl.() -> Unit = {}):
  ...
  public inline fun commonRotationUserOptions(block: CommonRotationUserOptionsDsl.() -> Unit = {}):
  ...
  public inline fun credentialsBaseOptions(block: CredentialsBaseOptionsDsl.() -> Unit = {}):
  ...
  public inline
      fun credentialsFromUsernameOptions(block: CredentialsFromUsernameOptionsDsl.() -> Unit = {}):
  ...
  public inline
      fun databaseClusterFromSnapshotProps(block: DatabaseClusterFromSnapshotPropsDsl.() -> Unit =
  ...
  public inline
      fun databaseInstanceFromSnapshotProps(block: DatabaseInstanceFromSnapshotPropsDsl.() -> Unit =
  ...
  public inline fun databaseInstanceNewProps(block: DatabaseInstanceNewPropsDsl.() -> Unit = {}):
  ...
  public inline
      fun databaseInstanceReadReplicaProps(block: DatabaseInstanceReadReplicaPropsDsl.() -> Unit =
  ...
  public inline fun databaseInstanceSourceProps(block: DatabaseInstanceSourcePropsDsl.() -> Unit =
  ...
  public inline fun databaseProxyAttributes(block: DatabaseProxyAttributesDsl.() -> Unit = {}):
  ...
  public inline fun databaseProxyOptions(block: DatabaseProxyOptionsDsl.() -> Unit = {}):
  ...
  public inline fun databaseProxyProps(block: DatabaseProxyPropsDsl.() -> Unit = {}):
      DatabaseProxyProps {
  ...
  public inline fun instanceEngineBindOptions(block: InstanceEngineBindOptionsDsl.() -> Unit = {}):
  ...
  public inline fun instanceEngineConfig(block: InstanceEngineConfigDsl.() -> Unit = {}):
  ...
  public inline fun instanceEngineFeatures(block: InstanceEngineFeaturesDsl.() -> Unit = {}):
  ...
  public inline fun mariaDbInstanceEngineProps(block: MariaDbInstanceEnginePropsDsl.() -> Unit =
  ...
  public inline fun mySqlInstanceEngineProps(block: MySqlInstanceEnginePropsDsl.() -> Unit = {}):
  ...
  public inline fun optionConfiguration(block: OptionConfigurationDsl.() -> Unit = {}):
      OptionConfiguration {
  ...
  public inline
      fun oracleEeCdbInstanceEngineProps(block: OracleEeCdbInstanceEnginePropsDsl.() -> Unit = {}):
  ...
  public inline fun oracleEeInstanceEngineProps(block: OracleEeInstanceEnginePropsDsl.() -> Unit =
  ...
  public inline
      fun oracleSe2CdbInstanceEngineProps(block: OracleSe2CdbInstanceEnginePropsDsl.() -> Unit =
  ...
  public inline fun oracleSe2InstanceEngineProps(block: OracleSe2InstanceEnginePropsDsl.() -> Unit =
  ...
  public inline
      fun parameterGroupClusterBindOptions(block: ParameterGroupClusterBindOptionsDsl.() -> Unit =
  ...
  public inline fun parameterGroupClusterConfig(block: ParameterGroupClusterConfigDsl.() -> Unit =
  ...
  public inline
      fun parameterGroupInstanceBindOptions(block: ParameterGroupInstanceBindOptionsDsl.() -> Unit =
  ...
  public inline fun parameterGroupInstanceConfig(block: ParameterGroupInstanceConfigDsl.() -> Unit =
  ...
  public inline fun parameterGroupProps(block: ParameterGroupPropsDsl.() -> Unit = {}):
      ParameterGroupProps {
  ...
  public inline fun postgresEngineFeatures(block: PostgresEngineFeaturesDsl.() -> Unit = {}):
  ...
  public inline fun postgresInstanceEngineProps(block: PostgresInstanceEnginePropsDsl.() -> Unit =
  ...
  public inline fun processorFeatures(block: ProcessorFeaturesDsl.() -> Unit = {}):
      ProcessorFeatures {
  ...
  public inline
      fun provisionedClusterInstanceProps(block: ProvisionedClusterInstancePropsDsl.() -> Unit =
  ...
  public inline fun proxyTargetConfig(block: ProxyTargetConfigDsl.() -> Unit = {}):
      ProxyTargetConfig {
  ...
  public inline fun rotationSingleUserOptions(block: RotationSingleUserOptionsDsl.() -> Unit = {}):
  ...
  public inline fun serverlessClusterAttributes(block: ServerlessClusterAttributesDsl.() -> Unit =
  ...
  public inline
      fun serverlessClusterFromSnapshotProps(block: ServerlessClusterFromSnapshotPropsDsl.() -> Unit
  ...
  public inline fun serverlessClusterProps(block: ServerlessClusterPropsDsl.() -> Unit = {}):
  ...
  public inline fun serverlessScalingOptions(block: ServerlessScalingOptionsDsl.() -> Unit = {}):
  ...
  public inline
      fun serverlessV2ClusterInstanceProps(block: ServerlessV2ClusterInstancePropsDsl.() -> Unit =
  ...
  public inline
      fun snapshotCredentialsFromGeneratedPasswordOptions(block: SnapshotCredentialsFromGeneratedPasswordOptionsDsl.() -> Unit
  ...
  public inline
      fun sqlServerEeInstanceEngineProps(block: SqlServerEeInstanceEnginePropsDsl.() -> Unit = {}):
  ...
  public inline
      fun sqlServerExInstanceEngineProps(block: SqlServerExInstanceEnginePropsDsl.() -> Unit = {}):
  ...
  public inline
      fun sqlServerSeInstanceEngineProps(block: SqlServerSeInstanceEnginePropsDsl.() -> Unit = {}):
  ...
  public inline
      fun sqlServerWebInstanceEngineProps(block: SqlServerWebInstanceEnginePropsDsl.() -> Unit =
