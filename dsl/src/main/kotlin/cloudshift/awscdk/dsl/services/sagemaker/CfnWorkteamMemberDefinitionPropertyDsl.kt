...
public class CfnWorkteamMemberDefinitionPropertyDsl {
    ...
    public fun cognitoMemberDefinition(
        cognitoMemberDefinition: CfnWorkteam.CognitoMemberDefinitionProperty
    ) {
        cdkBuilder.cognitoMemberDefinition(cognitoMemberDefinition)
    }
     ...
     *   (IdP). One to ten groups can be used to create a single private work team. When you add a
     *   user group to the list of `Groups` , you can add that user group to one or more private
     *   work teams. If you add a user group to a private work team, all workers in that user group
    ...
    public fun oidcMemberDefinition(
        oidcMemberDefinition: CfnWorkteam.OidcMemberDefinitionProperty
    ) {
        cdkBuilder.oidcMemberDefinition(oidcMemberDefinition)
    }
