...
public class CfnVirtualGatewayVirtualGatewayListenerTlsPropertyDsl {
    ...
    public fun certificate(certificate: CfnVirtualGateway.VirtualGatewayListenerTlsCertificateProperty) {
        cdkBuilder.certificate(certificate)
    }
    ...
    public fun validation(validation: CfnVirtualGateway.VirtualGatewayListenerTlsValidationContextProperty) {
        cdkBuilder.validation(validation)
    }
