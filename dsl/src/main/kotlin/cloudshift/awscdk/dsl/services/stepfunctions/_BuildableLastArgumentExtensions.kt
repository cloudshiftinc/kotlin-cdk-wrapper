...
public inline fun Activity.metric(arg0: String, block: MetricOptionsDsl.() -> Unit = {}): Metric {
...
public inline fun CfnActivity.applyRemovalPolicy(arg0: RemovalPolicy,
...
public inline fun CfnStateMachineAlias.applyRemovalPolicy(arg0: RemovalPolicy,
    block: RemovalPolicyOptionsDsl.() -> Unit = {}) {
  val builder = RemovalPolicyOptionsDsl()
  builder.apply(block)
  return applyRemovalPolicy(arg0,builder.build())
...
public inline fun CfnStateMachineVersion.applyRemovalPolicy(arg0: RemovalPolicy,
    block: RemovalPolicyOptionsDsl.() -> Unit = {}) {
  val builder = RemovalPolicyOptionsDsl()
  builder.apply(block)
  return applyRemovalPolicy(arg0,builder.build())
...
public inline fun Chain.toSingleState(arg0: String, block: ParallelPropsDsl.() -> Unit = {}):
    Parallel {
  val builder = ParallelPropsDsl()
  builder.apply(block)
  return toSingleState(arg0,builder.build())
}
...
public inline fun Map.addCatch(arg0: IChainable, block: CatchPropsDsl.() -> Unit = {}): Map {
...
public inline fun Parallel.addCatch(arg0: IChainable, block: CatchPropsDsl.() -> Unit = {}):
    Parallel {
  val builder = CatchPropsDsl()
  builder.apply(block)
  return addCatch(arg0,builder.build())
...
public inline fun StateMachine.metric(arg0: String, block: MetricOptionsDsl.() -> Unit = {}):
    Metric {
  val builder = MetricOptionsDsl()
  builder.apply(block)
  return metric(arg0,builder.build())
