...
public inline fun Chain.toSingleState(id: String, block: ParallelPropsDsl.() -> Unit = {}): Parallel {
...
public inline fun Activity.metric(metricName: String, block: MetricOptionsDsl.() -> Unit = {}): Metric {
...
public inline fun Activity.metricHeartbeatTimedOut(block: MetricOptionsDsl.() -> Unit = {}): Metric {
    val builder = MetricOptionsDsl()
    builder.apply(block)
...
public inline fun StateMachineFragment.toSingleState(block: SingleStateOptionsDsl.() -> Unit = {}): Parallel {
    val builder = SingleStateOptionsDsl()
    builder.apply(block)
    return toSingleState(builder.build())
}

public inline fun IStateMachine.metric(arg0: String, block: MetricOptionsDsl.() -> Unit = {}): Metric {
    val builder = MetricOptionsDsl()
    builder.apply(block)
...
public inline fun StateMachine.metric(metricName: String, block: MetricOptionsDsl.() -> Unit = {}): Metric {
    val builder = MetricOptionsDsl()
    builder.apply(block)
    return metric(metricName, builder.build())
}
...
public inline fun Parallel.addCatch(handler: IChainable, block: CatchPropsDsl.() -> Unit = {}): Parallel {
...
public inline fun TaskStateBase.addCatch(handler: IChainable, block: CatchPropsDsl.() -> Unit = {}): TaskStateBase {
    val builder = CatchPropsDsl()
    builder.apply(block)
    return addCatch(handler, builder.build())
}
...
public inline fun TaskStateBase.metric(metricName: String, block: MetricOptionsDsl.() -> Unit = {}): Metric {
    val builder = MetricOptionsDsl()
    builder.apply(block)
    return metric(metricName, builder.build())
}
...
public inline fun TaskStateBase.metricHeartbeatTimedOut(block: MetricOptionsDsl.() -> Unit = {}): Metric {
    val builder = MetricOptionsDsl()
    builder.apply(block)
    return metricHeartbeatTimedOut(builder.build())
}
...
public inline fun TaskStateBase.metricScheduleTime(block: MetricOptionsDsl.() -> Unit = {}): Metric {
    val builder = MetricOptionsDsl()
    builder.apply(block)
    return metricScheduleTime(builder.build())
}
