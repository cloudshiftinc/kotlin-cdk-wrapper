...
@CdkDslMarker
public class CfnTemplateRadarChartSortConfigurationPropertyDsl {
  private val cdkBuilder: CfnTemplate.RadarChartSortConfigurationProperty.Builder =
  ...
  public fun build(): CfnTemplate.RadarChartSortConfigurationProperty {
