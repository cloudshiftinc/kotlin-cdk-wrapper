...
public class EmrCreateClusterEbsConfigurationPropertyDsl {
    ...
    public fun ebsBlockDeviceConfigs(ebsBlockDeviceConfigs: EmrCreateClusterEbsBlockDeviceConfigPropertyDsl.() -> Unit) {
        _ebsBlockDeviceConfigs.add(EmrCreateClusterEbsBlockDeviceConfigPropertyDsl().apply(ebsBlockDeviceConfigs).build())
    }

    public fun ebsBlockDeviceConfigs(ebsBlockDeviceConfigs: Collection<EmrCreateCluster.EbsBlockDeviceConfigProperty>) {
