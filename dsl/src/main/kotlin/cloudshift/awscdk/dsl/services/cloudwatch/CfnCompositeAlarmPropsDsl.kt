...
public class CfnCompositeAlarmPropsDsl {
     ...
     *   state. `ActionsSuppressor` can be an AlarmName or an Amazon Resource Name (ARN) from an
     *   existing alarm.
     */
     ...
     *   waits after suppressor alarm goes out of the `ALARM` state. After this time, the composite
     ...
     *   for the suppressor alarm to go into the `ALARM` state. After this time, the composite alarm
     ...
     *   from any other state. Each action is specified as an Amazon Resource Name (ARN). For more
    ...
    /**
     * @param alarmName The name for the composite alarm. This name must be unique within your AWS
     *   account.
     */
     ...
     *   Resource Name (ARN). For more information about creating alarms and the actions that you
     *   can specify, see
     *   [PutCompositeAlarm](https://docs.aws.amazon.com/AmazonCloudWatch/latest/APIReference/API_PutCompositeAlarm.html)
     *   in the *Amazon CloudWatch API Reference* .
     */
     ...
     *   other state. Each action is specified as an Amazon Resource Name (ARN). For more
     *   information about creating alarms and the actions that you can specify, see
     *   [PutCompositeAlarm](https://docs.aws.amazon.com/AmazonCloudWatch/latest/APIReference/API_PutCompositeAlarm.html)
     *   in the *Amazon CloudWatch API Reference* .
     */
