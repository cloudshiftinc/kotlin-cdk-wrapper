...
public class CfnChannelOutputGroupPropertyDsl {
    ...
    /**
     * @param name A custom output group name that you can optionally define. Only letters, numbers,
     *   and the underscore character are allowed. The maximum length is 32 characters.
     */
