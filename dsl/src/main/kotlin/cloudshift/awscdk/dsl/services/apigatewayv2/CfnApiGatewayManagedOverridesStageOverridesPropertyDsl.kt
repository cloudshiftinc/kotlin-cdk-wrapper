...
public class CfnApiGatewayManagedOverridesStageOverridesPropertyDsl {
    ...
    public fun accessLogSettings(accessLogSettings: CfnApiGatewayManagedOverrides.AccessLogSettingsProperty) {
        cdkBuilder.accessLogSettings(accessLogSettings)
    }
    ...
    public fun defaultRouteSettings(defaultRouteSettings: CfnApiGatewayManagedOverrides.RouteSettingsProperty) {
        cdkBuilder.defaultRouteSettings(defaultRouteSettings)
    }
