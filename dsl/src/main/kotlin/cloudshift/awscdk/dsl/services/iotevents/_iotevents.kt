...
public object iotevents {
     ...
     */
    public inline fun cfnAlarmModelAcknowledgeFlowProperty(
        block: CfnAlarmModelAcknowledgeFlowPropertyDsl.() -> Unit = {}
     ...
     */
    public inline fun cfnAlarmModelAlarmActionProperty(
        block: CfnAlarmModelAlarmActionPropertyDsl.() -> Unit = {}
     ...
     */
    public inline fun cfnAlarmModelAlarmCapabilitiesProperty(
     ...
     */
    public inline fun cfnAlarmModelAlarmEventActionsProperty(
     ...
     */
    public inline fun cfnAlarmModelAlarmRuleProperty(
     ...
     * the value for the `timeInSeconds` parameter can be `'1586400675'` .
     * * For references, you must specify either variables or input values. For example, the value
     *   for the `offsetInNanos` parameter can be `$variable.time` .
     ...
     */
    public inline fun cfnAlarmModelAssetPropertyTimestampProperty(
        block: CfnAlarmModelAssetPropertyTimestampPropertyDsl.() -> Unit = {}
     ...
     *
     * **Examples** - For literal values, the expressions must contain single quotes. For example,
     * the value for the `quality` parameter can be `'GOOD'` .
     * * For references, you must specify either variables or input values. For example, the value
     *   for the `quality` parameter can be `$input.TemperatureInput.sensorData.quality` .
     *
     * For more information, see
     * [Expressions](https://docs.aws.amazon.com/iotevents/latest/developerguide/iotevents-expressions.html)
     * in the *AWS IoT Events Developer Guide* .
     ...
     */
    public inline fun cfnAlarmModelAssetPropertyValueProperty(
        block: CfnAlarmModelAssetPropertyValuePropertyDsl.() -> Unit = {}
     ...
     *
     * For more information, see
     * [Variant](https://docs.aws.amazon.com/iot-sitewise/latest/APIReference/API_Variant.html) in
     * the *AWS IoT SiteWise API Reference* .
     *
     * You must use expressions for all parameters in `AssetPropertyVariant` . The expressions
     * accept literals, operators, functions, references, and substitution templates.
     *
     * **Examples** - For literal values, the expressions must contain single quotes. For example,
     * the value for the `integerValue` parameter can be `'100'` .
     ...
     * in the *AWS IoT Events Developer Guide* .
     *
     * You must specify one of the following value types, depending on the `dataType` of the
     * specified asset property. For more information, see
     ...
     */
    public inline fun cfnAlarmModelAssetPropertyVariantProperty(
        block: CfnAlarmModelAssetPropertyVariantPropertyDsl.() -> Unit = {}
     ...
     */
    public inline fun cfnAlarmModelDynamoDBProperty(
        block: CfnAlarmModelDynamoDBPropertyDsl.() -> Unit = {}
     ...
     */
    public inline fun cfnAlarmModelDynamoDBv2Property(
        block: CfnAlarmModelDynamoDBv2PropertyDsl.() -> Unit = {}
     ...
     */
    public inline fun cfnAlarmModelFirehoseProperty(
        block: CfnAlarmModelFirehosePropertyDsl.() -> Unit = {}
     ...
     */
    public inline fun cfnAlarmModelInitializationConfigurationProperty(
        block: CfnAlarmModelInitializationConfigurationPropertyDsl.() -> Unit = {}
     ...
     */
    public inline fun cfnAlarmModelIotEventsProperty(
        block: CfnAlarmModelIotEventsPropertyDsl.() -> Unit = {}
     ...
     */
    public inline fun cfnAlarmModelIotSiteWiseProperty(
        block: CfnAlarmModelIotSiteWisePropertyDsl.() -> Unit = {}
     ...
     */
    public inline fun cfnAlarmModelIotTopicPublishProperty(
        block: CfnAlarmModelIotTopicPublishPropertyDsl.() -> Unit = {}
     ...
     */
    public inline fun cfnAlarmModelLambdaProperty(
        block: CfnAlarmModelLambdaPropertyDsl.() -> Unit = {}
     ...
     */
    public inline fun cfnAlarmModelPayloadProperty(
        block: CfnAlarmModelPayloadPropertyDsl.() -> Unit = {}
     ...
     * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-iotevents-alarmmodel.html)
     */
    public inline fun cfnAlarmModelProps(
        block: CfnAlarmModelPropsDsl.() -> Unit = {}
    ): CfnAlarmModelProps {
     ...
     */
    public inline fun cfnAlarmModelSimpleRuleProperty(
        block: CfnAlarmModelSimpleRulePropertyDsl.() -> Unit = {}
     ...
     */
    public inline fun cfnAlarmModelSnsProperty(
        block: CfnAlarmModelSnsPropertyDsl.() -> Unit = {}
     ...
     */
    public inline fun cfnAlarmModelSqsProperty(
        block: CfnAlarmModelSqsPropertyDsl.() -> Unit = {}
     ...
     *
     * You create a *detector model* (a model of your equipment or process) using *states* . For
     * each state, you define conditional (Boolean) logic that evaluates the incoming inputs to
     * detect significant events. When an event is detected, it can change the state or trigger
     * custom-built or predefined actions using other AWS services. You can define additional events
     * that trigger actions when entering or exiting a state and, optionally, when a condition is
     ...
     * model are reset to their initial states. (The detector's `state` , and the values of any
     * variables and timers are reset.)
     *
     * When you successfully update a detector model (using the AWS IoT Events console, AWS IoT
     * Events API or CLI commands, or AWS CloudFormation ) the version number of the detector model
     * is incremented. (A detector model with version number 1 before the update has version number
     * 2 after the update succeeds.)
     *
     * If you attempt to update a detector model using AWS CloudFormation and the update does not
     * succeed, the system may, in some cases, restore the original detector model. When this
     * occurs, the detector model's version is incremented twice (for example, from version 1 to
     * version 3) and the detector instances are reset.
     *
     ...
     * detector model's detector instances and version number depend on whether the update succeeded
     * or failed, with the results as stated.
     *
     * Example:
     * ```
     * ```
     ...
     */
    public inline fun cfnDetectorModelActionProperty(
        block: CfnDetectorModelActionPropertyDsl.() -> Unit = {}
     ...
     */
    public inline fun cfnDetectorModelAssetPropertyTimestampProperty(
        block: CfnDetectorModelAssetPropertyTimestampPropertyDsl.() -> Unit = {}
     ...
     */
    public inline fun cfnDetectorModelAssetPropertyValueProperty(
        block: CfnDetectorModelAssetPropertyValuePropertyDsl.() -> Unit = {}
     ...
     */
    public inline fun cfnDetectorModelAssetPropertyVariantProperty(
        block: CfnDetectorModelAssetPropertyVariantPropertyDsl.() -> Unit = {}
     ...
     */
    public inline fun cfnDetectorModelClearTimerProperty(
        block: CfnDetectorModelClearTimerPropertyDsl.() -> Unit = {}
     ...
     */
    public inline fun cfnDetectorModelDetectorModelDefinitionProperty(
     ...
     */
    public inline fun cfnDetectorModelDynamoDBProperty(
        block: CfnDetectorModelDynamoDBPropertyDsl.() -> Unit = {}
     ...
     */
    public inline fun cfnDetectorModelDynamoDBv2Property(
        block: CfnDetectorModelDynamoDBv2PropertyDsl.() -> Unit = {}
     ...
     */
    public inline fun cfnDetectorModelEventProperty(
        block: CfnDetectorModelEventPropertyDsl.() -> Unit = {}
     ...
     */
    public inline fun cfnDetectorModelFirehoseProperty(
        block: CfnDetectorModelFirehosePropertyDsl.() -> Unit = {}
     ...
     */
    public inline fun cfnDetectorModelIotEventsProperty(
        block: CfnDetectorModelIotEventsPropertyDsl.() -> Unit = {}
     ...
     */
    public inline fun cfnDetectorModelIotSiteWiseProperty(
        block: CfnDetectorModelIotSiteWisePropertyDsl.() -> Unit = {}
     ...
     */
    public inline fun cfnDetectorModelIotTopicPublishProperty(
        block: CfnDetectorModelIotTopicPublishPropertyDsl.() -> Unit = {}
     ...
     */
    public inline fun cfnDetectorModelLambdaProperty(
        block: CfnDetectorModelLambdaPropertyDsl.() -> Unit = {}
     ...
     */
    public inline fun cfnDetectorModelOnEnterProperty(
        block: CfnDetectorModelOnEnterPropertyDsl.() -> Unit = {}
     ...
     */
    public inline fun cfnDetectorModelOnExitProperty(
        block: CfnDetectorModelOnExitPropertyDsl.() -> Unit = {}
     ...
     */
    public inline fun cfnDetectorModelOnInputProperty(
        block: CfnDetectorModelOnInputPropertyDsl.() -> Unit = {}
     ...
     */
    public inline fun cfnDetectorModelPayloadProperty(
        block: CfnDetectorModelPayloadPropertyDsl.() -> Unit = {}
     ...
     * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-iotevents-detectormodel.html)
     */
    public inline fun cfnDetectorModelProps(
        block: CfnDetectorModelPropsDsl.() -> Unit = {}
     ...
     *
     * The timer is reset to the previously evaluated result of the duration. The duration
     * expression isn't reevaluated when you reset the timer.
     *
     * Example:
     * ```
     * // The code below shows an example of how to instantiate this type.
     ...
     */
    public inline fun cfnDetectorModelResetTimerProperty(
        block: CfnDetectorModelResetTimerPropertyDsl.() -> Unit = {}
     ...
     */
    public inline fun cfnDetectorModelSetTimerProperty(
        block: CfnDetectorModelSetTimerPropertyDsl.() -> Unit = {}
     ...
     */
    public inline fun cfnDetectorModelSetVariableProperty(
        block: CfnDetectorModelSetVariablePropertyDsl.() -> Unit = {}
     ...
     */
    public inline fun cfnDetectorModelSnsProperty(
        block: CfnDetectorModelSnsPropertyDsl.() -> Unit = {}
     ...
     */
    public inline fun cfnDetectorModelSqsProperty(
        block: CfnDetectorModelSqsPropertyDsl.() -> Unit = {}
     ...
     */
    public inline fun cfnDetectorModelStateProperty(
        block: CfnDetectorModelStatePropertyDsl.() -> Unit = {}
     ...
     */
    public inline fun cfnDetectorModelTransitionEventProperty(
        block: CfnDetectorModelTransitionEventPropertyDsl.() -> Unit = {}
     ...
     *
     * To monitor your devices and processes, they must have a way to get telemetry data into AWS
     * IoT Events . This is done by sending messages as *inputs* to AWS IoT Events . For more
     * information, see
     * [How to Use AWS IoT Events](https://docs.aws.amazon.com/iotevents/latest/developerguide/how-to-use-iotevents.html)
     * in the *AWS IoT Events Developer Guide* .
     *
     ...
     */
    public inline fun cfnInputAttributeProperty(
        block: CfnInputAttributePropertyDsl.() -> Unit = {}
     ...
     */
    public inline fun cfnInputInputDefinitionProperty(
