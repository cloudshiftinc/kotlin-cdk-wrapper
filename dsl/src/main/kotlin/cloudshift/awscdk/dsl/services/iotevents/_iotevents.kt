...
public object iotevents {
    ...
    public inline fun cfnAlarmModelProps(block: CfnAlarmModelPropsDsl.() -> Unit = {}): CfnAlarmModelProps {
    ...
    public inline fun cfnAlarmModelSnsProperty(block: CfnAlarmModelSnsPropertyDsl.() -> Unit = {}): CfnAlarmModel.SnsProperty {
        val builder = CfnAlarmModelSnsPropertyDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun cfnAlarmModelSqsProperty(block: CfnAlarmModelSqsPropertyDsl.() -> Unit = {}): CfnAlarmModel.SqsProperty {
    ...
    public inline fun cfnDetectorModelProps(block: CfnDetectorModelPropsDsl.() -> Unit = {}): CfnDetectorModelProps {
    ...
    public inline fun cfnInputAttributeProperty(block: CfnInputAttributePropertyDsl.() -> Unit = {}): CfnInput.AttributeProperty {
