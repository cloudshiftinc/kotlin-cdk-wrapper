...
public class CfnGameSessionQueuePropsDsl {
    ...
    /**
     * @param name A descriptive label that is associated with game session queue. Queue names must
    ...
    /**
     * @param tags A list of labels to assign to the new game session queue resource. Tags are
