...
public class CfnServiceServiceConnectConfigurationPropertyDsl {
   ...
   * (shown in the valid values below). Additional log drivers may be available in future releases of
   ...
   * The namespace must be in the same AWS Region as the Amazon ECS service and cluster. The type of
   * namespace doesn't affect Service Connect. For more information about AWS Cloud Map , see [Working
   * with Services](https://docs.aws.amazon.com/cloud-map/latest/dg/working-with-services.html) in the
