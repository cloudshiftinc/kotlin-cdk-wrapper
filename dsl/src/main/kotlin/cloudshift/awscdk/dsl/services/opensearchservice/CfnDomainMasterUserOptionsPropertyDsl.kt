...
public class CfnDomainMasterUserOptionsPropertyDsl {
   ...
   * The ARN can point to an IAM user or role. This property is required for Amazon Cognito to work,
   * and it must match the role configured for Cognito. Only specify if `InternalUserDatabaseEnabled`
   * is false in
