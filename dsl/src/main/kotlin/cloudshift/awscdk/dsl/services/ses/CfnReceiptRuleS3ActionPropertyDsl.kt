 ...
 * access those resources. For information about granting permissions, see the
...
public class CfnReceiptRuleS3ActionPropertyDsl {
     ...
     *   before saving them to the Amazon S3 bucket. You can use the default master key or a custom
     ...
     * submitted to Amazon S3 for storage. It is not encrypted using Amazon S3 server-side
     ...
     *   directory name that enables you to store similar data under the same directory in a bucket.
     */
     ...
     *   Amazon S3 bucket. You can find the ARN of a topic by using the
