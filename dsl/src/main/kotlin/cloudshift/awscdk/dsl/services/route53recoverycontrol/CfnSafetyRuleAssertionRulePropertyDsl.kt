 ...
 * that at least one routing control state is `On` after the transaction so that traffic continues
...
public class CfnSafetyRuleAssertionRulePropertyDsl {
     ...
     *   to determine if a request to change a routing control state is allowed. For example, you
     *   might include three routing controls, one for each of three AWS Regions.
     */
