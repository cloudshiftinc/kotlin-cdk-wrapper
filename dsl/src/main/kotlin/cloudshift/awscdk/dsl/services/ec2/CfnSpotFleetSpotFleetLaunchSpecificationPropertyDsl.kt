...
public class CfnSpotFleetSpotFleetLaunchSpecificationPropertyDsl {
   ...
   * volumes can be encrypted on creation. If a snapshot is the basis for a volume, it is not blank and
   ...
   * stack to provide optimal EBS I/O performance. This optimization isn't available with all instance
   ...
   */
  public
      fun iamInstanceProfile(iamInstanceProfile: CfnSpotFleet.IamInstanceProfileSpecificationProperty) {
    cdkBuilder.iamInstanceProfile(iamInstanceProfile)
  }
   ...
   * These are the same units that you chose to set the target capacity in terms of instances, or a
