...
public class CfnBotSlotPropertyDsl {
  ...
  /**
   * @param obfuscationSetting Determines whether the contents of the slot are obfuscated in Amazon
  ...
  /**
   * @param valueElicitationSetting Determines the slot resolution strategy that Amazon Lex uses to
