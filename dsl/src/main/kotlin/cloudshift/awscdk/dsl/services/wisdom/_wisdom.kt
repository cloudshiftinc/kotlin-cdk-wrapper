...
public object wisdom {
  ...
  public inline
      fun cfnAssistantAssociationAssociationDataProperty(block: CfnAssistantAssociationAssociationDataPropertyDsl.() -> Unit
  ...
  public inline fun cfnAssistantAssociationProps(block: CfnAssistantAssociationPropsDsl.() -> Unit =
  ...
  public inline fun cfnAssistantProps(block: CfnAssistantPropsDsl.() -> Unit = {}):
      CfnAssistantProps {
  ...
  public inline
      fun cfnAssistantServerSideEncryptionConfigurationProperty(block: CfnAssistantServerSideEncryptionConfigurationPropertyDsl.() -> Unit
  ...
  public inline
      fun cfnKnowledgeBaseAppIntegrationsConfigurationProperty(block: CfnKnowledgeBaseAppIntegrationsConfigurationPropertyDsl.() -> Unit
  ...
  public inline fun cfnKnowledgeBaseProps(block: CfnKnowledgeBasePropsDsl.() -> Unit = {}):
  ...
  public inline
      fun cfnKnowledgeBaseRenderingConfigurationProperty(block: CfnKnowledgeBaseRenderingConfigurationPropertyDsl.() -> Unit
  ...
  public inline
      fun cfnKnowledgeBaseServerSideEncryptionConfigurationProperty(block: CfnKnowledgeBaseServerSideEncryptionConfigurationPropertyDsl.() -> Unit
  ...
  public inline
      fun cfnKnowledgeBaseSourceConfigurationProperty(block: CfnKnowledgeBaseSourceConfigurationPropertyDsl.() -> Unit
