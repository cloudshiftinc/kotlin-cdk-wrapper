...
public class CfnListenerRuleAuthenticateOidcConfigPropertyDsl {
     ...
     *   modifying a rule. If you are creating a rule, you can omit this parameter or set it to
     *   false.
     */
    ...
    public fun build(): CfnListenerRule.AuthenticateOidcConfigProperty = cdkBuilder.build()
}
