...
public class CfnScalableTargetPropsDsl {
    ...
    /**
     * @param maxCapacity The maximum value that you plan to scale out to. When a scaling policy is
     *   in effect, Application Auto Scaling can scale out (expand) as needed to the maximum
     *   capacity limit in response to changing demand.
     */
    ...
    /**
     * @param resourceId The identifier of the resource associated with the scalable target. This
     ...
     *   (IAM) role that allows Application Auto Scaling to modify the scalable target on your
     *   behalf. This can be either an IAM service role that Application Auto Scaling can assume to
     *   make calls to other AWS resources on your behalf, or a service-linked role for the
     ...
     * for your AWS or custom resource, see the
    ...
    /**
     * @param scalableDimension The scalable dimension associated with the scalable target. This
    ...
    /**
     * @param scheduledActions The scheduled actions for the scalable target. Duplicates aren't
     *   allowed.
     */
     ...
     *   `true` suspends the specified scaling activities. Setting it to `false` (default) resumes
