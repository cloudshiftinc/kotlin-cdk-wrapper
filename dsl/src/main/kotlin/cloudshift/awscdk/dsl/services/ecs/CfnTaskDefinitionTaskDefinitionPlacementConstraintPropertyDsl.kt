...
public class CfnTaskDefinitionTaskDefinitionPlacementConstraintPropertyDsl {
    ...
    /**
     * @param expression A cluster query language expression to apply to the constraint. For more
     *   information, see
    ...
    /**
     * @param type The type of constraint. The `MemberOf` constraint restricts selection to be from
