...
public class CfnSpotFleetInstanceRequirementsRequestPropertyDsl {
   ...
   */
  public
      fun acceleratorTotalMemoryMiB(acceleratorTotalMemoryMiB: CfnSpotFleet.AcceleratorTotalMemoryMiBRequestProperty) {
    cdkBuilder.acceleratorTotalMemoryMiB(acceleratorTotalMemoryMiB)
  }
   ...
   */
  public
      fun baselineEbsBandwidthMbps(baselineEbsBandwidthMbps: CfnSpotFleet.BaselineEbsBandwidthMbpsRequestProperty) {
    cdkBuilder.baselineEbsBandwidthMbps(baselineEbsBandwidthMbps)
  }
   ...
   * an instance family, type, size, or generation. The following are examples: `m5.8xlarge` , `c5*.*`
   * , `m5a.*` , `r*` , `*3*` .
   *
   ...
   */
  public
      fun networkBandwidthGbps(networkBandwidthGbps: CfnSpotFleet.NetworkBandwidthGbpsRequestProperty) {
    cdkBuilder.networkBandwidthGbps(networkBandwidthGbps)
  }
   ...
   */
  public
      fun networkInterfaceCount(networkInterfaceCount: CfnSpotFleet.NetworkInterfaceCountRequestProperty) {
    cdkBuilder.networkInterfaceCount(networkInterfaceCount)
  }
   ...
   * This is the maximum you’ll pay for an Spot Instance, expressed as a percentage above the least
   ...
   */
  public
      fun totalLocalStorageGb(totalLocalStorageGb: CfnSpotFleet.TotalLocalStorageGBRequestProperty) {
    cdkBuilder.totalLocalStorageGb(totalLocalStorageGb)
  }
