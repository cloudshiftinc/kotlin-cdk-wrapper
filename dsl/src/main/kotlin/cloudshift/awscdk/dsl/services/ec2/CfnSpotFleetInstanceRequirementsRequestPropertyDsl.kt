 ...
 */
@CdkDslMarker
public class CfnSpotFleetInstanceRequirementsRequestPropertyDsl {
    private val cdkBuilder: CfnSpotFleet.InstanceRequirementsRequestProperty.Builder =
     ...
     *   Inferentia chips) on an instance. To exclude accelerator-enabled instance types, set `Max`
     *   to `0` .
     *
     ...
     * Default: No minimum or maximum limits
     */
    public fun acceleratorCount(acceleratorCount: CfnSpotFleet.AcceleratorCountRequestProperty) {
        cdkBuilder.acceleratorCount(acceleratorCount)
    }
    ...
    /**
     * @param acceleratorTotalMemoryMiB The minimum and maximum amount of total accelerator memory,
     *   in MiB. Default: No minimum or maximum limits
     */
    ...
    public fun acceleratorTotalMemoryMiB(
        acceleratorTotalMemoryMiB: CfnSpotFleet.AcceleratorTotalMemoryMiBRequestProperty
    ) {
        cdkBuilder.acceleratorTotalMemoryMiB(acceleratorTotalMemoryMiB)
    }
     ...
     * includes all C5a and C5n instance types. If you specify `m5a.*` , Amazon EC2 will allow all
     ...
     * a compatible CPU architecture based on the Amazon Machine Image (AMI) that you specify in
     ...
     *   are included. The current generation instance types are recommended for use. Current
     *   generation instance types are typically the latest two to three generations in each
     *   instance family. For more information, see
     ...
     *   No minimum or maximum limits
     */
    public fun memoryGiBPerVCpu(memoryGiBPerVCpu: CfnSpotFleet.MemoryGiBPerVCpuRequestProperty) {
        cdkBuilder.memoryGiBPerVCpu(memoryGiBPerVCpu)
    }
    ...
    /** @param memoryMiB The minimum and maximum amount of memory, in MiB. */
    public fun memoryMiB(memoryMiB: CfnSpotFleet.MemoryMiBRequestProperty) {
        cdkBuilder.memoryMiB(memoryMiB)
    }

    /**
     * @param networkBandwidthGbps The minimum and maximum amount of baseline network bandwidth, in
     *   gigabits per second (Gbps). For more information, see
    ...
    public fun networkBandwidthGbps(
        networkBandwidthGbps: CfnSpotFleet.NetworkBandwidthGbpsRequestProperty
    ) {
        cdkBuilder.networkBandwidthGbps(networkBandwidthGbps)
    }

    /**
     * @param networkInterfaceCount The minimum and maximum number of network interfaces. Default:
     *   No minimum or maximum limits
     */
    ...
    public fun networkInterfaceCount(
        networkInterfaceCount: CfnSpotFleet.NetworkInterfaceCountRequestProperty
    ) {
        cdkBuilder.networkInterfaceCount(networkInterfaceCount)
    }
     ...
     *   On-Demand Instances. This parameter is not supported for
     *   [GetSpotPlacementScores](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_GetSpotPlacementScores.html)
     *   .
     *
     * Default: `false`
     ...
     *   Instance. This is the maximum you’ll pay for an Spot Instance, expressed as a percentage
    ...
    public fun totalLocalStorageGb(
        totalLocalStorageGb: CfnSpotFleet.TotalLocalStorageGBRequestProperty
    ) {
        cdkBuilder.totalLocalStorageGb(totalLocalStorageGb)
    }
    ...
    /** @param vCpuCount The minimum and maximum number of vCPUs. */
    public fun vCpuCount(vCpuCount: CfnSpotFleet.VCpuCountRangeRequestProperty) {
        cdkBuilder.vCpuCount(vCpuCount)
    }

    public fun build(): CfnSpotFleet.InstanceRequirementsRequestProperty {
