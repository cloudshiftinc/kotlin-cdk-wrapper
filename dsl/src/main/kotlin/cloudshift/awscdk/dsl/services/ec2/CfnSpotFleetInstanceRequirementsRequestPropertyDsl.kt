...
public class CfnSpotFleetInstanceRequirementsRequestPropertyDsl {
    ...
    public fun acceleratorTotalMemoryMiB(acceleratorTotalMemoryMiB: CfnSpotFleet.AcceleratorTotalMemoryMiBRequestProperty) {
        cdkBuilder.acceleratorTotalMemoryMiB(acceleratorTotalMemoryMiB)
    }
    ...
    public fun baselineEbsBandwidthMbps(baselineEbsBandwidthMbps: CfnSpotFleet.BaselineEbsBandwidthMbpsRequestProperty) {
        cdkBuilder.baselineEbsBandwidthMbps(baselineEbsBandwidthMbps)
    }
    ...
    public fun networkBandwidthGbps(networkBandwidthGbps: CfnSpotFleet.NetworkBandwidthGbpsRequestProperty) {
        cdkBuilder.networkBandwidthGbps(networkBandwidthGbps)
    }
    ...
    public fun networkInterfaceCount(networkInterfaceCount: CfnSpotFleet.NetworkInterfaceCountRequestProperty) {
        cdkBuilder.networkInterfaceCount(networkInterfaceCount)
    }
    ...
    public fun totalLocalStorageGb(totalLocalStorageGb: CfnSpotFleet.TotalLocalStorageGBRequestProperty) {
        cdkBuilder.totalLocalStorageGb(totalLocalStorageGb)
    }
