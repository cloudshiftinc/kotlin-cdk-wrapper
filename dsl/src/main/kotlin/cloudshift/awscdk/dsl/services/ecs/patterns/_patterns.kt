...
public object patterns {
    ...
    public inline fun applicationTargetProps(block: ApplicationTargetPropsDsl.() -> Unit = {}): ApplicationTargetProps {
        val builder = ApplicationTargetPropsDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun fargateServiceBaseProps(block: FargateServiceBasePropsDsl.() -> Unit = {}): FargateServiceBaseProps {
    ...
    public inline fun networkTargetProps(block: NetworkTargetPropsDsl.() -> Unit = {}): NetworkTargetProps {
    ...
    public inline fun queueProcessingEc2ServiceProps(block: QueueProcessingEc2ServicePropsDsl.() -> Unit = {}): QueueProcessingEc2ServiceProps {
    ...
    public inline fun scheduledEc2TaskProps(block: ScheduledEc2TaskPropsDsl.() -> Unit = {}): ScheduledEc2TaskProps {
    ...
    public inline fun scheduledFargateTaskProps(block: ScheduledFargateTaskPropsDsl.() -> Unit = {}): ScheduledFargateTaskProps {
        val builder = ScheduledFargateTaskPropsDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun scheduledTaskBaseProps(block: ScheduledTaskBasePropsDsl.() -> Unit = {}): ScheduledTaskBaseProps {
        val builder = ScheduledTaskBasePropsDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun scheduledTaskImageProps(block: ScheduledTaskImagePropsDsl.() -> Unit = {}): ScheduledTaskImageProps {
