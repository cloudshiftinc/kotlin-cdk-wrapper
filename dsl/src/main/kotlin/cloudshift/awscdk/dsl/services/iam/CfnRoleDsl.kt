...
public class CfnRoleDsl(
     ...
     * policy with a role. For an example of a policy that can be used to assume a role, see
     ...
     * You can update a role's trust policy later. For more information about IAM roles, go to
