...
public class CfnAnalysisCategoryFilterConfigurationPropertyDsl {
   ...
   */
  public
      fun customFilterConfiguration(customFilterConfiguration: CfnAnalysis.CustomFilterConfigurationProperty) {
    cdkBuilder.customFilterConfiguration(customFilterConfiguration)
  }
   ...
   */
  public
      fun customFilterListConfiguration(customFilterListConfiguration: CfnAnalysis.CustomFilterListConfigurationProperty) {
    cdkBuilder.customFilterListConfiguration(customFilterListConfiguration)
  }
   ...
   */
  public
      fun filterListConfiguration(filterListConfiguration: CfnAnalysis.FilterListConfigurationProperty) {
    cdkBuilder.filterListConfiguration(filterListConfiguration)
  }
