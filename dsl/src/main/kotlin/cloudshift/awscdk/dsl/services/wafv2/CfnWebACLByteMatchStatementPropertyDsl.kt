 ...
 * corresponds with ASCII characters. In the AWS WAF console and the developer guide, this is called a
 ...
 */
@CdkDslMarker
public class CfnWebACLByteMatchStatementPropertyDsl {
  private val cdkBuilder: CfnWebACL.ByteMatchStatementProperty.Builder =
   ...
   * WAF to search for `SearchString` . 
   ...
   * a character other than an alphanumeric character or underscore (_). Examples include the value of
   * a header and `;BadBot` .
  ...
  public fun build(): CfnWebACL.ByteMatchStatementProperty {
