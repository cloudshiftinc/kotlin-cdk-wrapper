...
public object endpoints {
    ...
    public inline fun cfnEipEndpoint(eip: CfnEIP, block: CfnEipEndpointDsl.() -> Unit = {}): CfnEipEndpoint {
        val builder = CfnEipEndpointDsl(eip)
        builder.apply(block)
        return builder.build()
    }

    public inline fun cfnEipEndpointProps(block: CfnEipEndpointPropsDsl.() -> Unit = {}): CfnEipEndpointProps {
    ...
    public inline fun instanceEndpointProps(block: InstanceEndpointPropsDsl.() -> Unit = {}): InstanceEndpointProps {
