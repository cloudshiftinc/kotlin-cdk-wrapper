...
public class CfnGroupQueryPropertyDsl {
     ...
     *   the resource group. For example, if `ResourceTypeFilters` is `["AWS::EC2::Instance",
     *   "AWS::DynamoDB::Table"]` , only EC2 instances or DynamoDB tables can be members of this
     *   resource group. The default value is `["AWS::AllSupported"]` .
     */
    ...
    /**
     * @param stackIdentifier Specifies the ARN of a CloudFormation stack. All supported resources
     *   of the CloudFormation stack are members of the resource group. If you don't specify an ARN,
    ...
    /**
     * @param tagFilters A list of key-value pair objects that limit which resources can be members
     *   of the resource group. This property is required when the `ResourceQuery.Type` property is
     *   `TAG_FILTERS_1_0` .
     *
