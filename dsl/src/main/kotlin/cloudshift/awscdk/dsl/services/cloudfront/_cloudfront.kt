...
public object cloudfront {
    public inline fun addBehaviorOptions(block: AddBehaviorOptionsDsl.() -> Unit = {}): AddBehaviorOptions {
    ...
    public inline fun cfnCachePolicyProps(block: CfnCachePolicyPropsDsl.() -> Unit = {}): CfnCachePolicyProps {
    ...
    public inline fun cfnMonitoringSubscriptionProps(block: CfnMonitoringSubscriptionPropsDsl.() -> Unit = {}): CfnMonitoringSubscriptionProps {
    ...
    public inline fun cfnPublicKeyProps(block: CfnPublicKeyPropsDsl.() -> Unit = {}): CfnPublicKeyProps {
    ...
    public inline fun cfnRealtimeLogConfigProps(block: CfnRealtimeLogConfigPropsDsl.() -> Unit = {}): CfnRealtimeLogConfigProps {
    ...
    public inline fun cloudFrontWebDistributionProps(block: CloudFrontWebDistributionPropsDsl.() -> Unit = {}): CloudFrontWebDistributionProps {
        val builder = CloudFrontWebDistributionPropsDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun customOriginConfig(block: CustomOriginConfigDsl.() -> Unit = {}): CustomOriginConfig {
    ...
    public inline fun distributionAttributes(block: DistributionAttributesDsl.() -> Unit = {}): DistributionAttributes {
        val builder = DistributionAttributesDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun distributionProps(block: DistributionPropsDsl.() -> Unit = {}): DistributionProps {
    ...
    public inline fun functionAssociation(block: FunctionAssociationDsl.() -> Unit = {}): FunctionAssociation {
    ...
    public inline fun lambdaFunctionAssociation(block: LambdaFunctionAssociationDsl.() -> Unit = {}): LambdaFunctionAssociation {
        val builder = LambdaFunctionAssociationDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun loggingConfiguration(block: LoggingConfigurationDsl.() -> Unit = {}): LoggingConfiguration {
    ...
    public inline fun originAccessIdentityProps(block: OriginAccessIdentityPropsDsl.() -> Unit = {}): OriginAccessIdentityProps {
    ...
    public inline fun originBindOptions(block: OriginBindOptionsDsl.() -> Unit = {}): OriginBindOptions {
        val builder = OriginBindOptionsDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun originFailoverConfig(block: OriginFailoverConfigDsl.() -> Unit = {}): OriginFailoverConfig {
    ...
    public inline fun originRequestPolicyProps(block: OriginRequestPolicyPropsDsl.() -> Unit = {}): OriginRequestPolicyProps {
    ...
    public inline fun responseCustomHeader(block: ResponseCustomHeaderDsl.() -> Unit = {}): ResponseCustomHeader {
    ...
    public inline fun sourceConfiguration(block: SourceConfigurationDsl.() -> Unit = {}): SourceConfiguration {
        val builder = SourceConfigurationDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun viewerCertificateOptions(block: ViewerCertificateOptionsDsl.() -> Unit = {}): ViewerCertificateOptions {
