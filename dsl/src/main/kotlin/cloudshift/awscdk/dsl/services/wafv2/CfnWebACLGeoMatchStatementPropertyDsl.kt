 ...
 * Then, add one or more label match rules to run after the geo match rule and configure them to match
 ...
 * Organization for Standardization (ISO) 3166 standard. AWS WAF determines the codes using either the
 ...
 * country code&gt;-&lt;ISO region code&gt;` and `awswaf:clientip:geo:country:&lt;ISO country code&gt;`
 * .
 *
