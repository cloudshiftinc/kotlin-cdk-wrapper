...
public class CfnApplicationV2InputPropertyDsl {
   ...
   */
  public
      fun inputProcessingConfiguration(inputProcessingConfiguration: CfnApplicationV2.InputProcessingConfigurationProperty) {
    cdkBuilder.inputProcessingConfiguration(inputProcessingConfiguration)
  }
   ...
   */
  public
      fun kinesisFirehoseInput(kinesisFirehoseInput: CfnApplicationV2.KinesisFirehoseInputProperty) {
    cdkBuilder.kinesisFirehoseInput(kinesisFirehoseInput)
  }
   ...
   */
  public
      fun kinesisStreamsInput(kinesisStreamsInput: CfnApplicationV2.KinesisStreamsInputProperty) {
    cdkBuilder.kinesisStreamsInput(kinesisStreamsInput)
  }
