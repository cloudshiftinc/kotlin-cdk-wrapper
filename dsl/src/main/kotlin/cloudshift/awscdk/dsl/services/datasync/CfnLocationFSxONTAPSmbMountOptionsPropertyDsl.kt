...
public class CfnLocationFSxONTAPSmbMountOptionsPropertyDsl {
   ...
   * You also can configure DataSync to use a specific SMB version, but we recommend doing this only
   * if DataSync has trouble negotiating with the SMB file server automatically.
   *
   * These are the following options for configuring the SMB version:
   *
   * * `AUTOMATIC` (default): DataSync and the SMB file server negotiate the highest version of SMB
