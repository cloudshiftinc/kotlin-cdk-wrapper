...
public class CfnLocationFSxONTAPPropsDsl {
     ...
     *   that DataSync can use to access your FSx for ONTAP file system. You must configure the
     *   security groups to allow outbound traffic on the following ports (depending on the protocol
     *   that you're using):
