...
public class EventSourceMappingOptionsDsl {
    ...
    public fun sourceAccessConfigurations(sourceAccessConfigurations: SourceAccessConfigurationDsl.() -> Unit) {
        _sourceAccessConfigurations.add(SourceAccessConfigurationDsl().apply(sourceAccessConfigurations).build())
    }

    public fun sourceAccessConfigurations(sourceAccessConfigurations: Collection<SourceAccessConfiguration>) {
