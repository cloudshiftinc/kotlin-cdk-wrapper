...
public class CfnDomainEBSOptionsPropertyDsl {
     ...
     *   property applies only to the `gp3` and provisioned IOPS EBS volume types.
     */
    ...
    /**
     * @param volumeType The EBS volume type to use with the OpenSearch Service domain. If you
     *   choose `gp3` , you must also specify values for `Iops` and `Throughput` . For more
