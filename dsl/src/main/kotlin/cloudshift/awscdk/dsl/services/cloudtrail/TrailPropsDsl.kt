...
public class TrailPropsDsl {
  ...
  /**
   * @param enableFileValidation To determine whether a log file was modified, deleted, or unchanged
   * after CloudTrail delivered it, you can use CloudTrail log file integrity validation.
  ...
  /**
   * @param isMultiRegionTrail Whether or not this trail delivers log files from multiple regions to
   * a single S3 bucket for a single account.
   */
  ...
  /**
   * @param managementEvents When an event occurs in your account, CloudTrail evaluates whether the
   * event matches the settings for your trails.
