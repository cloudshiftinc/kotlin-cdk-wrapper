 ...
 * deployment group. If you specify an application revision, your target revision is deployed as
 * soon as the provisioning process is complete.
 *
 * Example:
 * ```
...
public class CfnDeploymentGroupDeploymentPropertyDsl {
     ...
     * that the `ApplicationStop` , `BeforeBlockTraffic` , and `AfterBlockTraffic` failures should
     * be ignored.
     */
