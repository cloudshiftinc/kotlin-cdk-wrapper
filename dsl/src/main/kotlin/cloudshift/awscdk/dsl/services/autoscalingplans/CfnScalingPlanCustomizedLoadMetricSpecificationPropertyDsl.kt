 ...
 * is a metric that counts the number of requests processed by your Auto Scaling group. If the `Sum`
...
public class CfnScalingPlanCustomizedLoadMetricSpecificationPropertyDsl {
     ...
     *   with dimensions, you must specify the same dimensions in your customized load metric
     *   specification.
     */
