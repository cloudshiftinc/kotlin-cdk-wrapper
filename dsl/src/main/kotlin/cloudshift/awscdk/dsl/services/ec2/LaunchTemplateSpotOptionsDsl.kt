...
public class LaunchTemplateSpotOptionsDsl {
     ...
     *   designed not to be interrupted and will run continuously for the duration you select. You
     *   can use a duration of 1, 2, 3, 4, 5, or 6 hours.
     */
    ...
    /**
     * @param maxPrice Maximum hourly price you're willing to pay for each Spot instance. The value
     *   is given in dollars. ex: 0.01 for 1 cent per hour, or 0.001 for one-tenth of a cent per
     *   hour.
     */
    ...
    /**
     * @param requestType The Spot Instance request type. If you are using Spot Instances with an
     *   Auto Scaling group, use one-time requests, as the Amazon EC2 Auto Scaling service handles
     *   requesting new Spot Instances whenever the group is below its desired capacity.
     */
    ...
    /**
     * @param validUntil The end date of the request. For a one-time request, the request remains
