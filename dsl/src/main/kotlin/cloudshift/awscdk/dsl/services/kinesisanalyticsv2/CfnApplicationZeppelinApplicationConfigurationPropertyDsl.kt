...
public class CfnApplicationZeppelinApplicationConfigurationPropertyDsl {
    ...
    public fun catalogConfiguration(
        catalogConfiguration: CfnApplication.CatalogConfigurationProperty
    ) {
        cdkBuilder.catalogConfiguration(catalogConfiguration)
    }
    ...
    public fun deployAsApplicationConfiguration(
        deployAsApplicationConfiguration: CfnApplication.DeployAsApplicationConfigurationProperty
    ) {
        cdkBuilder.deployAsApplicationConfiguration(deployAsApplicationConfiguration)
    }
    ...
    public fun monitoringConfiguration(
        monitoringConfiguration: CfnApplication.ZeppelinMonitoringConfigurationProperty
    ) {
        cdkBuilder.monitoringConfiguration(monitoringConfiguration)
    }
