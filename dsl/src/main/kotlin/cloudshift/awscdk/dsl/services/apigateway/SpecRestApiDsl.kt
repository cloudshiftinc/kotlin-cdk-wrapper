 ...
 * ```
 *
 * @see <a href=" `RestApi` - such as the description - must be declared in the specification. All
 *   Resources and Methods need to be defined as part of the OpenAPI specification file, and cannot
 *   be added via the CDK. By default, the API will automatically be deployed and accessible from a
 *   public endpoint."> `RestApi` - such as the description - must be declared in the specification.
 *   All Resources and Methods need to be defined as part of the OpenAPI specification file, and
 *   cannot be added via the CDK. By default, the API will automatically be deployed and accessible
 *   from a public endpoint.</a>
 */
@CdkDslMarker
