...
public class CfnFileSystemOpenZFSConfigurationPropertyDsl {
  ...
  /**
   * @param copyTagsToBackups A Boolean value indicating whether tags for the file system should be
   * copied to backups.
   ...
   * value is `true` , and you specify one or more tags, only the specified tags are copied to backups.
  ...
  /**
   * @param copyTagsToVolumes A Boolean value indicating whether tags for the file system should be
   * copied to volumes.
   * This value defaults to `false` . If it's set to `true` , all tags for the file system are
   ...
   * NVMe L2ARC cache. `Single_AZ_2` is available only in the US East (N. Virginia), US East (Ohio), US
   * West (Oregon), and Europe (Ireland) AWS Regions .
   *
   ...
   * for an Amazon FSx for NetApp ONTAP or FSx for OpenZFS file system.
   ...
   * of the Amazon FSx for OpenZFS file system.
