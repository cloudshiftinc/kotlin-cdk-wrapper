...
public class CfnFileSystemOpenZFSConfigurationPropertyDsl {
    ...
    public fun diskIopsConfiguration(diskIopsConfiguration: CfnFileSystem.DiskIopsConfigurationProperty) {
        cdkBuilder.diskIopsConfiguration(diskIopsConfiguration)
    }
    ...
    public fun rootVolumeConfiguration(rootVolumeConfiguration: CfnFileSystem.RootVolumeConfigurationProperty) {
        cdkBuilder.rootVolumeConfiguration(rootVolumeConfiguration)
    }
