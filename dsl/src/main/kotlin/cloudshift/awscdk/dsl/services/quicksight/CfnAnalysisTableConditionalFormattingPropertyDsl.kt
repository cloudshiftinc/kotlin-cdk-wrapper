 ...
 */
@CdkDslMarker
public class CfnAnalysisTableConditionalFormattingPropertyDsl {
    private val cdkBuilder: CfnAnalysis.TableConditionalFormattingProperty.Builder =
    ...
    public fun build(): CfnAnalysis.TableConditionalFormattingProperty {
