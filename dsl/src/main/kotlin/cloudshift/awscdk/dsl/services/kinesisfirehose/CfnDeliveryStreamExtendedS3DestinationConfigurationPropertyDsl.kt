...
public class CfnDeliveryStreamExtendedS3DestinationConfigurationPropertyDsl {
   ...
   * converting data from the JSON format to the Parquet or ORC format before writing it to Amazon S3.
   */
   ...
   */
  public
      fun dataFormatConversionConfiguration(dataFormatConversionConfiguration: CfnDeliveryStream.DataFormatConversionConfigurationProperty) {
    cdkBuilder.dataFormatConversionConfiguration(dataFormatConversionConfiguration)
  }

  /**
   * @param dynamicPartitioningConfiguration The configuration of the dynamic partitioning mechanism
   * that creates targeted data sets from the streaming data by partitioning it based on partition
   * keys.
   */
   ...
   */
  public
      fun dynamicPartitioningConfiguration(dynamicPartitioningConfiguration: CfnDeliveryStream.DynamicPartitioningConfigurationProperty) {
    cdkBuilder.dynamicPartitioningConfiguration(dynamicPartitioningConfiguration)
  }
  ...
  /**
   * @param prefix The `YYYY/MM/DD/HH` time format prefix is automatically used for delivered Amazon
   * S3 files.
   ...
   */
  public
      fun s3BackupConfiguration(s3BackupConfiguration: CfnDeliveryStream.S3DestinationConfigurationProperty) {
    cdkBuilder.s3BackupConfiguration(s3BackupConfiguration)
  }
