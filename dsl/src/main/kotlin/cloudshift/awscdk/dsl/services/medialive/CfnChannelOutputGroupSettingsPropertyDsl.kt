...
public class CfnChannelOutputGroupSettingsPropertyDsl {
    ...
    public fun frameCaptureGroupSettings(frameCaptureGroupSettings: CfnChannel.FrameCaptureGroupSettingsProperty) {
        cdkBuilder.frameCaptureGroupSettings(frameCaptureGroupSettings)
    }
    ...
    public fun mediaPackageGroupSettings(mediaPackageGroupSettings: CfnChannel.MediaPackageGroupSettingsProperty) {
        cdkBuilder.mediaPackageGroupSettings(mediaPackageGroupSettings)
    }
    ...
    public fun msSmoothGroupSettings(msSmoothGroupSettings: CfnChannel.MsSmoothGroupSettingsProperty) {
        cdkBuilder.msSmoothGroupSettings(msSmoothGroupSettings)
    }
    ...
    public fun multiplexGroupSettings(multiplexGroupSettings: CfnChannel.MultiplexGroupSettingsProperty) {
        cdkBuilder.multiplexGroupSettings(multiplexGroupSettings)
    }
