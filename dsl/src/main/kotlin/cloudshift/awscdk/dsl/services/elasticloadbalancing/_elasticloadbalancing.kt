...
public object elasticloadbalancing {
    ...
    public inline fun loadBalancerListener(block: LoadBalancerListenerDsl.() -> Unit = {}): LoadBalancerListener {
        val builder = LoadBalancerListenerDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun loadBalancerProps(block: LoadBalancerPropsDsl.() -> Unit = {}): LoadBalancerProps {
