...
public class CfnBucketReplicationDestinationPropertyDsl {
    ...
    public fun accessControlTranslation(accessControlTranslation: CfnBucket.AccessControlTranslationProperty) {
        cdkBuilder.accessControlTranslation(accessControlTranslation)
    }
    ...
    public fun encryptionConfiguration(encryptionConfiguration: CfnBucket.EncryptionConfigurationProperty) {
        cdkBuilder.encryptionConfiguration(encryptionConfiguration)
    }
