...
public object iam {
    ...
    public inline fun addToResourcePolicyResult(block: AddToResourcePolicyResultDsl.() -> Unit = {}): AddToResourcePolicyResult {
    ...
    public inline fun cfnAccessKeyProps(block: CfnAccessKeyPropsDsl.() -> Unit = {}): CfnAccessKeyProps {
    ...
    public inline fun cfnGroupPolicyProperty(block: CfnGroupPolicyPropertyDsl.() -> Unit = {}): CfnGroup.PolicyProperty {
    ...
    public inline fun cfnManagedPolicyProps(block: CfnManagedPolicyPropsDsl.() -> Unit = {}): CfnManagedPolicyProps {
    ...
    public inline fun cfnOIDCProviderProps(block: CfnOIDCProviderPropsDsl.() -> Unit = {}): CfnOIDCProviderProps {
    ...
    public inline fun cfnRolePolicyProperty(block: CfnRolePolicyPropertyDsl.() -> Unit = {}): CfnRole.PolicyProperty {
    ...
    public inline fun cfnSAMLProviderProps(block: CfnSAMLProviderPropsDsl.() -> Unit = {}): CfnSAMLProviderProps {
    ...
    public inline fun cfnServerCertificateProps(block: CfnServerCertificatePropsDsl.() -> Unit = {}): CfnServerCertificateProps {
    ...
    public inline fun cfnServiceLinkedRoleProps(block: CfnServiceLinkedRolePropsDsl.() -> Unit = {}): CfnServiceLinkedRoleProps {
    ...
    public inline fun cfnUserPolicyProperty(block: CfnUserPolicyPropertyDsl.() -> Unit = {}): CfnUser.PolicyProperty {
    ...
    public inline fun cfnVirtualMFADeviceProps(block: CfnVirtualMFADevicePropsDsl.() -> Unit = {}): CfnVirtualMFADeviceProps {
        val builder = CfnVirtualMFADevicePropsDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun commonGrantOptions(block: CommonGrantOptionsDsl.() -> Unit = {}): CommonGrantOptions {
        val builder = CommonGrantOptionsDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun customizeRolesOptions(block: CustomizeRolesOptionsDsl.() -> Unit = {}): CustomizeRolesOptions {
        val builder = CustomizeRolesOptionsDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun fromRoleArnOptions(block: FromRoleArnOptionsDsl.() -> Unit = {}): FromRoleArnOptions {
        val builder = FromRoleArnOptionsDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun fromRoleNameOptions(block: FromRoleNameOptionsDsl.() -> Unit = {}): FromRoleNameOptions {
    ...
    public inline fun grantOnPrincipalOptions(block: GrantOnPrincipalOptionsDsl.() -> Unit = {}): GrantOnPrincipalOptions {
        val builder = GrantOnPrincipalOptionsDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun grantWithResourceOptions(block: GrantWithResourceOptionsDsl.() -> Unit = {}): GrantWithResourceOptions {
    ...
    public inline fun instanceProfileAttributes(block: InstanceProfileAttributesDsl.() -> Unit = {}): InstanceProfileAttributes {
        val builder = InstanceProfileAttributesDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun instanceProfileProps(block: InstanceProfilePropsDsl.() -> Unit = {}): InstanceProfileProps {
    ...
    public inline fun managedPolicyProps(block: ManagedPolicyPropsDsl.() -> Unit = {}): ManagedPolicyProps {
    ...
    public inline fun policyDocumentProps(block: PolicyDocumentPropsDsl.() -> Unit = {}): PolicyDocumentProps {
    ...
    public inline fun policyStatementProps(block: PolicyStatementPropsDsl.() -> Unit = {}): PolicyStatementProps {
    ...
    public inline fun samlProviderProps(block: SamlProviderPropsDsl.() -> Unit = {}): SamlProviderProps {
        val builder = SamlProviderPropsDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun servicePrincipal(service: String, block: ServicePrincipalDsl.() -> Unit = {}): ServicePrincipal {
        val builder = ServicePrincipalDsl(service)
        builder.apply(block)
        return builder.build()
    }

    public inline fun servicePrincipalOpts(block: ServicePrincipalOptsDsl.() -> Unit = {}): ServicePrincipalOpts {
    ...
    public inline fun unknownPrincipalProps(block: UnknownPrincipalPropsDsl.() -> Unit = {}): UnknownPrincipalProps {
