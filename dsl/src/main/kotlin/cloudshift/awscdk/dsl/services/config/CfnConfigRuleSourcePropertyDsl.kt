...
public class CfnConfigRuleSourcePropertyDsl {
   ...
   *
   * AWS Config Custom Rules are rules that you can develop either with Guard ( `CUSTOM_POLICY` ) or
   * AWS Lambda ( `CUSTOM_LAMBDA` ). For more information, see [AWS Config Custom
   ...
   * For example, `IAM_PASSWORD_POLICY` is a managed rule. To reference a managed rule, see [List of
   * AWS Config Managed
