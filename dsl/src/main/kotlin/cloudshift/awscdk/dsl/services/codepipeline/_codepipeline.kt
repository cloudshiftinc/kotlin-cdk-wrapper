...
public object codepipeline {
    public inline fun actionArtifactBounds(block: ActionArtifactBoundsDsl.() -> Unit = {}): ActionArtifactBounds {
        val builder = ActionArtifactBoundsDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun actionBindOptions(block: ActionBindOptionsDsl.() -> Unit = {}): ActionBindOptions {
    ...
    public inline fun cfnCustomActionTypeProps(block: CfnCustomActionTypePropsDsl.() -> Unit = {}): CfnCustomActionTypeProps {
    ...
    public inline fun commonActionProps(block: CommonActionPropsDsl.() -> Unit = {}): CommonActionProps {
        val builder = CommonActionPropsDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun commonAwsActionProps(block: CommonAwsActionPropsDsl.() -> Unit = {}): CommonAwsActionProps {
        val builder = CommonAwsActionPropsDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun crossRegionSupport(block: CrossRegionSupportDsl.() -> Unit = {}): CrossRegionSupport {
        val builder = CrossRegionSupportDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun customActionProperty(block: CustomActionPropertyDsl.() -> Unit = {}): CustomActionProperty {
    ...
    public inline fun pipelineNotifyOnOptions(block: PipelineNotifyOnOptionsDsl.() -> Unit = {}): PipelineNotifyOnOptions {
