...
public class CfnApplicationInputPropertyDsl {
    ...
    /**
     * @param inputParallelism Describes the number of in-application streams to create. Data from
     *   your source is routed to these in-application input streams.
     *
     * See
     * [Configuring Application Input](https://docs.aws.amazon.com/kinesisanalytics/latest/dev/how-it-works-input.html)
     * .
    ...
    public fun inputProcessingConfiguration(
        inputProcessingConfiguration: CfnApplication.InputProcessingConfigurationProperty
    ) {
        cdkBuilder.inputProcessingConfiguration(inputProcessingConfiguration)
    }
     ...
     *   data element maps to corresponding columns in the in-application stream that is being
     ...
     *   Analytics to access the stream on your behalf. Note: Either `KinesisStreamsInput` or
    ...
    public fun kinesisFirehoseInput(
        kinesisFirehoseInput: CfnApplication.KinesisFirehoseInputProperty
    ) {
        cdkBuilder.kinesisFirehoseInput(kinesisFirehoseInput)
    }
     ...
     *   the stream's Amazon Resource Name (ARN) and an IAM role that enables Amazon Kinesis
     *   Analytics to access the stream on your behalf. Note: Either `KinesisStreamsInput` or
     *   `KinesisFirehoseInput` is required.
     */
    ...
    public fun kinesisStreamsInput(
        kinesisStreamsInput: CfnApplication.KinesisStreamsInputProperty
    ) {
        cdkBuilder.kinesisStreamsInput(kinesisStreamsInput)
    }

    /**
     * @param namePrefix Name prefix to use when creating an in-application stream. Suppose that you
     *   specify a prefix "MyInApplicationStream." Amazon Kinesis Analytics then creates one or more
     *   (as per the `InputParallelism` count you specified) in-application streams with names
