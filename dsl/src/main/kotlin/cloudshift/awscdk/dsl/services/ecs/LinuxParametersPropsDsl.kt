...
public class LinuxParametersPropsDsl {
    ...
    /**
     * @param maxSwap The total amount of swap memory a container can use. This parameter will be
    ...
    /**
     * @param swappiness This allows you to tune a container's memory swappiness behavior. This
     *   parameter maps to the --memory-swappiness option to docker run. The swappiness relates to
     *   the kernel's tendency to swap memory. A value of 0 will cause swapping to not happen unless
     *   absolutely necessary. A value of 100 will cause pages to be swapped very aggressively.
     *
     * This parameter is only supported when you are using the EC2 launch type. Accepted values are
