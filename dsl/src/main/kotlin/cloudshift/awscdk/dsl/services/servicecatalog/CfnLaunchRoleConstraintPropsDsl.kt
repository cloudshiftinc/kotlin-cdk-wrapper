...
public class CfnLaunchRoleConstraintPropsDsl {
     ...
     *   but can't use both. If you specify the `LocalRoleName` property, when an account uses the
    ...
    /**
     * @param roleArn The ARN of the launch role. You are required to specify `RoleArn` or
