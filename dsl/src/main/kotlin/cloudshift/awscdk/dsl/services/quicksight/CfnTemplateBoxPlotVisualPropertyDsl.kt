 ...
 */
@CdkDslMarker
public class CfnTemplateBoxPlotVisualPropertyDsl {
  private val cdkBuilder: CfnTemplate.BoxPlotVisualProperty.Builder =
   ...
   * @param chartConfiguration The configuration settings of the visual.
   */
  public fun chartConfiguration(chartConfiguration: CfnTemplate.BoxPlotChartConfigurationProperty) {
    cdkBuilder.chartConfiguration(chartConfiguration)
  }
  ...
  public fun build(): CfnTemplate.BoxPlotVisualProperty {
