...
public class CfnProjectEnvironmentPropertyDsl {
    ...
    /**
     * @param computeType The type of compute environment. This determines the number of CPU cores
     *   and memory the build environment uses. Available values include:
    ...
    /**
     * @param privilegedMode Enables running the Docker daemon inside a Docker container. Set to
     *   true only if the build project is used to build Docker images. Otherwise, a build that
     ...
     *   [AWS::CodeBuild::Project Environment](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-codebuild-project.html#cfn-codebuild-project-environment)
     *   property that specifies information about credentials that provide access to a private
     ...
     *   (Seoul), Asia Pacific (Singapore), Asia Pacific (Sydney), China (Beijing), and China
     *   (Ningxia).
