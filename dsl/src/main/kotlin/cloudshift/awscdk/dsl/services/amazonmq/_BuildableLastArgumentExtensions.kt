...
public inline fun CfnBroker.setConfiguration(
...
public inline fun CfnBroker.setEncryptionOptions(
...
/** Optional. */
public inline fun CfnBroker.setLdapServerMetadata(
 ...
 */
public inline fun CfnBroker.setMaintenanceWindowStartTime(
...
public inline fun CfnConfigurationAssociation.setConfiguration(
