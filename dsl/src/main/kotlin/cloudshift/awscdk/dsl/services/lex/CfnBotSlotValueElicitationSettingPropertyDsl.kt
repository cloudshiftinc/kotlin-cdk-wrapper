...
public class CfnBotSlotValueElicitationSettingPropertyDsl {
    ...
    public fun defaultValueSpecification(defaultValueSpecification: CfnBot.SlotDefaultValueSpecificationProperty) {
        cdkBuilder.defaultValueSpecification(defaultValueSpecification)
    }
    ...
    public fun waitAndContinueSpecification(waitAndContinueSpecification: CfnBot.WaitAndContinueSpecificationProperty) {
        cdkBuilder.waitAndContinueSpecification(waitAndContinueSpecification)
    }
