...
public class CfnAlarmDsl(
     ...
     * M, and the value that you set for `EvaluationPeriods` is the N value. For more information,
     * see
     ...
     * breaching to trigger the alarm, this value specifies that number. If you are setting an "M
     * out of N" alarm, this value is the N, and `DatapointsToAlarm` is the M.
     *
