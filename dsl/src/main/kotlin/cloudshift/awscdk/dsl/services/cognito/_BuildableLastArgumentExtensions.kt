...
public inline fun CfnUserPool.setUserPoolAddOns(block: CfnUserPoolUserPoolAddOnsPropertyDsl.() -> Unit = {}) {
...
public inline fun ClientAttributes.withStandardAttributes(block: StandardAttributesMaskDsl.() -> Unit = {}): ClientAttributes {
    val builder = StandardAttributesMaskDsl()
    builder.apply(block)
    return withStandardAttributes(builder.build())
}

public inline fun UserPool.addClient(id: String, block: UserPoolClientOptionsDsl.() -> Unit = {}): UserPoolClient {
    val builder = UserPoolClientOptionsDsl()
    builder.apply(block)
    return addClient(id, builder.build())
}

public inline fun UserPool.addDomain(id: String, block: UserPoolDomainOptionsDsl.() -> Unit = {}): UserPoolDomain {
    val builder = UserPoolDomainOptionsDsl()
    builder.apply(block)
