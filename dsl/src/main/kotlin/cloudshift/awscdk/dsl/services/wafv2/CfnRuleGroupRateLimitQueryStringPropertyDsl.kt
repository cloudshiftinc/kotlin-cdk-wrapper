 ...
 */
@CdkDslMarker
public class CfnRuleGroupRateLimitQueryStringPropertyDsl {
    private val cdkBuilder: CfnRuleGroup.RateLimitQueryStringProperty.Builder =
    ...
    public fun build(): CfnRuleGroup.RateLimitQueryStringProperty {
