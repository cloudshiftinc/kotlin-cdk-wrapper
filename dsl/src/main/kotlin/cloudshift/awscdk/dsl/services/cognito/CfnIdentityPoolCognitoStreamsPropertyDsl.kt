...
public class CfnIdentityPoolCognitoStreamsPropertyDsl {
     ...
     *   invoke `PutRecord` on your Amazon Cognito stream.
     */
    ...
    /**
     * @param streamName The name of the Amazon Cognito stream to receive updates. This stream must
     *   be in the developer's account and in the same Region as the identity pool.
     */
    ...
    /**
     * @param streamingStatus Status of the Amazon Cognito streams. Valid values are: `ENABLED` or
     *   `DISABLED` .
     */
