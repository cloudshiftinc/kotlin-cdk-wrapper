...
public class SageMakerCreateEndpointConfigDsl(
  ...
  private val cdkBuilder: SageMakerCreateEndpointConfig.Builder =
      SageMakerCreateEndpointConfig.Builder.create(scope, id)
  ...
  public fun build(): SageMakerCreateEndpointConfig {
