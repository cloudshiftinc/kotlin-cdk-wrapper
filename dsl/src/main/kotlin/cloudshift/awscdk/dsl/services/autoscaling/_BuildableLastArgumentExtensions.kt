...
public inline fun ILifecycleHookTarget.bind(
    arg0: Construct,
...
public inline fun IAutoScalingGroup.addLifecycleHook(
    arg0: String,
...
public inline fun IAutoScalingGroup.addWarmPool(block: WarmPoolOptionsDsl.() -> Unit = {}): WarmPool {
    val builder = WarmPoolOptionsDsl()
    builder.apply(block)
    return addWarmPool(builder.build())
}

public inline fun IAutoScalingGroup.scaleOnCpuUtilization(
    arg0: String,
...
public inline fun IAutoScalingGroup.scaleOnIncomingBytes(
    arg0: String,
...
public inline fun IAutoScalingGroup.scaleOnMetric(
    arg0: String,
...
public inline fun IAutoScalingGroup.scaleOnOutgoingBytes(
    arg0: String,
    block: NetworkUtilizationScalingPropsDsl.() -> Unit = {},
): TargetTrackingScalingPolicy {
    val builder = NetworkUtilizationScalingPropsDsl()
...
public inline fun IAutoScalingGroup.scaleOnSchedule(
    arg0: String,
...
public inline fun IAutoScalingGroup.scaleToTrackMetric(
    arg0: String,
...
public inline fun CfnWarmPool.setInstanceReusePolicy(
...
public inline fun CfnLaunchConfiguration.setMetadataOptions(
...
public inline fun CfnScalingPolicy.setPredictiveScalingConfiguration(
...
public inline fun CfnScalingPolicy.setTargetTrackingConfiguration(
...
public inline fun Signals.renderCreationPolicy(block: RenderSignalsOptionsDsl.() -> Unit = {}): CfnCreationPolicy {
...
public inline fun CfnAutoScalingGroup.setMixedInstancesPolicy(
...
public inline fun AutoScalingGroup.addLifecycleHook(
    id: String,
    block: BasicLifecycleHookPropsDsl.() -> Unit = {},
): LifecycleHook {
    val builder = BasicLifecycleHookPropsDsl()
...
public inline fun AutoScalingGroup.addWarmPool(block: WarmPoolOptionsDsl.() -> Unit = {}): WarmPool {
    val builder = WarmPoolOptionsDsl()
    builder.apply(block)
    return addWarmPool(builder.build())
}

public inline fun AutoScalingGroup.applyCloudFormationInit(
...
public inline fun AutoScalingGroup.scaleOnCpuUtilization(
    id: String,
    block: CpuUtilizationScalingPropsDsl.() -> Unit = {},
): TargetTrackingScalingPolicy {
    val builder = CpuUtilizationScalingPropsDsl()
...
public inline fun AutoScalingGroup.scaleOnIncomingBytes(
    id: String,
    block: NetworkUtilizationScalingPropsDsl.() -> Unit = {},
): TargetTrackingScalingPolicy {
    val builder = NetworkUtilizationScalingPropsDsl()
...
public inline fun AutoScalingGroup.scaleOnMetric(
    id: String,
    block: BasicStepScalingPolicyPropsDsl.() -> Unit = {},
): StepScalingPolicy {
    val builder = BasicStepScalingPolicyPropsDsl()
...
public inline fun AutoScalingGroup.scaleOnOutgoingBytes(
    id: String,
    block: NetworkUtilizationScalingPropsDsl.() -> Unit = {},
): TargetTrackingScalingPolicy {
    val builder = NetworkUtilizationScalingPropsDsl()
...
public inline fun AutoScalingGroup.scaleOnRequestCount(
    id: String,
...
public inline fun AutoScalingGroup.scaleOnSchedule(
    id: String,
    block: BasicScheduledActionPropsDsl.() -> Unit = {},
): ScheduledAction {
    val builder = BasicScheduledActionPropsDsl()
...
public inline fun AutoScalingGroup.scaleToTrackMetric(
    id: String,
    block: MetricTargetTrackingPropsDsl.() -> Unit = {},
): TargetTrackingScalingPolicy {
    val builder = MetricTargetTrackingPropsDsl()
