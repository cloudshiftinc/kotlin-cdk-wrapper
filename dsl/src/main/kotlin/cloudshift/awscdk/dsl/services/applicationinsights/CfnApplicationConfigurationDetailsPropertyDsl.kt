...
public class CfnApplicationConfigurationDetailsPropertyDsl {
    ...
    /**
     * @param alarms A list of alarms to monitor for the component. All component types can use
     *   `Alarm` .
     */
    ...
    public fun haClusterPrometheusExporter(
        haClusterPrometheusExporter: CfnApplication.HAClusterPrometheusExporterProperty
    ) {
        cdkBuilder.haClusterPrometheusExporter(haClusterPrometheusExporter)
    }
    ...
    public fun hanaPrometheusExporter(
        hanaPrometheusExporter: CfnApplication.HANAPrometheusExporterProperty
    ) {
        cdkBuilder.hanaPrometheusExporter(hanaPrometheusExporter)
    }
