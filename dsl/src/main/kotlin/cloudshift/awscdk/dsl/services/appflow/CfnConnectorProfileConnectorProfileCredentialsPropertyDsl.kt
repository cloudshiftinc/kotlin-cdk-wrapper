...
public class CfnConnectorProfileConnectorProfileCredentialsPropertyDsl {
    ...
    public fun amplitude(amplitude: CfnConnectorProfile.AmplitudeConnectorProfileCredentialsProperty) {
        cdkBuilder.amplitude(amplitude)
    }
    ...
    public fun customConnector(customConnector: CfnConnectorProfile.CustomConnectorProfileCredentialsProperty) {
        cdkBuilder.customConnector(customConnector)
    }
    ...
    public fun dynatrace(dynatrace: CfnConnectorProfile.DynatraceConnectorProfileCredentialsProperty) {
        cdkBuilder.dynatrace(dynatrace)
    }
    ...
    public fun googleAnalytics(googleAnalytics: CfnConnectorProfile.GoogleAnalyticsConnectorProfileCredentialsProperty) {
        cdkBuilder.googleAnalytics(googleAnalytics)
    }
    ...
    public fun inforNexus(inforNexus: CfnConnectorProfile.InforNexusConnectorProfileCredentialsProperty) {
        cdkBuilder.inforNexus(inforNexus)
    }
    ...
    public fun salesforce(salesforce: CfnConnectorProfile.SalesforceConnectorProfileCredentialsProperty) {
        cdkBuilder.salesforce(salesforce)
    }
    ...
    public fun serviceNow(serviceNow: CfnConnectorProfile.ServiceNowConnectorProfileCredentialsProperty) {
        cdkBuilder.serviceNow(serviceNow)
    }
    ...
    public fun snowflake(snowflake: CfnConnectorProfile.SnowflakeConnectorProfileCredentialsProperty) {
        cdkBuilder.snowflake(snowflake)
    }
    ...
    public fun trendmicro(trendmicro: CfnConnectorProfile.TrendmicroConnectorProfileCredentialsProperty) {
        cdkBuilder.trendmicro(trendmicro)
    }
