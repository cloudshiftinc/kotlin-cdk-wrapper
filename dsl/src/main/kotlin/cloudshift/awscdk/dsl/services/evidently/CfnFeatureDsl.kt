 ...
 * experiments. A feature must be created in a project. For information about creating a project,
 * see
...
public class CfnFeatureDsl(
     ...
     * user ID, account ID, or some other identifier. For the value, specify the name of the
     * variation that they are to be served.
     *
