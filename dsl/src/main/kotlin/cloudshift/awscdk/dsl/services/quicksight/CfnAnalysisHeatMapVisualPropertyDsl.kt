...
@CdkDslMarker
public class CfnAnalysisHeatMapVisualPropertyDsl {
    private val cdkBuilder: CfnAnalysis.HeatMapVisualProperty.Builder =
    ...
    public fun chartConfiguration(chartConfiguration: CfnAnalysis.HeatMapConfigurationProperty) {
        cdkBuilder.chartConfiguration(chartConfiguration)
    }
    ...
    public fun build(): CfnAnalysis.HeatMapVisualProperty {
