...
public class CfnAuthorizerDsl(
     ...
     * caches authorizer responses. The maximum value is 3600, or 1 hour. Supported only for HTTP
     * API Lambda authorizers.
     *
     ...
     * route.request.header.Auth, route.request.querystring.Name for WebSocket APIs. For HTTP APIs,
     * use selection expressions prefixed with `$` , for example, `$request.header.Auth` ,
