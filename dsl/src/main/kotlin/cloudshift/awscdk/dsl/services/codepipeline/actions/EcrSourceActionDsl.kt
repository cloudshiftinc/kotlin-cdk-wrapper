 ...
 *
 * Will trigger the pipeline as soon as the target tag in the repository changes, but only if there
 * is a CloudTrail Trail in the account that captures the ECR event.
 *
 * Example:
 * ```
