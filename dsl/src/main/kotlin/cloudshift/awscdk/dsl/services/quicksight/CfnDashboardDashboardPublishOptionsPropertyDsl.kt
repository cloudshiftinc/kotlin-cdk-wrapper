...
public class CfnDashboardDashboardPublishOptionsPropertyDsl {
    ...
    public fun dataPointDrillUpDownOption(dataPointDrillUpDownOption: CfnDashboard.DataPointDrillUpDownOptionProperty) {
        cdkBuilder.dataPointDrillUpDownOption(dataPointDrillUpDownOption)
    }
    ...
    public fun dataPointMenuLabelOption(dataPointMenuLabelOption: CfnDashboard.DataPointMenuLabelOptionProperty) {
        cdkBuilder.dataPointMenuLabelOption(dataPointMenuLabelOption)
    }
    ...
    public fun dataPointTooltipOption(dataPointTooltipOption: CfnDashboard.DataPointTooltipOptionProperty) {
        cdkBuilder.dataPointTooltipOption(dataPointTooltipOption)
    }
    ...
    public fun exportWithHiddenFieldsOption(exportWithHiddenFieldsOption: CfnDashboard.ExportWithHiddenFieldsOptionProperty) {
        cdkBuilder.exportWithHiddenFieldsOption(exportWithHiddenFieldsOption)
    }
    ...
    public fun sheetLayoutElementMaximizationOption(sheetLayoutElementMaximizationOption: IResolvable) {
        cdkBuilder.sheetLayoutElementMaximizationOption(sheetLayoutElementMaximizationOption)
    }

    public fun sheetLayoutElementMaximizationOption(sheetLayoutElementMaximizationOption: CfnDashboard.SheetLayoutElementMaximizationOptionProperty) {
        cdkBuilder.sheetLayoutElementMaximizationOption(sheetLayoutElementMaximizationOption)
    }
    ...
    public fun visualPublishOptions(visualPublishOptions: CfnDashboard.DashboardVisualPublishOptionsProperty) {
        cdkBuilder.visualPublishOptions(visualPublishOptions)
    }
