 ...
 */
@CdkDslMarker
public class CfnTemplateRadarChartVisualPropertyDsl {
  private val cdkBuilder: CfnTemplate.RadarChartVisualProperty.Builder =
   ...
   * @param chartConfiguration The configuration settings of the visual.
   */
  public fun chartConfiguration(chartConfiguration: CfnTemplate.RadarChartConfigurationProperty) {
    cdkBuilder.chartConfiguration(chartConfiguration)
  }
  ...
  public fun build(): CfnTemplate.RadarChartVisualProperty {
