...
public class CfnListenerRulePropsDsl {
    ...
    /**
     * @param actions The actions. The rule must include exactly one of the following types of
     *   actions: `forward` , `fixed-response` , or `redirect` , and it must be the last action to
     *   be performed. If the rule is for an HTTPS listener, it can also optionally include an
    ...
    /**
     * @param conditions The conditions. The rule can optionally include up to one of each of the
     *   following conditions: `http-request-method` , `host-header` , `path-pattern` , and
     *   `source-ip` . A rule can also optionally include one or more of each of the following
