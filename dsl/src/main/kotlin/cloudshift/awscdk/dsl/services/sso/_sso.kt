...
public object sso {
    ...
    public inline fun cfnAssignmentProps(block: CfnAssignmentPropsDsl.() -> Unit = {}): CfnAssignmentProps {
    ...
    public inline fun cfnInstanceAccessControlAttributeConfigurationAccessControlAttributeProperty(
        block: CfnInstanceAccessControlAttributeConfigurationAccessControlAttributePropertyDsl.() -> Unit =
            {},
    ...
    public inline fun cfnInstanceAccessControlAttributeConfigurationAccessControlAttributeValueProperty(
        block: CfnInstanceAccessControlAttributeConfigurationAccessControlAttributeValuePropertyDsl.() -> Unit =
            {},
    ...
    public inline fun cfnPermissionSetProps(block: CfnPermissionSetPropsDsl.() -> Unit = {}): CfnPermissionSetProps {
