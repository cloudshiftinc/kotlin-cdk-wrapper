...
public object secretsmanager {
     ...
     *
     * A resource-based policy is optional. If a secret already has a resource policy attached, you
     * must first remove it before attaching a new policy using this CloudFormation resource. You
     * can remove the policy using the
