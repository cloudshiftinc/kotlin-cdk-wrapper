...
public object secretsmanager {
  public inline fun attachedSecretOptions(block: AttachedSecretOptionsDsl.() -> Unit = {}):
  ...
  public inline
      fun cfnRotationScheduleHostedRotationLambdaProperty(block: CfnRotationScheduleHostedRotationLambdaPropertyDsl.() -> Unit
  ...
  public inline fun cfnRotationScheduleProps(block: CfnRotationSchedulePropsDsl.() -> Unit = {}):
  ...
  public inline
      fun cfnRotationScheduleRotationRulesProperty(block: CfnRotationScheduleRotationRulesPropertyDsl.() -> Unit
  ...
  public inline
      fun cfnSecretGenerateSecretStringProperty(block: CfnSecretGenerateSecretStringPropertyDsl.() -> Unit
  ...
  public inline
      fun cfnSecretReplicaRegionProperty(block: CfnSecretReplicaRegionPropertyDsl.() -> Unit = {}):
  ...
  public inline
      fun cfnSecretTargetAttachmentProps(block: CfnSecretTargetAttachmentPropsDsl.() -> Unit = {}):
  ...
  public inline
      fun multiUserHostedRotationOptions(block: MultiUserHostedRotationOptionsDsl.() -> Unit = {}):
  ...
  public inline fun rotationScheduleOptions(block: RotationScheduleOptionsDsl.() -> Unit = {}):
  ...
  public inline fun rotationScheduleProps(block: RotationSchedulePropsDsl.() -> Unit = {}):
  ...
  public inline fun secretAttachmentTargetProps(block: SecretAttachmentTargetPropsDsl.() -> Unit =
  ...
  public inline
      fun secretRotationApplicationOptions(block: SecretRotationApplicationOptionsDsl.() -> Unit =
  ...
  public inline fun secretRotationProps(block: SecretRotationPropsDsl.() -> Unit = {}):
      SecretRotationProps {
  ...
  public inline fun secretStringGenerator(block: SecretStringGeneratorDsl.() -> Unit = {}):
  ...
  public inline fun secretTargetAttachmentProps(block: SecretTargetAttachmentPropsDsl.() -> Unit =
  ...
  public inline
      fun singleUserHostedRotationOptions(block: SingleUserHostedRotationOptionsDsl.() -> Unit =
