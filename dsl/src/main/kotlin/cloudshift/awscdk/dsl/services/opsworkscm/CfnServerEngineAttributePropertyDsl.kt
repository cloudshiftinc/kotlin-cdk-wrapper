...
public class CfnServerEngineAttributePropertyDsl {
   ...
   * is required to access the Chef API. You can generate this key by running the following
   * [OpenSSL](https://docs.aws.amazon.com/https://www.openssl.org/) command on Linux-based computers.
   *
   ...
   * Enterprise console webpage after the server is online. The password must use between 8 and 32
   * ASCII characters.
