...
public class CfnDataSourceConfluenceConfigurationPropertyDsl {
    ...
    public fun attachmentConfiguration(attachmentConfiguration: CfnDataSource.ConfluenceAttachmentConfigurationProperty) {
        cdkBuilder.attachmentConfiguration(attachmentConfiguration)
    }
    ...
    public fun blogConfiguration(blogConfiguration: CfnDataSource.ConfluenceBlogConfigurationProperty) {
        cdkBuilder.blogConfiguration(blogConfiguration)
    }
    ...
    public fun pageConfiguration(pageConfiguration: CfnDataSource.ConfluencePageConfigurationProperty) {
        cdkBuilder.pageConfiguration(pageConfiguration)
    }
    ...
    public fun spaceConfiguration(spaceConfiguration: CfnDataSource.ConfluenceSpaceConfigurationProperty) {
        cdkBuilder.spaceConfiguration(spaceConfiguration)
    }
