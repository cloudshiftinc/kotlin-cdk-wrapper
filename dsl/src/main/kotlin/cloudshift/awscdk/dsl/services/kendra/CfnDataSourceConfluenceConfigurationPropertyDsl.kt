...
public class CfnDataSourceConfluenceConfigurationPropertyDsl {
  ...
  /**
   * @param attachmentConfiguration Configuration information for indexing attachments to Confluence
   * blogs and pages.
   */
   ...
   * pages, spaces, or attachments in your Confluence.
   ...
   * Use the full URL of the server. For example, *https://server.example.com:port/ * . You can also
   * use an IP address, for example, *https://192.168.1.113/ * .
   */
