...
public class CfnJobValidationConfigurationPropertyDsl {
     ...
     *   profile job. The TargetArn of the selected ruleset should be the same as the Amazon
    ...
    /**
     * @param validationMode Mode of data quality validation. Default mode is “CHECK_ALL” which
