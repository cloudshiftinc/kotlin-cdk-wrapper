...
public class CfnChannelChannelStoragePropertyDsl {
    ...
    /**
     * @param customerManagedS3 Used to store channel data in an S3 bucket that you manage. If
     *   customer managed storage is selected, the `retentionPeriod` parameter is ignored. You can't
     ...
     *   Analytics . You can't change the choice of S3 storage after the data store is created.
     */
