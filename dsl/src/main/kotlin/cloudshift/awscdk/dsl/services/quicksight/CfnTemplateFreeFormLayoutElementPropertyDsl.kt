...
public class CfnTemplateFreeFormLayoutElementPropertyDsl {
   ...
   */
  public
      fun backgroundStyle(backgroundStyle: CfnTemplate.FreeFormLayoutElementBackgroundStyleProperty) {
    cdkBuilder.backgroundStyle(backgroundStyle)
  }
   ...
   */
  public
      fun selectedBorderStyle(selectedBorderStyle: CfnTemplate.FreeFormLayoutElementBorderStyleProperty) {
    cdkBuilder.selectedBorderStyle(selectedBorderStyle)
  }
