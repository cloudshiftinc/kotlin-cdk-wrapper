...
public class CfnComponentVersionComponentPlatformPropertyDsl {
    ...
    /**
     * @param attributes A dictionary of attributes for the platform. The AWS IoT Greengrass Core
     *   software defines the `os` and `platform` by default. You can specify additional platform
    ...
    /**
     * @param name The friendly name of the platform. This name helps you identify the platform. If
     *   you omit this parameter, AWS IoT Greengrass creates a friendly name from the `os` and
