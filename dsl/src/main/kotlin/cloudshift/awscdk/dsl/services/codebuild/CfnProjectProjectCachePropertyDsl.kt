...
public class CfnProjectProjectCachePropertyDsl {
    ...
    /**
     * @param modes An array of strings that specify the local cache modes. You can use one or more
     ...
     *   a good choice if your build scenario is not suited to one of the other three local cache
     ...
     *   items are overridden if a source item has the same name. Directories are specified using
