...
public class CfnFunctionRuntimeManagementConfigPropertyDsl {
     ...
     *   runtime version when you update your function. This approach synchronizes runtime updates
     *   with function deployments, giving you control over when runtime updates are applied and
     *   allowing you to detect and mitigate rare runtime update incompatibilities early. When using
     *   this setting, you need to regularly update your functions to keep their runtime up-to-date.
     ...
     *   earlier runtime version. For more information, see
