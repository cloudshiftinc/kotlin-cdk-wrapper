...
public object efs {
  ...
  public inline fun accessPointAttributes(block: AccessPointAttributesDsl.() -> Unit = {}):
  ...
  public inline fun accessPointOptions(block: AccessPointOptionsDsl.() -> Unit = {}):
      AccessPointOptions {
  ...
  public inline
      fun cfnAccessPointAccessPointTagProperty(block: CfnAccessPointAccessPointTagPropertyDsl.() -> Unit
  ...
  public inline
      fun cfnAccessPointCreationInfoProperty(block: CfnAccessPointCreationInfoPropertyDsl.() -> Unit
  ...
  public inline
      fun cfnAccessPointPosixUserProperty(block: CfnAccessPointPosixUserPropertyDsl.() -> Unit =
  ...
  public inline
      fun cfnAccessPointRootDirectoryProperty(block: CfnAccessPointRootDirectoryPropertyDsl.() -> Unit
  ...
  public inline
      fun cfnFileSystemBackupPolicyProperty(block: CfnFileSystemBackupPolicyPropertyDsl.() -> Unit =
  ...
  public inline
      fun cfnFileSystemElasticFileSystemTagProperty(block: CfnFileSystemElasticFileSystemTagPropertyDsl.() -> Unit
  ...
  public inline
      fun cfnFileSystemLifecyclePolicyProperty(block: CfnFileSystemLifecyclePolicyPropertyDsl.() -> Unit
  ...
  public inline fun cfnMountTargetProps(block: CfnMountTargetPropsDsl.() -> Unit = {}):
      CfnMountTargetProps {
