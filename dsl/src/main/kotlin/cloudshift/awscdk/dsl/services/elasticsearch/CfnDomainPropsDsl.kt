...
public class CfnDomainPropsDsl {
    ...
    /**
     * @param domainName A name for the OpenSearch Service domain. For valid values, see the
     ...
     *   in the *Amazon OpenSearch Service Developer Guide* . If you set the
     ...
     *   AWS Key Management Service key to use. See
