...
public class CfnAnalysisDefaultNewSheetConfigurationPropertyDsl {
    ...
    public fun interactiveLayoutConfiguration(
        interactiveLayoutConfiguration: CfnAnalysis.DefaultInteractiveLayoutConfigurationProperty
    ) {
        cdkBuilder.interactiveLayoutConfiguration(interactiveLayoutConfiguration)
    }
    ...
    public fun paginatedLayoutConfiguration(
        paginatedLayoutConfiguration: CfnAnalysis.DefaultPaginatedLayoutConfigurationProperty
    ) {
        cdkBuilder.paginatedLayoutConfiguration(paginatedLayoutConfiguration)
    }
