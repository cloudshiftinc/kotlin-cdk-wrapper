 ...
 */
@CdkDslMarker
public class CfnTemplateLineChartVisualPropertyDsl {
    private val cdkBuilder: CfnTemplate.LineChartVisualProperty.Builder =
    ...
    /** @param chartConfiguration The configuration of a line chart. */
    public fun chartConfiguration(chartConfiguration: CfnTemplate.LineChartConfigurationProperty) {
        cdkBuilder.chartConfiguration(chartConfiguration)
    }
    ...
    public fun build(): CfnTemplate.LineChartVisualProperty {
