...
public class HttpGatewayRoutePathMatchConfigDsl {
  ...
  public
      fun prefixPathRewrite(block: CfnGatewayRouteHttpGatewayRoutePrefixRewritePropertyDsl.() -> Unit
      = {}) {
  ...
  public
      fun wholePathRewrite(block: CfnGatewayRouteHttpGatewayRoutePathRewritePropertyDsl.() -> Unit =
      {}) {
