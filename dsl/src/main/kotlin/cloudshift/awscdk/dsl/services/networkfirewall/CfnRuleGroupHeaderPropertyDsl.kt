...
public class CfnRuleGroupHeaderPropertyDsl {
    ...
    /**
     * @param destinationPort The destination port to inspect for. You can specify an individual
     *   port, for example `1994` and you can specify a port range, for example `1990:1994` . To
    ...
    /**
     * @param direction The direction of traffic flow to inspect. If set to `ANY` , the inspection
     *   matches bidirectional traffic, both from the source to the destination and from the
     *   destination to the source. If set to `FORWARD` , the inspection only matches traffic going
    ...
    /**
     * @param protocol The protocol to inspect for. To specify all, you can use `IP` , because all
    ...
    /**
     * @param source The source IP address or address range to inspect for, in CIDR notation. To
    ...
    /**
     * @param sourcePort The source port to inspect for. You can specify an individual port, for
     *   example `1994` and you can specify a port range, for example `1990:1994` . To match with
