...
public class TaskDefinitionPropsDsl {
    ...
    /**
     * @param cpu The number of cpu units used by the task. If you are using the EC2 launch type,
     *   this field is optional and any value can be used. If you are using the Fargate launch type,
     ...
     *   task. Only supported in Fargate platform version 1.4.0 or later.
     */
    ...
    /**
     * @param ipcMode The IPC resource namespace to use for the containers in the task. Not
     *   supported in Fargate and Windows containers.
     */
    ...
    /**
     * @param memoryMiB The amount (in MiB) of memory used by the task. If using the EC2 launch
     *   type, this field is optional and any value can be used. If using the Fargate launch type,
     *   this field is required and you must use one of the following values, which determines your
    ...
    /**
     * @param networkMode The networking mode to use for the containers in the task. On Fargate, the
     *   only supported networking mode is AwsVpc.
     */
    ...
    /**
     * @param pidMode The process namespace to use for the containers in the task. Not supported in
     *   Fargate and Windows containers.
     */
    ...
    /**
     * @param placementConstraints The placement constraints to use for tasks in the service. You
     *   can specify a maximum of 10 constraints per task (this limit includes constraints in the
    ...
    /**
     * @param runtimePlatform The operating system that your task definitions are running on. A
     *   runtimePlatform is supported only for tasks using the Fargate launch type.
     */
