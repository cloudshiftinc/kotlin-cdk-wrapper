...
public object appsync {
    ...
    public inline fun appsyncFunctionAttributes(block: AppsyncFunctionAttributesDsl.() -> Unit = {}): AppsyncFunctionAttributes {
        val builder = AppsyncFunctionAttributesDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun appsyncFunctionProps(block: AppsyncFunctionPropsDsl.() -> Unit = {}): AppsyncFunctionProps {
    ...
    public inline fun authorizationMode(block: AuthorizationModeDsl.() -> Unit = {}): AuthorizationMode {
    ...
    public inline fun backedDataSourceProps(block: BackedDataSourcePropsDsl.() -> Unit = {}): BackedDataSourceProps {
        val builder = BackedDataSourcePropsDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun baseAppsyncFunctionProps(block: BaseAppsyncFunctionPropsDsl.() -> Unit = {}): BaseAppsyncFunctionProps {
        val builder = BaseAppsyncFunctionPropsDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun baseDataSourceProps(block: BaseDataSourcePropsDsl.() -> Unit = {}): BaseDataSourceProps {
        val builder = BaseDataSourcePropsDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun baseResolverProps(block: BaseResolverPropsDsl.() -> Unit = {}): BaseResolverProps {
    ...
    public inline fun cfnGraphQLApiProps(block: CfnGraphQLApiPropsDsl.() -> Unit = {}): CfnGraphQLApiProps {
    ...
    public inline fun cfnGraphQLSchemaProps(block: CfnGraphQLSchemaPropsDsl.() -> Unit = {}): CfnGraphQLSchemaProps {
    ...
    public inline fun dataSourceOptions(block: DataSourceOptionsDsl.() -> Unit = {}): DataSourceOptions {
    ...
    public inline fun dynamoDbDataSourceProps(block: DynamoDbDataSourcePropsDsl.() -> Unit = {}): DynamoDbDataSourceProps {
    ...
    public inline fun extendedDataSourceProps(block: ExtendedDataSourcePropsDsl.() -> Unit = {}): ExtendedDataSourceProps {
        val builder = ExtendedDataSourcePropsDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun extendedResolverProps(block: ExtendedResolverPropsDsl.() -> Unit = {}): ExtendedResolverProps {
    ...
    public inline fun graphqlApiAttributes(block: GraphqlApiAttributesDsl.() -> Unit = {}): GraphqlApiAttributes {
    ...
    public inline fun httpDataSourceOptions(block: HttpDataSourceOptionsDsl.() -> Unit = {}): HttpDataSourceOptions {
        val builder = HttpDataSourceOptionsDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun httpDataSourceProps(block: HttpDataSourcePropsDsl.() -> Unit = {}): HttpDataSourceProps {
        val builder = HttpDataSourcePropsDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun lambdaAuthorizerConfig(block: LambdaAuthorizerConfigDsl.() -> Unit = {}): LambdaAuthorizerConfig {
    ...
    public inline fun lambdaDataSourceProps(block: LambdaDataSourcePropsDsl.() -> Unit = {}): LambdaDataSourceProps {
    ...
    public inline fun noneDataSourceProps(block: NoneDataSourcePropsDsl.() -> Unit = {}): NoneDataSourceProps {
        val builder = NoneDataSourcePropsDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun openIdConnectConfig(block: OpenIdConnectConfigDsl.() -> Unit = {}): OpenIdConnectConfig {
    ...
    public inline fun openSearchDataSourceProps(block: OpenSearchDataSourcePropsDsl.() -> Unit = {}): OpenSearchDataSourceProps {
    ...
    public inline fun rdsDataSourceProps(block: RdsDataSourcePropsDsl.() -> Unit = {}): RdsDataSourceProps {
    ...
    public inline fun schemaBindOptions(block: SchemaBindOptionsDsl.() -> Unit = {}): SchemaBindOptions {
