 ...
 * defined in the `AWS::AutoScaling::AutoScalingGroup` section of your template. However, you might
 * not want CloudFormation to do that when you have a scheduled action in effect. You can use an
 ...
 * values during a stack update unless you modified the individual values in your template. If you
 * have rolling updates enabled, before you can update the Auto Scaling group, you must suspend
 ...
 * [Scheduled scaling](https://docs.aws.amazon.com/autoscaling/ec2/userguide/schedule_time.html) and
