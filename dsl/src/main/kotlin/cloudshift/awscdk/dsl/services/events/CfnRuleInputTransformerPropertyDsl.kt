...
public class CfnRuleInputTransformerPropertyDsl {
   ...
   * You can then insert these in the template in `InputTemplate` to produce the output you want to
  ...
  /**
   * @param inputTemplate Input template where you specify placeholders that will be filled with the
