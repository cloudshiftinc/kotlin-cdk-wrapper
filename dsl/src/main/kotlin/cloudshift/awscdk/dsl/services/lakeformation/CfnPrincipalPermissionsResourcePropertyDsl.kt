...
public class CfnPrincipalPermissionsResourcePropertyDsl {
    ...
    /**
     * @param catalog The identifier for the Data Catalog. By default, the account ID. The Data
    ...
    public fun dataCellsFilter(
        dataCellsFilter: CfnPrincipalPermissions.DataCellsFilterResourceProperty
    ) {
        cdkBuilder.dataCellsFilter(dataCellsFilter)
    }
    ...
    /**
     * @param database The database for the resource. Unique to the Data Catalog. A database is a
     *   set of associated table definitions organized into a logical group. You can Grant and
    ...
    /**
     * @param table The table for the resource. A table is a metadata definition that represents
    ...
    /**
     * @param tableWithColumns The table with columns for the resource. A principal with permissions
     *   to this resource can select metadata from the columns of a table in the Data Catalog and
    ...
    public fun tableWithColumns(
        tableWithColumns: CfnPrincipalPermissions.TableWithColumnsResourceProperty
    ) {
        cdkBuilder.tableWithColumns(tableWithColumns)
    }
