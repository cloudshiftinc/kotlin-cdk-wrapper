...
public class CfnInstanceNetworkInterfacePropertyDsl {
   ...
   * instance.
   * Applies only if creating a network interface when launching an instance. The network interface
   * must be the primary network interface. If launching into a default subnet, the default value is
   * `true` .
   */
