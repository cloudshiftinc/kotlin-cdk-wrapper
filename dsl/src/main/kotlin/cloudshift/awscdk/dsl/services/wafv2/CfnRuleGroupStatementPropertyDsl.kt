...
public class CfnRuleGroupStatementPropertyDsl {
    ...
    public fun ipSetReferenceStatement(
        ipSetReferenceStatement: CfnRuleGroup.IPSetReferenceStatementProperty
    ) {
        cdkBuilder.ipSetReferenceStatement(ipSetReferenceStatement)
    }
    ...
    /**
     * @param rateBasedStatement A rate-based rule tracks the rate of requests for each originating
     *   IP address, and triggers the rule action when the rate exceeds a limit that you specify on
     *   the number of requests in any 5-minute time span. You can use this to put a temporary block
     *   on requests from an IP address that is sending excessive requests.
     *
    ...
    public fun regexPatternSetReferenceStatement(
        regexPatternSetReferenceStatement: CfnRuleGroup.RegexPatternSetReferenceStatementProperty
    ) {
        cdkBuilder.regexPatternSetReferenceStatement(regexPatternSetReferenceStatement)
    }
    ...
    public fun sizeConstraintStatement(
        sizeConstraintStatement: CfnRuleGroup.SizeConstraintStatementProperty
    ) {
        cdkBuilder.sizeConstraintStatement(sizeConstraintStatement)
    }
