...
public class CfnRuleGroupStatementPropertyDsl {
    ...
    public fun ipSetReferenceStatement(ipSetReferenceStatement: CfnRuleGroup.IPSetReferenceStatementProperty) {
        cdkBuilder.ipSetReferenceStatement(ipSetReferenceStatement)
    }
    ...
    public fun regexPatternSetReferenceStatement(regexPatternSetReferenceStatement: CfnRuleGroup.RegexPatternSetReferenceStatementProperty) {
        cdkBuilder.regexPatternSetReferenceStatement(regexPatternSetReferenceStatement)
    }
    ...
    public fun sizeConstraintStatement(sizeConstraintStatement: CfnRuleGroup.SizeConstraintStatementProperty) {
        cdkBuilder.sizeConstraintStatement(sizeConstraintStatement)
    }
