...
public class CfnChannelCaptionDestinationSettingsPropertyDsl {
     ...
     * @param aribDestinationSettings The configuration of one ARIB captions encode in the output.
     */
    public fun aribDestinationSettings(
        aribDestinationSettings: CfnChannel.AribDestinationSettingsProperty
    ) {
        cdkBuilder.aribDestinationSettings(aribDestinationSettings)
    }
     ...
     *   output.
     */
    public fun burnInDestinationSettings(
        burnInDestinationSettings: CfnChannel.BurnInDestinationSettingsProperty
    ) {
        cdkBuilder.burnInDestinationSettings(burnInDestinationSettings)
    }
     ...
     *   output.
     */
    public fun dvbSubDestinationSettings(
        dvbSubDestinationSettings: CfnChannel.DvbSubDestinationSettingsProperty
    ) {
        cdkBuilder.dvbSubDestinationSettings(dvbSubDestinationSettings)
    }
    ...
    /** @param ebuTtDDestinationSettings Settings for EBU-TT captions in the output. */
    public fun ebuTtDDestinationSettings(
        ebuTtDDestinationSettings: CfnChannel.EbuTtDDestinationSettingsProperty
    ) {
        cdkBuilder.ebuTtDDestinationSettings(ebuTtDDestinationSettings)
    }
     ...
     *   output.
     */
    public fun embeddedDestinationSettings(
        embeddedDestinationSettings: CfnChannel.EmbeddedDestinationSettingsProperty
    ) {
        cdkBuilder.embeddedDestinationSettings(embeddedDestinationSettings)
    }
     ...
     */
    public fun embeddedPlusScte20DestinationSettings(
        embeddedPlusScte20DestinationSettings: IResolvable
    ) {
     ...
     *   encode in the output.
     */
    public fun rtmpCaptionInfoDestinationSettings(
        rtmpCaptionInfoDestinationSettings: CfnChannel.RtmpCaptionInfoDestinationSettingsProperty
    ) {
        cdkBuilder.rtmpCaptionInfoDestinationSettings(rtmpCaptionInfoDestinationSettings)
    }
     ...
     *   captions encode in the output.
     */
    public fun scte20PlusEmbeddedDestinationSettings(
        scte20PlusEmbeddedDestinationSettings: IResolvable
    ) {
     ...
     *   output.
     */
    public fun scte27DestinationSettings(
        scte27DestinationSettings: CfnChannel.Scte27DestinationSettingsProperty
    ) {
        cdkBuilder.scte27DestinationSettings(scte27DestinationSettings)
    }
     ...
     *   output.
     */
    public fun smpteTtDestinationSettings(
        smpteTtDestinationSettings: CfnChannel.SmpteTtDestinationSettingsProperty
    ) {
        cdkBuilder.smpteTtDestinationSettings(smpteTtDestinationSettings)
    }
     ...
     *   output.
     */
    public fun teletextDestinationSettings(
        teletextDestinationSettings: CfnChannel.TeletextDestinationSettingsProperty
    ) {
        cdkBuilder.teletextDestinationSettings(teletextDestinationSettings)
    }
     ...
     * @param ttmlDestinationSettings The configuration of one TTML captions encode in the output.
     */
    public fun ttmlDestinationSettings(
        ttmlDestinationSettings: CfnChannel.TtmlDestinationSettingsProperty
    ) {
        cdkBuilder.ttmlDestinationSettings(ttmlDestinationSettings)
    }
     ...
     *   output.
     */
    public fun webvttDestinationSettings(
        webvttDestinationSettings: CfnChannel.WebvttDestinationSettingsProperty
    ) {
        cdkBuilder.webvttDestinationSettings(webvttDestinationSettings)
    }
