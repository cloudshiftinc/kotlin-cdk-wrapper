 ...
 * The cluster subnet group identifies the subnets of your VPC that Amazon Redshift uses when
 * creating the cluster. For more information about managing clusters, go to
...
public class CfnClusterDsl(
     ...
     * service automatically apply upgrades during the maintenance window to the Amazon Redshift
     ...
     * SQL client and use SQL commands to create a database. For more information, go to
