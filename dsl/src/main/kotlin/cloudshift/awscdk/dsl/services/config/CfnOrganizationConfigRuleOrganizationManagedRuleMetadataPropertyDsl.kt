...
public class CfnOrganizationConfigRuleOrganizationManagedRuleMetadataPropertyDsl {
     ...
     *   for a rule. This is for an AWS Config managed rule that is triggered at a periodic
     *   frequency.
     *
     ...
     *   list. For example, `IAM_PASSWORD_POLICY` is a managed rule. To reference a managed rule,
     *   see
