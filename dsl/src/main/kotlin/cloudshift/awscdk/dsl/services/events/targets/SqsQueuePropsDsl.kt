...
public class SqsQueuePropsDsl {
    ...
    /**
     * @param message The message to send to the queue. Must be a valid JSON text passed to the
     *   target queue.
     */
    ...
    /**
     * @param messageGroupId Message Group ID for messages sent to this queue. Required for FIFO
     *   queues, leave empty for regular queues.
     */
