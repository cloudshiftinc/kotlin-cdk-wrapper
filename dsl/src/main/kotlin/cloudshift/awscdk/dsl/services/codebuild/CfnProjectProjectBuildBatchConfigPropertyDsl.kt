...
public class CfnProjectProjectBuildBatchConfigPropertyDsl {
   ...
   * GitHub Enterprise, and your project is configured to report build statuses to the source provider.
   *
  ...
  /**
   * @param combineArtifacts Specifies if the build artifacts for the batch build should be combined
  ...
  /**
   * @param restrictions A `BatchRestrictions` object that specifies the restrictions for the batch
   * build.
   */
