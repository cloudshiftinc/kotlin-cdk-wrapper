...
public class CfnComponentVersionPropsDsl {
    ...
    /**
     * @param lambdaFunction The parameters to create a component from a Lambda function. You must
    ...
    /**
     * @param tags Application-specific metadata to attach to the component version. You can use
