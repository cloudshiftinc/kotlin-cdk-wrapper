...
public class CfnModelPackageTransformResourcesPropertyDsl {
   ...
   * The default value is `1` , and the maximum is `100` . For distributed transform jobs, specify a
   ...
   * If you are using built-in algorithms to transform moderately sized datasets, we recommend using
   ...
   * to encrypt model data on the storage volume attached to the ML compute instance(s) that run the
   * batch transform job.
   *
