...
public class CfnDatastoreDatastoreStoragePropertyDsl {
     ...
     *   Amazon S3 bucket that you manage. You can't change the choice of Amazon S3 storage after
    ...
    public fun iotSiteWiseMultiLayerStorage(
        iotSiteWiseMultiLayerStorage: CfnDatastore.IotSiteWiseMultiLayerStorageProperty
    ) {
        cdkBuilder.iotSiteWiseMultiLayerStorage(iotSiteWiseMultiLayerStorage)
    }
     ...
     *   IoT Analytics service. The choice of service-managed or customer-managed S3 storage cannot
