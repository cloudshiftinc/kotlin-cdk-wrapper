...
public class CfnPlaceIndexPropsDsl {
     ...
     * [AWS Service Terms](https://docs.aws.amazon.com/service-terms/) for Amazon Location Service.
     *
    ...
    public fun dataSourceConfiguration(
        dataSourceConfiguration: CfnPlaceIndex.DataSourceConfigurationProperty
    ) {
        cdkBuilder.dataSourceConfiguration(dataSourceConfiguration)
    }
    ...
    /**
     * @param indexName The name of the place index resource. Requirements:
