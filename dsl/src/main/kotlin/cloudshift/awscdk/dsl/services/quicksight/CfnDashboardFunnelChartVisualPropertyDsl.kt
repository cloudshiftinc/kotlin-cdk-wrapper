...
@CdkDslMarker
public class CfnDashboardFunnelChartVisualPropertyDsl {
    private val cdkBuilder: CfnDashboard.FunnelChartVisualProperty.Builder =
    ...
    public fun chartConfiguration(chartConfiguration: CfnDashboard.FunnelChartConfigurationProperty) {
        cdkBuilder.chartConfiguration(chartConfiguration)
    }
    ...
    public fun build(): CfnDashboard.FunnelChartVisualProperty {
