...
public object dlm {
     ...
     */
    public inline fun cfnLifecyclePolicyArchiveRetainRuleProperty(
        block: CfnLifecyclePolicyArchiveRetainRulePropertyDsl.() -> Unit = {}
     ...
     */
    public inline fun cfnLifecyclePolicyArchiveRuleProperty(
        block: CfnLifecyclePolicyArchiveRulePropertyDsl.() -> Unit = {}
     ...
     */
    public inline fun cfnLifecyclePolicyCreateRuleProperty(
        block: CfnLifecyclePolicyCreateRulePropertyDsl.() -> Unit = {}
     ...
     */
    public inline fun cfnLifecyclePolicyCrossRegionCopyActionProperty(
        block: CfnLifecyclePolicyCrossRegionCopyActionPropertyDsl.() -> Unit = {}
     ...
     */
    public inline fun cfnLifecyclePolicyCrossRegionCopyDeprecateRuleProperty(
        block: CfnLifecyclePolicyCrossRegionCopyDeprecateRulePropertyDsl.() -> Unit = {}
     ...
     */
    public inline fun cfnLifecyclePolicyCrossRegionCopyRetainRuleProperty(
        block: CfnLifecyclePolicyCrossRegionCopyRetainRulePropertyDsl.() -> Unit = {}
     ...
     */
    public inline fun cfnLifecyclePolicyCrossRegionCopyRuleProperty(
        block: CfnLifecyclePolicyCrossRegionCopyRulePropertyDsl.() -> Unit = {}
     ...
     */
    public inline fun cfnLifecyclePolicyDeprecateRuleProperty(
        block: CfnLifecyclePolicyDeprecateRulePropertyDsl.() -> Unit = {}
     ...
     */
    public inline fun cfnLifecyclePolicyEncryptionConfigurationProperty(
        block: CfnLifecyclePolicyEncryptionConfigurationPropertyDsl.() -> Unit = {}
     ...
     */
    public inline fun cfnLifecyclePolicyEventParametersProperty(
        block: CfnLifecyclePolicyEventParametersPropertyDsl.() -> Unit = {}
     ...
     */
    public inline fun cfnLifecyclePolicyEventSourceProperty(
        block: CfnLifecyclePolicyEventSourcePropertyDsl.() -> Unit = {}
     ...
     */
    public inline fun cfnLifecyclePolicyFastRestoreRuleProperty(
        block: CfnLifecyclePolicyFastRestoreRulePropertyDsl.() -> Unit = {}
     ...
     * type.
     *
     * If you choose to exclude boot volumes and you specify tags that consequently exclude all of
     * the additional data volumes attached to an instance, then Amazon Data Lifecycle Manager will
     * not create any snapshots for the affected instance, and it will emit a
     * `SnapshotsCreateFailed` Amazon CloudWatch metric. For more information, see
     ...
     */
    public inline fun cfnLifecyclePolicyParametersProperty(
        block: CfnLifecyclePolicyParametersPropertyDsl.() -> Unit = {}
     ...
     */
    public inline fun cfnLifecyclePolicyPolicyDetailsProperty(
     ...
     */
    public inline fun cfnLifecyclePolicyRetainRuleProperty(
        block: CfnLifecyclePolicyRetainRulePropertyDsl.() -> Unit = {}
     ...
     */
    public inline fun cfnLifecyclePolicyRetentionArchiveTierProperty(
        block: CfnLifecyclePolicyRetentionArchiveTierPropertyDsl.() -> Unit = {}
     ...
     */
    public inline fun cfnLifecyclePolicyScheduleProperty(
        block: CfnLifecyclePolicySchedulePropertyDsl.() -> Unit = {}
     ...
     */
    public inline fun cfnLifecyclePolicyShareRuleProperty(
        block: CfnLifecyclePolicyShareRulePropertyDsl.() -> Unit = {}
