...
@CdkDslMarker
public class CfnDashboardSankeyDiagramVisualPropertyDsl {
    private val cdkBuilder: CfnDashboard.SankeyDiagramVisualProperty.Builder =
    ...
    public fun chartConfiguration(chartConfiguration: CfnDashboard.SankeyDiagramChartConfigurationProperty) {
        cdkBuilder.chartConfiguration(chartConfiguration)
    }
    ...
    public fun build(): CfnDashboard.SankeyDiagramVisualProperty {
