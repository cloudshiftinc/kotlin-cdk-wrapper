...
@CdkDslMarker
public class AthenaGetQueryExecutionDsl(
  scope: Construct,
  id: String,
) {
  private val cdkBuilder: AthenaGetQueryExecution.Builder =
      AthenaGetQueryExecution.Builder.create(scope, id)
  ...
  public fun build(): AthenaGetQueryExecution = cdkBuilder.build()
}
