...
public class CfnGroupDsl(
     ...
     * For example, you cannot create groups named both "ADMINS" and "admins". If you don't specify
     * a name, AWS CloudFormation generates a unique physical ID and uses that ID for the group
     * name.
     *
