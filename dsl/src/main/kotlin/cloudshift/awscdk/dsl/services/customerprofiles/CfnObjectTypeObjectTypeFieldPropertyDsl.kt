...
public class CfnObjectTypeObjectTypeFieldPropertyDsl {
    ...
    /**
     * @param source A field of a ProfileObject. For example: _source.FirstName, where “_source” is
     *   a ProfileObjectType of a Zendesk user and “FirstName” is a field in that ObjectType.
     */
    ...
    /**
     * @param target The location of the data in the standard ProfileObject model. For example:
