...
public class ClusterPropsDsl {
  ...
  /**
   * @param placeClusterHandlerInVpc If set to true, the cluster handler functions will be placed in
   * the private subnets of the cluster vpc, subject to the `vpcSubnets` selection strategy.
   */
