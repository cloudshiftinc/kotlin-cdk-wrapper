...
public class CfnScalableTargetSuspendedStatePropertyDsl {
     ...
     *   step scaling policy is suspended. Set the value to `true` if you don't want Application
     *   Auto Scaling to remove capacity when a scaling policy is triggered. The default is `false`
     *   .
     */
     ...
     *   step scaling policy is suspended. Set the value to `true` if you don't want Application
     *   Auto Scaling to add capacity when a scaling policy is triggered. The default is `false` .
     */
    ...
    /**
     * @param scheduledScalingSuspended Whether scheduled scaling is suspended. Set the value to
     *   `true` if you don't want Application Auto Scaling to add or remove capacity by initiating
