 ...
 * as needed, according to the type. You specify a single request component in `FieldToMatch` for
 * each rule statement that requires it. To inspect more than one component of the web request,
...
public class CfnWebACLFieldToMatchPropertyDsl {
    ...
    /**
     * @param body Inspect the request body as plain text. The request body immediately follows the
     *   request headers. This is the part of a request that contains any additional data that you
     ...
     * distributions, the limit is 16 KB (16,384 bytes). For CloudFront distributions, you can
    ...
    /**
     * @param cookies Inspect the request cookies. You must configure scope and pattern matching
     *   filters in the `Cookies` object, to define the set of cookies and the parts of the cookies
    ...
    /**
     * @param headers Inspect the request headers. You must configure scope and pattern matching
     *   filters in the `Headers` object, to define the set of headers to and the parts of the
    ...
    /**
     * @param jsonBody Inspect the request body as JSON. The request body immediately follows the
     *   request headers. This is the part of a request that contains any additional data that you
     *   want to send to your web server as the HTTP request body, such as data from a form.
     *
     * A limited amount of the request body is forwarded to AWS WAF for inspection by the underlying
    ...
    /**
     * @param method Inspect the HTTP method. The method indicates the type of operation that the
    ...
    /**
     * @param queryString Inspect the query string. This is the part of a URL that appears after a
     *   `?` character, if any.
     */
    ...
    /**
     * @param singleHeader Inspect a single header. Provide the name of the header to inspect, for
    ...
    /**
     * @param singleQueryArgument Inspect a single query argument. Provide the name of the query
     *   argument to inspect, such as *UserName* or *SalesRegion* . The name can be up to 30
     *   characters long and isn't case sensitive.
     *
