...
public class CfnDeliveryStreamSplunkDestinationConfigurationPropertyDsl {
  ...
  /**
   * @param hecAcknowledgmentTimeoutInSeconds The amount of time that Kinesis Data Firehose waits to
   * receive an acknowledgment from Splunk after it sends it data.
   * At the end of the timeout period, Kinesis Data Firehose either tries to send the data again or
  ...
  /**
   * @param hecEndpoint The HTTP Event Collector (HEC) endpoint to which Kinesis Data Firehose sends
   * your data. 
   */
  ...
  /**
   * @param retryOptions The retry behavior in case Kinesis Data Firehose is unable to deliver data
   ...
   * When set to `FailedEventsOnly` , Kinesis Data Firehose writes any data that could not be
   * indexed to the configured Amazon S3 destination. When set to `AllEvents` , Kinesis Data Firehose
