...
public object events {
    ...
    public inline fun cfnApiDestinationProps(block: CfnApiDestinationPropsDsl.() -> Unit = {}): CfnApiDestinationProps {
    ...
    public inline fun cfnEventBusPolicyProps(block: CfnEventBusPolicyPropsDsl.() -> Unit = {}): CfnEventBusPolicyProps {
    ...
    public inline fun cfnRuleTagProperty(block: CfnRuleTagPropertyDsl.() -> Unit = {}): CfnRule.TagProperty {
        val builder = CfnRuleTagPropertyDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun cfnRuleTargetProperty(block: CfnRuleTargetPropertyDsl.() -> Unit = {}): CfnRule.TargetProperty {
    ...
    public inline fun connectionAttributes(block: ConnectionAttributesDsl.() -> Unit = {}): ConnectionAttributes {
    ...
    public inline fun eventBusAttributes(block: EventBusAttributesDsl.() -> Unit = {}): EventBusAttributes {
    ...
    public inline fun eventBusPolicyProps(block: EventBusPolicyPropsDsl.() -> Unit = {}): EventBusPolicyProps {
    ...
    public inline fun eventCommonOptions(block: EventCommonOptionsDsl.() -> Unit = {}): EventCommonOptions {
    ...
    public inline fun oAuthAuthorizationProps(block: OAuthAuthorizationPropsDsl.() -> Unit = {}): OAuthAuthorizationProps {
    ...
    public inline fun ruleTargetInputProperties(block: RuleTargetInputPropertiesDsl.() -> Unit = {}): RuleTargetInputProperties {
