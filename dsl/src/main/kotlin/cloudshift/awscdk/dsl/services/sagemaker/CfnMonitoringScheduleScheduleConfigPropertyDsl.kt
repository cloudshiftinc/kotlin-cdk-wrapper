...
public class CfnMonitoringScheduleScheduleConfigPropertyDsl {
   ...
   *
   *
   * * Even though the cron expression is set to start at 5PM UTC, note that there could be a delay
   * of 0-20 minutes from the actual requested time to run the execution.
