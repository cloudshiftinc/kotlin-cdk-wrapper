 ...
 * the trigger type is periodic. You can specify the parameter values for `SourceDetail` only for
 * custom rules.
 *
 * Example:
 * ```
...
public class CfnConfigRuleSourceDetailPropertyDsl {
    ...
    /**
     * @param eventSource The source of the event, such as an AWS service, that triggers AWS Config
    ...
    /**
     * @param messageType The type of notification that triggers AWS Config to run an evaluation for
