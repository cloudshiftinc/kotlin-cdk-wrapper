...
public class CfnLaunchTemplateNetworkInterfacePropertyDsl {
  ...
  /**
   * @param associateCarrierIpAddress Indicates whether to associate a Carrier IP address with eth0
  ...
  /**
   * @param ipv4PrefixCount The number of IPv4 prefixes to be automatically assigned to the network
   * interface.
  ...
  /**
   * @param ipv6PrefixCount The number of IPv6 prefixes to be automatically assigned to the network
   * interface.
