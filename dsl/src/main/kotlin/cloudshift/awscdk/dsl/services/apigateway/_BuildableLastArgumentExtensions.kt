...
public inline fun StageBase.addApiKey(id: String, block: ApiKeyOptionsDsl.() -> Unit = {}): IApiKey {
    val builder = ApiKeyOptionsDsl()
    builder.apply(block)
    return addApiKey(id, builder.build())
}

public inline fun StageBase.metric(metricName: String, block: MetricOptionsDsl.() -> Unit = {}): Metric {
...
public inline fun StageBase.metricIntegrationLatency(block: MetricOptionsDsl.() -> Unit = {}): Metric {
    val builder = MetricOptionsDsl()
    builder.apply(block)
...
public inline fun IResource.addProxy(block: ProxyResourceOptionsDsl.() -> Unit = {}): ProxyResource {
    val builder = ProxyResourceOptionsDsl()
    builder.apply(block)
    return addProxy(builder.build())
}

public inline fun IResource.addResource(arg0: String, block: ResourceOptionsDsl.() -> Unit = {}): Resource {
    val builder = ResourceOptionsDsl()
    builder.apply(block)
    return addResource(arg0, builder.build())
}

public inline fun RestApiBase.addApiKey(id: String, block: ApiKeyOptionsDsl.() -> Unit = {}): IApiKey {
    val builder = ApiKeyOptionsDsl()
    builder.apply(block)
    return addApiKey(id, builder.build())
}
...
public inline fun RestApiBase.addUsagePlan(id: String, block: UsagePlanPropsDsl.() -> Unit = {}): UsagePlan {
    val builder = UsagePlanPropsDsl()
    builder.apply(block)
    return addUsagePlan(id, builder.build())
}

public inline fun RestApiBase.metric(metricName: String, block: MetricOptionsDsl.() -> Unit = {}): Metric {
    val builder = MetricOptionsDsl()
    builder.apply(block)
    return metric(metricName, builder.build())
}
...
public inline fun RestApiBase.metricCacheMissCount(block: MetricOptionsDsl.() -> Unit = {}): Metric {
    val builder = MetricOptionsDsl()
    builder.apply(block)
    return metricCacheMissCount(builder.build())
}
...
public inline fun RestApiBase.metricIntegrationLatency(block: MetricOptionsDsl.() -> Unit = {}): Metric {
    val builder = MetricOptionsDsl()
    builder.apply(block)
    return metricIntegrationLatency(builder.build())
}
...
public inline fun Method.metricClientError(stage: IStage, block: MetricOptionsDsl.() -> Unit = {}): Metric {
    val builder = MetricOptionsDsl()
    builder.apply(block)
    return metricClientError(stage, builder.build())
}

public inline fun Method.metricCount(stage: IStage, block: MetricOptionsDsl.() -> Unit = {}): Metric {
    val builder = MetricOptionsDsl()
    builder.apply(block)
...
public inline fun Method.metricLatency(stage: IStage, block: MetricOptionsDsl.() -> Unit = {}): Metric {
    val builder = MetricOptionsDsl()
    builder.apply(block)
    return metricLatency(stage, builder.build())
}

public inline fun Method.metricServerError(stage: IStage, block: MetricOptionsDsl.() -> Unit = {}): Metric {
    val builder = MetricOptionsDsl()
    builder.apply(block)
...
public inline fun ResourceBase.addMethod(httpMethod: String, block: IntegrationDsl.() -> Unit = {}): Method {
    val builder = IntegrationDsl()
    builder.apply(block)
    return addMethod(httpMethod, builder.build())
}

public inline fun ResourceBase.addProxy(block: ProxyResourceOptionsDsl.() -> Unit = {}): ProxyResource {
    val builder = ProxyResourceOptionsDsl()
    builder.apply(block)
    return addProxy(builder.build())
}
