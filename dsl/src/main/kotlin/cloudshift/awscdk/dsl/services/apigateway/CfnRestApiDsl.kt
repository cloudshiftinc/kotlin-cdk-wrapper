...
public class CfnRestApiDsl(
   ...
   * @param bodyS3Location The Amazon Simple Storage Service (Amazon S3) location that points to an
   * OpenAPI file, which defines a set of RESTful APIs in JSON or YAML format. 
   */
   ...
   * @param failOnWarnings A query parameter to indicate whether to rollback the API update ( `true`
   * ) or not ( `false` ) when a warning is encountered. 
   */
