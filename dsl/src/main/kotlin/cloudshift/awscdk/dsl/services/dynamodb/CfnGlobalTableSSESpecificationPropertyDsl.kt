...
public class CfnGlobalTableSSESpecificationPropertyDsl {
     ...
     *   key or an AWS owned key. If enabled (true), server-side encryption type is set to KMS and
     *   an AWS managed key is used ( AWS KMS charges apply). If disabled (false) or not
     *   specified,server-side encryption is set to an AWS owned key. If you choose to use KMS
