...
public inline fun CfnGatewayRoute.setSpec(block: CfnGatewayRouteGatewayRouteSpecPropertyDsl.() -> Unit = {}) {
    val builder = CfnGatewayRouteGatewayRouteSpecPropertyDsl()
    builder.apply(block)
    return setSpec(builder.build())
}

public inline fun VirtualRouter.addRoute(id: String, block: RouteBasePropsDsl.() -> Unit = {}): Route {
...
public inline fun IVirtualRouter.addRoute(arg0: String, block: RouteBasePropsDsl.() -> Unit = {}): Route {
    val builder = RouteBasePropsDsl()
    builder.apply(block)
...
public inline fun Mesh.addVirtualNode(id: String, block: VirtualNodeBasePropsDsl.() -> Unit = {}): VirtualNode {
    val builder = VirtualNodeBasePropsDsl()
    builder.apply(block)
