...
public class CfnFlowRedshiftDestinationPropertiesPropertyDsl {
     ...
     *   when placing data in the Amazon Redshift destination. For example, this setting would
     *   determine if the flow should fail after one insertion error, or continue and attempt to
     *   insert every record regardless of the initial failure. `ErrorHandlingConfig` is a part of
