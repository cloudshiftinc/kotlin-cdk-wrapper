...
public class EcsDeploymentGroupDsl(
    ...
    private val cdkBuilder: EcsDeploymentGroup.Builder =
        EcsDeploymentGroup.Builder.create(scope, id)
    ...
    public fun blueGreenDeploymentConfig(
        blueGreenDeploymentConfig: EcsBlueGreenDeploymentConfigDsl.() -> Unit = {}
    ) {
