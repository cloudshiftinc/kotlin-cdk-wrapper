...
public class AthenaStopQueryExecutionDsl(
    ...
    private val cdkBuilder: AthenaStopQueryExecution.Builder =
        AthenaStopQueryExecution.Builder.create(scope, id)
    ...
    public fun build(): AthenaStopQueryExecution = cdkBuilder.build()
}
