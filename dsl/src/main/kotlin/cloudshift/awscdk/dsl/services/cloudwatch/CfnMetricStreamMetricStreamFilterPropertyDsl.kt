...
public class CfnMetricStreamMetricStreamFilterPropertyDsl {
     ...
     *   stream. If you omit this parameter, all metrics in the namespace are included or excluded,
    ...
    /**
     * @param namespace The name of the metric namespace in the filter. The namespace can contain
     *   only ASCII printable characters (ASCII range 32 through 126). It must contain at least one
