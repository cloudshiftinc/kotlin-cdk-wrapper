...
public class CfnTargetGroupPropsDsl {
     ...
     *   considering a target healthy. The range is 2-10. If the target group protocol is TCP,
     *   TCP_UDP, UDP, TLS, HTTP or HTTPS, the default is 5. For target groups with a protocol of
    ...
    /**
     * @param name The name of the target group. This name must be unique per region per account,
    ...
    /**
     * @param port The port on which the targets receive traffic. This port is used unless you
    ...
    /**
     * @param protocol The protocol to use for routing traffic to the targets. For Application Load
    ...
    /**
     * @param protocolVersion [HTTP/HTTPS protocol] The protocol version. The possible values are
    ...
    /**
     * @param vpcId The identifier of the virtual private cloud (VPC). If the target is a Lambda
