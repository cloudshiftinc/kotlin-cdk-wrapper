...
public object vpclattice {
    ...
    public inline fun cfnAuthPolicyProps(block: CfnAuthPolicyPropsDsl.() -> Unit = {}): CfnAuthPolicyProps {
    ...
    public inline fun cfnRuleActionProperty(block: CfnRuleActionPropertyDsl.() -> Unit = {}): CfnRule.ActionProperty {
    ...
    public inline fun cfnRuleForwardProperty(block: CfnRuleForwardPropertyDsl.() -> Unit = {}): CfnRule.ForwardProperty {
    ...
    public inline fun cfnRuleHttpMatchProperty(block: CfnRuleHttpMatchPropertyDsl.() -> Unit = {}): CfnRule.HttpMatchProperty {
        val builder = CfnRuleHttpMatchPropertyDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun cfnRuleMatchProperty(block: CfnRuleMatchPropertyDsl.() -> Unit = {}): CfnRule.MatchProperty {
        val builder = CfnRuleMatchPropertyDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun cfnRulePathMatchProperty(block: CfnRulePathMatchPropertyDsl.() -> Unit = {}): CfnRule.PathMatchProperty {
    ...
    public inline fun cfnServiceNetworkProps(block: CfnServiceNetworkPropsDsl.() -> Unit = {}): CfnServiceNetworkProps {
