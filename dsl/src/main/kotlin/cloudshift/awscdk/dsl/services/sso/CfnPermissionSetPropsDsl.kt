...
public class CfnPermissionSetPropsDsl {
     ...
     *   `CustomerManagedPolicyReference` to use the name and path of a customer managed policy, or
     *   `ManagedPolicyArn` to use the ARN of an AWS managed policy. A permissions boundary
     *   represents the maximum permissions that any policy can grant your role. For more
     *   information, see
