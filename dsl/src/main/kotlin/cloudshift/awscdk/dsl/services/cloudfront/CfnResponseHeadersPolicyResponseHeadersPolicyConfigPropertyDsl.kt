...
public class CfnResponseHeadersPolicyResponseHeadersPolicyConfigPropertyDsl {
    ...
    public fun customHeadersConfig(customHeadersConfig: CfnResponseHeadersPolicy.CustomHeadersConfigProperty) {
        cdkBuilder.customHeadersConfig(customHeadersConfig)
    }
    ...
    public fun removeHeadersConfig(removeHeadersConfig: CfnResponseHeadersPolicy.RemoveHeadersConfigProperty) {
        cdkBuilder.removeHeadersConfig(removeHeadersConfig)
    }
    ...
    public fun securityHeadersConfig(securityHeadersConfig: CfnResponseHeadersPolicy.SecurityHeadersConfigProperty) {
        cdkBuilder.securityHeadersConfig(securityHeadersConfig)
    }
    ...
    public fun serverTimingHeadersConfig(serverTimingHeadersConfig: CfnResponseHeadersPolicy.ServerTimingHeadersConfigProperty) {
        cdkBuilder.serverTimingHeadersConfig(serverTimingHeadersConfig)
    }
