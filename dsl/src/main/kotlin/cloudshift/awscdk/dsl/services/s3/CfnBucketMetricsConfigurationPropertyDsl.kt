 ...
 * existing metrics configuration. If you don't include the elements you want to keep, they are
...
public class CfnBucketMetricsConfigurationPropertyDsl {
     ...
     *   object. The metrics configuration only includes objects that meet the filter's criteria.
     */
    ...
    /**
     * @param id The ID used to identify the metrics configuration. This can be any value you choose
     *   that helps you identify your metrics configuration.
     */
