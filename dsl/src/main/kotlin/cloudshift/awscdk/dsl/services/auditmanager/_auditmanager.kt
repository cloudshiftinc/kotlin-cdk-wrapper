...
public object auditmanager {
    ...
    public inline fun cfnAssessmentProps(block: CfnAssessmentPropsDsl.() -> Unit = {}): CfnAssessmentProps {
        val builder = CfnAssessmentPropsDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun cfnAssessmentRoleProperty(block: CfnAssessmentRolePropertyDsl.() -> Unit = {}): CfnAssessment.RoleProperty {
