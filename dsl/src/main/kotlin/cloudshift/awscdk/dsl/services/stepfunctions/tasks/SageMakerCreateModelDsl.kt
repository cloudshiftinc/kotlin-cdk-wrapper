...
public class SageMakerCreateModelDsl(
  ...
  private val cdkBuilder: SageMakerCreateModel.Builder = SageMakerCreateModel.Builder.create(scope,
      id)
   ...
   *
   * @param subnetSelection The subnets of the VPC to which the hosted model is connected (Note this
   * parameter is only used when VPC is provided). 
   */
