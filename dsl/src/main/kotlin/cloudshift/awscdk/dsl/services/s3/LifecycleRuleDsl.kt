...
public class LifecycleRuleDsl {
    ...
    public fun noncurrentVersionTransitions(noncurrentVersionTransitions: NoncurrentVersionTransitionDsl.() -> Unit) {
        _noncurrentVersionTransitions.add(NoncurrentVersionTransitionDsl().apply(noncurrentVersionTransitions).build())
    }

    public fun noncurrentVersionTransitions(noncurrentVersionTransitions: Collection<NoncurrentVersionTransition>) {
