...
public class CfnPlaybackConfigurationAvailSuppressionPropertyDsl {
   ...
   * By default, ad suppression is set to OFF and all ad breaks are filled with ads or slate. When
   * Mode is set to BEHIND_LIVE_EDGE, ad suppression is active and MediaTailor won't fill ad breaks on
   * or behind the ad suppression Value time in the manifest lookback window.
   */
   ...
   * MediaTailor will fill ad breaks that occur within 45 minutes behind the live edge, but won't fill
