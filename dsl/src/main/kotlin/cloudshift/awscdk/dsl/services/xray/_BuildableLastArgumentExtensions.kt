...
public inline fun CfnGroup.setInsightsConfiguration(
...
public inline fun CfnSamplingRule.setSamplingRule(
...
public inline fun CfnSamplingRule.setSamplingRuleRecord(
...
/** @deprecated this property has been deprecated */
public inline fun CfnSamplingRule.setSamplingRuleUpdate(
