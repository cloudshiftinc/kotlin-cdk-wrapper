...
public class CfnSubscriptionDsl(
   ...
   * @param filterPolicyScope This attribute lets you choose the filtering scope by using one of the
   ...
   * subscriptions. For more information, see [Fanout to Amazon Kinesis Data Firehose delivery
   ...
   * @param subscriptionRoleArn This property applies only to Amazon Kinesis Data Firehose delivery
