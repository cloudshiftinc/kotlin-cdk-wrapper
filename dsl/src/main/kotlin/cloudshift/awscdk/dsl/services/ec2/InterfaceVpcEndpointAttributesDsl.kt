...
public class InterfaceVpcEndpointAttributesDsl {
    ...
    /**
     * @param securityGroups The security groups associated with the interface VPC endpoint. If you
     *   wish to manage the network connections associated with this endpoint, you will need to
