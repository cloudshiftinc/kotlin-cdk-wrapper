...
public class CfnClusterOutpostConfigPropertyDsl {
     ...
     *   local Amazon EKS cluster on Outposts. Choose an instance type based on the number of nodes
     *   that your cluster will have. For more information, see
     ...
     *   control plane instances of your local Amazon EKS cluster on an AWS Outpost. For more
     *   information, see
     *   [Capacity considerations](https://docs.aws.amazon.com/eks/latest/userguide/eks-outposts-capacity-considerations.html)
     *   in the *Amazon EKS User Guide* .
     */
    ...
    public fun controlPlanePlacement(
        controlPlanePlacement: CfnCluster.ControlPlanePlacementProperty
    ) {
        cdkBuilder.controlPlanePlacement(controlPlanePlacement)
    }
