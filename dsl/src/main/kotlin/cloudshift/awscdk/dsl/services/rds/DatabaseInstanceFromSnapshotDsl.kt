 ...
 */
@CdkDslMarker
public class DatabaseInstanceFromSnapshotDsl(
  scope: Construct,
  id: String,
) {
  private val cdkBuilder: DatabaseInstanceFromSnapshot.Builder =
      DatabaseInstanceFromSnapshot.Builder.create(scope, id)
   ...
   * Default: false
   *
   * @param deleteAutomatedBackups Indicates whether automated backups should be deleted or retained
   ...
   *
   * @param snapshotIdentifier The name or Amazon Resource Name (ARN) of the DB snapshot that's used
  ...
  public fun build(): DatabaseInstanceFromSnapshot {
