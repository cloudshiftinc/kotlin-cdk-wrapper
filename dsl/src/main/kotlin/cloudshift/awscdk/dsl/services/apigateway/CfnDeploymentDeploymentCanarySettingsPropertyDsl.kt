...
public class CfnDeploymentDeploymentCanarySettingsPropertyDsl {
     ...
     *   deployment. They can override existing stage variables or add new stage variables for the
     *   canary release deployment. These stage variables are represented as a string-to-string map
