...
public class CfnDistributionForwardedValuesPropertyDsl {
    ...
    /**
     * @param cookies This field is deprecated. We recommend that you use a cache policy or an
    ...
    /**
     * @param headers This field is deprecated. We recommend that you use a cache policy or an
     *   origin request policy instead of this field.
     *
    ...
    /**
     * @param queryString This field is deprecated. We recommend that you use a cache policy or an
     *   origin request policy instead of this field.
     *
     ...
     * CloudFront behavior depends on the value of `QueryString` and on the values that you specify
     ...
     * caches based on all query string parameters. Depending on how many query string parameters
     * and values you have, this can adversely affect performance because CloudFront must forward
     * more requests to the origin.
     *
     * If you specify true for `QueryString` and you specify one or more values for
     * `QueryStringCacheKeys` , CloudFront forwards all query string parameters to the origin, but
    ...
    /**
     * @param queryStringCacheKeys This field is deprecated. We recommend that you use a cache
    ...
    public fun build(): CfnDistribution.ForwardedValuesProperty {
        ...
        if (_queryStringCacheKeys.isNotEmpty())
            cdkBuilder.queryStringCacheKeys(_queryStringCacheKeys)
