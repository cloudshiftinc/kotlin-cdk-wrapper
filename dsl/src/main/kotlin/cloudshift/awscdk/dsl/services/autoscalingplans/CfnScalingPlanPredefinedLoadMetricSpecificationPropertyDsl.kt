...
public class CfnScalingPlanPredefinedLoadMetricSpecificationPropertyDsl {
     ...
     *   specify a resource label unless the metric type is `ALBTargetGroupRequestCount` and there
    ...
    public fun build(): CfnScalingPlan.PredefinedLoadMetricSpecificationProperty =
        cdkBuilder.build()
}
