...
public class CfnPushTemplateAPNSPushNotificationTemplatePropertyDsl {
  ...
  /**
   * @param mediaUrl The URL of an image or video to display in push notifications that are based on
   ...
   * push notification that's based on the message template and the value of the `Action` property is
   * `URL` .
   */
