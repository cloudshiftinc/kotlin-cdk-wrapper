 ...
 */
@CdkDslMarker
public class CfnModelQualityJobDefinitionMonitoringOutputConfigPropertyDsl {
    private val cdkBuilder: CfnModelQualityJobDefinition.MonitoringOutputConfigProperty.Builder =
    ...
    public fun build(): CfnModelQualityJobDefinition.MonitoringOutputConfigProperty {
