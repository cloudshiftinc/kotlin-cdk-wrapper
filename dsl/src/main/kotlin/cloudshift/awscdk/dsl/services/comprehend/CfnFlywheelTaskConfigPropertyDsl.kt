...
public class CfnFlywheelTaskConfigPropertyDsl {
    ...
    public fun documentClassificationConfig(documentClassificationConfig: CfnFlywheel.DocumentClassificationConfigProperty) {
        cdkBuilder.documentClassificationConfig(documentClassificationConfig)
    }
    ...
    public fun entityRecognitionConfig(entityRecognitionConfig: CfnFlywheel.EntityRecognitionConfigProperty) {
        cdkBuilder.entityRecognitionConfig(entityRecognitionConfig)
    }
