...
public class CfnChannelDvbSubDestinationSettingsPropertyDsl {
   ...
   * Similarly, setting a left alignment aligns captions to the bottom left of the output. If x and
   * y positions are specified in conjunction with the alignment parameter, the font is justified
   ...
   * 255 is opaque; 0 is transparent. Keeping this parameter blank is equivalent to setting it to 0
   ...
   * Using external fonts with these captions sources could cause an unexpected display of proportional
  ...
  /**
   * @param shadowXOffset Specifies the horizontal offset of the shadow relative to the captions in
   * pixels.
   ...
   * pixels.
   * A value of -2 would result in a shadow offset 2 pixels above the text. All burn-in and DVB-Sub
   * font settings must match.
   */
  ...
  /**
   * @param xPosition Specifies the horizontal position of the captions relative to the left side of
   * the output in pixels.
   * A value of 10 would result in the captions starting 10 pixels from the left of the output. If
   * no explicit xPosition is provided, the horizontal captions position is determined by the alignment
   ...
   * output in pixels.
   * A value of 10 would result in the captions starting 10 pixels from the top of the output. If no
   * explicit yPosition is provided, the captions are positioned towards the bottom of the output. This
   * option is not valid for source captions that are STL, 608/embedded, or Teletext. These source
   * settings are already pre-defined by the captions stream. All burn-in and DVB-Sub font settings
   * must match.
   */
