...
public class CfnDataSourceSalesforceKnowledgeArticleConfigurationPropertyDsl {
    ...
    public fun customKnowledgeArticleTypeConfigurations(customKnowledgeArticleTypeConfigurations: Collection<Any>) {
        _customKnowledgeArticleTypeConfigurations.addAll(customKnowledgeArticleTypeConfigurations)
    }

    public fun customKnowledgeArticleTypeConfigurations(customKnowledgeArticleTypeConfigurations: IResolvable) {
    ...
    public fun standardKnowledgeArticleTypeConfiguration(standardKnowledgeArticleTypeConfiguration: IResolvable) {
        cdkBuilder.standardKnowledgeArticleTypeConfiguration(standardKnowledgeArticleTypeConfiguration)
    }

    public fun standardKnowledgeArticleTypeConfiguration(standardKnowledgeArticleTypeConfiguration: CfnDataSource.SalesforceStandardKnowledgeArticleTypeConfigurationProperty) {
        cdkBuilder.standardKnowledgeArticleTypeConfiguration(standardKnowledgeArticleTypeConfiguration)
    }
