...
public class CfnChannelAudioNormalizationSettingsPropertyDsl {
   ...
   * If no value is entered, a default value is used according to the chosen algorithm. The CALM Act
   * (1770-1) recommends a target of -24 LKFS. The EBU R-128 specification (1770-2) recommends a target
   * of -23 LKFS.
   */
