...
public class CfnClientVpnEndpointPropsDsl {
     ...
     *   associated subnet is located, or the routes that you add manually. The address range cannot
     *   be changed after the Client VPN endpoint has been created. Client CIDR range must have a
    ...
    /**
     * @param connectionLogOptions Information about the client connection logging options. If you
    ...
    /**
     * @param dnsServers Information about the DNS servers to be used for DNS resolution. A Client
     ...
     *   endpoint. Default Value: `enabled`
     */
    ...
    /**
     * @param serverCertificateArn The ARN of the server certificate. For more information, see the
    ...
    /**
     * @param sessionTimeoutHours The maximum VPN session duration time in hours. Valid values: `8 |
     *   10 | 12 | 24`
     *
     * Default value: `24`
     */
    ...
    /**
     * @param transportProtocol The transport protocol to be used by the VPN session. Default value:
     *   `udp`
     */
    ...
    /**
     * @param vpcId The ID of the VPC to associate with the Client VPN endpoint. If no security
