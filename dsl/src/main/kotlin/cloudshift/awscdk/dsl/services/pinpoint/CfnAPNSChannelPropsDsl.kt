...
@CdkDslMarker
public class CfnAPNSChannelPropsDsl {
  private val cdkBuilder: CfnAPNSChannelProps.Builder = CfnAPNSChannelProps.builder()
  ...
  public fun build(): CfnAPNSChannelProps = cdkBuilder.build()
}
