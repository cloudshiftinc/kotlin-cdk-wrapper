...
public class CfnVPNConnectionVpnTunnelOptionsSpecificationPropertyDsl {
     ...
     *   virtual private gateway and customer gateway. Constraints: Allowed characters are
     *   alphanumeric characters, periods (.), and underscores (_). Must be between 8 and 64
