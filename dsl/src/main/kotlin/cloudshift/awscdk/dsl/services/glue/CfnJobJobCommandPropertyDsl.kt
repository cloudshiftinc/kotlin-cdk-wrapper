...
public class CfnJobJobCommandPropertyDsl {
    ...
    /**
     * @param name The name of the job command. For an Apache Spark ETL job, this must be `glueetl`
     *   . For a Python shell job, it must be `pythonshell` . For an Apache Spark streaming ETL job,
     *   this must be `gluestreaming` . For a Ray job, this must be `glueray` .
     */
    ...
    /**
     * @param pythonVersion The Python version being used to execute a Python shell job. Allowed
     *   values are 3 or 3.9. Version 2 is deprecated.
     */
     ...
     *   additional libraries available in your environment. This field is not used in other job
     *   types. For supported runtime environment values, see
