...
public object lambda {
    public inline fun adotInstrumentationConfig(block: AdotInstrumentationConfigDsl.() -> Unit = {}): AdotInstrumentationConfig {
    ...
    public inline fun assetImageCode(directory: String, block: AssetImageCodeDsl.() -> Unit = {}): AssetImageCode {
        val builder = AssetImageCodeDsl(directory)
        builder.apply(block)
        return builder.build()
    }

    public inline fun assetImageCodeProps(block: AssetImageCodePropsDsl.() -> Unit = {}): AssetImageCodeProps {
        val builder = AssetImageCodePropsDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun autoScalingOptions(block: AutoScalingOptionsDsl.() -> Unit = {}): AutoScalingOptions {
    ...
    public inline fun cfnCodeSigningConfigProps(block: CfnCodeSigningConfigPropsDsl.() -> Unit = {}): CfnCodeSigningConfigProps {
    ...
    public inline fun cfnEventInvokeConfigProps(block: CfnEventInvokeConfigPropsDsl.() -> Unit = {}): CfnEventInvokeConfigProps {
    ...
    public inline fun cfnFunctionCodeProperty(block: CfnFunctionCodePropertyDsl.() -> Unit = {}): CfnFunction.CodeProperty {
    ...
    public inline fun cfnLayerVersionPermissionProps(block: CfnLayerVersionPermissionPropsDsl.() -> Unit = {}): CfnLayerVersionPermissionProps {
        val builder = CfnLayerVersionPermissionPropsDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun cfnLayerVersionProps(block: CfnLayerVersionPropsDsl.() -> Unit = {}): CfnLayerVersionProps {
        val builder = CfnLayerVersionPropsDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun cfnParametersCode(block: CfnParametersCodeDsl.() -> Unit = {}): CfnParametersCode {
        val builder = CfnParametersCodeDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun cfnParametersCodeProps(block: CfnParametersCodePropsDsl.() -> Unit = {}): CfnParametersCodeProps {
    ...
    public inline fun cfnUrlCorsProperty(block: CfnUrlCorsPropertyDsl.() -> Unit = {}): CfnUrl.CorsProperty {
    ...
    public inline fun codeSigningConfigProps(block: CodeSigningConfigPropsDsl.() -> Unit = {}): CodeSigningConfigProps {
        val builder = CodeSigningConfigPropsDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun destinationConfig(block: DestinationConfigDsl.() -> Unit = {}): DestinationConfig {
    ...
    public inline fun dlqDestinationConfig(block: DlqDestinationConfigDsl.() -> Unit = {}): DlqDestinationConfig {
        val builder = DlqDestinationConfigDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun dockerBuildAssetOptions(block: DockerBuildAssetOptionsDsl.() -> Unit = {}): DockerBuildAssetOptions {
    ...
    public inline fun dockerImageFunctionProps(block: DockerImageFunctionPropsDsl.() -> Unit = {}): DockerImageFunctionProps {
        val builder = DockerImageFunctionPropsDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun ecrImageCode(repository: IRepository, block: EcrImageCodeDsl.() -> Unit = {}): EcrImageCode {
        val builder = EcrImageCodeDsl(repository)
        builder.apply(block)
        return builder.build()
    }

    public inline fun ecrImageCodeProps(block: EcrImageCodePropsDsl.() -> Unit = {}): EcrImageCodeProps {
        val builder = EcrImageCodePropsDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun environmentOptions(block: EnvironmentOptionsDsl.() -> Unit = {}): EnvironmentOptions {
    ...
    public inline fun eventInvokeConfigOptions(block: EventInvokeConfigOptionsDsl.() -> Unit = {}): EventInvokeConfigOptions {
        val builder = EventInvokeConfigOptionsDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun eventInvokeConfigProps(block: EventInvokeConfigPropsDsl.() -> Unit = {}): EventInvokeConfigProps {
    ...
    public inline fun eventSourceMappingOptions(block: EventSourceMappingOptionsDsl.() -> Unit = {}): EventSourceMappingOptions {
        val builder = EventSourceMappingOptionsDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun eventSourceMappingProps(block: EventSourceMappingPropsDsl.() -> Unit = {}): EventSourceMappingProps {
    ...
    public inline fun functionAttributes(block: FunctionAttributesDsl.() -> Unit = {}): FunctionAttributes {
    ...
    public inline fun functionUrlCorsOptions(block: FunctionUrlCorsOptionsDsl.() -> Unit = {}): FunctionUrlCorsOptions {
        val builder = FunctionUrlCorsOptionsDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun functionUrlOptions(block: FunctionUrlOptionsDsl.() -> Unit = {}): FunctionUrlOptions {
    ...
    public inline fun lambdaRuntimeProps(block: LambdaRuntimePropsDsl.() -> Unit = {}): LambdaRuntimeProps {
    ...
    public inline fun layerVersionAttributes(block: LayerVersionAttributesDsl.() -> Unit = {}): LayerVersionAttributes {
        val builder = LayerVersionAttributesDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun layerVersionOptions(block: LayerVersionOptionsDsl.() -> Unit = {}): LayerVersionOptions {
        val builder = LayerVersionOptionsDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun layerVersionPermission(block: LayerVersionPermissionDsl.() -> Unit = {}): LayerVersionPermission {
        val builder = LayerVersionPermissionDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun layerVersionProps(block: LayerVersionPropsDsl.() -> Unit = {}): LayerVersionProps {
    ...
    public inline fun paramsAndSecretsOptions(block: ParamsAndSecretsOptionsDsl.() -> Unit = {}): ParamsAndSecretsOptions {
    ...
    public inline fun resourceBindOptions(block: ResourceBindOptionsDsl.() -> Unit = {}): ResourceBindOptions {
    ...
    public inline fun singletonFunctionProps(block: SingletonFunctionPropsDsl.() -> Unit = {}): SingletonFunctionProps {
        val builder = SingletonFunctionPropsDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun sourceAccessConfiguration(block: SourceAccessConfigurationDsl.() -> Unit = {}): SourceAccessConfiguration {
        val builder = SourceAccessConfigurationDsl()
        builder.apply(block)
        return builder.build()
    }

    public inline fun utilizationScalingOptions(block: UtilizationScalingOptionsDsl.() -> Unit = {}): UtilizationScalingOptions {
    ...
    public inline fun versionAttributes(block: VersionAttributesDsl.() -> Unit = {}): VersionAttributes {
