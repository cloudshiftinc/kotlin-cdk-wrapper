...
public inline fun Table.autoScaleReadCapacity(block: EnableScalingPropsDsl.() -> Unit = {}): IScalableTableAttribute {
    val builder = EnableScalingPropsDsl()
    builder.apply(block)
    return autoScaleReadCapacity(builder.build())
}

public inline fun Table.autoScaleWriteCapacity(block: EnableScalingPropsDsl.() -> Unit = {}): IScalableTableAttribute {
    val builder = EnableScalingPropsDsl()
    builder.apply(block)
    return autoScaleWriteCapacity(builder.build())
}

public inline fun Table.metric(metricName: String, block: MetricOptionsDsl.() -> Unit = {}): Metric {
...
public inline fun Table.metricConsumedReadCapacityUnits(block: MetricOptionsDsl.() -> Unit = {}): Metric {
    val builder = MetricOptionsDsl()
    builder.apply(block)
    return metricConsumedReadCapacityUnits(builder.build())
}

public inline fun Table.metricConsumedWriteCapacityUnits(block: MetricOptionsDsl.() -> Unit = {}): Metric {
    val builder = MetricOptionsDsl()
    builder.apply(block)
    return metricConsumedWriteCapacityUnits(builder.build())
}

public inline fun Table.metricSuccessfulRequestLatency(block: MetricOptionsDsl.() -> Unit = {}): Metric {
    val builder = MetricOptionsDsl()
    builder.apply(block)
...
public inline fun ITable.metricConsumedReadCapacityUnits(block: MetricOptionsDsl.() -> Unit = {}): Metric {
    val builder = MetricOptionsDsl()
    builder.apply(block)
    return metricConsumedReadCapacityUnits(builder.build())
}

public inline fun ITable.metricConsumedWriteCapacityUnits(block: MetricOptionsDsl.() -> Unit = {}): Metric {
    val builder = MetricOptionsDsl()
    builder.apply(block)
    return metricConsumedWriteCapacityUnits(builder.build())
}

public inline fun ITable.metricSuccessfulRequestLatency(block: MetricOptionsDsl.() -> Unit = {}): Metric {
    val builder = MetricOptionsDsl()
    builder.apply(block)
    return metricSuccessfulRequestLatency(builder.build())
}
