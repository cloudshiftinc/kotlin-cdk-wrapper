...
public class UserPoolPropsDsl {
  ...
  /**
   * @param customAttributes Define a set of custom attributes that can be configured for each user
   * in the user pool.
   */
  ...
  /**
   * @param smsRoleExternalId The 'ExternalId' that Cognito service must be using when assuming the
