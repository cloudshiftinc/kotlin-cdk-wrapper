...
public class CfnChannelAudioDescriptionPropertyDsl {
    ...
    public fun audioNormalizationSettings(audioNormalizationSettings: CfnChannel.AudioNormalizationSettingsProperty) {
        cdkBuilder.audioNormalizationSettings(audioNormalizationSettings)
    }
    ...
    public fun audioWatermarkingSettings(audioWatermarkingSettings: CfnChannel.AudioWatermarkSettingsProperty) {
        cdkBuilder.audioWatermarkingSettings(audioWatermarkingSettings)
    }
