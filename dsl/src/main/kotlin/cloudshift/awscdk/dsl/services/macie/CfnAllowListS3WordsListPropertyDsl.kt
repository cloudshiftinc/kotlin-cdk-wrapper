...
public class CfnAllowListS3WordsListPropertyDsl {
    ...
    /**
     * @param objectKey The full name of the S3 object. This value correlates to the `Key` field of
     *   an object's properties in Amazon S3 . If the name includes a path, include the complete
     *   path. For example, `AllowLists/Macie/MyList.txt` .
     *
     * This value is case sensitive. In addition, don't use wildcard characters or specify partial
     * values for the name.
     */
