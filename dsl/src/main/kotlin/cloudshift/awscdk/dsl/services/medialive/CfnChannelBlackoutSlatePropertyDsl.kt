...
public class CfnChannelBlackoutSlatePropertyDsl {
    ...
    /**
     * @param blackoutSlateImage The blackout slate image to be used. Keep empty for solid black.
     ...
     *   Segmentation Descriptor is encountered. The blackout is lifted when the Network Start
     *   Segmentation Descriptor is encountered. The Network End and Network Start descriptors must
     ...
     *   image. The image is scaled to fill the entire output raster.
     */
