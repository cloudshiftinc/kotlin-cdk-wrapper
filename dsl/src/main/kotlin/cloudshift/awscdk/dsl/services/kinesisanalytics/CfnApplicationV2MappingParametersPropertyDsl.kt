...
public class CfnApplicationV2MappingParametersPropertyDsl {
    ...
    public fun csvMappingParameters(csvMappingParameters: CfnApplicationV2.CSVMappingParametersProperty) {
        cdkBuilder.csvMappingParameters(csvMappingParameters)
    }
    ...
    public fun jsonMappingParameters(jsonMappingParameters: CfnApplicationV2.JSONMappingParametersProperty) {
        cdkBuilder.jsonMappingParameters(jsonMappingParameters)
    }
