...
public class CfnDomainClusterConfigPropertyDsl {
   ...
   * master node, such as `m3.medium.search` . If you specify this property, you must specify `true`
   * for the `DedicatedMasterEnabled` property. For valid values, see [Supported instance types in
   * Amazon OpenSearch
