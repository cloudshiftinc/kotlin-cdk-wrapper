...
public object billingconductor {
  ...
  public inline
      fun cfnBillingGroupAccountGroupingProperty(block: CfnBillingGroupAccountGroupingPropertyDsl.() -> Unit
  ...
  public inline
      fun cfnBillingGroupComputationPreferenceProperty(block: CfnBillingGroupComputationPreferencePropertyDsl.() -> Unit
  ...
  public inline
      fun cfnCustomLineItemBillingPeriodRangeProperty(block: CfnCustomLineItemBillingPeriodRangePropertyDsl.() -> Unit
  ...
  public inline
      fun cfnCustomLineItemCustomLineItemChargeDetailsProperty(block: CfnCustomLineItemCustomLineItemChargeDetailsPropertyDsl.() -> Unit
  ...
  public inline
      fun cfnCustomLineItemCustomLineItemFlatChargeDetailsProperty(block: CfnCustomLineItemCustomLineItemFlatChargeDetailsPropertyDsl.() -> Unit
  ...
  public inline
      fun cfnCustomLineItemCustomLineItemPercentageChargeDetailsProperty(block: CfnCustomLineItemCustomLineItemPercentageChargeDetailsPropertyDsl.() -> Unit
  ...
  public inline fun cfnCustomLineItemProps(block: CfnCustomLineItemPropsDsl.() -> Unit = {}):
  ...
  public inline fun cfnPricingPlanProps(block: CfnPricingPlanPropsDsl.() -> Unit = {}):
      CfnPricingPlanProps {
  ...
  public inline
      fun cfnPricingRuleFreeTierProperty(block: CfnPricingRuleFreeTierPropertyDsl.() -> Unit = {}):
  ...
  public inline fun cfnPricingRuleProps(block: CfnPricingRulePropsDsl.() -> Unit = {}):
      CfnPricingRuleProps {
  ...
  public inline fun cfnPricingRuleTieringProperty(block: CfnPricingRuleTieringPropertyDsl.() -> Unit
