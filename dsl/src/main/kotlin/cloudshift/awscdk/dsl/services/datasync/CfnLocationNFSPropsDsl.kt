...
public class CfnLocationNFSPropsDsl {
     ...
     *   to connect to your NFS file server. If you are copying data to or from your AWS Snowcone
     *   device, see
    ...
    /**
     * @param serverHostname Specifies the IP address or domain name of your NFS file server. An
     *   agent that is installed on-premises uses this hostname to mount the NFS server in a
     *   network.
     *
     ...
     *   to or from. The NFS path should be a path that's exported by the NFS server, or a
     *   subdirectory of that path. The path should be such that it can be mounted by other NFS
