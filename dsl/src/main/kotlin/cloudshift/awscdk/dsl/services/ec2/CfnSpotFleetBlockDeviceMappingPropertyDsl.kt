...
public class CfnSpotFleetBlockDeviceMappingPropertyDsl {
    ...
    /**
     * @param virtualName The virtual device name ( `ephemeral` N). Instance store volumes are
     *   numbered starting from 0. An instance type with 2 available instance store volumes can
     *   specify mappings for `ephemeral0` and `ephemeral1` . The number of available instance store
