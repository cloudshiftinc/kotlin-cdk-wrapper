...
public class CfnFilterFindingCriteriaPropertyDsl {
   ...
   * For a mapping of JSON criterion to their console equivalent see [Finding
   ...
   * only unarchived findings are listed. When this attribute is not set, all existing findings are
   * listed.
   *
  ...
  /**
   * @param itemType Specifies the condition to be applied to a single field when filtering through
   * findings.
   */
