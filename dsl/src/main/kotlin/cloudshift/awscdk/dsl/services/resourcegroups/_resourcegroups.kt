...
public object resourcegroups {
  ...
  public inline
      fun cfnGroupConfigurationItemProperty(block: CfnGroupConfigurationItemPropertyDsl.() -> Unit =
  ...
  public inline
      fun cfnGroupConfigurationParameterProperty(block: CfnGroupConfigurationParameterPropertyDsl.() -> Unit
  ...
  public inline fun cfnGroupQueryProperty(block: CfnGroupQueryPropertyDsl.() -> Unit = {}):
  ...
  public inline fun cfnGroupResourceQueryProperty(block: CfnGroupResourceQueryPropertyDsl.() -> Unit
  ...
  public inline fun cfnGroupTagFilterProperty(block: CfnGroupTagFilterPropertyDsl.() -> Unit = {}):
