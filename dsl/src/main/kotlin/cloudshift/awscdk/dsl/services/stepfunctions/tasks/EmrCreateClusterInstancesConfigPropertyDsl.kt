...
public class EmrCreateClusterInstancesConfigPropertyDsl {
    ...
    public fun instanceFleets(instanceFleets: EmrCreateClusterInstanceFleetConfigPropertyDsl.() -> Unit) {
        _instanceFleets.add(EmrCreateClusterInstanceFleetConfigPropertyDsl().apply(instanceFleets).build())
    }

    public fun instanceFleets(instanceFleets: Collection<EmrCreateCluster.InstanceFleetConfigProperty>) {
        _instanceFleets.addAll(instanceFleets)
    }

    public fun instanceGroups(instanceGroups: EmrCreateClusterInstanceGroupConfigPropertyDsl.() -> Unit) {
        _instanceGroups.add(EmrCreateClusterInstanceGroupConfigPropertyDsl().apply(instanceGroups).build())
    }

    public fun instanceGroups(instanceGroups: Collection<EmrCreateCluster.InstanceGroupConfigProperty>) {
