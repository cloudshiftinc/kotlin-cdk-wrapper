 ...
 */
@CdkDslMarker
public class CfnTemplateLineChartConfigurationPropertyDsl {
  private val cdkBuilder: CfnTemplate.LineChartConfigurationProperty.Builder =
   ...
   */
  public
      fun defaultSeriesSettings(defaultSeriesSettings: CfnTemplate.LineChartDefaultSeriesSettingsProperty) {
    cdkBuilder.defaultSeriesSettings(defaultSeriesSettings)
  }
   ...
   * @param fieldWells The field well configuration of a line chart.
   */
  public fun fieldWells(fieldWells: CfnTemplate.LineChartFieldWellsProperty) {
    cdkBuilder.fieldWells(fieldWells)
  }
   ...
   */
  public
      fun primaryYAxisDisplayOptions(primaryYAxisDisplayOptions: CfnTemplate.LineSeriesAxisDisplayOptionsProperty) {
    cdkBuilder.primaryYAxisDisplayOptions(primaryYAxisDisplayOptions)
  }
   ...
   */
  public
      fun secondaryYAxisDisplayOptions(secondaryYAxisDisplayOptions: CfnTemplate.LineSeriesAxisDisplayOptionsProperty) {
    cdkBuilder.secondaryYAxisDisplayOptions(secondaryYAxisDisplayOptions)
  }

  /**
   * @param secondaryYAxisLabelOptions The options that determine the presentation of the secondary
   * y-axis label.
   */
   ...
   */
  public
      fun secondaryYAxisLabelOptions(secondaryYAxisLabelOptions: CfnTemplate.ChartAxisLabelOptionsProperty) {
    cdkBuilder.secondaryYAxisLabelOptions(secondaryYAxisLabelOptions)
  }
   ...
   * @param sortConfiguration The sort configuration of a line chart.
   */
  public fun sortConfiguration(sortConfiguration: CfnTemplate.LineChartSortConfigurationProperty) {
    cdkBuilder.sortConfiguration(sortConfiguration)
  }
  ...
  public fun build(): CfnTemplate.LineChartConfigurationProperty {
