...
public class CfnTemplateLineChartConfigurationPropertyDsl {
    ...
    public fun defaultSeriesSettings(defaultSeriesSettings: CfnTemplate.LineChartDefaultSeriesSettingsProperty) {
        cdkBuilder.defaultSeriesSettings(defaultSeriesSettings)
    }
    ...
    public fun primaryYAxisDisplayOptions(primaryYAxisDisplayOptions: CfnTemplate.LineSeriesAxisDisplayOptionsProperty) {
        cdkBuilder.primaryYAxisDisplayOptions(primaryYAxisDisplayOptions)
    }
    ...
    public fun secondaryYAxisDisplayOptions(secondaryYAxisDisplayOptions: CfnTemplate.LineSeriesAxisDisplayOptionsProperty) {
        cdkBuilder.secondaryYAxisDisplayOptions(secondaryYAxisDisplayOptions)
    }
