...
public class AppPropsDsl {
    ...
    /**
     * @param autoSynth Automatically call `synth()` before the program exits. If you set this, you
     *   don't have to call `synth()` explicitly. Note that this feature is only available for
     *   certain programming languages, and calling `synth()` is still recommended.
     */
    ...
    /**
     * @param context Additional context values for the application. Context set by the CLI or the
     ...
     *   App. The Stack Synthesizer controls aspects of synthesis and deployment, like how assets
     *   are referenced and what IAM roles to use. For more information, see the README of the main
     *   CDK package.
     */
    ...
    /**
     * @param outdir The output directory into which to emit synthesized artifacts. You should never
     *   need to set this value. By default, the value you pass to the CLI's `--output` flag will be
     *   used, and if you change it to a different directory the CLI will fail to pick up the
     *   generated Cloud Assembly.
     *
    ...
    /**
     * @param postCliContext Additional context values for the application. Context provided here
     *   has precedence over context set by:
     * * The CLI via --context
