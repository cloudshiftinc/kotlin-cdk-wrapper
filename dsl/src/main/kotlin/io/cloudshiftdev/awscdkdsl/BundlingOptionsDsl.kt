...
public class BundlingOptionsDsl {
    ...
    /**
     * @param entrypoint The entrypoint to run in the Docker container. Example value: `['/bin/sh',
     *   '-c']`
     */
    ...
    /**
     * @param local Local bundling provider. The provider implements a method `tryBundle()` which
     *   should return `true` if local bundling was performed. If `false` is returned, docker
