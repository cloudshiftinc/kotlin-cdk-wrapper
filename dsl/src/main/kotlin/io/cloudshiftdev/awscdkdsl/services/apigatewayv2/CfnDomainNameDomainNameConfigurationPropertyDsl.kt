...
public class CfnDomainNameDomainNameConfigurationPropertyDsl {
     ...
     *   certificate issued by AWS Certificate Manager . This ARN is used to validate custom domain
     *   ownership. It's required only if you configure mutual TLS and use either an ACM-imported or
     *   a private CA certificate ARN as the regionalCertificateArn.
     */
