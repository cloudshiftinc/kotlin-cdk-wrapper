...
public class CfnObjectTypePropsDsl {
     ...
     *   created in this profile object type mapping. If not specified the system will use the
     *   encryption key of the domain.
     */
    ...
    /**
     * @param templateId A unique identifier for the template mapping. This can be used instead of
     *   specifying the Keys and Fields properties directly.
     */
