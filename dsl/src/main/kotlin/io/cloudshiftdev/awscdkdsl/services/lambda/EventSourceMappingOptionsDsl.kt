...
public class EventSourceMappingOptionsDsl {
    ...
    /**
     * @param eventSourceArn The Amazon Resource Name (ARN) of the event source. Any record added to
     ...
     *   initially to bootstrap itself. They are in the format `abc.example.com:9096`.
     */
    ...
    /**
     * @param kafkaConsumerGroupId The identifier for the Kafka consumer group to join. The consumer
    ...
    public fun build(): EventSourceMappingOptions {
