...
public class CfnChannelPropsDsl {
    ...
    /**
     * @param source The name of the partner or external event source. You cannot change this name
     ...
     * source. For information about the source names for available partners, see
