...
public class RepositoryPropsDsl {
    ...
    /**
     * @param encryption The kind of server-side encryption to apply to this repository. If you
     *   choose KMS, you can specify a KMS key via `encryptionKey`. If encryptionKey is not
    ...
    /**
     * @param encryptionKey External KMS key to use for repository encryption. The 'encryption'
     *   property must be either not specified or set to "KMS". An error will be emitted if
     *   encryption is set to "AES256".
     */
