 ...
 * [Using gauge charts](https://docs.aws.amazon.com/quicksight/latest/user/gauge-chart.html) in the
...
public class CfnDashboardGaugeChartVisualPropertyDsl {
    ...
    public fun chartConfiguration(
        chartConfiguration: CfnDashboard.GaugeChartConfigurationProperty
    ) {
        cdkBuilder.chartConfiguration(chartConfiguration)
    }
    ...
    public fun conditionalFormatting(
        conditionalFormatting: CfnDashboard.GaugeChartConditionalFormattingProperty
    ) {
        cdkBuilder.conditionalFormatting(conditionalFormatting)
    }
