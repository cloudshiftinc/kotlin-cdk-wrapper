 ...
 * [Logging web ACL traffic](https://docs.aws.amazon.com/waf/latest/developerguide/logging.html) in
 ...
 * Amazon CloudWatch Logs log group, AWS WAF creates a resource policy on the log group. For an
 * Amazon S3 bucket, AWS WAF creates a bucket policy. For an Amazon Kinesis Data Firehose, AWS WAF
