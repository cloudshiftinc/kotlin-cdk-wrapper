...
public class CfnSegmentSegmentGroupsPropertyDsl {
    ...
    /**
     * @param include Specifies how to handle multiple segment groups for the segment. For example,
     *   if the segment includes three segment groups, whether the resulting segment includes
     *   endpoints that match all, any, or none of the segment groups.
     */
