...
public class CfnNodegroupPropsDsl {
    ...
    /**
     * @param amiType The AMI type for your node group. If you specify `launchTemplate` , and your
    ...
    /**
     * @param diskSize The root device disk size (in GiB) for your node group instances. The default
     *   disk size is 20 GiB for Linux and Bottlerocket. The default disk size is 50 GiB for
     *   Windows. If you specify `launchTemplate` , then don't specify `diskSize` , or the node
     ...
     *   scheduled to your nodes. For more information, see
    ...
    public fun build(): CfnNodegroupProps {
