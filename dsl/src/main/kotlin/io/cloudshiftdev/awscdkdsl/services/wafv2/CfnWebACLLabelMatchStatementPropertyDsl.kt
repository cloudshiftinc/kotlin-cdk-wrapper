...
public class CfnWebACLLabelMatchStatementPropertyDsl {
     ...
     *   include any number of preceding namespace specifications and prefix up to providing the
     *   fully qualified label name.
     * * If the `Scope` indicates `NAMESPACE` , then this specification can include any number of
     *   contiguous namespace strings, and can include the entire label namespace prefix from the
