...
public class CfnScalingPolicyTargetTrackingConfigurationPropertyDsl {
     ...
     *   disabled. If scaling in is disabled, the target tracking scaling policy doesn't remove
     *   instances from the Auto Scaling group. Otherwise, the target tracking scaling policy can
     *   remove instances from the Auto Scaling group. The default is `false` .
     */
