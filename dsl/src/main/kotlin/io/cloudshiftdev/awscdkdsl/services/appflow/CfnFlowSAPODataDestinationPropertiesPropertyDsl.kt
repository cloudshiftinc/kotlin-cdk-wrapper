...
public class CfnFlowSAPODataDestinationPropertiesPropertyDsl {
     ...
     *   response that it gets from the connector after placing data. For example, this setting
     *   would determine where to write the response from a destination connector upon a successful
     *   insert operation.
     */
    ...
    public fun successResponseHandlingConfig(
        successResponseHandlingConfig: CfnFlow.SuccessResponseHandlingConfigProperty
    ) {
        cdkBuilder.successResponseHandlingConfig(successResponseHandlingConfig)
    }
