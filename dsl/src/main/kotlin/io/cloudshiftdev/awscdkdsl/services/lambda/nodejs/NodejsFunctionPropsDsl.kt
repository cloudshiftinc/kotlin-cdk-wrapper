...
public class NodejsFunctionPropsDsl {
     ...
     *   the AWS SDK for JavaScript. This sets the `AWS_NODEJS_CONNECTION_REUSE_ENABLED` environment
     *   variable to `1`.
     */
     ...
     *   or `package-lock.json`). This will be used as the source for the volume mounted in the
     *   Docker container.
     *
    ...
    /**
     * @param handler The name of the exported handler in the entry file. The handler is prefixed
     *   with `index.` unless the specified handler value contains a `.`, in which case it is used
     *   as-is.
     */
    ...
    /**
     * @param runtime The runtime environment. Only runtimes of the Node.js family are supported.
     */
    ...
    public fun build(): NodejsFunctionProps {
