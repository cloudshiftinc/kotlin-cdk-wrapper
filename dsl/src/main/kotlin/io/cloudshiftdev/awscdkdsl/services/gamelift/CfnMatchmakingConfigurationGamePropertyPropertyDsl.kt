 ...
 * setting up the new game session. For example, a game property might specify a game mode, level,
 * or map. Game properties are passed to the game server process when initiating a new game session.
