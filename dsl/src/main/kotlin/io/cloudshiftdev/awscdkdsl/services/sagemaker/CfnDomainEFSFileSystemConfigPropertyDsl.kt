 ...
 */
@CdkDslMarker
public class CfnDomainEFSFileSystemConfigPropertyDsl {
    private val cdkBuilder: CfnDomain.EFSFileSystemConfigProperty.Builder =
    ...
    public fun build(): CfnDomain.EFSFileSystemConfigProperty = cdkBuilder.build()
}
