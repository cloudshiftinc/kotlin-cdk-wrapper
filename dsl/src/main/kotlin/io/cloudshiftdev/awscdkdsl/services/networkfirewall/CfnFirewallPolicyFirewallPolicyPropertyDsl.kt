...
public class CfnFirewallPolicyFirewallPolicyPropertyDsl {
     ...
     *   stateful rules. The stateful default action is optional, and is only valid when using the
     *   strict rule order.
     *
     ...
     *   stateful rules. The stateful rule groups that you use in your policy must have stateful
    ...
    public fun statefulEngineOptions(
        statefulEngineOptions: CfnFirewallPolicy.StatefulEngineOptionsProperty
    ) {
        cdkBuilder.statefulEngineOptions(statefulEngineOptions)
    }
     ...
     *   the policy. These define the inspection criteria in stateful rules.
     */
     ...
     *   firewall policy's `StatelessDefaultActions` setting. You name each custom action that you
     ...
     *   stateless rules in the policy. If you want non-matching packets to be forwarded for
     ...
     *   doesn't match any of the stateless rules in the policy. If you want non-matching fragmented
    ...
    public fun statelessFragmentDefaultActions(
        statelessFragmentDefaultActions: Collection<String>
    ) {
     ...
     *   the policy. These define the matching criteria in stateless rules.
     */
