...
public class CfnChannelInputLossBehaviorPropertyDsl {
     ...
     *   output before switching to the frame specified by inputLossImageType. A value x, where 0
     *   &lt;= x &lt;= 1,000,000 and a value of 1,000,000, is interpreted as infinite.
     */
     ...
     *   the color to use. Value: 6 hex characters that represent the values of RGB.
     */
     ...
     *   picture before substituting black into the output. A value x, where 0 &lt;= x &lt;=
