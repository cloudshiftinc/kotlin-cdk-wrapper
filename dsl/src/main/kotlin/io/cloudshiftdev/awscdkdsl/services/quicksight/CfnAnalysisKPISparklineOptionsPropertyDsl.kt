 ...
 */
@CdkDslMarker
public class CfnAnalysisKPISparklineOptionsPropertyDsl {
    private val cdkBuilder: CfnAnalysis.KPISparklineOptionsProperty.Builder =
    ...
    public fun build(): CfnAnalysis.KPISparklineOptionsProperty = cdkBuilder.build()
}
