 ...
 * the stack, once and only once, irrespective of how many times the construct is declared to be
 * part of the stack. This is guaranteed as long as the `uuid` property and the optional
...
public class SingletonFunctionDsl(
    ...
    private val cdkBuilder: SingletonFunction.Builder = SingletonFunction.Builder.create(scope, id)
     ...
     *
     * The identifier should be unique across all custom resource providers. We recommend generating
     * a UUID per provider.
     *
    ...
    public fun build(): SingletonFunction {
