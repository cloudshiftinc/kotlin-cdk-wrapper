...
public class CfnRecordSetGroupRecordSetPropertyDsl {
    ...
    public fun geoProximityLocation(
        geoProximityLocation: CfnRecordSetGroup.GeoProximityLocationProperty
    ) {
        cdkBuilder.geoProximityLocation(geoProximityLocation)
    }
    ...
    /**
     * @param resourceRecords Information about the records that you want to create. Each record
     *   should be in the format appropriate for the record type specified by the `Type` property.
     *   For information about different record types and their record formats, see
