...
public class CfnUserPoolEmailConfigurationPropertyDsl {
     ...
     *   using Amazon SES. A configuration set is applied to an email by including a reference to
     *   the configuration set in the headers of the email. Once applied, all of the rules in that
     ...
     *   functionality. When you use the default option, Amazon Cognito allows only a limited number
     *   of emails each day for your user pool. For typical production environments, the default
     *   email limit is less than the required delivery volume. To achieve a higher delivery volume,
     ...
     *   verified email address. When you use this option, the email delivery limits are the same
     ...
     * permissions that allow you to access Amazon SES and send email messages from your email
     ...
     * user pool. Typically, the Region in the `SourceArn` and the user pool Region are the same.
