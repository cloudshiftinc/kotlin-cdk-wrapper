...
public class CfnNetworkInsightsPathPropsDsl {
     ...
     *   source. If you specify this parameter, you can't specify the parameters for the source IP
     *   address or the destination port.
     */
    ...
    /**
     * @param source The ID or ARN of the source. If the resource is in another account, you must
     *   specify an ARN.
     */
