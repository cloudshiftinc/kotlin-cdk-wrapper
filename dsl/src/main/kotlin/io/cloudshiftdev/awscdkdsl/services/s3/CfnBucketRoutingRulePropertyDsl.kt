...
public class CfnBucketRoutingRulePropertyDsl {
    ...
    /**
     * @param redirectRule Container for redirect information. You can redirect requests to another
     *   host, to another page, or with another protocol. In the event of an error, you can specify
     ...
     *   specified redirect to apply. For example, 1. If request is for pages in the `/docs` folder,
     *   redirect to the `/documents` folder. 2. If request results in HTTP error 4xx, redirect
