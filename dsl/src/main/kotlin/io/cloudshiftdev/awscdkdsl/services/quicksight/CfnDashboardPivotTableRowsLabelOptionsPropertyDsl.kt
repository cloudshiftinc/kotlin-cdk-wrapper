 ...
 */
@CdkDslMarker
public class CfnDashboardPivotTableRowsLabelOptionsPropertyDsl {
    private val cdkBuilder: CfnDashboard.PivotTableRowsLabelOptionsProperty.Builder =
    ...
    public fun build(): CfnDashboard.PivotTableRowsLabelOptionsProperty = cdkBuilder.build()
}
