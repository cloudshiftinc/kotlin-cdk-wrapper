...
public class CfnLifecyclePolicyEncryptionConfigurationPropertyDsl {
     ...
     *   not enabled, enable encryption using this parameter. Copies of encrypted snapshots are
     *   encrypted, even if this parameter is false or when encryption by default is not enabled.
     */
