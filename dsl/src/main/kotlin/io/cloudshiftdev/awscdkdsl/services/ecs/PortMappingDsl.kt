...
public class PortMappingDsl {
    ...
    /**
     * @param appProtocol The protocol used by Service Connect. Valid values are AppProtocol.http,
     *   AppProtocol.http2, and AppProtocol.grpc. The protocol determines what telemetry will be
     *   shown in the ECS Console for Service Connect services using this port mapping.
     *
     ...
     *   you are using containers in a task with the awsvpc or host network mode, the hostPort can
     ...
     *   mapping with ECS Service Connect. This field may only be set when the task definition uses
     *   Bridge or Awsvpc network modes.
     */
