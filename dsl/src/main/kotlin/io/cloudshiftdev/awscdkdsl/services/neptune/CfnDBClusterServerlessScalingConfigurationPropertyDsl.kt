...
public class CfnDBClusterServerlessScalingConfigurationPropertyDsl {
     ...
     *   an Neptune Serverless cluster. You can specify NCU values in half-step increments, such as
     *   40, 40.5, 41, and so on. The smallest value you can use is 2.5, whereas the largest is 128.
     */
     ...
     *   an Neptune Serverless cluster. You can specify NCU values in half-step increments, such as
     *   8, 8.5, 9, and so on. The smallest value you can use is 1, whereas the largest is 128.
     */
