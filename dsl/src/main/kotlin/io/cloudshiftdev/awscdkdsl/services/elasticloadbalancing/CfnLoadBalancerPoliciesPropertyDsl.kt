...
public class CfnLoadBalancerPoliciesPropertyDsl {
    ...
    /**
     * @param instancePorts The instance ports for the policy. Required only for some policy types.
     */
    ...
    /**
     * @param loadBalancerPorts The load balancer ports for the policy. Required only for some
     *   policy types.
     */
