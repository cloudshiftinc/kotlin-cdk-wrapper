 ...
 * software. Each maintenance window has a schedule, a duration, a set of registered targets, and a
...
public class CfnMaintenanceWindowDsl(
    ...
    private val cdkBuilder: CfnMaintenanceWindow.Builder =
        CfnMaintenanceWindow.Builder.create(scope, id)
