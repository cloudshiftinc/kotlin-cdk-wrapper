...
public object cloud9 {
     ...
     * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-cloud9-environmentec2.html)
     */
    public inline fun cfnEnvironmentEC2Props(
        block: CfnEnvironmentEC2PropsDsl.() -> Unit = {}
    ...
    /**
     * The `Repository` property type specifies an AWS CodeCommit source code repository to be
     ...
     */
    public inline fun cfnEnvironmentEC2RepositoryProperty(
        block: CfnEnvironmentEC2RepositoryPropertyDsl.() -> Unit = {}
