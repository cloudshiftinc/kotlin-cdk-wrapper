...
public object datapipeline {
     ...
     * resources. For information about pipeline objects and components that you can use, see
     ...
     * Changes to the pipeline are saved unless one of the following validation errors exist in the
     * pipeline.
     ...
     */
    public inline fun cfnPipelineFieldProperty(
        block: CfnPipelineFieldPropertyDsl.() -> Unit = {}
