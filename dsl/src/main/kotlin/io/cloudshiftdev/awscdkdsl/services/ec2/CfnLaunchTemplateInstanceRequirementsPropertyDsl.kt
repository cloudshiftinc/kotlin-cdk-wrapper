...
public class CfnLaunchTemplateInstanceRequirementsPropertyDsl {
    ...
    public fun acceleratorTotalMemoryMiB(
        acceleratorTotalMemoryMiB: CfnLaunchTemplate.AcceleratorTotalMemoryMiBProperty
    ) {
        cdkBuilder.acceleratorTotalMemoryMiB(acceleratorTotalMemoryMiB)
    }
    ...
    public fun baselineEbsBandwidthMbps(
        baselineEbsBandwidthMbps: CfnLaunchTemplate.BaselineEbsBandwidthMbpsProperty
    ) {
        cdkBuilder.baselineEbsBandwidthMbps(baselineEbsBandwidthMbps)
    }
     ...
     *   more wild cards, represented by an asterisk ( `*` ), to exclude an instance type, size, or
    ...
    public fun networkBandwidthGbps(
        networkBandwidthGbps: CfnLaunchTemplate.NetworkBandwidthGbpsProperty
    ) {
        cdkBuilder.networkBandwidthGbps(networkBandwidthGbps)
    }
    ...
    public fun networkInterfaceCount(
        networkInterfaceCount: CfnLaunchTemplate.NetworkInterfaceCountProperty
    ) {
        cdkBuilder.networkInterfaceCount(networkInterfaceCount)
    }
    ...
    public fun totalLocalStorageGb(
        totalLocalStorageGb: CfnLaunchTemplate.TotalLocalStorageGBProperty
    ) {
        cdkBuilder.totalLocalStorageGb(totalLocalStorageGb)
    }
