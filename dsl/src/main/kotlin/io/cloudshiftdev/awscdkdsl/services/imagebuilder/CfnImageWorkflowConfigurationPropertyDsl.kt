 ...
 */
@CdkDslMarker
public class CfnImageWorkflowConfigurationPropertyDsl {
    private val cdkBuilder: CfnImage.WorkflowConfigurationProperty.Builder =
    ...
    public fun build(): CfnImage.WorkflowConfigurationProperty {
