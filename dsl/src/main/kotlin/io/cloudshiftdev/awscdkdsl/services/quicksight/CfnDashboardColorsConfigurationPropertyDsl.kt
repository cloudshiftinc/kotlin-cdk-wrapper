 ...
 */
@CdkDslMarker
public class CfnDashboardColorsConfigurationPropertyDsl {
    private val cdkBuilder: CfnDashboard.ColorsConfigurationProperty.Builder =
    ...
    public fun build(): CfnDashboard.ColorsConfigurationProperty {
