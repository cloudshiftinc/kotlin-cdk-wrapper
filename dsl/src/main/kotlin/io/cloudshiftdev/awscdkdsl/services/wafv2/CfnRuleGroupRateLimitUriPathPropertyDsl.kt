 ...
 */
@CdkDslMarker
public class CfnRuleGroupRateLimitUriPathPropertyDsl {
    private val cdkBuilder: CfnRuleGroup.RateLimitUriPathProperty.Builder =
    ...
    public fun build(): CfnRuleGroup.RateLimitUriPathProperty {
