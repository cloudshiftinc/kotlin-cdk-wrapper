 ...
 * configuration and associating that Launch Template with the instance. If an Instance is already
 * associated with a Launch Template, a warning will (optionally) be added to the construct node and
 * it will be skipped.
 *
...
public class InstanceRequireImdsv2AspectDsl {
     ...
     * to suppress false-positive warnings because any Launch Templates associated with Instances
