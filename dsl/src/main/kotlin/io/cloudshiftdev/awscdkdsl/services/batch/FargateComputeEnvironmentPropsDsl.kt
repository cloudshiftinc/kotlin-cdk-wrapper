 ...
 */
@CdkDslMarker
public class FargateComputeEnvironmentPropsDsl {
    private val cdkBuilder: FargateComputeEnvironmentProps.Builder =
    ...
    public fun build(): FargateComputeEnvironmentProps {
