...
public class AsgCapacityProviderPropsDsl {
     ...
     *   Auto Scaling Group will be managed for you. This means your cluster will automatically
     *   scale instances based on the load your tasks put on the cluster. For more information, see
     ...
     *   terminate EC2 instances that no longer have running non-daemon tasks. Scale-in protection
     *   will be automatically enabled on instances. When all non-daemon tasks are stopped on an
     *   instance, ECS initiates the scale-in process and turns off scale-in protection for the
     *   instance. The Auto Scaling Group can then terminate the instance. For more information see
     *   <a
    ...
    /**
     * @param maximumScalingStepSize Maximum scaling step size. In most cases this should be left
     *   alone.
     */
    ...
    /**
     * @param minimumScalingStepSize Minimum scaling step size. In most cases this should be left
     *   alone.
     */
    ...
    /**
     * @param targetCapacityPercent Target capacity percent. In most cases this should be left
     *   alone.
     */
