...
public class LustreFileSystemDsl(
     ...
     * types, valid values are 1,200, 2,400, 3,600, then continuing in increments of 3,600 GiB. For
     * SCRATCH_2 and PERSISTENT_1 types, valid values are 1,200, 2,400, then continuing in
