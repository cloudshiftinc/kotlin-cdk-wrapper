...
public class CodeDeployEcsDeployActionDsl {
     ...
     *
     * During deployment, a new task definition will be registered with ECS, and the new task
     * definition ID will be inserted into the CodeDeploy AppSpec file. The AppSpec file contents
     * will be provided to CodeDeploy for the deployment.
     *
     ...
     *
     * Provide pairs of an image details input artifact and a placeholder string that will be used
     * to dynamically update the ECS task definition template file prior to deployment. A maximum of
     * 4 images can be given.
     *
