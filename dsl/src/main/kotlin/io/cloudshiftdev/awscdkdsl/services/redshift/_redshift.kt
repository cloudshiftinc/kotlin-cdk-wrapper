...
public object redshift {
     ...
     * Amazon EC2 instance, you can authorize inbound access to either a Classless Interdomain
     * Routing (CIDR)/Internet Protocol (IP) range or to an Amazon EC2 security group. You can add
     ...
     * *EC2SecurityGroupOwnerId* . The Amazon EC2 security group and Amazon Redshift cluster must be
     ...
     * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-redshift-endpointaccess.html)
     */
    public inline fun cfnEndpointAccessProps(
        block: CfnEndpointAccessPropsDsl.() -> Unit = {}
     ...
     *
     * A scheduled action contains a schedule and an Amazon Redshift API action. For example, you
     * can create a schedule of when to run the `ResizeCluster` API operation.
     *
     * Example:
     * ```
     * // The code below shows an example of how to instantiate this type.
    ...
    /**
     * The action type that specifies an Amazon Redshift API operation that is supported by the
