...
public class CfnLoggingConfigurationFieldToMatchPropertyDsl {
    ...
    /**
     * @param method Redact the indicated HTTP method. The method indicates the type of operation
    ...
    /**
     * @param queryString Redact the query string. This is the part of a URL that appears after a
     *   `?` character, if any.
     */
    ...
    /**
     * @param singleHeader Redact a single header. Provide the name of the header to inspect, for
