 ...
 */
@CdkDslMarker
public class CfnTemplateEnrollmentFlagsV2PropertyDsl {
    private val cdkBuilder: CfnTemplate.EnrollmentFlagsV2Property.Builder =
    ...
    public fun build(): CfnTemplate.EnrollmentFlagsV2Property = cdkBuilder.build()
}
