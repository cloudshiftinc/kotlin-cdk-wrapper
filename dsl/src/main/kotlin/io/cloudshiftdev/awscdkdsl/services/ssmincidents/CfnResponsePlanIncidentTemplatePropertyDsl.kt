...
public class CfnResponsePlanIncidentTemplatePropertyDsl {
     ...
     *   relates to full application failure that impacts many to all customers.
    ...
    /**
     * @param incidentTags Tags to assign to the template. When the `StartIncident` API action is
    ...
    /**
     * @param notificationTargets The SNS targets that AWS Chatbot uses to notify the chat channel
