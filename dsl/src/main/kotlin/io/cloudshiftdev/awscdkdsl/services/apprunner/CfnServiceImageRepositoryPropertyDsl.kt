...
public class CfnServiceImageRepositoryPropertyDsl {
    ...
    /**
     * @param imageIdentifier The identifier of an image. For an image in Amazon Elastic Container
     *   Registry (Amazon ECR), this is an image name. For the image name format, see
    ...
    /**
     * @param imageRepositoryType The type of the image repository. This reflects the repository
