...
public object codedeploy {
     ...
     * ```
     */
    public inline fun autoRollbackConfig(
        block: AutoRollbackConfigDsl.() -> Unit = {}
    ): AutoRollbackConfig {
     ...
     * ```
     */
    public inline fun baseDeploymentConfigProps(
        block: BaseDeploymentConfigPropsDsl.() -> Unit = {}
     ...
     * ```
     */
    public inline fun baseTrafficShiftingConfigProps(
        block: BaseTrafficShiftingConfigPropsDsl.() -> Unit = {}
     ...
     * correct combination of revision, deployment configuration, and deployment group are
     * referenced during a deployment. You can use the `AWS::CodeDeploy::DeploymentGroup` resource
     * to associate the application with a CodeDeploy deployment group. For more information, see
    ...
    /**
     * The `AWS::CodeDeploy::DeploymentConfig` resource creates a set of deployment rules,
     ...
     * resource that defines how many instances must remain healthy during an AWS CodeDeploy
     * deployment.
     *
     * Example:
     * ```
     ...
     * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-codedeploy-deploymentconfig.html)
     */
    public inline fun cfnDeploymentConfigProps(
        block: CfnDeploymentConfigPropsDsl.() -> Unit = {}
     ...
     * to another version during an AWS Lambda deployment, or from one Amazon ECS task set to
     * another during an Amazon ECS deployment.
     *
     * Example:
     * ```
     * // The code below shows an example of how to instantiate this type.
     ...
     * that specifies which instances your application revisions are deployed to, along with other
     * deployment options.
     *
     ...
     * `AWS::CodeDeploy::DeploymentGroup` resource. To perform Amazon ECS blue/green deployments,
     * use the `AWS::CodeDeploy::BlueGreen` hook. See
    ...
    /**
     * The `Alarm` property type specifies a CloudWatch alarm to use for an AWS CodeDeploy
     * deployment group.
     *
     * The `Alarm` property of the
     * [CodeDeploy DeploymentGroup AlarmConfiguration](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-codedeploy-deploymentgroup-alarmconfiguration.html)
     ...
     * [DeploymentGroup](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-codedeploy-deploymentgroup.html)
     * resource that specifies an AWS CodeDeploy application revision to be deployed to instances in
     * the deployment group. If you specify an application revision, your target revision is
    ...
    /**
     * The `EC2TagSet` property type specifies information about groups of tags applied to Amazon
     * EC2 instances.
     *
     ...
     *
     * If you specify the `ELBInfo` property, the `DeploymentStyle.DeploymentOption` property must
     * be set to `WITH_TRAFFIC_CONTROL` for AWS CodeDeploy to route your traffic using the specified
     * load balancers.
     *
     ...
     * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-codedeploy-deploymentgroup.html)
     */
    public inline fun cfnDeploymentGroupProps(
        block: CfnDeploymentGroupPropsDsl.() -> Unit = {}
     ...
     * [CodeDeploy DeploymentGroup Revision](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-codedeploy-deploymentgroup-deployment-revision.html)
     * property that specifies the location of an application revision that is stored in Amazon
     ...
     * resource that specifies which on-premises instances to associate with the deployment group.
     * To register on-premise instances with AWS CodeDeploy , see
    ...
    /**
     * The `TargetGroupInfo` property type specifies information about a target group in Elastic
     ...
     *
     * If you specify the `TargetGroupInfo` property, the `DeploymentStyle.DeploymentOption`
     * property must be set to `WITH_TRAFFIC_CONTROL` for CodeDeploy to route your traffic using the
     ...
     * ```
     */
    public inline fun ecsApplicationProps(
        block: EcsApplicationPropsDsl.() -> Unit = {}
    ): EcsApplicationProps {
     ...
     * ```
     */
    public inline fun ecsDeploymentConfigProps(
        block: EcsDeploymentConfigPropsDsl.() -> Unit = {}
     ...
     * ```
     */
    public inline fun ecsDeploymentGroupProps(
        block: EcsDeploymentGroupPropsDsl.() -> Unit = {}
     ...
     * ```
     */
    public inline fun lambdaApplicationProps(
        block: LambdaApplicationPropsDsl.() -> Unit = {}
     ...
     * ```
     */
    public inline fun serverApplicationProps(
        block: ServerApplicationPropsDsl.() -> Unit = {}
     ...
     * ```
     */
    public inline fun trafficRoutingConfig(
        block: TrafficRoutingConfigDsl.() -> Unit = {}
