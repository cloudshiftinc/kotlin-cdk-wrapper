...
public class CfnDBClusterParameterGroupPropsDsl {
    ...
    /**
     * @param dbClusterParameterGroupName The name of the DB cluster parameter group. Constraints:
    ...
    /**
     * @param family The DB cluster parameter group family name. A DB cluster parameter group can be
     *   associated with one and only one DB cluster parameter group family, and can be applied only
     *   to a DB cluster running a DB engine and engine version compatible with that DB cluster
