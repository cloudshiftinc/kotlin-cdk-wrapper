...
public class PublicHostedZonePropsDsl {
     ...
     *   zone delegation. If supplied, this will create a Role in the same account as the Hosted
     *   Zone, which can be assumed by the `CrossAccountZoneDelegationRecord` to create a delegation
     *   record to a zone in a different account.
     *
