 ...
 */
@CdkDslMarker
public class CfnUserProfileCustomPosixUserConfigPropertyDsl {
    private val cdkBuilder: CfnUserProfile.CustomPosixUserConfigProperty.Builder =
    ...
    public fun build(): CfnUserProfile.CustomPosixUserConfigProperty = cdkBuilder.build()
}
