...
public class DatabaseInstanceReadReplicaPropsDsl {
    ...
    /**
     * @param sourceDatabaseInstance The source database instance. Each DB instance can have a
     *   limited number of read replicas. For more information, see
    ...
    public fun build(): DatabaseInstanceReadReplicaProps {
