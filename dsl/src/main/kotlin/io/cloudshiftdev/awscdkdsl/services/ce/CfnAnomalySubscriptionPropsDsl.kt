...
public class CfnAnomalySubscriptionPropsDsl {
    ...
    /**
     * @param frequency The frequency that anomaly notifications are sent. Notifications are sent
     *   either over email (for DAILY and WEEKLY frequencies) or SNS (for IMMEDIATE frequency). For
    ...
    /**
     * @param threshold (deprecated). An absolute dollar value that must be exceeded by the
     *   anomaly's total impact (see
     ...
     *   10,000,000,000 in string format. One of Threshold or ThresholdExpression is required for
