 ...
 * [Creating point maps](https://docs.aws.amazon.com/quicksight/latest/user/point-maps.html) in the
 ...
 */
@CdkDslMarker
public class CfnDashboardGeospatialMapVisualPropertyDsl {
    private val cdkBuilder: CfnDashboard.GeospatialMapVisualProperty.Builder =
    ...
    public fun chartConfiguration(
        chartConfiguration: CfnDashboard.GeospatialMapConfigurationProperty
    ) {
        cdkBuilder.chartConfiguration(chartConfiguration)
    }
    ...
    public fun build(): CfnDashboard.GeospatialMapVisualProperty {
