...
public class CfnEndpointConfigPropsDsl {
    ...
    /**
     * @param dataCaptureConfig Specifies how to capture endpoint data for model monitor. The data
    ...
    /**
     * @param shadowProductionVariants Array of `ProductionVariant` objects. There is one for each
     *   model that you want to host at this endpoint in shadow mode with production traffic
     *   replicated from the model specified on `ProductionVariants` . If you use this field, you
     *   can only specify one variant for `ProductionVariants` and one variant for
