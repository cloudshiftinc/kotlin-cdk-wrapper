...
public class CfnEvaluationFormSingleSelectQuestionRuleCategoryAutomationPropertyDsl {
    ...
    /**
     * @param condition The condition to apply for the automation option. If the condition is
     *   PRESENT, then the option is applied when the contact data includes the category. Similarly,
     *   if the condition is NOT_PRESENT, then the option is applied when the contact data does not
