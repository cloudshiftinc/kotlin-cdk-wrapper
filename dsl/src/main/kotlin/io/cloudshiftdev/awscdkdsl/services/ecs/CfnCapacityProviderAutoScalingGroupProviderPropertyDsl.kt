...
public class CfnCapacityProviderAutoScalingGroupProviderPropertyDsl {
     ...
     *   Auto Scaling group capacity provider. This determines whether the Auto Scaling group has
     ...
     * Auto Scaling group that contain tasks from being terminated during a scale-in action. The
