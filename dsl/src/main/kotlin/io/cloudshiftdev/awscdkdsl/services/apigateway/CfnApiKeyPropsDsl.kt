...
public class CfnApiKeyPropsDsl {
     ...
     *   is distinct from the created API key value. This parameter is deprecated and should not be
     *   used.
     */
    ...
    /**
     * @param name A name for the API key. If you don't specify a name, AWS CloudFormation generates
     *   a unique physical ID and uses that ID for the API key name. For more information, see
