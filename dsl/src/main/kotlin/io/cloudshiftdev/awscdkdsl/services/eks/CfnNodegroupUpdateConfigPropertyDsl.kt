...
public class CfnNodegroupUpdateConfigPropertyDsl {
     ...
     *   update. Nodes are updated in parallel. This value or `maxUnavailablePercentage` is required
     ...
     *   update. This percentage of nodes are updated in parallel, up to 100 nodes at once. This
