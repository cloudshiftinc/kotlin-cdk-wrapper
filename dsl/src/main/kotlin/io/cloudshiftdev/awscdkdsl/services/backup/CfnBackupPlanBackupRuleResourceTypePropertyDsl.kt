...
public class CfnBackupPlanBackupRuleResourceTypePropertyDsl {
    ...
    /**
     * @param startWindowMinutes An optional value that specifies a period of time in minutes after
     *   a backup is scheduled before a job is canceled if it doesn't start successfully. If this
     *   value is included, it must be at least 60 minutes to avoid errors.
     */
    ...
    /**
     * @param targetBackupVault The name of a logical container where backups are stored. Backup
