 ...
 */
@CdkDslMarker
public class CfnTransformerEdiTypePropertyDsl {
    private val cdkBuilder: CfnTransformer.EdiTypeProperty.Builder =
     ...
     *   messages that define specific business documents.
     */
    public fun x12Details(x12Details: CfnTransformer.X12DetailsProperty) {
        cdkBuilder.x12Details(x12Details)
    }

    public fun build(): CfnTransformer.EdiTypeProperty = cdkBuilder.build()
}
