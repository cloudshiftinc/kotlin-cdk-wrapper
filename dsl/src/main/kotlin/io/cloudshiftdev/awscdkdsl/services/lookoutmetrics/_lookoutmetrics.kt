...
public object lookoutmetrics {
     ...
     */
    public inline fun cfnAlertActionProperty(
        block: CfnAlertActionPropertyDsl.() -> Unit = {}
    ...
    /**
     * Contains information about the SNS topic to which you want to send your alerts and the IAM
     * role that has access to that topic.
     *
     * Example:
     * ```
     * // The code below shows an example of how to instantiate this type.
