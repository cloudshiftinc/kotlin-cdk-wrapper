...
public object fms {
    /**
     * Designates the IAM role and Amazon Simple Notification Service (SNS) topic to use to record
     * SNS logs.
     *
     ...
     * * An AWS Shield Advanced policy, which applies Shield Advanced protection to specified
     ...
     *   groups in Amazon CloudFront , so, to create AWS WAF Classic policies through CloudFront ,
     *   you first need to create your rule groups outside of CloudFront .
     ...
     * prerequisites and getting started under
     ...
     */
    public inline fun cfnPolicyIEMapProperty(
        block: CfnPolicyIEMapPropertyDsl.() -> Unit = {}
     ...
     *
     * For information about Network Firewall deployment models, see
    ...
    /**
     * Contains the AWS Network Firewall firewall policy options to configure the policy's
     ...
     * combines the tags with "AND" so that, if you add more than one tag to a policy scope, a
     * resource must have all the specified tags to be included or excluded. For more information,
     * see
