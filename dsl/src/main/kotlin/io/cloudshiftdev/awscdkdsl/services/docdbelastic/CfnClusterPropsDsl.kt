...
public class CfnClusterPropsDsl {
     ...
     *   can contain any printable ASCII characters. *Constraints* :
    ...
    /**
     * @param kmsKeyId The KMS key identifier to use to encrypt the new elastic cluster. The KMS key
    ...
    /**
     * @param shardCapacity The number of vCPUs assigned to each elastic cluster shard. Maximum
