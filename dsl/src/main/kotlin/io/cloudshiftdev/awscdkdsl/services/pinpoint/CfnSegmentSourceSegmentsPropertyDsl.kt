 ...
 * a segment. When you add dimensions to the segment, Amazon Pinpoint filters the base segment by
 ...
 * imported segment, the segment size estimate that displays on the Amazon Pinpoint console
