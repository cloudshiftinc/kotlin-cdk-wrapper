...
public class FargateTaskDefinitionPropsDsl {
    private val cdkBuilder: FargateTaskDefinitionProps.Builder =
        FargateTaskDefinitionProps.builder()

    private val _volumes: MutableList<Volume> = mutableListOf()

    /**
     * @param cpu The number of cpu units used by the task. For tasks using the Fargate launch type,
     ...
     *   task. The maximum supported value is 200 GiB.
     *
    ...
    /**
     * @param memoryLimitMiB The amount (in MiB) of memory used by the task. For tasks using the
