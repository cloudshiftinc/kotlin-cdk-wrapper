 ...
 */
@CdkDslMarker
public class CfnRecordSetGeoProximityLocationPropertyDsl {
    private val cdkBuilder: CfnRecordSet.GeoProximityLocationProperty.Builder =
    ...
    /** @param coordinates Contains the longitude and latitude for a geographic region. */
    public fun coordinates(coordinates: CfnRecordSet.CoordinatesProperty) {
        cdkBuilder.coordinates(coordinates)
    }
    ...
    public fun build(): CfnRecordSet.GeoProximityLocationProperty = cdkBuilder.build()
}
