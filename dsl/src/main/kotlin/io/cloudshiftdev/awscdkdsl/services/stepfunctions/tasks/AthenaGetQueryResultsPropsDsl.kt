 ...
 */
@CdkDslMarker
public class AthenaGetQueryResultsPropsDsl {
    private val cdkBuilder: AthenaGetQueryResultsProps.Builder =
    ...
    /**
     * @param queryExecutionId Query that will be retrieved. Example value: `adfsaf-23trf23-f23rt23`
     */
    ...
    public fun build(): AthenaGetQueryResultsProps = cdkBuilder.build()
}
