...
public class CfnDBClusterPropsDsl {
     ...
     *   must specify a minimum value of 1. Default: 1
     *
     * Constraints:
    ...
    /**
     * @param dbSubnetGroupName A subnet group to associate with this cluster. Constraints: Must
    ...
    /**
     * @param deletionProtection Protects clusters from being accidentally deleted. If enabled, the
    ...
    /**
     * @param kmsKeyId The AWS KMS key identifier for an encrypted cluster. The AWS KMS key
    ...
    /**
     * @param masterUserPassword The password for the master database user. This password can
    ...
    /**
     * @param masterUsername The name of the master user for the cluster. Constraints:
