...
public class CfnDatasetContainerActionPropertyDsl {
     ...
     *   needed resources in order to run the "containerAction". This includes, at minimum,
    ...
    /**
     * @param image The ARN of the Docker container stored in your account. The Docker container
     *   contains an application and needed support libraries and is used to generate data set
     *   contents.
     */
    ...
    public fun resourceConfiguration(
        resourceConfiguration: CfnDataset.ResourceConfigurationProperty
    ) {
        cdkBuilder.resourceConfiguration(resourceConfiguration)
    }
     ...
     *   containerized application (basically, parameters passed to the application). Each variable
