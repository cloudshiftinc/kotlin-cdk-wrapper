...
public class CfnAlarmPropsDsl {
     ...
     *   messaging), or both. *Allowed Values* : `Email` | `SMS`
     */
    ...
    /**
     * @param treatMissingData Specifies how the alarm handles missing data points. An alarm can
     *   treat missing data in the following ways:
    ...
    public fun build(): CfnAlarmProps {
        ...
        if (_notificationTriggers.isNotEmpty())
            cdkBuilder.notificationTriggers(_notificationTriggers)
