 ...
 *
 * Be aware that the header values must be arrays. When passing the Task Token in the headers field
 * `WAIT_FOR_TASK_TOKEN` integration, use `JsonPath.array()` to wrap the token in an array:
 * ```
