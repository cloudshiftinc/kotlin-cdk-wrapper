...
public class CfnRuleGroupStatelessRulesAndCustomActionsPropertyDsl {
     ...
     *   specification. You name each custom action that you define, and then you can use it by name
     *   in your stateless rule `RuleGroup.RuleDefinition` `Actions` specification.
     */
