...
public class InstanceRequireImdsv2AspectPropsDsl {
     ...
     *   is associated with an existing Launch Template should be suppressed or not. You can set
     *   this to `true` if `LaunchTemplateImdsAspect` is being used alongside this Aspect to
     *   suppress false-positive warnings because any Launch Templates associated with Instances
