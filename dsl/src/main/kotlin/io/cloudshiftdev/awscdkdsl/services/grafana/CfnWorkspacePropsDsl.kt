...
public class CfnWorkspacePropsDsl {
     ...
     *   organization. If this is `ORGANIZATION` , the `OrganizationalUnits` parameter specifies
     ...
     *   and notification channels. If this is `CUSTOMER_MANAGED` , you must manage those roles and
     ...
     *   will view data from. This role must already exist.
     */
