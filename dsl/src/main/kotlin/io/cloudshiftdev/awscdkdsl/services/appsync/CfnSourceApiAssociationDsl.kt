 ...
 * attached to each merged API. When linked to a merged API, the source API's schema, data sources,
 * and resolvers will be combined with other linked source API data to form a new, singular API.
 * Source APIs can originate from your account or from other accounts via Resource Access Manager.
 *
 * Example:
 * ```
...
public class CfnSourceApiAssociationDsl(
     ...
     * account) only require the API ID value or ARN of the merged API. However, Merged APIs from
     * other accounts (cross-account use cases) strictly require the full resource ARN of the merged
     * API.
     *
     ...
     * account) only require the API ID value or ARN of the source API. However, source APIs from
     * other accounts (cross-account use cases) strictly require the full resource ARN of the source
     * API.
     *
