...
public class CfnDataSourceWorkDocsConfigurationPropertyDsl {
     ...
     *   your Amazon WorkDocs site repository. Files that match the patterns are excluded from the
     ...
     *   WorkDocs data source attributes or field names to Amazon Kendra index field names. To
     *   create custom fields, use the `UpdateIndex` API before you map to Amazon WorkDocs fields.
     ...
     *   your Amazon WorkDocs site repository. Files that match the patterns are included in the
     *   index. Files that don't match the patterns are excluded from the index. If a file matches
     *   both an inclusion and exclusion pattern, the exclusion pattern takes precedence and the
     *   file isn't included in the index.
     */
     ...
     *   site repository. You can find the organization ID in the
