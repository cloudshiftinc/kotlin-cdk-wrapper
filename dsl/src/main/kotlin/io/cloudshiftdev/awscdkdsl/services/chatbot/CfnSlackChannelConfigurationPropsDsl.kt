...
public class CfnSlackChannelConfigurationPropsDsl {
    ...
    /**
     * @param slackWorkspaceId The ID of the Slack workspace authorized with AWS Chatbot . To get
     *   the workspace ID, you must perform the initial authorization flow with Slack in the AWS
     *   Chatbot console. Then you can copy and paste the workspace ID from the console. For more
