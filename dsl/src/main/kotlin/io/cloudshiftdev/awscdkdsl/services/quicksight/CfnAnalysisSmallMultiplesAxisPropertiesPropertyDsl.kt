 ...
 */
@CdkDslMarker
public class CfnAnalysisSmallMultiplesAxisPropertiesPropertyDsl {
    private val cdkBuilder: CfnAnalysis.SmallMultiplesAxisPropertiesProperty.Builder =
    ...
    public fun build(): CfnAnalysis.SmallMultiplesAxisPropertiesProperty = cdkBuilder.build()
}
