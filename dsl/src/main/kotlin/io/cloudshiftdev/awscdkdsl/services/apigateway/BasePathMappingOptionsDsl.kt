...
public class BasePathMappingOptionsDsl {
    ...
    /**
     * @param attachToStage Whether to attach the base path mapping to a stage. Use this property to
     *   create a base path mapping without attaching it to the Rest API default stage. This
     *   property is ignored if `stage` is provided.
     */
