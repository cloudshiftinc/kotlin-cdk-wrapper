...
public class EmrCreateClusterInstanceFleetConfigPropertyDsl {
    ...
    /**
     * @param instanceFleetType The node type that the instance fleet hosts. Valid values are
     ...
     *   the instance fleet.
     */
    public fun instanceTypeConfigs(
        instanceTypeConfigs: EmrCreateClusterInstanceTypeConfigPropertyDsl.() -> Unit
    ) {
        _instanceTypeConfigs.add(
            EmrCreateClusterInstanceTypeConfigPropertyDsl().apply(instanceTypeConfigs).build()
        )
    }
     ...
     */
    public fun instanceTypeConfigs(
        instanceTypeConfigs: Collection<EmrCreateCluster.InstanceTypeConfigProperty>
    ) {
    ...
    public fun launchSpecifications(
        launchSpecifications:
            EmrCreateClusterInstanceFleetProvisioningSpecificationsPropertyDsl.() -> Unit =
            {}
    ) {
    ...
    /** @param launchSpecifications The launch specification for the instance fleet. */
    public fun launchSpecifications(
        launchSpecifications: EmrCreateCluster.InstanceFleetProvisioningSpecificationsProperty
    ) {
