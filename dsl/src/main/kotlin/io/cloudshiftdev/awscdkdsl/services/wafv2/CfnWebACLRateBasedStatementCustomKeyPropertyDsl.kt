 ...
 */
@CdkDslMarker
public class CfnWebACLRateBasedStatementCustomKeyPropertyDsl {
    private val cdkBuilder: CfnWebACL.RateBasedStatementCustomKeyProperty.Builder =
     ...
     *   your custom key, then each value fully defines an aggregation instance.
     */
    public fun cookie(cookie: CfnWebACL.RateLimitCookieProperty) {
        cdkBuilder.cookie(cookie)
    }
     ...
     *   your custom key, then each value fully defines an aggregation instance.
     */
    public fun `header`(`header`: CfnWebACL.RateLimitHeaderProperty) {
        cdkBuilder.`header`(`header`)
    }
     ...
     * in the *AWS WAF Developer Guide* .
     */
    public fun labelNamespace(labelNamespace: CfnWebACL.RateLimitLabelNamespaceProperty) {
        cdkBuilder.labelNamespace(labelNamespace)
    }
     ...
     *   instance.
     */
    public fun queryArgument(queryArgument: CfnWebACL.RateLimitQueryArgumentProperty) {
        cdkBuilder.queryArgument(queryArgument)
    }
     ...
     *   key, then each string fully defines an aggregation instance.
     */
    public fun queryString(queryString: CfnWebACL.RateLimitQueryStringProperty) {
        cdkBuilder.queryString(queryString)
    }
     ...
     *   then each URI path fully defines an aggregation instance.
     */
    public fun uriPath(uriPath: CfnWebACL.RateLimitUriPathProperty) {
        cdkBuilder.uriPath(uriPath)
    }

    public fun build(): CfnWebACL.RateBasedStatementCustomKeyProperty = cdkBuilder.build()
}
