 ...
 * acme.example.com). You create records in a private hosted zone to define how you want to route
 * traffic for a domain and its subdomains within one or more Amazon Virtual Private Clouds (Amazon
 * VPCs).
 *
 ...
 * Route 53 DNS servers. When the NS and SOA records are available, the status of the zone changes
 * to `INSYNC` .
 *
...
public class CfnHostedZoneDsl(
     ...
     * optional; Amazon Route 53 assumes that the domain name is fully qualified. This means that
