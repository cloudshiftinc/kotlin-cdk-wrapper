...
public class CfnBotBotLocalePropertyDsl {
    ...
    /**
     * @param description A description of the bot locale. Use this to help identify the bot locale
     *   in lists.
     */
    ...
    /**
     * @param localeId The identifier of the language and locale that the bot will be used in. The
     *   string must match one of the supported locales.
     */
     ...
     *   intents. You must configure an `AMAZON.FallbackIntent` . `AMAZON.KendraSearchIntent` is
