...
public class AttachInitOptionsDsl {
    ...
    /**
     * @param embedFingerprint Whether to embed a hash into the userData. If `true` (the default), a
     *   hash of the config will be embedded into the UserData, so that if the config changes, the
     *   UserData changes and the instance will be replaced.
     *
