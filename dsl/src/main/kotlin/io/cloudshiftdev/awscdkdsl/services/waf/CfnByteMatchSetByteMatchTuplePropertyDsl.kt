...
public class CfnByteMatchSetByteMatchTuplePropertyDsl {
    ...
    /**
     * @param positionalConstraint Within the portion of a web request that you want to search (for
     *   example, in the query string, if any), specify where you want AWS WAF to search. Valid
    ...
    /**
     * @param targetString The value that you want AWS WAF to search for. AWS WAF searches for the
     *   specified string in the part of web requests that you specified in `FieldToMatch` . The
     ...
     *   the length of the body, you can create a size constraint set.
     ...
     *   CloudFormation sends this value to AWS WAF without encoding it. You must specify this
     *   property or the `TargetString` property.
     *
     ...
     *   attackers use in web requests in an effort to bypass AWS WAF . If you specify a
     *   transformation, AWS WAF performs the transformation on `FieldToMatch` before inspecting it
     *   for a match.
     *
