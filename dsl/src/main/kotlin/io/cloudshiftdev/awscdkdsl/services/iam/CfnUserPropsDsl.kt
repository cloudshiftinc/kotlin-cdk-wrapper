...
public class CfnUserPropsDsl {
    ...
    /**
     * @param loginProfile Creates a password for the specified IAM user. A password allows an IAM
     ...
     *   that you want to attach to the user. For more information about ARNs, see
    ...
    /**
     * @param path The path for the user name. For more information about paths, see
     ...
     *   IAM user. To view AWS::IAM::User snippets, see
    ...
    /**
     * @param tags A list of tags that you want to attach to the new user. Each tag consists of a
    ...
    /**
     * @param userName The name of the user to create. Do not include the path in this value. This
     *   parameter allows (per its
     *   [regex pattern](https://docs.aws.amazon.com/http://wikipedia.org/wiki/regex) ) a string of
     *   characters consisting of upper and lowercase alphanumeric characters with no spaces. You
     *   can also include any of the following characters: _+=,.&#64;-. The user name must be unique
     *   within the account. User names are not distinguished by case. For example, you cannot
     *   create users named both "John" and "john".
     *
