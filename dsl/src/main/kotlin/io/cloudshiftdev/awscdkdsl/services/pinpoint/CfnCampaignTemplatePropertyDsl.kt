...
public class CfnCampaignTemplatePropertyDsl {
    ...
    /**
     * @param name The name of the message template to use for the message. If specified, this value
     ...
     *   message. If specified, this value must match the identifier for an existing template
     *   version. To retrieve a list of versions and version identifiers for a template, use the
