...
public class CfnBackupSelectionPropsDsl {
     ...
     *   backup plan. It includes an array of resources, an optional array of patterns to exclude
     *   resources, an optional role to provide access to the AWS service the resource belongs to,
    ...
    public fun backupSelection(
        backupSelection: CfnBackupSelection.BackupSelectionResourceTypeProperty
    ) {
        cdkBuilder.backupSelection(backupSelection)
    }
