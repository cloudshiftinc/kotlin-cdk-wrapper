...
public class CfnScalingPolicyStepAdjustmentPropertyDsl {
    ...
    /**
     * @param scalingAdjustment The amount by which to scale. The adjustment is based on the value
     *   that you specified in the `AdjustmentType` property (either an absolute number or a
     *   percentage). A positive value adds to the current capacity and a negative number subtracts
