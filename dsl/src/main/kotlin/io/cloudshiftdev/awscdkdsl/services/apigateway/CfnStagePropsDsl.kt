...
public class CfnStagePropsDsl {
    ...
    /**
     * @param cacheClusterSize The stage's cache capacity in GB. For more information about choosing
     *   a cache size, see
    ...
    /**
     * @param methodSettings A map that defines the method settings for a Stage resource. Keys
     ...
     *   Identifier (URI) of a call to API Gateway. Stage names can only contain alphanumeric
     ...
     *   variable name is the key and the variable value is the value. Variable names are limited to
