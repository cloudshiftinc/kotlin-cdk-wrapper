...
public class CfnDeploymentStageDescriptionPropertyDsl {
    ...
    /**
     * @param cacheClusterSize The size of the stage's cache cluster. For more information, see
    ...
    /**
     * @param cachingEnabled Indicates whether responses are cached and returned for requests. You
     *   must enable a cache cluster on the stage to cache responses. For more information, see
    ...
    /**
     * @param throttlingBurstLimit The target request burst rate limit. This allows more requests
     *   through for a period of time than the target rate limit. For more information, see
    ...
    /**
     * @param throttlingRateLimit The target request steady-state rate limit. For more information,
     *   see
     *   [Manage API Request Throttling](https://docs.aws.amazon.com/apigateway/latest/developerguide/api-gateway-request-throttling.html)
     *   in the *API Gateway Developer Guide* .
     */
