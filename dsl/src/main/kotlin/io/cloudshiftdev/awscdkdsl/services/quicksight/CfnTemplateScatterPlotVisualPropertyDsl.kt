 ...
 * [Using scatter plots](https://docs.aws.amazon.com/quicksight/latest/user/scatter-plot.html) in
 ...
 */
@CdkDslMarker
public class CfnTemplateScatterPlotVisualPropertyDsl {
    private val cdkBuilder: CfnTemplate.ScatterPlotVisualProperty.Builder =
    ...
    public fun chartConfiguration(
        chartConfiguration: CfnTemplate.ScatterPlotConfigurationProperty
    ) {
        cdkBuilder.chartConfiguration(chartConfiguration)
    }
    ...
    public fun build(): CfnTemplate.ScatterPlotVisualProperty {
