...
public class CfnRealtimeLogConfigPropsDsl {
    ...
    /**
     * @param fields A list of fields that are included in each real-time log record. In an API
     *   response, the fields are provided in the same order in which they are sent to the Amazon
     *   Kinesis data stream.
     *
    ...
    /**
     * @param samplingRate The sampling rate for this real-time log configuration. The sampling rate
     *   determines the percentage of viewer requests that are represented in the real-time log
     *   data. The sampling rate is an integer between 1 and 100, inclusive.
     */
