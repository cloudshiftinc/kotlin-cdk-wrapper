...
public class CfnTaskSetPropsDsl {
     ...
     *   task set will have the `ECS_TASK_SET_EXTERNAL_ID` AWS Cloud Map attribute set to the
     *   provided value.
     */
    ...
    /**
     * @param launchType The launch type that new tasks in the task set uses. For more information,
     *   see
    ...
    /**
     * @param taskDefinition The task definition for the tasks in the task set to use. If a revision
