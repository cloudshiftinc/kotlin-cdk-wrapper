 ...
 */
@CdkDslMarker
public class CfnTemplateSubjectNameFlagsV3PropertyDsl {
    private val cdkBuilder: CfnTemplate.SubjectNameFlagsV3Property.Builder =
    ...
    public fun build(): CfnTemplate.SubjectNameFlagsV3Property = cdkBuilder.build()
}
