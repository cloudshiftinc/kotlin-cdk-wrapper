...
public class S3DeployActionPropsDsl {
    ...
    /**
     * @param accessControl The specified canned ACL to objects deployed to Amazon S3. This
    ...
    /**
     * @param encryptionKey The AWS KMS encryption key for the host bucket. The encryptionKey
     *   parameter encrypts uploaded artifacts with the provided AWS KMS key.
     */
    ...
    /** @param objectKey The key of the target object. This is required if extract is false. */
