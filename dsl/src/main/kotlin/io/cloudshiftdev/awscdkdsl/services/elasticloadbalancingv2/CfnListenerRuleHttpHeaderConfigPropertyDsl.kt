...
public class CfnListenerRuleHttpHeaderConfigPropertyDsl {
     ...
     *   The header name is case insensitive. The allowed characters are specified by RFC 7230.
    ...
    /**
     * @param values The strings to compare against the value of the HTTP header. The maximum size
     ...
     * value of the HTTP header. To require that all of the strings are a match, create one
