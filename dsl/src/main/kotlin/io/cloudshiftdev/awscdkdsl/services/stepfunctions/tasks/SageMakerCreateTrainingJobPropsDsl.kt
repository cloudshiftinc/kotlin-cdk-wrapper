...
public class SageMakerCreateTrainingJobPropsDsl {
    ...
    public fun algorithmSpecification(
        algorithmSpecification: AlgorithmSpecificationDsl.() -> Unit = {}
    ) {
    ...
    /**
     * @param enableNetworkIsolation Isolates the training container. No inbound or outbound network
     *   calls can be made to or from the training container.
     */
    ...
    /**
     * @param role Role for the Training Job. The role must be granted all necessary permissions for
     *   the SageMaker training job to be able to operate.
     *
     * See
