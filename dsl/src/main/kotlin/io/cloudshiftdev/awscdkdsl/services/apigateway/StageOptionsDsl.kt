...
public class StageOptionsDsl {
     ...
     *   $content variables. The format must include either `AccessLogFormat.contextRequestId()` or
    ...
    /**
     * @param dataTraceEnabled Specifies whether data trace logging is enabled for this method. When
     *   enabled, API gateway will log the full API requests and responses. This can be useful to
