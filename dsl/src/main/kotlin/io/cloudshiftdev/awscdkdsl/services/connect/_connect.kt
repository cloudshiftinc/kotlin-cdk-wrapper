...
public object connect {
     ...
     * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-connect-approvedorigin.html)
     */
    public inline fun cfnApprovedOriginProps(
        block: CfnApprovedOriginPropsDsl.() -> Unit = {}
     ...
     * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-connect-contactflowmodule.html)
     */
    public inline fun cfnContactFlowModuleProps(
        block: CfnContactFlowModulePropsDsl.() -> Unit = {}
     ...
     * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-connect-contactflow.html)
     */
    public inline fun cfnContactFlowProps(
        block: CfnContactFlowPropsDsl.() -> Unit = {}
    ): CfnContactFlowProps {
     ...
     *
     * The question type properties must be either for a numeric question or a single select
     * question.
     *
     * Example:
     * ```
     ...
     *
     * A section can contain sections and/or questions. Evaluation forms can only contain sections
    ...
    public inline fun cfnEvaluationFormEvaluationFormSingleSelectQuestionAutomationOptionProperty(
        block:
            CfnEvaluationFormEvaluationFormSingleSelectQuestionAutomationOptionPropertyDsl.(
            ) -> Unit =
            {}
     ...
     * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-connect-evaluationform.html)
     */
    public inline fun cfnEvaluationFormProps(
        block: CfnEvaluationFormPropsDsl.() -> Unit = {}
     ...
     * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-connect-hoursofoperation.html)
     */
    public inline fun cfnHoursOfOperationProps(
        block: CfnHoursOfOperationPropsDsl.() -> Unit = {}
     ...
     * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-connect-integrationassociation.html)
     */
    public inline fun cfnIntegrationAssociationProps(
        block: CfnIntegrationAssociationPropsDsl.() -> Unit = {}
     ...
     * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-connect-phonenumber.html)
     */
    public inline fun cfnPhoneNumberProps(
     ...
     * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-connect-quickconnect.html)
     */
    public inline fun cfnQuickConnectProps(
        block: CfnQuickConnectPropsDsl.() -> Unit = {}
     ...
     */
    public inline fun cfnRuleActionsProperty(
     ...
     */
    public inline fun cfnRuleReferenceProperty(
        block: CfnRuleReferencePropertyDsl.() -> Unit = {}
     ...
     */
    public inline fun cfnRuleTaskActionProperty(
        block: CfnRuleTaskActionPropertyDsl.() -> Unit = {}
     ...
     * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-connect-securitykey.html)
     */
    public inline fun cfnSecurityKeyProps(
     ...
     * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-connect-tasktemplate.html)
     */
    public inline fun cfnTaskTemplateProps(
        block: CfnTaskTemplatePropsDsl.() -> Unit = {}
     ...
     * [Add Users](https://docs.aws.amazon.com/connect/latest/adminguide/user-management.html) in
