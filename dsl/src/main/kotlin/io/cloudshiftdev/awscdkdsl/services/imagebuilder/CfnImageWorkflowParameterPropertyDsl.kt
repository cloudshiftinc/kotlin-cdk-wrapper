 ...
 */
@CdkDslMarker
public class CfnImageWorkflowParameterPropertyDsl {
    private val cdkBuilder: CfnImage.WorkflowParameterProperty.Builder =
    ...
    public fun build(): CfnImage.WorkflowParameterProperty {
