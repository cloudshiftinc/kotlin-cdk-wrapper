 ...
 * rendered as plaintext and is therefore readable. For security reasons, do not use plaintext in
 * your AWS CloudFormation template to store your credentials.
 *
 * Example:
 * ```
...
public class CfnWebhookDsl(
     ...
     * `SecretToken` property must be set. For IP, only the `AllowedIPRange` property must be set to
