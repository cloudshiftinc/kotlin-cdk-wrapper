...
public class CfnTemplateAggregationFunctionPropertyDsl {
    ...
    public fun attributeAggregationFunction(
        attributeAggregationFunction: CfnTemplate.AttributeAggregationFunctionProperty
    ) {
        cdkBuilder.attributeAggregationFunction(attributeAggregationFunction)
    }
    ...
    public fun numericalAggregationFunction(
        numericalAggregationFunction: CfnTemplate.NumericalAggregationFunctionProperty
    ) {
        cdkBuilder.numericalAggregationFunction(numericalAggregationFunction)
    }
