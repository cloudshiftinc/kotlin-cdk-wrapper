 ...
 * [HTTP APIs](https://docs.aws.amazon.com/apigateway/latest/developerguide/http-api.html) in the
...
public class CfnApiDsl(
     ...
     * request, specify `arn:aws:iam::*:user/ *` . To use resource-based permissions on supported
     * AWS services, specify `null` . Currently, this property is not used for HTTP integrations.
     * Supported only for HTTP APIs.
     *
     ...
     * `$default` route key can't be modified. You can add routes after creating the API, and you
