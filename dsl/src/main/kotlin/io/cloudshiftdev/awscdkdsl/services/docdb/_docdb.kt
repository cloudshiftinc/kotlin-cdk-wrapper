...
public object docdb {
     ...
     * engine used by instances in the cluster. To provide custom values for any of the parameters,
     * you must modify the group after you create it. After you create a DB cluster parameter group,
     * you must associate it with your cluster. For the new cluster parameter group and associated
     * settings to take effect, you must then reboot the DB instances in the cluster without
     * failover.
     *
     ...
     * group. This allows Amazon DocumentDB to fully complete the create action before the cluster
     ...
     * ```
     */
    public inline fun clusterParameterGroupProps(
        block: ClusterParameterGroupPropsDsl.() -> Unit = {}
