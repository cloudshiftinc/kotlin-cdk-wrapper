...
public class CfnDatabasePropsDsl {
    ...
    /**
     * @param masterUserPassword The password for the primary user of the database. The password can
    ...
    /**
     * @param masterUsername The name for the primary user. *MySQL*
     *
     * Constraints:
     * * Required for MySQL.
     ...
     *   occur for the database, formatted as follows: `ddd:hh24:mi-ddd:hh24:mi` . For example,
     *   `Tue:17:00-Tue:17:30` .
     */
