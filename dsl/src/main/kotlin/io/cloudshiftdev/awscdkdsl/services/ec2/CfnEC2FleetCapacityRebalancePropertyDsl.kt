...
public class CfnEC2FleetCapacityRebalancePropertyDsl {
     ...
     *   `maintain` . `launch` - EC2 Fleet launches a replacement Spot Instance when a rebalance
     ...
     *   terminating the old Spot Instance after launching a new replacement Spot Instance. Required
     *   when `ReplacementStrategy` is set to `launch-before-terminate` .
     *
