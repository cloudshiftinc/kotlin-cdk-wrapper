...
public class CfnKnowledgeBasePropsDsl {
    ...
    /**
     * @param knowledgeBaseType The type of knowledge base. Only CUSTOM knowledge bases allow you to
     *   upload your own content. EXTERNAL knowledge bases support integrations with third-party
     ...
     *   key to invoke Wisdom. For more information about setting up a customer managed key for
     *   Wisdom, see
    ...
    /**
     * @param sourceConfiguration The source of the knowledge base content. Only set this argument
