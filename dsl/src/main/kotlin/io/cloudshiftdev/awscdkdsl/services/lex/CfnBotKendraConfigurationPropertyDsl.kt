 ...
 * intent, Amazon Lex searches the specified Amazon Kendra index and returns documents from the
...
public class CfnBotKendraConfigurationPropertyDsl {
     ...
     *   response from a query. The filter is in the format defined by Amazon Kendra. For more
     *   information, see
