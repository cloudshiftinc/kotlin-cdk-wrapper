...
public class CfnLedgerPropsDsl {
     ...
     *   user. If not defined during ledger creation, this feature is enabled ( `true` ) by default.
     *
     ...
     *   at rest in the ledger. For more information, see
    ...
    /**
     * @param name The name of the ledger that you want to create. The name must be unique among all
     *   of the ledgers in your AWS account in the current Region.
     *
