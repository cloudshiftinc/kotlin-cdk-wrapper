...
public class CfnFHIRDatastoreKmsEncryptionConfigPropertyDsl {
    ...
    /**
     * @param cmkType The type of customer-managed-key(CMK) used for encryption. The two types of
     *   supported CMKs are customer owned CMKs and Amazon owned CMKs. For more information on CMK
     *   types, see
