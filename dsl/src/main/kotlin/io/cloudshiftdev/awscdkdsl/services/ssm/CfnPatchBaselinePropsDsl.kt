...
public class CfnPatchBaselinePropsDsl {
    ...
    /**
     * @param approvedPatches A list of explicitly approved patches for the baseline. For
    ...
    /**
     * @param approvedPatchesComplianceLevel Defines the compliance level for approved patches. When
     *   an approved patch is reported as missing, this value describes the severity of the
    ...
    /**
     * @param operatingSystem Defines the operating system the patch baseline applies to. The
    ...
    /**
     * @param rejectedPatches A list of explicitly rejected patches for the baseline. For
     *   information about accepted formats for lists of approved patches and rejected patches, see
     *   [About package name formats for approved and rejected patch lists](https://docs.aws.amazon.com/systems-manager/latest/userguide/patch-manager-approved-rejected-package-name-formats.html)
     *   in the *AWS Systems Manager User Guide* .
     */
    ...
    /**
     * @param tags Optional metadata that you assign to a resource. Tags enable you to categorize a
