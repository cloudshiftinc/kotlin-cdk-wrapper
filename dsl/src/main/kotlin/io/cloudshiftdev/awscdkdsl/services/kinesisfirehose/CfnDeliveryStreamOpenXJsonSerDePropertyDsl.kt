...
public class CfnDeliveryStreamOpenXJsonSerDePropertyDsl {
     ...
     *   the keys include dots and that you want Kinesis Data Firehose to replace them with
     *   underscores. This is useful because Apache Hive does not allow dots in column names. For
     *   example, if the JSON contains a key whose name is "a.b", you can define the column name to
