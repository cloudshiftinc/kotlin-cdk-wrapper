...
public class ContainerDefinitionOptionsDsl {
    private val cdkBuilder: ContainerDefinitionOptions.Builder =
        ContainerDefinitionOptions.builder()

    /**
     * @param containerHostName This parameter is ignored for models that contain only a
     *   PrimaryContainer. When a ContainerDefinition is part of an inference pipeline, the value of
     ...
     *   suffix). The S3 path is required for Amazon SageMaker built-in algorithms, but not if you
