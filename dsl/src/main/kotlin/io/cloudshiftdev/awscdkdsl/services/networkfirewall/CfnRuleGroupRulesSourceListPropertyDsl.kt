 ...
 * the other CIDR ranges. For more information, see `RuleGroup.RuleVariables` in this guide and
...
public class CfnRuleGroupRulesSourceListPropertyDsl {
    ...
    /**
     * @param targetTypes The types of targets to inspect for. Valid values are `TLS_SNI` and
     *   `HTTP_HOST` .
     */
