 ...
 */
@CdkDslMarker
public class CfnWebACLRateLimitQueryArgumentPropertyDsl {
    private val cdkBuilder: CfnWebACL.RateLimitQueryArgumentProperty.Builder =
    ...
    public fun build(): CfnWebACL.RateLimitQueryArgumentProperty {
