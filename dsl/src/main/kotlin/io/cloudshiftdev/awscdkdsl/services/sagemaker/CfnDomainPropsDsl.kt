...
public class CfnDomainPropsDsl {
    ...
    /**
     * @param authMode The mode of authentication that members use to access the Domain. *Valid
     *   Values* : `SSO | IAM`
     */
    ...
    /**
     * @param domainSettings A collection of settings that apply to the `SageMaker Domain` . These
     ...
     *   an AWS managed customer master key (CMK) by default. For more control, specify a customer
     *   managed CMK.
     *
    ...
    /**
     * @param subnetIds The VPC subnets that Studio uses for communication. *Length Constraints* :
    ...
    /**
     * @param tags Tags to associated with the Domain. Each tag consists of a key and an optional
     ...
     *   communication. *Length Constraints* : Maximum length of 32.
     *
     * *Pattern* : `[-0-9a-zA-Z]+`
     */
