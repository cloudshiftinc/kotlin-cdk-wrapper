 ...
 */
@CdkDslMarker
public class CfnModelS3DataSourcePropertyDsl {
    private val cdkBuilder: CfnModel.S3DataSourceProperty.Builder =
    ...
    public fun modelAccessConfig(modelAccessConfig: IResolvable) {
        cdkBuilder.modelAccessConfig(modelAccessConfig)
    }

    /** @param modelAccessConfig the value to be set. */
    public fun modelAccessConfig(modelAccessConfig: CfnModel.ModelAccessConfigProperty) {
        cdkBuilder.modelAccessConfig(modelAccessConfig)
    }

    /**
     * @param s3DataType If you choose `S3Prefix` , `S3Uri` identifies a key name prefix. SageMaker
     ...
     * source. The object that each `S3Uri` points to must be readable by the IAM role that
    ...
    public fun build(): CfnModel.S3DataSourceProperty = cdkBuilder.build()
}
