 ...
 */
@CdkDslMarker
public class CfnTemplateSubjectNameFlagsV2PropertyDsl {
    private val cdkBuilder: CfnTemplate.SubjectNameFlagsV2Property.Builder =
    ...
    public fun build(): CfnTemplate.SubjectNameFlagsV2Property = cdkBuilder.build()
}
