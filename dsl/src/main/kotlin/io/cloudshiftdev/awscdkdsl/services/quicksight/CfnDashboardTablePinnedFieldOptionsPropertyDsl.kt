 ...
 */
@CdkDslMarker
public class CfnDashboardTablePinnedFieldOptionsPropertyDsl {
    private val cdkBuilder: CfnDashboard.TablePinnedFieldOptionsProperty.Builder =
    ...
    public fun build(): CfnDashboard.TablePinnedFieldOptionsProperty {
