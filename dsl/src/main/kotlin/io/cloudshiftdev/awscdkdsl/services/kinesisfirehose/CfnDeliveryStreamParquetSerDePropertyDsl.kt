...
public class CfnDeliveryStreamParquetSerDePropertyDsl {
    ...
    /**
     * @param compression The compression code to use over data blocks. The possible values are
    ...
    /**
     * @param maxPaddingBytes The maximum amount of padding to apply. This is useful if you intend
     *   to copy the data from Amazon S3 to HDFS before querying. The default is 0.
     */
    ...
    /**
     * @param pageSizeBytes The Parquet page size. Column chunks are divided into pages. A page is
     *   conceptually an indivisible unit (in terms of compression and encoding). The minimum value
    ...
    /**
     * @param writerVersion Indicates the version of row format to output. The possible values are
