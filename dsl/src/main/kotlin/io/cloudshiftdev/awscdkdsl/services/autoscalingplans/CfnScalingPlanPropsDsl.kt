...
public class CfnScalingPlanPropsDsl {
    ...
    /**
     * @param applicationSource A CloudFormation stack or a set of tags. You can create one scaling
     *   plan per application source. The `ApplicationSource` property must be present to ensure
