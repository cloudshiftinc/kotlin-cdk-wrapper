...
public class CfnLaunchProfileStreamConfigurationPropertyDsl {
     ...
     *   be active before it is stopped or terminated. After this point, Nimble Studio automatically
     *   terminates or stops the session. The default length of time is 690 minutes, and the maximum
     *   length of time is 30 days.
     */
     ...
     *   your sessions and how long a session can stay in the `STOPPED` state. The default value
    ...
    public fun sessionStorage(
        sessionStorage: CfnLaunchProfile.StreamConfigurationSessionStorageProperty
    ) {
        cdkBuilder.sessionStorage(sessionStorage)
    }
