...
public class CfnServiceServiceConnectServicePropertyDsl {
    ...
    /**
     * @param clientAliases The list of client aliases for this Service Connect service. You use
     *   these to assign names that can be used by client applications. The maximum number of client
     *   aliases that you can have in this list is 1.
     *
     ...
     *   Amazon ECS creates for this Amazon ECS service. This must be unique within the AWS Cloud
     *   Map namespace. The name can contain up to 64 characters. The name can include lowercase
    ...
    /**
     * @param ingressPortOverride The port number for the Service Connect proxy to listen on. Use
     *   the value of this field to bypass the proxy for traffic on the port number specified in the
