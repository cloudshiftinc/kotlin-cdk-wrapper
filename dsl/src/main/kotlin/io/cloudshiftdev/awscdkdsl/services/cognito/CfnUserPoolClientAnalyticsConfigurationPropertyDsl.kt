...
public class CfnUserPoolClientAnalyticsConfigurationPropertyDsl {
    ...
    /**
     * @param applicationArn The Amazon Resource Name (ARN) of an Amazon Pinpoint project. You can
     *   use the Amazon Pinpoint project for integration with the chosen user pool client. Amazon
     *   Cognito publishes events to the Amazon Pinpoint project that the app ARN declares.
     */
