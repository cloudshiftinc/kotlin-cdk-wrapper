...
public class CfnTemplateKPIConditionalFormattingOptionPropertyDsl {
    ...
    /** @param actualValue The conditional formatting for the actual value of a KPI visual. */
    public fun actualValue(actualValue: CfnTemplate.KPIActualValueConditionalFormattingProperty) {
        cdkBuilder.actualValue(actualValue)
    }
    ...
    public fun comparisonValue(
        comparisonValue: CfnTemplate.KPIComparisonValueConditionalFormattingProperty
    ) {
        cdkBuilder.comparisonValue(comparisonValue)
    }
