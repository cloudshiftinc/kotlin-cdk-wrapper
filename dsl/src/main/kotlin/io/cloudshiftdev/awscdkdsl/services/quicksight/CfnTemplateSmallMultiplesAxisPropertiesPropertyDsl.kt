 ...
 */
@CdkDslMarker
public class CfnTemplateSmallMultiplesAxisPropertiesPropertyDsl {
    private val cdkBuilder: CfnTemplate.SmallMultiplesAxisPropertiesProperty.Builder =
    ...
    public fun build(): CfnTemplate.SmallMultiplesAxisPropertiesProperty = cdkBuilder.build()
}
