...
public class CfnResolverRulePropsDsl {
     ...
     *   specified in `TargetIps` . If a query matches multiple Resolver rules (example.com and
    ...
    /**
     * @param tags Tags help organize and categorize your Resolver rules. Each tag consists of a key
     ...
     *   forwards DNS queries to. Typically, these are the IP addresses of DNS resolvers on your
     *   network.
     */
