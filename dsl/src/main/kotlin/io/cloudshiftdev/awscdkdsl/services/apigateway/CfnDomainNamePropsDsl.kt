...
public class CfnDomainNamePropsDsl {
    ...
    public fun endpointConfiguration(
        endpointConfiguration: CfnDomainName.EndpointConfigurationProperty
    ) {
        cdkBuilder.endpointConfiguration(endpointConfiguration)
    }
     ...
     *   domain name. If specified, API Gateway performs two-way authentication between the client
     *   and the server. Clients must present a trusted certificate to access your API.
     */
     ...
     *   validate ownership of your custom domain. Only required when configuring mutual TLS and
     ...
     *   for validating the regional domain name. AWS Certificate Manager is the only supported
     *   source.
     */
