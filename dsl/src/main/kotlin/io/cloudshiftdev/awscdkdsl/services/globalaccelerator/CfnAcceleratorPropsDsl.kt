...
public class CfnAcceleratorPropsDsl {
    ...
    /**
     * @param name The name of the accelerator. The name must contain only alphanumeric characters
    ...
    /**
     * @param tags Create tags for an accelerator. For more information, see
