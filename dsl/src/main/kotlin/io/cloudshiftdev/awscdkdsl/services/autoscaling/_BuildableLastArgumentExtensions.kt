 ...
 * @param options
 */
public inline fun AutoScalingGroup.addWarmPool(
    block: WarmPoolOptionsDsl.() -> Unit = {}
): WarmPool {
 ...
 *
 * The AutoScalingGroup must have been attached to an Application Load Balancer in order to be able
 * to call this.
 *
 * @param id
 * @param props
 ...
 * @param options
 */
public inline fun IAutoScalingGroup.addWarmPool(
    block: WarmPoolOptionsDsl.() -> Unit = {}
): WarmPool {
    val builder = WarmPoolOptionsDsl()
    builder.apply(block)
 ...
 * @param renderOptions
 */
public inline fun Signals.renderCreationPolicy(
