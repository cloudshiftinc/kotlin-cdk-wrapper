 ...
 * to be clients and communicate with other services in the service network. For more information,
 * see
...
public class CfnServiceNetworkVpcAssociationDsl(
     ...
     * controls to control which resources in a VPC are allowed to access the service network and
     * its services. For more information, see
