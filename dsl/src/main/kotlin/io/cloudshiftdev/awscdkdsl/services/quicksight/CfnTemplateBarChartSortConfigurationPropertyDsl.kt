 ...
 */
@CdkDslMarker
public class CfnTemplateBarChartSortConfigurationPropertyDsl {
    private val cdkBuilder: CfnTemplate.BarChartSortConfigurationProperty.Builder =
    ...
    public fun build(): CfnTemplate.BarChartSortConfigurationProperty {
