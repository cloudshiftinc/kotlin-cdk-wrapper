...
public class CfnModelPackageTransformOutputPropertyDsl {
    ...
    /**
     * @param accept The MIME type used to specify the output data. Amazon SageMaker uses the MIME
     ...
     *   object. Choose a format that is most convenient to you. To concatenate the results in
     *   binary format, specify `None` . To add a newline character at the end of every transformed
     *   record, specify `Line` .
     */
     ...
     * for your role's account. For more information, see
     ...
     *   of the transform job. For example, `s3://bucket-name/key-name-prefix` .
     *
