...
public class CfnFargateProfileDsl(
     ...
     * and it provides read access to Amazon ECR image repositories. For more information, see
     ...
     *   for pods that match the selectors in the Fargate profile.
     */
     ...
     * a namespace. You may specify up to five selectors in a Fargate profile.
     *
     ...
     *
     * Each tag consists of a key and an optional value. You define both. Fargate profile tags do
     * not propagate to any other resources associated with the Fargate profile, such as the pods
