...
public class CfnOriginRequestPolicyQueryStringsConfigPropertyDsl {
     ...
     *   to the origin. Even when this field is set to `none` , any query strings that are listed in
     ...
     *   sends to the origin, **except** for those listed in the `QueryStringNames` type, which are
     *   not included.
     */
