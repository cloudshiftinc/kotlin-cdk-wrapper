...
public class CfnModelPackagePropsDsl {
     ...
     *   objects to be added to the existing array. The total number of additional Inference
     *   Specification objects cannot exceed 15. Each additional Inference Specification object
     ...
     *   Marketplace. For information about listing model packages on AWS Marketplace, see
    ...
    /**
     * @param domain The machine learning domain of your model package and its components. Common
    ...
    /**
     * @param tags A list of the tags associated with the model package. For more information, see
    ...
    /**
     * @param task The machine learning task your model package accomplishes. Common machine
