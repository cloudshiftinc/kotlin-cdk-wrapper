 ...
 *
 * import { SqsEventSource } from 'aws-cdk-lib/aws-lambda-event-sources'; lambda.addEventSource(new
 * SqsEventSource(sqs));
 *
...
public class EventSourceMappingDsl(
    ...
    private val cdkBuilder: EventSourceMapping.Builder =
        EventSourceMapping.Builder.create(scope, id)
    ...
    private val _sourceAccessConfigurations: MutableList<SourceAccessConfiguration> =
        mutableListOf()
    ...
    public fun sourceAccessConfigurations(
        sourceAccessConfigurations: SourceAccessConfigurationDsl.() -> Unit
    ) {
        _sourceAccessConfigurations.add(
            SourceAccessConfigurationDsl().apply(sourceAccessConfigurations).build()
        )
    }
     ...
     */
    public fun sourceAccessConfigurations(
        sourceAccessConfigurations: Collection<SourceAccessConfiguration>
    ) {
