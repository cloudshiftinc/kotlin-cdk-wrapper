...
public class CfnGroupConfigurationItemPropertyDsl {
    ...
    /**
     * @param parameters A collection of parameters for this configuration item. For the list of
    ...
    /**
     * @param type Specifies the type of configuration item. Each item must have a unique value for
     *   type. For the list of the types that you can specify for a configuration item, see
     *   [Supported resource types and parameters](https://docs.aws.amazon.com/ARG/latest/APIReference/about-slg.html#about-slg-types)
     *   in the *AWS Resource Groups User Guide* .
     */
