 ...
 * that is important to your application workload, such as vCPUs, memory, or I/O. If the request
 * type is `maintain` , you can specify a target capacity of `0` and add capacity later.
 *
