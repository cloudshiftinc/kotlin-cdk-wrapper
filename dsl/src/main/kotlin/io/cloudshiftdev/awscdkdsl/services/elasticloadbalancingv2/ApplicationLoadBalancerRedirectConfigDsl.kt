...
public class ApplicationLoadBalancerRedirectConfigDsl {
    ...
    /**
     * @param open Allow anyone to connect to this listener. If this is specified, the listener will
     *   be opened up to anyone who can reach it. For internal load balancers this is anyone in the
     *   same VPC. For public load balancers, this is anyone on the internet.
     *
