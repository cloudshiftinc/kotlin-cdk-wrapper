...
public class CfnChannelPropsDsl {
    ...
    /**
     * @param preset An optional transcode preset for the channel. This is selectable only for
     *   `ADVANCED_HD` and `ADVANCED_SD` channel types. For those channel types, the default preset
    ...
    /**
     * @param recordingConfigurationArn The ARN of a RecordingConfiguration resource. An empty
     *   string indicates that recording is disabled for the channel. A RecordingConfiguration ARN
     *   indicates that recording is enabled using the specified recording configuration. See the
    ...
    /**
     * @param type The channel type, which determines the allowable resolution and bitrate. *If you
