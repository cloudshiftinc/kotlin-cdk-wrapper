...
public class CfnAliasPropsDsl {
     ...
     *   . The KMS key must be in the same AWS account and Region. A valid key ID is required. If
     *   you supply a null or empty string value, this operation returns an error.
     *
