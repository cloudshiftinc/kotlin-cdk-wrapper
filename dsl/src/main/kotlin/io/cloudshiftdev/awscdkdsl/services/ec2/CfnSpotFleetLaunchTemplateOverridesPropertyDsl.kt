...
public class CfnSpotFleetLaunchTemplateOverridesPropertyDsl {
     ...
     *   requirements, Amazon EC2 will identify instance types with the provided requirements, and
     *   then use your On-Demand and Spot allocation strategies to launch instances from these
     *   instance types, in the same way as when you specify a list of instance types.
     *
     ...
     *   launched first. If `OnDemandAllocationStrategy` is set to `prioritized` , Spot Fleet uses
