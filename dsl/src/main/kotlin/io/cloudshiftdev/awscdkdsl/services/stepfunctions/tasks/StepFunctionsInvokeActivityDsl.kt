...
public class StepFunctionsInvokeActivityDsl(
    ...
    private val cdkBuilder: StepFunctionsInvokeActivity.Builder =
        StepFunctionsInvokeActivity.Builder.create(scope, id)
    ...
    public fun build(): StepFunctionsInvokeActivity = cdkBuilder.build()
}
