...
public class CfnServiceServiceConnectClientAliasPropertyDsl {
     ...
     *   letters, numbers, underscores (_), hyphens (-), and periods (.). The name can't start with
     *   a hyphen.
     *
     * If this parameter isn't specified, the default value of `discoveryName.namespace` is used. If
     * the `discoveryName` isn't specified, the port mapping name from the task definition is used
     ...
     * `db` , or the lowercase name of a database, such as `mysql` or `redis` . For more
     * information, see
     * [Service Connect](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/service-connect.html)
     * in the *Amazon Elastic Container Service Developer Guide* .
     */
    ...
    /**
     * @param port The listening port number for the Service Connect proxy. This port is available
     ...
     * that the client application uses by default. For more information, see
     * [Service Connect](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/service-connect.html)
     * in the *Amazon Elastic Container Service Developer Guide* .
     */
