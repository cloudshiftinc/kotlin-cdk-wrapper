...
public class InstancePropsDsl {
     ...
     *   default. This property is only used when you do not provide a security group.
     */
    ...
    /**
     * @param privateIpAddress Defines a private IP address to associate with an instance. Private
     *   IP should be available within the VPC that the instance is build within.
     */
    ...
    /**
     * @param resourceSignalTimeout The length of time to wait for the resourceSignalCount. The
     ...
     *   NAT. This controls whether source/destination checking is enabled on the instance. A value
     *   of true means that checking is enabled, and false means that checking is disabled. The
     *   value must be false for the instance to perform NAT.
     */
    ...
    /**
     * @param userDataCausesReplacement Changes to the UserData force replacement. Depending the EC2
     *   instance type, changing UserData either restarts the instance or replaces the instance.
