...
public class CfnOriginAccessControlOriginAccessControlConfigPropertyDsl {
     ...
     *   information to). Specify `always` for the most common use case. For more information, see
     ...
     *   header from the viewer request, you *must* add the `Authorization` header to a
    ...
    public fun build(): CfnOriginAccessControl.OriginAccessControlConfigProperty =
        cdkBuilder.build()
}
