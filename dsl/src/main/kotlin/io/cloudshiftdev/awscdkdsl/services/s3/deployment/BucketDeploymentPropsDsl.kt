...
public class BucketDeploymentPropsDsl {
    ...
    /**
     * @param destinationKeyPrefix Key prefix in the destination bucket. Must be &lt;=104 characters
     */
     ...
     *   deployment's sync command. This can be used to exclude a file from being pruned in the
     *   destination bucket.
     *
     ...
     *   extracted. If false, the file will remain zipped in the destination bucket.
     */
     ...
     *   deployment's sync command. Since all files from the deployment package are included by
     *   default, this property is usually leveraged alongside an `exclude` filter.
     */
     ...
     *   replicates the files from the CDK bucket to the destination bucket. If you are deploying
     *   large files, you will need to increase this number accordingly.
     */
     ...
     *   the resource is deleted or the destination is updated. NOTICE: Configuring this to "false"
     *   might have operational implications. Please visit to the package documentation referred
     *   below to make sure you fully understand those implications.
     */
     ...
     *   deployment. Warning: This is not a useful parameter until this bug is fixed:
    ...
    /**
     * @param useEfs Mount an EFS file system. Enable this if your assets are large and you
     *   encounter disk space errors. Enabling this option will require a VPC to be specified.
     */
    ...
    /**
     * @param vpc The VPC network to place the deployment lambda handler in. This is required if
     *   `useEfs` is set.
     */
    ...
    /**
     * @param vpcSubnets Where in the VPC to place the deployment lambda handler. Only used if 'vpc'
     *   is supplied.
     */
