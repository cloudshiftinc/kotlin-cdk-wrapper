...
public object codestarnotifications {
     ...
     * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-codestarnotifications-notificationrule.html)
     */
    public inline fun cfnNotificationRuleProps(
        block: CfnNotificationRulePropsDsl.() -> Unit = {}
    ...
    /**
     * Information about the AWS Chatbot topics or AWS Chatbot clients associated with a
     * notification rule.
     *
     * Example:
     * ```
     ...
     * ```
     */
    public inline fun notificationRuleOptions(
     ...
     * ```
     */
    public inline fun notificationRuleProps(
        block: NotificationRulePropsDsl.() -> Unit = {}
