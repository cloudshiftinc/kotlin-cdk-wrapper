 ...
 */
@CdkDslMarker
public class CfnAnalysisIntegerDefaultValuesPropertyDsl {
    private val cdkBuilder: CfnAnalysis.IntegerDefaultValuesProperty.Builder =
    ...
    public fun build(): CfnAnalysis.IntegerDefaultValuesProperty {
