...
public class CfnScalingPolicyStepScalingPolicyConfigurationPropertyDsl {
    ...
    /**
     * @param metricAggregationType The aggregation type for the CloudWatch metrics. Valid values
     *   are `Minimum` , `Maximum` , and `Average` . If the aggregation type is null, the value is
     *   treated as `Average` .
     */
     ...
     *   scale out an Amazon ECS service by 25 percent and you specify a `MinAdjustmentMagnitude`
     *   of 2. If the service has 4 tasks and the scaling policy is performed, 25 percent of 4 is 1.
     *   However, because you specified a `MinAdjustmentMagnitude` of 2, Application Auto Scaling
     ...
     *   alarm breach. At least one step adjustment is required if you are adding a new step scaling
