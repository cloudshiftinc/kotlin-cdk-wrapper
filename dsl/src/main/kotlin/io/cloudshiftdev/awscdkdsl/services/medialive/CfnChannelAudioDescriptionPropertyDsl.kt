...
public class CfnChannelAudioDescriptionPropertyDsl {
    ...
    /** @param audioNormalizationSettings The advanced audio normalization settings. */
    public fun audioNormalizationSettings(
        audioNormalizationSettings: CfnChannel.AudioNormalizationSettingsProperty
    ) {
        cdkBuilder.audioNormalizationSettings(audioNormalizationSettings)
    }
    ...
    /**
     * @param audioType Applies only if audioTypeControl is useConfigured. The values for audioType
    ...
    /**
     * @param audioTypeControl Determines how audio type is determined. followInput: If the input
     *   contains an ISO 639 audioType, then that value is passed through to the output. If the
     *   input contains no ISO 639 audioType, the value in Audio Type is included in the output.
     ...
     *   audio watermarks in the audio encode.
     */
    public fun audioWatermarkingSettings(
        audioWatermarkingSettings: CfnChannel.AudioWatermarkSettingsProperty
    ) {
        cdkBuilder.audioWatermarkingSettings(audioWatermarkingSettings)
    }
    ...
    /**
     * @param languageCode Indicates the language of the audio output track. Used only if
     *   languageControlMode is useConfigured, or there is no ISO 639 language code specified in the
     *   input.
     */
     ...
     *   output to follow the ISO 639 language code of the input. The languageCode setting is used
     *   when useConfigured is set, or when followInput is selected but there is no ISO 639 language
    ...
    /**
     * @param name The name of this AudioDescription. Outputs use this name to uniquely identify
     *   this AudioDescription. Description names should be unique within this channel.
     */
    ...
    /**
     * @param streamName Used for Microsoft Smooth and Apple HLS outputs. Indicates the name
     *   displayed by the player (for example, English or Director Commentary).
     */
