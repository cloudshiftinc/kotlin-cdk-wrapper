...
public class CfnEC2FleetSpotOptionsRequestPropertyDsl {
     ...
     *   the Spot Instance pools specified by the EC2 Fleet. If the allocation strategy is
     *   `lowestPrice` , EC2 Fleet launches instances from the Spot Instance pools with the lowest
     *   price. This is the default allocation strategy.
     *
     ...
     *   Spot capacity. Supported only when Spot `AllocationStrategy` is set to `lowest-price` . EC2
    ...
    public fun maintenanceStrategies(
        maintenanceStrategies: CfnEC2Fleet.MaintenanceStrategiesProperty
    ) {
        cdkBuilder.maintenanceStrategies(maintenanceStrategies)
    }
     ...
     *   pay. We do not recommend using this parameter because it can lead to increased
     ...
     * specified for `MaxTotalPrice` . For more information, see
    ...
    /**
     * @param minTargetCapacity The minimum target capacity for Spot Instances in the fleet. If the
     ...
     *   single Availability Zone. Supported only for fleets of type `instant` .
     */
     ...
     *   Spot Instances in the fleet. Supported only for fleets of type `instant` .
     */
