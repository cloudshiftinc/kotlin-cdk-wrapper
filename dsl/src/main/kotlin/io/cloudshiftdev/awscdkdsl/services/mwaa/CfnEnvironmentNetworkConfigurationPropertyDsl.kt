...
public class CfnEnvironmentNetworkConfigurationPropertyDsl {
    ...
    /**
     * @param securityGroupIds A list of one or more security group IDs. Accepts up to 5 security
     *   group IDs. A security group must be attached to the same VPC as the subnets. To learn more,
     *   see
    ...
    /**
     * @param subnetIds A list of subnet IDs. *Required* to create an environment. Must be private
     *   subnets in two different availability zones. A subnet must be attached to the same VPC as
     *   the security group. To learn more, see
     *   [About networking on Amazon MWAA](https://docs.aws.amazon.com/mwaa/latest/userguide/networking-about.html)
     *   .
     */
