 ...
 */
@CdkDslMarker
public class CfnAnalysisLineChartVisualPropertyDsl {
    private val cdkBuilder: CfnAnalysis.LineChartVisualProperty.Builder =
    ...
    /** @param chartConfiguration The configuration of a line chart. */
    public fun chartConfiguration(chartConfiguration: CfnAnalysis.LineChartConfigurationProperty) {
        cdkBuilder.chartConfiguration(chartConfiguration)
    }
    ...
    public fun build(): CfnAnalysis.LineChartVisualProperty {
