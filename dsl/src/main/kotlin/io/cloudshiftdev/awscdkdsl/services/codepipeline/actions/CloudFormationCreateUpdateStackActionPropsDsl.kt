...
public class CloudFormationCreateUpdateStackActionPropsDsl {
    ...
    /**
     * @param replaceOnFailure Replace the stack if it's in a failed state. If this is set to true
     *   and the stack is in a failed state (one of ROLLBACK_COMPLETE, ROLLBACK_FAILED,
     *   CREATE_FAILED, DELETE_FAILED, or UPDATE_ROLLBACK_FAILED), AWS CloudFormation deletes the
     *   stack and then creates a new stack.
     *
