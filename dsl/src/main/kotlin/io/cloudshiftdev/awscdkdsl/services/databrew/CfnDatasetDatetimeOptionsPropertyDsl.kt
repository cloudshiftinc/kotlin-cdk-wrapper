...
public class CfnDatasetDatetimeOptionsPropertyDsl {
     ...
     *   characters, all litera a-z or A-Z character should be escaped with single quotes. E.g.
     *   "MM.dd.yyyy-'at'-HH:mm".
     */
    ...
    /**
     * @param localeCode Optional value for a non-US locale code, needed for correct interpretation
     ...
     *   the Amazon S3 path. Shouldn't be used if Format for this parameter includes timezone
