...
public class CfnAccessPointPropsDsl {
    ...
    private val _accessPointTags: MutableList<CfnAccessPoint.AccessPointTagProperty> =
        mutableListOf()

    /**
     * @param accessPointTags An array of key-value pairs to apply to this resource. For more
     *   information, see
     *   [Tag](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-resource-tags.html)
     *   .
     */
    public fun accessPointTags(
        accessPointTags: CfnAccessPointAccessPointTagPropertyDsl.() -> Unit
    ) {
        _accessPointTags.add(
            CfnAccessPointAccessPointTagPropertyDsl().apply(accessPointTags).build()
        )
    }
    ...
    /**
     * @param fileSystemId The ID of the EFS file system that the access point applies to. Accepts
     *   only the ID format for input when specifying a file system, for example
