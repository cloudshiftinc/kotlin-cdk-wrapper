 ...
 */
@CdkDslMarker
public class CfnTemplateEnrollmentFlagsV4PropertyDsl {
    private val cdkBuilder: CfnTemplate.EnrollmentFlagsV4Property.Builder =
    ...
    public fun build(): CfnTemplate.EnrollmentFlagsV4Property = cdkBuilder.build()
}
