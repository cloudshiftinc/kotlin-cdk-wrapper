...
public class CfnBotPropsDsl {
    ...
    /**
     * @param botFileS3Location The Amazon S3 location of files used to import a bot. The files must
     *   be in the import format specified in
    ...
    /**
     * @param botTags A list of tags to add to the bot. You can only add tags when you import a bot.
    ...
    /**
     * @param dataPrivacy By default, data stored by Amazon Lex is encrypted. The `DataPrivacy`
     *   structure provides settings that determine how Amazon Lex handles special cases of securing
     ...
     *   about a user's conversation with the bot. A user interaction remains active for the amount
     ...
     *   bot. If the `TestBotAliasSettings` property is not specified, the settings are configured
     *   with default values.
     */
    ...
    /**
     * @param testBotAliasTags A list of tags to add to the test alias for a bot. You can only add
     *   tags when you import a bot. You can't use the `UpdateAlias` operation to update tags. To
