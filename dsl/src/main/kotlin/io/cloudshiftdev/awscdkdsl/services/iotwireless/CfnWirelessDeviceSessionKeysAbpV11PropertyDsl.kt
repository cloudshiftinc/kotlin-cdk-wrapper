...
public class CfnWirelessDeviceSessionKeysAbpV11PropertyDsl {
     ...
     *   would an application password. You can protect the AppSKey value by storing it in the AWS
    ...
    /**
     * @param fNwkSIntKey The FNwkSIntKey is a secret key, which you should handle in a similar way
     *   as you would an application password. You can protect the FNwkSIntKey value by storing it
     ...
     *   you would an application password. You can protect the NwkSEncKey value by storing it in
     *   the AWS Secrets Manager and use the
     *   [secretsmanager](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/dynamic-references.html#dynamic-references-secretsmanager)
     *   to reference this value.
     */
    ...
    /**
     * @param sNwkSIntKey The SNwkSIntKey is a secret key, which you should handle in a similar way
     *   as you would an application password. You can protect the SNwkSIntKey value by storing it
     *   in the AWS Secrets Manager and use the
     *   [secretsmanager](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/dynamic-references.html#dynamic-references-secretsmanager)
     *   to reference this value.
     */
