...
public class CfnIPAMPoolCidrPropsDsl {
    ...
    /**
     * @param cidr The CIDR provisioned to the IPAM pool. A CIDR is a representation of an IP
     *   address and its associated network mask (or netmask) and refers to a range of IP addresses.
     ...
     *   used for provisioning Amazon-provided IPv6 CIDRs to top-level pools and for provisioning
