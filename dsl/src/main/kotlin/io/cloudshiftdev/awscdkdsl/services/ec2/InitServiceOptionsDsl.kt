...
public class InitServiceOptionsDsl {
    ...
    /**
     * @param enabled Enable or disable this service. Set to true to ensure that the service will be
     ...
     *   finishes. Set to true to ensure that the service is running after cfn-init finishes.
     *
    ...
    /**
     * @param serviceManager What service manager to use. This needs to match the actual service
     *   manager on your Operating System. For example, Amazon Linux 1 uses SysVinit, but Amazon
     *   Linux 2 uses Systemd.
     */
     ...
     *   restartHandle have been performed. Register actions into the restartHandle by passing it to
     *   `InitFile`, `InitCommand`, `InitPackage` and `InitSource` objects.
     */
