...
public class CfnCampaignS3ConfigPropertyDsl {
    ...
    /**
     * @param prefix (Optional) Enter an S3 bucket prefix. The prefix is the string of characters
     *   after the bucket name and before the object name. You can use the prefix to organize data
     ...
     *   file. Compressed files have a reduced file size, which can optimize the cost of data
     *   storage.
     */
