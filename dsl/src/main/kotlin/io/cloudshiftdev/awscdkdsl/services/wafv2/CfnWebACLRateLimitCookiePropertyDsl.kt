 ...
 */
@CdkDslMarker
public class CfnWebACLRateLimitCookiePropertyDsl {
    private val cdkBuilder: CfnWebACL.RateLimitCookieProperty.Builder =
    ...
    public fun build(): CfnWebACL.RateLimitCookieProperty {
