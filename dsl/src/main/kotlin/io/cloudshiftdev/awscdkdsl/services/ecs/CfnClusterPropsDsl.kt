...
public class CfnClusterPropsDsl {
     ...
     * API operation is used to update the list of available capacity providers for a cluster after
    ...
    /**
     * @param clusterName A user-generated string that you use to identify your cluster. If you
     *   don't specify a name, AWS CloudFormation generates a unique physical ID for the name.
     */
    ...
    /**
     * @param clusterSettings The settings to use when creating a cluster. This parameter is used to
     ...
     *   cluster. When services or tasks are run in the cluster with no launch type or capacity
     ...
     *   This setting only applies to new services that set the `enabled` parameter to `true` in the
    ...
    public fun serviceConnectDefaults(
        serviceConnectDefaults: CfnCluster.ServiceConnectDefaultsProperty
    ) {
        cdkBuilder.serviceConnectDefaults(serviceConnectDefaults)
    }
