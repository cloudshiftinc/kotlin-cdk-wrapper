...
public class CfnCampaignPropsDsl {
    ...
    /**
     * @param isPaused Specifies whether to pause the campaign. A paused campaign doesn't run unless
     *   you resume it by changing this value to `false` . If you restart a campaign, the campaign
     *   restarts from the beginning and not at the point you paused it. If a campaign is running it
     *   will complete and then pause. Pause only pauses or skips the next run for a recurring
     *   future scheduled campaign. A campaign scheduled for immediate can't be paused.
     */
     ...
     *   in-app message campaign, where 1 is the highest priority and 5 is the lowest. If there are
     *   multiple messages scheduled to be displayed at the same time, the priority determines the
     *   order in which those messages are displayed.
     */
