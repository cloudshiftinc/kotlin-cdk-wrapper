...
public class StringListParameterDsl(
    ...
    private val cdkBuilder: StringListParameter.Builder =
        StringListParameter.Builder.create(scope, id)
     ...
     *
     * This is required only if `parameterName` is a token, which means we are unable to detect if
     * the name is simple or "path-like" for the purpose of rendering SSM parameter ARNs.
     *
