...
public class CfnApiCorsPropertyDsl {
    ...
    /**
     * @param allowHeaders Represents a collection of allowed headers. Supported only for HTTP APIs.
     */
    ...
    /**
     * @param allowMethods Represents a collection of allowed HTTP methods. Supported only for HTTP
     *   APIs.
     */
    ...
    /**
     * @param allowOrigins Represents a collection of allowed origins. Supported only for HTTP APIs.
     */
    ...
    /**
     * @param exposeHeaders Represents a collection of exposed headers. Supported only for HTTP
     *   APIs.
     */
