...
public class CfnDashboardDashboardVersionDefinitionPropertyDsl {
    ...
    /**
     * @param columnConfigurations An array of dashboard-level column configurations. Column
     *   configurations are used to set the default formatting for a column that is used throughout
     *   a dashboard.
     */
    ...
    /**
     * @param dataSetIdentifierDeclarations An array of dataset identifier declarations. With this
     *   mapping,you can use dataset identifiers instead of dataset Amazon Resource Names (ARNs)
    ...
    /**
     * @param filterGroups The filter definitions for a dashboard. For more information, see
