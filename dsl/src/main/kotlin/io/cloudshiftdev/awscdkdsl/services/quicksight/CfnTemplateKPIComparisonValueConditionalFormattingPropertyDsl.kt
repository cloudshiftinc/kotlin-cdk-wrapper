 ...
 */
@CdkDslMarker
public class CfnTemplateKPIComparisonValueConditionalFormattingPropertyDsl {
    private val cdkBuilder: CfnTemplate.KPIComparisonValueConditionalFormattingProperty.Builder =
    ...
    public fun build(): CfnTemplate.KPIComparisonValueConditionalFormattingProperty =
        cdkBuilder.build()
}
