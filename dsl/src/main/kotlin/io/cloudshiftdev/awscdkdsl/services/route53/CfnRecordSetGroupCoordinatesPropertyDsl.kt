 ...
 */
@CdkDslMarker
public class CfnRecordSetGroupCoordinatesPropertyDsl {
    private val cdkBuilder: CfnRecordSetGroup.CoordinatesProperty.Builder =
    ...
    public fun build(): CfnRecordSetGroup.CoordinatesProperty = cdkBuilder.build()
}
