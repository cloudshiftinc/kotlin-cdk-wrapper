 ...
 */
@CdkDslMarker
public class DockerImageAssetOptionsDsl {
    private val cdkBuilder: DockerImageAssetOptions.Builder = DockerImageAssetOptions.builder()
    ...
    public fun build(): DockerImageAssetOptions {
