 ...
 */
@CdkDslMarker
public class CfnTemplatePrivateKeyAttributesV4PropertyDsl {
    private val cdkBuilder: CfnTemplate.PrivateKeyAttributesV4Property.Builder =
    ...
    public fun build(): CfnTemplate.PrivateKeyAttributesV4Property {
