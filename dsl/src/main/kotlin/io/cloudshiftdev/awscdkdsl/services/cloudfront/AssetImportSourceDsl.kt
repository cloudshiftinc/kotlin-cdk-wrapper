 ...
 */
@CdkDslMarker
public class AssetImportSourceDsl(
    path: String,
) {
    private val cdkBuilder: AssetImportSource.Builder = AssetImportSource.Builder.create(path)
    ...
    public fun build(): AssetImportSource {
