...
public class CfnSolutionPropsDsl {
     ...
     *   the model. If no `eventType` is provided, Amazon Personalize uses all interactions for
     ...
     *   your use case to the available Amazon Personalize recipes. For more information, see
    ...
    /**
     * @param recipeArn The ARN of the recipe used to create the solution. This is required when
