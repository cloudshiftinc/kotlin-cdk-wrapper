 ...
 */
@CdkDslMarker
public class CfnTemplateKPIConditionalFormattingPropertyDsl {
    private val cdkBuilder: CfnTemplate.KPIConditionalFormattingProperty.Builder =
    ...
    public fun build(): CfnTemplate.KPIConditionalFormattingProperty {
