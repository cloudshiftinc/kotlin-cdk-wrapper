 ...
 * Directory ( Simple AD ) in AWS so that your directory users and groups can access the AWS
 * Management Console and AWS applications using their existing credentials.
 *
