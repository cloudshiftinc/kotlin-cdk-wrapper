...
public class OpenIdConnectConfigDsl {
    ...
    /**
     * @param clientId The client identifier of the Relying party at the OpenID identity provider. A
     *   regular expression can be specified so AppSync can validate against multiple client
    ...
    /**
     * @param oidcProvider The issuer for the OIDC configuration. The issuer returned by discovery
     *   must exactly match the value of `iss` in the OIDC token.
     */
