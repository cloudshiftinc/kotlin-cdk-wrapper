...
public class CfnRemediationConfigurationPropsDsl {
     ...
     *   If you do not select a number, the default is 5. For example, if you specify
     *   MaximumAutomaticAttempts as 5 with RetryAttemptSeconds as 50 seconds, AWS Config will put a
     *   RemediationException on your behalf for the failing resource after the 5th failed attempt
     *   within 50 seconds.
     */
     ...
     *   exception to prevent infinite remediation attempts. If `MaximumAutomaticAttempts`
     *   remediation attempts have been made under `RetryAttemptSeconds` , a remediation exception
    ...
    /**
     * @param targetType The type of the target. Target executes remediation. For example, SSM
     *   document.
     */
