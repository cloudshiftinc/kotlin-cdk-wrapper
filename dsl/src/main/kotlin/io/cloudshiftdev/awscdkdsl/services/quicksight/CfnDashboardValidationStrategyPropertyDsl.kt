 ...
 */
@CdkDslMarker
public class CfnDashboardValidationStrategyPropertyDsl {
    private val cdkBuilder: CfnDashboard.ValidationStrategyProperty.Builder =
    ...
    public fun build(): CfnDashboard.ValidationStrategyProperty = cdkBuilder.build()
}
