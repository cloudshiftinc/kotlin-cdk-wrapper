...
public class CfnFlowSalesforceDestinationPropertiesPropertyDsl {
     ...
     * transfer 900 records, and it might use Bulk API 2.0 on the next day to transfer 1,100
     ...
     *   when placing data in the Salesforce destination. For example, this setting would determine
