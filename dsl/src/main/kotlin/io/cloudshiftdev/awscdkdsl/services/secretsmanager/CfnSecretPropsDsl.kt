...
public class CfnSecretPropsDsl {
     ...
     *   and store in the secret. To include a specific string in the secret, use `SecretString`
     *   instead. If you omit both `GenerateSecretString` and `SecretString` , you create an empty
     *   secret. When you make a change to this property, a new secret version is created.
     *
     ...
     *   encrypt the secret value in the secret. An alias is always prefixed by `alias/` , for
     *   example `alias/aws/secretsmanager` . For more information, see
    ...
    /**
     * @param name The name of the new secret. The secret name can contain ASCII letters, numbers,
    ...
    /**
     * @param secretString The text to encrypt and store in the secret. We recommend you use a JSON
     *   structure of key/value pairs for your secret value. To generate a random password, use
     *   `GenerateSecretString` instead. If you omit both `GenerateSecretString` and `SecretString`
     *   , you create an empty secret. When you make a change to this property, a new secret version
     *   is created.
     */
    ...
    /**
     * @param tags A list of tags to attach to the secret. Each tag is a key and value pair of
