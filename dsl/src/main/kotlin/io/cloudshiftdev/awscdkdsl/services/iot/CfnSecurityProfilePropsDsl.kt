...
public class CfnSecurityProfilePropsDsl {
    ...
    /**
     * @param additionalMetricsToRetainV2 A list of metrics whose data is retained (stored). By
     *   default, data is retained for any metric used in the profile's `behaviors` , but it's also
