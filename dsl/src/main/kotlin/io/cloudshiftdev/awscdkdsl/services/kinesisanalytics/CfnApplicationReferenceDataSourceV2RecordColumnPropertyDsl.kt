...
/**
 * For a SQL-based Managed Service for Apache Flink application, describes the mapping of each data
...
public class CfnApplicationReferenceDataSourceV2RecordColumnPropertyDsl {
    ...
    public fun build(): CfnApplicationReferenceDataSourceV2.RecordColumnProperty =
        cdkBuilder.build()
}
