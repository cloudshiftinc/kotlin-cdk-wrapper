...
public class ParamsAndSecretsOptionsDsl {
    ...
    /**
     * @param cacheSize The maximum number of secrets and parameters to cache. Must be a value from
    ...
    /**
     * @param logLevel The level of logging provided by the Parameters and Secrets Extension. Note:
     *   Set to debug to see the cache configuration.
     */
    ...
    /**
     * @param maxConnections The maximum number of connection for HTTP clients that the Parameters
     *   and Secrets Extension uses to make requests to Parameter Store or Secrets Manager. There is
     *   no maximum limit. Minimum is 1.
     *
    ...
    /**
     * @param parameterStoreTimeout The timeout for requests to Parameter Store. A value of 0 means
    ...
    /**
     * @param secretsManagerTimeout The timeout for requests to Secrets Manager. A value of 0 means
     *   that there is no timeout.
     */
    ...
    /**
     * @param secretsManagerTtl The time-to-live of a secret in the cache. A value of 0 means there
     *   is no caching. The maximum time-to-live is 300 seconds.
     *
     * Note: This variable is ignored if cacheSize is 0.
     */
