...
public class CfnBotImageResponseCardPropertyDsl {
    ...
    /**
     * @param imageUrl The URL of an image to display on the response card. The image URL must be
     *   publicly available so that the platform displaying the response card has access to the
     *   image.
     */
    ...
    /**
     * @param subtitle The subtitle to display on the response card. The format of the subtitle is
    ...
    /**
     * @param title The title to display on the response card. The format of the title is determined
