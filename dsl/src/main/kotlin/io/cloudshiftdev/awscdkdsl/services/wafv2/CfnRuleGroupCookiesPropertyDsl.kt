 ...
 */
@CdkDslMarker
public class CfnRuleGroupCookiesPropertyDsl {
    private val cdkBuilder: CfnRuleGroup.CookiesProperty.Builder =
     ...
     * Example JSON: `"MatchPattern": { "IncludedCookies": [ "session-id-time", "session-id" ] }`
     */
    public fun matchPattern(matchPattern: CfnRuleGroup.CookieMatchPatternProperty) {
        cdkBuilder.matchPattern(matchPattern)
    }
    ...
    public fun build(): CfnRuleGroup.CookiesProperty = cdkBuilder.build()
}
