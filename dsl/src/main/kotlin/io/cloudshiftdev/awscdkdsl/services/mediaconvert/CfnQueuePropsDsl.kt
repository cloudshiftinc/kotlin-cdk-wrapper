...
public class CfnQueuePropsDsl {
    ...
    /**
     * @param status Initial state of the queue. Queues can be either ACTIVE or PAUSED. If you
     *   create a paused queue, then jobs that you send to that queue won't begin.
     */
