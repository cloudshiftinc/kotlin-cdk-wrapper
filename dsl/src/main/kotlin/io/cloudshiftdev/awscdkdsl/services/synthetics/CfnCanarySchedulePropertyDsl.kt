...
public class CfnCanarySchedulePropertyDsl {
    private val cdkBuilder: CfnCanary.ScheduleProperty.Builder =
     ...
     *   according to the schedule in the `Expression` value. If you specify 0, the canary continues
     ...
     *   canary is to run. For a rate expression, The syntax is `rate( *number unit* )` . *unit* can
     ...
     * for more than a year before running. For information about the syntax for cron expressions,
     * see
