 ...
 */
@CdkDslMarker
public class CfnGameSessionQueueGameSessionQueueDestinationPropertyDsl {
    private val cdkBuilder: CfnGameSessionQueue.GameSessionQueueDestinationProperty.Builder =
    ...
    public fun build(): CfnGameSessionQueue.GameSessionQueueDestinationProperty = cdkBuilder.build()
}
