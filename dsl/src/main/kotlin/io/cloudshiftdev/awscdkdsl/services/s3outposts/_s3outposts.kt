...
public object s3outposts {
     ...
     * the specified Amazon S3 on Outposts bucket.
     *
     ...
     * Outpost. For more information, see
     ...
     *
     * For more information, see
     * [Aborting Incomplete Multipart Uploads Using a Bucket Lifecycle Policy](https://docs.aws.amazon.com/AmazonS3/latest/userguide/mpuoverview.html#mpu-abort-incomplete-mpu-lifecycle-config)
     * .
     *
     * Example:
     * ```
     ...
     */
    public inline fun cfnBucketFilterAndOperatorProperty(
        block: CfnBucketFilterAndOperatorPropertyDsl.() -> Unit = {}
     ...
     */
    public inline fun cfnBucketFilterProperty(
        block: CfnBucketFilterPropertyDsl.() -> Unit = {}
     ...
     */
    public inline fun cfnBucketFilterTagProperty(
        block: CfnBucketFilterTagPropertyDsl.() -> Unit = {}
     ...
     * Outposts bucket, the calling identity must have the `s3-outposts:PutBucketPolicy` permissions
     * on the specified Outposts bucket and belong to the bucket owner's account in order to use
     * this resource.
     *
     ...
     * datasets in S3 on Outposts. S3 on Outposts uses endpoints to connect to S3 on Outposts
     * buckets so that you can perform actions within your virtual private cloud (VPC). For more
     * information, see
     ...
     */
    public inline fun cfnEndpointFailedReasonProperty(
     ...
     */
    public inline fun cfnEndpointNetworkInterfaceProperty(
        block: CfnEndpointNetworkInterfacePropertyDsl.() -> Unit = {}
