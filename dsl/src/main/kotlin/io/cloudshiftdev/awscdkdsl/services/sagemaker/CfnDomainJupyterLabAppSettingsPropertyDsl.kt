 ...
 */
@CdkDslMarker
public class CfnDomainJupyterLabAppSettingsPropertyDsl {
    private val cdkBuilder: CfnDomain.JupyterLabAppSettingsProperty.Builder =
    ...
    public fun build(): CfnDomain.JupyterLabAppSettingsProperty {
