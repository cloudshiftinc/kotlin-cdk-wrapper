 ...
 * Fleet, you can define separate On-Demand and Spot capacity targets, specify the instance types
 * that work best for your applications, and specify how Amazon EC2 should distribute your fleet
 * capacity within each purchasing model. For more information, see
 * [Launching an EC2 Fleet](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-fleet.html) in
...
public class CfnEC2FleetDsl(
    ...
    public fun targetCapacitySpecification(
        targetCapacitySpecification: CfnEC2Fleet.TargetCapacitySpecificationRequestProperty
    ) {
        cdkBuilder.targetCapacitySpecification(targetCapacitySpecification)
    }
