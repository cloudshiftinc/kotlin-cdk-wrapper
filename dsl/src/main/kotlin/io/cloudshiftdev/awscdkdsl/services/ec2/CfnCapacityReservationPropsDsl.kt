...
public class CfnCapacityReservationPropsDsl {
    ...
    /**
     * @param endDate The date and time at which the Capacity Reservation expires. When a Capacity
    ...
    /**
     * @param instanceCount The number of instances for which to reserve capacity. Valid range: 1 -
     *   1000
     */
    ...
    /**
     * @param instanceType The instance type for which to reserve capacity. For more information,
     *   see
