 ...
 * an existing KMS key, the update request fails, regardless of the value of the
...
public class CfnKeyDsl(
     ...
     * created, the key state is `PENDING_IMPORT` and `ENABLED` is `false` . After you import the
     * key material, `ENABLED` updated to `true` . The KMS key can then be used for Cryptographic
     * Operations.
     *
