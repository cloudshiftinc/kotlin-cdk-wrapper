...
public class CfnDetectorModelPropsDsl {
    ...
    /**
     * @param key The value used to identify a detector instance. When a device or system sends
     *   input, a new detector instance with a unique key value is created. AWS IoT Events can
     *   continue to route input to its corresponding detector instance based on this identifying
     *   information.
     *
