...
public class CfnApplicationV2FlinkApplicationConfigurationPropertyDsl {
    ...
    public fun checkpointConfiguration(
        checkpointConfiguration: CfnApplicationV2.CheckpointConfigurationProperty
    ) {
        cdkBuilder.checkpointConfiguration(checkpointConfiguration)
    }
    ...
    public fun monitoringConfiguration(
        monitoringConfiguration: CfnApplicationV2.MonitoringConfigurationProperty
    ) {
        cdkBuilder.monitoringConfiguration(monitoringConfiguration)
    }
    ...
    public fun parallelismConfiguration(
        parallelismConfiguration: CfnApplicationV2.ParallelismConfigurationProperty
    ) {
        cdkBuilder.parallelismConfiguration(parallelismConfiguration)
    }
