 ...
 * your existing standard queue and recreate it as a FIFO queue. For more information, see
...
public class CfnQueueDsl(
     ...
     * content as duplicates and delivers only one copy of the message. For more information, see
     * the `ContentBasedDeduplication` attribute for the
     ...
     *   the response, rather than returning an empty response if a message isn't yet available.
     */
