...
public class CfnAnomalyDetectorMetricMathAnomalyDetectorPropertyDsl {
    ...
    /**
     * @param metricDataQueries An array of metric data query structures that enables you to create
     *   an anomaly detector based on the result of a metric math expression. Each item in
     ...
     *   detector uses as input. Designate the expression by setting `ReturnData` to `true` for this
     *   object in the array. For all other expressions and metrics, set `ReturnData` to `false` .
