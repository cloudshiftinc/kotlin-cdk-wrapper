...
public class CfnTemplateConditionalFormattingCustomIconConditionPropertyDsl {
    ...
    public fun displayConfiguration(
        displayConfiguration: CfnTemplate.ConditionalFormattingIconDisplayConfigurationProperty
    ) {
        cdkBuilder.displayConfiguration(displayConfiguration)
    }
    ...
    public fun iconOptions(
        iconOptions: CfnTemplate.ConditionalFormattingCustomIconOptionsProperty
    ) {
        cdkBuilder.iconOptions(iconOptions)
    }
