 ...
 */
@CdkDslMarker
public class CfnDashboardKPIComparisonValueConditionalFormattingPropertyDsl {
    private val cdkBuilder: CfnDashboard.KPIComparisonValueConditionalFormattingProperty.Builder =
    ...
    public fun build(): CfnDashboard.KPIComparisonValueConditionalFormattingProperty =
        cdkBuilder.build()
}
