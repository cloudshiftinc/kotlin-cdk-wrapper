 ...
 */
@CdkDslMarker
public class FunctionUrlOriginDsl(
    lambdaFunctionUrl: IFunctionUrl,
) {
    private val cdkBuilder: FunctionUrlOrigin.Builder =
        FunctionUrlOrigin.Builder.create(lambdaFunctionUrl)
    ...
    public fun build(): FunctionUrlOrigin = cdkBuilder.build()
}
