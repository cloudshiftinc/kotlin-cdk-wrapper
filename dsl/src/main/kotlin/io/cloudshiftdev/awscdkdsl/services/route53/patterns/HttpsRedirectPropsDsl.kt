...
package io.cloudshiftdev.awscdkdsl.services.route53.patterns
...
public class HttpsRedirectPropsDsl {
    ...
    /**
     * @param targetDomain The redirect target fully qualified domain name (FQDN). An alias record
     *   will be created that points to your CloudFront distribution. Root domain or sub-domain can
     *   be supplied.
     */
     ...
     *   domain names in the hosted zone to the target domain. The hosted zone must contain entries
     *   for the domain name(s) supplied through `recordNames` that will redirect to the target
     *   domain.
     *
