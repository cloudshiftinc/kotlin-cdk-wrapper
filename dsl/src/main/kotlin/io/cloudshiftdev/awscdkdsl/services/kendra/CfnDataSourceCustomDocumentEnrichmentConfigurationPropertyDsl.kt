...
public class CfnDataSourceCustomDocumentEnrichmentConfigurationPropertyDsl {
     ...
     *   document metadata and content. For more information, see
    ...
    public fun postExtractionHookConfiguration(
        postExtractionHookConfiguration: CfnDataSource.HookConfigurationProperty
    ) {
        cdkBuilder.postExtractionHookConfiguration(postExtractionHookConfiguration)
    }
     ...
     *   function in AWS Lambda on the original or raw documents before extracting their metadata
     *   and text. You can use a Lambda function to apply advanced logic for creating, modifying, or
    ...
    public fun preExtractionHookConfiguration(
        preExtractionHookConfiguration: CfnDataSource.HookConfigurationProperty
    ) {
        cdkBuilder.preExtractionHookConfiguration(preExtractionHookConfiguration)
    }
    ...
    public fun build(): CfnDataSource.CustomDocumentEnrichmentConfigurationProperty {
        if (_inlineConfigurations.isNotEmpty())
            cdkBuilder.inlineConfigurations(_inlineConfigurations)
