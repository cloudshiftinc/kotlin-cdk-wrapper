 ...
 */
@CdkDslMarker
public class CfnDashboardTableStyleTargetPropertyDsl {
    private val cdkBuilder: CfnDashboard.TableStyleTargetProperty.Builder =
    ...
    public fun build(): CfnDashboard.TableStyleTargetProperty = cdkBuilder.build()
}
