 ...
 */
@CdkDslMarker
public class CfnDashboardDataPathTypePropertyDsl {
    private val cdkBuilder: CfnDashboard.DataPathTypeProperty.Builder =
    ...
    public fun build(): CfnDashboard.DataPathTypeProperty = cdkBuilder.build()
}
