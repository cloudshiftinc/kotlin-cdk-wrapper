 ...
 */
public inline fun CfnFirewallPolicy.setFirewallPolicy(
...
public inline fun CfnLoggingConfiguration.setLoggingConfiguration(
...
public inline fun CfnRuleGroup.setRuleGroup(
