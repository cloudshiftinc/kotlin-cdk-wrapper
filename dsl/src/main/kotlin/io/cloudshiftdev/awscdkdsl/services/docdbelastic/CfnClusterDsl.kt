...
public class CfnClusterDsl(
     ...
     * are creating a cluster using the same Amazon account that owns this KMS encryption key, you
     * can use the KMS key alias instead of the ARN as the KMS encryption key.
     *
