...
public class CfnRefreshScheduleScheduleFrequencyPropertyDsl {
    ...
    /**
     * @param refreshOnDay The day of the week that you want to schedule the refresh on. This value
    ...
    /**
     * @param timeOfTheDay The time of day that you want the dataset to refresh. This value is
     *   expressed in HH:MM format. This field is not required for schedules that refresh hourly.
     */
    ...
    /**
     * @param timeZone The timezone that you want the refresh schedule to use. The timezone ID must
