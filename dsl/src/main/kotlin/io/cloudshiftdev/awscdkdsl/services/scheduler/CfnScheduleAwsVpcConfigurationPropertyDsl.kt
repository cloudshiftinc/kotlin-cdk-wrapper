 ...
 */
@CdkDslMarker
public class CfnScheduleAwsVpcConfigurationPropertyDsl {
    private val cdkBuilder: CfnSchedule.AwsVpcConfigurationProperty.Builder =
     ...
     *   public IP address. You can specify `ENABLED` only when `LaunchType` in `EcsParameters` is
     *   set to `FARGATE` .
     */
    ...
    /**
     * @param securityGroups Specifies the security groups associated with the task. These security
    ...
    /**
     * @param subnets Specifies the subnets associated with the task. These subnets must all be in
    ...
    public fun build(): CfnSchedule.AwsVpcConfigurationProperty {
