...
public class CfnAnalysisTreeMapAggregatedFieldWellsPropertyDsl {
    ...
    /**
     * @param colors The color field well of a tree map. Values are grouped by aggregations based on
     *   group by fields.
     */
    ...
    /**
     * @param groups The group by field well of a tree map. Values are grouped based on group by
     *   fields.
     */
    ...
    public fun build(): CfnAnalysis.TreeMapAggregatedFieldWellsProperty {
