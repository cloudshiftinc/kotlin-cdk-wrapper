...
public class CfnServerDsl(
     ...
     * your VPC. With an endpoint that is hosted in a VPC, you can restrict access to your server
     * and resources only within your VPC or choose to make it internet facing by attaching Elastic
     * IP addresses directly to it.
     *
     ...
     * you would then need to explicitly set the `HomeDirectoryMapEntry` `Type` to `FILE` if you
