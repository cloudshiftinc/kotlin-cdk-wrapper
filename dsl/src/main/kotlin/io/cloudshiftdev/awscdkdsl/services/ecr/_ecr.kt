...
public object ecr {
    /**
     * The `AWS::ECR::PublicRepository` resource specifies an Amazon Elastic Container Registry
     * Public (Amazon ECR Public) repository, where users can push and pull Docker images, Open
     ...
     * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ecr-publicrepository.html)
     */
    public inline fun cfnPublicRepositoryProps(
        block: CfnPublicRepositoryPropsDsl.() -> Unit = {}
    ...
    /**
     * The `AWS::ECR::RegistryPolicy` resource creates or updates the permissions policy for a
     * private registry.
     *
     ...
     * IAM role is created in your account for the replication process. For more information, see
     ...
     * repositories in a private registry are replicated. If no filters are added, the contents of
     * all repositories are replicated.
     *
     * Example:
     * ```
     * // The code below shows an example of how to instantiate this type.
     ...
     * ECR) repository, where users can push and pull Docker images, Open Container Initiative (OCI)
     ...
     * server-side encryption with AWS Key Management Service key stored in AWS Key Management
     * Service ( AWS KMS ) to encrypt your images. For more information, see
     ...
     * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ecr-repository.html)
     */
    public inline fun cfnRepositoryProps(
        block: CfnRepositoryPropsDsl.() -> Unit = {}
    ): CfnRepositoryProps {
     ...
     * ```
     */
    public inline fun onCloudTrailImagePushedOptions(
     ...
     * ```
     */
    public inline fun repositoryAttributes(
