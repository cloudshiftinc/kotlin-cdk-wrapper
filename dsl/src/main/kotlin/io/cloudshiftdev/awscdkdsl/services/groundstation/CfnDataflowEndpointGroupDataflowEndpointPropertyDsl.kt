...
public class CfnDataflowEndpointGroupDataflowEndpointPropertyDsl {
     ...
     *   Station searches for a dataflow endpoint whose name matches the value specified by the
     *   dataflow endpoint config of the selected mission profile. If no matching dataflow endpoints
     *   are found then Ground Station will not display any available contacts for the satellite.
     */
