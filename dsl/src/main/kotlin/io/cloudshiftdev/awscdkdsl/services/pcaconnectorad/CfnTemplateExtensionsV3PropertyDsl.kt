 ...
 */
@CdkDslMarker
public class CfnTemplateExtensionsV3PropertyDsl {
    private val cdkBuilder: CfnTemplate.ExtensionsV3Property.Builder =
    ...
    public fun build(): CfnTemplate.ExtensionsV3Property = cdkBuilder.build()
}
