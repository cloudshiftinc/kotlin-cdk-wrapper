 ...
 */
@CdkDslMarker
public class CfnMatchingWorkflowIntermediateSourceConfigurationPropertyDsl {
    private val cdkBuilder: CfnMatchingWorkflow.IntermediateSourceConfigurationProperty.Builder =
    ...
    public fun build(): CfnMatchingWorkflow.IntermediateSourceConfigurationProperty =
        cdkBuilder.build()
}
