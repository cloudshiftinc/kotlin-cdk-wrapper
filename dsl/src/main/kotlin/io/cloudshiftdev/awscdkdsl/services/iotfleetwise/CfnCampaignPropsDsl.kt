...
public class CfnCampaignPropsDsl {
    ...
    /**
     * @param collectionScheme The data collection scheme associated with the campaign. You can
     ...
     *   FleetWise . If you don't want to compress the signals, use `OFF` . If it's not specified,
     *   `SNAPPY` is used.
     *
     * Default: `SNAPPY`
     */
    ...
    /**
     * @param dataDestinationConfigs (Optional) The destination where the campaign sends data. You
     *   can choose to send data to be stored in Amazon S3 or Amazon Timestream .
     *
     ...
     *   `model` to the campaign, and AWS IoT FleetWise will associate the data with those
     ...
     *   AWS IoT FleetWise . If you want to send diagnostic trouble codes, use `SEND_ACTIVE_DTCS` .
     ...
     *   forwarded to AWS IoT FleetWise . If you want to store collected data when a vehicle loses
     *   connection with the cloud, use `TO_DISK` . If it's not specified, `OFF` is used.
     *
     * Default: `OFF`
     */
