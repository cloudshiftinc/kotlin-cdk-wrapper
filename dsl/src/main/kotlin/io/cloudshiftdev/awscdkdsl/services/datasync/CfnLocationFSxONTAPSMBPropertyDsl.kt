...
public class CfnLocationFSxONTAPSMBPropertyDsl {
     ...
     *   and metadata that you need in the SVM. If you provide a user in your Active Directory, note
     *   the following:
     ...
     *   Domain Admins group or a custom group that you specified for file system administration
     ...
     *   Domain Admins group. If you configure your task to copy SACLs, make sure that the user has
     *   the required privileges. For information about copying SACLs, see
