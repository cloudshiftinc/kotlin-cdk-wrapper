...
import io.cloudshiftdev.awscdkdsl.services.logs.LogRetentionRetryOptionsDsl
...
public class SlackChannelConfigurationPropsDsl {
    ...
    /**
     * @param slackChannelId The ID of the Slack channel. To get the ID, open Slack, right click on
     *   the channel name in the left pane, then choose Copy Link. The channel ID is the 9-character
    ...
    /**
     * @param slackWorkspaceId The ID of the Slack workspace authorized with AWS Chatbot. To get the
     *   workspace ID, you must perform the initial authorization flow with Slack in the AWS Chatbot
     *   console. Then you can copy and paste the workspace ID from the console. For more details,
