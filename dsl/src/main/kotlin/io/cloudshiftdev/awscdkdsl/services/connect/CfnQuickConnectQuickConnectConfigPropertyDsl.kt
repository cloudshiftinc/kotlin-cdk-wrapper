...
public class CfnQuickConnectQuickConnectConfigPropertyDsl {
    ...
    /**
     * @param phoneConfig The phone configuration. This is required only if QuickConnectType is
     *   PHONE_NUMBER.
     */
    ...
    /**
     * @param queueConfig The queue configuration. This is required only if QuickConnectType is
     *   QUEUE.
     */
    ...
    /**
     * @param quickConnectType The type of quick connect. In the Amazon Connect console, when you
    ...
    /**
     * @param userConfig The user configuration. This is required only if QuickConnectType is USER.
     */
