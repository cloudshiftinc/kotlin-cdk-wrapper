...
public class CfnFilterPropsDsl {
    ...
    /**
     * @param name The name of the filter. Valid characters include period (.), underscore (_), dash
    ...
    /**
     * @param rank Specifies the position of the filter in the list of current filters. Also
     *   specifies the order in which this filter is applied to the findings. The minimum value for
    ...
    /**
     * @param tags The tags to be added to a new filter resource. Each tag consists of a key and an
