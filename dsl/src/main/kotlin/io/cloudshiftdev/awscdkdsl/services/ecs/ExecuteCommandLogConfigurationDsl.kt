 ...
 *
 * The logs can be sent to CloudWatch Logs and/ or an Amazon S3 bucket. For more information, see
...
public class ExecuteCommandLogConfigurationDsl {
    ...
    /**
     * @param cloudWatchLogGroup The name of the CloudWatch log group to send logs to. The
    ...
    /**
     * @param s3Bucket The name of the S3 bucket to send logs to. The S3 bucket must already be
     *   created.
     */
