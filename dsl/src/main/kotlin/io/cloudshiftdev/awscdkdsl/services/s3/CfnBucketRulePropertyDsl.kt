...
public class CfnBucketRulePropertyDsl {
     ...
     *   Glacier. The date value must be in ISO 8601 format. The time is always midnight UTC. If you
     ...
     *   from Amazon S3 and Amazon S3 Glacier. If you specify an expiration and transition time, you
     *   must use the same time unit for both properties (either in days or by date). The expiration
     ...
     *   without any noncurrent versions. If set to true, the delete marker will be removed if there
     *   are no noncurrent versions. This cannot be specified with `ExpirationInDays` ,
    ...
    /**
     * @param noncurrentVersionExpiration Specifies when noncurrent object versions expire. Upon
     *   expiration, Amazon S3 permanently deletes the noncurrent object versions. You set this
    ...
    public fun noncurrentVersionExpiration(
        noncurrentVersionExpiration: CfnBucket.NoncurrentVersionExpirationProperty
    ) {
        cdkBuilder.noncurrentVersionExpiration(noncurrentVersionExpiration)
    }
     ...
     *   expire, Amazon S3 permanently deletes them. If you specify a transition and expiration
     *   time, the expiration time must be later than the transition time.
     */
     ...
     *   suspended), specifies when non-current objects transition to a specified storage class. If
     *   you specify a transition and expiration time, the expiration time must be later than the
    ...
    public fun noncurrentVersionTransition(
        noncurrentVersionTransition: CfnBucket.NoncurrentVersionTransitionProperty
    ) {
        cdkBuilder.noncurrentVersionTransition(noncurrentVersionTransition)
    }
     ...
     *   storage class. If you specify a transition and expiration time, the expiration time must be
     *   later than the transition time. If you specify this property, don't specify the
     ...
     *   apply to. Objects must be larger than this value in bytes. For more information about size
     *   based rules, see
     ...
     *   to. Objects must be smaller than this value in bytes. For more information about sized
     *   based rules, see
     *   [Lifecycle configuration using size-based rules](https://docs.aws.amazon.com/AmazonS3/latest/userguide/lifecycle-configuration-examples.html#lc-size-rules)
     *   in the *Amazon S3 User Guide* .
     */
     ...
     *   class. If you specify an expiration and transition time, you must use the same time unit
     *   for both properties (either in days or by date). The expiration time must also be later
     *   than the transition time. If you specify this property, don't specify the `Transitions`
     *   property.
     */
     ...
     *   specified storage class. If you specify an expiration and transition time, you must use the
     *   same time unit for both properties (either in days or by date). The expiration time must
     *   also be later than the transition time. If you specify this property, don't specify the
     *   `Transition` property.
     */
