...
public class WithoutPolicyUpdatesOptionsDsl {
     ...
     *   `false` or not specified, grant permissions added to this role are ignored. It is your own
     *   responsibility to make sure the role has the required permissions.
     *
