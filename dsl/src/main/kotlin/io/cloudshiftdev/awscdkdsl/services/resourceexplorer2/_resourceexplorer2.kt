...
public object resourceexplorer2 {
     ...
     * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-resourceexplorer2-defaultviewassociation.html)
     */
    public inline fun cfnDefaultViewAssociationProps(
        block: CfnDefaultViewAssociationPropsDsl.() -> Unit = {}
    ...
    /**
     * Turns on Resource Explorer in the AWS Region in which you called this operation by creating
     * an index.
     *
     * Resource Explorer begins discovering the resources in this Region and stores the details
     ...
     * which the index exists, or you can create an aggregator index that returns search results
     * from all AWS Regions in the AWS account .
     *
     ...
     * operation also creates a service-linked role in your AWS account that allows Resource
     * Explorer to search for your resources and populate the index.
     *
     * Example:
     * ```
     * // The code below shows an example of how to instantiate this type.
     ...
     * [Search](https://docs.aws.amazon.com/resource-explorer/latest/apireference/API_Search.html)
     * operation. Results from queries that you make using this view include only resources that
     ...
     */
    public inline fun cfnViewFiltersProperty(
        block: CfnViewFiltersPropertyDsl.() -> Unit = {}
