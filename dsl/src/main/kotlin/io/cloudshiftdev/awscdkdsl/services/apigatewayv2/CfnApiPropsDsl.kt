...
public class CfnApiPropsDsl {
    ...
    /**
     * @param apiKeySelectionExpression An API key selection expression. Supported only for
     *   WebSocket APIs. See
    ...
    /**
     * @param body The OpenAPI definition. Supported only for HTTP APIs. To import an HTTP API, you
    ...
    /**
     * @param bodyS3Location The S3 location of an OpenAPI definition. Supported only for HTTP APIs.
     *   To import an HTTP API, you must specify a `Body` or `BodyS3Location` . If you specify a
     *   `Body` or `BodyS3Location` , don't specify CloudFormation resources such as
     *   `AWS::ApiGatewayV2::Authorizer` or `AWS::ApiGatewayV2::Route` . API Gateway doesn't support
     *   the combination of OpenAPI and CloudFormation resources.
     */
    ...
    /**
     * @param corsConfiguration A CORS configuration. Supported only for HTTP APIs. See
     ...
     *   specify `arn:aws:iam::*:user/ *` . To use resource-based permissions on supported AWS
    ...
    /**
     * @param disableSchemaValidation Avoid validating models when creating a deployment. Supported
    ...
    /**
     * @param name The name of the API. Required unless you specify an OpenAPI definition for `Body`
     *   or `S3BodyLocation` .
     */
    ...
    /**
     * @param protocolType The API protocol. Valid values are `WEBSOCKET` or `HTTP` . Required
    ...
    /**
     * @param routeKey This property is part of quick create. If you don't specify a `routeKey` , a
    ...
    /**
     * @param routeSelectionExpression The route selection expression for the API. For HTTP APIs,
     *   the `routeSelectionExpression` must be `${request.method} ${request.path}` . If not
     *   provided, this will be the default for HTTP APIs. This property is required for WebSocket
     *   APIs.
     */
    ...
    /**
     * @param target This property is part of quick create. Quick create produces an API with an
