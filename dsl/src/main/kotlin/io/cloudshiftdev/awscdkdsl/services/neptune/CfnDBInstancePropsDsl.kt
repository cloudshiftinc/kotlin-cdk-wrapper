...
public class CfnDBInstancePropsDsl {
     ...
     *   as possible. This parameter must be set to true when specifying a value for the
     ...
     *   automatically. When updating this property, some interruptions may occur.
     */
     ...
     *   instance. If you update this property, some interruptions may occur.
     */
    ...
    /**
     * @param dbInstanceIdentifier Contains a user-supplied database identifier. This identifier is
     ...
     *   AWS::Neptune::DBParameterGroup resource created in the template. If any of the data members
     *   of the referenced parameter group are changed during an update, the DB instance might need
     *   to be restarted, which causes some interruption. If the parameter group contains static
     *   parameters, whether they were changed or not, an update triggers a reboot.
     */
    ...
    /**
     * @param dbSnapshotIdentifier This parameter is not supported. `AWS::Neptune::DBInstance` does
     *   not support restoring from snapshots.
     *
     ...
     *   this value, the new subnet group must be a subnet group in a new virtual private cloud
     *   (VPC).
     */
