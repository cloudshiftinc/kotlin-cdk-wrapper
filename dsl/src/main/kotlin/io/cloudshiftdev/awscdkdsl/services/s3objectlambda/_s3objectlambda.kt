...
public object s3objectlambda {
    /**
     * The `AWS::S3ObjectLambda::AccessPoint` resource specifies an Object Lambda Access Point used
     * to access a bucket.
     *
     * Example:
     * ```
    ...
    /**
     * The `AWS::S3ObjectLambda::AccessPointPolicy` resource specifies the Object Lambda Access
     * Point resource policy document.
     *
     * Example:
     * ```
     * // The code below shows an example of how to instantiate this type.
     ...
     * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-s3objectlambda-accesspointpolicy.html)
     */
    public inline fun cfnAccessPointPolicyProps(
        block: CfnAccessPointPolicyPropsDsl.() -> Unit = {}
