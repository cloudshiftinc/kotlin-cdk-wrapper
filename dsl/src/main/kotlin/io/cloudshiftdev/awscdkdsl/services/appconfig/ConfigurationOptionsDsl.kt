 ...
 */
@CdkDslMarker
public class ConfigurationOptionsDsl {
    private val cdkBuilder: ConfigurationOptions.Builder = ConfigurationOptions.builder()
    ...
    public fun build(): ConfigurationOptions {
