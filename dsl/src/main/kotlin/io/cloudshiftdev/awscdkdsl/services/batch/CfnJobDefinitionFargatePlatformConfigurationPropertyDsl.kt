...
public class CfnJobDefinitionFargatePlatformConfigurationPropertyDsl {
     ...
     *   platform version is specified only for jobs that are running on Fargate resources. If one
     *   isn't specified, the `LATEST` platform version is used by default. This uses a recent,
     *   approved version of the AWS Fargate platform for compute resources. For more information,
     *   see
