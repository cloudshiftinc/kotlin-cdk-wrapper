...
public class CfnImageBuilderPropsDsl {
    ...
    /**
     * @param iamRoleArn The ARN of the IAM role that is applied to the image builder. To assume a
     *   role, the image builder calls the AWS Security Token Service `AssumeRole` API operation and
