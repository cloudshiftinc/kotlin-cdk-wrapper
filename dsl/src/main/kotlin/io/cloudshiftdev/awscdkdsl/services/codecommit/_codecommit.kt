...
public object codecommit {
     ...
     */
    public inline fun cfnRepositoryCodeProperty(
        block: CfnRepositoryCodePropertyDsl.() -> Unit = {}
    ...
    /**
     * Information about the Amazon S3 bucket that contains the code that will be committed to the
     * new repository.
     *
     ...
     */
    public inline fun cfnRepositoryS3Property(
        block: CfnRepositoryS3PropertyDsl.() -> Unit = {}
     ...
     * ```
     */
    public inline fun repositoryNotifyOnOptions(
     ...
     * ```
     */
    public inline fun repositoryTriggerOptions(
