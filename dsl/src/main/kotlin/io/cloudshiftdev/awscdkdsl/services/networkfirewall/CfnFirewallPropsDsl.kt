...
public class CfnFirewallPropsDsl {
     ...
     *   setting to protect against accidentally deleting a firewall that is in use. When you create
     *   a firewall, the operation initializes this flag to `TRUE` .
     */
    ...
    /**
     * @param firewallPolicyArn The Amazon Resource Name (ARN) of the firewall policy. The
     *   relationship of firewall to firewall policy is many to one. Each firewall requires one
    ...
    /**
     * @param vpcId The unique identifier of the VPC where the firewall is in use. You can't change
     *   the VPC of a firewall after you create the firewall.
     */
