...
public class CfnObjectTypeDsl(
     ...
     * service tries to fetch a standard profile and associate this object with the profile. If it
     * is set to `TRUE` , and if no match is found, then the service creates a new standard profile.
     *
