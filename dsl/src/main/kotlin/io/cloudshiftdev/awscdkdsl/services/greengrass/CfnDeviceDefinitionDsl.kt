 ...
 * versions must be associated with a device definition. Each device definition version can contain
 * one or more devices.
 *
...
public class CfnDeviceDefinitionDsl(
    ...
    private val cdkBuilder: CfnDeviceDefinition.Builder =
        CfnDeviceDefinition.Builder.create(scope, id)
