 ...
 */
@CdkDslMarker
public class SagemakerIntegrationDsl(
    endpoint: IEndpoint,
) {
    private val cdkBuilder: SagemakerIntegration.Builder =
        SagemakerIntegration.Builder.create(endpoint)
    ...
    public fun build(): SagemakerIntegration {
