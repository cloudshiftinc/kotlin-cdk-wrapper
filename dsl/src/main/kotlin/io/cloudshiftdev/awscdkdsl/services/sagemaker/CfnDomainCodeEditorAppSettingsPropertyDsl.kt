 ...
 */
@CdkDslMarker
public class CfnDomainCodeEditorAppSettingsPropertyDsl {
    private val cdkBuilder: CfnDomain.CodeEditorAppSettingsProperty.Builder =
    ...
    public fun build(): CfnDomain.CodeEditorAppSettingsProperty {
