...
public class CfnTopicRuleRepublishActionHeadersPropertyDsl {
     ...
     *   message to identify which request the response message is for. For more information, see
     ...
     *   at the broker. If the messages haven't been sent to the subscribers within that interval,
     *   the message expires and is removed. The value of `messageExpiry` represents the number of
     *   seconds before it expires. For more information about the limits of `messageExpiry` , see
     ...
     *   formatted as UTF-8. Valid values are `UNSPECIFIED_BYTES` and `UTF8_DATA` .
     *
     ...
     *   message. The response topic is used to describe the topic to which the receiver should
     *   publish as part of the request-response flow. The topic must not contain wildcard
     *   characters.
     *
     * For more information, see
