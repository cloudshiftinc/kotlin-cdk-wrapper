...
public class DistributionPropsDsl {
    ...
    /**
     * @param certificate A certificate to associate with the distribution. The certificate must be
     *   located in N. Virginia (us-east-1).
     */
    ...
    /**
     * @param domainNames Alternative domain names for this distribution. If you want to use your
     *   own domain name, such as www.example.com, instead of the cloudfront.net domain name, you
     *   can add an alternate domain name to your distribution. If you attach a certificate to the
     *   distribution, you must add (at least one of) the domain names of the certificate to this
     *   list.
     */
     ...
     *   communicate with CloudFront. For viewers and CloudFront to use HTTP/2, viewers must support
     *   TLS 1.2 or later, and must support server name identification (SNI).
     */
    ...
    /**
     * @param logBucket The Amazon S3 bucket to store the access logs in. Make sure to set
     *   `objectOwnership` to `s3.ObjectOwnership.OBJECT_WRITER` in your custom bucket.
     */
     ...
     *   CloudFront to use for HTTPS connections. CloudFront serves your objects only to browsers or
     *   devices that support at least the SSL version that you specify.
     */
     ...
     *   pay for CloudFront service. If you specify PriceClass_All, CloudFront responds to requests
     *   for your objects from all CloudFront edge locations. If you specify a price class other
     *   than PriceClass_All, CloudFront serves your objects from the CloudFront edge location that
    ...
    /**
     * @param sslSupportMethod The SSL method CloudFront will use for your distribution. Server Name
     *   Indication (SNI) - is an extension to the TLS computer networking protocol by which a
     *   client indicates which hostname it is attempting to connect to at the start of the
