 ...
 * @param options
 */
public inline fun BaseService.associateCloudMapService(
 ...
 * @param props
 */
public inline fun BaseService.autoScaleTaskCount(
 ...
 * additional alarms that should interrupt a deployment.
 *
 ...
 * AlarmBehavior values in multiple calls to this function, or the Alarm Behavior used here doesn't
 * match the one used in the service constructor, an error will be thrown.
 *
 * If the alarm's metric references the service, you cannot pass `Alarm.alarmName` here. That will
 * cause a circular dependency between the service and its deployment alarm. See this package's
 * README for options to alarm on service metrics, and avoid this circular dependency.
 *
 * @param alarmNames
 * @param options
 */
public inline fun BaseService.enableDeploymentAlarms(
 ...
 *
 * Use this function to create a load balancer target if you want to load balance to another
 * container than the first essential container or the first mapped port on the container.
 *
 * Use the return value of this function where you would normally use a load balancer target,
 * instead of the `Service` object itself.
 *
 * Example:
 * ```
 ...
 * @param options
 */
public inline fun BaseService.loadBalancerTarget(
 ...
 * @param props
 */
public inline fun BaseService.metric(
    metricName: String,
 ...
 * @param props
 */
public inline fun BaseService.metricCpuUtilization(
    block: MetricOptionsDsl.() -> Unit = {}
): Metric {
    val builder = MetricOptionsDsl()
    builder.apply(block)
 ...
 * @param props
 */
public inline fun BaseService.metricMemoryUtilization(
    block: MetricOptionsDsl.() -> Unit = {}
): Metric {
    val builder = MetricOptionsDsl()
    builder.apply(block)
...
public inline fun CfnCapacityProvider.setAutoScalingGroupProvider(
...
public inline fun CfnCluster.setConfiguration(
...
public inline fun CfnCluster.setServiceConnectDefaults(
 ...
 */
public inline fun CfnService.setDeploymentConfiguration(
...
public inline fun CfnService.setDeploymentController(
 ...
 */
public inline fun CfnService.setServiceConnectConfiguration(
...
public inline fun CfnTaskDefinition.setEphemeralStorage(
...
public inline fun CfnTaskDefinition.setProxyConfiguration(
...
public inline fun CfnTaskDefinition.setRuntimePlatform(
...
public inline fun CfnTaskSet.setNetworkConfiguration(
 ...
 * @param options
 */
public inline fun Cluster.addAsgCapacityProvider(
 ...
 * @param options
 */
public inline fun Cluster.addCapacity(
    id: String,
 ...
 * involving both Service- Discovery and Service Connect, customers should manage the HttpNamespace
 * outside of the Cluster.addDefaultCloudMapNamespace method.
 *
 * @param options
 */
public inline fun Cluster.addDefaultCloudMapNamespace(
 ...
 * @param props
 */
public inline fun Cluster.metric(
    metricName: String,
    block: MetricOptionsDsl.() -> Unit = {}
): Metric {
    val builder = MetricOptionsDsl()
 ...
 */
public inline fun ContainerDefinition.addContainerDependencies(
 ...
 * @param statement
 */
public inline fun ContainerDefinition.addToExecutionPolicy(
 ...
 * @param _options
 */
public inline fun ExternalService.associateCloudMapService(
    block: AssociateCloudMapServiceOptionsDsl.() -> Unit = {}
) {
    val builder = AssociateCloudMapServiceOptionsDsl()
    builder.apply(block)
 ...
 * @param _props
 */
public inline fun ExternalService.autoScaleTaskCount(
    block: EnableScalingPropsDsl.() -> Unit = {}
): ScalableTaskCount {
    val builder = EnableScalingPropsDsl()
    builder.apply(block)
 ...
 * @param _options
 */
public inline fun ExternalService.enableCloudMap(
    block: CloudMapOptionsDsl.() -> Unit = {}
): Service {
    val builder = CloudMapOptionsDsl()
    builder.apply(block)
    return enableCloudMap(builder.build())
 ...
 * @param _options
 */
public inline fun ExternalService.loadBalancerTarget(
    block: LoadBalancerTargetOptionsDsl.() -> Unit = {}
): IEcsLoadBalancerTarget {
    val builder = LoadBalancerTargetOptionsDsl()
    builder.apply(block)
 ...
 */
public inline fun ExternalTaskDefinition.addInferenceAccelerator(
 ...
 * @param props
 */
public inline fun ScalableTaskCount.scaleOnCpuUtilization(
    id: String,
 ...
 * @param props
 */
public inline fun ScalableTaskCount.scaleOnMemoryUtilization(
    id: String,
 ...
 * @param props
 */
public inline fun ScalableTaskCount.scaleOnMetric(
    id: String,
 ...
 * @param props
 */
public inline fun ScalableTaskCount.scaleOnRequestCount(
    id: String,
 ...
 * @param props
 */
public inline fun ScalableTaskCount.scaleOnSchedule(
    id: String,
 ...
 * @param props
 */
public inline fun ScalableTaskCount.scaleToTrackCustomMetric(
    id: String,
 ...
 * @param props
 */
public inline fun TaskDefinition.addContainer(
    id: String,
 ...
 * @param props
 */
public inline fun TaskDefinition.addFirelensLogRouter(
    id: String,
 ...
 */
public inline fun TaskDefinition.addInferenceAccelerator(
    block: InferenceAcceleratorDsl.() -> Unit = {}
) {
    val builder = InferenceAcceleratorDsl()
    builder.apply(block)
 ...
 * @param statement
 */
public inline fun TaskDefinition.addToExecutionRolePolicy(
    block: PolicyStatementDsl.() -> Unit = {}
) {
    val builder = PolicyStatementDsl()
    builder.apply(block)
