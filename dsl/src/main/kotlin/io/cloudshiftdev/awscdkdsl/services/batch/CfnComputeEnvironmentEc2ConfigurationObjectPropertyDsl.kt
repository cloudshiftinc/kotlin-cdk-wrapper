...
public class CfnComputeEnvironmentEc2ConfigurationObjectPropertyDsl {
     ...
     *   match the image type. This setting overrides the `imageId` set in the `computeResource`
     *   object.
     *
     ...
     * instances. Amazon ECS vends both x86 and ARM versions of the Amazon ECS-optimized Amazon
     * Linux 2 AMI. For more information, see
    ...
    /**
     * @param imageKubernetesVersion The Kubernetes version for the compute environment. If you
     *   don't specify a value, the latest version that AWS Batch supports is used.
     */
