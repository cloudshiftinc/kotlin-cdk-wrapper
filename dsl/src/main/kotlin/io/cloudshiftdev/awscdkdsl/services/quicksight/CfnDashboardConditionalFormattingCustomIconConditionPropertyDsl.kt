...
public class CfnDashboardConditionalFormattingCustomIconConditionPropertyDsl {
    ...
    public fun displayConfiguration(
        displayConfiguration: CfnDashboard.ConditionalFormattingIconDisplayConfigurationProperty
    ) {
        cdkBuilder.displayConfiguration(displayConfiguration)
    }
    ...
    public fun iconOptions(
        iconOptions: CfnDashboard.ConditionalFormattingCustomIconOptionsProperty
    ) {
        cdkBuilder.iconOptions(iconOptions)
    }
