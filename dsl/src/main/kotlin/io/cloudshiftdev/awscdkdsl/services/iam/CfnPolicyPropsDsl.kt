...
public class CfnPolicyPropsDsl {
    ...
    /**
     * @param groups The name of the group to associate the policy with. This parameter allows
    ...
    /**
     * @param roles The name of the role to associate the policy with. This parameter allows (per
     *   its [regex pattern](https://docs.aws.amazon.com/http://wikipedia.org/wiki/regex) ) a string
    ...
    /**
     * @param users The name of the user to associate the policy with. This parameter allows
     *   (through its [regex pattern](https://docs.aws.amazon.com/http://wikipedia.org/wiki/regex) )
     *   a string of characters consisting of upper and lowercase alphanumeric characters with no
     *   spaces. You can also include any of the following characters: _+=,.&#64;-
     */
