...
public class CfnInstanceEbsPropertyDsl {
     ...
     *   `KmsKeyId` is specified, the encrypted state must be `true` . If the encrypted state is
    ...
    /**
     * @param snapshotId The ID of the snapshot. If you specify both `SnapshotId` and `VolumeSize` ,
