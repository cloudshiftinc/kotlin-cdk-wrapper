 ...
 * [Using tables as visuals](https://docs.aws.amazon.com/quicksight/latest/user/tabular.html) in the
 ...
 */
@CdkDslMarker
public class CfnAnalysisTableVisualPropertyDsl {
    private val cdkBuilder: CfnAnalysis.TableVisualProperty.Builder =
    ...
    /** @param chartConfiguration The configuration settings of the visual. */
    public fun chartConfiguration(chartConfiguration: CfnAnalysis.TableConfigurationProperty) {
        cdkBuilder.chartConfiguration(chartConfiguration)
    }
    ...
    public fun conditionalFormatting(
        conditionalFormatting: CfnAnalysis.TableConditionalFormattingProperty
    ) {
        cdkBuilder.conditionalFormatting(conditionalFormatting)
    }
    ...
    public fun build(): CfnAnalysis.TableVisualProperty {
