...
public class CfnCoreDefinitionVersionCorePropertyDsl {
    ...
    /**
     * @param certificateArn The ARN of the device certificate for the core. This X.509 certificate
     *   is used to authenticate the core with AWS IoT and AWS IoT Greengrass services.
     */
