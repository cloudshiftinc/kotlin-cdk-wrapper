...
public class CfnProjectBuildStatusConfigPropertyDsl {
     ...
     *   [Create a commit status](https://docs.aws.amazon.com/https://developer.github.com/v3/repos/statuses/#create-a-commit-status)
     ...
     *   in the GitHub commit status. For more information, see
     *   [Create a commit status](https://docs.aws.amazon.com/https://developer.github.com/v3/repos/statuses/#create-a-commit-status)
     *   in the GitHub developer guide.
     */
