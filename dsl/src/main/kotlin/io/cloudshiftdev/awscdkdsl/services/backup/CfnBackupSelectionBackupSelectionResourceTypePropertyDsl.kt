...
public class CfnBackupSelectionBackupSelectionResourceTypePropertyDsl {
     ...
     *   "aws:ResourceTag/CreatedByCryo", "ConditionValue": "true" },` . Condition operators are
     *   case sensitive.
     *
    ...
    /**
     * @param notResources A list of Amazon Resource Names (ARNs) to exclude from a backup plan. The
