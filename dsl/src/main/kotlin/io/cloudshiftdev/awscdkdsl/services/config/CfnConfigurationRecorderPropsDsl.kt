...
public class CfnConfigurationRecorderPropsDsl {
    ...
    /**
     * @param name A name for the configuration recorder. If you don't specify a name, AWS
     *   CloudFormation CloudFormation generates a unique physical ID and uses that ID for the
     *   configuration recorder name. For more information, see
     ...
     *   or for a list of resource types. The resource types that you list must be supported by AWS
     *   Config .
     */
     ...
     *   for supported AWS resources. For more information, see
