...
public class CfnServiceDnsConfigPropertyDsl {
     ...
     * addresses for up to eight healthy instances. If fewer than eight instances are healthy,
     ...
     * the IP address for one randomly selected instance from among the healthy instances. If no
