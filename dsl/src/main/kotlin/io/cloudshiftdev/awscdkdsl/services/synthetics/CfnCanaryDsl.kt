 ...
 * check the availability and latency of your web services and troubleshoot anomalies by
 * investigating load time data, screenshots of the UI, logs, and metrics. You can set up a canary
 * to run continuously or just once.
 *
 ...
 * over the internet. For more information, see
