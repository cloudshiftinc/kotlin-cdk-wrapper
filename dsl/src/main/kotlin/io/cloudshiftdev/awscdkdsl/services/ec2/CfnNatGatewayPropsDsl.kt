...
public class CfnNatGatewayPropsDsl {
     ...
     *   that's associated with the NAT gateway. This property is required for a public NAT gateway
    ...
    /**
     * @param secondaryAllocationIds Secondary EIP allocation IDs. For more information, see
    ...
    /**
     * @param secondaryPrivateIpAddresses Secondary private IPv4 addresses. For more information
