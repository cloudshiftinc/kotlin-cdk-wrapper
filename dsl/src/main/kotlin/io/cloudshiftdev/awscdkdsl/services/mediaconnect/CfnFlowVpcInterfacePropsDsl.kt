...
public class CfnFlowVpcInterfacePropsDsl {
     ...
     *   VPC configuration. You must include at least one security group in the request.
     */
    ...
    /**
     * @param subnetId The subnet IDs that you want to use for your VPC interface. A range of IP
     *   addresses in your VPC. When you create your VPC, you specify a range of IPv4 addresses for
     *   the VPC in the form of a Classless Inter-Domain Routing (CIDR) block; for example,
     *   10.0.0.0/16. This is the primary CIDR block for your VPC. When you create a subnet for your
     *   VPC, you specify the CIDR block for the subnet, which is a subset of the VPC CIDR block.
     *
