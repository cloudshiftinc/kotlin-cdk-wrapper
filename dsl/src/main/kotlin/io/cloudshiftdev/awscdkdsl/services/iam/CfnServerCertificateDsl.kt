 ...
 * deploy it to AWS resources, and let ACM handle certificate renewals for you. Certificates
 ...
 * in the *AWS General Reference* . For general information about using the Query API with IAM, see
...
public class CfnServerCertificateDsl(
    ...
    private val cdkBuilder: CfnServerCertificate.Builder =
        CfnServerCertificate.Builder.create(scope, id)
