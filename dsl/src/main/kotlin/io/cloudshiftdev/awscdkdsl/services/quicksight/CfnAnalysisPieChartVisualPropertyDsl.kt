 ...
 *
 * For more information, see
 * [Using donut charts](https://docs.aws.amazon.com/quicksight/latest/user/donut-chart.html) in the
 * *Amazon QuickSight User Guide* .
 *
 * Example:
 * ```
 ...
 */
@CdkDslMarker
public class CfnAnalysisPieChartVisualPropertyDsl {
    private val cdkBuilder: CfnAnalysis.PieChartVisualProperty.Builder =
    ...
    /** @param chartConfiguration The configuration of a pie chart. */
    public fun chartConfiguration(chartConfiguration: CfnAnalysis.PieChartConfigurationProperty) {
        cdkBuilder.chartConfiguration(chartConfiguration)
    }
    ...
    public fun build(): CfnAnalysis.PieChartVisualProperty {
