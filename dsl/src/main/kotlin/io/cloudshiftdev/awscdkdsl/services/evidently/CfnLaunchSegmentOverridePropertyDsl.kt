...
public class CfnLaunchSegmentOverridePropertyDsl {
     ...
     *   there are more than one. Segment overrides with lower numbers are evaluated first.
     */
     ...
     *   this segment. This is a set of key-value pairs. The keys are variation names. The values
     *   represent the amount of traffic to allocate to that variation for this segment. This is
     *   expressed in thousandths of a percent, so a weight of 50000 represents 50% of traffic.
     */
