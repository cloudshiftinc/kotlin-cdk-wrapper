...
public class StepFunctionInvokeActionDsl {
     ...
     * Prefix (optional).
     *
     * By default, the action execution ID is used as the state machine execution name. If a prefix
     * is provided, it is prepended to the action execution ID with a hyphen and together used as
     * the state machine execution name.
     *
