 ...
 */
@CdkDslMarker
public class CfnDashboardSheetControlInfoIconLabelOptionsPropertyDsl {
    private val cdkBuilder: CfnDashboard.SheetControlInfoIconLabelOptionsProperty.Builder =
    ...
    public fun build(): CfnDashboard.SheetControlInfoIconLabelOptionsProperty = cdkBuilder.build()
}
