...
public class CfnConfigRuleScopePropertyDsl {
     ...
     *   evaluation for the rule. If you specify a resource ID, you must specify one resource type
     ...
     *   to trigger an evaluation for the rule. You can only specify one type if you also specify a
