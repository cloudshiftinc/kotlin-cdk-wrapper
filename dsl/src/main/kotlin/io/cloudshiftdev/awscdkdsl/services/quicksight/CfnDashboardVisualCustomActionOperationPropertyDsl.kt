...
public class CfnDashboardVisualCustomActionOperationPropertyDsl {
    ...
    public fun navigationOperation(
        navigationOperation: CfnDashboard.CustomActionNavigationOperationProperty
    ) {
        cdkBuilder.navigationOperation(navigationOperation)
    }
    ...
    public fun setParametersOperation(
        setParametersOperation: CfnDashboard.CustomActionSetParametersOperationProperty
    ) {
        cdkBuilder.setParametersOperation(setParametersOperation)
    }
