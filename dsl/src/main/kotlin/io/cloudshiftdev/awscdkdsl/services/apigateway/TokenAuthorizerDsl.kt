...
public class TokenAuthorizerDsl(
     ...
     *
     * The handler must follow a very specific protocol on the input it receives and the output it
     * needs to produce. API Gateway has documented the handler's
     ...
     *
     * When matched the authorizer lambda is invoked, otherwise a 401 Unauthorized is returned to
     * the client.
     *
