...
public class CfnDataSourceWebCrawlerUrlsPropertyDsl {
     ...
     *   you want to crawl. You can choose to crawl only the website host names, or the website host
     *   names with subdomains, or the website host names with subdomains and other domains that the
     *   web pages link to.
     *
    ...
    public fun seedUrlConfiguration(
        seedUrlConfiguration: CfnDataSource.WebCrawlerSeedUrlConfigurationProperty
    ) {
        cdkBuilder.seedUrlConfiguration(seedUrlConfiguration)
    }
     ...
     *   crawl. Only URLs belonging to the same website host names are crawled. You can list up to
     *   three sitemap URLs.
     */
    ...
    public fun siteMapsConfiguration(
        siteMapsConfiguration: CfnDataSource.WebCrawlerSiteMapsConfigurationProperty
    ) {
        cdkBuilder.siteMapsConfiguration(siteMapsConfiguration)
    }
