...
public class CfnAlarmMetricDataQueryPropertyDsl {
     ...
     *   those expressions. For more information about metric math expressions, see
     *   [Metric Math Syntax and Functions](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/using-metric-math.html#metric-math-syntax)
     *   in the *Amazon CloudWatch User Guide* .
     *
    ...
    /**
     * @param returnData This option indicates whether to return the timestamps and raw data values
     *   of this metric. When you create an alarm based on a metric math expression, specify `True`
     *   for this value for only the one math expression that the alarm is based on. You must
     *   specify `False` for `ReturnData` for all the other metrics and expressions used in the
     *   alarm.
     *
