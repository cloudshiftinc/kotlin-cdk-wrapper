 ...
 */
@CdkDslMarker
public class CfnTemplateTotalAggregationOptionPropertyDsl {
    private val cdkBuilder: CfnTemplate.TotalAggregationOptionProperty.Builder =
    ...
    public fun totalAggregationFunction(
        totalAggregationFunction: CfnTemplate.TotalAggregationFunctionProperty
    ) {
        cdkBuilder.totalAggregationFunction(totalAggregationFunction)
    }

    public fun build(): CfnTemplate.TotalAggregationOptionProperty = cdkBuilder.build()
}
