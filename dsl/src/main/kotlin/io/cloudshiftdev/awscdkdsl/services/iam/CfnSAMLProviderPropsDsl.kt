...
public class CfnSAMLProviderPropsDsl {
    ...
    /**
     * @param name The name of the provider to create. This parameter allows (through its
    ...
    /**
     * @param tags A list of tags that you want to attach to the new IAM SAML provider. Each tag
