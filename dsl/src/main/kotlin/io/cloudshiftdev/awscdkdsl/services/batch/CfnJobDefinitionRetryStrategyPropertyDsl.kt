...
public class CfnJobDefinitionRetryStrategyPropertyDsl {
    ...
    /**
     * @param attempts The number of times to move a job to the `RUNNABLE` status. You can specify
     ...
     *   retried or failed. If this parameter is specified, then the `attempts` parameter must also
