...
public class CfnApplicationLogPatternPropertyDsl {
    ...
    /**
     * @param pattern A regular expression that defines the log pattern. A log pattern can contain
     *   up to 50 characters, and it cannot be empty.
     */
    ...
    /**
     * @param patternName The name of the log pattern. A log pattern name can contain up to 50
     *   characters, and it cannot be empty. The characters can be Unicode letters, digits, or one
     *   of the following symbols: period, dash, underscore.
     */
