 ...
 */
@CdkDslMarker
public class CfnAnalysisDataPathTypePropertyDsl {
    private val cdkBuilder: CfnAnalysis.DataPathTypeProperty.Builder =
    ...
    public fun build(): CfnAnalysis.DataPathTypeProperty = cdkBuilder.build()
}
