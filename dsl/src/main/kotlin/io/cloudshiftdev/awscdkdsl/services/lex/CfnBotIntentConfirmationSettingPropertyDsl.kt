...
public class CfnBotIntentConfirmationSettingPropertyDsl {
     ...
     *   confirmation step. The dialog code hook is triggered based on these invocation settings
     *   when the confirmation next step or declination next step or failure next step is
    ...
    public fun confirmationConditional(
        confirmationConditional: CfnBot.ConditionalSpecificationProperty
    ) {
        cdkBuilder.confirmationConditional(confirmationConditional)
    }
    ...
    public fun declinationConditional(
        declinationConditional: CfnBot.ConditionalSpecificationProperty
    ) {
        cdkBuilder.declinationConditional(declinationConditional)
    }
     ...
     *   `promptSpecification` , Amazon Lex responds with this response to acknowledge that the
     *   intent was canceled.
     */
    ...
    public fun elicitationCodeHook(
        elicitationCodeHook: CfnBot.ElicitationCodeHookInvocationSettingProperty
    ) {
        cdkBuilder.elicitationCodeHook(elicitationCodeHook)
    }

    /**
     * @param failureConditional Provides a list of conditional branches. Branches are evaluated in
     *   the order that they are entered in the list. The first branch with a condition that
     *   evaluates to true is executed. The last branch in the list is the default branch. The
     *   default branch should not have any condition expression. The default branch is executed if
     *   no other branch has a matching condition.
     */
    ...
    /**
     * @param isActive Specifies whether the intent's confirmation is sent to the user. When this
     *   field is false, confirmation and declination responses aren't sent. If the `IsActive` field
    ...
    /**
     * @param promptSpecification Prompts the user to confirm the intent. This question should have
