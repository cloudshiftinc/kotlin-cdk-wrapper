...
public class CfnEIPPropsDsl {
    ...
    /**
     * @param domain The network ( `vpc` ). If you define an Elastic IP address and associate it
     *   with a VPC that is defined in the same template, you must declare a dependency on the
     *   VPC-gateway attachment by using the
    ...
    /**
     * @param publicIpv4Pool The ID of an address pool that you own. Use this parameter to let
     *   Amazon EC2 select an address from the address pool.
     *
    ...
    /**
     * @param transferAddress The Elastic IP address you are accepting for transfer. You can only
     *   accept one transferred address. For more information on Elastic IP address transfers, see
