...
public class CfnCertificatePropsDsl {
     ...
     *   resource. Valid options are DEFAULT with CaCertificatePem and CertificatePem, SNI_ONLY with
     ...
     * with certificates in `SNI_ONLY` mode must send the SNI extension when connecting to AWS IoT
     * Core .
     */
    ...
    /**
     * @param certificatePem The certificate data in PEM format. Requires SNI_ONLY for the
     *   certificate mode or the accompanying CACertificatePem for registration.
     */
    ...
    /**
     * @param status The status of the certificate. Valid values are ACTIVE, INACTIVE, REVOKED,
     *   PENDING_TRANSFER, and PENDING_ACTIVATION.
     *
