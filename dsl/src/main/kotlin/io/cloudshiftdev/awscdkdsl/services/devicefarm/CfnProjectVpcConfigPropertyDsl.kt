...
public class CfnProjectVpcConfigPropertyDsl {
    ...
    /**
     * @param subnetIds A subnet is a range of IP addresses in your VPC. You can launch Amazon
     *   resources, such as EC2 instances, into a specific subnet. When you create a subnet, you
     *   specify the IPv4 CIDR block for the subnet, which is a subset of the VPC CIDR block. See
