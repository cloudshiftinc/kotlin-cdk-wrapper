...
public class CfnDataRepositoryAssociationPropsDsl {
     ...
     *   be mapped 1-1 with `DataRepositoryPath` . The leading forward slash in the name is
     *   required. Two data repository associations cannot have overlapping file system paths. For
     *   example, if a data repository is associated with file system path `/ns1/` , then you cannot
     ...
     *   disk. The maximum number of disks that a single file can be striped across is limited by
     *   the total number of disks that make up the file system or cache.
     *
