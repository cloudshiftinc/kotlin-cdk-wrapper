...
public class CfnRepositoryPropsDsl {
     ...
     *   AWS CloudFormation stack. Information about code is only used in resource creation. Updates
     *   to a stack will not reflect changes made to code properties after initial resource
     *   creation.
     *
