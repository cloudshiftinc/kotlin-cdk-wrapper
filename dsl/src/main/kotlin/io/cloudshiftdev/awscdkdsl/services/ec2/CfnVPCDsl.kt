...
public class CfnVPCDsl(
     ...
     * the Amazon provided DNS service in the VPC that resolves public DNS hostnames to IP addresses
     * is not enabled. Enabled by default. For more information, see
     * [DNS attributes in your VPC](https://docs.aws.amazon.com/vpc/latest/userguide/vpc-dns.html#vpc-dns-support)
     * .
     *
