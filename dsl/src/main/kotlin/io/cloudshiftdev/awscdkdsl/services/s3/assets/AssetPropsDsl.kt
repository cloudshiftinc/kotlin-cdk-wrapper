...
package io.cloudshiftdev.awscdkdsl.services.s3.assets
...
public class AssetPropsDsl {
    ...
    /**
     * @param path The disk location of the asset. The path should refer to one of the following:
