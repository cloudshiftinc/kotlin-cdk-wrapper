...
public class CfnBucketAccessRulesPropertyDsl {
     ...
     *   currently specified. When this is true, you can use the
    ...
    /**
     * @param objectAccess Specifies the anonymous access to all objects in a bucket. The following
     ...
     * `public-read` ACL. Individual objects with a `public-read` ACL are readable by everyone on
     * the internet.
     */
