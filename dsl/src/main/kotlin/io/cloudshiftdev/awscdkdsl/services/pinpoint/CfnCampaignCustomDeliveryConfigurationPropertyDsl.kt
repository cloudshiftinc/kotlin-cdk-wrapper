...
public class CfnCampaignCustomDeliveryConfigurationPropertyDsl {
    ...
    /**
     * @param endpointTypes The types of endpoints to send the campaign or treatment to. Each valid
     *   value maps to a type of channel that you can associate with an endpoint by using the
