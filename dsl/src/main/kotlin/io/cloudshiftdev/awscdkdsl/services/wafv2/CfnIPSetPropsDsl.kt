...
public class CfnIPSetPropsDsl {
     ...
     *   blocks of IP addresses that you want AWS WAF to inspect for in incoming requests. All
     *   addresses must be specified using Classless Inter-Domain Routing (CIDR) notation. AWS WAF
    ...
    /**
     * @param name The name of the IP set. You cannot change the name of an `IPSet` after you create
     *   it.
     */
