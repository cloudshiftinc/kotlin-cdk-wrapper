 ...
 * the document itself in the Systems Manager console. For information, see
...
public class CfnMaintenanceWindowTaskMaintenanceWindowRunCommandParametersPropertyDsl {
    ...
    public fun cloudWatchOutputConfig(
        cloudWatchOutputConfig: CfnMaintenanceWindowTask.CloudWatchOutputConfigProperty
    ) {
        cdkBuilder.cloudWatchOutputConfig(cloudWatchOutputConfig)
    }
    ...
    public fun notificationConfig(
        notificationConfig: CfnMaintenanceWindowTask.NotificationConfigProperty
    ) {
        cdkBuilder.notificationConfig(notificationConfig)
    }
     ...
     *   parameters are the same as those for the `SendCommand` API call. For more information, see
     *   [SendCommand](https://docs.aws.amazon.com/systems-manager/latest/APIReference/API_SendCommand.html)
     *   in the *AWS Systems Manager API Reference* .
     */
