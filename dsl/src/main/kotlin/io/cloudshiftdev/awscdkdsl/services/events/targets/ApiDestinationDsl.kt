...
public class ApiDestinationDsl(
     ...
     *
     * These are merged with headers specified on the Connection, with the headers on the Connection
     * taking precedence.
     *
     ...
     *
     * If the API destination has a wilcard in the path, these path parts will be inserted in that
     * place.
     *
     * Default: - none
     *
