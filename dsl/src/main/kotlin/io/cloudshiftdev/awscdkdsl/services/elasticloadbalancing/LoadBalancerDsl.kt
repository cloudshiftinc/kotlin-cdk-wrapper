...
public class LoadBalancerDsl(
     ...
     *
     * This controls whether the load balancer evenly distributes requests across each availability
     * zone
     *
     * Default: true
     *
     ...
     *
     * This controls whether the LB has a public IP address assigned. It does not open up the Load
     * Balancer's security groups to public internet access.
     *
     * Default: false
     *
