...
public object targets {
     ...
     * ```
     */
    public inline fun apiGateway(
        restApi: RestApi,
        block: ApiGatewayDsl.() -> Unit = {}
    ): ApiGateway {
     ...
     *
     * Most likely the code will look something like this: `new BatchJob(jobQueue.jobQueueArn,
     * jobQueue, jobDefinition.jobDefinitionArn, jobDefinition)`
     *
     ...
     * ```
     */
    public inline fun codeBuildProject(
        project: IProject,
        block: CodeBuildProjectDsl.() -> Unit = {}
    ): CodeBuildProject {
     ...
     * ```
     */
    public inline fun codeBuildProjectProps(
        block: CodeBuildProjectPropsDsl.() -> Unit = {}
     ...
     * ```
     */
    public inline fun codePipelineTargetOptions(
        block: CodePipelineTargetOptionsDsl.() -> Unit = {}
     ...
     * ```
     */
    public inline fun kinesisStream(
        stream: IStream,
        block: KinesisStreamDsl.() -> Unit = {}
    ): KinesisStream {
     ...
     * ```
     */
    public inline fun kinesisStreamProps(
        block: KinesisStreamPropsDsl.() -> Unit = {}
    ): KinesisStreamProps {
     ...
     * ```
     */
    public inline fun lambdaFunction(
        handler: IFunction,
        block: LambdaFunctionDsl.() -> Unit = {}
    ): LambdaFunction {
     ...
     * ```
     */
    public inline fun lambdaFunctionProps(
        block: LambdaFunctionPropsDsl.() -> Unit = {}
    ): LambdaFunctionProps {
     ...
     * ```
     */
    public inline fun sfnStateMachineProps(
        block: SfnStateMachinePropsDsl.() -> Unit = {}
