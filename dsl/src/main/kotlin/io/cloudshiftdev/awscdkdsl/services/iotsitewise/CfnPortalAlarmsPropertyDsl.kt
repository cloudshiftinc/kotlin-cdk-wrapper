 ...
 * is outside a specified range. For more information, see
...
public class CfnPortalAlarmsPropertyDsl {
     ...
     *   IAM role that allows the alarm to perform actions and access AWS resources and services,
     ...
     *   [ARN](https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html) of the
     *   Lambda function that manages alarm notifications. For more information, see
