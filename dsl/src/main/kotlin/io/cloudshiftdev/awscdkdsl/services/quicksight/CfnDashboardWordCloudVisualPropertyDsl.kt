 ...
 * [Using word clouds](https://docs.aws.amazon.com/quicksight/latest/user/word-cloud.html) in the
 ...
 */
@CdkDslMarker
public class CfnDashboardWordCloudVisualPropertyDsl {
    private val cdkBuilder: CfnDashboard.WordCloudVisualProperty.Builder =
    ...
    public fun chartConfiguration(
        chartConfiguration: CfnDashboard.WordCloudChartConfigurationProperty
    ) {
        cdkBuilder.chartConfiguration(chartConfiguration)
    }
    ...
    public fun build(): CfnDashboard.WordCloudVisualProperty {
