...
public class AliasPropsDsl {
    ...
    /**
     * @param aliasName The name of the alias. The name must start with alias followed by a forward
     *   slash, such as alias/. You can't specify aliases that begin with alias/AWS. These aliases
     *   are reserved.
     */
    ...
    /**
     * @param targetKey The ID of the key for which you are creating the alias. Specify the key's
     *   globally unique identifier or Amazon Resource Name (ARN). You can't specify another alias.
     */
