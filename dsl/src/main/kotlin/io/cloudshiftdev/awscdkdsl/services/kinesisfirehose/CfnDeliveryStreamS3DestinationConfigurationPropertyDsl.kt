...
public class CfnDeliveryStreamS3DestinationConfigurationPropertyDsl {
     ...
     *   the data that it delivers to the Amazon S3 bucket. For valid values, see the
     *   `CompressionFormat` content for the
     ...
     *   server-side encryption. Kinesis Data Firehose uses AWS Key Management Service ( AWS KMS) to
     *   encrypt the data that it delivers to your Amazon S3 bucket.
     */
     ...
     *   Amazon S3 bucket. The prefix helps you identify the files that Kinesis Data Firehose
     *   delivered.
     */
