 ...
 */
@CdkDslMarker
public class CfnAnalysisColorsConfigurationPropertyDsl {
    private val cdkBuilder: CfnAnalysis.ColorsConfigurationProperty.Builder =
    ...
    public fun build(): CfnAnalysis.ColorsConfigurationProperty {
