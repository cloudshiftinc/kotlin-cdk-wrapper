...
public class CfnScheduledQueryMixedMeasureMappingPropertyDsl {
    ...
    /**
     * @param measureValueType Type of the value that is to be read from sourceColumn. If the
    ...
    /**
     * @param multiMeasureAttributeMappings Required when measureValueType is MULTI. Attribute
    ...
    /**
     * @param targetMeasureName Target measure name to be used. If not provided, the target measure
     *   name by default would be measure-name if provided, or sourceColumn otherwise.
     */
