...
public class CfnComponentPropsDsl {
     ...
     *   runtime. You can't specify `tags` as a valid property for `bindingProperties` .
     */
    ...
    /**
     * @param componentType The type of the component. This can be an Amplify custom UI component or
    ...
    /**
     * @param events Describes the events that can be raised on the component. Use for the workflow
     ...
     *   instance of the component. You can't specify `tags` as a valid property for `overrides` .
     */
    ...
    /**
     * @param properties Describes the component's properties. You can't specify `tags` as a valid
    ...
    /**
     * @param variants A list of the component's variants. A variant is a unique style configuration
     *   of a main component.
     */
