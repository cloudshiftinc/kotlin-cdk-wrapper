 ...
 * target in response to actual workloads, so that resource utilization remains at or near the
...
public class CfnScalingPolicyTargetTrackingScalingPolicyConfigurationPropertyDsl {
    ...
    /**
     * @param customizedMetricSpecification A customized metric. You can specify either a predefined
    ...
    public fun customizedMetricSpecification(
        customizedMetricSpecification: CfnScalingPolicy.CustomizedMetricSpecificationProperty
    ) {
        cdkBuilder.customizedMetricSpecification(customizedMetricSpecification)
    }
     ...
     *   policy won't remove capacity from the scalable target. Otherwise, scale in is enabled and
    ...
    /**
     * @param predefinedMetricSpecification A predefined metric. You can specify either a predefined
     *   metric or a customized metric.
     */
    ...
    public fun predefinedMetricSpecification(
        predefinedMetricSpecification: CfnScalingPolicy.PredefinedMetricSpecificationProperty
    ) {
        cdkBuilder.predefinedMetricSpecification(predefinedMetricSpecification)
    }
     ...
     *   in the range of -2^360 to 2^360. The value must be a valid number based on the choice of
     *   metric. For example, if the metric is CPU utilization, then the target value is a percent
     *   value that represents how much of the CPU can be used before scaling out.
     */
