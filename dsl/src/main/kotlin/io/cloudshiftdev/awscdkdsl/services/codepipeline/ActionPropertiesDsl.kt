...
public class ActionPropertiesDsl {
     ...
     *   resources, this is inferred from the Stack `resource` is part of. However, some Actions,
     *   like the CloudFormation ones, are not backed by any resource, and they still might want to
     *   be cross-account. In general, a concrete Action class should specify either `resource`, or
    ...
    /**
     * @param category The category of the action. The category defines which action type the owner
     ...
     *   automatically handling Actions backed by resources from a different account and/or region.
     */
