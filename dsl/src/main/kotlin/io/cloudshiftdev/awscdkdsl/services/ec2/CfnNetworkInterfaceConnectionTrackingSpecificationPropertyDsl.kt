 ...
 */
@CdkDslMarker
public class CfnNetworkInterfaceConnectionTrackingSpecificationPropertyDsl {
    private val cdkBuilder: CfnNetworkInterface.ConnectionTrackingSpecificationProperty.Builder =
    ...
    public fun build(): CfnNetworkInterface.ConnectionTrackingSpecificationProperty =
        cdkBuilder.build()
}
