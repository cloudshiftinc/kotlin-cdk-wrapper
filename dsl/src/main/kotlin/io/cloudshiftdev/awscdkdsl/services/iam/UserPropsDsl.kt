...
public class UserPropsDsl {
    ...
    /**
     * @param groups Groups to add this user to. You can also use `addToGroup` to add this user to a
     *   group.
     */
     ...
     *   Management Console. You can use `SecretValue.unsafePlainText` to specify a password in
     *   plain text or use `secretsmanager.Secret.fromSecretAttributes` to reference a secret in
     *   Secrets Manager.
     */
     ...
     *   next time the user logs in to the AWS Management Console. If this is set to 'true', you
     *   must also specify "initialPassword".
     */
    ...
    /**
     * @param userName A name for the IAM user. For valid values, see the UserName parameter for the
     *   CreateUser action in the IAM API Reference. If you don't specify a name, AWS CloudFormation
     *   generates a unique physical ID and uses that ID for the user name.
     *
