 ...
 */
@CdkDslMarker
public class CfnDashboardKPIActualValueConditionalFormattingPropertyDsl {
    private val cdkBuilder: CfnDashboard.KPIActualValueConditionalFormattingProperty.Builder =
    ...
    public fun build(): CfnDashboard.KPIActualValueConditionalFormattingProperty =
        cdkBuilder.build()
}
