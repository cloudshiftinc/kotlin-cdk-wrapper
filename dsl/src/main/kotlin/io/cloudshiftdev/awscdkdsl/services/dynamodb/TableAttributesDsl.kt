...
public class TableAttributesDsl {
    ...
    /**
     * @param globalIndexes The name of the global indexes set for this Table. Note that you need to
     *   set either this property, or `localIndexes`, if you want methods like grantReadData() to
     *   grant permissions for indexes as well as the table itself.
     */
     ...
     *   indexes. If false is provided, grant methods grant the permissions only when
    ...
    /**
     * @param localIndexes The name of the local indexes set for this Table. Note that you need to
     *   set either this property, or `globalIndexes`, if you want methods like grantReadData() to
     *   grant permissions for indexes as well as the table itself.
     */
