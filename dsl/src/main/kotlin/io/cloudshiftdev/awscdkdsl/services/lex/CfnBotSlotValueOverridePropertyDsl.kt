...
public class CfnBotSlotValueOverridePropertyDsl {
     ...
     *   list of slot values. When the value is `Scalar` , it indicates that the `value` field
    ...
    /**
     * @param values A list of one or more values that the user provided for the slot. For example,
     *   for a slot that elicits pizza toppings, the values might be "pepperoni" and "pineapple."
     */
