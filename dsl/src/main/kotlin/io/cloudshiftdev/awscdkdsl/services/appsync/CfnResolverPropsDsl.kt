...
public class CfnResolverPropsDsl {
    ...
    /**
     * @param requestMappingTemplate The request mapping template. Request mapping templates are
     *   optional when using a Lambda data source. For all other data sources, a request mapping
