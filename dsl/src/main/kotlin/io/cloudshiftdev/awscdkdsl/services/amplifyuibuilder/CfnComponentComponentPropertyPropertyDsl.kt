...
public class CfnComponentComponentPropertyPropertyDsl {
    ...
    public fun bindingProperties(
        bindingProperties: CfnComponent.ComponentPropertyBindingPropertiesProperty
    ) {
        cdkBuilder.bindingProperties(bindingProperties)
    }
    ...
    public fun collectionBindingProperties(
        collectionBindingProperties: CfnComponent.ComponentPropertyBindingPropertiesProperty
    ) {
        cdkBuilder.collectionBindingProperties(collectionBindingProperties)
    }
