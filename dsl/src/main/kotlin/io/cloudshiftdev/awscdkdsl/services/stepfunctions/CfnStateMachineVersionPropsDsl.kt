...
public class CfnStateMachineVersionPropsDsl {
     ...
     *   read-only snapshot of a state machine’s definition and configuration. Only publish the
     *   state machine version if the current state machine's revision ID matches the specified ID.
     *   Use this option to avoid publishing a version if the state machine has changed since you
     *   last updated it.
     *
