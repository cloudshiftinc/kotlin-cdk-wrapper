 ...
 */
@CdkDslMarker
public class CfnTemplateGeospatialMapVisualPropertyDsl {
    private val cdkBuilder: CfnTemplate.GeospatialMapVisualProperty.Builder =
    ...
    public fun chartConfiguration(
        chartConfiguration: CfnTemplate.GeospatialMapConfigurationProperty
    ) {
        cdkBuilder.chartConfiguration(chartConfiguration)
    }
    ...
    public fun build(): CfnTemplate.GeospatialMapVisualProperty {
