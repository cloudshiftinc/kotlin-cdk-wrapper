...
public class CfnInstanceEbsBlockDevicePropertyDsl {
    ...
    /**
     * @param iops The number of I/O operations per second (IOPS) that the volume supports. For more
     *   information, see
     *   [EbsBlockDevice](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_EbsBlockDevice.html)
     *   .
     */
     ...
     *   Provisioned IOPS (SSD) volumes, `st1` for Throughput Optimized hard disk drives (HDD),
     ...
     * default volume size (in GiB) specified in the AMI attributes to set IOPS to 50 x (volume
     * size).
     */
