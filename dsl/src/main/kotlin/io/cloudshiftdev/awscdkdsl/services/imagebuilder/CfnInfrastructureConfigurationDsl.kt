 ...
 * used to build your image. This allows you to log on to your instance to troubleshoot if your
 * build fails and you set terminateInstanceOnFailure to false.
 *
 * Example:
 * ```
