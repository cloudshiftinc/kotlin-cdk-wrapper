...
public class CfnApplicationPropsDsl {
    ...
    /**
     * @param displayName The display name of the application. This name is visible to users in the
     *   application catalog.
     */
    ...
    /**
     * @param instanceFamilies The instance families the application supports. *Allowed Values* :
    ...
    /**
     * @param name The name of the application. This name is visible to users when a name is not
     *   specified in the DisplayName property.
     *
    ...
    /**
     * @param platforms The platforms the application supports. *Allowed Values* :
