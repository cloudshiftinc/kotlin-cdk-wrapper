...
public class CfnModelQualityJobDefinitionBatchTransformInputPropertyDsl {
    ...
    /**
     * @param endTimeOffset If specified, monitoring jobs subtract this time from the end time. For
    ...
    public fun build(): CfnModelQualityJobDefinition.BatchTransformInputProperty =
        cdkBuilder.build()
}
