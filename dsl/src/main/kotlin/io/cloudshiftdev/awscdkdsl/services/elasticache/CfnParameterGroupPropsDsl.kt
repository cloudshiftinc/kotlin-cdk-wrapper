...
public class CfnParameterGroupPropsDsl {
     ...
     *   parameter group is compatible with. Valid values are: `memcached1.4` | `memcached1.5` |
    ...
    /**
     * @param properties A comma-delimited list of parameter name/value pairs. For example:
     * ```
    ...
    /**
     * @param tags A tag that can be added to an ElastiCache parameter group. Tags are composed of a
     *   Key/Value pair. You can use tags to categorize and track all your parameter groups. A tag
