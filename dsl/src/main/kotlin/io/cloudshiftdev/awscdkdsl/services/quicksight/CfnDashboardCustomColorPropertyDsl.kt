 ...
 */
@CdkDslMarker
public class CfnDashboardCustomColorPropertyDsl {
    private val cdkBuilder: CfnDashboard.CustomColorProperty.Builder =
    ...
    public fun build(): CfnDashboard.CustomColorProperty = cdkBuilder.build()
}
