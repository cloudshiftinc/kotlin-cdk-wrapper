...
public class CfnObjectTypeObjectTypeKeyPropertyDsl {
     ...
     *   ProfileObject can have only 1 UNIQUE key but multiple PROFILE keys. PROFILE means that this
     *   key can be used to tie an object to a PROFILE. UNIQUE means that it can be used to uniquely
     *   identify an object. If a key a is marked as SECONDARY, it will be used to search for
