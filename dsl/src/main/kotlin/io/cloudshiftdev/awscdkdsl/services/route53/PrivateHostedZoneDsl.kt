 ...
 *
 * Note that `enableDnsHostnames` and `enableDnsSupport` must have been enabled for the VPC you're
 * configuring for private hosted zones.
 *
 * Example:
 * ```
 * Vpc vpc;
...
public class PrivateHostedZoneDsl(
     ...
     *
     * Private hosted zones must be associated with at least one VPC. You can associated additional
     * VPCs using `addVpc(vpc)`.
     *
