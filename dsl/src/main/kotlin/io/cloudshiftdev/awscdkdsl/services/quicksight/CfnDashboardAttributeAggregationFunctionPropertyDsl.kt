 ...
 */
@CdkDslMarker
public class CfnDashboardAttributeAggregationFunctionPropertyDsl {
    private val cdkBuilder: CfnDashboard.AttributeAggregationFunctionProperty.Builder =
    ...
    public fun build(): CfnDashboard.AttributeAggregationFunctionProperty = cdkBuilder.build()
}
