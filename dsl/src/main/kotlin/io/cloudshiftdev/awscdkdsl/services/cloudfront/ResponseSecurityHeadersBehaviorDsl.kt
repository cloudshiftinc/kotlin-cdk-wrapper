...
public class ResponseSecurityHeadersBehaviorDsl {
    ...
    public fun contentSecurityPolicy(
        contentSecurityPolicy: ResponseHeadersContentSecurityPolicyDsl.() -> Unit = {}
    ) {
    ...
    public fun contentTypeOptions(
        contentTypeOptions: ResponseHeadersContentTypeOptionsDsl.() -> Unit = {}
    ) {
    ...
    public fun strictTransportSecurity(
        strictTransportSecurity: ResponseHeadersStrictTransportSecurityDsl.() -> Unit = {}
    ) {
