...
public class CfnLaunchTemplateCpuOptionsPropertyDsl {
    ...
    /**
     * @param amdSevSnp Indicates whether to enable the instance for AMD SEV-SNP. AMD SEV-SNP is
    ...
    /**
     * @param threadsPerCore The number of threads per CPU core. To disable multithreading for the
