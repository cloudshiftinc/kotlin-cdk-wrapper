...
public class CfnVirtualNodeAwsCloudMapInstanceAttributePropertyDsl {
    ...
    /**
     * @param key The name of an AWS Cloud Map service instance attribute key. Any AWS Cloud Map
    ...
    /**
     * @param value The value of an AWS Cloud Map service instance attribute key. Any AWS Cloud Map
     *   service instance that contains the specified key and value is returned.
     */
