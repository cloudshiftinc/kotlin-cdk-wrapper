...
public class CfnVPCEndpointServicePropsDsl {
    private val cdkBuilder: CfnVPCEndpointServiceProps.Builder =
    ...
    /**
     * @param payerResponsibility The entity that is responsible for the endpoint costs. The default
     *   is the endpoint owner. If you set the payer responsibility to the service owner, you cannot
     *   set it back to the endpoint owner.
     */
