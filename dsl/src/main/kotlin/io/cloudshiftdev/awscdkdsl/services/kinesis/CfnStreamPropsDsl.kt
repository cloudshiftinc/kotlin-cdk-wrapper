...
public class CfnStreamPropsDsl {
    ...
    /**
     * @param name The name of the Kinesis stream. If you don't specify a name, AWS CloudFormation
     *   generates a unique physical ID and uses that ID for the stream name. For more information,
     *   see
     ...
     *   shards to remain accessible. The default value is 24. For more information about the stream
    ...
    /**
     * @param shardCount The number of shards that the stream uses. For greater provisioned
     ...
     *   AWS KMS key for a specified stream. Removing this property from your stack template and
