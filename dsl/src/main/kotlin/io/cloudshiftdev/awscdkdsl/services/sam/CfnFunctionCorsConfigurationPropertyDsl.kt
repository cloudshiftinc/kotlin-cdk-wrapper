 ...
 */
@CdkDslMarker
public class CfnFunctionCorsConfigurationPropertyDsl {
    private val cdkBuilder: CfnFunction.CorsConfigurationProperty.Builder =
    ...
    public fun build(): CfnFunction.CorsConfigurationProperty = cdkBuilder.build()
}
