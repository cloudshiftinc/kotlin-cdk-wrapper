...
public class CfnJobTemplatePropsDsl {
     ...
     *   information about feature limitations, For more information, see
    ...
    public fun accelerationSettings(
        accelerationSettings: CfnJobTemplate.AccelerationSettingsProperty
    ) {
        cdkBuilder.accelerationSettings(accelerationSettings)
    }
    ...
    /**
     * @param hopDestinations Optional. Configuration for a destination queue to which the job can
     *   hop once a customer-defined minimum wait time has passed. For more information, see
    ...
    /**
     * @param priority Specify the relative priority for this job. In any given queue, the service
     ...
     *   specify a priority, the service uses the default value 0. Minimum: -50 Maximum: 50
     */
    ...
    /**
     * @param queue Optional. The queue that jobs created from this template are assigned to.
     *   Specify the Amazon Resource Name (ARN) of the queue. For example,
     *   arn:aws:mediaconvert:us-west-2:505474453218:queues/Default. If you don't specify this, jobs
     ...
     *   template. This specification must conform to the AWS Elemental MediaConvert job validation.
