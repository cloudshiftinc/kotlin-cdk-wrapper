...
public class CfnDataSourcePropsDsl {
     ...
     *   source. You can't specify the `RoleArn` parameter when the `Type` parameter is set to
     *   `CUSTOM` .
     *
     ...
     *   source and updates the index. If you don't set a schedule, Amazon Kendra doesn't
