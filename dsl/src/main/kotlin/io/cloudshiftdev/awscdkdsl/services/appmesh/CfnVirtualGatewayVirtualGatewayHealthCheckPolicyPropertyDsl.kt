...
public class CfnVirtualGatewayVirtualGatewayHealthCheckPolicyPropertyDsl {
    ...
    /**
     * @param path The destination path for the health check request. This value is only used if the
    ...
    /**
     * @param port The destination port for the health check request. This port must match the port
    ...
    /**
     * @param protocol The protocol for the health check request. If you specify `grpc` , then your
     *   service must conform to the
    ...
    public fun build(): CfnVirtualGateway.VirtualGatewayHealthCheckPolicyProperty =
        cdkBuilder.build()
}
