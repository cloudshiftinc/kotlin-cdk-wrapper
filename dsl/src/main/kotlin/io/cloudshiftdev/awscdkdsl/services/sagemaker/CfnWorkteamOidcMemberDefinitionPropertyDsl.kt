 ...
 * the list of `Groups` , you can add that user group to one or more private work teams. If you add
 * a user group to a private work team, all workers in that user group are added to the work team.
 *
 * Example:
 * ```
