 ...
 * spec, key usage, key material origin, and automatic key rotation status. These properties are
 ...
 * keys in all Regions that support multi-Region KMS keys. For details, see
