...
import io.cloudshiftdev.awscdkdsl.services.events.targets.TagDsl
...
public class ScheduledFargateTaskPropsDsl {
     ...
     *   TaskDefinition in this construct. ScheduledFargateTaskDefinitionOptions or
     *   ScheduledFargateTaskImageOptions must be defined, but not both.
     */
    public fun scheduledFargateTaskDefinitionOptions(
        scheduledFargateTaskDefinitionOptions: ScheduledFargateTaskDefinitionOptionsDsl.() -> Unit =
            {}
    ) {
     ...
     *   create a TaskDefinition. ScheduledFargateTaskDefinitionOptions or
     *   ScheduledFargateTaskImageOptions must be defined, but not both.
     */
    public fun scheduledFargateTaskImageOptions(
        scheduledFargateTaskImageOptions: ScheduledFargateTaskImageOptionsDsl.() -> Unit = {}
    ) {
