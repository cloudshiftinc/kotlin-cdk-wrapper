 ...
 * a property value for this resource in the AWS CloudFormation template. Changing the Amazon S3
 * file content without changing a property value will not result in an update operation.
 *
 * See
