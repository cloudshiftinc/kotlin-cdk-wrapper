...
public class CfnKeyPropsDsl {
    ...
    /**
     * @param keyPolicy The key policy to attach to the KMS key. If you provide a key policy, it
     ...
     *   after you create the KMS key. The default is `AWS_KMS` , which means that AWS KMS creates
     *   the key material.
     *
     * To
