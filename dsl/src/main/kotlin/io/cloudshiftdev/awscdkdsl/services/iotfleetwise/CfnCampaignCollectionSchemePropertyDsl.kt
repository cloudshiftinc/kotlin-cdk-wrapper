...
public class CfnCampaignCollectionSchemePropertyDsl {
    ...
    public fun conditionBasedCollectionScheme(
        conditionBasedCollectionScheme: CfnCampaign.ConditionBasedCollectionSchemeProperty
    ) {
        cdkBuilder.conditionBasedCollectionScheme(conditionBasedCollectionScheme)
    }
    ...
    public fun timeBasedCollectionScheme(
        timeBasedCollectionScheme: CfnCampaign.TimeBasedCollectionSchemeProperty
    ) {
        cdkBuilder.timeBasedCollectionScheme(timeBasedCollectionScheme)
    }
