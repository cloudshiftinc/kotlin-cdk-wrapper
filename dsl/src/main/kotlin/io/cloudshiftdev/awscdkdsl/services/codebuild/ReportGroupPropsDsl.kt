...
public class ReportGroupPropsDsl {
    ...
    /**
     * @param removalPolicy What to do when this resource is deleted from a stack. As CodeBuild does
     *   not allow deleting a ResourceGroup that has reports inside of it, this is set to retain the
     *   resource by default.
     */
     ...
     *   ZIP from them before doing the export. Ignored if `exportBucket` has not been provided.
     */
