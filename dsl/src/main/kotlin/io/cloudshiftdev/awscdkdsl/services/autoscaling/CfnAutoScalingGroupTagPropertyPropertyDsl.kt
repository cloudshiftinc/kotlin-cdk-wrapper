...
public class CfnAutoScalingGroupTagPropertyPropertyDsl {
     ...
     *   instances that are launched as part of the Auto Scaling group. Set to `false` if you want
     *   the tag attached only to the Auto Scaling group and not copied to any instances launched as
