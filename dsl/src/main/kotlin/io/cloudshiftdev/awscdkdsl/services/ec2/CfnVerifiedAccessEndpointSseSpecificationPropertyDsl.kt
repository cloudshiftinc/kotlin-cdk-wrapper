 ...
 */
@CdkDslMarker
public class CfnVerifiedAccessEndpointSseSpecificationPropertyDsl {
    private val cdkBuilder: CfnVerifiedAccessEndpoint.SseSpecificationProperty.Builder =
    ...
    public fun build(): CfnVerifiedAccessEndpoint.SseSpecificationProperty = cdkBuilder.build()
}
