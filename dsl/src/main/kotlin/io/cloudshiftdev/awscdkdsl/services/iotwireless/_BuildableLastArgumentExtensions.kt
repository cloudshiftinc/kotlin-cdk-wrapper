...
public inline fun CfnPartnerAccount.setSidewalk(
...
public inline fun CfnServiceProfile.setLoRaWan(
...
public inline fun CfnTaskDefinition.setUpdate(
...
public inline fun CfnWirelessDevice.setLoRaWan(
