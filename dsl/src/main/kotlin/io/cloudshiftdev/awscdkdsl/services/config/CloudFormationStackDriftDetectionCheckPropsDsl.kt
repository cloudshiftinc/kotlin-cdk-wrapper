...
public class CloudFormationStackDriftDetectionCheckPropsDsl {
    ...
    /**
     * @param role The IAM role to use for this rule. It must have permissions to detect drift for
     *   AWS CloudFormation stacks. Ensure to attach `config.amazonaws.com` trusted permissions and
     *   `ReadOnlyAccess` policy permissions. For specific policy permissions, refer to
