 ...
 *
 * The rule groups evaluates the responses that your protected resources send back to client login
 * and account creation attempts, keeping count of successful and failed attempts from each IP
 * address and client session. Using this information, the rule group labels and mitigates requests
 * from client sessions and IP addresses with too much suspicious activity in a short amount of
 * time.
 *
