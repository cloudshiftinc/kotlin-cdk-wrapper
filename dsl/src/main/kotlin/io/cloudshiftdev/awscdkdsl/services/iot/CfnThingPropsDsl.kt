...
public class CfnThingPropsDsl {
    ...
    /**
     * @param attributePayload A string that contains up to three key value pairs. Maximum length
    ...
    /**
     * @param thingName The name of the thing to update. You can't change a thing's name. To change
