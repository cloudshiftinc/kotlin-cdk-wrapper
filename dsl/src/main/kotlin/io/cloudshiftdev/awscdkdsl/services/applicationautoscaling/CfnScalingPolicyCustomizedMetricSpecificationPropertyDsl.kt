 ...
 *   of the metric should decrease when capacity increases, and increase when capacity decreases.
 *
 * For an example of how creating new metrics can be useful, see
 * [Scaling based on Amazon SQS](https://docs.aws.amazon.com/autoscaling/ec2/userguide/as-using-sqs-queue.html)
 * in the *Amazon EC2 Auto Scaling User Guide* . This topic mentions Auto Scaling groups, but the
 * same scenario for Amazon SQS can apply to the target tracking scaling policies that you create
 * for a Spot Fleet by using Application Auto Scaling.
 *
...
public class CfnScalingPolicyCustomizedMetricSpecificationPropertyDsl {
    ...
    /**
     * @param metricName The name of the metric. To get the exact metric name, namespace, and
