...
public class CfnCertificateSubjectPropertyDsl {
     ...
     *   can be any string within the length limit. Note: In publicly trusted certificates, the
     *   common name must be a fully qualified domain name (FQDN) associated with the certificate
     *   subject.
     */
     ...
     *   Jonathan is often shortened to John. Elizabeth is often shortened to Beth, Liz, or Eliza.
     */
    ...
    /**
     * @param surname Family name. In the US and the UK, for example, the surname of an individual
    ...
    /**
     * @param title A title such as Mr. or Ms., which is pre-pended to the name to refer formally to
