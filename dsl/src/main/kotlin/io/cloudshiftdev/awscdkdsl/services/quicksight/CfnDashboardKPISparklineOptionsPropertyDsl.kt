 ...
 */
@CdkDslMarker
public class CfnDashboardKPISparklineOptionsPropertyDsl {
    private val cdkBuilder: CfnDashboard.KPISparklineOptionsProperty.Builder =
    ...
    public fun build(): CfnDashboard.KPISparklineOptionsProperty = cdkBuilder.build()
}
