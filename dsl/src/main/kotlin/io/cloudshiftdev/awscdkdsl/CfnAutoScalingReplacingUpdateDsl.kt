 ...
 * update.
 *
 * During replacement, AWS CloudFormation retains the old group until it finishes creating the new
 * one. If the update fails, AWS CloudFormation can roll back to the old Auto Scaling group and
 * delete the new Auto Scaling group.
 *
