...
public class CfnSkillSkillPackagePropertyDsl {
     ...
     *   This property is optional. If you do not provide it, the bucket must be publicly accessible
     *   or configured with a policy that allows this access. Otherwise, AWS CloudFormation cannot
     *   create the skill.
     */
