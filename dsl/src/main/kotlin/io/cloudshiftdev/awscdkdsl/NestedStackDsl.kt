 ...
 * modified nested stacks, but does not update the resources of unmodified nested stacks.
 *
...
public class NestedStackDsl(
     ...
     *
     * The default is `Destroy`, because all Removal Policies of resources inside the Nested Stack
     * should already have been set correctly. You normally should not need to set this value.
     *
     ...
     *
     * When CloudFormation detects that the nested stack has reached the CREATE_COMPLETE state, it
     * marks the nested stack resource as CREATE_COMPLETE in the parent stack and resumes creating
     * the parent stack. If the timeout period expires before the nested stack reaches
