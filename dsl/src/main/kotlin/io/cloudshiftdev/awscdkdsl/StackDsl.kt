...
public class StackDsl(
     ...
     *
     * Set the `region`/`account` fields of `env` to either a concrete value to select the indicated
     ...
     *
     * Default: - The environment of the containing `Stage` if available, otherwise create the stack
     * will be environment-agnostic.
     *
     * Example:
     * ```
     ...
     *
     * If not specified, the value of the `&#64;aws-cdk/core:suppressTemplateIndentation` context
     * key will be used. If that is not specified, then the default value `false` will be used.
     *
