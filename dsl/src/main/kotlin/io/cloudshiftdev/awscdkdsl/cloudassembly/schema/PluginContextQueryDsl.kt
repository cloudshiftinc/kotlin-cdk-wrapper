 ...
 *
 * This alternate branch is necessary because it needs to be able to escape all type checking we do
 * on on the cloud assembly -- we cannot know the properties that will be used a priori.
 *
 * Example:
 * ```
