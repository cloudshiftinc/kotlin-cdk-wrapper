...
public class FileAssetSourceDsl {
    ...
    /**
     * @param sourceHash A hash on the content source. This hash is used to uniquely identify this
     *   asset throughout the system. If this value doesn't change, the asset will not be rebuilt or
     *   republished.
     */
