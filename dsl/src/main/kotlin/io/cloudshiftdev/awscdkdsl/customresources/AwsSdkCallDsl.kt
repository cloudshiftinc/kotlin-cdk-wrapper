...
public class AwsSdkCallDsl {
     ...
     *   property of the `Error` object will be tested against this pattern. If there is a match an
     ...
     *   API response. Use this to limit the data returned by the custom resource if working with
     *   API calls that could potentially result in custom response objects exceeding the hard limit
     *   of 4096 bytes.
     *
