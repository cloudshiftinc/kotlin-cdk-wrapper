...
public class CodeBuildStepPropsDsl {
    ...
    /**
     * @param additionalInputs Additional FileSets to put in other directories. Specifies a mapping
     *   from directory name to FileSets. During the script execution, the FileSets will be
     *   available in the directories indicated.
     *
    ...
    /**
     * @param buildEnvironment Changes to environment. This environment will be combined with the
     *   pipeline's default environment.
     */
    ...
    /**
     * @param envFromCfnOutputs Set environment variables based on Stack Outputs. `ShellStep`s
     *   following stack or stage deployments may access the `CfnOutput`s of those stacks to get
     *   access to --for example--automatically generated resource names or endpoint URLs.
     */
    ...
    /**
     * @param input FileSet to run these scripts on. The files in the FileSet will be placed in the
     *   working directory when the script is executed. Use `additionalInputs` to download file sets
    ...
    /**
     * @param installCommands Installation commands to run before the regular commands. For
     *   deployment engines that support it, install commands will be classified differently in the
     *   job history from the regular `commands`.
     */
     ...
     *   After running the script, the contents of the given directory will be treated as the
     *   primary output of this Step.
     */
    ...
    /**
     * @param rolePolicyStatements Policy statements to add to role used during the synth. Can be
     *   used to add acces to a CodeArtifact repository etc.
     */
