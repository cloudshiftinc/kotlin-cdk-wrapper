...
public class TagPropsDsl {
    ...
    /**
     * @param includeResourceTypes An array of Resource Types that will receive this tag. An empty
     *   array will match any Resource. A non-empty array will apply this tag only to Resource types
