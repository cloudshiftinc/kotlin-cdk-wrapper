...
internal constructor(
     ...
     * @param key2
     * @param defaultValue
     * @return A reference to a value in the map based on the two keys. If mapping is lazy, the
     *   value from the map or default value is returned instead of the reference and the mapping is
     *   not rendered in the template.
     */
    public open fun findInMap(key1: String, key2: String): String =
        unwrap(this).findInMap(key1, key2)
    ...
    public interface Builder {
         ...
         * uses the region name as a key and contains the values you want to specify for each
         * specific region.
         *
         * Default: - No mapping.
         *
    ...
    public companion object {
        ...
        internal fun unwrap(wrapped: CfnMapping): software.amazon.awscdk.CfnMapping =
            wrapped.cdkObject
    }
}
