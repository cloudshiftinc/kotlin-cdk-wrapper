...
internal constructor(
     ...
     *
     * Looks at the include and exclude resourceTypeName arrays to determine if the aspect applies
     * here
     *
     * @param include
     * @param exclude
     ...
     *
     * This method will eagerly render the tags currently applied. In most cases, you should be
     * using `tagManager.renderedTags` instead, which will return a `Lazy` value that will resolve
     * to the correct tags at synthesis time.
     *
     ...
     *
     * If you need to make a custom construct taggable, use the value of this property to pass to
     * the `tags` property of the underlying construct.
     */
     ...
     *
     * Normally this is `tags` but some resources choose a different name. Cognito UserPool uses
     * UserPoolTags
     */
    ...
    public companion object {
        ...
        internal fun unwrap(wrapped: TagManager): software.amazon.awscdk.TagManager =
            wrapped.cdkObject
    }
}
