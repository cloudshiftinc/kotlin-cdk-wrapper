...
public interface FileAssetSource {
     ...
     *
     * This hash is used to uniquely identify this asset throughout the system. If this value
     * doesn't change, the asset will not be rebuilt or republished.
     */
    ...
    public interface Builder {
         ...
         *   should produce the location of a ZIP file on `stdout`.
         */
         ...
         *   source resides. This can be a path to a file or a directory, depending on the packaging
         *   type.
         */
        ...
        /**
         * @param sourceHash A hash on the content source. This hash is used to uniquely identify
         *   this asset throughout the system. If this value doesn't change, the asset will not be
    ...
    public companion object {
        ...
        internal fun unwrap(wrapped: FileAssetSource): software.amazon.awscdk.FileAssetSource =
