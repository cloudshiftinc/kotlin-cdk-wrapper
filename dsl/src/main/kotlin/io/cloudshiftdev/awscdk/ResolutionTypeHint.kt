...
public enum class ResolutionTypeHint(
    ...
    public companion object {
        internal fun wrap(
            cdkObject: software.amazon.awscdk.ResolutionTypeHint
        ): ResolutionTypeHint =
            when (cdkObject) {
                ...
                software.amazon.awscdk.ResolutionTypeHint.STRING_LIST ->
                    ResolutionTypeHint.STRING_LIST
            }

        internal fun unwrap(
            wrapped: ResolutionTypeHint
        ): software.amazon.awscdk.ResolutionTypeHint = wrapped.cdkObject
    }
}
