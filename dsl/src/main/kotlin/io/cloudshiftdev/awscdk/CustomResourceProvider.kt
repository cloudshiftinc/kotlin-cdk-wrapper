...
internal constructor(
    ...
    public companion object {
        public fun orCreate(
            ...
            software.amazon.awscdk.CustomResourceProvider.getOrCreate(
                scope.let(Construct::unwrap),
                uniqueid,
                props.let(CustomResourceProviderProps::unwrap)
            )
        ...
        public fun orCreateProvider(
            ...
            software.amazon.awscdk.CustomResourceProvider.getOrCreateProvider(
                    scope.let(Construct::unwrap),
                    uniqueid,
                    props.let(CustomResourceProviderProps::unwrap)
                )
                .let(CustomResourceProvider::wrap)
        ...
        public fun orCreateProvider(
            ...
            orCreateProvider(scope, uniqueid, CustomResourceProviderProps(props))
        ...
        internal fun unwrap(
            wrapped: CustomResourceProvider
