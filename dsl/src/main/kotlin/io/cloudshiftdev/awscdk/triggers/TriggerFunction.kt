...
internal constructor(
    ...
    public interface Builder {
        ...
        /**
         * Adds trigger dependencies. Execute this trigger only after these construct scopes have
         * been provisioned.
         *
         ...
         *
         * This implies that the trigger is associated with the `currentVersion` of the handler,
         * which gets recreated every time the handler or its configuration is updated.
         *
         * Default: true
         *
    ...
    public companion object {
        ...
        ): TriggerFunction = TriggerFunction(cdkObject)

        internal fun unwrap(
            wrapped: TriggerFunction
        ): software.amazon.awscdk.triggers.TriggerFunction = wrapped.cdkObject
    }
}
