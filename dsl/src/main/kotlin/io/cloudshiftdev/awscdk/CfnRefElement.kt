...
internal constructor(
     ...
     *
     * If, by any chance, the intrinsic reference of a resource is not a string, you could coerce it
     * to an IResolvable through `Lazy.any({ produce: resource.ref })`.
     */
    ...
    public companion object {
        ...
        internal fun unwrap(wrapped: CfnRefElement): software.amazon.awscdk.CfnRefElement =
