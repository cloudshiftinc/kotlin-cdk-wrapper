...
public interface CfnUpdatePolicy {
    ...
    public interface Builder {
        /**
         * @param autoScalingReplacingUpdate Specifies whether an Auto Scaling group and the
         *   instances it contains are replaced during an update. During replacement, AWS
         *   CloudFormation retains the old group until it finishes creating the new one. If the
         *   update fails, AWS CloudFormation can roll back to the old Auto Scaling group and delete
         *   the new Auto Scaling group.
         */
        public fun autoScalingReplacingUpdate(
        ...
        public fun autoScalingReplacingUpdate(
            autoScalingReplacingUpdate: CfnAutoScalingReplacingUpdate.Builder.() -> Unit
        )

        /**
         * @param autoScalingRollingUpdate To specify how AWS CloudFormation handles rolling updates
         *   for an Auto Scaling group, use the AutoScalingRollingUpdate policy. Rolling updates
         *   enable you to specify whether AWS CloudFormation updates instances that are in an Auto
        ...
        public fun autoScalingRollingUpdate(
            autoScalingRollingUpdate: CfnAutoScalingRollingUpdate.Builder.() -> Unit
        )

        /**
         * @param autoScalingScheduledAction To specify how AWS CloudFormation handles updates for
         *   the MinSize, MaxSize, and DesiredCapacity properties when the
         *   AWS::AutoScaling::AutoScalingGroup resource has an associated scheduled action, use the
         *   AutoScalingScheduledAction policy.
         */
        public fun autoScalingScheduledAction(
        ...
        public fun autoScalingScheduledAction(
            autoScalingScheduledAction: CfnAutoScalingScheduledAction.Builder.() -> Unit
        )

        /**
         * @param codeDeployLambdaAliasUpdate To perform an AWS CodeDeploy deployment when the
         *   version changes on an AWS::Lambda::Alias resource, use the CodeDeployLambdaAliasUpdate
         *   update policy.
         */
        public fun codeDeployLambdaAliasUpdate(
        ...
        public fun codeDeployLambdaAliasUpdate(
            codeDeployLambdaAliasUpdate: CfnCodeDeployLambdaAliasUpdate.Builder.() -> Unit
        )

        /**
         * @param enableVersionUpgrade To upgrade an Amazon ES domain to a new version of
         *   Elasticsearch rather than replacing the entire AWS::Elasticsearch::Domain resource, use
         ...
         *   shards, rather than replacing the entire AWS::ElastiCache::ReplicationGroup resource,
    ...
    private class BuilderImpl : Builder {
         ...
         *   the new Auto Scaling group.
         */
        override fun autoScalingReplacingUpdate(
            autoScalingReplacingUpdate: CfnAutoScalingReplacingUpdate
        ) {
            cdkBuilder.autoScalingReplacingUpdate(
                autoScalingReplacingUpdate.let(CfnAutoScalingReplacingUpdate::unwrap)
            )
        }
        ...
        override fun autoScalingReplacingUpdate(
            ...
            autoScalingReplacingUpdate(CfnAutoScalingReplacingUpdate(autoScalingReplacingUpdate))
         ...
         *   Scaling group in batches or all at once.
         */
        override fun autoScalingRollingUpdate(
            autoScalingRollingUpdate: CfnAutoScalingRollingUpdate
        ) {
            cdkBuilder.autoScalingRollingUpdate(
                autoScalingRollingUpdate.let(CfnAutoScalingRollingUpdate::unwrap)
            )
        }
         ...
         *   AutoScalingScheduledAction policy.
         */
        override fun autoScalingScheduledAction(
            autoScalingScheduledAction: CfnAutoScalingScheduledAction
        ) {
            cdkBuilder.autoScalingScheduledAction(
                autoScalingScheduledAction.let(CfnAutoScalingScheduledAction::unwrap)
            )
        }
        ...
        override fun autoScalingScheduledAction(
            ...
            autoScalingScheduledAction(CfnAutoScalingScheduledAction(autoScalingScheduledAction))
         ...
         *   update policy.
         */
        override fun codeDeployLambdaAliasUpdate(
            codeDeployLambdaAliasUpdate: CfnCodeDeployLambdaAliasUpdate
        ) {
            cdkBuilder.codeDeployLambdaAliasUpdate(
                codeDeployLambdaAliasUpdate.let(CfnCodeDeployLambdaAliasUpdate::unwrap)
            )
        }
    ...
    internal constructor(
         ...
         * an update.
         *
         * During replacement, AWS CloudFormation retains the old group until it finishes creating
         * the new one. If the update fails, AWS CloudFormation can roll back to the old Auto
         * Scaling group and delete the new Auto Scaling group.
         */
         ...
         * the AutoScalingRollingUpdate policy.
         *
        ...
        /**
         * To upgrade an Amazon ES domain to a new version of Elasticsearch rather than replacing
         * the entire AWS::Elasticsearch::Domain resource, use the EnableVersionUpgrade update
         * policy.
         */
    ...
    public companion object {
        ...
        internal fun unwrap(wrapped: CfnUpdatePolicy): software.amazon.awscdk.CfnUpdatePolicy =
