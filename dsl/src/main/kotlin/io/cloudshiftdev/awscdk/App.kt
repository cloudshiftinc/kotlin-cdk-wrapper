...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param analyticsReporting Include runtime versioning information in the Stacks of this
         *   app.
         */
         ...
         *
         * If you set this, you don't have to call `synth()` explicitly. Note that this feature is
         * only available for certain programming languages, and calling `synth()` is still
         * recommended.
         *
         ...
         *
         * @param defaultStackSynthesizer The stack synthesizer to use by default for all Stacks in
         *   the App.
         */
         ...
         * `--output` flag will be used, and if you change it to a different directory the CLI will
         * fail to pick up the generated Cloud Assembly.
         *
         ...
         *
         * This property is recommended over the `AppProps.context` property since you can make
         * final decision over which context value to take in your app.
         *
         * Context can be read from any construct using `node.getContext(key)`.
         *
         * Default: - no additional context
        ...
        /**
         * Include construct creation stack trace in the `aws:cdk:trace` metadata key of all
         * constructs.
         *
         * Default: true stack traces are included unless `aws:cdk:disable-stack-trace` is set in
         * the context.
         *
         * @param stackTraces Include construct creation stack trace in the `aws:cdk:trace` metadata
         *   key of all constructs.
         */
    ...
    private class BuilderImpl : Builder {
        ...
        override fun defaultStackSynthesizer(defaultStackSynthesizer: IReusableStackSynthesizer) {
            cdkBuilder.defaultStackSynthesizer(
                defaultStackSynthesizer.let(IReusableStackSynthesizer::unwrap)
            )
        }
