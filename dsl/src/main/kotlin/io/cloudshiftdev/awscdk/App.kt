...
public open class App internal constructor(
  ...
  private class BuilderImpl : Builder {
    ...
    public override fun autoSynth(autoSynth: Boolean) {
      cdkBuilder.autoSynth(autoSynth)
    }

    public override fun context(context: Map<String, Any>) {
      cdkBuilder.context(context)
    }

    public override
        fun defaultStackSynthesizer(defaultStackSynthesizer: IReusableStackSynthesizer) {
    ...
    public override fun postCliContext(postCliContext: Map<String, Any>) {
      cdkBuilder.postCliContext(postCliContext)
    }

    public override fun stackTraces(stackTraces: Boolean) {
      cdkBuilder.stackTraces(stackTraces)
    }

    public override fun treeMetadata(treeMetadata: Boolean) {
