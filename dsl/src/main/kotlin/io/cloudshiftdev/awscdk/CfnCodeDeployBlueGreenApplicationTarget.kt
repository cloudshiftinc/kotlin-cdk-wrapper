...
public interface CfnCodeDeployBlueGreenApplicationTarget {
    ...
    public interface Builder {
        ...
        /**
         * @param type The resource type of the target being deployed. Right now, the only allowed
         *   value is 'AWS::ECS::Service'.
         */
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnCodeDeployBlueGreenApplicationTarget
