...
public enum class DockerVolumeConsistency(
  ...
  public companion object {
    internal fun wrap(cdkObject: software.amazon.awscdk.DockerVolumeConsistency):
        DockerVolumeConsistency = when (cdkObject) {
      software.amazon.awscdk.DockerVolumeConsistency.CONSISTENT ->
          DockerVolumeConsistency.CONSISTENT
      software.amazon.awscdk.DockerVolumeConsistency.DELEGATED -> DockerVolumeConsistency.DELEGATED
      software.amazon.awscdk.DockerVolumeConsistency.CACHED -> DockerVolumeConsistency.CACHED
    }

    internal fun unwrap(wrapped: DockerVolumeConsistency):
