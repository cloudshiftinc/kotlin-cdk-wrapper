...
public interface CfnTrafficRoutingTimeBasedCanary {
    ...
    public interface Builder {
        /**
         * @param bakeTimeMins The number of minutes between the first and second traffic shifts of
         *   a time-based canary deployment.
         */
    ...
    private class BuilderImpl : Builder {
        ...
        public fun build(): software.amazon.awscdk.CfnTrafficRoutingTimeBasedCanary =
            cdkBuilder.build()
    }
    ...
    internal constructor(
        ...
        /**
         * The percentage of traffic to shift in the first increment of a time-based canary
         * deployment.
         *
         * The step percentage must be 14% or greater.
         *
    ...
    public companion object {
        ...
        internal fun wrap(
            cdkObject: software.amazon.awscdk.CfnTrafficRoutingTimeBasedCanary
        ): CfnTrafficRoutingTimeBasedCanary = Wrapper(cdkObject)

        internal fun unwrap(
            wrapped: CfnTrafficRoutingTimeBasedCanary
