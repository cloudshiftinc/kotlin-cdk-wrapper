...
public interface DockerBuildOptions {
     ...
     */
    public fun cacheTo(): DockerCacheOption? =
    ...
    public companion object {
        ...
        ): DockerBuildOptions = Wrapper(cdkObject)

        internal fun unwrap(
            wrapped: DockerBuildOptions
        ): software.amazon.awscdk.DockerBuildOptions = (wrapped as Wrapper).cdkObject
    }
}
