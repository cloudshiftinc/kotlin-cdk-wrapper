...
internal constructor(
     ...
     *
     * This method will be called implicitly by language runtimes if the object is embedded into a
     * list. We treat it the same as an explicit stringification.
     */
    ...
    public companion object {
        ...
        internal fun wrap(cdkObject: software.amazon.awscdk.Intrinsic): Intrinsic =
            Intrinsic(cdkObject)

        internal fun unwrap(wrapped: Intrinsic): software.amazon.awscdk.Intrinsic =
            wrapped.cdkObject
    }
}
