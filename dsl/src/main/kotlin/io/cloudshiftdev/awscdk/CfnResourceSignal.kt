...
public interface CfnResourceSignal {
     ...
     * before the timeout period expires, the resource creation fails and AWS CloudFormation rolls
     * the stack back.
     */
     ...
     * timeout expires no sooner than the time you specify but can occur shortly thereafter. The
    ...
    public interface Builder {
        /**
         * @param count The number of success signals AWS CloudFormation must receive before it sets
         *   the resource status as CREATE_COMPLETE. If the resource receives a failure signal or
         *   doesn't receive the specified number of signals before the timeout period expires, the
         ...
         *   that was specified in the Count property. The timeout period starts after AWS
         *   CloudFormation starts creating the resource, and the timeout expires no sooner than the
    ...
    internal constructor(
         ...
         * status as CREATE_COMPLETE.
         *
         * If the resource receives a failure signal or doesn't receive the specified number of
         * signals before the timeout period expires, the resource creation fails and AWS
         ...
         * specified in the Count property.
         *
         * The timeout period starts after AWS CloudFormation starts creating the resource, and the
         * timeout expires no sooner than the time you specify but can occur shortly thereafter. The
         * maximum time that you can specify is 12 hours.
