...
public enum class SynthesisMessageLevel(
    ...
    public companion object {
        internal fun wrap(
            cdkObject: software.amazon.awscdk.cxapi.SynthesisMessageLevel
        ): SynthesisMessageLevel =
            when (cdkObject) {
                software.amazon.awscdk.cxapi.SynthesisMessageLevel.INFO ->
                    SynthesisMessageLevel.INFO
                software.amazon.awscdk.cxapi.SynthesisMessageLevel.WARNING ->
                    SynthesisMessageLevel.WARNING
                software.amazon.awscdk.cxapi.SynthesisMessageLevel.ERROR ->
                    SynthesisMessageLevel.ERROR
            }

        internal fun unwrap(
            wrapped: SynthesisMessageLevel
