...
internal constructor(
     ...
     *
     * Should only be used in user interfaces. If the stackName has not been set explicitly, or has
     * been set to artifactId, it will return the hierarchicalId of the stack. Otherwise, it will
     * return something like "<hierarchicalId> (<stackName>)"
     */
    public open fun displayName(): String = unwrap(this).getDisplayName()

    /** The environment into which to deploy this artifact. */
    public open fun environment(): Environment =
        unwrap(this).getEnvironment().let(Environment::wrap)
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder: software.amazon.awscdk.cxapi.CloudFormationStackArtifact.Builder =
            software.amazon.awscdk.cxapi.CloudFormationStackArtifact.Builder.create(
                assembly,
                artifactId
            )
        ...
        override fun properties(
            properties: AwsCloudFormationStackProperties.Builder.() -> Unit
        ...
        @JvmName("89ceb4e9acb0af4e90262523f7c7c05de15be68a16458b25e519add9141b9d88")
        override fun properties(
            properties: NestedCloudAssemblyProperties.Builder.() -> Unit
    ...
    public companion object {
        public fun isCloudFormationStackArtifact(art: Any): Boolean =
            software.amazon.awscdk.cxapi.CloudFormationStackArtifact.isCloudFormationStackArtifact(
                art
            )
        ...
        internal fun unwrap(
            wrapped: CloudFormationStackArtifact
