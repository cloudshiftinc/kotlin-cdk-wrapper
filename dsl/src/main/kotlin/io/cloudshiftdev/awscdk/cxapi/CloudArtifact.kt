...
internal constructor(
    ...
    /**
     * An identifier that shows where this artifact is located in the tree of nested assemblies,
     * based on their manifests.
     *
    ...
    public companion object {
        public fun fromManifest(
            ...
            software.amazon.awscdk.cxapi.CloudArtifact.fromManifest(
                    assembly.let(CloudAssembly::unwrap),
                    id,
                    artifact.let(ArtifactManifest::unwrap)
                )
                ?.let(CloudArtifact::wrap)
