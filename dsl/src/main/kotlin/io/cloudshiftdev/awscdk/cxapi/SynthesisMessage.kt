...
public interface SynthesisMessage {
    ...
    private class BuilderImpl : Builder {
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("9632d9a77fd16530e6e62a4bc87651a80c1d90b0739b16bdf07edfbaf8de3dc8")
        override fun entry(entry: MetadataEntry.Builder.() -> Unit): Unit =
    ...
    public companion object {
        ...
        ): SynthesisMessage = Wrapper(cdkObject)

        internal fun unwrap(
            wrapped: SynthesisMessage
        ): software.amazon.awscdk.cxapi.SynthesisMessage = (wrapped as Wrapper).cdkObject
    }
}
