...
public interface CfnCreationPolicy {
    ...
    public interface Builder {
        /**
         * @param autoScalingCreationPolicy For an Auto Scaling group replacement update, specifies
         *   how many instances must signal success for the update to succeed.
         */
        ...
        public fun autoScalingCreationPolicy(
            autoScalingCreationPolicy: CfnResourceAutoScalingCreationPolicy.Builder.() -> Unit
        )

        /**
         * @param resourceSignal When AWS CloudFormation creates the associated resource, configures
         *   the number of required success signals and the length of time that AWS CloudFormation
        ...
        /**
         * @param startFleet For an AppStream Fleet creation, specifies that the fleet is started
         *   after creation.
         */
    ...
    private class BuilderImpl : Builder {
         ...
         *   how many instances must signal success for the update to succeed.
         */
        override fun autoScalingCreationPolicy(
            autoScalingCreationPolicy: CfnResourceAutoScalingCreationPolicy
        ) {
            cdkBuilder.autoScalingCreationPolicy(
                autoScalingCreationPolicy.let(CfnResourceAutoScalingCreationPolicy::unwrap)
            )
        }
        ...
        override fun autoScalingCreationPolicy(
            ...
            autoScalingCreationPolicy(
                CfnResourceAutoScalingCreationPolicy(autoScalingCreationPolicy)
            )
    ...
    internal constructor(
        ...
        override fun autoScalingCreationPolicy(): CfnResourceAutoScalingCreationPolicy? =
            unwrap(this)
                ...
                ?.let(CfnResourceAutoScalingCreationPolicy::wrap)

        /**
         * When AWS CloudFormation creates the associated resource, configures the number of
         * required success signals and the length of time that AWS CloudFormation waits for those
         * signals.
         */
