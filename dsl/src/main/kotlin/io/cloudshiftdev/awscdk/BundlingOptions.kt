...
public interface BundlingOptions {
     ...
     *
     * The provider implements a method `tryBundle()` which should return `true` if local bundling
     * was performed. If `false` is returned, docker bundling will be done.
     *
     ...
     */
    public fun outputType(): BundlingOutput? =
     ...
     */
    public fun volumes(): List<DockerVolume> =
    ...
    public interface Builder {
        ...
        /**
         * @param command The command to run in the Docker container. Example value: `['npm',
         *   'install']`
         */
        ...
        /**
         * @param entrypoint The entrypoint to run in the Docker container. Example value:
         *   `['/bin/sh', '-c']`
         */
        ...
        /**
         * @param local Local bundling provider. The provider implements a method `tryBundle()`
         *   which should return `true` if local bundling was performed. If `false` is returned,
         *   docker bundling will be done.
         */
        ...
        /**
         * @param user The user to use when running the Docker container. user | user:group | uid |
    ...
    internal constructor(
         ...
         * Local bundling provider.
         *
         * The provider implements a method `tryBundle()` which should return `true` if local
         * bundling was performed. If `false` is returned, docker bundling will be done.
         *
         * Default: - bundling will only be performed in a Docker container
         */
    ...
    public companion object {
        ...
        internal fun unwrap(wrapped: BundlingOptions): software.amazon.awscdk.BundlingOptions =
