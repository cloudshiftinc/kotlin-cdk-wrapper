...
internal constructor(
    ...
    /**
     * Artifact ID of the assembly if it is a nested stage. The root stage (app) will return an
     * empty string.
     *
     ...
     *
     * If any plugin reports any violation, synthesis will be interrupted and the report displayed
     * to the user.
     *
     ...
     *
     * Once an assembly has been synthesized, it cannot be modified. Subsequent calls will return
     * the same assembly.
     *
     * @param options
     */
    ...
    public interface Builder {
         ...
         *
         * Stacks defined inside this `Stage` with either `region` or `account` missing from its env
         * will use the corresponding field given here.
         *
         * If either `region` or `account`is is not configured for `Stack` (either on the `Stack`
         * itself or on the containing `Stage`), the Stack will be *environment-agnostic*.
         *
         * Environment-agnostic stacks can be deployed to any environment, may not be able to take
         * advantage of all features of the CDK. For example, they will not be able to use
         * environmental context lookups, will not automatically translate Service Principals to the
         * right format based on the environment's AWS partition, and other such enhancements.
         *
         ...
         *
         * Can only be specified if this stage is the root stage (the app). If this is specified and
         * this stage is nested within another stage, an error will be thrown.
         *
         * Default: - for nested stages, outdir will be determined as a relative directory to the
         * outdir of the app. For apps, if outdir is not specified, a temporary directory will be
         * created.
         *
         ...
         * Validation plugins to run during synthesis.
         *
         * If any plugin reports any violation, synthesis will be interrupted and the report
    ...
    private class BuilderImpl(
         ...
         * @param policyValidationBeta1 Validation plugins to run during synthesis.
         */
        override fun policyValidationBeta1(
            policyValidationBeta1: List<IPolicyValidationPluginBeta1>
        ) {
            cdkBuilder.policyValidationBeta1(
                policyValidationBeta1.map(IPolicyValidationPluginBeta1::unwrap)
            )
        }
         ...
         */
        override fun policyValidationBeta1(
            vararg policyValidationBeta1: IPolicyValidationPluginBeta1
