...
public interface CfnCodeDeployBlueGreenApplication {
    ...
    public interface Builder {
        ...
        public fun ecsAttributes(
            ecsAttributes: CfnCodeDeployBlueGreenEcsAttributes.Builder.() -> Unit
        )
    ...
    private class BuilderImpl : Builder {
        ...
        @JvmName("7a6b144a7caab90d92ab5814297f2d3e984915d397737fb5bcc194546504c0df")
        override fun target(
            target: CfnCodeDeployBlueGreenApplicationTarget.Builder.() -> Unit
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnCodeDeployBlueGreenApplication
