...
internal constructor(
     ...
     *
     * **Please note**: this is a direct IAM JSON policy blob, *not* a `iam.PolicyStatement` object
     ...
     *
     * Can be used to trigger updates on code changes, even when the properties of a custom resource
     * remain unchanged.
     */
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CustomResourceProviderBase
