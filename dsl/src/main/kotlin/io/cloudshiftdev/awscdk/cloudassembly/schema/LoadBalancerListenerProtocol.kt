...
public enum class LoadBalancerListenerProtocol(
  ...
  public companion object {
    internal
        fun wrap(cdkObject: software.amazon.awscdk.cloudassembly.schema.LoadBalancerListenerProtocol):
    ...
    internal fun unwrap(wrapped: LoadBalancerListenerProtocol):
        software.amazon.awscdk.cloudassembly.schema.LoadBalancerListenerProtocol = wrapped.cdkObject
  }
}
