...
public interface Tag {
     ...
     * Tag key.
     *
     * (In the actual file on disk this will be cased as "Key", and the structure is patched to
     * match this structure upon loading:
     ...
     * Tag value.
     *
     * (In the actual file on disk this will be cased as "Value", and the structure is patched to
     * match this structure upon loading:
     * https://github.com/aws/aws-cdk/blob/4aadaa779b48f35838cccd4e25107b2338f05547/packages/%40aws-cdk/cloud-assembly-schema/lib/manifest.ts#L137)
     */
    ...
    public interface Builder {
        ...
        /**
         * @param value Tag value. (In the actual file on disk this will be cased as "Value", and
         *   the structure is patched to match this structure upon loading:
         *   https://github.com/aws/aws-cdk/blob/4aadaa779b48f35838cccd4e25107b2338f05547/packages/%40aws-cdk/cloud-assembly-schema/lib/manifest.ts#L137)
         */
    ...
    internal constructor(
         ...
         * Tag value.
         *
         * (In the actual file on disk this will be cased as "Value", and the structure is patched
         * to match this structure upon loading:
         * https://github.com/aws/aws-cdk/blob/4aadaa779b48f35838cccd4e25107b2338f05547/packages/%40aws-cdk/cloud-assembly-schema/lib/manifest.ts#L137)
         */
    ...
    public companion object {
        ...
        internal fun unwrap(wrapped: Tag): software.amazon.awscdk.cloudassembly.schema.Tag =
