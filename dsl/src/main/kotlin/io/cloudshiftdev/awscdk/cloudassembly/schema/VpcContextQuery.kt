...
public interface VpcContextQuery {
     ...
     *
     * You can explicitly disable this in order to avoid the lookup if you know the VPC does not
     * have a VPN Gatway attached.
     *
     * Default: true
     */
    ...
    public interface Builder {
         ...
         *   `VpcContextResponse`, which contains the VPN Gateway ID, if one exists. You can
         *   explicitly disable this in order to avoid the lookup if you know the VPC does not have
    ...
    internal constructor(
        ...
        /**
         * Whether to populate the `vpnGatewayId` field of the `VpcContextResponse`, which contains
         * the VPN Gateway ID, if one exists.
         *
         * You can explicitly disable this in order to avoid the lookup if you know the VPC does not
         * have a VPN Gatway attached.
         *
