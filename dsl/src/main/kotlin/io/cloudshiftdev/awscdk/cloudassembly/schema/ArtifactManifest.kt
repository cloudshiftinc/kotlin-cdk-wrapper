...
public interface ArtifactManifest {
    ...
    public interface Builder {
        ...
        /**
         * @param displayName A string that represents this artifact. Should only be used in user
         *   interfaces.
         */
    ...
    internal constructor(
        ...
        override fun metadata(): Map<String, List<MetadataEntry>> =
            unwrap(this).getMetadata()?.mapValues { it.value.map(MetadataEntry::wrap) }
                ?: emptyMap()
