...
public interface ContainerImageAssetMetadataEntry {
     ...
     *
     * This field is required if `imageParameterName` is ommited (otherwise, the app won't be able
     * to find the image).
     *
     ...
     *
     * Specify this property if you need to statically address the image, e.g. from a Kubernetes
     * Pod. Note, this is only the repository name, without the registry and the tag parts.
     *
     * Default: - this parameter is REQUIRED after 1.21.0
     */
    ...
    public interface Builder {
        ...
        /**
         * @param imageTag The docker image tag to use for tagging pushed images. This field is
         *   required if `imageParameterName` is ommited (otherwise, the app won't be able to find
         *   the image).
         */
        ...
        /**
         * @param repositoryName ECR repository name, if omitted a default name based on the asset's
         *   ID is used instead. Specify this property if you need to statically address the image,
         *   e.g. from a Kubernetes Pod. Note, this is only the repository name, without the
    ...
    internal constructor(
         ...
         * Default: no build secrets are passed
         */
        override fun buildSecrets(): Map<String, String> =
            unwrap(this).getBuildSecrets() ?: emptyMap()
         ...
         * The docker image tag to use for tagging pushed images.
         *
         * This field is required if `imageParameterName` is ommited (otherwise, the app won't be
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: ContainerImageAssetMetadataEntry
        ): software.amazon.awscdk.cloudassembly.schema.ContainerImageAssetMetadataEntry =
