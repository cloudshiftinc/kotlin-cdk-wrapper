...
public interface AssemblyManifest {
     ...
     *
     * If this field has values, it means that the cloud assembly is not complete and should not be
     * deployed.
     *
     * Default: - no missing context.
     */
    public fun missing(): List<MissingContext> =
    ...
    public interface Builder {
        ...
        /**
         * @param missing Missing context information. If this field has values, it means that the
    ...
    internal constructor(
         ...
         * Missing context information.
         *
         * If this field has values, it means that the cloud assembly is not complete and should not
         * be deployed.
         *
         * Default: - no missing context.
         */
