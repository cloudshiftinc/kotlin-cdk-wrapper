...
public interface HostedZoneContextQuery {
     ...
     *
     * If you provide VPC ID and privateZone is false, this will return no results and raise an
     * error.
     *
    ...
    public interface Builder {
        ...
        /**
         * @param vpcId The VPC ID to that the private zone must be associated with. If you provide
         *   VPC ID and privateZone is false, this will return no results and raise an error.
         */
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: HostedZoneContextQuery
