...
public interface AwsCloudFormationStackProperties {
     ...
     */
    public fun stackTemplateAssetObjectUrl(): String? =
    ...
    public interface Builder {
         ...
         * * If this value is not set, the bootstrap stack name must be known at deployment time so
         *   the stack version can be looked up from the stack outputs.
         * * If this value is set, the bootstrap stack can have any name because we won't need to
         *   look it up.
         */
        public fun bootstrapStackVersionSsmParameter(bootstrapStackVersionSsmParameter: String)

        /**
         * @param cloudFormationExecutionRoleArn The role that is passed to CloudFormation to
        ...
        /**
         * @param parameters Values for CloudFormation stack parameters that should be passed when
        ...
        /**
         * @param templateFile A file relative to the assembly root which contains the
         *   CloudFormation template for this stack.
         */
    ...
    internal constructor(
        ...
        /**
         * Values for CloudFormation stack parameters that should be passed when the stack is
         * deployed.
         *
         * Default: - No parameters
         */
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: AwsCloudFormationStackProperties
        ): software.amazon.awscdk.cloudassembly.schema.AwsCloudFormationStackProperties =
