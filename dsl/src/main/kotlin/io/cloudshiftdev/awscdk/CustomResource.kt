...
internal constructor(
     ...
     *
     * Attributes are returned from the custom resource provider through the `Data` map where the
     * key is the attribute name.
     *
     * @param attributeName the name of the attribute.
     * @return a token for `Fn::GetAtt`. Use `Token.asXxx` to encode the returned `Reference` as a
     *   specific type or use the convenience `getAttString` for string attributes.
     */
    ...
    public interface Builder {
        ...
        /**
         * For custom resources, you can specify AWS::CloudFormation::CustomResource (the default)
         * as the resource type, or you can specify your own resource type name.
         *
         * For example, you can use "Custom::MyCustomResourceTypeName".
         *
         * Custom resource type names must begin with "Custom::" and can include alphanumeric
         * characters and the following characters: _&#64;-. You can specify a custom resource type
         * name up to a maximum length of 60 characters. You cannot change the type during an
         * update.
         *
         ...
         *
         * @param resourceType For custom resources, you can specify
         *   AWS::CloudFormation::CustomResource (the default) as the resource type, or you can
         *   specify your own resource type name.
         */
         ...
         *
         * You can implement a provider by listening to raw AWS CloudFormation events and specify
         * the ARN of an SNS topic (`topic.topicArn`) or the ARN of an AWS Lambda function
