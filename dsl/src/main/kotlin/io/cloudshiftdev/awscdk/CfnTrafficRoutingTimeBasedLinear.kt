...
public interface CfnTrafficRoutingTimeBasedLinear {
    ...
    public interface Builder {
         ...
         *   a time-based linear deployment.
         */
         ...
         *   increment of a time-based linear deployment. The step percentage must be 14% or
         *   greater.
         */
    ...
    private class BuilderImpl : Builder {
        ...
        public fun build(): software.amazon.awscdk.CfnTrafficRoutingTimeBasedLinear =
            cdkBuilder.build()
    }
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnTrafficRoutingTimeBasedLinear
