...
internal constructor(
    private val cdkObject: software.amazon.awscdk.alexa.ask.CfnSkill,
) : CfnResource(cdkObject), IInspectable {
    /**  */
    public open fun attrId(): String = unwrap(this).getAttrId()

    /** Login with Amazon (LWA) configuration used to authenticate with the Alexa service. */
    public open fun authenticationConfiguration(): Any =
    ...
    public open fun authenticationConfiguration(`value`: AuthenticationConfigurationProperty) {
        unwrap(this)
            .setAuthenticationConfiguration(
                `value`.let(AuthenticationConfigurationProperty::unwrap)
            )
    }
    ...
    public open fun authenticationConfiguration(
        `value`: AuthenticationConfigurationProperty.Builder.() -> Unit
    ...
    public interface Builder {
         ...
         *
         * @param authenticationConfiguration Login with Amazon (LWA) configuration used to
         *   authenticate with the Alexa service.
         */
         ...
         * update the skill. For more information about the skill package format, see the .
         *
         ...
         *
         * @param skillPackage Configuration for the skill package that contains the components of
         *   the Alexa skill.
         */
         ...
         * The vendor ID associated with the Amazon developer account that will host the skill.
         *
         * Details for retrieving the vendor ID are in . The provided LWA credentials must be linked
         * to the developer account associated with this vendor ID.
         *
         ...
         *
         * @param vendorId The vendor ID associated with the Amazon developer account that will host
         *   the skill.
         */
    ...
    public interface SkillPackageProperty {
         ...
         * only overriding values inside of the skill manifest component of the package is
         * supported.
         *
         ...
         * permission to access the bucket and retrieve the skill package. This property is
         * optional. If you do not provide it, the bucket must be publicly accessible or configured
         * with a policy that allows this access. Otherwise, AWS CloudFormation cannot create the
         * skill.
         *
        ...
        public interface Builder {
            /**
             * @param overrides Overrides to the skill package to apply when creating or updating
             *   the skill. Values provided here do not modify the contents of the original skill
             *   package. Currently, only overriding values inside of the skill manifest component
             *   of the package is supported.
             */
            ...
            /**
             * @param s3Bucket The name of the Amazon S3 bucket where the .zip file that contains
             *   the skill package is stored.
             */
            public fun s3Bucket(s3Bucket: String)

            /**
             * @param s3BucketRole ARN of the IAM role that grants the Alexa service (
             *   `alexa-appkit.amazon.com` ) permission to access the bucket and retrieve the skill
             *   package. This property is optional. If you do not provide it, the bucket must be
             *   publicly accessible or configured with a policy that allows this access. Otherwise,
        ...
        internal constructor(
             ...
             * Currently, only overriding values inside of the skill manifest component of the
             ...
             * ARN of the IAM role that grants the Alexa service ( `alexa-appkit.amazon.com` )
             * permission to access the bucket and retrieve the skill package. This property is
             * optional. If you do not provide it, the bucket must be publicly accessible or
             * configured with a policy that allows this access. Otherwise, AWS CloudFormation
             * cannot create the skill.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ask-skill-skillpackage.html#cfn-ask-skill-skillpackage-s3bucketrole)
             */
    ...
    public interface AuthenticationConfigurationProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param refreshToken Refresh token from Login with Amazon (LWA). This token is secret.
             */
