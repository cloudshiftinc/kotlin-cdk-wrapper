...
internal constructor(
    private val cdkObject: software.amazon.awscdk.CfnCodeDeployBlueGreenHook,
) : CfnHook(cdkObject) {
    /**
    ...
    public open fun additionalOptions(`value`: CfnCodeDeployBlueGreenAdditionalOptions) {
        unwrap(this)
            .setAdditionalOptions(`value`.let(CfnCodeDeployBlueGreenAdditionalOptions::unwrap))
    }
    ...
    public open fun additionalOptions(
        `value`: CfnCodeDeployBlueGreenAdditionalOptions.Builder.() -> Unit
     ...
     * `CfnCodeDeployBlueGreenLifecycleEventHooks.afterAllowTraffic` function calls back CodeDeploy
    ...
    public open fun lifecycleEventHooks(`value`: CfnCodeDeployBlueGreenLifecycleEventHooks) {
        unwrap(this)
            .setLifecycleEventHooks(`value`.let(CfnCodeDeployBlueGreenLifecycleEventHooks::unwrap))
    }
    ...
    public open fun lifecycleEventHooks(
        `value`: CfnCodeDeployBlueGreenLifecycleEventHooks.Builder.() -> Unit
    ...
    public open fun trafficRoutingConfig(
        `value`: CfnTrafficRoutingConfig.Builder.() -> Unit
    ): Unit = trafficRoutingConfig(CfnTrafficRoutingConfig(`value`))
    ...
    public interface Builder {
        ...
        public fun additionalOptions(
            additionalOptions: CfnCodeDeployBlueGreenAdditionalOptions.Builder.() -> Unit
        )
        ...
        /**
         * Use lifecycle event hooks to specify a Lambda function that CodeDeploy can call to
         * validate a deployment.
         *
         * You can use the same function or a different one for deployment lifecycle events.
         * Following completion of the validation tests, the Lambda
         * `CfnCodeDeployBlueGreenLifecycleEventHooks.afterAllowTraffic` function calls back
        ...
        public fun lifecycleEventHooks(
            lifecycleEventHooks: CfnCodeDeployBlueGreenLifecycleEventHooks.Builder.() -> Unit
        )

        /**
         * The IAM Role for CloudFormation to use to perform blue-green deployments.
         *
         * @param serviceRole The IAM Role for CloudFormation to use to perform blue-green
         *   deployments.
         */
         ...
         * Traffic routing configuration settings.
         *
         * Default: - time-based canary traffic shifting, with a 15% step percentage and a five
         * minute bake time
         *
        ...
        public fun trafficRoutingConfig(
            trafficRoutingConfig: CfnTrafficRoutingConfig.Builder.() -> Unit
        )
    }
    ...
    private class BuilderImpl(
        ...
        override fun additionalOptions(additionalOptions: CfnCodeDeployBlueGreenAdditionalOptions) {
            cdkBuilder.additionalOptions(
                additionalOptions.let(CfnCodeDeployBlueGreenAdditionalOptions::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("2942ee11ea6a57ebe0c2645198c9fb7a2b6814640b751575ce2816ffb3a970cd")
        override fun additionalOptions(
            additionalOptions: CfnCodeDeployBlueGreenAdditionalOptions.Builder.() -> Unit
         ...
         *   CodeDeploy can call to validate a deployment.
         */
        override fun lifecycleEventHooks(
            lifecycleEventHooks: CfnCodeDeployBlueGreenLifecycleEventHooks
        ) {
            cdkBuilder.lifecycleEventHooks(
                lifecycleEventHooks.let(CfnCodeDeployBlueGreenLifecycleEventHooks::unwrap)
            )
        }
        ...
        override fun lifecycleEventHooks(
            ...
            lifecycleEventHooks(CfnCodeDeployBlueGreenLifecycleEventHooks(lifecycleEventHooks))
        ...
        override fun trafficRoutingConfig(trafficRoutingConfig: CfnTrafficRoutingConfig) {
            cdkBuilder.trafficRoutingConfig(
                trafficRoutingConfig.let(CfnTrafficRoutingConfig::unwrap)
            )
        }
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnCodeDeployBlueGreenHook
