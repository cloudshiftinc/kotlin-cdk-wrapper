...
internal constructor(
    ...
    public companion object {
        public fun fromSdkCalls(options: SdkCallsPolicyOptions): AwsCustomResourcePolicy =
            software.amazon.awscdk.customresources.AwsCustomResourcePolicy.fromSdkCalls(
                    options.let(SdkCallsPolicyOptions::unwrap)
                )
                .let(AwsCustomResourcePolicy::wrap)

        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("0941a10126c1569cb9626dfcc4e5dff6b1db29239307e7105ea475cbb57b3db3")
        public fun fromSdkCalls(
            options: SdkCallsPolicyOptions.Builder.() -> Unit
        ...
        public fun fromStatements(statements: List<PolicyStatement>): AwsCustomResourcePolicy =
            software.amazon.awscdk.customresources.AwsCustomResourcePolicy.fromStatements(
                    statements.map(PolicyStatement::unwrap)
                )
                .let(AwsCustomResourcePolicy::wrap)
        ...
        internal fun unwrap(
            wrapped: AwsCustomResourcePolicy
