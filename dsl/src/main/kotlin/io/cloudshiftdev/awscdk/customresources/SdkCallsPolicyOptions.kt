...
public interface SdkCallsPolicyOptions {
     ...
     * `onCreate` is used to create a resource which you don't know the physical name of in advance.
     *
    ...
    public interface Builder {
        /**
         * @param resources The resources that the calls will have access to. It is best to use
         *   specific resource ARN's when possible. However, you can also use
         *   `AwsCustomResourcePolicy.ANY_RESOURCE` to allow access to all resources. For example,
         *   when `onCreate` is used to create a resource which you don't know the physical name of
         *   in advance.
         *
         * Note that will apply to ALL SDK calls.
         */
    ...
    internal constructor(
         ...
         * It is best to use specific resource ARN's when possible. However, you can also use
         * `AwsCustomResourcePolicy.ANY_RESOURCE` to allow access to all resources. For example,
         * when `onCreate` is used to create a resource which you don't know the physical name of in
         * advance.
         *
         * Note that will apply to ALL SDK calls.
         */
