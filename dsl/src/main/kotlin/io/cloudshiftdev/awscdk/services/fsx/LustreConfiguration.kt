...
public interface LustreConfiguration {
     ...
     * listings. Use this property to choose how Amazon FSx keeps your file and directory listings
     * up to date as you add or modify objects in your linked S3 bucket. `AutoImportPolicy` can have
     ...
     *
     * The path must use the same Amazon S3 bucket as specified in ImportPath. If you only specify a
     * bucket name, such as s3://import-bucket, you get a 1:1 mapping of file system objects to S3
     * bucket objects. This mapping means that the input data in S3 is overwritten on export. If you
     * provide a custom prefix in the export path, such as
     ...
     *
     * The first digit is the day of the week, starting at 1 for Monday, then the following are
     * hours and minutes in the UTC time zone, 24 hour clock. For example: '2:20:30' is Tuesdays at
     * 20:30.
     *
    ...
    public interface Builder {
         ...
         *   When you create your file system, your existing S3 objects appear as file and directory
         *   listings. Use this property to choose how Amazon FSx keeps your file and directory
         ...
         *   exported. The path must use the same Amazon S3 bucket as specified in ImportPath. If
         *   you only specify a bucket name, such as s3://import-bucket, you get a 1:1 mapping of
         *   file system objects to S3 bucket objects. This mapping means that the input data in S3
         *   is overwritten on export. If you provide a custom prefix in the export path, such as
         *   s3://import-bucket/[custom-optional-prefix], Amazon FSx exports the contents of your
         *   file system to that export prefix in the Amazon S3 bucket.
         */
         ...
         *   you're using as the data repository for your Amazon FSx for Lustre file system. Must be
         *   of the format "s3://{bucketName}/optional-prefix" and cannot exceed 900 characters.
         */
         ...
         *   single physical disk. Allowed values are between 1 and 512,000.
         */
        public fun importedFileChunkSizeMiB(importedFileChunkSizeMiB: Number)

        /**
         * @param perUnitStorageThroughput Required for the PERSISTENT_1 deployment type, describes
         *   the amount of read and write throughput for each 1 tebibyte of storage, in MB/s/TiB.
         *   Valid values are 50, 100, 200.
         */
        public fun perUnitStorageThroughput(perUnitStorageThroughput: Number)

        /**
         * @param weeklyMaintenanceStartTime The preferred day and time to perform weekly
         *   maintenance. The first digit is the day of the week, starting at 1 for Monday, then the
         *   following are hours and minutes in the UTC time zone, 24 hour clock. For example:
         *   '2:20:30' is Tuesdays at 20:30.
         */
        ...
        public fun weeklyMaintenanceStartTime(
            weeklyMaintenanceStartTime: LustreMaintenanceTime.Builder.() -> Unit
        )
    }
    ...
    private class BuilderImpl : Builder {
        ...
        override fun dataCompressionType(dataCompressionType: LustreDataCompressionType) {
            cdkBuilder.dataCompressionType(
                dataCompressionType.let(LustreDataCompressionType::unwrap)
            )
        }
        ...
        override fun weeklyMaintenanceStartTime(weeklyMaintenanceStartTime: LustreMaintenanceTime) {
            cdkBuilder.weeklyMaintenanceStartTime(
                weeklyMaintenanceStartTime.let(LustreMaintenanceTime::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("e1343833c242fcc61da33ba57517a2aefb662f1b43aafc47411fe6741b730a2e")
        override fun weeklyMaintenanceStartTime(
            weeklyMaintenanceStartTime: LustreMaintenanceTime.Builder.() -> Unit
        ): Unit = weeklyMaintenanceStartTime(LustreMaintenanceTime(weeklyMaintenanceStartTime))

        public fun build(): software.amazon.awscdk.services.fsx.LustreConfiguration =
            cdkBuilder.build()
    }
    ...
    internal constructor(
         ...
         * The path in Amazon S3 where the root of your Amazon FSx file system is exported.
         *
         * The path must use the same Amazon S3 bucket as specified in ImportPath. If you only
         * specify a bucket name, such as s3://import-bucket, you get a 1:1 mapping of file system
         * objects to S3 bucket objects. This mapping means that the input data in S3 is overwritten
         ...
         * data repository for your Amazon FSx for Lustre file system.
         *
         * Must be of the format "s3://{bucketName}/optional-prefix" and cannot exceed 900
         * characters.
         *
         * Default: - no bucket is imported
         */
         ...
         * Default: 1024
         */
        override fun importedFileChunkSizeMiB(): Number? =
         ...
         *
         * The first digit is the day of the week, starting at 1 for Monday, then the following are
         * hours and minutes in the UTC time zone, 24 hour clock. For example: '2:20:30' is Tuesdays
         * at 20:30.
         *
         * Default: - no preference
         */
