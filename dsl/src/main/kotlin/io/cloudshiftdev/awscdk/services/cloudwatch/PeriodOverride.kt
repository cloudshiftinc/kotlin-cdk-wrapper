...
public enum class PeriodOverride(
    ...
    public companion object {
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.cloudwatch.PeriodOverride
        ): PeriodOverride =
            when (cdkObject) {
                software.amazon.awscdk.services.cloudwatch.PeriodOverride.AUTO ->
                    PeriodOverride.AUTO
                software.amazon.awscdk.services.cloudwatch.PeriodOverride.INHERIT ->
                    PeriodOverride.INHERIT
            }

        internal fun unwrap(
            wrapped: PeriodOverride
