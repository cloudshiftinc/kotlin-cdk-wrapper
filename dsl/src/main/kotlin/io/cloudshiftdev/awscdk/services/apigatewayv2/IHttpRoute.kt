...
public interface IHttpRoute : IRoute {
  ...
  private class Wrapper internal constructor(
    ...
    public override fun grantInvoke(arg0: IGrantable, arg1: GrantInvokeOptions): Grant =
        unwrap(this).grantInvoke(arg0.let(IGrantable::unwrap),
        arg1.let(GrantInvokeOptions::unwrap)).let(Grant::wrap)

    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("412779fe515aba89b3c88de8dca006d0a8d413686405d41ff168250ac6c8b73c")
    public override fun grantInvoke(arg0: IGrantable, arg1: GrantInvokeOptions.Builder.() -> Unit):
        Grant = grantInvoke(arg0, GrantInvokeOptions(arg1))
