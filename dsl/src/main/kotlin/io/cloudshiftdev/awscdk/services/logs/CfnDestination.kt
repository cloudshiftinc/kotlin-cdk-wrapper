...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param destinationPolicy An IAM policy document that governs which AWS accounts can
         ...
         *
         * @param targetArn The Amazon Resource Name (ARN) of the physical target where the log
