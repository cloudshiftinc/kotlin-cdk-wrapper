...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param capacityUnits You can set additional capacity units to meet the needs of your
         ...
         * values can consist of Unicode letters, digits, white space. They can also consist of
    ...
    public interface CapacityUnitsConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param rescoreCapacityUnits The amount of extra capacity for your rescore execution
             *   plan. A single extra capacity unit for a rescore execution plan provides 0.01
