...
internal constructor(
    ...
    public open fun metadataCatalogConfig(
        `value`: MetadataCatalogConfigProperty.Builder.() -> Unit
    ...
    public interface Builder {
         ...
         *
         * @param destinationFlowConfigList The configuration that controls how Amazon AppFlow
         ...
         * * **Active** - The flow runs based on the trigger settings that you defined. Active
         *   scheduled flows run as scheduled, and active event-triggered flows run when the
         *   specified change event occurs. However, active on-demand flows run only when you
         *   manually start them by using Amazon AppFlow.
         * * **Suspended** - You can use this option to deactivate an active flow. Scheduled and
         *   event-triggered flows will cease to run until you reactive them. This value only
         *   affects scheduled and event-triggered flows. It has no effect for on-demand flows.
         *
         * If you omit the FlowStatus parameter, Amazon AppFlow creates the flow with a default
         * status. The default status for on-demand flows is Active. The default status for
         * scheduled and event-triggered flows is Draft, which means they’re not yet active.
         *
         ...
         *
         * @param flowStatus Sets the status of the flow. You can specify one of the following
         *   values:.
         */
         ...
         * encryption.
         *
         * This is required if you do not want to use the Amazon AppFlow-managed KMS key. If you
         * don't provide anything here, Amazon AppFlow uses the Amazon AppFlow-managed KMS key.
         *
        ...
        public fun metadataCatalogConfig(
            metadataCatalogConfig: MetadataCatalogConfigProperty.Builder.() -> Unit
        )
         ...
         *
         * @param sourceFlowConfig Contains information about the configuration of the source
         *   connector used in the flow.
         */
         ...
         *
         * @param tasks A list of tasks that Amazon AppFlow performs while transferring the data in
         *   the flow run.
         */
         ...
         *
         * @param triggerConfig The trigger settings that determine how and when Amazon AppFlow runs
         *   the specified flow.
         */
    ...
    private class BuilderImpl(
        ...
        override fun metadataCatalogConfig(metadataCatalogConfig: MetadataCatalogConfigProperty) {
            cdkBuilder.metadataCatalogConfig(
                metadataCatalogConfig.let(MetadataCatalogConfigProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("2e720d9b9cc18741b25ccf2fd1461e54daea95b322bba21d71f7f0465ed70c5a")
        override fun metadataCatalogConfig(
            metadataCatalogConfig: MetadataCatalogConfigProperty.Builder.() -> Unit
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("7ce8f9686103aed30f45bf4fabc3a9f02ab3fb16971b7e673b19195615c083fd")
        override fun sourceFlowConfig(
            sourceFlowConfig: SourceFlowConfigProperty.Builder.() -> Unit
    ...
    public interface IncrementalPullConfigProperty {
        ...
        public interface Builder {
            /**
             * @param datetimeTypeFieldName A field that specifies the date time or timestamp field
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: IncrementalPullConfigProperty
            ): software.amazon.awscdk.services.appflow.CfnFlow.IncrementalPullConfigProperty =
    ...
    public interface LookoutMetricsDestinationPropertiesProperty {
        ...
        public interface Builder {
            /**
             * @param object The object specified in the Amazon Lookout for Metrics flow
             *   destination.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: LookoutMetricsDestinationPropertiesProperty
            ): software.amazon.awscdk.services.appflow.CfnFlow.LookoutMetricsDestinationPropertiesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SAPODataSourcePropertiesProperty {
        ...
        public interface Builder {
            ...
            public fun paginationConfig(
                paginationConfig: SAPODataPaginationConfigProperty.Builder.() -> Unit
            )
            ...
            public fun parallelismConfig(
                parallelismConfig: SAPODataParallelismConfigProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun paginationConfig(paginationConfig: SAPODataPaginationConfigProperty) {
                cdkBuilder.paginationConfig(
                    paginationConfig.let(SAPODataPaginationConfigProperty::unwrap)
                )
            }
            ...
            override fun parallelismConfig(parallelismConfig: SAPODataParallelismConfigProperty) {
                cdkBuilder.parallelismConfig(
                    parallelismConfig.let(SAPODataParallelismConfigProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("7f95371b951a28de06e5a099899d0ae58f7cd8fba9b9bbf1bd458d803c371c14")
            override fun parallelismConfig(
                parallelismConfig: SAPODataParallelismConfigProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SAPODataSourcePropertiesProperty
            ): software.amazon.awscdk.services.appflow.CfnFlow.SAPODataSourcePropertiesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface TrendmicroSourcePropertiesProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TrendmicroSourcePropertiesProperty
            ): software.amazon.awscdk.services.appflow.CfnFlow.TrendmicroSourcePropertiesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ServiceNowSourcePropertiesProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ServiceNowSourcePropertiesProperty
            ): software.amazon.awscdk.services.appflow.CfnFlow.ServiceNowSourcePropertiesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface TaskProperty {
        ...
        public interface Builder {
            ...
            public fun connectorOperator(
                connectorOperator: ConnectorOperatorProperty.Builder.() -> Unit
            )

            /**
             * @param destinationField A field in a destination connector, or a field value against
            ...
            /**
             * @param taskProperties A map used to store task-related information. The execution
             ...
             *   performs. *Allowed values* : `Arithmetic` | `Filter` | `Map` | `Map_all` | `Mask` |
        ...
        private class BuilderImpl : Builder {
            ...
            override fun connectorOperator(connectorOperator: ConnectorOperatorProperty) {
                cdkBuilder.connectorOperator(
                    connectorOperator.let(ConnectorOperatorProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("9eee05d1d2ad0e27526018cda419a9577c90e2716d3d3dbf25a6f2deacb3c813")
            override fun connectorOperator(
                connectorOperator: ConnectorOperatorProperty.Builder.() -> Unit
    ...
    public interface VeevaSourcePropertiesProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param includeAllVersions Boolean value to include All Versions of files in Veeva
            ...
            /**
             * @param includeRenditions Boolean value to include file renditions in Veeva document
             *   extract flow.
             */
            ...
            /**
             * @param includeSourceFiles Boolean value to include source files in Veeva document
             *   extract flow.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: VeevaSourcePropertiesProperty
            ): software.amazon.awscdk.services.appflow.CfnFlow.VeevaSourcePropertiesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface MarketoSourcePropertiesProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: MarketoSourcePropertiesProperty
            ): software.amazon.awscdk.services.appflow.CfnFlow.MarketoSourcePropertiesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SAPODataParallelismConfigProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SAPODataParallelismConfigProperty
            ): software.amazon.awscdk.services.appflow.CfnFlow.SAPODataParallelismConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface AmplitudeSourcePropertiesProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AmplitudeSourcePropertiesProperty
            ): software.amazon.awscdk.services.appflow.CfnFlow.AmplitudeSourcePropertiesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface PrefixConfigProperty {
         ...
         *   this version number. The version number increases by one when you change any of the
         ...
         */
        public fun pathPrefixHierarchy(): List<String> =
        ...
        public interface Builder {
            /**
             * @param pathPrefixHierarchy Specifies whether the destination file path includes
            ...
            /**
             * @param prefixType Determines the format of the prefix, and whether it applies to the
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appflow-flow-prefixconfig.html#cfn-appflow-flow-prefixconfig-pathprefixhierarchy)
             */
            override fun pathPrefixHierarchy(): List<String> =
                unwrap(this).getPathPrefixHierarchy() ?: emptyList()
    ...
    public interface ZendeskSourcePropertiesProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ZendeskSourcePropertiesProperty
            ): software.amazon.awscdk.services.appflow.CfnFlow.ZendeskSourcePropertiesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SnowflakeDestinationPropertiesProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param errorHandlingConfig The settings that determine how Amazon AppFlow handles an
             *   error when placing data in the Snowflake destination. For example, this setting
             *   would determine if the flow should fail after one insertion error, or continue and
            ...
            public fun errorHandlingConfig(
                errorHandlingConfig: ErrorHandlingConfigProperty.Builder.() -> Unit
            )

            /**
             * @param intermediateBucketName The intermediate bucket that Amazon AppFlow uses when
        ...
        private class BuilderImpl : Builder {
            ...
            override fun errorHandlingConfig(errorHandlingConfig: ErrorHandlingConfigProperty) {
                cdkBuilder.errorHandlingConfig(
                    errorHandlingConfig.let(ErrorHandlingConfigProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("646ce6c201ad615973cb0fb40476ff65e117a9cce859f39a0a75ffc640ead1e2")
            override fun errorHandlingConfig(
                errorHandlingConfig: ErrorHandlingConfigProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             *
             * For example, this setting would determine if the flow should fail after one insertion
             * error, or continue and attempt to insert every record regardless of the initial
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SnowflakeDestinationPropertiesProperty
            ): software.amazon.awscdk.services.appflow.CfnFlow.SnowflakeDestinationPropertiesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface EventBridgeDestinationPropertiesProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: EventBridgeDestinationPropertiesProperty
            ): software.amazon.awscdk.services.appflow.CfnFlow.EventBridgeDestinationPropertiesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DynatraceSourcePropertiesProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DynatraceSourcePropertiesProperty
            ): software.amazon.awscdk.services.appflow.CfnFlow.DynatraceSourcePropertiesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CustomConnectorSourcePropertiesProperty {
        ...
        public interface Builder {
            /**
             * @param customProperties Custom properties that are required to use the custom
            ...
            /**
             * @param dataTransferApi The API of the connector application that Amazon AppFlow uses
            ...
            /**
             * @param entityName The entity specified in the custom connector as a source in the
             *   flow.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("9ac4e51b048b3a753fce4e0cbfa032f54fa15f574236c63e35c626ad5c4dbc97")
            override fun dataTransferApi(
                dataTransferApi: DataTransferApiProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CustomConnectorSourcePropertiesProperty
            ): software.amazon.awscdk.services.appflow.CfnFlow.CustomConnectorSourcePropertiesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CustomConnectorDestinationPropertiesProperty {
        ...
        public interface Builder {
            /**
             * @param customProperties The custom properties that are specific to the connector when
            ...
            /**
             * @param entityName The entity specified in the custom connector as a destination in
             *   the flow.
             */
            public fun entityName(entityName: String)
            ...
            /**
             * @param errorHandlingConfig The settings that determine how Amazon AppFlow handles an
             *   error when placing data in the custom connector as destination.
             */
            public fun errorHandlingConfig(errorHandlingConfig: IResolvable)
            ...
            /**
             * @param idFieldNames The name of the field that Amazon AppFlow uses as an ID when
            ...
            /**
             * @param writeOperationType Specifies the type of write operation to be performed in
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appflow-flow-customconnectordestinationproperties.html#cfn-appflow-flow-customconnectordestinationproperties-idfieldnames)
             */
            override fun idFieldNames(): List<String> =
                unwrap(this).getIdFieldNames() ?: emptyList()
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CustomConnectorDestinationPropertiesProperty
            ): software.amazon.awscdk.services.appflow.CfnFlow.CustomConnectorDestinationPropertiesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface MarketoDestinationPropertiesProperty {
        ...
        public interface Builder {
            /**
             * @param errorHandlingConfig The settings that determine how Amazon AppFlow handles an
             *   error when placing data in the destination. For example, this setting would
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: MarketoDestinationPropertiesProperty
            ): software.amazon.awscdk.services.appflow.CfnFlow.MarketoDestinationPropertiesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ScheduledTriggerPropertiesProperty {
         ...
         *
         * If you want to schedule a flow by using times in a particular time zone, indicate the
         * time zone as a UTC offset in your timestamps. For example, the UTC offsets for the
        ...
        public interface Builder {
            /**
             * @param dataPullMode Specifies whether a scheduled flow has an incremental data
            ...
            /**
             * @param scheduleEndTime The time at which the scheduled flow ends. The time is
             *   formatted as a timestamp that follows the ISO 8601 standard, such as
             *   `2022-04-27T13:00:00-07:00` .
             */
            public fun scheduleEndTime(scheduleEndTime: Number)

            /**
             * @param scheduleExpression The scheduling expression that determines the rate at which
             *   the schedule will run, for example `rate(5minutes)` .
             */
            public fun scheduleExpression(scheduleExpression: String)

            /**
             * @param scheduleOffset Specifies the optional offset that is added to the time
             *   interval for a schedule-triggered flow.
             */
            public fun scheduleOffset(scheduleOffset: Number)

            /**
             * @param scheduleStartTime The time at which the scheduled flow starts. The time is
             *   formatted as a timestamp that follows the ISO 8601 standard, such as
             *   `2022-04-26T13:00:00-07:00` .
             */
            ...
            /**
             * @param timeZone Specifies the time zone used when referring to the dates and times of
             *   a scheduled flow, such as `America/New_York` . This time zone is only a descriptive
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ScheduledTriggerPropertiesProperty
            ): software.amazon.awscdk.services.appflow.CfnFlow.ScheduledTriggerPropertiesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface PardotSourcePropertiesProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: PardotSourcePropertiesProperty
            ): software.amazon.awscdk.services.appflow.CfnFlow.PardotSourcePropertiesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface RedshiftDestinationPropertiesProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param errorHandlingConfig The settings that determine how Amazon AppFlow handles an
             *   error when placing data in the Amazon Redshift destination. For example, this
             *   setting would determine if the flow should fail after one insertion error, or
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RedshiftDestinationPropertiesProperty
            ): software.amazon.awscdk.services.appflow.CfnFlow.RedshiftDestinationPropertiesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DataTransferApiProperty {
         ...
         *   small to large. For each flow run, Amazon AppFlow chooses to use the SYNC or ASYNC API
         *   type based on the amount of data that the run transfers.
        ...
        public interface Builder {
             ...
             *   from small to large. For each flow run, Amazon AppFlow chooses to use the SYNC or
             *   ASYNC API type based on the amount of data that the run transfers.
             * * **SYNC** - A synchronous API. This type of API optimizes a flow for small to
             *   medium-sized datasets.
             * * **ASYNC** - An asynchronous API. This type of API optimizes a flow for large
             *   datasets.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DataTransferApiProperty
            ): software.amazon.awscdk.services.appflow.CfnFlow.DataTransferApiProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface AggregationConfigProperty {
         ...
         * file sizes might differ from this target based on the number and size of the records that
         * each file contains.
         *
        ...
        public interface Builder {
            /**
             * @param aggregationType Specifies whether Amazon AppFlow aggregates the flow records
             ...
             *   AppFlow writes to the flow destination. For each file, Amazon AppFlow attempts to
             *   achieve the size that you specify. The actual file sizes might differ from this
        ...
        internal constructor(
             ...
             * flow destination.
             *
             * For each file, Amazon AppFlow attempts to achieve the size that you specify. The
             * actual file sizes might differ from this target based on the number and size of the
             * records that each file contains.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appflow-flow-aggregationconfig.html#cfn-appflow-flow-aggregationconfig-targetfilesize)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AggregationConfigProperty
            ): software.amazon.awscdk.services.appflow.CfnFlow.AggregationConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DestinationConnectorPropertiesProperty {
        ...
        public interface Builder {
            /**
             * @param customConnector The properties that are required to query the custom
             *   Connector.
             */
            ...
            public fun customConnector(
                customConnector: CustomConnectorDestinationPropertiesProperty.Builder.() -> Unit
            )
            ...
            public fun eventBridge(
                eventBridge: EventBridgeDestinationPropertiesProperty.Builder.() -> Unit
            )
            ...
            public fun lookoutMetrics(
                lookoutMetrics: LookoutMetricsDestinationPropertiesProperty.Builder.() -> Unit
            )
            ...
            public fun salesforce(
                salesforce: SalesforceDestinationPropertiesProperty.Builder.() -> Unit
            )
            ...
            public fun snowflake(
                snowflake: SnowflakeDestinationPropertiesProperty.Builder.() -> Unit
            )
        ...
        private class BuilderImpl : Builder {
             ...
             *   Connector.
             */
            override fun customConnector(
                customConnector: CustomConnectorDestinationPropertiesProperty
            ) {
                cdkBuilder.customConnector(
                    customConnector.let(CustomConnectorDestinationPropertiesProperty::unwrap)
                )
            }
            ...
            override fun eventBridge(eventBridge: EventBridgeDestinationPropertiesProperty) {
                cdkBuilder.eventBridge(
                    eventBridge.let(EventBridgeDestinationPropertiesProperty::unwrap)
                )
            }
             ...
             * @param lookoutMetrics The properties required to query Amazon Lookout for Metrics.
             */
            override fun lookoutMetrics(
                lookoutMetrics: LookoutMetricsDestinationPropertiesProperty
            ) {
                cdkBuilder.lookoutMetrics(
                    lookoutMetrics.let(LookoutMetricsDestinationPropertiesProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("ddb7f960e42c6343202933471ed9ab5339c32b041122e0dfbc29fe225a7e6749")
            override fun marketo(
                marketo: MarketoDestinationPropertiesProperty.Builder.() -> Unit
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("33d66fe5ccb9f40788193c3a72e5c940bb03a9acb942bd6be1b0d2bcc2441cff")
            override fun redshift(
                redshift: RedshiftDestinationPropertiesProperty.Builder.() -> Unit
            ...
            override fun salesforce(salesforce: SalesforceDestinationPropertiesProperty) {
                cdkBuilder.salesforce(
                    salesforce.let(SalesforceDestinationPropertiesProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("de7b5f9dbccba5f14b09ab028d85497fcd4ecf9714f59b00b55f144158a3b128")
            override fun sapoData(
                sapoData: SAPODataDestinationPropertiesProperty.Builder.() -> Unit
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("fcca6f0fd0c4540433e2a7534845fc07f1c5285b6dcc8c3082832b40867bc5f2")
            override fun upsolver(
                upsolver: UpsolverDestinationPropertiesProperty.Builder.() -> Unit
            ...
            override fun zendesk(
                zendesk: ZendeskDestinationPropertiesProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DestinationConnectorPropertiesProperty
            ): software.amazon.awscdk.services.appflow.CfnFlow.DestinationConnectorPropertiesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SalesforceDestinationPropertiesProperty {
         ...
         *   number of records that your flow transfers to Salesforce. If your flow transfers fewer
         *   than 1,000 records, Amazon AppFlow uses Salesforce REST API. If your flow transfers
         *   1,000 records or more, Amazon AppFlow uses Salesforce Bulk API 2.0.
         *
         ...
         * day to transfer 900 records, and it might use Bulk API 2.0 on the next day to transfer
         * 1,100 records. For each of these flow runs, the respective Salesforce API formats the
         ...
         *   asynchronous data transfers, and it's optimal for large sets of data. By choosing this
         ...
         *   you ensure that your flow writes consistent output, but you decrease performance for
         *   large data transfers that are better suited for Bulk API 2.0. In some cases, if your
         *   flow attempts to transfer a vary large set of data, it might fail with a timed out
         *   error.
         *
        ...
        public interface Builder {
            /**
             * @param dataTransferApi Specifies which Salesforce API is used by Amazon AppFlow when
             ...
             * API on one day to transfer 900 records, and it might use Bulk API 2.0 on the next day
             * to transfer 1,100 records. For each of these flow runs, the respective Salesforce API
             * formats the data differently. Some of the differences include how dates are formatted
             * and null values are represented. Also, Bulk API 2.0 doesn't transfer Salesforce
             * compound fields.
             *
             * By choosing this option, you optimize flow performance for both small and large data
             * transfers, but the tradeoff is inconsistent formatting in the output.
             * * **BULKV2** - Amazon AppFlow uses only Salesforce Bulk API 2.0. This API runs
             *   asynchronous data transfers, and it's optimal for large sets of data. By choosing
             *   this option, you ensure that your flow writes consistent output, but you optimize
             *   performance only for large data transfers.
             *
             * Note that Bulk API 2.0 does not transfer Salesforce compound fields.
            ...
            /**
             * @param errorHandlingConfig The settings that determine how Amazon AppFlow handles an
             *   error when placing data in the Salesforce destination. For example, this setting
             *   would determine if the flow should fail after one insertion error, or continue and
             *   attempt to insert every record regardless of the initial failure.
             *   `ErrorHandlingConfig` is a part of the destination connector details.
             */
            ...
            /**
             * @param writeOperationType This specifies the type of write operation to be performed
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SalesforceDestinationPropertiesProperty
            ): software.amazon.awscdk.services.appflow.CfnFlow.SalesforceDestinationPropertiesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface GoogleAnalyticsSourcePropertiesProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: GoogleAnalyticsSourcePropertiesProperty
            ): software.amazon.awscdk.services.appflow.CfnFlow.GoogleAnalyticsSourcePropertiesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SourceFlowConfigProperty {
        ...
        public interface Builder {
            /**
             * @param apiVersion The API version of the connector when it's used as a source in the
             *   flow.
             */
            public fun apiVersion(apiVersion: String)

            /**
             * @param connectorProfileName The name of the connector profile. This name must be
            ...
            /**
             * @param incrementalPullConfig Defines the configuration for a scheduled incremental
             *   data pull. If a valid configuration is provided, the fields specified in the
            ...
            public fun incrementalPullConfig(
                incrementalPullConfig: IncrementalPullConfigProperty.Builder.() -> Unit
            )

            /**
             * @param sourceConnectorProperties Specifies the information that is required to query
             *   a particular source connector.
             */
            ...
            public fun sourceConnectorProperties(
                sourceConnectorProperties: SourceConnectorPropertiesProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
             ...
             *   configuration are used when querying for the incremental data pull.
             */
            override fun incrementalPullConfig(
                incrementalPullConfig: IncrementalPullConfigProperty
            ) {
                cdkBuilder.incrementalPullConfig(
                    incrementalPullConfig.let(IncrementalPullConfigProperty::unwrap)
                )
            }
            ...
            override fun sourceConnectorProperties(sourceConnectorProperties: IResolvable) {
                cdkBuilder.sourceConnectorProperties(
                    sourceConnectorProperties.let(IResolvable::unwrap)
                )
            }
             ...
             *   a particular source connector.
             */
            override fun sourceConnectorProperties(
                sourceConnectorProperties: SourceConnectorPropertiesProperty
            ) {
                cdkBuilder.sourceConnectorProperties(
                    sourceConnectorProperties.let(SourceConnectorPropertiesProperty::unwrap)
                )
            }
            ...
            override fun sourceConnectorProperties(
                ...
                sourceConnectorProperties(
                    SourceConnectorPropertiesProperty(sourceConnectorProperties)
                )
        ...
        internal constructor(
             ...
             * Defines the configuration for a scheduled incremental data pull.
             *
             * If a valid configuration is provided, the fields specified in the configuration are
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appflow-flow-sourceflowconfig.html#cfn-appflow-flow-sourceflowconfig-sourceconnectorproperties)
             */
            override fun sourceConnectorProperties(): Any =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SourceFlowConfigProperty
            ): software.amazon.awscdk.services.appflow.CfnFlow.SourceFlowConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SalesforceSourcePropertiesProperty {
        /**
         * Specifies which Salesforce API is used by Amazon AppFlow when your flow transfers data
         * from Salesforce.
         * * **AUTOMATIC** - The default. Amazon AppFlow selects which API to use based on the
         *   number of records that your flow transfers from Salesforce. If your flow transfers
         *   fewer than 1,000,000 records, Amazon AppFlow uses Salesforce REST API. If your flow
         *   transfers 1,000,000 records or more, Amazon AppFlow uses Salesforce Bulk API 2.0.
         *
         * Each of these Salesforce APIs structures data differently. If Amazon AppFlow selects the
         * API automatically, be aware that, for recurring flows, the data output might vary from
         * one flow run to the next. For example, if a flow runs daily, it might use REST API on one
         * day to transfer 900,000 records, and it might use Bulk API 2.0 on the next day to
         * transfer 1,100,000 records. For each of these flow runs, the respective Salesforce API
         * formats the data differently. Some of the differences include how dates are formatted and
         * null values are represented. Also, Bulk API 2.0 doesn't transfer Salesforce compound
         * fields.
         *
         * By choosing this option, you optimize flow performance for both small and large data
         * transfers, but the tradeoff is inconsistent formatting in the output.
         ...
         *   you ensure that your flow writes consistent output, but you decrease performance for
         *   large data transfers that are better suited for Bulk API 2.0. In some cases, if your
         *   flow attempts to transfer a vary large set of data, it might fail wituh a timed out
         *   error.
         *
        ...
        public interface Builder {
             ...
             * transfer Salesforce compound fields.
             *
             * By choosing this option, you optimize flow performance for both small and large data
             * transfers, but the tradeoff is inconsistent formatting in the output.
             * * **BULKV2** - Amazon AppFlow uses only Salesforce Bulk API 2.0. This API runs
            ...
            /**
             * @param enableDynamicFieldUpdate The flag that enables dynamic fetching of new
             *   (recently added) fields in the Salesforce objects while running a flow.
             */
            ...
            /**
             * @param includeDeletedRecords Indicates whether Amazon AppFlow includes deleted files
             *   in the flow run.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            override fun enableDynamicFieldUpdate(enableDynamicFieldUpdate: IResolvable) {
                cdkBuilder.enableDynamicFieldUpdate(
                    enableDynamicFieldUpdate.let(IResolvable::unwrap)
                )
            }
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appflow-flow-salesforcesourceproperties.html#cfn-appflow-flow-salesforcesourceproperties-enabledynamicfieldupdate)
             */
            override fun enableDynamicFieldUpdate(): Any? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SalesforceSourcePropertiesProperty
            ): software.amazon.awscdk.services.appflow.CfnFlow.SalesforceSourcePropertiesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface TriggerConfigProperty {
        ...
        public interface Builder {
            /**
             * @param triggerProperties Specifies the configuration details of a schedule-triggered
            ...
            public fun triggerProperties(
                triggerProperties: ScheduledTriggerPropertiesProperty.Builder.() -> Unit
            )
        ...
        private class BuilderImpl : Builder {
            ...
            override fun triggerProperties(triggerProperties: ScheduledTriggerPropertiesProperty) {
                cdkBuilder.triggerProperties(
                    triggerProperties.let(ScheduledTriggerPropertiesProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("c76fa0bed44d3944999469fd8cd418aabb485e72ca02b7e619160a121612d55c")
            override fun triggerProperties(
                triggerProperties: ScheduledTriggerPropertiesProperty.Builder.() -> Unit
    ...
    public interface SuccessResponseHandlingConfigProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SuccessResponseHandlingConfigProperty
            ): software.amazon.awscdk.services.appflow.CfnFlow.SuccessResponseHandlingConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ConnectorOperatorProperty {
        ...
        public interface Builder {
            /**
             * @param amplitude The operation to be performed on the provided Amplitude source
             *   fields.
             */
            ...
            /**
             * @param dynatrace The operation to be performed on the provided Dynatrace source
             *   fields.
             */
            ...
            /**
             * @param inforNexus The operation to be performed on the provided Infor Nexus source
             *   fields.
             */
            ...
            /**
             * @param salesforce The operation to be performed on the provided Salesforce source
             *   fields.
             */
            ...
            /**
             * @param serviceNow The operation to be performed on the provided ServiceNow source
             *   fields.
             */
            ...
            /**
             * @param trendmicro The operation to be performed on the provided Trend Micro source
             *   fields.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ConnectorOperatorProperty
            ): software.amazon.awscdk.services.appflow.CfnFlow.ConnectorOperatorProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SourceConnectorPropertiesProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param customConnector The properties that are applied when the custom connector is
            ...
            public fun customConnector(
                customConnector: CustomConnectorSourcePropertiesProperty.Builder.() -> Unit
            )
            ...
            public fun googleAnalytics(
                googleAnalytics: GoogleAnalyticsSourcePropertiesProperty.Builder.() -> Unit
            )

            /**
             * @param inforNexus Specifies the information that is required for querying Infor
             *   Nexus.
             */
            ...
            /**
             * @param pardot Specifies the information that is required for querying Salesforce
             *   Pardot.
             */
            ...
            /**
             * @param trendmicro Specifies the information that is required for querying Trend
             *   Micro.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("bb35f6b9258846219cd95dafd31c938237d36e4ce3a1556c95a1d6aecd0e685d")
            override fun amplitude(
                amplitude: AmplitudeSourcePropertiesProperty.Builder.() -> Unit
            ): Unit = amplitude(AmplitudeSourcePropertiesProperty(amplitude))
            ...
            override fun customConnector(customConnector: CustomConnectorSourcePropertiesProperty) {
                cdkBuilder.customConnector(
                    customConnector.let(CustomConnectorSourcePropertiesProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("76208df19bab6e17a6e8a02e32038b136a2a9b7a69c47685c80a73e5c6425241")
            override fun datadog(
                datadog: DatadogSourcePropertiesProperty.Builder.() -> Unit
            ): Unit = datadog(DatadogSourcePropertiesProperty(datadog))
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("b1445c43826d94c7ef49bb243f14573a49dcff09184d1efdeda0b496c44189aa")
            override fun dynatrace(
                dynatrace: DynatraceSourcePropertiesProperty.Builder.() -> Unit
            ): Unit = dynatrace(DynatraceSourcePropertiesProperty(dynatrace))
            ...
            override fun googleAnalytics(googleAnalytics: GoogleAnalyticsSourcePropertiesProperty) {
                cdkBuilder.googleAnalytics(
                    googleAnalytics.let(GoogleAnalyticsSourcePropertiesProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("84905cc9ed238b015f19c3f2d8cfa80479df95f8d3c59443545e1ab0361bc716")
            override fun inforNexus(
                inforNexus: InforNexusSourcePropertiesProperty.Builder.() -> Unit
            ...
            @JvmName("eac2e3a380aeb37be1d0995732bab83aa975dc082f8bc73343b5b65fd09261d0")
            override fun marketo(
                marketo: MarketoSourcePropertiesProperty.Builder.() -> Unit
            ): Unit = marketo(MarketoSourcePropertiesProperty(marketo))
            ...
            @JvmName("84e751dbcc66ddddff42ae7200a0ed44711f742d4dfe05bf70c561b8114859ad")
            override fun salesforce(
                salesforce: SalesforceSourcePropertiesProperty.Builder.() -> Unit
            ...
            @JvmName("a91720667417ba79f50c8a6a05f832fc8455bdcf61489a13ee475a30fde1898b")
            override fun sapoData(
                sapoData: SAPODataSourcePropertiesProperty.Builder.() -> Unit
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("12b7a21810002ad5992a3ab65c20388543a23a79848ae6db912cb4035142695f")
            override fun serviceNow(
                serviceNow: ServiceNowSourcePropertiesProperty.Builder.() -> Unit
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("64c9d9db11035899e00f8dfeb0ccd08f8dc0169446816393aef91944bb0ca885")
            override fun singular(
                singular: SingularSourcePropertiesProperty.Builder.() -> Unit
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("1af1b3f8977ca1403cdaea86cbe2044fdc85d748515000d7070bb0dc50d878da")
            override fun trendmicro(
                trendmicro: TrendmicroSourcePropertiesProperty.Builder.() -> Unit
            ...
            @JvmName("95326e224b4f1217bf7962e047c13e31d49b9488908b39bd4918c5743554e103")
            override fun zendesk(
                zendesk: ZendeskSourcePropertiesProperty.Builder.() -> Unit
            ): Unit = zendesk(ZendeskSourcePropertiesProperty(zendesk))
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SourceConnectorPropertiesProperty
            ): software.amazon.awscdk.services.appflow.CfnFlow.SourceConnectorPropertiesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface UpsolverDestinationPropertiesProperty {
        ...
        public interface Builder {
            /**
             * @param bucketName The Upsolver Amazon S3 bucket name in which Amazon AppFlow places
             *   the transferred data.
             */
            public fun bucketName(bucketName: String)

            /**
             * @param bucketPrefix The object key for the destination Upsolver Amazon S3 bucket in
             *   which Amazon AppFlow places the files.
             */
            public fun bucketPrefix(bucketPrefix: String)

            /**
             * @param s3OutputFormatConfig The configuration that determines how data is formatted
             *   when Upsolver is used as the flow destination.
             */
            ...
            public fun s3OutputFormatConfig(
                s3OutputFormatConfig: UpsolverS3OutputFormatConfigProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
             ...
             *   when Upsolver is used as the flow destination.
             */
            override fun s3OutputFormatConfig(
                s3OutputFormatConfig: UpsolverS3OutputFormatConfigProperty
            ) {
                cdkBuilder.s3OutputFormatConfig(
                    s3OutputFormatConfig.let(UpsolverS3OutputFormatConfigProperty::unwrap)
                )
            }
            ...
            override fun s3OutputFormatConfig(
                ...
                s3OutputFormatConfig(UpsolverS3OutputFormatConfigProperty(s3OutputFormatConfig))
        ...
        internal constructor(
            ...
            /**
             * The configuration that determines how data is formatted when Upsolver is used as the
             * flow destination.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appflow-flow-upsolverdestinationproperties.html#cfn-appflow-flow-upsolverdestinationproperties-s3outputformatconfig)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: UpsolverDestinationPropertiesProperty
            ): software.amazon.awscdk.services.appflow.CfnFlow.UpsolverDestinationPropertiesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SAPODataPaginationConfigProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SAPODataPaginationConfigProperty
            ): software.amazon.awscdk.services.appflow.CfnFlow.SAPODataPaginationConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface MetadataCatalogConfigProperty {
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("3d03272fda4f639d1966ee835a77c0951c3b8ecd7142f46054faa44cc8f1f5ee")
            override fun glueDataCatalog(
                glueDataCatalog: GlueDataCatalogProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: MetadataCatalogConfigProperty
            ): software.amazon.awscdk.services.appflow.CfnFlow.MetadataCatalogConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ZendeskDestinationPropertiesProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param idFieldNames A list of field names that can be used as an ID field when
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ZendeskDestinationPropertiesProperty
            ): software.amazon.awscdk.services.appflow.CfnFlow.ZendeskDestinationPropertiesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface S3SourcePropertiesProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param bucketPrefix The object key for the Amazon S3 bucket in which the source files
             *   are stored.
             */
            public fun bucketPrefix(bucketPrefix: String)

            /**
             * @param s3InputFormatConfig When you use Amazon S3 as the source, the configuration
            ...
            public fun s3InputFormatConfig(
                s3InputFormatConfig: S3InputFormatConfigProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun s3InputFormatConfig(s3InputFormatConfig: S3InputFormatConfigProperty) {
                cdkBuilder.s3InputFormatConfig(
                    s3InputFormatConfig.let(S3InputFormatConfigProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("cb960761c4562e4c834f462f61e54872b320143be2d33df8bdfde92e5f0a21e4")
            override fun s3InputFormatConfig(
                s3InputFormatConfig: S3InputFormatConfigProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: S3SourcePropertiesProperty
            ): software.amazon.awscdk.services.appflow.CfnFlow.S3SourcePropertiesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SAPODataDestinationPropertiesProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param successResponseHandlingConfig Determines how Amazon AppFlow handles the
             *   success response that it gets from the connector after placing data. For example,
             ...
             *   connector upon a successful insert operation.
             */
            public fun successResponseHandlingConfig(
            ...
            public fun successResponseHandlingConfig(
                successResponseHandlingConfig:
                    SuccessResponseHandlingConfigProperty.Builder.() -> Unit
            )
        ...
        private class BuilderImpl : Builder {
            ...
            override fun successResponseHandlingConfig(successResponseHandlingConfig: IResolvable) {
                cdkBuilder.successResponseHandlingConfig(
                    successResponseHandlingConfig.let(IResolvable::unwrap)
                )
            }
             ...
             *   connector upon a successful insert operation.
             */
            override fun successResponseHandlingConfig(
                successResponseHandlingConfig: SuccessResponseHandlingConfigProperty
            ) {
                cdkBuilder.successResponseHandlingConfig(
                    successResponseHandlingConfig.let(SuccessResponseHandlingConfigProperty::unwrap)
                )
            }
            ...
            override fun successResponseHandlingConfig(
                ...
                successResponseHandlingConfig(
                    SuccessResponseHandlingConfigProperty(successResponseHandlingConfig)
                )
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SAPODataDestinationPropertiesProperty
            ): software.amazon.awscdk.services.appflow.CfnFlow.SAPODataDestinationPropertiesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ErrorHandlingConfigProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param failOnFirstError Specifies if the flow should fail after the first instance of
             *   a failure when attempting to place data in the destination.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ErrorHandlingConfigProperty
            ): software.amazon.awscdk.services.appflow.CfnFlow.ErrorHandlingConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SlackSourcePropertiesProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SlackSourcePropertiesProperty
            ): software.amazon.awscdk.services.appflow.CfnFlow.SlackSourcePropertiesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface InforNexusSourcePropertiesProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: InforNexusSourcePropertiesProperty
            ): software.amazon.awscdk.services.appflow.CfnFlow.InforNexusSourcePropertiesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface S3OutputFormatConfigProperty {
         ...
         *   Amazon S3. For example, an integer of `1` in your source data becomes the string `"1"`
         *   in the output.
         *
        ...
        public interface Builder {
            /**
             * @param aggregationConfig The aggregation settings that you can use to customize the
             *   output format of your flow data.
             */
            ...
            public fun aggregationConfig(
                aggregationConfig: AggregationConfigProperty.Builder.() -> Unit
            )

            /**
             * @param fileType Indicates the file type that Amazon AppFlow places in the Amazon S3
             *   bucket.
             */
            public fun fileType(fileType: String)

            /**
             * @param prefixConfig Determines the prefix that Amazon AppFlow applies to the folder
             *   name in the Amazon S3 bucket. You can name folders according to the flow frequency
             *   and date.
             */
            ...
            /**
             * @param preserveSourceDataTyping If your file output format is Parquet, use this
             *   parameter to set whether Amazon AppFlow preserves the data types in your source
             *   data when it writes the output to Amazon S3.
             * * `true` : Amazon AppFlow preserves the data types when it writes to Amazon S3. For
             *   example, an integer or `1` in your source data is still an integer in your output.
             * * `false` : Amazon AppFlow converts all of the source data into strings when it
             *   writes to Amazon S3. For example, an integer of `1` in your source data becomes the
        ...
        private class BuilderImpl : Builder {
            ...
            override fun aggregationConfig(aggregationConfig: AggregationConfigProperty) {
                cdkBuilder.aggregationConfig(
                    aggregationConfig.let(AggregationConfigProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("0564152b3d063bbba319273050c642c0f297b19c27a6cb573d3880d14d33aae5")
            override fun aggregationConfig(
                aggregationConfig: AggregationConfigProperty.Builder.() -> Unit
            ...
            override fun preserveSourceDataTyping(preserveSourceDataTyping: IResolvable) {
                cdkBuilder.preserveSourceDataTyping(
                    preserveSourceDataTyping.let(IResolvable::unwrap)
                )
            }
        ...
        internal constructor(
             ...
             * AppFlow preserves the data types in your source data when it writes the output to
             * Amazon S3.
             * * `true` : Amazon AppFlow preserves the data types when it writes to Amazon S3. For
             *   example, an integer or `1` in your source data is still an integer in your output.
             * * `false` : Amazon AppFlow converts all of the source data into strings when it
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appflow-flow-s3outputformatconfig.html#cfn-appflow-flow-s3outputformatconfig-preservesourcedatatyping)
             */
            override fun preserveSourceDataTyping(): Any? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: S3OutputFormatConfigProperty
            ): software.amazon.awscdk.services.appflow.CfnFlow.S3OutputFormatConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface UpsolverS3OutputFormatConfigProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param fileType Indicates the file type that Amazon AppFlow places in the Upsolver
             *   Amazon S3 bucket.
             */
            public fun fileType(fileType: String)

            /**
             * @param prefixConfig Specifies elements that Amazon AppFlow includes in the file and
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: UpsolverS3OutputFormatConfigProperty
            ): software.amazon.awscdk.services.appflow.CfnFlow.UpsolverS3OutputFormatConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface S3InputFormatConfigProperty {
        ...
        public interface Builder {
            /**
             * @param s3InputFileType The file type that Amazon AppFlow gets from your Amazon S3
             *   bucket.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: S3InputFormatConfigProperty
            ): software.amazon.awscdk.services.appflow.CfnFlow.S3InputFormatConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DatadogSourcePropertiesProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DatadogSourcePropertiesProperty
            ): software.amazon.awscdk.services.appflow.CfnFlow.DatadogSourcePropertiesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SingularSourcePropertiesProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SingularSourcePropertiesProperty
            ): software.amazon.awscdk.services.appflow.CfnFlow.SingularSourcePropertiesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DestinationFlowConfigProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param connectorType The type of destination connector, such as Sales force, Amazon
             *   S3, and so on.
             */
            public fun connectorType(connectorType: String)

            /**
             * @param destinationConnectorProperties This stores the information that is required to
             *   query a particular connector.
             */
            ...
            public fun destinationConnectorProperties(
                destinationConnectorProperties:
                    DestinationConnectorPropertiesProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
             ...
             *   query a particular connector.
             */
            override fun destinationConnectorProperties(
                destinationConnectorProperties: IResolvable
            ) {
                cdkBuilder.destinationConnectorProperties(
                    destinationConnectorProperties.let(IResolvable::unwrap)
                )
            }
            ...
            override fun destinationConnectorProperties(
                ...
                cdkBuilder.destinationConnectorProperties(
                    destinationConnectorProperties.let(
                        DestinationConnectorPropertiesProperty::unwrap
                    )
                )
            }
            ...
            override fun destinationConnectorProperties(
                ...
                destinationConnectorProperties(
                    DestinationConnectorPropertiesProperty(destinationConnectorProperties)
                )
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DestinationFlowConfigProperty
            ): software.amazon.awscdk.services.appflow.CfnFlow.DestinationFlowConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface GlueDataCatalogProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: GlueDataCatalogProperty
            ): software.amazon.awscdk.services.appflow.CfnFlow.GlueDataCatalogProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface S3DestinationPropertiesProperty {
        ...
        public interface Builder {
            /**
             * @param bucketName The Amazon S3 bucket name in which Amazon AppFlow places the
             *   transferred data.
             */
            public fun bucketName(bucketName: String)
            ...
            /**
             * @param s3OutputFormatConfig The configuration that determines how Amazon AppFlow
             *   should format the flow output data when Amazon S3 is used as the destination.
             */
            public fun s3OutputFormatConfig(s3OutputFormatConfig: IResolvable)
            ...
            public fun s3OutputFormatConfig(
                s3OutputFormatConfig: S3OutputFormatConfigProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun s3OutputFormatConfig(s3OutputFormatConfig: S3OutputFormatConfigProperty) {
                cdkBuilder.s3OutputFormatConfig(
                    s3OutputFormatConfig.let(S3OutputFormatConfigProperty::unwrap)
                )
            }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: S3DestinationPropertiesProperty
            ): software.amazon.awscdk.services.appflow.CfnFlow.S3DestinationPropertiesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface TaskPropertiesObjectProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TaskPropertiesObjectProperty
            ): software.amazon.awscdk.services.appflow.CfnFlow.TaskPropertiesObjectProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
