...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param description Any descriptive information that you want to add to the channel for
    ...
    private class BuilderImpl(
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("a1cc6a4df1a4648db43d3aff87ead5bb75c6d116955a455cb6f77090b6136e8b")
        override fun ingressAccessLogs(
            ingressAccessLogs: LogConfigurationProperty.Builder.() -> Unit
        ...
        public fun build(): software.amazon.awscdk.services.mediapackage.CfnChannel =
            cdkBuilder.build()
    }
    ...
    public interface IngestEndpointProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: IngestEndpointProperty
            ): software.amazon.awscdk.services.mediapackage.CfnChannel.IngestEndpointProperty =
