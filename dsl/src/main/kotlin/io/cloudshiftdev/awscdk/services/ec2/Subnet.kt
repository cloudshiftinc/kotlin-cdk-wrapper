...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.ec2.Subnet,
     ...
     *
     * Upon creation, this is the default ACL which allows all traffic, except explicit DENY entries
     * that you add.
     *
     * You can replace it with a custom ACL which denies all traffic except the explicit ALLOW
     * entries that you add by creating a `NetworkAcl` object and calling `associateNetworkAcl()`.
     */
    ...
    public interface Builder {
         ...
         *
         * @param mapPublicIpOnLaunch Controls if a public IP is associated to an instance at
         *   launch.
         */
    ...
    public companion object {
        public fun fromSubnetAttributes(
            ...
            software.amazon.awscdk.services.ec2.Subnet.fromSubnetAttributes(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    attrs.let(SubnetAttributes::unwrap)
                )
                .let(ISubnet::wrap)
        ...
        public fun fromSubnetId(
            ...
            software.amazon.awscdk.services.ec2.Subnet.fromSubnetId(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    subnetId
                )
