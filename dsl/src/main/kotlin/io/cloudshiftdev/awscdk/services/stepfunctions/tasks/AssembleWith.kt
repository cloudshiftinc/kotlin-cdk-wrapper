...
public enum class AssembleWith(
    ...
    public companion object {
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.AssembleWith
        ): AssembleWith =
            when (cdkObject) {
                software.amazon.awscdk.services.stepfunctions.tasks.AssembleWith.NONE ->
                    AssembleWith.NONE
                software.amazon.awscdk.services.stepfunctions.tasks.AssembleWith.LINE ->
                    AssembleWith.LINE
            }

        internal fun unwrap(
            wrapped: AssembleWith
