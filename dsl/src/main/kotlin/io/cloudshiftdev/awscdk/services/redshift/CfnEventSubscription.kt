...
internal constructor(
     ...
     * subscription.
     */
    public open fun eventCategories(): List<String> =
        unwrap(this).getEventCategories() ?: emptyList()
     ...
     * subscription.
     */
    public open fun eventCategories(vararg `value`: String): Unit =
        eventCategories(`value`.toList())
    ...
    public interface Builder {
         ...
         * A boolean value;
         *
         * set to `true` to activate the subscription, and set to `false` to create the subscription
         * but not activate it.
         *
         ...
         *
         * @param eventCategories Specifies the Amazon Redshift event categories to be published by
         ...
         * A list of one or more identifiers of Amazon Redshift source objects.
         *
         * All of the objects must be of the same type as was specified in the source type
         * parameter. The event subscription will return only events generated by the specified
         * objects. If not specified, then events are returned for all objects within the source
         * type specified.
         *
         ...
         * The type of source that will be generating the events.
         *
         * For example, if you want to be notified of events generated by a cluster, you would set
         * this parameter to cluster. If this value is not specified, events are returned for all
         * Amazon Redshift objects in your AWS account . You must specify a source type in order to
         * specify source IDs.
         *
