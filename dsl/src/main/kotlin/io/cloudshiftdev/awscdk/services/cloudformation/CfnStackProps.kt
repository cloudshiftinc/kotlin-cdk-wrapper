...
public interface CfnStackProps {
  ...
  private class BuilderImpl : Builder {
    private val cdkBuilder: software.amazon.awscdk.services.cloudformation.CfnStackProps.Builder =
        software.amazon.awscdk.services.cloudformation.CfnStackProps.builder()
    ...
    public fun build(): software.amazon.awscdk.services.cloudformation.CfnStackProps =
        cdkBuilder.build()
  }
  ...
  public companion object {
    ...
    internal fun wrap(cdkObject: software.amazon.awscdk.services.cloudformation.CfnStackProps):
        CfnStackProps = Wrapper(cdkObject)

    internal fun unwrap(wrapped: CfnStackProps):
        software.amazon.awscdk.services.cloudformation.CfnStackProps = (wrapped as
        CdkObject).cdkObject as software.amazon.awscdk.services.cloudformation.CfnStackProps
  }
}
