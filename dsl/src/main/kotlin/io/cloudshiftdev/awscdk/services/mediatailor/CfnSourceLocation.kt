...
internal constructor(
    ...
    public open fun accessConfiguration(
        `value`: AccessConfigurationProperty.Builder.() -> Unit
    ): Unit = accessConfiguration(AccessConfigurationProperty(`value`))
    ...
    /** The default segment delivery configuration. */
    public open fun defaultSegmentDeliveryConfiguration(
        `value`: DefaultSegmentDeliveryConfigurationProperty
    ) {
        unwrap(this)
            .setDefaultSegmentDeliveryConfiguration(
                `value`.let(DefaultSegmentDeliveryConfigurationProperty::unwrap)
            )
    }
    ...
    public open fun defaultSegmentDeliveryConfiguration(
        `value`: DefaultSegmentDeliveryConfigurationProperty.Builder.() -> Unit
    ): Unit =
    ...
    public interface Builder {
        ...
        public fun accessConfiguration(
            accessConfiguration: AccessConfigurationProperty.Builder.() -> Unit
        )
        ...
        public fun defaultSegmentDeliveryConfiguration(
            defaultSegmentDeliveryConfiguration:
                DefaultSegmentDeliveryConfigurationProperty.Builder.() -> Unit
        )
        ...
        public fun httpConfiguration(
            httpConfiguration: HttpConfigurationProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
        ...
        override fun accessConfiguration(accessConfiguration: AccessConfigurationProperty) {
            cdkBuilder.accessConfiguration(
                accessConfiguration.let(AccessConfigurationProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("f7a88d145bc10a5f5f2f903b775091902ea3ff0a961a7aeeb328bd12627aed70")
        override fun accessConfiguration(
            accessConfiguration: AccessConfigurationProperty.Builder.() -> Unit
         ...
         * @param defaultSegmentDeliveryConfiguration The default segment delivery configuration.
         */
        override fun defaultSegmentDeliveryConfiguration(
            defaultSegmentDeliveryConfiguration: IResolvable
        ) {
            cdkBuilder.defaultSegmentDeliveryConfiguration(
                defaultSegmentDeliveryConfiguration.let(IResolvable::unwrap)
            )
        }
        ...
        override fun defaultSegmentDeliveryConfiguration(
            ...
            cdkBuilder.defaultSegmentDeliveryConfiguration(
                defaultSegmentDeliveryConfiguration.let(
                    DefaultSegmentDeliveryConfigurationProperty::unwrap
                )
            )
        }
        ...
        override fun defaultSegmentDeliveryConfiguration(
            ...
            defaultSegmentDeliveryConfiguration(
                DefaultSegmentDeliveryConfigurationProperty(defaultSegmentDeliveryConfiguration)
            )
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("411543ce488bbe8334be375cc6ac845d6e4a00b8a51c9bdfa215efd6da46bc51")
        override fun httpConfiguration(
            httpConfiguration: HttpConfigurationProperty.Builder.() -> Unit
        ...
        override fun segmentDeliveryConfigurations(segmentDeliveryConfigurations: IResolvable) {
            cdkBuilder.segmentDeliveryConfigurations(
                segmentDeliveryConfigurations.let(IResolvable::unwrap)
            )
        }
         ...
         *   location.
         */
        override fun segmentDeliveryConfigurations(
            vararg segmentDeliveryConfigurations: Any
        ): Unit = segmentDeliveryConfigurations(segmentDeliveryConfigurations.toList())
    ...
    public interface DefaultSegmentDeliveryConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param baseUrl The hostname of the server that will be used to serve segments. This
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DefaultSegmentDeliveryConfigurationProperty
            ): software.amazon.awscdk.services.mediatailor.CfnSourceLocation.DefaultSegmentDeliveryConfigurationProperty =
    ...
    public interface SegmentDeliveryConfigurationProperty {
        /**
         * The base URL of the host or path of the segment delivery server that you're using to
         * serve segments.
         *
         * This is typically a content delivery network (CDN). The URL can be absolute or relative.
         * To use an absolute URL include the protocol, such as `https://example.com/some/path` . To
        ...
        public interface Builder {
            /**
             * @param baseUrl The base URL of the host or path of the segment delivery server that
             *   you're using to serve segments. This is typically a content delivery network (CDN).
        ...
        internal constructor(
             ...
             * serve segments.
             *
             * This is typically a content delivery network (CDN). The URL can be absolute or
             * relative. To use an absolute URL include the protocol, such as
             * `https://example.com/some/path` . To use a relative URL specify the relative path,
             * such as `/some/path*` .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-mediatailor-sourcelocation-segmentdeliveryconfiguration.html#cfn-mediatailor-sourcelocation-segmentdeliveryconfiguration-baseurl)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SegmentDeliveryConfigurationProperty
            ): software.amazon.awscdk.services.mediatailor.CfnSourceLocation.SegmentDeliveryConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SecretsManagerAccessTokenConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param headerName The name of the HTTP header used to supply the access token in
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SecretsManagerAccessTokenConfigurationProperty
            ): software.amazon.awscdk.services.mediatailor.CfnSourceLocation.SecretsManagerAccessTokenConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface HttpConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param baseUrl The base URL for the source location host server. This string must
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: HttpConfigurationProperty
            ): software.amazon.awscdk.services.mediatailor.CfnSourceLocation.HttpConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface AccessConfigurationProperty {
        /**
         * The type of authentication used to access content from `HttpConfiguration::BaseUrl` on
         * your source location. Accepted value: `S3_SIGV4` .
         *
         ...
         * mediatailor.amazonaws.com principal access in IAM. For information about configuring
         * access in IAM, see Access management in the IAM User Guide.
         *
        ...
        public interface Builder {
            ...
            public fun secretsManagerAccessTokenConfiguration(
                secretsManagerAccessTokenConfiguration:
                    SecretsManagerAccessTokenConfigurationProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
             ...
             *   configuration parameters.
             */
            override fun secretsManagerAccessTokenConfiguration(
                secretsManagerAccessTokenConfiguration: IResolvable
            ) {
                cdkBuilder.secretsManagerAccessTokenConfiguration(
                    secretsManagerAccessTokenConfiguration.let(IResolvable::unwrap)
                )
            }
            ...
            override fun secretsManagerAccessTokenConfiguration(
                ...
                cdkBuilder.secretsManagerAccessTokenConfiguration(
                    secretsManagerAccessTokenConfiguration.let(
                        SecretsManagerAccessTokenConfigurationProperty::unwrap
                    )
                )
            }
        ...
        internal constructor(
             ...
             * virtual-style access. If your source location base URL is an Amazon S3 bucket,
             * MediaTailor can use AWS Signature Version 4 (SigV4) authentication to access the
             * bucket where your source content is stored. Your MediaTailor source location baseURL
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AccessConfigurationProperty
            ): software.amazon.awscdk.services.mediatailor.CfnSourceLocation.AccessConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
