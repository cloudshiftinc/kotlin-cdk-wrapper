...
public interface IGatewayVpcEndpoint : IVpcEndpoint {
    ...
    internal constructor(
        internal val cdkObject: software.amazon.awscdk.services.ec2.IGatewayVpcEndpoint,
    ) : IGatewayVpcEndpoint {
        /**
    ...
    public companion object {
        ...
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.ec2.IGatewayVpcEndpoint
        ): IGatewayVpcEndpoint = Wrapper(cdkObject)

        internal fun unwrap(
            wrapped: IGatewayVpcEndpoint
        ): software.amazon.awscdk.services.ec2.IGatewayVpcEndpoint = (wrapped as Wrapper).cdkObject
    }
}
