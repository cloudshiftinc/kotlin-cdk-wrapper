...
public interface ResponseHeadersXSSProtection {
     ...
     *
     * When this setting is true, the value of the X-XSS-Protection header is 1. When this setting
    ...
    public interface Builder {
         ...
         *   X-XSS-Protection HTTP response header received from the origin with the one specified
         ...
         *   response header. When this setting is true, the value of the X-XSS-Protection header
         *   is 1. When this setting is false, the value of the X-XSS-Protection header is 0.
         */
        public fun protection(protection: Boolean)

        /**
         * @param reportUri A reporting URI, which CloudFront uses as the value of the report
         *   directive in the X-XSS-Protection header. You cannot specify a ReportUri when ModeBlock
         *   is true.
         */
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: ResponseHeadersXSSProtection
        ): software.amazon.awscdk.services.cloudfront.ResponseHeadersXSSProtection =
