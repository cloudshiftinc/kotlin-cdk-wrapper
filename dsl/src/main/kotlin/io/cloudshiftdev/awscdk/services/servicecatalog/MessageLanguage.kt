...
public enum class MessageLanguage(
    ...
    public companion object {
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.servicecatalog.MessageLanguage
        ): MessageLanguage =
            when (cdkObject) {
                software.amazon.awscdk.services.servicecatalog.MessageLanguage.EN ->
                    MessageLanguage.EN
                software.amazon.awscdk.services.servicecatalog.MessageLanguage.JP ->
                    MessageLanguage.JP
                software.amazon.awscdk.services.servicecatalog.MessageLanguage.ZH ->
                    MessageLanguage.ZH
            }

        internal fun unwrap(
            wrapped: MessageLanguage
