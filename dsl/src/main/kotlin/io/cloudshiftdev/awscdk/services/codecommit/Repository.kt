...
internal constructor(
    ...
    public open fun notifiyOnPullRequestMerged(
        ...
        unwrap(this)
            .notifiyOnPullRequestMerged(id, target.let(INotificationRuleTarget::unwrap))
    ...
    public open fun notify(arn: String, options: RepositoryTriggerOptions): Repository =
        unwrap(this)
            .notify(arn, options.let(RepositoryTriggerOptions::unwrap))
            .let(Repository::wrap)
    ...
    public open fun notify(
        arn: String,
        options: RepositoryTriggerOptions.Builder.() -> Unit
    ...
    public override fun onCommentOnCommit(
        id: String,
    ...
    public override fun onCommentOnPullRequest(
        id: String,
        options: OnEventOptions.Builder.() -> Unit
    ...
    public override fun onPullRequestStateChange(
        id: String,
        options: OnEventOptions.Builder.() -> Unit
    ...
    public override fun onReferenceCreated(
        id: String,
        options: OnEventOptions.Builder.() -> Unit
    ...
    public override fun onReferenceDeleted(
        id: String,
        options: OnEventOptions.Builder.() -> Unit
    ...
    public override fun onReferenceUpdated(
        id: String,
        options: OnEventOptions.Builder.() -> Unit
    ...
    public interface Builder {
         ...
         *
         * @param code The contents with which to initialize the repository after it has been
         *   created.
         */
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.codecommit.Repository =
            cdkBuilder.build()
    }
    ...
    public companion object {
        ...
        public fun fromRepositoryName(
            ...
            software.amazon.awscdk.services.codecommit.Repository.fromRepositoryName(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    repositoryName
                )
        ...
        ): Repository = Repository(cdkObject)

        internal fun unwrap(
            wrapped: Repository
        ): software.amazon.awscdk.services.codecommit.Repository = wrapped.cdkObject
    }
}
