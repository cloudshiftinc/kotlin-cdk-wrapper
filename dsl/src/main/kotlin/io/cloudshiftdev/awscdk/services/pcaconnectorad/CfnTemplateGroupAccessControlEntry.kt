...
internal constructor(
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnTemplateGroupAccessControlEntry
        ): software.amazon.awscdk.services.pcaconnectorad.CfnTemplateGroupAccessControlEntry =
            wrapped.cdkObject
    }
    ...
    public interface AccessRightsProperty {
        ...
        public interface Builder {
            /**
             * @param autoEnroll Allow or deny an Active Directory group from autoenrolling
             *   certificates issued against a template. The Active Directory group must be allowed
             *   to enroll to allow autoenrollment
             */
            public fun autoEnroll(autoEnroll: String)

            /**
             * @param enroll Allow or deny an Active Directory group from enrolling certificates
             *   issued against a template.
             */
