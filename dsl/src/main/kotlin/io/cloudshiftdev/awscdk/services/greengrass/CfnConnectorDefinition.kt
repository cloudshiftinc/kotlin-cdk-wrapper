...
internal constructor(
    ...
    public open fun initialVersion(
        `value`: ConnectorDefinitionVersionProperty.Builder.() -> Unit
    ...
    public interface Builder {
        ...
        public fun initialVersion(
            initialVersion: ConnectorDefinitionVersionProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.greengrass.CfnConnectorDefinition.Builder.create(
                scope,
                id
            )
        ...
        override fun initialVersion(initialVersion: ConnectorDefinitionVersionProperty) {
            cdkBuilder.initialVersion(
                initialVersion.let(ConnectorDefinitionVersionProperty::unwrap)
            )
        }
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnConnectorDefinition
    ...
    public interface ConnectorProperty {
         ...
         *
         * For more information about connectors provided by AWS , see
        ...
        public interface Builder {
            /**
             * @param connectorArn The Amazon Resource Name (ARN) of the connector. For more
            ...
            /**
             * @param id A descriptive or arbitrary ID for the connector. This value must be unique
             *   within the connector definition version. Maximum length is 128 characters with
             *   pattern `[a-zA-Z0-9:_-]+` .
             */
            public fun id(id: String)

            /**
             * @param parameters The parameters or configuration used by the connector. For more
             *   information about connectors provided by AWS , see
             *   [Greengrass Connectors Provided by AWS](https://docs.aws.amazon.com/greengrass/v1/developerguide/connectors-list.html)
             *   .
             */
        ...
        internal constructor(
             ...
             * A descriptive or arbitrary ID for the connector.
             *
             * This value must be unique within the connector definition version. Maximum length is
    ...
    public interface ConnectorDefinitionVersionProperty {
         ...
         *
         * Only one instance of a given connector can be added to a connector definition version at
         * a time.
         *
        ...
        public interface Builder {
            /**
             * @param connectors The connectors in this version. Only one instance of a given
             *   connector can be added to a connector definition version at a time.
             */
        ...
        internal constructor(
             ...
             * The connectors in this version.
             *
             * Only one instance of a given connector can be added to a connector definition version
             * at a time.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-greengrass-connectordefinition-connectordefinitionversion.html#cfn-greengrass-connectordefinition-connectordefinitionversion-connectors)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ConnectorDefinitionVersionProperty
            ): software.amazon.awscdk.services.greengrass.CfnConnectorDefinition.ConnectorDefinitionVersionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
