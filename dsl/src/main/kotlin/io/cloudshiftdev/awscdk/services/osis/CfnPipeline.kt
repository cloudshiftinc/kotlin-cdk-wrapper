...
internal constructor(
     ...
     */
    public open fun attrIngestEndpointUrls(): List<String> =
        unwrap(this).getAttrIngestEndpointUrls()
    ...
    public open fun logPublishingOptions(
        `value`: LogPublishingOptionsProperty.Builder.() -> Unit
    ...
    public open fun pipelineConfigurationBody(): String =
        unwrap(this).getPipelineConfigurationBody()
    ...
    public interface Builder {
         ...
         * `EncryptionAtRestOptions` . For more information, see
        ...
        public fun logPublishingOptions(
            logPublishingOptions: LogPublishingOptionsProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
        ...
        override fun logPublishingOptions(logPublishingOptions: LogPublishingOptionsProperty) {
            cdkBuilder.logPublishingOptions(
                logPublishingOptions.let(LogPublishingOptionsProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("c08b220362234c4cc0e216143ac2603e48f9251daf1947aeb3a3ce258c859b03")
        override fun logPublishingOptions(
            logPublishingOptions: LogPublishingOptionsProperty.Builder.() -> Unit
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnPipeline
        ): software.amazon.awscdk.services.osis.CfnPipeline = wrapped.cdkObject
    }
    ...
    public interface VpcEndpointProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param vpcId The ID for your VPC. AWS PrivateLink generates this value when you
             *   create a VPC.
             */
            public fun vpcId(vpcId: String)

            /**
             * @param vpcOptions Information about the VPC, including associated subnets and
             *   security groups.
             */
            public fun vpcOptions(vpcOptions: IResolvable)
    ...
    public interface CloudWatchLogDestinationProperty {
        ...
        public interface Builder {
            /**
             * @param logGroup The name of the CloudWatch Logs group to send pipeline logs to. You
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CloudWatchLogDestinationProperty
            ): software.amazon.awscdk.services.osis.CfnPipeline.CloudWatchLogDestinationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface LogPublishingOptionsProperty {
        ...
        public interface Builder {
             ...
             *   Amazon CloudWatch Logs. This parameter is required if `IsLoggingEnabled` is set to
             *   `true` .
             */
            ...
            public fun cloudWatchLogDestination(
                cloudWatchLogDestination: CloudWatchLogDestinationProperty.Builder.() -> Unit
            )
        ...
        private class BuilderImpl : Builder {
            ...
            override fun cloudWatchLogDestination(cloudWatchLogDestination: IResolvable) {
                cdkBuilder.cloudWatchLogDestination(
                    cloudWatchLogDestination.let(IResolvable::unwrap)
                )
            }
             ...
             *   `true` .
             */
            override fun cloudWatchLogDestination(
                cloudWatchLogDestination: CloudWatchLogDestinationProperty
            ) {
                cdkBuilder.cloudWatchLogDestination(
                    cloudWatchLogDestination.let(CloudWatchLogDestinationProperty::unwrap)
                )
            }
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-osis-pipeline-logpublishingoptions.html#cfn-osis-pipeline-logpublishingoptions-cloudwatchlogdestination)
             */
            override fun cloudWatchLogDestination(): Any? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: LogPublishingOptionsProperty
            ): software.amazon.awscdk.services.osis.CfnPipeline.LogPublishingOptionsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface EncryptionAtRestOptionsProperty {
        ...
        public interface Builder {
            /**
             * @param kmsKeyArn The ARN of the KMS key used to encrypt buffer data. By default, data
             *   is encrypted using an AWS owned key.
             */
