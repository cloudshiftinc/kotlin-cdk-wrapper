...
internal constructor(
    ...
    public open fun instanceAccessControlAttributeConfiguration(`value`: IResolvable) {
        unwrap(this)
            .setInstanceAccessControlAttributeConfiguration(`value`.let(IResolvable::unwrap))
    }
     ...
     */
    @Deprecated(message = "deprecated in CDK")
    public open fun instanceAccessControlAttributeConfiguration(
        `value`: InstanceAccessControlAttributeConfigurationProperty
    ) {
        unwrap(this)
            .setInstanceAccessControlAttributeConfiguration(
                `value`.let(InstanceAccessControlAttributeConfigurationProperty::unwrap)
            )
    }
    ...
    public open fun instanceAccessControlAttributeConfiguration(
        `value`: InstanceAccessControlAttributeConfigurationProperty.Builder.() -> Unit
    ): Unit =
        instanceAccessControlAttributeConfiguration(
            InstanceAccessControlAttributeConfigurationProperty(`value`)
        )
    ...
    public interface Builder {
        ...
        /**
         * (deprecated) The InstanceAccessControlAttributeConfiguration property has been deprecated
         * but is still supported for backwards compatibility purposes.
         *
        ...
        public fun instanceAccessControlAttributeConfiguration(
            instanceAccessControlAttributeConfiguration:
                InstanceAccessControlAttributeConfigurationProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
         ...
         */
        @Deprecated(message = "deprecated in CDK")
        override fun instanceAccessControlAttributeConfiguration(
            instanceAccessControlAttributeConfiguration: IResolvable
        ) {
            cdkBuilder.instanceAccessControlAttributeConfiguration(
                instanceAccessControlAttributeConfiguration.let(IResolvable::unwrap)
            )
        }
        ...
        override fun instanceAccessControlAttributeConfiguration(
            ...
            cdkBuilder.instanceAccessControlAttributeConfiguration(
                instanceAccessControlAttributeConfiguration.let(
                    InstanceAccessControlAttributeConfigurationProperty::unwrap
                )
            )
        }
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnInstanceAccessControlAttributeConfiguration
        ): software.amazon.awscdk.services.sso.CfnInstanceAccessControlAttributeConfiguration =
            wrapped.cdkObject
    }
    ...
    public interface AccessControlAttributeProperty {
        ...
        public interface Builder {
             ...
             *   source. This is used to map a specified attribute in your identity source with an
             *   attribute in IAM Identity Center .
             */
        ...
        private class BuilderImpl : Builder {
            ...
            @JvmName("2b2ba344d29acf07e85c56f3146a8d7709b6f35e982893821de32fd1907f06de")
            override fun `value`(
                `value`: AccessControlAttributeValueProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AccessControlAttributeProperty
            ): software.amazon.awscdk.services.sso.CfnInstanceAccessControlAttributeConfiguration.AccessControlAttributeProperty =
    ...
    public interface AccessControlAttributeValueProperty {
        ...
        public interface Builder {
            /**
             * @param source The identity source to use when mapping a specified attribute to IAM
             *   Identity Center .
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AccessControlAttributeValueProperty
            ): software.amazon.awscdk.services.sso.CfnInstanceAccessControlAttributeConfiguration.AccessControlAttributeValueProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface InstanceAccessControlAttributeConfigurationProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: InstanceAccessControlAttributeConfigurationProperty
            ): software.amazon.awscdk.services.sso.CfnInstanceAccessControlAttributeConfiguration.InstanceAccessControlAttributeConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
