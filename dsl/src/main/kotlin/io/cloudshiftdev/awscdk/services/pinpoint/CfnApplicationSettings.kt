...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param campaignHook The settings for the Lambda function to use by default as a code hook
         ...
         * The default sending limits for campaigns in the application.
         *
         * To override these limits for a specific campaign, use the Campaign resource to define
         ...
         * The default quiet time for campaigns in the application.
         *
         * Quiet time is a specific time range when campaigns don't send messages to endpoints, if
         * all the following conditions are met:
         * * The `EndpointDemographic.Timezone` property of the endpoint is set to a valid value.
         * * The current time in the endpoint's time zone is later than or equal to the time
         *   specified by the `QuietTime.Start` property for the application (or a campaign that has
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.pinpoint.CfnApplicationSettings.Builder.create(
                scope,
                id
            )
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnApplicationSettings
    ...
    public interface CampaignHookProperty {
        ...
        public interface Builder {
             ...
             *   function that Amazon Pinpoint invokes to send messages for campaigns in the
             *   application.
             */
