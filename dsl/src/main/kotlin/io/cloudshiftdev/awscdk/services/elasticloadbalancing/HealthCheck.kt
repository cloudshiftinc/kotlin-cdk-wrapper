...
public interface HealthCheck {
    ...
    public interface Builder {
        /**
         * @param healthyThreshold After how many successful checks is an instance considered
         *   healthy.
         */
        ...
        /**
         * @param path What path to use for HTTP or HTTPS health check (must return 200). For SSL
         *   and TCP health checks, accepting connections is enough to be considered healthy.
         */
