...
public interface LambdaFunctionAssociation {
    ...
    public interface Builder {
        /**
         * @param eventType The lambda event type defines at which event the lambda is called during
    ...
    internal constructor(
        ...
        /** A version of the lambda to associate. */
        override fun lambdaFunction(): IVersion =
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: LambdaFunctionAssociation
        ): software.amazon.awscdk.services.cloudfront.LambdaFunctionAssociation =
