...
internal constructor(
    ...
    public open fun addAutoScaling(options: AutoScalingOptions): IScalableFunctionAttribute =
        unwrap(this)
            .addAutoScaling(options.let(AutoScalingOptions::unwrap))
            .let(IScalableFunctionAttribute::wrap)
    ...
    public open fun addAutoScaling(
        options: AutoScalingOptions.Builder.() -> Unit
     ...
     * ARN of this alias.
     *
     * Used to be able to use Alias in place of a regular Lambda. Lambda accepts ARNs everywhere it
    ...
    public companion object {
        public fun fromAliasAttributes(
            ...
            software.amazon.awscdk.services.lambda.Alias.fromAliasAttributes(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    attrs.let(AliasAttributes::unwrap)
                )
                .let(IAlias::wrap)
