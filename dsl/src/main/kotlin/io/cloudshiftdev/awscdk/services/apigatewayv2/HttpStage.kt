...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * Default: '$default' the default stage of the API. This stage will have the URL at the
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.apigatewayv2.HttpStage =
            cdkBuilder.build()
    }
    ...
    public companion object {
        public fun fromHttpStageAttributes(
            ...
            software.amazon.awscdk.services.apigatewayv2.HttpStage.fromHttpStageAttributes(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    attrs.let(HttpStageAttributes::unwrap)
                )
                .let(IHttpStage::wrap)
        ...
        ): HttpStage = HttpStage(cdkObject)

        internal fun unwrap(
            wrapped: HttpStage
        ): software.amazon.awscdk.services.apigatewayv2.HttpStage = wrapped.cdkObject
    }
}
