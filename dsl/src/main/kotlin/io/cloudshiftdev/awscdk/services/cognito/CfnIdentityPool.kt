...
internal constructor(
     ...
     */
    public open fun samlProviderArns(): List<String> =
        unwrap(this).getSamlProviderArns() ?: emptyList()
    ...
    public interface Builder {
         ...
         * The "domain" Amazon Cognito uses when referencing your users.
         *
         * This name acts as a placeholder that allows your backend and the Amazon Cognito service
         * to communicate about the developer provider. For the `DeveloperProviderName` , you can
         * use letters and periods (.), underscores (_), and dashes (-).
         *
         * *Minimum length* : 1
         *
         * *Maximum length* : 100
         ...
         *
         * @param developerProviderName The "domain" Amazon Cognito uses when referencing your
         *   users.
         */
         ...
         *
         * @param supportedLoginProviders Key-value pairs that map provider names to provider app
         *   IDs.
         */
    ...
    private class BuilderImpl(
        ...
        override fun allowUnauthenticatedIdentities(allowUnauthenticatedIdentities: IResolvable) {
            cdkBuilder.allowUnauthenticatedIdentities(
                allowUnauthenticatedIdentities.let(IResolvable::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("eb7b28bad24809a271d41e21c713d6fad090f0b50d4de21405b2607e954d38d3")
        override fun cognitoStreams(
            cognitoStreams: CognitoStreamsProperty.Builder.() -> Unit
        ...
        public fun build(): software.amazon.awscdk.services.cognito.CfnIdentityPool =
            cdkBuilder.build()
    }
    ...
    public interface CognitoIdentityProviderProperty {
         ...
         * checks with the integrated user pools to make sure the user has not been globally signed
        ...
        public interface Builder {
             ...
             *   identity provider’s token. After you set the `ServerSideTokenCheck` to TRUE for an
             *   identity pool, that identity pool checks with the integrated user pools to make
             *   sure the user has not been globally signed out or deleted before the identity pool
        ...
        internal constructor(
             ...
             * pool checks with the integrated user pools to make sure the user has not been
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CognitoIdentityProviderProperty
            ): software.amazon.awscdk.services.cognito.CfnIdentityPool.CognitoIdentityProviderProperty =
    ...
    public interface CognitoStreamsProperty {
         ...
         * stream.
         *
         * This role must grant access to Amazon Cognito (cognito-sync) to invoke `PutRecord` on
         * your Amazon Cognito stream.
         *
         ...
         *
         * This stream must be in the developer's account and in the same Region as the identity
         * pool.
         *
        ...
        public interface Builder {
            /**
             * @param roleArn The Amazon Resource Name (ARN) of the role Amazon Cognito can assume
             *   to publish to the stream. This role must grant access to Amazon Cognito
             *   (cognito-sync) to invoke `PutRecord` on your Amazon Cognito stream.
             */
            public fun roleArn(roleArn: String)

            /**
             * @param streamName The name of the Amazon Cognito stream to receive updates. This
             *   stream must be in the developer's account and in the same Region as the identity
             *   pool.
             */
            public fun streamName(streamName: String)

            /**
             * @param streamingStatus Status of the Amazon Cognito streams. Valid values are:
             *   `ENABLED` or `DISABLED` .
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CognitoStreamsProperty
            ): software.amazon.awscdk.services.cognito.CfnIdentityPool.CognitoStreamsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface PushSyncProperty {
         ...
         */
        public fun applicationArns(): List<String> =
            unwrap(this).getApplicationArns() ?: emptyList()
        ...
        public interface Builder {
            /**
             * @param applicationArns The ARNs of the Amazon SNS platform applications that could be
             *   used by clients.
             */
            ...
            /**
             * @param roleArn An IAM role configured to allow Amazon Cognito to call Amazon SNS on
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-cognito-identitypool-pushsync.html#cfn-cognito-identitypool-pushsync-applicationarns)
             */
            override fun applicationArns(): List<String> =
                unwrap(this).getApplicationArns() ?: emptyList()
