...
internal constructor(
     ...
     * [io.cloudshiftdev.awscdk.services.verifiedpermissions.CfnPolicyTemplate].
     */
    @CdkDslMarker
    public interface Builder {
         ...
         *
         * @param policyStoreId The unique identifier of the policy store that contains the
         *   template.
         */
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.verifiedpermissions.CfnPolicyTemplate.Builder.create(
                scope,
                id
            )
