...
internal constructor(
    ...
    /**
     * The ID of the security group that authorizes traffic between the `RSessionGateway` apps and
    ...
    public open fun defaultSpaceSettings(
        `value`: DefaultSpaceSettingsProperty.Builder.() -> Unit
    ...
    public interface Builder {
         ...
         *
         * @param appNetworkAccessType Specifies the VPC used for non-EFS traffic. The default value
         *   is `PublicInternetOnly` .
         */
        public fun appNetworkAccessType(appNetworkAccessType: String)

        /**
         * The entity that creates and manages the required security groups for inter-app
         * communication in `VpcOnly` mode.
         *
         ...
         *
         * @param appSecurityGroupManagement The entity that creates and manages the required
        ...
        public fun defaultSpaceSettings(
            defaultSpaceSettings: DefaultSpaceSettingsProperty.Builder.() -> Unit
        )
         ...
         * managed customer master key (CMK) by default.
         *
         ...
         *   with an AWS managed customer master key (CMK) by default.
         */
    ...
    private class BuilderImpl(
        ...
        override fun defaultSpaceSettings(defaultSpaceSettings: DefaultSpaceSettingsProperty) {
            cdkBuilder.defaultSpaceSettings(
                defaultSpaceSettings.let(DefaultSpaceSettingsProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("0541aea2d9023d83138fd5d19ec34eb6bca50e6dcc332eb676c49b71ec567f81")
        override fun defaultSpaceSettings(
            defaultSpaceSettings: DefaultSpaceSettingsProperty.Builder.() -> Unit
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("67693a8dc439c00e3a65fd42feb54d1ef2cc19dc96b32eefca9bc368ad820bbe")
        override fun defaultUserSettings(
            defaultUserSettings: UserSettingsProperty.Builder.() -> Unit
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("97bc89f7e4a4c3d6a51d1471420dc3788d7f132c548680140caa8cd6b902723c")
        override fun domainSettings(
            domainSettings: DomainSettingsProperty.Builder.() -> Unit
        ): Unit = domainSettings(DomainSettingsProperty(domainSettings))
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnDomain
        ): software.amazon.awscdk.services.sagemaker.CfnDomain = wrapped.cdkObject
    }
    ...
    public interface ResourceSpecProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param lifecycleConfigArn The Amazon Resource Name (ARN) of the Lifecycle
             *   Configuration attached to the Resource.
             */
            public fun lifecycleConfigArn(lifecycleConfigArn: String)

            /**
             * @param sageMakerImageArn The ARN of the SageMaker image that the image version
             *   belongs to.
             */
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-sagemaker-domain-resourcespec.html#cfn-sagemaker-domain-resourcespec-sagemakerimageversionarn)
             */
            override fun sageMakerImageVersionArn(): String? =
    ...
    public interface JupyterServerAppSettingsProperty {
        ...
        public interface Builder {
            /**
             * @param defaultResourceSpec The default instance type and the Amazon Resource Name
             *   (ARN) of the default SageMaker image used by the JupyterServer app.
             */
            ...
            public fun defaultResourceSpec(
                defaultResourceSpec: ResourceSpecProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun defaultResourceSpec(defaultResourceSpec: ResourceSpecProperty) {
                cdkBuilder.defaultResourceSpec(
                    defaultResourceSpec.let(ResourceSpecProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("16529f01fa91e18098e31e0efd963479f78925d3a88a89427ddee33f55f07774")
            override fun defaultResourceSpec(
                defaultResourceSpec: ResourceSpecProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: JupyterServerAppSettingsProperty
            ): software.amazon.awscdk.services.sagemaker.CfnDomain.JupyterServerAppSettingsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface KernelGatewayAppSettingsProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param defaultResourceSpec The default instance type and the Amazon Resource Name
             *   (ARN) of the default SageMaker image used by the KernelGateway app.
             *
             * The Amazon SageMaker Studio UI does not use the default instance type value set here.
             * The default instance type set here is used when Apps are created using the AWS CLI or
             * AWS CloudFormation and the instance type parameter value is not passed.
             */
            public fun defaultResourceSpec(defaultResourceSpec: IResolvable)
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: KernelGatewayAppSettingsProperty
            ): software.amazon.awscdk.services.sagemaker.CfnDomain.KernelGatewayAppSettingsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DomainSettingsProperty {
        ...
        public interface Builder {
            ...
            public fun rStudioServerProDomainSettings(
                rStudioServerProDomainSettings:
                    RStudioServerProDomainSettingsProperty.Builder.() -> Unit
            )

            /**
             * @param securityGroupIds The security groups for the Amazon Virtual Private Cloud that
             *   the `Domain` uses for communication between Domain-level apps and user apps.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("93ef0e9d4e8ab8c25f1dacd8a12798de73fea998b847b67fee5327f6c7af6f6e")
            override fun dockerSettings(
                dockerSettings: DockerSettingsProperty.Builder.() -> Unit
            ): Unit = dockerSettings(DockerSettingsProperty(dockerSettings))

            /**
             * @param rStudioServerProDomainSettings A collection of settings that configure the
             *   `RStudioServerPro` Domain-level app.
             */
            override fun rStudioServerProDomainSettings(
                rStudioServerProDomainSettings: IResolvable
            ) {
                cdkBuilder.rStudioServerProDomainSettings(
                    rStudioServerProDomainSettings.let(IResolvable::unwrap)
                )
            }
            ...
            override fun rStudioServerProDomainSettings(
                ...
                cdkBuilder.rStudioServerProDomainSettings(
                    rStudioServerProDomainSettings.let(
                        RStudioServerProDomainSettingsProperty::unwrap
                    )
                )
            }
            ...
            override fun rStudioServerProDomainSettings(
                ...
                rStudioServerProDomainSettings(
                    RStudioServerProDomainSettingsProperty(rStudioServerProDomainSettings)
                )
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DomainSettingsProperty
            ): software.amazon.awscdk.services.sagemaker.CfnDomain.DomainSettingsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface JupyterLabAppSettingsProperty {
         ...
         */
        public fun lifecycleConfigArns(): List<String> =
        ...
        public interface Builder {
            /**
             * @param codeRepositories A list of Git repositories that SageMaker automatically
             *   displays to users for cloning in the JupyterLab application.
             */
            ...
            /**
             * @param defaultResourceSpec The default instance type and the Amazon Resource Name
             *   (ARN) of the default SageMaker image used by the JupyterLab app.
             */
            public fun defaultResourceSpec(defaultResourceSpec: IResolvable)
            ...
            /**
             * @param lifecycleConfigArns The Amazon Resource Name (ARN) of the lifecycle
             *   configurations attached to the user profile or domain. To remove a lifecycle
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-sagemaker-domain-jupyterlabappsettings.html#cfn-sagemaker-domain-jupyterlabappsettings-lifecycleconfigarns)
             */
            override fun lifecycleConfigArns(): List<String> =
                unwrap(this).getLifecycleConfigArns() ?: emptyList()
        }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: JupyterLabAppSettingsProperty
            ): software.amazon.awscdk.services.sagemaker.CfnDomain.JupyterLabAppSettingsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface RSessionAppSettingsProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param defaultResourceSpec Specifies the ARNs of a SageMaker image and SageMaker
             *   image version, and the instance type that the version runs on.
             */
            public fun defaultResourceSpec(defaultResourceSpec: IResolvable)
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RSessionAppSettingsProperty
            ): software.amazon.awscdk.services.sagemaker.CfnDomain.RSessionAppSettingsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface RStudioServerProDomainSettingsProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param domainExecutionRoleArn The ARN of the execution role for the
             *   `RStudioServerPro` Domain-level app.
             */
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-sagemaker-domain-rstudioserverprodomainsettings.html#cfn-sagemaker-domain-rstudioserverprodomainsettings-rstudiopackagemanagerurl)
             */
            override fun rStudioPackageManagerUrl(): String? =
                unwrap(this).getRStudioPackageManagerUrl()
        }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RStudioServerProDomainSettingsProperty
            ): software.amazon.awscdk.services.sagemaker.CfnDomain.RStudioServerProDomainSettingsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DockerSettingsProperty {
         ...
         */
        public fun vpcOnlyTrustedAccounts(): List<String> =
            unwrap(this).getVpcOnlyTrustedAccounts() ?: emptyList()
        ...
        public interface Builder {
            ...
            /**
             * @param vpcOnlyTrustedAccounts The list of AWS accounts that are trusted when the
        ...
        internal constructor(
            ...
            /**
             * The list of AWS accounts that are trusted when the domain is created in VPC-only
             * mode.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-sagemaker-domain-dockersettings.html#cfn-sagemaker-domain-dockersettings-vpconlytrustedaccounts)
             */
            override fun vpcOnlyTrustedAccounts(): List<String> =
                unwrap(this).getVpcOnlyTrustedAccounts() ?: emptyList()
        }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DockerSettingsProperty
            ): software.amazon.awscdk.services.sagemaker.CfnDomain.DockerSettingsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface RStudioServerProAppSettingsProperty {
        ...
        public interface Builder {
            /**
             * @param accessStatus Indicates whether the current user has access to the
             *   `RStudioServerPro` app.
             */
            public fun accessStatus(accessStatus: String)

            /**
             * @param userGroup The level of permissions that the user has within the
             *   `RStudioServerPro` app. This value defaults to `User`. The `Admin` value allows the
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RStudioServerProAppSettingsProperty
            ): software.amazon.awscdk.services.sagemaker.CfnDomain.RStudioServerProAppSettingsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CustomFileSystemConfigProperty {
        ...
        public interface Builder {
            ...
            public fun efsFileSystemConfig(
                efsFileSystemConfig: EFSFileSystemConfigProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun efsFileSystemConfig(efsFileSystemConfig: EFSFileSystemConfigProperty) {
                cdkBuilder.efsFileSystemConfig(
                    efsFileSystemConfig.let(EFSFileSystemConfigProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("51d19063b8418bdcc7fb6317565668cc527b6fd40ba7621f9328e0ac5ac8d994")
            override fun efsFileSystemConfig(
                efsFileSystemConfig: EFSFileSystemConfigProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CustomFileSystemConfigProperty
            ): software.amazon.awscdk.services.sagemaker.CfnDomain.CustomFileSystemConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface EFSFileSystemConfigProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param fileSystemPath The path to the file system directory that is accessible in
             *   Amazon SageMaker Studio. Permitted users can access only this directory and below.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: EFSFileSystemConfigProperty
            ): software.amazon.awscdk.services.sagemaker.CfnDomain.EFSFileSystemConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CustomPosixUserConfigProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CustomPosixUserConfigProperty
            ): software.amazon.awscdk.services.sagemaker.CfnDomain.CustomPosixUserConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CodeEditorAppSettingsProperty {
        ...
        public interface Builder {
            /**
             * @param defaultResourceSpec The default instance type and the Amazon Resource Name
             *   (ARN) of the default SageMaker image used by the Code Editor app.
             */
            public fun defaultResourceSpec(defaultResourceSpec: IResolvable)
            ...
            /**
             * @param lifecycleConfigArns The Amazon Resource Name (ARN) of the Code Editor
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CodeEditorAppSettingsProperty
            ): software.amazon.awscdk.services.sagemaker.CfnDomain.CodeEditorAppSettingsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DefaultEbsStorageSettingsProperty {
        ...
        public interface Builder {
            /**
             * @param defaultEbsVolumeSizeInGb The default size of the EBS storage volume for a
             *   private space.
             */
            public fun defaultEbsVolumeSizeInGb(defaultEbsVolumeSizeInGb: Number)

            /**
             * @param maximumEbsVolumeSizeInGb The maximum size of the EBS storage volume for a
             *   private space.
             */
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-sagemaker-domain-defaultebsstoragesettings.html#cfn-sagemaker-domain-defaultebsstoragesettings-defaultebsvolumesizeingb)
             */
            override fun defaultEbsVolumeSizeInGb(): Number =
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-sagemaker-domain-defaultebsstoragesettings.html#cfn-sagemaker-domain-defaultebsstoragesettings-maximumebsvolumesizeingb)
             */
            override fun maximumEbsVolumeSizeInGb(): Number =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DefaultEbsStorageSettingsProperty
            ): software.amazon.awscdk.services.sagemaker.CfnDomain.DefaultEbsStorageSettingsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface UserSettingsProperty {
         ...
         */
        public fun rStudioServerProAppSettings(): Any? =
        ...
        public interface Builder {
            ...
            public fun codeEditorAppSettings(
                codeEditorAppSettings: CodeEditorAppSettingsProperty.Builder.() -> Unit
            )

            /**
             * @param customFileSystemConfigs The settings for assigning a custom file system to a
             *   user profile. Permitted users can access this file system in Amazon SageMaker
             *   Studio.
             */
            ...
            /**
             * @param customPosixUserConfig Details about the POSIX identity that is used for file
             *   system operations.
             */
            ...
            public fun customPosixUserConfig(
                customPosixUserConfig: CustomPosixUserConfigProperty.Builder.() -> Unit
            )

            /**
             * @param defaultLandingUri The default experience that the user is directed to when
             *   accessing the domain. The supported values are:.
             * * `studio::` : Indicates that Studio is the default experience. This value can only
             *   be passed if `StudioWebPortal` is set to `ENABLED` .
             * * `app:JupyterServer:` : Indicates that Studio Classic is the default experience.
             */
            ...
            public fun jupyterLabAppSettings(
                jupyterLabAppSettings: JupyterLabAppSettingsProperty.Builder.() -> Unit
            )
            ...
            public fun jupyterServerAppSettings(
                jupyterServerAppSettings: JupyterServerAppSettingsProperty.Builder.() -> Unit
            )
            ...
            public fun kernelGatewayAppSettings(
                kernelGatewayAppSettings: KernelGatewayAppSettingsProperty.Builder.() -> Unit
            )

            /**
             * @param rSessionAppSettings A collection of settings that configure the
             *   `RSessionGateway` app.
             */
            ...
            public fun rSessionAppSettings(
                rSessionAppSettings: RSessionAppSettingsProperty.Builder.() -> Unit
            )

            /**
             * @param rStudioServerProAppSettings A collection of settings that configure user
            ...
            public fun rStudioServerProAppSettings(
                rStudioServerProAppSettings: RStudioServerProAppSettingsProperty.Builder.() -> Unit
            )

            /**
             * @param securityGroups The security groups for the Amazon Virtual Private Cloud (VPC)
             *   that the domain uses for communication. Optional when the
             *   `CreateDomain.AppNetworkAccessType` parameter is set to `PublicInternetOnly` .
             *
             * Required when the `CreateDomain.AppNetworkAccessType` parameter is set to `VpcOnly` ,
             * unless specified as part of the `DefaultUserSettings` for the domain.
             *
            ...
            /**
             * @param sharingSettings Specifies options for sharing Amazon SageMaker Studio
             *   notebooks.
             */
            ...
            public fun spaceStorageSettings(
                spaceStorageSettings: DefaultSpaceStorageSettingsProperty.Builder.() -> Unit
            )

            /**
             * @param studioWebPortal Whether the user can access Studio. If this value is set to
             *   `DISABLED` , the user cannot access Studio, even if that is the default experience
             *   for the domain.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            /** @param codeEditorAppSettings The Code Editor application settings. */
            override fun codeEditorAppSettings(
                codeEditorAppSettings: CodeEditorAppSettingsProperty
            ) {
                cdkBuilder.codeEditorAppSettings(
                    codeEditorAppSettings.let(CodeEditorAppSettingsProperty::unwrap)
                )
            }
            ...
            override fun customPosixUserConfig(
                ...
                cdkBuilder.customPosixUserConfig(
                    customPosixUserConfig.let(CustomPosixUserConfigProperty::unwrap)
                )
            }
            ...
            /** @param jupyterLabAppSettings The settings for the JupyterLab application. */
            override fun jupyterLabAppSettings(
                jupyterLabAppSettings: JupyterLabAppSettingsProperty
            ) {
                cdkBuilder.jupyterLabAppSettings(
                    jupyterLabAppSettings.let(JupyterLabAppSettingsProperty::unwrap)
                )
            }
            ...
            override fun jupyterServerAppSettings(jupyterServerAppSettings: IResolvable) {
                cdkBuilder.jupyterServerAppSettings(
                    jupyterServerAppSettings.let(IResolvable::unwrap)
                )
            }

            /** @param jupyterServerAppSettings The Jupyter server's app settings. */
            override fun jupyterServerAppSettings(
                jupyterServerAppSettings: JupyterServerAppSettingsProperty
            ) {
                cdkBuilder.jupyterServerAppSettings(
                    jupyterServerAppSettings.let(JupyterServerAppSettingsProperty::unwrap)
                )
            }
            ...
            override fun kernelGatewayAppSettings(kernelGatewayAppSettings: IResolvable) {
                cdkBuilder.kernelGatewayAppSettings(
                    kernelGatewayAppSettings.let(IResolvable::unwrap)
                )
            }

            /** @param kernelGatewayAppSettings The kernel gateway app settings. */
            override fun kernelGatewayAppSettings(
                kernelGatewayAppSettings: KernelGatewayAppSettingsProperty
            ) {
                cdkBuilder.kernelGatewayAppSettings(
                    kernelGatewayAppSettings.let(KernelGatewayAppSettingsProperty::unwrap)
                )
            }
            ...
            override fun rSessionAppSettings(rSessionAppSettings: RSessionAppSettingsProperty) {
                cdkBuilder.rSessionAppSettings(
                    rSessionAppSettings.let(RSessionAppSettingsProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("b81f78fa82c9334f24ab7a4ad9a3b8a2f1adaf4e91696e79d83a9b27793fabca")
            override fun rSessionAppSettings(
                rSessionAppSettings: RSessionAppSettingsProperty.Builder.() -> Unit
            ...
            override fun rStudioServerProAppSettings(rStudioServerProAppSettings: IResolvable) {
                cdkBuilder.rStudioServerProAppSettings(
                    rStudioServerProAppSettings.let(IResolvable::unwrap)
                )
            }
             ...
             *   interaction with the `RStudioServerPro` app.
             */
            override fun rStudioServerProAppSettings(
                rStudioServerProAppSettings: RStudioServerProAppSettingsProperty
            ) {
                cdkBuilder.rStudioServerProAppSettings(
                    rStudioServerProAppSettings.let(RStudioServerProAppSettingsProperty::unwrap)
                )
            }
            ...
            override fun rStudioServerProAppSettings(
                ...
                rStudioServerProAppSettings(
                    RStudioServerProAppSettingsProperty(rStudioServerProAppSettings)
                )
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("3c1f110e5a5c496b5a1af40ba1b094eeaa34ed4f7f1f095fd2c54606d0c7b86a")
            override fun sharingSettings(
                sharingSettings: SharingSettingsProperty.Builder.() -> Unit
            ...
            /** @param spaceStorageSettings The storage settings for a private space. */
            override fun spaceStorageSettings(
                spaceStorageSettings: DefaultSpaceStorageSettingsProperty
            ) {
                cdkBuilder.spaceStorageSettings(
                    spaceStorageSettings.let(DefaultSpaceStorageSettingsProperty::unwrap)
                )
            }
            ...
            override fun spaceStorageSettings(
                ...
                spaceStorageSettings(DefaultSpaceStorageSettingsProperty(spaceStorageSettings))
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-sagemaker-domain-usersettings.html#cfn-sagemaker-domain-usersettings-jupyterserverappsettings)
             */
            override fun jupyterServerAppSettings(): Any? =
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-sagemaker-domain-usersettings.html#cfn-sagemaker-domain-usersettings-kernelgatewayappsettings)
             */
            override fun kernelGatewayAppSettings(): Any? =
             ...
             * Whether the user can access Studio.
             *
             * If this value is set to `DISABLED` , the user cannot access Studio, even if that is
             * the default experience for the domain.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-sagemaker-domain-usersettings.html#cfn-sagemaker-domain-usersettings-studiowebportal)
             */
    ...
    public interface DefaultSpaceStorageSettingsProperty {
        ...
        public interface Builder {
            /**
             * @param defaultEbsStorageSettings The default EBS storage settings for a private
             *   space.
             */
            ...
            public fun defaultEbsStorageSettings(
                defaultEbsStorageSettings: DefaultEbsStorageSettingsProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun defaultEbsStorageSettings(defaultEbsStorageSettings: IResolvable) {
                cdkBuilder.defaultEbsStorageSettings(
                    defaultEbsStorageSettings.let(IResolvable::unwrap)
                )
            }
             ...
             *   space.
             */
            override fun defaultEbsStorageSettings(
                defaultEbsStorageSettings: DefaultEbsStorageSettingsProperty
            ) {
                cdkBuilder.defaultEbsStorageSettings(
                    defaultEbsStorageSettings.let(DefaultEbsStorageSettingsProperty::unwrap)
                )
            }
            ...
            override fun defaultEbsStorageSettings(
                ...
                defaultEbsStorageSettings(
                    DefaultEbsStorageSettingsProperty(defaultEbsStorageSettings)
                )
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-sagemaker-domain-defaultspacestoragesettings.html#cfn-sagemaker-domain-defaultspacestoragesettings-defaultebsstoragesettings)
             */
            override fun defaultEbsStorageSettings(): Any? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DefaultSpaceStorageSettingsProperty
            ): software.amazon.awscdk.services.sagemaker.CfnDomain.DefaultSpaceStorageSettingsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DefaultSpaceSettingsProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param securityGroups The security group IDs for the Amazon VPC that the space uses
             *   for communication.
             */
            public fun securityGroups(securityGroups: List<String>)
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DefaultSpaceSettingsProperty
            ): software.amazon.awscdk.services.sagemaker.CfnDomain.DefaultSpaceSettingsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SharingSettingsProperty {
        ...
        public interface Builder {
            /**
             * @param notebookOutputOption Whether to include the notebook cell output when sharing
             *   the notebook. The default is `Disabled` .
             */
            public fun notebookOutputOption(notebookOutputOption: String)

            /**
             * @param s3KmsKeyId When `NotebookOutputOption` is `Allowed` , the AWS Key Management
            ...
            /**
             * @param s3OutputPath When `NotebookOutputOption` is `Allowed` , the Amazon S3 bucket
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SharingSettingsProperty
            ): software.amazon.awscdk.services.sagemaker.CfnDomain.SharingSettingsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
