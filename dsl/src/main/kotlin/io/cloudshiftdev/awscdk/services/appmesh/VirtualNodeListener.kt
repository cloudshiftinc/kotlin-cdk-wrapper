...
internal constructor(
    ...
    public companion object {
        public fun grpc(): VirtualNodeListener =
            software.amazon.awscdk.services.appmesh.VirtualNodeListener.grpc()
                .let(VirtualNodeListener::wrap)

        public fun grpc(props: GrpcVirtualNodeListenerOptions): VirtualNodeListener =
            software.amazon.awscdk.services.appmesh.VirtualNodeListener.grpc(
                    props.let(GrpcVirtualNodeListenerOptions::unwrap)
                )
                .let(VirtualNodeListener::wrap)
        ...
        public fun tcp(
            props: TcpVirtualNodeListenerOptions.Builder.() -> Unit
