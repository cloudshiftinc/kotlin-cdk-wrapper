...
internal constructor(
    ...
    public interface Builder {
         ...
         * static number
         *
         * Default: - uses value of `maxInputBytesPerBatchPath` as the max size per batch, no limits
         * on the batch size under the 256KB limit if that property was also not provided
         *
         ...
         * JsonPath
         *
         * Default: - uses value of `maxInputBytesPerBatch` as the max size per batch, no limits on
         ...
         * static number
         *
         * Default: - uses value of `maxItemsPerBatchPath` as the max items per batch, no limits on
         * the number of items in a batch under the 256KB limit if that property was also not
         * provided
         *
