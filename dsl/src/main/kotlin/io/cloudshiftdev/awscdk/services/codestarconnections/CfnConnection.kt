...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param providerType The name of the external provider where your third-party code
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.codestarconnections.CfnConnection.Builder.create(
                scope,
                id
            )
