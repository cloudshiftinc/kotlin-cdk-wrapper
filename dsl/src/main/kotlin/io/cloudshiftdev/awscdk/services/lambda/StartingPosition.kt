...
public enum class StartingPosition(
    ...
    public companion object {
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.lambda.StartingPosition
        ): StartingPosition =
            when (cdkObject) {
                software.amazon.awscdk.services.lambda.StartingPosition.TRIM_HORIZON ->
                    StartingPosition.TRIM_HORIZON
                software.amazon.awscdk.services.lambda.StartingPosition.LATEST ->
