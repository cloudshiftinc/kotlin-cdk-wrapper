...
internal constructor(
    ...
    public interface Builder {
         ...
         * metadata.
         *
         * The `payloadResponseOnly` property cannot be used if `integrationPattern`,
         * `invocationType`, `clientContext`, or `qualifier` are specified. It always uses the
         * REQUEST_RESPONSE behavior.
         *
         * Default: false
         *
         * @param payloadResponseOnly Invoke the Lambda in a way that only returns the payload
         *   response without additional metadata.
         */
         ...
         *
         * You only need to supply this if you want the version of the Lambda Function to depend on
         * data in the state machine state. If not, you can pass the appropriate Alias or Version
         * object directly as the `lambdaFunction` argument.
         *
         ...
         */
        @Deprecated(message = "deprecated in CDK") public fun qualifier(qualifier: String)
         ...
         * `Lambda.SdkClientException` with an interval of 2 seconds, a back-off rate of 2 and 6
         * maximum attempts.
         *
         * Default: true
         *
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.stepfunctions.tasks.LambdaInvoke.Builder.create(
                scope,
                id
            )
