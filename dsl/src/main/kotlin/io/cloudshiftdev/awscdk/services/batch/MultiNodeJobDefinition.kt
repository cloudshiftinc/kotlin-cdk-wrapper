...
internal constructor(
    ...
    public interface Builder {
         ...
         * Default: false
         *
         * @param propagateTags Whether to propogate tags from the JobDefinition to the ECS task
         *   that Batch spawns.
         */
    ...
    public companion object {
        public fun fromJobDefinitionArn(
            ...
            software.amazon.awscdk.services.batch.MultiNodeJobDefinition.fromJobDefinitionArn(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    jobDefinitionArn
                )
                .let(IJobDefinition::wrap)
        ...
        internal fun unwrap(
            wrapped: MultiNodeJobDefinition
