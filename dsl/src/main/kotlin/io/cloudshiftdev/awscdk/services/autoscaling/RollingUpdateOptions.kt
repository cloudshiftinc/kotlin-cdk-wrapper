...
public interface RollingUpdateOptions {
    ...
    public interface Builder {
        /**
         * @param maxBatchSize The maximum number of instances that AWS CloudFormation updates at
         *   once. This number affects the speed of the replacement.
         */
        public fun maxBatchSize(maxBatchSize: Number)

        /**
         * @param minInstancesInService The minimum number of instances that must be in service
         *   before more instances are replaced. This number affects the speed of the replacement.
         */
         ...
         *   from new instances during an update.
         */
    ...
    internal constructor(
        ...
        /**
         * The minimum number of instances that must be in service before more instances are
         * replaced.
         *
         * This number affects the speed of the replacement.
         *
    ...
    public companion object {
        ...
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.autoscaling.RollingUpdateOptions
        ): RollingUpdateOptions = Wrapper(cdkObject)

        internal fun unwrap(
            wrapped: RollingUpdateOptions
