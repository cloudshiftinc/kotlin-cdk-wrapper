...
internal constructor(
    ...
    public interface Builder {
         ...
         * in the user pool.
         *
         * If you specify SUPPRESS, no email is sent. If you specify RESEND, do not specify the
         ...
         *
         * @param messageAction The action to take for the welcome email that is sent to a user
         *   after the user is created in the user pool.
         */
         ...
         * that doesn't use the same capitalization as the email address specified when their user
         * pool account was created, a "user does not exist" error message displays.
         *
