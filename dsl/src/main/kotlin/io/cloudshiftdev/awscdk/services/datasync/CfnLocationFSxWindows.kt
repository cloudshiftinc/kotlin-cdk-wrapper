...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param domain Specifies the name of the Microsoft Active Directory domain that the FSx
         ...
         *
         * @param fsxFilesystemArn Specifies the Amazon Resource Name (ARN) for the FSx for Windows
         ...
         *
         * @param password Specifies the password of the user with the permissions to mount and
         *   access the files, folders, and file metadata in your FSx for Windows File Server file
         *   system.
         */
