...
internal constructor(
    ...
    public interface Builder {
         ...
         *   rejected, asynchronously, during magnetic store writes. Only `S3Configuration` objects
         *   are allowed. The `S3Configuration` object has the following attributes:
         * * *BucketName* : The name of the S3 bucket.
         * * *EncryptionOption* : The encryption option for the S3 location. Valid values are S3
         *   server-side encryption with an S3 managed key ( `SSE_S3` ) or AWS managed key (
         *   `SSE_KMS` ).
         ...
         *
         * Both `BucketName` and `EncryptionOption` are *required* when `S3Configuration` is
         * specified. If you specify `SSE_KMS` as your `EncryptionOption` then `KmsKeyId` is
         * *required* .
         *
         * `EnableMagneticStoreWrites` attribute is *required* when `MagneticStoreWriteProperties`
         * is specified. `MagneticStoreRejectedDataLocation` attribute is *required* when
         ...
         *
         * @param retentionProperties The retention duration for the memory store and magnetic
         *   store. This object has the following attributes:.
         */
    ...
    public companion object {
        ...
        ): CfnTable = CfnTable(cdkObject)

        internal fun unwrap(
            wrapped: CfnTable
        ): software.amazon.awscdk.services.timestream.CfnTable = wrapped.cdkObject
    }
    ...
    public interface MagneticStoreWritePropertiesProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param magneticStoreRejectedDataLocation The location to write error reports for
             *   records rejected asynchronously during magnetic store writes.
             */
            public fun magneticStoreRejectedDataLocation(
                magneticStoreRejectedDataLocation: IResolvable
            )
            ...
            public fun magneticStoreRejectedDataLocation(
                magneticStoreRejectedDataLocation:
                    MagneticStoreRejectedDataLocationProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun enableMagneticStoreWrites(enableMagneticStoreWrites: IResolvable) {
                cdkBuilder.enableMagneticStoreWrites(
                    enableMagneticStoreWrites.let(IResolvable::unwrap)
                )
            }
             ...
             *   records rejected asynchronously during magnetic store writes.
             */
            override fun magneticStoreRejectedDataLocation(
                magneticStoreRejectedDataLocation: IResolvable
            ) {
                cdkBuilder.magneticStoreRejectedDataLocation(
                    magneticStoreRejectedDataLocation.let(IResolvable::unwrap)
                )
            }
            ...
            override fun magneticStoreRejectedDataLocation(
                ...
                cdkBuilder.magneticStoreRejectedDataLocation(
                    magneticStoreRejectedDataLocation.let(
                        MagneticStoreRejectedDataLocationProperty::unwrap
                    )
                )
            }
            ...
            override fun magneticStoreRejectedDataLocation(
                ...
                magneticStoreRejectedDataLocation(
                    MagneticStoreRejectedDataLocationProperty(magneticStoreRejectedDataLocation)
                )
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-timestream-table-magneticstorewriteproperties.html#cfn-timestream-table-magneticstorewriteproperties-enablemagneticstorewrites)
             */
            override fun enableMagneticStoreWrites(): Any =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: MagneticStoreWritePropertiesProperty
            ): software.amazon.awscdk.services.timestream.CfnTable.MagneticStoreWritePropertiesProperty =
    ...
    public interface S3ConfigurationProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param encryptionOption The encryption option for the customer S3 location. Options
             *   are S3 server-side encryption with an S3 managed key or AWS managed key.
             */
            public fun encryptionOption(encryptionOption: String)

            /**
             * @param kmsKeyId The AWS KMS key ID for the customer S3 location when encrypting with
             *   an AWS managed key.
             */
    ...
    public interface MagneticStoreRejectedDataLocationProperty {
        ...
        public interface Builder {
            /**
             * @param s3Configuration Configuration of an S3 location to write error reports for
             *   records rejected, asynchronously, during magnetic store writes.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: MagneticStoreRejectedDataLocationProperty
            ): software.amazon.awscdk.services.timestream.CfnTable.MagneticStoreRejectedDataLocationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface PartitionKeyProperty {
        ...
        public interface Builder {
            /**
             * @param enforcementInRecord The level of enforcement for the specification of a
             *   dimension key in ingested records. Options are REQUIRED (dimension key must be
            ...
            /**
             * @param type The type of the partition key. Options are DIMENSION (dimension key) and
             *   MEASURE (measure key).
             */
    ...
    public interface SchemaProperty {
        ...
        public interface Builder {
            /**
             * @param compositePartitionKey A non-empty list of partition keys defining the
             *   attributes used to partition the table data. The order of the list determines the
             *   partition hierarchy. The name and type of each partition key as well as the
             *   partition key order cannot be changed after the table is created. However, the
        ...
        internal constructor(
            ...
            /**
             * A non-empty list of partition keys defining the attributes used to partition the
             * table data.
             *
             * The order of the list determines the partition hierarchy. The name and type of each
             * partition key as well as the partition key order cannot be changed after the table is
    ...
    public interface RetentionPropertiesProperty {
        ...
        public interface Builder {
            /**
             * @param magneticStoreRetentionPeriodInDays The duration for which data must be stored
             *   in the magnetic store.
             */
            public fun magneticStoreRetentionPeriodInDays(
                magneticStoreRetentionPeriodInDays: String
            )

            /**
             * @param memoryStoreRetentionPeriodInHours The duration for which data must be stored
             *   in the memory store.
             */
        ...
        private class BuilderImpl : Builder {
             ...
             *   in the magnetic store.
             */
            override fun magneticStoreRetentionPeriodInDays(
                magneticStoreRetentionPeriodInDays: String
            ) {
             ...
             *   in the memory store.
             */
            override fun memoryStoreRetentionPeriodInHours(
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RetentionPropertiesProperty
            ): software.amazon.awscdk.services.timestream.CfnTable.RetentionPropertiesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
