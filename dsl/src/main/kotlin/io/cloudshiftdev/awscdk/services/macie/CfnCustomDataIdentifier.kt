...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param description A custom description of the custom data identifier. The description
         *   can contain 1-512 characters.
         */
         ...
         * An array of character sequences ( *ignore words* ) to exclude from the results.
         *
         * If text matches the regular expression ( `Regex` ) but it contains a string in this
         * array, Amazon Macie ignores the text and doesn't include it in the results.
         *
        ...
        /**
         * An array of character sequences ( *keywords* ), one of which must precede and be in
         * proximity ( `MaximumMatchDistance` ) of the regular expression ( `Regex` ) to match.
         *
         ...
         *
         * @param keywords An array of character sequences ( *keywords* ), one of which must precede
         *   and be in proximity ( `MaximumMatchDistance` ) of the regular expression ( `Regex` ) to
         *   match.
         */
         ...
         *
         * @param maximumMatchDistance The maximum number of characters that can exist between the
         *   end of at least one complete character sequence specified by the `Keywords` array and
         *   the end of text that matches the regular expression ( `Regex` ).
         */
    ...
    private class BuilderImpl(
         ...
         *   results.
         */
        override fun ignoreWords(vararg ignoreWords: String): Unit =
            ignoreWords(ignoreWords.toList())
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnCustomDataIdentifier
