...
internal constructor(
     ...
     */
    public open fun availabilityZoneRelocation(): Any? =
        unwrap(this).getAvailabilityZoneRelocation()
    ...
    public open fun clusterParameterGroupName(): String? =
        unwrap(this).getClusterParameterGroupName()
    ...
    public open fun clusterSecurityGroups(): List<String> =
        unwrap(this).getClusterSecurityGroups() ?: emptyList()
    ...
    public open fun deferMaintenanceStartTime(): String? =
        unwrap(this).getDeferMaintenanceStartTime()
    ...
    public open fun snapshotClusterIdentifier(): String? =
        unwrap(this).getSnapshotClusterIdentifier()
    ...
    public interface Builder {
         ...
         *
         * @param availabilityZone The EC2 Availability Zone (AZ) in which you want Amazon Redshift
         ...
         * such as deleting or modifying. The identifier also appears in the Amazon Redshift
         * console.
         *
         * Constraints:
         ...
         *
         * @param clusterParameterGroupName The name of the parameter group to be associated with
         *   this cluster.
         */
         ...
         *
         * @param clusterSecurityGroups A list of security groups to be associated with this
         *   cluster.
         */
         ...
         *
         * @param clusterSubnetGroupName The name of a cluster subnet group to be associated with
         *   this cluster.
         */
         ...
         *   in [Reserved Words](https://docs.aws.amazon.com/redshift/latest/dg/r_pg_keywords.html)
         *   in the Amazon Redshift Database Developer Guide.
         *
         ...
         *
         * @param deferMaintenanceDuration An integer indicating the duration of the maintenance
         *   window in days.
         */
         ...
         *
         * @param destinationRegion The destination region that snapshots are automatically copied
         ...
         *
         * @param hsmClientCertificateIdentifier Specifies the name of the HSM client certificate
         ...
         *
         * @param hsmConfigurationIdentifier Specifies the name of the HSM configuration that
         *   contains the information the Amazon Redshift cluster can use to retrieve and store keys
         *   in an HSM.
         */
         ...
         *
         * @param iamRoles A list of AWS Identity and Access Management (IAM) roles that can be used
        ...
        public fun loggingProperties(
            loggingProperties: LoggingPropertiesProperty.Builder.() -> Unit
        )
         ...
         *
         * @param maintenanceTrackName An optional parameter for the name of the maintenance track
         *   for the cluster.
         */
         ...
         *
         * @param manageMasterPassword If `true` , Amazon Redshift uses AWS Secrets Manager to
         *   manage this cluster's admin credentials.
         */
         ...
         * The default number of days to retain a manual snapshot.
         *
         * If the value is -1, the snapshot is retained indefinitely. This setting doesn't change
         ...
         *
         * @param manualSnapshotRetentionPeriod The default number of days to retain a manual
         *   snapshot.
         */
         ...
         *
         * @param masterPasswordSecretKmsKeyId The ID of the AWS Key Management Service (KMS) key
         *   used to encrypt and store the cluster's admin credentials secret.
         */
         ...
         *
         * @param masterUserPassword The password associated with the admin user account for the
         ...
         *
         * @param masterUsername The user name associated with the admin user account for the
         *   cluster that is being created.
         */
        public fun masterUsername(masterUsername: String)

        /**
         * A boolean indicating whether Amazon Redshift should deploy the cluster in two
         * Availability Zones.
         *
         ...
         *
         * @param multiAz A boolean indicating whether Amazon Redshift should deploy the cluster in
         ...
         * The Amazon Redshift operation to be performed.
         *
         * Supported operations are `pause-cluster` , `resume-cluster` , and
         ...
         * The name of the cluster the source snapshot was created from.
         *
         * This parameter is required if your user or role has a policy containing a snapshot
         ...
         *
         * @param snapshotCopyManual Indicates whether to apply the snapshot retention period to
         ...
         *
         * @param snapshotCopyRetentionPeriod The number of days to retain automated snapshots in
         *   the destination AWS Region after they are copied from the source AWS Region .
         */
    ...
    private class BuilderImpl(
        ...
        override fun availabilityZoneRelocation(availabilityZoneRelocation: IResolvable) {
            cdkBuilder.availabilityZoneRelocation(
                availabilityZoneRelocation.let(IResolvable::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("d493307f8744f66c8390c4cadb67055577fc3782950415e9c1772f9a33538a14")
        override fun loggingProperties(
            loggingProperties: LoggingPropertiesProperty.Builder.() -> Unit
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnCluster
        ): software.amazon.awscdk.services.redshift.CfnCluster = wrapped.cdkObject
    }
    ...
    public interface EndpointProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param port The port that the database engine is listening on. This property is read
             *   only.
             */
    ...
    public interface LoggingPropertiesProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: LoggingPropertiesProperty
            ): software.amazon.awscdk.services.redshift.CfnCluster.LoggingPropertiesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
