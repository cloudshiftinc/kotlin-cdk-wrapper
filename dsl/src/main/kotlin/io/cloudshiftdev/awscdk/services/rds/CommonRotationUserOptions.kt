...
public interface CommonRotationUserOptions {
    ...
    public interface Builder {
        ...
        /**
         * @param endpoint The VPC interface endpoint to use for the Secrets Manager API. If you
         *   enable private DNS hostnames for your VPC private endpoint (the default), you don't
         *   need to specify an endpoint. The standard Secrets Manager DNS hostname the Secrets
         *   Manager CLI and SDKs use by default (https://secretsmanager.<region>.amazonaws.com)
         *   automatically resolves to your VPC endpoint.
         */
    ...
    internal constructor(
         ...
         * The VPC interface endpoint to use for the Secrets Manager API.
         *
         * If you enable private DNS hostnames for your VPC private endpoint (the default), you
         * don't need to specify an endpoint. The standard Secrets Manager DNS hostname the Secrets
         * Manager CLI and SDKs use by default (https://secretsmanager.<region>.amazonaws.com)
         * automatically resolves to your VPC endpoint.
         *
         * Default: https://secretsmanager.<region>.amazonaws.com
         ...
         * Default: true
         */
        override fun rotateImmediatelyOnUpdate(): Boolean? =
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CommonRotationUserOptions
