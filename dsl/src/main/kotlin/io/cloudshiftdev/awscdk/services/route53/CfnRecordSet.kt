...
internal constructor(
     ...
     * Route 53 responds to DNS queries based on the geographic origin of the query and your
     * resources.
     */
    ...
    public open fun geoProximityLocation(
        `value`: GeoProximityLocationProperty.Builder.() -> Unit
     ...
     */
    public open fun resourceRecords(): List<String> =
     ...
     * One or more values that correspond with the value that you specified for the `Type` property.
     */
    public open fun resourceRecords(vararg `value`: String): Unit =
        resourceRecords(`value`.toList())
    ...
    public interface Builder {
         ...
         *
         * @param cidrRoutingConfig The object that is specified in resource record set object when
         *   you are linking a resource record set to a CIDR location.
         */
        ...
        /**
         * *GeoproximityLocation resource record sets only:* A complex type that lets you control
         * how Route 53 responds to DNS queries based on the geographic origin of the query and your
         * resources.
         *
         ...
         *
         * @param geoProximityLocation *GeoproximityLocation resource record sets only:* A complex
         *   type that lets you control how Route 53 responds to DNS queries based on the geographic
         ...
         * , AWS CloudFormation attempts to find a hosted zone whose name matches the
         * HostedZoneName. If AWS CloudFormation cannot find a hosted zone with a matching domain
         * name, or if there is more than one hosted zone with the specified domain name, AWS
         ...
         *   An identifier that differentiates among multiple resource record sets that have the
         *   same combination of name and type, such as multiple weighted resource record sets named
         ...
         *   multivalue answer record for each resource and specify `true` for `MultiValueAnswer` .
         */
         ...
         * IPv4 format for `ResourceRecords` . For information about the format of values for each
         * record type, see
         ...
         *
         * @param resourceRecords One or more values that correspond with the value that you
         ...
         *   the same combination of DNS name and type, a value that determines the proportion of
         *   DNS queries that Amazon Route 53 responds to using the current resource record set.
         */
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.route53.CfnRecordSet =
            cdkBuilder.build()
    }
    ...
    public companion object {
        ...
        ): CfnRecordSet = CfnRecordSet(cdkObject)

        internal fun unwrap(
            wrapped: CfnRecordSet
        ): software.amazon.awscdk.services.route53.CfnRecordSet = wrapped.cdkObject
    }
    ...
    public interface AliasTargetProperty {
         ...
         * record set inherits the health of the referenced AWS resource, such as an ELB load
        ...
        public interface Builder {
            ...
            /**
             * @param evaluateTargetHealth *Applies only to alias, failover alias, geolocation
             *   alias, latency alias, and weighted alias resource record sets:* When
             *   `EvaluateTargetHealth` is `true` , an alias resource record set inherits the health
             *   of the referenced AWS resource, such as an ELB load balancer or another resource
             *   record set in the hosted zone. Note the following:
