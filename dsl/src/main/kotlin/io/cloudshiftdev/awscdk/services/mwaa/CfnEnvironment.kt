...
internal constructor(
    ...
    /**
     * The queue ARN for the environment's
     * [Celery Executor](https://docs.aws.amazon.com/https://airflow.apache.org/docs/apache-airflow/stable/core-concepts/executor/celery.html)
     * . Amazon MWAA uses a Celery Executor to distribute tasks across multiple workers. When you
     * create an environment in a shared VPC, you must provide access to the Celery Executor queue
     * from your VPC.
     */
    ...
    public interface Builder {
        /**
         * A list of key-value pairs containing the Airflow configuration options for your
         * environment.
         *
         ...
         * managed, by the customer or by Amazon MWAA.
         *
         * If set to `SERVICE` , Amazon MWAA will create and manage the required VPC endpoints in
         * your VPC. If set to `CUSTOMER` , you must create, and manage, the VPC endpoints in your
         * VPC.
         *
         ...
         *
         * @param endpointManagement Defines whether the VPC endpoints configured for the
         *   environment are created, and managed, by the customer or by Amazon MWAA.
         */
         ...
         * AWS resources in your environment.
         *
         ...
         *   network traffic between the AWS resources for your environment.
         */
         ...
         *
         * @param pluginsS3ObjectVersion The version of the plugins.zip file on your Amazon S3
         ...
         *
         * @param pluginsS3Path The relative path to the `plugins.zip` file on your Amazon S3
         *   bucket. For example, `plugins.zip` . To learn more, see
         *   [Installing custom plugins](https://docs.aws.amazon.com/mwaa/latest/userguide/configuring-dag-import-plugins.html)
         *   .
         */
         ...
         *
         * @param requirementsS3ObjectVersion The version of the requirements.txt file on your
         *   Amazon S3 bucket. To learn more, see
         *   [Installing Python dependencies](https://docs.aws.amazon.com/mwaa/latest/userguide/working-dags-dependencies.html)
         *   .
         */
         ...
         *
         * @param requirementsS3Path The relative path to the `requirements.txt` file on your Amazon
         *   S3 bucket. For example, `requirements.txt` . To learn more, see
         *   [Installing Python dependencies](https://docs.aws.amazon.com/mwaa/latest/userguide/working-dags-dependencies.html)
         *   .
         */
         ...
         *
         * @param schedulers The number of schedulers that you want to run in your environment.
         *   Valid values:.
         */
         ...
         *
         * @param sourceBucketArn The Amazon Resource Name (ARN) of the Amazon S3 bucket where your
         *   DAG code and supporting files are stored.
         */
         ...
         *
         * @param startupScriptS3ObjectVersion The version of the startup shell script in your
         *   Amazon S3 bucket.
         */
         ...
         *
         * @param startupScriptS3Path The relative path to the startup shell script in your Amazon
         ...
         * [Tagging](https://docs.aws.amazon.com/general/latest/gr/aws_tagging.html) .
         *
         * If you specify new tags for an existing environment, the update requires service
         * interruption before taking effect.
         *
        ...
        /**
         * The day and time of the week to start weekly maintenance updates of your environment in
         ...
         *
         * @param weeklyMaintenanceWindowStart The day and time of the week to start weekly
    ...
    public interface LoggingConfigurationProperty {
        ...
        public interface Builder {
            ...
            public fun dagProcessingLogs(
                dagProcessingLogs: ModuleLoggingConfigurationProperty.Builder.() -> Unit
            )

            /**
             * @param schedulerLogs Defines the scheduler logs sent to CloudWatch Logs and the
             *   logging level to send.
             */
            ...
            public fun schedulerLogs(
                schedulerLogs: ModuleLoggingConfigurationProperty.Builder.() -> Unit
            )

            /**
             * @param taskLogs Defines the task logs sent to CloudWatch Logs and the logging level
             *   to send.
             */
            ...
            /**
             * @param webserverLogs Defines the web server logs sent to CloudWatch Logs and the
             *   logging level to send.
             */
            ...
            public fun webserverLogs(
                webserverLogs: ModuleLoggingConfigurationProperty.Builder.() -> Unit
            )

            /**
             * @param workerLogs Defines the worker logs sent to CloudWatch Logs and the logging
             *   level to send.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            override fun dagProcessingLogs(dagProcessingLogs: ModuleLoggingConfigurationProperty) {
                cdkBuilder.dagProcessingLogs(
                    dagProcessingLogs.let(ModuleLoggingConfigurationProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("1330f7c2b8e957ece7d3f6d63b8e92b8bd0cb2f4e727176b706cd8a77c679735")
            override fun dagProcessingLogs(
                dagProcessingLogs: ModuleLoggingConfigurationProperty.Builder.() -> Unit
            ...
            override fun schedulerLogs(schedulerLogs: ModuleLoggingConfigurationProperty) {
                cdkBuilder.schedulerLogs(
                    schedulerLogs.let(ModuleLoggingConfigurationProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("8a283a4f04f2890bdc485fdb461988647ae261ca78d3d9463cd916a5f9d3da19")
            override fun taskLogs(
                taskLogs: ModuleLoggingConfigurationProperty.Builder.() -> Unit
            ...
            override fun webserverLogs(webserverLogs: ModuleLoggingConfigurationProperty) {
                cdkBuilder.webserverLogs(
                    webserverLogs.let(ModuleLoggingConfigurationProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("663473f1a66947d758bb986bca1649a2c63d636a684bb8ae0cda9440fb485e36")
            override fun workerLogs(
                workerLogs: ModuleLoggingConfigurationProperty.Builder.() -> Unit
    ...
    public interface NetworkConfigurationProperty {
         ...
         *
         * *Required* to create an environment. Must be private subnets in two different
         * availability zones. A subnet must be attached to the same VPC as the security group. To
         * learn more, see
         * [About networking on Amazon MWAA](https://docs.aws.amazon.com/mwaa/latest/userguide/networking-about.html)
         * .
         *
        ...
        public interface Builder {
            /**
             * @param securityGroupIds A list of one or more security group IDs. Accepts up to 5
             *   security group IDs. A security group must be attached to the same VPC as the
             *   subnets. To learn more, see
             *   [Security in your VPC on Amazon MWAA](https://docs.aws.amazon.com/mwaa/latest/userguide/vpc-security.html)
             *   .
             */
            ...
            /**
             * @param subnetIds A list of subnet IDs. *Required* to create an environment. Must be
             *   private subnets in two different availability zones. A subnet must be attached to
             *   the same VPC as the security group. To learn more, see
             *   [About networking on Amazon MWAA](https://docs.aws.amazon.com/mwaa/latest/userguide/networking-about.html)
             *   .
             */
        ...
        internal constructor(
             ...
             * A list of one or more security group IDs.
             *
             * Accepts up to 5 security group IDs. A security group must be attached to the same VPC
             * as the subnets. To learn more, see
             * [Security in your VPC on Amazon MWAA](https://docs.aws.amazon.com/mwaa/latest/userguide/vpc-security.html)
             * .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-mwaa-environment-networkconfiguration.html#cfn-mwaa-environment-networkconfiguration-securitygroupids)
    ...
    public interface ModuleLoggingConfigurationProperty {
        /**
         * The ARN of the CloudWatch Logs log group for each type of Apache Airflow log type that
         * you have enabled.
         *
         ...
         * intrinsic function. Any value you provide for `CloudWatchLogGroupArn` is discarded by
         * Amazon MWAA.
         *
        ...
        public interface Builder {
            /**
             * @param cloudWatchLogGroupArn The ARN of the CloudWatch Logs log group for each type
             *   of Apache Airflow log type that you have enabled.
             *
             * `CloudWatchLogGroupArn` is available only as a return value, accessible when
             * specified as an attribute in the
             * [`Fn:GetAtt`](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-mwaa-environment.html#aws-resource-mwaa-environment-return-values)
             * intrinsic function. Any value you provide for `CloudWatchLogGroupArn` is discarded by
             * Amazon MWAA.
             */
             ...
             *   `DagProcessingLogs` ) to CloudWatch Logs. Valid values: `CRITICAL` , `ERROR` ,
             *   `WARNING` , `INFO` .
             */
        ...
        internal constructor(
            ...
            /**
             * The ARN of the CloudWatch Logs log group for each type of Apache Airflow log type
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ModuleLoggingConfigurationProperty
            ): software.amazon.awscdk.services.mwaa.CfnEnvironment.ModuleLoggingConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
