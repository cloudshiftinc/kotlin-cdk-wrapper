...
internal constructor(
    ...
    public companion object {
        public fun fromHostedZoneAttributes(
            ...
            software.amazon.awscdk.services.route53.HostedZone.fromHostedZoneAttributes(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    attrs.let(HostedZoneAttributes::unwrap)
                )
                .let(IHostedZone::wrap)
        ...
        public fun fromHostedZoneId(
            ...
            software.amazon.awscdk.services.route53.HostedZone.fromHostedZoneId(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    hostedZoneId
                )
        ...
        public fun fromLookup(
            ...
            software.amazon.awscdk.services.route53.HostedZone.fromLookup(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    query.let(HostedZoneProviderProps::unwrap)
                )
                .let(IHostedZone::wrap)
        ...
        ): HostedZone = HostedZone(cdkObject)

        internal fun unwrap(
            wrapped: HostedZone
        ): software.amazon.awscdk.services.route53.HostedZone = wrapped.cdkObject
    }
}
