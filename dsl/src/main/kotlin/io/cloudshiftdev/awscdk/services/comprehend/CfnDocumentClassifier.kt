...
internal constructor(
    ...
    public open fun inputDataConfig(`value`: DocumentClassifierInputDataConfigProperty) {
        unwrap(this)
            .setInputDataConfig(`value`.let(DocumentClassifierInputDataConfigProperty::unwrap))
    }

    /** Specifies the format and location of the input data for the job. */
    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("fa845bb8996e2d07951639209aea7266e697e921518a043a100313a831a7a0c9")
    public open fun inputDataConfig(
        `value`: DocumentClassifierInputDataConfigProperty.Builder.() -> Unit
    ...
    public open fun outputDataConfig(`value`: DocumentClassifierOutputDataConfigProperty) {
        unwrap(this)
            .setOutputDataConfig(`value`.let(DocumentClassifierOutputDataConfigProperty::unwrap))
    }

    /** Provides output results configuration parameters for custom classifier jobs. */
    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("12291ffa32da101ef8fdf0f59c198fd5baee02364473cdd77af792e863bcc29f")
    public open fun outputDataConfig(
        `value`: DocumentClassifierOutputDataConfigProperty.Builder.() -> Unit
    ...
    public interface Builder {
         ...
         *
         * @param dataAccessRoleArn The Amazon Resource Name (ARN) of the IAM role that grants
        ...
        public fun inputDataConfig(
            inputDataConfig: DocumentClassifierInputDataConfigProperty.Builder.() -> Unit
        )

        /**
         * The language of the input documents.
         *
         * You can specify any of the languages supported by Amazon Comprehend. All documents must
         ...
         *
         * @param modelKmsKeyId ID for the AWS KMS key that Amazon Comprehend uses to encrypt
        ...
        public fun outputDataConfig(
            outputDataConfig: DocumentClassifierOutputDataConfigProperty.Builder.() -> Unit
        )
         ...
         * Comprehend. For example, a tag with "Sales" as the key might be added to a resource to
         ...
         * The version name given to the newly created classifier.
         *
         * Version names can have a maximum of 256 characters. Alphanumeric characters, hyphens (-)
         * and underscores (_) are allowed. The version name must be unique among all models with
         * the same classifier name in the AWS account / AWS Region .
         *
         ...
         *
         * @param volumeKmsKeyId ID for the AWS Key Management Service (KMS) key that Amazon
         ...
         * resources you are using for your custom classifier.
         *
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.comprehend.CfnDocumentClassifier.Builder.create(
                scope,
                id
            )
        ...
        override fun inputDataConfig(inputDataConfig: DocumentClassifierInputDataConfigProperty) {
            cdkBuilder.inputDataConfig(
                inputDataConfig.let(DocumentClassifierInputDataConfigProperty::unwrap)
            )
        }
         ...
         *   classifier jobs.
         */
        override fun outputDataConfig(
            outputDataConfig: DocumentClassifierOutputDataConfigProperty
        ) {
            cdkBuilder.outputDataConfig(
                outputDataConfig.let(DocumentClassifierOutputDataConfigProperty::unwrap)
            )
        }
    ...
    public interface DocumentReaderConfigProperty {
         ...
         * * `TABLES` - Returns additional information about any tables that are detected in the
         *   input document.
        ...
        public interface Builder {
            /**
             * @param documentReadAction This field defines the Amazon Textract API operation that
             *   Amazon Comprehend uses to extract text from PDF files and image files. Enter one of
            ...
            /**
             * @param documentReadMode Determines the text extraction actions for PDF files. Enter
            ...
            /**
             * @param featureTypes Specifies the type of Amazon Textract features to apply. If you
             *   chose `TEXTRACT_ANALYZE_DOCUMENT` as the read action, you must specify one or both
             *   of the following values:
             * * `TABLES` - Returns additional information about any tables that are detected in the
             *   input document.
             * * `FORMS` - Returns additional information about any forms that are detected in the
             *   input document.
             */
        ...
        internal constructor(
             ...
             * Specifies the type of Amazon Textract features to apply.
             *
             * If you chose `TEXTRACT_ANALYZE_DOCUMENT` as the read action, you must specify one or
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DocumentReaderConfigProperty
            ): software.amazon.awscdk.services.comprehend.CfnDocumentClassifier.DocumentReaderConfigProperty =
    ...
    public interface DocumentClassifierDocumentsProperty {
        ...
        public interface Builder {
            /**
             * @param s3Uri The S3 URI location of the training documents specified in the S3Uri CSV
             *   file.
             */
            public fun s3Uri(s3Uri: String)

            /**
             * @param testS3Uri The S3 URI location of the test documents included in the TestS3Uri
             *   CSV file. This field is not required if you do not specify a test CSV file.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DocumentClassifierDocumentsProperty
            ): software.amazon.awscdk.services.comprehend.CfnDocumentClassifier.DocumentClassifierDocumentsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DocumentClassifierInputDataConfigProperty {
         ...
         * * `COMPREHEND_CSV` : A two-column CSV file, where labels are provided in the first
         ...
         *   Truth. This file is in JSON lines format. Each line is a complete JSON object that
         ...
         * classifier.
         *
         * The default delimiter between labels is a pipe (|). You can use a different character as
         * a delimiter (if it's an allowed character) by specifying it under Delimiter for labels.
         * If the training documents use a delimiter other than the default or the delimiter you
         * specify, the labels on that line will be combined to make a single unique label, such as
         * LABELLABELLABEL.
         *
         ...
         *
         * The S3 bucket must be in the same Region as the API endpoint that you are calling. The
         * URI can point to a single input file or it can provide the prefix for a collection of
         * input files.
         *
        ...
        public interface Builder {
             ...
             *   data for your custom model. An augmented manifest file is a labeled dataset that is
            ...
            public fun documentReaderConfig(
                documentReaderConfig: DocumentReaderConfigProperty.Builder.() -> Unit
            )

            /**
             * @param documentType The type of input documents for training the model. Provide
             *   plain-text documents to create a plain-text model, and provide semi-structured
             *   documents to create a native document model.
             */
            public fun documentType(documentType: String)

            /**
             * @param documents The S3 location of the training documents. This parameter is
            ...
            /**
             * @param labelDelimiter Indicates the delimiter used to separate each label for
             *   training a multi-label classifier. The default delimiter between labels is a pipe
             *   (|). You can use a different character as a delimiter (if it's an allowed
             *   character) by specifying it under Delimiter for labels. If the training documents
             *   use a delimiter other than the default or the delimiter you specify, the labels on
             *   that line will be combined to make a single unique label, such as LABELLABELLABEL.
             */
            public fun labelDelimiter(labelDelimiter: String)

            /**
             * @param s3Uri The Amazon S3 URI for the input data. The S3 bucket must be in the same
             *   Region as the API endpoint that you are calling. The URI can point to a single
             *   input file or it can provide the prefix for a collection of input files.
             *
             * For example, if you use the URI `S3://bucketName/prefix` , if the prefix is a single
             * file, Amazon Comprehend uses that file as input. If more than one file begins with
             * the prefix, Amazon Comprehend uses all of them as input.
             *
             * This parameter is required if you set `DataFormat` to `COMPREHEND_CSV` .
             */
            public fun s3Uri(s3Uri: String)
            ...
            /**
             * @param testS3Uri This specifies the Amazon S3 location that contains the test
             *   annotations for the document classifier. The URI must be in the same AWS Region as
        ...
        private class BuilderImpl : Builder {
            ...
            override fun documentReaderConfig(documentReaderConfig: DocumentReaderConfigProperty) {
                cdkBuilder.documentReaderConfig(
                    documentReaderConfig.let(DocumentReaderConfigProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("519b411b789a1ad772bfb7eb17d0edf75e33b4fb53670cdcc45bf87398c2eb16")
            override fun documentReaderConfig(
                documentReaderConfig: DocumentReaderConfigProperty.Builder.() -> Unit
            ...
            override fun documents(
                documents: DocumentClassifierDocumentsProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * The type of input documents for training the model.
             *
             * Provide plain-text documents to create a plain-text model, and provide
             ...
             * labels. If the training documents use a delimiter other than the default or the
             * delimiter you specify, the labels on that line will be combined to make a single
             * unique label, such as LABELLABELLABEL.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-comprehend-documentclassifier-documentclassifierinputdataconfig.html#cfn-comprehend-documentclassifier-documentclassifierinputdataconfig-labeldelimiter)
             */
             ...
             * The Amazon S3 URI for the input data.
             *
             * The S3 bucket must be in the same Region as the API endpoint that you are calling.
             * The URI can point to a single input file or it can provide the prefix for a
            ...
            /**
             * This specifies the Amazon S3 location that contains the test annotations for the
             * document classifier.
             *
             * The URI must be in the same AWS Region as the API endpoint that you are calling.
             *
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DocumentClassifierInputDataConfigProperty
            ): software.amazon.awscdk.services.comprehend.CfnDocumentClassifier.DocumentClassifierInputDataConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DocumentClassifierOutputDataConfigProperty {
        ...
        public interface Builder {
            /**
             * @param kmsKeyId ID for the AWS Key Management Service (KMS) key that Amazon
            ...
            /**
             * @param s3Uri When you use the `OutputDataConfig` object while creating a custom
             *   classifier, you specify the Amazon S3 location where you want to write the
             *   confusion matrix and other output files. The URI must be in the same Region as the
             *   API endpoint that you are calling. The location is used as the prefix for the
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DocumentClassifierOutputDataConfigProperty
            ): software.amazon.awscdk.services.comprehend.CfnDocumentClassifier.DocumentClassifierOutputDataConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface AugmentedManifestsListItemProperty {
         ...
         * for one or more jobs in the chain. Each LabelAttributeName key provides the annotations
        ...
        public interface Builder {
            /**
             * @param attributeNames The JSON attribute that contains the annotations for your
             *   training documents. The number of attribute names that you specify depends on
             *   whether your augmented manifest file is the output of a single labeling job or a
            ...
            /**
             * @param split The purpose of the data you've provided in the augmented manifest. You
             *   can either train or test this data. If you don't specify, the default is train.
             *
             * TRAIN - all of the documents in the manifest will be used for training. If no test
             * documents are provided, Amazon Comprehend will automatically reserve a portion of the
             * training documents for testing.
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AugmentedManifestsListItemProperty
            ): software.amazon.awscdk.services.comprehend.CfnDocumentClassifier.AugmentedManifestsListItemProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface VpcConfigProperty {
         ...
         * outbound traffic and provides security for the resources that you’ll be accessing on the
         * VPC. This ID number is preceded by "sg-", for instance: "sg-03b388029b0a285ea". For more
         * information, see
         ...
         *
         * This subnet is a subset of the a range of IPv4 addresses used by the VPC and is specific
         * to a given availability zone in the VPC’s Region. This ID number is preceded by
        ...
        public interface Builder {
            /**
             * @param securityGroupIds The ID number for a security group on an instance of your
             *   private VPC. Security groups on your VPC function serve as a virtual firewall to
             *   control inbound and outbound traffic and provides security for the resources that
             *   you’ll be accessing on the VPC. This ID number is preceded by "sg-", for instance:
             *   "sg-03b388029b0a285ea". For more information, see
             *   [Security Groups for your VPC](https://docs.aws.amazon.com/vpc/latest/userguide/VPC_SecurityGroups.html)
             *   .
             */
            ...
            /**
             * @param subnets The ID for each subnet being used in your private VPC. This subnet is
             *   a subset of the a range of IPv4 addresses used by the VPC and is specific to a
        ...
        internal constructor(
             ...
             * The ID number for a security group on an instance of your private VPC.
             *
             * Security groups on your VPC function serve as a virtual firewall to control inbound
             * and outbound traffic and provides security for the resources that you’ll be accessing
             ...
             * The ID for each subnet being used in your private VPC.
             *
             * This subnet is a subset of the a range of IPv4 addresses used by the VPC and is
             * specific to a given availability zone in the VPC’s Region. This ID number is preceded
             * by "subnet-", for instance: "subnet-04ccf456919e69055". For more information, see
             * [VPCs and Subnets](https://docs.aws.amazon.com/vpc/latest/userguide/VPC_Subnets.html)
             * .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-comprehend-documentclassifier-vpcconfig.html#cfn-comprehend-documentclassifier-vpcconfig-subnets)
