...
internal constructor(
    ...
    public interface Builder {
         ...
         * training data. For information about the required fields for a specific dataset domain
         * and type, see
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnDataset
        ): software.amazon.awscdk.services.forecast.CfnDataset = wrapped.cdkObject
    }
    ...
    public interface EncryptionConfigProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param roleArn The ARN of the IAM role that Amazon Forecast can assume to access the
             *   AWS KMS key. Passing a role across AWS accounts is not allowed. If you pass a role
    ...
    public interface SchemaProperty {
        ...
        public interface Builder {
            /**
             * @param attributes An array of attributes specifying the name and type of each field
             *   in a dataset.
             */
    ...
    public interface AttributesItemsProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AttributesItemsProperty
            ): software.amazon.awscdk.services.forecast.CfnDataset.AttributesItemsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
