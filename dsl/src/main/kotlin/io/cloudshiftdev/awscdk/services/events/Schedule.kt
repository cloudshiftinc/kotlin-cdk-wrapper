...
internal constructor(
    ...
    internal constructor(
        internal val cdkObject: software.amazon.awscdk.services.events.Schedule,
    ) : Schedule(cdkObject)

    public companion object {
        public fun cron(options: CronOptions): Schedule =
            software.amazon.awscdk.services.events.Schedule.cron(options.let(CronOptions::unwrap))
                .let(Schedule::wrap)
        ...
        public fun expression(expression: String): Schedule =
            software.amazon.awscdk.services.events.Schedule.expression(expression)
                .let(Schedule::wrap)

        public fun rate(duration: Duration): Schedule =
            software.amazon.awscdk.services.events.Schedule.rate(duration.let(Duration::unwrap))
                .let(Schedule::wrap)
