...
public interface HelmChartOptions {
    ...
    public interface Builder {
        ...
        /**
         * @param values The values to be used by the chart. For nested values use a nested
         *   dictionary. For example: values: { installationCRDs: true, webhook: { port: 9443 } }
         */
    ...
    private class BuilderImpl : Builder {
        ...
        public fun build(): software.amazon.awscdk.services.eks.HelmChartOptions =
            cdkBuilder.build()
    }
    ...
    internal constructor(
        ...
        /**
         * Whether or not Helm should wait until all Pods, PVCs, Services, and minimum number of
         * Pods of a Deployment, StatefulSet, or ReplicaSet are in a ready state before marking the
