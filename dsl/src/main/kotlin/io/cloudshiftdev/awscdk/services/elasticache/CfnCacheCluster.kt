...
internal constructor(
    ...
    public open fun preferredAvailabilityZone(): String? =
        unwrap(this).getPreferredAvailabilityZone()
    ...
    public interface Builder {
         ...
         *   single Availability Zone or created across multiple Availability Zones in the cluster's
         *   region.
         */
         ...
         * to their equivalent previous generation counterparts. Changing the CacheNodeType of a
         * Memcached instance is currently not supported. If you need to scale using Memcached, we
         * recommend forcing a replacement update by changing the `LogicalResourceId` of the
         * resource.
         * * General purpose:
         * * Current generation:
         *
         ...
         * [Supported Node Types by Region](https://docs.aws.amazon.com/AmazonElastiCache/latest/red-ug/CacheNodes.SupportedTypes.html#CacheNodes.SupportedTypesByRegion)
         *
         ...
         * The name of the parameter group to associate with this cluster.
         *
         * If this argument is omitted, the default parameter group for the specified engine is
         * used. You cannot use any parameter group which has `cluster-enabled='yes'` when creating
         * a cluster.
         *
         ...
         *
         * @param cacheSecurityGroupNames A list of security group names to associate with this
         *   cluster.
         */
         ...
         * that ID for the cache cluster. For more information, see
         * [Name Type](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-name.html)
         * .
         *
         * The name must contain 1 to 50 alphanumeric characters or hyphens. The name must start
         * with a letter and cannot end with a hyphen or contain two consecutive hyphens.
         *
         ...
         * were not previously specified and you don't specify any new values, an update requires
         ...
         *
         * @param preferredAvailabilityZone The EC2 Availability Zone in which the cluster is
         *   created.
         */
         ...
         *
         * @param preferredAvailabilityZones A list of the Availability Zones in which cache nodes
         *   are created.
         */
         ...
         * identifies a Redis RDB snapshot file stored in Amazon S3.
         *
         * The snapshot file is used to populate the node group (shard). The Amazon S3 object name
         ...
         * them.
         *
         * For example, if you set `SnapshotRetentionLimit` to 5, a snapshot taken today is retained
