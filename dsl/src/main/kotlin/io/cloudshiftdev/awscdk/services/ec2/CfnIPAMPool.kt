...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.ec2.CfnIPAMPool,
    ...
    public interface Builder {
         ...
         * netmask lengths for IPv4 addresses are 0 - 32. Possible netmask lengths for IPv6
         * addresses are 0 - 128.
         *
         ...
         *
         * @param allocationMaxNetmaskLength The maximum netmask length possible for CIDR
         *   allocations in this IPAM pool to be compliant.
         */
         ...
         *
         * @param allocationMinNetmaskLength The minimum netmask length required for CIDR
         *   allocations in this IPAM pool to be compliant.
         */
         ...
         * Tags that are required for resources that use CIDRs from this IPAM pool.
         *
         * Resources that do not have these tags will not be allowed to allocate space from the
         * pool. If the resources have their tags changed after they have allocated space or if the
         * allocation tagging requirements are changed on the pool, the resource may be marked as
         * noncompliant.
         *
         ...
         * other resources in order for the import to succeed. IPAM will import a CIDR regardless of
         * its compliance with the pool's allocation rules, so a resource might be imported and
         ...
         * allocations. Only resources in the same Region as the locale of the pool can get IP
         * address allocations from the pool. You can only allocate a CIDR for a VPC, for example,
         * from an IPAM pool that shares a locale with the VPC’s Region. Note that once you choose a
         * Locale for a pool, you cannot modify it. If you choose an AWS Region for locale that has
         ...
         * IPv6 CIDR block to a top-level IPv6 pool. For information on increasing the default
         * limit, see
         * [Quotas for your IPAM](https://docs.aws.amazon.com//vpc/latest/ipam/quotas-ipam.html) in
    ...
    private class BuilderImpl(
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("ef83e558225eb21dddf1d39328df53c2bd0b498f2d5a26d4bc20ea20a24682a6")
        override fun sourceResource(
            sourceResource: SourceResourceProperty.Builder.() -> Unit
    ...
    public interface ProvisionedCidrProperty {
         ...
         * and refers to a range of IP addresses. An IPv4 CIDR example is `10.24.34.0/23` . An IPv6
        ...
        public interface Builder {
            /**
             * @param cidr The CIDR provisioned to the IPAM pool. A CIDR is a representation of an
             *   IP address and its associated network mask (or netmask) and refers to a range of IP
        ...
        internal constructor(
             ...
             * The CIDR provisioned to the IPAM pool.
             *
             * A CIDR is a representation of an IP address and its associated network mask (or
             * netmask) and refers to a range of IP addresses. An IPv4 CIDR example is
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ProvisionedCidrProperty
            ): software.amazon.awscdk.services.ec2.CfnIPAMPool.ProvisionedCidrProperty =
    ...
    public interface SourceResourceProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SourceResourceProperty
            ): software.amazon.awscdk.services.ec2.CfnIPAMPool.SourceResourceProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
