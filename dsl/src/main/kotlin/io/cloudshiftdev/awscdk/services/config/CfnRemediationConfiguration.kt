...
internal constructor(
    ...
    public interface Builder {
        ...
        public fun executionControls(
            executionControls: ExecutionControlsProperty.Builder.() -> Unit
        )
         ...
         * seconds, AWS Config will put a RemediationException on your behalf for the failing
         ...
         *
         * @param maximumAutomaticAttempts The maximum number of failed attempts for
         *   auto-remediation. If you do not select a number, the default is 5.
         */
         ...
         * `RetryAttemptSeconds` , a remediation exception will be added to the resource. If you do
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.config.CfnRemediationConfiguration.Builder.create(
                scope,
                id
            )
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("be3a45ce517b58c86588a47a50ae3f6fff75472adb1a9bb29cbe4bd2da29274f")
        override fun executionControls(
            executionControls: ExecutionControlsProperty.Builder.() -> Unit
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnRemediationConfiguration
    ...
    public interface ExecutionControlsProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ExecutionControlsProperty
            ): software.amazon.awscdk.services.config.CfnRemediationConfiguration.ExecutionControlsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SsmControlsProperty {
        ...
        public interface Builder {
            /**
             * @param concurrentExecutionRatePercentage The maximum percentage of remediation
             *   actions allowed to run in parallel on the non-compliant resources for that specific
             *   rule. You can specify a percentage, such as 10%. The default value is 10.
             */
            public fun concurrentExecutionRatePercentage(concurrentExecutionRatePercentage: Number)

            /**
             * @param errorPercentage The percentage of errors that are allowed before SSM stops
             *   running automations on non-compliant resources for that specific rule. You can
             *   specify a percentage of errors, for example 10%. If you do not specifiy a
             *   percentage, the default is 50%. For example, if you set the ErrorPercentage to 40%
             *   for 10 non-compliant resources, then SSM stops running the automations when the
             *   fifth error is received.
             */
        ...
        private class BuilderImpl : Builder {
             ...
             *   rule. You can specify a percentage, such as 10%. The default value is 10.
             */
            override fun concurrentExecutionRatePercentage(
        ...
        internal constructor(
             ...
             * You can specify a percentage of errors, for example 10%. If you do not specifiy a
             * percentage, the default is 50%. For example, if you set the ErrorPercentage to 40%
             * for 10 non-compliant resources, then SSM stops running the automations when the fifth
             * error is received.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-config-remediationconfiguration-ssmcontrols.html#cfn-config-remediationconfiguration-ssmcontrols-errorpercentage)
             */
    ...
    public interface RemediationParameterValueProperty {
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("6a1446444839d26f366a9c554c7dad27fe1feaef75c5dbb0601c8b3d433e992f")
            override fun resourceValue(
                resourceValue: ResourceValueProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RemediationParameterValueProperty
            ): software.amazon.awscdk.services.config.CfnRemediationConfiguration.RemediationParameterValueProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
