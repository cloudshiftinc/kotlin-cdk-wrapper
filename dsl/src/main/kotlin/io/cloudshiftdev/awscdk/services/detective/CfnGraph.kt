...
internal constructor(
    ...
    public interface Builder {
        /**
         * Indicates whether to automatically enable new organization accounts as member accounts in
         * the organization behavior graph.
         *
         * By default, this property is set to `false` . If you want to change the value of this
         * property, you must be the Detective administrator for the organization. For more
         * information on setting a Detective administrator account, see
         ...
         *
         * @param autoEnableMembers Indicates whether to automatically enable new organization
