...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.iot.CfnScheduledAudit,
    ...
    public interface Builder {
         ...
         *
         * @param dayOfWeek The day of the week on which the scheduled audit is run (if the
         ...
         * Which checks are performed during the scheduled audit.
         *
         * Checks must be enabled for your account. (Use `DescribeAccountAuditConfiguration` to see
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.iot.CfnScheduledAudit =
            cdkBuilder.build()
    }
