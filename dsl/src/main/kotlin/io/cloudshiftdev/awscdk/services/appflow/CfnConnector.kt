...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.appflow.CfnConnector,
    ...
    public open fun connectorProvisioningConfig(): Any =
        unwrap(this).getConnectorProvisioningConfig()
    ...
    public open fun connectorProvisioningConfig(`value`: ConnectorProvisioningConfigProperty) {
        unwrap(this)
            .setConnectorProvisioningConfig(
                `value`.let(ConnectorProvisioningConfigProperty::unwrap)
            )
    }
    ...
    public open fun connectorProvisioningConfig(
        `value`: ConnectorProvisioningConfigProperty.Builder.() -> Unit
    ): Unit = connectorProvisioningConfig(ConnectorProvisioningConfigProperty(`value`))

    /** The provisioning type used to register the connector. */
    public open fun connectorProvisioningType(): String =
        unwrap(this).getConnectorProvisioningType()
    ...
    public interface Builder {
         ...
         *
         * @param connectorProvisioningConfig The configuration required for registering the
         *   connector.
         */
        ...
        public fun connectorProvisioningConfig(
            connectorProvisioningConfig: ConnectorProvisioningConfigProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
        ...
        override fun connectorProvisioningConfig(connectorProvisioningConfig: IResolvable) {
            cdkBuilder.connectorProvisioningConfig(
                connectorProvisioningConfig.let(IResolvable::unwrap)
            )
        }
         ...
         *   connector.
         */
        override fun connectorProvisioningConfig(
            connectorProvisioningConfig: ConnectorProvisioningConfigProperty
        ) {
            cdkBuilder.connectorProvisioningConfig(
                connectorProvisioningConfig.let(ConnectorProvisioningConfigProperty::unwrap)
            )
        }
        ...
        override fun connectorProvisioningConfig(
            ...
            connectorProvisioningConfig(
                ConnectorProvisioningConfigProperty(connectorProvisioningConfig)
            )
        ...
        public fun build(): software.amazon.awscdk.services.appflow.CfnConnector =
            cdkBuilder.build()
    }
    ...
    public companion object {
        ...
        ): software.amazon.awscdk.services.appflow.CfnConnector = wrapped.cdkObject
    }
    ...
    public interface ConnectorProvisioningConfigProperty {
        ...
        public interface Builder {
            /**
             * @param lambda Contains information about the configuration of the lambda which is
        ...
        private class BuilderImpl : Builder {
            private val cdkBuilder:
                ...
                software.amazon.awscdk.services.appflow.CfnConnector
            ...
            @JvmName("5950ab3d5fc3efe717c0d5750d63b530f6dc218e2d5f862378656fa69ec5b00f")
            override fun lambda(
                lambda: LambdaConnectorProvisioningConfigProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ConnectorProvisioningConfigProperty
            ): software.amazon.awscdk.services.appflow.CfnConnector.ConnectorProvisioningConfigProperty =
    ...
    public interface LambdaConnectorProvisioningConfigProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: LambdaConnectorProvisioningConfigProperty
            ): software.amazon.awscdk.services.appflow.CfnConnector.LambdaConnectorProvisioningConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
