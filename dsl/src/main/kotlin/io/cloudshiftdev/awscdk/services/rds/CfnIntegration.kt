...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param kmsKeyId The AWS Key Management System ( AWS KMS) key identifier for the key to
         *   use to encrypt the integration.
         */
         ...
         *
         * @param targetArn The ARN of the Redshift data warehouse to use as the target for
         *   replication.
         */
    ...
    public companion object {
        ...
        ): software.amazon.awscdk.services.rds.CfnIntegration = wrapped.cdkObject
    }
}
