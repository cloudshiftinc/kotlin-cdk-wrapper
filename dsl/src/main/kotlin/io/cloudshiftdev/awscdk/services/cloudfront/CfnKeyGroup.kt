...
internal constructor(
    ...
    private class BuilderImpl(
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("d9a4a4f05b6de8381284aad156431b9b88f598f84600d29913cf7a91f781bf4a")
        override fun keyGroupConfig(
            keyGroupConfig: KeyGroupConfigProperty.Builder.() -> Unit
        ): Unit = keyGroupConfig(KeyGroupConfigProperty(keyGroupConfig))

        public fun build(): software.amazon.awscdk.services.cloudfront.CfnKeyGroup =
            cdkBuilder.build()
    }
    ...
    public interface KeyGroupConfigProperty {
        ...
        public interface Builder {
            /**
             * @param comment A comment to describe the key group. The comment cannot be longer than
             *   128 characters.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: KeyGroupConfigProperty
            ): software.amazon.awscdk.services.cloudfront.CfnKeyGroup.KeyGroupConfigProperty =
