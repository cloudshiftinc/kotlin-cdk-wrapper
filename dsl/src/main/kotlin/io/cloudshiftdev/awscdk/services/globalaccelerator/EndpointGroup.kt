...
internal constructor(
     ...
     *
     * Uses a Custom Resource to look up the Security Group that Accelerator creates at deploy time.
     * Requires your VPC ID to perform the lookup.
     *
     * The Security Group will only be created if you enable **Client IP Preservation** on any of
     * the endpoints.
     *
     * You cannot manipulate the rules inside this security group, but you can use this security
     * group as a Peer in Connections rules on other constructs.
     *
     * @param id
     * @param vpc
     */
    public open fun connectionsPeer(id: String, vpc: IVpc): IPeer =
        unwrap(this).connectionsPeer(id, vpc.let(IVpc::unwrap)).let(IPeer::wrap)
    ...
    public interface Builder {
         ...
         * Default: 3
         *
         * @param healthCheckThreshold The number of consecutive health checks required to set the
         *   state of a healthy endpoint to unhealthy, or to set an unhealthy endpoint to healthy.
         */
         ...
         * Region based on optimal routing. Additional traffic is distributed to other endpoint
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.globalaccelerator.EndpointGroup.Builder.create(
                scope,
                id
            )
    ...
    public companion object {
        public fun fromEndpointGroupArn(
            ...
            software.amazon.awscdk.services.globalaccelerator.EndpointGroup.fromEndpointGroupArn(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    endpointGroupArn
                )
                .let(IEndpointGroup::wrap)
