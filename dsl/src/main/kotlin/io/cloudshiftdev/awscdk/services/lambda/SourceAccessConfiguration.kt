...
public interface SourceAccessConfiguration {
    ...
    public interface Builder {
        /**
         * @param type The type of authentication protocol or the VPC components for your event
         *   source. For example: "SASL_SCRAM_512_AUTH".
         */
         ...
         *   "arn:aws:secretsmanager:us-east-1:01234567890:secret:MyBrokerSecretName". The exact
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: SourceAccessConfiguration
