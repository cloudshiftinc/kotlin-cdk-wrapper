...
internal constructor(
    ...
    public interface Builder {
         ...
         * deleted.
         * * **true** - Deletes any reports that belong to the report group before deleting the
         *   report group.
         * * **false** - You must delete any reports in the report group. This is the default value.
         *   If you delete a report group that contains one or more reports, an exception is thrown.
         *
    ...
    private class BuilderImpl(
        ...
        override fun exportConfig(
            exportConfig: ReportExportConfigProperty.Builder.() -> Unit
    ...
    public interface ReportExportConfigProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param s3Destination A `S3ReportExportConfig` object that contains information about
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("29c4a28a99304714e987aae310598437035e5dbf4ed325d630307bf19085cf04")
            override fun s3Destination(
                s3Destination: S3ReportExportConfigProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ReportExportConfigProperty
            ): software.amazon.awscdk.services.codebuild.CfnReportGroup.ReportExportConfigProperty =
    ...
    public interface S3ReportExportConfigProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param encryptionDisabled A boolean value that specifies if the results of a report
             *   are encrypted.
             */
             ...
             * * `NONE` : CodeBuild creates the raw data in the output bucket. This is the default
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: S3ReportExportConfigProperty
            ): software.amazon.awscdk.services.codebuild.CfnReportGroup.S3ReportExportConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
