...
internal constructor(
    ...
    public interface Builder {
         ...
         * detection on the CloudFormation stack. For this reason, we recommend specifying the
         * resource policy content as a JSON object instead.
         *
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.organizations.CfnResourcePolicy.Builder.create(
                scope,
                id
            )
