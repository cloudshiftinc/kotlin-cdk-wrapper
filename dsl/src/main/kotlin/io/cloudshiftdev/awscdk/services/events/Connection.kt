...
internal constructor(
    ...
    public companion object {
        public fun fromConnectionAttributes(
            ...
            software.amazon.awscdk.services.events.Connection.fromConnectionAttributes(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    attrs.let(ConnectionAttributes::unwrap)
                )
                .let(IConnection::wrap)
        ...
        public fun fromEventBusArn(
            ...
            software.amazon.awscdk.services.events.Connection.fromEventBusArn(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    connectionArn,
                    connectionSecretArn
        ...
        ): Connection = Connection(cdkObject)

        internal fun unwrap(
            wrapped: Connection
        ): software.amazon.awscdk.services.events.Connection = wrapped.cdkObject
    }
}
