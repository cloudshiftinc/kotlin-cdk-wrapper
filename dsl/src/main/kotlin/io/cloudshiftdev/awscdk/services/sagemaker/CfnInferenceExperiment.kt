...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.sagemaker.CfnInferenceExperiment,
    ...
    public open fun schedule(
        `value`: InferenceExperimentScheduleProperty.Builder.() -> Unit
    ): Unit = schedule(InferenceExperimentScheduleProperty(`value`))

    /**
     * The configuration of `ShadowMode` inference experiment type, which shows the production
     * variant that takes all the inference requests, and the shadow variant to which Amazon
     * SageMaker replicates a percentage of the inference requests.
     */
    ...
    public interface Builder {
        ...
        public fun dataStorageConfig(
            dataStorageConfig: DataStorageConfigProperty.Builder.() -> Unit
        )
         ...
         *
         * @param desiredState The desired state of the experiment after stopping. The possible
         ...
         * `ModelVariantConfigSummary` object in the array describes the infrastructure
         ...
         *   artifacts and container images, and manage Amazon SageMaker Inference endpoints for
         *   model deployment.
         */
         ...
         *
         * @param shadowModeConfig The configuration of `ShadowMode` inference experiment type,
         *   which shows the production variant that takes all the inference requests, and the
         *   shadow variant to which Amazon SageMaker replicates a percentage of the inference
         *   requests.
         */
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.sagemaker.CfnInferenceExperiment.Builder.create(
                scope,
                id
            )
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("e51e3d075653daa5174b2be450830b085f8bebfaa6b2d62d2a20fe1a6bec95a5")
        override fun dataStorageConfig(
            dataStorageConfig: DataStorageConfigProperty.Builder.() -> Unit
        ...
        override fun schedule(
            schedule: InferenceExperimentScheduleProperty.Builder.() -> Unit
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("2243bb2097ea95ae6f2f4fe27c807f8fc42844d4f75293db606946ba663d6b13")
        override fun shadowModeConfig(
            shadowModeConfig: ShadowModeConfigProperty.Builder.() -> Unit
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnInferenceExperiment
    ...
    public interface DataStorageConfigProperty {
        ...
        public interface Builder {
            /**
             * @param contentType Configuration specifying how to treat different headers. If no
             *   headers are specified SageMaker will by default base64 encode when capturing the
             *   data.
             */
            ...
            /**
             * @param destination The Amazon S3 bucket where the inference request and response data
             *   is stored.
             */
            public fun destination(destination: String)

            /**
             * @param kmsKey The AWS Key Management Service key that Amazon SageMaker uses to
        ...
        private class BuilderImpl : Builder {
            ...
            override fun contentType(
                contentType: CaptureContentTypeHeaderProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * Configuration specifying how to treat different headers.
             *
             * If no headers are specified SageMaker will by default base64 encode when capturing
             * the data.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-sagemaker-inferenceexperiment-datastorageconfig.html#cfn-sagemaker-inferenceexperiment-datastorageconfig-contenttype)
             */
            ...
            /**
             * The AWS Key Management Service key that Amazon SageMaker uses to encrypt captured
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DataStorageConfigProperty
            ): software.amazon.awscdk.services.sagemaker.CfnInferenceExperiment.DataStorageConfigProperty =
    ...
    public interface ModelInfrastructureConfigProperty {
        ...
        public interface Builder {
            /**
             * @param infrastructureType The inference option to which to deploy your model.
            ...
            /**
             * @param realTimeInferenceConfig The infrastructure configuration for deploying the
             *   model to real-time inference.
             */
            ...
            public fun realTimeInferenceConfig(
                realTimeInferenceConfig: RealTimeInferenceConfigProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
             ...
             *   model to real-time inference.
             */
            override fun realTimeInferenceConfig(
                realTimeInferenceConfig: RealTimeInferenceConfigProperty
            ) {
                cdkBuilder.realTimeInferenceConfig(
                    realTimeInferenceConfig.let(RealTimeInferenceConfigProperty::unwrap)
                )
            }
            ...
            override fun realTimeInferenceConfig(
                ...
                realTimeInferenceConfig(RealTimeInferenceConfigProperty(realTimeInferenceConfig))
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ModelInfrastructureConfigProperty
            ): software.amazon.awscdk.services.sagemaker.CfnInferenceExperiment.ModelInfrastructureConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ShadowModelVariantConfigProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ShadowModelVariantConfigProperty
            ): software.amazon.awscdk.services.sagemaker.CfnInferenceExperiment.ShadowModelVariantConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ShadowModeConfigProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ShadowModeConfigProperty
            ): software.amazon.awscdk.services.sagemaker.CfnInferenceExperiment.ShadowModeConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface RealTimeInferenceConfigProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RealTimeInferenceConfigProperty
            ): software.amazon.awscdk.services.sagemaker.CfnInferenceExperiment.RealTimeInferenceConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ModelVariantConfigProperty {
        ...
        public interface Builder {
            /**
             * @param infrastructureConfig The configuration for the infrastructure that the model
             *   will be deployed to.
             */
            ...
            public fun infrastructureConfig(
                infrastructureConfig: ModelInfrastructureConfigProperty.Builder.() -> Unit
            )
        ...
        private class BuilderImpl : Builder {
             ...
             *   will be deployed to.
             */
            override fun infrastructureConfig(
                infrastructureConfig: ModelInfrastructureConfigProperty
            ) {
                cdkBuilder.infrastructureConfig(
                    infrastructureConfig.let(ModelInfrastructureConfigProperty::unwrap)
                )
            }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ModelVariantConfigProperty
            ): software.amazon.awscdk.services.sagemaker.CfnInferenceExperiment.ModelVariantConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface InferenceExperimentScheduleProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param startTime The timestamp at which the inference experiment started or will
             *   start.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: InferenceExperimentScheduleProperty
            ): software.amazon.awscdk.services.sagemaker.CfnInferenceExperiment.InferenceExperimentScheduleProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CaptureContentTypeHeaderProperty {
        ...
        public interface Builder {
            /**
             * @param csvContentTypes The list of all content type headers that Amazon SageMaker
            ...
            /**
             * @param jsonContentTypes The list of all content type headers that SageMaker will
    ...
    public interface EndpointMetadataProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param endpointStatus The status of the endpoint. For possible values of the status
             *   of an endpoint, see
             *   [](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-sagemaker-inferenceexperiment-endpointmetadata.html#cfn-sagemaker-inferenceexperiment-endpointmetadata-endpointstatus)
             *   .
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: EndpointMetadataProperty
            ): software.amazon.awscdk.services.sagemaker.CfnInferenceExperiment.EndpointMetadataProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
