...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * Changing this value will result in the access key being deleted and a new access key
         * (with a different ID and secret value) being assigned to the new user.
         *
