...
public interface ApplyCloudFormationInitOptions {
    ...
    public interface Builder {
         ...
         *   if the config changes, the UserData changes and instances will be replaced (given an
         *   UpdatePolicy has been configured on the AutoScalingGroup).
         *
         * If `false`, no such hash will be embedded, and if the CloudFormation Init config changes
         * nothing will happen to the running instances. If a config update introduces errors, you
