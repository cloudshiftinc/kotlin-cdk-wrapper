...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * Default: - Public subnets if `assignPublicIp` is set, otherwise the first available one
         * of Private, Isolated, Public, in that order.
         *
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: ApplicationLoadBalancedFargateService
        ): software.amazon.awscdk.services.ecs.patterns.ApplicationLoadBalancedFargateService =
            wrapped.cdkObject
    }
}
