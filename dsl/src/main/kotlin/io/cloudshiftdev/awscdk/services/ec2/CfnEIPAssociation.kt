...
internal constructor(
    ...
    public interface Builder {
         ...
         * @deprecated this property has been deprecated
         */
        @Deprecated(message = "deprecated in CDK") public fun eip(eip: String)
         ...
         * The ID of the network interface.
         *
         * If the instance has more than one network interface, you must specify a network interface
         * ID.
         *
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.ec2.CfnEIPAssociation =
            cdkBuilder.build()
    }
