...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.kinesis.CfnStream,
    ...
    public interface Builder {
         ...
         * that ID for the stream name. For more information, see
         ...
         * specified stream.
         *
         * Removing this property from your stack template and updating your stack disables
         * encryption.
         *
         ...
         *
         * @param streamEncryption When specified, enables or updates server-side encryption using
         *   an AWS KMS key for a specified stream.
         */
         ...
         * Specifies the capacity mode to which you want to set your data stream.
         *
         * Currently, in Kinesis Data Streams, you can choose between an *on-demand* capacity mode
        ...
        public fun streamModeDetails(
            streamModeDetails: StreamModeDetailsProperty.Builder.() -> Unit
        )
         ...
         *
         * @param tags An arbitrary set of tags (key–value pairs) to associate with the Kinesis
         *   stream.
         */
    ...
    private class BuilderImpl(
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("13144c49d575e3934185ca810fda708916113c21ab18297ad3c3810ee15617ff")
        override fun streamEncryption(
            streamEncryption: StreamEncryptionProperty.Builder.() -> Unit
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("88c9ad7dc25f819c3732b2119e267de19d8b6b442bcabf2ab6ed2ae9a306d457")
        override fun streamModeDetails(
            streamModeDetails: StreamModeDetailsProperty.Builder.() -> Unit
    ...
    public interface StreamModeDetailsProperty {
        ...
        public interface Builder {
            /**
             * @param streamMode Specifies the capacity mode to which you want to set your data
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: StreamModeDetailsProperty
            ): software.amazon.awscdk.services.kinesis.CfnStream.StreamModeDetailsProperty =
    ...
    public interface StreamEncryptionProperty {
         ...
         * (ARN) to either an alias or a key, or an alias name prefixed by "alias/".You can also use
        ...
        internal constructor(
             ...
             *
             * This value can be a globally unique identifier, a fully specified Amazon Resource
             * Name (ARN) to either an alias or a key, or an alias name prefixed by "alias/".You can
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: StreamEncryptionProperty
            ): software.amazon.awscdk.services.kinesis.CfnStream.StreamEncryptionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
