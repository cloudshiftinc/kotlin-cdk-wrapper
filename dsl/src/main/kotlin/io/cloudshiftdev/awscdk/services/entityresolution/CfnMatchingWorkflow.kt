...
internal constructor(
    ...
    public open fun resolutionTechniques(
        `value`: ResolutionTechniquesProperty.Builder.() -> Unit
    ...
    public interface Builder {
        ...
        public fun resolutionTechniques(
            resolutionTechniques: ResolutionTechniquesProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.entityresolution.CfnMatchingWorkflow.Builder.create(
                scope,
                id
            )
        ...
        override fun resolutionTechniques(resolutionTechniques: ResolutionTechniquesProperty) {
            cdkBuilder.resolutionTechniques(
                resolutionTechniques.let(ResolutionTechniquesProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("a12242bc1b27d8c9689dda0dfefcf5d7fd966f70e529f3e77333e4b94f1a9f0e")
        override fun resolutionTechniques(
            resolutionTechniques: ResolutionTechniquesProperty.Builder.() -> Unit
    ...
    public interface RuleBasedPropertiesProperty {
         ...
         * choosing `MANY_TO_MANY` , the system can match attributes across the sub-types of an
         * attribute type. For example, if the value of the `Email` field of Profile A and the value
         * of `BusinessEmail` field of Profile B matches, the two profiles are matched on the
         * `Email` type. When choosing `ONE_TO_ONE` ,the system can only match if the sub-types are
         * exact matches. For example, only when the value of the `Email` field of Profile A and the
        ...
        public interface Builder {
            /**
             * @param attributeMatchingModel The comparison type. You can either choose `ONE_TO_ONE`
             *   or `MANY_TO_MANY` as the AttributeMatchingModel. When choosing `MANY_TO_MANY` , the
             *   system can match attributes across the sub-types of an attribute type. For example,
             *   if the value of the `Email` field of Profile A and the value of `BusinessEmail`
             *   field of Profile B matches, the two profiles are matched on the `Email` type. When
             *   choosing `ONE_TO_ONE` ,the system can only match if the sub-types are exact
             *   matches. For example, only when the value of the `Email` field of Profile A and the
             *   value of the `Email` field of Profile B matches, the two profiles are matched on
             *   the `Email` type.
             */
        ...
        internal constructor(
             ...
             * When choosing `MANY_TO_MANY` , the system can match attributes across the sub-types
             * of an attribute type. For example, if the value of the `Email` field of Profile A and
             * the value of `BusinessEmail` field of Profile B matches, the two profiles are matched
             * on the `Email` type. When choosing `ONE_TO_ONE` ,the system can only match if the
             * sub-types are exact matches. For example, only when the value of the `Email` field of
             * Profile A and the value of the `Email` field of Profile B matches, the two profiles
             * are matched on the `Email` type.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-entityresolution-matchingworkflow-rulebasedproperties.html#cfn-entityresolution-matchingworkflow-rulebasedproperties-attributematchingmodel)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RuleBasedPropertiesProperty
            ): software.amazon.awscdk.services.entityresolution.CfnMatchingWorkflow.RuleBasedPropertiesProperty =
    ...
    public interface OutputSourceProperty {
         ...
         *
         * For example, if an attribute has an `AttributeType` of `PHONE_NUMBER` , and the data in
         * the input table is in a format of 1234567890, AWS Entity Resolution will normalize this
         ...
         *
         * Each of these objects selects a column to be included in the output table, and whether
        ...
        public interface Builder {
            /**
             * @param applyNormalization Normalizes the attributes defined in the schema in the
             *   input data. For example, if an attribute has an `AttributeType` of `PHONE_NUMBER` ,
             *   and the data in the input table is in a format of 1234567890, AWS Entity Resolution
            ...
            /**
             * @param kmsArn Customer KMS ARN for encryption at rest. If not provided, system will
             *   use an AWS Entity Resolution managed KMS key.
             */
            public fun kmsArn(kmsArn: String)

            /**
             * @param output A list of `OutputAttribute` objects, each of which have the fields
            ...
            /**
             * @param outputS3Path The S3 path to which AWS Entity Resolution will write the output
             *   table.
             */
        ...
        internal constructor(
             ...
             * Normalizes the attributes defined in the schema in the input data.
             *
             * For example, if an attribute has an `AttributeType` of `PHONE_NUMBER` , and the data
             * in the input table is in a format of 1234567890, AWS Entity Resolution will normalize
    ...
    public interface ProviderPropertiesProperty {
        ...
        public interface Builder {
            /**
             * @param intermediateSourceConfiguration The Amazon S3 location that temporarily stores
             *   your data while it processes. Your information won't be saved permanently.
             */
            ...
            public fun intermediateSourceConfiguration(
                intermediateSourceConfiguration:
                    IntermediateSourceConfigurationProperty.Builder.() -> Unit
            )

            /**
             * @param providerConfiguration The required configuration fields to use with the
             *   provider service.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            override fun intermediateSourceConfiguration(
                intermediateSourceConfiguration: IResolvable
            ) {
                cdkBuilder.intermediateSourceConfiguration(
                    intermediateSourceConfiguration.let(IResolvable::unwrap)
                )
            }
            ...
            override fun intermediateSourceConfiguration(
                ...
                cdkBuilder.intermediateSourceConfiguration(
                    intermediateSourceConfiguration.let(
                        IntermediateSourceConfigurationProperty::unwrap
                    )
                )
            }
            ...
            override fun intermediateSourceConfiguration(
                ...
                intermediateSourceConfiguration(
                    IntermediateSourceConfigurationProperty(intermediateSourceConfiguration)
                )
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ProviderPropertiesProperty
            ): software.amazon.awscdk.services.entityresolution.CfnMatchingWorkflow.ProviderPropertiesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ResolutionTechniquesProperty {
        ...
        public interface Builder {
            ...
            public fun providerProperties(
                providerProperties: ProviderPropertiesProperty.Builder.() -> Unit
            )

            /**
             * @param resolutionType The type of matching. There are two types of matching:
             *   `RULE_MATCHING` and `ML_MATCHING` .
             */
            public fun resolutionType(resolutionType: String)

            /**
             * @param ruleBasedProperties An object which defines the list of matching rules to run
             *   and has a field `Rules` , which is a list of rule objects.
             */
            ...
            public fun ruleBasedProperties(
                ruleBasedProperties: RuleBasedPropertiesProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun providerProperties(providerProperties: ProviderPropertiesProperty) {
                cdkBuilder.providerProperties(
                    providerProperties.let(ProviderPropertiesProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("8e1873bb6790a95692a48ecbe2d02211a68fb7e870f066de197064e5211312d4")
            override fun providerProperties(
                providerProperties: ProviderPropertiesProperty.Builder.() -> Unit
            ...
            override fun ruleBasedProperties(ruleBasedProperties: RuleBasedPropertiesProperty) {
                cdkBuilder.ruleBasedProperties(
                    ruleBasedProperties.let(RuleBasedPropertiesProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("1e25091e8a97032b2c448c5ce58b3d554750bdc070d7440d4c6c2bf477344024")
            override fun ruleBasedProperties(
                ruleBasedProperties: RuleBasedPropertiesProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ResolutionTechniquesProperty
            ): software.amazon.awscdk.services.entityresolution.CfnMatchingWorkflow.ResolutionTechniquesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface IntermediateSourceConfigurationProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: IntermediateSourceConfigurationProperty
            ): software.amazon.awscdk.services.entityresolution.CfnMatchingWorkflow.IntermediateSourceConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface OutputAttributeProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param name A name of a column to be written to the output. This must be an
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: OutputAttributeProperty
            ): software.amazon.awscdk.services.entityresolution.CfnMatchingWorkflow.OutputAttributeProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface RuleProperty {
        ...
        public interface Builder {
            /**
             * @param matchingKeys A list of `MatchingKeys` . The `MatchingKeys` must have been
