...
internal constructor(
     ...
     *
     * See
     * [the IAM documentation](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_policies_elements_condition.html).
    ...
    public open fun principalJson(): Map<String, List<String>> =
        unwrap(this).getPrincipalJson() ?: emptyMap()
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: PrincipalPolicyFragment
