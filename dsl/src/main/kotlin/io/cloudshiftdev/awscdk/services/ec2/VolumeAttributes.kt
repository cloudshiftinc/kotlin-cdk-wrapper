...
public interface VolumeAttributes {
    ...
    public interface Builder {
        /**
         * @param availabilityZone The availability zone that the EBS Volume is contained within
         *   (ex: us-west-2a).
         */
    ...
    private class BuilderImpl : Builder {
        ...
        public fun build(): software.amazon.awscdk.services.ec2.VolumeAttributes =
            cdkBuilder.build()
    }
