...
internal constructor(
     ...
     * * For ED25519 key pairs, the key fingerprint is the base64-encoded SHA-256 digest, which is
     *   the default for OpenSSH, starting with
     *   [OpenSSH 6.8](https://docs.aws.amazon.com/http://www.openssh.com/txt/release-6.8) .
     *
    ...
    public interface Builder {
         ...
         *
         * If the `PublicKeyMaterial` property is specified, the `KeyType` property is ignored, and
         * the key type is inferred from the `PublicKeyMaterial` value.
         *
         * Default: `rsa`
         *
         * Default: - "rsa"
