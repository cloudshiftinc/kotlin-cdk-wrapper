...
public interface HealthCheckConfig {
    ...
    public interface Builder {
         ...
         *   pass or fail for Route 53 to change the current status of the endpoint from unhealthy
         ...
         *   checks. Do not use when health check type is TCP.
         */
        public fun resourcePath(resourcePath: String)

        /**
         * @param type The type of health check that you want to create, which indicates how Route
         *   53 determines whether an endpoint is healthy. Cannot be modified once created.
