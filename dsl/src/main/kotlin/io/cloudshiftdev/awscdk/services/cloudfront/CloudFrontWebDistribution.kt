...
internal constructor(
     ...
     *
     * If you are using aliases for your distribution, this is the domainName your DNS records
     * should point to. (In Route53, you could create an ALIAS record to this value, for example.)
     */
    ...
    public interface Builder {
         ...
         *
         * @param errorConfigurations How CloudFront should handle requests that are not successful
         *   (eg PageNotFound).
         */
        public fun errorConfigurations(
            errorConfigurations: List<CfnDistribution.CustomErrorResponseProperty>
        )
         ...
         */
        public fun errorConfigurations(
            vararg errorConfigurations: CfnDistribution.CustomErrorResponseProperty
        )
         ...
         *
         * You can pass an empty object ({}) to have us auto create a bucket for logging. Omission
         * of this property indicates no logging is to be enabled.
         *
         ...
         *
         * Default: PriceClass.PRICE_CLASS_100 the cheapest option for CloudFront is picked by
         * default.
         *
         ...
         * you're using an alternate domain name with HTTPS, and if so, if you're using AWS
         ...
         *
         * @param viewerCertificate Specifies whether you want viewers to use HTTP or HTTPS to
         *   request your objects, whether you're using an alternate domain name with HTTPS, and if
         *   so, if you're using AWS Certificate Manager (ACM) or a third-party certificate
         *   authority.
         */
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.cloudfront.CloudFrontWebDistribution.Builder.create(
                scope,
                id
            )
         ...
         *   (eg PageNotFound).
         */
        override fun errorConfigurations(
            errorConfigurations: List<CfnDistribution.CustomErrorResponseProperty>
        ) {
            cdkBuilder.errorConfigurations(
                errorConfigurations.map(CfnDistribution.CustomErrorResponseProperty::unwrap)
            )
        }
        ...
        override fun errorConfigurations(
            vararg errorConfigurations: CfnDistribution.CustomErrorResponseProperty
        ): Unit = errorConfigurations(errorConfigurations.toList())
    ...
    public companion object {
        public fun fromDistributionAttributes(
            ...
            software.amazon.awscdk.services.cloudfront.CloudFrontWebDistribution
                .fromDistributionAttributes(
                    ...
                    id,
                    attrs.let(CloudFrontWebDistributionAttributes::unwrap)
                )
        ...
        public fun fromDistributionAttributes(
            ...
            fromDistributionAttributes(scope, id, CloudFrontWebDistributionAttributes(attrs))
        ...
        internal fun unwrap(
            wrapped: CloudFrontWebDistribution
