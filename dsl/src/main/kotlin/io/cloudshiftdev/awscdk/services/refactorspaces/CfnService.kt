...
internal constructor(
    ...
    private class BuilderImpl(
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("a6231c439ee4d9e501fb467b9f8e57e8b658fd232b6b74ea00bfbce15775d6ea")
        override fun lambdaEndpoint(
            lambdaEndpoint: LambdaEndpointInputProperty.Builder.() -> Unit
    ...
    public interface UrlEndpointInputProperty {
         ...
         *
         * If the URL is a public endpoint, the `HealthUrl` must also be a public endpoint. If the
         * URL is a private endpoint inside a virtual private cloud (VPC), the health URL must also
         ...
         *
         * The URL must be an
         * [rfc3986-formatted URL](https://docs.aws.amazon.com/https://datatracker.ietf.org/doc/html/rfc3986)
         * . If the host is a domain name, the name must be resolvable over the public internet. If
         * the scheme is `https` , the top level domain of the host must be listed in the
         * [IANA root zone database](https://docs.aws.amazon.com/https://www.iana.org/domains/root/db)
         * .
         *
        ...
        public interface Builder {
            /**
             * @param healthUrl The health check URL of the URL endpoint type. If the URL is a
             *   public endpoint, the `HealthUrl` must also be a public endpoint. If the URL is a
             *   private endpoint inside a virtual private cloud (VPC), the health URL must also be
             *   a private endpoint, and the host must be the same as the URL.
             */
            public fun healthUrl(healthUrl: String)

            /**
             * @param url The URL to route traffic to. The URL must be an
             *   [rfc3986-formatted URL](https://docs.aws.amazon.com/https://datatracker.ietf.org/doc/html/rfc3986)
        ...
        internal constructor(
             ...
             * The health check URL of the URL endpoint type.
             *
             * If the URL is a public endpoint, the `HealthUrl` must also be a public endpoint. If
             * the URL is a private endpoint inside a virtual private cloud (VPC), the health URL
             ...
             * The URL must be an
             * [rfc3986-formatted URL](https://docs.aws.amazon.com/https://datatracker.ietf.org/doc/html/rfc3986)
             * . If the host is a domain name, the name must be resolvable over the public internet.
             * If the scheme is `https` , the top level domain of the host must be listed in the
             * [IANA root zone database](https://docs.aws.amazon.com/https://www.iana.org/domains/root/db)
             * .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-refactorspaces-service-urlendpointinput.html#cfn-refactorspaces-service-urlendpointinput-url)
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: UrlEndpointInputProperty
            ): software.amazon.awscdk.services.refactorspaces.CfnService.UrlEndpointInputProperty =
    ...
    public interface LambdaEndpointInputProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: LambdaEndpointInputProperty
            ): software.amazon.awscdk.services.refactorspaces.CfnService.LambdaEndpointInputProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
