...
public interface MfaSecondFactor {
    ...
    public interface Builder {
        /**
         * @param otp The MFA token is a time-based one time password that is generated by a
    ...
    private class BuilderImpl : Builder {
        ...
        public fun build(): software.amazon.awscdk.services.cognito.MfaSecondFactor =
            cdkBuilder.build()
    }
    ...
    internal constructor(
        ...
        /**
         * The MFA token is a time-based one time password that is generated by a hardware or
         * software token.
         *
         * Default: false
         *
    ...
    public companion object {
        ...
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.cognito.MfaSecondFactor
        ): MfaSecondFactor = Wrapper(cdkObject)

        internal fun unwrap(
            wrapped: MfaSecondFactor
