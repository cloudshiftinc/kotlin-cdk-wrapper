...
internal constructor(
    ...
    public open fun codeSigningPolicies(
        `value`: CodeSigningPoliciesProperty.Builder.() -> Unit
    ): Unit = codeSigningPolicies(CodeSigningPoliciesProperty(`value`))
    ...
    public interface Builder {
        ...
        public fun allowedPublishers(
            allowedPublishers: AllowedPublishersProperty.Builder.() -> Unit
        )
         ...
         *
         * @param codeSigningPolicies The code signing policy controls the validation failure action
        ...
        public fun codeSigningPolicies(
            codeSigningPolicies: CodeSigningPoliciesProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
        ...
        override fun codeSigningPolicies(codeSigningPolicies: CodeSigningPoliciesProperty) {
            cdkBuilder.codeSigningPolicies(
                codeSigningPolicies.let(CodeSigningPoliciesProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("5e89c4bb122d8303bbd07d0c45a8ccec11bfba0a9205276573e8b3bdf0af14c6")
        override fun codeSigningPolicies(
            codeSigningPolicies: CodeSigningPoliciesProperty.Builder.() -> Unit
    ...
    public interface AllowedPublishersProperty {
        ...
        public interface Builder {
            /**
             * @param signingProfileVersionArns The Amazon Resource Name (ARN) for each of the
             *   signing profiles. A signing profile defines a trusted user who can sign a code
             *   package.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AllowedPublishersProperty
            ): software.amazon.awscdk.services.lambda.CfnCodeSigningConfig.AllowedPublishersProperty =
    ...
    public interface CodeSigningPoliciesProperty {
         ...
         * validation checks fail. If you set the policy to `Warn` , Lambda allows the deployment
         * and creates a CloudWatch log.
         *
         * Default value: `Warn`
         *
         * Default: - "Warn"
        ...
        public interface Builder {
             ...
             *   validation failure. If you set the policy to `Enforce` , Lambda blocks the
             *   deployment request if signature validation checks fail. If you set the policy to
        ...
        internal constructor(
             ...
             * signature validation checks fail. If you set the policy to `Warn` , Lambda allows the
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CodeSigningPoliciesProperty
            ): software.amazon.awscdk.services.lambda.CfnCodeSigningConfig.CodeSigningPoliciesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
