...
internal constructor(
    ...
    public open fun signatureValidityPeriod(`value`: SignatureValidityPeriodProperty) {
        unwrap(this)
            .setSignatureValidityPeriod(`value`.let(SignatureValidityPeriodProperty::unwrap))
    }

    /** The validity period override for any signature generated using this signing profile. */
    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("30dfd32a0fc87344ddf1d8406dc8817aaf4356cac7ded8734697eb18258b5eff")
    public open fun signatureValidityPeriod(
        `value`: SignatureValidityPeriodProperty.Builder.() -> Unit
    ): Unit = signatureValidityPeriod(SignatureValidityPeriodProperty(`value`))
    ...
    public interface Builder {
         ...
         *
         * @param signatureValidityPeriod The validity period override for any signature generated
         *   using this signing profile.
         */
        ...
        public fun signatureValidityPeriod(
            signatureValidityPeriod: SignatureValidityPeriodProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
         ...
         *   using this signing profile.
         */
        override fun signatureValidityPeriod(
            signatureValidityPeriod: SignatureValidityPeriodProperty
        ) {
            cdkBuilder.signatureValidityPeriod(
                signatureValidityPeriod.let(SignatureValidityPeriodProperty::unwrap)
            )
        }
    ...
    public interface SignatureValidityPeriodProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SignatureValidityPeriodProperty
            ): software.amazon.awscdk.services.signer.CfnSigningProfile.SignatureValidityPeriodProperty =
