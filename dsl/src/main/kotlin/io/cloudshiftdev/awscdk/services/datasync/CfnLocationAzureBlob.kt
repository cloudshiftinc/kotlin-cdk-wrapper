...
internal constructor(
    ...
    public open fun azureBlobSasConfiguration(`value`: AzureBlobSasConfigurationProperty) {
        unwrap(this)
            .setAzureBlobSasConfiguration(`value`.let(AzureBlobSasConfigurationProperty::unwrap))
    }

    /** Specifies the SAS configuration that allows DataSync to access your Azure Blob Storage. */
    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("cada99c19279ebff001010bf700bca5e722eb542e50b35ea2d0eb41ad3fc4b65")
    public open fun azureBlobSasConfiguration(
        `value`: AzureBlobSasConfigurationProperty.Builder.() -> Unit
    ...
    public interface Builder {
         ...
         *
         * @param azureBlobContainerUrl Specifies the URL of the Azure Blob Storage container
        ...
        public fun azureBlobSasConfiguration(
            azureBlobSasConfiguration: AzureBlobSasConfigurationProperty.Builder.() -> Unit
        )

        /**
         * Specifies the type of blob that you want your objects or files to be when transferring
         * them into Azure Blob Storage.
         *
         ...
         *
         * @param subdirectory Specifies path segments if you want to limit your transfer to a
    ...
    private class BuilderImpl(
         ...
         *   access your Azure Blob Storage.
         */
        override fun azureBlobSasConfiguration(
            azureBlobSasConfiguration: AzureBlobSasConfigurationProperty
        ) {
            cdkBuilder.azureBlobSasConfiguration(
                azureBlobSasConfiguration.let(AzureBlobSasConfigurationProperty::unwrap)
            )
        }
    ...
    public interface AzureBlobSasConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param azureBlobSasToken Specifies a SAS token that provides permissions to access
             *   your Azure Blob Storage. The token is part of the SAS URI string that comes after
             *   the storage resource URI and a question mark. A token looks something like this:
             *
             * `sp=r&amp;st=2023-12-20T14:54:52Z&amp;se=2023-12-20T22:54:52Z&amp;spr=https&amp;sv=2021-06-08&amp;sr=c&amp;sig=aBBKDWQvyuVcTPH9EBp%2FXTI9E%2F%2Fmq171%2BZU178wcwqU%3D`
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AzureBlobSasConfigurationProperty
            ): software.amazon.awscdk.services.datasync.CfnLocationAzureBlob.AzureBlobSasConfigurationProperty =
