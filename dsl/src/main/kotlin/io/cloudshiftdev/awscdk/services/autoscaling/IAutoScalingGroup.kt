...
public interface IAutoScalingGroup : IResource, IGrantable {
     ...
     * @param props
     */
    public fun scaleOnCpuUtilization(
        id: String,
     ...
     * @param props
     */
    public fun scaleOnIncomingBytes(
        id: String,
     ...
     * @param props
     */
    public fun scaleOnOutgoingBytes(
        id: String,
        props: NetworkUtilizationScalingProps
    ): TargetTrackingScalingPolicy
    ...
    internal constructor(
         ...
         * @param props
         */
        override fun scaleOnCpuUtilization(
            id: String,
            props: CpuUtilizationScalingProps
        ): TargetTrackingScalingPolicy =
            unwrap(this)
         ...
         * @param props
         */
        override fun scaleOnIncomingBytes(
            id: String,
            props: NetworkUtilizationScalingProps
        ): TargetTrackingScalingPolicy =
            unwrap(this)
         ...
         * @param props
         */
        override fun scaleOnOutgoingBytes(
            id: String,
            props: NetworkUtilizationScalingProps
        ): TargetTrackingScalingPolicy =
            unwrap(this)
         ...
         * @param props
         */
        override fun scaleToTrackMetric(
            id: String,
            props: MetricTargetTrackingProps
        ): TargetTrackingScalingPolicy =
            unwrap(this)
