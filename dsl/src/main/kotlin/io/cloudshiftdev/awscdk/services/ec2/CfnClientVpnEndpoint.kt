...
internal constructor(
    ...
    public open fun clientConnectOptions(
        `value`: ClientConnectOptionsProperty.Builder.() -> Unit
    ...
    public open fun clientLoginBannerOptions(`value`: ClientLoginBannerOptionsProperty) {
        unwrap(this)
            .setClientLoginBannerOptions(`value`.let(ClientLoginBannerOptionsProperty::unwrap))
    }
    ...
    public open fun clientLoginBannerOptions(
        `value`: ClientLoginBannerOptionsProperty.Builder.() -> Unit
    ...
    public open fun connectionLogOptions(
        `value`: ConnectionLogOptionsProperty.Builder.() -> Unit
    ...
    public interface Builder {
         ...
         * changed after the Client VPN endpoint has been created. Client CIDR range must have a
         * size of at least /22 and must not be greater than /12.
         *
         ...
         *
         * @param clientCidrBlock The IPv4 address range, in CIDR notation, from which to assign
         *   client IP addresses.
         */
         ...
         *
         * @param clientConnectOptions The options for managing connection authorization for new
         *   client connections.
         */
        ...
        public fun clientConnectOptions(
            clientConnectOptions: ClientConnectOptionsProperty.Builder.() -> Unit
        )
         ...
         *
         * @param clientLoginBannerOptions Options for enabling a customizable text banner that will
         *   be displayed on AWS provided clients when a VPN session is established.
         */
        ...
        public fun clientLoginBannerOptions(
            clientLoginBannerOptions: ClientLoginBannerOptionsProperty.Builder.() -> Unit
        )
        ...
        public fun connectionLogOptions(
            connectionLogOptions: ConnectionLogOptionsProperty.Builder.() -> Unit
        )
         ...
         * Information about the DNS servers to be used for DNS resolution.
         *
         * A Client VPN endpoint can have up to two DNS servers. If no DNS server is specified, the
         * DNS address configured on the device is used for the DNS server.
         *
         ...
         *
         * @param selfServicePortal Specify whether to enable the self-service portal for the Client
         *   VPN endpoint.
         */
         ...
         * The ID of the VPC to associate with the Client VPN endpoint.
         *
         * If no security group IDs are specified in the request, the default security group for the
         * VPC is applied.
         *
    ...
    private class BuilderImpl(
        ...
        override fun clientConnectOptions(clientConnectOptions: ClientConnectOptionsProperty) {
            cdkBuilder.clientConnectOptions(
                clientConnectOptions.let(ClientConnectOptionsProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("ecfde4af8328f55323d65ff362c60188b5d32150fa7bbfd0f4905659fd43abef")
        override fun clientConnectOptions(
            clientConnectOptions: ClientConnectOptionsProperty.Builder.() -> Unit
         ...
         *   be displayed on AWS provided clients when a VPN session is established.
         */
        override fun clientLoginBannerOptions(
            clientLoginBannerOptions: ClientLoginBannerOptionsProperty
        ) {
            cdkBuilder.clientLoginBannerOptions(
                clientLoginBannerOptions.let(ClientLoginBannerOptionsProperty::unwrap)
            )
        }
        ...
        override fun clientLoginBannerOptions(
            ...
            clientLoginBannerOptions(ClientLoginBannerOptionsProperty(clientLoginBannerOptions))
        ...
        override fun connectionLogOptions(connectionLogOptions: ConnectionLogOptionsProperty) {
            cdkBuilder.connectionLogOptions(
                connectionLogOptions.let(ConnectionLogOptionsProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("7982c3c0c85a9d1ddd3761028b13917e59c123fedc5465ce42490e50a08f2661")
        override fun connectionLogOptions(
            connectionLogOptions: ConnectionLogOptionsProperty.Builder.() -> Unit
    ...
    public interface DirectoryServiceAuthenticationRequestProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DirectoryServiceAuthenticationRequestProperty
            ): software.amazon.awscdk.services.ec2.CfnClientVpnEndpoint.DirectoryServiceAuthenticationRequestProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ClientAuthenticationRequestProperty {
        ...
        public interface Builder {
            /**
             * @param activeDirectory Information about the Active Directory to be used, if
            ...
            public fun activeDirectory(
                activeDirectory: DirectoryServiceAuthenticationRequestProperty.Builder.() -> Unit
            )
            ...
            public fun federatedAuthentication(
                federatedAuthentication: FederatedAuthenticationRequestProperty.Builder.() -> Unit
            )

            /**
             * @param mutualAuthentication Information about the authentication certificates to be
             *   used, if applicable. You must provide this information if *Type* is
            ...
            public fun mutualAuthentication(
                mutualAuthentication: CertificateAuthenticationRequestProperty.Builder.() -> Unit
            )
        ...
        private class BuilderImpl : Builder {
             ...
             *   `directory-service-authentication` .
             */
            override fun activeDirectory(
                activeDirectory: DirectoryServiceAuthenticationRequestProperty
            ) {
                cdkBuilder.activeDirectory(
                    activeDirectory.let(DirectoryServiceAuthenticationRequestProperty::unwrap)
                )
            }
            ...
            override fun activeDirectory(
                ...
                activeDirectory(DirectoryServiceAuthenticationRequestProperty(activeDirectory))
             ...
             *   applicable.
             */
            override fun federatedAuthentication(
                federatedAuthentication: FederatedAuthenticationRequestProperty
            ) {
                cdkBuilder.federatedAuthentication(
                    federatedAuthentication.let(FederatedAuthenticationRequestProperty::unwrap)
                )
            }
            ...
            override fun federatedAuthentication(
                ...
                federatedAuthentication(
                    FederatedAuthenticationRequestProperty(federatedAuthentication)
                )
            ...
            override fun mutualAuthentication(
                ...
                cdkBuilder.mutualAuthentication(
                    mutualAuthentication.let(CertificateAuthenticationRequestProperty::unwrap)
                )
            }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ClientAuthenticationRequestProperty
            ): software.amazon.awscdk.services.ec2.CfnClientVpnEndpoint.ClientAuthenticationRequestProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ClientLoginBannerOptionsProperty {
        ...
        /**
         * Enable or disable a customizable text banner that will be displayed on AWS provided
         * clients when a VPN session is established.
         *
        ...
        public interface Builder {
            /**
             * @param bannerText Customizable text that will be displayed in a banner on AWS
             *   provided clients when a VPN session is established. UTF-8 encoded characters only.
             *   Maximum of 1400 characters.
             */
            public fun bannerText(bannerText: String)

            /**
             * @param enabled Enable or disable a customizable text banner that will be displayed on
             *   AWS provided clients when a VPN session is established. Valid values: `true |
             *   false`
             *
             * Default value: `false`
             */
        ...
        internal constructor(
            ...
            /**
             * Customizable text that will be displayed in a banner on AWS provided clients when a
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ClientLoginBannerOptionsProperty
            ): software.amazon.awscdk.services.ec2.CfnClientVpnEndpoint.ClientLoginBannerOptionsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ConnectionLogOptionsProperty {
        ...
        public interface Builder {
            /**
             * @param cloudwatchLogGroup The name of the CloudWatch Logs log group. Required if
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ConnectionLogOptionsProperty
            ): software.amazon.awscdk.services.ec2.CfnClientVpnEndpoint.ConnectionLogOptionsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface FederatedAuthenticationRequestProperty {
         ...
         */
        public fun selfServiceSamlProviderArn(): String? =
        ...
        public interface Builder {
            /**
             * @param samlProviderArn The Amazon Resource Name (ARN) of the IAM SAML identity
             *   provider.
             */
            public fun samlProviderArn(samlProviderArn: String)

            /**
             * @param selfServiceSamlProviderArn The Amazon Resource Name (ARN) of the IAM SAML
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: FederatedAuthenticationRequestProperty
            ): software.amazon.awscdk.services.ec2.CfnClientVpnEndpoint.FederatedAuthenticationRequestProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CertificateAuthenticationRequestProperty {
        ...
        public interface Builder {
            /**
             * @param clientRootCertificateChainArn The ARN of the client certificate. The
             *   certificate must be signed by a certificate authority (CA) and it must be
        ...
        internal constructor(
             ...
             * The ARN of the client certificate.
             *
             * The certificate must be signed by a certificate authority (CA) and it must be
             * provisioned in AWS Certificate Manager (ACM).
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ec2-clientvpnendpoint-certificateauthenticationrequest.html#cfn-ec2-clientvpnendpoint-certificateauthenticationrequest-clientrootcertificatechainarn)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CertificateAuthenticationRequestProperty
            ): software.amazon.awscdk.services.ec2.CfnClientVpnEndpoint.CertificateAuthenticationRequestProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ClientConnectOptionsProperty {
        ...
        public interface Builder {
            /**
             * @param enabled Indicates whether client connect options are enabled. The default is
             *   `false` (not enabled).
             */
            public fun enabled(enabled: Boolean)
            ...
            /**
             * @param lambdaFunctionArn The Amazon Resource Name (ARN) of the AWS Lambda function
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ClientConnectOptionsProperty
            ): software.amazon.awscdk.services.ec2.CfnClientVpnEndpoint.ClientConnectOptionsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
