...
public interface AdvancedSecurityOptions {
    ...
    public interface Builder {
        ...
        /**
         * @param samlAuthenticationOptions Container for information about the SAML configuration
         *   for OpenSearch Dashboards. If set, `samlAuthenticationEnabled` will be enabled.
         */
        ...
        public fun samlAuthenticationOptions(
            samlAuthenticationOptions: SAMLOptionsProperty.Builder.() -> Unit
        )
    }
    ...
    private class BuilderImpl : Builder {
        ...
        override fun samlAuthenticationOptions(samlAuthenticationOptions: SAMLOptionsProperty) {
            cdkBuilder.samlAuthenticationOptions(
                samlAuthenticationOptions.let(SAMLOptionsProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("95d35bcd5990b82875687519147a3dda825cd7a271485f83779d92ad8484332d")
        override fun samlAuthenticationOptions(
            samlAuthenticationOptions: SAMLOptionsProperty.Builder.() -> Unit
    ...
    internal constructor(
         ...
         * True to enable SAML authentication for a domain.
         *
         * Default: - SAML authentication is disabled. Enabled if `samlAuthenticationOptions` is
         * set.
         *
         * [Documentation](https://docs.aws.amazon.com/opensearch-service/latest/developerguide/saml.html)
         */
        override fun samlAuthenticationEnabled(): Boolean? =
