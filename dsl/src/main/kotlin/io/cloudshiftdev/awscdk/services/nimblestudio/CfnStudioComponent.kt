...
internal constructor(
    ...
    public open fun configuration(
        `value`: StudioComponentConfigurationProperty.Builder.() -> Unit
    ...
    public open fun ec2SecurityGroupIds(): List<String> =
        unwrap(this).getEc2SecurityGroupIds() ?: emptyList()
    ...
    public interface Builder {
        ...
        public fun configuration(
            configuration: StudioComponentConfigurationProperty.Builder.() -> Unit
        )
        ...
        /**
         * An IAM role attached to Studio Component when the system initialization script runs which
         * give the studio component access to AWS resources when the system initialization script
         * runs.
         *
         ...
         *
         * @param secureInitializationRoleArn An IAM role attached to Studio Component when the
         *   system initialization script runs which give the studio component access to AWS
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.nimblestudio.CfnStudioComponent.Builder.create(
                scope,
                id
            )
        ...
        override fun configuration(configuration: StudioComponentConfigurationProperty) {
            cdkBuilder.configuration(
                configuration.let(StudioComponentConfigurationProperty::unwrap)
            )
        }
    ...
    public interface SharedFileSystemConfigurationProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param windowsMountDrive The mount location for a shared file system on a Windows
             *   virtual workstation.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SharedFileSystemConfigurationProperty
            ): software.amazon.awscdk.services.nimblestudio.CfnStudioComponent.SharedFileSystemConfigurationProperty =
    ...
    public interface ScriptParameterKeyValueProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ScriptParameterKeyValueProperty
            ): software.amazon.awscdk.services.nimblestudio.CfnStudioComponent.ScriptParameterKeyValueProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ComputeFarmConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param activeDirectoryUser The name of an Active Directory user that is used on
             *   ComputeFarm worker instances.
             */
            public fun activeDirectoryUser(activeDirectoryUser: String)

            /**
             * @param endpoint The endpoint of the ComputeFarm that is accessed by the studio
             *   component resource.
             */
            public fun endpoint(endpoint: String)
        }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ComputeFarmConfigurationProperty
            ): software.amazon.awscdk.services.nimblestudio.CfnStudioComponent.ComputeFarmConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface StudioComponentInitializationScriptProperty {
        ...
        public interface Builder {
            /**
             * @param launchProfileProtocolVersion The version number of the protocol that is used
             *   by the launch profile. The only valid version is "2021-03-31".
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: StudioComponentInitializationScriptProperty
            ): software.amazon.awscdk.services.nimblestudio.CfnStudioComponent.StudioComponentInitializationScriptProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ActiveDirectoryConfigurationProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param organizationalUnitDistinguishedName The distinguished name (DN) and
             *   organizational unit (OU) of an Active Directory computer.
             */
        ...
        internal constructor(
            ...
            /**
             * The directory ID of the AWS Directory Service for Microsoft Active Directory to
    ...
    public interface LicenseServiceConfigurationProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: LicenseServiceConfigurationProperty
            ): software.amazon.awscdk.services.nimblestudio.CfnStudioComponent.LicenseServiceConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface StudioComponentConfigurationProperty {
         ...
         */
        public fun activeDirectoryConfiguration(): Any? =
         ...
         */
        public fun licenseServiceConfiguration(): Any? =
        ...
        public interface Builder {
            ...
            public fun activeDirectoryConfiguration(
                activeDirectoryConfiguration:
                    ActiveDirectoryConfigurationProperty.Builder.() -> Unit
            )

            /**
             * @param computeFarmConfiguration The configuration for a render farm that is
            ...
            public fun computeFarmConfiguration(
                computeFarmConfiguration: ComputeFarmConfigurationProperty.Builder.() -> Unit
            )
            ...
            public fun licenseServiceConfiguration(
                licenseServiceConfiguration: LicenseServiceConfigurationProperty.Builder.() -> Unit
            )

            /**
             * @param sharedFileSystemConfiguration The configuration for a shared file storage
             *   system that is associated with a studio resource.
             */
            ...
            public fun sharedFileSystemConfiguration(
                sharedFileSystemConfiguration:
                    SharedFileSystemConfigurationProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun computeFarmConfiguration(computeFarmConfiguration: IResolvable) {
                cdkBuilder.computeFarmConfiguration(
                    computeFarmConfiguration.let(IResolvable::unwrap)
                )
            }
             ...
             *   associated with a studio resource.
             */
            override fun computeFarmConfiguration(
                computeFarmConfiguration: ComputeFarmConfigurationProperty
            ) {
                cdkBuilder.computeFarmConfiguration(
                    computeFarmConfiguration.let(ComputeFarmConfigurationProperty::unwrap)
                )
            }
            ...
            override fun licenseServiceConfiguration(licenseServiceConfiguration: IResolvable) {
                cdkBuilder.licenseServiceConfiguration(
                    licenseServiceConfiguration.let(IResolvable::unwrap)
                )
            }
             ...
             *   associated with a studio resource.
             */
            override fun licenseServiceConfiguration(
                licenseServiceConfiguration: LicenseServiceConfigurationProperty
            ) {
                cdkBuilder.licenseServiceConfiguration(
                    licenseServiceConfiguration.let(LicenseServiceConfigurationProperty::unwrap)
                )
            }
            ...
            override fun licenseServiceConfiguration(
                ...
                licenseServiceConfiguration(
                    LicenseServiceConfigurationProperty(licenseServiceConfiguration)
                )
            ...
            override fun sharedFileSystemConfiguration(sharedFileSystemConfiguration: IResolvable) {
                cdkBuilder.sharedFileSystemConfiguration(
                    sharedFileSystemConfiguration.let(IResolvable::unwrap)
                )
            }
             ...
             *   system that is associated with a studio resource.
             */
            override fun sharedFileSystemConfiguration(
                sharedFileSystemConfiguration: SharedFileSystemConfigurationProperty
            ) {
                cdkBuilder.sharedFileSystemConfiguration(
                    sharedFileSystemConfiguration.let(SharedFileSystemConfigurationProperty::unwrap)
                )
            }
            ...
            override fun sharedFileSystemConfiguration(
                ...
                sharedFileSystemConfiguration(
                    SharedFileSystemConfigurationProperty(sharedFileSystemConfiguration)
                )
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-nimblestudio-studiocomponent-studiocomponentconfiguration.html#cfn-nimblestudio-studiocomponent-studiocomponentconfiguration-computefarmconfiguration)
             */
            override fun computeFarmConfiguration(): Any? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: StudioComponentConfigurationProperty
            ): software.amazon.awscdk.services.nimblestudio.CfnStudioComponent.StudioComponentConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ActiveDirectoryComputerAttributeProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ActiveDirectoryComputerAttributeProperty
            ): software.amazon.awscdk.services.nimblestudio.CfnStudioComponent.ActiveDirectoryComputerAttributeProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
