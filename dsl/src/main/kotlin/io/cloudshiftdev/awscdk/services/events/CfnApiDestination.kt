...
internal constructor(
    ...
    public interface Builder {
         ...
         * The ARN of the connection to use for the API destination.
         *
         * The destination endpoint must support the authorization type specified for the
         * connection.
         *
         ...
         *
         * @param invocationEndpoint The URL to the HTTP invocation endpoint for the API
         *   destination.
         */
         ...
         *
         * @param invocationRateLimitPerSecond The maximum number of requests per second to send to
