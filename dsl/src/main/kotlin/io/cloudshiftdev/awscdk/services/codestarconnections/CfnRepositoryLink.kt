...
internal constructor(
     ...
     * [io.cloudshiftdev.awscdk.services.codestarconnections.CfnRepositoryLink].
     */
    @CdkDslMarker
    public interface Builder {
         ...
         *
         * @param ownerId The owner ID for the repository associated with the repository link, such
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.codestarconnections.CfnRepositoryLink.Builder.create(
                scope,
                id
            )
