...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.iam.CfnServiceLinkedRole,
    ...
    public interface Builder {
         ...
         *
         * @param customSuffix A string that you provide, which is combined with the
         *   service-provided prefix to form the complete role name.
         */
