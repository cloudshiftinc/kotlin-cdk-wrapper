...
internal constructor(
     ...
     * results.
     */
    public open fun defaultResultConfiguration(): Any? =
        unwrap(this).getDefaultResultConfiguration()
     ...
     * results.
     */
    public open fun defaultResultConfiguration(
        `value`: MembershipProtectedQueryResultConfigurationProperty
    ) {
        unwrap(this)
            .setDefaultResultConfiguration(
                `value`.let(MembershipProtectedQueryResultConfigurationProperty::unwrap)
            )
    }
    ...
    public open fun defaultResultConfiguration(
        `value`: MembershipProtectedQueryResultConfigurationProperty.Builder.() -> Unit
    ): Unit =
    ...
    public open fun paymentConfiguration(`value`: MembershipPaymentConfigurationProperty) {
        unwrap(this)
            .setPaymentConfiguration(`value`.let(MembershipPaymentConfigurationProperty::unwrap))
    }

    /** The payment responsibilities accepted by the collaboration member. */
    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("a31f3ad321ba01ad951334da843b4763ff03d4bcb24dd2eaabd60b8699eb7f3a")
    public open fun paymentConfiguration(
        `value`: MembershipPaymentConfigurationProperty.Builder.() -> Unit
    ...
    public interface Builder {
        ...
        public fun defaultResultConfiguration(
            defaultResultConfiguration:
                MembershipProtectedQueryResultConfigurationProperty.Builder.() -> Unit
        )
        ...
        public fun paymentConfiguration(
            paymentConfiguration: MembershipPaymentConfigurationProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
        ...
        override fun defaultResultConfiguration(defaultResultConfiguration: IResolvable) {
            cdkBuilder.defaultResultConfiguration(
                defaultResultConfiguration.let(IResolvable::unwrap)
            )
        }
         ...
         *   specified by the member who can receive results.
         */
        override fun defaultResultConfiguration(
            defaultResultConfiguration: MembershipProtectedQueryResultConfigurationProperty
        ) {
            cdkBuilder.defaultResultConfiguration(
                defaultResultConfiguration.let(
                    MembershipProtectedQueryResultConfigurationProperty::unwrap
                )
            )
        }
        ...
        override fun defaultResultConfiguration(
            ...
            defaultResultConfiguration(
                MembershipProtectedQueryResultConfigurationProperty(defaultResultConfiguration)
            )
        ...
        override fun paymentConfiguration(
            ...
            cdkBuilder.paymentConfiguration(
                paymentConfiguration.let(MembershipPaymentConfigurationProperty::unwrap)
            )
        }
    ...
    public interface MembershipPaymentConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param queryCompute The payment responsibilities accepted by the collaboration member
            ...
            public fun queryCompute(
                queryCompute: MembershipQueryComputePaymentConfigProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun queryCompute(queryCompute: MembershipQueryComputePaymentConfigProperty) {
                cdkBuilder.queryCompute(
                    queryCompute.let(MembershipQueryComputePaymentConfigProperty::unwrap)
                )
            }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: MembershipPaymentConfigurationProperty
            ): software.amazon.awscdk.services.cleanrooms.CfnMembership.MembershipPaymentConfigurationProperty =
    ...
    public interface ProtectedQueryS3OutputConfigurationProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ProtectedQueryS3OutputConfigurationProperty
            ): software.amazon.awscdk.services.cleanrooms.CfnMembership.ProtectedQueryS3OutputConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface MembershipQueryComputePaymentConfigProperty {
        ...
        public interface Builder {
            /**
             * @param isResponsible Indicates whether the collaboration member has accepted to pay
             *   for query compute costs ( `TRUE` ) or has not accepted to pay for query compute
             *   costs ( `FALSE` ).
             *
             * If the collaboration creator has not specified anyone to pay for query compute costs,
             * then the member who can query is the default payer.
             *
             * An error message is returned for the following reasons:
             * * If you set the value to `FALSE` but you are responsible to pay for query compute
             *   costs.
             * * If you set the value to `TRUE` but you are not responsible to pay for query compute
             *   costs.
             */
        ...
        internal constructor(
             ...
             * costs ( `TRUE` ) or has not accepted to pay for query compute costs ( `FALSE` ).
             *
             * If the collaboration creator has not specified anyone to pay for query compute costs,
             * then the member who can query is the default payer.
             *
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: MembershipQueryComputePaymentConfigProperty
            ): software.amazon.awscdk.services.cleanrooms.CfnMembership.MembershipQueryComputePaymentConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface MembershipProtectedQueryResultConfigurationProperty {
        ...
        public interface Builder {
            ...
            public fun outputConfiguration(
                outputConfiguration:
                    MembershipProtectedQueryOutputConfigurationProperty.Builder.() -> Unit
            )

            /**
             * @param roleArn The unique ARN for an IAM role that is used by AWS Clean Rooms to
             *   write protected query results to the result location, given by the member who can
             *   receive results.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            /** @param outputConfiguration Configuration for protected query results. */
            override fun outputConfiguration(
                outputConfiguration: MembershipProtectedQueryOutputConfigurationProperty
            ) {
                cdkBuilder.outputConfiguration(
                    outputConfiguration.let(
                        MembershipProtectedQueryOutputConfigurationProperty::unwrap
                    )
                )
            }
            ...
            override fun outputConfiguration(
                ...
                outputConfiguration(
                    MembershipProtectedQueryOutputConfigurationProperty(outputConfiguration)
                )
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: MembershipProtectedQueryResultConfigurationProperty
            ): software.amazon.awscdk.services.cleanrooms.CfnMembership.MembershipProtectedQueryResultConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface MembershipProtectedQueryOutputConfigurationProperty {
        ...
        private class BuilderImpl : Builder {
            ...
            @JvmName("b2597a2165549dafd127ba9eee175ac3ddd48f847c4150eae23d54c4edf57e86")
            override fun s3(
                s3: ProtectedQueryS3OutputConfigurationProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: MembershipProtectedQueryOutputConfigurationProperty
            ): software.amazon.awscdk.services.cleanrooms.CfnMembership.MembershipProtectedQueryOutputConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
