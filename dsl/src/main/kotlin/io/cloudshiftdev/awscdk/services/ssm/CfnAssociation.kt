...
internal constructor(
    ...
    public open fun outputLocation(`value`: InstanceAssociationOutputLocationProperty) {
        unwrap(this)
            .setOutputLocation(`value`.let(InstanceAssociationOutputLocationProperty::unwrap))
    }
    ...
    public open fun outputLocation(
        `value`: InstanceAssociationOutputLocationProperty.Builder.() -> Unit
    ...
    public interface Builder {
         ...
         *
         * @param applyOnlyAtCronInterval By default, when you create a new association, the system
         *   runs it immediately after it is created and then according to the schedule you
         *   specified.
         */
         ...
         * Choose the parameter that will define how your automation will branch out.
         *
         * This target is required for associations that use an Automation runbook and target
         * resources by using rate controls. Automation is a capability of AWS Systems Manager .
         *
         ...
         * associations are gated under.
         *
         * The associations only run when that Change Calendar is open. For more information, see
         ...
         *
         * @param calendarNames The names or Amazon Resource Names (ARNs) of the Change Calendar
         *   type documents your associations are gated under.
         */
         ...
         *   `default` version of a document if shared from another account, even though the Systems
         *   Manager console shows that a new version was processed. If you want to run an
         *   association using a new version of a document shared form another account, you must set
         *   the document version to `default` .
         * * `DocumentVersion` is not valid for documents owned by AWS , such as
         *   `AWS-RunPatchBaseline` or `AWS-UpdateSSMAgent` . If you specify `DocumentVersion` for
         *   an AWS document, the system returns the following error: "Error occurred during
         *   operation 'CreateAssociation'." (RequestToken: <token>, HandlerErrorCode:
         ...
         * `Targets` parameter. If you use the parameter `InstanceId` , you cannot use the
         * parameters `AssociationName` , `DocumentVersion` , `MaxErrors` , `MaxConcurrency` ,
         ...
         * The maximum number of targets allowed to run the association at the same time.
         *
         * You can specify a number, for example 10, or a percentage of the target set, for example
         * 10%. The default value is 100%, which means all targets run the association at the same
         * time.
         *
         ...
         * association on additional targets.
         *
         * You can specify either an absolute number of errors, for example 10, or a percentage of
         * the target set, for example 10%. If you specify 3, for example, the system stops sending
         * requests when the fourth error is received. If you specify 0, then the system stops
         * sending requests after the first error is returned. If you run an association on 50
         * managed nodes and set `MaxError` to 10%, then the system stops sending the request when
         ...
         *
         * @param name The name of the SSM document that contains the configuration information for
         *   the instance.
         */
         ...
         *
         * @param outputLocation An Amazon Simple Storage Service (Amazon S3) bucket where you want
        ...
        public fun outputLocation(
            outputLocation: InstanceAssociationOutputLocationProperty.Builder.() -> Unit
        )
         ...
         *
         * @param scheduleExpression A cron expression that specifies a schedule when the
         *   association runs.
         */
         ...
         *
         * @param scheduleOffset Number of days to wait after the scheduled day to run an
         *   association.
         */
         ...
         * runs successfully, then the association is `COMPLIANT` . If the association execution
         ...
         * Manager. It is managed by your direct call to the `PutComplianceItems` API action.
         *
         ...
         * The targets for the association.
         *
         * You must specify the `InstanceId` or `Targets` property. You can target all instances in
         * an AWS account by specifyingt he `InstanceIds` key with a value of `*` . To view a JSON
         * and a YAML example that targets all instances, see the "Create an association for all
         ...
         * "Success" before proceeding with the stack execution.
         *
         * If the association status doesn't show "Success" after the specified number of seconds,
         * then stack creation fails.
         *
         ...
         * for your AWS CloudFormation stack’s configuration might yield inaccurate results. If
         * drift detection is important in your scenario, we recommend that you don’t include
    ...
    private class BuilderImpl(
        ...
        override fun outputLocation(outputLocation: InstanceAssociationOutputLocationProperty) {
            cdkBuilder.outputLocation(
                outputLocation.let(InstanceAssociationOutputLocationProperty::unwrap)
            )
        }
    ...
    public companion object {
        ...
        ): CfnAssociation = CfnAssociation(cdkObject)

        internal fun unwrap(
            wrapped: CfnAssociation
        ): software.amazon.awscdk.services.ssm.CfnAssociation = wrapped.cdkObject
    }
    ...
    public interface TargetProperty {
         ...
         *
         * For example, if you specified `tag:ServerRole` , you could specify `value:WebServer` to
         * run a command on instances that include EC2 tags of `ServerRole,WebServer` .
         *
        ...
        public interface Builder {
            /**
             * @param key User-defined criteria for sending commands that target managed nodes that
             *   meet the criteria.
             */
            public fun key(key: String)

            /**
             * @param values User-defined criteria that maps to `Key` . For example, if you
             *   specified `tag:ServerRole` , you could specify `value:WebServer` to run a command
             *   on instances that include EC2 tags of `ServerRole,WebServer` .
             *
             * Depending on the type of target, the maximum number of values for a key might be
        ...
        internal constructor(
             ...
             * User-defined criteria that maps to `Key` .
             *
             * For example, if you specified `tag:ServerRole` , you could specify `value:WebServer`
    ...
    public interface S3OutputLocationProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: S3OutputLocationProperty
            ): software.amazon.awscdk.services.ssm.CfnAssociation.S3OutputLocationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface InstanceAssociationOutputLocationProperty {
        ...
        public interface Builder {
             ...
             *   [InstanceAssociationOutputLocation](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ssm-association-instanceassociationoutputlocation.html)
             *   property that specifies an Amazon S3 bucket where you want to store the results of
             *   this request.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: InstanceAssociationOutputLocationProperty
            ): software.amazon.awscdk.services.ssm.CfnAssociation.InstanceAssociationOutputLocationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
