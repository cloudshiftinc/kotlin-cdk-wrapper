...
internal constructor(
    ...
    public open fun targetRepository(
        `value`: TargetContainerRepositoryProperty.Builder.() -> Unit
    ...
    public interface Builder {
        ...
        /**
         * Dockerfiles are text documents that are used to build Docker containers, and ensure that
         * they contain all of the elements required by the application running inside.
         *
         ...
         *
         * @param dockerfileTemplateData Dockerfiles are text documents that are used to build
         *   Docker containers, and ensure that they contain all of the elements required by the
         ...
         *
         * @param dockerfileTemplateUri The S3 URI for the Dockerfile that will be used to build
         ...
         *
         * @param instanceConfiguration A group of options that can be used to configure an instance
         ...
         *
         * @param platformOverride Specifies the operating system platform when you use a custom
         *   base image.
         */
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.imagebuilder.CfnContainerRecipe.Builder.create(
                scope,
                id
            )
    ...
    public interface EbsInstanceBlockDeviceSpecificationProperty {
        ...
        public interface Builder {
            /**
             * @param deleteOnTermination Use to configure delete on termination of the associated
             *   device.
             */
    ...
    public interface InstanceConfigurationProperty {
         ...
         *
         * If not specified, Image Builder will use the appropriate ECS-optimized AMI as a base
         * image.
         *
        ...
        public interface Builder {
            /**
             * @param blockDeviceMappings Defines the block devices to attach for building an
            ...
            /**
             * @param image The AMI ID to use as the base image for a container build and test
             *   instance. If not specified, Image Builder will use the appropriate ECS-optimized
             *   AMI as a base image.
             */
