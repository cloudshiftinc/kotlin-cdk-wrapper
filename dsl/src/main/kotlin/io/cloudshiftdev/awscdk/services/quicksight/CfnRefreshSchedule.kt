...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param awsAccountId The AWS account ID of the account that you are creating a schedule
         *   in.
         */
    ...
    public interface ScheduleFrequencyProperty {
        ...
        public interface Builder {
            /**
             * @param interval The interval between scheduled refreshes. Valid values are as
             *   follows:.
             ...
             *   dataset.
             * * `MINUTE30` : The dataset refreshes every 30 minutes. This value is only supported
             *   for incremental refreshes. This interval can only be used for one schedule per
             *   dataset.
             * * `HOURLY` : The dataset refreshes every hour. This interval can only be used for one
             *   schedule per dataset.
            ...
            /**
             * @param timeOfTheDay The time of day that you want the dataset to refresh. This value
             *   is expressed in HH:MM format. This field is not required for schedules that refresh
             *   hourly.
             */
            public fun timeOfTheDay(timeOfTheDay: String)

            /**
             * @param timeZone The timezone that you want the refresh schedule to use. The timezone
             *   ID must match a corresponding ID found on `java.util.time.getAvailableIDs()` .
             */
        ...
        internal constructor(
             ...
             * The time of day that you want the dataset to refresh.
             *
             * This value is expressed in HH:MM format. This field is not required for schedules
             * that refresh hourly.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-quicksight-refreshschedule-schedulefrequency.html#cfn-quicksight-refreshschedule-schedulefrequency-timeoftheday)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ScheduleFrequencyProperty
            ): software.amazon.awscdk.services.quicksight.CfnRefreshSchedule.ScheduleFrequencyProperty =
    ...
    public interface RefreshOnDayProperty {
        ...
        public interface Builder {
            /**
             * @param dayOfMonth The day of the month that you want your dataset to refresh. This
             *   value is required for monthly refresh intervals.
             */
            public fun dayOfMonth(dayOfMonth: String)

            /**
             * @param dayOfWeek The day of the week that you want to schedule the refresh on. This
    ...
    public interface RefreshScheduleMapProperty {
        ...
        public interface Builder {
             ...
             *   follows:.
             * * `FULL_REFRESH` : A complete refresh of a dataset.
             * * `INCREMENTAL_REFRESH` : A partial refresh of some rows of a dataset, based on the
            ...
            public fun scheduleFrequency(
                scheduleFrequency: ScheduleFrequencyProperty.Builder.() -> Unit
            )
            ...
            /**
             * @param startAfterDateTime Time after which the refresh schedule can be started,
        ...
        private class BuilderImpl : Builder {
            ...
            override fun scheduleFrequency(scheduleFrequency: ScheduleFrequencyProperty) {
                cdkBuilder.scheduleFrequency(
                    scheduleFrequency.let(ScheduleFrequencyProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("bd298fed8f8ced1e9e3f632ed02bbb645481d7e8f484bb4a92d79efaf1a1e651")
            override fun scheduleFrequency(
                scheduleFrequency: ScheduleFrequencyProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RefreshScheduleMapProperty
            ): software.amazon.awscdk.services.quicksight.CfnRefreshSchedule.RefreshScheduleMapProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
