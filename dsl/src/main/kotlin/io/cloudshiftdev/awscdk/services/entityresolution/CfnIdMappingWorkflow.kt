...
internal constructor(
    ...
    public open fun idMappingTechniques(
        `value`: IdMappingTechniquesProperty.Builder.() -> Unit
    ): Unit = idMappingTechniques(IdMappingTechniquesProperty(`value`))
     ...
     * [io.cloudshiftdev.awscdk.services.entityresolution.CfnIdMappingWorkflow].
     */
    @CdkDslMarker
    public interface Builder {
        ...
        public fun idMappingTechniques(
            idMappingTechniques: IdMappingTechniquesProperty.Builder.() -> Unit
        )
         ...
         *
         * @param outputSourceConfig A list of `IdMappingWorkflowOutputSource` objects, each of
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.entityresolution.CfnIdMappingWorkflow.Builder.create(
                scope,
                id
            )
        ...
        override fun idMappingTechniques(idMappingTechniques: IdMappingTechniquesProperty) {
            cdkBuilder.idMappingTechniques(
                idMappingTechniques.let(IdMappingTechniquesProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("adf133ccc4d3eb2dd97e1dc0865da29cc2840795e113f053f00da756e475a701")
        override fun idMappingTechniques(
            idMappingTechniques: IdMappingTechniquesProperty.Builder.() -> Unit
    ...
    public interface IdMappingWorkflowOutputSourceProperty {
        ...
        public interface Builder {
            /**
             * @param kmsArn Customer AWS KMS ARN for encryption at rest. If not provided, system
             *   will use an AWS Entity Resolution managed KMS key.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: IdMappingWorkflowOutputSourceProperty
            ): software.amazon.awscdk.services.entityresolution.CfnIdMappingWorkflow.IdMappingWorkflowOutputSourceProperty =
    ...
    public interface IdMappingTechniquesProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param providerProperties An object which defines any additional configurations
             *   required by the provider service.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: IdMappingTechniquesProperty
            ): software.amazon.awscdk.services.entityresolution.CfnIdMappingWorkflow.IdMappingTechniquesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface IdMappingWorkflowInputSourceProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param schemaArn The ARN (Amazon Resource Name) that AWS Entity Resolution generated
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: IdMappingWorkflowInputSourceProperty
            ): software.amazon.awscdk.services.entityresolution.CfnIdMappingWorkflow.IdMappingWorkflowInputSourceProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
