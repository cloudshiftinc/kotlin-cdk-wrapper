...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param roleArn The Amazon Resource Name (ARN) of the role that is used for target
         *   invocation.
         */
         ...
         *   for AWS management events delivered through CloudTrail.
         ...
         * a Kinesis data stream, you can optionally specify which shard the event goes to by using
         * the `KinesisParameters` argument. To invoke a command on multiple EC2 instances with one
         * rule, you can use the `RunCommandParameters` field.
         *
         ...
         * * For EC2 instances, Kinesis Data Streams, AWS Step Functions state machines and API
         *   Gateway APIs, EventBridge relies on IAM roles that you specify in the `RoleARN`
         ...
         * account sends events to another account, your account is charged for each sent event.
         * Each event sent to another account is charged as a custom event. The account receiving
         * the event is not charged. For more information, see
         ...
         * account ID, then you must specify a `RoleArn` with proper permissions in the `Target`
         ...
         * in the *Amazon EventBridge User Guide* .
         *
         * If you have an IAM role on a cross-account event bus target, a `PutTargets` call without
         * a role on the same target (same `Id` and `Arn` ) will not remove the role.
         *
         ...
         *
         * @param targets Adds the specified targets to the specified rule, or updates the targets
    ...
    public interface TagProperty {
        ...
        public interface Builder {
            /**
             * @param key A string you can use to assign a value. The combination of tag keys and
    ...
    public interface RedshiftDataParametersProperty {
         ...
         * completes. If any SQL statement fails, then because they are run as one transaction, all
         * work is rolled back.
         *
        ...
        public interface Builder {
             ...
             *   database. Required when authenticating using AWS Secrets Manager.
             */
             ...
             *   don't start until the previous statement in the array completes. If any SQL
             *   statement fails, then because they are run as one transaction, all work is rolled
             *   back.
             */
        ...
        internal constructor(
             ...
             * One or more SQL statements to run.
             *
             * The SQL statements are run as a single transaction. They run serially in the order of
             * the array. Subsequent SQL statements don't start until the previous statement in the
             * array completes. If any SQL statement fails, then because they are run as one
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RedshiftDataParametersProperty
            ): software.amazon.awscdk.services.events.CfnRule.RedshiftDataParametersProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface RetryPolicyProperty {
        ...
        public interface Builder {
            /**
             * @param maximumEventAgeInSeconds The maximum amount of time, in seconds, to continue
             *   to make retry attempts.
             */
            public fun maximumEventAgeInSeconds(maximumEventAgeInSeconds: Number)

            /**
             * @param maximumRetryAttempts The maximum number of retry attempts to make before the
             *   request fails. Retry attempts continue until either the maximum number of attempts
             *   is made or until the duration of the `MaximumEventAgeInSeconds` is met.
             */
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-events-rule-retrypolicy.html#cfn-events-rule-retrypolicy-maximumeventageinseconds)
             */
            override fun maximumEventAgeInSeconds(): Number? =
                unwrap(this).getMaximumEventAgeInSeconds()

            /**
             * The maximum number of retry attempts to make before the request fails.
             *
             * Retry attempts continue until either the maximum number of attempts is made or until
    ...
    public interface InputTransformerProperty {
         ...
         *
         * You can then insert these in the template in `InputTemplate` to produce the output you
        ...
        public interface Builder {
            /**
             * @param inputPathsMap Map of JSON paths to be extracted from the event. You can then
             *   insert these in the template in `InputTemplate` to produce the output you want to
             *   be sent to the target.
             *
             * `InputPathsMap` is an array key-value pairs, where each value is a valid JSON path.
             * You can have as many as 100 key-value pairs. You must use JSON dot notation, not
             * bracket notation.
             *
             * The keys cannot start with " AWS ."
             */
            ...
            /**
             * @param inputTemplate Input template where you specify placeholders that will be
             *   filled with the values of the keys from `InputPathsMap` to customize the data sent
             *   to the target. Enclose each `InputPathsMaps` value in brackets: &lt; *value* &gt;
             *
             * If `InputTemplate` is a JSON object (surrounded by curly braces), the following
             * restrictions apply:
             * * The placeholder cannot be used as an object key.
        ...
        internal constructor(
             ...
             * Map of JSON paths to be extracted from the event.
             *
             * You can then insert these in the template in `InputTemplate` to produce the output
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: InputTransformerProperty
            ): software.amazon.awscdk.services.events.CfnRule.InputTransformerProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface RunCommandTargetProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param values If `Key` is `tag:` *tag-key* , `Values` is a list of tag values. If
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RunCommandTargetProperty
            ): software.amazon.awscdk.services.events.CfnRule.RunCommandTargetProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface KinesisParametersProperty {
        ...
        public interface Builder {
             ...
             *   partition key. For more information, see
             *   [Amazon Kinesis Streams Key Concepts](https://docs.aws.amazon.com/streams/latest/dev/key-concepts.html#partition-key)
             *   in the *Amazon Kinesis Streams Developer Guide* .
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: KinesisParametersProperty
            ): software.amazon.awscdk.services.events.CfnRule.KinesisParametersProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface EcsParametersProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param group Specifies an ECS task group for the task. The maximum length is 255
             *   characters.
             */
            ...
            /**
             * @param placementStrategies The placement strategy objects to use for the task. You
            ...
            /**
             * @param tagList The metadata that you apply to the task to help you categorize and
    ...
    public interface BatchParametersProperty {
         ...
         * are 1–10. When you specify a retry strategy here, it overrides the retry strategy defined
        ...
        public interface Builder {
            ...
            /**
             * @param jobDefinition The ARN or name of the job definition to use if the event target
             *   is an AWS Batch job. This job definition must already exist.
             */
            public fun jobDefinition(jobDefinition: String)

            /**
             * @param jobName The name to use for this execution of the job, if the target is an AWS
             *   Batch job.
             */
            public fun jobName(jobName: String)

            /**
             * @param retryStrategy The retry strategy to use for failed jobs, if the target is an
             *   AWS Batch job. The retry strategy is the number of times to retry the failed job
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: BatchParametersProperty
            ): software.amazon.awscdk.services.events.CfnRule.BatchParametersProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface BatchRetryStrategyProperty {
        ...
        public interface Builder {
            /**
             * @param attempts The number of times to attempt to retry, if the job fails. Valid
             *   values are 1–10.
             */
    ...
    public interface DeadLetterConfigProperty {
        ...
        public interface Builder {
            /**
             * @param arn The ARN of the SQS queue specified as the target for the dead-letter
             *   queue.
             */
    ...
    public interface SageMakerPipelineParametersProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SageMakerPipelineParametersProperty
            ): software.amazon.awscdk.services.events.CfnRule.SageMakerPipelineParametersProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface AppSyncParametersProperty {
        ...
        public interface Builder {
             ...
             *   subscription to be parsed and executed by the GraphQL service. For more
             *   information, see
             *   [Operations](https://docs.aws.amazon.com/appsync/latest/devguide/graphql-architecture.html#graphql-operations)
             *   in the *AWS AppSync User Guide* .
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AppSyncParametersProperty
            ): software.amazon.awscdk.services.events.CfnRule.AppSyncParametersProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface TargetProperty {
         ...
         *
         * For more information, see
         * [Jobs](https://docs.aws.amazon.com/batch/latest/userguide/jobs.html) in the *AWS Batch
         * User Guide* .
         *
         ...
         * Kinesis data stream.
         *
         * If you do not include this parameter, the default is to use the `eventId` as the
         * partition key.
         *
        ...
        public interface Builder {
            /**
             * @param appSyncParameters Contains the GraphQL operation to be parsed and executed, if
             *   the event target is an AWS AppSync API.
             */
            ...
            public fun appSyncParameters(
                appSyncParameters: AppSyncParametersProperty.Builder.() -> Unit
            )
             ...
             *   [Jobs](https://docs.aws.amazon.com/batch/latest/userguide/jobs.html) in the *AWS
             *   Batch User Guide* .
             */
            ...
            /**
             * @param ecsParameters Contains the Amazon ECS task definition and task count to be
             *   used, if the event target is an Amazon ECS task. For more information about Amazon
             *   ECS tasks, see
             *   [Task Definitions](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/task_defintions.html)
             *   in the *Amazon EC2 Container Service Developer Guide* .
             */
             ...
             *   Gateway endpoint or EventBridge ApiDestination. If you specify an API Gateway API
             ...
             *   invoking request. If you're using ApiDestinations, the corresponding Connection can
             *   also have these values configured. In case of any conflicting keys, values from the
            ...
            /**
             * @param id The ID of the target within the specified rule. Use this ID to reference
            ...
            /**
             * @param input Valid JSON text passed to the target. In this case, nothing from the
            ...
            /**
             * @param inputPath The value of the JSONPath that is used for extracting part of the
             *   matched event when passing it to the target. You may use JSON dot notation or
            ...
            /**
             * @param inputTransformer Settings to enable you to provide custom input to a target
             *   based on certain event data. You can extract one or more key-value pairs from the
            ...
            public fun inputTransformer(
                inputTransformer: InputTransformerProperty.Builder.() -> Unit
            )

            /**
             * @param kinesisParameters The custom parameter you can use to control the shard
             *   assignment, when the target is a Kinesis data stream. If you do not include this
            ...
            public fun kinesisParameters(
                kinesisParameters: KinesisParametersProperty.Builder.() -> Unit
            )

            /**
             * @param redshiftDataParameters Contains the Amazon Redshift Data API parameters to use
             *   when the target is a Amazon Redshift cluster. If you specify a Amazon Redshift
             *   Cluster as a Target, you can use this to specify parameters to invoke the Amazon
            ...
            public fun redshiftDataParameters(
                redshiftDataParameters: RedshiftDataParametersProperty.Builder.() -> Unit
            )

            /**
             * @param retryPolicy The `RetryPolicy` object that contains the retry policy
            ...
            /**
             * @param roleArn The Amazon Resource Name (ARN) of the IAM role to be used for this
             *   target when the rule is triggered. If one rule triggers multiple targets, you can
             *   use a different IAM role for each target.
             */
            public fun roleArn(roleArn: String)

            /**
             * @param runCommandParameters Parameters used when you are using the rule to invoke
            ...
            public fun runCommandParameters(
                runCommandParameters: RunCommandParametersProperty.Builder.() -> Unit
            )

            /**
             * @param sageMakerPipelineParameters Contains the SageMaker Model Building Pipeline
             *   parameters to start execution of a SageMaker Model Building Pipeline. If you
             *   specify a SageMaker Model Building Pipeline as a target, you can use this to
             *   specify parameters to start a pipeline execution based on EventBridge events.
             */
            ...
            public fun sageMakerPipelineParameters(
                sageMakerPipelineParameters: SageMakerPipelineParametersProperty.Builder.() -> Unit
            )

            /**
             * @param sqsParameters Contains the message group ID to use when the target is a FIFO
             *   queue. If you specify an SQS FIFO queue as a target, the queue must have
        ...
        private class BuilderImpl : Builder {
            ...
            override fun appSyncParameters(appSyncParameters: AppSyncParametersProperty) {
                cdkBuilder.appSyncParameters(
                    appSyncParameters.let(AppSyncParametersProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("a43551882193e3fe9df2b4bab16721122ca5a46b2fcc0c003a871cf84ec343db")
            override fun appSyncParameters(
                appSyncParameters: AppSyncParametersProperty.Builder.() -> Unit
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("3982e4b35d00e3d63457bc59d29e4364e0ab5494c552421864ae6649cf21d70f")
            override fun batchParameters(
                batchParameters: BatchParametersProperty.Builder.() -> Unit
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("4525cc9e72f77b18206f45d184df4bdf052c78b1042f8102ad34b2daed70656e")
            override fun ecsParameters(
                ecsParameters: EcsParametersProperty.Builder.() -> Unit
            ): Unit = ecsParameters(EcsParametersProperty(ecsParameters))
            ...
            override fun httpParameters(
                httpParameters: HttpParametersProperty.Builder.() -> Unit
            ): Unit = httpParameters(HttpParametersProperty(httpParameters))
            ...
            override fun kinesisParameters(kinesisParameters: KinesisParametersProperty) {
                cdkBuilder.kinesisParameters(
                    kinesisParameters.let(KinesisParametersProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("d864eb83fe1b255a63e132ec63a47751ecc2fc95eaf9e68687868e0ef7fd4c36")
            override fun kinesisParameters(
                kinesisParameters: KinesisParametersProperty.Builder.() -> Unit
            ...
            override fun redshiftDataParameters(
                ...
                cdkBuilder.redshiftDataParameters(
                    redshiftDataParameters.let(RedshiftDataParametersProperty::unwrap)
                )
            }
            ...
            override fun runCommandParameters(runCommandParameters: RunCommandParametersProperty) {
                cdkBuilder.runCommandParameters(
                    runCommandParameters.let(RunCommandParametersProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("f2bc3e927b3e1471cb8fbcbd3d0847bd2c344a95b0dc91715c3640cbc672ffdb")
            override fun runCommandParameters(
                runCommandParameters: RunCommandParametersProperty.Builder.() -> Unit
            ...
            override fun sageMakerPipelineParameters(
                ...
                cdkBuilder.sageMakerPipelineParameters(
                    sageMakerPipelineParameters.let(SageMakerPipelineParametersProperty::unwrap)
                )
            }
            ...
            override fun sageMakerPipelineParameters(
                ...
                sageMakerPipelineParameters(
                    SageMakerPipelineParametersProperty(sageMakerPipelineParameters)
                )
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("f10ce2650743bd28f69946a61fa34c1016da897addf1454ed0ab2b78ded9b8c6")
            override fun sqsParameters(
                sqsParameters: SqsParametersProperty.Builder.() -> Unit
            ): Unit = sqsParameters(SqsParametersProperty(sqsParameters))
        ...
        internal constructor(
            ...
            /**
             * The `DeadLetterConfig` that defines the target queue to send dead-letter queue events
             * to.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-events-rule-target.html#cfn-events-rule-target-deadletterconfig)
             */
             ...
             * data.
             *
             * You can extract one or more key-value pairs from the event and then use that data to
             * send customized input to the target.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-events-rule-target.html#cfn-events-rule-target-inputtransformer)
             */
    ...
    public interface BatchArrayPropertiesProperty {
        ...
        public interface Builder {
            /**
             * @param size The size of the array, if this is an array batch job. Valid values are
    ...
    public interface RunCommandParametersProperty {
        ...
        public interface Builder {
            /**
             * @param runCommandTargets Currently, we support including only one RunCommandTarget
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RunCommandParametersProperty
            ): software.amazon.awscdk.services.events.CfnRule.RunCommandParametersProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface HttpParametersProperty {
        ...
        public interface Builder {
             ...
             *   Gateway API or EventBridge ApiDestination path wildcards ("*").
             */
             ...
             *   part of request invoking the API Gateway API or EventBridge ApiDestination.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: HttpParametersProperty
            ): software.amazon.awscdk.services.events.CfnRule.HttpParametersProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
