...
internal constructor(
    ...
    public interface Builder {
         ...
         * A Boolean value;
         *
         * set to `true` to activate the subscription, set to `false` to create the subscription but
         * not active it.
         *
         ...
         * this parameter to `db-instance` . If this value is not specified, all events are
         * returned.
         *
