...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param clusterIdentifier The cluster identifier of the cluster associated with the
         *   endpoint.
         */
         ...
         *
         * @param vpcSecurityGroupIds The security group that defines the ports, protocols, and
    ...
    public interface VpcSecurityGroupProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: VpcSecurityGroupProperty
            ): software.amazon.awscdk.services.redshift.CfnEndpointAccess.VpcSecurityGroupProperty =
    ...
    public interface VpcEndpointProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param vpcEndpointId The connection endpoint ID for connecting an Amazon Redshift
