...
public open class CfnContainer internal constructor(
   ...
   * The service assigns this value when the container is created. Once the value has been assigned, it
   * does not change.
   */
  ...
  public companion object {
    public val CFN_RESOURCE_TYPE_NAME: String =
        software.amazon.awscdk.services.mediastore.CfnContainer.CFN_RESOURCE_TYPE_NAME
  ...
  public interface CorsRuleProperty {
    ...
    public interface Builder {
      ...
      /**
       * @param allowedMethods Identifies an HTTP method that the origin that is specified in the
      ...
      /**
       * @param maxAgeSeconds The time in seconds that your browser caches the preflight response
