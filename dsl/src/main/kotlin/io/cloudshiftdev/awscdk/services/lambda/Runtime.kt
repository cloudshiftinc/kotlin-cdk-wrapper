...
internal constructor(
     ...
     * Profiler.
     */
    public open fun supportsCodeGuruProfiling(): Boolean =
        unwrap(this).getSupportsCodeGuruProfiling()
    ...
    public interface Builder {
         ...
         * Default: false
         *
         * @param isVariable Whether the runtime enum is meant to change over time, IE
         *   NODEJS_LATEST.
         */
         ...
         * Default: false
         *
         * @param supportsCodeGuruProfiling Whether this runtime is integrated with and supported
         *   for profiling using Amazon CodeGuru Profiler.
         */
         ...
         * Default: false
         *
         * @param supportsInlineCode Whether the `ZipFile` (aka inline code) property can be used
         *   with this runtime.
         */
