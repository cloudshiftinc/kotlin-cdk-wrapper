...
internal constructor(
     ...
     * `["us-west-2c:vpce-111122223333", "us-west-2a:vpce-987654321098",
     * "us-west-2b:vpce-012345678901"]` .
     */
    ...
    public interface Builder {
         ...
         * policy association.
         *
         * Use this setting to protect against accidentally modifying the firewall policy for a
         * firewall that is in use. When you create a firewall, the operation initializes this
         * setting to `TRUE` .
         *
         ...
         *
         * @param firewallPolicyChangeProtection A setting indicating whether the firewall is
         *   protected against a change to the firewall policy association.
         */
         ...
         *
         * @param subnetChangeProtection A setting indicating whether the firewall is protected
         *   against changes to the subnet associations.
         */
    ...
    private class BuilderImpl(
        ...
        override fun firewallPolicyChangeProtection(firewallPolicyChangeProtection: IResolvable) {
            cdkBuilder.firewallPolicyChangeProtection(
                firewallPolicyChangeProtection.let(IResolvable::unwrap)
            )
        }
    ...
    public interface SubnetMappingProperty {
        ...
        public interface Builder {
            /**
             * @param ipAddressType The subnet's IP address type. You can't change the IP address
