...
internal constructor(
    ...
    /**  */
    public open fun kafkaVersionsList(): List<String> =
        unwrap(this).getKafkaVersionsList() ?: emptyList()
    ...
    public interface Builder {
         ...
         * contents of the file are base64 encoded. When using the console, the SDK, or the CLI, the
         ...
         *
         * @param serverProperties Contents of the server.properties file. When using the API, you
         *   must ensure that the contents of the file are base64 encoded. When using the console,
         *   the SDK, or the CLI, the contents of server.properties can be in plaintext.
         */
    ...
    private class BuilderImpl(
        ...
        override fun latestRevision(
            latestRevision: LatestRevisionProperty.Builder.() -> Unit
        ...
        public fun build(): software.amazon.awscdk.services.msk.CfnConfiguration =
            cdkBuilder.build()
    }
    ...
    public interface LatestRevisionProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: LatestRevisionProperty
            ): software.amazon.awscdk.services.msk.CfnConfiguration.LatestRevisionProperty =
