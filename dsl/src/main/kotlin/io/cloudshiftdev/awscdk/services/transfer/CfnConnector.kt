...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.transfer.CfnConnector,
    ...
    public interface Builder {
         ...
         * Connectors are used to send files using either the AS2 or SFTP protocol.
         *
         * For the access role, provide the Amazon Resource Name (ARN) of the AWS Identity and
         ...
         * example, for `--send-file-paths /bucket/dir/file.txt` , parent directory is
         ...
         * using a customer-managed key instead of the AWS managed key in Secrets Manager, then the
         ...
         * that the role provides `secretsmanager:GetSecretValue` permission to AWS Secrets Manager
         * .
         *
         ...
         *
         * @param accessRole Connectors are used to send files using either the AS2 or SFTP
         *   protocol.
         */
         ...
         *   Management (IAM) role that allows a connector to turn on CloudWatch logging for Amazon
         *   S3 events.
         */
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.transfer.CfnConnector =
            cdkBuilder.build()
    }
    ...
    public interface SftpConfigProperty {
         ...
         */
        public fun trustedHostKeys(): List<String> =
            unwrap(this).getTrustedHostKeys() ?: emptyList()
        ...
        public interface Builder {
             ...
             *   identify the external server to which you are connecting. You can use the
            ...
            /**
             * @param userSecretId The identifier for the secret (in AWS Secrets Manager) that
             *   contains the SFTP user's private key, password, or both. The identifier must be the
        ...
        internal constructor(
             ...
             * server to which you are connecting.
             *
             * You can use the `ssh-keyscan` command against the SFTP server to retrieve the
             * necessary key.
             *
             * The three standard SSH public key format elements are `&lt;key type&gt;` , `&lt;body
             * base64&gt;` , and an optional `&lt;comment&gt;` , with spaces between each element.
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-transfer-connector-sftpconfig.html#cfn-transfer-connector-sftpconfig-trustedhostkeys)
             */
            override fun trustedHostKeys(): List<String> =
                unwrap(this).getTrustedHostKeys() ?: emptyList()
    ...
    public interface As2ConfigProperty {
         ...
         *
         * If you have previously enabled Basic authentication for a connector, you can disable it
         * by using the `UpdateConnector` API call. For example, if you are using the CLI, you can
         * run the following command to remove Basic authentication:
         *
        ...
        /**
         * Used for outbound requests (from an AWS Transfer Family server to a partner AS2 server)
        ...
        public interface Builder {
            /**
             * @param basicAuthSecretId Provides Basic authentication support to the AS2 Connectors
             *   API. To use Basic authentication, you must provide the name or Amazon Resource Name
             *   (ARN) of a secret in AWS Secrets Manager .
             *
             * The default value for this parameter is `null` , which indicates that Basic
             * authentication is not enabled for the connector.
             *
             ...
             *
             * Note the following:
             * * You are storing these credentials in Secrets Manager, *not passing them directly*
             *   into this API.
             ...
             *   you are using the AWS management console, you can have the system create the secret
             *   for you.
             *
             * If you have previously enabled Basic authentication for a connector, you can disable
             * it by using the `UpdateConnector` API call. For example, if you are using the CLI,
             * you can run the following command to remove Basic authentication:
             *
             * `update-connector --connector-id my-connector-id --as2-config 'BasicAuthSecretId=""'`
             */
             ...
             *
             * You can only specify `NONE` if the URL for your connector uses HTTPS. This ensures
            ...
            /**
             * @param mdnResponse Used for outbound requests (from an AWS Transfer Family server to
             *   a partner AS2 server) to determine whether the partner response for transfers is
             *   synchronous or asynchronous. Specify either of the following values:
             * * `SYNC` : The system expects a synchronous MDN response, confirming that the file
            ...
            /**
             * @param messageSubject Used as the `Subject` HTTP header attribute in AS2 messages
             *   that are being sent with the connector.
             */
            public fun messageSubject(messageSubject: String)

            /**
             * @param partnerProfileId A unique identifier for the partner profile for the
             *   connector.
             */
            public fun partnerProfileId(partnerProfileId: String)

            /**
             * @param signingAlgorithm The algorithm that is used to sign the AS2 messages sent with
             *   the connector.
             */
        ...
        internal constructor(
             ...
             * Provides Basic authentication support to the AS2 Connectors API.
             *
             * To use Basic authentication, you must provide the name or Amazon Resource Name (ARN)
             * of a secret in AWS Secrets Manager .
             *
             * The default value for this parameter is `null` , which indicates that Basic
             * authentication is not enabled for the connector.
             *
            ...
            /**
             * Used for outbound requests (from an AWS Transfer Family server to a partner AS2
             * server) to determine whether the partner response for transfers is synchronous or
             * asynchronous.
             *
             * Specify either of the following values:
             * * `SYNC` : The system expects a synchronous MDN response, confirming that the file
            ...
            /**
             * Used as the `Subject` HTTP header attribute in AS2 messages that are being sent with
             * the connector.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-transfer-connector-as2config.html#cfn-transfer-connector-as2config-messagesubject)
             */
