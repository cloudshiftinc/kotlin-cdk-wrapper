...
internal constructor(
    ...
    public interface Builder {
        ...
        /**
         * Identifier for a state machine revision, which is an immutable, read-only snapshot of a
         * state machine’s definition and configuration.
         *
         * Only publish the state machine version if the current state machine's revision ID matches
         * the specified ID. Use this option to avoid publishing a version if the state machine has
         ...
         *
         * @param stateMachineRevisionId Identifier for a state machine revision, which is an
         *   immutable, read-only snapshot of a state machine’s definition and configuration.
         */
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.stepfunctions.CfnStateMachineVersion.Builder.create(
                scope,
                id
            )
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnStateMachineVersion
