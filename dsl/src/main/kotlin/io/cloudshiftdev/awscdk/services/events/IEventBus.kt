...
public interface IEventBus : IResource {
    ...
    internal constructor(
         ...
         * @param props Properties of the archive.
         */
        override fun archive(id: String, props: BaseArchiveProps): Archive =
        ...
        /**
         * Grants an IAM Principal to send custom events to the eventBus so that they can be matched
         * to rules.
         *
         * @param grantee The principal (no-op if undefined).
         */
