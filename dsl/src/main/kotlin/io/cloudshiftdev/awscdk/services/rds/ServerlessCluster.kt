...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * Automatic backup retention cannot be disabled on serverless clusters. Must be a value
         ...
         * Security group.
         *
         * Default: - a new security group is created if `vpc` was provided. If the `vpc` property
         * was not provided, no VPC security groups will be associated with the DB cluster.
         *
         ...
         *
         * Default: - a new subnet group is created if `vpc` was provided. If the `vpc` property was
         * not provided, no subnet group will be associated with the DB cluster
         *
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.rds.ServerlessCluster =
            cdkBuilder.build()
    }
    ...
    public companion object {
        public fun fromServerlessClusterAttributes(
            ...
            software.amazon.awscdk.services.rds.ServerlessCluster.fromServerlessClusterAttributes(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    attrs.let(ServerlessClusterAttributes::unwrap)
                )
                .let(IServerlessCluster::wrap)
        ...
        public fun fromServerlessClusterAttributes(
            ...
            fromServerlessClusterAttributes(scope, id, ServerlessClusterAttributes(attrs))
