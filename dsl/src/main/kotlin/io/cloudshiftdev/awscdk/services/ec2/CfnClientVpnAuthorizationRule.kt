...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.ec2.CfnClientVpnAuthorizationRule,
    ...
    public interface Builder {
         ...
         * Indicates whether to grant access to all clients.
         *
         * Specify `true` to grant all clients who successfully establish a VPN connection access to
         ...
         *
         * @param targetNetworkCidr The IPv4 address range, in CIDR notation, of the network for
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.ec2.CfnClientVpnAuthorizationRule.Builder.create(
                scope,
                id
            )
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnClientVpnAuthorizationRule
