...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.rds.CfnDBInstance,
    ...
    public open fun certificateDetails(
        `value`: CertificateDetailsProperty.Builder.() -> Unit
    ): Unit = certificateDetails(CertificateDetailsProperty(`value`))

    /** Specifies whether the DB instance is restarted when you rotate your SSL/TLS certificate. */
    public open fun certificateRotationRestart(): Any? =
        unwrap(this).getCertificateRotationRestart()
    ...
    public open fun dbSecurityGroups(): List<String> =
        unwrap(this).getDbSecurityGroups() ?: emptyList()
     ...
     */
    public open fun sourceDbClusterIdentifier(): String? =
        unwrap(this).getSourceDbClusterIdentifier()
    ...
    public interface Builder {
         ...
         * which corresponds to the minimum Iops value of 1,000. If you increase the `Iops` value
         * (in 1,000 IOPS increments), then you must also increase the `AllocatedStorage` value (in
         * 100-GiB increments).
         *
         * *Amazon Aurora*
         *
         ...
         *
         * @param allocatedStorage The amount of storage in gibibytes (GiB) to be initially
         ...
         *
         * @param associatedRoles The AWS Identity and Access Management (IAM) roles associated with
         *   the DB instance.
         */
         ...
         *
         * @param automaticBackupReplicationRegion The destination region for the backup replication
         *   of the DB instance.
         */
         ...
         * Availability Zones. Specify one of these Availability Zones. Aurora automatically chooses
        ...
        public fun certificateDetails(
            certificateDetails: CertificateDetailsProperty.Builder.() -> Unit
        )
         ...
         * managed by the DB cluster. Setting this value for an Aurora DB instance has no effect on
         ...
         *
         * @param copyTagsToSnapshot Specifies whether to copy tags from the DB instance to
        ...
        /**
         * The instance profile associated with the underlying Amazon EC2 instance of an RDS Custom
         * DB instance.
         *
         ...
         *
         * @param customIamInstanceProfile The instance profile associated with the underlying
         ...
         *
         * @param dbClusterIdentifier The identifier of the DB cluster that the instance will belong
         *   to.
         */
         ...
         * DB instance classes are available in all AWS Regions, or for all database engines.
         *
         ...
         * in the *Amazon RDS User Guide.* For more information about DB instance class pricing and
         * AWS Region support for DB instance classes, see
         * [Amazon RDS Pricing](https://docs.aws.amazon.com/rds/pricing/) .
         *
         ...
         *   `db.m4.large` . Not all DB instance classes are available in all AWS Regions, or for
         ...
         * A name for the DB instance.
         *
         * If you specify a name, AWS CloudFormation converts it to lowercase. If you don't specify
         * a name, AWS CloudFormation generates a unique physical ID and uses that ID for the DB
         ...
         *
         * The name of the database to create when the DB instance is created. If this parameter is
         * not specified, the default `postgres` database is created in the DB instance.
         *
         * Constraints:
         * * Must begin with a letter. Subsequent characters can be letters, underscores, or digits
         *   (0-9).
         ...
         *
         * @param dbName The meaning of this parameter differs according to the database engine you
         *   use.
         */
         ...
         *
         * If you don't specify a value for `DBParameterGroupName` property, the default DB
         * parameter group for the specified engine and engine version is used.
         *
         ...
         *
         * If you set DBSecurityGroups, you must not set VPCSecurityGroups, and vice versa. Also,
         * note that the DBSecurityGroups property exists only for backwards compatibility with
         * older regions and is no longer recommended for providing security information to an RDS
         * DB instance. Instead, use VPCSecurityGroups.
         *
         ...
         * If the `DBSnapshotIdentifier` property is an empty string or the `AWS::RDS::DBInstance`
         ...
         * properties that you can specify, see the `RestoreDBInstanceFromDBSnapshot` action in the
         * *Amazon RDS API Reference* .
         *
         * After you restore a DB instance with a `DBSnapshotIdentifier` property, you must specify
         * the same `DBSnapshotIdentifier` property for any future updates to the DB instance. When
         * you specify this property for an update, the DB instance is not restored from the DB
         * snapshot again, and the data in the database is not changed. However, if you don't
         * specify the `DBSnapshotIdentifier` property, an empty DB instance is created, and the
         * original DB instance is deleted. If you specify a property that is different from the
         * previous snapshot restore property, a new DB instance is restored from the specified
         * `DBSnapshotIdentifier` property, and the original DB instance is deleted.
         *
         * If you specify the `DBSnapshotIdentifier` property to restore a DB instance (as opposed
         * to specifying it for DB instance updates), then don't specify the following properties:
         * * `CharacterSetName`
         * * `DBClusterIdentifier`
         * * `DBName`
         ...
         *
         * @param dbSnapshotIdentifier The name or Amazon Resource Name (ARN) of the DB snapshot
         *   that's used to restore the DB instance.
         */
         ...
         * [Using Amazon RDS with Amazon Virtual Private Cloud (VPC)](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_VPC.html)
         * in the *Amazon RDS User Guide* .
         *
         * *Amazon Aurora*
         *
         * Not applicable. The DB subnet group is managed by the DB cluster. If specified, the
         ...
         *
         * @param dedicatedLogVolume Indicates whether the DB instance has a dedicated log volume
         *   (DLV) enabled.
         */
         ...
         * instance is deleted.
         *
         * This parameter isn't case-sensitive. The default is to remove automated backups
         * immediately after the DB instance is deleted.
         *
         * *Amazon Aurora*
         *
         * Not applicable. When you delete a DB cluster, all automated backups for that DB cluster
         * are deleted and can't be recovered. Manual DB cluster snapshots of the DB cluster are not
         * deleted.
         *
         ...
         * protection is disabled. For more information, see
         * [Deleting a DB Instance](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_DeleteInstance.html)
         * .
         *
         * *Amazon Aurora*
         *
         * Not applicable. You can enable or disable deletion protection for the DB cluster. For
         * more information, see `CreateDBCluster` . DB instances in a DB cluster can be deleted
         ...
         * The Active Directory directory ID to create the DB instance in.
         *
         * Currently, only Db2, MySQL, Microsoft SQL Server, Oracle, and PostgreSQL DB instances can
         ...
         *
         * @param domainAuthSecretArn The ARN for the Secrets Manager secret with the credentials
         *   for the user joining the domain.
         */
         ...
         *
         * @param domainDnsIps The IPv4 DNS IP addresses of your primary and secondary Active
         ...
         *
         * @param enableIamDatabaseAuthentication A value that indicates whether to enable mapping
         *   of AWS Identity and Access Management (IAM) accounts to database accounts.
         */
         ...
         *
         * @param enablePerformanceInsights Specifies whether to enable Performance Insights for the
         *   DB instance.
         */
         ...
         * 200 GiB of storage (a ratio of 5:1), or specify 2000 IOPS with 200 GiB of storage (a
         * ratio of 10:1). For more information, see
         * [Amazon RDS Provisioned IOPS Storage to Improve Performance](https://docs.aws.amazon.com/AmazonRDS/latest/DeveloperGuide/CHAP_Storage.html#USER_PIOPS)
         * in the *Amazon RDS User Guide* .
         *
         * If you specify `io1` for the `StorageType` property, then you must also specify the
         * `Iops` property.
         *
         * Constraints:
         * * For RDS for Db2, MariaDB, MySQL, Oracle, and PostgreSQL - Must be a multiple between .5
         *   and 50 of the storage amount for the DB instance.
         * * For RDS for SQL Server - Must be a multiple between 1 and 50 of the storage amount for
         *   the DB instance.
         *
         ...
         * a KMS key for the destination AWS Region. KMS encryption keys are specific to the region
         * that they're created in, and you can't use encryption keys from one region in another
         * region.
         *
         * If you specify the `SnapshotIdentifier` property, the `StorageEncrypted` property value
         * is inherited from the snapshot, and if the DB instance is encrypted, the specified
         * `KmsKeyId` property is used.
         *
         * If you specify `DBSecurityGroups` , AWS CloudFormation ignores this property. To specify
         * both a security group and this property, you must use a VPC security group. For more
         * information about Amazon RDS and VPC, see
         ...
         *
         * @param kmsKeyId The ARN of the AWS KMS key that's used to encrypt the DB instance, such
         *   as `arn:aws:kms:us-east-1:012345678910:key/abcd1234-a123-456a-a12b-a123b4cd56ef` .
         */
         ...
         * * RDS for Db2 - `bring-your-own-license` . For more information about RDS for Db2
         *   licensing, see
         *   [](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/db2-licensing.html) in the
         ...
         *
         * @param masterUserSecret The secret managed by RDS in AWS Secrets Manager for the master
         *   user password.
         */
         ...
         *
         * @param monitoringInterval The interval, in seconds, between points when Enhanced
         ...
         * *Amazon Aurora*
         *
         * Not applicable. Amazon Aurora storage is replicated across all of the Availability Zones
         * and doesn't require the `MultiAZ` option to be set.
         *
         ...
         *
         * @param multiAz Specifies whether the database instance is a Multi-AZ DB instance
         *   deployment.
         */
         ...
         *
         * @param ncharCharacterSetName The name of the NCHAR character set for the Oracle DB
         *   instance.
         */
         ...
         * `DBSubnetGroup` can support only the IPv4 protocol or the IPv4 and IPv6 protocols (
         * `DUAL` ).
         *
         * For more information, see
         ...
         * removed from an option group. Also, that option group can't be removed from a DB instance
         ...
         *
         * @param optionGroupName Indicates that the DB instance should be associated with the
         ...
         * your default KMS key. There is a default KMS key for your AWS account. Your AWS account
         ...
         *
         * @param performanceInsightsKmsKeyId The AWS KMS key identifier for encryption of
         ...
         *
         * @param performanceInsightsRetentionPeriod The number of days to retain Performance
         *   Insights data.
         */
         ...
         * each AWS Region, occurring on a random day of the week. To see the time blocks available,
         * see
         ...
         * in the *Amazon RDS User Guide.*
         *
         * This property applies when AWS CloudFormation initially creates the DB instance. If you
         * use AWS CloudFormation to update the DB instance, those updates are applied immediately.
         *
         ...
         *
         * @param preferredMaintenanceWindow The weekly time range during which system maintenance
         ...
         *
         * @param processorFeatures The number of CPU cores and the number of threads per core for
         ...
         * DNS name, which resolves to a public IP address. If you specify false, AWS CloudFormation
         * creates an internal instance with a DNS name that resolves to a private IP address.
         *
         * The default behavior value depends on your VPC setup and the database subnet group. For
         * more information, see the `PubliclyAccessible` parameter in the
         ...
         *
         * @param sourceDbClusterIdentifier The identifier of the Multi-AZ DB cluster that will act
         *   as the source for the read replica.
         */
         ...
         *
         * @param sourceDbInstanceAutomatedBackupsArn The Amazon Resource Name (ARN) of the
         *   replicated automated backups from which to restore, for example,
         *   `arn:aws:rds:us-east-1:123456789012:auto-backup:ab-L2IJCEXJP7XQ7HOJ4SIEXAMPLE` .
         */
         ...
         * [Working with Read Replicas](https://docs.aws.amazon.com/AmazonRDS/latest/DeveloperGuide/USER_ReadRepl.html)
         * in the *Amazon RDS User Guide* .
         *
         * For information about constraints that apply to DB instance identifiers, see
         * [Naming constraints in Amazon RDS](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/CHAP_Limits.html#RDS_Limits.Constraints)
         * in the *Amazon RDS User Guide* .
         *
         * The `SourceDBInstanceIdentifier` property determines whether a DB instance is a read
         * replica. If you remove the `SourceDBInstanceIdentifier` property from your template and
         * then update your stack, AWS CloudFormation promotes the Read Replica to a standalone DB
         * instance.
         ...
         *   read replica inherits the value of the `VPCSecurityGroups` property from the source DB
         *   when you create the replica. However, if you update the stack, AWS CloudFormation
         *   reverts the replica's `VPCSecurityGroups` property to the default value because it's
         *   not defined in the stack's template. This change might cause unexpected issues.
         ...
         *   `MasterUserPassword` , and `PreferredBackupWindow` properties. The database attributes
         *   are inherited from the source DB instance, and backups are disabled for read replicas.
         * * If the source DB instance is in a different region than the read replica, specify the
         *   source region in `SourceRegion` , and specify an ARN for a valid DB instance in
         *   `SourceDBInstanceIdentifier` . For more information, see
         *   [Constructing a Amazon RDS Amazon Resource Name (ARN)](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_Tagging.html#USER_Tagging.ARN)
         *   in the *Amazon RDS User Guide* .
         ...
         *
         * @param sourceDbInstanceIdentifier If you want to create a read replica DB instance,
         *   specify the ID of the source DB instance.
         */
         ...
         *
         * @param sourceDbiResourceId The resource ID of the source DB instance from which to
         *   restore.
         */
         ...
         *
         * @param sourceRegion The ID of the region that contains the source DB instance for the
         *   read replica.
         */
         ...
         *
         * If you specify the `SourceDBInstanceIdentifier` property, don't specify this property.
         * The value is inherited from the source DB instance, and if the DB instance is encrypted,
         * the specified `KmsKeyId` property is used.
         *
         * If you specify the `DBSnapshotIdentifier` and the specified snapshot is encrypted, don't
         * specify this property. The value is inherited from the snapshot, and the specified
         * `KmsKeyId` property is used.
         *
         * If you specify the `DBSnapshotIdentifier` and the specified snapshot isn't encrypted, you
         * can use this property to specify that the restored DB instance is encrypted. Specify the
         * `KmsKeyId` property for the KMS key to use for encryption. If you don't want the restored
         * DB instance to be encrypted, then don't set this property or set it to `false` .
         *
         * *Amazon Aurora*
         *
        ...
        /**
         * Specifies the storage throughput value for the DB instance. This setting applies only to
         ...
         *
         * @param useDefaultProcessorFeatures Specifies whether the DB instance class of the DB
         ...
         *
         * @param useLatestRestorableTime Specifies whether the DB instance is restored from the
         *   latest backup time.
         */
         ...
         * * You can't revert to using an RDS security group after you establish a VPC security
         *   group membership.
         ...
         *
         * @param vpcSecurityGroups A list of the VPC security group IDs to assign to the DB
         *   instance.
         */
    ...
    private class BuilderImpl(
        ...
        override fun certificateDetails(certificateDetails: CertificateDetailsProperty) {
            cdkBuilder.certificateDetails(
                certificateDetails.let(CertificateDetailsProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("527e2d3895792e597e6dd0df6c49c0c759da008f3ce325ffa8f5506a21c6806b")
        override fun certificateDetails(
            certificateDetails: CertificateDetailsProperty.Builder.() -> Unit
        ...
        override fun certificateRotationRestart(certificateRotationRestart: IResolvable) {
            cdkBuilder.certificateRotationRestart(
                certificateRotationRestart.let(IResolvable::unwrap)
            )
        }
        ...
        override fun enableIamDatabaseAuthentication(enableIamDatabaseAuthentication: IResolvable) {
            cdkBuilder.enableIamDatabaseAuthentication(
                enableIamDatabaseAuthentication.let(IResolvable::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("fd2e9e3e70cdc72e383888e63bd1e2a69e4b1df6b4c3b633e7736d38e672fb2c")
        override fun masterUserSecret(
            masterUserSecret: MasterUserSecretProperty.Builder.() -> Unit
         ...
         *   Insights data.
         */
        override fun performanceInsightsRetentionPeriod(
         ...
         *   `arn:aws:rds:us-east-1:123456789012:auto-backup:ab-L2IJCEXJP7XQ7HOJ4SIEXAMPLE` .
         */
        override fun sourceDbInstanceAutomatedBackupsArn(
        ...
        override fun useDefaultProcessorFeatures(useDefaultProcessorFeatures: IResolvable) {
            cdkBuilder.useDefaultProcessorFeatures(
                useDefaultProcessorFeatures.let(IResolvable::unwrap)
            )
        }
    ...
    public companion object {
        ...
        ): software.amazon.awscdk.services.rds.CfnDBInstance = wrapped.cdkObject
    }
    ...
    public interface DBInstanceRoleProperty {
         ...
         * access other AWS services on your behalf. For the list of supported feature names, see
         * the `SupportedFeatureNames` description in
        ...
        public interface Builder {
            /**
             * @param featureName The name of the feature associated with the AWS Identity and
             *   Access Management (IAM) role. IAM roles that are associated with a DB instance
             *   grant permission for the DB instance to access other AWS services on your behalf.
             *   For the list of supported feature names, see the `SupportedFeatureNames`
             *   description in
             *   [DBEngineVersion](https://docs.aws.amazon.com/AmazonRDS/latest/APIReference/API_DBEngineVersion.html)
             *   in the *Amazon RDS API Reference* .
             */
            ...
            /**
             * @param roleArn The Amazon Resource Name (ARN) of the IAM role that is associated with
             *   the DB instance.
             */
        ...
        internal constructor(
             ...
             * role.
             *
             * IAM roles that are associated with a DB instance grant permission for the DB instance
             * to access other AWS services on your behalf. For the list of supported feature names,
             * see the `SupportedFeatureNames` description in
             * [DBEngineVersion](https://docs.aws.amazon.com/AmazonRDS/latest/APIReference/API_DBEngineVersion.html)
             * in the *Amazon RDS API Reference* .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-rds-dbinstance-dbinstancerole.html#cfn-rds-dbinstance-dbinstancerole-featurename)
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DBInstanceRoleProperty
            ): software.amazon.awscdk.services.rds.CfnDBInstance.DBInstanceRoleProperty =
    ...
    public interface EndpointProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param hostedZoneId Specifies the ID that Amazon Route 53 assigns when you create a
             *   hosted zone.
             */
    ...
    public interface CertificateDetailsProperty {
        ...
        public interface Builder {
            /**
             * @param caIdentifier The CA identifier of the CA certificate used for the DB
             *   instance's server certificate.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CertificateDetailsProperty
            ): software.amazon.awscdk.services.rds.CfnDBInstance.CertificateDetailsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ProcessorFeatureProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ProcessorFeatureProperty
            ): software.amazon.awscdk.services.rds.CfnDBInstance.ProcessorFeatureProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface MasterUserSecretProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: MasterUserSecretProperty
            ): software.amazon.awscdk.services.rds.CfnDBInstance.MasterUserSecretProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
