...
public interface SingletonFunctionProps : FunctionProps {
  /**
   ...
   */
  public fun lambdaPurpose(): String? = unwrap(this).getLambdaPurpose()
  ...
  /**
   * A builder for [SingletonFunctionProps]
   */
  @CdkDslMarker
  public interface Builder {
    ...
    @JvmName("64c5e6576f3d9e1c1d16a4e0fbdac38a788ae589090b1df65a34cba781482c0b")
    public
     ...
     */
    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("6ffb7ce8764f13284eed0dc307bb0cd2e8dc3b66cb30d9917d8a9dba172adc38")
     ...
     */
    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("9acd865792ee4720ac380e2f2e3047e5b6b5015888331ac6260e62b68f8103e8")
    public
     ...
     */
    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("31f947f2ffa96643bf58e4ff0961015295b324800ee46c8c0e1bc57dc992aefa")
    public fun vpcSubnets(vpcSubnets: SubnetSelection.Builder.() -> Unit)
  }

  private class BuilderImpl : Builder {
    private val cdkBuilder: software.amazon.awscdk.services.lambda.SingletonFunctionProps.Builder =
    ...
    public fun build(): software.amazon.awscdk.services.lambda.SingletonFunctionProps =
        cdkBuilder.build()
  }

  private class Wrapper(
    override val cdkObject: software.amazon.awscdk.services.lambda.SingletonFunctionProps,
  ) : CdkObject(cdkObject), SingletonFunctionProps {
    /**
     ...
     * Default: SingletonLambda
     */
    override fun lambdaPurpose(): String? = unwrap(this).getLambdaPurpose()
     ...
     * We recommend generating a UUID per provider.
     */
    override fun uuid(): String = unwrap(this).getUuid()
  ...
  public companion object {
    public operator fun invoke(block: Builder.() -> Unit = {}): SingletonFunctionProps {
      val builderImpl = BuilderImpl()
      return Wrapper(builderImpl.apply(block).build())
    }

    internal fun wrap(cdkObject: software.amazon.awscdk.services.lambda.SingletonFunctionProps):
        SingletonFunctionProps = Wrapper(cdkObject)
    ...
    internal fun unwrap(wrapped: SingletonFunctionProps):
        ...
        CdkObject).cdkObject as software.amazon.awscdk.services.lambda.SingletonFunctionProps
  }
}
