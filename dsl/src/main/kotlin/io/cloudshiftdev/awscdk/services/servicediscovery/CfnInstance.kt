...
internal constructor(
    ...
    public interface Builder {
         ...
         * * **AWS_ALIAS_DNS_NAME** - If you want AWS Cloud Map to create a Route 53 alias record
         *   that routes traffic to an Elastic Load Balancing load balancer, specify the DNS name
         *   that is associated with the load balancer. For information about how to get the DNS
         *   name, see
         ...
         *   AWS Cloud Map will create the health check, but it won't associate the health check
         ...
         *   , if the `AWS_EC2_INSTANCE_ID` attribute is specified, the only other attribute that
         *   can be specified is `AWS_INIT_HEALTH_STATUS` . After the resource has been created, the
         ...
         *   [AWS::ServiceDiscovery::Instance](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-servicediscovery-instance.html)
         *   you can optionally use `AWS_INIT_HEALTH_STATUS` to specify the initial status of the
         ...
         *   IPv6 address that you want Route 53 to return in response to DNS queries, for example,
         ...
         *
         * @param serviceId The ID of the service that you want to use for settings for the
         *   instance.
         */
