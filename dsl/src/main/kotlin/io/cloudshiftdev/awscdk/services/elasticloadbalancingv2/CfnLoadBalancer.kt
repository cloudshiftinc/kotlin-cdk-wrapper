...
internal constructor(
     ...
     */
    public open fun attrCanonicalHostedZoneId(): String =
        unwrap(this).getAttrCanonicalHostedZoneId()
    ...
    public interface Builder {
         ...
         * Load Balancer through AWS PrivateLink .
         *
         ...
         * addresses). You can’t specify `dualstack` for a load balancer with a UDP or TCP_UDP
         * listener.
         *
         ...
         * load balancer. If you specify a name, you cannot perform updates that require replacement
         * of this resource, but you can perform other updates. To replace the resource, specify a
         * new name.
         *
         ...
         *
         * @param securityGroups [Application Load Balancers and Network Load Balancers] The IDs of
         ...
         * internet-facing load balancer. For internal load balancers, you can specify one private
         * IP address per subnet from the IPv4 range of the subnet. For internet-facing load
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.elasticloadbalancingv2.CfnLoadBalancer.Builder.create(
                scope,
                id
            )
         ...
         *   PrivateLink .
         */
        override fun enforceSecurityGroupInboundRulesOnPrivateLinkTraffic(
            enforceSecurityGroupInboundRulesOnPrivateLinkTraffic: String
        ) {
    ...
    public interface SubnetMappingProperty {
        ...
        public interface Builder {
            /**
             * @param allocationId [Network Load Balancers] The allocation ID of the Elastic IP
            ...
            /**
             * @param privateIPv4Address [Network Load Balancers] The private IPv4 address for an
    ...
    public interface LoadBalancerAttributeProperty {
         ...
         *   enabled. The possible values are `true` and `false` . The default for Network Load
         ...
         *   is required if access logs are enabled. The bucket must exist in the same region as the
         *   load balancer and have a bucket policy that grants Elastic Load Balancing permissions
         ...
         *   Balancer should preserve the `Host` header in the HTTP request and send it to the
         *   target without any change. The possible values are `true` and `false` . The default is
         *   `false` .
         * * `routing.http.x_amzn_tls_version_and_cipher_suite.enabled` - Indicates whether the two
         *   headers ( `x-amzn-tls-version` and `x-amzn-tls-cipher-suite` ), which contain
         *   information about the negotiated TLS version and cipher suite, are added to the client
         *   request before sending it to the target. The `x-amzn-tls-version` header has
         ...
         *   should preserve the source port that the client used to connect to the load balancer.
         ...
         *   the `X-Forwarded-For` header in the HTTP request before the Application Load Balancer
         *   sends the request to the target. The possible values are `append` , `preserve` , and
         ...
         *   `X-Forwarded-For` header in the HTTP request, and sends it to targets without any
         *   change.
         ...
         * * `waf.fail_open.enabled` - Indicates whether to allow a WAF-enabled load balancer to
         *   route requests to targets if it is unable to forward the request to AWS WAF. The
         *   possible values are `true` and `false` . The default is `false` .
         *
         * The following attributes are supported by only Network Load Balancers:
         * * `dns_record.client_routing_policy` - Indicates how traffic is distributed among the
         *   load balancer Availability Zones. The possible values are `availability_zone_affinity`
         *   with 100 percent zonal affinity, `partial_availability_zone_affinity` with 85 percent
         *   zonal affinity, and `any_availability_zone` with 0 percent zonal affinity.
         *
        ...
        public interface Builder {
             ...
             *   is enabled. The possible values are `true` and `false` . The default for Network
             *   Load Balancers and Gateway Load Balancers is `false` . The default for Application
             *   Load Balancers is `true` , and cannot be changed.
             *
             * The following attributes are supported by both Application Load Balancers and Network
             * Load Balancers:
             * * `access_logs.s3.enabled` - Indicates whether access logs are enabled. The value is
             ...
             *   two headers ( `x-amzn-tls-version` and `x-amzn-tls-cipher-suite` ), which contain
             *   information about the negotiated TLS version and cipher suite, are added to the
             *   client request before sending it to the target. The `x-amzn-tls-version` header has
             *   information about the TLS protocol version negotiated with the client, and the
             *   `x-amzn-tls-cipher-suite` header has information about the cipher suite negotiated
             *   with the client. Both headers are in OpenSSL format. The possible values for the
             ...
             * * `routing.http.xff_header_processing.mode` - Enables you to modify, preserve, or
             *   remove the `X-Forwarded-For` header in the HTTP request before the Application Load
             *   Balancer sends the request to the target. The possible values are `append` ,
             *   `preserve` , and `remove` . The default is `append` .
             * * If the value is `append` , the Application Load Balancer adds the client IP address
             ...
             * * `routing.http2.enabled` - Indicates whether HTTP/2 is enabled. The possible values
             *   are `true` and `false` . The default is `true` . Elastic Load Balancing requires
             ...
             * The following attributes are supported by only Network Load Balancers:
             * * `dns_record.client_routing_policy` - Indicates how traffic is distributed among the
             *   load balancer Availability Zones. The possible values are
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: LoadBalancerAttributeProperty
            ): software.amazon.awscdk.services.elasticloadbalancingv2.CfnLoadBalancer.LoadBalancerAttributeProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
