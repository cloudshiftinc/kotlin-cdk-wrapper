...
internal constructor(
    ...
    public open fun configuredTableIdentifier(): String =
        unwrap(this).getConfiguredTableIdentifier()
    ...
    public interface Builder {
         ...
         * The name of the configured table association, in lowercase.
         *
         * The table is identified by this name when running protected queries against the
         * underlying data.
         *
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.cleanrooms.CfnConfiguredTableAssociation.Builder.create(
                scope,
                id
            )
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnConfiguredTableAssociation
        ): software.amazon.awscdk.services.cleanrooms.CfnConfiguredTableAssociation =
            wrapped.cdkObject
    }
}
