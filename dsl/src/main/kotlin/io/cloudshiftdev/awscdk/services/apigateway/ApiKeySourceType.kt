...
public enum class ApiKeySourceType(
  ...
  public companion object {
    internal fun wrap(cdkObject: software.amazon.awscdk.services.apigateway.ApiKeySourceType):
        ApiKeySourceType = when (cdkObject) {
      software.amazon.awscdk.services.apigateway.ApiKeySourceType.HEADER -> ApiKeySourceType.HEADER
      software.amazon.awscdk.services.apigateway.ApiKeySourceType.AUTHORIZER ->
          ApiKeySourceType.AUTHORIZER
    }

    internal fun unwrap(wrapped: ApiKeySourceType):
