...
internal constructor(
     ...
     *
     * This method adds an Event Selector for filtering events that match either S3 or Lambda
     * function operations.
     *
     * Data events: These events provide insight into the resource operations performed on or within
    ...
    public open fun addEventSelector(
        ...
        unwrap(this)
            .addEventSelector(dataResourceType.let(DataResourceType::unwrap), dataResourceValues)
    }
    ...
    public open fun addEventSelector(
        ...
        unwrap(this)
            .addEventSelector(
                dataResourceType.let(DataResourceType::unwrap),
                dataResourceValues,
    ...
    public open fun addEventSelector(
        ...
        addEventSelector(dataResourceType, dataResourceValues, AddEventSelectorOptions(options))
     ...
     * @param options the options to configure logging of management and data events.
     */
    public open fun addLambdaEventSelector(
        handlers: List<IFunction>,
        options: AddEventSelectorOptions
    ) {
        unwrap(this)
            .addLambdaEventSelector(
                handlers.map(IFunction::unwrap),
                options.let(AddEventSelectorOptions::unwrap)
            )
    }
    ...
    public open fun addLambdaEventSelector(
        handlers: List<IFunction>,
        options: AddEventSelectorOptions.Builder.() -> Unit
    ): Unit = addLambdaEventSelector(handlers, AddEventSelectorOptions(options))
     ...
     * a resource. These are also known as data plane operations.
     *
     * @param s3Selector the list of S3 bucket with optional prefix to include in logging (maximum
     *   250 entries).
     * @param options the options to configure logging of management and data events.
     */
     ...
     * @param options the options to configure logging of management and data events.
     */
    public open fun addS3EventSelector(
        s3Selector: List<S3EventSelector>,
        options: AddEventSelectorOptions
    ) {
        unwrap(this)
            .addS3EventSelector(
                s3Selector.map(S3EventSelector::unwrap),
                options.let(AddEventSelectorOptions::unwrap)
            )
    }
    ...
    public open fun addS3EventSelector(
        s3Selector: List<S3EventSelector>,
        options: AddEventSelectorOptions.Builder.() -> Unit
    ): Unit = addS3EventSelector(s3Selector, AddEventSelectorOptions(options))
    ...
    public open fun logAllLambdaDataEvents(
        options: AddEventSelectorOptions.Builder.() -> Unit
    ): Unit = logAllLambdaDataEvents(AddEventSelectorOptions(options))
    ...
    public interface Builder {
         ...
         * with RSA for digital signing. This makes it computationally infeasible to modify, delete
         * or forge CloudTrail log files without detection. You can use the AWS CLI to validate the
        ...
        /**
         * The AWS Key Management Service (AWS KMS) key ID that you want to use to encrypt
         * CloudTrail logs.
         *
         * Default: - No encryption.
         *
         * @param encryptionKey The AWS Key Management Service (AWS KMS) key ID that you want to use
         *   to encrypt CloudTrail logs.
         */
         ...
         * CloudFront, and Route 53, events are delivered to any trail that includes global
         * services, and are logged as occurring in US East (N. Virginia) Region.
         *
         * Default: true
         *
         * @param includeGlobalServiceEvents For most services, events are recorded in the region
         ...
         * Default: - No Value.
         *
         * @param insightTypes A JSON string that contains the insight types you want to log on a
         *   trail.
         */
        ...
        /**
         * Whether or not this trail delivers log files from multiple regions to a single S3 bucket
         * for a single account.
         *
         * Default: true
         *
         * @param isMultiRegionTrail Whether or not this trail delivers log files from multiple
         *   regions to a single S3 bucket for a single account.
         */
         ...
         *
         * If this is set to true then the current account *must* be the management account. If it
         * is not, then CloudFormation will throw an error.
         *
         * If this is set to true and the current account is a management account for an
         * organization in AWS Organizations, the trail will be created in all AWS accounts that
         * belong to the organization. If this is set to false, the trail will remain in the current
         * AWS account but be deleted from all member accounts in the organization.
         *
         * Default: - false
         *
         ...
         * settings for your trails.
         *
         * Only events that match your trail settings are delivered to your Amazon S3 bucket and
         * Amazon CloudWatch Logs log group.
         *
         * This method sets the management configuration for this trail.
         *
         * Management events provide insight into management operations that are performed on
         ...
         * example, when a user logs in to your account, CloudTrail logs the ConsoleLogin event.
         *
         * Default: ReadWriteType.ALL
         *
         * @param managementEvents When an event occurs in your account, CloudTrail evaluates
         *   whether the event matches the settings for your trails.
         */
         ...
         * Default: - No prefix.
         *
         * @param s3KeyPrefix An Amazon S3 object key prefix that precedes the name of all log
         *   files.
         */
         ...
         * Default: false
         *
         * @param sendToCloudWatchLogs If CloudTrail pushes logs to CloudWatch Logs in addition to
         *   S3.
         */
    ...
    public companion object {
        public fun onEvent(scope: CloudshiftdevConstructsConstruct, id: String): Rule =
            software.amazon.awscdk.services.cloudtrail.Trail.onEvent(
        ...
        public fun onEvent(
            ...
            software.amazon.awscdk.services.cloudtrail.Trail.onEvent(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    options.let(OnEventOptions::unwrap)
                )
                .let(Rule::wrap)
