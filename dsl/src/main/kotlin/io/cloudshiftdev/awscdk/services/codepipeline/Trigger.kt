...
internal constructor(
    ...
    private class BuilderImpl : Builder {
        ...
        public fun build(): software.amazon.awscdk.services.codepipeline.Trigger =
            cdkBuilder.build()
    }
    ...
    public companion object {
        ...
        ): Trigger = Trigger(cdkObject)

        internal fun unwrap(
            wrapped: Trigger
        ): software.amazon.awscdk.services.codepipeline.Trigger = wrapped.cdkObject
    }
}
