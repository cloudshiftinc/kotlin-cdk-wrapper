...
internal constructor(
    ...
    /**
     * When the value of `RuleType` is `FORWARD` , the ID that Resolver assigned to the resolver
     * rule when you created it, such as `rslvr-rr-5328a0899aexample` .
     *
    ...
    public interface Builder {
         ...
         * `TargetIps` .
         *
         * If a query matches multiple Resolver rules (example.com and www.example.com), the query
         * is routed using the Resolver rule that contains the most specific domain name
         * (www.example.com).
         *
         ...
         *
         * @param name The name for the Resolver rule, which you specified when you created the
         *   Resolver rule.
         */
         ...
         *
         * @param ruleType When you want to forward DNS queries for specified domain name to
         ...
         *
         * @param targetIps An array that contains the IP addresses and ports that an outbound
         *   endpoint forwards DNS queries to.
         */
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.route53resolver.CfnResolverRule.Builder.create(
                scope,
                id
            )
