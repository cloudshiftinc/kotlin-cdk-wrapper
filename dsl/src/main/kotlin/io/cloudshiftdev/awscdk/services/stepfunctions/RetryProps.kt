...
public interface RetryProps {
     ...
     */
    public fun jitterStrategy(): JitterType? =
    ...
    public interface Builder {
        /**
         * @param backoffRate Multiplication for how much longer the wait interval gets on every
         *   retry.
         */
        ...
        /**
         * @param maxAttempts How many times to retry this particular error. May be 0 to disable
         *   retry for specific errors (in case you have a catch-all retry policy).
         */
    ...
    internal constructor(
         ...
         * How many times to retry this particular error.
         *
         * May be 0 to disable retry for specific errors (in case you have a catch-all retry
         * policy).
         *
         * Default: 3
         */
