...
internal constructor(
     ...
     * `PENDING_CREATION` , `PENDING_UPDATE` , `PENDING_DELETION` , `FAILED_CREATION` ,
     * `FAILED_UPDATE` , `FAILED_DELETION` , and `DELETED` ..
     */
    ...
    public open fun ingressVpcConfiguration(`value`: IngressVpcConfigurationProperty) {
        unwrap(this)
            .setIngressVpcConfiguration(`value`.let(IngressVpcConfigurationProperty::unwrap))
    }
    ...
    public open fun ingressVpcConfiguration(
        `value`: IngressVpcConfigurationProperty.Builder.() -> Unit
    ): Unit = ingressVpcConfiguration(IngressVpcConfigurationProperty(`value`))
    ...
    public interface Builder {
         ...
         *
         * @param ingressVpcConfiguration Specifications for the customer’s Amazon VPC and the
         *   related AWS PrivateLink VPC endpoint that are used to create the VPC Ingress Connection
         *   resource.
         */
        ...
        public fun ingressVpcConfiguration(
            ingressVpcConfiguration: IngressVpcConfigurationProperty.Builder.() -> Unit
        )
         ...
         *
         * @param serviceArn The Amazon Resource Name (ARN) for this App Runner service that is used
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.apprunner.CfnVpcIngressConnection.Builder.create(
                scope,
                id
            )
         ...
         *   resource.
         */
        override fun ingressVpcConfiguration(
            ingressVpcConfiguration: IngressVpcConfigurationProperty
        ) {
            cdkBuilder.ingressVpcConfiguration(
                ingressVpcConfiguration.let(IngressVpcConfigurationProperty::unwrap)
            )
        }
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnVpcIngressConnection
    ...
    public interface IngressVpcConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param vpcEndpointId The ID of the VPC endpoint that your App Runner service connects
             *   to.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: IngressVpcConfigurationProperty
            ): software.amazon.awscdk.services.apprunner.CfnVpcIngressConnection.IngressVpcConfigurationProperty =
