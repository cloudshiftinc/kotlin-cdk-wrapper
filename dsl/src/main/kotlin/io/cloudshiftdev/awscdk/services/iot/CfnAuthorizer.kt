...
internal constructor(
    ...
    public interface Builder {
        ...
        /**
         * When `true` , the result from the authorizer's Lambda function is cached for clients that
         * use persistent HTTP connections.
         *
         * The results are cached for the time specified by the Lambda function in
         * `refreshAfterInSeconds` . This value doesn't affect authorization of clients that use
         * MQTT connections.
         *
         ...
         *
         * @param enableCachingForHttp When `true` , the result from the authorizer's Lambda
         *   function is cached for clients that use persistent HTTP connections.
         */
         ...
         *
         * @param tokenSigningPublicKeys The public keys used to validate the token signature
    ...
    public companion object {
        ...
        ): software.amazon.awscdk.services.iot.CfnAuthorizer = wrapped.cdkObject
    }
}
