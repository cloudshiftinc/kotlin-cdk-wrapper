...
internal constructor(
     ...
     */
    public override fun addObjectCreatedNotification(
        dest: IBucketNotificationDestination,
        filters: NotificationKeyFilter
    ) {
        unwrap(this)
     ...
     * @param filters Filters (see onEvent).
     */
    public override fun addObjectRemovedNotification(
        dest: IBucketNotificationDestination,
        filters: NotificationKeyFilter
    ) {
        unwrap(this)
     ...
     */
    public override fun addToResourcePolicy(
     ...
     * ```
     *
     * Note that if this `IBucket` refers to an existing bucket, possibly not managed by
     * CloudFormation, this method will have no effect, since it's impossible to modify the policy
    ...
    public override fun grantWrite(
        ...
        unwrap(this)
            .grantWrite(identity.let(IGrantable::unwrap), objectsKeyPattern, allowedActionPatterns)
            .let(Grant::wrap)
     ...
     * @param options Options for adding the rule.
     */
    public override fun onCloudTrailEvent(
        id: String,
     ...
     * @param options Options for adding the rule.
     */
    public override fun onCloudTrailPutObject(
        id: String,
        options: OnCloudTrailBucketEventOptions
    ): Rule =
        unwrap(this)
     ...
     * @param options Options for adding the rule.
     */
    public override fun onCloudTrailWriteObject(
        id: String,
        options: OnCloudTrailBucketEventOptions
    ): Rule =
        unwrap(this)
     ...
     * @return an TransferAccelerationUrl token
     */
    public override fun transferAccelerationUrlForObject(
        key: String,
    ...
    /**
     * The https URL of an S3 object. Specify `regional: false` at the options for non-regional
     * URLs. For example:.
     ...
     * @return an ObjectS3Url token
     */
    public override fun virtualHostedUrlForObject(
        key: String,
