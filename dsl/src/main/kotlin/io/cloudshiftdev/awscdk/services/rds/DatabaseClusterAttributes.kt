...
public interface DatabaseClusterAttributes {
     ...
     */
    public fun instanceEndpointAddresses(): List<String> =
    ...
    public fun instanceIdentifiers(): List<String> =
        unwrap(this).getInstanceIdentifiers() ?: emptyList()
    ...
    public interface Builder {
         ...
         *   cluster-ABCD1234EFGH5678IJKL90MNOP. This AWS Region-unique identifier is used to grant
    ...
    internal constructor(
         ...
         * Default: - no instance identifiers
         */
        override fun instanceIdentifiers(): List<String> =
            unwrap(this).getInstanceIdentifiers() ?: emptyList()
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: DatabaseClusterAttributes
