...
internal constructor(
    ...
    public open fun suppressionOptions(
        `value`: SuppressionOptionsProperty.Builder.() -> Unit
    ): Unit = suppressionOptions(SuppressionOptionsProperty(`value`))
    ...
    public interface Builder {
         ...
         *
         * @param deliveryOptions Specifies whether messages that use the configuration set are
        ...
        public fun reputationOptions(
            reputationOptions: ReputationOptionsProperty.Builder.() -> Unit
        )
         ...
         *
         * @param sendingOptions An object that defines whether or not Amazon SES can send email
        ...
        public fun suppressionOptions(
            suppressionOptions: SuppressionOptionsProperty.Builder.() -> Unit
        )
         ...
         *
         * @param trackingOptions The name of the custom open and click tracking domain associated
    ...
    private class BuilderImpl(
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("bea76d4086f6acc6c515602f5efc12d6f5d2dcd3e9dc35e7920f14a83af7c1e7")
        override fun deliveryOptions(
            deliveryOptions: DeliveryOptionsProperty.Builder.() -> Unit
        ): Unit = deliveryOptions(DeliveryOptionsProperty(deliveryOptions))
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("1c733d8e8b31cc6e04a50d62a5a57004f2628da598b37f0ba686bba934b96d4a")
        override fun reputationOptions(
            reputationOptions: ReputationOptionsProperty.Builder.() -> Unit
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("3e9c3e2a8b9ec17cd157bffa04702b878b5ea0856e2d9133e5a9b4be6ebae26a")
        override fun sendingOptions(
            sendingOptions: SendingOptionsProperty.Builder.() -> Unit
        ...
        override fun suppressionOptions(suppressionOptions: SuppressionOptionsProperty) {
            cdkBuilder.suppressionOptions(
                suppressionOptions.let(SuppressionOptionsProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("f217a82d0ce4dd438c1e6ecf7a3e479a7082ceb507fd0c05826e87dbef8e7958")
        override fun suppressionOptions(
            suppressionOptions: SuppressionOptionsProperty.Builder.() -> Unit
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("bb098918d914c45ab533668f71503aab74c3c4da79158f851169d8676c5dceaa")
        override fun trackingOptions(
            trackingOptions: TrackingOptionsProperty.Builder.() -> Unit
        ): Unit = trackingOptions(TrackingOptionsProperty(trackingOptions))
        ...
        public fun build(): software.amazon.awscdk.services.ses.CfnConfigurationSet =
            cdkBuilder.build()
    }
    ...
    public interface DeliveryOptionsProperty {
         ...
         * established. If the value is `OPTIONAL` , messages can be delivered in plain text if a
        ...
        public interface Builder {
            ...
            /**
             * @param tlsPolicy Specifies whether messages that use the configuration set are
             *   required to use Transport Layer Security (TLS). If the value is `REQUIRE` ,
             *   messages are only delivered if a TLS connection can be established. If the value is
             *   `OPTIONAL` , messages can be delivered in plain text if a TLS connection can't be
             *   established.
             *
             * Valid Values: `REQUIRE | OPTIONAL`
             */
        ...
        internal constructor(
             ...
             *
             * If the value is `REQUIRE` , messages are only delivered if a TLS connection can be
             * established. If the value is `OPTIONAL` , messages can be delivered in plain text if
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DeliveryOptionsProperty
            ): software.amazon.awscdk.services.ses.CfnConfigurationSet.DeliveryOptionsProperty =
    ...
    public interface GuardianOptionsProperty {
        ...
        public interface Builder {
            /**
             * @param optimizedSharedDelivery Specifies the status of your VDM optimized shared
             *   delivery. Can be one of the following:.
             * * `ENABLED` – Amazon SES enables optimized shared delivery for the configuration set.
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ses-configurationset-guardianoptions.html#cfn-ses-configurationset-guardianoptions-optimizedshareddelivery)
             */
            override fun optimizedSharedDelivery(): String =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: GuardianOptionsProperty
            ): software.amazon.awscdk.services.ses.CfnConfigurationSet.GuardianOptionsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface VdmOptionsProperty {
        ...
        public interface Builder {
            /**
             * @param dashboardOptions Settings for your VDM configuration as applicable to the
             *   Dashboard.
             */
            ...
            public fun dashboardOptions(
                dashboardOptions: DashboardOptionsProperty.Builder.() -> Unit
            )

            /**
             * @param guardianOptions Settings for your VDM configuration as applicable to the
             *   Guardian.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("9632d1b5dcfc878d2221fd033755a8f3e6b6e1ed1099d509a3393553918608b9")
            override fun guardianOptions(
                guardianOptions: GuardianOptionsProperty.Builder.() -> Unit
    ...
    public interface DashboardOptionsProperty {
        ...
        public interface Builder {
            /**
             * @param engagementMetrics Specifies the status of your VDM engagement metrics
             *   collection. Can be one of the following:.
             * * `ENABLED` – Amazon SES enables engagement metrics for the configuration set.
             * * `DISABLED` – Amazon SES disables engagement metrics for the configuration set.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DashboardOptionsProperty
            ): software.amazon.awscdk.services.ses.CfnConfigurationSet.DashboardOptionsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SendingOptionsProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SendingOptionsProperty
            ): software.amazon.awscdk.services.ses.CfnConfigurationSet.SendingOptionsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SuppressionOptionsProperty {
         ...
         */
        public fun suppressedReasons(): List<String> =
            unwrap(this).getSuppressedReasons() ?: emptyList()
        ...
        public interface Builder {
             ...
             *   automatically added to the suppression list for your account. This list can contain
             *   any or all of the following:
             * * `COMPLAINT` – Amazon SES adds an email address to the suppression list for your
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ses-configurationset-suppressionoptions.html#cfn-ses-configurationset-suppressionoptions-suppressedreasons)
             */
            override fun suppressedReasons(): List<String> =
                unwrap(this).getSuppressedReasons() ?: emptyList()
        }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SuppressionOptionsProperty
            ): software.amazon.awscdk.services.ses.CfnConfigurationSet.SuppressionOptionsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface TrackingOptionsProperty {
        ...
        public interface Builder {
            /**
             * @param customRedirectDomain The custom subdomain that is used to redirect email
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TrackingOptionsProperty
            ): software.amazon.awscdk.services.ses.CfnConfigurationSet.TrackingOptionsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ReputationOptionsProperty {
        ...
        public interface Builder {
            /**
             * @param reputationMetricsEnabled Describes whether or not Amazon SES publishes
             *   reputation metrics for the configuration set, such as bounce and complaint rates,
             *   to Amazon CloudWatch. If the value is `true` , reputation metrics are published. If
             *   the value is `false` , reputation metrics are not published. The default value is
             *   `false` .
             */
        ...
        private class BuilderImpl : Builder {
            ...
            override fun reputationMetricsEnabled(reputationMetricsEnabled: IResolvable) {
                cdkBuilder.reputationMetricsEnabled(
                    reputationMetricsEnabled.let(IResolvable::unwrap)
                )
            }
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ses-configurationset-reputationoptions.html#cfn-ses-configurationset-reputationoptions-reputationmetricsenabled)
             */
            override fun reputationMetricsEnabled(): Any? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ReputationOptionsProperty
            ): software.amazon.awscdk.services.ses.CfnConfigurationSet.ReputationOptionsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
