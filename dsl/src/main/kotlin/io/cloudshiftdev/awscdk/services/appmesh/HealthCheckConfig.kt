...
public interface HealthCheckConfig {
    ...
    public fun virtualGatewayHealthCheck():
        ...
        unwrap(this)
            ...
            ?.let(CfnVirtualGateway.VirtualGatewayHealthCheckPolicyProperty::wrap)
    ...
    public interface Builder {
        ...
        public fun virtualNodeHealthCheck(
            virtualNodeHealthCheck: CfnVirtualNode.HealthCheckProperty.Builder.() -> Unit
        )
    }
    ...
    private class BuilderImpl : Builder {
        ...
        override fun virtualGatewayHealthCheck(
            ...
            cdkBuilder.virtualGatewayHealthCheck(
                virtualGatewayHealthCheck.let(
                    CfnVirtualGateway.VirtualGatewayHealthCheckPolicyProperty::unwrap
                )
            )
        }
        ...
        /** @param virtualNodeHealthCheck VirtualNode CFN configuration for Health Checks. */
        override fun virtualNodeHealthCheck(
            virtualNodeHealthCheck: CfnVirtualNode.HealthCheckProperty
        ) {
            cdkBuilder.virtualNodeHealthCheck(
                virtualNodeHealthCheck.let(CfnVirtualNode.HealthCheckProperty::unwrap)
            )
        }
