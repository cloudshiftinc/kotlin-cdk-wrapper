...
public enum class EncryptionOption(
    ...
    public companion object {
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.EncryptionOption
        ): EncryptionOption =
            when (cdkObject) {
                ...
                software.amazon.awscdk.services.stepfunctions.tasks.EncryptionOption
                    .CLIENT_SIDE_KMS -> EncryptionOption.CLIENT_SIDE_KMS
            }

        internal fun unwrap(
            wrapped: EncryptionOption
