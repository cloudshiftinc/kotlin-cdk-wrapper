...
internal constructor(
    ...
    public override fun addToResourcePolicy(
        ...
        unwrap(this)
            .addToResourcePolicy(statement.let(PolicyStatement::unwrap), allowNoOp)
            .let(AddToResourcePolicyResult::wrap)

    /**
     * Grant the indicated permissions on this key to the given principal.
     *
     * This modifies both the principal's policy as well as the resource policy, since the default
     * CloudFormation setup for KMS keys is that the policy must not be empty and so default grants
     * won't work.
     *
     * @param grantee
     * @param actions
    ...
    public interface Builder {
         ...
         *
         * Key administrators have permissions to manage the key (e.g., change permissions, revoke),
         * but do not have permissions to use the key in cryptographic operations (e.g., encrypt,
         * decrypt).
         *
         ...
         *
         * IMPORTANT: If you change this property of an existing key, the existing key is scheduled
         * for deletion and a new key is created with the specified value.
         *
         * Default: KeySpec.SYMMETRIC_DEFAULT
         *
         * @param keySpec The cryptographic configuration of the key. The valid value depends on
         *   usage of the key.
         */
        ...
        /**
         * Specifies the number of days in the waiting period before AWS KMS deletes a CMK that has
         * been removed from a CloudFormation stack.
         *
         * When you remove a customer master key (CMK) from a CloudFormation stack, AWS KMS
         * schedules the CMK for deletion and starts the mandatory waiting period. The
         * PendingWindowInDays property determines the length of waiting period. During the waiting
         * period, the key state of CMK is Pending Deletion, which prevents the CMK from being used
         * in cryptographic operations. When the waiting period expires, AWS KMS permanently deletes
         * the CMK.
         *
         ...
         *
         * NOTE - If the `&#64;aws-cdk/aws-kms:defaultKeyPolicies` feature flag is set (the default
         * for new projects), this policy will *override* the default key policy and become the only
         * key policy for the key. If the feature flag is not set, this policy will be appended to
         * the default key policy.
         *
         * Default: - A policy document with permissions for the account root to administer the key
         * will be created.
         *
         ...
         *
         * This is useful when one wants to retain access to data that was encrypted with a key that
         * is being retired.
         *
         * Default: RemovalPolicy.Retain
         *
         * @param removalPolicy Whether the encryption key should be retained when it is removed
         *   from the Stack.
         */
    ...
    public companion object {
        public fun fromCfnKey(cfnKey: CfnKey): IKey =
            software.amazon.awscdk.services.kms.Key.fromCfnKey(cfnKey.let(CfnKey::unwrap))
                .let(IKey::wrap)
        ...
        public fun fromKeyArn(
            ...
            software.amazon.awscdk.services.kms.Key.fromKeyArn(
        ...
        public fun fromLookup(
            ...
            software.amazon.awscdk.services.kms.Key.fromLookup(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    options.let(KeyLookupOptions::unwrap)
                )
                .let(IKey::wrap)
        ...
        internal fun unwrap(wrapped: Key): software.amazon.awscdk.services.kms.Key =
            wrapped.cdkObject
    }
}
