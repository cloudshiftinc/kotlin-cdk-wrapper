...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param pricingPlan When you use AWS CloudFormation , you can create only on-demand
         *   queues.
         */
         ...
         * Initial state of the queue.
         *
         * Queues can be either ACTIVE or PAUSED. If you create a paused queue, then jobs that you
         * send to that queue won't begin.
         *
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.mediaconvert.CfnQueue =
            cdkBuilder.build()
    }
    ...
    public companion object {
        ...
        ): CfnQueue = CfnQueue(cdkObject)

        internal fun unwrap(
            wrapped: CfnQueue
        ): software.amazon.awscdk.services.mediaconvert.CfnQueue = wrapped.cdkObject
    }
}
