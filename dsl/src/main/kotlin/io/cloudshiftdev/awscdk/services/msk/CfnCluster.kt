...
internal constructor(
    ...
    public open fun brokerNodeGroupInfo(
        `value`: BrokerNodeGroupInfoProperty.Builder.() -> Unit
    ): Unit = brokerNodeGroupInfo(BrokerNodeGroupInfoProperty(`value`))
    ...
    public open fun clientAuthentication(
        `value`: ClientAuthenticationProperty.Builder.() -> Unit
    ...
    public interface Builder {
        ...
        public fun brokerNodeGroupInfo(
            brokerNodeGroupInfo: BrokerNodeGroupInfoProperty.Builder.() -> Unit
        )
        ...
        public fun clientAuthentication(
            clientAuthentication: ClientAuthenticationProperty.Builder.() -> Unit
        )
        ...
        public fun configurationInfo(
            configurationInfo: ConfigurationInfoProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
        ...
        override fun brokerNodeGroupInfo(brokerNodeGroupInfo: BrokerNodeGroupInfoProperty) {
            cdkBuilder.brokerNodeGroupInfo(
                brokerNodeGroupInfo.let(BrokerNodeGroupInfoProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("61ad7de6319342519a3c1d5709ea2dd2cd0a7ca9f7ee3b5bb8f1e1d709ab7ec7")
        override fun brokerNodeGroupInfo(
            brokerNodeGroupInfo: BrokerNodeGroupInfoProperty.Builder.() -> Unit
        ...
        override fun clientAuthentication(clientAuthentication: ClientAuthenticationProperty) {
            cdkBuilder.clientAuthentication(
                clientAuthentication.let(ClientAuthenticationProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("03a15325d3f00abc56619850e839d374872995e53db76160e9cfd6a13842a014")
        override fun configurationInfo(
            configurationInfo: ConfigurationInfoProperty.Builder.() -> Unit
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("f3fdb09acff026972fdfc983e70307d7b654758bf6624a536e6fc64e6bd49810")
        override fun encryptionInfo(
            encryptionInfo: EncryptionInfoProperty.Builder.() -> Unit
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("dfb8e468253cc86a8dbad997c1624bae69c363d28d7aeb6903324f1029add53e")
        override fun openMonitoring(
            openMonitoring: OpenMonitoringProperty.Builder.() -> Unit
    ...
    public interface EncryptionInTransitProperty {
        ...
        public interface Builder {
            /**
             * @param clientBroker Indicates the encryption setting for data in transit between
             *   clients and brokers. You must set it to one of the following values.
             *
             * `TLS` means that client-broker communication is enabled with TLS only.
             *
            ...
            /**
             * @param inCluster When set to true, it indicates that data communication among the
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: EncryptionInTransitProperty
            ): software.amazon.awscdk.services.msk.CfnCluster.EncryptionInTransitProperty =
    ...
    public interface PublicAccessProperty {
        ...
        public interface Builder {
            /**
             * @param type DISABLED means that public access is turned off. SERVICE_PROVIDED_EIPS
             *   means that public access is turned on.
             */
    ...
    public interface VpcConnectivityProperty {
        ...
        public interface Builder {
            ...
            public fun clientAuthentication(
                clientAuthentication: VpcConnectivityClientAuthenticationProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun clientAuthentication(
                ...
                cdkBuilder.clientAuthentication(
                    clientAuthentication.let(VpcConnectivityClientAuthenticationProperty::unwrap)
                )
            }
            ...
            override fun clientAuthentication(
                ...
                clientAuthentication(
                    VpcConnectivityClientAuthenticationProperty(clientAuthentication)
                )
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: VpcConnectivityProperty
            ): software.amazon.awscdk.services.msk.CfnCluster.VpcConnectivityProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface VpcConnectivityClientAuthenticationProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: VpcConnectivityClientAuthenticationProperty
            ): software.amazon.awscdk.services.msk.CfnCluster.VpcConnectivityClientAuthenticationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface PrometheusProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param nodeExporter Indicates whether you want to enable or disable the Node
             *   Exporter.
             */
    ...
    public interface ConnectivityInfoProperty {
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("7ca41c7a838de77bd0fa0a604512e42a1b2e929eec389c095805c30bf57f92ae")
            override fun vpcConnectivity(
                vpcConnectivity: VpcConnectivityProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ConnectivityInfoProperty
            ): software.amazon.awscdk.services.msk.CfnCluster.ConnectivityInfoProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface EncryptionAtRestProperty {
        ...
        public interface Builder {
             ...
             *   encrypting data at rest. If you don't specify a KMS key, MSK creates one for you
             *   and uses it.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: EncryptionAtRestProperty
            ): software.amazon.awscdk.services.msk.CfnCluster.EncryptionAtRestProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface EncryptionInfoProperty {
        ...
        public interface Builder {
            ...
            public fun encryptionAtRest(
                encryptionAtRest: EncryptionAtRestProperty.Builder.() -> Unit
            )
            ...
            public fun encryptionInTransit(
                encryptionInTransit: EncryptionInTransitProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun encryptionInTransit(encryptionInTransit: EncryptionInTransitProperty) {
                cdkBuilder.encryptionInTransit(
                    encryptionInTransit.let(EncryptionInTransitProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("39a78f0d61fc52ce561187da89d622589f184acb6bbdb8065391a2ede2823020")
            override fun encryptionInTransit(
                encryptionInTransit: EncryptionInTransitProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: EncryptionInfoProperty
            ): software.amazon.awscdk.services.msk.CfnCluster.EncryptionInfoProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface OpenMonitoringProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: OpenMonitoringProperty
            ): software.amazon.awscdk.services.msk.CfnCluster.OpenMonitoringProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface FirehoseProperty {
        ...
        public interface Builder {
            /**
             * @param deliveryStream The Kinesis Data Firehose delivery stream that is the
    ...
    public interface VpcConnectivitySaslProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: VpcConnectivitySaslProperty
            ): software.amazon.awscdk.services.msk.CfnCluster.VpcConnectivitySaslProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CloudWatchLogsProperty {
        ...
        public interface Builder {
            /**
             * @param enabled Specifies whether broker logs get sent to the specified CloudWatch
             *   Logs destination.
             */
            public fun enabled(enabled: Boolean)
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CloudWatchLogsProperty
            ): software.amazon.awscdk.services.msk.CfnCluster.CloudWatchLogsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ProvisionedThroughputProperty {
        ...
        /**
         * Throughput value of the EBS volumes for the data drive on each kafka broker node in MiB
         * per second.
         *
        ...
        public interface Builder {
            ...
            /**
             * @param volumeThroughput Throughput value of the EBS volumes for the data drive on
             *   each kafka broker node in MiB per second.
             */
    ...
    public interface ClientAuthenticationProperty {
        ...
        public interface Builder {
            /**
             * @param sasl Details for client authentication using SASL. To turn on SASL, you must
             *   also turn on `EncryptionInTransit` by setting `inCluster` to true. You must set
             *   `clientBroker` to either `TLS` or `TLS_PLAINTEXT` . If you choose `TLS_PLAINTEXT` ,
            ...
            /**
             * @param tls Details for ClientAuthentication using TLS. To turn on TLS access control,
             *   you must also turn on `EncryptionInTransit` by setting `inCluster` to true and
             *   `clientBroker` to `TLS` .
             */
            public fun tls(tls: IResolvable)
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("713c425e8307846c7f9d89f7971c7cab5fd866d3111c9ded45af6da17f6b2b36")
            override fun sasl(sasl: SaslProperty.Builder.() -> Unit): Unit =
            ...
            override fun unauthenticated(
                unauthenticated: UnauthenticatedProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * Details for client authentication using SASL.
             *
             * To turn on SASL, you must also turn on `EncryptionInTransit` by setting `inCluster`
             * to true. You must set `clientBroker` to either `TLS` or `TLS_PLAINTEXT` . If you
             * choose `TLS_PLAINTEXT` , then you must also set `unauthenticated` to true.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-msk-cluster-clientauthentication.html#cfn-msk-cluster-clientauthentication-sasl)
             */
            override fun sasl(): Any? = unwrap(this).getSasl()
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ClientAuthenticationProperty
            ): software.amazon.awscdk.services.msk.CfnCluster.ClientAuthenticationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface NodeExporterProperty {
        ...
        public interface Builder {
            /**
             * @param enabledInBroker Indicates whether you want to enable or disable the Node
             *   Exporter.
             */
    ...
    public interface ConfigurationInfoProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ConfigurationInfoProperty
            ): software.amazon.awscdk.services.msk.CfnCluster.ConfigurationInfoProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface TlsProperty {
        ...
        public interface Builder {
            /**
             * @param certificateAuthorityArnList List of AWS Private CA Amazon Resource Name
             *   (ARN)s.
             */
        ...
        private class BuilderImpl : Builder {
             ...
             *   (ARN)s.
             */
            override fun certificateAuthorityArnList(
                vararg certificateAuthorityArnList: String
            ): Unit = certificateAuthorityArnList(certificateAuthorityArnList.toList())
    ...
    public interface EBSStorageInfoProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param volumeSize The size in GiB of the EBS volume for the data drive on each broker
             *   node.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: EBSStorageInfoProperty
            ): software.amazon.awscdk.services.msk.CfnCluster.EBSStorageInfoProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface VpcConnectivityIamProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: VpcConnectivityIamProperty
            ): software.amazon.awscdk.services.msk.CfnCluster.VpcConnectivityIamProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface UnauthenticatedProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: UnauthenticatedProperty
            ): software.amazon.awscdk.services.msk.CfnCluster.UnauthenticatedProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface VpcConnectivityTlsProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: VpcConnectivityTlsProperty
            ): software.amazon.awscdk.services.msk.CfnCluster.VpcConnectivityTlsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface BrokerNodeGroupInfoProperty {
         ...
         * subnets that you specify must be in distinct Availability Zones. When you create a
         * cluster, Amazon MSK distributes the broker nodes evenly across the subnets that you
         * specify.
         *
         ...
         * kafka.m5.2xlarge, kafka.m5.4xlarge, kafka.m5.8xlarge, kafka.m5.12xlarge,
         * kafka.m5.16xlarge, kafka.m5.24xlarge, and kafka.t3.small.
         *
         ...
         * associated with the VPC. If you specify security groups that were shared with you, you
         * must ensure that you have permissions to them. Specifically, you need the
        ...
        public interface Builder {
            ...
            /**
             * @param clientSubnets The list of subnets to connect to in the client virtual private
             *   cloud (VPC). Amazon creates elastic network interfaces inside these subnets. Client
             *   applications use elastic network interfaces to produce and consume data.
             *
             * If you use the US West (N. California) Region, specify exactly two subnets. For other
             * Regions where Amazon MSK is available, you can specify either two or three subnets.
             * The subnets that you specify must be in distinct Availability Zones. When you create
             * a cluster, Amazon MSK distributes the broker nodes evenly across the subnets that you
             * specify.
             *
             * Client subnets can't occupy the Availability Zone with ID `use1-az3` .
             */
            ...
            public fun connectivityInfo(
                connectivityInfo: ConnectivityInfoProperty.Builder.() -> Unit
            )

            /**
             * @param instanceType The type of Amazon EC2 instances to use for brokers. The
            ...
            /**
             * @param securityGroups The security groups to associate with the elastic network
             *   interfaces in order to specify who can connect to and communicate with the Amazon
             *   MSK cluster. If you don't specify a security group, Amazon MSK uses the default
             *   security group associated with the VPC. If you specify security groups that were
             *   shared with you, you must ensure that you have permissions to them. Specifically,
             *   you need the `ec2:DescribeSecurityGroups` permission.
             */
            ...
            /**
             * @param storageInfo Contains information about storage volumes attached to Amazon MSK
             *   broker nodes.
             */
        ...
        internal constructor(
             ...
             * The list of subnets to connect to in the client virtual private cloud (VPC).
             *
             * Amazon creates elastic network interfaces inside these subnets. Client applications
            ...
            /**
             * The security groups to associate with the elastic network interfaces in order to
             * specify who can connect to and communicate with the Amazon MSK cluster.
             *
             * If you don't specify a security group, Amazon MSK uses the default security group
             * associated with the VPC. If you specify security groups that were shared with you,
             * you must ensure that you have permissions to them. Specifically, you need the
             * `ec2:DescribeSecurityGroups` permission.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-msk-cluster-brokernodegroupinfo.html#cfn-msk-cluster-brokernodegroupinfo-securitygroups)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: BrokerNodeGroupInfoProperty
            ): software.amazon.awscdk.services.msk.CfnCluster.BrokerNodeGroupInfoProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface JmxExporterProperty {
        ...
        public interface Builder {
            /**
             * @param enabledInBroker Indicates whether you want to enable or disable the JMX
             *   Exporter.
             */
            public fun enabledInBroker(enabledInBroker: Boolean)
    ...
    public interface BrokerLogsProperty {
        ...
        private class BuilderImpl : Builder {
            ...
            override fun cloudWatchLogs(
                cloudWatchLogs: CloudWatchLogsProperty.Builder.() -> Unit
        ...
        internal constructor(
            ...
            /**
             * Details of the Kinesis Data Firehose delivery stream that is the destination for
             * broker logs.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-msk-cluster-brokerlogs.html#cfn-msk-cluster-brokerlogs-firehose)
             */
    ...
    public interface StorageInfoProperty {
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("3c96fc46257901e7b2884edaa78a13e0c177649c7d2f5b7f0f04366e35a31b3f")
            override fun ebsStorageInfo(
                ebsStorageInfo: EBSStorageInfoProperty.Builder.() -> Unit
    ...
    public interface VpcConnectivityScramProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: VpcConnectivityScramProperty
            ): software.amazon.awscdk.services.msk.CfnCluster.VpcConnectivityScramProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
