...
internal constructor(
    ...
    public open fun transformEncryption(
        `value`: TransformEncryptionProperty.Builder.() -> Unit
    ): Unit = transformEncryption(TransformEncryptionProperty(`value`))
    ...
    public open fun transformParameters(
        `value`: TransformParametersProperty.Builder.() -> Unit
    ): Unit = transformParameters(TransformParametersProperty(`value`))
    ...
    public interface Builder {
         ...
         * compatible with.
         *
         * Glue 1.0 is recommended for most customers. If the value is not set, the Glue
        ...
        public fun inputRecordTables(
            inputRecordTables: InputRecordTablesProperty.Builder.() -> Unit
        )
         ...
         *   to task runs for this transform.
         */
         ...
         *
         * @param maxRetries The maximum number of times to retry after an `MLTaskRun` of the
         ...
         *
         * @param name A user-defined name for the machine learning transform. Names are required to
         *   be unique. `Name` is optional:.
         */
         ...
         * [AWS Tags in AWS Glue](https://docs.aws.amazon.com/glue/latest/dg/monitor-tags.html) in
         * the developer guide.
         *
        ...
        public fun transformEncryption(
            transformEncryption: TransformEncryptionProperty.Builder.() -> Unit
        )
        ...
        public fun transformParameters(
            transformParameters: TransformParametersProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("fca839ef9d1b62497d77256d22b07512a4a920922f8aa6f37e15f312aaa82c75")
        override fun inputRecordTables(
            inputRecordTables: InputRecordTablesProperty.Builder.() -> Unit
        ...
        override fun transformEncryption(transformEncryption: TransformEncryptionProperty) {
            cdkBuilder.transformEncryption(
                transformEncryption.let(TransformEncryptionProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("7b4c4be7710e625f57455d8cede56a9d6bb04bd35ce28cec13ebb09d79d53e11")
        override fun transformEncryption(
            transformEncryption: TransformEncryptionProperty.Builder.() -> Unit
        ...
        override fun transformParameters(transformParameters: TransformParametersProperty) {
            cdkBuilder.transformParameters(
                transformParameters.let(TransformParametersProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("fed60572c4823d8272124aedabc053c220a64599b0630ba5a3c181911cfd7ec9")
        override fun transformParameters(
            transformParameters: TransformParametersProperty.Builder.() -> Unit
    ...
    public interface TransformEncryptionProperty {
        ...
        public interface Builder {
            /**
             * @param mlUserDataEncryption The encryption-at-rest settings of the transform that
             *   apply to accessing user data.
             */
            ...
            public fun mlUserDataEncryption(
                mlUserDataEncryption: MLUserDataEncryptionProperty.Builder.() -> Unit
            )
        ...
        private class BuilderImpl : Builder {
            ...
            override fun mlUserDataEncryption(mlUserDataEncryption: MLUserDataEncryptionProperty) {
                cdkBuilder.mlUserDataEncryption(
                    mlUserDataEncryption.let(MLUserDataEncryptionProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("6581c0127c03889021bdaa631f1ef422965b6cae92da1772aa113a216c632231")
            override fun mlUserDataEncryption(
                mlUserDataEncryption: MLUserDataEncryptionProperty.Builder.() -> Unit
            ): Unit = mlUserDataEncryption(MLUserDataEncryptionProperty(mlUserDataEncryption))

            /** @param taskRunSecurityConfigurationName The name of the security configuration. */
            override fun taskRunSecurityConfigurationName(
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TransformEncryptionProperty
            ): software.amazon.awscdk.services.glue.CfnMLTransform.TransformEncryptionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface FindMatchesParametersProperty {
         ...
         * substantially higher. A value of 0.0 means a bias purely for cost, which results in a
         * less accurate `FindMatches` transform, sometimes with unacceptable accuracy.
         *
        ...
        public interface Builder {
            /**
             * @param accuracyCostTradeoff The value that is selected when tuning your transform for
             *   a balance between accuracy and cost. A value of 0.5 means that the system balances
             *   accuracy and cost concerns. A value of 1.0 means a bias purely for accuracy, which
             *   typically results in a higher cost, sometimes substantially higher. A value of 0.0
             *   means a bias purely for cost, which results in a less accurate `FindMatches`
            ...
            /**
             * @param enforceProvidedLabels The value to switch on or off to force the output to
             *   match the provided labels from users. If the value is `True` , the `find matches`
             *   transform forces the output to match the provided labels. The results override the
             *   normal conflation results. If the value is `False` , the `find matches` transform
            ...
            /**
             * @param precisionRecallTradeoff The value selected when tuning your transform for a
             *   balance between precision and recall. A value of 0.5 means no preference; a value
             *   of 1.0 means a bias purely for precision, and a value of 0.0 means a bias for
             *   recall. Because this is a tradeoff, choosing values close to 1.0 means very low
        ...
        internal constructor(
             ...
             * and cost.
             *
             * A value of 0.5 means that the system balances accuracy and cost concerns. A value of
             * 1.0 means a bias purely for accuracy, which typically results in a higher cost,
             ...
             * recall.
             *
             * A value of 0.5 means no preference; a value of 1.0 means a bias purely for precision,
             * and a value of 0.0 means a bias for recall. Because this is a tradeoff, choosing
             * values close to 1.0 means very low recall, and choosing values close to 0.0 results
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-glue-mltransform-findmatchesparameters.html#cfn-glue-mltransform-findmatchesparameters-precisionrecalltradeoff)
             */
            override fun precisionRecallTradeoff(): Number? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: FindMatchesParametersProperty
            ): software.amazon.awscdk.services.glue.CfnMLTransform.FindMatchesParametersProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface TransformParametersProperty {
        ...
        public interface Builder {
            ...
            public fun findMatchesParameters(
                findMatchesParameters: FindMatchesParametersProperty.Builder.() -> Unit
            )

            /**
             * @param transformType The type of machine learning transform. `FIND_MATCHES` is the
             *   only option. For information about the types of machine learning transforms, see
             *   [Creating Machine Learning Transforms](https://docs.aws.amazon.com/glue/latest/dg/add-job-machine-learning-transform.html)
             *   .
             */
        ...
        private class BuilderImpl : Builder {
            ...
            /** @param findMatchesParameters The parameters for the find matches algorithm. */
            override fun findMatchesParameters(
                findMatchesParameters: FindMatchesParametersProperty
            ) {
                cdkBuilder.findMatchesParameters(
                    findMatchesParameters.let(FindMatchesParametersProperty::unwrap)
                )
            }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TransformParametersProperty
            ): software.amazon.awscdk.services.glue.CfnMLTransform.TransformParametersProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface MLUserDataEncryptionProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param mlUserDataEncryptionMode The encryption mode applied to user data. Valid
             *   values are:.
             * * DISABLED: encryption is disabled.
             * * SSEKMS: use of server-side encryption with AWS Key Management Service (SSE-KMS) for
             *   user data stored in Amazon S3.
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-glue-mltransform-mluserdataencryption.html#cfn-glue-mltransform-mluserdataencryption-mluserdataencryptionmode)
             */
            override fun mlUserDataEncryptionMode(): String =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: MLUserDataEncryptionProperty
            ): software.amazon.awscdk.services.glue.CfnMLTransform.MLUserDataEncryptionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface InputRecordTablesProperty {
        ...
        public interface Builder {
            /**
             * @param glueTables The database and table in the AWS Glue Data Catalog that is used
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: InputRecordTablesProperty
            ): software.amazon.awscdk.services.glue.CfnMLTransform.InputRecordTablesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
