...
internal constructor(
    ...
    /**
     * The Amazon Resource Name (ARN) of the account that is designated as the management account
    ...
    public interface Builder {
         ...
         *   set, the management account gains access to advanced features that give you more
         *   control over accounts in your organization. By default or if you set the `FeatureSet`
         *   property to `ALL` , the new organization is created with all features enabled and
         *   service control policies automatically enabled in the
         ...
         *   in the *AWS Organizations User Guide* .
         *
         * The consolidated billing feature subset isn't available for organizations in the AWS
         * GovCloud (US) Region.
         *
         * Feature set `ALL` provides the following advanced features:
         * * Apply any
         *   [policy type](https://docs.aws.amazon.com/organizations/latest/userguide/orgs_manage_policies.html#orgs-policy-types)
         *   to any member account in the organization.
         * * Apply [service control policies (SCPs)](https://docs.aws.amazon.com/organizations/latest/userguide/orgs_manage_policies_scps.html)
         *   to member accounts that restrict the services and actions that users (including the
         *   root user) and roles in an account can access. Using SCPs you can prevent member
         *   accounts from leaving the organization.
         * * Enable [integration with supported AWS services](https://docs.aws.amazon.com/organizations/latest/userguide/orgs_integrate_services_list.html)
         *   to let those services provide functionality across all of the accounts in your
         *   organization.
         *
