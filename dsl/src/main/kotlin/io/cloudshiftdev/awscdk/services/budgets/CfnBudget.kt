...
internal constructor(
    ...
    public interface Builder {
         ...
         * subscriber and up to 10 email subscribers. If you include notifications and subscribers
         * in your `CreateBudget` call, AWS creates the notifications and subscribers for you.
         *
         ...
         *
         * @param notificationsWithSubscribers A notification that you want to associate with a
         *   budget.
         */
    ...
    private class BuilderImpl(
        ...
        override fun notificationsWithSubscribers(notificationsWithSubscribers: IResolvable) {
            cdkBuilder.notificationsWithSubscribers(
                notificationsWithSubscribers.let(IResolvable::unwrap)
            )
        }
    ...
    public interface BudgetDataProperty {
         ...
         * default to `100` . This is the only valid value for RI or Savings Plans utilization or
         ...
         *
         * The period has a start date and an end date. The start date must come before the end
         ...
         * ANNUALLY). For example, if you create your budget on January 24, 2019, choose `MONTHLY` ,
         * and don't set a start date, the start date defaults to `01/01/19 00:00 UTC` . The
        ...
        public interface Builder {
            ...
            /**
             * @param budgetLimit The total amount of cost, usage, RI utilization, RI coverage,
             *   Savings Plans utilization, or Savings Plans coverage that you want to track with
             *   your budget. `BudgetLimit` is required for cost or usage budgets, but optional for
             *   RI or Savings Plans utilization or coverage budgets. RI and Savings Plans
             *   utilization or coverage budgets default to `100` . This is the only valid value for
            ...
            /**
             * @param budgetName The name of a budget. The value must be unique within an account.
             *   `BudgetName` can't include `:` and `\` characters. If you don't include value for
             *   `BudgetName` in the template, Billing and Cost Management assigns your budget a
             *   randomly generated name.
             */
            public fun budgetName(budgetName: String)

            /**
             * @param budgetType Specifies whether this budget tracks costs, usage, RI utilization,
             *   RI coverage, Savings Plans utilization, or Savings Plans coverage.
             */
            public fun budgetType(budgetType: String)

            /**
             * @param costFilters The cost filters, such as `Region` , `Service` , `LinkedAccount` ,
             *   `Tag` , or `CostCategory` , that are applied to a budget. AWS Budgets supports the
            ...
            /**
             * @param costTypes The types of costs that are included in this `COST` budget. `USAGE`
            ...
            /**
             * @param plannedBudgetLimits A map containing multiple `BudgetLimit` , including
             *   current or future limits. `PlannedBudgetLimits` is available for cost or usage
             *   budget and supports both monthly and quarterly `TimeUnit` .
             *
             * For monthly budgets, provide 12 months of `PlannedBudgetLimits` values. This must
             * start from the current month and include the next 11 months. The `key` is the start
             * of the month, `UTC` in epoch seconds.
             *
             * For quarterly budgets, provide four quarters of `PlannedBudgetLimits` value entries
             * in standard calendar quarter increments. This must start from the current quarter and
             * include the next three quarters. The `key` is the start of the quarter, `UTC` in
             * epoch seconds.
             *
             * If the planned budget expires before 12 months for monthly or four quarters for
             * quarterly, provide the `PlannedBudgetLimits` values only for the remaining periods.
            ...
            /**
             * @param timePeriod The period of time that is covered by a budget. The period has a
             *   start date and an end date. The start date must come before the end date. There are
             *   no restrictions on the end date.
             *
             * The start date for a budget. If you created your budget and didn't specify a start
             * date, the start date defaults to the start of the chosen time period (MONTHLY,
             * QUARTERLY, or ANNUALLY). For example, if you create your budget on January 24, 2019,
             * choose `MONTHLY` , and don't set a start date, the start date defaults to `01/01/19
            ...
            /**
             * @param timeUnit The length of time until a budget resets the actual and forecasted
             *   spend. `DAILY` is available only for `RI_UTILIZATION` and `RI_COVERAGE` budgets.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("88da46d360439fbdd476f26c072bc4756180ee7bf65db6f45bcaf700dd1a5cc2")
            override fun autoAdjustData(
                autoAdjustData: AutoAdjustDataProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             *
             * The value must be unique within an account. `BudgetName` can't include `:` and `\`
             * characters. If you don't include value for `BudgetName` in the template, Billing and
             * Cost Management assigns your budget a randomly generated name.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-budgets-budget-budgetdata.html#cfn-budgets-budget-budgetdata-budgetname)
             */
    ...
    public interface AutoAdjustDataProperty {
        ...
        public interface Builder {
            /**
             * @param autoAdjustType The string that defines whether your budget auto-adjusts based
             *   on historical or forecasted data.
             */
            public fun autoAdjustType(autoAdjustType: String)

            /**
             * @param historicalOptions The parameters that define or describe the historical data
            ...
            public fun historicalOptions(
                historicalOptions: HistoricalOptionsProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun historicalOptions(historicalOptions: HistoricalOptionsProperty) {
                cdkBuilder.historicalOptions(
                    historicalOptions.let(HistoricalOptionsProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("5eceb443e67551a23c0248352444c86100f311f34ebddb20ea68d14d5ad8abaf")
            override fun historicalOptions(
                historicalOptions: HistoricalOptionsProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AutoAdjustDataProperty
            ): software.amazon.awscdk.services.budgets.CfnBudget.AutoAdjustDataProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface TimePeriodProperty {
         ...
         *
         * If you created your budget and didn't specify a start date, the start date defaults to
         * the start of the chosen time period (MONTHLY, QUARTERLY, or ANNUALLY). For example, if
         * you create your budget on January 24, 2019, choose `MONTHLY` , and don't set a start
         * date, the start date defaults to `01/01/19 00:00 UTC` . The defaults are the same for the
        ...
        public interface Builder {
            /**
             * @param end The end date for a budget. If you didn't specify an end date, AWS set your
            ...
            /**
             * @param start The start date for a budget. If you created your budget and didn't
             *   specify a start date, the start date defaults to the start of the chosen time
             *   period (MONTHLY, QUARTERLY, or ANNUALLY). For example, if you create your budget on
             *   January 24, 2019, choose `MONTHLY` , and don't set a start date, the start date
             *   defaults to `01/01/19 00:00 UTC` . The defaults are the same for the AWS Billing
             *   and Cost Management console and the API.
             *
             * You can change your start date with the `UpdateBudget` operation.
             *
             * Valid values depend on the value of `BudgetType` :
             * * If `BudgetType` is `COST` or `USAGE` : Valid values are `MONTHLY` , `QUARTERLY` ,
             *   and `ANNUALLY` .
             * * If `BudgetType` is `RI_UTILIZATION` or `RI_COVERAGE` : Valid values are `DAILY` ,
             *   `MONTHLY` , `QUARTERLY` , and `ANNUALLY` .
             */
        ...
        internal constructor(
             ...
             * The start date for a budget.
             *
             * If you created your budget and didn't specify a start date, the start date defaults
             * to the start of the chosen time period (MONTHLY, QUARTERLY, or ANNUALLY). For
             * example, if you create your budget on January 24, 2019, choose `MONTHLY` , and don't
             * set a start date, the start date defaults to `01/01/19 00:00 UTC` . The defaults are
    ...
    public interface SpendProperty {
        ...
        public interface Builder {
            /**
             * @param amount The cost or usage amount that's associated with a budget forecast,
             *   actual spend, or budget threshold.
             */
            public fun amount(amount: Number)

            /**
             * @param unit The unit of measurement that's used for the budget forecast, actual
    ...
    public interface HistoricalOptionsProperty {
        ...
        public interface Builder {
            /**
             * @param budgetAdjustmentPeriod The number of budget periods included in the
             *   moving-average calculation that determines your auto-adjusted budget amount. The
        ...
        internal constructor(
             ...
             * determines your auto-adjusted budget amount.
             *
             * The maximum value depends on the `TimeUnit` granularity of the budget:
             * * For the `DAILY` granularity, the maximum value is `60` .
             * * For the `MONTHLY` granularity, the maximum value is `12` .
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: HistoricalOptionsProperty
            ): software.amazon.awscdk.services.budgets.CfnBudget.HistoricalOptionsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SubscriberProperty {
        ...
        public interface Builder {
            /**
             * @param address The address that AWS sends budget notifications to, either an SNS
             *   topic or an email. When you create a subscriber, the value of `Address` can't
             *   contain line breaks.
             */
    ...
    public interface NotificationWithSubscribersProperty {
        ...
        private class BuilderImpl : Builder {
            ...
            /** @param subscribers A list of subscribers who are subscribed to this notification. */
            override fun subscribers(vararg subscribers: Any): Unit =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: NotificationWithSubscribersProperty
            ): software.amazon.awscdk.services.budgets.CfnBudget.NotificationWithSubscribersProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface NotificationProperty {
         ...
         * 50% - 200% of the budgeted amount. The maximum limit for your threshold is 1,000,000%
         ...
         *
         * For `ABSOLUTE_VALUE` thresholds, AWS notifies you when you go over or are forecasted to
         * go over your total cost threshold. For `PERCENTAGE` thresholds, AWS notifies you when you
         * go over or are forecasted to go over a certain percentage of your forecasted spend. For
         * example, if you have a budget for 200 dollars and you have a `PERCENTAGE` threshold of
        ...
        public interface Builder {
            ...
            /**
             * @param notificationType Specifies whether the notification is for how much you have
             *   spent ( `ACTUAL` ) or for how much that you're forecasted to spend ( `FORECASTED`
             *   ).
             */
            public fun notificationType(notificationType: String)

            /**
             * @param threshold The threshold that's associated with a notification. Thresholds are
             *   always a percentage, and many customers find value being alerted between 50% - 200%
             *   of the budgeted amount. The maximum limit for your threshold is 1,000,000% above
             *   the budgeted amount.
             */
             ...
             *   total cost threshold. For `PERCENTAGE` thresholds, AWS notifies you when you go
             *   over or are forecasted to go over a certain percentage of your forecasted spend.
        ...
        internal constructor(
            ...
            /**
             * Specifies whether the notification is for how much you have spent ( `ACTUAL` ) or for
             * how much that you're forecasted to spend ( `FORECASTED` ).
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-budgets-budget-notification.html#cfn-budgets-budget-notification-notificationtype)
             */
             ...
             * The threshold that's associated with a notification.
             *
             * Thresholds are always a percentage, and many customers find value being alerted
             * between 50% - 200% of the budgeted amount. The maximum limit for your threshold is
             ...
             * The type of threshold for a notification.
             *
             * For `ABSOLUTE_VALUE` thresholds, AWS notifies you when you go over or are forecasted
             * to go over your total cost threshold. For `PERCENTAGE` thresholds, AWS notifies you
             * when you go over or are forecasted to go over a certain percentage of your forecasted
             * spend. For example, if you have a budget for 200 dollars and you have a `PERCENTAGE`
             * threshold of 80%, AWS notifies you when you go over 160 dollars.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-budgets-budget-notification.html#cfn-budgets-budget-notification-thresholdtype)
             */
    ...
    public interface CostTypesProperty {
        ...
        public interface Builder {
            /**
             * @param includeCredit Specifies whether a budget includes credits. The default value
             *   is `true` .
             */
            ...
            /**
             * @param includeDiscount Specifies whether a budget includes discounts. The default
             *   value is `true` .
             */
            ...
            /**
             * @param includeOtherSubscription Specifies whether a budget includes non-RI
             *   subscription costs. The default value is `true` .
             */
            ...
            /**
             * @param includeRecurring Specifies whether a budget includes recurring fees such as
             *   monthly RI fees. The default value is `true` .
             */
            ...
            /**
             * @param includeRefund Specifies whether a budget includes refunds. The default value
             *   is `true` .
             */
            ...
            /**
             * @param includeSubscription Specifies whether a budget includes subscriptions. The
            ...
            /**
             * @param includeTax Specifies whether a budget includes taxes. The default value is
             *   `true` .
             */
            ...
            /**
             * @param includeUpfront Specifies whether a budget includes upfront RI costs. The
             *   default value is `true` .
             */
            ...
            /**
             * @param useAmortized Specifies whether a budget uses the amortized rate. The default
             *   value is `false` .
             */
            ...
            /**
             * @param useBlended Specifies whether a budget uses a blended rate. The default value
             *   is `false` .
             */
        ...
        private class BuilderImpl : Builder {
            ...
            override fun includeOtherSubscription(includeOtherSubscription: IResolvable) {
                cdkBuilder.includeOtherSubscription(
                    includeOtherSubscription.let(IResolvable::unwrap)
                )
            }
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-budgets-budget-costtypes.html#cfn-budgets-budget-costtypes-includeothersubscription)
             */
            override fun includeOtherSubscription(): Any? =
