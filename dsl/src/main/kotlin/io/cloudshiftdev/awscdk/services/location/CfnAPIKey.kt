...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * This action is irreversible. Only use ForceDelete if you are certain the key is no longer
         * in use.
         *
         ...
         *
         * @param forceDelete ForceDelete bypasses an API key's expiry conditions and deletes the
         *   key.
         */
         ...
         * days. `False` if force update is not preferred.
         *
         ...
         * Applies one or more tags to the map resource.
         *
         * A tag is a key-value pair that helps manage, identify, search, and filter your resources
         * by labelling them.
         *
    ...
    private class BuilderImpl(
        ...
        override fun restrictions(
            restrictions: ApiKeyRestrictionsProperty.Builder.() -> Unit
    ...
    public companion object {
        ...
        ): CfnAPIKey = CfnAPIKey(cdkObject)

        internal fun unwrap(
            wrapped: CfnAPIKey
        ): software.amazon.awscdk.services.location.CfnAPIKey = wrapped.cdkObject
    }
    ...
    public interface ApiKeyRestrictionsProperty {
         ...
         * only valid action is `geo:GetMap*` as an input to the list. `["geo:GetMap*"]` is valid
         * but `["geo:GetMapTile"]` is not. Similarly, you cannot use
         ...
         * * The ARN must be the correct ARN for a map, place, or route ARN. You may include
         *   wildcards in the resource-id to match multiple resources of the same type.
        ...
        public interface Builder {
            /**
             * @param allowActions A list of allowed actions that an API key resource grants
             *   permissions to perform. You must have at least one action for each type of
             *   resource. For example, if you have a place resource, you must include at least one
             *   place action.
             *
             * The following are valid values for the actions.
             * * *Map actions*
             ...
             * the only valid action is `geo:GetMap*` as an input to the list. `["geo:GetMap*"]` is
             * valid but `["geo:GetMapTile"]` is not. Similarly, you cannot use
             * `["geo:SearchPlaceIndexFor*"]` - you must list each of the Place actions separately.
             */
            ...
            /**
             * @param allowReferers An optional list of allowed HTTP referers for which requests
             *   must originate from. Requests using this API key from other domains will not be
             *   allowed.
             *
             * Requirements:
             * * Contain only alphanumeric characters (A–Z, a–z, 0–9) or any symbols in this list
            ...
            /**
             * @param allowResources A list of allowed resource ARNs that a API key bearer can
             *   perform actions on.
             * * The ARN must be the correct ARN for a map, place, or route ARN. You may include
             *   wildcards in the resource-id to match multiple resources of the same type.
             ...
             *   colons (:).
             * * No spaces allowed, even with wildcards. For example, `arn:aws:geo:region:
             *   *account-id* :map/ExampleMap*` .
             *
             * For more information about ARN format, see
             * [Amazon Resource Names (ARNs)](https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html)
             * .
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-location-apikey-apikeyrestrictions.html#cfn-location-apikey-apikeyrestrictions-allowreferers)
             */
            override fun allowReferers(): List<String> =
                unwrap(this).getAllowReferers() ?: emptyList()
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ApiKeyRestrictionsProperty
            ): software.amazon.awscdk.services.location.CfnAPIKey.ApiKeyRestrictionsProperty =
