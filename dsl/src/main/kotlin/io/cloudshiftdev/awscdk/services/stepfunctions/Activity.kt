...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.stepfunctions.Activity,
     ...
     * @param props
     */
    public open fun metricScheduleTime(): Metric =
        unwrap(this).metricScheduleTime().let(Metric::wrap)
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.stepfunctions.Activity =
            cdkBuilder.build()
    }
    ...
    public companion object {
        public fun fromActivityArn(
            ...
            software.amazon.awscdk.services.stepfunctions.Activity.fromActivityArn(
        ...
        public fun fromActivityName(
            ...
            software.amazon.awscdk.services.stepfunctions.Activity.fromActivityName(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    activityName
                )
        ...
        ): Activity = Activity(cdkObject)

        internal fun unwrap(
            wrapped: Activity
        ): software.amazon.awscdk.services.stepfunctions.Activity = wrapped.cdkObject
    }
}
