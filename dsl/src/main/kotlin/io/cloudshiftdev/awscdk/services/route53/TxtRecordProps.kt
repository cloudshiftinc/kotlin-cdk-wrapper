...
public interface TxtRecordProps : RecordSetOptions {
  /**
   * The text values.
   */
  ...
  private class BuilderImpl : Builder {
    ...
    public fun build(): software.amazon.awscdk.services.route53.TxtRecordProps = cdkBuilder.build()
  }
