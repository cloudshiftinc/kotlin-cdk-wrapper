...
internal constructor(
    ...
    public open fun availabilityZones(): List<String> =
        unwrap(this).getAvailabilityZones() ?: emptyList()
    ...
    public open fun instanceMaintenancePolicy(`value`: InstanceMaintenancePolicyProperty) {
        unwrap(this)
            .setInstanceMaintenancePolicy(`value`.let(InstanceMaintenancePolicyProperty::unwrap))
    }

    /** An instance maintenance policy. */
    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("f5589b948c6edc939d9b439b9912d34e4ae4c3d6ccafb514dc9cd40139931f49")
    public open fun instanceMaintenancePolicy(
        `value`: InstanceMaintenancePolicyProperty.Builder.() -> Unit
    ...
    public open fun launchTemplate(
        `value`: LaunchTemplateSpecificationProperty.Builder.() -> Unit
    ...
    public open fun loadBalancerNames(): List<String> =
        unwrap(this).getLoadBalancerNames() ?: emptyList()
    ...
    public open fun mixedInstancesPolicy(
        `value`: MixedInstancesPolicyProperty.Builder.() -> Unit
    ...
    public open fun notificationConfigurations(): Any? =
        unwrap(this).getNotificationConfigurations()
     ...
     */
    public open fun targetGroupArns(): List<String> =
        unwrap(this).getTargetGroupArns() ?: emptyList()
     ...
     * the Auto Scaling group.
     */
    public open fun targetGroupArns(vararg `value`: String): Unit =
        targetGroupArns(`value`.toList())

    /** A policy or a list of policies that are used to select the instance to terminate. */
    public open fun terminationPolicies(): List<String> =
        unwrap(this).getTerminationPolicies() ?: emptyList()
     ...
     */
    public open fun vpcZoneIdentifier(): List<String> =
        unwrap(this).getVpcZoneIdentifier() ?: emptyList()
    ...
    public interface Builder {
         ...
         *
         * @param autoScalingGroupName The name of the Auto Scaling group. This name must be unique
         ...
         * Indicates whether Capacity Rebalancing is enabled.
         *
         * Otherwise, Capacity Rebalancing is disabled. When you turn on Capacity Rebalancing,
         * Amazon EC2 Auto Scaling attempts to launch a Spot Instance whenever Amazon EC2 notifies
         * that a Spot Instance is at an elevated risk of interruption. After launching a new
         * instance, it then terminates an old instance. For more information, see
         ...
         * Scaling also waits for the warm-up period before aggregating the metrics for new
         ...
         * default instance warmup, *even if it is set to 0 seconds* . To remove a value that you
         ...
         *   considered to have finished initializing and resource consumption to become stable
         ...
         *
         * The number must be greater than or equal to the minimum size of the group and less than
         * or equal to the maximum size of the group. If you do not specify a desired capacity when
         ...
         * CREATE_COMPLETE) when the desired capacity is reached. However, if a maximum Spot price
         * is set in the launch template or launch configuration that you specified, then desired
         * capacity is not used as a criteria for success. Whether your request is fulfilled depends
         * on Spot Instance capacity and your maximum price.
         *
         ...
         *
         * @param desiredCapacity The desired capacity is the initial capacity of the Auto Scaling
         *   group at the time of its creation and the capacity it attempts to maintain.
         */
         ...
         *
         * This is useful if your instances do not immediately pass their health checks after they
         ...
         *
         * @param healthCheckGracePeriod The amount of time, in seconds, that Amazon EC2 Auto
        ...
        public fun instanceMaintenancePolicy(
            instanceMaintenancePolicy: InstanceMaintenancePolicyProperty.Builder.() -> Unit
        )
         ...
         * Information used to specify the launch template and version to use to launch instances.
         *
         * You can alternatively associate a launch template to the Auto Scaling group by specifying
         * a `MixedInstancesPolicy` . For more information about creating launch templates, see
         ...
         *
         * @param launchTemplate Information used to specify the launch template and version to use
         *   to launch instances.
         */
        ...
        public fun launchTemplate(
            launchTemplate: LaunchTemplateSpecificationProperty.Builder.() -> Unit
        )
         ...
         *
         * @param lifecycleHookSpecificationList One or more lifecycle hooks to add to the Auto
         ...
         *
         * @param loadBalancerNames A list of Classic Load Balancers associated with this Auto
         *   Scaling group.
         */
         ...
         * The maximum amount of time, in seconds, that an instance can be in service.
         *
         * The default is null. If specified, the value must be either 0 or a number equal to or
         * greater than 86,400 seconds (1 day). For more information, see
         ...
         *
         * @param maxInstanceLifetime The maximum amount of time, in seconds, that an instance can
         *   be in service.
         */
         ...
         *
         * @param metricsCollection Enables the monitoring of group metrics of an Auto Scaling
         *   group.
         */
         ...
         * Instances and Spot Instances, the maximum price to pay for Spot Instances (optional), and
         * how the Auto Scaling group allocates instance types to fulfill On-Demand and Spot
         * capacities, but also the properties that specify the instance configuration
         * information—the launch template and instance types. The policy can also include a weight
         * for each instance type and different launch templates for individual instance types.
         *
         * For more information, see
        ...
        public fun mixedInstancesPolicy(
            mixedInstancesPolicy: MixedInstancesPolicyProperty.Builder.() -> Unit
        )
         ...
         *
         * @param notificationConfigurations Configures an Auto Scaling group to send notifications
         *   when specified events take place.
         */
         ...
         *
         * @param placementGroup The name of the placement group into which to launch your
         *   instances.
         */
         ...
         * uses to call other AWS service on your behalf.
         *
         ...
         *
         * @param serviceLinkedRoleArn The Amazon Resource Name (ARN) of the service-linked role
         *   that the Auto Scaling group uses to call other AWS service on your behalf.
         */
         ...
         * launches. Tags are not propagated to Amazon EBS volumes. To add tags to Amazon EBS
         * volumes, specify the tags in a launch template but use caution. If the launch template
         * specifies an instance tag with a key that is also specified for the Auto Scaling group,
         * Amazon EC2 Auto Scaling overrides the value of that instance tag with the value specified
         * by the Auto Scaling group. For more information, see
         ...
         *
         * @param targetGroupArns The Amazon Resource Names (ARN) of the Elastic Load Balancing
         *   target groups to associate with the Auto Scaling group.
         */
        ...
        /**
         * A list of subnet IDs for a virtual private cloud (VPC) where instances in the Auto
         * Scaling group can be created.
         *
         * If this resource specifies public subnets and is also in a VPC that is defined in the
         * same stack template, you must use the
         ...
         * replaces old instances with new ones, according to the specified subnets. You can
         * optionally specify how CloudFormation handles these updates by using an
         ...
         * with `AvailabilityZones` , the subnets that you specify for this property must reside in
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.autoscaling.CfnAutoScalingGroup.Builder.create(
                scope,
                id
            )
         ...
         * @param instanceMaintenancePolicy An instance maintenance policy.
         */
        override fun instanceMaintenancePolicy(
            instanceMaintenancePolicy: InstanceMaintenancePolicyProperty
        ) {
            cdkBuilder.instanceMaintenancePolicy(
                instanceMaintenancePolicy.let(InstanceMaintenancePolicyProperty::unwrap)
            )
        }
        ...
        override fun launchTemplate(launchTemplate: LaunchTemplateSpecificationProperty) {
            cdkBuilder.launchTemplate(
                launchTemplate.let(LaunchTemplateSpecificationProperty::unwrap)
            )
        }
        ...
        override fun lifecycleHookSpecificationList(lifecycleHookSpecificationList: IResolvable) {
            cdkBuilder.lifecycleHookSpecificationList(
                lifecycleHookSpecificationList.let(IResolvable::unwrap)
            )
        }
         ...
         *   Scaling group before instances are launched.
         */
        override fun lifecycleHookSpecificationList(
            vararg lifecycleHookSpecificationList: Any
        ): Unit = lifecycleHookSpecificationList(lifecycleHookSpecificationList.toList())
        ...
        override fun mixedInstancesPolicy(mixedInstancesPolicy: MixedInstancesPolicyProperty) {
            cdkBuilder.mixedInstancesPolicy(
                mixedInstancesPolicy.let(MixedInstancesPolicyProperty::unwrap)
            )
        }
         ...
         *   protected from termination by Amazon EC2 Auto Scaling when scaling in.
         */
        override fun newInstancesProtectedFromScaleIn(
            newInstancesProtectedFromScaleIn: IResolvable
        ) {
            cdkBuilder.newInstancesProtectedFromScaleIn(
                newInstancesProtectedFromScaleIn.let(IResolvable::unwrap)
            )
        }
        ...
        override fun notificationConfigurations(notificationConfigurations: IResolvable) {
            cdkBuilder.notificationConfigurations(
                notificationConfigurations.let(IResolvable::unwrap)
            )
        }
    ...
    public interface LaunchTemplateSpecificationProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: LaunchTemplateSpecificationProperty
            ): software.amazon.awscdk.services.autoscaling.CfnAutoScalingGroup.LaunchTemplateSpecificationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface TagPropertyProperty {
        ...
        /**
         * Set to `true` if you want CloudFormation to copy the tag to EC2 instances that are
        ...
        public interface Builder {
            ...
            /**
             * @param propagateAtLaunch Set to `true` if you want CloudFormation to copy the tag to
             *   EC2 instances that are launched as part of the Auto Scaling group. Set to `false`
             *   if you want the tag attached only to the Auto Scaling group and not copied to any
        ...
        internal constructor(
             ...
             * launched as part of the Auto Scaling group.
             *
             * Set to `false` if you want the tag attached only to the Auto Scaling group and not
             * copied to any instances launched as part of the Auto Scaling group.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-autoscaling-autoscalinggroup-tagproperty.html#cfn-autoscaling-autoscalinggroup-tagproperty-propagateatlaunch)
             */
    ...
    public interface VCpuCountRequestProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: VCpuCountRequestProperty
            ): software.amazon.awscdk.services.autoscaling.CfnAutoScalingGroup.VCpuCountRequestProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface LaunchTemplateOverridesProperty {
         ...
         *
         * When a Spot or On-Demand Instance is launched, the capacity units count toward the
         * desired capacity. Amazon EC2 Auto Scaling launches instances until the desired capacity
         * is totally fulfilled, even if this results in an overage. For example, if there are two
         * units remaining to fulfill capacity, and Amazon EC2 Auto Scaling can only launch an
         * instance with a `WeightedCapacity` of five units, the instance is launched, and the
        ...
        public interface Builder {
            /**
             * @param instanceRequirements The instance requirements. Amazon EC2 Auto Scaling uses
             *   your specified requirements to identify instance types. Then, it uses your
            ...
            /**
             * @param instanceType The instance type, such as `m3.xlarge` . You must specify an
            ...
            /**
             * @param launchTemplateSpecification Provides a launch template for the specified
             *   instance type or set of instance requirements. For example, some instance types
             *   might require a launch template with a different AMI. If not provided, Amazon EC2
            ...
            public fun launchTemplateSpecification(
                launchTemplateSpecification: LaunchTemplateSpecificationProperty.Builder.() -> Unit
            )

            /**
             * @param weightedCapacity If you provide a list of instance types to use, you can
             *   specify the number of capacity units provided by each instance type in terms of
             ...
             *   Scaling can only launch an instance with a `WeightedCapacity` of five units, the
             *   instance is launched, and the desired capacity is exceeded by three units. For more
             *   information, see
             *   [Configure instance weighting for Amazon EC2 Auto Scaling](https://docs.aws.amazon.com/autoscaling/ec2/userguide/ec2-auto-scaling-mixed-instances-groups-instance-weighting.html)
             *   in the *Amazon EC2 Auto Scaling User Guide* . Value must be in the range of 1-999.
             *
             * If you specify a value for `WeightedCapacity` for one instance type, you must specify
             * a value for `WeightedCapacity` for all of them.
             *
             ...
             * instances. However, if you configure a mixed instances policy that defines weights
             * for the instance types, you must specify these sizes with the same units that you use
        ...
        private class BuilderImpl : Builder {
            ...
            override fun launchTemplateSpecification(
                ...
                cdkBuilder.launchTemplateSpecification(
                    launchTemplateSpecification.let(LaunchTemplateSpecificationProperty::unwrap)
                )
            }
            ...
            override fun launchTemplateSpecification(
                ...
                launchTemplateSpecification(
                    LaunchTemplateSpecificationProperty(launchTemplateSpecification)
                )
        ...
        internal constructor(
             ...
             *
             * When a Spot or On-Demand Instance is launched, the capacity units count toward the
             * desired capacity. Amazon EC2 Auto Scaling launches instances until the desired
             * capacity is totally fulfilled, even if this results in an overage. For example, if
             * there are two units remaining to fulfill capacity, and Amazon EC2 Auto Scaling can
             * only launch an instance with a `WeightedCapacity` of five units, the instance is
             * launched, and the desired capacity is exceeded by three units. For more information,
             * see
             * [Configure instance weighting for Amazon EC2 Auto Scaling](https://docs.aws.amazon.com/autoscaling/ec2/userguide/ec2-auto-scaling-mixed-instances-groups-instance-weighting.html)
             * in the *Amazon EC2 Auto Scaling User Guide* . Value must be in the range of 1-999.
             *
    ...
    public interface InstancesDistributionProperty {
         ...
         *   priority, launching the lowest priced instance types within an Availability Zone first.
         *   This is the default value for Auto Scaling groups that specify `InstanceRequirements` .
         * * **prioritized** - You set the order of instance types for the launch template overrides
         *   from highest to lowest priority (from first to last in the list). Amazon EC2 Auto
         *   Scaling launches your highest priority instance types first. If all your On-Demand
         *   capacity cannot be fulfilled using your highest priority instance type, then Amazon EC2
         *   Auto Scaling launches the remaining capacity using the second priority instance type,
         *   and so on. This is the default value for Auto Scaling groups that don't specify
         ...
         *
         * An update to this setting means a gradual replacement of instances to adjust the current
         * On-Demand and Spot Instance levels for your additional capacity higher than the base
         ...
         *   based on the available Spot capacity. This strategy has the lowest risk of
         *   interruption. To give certain instance types a higher chance of launching first, use
         ...
         *   Amazon EC2 Auto Scaling honors the instance type priorities on a best effort basis but
         *   optimizes for capacity first. Note that if the On-Demand allocation strategy is set to
         *   `prioritized` , the same priority is applied when fulfilling On-Demand capacity. This
         *   is not a valid value for Auto Scaling groups that specify `InstanceRequirements` .
         ...
         *   `SpotInstancePools` property. To ensure that your desired capacity is met, you might
         *   receive Spot Instances from several pools. This is the default value, but it might lead
         *   to high interruption rates because this strategy only considers instance price and not
         *   available capacity.
         * * **price-capacity-optimized (recommended)** - The price and capacity optimized
         *   allocation strategy looks at both price and capacity to select the Spot Instance pools
         ...
         * only when the `SpotAllocationStrategy` is `lowest-price` . Value must be in the range of
         * 1–20.
         *
         * Default: 2
         *
         ...
         * price because it can lead to increased interruptions. When Spot Instances launch, you pay
         * the current Spot price. To remove a maximum price that you previously set, include the
        ...
        public interface Builder {
             ...
             *   Instances when they are launched. Possible instance types are determined by the
             ...
             *   overrides from highest to lowest priority (from first to last in the list). Amazon
             *   EC2 Auto Scaling launches your highest priority instance types first. If all your
             *   On-Demand capacity cannot be fulfilled using your highest priority instance type,
             ...
             *   groups that don't specify `InstanceRequirements` and cannot be used for groups that
             *   do.
             */
            public fun onDemandAllocationStrategy(onDemandAllocationStrategy: String)

            /**
             * @param onDemandBaseCapacity The minimum amount of the Auto Scaling group's capacity
             *   that must be fulfilled by On-Demand Instances. This base portion is launched first
             ...
             * current On-Demand Instance levels. When replacing instances, Amazon EC2 Auto Scaling
             * launches new instances before terminating the previous ones.
             */
             ...
             *   `OnDemandBaseCapacity` . Expressed as a number (for example, 20 specifies 20%
             *   On-Demand Instances, 80% Spot Instances). If set to 100, only On-Demand Instances
             *   are used.
             *
             * Default: 100
             *
             ...
             * the base capacity. When replacing instances, Amazon EC2 Auto Scaling launches new
             * instances before terminating the previous ones.
             */
            public fun onDemandPercentageAboveBaseCapacity(
                onDemandPercentageAboveBaseCapacity: Number
            )

            /**
             * @param spotAllocationStrategy The allocation strategy to apply to your Spot Instances
             *   when they are launched. Possible instance types are determined by the launch
             *   template overrides that you specify.
             *
             * The following lists the valid values:
             * * **capacity-optimized** - Requests Spot Instances using pools that are optimally
             *   chosen based on the available Spot capacity. This strategy has the lowest risk of
             *   interruption. To give certain instance types a higher chance of launching first,
             ...
             *   might receive Spot Instances from several pools. This is the default value, but it
             *   might lead to high interruption rates because this strategy only considers instance
            ...
            /**
             * @param spotInstancePools The number of Spot Instance pools across which to allocate
             *   your Spot Instances. The Spot pools are determined from the different instance
             ...
             *   Spot Instance. If your maximum price is lower than the Spot price for the instance
             *   types that you selected, your Spot Instances are not launched. We do not recommend
             *   specifying a maximum price because it can lead to increased interruptions. When
             *   Spot Instances launch, you pay the current Spot price. To remove a maximum price
             *   that you previously set, include the property but specify an empty string ("") for
             *   the value.
             *
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-autoscaling-autoscalinggroup-instancesdistribution.html#cfn-autoscaling-autoscalinggroup-instancesdistribution-spotallocationstrategy)
             */
            override fun spotAllocationStrategy(): String? =
             ...
             * Valid only when the `SpotAllocationStrategy` is `lowest-price` . Value must be in the
             * range of 1–20.
             *
             * Default: 2
             *
             ...
             * launch, you pay the current Spot price. To remove a maximum price that you previously
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: InstancesDistributionProperty
            ): software.amazon.awscdk.services.autoscaling.CfnAutoScalingGroup.InstancesDistributionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface NotificationConfigurationProperty {
         ...
         */
        public fun notificationTypes(): List<String> =
            unwrap(this).getNotificationTypes() ?: emptyList()
        ...
        public interface Builder {
            /**
             * @param notificationTypes A list of event types that send a notification. Event types
             *   can include any of the following types. *Allowed values* :
             * * `autoscaling:EC2_INSTANCE_LAUNCH`
             * * `autoscaling:EC2_INSTANCE_LAUNCH_ERROR`
             * * `autoscaling:EC2_INSTANCE_TERMINATE`
             * * `autoscaling:EC2_INSTANCE_TERMINATE_ERROR`
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-autoscaling-autoscalinggroup-notificationconfiguration.html#cfn-autoscaling-autoscalinggroup-notificationconfiguration-notificationtypes)
             */
            override fun notificationTypes(): List<String> =
                unwrap(this).getNotificationTypes() ?: emptyList()
    ...
    public interface MetricsCollectionProperty {
        ...
        public interface Builder {
            /**
             * @param granularity The frequency at which Amazon EC2 Auto Scaling sends aggregated
             *   data to CloudWatch. The only valid value is `1Minute` .
             */
            public fun granularity(granularity: String)

            /**
             * @param metrics Identifies the metrics to enable. You can specify one or more of the
             *   following metrics:
             * * `GroupMinSize`
             * * `GroupMaxSize`
             * * `GroupDesiredCapacity`
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: MetricsCollectionProperty
            ): software.amazon.awscdk.services.autoscaling.CfnAutoScalingGroup.MetricsCollectionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface InstanceRequirementsProperty {
         ...
         *   includes EC2 instance types currently recommended for use. This typically includes the
         ...
         * instance type matches your attributes, then the identified price is from either the
         * lowest priced current generation instance types or, failing that, the lowest priced
         * previous generation instance types that match your attributes. When Amazon EC2 Auto
         * Scaling selects instance types with your attributes, we will exclude instance types whose
         ...
         * instance type with your specified attributes. If no current generation C, M, or R
         * instance type matches your attributes, then the identified price is from either the
         * lowest priced current generation instance types or, failing that, the lowest priced
         * previous generation instance types that match your attributes. When Amazon EC2 Auto
         * Scaling selects instance types with your attributes, we will exclude instance types whose
        ...
        public interface Builder {
             ...
             *   or AWS Inferentia chips) for an instance type. To exclude accelerator-enabled
             ...
             * `m5a.*` , Amazon EC2 Auto Scaling will allow all the M5a instance types, but not the
             * M5n instance types.
             *
             * If you specify `AllowedInstanceTypes` , you can't specify `ExcludedInstanceTypes` .
             *
            ...
            /**
             * @param bareMetal Indicates whether bare metal instance types are included, excluded,
             *   or required. Default: `excluded`
             */
            public fun bareMetal(bareMetal: String)

            /**
             * @param baselineEbsBandwidthMbps The minimum and maximum baseline bandwidth
             *   performance for an instance type, in Mbps. For more information, see
             *   [Amazon EBS–optimized instances](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ebs-optimized.html)
             *   in the *Amazon EC2 User Guide for Linux Instances* .
             *
             * Default: No minimum or maximum limits
            ...
            /**
             * @param burstablePerformance Indicates whether burstable performance instance types
             ...
             *
             * For example, if you specify `c5*` , you are excluding the entire C5 instance family,
             * which includes all C5a and C5n instance types. If you specify `m5a.*` , Amazon EC2
             * Auto Scaling will exclude all the M5a instance types, but not the M5n instance types.
             *
             * If you specify `ExcludedInstanceTypes` , you can't specify `AllowedInstanceTypes` .
             *
             * Default: No excluded instance types
            ...
            /**
             * @param memoryGiBPerVCpu The minimum and maximum amount of memory per vCPU for an
             *   instance type, in GiB. Default: No minimum or maximum limits
             */
            ...
            /**
             * @param memoryMiB The minimum and maximum instance memory size for an instance type,
             *   in MiB.
             */
            ...
            /**
             * @param networkInterfaceCount The minimum and maximum number of network interfaces for
             *   an instance type. Default: No minimum or maximum limits
             */
             ...
             *   instance types that match your attributes. When Amazon EC2 Auto Scaling selects
            ...
            /**
             * @param requireHibernateSupport Indicates whether instance types must provide
             *   On-Demand Instance hibernation support. Default: `false`
             */
             ...
             *   The identified Spot price is the price of the lowest priced current generation C,
             *   M, or R instance type with your specified attributes. If no current generation C,
            ...
            /**
             * @param totalLocalStorageGb The minimum and maximum total local storage size for an
             *   instance type, in GB. Default: No minimum or maximum limits
             */
        ...
        internal constructor(
             ...
             * R instance type matches your attributes, then the identified price is from either the
             * lowest priced current generation instance types or, failing that, the lowest priced
             * previous generation instance types that match your attributes. When Amazon EC2 Auto
             * Scaling selects instance types with your attributes, we will exclude instance types
    ...
    public interface InstanceMaintenancePolicyProperty {
         ...
         * to use to support your workload when replacing instances. Value range is 0 to 100. To
         * clear a previously set value, specify a value of `-1` .
         *
        ...
        public interface Builder {
            /**
             * @param maxHealthyPercentage Specifies the upper threshold as a percentage of the
             *   desired capacity of the Auto Scaling group. It represents the maximum percentage of
             *   the group that can be in service and healthy, or pending, to support your workload
             *   when replacing instances. Value range is 100 to 200. To clear a previously set
            ...
            /**
             * @param minHealthyPercentage Specifies the lower threshold as a percentage of the
             *   desired capacity of the Auto Scaling group. It represents the minimum percentage of
             *   the group to keep in service, healthy, and ready to use to support your workload
             *   when replacing instances. Value range is 0 to 100. To clear a previously set value,
        ...
        internal constructor(
             ...
             * Scaling group.
             *
             * It represents the maximum percentage of the group that can be in service and healthy,
             * or pending, to support your workload when replacing instances. Value range is 100
             * to 200. To clear a previously set value, specify a value of `-1` .
             *
             * Both `MinHealthyPercentage` and `MaxHealthyPercentage` must be specified, and the
             * difference between them cannot be greater than 100. A large range increases the
             * number of instances that can be replaced at the same time.
             ...
             * Scaling group.
             *
             * It represents the minimum percentage of the group to keep in service, healthy, and
             * ready to use to support your workload when replacing instances. Value range is 0
             * to 100. To clear a previously set value, specify a value of `-1` .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-autoscaling-autoscalinggroup-instancemaintenancepolicy.html#cfn-autoscaling-autoscalinggroup-instancemaintenancepolicy-minhealthypercentage)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: InstanceMaintenancePolicyProperty
            ): software.amazon.awscdk.services.autoscaling.CfnAutoScalingGroup.InstanceMaintenancePolicyProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface LifecycleHookSpecificationProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param heartbeatTimeout The maximum time, in seconds, that can elapse before the
             *   lifecycle hook times out. The range is from `30` to `7200` seconds. The default
            ...
            /**
             * @param lifecycleTransition The lifecycle transition. For Auto Scaling groups, there
             *   are two major lifecycle transitions.
             * * To create a lifecycle hook for scale-out events, specify
             *   `autoscaling:EC2_INSTANCE_LAUNCHING` .
             * * To create a lifecycle hook for scale-in events, specify
             *   `autoscaling:EC2_INSTANCE_TERMINATING` .
            ...
            /**
             * @param notificationMetadata Additional information that you want to include any time
            ...
            /**
             * @param notificationTargetArn The Amazon Resource Name (ARN) of the notification
             *   target that Amazon EC2 Auto Scaling sends notifications to when an instance is in a
             *   wait state for the lifecycle hook. You can specify an Amazon SNS topic or an Amazon
             *   SQS queue.
             */
             ...
             *   to the specified notification target. For information about creating this role, see
             *   [Configure a notification target for a lifecycle hook](https://docs.aws.amazon.com/autoscaling/ec2/userguide/prepare-for-lifecycle-notifications.html#lifecycle-hook-notification-target)
             *   in the *Amazon EC2 Auto Scaling User Guide* .
             *
             * Valid only if the notification target is an Amazon SNS topic or an Amazon SQS queue.
        ...
        internal constructor(
             ...
             * The maximum time, in seconds, that can elapse before the lifecycle hook times out.
             *
             * The range is from `30` to `7200` seconds. The default value is `3600` seconds (1
             * hour).
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-autoscaling-autoscalinggroup-lifecyclehookspecification.html#cfn-autoscaling-autoscalinggroup-lifecyclehookspecification-heartbeattimeout)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: LifecycleHookSpecificationProperty
            ): software.amazon.awscdk.services.autoscaling.CfnAutoScalingGroup.LifecycleHookSpecificationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface MixedInstancesPolicyProperty {
        ...
        public interface Builder {
            ...
            public fun instancesDistribution(
                instancesDistribution: InstancesDistributionProperty.Builder.() -> Unit
            )

            /**
             * @param launchTemplate One or more launch templates and the instance types (overrides)
             *   that are used to launch EC2 instances to fulfill On-Demand and Spot capacities.
             */
            public fun launchTemplate(launchTemplate: IResolvable)
        ...
        private class BuilderImpl : Builder {
            ...
            /** @param instancesDistribution The instances distribution. */
            override fun instancesDistribution(
                instancesDistribution: InstancesDistributionProperty
            ) {
                cdkBuilder.instancesDistribution(
                    instancesDistribution.let(InstancesDistributionProperty::unwrap)
                )
            }
            ...
            @JvmName("8ce44d33aa3fb8b16dd87d85a8716387ee4ee1693a6889cfcfb3e7ce7ded3d33")
            override fun launchTemplate(
                launchTemplate: LaunchTemplateProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: MixedInstancesPolicyProperty
            ): software.amazon.awscdk.services.autoscaling.CfnAutoScalingGroup.MixedInstancesPolicyProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface LaunchTemplateProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param overrides Any properties that you specify override the same properties in the
             *   launch template.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: LaunchTemplateProperty
            ): software.amazon.awscdk.services.autoscaling.CfnAutoScalingGroup.LaunchTemplateProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
