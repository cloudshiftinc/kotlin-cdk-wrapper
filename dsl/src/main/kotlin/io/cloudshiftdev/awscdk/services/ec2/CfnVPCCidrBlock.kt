...
internal constructor(
    ...
    public interface Builder {
        ...
        /**
         * The netmask length of the IPv4 CIDR you would like to associate from an Amazon VPC IP
         ...
         *
         * @param ipv4NetmaskLength The netmask length of the IPv4 CIDR you would like to associate
        ...
        /**
         * The netmask length of the IPv6 CIDR you would like to associate from an Amazon VPC IP
         * Address Manager (IPAM) pool.
         *
         * For more information about IPAM, see
         * [What is IPAM?](https://docs.aws.amazon.com//vpc/latest/ipam/what-is-it-ipam.html) in the
         ...
         *
         * @param ipv6NetmaskLength The netmask length of the IPv6 CIDR you would like to associate
         *   from an Amazon VPC IP Address Manager (IPAM) pool.
         */
    ...
    private class BuilderImpl(
        ...
        override fun amazonProvidedIpv6CidrBlock(amazonProvidedIpv6CidrBlock: IResolvable) {
            cdkBuilder.amazonProvidedIpv6CidrBlock(
                amazonProvidedIpv6CidrBlock.let(IResolvable::unwrap)
            )
        }
