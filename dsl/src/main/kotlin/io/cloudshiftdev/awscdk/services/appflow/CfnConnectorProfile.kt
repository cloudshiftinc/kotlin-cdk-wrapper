...
internal constructor(
    ...
    public open fun connectorProfileConfig(
        `value`: ConnectorProfileConfigProperty.Builder.() -> Unit
    ): Unit = connectorProfileConfig(ConnectorProfileConfigProperty(`value`))
    ...
    public interface Builder {
         ...
         *
         * @param connectorProfileConfig Defines the connector-specific configuration and
         *   credentials.
         */
        ...
        public fun connectorProfileConfig(
            connectorProfileConfig: ConnectorProfileConfigProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
         ...
         *   credentials.
         */
        override fun connectorProfileConfig(
            connectorProfileConfig: ConnectorProfileConfigProperty
        ) {
            cdkBuilder.connectorProfileConfig(
                connectorProfileConfig.let(ConnectorProfileConfigProperty::unwrap)
            )
        }
    ...
    public interface MarketoConnectorProfilePropertiesProperty {
        ...
        private class BuilderImpl : Builder {
            private val cdkBuilder:
                ...
                software.amazon.awscdk.services.appflow.CfnConnectorProfile
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: MarketoConnectorProfilePropertiesProperty
            ): software.amazon.awscdk.services.appflow.CfnConnectorProfile.MarketoConnectorProfilePropertiesProperty =
    ...
    public interface ConnectorProfileCredentialsProperty {
        ...
        public interface Builder {
            ...
            public fun amplitude(
                amplitude: AmplitudeConnectorProfileCredentialsProperty.Builder.() -> Unit
            )

            /**
             * @param customConnector The connector-specific profile credentials that are required
            ...
            public fun customConnector(
                customConnector: CustomConnectorProfileCredentialsProperty.Builder.() -> Unit
            )
            ...
            public fun datadog(
                datadog: DatadogConnectorProfileCredentialsProperty.Builder.() -> Unit
            )
            ...
            public fun dynatrace(
                dynatrace: DynatraceConnectorProfileCredentialsProperty.Builder.() -> Unit
            )
            ...
            public fun googleAnalytics(
                googleAnalytics:
                    GoogleAnalyticsConnectorProfileCredentialsProperty.Builder.() -> Unit
            )
            ...
            public fun inforNexus(
                inforNexus: InforNexusConnectorProfileCredentialsProperty.Builder.() -> Unit
            )
            ...
            public fun marketo(
                marketo: MarketoConnectorProfileCredentialsProperty.Builder.() -> Unit
            )

            /**
             * @param pardot The connector-specific credentials required when using Salesforce
             *   Pardot.
             */
            ...
            /**
             * @param redshift The connector-specific credentials required when using Amazon
             *   Redshift.
             */
            ...
            public fun redshift(
                redshift: RedshiftConnectorProfileCredentialsProperty.Builder.() -> Unit
            )
            ...
            public fun salesforce(
                salesforce: SalesforceConnectorProfileCredentialsProperty.Builder.() -> Unit
            )

            /**
             * @param sapoData The connector-specific profile credentials required when using
             *   SAPOData.
             */
            ...
            public fun sapoData(
                sapoData: SAPODataConnectorProfileCredentialsProperty.Builder.() -> Unit
            )
            ...
            public fun serviceNow(
                serviceNow: ServiceNowConnectorProfileCredentialsProperty.Builder.() -> Unit
            )
            ...
            public fun singular(
                singular: SingularConnectorProfileCredentialsProperty.Builder.() -> Unit
            )
            ...
            public fun snowflake(
                snowflake: SnowflakeConnectorProfileCredentialsProperty.Builder.() -> Unit
            )
            ...
            public fun trendmicro(
                trendmicro: TrendmicroConnectorProfileCredentialsProperty.Builder.() -> Unit
            )
            ...
            public fun zendesk(
                zendesk: ZendeskConnectorProfileCredentialsProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun amplitude(amplitude: AmplitudeConnectorProfileCredentialsProperty) {
                cdkBuilder.amplitude(
                    amplitude.let(AmplitudeConnectorProfileCredentialsProperty::unwrap)
                )
            }
            ...
            override fun customConnector(
                ...
                cdkBuilder.customConnector(
                    customConnector.let(CustomConnectorProfileCredentialsProperty::unwrap)
                )
            }
            ...
            override fun dynatrace(dynatrace: DynatraceConnectorProfileCredentialsProperty) {
                cdkBuilder.dynatrace(
                    dynatrace.let(DynatraceConnectorProfileCredentialsProperty::unwrap)
                )
            }
            ...
            override fun googleAnalytics(
                ...
                cdkBuilder.googleAnalytics(
                    googleAnalytics.let(GoogleAnalyticsConnectorProfileCredentialsProperty::unwrap)
                )
            }
            ...
            override fun inforNexus(inforNexus: InforNexusConnectorProfileCredentialsProperty) {
                cdkBuilder.inforNexus(
                    inforNexus.let(InforNexusConnectorProfileCredentialsProperty::unwrap)
                )
            }
            ...
            @JvmName("8c831f31c91ed683a67abeafbf5a5743266097be49831a41f426f4ed1e01c4d9")
            override fun pardot(
                pardot: PardotConnectorProfileCredentialsProperty.Builder.() -> Unit
            ...
            override fun redshift(redshift: RedshiftConnectorProfileCredentialsProperty) {
                cdkBuilder.redshift(
                    redshift.let(RedshiftConnectorProfileCredentialsProperty::unwrap)
                )
            }
            ...
            override fun salesforce(salesforce: SalesforceConnectorProfileCredentialsProperty) {
                cdkBuilder.salesforce(
                    salesforce.let(SalesforceConnectorProfileCredentialsProperty::unwrap)
                )
            }
            ...
            override fun sapoData(sapoData: SAPODataConnectorProfileCredentialsProperty) {
                cdkBuilder.sapoData(
                    sapoData.let(SAPODataConnectorProfileCredentialsProperty::unwrap)
                )
            }
            ...
            override fun serviceNow(serviceNow: ServiceNowConnectorProfileCredentialsProperty) {
                cdkBuilder.serviceNow(
                    serviceNow.let(ServiceNowConnectorProfileCredentialsProperty::unwrap)
                )
            }
            ...
            override fun singular(singular: SingularConnectorProfileCredentialsProperty) {
                cdkBuilder.singular(
                    singular.let(SingularConnectorProfileCredentialsProperty::unwrap)
                )
            }
            ...
            @JvmName("e708360ff956de5ae66e5bcf479a906c70976420e0fdf09de88597ae609bcdfe")
            override fun slack(
                slack: SlackConnectorProfileCredentialsProperty.Builder.() -> Unit
            ...
            override fun snowflake(snowflake: SnowflakeConnectorProfileCredentialsProperty) {
                cdkBuilder.snowflake(
                    snowflake.let(SnowflakeConnectorProfileCredentialsProperty::unwrap)
                )
            }
            ...
            override fun trendmicro(trendmicro: TrendmicroConnectorProfileCredentialsProperty) {
                cdkBuilder.trendmicro(
                    trendmicro.let(TrendmicroConnectorProfileCredentialsProperty::unwrap)
                )
            }
            ...
            @JvmName("9003ee28121c39c203be2c1846faf43651b82652c7c1232e5aaffd48f12ad32b")
            override fun veeva(
                veeva: VeevaConnectorProfileCredentialsProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ConnectorProfileCredentialsProperty
            ): software.amazon.awscdk.services.appflow.CfnConnectorProfile.ConnectorProfileCredentialsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ConnectorProfileConfigProperty {
         ...
         */
        public fun connectorProfileCredentials(): Any? =
        ...
        public interface Builder {
            /**
             * @param connectorProfileCredentials The connector-specific credentials required by
             *   each connector.
             */
            ...
            public fun connectorProfileCredentials(
                connectorProfileCredentials: ConnectorProfileCredentialsProperty.Builder.() -> Unit
            )
            ...
            public fun connectorProfileProperties(
                connectorProfileProperties: ConnectorProfilePropertiesProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun connectorProfileCredentials(connectorProfileCredentials: IResolvable) {
                cdkBuilder.connectorProfileCredentials(
                    connectorProfileCredentials.let(IResolvable::unwrap)
                )
            }
             ...
             *   each connector.
             */
            override fun connectorProfileCredentials(
                connectorProfileCredentials: ConnectorProfileCredentialsProperty
            ) {
                cdkBuilder.connectorProfileCredentials(
                    connectorProfileCredentials.let(ConnectorProfileCredentialsProperty::unwrap)
                )
            }
            ...
            override fun connectorProfileCredentials(
                ...
                connectorProfileCredentials(
                    ConnectorProfileCredentialsProperty(connectorProfileCredentials)
                )
            ...
            override fun connectorProfileProperties(connectorProfileProperties: IResolvable) {
                cdkBuilder.connectorProfileProperties(
                    connectorProfileProperties.let(IResolvable::unwrap)
                )
            }
             ...
             *   configuration.
             */
            override fun connectorProfileProperties(
                connectorProfileProperties: ConnectorProfilePropertiesProperty
            ) {
                cdkBuilder.connectorProfileProperties(
                    connectorProfileProperties.let(ConnectorProfilePropertiesProperty::unwrap)
                )
            }
            ...
            override fun connectorProfileProperties(
                ...
                connectorProfileProperties(
                    ConnectorProfilePropertiesProperty(connectorProfileProperties)
                )
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appflow-connectorprofile-connectorprofileconfig.html#cfn-appflow-connectorprofile-connectorprofileconfig-connectorprofileproperties)
             */
            override fun connectorProfileProperties(): Any? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ConnectorProfileConfigProperty
            ): software.amazon.awscdk.services.appflow.CfnConnectorProfile.ConnectorProfileConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CustomConnectorProfilePropertiesProperty {
        ...
        public interface Builder {
            /**
             * @param oAuth2Properties The OAuth 2.0 properties required for OAuth 2.0
             *   authentication.
             */
            ...
            public fun oAuth2Properties(
                oAuth2Properties: OAuth2PropertiesProperty.Builder.() -> Unit
            )

            /**
             * @param profileProperties A map of properties that are required to create a profile
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CustomConnectorProfilePropertiesProperty
            ): software.amazon.awscdk.services.appflow.CfnConnectorProfile.CustomConnectorProfilePropertiesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SnowflakeConnectorProfileCredentialsProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SnowflakeConnectorProfileCredentialsProperty
            ): software.amazon.awscdk.services.appflow.CfnConnectorProfile.SnowflakeConnectorProfileCredentialsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface OAuthCredentialsProperty {
        ...
        public interface Builder {
            ...
            public fun connectorOAuthRequest(
                connectorOAuthRequest: ConnectorOAuthRequestProperty.Builder.() -> Unit
            )
        ...
        private class BuilderImpl : Builder {
            ...
            /** @param connectorOAuthRequest the value to be set. */
            override fun connectorOAuthRequest(
                connectorOAuthRequest: ConnectorOAuthRequestProperty
            ) {
                cdkBuilder.connectorOAuthRequest(
                    connectorOAuthRequest.let(ConnectorOAuthRequestProperty::unwrap)
                )
            }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: OAuthCredentialsProperty
            ): software.amazon.awscdk.services.appflow.CfnConnectorProfile.OAuthCredentialsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ConnectorProfilePropertiesProperty {
        ...
        public interface Builder {
            ...
            public fun customConnector(
                customConnector: CustomConnectorProfilePropertiesProperty.Builder.() -> Unit
            )
            ...
            public fun datadog(
                datadog: DatadogConnectorProfilePropertiesProperty.Builder.() -> Unit
            )
            ...
            public fun dynatrace(
                dynatrace: DynatraceConnectorProfilePropertiesProperty.Builder.() -> Unit
            )
            ...
            public fun inforNexus(
                inforNexus: InforNexusConnectorProfilePropertiesProperty.Builder.() -> Unit
            )
            ...
            public fun marketo(
                marketo: MarketoConnectorProfilePropertiesProperty.Builder.() -> Unit
            )
            ...
            public fun redshift(
                redshift: RedshiftConnectorProfilePropertiesProperty.Builder.() -> Unit
            )
            ...
            public fun salesforce(
                salesforce: SalesforceConnectorProfilePropertiesProperty.Builder.() -> Unit
            )

            /**
             * @param sapoData The connector-specific profile properties required when using
             *   SAPOData.
             */
            public fun sapoData(sapoData: IResolvable)
            ...
            public fun sapoData(
                sapoData: SAPODataConnectorProfilePropertiesProperty.Builder.() -> Unit
            )
            ...
            public fun serviceNow(
                serviceNow: ServiceNowConnectorProfilePropertiesProperty.Builder.() -> Unit
            )
            ...
            public fun snowflake(
                snowflake: SnowflakeConnectorProfilePropertiesProperty.Builder.() -> Unit
            )
            ...
            public fun zendesk(
                zendesk: ZendeskConnectorProfilePropertiesProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun customConnector(
                ...
                cdkBuilder.customConnector(
                    customConnector.let(CustomConnectorProfilePropertiesProperty::unwrap)
                )
            }
            ...
            override fun dynatrace(dynatrace: DynatraceConnectorProfilePropertiesProperty) {
                cdkBuilder.dynatrace(
                    dynatrace.let(DynatraceConnectorProfilePropertiesProperty::unwrap)
                )
            }
            ...
            override fun inforNexus(inforNexus: InforNexusConnectorProfilePropertiesProperty) {
                cdkBuilder.inforNexus(
                    inforNexus.let(InforNexusConnectorProfilePropertiesProperty::unwrap)
                )
            }
            ...
            @JvmName("c65da59347459711bc397bb3dbc1ec11dae4eac674f001a943e7ebe90ab2b307")
            override fun pardot(
                pardot: PardotConnectorProfilePropertiesProperty.Builder.() -> Unit
            ): Unit = pardot(PardotConnectorProfilePropertiesProperty(pardot))
            ...
            override fun redshift(redshift: RedshiftConnectorProfilePropertiesProperty) {
                cdkBuilder.redshift(
                    redshift.let(RedshiftConnectorProfilePropertiesProperty::unwrap)
                )
            }
            ...
            override fun salesforce(salesforce: SalesforceConnectorProfilePropertiesProperty) {
                cdkBuilder.salesforce(
                    salesforce.let(SalesforceConnectorProfilePropertiesProperty::unwrap)
                )
            }
            ...
            override fun sapoData(sapoData: SAPODataConnectorProfilePropertiesProperty) {
                cdkBuilder.sapoData(
                    sapoData.let(SAPODataConnectorProfilePropertiesProperty::unwrap)
                )
            }
            ...
            override fun serviceNow(serviceNow: ServiceNowConnectorProfilePropertiesProperty) {
                cdkBuilder.serviceNow(
                    serviceNow.let(ServiceNowConnectorProfilePropertiesProperty::unwrap)
                )
            }
            ...
            @JvmName("0a97573d8fe1cf050e5807ba73d78f36907be09ba79653422c392f7acd4e2e21")
            override fun slack(
                slack: SlackConnectorProfilePropertiesProperty.Builder.() -> Unit
            ...
            override fun snowflake(snowflake: SnowflakeConnectorProfilePropertiesProperty) {
                cdkBuilder.snowflake(
                    snowflake.let(SnowflakeConnectorProfilePropertiesProperty::unwrap)
                )
            }
            ...
            @JvmName("bd5533750d9a06d562f5148d5e41ba2bdfb626ac3643765b9667b5fbf56bb147")
            override fun veeva(
                veeva: VeevaConnectorProfilePropertiesProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ConnectorProfilePropertiesProperty
            ): software.amazon.awscdk.services.appflow.CfnConnectorProfile.ConnectorProfilePropertiesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DynatraceConnectorProfilePropertiesProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DynatraceConnectorProfilePropertiesProperty
            ): software.amazon.awscdk.services.appflow.CfnConnectorProfile.DynatraceConnectorProfilePropertiesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface InforNexusConnectorProfilePropertiesProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: InforNexusConnectorProfilePropertiesProperty
            ): software.amazon.awscdk.services.appflow.CfnConnectorProfile.InforNexusConnectorProfilePropertiesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface OAuthPropertiesProperty {
        ...
        public interface Builder {
            /**
             * @param authCodeUrl The authorization code url required to redirect to SAP Login Page
             *   to fetch authorization code for OAuth type authentication.
             */
            ...
            /**
             * @param tokenUrl The token url required to fetch access/refresh tokens using
             *   authorization code and also to refresh expired access token using refresh token.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            /** @param oAuthScopes The OAuth scopes required for OAuth type authentication. */
            override fun oAuthScopes(vararg oAuthScopes: String): Unit =
                oAuthScopes(oAuthScopes.toList())
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: OAuthPropertiesProperty
            ): software.amazon.awscdk.services.appflow.CfnConnectorProfile.OAuthPropertiesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ServiceNowConnectorProfileCredentialsProperty {
        ...
        public interface Builder {
            ...
            public fun oAuth2Credentials(
                oAuth2Credentials: OAuth2CredentialsProperty.Builder.() -> Unit
            )
        ...
        private class BuilderImpl : Builder {
            ...
            override fun oAuth2Credentials(oAuth2Credentials: OAuth2CredentialsProperty) {
                cdkBuilder.oAuth2Credentials(
                    oAuth2Credentials.let(OAuth2CredentialsProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("52363dd6c5a8eb299b5db6177cba24c77f4eff2eb58a49b48fab009df69af22f")
            override fun oAuth2Credentials(
                oAuth2Credentials: OAuth2CredentialsProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ServiceNowConnectorProfileCredentialsProperty
            ): software.amazon.awscdk.services.appflow.CfnConnectorProfile.ServiceNowConnectorProfileCredentialsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ServiceNowConnectorProfilePropertiesProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ServiceNowConnectorProfilePropertiesProperty
            ): software.amazon.awscdk.services.appflow.CfnConnectorProfile.ServiceNowConnectorProfilePropertiesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface PardotConnectorProfileCredentialsProperty {
        ...
        public interface Builder {
            /**
             * @param accessToken The credentials used to access protected Salesforce Pardot
             *   resources.
             */
            public fun accessToken(accessToken: String)

            /**
             * @param clientCredentialsArn The secret manager ARN, which contains the client ID and
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: PardotConnectorProfileCredentialsProperty
            ): software.amazon.awscdk.services.appflow.CfnConnectorProfile.PardotConnectorProfileCredentialsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DatadogConnectorProfilePropertiesProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DatadogConnectorProfilePropertiesProperty
            ): software.amazon.awscdk.services.appflow.CfnConnectorProfile.DatadogConnectorProfilePropertiesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ApiKeyCredentialsProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ApiKeyCredentialsProperty
            ): software.amazon.awscdk.services.appflow.CfnConnectorProfile.ApiKeyCredentialsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ZendeskConnectorProfilePropertiesProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ZendeskConnectorProfilePropertiesProperty
            ): software.amazon.awscdk.services.appflow.CfnConnectorProfile.ZendeskConnectorProfilePropertiesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ConnectorOAuthRequestProperty {
        ...
        public interface Builder {
            /**
             * @param authCode The code provided by the connector when it has been authenticated via
             *   the connected app.
             */
            public fun authCode(authCode: String)

            /**
             * @param redirectUri The URL to which the authentication server redirects the browser
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ConnectorOAuthRequestProperty
            ): software.amazon.awscdk.services.appflow.CfnConnectorProfile.ConnectorOAuthRequestProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface BasicAuthCredentialsProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: BasicAuthCredentialsProperty
            ): software.amazon.awscdk.services.appflow.CfnConnectorProfile.BasicAuthCredentialsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SalesforceConnectorProfilePropertiesProperty {
         ...
         * Salesforce.
         *
         * Amazon AppFlow sends private calls through AWS PrivateLink . These calls travel through
         * AWS infrastructure without being exposed to the public internet.
         *
         ...
         * * Calls to get or refresh access tokens that allow Amazon AppFlow to access your
         *   Salesforce records.
        ...
        public interface Builder {
            ...
            /**
             * @param isSandboxEnvironment Indicates whether the connector profile applies to a
            ...
            /**
             * @param usePrivateLinkForMetadataAndAuthorization If the connection mode for the
             *   connector profile is private, this parameter sets whether Amazon AppFlow uses the
             *   private network to send metadata and authorization calls to Salesforce. Amazon
             *   AppFlow sends private calls through AWS PrivateLink . These calls travel through
             *   AWS infrastructure without being exposed to the public internet.
             *
             * Set either of the following values:
             * * **true** - Amazon AppFlow sends all calls to Salesforce over the private network.
        ...
        private class BuilderImpl : Builder {
             ...
             * * Calls to transfer your Salesforce records as part of a flow run.
             */
            override fun usePrivateLinkForMetadataAndAuthorization(
                usePrivateLinkForMetadataAndAuthorization: Boolean
            ) {
            ...
            override fun usePrivateLinkForMetadataAndAuthorization(
                ...
                cdkBuilder.usePrivateLinkForMetadataAndAuthorization(
                    usePrivateLinkForMetadataAndAuthorization.let(IResolvable::unwrap)
                )
            }
        ...
        internal constructor(
             ...
             * whether Amazon AppFlow uses the private network to send metadata and authorization
             * calls to Salesforce.
             *
             * Amazon AppFlow sends private calls through AWS PrivateLink . These calls travel
             * through AWS infrastructure without being exposed to the public internet.
             *
             * Set either of the following values:
             * * **true** - Amazon AppFlow sends all calls to Salesforce over the private network.
             *
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SalesforceConnectorProfilePropertiesProperty
            ): software.amazon.awscdk.services.appflow.CfnConnectorProfile.SalesforceConnectorProfilePropertiesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DynatraceConnectorProfileCredentialsProperty {
        ...
        public interface Builder {
            /**
             * @param apiToken The API tokens used by Dynatrace API to authenticate various API
             *   calls.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DynatraceConnectorProfileCredentialsProperty
            ): software.amazon.awscdk.services.appflow.CfnConnectorProfile.DynatraceConnectorProfileCredentialsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SnowflakeConnectorProfilePropertiesProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param bucketPrefix The bucket path that refers to the Amazon S3 bucket associated
             *   with Snowflake.
             */
            ...
            /**
             * @param stage The name of the Amazon S3 stage that was created while setting up an
             *   Amazon S3 stage in the Snowflake account. This is written in the following format:
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appflow-connectorprofile-snowflakeconnectorprofileproperties.html#cfn-appflow-connectorprofile-snowflakeconnectorprofileproperties-privatelinkservicename)
             */
            override fun privateLinkServiceName(): String? =
             ...
             *
             * This is written in the following format: &lt; Database&gt;&lt; Schema&gt;<Stage
             * Name>.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appflow-connectorprofile-snowflakeconnectorprofileproperties.html#cfn-appflow-connectorprofile-snowflakeconnectorprofileproperties-stage)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SnowflakeConnectorProfilePropertiesProperty
            ): software.amazon.awscdk.services.appflow.CfnConnectorProfile.SnowflakeConnectorProfilePropertiesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface PardotConnectorProfilePropertiesProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: PardotConnectorProfilePropertiesProperty
            ): software.amazon.awscdk.services.appflow.CfnConnectorProfile.PardotConnectorProfilePropertiesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface MarketoConnectorProfileCredentialsProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param connectorOAuthRequest Used by select connectors for which the OAuth workflow
             *   is supported, such as Salesforce, Google Analytics, Marketo, Zendesk, and Slack.
             */
            public fun connectorOAuthRequest(connectorOAuthRequest: IResolvable)
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: MarketoConnectorProfileCredentialsProperty
            ): software.amazon.awscdk.services.appflow.CfnConnectorProfile.MarketoConnectorProfileCredentialsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface VeevaConnectorProfileCredentialsProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: VeevaConnectorProfileCredentialsProperty
            ): software.amazon.awscdk.services.appflow.CfnConnectorProfile.VeevaConnectorProfileCredentialsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface GoogleAnalyticsConnectorProfileCredentialsProperty {
        ...
        public interface Builder {
            /**
             * @param accessToken The credentials used to access protected Google Analytics
             *   resources.
             */
            public fun accessToken(accessToken: String)
            ...
            /**
             * @param refreshToken The credentials used to acquire new access tokens. This is
             *   required only for OAuth2 access tokens, and is not required for OAuth1 access
             *   tokens.
             */
            public fun refreshToken(refreshToken: String)
        }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: GoogleAnalyticsConnectorProfileCredentialsProperty
            ): software.amazon.awscdk.services.appflow.CfnConnectorProfile.GoogleAnalyticsConnectorProfileCredentialsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SingularConnectorProfileCredentialsProperty {
        ...
        public interface Builder {
            /**
             * @param apiKey A unique alphanumeric identifier used to authenticate a user,
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SingularConnectorProfileCredentialsProperty
            ): software.amazon.awscdk.services.appflow.CfnConnectorProfile.SingularConnectorProfileCredentialsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SlackConnectorProfilePropertiesProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SlackConnectorProfilePropertiesProperty
            ): software.amazon.awscdk.services.appflow.CfnConnectorProfile.SlackConnectorProfilePropertiesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SalesforceConnectorProfileCredentialsProperty {
         ...
         *   the access token from Salesforce. Amazon AppFlow receives the authorization code from
         ...
         *   client secret) when it requests the access token from Salesforce. You provide these
         *   credentials to Amazon AppFlow when you define the connection to your Salesforce
         *   account.
         * * **JWT_BEARER** - Amazon AppFlow passes a JSON web token (JWT) when it requests the
         *   access token from Salesforce. You provide the JWT to Amazon AppFlow when you define the
         *   connection to your Salesforce account. When you use this grant type, you don't need to
         *   log in to your Salesforce account to authorize Amazon AppFlow to access your records.
         *
        ...
        public interface Builder {
            ...
            /**
             * @param oAuth2GrantType Specifies the OAuth 2.0 grant type that Amazon AppFlow uses
             *   when it requests an access token from Salesforce. Amazon AppFlow requires an access
             *   token each time it attempts to access your Salesforce records. You can specify one
             *   of the following values:
             * * **AUTHORIZATION_CODE** - Amazon AppFlow passes an authorization code when it
             *   requests the access token from Salesforce. Amazon AppFlow receives the
             *   authorization code from Salesforce after you log in to your Salesforce account and
             ...
             *   account.
             * * **JWT_BEARER** - Amazon AppFlow passes a JSON web token (JWT) when it requests the
             *   access token from Salesforce. You provide the JWT to Amazon AppFlow when you define
             *   the connection to your Salesforce account. When you use this grant type, you don't
             *   need to log in to your Salesforce account to authorize Amazon AppFlow to access
             *   your records.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SalesforceConnectorProfileCredentialsProperty
            ): software.amazon.awscdk.services.appflow.CfnConnectorProfile.SalesforceConnectorProfileCredentialsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CustomAuthCredentialsProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param customAuthenticationType The custom authentication type that the connector
             *   uses.
             */
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appflow-connectorprofile-customauthcredentials.html#cfn-appflow-connectorprofile-customauthcredentials-customauthenticationtype)
             */
            override fun customAuthenticationType(): String =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CustomAuthCredentialsProperty
            ): software.amazon.awscdk.services.appflow.CfnConnectorProfile.CustomAuthCredentialsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface RedshiftConnectorProfilePropertiesProperty {
         ...
         *
         * For more information, and for the polices that you attach to this role, see
        ...
        public interface Builder {
            ...
            /**
             * @param dataApiRoleArn The Amazon Resource Name (ARN) of an IAM role that permits
             *   Amazon AppFlow to access your Amazon Redshift database through the Data API. For
             *   more information, and for the polices that you attach to this role, see
             *   [Allow Amazon AppFlow to access Amazon Redshift databases with the Data API](https://docs.aws.amazon.com/appflow/latest/userguide/security_iam_service-role-policies.html#access-redshift)
             *   .
             */
            ...
            /**
             * @param isRedshiftServerless Indicates whether the connector profile defines a
             *   connection to an Amazon Redshift Serverless data warehouse.
             */
        ...
        internal constructor(
             ...
             * your Amazon Redshift database through the Data API.
             *
             * For more information, and for the polices that you attach to this role, see
             * [Allow Amazon AppFlow to access Amazon Redshift databases with the Data API](https://docs.aws.amazon.com/appflow/latest/userguide/security_iam_service-role-policies.html#access-redshift)
             * .
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RedshiftConnectorProfilePropertiesProperty
            ): software.amazon.awscdk.services.appflow.CfnConnectorProfile.RedshiftConnectorProfilePropertiesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ZendeskConnectorProfileCredentialsProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ZendeskConnectorProfileCredentialsProperty
            ): software.amazon.awscdk.services.appflow.CfnConnectorProfile.ZendeskConnectorProfileCredentialsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CustomConnectorProfileCredentialsProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param basic The basic credentials that are required for the authentication of the
             *   user.
             */
            ...
            /**
             * @param custom If the connector uses the custom authentication mechanism, this holds
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CustomConnectorProfileCredentialsProperty
            ): software.amazon.awscdk.services.appflow.CfnConnectorProfile.CustomConnectorProfileCredentialsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface VeevaConnectorProfilePropertiesProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: VeevaConnectorProfilePropertiesProperty
            ): software.amazon.awscdk.services.appflow.CfnConnectorProfile.VeevaConnectorProfilePropertiesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface OAuth2CredentialsProperty {
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("c3eb0d875de5660f896f978d3b639a614e893c8dedd762ca9248a0f3e4b08194")
            override fun oAuthRequest(
                oAuthRequest: ConnectorOAuthRequestProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: OAuth2CredentialsProperty
            ): software.amazon.awscdk.services.appflow.CfnConnectorProfile.OAuth2CredentialsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface RedshiftConnectorProfileCredentialsProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RedshiftConnectorProfileCredentialsProperty
            ): software.amazon.awscdk.services.appflow.CfnConnectorProfile.RedshiftConnectorProfileCredentialsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SAPODataConnectorProfileCredentialsProperty {
        ...
        public interface Builder {
            ...
            public fun basicAuthCredentials(
                basicAuthCredentials: BasicAuthCredentialsProperty.Builder.() -> Unit
            )
            ...
            public fun oAuthCredentials(
                oAuthCredentials: OAuthCredentialsProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun basicAuthCredentials(basicAuthCredentials: BasicAuthCredentialsProperty) {
                cdkBuilder.basicAuthCredentials(
                    basicAuthCredentials.let(BasicAuthCredentialsProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("3f3e18012316994888207e7b5a0bf13f1b43634901a4b07b06315e9e737f1681")
            override fun basicAuthCredentials(
                basicAuthCredentials: BasicAuthCredentialsProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SAPODataConnectorProfileCredentialsProperty
            ): software.amazon.awscdk.services.appflow.CfnConnectorProfile.SAPODataConnectorProfileCredentialsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface OAuth2PropertiesProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param tokenUrlCustomProperties Associates your token URL with a map of properties
             *   that you define. Use this parameter to provide any additional details that the
        ...
        private class BuilderImpl : Builder {
            ...
            override fun tokenUrlCustomProperties(tokenUrlCustomProperties: IResolvable) {
                cdkBuilder.tokenUrlCustomProperties(
                    tokenUrlCustomProperties.let(IResolvable::unwrap)
                )
            }
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appflow-connectorprofile-oauth2properties.html#cfn-appflow-connectorprofile-oauth2properties-tokenurlcustomproperties)
             */
            override fun tokenUrlCustomProperties(): Any? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: OAuth2PropertiesProperty
            ): software.amazon.awscdk.services.appflow.CfnConnectorProfile.OAuth2PropertiesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SAPODataConnectorProfilePropertiesProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param disableSso If you set this parameter to true, Amazon AppFlow bypasses the
             *   single sign-on (SSO) settings in your SAP account when it accesses your SAP OData
             *   instance.
             */
            ...
            /**
             * @param privateLinkServiceName The SAPOData Private Link service name to be used for
             *   private data transfers.
             */
            public fun privateLinkServiceName(privateLinkServiceName: String)
        }
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("234337966d9cc333f43582bd408bf7f62af955ea3e1b8cb2d39e12371af762ed")
            override fun oAuthProperties(
                oAuthProperties: OAuthPropertiesProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appflow-connectorprofile-sapodataconnectorprofileproperties.html#cfn-appflow-connectorprofile-sapodataconnectorprofileproperties-applicationservicepath)
             */
            override fun applicationServicePath(): String? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SAPODataConnectorProfilePropertiesProperty
            ): software.amazon.awscdk.services.appflow.CfnConnectorProfile.SAPODataConnectorProfilePropertiesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface InforNexusConnectorProfileCredentialsProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: InforNexusConnectorProfileCredentialsProperty
            ): software.amazon.awscdk.services.appflow.CfnConnectorProfile.InforNexusConnectorProfileCredentialsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface TrendmicroConnectorProfileCredentialsProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TrendmicroConnectorProfileCredentialsProperty
            ): software.amazon.awscdk.services.appflow.CfnConnectorProfile.TrendmicroConnectorProfileCredentialsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SlackConnectorProfileCredentialsProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SlackConnectorProfileCredentialsProperty
            ): software.amazon.awscdk.services.appflow.CfnConnectorProfile.SlackConnectorProfileCredentialsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DatadogConnectorProfileCredentialsProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param applicationKey Application keys, in conjunction with your API key, give you
             *   full access to Datadog’s programmatic API. Application keys are associated with the
        ...
        internal constructor(
             ...
             * programmatic API.
             *
             * Application keys are associated with the user account that created them. The
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DatadogConnectorProfileCredentialsProperty
            ): software.amazon.awscdk.services.appflow.CfnConnectorProfile.DatadogConnectorProfileCredentialsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface AmplitudeConnectorProfileCredentialsProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AmplitudeConnectorProfileCredentialsProperty
            ): software.amazon.awscdk.services.appflow.CfnConnectorProfile.AmplitudeConnectorProfileCredentialsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
