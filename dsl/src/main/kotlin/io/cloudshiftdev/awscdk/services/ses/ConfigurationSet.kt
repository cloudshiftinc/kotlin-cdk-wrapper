...
internal constructor(
    ...
    public open fun addEventDestination(
        ...
        unwrap(this)
            .addEventDestination(id, options.let(ConfigurationSetEventDestinationOptions::unwrap))
            .let(ConfigurationSetEventDestination::wrap)
    ...
    public open fun addEventDestination(
        ...
        addEventDestination(id, ConfigurationSetEventDestinationOptions(options))
    ...
    public interface Builder {
        ...
        /**
         * Whether to publish reputation metrics for the configuration set, such as bounce and
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.ses.ConfigurationSet =
            cdkBuilder.build()
    }
    ...
    public companion object {
        public fun fromConfigurationSetName(
            ...
            software.amazon.awscdk.services.ses.ConfigurationSet.fromConfigurationSetName(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    configurationSetName
                )
                .let(IConfigurationSet::wrap)
