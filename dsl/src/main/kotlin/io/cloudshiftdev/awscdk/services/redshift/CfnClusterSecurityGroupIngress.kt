...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param clusterSecurityGroupName The name of the security group to which the ingress rule
         *   is added.
         */
         ...
         *
         * @param ec2SecurityGroupName The EC2 security group to be added the Amazon Redshift
         *   security group.
         */
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.redshift.CfnClusterSecurityGroupIngress.Builder.create(
                scope,
                id
            )
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnClusterSecurityGroupIngress
        ): software.amazon.awscdk.services.redshift.CfnClusterSecurityGroupIngress =
            wrapped.cdkObject
    }
}
