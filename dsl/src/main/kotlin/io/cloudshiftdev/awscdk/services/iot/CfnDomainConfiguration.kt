...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.iot.CfnDomainConfiguration,
    ...
    public open fun domainConfigurationStatus(): String? =
        unwrap(this).getDomainConfigurationStatus()
    ...
    /** The ARNs of the certificates that AWS IoT passes to the device during the TLS handshake. */
    public open fun serverCertificateArns(): List<String> =
        unwrap(this).getServerCertificateArns() ?: emptyList()
    ...
    public open fun serverCertificateConfig(`value`: ServerCertificateConfigProperty) {
        unwrap(this)
            .setServerCertificateConfig(`value`.let(ServerCertificateConfigProperty::unwrap))
    }

    /** The server certificate configuration. */
    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("61b5c03c59bdca05b84baed94e338847989f1969a636792a06676085707e4803")
    public open fun serverCertificateConfig(
        `value`: ServerCertificateConfigProperty.Builder.() -> Unit
    ): Unit = serverCertificateConfig(ServerCertificateConfigProperty(`value`))
    ...
    public interface Builder {
         ...
         *
         * @param serverCertificateArns The ARNs of the certificates that AWS IoT passes to the
         *   device during the TLS handshake.
         */
        ...
        public fun serverCertificateConfig(
            serverCertificateConfig: ServerCertificateConfigProperty.Builder.() -> Unit
        )
         ...
         *
         * @param validationCertificateArn The certificate used to validate the server certificate
         *   and prove domain name ownership.
         */
    ...
    private class BuilderImpl(
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("ce4759ae749a4e31a1c4dd04b7986e8d3ab600f3d189c96aff7f6df92ee08972")
        override fun authorizerConfig(
            authorizerConfig: AuthorizerConfigProperty.Builder.() -> Unit
         ...
         * @param serverCertificateConfig The server certificate configuration.
         */
        override fun serverCertificateConfig(
            serverCertificateConfig: ServerCertificateConfigProperty
        ) {
            cdkBuilder.serverCertificateConfig(
                serverCertificateConfig.let(ServerCertificateConfigProperty::unwrap)
            )
        }
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnDomainConfiguration
    ...
    public interface ServerCertificateConfigProperty {
        ...
        public interface Builder {
            /**
             * @param enableOcspCheck A Boolean value that indicates whether Online Certificate
             *   Status Protocol (OCSP) server certificate check is enabled or not. For more
             *   information, see
             *   [Configurable endpoints](https://docs.aws.amazon.com//iot/latest/developerguide/iot-custom-endpoints-configurable.html)
             *   from the AWS IoT Core Developer Guide.
             */
        ...
        internal constructor(
            ...
            /**
             * A Boolean value that indicates whether Online Certificate Status Protocol (OCSP)
             * server certificate check is enabled or not.
             *
             * For more information, see
             * [Configurable endpoints](https://docs.aws.amazon.com//iot/latest/developerguide/iot-custom-endpoints-configurable.html)
             * from the AWS IoT Core Developer Guide.
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ServerCertificateConfigProperty
            ): software.amazon.awscdk.services.iot.CfnDomainConfiguration.ServerCertificateConfigProperty =
    ...
    public interface AuthorizerConfigProperty {
        ...
        public interface Builder {
            /**
             * @param allowAuthorizerOverride A Boolean that specifies whether the domain
             *   configuration's authorization service can be overridden.
             */
        ...
        internal constructor(
            ...
            /**
             * A Boolean that specifies whether the domain configuration's authorization service can
             * be overridden.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-iot-domainconfiguration-authorizerconfig.html#cfn-iot-domainconfiguration-authorizerconfig-allowauthorizeroverride)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AuthorizerConfigProperty
            ): software.amazon.awscdk.services.iot.CfnDomainConfiguration.AuthorizerConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface TlsConfigProperty {
        ...
        public interface Builder {
            /**
             * @param securityPolicy The security policy for a domain configuration. For more
             *   information, see
             *   [Security policies](https://docs.aws.amazon.com/iot/latest/developerguide/transport-security.html#tls-policy-table)
             *   in the *AWS IoT Core developer guide* .
             */
    ...
    public interface ServerCertificateSummaryProperty {
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-iot-domainconfiguration-servercertificatesummary.html#cfn-iot-domainconfiguration-servercertificatesummary-servercertificatestatus)
             */
            override fun serverCertificateStatus(): String? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ServerCertificateSummaryProperty
            ): software.amazon.awscdk.services.iot.CfnDomainConfiguration.ServerCertificateSummaryProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
