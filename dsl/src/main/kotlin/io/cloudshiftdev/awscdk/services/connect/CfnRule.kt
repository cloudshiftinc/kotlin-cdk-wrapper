...
internal constructor(
    ...
    public open fun triggerEventSource(
        `value`: RuleTriggerEventSourceProperty.Builder.() -> Unit
    ...
    public interface Builder {
        ...
        public fun triggerEventSource(
            triggerEventSource: RuleTriggerEventSourceProperty.Builder.() -> Unit
        )
    }
    ...
    private class BuilderImpl(
        ...
        override fun triggerEventSource(triggerEventSource: RuleTriggerEventSourceProperty) {
            cdkBuilder.triggerEventSource(
                triggerEventSource.let(RuleTriggerEventSourceProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("6770d60045eb707d2cdb9bcff23a919cdb0a4e29565bdf23cd7e7d4705b72a81")
        override fun triggerEventSource(
            triggerEventSource: RuleTriggerEventSourceProperty.Builder.() -> Unit
    ...
    public interface FieldValueProperty {
        ...
        internal constructor(
            internal val cdkObject:
                software.amazon.awscdk.services.connect.CfnRule.FieldValueProperty,
        ) : FieldValueProperty {
            /**
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-connect-rule-fieldvalue.html#cfn-connect-rule-fieldvalue-booleanvalue)
             */
    ...
    public interface UpdateCaseActionProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: UpdateCaseActionProperty
            ): software.amazon.awscdk.services.connect.CfnRule.UpdateCaseActionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface FieldProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: FieldProperty
            ): software.amazon.awscdk.services.connect.CfnRule.FieldProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CreateCaseActionProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CreateCaseActionProperty
            ): software.amazon.awscdk.services.connect.CfnRule.CreateCaseActionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface RuleTriggerEventSourceProperty {
         ...
         */
        public fun integrationAssociationArn(): String? =
        ...
        public interface Builder {
             ...
             *   association. `IntegrationAssociationArn` is required if `TriggerEventSource` is one
        ...
        internal constructor(
             ...
             * The Amazon Resource Name (ARN) of the integration association.
             *
             * `IntegrationAssociationArn` is required if `TriggerEventSource` is one of the
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RuleTriggerEventSourceProperty
            ): software.amazon.awscdk.services.connect.CfnRule.RuleTriggerEventSourceProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface TaskActionProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param description The description. Supports variable injection. For more
             *   information, see
             *   [JSONPath reference](https://docs.aws.amazon.com/connect/latest/adminguide/contact-lens-variable-injection.html)
             *   in the *Amazon Connect Administrators Guide* .
             */
             ...
             *   Otherwise, null. `URL` is the only accepted type. (Supports variable injection in
             *   the `Value` field.)
             */
    ...
    public interface SendNotificationActionProperty {
        ...
        public interface Builder {
            /**
             * @param content Notification content. Supports variable injection. For more
             *   information, see
             *   [JSONPath reference](https://docs.aws.amazon.com/connect/latest/adminguide/contact-lens-variable-injection.html)
             *   in the *Amazon Connect Administrators Guide* .
             */
            ...
            /**
             * @param subject The subject of the email if the delivery method is `EMAIL` . Supports
        ...
        private class BuilderImpl : Builder {
            ...
            override fun recipient(
                recipient: NotificationRecipientTypeProperty.Builder.() -> Unit
            ): Unit = recipient(NotificationRecipientTypeProperty(recipient))
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SendNotificationActionProperty
            ): software.amazon.awscdk.services.connect.CfnRule.SendNotificationActionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface EventBridgeActionProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: EventBridgeActionProperty
            ): software.amazon.awscdk.services.connect.CfnRule.EventBridgeActionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ReferenceProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param value A valid value for the reference. For example, for a URL reference, a
             *   formatted URL that is displayed to an agent in the Contact Control Panel (CCP).
             */
        ...
        internal constructor(
            internal val cdkObject:
                software.amazon.awscdk.services.connect.CfnRule.ReferenceProperty,
        ) : ReferenceProperty {
            /**
             * The type of the reference. `DATE` must be of type Epoch timestamp.
             *
             ...
             * A valid value for the reference.
             *
             * For example, for a URL reference, a formatted URL that is displayed to an agent in
    ...
    public interface NotificationRecipientTypeProperty {
         ...
         * The tags used to organize, track, or control access for this resource.
         *
         * For example, { "tags": {"key1":"value1", "key2":"value2"} }. Amazon Connect users with
         * the specified tags will be notified.
         *
        ...
        public interface Builder {
            ...
            /**
             * @param userTags The tags used to organize, track, or control access for this
             *   resource. For example, { "tags": {"key1":"value1", "key2":"value2"} }. Amazon
        ...
        internal constructor(
             ...
             * The tags used to organize, track, or control access for this resource.
             *
             * For example, { "tags": {"key1":"value1", "key2":"value2"} }. Amazon Connect users
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: NotificationRecipientTypeProperty
            ): software.amazon.awscdk.services.connect.CfnRule.NotificationRecipientTypeProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ActionsProperty {
         ...
         */
        public fun assignContactCategoryActions(): Any? =
        ...
        private class BuilderImpl : Builder {
             ...
             *   The syntax can be empty, for example, `{}` .
             */
            override fun assignContactCategoryActions(
                vararg assignContactCategoryActions: Any
            ): Unit = assignContactCategoryActions(assignContactCategoryActions.toList())
            ...
            override fun assignContactCategoryActions(assignContactCategoryActions: IResolvable) {
                cdkBuilder.assignContactCategoryActions(
                    assignContactCategoryActions.let(IResolvable::unwrap)
                )
            }
            ...
            override fun endAssociatedTasksActions(endAssociatedTasksActions: IResolvable) {
                cdkBuilder.endAssociatedTasksActions(
                    endAssociatedTasksActions.let(IResolvable::unwrap)
                )
            }
             ...
             *   `OnZendeskTicketStatusUpdate` | `OnSalesforceCaseCreate`
             */
            override fun taskActions(vararg taskActions: Any): Unit =
                taskActions(taskActions.toList())
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-connect-rule-actions.html#cfn-connect-rule-actions-endassociatedtasksactions)
             */
            override fun endAssociatedTasksActions(): Any? =
