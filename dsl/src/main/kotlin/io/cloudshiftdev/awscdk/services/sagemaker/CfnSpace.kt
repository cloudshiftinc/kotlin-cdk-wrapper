...
internal constructor(
     ...
     * authentication, users can navigate to the URL after appending the respective redirect
     * parameter for the application type to be federated through AWS IAM Identity Center.
     *
    ...
    public open fun spaceSharingSettings(
        `value`: SpaceSharingSettingsProperty.Builder.() -> Unit
    ...
    public interface Builder {
        ...
        public fun ownershipSettings(
            ownershipSettings: OwnershipSettingsProperty.Builder.() -> Unit
        )
        ...
        public fun spaceSharingSettings(
            spaceSharingSettings: SpaceSharingSettingsProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("acff03d049c60e7437e3b8b96be6700c9699cbb5404ff8c2ee976cd2f854490a")
        override fun ownershipSettings(
            ownershipSettings: OwnershipSettingsProperty.Builder.() -> Unit
        ...
        override fun spaceSharingSettings(spaceSharingSettings: SpaceSharingSettingsProperty) {
            cdkBuilder.spaceSharingSettings(
                spaceSharingSettings.let(SpaceSharingSettingsProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("08def4189b469d2edc8bfea2b451f8f7a9ad8bd03172f1f72dbbf334be9460a7")
        override fun spaceSharingSettings(
            spaceSharingSettings: SpaceSharingSettingsProperty.Builder.() -> Unit
    ...
    public interface SpaceSharingSettingsProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SpaceSharingSettingsProperty
            ): software.amazon.awscdk.services.sagemaker.CfnSpace.SpaceSharingSettingsProperty =
    ...
    public interface JupyterServerAppSettingsProperty {
        ...
        public interface Builder {
             ...
             *   (ARN) of the default SageMaker image used by the JupyterServer app. If you use the
    ...
    public interface SpaceJupyterLabAppSettingsProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SpaceJupyterLabAppSettingsProperty
            ): software.amazon.awscdk.services.sagemaker.CfnSpace.SpaceJupyterLabAppSettingsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface EbsStorageSettingsProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: EbsStorageSettingsProperty
            ): software.amazon.awscdk.services.sagemaker.CfnSpace.EbsStorageSettingsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface OwnershipSettingsProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: OwnershipSettingsProperty
            ): software.amazon.awscdk.services.sagemaker.CfnSpace.OwnershipSettingsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SpaceSettingsProperty {
        ...
        public interface Builder {
            ...
            public fun codeEditorAppSettings(
                codeEditorAppSettings: SpaceCodeEditorAppSettingsProperty.Builder.() -> Unit
            )

            /**
             * @param customFileSystems A file system, created by you, that you assign to a space
            ...
            public fun jupyterLabAppSettings(
                jupyterLabAppSettings: SpaceJupyterLabAppSettingsProperty.Builder.() -> Unit
            )
            ...
            public fun spaceStorageSettings(
                spaceStorageSettings: SpaceStorageSettingsProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun codeEditorAppSettings(
                ...
                cdkBuilder.codeEditorAppSettings(
                    codeEditorAppSettings.let(SpaceCodeEditorAppSettingsProperty::unwrap)
                )
            }
            ...
            override fun codeEditorAppSettings(
                ...
                codeEditorAppSettings(SpaceCodeEditorAppSettingsProperty(codeEditorAppSettings))
            ...
            override fun jupyterLabAppSettings(
                ...
                cdkBuilder.jupyterLabAppSettings(
                    jupyterLabAppSettings.let(SpaceJupyterLabAppSettingsProperty::unwrap)
                )
            }
            ...
            override fun jupyterLabAppSettings(
                ...
                jupyterLabAppSettings(SpaceJupyterLabAppSettingsProperty(jupyterLabAppSettings))
            ...
            override fun spaceStorageSettings(spaceStorageSettings: SpaceStorageSettingsProperty) {
                cdkBuilder.spaceStorageSettings(
                    spaceStorageSettings.let(SpaceStorageSettingsProperty::unwrap)
                )
            }
    ...
    public interface SpaceStorageSettingsProperty {
        ...
        public interface Builder {
            ...
            public fun ebsStorageSettings(
                ebsStorageSettings: EbsStorageSettingsProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun ebsStorageSettings(ebsStorageSettings: EbsStorageSettingsProperty) {
                cdkBuilder.ebsStorageSettings(
                    ebsStorageSettings.let(EbsStorageSettingsProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("685af989ba2409bea91c1c7183d1e017811b8406dc2cb03fc45796cc3adf4da3")
            override fun ebsStorageSettings(
                ebsStorageSettings: EbsStorageSettingsProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SpaceStorageSettingsProperty
            ): software.amazon.awscdk.services.sagemaker.CfnSpace.SpaceStorageSettingsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CustomFileSystemProperty {
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("725ca5e0d45e073f9dc82a5b9c4d49c124c28a0ae1d82214e51e13314304bc14")
            override fun efsFileSystem(
                efsFileSystem: EFSFileSystemProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CustomFileSystemProperty
            ): software.amazon.awscdk.services.sagemaker.CfnSpace.CustomFileSystemProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SpaceCodeEditorAppSettingsProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SpaceCodeEditorAppSettingsProperty
            ): software.amazon.awscdk.services.sagemaker.CfnSpace.SpaceCodeEditorAppSettingsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
