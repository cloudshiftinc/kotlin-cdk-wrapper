...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.docdbelastic.CfnCluster,
    ...
    public interface Builder {
         ...
         *
         * @param adminUserPassword The password for the Elastic DocumentDB cluster administrator
         *   and can contain any printable ASCII characters.
         */
         ...
         *   used for accessing the elastic cluster.
         */
         ...
         * that KMS creates for your account. Your account has a different default encryption key
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.docdbelastic.CfnCluster =
            cdkBuilder.build()
    }
