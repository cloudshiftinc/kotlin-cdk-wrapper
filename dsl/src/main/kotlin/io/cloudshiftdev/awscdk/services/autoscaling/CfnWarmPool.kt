...
internal constructor(
    ...
    public open fun instanceReusePolicy(
        `value`: InstanceReusePolicyProperty.Builder.() -> Unit
    ): Unit = instanceReusePolicy(InstanceReusePolicyProperty(`value`))
    ...
    public interface Builder {
        ...
        public fun instanceReusePolicy(
            instanceReusePolicy: InstanceReusePolicyProperty.Builder.() -> Unit
        )
         ...
         *
         * @param maxGroupPreparedCapacity Specifies the maximum number of instances that are
    ...
    private class BuilderImpl(
        ...
        override fun instanceReusePolicy(instanceReusePolicy: InstanceReusePolicyProperty) {
            cdkBuilder.instanceReusePolicy(
                instanceReusePolicy.let(InstanceReusePolicyProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("a2ff5f96c2ab03a54304029bc8d707c33d8e1684eb458cf69a86659ee2f20bc8")
        override fun instanceReusePolicy(
            instanceReusePolicy: InstanceReusePolicyProperty.Builder.() -> Unit
        ...
        public fun build(): software.amazon.awscdk.services.autoscaling.CfnWarmPool =
            cdkBuilder.build()
    }
    ...
    public interface InstanceReusePolicyProperty {
        ...
        public interface Builder {
            /**
             * @param reuseOnScaleIn Specifies whether instances in the Auto Scaling group can be
             *   returned to the warm pool on scale in.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: InstanceReusePolicyProperty
            ): software.amazon.awscdk.services.autoscaling.CfnWarmPool.InstanceReusePolicyProperty =
