...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.ecs.BaseService,
) :
    Resource(cdkObject),
    IBaseService,
    ...
    public open fun associateCloudMapService(
        options: AssociateCloudMapServiceOptions.Builder.() -> Unit
    ): Unit = associateCloudMapService(AssociateCloudMapServiceOptions(options))

    /**
     * This method is called to attach this service to an Application Load Balancer.
     *
     * Don't call this function directly. Instead, call `listener.addTargets()` to add this service
     * to a load balancer.
     *
     * @param targetGroup
     */
    ...
    public open fun autoScaleTaskCount(props: EnableScalingProps): ScalableTaskCount =
        unwrap(this)
            .autoScaleTaskCount(props.let(EnableScalingProps::unwrap))
    ...
    public open fun autoScaleTaskCount(
     ...
     *
     * New alarms specified in subsequent calls of this function will be appended to the existing
     * list of alarms.
     *
     * The same Alarm Behavior must be used on all deployment alarms. If you specify different
     * AlarmBehavior values in multiple calls to this function, or the Alarm Behavior used here
     * doesn't match the one used in the service constructor, an error will be thrown.
     *
     * If the alarm's metric references the service, you cannot pass `Alarm.alarmName` here. That
     * will cause a circular dependency between the service and its deployment alarm. See this
     * package's README for options to alarm on service metrics, and avoid this circular dependency.
     *
     * @param alarmNames
     * @param options
     */
     ...
     * @param options
     */
    public open fun enableDeploymentAlarms(
    ...
    public open fun enableDeploymentAlarms(
        alarmNames: List<String>,
        options: DeploymentAlarmOptions.Builder.() -> Unit
    ): Unit = enableDeploymentAlarms(alarmNames, DeploymentAlarmOptions(options))
    ...
    public open fun loadBalancerTarget(options: LoadBalancerTargetOptions): IEcsLoadBalancerTarget =
        unwrap(this)
            .loadBalancerTarget(options.let(LoadBalancerTargetOptions::unwrap))
    ...
    public open fun loadBalancerTarget(
        options: LoadBalancerTargetOptions.Builder.() -> Unit
    ...
    internal constructor(
        internal val cdkObject: software.amazon.awscdk.services.ecs.BaseService,
    ...
    public companion object {
        public fun fromServiceArnWithCluster(
            ...
            software.amazon.awscdk.services.ecs.BaseService.fromServiceArnWithCluster(
