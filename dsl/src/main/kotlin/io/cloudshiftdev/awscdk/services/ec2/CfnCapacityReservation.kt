...
internal constructor(
    ...
    /**
     * Returns the remaining capacity, which indicates the number of instances that can be launched
    ...
    public interface Builder {
         ...
         *
         * @param availabilityZone The Availability Zone in which to create the Capacity
         *   Reservation.
         */
         ...
         * The date and time at which the Capacity Reservation expires.
         *
         * When a Capacity Reservation expires, the reserved capacity is released and you can no
         * longer launch instances into it. The Capacity Reservation's state changes to `expired`
         ...
         *
         * @param tenancy Indicates the tenancy of the Capacity Reservation. A Capacity Reservation
