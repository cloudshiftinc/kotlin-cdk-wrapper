...
internal constructor(
    ...
    public open fun allowFrom(
        ...
        unwrap(this)
            .allowFrom(other.let(IConnectable::unwrap), portRange.let(Port::unwrap), description)
    }
    ...
    public open fun allowTo(
        ...
        unwrap(this)
            .allowTo(other.let(IConnectable::unwrap), portRange.let(Port::unwrap), description)
    }
    ...
    public interface Builder {
         ...
         *
         * @param peer Class that represents the rule by which others can connect to this
         *   connectable.
         */
