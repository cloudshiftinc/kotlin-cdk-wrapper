...
public enum class DefaultResult(
    ...
    public companion object {
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.autoscaling.DefaultResult
        ): DefaultResult =
            when (cdkObject) {
                software.amazon.awscdk.services.autoscaling.DefaultResult.CONTINUE ->
                    DefaultResult.CONTINUE
                software.amazon.awscdk.services.autoscaling.DefaultResult.ABANDON ->
                    DefaultResult.ABANDON
            }

        internal fun unwrap(
            wrapped: DefaultResult
