...
public open class CfnFunctionDefinition
internal constructor(
    ...
    public open fun initialVersion(
        `value`: FunctionDefinitionVersionProperty.Builder.() -> Unit
    ...
    public interface Builder {
         ...
         *
         * @param initialVersion The function definition version to include when the function
        ...
        public fun initialVersion(
            initialVersion: FunctionDefinitionVersionProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.greengrass.CfnFunctionDefinition.Builder.create(
                scope,
                id
            )
    ...
    public companion object {
        ...
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.greengrass.CfnFunctionDefinition
        ): CfnFunctionDefinition = CfnFunctionDefinition(cdkObject)

        internal fun unwrap(
            wrapped: CfnFunctionDefinition
    ...
    public interface RunAsProperty {
        ...
        public interface Builder {
            /**
             * @param gid The group ID whose permissions are used to run the Lambda function. You
             *   can use the `getent group` command on your core device to look up the group ID.
             */
            public fun gid(gid: Number)

            /**
             * @param uid The user ID whose permissions are used to run the Lambda function. You can
             *   use the `getent passwd` command on your core device to look up the user ID.
             */
    ...
    public interface EnvironmentProperty {
        ...
        public interface Builder {
            /**
             * @param accessSysfs Indicates whether the function is allowed to access the `/sys`
             ...
             *   [resources](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-greengrass-resourcedefinitionversion-resourceinstance.html)
             *   in the group that the function can access, with the corresponding read-only or
    ...
    public interface FunctionDefinitionVersionProperty {
        ...
        public interface Builder {
            /**
             * @param defaultConfig The default configuration that applies to all Lambda functions
        ...
        private class BuilderImpl : Builder {
            private val cdkBuilder:
                ...
                software.amazon.awscdk.services.greengrass.CfnFunctionDefinition
            ...
            override fun defaultConfig(
                defaultConfig: DefaultConfigProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: FunctionDefinitionVersionProperty
            ): software.amazon.awscdk.services.greengrass.CfnFunctionDefinition.FunctionDefinitionVersionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DefaultConfigProperty {
        /**
         * Configuration settings for the Lambda execution environment on the AWS IoT Greengrass
         * core.
         *
        ...
        public interface Builder {
            /**
             * @param execution Configuration settings for the Lambda execution environment on the
    ...
    public interface ResourceAccessPolicyProperty {
        ...
        public interface Builder {
            /**
             * @param permission The read-only or read-write access that the Lambda function has to
             *   the resource. Valid values are `ro` or `rw` .
             */
            public fun permission(permission: String)

            /**
             * @param resourceId The ID of the resource. This ID is assigned to the resource when
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ResourceAccessPolicyProperty
            ): software.amazon.awscdk.services.greengrass.CfnFunctionDefinition.ResourceAccessPolicyProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface FunctionConfigurationProperty {
         ...
         *
         * Pinned functions start when the core starts and process all requests in the same
        ...
        public interface Builder {
            ...
            /**
             * @param pinned Indicates whether the function is pinned (or *long-lived* ). Pinned
             *   functions start when the core starts and process all requests in the same
             *   container. The default value is false.
             */
            ...
            /**
             * @param timeout The allowed execution time (in seconds) after which the function
             *   should terminate. For pinned functions, this timeout applies for each request.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: FunctionConfigurationProperty
            ): software.amazon.awscdk.services.greengrass.CfnFunctionDefinition.FunctionConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface FunctionProperty {
        ...
        public interface Builder {
            /**
             * @param functionArn The Amazon Resource Name (ARN) of the alias (recommended) or
             *   version of the referenced Lambda function.
             */
            ...
            public fun functionConfiguration(
                functionConfiguration: FunctionConfigurationProperty.Builder.() -> Unit
            )

            /**
             * @param id A descriptive or arbitrary ID for the function. This value must be unique
             *   within the function definition version. Maximum length is 128 characters with
             *   pattern `[a-zA-Z0-9:_-]+` .
             */
        ...
        private class BuilderImpl : Builder {
             ...
             *   These settings configure the function's behavior in the Greengrass group.
             */
            override fun functionConfiguration(
                functionConfiguration: FunctionConfigurationProperty
            ) {
                cdkBuilder.functionConfiguration(
                    functionConfiguration.let(FunctionConfigurationProperty::unwrap)
                )
            }
        ...
        internal constructor(
            ...
            /**
             * The Amazon Resource Name (ARN) of the alias (recommended) or version of the
             ...
             * A descriptive or arbitrary ID for the function.
             *
             * This value must be unique within the function definition version. Maximum length is
    ...
    public interface ExecutionProperty {
         ...
         *   property of a function, this setting applies to the individual function and overrides
         ...
         *
         * Typically, this is the ggc_user and ggc_group. For more information, see
         ...
         *   [`Environment`](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-greengrass-functiondefinitionversion-environment.html)
         *   property of a function, this setting applies to the individual function and overrides
         *   the default. You can override the user, group, or both. Omit this value to run the
         *   function with the default permissions.
         *
         * Running as the root user increases risks to your data and device. Do not run as root
         * (UID/GID=0) unless your business case requires it. For more information and requirements,
         * see
        ...
        public interface Builder {
            /**
             * @param isolationMode The containerization that the Lambda function runs in. Valid
             *   values are `GreengrassContainer` or `NoContainer` . Typically, this is
             *   `GreengrassContainer` . For more information, see
             *   [Containerization](https://docs.aws.amazon.com/greengrass/v1/developerguide/lambda-group-config.html#lambda-function-containerization)
             *   in the *Developer Guide* .
             * * When set on the
             ...
             * * When set on the
             *   [`Environment`](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-greengrass-functiondefinitionversion-environment.html)
             *   property of a function, this setting applies to the individual function and
             ...
             *   [`DefaultConfig`](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-greengrass-functiondefinitionversion-defaultconfig.html)
             *   property of a function definition version, this setting is used as the default
             *   access identity for all Lambda functions in the function definition version.
             * * When set on the
             *   [`Environment`](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-greengrass-functiondefinitionversion-environment.html)
             *   property of a function, this setting applies to the individual function and
             *   overrides the default. You can override the user, group, or both. Omit this value
             *   to run the function with the default permissions.
             *
             * Running as the root user increases risks to your data and device. Do not run as root
