...
internal constructor(
    ...
    public interface Builder {
         ...
         * `alias/ExampleAlias` .
         *
         * If you change the value of the `AliasName` property, the existing alias is deleted and a
         * new alias is created for the specified KMS key. This change can disrupt applications that
         * use the alias. It can also allow or deny access to a KMS key affected by attribute-based
         * access control (ABAC).
         *
         ...
         * begin with `alias/aws/` . The `alias/aws/` prefix is reserved for
         ...
         *
         * @param aliasName Specifies the alias name. This value must begin with `alias/` followed
