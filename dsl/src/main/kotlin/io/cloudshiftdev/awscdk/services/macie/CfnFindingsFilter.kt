...
internal constructor(
    ...
    public interface Builder {
         ...
         * characters.
         *
         * Avoid including sensitive data in the description. Users of the account might be able to
         * see the description, depending on the actions that they're allowed to perform in Amazon
         * Macie .
         *
         ...
         *
         * @param description A custom description of the findings filter. The description can
         ...
         * to other filters that are also applied to findings.
         *
         ...
         *
         * @param position The position of the findings filter in the list of saved filter rules on
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.macie.CfnFindingsFilter =
            cdkBuilder.build()
    }
    ...
    public interface FindingsFilterListItemProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: FindingsFilterListItemProperty
            ): software.amazon.awscdk.services.macie.CfnFindingsFilter.FindingsFilterListItemProperty =
    ...
    public interface FindingCriteriaProperty {
        /**
         * Specifies a condition that defines the property, operator, and one or more values to use
        ...
        public interface Builder {
            /**
             * @param criterion Specifies a condition that defines the property, operator, and one
             *   or more values to use to filter the results.
             */
    ...
    public interface CriterionAdditionalPropertiesProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param gte The value for the specified property is greater than or equal to the
             *   specified value.
             */
            ...
            /**
             * @param lte The value for the specified property is less than or equal to the
             *   specified value.
             */
            public fun lte(lte: Number)

            /**
             * @param neq The value for the specified property doesn't match (doesn't equal) the
             *   specified value. If you specify multiple values, Amazon Macie uses OR logic to join
             *   the values.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CriterionAdditionalPropertiesProperty
            ): software.amazon.awscdk.services.macie.CfnFindingsFilter.CriterionAdditionalPropertiesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
