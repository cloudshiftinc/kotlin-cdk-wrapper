...
public enum class TagMutability(
    ...
    public companion object {
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.ecr.TagMutability
        ): TagMutability =
            when (cdkObject) {
                software.amazon.awscdk.services.ecr.TagMutability.MUTABLE -> TagMutability.MUTABLE
                software.amazon.awscdk.services.ecr.TagMutability.IMMUTABLE ->
                    TagMutability.IMMUTABLE
            }

        internal fun unwrap(
            wrapped: TagMutability
        ): software.amazon.awscdk.services.ecr.TagMutability = wrapped.cdkObject
    }
}
