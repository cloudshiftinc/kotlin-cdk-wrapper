...
internal constructor(
    ...
    /** Information about third-party services integrated into the response plan. */
    public open fun integrations(vararg __idx_ac66f0: Any): Unit =
        integrations(__idx_ac66f0.toList())
    ...
    public interface Builder {
         ...
         *
         * @param chatChannel The AWS Chatbot chat channel used for collaboration during an
         *   incident.
         */
    ...
    private class BuilderImpl(
         ...
         *   that the response plan engages during an incident.
         */
        override fun engagements(vararg engagements: String): Unit =
            engagements(engagements.toList())
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("c0e9785cd11cdaa6f6c209eb5f084c2947c773ffbb1286e908b50e3a0871eb7d")
        override fun incidentTemplate(
            incidentTemplate: IncidentTemplateProperty.Builder.() -> Unit
         ...
         *   plan.
         */
        override fun integrations(vararg integrations: Any): Unit =
    ...
    public interface NotificationTargetItemProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: NotificationTargetItemProperty
            ): software.amazon.awscdk.services.ssmincidents.CfnResponsePlan.NotificationTargetItemProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface IntegrationProperty {
        ...
        public interface Builder {
            /**
             * @param pagerDutyConfiguration Information about the PagerDuty service where the
             *   response plan creates an incident.
             */
             ...
             *   response plan creates an incident.
             */
            public fun pagerDutyConfiguration(
            ...
            public fun pagerDutyConfiguration(
                pagerDutyConfiguration: PagerDutyConfigurationProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun pagerDutyConfiguration(
                ...
                cdkBuilder.pagerDutyConfiguration(
                    pagerDutyConfiguration.let(PagerDutyConfigurationProperty::unwrap)
                )
            }
    ...
    public interface SsmAutomationProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param roleArn The Amazon Resource Name (ARN) of the role that the automation
             *   document will assume when running commands.
             */
            public fun roleArn(roleArn: String)

            /**
             * @param targetAccount The account that the automation document will be run in. This
        ...
        internal constructor(
            ...
            /**
             * The key-value pairs to resolve dynamic parameter values when processing a Systems
    ...
    public interface PagerDutyIncidentConfigurationProperty {
        /**
         * The ID of the PagerDuty service that the response plan associates with an incident when
         * it launches.
         *
        ...
        public interface Builder {
            /**
             * @param serviceId The ID of the PagerDuty service that the response plan associates
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: PagerDutyIncidentConfigurationProperty
            ): software.amazon.awscdk.services.ssmincidents.CfnResponsePlan.PagerDutyIncidentConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ActionProperty {
        ...
        public interface Builder {
            /**
             * @param ssmAutomation Details about the Systems Manager automation document that will
        ...
        private class BuilderImpl : Builder {
            ...
            override fun ssmAutomation(
                ssmAutomation: SsmAutomationProperty.Builder.() -> Unit
    ...
    public interface DynamicSsmParameterProperty {
        ...
        public interface Builder {
            /**
             * @param key The key parameter to use when running the Systems Manager Automation
             *   runbook.
             */
            public fun key(key: String)
        ...
        private class BuilderImpl : Builder {
            ...
            @JvmName("3fc880425978a155fceda534e935c6cd1c33134d904c0d20d072fa38894ebfba")
            override fun `value`(
                `value`: DynamicSsmParameterValueProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DynamicSsmParameterProperty
            ): software.amazon.awscdk.services.ssmincidents.CfnResponsePlan.DynamicSsmParameterProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DynamicSsmParameterValueProperty {
        ...
        public interface Builder {
            /**
             * @param variable Variable dynamic parameters. A parameter value is determined when an
             *   incident is created.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DynamicSsmParameterValueProperty
            ): software.amazon.awscdk.services.ssmincidents.CfnResponsePlan.DynamicSsmParameterValueProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface IncidentTemplateProperty {
         ...
         * * `5` - No impact, customers aren't currently impacted but urgent action is needed to
         *   avoid impact.
         *
         ...
         *
         * When the `StartIncident` API action is called, Incident Manager assigns the tags
         * specified in the template to the incident.
         *
        ...
        public interface Builder {
             ...
             *   impact provided by a response plan. **Possible impacts:** - `1` - Critical impact,
            ...
            /**
             * @param incidentTags Tags to assign to the template. When the `StartIncident` API
            ...
            /**
             * @param notificationTargets The Amazon Simple Notification Service ( Amazon SNS )
             *   targets that AWS Chatbot uses to notify the chat channel of updates to an incident.
             *   You can also make updates to the incident through the chat channel using the Amazon
             *   SNS topics.
             */
        ...
        internal constructor(
             ...
             *
             * **Possible impacts:** - `1` - Critical impact, this typically relates to full
            ...
            /**
             * The Amazon Simple Notification Service ( Amazon SNS ) targets that AWS Chatbot uses
             * to notify the chat channel of updates to an incident.
             *
             * You can also make updates to the incident through the chat channel using the Amazon
             * SNS topics.
             *
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: IncidentTemplateProperty
            ): software.amazon.awscdk.services.ssmincidents.CfnResponsePlan.IncidentTemplateProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ChatChannelProperty {
         ...
         * incident.
         *
         * You can also make updates to the incident through the chat channel by using the Amazon
         * SNS topics
         *
        ...
        public interface Builder {
            /**
             * @param chatbotSns The Amazon SNS targets that AWS Chatbot uses to notify the chat
             *   channel of updates to an incident. You can also make updates to the incident
        ...
        private class BuilderImpl : Builder {
             ...
             *   through the chat channel by using the Amazon SNS topics
             */
            override fun chatbotSns(vararg chatbotSns: String): Unit =
                chatbotSns(chatbotSns.toList())
        ...
        internal constructor(
            ...
            /**
             * The Amazon SNS targets that AWS Chatbot uses to notify the chat channel of updates to
             * an incident.
             *
             * You can also make updates to the incident through the chat channel by using the
             * Amazon SNS topics
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ssmincidents-responseplan-chatchannel.html#cfn-ssmincidents-responseplan-chatchannel-chatbotsns)
             */
    ...
    public interface PagerDutyConfigurationProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param pagerDutyIncidentConfiguration Details about the PagerDuty service associated
            ...
            public fun pagerDutyIncidentConfiguration(
                pagerDutyIncidentConfiguration:
                    PagerDutyIncidentConfigurationProperty.Builder.() -> Unit
            )

            /**
             * @param secretId The ID of the AWS Secrets Manager secret that stores your PagerDuty
             *   key, either a General Access REST API Key or User Token REST API Key, and other
             *   user credentials.
             */
        ...
        private class BuilderImpl : Builder {
             ...
             *   with the configuration.
             */
            override fun pagerDutyIncidentConfiguration(
                pagerDutyIncidentConfiguration: IResolvable
            ) {
                cdkBuilder.pagerDutyIncidentConfiguration(
                    pagerDutyIncidentConfiguration.let(IResolvable::unwrap)
                )
            }
            ...
            override fun pagerDutyIncidentConfiguration(
                ...
                cdkBuilder.pagerDutyIncidentConfiguration(
                    pagerDutyIncidentConfiguration.let(
                        PagerDutyIncidentConfigurationProperty::unwrap
                    )
                )
            }
            ...
            override fun pagerDutyIncidentConfiguration(
                ...
                pagerDutyIncidentConfiguration(
                    PagerDutyIncidentConfigurationProperty(pagerDutyIncidentConfiguration)
                )
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: PagerDutyConfigurationProperty
            ): software.amazon.awscdk.services.ssmincidents.CfnResponsePlan.PagerDutyConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
