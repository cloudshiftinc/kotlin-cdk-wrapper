...
internal constructor(
    ...
    public open fun memberConfiguration(
        `value`: MemberConfigurationProperty.Builder.() -> Unit
    ): Unit = memberConfiguration(MemberConfigurationProperty(`value`))
    ...
    public interface Builder {
        /**
         * The unique identifier of the invitation to join the network sent to the account that
         * creates the member.
         *
         ...
         *
         * @param invitationId The unique identifier of the invitation to join the network sent to
        ...
        public fun memberConfiguration(
            memberConfiguration: MemberConfigurationProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
        ...
        override fun memberConfiguration(memberConfiguration: MemberConfigurationProperty) {
            cdkBuilder.memberConfiguration(
                memberConfiguration.let(MemberConfigurationProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("19fa8a7d67747633bb1899828e09039b0c6804f6c4091c3bee870507b04f9ccb")
        override fun memberConfiguration(
            memberConfiguration: MemberConfigurationProperty.Builder.() -> Unit
    ...
    public interface ApprovalThresholdPolicyProperty {
         ...
         *
         * If members cast neither the required number of `YES` votes to approve the proposal nor
         * the number of `NO` votes required to reject it before the duration expires, the proposal
         * is `EXPIRED` and `ProposalActions` aren't carried out.
         *
        ...
        public interface Builder {
            /**
             * @param proposalDurationInHours The duration from the time that a proposal is created
             *   until it expires. If members cast neither the required number of `YES` votes to
             *   approve the proposal nor the number of `NO` votes required to reject it before the
             *   duration expires, the proposal is `EXPIRED` and `ProposalActions` aren't carried
             *   out.
             */
            public fun proposalDurationInHours(proposalDurationInHours: Number)

            /**
             * @param thresholdComparator Determines whether the vote percentage must be greater
             *   than the `ThresholdPercentage` or must be greater than or equal to the
             *   `ThresholdPercentage` to be approved.
             */
            public fun thresholdComparator(thresholdComparator: String)

            /**
             * @param thresholdPercentage The percentage of votes among all members that must be
             *   `YES` for a proposal to be approved. For example, a `ThresholdPercentage` value of
             *   `50` indicates 50%. The `ThresholdComparator` determines the precise comparison. If
             *   a `ThresholdPercentage` value of `50` is specified on a network with 10 members,
        ...
        internal constructor(
             ...
             * The duration from the time that a proposal is created until it expires.
             *
             * If members cast neither the required number of `YES` votes to approve the proposal
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-managedblockchain-member-approvalthresholdpolicy.html#cfn-managedblockchain-member-approvalthresholdpolicy-proposaldurationinhours)
             */
            override fun proposalDurationInHours(): Number? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ApprovalThresholdPolicyProperty
            ): software.amazon.awscdk.services.managedblockchain.CfnMember.ApprovalThresholdPolicyProperty =
    ...
    public interface MemberConfigurationProperty {
         ...
         */
        public fun memberFrameworkConfiguration(): Any? =
        ...
        public interface Builder {
            ...
            /**
             * @param memberFrameworkConfiguration Configuration properties of the blockchain
             *   framework relevant to the member.
             */
            ...
            public fun memberFrameworkConfiguration(
                memberFrameworkConfiguration:
                    MemberFrameworkConfigurationProperty.Builder.() -> Unit
            )
        ...
        private class BuilderImpl : Builder {
            ...
            override fun memberFrameworkConfiguration(memberFrameworkConfiguration: IResolvable) {
                cdkBuilder.memberFrameworkConfiguration(
                    memberFrameworkConfiguration.let(IResolvable::unwrap)
                )
            }
             ...
             *   framework relevant to the member.
             */
            override fun memberFrameworkConfiguration(
                memberFrameworkConfiguration: MemberFrameworkConfigurationProperty
            ) {
                cdkBuilder.memberFrameworkConfiguration(
                    memberFrameworkConfiguration.let(MemberFrameworkConfigurationProperty::unwrap)
                )
            }
            ...
            override fun memberFrameworkConfiguration(
                ...
                memberFrameworkConfiguration(
                    MemberFrameworkConfigurationProperty(memberFrameworkConfiguration)
                )
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: MemberConfigurationProperty
            ): software.amazon.awscdk.services.managedblockchain.CfnMember.MemberConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface NetworkConfigurationProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param frameworkVersion The version of the blockchain framework that the network
             *   uses.
             */
            ...
            /**
             * @param networkFrameworkConfiguration Configuration properties relevant to the network
             *   for the blockchain framework that the network uses.
             */
            ...
            public fun networkFrameworkConfiguration(
                networkFrameworkConfiguration:
                    NetworkFrameworkConfigurationProperty.Builder.() -> Unit
            )
        ...
        private class BuilderImpl : Builder {
            ...
            override fun networkFrameworkConfiguration(networkFrameworkConfiguration: IResolvable) {
                cdkBuilder.networkFrameworkConfiguration(
                    networkFrameworkConfiguration.let(IResolvable::unwrap)
                )
            }
             ...
             *   for the blockchain framework that the network uses.
             */
            override fun networkFrameworkConfiguration(
                networkFrameworkConfiguration: NetworkFrameworkConfigurationProperty
            ) {
                cdkBuilder.networkFrameworkConfiguration(
                    networkFrameworkConfiguration.let(NetworkFrameworkConfigurationProperty::unwrap)
                )
            }
            ...
            override fun networkFrameworkConfiguration(
                ...
                networkFrameworkConfiguration(
                    NetworkFrameworkConfigurationProperty(networkFrameworkConfiguration)
                )
    ...
    public interface NetworkFabricConfigurationProperty {
         ...
         * [Amazon Managed Blockchain Pricing](https://docs.aws.amazon.com/managed-blockchain/pricing/)
         *
        ...
        public interface Builder {
            /**
             * @param edition The edition of Amazon Managed Blockchain that the network uses. Valid
             *   values are `standard` and `starter` . For more information, see
             *   [Amazon Managed Blockchain Pricing](https://docs.aws.amazon.com/managed-blockchain/pricing/)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: NetworkFabricConfigurationProperty
            ): software.amazon.awscdk.services.managedblockchain.CfnMember.NetworkFabricConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface VotingPolicyProperty {
        ...
        public interface Builder {
            /**
             * @param approvalThresholdPolicy Defines the rules for the network for voting on
             *   proposals, such as the percentage of `YES` votes required for the proposal to be
             *   approved and the duration of the proposal. The policy applies to all proposals and
            ...
            public fun approvalThresholdPolicy(
                approvalThresholdPolicy: ApprovalThresholdPolicyProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
             ...
             *   is specified when the network is created.
             */
            override fun approvalThresholdPolicy(
                approvalThresholdPolicy: ApprovalThresholdPolicyProperty
            ) {
                cdkBuilder.approvalThresholdPolicy(
                    approvalThresholdPolicy.let(ApprovalThresholdPolicyProperty::unwrap)
                )
            }
            ...
            override fun approvalThresholdPolicy(
                ...
                approvalThresholdPolicy(ApprovalThresholdPolicyProperty(approvalThresholdPolicy))
        ...
        internal constructor(
            ...
            /**
             * Defines the rules for the network for voting on proposals, such as the percentage of
             * `YES` votes required for the proposal to be approved and the duration of the
             * proposal.
             *
             * The policy applies to all proposals and is specified when the network is created.
             *
    ...
    public interface MemberFrameworkConfigurationProperty {
        ...
        public interface Builder {
            ...
            public fun memberFabricConfiguration(
                memberFabricConfiguration: MemberFabricConfigurationProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun memberFabricConfiguration(memberFabricConfiguration: IResolvable) {
                cdkBuilder.memberFabricConfiguration(
                    memberFabricConfiguration.let(IResolvable::unwrap)
                )
            }

            /** @param memberFabricConfiguration Configuration properties for Hyperledger Fabric. */
            override fun memberFabricConfiguration(
                memberFabricConfiguration: MemberFabricConfigurationProperty
            ) {
                cdkBuilder.memberFabricConfiguration(
                    memberFabricConfiguration.let(MemberFabricConfigurationProperty::unwrap)
                )
            }
            ...
            override fun memberFabricConfiguration(
                ...
                memberFabricConfiguration(
                    MemberFabricConfigurationProperty(memberFabricConfiguration)
                )
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-managedblockchain-member-memberframeworkconfiguration.html#cfn-managedblockchain-member-memberframeworkconfiguration-memberfabricconfiguration)
             */
            override fun memberFabricConfiguration(): Any? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: MemberFrameworkConfigurationProperty
            ): software.amazon.awscdk.services.managedblockchain.CfnMember.MemberFrameworkConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface MemberFabricConfigurationProperty {
         ...
         * must contain at least one uppercase letter, one lowercase letter, and one digit. It
         * cannot have a single quotation mark (‘), a double quotation marks (“), a forward
         * slash(/), a backward slash(),
         *
        ...
        public interface Builder {
            /**
             * @param adminPassword The password for the member's initial administrative user. The
             *   `AdminPassword` must be at least 8 characters long and no more than 32 characters.
             *   It must contain at least one uppercase letter, one lowercase letter, and one digit.
             *   It cannot have a single quotation mark (‘), a double quotation marks (“), a forward
             *   slash(/), a backward slash(),
             */
        ...
        internal constructor(
             ...
             * The password for the member's initial administrative user.
             *
             * The `AdminPassword` must be at least 8 characters long and no more than 32
             * characters. It must contain at least one uppercase letter, one lowercase letter, and
             * one digit. It cannot have a single quotation mark (‘), a double quotation marks (“),
             * a forward slash(/), a backward slash(),
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-managedblockchain-member-memberfabricconfiguration.html#cfn-managedblockchain-member-memberfabricconfiguration-adminpassword)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: MemberFabricConfigurationProperty
            ): software.amazon.awscdk.services.managedblockchain.CfnMember.MemberFabricConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface NetworkFrameworkConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param networkFabricConfiguration Configuration properties for Hyperledger Fabric for
             *   a member in a Managed Blockchain network that is using the Hyperledger Fabric
             *   framework.
             */
            ...
            public fun networkFabricConfiguration(
                networkFabricConfiguration: NetworkFabricConfigurationProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun networkFabricConfiguration(networkFabricConfiguration: IResolvable) {
                cdkBuilder.networkFabricConfiguration(
                    networkFabricConfiguration.let(IResolvable::unwrap)
                )
            }
             ...
             *   framework.
             */
            override fun networkFabricConfiguration(
                networkFabricConfiguration: NetworkFabricConfigurationProperty
            ) {
                cdkBuilder.networkFabricConfiguration(
                    networkFabricConfiguration.let(NetworkFabricConfigurationProperty::unwrap)
                )
            }
            ...
            override fun networkFabricConfiguration(
                ...
                networkFabricConfiguration(
                    NetworkFabricConfigurationProperty(networkFabricConfiguration)
                )
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-managedblockchain-member-networkframeworkconfiguration.html#cfn-managedblockchain-member-networkframeworkconfiguration-networkfabricconfiguration)
             */
            override fun networkFabricConfiguration(): Any? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: NetworkFrameworkConfigurationProperty
            ): software.amazon.awscdk.services.managedblockchain.CfnMember.NetworkFrameworkConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
