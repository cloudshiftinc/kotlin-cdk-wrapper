...
internal constructor(
    ...
    public open fun dataCatalogEncryptionSettings(`value`: DataCatalogEncryptionSettingsProperty) {
        unwrap(this)
            .setDataCatalogEncryptionSettings(
                `value`.let(DataCatalogEncryptionSettingsProperty::unwrap)
            )
    }
    ...
    public open fun dataCatalogEncryptionSettings(
        `value`: DataCatalogEncryptionSettingsProperty.Builder.() -> Unit
     ...
     * [io.cloudshiftdev.awscdk.services.glue.CfnDataCatalogEncryptionSettings].
     */
    @CdkDslMarker
    public interface Builder {
         ...
         *
         * @param dataCatalogEncryptionSettings Contains configuration information for maintaining
        ...
        public fun dataCatalogEncryptionSettings(
            dataCatalogEncryptionSettings: DataCatalogEncryptionSettingsProperty.Builder.() -> Unit
        )
    }
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.glue.CfnDataCatalogEncryptionSettings.Builder.create(
                scope,
                id
            )
        ...
        override fun dataCatalogEncryptionSettings(dataCatalogEncryptionSettings: IResolvable) {
            cdkBuilder.dataCatalogEncryptionSettings(
                dataCatalogEncryptionSettings.let(IResolvable::unwrap)
            )
        }
         ...
         *   Data Catalog security.
         */
        override fun dataCatalogEncryptionSettings(
            dataCatalogEncryptionSettings: DataCatalogEncryptionSettingsProperty
        ) {
            cdkBuilder.dataCatalogEncryptionSettings(
                dataCatalogEncryptionSettings.let(DataCatalogEncryptionSettingsProperty::unwrap)
            )
        }
        ...
        override fun dataCatalogEncryptionSettings(
            ...
            dataCatalogEncryptionSettings(
                DataCatalogEncryptionSettingsProperty(dataCatalogEncryptionSettings)
            )
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnDataCatalogEncryptionSettings
    ...
    public interface EncryptionAtRestProperty {
        ...
        public interface Builder {
            /**
             * @param catalogEncryptionMode The encryption-at-rest mode for encrypting Data Catalog
             *   data.
             */
            public fun catalogEncryptionMode(catalogEncryptionMode: String)

            /**
             * @param catalogEncryptionServiceRole The role that AWS Glue assumes to encrypt and
             *   decrypt the Data Catalog objects on the caller's behalf.
             */
    ...
    public interface DataCatalogEncryptionSettingsProperty {
         ...
         * it in the `ENCRYPTED_PASSWORD` field in the connection properties.
         *
         ...
         */
        public fun connectionPasswordEncryption(): Any? =
        ...
        public interface Builder {
            /**
             * @param connectionPasswordEncryption When connection password protection is enabled,
             *   the Data Catalog uses a customer-provided key to encrypt the password as part of
            ...
            public fun connectionPasswordEncryption(
                connectionPasswordEncryption:
                    ConnectionPasswordEncryptionProperty.Builder.() -> Unit
            )
        ...
        private class BuilderImpl : Builder {
            ...
            override fun connectionPasswordEncryption(connectionPasswordEncryption: IResolvable) {
                cdkBuilder.connectionPasswordEncryption(
                    connectionPasswordEncryption.let(IResolvable::unwrap)
                )
            }
            ...
            override fun connectionPasswordEncryption(
                ...
                cdkBuilder.connectionPasswordEncryption(
                    connectionPasswordEncryption.let(ConnectionPasswordEncryptionProperty::unwrap)
                )
            }
            ...
            override fun connectionPasswordEncryption(
                ...
                connectionPasswordEncryption(
                    ConnectionPasswordEncryptionProperty(connectionPasswordEncryption)
                )
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DataCatalogEncryptionSettingsProperty
            ): software.amazon.awscdk.services.glue.CfnDataCatalogEncryptionSettings.DataCatalogEncryptionSettingsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ConnectionPasswordEncryptionProperty {
         ...
         * to encrypt passwords before storing them in the Data Catalog. You can set the decrypt
         * permission to enable or restrict access on the password key according to your security
         * requirements.
         *
        ...
        public interface Builder {
            /**
             * @param kmsKeyId An AWS KMS key that is used to encrypt the connection password. If
             *   connection password protection is enabled, the caller of `CreateConnection` and
             *   `UpdateConnection` needs at least `kms:Encrypt` permission on the specified AWS KMS
             *   key, to encrypt passwords before storing them in the Data Catalog. You can set the
            ...
            /**
             * @param returnConnectionPasswordEncrypted When the `ReturnConnectionPasswordEncrypted`
             *   flag is set to "true", passwords remain encrypted in the responses of
             *   `GetConnection` and `GetConnections` . This encryption takes effect independently
             ...
             *   from catalog encryption.
             */
            public fun returnConnectionPasswordEncrypted(
        ...
        private class BuilderImpl : Builder {
            ...
            override fun returnConnectionPasswordEncrypted(
                ...
                cdkBuilder.returnConnectionPasswordEncrypted(
                    returnConnectionPasswordEncrypted.let(IResolvable::unwrap)
                )
            }
        ...
        internal constructor(
             ...
             * `UpdateConnection` needs at least `kms:Encrypt` permission on the specified AWS KMS
             * key, to encrypt passwords before storing them in the Data Catalog. You can set the
             * decrypt permission to enable or restrict access on the password key according to your
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ConnectionPasswordEncryptionProperty
            ): software.amazon.awscdk.services.glue.CfnDataCatalogEncryptionSettings.ConnectionPasswordEncryptionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
