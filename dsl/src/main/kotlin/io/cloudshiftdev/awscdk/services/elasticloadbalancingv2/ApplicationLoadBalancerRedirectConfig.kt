...
public interface ApplicationLoadBalancerRedirectConfig {
     ...
     *
     * If this is specified, the listener will be opened up to anyone who can reach it. For internal
     ...
     * and use the listener's `connections` object to selectively grant access to the listener.
     *
     * Default: true
     */
    ...
    public interface Builder {
        /**
         * @param open Allow anyone to connect to this listener. If this is specified, the listener
         *   will be opened up to anyone who can reach it. For internal load balancers this is
         *   anyone in the same VPC. For public load balancers, this is anyone on the internet.
         *
    ...
    internal constructor(
         ...
         * Allow anyone to connect to this listener.
         *
         * If this is specified, the listener will be opened up to anyone who can reach it. For
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: ApplicationLoadBalancerRedirectConfig
        ): software.amazon.awscdk.services.elasticloadbalancingv2.ApplicationLoadBalancerRedirectConfig =
