...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.networkmanager.CfnVpcAttachment,
     ...
     *
     * This can be: `REJECTED` | `PENDING_ATTACHMENT_ACCEPTANCE` | `CREATING` | `FAILED` |
    ...
    public open fun proposedSegmentChange(
        `value`: ProposedSegmentChangeProperty.Builder.() -> Unit
    ...
    public interface Builder {
        ...
        public fun proposedSegmentChange(
            proposedSegmentChange: ProposedSegmentChangeProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.networkmanager.CfnVpcAttachment.Builder.create(
                scope,
                id
            )
        ...
        override fun proposedSegmentChange(proposedSegmentChange: ProposedSegmentChangeProperty) {
            cdkBuilder.proposedSegmentChange(
                proposedSegmentChange.let(ProposedSegmentChangeProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("ad6df3611e86e18a84c20a6d40323432db1b1213cd55e3f7ae0a0b4320a85d6b")
        override fun proposedSegmentChange(
            proposedSegmentChange: ProposedSegmentChangeProperty.Builder.() -> Unit
    ...
    public interface VpcOptionsProperty {
        ...
        public interface Builder {
            /**
             * @param applianceModeSupport Indicates whether appliance mode is supported. If
             *   enabled, traffic flow between a source and destination use the same Availability
             *   Zone for the VPC attachment for the lifetime of that flow. The default value is
             *   `false` .
             */
        ...
        internal constructor(
             ...
             * Indicates whether appliance mode is supported.
             *
             * If enabled, traffic flow between a source and destination use the same Availability
             * Zone for the VPC attachment for the lifetime of that flow. The default value is
             * `false` .
             *
             * Default: - false
    ...
    public interface ProposedSegmentChangeProperty {
         ...
         */
        public fun attachmentPolicyRuleNumber(): Number? =
        ...
        public interface Builder {
            /**
             * @param attachmentPolicyRuleNumber The rule number in the policy document that applies
             *   to this change.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ProposedSegmentChangeProperty
            ): software.amazon.awscdk.services.networkmanager.CfnVpcAttachment.ProposedSegmentChangeProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
