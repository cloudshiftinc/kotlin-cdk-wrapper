...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param basicAuthConfig The basic authorization credentials for a branch of an Amplify
         *   app.
         */
         ...
         * for this branch.
         *
         * If this property is enabled, Amplify deploys your app to a unique preview URL after each
         * pull request is opened. Development and QA teams can use this preview to test the pull
         ...
         * backend environment that it deletes when the pull request is closed. If you want to
         ...
         *
         * @param enablePullRequestPreview Specifies whether Amplify Hosting creates a preview for
         *   each pull request that is made for this branch.
         */
         ...
         * specify a dedicated backend environment for your previews.
         *
         ...
         *
         * @param pullRequestEnvironmentName If pull request previews are enabled for this branch,
         *   you can use this property to specify a dedicated backend environment for your previews.
         */
