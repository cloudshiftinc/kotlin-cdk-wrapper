...
public interface CatchProps {
     ...
     *
     * A list of error strings to retry, which can be either predefined errors (for example
     * Errors.NoChoiceMatched) or a self-defined error.
     *
     * Default: All errors
     */
     ...
     *
     * May also be the special value JsonPath.DISCARD, which will cause the error data to be
     * discarded.
     *
     * Default: $
     */
    ...
    public interface Builder {
        /**
         * @param errors Errors to recover from by going to the given state. A list of error strings
         *   to retry, which can be either predefined errors (for example Errors.NoChoiceMatched) or
        ...
        /**
         * @param resultPath JSONPath expression to indicate where to inject the error data. May
         *   also be the special value JsonPath.DISCARD, which will cause the error data to be
         *   discarded.
         */
