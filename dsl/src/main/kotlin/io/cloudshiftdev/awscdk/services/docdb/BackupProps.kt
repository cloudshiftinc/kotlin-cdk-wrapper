...
public interface BackupProps {
    ...
    public interface Builder {
        /**
         * @param preferredWindow A daily time range in 24-hours UTC format in which backups
         *   preferably execute. Must be at least 30 minutes long.
         *
         * Example: '01:00-02:00'
         */
    ...
    public companion object {
        ...
        ): BackupProps = Wrapper(cdkObject)

        internal fun unwrap(
            wrapped: BackupProps
        ): software.amazon.awscdk.services.docdb.BackupProps = (wrapped as Wrapper).cdkObject
    }
}
