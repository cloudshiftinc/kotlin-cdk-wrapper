...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param connectorDefinitionId The ID of the connector definition associated with this
         *   version.
         */
         ...
         * The connectors in this version.
         *
         * Only one instance of a given connector can be added to the connector definition version
         * at a time.
         *
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.greengrass.CfnConnectorDefinitionVersion.Builder.create(
                scope,
                id
            )
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnConnectorDefinitionVersion
        ): software.amazon.awscdk.services.greengrass.CfnConnectorDefinitionVersion =
            wrapped.cdkObject
    }
