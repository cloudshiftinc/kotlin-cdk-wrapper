...
internal constructor(
     ...
     *
     * Use the object returned by this method if you want this Role to be used by a construct
     * without it automatically updating the Role's Policies.
     *
     * If you do, you are responsible for adding the correct statements to the Role's policies
     * yourself.
     *
     * @param options
     */
    ...
    public open fun withoutPolicyUpdates(options: WithoutPolicyUpdatesOptions): IRole =
        unwrap(this)
            .withoutPolicyUpdates(options.let(WithoutPolicyUpdatesOptions::unwrap))
            .let(IRole::wrap)
    ...
    public open fun withoutPolicyUpdates(
        options: WithoutPolicyUpdatesOptions.Builder.() -> Unit
    ...
    public interface Builder {
        /**
         * The IAM principal (i.e. `new ServicePrincipal('sns.amazonaws.com')`) which can assume
         * this role.
         *
         * You can later modify the assume role policy document by accessing it via the
         * `assumeRolePolicy` property.
         *
         * @param assumedBy The IAM principal (i.e. `new ServicePrincipal('sns.amazonaws.com')`)
         ...
         *
         * If the configured and provided external IDs do not match, the AssumeRole operation will
         * fail.
         *
         * Default: No external ID required
         *
         * @param externalIds List of IDs that the role assumer needs to provide one of when
         *   assuming this role.
         */
         ...
         *
         * These policies will be created with the role, whereas those added by `addToPolicy` are
         * added using a separate CloudFormation resource (allowing a way around circular
         ...
         * operations to create a console URL.
         *
         * Default: Duration.hours(1)
         *
         * @param maxSessionDuration The maximum session duration that you want to set for the
         *   specified role.
         */
         ...
         *
         * For valid values, see the RoleName parameter for the CreateRole action in the IAM API
         * Reference.
         *
         ...
         * your template's capabilities. For more information, see Acknowledging IAM Resources in
    ...
    private class BuilderImpl(
         ...
         *   assuming this role.
         */
        override fun externalIds(vararg externalIds: String): Unit =
    ...
    public companion object {
        public fun customizeRoles(scope: CloudshiftdevConstructsConstruct) {
            software.amazon.awscdk.services.iam.Role.customizeRoles(
        ...
        public fun customizeRoles(
            scope: CloudshiftdevConstructsConstruct,
            options: CustomizeRolesOptions.Builder.() -> Unit
        ): Unit = customizeRoles(scope, CustomizeRolesOptions(options))
        ...
        public fun fromRoleArn(
            ...
            software.amazon.awscdk.services.iam.Role.fromRoleArn(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    roleArn
                )
        ...
        public fun fromRoleArn(
            ...
            software.amazon.awscdk.services.iam.Role.fromRoleArn(
                    ...
                    id,
                    roleArn,
                    options.let(FromRoleArnOptions::unwrap)
                )
                .let(IRole::wrap)
        ...
        public fun fromRoleName(
            ...
            software.amazon.awscdk.services.iam.Role.fromRoleName(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    roleName
                )
        ...
        public fun fromRoleName(
            ...
            software.amazon.awscdk.services.iam.Role.fromRoleName(
                    ...
                    id,
                    roleName,
                    options.let(FromRoleNameOptions::unwrap)
                )
                .let(IRole::wrap)
        ...
        internal fun wrap(cdkObject: software.amazon.awscdk.services.iam.Role): Role =
            Role(cdkObject)

        internal fun unwrap(wrapped: Role): software.amazon.awscdk.services.iam.Role =
            wrapped.cdkObject
    }
}
