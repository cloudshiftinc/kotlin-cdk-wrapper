...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.cloud9.CfnEnvironmentEC2,
     ...
     * Any AWS CodeCommit source code repositories to be cloned into the development environment.
     */
    public open fun repositories(vararg __idx_ac66f0: Any): Unit =
        repositories(__idx_ac66f0.toList())
    ...
    public interface Builder {
        /**
         * The number of minutes until the running instance is shut down after the environment was
         * last used.
         *
         ...
         *
         * @param automaticStopTimeMinutes The number of minutes until the running instance is shut
         *   down after the environment was last used.
         */
         ...
         *
         * @param connectionType The connection type used for connecting to an Amazon EC2
         *   environment.
         */
         ...
         * communicating with the API, such as AWS SDK, AWS CLI and AWS CloudFormation. This change
         * will only affect direct API consumers, and not AWS Cloud9 console users.
         *
         ...
         * The Amazon Resource Name (ARN) of the environment owner.
         *
         * This ARN can be the ARN of any AWS Identity and Access Management principal. If this
        ...
        /**
         * The ID of the subnet in Amazon Virtual Private Cloud (Amazon VPC) that AWS Cloud9 will
         * use to communicate with the Amazon Elastic Compute Cloud (Amazon EC2) instance.
         *
         ...
         *
         * @param subnetId The ID of the subnet in Amazon Virtual Private Cloud (Amazon VPC) that
         *   AWS Cloud9 will use to communicate with the Amazon Elastic Compute Cloud (Amazon EC2)
         *   instance.
         */
    ...
    private class BuilderImpl(
         ...
         *   development environment.
         */
        override fun repositories(vararg repositories: Any): Unit =
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnEnvironmentEC2
        ): software.amazon.awscdk.services.cloud9.CfnEnvironmentEC2 = wrapped.cdkObject
    }

    public interface RepositoryProperty {
        /**
         * The path within the development environment's default file system location to clone the
         * AWS CodeCommit repository into.
         *
        ...
        public interface Builder {
            /**
             * @param pathComponent The path within the development environment's default file
             *   system location to clone the AWS CodeCommit repository into. For example,
             *   `/REPOSITORY_NAME` would clone the repository into the
             *   `/home/USER_NAME/environment/REPOSITORY_NAME` directory in the environment.
             */
        ...
        internal constructor(
            ...
            /**
             * The path within the development environment's default file system location to clone
             * the AWS CodeCommit repository into.
             *
             * For example, `/REPOSITORY_NAME` would clone the repository into the
             * `/home/USER_NAME/environment/REPOSITORY_NAME` directory in the environment.
             *
