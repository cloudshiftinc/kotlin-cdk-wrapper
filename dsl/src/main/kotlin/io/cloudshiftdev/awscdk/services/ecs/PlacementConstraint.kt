...
internal constructor(
    ...
    public companion object {
        public fun distinctInstances(): PlacementConstraint =
            software.amazon.awscdk.services.ecs.PlacementConstraint.distinctInstances()
                .let(PlacementConstraint::wrap)

        public fun memberOf(expressions: String): PlacementConstraint =
            software.amazon.awscdk.services.ecs.PlacementConstraint.memberOf(expressions)
                .let(PlacementConstraint::wrap)
