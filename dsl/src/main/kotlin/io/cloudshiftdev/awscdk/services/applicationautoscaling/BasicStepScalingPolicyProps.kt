...
public interface BasicStepScalingPolicyProps {
    ...
    public interface Builder {
        ...
        /**
         * @param datapointsToAlarm The number of data points out of the evaluation periods that
         *   must be breaching to trigger a scaling action. Creates an "M out of N" alarm, where
         *   this property is the M and the value set for `evaluationPeriods` is the N value.
         *
         * Only has meaning if `evaluationPeriods != 1`.
         */
        ...
        /**
         * @param evaluationPeriods How many evaluation periods of the metric to wait before
         *   triggering a scaling action. Raising this value can be used to smooth out the metric,
         *   at the expense of slower response times.
         *
         * If `datapointsToAlarm` is not set, then all data points in the evaluation period must
         * meet the criteria to trigger a scaling action.
         */
         ...
         *   of percentage scaling. Only when using AdjustmentType = PercentChangeInCapacity, this
         *   number controls the minimum absolute effect size.
         */
        public fun minAdjustmentMagnitude(minAdjustmentMagnitude: Number)

        /**
         * @param scalingSteps The intervals for scaling. Maps a range of metric values to a
         *   particular scaling behavior.
         *
         * Must be between 2 and 40 steps.
         */
    ...
    internal constructor(
        ...
        /**
         * The number of data points out of the evaluation periods that must be breaching to trigger
         * a scaling action.
         *
         * Creates an "M out of N" alarm, where this property is the M and the value set for
         * `evaluationPeriods` is the N value.
         ...
         * How many evaluation periods of the metric to wait before triggering a scaling action.
         *
         * Raising this value can be used to smooth out the metric, at the expense of slower
         * response times.
         *
         * If `datapointsToAlarm` is not set, then all data points in the evaluation period must
         * meet the criteria to trigger a scaling action.
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: BasicStepScalingPolicyProps
        ): software.amazon.awscdk.services.applicationautoscaling.BasicStepScalingPolicyProps =
