...
public interface CapacityProviderStrategy {
    ...
    public interface Builder {
         ...
         *   specified capacity provider. Only one capacity provider in a capacity provider strategy
         ...
         *   tasks launched that should use the specified capacity provider. The weight value is
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CapacityProviderStrategy
