...
public interface JsonSchema {
    ...
    /**  */
    public fun allOf(): List<JsonSchema> =
        unwrap(this).getAllOf()?.map(JsonSchema::wrap) ?: emptyList()

    /**  */
    public fun anyOf(): List<JsonSchema> =
        unwrap(this).getAnyOf()?.map(JsonSchema::wrap) ?: emptyList()
    ...
    /**  */
    public fun oneOf(): List<JsonSchema> =
        unwrap(this).getOneOf()?.map(JsonSchema::wrap) ?: emptyList()
    ...
    private class BuilderImpl : Builder {
        ...
        override fun patternProperties(patternProperties: Map<String, JsonSchema>) {
            cdkBuilder.patternProperties(
                patternProperties.mapValues { JsonSchema.unwrap(it.value) }
            )
        }
        ...
        public fun build(): software.amazon.awscdk.services.apigateway.JsonSchema =
            cdkBuilder.build()
    }
    ...
    internal constructor(
        ...
        /**  */
        override fun allOf(): List<JsonSchema> =
            unwrap(this).getAllOf()?.map(JsonSchema::wrap) ?: emptyList()

        /**  */
        override fun anyOf(): List<JsonSchema> =
            unwrap(this).getAnyOf()?.map(JsonSchema::wrap) ?: emptyList()
        ...
        /**  */
        override fun oneOf(): List<JsonSchema> =
            unwrap(this).getOneOf()?.map(JsonSchema::wrap) ?: emptyList()
        ...
        override fun patternProperties(): Map<String, JsonSchema> =
            unwrap(this).getPatternProperties()?.mapValues { JsonSchema.wrap(it.value) }
                ?: emptyMap()
    ...
    public companion object {
        ...
        ): JsonSchema = Wrapper(cdkObject)

        internal fun unwrap(
            wrapped: JsonSchema
        ): software.amazon.awscdk.services.apigateway.JsonSchema = (wrapped as Wrapper).cdkObject
    }
}
