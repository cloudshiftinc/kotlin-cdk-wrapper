...
public interface DeviceTracking {
    ...
    public interface Builder {
        ...
        /**
         * @param deviceOnlyRememberedOnUserPrompt If true, a device is only remembered on user
         *   prompt.
         */
    ...
    private class BuilderImpl : Builder {
        ...
        public fun build(): software.amazon.awscdk.services.cognito.DeviceTracking =
            cdkBuilder.build()
    }
