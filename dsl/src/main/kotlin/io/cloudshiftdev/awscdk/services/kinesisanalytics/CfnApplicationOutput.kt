...
internal constructor(
     ...
     * [io.cloudshiftdev.awscdk.services.kinesisanalytics.CfnApplicationOutput].
     */
    @CdkDslMarker
    public interface Builder {
         ...
         * An array of objects, each describing one output configuration.
         *
         * In the output configuration, you specify the name of an in-application stream, a
         * destination (that is, an Amazon Kinesis stream, an Amazon Kinesis Firehose delivery
         * stream, or an AWS Lambda function), and record the formation to use when writing to the
         * destination.
         *
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.kinesisanalytics.CfnApplicationOutput.Builder.create(
                scope,
                id
            )
    ...
    public interface DestinationSchemaProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DestinationSchemaProperty
            ): software.amazon.awscdk.services.kinesisanalytics.CfnApplicationOutput.DestinationSchemaProperty =
    ...
    public interface KinesisStreamsOutputProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param roleArn ARN of the IAM role that Amazon Kinesis Analytics can assume to write
             *   to the destination stream on your behalf. You need to grant the necessary
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: KinesisStreamsOutputProperty
            ): software.amazon.awscdk.services.kinesisanalytics.CfnApplicationOutput.KinesisStreamsOutputProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface OutputProperty {
        ...
        public interface Builder {
            ...
            public fun destinationSchema(
                destinationSchema: DestinationSchemaProperty.Builder.() -> Unit
            )

            /**
             * @param kinesisFirehoseOutput Identifies an Amazon Kinesis Firehose delivery stream as
             *   the destination.
             */
            ...
            public fun kinesisFirehoseOutput(
                kinesisFirehoseOutput: KinesisFirehoseOutputProperty.Builder.() -> Unit
            )
            ...
            public fun kinesisStreamsOutput(
                kinesisStreamsOutput: KinesisStreamsOutputProperty.Builder.() -> Unit
            )
        ...
        private class BuilderImpl : Builder {
            ...
            override fun destinationSchema(destinationSchema: DestinationSchemaProperty) {
                cdkBuilder.destinationSchema(
                    destinationSchema.let(DestinationSchemaProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("ed57bf0989507d124ac3e68c92223c9d3573f229cff0a0a20aa74031d27b9483")
            override fun destinationSchema(
                destinationSchema: DestinationSchemaProperty.Builder.() -> Unit
             ...
             *   the destination.
             */
            override fun kinesisFirehoseOutput(
                kinesisFirehoseOutput: KinesisFirehoseOutputProperty
            ) {
                cdkBuilder.kinesisFirehoseOutput(
                    kinesisFirehoseOutput.let(KinesisFirehoseOutputProperty::unwrap)
                )
            }
            ...
            override fun kinesisStreamsOutput(kinesisStreamsOutput: KinesisStreamsOutputProperty) {
                cdkBuilder.kinesisStreamsOutput(
                    kinesisStreamsOutput.let(KinesisStreamsOutputProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("cb46a3f10ac4e629e90925bd5b55dd73632801b9090eccd5453b8b4911f75b6b")
            override fun kinesisStreamsOutput(
                kinesisStreamsOutput: KinesisStreamsOutputProperty.Builder.() -> Unit
    ...
    public interface KinesisFirehoseOutputProperty {
        ...
        public interface Builder {
            /**
             * @param resourceArn ARN of the destination Amazon Kinesis Firehose delivery stream to
             *   write to.
             */
            public fun resourceArn(resourceArn: String)
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: KinesisFirehoseOutputProperty
            ): software.amazon.awscdk.services.kinesisanalytics.CfnApplicationOutput.KinesisFirehoseOutputProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface LambdaOutputProperty {
        ...
        public interface Builder {
            /**
             * @param resourceArn Amazon Resource Name (ARN) of the destination Lambda function to
             *   write to.
             *
            ...
            /**
             * @param roleArn ARN of the IAM role that Amazon Kinesis Analytics can assume to write
             *   to the destination function on your behalf. You need to grant the necessary
             *   permissions to this role.
             */
            public fun roleArn(roleArn: String)
        }
