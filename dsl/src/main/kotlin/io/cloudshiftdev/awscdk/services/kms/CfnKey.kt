...
internal constructor(
     ...
     *
     * For information about the key ARN of a KMS key, see
     ...
     *
     * For information about the key ID of a KMS key, see
     ...
     * required for asymmetric KMS keys and HMAC KMS keys. You can't change the `KeyUsage` value
    ...
    public interface Builder {
         ...
         *
         * @param bypassPolicyLockoutSafetyCheck Skips ("bypasses") the key policy lockout safety
         ...
         * A description of the KMS key.
         *
         * Use a description that helps you to distinguish this KMS key from others in the account,
         ...
         * `EnableKeyRotation` to `true` on the primary key (created by using `AWS::KMS::Key` ). AWS
         * KMS copies the rotation status to all replica keys. For details, see
         * [Rotating multi-Region keys](https://docs.aws.amazon.com/kms/latest/developerguide/multi-region-keys-manage.html#multi-region-rotate)
         * in the *AWS Key Management Service Developer Guide* .
         *
         * When you enable automatic rotation, AWS KMS automatically creates new key material for
         * the KMS key one year after the enable date and every year thereafter. AWS KMS retains all
         * key material until you delete the KMS key. For detailed information about automatic key
         * rotation, see
         ...
         *
         * @param enableKeyRotation Enables automatic rotation of the key material for the specified
         *   KMS key.
         */
        ...
        /**
         * Specifies whether the KMS key is enabled. Disabled KMS keys cannot be used in
         * cryptographic operations.
         *
         * When `Enabled` is `true` , the *key state* of the KMS key is `Enabled` . When `Enabled`
         * is `false` , the key state of the KMS key is `Disabled` . The default value is `true` .
         *
         ...
         * operations.
         *
         * For information about the key states of a KMS key, see
         ...
         *
         * @param enabled Specifies whether the KMS key is enabled. Disabled KMS keys cannot be used
         ...
         *   the key policy must exist and be visible to AWS KMS . When you create a new AWS
         ...
         *   immediately visible to AWS KMS . For more information, see
         ...
         * Specifies the type of KMS key to create.
         *
         * The default value, `SYMMETRIC_DEFAULT` , creates a KMS key with a 256-bit symmetric key
         * for encryption and decryption. In China Regions, `SYMMETRIC_DEFAULT` creates a 128-bit
         * symmetric key that uses SM4 encryption. You can't change the `KeySpec` value after the
         * KMS key is created. For help choosing a key spec for your KMS key, see
         * [Choosing a KMS key type](https://docs.aws.amazon.com/kms/latest/developerguide/symm-asymm-choose.html)
         * in the *AWS Key Management Service Developer Guide* .
         *
         * The `KeySpec` property determines the type of key material in the KMS key and the
         * algorithms that the KMS key supports. To further restrict the algorithms that can be used
         * with the KMS key, use a condition key in its key policy or IAM policy. For more
         * information, see
         * [AWS KMS condition keys](https://docs.aws.amazon.com/kms/latest/developerguide/policy-conditions.html#conditions-kms)
         * in the *AWS Key Management Service Developer Guide* .
         *
         * If you change the value of the `KeySpec` property on an existing KMS key, the update
         * request fails, regardless of the value of the
         ...
         * . This prevents you from accidentally deleting a KMS key by changing an immutable
         * property value. &gt;
         * [AWS services that are integrated with AWS KMS](https://docs.aws.amazon.com/kms/features/#AWS_Service_Integration)
         * use symmetric encryption KMS keys to protect your data. These services do not support
         * encryption with asymmetric KMS keys. For help determining whether a KMS key is
         * asymmetric, see
         * [Identifying asymmetric KMS keys](https://docs.aws.amazon.com/kms/latest/developerguide/find-symm-asymm.html)
         * in the *AWS Key Management Service Developer Guide* .
         *
         ...
         * Determines the
         * [cryptographic operations](https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#cryptographic-operations)
         * for which you can use the KMS key. The default value is `ENCRYPT_DECRYPT` . This property
         * is required for asymmetric KMS keys and HMAC KMS keys. You can't change the `KeyUsage`
         * value after the KMS key is created.
         *
         * If you change the value of the `KeyUsage` property on an existing KMS key, the update
         * request fails, regardless of the value of the
         * [`UpdateReplacePolicy` attribute](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-attribute-updatereplacepolicy.html)
         * . This prevents you from accidentally deleting a KMS key by changing an immutable
         * property value.
         ...
         *
         * @param keyUsage Determines the
         *   [cryptographic operations](https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#cryptographic-operations)
         *   for which you can use the KMS key. The default value is `ENCRYPT_DECRYPT` . This
         *   property is required for asymmetric KMS keys and HMAC KMS keys. You can't change the
         ...
         *
         * For a list of AWS Regions in which multi-Region keys are supported, see
         ...
         * property value.
         *
         * For a multi-Region key, set to this property to `true` . For a single-Region key, omit
         * this property or set it to `false` . The default value is `false` .
         *
         * *Multi-Region keys* are an AWS KMS feature that lets you create multiple interoperable
         * KMS keys in different AWS Regions . Because these KMS keys have the same key ID, key
         * material, and other metadata, you can use them to encrypt data in one AWS Region and
         * decrypt it in a different AWS Region without making a cross-Region call or exposing the
         * plaintext data. For more information, see
         * [Multi-Region keys](https://docs.aws.amazon.com/kms/latest/developerguide/multi-region-keys-overview.html)
         * in the *AWS Key Management Service Developer Guide* .
         *
         * You can create a symmetric encryption, HMAC, or asymmetric multi-Region KMS key, and you
         ...
         * resource in a CloudFormation stack in the replica Region. Specify the key ARN of this
         * primary key.
         *
         * Default: - false
         *
         ...
         * (for imported key material), set this value to `EXTERNAL` . For more information about
         ...
         * in the *AWS Key Management Service Developer Guide* .
         *
         * You can ignore `ENABLED` when Origin is `EXTERNAL` . When a KMS key with Origin
         * `EXTERNAL` is created, the key state is `PENDING_IMPORT` and `ENABLED` is `false` . After
         * you import the key material, `ENABLED` updated to `true` . The KMS key can then be used
         * for Cryptographic Operations.
         *
         * AWS CloudFormation doesn't support creating an `Origin` parameter of the `AWS_CLOUDHSM`
         * or `EXTERNAL_KEY_STORE` values.
         *
         * Default: - "AWS_KMS"
         *
        ...
        /**
         * Specifies the number of days in the waiting period before AWS KMS deletes a KMS key that
         ...
         * deletion and starts the mandatory waiting period. The `PendingWindowInDays` property
         * determines the length of waiting period. During the waiting period, the key state of KMS
         * key is `Pending Deletion` or `Pending Replica Deletion` , which prevents the KMS key from
         * being used in cryptographic operations. When the waiting period expires, AWS KMS
         * permanently deletes the KMS key.
         *
         * AWS KMS will not delete a
         * [multi-Region primary key](https://docs.aws.amazon.com/kms/latest/developerguide/multi-region-keys-overview.html)
         * that has replica keys. If you remove a multi-Region primary key from a CloudFormation
         * stack, its key state changes to `PendingReplicaDeletion` so it cannot be replicated or
         * used in cryptographic operations. This state can persist indefinitely. When the last of
         * its replica keys is deleted, the key state of the primary key changes to
         * `PendingDeletion` and the waiting period specified by `PendingWindowInDays` begins. When
         * this waiting period expires, AWS KMS deletes the primary key. For details, see
         * [Deleting multi-Region keys](https://docs.aws.amazon.com/kms/latest/developerguide/multi-region-keys-delete.html)
         * in the *AWS Key Management Service Developer Guide* .
         *
         * You cannot use a CloudFormation template to cancel deletion of the KMS key after you
         * remove it from the stack, regardless of the waiting period. If you specify a KMS key in
         * your template, even one with the same name, CloudFormation creates a new KMS key. To
         * cancel deletion of a KMS key, use the AWS KMS console or the
         * [CancelKeyDeletion](https://docs.aws.amazon.com/kms/latest/APIReference/API_CancelKeyDeletion.html)
         * operation.
         *
         * For information about the `Pending Deletion` and `Pending Replica Deletion` key states,
         * see
         * [Key state: Effect on your KMS key](https://docs.aws.amazon.com/kms/latest/developerguide/key-state.html)
         * in the *AWS Key Management Service Developer Guide* . For more information about deleting
         * KMS keys, see the
         * [ScheduleKeyDeletion](https://docs.aws.amazon.com/kms/latest/APIReference/API_ScheduleKeyDeletion.html)
         ...
         *
         * @param pendingWindowInDays Specifies the number of days in the waiting period before AWS
         *   KMS deletes a KMS key that has been removed from a CloudFormation stack.
         */
         ...
         * see [ABAC for AWS KMS](https://docs.aws.amazon.com/kms/latest/developerguide/abac.html)
         * in the *AWS Key Management Service Developer Guide* .
         *
         * For information about tags in AWS KMS , see
         * [Tagging keys](https://docs.aws.amazon.com/kms/latest/developerguide/tagging-keys.html)
         * in the *AWS Key Management Service Developer Guide* . For information about tags in
         * CloudFormation, see
    ...
    private class BuilderImpl(
        ...
        override fun bypassPolicyLockoutSafetyCheck(bypassPolicyLockoutSafetyCheck: IResolvable) {
            cdkBuilder.bypassPolicyLockoutSafetyCheck(
                bypassPolicyLockoutSafetyCheck.let(IResolvable::unwrap)
            )
        }
