...
internal constructor(
    ...
    public open fun withStandardAttributes(attributes: StandardAttributesMask): ClientAttributes =
        unwrap(this)
            .withStandardAttributes(attributes.let(StandardAttributesMask::unwrap))
            .let(ClientAttributes::wrap)
    ...
    public open fun withStandardAttributes(
        attributes: StandardAttributesMask.Builder.() -> Unit
