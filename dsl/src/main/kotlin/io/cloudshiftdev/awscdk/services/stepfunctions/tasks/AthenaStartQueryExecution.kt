...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * The values are applied sequentially to the parameters in the query in the order in which
         * the parameters occur.
         *
        ...
        public fun queryExecutionContext(
            queryExecutionContext: QueryExecutionContext.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
        ...
        override fun queryExecutionContext(queryExecutionContext: QueryExecutionContext) {
            cdkBuilder.queryExecutionContext(
                queryExecutionContext.let(QueryExecutionContext::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("0ce2f6d23d7d00ff94cd1e82fa29642e77ead98a14d1978fc6ca7e174440e769")
        override fun queryExecutionContext(
            queryExecutionContext: QueryExecutionContext.Builder.() -> Unit
        ...
        override fun resultConfiguration(
            resultConfiguration: ResultConfiguration.Builder.() -> Unit
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: AthenaStartQueryExecution
        ): software.amazon.awscdk.services.stepfunctions.tasks.AthenaStartQueryExecution =
            wrapped.cdkObject
    }
}
