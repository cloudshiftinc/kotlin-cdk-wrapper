...
public enum class Operation(
  ...
  BATCH_EXECUTE_STATEMENT(software.amazon.awscdk.services.dynamodb.Operation.BATCH_EXECUTE_STATEMENT),
  EXECUTE_STATEMENT(software.amazon.awscdk.services.dynamodb.Operation.EXECUTE_STATEMENT),
  ;

  public companion object {
    internal fun wrap(cdkObject: software.amazon.awscdk.services.dynamodb.Operation): Operation =
        when (cdkObject) {
      software.amazon.awscdk.services.dynamodb.Operation.GET_ITEM -> Operation.GET_ITEM
      software.amazon.awscdk.services.dynamodb.Operation.BATCH_GET_ITEM -> Operation.BATCH_GET_ITEM
      ...
      software.amazon.awscdk.services.dynamodb.Operation.GET_RECORDS -> Operation.GET_RECORDS
      software.amazon.awscdk.services.dynamodb.Operation.PUT_ITEM -> Operation.PUT_ITEM
      software.amazon.awscdk.services.dynamodb.Operation.DELETE_ITEM -> Operation.DELETE_ITEM
      software.amazon.awscdk.services.dynamodb.Operation.UPDATE_ITEM -> Operation.UPDATE_ITEM
    ...
    internal fun unwrap(wrapped: Operation): software.amazon.awscdk.services.dynamodb.Operation =
        wrapped.cdkObject
  }
}
