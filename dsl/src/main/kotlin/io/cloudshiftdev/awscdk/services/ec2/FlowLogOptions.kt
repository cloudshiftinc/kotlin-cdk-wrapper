...
public interface FlowLogOptions {
     ...
     */
    public fun logFormat(): List<LogFormat> =
    ...
    public interface Builder {
         ...
         *   should appear. If multiple fields are specified, they will be separated by spaces. For
         *   full control over the literal log format string, pass a single field constructed with
         *   `LogFormat.custom()`.
         *
         * See https://docs.aws.amazon.com/vpc/latest/userguide/flow-logs.html#flow-log-records
         */
        ...
        /**
         * @param maxAggregationInterval The maximum interval of time during which a flow of packets
         *   is captured and aggregated into a flow log record. When creating flow logs for a
         *   Transit Gateway or Transit Gateway Attachment, this property must be ONE_MINUTES.
         */
         ...
         *   accepts or rejects, or all traffic. When the target is either `TransitGateway` or
    ...
    private class BuilderImpl : Builder {
        ...
        override fun maxAggregationInterval(maxAggregationInterval: FlowLogMaxAggregationInterval) {
            cdkBuilder.maxAggregationInterval(
                maxAggregationInterval.let(FlowLogMaxAggregationInterval::unwrap)
            )
        }
    ...
    internal constructor(
         ...
         * The fields to include in the flow log record, in the order in which they should appear.
         *
         * If multiple fields are specified, they will be separated by spaces. For full control over
         * the literal log format string, pass a single field constructed with `LogFormat.custom()`.
         *
         * See https://docs.aws.amazon.com/vpc/latest/userguide/flow-logs.html#flow-log-records
         *
         * Default: - default log format is used.
         */
        override fun logFormat(): List<LogFormat> =
            unwrap(this).getLogFormat()?.map(LogFormat::wrap) ?: emptyList()
         ...
         *
         * When creating flow logs for a Transit Gateway or Transit Gateway Attachment, this
         * property must be ONE_MINUTES.
         *
         * Default: - FlowLogMaxAggregationInterval.ONE_MINUTES if creating flow logs for Transit
         * Gateway, otherwise FlowLogMaxAggregationInterval.TEN_MINUTES.
         *
         ...
         * The type of traffic to log.
         *
         * You can log traffic that the resource accepts or rejects, or all traffic. When the target
         * is either `TransitGateway` or `TransitGatewayAttachment`, setting the traffic type is not
         * possible.
         *
         * Default: ALL
         *
    ...
    public companion object {
        ...
        ): FlowLogOptions = Wrapper(cdkObject)

        internal fun unwrap(
            wrapped: FlowLogOptions
        ): software.amazon.awscdk.services.ec2.FlowLogOptions = (wrapped as Wrapper).cdkObject
    }
}
