...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.verifiedpermissions.CfnPolicyStore,
) : CfnResource(cdkObject), IInspectable {
    /**
     * The
     * [Amazon Resource Name (ARN)](https://docs.aws.amazon.com//general/latest/gr/aws-arns-and-namespaces.html)
     * of the new or updated policy store.
     */
    ...
    public open fun validationSettings(
        `value`: ValidationSettingsProperty.Builder.() -> Unit
    ): Unit = validationSettings(ValidationSettingsProperty(`value`))
    ...
    public interface Builder {
         ...
         *
         * @param description Descriptive text that you can provide to help with identification of
         ...
         * Creates or updates the policy schema in a policy store.
         *
         * Cedar can use the schema to validate any Cedar policies and policy templates submitted to
         * the policy store. Any changes to the schema validate only policies and templates
         * submitted after the schema change. Existing policies and templates are not re-evaluated
         * against the changed schema. If you later update a policy, then it is evaluated against
         * the new schema at that time.
         *
        ...
        public fun validationSettings(
            validationSettings: ValidationSettingsProperty.Builder.() -> Unit
        )
    }
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.verifiedpermissions.CfnPolicyStore.Builder.create(
                scope,
                id
            )
        ...
        override fun validationSettings(validationSettings: ValidationSettingsProperty) {
            cdkBuilder.validationSettings(
                validationSettings.let(ValidationSettingsProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("a939b3acbcc541a7865e358016c9d553cdf3a8bb0dfac3f3afb0c2172bcc43b3")
        override fun validationSettings(
            validationSettings: ValidationSettingsProperty.Builder.() -> Unit
    ...
    public interface ValidationSettingsProperty {
        ...
        public interface Builder {
             ...
             *   values are:.
             * * *OFF* – Neither Verified Permissions nor Cedar perform any validation on policies.
             *   No validation errors are reported by either service.
             * * *STRICT* – Requires a schema to be present in the policy store. Cedar performs
             *   validation on all submitted new or updated static policies and policy templates.
             *   Any that fail validation are rejected and Cedar doesn't store them in the policy
             *   store.
             *
             * If `Mode=STRICT` and the policy store doesn't contain a schema, Verified Permissions
             * rejects all static policies and policy templates because there is no schema to
             * validate against.
             *
             * To submit a static policy or policy template without a schema, you must turn off
             * validation.
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ValidationSettingsProperty
            ): software.amazon.awscdk.services.verifiedpermissions.CfnPolicyStore.ValidationSettingsProperty =
    ...
    public interface SchemaDefinitionProperty {
        ...
        public interface Builder {
            /**
             * @param cedarJson A JSON string representation of the schema supported by applications
