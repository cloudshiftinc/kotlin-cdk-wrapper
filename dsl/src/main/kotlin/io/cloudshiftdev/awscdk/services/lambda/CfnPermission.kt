...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param eventSourceToken For Alexa Smart Home functions, a token that the invoker must
         *   supply.
         */
         ...
         * For AWS service , the ID of the AWS account that owns the resource.
         *
         * Use this together with `SourceArn` to ensure that the specified account owns the
         * resource. It is possible for an Amazon S3 bucket to be deleted by its owner and recreated
         * by another account.
         *
         ...
         *
         * @param sourceArn For AWS services , the ARN of the AWS resource that invokes the
         *   function.
         */
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.lambda.CfnPermission =
            cdkBuilder.build()
    }
