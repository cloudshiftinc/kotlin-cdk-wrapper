...
internal constructor(
    ...
    public open fun addContainerDependencies(containerDependencies: ContainerDependency) {
        unwrap(this)
            .addContainerDependencies(containerDependencies.let(ContainerDependency::unwrap))
    }
    ...
    public open fun addContainerDependencies(
        containerDependencies: ContainerDependency.Builder.() -> Unit
    ...
    /**
     * This method adds a link which allows containers to communicate with each other without the
    ...
    public open fun addUlimits(ulimits: Ulimit.Builder.() -> Unit): Unit =
    ...
    public open fun findPortMapping(containerPort: Number, protocol: Protocol): PortMapping? =
        unwrap(this)
            .findPortMapping(containerPort, protocol.let(Protocol::unwrap))
            ?.let(PortMapping::wrap)
    ...
    public open fun renderContainerDefinition(): CfnTaskDefinition.ContainerDefinitionProperty =
        unwrap(this)
            ...
            .let(CfnTaskDefinition.ContainerDefinitionProperty::wrap)
     ...
     *   change).
     */
    public open fun renderContainerDefinition(
        _taskDefinition: TaskDefinition
    ): CfnTaskDefinition.ContainerDefinitionProperty =
        unwrap(this)
            .renderContainerDefinition(_taskDefinition.let(TaskDefinition::unwrap))
            .let(CfnTaskDefinition.ContainerDefinitionProperty::wrap)
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.ecs.ContainerDefinition =
            cdkBuilder.build()
    }
