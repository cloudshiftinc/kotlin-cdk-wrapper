...
public interface IPublicSubnet : ISubnet {
    ...
    internal constructor(
        internal val cdkObject: software.amazon.awscdk.services.ec2.IPublicSubnet,
    ) : IPublicSubnet {
        /**
    ...
    public companion object {
        ...
        ): IPublicSubnet = Wrapper(cdkObject)

        internal fun unwrap(
            wrapped: IPublicSubnet
        ): software.amazon.awscdk.services.ec2.IPublicSubnet = (wrapped as Wrapper).cdkObject
    }
}
