...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.cloudformation.CfnMacro,
    ...
    public interface Builder {
         ...
         *
         * @param functionName The Amazon Resource Name (ARN) of the underlying AWS Lambda function
         *   that you want AWS CloudFormation to invoke when the macro is run.
         */
        public fun functionName(functionName: String)

        /**
         * The CloudWatch Logs group to which AWS CloudFormation sends error logging information
         ...
         *
         * @param logGroupName The CloudWatch Logs group to which AWS CloudFormation sends error
         *   logging information when invoking the macro's underlying AWS Lambda function.
         */
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.cloudformation.CfnMacro =
            cdkBuilder.build()
    }
    ...
    public companion object {
        ...
        ): CfnMacro = CfnMacro(cdkObject)

        internal fun unwrap(
            wrapped: CfnMacro
        ): software.amazon.awscdk.services.cloudformation.CfnMacro = wrapped.cdkObject
    }
}
