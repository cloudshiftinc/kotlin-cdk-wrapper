...
internal constructor(
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.s3.CfnMultiRegionAccessPointPolicy.Builder.create(
                scope,
                id
            )
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnMultiRegionAccessPointPolicy
    ...
    public interface PolicyStatusProperty {
        ...
        public interface Builder {
            /**
             * @param isPublic The policy status for this bucket. `TRUE` indicates that this bucket
