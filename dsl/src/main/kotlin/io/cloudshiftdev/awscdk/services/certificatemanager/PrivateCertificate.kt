...
internal constructor(
     ...
     * [io.cloudshiftdev.awscdk.services.certificatemanager.PrivateCertificate].
     */
    @CdkDslMarker
    public interface Builder {
         ...
         *
         * @param certificateAuthority Private certificate authority (CA) that will be used to issue
         *   the certificate.
         */
         ...
         * specified signing algorithm family (RSA or ECDSA) must match the algorithm family of the
         * CA's secret key.
         *
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.certificatemanager.PrivateCertificate.Builder.create(
                scope,
                id
            )
