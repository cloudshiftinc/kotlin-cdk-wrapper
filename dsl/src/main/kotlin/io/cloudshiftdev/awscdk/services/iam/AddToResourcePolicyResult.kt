...
public interface AddToResourcePolicyResult {
    ...
    public interface Builder {
        /**
         * @param policyDependable Dependable which allows depending on the policy change being
         *   applied.
         */
    ...
    internal constructor(
         ...
         * Dependable which allows depending on the policy change being applied.
         *
         * Default: - If `statementAdded` is true, the resource object itself. Otherwise, no
         * dependable.
         */
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: AddToResourcePolicyResult
