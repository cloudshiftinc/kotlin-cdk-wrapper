...
public interface EdgeLambda {
     ...
     *
     * Only valid for "request" event types (`ORIGIN_REQUEST` or `VIEWER_REQUEST`). See
    ...
    public interface Builder {
        ...
        /**
         * @param functionVersion The version of the Lambda function that will be invoked. **Note**:
         *   it's not possible to use the '$LATEST' function version for Lambda&#64;Edge!
         */
    ...
    private class BuilderImpl : Builder {
        ...
        public fun build(): software.amazon.awscdk.services.cloudfront.EdgeLambda =
            cdkBuilder.build()
    }
    ...
    internal constructor(
         ...
         * **Note**: it's not possible to use the '$LATEST' function version for Lambda&#64;Edge!
         */
        override fun functionVersion(): IVersion =
    ...
    public companion object {
        ...
        ): EdgeLambda = Wrapper(cdkObject)

        internal fun unwrap(
            wrapped: EdgeLambda
        ): software.amazon.awscdk.services.cloudfront.EdgeLambda = (wrapped as Wrapper).cdkObject
    }
}
