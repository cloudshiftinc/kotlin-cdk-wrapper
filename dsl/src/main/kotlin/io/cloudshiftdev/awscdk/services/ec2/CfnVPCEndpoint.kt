...
internal constructor(
    ...
    public interface Builder {
         ...
         * AWS CloudFormation converts YAML policies to JSON format before calling the API to create
         * or modify the VPC endpoint.
         *
         ...
         *
         * @param policyDocument An endpoint policy, which controls access to the service from the
         *   VPC.
         */
         ...
         * Indicate whether to associate a private hosted zone with the specified VPC.
         *
         * The private hosted zone contains a record set for the default public DNS name for the
         * service for the Region (for example, `kinesis.us-east-1.amazonaws.com` ), which resolves
         * to the private IP addresses of the endpoint network interfaces in the VPC. This enables
         * you to make requests to the default public DNS name for the service instead of the public
         * DNS names that are automatically generated by the VPC endpoint service.
         *
         ...
         *
         * @param securityGroupIds The IDs of the security groups to associate with the endpoint
         *   network interfaces.
         */
         ...
         * The IDs of the subnets in which to create endpoint network interfaces.
         *
         * You must specify this property for an interface endpoint or a Gateway Load Balancer
         * endpoint. You can't specify this property for a gateway endpoint. For a Gateway Load
    ...
    public companion object {
        ...
        ): software.amazon.awscdk.services.ec2.CfnVPCEndpoint = wrapped.cdkObject
    }
}
