...
internal constructor(
    ...
    public open fun notifyOnCreateOrReopenCase(): Any? =
        unwrap(this).getNotifyOnCreateOrReopenCase()
    ...
    public interface Builder {
         ...
         * The Amazon Resource Name (ARN) of the IAM role for this Slack channel configuration.
         *
         * The AWS Support App uses this role to perform AWS Support and Service Quotas actions on
         * your behalf.
         *
         ...
         *
         * @param channelRoleArn The Amazon Resource Name (ARN) of the IAM role for this Slack
         ...
         *
         * @param notifyOnAddCorrespondenceToCase Whether to get notified when a correspondence is
         *   added to your support cases.
         */
         ...
         *
         * @param notifyOnCaseSeverity The case severity for your support cases that you want to
         ...
         *
         * @param notifyOnCreateOrReopenCase Whether to get notified when your support cases are
         *   created or reopened.
         */
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.supportapp.CfnSlackChannelConfiguration.Builder.create(
                scope,
                id
            )
        ...
        override fun notifyOnAddCorrespondenceToCase(notifyOnAddCorrespondenceToCase: IResolvable) {
            cdkBuilder.notifyOnAddCorrespondenceToCase(
                notifyOnAddCorrespondenceToCase.let(IResolvable::unwrap)
            )
        }
        ...
        override fun notifyOnCreateOrReopenCase(notifyOnCreateOrReopenCase: IResolvable) {
            cdkBuilder.notifyOnCreateOrReopenCase(
                notifyOnCreateOrReopenCase.let(IResolvable::unwrap)
            )
        }
    ...
    public companion object {
        ...
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.supportapp.CfnSlackChannelConfiguration
        ): CfnSlackChannelConfiguration = CfnSlackChannelConfiguration(cdkObject)

        internal fun unwrap(
            wrapped: CfnSlackChannelConfiguration
        ): software.amazon.awscdk.services.supportapp.CfnSlackChannelConfiguration =
            wrapped.cdkObject
    }
}
