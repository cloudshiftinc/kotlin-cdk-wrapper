...
internal constructor(
     ...
     */
    public open fun elasticsearchClusterConfig(): Any? =
        unwrap(this).getElasticsearchClusterConfig()
    ...
    public open fun elasticsearchClusterConfig(`value`: ElasticsearchClusterConfigProperty) {
        unwrap(this)
            .setElasticsearchClusterConfig(`value`.let(ElasticsearchClusterConfigProperty::unwrap))
    }
    ...
    public open fun elasticsearchClusterConfig(
        `value`: ElasticsearchClusterConfigProperty.Builder.() -> Unit
    ...
    public interface Builder {
         ...
         * data type in the *Amazon OpenSearch Service Developer Guide* . If you don't specify a
         * name, AWS CloudFormation generates a unique physical ID and uses that ID for the domain
        ...
        public fun elasticsearchClusterConfig(
            elasticsearchClusterConfig: ElasticsearchClusterConfigProperty.Builder.() -> Unit
        )
         ...
         * When `EnableVersionUpgrade` is set to `false` , or is not specified, updating
         ...
         *   specified, 1.5 is used as the default. For information about the versions that
         *   OpenSearch Service supports, see
         *   [Supported versions of OpenSearch and Elasticsearch](https://docs.aws.amazon.com/opensearch-service/latest/developerguide/what-is.html#choosing-version)
         *   in the *Amazon OpenSearch Service Developer Guide* .
         */
    ...
    private class BuilderImpl(
        ...
        override fun elasticsearchClusterConfig(elasticsearchClusterConfig: IResolvable) {
            cdkBuilder.elasticsearchClusterConfig(
                elasticsearchClusterConfig.let(IResolvable::unwrap)
            )
        }
         ...
         *   Service domain.
         */
        override fun elasticsearchClusterConfig(
            elasticsearchClusterConfig: ElasticsearchClusterConfigProperty
        ) {
            cdkBuilder.elasticsearchClusterConfig(
                elasticsearchClusterConfig.let(ElasticsearchClusterConfigProperty::unwrap)
            )
        }
        ...
        override fun elasticsearchClusterConfig(
            ...
            elasticsearchClusterConfig(
                ElasticsearchClusterConfigProperty(elasticsearchClusterConfig)
            )
        ...
        public fun build(): software.amazon.awscdk.services.elasticsearch.CfnDomain =
            cdkBuilder.build()
    }
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnDomain
        ): software.amazon.awscdk.services.elasticsearch.CfnDomain = wrapped.cdkObject
    }
    ...
    public interface ElasticsearchClusterConfigProperty {
        ...
        public interface Builder {
             ...
             *   dedicated master node, such as `m3.medium.elasticsearch` . If you specify this
             *   property, you must specify true for the `DedicatedMasterEnabled` property. For
             *   valid values, see
             *   [Supported instance types in Amazon OpenSearch Service](https://docs.aws.amazon.com/opensearch-service/latest/developerguide/supported-instance-types.html)
             *   .
             */
            ...
            /**
             * @param warmType The instance type for the cluster's warm nodes. Required if you
             *   enable warm storage.
             */
        ...
        internal constructor(
             ...
             * as `m3.medium.elasticsearch` . If you specify this property, you must specify true
             * for the `DedicatedMasterEnabled` property. For valid values, see
             * [Supported instance types in Amazon OpenSearch Service](https://docs.aws.amazon.com/opensearch-service/latest/developerguide/supported-instance-types.html)
             * .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-elasticsearch-domain-elasticsearchclusterconfig.html#cfn-elasticsearch-domain-elasticsearchclusterconfig-dedicatedmastertype)
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ElasticsearchClusterConfigProperty
            ): software.amazon.awscdk.services.elasticsearch.CfnDomain.ElasticsearchClusterConfigProperty =
    ...
    public interface MasterUserOptionsProperty {
        ...
        public interface Builder {
            /**
             * @param masterUserArn ARN for the master user. Only specify if
             *   `InternalUserDatabaseEnabled` is false in `AdvancedSecurityOptions` .
             */
            public fun masterUserArn(masterUserArn: String)

            /**
             * @param masterUserName Username for the master user. Only specify if
             *   `InternalUserDatabaseEnabled` is true in `AdvancedSecurityOptions` .
             */
    ...
    public interface EncryptionAtRestOptionsProperty {
         ...
         * The KMS key ID.
         *
         * Takes the form `1a2a3a4-1a2a-3a4a-5a6a-1a2a3a4a5a6a` . Required if you enable encryption
         * at rest.
         *
        ...
        internal constructor(
             ...
             * The KMS key ID.
             *
             * Takes the form `1a2a3a4-1a2a-3a4a-5a6a-1a2a3a4a5a6a` . Required if you enable
             * encryption at rest.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-elasticsearch-domain-encryptionatrestoptions.html#cfn-elasticsearch-domain-encryptionatrestoptions-kmskeyid)
             */
    ...
    public interface SnapshotOptionsProperty {
        ...
        public interface Builder {
             ...
             *   automated daily snapshot of the indices in the OpenSearch Service domain. For
        ...
        internal constructor(
             ...
             * indices in the OpenSearch Service domain.
             *
    ...
    public interface ColdStorageOptionsProperty {
        ...
        public interface Builder {
             ...
             *   enable UltraWarm storage in order to enable cold storage.
             */
            public fun enabled(enabled: Boolean)
    ...
    public interface VPCOptionsProperty {
        ...
        public interface Builder {
             ...
             *   uses. For example, you must specify three subnet IDs for a three Availability Zone
             *   domain. To learn more, see
    ...
    public interface EBSOptionsProperty {
         ...
         * io1.
         *
         * For more information about each type, see
        ...
        public interface Builder {
            ...
            /**
             * @param volumeType The EBS volume type to use with the OpenSearch Service domain, such
             *   as standard, gp2, or io1. For more information about each type, see
             *   [Amazon EBS volume types](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/EBSVolumeTypes.html)
             *   in the *Amazon EC2 User Guide for Linux Instances* .
             */
        ...
        internal constructor(
            ...
            /**
             * The EBS volume type to use with the OpenSearch Service domain, such as standard, gp2,
             * or io1.
             *
             * For more information about each type, see
             * [Amazon EBS volume types](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/EBSVolumeTypes.html)
    ...
    public interface CognitoOptionsProperty {
        ...
        /**
         * The `AmazonESCognitoAccess` role that allows OpenSearch Service to configure your user
        ...
        public interface Builder {
             ...
             *   Service to use for OpenSearch Dashboards authentication. Required if you enable
             *   Cognito authentication.
             */
            public fun identityPoolId(identityPoolId: String)

            /**
             * @param roleArn The `AmazonESCognitoAccess` role that allows OpenSearch Service to
             *   configure your user pool and identity pool. Required if you enable Cognito
             *   authentication.
             */
             ...
             *   use for OpenSearch Dashboards authentication. Required if you enable Cognito
             *   authentication.
             */
        ...
        internal constructor(
            ...
            /**
             * The `AmazonESCognitoAccess` role that allows OpenSearch Service to configure your
