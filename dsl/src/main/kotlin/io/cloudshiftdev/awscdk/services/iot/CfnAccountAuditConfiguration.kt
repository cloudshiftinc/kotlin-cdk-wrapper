...
internal constructor(
    ...
    public open fun auditCheckConfigurations(`value`: AuditCheckConfigurationsProperty) {
        unwrap(this)
            .setAuditCheckConfigurations(`value`.let(AuditCheckConfigurationsProperty::unwrap))
    }

    /** Specifies which audit checks are enabled and disabled for this account. */
    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("565de4b18f527546eaa72c809c3ffa5fa4277be3a78f3b5a410e6e4cf05d9404")
    public open fun auditCheckConfigurations(
        `value`: AuditCheckConfigurationsProperty.Builder.() -> Unit
    ...
    /** Information about the targets to which audit notifications are sent. */
    public open fun auditNotificationTargetConfigurations(
        `value`: AuditNotificationTargetConfigurationsProperty
    ) {
        unwrap(this)
            .setAuditNotificationTargetConfigurations(
                `value`.let(AuditNotificationTargetConfigurationsProperty::unwrap)
            )
    }
    ...
    public open fun auditNotificationTargetConfigurations(
        `value`: AuditNotificationTargetConfigurationsProperty.Builder.() -> Unit
    ): Unit =
        auditNotificationTargetConfigurations(
            AuditNotificationTargetConfigurationsProperty(`value`)
        )
    ...
    public interface Builder {
        ...
        public fun auditCheckConfigurations(
            auditCheckConfigurations: AuditCheckConfigurationsProperty.Builder.() -> Unit
        )
        ...
        public fun auditNotificationTargetConfigurations(
            auditNotificationTargetConfigurations:
                AuditNotificationTargetConfigurationsProperty.Builder.() -> Unit
        )
         ...
         *   IoT to access information about your devices, policies, certificates, and other items
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.iot.CfnAccountAuditConfiguration.Builder.create(
                scope,
                id
            )
         ...
         *   this account.
         */
        override fun auditCheckConfigurations(
            auditCheckConfigurations: AuditCheckConfigurationsProperty
        ) {
            cdkBuilder.auditCheckConfigurations(
                auditCheckConfigurations.let(AuditCheckConfigurationsProperty::unwrap)
            )
        }
        ...
        override fun auditCheckConfigurations(
            ...
            auditCheckConfigurations(AuditCheckConfigurationsProperty(auditCheckConfigurations))
         ...
         *   notifications are sent.
         */
        override fun auditNotificationTargetConfigurations(
            auditNotificationTargetConfigurations: IResolvable
        ) {
            cdkBuilder.auditNotificationTargetConfigurations(
                auditNotificationTargetConfigurations.let(IResolvable::unwrap)
            )
        }
        ...
        override fun auditNotificationTargetConfigurations(
            ...
            cdkBuilder.auditNotificationTargetConfigurations(
                auditNotificationTargetConfigurations.let(
                    AuditNotificationTargetConfigurationsProperty::unwrap
                )
            )
        }
        ...
        override fun auditNotificationTargetConfigurations(
            ...
            auditNotificationTargetConfigurations(
                AuditNotificationTargetConfigurationsProperty(auditNotificationTargetConfigurations)
            )
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnAccountAuditConfiguration
    ...
    public interface AuditCheckConfigurationsProperty {
         ...
         *
         * For this check, AWS IoT Device Defender audits all Amazon Cognito identity pools that
         * have been used to connect to the AWS IoT message broker during the 31 days before the
         * audit is performed.
         *
         ...
         */
        public fun caCertificateKeyQualityCheck(): Any? =
         ...
         */
        public fun deviceCertificateSharedCheck(): Any? =
         ...
         *
         * Misconfigured policies, including overly permissive policies, can cause security
         * incidents like allowing devices access to unintended resources. This check is a warning
         * for you to make sure that only intended actions are allowed before updating the policy.
         *
        ...
        /**
         * Checks if a role alias has access to services that haven't been used for the AWS IoT
         * device in the last year.
         *
        ...
        /**
         * Checks if the temporary credentials provided by AWS IoT role aliases are overly
         * permissive.
         *
        ...
        public interface Builder {
             ...
             *   authenticated Amazon Cognito identity pool role. For this check, AWS IoT Device
             *   Defender audits all Amazon Cognito identity pools that have been used to connect to
             *   the AWS IoT message broker during the 31 days before the audit is performed.
             */
            ...
            public fun authenticatedCognitoRoleOverlyPermissiveCheck(
                authenticatedCognitoRoleOverlyPermissiveCheck:
                    AuditCheckConfigurationProperty.Builder.() -> Unit
            )

            /**
             * @param caCertificateExpiringCheck Checks if a CA certificate is expiring. This check
             *   applies to CA certificates expiring within 30 days or that have expired.
             */
            ...
            public fun caCertificateExpiringCheck(
                caCertificateExpiringCheck: AuditCheckConfigurationProperty.Builder.() -> Unit
            )

            /**
             * @param caCertificateKeyQualityCheck Checks the quality of the CA certificate key. The
             *   quality checks if the key is in a valid format, not expired, and if the key meets a
             *   minimum required size. This check applies to CA certificates that are `ACTIVE` or
             *   `PENDING_TRANSFER` .
             */
            ...
            public fun caCertificateKeyQualityCheck(
                caCertificateKeyQualityCheck: AuditCheckConfigurationProperty.Builder.() -> Unit
            )

            /**
             * @param conflictingClientIdsCheck Checks if multiple devices connect using the same
             *   client ID.
             */
            ...
            public fun conflictingClientIdsCheck(
                conflictingClientIdsCheck: AuditCheckConfigurationProperty.Builder.() -> Unit
            )

            /**
             * @param deviceCertificateExpiringCheck Checks if a device certificate is expiring.
             *   This check applies to device certificates expiring within 30 days or that have
             *   expired.
             */
            ...
            public fun deviceCertificateExpiringCheck(
                deviceCertificateExpiringCheck: AuditCheckConfigurationProperty.Builder.() -> Unit
            )

            /**
             * @param deviceCertificateKeyQualityCheck Checks the quality of the device certificate
             *   key. The quality checks if the key is in a valid format, not expired, signed by a
             *   registered certificate authority, and if the key meets a minimum required size.
             */
            public fun deviceCertificateKeyQualityCheck(
                deviceCertificateKeyQualityCheck: IResolvable
            )
            ...
            public fun deviceCertificateKeyQualityCheck(
                deviceCertificateKeyQualityCheck: AuditCheckConfigurationProperty.Builder.() -> Unit
            )

            /**
             * @param deviceCertificateSharedCheck Checks if multiple concurrent connections use the
             *   same X.509 certificate to authenticate with AWS IoT .
             */
            ...
            public fun deviceCertificateSharedCheck(
                deviceCertificateSharedCheck: AuditCheckConfigurationProperty.Builder.() -> Unit
            )

            /**
             * @param intermediateCaRevokedForActiveDeviceCertificatesCheck Checks if device
             *   certificates are still active despite being revoked by an intermediate CA.
             */
            ...
            /**
             * @param ioTPolicyPotentialMisConfigurationCheck Checks if an AWS IoT policy is
             *   potentially misconfigured. Misconfigured policies, including overly permissive
             *   policies, can cause security incidents like allowing devices access to unintended
             *   resources. This check is a warning for you to make sure that only intended actions
             *   are allowed before updating the policy.
             */
            ...
            /**
             * @param iotPolicyOverlyPermissiveCheck Checks the permissiveness of a policy attached
             *   to an authenticated Amazon Cognito identity pool role.
             */
            ...
            public fun iotPolicyOverlyPermissiveCheck(
                iotPolicyOverlyPermissiveCheck: AuditCheckConfigurationProperty.Builder.() -> Unit
            )

            /**
             * @param iotRoleAliasAllowsAccessToUnusedServicesCheck Checks if a role alias has
             *   access to services that haven't been used for the AWS IoT device in the last year.
             */
            ...
            /**
             * @param iotRoleAliasOverlyPermissiveCheck Checks if the temporary credentials provided
             *   by AWS IoT role aliases are overly permissive.
             */
            public fun iotRoleAliasOverlyPermissiveCheck(
                iotRoleAliasOverlyPermissiveCheck: IResolvable
            )
            ...
            public fun loggingDisabledCheck(
                loggingDisabledCheck: AuditCheckConfigurationProperty.Builder.() -> Unit
            )

            /**
             * @param revokedCaCertificateStillActiveCheck Checks if a revoked CA certificate is
             *   still active.
             */
            ...
            /**
             * @param revokedDeviceCertificateStillActiveCheck Checks if a revoked device
            ...
            /**
             * @param unauthenticatedCognitoRoleOverlyPermissiveCheck Checks if policy attached to
             *   an unauthenticated Amazon Cognito identity pool role is too permissive.
             */
        ...
        private class BuilderImpl : Builder {
             ...
             *   the AWS IoT message broker during the 31 days before the audit is performed.
             */
            override fun authenticatedCognitoRoleOverlyPermissiveCheck(
                authenticatedCognitoRoleOverlyPermissiveCheck: IResolvable
            ) {
                cdkBuilder.authenticatedCognitoRoleOverlyPermissiveCheck(
                    authenticatedCognitoRoleOverlyPermissiveCheck.let(IResolvable::unwrap)
                )
            }
            ...
            override fun authenticatedCognitoRoleOverlyPermissiveCheck(
                ...
                cdkBuilder.authenticatedCognitoRoleOverlyPermissiveCheck(
                    authenticatedCognitoRoleOverlyPermissiveCheck.let(
                        AuditCheckConfigurationProperty::unwrap
                    )
                )
            }
            ...
            override fun authenticatedCognitoRoleOverlyPermissiveCheck(
                ...
                authenticatedCognitoRoleOverlyPermissiveCheck(
                    AuditCheckConfigurationProperty(authenticatedCognitoRoleOverlyPermissiveCheck)
                )
            ...
            override fun caCertificateExpiringCheck(caCertificateExpiringCheck: IResolvable) {
                cdkBuilder.caCertificateExpiringCheck(
                    caCertificateExpiringCheck.let(IResolvable::unwrap)
                )
            }
             ...
             *   applies to CA certificates expiring within 30 days or that have expired.
             */
            override fun caCertificateExpiringCheck(
                caCertificateExpiringCheck: AuditCheckConfigurationProperty
            ) {
                cdkBuilder.caCertificateExpiringCheck(
                    caCertificateExpiringCheck.let(AuditCheckConfigurationProperty::unwrap)
                )
            }
            ...
            override fun caCertificateExpiringCheck(
                ...
                caCertificateExpiringCheck(
                    AuditCheckConfigurationProperty(caCertificateExpiringCheck)
                )
            ...
            override fun caCertificateKeyQualityCheck(caCertificateKeyQualityCheck: IResolvable) {
                cdkBuilder.caCertificateKeyQualityCheck(
                    caCertificateKeyQualityCheck.let(IResolvable::unwrap)
                )
            }
             ...
             *   `PENDING_TRANSFER` .
             */
            override fun caCertificateKeyQualityCheck(
                caCertificateKeyQualityCheck: AuditCheckConfigurationProperty
            ) {
                cdkBuilder.caCertificateKeyQualityCheck(
                    caCertificateKeyQualityCheck.let(AuditCheckConfigurationProperty::unwrap)
                )
            }
            ...
            override fun conflictingClientIdsCheck(conflictingClientIdsCheck: IResolvable) {
                cdkBuilder.conflictingClientIdsCheck(
                    conflictingClientIdsCheck.let(IResolvable::unwrap)
                )
            }
             ...
             *   client ID.
             */
            override fun conflictingClientIdsCheck(
                conflictingClientIdsCheck: AuditCheckConfigurationProperty
            ) {
                cdkBuilder.conflictingClientIdsCheck(
                    conflictingClientIdsCheck.let(AuditCheckConfigurationProperty::unwrap)
                )
            }
            ...
            override fun conflictingClientIdsCheck(
                ...
                conflictingClientIdsCheck(
                    AuditCheckConfigurationProperty(conflictingClientIdsCheck)
                )
             ...
             *   expired.
             */
            override fun deviceCertificateExpiringCheck(
                deviceCertificateExpiringCheck: IResolvable
            ) {
                cdkBuilder.deviceCertificateExpiringCheck(
                    deviceCertificateExpiringCheck.let(IResolvable::unwrap)
                )
            }
            ...
            override fun deviceCertificateExpiringCheck(
                ...
                cdkBuilder.deviceCertificateExpiringCheck(
                    deviceCertificateExpiringCheck.let(AuditCheckConfigurationProperty::unwrap)
                )
            }
            ...
            override fun deviceCertificateExpiringCheck(
                ...
                deviceCertificateExpiringCheck(
                    AuditCheckConfigurationProperty(deviceCertificateExpiringCheck)
                )
             ...
             *   registered certificate authority, and if the key meets a minimum required size.
             */
            override fun deviceCertificateKeyQualityCheck(
                deviceCertificateKeyQualityCheck: IResolvable
            ) {
                cdkBuilder.deviceCertificateKeyQualityCheck(
                    deviceCertificateKeyQualityCheck.let(IResolvable::unwrap)
                )
            }
            ...
            override fun deviceCertificateKeyQualityCheck(
                ...
                cdkBuilder.deviceCertificateKeyQualityCheck(
                    deviceCertificateKeyQualityCheck.let(AuditCheckConfigurationProperty::unwrap)
                )
            }
            ...
            override fun deviceCertificateKeyQualityCheck(
                ...
                deviceCertificateKeyQualityCheck(
                    AuditCheckConfigurationProperty(deviceCertificateKeyQualityCheck)
                )
            ...
            override fun deviceCertificateSharedCheck(deviceCertificateSharedCheck: IResolvable) {
                cdkBuilder.deviceCertificateSharedCheck(
                    deviceCertificateSharedCheck.let(IResolvable::unwrap)
                )
            }
             ...
             *   same X.509 certificate to authenticate with AWS IoT .
             */
            override fun deviceCertificateSharedCheck(
                deviceCertificateSharedCheck: AuditCheckConfigurationProperty
            ) {
                cdkBuilder.deviceCertificateSharedCheck(
                    deviceCertificateSharedCheck.let(AuditCheckConfigurationProperty::unwrap)
                )
            }
            ...
            override fun deviceCertificateSharedCheck(
                ...
                deviceCertificateSharedCheck(
                    AuditCheckConfigurationProperty(deviceCertificateSharedCheck)
                )
             ...
             *   certificates are still active despite being revoked by an intermediate CA.
             */
            override fun intermediateCaRevokedForActiveDeviceCertificatesCheck(
                intermediateCaRevokedForActiveDeviceCertificatesCheck: IResolvable
            ) {
                cdkBuilder.intermediateCaRevokedForActiveDeviceCertificatesCheck(
                    intermediateCaRevokedForActiveDeviceCertificatesCheck.let(IResolvable::unwrap)
                )
            }
            ...
            override fun intermediateCaRevokedForActiveDeviceCertificatesCheck(
                ...
                cdkBuilder.intermediateCaRevokedForActiveDeviceCertificatesCheck(
                    intermediateCaRevokedForActiveDeviceCertificatesCheck.let(
                        AuditCheckConfigurationProperty::unwrap
                    )
                )
            }
             ...
             *   are allowed before updating the policy.
             */
            override fun ioTPolicyPotentialMisConfigurationCheck(
                ioTPolicyPotentialMisConfigurationCheck: IResolvable
            ) {
                cdkBuilder.ioTPolicyPotentialMisConfigurationCheck(
                    ioTPolicyPotentialMisConfigurationCheck.let(IResolvable::unwrap)
                )
            }
            ...
            override fun ioTPolicyPotentialMisConfigurationCheck(
                ...
                cdkBuilder.ioTPolicyPotentialMisConfigurationCheck(
                    ioTPolicyPotentialMisConfigurationCheck.let(
                        AuditCheckConfigurationProperty::unwrap
                    )
                )
            }
            ...
            override fun ioTPolicyPotentialMisConfigurationCheck(
                ...
                ioTPolicyPotentialMisConfigurationCheck(
                    AuditCheckConfigurationProperty(ioTPolicyPotentialMisConfigurationCheck)
                )
             ...
             *   to an authenticated Amazon Cognito identity pool role.
             */
            override fun iotPolicyOverlyPermissiveCheck(
                iotPolicyOverlyPermissiveCheck: IResolvable
            ) {
                cdkBuilder.iotPolicyOverlyPermissiveCheck(
                    iotPolicyOverlyPermissiveCheck.let(IResolvable::unwrap)
                )
            }
            ...
            override fun iotPolicyOverlyPermissiveCheck(
                ...
                cdkBuilder.iotPolicyOverlyPermissiveCheck(
                    iotPolicyOverlyPermissiveCheck.let(AuditCheckConfigurationProperty::unwrap)
                )
            }
            ...
            override fun iotPolicyOverlyPermissiveCheck(
                ...
                iotPolicyOverlyPermissiveCheck(
                    AuditCheckConfigurationProperty(iotPolicyOverlyPermissiveCheck)
                )
             ...
             *   access to services that haven't been used for the AWS IoT device in the last year.
             */
            override fun iotRoleAliasAllowsAccessToUnusedServicesCheck(
                iotRoleAliasAllowsAccessToUnusedServicesCheck: IResolvable
            ) {
                cdkBuilder.iotRoleAliasAllowsAccessToUnusedServicesCheck(
                    iotRoleAliasAllowsAccessToUnusedServicesCheck.let(IResolvable::unwrap)
                )
            }
            ...
            override fun iotRoleAliasAllowsAccessToUnusedServicesCheck(
                ...
                cdkBuilder.iotRoleAliasAllowsAccessToUnusedServicesCheck(
                    iotRoleAliasAllowsAccessToUnusedServicesCheck.let(
                        AuditCheckConfigurationProperty::unwrap
                    )
                )
            }
            ...
            override fun iotRoleAliasAllowsAccessToUnusedServicesCheck(
                ...
                iotRoleAliasAllowsAccessToUnusedServicesCheck(
                    AuditCheckConfigurationProperty(iotRoleAliasAllowsAccessToUnusedServicesCheck)
                )
             ...
             *   by AWS IoT role aliases are overly permissive.
             */
            override fun iotRoleAliasOverlyPermissiveCheck(
                iotRoleAliasOverlyPermissiveCheck: IResolvable
            ) {
                cdkBuilder.iotRoleAliasOverlyPermissiveCheck(
                    iotRoleAliasOverlyPermissiveCheck.let(IResolvable::unwrap)
                )
            }
            ...
            override fun iotRoleAliasOverlyPermissiveCheck(
                ...
                cdkBuilder.iotRoleAliasOverlyPermissiveCheck(
                    iotRoleAliasOverlyPermissiveCheck.let(AuditCheckConfigurationProperty::unwrap)
                )
            }
            ...
            override fun iotRoleAliasOverlyPermissiveCheck(
                ...
                iotRoleAliasOverlyPermissiveCheck(
                    AuditCheckConfigurationProperty(iotRoleAliasOverlyPermissiveCheck)
                )
            ...
            /** @param loggingDisabledCheck Checks if AWS IoT logs are disabled. */
            override fun loggingDisabledCheck(
                loggingDisabledCheck: AuditCheckConfigurationProperty
            ) {
                cdkBuilder.loggingDisabledCheck(
                    loggingDisabledCheck.let(AuditCheckConfigurationProperty::unwrap)
                )
            }
             ...
             *   still active.
             */
            override fun revokedCaCertificateStillActiveCheck(
                revokedCaCertificateStillActiveCheck: IResolvable
            ) {
                cdkBuilder.revokedCaCertificateStillActiveCheck(
                    revokedCaCertificateStillActiveCheck.let(IResolvable::unwrap)
                )
            }
            ...
            override fun revokedCaCertificateStillActiveCheck(
                ...
                cdkBuilder.revokedCaCertificateStillActiveCheck(
                    revokedCaCertificateStillActiveCheck.let(
                        AuditCheckConfigurationProperty::unwrap
                    )
                )
            }
            ...
            override fun revokedCaCertificateStillActiveCheck(
                ...
                revokedCaCertificateStillActiveCheck(
                    AuditCheckConfigurationProperty(revokedCaCertificateStillActiveCheck)
                )
             ...
             *   certificate is still active.
             */
            override fun revokedDeviceCertificateStillActiveCheck(
                revokedDeviceCertificateStillActiveCheck: IResolvable
            ) {
                cdkBuilder.revokedDeviceCertificateStillActiveCheck(
                    revokedDeviceCertificateStillActiveCheck.let(IResolvable::unwrap)
                )
            }
            ...
            override fun revokedDeviceCertificateStillActiveCheck(
                ...
                cdkBuilder.revokedDeviceCertificateStillActiveCheck(
                    revokedDeviceCertificateStillActiveCheck.let(
                        AuditCheckConfigurationProperty::unwrap
                    )
                )
            }
             ...
             *   an unauthenticated Amazon Cognito identity pool role is too permissive.
             */
            override fun unauthenticatedCognitoRoleOverlyPermissiveCheck(
                unauthenticatedCognitoRoleOverlyPermissiveCheck: IResolvable
            ) {
                cdkBuilder.unauthenticatedCognitoRoleOverlyPermissiveCheck(
                    unauthenticatedCognitoRoleOverlyPermissiveCheck.let(IResolvable::unwrap)
                )
            }
            ...
            override fun unauthenticatedCognitoRoleOverlyPermissiveCheck(
                ...
                cdkBuilder.unauthenticatedCognitoRoleOverlyPermissiveCheck(
                    unauthenticatedCognitoRoleOverlyPermissiveCheck.let(
                        AuditCheckConfigurationProperty::unwrap
                    )
                )
            }
            ...
            override fun unauthenticatedCognitoRoleOverlyPermissiveCheck(
                ...
                unauthenticatedCognitoRoleOverlyPermissiveCheck(
                    AuditCheckConfigurationProperty(unauthenticatedCognitoRoleOverlyPermissiveCheck)
                )
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-iot-accountauditconfiguration-auditcheckconfigurations.html#cfn-iot-accountauditconfiguration-auditcheckconfigurations-cacertificateexpiringcheck)
             */
            override fun caCertificateExpiringCheck(): Any? =
                unwrap(this).getCaCertificateExpiringCheck()

            /**
             * Checks the quality of the CA certificate key.
             *
             * The quality checks if the key is in a valid format, not expired, and if the key meets
             * a minimum required size. This check applies to CA certificates that are `ACTIVE` or
             * `PENDING_TRANSFER` .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-iot-accountauditconfiguration-auditcheckconfigurations.html#cfn-iot-accountauditconfiguration-auditcheckconfigurations-cacertificatekeyqualitycheck)
             */
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-iot-accountauditconfiguration-auditcheckconfigurations.html#cfn-iot-accountauditconfiguration-auditcheckconfigurations-conflictingclientidscheck)
             */
            override fun conflictingClientIdsCheck(): Any? =
             ...
             * Checks the quality of the device certificate key.
             *
             * The quality checks if the key is in a valid format, not expired, signed by a
             * registered certificate authority, and if the key meets a minimum required size.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-iot-accountauditconfiguration-auditcheckconfigurations.html#cfn-iot-accountauditconfiguration-auditcheckconfigurations-devicecertificatekeyqualitycheck)
             */
            ...
            /**
             * Checks if multiple concurrent connections use the same X.509 certificate to
            ...
            /**
             * Checks if device certificates are still active despite being revoked by an
             * intermediate CA.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-iot-accountauditconfiguration-auditcheckconfigurations.html#cfn-iot-accountauditconfiguration-auditcheckconfigurations-intermediatecarevokedforactivedevicecertificatescheck)
             */
             ...
             *
             * Misconfigured policies, including overly permissive policies, can cause security
             * incidents like allowing devices access to unintended resources. This check is a
             * warning for you to make sure that only intended actions are allowed before updating
             * the policy.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-iot-accountauditconfiguration-auditcheckconfigurations.html#cfn-iot-accountauditconfiguration-auditcheckconfigurations-iotpolicypotentialmisconfigurationcheck)
             */
            ...
            /**
             * Checks if policy attached to an unauthenticated Amazon Cognito identity pool role is
             * too permissive.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-iot-accountauditconfiguration-auditcheckconfigurations.html#cfn-iot-accountauditconfiguration-auditcheckconfigurations-unauthenticatedcognitoroleoverlypermissivecheck)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AuditCheckConfigurationsProperty
            ): software.amazon.awscdk.services.iot.CfnAccountAuditConfiguration.AuditCheckConfigurationsProperty =
    ...
    public interface AuditNotificationTargetProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param roleArn The ARN of the role that grants permission to send notifications to
             *   the target.
             */
            public fun roleArn(roleArn: String)

            /**
             * @param targetArn The ARN of the target (SNS topic) to which audit notifications are
             *   sent.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AuditNotificationTargetProperty
            ): software.amazon.awscdk.services.iot.CfnAccountAuditConfiguration.AuditNotificationTargetProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface AuditCheckConfigurationProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AuditCheckConfigurationProperty
            ): software.amazon.awscdk.services.iot.CfnAccountAuditConfiguration.AuditCheckConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface AuditNotificationTargetConfigurationsProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AuditNotificationTargetConfigurationsProperty
            ): software.amazon.awscdk.services.iot.CfnAccountAuditConfiguration.AuditNotificationTargetConfigurationsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
