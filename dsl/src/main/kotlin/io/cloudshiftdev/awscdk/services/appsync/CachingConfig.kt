...
public interface CachingConfig {
    ...
    public interface Builder {
        /**
         * @param cachingKeys The caching keys for a resolver that has caching enabled. Valid values
         *   are entries from the $context.arguments, $context.source, and $context.identity maps.
         */
    ...
    private class BuilderImpl : Builder {
        ...
        public fun build(): software.amazon.awscdk.services.appsync.CachingConfig =
            cdkBuilder.build()
    }
