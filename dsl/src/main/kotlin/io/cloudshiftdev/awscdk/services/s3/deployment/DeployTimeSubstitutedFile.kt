...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param destinationKey The object key in the destination bucket where the processed file
         *   would be written to.
         */
         ...
         * spaces. For example, if you use the key 'xxxx' in the file, it must be written as: {{
         * xxxx }} to be recognized by the construct as a substitution.
         *
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.s3.deployment.DeployTimeSubstitutedFile.Builder.create(
                scope,
                id
            )
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: DeployTimeSubstitutedFile
        ): software.amazon.awscdk.services.s3.deployment.DeployTimeSubstitutedFile =
            wrapped.cdkObject
    }
}
