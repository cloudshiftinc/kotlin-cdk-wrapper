...
internal constructor(
    ...
    public interface Builder {
         ...
         * numbers, hyphen, underscore, dollar sign, or hash mark.
         *
         * No whitespace.
         *
         ...
         *
         * @param schemaDefinition The schema definition using the `DataFormat` setting for
         *   `SchemaName` .
         */
        public fun schemaDefinition(schemaDefinition: String)

        /**
         * AWS tags that contain a key value pair and may be searched by console, command line, or
         * API.
         *
    ...
    private class BuilderImpl(
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("3eeb7859853555ddbc8e034fa3c713d1c5d55ef36b6839602ae57bb54808494c")
        override fun checkpointVersion(
            checkpointVersion: SchemaVersionProperty.Builder.() -> Unit
