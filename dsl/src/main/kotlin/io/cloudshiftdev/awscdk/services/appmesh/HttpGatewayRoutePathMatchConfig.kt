...
public interface HttpGatewayRoutePathMatchConfig {
    ...
    public fun prefixPathRewrite(): CfnGatewayRoute.HttpGatewayRoutePrefixRewriteProperty? =
        unwrap(this)
            ...
            ?.let(CfnGatewayRoute.HttpGatewayRoutePrefixRewriteProperty::wrap)
    ...
    public fun wholePathRewrite(): CfnGatewayRoute.HttpGatewayRoutePathRewriteProperty? =
        unwrap(this)
            .getWholePathRewrite()
            ?.let(CfnGatewayRoute.HttpGatewayRoutePathRewriteProperty::wrap)

    /** A builder for [HttpGatewayRoutePathMatchConfig] */
    @CdkDslMarker
    public interface Builder {
        /**
         * @param prefixPathMatch Gateway route configuration for matching on the prefix of the URL
         *   path of the request.
         */
        public fun prefixPathMatch(prefixPathMatch: String)

        /**
         * @param prefixPathRewrite Gateway route configuration for rewriting the prefix of the URL
         *   path of the request.
         */
        ...
        /**
         * @param wholePathMatch Gateway route configuration for matching on the complete URL path
         *   of the request.
         */
        ...
        public fun wholePathMatch(
            wholePathMatch: CfnGatewayRoute.HttpPathMatchProperty.Builder.() -> Unit
        )

        /**
         * @param wholePathRewrite Gateway route configuration for rewriting the complete URL path
         *   of the request..
         */
        ...
        public fun wholePathRewrite(
            wholePathRewrite: CfnGatewayRoute.HttpGatewayRoutePathRewriteProperty.Builder.() -> Unit
        )
    }
    ...
    private class BuilderImpl : Builder {
         ...
         *   path of the request.
         */
        override fun prefixPathRewrite(
            prefixPathRewrite: CfnGatewayRoute.HttpGatewayRoutePrefixRewriteProperty
        ) {
            cdkBuilder.prefixPathRewrite(
                prefixPathRewrite.let(CfnGatewayRoute.HttpGatewayRoutePrefixRewriteProperty::unwrap)
            )
        }
        ...
        override fun wholePathMatch(wholePathMatch: CfnGatewayRoute.HttpPathMatchProperty) {
            cdkBuilder.wholePathMatch(
                wholePathMatch.let(CfnGatewayRoute.HttpPathMatchProperty::unwrap)
            )
        }
         ...
         *   of the request..
         */
        override fun wholePathRewrite(
            wholePathRewrite: CfnGatewayRoute.HttpGatewayRoutePathRewriteProperty
        ) {
            cdkBuilder.wholePathRewrite(
                wholePathRewrite.let(CfnGatewayRoute.HttpGatewayRoutePathRewriteProperty::unwrap)
            )
        }
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: HttpGatewayRoutePathMatchConfig
        ): software.amazon.awscdk.services.appmesh.HttpGatewayRoutePathMatchConfig =
