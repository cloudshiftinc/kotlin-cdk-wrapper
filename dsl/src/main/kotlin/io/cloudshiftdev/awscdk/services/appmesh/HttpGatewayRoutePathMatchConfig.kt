...
public interface HttpGatewayRoutePathMatchConfig {
  ...
  private class BuilderImpl : Builder {
    ...
    public override fun wholePathMatch(wholePathMatch: CfnGatewayRoute.HttpPathMatchProperty) {
  ...
  private class Wrapper internal constructor(
    internal val cdkObject: software.amazon.awscdk.services.appmesh.HttpGatewayRoutePathMatchConfig,
  ) : HttpGatewayRoutePathMatchConfig {
    public override fun prefixPathMatch(): String? = unwrap(this).getPrefixPathMatch()

    public override fun prefixPathRewrite(): CfnGatewayRoute.HttpGatewayRoutePrefixRewriteProperty?
        =
        unwrap(this).getPrefixPathRewrite()?.let(CfnGatewayRoute.HttpGatewayRoutePrefixRewriteProperty::wrap)

    public override fun wholePathMatch(): CfnGatewayRoute.HttpPathMatchProperty? =
        unwrap(this).getWholePathMatch()?.let(CfnGatewayRoute.HttpPathMatchProperty::wrap)

    public override fun wholePathRewrite(): CfnGatewayRoute.HttpGatewayRoutePathRewriteProperty? =
        unwrap(this).getWholePathRewrite()?.let(CfnGatewayRoute.HttpGatewayRoutePathRewriteProperty::wrap)
  }
