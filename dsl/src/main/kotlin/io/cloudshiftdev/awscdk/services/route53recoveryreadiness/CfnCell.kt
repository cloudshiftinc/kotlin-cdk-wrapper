...
internal constructor(
    ...
    /**
     * The readiness scope for the cell, which can be the Amazon Resource Name (ARN) of a cell or
     * the ARN of a recovery group.
     *
    ...
    public interface Builder {
         ...
         *
         * @param cells A list of cell Amazon Resource Names (ARNs) contained within this cell, for
         *   use in nested cells.
         */
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.route53recoveryreadiness.CfnCell.Builder.create(
                scope,
                id
            )
