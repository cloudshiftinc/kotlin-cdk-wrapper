...
internal constructor(
    ...
    public interface Builder {
         ...
         * If true, the schedule is enabled.
         *
         * If false, the scheduled action does not trigger. For more information about `state` of
         * the scheduled action, see `ScheduledAction` .
         *
         ...
         * The IAM role to assume to run the scheduled action.
         *
         * This IAM role must have permission to run the Amazon Redshift API operation in the
         * scheduled action. This IAM role must allow the Amazon Redshift scheduler (Principal
    ...
    private class BuilderImpl(
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("d14944716e8349afb884b0656bf96de37477ce11afde21172787d26fbb9224eb")
        override fun targetAction(
            targetAction: ScheduledActionTypeProperty.Builder.() -> Unit
    ...
    public interface ResizeClusterMessageProperty {
        ...
        public interface Builder {
             ...
             *   classic resize process. If you don't provide this parameter or set the value to
            ...
            /**
             * @param numberOfNodes The new number of nodes for the cluster. If not specified, the
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ResizeClusterMessageProperty
            ): software.amazon.awscdk.services.redshift.CfnScheduledAction.ResizeClusterMessageProperty =
    ...
    public interface ResumeClusterMessageProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ResumeClusterMessageProperty
            ): software.amazon.awscdk.services.redshift.CfnScheduledAction.ResumeClusterMessageProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface PauseClusterMessageProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: PauseClusterMessageProperty
            ): software.amazon.awscdk.services.redshift.CfnScheduledAction.PauseClusterMessageProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ScheduledActionTypeProperty {
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("a24da4bcf80749aa50cbefd201500769afcab07d995759c89ae4b58185cd8ff4")
            override fun pauseCluster(
                pauseCluster: PauseClusterMessageProperty.Builder.() -> Unit
            ): Unit = pauseCluster(PauseClusterMessageProperty(pauseCluster))
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("dc0c6375f9e1956454d5514ce08573f2beb7656c87933e47644f071f71821d30")
            override fun resizeCluster(
                resizeCluster: ResizeClusterMessageProperty.Builder.() -> Unit
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("cb060bab55e9fef415647c52936d5aa164157292c6e5658c8be5d9de35546c1b")
            override fun resumeCluster(
                resumeCluster: ResumeClusterMessageProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ScheduledActionTypeProperty
            ): software.amazon.awscdk.services.redshift.CfnScheduledAction.ScheduledActionTypeProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
