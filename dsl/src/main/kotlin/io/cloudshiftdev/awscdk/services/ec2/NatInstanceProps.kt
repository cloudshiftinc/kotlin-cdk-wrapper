...
public interface NatInstanceProps {
    ...
    public interface Builder {
         ...
         *   types (T2, T3, T3a, etc). The unlimited CPU credit option is not supported for T3
         *   instances with dedicated host (`host`) tenancy.
         */
         ...
         *
         * If you set this to another value than INBOUND_AND_OUTBOUND, you must configure the NAT
         * instance's security groups in another way, either by passing in a fully configured
         * Security Group using the `securityGroup` property, or by configuring it using the
         * `.securityGroup` or `.connections` members after passing the NAT Instance Provider to a
         * Vpc.
         */
        ...
        /**
         * @param machineImage The machine image (AMI) to use. By default, will do an AMI lookup for
         *   the latest NAT instance image.
         *
         * If you have a specific AMI ID you want to use, pass a `GenericLinuxImage`. For example:
         * ```
         * NatProvider.instance(NatInstanceProps.builder()
    ...
    private class BuilderImpl : Builder {
        ...
        public fun build(): software.amazon.awscdk.services.ec2.NatInstanceProps =
            cdkBuilder.build()
    }
