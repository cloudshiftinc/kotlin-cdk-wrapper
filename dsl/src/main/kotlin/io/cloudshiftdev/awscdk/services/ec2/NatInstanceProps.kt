...
public interface NatInstanceProps {
  ...
  private class Wrapper internal constructor(
    ...
    public override fun creditSpecification(): CpuCredits? =
        unwrap(this).getCreditSpecification()?.let(CpuCredits::wrap)

    public override fun defaultAllowedTraffic(): NatTrafficDirection? =
        unwrap(this).getDefaultAllowedTraffic()?.let(NatTrafficDirection::wrap)
    ...
    public override fun keyPair(): IKeyPair? = unwrap(this).getKeyPair()?.let(IKeyPair::wrap)
