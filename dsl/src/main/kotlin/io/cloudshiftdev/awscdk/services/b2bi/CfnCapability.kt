...
internal constructor(
    ...
    public open fun configuration(
        `value`: CapabilityConfigurationProperty.Builder.() -> Unit
    ): Unit = configuration(CapabilityConfigurationProperty(`value`))
    ...
    public interface Builder {
         ...
         * used with this capability.
         *
         * Each item contains the name of the bucket and the key, to identify the document's
         * location.
         *
         ...
         *
         * @param instructionsDocuments Specifies one or more locations in Amazon S3, each
         *   specifying an EDI document that can be used with this capability.
         */
    ...
    private class BuilderImpl(
        ...
        override fun configuration(
            configuration: CapabilityConfigurationProperty.Builder.() -> Unit
    ...
    public companion object {
        ...
        ): CfnCapability = CfnCapability(cdkObject)

        internal fun unwrap(
            wrapped: CfnCapability
        ): software.amazon.awscdk.services.b2bi.CfnCapability = wrapped.cdkObject
    }
    ...
    public interface CapabilityConfigurationProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CapabilityConfigurationProperty
            ): software.amazon.awscdk.services.b2bi.CfnCapability.CapabilityConfigurationProperty =
    ...
    public interface X12DetailsProperty {
        ...
        public interface Builder {
             ...
             *   transaction set. Transaction sets are maintained by the X12 Accredited Standards
             *   Committee.
             */
    ...
    public interface EdiConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param inputLocation Contains the Amazon S3 bucket and prefix for the location of the
            ...
            /**
             * @param outputLocation Contains the Amazon S3 bucket and prefix for the location of
            ...
            /**
             * @param transformerId Returns the system-assigned unique identifier for the
             *   transformer.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            override fun outputLocation(
                outputLocation: S3LocationProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * is contained in an `S3Location` object.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-b2bi-capability-ediconfiguration.html#cfn-b2bi-capability-ediconfiguration-outputlocation)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: EdiConfigurationProperty
            ): software.amazon.awscdk.services.b2bi.CfnCapability.EdiConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface EdiTypeProperty {
        ...
        internal constructor(
            internal val cdkObject:
                software.amazon.awscdk.services.b2bi.CfnCapability.EdiTypeProperty,
        ) : EdiTypeProperty {
            /**
             * Returns the details for the EDI standard that is being used for the transformer.
             *
