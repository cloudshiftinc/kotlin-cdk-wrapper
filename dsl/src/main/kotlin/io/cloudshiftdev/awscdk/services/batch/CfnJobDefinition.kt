...
internal constructor(
    ...
    public open fun containerProperties(
        `value`: ContainerPropertiesProperty.Builder.() -> Unit
    ): Unit = containerProperties(ContainerPropertiesProperty(`value`))
    ...
    public open fun platformCapabilities(): List<String> =
        unwrap(this).getPlatformCapabilities() ?: emptyList()
    ...
    public interface Builder {
        ...
        public fun containerProperties(
            containerProperties: ContainerPropertiesProperty.Builder.() -> Unit
        )
         ...
         *
         * @param eksProperties An object with properties that are specific to Amazon EKS-based
         *   jobs.
         */
         ...
         * override any corresponding parameter defaults from the job definition. For more
         * information about specifying parameters, see
         ...
         *
         * @param parameters Default parameters or parameter substitution placeholders that are set
         ...
         * corresponding Amazon ECS task.
         *
         * If no value is specified, the tags aren't propagated. Tags can only be propagated to the
         * tasks when the tasks are created. For tags with the same name, job tags are given
         * priority over job definitions tags. If the total number of combined tags from the job and
         ...
         *
         * @param propagateTags Specifies whether to propagate the tags from the job or job
         *   definition to the corresponding Amazon ECS task.
         */
         ...
         * The scheduling priority of the job definition.
         *
         * This only affects jobs in job queues with a fair share policy. Jobs with a higher
         ...
         * The timeout time for jobs that are submitted with this job definition.
         *
         * After the amount of time you specify passes, AWS Batch terminates your jobs if they
         * aren't finished.
         *
    ...
    private class BuilderImpl(
        ...
        override fun containerProperties(containerProperties: ContainerPropertiesProperty) {
            cdkBuilder.containerProperties(
                containerProperties.let(ContainerPropertiesProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("a4cf19641d5566ae14a63dfceec2d34db0f790bc7d23f120f624afcdf4d912eb")
        override fun containerProperties(
            containerProperties: ContainerPropertiesProperty.Builder.() -> Unit
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("8bde92f0b9ddcf3791dc7f0235f8fd0f91ffb9d87442b55922414a7a4c0ec9cf")
        override fun nodeProperties(
            nodeProperties: NodePropertiesProperty.Builder.() -> Unit
        ): Unit = nodeProperties(NodePropertiesProperty(nodeProperties))
        ...
        public fun build(): software.amazon.awscdk.services.batch.CfnJobDefinition =
            cdkBuilder.build()
    }
    ...
    public interface LinuxParametersProperty {
         ...
         * [docker run](https://docs.aws.amazon.com/https://docs.docker.com/engine/reference/run/)
         * where the value is the sum of the container memory plus the `maxSwap` value. For more
         * information, see
         * [`--memory-swap` details](https://docs.aws.amazon.com/https://docs.docker.com/config/containers/resource_constraints/#--memory-swap-details)
         ...
         * doesn't use the swap configuration for the container instance that it's running on. A
         ...
         * `swappiness` value of `100` causes pages to be swapped aggressively. Valid values are
         * whole numbers between `0` and `100` . If the `swappiness` parameter isn't specified, a
         * default value of `60` is used. If a value isn't specified for `maxSwap` , then this
         * parameter is ignored. If `maxSwap` is set to 0, the container doesn't use swap. This
         ...
         *   to use.
         *
         * By default, the Amazon ECS optimized AMIs don't have swap enabled. You must enable swap
         * on the instance to use this feature. For more information, see
         * [Instance store swap volumes](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/instance-store-swap-volumes.html)
         * in the *Amazon EC2 User Guide for Linux Instances* or
         * [How do I allocate memory to work as swap space in an Amazon EC2 instance by using a swap file?](https://docs.aws.amazon.com/premiumsupport/knowledge-center/ec2-memory-swap-file/)
         * * The swap space parameters are only supported for job definitions using EC2 resources.
         * * If the `maxSwap` and `swappiness` parameters are omitted from a job definition, each
         *   container has a default `swappiness` value of 60. Moreover, the total swap usage is
        ...
        public interface Builder {
            /**
             * @param devices Any of the host devices to expose to the container. This parameter
            ...
            /**
             * @param initProcessEnabled If true, run an `init` process inside the container that
             *   forwards signals and reaps processes. This parameter maps to the `--init` option to
             *   [docker run](https://docs.aws.amazon.com/https://docs.docker.com/engine/reference/run/)
             *   . This parameter requires version 1.25 of the Docker Remote API or greater on your
             ...
             * container doesn't use the swap configuration for the container instance that it's
             ...
             *   absolutely necessary. A `swappiness` value of `100` causes pages to be swapped
             *   aggressively. Valid values are whole numbers between `0` and `100` . If the
             *   `swappiness` parameter isn't specified, a default value of `60` is used. If a value
             *   isn't specified for `maxSwap` , then this parameter is ignored. If `maxSwap` is set
             *   to 0, the container doesn't use swap. This parameter maps to the
             ...
             * swap on the instance to use this feature. For more information, see
             * [Instance store swap volumes](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/instance-store-swap-volumes.html)
             * in the *Amazon EC2 User Guide for Linux Instances* or
             * [How do I allocate memory to work as swap space in an Amazon EC2 instance by using a swap file?](https://docs.aws.amazon.com/premiumsupport/knowledge-center/ec2-memory-swap-file/)
            ...
            /**
             * @param tmpfs The container path, mount options, and size (in MiB) of the `tmpfs`
        ...
        internal constructor(
             ...
             * , then this parameter is ignored. If `maxSwap` is set to 0, the container doesn't use
             * swap. This parameter maps to the `--memory-swappiness` option to
             * [docker run](https://docs.aws.amazon.com/https://docs.docker.com/engine/reference/run/)
             * .
             *
             * Consider the following when you use a per-container swap configuration.
    ...
    public interface ResourceRequirementProperty {
         ...
         *   parameter is supported for jobs that are running on Amazon EC2 resources. If your
         *   container attempts to exceed the memory specified, the container is terminated. This
         ...
         *   [docker run](https://docs.aws.amazon.com/https://docs.docker.com/engine/reference/run/)
         *   . Each vCPU is equivalent to 1,024 CPU shares. For Amazon EC2 resources, you must
         *   specify at least one vCPU. This is required but can be specified in several places; it
    ...
    public interface TimeoutProperty {
         ...
         * timestamp.
         *
         * After this time passes, AWS Batch terminates your jobs if they aren't finished. The
        ...
        public interface Builder {
            /**
             * @param attemptDurationSeconds The job timeout time (in seconds) that's measured from
             *   the job attempt's `startedAt` timestamp. After this time passes, AWS Batch
             *   terminates your jobs if they aren't finished. The minimum value for the timeout is
             *   60 seconds.
             *
             * For array jobs, the timeout applies to the child jobs, not to the parent array job.
             *
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-batch-jobdefinition-timeout.html#cfn-batch-jobdefinition-timeout-attemptdurationseconds)
             */
            override fun attemptDurationSeconds(): Number? =
                unwrap(this).getAttemptDurationSeconds()
        }
    ...
    public interface SecretProperty {
         ...
         * Manager secret or the full ARN of the parameter in the AWS Systems Manager Parameter
         * Store.
         *
         * If the AWS Systems Manager Parameter Store parameter exists in the same Region as the job
         * you're launching, then you can use either the full Amazon Resource Name (ARN) or name of
         * the parameter. If the parameter exists in a different Region, then the full ARN must be
         * specified.
         *
        ...
        public interface Builder {
             ...
             *   either the full Amazon Resource Name (ARN) of the AWS Secrets Manager secret or the
             ...
             * job you're launching, then you can use either the full Amazon Resource Name (ARN) or
             * name of the parameter. If the parameter exists in a different Region, then the full
        ...
        internal constructor(
             ...
             * The secret to expose to the container.
             *
             * The supported values are either the full Amazon Resource Name (ARN) of the AWS
             * Secrets Manager secret or the full ARN of the parameter in the AWS Systems Manager
             * Parameter Store.
             *
             * If the AWS Systems Manager Parameter Store parameter exists in the same Region as the
             * job you're launching, then you can use either the full Amazon Resource Name (ARN) or
    ...
    public interface VolumesHostProperty {
         ...
         * location doesn't exist on the host container instance, the Docker daemon creates it. If
        ...
        public interface Builder {
             ...
             *   container. If this parameter is empty, then the Docker daemon has assigned a host
             *   path for you. If this parameter contains a file location, then the data volume
             *   persists at the specified location on the host container instance until you delete
             *   it manually. If the source path location doesn't exist on the host container
        ...
        internal constructor(
             ...
             * the source path location doesn't exist on the host container instance, the Docker
    ...
    public interface AuthorizationConfigProperty {
         ...
         * `EFSVolumeConfiguration` must either be omitted or set to `/` which enforces the path set
         * on the EFS access point. If an access point is used, transit encryption must be enabled
         * in the `EFSVolumeConfiguration` . For more information, see
        ...
        public interface Builder {
             ...
             *   either be omitted or set to `/` which enforces the path set on the EFS access
            ...
            /**
             * @param iam Whether or not to use the AWS Batch job IAM role defined in a job
             *   definition when mounting the Amazon EFS file system. If enabled, transit encryption
             *   must be enabled in the `EFSVolumeConfiguration` . If this parameter is omitted, the
        ...
        internal constructor(
             ...
             * set on the EFS access point. If an access point is used, transit encryption must be
             ...
             * mounting the Amazon EFS file system.
             *
             * If enabled, transit encryption must be enabled in the `EFSVolumeConfiguration` . If
    ...
    public interface EfsVolumeConfigurationProperty {
        ...
        public interface Builder {
             ...
             *   Amazon EFS volume is used instead. Specifying `/` has the same effect as omitting
            ...
            /**
             * @param transitEncryption Determines whether to enable encryption for Amazon EFS data
             *   in transit between the Amazon ECS host and the Amazon EFS server. Transit
             *   encryption must be enabled if Amazon EFS IAM authorization is used. If this
             ...
             *   Amazon ECS host and the Amazon EFS server. If you don't specify a transit
             *   encryption port, it uses the port selection strategy that the Amazon EFS mount
             *   helper uses. The value must be between 0 and 65,535. For more information, see
        ...
        internal constructor(
             ...
             * Amazon EFS server.
             *
             * If you don't specify a transit encryption port, it uses the port selection strategy
    ...
    public interface EksSecretProperty {
         ...
         * The name of the secret.
         *
         * The name must be allowed as a DNS subdomain name. For more information, see
        ...
        public interface Builder {
            ...
            /**
             * @param secretName The name of the secret. The name must be allowed as a DNS subdomain
    ...
    public interface EksPropertiesProperty {
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("736253c4cd1efc18e8b136980a99629cc7b68d3ead8e7f8bf14257b5e627ee7c")
            override fun podProperties(
                podProperties: PodPropertiesProperty.Builder.() -> Unit
            ): Unit = podProperties(PodPropertiesProperty(podProperties))
    ...
    public interface NodePropertiesProperty {
        ...
        public interface Builder {
            /**
             * @param mainNode Specifies the node index for the main node of a multi-node parallel
             *   job. This node index value must be fewer than the number of nodes.
             */
            public fun mainNode(mainNode: Number)

            /**
             * @param nodeRangeProperties A list of node ranges and their properties that are
            ...
            /**
             * @param numNodes The number of nodes that are associated with a multi-node parallel
             *   job.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: NodePropertiesProperty
            ): software.amazon.awscdk.services.batch.CfnJobDefinition.NodePropertiesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface LogConfigurationProperty {
         ...
         *   [Amazon CloudWatch Logs logging driver](https://docs.aws.amazon.com/https://docs.docker.com/config/containers/logging/awslogs/)
         *   in the Docker documentation.
         * * **fluentd** - Specifies the Fluentd logging driver. For more information including
         *   usage and options, see
         *   [Fluentd logging driver](https://docs.aws.amazon.com/https://docs.docker.com/config/containers/logging/fluentd/)
         *   in the *Docker documentation* .
         * * **gelf** - Specifies the Graylog Extended Format (GELF) logging driver. For more
         *   information including usage and options, see
         *   [Graylog Extended Format logging driver](https://docs.aws.amazon.com/https://docs.docker.com/config/containers/logging/gelf/)
         *   in the *Docker documentation* .
         * * **journald** - Specifies the journald logging driver. For more information including
         *   usage and options, see
         *   [Journald logging driver](https://docs.aws.amazon.com/https://docs.docker.com/config/containers/logging/journald/)
         *   in the *Docker documentation* .
         * * **json-file** - Specifies the JSON file logging driver. For more information including
         *   usage and options, see
         *   [JSON File logging driver](https://docs.aws.amazon.com/https://docs.docker.com/config/containers/logging/json-file/)
         *   in the *Docker documentation* .
         * * **splunk** - Specifies the Splunk logging driver. For more information including usage
         *   and options, see
         *   [Splunk logging driver](https://docs.aws.amazon.com/https://docs.docker.com/config/containers/logging/splunk/)
         *   in the *Docker documentation* .
         * * **syslog** - Specifies the syslog logging driver. For more information including usage
         *   and options, see
         *   [Syslog logging driver](https://docs.aws.amazon.com/https://docs.docker.com/config/containers/logging/syslog/)
         *   in the *Docker documentation* .
         *
         ...
         * changes that you want to have included. However, Amazon Web Services doesn't currently
        ...
        public interface Builder {
            /**
             * @param logDriver The log driver to use for the container. The valid values that are
             *   listed for this parameter are log drivers that the Amazon ECS container agent can
             ...
             *   [Graylog Extended Format logging driver](https://docs.aws.amazon.com/https://docs.docker.com/config/containers/logging/gelf/)
             *   in the *Docker documentation* .
             * * **journald** - Specifies the journald logging driver. For more information
        ...
        internal constructor(
             ...
             * The log driver to use for the container.
             *
             * The valid values that are listed for this parameter are log drivers that the Amazon
    ...
    public interface FargatePlatformConfigurationProperty {
         ...
         *
         * A platform version is specified only for jobs that are running on Fargate resources. If
         * one isn't specified, the `LATEST` platform version is used by default. This uses a
         * recent, approved version of the AWS Fargate platform for compute resources. For more
         * information, see
        ...
        public interface Builder {
            /**
             * @param platformVersion The AWS Fargate platform version where the jobs are running. A
             *   platform version is specified only for jobs that are running on Fargate resources.
             *   If one isn't specified, the `LATEST` platform version is used by default. This uses
             *   a recent, approved version of the AWS Fargate platform for compute resources. For
             *   more information, see
             *   [AWS Fargate platform versions](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/platform_versions.html)
             *   in the *Amazon Elastic Container Service Developer Guide* .
             */
        ...
        internal constructor(
             ...
             * If one isn't specified, the `LATEST` platform version is used by default. This uses a
             * recent, approved version of the AWS Fargate platform for compute resources. For more
             * information, see
             * [AWS Fargate platform versions](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/platform_versions.html)
             * in the *Amazon Elastic Container Service Developer Guide* .
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: FargatePlatformConfigurationProperty
            ): software.amazon.awscdk.services.batch.CfnJobDefinition.FargatePlatformConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface EvaluateOnExitProperty {
         ...
         * returned for a job.
         *
         * The pattern can be up to 512 characters long. It can contain only numbers, and can end
         ...
         * (.), colons (:), and white space (including spaces and tabs). It can optionally end with
         ...
         *
         * The pattern can contain up to 512 characters. It can contain letters, numbers, periods
         * (.), colons (:), and white spaces (including spaces or tabs). It can optionally end with
         * an asterisk (*) so that only the start of the string needs to be an exact match.
         *
        ...
        public interface Builder {
            ...
            /**
             * @param onExitCode Contains a glob pattern to match against the decimal representation
             *   of the `ExitCode` returned for a job. The pattern can be up to 512 characters long.
             *   It can contain only numbers, and can end with an asterisk (*) so that only the
            ...
            /**
             * @param onReason Contains a glob pattern to match against the `Reason` returned for a
             *   job. The pattern can contain up to 512 characters. It can contain letters, numbers,
            ...
            /**
             * @param onStatusReason Contains a glob pattern to match against the `StatusReason`
        ...
        internal constructor(
             ...
             * returned for a job.
             *
             * The pattern can be up to 512 characters long. It can contain only numbers, and can
             ...
             * periods (.), colons (:), and white space (including spaces and tabs). It can
             * optionally end with an asterisk (*) so that only the start of the string needs to be
             * an exact match.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-batch-jobdefinition-evaluateonexit.html#cfn-batch-jobdefinition-evaluateonexit-onreason)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: EvaluateOnExitProperty
            ): software.amazon.awscdk.services.batch.CfnJobDefinition.EvaluateOnExitProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface TmpfsProperty {
         ...
         * | " `strictatime` " | " `nostrictatime` " | " `mode` " | " `uid` " | " `gid` " | "
        ...
        public interface Builder {
            /**
             * @param containerPath The absolute file path in the container where the `tmpfs` volume
             *   is mounted.
             */
            public fun containerPath(containerPath: String)

            /**
             * @param mountOptions The list of `tmpfs` volume mount options. Valid values: "
             *   `defaults` " | " `ro` " | " `rw` " | " `suid` " | " `nosuid` " | " `dev` " | "
             *   `nodev` " | " `exec` " | " `noexec` " | " `sync` " | " `async` " | " `dirsync` " |
             *   " `remount` " | " `mand` " | " `nomand` " | " `atime` " | " `noatime` " | "
        ...
        internal constructor(
             ...
             * `dev` " | " `nodev` " | " `exec` " | " `noexec` " | " `sync` " | " `async` " | "
             * `dirsync` " | " `remount` " | " `mand` " | " `nomand` " | " `atime` " | " `noatime` "
             * | " `diratime` " | " `nodiratime` " | " `bind` " | " `rbind" | "unbindable" |
             * "runbindable" | "private" | "rprivate" | "shared" | "rshared" | "slave" | "rslave" |
    ...
    public interface NodeRangePropertyProperty {
         ...
         * value is omitted ( `n:` ), then the highest possible node index is used to end the range.
         * Your accumulative node ranges must account for all nodes ( `0:n` ). You can nest node
        ...
        public interface Builder {
            ...
            /**
             * @param targetNodes The range of nodes, using node index values. A range of `0:3`
             *   indicates nodes with index values of `0` through `3` . If the starting range value
             *   is omitted ( `:n` ), then `0` is used to start the range. If the ending range value
             *   is omitted ( `n:` ), then the highest possible node index is used to end the range.
             *   Your accumulative node ranges must account for all nodes ( `0:n` ). You can nest
             *   node ranges (for example, `0:10` and `4:5` ). In this case, the `4:5` range
        ...
        private class BuilderImpl : Builder {
            ...
            override fun container(
                container: ContainerPropertiesProperty.Builder.() -> Unit
            ): Unit = container(ContainerPropertiesProperty(container))
        ...
        internal constructor(
             ...
             * The range of nodes, using node index values.
             *
             * A range of `0:3` indicates nodes with index values of `0` through `3` . If the
             * starting range value is omitted ( `:n` ), then `0` is used to start the range. If the
             * ending range value is omitted ( `n:` ), then the highest possible node index is used
             * to end the range. Your accumulative node ranges must account for all nodes ( `0:n` ).
             * You can nest node ranges (for example, `0:10` and `4:5` ). In this case, the `4:5`
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: NodeRangePropertyProperty
            ): software.amazon.awscdk.services.batch.CfnJobDefinition.NodeRangePropertyProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface EksVolumeProperty {
        ...
        public interface Builder {
            /**
             * @param emptyDir Specifies the configuration of a Kubernetes `emptyDir` volume. For
             *   more information, see
             *   [emptyDir](https://docs.aws.amazon.com/https://kubernetes.io/docs/concepts/storage/volumes/#emptydir)
             *   in the *Kubernetes documentation* .
             */
            ...
            /**
             * @param hostPath Specifies the configuration of a Kubernetes `hostPath` volume. For
             *   more information, see
             *   [hostPath](https://docs.aws.amazon.com/https://kubernetes.io/docs/concepts/storage/volumes/#hostpath)
             *   in the *Kubernetes documentation* .
             */
            ...
            /**
             * @param name The name of the volume. The name must be allowed as a DNS subdomain name.
             *   For more information, see
             *   [DNS subdomain names](https://docs.aws.amazon.com/https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#dns-subdomain-names)
             *   in the *Kubernetes documentation* .
             */
    ...
    public interface NetworkConfigurationProperty {
         ...
         *
         * For a job that's running on Fargate resources in a private subnet to send outbound
         * traffic to the internet (for example, to pull container images), the private subnet
        ...
        public interface Builder {
            /**
             * @param assignPublicIp Indicates whether the job has a public IP address. For a job
             *   that's running on Fargate resources in a private subnet to send outbound traffic to
             *   the internet (for example, to pull container images), the private subnet requires a
    ...
    public interface UlimitProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param name The `type` of the `ulimit` . Valid values are: `core` | `cpu` | `data` |
             *   `fsize` | `locks` | `memlock` | `msgqueue` | `nice` | `nofile` | `nproc` | `rss` |
        ...
        internal constructor(
             ...
             * The `type` of the `ulimit` .
             *
             * Valid values are: `core` | `cpu` | `data` | `fsize` | `locks` | `memlock` |
             * `msgqueue` | `nice` | `nofile` | `nproc` | `rss` | `rtprio` | `rttime` | `sigpending`
             * | `stack` .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-batch-jobdefinition-ulimit.html#cfn-batch-jobdefinition-ulimit-name)
             */
    ...
    public interface EksContainerProperty {
         ...
         *
         * If this isn't specified, the `CMD` of the container image is used. This corresponds to
         * the `args` member in the
         ...
         * variable doesn't exist, the command string will remain " `$(NAME1)` ." `$$` is replaced
         * with `$` , and the resulting string isn't expanded. For example, `$$(VAR_NAME)` is passed
         * as `$(VAR_NAME)` whether or not the `VAR_NAME` environment variable exists. For more
         * information, see
         * [Dockerfile reference: CMD](https://docs.aws.amazon.com/https://docs.docker.com/engine/reference/builder/#cmd)
         * and
         ...
         * changed. For example, if the reference is to " `$(NAME1)` " and the `NAME1` environment
         * variable doesn't exist, the command string will remain " `$(NAME1)` ." `$$` is replaced
         * with `$` and the resulting string isn't expanded. For example, `$$(VAR_NAME)` will be
         * passed as `$(VAR_NAME)` whether or not the `VAR_NAME` environment variable exists. The
         * entrypoint can't be updated. For more information, see
         ...
         * `IfNotPresent` . However, if the `:latest` tag is specified, it defaults to `Always` .
         * For more information, see
        ...
        public interface Builder {
            /**
             * @param args An array of arguments to the entrypoint. If this isn't specified, the
             *   `CMD` of the container image is used. This corresponds to the `args` member in the
             *   [Entrypoint](https://docs.aws.amazon.com/https://kubernetes.io/docs/reference/kubernetes-api/workload-resources/pod-v1/#entrypoint)
             *   portion of the
             *   [Pod](https://docs.aws.amazon.com/https://kubernetes.io/docs/reference/kubernetes-api/workload-resources/pod-v1/)
             *   in Kubernetes. Environment variable references are expanded using the container's
             ...
             * isn't changed. For example, if the reference is to " `$(NAME1)` " and the `NAME1`
             * environment variable doesn't exist, the command string will remain " `$(NAME1)` ."
             * `$$` is replaced with `$` , and the resulting string isn't expanded. For example,
             * `$$(VAR_NAME)` is passed as `$(VAR_NAME)` whether or not the `VAR_NAME` environment
            ...
            /**
             * @param command The entrypoint for the container. This isn't run within a shell. If
             *   this isn't specified, the `ENTRYPOINT` of the container image is used. Environment
            ...
            /**
             * @param imagePullPolicy The image pull policy for the container. Supported values are
            ...
            /**
             * @param resources The type and amount of resources to assign to a container. The
            ...
            /**
             * @param volumeMounts The volume mounts for the container. AWS Batch supports
             *   `emptyDir` , `hostPath` , and `secret` volume types. For more information about
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("630ea6b519c7e542aaed3622e1835518d66bad7f20d399381064a7aa911e4af9")
            override fun securityContext(
                securityContext: SecurityContextProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * An array of arguments to the entrypoint.
             *
             * If this isn't specified, the `CMD` of the container image is used. This corresponds
             * to the `args` member in the
             * [Entrypoint](https://docs.aws.amazon.com/https://kubernetes.io/docs/reference/kubernetes-api/workload-resources/pod-v1/#entrypoint)
             * portion of the
             * [Pod](https://docs.aws.amazon.com/https://kubernetes.io/docs/reference/kubernetes-api/workload-resources/pod-v1/)
             * in Kubernetes. Environment variable references are expanded using the container's
             ...
             * The entrypoint for the container.
             *
             * This isn't run within a shell. If this isn't specified, the `ENTRYPOINT` of the
             * container image is used. Environment variable references are expanded using the
             ...
             * The image pull policy for the container.
             *
             * Supported values are `Always` , `IfNotPresent` , and `Never` . This parameter
             * defaults to `IfNotPresent` . However, if the `:latest` tag is specified, it defaults
             * to `Always` . For more information, see
             * [Updating images](https://docs.aws.amazon.com/https://kubernetes.io/docs/concepts/containers/images/#updating-images)
             * in the *Kubernetes documentation* .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-batch-jobdefinition-ekscontainer.html#cfn-batch-jobdefinition-ekscontainer-imagepullpolicy)
             ...
             * The name of the container.
             *
             * If the name isn't specified, the default name " `Default` " is used. Each container
    ...
    public interface VolumesProperty {
        ...
        public interface Builder {
            /**
             * @param efsVolumeConfiguration This is used when you're using an Amazon Elastic File
             *   System file system for job storage. For more information, see
             *   [Amazon EFS Volumes](https://docs.aws.amazon.com/batch/latest/userguide/efs-volumes.html)
             *   in the *AWS Batch User Guide* .
             */
            ...
            /**
             * @param name The name of the volume. It can be up to 255 characters long. It can
        ...
        internal constructor(
             ...
             *
             * If the host parameter is empty, then the Docker daemon assigns a host path for your
             * data volume. However, the data isn't guaranteed to persist after the containers that
    ...
    public interface SecurityContextProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SecurityContextProperty
            ): software.amazon.awscdk.services.batch.CfnJobDefinition.SecurityContextProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface RuntimePlatformProperty {
         ...
         * supported for `ARM64` and Windows-based containers on Fargate. A job queue will be
         * blocked if a Fargate `ARM64` or Windows job is submitted to a job queue with only Fargate
         * Spot compute environments. However, you can attach both `FARGATE` and `FARGATE_SPOT`
         ...
         * `efsVolumeConfiguration` . &gt; The AWS Batch Scheduler checks the compute environments
         * that are attached to the job queue before registering a task definition with Fargate. In
         * this scenario, the job queue is where the job is submitted. If the job requires a Windows
         * container and the first compute environment is `LINUX` , the compute environment is
         * skipped and the next compute environment is checked until a Windows-based compute
         * environment is found. &gt; Fargate Spot is not supported for `ARM64` and Windows-based
         * containers on Fargate. A job queue will be blocked if a Fargate `ARM64` or Windows job is
         * submitted to a job queue with only Fargate Spot compute environments. However, you can
        ...
        public interface Builder {
            /**
             * @param cpuArchitecture The vCPU architecture. The default value is `X86_64` . Valid
             *   values are `X86_64` and `ARM64` .
             *
             * This parameter must be set to `X86_64` for Windows containers. &gt; Fargate Spot is
             * not supported for `ARM64` and Windows-based containers on Fargate. A job queue will
             * be blocked if a Fargate `ARM64` or Windows job is submitted to a job queue with only
            ...
            /**
             * @param operatingSystemFamily The operating system for the compute environment. Valid
             *   values are: `LINUX` (default), `WINDOWS_SERVER_2019_CORE` ,
             *   `WINDOWS_SERVER_2019_FULL` , `WINDOWS_SERVER_2022_CORE` , and
             *   `WINDOWS_SERVER_2022_FULL` .
             *
             * The following parameters can’t be set for Windows containers: `linuxParameters` ,
             * `privileged` , `user` , `ulimits` , `readonlyRootFilesystem` , and
             * `efsVolumeConfiguration` . &gt; The AWS Batch Scheduler checks the compute
             * environments that are attached to the job queue before registering a task definition
             * with Fargate. In this scenario, the job queue is where the job is submitted. If the
             * job requires a Windows container and the first compute environment is `LINUX` , the
             * compute environment is skipped and the next compute environment is checked until a
             * Windows-based compute environment is found. &gt; Fargate Spot is not supported for
             * `ARM64` and Windows-based containers on Fargate. A job queue will be blocked if a
             * Fargate `ARM64` or Windows job is submitted to a job queue with only Fargate Spot
             * compute environments. However, you can attach both `FARGATE` and `FARGATE_SPOT`
             * compute environments to the same job queue.
             */
    ...
    public interface PodPropertiesProperty {
         ...
         *
         * The default value is `ClusterFirst` . If the `hostNetwork` parameter is not specified,
         * the default is `ClusterFirstWithHostNet` . `ClusterFirst` indicates that any DNS query
         * that does not match the configured cluster domain suffix is forwarded to the upstream
         * nameserver inherited from the node. For more information, see
         ...
         *
         * The default value is `true` . Setting this to `false` enables the Kubernetes pod
         * networking model. Most AWS Batch workloads are egress-only and don't require the overhead
         * of IP allocation for each pod for incoming connections. For more information, see
        ...
        public interface Builder {
            ...
            /**
             * @param dnsPolicy The DNS policy for the pod. The default value is `ClusterFirst` . If
             ...
             *   not match the configured cluster domain suffix is forwarded to the upstream
             *   nameserver inherited from the node. For more information, see
             *   [Pod's DNS policy](https://docs.aws.amazon.com/https://kubernetes.io/docs/concepts/services-networking/dns-pod-service/#pod-s-dns-policy)
             *   in the *Kubernetes documentation* .
             *
            ...
            /**
             * @param hostNetwork Indicates if the pod uses the hosts' network IP address. The
             *   default value is `true` . Setting this to `false` enables the Kubernetes pod
             *   networking model. Most AWS Batch workloads are egress-only and don't require the
            ...
            /**
             * @param volumes Specifies the volumes for a job definition that uses Amazon EKS
             *   resources.
             */
        ...
        internal constructor(
             ...
             * The DNS policy for the pod.
             *
             * The default value is `ClusterFirst` . If the `hostNetwork` parameter is not
             * specified, the default is `ClusterFirstWithHostNet` . `ClusterFirst` indicates that
             * any DNS query that does not match the configured cluster domain suffix is forwarded
             * to the upstream nameserver inherited from the node. For more information, see
             * [Pod's DNS policy](https://docs.aws.amazon.com/https://kubernetes.io/docs/concepts/services-networking/dns-pod-service/#pod-s-dns-policy)
             * in the *Kubernetes documentation* .
             *
             * Valid values: `Default` | `ClusterFirst` | `ClusterFirstWithHostNet`
    ...
    public interface MetadataProperty {
        ...
        public interface Builder {
             ...
             *   and underscores (_). Labels can be added or modified at any time. Each resource can
    ...
    public interface EksContainerEnvironmentVariableProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: EksContainerEnvironmentVariableProperty
            ): software.amazon.awscdk.services.batch.CfnJobDefinition.EksContainerEnvironmentVariableProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ContainerPropertiesProperty {
         ...
         * [docker run](https://docs.aws.amazon.com/https://docs.docker.com/engine/reference/run/) .
         *
         * We don't recommend using plaintext environment variables for sensitive information, such
         ...
         */
        public fun fargatePlatformConfiguration(): Any? =
         ...
         * specified with `*repository-url* / *image* : *tag*` . It can be 255 characters long. It
         * can contain uppercase and lowercase letters, numbers, hyphens (-), underscores (_),
         * colons (:), periods (.), forward slashes (/), and number signs (#). This parameter maps
         * to `Image` in the
         * [Create a container](https://docs.aws.amazon.com/https://docs.docker.com/engine/api/v1.23/#create-a-container)
         * section of the
         * [Docker Remote API](https://docs.aws.amazon.com/https://docs.docker.com/engine/api/v1.23/)
         ...
         * the container might use a different logging driver than the Docker daemon by specifying a
         ...
         * attempts to exceed the specified number, it's terminated. You must specify at least 4 MiB
         * of memory for a job using this parameter. The memory hard limit can be specified in
         ...
         * and the `--cpu-shares` option to
         * [docker run](https://docs.aws.amazon.com/https://docs.docker.com/engine/reference/run/) .
         * The number of vCPUs must be specified but can be specified in several places. You must
        ...
        public interface Builder {
             ...
             * such as credential data. &gt; Environment variables cannot start with " `AWS_BATCH`
            ...
            /**
             * @param executionRoleArn The Amazon Resource Name (ARN) of the execution role that AWS
             *   Batch can assume. For jobs that run on Fargate resources, you must provide an
            ...
            /**
             * @param fargatePlatformConfiguration The platform configuration for jobs that are
             *   running on Fargate resources. Jobs that are running on Amazon EC2 resources must
             ...
             *   not specify this parameter.
             */
            public fun fargatePlatformConfiguration(
            ...
            public fun fargatePlatformConfiguration(
                fargatePlatformConfiguration:
                    FargatePlatformConfigurationProperty.Builder.() -> Unit
            )

            /**
             * @param image Required. The image used to start a container. This string is passed
             *   directly to the Docker daemon. Images in the Docker Hub registry are available by
            ...
            /**
             * @param instanceType The instance type to use for a multi-node parallel job. All node
            ...
            /**
             * @param jobRoleArn The Amazon Resource Name (ARN) of the IAM role that the container
             *   can assume for AWS permissions. For more information, see
             *   [IAM roles for tasks](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/task-iam-roles.html)
             *   in the *Amazon Elastic Container Service Developer Guide* .
             */
             ...
             *   However the container might use a different logging driver than the Docker daemon
             ...
             *   for a job using this parameter. The memory hard limit can be specified in several
            ...
            /**
             * @param networkConfiguration The network configuration for jobs that are running on
             *   Fargate resources. Jobs that are running on Amazon EC2 resources must not specify
             *   this parameter.
             */
             ...
             *   permissions on the host container instance (similar to the `root` user). This
             ...
             *   container. The supported resources include `GPU` , `MEMORY` , and `VCPU` .
             */
            ...
            /**
             * @param runtimePlatform An object that represents the compute environment architecture
             *   for AWS Batch jobs on Fargate.
             */
            ...
            /**
             * @param secrets The secrets for the container. For more information, see
             *   [Specifying sensitive data](https://docs.aws.amazon.com/batch/latest/userguide/specifying-sensitive-data.html)
             *   in the *AWS Batch User Guide* .
             */
            ...
            /**
             * @param user The user name to use inside the container. This parameter maps to `User`
             *   in the
             *   [Create a container](https://docs.aws.amazon.com/https://docs.docker.com/engine/api/v1.23/#create-a-container)
             *   section of the
             *   [Docker Remote API](https://docs.aws.amazon.com/https://docs.docker.com/engine/api/v1.23/)
             ...
             *   vCPU requirements for the job definition. It's not supported for jobs running on
             *   Fargate resources. For jobs running on Amazon EC2 resources, it specifies the
             *   number of vCPUs reserved for the job.
             *
             * Each vCPU is equivalent to 1,024 CPU shares. This parameter maps to `CpuShares` in
             * the
             * [Create a container](https://docs.aws.amazon.com/https://docs.docker.com/engine/api/v1.23/#create-a-container)
             * section of the
             * [Docker Remote API](https://docs.aws.amazon.com/https://docs.docker.com/engine/api/v1.23/)
             * and the `--cpu-shares` option to
             * [docker run](https://docs.aws.amazon.com/https://docs.docker.com/engine/reference/run/)
             * . The number of vCPUs must be specified but can be specified in several places. You
        ...
        private class BuilderImpl : Builder {
            ...
            override fun fargatePlatformConfiguration(fargatePlatformConfiguration: IResolvable) {
                cdkBuilder.fargatePlatformConfiguration(
                    fargatePlatformConfiguration.let(IResolvable::unwrap)
                )
            }
             ...
             *   not specify this parameter.
             */
            override fun fargatePlatformConfiguration(
                fargatePlatformConfiguration: FargatePlatformConfigurationProperty
            ) {
                cdkBuilder.fargatePlatformConfiguration(
                    fargatePlatformConfiguration.let(FargatePlatformConfigurationProperty::unwrap)
                )
            }
        ...
        internal constructor(
             ...
             * (#). This parameter maps to `Image` in the
             * [Create a container](https://docs.aws.amazon.com/https://docs.docker.com/engine/api/v1.23/#create-a-container)
             * section of the
             * [Docker Remote API](https://docs.aws.amazon.com/https://docs.docker.com/engine/api/v1.23/)
             * and the `IMAGE` parameter of
             ...
             * requirements for the job definition.
             *
             * It's not supported for jobs running on Fargate resources. For jobs that run on Amazon
             * EC2 resources, it specifies the memory hard limit (in MiB) for a container. If your
             * container attempts to exceed the specified number, it's terminated. You must specify
             * at least 4 MiB of memory for a job using this parameter. The memory hard limit can be
             ...
             * requirements for the job definition.
             *
             * It's not supported for jobs running on Fargate resources. For jobs running on Amazon
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ContainerPropertiesProperty
            ): software.amazon.awscdk.services.batch.CfnJobDefinition.ContainerPropertiesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface RetryStrategyProperty {
         ...
         *
         * You can specify between 1 and 10 attempts. If the value of `attempts` is greater than
        ...
        public interface Builder {
            /**
             * @param attempts The number of times to move a job to the `RUNNABLE` status. You can
             *   specify between 1 and 10 attempts. If the value of `attempts` is greater than one,
             *   the job is retried on failure the same number of attempts as the value.
             */
            public fun attempts(attempts: Number)

            /**
             * @param evaluateOnExit Array of up to 5 objects that specify the conditions where jobs
             *   are retried or failed. If this parameter is specified, then the `attempts`
             *   parameter must also be specified. If none of the listed conditions match, then the
             *   job is retried.
             */
    ...
    public interface EksContainerVolumeMountProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param name The name the volume mount. This must match the name of one of the volumes
             *   in the pod.
             */
            public fun name(name: String)
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: EksContainerVolumeMountProperty
            ): software.amazon.awscdk.services.batch.CfnJobDefinition.EksContainerVolumeMountProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DeviceProperty {
        ...
        public interface Builder {
            /**
             * @param containerPath The path inside the container that's used to expose the host
