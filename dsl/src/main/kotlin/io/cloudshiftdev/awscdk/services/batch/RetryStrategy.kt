...
internal constructor(
    ...
    public companion object {
        public fun of(action: Action, on: Reason): RetryStrategy =
            software.amazon.awscdk.services.batch.RetryStrategy.of(
                    action.let(Action::unwrap),
                    on.let(Reason::unwrap)
                )
                .let(RetryStrategy::wrap)

        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.batch.RetryStrategy
        ): RetryStrategy = RetryStrategy(cdkObject)

        internal fun unwrap(
            wrapped: RetryStrategy
        ): software.amazon.awscdk.services.batch.RetryStrategy = wrapped.cdkObject
    }
}
