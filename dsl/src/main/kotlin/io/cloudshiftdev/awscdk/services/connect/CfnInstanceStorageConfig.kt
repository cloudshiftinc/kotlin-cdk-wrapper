...
internal constructor(
    ...
    public open fun kinesisFirehoseConfig(
        `value`: KinesisFirehoseConfigProperty.Builder.() -> Unit
    ...
    public open fun kinesisStreamConfig(
        `value`: KinesisStreamConfigProperty.Builder.() -> Unit
    ): Unit = kinesisStreamConfig(KinesisStreamConfigProperty(`value`))
    ...
    public open fun kinesisVideoStreamConfig(`value`: KinesisVideoStreamConfigProperty) {
        unwrap(this)
            .setKinesisVideoStreamConfig(`value`.let(KinesisVideoStreamConfigProperty::unwrap))
    }

    /** The configuration of the Kinesis video stream. */
    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("80b2083296e858d8b30c96551ab620fac29935872c4a0965d86e899f3f388705")
    public open fun kinesisVideoStreamConfig(
        `value`: KinesisVideoStreamConfigProperty.Builder.() -> Unit
    ...
    public interface Builder {
        ...
        public fun kinesisFirehoseConfig(
            kinesisFirehoseConfig: KinesisFirehoseConfigProperty.Builder.() -> Unit
        )
        ...
        public fun kinesisStreamConfig(
            kinesisStreamConfig: KinesisStreamConfigProperty.Builder.() -> Unit
        )
        ...
        public fun kinesisVideoStreamConfig(
            kinesisVideoStreamConfig: KinesisVideoStreamConfigProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.connect.CfnInstanceStorageConfig.Builder.create(
                scope,
                id
            )
        ...
        override fun kinesisFirehoseConfig(kinesisFirehoseConfig: KinesisFirehoseConfigProperty) {
            cdkBuilder.kinesisFirehoseConfig(
                kinesisFirehoseConfig.let(KinesisFirehoseConfigProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("837242d5661f3787c2b251575e565ac16b1cc8ddceaa3e928aba36258457650d")
        override fun kinesisFirehoseConfig(
            kinesisFirehoseConfig: KinesisFirehoseConfigProperty.Builder.() -> Unit
        ...
        override fun kinesisStreamConfig(kinesisStreamConfig: KinesisStreamConfigProperty) {
            cdkBuilder.kinesisStreamConfig(
                kinesisStreamConfig.let(KinesisStreamConfigProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("5e0974cfd229ccc4f27fe13b7d0d51afc36bdd3fe5e372817ba019ba82b8bcd0")
        override fun kinesisStreamConfig(
            kinesisStreamConfig: KinesisStreamConfigProperty.Builder.() -> Unit
         ...
         * @param kinesisVideoStreamConfig The configuration of the Kinesis video stream.
         */
        override fun kinesisVideoStreamConfig(
            kinesisVideoStreamConfig: KinesisVideoStreamConfigProperty
        ) {
            cdkBuilder.kinesisVideoStreamConfig(
                kinesisVideoStreamConfig.let(KinesisVideoStreamConfigProperty::unwrap)
            )
        }
        ...
        override fun kinesisVideoStreamConfig(
            ...
            kinesisVideoStreamConfig(KinesisVideoStreamConfigProperty(kinesisVideoStreamConfig))
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnInstanceStorageConfig
    ...
    public interface KinesisStreamConfigProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: KinesisStreamConfigProperty
            ): software.amazon.awscdk.services.connect.CfnInstanceStorageConfig.KinesisStreamConfigProperty =
    ...
    public interface KinesisFirehoseConfigProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: KinesisFirehoseConfigProperty
            ): software.amazon.awscdk.services.connect.CfnInstanceStorageConfig.KinesisFirehoseConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface S3ConfigProperty {
        ...
        public interface Builder {
            ...
            public fun encryptionConfig(
                encryptionConfig: EncryptionConfigProperty.Builder.() -> Unit
            )
        }
    ...
    public interface KinesisVideoStreamConfigProperty {
         ...
         *
         * Kinesis Video Streams retains the data in a data store that is associated with the
         * stream.
         *
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: KinesisVideoStreamConfigProperty
            ): software.amazon.awscdk.services.connect.CfnInstanceStorageConfig.KinesisVideoStreamConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
