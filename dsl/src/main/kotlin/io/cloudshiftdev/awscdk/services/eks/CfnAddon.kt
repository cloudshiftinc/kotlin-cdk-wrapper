...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.eks.CfnAddon,
    ...
    public interface Builder {
         ...
         *
         * @param preserveOnDelete Specifying this option preserves the add-on software on your
         ...
         * * *None* – If the self-managed version of the add-on is installed on your cluster, Amazon
         *   EKS doesn't change the value. Creation of the add-on might fail.
         ...
         *   works differently during the update operation. For more information, see
         ...
         * account.
         *
         * The role must be assigned the IAM permissions required by the add-on. If you don't
         * specify an existing IAM role, then the add-on uses the permissions assigned to the node
         ...
         * created for your cluster. For more information, see
         ...
         *
         * @param serviceAccountRoleArn The Amazon Resource Name (ARN) of an existing IAM role to
         *   bind to the add-on's service account.
         */
         ...
         * The metadata that you apply to the add-on to assist with categorization and organization.
         *
         * Each tag consists of a key and an optional value, both of which you define. Add-on tags
         * do not propagate to any other resources associated with the cluster.
         *
