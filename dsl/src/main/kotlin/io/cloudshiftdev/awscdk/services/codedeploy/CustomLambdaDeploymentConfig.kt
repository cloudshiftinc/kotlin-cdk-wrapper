...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * Must be unique per account/region. Other parameters cannot be updated if this name is
         * provided.
         *
         ...
         *
         * @param interval The interval, in number of minutes: - For LINEAR, how frequently
         *   additional traffic is shifted - For CANARY, how long to shift traffic before the full
         *   deployment.
         * @deprecated Use `LambdaDeploymentConfig`
         */
        @Deprecated(message = "deprecated in CDK") public fun interval(interval: Duration)
         ...
         *
         * @param percentage The integer percentage of traffic to shift: - For LINEAR, the
         *   percentage to shift every interval - For CANARY, the percentage to shift until the
         *   interval passes, before the full deployment.
         * @deprecated Use `LambdaDeploymentConfig`
         */
        @Deprecated(message = "deprecated in CDK") public fun percentage(percentage: Number)
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.codedeploy.CustomLambdaDeploymentConfig.Builder.create(
                scope,
                id
            )
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CustomLambdaDeploymentConfig
        ): software.amazon.awscdk.services.codedeploy.CustomLambdaDeploymentConfig =
            wrapped.cdkObject
    }
}
