...
internal constructor(
     ...
     *
     * After the first certificate, this creates NetworkListenerCertificates resources since
    ...
    public open fun addTargets(id: String, props: AddNetworkTargetsProps): NetworkTargetGroup =
        unwrap(this)
            .addTargets(id, props.let(AddNetworkTargetsProps::unwrap))
            .let(NetworkTargetGroup::wrap)
    ...
    public interface Builder {
         ...
         *   is sent on the initial TLS handshake hello messages.
         */
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.elasticloadbalancingv2.NetworkListener.Builder.create(
                scope,
                id
            )
    ...
    public companion object {
        public fun fromLookup(
            ...
            software.amazon.awscdk.services.elasticloadbalancingv2.NetworkListener.fromLookup(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    options.let(NetworkListenerLookupOptions::unwrap)
                )
                .let(INetworkListener::wrap)
