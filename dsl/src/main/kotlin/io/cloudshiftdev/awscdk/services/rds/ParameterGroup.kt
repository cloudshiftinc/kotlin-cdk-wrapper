...
internal constructor(
     ...
     * @param _options
     */
    public override fun bindToCluster(
        _options: ParameterGroupClusterBindOptions
    ): ParameterGroupClusterConfig =
        unwrap(this)
            .bindToCluster(_options.let(ParameterGroupClusterBindOptions::unwrap))
            .let(ParameterGroupClusterConfig::wrap)
    ...
    public override fun bindToCluster(
        _options: ParameterGroupClusterBindOptions.Builder.() -> Unit
     ...
     * @param _options
     */
    public override fun bindToInstance(
        _options: ParameterGroupInstanceBindOptions
    ): ParameterGroupInstanceConfig =
        unwrap(this)
            .bindToInstance(_options.let(ParameterGroupInstanceBindOptions::unwrap))
            .let(ParameterGroupInstanceConfig::wrap)
    ...
    public override fun bindToInstance(
        _options: ParameterGroupInstanceBindOptions.Builder.() -> Unit
    ...
    public companion object {
        public fun fromParameterGroupName(
            ...
            software.amazon.awscdk.services.rds.ParameterGroup.fromParameterGroupName(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    parameterGroupName
                )
                .let(IParameterGroup::wrap)
        ...
        ): ParameterGroup = ParameterGroup(cdkObject)

        internal fun unwrap(
            wrapped: ParameterGroup
        ): software.amazon.awscdk.services.rds.ParameterGroup = wrapped.cdkObject
    }
}
