...
internal constructor(
    ...
    public open fun renderingConfiguration(
        `value`: RenderingConfigurationProperty.Builder.() -> Unit
    ): Unit = renderingConfiguration(RenderingConfigurationProperty(`value`))
    ...
    public interface Builder {
         ...
         * The type of knowledge base.
         *
         * Only CUSTOM knowledge bases allow you to upload your own content. EXTERNAL knowledge
         * bases support integrations with third-party systems whose content is synchronized
         * automatically.
         *
        ...
        public fun renderingConfiguration(
            renderingConfiguration: RenderingConfigurationProperty.Builder.() -> Unit
        )
         ...
         *
         * @param serverSideEncryptionConfiguration This customer managed key must have a policy
         *   that allows `kms:CreateGrant` and `kms:DescribeKey` permissions to the IAM identity
    ...
    private class BuilderImpl(
         ...
         * @param renderingConfiguration Information about how to render the content.
         */
        override fun renderingConfiguration(
            renderingConfiguration: RenderingConfigurationProperty
        ) {
            cdkBuilder.renderingConfiguration(
                renderingConfiguration.let(RenderingConfigurationProperty::unwrap)
            )
        }
        ...
        public fun build(): software.amazon.awscdk.services.wisdom.CfnKnowledgeBase =
            cdkBuilder.build()
    }
    ...
    public interface ServerSideEncryptionConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param kmsKeyId The customer managed key used for encryption. This customer managed
             *   key must have a policy that allows `kms:CreateGrant` and `kms:DescribeKey`
    ...
    public interface SourceConfigurationProperty {
        ...
        public interface Builder {
            ...
            public fun appIntegrations(
                appIntegrations: AppIntegrationsConfigurationProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun appIntegrations(appIntegrations: AppIntegrationsConfigurationProperty) {
                cdkBuilder.appIntegrations(
                    appIntegrations.let(AppIntegrationsConfigurationProperty::unwrap)
                )
            }
    ...
    public interface RenderingConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param templateUri A URI template containing exactly one variable in
             *   `${variableName}` format. This can only be set for `EXTERNAL` knowledge bases. For
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RenderingConfigurationProperty
            ): software.amazon.awscdk.services.wisdom.CfnKnowledgeBase.RenderingConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface AppIntegrationsConfigurationProperty {
         ...
         *   is not provided, including at least `Id` , `ArticleNumber` , `VersionNumber` , `Title`
         ...
         *   , your AppIntegrations DataIntegration must have an ObjectConfiguration if objectFields
         *   is not provided, including at least `number` , `short_description` , `sys_mod_count` ,
         ...
         *   file extensions that are among `docx` , `pdf` , `html` , `htm` , and `txt` .
         * * For [Amazon S3](https://docs.aws.amazon.com/https://aws.amazon.com/s3/) , the
         *   ObjectConfiguration and FileConfiguration of your AppIntegrations DataIntegration must
         *   be null. The `SourceURI` of your DataIntegration must use the following format:
        ...
        public interface Builder {
             ...
             * * For [Zendesk](https://docs.aws.amazon.com/https://developer.zendesk.com/api-reference/help_center/help-center-api/articles/)
             *   , your AppIntegrations DataIntegration must have an ObjectConfiguration if
             *   `objectFields` is not provided, including at least `id` , `title` , `updated_at` ,
             ...
             * * For [Amazon S3](https://docs.aws.amazon.com/https://aws.amazon.com/s3/) , the
             *   ObjectConfiguration and FileConfiguration of your AppIntegrations DataIntegration
            ...
            /**
             * @param objectFields The fields from the source that are made available to your agents
             *   in Amazon Q. Optional if ObjectConfiguration is included in the provided
             *   DataIntegration.
             * * For [Salesforce](https://docs.aws.amazon.com/https://developer.salesforce.com/docs/atlas.en-us.knowledge_dev.meta/knowledge_dev/sforce_api_objects_knowledge__kav.htm)
             *   , you must include at least `Id` , `ArticleNumber` , `VersionNumber` , `Title` ,
             *   `PublishStatus` , and `IsDeleted` .
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-wisdom-knowledgebase-appintegrationsconfiguration.html#cfn-wisdom-knowledgebase-appintegrationsconfiguration-objectfields)
             */
            override fun objectFields(): List<String> =
                unwrap(this).getObjectFields() ?: emptyList()
        }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AppIntegrationsConfigurationProperty
            ): software.amazon.awscdk.services.wisdom.CfnKnowledgeBase.AppIntegrationsConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
