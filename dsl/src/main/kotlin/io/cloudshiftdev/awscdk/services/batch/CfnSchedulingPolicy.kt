...
internal constructor(
    ...
    public interface Builder {
         ...
         * The name of the scheduling policy.
         *
         * It can be up to 128 letters long. It can contain uppercase and lowercase letters,
    ...
    private class BuilderImpl(
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("62f06a0b5b52fb1318708cc740c9dcf623307c96501bdeface2fff8746888e96")
        override fun fairsharePolicy(
            fairsharePolicy: FairsharePolicyProperty.Builder.() -> Unit
        ): Unit = fairsharePolicy(FairsharePolicyProperty(fairsharePolicy))
    ...
    public interface ShareAttributesProperty {
         ...
         *
         * If the string ends with an asterisk (*), this entry specifies the weight factor to use
         * for fair share identifiers that start with that prefix. The list of fair share
         * identifiers in a fair share policy can't overlap. For example, you can't have one that
         ...
         * example, jobs that use a share identifier with a weight factor of 0.125 (1/8) get 8 times
        ...
        public interface Builder {
            /**
             * @param shareIdentifier A fair share identifier or fair share identifier prefix. If
             *   the string ends with an asterisk (*), this entry specifies the weight factor to use
             *   for fair share identifiers that start with that prefix. The list of fair share
             *   identifiers in a fair share policy can't overlap. For example, you can't have one
             *   that specifies a `shareIdentifier` of `UserA*` and another that specifies a
            ...
            /**
             * @param weightFactor The weight factor for the fair share identifier. The default
             *   value is 1.0. A lower value has a higher priority for compute resources. For
             *   example, jobs that use a share identifier with a weight factor of 0.125 (1/8) get 8
             *   times the compute resources of jobs that use a share identifier with a weight
             *   factor of 1.
             *
             * The smallest supported value is 0.0001, and the largest supported value is 999.9999.
             */
        ...
        internal constructor(
             ...
             * A fair share identifier or fair share identifier prefix.
             *
             * If the string ends with an asterisk (*), this entry specifies the weight factor to
             * use for fair share identifiers that start with that prefix. The list of fair share
             * identifiers in a fair share policy can't overlap. For example, you can't have one
             * that specifies a `shareIdentifier` of `UserA*` and another that specifies a
             * `shareIdentifier` of `UserA-1` .
             *
             ...
             * The weight factor for the fair share identifier.
             *
             * The default value is 1.0. A lower value has a higher priority for compute resources.
             * For example, jobs that use a share identifier with a weight factor of 0.125 (1/8) get
             * 8 times the compute resources of jobs that use a share identifier with a weight
             * factor of 1.
             *
             * The smallest supported value is 0.0001, and the largest supported value is 999.9999.
             *
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ShareAttributesProperty
            ): software.amazon.awscdk.services.batch.CfnSchedulingPolicy.ShareAttributesProperty =
    ...
    public interface FairsharePolicyProperty {
         ...
         * the maximum available vCPU if there's only one fair share identifier. It reserves 25% if
         ...
         * 25% of the maximum available vCPU if there's only one fair share identifier, 6.25% if
         ...
         * more recently run jobs to have more weight than jobs that ran earlier. The maximum
        ...
        public interface Builder {
            /**
             * @param computeReservation A value used to reserve some of the available maximum vCPU
             *   for fair share identifiers that aren't already used. The reserved ratio is `(
             ...
             * of the maximum available vCPU if there's only one fair share identifier. It reserves
             * 25% if there are two fair share identifiers. It reserves 12.5% if there are three
             * fair share identifiers. A `computeReservation` value of 25 indicates that AWS Batch
             * should reserve 25% of the maximum available vCPU if there's only one fair share
            ...
            /**
             * @param shareDecaySeconds The amount of time (in seconds) to use to calculate a fair
             *   share percentage for each fair share identifier in use. A value of zero (0)
             *   indicates that only current usage is measured. The decay allows for more recently
             *   run jobs to have more weight than jobs that ran earlier. The maximum supported
             *   value is 604800 (1 week).
             */
            public fun shareDecaySeconds(shareDecaySeconds: Number)

            /**
             * @param shareDistribution An array of `SharedIdentifier` objects that contain the
             *   weights for the fair share identifiers for the fair share policy. Fair share
        ...
        internal constructor(
             ...
             * fair share identifier in use.
             *
             * A value of zero (0) indicates that only current usage is measured. The decay allows
             * for more recently run jobs to have more weight than jobs that ran earlier. The
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: FairsharePolicyProperty
            ): software.amazon.awscdk.services.batch.CfnSchedulingPolicy.FairsharePolicyProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
