...
internal constructor(
    ...
    public companion object {
        ...
        public fun ofType(type: String, fields: String): IamResource =
            software.amazon.awscdk.services.appsync.IamResource.ofType(type, fields)
                .let(IamResource::wrap)

        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.appsync.IamResource
        ): IamResource = IamResource(cdkObject)

        internal fun unwrap(
            wrapped: IamResource
        ): software.amazon.awscdk.services.appsync.IamResource = wrapped.cdkObject
    }
}
