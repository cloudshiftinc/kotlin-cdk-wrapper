...
internal constructor(
    ...
    public open fun elasticsearchSettings(
        `value`: ElasticsearchSettingsProperty.Builder.() -> Unit
    ...
    public open fun extraConnectionAttributes(): String? =
        unwrap(this).getExtraConnectionAttributes()
    ...
    public open fun microsoftSqlServerSettings(): Any? =
        unwrap(this).getMicrosoftSqlServerSettings()
    ...
    public open fun microsoftSqlServerSettings(`value`: MicrosoftSqlServerSettingsProperty) {
        unwrap(this)
            .setMicrosoftSqlServerSettings(`value`.let(MicrosoftSqlServerSettingsProperty::unwrap))
    }

    /** Settings in JSON format for the source and target Microsoft SQL Server endpoint. */
    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("01437218f3a5caa6cc9cbe0ab603838b7bf74521b6a8609feb8df795add9ad25")
    public open fun microsoftSqlServerSettings(
        `value`: MicrosoftSqlServerSettingsProperty.Builder.() -> Unit
    ...
    public open fun postgreSqlSettings(
        `value`: PostgreSqlSettingsProperty.Builder.() -> Unit
    ): Unit = postgreSqlSettings(PostgreSqlSettingsProperty(`value`))
    ...
    public interface Builder {
         ...
         *
         * @param docDbSettings Settings in JSON format for the source and target DocumentDB
         *   endpoint.
         */
        ...
        public fun elasticsearchSettings(
            elasticsearchSettings: ElasticsearchSettingsProperty.Builder.() -> Unit
        )
         ...
         * Multiple attributes are separated by a semicolon (;) with no additional white space. For
         ...
         * Settings in JSON format for the source GCP MySQL endpoint.
         *
         * These settings are much the same as the settings for any MySQL-compatible endpoint. For
         ...
         *
         * @param microsoftSqlServerSettings Settings in JSON format for the source and target
        ...
        public fun microsoftSqlServerSettings(
            microsoftSqlServerSettings: MicrosoftSqlServerSettingsProperty.Builder.() -> Unit
        )
        ...
        public fun postgreSqlSettings(
            postgreSqlSettings: PostgreSqlSettingsProperty.Builder.() -> Unit
        )
         ...
         *
         * The value for this parameter can have up to 31 characters. It can contain only ASCII
    ...
    private class BuilderImpl(
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("5cdc3c3c4090352539fd080a3d02f6645a0a6109d09f40cc53594a993068d096")
        override fun dynamoDbSettings(
            dynamoDbSettings: DynamoDbSettingsProperty.Builder.() -> Unit
        ...
        override fun elasticsearchSettings(elasticsearchSettings: ElasticsearchSettingsProperty) {
            cdkBuilder.elasticsearchSettings(
                elasticsearchSettings.let(ElasticsearchSettingsProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("889d325b4eeeb0880dc74130a7f1cc5cebd2323685790c333d6149a4f2bfcb8f")
        override fun elasticsearchSettings(
            elasticsearchSettings: ElasticsearchSettingsProperty.Builder.() -> Unit
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("925d4ba9af14d43c38e62d809c4a9bfbfc5cb3d9712b4896f8527703dd9b701e")
        override fun gcpMySqlSettings(
            gcpMySqlSettings: GcpMySQLSettingsProperty.Builder.() -> Unit
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("a55b78aff146203eb19a530ed10a3898c4b42f0d0fc717956cb7c7f6b0c6fac8")
        override fun ibmDb2Settings(
            ibmDb2Settings: IbmDb2SettingsProperty.Builder.() -> Unit
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("96defed71e91fdb933b12d6dd79a8a2249d0156ed38c4ecfcd729da4e63e7bd2")
        override fun kinesisSettings(
            kinesisSettings: KinesisSettingsProperty.Builder.() -> Unit
        ): Unit = kinesisSettings(KinesisSettingsProperty(kinesisSettings))
        ...
        override fun microsoftSqlServerSettings(microsoftSqlServerSettings: IResolvable) {
            cdkBuilder.microsoftSqlServerSettings(
                microsoftSqlServerSettings.let(IResolvable::unwrap)
            )
        }
         ...
         *   Microsoft SQL Server endpoint.
         */
        override fun microsoftSqlServerSettings(
            microsoftSqlServerSettings: MicrosoftSqlServerSettingsProperty
        ) {
            cdkBuilder.microsoftSqlServerSettings(
                microsoftSqlServerSettings.let(MicrosoftSqlServerSettingsProperty::unwrap)
            )
        }
        ...
        override fun microsoftSqlServerSettings(
            ...
            microsoftSqlServerSettings(
                MicrosoftSqlServerSettingsProperty(microsoftSqlServerSettings)
            )
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("050ff78e40a1395c73c5b4f2c039e024a8067554393984a41d14a33f0eac6cf4")
        override fun mongoDbSettings(
            mongoDbSettings: MongoDbSettingsProperty.Builder.() -> Unit
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("f44b6d9df7919882c0942ce2d41354a6064d5c40384ff1834ce0fa81ae5d2bb7")
        override fun neptuneSettings(
            neptuneSettings: NeptuneSettingsProperty.Builder.() -> Unit
        ): Unit = neptuneSettings(NeptuneSettingsProperty(neptuneSettings))
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("cf0444a7326a153335d36ebdb3dd8d1f3540e068cbdbf7f679c3a4032dccea88")
        override fun oracleSettings(
            oracleSettings: OracleSettingsProperty.Builder.() -> Unit
        ...
        override fun postgreSqlSettings(postgreSqlSettings: PostgreSqlSettingsProperty) {
            cdkBuilder.postgreSqlSettings(
                postgreSqlSettings.let(PostgreSqlSettingsProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("90679fdd6b6c393ffe4be191fbab0408dfed36b58b34c62d52ff4d5baccc34ce")
        override fun postgreSqlSettings(
            postgreSqlSettings: PostgreSqlSettingsProperty.Builder.() -> Unit
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("11b670292b1e44ce7dda450ac19ef54cc289ada19014482359d029ad114fcb7e")
        override fun redshiftSettings(
            redshiftSettings: RedshiftSettingsProperty.Builder.() -> Unit
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("40dcc88d57b0b2dd6f75aa352d9dae019e3e8de6e8a1892482e39a7ef92fe742")
        override fun sybaseSettings(
            sybaseSettings: SybaseSettingsProperty.Builder.() -> Unit
    ...
    public interface MySqlSettingsProperty {
         ...
         * the AWS Secrets Manager secret that allows access to the MySQL endpoint.
         *
         ...
         * values for `UserName` , `Password` , `ServerName` , and `Port` . You can't specify both.
         *
         * For more information on creating this `SecretsManagerSecret` , the corresponding
         * `SecretsManagerAccessRoleArn` , and the `SecretsManagerSecretId` that is required to
         * access it, see
        ...
        public interface Builder {
            /**
             * @param afterConnectScript Specifies a script to run immediately after AWS DMS
             *   connects to the endpoint. The migration task continues running regardless if the
             *   SQL statement succeeds or fails.
             *
             * For this parameter, provide the code of the script itself, not the name of a file
             * containing the script.
             */
            ...
            /**
             * @param cleanSourceMetadataOnMismatch Cleans and recreates table metadata information
             *   on the replication instance when a mismatch occurs. For example, in a situation
             *   where running an alter DDL on the table could result in different information about
            ...
            /**
             * @param maxFileSize Specifies the maximum size (in KB) of any .csv file used to
             *   transfer data to a MySQL-compatible database. Example: `maxFileSize=512`
             */
            public fun maxFileSize(maxFileSize: Number)

            /**
             * @param parallelLoadThreads Improves performance when loading data into the
             *   MySQL-compatible target database. Specifies how many threads to use to load the
             *   data into the MySQL-compatible target database. Setting a large number of threads
             *   can have an adverse effect on database performance, because a separate connection
             *   is required for each thread. The default is one.
             *
             * Example: `parallelLoadThreads=1`
             */
            ...
            /**
             * @param secretsManagerAccessRoleArn The full Amazon Resource Name (ARN) of the IAM
             *   role that specifies AWS DMS as the trusted entity and grants the required
             *   permissions to access the value in `SecretsManagerSecret` . The role must allow the
             *   `iam:PassRole` action. `SecretsManagerSecret` has the value of the AWS Secrets
             *   Manager secret that allows access to the MySQL endpoint.
             *
             * You can specify one of two sets of values for these permissions. You can specify the
             * values for this setting and `SecretsManagerSecretId` . Or you can specify clear-text
             * values for `UserName` , `Password` , `ServerName` , and `Port` . You can't specify
             * both.
             *
             * For more information on creating this `SecretsManagerSecret` , the corresponding
             * `SecretsManagerAccessRoleArn` , and the `SecretsManagerSecretId` that is required to
            ...
            /**
             * @param serverTimezone Specifies the time zone for the source MySQL database. Example:
            ...
            /**
             * @param targetDbType Specifies where to migrate source tables on the target, either to
             *   a single database or multiple databases. If you specify `SPECIFIC_DATABASE` ,
             *   specify the database name using the `DatabaseName` parameter of the `Endpoint`
             *   object.
             *
             * Example: `targetDbType=MULTIPLE_DATABASES`
             */
        ...
        private class BuilderImpl : Builder {
            ...
            override fun cleanSourceMetadataOnMismatch(cleanSourceMetadataOnMismatch: IResolvable) {
                cdkBuilder.cleanSourceMetadataOnMismatch(
                    cleanSourceMetadataOnMismatch.let(IResolvable::unwrap)
                )
            }
        ...
        internal constructor(
             ...
             *
             * The role must allow the `iam:PassRole` action. `SecretsManagerSecret` has the value
             * of the AWS Secrets Manager secret that allows access to the MySQL endpoint.
             *
             * You can specify one of two sets of values for these permissions. You can specify the
             * values for this setting and `SecretsManagerSecretId` . Or you can specify clear-text
             * values for `UserName` , `Password` , `ServerName` , and `Port` . You can't specify
            ...
            /**
             * The full ARN, partial ARN, or display name of the `SecretsManagerSecret` that
             * contains the MySQL endpoint connection details.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-dms-endpoint-mysqlsettings.html#cfn-dms-endpoint-mysqlsettings-secretsmanagersecretid)
             */
            override fun secretsManagerSecretId(): String? =
             ...
             *
             * If you specify `SPECIFIC_DATABASE` , specify the database name using the
    ...
    public interface DynamoDbSettingsProperty {
        ...
        public interface Builder {
            /**
             * @param serviceAccessRoleArn The Amazon Resource Name (ARN) used by the service to
             *   access the IAM role. The role must allow the `iam:PassRole` action.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DynamoDbSettingsProperty
            ): software.amazon.awscdk.services.dms.CfnEndpoint.DynamoDbSettingsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface KafkaSettingsProperty {
         ...
         * example, `"ec2-12-345-678-901.compute-1.amazonaws.com:2345"` . For more information and
         * examples of specifying a list of broker locations, see
         ...
         */
        public fun includeTableAlterOperations(): Any? =
         ...
         * format moving from an Oracle source to a Kafka target. Use the `NoHexPrefix` endpoint
         ...
         * `primary-key-type` .
         *
         * Doing this increases data distribution among Kafka partitions. For example, suppose that
         * a SysBench schema has thousands of tables and each table has only limited range for a
         * primary key. In this case, the same primary key is sent from thousands of tables to the
         * same partition, which causes throttling. The default is `false` .
         *
         ...
         */
        public fun partitionIncludeSchemaTable(): Any? =
         ...
         * validate a client identity and make an encrypted connection between server and client
        ...
        /**
         * The secure user name you created when you first set up your Amazon MSK cluster to
         * validate a client identity and make an encrypted connection between server and client
         * using SASL-SSL authentication.
         *
        ...
        /**
         * The Amazon Resource Name (ARN) for the private certificate authority (CA) cert that AWS
        ...
        public interface Builder {
            /**
             * @param broker A comma-separated list of one or more broker locations in your Kafka
             *   cluster that host your Kafka instance. Specify each broker location in the form
             ...
             *   column definition, and table and column changes in the Kafka message output. The
             *   default is `false` .
             */
            ...
            /**
             * @param includePartitionValue Shows the partition value within the Kafka message
             *   output unless the partition type is `schema-table-type` . The default is `false` .
             */
            ...
            /**
             * @param includeTableAlterOperations Includes any data definition language (DDL)
             *   operations that change the table in the control data, such as `rename-table` ,
             *   `drop-table` , `add-column` , `drop-column` , and `rename-column` . The default is
             *   `false` .
             */
            ...
            /**
             * @param includeTransactionDetails Provides detailed transaction information from the
             *   source database. This information includes a commit timestamp, a log position, and
             *   values for `transaction_id` , previous `transaction_id` , and
             *   `transaction_record_id` (the record offset within a transaction). The default is
             *   `false` .
             */
            ...
            /**
             * @param messageFormat The output format for the records created on the endpoint. The
             *   message format is `JSON` (default) or `JSON_UNFORMATTED` (a single line with no
             *   tab).
             */
            public fun messageFormat(messageFormat: String)

            /**
             * @param messageMaxBytes The maximum size in bytes for records created on the endpoint
             *   The default is 1,000,000.
             */
            public fun messageMaxBytes(messageMaxBytes: Number)

            /**
             * @param noHexPrefix Set this optional parameter to `true` to avoid adding a '0x'
             *   prefix to raw data in hexadecimal format. For example, by default, AWS DMS adds a
             *   '0x' prefix to the LOB column type in hexadecimal format moving from an Oracle
             *   source to a Kafka target. Use the `NoHexPrefix` endpoint setting to enable
            ...
            /**
             * @param partitionIncludeSchemaTable Prefixes schema and table names to partition
             *   values, when the partition type is `primary-key-type` . Doing this increases data
             *   distribution among Kafka partitions. For example, suppose that a SysBench schema
             *   has thousands of tables and each table has only limited range for a primary key. In
            ...
            /**
             * @param saslPassword The secure password that you created when you first set up your
             *   Amazon MSK cluster to validate a client identity and make an encrypted connection
             *   between server and client using SASL-SSL authentication.
             */
            public fun saslPassword(saslPassword: String)

            /**
             * @param saslUserName The secure user name you created when you first set up your
             *   Amazon MSK cluster to validate a client identity and make an encrypted connection
             *   between server and client using SASL-SSL authentication.
             */
            ...
            /**
             * @param securityProtocol Set secure connection to a Kafka target endpoint using
             *   Transport Layer Security (TLS). Options include `ssl-encryption` ,
             *   `ssl-authentication` , and `sasl-ssl` . `sasl-ssl` requires `SaslUsername` and
             *   `SaslPassword` .
             */
             ...
             *   authority (CA) cert that AWS DMS uses to securely connect to your Kafka target
             *   endpoint.
             */
            public fun sslCaCertificateArn(sslCaCertificateArn: String)

            /**
             * @param sslClientCertificateArn The Amazon Resource Name (ARN) of the client
             *   certificate used to securely connect to a Kafka target endpoint.
             */
            public fun sslClientCertificateArn(sslClientCertificateArn: String)

            /**
             * @param sslClientKeyArn The Amazon Resource Name (ARN) for the client private key used
            ...
            /**
             * @param topic The topic to which you migrate the data. If you don't specify a topic,
        ...
        private class BuilderImpl : Builder {
            ...
            override fun includeTableAlterOperations(includeTableAlterOperations: IResolvable) {
                cdkBuilder.includeTableAlterOperations(
                    includeTableAlterOperations.let(IResolvable::unwrap)
                )
            }
            ...
            override fun includeTransactionDetails(includeTransactionDetails: IResolvable) {
                cdkBuilder.includeTransactionDetails(
                    includeTransactionDetails.let(IResolvable::unwrap)
                )
            }
            ...
            override fun partitionIncludeSchemaTable(partitionIncludeSchemaTable: IResolvable) {
                cdkBuilder.partitionIncludeSchemaTable(
                    partitionIncludeSchemaTable.let(IResolvable::unwrap)
                )
            }
        ...
        internal constructor(
             ...
             * host your Kafka instance.
             *
             * Specify each broker location in the form `*broker-hostname-or-ip* : *port*` . For
             * example, `"ec2-12-345-678-901.compute-1.amazonaws.com:2345"` . For more information
             * and examples of specifying a list of broker locations, see
             * [Using Apache Kafka as a target for AWS Database Migration Service](https://docs.aws.amazon.com/dms/latest/userguide/CHAP_Target.Kafka.html)
             * in the *AWS Database Migration Service User Guide* .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-dms-endpoint-kafkasettings.html#cfn-dms-endpoint-kafkasettings-broker)
             ...
             * and column changes in the Kafka message output.
             *
             * The default is `false` .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-dms-endpoint-kafkasettings.html#cfn-dms-endpoint-kafkasettings-includecontroldetails)
            ...
            /**
             * Includes any data definition language (DDL) operations that change the table in the
             * control data, such as `rename-table` , `drop-table` , `add-column` , `drop-column` ,
             * and `rename-column` .
             *
             * The default is `false` .
             *
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-dms-endpoint-kafkasettings.html#cfn-dms-endpoint-kafkasettings-includetransactiondetails)
             */
            override fun includeTransactionDetails(): Any? =
                unwrap(this).getIncludeTransactionDetails()

            /**
             * The output format for the records created on the endpoint.
             *
             * The message format is `JSON` (default) or `JSON_UNFORMATTED` (a single line with no
             * tab).
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-dms-endpoint-kafkasettings.html#cfn-dms-endpoint-kafkasettings-messageformat)
             */
             ...
             * hexadecimal format.
             *
             * For example, by default, AWS DMS adds a '0x' prefix to the LOB column type in
             * hexadecimal format moving from an Oracle source to a Kafka target. Use the
             ...
             * for a primary key. In this case, the same primary key is sent from thousands of
             * tables to the same partition, which causes throttling. The default is `false` .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-dms-endpoint-kafkasettings.html#cfn-dms-endpoint-kafkasettings-partitionincludeschematable)
             */
             ...
             * AWS DMS uses to securely connect to your Kafka target endpoint.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-dms-endpoint-kafkasettings.html#cfn-dms-endpoint-kafkasettings-sslcacertificatearn)
             */
            ...
            /**
             * The Amazon Resource Name (ARN) of the client certificate used to securely connect to
             * a Kafka target endpoint.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-dms-endpoint-kafkasettings.html#cfn-dms-endpoint-kafkasettings-sslclientcertificatearn)
             */
            override fun sslClientCertificateArn(): String? =
                unwrap(this).getSslClientCertificateArn()

            /**
             * The Amazon Resource Name (ARN) for the client private key used to securely connect to
             * a Kafka target endpoint.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-dms-endpoint-kafkasettings.html#cfn-dms-endpoint-kafkasettings-sslclientkeyarn)
             */
             ...
             * The topic to which you migrate the data.
             *
             * If you don't specify a topic, AWS DMS specifies `"kafka-default-topic"` as the
             * migration topic.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-dms-endpoint-kafkasettings.html#cfn-dms-endpoint-kafkasettings-topic)
             */
    ...
    public interface OracleSettingsProperty {
         ...
         * for an Amazon RDS for Oracle as the source.
         *
         ...
         * which destination to get archive redo logs from to read changes. This need arises because
         ...
         * never use `RESETLOGS` unless necessary. For additional information about `RESETLOGS` ,
         * see
         ...
         *
         * This value should be the same as a number in the dest_id column of the v$archived_log
         * view. If you work with an additional redo log destination, use the
         * `AdditionalArchivedLogDestId` option to specify the additional destination ID. Doing this
         ...
         *
         * You can set this value from the `*asm_user_password*` value. You set this value as part
         * of the comma-separated value that you set to the `Password` request parameter when you
         * create the endpoint to access transaction logs using Binary Reader. For more information,
         * see
         ...
         * extra connection attribute string to access an Oracle server with Binary Reader that uses
         * ASM. For more information, see
         * [Configuration for change data capture (CDC) on an Oracle source database](https://docs.aws.amazon.com/dms/latest/userguide/CHAP_Source.Oracle.html#dms/latest/userguide/CHAP_Source.Oracle.html#CHAP_Source.Oracle.CDC.Configuration)
         * .
         *
         ...
         * target database by writing directly to tables and not writing a trail to database logs.
         *
         ...
         *
         * This attribute also only applies when you use the AWS DMS parallel load feature. Note
         ...
         * setting with the `archivedLogDestId` extra connection attribute in a primary-to-single
         ...
         * source. In this case, AWS DMS needs information about what destination to get archive
         * redo logs from to read changes. AWS DMS needs this because after the switchover the
         * previous primary is a standby instance. For example, in a primary-to-single standby setup
         * you might apply the following settings.
         *
         ...
         *
         * You can select a scale up to 38, or you can select FLOAT. By default, the NUMBER data
         ...
         *
         * The role must allow the `iam:PassRole` action. `SecretsManagerSecret` has the value of
         * the AWS Secrets Manager secret that allows access to the Oracle endpoint.
         *
         * You can specify one of two sets of values for these permissions. You can specify the
         * values for this setting and `SecretsManagerSecretId` . Or you can specify clear-text
         * values for `UserName` , `Password` , `ServerName` , and `Port` . You can't specify both.
         ...
         * `SecretsManagerOracleAsmAccessRoleArn` , and the `SecretsManagerOracleAsmSecretId` that
         * is required to access it, see
         * [Using secrets to access AWS Database Migration Service resources](https://docs.aws.amazon.com/dms/latest/userguide/CHAP_Security.html#security-iam-secretsmanager)
         * in the *AWS Database Migration Service User Guide* .
         *
         ...
         * setting the key name value of `SecurityDbEncryptionName` , see the information and
         * example for setting the `securityDbEncryptionName` extra connection attribute in
         * [Supported encryption methods for using Oracle as a source for AWS DMS](https://docs.aws.amazon.com/dms/latest/userguide/CHAP_Source.Oracle.html#CHAP_Source.Oracle.Encryption)
         * in the *AWS Database Migration Service User Guide* .
         *
         ...
         */
        public fun useAlternateFolderForOnline(): Any? =
         ...
         * RDS for Oracle as the source, you set additional attributes. For more information about
         * using this setting with Oracle Automatic Storage Management (ASM), see
         ...
         * default).
         *
         * Set this attribute to N if you want to access the redo logs as a binary file. When you
         * set `UseLogminerReader` to N, also set `UseBfile` to Y. For more information on this
         ...
         * capture change data for an Amazon RDS for Oracle as the source.
         *
         * This value specifies the path prefix used to replace the default Oracle root to access
         * the redo logs.
         *
        ...
        public interface Builder {
            /**
             * @param accessAlternateDirectly Set this attribute to `false` in order to use the
             *   Binary Reader to capture change data for an Amazon RDS for Oracle as the source.
             *   This tells the DMS instance to not access redo logs through any specified path
            ...
            /**
             * @param addSupplementalLogging Set this attribute to set up table-level supplemental
             *   logging for the Oracle database. This attribute enables PRIMARY KEY supplemental
             ...
             *   primary/ standby setup. This attribute is useful in the case of a switchover. In
             *   this case, AWS DMS needs to know which destination to get archive redo logs from to
             *   read changes. This need arises because the previous primary instance is now a
             *   standby instance after switchover.
             *
             * Although AWS DMS supports the use of the Oracle `RESETLOGS` option to open the
             * database, never use `RESETLOGS` unless necessary. For additional information about
             * `RESETLOGS` , see
             * [RMAN Data Repair Concepts](https://docs.aws.amazon.com/https://docs.oracle.com/en/database/oracle/oracle-database/19/bradv/rman-data-repair-concepts.html#GUID-1805CCF7-4AF2-482D-B65A-998192F89C2B)
             * in the *Oracle Database Backup and Recovery User's Guide* .
             */
            ...
            /**
             * @param allowSelectNestedTables Set this attribute to `true` to enable replication of
             *   Oracle tables containing columns that are nested tables or defined types.
             */
            ...
            /**
             * @param archivedLogDestId Specifies the ID of the destination for the archived redo
             *   logs. This value should be the same as a number in the dest_id column of the
             *   v$archived_log view. If you work with an additional redo log destination, use the
             *   `AdditionalArchivedLogDestId` option to specify the additional destination ID.
             *   Doing this improves performance by ensuring that the correct logs are accessed from
             *   the outset.
             */
            public fun archivedLogDestId(archivedLogDestId: Number)

            /**
             * @param archivedLogsOnly When this field is set to `Y` , AWS DMS only accesses the
             *   archived redo logs. If the archived redo logs are stored on Automatic Storage
             *   Management (ASM) only, the AWS DMS user account needs to be granted ASM privileges.
             */
            ...
            /**
             * @param asmPassword For an Oracle source endpoint, your Oracle Automatic Storage
             *   Management (ASM) password. You can set this value from the `*asm_user_password*`
             *   value. You set this value as part of the comma-separated value that you set to the
             *   `Password` request parameter when you create the endpoint to access transaction
             *   logs using Binary Reader. For more information, see
             *   [Configuration for change data capture (CDC) on an Oracle source database](https://docs.aws.amazon.com/dms/latest/userguide/CHAP_Source.Oracle.html#dms/latest/userguide/CHAP_Source.Oracle.html#CHAP_Source.Oracle.CDC.Configuration)
             *   .
             */
            ...
            /**
             * @param asmServer For an Oracle source endpoint, your ASM server address. You can set
             *   this value from the `asm_server` value. You set `asm_server` as part of the extra
             *   connection attribute string to access an Oracle server with Binary Reader that uses
             *   ASM. For more information, see
             *   [Configuration for change data capture (CDC) on an Oracle source database](https://docs.aws.amazon.com/dms/latest/userguide/CHAP_Source.Oracle.html#dms/latest/userguide/CHAP_Source.Oracle.html#CHAP_Source.Oracle.CDC.Configuration)
             *   .
             */
            ...
            /**
             * @param asmUser For an Oracle source endpoint, your ASM user name. You can set this
             *   value from the `asm_user` value. You set `asm_user` as part of the extra connection
            ...
            /**
             * @param charLengthSemantics Specifies whether the length of a character column is in
             *   bytes or in characters. To indicate that the character column length is in
             *   characters, set this attribute to `CHAR` . Otherwise, the character column length
             *   is in bytes.
             *
             * Example: `charLengthSemantics=CHAR;`
             */
            ...
            /**
             * @param directPathNoLog When set to `true` , this attribute helps to increase the
             *   commit rate on the Oracle target database by writing directly to tables and not
            ...
            /**
             * @param directPathParallelLoad When set to `true` , this attribute specifies a
             *   parallel load when `useDirectPathFullLoad` is set to `Y` . This attribute also only
             *   applies when you use the AWS DMS parallel load feature. Note that the target table
             ...
             *   replication and create existing tables or indexes under the same tablespace on the
             *   target.
             */
            ...
            /**
             * @param extraArchivedLogDestIds Specifies the IDs of one more destinations for one or
             *   more archived redo logs. These IDs are the values of the `dest_id` column in the
             *   `v$archived_log` view. Use this setting with the `archivedLogDestId` extra
             *   connection attribute in a primary-to-single setup or a primary-to-multiple-standby
             *   setup.
             *
             * This setting is useful in a switchover when you use an Oracle Data Guard database as
             * a source. In this case, AWS DMS needs information about what destination to get
             * archive redo logs from to read changes. AWS DMS needs this because after the
            ...
            /**
             * @param failTasksOnLobTruncation When set to `true` , this attribute causes a task to
             *   fail if the actual size of an LOB column is greater than the specified `LobMaxSize`
            ...
            /**
             * @param numberDatatypeScale Specifies the number scale. You can select a scale up to
             *   38, or you can select FLOAT. By default, the NUMBER data type is converted to
            ...
            /**
             * @param oraclePathPrefix Set this string attribute to the required value in order to
             *   use the Binary Reader to capture change data for an Amazon RDS for Oracle as the
             *   source. This value specifies the default Oracle root used to access the redo logs.
             */
            public fun oraclePathPrefix(oraclePathPrefix: String)

            /**
             * @param parallelAsmReadThreads Set this attribute to change the number of threads that
             *   DMS configures to perform a change data capture (CDC) load using Oracle Automatic
             *   Storage Management (ASM). You can specify an integer value between 2 (the default)
             ...
             *   that DMS configures to perform a change data capture (CDC) load using Oracle
             *   Automatic Storage Management (ASM). You can specify an integer value between 1000
             *   (the default) and 200,000 (the maximum).
             */
            ...
            /**
             * @param replacePathPrefix Set this attribute to true in order to use the Binary Reader
             *   to capture change data for an Amazon RDS for Oracle as the source. This setting
            ...
            /**
             * @param retryInterval Specifies the number of seconds that the system waits before
             *   resending a query. Example: `retryInterval=6;`
             */
            ...
            /**
             * @param secretsManagerOracleAsmAccessRoleArn Required only if your Oracle endpoint
             *   uses Advanced Storage Manager (ASM). The full ARN of the IAM role that specifies
             *   AWS DMS as the trusted entity and grants the required permissions to access the
             ...
             * You can specify one of two sets of values for these permissions. You can specify the
             * values for this setting and `SecretsManagerOracleAsmSecretId` . Or you can specify
             * clear-text values for `AsmUser` , `AsmPassword` , and `AsmServerName` . You can't
             * specify both.
             *
             * For more information on creating this `SecretsManagerOracleAsmSecret` , the
             * corresponding `SecretsManagerOracleAsmAccessRoleArn` , and the
             * `SecretsManagerOracleAsmSecretId` that is required to access it, see
             * [Using secrets to access AWS Database Migration Service resources](https://docs.aws.amazon.com/dms/latest/userguide/CHAP_Security.html#security-iam-secretsmanager)
             * in the *AWS Database Migration Service User Guide* .
             */
            public fun secretsManagerOracleAsmAccessRoleArn(
                secretsManagerOracleAsmAccessRoleArn: String
            )

            /**
             * @param secretsManagerOracleAsmSecretId Required only if your Oracle endpoint uses
             *   Advanced Storage Manager (ASM). The full ARN, partial ARN, or display name of the
             *   `SecretsManagerOracleAsmSecret` that contains the Oracle ASM connection details for
             *   the Oracle endpoint.
             */
            ...
            /**
             * @param securityDbEncryption For an Oracle source endpoint, the transparent data
             *   encryption (TDE) password required by AWM DMS to access Oracle redo logs encrypted
             *   by TDE using Binary Reader. It is also the `*TDE_Password*` part of the
             *   comma-separated value you set to the `Password` request parameter when you create
             *   the endpoint. The `SecurityDbEncryptian` setting is related to this
            ...
            /**
             * @param securityDbEncryptionName For an Oracle source endpoint, the name of a key used
             *   for the transparent data encryption (TDE) of the columns and tablespaces in an
             *   Oracle source database that is encrypted using TDE. The key value is the value of
             *   the `SecurityDbEncryption` setting. For more information on setting the key name
             *   value of `SecurityDbEncryptionName` , see the information and example for setting
             *   the `securityDbEncryptionName` extra connection attribute in
             *   [Supported encryption methods for using Oracle as a source for AWS DMS](https://docs.aws.amazon.com/dms/latest/userguide/CHAP_Source.Oracle.html#CHAP_Source.Oracle.Encryption)
             *   in the *AWS Database Migration Service User Guide* .
             */
            ...
            /**
             * @param spatialDataOptionToGeoJsonFunctionName Use this attribute to convert
             *   `SDO_GEOMETRY` to `GEOJSON` format. By default, DMS calls the `SDO2GEOJSON` custom
             *   function if present and accessible. Or you can create your own custom function that
             *   mimics the operation of `SDOGEOJSON` and set
             *   `SpatialDataOptionToGeoJsonFunctionName` to call it instead.
             */
            ...
            /**
             * @param standbyDelayTime Use this attribute to specify a time in minutes for the delay
             *   in standby sync. If the source is an Oracle Active Data Guard standby database, use
             *   this attribute to specify the time lag between primary and standby databases.
             *
             * In AWS DMS , you can create an Oracle CDC task that uses an Active Data Guard standby
             * instance as a source for replicating ongoing changes. Doing this eliminates the need
             * to connect to an active database that might be in production.
             */
            public fun standbyDelayTime(standbyDelayTime: Number)

            /**
             * @param useAlternateFolderForOnline Set this attribute to `true` in order to use the
             *   Binary Reader to capture change data for an Amazon RDS for Oracle as the source.
             *   This tells the DMS instance to use any specified prefix replacement to access all
             *   online redo logs.
             */
            ...
            /**
             * @param useBFile Set this attribute to Y to capture change data using the Binary
             *   Reader utility. Set `UseLogminerReader` to N to set this attribute to Y. To use
            ...
            /**
             * @param useDirectPathFullLoad Set this attribute to Y to have AWS DMS use a direct
             *   path full load. Specify this value to use the direct path protocol in the Oracle
             *   Call Interface (OCI). By using this OCI protocol, you can bulk-load Oracle target
            ...
            /**
             * @param useLogminerReader Set this attribute to Y to capture change data using the
             *   Oracle LogMiner utility (the default). Set this attribute to N if you want to
             *   access the redo logs as a binary file. When you set `UseLogminerReader` to N, also
             *   set `UseBfile` to Y. For more information on this setting and using Oracle ASM, see
             *   [Using Oracle LogMiner or AWS DMS Binary Reader for CDC](https://docs.aws.amazon.com/dms/latest/userguide/CHAP_Source.Oracle.html#CHAP_Source.Oracle.CDC)
             *   in the *AWS DMS User Guide* .
             */
            ...
            /**
             * @param usePathPrefix Set this string attribute to the required value in order to use
             *   the Binary Reader to capture change data for an Amazon RDS for Oracle as the
             *   source. This value specifies the path prefix used to replace the default Oracle
             *   root to access the redo logs.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            override fun enableHomogenousTablespace(enableHomogenousTablespace: IResolvable) {
                cdkBuilder.enableHomogenousTablespace(
                    enableHomogenousTablespace.let(IResolvable::unwrap)
                )
            }
            ...
            override fun failTasksOnLobTruncation(failTasksOnLobTruncation: IResolvable) {
                cdkBuilder.failTasksOnLobTruncation(
                    failTasksOnLobTruncation.let(IResolvable::unwrap)
                )
            }
             ...
             * in the *AWS Database Migration Service User Guide* .
             */
            override fun secretsManagerOracleAsmAccessRoleArn(
                secretsManagerOracleAsmAccessRoleArn: String
            ) {
                cdkBuilder.secretsManagerOracleAsmAccessRoleArn(
             ...
             *   `SpatialDataOptionToGeoJsonFunctionName` to call it instead.
             */
            override fun spatialDataOptionToGeoJsonFunctionName(
                spatialDataOptionToGeoJsonFunctionName: String
            ) {
                cdkBuilder.spatialDataOptionToGeoJsonFunctionName(
            ...
            override fun useAlternateFolderForOnline(useAlternateFolderForOnline: IResolvable) {
                cdkBuilder.useAlternateFolderForOnline(
                    useAlternateFolderForOnline.let(IResolvable::unwrap)
                )
            }
        ...
        internal constructor(
             ...
             * data for an Amazon RDS for Oracle as the source.
             *
             * This tells the DMS instance to not access redo logs through any specified path prefix
             * replacement using direct file access.
             *
             ...
             * Set this attribute with `ArchivedLogDestId` in a primary/ standby setup.
             *
             * This attribute is useful in the case of a switchover. In this case, AWS DMS needs to
             ...
             * This value should be the same as a number in the dest_id column of the v$archived_log
             * view. If you work with an additional redo log destination, use the
             * `AdditionalArchivedLogDestId` option to specify the additional destination ID. Doing
             * this improves performance by ensuring that the correct logs are accessed from the
             * outset.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-dms-endpoint-oraclesettings.html#cfn-dms-endpoint-oraclesettings-archivedlogdestid)
             */
             ...
             * AWS DMS user account needs to be granted ASM privileges.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-dms-endpoint-oraclesettings.html#cfn-dms-endpoint-oraclesettings-archivedlogsonly)
             */
             ...
             * password.
             *
             * You can set this value from the `*asm_user_password*` value. You set this value as
             * part of the comma-separated value that you set to the `Password` request parameter
             ...
             * For an Oracle source endpoint, your ASM server address.
             *
             * You can set this value from the `asm_server` value. You set `asm_server` as part of
             * the extra connection attribute string to access an Oracle server with Binary Reader
             * that uses ASM. For more information, see
             * [Configuration for change data capture (CDC) on an Oracle source database](https://docs.aws.amazon.com/dms/latest/userguide/CHAP_Source.Oracle.html#dms/latest/userguide/CHAP_Source.Oracle.html#CHAP_Source.Oracle.CDC.Configuration)
             * .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-dms-endpoint-oraclesettings.html#cfn-dms-endpoint-oraclesettings-asmserver)
             ...
             * For an Oracle source endpoint, your ASM user name.
             *
             * You can set this value from the `asm_user` value. You set `asm_user` as part of the
             * extra connection attribute string to access an Oracle server with Binary Reader that
             * uses ASM. For more information, see
             * [Configuration for change data capture (CDC) on an Oracle source database](https://docs.aws.amazon.com/dms/latest/userguide/CHAP_Source.Oracle.html#dms/latest/userguide/CHAP_Source.Oracle.html#CHAP_Source.Oracle.CDC.Configuration)
             * .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-dms-endpoint-oraclesettings.html#cfn-dms-endpoint-oraclesettings-asmuser)
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-dms-endpoint-oraclesettings.html#cfn-dms-endpoint-oraclesettings-enablehomogenoustablespace)
             */
            override fun enableHomogenousTablespace(): Any? =
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-dms-endpoint-oraclesettings.html#cfn-dms-endpoint-oraclesettings-failtasksonlobtruncation)
             */
            override fun failTasksOnLobTruncation(): Any? =
             ...
             * this attribute together with the `readAheadBlocks` attribute.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-dms-endpoint-oraclesettings.html#cfn-dms-endpoint-oraclesettings-parallelasmreadthreads)
             */
            override fun parallelAsmReadThreads(): Number? =
             ...
             *
             * The role must allow the `iam:PassRole` action. `SecretsManagerSecret` has the value
             * of the AWS Secrets Manager secret that allows access to the Oracle endpoint.
             *
             * You can specify one of two sets of values for these permissions. You can specify the
             * values for this setting and `SecretsManagerSecretId` . Or you can specify clear-text
             * values for `UserName` , `Password` , `ServerName` , and `Port` . You can't specify
             ...
             * Required only if your Oracle endpoint uses Advanced Storage Manager (ASM).
             *
             * The full ARN of the IAM role that specifies AWS DMS as the trusted entity and grants
             * the required permissions to access the `SecretsManagerOracleAsmSecret` . This
             * `SecretsManagerOracleAsmSecret` has the secret value that allows access to the Oracle
             * ASM of the endpoint.
             *
             * You can specify one of two sets of values for these permissions. You can specify the
             * values for this setting and `SecretsManagerOracleAsmSecretId` . Or you can specify
             ...
             * required by AWM DMS to access Oracle redo logs encrypted by TDE using Binary Reader.
             *
             * It is also the `*TDE_Password*` part of the comma-separated value you set to the
             * `Password` request parameter when you create the endpoint. The `SecurityDbEncryptian`
             ...
             * encrypted using TDE.
             *
             * The key value is the value of the `SecurityDbEncryption` setting. For more
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-dms-endpoint-oraclesettings.html#cfn-dms-endpoint-oraclesettings-securitydbencryptionname)
             */
            override fun securityDbEncryptionName(): String? =
                unwrap(this).getSecurityDbEncryptionName()

            /**
             * Use this attribute to convert `SDO_GEOMETRY` to `GEOJSON` format.
             *
             * By default, DMS calls the `SDO2GEOJSON` custom function if present and accessible. Or
             * you can create your own custom function that mimics the operation of `SDOGEOJSON` and
             ...
             * Set this attribute to Y to have AWS DMS use a direct path full load.
             *
             * Specify this value to use the direct path protocol in the Oracle Call Interface
             * (OCI). By using this OCI protocol, you can bulk-load Oracle target tables during a
             * full load.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-dms-endpoint-oraclesettings.html#cfn-dms-endpoint-oraclesettings-usedirectpathfullload)
             */
             ...
             * default).
             *
             * Set this attribute to N if you want to access the redo logs as a binary file. When
             * you set `UseLogminerReader` to N, also set `UseBfile` to Y. For more information on
             * this setting and using Oracle ASM, see
             * [Using Oracle LogMiner or AWS DMS Binary Reader for CDC](https://docs.aws.amazon.com/dms/latest/userguide/CHAP_Source.Oracle.html#CHAP_Source.Oracle.CDC)
             * in the *AWS DMS User Guide* .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-dms-endpoint-oraclesettings.html#cfn-dms-endpoint-oraclesettings-uselogminerreader)
             ...
             * capture change data for an Amazon RDS for Oracle as the source.
             *
             * This value specifies the path prefix used to replace the default Oracle root to
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: OracleSettingsProperty
            ): software.amazon.awscdk.services.dms.CfnEndpoint.OracleSettingsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface S3SettingsProperty {
         ...
         */
        public fun addTrailingPaddingCharacter(): Any? =
            unwrap(this).getAddTrailingPaddingCharacter()

        /**
         * An optional parameter to set a folder name in the S3 bucket.
         *
         * If provided, tables are created in the path `*bucketFolder* / *schema_name* /
         * *table_name* /` . If this parameter isn't specified, the path used is `*schema_name* /
         * *table_name* /` .
         *
        ...
        /**
         * A value that enables AWS DMS to specify a predefined (canned) access control list (ACL)
         ...
         * value of the `IncludeOpForFullLoad` parameter. If `IncludeOpForFullLoad` is set to `true`
         ...
         * records are written without an indication of INSERT or UPDATE operations at the source.
         ...
         *
         * For an S3 source, this setting is required if a task captures change data; otherwise,
         * it's optional. If `CdcPath` is set, AWS DMS reads CDC files from this path and replicates
         ...
         * target where AWS DMS can save the transaction order for the CDC load. AWS DMS creates
         * this CDC folder path in either your S3 target working directory or the S3 target location
         * specified by
         ...
         * as `MyTargetBucket` but do not specify `BucketFolder` , AWS DMS creates the CDC folder
         ...
         *
         * When set to GZIP it enables the service to compress the target files. To allow the
         * service to write the target files uncompressed, either set this parameter to NONE (the
         * default) or don't specify the parameter at all. This parameter applies to both .csv and
         ...
         *
         * While handling the null value, you can use this parameter to pass a user-defined string
         * as null when writing to the target. For example, when target columns are not nullable,
         * you can use this option to differentiate between the empty string value and the null
         * value. So, if you set this parameter value to the empty string ("" or ''), AWS DMS treats
         * the empty string as the null value instead of `NULL` .
         *
         ...
         *
         * This parameter defaults to 1024 * 1024 bytes (1 MiB). This number is used for .parquet
         * file format only.
         *
         ...
         * UTC time into a specified time zone.
         *
         * The conversion occurs when a date partition folder is created and a change data capture
         * (CDC) file name is generated. The time zone format is Area/Location. Use this parameter
         * when `DatePartitionedEnabled` is set to `true` , as shown in the following example.
         *
         ...
         * dictionary page before it reverts to `PLAIN` encoding. This size is used for .parquet
         * file format only.
         *
         ...
         * literals are copied to the target as is. In this case, a delimiter (row or column)
         * signals the end of the field. Thus, you can't use a delimiter as part of the string,
         * because it signals the end of the value.
         *
         ...
         * in it, AWS DMS encloses the entire column with an additional pair of double quotation
         ...
         *
         * A smaller row group size provides faster reads. But as the number of row groups grows,
         * the slower writes become. This parameter defaults to 10,000 rows. This number is used for
         ...
         * access the IAM role.
         *
         * The role must allow the `iam:PassRole` action. It enables AWS DMS to read and write
         ...
         *
         * AWS DMS includes an additional `STRING` column in the .csv or .parquet object files of
         ...
         * the timestamp column contains the task start time. For CDC loads, each row of the
        ...
        public interface Builder {
            /**
             * @param addColumnName An optional parameter that, when set to `true` or `y` , you can
             *   use to add column name information to the .csv output file. The default value is
             *   `false` . Valid values are `true` , `false` , `y` , and `n` .
             */
             ...
             *   `AddTrailingPaddingCharacter` to add padding on string data. The default value is
             *   `false` .
             */
            ...
            /**
             * @param bucketFolder An optional parameter to set a folder name in the S3 bucket. If
             *   provided, tables are created in the path `*bucketFolder* / *schema_name* /
             *   *table_name* /` . If this parameter isn't specified, the path used is
            ...
            /**
             * @param cannedAclForObjects A value that enables AWS DMS to specify a predefined
             *   (canned) access control list (ACL) for objects created in an Amazon S3 bucket as
             *   .csv or .parquet files. For more information about Amazon S3 canned ACLs, see
             *   [Canned ACL](https://docs.aws.amazon.com/AmazonS3/latest/dev/acl-overview.html#canned-acl)
            ...
            /**
             * @param cdcInsertsAndUpdates A value that enables a change data capture (CDC) load to
             *   write INSERT and UPDATE operations to .csv or .parquet (columnar storage) output
             *   files. The default setting is `false` , but when `CdcInsertsAndUpdates` is set to
             *   `true` or `y` , only INSERTs and UPDATEs from the source database are migrated to
             *   the .csv or .parquet file. For .csv file format only, how these INSERTs and UPDATEs
             *   are recorded depends on the value of the `IncludeOpForFullLoad` parameter. If
             ...
             *   in the *AWS Database Migration Service User Guide* .
             *
             * AWS DMS supports the use of the `CdcInsertsAndUpdates` parameter in versions 3.3.1
             * and later.
             *
             * `CdcInsertsOnly` and `CdcInsertsAndUpdates` can't both be set to `true` for the same
            ...
            /**
             * @param cdcInsertsOnly A value that enables a change data capture (CDC) load to write
             *   only INSERT operations to .csv or columnar storage (.parquet) output files. By
             *   default (the `false` setting), the first field in a .csv or .parquet record
             *   contains the letter I (INSERT), U (UPDATE), or D (DELETE). These values indicate
             *   whether the row was inserted, updated, or deleted at the source database for a CDC
             *   load to the target. If `CdcInsertsOnly` is set to `true` or `y` , only INSERTs from
             *   the source database are migrated to the .csv or .parquet file. For .csv format
             *   only, how these INSERTs are recorded depends on the value of `IncludeOpForFullLoad`
            ...
            /**
             * @param cdcMaxBatchInterval Maximum length of the interval, defined in seconds, after
             *   which to output a file to Amazon S3. When `CdcMaxBatchInterval` and
             *   `CdcMinFileSize` are both specified, the file write is triggered by whichever
             *   parameter condition is met first within an AWS DMS CloudFormation template.
             *
             * The default value is 60 seconds.
             */
            ...
            /**
             * @param cdcMinFileSize Minimum file size, defined in kilobytes, to reach for a file
             *   output to Amazon S3. When `CdcMinFileSize` and `CdcMaxBatchInterval` are both
             *   specified, the file write is triggered by whichever parameter condition is met
             *   first within an AWS DMS CloudFormation template.
             *
             * The default value is 32 MB.
             */
            ...
            /**
             * @param cdcPath Specifies the folder path of CDC files. For an S3 source, this setting
             *   is required if a task captures change data; otherwise, it's optional. If `CdcPath`
             *   is set, AWS DMS reads CDC files from this path and replicates the data changes to
             *   the target endpoint. For an S3 target if you set
             *   [`PreserveTransactions`](https://docs.aws.amazon.com/dms/latest/APIReference/API_S3Settings.html#DMS-Type-S3Settings-PreserveTransactions)
             *   to `true` , AWS DMS verifies that you have set this parameter to a folder path on
             *   your S3 target where AWS DMS can save the transaction order for the CDC load. AWS
             *   DMS creates this CDC folder path in either your S3 target working directory or the
             *   S3 target location specified by
             *   [`BucketFolder`](https://docs.aws.amazon.com/dms/latest/APIReference/API_S3Settings.html#DMS-Type-S3Settings-BucketFolder)
             *   and
             *   [`BucketName`](https://docs.aws.amazon.com/dms/latest/APIReference/API_S3Settings.html#DMS-Type-S3Settings-BucketName)
             *   .
             ...
             * `BucketName` as `MyTargetBucket` but do not specify `BucketFolder` , AWS DMS creates
            ...
            /**
             * @param compressionType An optional parameter. When set to GZIP it enables the service
             *   to compress the target files. To allow the service to write the target files
             *   uncompressed, either set this parameter to NONE (the default) or don't specify the
            ...
            /**
             * @param csvDelimiter The delimiter used to separate columns in the .csv file for both
             *   source and target. The default is a comma.
             */
            public fun csvDelimiter(csvDelimiter: String)

            /**
             * @param csvNoSupValue This setting only applies if your Amazon S3 output files during
             *   a change data capture (CDC) load are written in .csv format. If
             *   [`UseCsvNoSupValue`](https://docs.aws.amazon.com/dms/latest/APIReference/API_S3Settings.html#DMS-Type-S3Settings-UseCsvNoSupValue)
             *   is set to true, specify a string value that you want AWS DMS to use for all columns
             *   not included in the supplemental log. If you do not specify a string value, AWS DMS
             *   uses the null value for these columns regardless of the `UseCsvNoSupValue` setting.
             *
             * This setting is supported in AWS DMS versions 3.4.1 and later.
             */
            ...
            /**
             * @param csvNullValue An optional parameter that specifies how AWS DMS treats null
             *   values. While handling the null value, you can use this parameter to pass a
             *   user-defined string as null when writing to the target. For example, when target
             *   columns are not nullable, you can use this option to differentiate between the
             *   empty string value and the null value. So, if you set this parameter value to the
             *   empty string ("" or ''), AWS DMS treats the empty string as the null value instead
             *   of `NULL` .
             *
             * The default value is `NULL` . Valid values include any valid string.
             */
            ...
            /**
             * @param csvRowDelimiter The delimiter used to separate rows in the .csv file for both
             *   source and target. The default is a carriage return ( `\n` ).
             */
            public fun csvRowDelimiter(csvRowDelimiter: String)

            /**
             * @param dataFormat The format of the data that you want to use for output. You can
            ...
            /**
             * @param dataPageSize The size of one data page in bytes. This parameter defaults to
             *   1024 * 1024 bytes (1 MiB). This number is used for .parquet file format only.
             */
            public fun dataPageSize(dataPageSize: Number)

            /**
             * @param datePartitionDelimiter Specifies a date separating delimiter to use during
             *   folder partitioning. The default value is `SLASH` . Use this parameter when
             ...
             *   folders based on transaction commit dates. The default value is `false` . For more
             ...
             *   folder partitioning. The default value is `YYYYMMDD` . Use this parameter when
             *   `DatePartitionedEnabled` is set to `true` .
             */
             ...
             *   The conversion occurs when a date partition folder is created and a change data
             *   capture (CDC) file name is generated. The time zone format is Area/Location. Use
             *   this parameter when `DatePartitionedEnabled` is set to `true` , as shown in the
             *   following example.
             *
             * `s3-settings='{"DatePartitionEnabled": true, "DatePartitionSequence": "YYYYMMDDHH",
             * "DatePartitionDelimiter": "SLASH", "DatePartitionTimezone":" *Asia/Seoul* ",
             ...
             *   If the dictionary page exceeds this, this column is stored using an encoding type
             *   of `PLAIN` . This parameter defaults to 1024 * 1024 bytes (1 MiB), the maximum size
             *   of a dictionary page before it reverts to `PLAIN` encoding. This size is used for
             *   .parquet file format only.
             */
            public fun dictPageSizeLimit(dictPageSizeLimit: Number)

            /**
             * @param enableStatistics A value that enables statistics for Parquet pages and row
             *   groups. Choose `true` to enable statistics, `false` to disable. Statistics include
             *   `NULL` , `DISTINCT` , `MAX` , and `MIN` values. This parameter defaults to `true` .
            ...
            /**
             * @param encryptionMode The type of server-side encryption that you want to use for
             *   your data. This encryption type is part of the endpoint settings or the extra
             *   connections attributes for Amazon S3. You can choose either `SSE_S3` (the default)
             *   or `SSE_KMS` .
             *
             * For the `ModifyEndpoint` operation, you can change the existing value of the
             ...
             *
             * To use `SSE_S3` , you need an IAM role with permission to allow
            ...
            /**
             * @param expectedBucketOwner To specify a bucket owner and prevent sniping, you can use
             *   the `ExpectedBucketOwner` endpoint setting. Example:
            ...
            /**
             * @param externalTableDefinition The external table definition. Conditional: If `S3` is
             *   used as a source then `ExternalTableDefinition` is required.
             */
            ...
            /**
             * @param ignoreHeaderRows When this value is set to 1, AWS DMS ignores the first row
             *   header in a .csv file. A value of 1 turns on the feature; a value of 0 turns off
             *   the feature. The default is 0.
             */
            public fun ignoreHeaderRows(ignoreHeaderRows: Number)

            /**
             * @param includeOpForFullLoad A value that enables a full load to write INSERT
             *   operations to the comma-separated value (.csv) output files only to indicate how
             *   the rows were added to the source database.
             *
             * AWS DMS supports the `IncludeOpForFullLoad` parameter in versions 3.1.4 and later.
             *
             * For full load, records can only be inserted. By default (the `false` setting), no
             * information is recorded in these output files for a full load to indicate that the
             * rows were inserted at the source database. If `IncludeOpForFullLoad` is set to `true`
             * or `y` , the INSERT is recorded as an I annotation in the first field of the .csv
             * file. This allows the format of your target records from a full load to be consistent
             * with the target records from a CDC load.
             *
             * This setting works together with the `CdcInsertsOnly` and the `CdcInsertsAndUpdates`
            ...
            /**
             * @param maxFileSize A value that specifies the maximum size (in KB) of any .csv file
             *   to be created while migrating to an S3 target during full load. The default value
             *   is 1,048,576 KB (1 GB). Valid values include 1 to 1,048,576.
             */
            public fun maxFileSize(maxFileSize: Number)

            /**
             * @param parquetTimestampInMillisecond A value that specifies the precision of any
             *   `TIMESTAMP` column values that are written to an Amazon S3 object file in .parquet
             *   format.
             *
             * AWS DMS supports the `ParquetTimestampInMillisecond` parameter in versions 3.1.4 and
             * later.
             ...
             *   transaction order for a change data capture (CDC) load on the Amazon S3 target
             *   specified by
             *   [`CdcPath`](https://docs.aws.amazon.com/dms/latest/APIReference/API_S3Settings.html#DMS-Type-S3Settings-CdcPath)
             *   . For more information, see
             *   [Capturing data changes (CDC) including transaction order on the S3 target](https://docs.aws.amazon.com/dms/latest/userguide/CHAP_Target.S3.html#CHAP_Target.S3.EndpointSettings.CdcPath)
            ...
            /**
             * @param rfc4180 For an S3 source, when this value is set to `true` or `y` , each
             *   leading double quotation mark has to be followed by an ending double quotation
             *   mark. This formatting complies with RFC 4180. When this value is set to `false` or
             *   `n` , string literals are copied to the target as is. In this case, a delimiter
             *   (row or column) signals the end of the field. Thus, you can't use a delimiter as
             *   part of the string, because it signals the end of the value.
             *
             * For an S3 target, an optional parameter used to set behavior to comply with RFC 4180
             * for data migrated to Amazon S3 using .csv file format only. When this value is set to
             * `true` or `y` using Amazon S3 as a target, if the data has quotation marks or newline
             * characters in it, AWS DMS encloses the entire column with an additional pair of
             * double quotation marks ("). Every quotation mark within the data is repeated twice.
             *
             * The default value is `true` . Valid values include `true` , `false` , `y` , and `n` .
             */
            ...
            /**
             * @param rowGroupLength The number of rows in a row group. A smaller row group size
             *   provides faster reads. But as the number of row groups grows, the slower writes
             *   become. This parameter defaults to 10,000 rows. This number is used for .parquet
             *   file format only.
             *
             * If you choose a value larger than the maximum, `RowGroupLength` is set to the max row
             * group length in bytes (64 * 1024 * 1024).
            ...
            /**
             * @param serverSideEncryptionKmsKeyId If you are using `SSE_KMS` for the
             *   `EncryptionMode` , provide the AWS KMS key ID. The key that you use needs an
            ...
            /**
             * @param serviceAccessRoleArn A required parameter that specifies the Amazon Resource
             *   Name (ARN) used by the service to access the IAM role. The role must allow the
             *   `iam:PassRole` action. It enables AWS DMS to read and write objects from an S3
             *   bucket.
             */
            public fun serviceAccessRoleArn(serviceAccessRoleArn: String)

            /**
             * @param timestampColumnName A value that when nonblank causes AWS DMS to add a column
             *   with timestamp information to the endpoint data for an Amazon S3 target.
             *
             * AWS DMS supports the `TimestampColumnName` parameter in versions 3.1.4 and later.
             *
             * AWS DMS includes an additional `STRING` column in the .csv or .parquet object files
            ...
            /**
             * @param useCsvNoSupValue This setting applies if the S3 output files during a change
             *   data capture (CDC) load are written in .csv format. If this setting is set to
             *   `true` for columns not included in the supplemental log, AWS DMS uses the value
             *   specified by
             *   [`CsvNoSupValue`](https://docs.aws.amazon.com/dms/latest/APIReference/API_S3Settings.html#DMS-Type-S3Settings-CsvNoSupValue)
             *   . If this setting isn't set or is set to `false` , AWS DMS uses the null value for
             *   these columns.
             *
             * This setting is supported in AWS DMS versions 3.4.1 and later.
             */
            ...
            /**
             * @param useTaskStartTimeForFullLoadTimestamp When set to true, this parameter uses the
             *   task start time as the timestamp column value instead of the time data is written
             *   to target. For full load, when `useTaskStartTimeForFullLoadTimestamp` is set to
             *   `true` , each row of the timestamp column contains the task start time. For CDC
             *   loads, each row of the timestamp column contains the transaction commit time.
             *
        ...
        private class BuilderImpl : Builder {
            ...
            override fun addTrailingPaddingCharacter(addTrailingPaddingCharacter: IResolvable) {
                cdkBuilder.addTrailingPaddingCharacter(
                    addTrailingPaddingCharacter.let(IResolvable::unwrap)
                )
            }
            ...
            override fun parquetTimestampInMillisecond(parquetTimestampInMillisecond: IResolvable) {
                cdkBuilder.parquetTimestampInMillisecond(
                    parquetTimestampInMillisecond.let(IResolvable::unwrap)
                )
            }
             ...
             * target.
             */
            override fun useTaskStartTimeForFullLoadTimestamp(
                useTaskStartTimeForFullLoadTimestamp: Boolean
            ) {
                cdkBuilder.useTaskStartTimeForFullLoadTimestamp(
            ...
            override fun useTaskStartTimeForFullLoadTimestamp(
                ...
                cdkBuilder.useTaskStartTimeForFullLoadTimestamp(
                    useTaskStartTimeForFullLoadTimestamp.let(IResolvable::unwrap)
                )
            }
        ...
        internal constructor(
            ...
            /**
             * A value that enables AWS DMS to specify a predefined (canned) access control list
             * (ACL) for objects created in an Amazon S3 bucket as .csv or .parquet files. For more
             * information about Amazon S3 canned ACLs, see
             * [Canned ACL](https://docs.aws.amazon.com/AmazonS3/latest/dev/acl-overview.html#canned-acl)
             * in the *Amazon S3 Developer Guide* .
             *
            ...
            /**
             * A value that enables a change data capture (CDC) load to write INSERT and UPDATE
             * operations to .csv or .parquet (columnar storage) output files. The default setting
             * is `false` , but when `CdcInsertsAndUpdates` is set to `true` or `y` , only INSERTs
             ...
             * INSERT and UPDATE operations at the source. But if `IncludeOpForFullLoad` is set to
             ...
             * (INSERT), U (UPDATE), or D (DELETE). These values indicate whether the row was
             ...
             * are migrated to the .csv or .parquet file. For .csv format only, how these INSERTs
             ...
             *
             * When `CdcMaxBatchInterval` and `CdcMinFileSize` are both specified, the file write is
             * triggered by whichever parameter condition is met first within an AWS DMS
             ...
             *
             * For an S3 source, this setting is required if a task captures change data; otherwise,
             * it's optional. If `CdcPath` is set, AWS DMS reads CDC files from this path and
             * replicates the data changes to the target endpoint. For an S3 target if you set
             * [`PreserveTransactions`](https://docs.aws.amazon.com/dms/latest/APIReference/API_S3Settings.html#DMS-Type-S3Settings-PreserveTransactions)
             * to `true` , AWS DMS verifies that you have set this parameter to a folder path on
             * your S3 target where AWS DMS can save the transaction order for the CDC load. AWS DMS
             * creates this CDC folder path in either your S3 target working directory or the S3
             ...
             *
             * When set to GZIP it enables the service to compress the target files. To allow the
             * service to write the target files uncompressed, either set this parameter to NONE
             * (the default) or don't specify the parameter at all. This parameter applies to both
             ...
             * An optional parameter that specifies how AWS DMS treats null values.
             *
             * While handling the null value, you can use this parameter to pass a user-defined
             * string as null when writing to the target. For example, when target columns are not
             * nullable, you can use this option to differentiate between the empty string value and
             * the null value. So, if you set this parameter value to the empty string ("" or ''),
             * AWS DMS treats the empty string as the null value instead of `NULL` .
             *
             * The default value is `NULL` . Valid values include any valid string.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-dms-endpoint-s3settings.html#cfn-dms-endpoint-s3settings-csvnullvalue)
             ...
             * The size of one data page in bytes.
             *
             * This parameter defaults to 1024 * 1024 bytes (1 MiB). This number is used for
             * .parquet file format only.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-dms-endpoint-s3settings.html#cfn-dms-endpoint-s3settings-datapagesize)
             */
             ...
             * Specifies a date separating delimiter to use during folder partitioning.
             *
             * The default value is `SLASH` . Use this parameter when `DatePartitionedEnabled` is
             * set to `true` .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-dms-endpoint-s3settings.html#cfn-dms-endpoint-s3settings-datepartitiondelimiter)
             */
            override fun datePartitionDelimiter(): String? =
             ...
             * commit dates.
             *
             * The default value is `false` . For more information about date-based folder
             * partitioning, see
             * [Using date-based folder partitioning](https://docs.aws.amazon.com/dms/latest/userguide/CHAP_Target.S3.html#CHAP_Target.S3.DatePartitioning)
             * .
             *
             ...
             * current UTC time into a specified time zone.
             *
             * The conversion occurs when a date partition folder is created and a change data
             * capture (CDC) file name is generated. The time zone format is Area/Location. Use this
             * parameter when `DatePartitionedEnabled` is set to `true` , as shown in the following
             * example.
             *
             * `s3-settings='{"DatePartitionEnabled": true, "DatePartitionSequence": "YYYYMMDDHH",
             * "DatePartitionDelimiter": "SLASH", "DatePartitionTimezone":" *Asia/Seoul* ",
             ...
             *
             * Choose `true` to enable statistics, `false` to disable. Statistics include `NULL` ,
             * `DISTINCT` , `MAX` , and `MIN` values. This parameter defaults to `true` . This value
             ...
             * The type of server-side encryption that you want to use for your data.
             *
             * This encryption type is part of the endpoint settings or the extra connections
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-dms-endpoint-s3settings.html#cfn-dms-endpoint-s3settings-externaltabledefinition)
             */
            override fun externalTableDefinition(): String? =
            ...
            /**
             * When this value is set to 1, AWS DMS ignores the first row header in a .csv file. A
            ...
            /**
             * If this setting is set to `true` , AWS DMS saves the transaction order for a change
             ...
             * quotation mark has to be followed by an ending double quotation mark.
             *
             * This formatting complies with RFC 4180. When this value is set to `false` or `n` ,
             ...
             * The number of rows in a row group.
             *
             * A smaller row group size provides faster reads. But as the number of row groups
             * grows, the slower writes become. This parameter defaults to 10,000 rows. This number
             * is used for .parquet file format only.
             *
             * If you choose a value larger than the maximum, `RowGroupLength` is set to the max row
             * group length in bytes (64 * 1024 * 1024).
            ...
            /**
             * A required parameter that specifies the Amazon Resource Name (ARN) used by the
             * service to access the IAM role.
             *
             * The role must allow the `iam:PassRole` action. It enables AWS DMS to read and write
             * objects from an S3 bucket.
             *
             ...
             * are written in .csv format. If this setting is set to `true` for columns not included
             * in the supplemental log, AWS DMS uses the value specified by
             * [`CsvNoSupValue`](https://docs.aws.amazon.com/dms/latest/APIReference/API_S3Settings.html#DMS-Type-S3Settings-CsvNoSupValue)
             * . If this setting isn't set or is set to `false` , AWS DMS uses the null value for
             * these columns.
             *
             ...
             * value instead of the time data is written to target.
             *
             * For full load, when `useTaskStartTimeForFullLoadTimestamp` is set to `true` , each
             * row of the timestamp column contains the task start time. For CDC loads, each row of
    ...
    public interface SybaseSettingsProperty {
         ...
         *
         * The role must allow the `iam:PassRole` action. `SecretsManagerSecret` has the value of
         * the AWS Secrets Manager secret that allows access to the SAP ASE endpoint.
         *
         * You can specify one of two sets of values for these permissions. You can specify the
         * values for this setting and `SecretsManagerSecretId` . Or you can specify clear-text
         * values for `UserName` , `Password` , `ServerName` , and `Port` . You can't specify both.
        ...
        internal constructor(
             ...
             *
             * The role must allow the `iam:PassRole` action. `SecretsManagerSecret` has the value
             * of the AWS Secrets Manager secret that allows access to the SAP ASE endpoint.
             *
             * You can specify one of two sets of values for these permissions. You can specify the
             * values for this setting and `SecretsManagerSecretId` . Or you can specify clear-text
             * values for `UserName` , `Password` , `ServerName` , and `Port` . You can't specify
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SybaseSettingsProperty
            ): software.amazon.awscdk.services.dms.CfnEndpoint.SybaseSettingsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface MicrosoftSqlServerSettingsProperty {
         ...
         * during full load and ongoing replication tasks. However, it can add some source latency
         * to ongoing replication.
         *
         ...
         *
         * *Start transactions in the database:* This is the default method. When this method is
         * used, AWS DMS prevents TLOG truncation by mimicking a transaction in the database. As
         * long as such a transaction is open, changes that appear after the transaction started
         * aren't truncated. If you need Microsoft Replication to be enabled in your database, then
         ...
         * one AWS DMS task can access the database at any given time. Therefore, if you need to run
         ...
         *
         * The role must allow the `iam:PassRole` action. `SecretsManagerSecret` has the value of
         * the AWS Secrets Manager secret that allows access to the SQL Server endpoint.
         *
         * You can specify one of two sets of values for these permissions. You can specify the
         * values for this setting and `SecretsManagerSecretId` . Or you can specify clear-text
         * values for `UserName` , `Password` , `ServerName` , and `Port` . You can't specify both.
        ...
        /**
         * The full ARN, partial ARN, or display name of the `SecretsManagerSecret` that contains
         * the MicrosoftSQLServer endpoint connection details.
         *
        ...
        public interface Builder {
            /**
             * @param bcpPacketSize The maximum size of the packets (in bytes) used to transfer data
             *   using BCP.
             */
             ...
             *   When the replication task starts, all the internal AWS DMS control tables (awsdms_
             *   apply_exception, awsdms_apply, awsdms_changes) are created for the specified file
             *   group.
             */
             ...
             *   replication instance when a mismatch occurs. An example is a situation where
             *   running an alter DDL statement on a table might result in different information
            ...
            /**
             * @param readBackupOnly When this attribute is set to `Y` , AWS DMS only reads changes
             *   from transaction log backups and doesn't read from the active transaction log file
             *   during ongoing replication. Setting this parameter to `Y` enables you to control
             *   active transaction log file growth during full load and ongoing replication tasks.
            ...
            /**
             * @param safeguardPolicy Use this attribute to minimize the need to access the backup
             *   log and enable AWS DMS to prevent truncation using one of the following two
             *   methods. *Start transactions in the database:* This is the default method. When
             *   this method is used, AWS DMS prevents TLOG truncation by mimicking a transaction in
             ...
             *
             * *Exclusively use sp_repldone within a single task* : When this method is used, AWS
             * DMS reads the changes and then uses sp_repldone to mark the TLOG transactions as
             * ready for truncation. Although this method doesn't involve any transactional
             * activities, it can only be used when Microsoft Replication isn't running. Also, when
             * using this method, only one AWS DMS task can access the database at any given time.
             * Therefore, if you need to run parallel AWS DMS tasks against the same database, use
             * the default method.
             */
            ...
            /**
             * @param secretsManagerSecretId The full ARN, partial ARN, or display name of the
             *   `SecretsManagerSecret` that contains the MicrosoftSQLServer endpoint connection
             *   details.
             */
            public fun secretsManagerSecretId(secretsManagerSecretId: String)

            /**
             * @param serverName Fully qualified domain name of the endpoint. For an Amazon RDS SQL
            ...
            /**
             * @param trimSpaceInChar Use the `TrimSpaceInChar` source endpoint setting to
             *   right-trim data on CHAR and NCHAR data types during migration. Setting
             *   `TrimSpaceInChar` does not left-trim data. The default value is `true` .
             */
            ...
            /**
             * @param useBcpFullLoad Use this to attribute to transfer data for full-load operations
             *   using BCP. When the target table contains an identity column that does not exist in
        ...
        private class BuilderImpl : Builder {
            ...
            override fun useThirdPartyBackupDevice(useThirdPartyBackupDevice: IResolvable) {
                cdkBuilder.useThirdPartyBackupDevice(
                    useThirdPartyBackupDevice.let(IResolvable::unwrap)
                )
            }
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-dms-endpoint-microsoftsqlserversettings.html#cfn-dms-endpoint-microsoftsqlserversettings-controltablesfilegroup)
             */
            override fun controlTablesFileGroup(): String? =
             ...
             * mismatch occurs.
             *
             * An example is a situation where running an alter DDL statement on a table might
             ...
             * replication.
             *
             * Setting this parameter to `Y` enables you to control active transaction log file
             * growth during full load and ongoing replication tasks. However, it can add some
             ...
             *
             * The role must allow the `iam:PassRole` action. `SecretsManagerSecret` has the value
             * of the AWS Secrets Manager secret that allows access to the SQL Server endpoint.
             *
             * You can specify one of two sets of values for these permissions. You can specify the
             * values for this setting and `SecretsManagerSecretId` . Or you can specify clear-text
             * values for `UserName` , `Password` , `ServerName` , and `Port` . You can't specify
            ...
            /**
             * The full ARN, partial ARN, or display name of the `SecretsManagerSecret` that
             * contains the MicrosoftSQLServer endpoint connection details.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-dms-endpoint-microsoftsqlserversettings.html#cfn-dms-endpoint-microsoftsqlserversettings-secretsmanagersecretid)
             */
            override fun secretsManagerSecretId(): String? =
             ...
             * NCHAR data types during migration.
             *
             * Setting `TrimSpaceInChar` does not left-trim data. The default value is `true` .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-dms-endpoint-microsoftsqlserversettings.html#cfn-dms-endpoint-microsoftsqlserversettings-trimspaceinchar)
            ...
            /**
             * When this attribute is set to `Y` , DMS processes third-party transaction log backups
             * if they are created in native format.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-dms-endpoint-microsoftsqlserversettings.html#cfn-dms-endpoint-microsoftsqlserversettings-usethirdpartybackupdevice)
             */
            override fun useThirdPartyBackupDevice(): Any? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: MicrosoftSqlServerSettingsProperty
            ): software.amazon.awscdk.services.dms.CfnEndpoint.MicrosoftSqlServerSettingsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface IbmDb2SettingsProperty {
        ...
        /**
         * The full ARN, partial ARN, or display name of the `SecretsManagerSecret` that contains
         * the IBMDB2 endpoint connection details.
         *
        ...
        public interface Builder {
            /**
             * @param currentLsn For ongoing replication (CDC), use CurrentLSN to specify a log
            ...
            /**
             * @param keepCsvFiles If true, AWS DMS saves any .csv files to the Db2 LUW target that
             *   were used to replicate data. DMS uses these files for analysis and troubleshooting.
             *   The default value is false.
             */
            ...
            /**
             * @param loadTimeout The amount of time (in milliseconds) before AWS DMS times out
             *   operations performed by DMS on the Db2 target. The default value is 1200 (20
             *   minutes).
             */
            public fun loadTimeout(loadTimeout: Number)

            /**
             * @param maxFileSize Specifies the maximum size (in KB) of .csv files used to transfer
             *   data to Db2 LUW.
             */
            public fun maxFileSize(maxFileSize: Number)

            /**
             * @param maxKBytesPerRead Maximum number of bytes per read, as a NUMBER value. The
             *   default is 64 KB.
             */
             ...
             *   role that specifies AWS DMS as the trusted entity and grants the required
             *   permissions to access the value in `SecretsManagerSecret` . The role must allow the
             *   `iam:PassRole` action. `SecretsManagerSecret` has the value ofthe AWS Secrets
             ...
             *   generating .csv files on the local disk on the DMS replication instance. The
        ...
        internal constructor(
            ...
            /**
             * If true, AWS DMS saves any .csv files to the Db2 LUW target that were used to
            ...
            /**
             * The amount of time (in milliseconds) before AWS DMS times out operations performed by
             * DMS on the Db2 target.
             *
             * The default value is 1200 (20 minutes).
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-dms-endpoint-ibmdb2settings.html#cfn-dms-endpoint-ibmdb2settings-loadtimeout)
             ...
             *
             * The role must allow the `iam:PassRole` action. `SecretsManagerSecret` has the value
             * ofthe AWS Secrets Manager secret that allows access to the Db2 LUW endpoint.
             *
             * You can specify one of two sets of values for these permissions. You can specify the
             * values for this setting and `SecretsManagerSecretId` . Or you can specify clear-text
             * values for `UserName` , `Password` , `ServerName` , and `Port` . You can't specify
            ...
            /**
             * The full ARN, partial ARN, or display name of the `SecretsManagerSecret` that
             * contains the IBMDB2 endpoint connection details.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-dms-endpoint-ibmdb2settings.html#cfn-dms-endpoint-ibmdb2settings-secretsmanagersecretid)
             */
            override fun secretsManagerSecretId(): String? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: IbmDb2SettingsProperty
            ): software.amazon.awscdk.services.dms.CfnEndpoint.IbmDb2SettingsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DocDbSettingsProperty {
         ...
         *
         * The role must allow the `iam:PassRole` action. `SecretsManagerSecret` has the value of
         * the AWS Secrets Manager secret that allows access to the DocumentDB endpoint.
         *
         * You can specify one of two sets of values for these permissions. You can specify the
         * values for this setting and `SecretsManagerSecretId` . Or you can specify clear-text
         * values for `UserName` , `Password` , `ServerName` , and `Port` . You can't specify both.
        ...
        public interface Builder {
            /**
             * @param docsToInvestigate Indicates the number of documents to preview to determine
             *   the document organization. Use this setting when `NestingLevel` is set to `"one"` .
             *
             * Must be a positive value greater than `0` . Default value is `1000` .
             */
            ...
            /**
             * @param nestingLevel Specifies either document or table mode. Default value is
             *   `"none"` . Specify `"none"` to use document mode. Specify `"one"` to use table
             *   mode.
             */
        ...
        internal constructor(
             ...
             *
             * The role must allow the `iam:PassRole` action. `SecretsManagerSecret` has the value
             * of the AWS Secrets Manager secret that allows access to the DocumentDB endpoint.
             *
             * You can specify one of two sets of values for these permissions. You can specify the
             * values for this setting and `SecretsManagerSecretId` . Or you can specify clear-text
             * values for `UserName` , `Password` , `ServerName` , and `Port` . You can't specify
    ...
    public interface RedshiftSettingsProperty {
         ...
         * 00/00/00 00:00:00, to be loaded without generating an error.
         *
         ...
         *
         * This parameter should contain the code itself, not the name of a file containing the
         * code.
         *
         ...
         * *BucketFolder/TableID* path. AWS DMS uses the Redshift `COPY` command to upload the .csv
         * files to the target table. The files are deleted once the `COPY` operation has finished.
         * For more information, see
         * [COPY](https://docs.aws.amazon.com/redshift/latest/dg/r_COPY.html) in the *Amazon
         ...
         * table is empty.
         *
         * This applies even if the table columns already have encodings other than `RAW` . If you
         ...
         * NULL. If this parameter is left unset (NULL), it defaults to a format of 'YYYY-MM-DD'.
         * Using `auto` recognizes most strings, even some that aren't supported when you use a date
         * format string.
         *
         ...
         */
        public fun fileTransferUploadStreams(): Number? =
         ...
         *
         * By default, Redshift migrates booleans as `varchar(1)` . You must set this setting on
         ...
         *
         * The role must allow the `iam:PassRole` action. `SecretsManagerSecret` has the value of
         * the AWS Secrets Manager secret that allows access to the Amazon Redshift endpoint.
         *
         * You can specify one of two sets of values for these permissions. You can specify the
         * values for this setting and `SecretsManagerSecretId` . Or you can specify clear-text
         * values for `UserName` , `Password` , `ServerName` , and `Port` . You can't specify both.
         ...
         * The AWS KMS key ID.
         *
         * If you are using `SSE_KMS` for the `EncryptionMode` , provide this key ID. The key that
         * you use needs an attached policy that enables IAM user permissions and allows use of the
         * key.
         *
         ...
         * `'epochmillisecs'` . It defaults to 10. Using `auto` recognizes most strings, even some
         * that aren't supported when you use a time format string.
         *
         ...
         * characters, so that the data fits in the column.
         *
        ...
        public interface Builder {
            /**
             * @param acceptAnyDate A value that indicates to allow any date format, including
             *   invalid formats such as 00/00/00 00:00:00, to be loaded without generating an
            ...
            /**
             * @param afterConnectScript Code to run after connecting. This parameter should contain
             *   the code itself, not the name of a file containing the code.
             */
            public fun afterConnectScript(afterConnectScript: String)

            /**
             * @param bucketFolder An S3 folder where the comma-separated-value (.csv) files are
             *   stored before being uploaded to the target Redshift cluster. For full load mode,
             *   AWS DMS converts source records into .csv files and loads them to the
             *   *BucketFolder/TableID* path. AWS DMS uses the Redshift `COPY` command to upload the
             *   .csv files to the target table. The files are deleted once the `COPY` operation has
             *   finished. For more information, see
             *   [COPY](https://docs.aws.amazon.com/redshift/latest/dg/r_COPY.html) in the *Amazon
             *   Redshift Database Developer Guide* .
             *
             * For change-data-capture (CDC) mode, AWS DMS creates a *NetChanges* table, and loads
             * the .csv files to this *BucketFolder/NetChangesTableID* path.
             */
            public fun bucketFolder(bucketFolder: String)

            /**
             * @param bucketName The name of the intermediate S3 bucket used to store .csv files
             *   before uploading data to Redshift.
             */
            public fun bucketName(bucketName: String)

            /**
             * @param caseSensitiveNames If Amazon Redshift is configured to support case sensitive
             *   schema names, set `CaseSensitiveNames` to `true` . The default is `false` .
             */
             ...
             *   have encodings other than `RAW` . If you set `CompUpdate` to `false` , automatic
             *   compression is disabled and existing column encodings aren't changed. The default
             *   is `true` .
             */
            ...
            /**
             * @param connectionTimeout A value that sets the amount of time to wait (in
             *   milliseconds) before timing out, beginning from when you initially establish a
             *   connection.
             */
             ...
             *   `auto` recognizes most strings, even some that aren't supported when you use a date
             *   format string.
             *
            ...
            /**
             * @param emptyAsNull A value that specifies whether AWS DMS should migrate empty CHAR
             *   and VARCHAR fields as NULL. A value of `true` sets empty CHAR and VARCHAR fields to
             ...
             *   to populate the tables. The default is `false` .
             */
             ...
             *   This parameter accepts a value from 1 through 64. It defaults to 10.
             *
             * The number of parallel streams used to upload a single .csv file to an S3 bucket
             * using S3 Multipart Upload. For more information, see
             * [Multipart upload overview](https://docs.aws.amazon.com/AmazonS3/latest/dev/mpuoverview.html)
             * .
             *
             * `FileTransferUploadStreams` accepts a value from 1 through 64. It defaults to 10.
             ...
             *   operations performed by AWS DMS on a Redshift cluster, such as Redshift COPY,
             *   INSERT, DELETE, and UPDATE.
             */
            public fun loadTimeout(loadTimeout: Number)

            /**
             * @param mapBooleanAsBoolean When true, lets Redshift migrate the boolean type as
             *   boolean. By default, Redshift migrates booleans as `varchar(1)` . You must set this
            ...
            /**
             * @param maxFileSize The maximum size (in KB) of any .csv file used to load data on an
             *   S3 bucket and transfer data to Amazon Redshift. It defaults to 1048576KB (1 GB).
             */
            public fun maxFileSize(maxFileSize: Number)

            /**
             * @param removeQuotes A value that specifies to remove surrounding quotation marks from
             *   strings in the incoming data. All characters within the quotation marks, including
            ...
            /**
             * @param replaceChars A value that specifies to replaces the invalid characters
             *   specified in `ReplaceInvalidChars` , substituting the specified characters instead.
             *   The default is `"?"` .
             */
            ...
            /**
             * @param secretsManagerSecretId The full ARN, partial ARN, or display name of the
             *   `SecretsManagerSecret` that contains the Amazon Redshift endpoint connection
             *   details.
             */
            public fun secretsManagerSecretId(secretsManagerSecretId: String)

            /**
             * @param serverSideEncryptionKmsKeyId The AWS KMS key ID. If you are using `SSE_KMS`
             *   for the `EncryptionMode` , provide this key ID. The key that you use needs an
             *   attached policy that enables IAM user permissions and allows use of the key.
             */
            public fun serverSideEncryptionKmsKeyId(serverSideEncryptionKmsKeyId: String)

            /**
             * @param serviceAccessRoleArn The Amazon Resource Name (ARN) of the IAM role that has
             *   access to the Amazon Redshift service. The role must allow the `iam:PassRole`
             *   action.
             */
            public fun serviceAccessRoleArn(serviceAccessRoleArn: String)
             ...
             *   (case-sensitive), `'timeformat_string'` , `'epochsecs'` , or `'epochmillisecs'` .
             *   It defaults to 10. Using `auto` recognizes most strings, even some that aren't
            ...
            /**
             * @param trimBlanks A value that specifies to remove the trailing white space
             *   characters from a VARCHAR string. This parameter applies only to columns with a
             *   VARCHAR data type. Choose `true` to remove unneeded white space. The default is
             *   `false` .
             */
             ...
             *   appropriate number of characters, so that the data fits in the column. This
             *   parameter applies only to columns with a VARCHAR or CHAR data type, and rows with a
             *   size of 4 MB or less. Choose `true` to truncate data. The default is `false` .
             */
            ...
            /**
             * @param writeBufferSize The size (in KB) of the in-memory file write buffer used when
             *   generating .csv files on the local disk at the DMS replication instance. The
        ...
        internal constructor(
             ...
             * the *BucketFolder/TableID* path. AWS DMS uses the Redshift `COPY` command to upload
             * the .csv files to the target table. The files are deleted once the `COPY` operation
             * has finished. For more information, see
             * [COPY](https://docs.aws.amazon.com/redshift/latest/dg/r_COPY.html) in the *Amazon
             * Redshift Database Developer Guide* .
             *
             * For change-data-capture (CDC) mode, AWS DMS creates a *NetChanges* table, and loads
             ...
             * the table is empty.
             *
             * This applies even if the table columns already have encodings other than `RAW` . If
             * you set `CompUpdate` to `false` , automatic compression is disabled and existing
             ...
             * The date format that you are using.
             *
             * Valid values are `auto` (case-sensitive), your date format string enclosed in quotes,
             * or NULL. If this parameter is left unset (NULL), it defaults to a format of
             * 'YYYY-MM-DD'. Using `auto` recognizes most strings, even some that aren't supported
             ...
             * performed by AWS DMS on a Redshift cluster, such as Redshift COPY, INSERT, DELETE,
             * and UPDATE.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-dms-endpoint-redshiftsettings.html#cfn-dms-endpoint-redshiftsettings-loadtimeout)
             */
             ...
             *
             * The role must allow the `iam:PassRole` action. `SecretsManagerSecret` has the value
             * of the AWS Secrets Manager secret that allows access to the Amazon Redshift endpoint.
             *
             * You can specify one of two sets of values for these permissions. You can specify the
             * values for this setting and `SecretsManagerSecretId` . Or you can specify clear-text
             * values for `UserName` , `Password` , `ServerName` , and `Port` . You can't specify
             ...
             * The AWS KMS key ID.
             *
             * If you are using `SSE_KMS` for the `EncryptionMode` , provide this key ID. The key
             * that you use needs an attached policy that enables IAM user permissions and allows
             * use of the key.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-dms-endpoint-redshiftsettings.html#cfn-dms-endpoint-redshiftsettings-serversideencryptionkmskeyid)
             */
             ...
             *
             * Valid values are `auto` (case-sensitive), `'timeformat_string'` , `'epochsecs'` , or
             * `'epochmillisecs'` . It defaults to 10. Using `auto` recognizes most strings, even
             * some that aren't supported when you use a time format string.
             *
             * If your date and time values use formats different from each other, set this
             * parameter to `auto` .
             *
             ...
             * string.
             *
             * This parameter applies only to columns with a VARCHAR data type. Choose `true` to
             ...
             * characters, so that the data fits in the column.
             *
             * This parameter applies only to columns with a VARCHAR or CHAR data type, and rows
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RedshiftSettingsProperty
            ): software.amazon.awscdk.services.dms.CfnEndpoint.RedshiftSettingsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface MongoDbSettingsProperty {
         ...
         *
         * The role must allow the `iam:PassRole` action. `SecretsManagerSecret` has the value of
         * the AWS Secrets Manager secret that allows access to the MongoDB endpoint.
         *
         * You can specify one of two sets of values for these permissions. You can specify the
         * values for this setting and `SecretsManagerSecretId` . Or you can specify clear-text
         * values for `UserName` , `Password` , `ServerName` , and `Port` . You can't specify both.
        ...
        public interface Builder {
            /**
             * @param authMechanism The authentication mechanism you use to access the MongoDB
             *   source endpoint. For the default value, in MongoDB version 2.x, `"default"` is
             *   `"mongodb_cr"` . For MongoDB version 3.x or later, `"default"` is `"scram_sha_1"` .
             *   This setting isn't used when `AuthType` is set to `"no"` .
             */
             ...
             *   is set to `"no"` . The default is `"admin"` .
             */
            public fun authSource(authSource: String)

            /**
             * @param authType The authentication type you use to access the MongoDB source
             *   endpoint. When set to `"no"` , user name and password parameters are not used and
             *   can be empty.
             */
            ...
            /**
             * @param password The password for the user account you use to access the MongoDB
             *   source endpoint.
             */
            public fun password(password: String)
        ...
        internal constructor(
             ...
             *
             * The role must allow the `iam:PassRole` action. `SecretsManagerSecret` has the value
             * of the AWS Secrets Manager secret that allows access to the MongoDB endpoint.
             *
             * You can specify one of two sets of values for these permissions. You can specify the
             * values for this setting and `SecretsManagerSecretId` . Or you can specify clear-text
             * values for `UserName` , `Password` , `ServerName` , and `Port` . You can't specify
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: MongoDbSettingsProperty
            ): software.amazon.awscdk.services.dms.CfnEndpoint.MongoDbSettingsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface PostgreSqlSettingsProperty {
         ...
         *
         * The role must allow the `iam:PassRole` action. `SecretsManagerSecret` has the value of
         * the AWS Secrets Manager secret that allows access to the PostgreSQL endpoint.
         *
         * You can specify one of two sets of values for these permissions. You can specify the
         * values for this setting and `SecretsManagerSecretId` . Or you can specify clear-text
         * values for `UserName` , `Password` , `ServerName` , and `Port` . You can't specify both.
         ...
         * verifies that the task was created with a valid setting of `CdcStartPosition` . If the
         * specified slot doesn't exist or the task doesn't have a valid `CdcStartPosition` setting,
         * DMS raises an error.
         *
        ...
        public interface Builder {
            /**
             * @param afterConnectScript For use with change data capture (CDC) only, this attribute
             *   has AWS DMS bypass foreign keys and user triggers to reduce the time it takes to
             *   bulk load data. Example: `afterConnectScript=SET
             *   session_replication_role='replica'`
             */
            public fun afterConnectScript(afterConnectScript: String)

            /**
             * @param babelfishDatabaseName The Babelfish for Aurora PostgreSQL database name for
             *   the endpoint.
             */
             ...
             *   PostgreSQL database when the task starts. You can later remove these artifacts.
             *
             ...
             *   PostgreSQL- compatible endpoints that require some additional configuration, such
             *   as Babelfish endpoints.
             */
            public fun databaseMode(databaseMode: String)

            /**
             * @param ddlArtifactsSchema The schema in which the operational DDL database artifacts
             *   are created. Example: `ddlArtifactsSchema=xyzddlschema;`
             */
            public fun ddlArtifactsSchema(ddlArtifactsSchema: String)

            /**
             * @param executeTimeout Sets the client statement timeout for the PostgreSQL instance,
             *   in seconds. The default value is 60 seconds. Example: `executeTimeout=100;`
             */
            public fun executeTimeout(executeTimeout: Number)

            /**
             * @param failTasksOnLobTruncation When set to `true` , this value causes a task to fail
             *   if the actual size of a LOB column is greater than the specified `LobMaxSize` . If
             *   task is set to Limited LOB mode and this option is set to true, the task fails
             *   instead of truncating the LOB data.
             */
            public fun failTasksOnLobTruncation(failTasksOnLobTruncation: Boolean)
             ...
             *   transaction. By doing this, it prevents idle logical replication slots from holding
             *   onto old WAL logs, which can result in storage full situations on the source. This
            ...
            /**
             * @param mapBooleanAsBoolean When true, lets PostgreSQL migrate the boolean type as
             *   boolean. By default, PostgreSQL migrates booleans as `varchar(5)` . You must set
             *   this setting on both the source and target endpoints for it to take effect.
             */
            public fun mapBooleanAsBoolean(mapBooleanAsBoolean: Boolean)
            ...
            /**
             * @param maxFileSize Specifies the maximum size (in KB) of any .csv file used to
             *   transfer data to PostgreSQL. Example: `maxFileSize=512`
             */
            public fun maxFileSize(maxFileSize: Number)
            ...
            /**
             * @param slotName Sets the name of a previously created logical replication slot for a
             *   change data capture (CDC) load of the PostgreSQL source instance. When used with
             *   the `CdcStartPosition` request parameter for the AWS DMS API , this attribute also
             *   makes it possible to use native CDC start points. DMS verifies that the specified
             *   logical replication slot exists before starting the CDC load task. It also verifies
             *   that the task was created with a valid setting of `CdcStartPosition` . If the
             *   specified slot doesn't exist or the task doesn't have a valid `CdcStartPosition`
        ...
        internal constructor(
             ...
             * compatible endpoints that require some additional configuration, such as Babelfish
             * endpoints.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-dms-endpoint-postgresqlsettings.html#cfn-dms-endpoint-postgresqlsettings-databasemode)
             */
             ...
             * The write-ahead log (WAL) heartbeat feature mimics a dummy transaction.
             *
             * By doing this, it prevents idle logical replication slots from holding onto old WAL
             * logs, which can result in storage full situations on the source. This heartbeat keeps
             * `restart_lsn` moving and prevents storage full scenarios.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-dms-endpoint-postgresqlsettings.html#cfn-dms-endpoint-postgresqlsettings-heartbeatenable)
             */
             ...
             * When true, lets PostgreSQL migrate the boolean type as boolean.
             *
             * By default, PostgreSQL migrates booleans as `varchar(5)` . You must set this setting
             * on both the source and target endpoints for it to take effect.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-dms-endpoint-postgresqlsettings.html#cfn-dms-endpoint-postgresqlsettings-mapbooleanasboolean)
             */
            override fun mapBooleanAsBoolean(): Any? = unwrap(this).getMapBooleanAsBoolean()
             ...
             *
             * The role must allow the `iam:PassRole` action. `SecretsManagerSecret` has the value
             * of the AWS Secrets Manager secret that allows access to the PostgreSQL endpoint.
             *
             * You can specify one of two sets of values for these permissions. You can specify the
             * values for this setting and `SecretsManagerSecretId` . Or you can specify clear-text
             * values for `UserName` , `Password` , `ServerName` , and `Port` . You can't specify
             ...
             * capture (CDC) load of the PostgreSQL source instance.
             *
             * When used with the `CdcStartPosition` request parameter for the AWS DMS API , this
             ...
             * also verifies that the task was created with a valid setting of `CdcStartPosition` .
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: PostgreSqlSettingsProperty
            ): software.amazon.awscdk.services.dms.CfnEndpoint.PostgreSqlSettingsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface NeptuneSettingsProperty {
         ...
         * Neptune target database before raising an error.
         *
         * The default is 5.
         *
        ...
        public interface Builder {
             ...
             *   bulk-load of migrated graph data to the Neptune target database before raising an
             *   error. The default is 250.
             */
            public fun errorRetryDuration(errorRetryDuration: Number)

            /**
             * @param iamAuthEnabled If you want IAM authorization enabled for this endpoint, set
             *   this parameter to `true` . Then attach the appropriate IAM policy document to your
            ...
            /**
             * @param maxFileSize The maximum size in kilobytes of migrated graph data stored in a
             *   .csv file before AWS DMS bulk-loads the data to the Neptune target database. The
             *   default is 1,048,576 KB. If the bulk load is successful, AWS DMS clears the bucket,
             *   ready to store the next batch of migrated graph data.
             */
            public fun maxFileSize(maxFileSize: Number)

            /**
             * @param maxRetryCount The number of times for AWS DMS to retry a bulk load of migrated
            ...
            /**
             * @param s3BucketFolder A folder path where you want AWS DMS to store migrated graph
             *   data in the S3 bucket specified by `S3BucketName`.
             */
            public fun s3BucketFolder(s3BucketFolder: String)

            /**
             * @param s3BucketName The name of the Amazon S3 bucket where AWS DMS can temporarily
             *   store migrated graph data in .csv files before bulk-loading it to the Neptune
             *   target database. AWS DMS maps the SQL source data to graph data before storing it
             *   in these .csv files.
             */
            public fun s3BucketName(s3BucketName: String)

            /**
             * @param serviceAccessRoleArn The Amazon Resource Name (ARN) of the service role that
             *   you created for the Neptune target endpoint. The role must allow the `iam:PassRole`
             *   action.
             *
             * For more information, see
             * [Creating an IAM Service Role for Accessing Amazon Neptune as a Target](https://docs.aws.amazon.com/dms/latest/userguide/CHAP_Target.Neptune.html#CHAP_Target.Neptune.ServiceRole)
        ...
        internal constructor(
             ...
             * If the bulk load is successful, AWS DMS clears the bucket, ready to store the next
             * batch of migrated graph data.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-dms-endpoint-neptunesettings.html#cfn-dms-endpoint-neptunesettings-maxfilesize)
             */
            override fun maxFileSize(): Number? = unwrap(this).getMaxFileSize()
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: NeptuneSettingsProperty
            ): software.amazon.awscdk.services.dms.CfnEndpoint.NeptuneSettingsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface KinesisSettingsProperty {
         ...
         * SysBench schema has thousands of tables and each table has only limited range for a
         * primary key. In this case, the same primary key is sent from thousands of tables to the
         * same shard, which causes throttling. The default is `false` .
         *
        ...
        public interface Builder {
            /**
             * @param includeControlDetails Shows detailed control information for table definition,
             *   column definition, and table and column changes in the Kinesis message output. The
             *   default is `false` .
             */
            public fun includeControlDetails(includeControlDetails: Boolean)
            ...
            /**
             * @param includePartitionValue Shows the partition value within the Kinesis message
             *   output, unless the partition type is `schema-table-type` . The default is `false` .
             */
            public fun includePartitionValue(includePartitionValue: Boolean)
             ...
             *   prefix to raw data in hexadecimal format. For example, by default, AWS DMS adds a
             *   '0x' prefix to the LOB column type in hexadecimal format moving from an Oracle
             *   source to an Amazon Kinesis target. Use the `NoHexPrefix` endpoint setting to
             ...
             * @param partitionIncludeSchemaTable Prefixes schema and table names to partition
             *   values, when the partition type is `primary-key-type` . Doing this increases data
             *   distribution among Kinesis shards. For example, suppose that a SysBench schema has
             *   thousands of tables and each table has only limited range for a primary key. In
             *   this case, the same primary key is sent from thousands of tables to the same shard,
            ...
            /**
             * @param serviceAccessRoleArn The Amazon Resource Name (ARN) for the IAM role that AWS
             *   DMS uses to write to the Kinesis data stream. The role must allow the
             *   `iam:PassRole` action.
             */
            public fun serviceAccessRoleArn(serviceAccessRoleArn: String)
        ...
        internal constructor(
            ...
            /**
             * Shows detailed control information for table definition, column definition, and table
             * and column changes in the Kinesis message output.
             *
             * The default is `false` .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-dms-endpoint-kinesissettings.html#cfn-dms-endpoint-kinesissettings-includecontroldetails)
             ...
             * that a SysBench schema has thousands of tables and each table has only limited range
             * for a primary key. In this case, the same primary key is sent from thousands of
             * tables to the same shard, which causes throttling. The default is `false` .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-dms-endpoint-kinesissettings.html#cfn-dms-endpoint-kinesissettings-partitionincludeschematable)
             */
            override fun partitionIncludeSchemaTable(): Any? =
            ...
            /**
             * The Amazon Resource Name (ARN) for the IAM role that AWS DMS uses to write to the
             * Kinesis data stream.
             *
             * The role must allow the `iam:PassRole` action.
             *
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: KinesisSettingsProperty
            ): software.amazon.awscdk.services.dms.CfnEndpoint.KinesisSettingsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ElasticsearchSettingsProperty {
         ...
         * operation stops.
         *
         * To avoid early failure, this counter is only effective after 1,000 records are
        ...
        public interface Builder {
            /**
             * @param endpointUri The endpoint for the OpenSearch cluster. AWS DMS uses HTTPS if a
             *   transport protocol (either HTTP or HTTPS) isn't specified.
             */
            public fun endpointUri(endpointUri: String)

            /**
             * @param errorRetryDuration The maximum number of seconds for which DMS retries failed
             ...
             *   written before a full load operation stops. To avoid early failure, this counter is
             *   only effective after 1,000 records are transferred. OpenSearch also has the concept
        ...
        internal constructor(
             ...
             * To avoid early failure, this counter is only effective after 1,000 records are
             * transferred. OpenSearch also has the concept of error monitoring during the last 10
             * minutes of an Observation Window. If transfer of all records fail in the last 10
             * minutes, the full load operation stops.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-dms-endpoint-elasticsearchsettings.html#cfn-dms-endpoint-elasticsearchsettings-fullloaderrorpercentage)
             */
            override fun fullLoadErrorPercentage(): Number? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ElasticsearchSettingsProperty
            ): software.amazon.awscdk.services.dms.CfnEndpoint.ElasticsearchSettingsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface RedisSettingsProperty {
         ...
         * The `ssl-encryption` option makes an encrypted connection. Optionally, you can identify
         * an Amazon Resource Name (ARN) for an SSL certificate authority (CA) using the
        ...
        public interface Builder {
            /**
             * @param authPassword The password provided with the `auth-role` and `auth-token`
             *   options of the `AuthType` setting for a Redis target endpoint.
             */
            public fun authPassword(authPassword: String)

            /**
             * @param authType The type of authentication to perform when connecting to a Redis
             *   target. Options include `none` , `auth-token` , and `auth-role` . The `auth-token`
             *   option requires an `AuthPassword` value to be provided. The `auth-role` option
             *   requires `AuthUserName` and `AuthPassword` values to be provided.
             */
            public fun authType(authType: String)

            /**
             * @param authUserName The user name provided with the `auth-role` option of the
            ...
            /**
             * @param sslCaCertificateArn The Amazon Resource Name (ARN) for the certificate
             *   authority (CA) that DMS uses to connect to your Redis target endpoint.
             */
            public fun sslCaCertificateArn(sslCaCertificateArn: String)

            /**
             * @param sslSecurityProtocol The connection to a Redis target endpoint using Transport
             *   Layer Security (TLS). Valid values include `plaintext` and `ssl-encryption` . The
             *   default is `ssl-encryption` . The `ssl-encryption` option makes an encrypted
             *   connection. Optionally, you can identify an Amazon Resource Name (ARN) for an SSL
             *   certificate authority (CA) using the `SslCaCertificateArn` setting. If an ARN isn't
             *   given for a CA, DMS uses the Amazon root CA.
             *
             * The `plaintext` option doesn't provide Transport Layer Security (TLS) encryption for
             * traffic between endpoint and database.
             */
        ...
        internal constructor(
             ...
             * authority (CA) using the `SslCaCertificateArn` setting. If an ARN isn't given for a
             * CA, DMS uses the Amazon root CA.
             *
             * The `plaintext` option doesn't provide Transport Layer Security (TLS) encryption for
             * traffic between endpoint and database.
             *
    ...
    public interface GcpMySQLSettingsProperty {
         ...
         *
         * If you need AWS DMS to poll all the nodes in the Always On cluster for transaction
         ...
         * `DatabaseName` request parameter on either the `CreateEndpoint` or `ModifyEndpoint` API
         * call. Specifying `DatabaseName` when you create or modify a MySQL endpoint replicates all
         * the task tables to this single database. For MySQL endpoints, you specify the database
         * only when you specify the schema in the table-mapping rules of the AWS DMS task.
         *
         ...
         *
         * For more information on creating this `SecretsManagerSecret` , the corresponding
         * `SecretsManagerAccessRoleArn` , and the `SecretsManagerSecretId` required to access it,
         * see
         * [Using secrets to access AWS Database Migration Service resources](https://docs.aws.amazon.com/dms/latest/userguide/CHAP_Security.html#security-iam-secretsmanager)
         * in the *AWS Database Migration Service User Guide* .
         *
        ...
        public interface Builder {
            ...
            /**
             * @param cleanSourceMetadataOnMismatch Adjusts the behavior of AWS DMS when migrating
             *   from an SQL Server source database that is hosted as part of an Always On
             *   availability group cluster. If you need AWS DMS to poll all the nodes in the Always
             *   On cluster for transaction backups, set this attribute to `false` .
             */
            public fun cleanSourceMetadataOnMismatch(cleanSourceMetadataOnMismatch: Boolean)
            ...
            /**
             * @param databaseName Database name for the endpoint. For a MySQL source or target
             *   endpoint, don't explicitly specify the database using the `DatabaseName` request
             *   parameter on either the `CreateEndpoint` or `ModifyEndpoint` API call. Specifying
             *   `DatabaseName` when you create or modify a MySQL endpoint replicates all the task
             *   tables to this single database. For MySQL endpoints, you specify the database only
             *   when you specify the schema in the table-mapping rules of the AWS DMS task.
             */
            public fun databaseName(databaseName: String)
             ...
             *
             * For more information on creating this `SecretsManagerSecret` , the corresponding
             * `SecretsManagerAccessRoleArn` , and the `SecretsManagerSecretId` required to access
             * it, see
             * [Using secrets to access AWS Database Migration Service resources](https://docs.aws.amazon.com/dms/latest/userguide/CHAP_Security.html#security-iam-secretsmanager)
             * in the *AWS Database Migration Service User Guide* .
             */
            ...
            /**
             * @param serverTimezone Specifies the time zone for the source MySQL database. Don't
             *   enclose time zones in single quotation marks. Example: `serverTimezone=US/Pacific;`
             */
            public fun serverTimezone(serverTimezone: String)
        ...
        internal constructor(
             ...
             * that is hosted as part of an Always On availability group cluster.
             *
             * If you need AWS DMS to poll all the nodes in the Always On cluster for transaction
             * backups, set this attribute to `false` .
             *
             ...
             * the `DatabaseName` request parameter on either the `CreateEndpoint` or
             * `ModifyEndpoint` API call. Specifying `DatabaseName` when you create or modify a
             * MySQL endpoint replicates all the task tables to this single database. For MySQL
             * endpoints, you specify the database only when you specify the schema in the
             * table-mapping rules of the AWS DMS task.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-dms-endpoint-gcpmysqlsettings.html#cfn-dms-endpoint-gcpmysqlsettings-databasename)
             */
            override fun databaseName(): String? = unwrap(this).getDatabaseName()
             ...
             * `SecretsManagerSecret` has the value of the AWS Secrets Manager secret that allows
            ...
            /**
             * Specifies the time zone for the source MySQL database. Don't enclose time zones in
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: GcpMySQLSettingsProperty
            ): software.amazon.awscdk.services.dms.CfnEndpoint.GcpMySQLSettingsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
