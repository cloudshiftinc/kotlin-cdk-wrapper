...
internal constructor(
    ...
    public companion object {
        ...
        public fun icmp(props: AclIcmp): AclTraffic =
            software.amazon.awscdk.services.ec2.AclTraffic.icmp(props.let(AclIcmp::unwrap))
                .let(AclTraffic::wrap)
        ...
        public fun icmpv6(props: AclIcmp): AclTraffic =
            software.amazon.awscdk.services.ec2.AclTraffic.icmpv6(props.let(AclIcmp::unwrap))
                .let(AclTraffic::wrap)
        ...
        public fun tcpPortRange(startPort: Number, endPort: Number): AclTraffic =
            software.amazon.awscdk.services.ec2.AclTraffic.tcpPortRange(startPort, endPort)
                .let(AclTraffic::wrap)
        ...
        public fun udpPortRange(startPort: Number, endPort: Number): AclTraffic =
            software.amazon.awscdk.services.ec2.AclTraffic.udpPortRange(startPort, endPort)
                .let(AclTraffic::wrap)
