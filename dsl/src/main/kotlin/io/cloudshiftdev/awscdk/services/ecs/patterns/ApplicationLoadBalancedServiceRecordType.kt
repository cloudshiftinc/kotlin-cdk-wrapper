        ...
        internal fun wrap(
            ...
            when (cdkObject) {
                software.amazon.awscdk.services.ecs.patterns
                    .ApplicationLoadBalancedServiceRecordType
                    .ALIAS -> ApplicationLoadBalancedServiceRecordType.ALIAS
                software.amazon.awscdk.services.ecs.patterns
                    .ApplicationLoadBalancedServiceRecordType
                    .CNAME -> ApplicationLoadBalancedServiceRecordType.CNAME
                software.amazon.awscdk.services.ecs.patterns
                    .ApplicationLoadBalancedServiceRecordType
                    .NONE -> ApplicationLoadBalancedServiceRecordType.NONE
            }

        internal fun unwrap(
            wrapped: ApplicationLoadBalancedServiceRecordType
        ): software.amazon.awscdk.services.ecs.patterns.ApplicationLoadBalancedServiceRecordType =
            wrapped.cdkObject
    }
}
