...
internal constructor(
    ...
    public interface Builder {
         ...
         * `rekognition:detectLabels` requires also S3 permissions to read the object on which it
         * must act.
         *
         ...
         *
         * Use in the case where the IAM action name does not match with the API service/action
         * name, e.g. `s3:ListBuckets` requires `s3:ListAllMyBuckets`.
         *
        ...
        /**
         * The resources for the IAM statement that will be added to the state machine role's policy
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.stepfunctions.tasks.CallAwsService.Builder.create(
                scope,
                id
            )
         ...
         *   machine role's policy.
         */
        override fun additionalIamStatements(
            vararg additionalIamStatements: PolicyStatement
        ): Unit = additionalIamStatements(additionalIamStatements.toList())
