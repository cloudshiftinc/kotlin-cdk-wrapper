...
internal constructor(
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.mediapackage.CfnPackagingConfiguration.Builder.create(
                scope,
                id
            )
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnPackagingConfiguration
    ...
    public interface DashPackageProperty {
         ...
         * places your encoder's Sequence Parameter Set (SPS), Picture Parameter Set (PPS), and
         ...
         * (MPD).
         *
         * When set to `NUMBER_WITH_TIMELINE` , a full timeline is presented in each
         * SegmentTemplate, with $Number$ media URLs. When set to `TIME_WITH_TIMELINE` , a full
         * timeline is presented in each SegmentTemplate, with $Time$ media URLs. When set to
         * `NUMBER_WITH_DURATION` , only a duration is included in each SegmentTemplate, with
         * $Number$ media URLs.
         *
        ...
        public interface Builder {
            /**
             * @param dashManifests A list of DASH manifest configurations that are available from
             *   this endpoint.
             */
            ...
            /**
             * @param includeEncoderConfigurationInSegments When
             *   includeEncoderConfigurationInSegments is set to true, AWS Elemental MediaPackage
             *   places your encoder's Sequence Parameter Set (SPS), Picture Parameter Set (PPS),
             *   and Video Parameter Set (VPS) metadata in every video segment instead of in the
             *   init fragment. This lets you use different SPS/PPS/VPS settings for your assets
             ...
             *   fragments are rounded to the nearest multiple of the source segment duration.
             */
            public fun segmentDurationSeconds(segmentDurationSeconds: Number)

            /**
             * @param segmentTemplateFormat Determines the type of SegmentTemplate included in the
             *   Media Presentation Description (MPD). When set to `NUMBER_WITH_TIMELINE` , a full
             *   timeline is presented in each SegmentTemplate, with $Number$ media URLs. When set
             *   to `TIME_WITH_TIMELINE` , a full timeline is presented in each SegmentTemplate,
        ...
        private class BuilderImpl : Builder {
             ...
             *   during content playback.
             */
            override fun includeEncoderConfigurationInSegments(
                includeEncoderConfigurationInSegments: Boolean
            ) {
                cdkBuilder.includeEncoderConfigurationInSegments(
            ...
            override fun includeEncoderConfigurationInSegments(
                ...
                cdkBuilder.includeEncoderConfigurationInSegments(
                    includeEncoderConfigurationInSegments.let(IResolvable::unwrap)
                )
            }
        ...
        internal constructor(
             ...
             * fragment.
             *
             * This lets you use different SPS/PPS/VPS settings for your assets during content
             * playback.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-mediapackage-packagingconfiguration-dashpackage.html#cfn-mediapackage-packagingconfiguration-dashpackage-includeencoderconfigurationinsegments)
             */
    ...
    public interface MssPackageProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param mssManifests A list of Microsoft Smooth manifest configurations that are
        ...
        internal constructor(
            ...
            /**
             * A list of Microsoft Smooth manifest configurations that are available from this
             * endpoint.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-mediapackage-packagingconfiguration-msspackage.html#cfn-mediapackage-packagingconfiguration-msspackage-mssmanifests)
             */
    ...
    public interface HlsEncryptionProperty {
        ...
        public interface Builder {
             ...
             *   32-character string, used with the key for encrypting blocks. If you don't specify
             *   a constant initialization vector (IV), AWS Elemental MediaPackage periodically
             *   rotates the IV.
             */
        ...
        internal constructor(
             ...
             *
             * If you don't specify a constant initialization vector (IV), AWS Elemental
             * MediaPackage periodically rotates the IV.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-mediapackage-packagingconfiguration-hlsencryption.html#cfn-mediapackage-packagingconfiguration-hlsencryption-constantinitializationvector)
             */
    ...
    public interface HlsManifestProperty {
        ...
        public interface Builder {
            /**
             * @param adMarkers This setting controls ad markers in the packaged content. Valid
             *   values:
             * * `NONE` - Omits all SCTE-35 ad markers from the output.
             ...
             *   When enabled, the output includes an additional I-frame only stream, along with the
             *   other tracks.
             */
            public fun includeIframeOnlyStream(includeIframeOnlyStream: Boolean)
             ...
             *   create a unique path to this packaging configuration.
             */
        ...
        internal constructor(
             ...
             * to this packaging configuration.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-mediapackage-packagingconfiguration-hlsmanifest.html#cfn-mediapackage-packagingconfiguration-hlsmanifest-manifestname)
             */
    ...
    public interface DashManifestProperty {
         ...
         *   The MANIFEST value is compatible with source HLS playlists using the SCTE-35 Enhanced
         *   syntax ( `EXT-OATCLS-SCTE35` tags). SCTE-35 Elemental and SCTE-35 Daterange syntaxes
        ...
        public interface Builder {
            ...
            /**
             * @param profile The DASH profile type. When set to `HBBTV_1_5` , the content is
             *   compliant with HbbTV 1.5.
             */
            public fun profile(profile: String)

            /**
             * @param scteMarkersSource The source of scte markers used. Value description:
             * * `SEGMENTS` - The scte markers are sourced from the segments of the ingested
             *   content.
             * * `MANIFEST` - the scte markers are sourced from the manifest of the ingested
             *   content. The MANIFEST value is compatible with source HLS playlists using the
             *   SCTE-35 Enhanced syntax ( `EXT-OATCLS-SCTE35` tags). SCTE-35 Elemental and SCTE-35
        ...
        internal constructor(
             ...
             * Determines the position of some tags in the Media Presentation Description (MPD).
             *
             * When set to `FULL` , elements like `SegmentTemplate` and `ContentProtection` are
    ...
    public interface SpekeKeyProviderProperty {
        ...
        public interface Builder {
             ...
             *   access to the key provider API. Valid format: arn:aws:iam::{accountID}:role/{name}
             */
    ...
    public interface CmafPackageProperty {
        ...
        public interface Builder {
             ...
             *   are rounded to the nearest multiple of the source fragment duration.
             */
            public fun segmentDurationSeconds(segmentDurationSeconds: Number)
        }
