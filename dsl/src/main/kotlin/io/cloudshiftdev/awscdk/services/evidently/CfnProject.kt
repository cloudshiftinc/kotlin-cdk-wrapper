...
internal constructor(
    ...
    public open fun appConfigResource(
        `value`: AppConfigResourceObjectProperty.Builder.() -> Unit
    ...
    public interface Builder {
        /**
         * Use this parameter if the project will use *client-side evaluation powered by AWS
         * AppConfig* .
         *
         * Client-side evaluation allows your application to assign variations to user sessions
         * locally instead of by calling the
         ...
         *
         * This parameter is a structure that contains information about the AWS AppConfig
         * application that will be used as for client-side evaluation.
         *
         ...
         *
         * @param appConfigResource Use this parameter if the project will use *client-side
         *   evaluation powered by AWS AppConfig* .
         */
        ...
        public fun appConfigResource(
            appConfigResource: AppConfigResourceObjectProperty.Builder.() -> Unit
        )

        /**
         * A structure that contains information about where Evidently is to store evaluation events
         * for longer term storage, if you choose to do so.
         *
         * If you choose not to store these events, Evidently deletes them after using them to
         ...
         *
         * @param dataDelivery A structure that contains information about where Evidently is to
    ...
    private class BuilderImpl(
        ...
        override fun appConfigResource(appConfigResource: AppConfigResourceObjectProperty) {
            cdkBuilder.appConfigResource(
                appConfigResource.let(AppConfigResourceObjectProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("5c58780625dbccb6ada80e2fdecd5fa7458ecfa7e3b72b67e9e56897231e88c8")
        override fun appConfigResource(
            appConfigResource: AppConfigResourceObjectProperty.Builder.() -> Unit
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("cb85785ee2aedddaff00d956283467969b245ea062d5a0993529891592acec7a")
        override fun dataDelivery(
            dataDelivery: DataDeliveryObjectProperty.Builder.() -> Unit
        ...
        public fun build(): software.amazon.awscdk.services.evidently.CfnProject =
            cdkBuilder.build()
    }
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnProject
        ): software.amazon.awscdk.services.evidently.CfnProject = wrapped.cdkObject
    }
    ...
    public interface AppConfigResourceObjectProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AppConfigResourceObjectProperty
            ): software.amazon.awscdk.services.evidently.CfnProject.AppConfigResourceObjectProperty =
    ...
    public interface DataDeliveryObjectProperty {
        /**
         * If the project stores evaluation events in CloudWatch Logs , this structure stores the
         * log group name.
         *
        ...
        public interface Builder {
            /**
             * @param logGroup If the project stores evaluation events in CloudWatch Logs , this
             *   structure stores the log group name.
             */
            public fun logGroup(logGroup: String)

            /**
             * @param s3 If the project stores evaluation events in an Amazon S3 bucket, this
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DataDeliveryObjectProperty
            ): software.amazon.awscdk.services.evidently.CfnProject.DataDeliveryObjectProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
