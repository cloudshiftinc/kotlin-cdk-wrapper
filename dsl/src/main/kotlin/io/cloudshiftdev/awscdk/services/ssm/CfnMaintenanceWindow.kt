...
internal constructor(
    ...
    public interface Builder {
        ...
        /**
         * The number of hours before the end of the maintenance window that AWS Systems Manager
         ...
         *
         * @param cutoff The number of hours before the end of the maintenance window that AWS
         ...
         *
         * @param scheduleTimezone The time zone that the scheduled maintenance window executions
         ...
         * environment. For example, you might want to tag a maintenance window to identify the type
         * of tasks it will run, the types of targets, and the environment it will run in.
         *
