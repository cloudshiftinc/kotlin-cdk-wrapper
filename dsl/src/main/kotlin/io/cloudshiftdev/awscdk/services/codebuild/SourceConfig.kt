...
public interface SourceConfig {
    ...
    public interface Builder {
        ...
        public fun buildTriggers(
            buildTriggers: CfnProject.ProjectTriggersProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl : Builder {
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("1cfceff0ac51b0021f8ad41227a9cafc14b8aa237334fd1191424d2aa70f6d22")
        override fun sourceProperty(
            sourceProperty: CfnProject.SourceProperty.Builder.() -> Unit
        ): Unit = sourceProperty(CfnProject.SourceProperty(sourceProperty))
        ...
        public fun build(): software.amazon.awscdk.services.codebuild.SourceConfig =
            cdkBuilder.build()
    }
