...
public enum class PropagatedTagSource(
  ...
  public companion object {
    internal fun wrap(cdkObject: software.amazon.awscdk.services.ecs.PropagatedTagSource):
        PropagatedTagSource = when (cdkObject) {
      software.amazon.awscdk.services.ecs.PropagatedTagSource.SERVICE -> PropagatedTagSource.SERVICE
      software.amazon.awscdk.services.ecs.PropagatedTagSource.TASK_DEFINITION ->
          PropagatedTagSource.TASK_DEFINITION
      software.amazon.awscdk.services.ecs.PropagatedTagSource.NONE -> PropagatedTagSource.NONE
    }

    internal fun unwrap(wrapped: PropagatedTagSource):
