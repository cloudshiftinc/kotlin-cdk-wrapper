...
public interface Behavior {
     ...
     *
     * This value applies only when your custom origin does not add HTTP headers, such as
     ...
     *
     * You must specify exactly one default distribution per CloudFront distribution. The default
    ...
    public interface Builder {
        ...
        public fun forwardedValues(
            forwardedValues: CfnDistribution.ForwardedValuesProperty.Builder.() -> Unit
        )

        /**
         * @param functionAssociations The CloudFront functions to invoke before serving the
         *   contents.
         */
         ...
         *   You must specify exactly one default distribution per CloudFront distribution. The
         *   default behavior is allowed to omit the "path" property.
         */
         ...
         */
        public fun lambdaFunctionAssociations(
            vararg lambdaFunctionAssociations: LambdaFunctionAssociation
        )

        /**
         * @param maxTtl The max amount of time you want objects to stay in the cache before
         *   CloudFront queries your origin.
         */
        public fun maxTtl(maxTtl: Duration)

        /**
         * @param minTtl The minimum amount of time that you want objects to stay in the cache
        ...
        /**
         * @param trustedSigners Trusted signers is how CloudFront allows you to serve private
         *   content. The signers are the account IDs that are allowed to sign cookies/presigned
         *   URLs for this distribution.
         *
         * If you pass a non empty value, all requests for this behavior must be signed (no public
         * access will be allowed)
         *
    ...
    private class BuilderImpl : Builder {
        ...
        override fun forwardedValues(forwardedValues: CfnDistribution.ForwardedValuesProperty) {
            cdkBuilder.forwardedValues(
                forwardedValues.let(CfnDistribution.ForwardedValuesProperty::unwrap)
            )
        }
         ...
         *   distribution behaviour.
         */
        override fun lambdaFunctionAssociations(
            lambdaFunctionAssociations: List<LambdaFunctionAssociation>
        ) {
            cdkBuilder.lambdaFunctionAssociations(
                lambdaFunctionAssociations.map(LambdaFunctionAssociation::unwrap)
            )
        }
        ...
        override fun lambdaFunctionAssociations(
            vararg lambdaFunctionAssociations: LambdaFunctionAssociation
        ): Unit = lambdaFunctionAssociations(lambdaFunctionAssociations.toList())
    ...
    internal constructor(
        ...
        /**
         * The max amount of time you want objects to stay in the cache before CloudFront queries
         * your origin.
         *
         * Default: Duration.seconds(31536000) (one year)
         */
         ...
         * The path this behavior responds to.
         *
         * Required for all non-default behaviors. (The default behavior implicitly has "*" as the
         * path pattern. )
         */
    ...
    public companion object {
        ...
        ): Behavior = Wrapper(cdkObject)

        internal fun unwrap(
            wrapped: Behavior
        ): software.amazon.awscdk.services.cloudfront.Behavior = (wrapped as Wrapper).cdkObject
    }
}
