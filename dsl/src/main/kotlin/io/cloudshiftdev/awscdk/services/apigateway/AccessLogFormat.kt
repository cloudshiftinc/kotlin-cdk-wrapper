...
internal constructor(
    ...
    public companion object {
        public fun clf(): AccessLogFormat =
            software.amazon.awscdk.services.apigateway.AccessLogFormat.clf()
                .let(AccessLogFormat::wrap)

        public fun custom(format: String): AccessLogFormat =
            software.amazon.awscdk.services.apigateway.AccessLogFormat.custom(format)
                .let(AccessLogFormat::wrap)

        public fun jsonWithStandardFields(): AccessLogFormat =
            software.amazon.awscdk.services.apigateway.AccessLogFormat.jsonWithStandardFields()
                .let(AccessLogFormat::wrap)

        public fun jsonWithStandardFields(fields: JsonWithStandardFieldProps): AccessLogFormat =
            software.amazon.awscdk.services.apigateway.AccessLogFormat.jsonWithStandardFields(
                    fields.let(JsonWithStandardFieldProps::unwrap)
                )
                .let(AccessLogFormat::wrap)
        ...
        public fun jsonWithStandardFields(
            fields: JsonWithStandardFieldProps.Builder.() -> Unit
