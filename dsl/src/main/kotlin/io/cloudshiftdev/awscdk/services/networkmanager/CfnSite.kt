...
internal constructor(
    ...
    public interface Builder {
         ...
         * The site location.
         *
         * This information is used for visualization in the Network Manager console. If you specify
         * the address, the latitude and longitude are automatically calculated.
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.networkmanager.CfnSite =
            cdkBuilder.build()
    }
    ...
    public companion object {
        ...
        ): CfnSite = CfnSite(cdkObject)

        internal fun unwrap(
            wrapped: CfnSite
        ): software.amazon.awscdk.services.networkmanager.CfnSite = wrapped.cdkObject
    }
