...
internal constructor(
    ...
    public companion object {
        ...
        public operator fun invoke(
            repository: CloudshiftdevAwscdkServicesEcrIRepository,
            block: Builder.() -> Unit = {}
        ): EcrImageCode {
            val builderImpl =
                BuilderImpl(CloudshiftdevAwscdkServicesEcrIRepository.unwrap(repository))
            return EcrImageCode(builderImpl.apply(block).build())
        }

        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.lambda.EcrImageCode
        ): EcrImageCode = EcrImageCode(cdkObject)

        internal fun unwrap(
            wrapped: EcrImageCode
        ): software.amazon.awscdk.services.lambda.EcrImageCode = wrapped.cdkObject
    }
}
