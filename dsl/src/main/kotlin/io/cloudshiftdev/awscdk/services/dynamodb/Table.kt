...
internal constructor(
    ...
    public open fun addGlobalSecondaryIndex(
        props: GlobalSecondaryIndexProps.Builder.() -> Unit
    ): Unit = addGlobalSecondaryIndex(GlobalSecondaryIndexProps(props))
    ...
    public open fun addLocalSecondaryIndex(
        props: LocalSecondaryIndexProps.Builder.() -> Unit
    ): Unit = addLocalSecondaryIndex(LocalSecondaryIndexProps(props))
     ...
     */
    public open fun autoScaleGlobalSecondaryIndexReadCapacity(
        indexName: String,
        ...
        unwrap(this)
            .autoScaleGlobalSecondaryIndexReadCapacity(
                indexName,
                props.let(EnableScalingProps::unwrap)
            )
            .let(IScalableTableAttribute::wrap)
    ...
    public open fun autoScaleGlobalSecondaryIndexReadCapacity(
        indexName: String,
        props: EnableScalingProps.Builder.() -> Unit
    ): IScalableTableAttribute =
     ...
     * @return An object to configure additional AutoScaling settings for this attribute
     */
    public open fun autoScaleGlobalSecondaryIndexWriteCapacity(
        indexName: String,
        props: EnableScalingProps
    ): IScalableTableAttribute =
        unwrap(this)
    ...
    public open fun autoScaleReadCapacity(props: EnableScalingProps): IScalableTableAttribute =
        unwrap(this)
            .autoScaleReadCapacity(props.let(EnableScalingProps::unwrap))
            .let(IScalableTableAttribute::wrap)
    ...
    public open fun autoScaleReadCapacity(
        props: EnableScalingProps.Builder.() -> Unit
    ...
    public open fun autoScaleWriteCapacity(props: EnableScalingProps): IScalableTableAttribute =
        unwrap(this)
            .autoScaleWriteCapacity(props.let(EnableScalingProps::unwrap))
            .let(IScalableTableAttribute::wrap)
    ...
    public open fun autoScaleWriteCapacity(
        props: EnableScalingProps.Builder.() -> Unit
    ...
    public interface Builder {
         ...
         *
         * **NOTE**: if you set this to `CUSTOMER_MANAGED` and `encryptionKey` is not specified, the
         * key that the Tablet generates for you will be created with default permissions. If you
         * are using CDKv2, these permissions will be sufficient to enable the key for use with
         * DynamoDB tables. If you are using CDKv1, make sure the feature flag
         * `&#64;aws-cdk/aws-kms:defaultKeyPolicies` is set to `true` in your `cdk.json`.
         *
         * Default: - The table is encrypted with an encryption key managed by DynamoDB, and you are
         * not charged any fee for using it.
         *
         * @param encryption Whether server-side encryption with an AWS managed customer master key
         *   is enabled.
         */
         ...
         *
         * This property can only be set if `encryption` is set to
         * `TableEncryption.CUSTOMER_MANAGED`.
         *
         * Default: - If `encryption` is set to `TableEncryption.CUSTOMER_MANAGED` and this property
         * is undefined, a new KMS key will be created and associated with this table. If
         * `encryption` and this property are both undefined, then the table is encrypted with an
         * encryption key managed by DynamoDB, and you are not charged any fee for using it.
         *
         ...
         *
         * @param importSource The properties of data being imported from the S3 bucket source to
         *   the table.
         */
         ...
         *
         * @param replicationTimeout The timeout for a table replication operation in a single
         *   region.
         */
         ...
         * replication will be completed asynchronously. This property is ignored if
         * replicationRegions property is not set.
         *
         * WARNING: DO NOT UNSET this property if adding/removing multiple replicationRegions in one
         * deployment, as CloudFormation only supports one region replication at a time. CDK
         * overcomes this limitation by waiting for replication to finish before starting new
         * replicationRegion.
         *
         * If the custom resource which handles replication has a physical resource ID with the
         * format `region` instead of `tablename-region` (this would happen if the custom resource
         * hasn't received an event since v1.91.0), DO NOT SET this property to false without making
         * a change to the table name. This will cause the existing replicas to be deleted.
         *
         * Default: true
         *
    ...
    private class BuilderImpl(
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("ca2f70bbf86ecde413627217be1d1e3d8fdc03a709cc0c706605cdcb1bf7f7d6")
        override fun importSource(
            importSource: ImportSourceSpecification.Builder.() -> Unit
    ...
    public companion object {
        public fun fromTableArn(
            ...
            software.amazon.awscdk.services.dynamodb.Table.fromTableArn(
        ...
        public fun fromTableAttributes(
            ...
            software.amazon.awscdk.services.dynamodb.Table.fromTableAttributes(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    attrs.let(TableAttributes::unwrap)
                )
                .let(ITable::wrap)
        ...
        public fun fromTableName(
            ...
            software.amazon.awscdk.services.dynamodb.Table.fromTableName(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    tableName
                )
