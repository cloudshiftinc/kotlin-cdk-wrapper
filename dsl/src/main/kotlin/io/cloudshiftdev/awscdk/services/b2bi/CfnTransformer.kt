...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param fileFormat Returns that the currently supported file formats for EDI
         ...
         *
         * @param mappingTemplate Returns a sample EDI document that is used by a transformer as a
         ...
         *
         * @param sampleDocument Returns a sample EDI document that is used by a transformer as a
         *   guide for processing the EDI data.
         */
         ...
         * Returns the state of the newly created transformer.
         *
         * The transformer can be either `active` or `inactive` . For the transformer to be used in
         ...
         * A key-value pair for a specific transformer.
         *
         * Tags are metadata that you can use to search for and group capabilities for various
         * purposes.
         *
