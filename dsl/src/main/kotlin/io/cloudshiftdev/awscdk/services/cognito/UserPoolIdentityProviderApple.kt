...
internal constructor(
     ...
     * [io.cloudshiftdev.awscdk.services.cognito.UserPoolIdentityProviderApple].
     */
    @CdkDslMarker
    public interface Builder {
        ...
        /**
         * The keyId (of the same key, which content has to be later supplied as `privateKey`) for
         * Apple APIs to authenticate the client.
         *
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.cognito.UserPoolIdentityProviderApple.Builder.create(
                scope,
                id
            )
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: UserPoolIdentityProviderApple
