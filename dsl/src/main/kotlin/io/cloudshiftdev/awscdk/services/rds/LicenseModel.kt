...
public enum class LicenseModel(
  ...
  public companion object {
    internal fun wrap(cdkObject: software.amazon.awscdk.services.rds.LicenseModel): LicenseModel =
        when (cdkObject) {
    ...
    internal fun unwrap(wrapped: LicenseModel): software.amazon.awscdk.services.rds.LicenseModel =
        wrapped.cdkObject
  }
}
