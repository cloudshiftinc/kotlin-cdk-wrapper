...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param agentArns The Amazon Resource Names (ARNs) of the agents that are used to connect
         *   to the HDFS cluster.
         */
         ...
         * principal and the encrypted keys.
         *
         * Provide the base64-encoded file text. If `KERBEROS` is specified for `AuthType` , this
         * value is required.
         *
         ...
         * the `krb5.conf` by providing a string of the file's contents or an Amazon S3 presigned
         * URL of the file. If `KERBEROS` is specified for `AuthType` , this value is required.
         *
         ...
         *   information. You can load the `krb5.conf` by providing a string of the file's contents
         *   or an Amazon S3 presigned URL of the file. If `KERBEROS` is specified for `AuthType` ,
         ...
         *
         * @param kerberosPrincipal The Kerberos principal with access to the files and folders on
         *   the HDFS cluster.
         */
         ...
         * directories. The NameNode contains the information to map blocks of data to the
         ...
         * (HDFS) cluster.
         *
         * If `QopConfiguration` isn't specified, `RpcProtection` and `DataTransferProtection`
         * default to `PRIVACY` . If you set `RpcProtection` or `DataTransferProtection` , the other
         * parameter assumes the same value.
         *
         ...
         *
         * @param qopConfiguration The Quality of Protection (QOP) configuration specifies the
         *   Remote Procedure Call (RPC) and data transfer protection settings configured on the
         ...
         *
         * @param replicationFactor The number of DataNodes to replicate the data to when writing to
         *   the HDFS cluster.
         */
    ...
    private class BuilderImpl(
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("1ee2c26ee4fdb27c4be1388e24b497fbc88bb6e95670effebd757ecad371deee")
        override fun qopConfiguration(
            qopConfiguration: QopConfigurationProperty.Builder.() -> Unit
    ...
    public interface NameNodeProperty {
        ...
        public interface Builder {
            /**
             * @param hostname The hostname of the NameNode in the HDFS cluster. This value is the
             *   IP address or Domain Name Service (DNS) name of the NameNode. An agent that's
    ...
    public interface QopConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param dataTransferProtection The data transfer protection setting configured on the
             *   HDFS cluster. This setting corresponds to your `dfs.data.transfer.protection`
             *   setting in the `hdfs-site.xml` file on your Hadoop cluster.
             */
            public fun dataTransferProtection(dataTransferProtection: String)

            /**
             * @param rpcProtection The Remote Procedure Call (RPC) protection setting configured on
             *   the HDFS cluster. This setting corresponds to your `hadoop.rpc.protection` setting
             *   in your `core-site.xml` file on your Hadoop cluster.
             */
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-datasync-locationhdfs-qopconfiguration.html#cfn-datasync-locationhdfs-qopconfiguration-datatransferprotection)
             */
            override fun dataTransferProtection(): String? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: QopConfigurationProperty
            ): software.amazon.awscdk.services.datasync.CfnLocationHDFS.QopConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
