...
internal constructor(
     ...
     *
     * For more information about ARNs and their format, see
    ...
    public interface Builder {
         ...
         * The blockchain network that the `Accessor` token is created for.
         *
         * We recommend using the appropriate `networkType` value for the blockchain network that
         * you are creating the `Accessor` token for. You cannot use the value
         ...
         * * to all existing `Accessor` tokens that were created before the `networkType` property
         *   was introduced.
         *
