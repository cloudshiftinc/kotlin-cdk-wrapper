...
internal constructor(
     ...
     * S3 role ARN.
     */
    public open fun schemaConversionApplicationAttributes(
        `value`: SchemaConversionApplicationAttributesProperty
    ) {
        unwrap(this)
            .setSchemaConversionApplicationAttributes(
                `value`.let(SchemaConversionApplicationAttributesProperty::unwrap)
            )
    }
    ...
    public open fun schemaConversionApplicationAttributes(
        `value`: SchemaConversionApplicationAttributesProperty.Builder.() -> Unit
    ): Unit =
        schemaConversionApplicationAttributes(
            SchemaConversionApplicationAttributesProperty(`value`)
        )
    ...
    public interface Builder {
         ...
         *
         * @param instanceProfileIdentifier The identifier of the instance profile for your
         *   migration project.
         */
         ...
         *
         * @param migrationProjectCreationTime The property describes a creating time of the
         *   migration project.
         * @deprecated this property has been deprecated
         */
        @Deprecated(message = "deprecated in CDK")
         ...
         *
         * @param schemaConversionApplicationAttributes The schema conversion application
         *   attributes, including the Amazon S3 bucket name and Amazon S3 role ARN.
         */
        ...
        public fun schemaConversionApplicationAttributes(
            schemaConversionApplicationAttributes:
                SchemaConversionApplicationAttributesProperty.Builder.() -> Unit
        )
         ...
         * The settings in JSON format for migration rules.
         *
         * Migration rules make it possible for you to change the object names according to the
         * rules that you specify. For example, you can change an object name to lowercase or
    ...
    private class BuilderImpl(
         ...
         *   attributes, including the Amazon S3 bucket name and Amazon S3 role ARN.
         */
        override fun schemaConversionApplicationAttributes(
            schemaConversionApplicationAttributes: IResolvable
        ) {
            cdkBuilder.schemaConversionApplicationAttributes(
                schemaConversionApplicationAttributes.let(IResolvable::unwrap)
            )
        }
        ...
        override fun schemaConversionApplicationAttributes(
            ...
            cdkBuilder.schemaConversionApplicationAttributes(
                schemaConversionApplicationAttributes.let(
                    SchemaConversionApplicationAttributesProperty::unwrap
                )
            )
        }
        ...
        override fun schemaConversionApplicationAttributes(
            ...
            schemaConversionApplicationAttributes(
                SchemaConversionApplicationAttributesProperty(schemaConversionApplicationAttributes)
            )
        ...
        override fun sourceDataProviderDescriptors(sourceDataProviderDescriptors: IResolvable) {
            cdkBuilder.sourceDataProviderDescriptors(
                sourceDataProviderDescriptors.let(IResolvable::unwrap)
            )
        }
         ...
         *   including the name or ARN, and AWS Secrets Manager parameters.
         */
        override fun sourceDataProviderDescriptors(
            vararg sourceDataProviderDescriptors: Any
        ): Unit = sourceDataProviderDescriptors(sourceDataProviderDescriptors.toList())
        ...
        override fun targetDataProviderDescriptors(targetDataProviderDescriptors: IResolvable) {
            cdkBuilder.targetDataProviderDescriptors(
                targetDataProviderDescriptors.let(IResolvable::unwrap)
            )
        }
         ...
         *   including the name or ARN, and AWS Secrets Manager parameters.
         */
        override fun targetDataProviderDescriptors(
            vararg targetDataProviderDescriptors: Any
        ): Unit = targetDataProviderDescriptors(targetDataProviderDescriptors.toList())
        ...
        public fun build(): software.amazon.awscdk.services.dms.CfnMigrationProject =
            cdkBuilder.build()
    }
    ...
    public interface DataProviderDescriptorProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param secretsManagerAccessRoleArn The ARN of the role used to access AWS Secrets
             *   Manager.
             */
            public fun secretsManagerAccessRoleArn(secretsManagerAccessRoleArn: String)

            /**
             * @param secretsManagerSecretId The identifier of the AWS Secrets Manager Secret used
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-dms-migrationproject-dataproviderdescriptor.html#cfn-dms-migrationproject-dataproviderdescriptor-dataprovideridentifier)
             */
            override fun dataProviderIdentifier(): String? =
            ...
            /**
             * The identifier of the AWS Secrets Manager Secret used to store access credentials for
             * the data provider.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-dms-migrationproject-dataproviderdescriptor.html#cfn-dms-migrationproject-dataproviderdescriptor-secretsmanagersecretid)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DataProviderDescriptorProperty
            ): software.amazon.awscdk.services.dms.CfnMigrationProject.DataProviderDescriptorProperty =
    ...
    public interface SchemaConversionApplicationAttributesProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SchemaConversionApplicationAttributesProperty
            ): software.amazon.awscdk.services.dms.CfnMigrationProject.SchemaConversionApplicationAttributesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
