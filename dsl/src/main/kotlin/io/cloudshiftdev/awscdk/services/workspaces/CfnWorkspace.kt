...
internal constructor(
    ...
    public open fun workspaceProperties(
        `value`: WorkspacePropertiesProperty.Builder.() -> Unit
    ): Unit = workspaceProperties(WorkspacePropertiesProperty(`value`))
    ...
    public interface Builder {
         ...
         *
         * @param directoryId The identifier of the AWS Directory Service directory for the
         *   WorkSpace.
         */
         ...
         *
         * @param rootVolumeEncryptionEnabled Indicates whether the data stored on the root volume
         *   is encrypted.
         */
         ...
         *
         * @param userVolumeEncryptionEnabled Indicates whether the data stored on the user volume
         *   is encrypted.
         */
         ...
         *
         * @param volumeEncryptionKey The ARN of the symmetric AWS KMS key used to encrypt data
        ...
        public fun workspaceProperties(
            workspaceProperties: WorkspacePropertiesProperty.Builder.() -> Unit
        )
    }
    ...
    private class BuilderImpl(
        ...
        override fun rootVolumeEncryptionEnabled(rootVolumeEncryptionEnabled: IResolvable) {
            cdkBuilder.rootVolumeEncryptionEnabled(
                rootVolumeEncryptionEnabled.let(IResolvable::unwrap)
            )
        }
        ...
        override fun userVolumeEncryptionEnabled(userVolumeEncryptionEnabled: IResolvable) {
            cdkBuilder.userVolumeEncryptionEnabled(
                userVolumeEncryptionEnabled.let(IResolvable::unwrap)
            )
        }
        ...
        override fun workspaceProperties(workspaceProperties: WorkspacePropertiesProperty) {
            cdkBuilder.workspaceProperties(
                workspaceProperties.let(WorkspacePropertiesProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("9c513f7198f435a1a76ee09cbc2718464f34127212b93b77acf4625ed6f422f3")
        override fun workspaceProperties(
            workspaceProperties: WorkspacePropertiesProperty.Builder.() -> Unit
        ): Unit = workspaceProperties(WorkspacePropertiesProperty(workspaceProperties))

        public fun build(): software.amazon.awscdk.services.workspaces.CfnWorkspace =
            cdkBuilder.build()
    }
    ...
    public interface WorkspacePropertiesProperty {
         ...
         * to be allow-listed to use this value. For more information, see
        ...
        public interface Builder {
            ...
            /**
             * @param rootVolumeSizeGib The size of the root volume. For important information about
            ...
            /**
             * @param runningModeAutoStopTimeoutInMinutes The time after a user logs off when
             *   WorkSpaces are automatically stopped. Configured in 60-minute intervals.
             */
            public fun runningModeAutoStopTimeoutInMinutes(
                runningModeAutoStopTimeoutInMinutes: Number
            )

            /**
             * @param userVolumeSizeGib The size of the user storage. For important information
        ...
        private class BuilderImpl : Builder {
             ...
             *   WorkSpaces are automatically stopped. Configured in 60-minute intervals.
             */
            override fun runningModeAutoStopTimeoutInMinutes(
                runningModeAutoStopTimeoutInMinutes: Number
            ) {
        ...
        internal constructor(
             ...
             * The size of the root volume.
             *
             * For important information about how to modify the size of the root and user volumes,
             * see
             * [Modify a WorkSpace](https://docs.aws.amazon.com/workspaces/latest/adminguide/modify-workspaces.html)
             * .
             *
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: WorkspacePropertiesProperty
            ): software.amazon.awscdk.services.workspaces.CfnWorkspace.WorkspacePropertiesProperty =
