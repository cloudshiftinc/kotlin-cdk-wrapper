...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param dbSubnetGroupName The name for the subnet group. This value is stored as a
         *   lowercase string.
         */
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.docdb.CfnDBSubnetGroup =
            cdkBuilder.build()
    }
