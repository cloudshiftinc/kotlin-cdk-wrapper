...
internal constructor(
    ...
    public open fun initialVersion(
        `value`: DeviceDefinitionVersionProperty.Builder.() -> Unit
    ): Unit = initialVersion(DeviceDefinitionVersionProperty(`value`))
    ...
    public interface Builder {
         ...
         * property types.
         *
         * To associate a device definition version after the device definition is created, create
         * an
         ...
         *
         * @param initialVersion The device definition version to include when the device definition
         *   is created.
         */
        ...
        public fun initialVersion(
            initialVersion: DeviceDefinitionVersionProperty.Builder.() -> Unit
        )
    ...
    public interface DeviceProperty {
        ...
        public interface Builder {
             ...
             *   the device. This X.509 certificate is used to authenticate the device with AWS IoT
             *   and AWS IoT Greengrass services.
             */
            public fun certificateArn(certificateArn: String)

            /**
             * @param id A descriptive or arbitrary ID for the device. This value must be unique
             *   within the device definition version. Maximum length is 128 characters with pattern
             *   `[a-zA-Z0-9:_-]+` .
             */
            public fun id(id: String)

            /**
             * @param syncShadow Indicates whether the device's local shadow is synced with the
             *   cloud automatically.
             */
    ...
    public interface DeviceDefinitionVersionProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DeviceDefinitionVersionProperty
            ): software.amazon.awscdk.services.greengrass.CfnDeviceDefinition.DeviceDefinitionVersionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
