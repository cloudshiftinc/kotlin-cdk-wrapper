...
internal constructor(
    ...
    public interface Builder {
         ...
         * when Amazon S3 considers an object public, see
         ...
         *   to apply to this Multi-Region Access Point.
         */
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnMultiRegionAccessPoint
    ...
    public interface RegionProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param bucketAccountId The AWS account ID that owns the Amazon S3 bucket that's
