...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param apiPassthrough Specifies X.509 certificate information to be included in the
         *   issued certificate. An `APIPassthrough` or `APICSRPassthrough` template variant must be
         *   selected, or else this parameter is ignored.
         */
         ...
         *
         * @param certificateAuthorityArn The Amazon Resource Name (ARN) for the private CA issues
         *   the certificate.
         */
         ...
         *
         * @param certificateSigningRequest The certificate signing request (CSR) for the
         *   certificate.
         */
         ...
         *
         * @param signingAlgorithm The name of the algorithm that will be used to sign the
    ...
    private class BuilderImpl(
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("4a0f3e97e90bcc47dd6dd05629ad56eda48248296dea15b86de83bdfb30aae6c")
        override fun apiPassthrough(
            apiPassthrough: ApiPassthroughProperty.Builder.() -> Unit
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("ef057b0455ab55481fcb02ec9d1a835d1d51f8b02a71a15350ad792b8eca4b82")
        override fun validityNotBefore(
            validityNotBefore: ValidityProperty.Builder.() -> Unit
        ): Unit = validityNotBefore(ValidityProperty(validityNotBefore))

        public fun build(): software.amazon.awscdk.services.acmpca.CfnCertificate =
            cdkBuilder.build()
    }
    ...
    public interface PolicyInformationProperty {
        ...
        public interface Builder {
            /**
             * @param certPolicyId Specifies the object identifier (OID) of the certificate policy
             *   under which the certificate was issued. For more information, see NIST's definition
             *   of
             *   [Object Identifier (OID)](https://docs.aws.amazon.com/https://csrc.nist.gov/glossary/term/Object_Identifier)
             *   .
             */
            ...
            /**
             * @param policyQualifiers Modifies the given `CertPolicyId` with a qualifier. AWS
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: PolicyInformationProperty
            ): software.amazon.awscdk.services.acmpca.CfnCertificate.PolicyInformationProperty =
    ...
    public interface SubjectProperty {
        ...
        public interface Builder {
            /**
             * @param commonName For CA and end-entity certificates in a private PKI, the common
             *   name (CN) can be any string within the length limit. Note: In publicly trusted
             ...
             *   *GivenName* , the first letter of the middle name if one exists, and the first
            ...
            /**
             * @param surname Family name. In the US and the UK, for example, the surname of an
             *   individual is ordered last. In Asian cultures the surname is typically ordered
             *   first.
             */
            public fun surname(surname: String)

            /**
             * @param title A title such as Mr. or Ms., which is pre-pended to the name to refer
        ...
        internal constructor(
             ...
             * Family name.
             *
             * In the US and the UK, for example, the surname of an individual is ordered last. In
    ...
    public interface PolicyQualifierInfoProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param qualifier Defines the qualifier type. AWS Private CA supports the use of a URI
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: PolicyQualifierInfoProperty
            ): software.amazon.awscdk.services.acmpca.CfnCertificate.PolicyQualifierInfoProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CustomExtensionProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param objectIdentifier Specifies the object identifier (OID) of the X.509 extension.
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CustomExtensionProperty
            ): software.amazon.awscdk.services.acmpca.CfnCertificate.CustomExtensionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ApiPassthroughProperty {
         ...
         * Contains information about the certificate subject.
         *
         * The Subject field in the certificate identifies the entity that owns or controls the
         * public key in the certificate. The entity can be a user, computer, device, or service.
         * The Subject must contain an X.500 distinguished name (DN). A DN is a sequence of relative
        ...
        public interface Builder {
            ...
            /**
             * @param subject Contains information about the certificate subject. The Subject field
             *   in the certificate identifies the entity that owns or controls the public key in
             *   the certificate. The entity can be a user, computer, device, or service. The
        ...
        internal constructor(
             ...
             *
             * The Subject field in the certificate identifies the entity that owns or controls the
             * public key in the certificate. The entity can be a user, computer, device, or
             * service. The Subject must contain an X.500 distinguished name (DN). A DN is a
             * sequence of relative distinguished names (RDNs). The RDNs are separated by commas in
             * the certificate.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-acmpca-certificate-apipassthrough.html#cfn-acmpca-certificate-apipassthrough-subject)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ApiPassthroughProperty
            ): software.amazon.awscdk.services.acmpca.CfnCertificate.ApiPassthroughProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ExtensionsProperty {
         ...
         * the certificate.
         *
         * These identities may be included in addition to or in place of the identity in the
        ...
        public interface Builder {
            /**
             * @param certificatePolicies Contains a sequence of one or more policy information
             *   terms, each of which consists of an object identifier (OID) and optional
             *   qualifiers. For more information, see NIST's definition of
             *   [Object Identifier (OID)](https://docs.aws.amazon.com/https://csrc.nist.gov/glossary/term/Object_Identifier)
             *   .
             *
            ...
            /**
             * @param customExtensions Contains a sequence of one or more X.509 extensions, each of
             *   which consists of an object identifier (OID), a base64-encoded value, and the
            ...
            /**
             * @param extendedKeyUsage Specifies additional purposes for which the certified public
             *   key may be used other than basic purposes indicated in the `KeyUsage` extension.
             */
            ...
            /**
             * @param keyUsage Defines one or more purposes for which the key contained in the
            ...
            /**
             * @param subjectAlternativeNames The subject alternative name extension allows
             *   identities to be bound to the subject of the certificate. These identities may be
             *   included in addition to or in place of the identity in the subject field of the
             *   certificate.
             */
        ...
        internal constructor(
             ...
             * of an object identifier (OID) and optional qualifiers.
             *
             * For more information, see NIST's definition of
             * [Object Identifier (OID)](https://docs.aws.amazon.com/https://csrc.nist.gov/glossary/term/Object_Identifier)
             * .
    ...
    public interface ExtendedKeyUsageProperty {
        ...
        private class BuilderImpl : Builder {
             ...
             *   object identifier (OID).
             */
            override fun extendedKeyUsageObjectIdentifier(
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ExtendedKeyUsageProperty
            ): software.amazon.awscdk.services.acmpca.CfnCertificate.ExtendedKeyUsageProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface QualifierProperty {
        ...
        public interface Builder {
            /**
             * @param cpsUri Contains a pointer to a certification practice statement (CPS)
             *   published by the CA.
             */
    ...
    public interface ValidityProperty {
        ...
        public interface Builder {
            /**
             * @param type Specifies whether the `Value` parameter represents days, months, or
             *   years.
             */
