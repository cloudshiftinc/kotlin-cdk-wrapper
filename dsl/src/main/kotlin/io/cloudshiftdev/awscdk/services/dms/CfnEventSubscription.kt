...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.dms.CfnEventSubscription,
    ...
    public interface Builder {
         ...
         *
         * @param snsTopicArn The Amazon Resource Name (ARN) of the Amazon SNS topic created for
         *   event notification.
         */
         ...
         * The type of AWS DMS resource that generates the events.
         *
         * For example, if you want to be notified of events generated by a replication instance,
         * you set this parameter to `replication-instance` . If this value isn't specified, all
         * events are returned.
         *
    ...
    public companion object {
        ...
        ): software.amazon.awscdk.services.dms.CfnEventSubscription = wrapped.cdkObject
    }
}
