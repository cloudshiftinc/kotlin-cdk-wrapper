...
internal constructor(
    ...
    public interface Builder {
        /**
         * Amount of time in seconds after a contact ends that you’d like to receive a Ground
         * Station Contact State Change indicating the pass has finished.
         *
        ...
        /**
         * Amount of time in seconds prior to contact start that you'd like to receive a Ground
         ...
         *
         * @param contactPrePassDurationSeconds Amount of time in seconds prior to contact start
         *   that you'd like to receive a Ground Station Contact State Change Event indicating an
         *   upcoming pass.
         */
        ...
        /**
         * Minimum length of a contact in seconds that Ground Station will return when listing
         * contacts.
         *
         ...
         *
         * @param minimumViableContactDurationSeconds Minimum length of a contact in seconds that
         *   Ground Station will return when listing contacts.
         */
         ...
         *
         * @param streamsKmsRole The ARN of the KMS Key or Alias Key role used to define permissions
         *   on KMS Key usage.
         */
        ...
        /**
         * The ARN of a tracking config objects that defines how to track the satellite through the
         * sky during a contact.
         *
         ...
         *
         * @param trackingConfigArn The ARN of a tracking config objects that defines how to track
         *   the satellite through the sky during a contact.
         */
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.groundstation.CfnMissionProfile.Builder.create(
                scope,
                id
            )
         ...
         *   Ground Station will return when listing contacts.
         */
        override fun minimumViableContactDurationSeconds(
    ...
    public interface DataflowEdgeProperty {
        ...
        public interface Builder {
            /**
             * @param destination The ARN of the destination for this dataflow edge. For example,
             *   specify the ARN of a dataflow endpoint config for a downlink edge or an antenna
             *   uplink config for an uplink edge.
             */
            public fun destination(destination: String)

            /**
             * @param source The ARN of the source for this dataflow edge. For example, specify the
             *   ARN of an antenna downlink config for a downlink edge or a dataflow endpoint config
             *   for an uplink edge.
             */
