...
internal constructor(
    ...
    public open fun identityProviderDetails(`value`: IdentityProviderDetailsProperty) {
        unwrap(this)
            .setIdentityProviderDetails(`value`.let(IdentityProviderDetailsProperty::unwrap))
    }
    ...
    public open fun identityProviderDetails(
        `value`: IdentityProviderDetailsProperty.Builder.() -> Unit
    ): Unit = identityProviderDetails(IdentityProviderDetailsProperty(`value`))
    ...
    public interface Builder {
         ...
         *
         * @param endpointDetails The virtual private cloud (VPC) endpoint settings that are
         ...
         * The type of endpoint that you want your server to use.
         *
         * You can choose to make your server's endpoint publicly accessible (PUBLIC) or host it
         * inside your VPC. With an endpoint that is hosted in a VPC, you can restrict access to
         * your server and resources only within your VPC or choose to make it internet facing by
         * attaching Elastic IP addresses directly to it.
         *
         * After May 19, 2021, you won't be able to create a server using
         * `EndpointType=VPC_ENDPOINT` in your AWS account if your account hasn't already done so
         * before May 19, 2021. If you have already created servers with `EndpointType=VPC_ENDPOINT`
         * in your AWS account on or before May 19, 2021, you will not be affected. After this date,
         ...
         * `AWS_DIRECTORY_SERVICE` or invoke a customer-supplied authentication API, including the
         * API Gateway URL. Not required when `IdentityProviderType` is set to `SERVICE_MANAGED` .
         *
        ...
        public fun identityProviderDetails(
            identityProviderDetails: IdentityProviderDetailsProperty.Builder.() -> Unit
        )
         ...
         * environment or in AWS using AD Connector. This option also requires you to provide a
         * Directory ID by using the `IdentityProviderDetails` parameter.
         *
         ...
         *
         * Use the `AWS_LAMBDA` value to directly use an AWS Lambda function as your identity
         ...
         *
         * @param loggingRole The Amazon Resource Name (ARN) of the AWS Identity and Access
         ...
         *
         * @param postAuthenticationLoginBanner Specifies a string to display when users connect to
         *   a server. This string is displayed after the user authenticates.
         */
         ...
         *   command on a file that you are uploading to an Amazon S3 bucket, use the
         *   `SetStatOption` parameter. To have the AWS Transfer Family server ignore the `SETSTAT`
         *   command and upload files without needing to make any changes to your SFTP client, set
         *   the value to `ENABLE_NO_OP` . If you set the `SetStatOption` parameter to
         *   `ENABLE_NO_OP` , Transfer Family generates a log entry to Amazon CloudWatch Logs, so
         *   that you can determine when the client is making a `SETSTAT` call.
         * * To determine whether your AWS Transfer Family server resumes recent, negotiated
         ...
         *   `IdentityProviderType` can be set any of the supported identity types:
         ...
         *
         * @param s3StorageOptions Specifies whether or not performance for your Amazon S3
         ...
         *
         * @param securityPolicyName Specifies the name of the security policy that is attached to
         *   the server.
         */
         ...
         *
         * @param structuredLogDestinations Specifies the log groups to which your server logs are
         *   sent.
         */
         ...
         * execute on partial upload. A partial upload occurs when a file is open when the session
         * disconnects.
         *
         ...
         *
         * @param workflowDetails Specifies the workflow ID for the workflow to assign and the
    ...
    private class BuilderImpl(
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("bf0a236db158e33b6465b83db4fee875e78a60764aeaeab4a59b5a8275e50fa2")
        override fun endpointDetails(
            endpointDetails: EndpointDetailsProperty.Builder.() -> Unit
        ): Unit = endpointDetails(EndpointDetailsProperty(endpointDetails))
         ...
         *   `AWS_DIRECTORY_SERVICE` , `AWS _LAMBDA` or `API_GATEWAY` .
         */
        override fun identityProviderDetails(
            identityProviderDetails: IdentityProviderDetailsProperty
        ) {
            cdkBuilder.identityProviderDetails(
                identityProviderDetails.let(IdentityProviderDetailsProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("ccc7183bb666df2becd469fea8bddfeb4f843e9946ac8688388de90179b8c491")
        override fun protocolDetails(
            protocolDetails: ProtocolDetailsProperty.Builder.() -> Unit
        ): Unit = protocolDetails(ProtocolDetailsProperty(protocolDetails))
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("b659ec0eca872ff75383846e223a401c1c1166dc943ca76d7852c3201d038157")
        override fun s3StorageOptions(
            s3StorageOptions: S3StorageOptionsProperty.Builder.() -> Unit
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("8ef374116af82579036ffca50924ac903bbdc16964dff47ec56c8af807f752c7")
        override fun workflowDetails(
            workflowDetails: WorkflowDetailsProperty.Builder.() -> Unit
        ): Unit = workflowDetails(WorkflowDetailsProperty(workflowDetails))
    ...
    public companion object {
        ...
        ): CfnServer = CfnServer(cdkObject)

        internal fun unwrap(
            wrapped: CfnServer
        ): software.amazon.awscdk.services.transfer.CfnServer = wrapped.cdkObject
    }
    ...
    public interface ProtocolDetailsProperty {
         ...
         * environment, see
         * [Configuring your FTPS server behind a firewall or NAT with AWS Transfer Family](https://docs.aws.amazon.com/storage/configuring-your-ftps-server-behind-a-firewall-or-nat-with-aws-transfer-family/)
         * .
         *
         * *Special values*
         *
         * The `AUTO` and `0.0.0.0` are special values for the `PassiveIp` parameter. The value
         * `PassiveIp=AUTO` is assigned by default to FTP and FTPS type servers. In this case, the
         * server automatically responds with one of the endpoint IPs within the PASV response.
         ...
         * session ID. This property is available during `CreateServer` and `UpdateServer` calls. If
         * a `TlsSessionResumptionMode` value is not specified during `CreateServer` , it is set to
         * `ENFORCED` by default.
         ...
         *   resumption. The server doesn't reject client data connections that do not perform the
         *   TLS session resumption client processing.
         * * `ENFORCED` : the server processes and accepts clients that are performing TLS session
         *   resumption. The server rejects client data connections that do not perform the TLS
         *   session resumption client processing. Before you set the value to `ENFORCED` , test
         *   your clients.
         *
         ...
         * protocol negotiation. To determine whether or not you can use the `ENFORCED` value, you
        ...
        public interface Builder {
            ...
            /**
             * @param passiveIp Indicates passive mode, for FTP and FTPS protocols. Enter a single
             *   IPv4 address, such as the public IP address of a firewall, router, or load
             *   balancer. For example:
             *
             * `aws transfer update-server --protocol-details PassiveIp=0.0.0.0`
             *
             ...
             *
             * The `AUTO` and `0.0.0.0` are special values for the `PassiveIp` parameter. The value
             * `PassiveIp=AUTO` is assigned by default to FTP and FTPS type servers. In this case,
             * the server automatically responds with one of the endpoint IPs within the PASV
             * response. `PassiveIp=0.0.0.0` has a more unique application for its usage. For
             * example, if you have a High Availability (HA) Network Load Balancer (NLB)
             * environment, where you have 3 subnets, you can only specify a single IP address using
             * the `PassiveIp` parameter. This reduces the effectiveness of having High
             * Availability. In this case, you can specify `PassiveIp=0.0.0.0` . This tells the
             * client to use the same IP address as the Control connection and utilize all AZs for
             * their connections. Note, however, that not all FTP clients support the
             * `PassiveIp=0.0.0.0` response. FileZilla and WinSCP do support it. If you are using
             * other clients, check to see if your client supports the `PassiveIp=0.0.0.0` response.
             */
            public fun passiveIp(passiveIp: String)

            /**
             * @param setStatOption Use the `SetStatOption` to ignore the error that is generated
             *   when the client attempts to use `SETSTAT` on a file you are uploading to an S3
             *   bucket. Some SFTP file transfer clients can attempt to change the attributes of
             *   remote files, including timestamp and permissions, using commands, such as
             *   `SETSTAT` when uploading the file. However, these commands are not compatible with
             ...
             * `SETSTAT` command, and upload files without needing to make any changes to your SFTP
             * client. While the `SetStatOption` `ENABLE_NO_OP` setting ignores the error, it does
             * generate a log entry in Amazon CloudWatch Logs, so you can determine when the client
            ...
            /**
             * @param tlsSessionResumptionMode A property used with Transfer Family servers that use
             *   the FTPS protocol. TLS Session Resumption provides a mechanism to resume or share a
             *   negotiated secret key between the control and data connection for an FTPS session.
             ...
             *   `CreateServer` and `UpdateServer` calls. If a `TlsSessionResumptionMode` value is
             *   not specified during `CreateServer` , it is set to `ENFORCED` by default.
             * * `DISABLED` : the server does not process TLS session resumption client requests and
             *   creates a new TLS session for each request.
             ...
             *   the TLS session resumption client processing. Before you set the value to
             *   `ENFORCED` , test your clients.
             *
             * Not all FTPS clients perform TLS session resumption. So, if you choose to enforce TLS
             * session resumption, you prevent any connections from FTPS clients that don't perform
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-transfer-server-protocoldetails.html#cfn-transfer-server-protocoldetails-as2transports)
             */
            override fun as2Transports(): List<String> =
                unwrap(this).getAs2Transports() ?: emptyList()

            /**
             * Indicates passive mode, for FTP and FTPS protocols.
             *
             * Enter a single IPv4 address, such as the public IP address of a firewall, router, or
             ...
             * A property used with Transfer Family servers that use the FTPS protocol.
             *
             * TLS Session Resumption provides a mechanism to resume or share a negotiated secret
             * key between the control and data connection for an FTPS session.
             * `TlsSessionResumptionMode` determines whether or not the server resumes recent,
             * negotiated sessions through a unique session ID. This property is available during
             * `CreateServer` and `UpdateServer` calls. If a `TlsSessionResumptionMode` value is not
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-transfer-server-protocoldetails.html#cfn-transfer-server-protocoldetails-tlssessionresumptionmode)
             */
            override fun tlsSessionResumptionMode(): String? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ProtocolDetailsProperty
            ): software.amazon.awscdk.services.transfer.CfnServer.ProtocolDetailsProperty =
    ...
    public interface WorkflowDetailsProperty {
        ...
        public interface Builder {
             ...
             *   uploaded. You can attach a workflow to a server that executes whenever there is a
             *   partial upload.
             *
             * A *partial upload* occurs when a file is open when the session disconnects.
             */
            ...
            /**
             * @param onUpload A trigger that starts a workflow: the workflow begins to execute
             *   after a file is uploaded. To remove an associated workflow from a server, you can
             *   provide an empty `OnUpload` object, as in the following example.
             *
             * `aws transfer update-server --server-id s-01234567890abcdef --workflow-details
             * '{"OnUpload":[]}'`
             */
        ...
        internal constructor(
             ...
             * A trigger that starts a workflow if a file is only partially uploaded.
             *
             * You can attach a workflow to a server that executes whenever there is a partial
             * upload.
             *
             * A *partial upload* occurs when a file is open when the session disconnects.
             *
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: WorkflowDetailsProperty
            ): software.amazon.awscdk.services.transfer.CfnServer.WorkflowDetailsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface WorkflowDetailProperty {
        ...
        public interface Builder {
            /**
             * @param executionRole Includes the necessary permissions for S3, EFS, and Lambda
             *   operations that Transfer can assume, so that all workflow steps can operate on the
             *   required resources.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: WorkflowDetailProperty
            ): software.amazon.awscdk.services.transfer.CfnServer.WorkflowDetailProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface S3StorageOptionsProperty {
        ...
        public interface Builder {
            /**
             * @param directoryListingOptimization Specifies whether or not performance for your
             *   Amazon S3 directories is optimized. This is disabled by default. By default, home
             *   directory mappings have a `TYPE` of `DIRECTORY` . If you enable this option, you
             *   would then need to explicitly set the `HomeDirectoryMapEntry` `Type` to `FILE` if
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: S3StorageOptionsProperty
            ): software.amazon.awscdk.services.transfer.CfnServer.S3StorageOptionsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface IdentityProviderDetailsProperty {
        /**
         * The identifier of the AWS Directory Service directory that you want to use as your
         * identity provider.
         *
         ...
         * * `PUBLIC_KEY_AND_PASSWORD` - users must provide both their private key and their
         *   password to connect. The server checks the key first, and then if the key is valid, the
         ...
         */
        public fun sftpAuthenticationMethods(): String? =
        ...
        public interface Builder {
            /**
             * @param directoryId The identifier of the AWS Directory Service directory that you
            ...
            /**
             * @param invocationRole This parameter is only applicable if your
             *   `IdentityProviderType` is `API_GATEWAY` . Provides the type of `InvocationRole`
             ...
             *   providers *only* , you can specify whether to authenticate using a password, SSH
             *   key pair, or both.
             * * `PASSWORD` - users must provide their password to connect.
             * * `PUBLIC_KEY` - users must provide their private key to connect.
             * * `PUBLIC_KEY_OR_PASSWORD` - users can authenticate with either their password or
             *   their key. This is the default value.
             * * `PUBLIC_KEY_AND_PASSWORD` - users must provide both their private key and their
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: IdentityProviderDetailsProperty
            ): software.amazon.awscdk.services.transfer.CfnServer.IdentityProviderDetailsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface EndpointDetailsProperty {
         ...
         *   `SubnetIds` . For example, if you have three subnet IDs, you must also specify three
         ...
         */
        public fun addressAllocationIds(): List<String> =
         ...
         * . To change security groups associated with your server's VPC endpoint after creation,
         * use the Amazon EC2
        ...
        public interface Builder {
            /**
             * @param addressAllocationIds A list of address allocation IDs that are required to
             *   attach an Elastic IP address to your server's endpoint. An address allocation ID
             *   corresponds to the allocation ID of an Elastic IP address. This value can be
             *   retrieved from the `allocationId` field from the Amazon EC2
             ...
             *   `AddressAllocationIds` cannot be updated simultaneously).
             * * `AddressAllocationIds` can't contain duplicates, and must be equal in length to
             *   `SubnetIds` . For example, if you have three subnet IDs, you must also specify
            ...
            /**
             * @param securityGroupIds A list of security groups IDs that are available to attach to
             *   your server's endpoint.
             *
             * This property can only be set when `EndpointType` is set to `VPC` .
             *
            ...
            /**
             * @param subnetIds A list of subnet IDs that are required to host your server endpoint
             *   in your VPC.
             *
             * This property can only be set when `EndpointType` is set to `VPC` .
             */
            ...
            /**
             * @param vpcId The VPC ID of the virtual private cloud in which the server's endpoint
             *   will be hosted.
             *
             * This property can only be set when `EndpointType` is set to `VPC` .
             */
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-transfer-server-endpointdetails.html#cfn-transfer-server-endpointdetails-addressallocationids)
             */
            override fun addressAllocationIds(): List<String> =
                unwrap(this).getAddressAllocationIds() ?: emptyList()
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: EndpointDetailsProperty
            ): software.amazon.awscdk.services.transfer.CfnServer.EndpointDetailsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
