...
internal constructor(
    ...
    public companion object {
        public fun fromKubectlProviderAttributes(
            ...
            software.amazon.awscdk.services.eks.KubectlProvider.fromKubectlProviderAttributes(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    attrs.let(KubectlProviderAttributes::unwrap)
                )
                .let(IKubectlProvider::wrap)
        ...
        public fun fromKubectlProviderAttributes(
            ...
            fromKubectlProviderAttributes(scope, id, KubectlProviderAttributes(attrs))

        public fun orCreate(
            scope: CloudshiftdevConstructsConstruct,
            cluster: ICluster
        ): IKubectlProvider =
            software.amazon.awscdk.services.eks.KubectlProvider.getOrCreate(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
