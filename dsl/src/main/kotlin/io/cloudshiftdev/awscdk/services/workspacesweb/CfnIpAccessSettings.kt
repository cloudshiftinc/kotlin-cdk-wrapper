...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param additionalEncryptionContext Additional encryption context of the IP access
         *   settings.
         */
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.workspacesweb.CfnIpAccessSettings.Builder.create(
                scope,
                id
            )
    ...
    public interface IpRuleProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param ipRange The IP range of the IP rule. This can either be a single IP address or
             *   a range using CIDR notation.
             */
