...
public interface IApplicationListener : IListener, IConnectable {
     ...
     *
     * It is not possible to add a default action to an imported IApplicationListener. In order to
     * add actions to an imported IApplicationListener a `priority` must be provided.
     *
     * @param id
     * @param props
     */
     ...
     *
     * It's possible to add conditions to the TargetGroups added in this way. At least one
     * TargetGroup must be added without conditions.
     *
     * @param id
     * @param props
     */
    ...
    internal constructor(
         ...
         * It's possible to add routing conditions to the Action added in this way.
         *
         * It is not possible to add a default action to an imported IApplicationListener. In order
         * to add actions to an imported IApplicationListener a `priority` must be provided.
         *
         * @param id
         * @param props
         */
         ...
         * This method implicitly creates an ApplicationTargetGroup for the targets involved.
         *
         * It's possible to add conditions to the targets added in this way. At least one set of
         * targets must be added without conditions.
         *
         * @param id
         * @param props
         * @return The newly created target group
        ...
        override fun registerConnectable(connectable: IConnectable, portRange: Port) {
            unwrap(this)
                .registerConnectable(
                    connectable.let(IConnectable::unwrap),
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("bcc196a279cd8df29b10150b2d6fcd0fb653d88666d4c7b6871b5f67e18a087a")
        override fun registerConnectable(
