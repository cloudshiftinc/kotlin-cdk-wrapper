...
internal constructor(
    ...
    public open fun managedPolicies(): List<String> =
        unwrap(this).getManagedPolicies() ?: emptyList()
    ...
    /** A structure that stores the details of the AWS managed policy. */
    public open fun managedPolicies(vararg `value`: String): Unit =
        managedPolicies(`value`.toList())
    ...
    public open fun permissionsBoundary(
        `value`: PermissionsBoundaryProperty.Builder.() -> Unit
    ): Unit = permissionsBoundary(PermissionsBoundaryProperty(`value`))
    ...
    public interface Builder {
         ...
         *
         * @param customerManagedPolicyReferences Specifies the names and paths of the customer
         *   managed policies that you have attached to your permission set.
         */
         ...
         * to set as a permissions boundary.
         *
         * Specify either `CustomerManagedPolicyReference` to use the name and path of a customer
         * managed policy, or `ManagedPolicyArn` to use the ARN of an AWS managed policy. A
         * permissions boundary represents the maximum permissions that any policy can grant your
         ...
         *
         * @param permissionsBoundary Specifies the configuration of the AWS managed or customer
         *   managed policy that you want to set as a permissions boundary.
         */
        ...
        public fun permissionsBoundary(
            permissionsBoundary: PermissionsBoundaryProperty.Builder.() -> Unit
        )
         ...
         *
         * @param sessionDuration The length of time that the application user sessions are valid
    ...
    private class BuilderImpl(
        ...
        override fun customerManagedPolicyReferences(customerManagedPolicyReferences: IResolvable) {
            cdkBuilder.customerManagedPolicyReferences(
                customerManagedPolicyReferences.let(IResolvable::unwrap)
            )
        }
         ...
         *   managed policies that you have attached to your permission set.
         */
        override fun customerManagedPolicyReferences(
            vararg customerManagedPolicyReferences: Any
        ): Unit = customerManagedPolicyReferences(customerManagedPolicyReferences.toList())
        ...
        override fun permissionsBoundary(permissionsBoundary: PermissionsBoundaryProperty) {
            cdkBuilder.permissionsBoundary(
                permissionsBoundary.let(PermissionsBoundaryProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("6b2b281fcd686446b3f09daa41b872dc6e753e0375a9adcd7db672c7edd7a792")
        override fun permissionsBoundary(
            permissionsBoundary: PermissionsBoundaryProperty.Builder.() -> Unit
        ...
        public fun build(): software.amazon.awscdk.services.sso.CfnPermissionSet =
            cdkBuilder.build()
    }
    ...
    public interface PermissionsBoundaryProperty {
        ...
        public interface Builder {
            /**
             * @param customerManagedPolicyReference Specifies the name and path of a customer
             *   managed policy. You must have an IAM policy that matches the name and path in each
            ...
            public fun customerManagedPolicyReference(
                customerManagedPolicyReference:
                    CustomerManagedPolicyReferenceProperty.Builder.() -> Unit
            )

            /**
             * @param managedPolicyArn The AWS managed policy ARN that you want to attach to a
        ...
        private class BuilderImpl : Builder {
             ...
             *   AWS account where you want to deploy your permission set.
             */
            override fun customerManagedPolicyReference(
                customerManagedPolicyReference: IResolvable
            ) {
                cdkBuilder.customerManagedPolicyReference(
                    customerManagedPolicyReference.let(IResolvable::unwrap)
                )
            }
            ...
            override fun customerManagedPolicyReference(
                ...
                cdkBuilder.customerManagedPolicyReference(
                    customerManagedPolicyReference.let(
                        CustomerManagedPolicyReferenceProperty::unwrap
                    )
                )
            }
            ...
            override fun customerManagedPolicyReference(
                ...
                customerManagedPolicyReference(
                    CustomerManagedPolicyReferenceProperty(customerManagedPolicyReference)
                )
        ...
        internal constructor(
             ...
             * Specifies the name and path of a customer managed policy.
             *
             * You must have an IAM policy that matches the name and path in each AWS account where
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: PermissionsBoundaryProperty
            ): software.amazon.awscdk.services.sso.CfnPermissionSet.PermissionsBoundaryProperty =
    ...
    public interface CustomerManagedPolicyReferenceProperty {
         ...
         * deploy your permission set.
         *
         * The default is `/` . For more information, see
        ...
        public interface Builder {
            /**
             * @param name The name of the IAM policy that you have configured in each account where
             *   you want to deploy your permission set.
             */
            public fun name(name: String)

            /**
             * @param path The path to the IAM policy that you have configured in each account where
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CustomerManagedPolicyReferenceProperty
            ): software.amazon.awscdk.services.sso.CfnPermissionSet.CustomerManagedPolicyReferenceProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
