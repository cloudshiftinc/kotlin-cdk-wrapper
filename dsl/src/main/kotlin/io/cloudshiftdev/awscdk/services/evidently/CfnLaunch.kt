...
internal constructor(
    ...
    public open fun executionStatus(
        `value`: ExecutionStatusObjectProperty.Builder.() -> Unit
    ): Unit = executionStatus(ExecutionStatusObjectProperty(`value`))
    ...
    public interface Builder {
        ...
        public fun executionStatus(
            executionStatus: ExecutionStatusObjectProperty.Builder.() -> Unit
        )
         ...
         *
         * @param groups An array of structures that contains the feature and variations that are to
         ...
         * omit `randomizationSalt` , Evidently uses the launch name as the `randomizationsSalt` .
         *
    ...
    public companion object {
        ...
        ): CfnLaunch = CfnLaunch(cdkObject)

        internal fun unwrap(
            wrapped: CfnLaunch
        ): software.amazon.awscdk.services.evidently.CfnLaunch = wrapped.cdkObject
    }
    ...
    public interface LaunchGroupObjectProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param groupName A name for this launch group. It can include up to 127 characters.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: LaunchGroupObjectProperty
            ): software.amazon.awscdk.services.evidently.CfnLaunch.LaunchGroupObjectProperty =
    ...
    public interface ExecutionStatusObjectProperty {
        ...
        /**
         * If you are using AWS CloudFormation to stop this launch, this is an optional field that
         * you can use to record why the launch is being stopped or cancelled.
         *
        ...
        public interface Builder {
            /**
             * @param desiredState If you are using AWS CloudFormation to stop this launch, specify
            ...
            /**
             * @param reason If you are using AWS CloudFormation to stop this launch, this is an
             *   optional field that you can use to record why the launch is being stopped or
             *   cancelled.
             */
            public fun reason(reason: String)

            /**
             * @param status To start the launch now, specify `START` for this parameter. If this
             *   launch is currently running and you want to stop it now, specify `STOP` .
             */
        ...
        internal constructor(
            ...
            /**
             * If you are using AWS CloudFormation to stop this launch, specify either `COMPLETED`
            ...
            /**
             * If you are using AWS CloudFormation to stop this launch, this is an optional field
             * that you can use to record why the launch is being stopped or cancelled.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-evidently-launch-executionstatusobject.html#cfn-evidently-launch-executionstatusobject-reason)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ExecutionStatusObjectProperty
            ): software.amazon.awscdk.services.evidently.CfnLaunch.ExecutionStatusObjectProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface GroupToWeightProperty {
        ...
        public interface Builder {
             ...
             *   allocate 20% of the launch audience to this launch group.
             */
    ...
    public interface MetricDefinitionObjectProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: MetricDefinitionObjectProperty
            ): software.amazon.awscdk.services.evidently.CfnLaunch.MetricDefinitionObjectProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SegmentOverrideProperty {
        ...
        public interface Builder {
            /**
             * @param evaluationOrder A number indicating the order to use to evaluate segment
             *   overrides, if there are more than one. Segment overrides with lower numbers are
             *   evaluated first.
             */
            ...
            /**
             * @param weights The traffic allocation percentages among the feature variations to
             *   assign to this segment. This is a set of key-value pairs. The keys are variation
             *   names. The values represent the amount of traffic to allocate to that variation for
             *   this segment. This is expressed in thousandths of a percent, so a weight of 50000
        ...
        internal constructor(
             ...
             * segment.
             *
             * This is a set of key-value pairs. The keys are variation names. The values represent
             * the amount of traffic to allocate to that variation for this segment. This is
             * expressed in thousandths of a percent, so a weight of 50000 represents 50% of
             * traffic.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-evidently-launch-segmentoverride.html#cfn-evidently-launch-segmentoverride-weights)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SegmentOverrideProperty
            ): software.amazon.awscdk.services.evidently.CfnLaunch.SegmentOverrideProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface StepConfigProperty {
        /**
         * An array of structures that define how much launch traffic to allocate to each launch
         * group during this step of the launch.
         *
        ...
        /**
         * An array of structures that you can use to specify different traffic splits for one or
         * more audience *segments* .
         *
         * A segment is a portion of your audience that share one or more characteristics. Examples
         * could be Chrome browser users, users in Europe, or Firefox browser users in Europe who
        ...
        public interface Builder {
            /**
             * @param groupWeights An array of structures that define how much launch traffic to
             *   allocate to each launch group during this step of the launch.
             */
             ...
             *   traffic splits for one or more audience *segments* . A segment is a portion of your
             *   audience that share one or more characteristics. Examples could be Chrome browser
             *   users, users in Europe, or Firefox browser users in Europe who also fit other
        ...
        internal constructor(
            ...
            /**
             * An array of structures that you can use to specify different traffic splits for one
             * or more audience *segments* .
             *
             * A segment is a portion of your audience that share one or more characteristics.
             * Examples could be Chrome browser users, users in Europe, or Firefox browser users in
             * Europe who also fit other criteria that your application collects, such as age.
             *
             * For more information, see
             * [Use segments to focus your audience](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/CloudWatch-Evidently-segments.html)
             * .
