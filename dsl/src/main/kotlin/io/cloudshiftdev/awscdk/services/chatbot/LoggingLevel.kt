...
public enum class LoggingLevel(
    ...
    public companion object {
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.chatbot.LoggingLevel
        ): LoggingLevel =
            when (cdkObject) {
        ...
        internal fun unwrap(
            wrapped: LoggingLevel
        ): software.amazon.awscdk.services.chatbot.LoggingLevel = wrapped.cdkObject
    }
}
