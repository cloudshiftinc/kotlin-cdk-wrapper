...
internal constructor(
    ...
    public open fun healthEventsConfig(
        `value`: HealthEventsConfigProperty.Builder.() -> Unit
    ): Unit = healthEventsConfig(HealthEventsConfigProperty(`value`))
     ...
     * limit) to another location, such as an Amazon S3 bucket.
     */
    public open fun internetMeasurementsLogDelivery(
        `value`: InternetMeasurementsLogDeliveryProperty
    ) {
        unwrap(this)
            .setInternetMeasurementsLogDelivery(
                `value`.let(InternetMeasurementsLogDeliveryProperty::unwrap)
            )
    }
    ...
    public open fun internetMeasurementsLogDelivery(
        `value`: InternetMeasurementsLogDeliveryProperty.Builder.() -> Unit
     ...
     * (ARNs).
     */
    public open fun resourcesToRemove(): List<String> =
        unwrap(this).getResourcesToRemove() ?: emptyList()
    ...
    public interface Builder {
         ...
         * application, that are the thresholds for when Amazon CloudWatch Internet Monitor creates
         * a health event. You can override the defaults to set a custom threshold for overall
         * performance or availability scores, or both.
         *
         * You can also set thresholds for local health scores,, where Internet Monitor creates a
         * health event when scores cross a threshold for one or more city-networks, in addition to
         * creating an event when an overall score crosses a threshold.
         *
         ...
         *
         * @param healthEventsConfig A complex type with the configuration information that
         *   determines the threshold and other conditions for when Internet Monitor creates a
         *   health event for an overall performance or availability issue, across an application's
         *   geographies.
         */
        ...
        public fun healthEventsConfig(
            healthEventsConfig: HealthEventsConfigProperty.Builder.() -> Unit
        )

        /**
         * Publish internet measurements for a monitor for all city-networks (up to the 500,000
         * service limit) to another location, such as an Amazon S3 bucket.
         *
         ...
         *
         * @param internetMeasurementsLogDelivery Publish internet measurements for a monitor for
         *   all city-networks (up to the 500,000 service limit) to another location, such as an
         *   Amazon S3 bucket.
         */
        ...
        public fun internetMeasurementsLogDelivery(
            internetMeasurementsLogDelivery:
                InternetMeasurementsLogDeliveryProperty.Builder.() -> Unit
        )

        /**
         * The maximum number of city-networks to monitor for your resources.
         *
         * A city-network is the location (city) where clients access your application resources
         * from and the network, such as an internet service provider, that clients access the
         * resources through.
         *
         * For more information, see
         ...
         *
         * Be aware that if you include content in the `Resources` field when you update a monitor,
         * the `ResourcesToAdd` and `ResourcesToRemove` fields must be empty.
         *
         ...
         *
         * @param resources The resources that have been added for the monitor, listed by their
         ...
         *
         * If you add only VPC resources, at least one VPC must have an Internet Gateway attached to
         ...
         *
         * @param resourcesToAdd The resources to include in a monitor, which you provide as a set
         ...
         *
         * @param resourcesToRemove The resources to remove from a monitor, which you provide as a
         ...
         * monitor.
         *
         * You can also, optionally, set a limit for the number of city-networks (client locations
         * and ASNs, typically internet service providers) that Internet Monitor will monitor
         * traffic for. The city-networks maximum limit caps the number of city-networks that
         * Internet Monitor monitors for your application, regardless of the percentage of traffic
    ...
    private class BuilderImpl(
        ...
        override fun healthEventsConfig(healthEventsConfig: HealthEventsConfigProperty) {
            cdkBuilder.healthEventsConfig(
                healthEventsConfig.let(HealthEventsConfigProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("b05a560a3c40f38371339032cfd1a3ffdeb5ffb50a6de313facf159c12d1e230")
        override fun healthEventsConfig(
            healthEventsConfig: HealthEventsConfigProperty.Builder.() -> Unit
        ...
        override fun internetMeasurementsLogDelivery(internetMeasurementsLogDelivery: IResolvable) {
            cdkBuilder.internetMeasurementsLogDelivery(
                internetMeasurementsLogDelivery.let(IResolvable::unwrap)
            )
        }
         ...
         *   Amazon S3 bucket.
         */
        override fun internetMeasurementsLogDelivery(
            internetMeasurementsLogDelivery: InternetMeasurementsLogDeliveryProperty
        ) {
            cdkBuilder.internetMeasurementsLogDelivery(
                internetMeasurementsLogDelivery.let(InternetMeasurementsLogDeliveryProperty::unwrap)
            )
        }
    ...
    public interface InternetMeasurementsLogDeliveryProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: InternetMeasurementsLogDeliveryProperty
            ): software.amazon.awscdk.services.internetmonitor.CfnMonitor.InternetMeasurementsLogDeliveryProperty =
    ...
    public interface HealthEventsConfigProperty {
         ...
         */
        public fun availabilityScoreThreshold(): Number? =
         ...
         *
         * When the overall performance score is at or below this percentage, Internet Monitor
         * creates a health event.
         *
         ...
         */
        public fun performanceScoreThreshold(): Number? =
        ...
        public interface Builder {
            /**
             * @param availabilityLocalHealthEventsConfig The configuration that determines the
             *   threshold and other conditions for when Internet Monitor creates a health event for
             *   a local availability issue.
             */
            ...
            public fun availabilityLocalHealthEventsConfig(
                availabilityLocalHealthEventsConfig:
                    LocalHealthEventsConfigProperty.Builder.() -> Unit
            )

            /**
             * @param availabilityScoreThreshold The health event threshold percentage set for
             *   availability scores. When the overall availability score is at or below this
             *   percentage, Internet Monitor creates a health event.
             */
            public fun availabilityScoreThreshold(availabilityScoreThreshold: Number)

            /**
             * @param performanceLocalHealthEventsConfig The configuration that determines the
             *   threshold and other conditions for when Internet Monitor creates a health event for
             *   a local performance issue.
             */
            public fun performanceLocalHealthEventsConfig(
                performanceLocalHealthEventsConfig: IResolvable
            )
            ...
            /**
             * @param performanceScoreThreshold The health event threshold percentage set for
             *   performance scores. When the overall performance score is at or below this
             *   percentage, Internet Monitor creates a health event.
             */
        ...
        private class BuilderImpl : Builder {
             ...
             *   a local availability issue.
             */
            override fun availabilityLocalHealthEventsConfig(
                availabilityLocalHealthEventsConfig: IResolvable
            ) {
                cdkBuilder.availabilityLocalHealthEventsConfig(
                    availabilityLocalHealthEventsConfig.let(IResolvable::unwrap)
                )
            }
            ...
            override fun availabilityLocalHealthEventsConfig(
                ...
                cdkBuilder.availabilityLocalHealthEventsConfig(
                    availabilityLocalHealthEventsConfig.let(LocalHealthEventsConfigProperty::unwrap)
                )
            }
            ...
            override fun availabilityLocalHealthEventsConfig(
                ...
                availabilityLocalHealthEventsConfig(
                    LocalHealthEventsConfigProperty(availabilityLocalHealthEventsConfig)
                )
             ...
             *   a local performance issue.
             */
            override fun performanceLocalHealthEventsConfig(
                performanceLocalHealthEventsConfig: IResolvable
            ) {
                cdkBuilder.performanceLocalHealthEventsConfig(
                    performanceLocalHealthEventsConfig.let(IResolvable::unwrap)
                )
            }
            ...
            override fun performanceLocalHealthEventsConfig(
                ...
                cdkBuilder.performanceLocalHealthEventsConfig(
                    performanceLocalHealthEventsConfig.let(LocalHealthEventsConfigProperty::unwrap)
                )
            }
            ...
            override fun performanceLocalHealthEventsConfig(
                ...
                performanceLocalHealthEventsConfig(
                    LocalHealthEventsConfigProperty(performanceLocalHealthEventsConfig)
                )
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: HealthEventsConfigProperty
            ): software.amazon.awscdk.services.internetmonitor.CfnMonitor.HealthEventsConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface LocalHealthEventsConfigProperty {
         ...
         * issue before Internet Monitor creates an event when a threshold is crossed for a local
         * health score.
         *
        ...
        public interface Builder {
            /**
             * @param healthScoreThreshold The health event threshold percentage set for a local
             *   health score.
             */
            public fun healthScoreThreshold(healthScoreThreshold: Number)

            /**
             * @param minTrafficImpact The minimum percentage of overall traffic for an application
             *   that must be impacted by an issue before Internet Monitor creates an event when a
             *   threshold is crossed for a local health score. If you don't set a minimum traffic
             *   impact threshold, the default value is 0.01%.
             */
            public fun minTrafficImpact(minTrafficImpact: Number)

            /**
             * @param status The status of whether Internet Monitor creates a health event based on
             *   a threshold percentage set for a local health score. The status can be `ENABLED` or
             *   `DISABLED` .
             */
            public fun status(status: String)
        }
        ...
        internal constructor(
            ...
            /**
             * The minimum percentage of overall traffic for an application that must be impacted by
             * an issue before Internet Monitor creates an event when a threshold is crossed for a
             * local health score.
             *
             * If you don't set a minimum traffic impact threshold, the default value is 0.01%.
             *
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: LocalHealthEventsConfigProperty
            ): software.amazon.awscdk.services.internetmonitor.CfnMonitor.LocalHealthEventsConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface S3ConfigProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param logDeliveryStatus The status of publishing Internet Monitor internet
             *   measurements to an Amazon S3 bucket. The delivery status is `ENABLED` if you choose
             *   to deliver internet measurements to an S3 bucket, and `DISABLED` otherwise.
             */
        ...
        internal constructor(
             ...
             * bucket.
             *
             * The delivery status is `ENABLED` if you choose to deliver internet measurements to an
             * S3 bucket, and `DISABLED` otherwise.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-internetmonitor-monitor-s3config.html#cfn-internetmonitor-monitor-s3config-logdeliverystatus)
             */
