...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param catalogId Catalog id string, not less than 1 or more than 255 bytes long, matching
         *   the
         *   [single-line string pattern](https://docs.aws.amazon.com/lake-formation/latest/dg/aws-lake-formation-api-aws-lake-formation-api-common.html)
         *   .
         */
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.lakeformation.CfnTag =
            cdkBuilder.build()
    }
