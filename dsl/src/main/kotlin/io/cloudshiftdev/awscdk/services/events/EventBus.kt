...
internal constructor(
    ...
    public open fun addToResourcePolicy(
    ...
    public interface Builder {
         ...
         *
         * @param eventBusName The name of the event bus you are creating Note: If 'eventSourceName'
         *   is passed in, you cannot set this.
         */
        public fun eventBusName(eventBusName: String)

        /**
         * The partner event source to associate with this event bus resource Note: If
         * 'eventBusName' is passed in, you cannot set this.
         *
    ...
    public companion object {
        public fun fromEventBusArn(
            ...
            software.amazon.awscdk.services.events.EventBus.fromEventBusArn(
        ...
        public fun fromEventBusAttributes(
            ...
            software.amazon.awscdk.services.events.EventBus.fromEventBusAttributes(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    attrs.let(EventBusAttributes::unwrap)
                )
                .let(IEventBus::wrap)
        ...
        public fun fromEventBusName(
            ...
            software.amazon.awscdk.services.events.EventBus.fromEventBusName(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    eventBusName
                )
        ...
        public fun grantAllPutEvents(grantee: IGrantable): Grant =
            software.amazon.awscdk.services.events.EventBus.grantAllPutEvents(
