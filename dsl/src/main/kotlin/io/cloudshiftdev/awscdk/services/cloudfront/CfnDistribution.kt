...
internal constructor(
    ...
    public open fun distributionConfig(
        `value`: DistributionConfigProperty.Builder.() -> Unit
    ): Unit = distributionConfig(DistributionConfigProperty(`value`))
    ...
    public interface Builder {
        ...
        public fun distributionConfig(
            distributionConfig: DistributionConfigProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
        ...
        override fun distributionConfig(distributionConfig: DistributionConfigProperty) {
            cdkBuilder.distributionConfig(
                distributionConfig.let(DistributionConfigProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("e379aee3bd221f987c8405b941cbd20ab829a4fddd8b607816a784e31c131113")
        override fun distributionConfig(
            distributionConfig: DistributionConfigProperty.Builder.() -> Unit
    ...
    public interface DefaultCacheBehaviorProperty {
         ...
         * behavior.
         *
         * If so, specify `true` ; if not, specify `false` . For more information, see
         ...
         * been updated. The value that you specify applies only when your origin does not add HTTP
         * headers such as `Cache-Control max-age` , `Cache-Control s-maxage` , and `Expires` to
         ...
         * This field is deprecated.
         *
         * We recommend that you use a cache policy or an origin request policy instead of this
         ...
         * CloudFront forwards another request to your origin to determine whether the object has
         * been updated. The value that you specify applies only when your origin adds HTTP headers
         ...
         * `SmoothStreaming` , you can still distribute other content using this cache behavior if
         * the content matches the value of `PathPattern` .
         *
         * Default: - false
         *
         ...
         * signed cookies for all requests that match the cache behavior. The URLs or cookies must
         * be signed with a private key whose corresponding public key is in the key group. The
         ...
         */
        public fun trustedKeyGroups(): List<String> =
            unwrap(this).getTrustedKeyGroups() ?: emptyList()
         ...
         * signed with the private key of a CloudFront key pair in a trusted signer's AWS account .
         ...
         *   status code of 301 (Moved Permanently) to the viewer along with the HTTPS URL. The
        ...
        public interface Builder {
            /**
             * @param allowedMethods A complex type that controls which HTTP methods CloudFront
             *   processes and forwards to your Amazon S3 bucket or your custom origin. There are
             *   three choices:
             * * CloudFront forwards only `GET` and `HEAD` requests.
             * * CloudFront forwards only `GET` , `HEAD` , and `OPTIONS` requests.
             * * CloudFront forwards `GET, HEAD, OPTIONS, PUT, PATCH, POST` , and `DELETE` requests.
            ...
            /**
             * @param cachePolicyId The unique identifier of the cache policy that is attached to
            ...
            /**
             * @param cachedMethods A complex type that controls whether CloudFront caches the
             *   response to requests using the specified HTTP methods. There are two choices:
             * * CloudFront caches responses to `GET` and `HEAD` requests.
             * * CloudFront caches responses to `GET` , `HEAD` , and `OPTIONS` requests.
             *
             * If you pick the second choice for your Amazon S3 Origin, you may need to forward
            ...
            /**
             * @param compress Whether you want CloudFront to automatically compress certain files
             *   for this cache behavior. If so, specify `true` ; if not, specify `false` . For more
             *   information, see
             *   [Serving Compressed Files](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/ServingCompressedFiles.html)
             *   in the *Amazon CloudFront Developer Guide* .
             */
            ...
            /**
             * @param defaultTtl This field is deprecated. We recommend that you use the
             *   `DefaultTTL` field in a cache policy instead of this field. For more information,
             *   see
             *   [Creating cache policies](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/controlling-the-cache-key.html#cache-key-create-cache-policy)
             *   or
             *   [Using the managed cache policies](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/using-managed-cache-policies.html)
             ...
             *   configuration that you want CloudFront to use for encrypting specific fields of
             *   data for the default cache behavior.
             */
            public fun fieldLevelEncryptionId(fieldLevelEncryptionId: String)

            /**
             * @param forwardedValues This field is deprecated. We recommend that you use a cache
             *   policy or an origin request policy instead of this field. For more information, see
             *   [Working with policies](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/working-with-policies.html)
             *   in the *Amazon CloudFront Developer Guide* .
             *
             ...
             * an origin request policy. For more information, see
             * [Creating origin request policies](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/controlling-origin-requests.html#origin-request-create-origin-request-policy)
             * or
             * [Using the managed origin request policies](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/using-managed-origin-request-policies.html)
             * in the *Amazon CloudFront Developer Guide* .
            ...
            /**
             * @param functionAssociations A list of CloudFront functions that are associated with
             *   this cache behavior. Your functions must be published to the `LIVE` stage to
            ...
            /**
             * @param lambdaFunctionAssociations A complex type that contains zero or more
             *   Lambda&#64;Edge function associations for a cache behavior.
             */
            ...
            /**
             * @param maxTtl This field is deprecated. We recommend that you use the `MaxTTL` field
            ...
            /**
             * @param minTtl This field is deprecated. We recommend that you use the `MinTTL` field
             *   in a cache policy instead of this field. For more information, see
             *   [Creating cache policies](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/controlling-the-cache-key.html#cache-key-create-cache-policy)
             *   or
             *   [Using the managed cache policies](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/using-managed-cache-policies.html)
             ...
             * to your origin (under `Headers` , if you specify `1` for `Quantity` and `*` for
             * `Name` ).
             */
            public fun minTtl(minTtl: Number)

            /**
             * @param originRequestPolicyId The unique identifier of the origin request policy that
             *   is attached to the default cache behavior. For more information, see
             *   [Creating origin request policies](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/controlling-origin-requests.html#origin-request-create-origin-request-policy)
             *   or
             *   [Using the managed origin request policies](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/using-managed-origin-request-policies.html)
             *   in the *Amazon CloudFront Developer Guide* .
             ...
             *   configuration that is attached to this cache behavior. For more information, see
             *   [Real-time logs](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/real-time-logs.html)
             *   in the *Amazon CloudFront Developer Guide* .
             */
             ...
             *   Microsoft Smooth Streaming format using the origin that is associated with this
             *   cache behavior. If so, specify `true` ; if not, specify `false` . If you specify
             *   `true` for `SmoothStreaming` , you can still distribute other content using this
            ...
            /**
             * @param targetOriginId The value of `ID` for the origin that you want CloudFront to
             *   route requests to when they use the default cache behavior.
             */
            public fun targetOriginId(targetOriginId: String)

            /**
             * @param trustedKeyGroups A list of key groups that CloudFront can use to validate
             *   signed URLs or signed cookies. When a cache behavior contains trusted key groups,
             *   CloudFront requires signed URLs or signed cookies for all requests that match the
             *   cache behavior. The URLs or cookies must be signed with a private key whose
            ...
            /**
             * @param trustedSigners We recommend using `TrustedKeyGroups` instead of
             *   `TrustedSigners` . A list of AWS account IDs whose public keys CloudFront can use
            ...
            /**
             * @param viewerProtocolPolicy The protocol that viewers can use to access the files in
             *   the origin specified by `TargetOriginId` when a request matches the path pattern in
             ...
             * protocol matches the protocol used previously. For more information, see
             * [Managing Cache Expiration](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/Expiration.html)
             * in the *Amazon CloudFront Developer Guide* .
             */
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("f2f8ad03cda9ea3bdabbeb32d3f74dfffacbde0f8cb9bae3862a79e5b38d9b2e")
            override fun forwardedValues(
                forwardedValues: ForwardedValuesProperty.Builder.() -> Unit
            ...
            override fun lambdaFunctionAssociations(lambdaFunctionAssociations: IResolvable) {
                cdkBuilder.lambdaFunctionAssociations(
                    lambdaFunctionAssociations.let(IResolvable::unwrap)
                )
            }
        ...
        internal constructor(
             ...
             * your Amazon S3 bucket or your custom origin.
             *
             * There are three choices:
             * * CloudFront forwards only `GET` and `HEAD` requests.
             * * CloudFront forwards only `GET` , `HEAD` , and `OPTIONS` requests.
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-cloudfront-distribution-defaultcachebehavior.html#cfn-cloudfront-distribution-defaultcachebehavior-cachedmethods)
             */
            override fun cachedMethods(): List<String> =
                unwrap(this).getCachedMethods() ?: emptyList()
             ...
             * This field is deprecated.
             *
             * We recommend that you use the `DefaultTTL` field in a cache policy instead of this
             * field. For more information, see
             * [Creating cache policies](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/controlling-the-cache-key.html#cache-key-create-cache-policy)
             * or
             * [Using the managed cache policies](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/using-managed-cache-policies.html)
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-cloudfront-distribution-defaultcachebehavior.html#cfn-cloudfront-distribution-defaultcachebehavior-fieldlevelencryptionid)
             */
            override fun fieldLevelEncryptionId(): String? =
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-cloudfront-distribution-defaultcachebehavior.html#cfn-cloudfront-distribution-defaultcachebehavior-lambdafunctionassociations)
             */
            override fun lambdaFunctionAssociations(): Any? =
                unwrap(this).getLambdaFunctionAssociations()

            /**
             * This field is deprecated.
             *
             * We recommend that you use the `MaxTTL` field in a cache policy instead of this field.
             * For more information, see
             * [Creating cache policies](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/controlling-the-cache-key.html#cache-key-create-cache-policy)
             * or
             * [Using the managed cache policies](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/using-managed-cache-policies.html)
             ...
             * This field is deprecated.
             *
             * We recommend that you use the `MinTTL` field in a cache policy instead of this field.
             * For more information, see
             * [Creating cache policies](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/controlling-the-cache-key.html#cache-key-create-cache-policy)
             * or
             * [Using the managed cache policies](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/using-managed-cache-policies.html)
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-cloudfront-distribution-defaultcachebehavior.html#cfn-cloudfront-distribution-defaultcachebehavior-responseheaderspolicyid)
             */
            override fun responseHeadersPolicyId(): String? =
             ...
             *
             * If so, specify `true` ; if not, specify `false` . If you specify `true` for
             * `SmoothStreaming` , you can still distribute other content using this cache behavior
             * if the content matches the value of `PathPattern` .
             *
             * Default: - false
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-cloudfront-distribution-defaultcachebehavior.html#cfn-cloudfront-distribution-defaultcachebehavior-smoothstreaming)
             ...
             * The signed URL or cookie contains information about which public key CloudFront
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-cloudfront-distribution-defaultcachebehavior.html#cfn-cloudfront-distribution-defaultcachebehavior-trustedkeygroups)
             */
            override fun trustedKeyGroups(): List<String> =
                unwrap(this).getTrustedKeyGroups() ?: emptyList()
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-cloudfront-distribution-defaultcachebehavior.html#cfn-cloudfront-distribution-defaultcachebehavior-trustedsigners)
             */
            override fun trustedSigners(): List<String> =
                unwrap(this).getTrustedSigners() ?: emptyList()
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DefaultCacheBehaviorProperty
            ): software.amazon.awscdk.services.cloudfront.CfnDistribution.DefaultCacheBehaviorProperty =
    ...
    public interface CacheBehaviorProperty {
         ...
         * behavior to. When CloudFront receives a viewer request, the requested path is compared
        ...
        public interface Builder {
            ...
            /**
             * @param functionAssociations A list of CloudFront functions that are associated with
             *   this cache behavior. CloudFront functions must be published to the `LIVE` stage to
             *   associate them with a cache behavior.
             */
            public fun functionAssociations(functionAssociations: IResolvable)
             ...
             *   requests to apply the behavior to. When CloudFront receives a viewer request, the
             *   requested path is compared with path patterns in the order in which cache behaviors
             *   are listed in the distribution.
             *
             * You can optionally include a slash ( `/` ) at the beginning of the path pattern. For
             * example, `/images/ *.jpg` . CloudFront behavior is the same with or without the
             * leading `/` .
             *
             * The path pattern for the default cache behavior is `*` and cannot be changed. If the
             * request for an object does not match the path pattern for any cache behaviors,
        ...
        internal constructor(
            ...
            /**
             * The value of `ID` for the origin that you want CloudFront to route requests to when
             * they match this cache behavior.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-cloudfront-distribution-cachebehavior.html#cfn-cloudfront-distribution-cachebehavior-targetoriginid)
             */
            override fun targetOriginId(): String = unwrap(this).getTargetOriginId()
    ...
    public interface CustomErrorResponseProperty {
         ...
         * problem that caused the error has been resolved and the requested object is now
         * available.
         *
         * For more information, see
         ...
         * your origin returns the HTTP status code specified by `ErrorCode` , for example,
         * `/4xx-errors/403-forbidden.html` . If you want to store your objects and your custom
         * error pages in different locations, your distribution must include a cache behavior for
         * which the following is true:.
         * * The value of `PathPattern` matches the path to your custom error messages. For example,
         *   suppose you saved custom error pages for 4xx errors in an Amazon S3 bucket in a
         *   directory named `/4xx-errors` . Your distribution must include a cache behavior for
         *   which the path pattern routes requests for your custom error pages to that location,
         *   for example, `/4xx-errors/ *` .
         * * The value of `TargetOriginId` specifies the value of the `ID` element for the origin
         ...
         * CloudFront can't get the files that you want to return to viewers because the origin
        ...
        public interface Builder {
            /**
             * @param errorCachingMinTtl The minimum amount of time, in seconds, that you want
             *   CloudFront to cache the HTTP status code specified in `ErrorCode` . When this time
             *   period has elapsed, CloudFront queries your origin to see whether the problem that
             *   caused the error has been resolved and the requested object is now available.
             *
             * For more information, see
             * [Customizing Error Responses](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/custom-error-pages.html)
             * in the *Amazon CloudFront Developer Guide* .
            ...
            /**
             * @param errorCode The HTTP status code for which you want to specify a custom error
             *   page and/or a caching duration.
             */
            public fun errorCode(errorCode: Number)

            /**
             * @param responseCode The HTTP status code that you want CloudFront to return to the
             *   viewer along with the custom error page. There are a variety of reasons that you
             *   might want CloudFront to return a status code different from the status code that
             ...
             *   errors, you can specify `400` or `500` as the `ResponseCode` for all 4xx or 5xx
             *   errors.
             ...
             *   return to a viewer when your origin returns the HTTP status code specified by
             *   `ErrorCode` , for example, `/4xx-errors/403-forbidden.html` . If you want to store
             *   your objects and your custom error pages in different locations, your distribution
             ...
             *   in a directory named `/4xx-errors` . Your distribution must include a cache
        ...
        internal constructor(
             ...
             * your origin returns the HTTP status code specified by `ErrorCode` , for example,
             * `/4xx-errors/403-forbidden.html` . If you want to store your objects and your custom
             * error pages in different locations, your distribution must include a cache behavior
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CustomErrorResponseProperty
            ): software.amazon.awscdk.services.cloudfront.CfnDistribution.CustomErrorResponseProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface GeoRestrictionProperty {
         ...
         * content ( `blacklist` ).
         *
         * The `Location` element is a two-letter, uppercase country code for a country that you
         * want to include in your `blacklist` or `whitelist` . Include one `Location` element for
         * each country.
         *
        ...
        public interface Builder {
            /**
             * @param locations A complex type that contains a `Location` element for each country
             ...
             *   two-letter, uppercase country code for a country that you want to include in your
            ...
            /**
             * @param restrictionType The method that you want to use to restrict distribution of
        ...
        internal constructor(
             ...
             *
             * The `Location` element is a two-letter, uppercase country code for a country that you
             * want to include in your `blacklist` or `whitelist` . Include one `Location` element
             * for each country.
             *
             * CloudFront and `MaxMind` both use `ISO 3166` country codes. For the current list of
             * countries and the corresponding codes, see `ISO 3166-1-alpha-2` code on the
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: GeoRestrictionProperty
            ): software.amazon.awscdk.services.cloudfront.CfnDistribution.GeoRestrictionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface S3OriginConfigProperty {
         ...
         *
         * For more information, see
         * [Restricting access to an AWS](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/private-content-restricting-access-to-origin.html)
         * in the *Amazon CloudFront Developer Guide* .
         *
         * The CloudFront origin access identity to associate with the origin. Use an origin access
         * identity to configure the origin so that viewers can *only* access objects in an Amazon
         * S3 bucket through CloudFront. The format of the value is:
         *
        ...
        public interface Builder {
            /**
             * @param originAccessIdentity If you're using origin access control (OAC) instead of
             *   origin access identity, specify an empty `OriginAccessIdentity` element. For more
             *   information, see
             *   [Restricting access to an AWS](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/private-content-restricting-access-to-origin.html)
             *   in the *Amazon CloudFront Developer Guide* .
             *
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: S3OriginConfigProperty
            ): software.amazon.awscdk.services.cloudfront.CfnDistribution.S3OriginConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface LoggingProperty {
         ...
         * for `IncludeCookies` .
         *
         * If you choose to include cookies in logs, CloudFront logs all cookies regardless of how
         * you configure the cache behaviors for this distribution. If you don't want to include
         * cookies when you create a distribution or if you want to disable include cookies for an
        ...
        public interface Builder {
            ...
            /**
             * @param includeCookies Specifies whether you want CloudFront to include cookies in
             *   access logs, specify `true` for `IncludeCookies` . If you choose to include cookies
             *   in logs, CloudFront logs all cookies regardless of how you configure the cache
             *   behaviors for this distribution. If you don't want to include cookies when you
             *   create a distribution or if you want to disable include cookies for an existing
        ...
        internal constructor(
             ...
             * `true` for `IncludeCookies` .
             *
             * If you choose to include cookies in logs, CloudFront logs all cookies regardless of
             * how you configure the cache behaviors for this distribution. If you don't want to
    ...
    public interface CookiesProperty {
         ...
         */
        public fun whitelistedNames(): List<String> =
            unwrap(this).getWhitelistedNames() ?: emptyList()

        /** A builder for [CookiesProperty] */
        @CdkDslMarker
        public interface Builder {
            /**
             * @param forward This field is deprecated. We recommend that you use a cache policy or
             ...
             * or the list of cookies specified in the `WhitelistedNames` complex type.
             *
             * Amazon S3 doesn't process cookies. When the cache behavior is forwarding requests to
             * an Amazon S3 origin, specify none for the `Forward` element.
             */
            public fun forward(forward: String)

            /**
             * @param whitelistedNames This field is deprecated. We recommend that you use a cache
             *   policy or an origin request policy instead of this field.
             *
             * If you want to include cookies in the cache key, use a cache policy. For more
             * information, see
             * [Creating cache policies](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/controlling-the-cache-key.html#cache-key-create-cache-policy)
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-cloudfront-distribution-cookies.html#cfn-cloudfront-distribution-cookies-whitelistednames)
             */
            override fun whitelistedNames(): List<String> =
                unwrap(this).getWhitelistedNames() ?: emptyList()
        }
    ...
    public interface FunctionAssociationProperty {
        ...
        public interface Builder {
             ...
             *   `viewer-response` . You cannot use origin-facing event types ( `origin-request` and
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: FunctionAssociationProperty
            ): software.amazon.awscdk.services.cloudfront.CfnDistribution.FunctionAssociationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CustomOriginConfigProperty {
         ...
         *
         * This is also known as the *origin response timeout* . The minimum timeout is 1 second,
        ...
        public fun originSslProtocols(): List<String> =
            unwrap(this).getOriginSslProtocols() ?: emptyList()

        /** A builder for [CustomOriginConfigProperty] */
        @CdkDslMarker
        public interface Builder {
            /**
             * @param httpPort The HTTP port that CloudFront uses to connect to the origin. Specify
             ...
             *   connection to the origin. The minimum timeout is 1 second, the maximum is 60
             *   seconds, and the default (if you don't specify otherwise) is 5 seconds.
             *
             * For more information, see
             * [Origin Keep-alive Timeout](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/distribution-web-values-specify.html#DownloadDistValuesOriginKeepaliveTimeout)
             * in the *Amazon CloudFront Developer Guide* .
            ...
            /**
             * @param originProtocolPolicy Specifies the protocol (HTTP or HTTPS) that CloudFront
             *   uses to connect to the origin. Valid values are:.
             * * `http-only` – CloudFront always uses HTTP to connect to the origin.
             * * `match-viewer` – CloudFront connects to the origin using the same protocol that the
             *   viewer used to connect to CloudFront.
             * * `https-only` – CloudFront always uses HTTPS to connect to the origin.
            ...
            /**
             * @param originReadTimeout Specifies how long, in seconds, CloudFront waits for a
             *   response from the origin. This is also known as the *origin response timeout* . The
             *   minimum timeout is 1 second, the maximum is 60 seconds, and the default (if you
            ...
            /**
             * @param originSslProtocols Specifies the minimum SSL/TLS protocol that CloudFront uses
             *   when connecting to your origin over HTTPS. Valid values include `SSLv3` , `TLSv1` ,
             *   `TLSv1.1` , and `TLSv1.2` .
             *
             * For more information, see
             * [Minimum Origin SSL Protocol](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/distribution-web-values-specify.html#DownloadDistValuesOriginSSLProtocols)
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-cloudfront-distribution-customoriginconfig.html#cfn-cloudfront-distribution-customoriginconfig-originkeepalivetimeout)
             */
            override fun originKeepaliveTimeout(): Number? =
             ...
             * second, the maximum is 60 seconds, and the default (if you don't specify otherwise)
             * is 30 seconds.
             *
             * For more information, see
             * [Origin Response Timeout](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/distribution-web-values-specify.html#DownloadDistValuesOriginResponseTimeout)
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-cloudfront-distribution-customoriginconfig.html#cfn-cloudfront-distribution-customoriginconfig-originsslprotocols)
             */
            override fun originSslProtocols(): List<String> =
                unwrap(this).getOriginSslProtocols() ?: emptyList()
        }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CustomOriginConfigProperty
            ): software.amazon.awscdk.services.cloudfront.CfnDistribution.CustomOriginConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ForwardedValuesProperty {
         ...
         * use an origin request policy. For more information, see
         * [Creating origin request policies](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/controlling-origin-requests.html#origin-request-create-origin-request-policy)
         * in the *Amazon CloudFront Developer Guide* .
         *
         ...
         */
        public fun queryStringCacheKeys(): List<String> =
        ...
        public interface Builder {
            /**
             * @param cookies This field is deprecated. We recommend that you use a cache policy or
             *   an origin request policy instead of this field.
             *
             * If you want to include cookies in the cache key, use a cache policy. For more
             * information, see
            ...
            /**
             * @param headers This field is deprecated. We recommend that you use a cache policy or
             *   an origin request policy instead of this field.
             *
             * If you want to include headers in the cache key, use a cache policy. For more
             * information, see
            ...
            /**
             * @param queryString This field is deprecated. We recommend that you use a cache policy
             ...
             * key, use an origin request policy. For more information, see
             * [Creating origin request policies](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/controlling-origin-requests.html#origin-request-create-origin-request-policy)
             * in the *Amazon CloudFront Developer Guide* .
             *
             * Indicates whether you want CloudFront to forward query strings to the origin that is
            ...
            /**
             * @param queryStringCacheKeys This field is deprecated. We recommend that you use a
             *   cache policy or an origin request policy instead of this field.
             *
             * If you want to include query strings in the cache key, use a cache policy. For more
             * information, see
             * [Creating cache policies](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/controlling-the-cache-key.html#cache-key-create-cache-policy)
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-cloudfront-distribution-forwardedvalues.html#cfn-cloudfront-distribution-forwardedvalues-querystringcachekeys)
             */
            override fun queryStringCacheKeys(): List<String> =
                unwrap(this).getQueryStringCacheKeys() ?: emptyList()
        }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ForwardedValuesProperty
            ): software.amazon.awscdk.services.cloudfront.CfnDistribution.ForwardedValuesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ViewerCertificateProperty {
         ...
         * , provide the Amazon Resource Name (ARN) of the ACM certificate. CloudFront only supports
         ...
         *
         * If the distribution uses `Aliases` (alternate domain names or CNAMEs), omit this field
         ...
         */
        public fun cloudFrontDefaultCertificate(): Any? =
         ...
         * CloudFront automatically sets the security policy to `TLSv1` regardless of the value that
         * you set here.
         *
         ...
         * * `vip` – The distribution accepts HTTPS connections from all viewers including those
         *   that don't support SNI. This is not recommended, and results in additional monthly
         *   charges from CloudFront.
         * * `static-ip` - Do not specify this value unless your distribution has been enabled for
         *   this feature by the CloudFront team. If you have a use case that requires static IP
         *   addresses for a distribution, contact CloudFront through the
         *   [AWS Support Center](https://docs.aws.amazon.com/support/home) .
         *
         * If the distribution uses the CloudFront domain name such as
        ...
        public interface Builder {
            /**
             * @param acmCertificateArn In CloudFormation, this field name is `AcmCertificateArn` .
             *   Note the different capitalization. If the distribution uses `Aliases` (alternate
             *   domain names or CNAMEs) and the SSL/TLS certificate is stored in
             *   [AWS Certificate Manager (ACM)](https://docs.aws.amazon.com/acm/latest/userguide/acm-overview.html)
             *   , provide the Amazon Resource Name (ARN) of the ACM certificate. CloudFront only
             *   supports ACM certificates in the US East (N. Virginia) Region ( `us-east-1` ).
             *
             * If you specify an ACM certificate ARN, you must also specify values for
             * `MinimumProtocolVersion` and `SSLSupportMethod` . (In CloudFormation, the field name
             * is `SslSupportMethod` . Note the different capitalization.)
             */
            public fun acmCertificateArn(acmCertificateArn: String)

            /**
             * @param cloudFrontDefaultCertificate If the distribution uses the CloudFront domain
             *   name such as `d111111abcdef8.cloudfront.net` , set this field to `true` . If the
             *   distribution uses `Aliases` (alternate domain names or CNAMEs), omit this field and
            ...
            /**
             * @param iamCertificateId In CloudFormation, this field name is `IamCertificateId` .
             *   Note the different capitalization. If the distribution uses `Aliases` (alternate
             *   domain names or CNAMEs) and the SSL/TLS certificate is stored in
             *   [AWS Identity and Access Management (IAM)](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_credentials_server-certs.html)
             *   , provide the ID of the IAM certificate.
            ...
            /**
             * @param minimumProtocolVersion If the distribution uses `Aliases` (alternate domain
             *   names or CNAMEs), specify the security policy that you want CloudFront to use for
             ...
             * specify `TLSv1` or higher. (In CloudFormation, the field name is `SslSupportMethod` .
             * Note the different capitalization.)
             *
             * If the distribution uses the CloudFront domain name such as
             * `d111111abcdef8.cloudfront.net` (you set `CloudFrontDefaultCertificate` to `true` ),
             * CloudFront automatically sets the security policy to `TLSv1` regardless of the value
             * that you set here.
             */
            public fun minimumProtocolVersion(minimumProtocolVersion: String)

            /**
             * @param sslSupportMethod In CloudFormation, this field name is `SslSupportMethod` .
             *   Note the different capitalization. If the distribution uses `Aliases` (alternate
             *   domain names or CNAMEs), specify which viewers the distribution accepts HTTPS
             *   connections from.
             ...
             *   that don't support SNI. This is not recommended, and results in additional monthly
             *   charges from CloudFront.
             * * `static-ip` - Do not specify this value unless your distribution has been enabled
             *   for this feature by the CloudFront team. If you have a use case that requires
        ...
        private class BuilderImpl : Builder {
            ...
            override fun cloudFrontDefaultCertificate(cloudFrontDefaultCertificate: IResolvable) {
                cdkBuilder.cloudFrontDefaultCertificate(
                    cloudFrontDefaultCertificate.let(IResolvable::unwrap)
                )
            }
        ...
        internal constructor(
             ...
             * `d111111abcdef8.cloudfront.net` , set this field to `true` .
             *
             * If the distribution uses `Aliases` (alternate domain names or CNAMEs), omit this
             * field and specify values for the following fields:
             * * `AcmCertificateArn` or `IamCertificateId` (specify a value for one, not both)
             * * `MinimumProtocolVersion`
             * * `SslSupportMethod`
             *
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-cloudfront-distribution-viewercertificate.html#cfn-cloudfront-distribution-viewercertificate-minimumprotocolversion)
             */
            override fun minimumProtocolVersion(): String? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ViewerCertificateProperty
            ): software.amazon.awscdk.services.cloudfront.CfnDistribution.ViewerCertificateProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DistributionConfigProperty {
         ...
         * `https://www.example.com/product-description.html` ). Specifying a default root object
         ...
         * migration, see
         * [Connection Migration](https://docs.aws.amazon.com/https://www.rfc-editor.org/rfc/rfc9000.html#name-connection-migration)
         ...
         * code `NOERROR` and with no IP addresses. This allows viewers to submit a second request,
         ...
         * traffic to your CloudFront distribution, you need to create a second alias resource
         ...
         *
         * If you created a CNAME resource record set, either with Amazon Route 53 AWS Integration
         * or with another DNS service, you don't need to make any changes. A CNAME record will
         * route traffic to your distribution regardless of the IP address format of the viewer
         * request.
         *
         ...
         * CloudFront service.
         *
         * If you specify `PriceClass_All` , CloudFront responds to requests for your objects from
         * all CloudFront edge locations.
         *
         * If you specify a price class other than `PriceClass_All` , CloudFront serves your objects
         * from the CloudFront edge location that has the lowest latency among the edge locations in
         ...
         * [Amazon CloudFront Pricing](https://docs.aws.amazon.com/cloudfront/pricing/) .
         *
         ...
         * content or with an HTTP 403 status code (Forbidden). You can also configure CloudFront to
         * return a custom error page when a request is blocked. For more information about AWS WAF
         * , see the
        ...
        public interface Builder {
            ...
            /**
             * @param cacheBehaviors A complex type that contains zero or more `CacheBehavior`
             *   elements.
             */
            ...
            /**
             * @param comment A comment to describe the distribution. The comment cannot be longer
             *   than 128 characters.
             */
            ...
            /**
             * @param defaultCacheBehavior A complex type that describes the default cache behavior
             *   if you don't specify a `CacheBehavior` element or if files don't match any of the
             *   values of `PathPattern` in `CacheBehavior` elements. You must create exactly one
            ...
            public fun defaultCacheBehavior(
                defaultCacheBehavior: DefaultCacheBehaviorProperty.Builder.() -> Unit
            )

            /**
             * @param defaultRootObject The object that you want CloudFront to request from your
             *   origin (for example, `index.html` ) when a viewer requests the root URL for your
             *   distribution ( `https://www.example.com` ) instead of an object in your
             *   distribution ( `https://www.example.com/product-description.html` ). Specifying a
             *   default root object avoids exposing the contents of your distribution. Specify only
             *   the object name, for example, `index.html` . Don't add a `/` before the object
             *   name.
             *
             * If you don't want to specify a default root object when you create a distribution,
             * include an empty `DefaultRootObject` element.
            ...
            /**
             * @param httpVersion (Optional) Specify the maximum HTTP version(s) that you want
             *   viewers to use to communicate with CloudFront . The default value for new
             *   distributions is `http1.1` .
             *
            ...
            /**
             * @param ipv6Enabled If you want CloudFront to respond to IPv6 DNS requests with an
             *   IPv6 address for your distribution, specify `true` . If you specify `false` ,
             *   CloudFront responds to IPv6 DNS requests with the DNS response code `NOERROR` and
             ...
             * the `IpAddress` parameter to restrict the IP addresses that can access your content,
             ...
             * can create two distributions. For more information, see
             * [Creating a Signed URL Using a Custom Policy](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/private-content-creating-signed-url-custom-policy.html)
             * in the *Amazon CloudFront Developer Guide* .
             *
             * If you're using an Amazon Route 53 AWS Integration alias resource record set to route
             ...
             * in the *Amazon Route 53 AWS Integration Developer Guide* .
             *
             * If you created a CNAME resource record set, either with Amazon Route 53 AWS
             * Integration or with another DNS service, you don't need to make any changes. A CNAME
             * record will route traffic to your distribution regardless of the IP address format of
             * the viewer request.
             */
             ...
             *   distribution. For more information about logging, see
             *   [Access Logs](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/AccessLogs.html)
             *   in the *Amazon CloudFront Developer Guide* .
             */
            ...
            /**
             * @param originGroups A complex type that contains information about origin groups for
             *   this distribution.
             */
            ...
            /**
             * @param priceClass The price class that corresponds with the maximum price that you
            ...
            /**
             * @param staging A Boolean that indicates whether this is a staging distribution. When
             *   this value is `true` , this is a staging distribution. When this value is `false` ,
             *   this is not a staging distribution.
             */
            ...
            public fun viewerCertificate(
                viewerCertificate: ViewerCertificateProperty.Builder.() -> Unit
            )
             ...
             * configure CloudFront to return a custom error page when a request is blocked. For
             * more information about AWS WAF , see the
             * [AWS WAF Developer Guide](https://docs.aws.amazon.com/waf/latest/developerguide/what-is-aws-waf.html)
             * .
             */
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("727a62ee2d654fbc3a1c3b7028a0c1e7cdb5dc3e7d19714972629cd0f8e2e5f0")
            override fun customOrigin(
                customOrigin: LegacyCustomOriginProperty.Builder.() -> Unit
            ...
            override fun defaultCacheBehavior(defaultCacheBehavior: DefaultCacheBehaviorProperty) {
                cdkBuilder.defaultCacheBehavior(
                    defaultCacheBehavior.let(DefaultCacheBehaviorProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("8d62aa0f015521cdd4014cc800720d9a7da92b7f050630202b0f209e35d72d47")
            override fun defaultCacheBehavior(
                defaultCacheBehavior: DefaultCacheBehaviorProperty.Builder.() -> Unit
            ...
            override fun viewerCertificate(viewerCertificate: ViewerCertificateProperty) {
                cdkBuilder.viewerCertificate(
                    viewerCertificate.let(ViewerCertificateProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("b3fcb2f5f45457646e32f82b20be2f6c740f0ffbd4e51595da0a7e5e7bacfb32")
            override fun viewerCertificate(
                viewerCertificate: ViewerCertificateProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * distribution, specify `true` .
             *
             * If you specify `false` , CloudFront responds to IPv6 DNS requests with the DNS
             * response code `NOERROR` and with no IP addresses. This allows viewers to submit a
             ...
             * CloudFront service.
             *
             * If you specify `PriceClass_All` , CloudFront responds to requests for your objects
             ...
             * A Boolean that indicates whether this is a staging distribution.
             *
             * When this value is `true` , this is a staging distribution. When this value is
             ...
             * this distribution.
             *
             * To specify a web ACL created using the latest version of AWS WAF , use the ACL ARN,
             * for example
             * `arn:aws:wafv2:us-east-1:123456789012:global/webacl/ExampleWebACL/a1b2c3d4-5678-90ab-cdef-EXAMPLE11111`
             * . To specify a web ACL created using AWS WAF Classic, use the ACL ID, for example
             * `a1b2c3d4-5678-90ab-cdef-EXAMPLE11111` .
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DistributionConfigProperty
            ): software.amazon.awscdk.services.cloudfront.CfnDistribution.DistributionConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface OriginShieldProperty {
         ...
         * use the region code, not the region name. For example, specify the US East (Ohio) region
         * as `us-east-2` .
         *
         ...
         * [Choosing the AWS Region for Origin Shield](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/origin-shield.html#choose-origin-shield-region)
         * in the *Amazon CloudFront Developer Guide* .
         *
        ...
        public interface Builder {
            /**
             * @param enabled A flag that specifies whether Origin Shield is enabled. When it's
             *   enabled, CloudFront routes all requests through Origin Shield, which can help
             *   protect your origin. When it's disabled, CloudFront might send requests directly to
            ...
            /**
             * @param originShieldRegion The AWS Region for Origin Shield. Specify the AWS Region
             *   that has the lowest latency to your origin. To specify a region, use the region
             *   code, not the region name. For example, specify the US East (Ohio) region as
             *   `us-east-2` .
             *
             * When you enable CloudFront Origin Shield, you must specify the AWS Region for Origin
             * Shield. For the list of AWS Regions that you can specify, and for help choosing the
             * best Region for your origin, see
             * [Choosing the AWS Region for Origin Shield](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/origin-shield.html#choose-origin-shield-region)
             * in the *Amazon CloudFront Developer Guide* .
             */
    ...
    public interface OriginGroupFailoverCriteriaProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: OriginGroupFailoverCriteriaProperty
            ): software.amazon.awscdk.services.cloudfront.CfnDistribution.OriginGroupFailoverCriteriaProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface OriginGroupMembersProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: OriginGroupMembersProperty
            ): software.amazon.awscdk.services.cloudfront.CfnDistribution.OriginGroupMembersProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface LambdaFunctionAssociationProperty {
         ...
         *   origin and before it caches the object in the response. When the requested object is in
        ...
        public interface Builder {
             ...
             * * `viewer-request` : The function executes when CloudFront receives a request from a
             *   viewer and before it checks to see whether the requested object is in the edge
             *   cache.
             * * `origin-request` : The function executes only when CloudFront sends a request to
             *   your origin. When the requested object is in the edge cache, the function doesn't
             *   execute.
            ...
            /**
             * @param includeBody A flag that allows a Lambda&#64;Edge function to have read access
             *   to the body content. For more information, see
             *   [Accessing the Request Body by Choosing the Include Body Option](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/lambda-include-body-access.html)
             *   in the Amazon CloudFront Developer Guide.
             */
            ...
            /**
             * @param lambdaFunctionArn The ARN of the Lambda&#64;Edge function. You must specify
        ...
        internal constructor(
             ...
             * The ARN of the Lambda&#64;Edge function.
             *
             * You must specify the ARN of a function version; you can't specify an alias or
             * $LATEST.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-cloudfront-distribution-lambdafunctionassociation.html#cfn-cloudfront-distribution-lambdafunctionassociation-lambdafunctionarn)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: LambdaFunctionAssociationProperty
            ): software.amazon.awscdk.services.cloudfront.CfnDistribution.LambdaFunctionAssociationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface LegacyS3OriginProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: LegacyS3OriginProperty
            ): software.amazon.awscdk.services.cloudfront.CfnDistribution.LegacyS3OriginProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface OriginGroupProperty {
        ...
        public interface Builder {
            ...
            public fun failoverCriteria(
                failoverCriteria: OriginGroupFailoverCriteriaProperty.Builder.() -> Unit
            )
            ...
            /**
             * @param members A complex type that contains information about the origins in an
             *   origin group.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            override fun failoverCriteria(failoverCriteria: OriginGroupFailoverCriteriaProperty) {
                cdkBuilder.failoverCriteria(
                    failoverCriteria.let(OriginGroupFailoverCriteriaProperty::unwrap)
                )
            }
    ...
    public interface OriginProperty {
         ...
         *
         * The minimum number is 1, the maximum is 3, and the default (if you don't specify
         * otherwise) is 3.
         *
         ...
         * Amazon S3 bucket is not configured with static website hosting, use the `S3OriginConfig`
         * type instead.
         *
         ...
         *
         * To specify any other type of origin, including an Amazon S3 bucket that is configured
         * with static website hosting, use the `CustomOriginConfig` type instead.
         *
        ...
        public interface Builder {
            /**
             * @param connectionAttempts The number of times that CloudFront attempts to connect to
             *   the origin. The minimum number is 1, the maximum is 3, and the default (if you
             *   don't specify otherwise) is 3.
             *
             * For a custom origin (including an Amazon S3 bucket that's configured with static
             * website hosting), this value also specifies the number of times that CloudFront
             * attempts to get a response from the origin, in the case of an
             * [Origin Response Timeout](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/distribution-web-values-specify.html#DownloadDistValuesOriginResponseTimeout)
             * .
             *
             * For more information, see
             ...
             *   establish a connection to the origin. The minimum timeout is 1 second, the maximum
             *   is 10 seconds, and the default (if you don't specify otherwise) is 10 seconds.
             *
             * For more information, see
             * [Origin Connection Timeout](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/distribution-web-values-specify.html#origin-connection-timeout)
             * in the *Amazon CloudFront Developer Guide* .
             ...
             *   bucket, with one exception. If the Amazon S3 bucket is configured with static
             *   website hosting, use this type. If the Amazon S3 bucket is not configured with
            ...
            public fun customOriginConfig(
                customOriginConfig: CustomOriginConfigProperty.Builder.() -> Unit
            )
            ...
            /**
             * @param originAccessControlId The unique identifier of an origin access control for
            ...
            /**
             * @param originCustomHeaders A list of HTTP header names and values that CloudFront
             *   adds to the requests that it sends to the origin. For more information, see
             *   [Adding Custom Headers to Origin Requests](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/add-origin-custom-headers.html)
             *   in the *Amazon CloudFront Developer Guide* .
             */
            ...
            /**
             * @param originPath An optional path that CloudFront appends to the origin domain name
             *   when CloudFront requests content from the origin. For more information, see
             *   [Origin Path](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/distribution-web-values-specify.html#DownloadDistValuesOriginPath)
             *   in the *Amazon CloudFront Developer Guide* .
             */
            ...
            /**
             * @param originShield CloudFront Origin Shield. Using Origin Shield can help reduce the
             *   load on your origin. For more information, see
             *   [Using Origin Shield](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/origin-shield.html)
             *   in the *Amazon CloudFront Developer Guide* .
             */
            ...
            /**
             * @param s3OriginConfig Use this type to specify an origin that is an Amazon S3 bucket
             *   that is not configured with static website hosting. To specify any other type of
             *   origin, including an Amazon S3 bucket that is configured with static website
        ...
        private class BuilderImpl : Builder {
            ...
            override fun customOriginConfig(customOriginConfig: CustomOriginConfigProperty) {
                cdkBuilder.customOriginConfig(
                    customOriginConfig.let(CustomOriginConfigProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("673786f28187da609be6f59efa8a3d8d357f3ffa2f59a93f79f80c4940585d7f")
            override fun customOriginConfig(
                customOriginConfig: CustomOriginConfigProperty.Builder.() -> Unit
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("345ceecbfefa4e6f7dfc83aa125d7e491472a25e0620b0a0ff0e1fa09fe5eea9")
            override fun s3OriginConfig(
                s3OriginConfig: S3OriginConfigProperty.Builder.() -> Unit
        ...
        internal constructor(
            ...
            /**
             * The number of seconds that CloudFront waits when trying to establish a connection to
             * the origin.
             *
             ...
             * exception.
             *
             * If the Amazon S3 bucket is configured with static website hosting, use this type. If
    ...
    public interface OriginGroupMemberProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: OriginGroupMemberProperty
            ): software.amazon.awscdk.services.cloudfront.CfnDistribution.OriginGroupMemberProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface OriginCustomHeaderProperty {
        ...
        public interface Builder {
            /**
             * @param headerName The name of a header that you want CloudFront to send to your
            ...
            /**
             * @param headerValue The value for the header that you specified in the `HeaderName`
             *   field.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: OriginCustomHeaderProperty
            ): software.amazon.awscdk.services.cloudfront.CfnDistribution.OriginCustomHeaderProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface RestrictionsProperty {
        ...
        public interface Builder {
            /**
             * @param geoRestriction A complex type that controls the countries in which your
             *   content is distributed. CloudFront determines the location of your users using
             *   `MaxMind` GeoIP databases. To disable geo restriction, remove the
             *   [Restrictions](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-cloudfront-distribution-distributionconfig.html#cfn-cloudfront-distribution-distributionconfig-restrictions)
             *   property from your stack template.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("f953f010c1b6055a54f92673e021554d06508699325e69a30cbf137403e63ba8")
            override fun geoRestriction(
                geoRestriction: GeoRestrictionProperty.Builder.() -> Unit
    ...
    public interface LegacyCustomOriginProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: LegacyCustomOriginProperty
            ): software.amazon.awscdk.services.cloudfront.CfnDistribution.LegacyCustomOriginProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
