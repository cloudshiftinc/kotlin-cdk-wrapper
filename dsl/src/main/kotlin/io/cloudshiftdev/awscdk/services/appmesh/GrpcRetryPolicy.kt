...
public interface GrpcRetryPolicy : HttpRetryPolicy {
    ...
    public interface Builder {
        /**
         * @param grpcRetryEvents gRPC events on which to retry. You must specify at least one value
    ...
    private class BuilderImpl : Builder {
        ...
        public fun build(): software.amazon.awscdk.services.appmesh.GrpcRetryPolicy =
            cdkBuilder.build()
    }
