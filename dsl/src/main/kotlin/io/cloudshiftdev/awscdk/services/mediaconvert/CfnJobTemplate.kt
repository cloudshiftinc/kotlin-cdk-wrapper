...
internal constructor(
    ...
    public open fun accelerationSettings(
        `value`: AccelerationSettingsProperty.Builder.() -> Unit
    ...
    public interface Builder {
        ...
        public fun accelerationSettings(
            accelerationSettings: AccelerationSettingsProperty.Builder.() -> Unit
        )
         ...
         * When more than one job has the same priority, the service begins processing the job that
         * you submitted first. If you don't specify a priority, the service uses the default
         * value 0. Minimum: -50 Maximum: 50
         *
         ...
         * Optional.
         *
         * The queue that jobs created from this template are assigned to. Specify the Amazon
         ...
         * topic.
         *
         * For more information about MediaConvert job templates, see
    ...
    private class BuilderImpl(
        ...
        override fun accelerationSettings(accelerationSettings: AccelerationSettingsProperty) {
            cdkBuilder.accelerationSettings(
                accelerationSettings.let(AccelerationSettingsProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("71826123168d5fa0ad81f034744e0fd2541d75930c20fcfd4edf9b5fc23a313e")
        override fun accelerationSettings(
            accelerationSettings: AccelerationSettingsProperty.Builder.() -> Unit
    ...
    public interface AccelerationSettingsProperty {
        ...
        public interface Builder {
            /**
             * @param mode Specify the conditions when the service will run your job with
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AccelerationSettingsProperty
            ): software.amazon.awscdk.services.mediaconvert.CfnJobTemplate.AccelerationSettingsProperty =
    ...
    public interface HopDestinationProperty {
         ...
         * for the job in the destination queue. If you don't specify, the relative priority will
         ...
         *
         * When you set up a job to use queue hopping, you can specify a destination queue. This
         * queue cannot be the original queue to which the job is submitted. If the original queue
         * isn't the default queue and you don't specify the destination queue, the job will move to
         * the default queue.
         *
         ...
         *
         * Minimum wait time in minutes until the job can hop to the destination queue. Valid range
        ...
        public interface Builder {
            /**
             * @param priority Optional. When you set up a job to use queue hopping, you can specify
             *   a different relative priority for the job in the destination queue. If you don't
             *   specify, the relative priority will remain the same as in the previous queue.
             */
            public fun priority(priority: Number)

            /**
             * @param queue Optional unless the job is submitted on the default queue. When you set
             *   up a job to use queue hopping, you can specify a destination queue. This queue
             *   cannot be the original queue to which the job is submitted. If the original queue
             *   isn't the default queue and you don't specify the destination queue, the job will
             *   move to the default queue.
             */
            public fun queue(queue: String)

            /**
             * @param waitMinutes Required for setting up a job to use queue hopping. Minimum wait
             *   time in minutes until the job can hop to the destination queue. Valid range is 1 to
        ...
        internal constructor(
             ...
             * Optional.
             *
             * When you set up a job to use queue hopping, you can specify a different relative
             * priority for the job in the destination queue. If you don't specify, the relative
             * priority will remain the same as in the previous queue.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-mediaconvert-jobtemplate-hopdestination.html#cfn-mediaconvert-jobtemplate-hopdestination-priority)
             */
             ...
             *
             * When you set up a job to use queue hopping, you can specify a destination queue. This
             * queue cannot be the original queue to which the job is submitted. If the original
             ...
             * Required for setting up a job to use queue hopping.
             *
             * Minimum wait time in minutes until the job can hop to the destination queue. Valid
             * range is 1 to 4320 minutes, inclusive.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-mediaconvert-jobtemplate-hopdestination.html#cfn-mediaconvert-jobtemplate-hopdestination-waitminutes)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: HopDestinationProperty
            ): software.amazon.awscdk.services.mediaconvert.CfnJobTemplate.HopDestinationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
