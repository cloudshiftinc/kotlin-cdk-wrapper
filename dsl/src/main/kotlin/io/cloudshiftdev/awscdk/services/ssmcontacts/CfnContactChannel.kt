...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param channelType The type of the contact channel. Incident Manager supports three
         *   contact methods:.
         */
         ...
         *
         * @param deferActivation If you want to activate the channel at a later time, you can
         *   choose to defer activation.
         */
