...
public interface EndpointGroupOptions {
     ...
     */
    public fun endpoints(): List<IEndpoint> =
     ...
     * based on optimal routing. Additional traffic is distributed to other endpoint groups for this
     * listener.
     *
     * Default: 100
     */
    ...
    public interface Builder {
        ...
        /**
         * @param healthCheckInterval The time between health checks for each endpoint. Must be
         *   either 10 or 30 seconds.
         */
         ...
         *   percentage is applied to the traffic that would otherwise have been routed to the
    ...
    public companion object {
        ...
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.globalaccelerator.EndpointGroupOptions
        ): EndpointGroupOptions = Wrapper(cdkObject)

        internal fun unwrap(
            wrapped: EndpointGroupOptions
        ): software.amazon.awscdk.services.globalaccelerator.EndpointGroupOptions =
