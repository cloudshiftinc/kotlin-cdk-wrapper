...
public interface HealthCheck {
     ...
     * the target type is instance or ip, health checks are always enabled and cannot be disabled.
     *
     ...
     *
     * You can specify values between 0 and 99. You can specify multiple values (for example, "0,1")
     * or a range of values (for example, "0-5").
     *
     * Default: - 12
     */
     ...
     * target healthy.
     *
     * For Application Load Balancers, the default is 5. For Network Load Balancers, the default
     * is 3.
     *
    ...
    public interface Builder {
         ...
         *   target. For Application Load Balancers, you can specify values between 200 and 499, and
         *   the default value is 200. You can specify multiple values (for example, "200,202") or a
         ...
         *   before considering an unhealthy target healthy. For Application Load Balancers, the
        ...
        /**
         * @param protocol The protocol the load balancer uses when performing health checks on
         *   targets. The TCP protocol is supported for health checks only if the protocol of the
         *   target group is TCP, TLS, UDP, or TCP_UDP. The TLS, UDP, and TCP_UDP protocols are not
         *   supported for health checks.
         */
        public fun protocol(protocol: Protocol)

        /**
         * @param timeout The amount of time, in seconds, during which no response from a target
         *   means a failed health check. Must be 2 to 120 seconds.
         */
        public fun timeout(timeout: Duration)

        /**
         * @param unhealthyThresholdCount The number of consecutive health check failures required
         *   before considering a target unhealthy. For Application Load Balancers, the default
         *   is 2. For Network Load Balancers, this value must be the same as the healthy threshold
         *   count.
         */
    ...
    internal constructor(
         ...
         * If the target type is instance or ip, health checks are always enabled and cannot be
         * disabled.
         *
         * Default: - Determined automatically.
         */
         ...
         * "0,1") or a range of values (for example, "0-5").
         *
         * Default: - 12
         */
         ...
         * Must be 5 to 300 seconds
         *
         * Default: 10 seconds if protocol is `GENEVE`, 35 seconds if target type is `lambda`, else
         * 30 seconds
         */
         ...
         * The protocol the load balancer uses when performing health checks on targets.
         *
         * The TCP protocol is supported for health checks only if the protocol of the target group
         * is TCP, TLS, UDP, or TCP_UDP. The TLS, UDP, and TCP_UDP protocols are not supported for
         * health checks.
         *
         * Default: HTTP for ALBs, TCP for NLBs
         */
         ...
         * unhealthy.
         *
         * For Application Load Balancers, the default is 2. For Network Load Balancers, this value
