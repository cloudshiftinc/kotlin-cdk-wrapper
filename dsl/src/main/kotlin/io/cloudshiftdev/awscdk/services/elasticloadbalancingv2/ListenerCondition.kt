...
internal constructor(
    ...
    public companion object {
        public fun hostHeaders(values: List<String>): ListenerCondition =
            software.amazon.awscdk.services.elasticloadbalancingv2.ListenerCondition.hostHeaders(
                    values
                )
                .let(ListenerCondition::wrap)

        public fun hostHeaders(vararg values: String): ListenerCondition =
            hostHeaders(values.toList())

        public fun httpHeader(name: String, values: List<String>): ListenerCondition =
            software.amazon.awscdk.services.elasticloadbalancingv2.ListenerCondition.httpHeader(
                    name,
                    values
                )
                .let(ListenerCondition::wrap)
        ...
        public fun queryStrings(values: List<QueryStringCondition>): ListenerCondition =
            software.amazon.awscdk.services.elasticloadbalancingv2.ListenerCondition.queryStrings(
                    values.map(QueryStringCondition::unwrap)
                )
                .let(ListenerCondition::wrap)
        ...
        public fun sourceIps(values: List<String>): ListenerCondition =
            software.amazon.awscdk.services.elasticloadbalancingv2.ListenerCondition.sourceIps(
                    values
                )
                .let(ListenerCondition::wrap)
