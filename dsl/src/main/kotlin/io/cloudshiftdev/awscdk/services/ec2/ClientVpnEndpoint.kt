...
internal constructor(
     ...
     * @param props
     */
    public open fun addAuthorizationRule(
        id: String,
        props: ClientVpnAuthorizationRuleOptions
    ): ClientVpnAuthorizationRule =
        unwrap(this)
            .addAuthorizationRule(id, props.let(ClientVpnAuthorizationRuleOptions::unwrap))
            .let(ClientVpnAuthorizationRule::wrap)
    ...
    public open fun addAuthorizationRule(
        id: String,
        props: ClientVpnAuthorizationRuleOptions.Builder.() -> Unit
    ): ClientVpnAuthorizationRule =
    ...
    public open fun addRoute(id: String, props: ClientVpnRouteOptions): ClientVpnRoute =
        unwrap(this)
            .addRoute(id, props.let(ClientVpnRouteOptions::unwrap))
            .let(ClientVpnRoute::wrap)
    ...
    public open fun addRoute(
        id: String,
        props: ClientVpnRouteOptions.Builder.() -> Unit
    ...
    public interface Builder {
         ...
         *
         * @param clientLoginBanner Customizable text that will be displayed in a banner on AWS
         ...
         */
        public fun userBasedAuthentication(
    ...
    private class BuilderImpl(
        ...
        override fun clientConnectionHandler(clientConnectionHandler: IClientVpnConnectionHandler) {
            cdkBuilder.clientConnectionHandler(
                clientConnectionHandler.let(IClientVpnConnectionHandler::unwrap)
            )
        }
        ...
        override fun userBasedAuthentication(
            ...
            cdkBuilder.userBasedAuthentication(
                userBasedAuthentication.let(ClientVpnUserBasedAuthentication::unwrap)
            )
        }
        ...
        public fun build(): software.amazon.awscdk.services.ec2.ClientVpnEndpoint =
            cdkBuilder.build()
    }
    ...
    public companion object {
        public fun fromEndpointAttributes(
            ...
            software.amazon.awscdk.services.ec2.ClientVpnEndpoint.fromEndpointAttributes(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    attrs.let(ClientVpnEndpointAttributes::unwrap)
                )
                .let(IClientVpnEndpoint::wrap)
        ...
        public fun fromEndpointAttributes(
            ...
            fromEndpointAttributes(scope, id, ClientVpnEndpointAttributes(attrs))
