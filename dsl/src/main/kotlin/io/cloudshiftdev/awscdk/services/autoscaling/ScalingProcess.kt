...
public enum class ScalingProcess(
    ...
    public companion object {
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.autoscaling.ScalingProcess
        ): ScalingProcess =
            when (cdkObject) {
                software.amazon.awscdk.services.autoscaling.ScalingProcess.LAUNCH ->
