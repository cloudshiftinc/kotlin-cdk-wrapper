...
public interface VirtualServiceAttributes {
    ...
    public interface Builder {
        ...
        /**
         * @param virtualServiceName The name of the VirtualService, it is recommended this follows
         *   the fully-qualified domain name format.
         */
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: VirtualServiceAttributes
