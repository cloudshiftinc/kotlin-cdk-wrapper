...
public interface InstanceProfileAttributes {
    ...
    public interface Builder {
        /**
         * @param instanceProfileArn The ARN of the InstanceProfile. Format:
         *   arn:<partition>:iam::<account-id>:instance-profile/<instance-profile-name-with-path>
         */
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: InstanceProfileAttributes
