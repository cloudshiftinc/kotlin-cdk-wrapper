...
public interface OpenIdConnectConfig {
    ...
    public interface Builder {
         ...
         *   provider. A regular expression can be specified so AppSync can validate against
         *   multiple client identifiers at a time.
         */
        public fun clientId(clientId: String)

        /**
         * @param oidcProvider The issuer for the OIDC configuration. The issuer returned by
         *   discovery must exactly match the value of `iss` in the OIDC token.
         */
         ...
         *   authenticated by OIDC provider. `auth_time` claim in OIDC token is required for this
         *   validation to work.
         */
         ...
         *   issued to a user. This validation uses `iat` claim of OIDC token.
         */
    ...
    internal constructor(
        ...
        /**
         * The number of milliseconds an OIDC token is valid after being authenticated by OIDC
         * provider.
         *
         * `auth_time` claim in OIDC token is required for this validation to work.
         *
