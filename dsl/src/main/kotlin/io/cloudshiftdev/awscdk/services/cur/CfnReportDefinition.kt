...
internal constructor(
    ...
    public open fun additionalArtifacts(): List<String> =
        unwrap(this).getAdditionalArtifacts() ?: emptyList()
    ...
    public interface Builder {
         ...
         *
         * @param additionalArtifacts A list of manifests that you want AWS to create for this
         *   report.
         */
        ...
        /**
         * A list of strings that indicate additional content that AWS includes in the report, such
         ...
         *
         * @param additionalSchemaElements A list of strings that indicate additional content that
         *   AWS includes in the report, such as individual resource IDs.
         */
         ...
         *
         * @param refreshClosedReports Whether you want AWS to update your reports after they have
         ...
         *
         * @param reportVersioning Whether you want AWS to overwrite the previous version of each
        ...
        /**
         * The prefix that Amazon Web Services adds to the report name when Amazon Web Services
         * delivers the report.
         *
         ...
         *
         * @param s3Prefix The prefix that Amazon Web Services adds to the report name when Amazon
         *   Web Services delivers the report.
         */
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.cur.CfnReportDefinition =
            cdkBuilder.build()
    }
