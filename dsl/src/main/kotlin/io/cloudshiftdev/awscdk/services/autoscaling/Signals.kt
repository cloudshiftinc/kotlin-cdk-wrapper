...
internal constructor(
    ...
    public open fun renderCreationPolicy(renderOptions: RenderSignalsOptions): CfnCreationPolicy =
        unwrap(this)
            .renderCreationPolicy(renderOptions.let(RenderSignalsOptions::unwrap))
            .let(CfnCreationPolicy::wrap)
    ...
    public open fun renderCreationPolicy(
        renderOptions: RenderSignalsOptions.Builder.() -> Unit
    ...
    public companion object {
        ...
        public fun waitForAll(options: SignalsOptions): Signals =
            software.amazon.awscdk.services.autoscaling.Signals.waitForAll(
                    options.let(SignalsOptions::unwrap)
                )
                .let(Signals::wrap)
        ...
        public fun waitForCount(count: Number, options: SignalsOptions): Signals =
            software.amazon.awscdk.services.autoscaling.Signals.waitForCount(
                    count,
                    options.let(SignalsOptions::unwrap)
                )
                .let(Signals::wrap)
        ...
        public fun waitForCount(
            count: Number,
            options: SignalsOptions.Builder.() -> Unit
        ): Signals = waitForCount(count, SignalsOptions(options))

        public fun waitForMinCapacity(): Signals =
            software.amazon.awscdk.services.autoscaling.Signals.waitForMinCapacity()
                .let(Signals::wrap)
