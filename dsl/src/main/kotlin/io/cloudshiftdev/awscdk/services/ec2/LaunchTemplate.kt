...
internal constructor(
    ...
    public interface Builder {
         ...
         *   instances launched with this launch template using the Amazon EC2 console, CLI, or
         *   API;.
         */
         ...
         *
         * Default: - Hibernation configuration is not specified in the launch template; defaulting
         * to false.
         *
         * @param hibernationConfigured If you set this parameter to true, the instance is enabled
         *   for hibernation.
         */
         ...
         *
         * @param instanceProfile The instance profile used to pass role information to EC2
         *   instances.
         */
         ...
         */
        @Deprecated(message = "deprecated in CDK") public fun keyName(keyName: String)
         ...
         *
         * Default: - Enablement of Nitro enclaves is not specified in the launch template;
         * defaulting to false.
         *
         * @param nitroEnclaveEnabled If this parameter is set to true, the instance is enabled for
         *   AWS Nitro Enclaves;.
         */
         ...
         *
         * @param securityGroup Security group to assign to instances created with the launch
         *   template.
         */
        public fun securityGroup(securityGroup: ISecurityGroup)

        /**
         * If this property is defined, then the Launch Template's InstanceMarketOptions will be set
         * to use Spot instances, and the options for the Spot instances will be as defined.
         *
    ...
    private class BuilderImpl(
        ...
        override fun instanceInitiatedShutdownBehavior(
            ...
            cdkBuilder.instanceInitiatedShutdownBehavior(
                instanceInitiatedShutdownBehavior.let(InstanceInitiatedShutdownBehavior::unwrap)
            )
        }
    ...
    public companion object {
        public fun fromLaunchTemplateAttributes(
            ...
            software.amazon.awscdk.services.ec2.LaunchTemplate.fromLaunchTemplateAttributes(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    attrs.let(LaunchTemplateAttributes::unwrap)
                )
                .let(ILaunchTemplate::wrap)
        ...
        public fun fromLaunchTemplateAttributes(
            ...
            fromLaunchTemplateAttributes(scope, id, LaunchTemplateAttributes(attrs))
        ...
        ): LaunchTemplate = LaunchTemplate(cdkObject)

        internal fun unwrap(
            wrapped: LaunchTemplate
        ): software.amazon.awscdk.services.ec2.LaunchTemplate = wrapped.cdkObject
    }
}
