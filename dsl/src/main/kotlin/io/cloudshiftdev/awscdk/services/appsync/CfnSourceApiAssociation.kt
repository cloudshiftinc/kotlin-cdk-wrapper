...
internal constructor(
    ...
    public open fun sourceApiAssociationConfig(): Any? =
        unwrap(this).getSourceApiAssociationConfig()
    ...
    public open fun sourceApiAssociationConfig(`value`: SourceApiAssociationConfigProperty) {
        unwrap(this)
            .setSourceApiAssociationConfig(`value`.let(SourceApiAssociationConfigProperty::unwrap))
    }

    /** The `SourceApiAssociationConfig` object data. */
    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("e1bce05f541ba7087b1072d6d8719c04c39d66c9ea93eb11905c18f00dc120ee")
    public open fun sourceApiAssociationConfig(
        `value`: SourceApiAssociationConfigProperty.Builder.() -> Unit
    ...
    public interface Builder {
         ...
         * account) only require the API ID value or ARN of the merged API. However, Merged APIs
         * from other accounts (cross-account use cases) strictly require the full resource ARN of
         * the merged API.
         *
        ...
        public fun sourceApiAssociationConfig(
            sourceApiAssociationConfig: SourceApiAssociationConfigProperty.Builder.() -> Unit
        )
         ...
         * account) only require the API ID value or ARN of the source API. However, source APIs
         * from other accounts (cross-account use cases) strictly require the full resource ARN of
         * the source API.
         *
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.appsync.CfnSourceApiAssociation.Builder.create(
                scope,
                id
            )
        ...
        override fun sourceApiAssociationConfig(sourceApiAssociationConfig: IResolvable) {
            cdkBuilder.sourceApiAssociationConfig(
                sourceApiAssociationConfig.let(IResolvable::unwrap)
            )
        }
         ...
         * @param sourceApiAssociationConfig The `SourceApiAssociationConfig` object data.
         */
        override fun sourceApiAssociationConfig(
            sourceApiAssociationConfig: SourceApiAssociationConfigProperty
        ) {
            cdkBuilder.sourceApiAssociationConfig(
                sourceApiAssociationConfig.let(SourceApiAssociationConfigProperty::unwrap)
            )
        }
        ...
        override fun sourceApiAssociationConfig(
            ...
            sourceApiAssociationConfig(
                SourceApiAssociationConfigProperty(sourceApiAssociationConfig)
            )
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnSourceApiAssociation
    ...
    public interface SourceApiAssociationConfigProperty {
         ...
         * source APIs so that any change in the source APIs are also made to the merged API. Auto
        ...
        public interface Builder {
            /**
             * @param mergeType The property that indicates which merging option is enabled in the
             *   source API association. Valid merge types are `MANUAL_MERGE` (default) and
             *   `AUTO_MERGE` . Manual merges are the default behavior and require the user to
             *   trigger any changes from the source APIs to the merged API manually. Auto merges
             *   subscribe the merged API to the changes performed on the source APIs so that any
        ...
        internal constructor(
             ...
             * the default behavior and require the user to trigger any changes from the source APIs
             * to the merged API manually. Auto merges subscribe the merged API to the changes
             * performed on the source APIs so that any change in the source APIs are also made to
             * the merged API. Auto merges use `MergedApiExecutionRoleArn` to perform merge
             * operations.
             *
             * The following values are valid:
             *
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SourceApiAssociationConfigProperty
            ): software.amazon.awscdk.services.appsync.CfnSourceApiAssociation.SourceApiAssociationConfigProperty =
