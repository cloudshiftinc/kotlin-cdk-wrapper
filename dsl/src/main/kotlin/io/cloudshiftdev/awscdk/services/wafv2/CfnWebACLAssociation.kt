...
internal constructor(
    ...
    public interface Builder {
         ...
         * * For an Amazon API Gateway REST API: `arn: *partition* :apigateway: *region*
         *   ::/restapis/ *api-id* /stages/ *stage-name*`
         * * For an AWS AppSync GraphQL API: `arn: *partition* :appsync: *region* : *account-id*
         *   :apis/ *GraphQLApiId*`
         * * For an Amazon Cognito user pool: `arn: *partition* :cognito-idp: *region* :
         *   *account-id* :userpool/ *user-pool-id*`
         ...
         *
         * @param resourceArn The Amazon Resource Name (ARN) of the resource to associate with the
         *   web ACL.
         */
