...
internal constructor(
     ...
     * `1`
     */
    public open fun attrConfigurationRevision(): Number =
        unwrap(this).getAttrConfigurationRevision()
    ...
    public open fun ldapServerMetadata(
        `value`: LdapServerMetadataProperty.Builder.() -> Unit
    ): Unit = ldapServerMetadata(LdapServerMetadataProperty(`value`))
     ...
     */
    public open fun maintenanceWindowStartTime(): Any? =
        unwrap(this).getMaintenanceWindowStartTime()
    ...
    public open fun maintenanceWindowStartTime(
        `value`: MaintenanceWindowProperty.Builder.() -> Unit
    ...
    public interface Builder {
        ...
        /**
         * Enables automatic upgrades to new minor versions for brokers, as new broker engine
         ...
         *   brokers, as new broker engine versions are released and supported by Amazon MQ.
         */
         ...
         * information in broker names. Broker names are accessible to other AWS services, including
         * C CloudWatch Logs . Broker names are not intended to be used for private or sensitive
         * data.
         *
         ...
         *
         * @param dataReplicationMode Defines whether this broker is a part of a data replication
         *   pair.
         */
        public fun dataReplicationMode(dataReplicationMode: String)

        /**
         * The Amazon Resource Name (ARN) of the primary broker that is used to replicate data from
         * in a data replication pair, and is applied to the replica broker.
         *
         ...
         *
         * @param dataReplicationPrimaryBrokerArn The Amazon Resource Name (ARN) of the primary
         *   broker that is used to replicate data from in a data replication pair, and is applied
         *   to the replica broker.
         */
        ...
        public fun encryptionOptions(
            encryptionOptions: EncryptionOptionsProperty.Builder.() -> Unit
        )
         ...
         * Optional.
         *
         * The metadata of the LDAP server used to authenticate and authorize connections to the
        ...
        public fun ldapServerMetadata(
            ldapServerMetadata: LdapServerMetadataProperty.Builder.() -> Unit
        )
        ...
        public fun maintenanceWindowStartTime(
            maintenanceWindowStartTime: MaintenanceWindowProperty.Builder.() -> Unit
        )
         ...
         *
         * @param publiclyAccessible Enables connections from applications outside of the VPC that
         ...
         *
         * @param securityGroups The list of rules (1 minimum, 125 maximum) that authorize
         ...
         * Amazon MQ will not be able to create VPC endpoints for your broker with multiple subnets
         * in the same Availability Zone. A SINGLE_INSTANCE deployment requires one subnet (for
         * example, the default subnet). An ACTIVE_STANDBY_MULTI_AZ deployment (ACTIVEMQ) requires
         * two subnets. A CLUSTER_MULTI_AZ deployment (RABBITMQ) has no subnet requirements when
         * deployed with public accessibility, deployment without public accessibility requires at
         * least one subnet.
         *
         * If you specify subnets in a shared VPC for a RabbitMQ broker, the associated VPC to which
         * the specified subnets belong must be owned by your AWS account . Amazon MQ will not be
         * able to create VPC enpoints in VPCs that are not owned by your AWS account .
         *
         ...
         * created when a broker is first provisioned. All subsequent RabbitMQ users are created by
         * via the RabbitMQ web console or by using the RabbitMQ management API.
         *
    ...
    private class BuilderImpl(
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("27fe168ca245b68292bfdf48ec00a367af07255b6f406ed3296fa43c1a3547da")
        override fun encryptionOptions(
            encryptionOptions: EncryptionOptionsProperty.Builder.() -> Unit
        ...
        override fun ldapServerMetadata(ldapServerMetadata: LdapServerMetadataProperty) {
            cdkBuilder.ldapServerMetadata(
                ldapServerMetadata.let(LdapServerMetadataProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("d49dc3540c98e0160a80f08fb28165514a9e96f98b851cadb657f7d784c7ecfd")
        override fun ldapServerMetadata(
            ldapServerMetadata: LdapServerMetadataProperty.Builder.() -> Unit
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("4c46ecfc3b2482edc22ff6cd2af903a75fe8815c2089bb6ed4e59dd3de838727")
        override fun logs(logs: LogListProperty.Builder.() -> Unit): Unit =
        ...
        override fun maintenanceWindowStartTime(maintenanceWindowStartTime: IResolvable) {
            cdkBuilder.maintenanceWindowStartTime(
                maintenanceWindowStartTime.let(IResolvable::unwrap)
            )
        }
         ...
         *   Amazon MQ begins to apply pending updates or patches to the broker.
         */
        override fun maintenanceWindowStartTime(
            maintenanceWindowStartTime: MaintenanceWindowProperty
        ) {
            cdkBuilder.maintenanceWindowStartTime(
                maintenanceWindowStartTime.let(MaintenanceWindowProperty::unwrap)
            )
        }
    ...
    public companion object {
        ...
        ): CfnBroker = CfnBroker(cdkObject)

        internal fun unwrap(
            wrapped: CfnBroker
        ): software.amazon.awscdk.services.amazonmq.CfnBroker = wrapped.cdkObject
    }
    ...
    public interface LdapServerMetadataProperty {
         ...
         * succeeds, then the user is assigned the the value of the `cn` attribute for each role
         * entry that they are a member of.
         *
         ...
         * `{0}` placeholder in the search filter. The client's username is substituted into the
         * `{1}` placeholder. For example, if you set this option to `(member=uid={1})` for the user
         * janedoe, the search filter becomes `(member=uid=janedoe)` after string substitution. It
         * matches all role entries that have a member attribute equal to `uid=janedoe` under the
         * subtree selected by the `RoleBases` .
         *
         ...
         * directory entry. The `UserRoleName` option allows you to provide the name of this
         * attribute.
         *
         ...
         * example, if this option is set to `(uid={0})` and the received username is `janedoe` ,
         * the search filter becomes `(uid=janedoe)` after string substitution. It will result in
         * matching an entry like `uid=janedoe` , `ou=Users` , `ou=corp` , `dc=corp` , `dc=example`
         * , `dc=com` .
         *
        ...
        public interface Builder {
            /**
             * @param hosts Specifies the location of the LDAP server such as AWS Directory Service
            ...
            /**
             * @param roleBase The distinguished name of the node in the directory information tree
            ...
            /**
             * @param roleName The group name attribute in a role entry whose value is the name of
             *   that role. For example, you can specify `cn` for a group entry's common name. If
             *   authentication succeeds, then the user is assigned the the value of the `cn`
             *   attribute for each role entry that they are a member of.
             */
            public fun roleName(roleName: String)

            /**
             * @param roleSearchMatching The LDAP search filter used to find roles within the
             *   roleBase. The distinguished name of the user matched by userSearchMatching is
             *   substituted into the `{0}` placeholder in the search filter. The client's username
             *   is substituted into the `{1}` placeholder. For example, if you set this option to
            ...
            /**
             * @param roleSearchSubtree The directory search scope for the role. If set to true,
            ...
            /**
             * @param serviceAccountPassword Service account password. A service account is an
             *   account in your LDAP server that has access to initiate a connection. For example,
             *   `cn=admin` , `dc=corp` , `dc=example` , `dc=com` .
             */
            public fun serviceAccountPassword(serviceAccountPassword: String)

            /**
             * @param serviceAccountUsername Service account username. A service account is an
             *   account in your LDAP server that has access to initiate a connection. For example,
            ...
            /**
             * @param userBase Select a particular subtree of the directory information tree (DIT)
             *   to search for user entries. The subtree is specified by a DN, which specifies the
             *   base node of the subtree. For example, by setting this option to `ou=Users` ,
             *   `ou=corp` , `dc=corp` , `dc=example` , `dc=com` , the search for user entries is
            ...
            /**
             * @param userRoleName The name of the LDAP attribute in the user's directory entry for
             *   the user's group membership. In some cases, user roles may be identified by the
             *   value of an attribute in the user's directory entry. The `UserRoleName` option
             *   allows you to provide the name of this attribute.
             */
            public fun userRoleName(userRoleName: String)

            /**
             * @param userSearchMatching The LDAP search filter used to find users within the
             *   `userBase` .
             *
             * The client's username is substituted into the `{0}` placeholder in the search filter.
             * For example, if this option is set to `(uid={0})` and the received username is
             * `janedoe` , the search filter becomes `(uid=janedoe)` after string substitution. It
             * will result in matching an entry like `uid=janedoe` , `ou=Users` , `ou=corp` ,
             * `dc=corp` , `dc=example` , `dc=com` .
             */
            public fun userSearchMatching(userSearchMatching: String)

            /**
             * @param userSearchSubtree The directory search scope for the user. If set to true,
             *   scope is to search the entire subtree.
             */
        ...
        internal constructor(
             ...
             * The LDAP search filter used to find roles within the roleBase.
             *
             * The distinguished name of the user matched by userSearchMatching is substituted into
             * the `{0}` placeholder in the search filter. The client's username is substituted into
             ...
             * `uid=janedoe` under the subtree selected by the `RoleBases` .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-amazonmq-broker-ldapservermetadata.html#cfn-amazonmq-broker-ldapservermetadata-rolesearchmatching)
             */
             ...
             * The subtree is specified by a DN, which specifies the base node of the subtree. For
             * example, by setting this option to `ou=Users` , `ou=corp` , `dc=corp` , `dc=example`
             * , `dc=com` , the search for user entries is restricted to the subtree beneath
             ...
             * membership.
             *
             * In some cases, user roles may be identified by the value of an attribute in the
             * user's directory entry. The `UserRoleName` option allows you to provide the name of
             * this attribute.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-amazonmq-broker-ldapservermetadata.html#cfn-amazonmq-broker-ldapservermetadata-userrolename)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: LdapServerMetadataProperty
            ): software.amazon.awscdk.services.amazonmq.CfnBroker.LdapServerMetadataProperty =
    ...
    public interface UserProperty {
         ...
         *
         * This value must be at least 12 characters long, must contain at least 4 unique
         ...
         * dashes, periods, underscores, and tildes (- . _ ~). For Amazon MQ for RabbitMQ brokers,
         * this value can contain only alphanumeric characters, dashes, periods, underscores (- .
         * _). This value must not contain a tilde (~) character. Amazon MQ prohibts using guest as
        ...
        public interface Builder {
            /**
             * @param consoleAccess Enables access to the ActiveMQ web console for the ActiveMQ
             ...
             *   This value can contain only alphanumeric characters, dashes, periods, underscores,
             *   and tildes (- . _ ~). This value must be 2-100 characters long. Does not apply to
             *   RabbitMQ brokers.
             */
            ...
            /**
             * @param replicationUser Defines if this user is intended for CRDR replication
             *   purposes.
             */
            ...
            /**
             * @param username The username of the broker user. For Amazon MQ for ActiveMQ brokers,
             *   this value can contain only alphanumeric characters, dashes, periods, underscores,
             *   and tildes (- . _ ~). For Amazon MQ for RabbitMQ brokers, this value can contain
             *   only alphanumeric characters, dashes, periods, underscores (- . _). This value must
             ...
             * sensitive information in broker usernames. Broker usernames are accessible to other
             * AWS services, including CloudWatch Logs . Broker usernames are not intended to be
        ...
        internal constructor(
             ...
             * characters, dashes, periods, underscores, and tildes (- . _ ~). For Amazon MQ for
    ...
    public interface EncryptionOptionsProperty {
        ...
        public interface Builder {
            /**
             * @param kmsKeyId The customer master key (CMK) to use for the A AWS KMS (KMS). This
             *   key is used to encrypt your data at rest. If not provided, Amazon MQ will use a
             *   default CMK to encrypt your data.
             */
            public fun kmsKeyId(kmsKeyId: String)

            /**
             * @param useAwsOwnedKey Enables the use of an AWS owned CMK using AWS KMS (KMS). Set to
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: EncryptionOptionsProperty
            ): software.amazon.awscdk.services.amazonmq.CfnBroker.EncryptionOptionsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface LogListProperty {
         ...
         *
         * Every user management action made using JMX or the ActiveMQ Web Console is logged. Does
        ...
        public interface Builder {
            /**
             * @param audit Enables audit logging. Every user management action made using JMX or
    ...
    public interface MaintenanceWindowProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param timeZone The time zone, UTC by default, in either the Country/City format, or
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: MaintenanceWindowProperty
            ): software.amazon.awscdk.services.amazonmq.CfnBroker.MaintenanceWindowProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
