...
public interface AcceleratorAttributes {
    ...
    public interface Builder {
        ...
        /**
         * @param dualStackDnsName The DNS name that points to the dual-stack accelerator's four
    ...
    internal constructor(
        ...
        /**
         * The DNS name that points to the dual-stack accelerator's four static IP addresses: two
