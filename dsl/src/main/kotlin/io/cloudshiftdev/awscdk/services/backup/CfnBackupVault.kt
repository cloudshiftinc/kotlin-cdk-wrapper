...
internal constructor(
     ...
     * the Region where they are created. They consist of lowercase and uppercase letters, numbers,
     * and hyphens.
     */
    ...
    public open fun backupVaultTags(): Map<String, String> =
        unwrap(this).getBackupVaultTags() ?: emptyMap()
    ...
    public open fun lockConfiguration(
        `value`: LockConfigurationTypeProperty.Builder.() -> Unit
    ): Unit = lockConfiguration(LockConfigurationTypeProperty(`value`))
    ...
    public open fun notifications(
        `value`: NotificationObjectTypeProperty.Builder.() -> Unit
    ): Unit = notifications(NotificationObjectTypeProperty(`value`))
    ...
    public interface Builder {
         ...
         *
         * @param accessPolicy A resource-based policy that is used to manage access permissions on
         ...
         *
         * @param backupVaultTags Metadata that you can assign to help organize the resources that
         *   you create.
         */
         ...
         * handles encryption for backups from services that do not yet support full AWS Backup ,
         * see
         ...
         *
         * @param encryptionKeyArn A server-side encryption key you can specify to encrypt your
         *   backups from services that support full AWS Backup management;.
         */
        ...
        public fun lockConfiguration(
            lockConfiguration: LockConfigurationTypeProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
        ...
        override fun lockConfiguration(lockConfiguration: LockConfigurationTypeProperty) {
            cdkBuilder.lockConfiguration(
                lockConfiguration.let(LockConfigurationTypeProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("4a71402da52619170c8b22fd24486cad861ae95c5fa738d771d76af2f598f4f1")
        override fun lockConfiguration(
            lockConfiguration: LockConfigurationTypeProperty.Builder.() -> Unit
        ...
        override fun notifications(
            notifications: NotificationObjectTypeProperty.Builder.() -> Unit
        ): Unit = notifications(NotificationObjectTypeProperty(notifications))

        public fun build(): software.amazon.awscdk.services.backup.CfnBackupVault =
            cdkBuilder.build()
    }
    ...
    public interface NotificationObjectTypeProperty {
        ...
        public interface Builder {
            /**
             * @param backupVaultEvents An array of events that indicate the status of jobs to back
             *   up resources to the backup vault. For valid events, see
             *   [BackupVaultEvents](https://docs.aws.amazon.com/aws-backup/latest/devguide/API_PutBackupVaultNotifications.html#API_PutBackupVaultNotifications_RequestSyntax)
             *   in the *AWS Backup API Guide* .
             */
            ...
            /**
             * @param snsTopicArn An ARN that uniquely identifies an Amazon Simple Notification
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: NotificationObjectTypeProperty
            ): software.amazon.awscdk.services.backup.CfnBackupVault.NotificationObjectTypeProperty =
    ...
    public interface LockConfigurationTypeProperty {
         ...
         * date.
         *
         * For example, setting `ChangeableForDays` to 30 on Jan. 1, 2022 at 8pm UTC will set the
         * lock date to Jan. 31, 2022 at 8pm UTC.
         *
        ...
        public interface Builder {
            /**
             * @param changeableForDays The AWS Backup Vault Lock configuration that specifies the
             *   number of days before the lock date. For example, setting `ChangeableForDays` to 30
             *   on Jan. 1, 2022 at 8pm UTC will set the lock date to Jan. 31, 2022 at 8pm UTC.
             *
             * AWS Backup enforces a 72-hour cooling-off period before Vault Lock takes effect and
             * becomes immutable. Therefore, you must set `ChangeableForDays` to 3 or greater.
             *
            ...
            /**
             * @param maxRetentionDays The AWS Backup Vault Lock configuration that specifies the
             *   maximum retention period that the vault retains its recovery points. This setting
             *   can be useful if, for example, your organization's policies require you to destroy
             ...
             * retention period. If the job's retention period is longer than that maximum retention
             * period, then the vault fails the backup or copy job, and you should either modify
             * your lifecycle settings or use a different vault. Recovery points already saved in
             * the vault prior to Vault Lock are not affected.
             */
            public fun maxRetentionDays(maxRetentionDays: Number)

            /**
             * @param minRetentionDays The AWS Backup Vault Lock configuration that specifies the
             *   minimum retention period that the vault retains its recovery points. This setting
             *   can be useful if, for example, your organization's policies require you to retain
             ...
             * modify your lifecycle settings or use a different vault. Recovery points already
        ...
        internal constructor(
            ...
            /**
             * The AWS Backup Vault Lock configuration that specifies the number of days before the
             * lock date.
             *
             * For example, setting `ChangeableForDays` to 30 on Jan. 1, 2022 at 8pm UTC will set
             * the lock date to Jan. 31, 2022 at 8pm UTC.
             *
             * AWS Backup enforces a 72-hour cooling-off period before Vault Lock takes effect and
             * becomes immutable. Therefore, you must set `ChangeableForDays` to 3 or greater.
             *
            ...
            /**
             * The AWS Backup Vault Lock configuration that specifies the maximum retention period
             * that the vault retains its recovery points.
             *
             * This setting can be useful if, for example, your organization's policies require you
            ...
            /**
             * The AWS Backup Vault Lock configuration that specifies the minimum retention period
             * that the vault retains its recovery points.
             *
             * This setting can be useful if, for example, your organization's policies require you
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: LockConfigurationTypeProperty
            ): software.amazon.awscdk.services.backup.CfnBackupVault.LockConfigurationTypeProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
