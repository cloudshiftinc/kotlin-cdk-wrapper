...
internal constructor(
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnTrustAnchor
        ): software.amazon.awscdk.services.rolesanywhere.CfnTrustAnchor = wrapped.cdkObject
    }

    public interface SourceDataProperty {
        /**
         * The root certificate of the AWS Private Certificate Authority specified by this ARN is
         * used in trust validation for temporary credential requests.
         *
        ...
        public interface Builder {
            /**
             * @param acmPcaArn The root certificate of the AWS Private Certificate Authority
             *   specified by this ARN is used in trust validation for temporary credential
            ...
            /**
             * @param x509CertificateData The PEM-encoded data for the certificate anchor. Included
        ...
        internal constructor(
            ...
            /**
             * The root certificate of the AWS Private Certificate Authority specified by this ARN
             * is used in trust validation for temporary credential requests.
             *
             * Included for trust anchors of type `AWS_ACM_PCA` .
             *
             * This field is not supported in your region.
    ...
    public interface NotificationSettingProperty {
        ...
        public interface Builder {
            /**
             * @param channel The specified channel of notification. IAM Roles Anywhere uses
             *   CloudWatch metrics, EventBridge , and AWS Health Dashboard to notify for an event.
             *
             * In the absence of a specific channel, IAM Roles Anywhere applies this setting to
             * 'ALL' channels.
             */
            ...
            /**
             * @param threshold The number of days before a notification event. This value is
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: NotificationSettingProperty
            ): software.amazon.awscdk.services.rolesanywhere.CfnTrustAnchor.NotificationSettingProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SourceProperty {
        ...
        public interface Builder {
            /**
             * @param sourceData A union object representing the data field of the TrustAnchor
