...
public interface CustomReason {
    ...
    public interface Builder {
        /**
         * @param onExitCode A glob string that will match on the job exit code. For example,
         *   `'40*'` will match 400, 404, 40123456789012
         */
        public fun onExitCode(onExitCode: String)

        /**
         * @param onReason A glob string that will match on the reason returned by the exiting job
         *   For example, `'CannotPullContainerError*'` indicates that container needed to start the
         *   job could not be pulled.
         */
    ...
    internal constructor(
        ...
        /**
         * A glob string that will match on the reason returned by the exiting job For example,
         * `'CannotPullContainerError*'` indicates that container needed to start the job could not
         * be pulled.
         *
         * Default: - will not match on the reason
         */
    ...
    public companion object {
        ...
        ): CustomReason = Wrapper(cdkObject)

        internal fun unwrap(
            wrapped: CustomReason
        ): software.amazon.awscdk.services.batch.CustomReason = (wrapped as Wrapper).cdkObject
    }
}
