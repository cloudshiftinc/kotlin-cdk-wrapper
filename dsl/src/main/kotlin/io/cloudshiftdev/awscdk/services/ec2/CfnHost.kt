...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param assetId The ID of the Outpost hardware asset on which the Dedicated Host is
         *   allocated.
         */
         ...
         *
         * @param autoPlacement Indicates whether the host accepts any untargeted instance launches
         *   that match its instance type configuration, or if it only accepts Host tenancy instance
         *   launches that specify its unique host ID.
         */
         ...
         *
         * @param hostRecovery Indicates whether to enable or disable host recovery for the
         *   Dedicated Host.
         */
        ...
        /**
         * The Amazon Resource Name (ARN) of the AWS Outpost on which the Dedicated Host is
         * allocated.
         *
         ...
         *
         * @param outpostArn The Amazon Resource Name (ARN) of the AWS Outpost on which the
