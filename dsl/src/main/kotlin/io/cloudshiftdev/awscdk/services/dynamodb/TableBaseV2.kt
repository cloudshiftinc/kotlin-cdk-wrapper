...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.dynamodb.TableBaseV2,
     ...
     * this table if one was configured.
     *
     ...
     * PutItem, UpdateItem, DeleteItem, DescribeTable.
     *
     * Note: Appropriate grants will also be added to the customer-managed KMS keys associated with
     * this table if one was configured.
     *
    ...
    public open fun metricThrottledRequestsForOperation(
        ...
        unwrap(this)
            .metricThrottledRequestsForOperation(
                operation,
                props.let(OperationsMetricOptions::unwrap)
            )
            .let(IMetric::wrap)
    ...
    ): IMetric = metricThrottledRequestsForOperation(operation, OperationsMetricOptions(props))
     ...
     *
     * Note: This metric reports user errors across all the tables in the account and region the
     * table resides in.
     *
     * By default, the metric will be calculated as a sum over a period of 5 minutes. You can
     * customize this by using the `statistic` and `period` properties.
    ...
    internal constructor(
        internal val cdkObject: software.amazon.awscdk.services.dynamodb.TableBaseV2,
    ...
    public companion object {
        ...
        ): TableBaseV2 = Wrapper(cdkObject)

        internal fun unwrap(
            wrapped: TableBaseV2
        ): software.amazon.awscdk.services.dynamodb.TableBaseV2 = (wrapped as Wrapper).cdkObject
    }
}
