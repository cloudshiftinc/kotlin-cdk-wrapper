...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.guardduty.CfnMember,
    ...
    public interface Builder {
         ...
         *
         * @param disableEmailNotification Specifies whether or not to disable email notification
         *   for the member account that you invite.
         */
         ...
         * member account and its administrator account.
         *
         * Valid values are `Created` and `Invited` when using an `AWS::GuardDuty::Member` resource.
         * If the value for this property is not provided or set to `Created` , a member account is
         * created but not invited. If the value of this property is set to `Invited` , a member
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnMember
        ): software.amazon.awscdk.services.guardduty.CfnMember = wrapped.cdkObject
    }
}
