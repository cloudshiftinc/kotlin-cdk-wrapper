...
public enum class TagOperation(
    ...
    public companion object {
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.backup.TagOperation
        ): TagOperation =
            when (cdkObject) {
        ...
        internal fun unwrap(
            wrapped: TagOperation
        ): software.amazon.awscdk.services.backup.TagOperation = wrapped.cdkObject
    }
}
