...
internal constructor(
    ...
    public open fun proactiveEngagementStatus(): String =
        unwrap(this).getProactiveEngagementStatus()
    ...
    public interface Builder {
        /**
         * The list of email addresses and phone numbers that the Shield Response Team (SRT) can use
         * to contact you for escalations to the SRT and to initiate proactive customer support,
         * plus any relevant notes.
         *
         * To enable proactive engagement, the contact list must include at least one phone number.
         *
         * If you provide more than one contact, in the notes, indicate the circumstances under
         * which each contact should be used. Include primary and secondary contact designations,
         * and provide the hours of availability and time zones for each contact.
         *
         * Example contact notes:
         * * This is a hotline that's staffed 24x7x365. Please work with the responding analyst and
         *   they will get the appropriate person on the call.
         * * Please contact the secondary phone number if the hotline doesn't respond within 5
         *   minutes.
         *
         ...
         * Valid values:
         *
         * `ENABLED` - The Shield Response Team (SRT) will use email and phone to notify contacts
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnProactiveEngagement
    ...
    public interface EmergencyContactProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: EmergencyContactProperty
            ): software.amazon.awscdk.services.shield.CfnProactiveEngagement.EmergencyContactProperty =
