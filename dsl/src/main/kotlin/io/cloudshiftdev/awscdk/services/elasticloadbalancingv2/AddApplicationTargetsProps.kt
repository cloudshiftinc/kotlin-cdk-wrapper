...
public interface AddApplicationTargetsProps : AddRuleProps {
    ...
    public fun loadBalancingAlgorithmType(): TargetGroupLoadBalancingAlgorithmType? =
        unwrap(this)
            ...
            ?.let(TargetGroupLoadBalancingAlgorithmType::wrap)
     ...
     *
     * Can be `Instance`, `IPAddress`, or any self-registering load balancing target. All target
    ...
    public interface Builder {
         ...
         *   target a linearly increasing share of the traffic to the target group. The range is
         *   30-900 seconds (15 minutes).
         */
        public fun slowStart(slowStart: Duration)

        /**
         * @param stickinessCookieDuration The stickiness cookie expiration period. Setting this
         *   value enables load balancer stickiness.
         *
         * After this period, the cookie is considered stale. The minimum value is 1 second and the
         * maximum value is 7 days (604800 seconds).
         */
        ...
        /**
         * @param stickinessCookieName The name of an application-based stickiness cookie. Names
         *   that start with the following prefixes are not allowed: AWSALB, AWSALBAPP, and
         *   AWSALBTG; they're reserved for use by the load balancer.
         *
        ...
        /**
         * @param targetGroupName The name of the target group. This name must be unique per region
        ...
        /**
         * @param targets The targets to add to this target group. Can be `Instance`, `IPAddress`,
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: AddApplicationTargetsProps
        ): software.amazon.awscdk.services.elasticloadbalancingv2.AddApplicationTargetsProps =
