...
public interface Volume {
     ...
     *
     * When specifying Amazon EFS volumes in tasks using the Fargate launch type, Fargate creates a
     ...
     * querying the task metadata version 4 endpoint, but is not visible in CloudWatch Container
     * Insights.
     *
     ...
     * types. The contents of the host parameter determine whether your bind mount host volume
     * persists on the host container instance and where it is stored. If the host parameter is
     * empty, then the Docker daemon assigns a host path for your data volume. However, the data is
     ...
     *
     * Up to 255 letters (uppercase and lowercase), numbers, and hyphens are allowed. This name is
    ...
    public interface Builder {
         ...
         *   volumes. Docker volumes are only supported when you are using the EC2 launch type.
        ...
        public fun dockerVolumeConfiguration(
            dockerVolumeConfiguration: DockerVolumeConfiguration.Builder.() -> Unit
        )

        /**
         * @param efsVolumeConfiguration This property is specified when you are using Amazon EFS.
         *   When specifying Amazon EFS volumes in tasks using the Fargate launch type, Fargate
         *   creates a supervisor container that is responsible for managing the Amazon EFS volume.
         *   The supervisor container uses a small amount of the task's memory. The supervisor
         *   container is visible when querying the task metadata version 4 endpoint, but is not
        ...
        public fun efsVolumeConfiguration(
            efsVolumeConfiguration: EfsVolumeConfiguration.Builder.() -> Unit
        )

        /**
         * @param host This property is specified when you are using bind mount host volumes. Bind
         *   mount host volumes are supported when you are using either the EC2 or Fargate launch
         *   types. The contents of the host parameter determine whether your bind mount host volume
         ...
         *   and hyphens are allowed. This name is referenced in the sourceVolume parameter of
    ...
    private class BuilderImpl : Builder {
        ...
        override fun dockerVolumeConfiguration(
            ...
            cdkBuilder.dockerVolumeConfiguration(
                dockerVolumeConfiguration.let(DockerVolumeConfiguration::unwrap)
            )
        }
        ...
        override fun efsVolumeConfiguration(efsVolumeConfiguration: EfsVolumeConfiguration) {
            cdkBuilder.efsVolumeConfiguration(
                efsVolumeConfiguration.let(EfsVolumeConfiguration::unwrap)
            )
        }
    ...
    internal constructor(
         ...
         * This property is specified when you are using Docker volumes.
         *
         * Docker volumes are only supported when you are using the EC2 launch type. Windows
         ...
         * The name of the volume.
         *
         * Up to 255 letters (uppercase and lowercase), numbers, and hyphens are allowed. This name
    ...
    public companion object {
        ...
        internal fun unwrap(wrapped: Volume): software.amazon.awscdk.services.ecs.Volume =
