...
internal constructor(
    ...
    public interface Builder {
         ...
         * The maximum operating resources that this rule group can use.
         *
         * You can't change a rule group's capacity setting after you create the rule group. When
         * you update a rule group, you are limited to this capacity. When you reference a rule
         ...
         * Indicates whether the rule group is stateless or stateful.
         *
         * If the rule group is stateless, it contains stateless rules. If it is stateful, it
    ...
    public interface IPSetProperty {
        ...
        private class BuilderImpl : Builder {
            ...
            /** @param definition The list of IP addresses and address ranges, in CIDR notation. */
            override fun definition(vararg definition: String): Unit =
    ...
    public interface CustomActionProperty {
        ...
        public interface Builder {
            ...
            public fun actionDefinition(
                actionDefinition: ActionDefinitionProperty.Builder.() -> Unit
            )

            /**
             * @param actionName The descriptive name of the custom action. You can't change the
    ...
    public interface RulesSourceProperty {
         ...
         * ports, direction, and rule options. For information about the Suricata `Rules` format,
         * see
        ...
        public interface Builder {
            ...
            /**
             * @param rulesString Stateful inspection criteria, provided in Suricata compatible
             *   rules. Suricata is an open-source threat detection framework that includes a
            ...
            /**
             * @param statefulRules An array of individual stateful rules inspection criteria to be
             *   used together in a stateful rule group. Use this option to specify simple Suricata
             *   rules with protocol, source and destination, ports, direction, and rule options.
            ...
            public fun statelessRulesAndCustomActions(
                statelessRulesAndCustomActions:
                    StatelessRulesAndCustomActionsProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("4c7c626f64d529118eaa4e54bb67e966574361929b99cc5af792bcd0b173bb69")
            override fun rulesSourceList(
                rulesSourceList: RulesSourceListProperty.Builder.() -> Unit
             ...
             *   stateless rule group.
             */
            override fun statelessRulesAndCustomActions(
                statelessRulesAndCustomActions: IResolvable
            ) {
                cdkBuilder.statelessRulesAndCustomActions(
                    statelessRulesAndCustomActions.let(IResolvable::unwrap)
                )
            }
            ...
            override fun statelessRulesAndCustomActions(
                ...
                cdkBuilder.statelessRulesAndCustomActions(
                    statelessRulesAndCustomActions.let(
                        StatelessRulesAndCustomActionsProperty::unwrap
                    )
                )
            }
            ...
            override fun statelessRulesAndCustomActions(
                ...
                statelessRulesAndCustomActions(
                    StatelessRulesAndCustomActionsProperty(statelessRulesAndCustomActions)
                )
        ...
        internal constructor(
             ...
             * Stateful inspection criteria, provided in Suricata compatible rules.
             *
             * Suricata is an open-source threat detection framework that includes a standard
             ...
             * destination, ports, direction, and rule options. For information about the Suricata
             * `Rules` format, see
             * [Rules Format](https://docs.aws.amazon.com/https://suricata.readthedocs.io/en/suricata-6.0.9/rules/intro.html)
             * .
             *
    ...
    public interface StatelessRulesAndCustomActionsProperty {
        ...
        public interface Builder {
            /**
             * @param customActions Defines an array of individual custom action definitions that
             *   are available for use by the stateless rules in this
             *   `StatelessRulesAndCustomActions` specification. You name each custom action that
             *   you define, and then you can use it by name in your stateless rule
             *   `RuleGroup.RuleDefinition` `Actions` specification.
             */
            ...
            /**
             * @param statelessRules Defines the set of stateless rules for use in a stateless rule
             *   group.
             */
        ...
        internal constructor(
             ...
             * by the stateless rules in this `StatelessRulesAndCustomActions` specification.
             *
             * You name each custom action that you define, and then you can use it by name in your
             * stateless rule `RuleGroup.RuleDefinition` `Actions` specification.
             *
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: StatelessRulesAndCustomActionsProperty
            ): software.amazon.awscdk.services.networkfirewall.CfnRuleGroup.StatelessRulesAndCustomActionsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface PortRangeProperty {
        ...
        public interface Builder {
            /**
             * @param fromPort The lower limit of the port range. This must be less than or equal to
             *   the `ToPort` specification.
             */
            public fun fromPort(fromPort: Number)

            /**
             * @param toPort The upper limit of the port range. This must be greater than or equal
             *   to the `FromPort` specification.
             */
    ...
    public interface RuleDefinitionProperty {
         ...
         *   intended destination.
         * * *aws:forward_to_sfe* - Discontinues stateless inspection of the packet and forwards it
         *   to the stateful rule engine for inspection.
         *
         * Additionally, you can specify a custom action. To do this, you define a custom action by
         * name and type, then provide the name you've assigned to the action in this `Actions`
         * setting.
         *
         ...
         * , then you could specify the standard action `aws:pass` combined with the custom action
         * using `[“aws:pass”, “MyMetricsAction”]` .
         *
        ...
        public interface Builder {
             ...
             *   definition's match attributes. You must specify a standard action and you can add
             *   custom actions.
             *
             * Network Firewall only forwards a packet for stateful rule inspection if you specify
             * `aws:forward_to_sfe` for a rule that the packet matches, or if the packet doesn't
             * match any stateless rule and you specify `aws:forward_to_sfe` for the
             * `StatelessDefaultActions` setting for the `FirewallPolicy` .
             *
             * For every rule, you must specify exactly one of the following standard actions.
             * * *aws:pass* - Discontinues all inspection of the packet and permits it to go to its
             *   intended destination.
             * * *aws:drop* - Discontinues all inspection of the packet and blocks it from going to
             ...
             * by name and type, then provide the name you've assigned to the action in this
             * `Actions` setting.
             *
             * To provide more than one action in this setting, separate the settings with a comma.
             * For example, if you have a publish metrics custom action that you've named
             * `MyMetricsAction` , then you could specify the standard action `aws:pass` combined
             * with the custom action using `[“aws:pass”, “MyMetricsAction”]` .
             */
            ...
            /**
             * @param matchAttributes Criteria for Network Firewall to use to inspect an individual
             *   packet in stateless rule inspection. Each match attributes set can include one or
             *   more items such as IP address, CIDR range, port number, protocol, and TCP flags.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("be49946981ce0bea8247a6726d3b4ecc81fddd180a7d520f19c5edb1676fcccb")
            override fun matchAttributes(
                matchAttributes: MatchAttributesProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * rule inspection.
             *
             * Each match attributes set can include one or more items such as IP address, CIDR
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RuleDefinitionProperty
            ): software.amazon.awscdk.services.networkfirewall.CfnRuleGroup.RuleDefinitionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface StatefulRuleProperty {
         ...
         * * *DROP* - Blocks the packets from going to the intended destination and sends an alert
         *   log message, if alert logging is configured in the `Firewall` `LoggingConfiguration` .
         * * *REJECT* - Drops traffic that matches the conditions of the stateful rule and sends a
         *   TCP reset packet back to sender of the packet. A TCP reset packet is a packet with no
         *   payload and a `RST` bit contained in the TCP header flags. `REJECT` is available only
         *   for TCP traffic.
         ...
         * * *REJECT* - Drops TCP traffic that matches the conditions of the stateful rule, and
         *   sends a TCP reset packet back to sender of the packet. A TCP reset packet is a packet
         *   with no payload and a `RST` bit contained in the TCP header flags. Also sends an alert
         *   log mesage if alert logging is configured in the `Firewall` `LoggingConfiguration` .
         *
        ...
        public interface Builder {
            /**
             * @param action Defines what Network Firewall should do with the packets in a traffic
             *   flow when the flow matches the stateful rule criteria. For all actions, Network
             *   Firewall performs the specified action and discontinues stateful inspection of the
             *   traffic flow.
             *
             * The actions for a stateful rule are defined as follows:
             * * *PASS* - Permits the packets to go to the intended destination.
             * * *DROP* - Blocks the packets from going to the intended destination and sends an
             *   alert log message, if alert logging is configured in the `Firewall`
             *   `LoggingConfiguration` .
             * * *REJECT* - Drops traffic that matches the conditions of the stateful rule and sends
             *   a TCP reset packet back to sender of the packet. A TCP reset packet is a packet
             *   with no payload and a `RST` bit contained in the TCP header flags. `REJECT` is
             *   available only for TCP traffic.
             * * *ALERT* - Permits the packets to go to the intended destination and sends an alert
             *   log message, if alert logging is configured in the `Firewall`
             *   `LoggingConfiguration` .
             *
             ...
             * * *REJECT* - Drops TCP traffic that matches the conditions of the stateful rule, and
             *   sends a TCP reset packet back to sender of the packet. A TCP reset packet is a
             *   packet with no payload and a `RST` bit contained in the TCP header flags. Also
             *   sends an alert log mesage if alert logging is configured in the `Firewall`
             *   `LoggingConfiguration` .
             *
             * `REJECT` isn't currently available for use with IMAP and FTP protocols.
             */
        ...
        private class BuilderImpl : Builder {
             ...
             *   settings.
             */
            override fun ruleOptions(vararg ruleOptions: Any): Unit =
                ruleOptions(ruleOptions.toList())
        ...
        internal constructor(
             ...
             *
             * For all actions, Network Firewall performs the specified action and discontinues
    ...
    public interface MatchAttributesProperty {
         ...
         *
         * If not specified, this matches with any settings. This setting is only used for protocol
         * 6 (TCP).
         *
        ...
        public interface Builder {
            /**
             * @param destinationPorts The destination ports to inspect for. If not specified, this
             *   matches with any destination port. This setting is only used for protocols 6 (TCP)
             *   and 17 (UDP).
             *
             * You can specify individual ports, for example `1994` and you can specify port ranges,
             * for example `1990:1994` .
             */
            ...
            /**
             * @param destinations The destination IP addresses and address ranges to inspect for,
            ...
            /**
             * @param protocols The protocols to inspect for, specified using each protocol's
             *   assigned internet protocol number (IANA). If not specified, this matches with any
             *   protocol.
             */
            ...
            /**
             * @param sourcePorts The source ports to inspect for. If not specified, this matches
             *   with any source port. This setting is only used for protocols 6 (TCP) and 17 (UDP).
             *
             * You can specify individual ports, for example `1994` and you can specify port ranges,
             * for example `1990:1994` .
             */
            ...
            /**
             * @param sources The source IP addresses and address ranges to inspect for, in CIDR
            ...
            /**
             * @param tcpFlags The TCP flags and masks to inspect for. If not specified, this
        ...
        private class BuilderImpl : Builder {
             ...
             * for example `1990:1994` .
             */
            override fun sourcePorts(vararg sourcePorts: Any): Unit =
        ...
        internal constructor(
             ...
             * The destination ports to inspect for.
             *
             * If not specified, this matches with any destination port. This setting is only used
             ...
             * The TCP flags and masks to inspect for.
             *
             * If not specified, this matches with any settings. This setting is only used for
             * protocol 6 (TCP).
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-networkfirewall-rulegroup-matchattributes.html#cfn-networkfirewall-rulegroup-matchattributes-tcpflags)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: MatchAttributesProperty
            ): software.amazon.awscdk.services.networkfirewall.CfnRuleGroup.MatchAttributesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface StatefulRuleOptionsProperty {
        ...
        public interface Builder {
            /**
             * @param ruleOrder Indicates how to manage the order of the rule evaluation for the
             *   rule group. `DEFAULT_ACTION_ORDER` is the default behavior. Stateful rules are
             *   provided to the rule engine as Suricata compatible strings, and Suricata evaluates
             *   them based on certain settings. For more information, see
             *   [Evaluation order for stateful rules](https://docs.aws.amazon.com/network-firewall/latest/developerguide/suricata-rule-evaluation-order.html)
             *   in the *AWS Network Firewall Developer Guide* .
             */
        ...
        internal constructor(
             ...
             * certain settings. For more information, see
             * [Evaluation order for stateful rules](https://docs.aws.amazon.com/network-firewall/latest/developerguide/suricata-rule-evaluation-order.html)
             * in the *AWS Network Firewall Developer Guide* .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-networkfirewall-rulegroup-statefulruleoptions.html#cfn-networkfirewall-rulegroup-statefulruleoptions-ruleorder)
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: StatefulRuleOptionsProperty
            ): software.amazon.awscdk.services.networkfirewall.CfnRuleGroup.StatefulRuleOptionsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface RuleOptionProperty {
         ...
         * `sid:112233` . The sid must be unique within the rule group. For information about
         * Suricata rule option keywords, see
         ...
         * settings depends on the keyword. The format for Settings is `number` . For information
         * about Suricata rule option settings, see
         * [Rule options](https://docs.aws.amazon.com/https://suricata.readthedocs.io/en/suricata-6.0.9/rules/intro.html#rule-options)
         * .
         *
        ...
        public interface Builder {
             ...
             *   signature ID (sid) is required in the format `sid:112233` . The sid must be unique
             *   within the rule group. For information about Suricata rule option keywords, see
             *   [Rule options](https://docs.aws.amazon.com/https://suricata.readthedocs.io/en/suricata-6.0.9/rules/intro.html#rule-options)
             *   .
             */
            ...
            /**
             * @param settings The Suricata rule option settings. Settings have zero or more values,
             *   and the number of possible settings and required settings depends on the keyword.
             *   The format for Settings is `number` . For information about Suricata rule option
             *   settings, see
             *   [Rule options](https://docs.aws.amazon.com/https://suricata.readthedocs.io/en/suricata-6.0.9/rules/intro.html#rule-options)
             *   .
             */
        ...
        internal constructor(
             ...
             *
             * Settings have zero or more values, and the number of possible settings and required
             * settings depends on the keyword. The format for Settings is `number` . For
             * information about Suricata rule option settings, see
             * [Rule options](https://docs.aws.amazon.com/https://suricata.readthedocs.io/en/suricata-6.0.9/rules/intro.html#rule-options)
             * .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-networkfirewall-rulegroup-ruleoption.html#cfn-networkfirewall-rulegroup-ruleoption-settings)
    ...
    public interface StatelessRuleProperty {
        ...
        public interface Builder {
            /**
             * @param priority Indicates the order in which to run this rule relative to all of the
             ...
             *   that the priority settings are unique for the rule group.
             *
             * Each stateless rule group uses exactly one `StatelessRulesAndCustomActions` object,
             * and each `StatelessRulesAndCustomActions` contains exactly one `StatelessRules`
             ...
             *
             * You can change the priority settings of your rules at any time. To make it easier to
             * insert rules later, number them so there's a wide range in between, for example use
             * 100, 200, and so on.
             */
            public fun priority(priority: Number)

            /**
             * @param ruleDefinition Defines the stateless 5-tuple packet inspection criteria and
             *   the action to take on a packet that matches the criteria.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("43c34ade5d18e8bd5988d3b80759936fc07623d0552b77d061fbdfc8c246238e")
            override fun ruleDefinition(
                ruleDefinition: RuleDefinitionProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * defined for a stateless rule group.
             *
             * Network Firewall evaluates the rules in a rule group starting with the lowest
             * priority setting. You must ensure that the priority settings are unique for the rule
             * group.
             *
             * Each stateless rule group uses exactly one `StatelessRulesAndCustomActions` object,
             * and each `StatelessRulesAndCustomActions` contains exactly one `StatelessRules`
    ...
    public interface RulesSourceListProperty {
        ...
        public interface Builder {
            /**
             * @param generatedRulesType Whether you want to allow or deny access to the domains in
             *   your target list.
             */
            public fun generatedRulesType(generatedRulesType: String)

            /**
             * @param targetTypes The types of targets to inspect for. Valid values are `TLS_SNI`
             *   and `HTTP_HOST` .
             */
            ...
            /**
             * @param targets The domains that you want to inspect for in your traffic flows. Valid
        ...
        private class BuilderImpl : Builder {
             ...
             *   and `HTTP_HOST` .
             */
            override fun targetTypes(vararg targetTypes: String): Unit =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RulesSourceListProperty
            ): software.amazon.awscdk.services.networkfirewall.CfnRuleGroup.RulesSourceListProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ActionDefinitionProperty {
        ...
        public interface Builder {
             ...
             *   metrics to Amazon CloudWatch for the matching packet. This setting defines a
            ...
            public fun publishMetricAction(
                publishMetricAction: PublishMetricActionProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun publishMetricAction(publishMetricAction: PublishMetricActionProperty) {
                cdkBuilder.publishMetricAction(
                    publishMetricAction.let(PublishMetricActionProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("9c709e38e77861004c23b0b23e18c692c5afae875be2890cf84ebfddc0c185d9")
            override fun publishMetricAction(
                publishMetricAction: PublishMetricActionProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * CloudWatch for the matching packet.
             *
             * This setting defines a CloudWatch dimension value to be published.
             *
             * You can pair this custom action with any of the standard stateless rule actions. For
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ActionDefinitionProperty
            ): software.amazon.awscdk.services.networkfirewall.CfnRuleGroup.ActionDefinitionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface PublishMetricActionProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: PublishMetricActionProperty
            ): software.amazon.awscdk.services.networkfirewall.CfnRuleGroup.PublishMetricActionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface IPSetReferenceProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: IPSetReferenceProperty
            ): software.amazon.awscdk.services.networkfirewall.CfnRuleGroup.IPSetReferenceProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface RuleGroupProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param ruleVariables Settings that are available for use in the rules in the rule
             ...
             *   stateful rules. The policies where you use your stateful rule group must have
             *   stateful rule options settings that are compatible with these settings. Some
            ...
            public fun statefulRuleOptions(
                statefulRuleOptions: StatefulRuleOptionsProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("1577f3e6419db0c8458a5cdac88441f1950350eadcc541cbcb17e3d1ca51d9e6")
            override fun referenceSets(
                referenceSets: ReferenceSetsProperty.Builder.() -> Unit
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("62687cd1cde86cf76a66787e1727f8e8d85bf027028723533321731ccd238059")
            override fun ruleVariables(
                ruleVariables: RuleVariablesProperty.Builder.() -> Unit
            ...
            override fun statefulRuleOptions(statefulRuleOptions: StatefulRuleOptionsProperty) {
                cdkBuilder.statefulRuleOptions(
                    statefulRuleOptions.let(StatefulRuleOptionsProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("745a88ef4d06c5778c2314ae57d8e53da7108f628231f00a66a0eabd68805809")
            override fun statefulRuleOptions(
                statefulRuleOptions: StatefulRuleOptionsProperty.Builder.() -> Unit
    ...
    public interface AddressProperty {
        ...
        public interface Builder {
            /**
             * @param addressDefinition Specify an IP address or a block of IP addresses in
             *   Classless Inter-Domain Routing (CIDR) notation. Network Firewall supports all
    ...
    public interface HeaderProperty {
         ...
         *
         * If set to `ANY` , the inspection matches bidirectional traffic, both from the source to
         * the destination and from the destination to the source. If set to `FORWARD` , the
        ...
        public interface Builder {
            /**
             * @param destination The destination IP address or address range to inspect for, in
             *   CIDR notation. To match with any address, specify `ANY` .
             *
             * Specify an IP address or a block of IP addresses in Classless Inter-Domain Routing
            ...
            /**
             * @param destinationPort The destination port to inspect for. You can specify an
             *   individual port, for example `1994` and you can specify a port range, for example
             *   `1990:1994` . To match with any port, specify `ANY` .
             */
            public fun destinationPort(destinationPort: String)

            /**
             * @param direction The direction of traffic flow to inspect. If set to `ANY` , the
             *   inspection matches bidirectional traffic, both from the source to the destination
             *   and from the destination to the source. If set to `FORWARD` , the inspection only
             *   matches traffic going from the source to the destination.
             */
            public fun direction(direction: String)

            /**
             * @param protocol The protocol to inspect for. To specify all, you can use `IP` ,
             *   because all traffic on AWS and on the internet is IP.
             */
            public fun protocol(protocol: String)

            /**
             * @param source The source IP address or address range to inspect for, in CIDR
             ...
             *   for example `1994` and you can specify a port range, for example `1990:1994` . To
        ...
        internal constructor(
             ...
             * The destination port to inspect for.
             *
             * You can specify an individual port, for example `1994` and you can specify a port
             * range, for example `1990:1994` . To match with any port, specify `ANY` .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-networkfirewall-rulegroup-header.html#cfn-networkfirewall-rulegroup-header-destinationport)
             */
             ...
             * The direction of traffic flow to inspect.
             *
             * If set to `ANY` , the inspection matches bidirectional traffic, both from the source
             * to the destination and from the destination to the source. If set to `FORWARD` , the
             * inspection only matches traffic going from the source to the destination.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-networkfirewall-rulegroup-header.html#cfn-networkfirewall-rulegroup-header-direction)
             */
             ...
             * The protocol to inspect for.
             *
             * To specify all, you can use `IP` , because all traffic on AWS and on the internet is
             * IP.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-networkfirewall-rulegroup-header.html#cfn-networkfirewall-rulegroup-header-protocol)
             */
    ...
    public interface TCPFlagFieldProperty {
         ...
         * flags that must not be set in order for the packet to match.
         *
        ...
        public interface Builder {
            /**
             * @param flags Used in conjunction with the `Masks` setting to define the flags that
             *   must be set and flags that must not be set in order for the packet to match. This
            ...
            /**
             * @param masks The set of flags to consider in the inspection. To inspect all flags in
