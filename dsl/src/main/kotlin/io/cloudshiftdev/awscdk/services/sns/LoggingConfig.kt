...
public interface LoggingConfig {
     ...
     * Default: None
     */
    public fun failureFeedbackRole(): IRole? =
     ...
     * Default: None
     */
    public fun successFeedbackRole(): IRole? =
    ...
    public interface Builder {
        /**
         * @param failureFeedbackRole The IAM role to be used when logging failed message deliveries
        ...
        /**
         * @param successFeedbackRole The IAM role to be used when logging successful message
         ...
         *   logged in Amazon CloudWatch. Valid values are integer between 0-100
         */
    ...
    internal constructor(
        ...
        /** Indicates one of the supported protocols for the SNS topic. */
        override fun protocol(): LoggingProtocol =
         ...
         * Default: None
         */
        override fun successFeedbackSampleRate(): Number? =
    ...
    public companion object {
        ...
        ): LoggingConfig = Wrapper(cdkObject)

        internal fun unwrap(
            wrapped: LoggingConfig
        ): software.amazon.awscdk.services.sns.LoggingConfig = (wrapped as Wrapper).cdkObject
    }
}
