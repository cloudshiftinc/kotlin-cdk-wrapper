...
internal constructor(
    ...
    public open fun elasticsearchConfig(
        `value`: ElasticsearchConfigProperty.Builder.() -> Unit
    ): Unit = elasticsearchConfig(ElasticsearchConfigProperty(`value`))
    ...
    public open fun openSearchServiceConfig(`value`: OpenSearchServiceConfigProperty) {
        unwrap(this)
            .setOpenSearchServiceConfig(`value`.let(OpenSearchServiceConfigProperty::unwrap))
    }

    /** AWS Region and Endpoints for an Amazon OpenSearch Service domain in your account. */
    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("91b6688c97e2b6484edfbfcf4fd03c030800e3fad8600f188de4d1ac9717d780")
    public open fun openSearchServiceConfig(
        `value`: OpenSearchServiceConfigProperty.Builder.() -> Unit
    ): Unit = openSearchServiceConfig(OpenSearchServiceConfigProperty(`value`))
    ...
    public open fun relationalDatabaseConfig(`value`: RelationalDatabaseConfigProperty) {
        unwrap(this)
            .setRelationalDatabaseConfig(`value`.let(RelationalDatabaseConfigProperty::unwrap))
    }

    /** Relational Database configuration of the relational database data source. */
    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("deddcd787d4e34169de7fdff78aa257416249c83b6cd9a650996203375316d9f")
    public open fun relationalDatabaseConfig(
        `value`: RelationalDatabaseConfigProperty.Builder.() -> Unit
    ...
    public interface Builder {
         ...
         *
         * @param dynamoDbConfig AWS Region and TableName for an Amazon DynamoDB table in your
         *   account.
         */
         ...
         *
         * @param elasticsearchConfig AWS Region and Endpoints for an Amazon OpenSearch Service
        ...
        public fun elasticsearchConfig(
            elasticsearchConfig: ElasticsearchConfigProperty.Builder.() -> Unit
        )
         ...
         *
         * @param eventBridgeConfig An EventBridge configuration that contains a valid ARN of an
         *   event bus.
         */
        ...
        public fun eventBridgeConfig(
            eventBridgeConfig: EventBridgeConfigProperty.Builder.() -> Unit
        )
         ...
         * Enables or disables enhanced data source metrics for specified data sources.
         *
         * Note that `MetricsConfig` won't be used unless the `dataSourceLevelMetricsBehavior` value
         * is set to `PER_DATA_SOURCE_METRICS` . If the `dataSourceLevelMetricsBehavior` is set to
        ...
        public fun openSearchServiceConfig(
            openSearchServiceConfig: OpenSearchServiceConfigProperty.Builder.() -> Unit
        )
         ...
         *
         * @param relationalDatabaseConfig Relational Database configuration of the relational
        ...
        public fun relationalDatabaseConfig(
            relationalDatabaseConfig: RelationalDatabaseConfigProperty.Builder.() -> Unit
        )
         ...
         * `AMAZON_ELASTICSEARCH` , `AMAZON_EVENTBRIDGE` , or `AMAZON_OPENSEARCH_SERVICE` .
         *
         ...
         *
         * @param serviceRoleArn The AWS Identity and Access Management service role ARN for the
         *   data source.
         */
    ...
    private class BuilderImpl(
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("0bf043b8a0324e8cba83c896eb3b8de672374ba174fe1c1840e63db4787ab86d")
        override fun dynamoDbConfig(
            dynamoDbConfig: DynamoDBConfigProperty.Builder.() -> Unit
        ...
        override fun elasticsearchConfig(elasticsearchConfig: ElasticsearchConfigProperty) {
            cdkBuilder.elasticsearchConfig(
                elasticsearchConfig.let(ElasticsearchConfigProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("af23ba3c1884605cbefd293bf604520c0a4999decc3132972519ce6c8f566eec")
        override fun elasticsearchConfig(
            elasticsearchConfig: ElasticsearchConfigProperty.Builder.() -> Unit
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("c4c74ddc3490714ef3189129995dee44bb1ca9c7bfba1a9a6bdb7d2451070dd2")
        override fun eventBridgeConfig(
            eventBridgeConfig: EventBridgeConfigProperty.Builder.() -> Unit
         ...
         *   domain in your account.
         */
        override fun openSearchServiceConfig(
            openSearchServiceConfig: OpenSearchServiceConfigProperty
        ) {
            cdkBuilder.openSearchServiceConfig(
                openSearchServiceConfig.let(OpenSearchServiceConfigProperty::unwrap)
            )
        }
         ...
         *   database data source.
         */
        override fun relationalDatabaseConfig(
            relationalDatabaseConfig: RelationalDatabaseConfigProperty
        ) {
            cdkBuilder.relationalDatabaseConfig(
                relationalDatabaseConfig.let(RelationalDatabaseConfigProperty::unwrap)
            )
        }
        ...
        override fun relationalDatabaseConfig(
            ...
            relationalDatabaseConfig(RelationalDatabaseConfigProperty(relationalDatabaseConfig))
        ...
        public fun build(): software.amazon.awscdk.services.appsync.CfnDataSource =
            cdkBuilder.build()
    }
    ...
    public interface EventBridgeConfigProperty {
         ...
         *
         * For more information about event buses, see
        ...
        public interface Builder {
            /**
             * @param eventBusArn The event bus pipeline's ARN. For more information about event
             *   buses, see
             *   [EventBridge event buses](https://docs.aws.amazon.com/eventbridge/latest/userguide/eb-event-bus.html)
             *   .
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: EventBridgeConfigProperty
            ): software.amazon.awscdk.services.appsync.CfnDataSource.EventBridgeConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface RelationalDatabaseConfigProperty {
        ...
        public interface Builder {
            ...
            public fun rdsHttpEndpointConfig(
                rdsHttpEndpointConfig: RdsHttpEndpointConfigProperty.Builder.() -> Unit
            )
        ...
        private class BuilderImpl : Builder {
            ...
            /** @param rdsHttpEndpointConfig Information about the Amazon RDS resource. */
            override fun rdsHttpEndpointConfig(
                rdsHttpEndpointConfig: RdsHttpEndpointConfigProperty
            ) {
                cdkBuilder.rdsHttpEndpointConfig(
                    rdsHttpEndpointConfig.let(RdsHttpEndpointConfigProperty::unwrap)
                )
            }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RelationalDatabaseConfigProperty
            ): software.amazon.awscdk.services.appsync.CfnDataSource.RelationalDatabaseConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface OpenSearchServiceConfigProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: OpenSearchServiceConfigProperty
            ): software.amazon.awscdk.services.appsync.CfnDataSource.OpenSearchServiceConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface AwsIamConfigProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param signingServiceName The signing service name for AWS Identity and Access
    ...
    public interface ElasticsearchConfigProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ElasticsearchConfigProperty
            ): software.amazon.awscdk.services.appsync.CfnDataSource.ElasticsearchConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DeltaSyncConfigProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param deltaSyncTableTtl The number of minutes that a Delta Sync log entry is stored
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DeltaSyncConfigProperty
            ): software.amazon.awscdk.services.appsync.CfnDataSource.DeltaSyncConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DynamoDBConfigProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param useCallerCredentials Set to `TRUE` to use AWS Identity and Access Management
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("a1002deaccd15ebe98dae193da399c9a598c2958f044db78528bbe004ff78089")
            override fun deltaSyncConfig(
                deltaSyncConfig: DeltaSyncConfigProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DynamoDBConfigProperty
            ): software.amazon.awscdk.services.appsync.CfnDataSource.DynamoDBConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface RdsHttpEndpointConfigProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param awsSecretStoreArn The ARN for database credentials stored in AWS Secrets
             *   Manager .
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RdsHttpEndpointConfigProperty
            ): software.amazon.awscdk.services.appsync.CfnDataSource.RdsHttpEndpointConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
