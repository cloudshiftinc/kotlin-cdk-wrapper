...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param serverSideEncryption A ServerSideEncryption can be enabled to encrypt assets that
         *   are put into assetBucket.
         */
        public fun serverSideEncryption(serverSideEncryption: ServerSideEncryption)

        /**
         * For AWS_KMS ServerSideEncryption a KMS KeyId must be provided which will be used to
         * encrypt assets.
         *
         * Default: - No KMS KeyId and SSE_KMS encryption cannot be used
         *
         * @param serverSideEncryptionAwsKmsKeyId For AWS_KMS ServerSideEncryption a KMS KeyId must
         *   be provided which will be used to encrypt assets.
         */
