    ...
    public companion object {
        public fun ebs(volumeSize: Number): BlockDeviceVolume =
            software.amazon.awscdk.services.autoscaling.BlockDeviceVolume.ebs(volumeSize)
                .let(BlockDeviceVolume::wrap)

        public fun ebs(volumeSize: Number, options: EbsDeviceOptions): BlockDeviceVolume =
            software.amazon.awscdk.services.autoscaling.BlockDeviceVolume.ebs(
                    volumeSize,
                    options.let(EbsDeviceOptions::unwrap)
                )
                .let(BlockDeviceVolume::wrap)
        ...
        public fun ebsFromSnapshot(
            ...
            software.amazon.awscdk.services.autoscaling.BlockDeviceVolume.ebsFromSnapshot(
                    snapshotId,
                    options.let(EbsDeviceSnapshotOptions::unwrap)
                )
                .let(BlockDeviceVolume::wrap)
        ...
        public fun ebsFromSnapshot(
            snapshotId: String,
            options: EbsDeviceSnapshotOptions.Builder.() -> Unit
        ): BlockDeviceVolume = ebsFromSnapshot(snapshotId, EbsDeviceSnapshotOptions(options))

        public fun ephemeral(volumeIndex: Number): BlockDeviceVolume =
            software.amazon.awscdk.services.autoscaling.BlockDeviceVolume.ephemeral(volumeIndex)
                .let(BlockDeviceVolume::wrap)

        public fun noDevice(): BlockDeviceVolume =
            software.amazon.awscdk.services.autoscaling.BlockDeviceVolume.noDevice()
                .let(BlockDeviceVolume::wrap)
