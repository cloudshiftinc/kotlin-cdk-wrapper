...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param amazonSideAsn The private Autonomous System Number (ASN) for the Amazon side of a
         *   BGP session.
         */
    ...
    public companion object {
        ...
        ): CfnVPNGateway = CfnVPNGateway(cdkObject)

        internal fun unwrap(
            wrapped: CfnVPNGateway
        ): software.amazon.awscdk.services.ec2.CfnVPNGateway = wrapped.cdkObject
    }
}
