...
internal constructor(
    ...
    public open fun streamingDistributionConfig(): Any =
        unwrap(this).getStreamingDistributionConfig()
    ...
    public open fun streamingDistributionConfig(`value`: StreamingDistributionConfigProperty) {
        unwrap(this)
            .setStreamingDistributionConfig(
                `value`.let(StreamingDistributionConfigProperty::unwrap)
            )
    }
    ...
    public open fun streamingDistributionConfig(
        `value`: StreamingDistributionConfigProperty.Builder.() -> Unit
    ...
    public interface Builder {
        ...
        public fun streamingDistributionConfig(
            streamingDistributionConfig: StreamingDistributionConfigProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.cloudfront.CfnStreamingDistribution.Builder.create(
                scope,
                id
            )
        ...
        override fun streamingDistributionConfig(streamingDistributionConfig: IResolvable) {
            cdkBuilder.streamingDistributionConfig(
                streamingDistributionConfig.let(IResolvable::unwrap)
            )
        }
         ...
         *   distribution.
         */
        override fun streamingDistributionConfig(
            streamingDistributionConfig: StreamingDistributionConfigProperty
        ) {
            cdkBuilder.streamingDistributionConfig(
                streamingDistributionConfig.let(StreamingDistributionConfigProperty::unwrap)
            )
        }
        ...
        override fun streamingDistributionConfig(
            ...
            streamingDistributionConfig(
                StreamingDistributionConfigProperty(streamingDistributionConfig)
            )
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnStreamingDistribution
    ...
    public interface StreamingDistributionConfigProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param enabled Whether the streaming distribution is enabled to accept user requests
             *   for content.
             */
             ...
             *   from which you want CloudFront to get your media files for distribution.
             */
             ...
             *   permit to create signed URLs for private content. If you want the distribution to
             *   use signed URLs, include this element; if you want the distribution to use public
             *   URLs, remove this element. For more information, see
             *   [Serving Private Content through CloudFront](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/PrivateContent.html)
             *   in the *Amazon CloudFront Developer Guide* .
             */
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("743ef977a158c5f6c2f051d502ab89211e8cda4e0e8658699025623e3dd74121")
            override fun trustedSigners(
                trustedSigners: TrustedSignersProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             *
             * If you want the distribution to use signed URLs, include this element; if you want
             * the distribution to use public URLs, remove this element. For more information, see
             * [Serving Private Content through CloudFront](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/PrivateContent.html)
             * in the *Amazon CloudFront Developer Guide* .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-cloudfront-streamingdistribution-streamingdistributionconfig.html#cfn-cloudfront-streamingdistribution-streamingdistributionconfig-trustedsigners)
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: StreamingDistributionConfigProperty
            ): software.amazon.awscdk.services.cloudfront.CfnStreamingDistribution.StreamingDistributionConfigProperty =
    ...
    public interface S3OriginProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param originAccessIdentity The CloudFront origin access identity to associate with
             *   the distribution. Use an origin access identity to configure the distribution so
             *   that end users can only access objects in an Amazon S3 bucket through CloudFront.
             *
        ...
        internal constructor(
             ...
             * The CloudFront origin access identity to associate with the distribution.
             *
             * Use an origin access identity to configure the distribution so that end users can
    ...
    public interface LoggingProperty {
         ...
         *
         * If you don't want to enable logging when you create a streaming distribution or if you
         ...
         * this streaming distribution, for example, `myprefix/` .
         *
        ...
        public interface Builder {
             ...
             *   S3 bucket. If you don't want to enable logging when you create a streaming
             *   distribution or if you want to disable logging for an existing streaming
             *   distribution, specify `false` for `Enabled` , and specify `empty Bucket` and
             *   `Prefix` elements. If you specify `false` for `Enabled` but you specify values for
        ...
        internal constructor(
             ...
             * you want to disable logging for an existing streaming distribution, specify `false`
    ...
    public interface TrustedSignersProperty {
        /**
         * An AWS account number that contains active CloudFront key pairs that CloudFront can use
         ...
         */
        public fun awsAccountNumbers(): List<String> =
            unwrap(this).getAwsAccountNumbers() ?: emptyList()
        ...
        public interface Builder {
            /**
             * @param awsAccountNumbers An AWS account number that contains active CloudFront key
             *   pairs that CloudFront can use to verify the signatures of signed URLs and signed
             *   cookies. If the AWS account that owns the key pairs is the same account that owns
             *   the CloudFront distribution, the value of this field is `self` .
             */
            ...
            /**
             * @param enabled This field is `true` if any of the AWS accounts in the list are
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-cloudfront-streamingdistribution-trustedsigners.html#cfn-cloudfront-streamingdistribution-trustedsigners-awsaccountnumbers)
             */
            override fun awsAccountNumbers(): List<String> =
                unwrap(this).getAwsAccountNumbers() ?: emptyList()
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TrustedSignersProperty
            ): software.amazon.awscdk.services.cloudfront.CfnStreamingDistribution.TrustedSignersProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
