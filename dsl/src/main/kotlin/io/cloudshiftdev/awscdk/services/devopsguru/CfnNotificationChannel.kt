...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param config A `NotificationChannelConfig` object that contains information about
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.devopsguru.CfnNotificationChannel.Builder.create(
                scope,
                id
            )
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnNotificationChannel
    ...
    public interface NotificationFilterConfigProperty {
         ...
         * `MEDIUM` severity levels. For more information, see
        ...
        public interface Builder {
            /**
             * @param messageTypes The events that you want to receive notifications for. For
             *   example, you can choose to receive notifications only when the severity level is
             *   upgraded or a new insight is created.
             */
             ...
             *   example, you can choose to receive notifications only for insights with `HIGH` and
             *   `MEDIUM` severity levels. For more information, see
             *   [Understanding insight severities](https://docs.aws.amazon.com/devops-guru/latest/userguide/working-with-insights.html#understanding-insights-severities)
             *   .
             */
        ...
        private class BuilderImpl : Builder {
             ...
             *   .
             */
            override fun severities(vararg severities: String): Unit =
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-devopsguru-notificationchannel-notificationfilterconfig.html#cfn-devopsguru-notificationchannel-notificationfilterconfig-messagetypes)
             */
            override fun messageTypes(): List<String> =
                unwrap(this).getMessageTypes() ?: emptyList()

            /**
             * The severity levels that you want to receive notifications for.
             *
             * For example, you can choose to receive notifications only for insights with `HIGH`
             * and `MEDIUM` severity levels. For more information, see
             * [Understanding insight severities](https://docs.aws.amazon.com/devops-guru/latest/userguide/working-with-insights.html#understanding-insights-severities)
             * .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-devopsguru-notificationchannel-notificationfilterconfig.html#cfn-devopsguru-notificationchannel-notificationfilterconfig-severities)
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: NotificationFilterConfigProperty
            ): software.amazon.awscdk.services.devopsguru.CfnNotificationChannel.NotificationFilterConfigProperty =
    ...
    public interface NotificationChannelConfigProperty {
        ...
        public interface Builder {
             ...
             *   use with DevOps Guru. If you do not provide filter configurations, the default
             ...
             *   notifications when insights are created. If you use an Amazon SNS topic in another
             *   account, you must attach a policy to it that grants DevOps Guru permission to send
             *   it notifications. DevOps Guru adds the required policy on your behalf to send
             *   notifications using Amazon SNS in your account. DevOps Guru only supports standard
        ...
        private class BuilderImpl : Builder {
            ...
            override fun filters(
                filters: NotificationFilterConfigProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * Guru.
             *
             * If you do not provide filter configurations, the default configurations are to
             ...
             * account. DevOps Guru only supports standard SNS topics. For more information, see
             * [Permissions for Amazon SNS topics](https://docs.aws.amazon.com/devops-guru/latest/userguide/sns-required-permissions.html)
             * .
             *
             * If you use an Amazon SNS topic that is encrypted by an AWS Key Management Service
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: NotificationChannelConfigProperty
            ): software.amazon.awscdk.services.devopsguru.CfnNotificationChannel.NotificationChannelConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SnsChannelConfigProperty {
        ...
        public interface Builder {
            /**
             * @param topicArn The Amazon Resource Name (ARN) of an Amazon Simple Notification
             *   Service topic.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SnsChannelConfigProperty
            ): software.amazon.awscdk.services.devopsguru.CfnNotificationChannel.SnsChannelConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
