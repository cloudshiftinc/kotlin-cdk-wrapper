...
internal constructor(
    ...
    /** The type of client authentication used to connect to the Apache Kafka cluster. */
    public open fun kafkaClusterClientAuthentication(
        `value`: KafkaClusterClientAuthenticationProperty
    ) {
        unwrap(this)
            .setKafkaClusterClientAuthentication(
                `value`.let(KafkaClusterClientAuthenticationProperty::unwrap)
            )
    }
    ...
    public open fun kafkaClusterClientAuthentication(
        `value`: KafkaClusterClientAuthenticationProperty.Builder.() -> Unit
    ...
    /** Details of encryption in transit to the Apache Kafka cluster. */
    public open fun kafkaClusterEncryptionInTransit(
        `value`: KafkaClusterEncryptionInTransitProperty
    ) {
        unwrap(this)
            .setKafkaClusterEncryptionInTransit(
                `value`.let(KafkaClusterEncryptionInTransitProperty::unwrap)
            )
    }
    ...
    public open fun kafkaClusterEncryptionInTransit(
        `value`: KafkaClusterEncryptionInTransitProperty.Builder.() -> Unit
    ...
    public open fun workerConfiguration(
        `value`: WorkerConfigurationProperty.Builder.() -> Unit
    ): Unit = workerConfiguration(WorkerConfigurationProperty(`value`))
    ...
    public interface Builder {
         ...
         *
         * @param kafkaClusterClientAuthentication The type of client authentication used to connect
        ...
        public fun kafkaClusterClientAuthentication(
            kafkaClusterClientAuthentication:
                KafkaClusterClientAuthenticationProperty.Builder.() -> Unit
        )
         ...
         *
         * @param kafkaClusterEncryptionInTransit Details of encryption in transit to the Apache
         *   Kafka cluster.
         */
        ...
        public fun kafkaClusterEncryptionInTransit(
            kafkaClusterEncryptionInTransit:
                KafkaClusterEncryptionInTransitProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
         ...
         *   to the Apache Kafka cluster.
         */
        override fun kafkaClusterClientAuthentication(
            kafkaClusterClientAuthentication: IResolvable
        ) {
            cdkBuilder.kafkaClusterClientAuthentication(
                kafkaClusterClientAuthentication.let(IResolvable::unwrap)
            )
        }
        ...
        override fun kafkaClusterClientAuthentication(
            ...
            cdkBuilder.kafkaClusterClientAuthentication(
                kafkaClusterClientAuthentication.let(
                    KafkaClusterClientAuthenticationProperty::unwrap
                )
            )
        }
        ...
        override fun kafkaClusterClientAuthentication(
            ...
            kafkaClusterClientAuthentication(
                KafkaClusterClientAuthenticationProperty(kafkaClusterClientAuthentication)
            )
        ...
        override fun kafkaClusterEncryptionInTransit(kafkaClusterEncryptionInTransit: IResolvable) {
            cdkBuilder.kafkaClusterEncryptionInTransit(
                kafkaClusterEncryptionInTransit.let(IResolvable::unwrap)
            )
        }
         ...
         *   Kafka cluster.
         */
        override fun kafkaClusterEncryptionInTransit(
            kafkaClusterEncryptionInTransit: KafkaClusterEncryptionInTransitProperty
        ) {
            cdkBuilder.kafkaClusterEncryptionInTransit(
                kafkaClusterEncryptionInTransit.let(KafkaClusterEncryptionInTransitProperty::unwrap)
            )
        }
        ...
        override fun kafkaClusterEncryptionInTransit(
            ...
            kafkaClusterEncryptionInTransit(
                KafkaClusterEncryptionInTransitProperty(kafkaClusterEncryptionInTransit)
            )
    ...
    public interface ApacheKafkaClusterProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param vpc Details of an Amazon VPC which has network connectivity to the Apache
             *   Kafka cluster.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ApacheKafkaClusterProperty
            ): software.amazon.awscdk.services.kafkaconnect.CfnConnector.ApacheKafkaClusterProperty =
    ...
    public interface CloudWatchLogsLogDeliveryProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CloudWatchLogsLogDeliveryProperty
            ): software.amazon.awscdk.services.kafkaconnect.CfnConnector.CloudWatchLogsLogDeliveryProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface KafkaClusterEncryptionInTransitProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: KafkaClusterEncryptionInTransitProperty
            ): software.amazon.awscdk.services.kafkaconnect.CfnConnector.KafkaClusterEncryptionInTransitProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CapacityProperty {
        ...
        public interface Builder {
            ...
            public fun provisionedCapacity(
                provisionedCapacity: ProvisionedCapacityProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun provisionedCapacity(provisionedCapacity: ProvisionedCapacityProperty) {
                cdkBuilder.provisionedCapacity(
                    provisionedCapacity.let(ProvisionedCapacityProperty::unwrap)
                )
            }
    ...
    public interface WorkerConfigurationProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param workerConfigurationArn The Amazon Resource Name (ARN) of the worker
             *   configuration.
             */
    ...
    public interface ScaleOutPolicyProperty {
        ...
        public interface Builder {
            /**
             * @param cpuUtilizationPercentage The CPU utilization percentage threshold at which you
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-kafkaconnect-connector-scaleoutpolicy.html#cfn-kafkaconnect-connector-scaleoutpolicy-cpuutilizationpercentage)
             */
            override fun cpuUtilizationPercentage(): Number =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ScaleOutPolicyProperty
            ): software.amazon.awscdk.services.kafkaconnect.CfnConnector.ScaleOutPolicyProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ScaleInPolicyProperty {
        ...
        public interface Builder {
            /**
             * @param cpuUtilizationPercentage Specifies the CPU utilization percentage threshold at
    ...
    public interface ProvisionedCapacityProperty {
        ...
        public interface Builder {
            /**
             * @param mcuCount The number of microcontroller units (MCUs) allocated to each
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ProvisionedCapacityProperty
            ): software.amazon.awscdk.services.kafkaconnect.CfnConnector.ProvisionedCapacityProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface FirehoseLogDeliveryProperty {
        ...
        public interface Builder {
            /**
             * @param deliveryStream The name of the Kinesis Data Firehose delivery stream that is
             *   the destination for log delivery.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: FirehoseLogDeliveryProperty
            ): software.amazon.awscdk.services.kafkaconnect.CfnConnector.FirehoseLogDeliveryProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface KafkaClusterClientAuthenticationProperty {
        ...
        public interface Builder {
            /**
             * @param authenticationType The type of client authentication used to connect to the
             *   Apache Kafka cluster. Value NONE means that no client authentication is used.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: KafkaClusterClientAuthenticationProperty
            ): software.amazon.awscdk.services.kafkaconnect.CfnConnector.KafkaClusterClientAuthenticationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface KafkaClusterProperty {
        ...
        public interface Builder {
            /**
             * @param apacheKafkaCluster The Apache Kafka cluster to which the connector is
             *   connected.
             */
            ...
            public fun apacheKafkaCluster(
                apacheKafkaCluster: ApacheKafkaClusterProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun apacheKafkaCluster(apacheKafkaCluster: ApacheKafkaClusterProperty) {
                cdkBuilder.apacheKafkaCluster(
                    apacheKafkaCluster.let(ApacheKafkaClusterProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("d733d131c117c3d594dc55c27b1ce3ba06a34359fe5f405a937694015bf92eda")
            override fun apacheKafkaCluster(
                apacheKafkaCluster: ApacheKafkaClusterProperty.Builder.() -> Unit
    ...
    public interface WorkerLogDeliveryProperty {
        ...
        public interface Builder {
            ...
            public fun cloudWatchLogs(
                cloudWatchLogs: CloudWatchLogsLogDeliveryProperty.Builder.() -> Unit
            )
        ...
        private class BuilderImpl : Builder {
            ...
            override fun cloudWatchLogs(cloudWatchLogs: CloudWatchLogsLogDeliveryProperty) {
                cdkBuilder.cloudWatchLogs(
                    cloudWatchLogs.let(CloudWatchLogsLogDeliveryProperty::unwrap)
                )
            }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: WorkerLogDeliveryProperty
            ): software.amazon.awscdk.services.kafkaconnect.CfnConnector.WorkerLogDeliveryProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface LogDeliveryProperty {
        ...
        public interface Builder {
            ...
            public fun workerLogDelivery(
                workerLogDelivery: WorkerLogDeliveryProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun workerLogDelivery(workerLogDelivery: WorkerLogDeliveryProperty) {
                cdkBuilder.workerLogDelivery(
                    workerLogDelivery.let(WorkerLogDeliveryProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("a798e2587e298cbcf87002ac2e8daf944a99c15ed912f790fac86650d746959f")
            override fun workerLogDelivery(
                workerLogDelivery: WorkerLogDeliveryProperty.Builder.() -> Unit
    ...
    public interface AutoScalingProperty {
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("924a00c92bc533726be73cecf82968cb4d0833bcbd4018288d92d9c5250bc720")
            override fun scaleInPolicy(
                scaleInPolicy: ScaleInPolicyProperty.Builder.() -> Unit
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("758b465f5bd575830bc6a5bd3795c00ca401ed930331d39366b2312db08cbbf3")
            override fun scaleOutPolicy(
                scaleOutPolicy: ScaleOutPolicyProperty.Builder.() -> Unit
