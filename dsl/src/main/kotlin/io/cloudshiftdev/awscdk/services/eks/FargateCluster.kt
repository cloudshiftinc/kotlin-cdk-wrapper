...
internal constructor(
    ...
    private class BuilderImpl(
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("dc860ea781697ba194a8fdaea2f9a54f5247fffaacaaa032cb4d272ce0b6e7b9")
        override fun defaultProfile(
            defaultProfile: FargateProfileOptions.Builder.() -> Unit
    ...
    public companion object {
        ...
        ): FargateCluster = FargateCluster(cdkObject)

        internal fun unwrap(
            wrapped: FargateCluster
        ): software.amazon.awscdk.services.eks.FargateCluster = wrapped.cdkObject
    }
}
