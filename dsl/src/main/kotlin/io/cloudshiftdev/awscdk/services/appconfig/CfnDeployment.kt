...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.appconfig.CfnDeployment,
    ...
    public interface Builder {
         ...
         * version number or version label. For all other configurations, you must specify the
         * version number.
         *
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.appconfig.CfnDeployment =
            cdkBuilder.build()
    }
