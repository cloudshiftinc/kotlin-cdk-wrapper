...
internal constructor(
    ...
    public interface Builder {
        ...
        /**
         * The configuration that specifies how traffic is shifted from the 'blue' target group to
         * the 'green' target group during a deployment.
         *
         * Default: AllAtOnce
         *
         * @param trafficRouting The configuration that specifies how traffic is shifted from the
         *   'blue' target group to the 'green' target group during a deployment.
         */
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.codedeploy.LambdaDeploymentConfig.Builder.create(
                scope,
                id
            )
    ...
    public companion object {
        ...
        public fun doImport(
            ...
            software.amazon.awscdk.services.codedeploy.LambdaDeploymentConfig.doImport(
                    _scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    _id,
                    props.let(LambdaDeploymentConfigImportProps::unwrap)
                )
                .let(ILambdaDeploymentConfig::wrap)
        ...
        internal fun unwrap(
            wrapped: LambdaDeploymentConfig
