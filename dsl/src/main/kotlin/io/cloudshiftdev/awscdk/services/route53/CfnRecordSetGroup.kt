...
internal constructor(
    ...
    public interface Builder {
         ...
         * hosted zones with the same domain name, you must specify the hosted zone using
         * `HostedZoneId` .
         *
         ...
         * `HostedZoneName` , AWS CloudFormation attempts to find a hosted zone whose name matches
         * the `HostedZoneName` . If AWS CloudFormation can't find a hosted zone with a matching
         * domain name, or if there is more than one hosted zone with the specified domain name, AWS
        ...
        /**
         * A complex type that contains one `RecordSet` element for each record that you want to
         * create.
         *
         ...
         *
         * @param recordSets A complex type that contains one `RecordSet` element for each record
    ...
    public interface CoordinatesProperty {
        ...
        public interface Builder {
            /**
             * @param latitude Specifies a coordinate of the north–south position of a geographic
             *   point on the surface of the Earth (-90 - 90).
             */
            public fun latitude(latitude: String)

            /**
             * @param longitude Specifies a coordinate of the east–west position of a geographic
    ...
    public interface GeoProximityLocationProperty {
         ...
         *
         * To use `Bias` to change the size of the geographic region, specify the applicable value
         * for the bias:
         * * To expand the size of the geographic region from which Route 53 routes traffic to a
         *   resource, specify a positive integer from 1 to 99 for the bias. Route 53 shrinks the
         ...
         * example, if the Local Zone is `us-east-1-bue-1a` the Local Zone Group is
         * `us-east-1-bue-1` .
         *
        ...
        public interface Builder {
            ...
            /**
             * @param bias The bias increases or decreases the size of the geographic region from
             *   which Route 53 routes traffic to a resource. To use `Bias` to change the size of
             *   the geographic region, specify the applicable value for the bias:
             * * To expand the size of the geographic region from which Route 53 routes traffic to a
             *   resource, specify a positive integer from 1 to 99 for the bias. Route 53 shrinks
             *   the size of adjacent regions.
             * * To shrink the size of the geographic region from which Route 53 routes traffic to a
             *   resource, specify a negative bias of -1 to -99. Route 53 expands the size of
             *   adjacent regions.
             */
            ...
            /**
             * @param localZoneGroup Specifies an AWS Local Zone Group. A local Zone Group is
             *   usually the Local Zone code without the ending character. For example, if the Local
             *   Zone is `us-east-1-bue-1a` the Local Zone Group is `us-east-1-bue-1` .
             *
             * You can identify the Local Zones Group for a specific Local Zone by using the
             * [describe-availability-zones](https://docs.aws.amazon.com/cli/latest/reference/ec2/describe-availability-zones.html)
             * CLI command:
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: GeoProximityLocationProperty
            ): software.amazon.awscdk.services.route53.CfnRecordSetGroup.GeoProximityLocationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CidrRoutingConfigProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CidrRoutingConfigProperty
            ): software.amazon.awscdk.services.route53.CfnRecordSetGroup.CidrRoutingConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface GeoLocationProperty {
         ...
         * [ISO standard 3166-1 alpha-2](https://docs.aws.amazon.com/https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2)
         * .
         *
         ...
         * abbreviations, see
         * [Appendix B: Two–Letter State and Possession Abbreviations](https://docs.aws.amazon.com/https://pe.usps.com/text/pub28/28apb.htm)
        ...
        public interface Builder {
            /**
             * @param continentCode For geolocation resource record sets, a two-letter abbreviation
             *   that identifies a continent. Route 53 supports the following continent codes:.
             * * *AF* : Africa
             * * *AN* : Antarctica
             * * *AS* : Asia
             * * *EU* : Europe
            ...
            /**
             * @param countryCode For geolocation resource record sets, the two-letter code for a
             *   country. Route 53 uses the two-letter country codes that are specified in
             *   [ISO standard 3166-1 alpha-2](https://docs.aws.amazon.com/https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2)
             *   .
             */
            ...
            /**
             * @param subdivisionCode For geolocation resource record sets, the two-letter code for
             *   a state of the United States. Route 53 doesn't support any other values for
    ...
    public interface AliasTargetProperty {
         ...
         * of the record. For example, if the name of the record is *acme.example.com* , your
         * CloudFront distribution must include *acme.example.com* as one of the alternate domain
         ...
         *   environment includes the region that you deployed the environment in, you can create an
         *   alias record that routes traffic to the environment. For example, the domain name
         ...
         *   console, see
         *   [Using Custom Domains with AWS Elastic Beanstalk](https://docs.aws.amazon.com/elasticbeanstalk/latest/dg/customdomains.html)
         ...
         *   `s3-website.us-east-2.amazonaws.com` . For more information about valid values, see the
         *   table
         *   [Amazon S3 Website Endpoints](https://docs.aws.amazon.com/general/latest/gr/s3.html#s3_website_region_endpoints)
         *   in the *Amazon Web Services General Reference* . For more information about using S3
         *   buckets for websites, see
         *   [Getting Started with Amazon Route 53](https://docs.aws.amazon.com/Route53/latest/DeveloperGuide/getting-started.html)
         *   in the *Amazon Route 53 Developer Guide.*
         * * **Another Route 53 record** - Specify the value of the `Name` element for a record in
         ...
         * `true` , an alias record inherits the health of the referenced AWS resource, such as an
         * ELB load balancer or another record in the hosted zone.
         *
         * Note the following:
         ...
         *   an Elastic Beanstalk environment in `DNSName` and the environment contains an ELB load
         *   balancer, Elastic Load Balancing routes queries only to the healthy Amazon EC2
         *   instances that are registered with the load balancer. (An environment automatically
         *   contains an ELB load balancer if it includes more than one Amazon EC2 instance.) If you
         *   set `EvaluateTargetHealth` to `true` and either no Amazon EC2 instances are healthy or
         *   the load balancer itself is unhealthy, Route 53 routes queries to other available
         ...
         *   the load balancer based on the health of the target groups that are associated with the
         *   load balancer:
         ...
         *   `DNSName` is a record or a group of records (for example, a group of weighted records)
         *   but is not another alias record, we recommend that you associate a health check with
         *   all of the records in the alias target. For more information, see
         ...
         * traffic:.
         * * **Amazon API Gateway custom regional APIs and edge-optimized APIs** - Specify the
         *   hosted zone ID for your API. You can get the applicable value using the AWS CLI command
         *   [get-domain-names](https://docs.aws.amazon.com/cli/latest/reference/apigateway/get-domain-names.html)
         *   :
         * * For regional APIs, specify the value of `regionalHostedZoneId` .
         * * For edge-optimized APIs, specify the value of `distributionHostedZoneId` .
         * * **Amazon Virtual Private Cloud interface VPC endpoint** - Specify the hosted zone ID
         *   for your interface endpoint. You can get the value of `HostedZoneId` using the AWS CLI
         *   command
         *   [describe-vpc-endpoints](https://docs.aws.amazon.com/cli/latest/reference/ec2/describe-vpc-endpoints.html)
         *   .
         ...
         *   created the environment in. The environment must have a regionalized subdomain. For a
         *   list of regions and the corresponding hosted zone IDs, see
         *   [AWS Elastic Beanstalk endpoints and quotas](https://docs.aws.amazon.com/general/latest/gr/elasticbeanstalk.html)
         ...
         * * [Service Endpoints](https://docs.aws.amazon.com/general/latest/gr/elb.html) table in
         *   the "Elastic Load Balancing endpoints and quotas" topic in the *Amazon Web Services
         *   General Reference* : Use the value that corresponds with the region that you created
         *   your load balancer in. Note that there are separate columns for Application and Classic
         *   Load Balancers and for Network Load Balancers.
         ...
         *   the region that you created the bucket in. For more information about valid values, see
         *   the table
         *   [Amazon S3 Website Endpoints](https://docs.aws.amazon.com/general/latest/gr/s3.html#s3_website_region_endpoints)
         *   in the *Amazon Web Services General Reference* .
        ...
        public interface Builder {
            /**
             * @param dnsName *Alias records only:* The value that you specify depends on where you
             *   want to route queries:.
             * * **Amazon API Gateway custom regional APIs and edge-optimized APIs** - Specify the
             *   applicable domain name for your API. You can get the applicable value using the AWS
             *   CLI command
             *   [get-domain-names](https://docs.aws.amazon.com/cli/latest/reference/apigateway/get-domain-names.html)
             *   :
             * * For regional APIs, specify the value of `regionalDomainName` .
             ...
             * * **Amazon Virtual Private Cloud interface VPC endpoint** - Enter the API endpoint
             *   for the interface endpoint, such as
             *   `vpce-123456789abcdef01-example-us-east-1a.elasticloadbalancing.us-east-1.vpce.amazonaws.com`
             *   . For edge-optimized APIs, this is the domain name for the corresponding CloudFront
             *   distribution. You can get the value of `DnsName` using the AWS CLI command
             *   [describe-vpc-endpoints](https://docs.aws.amazon.com/cli/latest/reference/ec2/describe-vpc-endpoints.html)
             ...
             * name of the record. For example, if the name of the record is *acme.example.com* ,
             * your CloudFront distribution must include *acme.example.com* as one of the alternate
             ...
             *   the AWS CLI .
             * * *AWS Management Console* : Go to the EC2 page, choose *Load Balancers* in the
             *   navigation pane, choose the load balancer, choose the *Description* tab, and get
             *   the value of the *DNS name* field.
             *
             * If you're routing traffic to a Classic Load Balancer, get the value that begins with
             * *dualstack* . If you're routing traffic to another type of load balancer, get the
             ...
             *   [describe-accelerator](https://docs.aws.amazon.com/cli/latest/reference/globalaccelerator/describe-accelerator.html)
             *   .
             * * **Amazon S3 bucket that is configured as a static website** - Specify the domain
             *   name of the Amazon S3 website endpoint that you created the bucket in, for example,
             ...
             *   S3 buckets for websites, see
             *   [Getting Started with Amazon Route 53](https://docs.aws.amazon.com/Route53/latest/DeveloperGuide/getting-started.html)
             *   in the *Amazon Route 53 Developer Guide.*
             * * **Another Route 53 record** - Specify the value of the `Name` element for a record
             ...
             * of `Type` is `CNAME` . This is because the alias record must have the same type as
            ...
            /**
             * @param evaluateTargetHealth *Applies only to alias records with any routing policy:*
             ...
             * * **CloudFront distributions** - You can't set `EvaluateTargetHealth` to `true` when
             *   the alias target is a CloudFront distribution.
             * * **Elastic Beanstalk environments that have regionalized subdomains** - If you
             *   specify an Elastic Beanstalk environment in `DNSName` and the environment contains
             ...
             *   that are registered with the load balancer. If you set `EvaluateTargetHealth` to
             *   `true` and either no EC2 instances are healthy or the load balancer itself is
             ...
             *   routes queries to the load balancer based on the health of the target groups that
             ...
             *   `EvaluateTargetHealth` to `true` when the alias target is an S3 bucket.
             * * **Other records in the same hosted zone** - If the AWS resource that you specify in
             *   `DNSName` is a record or a group of records (for example, a group of weighted
             *   records) but is not another alias record, we recommend that you associate a health
            ...
            /**
             * @param hostedZoneId *Alias resource records sets only* : The value used depends on
             *   where you want to route traffic:.
             * * **Amazon API Gateway custom regional APIs and edge-optimized APIs** - Specify the
             *   hosted zone ID for your API. You can get the applicable value using the AWS CLI
             *   command
             *   [get-domain-names](https://docs.aws.amazon.com/cli/latest/reference/apigateway/get-domain-names.html)
             *   :
             * * For regional APIs, specify the value of `regionalHostedZoneId` .
             * * For edge-optimized APIs, specify the value of `distributionHostedZoneId` .
             * * **Amazon Virtual Private Cloud interface VPC endpoint** - Specify the hosted zone
             *   ID for your interface endpoint. You can get the value of `HostedZoneId` using the
             *   AWS CLI command
             *   [describe-vpc-endpoints](https://docs.aws.amazon.com/cli/latest/reference/ec2/describe-vpc-endpoints.html)
             *   .
             * * **CloudFront distribution** - Specify `Z2FDTNDATAQYW2` . This is always the hosted
             *   zone ID when you create an alias record that routes traffic to a CloudFront
             *   distribution.
             *
             * Alias records for CloudFront can't be created in a private zone.
             * * **Elastic Beanstalk environment** - Specify the hosted zone ID for the region that
             *   you created the environment in. The environment must have a regionalized subdomain.
             ...
             *   your hosted zone. (An alias record can't reference a record in a different hosted
             *   zone.)
             */
            public fun hostedZoneId(hostedZoneId: String)
        }
        ...
        internal constructor(
             ...
             * is `true` , an alias record inherits the health of the referenced AWS resource, such
             * as an ELB load balancer or another record in the hosted zone.
             *
             * Note the following:
             * * **CloudFront distributions** - You can't set `EvaluateTargetHealth` to `true` when
             *   the alias target is a CloudFront distribution.
    ...
    public interface RecordSetProperty {
         ...
         * `HealthCheckId` element and specify the health check that you want Amazon Route 53 to
         ...
         * value of `CountryCode` is `*` . Two groups of queries are routed to the resource that you
         * specify in this record: queries that come from locations for which you haven't created
         * geolocation resource record sets and queries from IP addresses that aren't mapped to a
         * location. If you don't create a `*` resource record set, Route 53 returns a "no answer"
         ...
         * record set, for example, the endpoint specified by the IP address in the `Value` element.
         * When you add a `HealthCheckId` element to a resource record set, Route 53 checks the
         * health of the endpoint that you specified in the health check.
         *
         ...
         *   resource record sets that have the same routing policy, name, and type (such as
         *   multiple weighted records named www.example.com with a type of A) and you specify
         *   health check IDs for all the resource record sets.
         *
         ...
         *
         * If the health check status for all resource record sets in the group is unhealthy, Route
         * 53 considers all resource record sets in the group healthy and responds to DNS queries
         * accordingly.
         ...
         * States, for North America, and a resource record set that has `*` for `CountryCode` is
         * `*` , which applies to all locations. If the endpoint for the state resource record set
         * is unhealthy, Route 53 checks for healthy resource record sets in the following order
         ...
         *   fewer healthy records, Route 53 responds to all DNS queries with all the healthy
         *   records.
         ...
         * update, or delete.
         *
         * For `ListResourceRecordSets` responses, the name of a record in the specified hosted
         * zone.
         *
         ...
         *
         * The resource typically is an AWS resource, such as an EC2 instance or an ELB load
         ...
         * `Type` property. For information about different record types and their record formats,
         * see
         ...
         */
        public fun resourceRecords(): List<String> =
            unwrap(this).getResourceRecords() ?: emptyList()
         ...
         * `AAAA` | `CAA` | `CNAME` | `MX` | `NAPTR` | `PTR` | `SPF` | `SRV` | `TXT` . When creating
         * a group of weighted, latency, geolocation, or failover resource record sets, specify the
         ...
         * longer appropriate for SPF version 1; implementations are not to use it." In RFC 7208,
         * see section 14.1,
         * [The SPF DNS Record Type](https://docs.aws.amazon.com/http://tools.ietf.org/html/rfc7208#section-14.1)
         * .
         *
         ...
         *
         * Route 53 calculates the sum of the weights for the resource record sets that have the
         * same combination of DNS name and type. Route 53 then responds to queries based on the
         ...
         *   for a resource record set, Route 53 never responds to queries with the applicable value
         *   for that resource record set. However, if you set `Weight` to `0` for all resource
         *   record sets that have the same combination of DNS name and type, traffic is routed to
         *   all resources with equal probability.
         *
         * The effect of setting `Weight` to `0` is different when you associate health checks with
         * weighted resource record sets. For more information, see
        ...
        public interface Builder {
            /**
             * @param aliasTarget *Alias resource record sets only:* Information about the AWS
             *   resource, such as a CloudFront distribution or an Amazon S3 bucket, that you want
             *   to route traffic to. If you're creating resource records sets for a private hosted
            ...
            public fun cidrRoutingConfig(
                cidrRoutingConfig: CidrRoutingConfigProperty.Builder.() -> Unit
            )

            /**
             * @param failover *Failover resource record sets only:* To configure failover, you add
             *   the `Failover` element to two resource record sets. For one resource record set,
             *   you specify `PRIMARY` as the value for `Failover` ; for the other resource record
             *   set, you specify `SECONDARY` . In addition, you include the `HealthCheckId` element
             *   and specify the health check that you want Amazon Route 53 to perform for each
             *   resource record set.
             *
             ...
             *   with the applicable value from the primary resource record set regardless of the
             *   health of the secondary resource record set.
             ...
             *   if the primary resource record set is unhealthy, Route 53 always responds to DNS
            ...
            /**
             * @param geoLocation *Geolocation resource record sets only:* A complex type that lets
             *   you control how Amazon Route 53 responds to DNS queries based on the geographic
             *   origin of the query. For example, if you want all queries from Africa to be routed
             *   to a web server with an IP address of `192.0.2.111` , create a resource record set
             ...
             * aren't specified in other geolocation resource record sets that have the same values
             * for the `Name` and `Type` elements.
             *
             ...
             * the resource that you specify in this record: queries that come from locations for
             * which you haven't created geolocation resource record sets and queries from IP
             ...
             * the `Name` and `Type` elements as geolocation resource record sets.
             */
            ...
            /**
             * @param geoProximityLocation A complex type that contains information about a
             *   geographic location.
             */
            ...
            public fun geoProximityLocation(
                geoProximityLocation: GeoProximityLocationProperty.Builder.() -> Unit
            )

            /**
             * @param healthCheckId If you want Amazon Route 53 to return this resource record set
             *   in response to a DNS query only when the status of a health check is healthy,
             *   include the `HealthCheckId` element and specify the ID of the applicable health
             *   check. Route 53 determines whether a resource record set is healthy based on one of
             *   the following:
             ...
             * set to be healthy and includes the alias record among the records that it responds to
             * DNS queries with.
             *
             ...
             * a resource record set for the larger, associated geographic region. For example,
             * suppose you have resource record sets for a state in the United States, for the
             * entire United States, for North America, and a resource record set that has `*` for
             * `CountryCode` is `*` , which applies to all locations. If the endpoint for the state
             ...
             *
             * If your health checks specify the endpoint only by domain name, we recommend that you
             * create a separate health check for each endpoint. For example, create a health check
             * for each `HTTP` server that is serving content for `www.example.com` . For the value
            ...
            /**
             * @param hostedZoneId The ID of the hosted zone that you want to create records in.
             *   Specify either `HostedZoneName` or `HostedZoneId` , but not both. If you have
             *   multiple hosted zones with the same domain name, you must specify the hosted zone
             *   using `HostedZoneId` .
             *
             * Do not provide the `HostedZoneId` if it is already defined in
             * `AWS::Route53::RecordSetGroup` . The creation fails if `HostedZoneId` is defined in
             * both.
             */
            public fun hostedZoneId(hostedZoneId: String)
             ...
             *
             * When you create a stack using an `AWS::Route53::RecordSet` that specifies
             * `HostedZoneName` , AWS CloudFormation attempts to find a hosted zone whose name
             * matches the `HostedZoneName` . If AWS CloudFormation can't find a hosted zone with a
             * matching domain name, or if there is more than one hosted zone with the specified
             * domain name, AWS CloudFormation will not create the stack.
             *
             * Specify either `HostedZoneName` or `HostedZoneId` , but not both. If you have
             * multiple hosted zones with the same domain name, you must specify the hosted zone
             * using `HostedZoneId` .
            ...
            /**
             * @param setIdentifier *Resource record sets that have a routing policy other than
             *   simple:* An identifier that differentiates among multiple resource record sets that
             *   have the same combination of name and type, such as multiple weighted resource
             *   record sets named acme.example.com that have a type of A. In a group of resource
             *   record sets that have the same name and type, the value of `SetIdentifier` must be
            ...
            /**
             * @param multiValueAnswer *Multivalue answer resource record sets only* : To route
             *   traffic approximately randomly to multiple resources, such as web servers, create
             ...
             *   Amazon Route 53 responds to DNS queries with the corresponding IP address only when
            ...
            /**
             * @param name For `ChangeResourceRecordSets` requests, the name of the record that you
             *   want to create, update, or delete. For `ListResourceRecordSets` responses, the name
             ...
             * Route 53 treats `www.example.com` (without a trailing dot) and `www.example.com.`
            ...
            /**
             * @param region *Latency-based resource record sets only:* The Amazon EC2 Region where
             *   you created the resource that this resource record set refers to. The resource
             *   typically is an AWS resource, such as an EC2 instance or an ELB load balancer, and
             ...
             * EC2 Region. Route 53 then returns the value that is associated with the selected
             * resource record set.
             *
             * Note the following:
             * * You can only specify one `ResourceRecord` per latency resource record set.
            ...
            /**
             * @param resourceRecords Information about the records that you want to create. Each
             *   record should be in the format appropriate for the record type specified by the
             *   `Type` property. For information about different record types and their record
             *   formats, see
             *   [Values That You Specify When You Create or Edit Amazon Route 53 Records](https://docs.aws.amazon.com/Route53/latest/DeveloperGuide/resource-record-sets-values.html)
             *   in the *Amazon Route 53 Developer Guide* .
             */
            ...
            /**
             * @param ttl The resource record cache time to live (TTL), in seconds. Note the
             *   following:.
            ...
            /**
             * @param type The DNS record type. For information about different record types and how
             ...
             *
             * Values for weighted, latency, geolocation, and failover resource record sets: `A` |
             * `AAAA` | `CAA` | `CNAME` | `MX` | `NAPTR` | `PTR` | `SPF` | `SRV` | `TXT` . When
             ...
             * which the value of `Type` is `SPF` . RFC 7208, *Sender Policy Framework (SPF) for
             * Authorizing Use of Domains in Email, Version 1* , has been updated to say, "...[I]ts
             * existence and mechanism defined in [RFC4408] have led to some interoperability
             * issues. Accordingly, its use is no longer appropriate for SPF version 1;
             * implementations are not to use it." In RFC 7208, see section 14.1,
             * [The SPF DNS Record Type](https://docs.aws.amazon.com/http://tools.ietf.org/html/rfc7208#section-14.1)
             * .
             *
             * Values for alias resource record sets:
             ...
             * traffic to your distribution, one with a value of `A` and one with a value of `AAAA`
             * .
             * * *Amazon API Gateway environment that has a regionalized subdomain* : `A`
             * * *ELB load balancers:* `A` | `AAAA`
             * * *Amazon S3 buckets:* `A`
             ...
             *
             * If you're creating an alias record that has the same name as the hosted zone (known
             * as the zone apex), you can't route traffic to a record for which the value of `Type`
             * is `CNAME` . This is because the alias record must have the same type as the record
            ...
            /**
             * @param weight *Weighted resource record sets only:* Among resource record sets that
             ...
             *   the same values for the `Name` and `Type` elements as weighted resource record
             *   sets.
             ...
             * with weighted resource record sets. For more information, see
             * [Options for Configuring Route 53 Active-Active and Active-Passive Failover](https://docs.aws.amazon.com/Route53/latest/DeveloperGuide/dns-failover-configuring-options.html)
             * in the *Amazon Route 53 Developer Guide* .
             */
        ...
        private class BuilderImpl : Builder {
            ...
            override fun cidrRoutingConfig(cidrRoutingConfig: CidrRoutingConfigProperty) {
                cdkBuilder.cidrRoutingConfig(
                    cidrRoutingConfig.let(CidrRoutingConfigProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("4f994abe22d3e39e024a475c2fe39bae7e3c8393f2519714f52cd2abb0591254")
            override fun cidrRoutingConfig(
                cidrRoutingConfig: CidrRoutingConfigProperty.Builder.() -> Unit
            ...
            override fun geoProximityLocation(geoProximityLocation: GeoProximityLocationProperty) {
                cdkBuilder.geoProximityLocation(
                    geoProximityLocation.let(GeoProximityLocationProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("cb7bba9ec85e663409ea69ea66ef74ac4c0cde53214787b6a6c399a7c1946b37")
            override fun geoProximityLocation(
                geoProximityLocation: GeoProximityLocationProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * element to two resource record sets.
             *
             * For one resource record set, you specify `PRIMARY` as the value for `Failover` ; for
             * the other resource record set, you specify `SECONDARY` . In addition, you include the
             * `HealthCheckId` element and specify the health check that you want Amazon Route 53 to
             * perform for each resource record set.
             *
             * Except where noted, the following failover behaviors assume that you have included
             ...
             * IP address of `192.0.2.111` , create a resource record set with a `Type` of `A` and a
             * `ContinentCode` of `AF` .
             *
             * If you create separate resource record sets for overlapping geographic regions (for
             * example, one resource record set for a continent and one for a country on the same
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-route53-recordsetgroup-recordset.html#cfn-route53-recordsetgroup-recordset-resourcerecords)
             */
            override fun resourceRecords(): List<String> =
                unwrap(this).getResourceRecords() ?: emptyList()
             ...
             * acme.example.com that have a type of A. In a group of resource record sets that have
             * the same name and type, the value of `SetIdentifier` must be unique for each resource
             * record set.
             *
             * For information about routing policies, see
             * [Choosing a Routing Policy](https://docs.aws.amazon.com/Route53/latest/DeveloperGuide/routing-policy.html)
