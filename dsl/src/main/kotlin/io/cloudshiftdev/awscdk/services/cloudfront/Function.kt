...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * In order to associate a Key Value Store, the `runtime` must be `cloudfront-js-2.0` or
         * newer.
         *
    ...
    public companion object {
        public fun fromFunctionAttributes(
            ...
            software.amazon.awscdk.services.cloudfront.Function.fromFunctionAttributes(
        ...
        ): Function = Function(cdkObject)

        internal fun unwrap(
            wrapped: Function
        ): software.amazon.awscdk.services.cloudfront.Function = wrapped.cdkObject
    }
}
