...
public enum class ClusterLoggingTypes(
  ...
  public companion object {
    internal fun wrap(cdkObject: software.amazon.awscdk.services.eks.ClusterLoggingTypes):
        ClusterLoggingTypes = when (cdkObject) {
      software.amazon.awscdk.services.eks.ClusterLoggingTypes.API -> ClusterLoggingTypes.API
      software.amazon.awscdk.services.eks.ClusterLoggingTypes.AUDIT -> ClusterLoggingTypes.AUDIT
    ...
    internal fun unwrap(wrapped: ClusterLoggingTypes):
