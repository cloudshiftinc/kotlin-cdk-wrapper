...
public interface BasicScheduledActionProps {
    ...
    public interface Builder {
        ...
        /**
         * @param maxCapacity The new maximum capacity. At the scheduled time, set the maximum
         *   capacity to the given capacity.
         *
         * At least one of maxCapacity, minCapacity, or desiredCapacity must be supplied.
         */
        ...
        /**
         * @param minCapacity The new minimum capacity. At the scheduled time, set the minimum
         *   capacity to the given capacity.
         *
         * At least one of maxCapacity, minCapacity, or desiredCapacity must be supplied.
         */
         ...
         * Zone Database (such as Etc/GMT+9 or Pacific/Tahiti).
         *
         * For more information, see https://en.wikipedia.org/wiki/List_of_tz_database_time_zones.
         */
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: BasicScheduledActionProps
        ): software.amazon.awscdk.services.autoscaling.BasicScheduledActionProps =
