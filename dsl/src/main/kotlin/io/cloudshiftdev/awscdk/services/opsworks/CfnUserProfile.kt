...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param allowSelfManagement Whether users can specify their own SSH public key through the
         *   My Settings page.
         */
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.opsworks.CfnUserProfile =
            cdkBuilder.build()
    }
