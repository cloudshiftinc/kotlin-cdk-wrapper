...
public interface ProxyTargetConfig {
    ...
    public interface Builder {
        /**
         * @param dbClusters The database clusters to which this proxy connects. Either this or
         *   `dbInstances` will be set and the other `undefined`.
         */
        ...
        /**
         * @param dbInstances The database instances to which this proxy connects. Either this or
         *   `dbClusters` will be set and the other `undefined`.
         */
        ...
        /**
         * @param engineFamily The engine family of the database instance or cluster this proxy
         *   connects with.
         */
    ...
    private class BuilderImpl : Builder {
        ...
        public fun build(): software.amazon.awscdk.services.rds.ProxyTargetConfig =
            cdkBuilder.build()
    }
