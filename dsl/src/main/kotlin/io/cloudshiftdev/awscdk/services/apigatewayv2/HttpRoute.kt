...
internal constructor(
     ...
     *
     * This method requires that the authorizer of the route is undefined or is an
     * `HttpIamAuthorizer`.
     *
     * @param grantee
     * @param options
    ...
    public override fun grantInvoke(grantee: IGrantable, options: GrantInvokeOptions): Grant =
        unwrap(this)
            .grantInvoke(grantee.let(IGrantable::unwrap), options.let(GrantInvokeOptions::unwrap))
            .let(Grant::wrap)
    ...
    public override fun grantInvoke(
        grantee: IGrantable,
        options: GrantInvokeOptions.Builder.() -> Unit
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.apigatewayv2.HttpRoute =
            cdkBuilder.build()
    }
    ...
    public companion object {
        ...
        ): HttpRoute = HttpRoute(cdkObject)

        internal fun unwrap(
            wrapped: HttpRoute
        ): software.amazon.awscdk.services.apigatewayv2.HttpRoute = wrapped.cdkObject
    }
}
