...
internal constructor(
    ...
    public open fun tracingConfiguration(
        `value`: TracingConfigurationProperty.Builder.() -> Unit
    ...
    public interface Builder {
         ...
         * The Amazon States Language definition of the state machine.
         *
         * The state machine definition must be in JSON or YAML, and the format of the object must
         * match the format of your CloudFormation template file. See
         ...
         *
         * @param definitionS3Location The name of the S3 bucket where the state machine definition
         *   is stored.
         */
         ...
         *
         * This enables the customer to inject values obtained at runtime, for example from
         * intrinsic functions, in the state machine definition. Variables can be template parameter
         * names, resource logical IDs, resource attributes, or a variable in a key-value map.
         *
         ...
         *
         * @param loggingConfiguration Defines what execution history events are logged and where
         *   they are logged.
         */
         ...
         *
         * @param roleArn The Amazon Resource Name (ARN) of the IAM role to use for this state
         *   machine.
         */
         ...
         * Determines whether a `STANDARD` or `EXPRESS` state machine is created.
         *
         * The default is `STANDARD` . You cannot update the `type` of a state machine once it has
         * been created. For more information on `STANDARD` and `EXPRESS` workflows, see
         ...
         *
         * @param tracingConfiguration Selects whether or not the state machine's AWS X-Ray tracing
         *   is enabled.
         */
        ...
        public fun tracingConfiguration(
            tracingConfiguration: TracingConfigurationProperty.Builder.() -> Unit
        )
    }
    ...
    private class BuilderImpl(
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("fb91d2880c08f8cce2cd0af04a2a3eecc09e8fd6582da5821f01a10d04625122")
        override fun definitionS3Location(
            definitionS3Location: S3LocationProperty.Builder.() -> Unit
        ...
        override fun tracingConfiguration(tracingConfiguration: TracingConfigurationProperty) {
            cdkBuilder.tracingConfiguration(
                tracingConfiguration.let(TracingConfigurationProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("2e5b2dbb55d6717ac848eee9a562bad6fe394f4ef85b956a0e7d0b7fc2f329f9")
        override fun tracingConfiguration(
            tracingConfiguration: TracingConfigurationProperty.Builder.() -> Unit
    ...
    public interface LoggingConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param destinations An array of objects that describes where your execution history
             *   events will be logged. Limited to size 1. Required, if your log level is not set to
             *   `OFF` .
             */
            ...
            /**
             * @param includeExecutionData Determines whether execution data is included in your
             *   log. When set to `false` , data is excluded.
             */
    ...
    public interface S3LocationProperty {
        ...
        public interface Builder {
            /**
             * @param bucket The name of the S3 bucket where the state machine definition JSON or
             *   YAML file is stored.
             */
            ...
            /**
             * @param version For versioning-enabled buckets, a specific version of the state
             *   machine definition.
             */
        ...
        internal constructor(
            ...
            /**
             * The name of the S3 bucket where the state machine definition JSON or YAML file is
             * stored.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-stepfunctions-statemachine-s3location.html#cfn-stepfunctions-statemachine-s3location-bucket)
             */
    ...
    public interface LogDestinationProperty {
        ...
        public interface Builder {
            /**
             * @param cloudWatchLogsLogGroup An object describing a CloudWatch log group. For more
             *   information, see
             *   [AWS::Logs::LogGroup](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-logs-loggroup.html)
             *   in the AWS CloudFormation User Guide.
             */
            ...
            public fun cloudWatchLogsLogGroup(
                cloudWatchLogsLogGroup: CloudWatchLogsLogGroupProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
             ...
             *   in the AWS CloudFormation User Guide.
             */
            override fun cloudWatchLogsLogGroup(
                cloudWatchLogsLogGroup: CloudWatchLogsLogGroupProperty
            ) {
                cdkBuilder.cloudWatchLogsLogGroup(
                    cloudWatchLogsLogGroup.let(CloudWatchLogsLogGroupProperty::unwrap)
                )
            }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: LogDestinationProperty
            ): software.amazon.awscdk.services.stepfunctions.CfnStateMachine.LogDestinationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CloudWatchLogsLogGroupProperty {
        ...
        public interface Builder {
            /**
             * @param logGroupArn The ARN of the the CloudWatch log group to which you want your
             *   logs emitted to. The ARN must end with `:*`
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CloudWatchLogsLogGroupProperty
            ): software.amazon.awscdk.services.stepfunctions.CfnStateMachine.CloudWatchLogsLogGroupProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface TracingConfigurationProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TracingConfigurationProperty
            ): software.amazon.awscdk.services.stepfunctions.CfnStateMachine.TracingConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
