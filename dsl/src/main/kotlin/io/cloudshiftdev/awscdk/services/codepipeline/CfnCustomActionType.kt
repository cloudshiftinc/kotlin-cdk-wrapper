...
internal constructor(
    ...
    public open fun inputArtifactDetails(
        `value`: ArtifactDetailsProperty.Builder.() -> Unit
    ): Unit = inputArtifactDetails(ArtifactDetailsProperty(`value`))
    ...
    public open fun outputArtifactDetails(
        `value`: ArtifactDetailsProperty.Builder.() -> Unit
    ): Unit = outputArtifactDetails(ArtifactDetailsProperty(`value`))
    ...
    public interface Builder {
        ...
        public fun inputArtifactDetails(
            inputArtifactDetails: ArtifactDetailsProperty.Builder.() -> Unit
        )
         ...
         *
         * @param outputArtifactDetails The details of the output artifact of the action, such as
         *   its commit ID.
         */
        ...
        public fun outputArtifactDetails(
            outputArtifactDetails: ArtifactDetailsProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.codepipeline.CfnCustomActionType.Builder.create(
                scope,
                id
            )
        ...
        override fun inputArtifactDetails(inputArtifactDetails: ArtifactDetailsProperty) {
            cdkBuilder.inputArtifactDetails(
                inputArtifactDetails.let(ArtifactDetailsProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("380c062bcef39dbf9342bf4841e882b91132ec40b94655336d24309de3bb0244")
        override fun inputArtifactDetails(
            inputArtifactDetails: ArtifactDetailsProperty.Builder.() -> Unit
        ...
        override fun outputArtifactDetails(outputArtifactDetails: ArtifactDetailsProperty) {
            cdkBuilder.outputArtifactDetails(
                outputArtifactDetails.let(ArtifactDetailsProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("a90a14ad5054c55a647d31790af6d09a9b2f40e2aae4353f23e4217cbf79a3fe")
        override fun outputArtifactDetails(
            outputArtifactDetails: ArtifactDetailsProperty.Builder.() -> Unit
    ...
    public interface ArtifactDetailsProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ArtifactDetailsProperty
            ): software.amazon.awscdk.services.codepipeline.CfnCustomActionType.ArtifactDetailsProperty =
    ...
    public interface SettingsProperty {
         ...
         */
        public fun thirdPartyConfigurationUrl(): String? =
        ...
        public interface Builder {
            /**
             * @param entityUrlTemplate The URL returned to the CodePipeline console that provides a
             *   deep link to the resources of the external system, such as the configuration page
             *   for a CodeDeploy deployment group. This link is provided as part of the action
             *   display in the pipeline.
             */
            public fun entityUrlTemplate(entityUrlTemplate: String)

            /**
             * @param executionUrlTemplate The URL returned to the CodePipeline console that
             *   contains a link to the top-level landing page for the external system, such as the
             *   console page for CodeDeploy. This link is shown on the pipeline view page in the
            ...
            /**
             * @param revisionUrlTemplate The URL returned to the CodePipeline console that contains
             *   a link to the page where customers can update or change the configuration of the
             *   external action.
             */
            public fun revisionUrlTemplate(revisionUrlTemplate: String)

            /**
             * @param thirdPartyConfigurationUrl The URL of a sign-up page where users can sign up
             *   for an external service and perform initial configuration of the action provided by
             *   that service.
             */
        ...
        internal constructor(
             ...
             * landing page for the external system, such as the console page for CodeDeploy.
             *
             * This link is shown on the pipeline view page in the CodePipeline console and provides
    ...
    public interface ConfigurationPropertiesProperty {
        ...
        public interface Builder {
            /**
             * @param description The description of the action configuration property that is
             *   displayed to users.
             */
            ...
            /**
             * @param queryable Indicates that the property is used with `PollForJobs` . When
            ...
            /**
             * @param secret Whether the configuration property is secret. Secrets are hidden from
             *   all calls except for `GetJobDetails` , `GetThirdPartyJobDetails` , `PollForJobs` ,
        ...
        internal constructor(
             ...
             * Indicates that the property is used with `PollForJobs` .
             *
             * When creating a custom action, an action can have up to one queryable property. If it
             * has one, that property must be both required and not secret.
             *
             * If you create a pipeline with a custom action type, and that custom action contains a
             * queryable property, the value for that configuration property is subject to other
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ConfigurationPropertiesProperty
            ): software.amazon.awscdk.services.codepipeline.CfnCustomActionType.ConfigurationPropertiesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
