...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.stepfunctions.Parallel,
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.stepfunctions.Parallel =
            cdkBuilder.build()
    }
    ...
    public companion object {
        ...
        ): Parallel = Parallel(cdkObject)

        internal fun unwrap(
            wrapped: Parallel
        ): software.amazon.awscdk.services.stepfunctions.Parallel = wrapped.cdkObject
    }
}
