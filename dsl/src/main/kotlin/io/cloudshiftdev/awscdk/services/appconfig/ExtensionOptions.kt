...
public interface ExtensionOptions {
    ...
    public interface Builder {
        ...
        /**
         * @param latestVersionNumber The latest version number of the extension. When you create a
         *   new version, specify the most recent current version number. For example, you create
