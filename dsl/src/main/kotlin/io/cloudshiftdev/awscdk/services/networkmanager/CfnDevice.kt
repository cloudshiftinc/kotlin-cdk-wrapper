...
internal constructor(
    ...
    public interface AWSLocationProperty {
        ...
        public interface Builder {
            /**
             * @param subnetArn The Amazon Resource Name (ARN) of the subnet that the device is
             *   located in.
             */
            public fun subnetArn(subnetArn: String)

            /**
             * @param zone The Zone that the device is located in. Specify the ID of an Availability
