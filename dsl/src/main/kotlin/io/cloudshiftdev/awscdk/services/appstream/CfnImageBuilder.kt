...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param instanceType The instance type to use when launching the image builder. The
    ...
    public interface VpcConfigProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param subnetIds The identifier of the subnet to which a network interface is
             *   attached from the image builder instance. An image builder instance can use one
             *   subnet.
             */
