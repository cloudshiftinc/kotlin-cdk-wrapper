...
internal constructor(
    ...
    public interface Builder {
        /**
         * Specifies whether principals outside your organization in AWS Organizations can be
         ...
         *
         * @param allowExternalPrincipals Specifies whether principals outside your organization in
         *   AWS Organizations can be associated with a resource share.
         */
         ...
         *   [Amazon Resource Names (ARNs)](https://docs.aws.amazon.com//general/latest/gr/aws-arns-and-namespaces.html)
         *   of the AWS RAM permission to associate with the resource share. If you do not specify
         ...
         *
         * Not all resource types can be shared with IAM roles and users. For more information, see
         * the column *Can share with IAM roles and users* in the tables on
         ...
         *
         * @param principals Specifies the principals to associate with the resource share. The
         *   possible values are:.
         */
         ...
         *
         * @param resourceArns Specifies a list of one or more ARNs of the resources to associate
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.ram.CfnResourceShare =
            cdkBuilder.build()
    }
