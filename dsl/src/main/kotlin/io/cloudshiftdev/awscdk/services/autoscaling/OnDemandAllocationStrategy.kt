...
public enum class OnDemandAllocationStrategy(
  ...
  LOWEST_PRICE(software.amazon.awscdk.services.autoscaling.OnDemandAllocationStrategy.LOWEST_PRICE),
  ;

  public companion object {
    internal
        fun wrap(cdkObject: software.amazon.awscdk.services.autoscaling.OnDemandAllocationStrategy):
        OnDemandAllocationStrategy = when (cdkObject) {
      software.amazon.awscdk.services.autoscaling.OnDemandAllocationStrategy.PRIORITIZED ->
    ...
    internal fun unwrap(wrapped: OnDemandAllocationStrategy):
        software.amazon.awscdk.services.autoscaling.OnDemandAllocationStrategy = wrapped.cdkObject
  }
}
