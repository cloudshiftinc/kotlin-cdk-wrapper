...
public interface ITable : IResource {
     ...
     * @param props properties of a metric.
     */
    public fun metricSystemErrorsForOperations(
     ...
     */
    @Deprecated(message = "deprecated in CDK") public fun metricThrottledRequests(): Metric
    ...
    public fun metricThrottledRequestsForOperations(
    ...
    internal constructor(
         ...
         * Permits all DynamoDB operations ("dynamodb:*") to an IAM principal.
         *
         * Appropriate grants will also be added to the customer-managed KMS key if one was
         * configured.
         *
         * @param grantee The principal to grant access to.
         */
        ...
        /**
         * Permits an IAM principal all data read operations from this table: BatchGetItem,
         * GetRecords, GetShardIterator, Query, GetItem, Scan.
         *
         * Appropriate grants will also be added to the customer-managed KMS key if one was
         * configured.
         *
         ...
         * Permits an IAM principal to all data read/write operations to this table.
         *
         * BatchGetItem, GetRecords, GetShardIterator, Query, GetItem, Scan, BatchWriteItem,
        ...
        /**
         * Permits an IAM principal all data write operations to this table: BatchWriteItem,
         * PutItem, UpdateItem, DeleteItem.
         *
         * Appropriate grants will also be added to the customer-managed KMS key if one was
         * configured.
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("e9b8e70255d87720549813a96360e76430b16a256c0f36155443932de96201a2")
        override fun metricConditionalCheckFailedRequests(
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("3c6dedc5612550c906d2dcf85f8bb47accdc7927dd2378e3f46db1bac0bee1cb")
        override fun metricConsumedReadCapacityUnits(
            props: MetricOptions.Builder.() -> Unit
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("7445a448a81fdfe9ee99fd876103c7f742088e6821f8fbd70b24a1cb51fef4c6")
        override fun metricConsumedWriteCapacityUnits(
            props: MetricOptions.Builder.() -> Unit
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("bc4a2ceba40208e097d1967e18a76b045f6c6dfc471c5ef50286afc017fb5bf0")
        override fun metricSuccessfulRequestLatency(
            props: MetricOptions.Builder.() -> Unit
         ...
         * @param props properties of a metric.
         */
        override fun metricSystemErrorsForOperations(
            props: SystemErrorsForOperationsMetricOptions
        ): IMetric =
            unwrap(this)
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("c5c36f4b41b0cef64cf51971857d069781a38fec62ede50552fbcd95f5f15d08")
        override fun metricThrottledRequestsForOperations(
            props: OperationsMetricOptions.Builder.() -> Unit
    ...
    public companion object {
        ...
        internal fun unwrap(wrapped: ITable): software.amazon.awscdk.services.dynamodb.ITable =
