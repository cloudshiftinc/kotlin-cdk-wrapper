...
internal constructor(
    ...
    public interface Builder {
         ...
         * group version must reference a core definition version that contains one core. Other
         ...
         * The Amazon Resource Name (ARN) of the IAM role attached to the group.
         *
         * This role contains the permissions that Lambda functions and connectors use to interact
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnGroup
        ): software.amazon.awscdk.services.greengrass.CfnGroup = wrapped.cdkObject
    }
    ...
    public interface GroupVersionProperty {
         ...
         */
        public fun deviceDefinitionVersionArn(): String? =
         ...
         */
        public fun loggerDefinitionVersionArn(): String? =
        ...
        public interface Builder {
             ...
             *   definition version that contains the connectors you want to deploy with the group
             *   version.
             */
            public fun connectorDefinitionVersionArn(connectorDefinitionVersionArn: String)

            /**
             * @param coreDefinitionVersionArn The ARN of the core definition version that contains
             *   the core you want to deploy with the group version. Currently, the core definition
             *   version can contain only one core.
             */
            public fun coreDefinitionVersionArn(coreDefinitionVersionArn: String)

            /**
             * @param deviceDefinitionVersionArn The ARN of the device definition version that
             *   contains the devices you want to deploy with the group version.
             */
            ...
            /**
             * @param loggerDefinitionVersionArn The ARN of the logger definition version that
             *   contains the loggers you want to deploy with the group version.
             */
            ...
            /**
             * @param subscriptionDefinitionVersionArn The ARN of the subscription definition
             *   version that contains the subscriptions you want to deploy with the group version.
             */
        ...
        private class BuilderImpl : Builder {
             ...
             *   version that contains the subscriptions you want to deploy with the group version.
             */
            override fun subscriptionDefinitionVersionArn(
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-greengrass-group-groupversion.html#cfn-greengrass-group-groupversion-coredefinitionversionarn)
             */
            override fun coreDefinitionVersionArn(): String? =
            ...
            /**
             * The ARN of the subscription definition version that contains the subscriptions you
