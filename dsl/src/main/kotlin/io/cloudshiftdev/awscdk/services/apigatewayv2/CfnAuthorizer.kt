...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param authorizerPayloadFormatVersion Specifies the format of the payload sent to an HTTP
         ...
         * caches authorizer responses. The maximum value is 3600, or 1 hour. Supported only for
         ...
         *
         * @param authorizerResultTtlInSeconds The time to live (TTL) for cached authorizer results,
         *   in seconds.
         */
         ...
         * The authorizer type.
         *
         * Specify `REQUEST` for a Lambda function using incoming request parameters. Specify `JWT`
         ...
         * *{account_id}* :function: *{lambda_function_name}* /invocations` . In general, the URI
         * has this form: `arn:aws:apigateway: *{region}* :lambda:path/ *{service_api}*` , where
         * *{region}* is the same as the region hosting the Lambda function, path indicates that the
         * remaining substring in the URI should be treated as the path to the resource, including
         ...
         * Specifies whether a Lambda authorizer returns a response in a simple format.
         *
         * By default, a Lambda authorizer must return an IAM policy. If enabled, the Lambda
         * authorizer can return a boolean value instead of an IAM policy. Supported only for HTTP
         ...
         *
         * @param enableSimpleResponses Specifies whether a Lambda authorizer returns a response in
         *   a simple format.
         */
         ...
         * query string parameters, stage variables, and context parameters. For example, if an Auth
         * header and a Name query string parameter are defined as identity sources, this value is
         ...
         * Unauthorized response without calling the Lambda function. For HTTP APIs, identity
         * sources are also used as the cache key when caching is enabled. To learn more, see
         * [Working with AWS Lambda authorizers for HTTP APIs](https://docs.aws.amazon.com/apigateway/latest/developerguide/http-api-lambda-authorizer.html)
         * .
         *
         ...
         *
         * @param jwtConfiguration The `JWTConfiguration` property specifies the configuration of a
         *   JWT authorizer.
         */
    ...
    private class BuilderImpl(
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("e27125f0db7456c147dc77c030c5a26fe0b613bb82de1d4a8a9d63760df2af6c")
        override fun jwtConfiguration(
            jwtConfiguration: JWTConfigurationProperty.Builder.() -> Unit
    ...
    public interface JWTConfigurationProperty {
         ...
         *
         * A valid JWT must provide an `aud` that matches at least one entry in this list. See
         ...
         * {region} .amazonaws.com/ {userPoolId}` . Required for the `JWT` authorizer type.
        ...
        public interface Builder {
            /**
             * @param audience A list of the intended recipients of the JWT. A valid JWT must
             ...
             *   `https://cognito-idp. {region} .amazonaws.com/ {userPoolId}` . Required for the
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: JWTConfigurationProperty
            ): software.amazon.awscdk.services.apigatewayv2.CfnAuthorizer.JWTConfigurationProperty =
