...
public interface IVersion : IFunction {
     ...
     */
    @Deprecated(message = "deprecated in CDK") public fun addAlias(aliasName: String): Alias
    ...
    internal constructor(
         ...
         * @param aliasName The name of the alias.
         * @param options Alias options.
         * @deprecated Calling `addAlias` on a `Version` object will cause the Alias to be replaced
         *   on every function update. Call `function.addAlias()` or `new Alias()` instead.
         */
        @Deprecated(message = "deprecated in CDK")
         ...
         */
        override fun addEventSourceMapping(
            id: String,
        ...
        override fun addFunctionUrl(options: FunctionUrlOptions): FunctionUrl =
            unwrap(this)
                .addFunctionUrl(options.let(FunctionUrlOptions::unwrap))
                .let(FunctionUrl::wrap)
        ...
        override fun configureAsyncInvoke(
         ...
         */
        override fun grantInvokeCompositePrincipal(
         ...
         *
         * Note that this is reference to a non-specific AWS Lambda version, which means the
         * function this version refers to can return different results in different invocations.
         *
         ...
         * @param props
         */
        override fun metricInvocations(): Metric =
         ...
         *
         * This property is for cdk modules to consume only. You should not need to use this
         * property. Instead, use grantInvoke() directly.
         */
