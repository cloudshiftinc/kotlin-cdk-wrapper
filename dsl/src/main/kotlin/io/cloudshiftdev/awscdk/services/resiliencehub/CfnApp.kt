...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param appAssessmentSchedule Assessment execution schedule with 'Daily' or 'Disabled'
         *   values.
         */
         ...
         * implement `additionalInfo` through the AWS Resilience Hub console rather than using an
         * API call, see
         ...
         * * `type`
         *
         * The type of AppComponent. For more information about the types of AppComponent, see
         ...
         * The list of events you would like to subscribe and get notification for.
         *
         * Currently, AWS Resilience Hub supports notifications only for *Drift detected* and
         ...
         *
         * @param eventSubscriptions The list of events you would like to subscribe and get
         *   notification for.
         */
         ...
         *
         * @param permissionModel Defines the roles and credentials that AWS Resilience Hub would
         *   use while creating the application, importing its resources, and running an assessment.
         */
    ...
    private class BuilderImpl(
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("e918c216fb8f3bf92d254812b276851f7aa4316f4e196983dece2146130f3aca")
        override fun permissionModel(
            permissionModel: PermissionModelProperty.Builder.() -> Unit
        ): Unit = permissionModel(PermissionModelProperty(permissionModel))
        ...
        public fun build(): software.amazon.awscdk.services.resiliencehub.CfnApp =
            cdkBuilder.build()
    }
    ...
    public interface PhysicalResourceIdProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: PhysicalResourceIdProperty
            ): software.amazon.awscdk.services.resiliencehub.CfnApp.PhysicalResourceIdProperty =
    ...
    public interface PermissionModelProperty {
         ...
         *   other accounts.
         * * These roles must have a trust policy with `iam:AssumeRole` permission to the invoker
         *   role in the primary account.
         *
         ...
         */
        public fun crossAccountRoleArns(): List<String> =
         ...
         *
         * It can scan for the resources by using a pre-existing role in your AWS account, or by
        ...
        public interface Builder {
            /**
             * @param crossAccountRoleArns Defines a list of role Amazon Resource Names (ARNs) to be
             *   used in other accounts. These ARNs are used for querying purposes while importing
            ...
            /**
             * @param invokerRoleName Existing AWS IAM role name in the primary AWS account that
             *   will be assumed by AWS Resilience Hub Service Principle to obtain a read-only
             *   access to your application resources while running an assessment.
             * * You must have `iam:passRole` permission for this role while creating or updating
             *   the application.
             * * Currently, `invokerRoleName` accepts only `[A-Za-z0-9_+=,.&#64;-]` characters.
             */
             ...
             *   resources by using a pre-existing role in your AWS account, or by using the
             *   credentials of the current IAM user.
             */
            public fun type(type: String)
        }
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-resiliencehub-app-permissionmodel.html#cfn-resiliencehub-app-permissionmodel-crossaccountrolearns)
             */
            override fun crossAccountRoleArns(): List<String> =
                unwrap(this).getCrossAccountRoleArns() ?: emptyList()
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: PermissionModelProperty
            ): software.amazon.awscdk.services.resiliencehub.CfnApp.PermissionModelProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ResourceMappingProperty {
        ...
        public interface Builder {
            /**
             * @param eksSourceName Name of the Amazon Elastic Kubernetes Service cluster and
            ...
            /**
             * @param logicalStackName Name of the AWS CloudFormation stack this resource is mapped
             *   to when the `mappingType` is `CfnStack` .
             */
            ...
            public fun physicalResourceId(
                physicalResourceId: PhysicalResourceIdProperty.Builder.() -> Unit
            )
            ...
            /**
             * @param terraformSourceName Name of the Terraform source that this resource is mapped
             *   to when the `mappingType` is `Terraform` .
             */
        ...
        private class BuilderImpl : Builder {
            ...
            override fun physicalResourceId(physicalResourceId: PhysicalResourceIdProperty) {
                cdkBuilder.physicalResourceId(
                    physicalResourceId.let(PhysicalResourceIdProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("c64aca1583c97db6bc67cb6995d70235bf84d03b55a6e55a3704aaba9f51f705")
            override fun physicalResourceId(
                physicalResourceId: PhysicalResourceIdProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ResourceMappingProperty
            ): software.amazon.awscdk.services.resiliencehub.CfnApp.ResourceMappingProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface EventSubscriptionProperty {
        ...
        public interface Builder {
            /**
             * @param eventType The type of event you would like to subscribe and get notification
             *   for. Currently, AWS Resilience Hub supports notifications only for *Drift detected*
             *   ( `DriftDetected` ) and *Scheduled assessment failure* (
            ...
            /**
             * @param snsTopicArn Amazon Resource Name (ARN) of the Amazon Simple Notification
             *   Service topic. The format for this ARN is:
             *   `arn:partition:sns:region:account:topic-name` . For more information about ARNs,
             *   see
             *   [Amazon Resource Names (ARNs)](https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html)
             *   in the *AWS General Reference* guide.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: EventSubscriptionProperty
            ): software.amazon.awscdk.services.resiliencehub.CfnApp.EventSubscriptionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
