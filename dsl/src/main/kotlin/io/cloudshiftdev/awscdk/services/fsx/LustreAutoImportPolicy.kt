...
public enum class LustreAutoImportPolicy(
    ...
    public companion object {
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.fsx.LustreAutoImportPolicy
        ): LustreAutoImportPolicy =
            when (cdkObject) {
                software.amazon.awscdk.services.fsx.LustreAutoImportPolicy.NONE ->
                    LustreAutoImportPolicy.NONE
                software.amazon.awscdk.services.fsx.LustreAutoImportPolicy.NEW ->
        ...
        internal fun unwrap(
            wrapped: LustreAutoImportPolicy
