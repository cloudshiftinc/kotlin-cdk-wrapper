...
internal constructor(
    ...
    public interface Builder {
         ...
         * model has a type that defines the properties that the composite model supports. You can
         ...
         * created from this asset model. For more information, see
         ...
         * [Quotas](https://docs.aws.amazon.com/iot-sitewise/latest/userguide/quotas.html) in the
    ...
    public interface TumblingWindowProperty {
         ...
         * 1 week.
         *
         * AWS IoT SiteWise computes the `1w` interval the end of Sunday at midnight each week
         * (UTC), the `1d` interval at the end of each day at midnight (UTC), the `1h` interval at
         * the end of each hour, and so on.
         *
         * When AWS IoT SiteWise aggregates data points for metric computations, the start of each
         * interval is exclusive and the end of each interval is inclusive. AWS IoT SiteWise places
         ...
         * * The ISO 8601 format.
         *
         * For example, if you specify `PT18H` for `offset` and `1d` for `interval` , AWS IoT
         ...
         * create the metric at 2 PM (UTC), you get the first aggregation result at 2:03 PM (UTC).
        ...
        public interface Builder {
             ...
             *   between 1 minute and 1 week. AWS IoT SiteWise computes the `1w` interval the end of
             *   Sunday at midnight each week (UTC), the `1d` interval at the end of each day at
             *   midnight (UTC), the `1h` interval at the end of each hour, and so on.
             *
             * When AWS IoT SiteWise aggregates data points for metric computations, the start of
             * each interval is exclusive and the end of each interval is inclusive. AWS IoT
             ...
             * * The offset time.
             *
             * For example, if you specify `18h` for `offset` and `1d` for `interval` , AWS IoT
             * SiteWise aggregates data in one of the following ways:
             ...
             * `interval` , AWS IoT SiteWise aggregates data in one of the following ways:
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TumblingWindowProperty
            ): software.amazon.awscdk.services.iotsitewise.CfnAssetModel.TumblingWindowProperty =
    ...
    public interface AssetModelPropertyProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param dataTypeSpec The data type of the structure for this property. This parameter
            ...
            /**
             * @param logicalId The `LogicalID` of the asset model property. The maximum length is
             *   256 characters, with the pattern `[^\\u0000-\\u001F\\u007F]+` .
             */
            public fun logicalId(logicalId: String)

            /**
             * @param name The name of the asset model property. The maximum length is 256
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AssetModelPropertyProperty
            ): software.amazon.awscdk.services.iotsitewise.CfnAssetModel.AssetModelPropertyProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface AssetModelCompositeModelProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param compositeModelProperties The asset property definitions for this composite
             *   model.
             */
            ...
            /**
             * @param parentAssetModelCompositeModelExternalId The parent composite model External
             *   ID.
             */
            public fun parentAssetModelCompositeModelExternalId(
                parentAssetModelCompositeModelExternalId: String
            )

            /**
             * @param path The path of the composite model. This is only for derived composite
             *   models
             */
        ...
        private class BuilderImpl : Builder {
            ...
            override fun compositeModelProperties(compositeModelProperties: IResolvable) {
                cdkBuilder.compositeModelProperties(
                    compositeModelProperties.let(IResolvable::unwrap)
                )
            }
             ...
             *   ID.
             */
            override fun parentAssetModelCompositeModelExternalId(
                parentAssetModelCompositeModelExternalId: String
            ) {
                cdkBuilder.parentAssetModelCompositeModelExternalId(
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-iotsitewise-assetmodel-assetmodelcompositemodel.html#cfn-iotsitewise-assetmodel-assetmodelcompositemodel-compositemodelproperties)
             */
            override fun compositeModelProperties(): Any? =
                unwrap(this).getCompositeModelProperties()
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AssetModelCompositeModelProperty
            ): software.amazon.awscdk.services.iotsitewise.CfnAssetModel.AssetModelCompositeModelProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ExpressionVariableProperty {
        ...
        public interface Builder {
            /**
             * @param name The friendly name of the variable to be used in the expression. The
             *   maximum length is 64 characters with the pattern `^[a-z][a-z0-9_]*$` .
             */
            public fun name(name: String)
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ExpressionVariableProperty
            ): software.amazon.awscdk.services.iotsitewise.CfnAssetModel.ExpressionVariableProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface MetricProperty {
        ...
        public interface Builder {
            /**
             * @param expression The mathematical expression that defines the metric aggregation
             *   function.
             *
             * You can specify up to 10 variables per expression. You can specify up to 10 functions
             * per expression.
             *
             * For more information, see
             * [Quotas](https://docs.aws.amazon.com/iot-sitewise/latest/userguide/quotas.html) in
            ...
            /**
             * @param window The window (time interval) over which AWS IoT SiteWise computes the
             *   metric's aggregation expression. AWS IoT SiteWise computes one data point per
             *   `window` .
             */
    ...
    public interface PropertyPathDefinitionProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: PropertyPathDefinitionProperty
            ): software.amazon.awscdk.services.iotsitewise.CfnAssetModel.PropertyPathDefinitionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface PropertyTypeProperty {
         ...
         * [industrial IoT](https://docs.aws.amazon.com/https://en.wikipedia.org/wiki/Internet_of_things#Industrial_applications)
         * wind turbine.
         *
         ...
         * input data points over a time interval and output a single data point, such as to
         ...
         *
         * A transform contains a mathematical expression that maps a property's data points from
         * one form to another, such as a unit conversion from Celsius to Fahrenheit.
         *
        ...
        /**
         * The type of property type, which can be one of `Attribute` , `Measurement` , `Metric` ,
         * or `Transform` .
         *
        ...
        public interface Builder {
            ...
            /**
             * @param metric Specifies an asset metric property. A metric contains a mathematical
            ...
            /**
             * @param transform Specifies an asset transform property. A transform contains a
             *   mathematical expression that maps a property's data points from one form to
             *   another, such as a unit conversion from Celsius to Fahrenheit.
             *
             * This is required if the `TypeName` is `Transform` .
             */
            ...
            /**
             * @param typeName The type of property type, which can be one of `Attribute` ,
        ...
        internal constructor(
             ...
             * Specifies an asset metric property.
             *
             * A metric contains a mathematical expression that uses aggregate functions to process
             * all input data points over a time interval and output a single data point, such as to
             * calculate the average hourly temperature.
             *
             * This is required if the `TypeName` is `Metric` .
             *
             ...
             * Specifies an asset transform property.
             *
             * A transform contains a mathematical expression that maps a property's data points
             * from one form to another, such as a unit conversion from Celsius to Fahrenheit.
             *
             * This is required if the `TypeName` is `Transform` .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-iotsitewise-assetmodel-propertytype.html#cfn-iotsitewise-assetmodel-propertytype-transform)
    ...
    public interface TransformProperty {
        ...
        public interface Builder {
            /**
             * @param expression The mathematical expression that defines the transformation
             *   function. You can specify up to 10 variables per expression. You can specify up to
    ...
    public interface AttributeProperty {
         ...
         * update an attribute's value after you create an asset. For more information, see
        ...
        public interface Builder {
            /**
             * @param defaultValue The default value of the asset model property attribute. All
             *   assets that you create from the asset model contain this attribute value. You can
             *   update an attribute's value after you create an asset. For more information, see
             *   [Updating attribute values](https://docs.aws.amazon.com/iot-sitewise/latest/userguide/update-attribute-values.html)
             *   in the *AWS IoT SiteWise User Guide* .
             */
    ...
    public interface AssetModelHierarchyProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param name The name of the asset model hierarchy. The maximum length is 256
             *   characters with the pattern `[^\u0000-\u001F\u007F]+` .
             */
            public fun name(name: String)
        }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AssetModelHierarchyProperty
            ): software.amazon.awscdk.services.iotsitewise.CfnAssetModel.AssetModelHierarchyProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface VariableValueProperty {
         ...
         * hierarchies using the same model and therefore the same property. For example, you might
        ...
        public interface Builder {
             ...
             *   `PropertyLogicalID` . You use a `hierarchyLogicalID` instead of a model ID because
             *   you can have several hierarchies using the same model and therefore the same
             *   property. For example, you might have separately grouped assets that come from the
             *   same asset model. For more information, see
             *   [Defining relationships between assets](https://docs.aws.amazon.com/iot-sitewise/latest/userguide/asset-hierarchies.html)
             *   in the *AWS IoT SiteWise User Guide* .
             */
            ...
            /**
             * @param propertyExternalId The External ID of the property that is trying to be
             *   referenced.
             */
        ...
        internal constructor(
             ...
             *
             * You use a `hierarchyLogicalID` instead of a model ID because you can have several
             * hierarchies using the same model and therefore the same property. For example, you
             * might have separately grouped assets that come from the same asset model. For more
             * information, see
             * [Defining relationships between assets](https://docs.aws.amazon.com/iot-sitewise/latest/userguide/asset-hierarchies.html)
             * in the *AWS IoT SiteWise User Guide* .
             *
