...
internal constructor(
    ...
    public open fun registrationConfig(
        `value`: RegistrationConfigProperty.Builder.() -> Unit
    ): Unit = registrationConfig(RegistrationConfigProperty(`value`))
    ...
    public interface Builder {
         ...
         *
         * @param autoRegistrationStatus Whether the CA certificate is configured for auto
        ...
        public fun registrationConfig(
            registrationConfig: RegistrationConfigProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
        ...
        override fun registrationConfig(registrationConfig: RegistrationConfigProperty) {
            cdkBuilder.registrationConfig(
                registrationConfig.let(RegistrationConfigProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("e2142c3ff8971b8bf8373de41fcccea8548a7d3aeba5325b6636b84f35d0ba07")
        override fun registrationConfig(
            registrationConfig: RegistrationConfigProperty.Builder.() -> Unit
        ...
        public fun build(): software.amazon.awscdk.services.iot.CfnCACertificate =
            cdkBuilder.build()
    }
    ...
    public interface RegistrationConfigProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RegistrationConfigProperty
            ): software.amazon.awscdk.services.iot.CfnCACertificate.RegistrationConfigProperty =
