...
public interface PasswordPolicy {
     ...
     *
     * This must be provided as whole days, like Duration.days(3) or Duration.hours(48). Fractional
     * days, such as Duration.hours(20), will generate an error.
     *
    ...
    public interface Builder {
        ...
        /**
         * @param requireLowercase Whether the user is required to have lowercase characters in
         *   their password.
         */
        ...
        /**
         * @param requireUppercase Whether the user is required to have uppercase characters in
         *   their password.
         */
        public fun requireUppercase(requireUppercase: Boolean)

        /**
         * @param tempPasswordValidity The length of time the temporary password generated by an
         *   admin is valid. This must be provided as whole days, like Duration.days(3) or
         *   Duration.hours(48). Fractional days, such as Duration.hours(20), will generate an
         *   error.
         */
    ...
    private class BuilderImpl : Builder {
        ...
        public fun build(): software.amazon.awscdk.services.cognito.PasswordPolicy =
            cdkBuilder.build()
    }
