...
public enum class LambdaInvocationType(
    ...
    public companion object {
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.LambdaInvocationType
        ): LambdaInvocationType =
            when (cdkObject) {
                software.amazon.awscdk.services.stepfunctions.tasks.LambdaInvocationType
                    .REQUEST_RESPONSE -> LambdaInvocationType.REQUEST_RESPONSE
