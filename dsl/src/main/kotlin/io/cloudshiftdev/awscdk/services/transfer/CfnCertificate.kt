...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param certificateChain The list of certificates that make up the chain for the
         *   certificate.
         */
         ...
         *
         * @param inactiveDate An optional date that specifies when the certificate becomes
         *   inactive.
         */
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.transfer.CfnCertificate =
            cdkBuilder.build()
    }
    ...
    public companion object {
        ...
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.transfer.CfnCertificate
