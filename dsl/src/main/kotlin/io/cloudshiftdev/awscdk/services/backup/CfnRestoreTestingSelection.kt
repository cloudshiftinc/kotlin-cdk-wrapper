...
internal constructor(
     ...
     * , but not both.
     */
    public open fun protectedResourceArns(): List<String> =
        unwrap(this).getProtectedResourceArns() ?: emptyList()
    ...
    public open fun protectedResourceConditions(`value`: ProtectedResourceConditionsProperty) {
        unwrap(this)
            .setProtectedResourceConditions(
                `value`.let(ProtectedResourceConditionsProperty::unwrap)
            )
    }
    ...
    public open fun protectedResourceConditions(
        `value`: ProtectedResourceConditionsProperty.Builder.() -> Unit
    ...
    public interface Builder {
         ...
         *
         * @param protectedResourceArns You can include specific ARNs, such as
         ...
         *
         * @param protectedResourceConditions In a resource testing selection, this parameter
         *   filters by specific conditions such as `StringEquals` or `StringNotEquals` .
         */
        ...
        public fun protectedResourceConditions(
            protectedResourceConditions: ProtectedResourceConditionsProperty.Builder.() -> Unit
        )
         ...
         *
         * @param restoreMetadataOverrides You can override certain restore metadata keys by
         *   including the parameter `RestoreMetadataOverrides` in the body of
         ...
         *
         * @param restoreTestingPlanName The RestoreTestingPlanName is a unique string that is the
         ...
         *
         * @param restoreTestingSelectionName This is the unique name of the restore testing
         *   selection that belongs to the related restore testing plan.
         */
         ...
         *
         * @param validationWindowHours This is amount of hours (1 to 168) available to run a
         *   validation script on the data.
         */
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.backup.CfnRestoreTestingSelection.Builder.create(
                scope,
                id
            )
        ...
        override fun protectedResourceConditions(protectedResourceConditions: IResolvable) {
            cdkBuilder.protectedResourceConditions(
                protectedResourceConditions.let(IResolvable::unwrap)
            )
        }
         ...
         *   filters by specific conditions such as `StringEquals` or `StringNotEquals` .
         */
        override fun protectedResourceConditions(
            protectedResourceConditions: ProtectedResourceConditionsProperty
        ) {
            cdkBuilder.protectedResourceConditions(
                protectedResourceConditions.let(ProtectedResourceConditionsProperty::unwrap)
            )
        }
        ...
        override fun protectedResourceConditions(
            ...
            protectedResourceConditions(
                ProtectedResourceConditionsProperty(protectedResourceConditions)
            )
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnRestoreTestingSelection
    ...
    public interface ProtectedResourceConditionsProperty {
        ...
        public interface Builder {
            /**
             * @param stringEquals Filters the values of your tagged resources for only those
            ...
            /**
             * @param stringNotEquals Filters the values of your tagged resources for only those
             *   resources that you tagged that do not have the same value. Also called "negated
             *   matching."
             */
        ...
        internal constructor(
            ...
            /**
             * Filters the values of your tagged resources for only those resources that you tagged
             * that do not have the same value.
             *
             * Also called "negated matching."
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-backup-restoretestingselection-protectedresourceconditions.html#cfn-backup-restoretestingselection-protectedresourceconditions-stringnotequals)
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ProtectedResourceConditionsProperty
            ): software.amazon.awscdk.services.backup.CfnRestoreTestingSelection.ProtectedResourceConditionsProperty =
    ...
    public interface KeyValueProperty {
        ...
        public interface Builder {
            /**
             * @param key The tag key (String). The key can't start with `aws:` . Length
