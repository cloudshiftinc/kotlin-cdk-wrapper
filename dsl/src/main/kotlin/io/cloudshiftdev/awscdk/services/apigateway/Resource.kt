...
internal constructor(
    ...
    public companion object {
        public fun fromResourceAttributes(
            ...
            software.amazon.awscdk.services.apigateway.Resource.fromResourceAttributes(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    attrs.let(ResourceAttributes::unwrap)
                )
                .let(IResource::wrap)
        ...
        ): Resource = Resource(cdkObject)

        internal fun unwrap(
            wrapped: Resource
        ): software.amazon.awscdk.services.apigateway.Resource = wrapped.cdkObject
    }
}
