...
internal constructor(
    ...
    /** The ID of the path. */
    public open fun attrNetworkInsightsPathId(): String =
        unwrap(this).getAttrNetworkInsightsPathId()
    ...
    public interface Builder {
         ...
         *
         * @param filterAtDestination Scopes the analysis to network paths that match specific
         *   filters at the destination.
         */
         ...
         * Scopes the analysis to network paths that match specific filters at the source.
         *
         * If you specify this parameter, you can't specify the parameters for the source IP address
         ...
         *
         * @param filterAtSource Scopes the analysis to network paths that match specific filters at
         *   the source.
         */
    ...
    private class BuilderImpl(
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("6fc130fe57308efc3533736b34dac6c768021dee3a12c125c4af637efd2dfd29")
        override fun filterAtDestination(
            filterAtDestination: PathFilterProperty.Builder.() -> Unit
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnNetworkInsightsPath
    ...
    public interface PathFilterProperty {
        ...
        public interface Builder {
            ...
            public fun destinationPortRange(
                destinationPortRange: FilterPortRangeProperty.Builder.() -> Unit
            )
        ...
        private class BuilderImpl : Builder {
            ...
            override fun destinationPortRange(destinationPortRange: FilterPortRangeProperty) {
                cdkBuilder.destinationPortRange(
                    destinationPortRange.let(FilterPortRangeProperty::unwrap)
                )
            }
            ...
            override fun sourcePortRange(
                sourcePortRange: FilterPortRangeProperty.Builder.() -> Unit
    ...
    public interface FilterPortRangeProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: FilterPortRangeProperty
            ): software.amazon.awscdk.services.ec2.CfnNetworkInsightsPath.FilterPortRangeProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
