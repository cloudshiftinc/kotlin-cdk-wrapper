...
internal constructor(
    ...
    public open fun customSecurityGroupIds(): List<String> =
        unwrap(this).getCustomSecurityGroupIds() ?: emptyList()
    ...
    public open fun lifecycleEventConfiguration(`value`: LifecycleEventConfigurationProperty) {
        unwrap(this)
            .setLifecycleEventConfiguration(
                `value`.let(LifecycleEventConfigurationProperty::unwrap)
            )
    }
    ...
    public open fun lifecycleEventConfiguration(
        `value`: LifecycleEventConfigurationProperty.Builder.() -> Unit
    ...
    public open fun loadBasedAutoScaling(
        `value`: LoadBasedAutoScalingProperty.Builder.() -> Unit
    ...
    public interface Builder {
         ...
         * to be installed on the layer's instances.
         *
         * For more information, see
         ...
         *
         * @param customRecipes A `LayerCustomRecipes` object that specifies the layer custom
         *   recipes.
         */
         ...
         *
         * @param lifecycleEventConfiguration A `LifeCycleEventConfiguration` object that you can
         *   use to configure the Shutdown event to specify an execution timeout and enable or
        ...
        public fun lifecycleEventConfiguration(
            lifecycleEventConfiguration: LifecycleEventConfigurationProperty.Builder.() -> Unit
        )
         ...
         *
         * @param loadBasedAutoScaling The load-based scaling configuration for the AWS OpsWorks
         *   layer.
         */
        ...
        public fun loadBasedAutoScaling(
            loadBasedAutoScaling: LoadBasedAutoScalingProperty.Builder.() -> Unit
        )
         ...
         * used internally by AWS OpsWorks Stacks and by Chef recipes.
         *
         * The short name is also used as the name for the directory where your app files are
         * installed. It can have a maximum of 32 characters, which are limited to the alphanumeric
         * characters, '-', '_', and '.'.
         *
         * Built-in layer short names are defined by AWS OpsWorks Stacks. For more information, see
         * the [Layer Reference](https://docs.aws.amazon.com/opsworks/latest/userguide/layers.html)
         * .
         *
         ...
         * The layer type.
         *
         * A stack cannot have more than one built-in layer of the same type. It can have any number
         ...
         *
         * @param volumeConfigurations A `VolumeConfigurations` object that describes the layer's
         *   Amazon EBS volumes.
         */
    ...
    private class BuilderImpl(
        ...
        override fun lifecycleEventConfiguration(lifecycleEventConfiguration: IResolvable) {
            cdkBuilder.lifecycleEventConfiguration(
                lifecycleEventConfiguration.let(IResolvable::unwrap)
            )
        }
         ...
         *   disable Elastic Load Balancer connection draining.
         */
        override fun lifecycleEventConfiguration(
            lifecycleEventConfiguration: LifecycleEventConfigurationProperty
        ) {
            cdkBuilder.lifecycleEventConfiguration(
                lifecycleEventConfiguration.let(LifecycleEventConfigurationProperty::unwrap)
            )
        }
        ...
        override fun lifecycleEventConfiguration(
            ...
            lifecycleEventConfiguration(
                LifecycleEventConfigurationProperty(lifecycleEventConfiguration)
            )
        ...
        override fun loadBasedAutoScaling(loadBasedAutoScaling: LoadBasedAutoScalingProperty) {
            cdkBuilder.loadBasedAutoScaling(
                loadBasedAutoScaling.let(LoadBasedAutoScalingProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("671c26bd97fcf55213bf45b05b04f31b88c41667f1af0a8b21ab011d83bb7a76")
        override fun loadBasedAutoScaling(
            loadBasedAutoScaling: LoadBasedAutoScalingProperty.Builder.() -> Unit
    ...
    public interface AutoScalingThresholdsProperty {
         ...
         * The load threshold.
         *
         * A value of -1 disables the threshold. For more information about how load is computed,
         * see
        ...
        public interface Builder {
            ...
            /**
             * @param ignoreMetricsTime The amount of time (in minutes) after a scaling event occurs
             *   that AWS OpsWorks Stacks should ignore metrics and suppress additional scaling
             *   events. For example, AWS OpsWorks Stacks adds new instances following an upscaling
             *   event but the instances won't start reducing the load until they have been booted
             *   and configured. There is no point in raising additional scaling events during that
             *   operation, which typically takes several minutes. `IgnoreMetricsTime` allows you to
             *   direct AWS OpsWorks Stacks to suppress scaling events long enough to get the new
             *   instances online.
             */
            ...
            /**
             * @param loadThreshold The load threshold. A value of -1 disables the threshold. For
             *   more information about how load is computed, see
             *   [Load (computing)](https://docs.aws.amazon.com/http://en.wikipedia.org/wiki/Load_%28computing%29)
             *   .
             */
            ...
            /**
             * @param memoryThreshold The memory utilization threshold, as a percent of the
        ...
        internal constructor(
             ...
             * should ignore metrics and suppress additional scaling events.
             *
             * For example, AWS OpsWorks Stacks adds new instances following an upscaling event but
             ...
             * The load threshold.
             *
             * A value of -1 disables the threshold. For more information about how load is
             * computed, see
             * [Load (computing)](https://docs.aws.amazon.com/http://en.wikipedia.org/wiki/Load_%28computing%29)
             * .
             *
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AutoScalingThresholdsProperty
            ): software.amazon.awscdk.services.opsworks.CfnLayer.AutoScalingThresholdsProperty =
    ...
    public interface LifecycleEventConfigurationProperty {
        ...
        public interface Builder {
            ...
            public fun shutdownEventConfiguration(
                shutdownEventConfiguration: ShutdownEventConfigurationProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun shutdownEventConfiguration(shutdownEventConfiguration: IResolvable) {
                cdkBuilder.shutdownEventConfiguration(
                    shutdownEventConfiguration.let(IResolvable::unwrap)
                )
            }

            /** @param shutdownEventConfiguration The Shutdown event configuration. */
            override fun shutdownEventConfiguration(
                shutdownEventConfiguration: ShutdownEventConfigurationProperty
            ) {
                cdkBuilder.shutdownEventConfiguration(
                    shutdownEventConfiguration.let(ShutdownEventConfigurationProperty::unwrap)
                )
            }
            ...
            override fun shutdownEventConfiguration(
                ...
                shutdownEventConfiguration(
                    ShutdownEventConfigurationProperty(shutdownEventConfiguration)
                )
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-opsworks-layer-lifecycleeventconfiguration.html#cfn-opsworks-layer-lifecycleeventconfiguration-shutdowneventconfiguration)
             */
            override fun shutdownEventConfiguration(): Any? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: LifecycleEventConfigurationProperty
            ): software.amazon.awscdk.services.opsworks.CfnLayer.LifecycleEventConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface RecipesProperty {
        ...
        public interface Builder {
            /**
             * @param configure An array of custom recipe names to be run following a `configure`
             *   event.
             */
            ...
            /**
             * @param shutdown An array of custom recipe names to be run following a `shutdown`
             *   event.
             */
            ...
            /**
             * @param undeploy An array of custom recipe names to be run following a `undeploy`
             *   event.
             */
    ...
    public interface LoadBasedAutoScalingProperty {
        ...
        public interface Builder {
             ...
             *   configuration, which defines how and when AWS OpsWorks Stacks increases the number
             *   of instances.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("f9cda7a5b9775e3f009d9a6d189c785654f2ecd2ae9d640b1d53e089103a9535")
            override fun downScaling(
                downScaling: AutoScalingThresholdsProperty.Builder.() -> Unit
            ): Unit = downScaling(AutoScalingThresholdsProperty(downScaling))
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("e98bf6335bbca94e6f468a1b112e8bd884eff09cac00c5118212d2e46a79fce4")
            override fun upScaling(
                upScaling: AutoScalingThresholdsProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: LoadBasedAutoScalingProperty
            ): software.amazon.awscdk.services.opsworks.CfnLayer.LoadBasedAutoScalingProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface VolumeConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param encrypted Specifies whether an Amazon EBS volume is encrypted. For more
             *   information, see
             *   [Amazon EBS Encryption](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/EBSEncryption.html)
             *   .
             */
             ...
             *   volume. For PIOPS volumes, the IOPS per disk.
             *
             * If you specify `io1` for the volume type, you must specify this property.
             */
             ...
             * * `io1` - Provisioned IOPS (SSD). PIOPS volumes must have a minimum size of 4 GiB and
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: VolumeConfigurationProperty
            ): software.amazon.awscdk.services.opsworks.CfnLayer.VolumeConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ShutdownEventConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param delayUntilElbConnectionsDrained Whether to enable Elastic Load Balancing
             *   connection draining. For more information, see
             *   [Connection Draining](https://docs.aws.amazon.com/ElasticLoadBalancing/latest/DeveloperGuide/TerminologyandKeyConcepts.html#conn-drain)
             */
        ...
        private class BuilderImpl : Builder {
             ...
             *   [Connection Draining](https://docs.aws.amazon.com/ElasticLoadBalancing/latest/DeveloperGuide/TerminologyandKeyConcepts.html#conn-drain)
             */
            override fun delayUntilElbConnectionsDrained(
                delayUntilElbConnectionsDrained: IResolvable
            ) {
                cdkBuilder.delayUntilElbConnectionsDrained(
                    delayUntilElbConnectionsDrained.let(IResolvable::unwrap)
                )
            }
        ...
        internal constructor(
            ...
            /**
             * The time, in seconds, that AWS OpsWorks Stacks waits after triggering a Shutdown
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ShutdownEventConfigurationProperty
            ): software.amazon.awscdk.services.opsworks.CfnLayer.ShutdownEventConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
