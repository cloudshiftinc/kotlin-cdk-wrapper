...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.batch.EcsFargateContainerDefinition,
) :
     ...
     */
    public override fun environment(): Map<String, String> =
    ...
    public interface Builder {
         ...
         * requires a NAT gateway be attached to route requests to the internet.
         *
         * Default: false
         *
         ...
         * The environment variables to pass to a container.
         *
         * Cannot start with `AWS_BATCH`. We don't recommend using plaintext environment variables
        ...
        /**
         * The role used by Amazon ECS container and AWS Fargate agents to make AWS API calls on
         * your behalf.
         *
         ...
         *
         * @param executionRole The role used by Amazon ECS container and AWS Fargate agents to make
         ...
         * Default: LATEST
         *
         * @param fargatePlatformVersion Which version of Fargate to use when running this
         *   container.
         */
         ...
         * A map from environment variable names to the secrets for the container.
         *
         * Allows your job definitions to reference the secret by the environment variable name
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.batch.EcsFargateContainerDefinition.Builder.create(
                scope,
                id
            )
         ...
         * @param fargateOperatingSystemFamily The operating system for the compute environment.
         */
        override fun fargateOperatingSystemFamily(
            fargateOperatingSystemFamily: OperatingSystemFamily
        ) {
            cdkBuilder.fargateOperatingSystemFamily(
                fargateOperatingSystemFamily.let(OperatingSystemFamily::unwrap)
            )
        }
        ...
        override fun fargatePlatformVersion(fargatePlatformVersion: FargatePlatformVersion) {
            cdkBuilder.fargatePlatformVersion(
                fargatePlatformVersion.let(FargatePlatformVersion::unwrap)
            )
        }
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: EcsFargateContainerDefinition
