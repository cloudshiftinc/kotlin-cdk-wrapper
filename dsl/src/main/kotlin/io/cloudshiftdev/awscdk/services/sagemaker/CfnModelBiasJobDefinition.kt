...
internal constructor(
    ...
    public open fun modelBiasAppSpecification(`value`: ModelBiasAppSpecificationProperty) {
        unwrap(this)
            .setModelBiasAppSpecification(`value`.let(ModelBiasAppSpecificationProperty::unwrap))
    }

    /** Configures the model bias job to run a specified Docker container image. */
    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("985bf816bd154874821ebc9daa3ebd4d218cbbb04339d4ce5b6f4113a81ff05f")
    public open fun modelBiasAppSpecification(
        `value`: ModelBiasAppSpecificationProperty.Builder.() -> Unit
    ...
    public open fun modelBiasBaselineConfig(`value`: ModelBiasBaselineConfigProperty) {
        unwrap(this)
            .setModelBiasBaselineConfig(`value`.let(ModelBiasBaselineConfigProperty::unwrap))
    }

    /** The baseline configuration for a model bias job. */
    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("bd0d9e14442da8784f311283f599e6dd4ea4e46ecaad64599fe71b73d9abcdbe")
    public open fun modelBiasBaselineConfig(
        `value`: ModelBiasBaselineConfigProperty.Builder.() -> Unit
    ): Unit = modelBiasBaselineConfig(ModelBiasBaselineConfigProperty(`value`))
    ...
    public open fun modelBiasJobOutputConfig(`value`: MonitoringOutputConfigProperty) {
        unwrap(this)
            .setModelBiasJobOutputConfig(`value`.let(MonitoringOutputConfigProperty::unwrap))
    }

    /** The output configuration for monitoring jobs. */
    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("5fd536534c49251923d21f6391d251b2214fef49b5fbe1022229b25687fe8fc6")
    public open fun modelBiasJobOutputConfig(
        `value`: MonitoringOutputConfigProperty.Builder.() -> Unit
    ): Unit = modelBiasJobOutputConfig(MonitoringOutputConfigProperty(`value`))
    ...
    public interface Builder {
        ...
        public fun modelBiasAppSpecification(
            modelBiasAppSpecification: ModelBiasAppSpecificationProperty.Builder.() -> Unit
        )
        ...
        public fun modelBiasBaselineConfig(
            modelBiasBaselineConfig: ModelBiasBaselineConfigProperty.Builder.() -> Unit
        )
        ...
        public fun modelBiasJobInput(
            modelBiasJobInput: ModelBiasJobInputProperty.Builder.() -> Unit
        )
        ...
        public fun modelBiasJobOutputConfig(
            modelBiasJobOutputConfig: MonitoringOutputConfigProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.sagemaker.CfnModelBiasJobDefinition.Builder.create(
                scope,
                id
            )
         ...
         *   container image.
         */
        override fun modelBiasAppSpecification(
            modelBiasAppSpecification: ModelBiasAppSpecificationProperty
        ) {
            cdkBuilder.modelBiasAppSpecification(
                modelBiasAppSpecification.let(ModelBiasAppSpecificationProperty::unwrap)
            )
        }
         ...
         * @param modelBiasBaselineConfig The baseline configuration for a model bias job.
         */
        override fun modelBiasBaselineConfig(
            modelBiasBaselineConfig: ModelBiasBaselineConfigProperty
        ) {
            cdkBuilder.modelBiasBaselineConfig(
                modelBiasBaselineConfig.let(ModelBiasBaselineConfigProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("6f86e4242430b3813c716bc4c8cd23bd0faa5f2b5146072b66d4b7597a236bf6")
        override fun modelBiasJobInput(
            modelBiasJobInput: ModelBiasJobInputProperty.Builder.() -> Unit
         ...
         * @param modelBiasJobOutputConfig The output configuration for monitoring jobs.
         */
        override fun modelBiasJobOutputConfig(
            modelBiasJobOutputConfig: MonitoringOutputConfigProperty
        ) {
            cdkBuilder.modelBiasJobOutputConfig(
                modelBiasJobOutputConfig.let(MonitoringOutputConfigProperty::unwrap)
            )
        }
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnModelBiasJobDefinition
    ...
    public interface S3OutputProperty {
        ...
        public interface Builder {
             ...
             *   SageMaker saves the results of a monitoring job. `LocalPath` is an absolute path
             *   for the output data.
             */
            public fun localPath(localPath: String)
    ...
    public interface ModelBiasAppSpecificationProperty {
        ...
        public interface Builder {
            /**
             * @param configUri JSON formatted S3 file that defines bias parameters. For more
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ModelBiasAppSpecificationProperty
            ): software.amazon.awscdk.services.sagemaker.CfnModelBiasJobDefinition.ModelBiasAppSpecificationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ModelBiasBaselineConfigProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ModelBiasBaselineConfigProperty
            ): software.amazon.awscdk.services.sagemaker.CfnModelBiasJobDefinition.ModelBiasBaselineConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ModelBiasJobInputProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ModelBiasJobInputProperty
            ): software.amazon.awscdk.services.sagemaker.CfnModelBiasJobDefinition.ModelBiasJobInputProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
