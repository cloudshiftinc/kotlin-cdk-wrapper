...
public enum class DeduplicationScope(
    ...
    public companion object {
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.sqs.DeduplicationScope
        ): DeduplicationScope =
            when (cdkObject) {
                software.amazon.awscdk.services.sqs.DeduplicationScope.MESSAGE_GROUP ->
                    DeduplicationScope.MESSAGE_GROUP
                software.amazon.awscdk.services.sqs.DeduplicationScope.QUEUE ->
                    DeduplicationScope.QUEUE
            }

        internal fun unwrap(
            wrapped: DeduplicationScope
