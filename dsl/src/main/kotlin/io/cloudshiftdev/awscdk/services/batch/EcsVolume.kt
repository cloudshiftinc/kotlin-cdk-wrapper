...
internal constructor(
    ...
    public companion object {
        public fun efs(options: EfsVolumeOptions): EfsVolume =
            software.amazon.awscdk.services.batch.EcsVolume.efs(
                    options.let(EfsVolumeOptions::unwrap)
                )
                .let(EfsVolume::wrap)
        ...
        public fun host(options: HostVolumeOptions): HostVolume =
            software.amazon.awscdk.services.batch.EcsVolume.host(
                    options.let(HostVolumeOptions::unwrap)
                )
                .let(HostVolume::wrap)
