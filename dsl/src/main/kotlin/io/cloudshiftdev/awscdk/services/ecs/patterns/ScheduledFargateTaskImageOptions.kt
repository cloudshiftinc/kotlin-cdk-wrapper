...
public interface ScheduledFargateTaskImageOptions :
    ScheduledTaskImageProps, FargateServiceBaseProps {
    ...
    public interface Builder {
         ...
         *   the task. The minimum supported value is `21` GiB and the maximum supported value is
         *   `200` GiB.
         *
        ...
        /**
         * @param memoryLimitMiB The amount (in MiB) of memory used by the task. This field is
         *   required and you must use one of the following values, which determines your range of
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: ScheduledFargateTaskImageOptions
        ): software.amazon.awscdk.services.ecs.patterns.ScheduledFargateTaskImageOptions =
