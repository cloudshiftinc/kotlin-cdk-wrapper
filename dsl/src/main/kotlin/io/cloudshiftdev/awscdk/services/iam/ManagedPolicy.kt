...
internal constructor(
    ...
    public interface Builder {
         ...
         * example, "Grants access to production DynamoDB tables." The policy description is
    ...
    public companion object {
        ...
        public fun fromManagedPolicyArn(
            ...
            software.amazon.awscdk.services.iam.ManagedPolicy.fromManagedPolicyArn(
        ...
        public fun fromManagedPolicyName(
            ...
            software.amazon.awscdk.services.iam.ManagedPolicy.fromManagedPolicyName(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    managedPolicyName
                )
        ...
        ): ManagedPolicy = ManagedPolicy(cdkObject)

        internal fun unwrap(
            wrapped: ManagedPolicy
        ): software.amazon.awscdk.services.iam.ManagedPolicy = wrapped.cdkObject
    }
}
