...
internal constructor(
    ...
    public interface Builder {
        /**
         * Whether requests from service consumers to connect to the service through an endpoint
         * must be accepted.
         *
         * Default: true
         *
         * @param acceptanceRequired Whether requests from service consumers to connect to the
         *   service through an endpoint must be accepted.
         */
         ...
         *
         * These principals can connect to your service using VPC endpoints. Takes a list of one or
         * more ArnPrincipal.
         *
         * Default: - no principals
         *
         * @param allowedPrincipals IAM users, IAM roles, or AWS accounts to allow inbound
         *   connections from.
         */
         ...
         *
         * @param vpcEndpointServiceLoadBalancers One or more load balancers to host the VPC
         *   Endpoint Service.
         */
        public fun vpcEndpointServiceLoadBalancers(
            vpcEndpointServiceLoadBalancers: List<IVpcEndpointServiceLoadBalancer>
        )
    ...
    private class BuilderImpl(
         ...
         *   Endpoint Service.
         */
        override fun vpcEndpointServiceLoadBalancers(
            vpcEndpointServiceLoadBalancers: List<IVpcEndpointServiceLoadBalancer>
        ) {
            cdkBuilder.vpcEndpointServiceLoadBalancers(
                vpcEndpointServiceLoadBalancers.map(IVpcEndpointServiceLoadBalancer::unwrap)
            )
        }
        ...
        override fun vpcEndpointServiceLoadBalancers(
            vararg vpcEndpointServiceLoadBalancers: IVpcEndpointServiceLoadBalancer
        ): Unit = vpcEndpointServiceLoadBalancers(vpcEndpointServiceLoadBalancers.toList())

        public fun build(): software.amazon.awscdk.services.ec2.VpcEndpointService =
            cdkBuilder.build()
    }
