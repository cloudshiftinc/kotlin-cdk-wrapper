...
internal constructor(
    ...
    public interface Builder {
         ...
         * including the full length of the parameter Amazon Resource Name (ARN), is 1011
         * characters. For example, the length of the following parameter name is 65 characters, not
         ...
         * environment. For example, you might want to tag a Systems Manager parameter to identify
         * the type of resource to which it applies, the environment, or the type of configuration
         ...
         *
         * @param tags Optional metadata that you assign to a resource in the form of an arbitrary
         *   set of tags (key-value pairs).
         */
    ...
    public companion object {
        ...
        ): CfnParameter = CfnParameter(cdkObject)

        internal fun unwrap(
            wrapped: CfnParameter
        ): software.amazon.awscdk.services.ssm.CfnParameter = wrapped.cdkObject
    }
}
