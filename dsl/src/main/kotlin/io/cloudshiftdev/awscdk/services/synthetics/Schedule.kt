...
internal constructor(
    ...
    public companion object {
        public fun cron(options: CronOptions): Schedule =
            software.amazon.awscdk.services.synthetics.Schedule.cron(
        ...
        public fun expression(expression: String): Schedule =
            software.amazon.awscdk.services.synthetics.Schedule.expression(expression)
                .let(Schedule::wrap)
        ...
        public fun rate(interval: Duration): Schedule =
            software.amazon.awscdk.services.synthetics.Schedule.rate(interval.let(Duration::unwrap))
                .let(Schedule::wrap)
        ...
        internal fun unwrap(
            wrapped: Schedule
        ): software.amazon.awscdk.services.synthetics.Schedule = wrapped.cdkObject
    }
}
