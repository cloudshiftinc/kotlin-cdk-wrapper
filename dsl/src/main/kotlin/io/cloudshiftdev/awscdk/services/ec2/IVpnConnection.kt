...
public interface IVpnConnection : IResource {
    ...
    internal constructor(
         ...
         * @param props
         */
        override fun metricTunnelDataIn(): Metric =
         ...
         * @param props
         */
        override fun metricTunnelState(): Metric =
    ...
    public companion object {
        ...
        ): IVpnConnection = Wrapper(cdkObject)

        internal fun unwrap(
            wrapped: IVpnConnection
        ): software.amazon.awscdk.services.ec2.IVpnConnection = (wrapped as Wrapper).cdkObject
    }
}
