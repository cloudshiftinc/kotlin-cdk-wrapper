...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * The name must adhere to specific constraints: it can only include lowercase letters
         * (a-z), numbers (0-9), underscores (_), and hyphens (-), and must not exceed 64 characters
         * in length.
         *
         ...
         * `STANDARD` to `MANAGED`. However, updating ScalingMode from `MANAGED` to `STANDARD` is
         * not supported.
         *
    ...
    public companion object {
        public fun fromDedicatedIpPoolName(
            ...
            software.amazon.awscdk.services.ses.DedicatedIpPool.fromDedicatedIpPoolName(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    dedicatedIpPoolName
                )
                .let(IDedicatedIpPool::wrap)
