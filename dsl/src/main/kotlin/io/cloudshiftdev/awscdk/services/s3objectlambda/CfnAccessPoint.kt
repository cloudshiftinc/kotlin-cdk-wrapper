...
internal constructor(
    ...
    /**
     * The Public Access Block Configuration is used to block policies that would allow public
     * access to this Object lambda Access Point.
     *
     * All public access to Object lambda Access Points are blocked by default, and any policy that
     * would give public access to them will be also blocked. This behavior cannot be changed for
    ...
    public open fun objectLambdaConfiguration(`value`: ObjectLambdaConfigurationProperty) {
        unwrap(this)
            .setObjectLambdaConfiguration(`value`.let(ObjectLambdaConfigurationProperty::unwrap))
    }

    /** A configuration used when creating an Object Lambda Access Point. */
    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("e2fc78fc0b4db42c7380110f3c8f27370f1247661726b71bd1d721bb448d7aca")
    public open fun objectLambdaConfiguration(
        `value`: ObjectLambdaConfigurationProperty.Builder.() -> Unit
    ...
    public interface Builder {
         ...
         *
         * @param objectLambdaConfiguration A configuration used when creating an Object Lambda
         *   Access Point.
         */
        ...
        public fun objectLambdaConfiguration(
            objectLambdaConfiguration: ObjectLambdaConfigurationProperty.Builder.() -> Unit
        )
    }
    ...
    private class BuilderImpl(
         ...
         *   Access Point.
         */
        override fun objectLambdaConfiguration(
            objectLambdaConfiguration: ObjectLambdaConfigurationProperty
        ) {
            cdkBuilder.objectLambdaConfiguration(
                objectLambdaConfiguration.let(ObjectLambdaConfigurationProperty::unwrap)
            )
        }
    ...
    public interface ContentTransformationProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ContentTransformationProperty
            ): software.amazon.awscdk.services.s3objectlambda.CfnAccessPoint.ContentTransformationProperty =
    ...
    public interface PolicyStatusProperty {
        ...
        public interface Builder {
            /**
             * @param isPublic Specifies whether the Object lambda Access Point Policy is Public or
             *   not. Object lambda Access Points are private by default.
             */
    ...
    public interface PublicAccessBlockConfigurationProperty {
         ...
         * AWS service principals and authorized users within this account.
         *
        ...
        public interface Builder {
             ...
             *   lists (ACLs) for buckets in this account. Setting this element to `TRUE` causes the
             *   following behavior:
             * * `PutBucketAcl` and `PutObjectAcl` calls fail if the specified ACL is public.
             * * PUT Object calls fail if the request includes a public ACL.
             * * PUT Bucket calls fail if the request includes a public ACL.
             ...
             *   policies for buckets in this account. Setting this element to `TRUE` causes Amazon
             ...
             *   buckets in this account. Setting this element to `TRUE` causes Amazon S3 to ignore
             ...
             *   bucket policies for buckets in this account. Setting this element to `TRUE`
             *   restricts access to buckets with public policies to only AWS service principals and
        ...
        internal constructor(
             ...
             * this account.
             *
             * Setting this element to `TRUE` restricts access to buckets with public policies to
             * only AWS service principals and authorized users within this account.
             *
             * Enabling this setting doesn't affect previously stored bucket policies, except that
             * public and cross-account access within any public bucket policy, including non-public
             * delegation to specific accounts, is blocked.
    ...
    public interface TransformationConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param actions A container for the action of an Object Lambda Access Point
             *   configuration. Valid inputs are `GetObject` , `HeadObject` , `ListObjects` , and
             *   `ListObjectsV2` .
             */
            ...
            /**
             * @param contentTransformation A container for the content transformation of an Object
             *   Lambda Access Point configuration. Can include the FunctionArn and FunctionPayload.
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TransformationConfigurationProperty
            ): software.amazon.awscdk.services.s3objectlambda.CfnAccessPoint.TransformationConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ObjectLambdaConfigurationProperty {
         ...
         */
        public fun allowedFeatures(): List<String> =
            unwrap(this).getAllowedFeatures() ?: emptyList()
        ...
        public interface Builder {
            /**
             * @param allowedFeatures A container for allowed features. Valid inputs are
            ...
            /**
             * @param supportingAccessPoint Standard access point associated with the Object Lambda
             *   Access Point.
             */
            public fun supportingAccessPoint(supportingAccessPoint: String)

            /**
             * @param transformationConfigurations A container for transformation configurations for
        ...
        private class BuilderImpl : Builder {
            ...
            override fun transformationConfigurations(transformationConfigurations: IResolvable) {
                cdkBuilder.transformationConfigurations(
                    transformationConfigurations.let(IResolvable::unwrap)
                )
            }
             ...
             *   an Object Lambda Access Point.
             */
            override fun transformationConfigurations(
                vararg transformationConfigurations: Any
            ): Unit = transformationConfigurations(transformationConfigurations.toList())
        ...
        internal constructor(
             ...
             * A container for allowed features.
             *
             * Valid inputs are `GetObject-Range` , `GetObject-PartNumber` , `HeadObject-Range` ,
             * and `HeadObject-PartNumber` .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-s3objectlambda-accesspoint-objectlambdaconfiguration.html#cfn-s3objectlambda-accesspoint-objectlambdaconfiguration-allowedfeatures)
             */
            override fun allowedFeatures(): List<String> =
                unwrap(this).getAllowedFeatures() ?: emptyList()
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ObjectLambdaConfigurationProperty
            ): software.amazon.awscdk.services.s3objectlambda.CfnAccessPoint.ObjectLambdaConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface AliasProperty {
         ...
         * The status of the Object Lambda Access Point alias.
         *
         * If the status is `PROVISIONING` , the Object Lambda Access Point is provisioning the
         * alias and the alias is not ready for use yet. If the status is `READY` , the Object
