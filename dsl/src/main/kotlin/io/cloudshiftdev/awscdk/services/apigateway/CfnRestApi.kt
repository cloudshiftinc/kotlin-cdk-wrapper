...
internal constructor(
    ...
    public open fun binaryMediaTypes(): List<String> =
        unwrap(this).getBinaryMediaTypes() ?: emptyList()
    ...
    public open fun endpointConfiguration(
        `value`: EndpointConfigurationProperty.Builder.() -> Unit
    ...
    public interface Builder {
         ...
         *
         * @param bodyS3Location The Amazon Simple Storage Service (Amazon S3) location that points
         *   to an OpenAPI file, which defines a set of RESTful APIs in JSON or YAML format.
         */
         ...
         * A list of the endpoint types of the API.
         *
         * Use this property when creating an API. When importing an existing API, specify the
        ...
        public fun endpointConfiguration(
            endpointConfiguration: EndpointConfigurationProperty.Builder.() -> Unit
        )
         ...
         *
         * If you don't specify this property, a default value is chosen. For REST APIs created
         * before March 29, 2021, the default is `overwrite` . For REST APIs created after March 29,
         * 2021, the new API definition takes precedence, but any container types such as endpoint
         * configurations and binary media types are merged with the existing API.
         *
         * Use the default mode to define top-level `RestApi` properties in addition to using
         * OpenAPI. Generally, it's preferred to use API Gateway's OpenAPI extensions to model these
         * properties.
         *
         ...
         * Custom header parameters as part of the request.
         *
         * For example, to exclude DocumentationParts from an imported API, set
         ...
         * A policy document that contains the permissions for the `RestApi` resource.
         *
         * To set the ARN for the policy, use the `!Join` intrinsic function with `""` as delimiter
         * and values of `"execute-api:/"` and `"*"` .
         *
         ...
         * The key-value map of strings.
         *
         * The valid character set is [a-zA-Z+-=._:/]. The tag key can be up to 128 characters and
    ...
    private class BuilderImpl(
        ...
        override fun endpointConfiguration(endpointConfiguration: EndpointConfigurationProperty) {
            cdkBuilder.endpointConfiguration(
                endpointConfiguration.let(EndpointConfigurationProperty::unwrap)
            )
        }
        ...
        public fun build(): software.amazon.awscdk.services.apigateway.CfnRestApi =
            cdkBuilder.build()
    }
    ...
    public companion object {
        ...
        ): CfnRestApi = CfnRestApi(cdkObject)

        internal fun unwrap(
            wrapped: CfnRestApi
        ): software.amazon.awscdk.services.apigateway.CfnRestApi = wrapped.cdkObject
    }
    ...
    public interface S3LocationProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param eTag The Amazon S3 ETag (a file checksum) of the OpenAPI file. If you don't
            ...
            /**
             * @param version For versioning-enabled buckets, a specific version of the OpenAPI
             *   file.
             */
    ...
    public interface EndpointConfigurationProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param vpcEndpointIds A list of VpcEndpointIds of an API (RestApi) against which to
             *   create Route53 ALIASes. It is only supported for `PRIVATE` endpoint type.
             */
        ...
        internal constructor(
             ...
             * For a regional API and its custom domain name, the endpoint type is `REGIONAL` . For
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-apigateway-restapi-endpointconfiguration.html#cfn-apigateway-restapi-endpointconfiguration-vpcendpointids)
             */
            override fun vpcEndpointIds(): List<String> =
                unwrap(this).getVpcEndpointIds() ?: emptyList()
        }
