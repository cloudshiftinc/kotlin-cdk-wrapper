...
public interface VpcAttributes {
     ...
     */
    public fun isolatedSubnetIds(): List<String> =
        unwrap(this).getIsolatedSubnetIds() ?: emptyList()
     ...
     */
    public fun isolatedSubnetNames(): List<String> =
        unwrap(this).getIsolatedSubnetNames() ?: emptyList()
     ...
     */
    public fun privateSubnetNames(): List<String> =
        unwrap(this).getPrivateSubnetNames() ?: emptyList()
     ...
     */
    public fun publicSubnetNames(): List<String> =
        unwrap(this).getPublicSubnetNames() ?: emptyList()
     ...
     */
    public fun publicSubnetRouteTableIds(): List<String> =
    ...
    public interface Builder {
        ...
        /**
         * @param isolatedSubnetIds List of isolated subnet IDs. Must be undefined or match the
         *   availability zones in length and order.
         */
        ...
        /**
         * @param isolatedSubnetNames List of names for the isolated subnets. Must be undefined or
         *   have a name for every isolated subnet group.
         */
        ...
        /**
         * @param privateSubnetIds List of private subnet IDs. Must be undefined or match the
         *   availability zones in length and order.
         */
        ...
        /**
         * @param privateSubnetIpv4CidrBlocks List of IPv4 CIDR blocks for the private subnets. Must
         *   be undefined or have an entry for every private subnet group.
         */
        ...
        /**
         * @param privateSubnetNames List of names for the private subnets. Must be undefined or
         *   have a name for every private subnet group.
         */
        ...
        /**
         * @param publicSubnetIds List of public subnet IDs. Must be undefined or match the
         *   availability zones in length and order.
         */
        ...
        /**
         * @param publicSubnetIpv4CidrBlocks List of IPv4 CIDR blocks for the public subnets. Must
         *   be undefined or have an entry for every public subnet group.
         */
        ...
        /**
         * @param publicSubnetNames List of names for the public subnets. Must be undefined or have
         *   a name for every public subnet group.
         */
        ...
        /**
         * @param publicSubnetRouteTableIds List of IDs of route tables for the public subnets. Must
         *   be undefined or have a name for every public subnet group.
         */
    ...
    private class BuilderImpl : Builder {
         ...
         *   Must be undefined or have an entry for every isolated subnet group.
         */
        override fun isolatedSubnetIpv4CidrBlocks(
            vararg isolatedSubnetIpv4CidrBlocks: String
        ): Unit = isolatedSubnetIpv4CidrBlocks(isolatedSubnetIpv4CidrBlocks.toList())
    ...
    internal constructor(
         ...
         * Default: - The VPC does not have any isolated subnets
         */
        override fun isolatedSubnetIds(): List<String> =
            unwrap(this).getIsolatedSubnetIds() ?: emptyList()
         ...
         * Default: - All isolated subnets will have the name `Isolated`
         */
        override fun isolatedSubnetNames(): List<String> =
            unwrap(this).getIsolatedSubnetNames() ?: emptyList()
         ...
         * Default: - The VPC does not have any private subnets
         */
        override fun privateSubnetIds(): List<String> =
            unwrap(this).getPrivateSubnetIds() ?: emptyList()
         ...
         * Default: - All private subnets will have the name `Private`
         */
        override fun privateSubnetNames(): List<String> =
            unwrap(this).getPrivateSubnetNames() ?: emptyList()
         ...
         * Default: - The VPC does not have any public subnets
         */
        override fun publicSubnetIds(): List<String> =
            unwrap(this).getPublicSubnetIds() ?: emptyList()
         ...
         * Default: - All public subnets will have the name `Public`
         */
        override fun publicSubnetNames(): List<String> =
            unwrap(this).getPublicSubnetNames() ?: emptyList()
    ...
    public companion object {
        ...
        ): VpcAttributes = Wrapper(cdkObject)

        internal fun unwrap(
            wrapped: VpcAttributes
        ): software.amazon.awscdk.services.ec2.VpcAttributes = (wrapped as Wrapper).cdkObject
    }
}
