...
internal constructor(
    ...
    public companion object {
        public fun fromAsset(
            ...
            software.amazon.awscdk.services.stepfunctions.tasks.DockerImage.fromAsset(
                    scope.let(Construct::unwrap),
                    id,
                    props.let(DockerImageAssetProps::unwrap)
                )
                .let(DockerImage::wrap)
        ...
        public fun fromEcrRepository(repository: IRepository): DockerImage =
            software.amazon.awscdk.services.stepfunctions.tasks.DockerImage.fromEcrRepository(
        ...
        public fun fromJsonExpression(expression: String): DockerImage =
            software.amazon.awscdk.services.stepfunctions.tasks.DockerImage.fromJsonExpression(
                    expression
                )
                .let(DockerImage::wrap)

        public fun fromJsonExpression(
            expression: String,
            allowAnyEcrImagePull: Boolean
        ): DockerImage =
            software.amazon.awscdk.services.stepfunctions.tasks.DockerImage.fromJsonExpression(
                    expression,
                    allowAnyEcrImagePull
                )
                .let(DockerImage::wrap)

        public fun fromRegistry(imageUri: String): DockerImage =
            software.amazon.awscdk.services.stepfunctions.tasks.DockerImage.fromRegistry(imageUri)
                .let(DockerImage::wrap)
