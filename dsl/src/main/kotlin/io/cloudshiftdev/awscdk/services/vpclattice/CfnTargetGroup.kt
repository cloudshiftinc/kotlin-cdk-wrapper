...
internal constructor(
    ...
    public interface HealthCheckConfigProperty {
         ...
         */
        public fun healthCheckIntervalSeconds(): Number? =
         ...
         */
        public fun healthCheckTimeoutSeconds(): Number? =
         ...
         * `/path?query` ). The default path is `/` . Health checks are not supported if the
         * protocol version is `gRPC` , however, you can choose `HTTP/1.1` or `HTTP/2` and specify a
         * valid URI.
         *
        ...
        public interface Builder {
             ...
             *   health checks of an individual target. The range is 5–300 seconds. The default is
             *   30 seconds.
             */
            public fun healthCheckIntervalSeconds(healthCheckIntervalSeconds: Number)

            /**
             * @param healthCheckTimeoutSeconds The amount of time, in seconds, to wait before
             *   reporting a target as unhealthy. The range is 1–120 seconds. The default is 5
             *   seconds.
             */
            public fun healthCheckTimeoutSeconds(healthCheckTimeoutSeconds: Number)

            /**
             * @param healthyThresholdCount The number of consecutive successful health checks
             *   required before considering an unhealthy target healthy. The range is 2–10. The
             *   default is 5.
             */
            public fun healthyThresholdCount(healthyThresholdCount: Number)

            /**
             * @param matcher The codes to use when checking for a successful response from a
             *   target.
             */
            ...
            /**
             * @param port The port used when performing health checks on targets. The default
             *   setting is the port that a target receives traffic on.
             */
            public fun port(port: Number)

            /**
             * @param protocol The protocol used when performing health checks on targets. The
             *   possible protocols are `HTTP` and `HTTPS` . The default is `HTTP` .
             */
            public fun protocol(protocol: String)

            /**
             * @param protocolVersion The protocol version used when performing health checks on
             *   targets. The possible protocol versions are `HTTP1` and `HTTP2` .
             */
            public fun protocolVersion(protocolVersion: String)

            /**
             * @param unhealthyThresholdCount The number of consecutive failed health checks
             *   required before considering a target unhealthy. The range is 2–10. The default
             *   is 2.
             */
        ...
        internal constructor(
             ...
             * If the protocol version is `HTTP/1.1` or `HTTP/2` , specify a valid URI (for example,
             * `/path?query` ). The default path is `/` . Health checks are not supported if the
             * protocol version is `gRPC` , however, you can choose `HTTP/1.1` or `HTTP/2` and
             * specify a valid URI.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-vpclattice-targetgroup-healthcheckconfig.html#cfn-vpclattice-targetgroup-healthcheckconfig-path)
             */
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-vpclattice-targetgroup-healthcheckconfig.html#cfn-vpclattice-targetgroup-healthcheckconfig-unhealthythresholdcount)
             */
            override fun unhealthyThresholdCount(): Number? =
    ...
    public interface MatcherProperty {
        ...
        public interface Builder {
            /**
             * @param httpCode The HTTP code to use when checking for a successful response from a
             *   target.
             */
    ...
    public interface TargetProperty {
         ...
         * is `IP` , this is an IP address. If the target group type is `LAMBDA` , this is the ARN
         * of a Lambda function. If the target group type is `ALB` , this is the ARN of an
        ...
        public interface Builder {
            /**
             * @param id The ID of the target. If the target group type is `INSTANCE` , this is an
             *   instance ID. If the target group type is `IP` , this is an IP address. If the
             *   target group type is `LAMBDA` , this is the ARN of a Lambda function. If the target
             *   group type is `ALB` , this is the ARN of an Application Load Balancer.
             */
            public fun id(id: String)

            /**
             * @param port The port on which the target is listening. For HTTP, the default is 80.
        ...
        internal constructor(
             ...
             * The ID of the target.
             *
             * If the target group type is `INSTANCE` , this is an instance ID. If the target group
             * type is `IP` , this is an IP address. If the target group type is `LAMBDA` , this is
             * the ARN of a Lambda function. If the target group type is `ALB` , this is the ARN of
    ...
    public interface TargetGroupConfigProperty {
         ...
         *
         * The default is the protocol of the target group. Not supported if the target group type
         * is `LAMBDA` .
         *
        ...
        public interface Builder {
            /**
             * @param healthCheck The health check configuration. Not supported if the target group
            ...
            /**
             * @param ipAddressType The type of IP address used for the target group. Supported only
             *   if the target group type is `IP` . The default is `IPV4` .
             */
            public fun ipAddressType(ipAddressType: String)

            /**
             * @param lambdaEventStructureVersion The version of the event structure that your
             *   Lambda function receives. Supported only if the target group type is `LAMBDA` . The
             *   default is `V1` .
             */
            public fun lambdaEventStructureVersion(lambdaEventStructureVersion: String)

            /**
             * @param port The port on which the targets are listening. For HTTP, the default is 80.
             *   For HTTPS, the default is 443. Not supported if the target group type is `LAMBDA` .
             */
            public fun port(port: Number)

            /**
             * @param protocol The protocol to use for routing traffic to the targets. The default
             *   is the protocol of the target group. Not supported if the target group type is
             *   `LAMBDA` .
             */
            public fun protocol(protocol: String)

            /**
             * @param protocolVersion The protocol version. The default is `HTTP1` . Not supported
             *   if the target group type is `LAMBDA` .
             */
            public fun protocolVersion(protocolVersion: String)

            /**
             * @param vpcIdentifier The ID of the VPC. Not supported if the target group type is
             *   `LAMBDA` .
             */
        ...
        private class BuilderImpl : Builder {
            ...
            override fun healthCheck(
                healthCheck: HealthCheckConfigProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * The port on which the targets are listening.
             *
             * For HTTP, the default is 80. For HTTPS, the default is 443. Not supported if the
             ...
             * The protocol to use for routing traffic to the targets.
             *
             * The default is the protocol of the target group. Not supported if the target group
             * type is `LAMBDA` .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-vpclattice-targetgroup-targetgroupconfig.html#cfn-vpclattice-targetgroup-targetgroupconfig-protocol)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TargetGroupConfigProperty
            ): software.amazon.awscdk.services.vpclattice.CfnTargetGroup.TargetGroupConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
