...
internal constructor(
    ...
    public interface Builder {
         ...
         * The name of the feature that stores the `EventTime` of a Record in a `FeatureGroup` .
         *
         * A `EventTime` is point in time when a new event occurs that corresponds to the creation
         * or update of a `Record` in `FeatureGroup` . All `Records` in the `FeatureGroup` must have
         ...
         *
         * @param eventTimeFeatureName The name of the feature that stores the `EventTime` of a
         ...
         *
         * @param featureDefinitions A list of `Feature` s. Each `Feature` must include a
         ...
         *
         * @param recordIdentifierFeatureName The name of the `Feature` whose value uniquely
         *   identifies a `Record` defined in the `FeatureGroup` `FeatureDefinitions` .
         */
         ...
         *
         * @param roleArn The Amazon Resource Name (ARN) of the IAM execution role used to create
         *   the feature group.
         */
         ...
         * Used to set feature group throughput configuration.
         *
         * There are two modes: `ON_DEMAND` and `PROVISIONED` . With on-demand mode, you are charged
         * for data reads and writes that your application performs on your feature group. You do
         * not need to specify read and write throughput because Feature Store accommodates your
    ...
    private class BuilderImpl(
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("feeb221954c6f330aee919a38c50d43bdb2806eba422525d9ff849dd44995890")
        override fun throughputConfig(
            throughputConfig: ThroughputConfigProperty.Builder.() -> Unit
    ...
    public interface OfflineStoreConfigProperty {
         ...
         *
         * Supported formats are Glue (Default) and
         * [Apache Iceberg](https://docs.aws.amazon.com/https://iceberg.apache.org/) .
         *
        ...
        public interface Builder {
            /**
             * @param dataCatalogConfig The meta data of the Glue table that is autogenerated when
             *   an `OfflineStore` is created.
             */
            ...
            public fun dataCatalogConfig(
                dataCatalogConfig: DataCatalogConfigProperty.Builder.() -> Unit
            )

            /**
             * @param disableGlueTableCreation Set to `True` to disable the automatic creation of an
             *   AWS Glue table when configuring an `OfflineStore` . If set to `False` , Feature
             *   Store will name the `OfflineStore` Glue table following
             *   [Athena's naming recommendations](https://docs.aws.amazon.com/athena/latest/ug/tables-databases-columns-names.html)
             *   .
             *
             * The default value is `False` .
            ...
            /**
             * @param s3StorageConfig The Amazon Simple Storage (Amazon S3) location of
             *   `OfflineStore` .
             */
            ...
            /**
             * @param tableFormat Format for the offline store table. Supported formats are Glue
             *   (Default) and
             *   [Apache Iceberg](https://docs.aws.amazon.com/https://iceberg.apache.org/) .
             */
        ...
        private class BuilderImpl : Builder {
            ...
            override fun dataCatalogConfig(dataCatalogConfig: DataCatalogConfigProperty) {
                cdkBuilder.dataCatalogConfig(
                    dataCatalogConfig.let(DataCatalogConfigProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("8e047b0fe9e5caed0af2f193bd89b57a611aa498fc2d1fb1eae59793dc052a66")
            override fun dataCatalogConfig(
                dataCatalogConfig: DataCatalogConfigProperty.Builder.() -> Unit
            ...
            override fun disableGlueTableCreation(disableGlueTableCreation: IResolvable) {
                cdkBuilder.disableGlueTableCreation(
                    disableGlueTableCreation.let(IResolvable::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("b930ec4e1b421a35978668af54bfe7fe10be792f7c06729aaead85ddd0ee8bab")
            override fun s3StorageConfig(
                s3StorageConfig: S3StorageConfigProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-sagemaker-featuregroup-offlinestoreconfig.html#cfn-sagemaker-featuregroup-offlinestoreconfig-disablegluetablecreation)
             */
            override fun disableGlueTableCreation(): Any? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: OfflineStoreConfigProperty
            ): software.amazon.awscdk.services.sagemaker.CfnFeatureGroup.OfflineStoreConfigProperty =
    ...
    public interface ThroughputConfigProperty {
        ...
        public interface Builder {
             ...
             *   enabled, this indicates the read throughput you are billed for and can consume
             *   without throttling. This field is not applicable for on-demand feature groups.
             */
            public fun provisionedReadCapacityUnits(provisionedReadCapacityUnits: Number)

            /**
             * @param provisionedWriteCapacityUnits For provisioned feature groups, this indicates
             *   the write throughput you are billed for and can consume without throttling. This
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ThroughputConfigProperty
            ): software.amazon.awscdk.services.sagemaker.CfnFeatureGroup.ThroughputConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface OnlineStoreSecurityConfigProperty {
         ...
         *
         * The caller (either user or IAM role) of `CreateFeatureGroup` must have below permissions
         * to the `OnlineStore` `KmsKeyId` :
         * * `"kms:Encrypt"`
         * * `"kms:Decrypt"`
         * * `"kms:DescribeKey"`
         * * `"kms:CreateGrant"`
        ...
        public interface Builder {
            /**
             * @param kmsKeyId The AWS Key Management Service (KMS) key ARN that SageMaker Feature
             *   Store uses to encrypt the Amazon S3 objects at rest using Amazon S3 server-side
             *   encryption. The caller (either user or IAM role) of `CreateFeatureGroup` must have
        ...
        internal constructor(
            ...
            /**
             * The AWS Key Management Service (KMS) key ARN that SageMaker Feature Store uses to
             * encrypt the Amazon S3 objects at rest using Amazon S3 server-side encryption.
             *
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: OnlineStoreSecurityConfigProperty
            ): software.amazon.awscdk.services.sagemaker.CfnFeatureGroup.OnlineStoreSecurityConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface FeatureDefinitionProperty {
        ...
        public interface Builder {
            /**
             * @param featureName The name of a feature. The type must be a string. `FeatureName`
            ...
            /**
             * @param featureType The value type of a feature. Valid values are Integral,
             *   Fractional, or String.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: FeatureDefinitionProperty
            ): software.amazon.awscdk.services.sagemaker.CfnFeatureGroup.FeatureDefinitionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DataCatalogConfigProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DataCatalogConfigProperty
            ): software.amazon.awscdk.services.sagemaker.CfnFeatureGroup.DataCatalogConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface OnlineStoreConfigProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param securityConfig Use to specify KMS Key ID ( `KMSKeyId` ) for at-rest encryption
             *   of your `OnlineStore` .
             */
            ...
            public fun securityConfig(
                securityConfig: OnlineStoreSecurityConfigProperty.Builder.() -> Unit
            )

            /**
             * @param storageType Option for different tiers of low latency storage for real-time
             *   data retrieval.
             * * `Standard` : A managed low latency data store for feature groups.
             * * `InMemory` : A managed data store for feature groups that supports very low latency
             *   retrieval.
        ...
        private class BuilderImpl : Builder {
            ...
            override fun securityConfig(securityConfig: OnlineStoreSecurityConfigProperty) {
                cdkBuilder.securityConfig(
                    securityConfig.let(OnlineStoreSecurityConfigProperty::unwrap)
                )
            }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: OnlineStoreConfigProperty
            ): software.amazon.awscdk.services.sagemaker.CfnFeatureGroup.OnlineStoreConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface S3StorageConfigProperty {
        /**
         * The AWS Key Management Service (KMS) key ARN of the key used to encrypt any objects
        ...
        public interface Builder {
            /**
             * @param kmsKeyId The AWS Key Management Service (KMS) key ARN of the key used to
            ...
            /**
             * @param s3Uri The S3 URI, or location in Amazon S3, of `OfflineStore` . S3 URIs have a
             *   format similar to the following: `s3://example-bucket/prefix/` .
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: S3StorageConfigProperty
            ): software.amazon.awscdk.services.sagemaker.CfnFeatureGroup.S3StorageConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
