...
public interface SubjectAlternativeNamesMatcherConfig {
    ...
    private class BuilderImpl : Builder {
        ...
        override fun subjectAlternativeNamesMatch(
            ...
            cdkBuilder.subjectAlternativeNamesMatch(
                subjectAlternativeNamesMatch.let(
                    CfnVirtualNode.SubjectAlternativeNameMatchersProperty::unwrap
                )
            )
        }
        ...
        override fun subjectAlternativeNamesMatch(
            ...
            subjectAlternativeNamesMatch(
                CfnVirtualNode.SubjectAlternativeNameMatchersProperty(subjectAlternativeNamesMatch)
            )
    ...
    internal constructor(
        ...
        override fun subjectAlternativeNamesMatch():
            ...
            unwrap(this)
                .getSubjectAlternativeNamesMatch()
                .let(CfnVirtualNode.SubjectAlternativeNameMatchersProperty::wrap)
    }
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: SubjectAlternativeNamesMatcherConfig
        ): software.amazon.awscdk.services.appmesh.SubjectAlternativeNamesMatcherConfig =
