...
internal constructor(
    ...
    public interface Builder {
         ...
         * args member in the Entrypoint portion of the Pod in Kubernetes. Environment variable
         * references are expanded using the container's environment. If the referenced environment
         * variable doesn't exist, the reference in the command isn't changed. For example, if the
         * reference is to "$(NAME1)" and the NAME1 environment variable doesn't exist, the command
         * string will remain "$(NAME1)." $$ is replaced with $, and the resulting string isn't
         * expanded. or example, $$(VAR_NAME) is passed as $(VAR_NAME) whether or not the VAR_NAME
         ...
         * command isn't changed. For example, if the reference is to `"$(NAME1)"` and the `NAME1`
         * environment variable doesn't exist, the command string will remain `"$(NAME1)."` `$$` is
         * replaced with `$` and the resulting string isn't expanded. For example, `$$(VAR_NAME)`
         * will be passed as `$(VAR_NAME)` whether or not the `VAR_NAME` environment variable
         * exists.
         *
         * The entrypoint can't be updated.
         *
         ...
         *
         * @param cpuLimit The hard limit of CPUs to present to this container. Must be an even
         *   multiple of 0.25.
         */
         ...
         * If specified, gives this container readonly access to its root file system.
         *
         * This parameter maps to `ReadOnlyRootFilesystem` policy in the Volumes and file systems
         * pod security policies in the Kubernetes documentation.
         *
         * *Note*: this is only compatible with Kubernetes &lt; v1.25
         *
         ...
         * [Documentation](https://kubernetes.io/docs/concepts/security/pod-security-policy/#volumes-and-file-systems)
         *
         * @param readonlyRootFilesystem If specified, gives this container readonly access to its
         *   root file system.
         */
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: EksContainerDefinition
