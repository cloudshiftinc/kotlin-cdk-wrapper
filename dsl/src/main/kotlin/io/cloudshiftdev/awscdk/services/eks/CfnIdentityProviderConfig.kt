...
internal constructor(
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnIdentityProviderConfig
    ...
    public interface OidcIdentityProviderConfigProperty {
         ...
         * as `system:` groups).
         *
         * For example, the value `oidc:` creates group names like `oidc:engineering` and
        ...
        public interface Builder {
            /**
             * @param clientId This is also known as *audience* . The ID of the client application
             *   that makes authentication requests to the OIDC identity provider.
             */
            public fun clientId(clientId: String)

            /**
             * @param groupsClaim The JSON web token (JWT) claim that the provider uses to return
             *   your groups.
             */
            public fun groupsClaim(groupsClaim: String)

            /**
             * @param groupsPrefix The prefix that is prepended to group claims to prevent clashes
             *   with existing names (such as `system:` groups). For example, the value `oidc:`
             *   creates group names like `oidc:engineering` and `oidc:infra` . The prefix can't
             *   contain `system:`
             */
            ...
            /**
             * @param requiredClaims The key-value pairs that describe required claims in the
             *   identity token. If set, each claim is verified to be present in the token with a
             *   matching value.
             */
        ...
        internal constructor(
             ...
             * This is also known as *audience* .
             *
             * The ID of the client application that makes authentication requests to the OIDC
             * identity provider.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-eks-identityproviderconfig-oidcidentityproviderconfig.html#cfn-eks-identityproviderconfig-oidcidentityproviderconfig-clientid)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: OidcIdentityProviderConfigProperty
            ): software.amazon.awscdk.services.eks.CfnIdentityProviderConfig.OidcIdentityProviderConfigProperty =
