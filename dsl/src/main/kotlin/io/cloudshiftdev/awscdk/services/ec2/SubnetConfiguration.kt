...
public interface SubnetConfiguration {
     ...
     *
     * The number of available IP addresses in each subnet of this group will be equal to `2^(32 -
     * cidrMask) - 2`.
     *
     ...
     * Default: true
     */
    public fun ipv6AssignAddressOnCreation(): Boolean? =
     ...
     *
     * This name can be used when selecting VPC subnets to distinguish between different subnet
     ...
     *
     * When true, the IP space for the subnet is reserved but no actual resources are provisioned.
     * This space is only dependent on the number of availability zones and on `cidrMask` - all
     * other subnet properties are ignored.
     *
     * Default: false
     */
    ...
    public interface Builder {
        /**
         * @param cidrMask The number of leading 1 bits in the routing mask. The number of available
         *   IP addresses in each subnet of this group will be equal to `2^(32 - cidrMask) - 2`.
         *
         * Valid values are `16--28`.
         *
         * Note this is specific to IPv4 addresses.
        ...
        /**
         * @param ipv6AssignAddressOnCreation This property is specific to dual stack VPCs. If set
         *   to false, then an IPv6 address will not be automatically assigned.
         *
         * Note this is specific to IPv6 addresses.
         */
        ...
        /**
         * @param mapPublicIpOnLaunch Controls if a public IPv4 address is associated to an instance
         *   at launch. Note this is specific to IPv4 addresses.
         */
        ...
        /**
         * @param reserved Controls if subnet IP space needs to be reserved. When true, the IP space
         *   for the subnet is reserved but no actual resources are provisioned. This space is only
        ...
        /**
         * @param subnetType The type of Subnet to configure. The Subnet type will control the
         *   ability to route and connect to the Internet.
         */
    ...
    private class BuilderImpl : Builder {
        ...
        public fun build(): software.amazon.awscdk.services.ec2.SubnetConfiguration =
            cdkBuilder.build()
    }
    ...
    internal constructor(
         ...
         * Controls if subnet IP space needs to be reserved.
         *
         * When true, the IP space for the subnet is reserved but no actual resources are
         * provisioned. This space is only dependent on the number of availability zones and on
         * `cidrMask` - all other subnet properties are ignored.
         *
         * Default: false
         */
