...
public interface IInstanceEngine : IEngine {
    ...
    public fun bindToInstance(
        scope: Construct,
        options: InstanceEngineBindOptions.Builder.() -> Unit
    ): InstanceEngineConfig
    ...
    internal constructor(
        ...
        override fun bindToInstance(
            ...
            unwrap(this)
                .bindToInstance(
                    ...
                    options.let(InstanceEngineBindOptions::unwrap)
                )
                .let(InstanceEngineConfig::wrap)
        ...
        override fun bindToInstance(
            scope: Construct,
            options: InstanceEngineBindOptions.Builder.() -> Unit
        ): InstanceEngineConfig = bindToInstance(scope, InstanceEngineBindOptions(options))
