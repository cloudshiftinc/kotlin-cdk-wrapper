...
internal constructor(
    ...
    public interface Builder {
         ...
         * Determines if the replication set deletion protection is enabled or not.
         *
         * If deletion protection is enabled, you can't delete the last Region in the replication
         * set.
         *
         ...
         *
         * @param deletionProtected Determines if the replication set deletion protection is enabled
         *   or not.
         */
    ...
    public interface RegionConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param sseKmsKeyId The AWS Key Management Service key ID to use to encrypt your
             *   replication set.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RegionConfigurationProperty
            ): software.amazon.awscdk.services.ssmincidents.CfnReplicationSet.RegionConfigurationProperty =
    ...
    public interface ReplicationRegionProperty {
        ...
        public interface Builder {
            ...
            public fun regionConfiguration(
                regionConfiguration: RegionConfigurationProperty.Builder.() -> Unit
            )
        ...
        private class BuilderImpl : Builder {
            ...
            override fun regionConfiguration(regionConfiguration: RegionConfigurationProperty) {
                cdkBuilder.regionConfiguration(
                    regionConfiguration.let(RegionConfigurationProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("c1f73e959c6950a8afb5ef01a749a688d89fcd4b3088e8851c81c560a2121efd")
            override fun regionConfiguration(
                regionConfiguration: RegionConfigurationProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ReplicationRegionProperty
            ): software.amazon.awscdk.services.ssmincidents.CfnReplicationSet.ReplicationRegionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
