...
public interface ModelOptions {
    ...
    public interface Builder {
        /**
         * @param contentType The content type for the model. You can also force a content type in
         *   the request or response model mapping.
         */
        ...
        /**
         * @param modelName A name for the model. Important If you specify a name, you cannot
         *   perform updates that require replacement of this resource. You can perform updates that
         *   require no or some interruption. If you must replace the resource, specify a new name.
         */
        public fun modelName(modelName: String)

        /**
         * @param schema The schema to use to transform data to one or more output formats. Specify
         *   null ({}) if you don't want to specify a schema.
         */
    ...
    private class BuilderImpl : Builder {
        ...
        public fun build(): software.amazon.awscdk.services.apigateway.ModelOptions =
            cdkBuilder.build()
    }
