...
public enum class PartitionDateSource(
  ...
  public companion object {
    internal fun wrap(cdkObject: software.amazon.awscdk.services.s3.PartitionDateSource):
        PartitionDateSource = when (cdkObject) {
    ...
    internal fun unwrap(wrapped: PartitionDateSource):
