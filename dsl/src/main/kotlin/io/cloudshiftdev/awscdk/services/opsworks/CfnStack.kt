...
internal constructor(
    ...
    public open fun configurationManager(
        `value`: StackConfigurationManagerProperty.Builder.() -> Unit
    ): Unit = configurationManager(StackConfigurationManagerProperty(`value`))
     ...
     */
    public open fun defaultInstanceProfileArn(): String =
        unwrap(this).getDefaultInstanceProfileArn()
    ...
    public interface Builder {
        ...
        public fun chefConfiguration(
            chefConfiguration: ChefConfigurationProperty.Builder.() -> Unit
        )
         ...
         *
         * @param clonePermissions If you're cloning an AWS OpsWorks stack, indicates whether to
         *   clone the source stack's permissions.
         */
         ...
         * The configuration manager.
         *
         * When you create a stack we recommend that you use the configuration manager to specify
         * the Chef version: 12, 11.10, or 11.4 for Linux stacks, or 12.2 for Windows stacks. The
        ...
        public fun configurationManager(
            configurationManager: StackConfigurationManagerProperty.Builder.() -> Unit
        )
         ...
         *
         * @param customCookbooksSource Contains the information required to retrieve an app or
         *   cookbook from a repository.
         */
         ...
         * A string that contains user-defined, custom JSON.
         *
         * It can be used to override the corresponding default stack configuration attribute values
         ...
         *
         * For more information, see
         * [Regions and Endpoints](https://docs.aws.amazon.com/general/latest/gr/rande.html) . If
         * you also specify a value for `DefaultSubnetId` , the subnet must be in the same zone. For
         ...
         *
         * @param defaultAvailabilityZone The stack's default Availability Zone, which must be in
         ...
         *
         * @param defaultInstanceProfileArn The Amazon Resource Name (ARN) of an IAM profile that is
         *   the default profile for all of the stack's EC2 instances.
         */
         ...
         * specify a different operating system when you create the instance.
         *
         ...
         * supported with all versions of Chef. For more information about supported operating
         * systems, see
         ...
         *   instance unless you specify a different operating system when you create the instance.
         */
         ...
         * The default root device type.
         *
         * This value is the default for all instances in the stack, but you can override it when
         ...
         * A default Amazon EC2 key pair name.
         *
         * The default value is none. If you specify a key pair name, AWS OpsWorks installs the
         * public key on the instance and you can use the private key with an SSH client to log in
         ...
         * parameter. If you also specify a value for `DefaultAvailabilityZone` , the subnet must be
         * in that zone.
         *
         ...
         *
         * @param ecsClusterArn The Amazon Resource Name (ARN) of the Amazon Elastic Container
        ...
        /**
         * The Amazon Relational Database Service ( Amazon RDS ) database instance to register with
         * the AWS OpsWorks stack.
         *
         * If you specify a database instance that's registered with another AWS OpsWorks stack, AWS
         * CloudFormation deregisters the existing association before registering the database
         * instance.
         *
         ...
         *
         * @param rdsDbInstances The Amazon Relational Database Service ( Amazon RDS ) database
         *   instance to register with the AWS OpsWorks stack.
         */
         ...
         *
         * @param serviceRoleArn The stack's IAM role, which allows AWS OpsWorks Stacks to work with
         ...
         *
         * @param sourceStackId If you're cloning an AWS OpsWorks stack, the stack ID of the source
         ...
         *   each layer that you create. However, you can still manually associate a built-in
         *   security group with a layer on creation; custom security groups are required only for
         ...
         * The ID of the VPC that the stack is to be launched into.
         *
         * The VPC must be in the stack's region. All instances are launched into this VPC. You
         ...
         * Stacks sets these parameters to the first valid Availability Zone for the specified
    ...
    private class BuilderImpl(
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("7c52845227911481080e46e0f18dd87dd85091e61f37801c276c5b0d79512091")
        override fun chefConfiguration(
            chefConfiguration: ChefConfigurationProperty.Builder.() -> Unit
         ...
         *   application stack IDs from the source stack to include in the cloned stack.
         */
        override fun cloneAppIds(vararg cloneAppIds: String): Unit =
            cloneAppIds(cloneAppIds.toList())
        ...
        override fun configurationManager(configurationManager: StackConfigurationManagerProperty) {
            cdkBuilder.configurationManager(
                configurationManager.let(StackConfigurationManagerProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("63882aab79a73f1c4aeceacb3cf4156ba0b410ca519a816e8dfd0bb7802282b0")
        override fun configurationManager(
            configurationManager: StackConfigurationManagerProperty.Builder.() -> Unit
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("02814ce37b712fafba48ed90650097bc884bff764f2d799c44da9700d64e12bc")
        override fun customCookbooksSource(
            customCookbooksSource: SourceProperty.Builder.() -> Unit
    ...
    public interface ChefConfigurationProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ChefConfigurationProperty
            ): software.amazon.awscdk.services.opsworks.CfnStack.ChefConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface StackConfigurationManagerProperty {
         ...
         * The Chef version.
         *
         * This parameter must be set to 12, 11.10, or 11.4 for Linux stacks, and to 12.2 for
        ...
        public interface Builder {
            ...
            /**
             * @param version The Chef version. This parameter must be set to 12, 11.10, or 11.4 for
             *   Linux stacks, and to 12.2 for Windows stacks. The default value for Linux stacks
             *   is 12.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: StackConfigurationManagerProperty
            ): software.amazon.awscdk.services.opsworks.CfnStack.StackConfigurationManagerProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SourceProperty {
         ...
         *
         * AWS OpsWorks Stacks enables you to easily deploy new versions of an application. One of
         ...
         *
         * For more information, see
         * [Using Git Repository SSH Keys](https://docs.aws.amazon.com/opsworks/latest/userguide/workingapps-deploykeys.html)
         * in the *AWS OpsWorks User Guide* . To pass in an SSH key as a parameter, see the
         * following example:
         *
         * `"Parameters" : { "GitSSHKey" : { "Description" : "Change SSH key newlines to commas.",
         * "Type" : "CommaDelimitedList", "NoEcho" : "true" }, ... "CustomCookbooksSource": {
         * "Revision" : { "Ref": "GitRevision"}, "SshKey" : { "Fn::Join" :
        ...
        public interface Builder {
            ...
            /**
             * @param revision The application's version. AWS OpsWorks Stacks enables you to easily
             *   deploy new versions of an application. One of the simplest approaches is to have
             *   branches or revisions in your repository that represent different versions that can
             *   potentially be deployed.
             */
            public fun revision(revision: String)

            /**
             * @param sshKey The repository's SSH key. For more information, see
             *   [Using Git Repository SSH Keys](https://docs.aws.amazon.com/opsworks/latest/userguide/workingapps-deploykeys.html)
             *   in the *AWS OpsWorks User Guide* . To pass in an SSH key as a parameter, see the
             *   following example:
             *
             * `"Parameters" : { "GitSSHKey" : { "Description" : "Change SSH key newlines to
             * commas.", "Type" : "CommaDelimitedList", "NoEcho" : "true" }, ...
             * "CustomCookbooksSource": { "Revision" : { "Ref": "GitRevision"}, "SshKey" : {
             * "Fn::Join" : [ "\n", { "Ref": "GitSSHKey"} ] }, "Type": "git", "Url": { "Ref":
             * "GitURL"} } ...`
             */
        ...
        internal constructor(
             ...
             * The application's version.
             *
             * AWS OpsWorks Stacks enables you to easily deploy new versions of an application. One
             * of the simplest approaches is to have branches or revisions in your repository that
             * represent different versions that can potentially be deployed.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-opsworks-stack-source.html#cfn-opsworks-stack-source-revision)
             */
    ...
    public interface RdsDbInstanceProperty {
        ...
        public interface Builder {
            /**
             * @param dbPassword AWS OpsWorks Stacks returns `*****FILTERED*****` instead of the
             *   actual value.
             */
