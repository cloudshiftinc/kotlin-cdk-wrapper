...
public open class ListenerAction internal constructor(
  ...
  public companion object {
    public open fun authenticateOidc(options: AuthenticateOidcOptions): ListenerAction =
        software.amazon.awscdk.services.elasticloadbalancingv2.ListenerAction.authenticateOidc(options.let(AuthenticateOidcOptions::unwrap)).let(ListenerAction::wrap)

    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("02f4270c547a02b7f0b9d0550ece424b1b41de91bfc69f93696b32175affcdfd")
    public open fun authenticateOidc(options: AuthenticateOidcOptions.Builder.() -> Unit):
        ListenerAction = authenticateOidc(AuthenticateOidcOptions(options))

    public open fun fixedResponse(statusCode: Number): ListenerAction =
        software.amazon.awscdk.services.elasticloadbalancingv2.ListenerAction.fixedResponse(statusCode).let(ListenerAction::wrap)

    public open fun fixedResponse(statusCode: Number, options: FixedResponseOptions): ListenerAction
        =
        software.amazon.awscdk.services.elasticloadbalancingv2.ListenerAction.fixedResponse(statusCode,
        options.let(FixedResponseOptions::unwrap)).let(ListenerAction::wrap)

    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("6ca345f3d3c2683f66fa1e38f24b92a4b0f6c61f223ba47cf89c0dbdd408da8b")
    public open fun fixedResponse(statusCode: Number,
        options: FixedResponseOptions.Builder.() -> Unit): ListenerAction =
        fixedResponse(statusCode, FixedResponseOptions(options))
    ...
    public open fun forward(targetGroups: List<IApplicationTargetGroup>, options: ForwardOptions):
        ...
        options.let(ForwardOptions::unwrap)).let(ListenerAction::wrap)

    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("b1977ca66cf3b21839ab7046d80272a616a15a4f9d160ae53eba23adceb6f9d1")
    public open fun forward(targetGroups: List<IApplicationTargetGroup>,
        options: ForwardOptions.Builder.() -> Unit): ListenerAction = forward(targetGroups,
        ForwardOptions(options))

    public open fun redirect(options: RedirectOptions): ListenerAction =
        software.amazon.awscdk.services.elasticloadbalancingv2.ListenerAction.redirect(options.let(RedirectOptions::unwrap)).let(ListenerAction::wrap)

    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("ff3e5156e25823d24931fc41a372d9f2a6c74f1a1eab69d9035d3936cbcb40e4")
    public open fun redirect(options: RedirectOptions.Builder.() -> Unit): ListenerAction =
    ...
    public open fun weightedForward(targetGroups: List<WeightedTargetGroup>,
        ...
        software.amazon.awscdk.services.elasticloadbalancingv2.ListenerAction.weightedForward(targetGroups.map(WeightedTargetGroup::unwrap),
        options.let(ForwardOptions::unwrap)).let(ListenerAction::wrap)
