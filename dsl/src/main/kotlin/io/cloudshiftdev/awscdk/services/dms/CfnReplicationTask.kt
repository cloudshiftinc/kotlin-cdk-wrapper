...
internal constructor(
    ...
    public open fun replicationTaskIdentifier(): String? =
        unwrap(this).getReplicationTaskIdentifier()
    ...
    public interface Builder {
         ...
         * Indicates when you want a change data capture (CDC) operation to start.
         *
         * Use either `CdcStartPosition` or `CdcStartTime` to specify when you want a CDC operation
         ...
         * replication slot. For more information, see
         ...
         *
         * @param cdcStopPosition Indicates when you want a change data capture (CDC) operation to
         *   stop.
         */
         ...
         *
         * @param sourceEndpointArn An Amazon Resource Name (ARN) that uniquely identifies the
         *   source endpoint.
         */
         ...
         *
         * @param targetEndpointArn An Amazon Resource Name (ARN) that uniquely identifies the
         *   target endpoint.
         */
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.dms.CfnReplicationTask =
            cdkBuilder.build()
    }
