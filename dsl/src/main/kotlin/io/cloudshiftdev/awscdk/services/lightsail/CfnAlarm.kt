...
internal constructor(
    ...
    public open fun contactProtocols(): List<String> =
        unwrap(this).getContactProtocols() ?: emptyList()
    ...
    public open fun notificationTriggers(): List<String> =
        unwrap(this).getNotificationTriggers() ?: emptyList()
    ...
    public interface Builder {
         ...
         *
         * @param contactProtocols The contact protocols for the alarm, such as `Email` , `SMS`
         ...
         *
         * @param datapointsToAlarm The number of data points within the evaluation periods that
         *   must be breaching to cause the alarm to go to the `ALARM` state.
         */
         ...
         * The alarm states that trigger a notification.
         *
         * To specify the `OK` and `INSUFFICIENT_DATA` values, you must also specify
         * `ContactProtocols` values. Otherwise, the `OK` and `INSUFFICIENT_DATA` values will not
         * take effect and the stack will drift.
         *
         ...
         * * `notBreaching` - Assumes the missing data is within the threshold. Missing data does
         *   not count towards the number of times that the metric is not within the threshold.
