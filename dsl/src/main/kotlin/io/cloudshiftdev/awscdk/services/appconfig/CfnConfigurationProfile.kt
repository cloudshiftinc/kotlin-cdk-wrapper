...
internal constructor(
     ...
     * configuration stores, see the documentation for how to specify an AWS KMS key for that
     * particular service.
     */
    ...
    public interface Builder {
        ...
        /**
         * The AWS Key Management Service key identifier (key ID, key alias, or key ARN) provided
         ...
         *
         * @param kmsKeyIdentifier The AWS Key Management Service key identifier (key ID, key alias,
         ...
         *   `hosted` .
         * * For an AWS Systems Manager Parameter Store parameter, specify either the parameter name
         *   in the format `ssm-parameter://&lt;parameter name&gt;` or the ARN.
         * * For an AWS CodePipeline pipeline, specify the URI in the following format:
         ...
         * `LocationUri` .
         *
         * A retrieval role ARN is not required for configurations stored in the AWS AppConfig
         ...
         *
         * @param retrievalRoleArn The ARN of an IAM role with permission to access the
         ...
         * The type of configurations contained in the profile.
         *
         * AWS AppConfig supports `feature flags` and `freeform` configurations. We recommend you
         * create feature flag configurations to enable or disable new features and freeform
         * configurations to distribute configurations to an application. When calling this API,
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.appconfig.CfnConfigurationProfile.Builder.create(
                scope,
                id
            )
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnConfigurationProfile
