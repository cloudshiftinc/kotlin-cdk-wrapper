...
internal constructor(
    ...
    public override fun metricGetRecordsIteratorAgeMilliseconds(
        props: MetricOptions.Builder.() -> Unit
    ...
    public override fun metricPutRecordsFailedRecords(
        props: MetricOptions.Builder.() -> Unit
    ...
    public override fun metricPutRecordsSuccessfulRecords(
        props: MetricOptions.Builder.() -> Unit
    ...
    public override fun metricPutRecordsThrottledRecords(
        props: MetricOptions.Builder.() -> Unit
    ...
    public override fun metricPutRecordsTotalRecords(
        props: MetricOptions.Builder.() -> Unit
    ): Metric = metricPutRecordsTotalRecords(MetricOptions(props))
    ...
    public override fun metricReadProvisionedThroughputExceeded(
        props: MetricOptions.Builder.() -> Unit
    ...
    public override fun metricWriteProvisionedThroughputExceeded(
        props: MetricOptions.Builder.() -> Unit
    ...
    public interface Builder {
         ...
         * StreamEncryption.UNENCRYPTED otherwise. StreamEncryption.KMS if an encryption key is
         * supplied through the encryptionKey property
         *
         ...
         *
         * Default: - Kinesis Data Streams master key ('/alias/aws/kinesis'). If encryption is set
         * to StreamEncryption.KMS and this property is undefined, a new KMS key will be created and
         ...
         *
         * @param retentionPeriod The number of hours for the data records that are stored in shards
    ...
    public companion object {
        public fun fromStreamArn(
            ...
            software.amazon.awscdk.services.kinesis.Stream.fromStreamArn(
        ...
        public fun fromStreamAttributes(
            ...
            software.amazon.awscdk.services.kinesis.Stream.fromStreamAttributes(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    attrs.let(StreamAttributes::unwrap)
                )
                .let(IStream::wrap)
