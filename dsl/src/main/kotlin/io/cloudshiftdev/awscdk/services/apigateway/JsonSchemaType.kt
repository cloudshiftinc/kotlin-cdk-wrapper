...
public enum class JsonSchemaType(
    ...
    public companion object {
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.apigateway.JsonSchemaType
        ): JsonSchemaType =
            when (cdkObject) {
                software.amazon.awscdk.services.apigateway.JsonSchemaType.NULL ->
                    JsonSchemaType.NULL
                software.amazon.awscdk.services.apigateway.JsonSchemaType.BOOLEAN ->
                    JsonSchemaType.BOOLEAN
                software.amazon.awscdk.services.apigateway.JsonSchemaType.OBJECT ->
                    JsonSchemaType.OBJECT
                software.amazon.awscdk.services.apigateway.JsonSchemaType.ARRAY ->
                    JsonSchemaType.ARRAY
                software.amazon.awscdk.services.apigateway.JsonSchemaType.NUMBER ->
                    JsonSchemaType.NUMBER
                software.amazon.awscdk.services.apigateway.JsonSchemaType.INTEGER ->
                    JsonSchemaType.INTEGER
                software.amazon.awscdk.services.apigateway.JsonSchemaType.STRING ->
