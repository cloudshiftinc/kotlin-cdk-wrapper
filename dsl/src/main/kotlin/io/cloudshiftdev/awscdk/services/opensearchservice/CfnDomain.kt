...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.opensearchservice.CfnDomain,
    ...
    public open fun advancedSecurityOptions(`value`: AdvancedSecurityOptionsInputProperty) {
        unwrap(this)
            .setAdvancedSecurityOptions(`value`.let(AdvancedSecurityOptionsInputProperty::unwrap))
    }

    /** Specifies options for fine-grained access control and SAML authentication. */
    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("6c28b2da42ac3dc4442bbe6a9008f9d5a959103d9590cea7c6832ba6f41d03bf")
    public open fun advancedSecurityOptions(
        `value`: AdvancedSecurityOptionsInputProperty.Builder.() -> Unit
     ...
     *
     * This endpoint functions like a normal endpoint, except that it works with both IPv4 and IPv6
    ...
    public open fun domainEndpointOptions(
        `value`: DomainEndpointOptionsProperty.Builder.() -> Unit
    ...
    public open fun encryptionAtRestOptions(`value`: EncryptionAtRestOptionsProperty) {
        unwrap(this)
            .setEncryptionAtRestOptions(`value`.let(EncryptionAtRestOptionsProperty::unwrap))
    }

    /** Whether the domain should encrypt data at rest, and if so, the AWS KMS key to use. */
    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("9cdbf6ec2ef8e9ca0b822a48221d6d133494b3fca448529843523cf8dacf5de7")
    public open fun encryptionAtRestOptions(
        `value`: EncryptionAtRestOptionsProperty.Builder.() -> Unit
    ): Unit = encryptionAtRestOptions(EncryptionAtRestOptionsProperty(`value`))
    ...
    public open fun nodeToNodeEncryptionOptions(`value`: NodeToNodeEncryptionOptionsProperty) {
        unwrap(this)
            .setNodeToNodeEncryptionOptions(
                `value`.let(NodeToNodeEncryptionOptionsProperty::unwrap)
            )
    }
    ...
    public open fun nodeToNodeEncryptionOptions(
        `value`: NodeToNodeEncryptionOptionsProperty.Builder.() -> Unit
    ...
    public open fun offPeakWindowOptions(
        `value`: OffPeakWindowOptionsProperty.Builder.() -> Unit
    ...
    public open fun softwareUpdateOptions(
        `value`: SoftwareUpdateOptionsProperty.Builder.() -> Unit
    ...
    public interface Builder {
         ...
         * access the OpenSearch Service domain and their permissions.
         *
        ...
        public fun advancedSecurityOptions(
            advancedSecurityOptions: AdvancedSecurityOptionsInputProperty.Builder.() -> Unit
        )
         ...
         *
         * @param cognitoOptions Configures OpenSearch Service to use Amazon Cognito authentication
        ...
        /**
         * Specifies additional options for the domain endpoint, such as whether to require HTTPS
         * for all traffic or whether to use a custom endpoint rather than the default endpoint.
         *
         ...
         *
         * @param domainEndpointOptions Specifies additional options for the domain endpoint, such
         *   as whether to require HTTPS for all traffic or whether to use a custom endpoint rather
         *   than the default endpoint.
         */
        ...
        public fun domainEndpointOptions(
            domainEndpointOptions: DomainEndpointOptionsProperty.Builder.() -> Unit
        )

        /**
         * A name for the OpenSearch Service domain.
         *
         * The name must have a minimum length of 3 and a maximum length of 28. If you don't specify
         * a name, AWS CloudFormation generates a unique physical ID and uses that ID for the domain
         ...
         * to data nodes in the OpenSearch Service domain.
         *
         * For more information, see
         ...
         *
         * @param ebsOptions The configurations of Amazon Elastic Block Store (Amazon EBS) volumes
         *   that are attached to data nodes in the OpenSearch Service domain.
         */
         ...
         * property by adding it causes no interruption. However, if you change this property after
         * it's already been set within a template, the domain is deleted and recreated in order to
         * modify the property.
         *
         ...
         *
         * @param encryptionAtRestOptions Whether the domain should encrypt data at rest, and if so,
        ...
        public fun encryptionAtRestOptions(
            encryptionAtRestOptions: EncryptionAtRestOptionsProperty.Builder.() -> Unit
        )

        /**
         * The version of OpenSearch to use.
         *
         * The value must be in the format `OpenSearch_X.Y` or `Elasticsearch_X.Y` . If not
         * specified, the latest version of OpenSearch is used. For information about the versions
         * that OpenSearch Service supports, see
         ...
         * Choose either dual stack or IPv4 as your IP address type.
         *
         * Dual stack allows you to share domain resources across IPv4 and IPv6 address types, and
         * is the recommended option. If you set your IP address type to dual stack, you can't
         ...
         * `ES_APPLICATION_LOGS` , `INDEX_SLOW_LOGS` , `AUDIT_LOGS` , depending on the types of logs
         * you want to publish.
         *
        ...
        public fun nodeToNodeEncryptionOptions(
            nodeToNodeEncryptionOptions: NodeToNodeEncryptionOptionsProperty.Builder.() -> Unit
        )

        /**
         * Options for a domain's off-peak window, during which OpenSearch Service can perform
         ...
         *
         * @param offPeakWindowOptions Options for a domain's off-peak window, during which
        ...
        public fun offPeakWindowOptions(
            offPeakWindowOptions: OffPeakWindowOptionsProperty.Builder.() -> Unit
        )
        ...
        public fun softwareUpdateOptions(
            softwareUpdateOptions: SoftwareUpdateOptionsProperty.Builder.() -> Unit
        )
         ...
         * replacement. You might encounter this scenario if you're updating your security
         * configuration from a VPC to a public endpoint.
         *
         ...
         *
         * @param vpcOptions The virtual private cloud (VPC) configuration for the OpenSearch
         *   Service domain.
         */
    ...
    private class BuilderImpl(
         ...
         *   authentication.
         */
        override fun advancedSecurityOptions(
            advancedSecurityOptions: AdvancedSecurityOptionsInputProperty
        ) {
            cdkBuilder.advancedSecurityOptions(
                advancedSecurityOptions.let(AdvancedSecurityOptionsInputProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("4bbf5b9c5171b1ae7b4aebdc4a06f730f24d5e5f5f024dfdc3e9ce4d90603359")
        override fun cognitoOptions(
            cognitoOptions: CognitoOptionsProperty.Builder.() -> Unit
        ...
        override fun domainEndpointOptions(domainEndpointOptions: DomainEndpointOptionsProperty) {
            cdkBuilder.domainEndpointOptions(
                domainEndpointOptions.let(DomainEndpointOptionsProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("254043fab7706a69964bd04ba00f4938efd89d3bcba72a854478c427e1aae7b4")
        override fun domainEndpointOptions(
            domainEndpointOptions: DomainEndpointOptionsProperty.Builder.() -> Unit
         ...
         *   the AWS KMS key to use.
         */
        override fun encryptionAtRestOptions(
            encryptionAtRestOptions: EncryptionAtRestOptionsProperty
        ) {
            cdkBuilder.encryptionAtRestOptions(
                encryptionAtRestOptions.let(EncryptionAtRestOptionsProperty::unwrap)
            )
        }
        ...
        override fun nodeToNodeEncryptionOptions(nodeToNodeEncryptionOptions: IResolvable) {
            cdkBuilder.nodeToNodeEncryptionOptions(
                nodeToNodeEncryptionOptions.let(IResolvable::unwrap)
            )
        }
         ...
         * @param nodeToNodeEncryptionOptions Specifies whether node-to-node encryption is enabled.
         */
        override fun nodeToNodeEncryptionOptions(
            nodeToNodeEncryptionOptions: NodeToNodeEncryptionOptionsProperty
        ) {
            cdkBuilder.nodeToNodeEncryptionOptions(
                nodeToNodeEncryptionOptions.let(NodeToNodeEncryptionOptionsProperty::unwrap)
            )
        }
        ...
        override fun nodeToNodeEncryptionOptions(
            ...
            nodeToNodeEncryptionOptions(
                NodeToNodeEncryptionOptionsProperty(nodeToNodeEncryptionOptions)
            )
        ...
        override fun offPeakWindowOptions(offPeakWindowOptions: OffPeakWindowOptionsProperty) {
            cdkBuilder.offPeakWindowOptions(
                offPeakWindowOptions.let(OffPeakWindowOptionsProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("e70e5778d97125c7fda25481a6d9e1dee790e8fcafaf024d5d7c4e554b4a6f72")
        override fun offPeakWindowOptions(
            offPeakWindowOptions: OffPeakWindowOptionsProperty.Builder.() -> Unit
        ...
        override fun snapshotOptions(
            snapshotOptions: SnapshotOptionsProperty.Builder.() -> Unit
        ): Unit = snapshotOptions(SnapshotOptionsProperty(snapshotOptions))
        ...
        override fun softwareUpdateOptions(softwareUpdateOptions: SoftwareUpdateOptionsProperty) {
            cdkBuilder.softwareUpdateOptions(
                softwareUpdateOptions.let(SoftwareUpdateOptionsProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("6e26d3115ca890c89afa47f5ab6ffe5fb905dfa1a0a2a8f81deb379168fa8458")
        override fun softwareUpdateOptions(
            softwareUpdateOptions: SoftwareUpdateOptionsProperty.Builder.() -> Unit
    ...
    public interface MasterUserOptionsProperty {
        ...
        public interface Builder {
            /**
             * @param masterUserArn Amazon Resource Name (ARN) for the master user. The ARN can
             *   point to an IAM user or role. This property is required for Amazon Cognito to work,
             *   and it must match the role configured for Cognito. Only specify if
             *   `InternalUserDatabaseEnabled` is false in
             *   [AdvancedSecurityOptionsInput](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-opensearchservice-domain-advancedsecurityoptionsinput.html)
             *   .
             */
             ...
             *   [AdvancedSecurityOptionsInput](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-opensearchservice-domain-advancedsecurityoptionsinput.html)
             *   . If you don't want to specify this value directly within the template, you can use
             *   a
             *   [dynamic reference](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/dynamic-references.html)
             *   instead.
             */
        ...
        internal constructor(
             ...
             * Amazon Resource Name (ARN) for the master user.
             *
             * The ARN can point to an IAM user or role. This property is required for Amazon
             * Cognito to work, and it must match the role configured for Cognito. Only specify if
             * `InternalUserDatabaseEnabled` is false in
             * [AdvancedSecurityOptionsInput](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-opensearchservice-domain-advancedsecurityoptionsinput.html)
             * .
             *
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: MasterUserOptionsProperty
            ): software.amazon.awscdk.services.opensearchservice.CfnDomain.MasterUserOptionsProperty =
    ...
    public interface AdvancedSecurityOptionsInputProperty {
         ...
         */
        public fun internalUserDatabaseEnabled(): Any? =
        ...
        public interface Builder {
            /**
             * @param anonymousAuthDisableDate Date and time when the migration period will be
             *   disabled. Only necessary when
             *   [enabling fine-grained access control on an existing domain](https://docs.aws.amazon.com/opensearch-service/latest/developerguide/fgac.html#fgac-enabling-existing)
             *   .
             */
            ...
            /**
             * @param enabled True to enable fine-grained access control. You must also enable
             *   encryption of data at rest and node-to-node encryption. See
             *   [Fine-grained access control in Amazon OpenSearch Service](https://docs.aws.amazon.com/opensearch-service/latest/developerguide/fgac.html)
             *   .
             */
            ...
            public fun masterUserOptions(
                masterUserOptions: MasterUserOptionsProperty.Builder.() -> Unit
            )

            /**
             * @param samlOptions Container for information about the SAML configuration for
        ...
        private class BuilderImpl : Builder {
            ...
            override fun internalUserDatabaseEnabled(internalUserDatabaseEnabled: IResolvable) {
                cdkBuilder.internalUserDatabaseEnabled(
                    internalUserDatabaseEnabled.let(IResolvable::unwrap)
                )
            }
            ...
            override fun masterUserOptions(masterUserOptions: MasterUserOptionsProperty) {
                cdkBuilder.masterUserOptions(
                    masterUserOptions.let(MasterUserOptionsProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("db718d65484ad7164088f3bb85f48b915da76cb61cefa31caf55466a4df21631")
            override fun masterUserOptions(
                masterUserOptions: MasterUserOptionsProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-opensearchservice-domain-advancedsecurityoptionsinput.html#cfn-opensearchservice-domain-advancedsecurityoptionsinput-anonymousauthdisabledate)
             */
            override fun anonymousAuthDisableDate(): String? =
                unwrap(this).getAnonymousAuthDisableDate()
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AdvancedSecurityOptionsInputProperty
            ): software.amazon.awscdk.services.opensearchservice.CfnDomain.AdvancedSecurityOptionsInputProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface LogPublishingOptionProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param enabled If `true` , enables the publishing of logs to CloudWatch. Default:
             *   `false` .
             */
            public fun enabled(enabled: Boolean)
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: LogPublishingOptionProperty
            ): software.amazon.awscdk.services.opensearchservice.CfnDomain.LogPublishingOptionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface IdpProperty {
        ...
        public interface Builder {
            /**
             * @param entityId The unique entity ID of the application in the SAML identity
             *   provider.
             */
    ...
    public interface SoftwareUpdateOptionsProperty {
        ...
        public interface Builder {
            /**
             * @param autoSoftwareUpdateEnabled Specifies whether automatic service software updates
        ...
        private class BuilderImpl : Builder {
            ...
            override fun autoSoftwareUpdateEnabled(autoSoftwareUpdateEnabled: IResolvable) {
                cdkBuilder.autoSoftwareUpdateEnabled(
                    autoSoftwareUpdateEnabled.let(IResolvable::unwrap)
                )
            }
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-opensearchservice-domain-softwareupdateoptions.html#cfn-opensearchservice-domain-softwareupdateoptions-autosoftwareupdateenabled)
             */
            override fun autoSoftwareUpdateEnabled(): Any? =
                unwrap(this).getAutoSoftwareUpdateEnabled()
        }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SoftwareUpdateOptionsProperty
            ): software.amazon.awscdk.services.opensearchservice.CfnDomain.SoftwareUpdateOptionsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface OffPeakWindowProperty {
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("cc5262ef36470bc541159ef7d9a759a914ee2768b27431e784d1afc15afb33f3")
            override fun windowStartTime(
                windowStartTime: WindowStartTimeProperty.Builder.() -> Unit
    ...
    public interface SAMLOptionsProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param masterUserName The SAML master user name, which is stored in the domain's
             *   internal user database.
             */
            public fun masterUserName(masterUserName: String)

            /**
             * @param rolesKey Element of the SAML assertion to use for backend roles. Default is
             *   `roles` .
             */
            public fun rolesKey(rolesKey: String)

            /**
             * @param sessionTimeoutMinutes The duration, in minutes, after which a user session
             *   becomes inactive. Acceptable values are between 1 and 1440, and the default value
             *   is 60.
             */
            public fun sessionTimeoutMinutes(sessionTimeoutMinutes: Number)

            /**
             * @param subjectKey Element of the SAML assertion to use for the user name. Default is
             *   `NameID` .
             */
    ...
    public interface EncryptionAtRestOptionsProperty {
        ...
        public interface Builder {
             ...
             *   [AdvancedSecurityOptionsInput](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-opensearchservice-domain-advancedsecurityoptionsinput.html)
             *   . If no encryption at rest options were initially specified in the template,
             *   updating this property by adding it causes no interruption. However, if you change
             *   this property after it's already been set within a template, the domain is deleted
             *   and recreated in order to modify the property.
             */
            public fun enabled(enabled: Boolean)
             ...
             *   . Required if you enable encryption at rest. You can also use `keyAlias` as a
             *   value.
             *
             * If no encryption at rest options were initially specified in the template, updating
             * this property by adding it causes no interruption. However, if you change this
             * property after it's already been set within a template, the domain is deleted and
             * recreated in order to modify the property.
             */
        ...
        internal constructor(
            ...
            /**
             * Specify `true` to enable encryption at rest. Required if you enable fine-grained
             * access control in
             * [AdvancedSecurityOptionsInput](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-opensearchservice-domain-advancedsecurityoptionsinput.html)
             * .
             *
            ...
            /**
             * The KMS key ID. Takes the form `1a2a3a4-1a2a-3a4a-5a6a-1a2a3a4a5a6a` . Required if
             * you enable encryption at rest.
             *
             * You can also use `keyAlias` as a value.
             *
             * If no encryption at rest options were initially specified in the template, updating
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: EncryptionAtRestOptionsProperty
            ): software.amazon.awscdk.services.opensearchservice.CfnDomain.EncryptionAtRestOptionsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface OffPeakWindowOptionsProperty {
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("0816bae19b39183938b8f9bbfbcecebc689836be9c7c945c0fda0ba6d6bb8c40")
            override fun offPeakWindow(
                offPeakWindow: OffPeakWindowProperty.Builder.() -> Unit
            ): Unit = offPeakWindow(OffPeakWindowProperty(offPeakWindow))
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: OffPeakWindowOptionsProperty
            ): software.amazon.awscdk.services.opensearchservice.CfnDomain.OffPeakWindowOptionsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ClusterConfigProperty {
         ...
         * cluster management tasks to increase the stability of your search clusters. See
         ...
         * `DedicatedMasterEnabled` property. For valid values, see
         ...
         * prevent data loss and minimize downtime in the event of node or data center failure.
         * Don't enable zone awareness if your cluster has no replica index shards or is a
        ...
        public interface Builder {
            ...
            public fun coldStorageOptions(
                coldStorageOptions: ColdStorageOptionsProperty.Builder.() -> Unit
            )

            /**
             * @param dedicatedMasterCount The number of instances to use for the master node. If
             *   you specify this property, you must specify `true` for the `DedicatedMasterEnabled`
             *   property.
             */
            public fun dedicatedMasterCount(dedicatedMasterCount: Number)

            /**
             * @param dedicatedMasterEnabled Indicates whether to use a dedicated master node for
             *   the OpenSearch Service domain. A dedicated master node is a cluster node that
             *   performs cluster management tasks, but doesn't hold data or respond to data upload
             *   requests. Dedicated master nodes offload cluster management tasks to increase the
             *   stability of your search clusters. See
             *   [Dedicated master nodes in Amazon OpenSearch Service](https://docs.aws.amazon.com/opensearch-service/latest/developerguide/managedomains-dedicatedmasternodes.html)
             *   .
             */
             ...
             *   dedicated master node, such as `m3.medium.search` . If you specify this property,
             *   you must specify `true` for the `DedicatedMasterEnabled` property. For valid
             *   values, see
             *   [Supported instance types in Amazon OpenSearch Service](https://docs.aws.amazon.com/opensearch-service/latest/developerguide/supported-instance-types.html)
             *   .
             */
            ...
            /**
             * @param instanceCount The number of data nodes (instances) to use in the OpenSearch
             *   Service domain.
             */
            public fun instanceCount(instanceCount: Number)

            /**
             * @param instanceType The instance type for your data nodes, such as `m3.medium.search`
            ...
            /**
             * @param multiAzWithStandbyEnabled Indicates whether Multi-AZ with Standby deployment
            ...
            /**
             * @param zoneAwarenessConfig Specifies zone awareness configuration options. Only use
            ...
            public fun zoneAwarenessConfig(
                zoneAwarenessConfig: ZoneAwarenessConfigProperty.Builder.() -> Unit
            )

            /**
             * @param zoneAwarenessEnabled Indicates whether to enable zone awareness for the
             *   OpenSearch Service domain. When you enable zone awareness, OpenSearch Service
             *   allocates the nodes and replica index shards that belong to a cluster across two
             *   Availability Zones (AZs) in the same region to prevent data loss and minimize
             *   downtime in the event of node or data center failure. Don't enable zone awareness
             *   if your cluster has no replica index shards or is a single-node cluster. For more
             *   information, see
             *   [Configuring a multi-AZ domain in Amazon OpenSearch Service](https://docs.aws.amazon.com/opensearch-service/latest/developerguide/managedomains-multiaz.html)
             *   .
             */
        ...
        private class BuilderImpl : Builder {
            ...
            override fun coldStorageOptions(coldStorageOptions: ColdStorageOptionsProperty) {
                cdkBuilder.coldStorageOptions(
                    coldStorageOptions.let(ColdStorageOptionsProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("1822352ea71203b92b2fbf8a9c574aa529cf46c3083eb8ea53e532de17da1635")
            override fun coldStorageOptions(
                coldStorageOptions: ColdStorageOptionsProperty.Builder.() -> Unit
            ...
            override fun multiAzWithStandbyEnabled(multiAzWithStandbyEnabled: IResolvable) {
                cdkBuilder.multiAzWithStandbyEnabled(
                    multiAzWithStandbyEnabled.let(IResolvable::unwrap)
                )
            }
            ...
            override fun zoneAwarenessConfig(zoneAwarenessConfig: ZoneAwarenessConfigProperty) {
                cdkBuilder.zoneAwarenessConfig(
                    zoneAwarenessConfig.let(ZoneAwarenessConfigProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("cdc81f2f0fd336ad06569f2ff2c6451da52fa162b58311d6df529bf63527dbb0")
            override fun zoneAwarenessConfig(
                zoneAwarenessConfig: ZoneAwarenessConfigProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * The number of instances to use for the master node.
             *
             * If you specify this property, you must specify `true` for the
            ...
            /**
             * The hardware configuration of the computer that hosts the dedicated master node, such
             * as `m3.medium.search` . If you specify this property, you must specify `true` for the
             * `DedicatedMasterEnabled` property. For valid values, see
             * [Supported instance types in Amazon OpenSearch Service](https://docs.aws.amazon.com/opensearch-service/latest/developerguide/supported-instance-types.html)
             * .
             *
            ...
            /**
             * The instance type for your data nodes, such as `m3.medium.search` . For valid values,
             * see
             * [Supported instance types in Amazon OpenSearch Service](https://docs.aws.amazon.com/opensearch-service/latest/developerguide/supported-instance-types.html)
             * .
             *
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-opensearchservice-domain-clusterconfig.html#cfn-opensearchservice-domain-clusterconfig-multiazwithstandbyenabled)
             */
            override fun multiAzWithStandbyEnabled(): Any? =
             ...
             * Indicates whether to enable zone awareness for the OpenSearch Service domain.
             *
             * When you enable zone awareness, OpenSearch Service allocates the nodes and replica
             * index shards that belong to a cluster across two Availability Zones (AZs) in the same
             * region to prevent data loss and minimize downtime in the event of node or data center
             * failure. Don't enable zone awareness if your cluster has no replica index shards or
             * is a single-node cluster. For more information, see
             * [Configuring a multi-AZ domain in Amazon OpenSearch Service](https://docs.aws.amazon.com/opensearch-service/latest/developerguide/managedomains-multiaz.html)
             * .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-opensearchservice-domain-clusterconfig.html#cfn-opensearchservice-domain-clusterconfig-zoneawarenessenabled)
    ...
    public interface NodeToNodeEncryptionOptionsProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: NodeToNodeEncryptionOptionsProperty
            ): software.amazon.awscdk.services.opensearchservice.CfnDomain.NodeToNodeEncryptionOptionsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SnapshotOptionsProperty {
         ...
         */
        public fun automatedSnapshotStartHour(): Number? =
        ...
        public interface Builder {
             ...
             *   automated daily snapshot of the indexes in the OpenSearch Service domain. For
             *   example, if you specify 0, OpenSearch Service takes an automated snapshot everyday
             *   between midnight and 1 am. You can specify a value between 0 and 23.
             */
        ...
        internal constructor(
             ...
             * indexes in the OpenSearch Service domain.
             *
             * For example, if you specify 0, OpenSearch Service takes an automated snapshot
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SnapshotOptionsProperty
            ): software.amazon.awscdk.services.opensearchservice.CfnDomain.SnapshotOptionsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ZoneAwarenessConfigProperty {
        ...
        public interface Builder {
            /**
             * @param availabilityZoneCount If you enabled multiple Availability Zones (AZs), the
             *   number of AZs that you want the domain to use. Valid values are `2` and `3` .
             *   Default is 2.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ZoneAwarenessConfigProperty
            ): software.amazon.awscdk.services.opensearchservice.CfnDomain.ZoneAwarenessConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DomainEndpointOptionsProperty {
        ...
        public interface Builder {
            /**
             * @param customEndpoint The fully qualified URL for your custom endpoint. Required if
             *   you enabled a custom endpoint for the domain.
             */
             ...
             *   SSL/TLS certificate. Required if you enabled a custom endpoint for the domain.
             */
            public fun customEndpointCertificateArn(customEndpointCertificateArn: String)

            /**
             * @param customEndpointEnabled True to enable a custom endpoint for the domain. If
             *   enabled, you must also provide values for `CustomEndpoint` and
             *   `CustomEndpointCertificateArn` .
             */
             ...
             *   Valid values are TLS 1.3 (recommended) or 1.2:.
             * * `Policy-Min-TLS-1-0-2019-07`
             * * `Policy-Min-TLS-1-2-2019-07`
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DomainEndpointOptionsProperty
            ): software.amazon.awscdk.services.opensearchservice.CfnDomain.DomainEndpointOptionsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ServiceSoftwareOptionsProperty {
        ...
        public interface Builder {
             ...
             *   request a service software update. After this date, we automatically update your
             *   service software.
             */
            public fun automatedUpdateDate(automatedUpdateDate: String)

            /**
             * @param cancellable True if you're able to cancel your service software version
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ServiceSoftwareOptionsProperty
            ): software.amazon.awscdk.services.opensearchservice.CfnDomain.ServiceSoftwareOptionsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface WindowStartTimeProperty {
         ...
         *
         * For example, 17 refers to 5:00 P.M. UTC. The minimum value is 0 and the maximum value
         * is 23.
         *
        ...
        public interface Builder {
             ...
             *   24-hour time. For example, 17 refers to 5:00 P.M. UTC. The minimum value is 0 and
             *   the maximum value is 23.
             */
            public fun hours(hours: Number)

            /**
             * @param minutes The start minute of the window, in UTC. The minimum value is 0 and the
             *   maximum value is 59.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: WindowStartTimeProperty
            ): software.amazon.awscdk.services.opensearchservice.CfnDomain.WindowStartTimeProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ColdStorageOptionsProperty {
        ...
        public interface Builder {
            /**
             * @param enabled Whether to enable or disable cold storage on the domain. You must
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ColdStorageOptionsProperty
            ): software.amazon.awscdk.services.opensearchservice.CfnDomain.ColdStorageOptionsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface VPCOptionsProperty {
         ...
         * group for the VPC. To learn more, see
        ...
        public interface Builder {
            /**
             * @param securityGroupIds The list of security group IDs that are associated with the
             *   VPC endpoints for the domain. If you don't provide a security group ID, OpenSearch
             *   Service uses the default security group for the VPC. To learn more, see
             *   [Security groups for your VPC](https://docs.aws.amazon.com/vpc/latest/userguide/VPC_SecurityGroups.html)
             *   in the *Amazon VPC User Guide* .
             */
            ...
            /**
             * @param subnetIds Provide one subnet ID for each Availability Zone that your domain
             *   uses. For example, you must specify three subnet IDs for a three-AZ domain. To
             *   learn more, see
             *   [VPCs and subnets](https://docs.aws.amazon.com/vpc/latest/userguide/VPC_Subnets.html)
             *   in the *Amazon VPC User Guide* .
             *
             * If you specify more than one subnet, you must also configure `ZoneAwarenessEnabled`
             * and `ZoneAwarenessConfig` within
             * [ClusterConfig](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-opensearchservice-domain-clusterconfig.html)
             * , otherwise you'll see the error "You must specify exactly one subnet" during
             * template creation.
             */
        ...
        internal constructor(
             ...
             * domain.
             *
             * If you don't provide a security group ID, OpenSearch Service uses the default
             * security group for the VPC. To learn more, see
             * [Security groups for your VPC](https://docs.aws.amazon.com/vpc/latest/userguide/VPC_SecurityGroups.html)
             * in the *Amazon VPC User Guide* .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-opensearchservice-domain-vpcoptions.html#cfn-opensearchservice-domain-vpcoptions-securitygroupids)
             ...
             * Provide one subnet ID for each Availability Zone that your domain uses.
             *
             * For example, you must specify three subnet IDs for a three-AZ domain. To learn more,
             * see
             * [VPCs and subnets](https://docs.aws.amazon.com/vpc/latest/userguide/VPC_Subnets.html)
             * in the *Amazon VPC User Guide* .
             *
    ...
    public interface EBSOptionsProperty {
         ...
         * information about each type, see
        ...
        public interface Builder {
            /**
             * @param ebsEnabled Specifies whether Amazon EBS volumes are attached to data nodes in
            ...
            /**
             * @param throughput The throughput (in MiB/s) of the EBS volumes attached to data
             *   nodes. Applies only to the `gp3` volume type.
             */
            public fun throughput(throughput: Number)

            /**
             * @param volumeSize The size (in GiB) of the EBS volume for each data node. The minimum
             *   and maximum size of an EBS volume depends on the EBS volume type and the instance
             *   type to which it is attached. For more information, see
             *   [EBS volume size limits](https://docs.aws.amazon.com/opensearch-service/latest/developerguide/limits.html#ebsresource)
             *   in the *Amazon OpenSearch Service Developer Guide* .
             */
            ...
            /**
             * @param volumeType The EBS volume type to use with the OpenSearch Service domain. If
             *   you choose `gp3` , you must also specify values for `Iops` and `Throughput` . For
             *   more information about each type, see
             *   [Amazon EBS volume types](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/EBSVolumeTypes.html)
             *   in the *Amazon EC2 User Guide for Linux Instances* .
             */
        ...
        internal constructor(
            ...
            /**
             * Specifies whether Amazon EBS volumes are attached to data nodes in the OpenSearch
             * Service domain.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-opensearchservice-domain-ebsoptions.html#cfn-opensearchservice-domain-ebsoptions-ebsenabled)
             */
             ...
             * The EBS volume type to use with the OpenSearch Service domain.
             *
             * If you choose `gp3` , you must also specify values for `Iops` and `Throughput` . For
             * more information about each type, see
             * [Amazon EBS volume types](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/EBSVolumeTypes.html)
             * in the *Amazon EC2 User Guide for Linux Instances* .
             *
    ...
    public interface CognitoOptionsProperty {
        ...
        public interface Builder {
            /**
             * @param enabled Whether to enable or disable Amazon Cognito authentication for
             *   OpenSearch Dashboards. See
             *   [Amazon Cognito authentication for OpenSearch Dashboards](https://docs.aws.amazon.com/opensearch-service/latest/developerguide/cognito-auth.html)
             *   .
             */
            public fun enabled(enabled: Boolean)
            ...
            /**
             * @param identityPoolId The Amazon Cognito identity pool ID that you want OpenSearch
             *   Service to use for OpenSearch Dashboards authentication. Required if you enabled
             ...
             *   Service to configure your user pool and identity pool. Required if you enabled
             *   Cognito Authentication for OpenSearch Dashboards.
             */
            public fun roleArn(roleArn: String)

            /**
             * @param userPoolId The Amazon Cognito user pool ID that you want OpenSearch Service to
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CognitoOptionsProperty
            ): software.amazon.awscdk.services.opensearchservice.CfnDomain.CognitoOptionsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
