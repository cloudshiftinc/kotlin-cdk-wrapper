...
public interface ApplicationLoadBalancedTaskImageProps {
    ...
    public interface Builder {
         ...
         *   user-specified or automatically assigned host port. If you are using containers in a
         *   task with the awsvpc or host network mode, exposed ports should be specified using
         *   containerPort. If you are using containers in a task with the bridge network mode and
         *   you specify a container port and not a host port, your container automatically receives
         *   a host port in the ephemeral port range.
         *
         * Port mappings that are automatically assigned in this way do not count toward the 100
         * reserved ports limit of a container instance.
         *
    ...
    internal constructor(
        ...
        /**
         * A list of port numbers on the container that is bound to the user-specified or
         ...
         * Default: - [80]
         */
        override fun containerPorts(): List<Number> =
            unwrap(this).getContainerPorts() ?: emptyList()
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: ApplicationLoadBalancedTaskImageProps
        ): software.amazon.awscdk.services.ecs.patterns.ApplicationLoadBalancedTaskImageProps =
