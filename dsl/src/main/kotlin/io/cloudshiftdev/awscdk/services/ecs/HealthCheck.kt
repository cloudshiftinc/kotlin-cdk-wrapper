...
public interface HealthCheck {
     ...
     * healthy.
     *
     * The string array must start with CMD to execute the command arguments directly, or CMD-SHELL
    ...
    public interface Builder {
         ...
         *   determine if it is healthy. The string array must start with CMD to execute the command
         *   arguments directly, or CMD-SHELL to run the command with the container's default shell.
         *
         * For example: [ "CMD-SHELL", "curl -f http://localhost/ || exit 1" ]
         */
         ...
         *   bootstrap before failed health checks count towards the maximum number of retries. You
         *   may specify between 0 and 300 seconds.
         */
         ...
         *   is considered a failure. You may specify between 2 and 60 seconds.
         */
