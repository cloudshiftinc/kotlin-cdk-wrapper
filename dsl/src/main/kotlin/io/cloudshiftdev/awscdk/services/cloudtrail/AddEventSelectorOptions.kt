...
public interface AddEventSelectorOptions {
    ...
    public interface Builder {
        ...
        public fun excludeManagementEventSources(
            excludeManagementEventSources: List<ManagementEventSources>
        )
    ...
    private class BuilderImpl : Builder {
        ...
        override fun excludeManagementEventSources(
            ...
            cdkBuilder.excludeManagementEventSources(
                excludeManagementEventSources.map(ManagementEventSources::unwrap)
            )
        }
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: AddEventSelectorOptions
