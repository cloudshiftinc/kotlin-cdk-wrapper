...
public interface LogConfig {
     ...
     *
     * By default AppSync keeps the logs infinitely. When updating this property, unsetting it
     * doesn't remove the log retention policy. To remove the retention policy, set the value to
     * `INFINITE`
     *
    ...
    public interface Builder {
         ...
         *   AppSync keeps the logs infinitely. When updating this property, unsetting it doesn't
         *   remove the log retention policy. To remove the retention policy, set the value to
         *   `INFINITE`
         */
    ...
    internal constructor(
         ...
         * Default: RetentionDays.INFINITE
         */
        override fun retention(): RetentionDays? =
