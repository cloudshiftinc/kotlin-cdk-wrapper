...
public enum class SpotRequestType(
    ...
    public companion object {
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.ec2.SpotRequestType
        ): SpotRequestType =
            when (cdkObject) {
                software.amazon.awscdk.services.ec2.SpotRequestType.ONE_TIME ->
                    SpotRequestType.ONE_TIME
                software.amazon.awscdk.services.ec2.SpotRequestType.PERSISTENT ->
                    SpotRequestType.PERSISTENT
            }

        internal fun unwrap(
            wrapped: SpotRequestType
