...
internal constructor(
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.lakeformation.CfnPrincipalPermissions.Builder.create(
                scope,
                id
            )
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnPrincipalPermissions
    ...
    public interface ResourceProperty {
        ...
        public interface Builder {
            ...
            public fun dataCellsFilter(
                dataCellsFilter: DataCellsFilterResourceProperty.Builder.() -> Unit
            )

            /**
             * @param dataLocation The location of an Amazon S3 path where permissions are granted
             *   or revoked.
             */
            ...
            /**
             * @param lfTagPolicy A list of LF-tag conditions that define a resource's LF-tag
             *   policy.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            override fun dataCellsFilter(dataCellsFilter: DataCellsFilterResourceProperty) {
                cdkBuilder.dataCellsFilter(
                    dataCellsFilter.let(DataCellsFilterResourceProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("e7b4189fe1269e009c363138ef33cb5e5b1a0ceb7590abade6833e9511b923a9")
            override fun dataLocation(
                dataLocation: DataLocationResourceProperty.Builder.() -> Unit
            ): Unit = dataLocation(DataLocationResourceProperty(dataLocation))
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("7e7fbdb2b7dbf0e67b4e4467adb58fce79882b5f0045c739c4d75f5326b5bb21")
            override fun lfTagPolicy(
                lfTagPolicy: LFTagPolicyResourceProperty.Builder.() -> Unit
    ...
    public interface DataLocationResourceProperty {
        ...
        public interface Builder {
            /**
             * @param catalogId The identifier for the Data Catalog where the location is registered
    ...
    public interface DataCellsFilterResourceProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DataCellsFilterResourceProperty
            ): software.amazon.awscdk.services.lakeformation.CfnPrincipalPermissions.DataCellsFilterResourceProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DataLakePrincipalProperty {
        ...
        public interface Builder {
            /**
             * @param dataLakePrincipalIdentifier An identifier for the AWS Lake Formation
             *   principal.
             */
    ...
    public interface LFTagKeyResourceProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param tagValues A list of possible values for the corresponding `TagKey` of an
             *   LF-tag key-value pair.
             */
        ...
        internal constructor(
            ...
            /**
             * The identifier for the Data Catalog where the location is registered with Data
             * Catalog .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-lakeformation-principalpermissions-lftagkeyresource.html#cfn-lakeformation-principalpermissions-lftagkeyresource-catalogid)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: LFTagKeyResourceProperty
            ): software.amazon.awscdk.services.lakeformation.CfnPrincipalPermissions.LFTagKeyResourceProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface LFTagPolicyResourceProperty {
         ...
         * The identifier for the Data Catalog .
         *
         * The Data Catalog is the persistent metadata store. It contains database definitions,
         * table definitions, and other control information to manage your AWS Lake Formation
         * environment.
         *
        ...
        public interface Builder {
            /**
             * @param catalogId The identifier for the Data Catalog . The Data Catalog is the
            ...
            /**
             * @param expression A list of LF-tag conditions that apply to the resource's LF-tag
             *   policy.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: LFTagPolicyResourceProperty
            ): software.amazon.awscdk.services.lakeformation.CfnPrincipalPermissions.LFTagPolicyResourceProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface TableResourceProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param tableWildcard A wildcard object representing every table under a database. At
