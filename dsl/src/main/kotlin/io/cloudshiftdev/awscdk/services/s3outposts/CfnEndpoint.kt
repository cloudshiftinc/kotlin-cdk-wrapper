...
internal constructor(
    ...
    public interface Builder {
         ...
         * endpoint.
         *
         * To use the Amazon VPC , choose `Private` . To use the endpoint with an on-premises
         * network, choose `CustomerOwnedIp` . If you choose `CustomerOwnedIp` , you must also
         ...
         *
         * @param accessType The container for the type of connectivity used to access the Amazon S3
         *   on Outposts endpoint.
         */
         ...
         *
         * @param customerOwnedIpv4Pool The ID of the customer-owned IPv4 address pool (CoIP pool)
         *   for the endpoint.
         */
         ...
         *
         * @param failedReason The failure reason, if any, for a create or delete endpoint
         *   operation.
         */
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.s3outposts.CfnEndpoint =
            cdkBuilder.build()
    }
    ...
    public interface FailedReasonProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param message Additional error details describing the endpoint failure and
             *   recommended action.
             */
