...
internal constructor(
     ...
     *
     * This is useful if you want to represent an Alarm in a non-AlarmWidget. An `AlarmWidget` can
     * directly show an alarm, but it can only show a single alarm and no other metrics. Instead,
     * you can convert the alarm to a HorizontalAnnotation and add it as an annotation to another
     * graph.
     *
     * This might be useful if:
     * * You want to show multiple alarms inside a single graph, for example if you have both a
     *   "small margin/long period" alarm as well as a "large margin/short period" alarm.
    ...
    public interface Builder {
        ...
        /**
         * Specifies whether to evaluate the data and potentially change the alarm state if there
    ...
    public companion object {
        public fun fromAlarmArn(
            ...
            software.amazon.awscdk.services.cloudwatch.Alarm.fromAlarmArn(
        ...
        public fun fromAlarmName(
            ...
            software.amazon.awscdk.services.cloudwatch.Alarm.fromAlarmName(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    alarmName
                )
