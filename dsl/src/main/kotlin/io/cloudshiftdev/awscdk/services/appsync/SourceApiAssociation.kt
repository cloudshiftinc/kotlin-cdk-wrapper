...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.appsync.SourceApiAssociation,
    ...
    public interface Builder {
         ...
         *
         * @param mergedApiExecutionRole The merged api execution role for adding the access policy
         *   for the source api.
         */
    ...
    public companion object {
        public fun fromSourceApiAssociationAttributes(
            ...
            software.amazon.awscdk.services.appsync.SourceApiAssociation
                .fromSourceApiAssociationAttributes(
                    ...
                    id,
                    attrs.let(SourceApiAssociationAttributes::unwrap)
                )
                .let(ISourceApiAssociation::wrap)
        ...
        public fun fromSourceApiAssociationAttributes(
            ...
            fromSourceApiAssociationAttributes(scope, id, SourceApiAssociationAttributes(attrs))
