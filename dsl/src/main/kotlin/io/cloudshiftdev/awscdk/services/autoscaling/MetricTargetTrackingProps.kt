...
public interface MetricTargetTrackingProps : BaseTargetTrackingProps {
     ...
     * Metric to track.
     *
     * The metric must represent a utilization, so that if it's higher than the target value, your
     * ASG should scale out, and if it's lower it should scale in.
     */
    ...
    public interface Builder {
         ...
         *   won't remove capacity from the autoscaling group. Otherwise, scale in is enabled and
         *   the target tracking policy can remove capacity from the group.
         */
         ...
         *   higher than the target value, your ASG should scale out, and if it's lower it should
         *   scale in.
         */
    ...
    internal constructor(
         ...
         * Metric to track.
         *
         * The metric must represent a utilization, so that if it's higher than the target value,
         * your ASG should scale out, and if it's lower it should scale in.
         */
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: MetricTargetTrackingProps
        ): software.amazon.awscdk.services.autoscaling.MetricTargetTrackingProps =
