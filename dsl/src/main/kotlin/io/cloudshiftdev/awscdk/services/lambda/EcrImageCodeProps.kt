...
public interface EcrImageCodeProps {
     ...
     */
    @Deprecated(message = "deprecated in CDK") public fun tag(): String? = unwrap(this).getTag()
    ...
    public interface Builder {
         ...
         *   executable. This needs to be in the 'exec form', viz., `[ 'executable', 'param1',
         *   'param2' ]`.
         */
         ...
         * @deprecated use `tagOrDigest`
         */
        @Deprecated(message = "deprecated in CDK") public fun tag(tag: String)

        /**
         * @param tagOrDigest The image tag or digest to use when pulling the image from ECR
         *   (digests must start with `sha256:`).
         */
         ...
         *   Dockerfile. A WORKDIR allows you to configure the working directory the container will
         *   use.
         */
