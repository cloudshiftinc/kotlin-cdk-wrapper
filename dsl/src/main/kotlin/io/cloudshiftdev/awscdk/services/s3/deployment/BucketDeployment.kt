...
internal constructor(
     ...
     *
     * If you want to reference the destination bucket in another construct and make sure the bucket
     * deployment has happened before the next operation is started, pass the other construct a
     * reference to `deployment.deployedBucket`.
     *
     * Note that this only returns an immutable reference to the destination bucket. If sequenced
     * access to the original destination bucket is required, you may add a dependency on the bucket
     * deployment instead: `otherResource.node.addDependency(deployment)`
     */
     ...
     *
     * This returns a list of tokenized object keys for source files that are deployed to the
     * bucket.
     *
     * This can be useful when using `BucketDeployment` with `extract` set to `false` and you need
     * to reference the object key that resides in the bucket for that zip source file somewhere
     * else in your CDK application, such as in a CFN output.
     *
     * For example, use `Fn.select(0, myBucketDeployment.objectKeys)` to reference the object key of
     * the first source file in your bucket deployment.
     */
    ...
    public interface Builder {
         ...
         * [Documentation](https://docs.aws.amazon.com/AmazonS3/latest/dev/UsingMetadata.html#SysMetadata)
         *
         * @param contentDisposition System-defined cache-disposition metadata to be set on all
         ...
         * [Documentation](https://docs.aws.amazon.com/AmazonS3/latest/dev/UsingMetadata.html#SysMetadata)
         *
         * @param contentEncoding System-defined content-encoding metadata to be set on all objects
         *   in the deployment.
         */
         ...
         * [Documentation](https://docs.aws.amazon.com/AmazonS3/latest/dev/UsingMetadata.html#SysMetadata)
         *
         * @param contentLanguage System-defined content-language metadata to be set on all objects
         *   in the deployment.
         */
         ...
         *
         * Files in the distribution's edge caches will be invalidated after files are uploaded to
         * the destination bucket.
         *
         * Default: - No invalidation occurs
         *
         * @param distribution The CloudFront distribution using the destination bucket as an
         *   origin.
         */
         ...
         * [Documentation](https://docs.aws.amazon.com/AmazonS3/latest/dev/UsingMetadata.html#SysMetadata)
         *
         * @param expires System-defined expires metadata to be set on all objects in the
         *   deployment.
         */
         ...
         * Default: true
         *
         * @param extract If this is set, the zip file will be synced to the destination S3 bucket
         *   and extracted.
         */
         ...
         * command.
         *
         * Since all files from the deployment package are included by default, this property is
         * usually leveraged alongside an `exclude` filter.
         *
        ...
        /**
         * The Log Group used for logging of events emitted by the custom resource's lambda
         * function.
         *
         ...
         * Default: 128
         *
         * @param memoryLimit The amount of memory (in MiB) to allocate to the AWS Lambda function
         *   which replicates the files from the CDK bucket to the destination bucket.
         */
        ...
        /**
         * If this is set to false, files in the destination bucket that do not exist in the asset,
         * will NOT be deleted during deployment (create/update).
         *
         * Default: true
         *
         * [Documentation](https://docs.aws.amazon.com/cli/latest/reference/s3/sync.html)
         *
         * @param prune If this is set to false, files in the destination bucket that do not exist
         *   in the asset, will NOT be deleted during deployment (create/update).
         */
        public fun prune(prune: Boolean)

        /**
         * If this is set to "false", the destination files will be deleted when the resource is
         * deleted or the destination is updated.
         *
         * NOTICE: Configuring this to "false" might have operational implications. Please visit to
         * the package documentation referred below to make sure you fully understand those
         * implications.
         *
         ...
         *
         * @param retainOnDelete If this is set to "false", the destination files will be deleted
         *   when the resource is deleted or the destination is updated.
         */
         ...
         * [Documentation](https://docs.aws.amazon.com/AmazonS3/latest/dev/UsingMetadata.html#SysMetadata)
         *
         * @param serverSideEncryption System-defined x-amz-server-side-encryption metadata to be
         *   set on all objects in the deployment.
         */
        public fun serverSideEncryption(serverSideEncryption: ServerSideEncryption)

        /**
         * System-defined x-amz-server-side-encryption-aws-kms-key-id metadata to be set on all
         * objects in the deployment.
         *
         * Default: - Not set.
         *
         ...
         *   x-amz-server-side-encryption-customer-algorithm metadata to be set on all objects in
         *   the deployment.
         */
        ...
        /**
         * If set to true, uploads will precompute the value of `x-amz-content-sha256` and include
         * it in the signed S3 request headers.
         *
         ...
         * [Documentation](https://docs.aws.amazon.com/AmazonS3/latest/dev/UsingMetadata.html#SysMetadata)
         *
         * @param storageClass System-defined x-amz-storage-class metadata to be set on all objects
         *   in the deployment.
         */
         ...
         * [Documentation](https://docs.aws.amazon.com/AmazonS3/latest/dev/UsingMetadata.html#SysMetadata)
         *
         * @param websiteRedirectLocation System-defined x-amz-website-redirect-location metadata to
         *   be set on all objects in the deployment.
         */
    ...
    private class BuilderImpl(
         ...
         *   the deployment.
         */
        override fun serverSideEncryptionCustomerAlgorithm(
            serverSideEncryptionCustomerAlgorithm: String
        ) {
