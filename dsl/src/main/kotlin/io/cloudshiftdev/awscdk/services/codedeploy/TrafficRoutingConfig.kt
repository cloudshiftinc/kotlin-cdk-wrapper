...
public interface TrafficRoutingConfig {
    ...
    public interface Builder {
        ...
        /**
         * @param type The type of traffic shifting ( `TimeBasedCanary` or `TimeBasedLinear` ) used
    ...
    private class BuilderImpl : Builder {
        ...
        override fun timeBasedCanary(
            timeBasedCanary: CanaryTrafficRoutingConfig.Builder.() -> Unit
        ...
        override fun timeBasedLinear(
            timeBasedLinear: LinearTrafficRoutingConfig.Builder.() -> Unit
