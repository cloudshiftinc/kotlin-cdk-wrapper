...
public enum class DevicePermission(
    ...
    public companion object {
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.batch.DevicePermission
        ): DevicePermission =
            when (cdkObject) {
                software.amazon.awscdk.services.batch.DevicePermission.READ -> DevicePermission.READ
                software.amazon.awscdk.services.batch.DevicePermission.WRITE ->
                    DevicePermission.WRITE
                software.amazon.awscdk.services.batch.DevicePermission.MKNOD ->
                    DevicePermission.MKNOD
            }

        internal fun unwrap(
            wrapped: DevicePermission
