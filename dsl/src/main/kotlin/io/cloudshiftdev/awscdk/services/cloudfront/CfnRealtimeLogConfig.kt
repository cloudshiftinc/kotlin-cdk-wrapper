...
internal constructor(
    ...
    public interface Builder {
         ...
         * A list of fields that are included in each real-time log record.
         *
         * In an API response, the fields are provided in the same order in which they are sent to
         ...
         * The sampling rate for this real-time log configuration.
         *
         * The sampling rate determines the percentage of viewer requests that are represented in
         * the real-time log data. The sampling rate is an integer between 1 and 100, inclusive.
         *
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.cloudfront.CfnRealtimeLogConfig.Builder.create(
                scope,
                id
            )
    ...
    public interface KinesisStreamConfigProperty {
        ...
        public interface Builder {
            /**
             * @param roleArn The Amazon Resource Name (ARN) of an AWS Identity and Access
             *   Management (IAM) role that CloudFront can use to send real-time log data to your
             *   Kinesis data stream. For more information the IAM role, see
             *   [Real-time log configuration IAM role](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/real-time-logs.html#understand-real-time-log-config-iam-role)
             *   in the *Amazon CloudFront Developer Guide* .
             */
            ...
            /**
             * @param streamArn The Amazon Resource Name (ARN) of the Kinesis data stream where you
    ...
    public interface EndPointProperty {
        ...
        public interface Builder {
            /**
             * @param kinesisStreamConfig Contains information about the Amazon Kinesis data stream
