...
internal constructor(
    ...
    public interface Builder {
         ...
         * functions on messages for advanced processing; or performing mathematical transformations
    ...
    public interface ActivityProperty {
        ...
        public interface Builder {
            /**
             * @param addAttributes Adds other attributes based on existing attributes in the
             *   message.
             */
            ...
            /**
             * @param deviceRegistryEnrich Adds data from the AWS IoT device registry to your
             *   message.
             */
            ...
            public fun deviceRegistryEnrich(
                deviceRegistryEnrich: DeviceRegistryEnrichProperty.Builder.() -> Unit
            )

            /**
             * @param deviceShadowEnrich Adds information from the AWS IoT Device Shadows service to
             *   a message.
             */
            ...
            public fun deviceShadowEnrich(
                deviceShadowEnrich: DeviceShadowEnrichProperty.Builder.() -> Unit
            )
            ...
            /**
             * @param math Computes an arithmetic expression using the message's attributes and adds
             *   it to the message.
             */
            ...
            public fun removeAttributes(
                removeAttributes: RemoveAttributesProperty.Builder.() -> Unit
            )

            /**
             * @param selectAttributes Creates a new message using only the specified attributes
            ...
            public fun selectAttributes(
                selectAttributes: SelectAttributesProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun addAttributes(
                addAttributes: AddAttributesProperty.Builder.() -> Unit
            ...
            override fun deviceRegistryEnrich(deviceRegistryEnrich: DeviceRegistryEnrichProperty) {
                cdkBuilder.deviceRegistryEnrich(
                    deviceRegistryEnrich.let(DeviceRegistryEnrichProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("ab22e542b2d957497953e9d0672c37ec53a0d249180ac68a5b2fc0e3e956d83a")
            override fun deviceRegistryEnrich(
                deviceRegistryEnrich: DeviceRegistryEnrichProperty.Builder.() -> Unit
            ...
            override fun deviceShadowEnrich(deviceShadowEnrich: DeviceShadowEnrichProperty) {
                cdkBuilder.deviceShadowEnrich(
                    deviceShadowEnrich.let(DeviceShadowEnrichProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("5d41686fb04cacb0ea68292b59291060d7ff78c8f5b17e4b82aed6959861f72f")
            override fun deviceShadowEnrich(
                deviceShadowEnrich: DeviceShadowEnrichProperty.Builder.() -> Unit
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("1c6a1a86c0e9519c5c512a75d39a299706b42961487e63592617ff0e0dea4a2b")
            override fun math(math: MathProperty.Builder.() -> Unit): Unit =
    ...
    public interface FilterProperty {
        ...
        public interface Builder {
            /**
             * @param filter An expression that looks like an SQL WHERE clause that must return a
             *   Boolean value.
             */
    ...
    public interface DeviceShadowEnrichProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DeviceShadowEnrichProperty
            ): software.amazon.awscdk.services.iotanalytics.CfnPipeline.DeviceShadowEnrichProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SelectAttributesProperty {
        ...
        private class BuilderImpl : Builder {
            ...
            /** @param attributes A list of the attributes to select from the message. */
            override fun attributes(vararg attributes: String): Unit =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SelectAttributesProperty
            ): software.amazon.awscdk.services.iotanalytics.CfnPipeline.SelectAttributesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface RemoveAttributesProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RemoveAttributesProperty
            ): software.amazon.awscdk.services.iotanalytics.CfnPipeline.RemoveAttributesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface MathProperty {
        ...
        public interface Builder {
            /**
             * @param attribute The name of the attribute that contains the result of the math
             *   operation.
             */
            public fun attribute(attribute: String)

            /**
             * @param math An expression that uses one or more existing attributes and must return
             *   an integer value.
             */
    ...
    public interface DeviceRegistryEnrichProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param roleArn The ARN of the role that allows access to the device's registry
             *   information.
             */
            public fun roleArn(roleArn: String)

            /**
             * @param thingName The name of the IoT device whose registry information is added to
             *   the message.
             */
            public fun thingName(thingName: String)
        }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DeviceRegistryEnrichProperty
            ): software.amazon.awscdk.services.iotanalytics.CfnPipeline.DeviceRegistryEnrichProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
