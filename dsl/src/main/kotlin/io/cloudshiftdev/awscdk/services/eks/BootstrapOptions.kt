...
public interface BootstrapOptions {
    ...
    public interface Builder {
        ...
        /**
         * @param kubeletExtraArgs Extra arguments to add to the kubelet. Useful for adding labels
         *   or taints. For example, `--node-labels foo=bar,goo=far`.
         */
    ...
    private class BuilderImpl : Builder {
        ...
        public fun build(): software.amazon.awscdk.services.eks.BootstrapOptions =
            cdkBuilder.build()
    }
