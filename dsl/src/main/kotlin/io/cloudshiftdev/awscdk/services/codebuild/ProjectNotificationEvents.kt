...
public enum class ProjectNotificationEvents(
    ...
    public companion object {
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.codebuild.ProjectNotificationEvents
            ...
            when (cdkObject) {
                ...
                software.amazon.awscdk.services.codebuild.ProjectNotificationEvents
                    .BUILD_SUCCEEDED -> ProjectNotificationEvents.BUILD_SUCCEEDED
                software.amazon.awscdk.services.codebuild.ProjectNotificationEvents
                    .BUILD_IN_PROGRESS -> ProjectNotificationEvents.BUILD_IN_PROGRESS
                software.amazon.awscdk.services.codebuild.ProjectNotificationEvents.BUILD_STOPPED ->
                    ProjectNotificationEvents.BUILD_STOPPED
                software.amazon.awscdk.services.codebuild.ProjectNotificationEvents
                    .BUILD_PHASE_FAILED -> ProjectNotificationEvents.BUILD_PHASE_FAILED
                software.amazon.awscdk.services.codebuild.ProjectNotificationEvents
                    .BUILD_PHASE_SUCCEEDED -> ProjectNotificationEvents.BUILD_PHASE_SUCCEEDED
            }

        internal fun unwrap(
            wrapped: ProjectNotificationEvents
