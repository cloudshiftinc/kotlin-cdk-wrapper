...
internal constructor(
    ...
    public companion object {
        ...
        public fun fromAsset(directory: String, props: AssetImageProps): AssetImage =
            software.amazon.awscdk.services.ecs.ContainerImage.fromAsset(
                    directory,
        ...
        public fun fromAsset(
            directory: String,
            props: AssetImageProps.Builder.() -> Unit
        ...
        public fun fromDockerImageAsset(asset: DockerImageAsset): ContainerImage =
            software.amazon.awscdk.services.ecs.ContainerImage.fromDockerImageAsset(
                    asset.let(DockerImageAsset::unwrap)
                )
                .let(ContainerImage::wrap)

        public fun fromEcrRepository(repository: IRepository): EcrImage =
            software.amazon.awscdk.services.ecs.ContainerImage.fromEcrRepository(
        ...
        public fun fromRegistry(name: String): RepositoryImage =
            software.amazon.awscdk.services.ecs.ContainerImage.fromRegistry(name)
                .let(RepositoryImage::wrap)

        public fun fromRegistry(name: String, props: RepositoryImageProps): RepositoryImage =
            software.amazon.awscdk.services.ecs.ContainerImage.fromRegistry(
                    name,
        ...
        public fun fromRegistry(
            name: String,
            props: RepositoryImageProps.Builder.() -> Unit
        ): RepositoryImage = fromRegistry(name, RepositoryImageProps(props))

        public fun fromTarball(tarballFile: String): ContainerImage =
            software.amazon.awscdk.services.ecs.ContainerImage.fromTarball(tarballFile)
                .let(ContainerImage::wrap)

        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.ecs.ContainerImage
        ): ContainerImage = Wrapper(cdkObject)

        internal fun unwrap(
            wrapped: ContainerImage
        ): software.amazon.awscdk.services.ecs.ContainerImage = (wrapped as Wrapper).cdkObject
    }
}
