...
internal constructor(
    ...
    public open fun scaleOnCpuUtilization(
        id: String,
        props: CpuUtilizationScalingProps.Builder.() -> Unit
    ): Unit = scaleOnCpuUtilization(id, CpuUtilizationScalingProps(props))
    ...
    public open fun scaleOnMemoryUtilization(
        id: String,
        props: MemoryUtilizationScalingProps.Builder.() -> Unit
    ): Unit = scaleOnMemoryUtilization(id, MemoryUtilizationScalingProps(props))
    ...
    ): Unit = scaleOnRequestCount(id, RequestCountScalingProps(props))
    ...
    public open fun scaleToTrackCustomMetric(
        id: String,
        props: TrackCustomMetricProps.Builder.() -> Unit
    ): Unit = scaleToTrackCustomMetric(id, TrackCustomMetricProps(props))
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.ecs.ScalableTaskCount =
            cdkBuilder.build()
    }
