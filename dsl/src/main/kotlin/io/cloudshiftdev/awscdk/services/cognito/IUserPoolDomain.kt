...
public interface IUserPoolDomain : IResource {
    ...
    internal constructor(
         ...
         * The domain that was specified to be created.
         *
         * If `customDomain` was selected, this holds the full domain name that was specified. If
         * the `cognitoDomain` was used, it contains the prefix to the Cognito hosted domain.
         */
