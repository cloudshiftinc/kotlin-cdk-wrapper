...
internal constructor(
    ...
    public open fun snapshotArnsToRestore(): List<String> =
        unwrap(this).getSnapshotArnsToRestore() ?: emptyList()
    ...
    public interface Builder {
         ...
         *
         * @param endpoint Represents the information required for client programs to connect to a
         *   cache node.
         */
         ...
         *
         * @param finalSnapshotName The name of the final snapshot taken of a cache before the cache
         *   is deleted.
         */
        public fun finalSnapshotName(finalSnapshotName: String)

        /**
         * The ID of the AWS Key Management Service (KMS) key that is used to encrypt data at rest
         ...
         *
         * @param kmsKeyId The ID of the AWS Key Management Service (KMS) key that is used to
         ...
         *
         * @param majorEngineVersion The version number of the engine the serverless cache is
         *   compatible with.
         */
         ...
         *
         * @param readerEndpoint Represents the information required for client programs to connect
         *   to a cache node.
         */
         ...
         *
         * @param snapshotArnsToRestore The ARN of the snapshot from which to restore data into the
         *   new cache.
         */
         ...
         *
         * @param subnetIds If no subnet IDs are given and your VPC is in us-west-1, then
    ...
    private class BuilderImpl(
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("775c3a878237c535ebce61e5a18e85026371df6dacc4535b533a50e54c677b1f")
        override fun cacheUsageLimits(
            cacheUsageLimits: CacheUsageLimitsProperty.Builder.() -> Unit
    ...
    public interface CacheUsageLimitsProperty {
        ...
        public interface Builder {
            /**
             * @param dataStorage The maximum data storage limit in the cache, expressed in
             *   Gigabytes.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("d61e195d9aa7328e1967852fc8f4f6db0345faaf467cc8f527c6bd215607685d")
            override fun ecpuPerSecond(
                ecpuPerSecond: ECPUPerSecondProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CacheUsageLimitsProperty
            ): software.amazon.awscdk.services.elasticache.CfnServerlessCache.CacheUsageLimitsProperty =
    ...
    public interface ECPUPerSecondProperty {
        ...
        public interface Builder {
            /**
             * @param maximum The configuration for the maximum number of ECPUs the cache can
             *   consume per second.
             */
