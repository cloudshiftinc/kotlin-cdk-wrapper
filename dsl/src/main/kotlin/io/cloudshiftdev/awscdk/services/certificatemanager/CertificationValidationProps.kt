...
public interface CertificationValidationProps {
     ...
     * Default: - Apex domain
     */
    public fun validationDomains(): Map<String, String> =
    ...
    internal constructor(
         ...
         * Default: ValidationMethod.EMAIL
         */
        override fun method(): ValidationMethod? =
         ...
         * Default: - Apex domain
         */
        override fun validationDomains(): Map<String, String> =
            unwrap(this).getValidationDomains() ?: emptyMap()
    }
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CertificationValidationProps
        ): software.amazon.awscdk.services.certificatemanager.CertificationValidationProps =
