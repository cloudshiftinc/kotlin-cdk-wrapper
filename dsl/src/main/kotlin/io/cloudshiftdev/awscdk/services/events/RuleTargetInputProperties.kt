...
public interface RuleTargetInputProperties {
     ...
     *
     * Default: - input for the event target. If the input contains a paths map values wil be
     * extracted from event and inserted into the `inputTemplate`.
     */
    ...
    public interface Builder {
        ...
        /**
         * @param inputPathsMap Paths map to extract values from event and insert into
         *   `inputTemplate`.
         */
    ...
    internal constructor(
         ...
         * Default: - No values extracted from event.
         */
        override fun inputPathsMap(): Map<String, String> =
            unwrap(this).getInputPathsMap() ?: emptyMap()
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: RuleTargetInputProperties
