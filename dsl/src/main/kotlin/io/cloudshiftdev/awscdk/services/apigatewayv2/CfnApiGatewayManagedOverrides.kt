...
internal constructor(
    ...
    public interface Builder {
        /**
         * The ID of the API for which to override the configuration of API Gateway-managed
         * resources.
         *
         ...
         *
         * @param apiId The ID of the API for which to override the configuration of API
    ...
    private class BuilderImpl(
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("1994cd72c74baf9b22c5e968c3a4a843eb3995442f997c9beaacc8c19e88440e")
        override fun integration(
            integration: IntegrationOverridesProperty.Builder.() -> Unit
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnApiGatewayManagedOverrides
        ): software.amazon.awscdk.services.apigatewayv2.CfnApiGatewayManagedOverrides =
            wrapped.cdkObject
    }
    ...
    public interface RouteOverridesProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param authorizerId The identifier of the `Authorizer` resource to be associated with
             *   this route. The authorizer identifier is generated by API Gateway when you created
             *   the authorizer.
             */
            ...
            /**
             * @param target For HTTP integrations, specify a fully qualified URL. For Lambda
             *   integrations, specify a function ARN. The type of the integration will be
             *   HTTP_PROXY or AWS_PROXY, respectively.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RouteOverridesProperty
            ): software.amazon.awscdk.services.apigatewayv2.CfnApiGatewayManagedOverrides.RouteOverridesProperty =
    ...
    public interface RouteSettingsProperty {
         ...
         * route.
         *
         * This property affects the log entries pushed to Amazon CloudWatch Logs. Supported only
         * for WebSocket APIs.
         *
        ...
        public interface Builder {
            /**
             * @param dataTraceEnabled Specifies whether ( `true` ) or not ( `false` ) data trace
            ...
            /**
             * @param loggingLevel Specifies the logging level for this route: `INFO` , `ERROR` , or
             *   `OFF` . This property affects the log entries pushed to Amazon CloudWatch Logs.
    ...
    public interface AccessLogSettingsProperty {
        ...
        public interface Builder {
            /**
             * @param destinationArn The ARN of the CloudWatch Logs log group to receive access
             *   logs.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AccessLogSettingsProperty
            ): software.amazon.awscdk.services.apigatewayv2.CfnApiGatewayManagedOverrides.AccessLogSettingsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface IntegrationOverridesProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param payloadFormatVersion Specifies the format of the payload sent to an
             *   integration. Required for HTTP APIs. For HTTP APIs, supported values for Lambda
             *   proxy integrations are `1.0` and `2.0` . For all other integrations, `1.0` is the
             *   only supported value. To learn more, see
             *   [Working with AWS Lambda proxy integrations for HTTP APIs](https://docs.aws.amazon.com/apigateway/latest/developerguide/http-api-develop-integrations-lambda.html)
             *   .
             */
            ...
            /**
             * @param timeoutInMillis Custom timeout between 50 and 29,000 milliseconds for
             *   WebSocket APIs and between 50 and 30,000 milliseconds for HTTP APIs. The default
        ...
        internal constructor(
             ...
             * Specifies the format of the payload sent to an integration.
             *
             * Required for HTTP APIs. For HTTP APIs, supported values for Lambda proxy integrations
             * are `1.0` and `2.0` . For all other integrations, `1.0` is the only supported value.
             * To learn more, see
             * [Working with AWS Lambda proxy integrations for HTTP APIs](https://docs.aws.amazon.com/apigateway/latest/developerguide/http-api-develop-integrations-lambda.html)
             * .
             *
             ...
             * and 30,000 milliseconds for HTTP APIs.
             *
             * The default timeout is 29 seconds for WebSocket APIs and 30 seconds for HTTP APIs.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-apigatewayv2-apigatewaymanagedoverrides-integrationoverrides.html#cfn-apigatewayv2-apigatewaymanagedoverrides-integrationoverrides-timeoutinmillis)
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: IntegrationOverridesProperty
            ): software.amazon.awscdk.services.apigatewayv2.CfnApiGatewayManagedOverrides.IntegrationOverridesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface StageOverridesProperty {
        ...
        public interface Builder {
            ...
            public fun accessLogSettings(
                accessLogSettings: AccessLogSettingsProperty.Builder.() -> Unit
            )

            /**
             * @param autoDeploy Specifies whether updates to an API automatically trigger a new
             *   deployment. The default value is `true` .
             */
            ...
            public fun defaultRouteSettings(
                defaultRouteSettings: RouteSettingsProperty.Builder.() -> Unit
            )
            ...
            /**
             * @param stageVariables A map that defines the stage variables for a `Stage` . Variable
        ...
        private class BuilderImpl : Builder {
            ...
            override fun accessLogSettings(accessLogSettings: AccessLogSettingsProperty) {
                cdkBuilder.accessLogSettings(
                    accessLogSettings.let(AccessLogSettingsProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("2231515a54b96e4144859c2f13013a00add666280ae0fca11ce1fb7b967d1b65")
            override fun accessLogSettings(
                accessLogSettings: AccessLogSettingsProperty.Builder.() -> Unit
            ...
            override fun defaultRouteSettings(defaultRouteSettings: RouteSettingsProperty) {
                cdkBuilder.defaultRouteSettings(
                    defaultRouteSettings.let(RouteSettingsProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("835f35219001fb090ef2ac51dcf9833a07dfdacfd1bec35109297159c68d986a")
            override fun defaultRouteSettings(
                defaultRouteSettings: RouteSettingsProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: StageOverridesProperty
            ): software.amazon.awscdk.services.apigatewayv2.CfnApiGatewayManagedOverrides.StageOverridesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
