...
internal constructor(
     ...
     *
     * The sources are the URLs of locations on the upstream system where MediaLive pulls the
     * content from, for this input. You included these URLs in the create request.
     */
    ...
    /** Settings that apply only if the input is an Elemental Link input. */
    public open fun inputDevices(vararg __idx_ac66f0: Any): Unit =
        inputDevices(__idx_ac66f0.toList())

    /**
     * The list of input security groups (referenced by IDs) to attach to the input if the input is
     * a push type.
     */
    public open fun inputSecurityGroups(): List<String> =
        unwrap(this).getInputSecurityGroups() ?: emptyList()
    ...
    public interface Builder {
        ...
        /**
         * The list of input security groups (referenced by IDs) to attach to the input if the input
         * is a push type.
         *
         ...
         *
         * @param inputSecurityGroups The list of input security groups (referenced by IDs) to
         *   attach to the input if the input is a push type.
         */
        ...
        /**
         * The IAM role for MediaLive to assume when creating a MediaConnect input or Amazon VPC
         * input.
         *
    ...
    private class BuilderImpl(
         ...
         * @param inputDevices Settings that apply only if the input is an Elemental Link input.
         */
        override fun inputDevices(vararg inputDevices: Any): Unit =
    ...
    public interface InputSourceRequestProperty {
        ...
        public interface Builder {
             ...
             *   upstream system. The password parameter applies only if the upstream system
            ...
            /**
             * @param username The user name to connect to the upstream system. The user name
             *   applies only if the upstream system requires credentials.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: InputSourceRequestProperty
            ): software.amazon.awscdk.services.medialive.CfnInput.InputSourceRequestProperty =
    ...
    public interface InputVpcRequestProperty {
        ...
        public interface Builder {
            /**
             * @param securityGroupIds The list of up to five VPC security group IDs to attach to
             *   the input VPC network interfaces. The security groups require subnet IDs. If none
             *   are specified, MediaLive uses the VPC default security group.
             */
            ...
            /**
             * @param subnetIds The list of two VPC subnet IDs from the same VPC. You must associate
             *   subnet IDs to two unique Availability Zones.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: InputVpcRequestProperty
            ): software.amazon.awscdk.services.medialive.CfnInput.InputVpcRequestProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface InputDeviceSettingsProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: InputDeviceSettingsProperty
            ): software.amazon.awscdk.services.medialive.CfnInput.InputDeviceSettingsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface InputDeviceRequestProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: InputDeviceRequestProperty
            ): software.amazon.awscdk.services.medialive.CfnInput.InputDeviceRequestProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface InputDestinationRequestProperty {
        ...
        public interface Builder {
            /**
             * @param streamName The stream name (application name/application instance) for the
             *   location the RTMP source content will be pushed to in MediaLive.
             */
        ...
        internal constructor(
            ...
            /**
             * The stream name (application name/application instance) for the location the RTMP
             * source content will be pushed to in MediaLive.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-medialive-input-inputdestinationrequest.html#cfn-medialive-input-inputdestinationrequest-streamname)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: InputDestinationRequestProperty
            ): software.amazon.awscdk.services.medialive.CfnInput.InputDestinationRequestProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface MediaConnectFlowRequestProperty {
        /**
         * The ARN of one or two MediaConnect flows that are the sources for this MediaConnect
         * input.
         *
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: MediaConnectFlowRequestProperty
            ): software.amazon.awscdk.services.medialive.CfnInput.MediaConnectFlowRequestProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
