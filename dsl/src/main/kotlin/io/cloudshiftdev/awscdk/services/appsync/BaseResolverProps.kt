...
public interface BaseResolverProps {
     ...
     *
     * Default: - no pipeline resolver configuration An empty array | undefined sets resolver to be
     * of kind, unit
     */
    ...
    public interface Builder {
        ...
        /**
         * @param fieldName name of the GraphQL field in the given type this resolver is attached
         *   to.
         */
    ...
    internal constructor(
         ...
         * configuration of the pipeline resolver.
         *
         * Default: - no pipeline resolver configuration An empty array | undefined sets resolver to
         * be of kind, unit
         */
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: BaseResolverProps
        ): software.amazon.awscdk.services.appsync.BaseResolverProps =
