...
internal constructor(
     ...
     * or later cluster with version `&gt;1.10.1` or later of the Amazon VPC CNI add-on and
     ...
     * `https://oidc.eks.us-west-2.amazonaws.com/id/EXAMPLED539D4633E53DE1B716D3041E` . If you need
     * to remove `https://` from this output value, you can include the following code in your
     * template.
     *
    ...
    public open fun kubernetesNetworkConfig(`value`: KubernetesNetworkConfigProperty) {
        unwrap(this)
            .setKubernetesNetworkConfig(`value`.let(KubernetesNetworkConfigProperty::unwrap))
    }

    /** The Kubernetes network configuration for the cluster. */
    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("0ad3200466ba4740d3792f66a48b1a165681c20a4d21e1790d200e4ae5f3f30b")
    public open fun kubernetesNetworkConfig(
        `value`: KubernetesNetworkConfigProperty.Builder.() -> Unit
    ): Unit = kubernetesNetworkConfig(KubernetesNetworkConfigProperty(`value`))
    ...
    public open fun resourcesVpcConfig(
        `value`: ResourcesVpcConfigProperty.Builder.() -> Unit
    ): Unit = resourcesVpcConfig(ResourcesVpcConfigProperty(`value`))
    ...
    public interface Builder {
        ...
        public fun kubernetesNetworkConfig(
            kubernetesNetworkConfig: KubernetesNetworkConfigProperty.Builder.() -> Unit
        )
         ...
         * in the *Amazon EKS User Guide* . You must specify at least two subnets. You can specify
         * up to five security groups, but we recommend that you use a dedicated security group for
        ...
        public fun resourcesVpcConfig(
            resourcesVpcConfig: ResourcesVpcConfigProperty.Builder.() -> Unit
        )
         ...
         * to manage the AWS CloudFormation stack. If you don't have these permissions, there might
         * be unexpected behavior with stack-level tags propagating to the resource during resource
         * creation and update.
         *
    ...
    private class BuilderImpl(
         ...
         * @param kubernetesNetworkConfig The Kubernetes network configuration for the cluster.
         */
        override fun kubernetesNetworkConfig(
            kubernetesNetworkConfig: KubernetesNetworkConfigProperty
        ) {
            cdkBuilder.kubernetesNetworkConfig(
                kubernetesNetworkConfig.let(KubernetesNetworkConfigProperty::unwrap)
            )
        }
        ...
        override fun resourcesVpcConfig(resourcesVpcConfig: ResourcesVpcConfigProperty) {
            cdkBuilder.resourcesVpcConfig(
                resourcesVpcConfig.let(ResourcesVpcConfigProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("5fc182e569f83b4f2259bcf755a598aac7a873678fefda3a91de8d9ff379b29c")
        override fun resourcesVpcConfig(
            resourcesVpcConfig: ResourcesVpcConfigProperty.Builder.() -> Unit
    ...
    public interface AccessConfigProperty {
         ...
         *
         * If you create a cluster by using the EKS API, AWS SDKs, or AWS CloudFormation , the
         * default is `CONFIG_MAP` . If you create the cluster by using the AWS Management Console ,
         * the default value is `API_AND_CONFIG_MAP` .
         *
        ...
        public interface Builder {
            /**
             * @param authenticationMode The desired authentication mode for the cluster. If you
             *   create a cluster by using the EKS API, AWS SDKs, or AWS CloudFormation , the
             *   default is `CONFIG_MAP` . If you create the cluster by using the AWS Management
             *   Console , the default value is `API_AND_CONFIG_MAP` .
             */
            public fun authenticationMode(authenticationMode: String)

            /**
             * @param bootstrapClusterCreatorAdminPermissions Specifies whether or not the cluster
             *   creator IAM principal was set as a cluster admin access entry during cluster
        ...
        private class BuilderImpl : Builder {
             ...
             *   creation time. The default value is `true` .
             */
            override fun bootstrapClusterCreatorAdminPermissions(
                bootstrapClusterCreatorAdminPermissions: Boolean
            ) {
                cdkBuilder.bootstrapClusterCreatorAdminPermissions(
            ...
            override fun bootstrapClusterCreatorAdminPermissions(
                ...
                cdkBuilder.bootstrapClusterCreatorAdminPermissions(
                    bootstrapClusterCreatorAdminPermissions.let(IResolvable::unwrap)
                )
            }
    ...
    public interface ControlPlanePlacementProperty {
        ...
        public interface Builder {
             ...
             *   instances. This property is only used for a local cluster on an AWS Outpost.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ControlPlanePlacementProperty
            ): software.amazon.awscdk.services.eks.CfnCluster.ControlPlanePlacementProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ClusterLoggingProperty {
        /**
         * The enabled control plane logs for your cluster. All log types are disabled if the array
         * is empty.
         *
        ...
        public interface Builder {
            /**
             * @param enabledTypes The enabled control plane logs for your cluster. All log types
             *   are disabled if the array is empty.
             *
             * When updating a resource, you must include this `EnabledTypes` property if the
             * previous CloudFormation template of the resource had it.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ClusterLoggingProperty
            ): software.amazon.awscdk.services.eks.CfnCluster.ClusterLoggingProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ResourcesVpcConfigProperty {
         ...
         * the private VPC endpoint. The default value for this parameter is `false` , which
         * disables private access for your Kubernetes API server. If you disable private access and
         * you have nodes or AWS Fargate pods in the cluster, then ensure that `publicAccessCidrs`
         * includes the necessary CIDR blocks for communication with the nodes or Fargate pods. For
         * more information, see
        ...
        /**
         * Set this value to `false` to disable public access to your cluster's Kubernetes API
         * server endpoint.
         *
         * If you disable public access, your cluster's Kubernetes API server can only receive
         * requests from within the cluster VPC. The default value for this parameter is `true` ,
         * which enables public access for your Kubernetes API server. For more information, see
         * [Amazon EKS cluster endpoint access control](https://docs.aws.amazon.com/eks/latest/userguide/cluster-endpoint.html)
         * in the **Amazon EKS User Guide** .
         *
         ...
         * endpoint.
         *
         * Communication to the endpoint from addresses outside of the CIDR blocks that you specify
         * is denied. The default value is `0.0.0.0/0` . If you've disabled private endpoint access,
         * make sure that you specify the necessary CIDR blocks for every node and AWS Fargate `Pod`
         * in the cluster. For more information, see
         * [Amazon EKS cluster endpoint access control](https://docs.aws.amazon.com/eks/latest/userguide/cluster-endpoint.html)
         * in the **Amazon EKS User Guide** .
         *
         ...
         */
        public fun publicAccessCidrs(): List<String> =
            unwrap(this).getPublicAccessCidrs() ?: emptyList()
         ...
         * between Amazon EKS defaults for clusters deployed with Kubernetes. For more information,
         * see
        ...
        public interface Builder {
            /**
             * @param endpointPrivateAccess Set this value to `true` to enable private access for
             ...
             *   endpoint. The default value for this parameter is `false` , which disables private
             *   access for your Kubernetes API server. If you disable private access and you have
            ...
            /**
             * @param endpointPublicAccess Set this value to `false` to disable public access to
             *   your cluster's Kubernetes API server endpoint. If you disable public access, your
             *   cluster's Kubernetes API server can only receive requests from within the cluster
             *   VPC. The default value for this parameter is `true` , which enables public access
             *   for your Kubernetes API server. For more information, see
             *   [Amazon EKS cluster endpoint access control](https://docs.aws.amazon.com/eks/latest/userguide/cluster-endpoint.html)
             *   in the **Amazon EKS User Guide** .
             */
            ...
            /**
             * @param publicAccessCidrs The CIDR blocks that are allowed access to your cluster's
             *   public Kubernetes API server endpoint. Communication to the endpoint from addresses
             *   outside of the CIDR blocks that you specify is denied. The default value is
             *   `0.0.0.0/0` . If you've disabled private endpoint access, make sure that you
             *   specify the necessary CIDR blocks for every node and AWS Fargate `Pod` in the
            ...
            /**
             * @param securityGroupIds Specify one or more security groups for the cross-account
             *   elastic network interfaces that Amazon EKS creates to use that allow communication
             *   between your nodes and the Kubernetes control plane. If you don't specify any
             *   security groups, then familiarize yourself with the difference between Amazon EKS
            ...
            /**
             * @param subnetIds Specify subnets for your Amazon EKS nodes. Amazon EKS creates
        ...
        internal constructor(
             ...
             * server endpoint.
             *
             * If you enable private access, Kubernetes API requests from within your cluster's VPC
             * use the private VPC endpoint. The default value for this parameter is `false` , which
             * disables private access for your Kubernetes API server. If you disable private access
             * and you have nodes or AWS Fargate pods in the cluster, then ensure that
             * `publicAccessCidrs` includes the necessary CIDR blocks for communication with the
             * nodes or Fargate pods. For more information, see
             * [Amazon EKS cluster endpoint access control](https://docs.aws.amazon.com/eks/latest/userguide/cluster-endpoint.html)
             * in the **Amazon EKS User Guide** .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-eks-cluster-resourcesvpcconfig.html#cfn-eks-cluster-resourcesvpcconfig-endpointprivateaccess)
             ...
             * If you disable public access, your cluster's Kubernetes API server can only receive
             * requests from within the cluster VPC. The default value for this parameter is `true`
             * , which enables public access for your Kubernetes API server. For more information,
             * see
             * [Amazon EKS cluster endpoint access control](https://docs.aws.amazon.com/eks/latest/userguide/cluster-endpoint.html)
             * in the **Amazon EKS User Guide** .
             *
             ...
             * server endpoint.
             *
             * Communication to the endpoint from addresses outside of the CIDR blocks that you
             * specify is denied. The default value is `0.0.0.0/0` . If you've disabled private
             * endpoint access, make sure that you specify the necessary CIDR blocks for every node
             * and AWS Fargate `Pod` in the cluster. For more information, see
             * [Amazon EKS cluster endpoint access control](https://docs.aws.amazon.com/eks/latest/userguide/cluster-endpoint.html)
             * in the **Amazon EKS User Guide** .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-eks-cluster-resourcesvpcconfig.html#cfn-eks-cluster-resourcesvpcconfig-publicaccesscidrs)
             */
            override fun publicAccessCidrs(): List<String> =
                unwrap(this).getPublicAccessCidrs() ?: emptyList()
             ...
             *
             * If you don't specify any security groups, then familiarize yourself with the
             * difference between Amazon EKS defaults for clusters deployed with Kubernetes. For
             * more information, see
             * [Amazon EKS security group considerations](https://docs.aws.amazon.com/eks/latest/userguide/sec-group-reqs.html)
             * in the **Amazon EKS User Guide** .
             *
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ResourcesVpcConfigProperty
            ): software.amazon.awscdk.services.eks.CfnCluster.ResourcesVpcConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ProviderProperty {
         ...
         *
         * The KMS key must be symmetric and created in the same AWS Region as the cluster. If the
         * KMS key was created in a different account, the
         * [IAM principal](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_roles_terms-and-concepts.html)
        ...
        public interface Builder {
             ...
             *   symmetric and created in the same AWS Region as the cluster. If the KMS key was
             *   created in a different account, the
             *   [IAM principal](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_roles_terms-and-concepts.html)
             *   must have access to the KMS key. For more information, see
             *   [Allowing users in other accounts to use a KMS key](https://docs.aws.amazon.com/kms/latest/developerguide/key-policy-modifying-external-accounts.html)
             *   in the *AWS Key Management Service Developer Guide* .
        ...
        internal constructor(
             ...
             * Amazon Resource Name (ARN) or alias of the KMS key.
             *
             * The KMS key must be symmetric and created in the same AWS Region as the cluster. If
             * the KMS key was created in a different account, the
             * [IAM principal](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_roles_terms-and-concepts.html)
             * must have access to the KMS key. For more information, see
             * [Allowing users in other accounts to use a KMS key](https://docs.aws.amazon.com/kms/latest/developerguide/key-policy-modifying-external-accounts.html)
             * in the *AWS Key Management Service Developer Guide* .
    ...
    public interface LoggingProperty {
        ...
        public interface Builder {
            /**
             * @param clusterLogging The cluster control plane logging configuration for your
             *   cluster.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("6eef5ca98ad698d391f4345c1070b4d8235bd9d01892094d471af59ebc1ff719")
            override fun clusterLogging(
                clusterLogging: ClusterLoggingProperty.Builder.() -> Unit
            ): Unit = clusterLogging(ClusterLoggingProperty(clusterLogging))
    ...
    public interface OutpostConfigProperty {
        ...
        public interface Builder {
            /**
             * @param controlPlaneInstanceType The Amazon EC2 instance type that you want to use for
             *   your local Amazon EKS cluster on Outposts. Choose an instance type based on the
             ...
             * instances. The instance type can't be changed after cluster creation. The control
             * plane is not automatically scaled by Amazon EKS.
             */
            public fun controlPlaneInstanceType(controlPlaneInstanceType: String)

            /**
             * @param controlPlanePlacement An object representing the placement configuration for
             *   all the control plane instances of your local Amazon EKS cluster on an AWS Outpost.
             *   For more information, see
             *   [Capacity considerations](https://docs.aws.amazon.com/eks/latest/userguide/eks-outposts-capacity-considerations.html)
             *   in the *Amazon EKS User Guide* .
             */
            ...
            public fun controlPlanePlacement(
                controlPlanePlacement: ControlPlanePlacementProperty.Builder.() -> Unit
            )

            /**
             * @param outpostArns The ARN of the Outpost that you want to use for your local Amazon
        ...
        private class BuilderImpl : Builder {
             ...
             *   in the *Amazon EKS User Guide* .
             */
            override fun controlPlanePlacement(
                controlPlanePlacement: ControlPlanePlacementProperty
            ) {
                cdkBuilder.controlPlanePlacement(
                    controlPlanePlacement.let(ControlPlanePlacementProperty::unwrap)
                )
            }
             ...
             *   EKS cluster on Outposts. Only a single Outpost ARN is supported.
             */
            override fun outpostArns(vararg outpostArns: String): Unit =
                outpostArns(outpostArns.toList())
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-eks-cluster-outpostconfig.html#cfn-eks-cluster-outpostconfig-controlplaneinstancetype)
             */
            override fun controlPlaneInstanceType(): String =
                unwrap(this).getControlPlaneInstanceType()

            /**
             * An object representing the placement configuration for all the control plane
             * instances of your local Amazon EKS cluster on an AWS Outpost.
             *
             * For more information, see
             * [Capacity considerations](https://docs.aws.amazon.com/eks/latest/userguide/eks-outposts-capacity-considerations.html)
             * in the *Amazon EKS User Guide* .
    ...
    public interface KubernetesNetworkConfigProperty {
         ...
         *
         * If you don't specify a value, `ipv4` is used by default. You can only specify an IP
         * family when you create a cluster and can't change this value once the cluster is created.
         * If you specify `ipv6` , the VPC and subnets that you specify for cluster creation must
         * have both `IPv4` and `IPv6` CIDR blocks assigned to them. You can't specify `ipv6` for
         * clusters in China Regions.
         *
         * You can only specify `ipv6` for `1.21` and later clusters that use version `1.10.1` or
         * later of the Amazon VPC CNI add-on. If you specify `ipv6` , then ensure that your VPC
         ...
         * in the Amazon EKS User Guide. Kubernetes assigns services `IPv6` addresses from the
         * unique local address range `(fc00::/7)` . You can't specify a custom `IPv6` CIDR block.
         ...
         * block, Kubernetes assigns addresses from either the `10.100.0.0/16` or `172.20.0.0/16`
         ...
         * created a 1.21 or later cluster with version 1.10.1 or later of the Amazon VPC CNI add-on
         * and specified `ipv6` for *ipFamily* when you created the cluster. Kubernetes assigns
         * service addresses from the unique local address range ( `fc00::/7` ) because you can't
         * specify a custom IPv6 CIDR block when you create the cluster.
         *
        ...
        public interface Builder {
            /**
             * @param ipFamily Specify which IP family is used to assign Kubernetes pod and service
             *   IP addresses. If you don't specify a value, `ipv4` is used by default. You can only
             *   specify an IP family when you create a cluster and can't change this value once the
             ...
             * or later of the Amazon VPC CNI add-on. If you specify `ipv6` , then ensure that your
             * VPC meets the requirements listed in the considerations listed in
             * [Assigning IPv6 addresses to pods and services](https://docs.aws.amazon.com/eks/latest/userguide/cni-ipv6.html)
             * in the Amazon EKS User Guide. Kubernetes assigns services `IPv6` addresses from the
             ...
             *   a block, Kubernetes assigns addresses from either the `10.100.0.0/16` or
             *   `172.20.0.0/16` CIDR blocks. We recommend that you specify a block that does not
             *   overlap with resources in other networks that are peered or connected to your VPC.
            ...
            /**
             * @param serviceIpv6Cidr The CIDR block that Kubernetes pod and service IP addresses
             *   are assigned from if you created a 1.21 or later cluster with version 1.10.1 or
             *   later of the Amazon VPC CNI add-on and specified `ipv6` for *ipFamily* when you
             *   created the cluster. Kubernetes assigns service addresses from the unique local
             *   address range ( `fc00::/7` ) because you can't specify a custom IPv6 CIDR block
        ...
        internal constructor(
             ...
             * created. If you specify `ipv6` , the VPC and subnets that you specify for cluster
             * creation must have both `IPv4` and `IPv6` CIDR blocks assigned to them. You can't
             ...
             * add-on and specified `ipv6` for *ipFamily* when you created the cluster. Kubernetes
             * assigns service addresses from the unique local address range ( `fc00::/7` ) because
             * you can't specify a custom IPv6 CIDR block when you create the cluster.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-eks-cluster-kubernetesnetworkconfig.html#cfn-eks-cluster-kubernetesnetworkconfig-serviceipv6cidr)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: KubernetesNetworkConfigProperty
            ): software.amazon.awscdk.services.eks.CfnCluster.KubernetesNetworkConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface LoggingTypeConfigProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: LoggingTypeConfigProperty
            ): software.amazon.awscdk.services.eks.CfnCluster.LoggingTypeConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface EncryptionConfigProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: EncryptionConfigProperty
            ): software.amazon.awscdk.services.eks.CfnCluster.EncryptionConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
