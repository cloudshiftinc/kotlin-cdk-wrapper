...
public interface DomainAttributes {
    ...
    public interface Builder {
         ...
         * @deprecated use opensearchservice module instead
         */
        @Deprecated(message = "deprecated in CDK") public fun domainArn(domainArn: String)

        /**
         * @param domainEndpoint The domain endpoint of the Elasticsearch domain.
         * @deprecated use opensearchservice module instead
         */
        @Deprecated(message = "deprecated in CDK") public fun domainEndpoint(domainEndpoint: String)
    }
