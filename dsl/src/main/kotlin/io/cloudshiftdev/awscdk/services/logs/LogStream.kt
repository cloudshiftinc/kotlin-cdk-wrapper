...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * Normally you want to retain the log stream so you can diagnose issues from logs even
         * after a deployment that no longer includes the log stream.
         *
         * The date-based retention policy of your log group will age out the logs after a certain
         * time.
         *
         * Default: RemovalPolicy.Retain
         *
         * @param removalPolicy Determine what happens when the log stream resource is removed from
         *   the app.
         */
    ...
    public companion object {
        public fun fromLogStreamName(
            ...
            software.amazon.awscdk.services.logs.LogStream.fromLogStreamName(
