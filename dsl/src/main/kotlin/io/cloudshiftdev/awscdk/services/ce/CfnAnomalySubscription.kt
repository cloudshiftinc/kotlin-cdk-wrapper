...
internal constructor(
    ...
    public interface Builder {
         ...
         * An
         * [Expression](https://docs.aws.amazon.com/aws-cost-management/latest/APIReference/API_Expression.html)
         * object in JSON string format used to specify the anomalies that you want to generate
         * alerts for. This supports dimensions and nested expressions. The supported dimensions are
         * `ANOMALY_TOTAL_IMPACT_ABSOLUTE` and `ANOMALY_TOTAL_IMPACT_PERCENTAGE` , corresponding to
         * an anomaly’s TotalImpact and TotalImpactPercentage, respectively (see
         * [Impact](https://docs.aws.amazon.com/aws-cost-management/latest/APIReference/API_Impact.html)
         * for more details). The supported nested expression types are `AND` and `OR` . The match
         * option `GREATER_THAN_OR_EQUAL` is required. Values must be numbers between 0 and
         * 10,000,000,000 in string format.
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnAnomalySubscription
    ...
    public interface SubscriberProperty {
        ...
        public interface Builder {
            /**
             * @param address The email address or SNS Topic Amazon Resource Name (ARN), depending
             *   on the `Type` .
             */
