...
public interface BackupPlanRuleProps {
     ...
     * Default: - 7 days
     */
    public fun completionWindow(): Duration? =
     ...
     */
    public fun recoveryPointTags(): Map<String, String> =
    ...
    public interface Builder {
         ...
         *   deleted. Must be greater than `moveToColdStorageAfter`.
         */
         ...
         *   (PITR). Property `deleteAfter` defines the retention period for the backup. It is
         *   mandatory if PITR is enabled. If no value is specified, the retention period is set to
         *   35 days which is the maximum retention period supported by PITR.
         *
    ...
    internal constructor(
         ...
         * Default: - no recovery point tags.
         */
        override fun recoveryPointTags(): Map<String, String> =
            unwrap(this).getRecoveryPointTags() ?: emptyMap()
