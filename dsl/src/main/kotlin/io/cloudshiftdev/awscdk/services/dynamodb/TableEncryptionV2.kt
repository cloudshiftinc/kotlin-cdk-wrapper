...
internal constructor(
    ...
    /**  */
    public open fun replicaKeyArns(): Map<String, String> =
        unwrap(this).getReplicaKeyArns() ?: emptyMap()
    ...
    public companion object {
        public fun awsManagedKey(): TableEncryptionV2 =
            software.amazon.awscdk.services.dynamodb.TableEncryptionV2.awsManagedKey()
                .let(TableEncryptionV2::wrap)

        public fun customerManagedKey(tableKey: IKey): TableEncryptionV2 =
            software.amazon.awscdk.services.dynamodb.TableEncryptionV2.customerManagedKey(
                    tableKey.let(IKey::unwrap)
                )
                .let(TableEncryptionV2::wrap)

        public fun customerManagedKey(
            tableKey: IKey,
        ...
        public fun dynamoOwnedKey(): TableEncryptionV2 =
            software.amazon.awscdk.services.dynamodb.TableEncryptionV2.dynamoOwnedKey()
                .let(TableEncryptionV2::wrap)
