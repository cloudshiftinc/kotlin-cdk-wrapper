...
public interface MultiNodeContainer {
    ...
    public interface Builder {
        ...
        /**
         * @param endNode The index of the last node to run this container. The container is run on
         *   all nodes in the range [startNode, endNode] (inclusive)
         */
        public fun endNode(endNode: Number)

        /**
         * @param startNode The index of the first node to run this container. The container is run
         *   on all nodes in the range [startNode, endNode] (inclusive)
         */
