...
internal constructor(
    ...
    public open fun billingPeriodRange(
        `value`: BillingPeriodRangeProperty.Builder.() -> Unit
    ): Unit = billingPeriodRange(BillingPeriodRangeProperty(`value`))
    ...
    public open fun customLineItemChargeDetails(`value`: CustomLineItemChargeDetailsProperty) {
        unwrap(this)
            .setCustomLineItemChargeDetails(
                `value`.let(CustomLineItemChargeDetailsProperty::unwrap)
            )
    }
    ...
    public open fun customLineItemChargeDetails(
        `value`: CustomLineItemChargeDetailsProperty.Builder.() -> Unit
    ...
    public interface Builder {
         ...
         *
         * @param billingGroupArn The Amazon Resource Name (ARN) that references the billing group
        ...
        public fun billingPeriodRange(
            billingPeriodRange: BillingPeriodRangeProperty.Builder.() -> Unit
        )
        ...
        public fun customLineItemChargeDetails(
            customLineItemChargeDetails: CustomLineItemChargeDetailsProperty.Builder.() -> Unit
        )
         ...
         *
         * @param tags A map that contains tag keys and tag values that are attached to a custom
         *   line item.
         */
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.billingconductor.CfnCustomLineItem.Builder.create(
                scope,
                id
            )
        ...
        override fun billingPeriodRange(billingPeriodRange: BillingPeriodRangeProperty) {
            cdkBuilder.billingPeriodRange(
                billingPeriodRange.let(BillingPeriodRangeProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("19ace5344de6c360a357deb5fda8b02710864d6b1e70ccd7557683e7c24529f7")
        override fun billingPeriodRange(
            billingPeriodRange: BillingPeriodRangeProperty.Builder.() -> Unit
        ...
        override fun customLineItemChargeDetails(customLineItemChargeDetails: IResolvable) {
            cdkBuilder.customLineItemChargeDetails(
                customLineItemChargeDetails.let(IResolvable::unwrap)
            )
        }
         ...
         * @param customLineItemChargeDetails The charge details of a custom line item.
         */
        override fun customLineItemChargeDetails(
            customLineItemChargeDetails: CustomLineItemChargeDetailsProperty
        ) {
            cdkBuilder.customLineItemChargeDetails(
                customLineItemChargeDetails.let(CustomLineItemChargeDetailsProperty::unwrap)
            )
        }
        ...
        override fun customLineItemChargeDetails(
            ...
            customLineItemChargeDetails(
                CustomLineItemChargeDetailsProperty(customLineItemChargeDetails)
            )
    ...
    public interface LineItemFilterProperty {
        ...
        public interface Builder {
            /**
             * @param attribute The attribute of the line item filter. This specifies what attribute
             *   that you can filter on.
             */
            public fun attribute(attribute: String)

            /**
             * @param matchOption The match criteria of the line item filter. This parameter
             *   specifies whether not to include the resource value from the billing group total
             *   cost.
             */
            public fun matchOption(matchOption: String)

            /**
             * @param values The values of the line item filter. This specifies the values to filter
        ...
        internal constructor(
             ...
             * The match criteria of the line item filter.
             *
             * This parameter specifies whether not to include the resource value from the billing
             * group total cost.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-billingconductor-customlineitem-lineitemfilter.html#cfn-billingconductor-customlineitem-lineitemfilter-matchoption)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: LineItemFilterProperty
            ): software.amazon.awscdk.services.billingconductor.CfnCustomLineItem.LineItemFilterProperty =
    ...
    public interface CustomLineItemFlatChargeDetailsProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CustomLineItemFlatChargeDetailsProperty
            ): software.amazon.awscdk.services.billingconductor.CfnCustomLineItem.CustomLineItemFlatChargeDetailsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CustomLineItemChargeDetailsProperty {
        /**
         * A `CustomLineItemFlatChargeDetails` that describes the charge details of a flat custom
         * line item.
         *
        ...
        public interface Builder {
            /**
             * @param flat A `CustomLineItemFlatChargeDetails` that describes the charge details of
            ...
            public fun percentage(
                percentage: CustomLineItemPercentageChargeDetailsProperty.Builder.() -> Unit
            )

            /**
             * @param type The type of the custom line item that indicates whether the charge is a
             *   fee or credit.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            @JvmName("b3694dda8f7a271affa2fd567c61d74095c408451b6c1953385f3186d3e086a4")
            override fun flat(
                flat: CustomLineItemFlatChargeDetailsProperty.Builder.() -> Unit
            ...
            override fun percentage(percentage: CustomLineItemPercentageChargeDetailsProperty) {
                cdkBuilder.percentage(
                    percentage.let(CustomLineItemPercentageChargeDetailsProperty::unwrap)
                )
            }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CustomLineItemChargeDetailsProperty
            ): software.amazon.awscdk.services.billingconductor.CfnCustomLineItem.CustomLineItemChargeDetailsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface BillingPeriodRangeProperty {
        /**
         * The exclusive end billing period that defines a billing period range where a custom line
         * is applied.
         *
         ...
         */
        public fun exclusiveEndBillingPeriod(): String? =
        ...
        public interface Builder {
            /**
             * @param exclusiveEndBillingPeriod The exclusive end billing period that defines a
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: BillingPeriodRangeProperty
            ): software.amazon.awscdk.services.billingconductor.CfnCustomLineItem.BillingPeriodRangeProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CustomLineItemPercentageChargeDetailsProperty {
         ...
         */
        public fun childAssociatedResources(): List<String> =
            unwrap(this).getChildAssociatedResources() ?: emptyList()

        /**
         * The custom line item's percentage value.
         *
         * This will be multiplied against the combined value of its associated resources to
        ...
        public interface Builder {
            /**
             * @param childAssociatedResources A list of resource ARNs to associate to the
             *   percentage custom line item.
             */
            ...
            /**
             * @param percentageValue The custom line item's percentage value. This will be
             *   multiplied against the combined value of its associated resources to determine its
             *   charge value.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CustomLineItemPercentageChargeDetailsProperty
            ): software.amazon.awscdk.services.billingconductor.CfnCustomLineItem.CustomLineItemPercentageChargeDetailsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
