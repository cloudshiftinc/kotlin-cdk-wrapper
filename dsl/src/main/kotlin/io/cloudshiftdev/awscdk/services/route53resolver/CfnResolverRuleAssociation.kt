...
internal constructor(
    ...
    /**
     * The name of an association between a resolver rule and a VPC, such as `test.example.com in
     * beta VPC` .
     */
    ...
    public interface Builder {
         ...
         *
         * @param resolverRuleId The ID of the Resolver rule that you associated with the VPC that
         *   is specified by `VPCId` .
         */
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnResolverRuleAssociation
        ): software.amazon.awscdk.services.route53resolver.CfnResolverRuleAssociation =
            wrapped.cdkObject
    }
}
