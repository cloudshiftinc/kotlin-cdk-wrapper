...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param netmaskLength The netmask length of the CIDR you would like to allocate from the
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.ec2.CfnIPAMAllocation =
            cdkBuilder.build()
    }
