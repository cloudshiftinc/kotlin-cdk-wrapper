...
internal constructor(
    ...
    public interface AggregateConfigurationProperty {
         ...
         * high-availability (HA) pair has one aggregate. The names of the aggregates map to the
         * names of the aggregates in the ONTAP CLI and REST API. For FlexVols, there will always be
         * a single entry.
         *
         ...
         * aggregate.
         *
         * This field is optional when creating a FlexGroup volume. If unspecified, the default
         * value will be 8. This field cannot be provided when creating a FlexVol volume.
         *
        ...
        public interface Builder {
            /**
             * @param aggregates The list of aggregates that this volume resides on. Aggregates are
             *   storage pools which make up your primary storage tier. Each high-availability (HA)
            ...
            /**
             * @param constituentsPerAggregate Used to explicitly set the number of constituents
             *   within the FlexGroup per storage aggregate. This field is optional when creating a
             *   FlexGroup volume. If unspecified, the default value will be 8. This field cannot be
        ...
        private class BuilderImpl : Builder {
             ...
             *   adding more volumes.
             */
            override fun aggregates(vararg aggregates: String): Unit =
        ...
        internal constructor(
             ...
             * Aggregates are storage pools which make up your primary storage tier. Each
             * high-availability (HA) pair has one aggregate. The names of the aggregates map to the
             * names of the aggregates in the ONTAP CLI and REST API. For FlexVols, there will
             * always be a single entry.
             *
             * Amazon FSx responds with an HTTP status code 400 (Bad Request) for the following
             * conditions:
             * * The strings in the value of `Aggregates` are not are not formatted as `aggrX` ,
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-fsx-volume-aggregateconfiguration.html#cfn-fsx-volume-aggregateconfiguration-constituentsperaggregate)
             */
            override fun constituentsPerAggregate(): Number? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AggregateConfigurationProperty
            ): software.amazon.awscdk.services.fsx.CfnVolume.AggregateConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SnaplockRetentionPeriodProperty {
         ...
         *
         * The default retention period must be greater than or equal to the minimum retention
         * period and less than or equal to the maximum retention period.
         *
        ...
        public interface Builder {
            /**
             * @param defaultRetention The retention period assigned to a write once, read many
             *   (WORM) file by default if an explicit retention period is not set for an FSx for
             *   ONTAP SnapLock volume. The default retention period must be greater than or equal
             *   to the minimum retention period and less than or equal to the maximum retention
             *   period.
             */
            ...
            public fun defaultRetention(
                defaultRetention: RetentionPeriodProperty.Builder.() -> Unit
            )

            /**
             * @param maximumRetention The longest retention period that can be assigned to a WORM
             *   file on an FSx for ONTAP SnapLock volume.
             */
            ...
            public fun maximumRetention(
                maximumRetention: RetentionPeriodProperty.Builder.() -> Unit
            )

            /**
             * @param minimumRetention The shortest retention period that can be assigned to a WORM
             *   file on an FSx for ONTAP SnapLock volume.
             */
            ...
            public fun minimumRetention(
                minimumRetention: RetentionPeriodProperty.Builder.() -> Unit
            )
        }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SnaplockRetentionPeriodProperty
            ): software.amazon.awscdk.services.fsx.CfnVolume.SnaplockRetentionPeriodProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface TieringPolicyProperty {
         ...
         * * `ALL` - moves all user data blocks in both the active file system and Snapshot copies
         *   to the storage pool tier.
        ...
        public interface Builder {
            /**
             * @param coolingPeriod Specifies the number of days that user data in a volume must
             *   remain inactive before it is considered "cold" and moved to the capacity pool. Used
             *   with the `AUTO` and `SNAPSHOT_ONLY` tiering policies. Enter a whole number between
             ...
             *   `SNAPSHOT_ONLY` .
             * * `SNAPSHOT_ONLY` - moves cold snapshots to the capacity pool storage tier.
             * * `AUTO` - moves cold user data and snapshots to the capacity pool storage tier based
        ...
        internal constructor(
             ...
             * it is considered "cold" and moved to the capacity pool.
             *
             * Used with the `AUTO` and `SNAPSHOT_ONLY` tiering policies. Enter a whole number
             * between 2 and 183. Default values are 31 days for `AUTO` and 2 days for
             * `SNAPSHOT_ONLY` .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-fsx-volume-tieringpolicy.html#cfn-fsx-volume-tieringpolicy-coolingperiod)
             */
    ...
    public interface OriginSnapshotProperty {
         ...
         *   throughput. However, the origin snapshot can't be deleted if there is a volume using
         *   its copied data.
        ...
        public interface Builder {
            /**
             * @param copyStrategy Specifies the strategy used when copying data from the snapshot
             *   to the new volume.
             * * `CLONE` - The new volume references the data in the origin snapshot. Cloning a
             *   snapshot is faster than copying data from the snapshot to a new volume and doesn't
            ...
            /**
             * @param snapshotArn Specifies the snapshot to use when creating an OpenZFS volume from
             *   a snapshot.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: OriginSnapshotProperty
            ): software.amazon.awscdk.services.fsx.CfnVolume.OriginSnapshotProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface RetentionPeriodProperty {
         ...
         * forever. If you set it to `UNSPECIFIED` , the files are retained until you set an
        ...
        public interface Builder {
            /**
             * @param type Defines the type of time for the retention period of an FSx for ONTAP
             *   SnapLock volume. Set it to one of the valid types. If you set it to `INFINITE` ,
             *   the files are retained forever. If you set it to `UNSPECIFIED` , the files are
             *   retained until you set an explicit retention period.
             */
            public fun type(type: String)
        ...
        internal constructor(
             ...
             * volume.
             *
             * Set it to one of the valid types. If you set it to `INFINITE` , the files are
             * retained forever. If you set it to `UNSPECIFIED` , the files are retained until you
    ...
    public interface AutocommitPeriodProperty {
        ...
        public interface Builder {
            /**
             * @param type Defines the type of time for the autocommit period of a file in an FSx
             *   for ONTAP SnapLock volume. Setting this value to `NONE` disables autocommit. The
             *   default value is `NONE` .
             */
            public fun type(type: String)

            /**
             * @param value Defines the amount of time for the autocommit period of a file in an FSx
        ...
        internal constructor(
            ...
            /**
             * Defines the type of time for the autocommit period of a file in an FSx for ONTAP
             * SnapLock volume.
             *
             * Setting this value to `NONE` disables autocommit. The default value is `NONE` .
             *
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AutocommitPeriodProperty
            ): software.amazon.awscdk.services.fsx.CfnVolume.AutocommitPeriodProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface OpenZFSConfigurationProperty {
         ...
         * specify one or more tags when creating the snapshot, no tags are copied from the volume,
         ...
         * quota limits the amount of storage that the volume can consume to the configured amount,
         * but does not guarantee the space will be available on the parent volume. To guarantee
         * quota space, you must also set `StorageCapacityReservationGiB` . To *not* specify a
         * storage capacity quota, set this to `-1` .
         *
         * For more information, see
         ...
         * more storage than the parent volume has. To *not* specify a storage capacity reservation,
         * set this to `0` or `-1` . For more information, see
         * [Volume properties](https://docs.aws.amazon.com/fsx/latest/OpenZFSGuide/managing-volumes.html#volume-properties)
         * in the *Amazon FSx for OpenZFS User Guide* .
         *
        ...
        public interface Builder {
             ...
             *   should be copied to snapshots. This value defaults to `false` . If it's set to
             *   `true` , all tags for the volume are copied to snapshots where the user doesn't
             *   specify tags. If this value is `true` , and you specify one or more tags, only the
            ...
            /**
             * @param nfsExports The configuration object for mounting a Network File System (NFS)
             *   file system.
             */
            ...
            /**
             * @param options To delete the volume's child volumes, snapshots, and clones, use the
            ...
            /**
             * @param originSnapshot The configuration object that specifies the snapshot to use as
            ...
            /**
             * @param parentVolumeId The ID of the volume to use as the parent volume of the volume
            ...
            /**
             * @param recordSizeKiB Specifies the suggested block size for a volume in a ZFS
             *   dataset, in kibibytes (KiB). Valid values are 4, 8, 16, 32, 64, 128, 256, 512, or
             *   1024 KiB. The default is 128 KiB. We recommend using the default setting for the
             *   majority of use cases. Generally, workloads that write in fixed small or large
            ...
            /**
             * @param storageCapacityQuotaGiB Sets the maximum storage size in gibibytes (GiB) for
             *   the volume. You can specify a quota that is larger than the storage on the parent
             *   volume. A volume quota limits the amount of storage that the volume can consume to
             *   the configured amount, but does not guarantee the space will be available on the
             *   parent volume. To guarantee quota space, you must also set
             *   `StorageCapacityReservationGiB` . To *not* specify a storage capacity quota, set
             *   this to `-1` .
             *
             * For more information, see
             * [Volume properties](https://docs.aws.amazon.com/fsx/latest/OpenZFSGuide/managing-volumes.html#volume-properties)
            ...
            /**
             * @param storageCapacityReservationGiB Specifies the amount of storage in gibibytes
             *   (GiB) to reserve from the parent volume. Setting `StorageCapacityReservationGiB`
             *   guarantees that the specified amount of storage space on the parent volume will
             *   always be available for the volume. You can't reserve more storage than the parent
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("bc249c4485e28a5183f8f7c874ed1490b18c693d1ab99d945c20696f0af2a6cf")
            override fun originSnapshot(
                originSnapshot: OriginSnapshotProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * and you specify one or more tags, only the specified tags are copied to snapshots. If
             * you specify one or more tags when creating the snapshot, no tags are copied from the
             ...
             * workloads that write in fixed small or large record sizes may benefit from setting a
             * custom record size, like database workloads (small record size) or media streaming
             ...
             * Sets the maximum storage size in gibibytes (GiB) for the volume.
             *
             * You can specify a quota that is larger than the storage on the parent volume. A
             * volume quota limits the amount of storage that the volume can consume to the
             * configured amount, but does not guarantee the space will be available on the parent
             ...
             * Specifies the amount of storage in gibibytes (GiB) to reserve from the parent volume.
             *
             * Setting `StorageCapacityReservationGiB` guarantees that the specified amount of
             * storage space on the parent volume will always be available for the volume. You can't
             * reserve more storage than the parent volume has. To *not* specify a storage capacity
    ...
    public interface OntapConfigurationProperty {
         ...
         * all automatic and user-initiated backups where the user doesn't specify tags. If this
         * value is true, and you specify one or more tags, only the specified tags are copied to
         * backups. If you specify one or more tags when creating a user-initiated backup, no tags
         ...
         *
         * For more information, see
         * [Volume types](https://docs.aws.amazon.com/fsx/latest/ONTAPGuide/volume-types) in the
         ...
         *
         * If a volume's security style is not specified, it is automatically set to the root
         * volume's security style. The security style determines the type of permissions that FSx
         * for ONTAP uses to control data access. For more information, see
         * [Volume security style](https://docs.aws.amazon.com/fsx/latest/ONTAPGuide/volume-security-style)
         ...
         *   NFS clients, and an application accessing the data uses a UNIX user as the service
         *   account.
         * * `NTFS` if the file system is managed by a Windows administrator, the majority of users
         *   are SMB clients, and an application accessing the data uses a Windows user as the
         *   service account.
         * * `MIXED` This is an advanced setting. For more information, see the topic
         *   [What the security styles and their effects are](https://docs.aws.amazon.com/https://docs.netapp.com/us-en/ontap/nfs-admin/security-styles-their-effects-concept.html)
         ...
         *   minutes past the hour. A maximum of two daily snapshots taken Monday through Saturday
         *   at 10 minutes after midnight. A maximum of two weekly snapshots taken every Sunday at
         ...
         * * `none` : This policy does not take any snapshots. This policy can be assigned to
         *   volumes to prevent automatic snapshots from being taken.
         *
         ...
         * volume's data between the file system's primary storage and capacity pool storage based
         * on your access patterns.
         *
         * Valid tiering policies are the following:
         * * `SNAPSHOT_ONLY` - (Default value) moves cold snapshots to the capacity pool storage
         *   tier.
         * * `AUTO` - moves cold user data and snapshots to the capacity pool storage tier based on
         *   your access patterns.
         * * `ALL` - moves all user data blocks in both the active file system and Snapshot copies
         ...
         *
         * FSx for ONTAP offers two styles of volumes that you can use for different purposes,
        ...
        public interface Builder {
            /**
             * @param aggregateConfiguration Used to specify the configuration options for an FSx
             *   for ONTAP volume's storage aggregate or aggregates.
             */
            ...
            public fun aggregateConfiguration(
                aggregateConfiguration: AggregateConfigurationProperty.Builder.() -> Unit
            )

            /**
             * @param copyTagsToBackups A boolean flag indicating whether tags for the volume should
             *   be copied to backups. This value defaults to false. If it's set to true, all tags
             *   for the volume are copied to all automatic and user-initiated backups where the
             *   user doesn't specify tags. If this value is true, and you specify one or more tags,
             *   only the specified tags are copied to backups. If you specify one or more tags when
             *   creating a user-initiated backup, no tags are copied from the volume, regardless of
             *   this value.
             */
             ...
             *   mounted. The `JunctionPath` must have a leading forward slash, such as `/vol3` .
             */
            public fun junctionPath(junctionPath: String)

            /**
             * @param ontapVolumeType Specifies the type of volume you are creating. Valid values
             *   are the following:.
             * * `RW` specifies a read/write volume. `RW` is the default.
            ...
            /**
             * @param securityStyle Specifies the security style for the volume. If a volume's
             *   security style is not specified, it is automatically set to the root volume's
             *   security style. The security style determines the type of permissions that FSx for
             *   ONTAP uses to control data access. For more information, see
             *   [Volume security style](https://docs.aws.amazon.com/fsx/latest/ONTAPGuide/volume-security-style)
             *   in the *Amazon FSx for NetApp ONTAP User Guide* . Specify one of the following
             *   values:
             * * `UNIX` if the file system is managed by a UNIX administrator, the majority of users
             *   are NFS clients, and an application accessing the data uses a UNIX user as the
             *   service account.
             * * `NTFS` if the file system is managed by a Windows administrator, the majority of
             *   users are SMB clients, and an application accessing the data uses a Windows user as
             *   the service account.
             * * `MIXED` This is an advanced setting. For more information, see the topic
             *   [What the security styles and their effects are](https://docs.aws.amazon.com/https://docs.netapp.com/us-en/ontap/nfs-admin/security-styles-their-effects-concept.html)
             *   in the NetApp Documentation Center.
            ...
            /**
             * @param sizeInMegabytes Use `SizeInBytes` instead. Specifies the size of the volume,
             *   in megabytes (MB), that you are creating.
             */
            ...
            public fun snaplockConfiguration(
                snaplockConfiguration: SnaplockConfigurationProperty.Builder.() -> Unit
            )

            /**
             * @param snapshotPolicy Specifies the snapshot policy for the volume. There are three
             *   built-in snapshot policies:.
             * * `default` : This is the default policy. A maximum of six hourly snapshots taken
             *   five minutes past the hour. A maximum of two daily snapshots taken Monday through
             *   Saturday at 10 minutes after midnight. A maximum of two weekly snapshots taken
             ...
             *   compaction storage efficiency features on the volume, or set to false to disable
             *   them. `StorageEfficiencyEnabled` is required when creating a `RW` volume (
            ...
            /**
             * @param tieringPolicy Describes the data tiering policy for an ONTAP volume. When
             *   enabled, Amazon FSx for ONTAP's intelligent tiering automatically transitions a
             *   volume's data between the file system's primary storage and capacity pool storage
            ...
            /**
             * @param volumeStyle Use to specify the style of an ONTAP volume. FSx for ONTAP offers
             *   two styles of volumes that you can use for different purposes, FlexVol and
             *   FlexGroup volumes. For more information, see
             *   [Volume styles](https://docs.aws.amazon.com/fsx/latest/ONTAPGuide/volume-styles.html)
             *   in the Amazon FSx for NetApp ONTAP User Guide.
             */
        ...
        private class BuilderImpl : Builder {
             ...
             *   for ONTAP volume's storage aggregate or aggregates.
             */
            override fun aggregateConfiguration(
                aggregateConfiguration: AggregateConfigurationProperty
            ) {
                cdkBuilder.aggregateConfiguration(
                    aggregateConfiguration.let(AggregateConfigurationProperty::unwrap)
                )
            }
             ...
             *   SnapLock volume.
             */
            override fun snaplockConfiguration(
                snaplockConfiguration: SnaplockConfigurationProperty
            ) {
                cdkBuilder.snaplockConfiguration(
                    snaplockConfiguration.let(SnaplockConfigurationProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("69ed72f068811bbd74787e358b6614189a2ac6deb0d6047f15850ec03a5458df")
            override fun tieringPolicy(
                tieringPolicy: TieringPolicyProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             *
             * If a volume's security style is not specified, it is automatically set to the root
             * volume's security style. The security style determines the type of permissions that
             * FSx for ONTAP uses to control data access. For more information, see
             * [Volume security style](https://docs.aws.amazon.com/fsx/latest/ONTAPGuide/volume-security-style)
             * in the *Amazon FSx for NetApp ONTAP User Guide* . Specify one of the following
             * values:
             * * `UNIX` if the file system is managed by a UNIX administrator, the majority of users
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-fsx-volume-ontapconfiguration.html#cfn-fsx-volume-ontapconfiguration-storageefficiencyenabled)
             */
            override fun storageEfficiencyEnabled(): String? =
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-fsx-volume-ontapconfiguration.html#cfn-fsx-volume-ontapconfiguration-storagevirtualmachineid)
             */
            override fun storageVirtualMachineId(): String =
    ...
    public interface SnaplockConfigurationProperty {
         ...
         *
         * After it is set, it can't be changed. You can choose one of the following retention
         * modes:
         * * `COMPLIANCE` : Files transitioned to write once, read many (WORM) on a Compliance
         *   volume can't be deleted until their retention periods expire. This retention mode is
         *   used to address government or industry-specific mandates or to protect against
         ...
         *   retention mode is used to advance an organization's data integrity and internal
        ...
        public interface Builder {
             ...
             *   SnapLock volume. The default value is `false` . If you set `AuditLogVolume` to
             *   `true` , the SnapLock volume is created as an audit log volume. The minimum
             *   retention period for an audit log volume is six months.
             *
             * For more information, see
             * [SnapLock audit log volumes](https://docs.aws.amazon.com/fsx/latest/ONTAPGuide/how-snaplock-works.html#snaplock-audit-log-volume)
             * .
            ...
            /**
             * @param autocommitPeriod The configuration object for setting the autocommit period of
            ...
            public fun autocommitPeriod(
                autocommitPeriod: AutocommitPeriodProperty.Builder.() -> Unit
            )

            /**
             * @param privilegedDelete Enables, disables, or permanently disables privileged delete
             *   on an FSx for ONTAP SnapLock Enterprise volume. Enabling privileged delete allows
             *   SnapLock administrators to delete write once, read many (WORM) files even if they
             *   have active retention periods. `PERMANENTLY_DISABLED` is a terminal state. If
             *   privileged delete is permanently disabled on a SnapLock volume, you can't re-enable
            ...
            /**
             * @param retentionPeriod Specifies the retention period of an FSx for ONTAP SnapLock
             *   volume.
             */
            ...
            public fun retentionPeriod(
                retentionPeriod: SnaplockRetentionPeriodProperty.Builder.() -> Unit
            )
             ...
             *   .
             * * `ENTERPRISE` : Files transitioned to WORM on an Enterprise volume can be deleted by
             *   authorized users before their retention periods expire using privileged delete.
             *   This retention mode is used to advance an organization's data integrity and
            ...
            /**
             * @param volumeAppendModeEnabled Enables or disables volume-append mode on an FSx for
             *   ONTAP SnapLock volume. Volume-append mode allows you to create WORM-appendable
             *   files and write data to them incrementally. The default value is `false` .
             *
             * For more information, see
             * [Volume-append mode](https://docs.aws.amazon.com/fsx/latest/ONTAPGuide/worm-state.html#worm-state-append)
             * .
        ...
        private class BuilderImpl : Builder {
            ...
            override fun retentionPeriod(retentionPeriod: SnaplockRetentionPeriodProperty) {
                cdkBuilder.retentionPeriod(
                    retentionPeriod.let(SnaplockRetentionPeriodProperty::unwrap)
                )
            }
        ...
        internal constructor(
             ...
             *
             * The default value is `false` . If you set `AuditLogVolume` to `true` , the SnapLock
             * volume is created as an audit log volume. The minimum retention period for an audit
            ...
            /**
             * Enables, disables, or permanently disables privileged delete on an FSx for ONTAP
             * SnapLock Enterprise volume.
             *
             * Enabling privileged delete allows SnapLock administrators to delete write once, read
             * many (WORM) files even if they have active retention periods. `PERMANENTLY_DISABLED`
             * is a terminal state. If privileged delete is permanently disabled on a SnapLock
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-fsx-volume-snaplockconfiguration.html#cfn-fsx-volume-snaplockconfiguration-volumeappendmodeenabled)
             */
            override fun volumeAppendModeEnabled(): String? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SnaplockConfigurationProperty
            ): software.amazon.awscdk.services.fsx.CfnVolume.SnaplockConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
