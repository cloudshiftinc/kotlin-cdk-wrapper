...
internal constructor(
    ...
    /**  */
    public open fun attrDetails(): IResolvable =
        unwrap(this).getAttrDetails().let(IResolvable::wrap)
    ...
    public open fun configuration(
        `value`: IdentitySourceConfigurationProperty.Builder.() -> Unit
     ...
     * [io.cloudshiftdev.awscdk.services.verifiedpermissions.CfnIdentitySource].
     */
    @CdkDslMarker
    public interface Builder {
        ...
        public fun configuration(
            configuration: IdentitySourceConfigurationProperty.Builder.() -> Unit
        )
         ...
         *
         * @param principalEntityType Specifies the namespace and data type of the principals
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.verifiedpermissions.CfnIdentitySource.Builder.create(
                scope,
                id
            )
    ...
    public interface IdentitySourceConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param cognitoUserPoolConfiguration A structure that contains configuration
             *   information used when creating or updating an identity source that represents a
             *   connection to an Amazon Cognito user pool used as an identity provider for Verified
             *   Permissions .
             */
            ...
            public fun cognitoUserPoolConfiguration(
                cognitoUserPoolConfiguration:
                    CognitoUserPoolConfigurationProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun cognitoUserPoolConfiguration(cognitoUserPoolConfiguration: IResolvable) {
                cdkBuilder.cognitoUserPoolConfiguration(
                    cognitoUserPoolConfiguration.let(IResolvable::unwrap)
                )
            }
             ...
             *   Permissions .
             */
            override fun cognitoUserPoolConfiguration(
                cognitoUserPoolConfiguration: CognitoUserPoolConfigurationProperty
            ) {
                cdkBuilder.cognitoUserPoolConfiguration(
                    cognitoUserPoolConfiguration.let(CognitoUserPoolConfigurationProperty::unwrap)
                )
            }
            ...
            override fun cognitoUserPoolConfiguration(
                ...
                cognitoUserPoolConfiguration(
                    CognitoUserPoolConfigurationProperty(cognitoUserPoolConfiguration)
                )
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: IdentitySourceConfigurationProperty
            ): software.amazon.awscdk.services.verifiedpermissions.CfnIdentitySource.IdentitySourceConfigurationProperty =
    ...
    public interface IdentitySourceDetailsProperty {
        ...
        public interface Builder {
            /**
             * @param clientIds The application client IDs associated with the specified Amazon
             ...
             *   endpoint. This is a URL string in the following format. This URL replaces the
             *   placeholders for both the AWS Region and the user pool identifier with those
            ...
            /**
             * @param openIdIssuer A string that identifies the type of OIDC service represented by
             *   this identity source. At this time, the only valid value is `cognito` .
             */
        ...
        internal constructor(
             ...
             * The well-known URL that points to this user pool's OIDC discovery endpoint.
             *
             * This is a URL string in the following format. This URL replaces the placeholders for
             * both the AWS Region and the user pool identifier with those appropriate for this user
             * pool.
             *
             * `https://cognito-idp. *&lt;region&gt;* .amazonaws.com/ *&lt;user-pool-id&gt;*
             * /.well-known/openid-configuration`
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: IdentitySourceDetailsProperty
            ): software.amazon.awscdk.services.verifiedpermissions.CfnIdentitySource.IdentitySourceDetailsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CognitoUserPoolConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param clientIds The unique application client IDs that are associated with the
             *   specified Amazon Cognito user pool. Example: `"ClientIds":
             *   ["&amp;ExampleCogClientId;"]`
             */
            public fun clientIds(clientIds: List<String>)
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CognitoUserPoolConfigurationProperty
            ): software.amazon.awscdk.services.verifiedpermissions.CfnIdentitySource.CognitoUserPoolConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
