...
public interface CloudWatchDimension {
    ...
    public interface Builder {
        /**
         * @param defaultValue The default value of the dimension that is published to Amazon
        ...
        /**
         * @param source The place where Amazon SES finds the value of a dimension to publish to
         *   Amazon CloudWatch.
         */
    ...
    private class BuilderImpl : Builder {
        ...
        public fun build(): software.amazon.awscdk.services.ses.CloudWatchDimension =
            cdkBuilder.build()
    }
