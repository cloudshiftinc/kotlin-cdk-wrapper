...
internal constructor(
    ...
    public open fun quickConnectConfig(
        `value`: QuickConnectConfigProperty.Builder.() -> Unit
    ): Unit = quickConnectConfig(QuickConnectConfigProperty(`value`))
    ...
    public interface Builder {
        ...
        public fun quickConnectConfig(
            quickConnectConfig: QuickConnectConfigProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
        ...
        override fun quickConnectConfig(quickConnectConfig: QuickConnectConfigProperty) {
            cdkBuilder.quickConnectConfig(
                quickConnectConfig.let(QuickConnectConfigProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("66facc532a2e04b3aeb9c446901372563a69d59c013e8aab2c125b1fdcf2ec41")
        override fun quickConnectConfig(
            quickConnectConfig: QuickConnectConfigProperty.Builder.() -> Unit
        ...
        public fun build(): software.amazon.awscdk.services.connect.CfnQuickConnect =
            cdkBuilder.build()
    }
    ...
    public interface PhoneNumberQuickConnectConfigProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: PhoneNumberQuickConnectConfigProperty
            ): software.amazon.awscdk.services.connect.CfnQuickConnect.PhoneNumberQuickConnectConfigProperty =
    ...
    public interface QuickConnectConfigProperty {
         ...
         * The type of quick connect.
         *
         * In the Amazon Connect console, when you create a quick connect, you are prompted to
         * assign one of the following types: Agent (USER), External (PHONE_NUMBER), or Queue
         * (QUEUE).
         *
        ...
        public interface Builder {
            /**
             * @param phoneConfig The phone configuration. This is required only if QuickConnectType
             *   is PHONE_NUMBER.
             */
            ...
            public fun phoneConfig(
                phoneConfig: PhoneNumberQuickConnectConfigProperty.Builder.() -> Unit
            )

            /**
             * @param queueConfig The queue configuration. This is required only if QuickConnectType
             *   is QUEUE.
             */
            ...
            /**
             * @param quickConnectType The type of quick connect. In the Amazon Connect console,
             *   when you create a quick connect, you are prompted to assign one of the following
             *   types: Agent (USER), External (PHONE_NUMBER), or Queue (QUEUE).
             */
            public fun quickConnectType(quickConnectType: String)

            /**
             * @param userConfig The user configuration. This is required only if QuickConnectType
             *   is USER.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            override fun phoneConfig(phoneConfig: PhoneNumberQuickConnectConfigProperty) {
                cdkBuilder.phoneConfig(
                    phoneConfig.let(PhoneNumberQuickConnectConfigProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("b017bd39c984da0288194f7ee2258d3baea9f333ac105fbfca15bd258043ebac")
            override fun queueConfig(
                queueConfig: QueueQuickConnectConfigProperty.Builder.() -> Unit
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("841daf7430e31b2285dd0f375fab0519cc1a3755c3297f1c297f9761ce90cf40")
            override fun userConfig(
                userConfig: UserQuickConnectConfigProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: QuickConnectConfigProperty
            ): software.amazon.awscdk.services.connect.CfnQuickConnect.QuickConnectConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface UserQuickConnectConfigProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: UserQuickConnectConfigProperty
            ): software.amazon.awscdk.services.connect.CfnQuickConnect.UserQuickConnectConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface QueueQuickConnectConfigProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: QueueQuickConnectConfigProperty
            ): software.amazon.awscdk.services.connect.CfnQuickConnect.QueueQuickConnectConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
