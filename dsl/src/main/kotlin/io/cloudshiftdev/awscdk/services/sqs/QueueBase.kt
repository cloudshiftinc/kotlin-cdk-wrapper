...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.sqs.QueueBase,
     ...
     * * sqs:GetQueueUrl
     *
     * If encryption is used, permission to use the key to decrypt the contents of the queue will
    ...
    public override fun metricApproximateAgeOfOldestMessage(
        props: MetricOptions.Builder.() -> Unit
    ...
    public override fun metricApproximateNumberOfMessagesDelayed(
        props: MetricOptions.Builder.() -> Unit
    ...
    public override fun metricApproximateNumberOfMessagesNotVisible(
        props: MetricOptions.Builder.() -> Unit
    ...
    public override fun metricApproximateNumberOfMessagesVisible(
        props: MetricOptions.Builder.() -> Unit
    ...
    public override fun metricNumberOfEmptyReceives(
        props: MetricOptions.Builder.() -> Unit
    ...
    public override fun metricNumberOfMessagesDeleted(
        props: MetricOptions.Builder.() -> Unit
    ...
    public override fun metricNumberOfMessagesReceived(
        props: MetricOptions.Builder.() -> Unit
    ...
    public override fun metricNumberOfMessagesSent(
        props: MetricOptions.Builder.() -> Unit
    ...
    internal constructor(
        internal val cdkObject: software.amazon.awscdk.services.sqs.QueueBase,
    ) : QueueBase(cdkObject)
