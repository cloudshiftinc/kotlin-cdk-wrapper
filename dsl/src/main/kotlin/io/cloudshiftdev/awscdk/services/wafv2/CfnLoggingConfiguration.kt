...
internal constructor(
    ...
    /**
     * Indicates whether the logging configuration was created by AWS Firewall Manager , as part of
     * an AWS WAF policy configuration.
     *
    ...
    public interface Builder {
         ...
         *
         * @param logDestinationConfigs The logging destination configuration that you want to
         ...
         *
         * @param resourceArn The Amazon Resource Name (ARN) of the web ACL that you want to
    ...
    public interface LabelNameConditionProperty {
        ...
        public interface Builder {
             ...
             *   condition. This must be a fully qualified label name. Fully qualified labels have a
             *   prefix, optional namespaces, and label name. The prefix identifies the rule group
             *   or web ACL context of the rule that added the label.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: LabelNameConditionProperty
            ): software.amazon.awscdk.services.wafv2.CfnLoggingConfiguration.LabelNameConditionProperty =
    ...
    public interface FilterProperty {
        ...
        public interface Builder {
            /**
             * @param behavior How to handle logs that satisfy the filter's conditions and
             *   requirement.
             */
            ...
            /**
             * @param requirement Logic to apply to the filtering conditions. You can specify that,
             *   in order to satisfy the filter, a log must match all conditions or must match at
             *   least one condition.
             */
        ...
        internal constructor(
             ...
             * Logic to apply to the filtering conditions.
             *
             * You can specify that, in order to satisfy the filter, a log must match all conditions
    ...
    public interface LoggingFilterProperty {
        ...
        public interface Builder {
            /**
             * @param defaultBehavior Default handling for logs that don't match any of the
    ...
    public interface ConditionProperty {
         ...
         *
         * This is the fully qualified label name that a log record must contain in order to meet
         * the condition. Fully qualified labels have a prefix, optional namespaces, and label name.
        ...
        public interface Builder {
            /**
             * @param actionCondition A single action condition. This is the action setting that a
            ...
            /**
             * @param labelNameCondition A single label name condition. This is the fully qualified
             *   label name that a log record must contain in order to meet the condition. Fully
             *   qualified labels have a prefix, optional namespaces, and label name. The prefix
            ...
            public fun labelNameCondition(
                labelNameCondition: LabelNameConditionProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun actionCondition(
                actionCondition: ActionConditionProperty.Builder.() -> Unit
            ...
            override fun labelNameCondition(labelNameCondition: LabelNameConditionProperty) {
                cdkBuilder.labelNameCondition(
                    labelNameCondition.let(LabelNameConditionProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("5c2ef676ac8836bd83691849c0052441a394f30aa7e8af8a052f1c99f452d30c")
            override fun labelNameCondition(
                labelNameCondition: LabelNameConditionProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * A single action condition.
             *
             * This is the action setting that a log record must contain in order to meet the
             * condition.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-wafv2-loggingconfiguration-condition.html#cfn-wafv2-loggingconfiguration-condition-actioncondition)
             */
             ...
             * A single label name condition.
             *
             * This is the fully qualified label name that a log record must contain in order to
             * meet the condition. Fully qualified labels have a prefix, optional namespaces, and
    ...
    public interface ActionConditionProperty {
        ...
        public interface Builder {
             ...
             *   condition. This is the action that AWS WAF applied to the web request.
             *
             * For rule groups, this is either the configured rule action setting, or if you've
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ActionConditionProperty
            ): software.amazon.awscdk.services.wafv2.CfnLoggingConfiguration.ActionConditionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface FieldToMatchProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param method Redact the indicated HTTP method. The method indicates the type of
             *   operation that the request is asking the origin to perform.
             */
            public fun method(method: Any)

            /**
             * @param queryString Redact the query string. This is the part of a URL that appears
             *   after a `?` character, if any.
             */
            public fun queryString(queryString: Any)

            /**
             * @param singleHeader Redact a single header. Provide the name of the header to
            ...
            /**
             * @param uriPath Redact the request URI path. This is the part of the web request that
