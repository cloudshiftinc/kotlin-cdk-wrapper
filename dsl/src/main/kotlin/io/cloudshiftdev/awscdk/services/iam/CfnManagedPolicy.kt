...
internal constructor(
     ...
     * [ISO 8601 date-time format](https://docs.aws.amazon.com/http://www.iso.org/iso/iso8601) ,
     ...
     * created. When a policy has more than one version, this field contains the date and time when
     * the most recent policy version was created.
     */
    ...
    public interface Builder {
         ...
         *
         * @param policyDocument The JSON policy document that you want to use as the content for
         *   the new policy.
         */
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.iam.CfnManagedPolicy =
            cdkBuilder.build()
    }
