...
internal constructor(
    ...
    /** A step scaling policy. */
    public open fun stepScalingPolicyConfiguration(
        `value`: StepScalingPolicyConfigurationProperty
    ) {
        unwrap(this)
            .setStepScalingPolicyConfiguration(
                `value`.let(StepScalingPolicyConfigurationProperty::unwrap)
            )
    }
    ...
    public open fun stepScalingPolicyConfiguration(
        `value`: StepScalingPolicyConfigurationProperty.Builder.() -> Unit
    ...
    /** A target tracking scaling policy. */
    public open fun targetTrackingScalingPolicyConfiguration(
        `value`: TargetTrackingScalingPolicyConfigurationProperty
    ) {
        unwrap(this)
            .setTargetTrackingScalingPolicyConfiguration(
                `value`.let(TargetTrackingScalingPolicyConfigurationProperty::unwrap)
            )
    }
    ...
    public open fun targetTrackingScalingPolicyConfiguration(
        `value`: TargetTrackingScalingPolicyConfigurationProperty.Builder.() -> Unit
    ): Unit =
        targetTrackingScalingPolicyConfiguration(
            TargetTrackingScalingPolicyConfigurationProperty(`value`)
        )
    ...
    public interface Builder {
         ...
         * The name of the scaling policy.
         *
         * Updates to the name of a target tracking scaling policy are not supported, unless you
         * also update the metric used for scaling. To change only a target tracking scaling
         * policy's name, first delete the policy by removing the existing
         * `AWS::ApplicationAutoScaling::ScalingPolicy` resource from the template and updating the
         ...
         * * SageMaker endpoint variant - The resource type is `variant` and the unique identifier
         ...
         *   in our
         *   [GitHub repository](https://docs.aws.amazon.com/https://github.com/aws/aws-auto-scaling-custom-resource)
         *   .
         ...
         *   identifier is the function name with a function version or alias name suffix that is
         *   not `$LATEST` . Example: `function:my-function:prod` or `function:my-function:1` .
         ...
         * @param stepScalingPolicyConfiguration A step scaling policy.
         */
        public fun stepScalingPolicyConfiguration(
        ...
        public fun stepScalingPolicyConfiguration(
            stepScalingPolicyConfiguration:
                StepScalingPolicyConfigurationProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.applicationautoscaling.CfnScalingPolicy.Builder.create(
                scope,
                id
            )
        ...
        override fun stepScalingPolicyConfiguration(stepScalingPolicyConfiguration: IResolvable) {
            cdkBuilder.stepScalingPolicyConfiguration(
                stepScalingPolicyConfiguration.let(IResolvable::unwrap)
            )
        }
         ...
         * @param stepScalingPolicyConfiguration A step scaling policy.
         */
        override fun stepScalingPolicyConfiguration(
            stepScalingPolicyConfiguration: StepScalingPolicyConfigurationProperty
        ) {
            cdkBuilder.stepScalingPolicyConfiguration(
                stepScalingPolicyConfiguration.let(StepScalingPolicyConfigurationProperty::unwrap)
            )
        }
        ...
        override fun stepScalingPolicyConfiguration(
            ...
            stepScalingPolicyConfiguration(
                StepScalingPolicyConfigurationProperty(stepScalingPolicyConfiguration)
            )
    ...
    public interface PredefinedMetricSpecificationProperty {
        ...
        public interface Builder {
            /**
             * @param predefinedMetricType The metric type. The `ALBRequestCountPerTarget` metric
             *   type applies only to Spot fleet requests and ECS services.
             */
        ...
        internal constructor(
             ...
             * The metric type.
             *
             * The `ALBRequestCountPerTarget` metric type applies only to Spot fleet requests and
             * ECS services.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-applicationautoscaling-scalingpolicy-predefinedmetricspecification.html#cfn-applicationautoscaling-scalingpolicy-predefinedmetricspecification-predefinedmetrictype)
             */
             ...
             * `ALBRequestCountPerTarget` and there is a target group attached to the Spot Fleet or
             * ECS service.
             *
             * You create the resource label by appending the final portion of the load balancer ARN
             * and the final portion of the target group ARN into a single value, separated by a
    ...
    public interface TargetTrackingMetricStatProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TargetTrackingMetricStatProperty
            ): software.amazon.awscdk.services.applicationautoscaling.CfnScalingPolicy.TargetTrackingMetricStatProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface StepAdjustmentProperty {
         ...
         * (either an absolute number or a percentage). A positive value adds to the current
        ...
        public interface Builder {
            ...
            /**
             * @param scalingAdjustment The amount by which to scale. The adjustment is based on the
    ...
    public interface TargetTrackingMetricDimensionProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TargetTrackingMetricDimensionProperty
            ): software.amazon.awscdk.services.applicationautoscaling.CfnScalingPolicy.TargetTrackingMetricDimensionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface StepScalingPolicyConfigurationProperty {
         ...
         * specified a `MinAdjustmentMagnitude` of 2, Application Auto Scaling scales out the
         * service by 2 tasks.
         *
        ...
        public interface Builder {
            ...
            /**
             * @param cooldown The amount of time, in seconds, to wait for a previous scaling
             *   activity to take effect. If not specified, the default value is 300. For more
             *   information, see
             *   [Cooldown period](https://docs.aws.amazon.com/autoscaling/application/userguide/step-scaling-policy-overview.html#step-scaling-cooldown)
             *   in the *Application Auto Scaling User Guide* .
             */
            ...
            /**
             * @param metricAggregationType The aggregation type for the CloudWatch metrics. Valid
             *   values are `Minimum` , `Maximum` , and `Average` . If the aggregation type is null,
             *   the value is treated as `Average` .
             */
            public fun metricAggregationType(metricAggregationType: String)

            /**
             * @param minAdjustmentMagnitude The minimum value to scale by when the adjustment type
             *   is `PercentChangeInCapacity` . For example, suppose that you create a step scaling
             *   policy to scale out an Amazon ECS service by 25 percent and you specify a
             *   `MinAdjustmentMagnitude` of 2. If the service has 4 tasks and the scaling policy is
            ...
            /**
             * @param stepAdjustments A set of adjustments that enable you to scale based on the
             *   size of the alarm breach. At least one step adjustment is required if you are
        ...
        internal constructor(
            ...
            /**
             * Specifies whether the `ScalingAdjustment` value in the `StepAdjustment` property is
             ...
             * The aggregation type for the CloudWatch metrics.
             *
             * Valid values are `Minimum` , `Maximum` , and `Average` . If the aggregation type is
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-applicationautoscaling-scalingpolicy-stepscalingpolicyconfiguration.html#cfn-applicationautoscaling-scalingpolicy-stepscalingpolicyconfiguration-minadjustmentmagnitude)
             */
            override fun minAdjustmentMagnitude(): Number? =
                unwrap(this).getMinAdjustmentMagnitude()
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: StepScalingPolicyConfigurationProperty
            ): software.amazon.awscdk.services.applicationautoscaling.CfnScalingPolicy.StepScalingPolicyConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CustomizedMetricSpecificationProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param metrics The metrics to include in the target tracking scaling policy, as a
             *   metric data query. This can include both raw metric and metric math expressions.
             */
    ...
    public interface TargetTrackingMetricDataQueryProperty {
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("212adca6a74036f0fadf8d3aab1a9cd434f87243e7be7d72832b6caf3cc86131")
            override fun metricStat(
                metricStat: TargetTrackingMetricStatProperty.Builder.() -> Unit
            ): Unit = metricStat(TargetTrackingMetricStatProperty(metricStat))
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TargetTrackingMetricDataQueryProperty
            ): software.amazon.awscdk.services.applicationautoscaling.CfnScalingPolicy.TargetTrackingMetricDataQueryProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface TargetTrackingScalingPolicyConfigurationProperty {
         ...
         * either too small or too large. Values must be in the range of -2^360 to 2^360. The value
         * must be a valid number based on the choice of metric. For example, if the metric is CPU
         * utilization, then the target value is a percent value that represents how much of the CPU
        ...
        public interface Builder {
            /**
             * @param customizedMetricSpecification A customized metric. You can specify either a
             ...
             *   tracking scaling policy won't remove capacity from the scalable target. Otherwise,
             *   scale in is enabled and the target tracking scaling policy can remove capacity from
            ...
            /**
             * @param predefinedMetricSpecification A predefined metric. You can specify either a
             *   predefined metric or a customized metric.
             */
             ...
             *   completes before another scale-in activity can start. For more information and for
             *   default values, see
             *   [Define cooldown periods](https://docs.aws.amazon.com/autoscaling/application/userguide/target-tracking-scaling-policy-overview.html#target-tracking-cooldown)
             *   in the *Application Auto Scaling User Guide* .
             */
            ...
            /**
             * @param scaleOutCooldown The amount of time, in seconds, to wait for a previous
             *   scale-out activity to take effect. For more information and for default values, see
             *   [Define cooldown periods](https://docs.aws.amazon.com/autoscaling/application/userguide/target-tracking-scaling-policy-overview.html#target-tracking-cooldown)
             *   in the *Application Auto Scaling User Guide* .
             */
             ...
             *   large. Values must be in the range of -2^360 to 2^360. The value must be a valid
             *   number based on the choice of metric. For example, if the metric is CPU
             *   utilization, then the target value is a percent value that represents how much of
    ...
    public interface TargetTrackingMetricProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TargetTrackingMetricProperty
            ): software.amazon.awscdk.services.applicationautoscaling.CfnScalingPolicy.TargetTrackingMetricProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
