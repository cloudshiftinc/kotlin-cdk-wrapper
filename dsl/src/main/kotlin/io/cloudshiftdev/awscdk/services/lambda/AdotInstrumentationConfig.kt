...
public interface AdotInstrumentationConfig {
    ...
    public interface Builder {
        /**
         * @param execWrapper The startup script to run, see ADOT documentation to pick the right
         *   script for your use case: https://aws-otel.github.io/docs/getting-started/lambda.
         */
    ...
    internal constructor(
        ...
        /**
         * The startup script to run, see ADOT documentation to pick the right script for your use
         * case: https://aws-otel.github.io/docs/getting-started/lambda.
         */
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: AdotInstrumentationConfig
