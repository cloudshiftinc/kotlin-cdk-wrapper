...
internal constructor(
    ...
    public open fun addCorsRule(rule: CorsRule.Builder.() -> Unit): Unit =
    ...
    public interface Builder {
         ...
         *
         * @param accessControl Specifies a canned ACL that grants predefined permissions to the
         *   bucket.
         */
        public fun accessControl(accessControl: BucketAccessControl)

        /**
         * Whether all objects should be automatically deleted when the bucket is removed from the
         * stack or when the stack is deleted.
         *
         * Requires the `removalPolicy` to be set to `RemovalPolicy.DESTROY`.
         *
         * **Warning** if you have deployed a bucket with `autoDeleteObjects: true`, switching this
         * to `false` in a CDK version *before* `1.126.0` will lead to all objects in the bucket
         * being deleted. Be sure to update your bucket resources by deploying with CDK version
         * `1.126.0` or later **before** switching this value to `false`.
         *
         * Default: false
         *
         * @param autoDeleteObjects Whether all objects should be automatically deleted when the
         *   bucket is removed from the stack or when the stack is deleted.
         */
         ...
         *
         * If you choose KMS, you can specify a KMS key via `encryptionKey`. If encryption key is
         * not specified, a key will automatically be created.
         *
         ...
         *
         * The `encryption` property must be either not specified or set to `KMS` or `DSSE`. An
         * error will be emitted if `encryption` is set to `UNENCRYPTED` or `S3_MANAGED`.
         *
         * Default: - If `encryption` is set to `KMS` and this property is undefined, a new KMS key
         * will be created and associated with this bucket.
         *
         ...
         * Default: false
         *
         * @param eventBridgeEnabled Whether this bucket should send notifications to Amazon
         *   EventBridge or not.
         */
         ...
         */
        public fun intelligentTieringConfigurations(
            vararg intelligentTieringConfigurations: IntelligentTieringConfiguration
        )
         ...
         *
         * @param lifecycleRules Rules that define how Amazon S3 manages objects during their
         *   lifetime.
         */
         ...
         *
         * @param objectLockDefaultRetention The default retention mode and rules for S3 Object
         *   Lock.
         */
         ...
         *
         * Enabling object lock for existing buckets is not supported. Object lock must be enabled
         ...
         *
         * Default: - If "serverAccessLogsPrefix" undefined - access logs disabled, otherwise - log
         * to current bucket.
         *
         ...
         *
         * @param serverAccessLogsPrefix Optional log file prefix to use for the bucket's access
         *   logs.
         */
         ...
         * Default: false
         *
         * @param transferAcceleration Whether this bucket should have transfer acceleration turned
         *   on or not.
         */
         ...
         *
         * @param websiteErrorDocument The name of the error document (e.g. "404.html") for the
         *   website. `websiteIndexDocument` must also be set if this is set.
         */
         ...
         * website hosting for this bucket.
         *
         ...
         *
         * @param websiteRedirect Specifies the redirect behavior of all requests to a website
         *   endpoint of a bucket.
         */
    ...
    private class BuilderImpl(
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("0ae01d0ba0bb2c5f41b4b7400230c6ab9304113667d092e5c1ca903318f6b380")
        override fun blockPublicAccess(
            blockPublicAccess: BlockPublicAccess.Builder.() -> Unit
        ...
        override fun intelligentTieringConfigurations(
            ...
            cdkBuilder.intelligentTieringConfigurations(
                intelligentTieringConfigurations.map(IntelligentTieringConfiguration::unwrap)
            )
        }
        ...
        override fun objectLockDefaultRetention(objectLockDefaultRetention: ObjectLockRetention) {
            cdkBuilder.objectLockDefaultRetention(
                objectLockDefaultRetention.let(ObjectLockRetention::unwrap)
            )
        }
        ...
        override fun targetObjectKeyFormat(targetObjectKeyFormat: TargetObjectKeyFormat) {
            cdkBuilder.targetObjectKeyFormat(
                targetObjectKeyFormat.let(TargetObjectKeyFormat::unwrap)
            )
        }
    ...
    public companion object {
        public fun fromBucketArn(
            ...
            software.amazon.awscdk.services.s3.Bucket.fromBucketArn(
        ...
        public fun fromBucketAttributes(
            ...
            software.amazon.awscdk.services.s3.Bucket.fromBucketAttributes(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    attrs.let(BucketAttributes::unwrap)
                )
                .let(IBucket::wrap)
        ...
        public fun fromBucketName(
            ...
            software.amazon.awscdk.services.s3.Bucket.fromBucketName(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    bucketName
                )
        ...
        public fun fromCfnBucket(cfnBucket: CfnBucket): IBucket =
            software.amazon.awscdk.services.s3.Bucket.fromCfnBucket(
                    cfnBucket.let(CfnBucket::unwrap)
                )
                .let(IBucket::wrap)
