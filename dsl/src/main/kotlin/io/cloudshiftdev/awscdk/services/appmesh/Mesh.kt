...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.appmesh.Mesh,
     ...
     * @param props
     */
    public override fun addVirtualGateway(
        id: String,
    ...
    public override fun addVirtualNode(
        id: String,
    ...
    public override fun addVirtualRouter(
        id: String,
    ...
    public interface Builder {
         ...
         *
         * @param serviceDiscovery Defines how upstream clients will discover VirtualNodes in the
         *   Mesh.
         */
    ...
    private class BuilderImpl(
        ...
        override fun serviceDiscovery(
            serviceDiscovery: MeshServiceDiscovery.Builder.() -> Unit
    ...
    public companion object {
        public fun fromMeshArn(
            ...
            software.amazon.awscdk.services.appmesh.Mesh.fromMeshArn(
        ...
        public fun fromMeshName(
            ...
            software.amazon.awscdk.services.appmesh.Mesh.fromMeshName(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    meshName
                )
