...
internal constructor(
    ...
    public open fun pricingRuleArns(): List<String> =
        unwrap(this).getPricingRuleArns() ?: emptyList()
    ...
    /** The `PricingRuleArns` that are associated with the Pricing Plan. */
    public open fun pricingRuleArns(vararg `value`: String): Unit =
        pricingRuleArns(`value`.toList())
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.billingconductor.CfnPricingPlan.Builder.create(
                scope,
                id
            )
