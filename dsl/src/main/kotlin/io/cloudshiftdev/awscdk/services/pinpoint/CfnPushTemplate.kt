...
internal constructor(
    ...
    public open fun baidu(
        `value`: AndroidPushNotificationTemplateProperty.Builder.() -> Unit
    ): Unit = baidu(AndroidPushNotificationTemplateProperty(`value`))
    ...
    public open fun defaultValue(
        `value`: DefaultPushNotificationTemplateProperty.Builder.() -> Unit
    ...
    public interface Builder {
         ...
         * template. The corresponding value defines the default value for that variable. When you
         * create a message that's based on the template, you can override these defaults with
        ...
        public fun defaultValue(
            defaultValue: DefaultPushNotificationTemplateProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
        ...
        @JvmName("dc694eece0399854bffddc89d3dbd2d5a139541583ffe80e340afa48420aa17d")
        override fun baidu(
            baidu: AndroidPushNotificationTemplateProperty.Builder.() -> Unit
        ...
        override fun defaultValue(defaultValue: DefaultPushNotificationTemplateProperty) {
            cdkBuilder.defaultValue(
                defaultValue.let(DefaultPushNotificationTemplateProperty::unwrap)
            )
        }
    ...
    public interface DefaultPushNotificationTemplateProperty {
         ...
         * message template.
         *
         * You can use the default stream or specify the file name of a sound resource that's
         * bundled in your app. On an Android platform, the sound file must reside in `/res/raw/` .
         *
        ...
        public interface Builder {
            /**
             * @param action The action to occur if a recipient taps a push notification that's
            ...
            /**
             * @param body The message body to use in push notifications that are based on the
             *   message template.
             */
            public fun body(body: String)

            /**
             * @param sound The sound to play when a recipient receives a push notification that's
             *   based on the message template. You can use the default stream or specify the file
             *   name of a sound resource that's bundled in your app. On an Android platform, the
             *   sound file must reside in `/res/raw/` .
             *
             * For an iOS platform, this value is the key for the name of a sound file in your app's
             * main bundle or the `Library/Sounds` folder in your app's data container. If the sound
             * file can't be found or you specify `default` for the value, the system plays the
             * default alert sound.
             */
            public fun sound(sound: String)

            /**
             * @param title The title to use in push notifications that are based on the message
             ...
             *   taps a push notification that's based on the message template and the value of the
        ...
        internal constructor(
            ...
            /**
             * The URL to open in a recipient's default mobile browser, if a recipient taps a push
             * notification that's based on the message template and the value of the `Action`
             * property is `URL` .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-pinpoint-pushtemplate-defaultpushnotificationtemplate.html#cfn-pinpoint-pushtemplate-defaultpushnotificationtemplate-url)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DefaultPushNotificationTemplateProperty
            ): software.amazon.awscdk.services.pinpoint.CfnPushTemplate.DefaultPushNotificationTemplateProperty =
    ...
    public interface AndroidPushNotificationTemplateProperty {
        ...
        /**
         * The URL of the small icon image to display in the status bar and the content view of a
        ...
        public interface Builder {
            ...
            /**
             * @param body The message body to use in a push notification that's based on the
             *   message template.
             */
            public fun body(body: String)

            /**
             * @param imageIconUrl The URL of the large icon image to display in the content view of
             *   a push notification that's based on the message template.
             */
            public fun imageIconUrl(imageIconUrl: String)

            /**
             * @param imageUrl The URL of an image to display in a push notification that's based on
             *   the message template.
             */
            public fun imageUrl(imageUrl: String)

            /**
             * @param smallImageIconUrl The URL of the small icon image to display in the status bar
             *   and the content view of a push notification that's based on the message template.
             */
            ...
            /**
             * @param title The title to use in a push notification that's based on the message
             *   template. This title appears above the notification message on a recipient's
             *   device.
             */
            public fun title(title: String)
        ...
        internal constructor(
            ...
            /**
             * The URL of the small icon image to display in the status bar and the content view of
             * a push notification that's based on the message template.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-pinpoint-pushtemplate-androidpushnotificationtemplate.html#cfn-pinpoint-pushtemplate-androidpushnotificationtemplate-smallimageiconurl)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AndroidPushNotificationTemplateProperty
            ): software.amazon.awscdk.services.pinpoint.CfnPushTemplate.AndroidPushNotificationTemplateProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface APNSPushNotificationTemplateProperty {
         ...
         * `Library/Sounds` folder in your app's data container. If the sound file can't be found or
         * you specify `default` for the value, the system plays the default alert sound.
         *
        ...
        public interface Builder {
            ...
            /**
             * @param mediaUrl The URL of an image or video to display in push notifications that
             *   are based on the message template.
             */
            public fun mediaUrl(mediaUrl: String)

            /**
             * @param sound The key for the sound to play when the recipient receives a push
             *   notification that's based on the message template. The value for this key is the
             *   name of a sound file in your app's main bundle or the `Library/Sounds` folder in
            ...
            /**
             * @param url The URL to open in the recipient's default mobile browser, if a recipient
             *   taps a push notification that's based on the message template and the value of the
             *   `Action` property is `URL` .
             */
            public fun url(url: String)
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: APNSPushNotificationTemplateProperty
            ): software.amazon.awscdk.services.pinpoint.CfnPushTemplate.APNSPushNotificationTemplateProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
