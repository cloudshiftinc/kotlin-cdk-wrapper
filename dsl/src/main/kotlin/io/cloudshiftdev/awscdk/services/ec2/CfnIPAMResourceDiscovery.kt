...
internal constructor(
     ...
     *
     * The default resource discovery is the resource discovery automatically created when you
     * create an IPAM.
     */
     ...
     * * `isolate-in-progress` - AWS account that created the resource discovery has been removed
     *   and the resource discovery is being isolated.
     * * `isolate-complete` - Resource discovery isolation is complete.
     * * `restore-in-progress` - AWS account that created the resource discovery and was isolated
     *   has been restored.
     */
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnIPAMResourceDiscovery
