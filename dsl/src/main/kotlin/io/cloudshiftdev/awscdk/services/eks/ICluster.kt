...
public interface ICluster : IResource, IConnectable {
     ...
     */
    public fun connectAutoScalingGroupCapacity(
    ...
    internal constructor(
        ...
        override fun addCdk8sChart(id: String, chart: Construct): KubernetesManifest =
            unwrap(this)
                .addCdk8sChart(id, chart.let(Construct::unwrap))
        ...
        override fun addHelmChart(id: String, options: HelmChartOptions): HelmChart =
            unwrap(this)
                .addHelmChart(id, options.let(HelmChartOptions::unwrap))
                .let(HelmChart::wrap)
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("d1c04bf62363d27f7f1fcd0ee00a0a93e786f9d5a35ef2d9e35f27368f469899")
        override fun addServiceAccount(
            id: String,
            options: ServiceAccountOptions.Builder.() -> Unit
         ...
         * The AutoScalingGroup must be running an EKS-optimized AMI containing the
         * /etc/eks/bootstrap.sh script. This method will configure Security Groups, add the right
         * policies to the instance role, apply the right tags, and add the required user data to
         * the instance's launch configuration.
         *
         ...
         *
         * @param autoScalingGroup [disable-awslint:ref-via-interface].
         * @param options options for adding auto scaling groups, like customizing the bootstrap
         *   script.
         */
        override fun connectAutoScalingGroupCapacity(
            autoScalingGroup: AutoScalingGroup,
            options: AutoScalingGroupOptions
        ) {
            unwrap(this)
    ...
    public companion object {
        ...
        internal fun unwrap(wrapped: ICluster): software.amazon.awscdk.services.eks.ICluster =
