...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param configuration Specifies the `MapConfiguration` , including the map style, for the
         *   map resource that you create.
         */
    ...
    private class BuilderImpl(
        ...
        override fun configuration(
            configuration: MapConfigurationProperty.Builder.() -> Unit
    ...
    public interface MapConfigurationProperty {
         ...
         *
         * Leave unset to not enable any custom layer, or, for styles that support custom layers,
         * you can enable layer(s), such as the `POI` layer for the VectorEsriNavigation style.
         *
         ...
         * * `VectorEsriNavigation` – The Esri Navigation map style, which provides a detailed
         *   basemap for the world symbolized with a custom navigation map style that's designed for
         *   use during the day in mobile devices. It also includes a richer set of places, such as
         *   shops, services, restaurants, attractions, and other points of interest. Enable the
         *   `POI` layer by setting it in CustomLayers to leverage the additional places data.
         * * `RasterEsriImagery` – The Esri Imagery map style. A raster basemap that provides one
         *   meter or better satellite and aerial imagery in many parts of the world and lower
         *   resolution satellite imagery worldwide.
         * * `VectorEsriLightGrayCanvas` – The Esri Light Gray Canvas map style, which provides a
         *   detailed vector basemap with a light gray, neutral background style with minimal
         *   colors, labels, and features that's designed to draw attention to your thematic
         *   content.
         * * `VectorEsriTopographic` – The Esri Light map style, which provides a detailed vector
         *   basemap with a classic Esri map style.
         * * `VectorEsriStreets` – The Esri Street Map style, which provides a detailed vector
         *   basemap for the world symbolized with a classic Esri street map style. The vector tile
         *   layer is similar in content and style to the World Street Map raster map.
         * * `VectorEsriDarkGrayCanvas` – The Esri Dark Gray Canvas map style. A vector basemap with
         *   a dark gray, neutral background with minimal colors, labels, and features that's
         ...
         *   features including roads, buildings, landmarks, and water features. It also now
         *   includes a fully designed map of Japan.
         * * `RasterHereExploreSatellite` – A global map containing high resolution satellite
         *   imagery.
         * * `HybridHereExploreSatellite` – A global map displaying the road network, street names,
         *   and city labels over satellite imagery. This style will automatically retrieve both
         *   raster and vector tiles, and your charges will be based on total tiles retrieved.
         *
         * Hybrid styles use both vector and raster tiles when rendering the map that you see. This
         * means that more tiles are retrieved than when using either vector or raster tiles alone.
         ...
         * `VectorHereBerlin` has been deprecated, but will continue to work in applications that
         * use it.
         * * `VectorHereExploreTruck` – A global map containing truck restrictions and attributes
         *   (e.g. width / height / HAZMAT) symbolized with highlighted segments and icons on top of
         *   HERE Explore to support use cases within transport and logistics.
         *
         * Valid
         ...
         *   detailed land use coloring, area names, roads, landmarks, and points of interest
         *   covering Southeast Asia.
         * * `VectorGrabStandardDark` – The Grab Standard Dark map style provides a dark variation
         *   of the standard basemap covering Southeast Asia.
         *
         * Grab provides maps only for countries in Southeast Asia, and is only available in the
         * Asia Pacific (Singapore) Region ( `ap-southeast-1` ). For more information, see
         ...
         *   light-themed style with muted colors and fewer features that aids in understanding
         *   overlaid data.
         * * `VectorOpenDataVisualizationDark` – The Open Data Visualization Dark map style is a
         *   dark-themed style with muted colors and fewer features that aids in understanding
         *   overlaid data.
         *
        ...
        public interface Builder {
            /**
             * @param customLayers Specifies the custom layers for the style. Leave unset to not
             *   enable any custom layer, or, for styles that support custom layers, you can enable
             *   layer(s), such as the `POI` layer for the VectorEsriNavigation style.
             *
             ...
             *   Enable the `POI` layer by setting it in CustomLayers to leverage the additional
             *   places data.
             ...
             * * `VectorEsriLightGrayCanvas` – The Esri Light Gray Canvas map style, which provides
             ...
             * [HERE Technologies map styles](https://docs.aws.amazon.com/location/latest/developerguide/HERE.html)
             * :
             * * `VectorHereExplore` – A default HERE map style containing a neutral, global map and
             *   its features including roads, buildings, landmarks, and water features. It also now
             *   includes a fully designed map of Japan.
             * * `RasterHereExploreSatellite` – A global map containing high resolution satellite
             *   imagery.
             * * `HybridHereExploreSatellite` – A global map displaying the road network, street
             *   names, and city labels over satellite imagery. This style will automatically
             *   retrieve both raster and vector tiles, and your charges will be based on total
             *   tiles retrieved.
             *
             * Hybrid styles use both vector and raster tiles when rendering the map that you see.
             * This means that more tiles are retrieved than when using either vector or raster
             * tiles alone. Your charges will include all tiles retrieved.
             ...
             *   attributes (e.g. width / height / HAZMAT) symbolized with highlighted segments and
             *   icons on top of HERE Explore to support use cases within transport and logistics.
             *
             * Valid
             * [GrabMaps map styles](https://docs.aws.amazon.com/location/latest/developerguide/grab.html)
             * :
             ...
             * :
             * * `VectorOpenDataStandardLight` – The Open Data Standard Light map style provides a
             *   detailed basemap for the world suitable for website and mobile application use. The
             *   map includes highways major roads, minor roads, railways, water features, cities,
             ...
             *   boundaries.
             * * `VectorOpenDataVisualizationLight` – The Open Data Visualization Light map style is
             *   a light-themed style with muted colors and fewer features that aids in
        ...
        internal constructor(
             ...
             * Specifies the custom layers for the style.
             *
             * Leave unset to not enable any custom layer, or, for styles that support custom
             * layers, you can enable layer(s), such as the `POI` layer for the VectorEsriNavigation
             * style.
             *
             * Currenlty only `VectorEsriNavigation` supports CustomLayers. For more information,
             * see
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-location-map-mapconfiguration.html#cfn-location-map-mapconfiguration-customlayers)
             */
            override fun customLayers(): List<String> =
                unwrap(this).getCustomLayers() ?: emptyList()
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: MapConfigurationProperty
            ): software.amazon.awscdk.services.location.CfnMap.MapConfigurationProperty =
