...
internal constructor(
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.ecr.CfnReplicationConfiguration.Builder.create(
                scope,
                id
            )
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnReplicationConfiguration
    ...
    public interface ReplicationDestinationProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param registryId The AWS account ID of the Amazon ECR private registry to replicate
             *   to. When configuring cross-Region replication within your own registry, specify
             *   your own account ID.
             */
    ...
    public interface ReplicationConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param rules An array of objects representing the replication destinations and
    ...
    public interface ReplicationRuleProperty {
        ...
        public interface Builder {
            /**
             * @param destinations An array of objects representing the destination for a
             *   replication rule.
             */
            ...
            /**
             * @param repositoryFilters An array of objects representing the filters for a
             *   replication rule. Specifying a repository filter for a replication rule provides a
             *   method for controlling which repositories in a private registry are replicated.
             */
    ...
    public interface RepositoryFilterProperty {
         ...
         *
         * When the `PREFIX_MATCH` filter type is specified, this value is required and should be
         * the repository name prefix to configure replication for.
         *
        ...
        public interface Builder {
             ...
             *   specified, this value is required and should be the repository name prefix to
             *   configure replication for.
             */
            public fun filter(filter: String)

            /**
             * @param filterType The repository filter type. The only supported value is
             *   `PREFIX_MATCH` , which is a repository name prefix specified with the `filter`
             *   parameter.
             */
        ...
        internal constructor(
             ...
             * The repository filter details.
             *
             * When the `PREFIX_MATCH` filter type is specified, this value is required and should
             * be the repository name prefix to configure replication for.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ecr-replicationconfiguration-repositoryfilter.html#cfn-ecr-replicationconfiguration-repositoryfilter-filter)
             */
             ...
             * The repository filter type.
             *
             * The only supported value is `PREFIX_MATCH` , which is a repository name prefix
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RepositoryFilterProperty
            ): software.amazon.awscdk.services.ecr.CfnReplicationConfiguration.RepositoryFilterProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
