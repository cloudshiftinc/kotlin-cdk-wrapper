...
internal constructor(
    ...
    public open fun alertSensitivityThreshold(): Number =
        unwrap(this).getAlertSensitivityThreshold()
    ...
    public interface Builder {
         ...
         *
         * @param alertSensitivityThreshold An integer from 0 to 100 specifying the alert
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.lookoutmetrics.CfnAlert =
            cdkBuilder.build()
    }
    ...
    public companion object {
        ...
        ): CfnAlert = CfnAlert(cdkObject)

        internal fun unwrap(
            wrapped: CfnAlert
        ): software.amazon.awscdk.services.lookoutmetrics.CfnAlert = wrapped.cdkObject
    }
    ...
    public interface ActionProperty {
        ...
        public interface Builder {
            ...
            public fun lambdaConfiguration(
                lambdaConfiguration: LambdaConfigurationProperty.Builder.() -> Unit
            )
        ...
        private class BuilderImpl : Builder {
            ...
            override fun lambdaConfiguration(lambdaConfiguration: LambdaConfigurationProperty) {
                cdkBuilder.lambdaConfiguration(
                    lambdaConfiguration.let(LambdaConfigurationProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("6a3986527e9aa6ec69402be8b4e46fed80a6999a2031ccfe032e4b81c8bdbba2")
            override fun lambdaConfiguration(
                lambdaConfiguration: LambdaConfigurationProperty.Builder.() -> Unit
    ...
    public interface LambdaConfigurationProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param roleArn The ARN of an IAM role that has permission to invoke the Lambda
             *   function.
             */
