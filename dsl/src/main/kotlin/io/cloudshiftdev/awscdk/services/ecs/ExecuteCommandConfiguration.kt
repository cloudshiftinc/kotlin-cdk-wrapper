...
public interface ExecuteCommandConfiguration {
    ...
    public interface Builder {
         ...
         *   actions. The logs can be sent to CloudWatch Logs or an Amazon S3 bucket.
         */
        ...
        public fun logConfiguration(
            logConfiguration: ExecuteCommandLogConfiguration.Builder.() -> Unit
        )
    ...
    private class BuilderImpl : Builder {
        ...
        override fun logConfiguration(logConfiguration: ExecuteCommandLogConfiguration) {
            cdkBuilder.logConfiguration(
                logConfiguration.let(ExecuteCommandLogConfiguration::unwrap)
            )
        }
    ...
    internal constructor(
        ...
        /**
         * The AWS Key Management Service key ID to encrypt the data between the local client and
         * the container.
         *
         * Default: - none
         */
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: ExecuteCommandConfiguration
