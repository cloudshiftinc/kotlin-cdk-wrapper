...
internal constructor(
    ...
    public open fun routingConfig(
        `value`: AliasRoutingConfigurationProperty.Builder.() -> Unit
    ): Unit = routingConfig(AliasRoutingConfigurationProperty(`value`))
    ...
    public interface Builder {
        ...
        public fun routingConfig(
            routingConfig: AliasRoutingConfigurationProperty.Builder.() -> Unit
        )
    }
    ...
    public interface AliasRoutingConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param additionalVersionWeights The second version, and the percentage of traffic
             *   that's routed to it.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            override fun additionalVersionWeights(additionalVersionWeights: IResolvable) {
                cdkBuilder.additionalVersionWeights(
                    additionalVersionWeights.let(IResolvable::unwrap)
                )
            }
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-lambda-alias-aliasroutingconfiguration.html#cfn-lambda-alias-aliasroutingconfiguration-additionalversionweights)
             */
            override fun additionalVersionWeights(): Any =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AliasRoutingConfigurationProperty
            ): software.amazon.awscdk.services.lambda.CfnAlias.AliasRoutingConfigurationProperty =
