...
internal constructor(
    ...
    public interface Builder {
         ...
         * The objects that define the pipeline.
         *
         * These objects overwrite the existing pipeline definition. Not all objects, fields, and
         * values can be updated. For information about restrictions, see
        ...
        /**
         * A list of arbitrary tags (key-value pairs) to associate with the pipeline, which you can
         * use to control permissions.
         *
    ...
    public interface ParameterObjectProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ParameterObjectProperty
            ): software.amazon.awscdk.services.datapipeline.CfnPipeline.ParameterObjectProperty =
    ...
    public interface ParameterValueProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ParameterValueProperty
            ): software.amazon.awscdk.services.datapipeline.CfnPipeline.ParameterValueProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface PipelineObjectProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: PipelineObjectProperty
            ): software.amazon.awscdk.services.datapipeline.CfnPipeline.PipelineObjectProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ParameterAttributeProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ParameterAttributeProperty
            ): software.amazon.awscdk.services.datapipeline.CfnPipeline.ParameterAttributeProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface FieldProperty {
         ...
         *
         * To view valid values for a particular field, see
        ...
        public interface Builder {
            /**
             * @param key Specifies the name of a field for a particular object. To view valid
             *   values for a particular field, see
             *   [Pipeline Object Reference](https://docs.aws.amazon.com/datapipeline/latest/DeveloperGuide/dp-pipeline-objects.html)
             *   in the *AWS Data Pipeline Developer Guide* .
             */
            public fun key(key: String)
            ...
            /**
             * @param refValue A field value that you specify as an identifier of another object in
             *   the same pipeline definition.
             *
             * You can specify the field value as either a string value ( `StringValue` ) or a
             * reference to another object ( `RefValue` ), but not both.
             *
             * Required if the key that you are using requires it.
             */
            ...
            /**
             * @param stringValue A field value that you specify as a string. To view valid values
             *   for a particular field, see
             *   [Pipeline Object Reference](https://docs.aws.amazon.com/datapipeline/latest/DeveloperGuide/dp-pipeline-objects.html)
             *   in the *AWS Data Pipeline Developer Guide* .
             *
             * You can specify the field value as either a string value ( `StringValue` ) or a
