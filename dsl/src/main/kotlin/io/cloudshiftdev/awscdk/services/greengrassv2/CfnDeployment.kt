...
internal constructor(
    ...
    public open fun deploymentPolicies(
        `value`: DeploymentPoliciesProperty.Builder.() -> Unit
    ): Unit = deploymentPolicies(DeploymentPoliciesProperty(`value`))
    ...
    public open fun iotJobConfiguration(`value`: DeploymentIoTJobConfigurationProperty) {
        unwrap(this)
            .setIotJobConfiguration(`value`.let(DeploymentIoTJobConfigurationProperty::unwrap))
    }

    /** The job configuration for the deployment configuration. */
    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("54578ced49c987e269c6f5f2922f0208a0a96f232f97b778c894c28bcd56b237")
    public open fun iotJobConfiguration(
        `value`: DeploymentIoTJobConfigurationProperty.Builder.() -> Unit
    ...
    public interface Builder {
         ...
         * The components to deploy.
         *
         * This is a dictionary, where each key is the name of a component, and each key's value is
         * the version and configuration to deploy for that component.
         *
        ...
        public fun deploymentPolicies(
            deploymentPolicies: DeploymentPoliciesProperty.Builder.() -> Unit
        )
        ...
        public fun iotJobConfiguration(
            iotJobConfiguration: DeploymentIoTJobConfigurationProperty.Builder.() -> Unit
        )
         ...
         * Application-specific metadata to attach to the deployment.
         *
         * You can use tags in IAM policies to control access to AWS IoT Greengrass resources. You
         * can also use tags to categorize your resources. For more information, see
         ...
         * format, which is different from most `Tags` implementations in AWS CloudFormation
         * templates.
         *
         * ```
    ...
    private class BuilderImpl(
        ...
        override fun deploymentPolicies(deploymentPolicies: DeploymentPoliciesProperty) {
            cdkBuilder.deploymentPolicies(
                deploymentPolicies.let(DeploymentPoliciesProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("6abdf667c4571f2e053be60238321b64f1b0cb205d4938adba46df49ad0ba187")
        override fun deploymentPolicies(
            deploymentPolicies: DeploymentPoliciesProperty.Builder.() -> Unit
         ...
         * @param iotJobConfiguration The job configuration for the deployment configuration.
         */
        override fun iotJobConfiguration(
            iotJobConfiguration: DeploymentIoTJobConfigurationProperty
        ) {
            cdkBuilder.iotJobConfiguration(
                iotJobConfiguration.let(DeploymentIoTJobConfigurationProperty::unwrap)
            )
        }
    ...
    public interface ComponentDeploymentSpecificationProperty {
         ...
         * to the default configuration for the component. A merge updates the core device's
         * component configuration with the keys and values that you specify. The AWS IoT Greengrass
         * Core software applies reset updates before it applies merge updates. For more
         * information, see
         ...
         * device.
         *
         * If you omit this parameter, the software uses the system user and group that you
        ...
        public interface Builder {
            ...
            /**
             * @param configurationUpdate The configuration updates to deploy for the component. You
             *   can define reset updates and merge updates. A reset updates the keys that you
             *   specify to the default configuration for the component. A merge updates the core
             *   device's component configuration with the keys and values that you specify. The AWS
             *   IoT Greengrass Core software applies reset updates before it applies merge updates.
            ...
            public fun configurationUpdate(
                configurationUpdate: ComponentConfigurationUpdateProperty.Builder.() -> Unit
            )

            /**
             * @param runWith The system user and group that the software uses to run component
             *   processes on the core device. If you omit this parameter, the software uses the
             *   system user and group that you configure for the core device. For more information,
             *   see
             *   [Configure the user and group that run components](https://docs.aws.amazon.com/greengrass/v2/developerguide/configure-greengrass-core-v2.html#configure-component-user)
             *   in the *AWS IoT Greengrass V2 Developer Guide* .
             */
        ...
        private class BuilderImpl : Builder {
             ...
             *   .
             */
            override fun configurationUpdate(
                configurationUpdate: ComponentConfigurationUpdateProperty
            ) {
                cdkBuilder.configurationUpdate(
                    configurationUpdate.let(ComponentConfigurationUpdateProperty::unwrap)
                )
            }
        ...
        internal constructor(
             ...
             * The configuration updates to deploy for the component.
             *
             * You can define reset updates and merge updates. A reset updates the keys that you
             * specify to the default configuration for the component. A merge updates the core
             * device's component configuration with the keys and values that you specify. The AWS
             * IoT Greengrass Core software applies reset updates before it applies merge updates.
             * For more information, see
            ...
            /**
             * The system user and group that the software uses to run component processes on the
             * core device.
             *
             * If you omit this parameter, the software uses the system user and group that you
             * configure for the core device. For more information, see
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ComponentDeploymentSpecificationProperty
            ): software.amazon.awscdk.services.greengrassv2.CfnDeployment.ComponentDeploymentSpecificationProperty =
    ...
    public interface IoTJobAbortCriteriaProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param thresholdPercentage The minimum percentage of `failureType` failures that
             *   occur before the job can cancel. This parameter supports up to two digits after the
             *   decimal (for example, you can specify `10.9` or `10.99` , but not `10.999` ).
             */
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-greengrassv2-deployment-iotjobabortcriteria.html#cfn-greengrassv2-deployment-iotjobabortcriteria-minnumberofexecutedthings)
             */
            override fun minNumberOfExecutedThings(): Number =
             ...
             * cancel.
             *
             * This parameter supports up to two digits after the decimal (for example, you can
             * specify `10.9` or `10.99` , but not `10.999` ).
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-greengrassv2-deployment-iotjobabortcriteria.html#cfn-greengrassv2-deployment-iotjobabortcriteria-thresholdpercentage)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: IoTJobAbortCriteriaProperty
            ): software.amazon.awscdk.services.greengrassv2.CfnDeployment.IoTJobAbortCriteriaProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DeploymentConfigurationValidationPolicyProperty {
        ...
        public interface Builder {
            /**
             * @param timeoutInSeconds The amount of time in seconds that a component can validate
             *   its configuration updates. If the validation time exceeds this timeout, then the
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DeploymentConfigurationValidationPolicyProperty
            ): software.amazon.awscdk.services.greengrassv2.CfnDeployment.DeploymentConfigurationValidationPolicyProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SystemResourceLimitsProperty {
        ...
        /**
         * The maximum amount of RAM, expressed in kilobytes, that a component's processes can use
         * on the core device.
         *
         * For more information, see
        ...
        public interface Builder {
            /**
             * @param cpus The maximum amount of CPU time that a component's processes can use on
             *   the core device. A core device's total CPU time is equivalent to the device's
             *   number of CPU cores. For example, on a core device with 4 CPU cores, you can set
             *   this value to 2 to limit the component's processes to 50 percent usage of each CPU
             ...
             *   number greater than the number of CPU cores, the AWS IoT Greengrass Core software
             ...
             *   processes can use on the core device. For more information, see
             *   [Configure system resource limits for components](https://docs.aws.amazon.com/greengrass/v2/developerguide/configure-greengrass-core-v2.html#configure-component-system-resource-limits)
             *   .
             */
        ...
        internal constructor(
             ...
             * A core device's total CPU time is equivalent to the device's number of CPU cores. For
             * example, on a core device with 4 CPU cores, you can set this value to 2 to limit the
             * component's processes to 50 percent usage of each CPU core. On a device with 1 CPU
             * core, you can set this value to 0.25 to limit the component's processes to 25 percent
             * usage of the CPU. If you set this value to a number greater than the number of CPU
             * cores, the AWS IoT Greengrass Core software doesn't limit the component's CPU usage.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-greengrassv2-deployment-systemresourcelimits.html#cfn-greengrassv2-deployment-systemresourcelimits-cpus)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SystemResourceLimitsProperty
            ): software.amazon.awscdk.services.greengrassv2.CfnDeployment.SystemResourceLimitsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface IoTJobTimeoutConfigProperty {
        ...
        public interface Builder {
            /**
             * @param inProgressTimeoutInMinutes The amount of time, in minutes, that devices have
             *   to complete the job. The timer starts when the job status is set to `IN_PROGRESS` .
             *   If the job status doesn't change to a terminal state before the time expires, then
        ...
        internal constructor(
             ...
             * The amount of time, in minutes, that devices have to complete the job.
             *
             * The timer starts when the job status is set to `IN_PROGRESS` . If the job status
             * doesn't change to a terminal state before the time expires, then the job status is
             * set to `TIMED_OUT` .
             *
             * The timeout interval must be between 1 minute and 7 days (10080 minutes).
             *
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: IoTJobTimeoutConfigProperty
            ): software.amazon.awscdk.services.greengrassv2.CfnDeployment.IoTJobTimeoutConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ComponentConfigurationUpdateProperty {
         ...
         * keeps it's existing configuration for keys and values that you don't specify in this
         ...
         * ( `/` ) and use forward slashes to separate the key for each level in the object. For
        ...
        public interface Builder {
            /**
             * @param merge A serialized JSON string that contains the configuration object to merge
             *   to target devices. The core device merges this configuration with the component's
             *   existing configuration. If this is the first time a component deploys on a device,
             *   the core device merges this configuration with the component's default
            ...
            /**
             * @param reset The list of configuration nodes to reset to default values on target
             *   devices. Use JSON pointers to specify each node to reset. JSON pointers start with
             *   a forward slash ( `/` ) and use forward slashes to separate the key for each level
             *   in the object. For more information, see the
             *   [JSON pointer specification](https://docs.aws.amazon.com/https://tools.ietf.org/html/rfc6901)
             *   and
             *   [Reset configuration updates](https://docs.aws.amazon.com/greengrass/v2/developerguide/update-component-configurations.html#reset-configuration-update)
             *   in the *AWS IoT Greengrass V2 Developer Guide* .
        ...
        internal constructor(
             ...
             * devices.
             *
             * The core device merges this configuration with the component's existing
             * configuration. If this is the first time a component deploys on a device, the core
             * device merges this configuration with the component's default configuration. This
             * means that the core device keeps it's existing configuration for keys and values that
             * you don't specify in this object. For more information, see
             * [Merge configuration updates](https://docs.aws.amazon.com/greengrass/v2/developerguide/update-component-configurations.html#merge-configuration-update)
             * in the *AWS IoT Greengrass V2 Developer Guide* .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-greengrassv2-deployment-componentconfigurationupdate.html#cfn-greengrassv2-deployment-componentconfigurationupdate-merge)
             ...
             * The list of configuration nodes to reset to default values on target devices.
             *
             * Use JSON pointers to specify each node to reset. JSON pointers start with a forward
             * slash ( `/` ) and use forward slashes to separate the key for each level in the
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ComponentConfigurationUpdateProperty
            ): software.amazon.awscdk.services.greengrassv2.CfnDeployment.ComponentConfigurationUpdateProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DeploymentPoliciesProperty {
        ...
        public interface Builder {
            /**
             * @param componentUpdatePolicy The component update policy for the configuration
             *   deployment. This policy defines when it's safe to deploy the configuration to
             *   devices.
             */
            ...
            public fun componentUpdatePolicy(
                componentUpdatePolicy: DeploymentComponentUpdatePolicyProperty.Builder.() -> Unit
            )

            /**
             * @param configurationValidationPolicy The configuration validation policy for the
             *   configuration deployment. This policy defines how long each component has to
            ...
            public fun configurationValidationPolicy(
                configurationValidationPolicy:
                    DeploymentConfigurationValidationPolicyProperty.Builder.() -> Unit
            )

            /**
             * @param failureHandlingPolicy The failure handling policy for the configuration
             *   deployment. This policy defines what to do if the deployment fails. Default:
             *   `ROLLBACK`
             */
        ...
        private class BuilderImpl : Builder {
             ...
             *   devices.
             */
            override fun componentUpdatePolicy(
                componentUpdatePolicy: DeploymentComponentUpdatePolicyProperty
            ) {
                cdkBuilder.componentUpdatePolicy(
                    componentUpdatePolicy.let(DeploymentComponentUpdatePolicyProperty::unwrap)
                )
            }
            ...
            override fun componentUpdatePolicy(
                ...
                componentUpdatePolicy(
                    DeploymentComponentUpdatePolicyProperty(componentUpdatePolicy)
                )
            ...
            override fun configurationValidationPolicy(configurationValidationPolicy: IResolvable) {
                cdkBuilder.configurationValidationPolicy(
                    configurationValidationPolicy.let(IResolvable::unwrap)
                )
            }
            ...
            override fun configurationValidationPolicy(
                ...
                cdkBuilder.configurationValidationPolicy(
                    configurationValidationPolicy.let(
                        DeploymentConfigurationValidationPolicyProperty::unwrap
                    )
                )
            }
            ...
            override fun configurationValidationPolicy(
                ...
                configurationValidationPolicy(
                    DeploymentConfigurationValidationPolicyProperty(configurationValidationPolicy)
                )
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DeploymentPoliciesProperty
            ): software.amazon.awscdk.services.greengrassv2.CfnDeployment.DeploymentPoliciesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface IoTJobAbortConfigProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: IoTJobAbortConfigProperty
            ): software.amazon.awscdk.services.greengrassv2.CfnDeployment.IoTJobAbortConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DeploymentComponentUpdatePolicyProperty {
         ...
         *   updates that component. Components can use the
        ...
        public interface Builder {
            /**
             * @param action Whether or not to notify components and wait for components to become
             ...
             *   [Create deployments](https://docs.aws.amazon.com/greengrass/v2/developerguide/create-deployments.html)
             *   in the *AWS IoT Greengrass V2 Developer Guide* .
             * * `SKIP_NOTIFY_COMPONENTS` – The deployment doesn't notify components or wait for
             *   them to be safe to update.
             *
             * Default: `NOTIFY_COMPONENTS`
             */
            public fun action(action: String)
            ...
            /**
             * @param timeoutInSeconds The amount of time in seconds that each component on a device
             *   has to report that it's safe to update. If the component waits for longer than this
        ...
        internal constructor(
             ...
             * safe to update.
             *
             * If the component waits for longer than this timeout, then the deployment proceeds on
             * the device.
             *
             * Default: `60`
             *
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DeploymentComponentUpdatePolicyProperty
            ): software.amazon.awscdk.services.greengrassv2.CfnDeployment.DeploymentComponentUpdatePolicyProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DeploymentIoTJobConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param abortConfig The stop configuration for the job. This configuration defines
            ...
            /**
             * @param jobExecutionsRolloutConfig The rollout configuration for the job. This
             *   configuration defines the rate at which the job rolls out to the fleet of target
             *   devices.
             */
            ...
            public fun jobExecutionsRolloutConfig(
                jobExecutionsRolloutConfig: IoTJobExecutionsRolloutConfigProperty.Builder.() -> Unit
            )

            /**
             * @param timeoutConfig The timeout configuration for the job. This configuration
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("5d858e42f8f3f4ef01f1431c7d10deefde49f8ac38da46d650259358da27a86e")
            override fun abortConfig(
                abortConfig: IoTJobAbortConfigProperty.Builder.() -> Unit
            ...
            override fun jobExecutionsRolloutConfig(jobExecutionsRolloutConfig: IResolvable) {
                cdkBuilder.jobExecutionsRolloutConfig(
                    jobExecutionsRolloutConfig.let(IResolvable::unwrap)
                )
            }
            ...
            override fun jobExecutionsRolloutConfig(
                ...
                cdkBuilder.jobExecutionsRolloutConfig(
                    jobExecutionsRolloutConfig.let(IoTJobExecutionsRolloutConfigProperty::unwrap)
                )
            }
            ...
            override fun jobExecutionsRolloutConfig(
                ...
                jobExecutionsRolloutConfig(
                    IoTJobExecutionsRolloutConfigProperty(jobExecutionsRolloutConfig)
                )
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("5bbff9c41ac0d600277c1581de9bef91b834f376dabcf95949d9426d71cd1527")
            override fun timeoutConfig(
                timeoutConfig: IoTJobTimeoutConfigProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-greengrassv2-deployment-deploymentiotjobconfiguration.html#cfn-greengrassv2-deployment-deploymentiotjobconfiguration-jobexecutionsrolloutconfig)
             */
            override fun jobExecutionsRolloutConfig(): Any? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DeploymentIoTJobConfigurationProperty
            ): software.amazon.awscdk.services.greengrassv2.CfnDeployment.DeploymentIoTJobConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface IoTJobExponentialRolloutRateProperty {
        ...
        public interface Builder {
             ...
             *   notification, per minute, when the job starts. This parameter defines the initial
             *   rollout rate of the job.
             */
            public fun baseRatePerMinute(baseRatePerMinute: Number)

            /**
             * @param incrementFactor The exponential factor to increase the rollout rate for the
             *   job. This parameter supports up to one digit after the decimal (for example, you
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: IoTJobExponentialRolloutRateProperty
            ): software.amazon.awscdk.services.greengrassv2.CfnDeployment.IoTJobExponentialRolloutRateProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ComponentRunWithProperty {
         ...
         * `user:group` . The group is optional. If you don't specify a group, the AWS IoT
         ...
         * user that you configure on the AWS IoT Greengrass nucleus component. For more
         * information, see
         * [Configure the user and group that run components](https://docs.aws.amazon.com/greengrass/v2/developerguide/configure-greengrass-core-v2.html#configure-component-user)
         * .
         *
        ...
        public interface Builder {
            /**
             * @param posixUser The POSIX system user and (optional) group to use to run this
             *   component. Specify the user and group separated by a colon ( `:` ) in the following
             *   format: `user:group` . The group is optional. If you don't specify a group, the AWS
             *   IoT Greengrass Core software uses the primary user for the group.
             */
            public fun posixUser(posixUser: String)

            /**
             * @param systemResourceLimits The system resource limits to apply to this component's
             *   process on the core device. AWS IoT Greengrass supports this feature only on Linux
             *   core devices.
             *
             * If you omit this parameter, the AWS IoT Greengrass Core software uses the default
             * system resource limits that you configure on the AWS IoT Greengrass nucleus
            ...
            public fun systemResourceLimits(
                systemResourceLimits: SystemResourceLimitsProperty.Builder.() -> Unit
            )

            /**
             * @param windowsUser The Windows user to use to run this component on Windows core
             *   devices. The user must exist on each Windows core device, and its name and password
             *   must be in the LocalSystem account's Credentials Manager instance.
             *
             * If you omit this parameter, the AWS IoT Greengrass Core software uses the default
             * Windows user that you configure on the AWS IoT Greengrass nucleus component. For more
             * information, see
             * [Configure the user and group that run components](https://docs.aws.amazon.com/greengrass/v2/developerguide/configure-greengrass-core-v2.html#configure-component-user)
             * .
             */
        ...
        private class BuilderImpl : Builder {
            ...
            override fun systemResourceLimits(systemResourceLimits: SystemResourceLimitsProperty) {
                cdkBuilder.systemResourceLimits(
                    systemResourceLimits.let(SystemResourceLimitsProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("aef781a843243efacf3e7c91fe786e9fcf8a47f6be21dd3ead4beb719503243e")
            override fun systemResourceLimits(
                systemResourceLimits: SystemResourceLimitsProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * The Windows user to use to run this component on Windows core devices.
             *
             * The user must exist on each Windows core device, and its name and password must be in
             * the LocalSystem account's Credentials Manager instance.
             *
             * If you omit this parameter, the AWS IoT Greengrass Core software uses the default
             * Windows user that you configure on the AWS IoT Greengrass nucleus component. For more
             * information, see
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ComponentRunWithProperty
            ): software.amazon.awscdk.services.greengrassv2.CfnDeployment.ComponentRunWithProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface IoTJobExecutionsRolloutConfigProperty {
        ...
        public interface Builder {
            ...
            public fun exponentialRate(
                exponentialRate: IoTJobExponentialRolloutRateProperty.Builder.() -> Unit
            )
        ...
        private class BuilderImpl : Builder {
            ...
            override fun exponentialRate(exponentialRate: IoTJobExponentialRolloutRateProperty) {
                cdkBuilder.exponentialRate(
                    exponentialRate.let(IoTJobExponentialRolloutRateProperty::unwrap)
                )
            }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: IoTJobExecutionsRolloutConfigProperty
            ): software.amazon.awscdk.services.greengrassv2.CfnDeployment.IoTJobExecutionsRolloutConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
