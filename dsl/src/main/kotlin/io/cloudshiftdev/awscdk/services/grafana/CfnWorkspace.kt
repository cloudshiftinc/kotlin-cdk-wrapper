...
internal constructor(
     ...
     * Type: Timestamp
     */
    public open fun attrModificationTimestamp(): String =
        unwrap(this).getAttrModificationTimestamp()
     ...
     * authenticate users for using the Grafana console within a workspace. For more information,
     * see
    ...
    public open fun networkAccessControl(
        `value`: NetworkAccessControlProperty.Builder.() -> Unit
     ...
     */
    public open fun organizationalUnits(): List<String> =
    ...
    public interface Builder {
        /**
         * Specifies whether the workspace can access AWS resources in this AWS account only, or
         * whether it can also access AWS resources in other accounts in the same organization.
         *
         ...
         *
         * @param accountAccessType Specifies whether the workspace can access AWS resources in this
         *   AWS account only, or whether it can also access AWS resources in other accounts in the
         *   same organization.
         */
        ...
        /**
         * Specifies the AWS data sources that have been configured to have IAM roles and
         ...
         *
         * @param dataSources Specifies the AWS data sources that have been configured to have IAM
         ...
         * Specifies the version of Grafana to support in the workspace.
         *
         * Defaults to the latest version on create (for example, 9.4), or the current version of
         * the workspace on update.
         *
         ...
         *
         * @param networkAccessControl The configuration settings for network access to your
         *   workspace.
         */
        ...
        public fun networkAccessControl(
            networkAccessControl: NetworkAccessControlProperty.Builder.() -> Unit
        )

        /**
         * The AWS notification channels that Amazon Managed Grafana can automatically create IAM
         ...
         *
         * @param notificationDestinations The AWS notification channels that Amazon Managed Grafana
         ...
         *
         * @param organizationRoleName The name of the IAM role that is used to access resources
         ...
         *
         * @param organizationalUnits Specifies the organizational units that this workspace is
         *   allowed to use data sources from, if this workspace is in an account that is part of an
         *   organization.
         */
         ...
         * If this is `SERVICE_MANAGED` , and the workplace was created through the Amazon Managed
         * Grafana console, then Amazon Managed Grafana automatically creates the IAM roles and
         * provisions the permissions that the workspace needs to use AWS data sources and
         ...
         * data sources in other AWS accounts in the organization, this parameter must be set to
         * `CUSTOMER_MANAGED` .
         *
         ...
         *
         * @param permissionType If this is `SERVICE_MANAGED` , and the workplace was created
         *   through the Amazon Managed Grafana console, then Amazon Managed Grafana automatically
         *   creates the IAM roles and provisions the permissions that the workspace needs to use
         *   AWS data sources and notification channels.
         */
        ...
        /**
         * The IAM role that grants permissions to the AWS resources that the workspace will view
         * data from.
         *
         ...
         *
         * @param roleArn The IAM role that grants permissions to the AWS resources that the
         ...
         *
         * @param samlConfiguration If the workspace uses SAML, use this structure to map SAML
        ...
        public fun samlConfiguration(
            samlConfiguration: SamlConfigurationProperty.Builder.() -> Unit
        )

        /**
         * The name of the AWS CloudFormation stack set that is used to generate IAM roles to be
         ...
         *
         * @param stackSetName The name of the AWS CloudFormation stack set that is used to generate
    ...
    private class BuilderImpl(
         ...
         *   sources.
         */
        override fun dataSources(vararg dataSources: String): Unit =
        ...
        override fun networkAccessControl(networkAccessControl: NetworkAccessControlProperty) {
            cdkBuilder.networkAccessControl(
                networkAccessControl.let(NetworkAccessControlProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("df2922984192277a6cb4babdf86c15baf8ea0664de96e9273ca37d3ccaf3d04d")
        override fun networkAccessControl(
            networkAccessControl: NetworkAccessControlProperty.Builder.() -> Unit
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("19f9da4b10020d14cb5d2bc9761e2de07ca9b315e7d18d487e8454cf8b620839")
        override fun samlConfiguration(
            samlConfiguration: SamlConfigurationProperty.Builder.() -> Unit
        ...
        public fun build(): software.amazon.awscdk.services.grafana.CfnWorkspace =
            cdkBuilder.build()
    }
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnWorkspace
        ): software.amazon.awscdk.services.grafana.CfnWorkspace = wrapped.cdkObject
    }
    ...
    public interface AssertionAttributesProperty {
        ...
        public interface Builder {
            /**
             * @param email The name of the attribute within the SAML assertion to use as the email
             *   names for SAML users.
             */
            public fun email(email: String)

            /**
             * @param groups The name of the attribute within the SAML assertion to use as the user
             *   full "friendly" names for user groups.
             */
            public fun groups(groups: String)

            /**
             * @param login The name of the attribute within the SAML assertion to use as the login
             *   names for SAML users.
             */
            public fun login(login: String)

            /**
             * @param name The name of the attribute within the SAML assertion to use as the user
             *   full "friendly" names for SAML users.
             */
            public fun name(name: String)

            /**
             * @param org The name of the attribute within the SAML assertion to use as the user
             *   full "friendly" names for the users' organizations.
             */
            public fun org(org: String)

            /**
             * @param role The name of the attribute within the SAML assertion to use as the user
             *   roles.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AssertionAttributesProperty
            ): software.amazon.awscdk.services.grafana.CfnWorkspace.AssertionAttributesProperty =
    ...
    public interface SamlConfigurationProperty {
         ...
         */
        public fun allowedOrganizations(): List<String> =
        ...
        public interface Builder {
            /**
             * @param allowedOrganizations Lists which organizations defined in the SAML assertion
             *   are allowed to use the Amazon Managed Grafana workspace. If this is empty, all
            ...
            /**
             * @param assertionAttributes A structure that defines which attributes in the SAML
             *   assertion are to be used to define information about the users authenticated by
            ...
            public fun assertionAttributes(
                assertionAttributes: AssertionAttributesProperty.Builder.() -> Unit
            )

            /**
             * @param idpMetadata A structure containing the identity provider (IdP) metadata used
            ...
            /**
             * @param loginValidityDuration How long a sign-on session by a SAML user is valid,
             *   before the user has to sign on again.
             */
            public fun loginValidityDuration(loginValidityDuration: Number)

            /**
             * @param roleValues A structure containing arrays that map group names in the SAML
        ...
        private class BuilderImpl : Builder {
            ...
            override fun assertionAttributes(assertionAttributes: AssertionAttributesProperty) {
                cdkBuilder.assertionAttributes(
                    assertionAttributes.let(AssertionAttributesProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("04e8718853837bb26880a91e92d3c04665c0bb5204515f23f9cde811673e1eb2")
            override fun assertionAttributes(
                assertionAttributes: AssertionAttributesProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-grafana-workspace-samlconfiguration.html#cfn-grafana-workspace-samlconfiguration-allowedorganizations)
             */
            override fun allowedOrganizations(): List<String> =
                unwrap(this).getAllowedOrganizations() ?: emptyList()
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SamlConfigurationProperty
            ): software.amazon.awscdk.services.grafana.CfnWorkspace.SamlConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface NetworkAccessControlProperty {
         ...
         * allowed to access your workspace. If the list is not included in the configuration
         * (passed an empty array) then no IP addresses are allowed to access the workspace. You
         ...
         * within a VPC. If a `NetworkAccessConfiguration` is specified then only VPC endpoints
         * specified here are allowed to access the workspace. If you pass in an empty array of
         ...
         * workspaces (using the `com.amazonaws.[region].grafana-workspace` service endpoint). Other
        ...
        public interface Builder {
            /**
             * @param prefixListIds An array of prefix list IDs. A prefix list is a list of CIDR
             *   ranges of IP addresses. The IP addresses specified are allowed to access your
             *   workspace. If the list is not included in the configuration (passed an empty array)
             *   then no IP addresses are allowed to access the workspace. You create a prefix list
            ...
            /**
             * @param vpceIds An array of Amazon VPC endpoint IDs for the workspace. You can create
             *   VPC endpoints to your Amazon Managed Grafana workspace for access from within a
             *   VPC. If a `NetworkAccessConfiguration` is specified then only VPC endpoints
             ...
             * Grafana workspaces (using the `com.amazonaws.[region].grafana-workspace` service
        ...
        internal constructor(
             ...
             * An array of prefix list IDs.
             *
             * A prefix list is a list of CIDR ranges of IP addresses. The IP addresses specified
             * are allowed to access your workspace. If the list is not included in the
             * configuration (passed an empty array) then no IP addresses are allowed to access the
             * workspace. You create a prefix list using the Amazon VPC console.
             *
             * Prefix list IDs have the format `pl- *1a2b3c4d*` .
             *
             * For more information about prefix lists, see
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-grafana-workspace-networkaccesscontrol.html#cfn-grafana-workspace-networkaccesscontrol-prefixlistids)
             */
            override fun prefixListIds(): List<String> =
                unwrap(this).getPrefixListIds() ?: emptyList()
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: NetworkAccessControlProperty
            ): software.amazon.awscdk.services.grafana.CfnWorkspace.NetworkAccessControlProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface VpcConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param securityGroupIds The list of Amazon EC2 security group IDs attached to the
    ...
    public interface RoleValuesProperty {
        ...
        internal constructor(
            ...
            /**
             * A list of groups from the SAML assertion attribute to grant the Grafana `Admin` role
             * to.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-grafana-workspace-rolevalues.html#cfn-grafana-workspace-rolevalues-admin)
             */
            ...
            /**
             * A list of groups from the SAML assertion attribute to grant the Grafana `Editor` role
             * to.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-grafana-workspace-rolevalues.html#cfn-grafana-workspace-rolevalues-editor)
             */
