...
internal constructor(
    ...
    public interface Builder {
         ...
         *   permissions. Before you can create a portal that uses IAM Identity Center , you must
         ...
         * * `IAM` – The portal uses AWS Identity and Access Management ( IAM ) to authenticate
         ...
         *
         * @param portalAuthMode The service to use to authenticate users to the portal. Choose from
         ...
         * a service role that allows the portal's users to access your AWS IoT SiteWise resources
         ...
         *   service role that allows the portal's users to access your AWS IoT SiteWise resources
         *   on your behalf. For more information, see
         *   [Using service roles for AWS IoT SiteWise Monitor](https://docs.aws.amazon.com/iot-sitewise/latest/userguide/monitor-service-role.html)
         *   in the *AWS IoT SiteWise User Guide* .
         */
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.iotsitewise.CfnPortal =
            cdkBuilder.build()
    }
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnPortal
        ): software.amazon.awscdk.services.iotsitewise.CfnPortal = wrapped.cdkObject
    }

    public interface AlarmsProperty {
        /**
         * The [ARN](https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html) of
         * the IAM role that allows the alarm to perform actions and access AWS resources and
        ...
        public interface Builder {
             ...
             *   and services, such as AWS IoT Events .
             */
        ...
        internal constructor(
             ...
             * of the IAM role that allows the alarm to perform actions and access AWS resources and
             * services, such as AWS IoT Events .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-iotsitewise-portal-alarms.html#cfn-iotsitewise-portal-alarms-alarmrolearn)
             */
