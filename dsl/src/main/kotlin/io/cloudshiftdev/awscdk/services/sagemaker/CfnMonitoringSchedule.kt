...
internal constructor(
    ...
    public open fun attrMonitoringScheduleArn(): String =
        unwrap(this).getAttrMonitoringScheduleArn()
    ...
    public open fun lastMonitoringExecutionSummary(`value`: MonitoringExecutionSummaryProperty) {
        unwrap(this)
            .setLastMonitoringExecutionSummary(
                `value`.let(MonitoringExecutionSummaryProperty::unwrap)
            )
    }
    ...
    public open fun lastMonitoringExecutionSummary(
        `value`: MonitoringExecutionSummaryProperty.Builder.() -> Unit
    ...
    public open fun monitoringScheduleConfig(`value`: MonitoringScheduleConfigProperty) {
        unwrap(this)
            .setMonitoringScheduleConfig(`value`.let(MonitoringScheduleConfigProperty::unwrap))
    }
    ...
    public open fun monitoringScheduleConfig(
        `value`: MonitoringScheduleConfigProperty.Builder.() -> Unit
    ...
    public interface Builder {
        ...
        public fun lastMonitoringExecutionSummary(
            lastMonitoringExecutionSummary: MonitoringExecutionSummaryProperty.Builder.() -> Unit
        )
        ...
        public fun monitoringScheduleConfig(
            monitoringScheduleConfig: MonitoringScheduleConfigProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.sagemaker.CfnMonitoringSchedule.Builder.create(
                scope,
                id
            )
        ...
        override fun lastMonitoringExecutionSummary(lastMonitoringExecutionSummary: IResolvable) {
            cdkBuilder.lastMonitoringExecutionSummary(
                lastMonitoringExecutionSummary.let(IResolvable::unwrap)
            )
        }
         ...
         *   there was one.
         */
        override fun lastMonitoringExecutionSummary(
            lastMonitoringExecutionSummary: MonitoringExecutionSummaryProperty
        ) {
            cdkBuilder.lastMonitoringExecutionSummary(
                lastMonitoringExecutionSummary.let(MonitoringExecutionSummaryProperty::unwrap)
            )
        }
        ...
        override fun lastMonitoringExecutionSummary(
            ...
            lastMonitoringExecutionSummary(
                MonitoringExecutionSummaryProperty(lastMonitoringExecutionSummary)
            )
         ...
         *   schedule and defines the monitoring job.
         */
        override fun monitoringScheduleConfig(
            monitoringScheduleConfig: MonitoringScheduleConfigProperty
        ) {
            cdkBuilder.monitoringScheduleConfig(
                monitoringScheduleConfig.let(MonitoringScheduleConfigProperty::unwrap)
            )
        }
        ...
        override fun monitoringScheduleConfig(
            ...
            monitoringScheduleConfig(MonitoringScheduleConfigProperty(monitoringScheduleConfig))
    ...
    public interface StoppingConditionProperty {
         ...
         * generated. We recommend starting with 900 seconds and increasing as necessary based on
         * your model.
         *
         * For all other jobs, if the job does not complete during this time, SageMaker ends the
        ...
        public interface Builder {
             ...
             *   compilation job can run before it is stopped. For compilation jobs, if the job does
             *   not complete during this time, a `TimeOut` error is generated. We recommend
             *   starting with 900 seconds and increasing as necessary based on your model.
             *
             * For all other jobs, if the job does not complete during this time, SageMaker ends the
             * job. When `RetryStrategy` is specified in the job request, `MaxRuntimeInSeconds`
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: StoppingConditionProperty
            ): software.amazon.awscdk.services.sagemaker.CfnMonitoringSchedule.StoppingConditionProperty =
    ...
    public interface BatchTransformInputProperty {
        ...
        public interface Builder {
            /**
             * @param dataCapturedDestinationS3Uri The Amazon S3 location being used to capture the
             *   data.
             */
            ...
            /**
             * @param localPath Path to the filesystem where the batch transform data is available
             *   to the container.
             */
             ...
             *   replicated or sharded by an S3 key. Defaults to `FullyReplicated`
             */
            public fun s3DataDistributionType(s3DataDistributionType: String)

            /**
             * @param s3InputMode Whether the `Pipe` or `File` is used as the input mode for
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("5e1de90d889696aab90fdc83d5b3ac4a95499185210d1ae296f177b70867162e")
            override fun datasetFormat(
                datasetFormat: DatasetFormatProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-sagemaker-monitoringschedule-batchtransforminput.html#cfn-sagemaker-monitoringschedule-batchtransforminput-excludefeaturesattribute)
             */
            override fun excludeFeaturesAttribute(): String? =
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-sagemaker-monitoringschedule-batchtransforminput.html#cfn-sagemaker-monitoringschedule-batchtransforminput-s3datadistributiontype)
             */
            override fun s3DataDistributionType(): String? =
             ...
             * monitoring job.
             *
             * `Pipe` mode is recommended for large datasets. `File` mode is useful for small files
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: BatchTransformInputProperty
            ): software.amazon.awscdk.services.sagemaker.CfnMonitoringSchedule.BatchTransformInputProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface EndpointInputProperty {
        ...
        public interface Builder {
            /**
             * @param endpointName An endpoint in customer's account which has enabled
            ...
            /**
             * @param s3DataDistributionType Whether input data distributed in Amazon S3 is fully
             *   replicated or sharded by an Amazon S3 key. Defaults to `FullyReplicated`
             */
            public fun s3DataDistributionType(s3DataDistributionType: String)
    ...
    public interface MonitoringAppSpecificationProperty {
         ...
         */
        public fun containerArguments(): List<String> =
            unwrap(this).getContainerArguments() ?: emptyList()
         ...
         */
        public fun containerEntrypoint(): List<String> =
         ...
         *
         * It can base64 decode the payload and convert it into a flattened JSON so that the
         * built-in container can use the converted data. Applicable only for the built-in (first
         * party) containers.
         *
        ...
        public interface Builder {
             ...
             *   after analysis has been performed. Applicable only for the built-in (first party)
             *   containers.
             */
            public fun postAnalyticsProcessorSourceUri(postAnalyticsProcessorSourceUri: String)

            /**
             * @param recordPreprocessorSourceUri An Amazon S3 URI to a script that is called per
             *   row prior to running analysis. It can base64 decode the payload and convert it into
             *   a flattened JSON so that the built-in container can use the converted data.
             *   Applicable only for the built-in (first party) containers.
             */
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-sagemaker-monitoringschedule-monitoringappspecification.html#cfn-sagemaker-monitoringschedule-monitoringappspecification-containerarguments)
             */
            override fun containerArguments(): List<String> =
                unwrap(this).getContainerArguments() ?: emptyList()
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-sagemaker-monitoringschedule-monitoringappspecification.html#cfn-sagemaker-monitoringschedule-monitoringappspecification-containerentrypoint)
             */
            override fun containerEntrypoint(): List<String> =
                unwrap(this).getContainerEntrypoint() ?: emptyList()
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: MonitoringAppSpecificationProperty
            ): software.amazon.awscdk.services.sagemaker.CfnMonitoringSchedule.MonitoringAppSpecificationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface MonitoringOutputConfigProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param monitoringOutputs Monitoring outputs for monitoring jobs. This is where the
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: MonitoringOutputConfigProperty
            ): software.amazon.awscdk.services.sagemaker.CfnMonitoringSchedule.MonitoringOutputConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface MonitoringInputProperty {
        ...
        public interface Builder {
            ...
            public fun batchTransformInput(
                batchTransformInput: BatchTransformInputProperty.Builder.() -> Unit
            )
        ...
        private class BuilderImpl : Builder {
            ...
            override fun batchTransformInput(batchTransformInput: BatchTransformInputProperty) {
                cdkBuilder.batchTransformInput(
                    batchTransformInput.let(BatchTransformInputProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("db41791840963983b97700ef7ac73e98d09b85c6db56bd096e155140e7f40940")
            override fun batchTransformInput(
                batchTransformInput: BatchTransformInputProperty.Builder.() -> Unit
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("c253a1262d85ceceb38075f6ddcf0a394d94ac975e8b3c6196b29e44dccf0b73")
            override fun endpointInput(
                endpointInput: EndpointInputProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: MonitoringInputProperty
            ): software.amazon.awscdk.services.sagemaker.CfnMonitoringSchedule.MonitoringInputProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface VpcConfigProperty {
         ...
         *
         * For information about the availability of specific instance types, see
        ...
        public interface Builder {
            ...
            /**
             * @param subnets The ID of the subnets in the VPC to which you want to connect your
             *   training job or model. For information about the availability of specific instance
             *   types, see
             *   [Supported Instance Types and Availability Zones](https://docs.aws.amazon.com/sagemaker/latest/dg/instance-types-az.html)
             *   .
             */
    ...
    public interface MonitoringExecutionSummaryProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param lastModifiedTime A timestamp that indicates the last time the monitoring job
             *   was modified.
             */
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-sagemaker-monitoringschedule-monitoringexecutionsummary.html#cfn-sagemaker-monitoringschedule-monitoringexecutionsummary-monitoringexecutionstatus)
             */
            override fun monitoringExecutionStatus(): String =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: MonitoringExecutionSummaryProperty
            ): software.amazon.awscdk.services.sagemaker.CfnMonitoringSchedule.MonitoringExecutionSummaryProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface MonitoringOutputProperty {
        ...
        public interface Builder {
            /**
             * @param s3Output The Amazon S3 storage location where the results of a monitoring job
             *   are saved.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: MonitoringOutputProperty
            ): software.amazon.awscdk.services.sagemaker.CfnMonitoringSchedule.MonitoringOutputProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ConstraintsResourceProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ConstraintsResourceProperty
            ): software.amazon.awscdk.services.sagemaker.CfnMonitoringSchedule.ConstraintsResourceProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface MonitoringJobDefinitionProperty {
        ...
        public interface Builder {
            /**
             * @param baselineConfig Baseline configuration used to validate that the data conforms
            ...
            /**
             * @param monitoringAppSpecification Configures the monitoring job to run a specified
            ...
            public fun monitoringAppSpecification(
                monitoringAppSpecification: MonitoringAppSpecificationProperty.Builder.() -> Unit
            )

            /**
             * @param monitoringInputs The array of inputs for the monitoring job. Currently we
            ...
            /**
             * @param monitoringOutputConfig The array of outputs from the monitoring job to be
            ...
            public fun monitoringOutputConfig(
                monitoringOutputConfig: MonitoringOutputConfigProperty.Builder.() -> Unit
            )

            /**
             * @param monitoringResources Identifies the resources, ML compute instances, and ML
             *   storage volumes to deploy for a monitoring job. In distributed processing, you
            ...
            public fun monitoringResources(
                monitoringResources: MonitoringResourcesProperty.Builder.() -> Unit
            )
            ...
            /**
             * @param roleArn The Amazon Resource Name (ARN) of an IAM role that Amazon SageMaker
             *   can assume to perform tasks on your behalf.
             */
            public fun roleArn(roleArn: String)

            /**
             * @param stoppingCondition Specifies a time limit for how long the monitoring job is
             *   allowed to run.
             */
            ...
            public fun stoppingCondition(
                stoppingCondition: StoppingConditionProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("b25d852cd5d3c2a37f56c5a52e7ca9a2a71206ade16624d6cc4a9b0beff29c31")
            override fun baselineConfig(
                baselineConfig: BaselineConfigProperty.Builder.() -> Unit
            ...
            override fun monitoringAppSpecification(monitoringAppSpecification: IResolvable) {
                cdkBuilder.monitoringAppSpecification(
                    monitoringAppSpecification.let(IResolvable::unwrap)
                )
            }
             ...
             *   Docker container image.
             */
            override fun monitoringAppSpecification(
                monitoringAppSpecification: MonitoringAppSpecificationProperty
            ) {
                cdkBuilder.monitoringAppSpecification(
                    monitoringAppSpecification.let(MonitoringAppSpecificationProperty::unwrap)
                )
            }
            ...
            override fun monitoringAppSpecification(
                ...
                monitoringAppSpecification(
                    MonitoringAppSpecificationProperty(monitoringAppSpecification)
                )
             ...
             *   uploaded to Amazon S3.
             */
            override fun monitoringOutputConfig(
                monitoringOutputConfig: MonitoringOutputConfigProperty
            ) {
                cdkBuilder.monitoringOutputConfig(
            ...
            override fun monitoringResources(monitoringResources: MonitoringResourcesProperty) {
                cdkBuilder.monitoringResources(
                    monitoringResources.let(MonitoringResourcesProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("8022d69c22dc6522ee8bdf8ab2a559c644a65bc1751c6bef76f1b088999f08ea")
            override fun monitoringResources(
                monitoringResources: MonitoringResourcesProperty.Builder.() -> Unit
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("ca1e58e1787bc2974f9606bd97a8f34e0a4a7e268cc75127d72db1c607ff1e5c")
            override fun networkConfig(
                networkConfig: NetworkConfigProperty.Builder.() -> Unit
            ...
            override fun stoppingCondition(stoppingCondition: StoppingConditionProperty) {
                cdkBuilder.stoppingCondition(
                    stoppingCondition.let(StoppingConditionProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("cb17ece77e3617d634427f12d51a676b359b03f74b1d2134d41d8f7f1c00f89d")
            override fun stoppingCondition(
                stoppingCondition: StoppingConditionProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-sagemaker-monitoringschedule-monitoringjobdefinition.html#cfn-sagemaker-monitoringschedule-monitoringjobdefinition-monitoringappspecification)
             */
            override fun monitoringAppSpecification(): Any =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: MonitoringJobDefinitionProperty
            ): software.amazon.awscdk.services.sagemaker.CfnMonitoringSchedule.MonitoringJobDefinitionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface MonitoringResourcesProperty {
        ...
        public interface Builder {
            /**
             * @param clusterConfig The configuration for the cluster resources used to run the
             *   processing job.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("3d2b692d1210ed45b37baed02724a97982292097ce28b4a791ca0767901a580d")
            override fun clusterConfig(
                clusterConfig: ClusterConfigProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: MonitoringResourcesProperty
            ): software.amazon.awscdk.services.sagemaker.CfnMonitoringSchedule.MonitoringResourcesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DatasetFormatProperty {
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("27cbe0d83c6f9d282dc965ffde94c2e6a7426393149c5c419f22f80d47c0cbda")
            override fun json(json: JsonProperty.Builder.() -> Unit): Unit =
    ...
    public interface ClusterConfigProperty {
        ...
        public interface Builder {
            /**
             * @param instanceCount The number of ML compute instances to use in the model
             *   monitoring job.
             *
             * For distributed processing jobs, specify a value greater than 1. The default value
             * is 1.
             */
            ...
            /**
             * @param volumeSizeInGb The size of the ML storage volume, in gigabytes, that you want
    ...
    public interface StatisticsResourceProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: StatisticsResourceProperty
            ): software.amazon.awscdk.services.sagemaker.CfnMonitoringSchedule.StatisticsResourceProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ScheduleConfigProperty {
         ...
         *
         * Express this time as an offset to the times that you schedule your monitoring jobs to
         * run. You schedule monitoring jobs with the `ScheduleExpression` parameter. Specify this
         * offset in ISO 8601 duration format. For example, if you want to end the window one hour
         ...
         * than 24 hours. You specify the start time with the `DataAnalysisStartTime` parameter.
         *
         ...
         * Express this time as an offset to the times that you schedule your monitoring jobs to
         * run. You schedule monitoring jobs with the `ScheduleExpression` parameter. Specify this
         * offset in ISO 8601 duration format. For example, if you want to monitor the five hours of
         * data in your dataset that precede the start of each monitoring job, you would specify:
         * `"-PT5H"` .
         *
         * The start time that you specify must not precede the end time that you specify by more
         * than 24 hours. You specify the end time with the `DataAnalysisEndTime` parameter.
         *
         * If you set `ScheduleExpression` to `NOW` , this parameter is required.
         *
        ...
        public interface Builder {
            /**
             * @param dataAnalysisEndTime Sets the end time for a monitoring job window. Express
             *   this time as an offset to the times that you schedule your monitoring jobs to run.
             *   You schedule monitoring jobs with the `ScheduleExpression` parameter. Specify this
             *   offset in ISO 8601 duration format. For example, if you want to end the window one
            ...
            /**
             * @param dataAnalysisStartTime Sets the start time for a monitoring job window. Express
             *   this time as an offset to the times that you schedule your monitoring jobs to run.
             *   You schedule monitoring jobs with the `ScheduleExpression` parameter. Specify this
             ...
             * more than 24 hours. You specify the end time with the `DataAnalysisEndTime`
             * parameter.
             *
             * If you set `ScheduleExpression` to `NOW` , this parameter is required.
             */
            ...
            /**
             * @param scheduleExpression A cron expression that describes details about the
             *   monitoring schedule. The supported cron expressions are:
             * * If you want to set the job to start every hour, use the following:
             *
             * `Hourly: cron(0 * ? * * *)`
             * * If you want to start the job daily:
        ...
        internal constructor(
             ...
             *
             * Express this time as an offset to the times that you schedule your monitoring jobs to
             * run. You schedule monitoring jobs with the `ScheduleExpression` parameter. Specify
             * this offset in ISO 8601 duration format. For example, if you want to end the window
             * one hour before the start of each monitoring job, you would specify: `"-PT1H"` .
             *
             * The end time that you specify must not follow the start time that you specify by more
             * than 24 hours. You specify the start time with the `DataAnalysisStartTime` parameter.
             *
             ...
             * Express this time as an offset to the times that you schedule your monitoring jobs to
             * run. You schedule monitoring jobs with the `ScheduleExpression` parameter. Specify
             * this offset in ISO 8601 duration format. For example, if you want to monitor the five
             * hours of data in your dataset that precede the start of each monitoring job, you
             * would specify: `"-PT5H"` .
             *
             * The start time that you specify must not precede the end time that you specify by
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ScheduleConfigProperty
            ): software.amazon.awscdk.services.sagemaker.CfnMonitoringSchedule.ScheduleConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface S3OutputProperty {
        /**
         * The local path to the S3 storage location where SageMaker saves the results of a
         * monitoring job.
         *
        ...
        public interface Builder {
            ...
            /**
             * @param s3UploadMode Whether to upload the results of the monitoring job continuously
    ...
    public interface BaselineConfigProperty {
        ...
        public interface Builder {
            ...
            public fun constraintsResource(
                constraintsResource: ConstraintsResourceProperty.Builder.() -> Unit
            )
            ...
            public fun statisticsResource(
                statisticsResource: StatisticsResourceProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun constraintsResource(constraintsResource: ConstraintsResourceProperty) {
                cdkBuilder.constraintsResource(
                    constraintsResource.let(ConstraintsResourceProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("60a9519e03630673bb7da9627f7020656378dfcca99f79101f445540f36e8101")
            override fun constraintsResource(
                constraintsResource: ConstraintsResourceProperty.Builder.() -> Unit
            ...
            override fun statisticsResource(statisticsResource: StatisticsResourceProperty) {
                cdkBuilder.statisticsResource(
                    statisticsResource.let(StatisticsResourceProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("92d3382c0ab7be9dec1b304b69e9f65d03676c7c3db097baeb527474f5116586")
            override fun statisticsResource(
                statisticsResource: StatisticsResourceProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: BaselineConfigProperty
            ): software.amazon.awscdk.services.sagemaker.CfnMonitoringSchedule.BaselineConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface MonitoringScheduleConfigProperty {
        ...
        public interface Builder {
            ...
            public fun monitoringJobDefinition(
                monitoringJobDefinition: MonitoringJobDefinitionProperty.Builder.() -> Unit
            )

            /**
             * @param monitoringJobDefinitionName The name of the monitoring job definition to
             *   schedule.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            /** @param monitoringJobDefinition Defines the monitoring job. */
            override fun monitoringJobDefinition(
                monitoringJobDefinition: MonitoringJobDefinitionProperty
            ) {
                cdkBuilder.monitoringJobDefinition(
                    monitoringJobDefinition.let(MonitoringJobDefinitionProperty::unwrap)
                )
            }
            ...
            override fun monitoringJobDefinition(
                ...
                monitoringJobDefinition(MonitoringJobDefinitionProperty(monitoringJobDefinition))
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("d4171e772520d95691b15ef908333ba913df631dbe57a741ae90235c7af47092")
            override fun scheduleConfig(
                scheduleConfig: ScheduleConfigProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: MonitoringScheduleConfigProperty
            ): software.amazon.awscdk.services.sagemaker.CfnMonitoringSchedule.MonitoringScheduleConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface NetworkConfigProperty {
        ...
        public interface Builder {
            /**
             * @param enableInterContainerTrafficEncryption Whether to encrypt all communications
             *   between distributed processing jobs. Choose `True` to encrypt communications.
             *   Encryption provides greater security for distributed processing jobs, but the
            ...
            /**
             * @param enableNetworkIsolation Whether to allow inbound and outbound network calls to
            ...
            /**
             * @param vpcConfig Specifies a VPC that your training jobs and hosted models have
        ...
        private class BuilderImpl : Builder {
             ...
             *   processing might take longer.
             */
            override fun enableInterContainerTrafficEncryption(
                enableInterContainerTrafficEncryption: Boolean
            ) {
            ...
            override fun enableInterContainerTrafficEncryption(
                ...
                cdkBuilder.enableInterContainerTrafficEncryption(
                    enableInterContainerTrafficEncryption.let(IResolvable::unwrap)
                )
            }
