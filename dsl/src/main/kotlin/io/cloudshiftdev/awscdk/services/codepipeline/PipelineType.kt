...
public enum class PipelineType(
  ...
  public companion object {
    internal fun wrap(cdkObject: software.amazon.awscdk.services.codepipeline.PipelineType):
        PipelineType = when (cdkObject) {
    ...
    internal fun unwrap(wrapped: PipelineType):
