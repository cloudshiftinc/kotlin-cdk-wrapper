...
internal constructor(
    ...
    public interface Builder {
         ...
         *   that you want to mask. For more information about the available options, see
         ...
         * audit findings to. If you specify destinations such as log groups, Firehose streams, and
         * S3 buckets, they must already exist.
        ...
        /**
         * Currently the only valid value for this parameter is `ALL` , which specifies that the
         * policy applies to all log groups in the account.
         *
         * If you omit this parameter, the default of `ALL` is used. To scope down a subscription
         * filter policy to a subset of log groups, use the `selectionCriteria` parameter.
         *
         ...
         * account.
         *
         * Currently, the only supported filter is `LogGroupName NOT IN []` . The
         * `selectionCriteria` string can be up to 25KB in length. The length is determined by using
         * its UTF-8 bytes.
         *
         * Using the `selectionCriteria` parameter is useful to help prevent infinite loops. For
         ...
         *
         * @param selectionCriteria Use this parameter to apply a subscription filter policy to a
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.logs.CfnAccountPolicy =
            cdkBuilder.build()
    }
