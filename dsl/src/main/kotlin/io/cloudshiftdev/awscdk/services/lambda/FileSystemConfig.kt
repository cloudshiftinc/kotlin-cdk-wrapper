...
public interface FileSystemConfig {
     ...
     */
    public fun dependency(): List<IDependable> =
    ...
    private class BuilderImpl : Builder {
        ...
        /** @param dependency array of IDependable that lambda function depends on. */
        override fun dependency(vararg dependency: IDependable): Unit =
        ...
        public fun build(): software.amazon.awscdk.services.lambda.FileSystemConfig =
            cdkBuilder.build()
    }
