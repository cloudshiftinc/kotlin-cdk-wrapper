...
internal constructor(
    ...
    public interface Builder {
         ...
         * Indicates whether to force the revoke action.
         *
         * If true, the Redshift-managed VPC endpoints associated with the endpoint authorization
         * are also deleted.
         *
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.redshift.CfnEndpointAuthorization.Builder.create(
                scope,
                id
            )
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnEndpointAuthorization
