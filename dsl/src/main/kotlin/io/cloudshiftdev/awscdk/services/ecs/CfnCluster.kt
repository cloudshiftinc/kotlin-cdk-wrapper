...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.ecs.CfnCluster,
    ...
    public open fun capacityProviders(): List<String> =
        unwrap(this).getCapacityProviders() ?: emptyList()
    ...
    public open fun serviceConnectDefaults(
        `value`: ServiceConnectDefaultsProperty.Builder.() -> Unit
    ): Unit = serviceConnectDefaults(ServiceConnectDefaultsProperty(`value`))
    ...
    public interface Builder {
         ...
         * The short name of one or more capacity providers to associate with the cluster.
         *
         * A capacity provider must be associated with a cluster before it can be included as part
         ...
         * capacity providers. The AWS Fargate capacity providers are available to all accounts and
         ...
         *
         * @param capacityProviders The short name of one or more capacity providers to associate
         *   with the cluster.
         */
         ...
         * A user-generated string that you use to identify your cluster.
         *
         * If you don't specify a name, AWS CloudFormation generates a unique physical ID for the
         * name.
         *
         ...
         * the `ServiceConnectConfiguration` . You can set the namespace of each service
         ...
         *
         * @param serviceConnectDefaults Use this parameter to set a default Service Connect
         *   namespace.
         */
        ...
        public fun serviceConnectDefaults(
            serviceConnectDefaults: ServiceConnectDefaultsProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
        ...
        override fun configuration(
            configuration: ClusterConfigurationProperty.Builder.() -> Unit
        ): Unit = configuration(ClusterConfigurationProperty(configuration))
        ...
        override fun defaultCapacityProviderStrategy(defaultCapacityProviderStrategy: IResolvable) {
            cdkBuilder.defaultCapacityProviderStrategy(
                defaultCapacityProviderStrategy.let(IResolvable::unwrap)
            )
        }
         ...
         *   cluster.
         */
        override fun defaultCapacityProviderStrategy(
            vararg defaultCapacityProviderStrategy: Any
        ): Unit = defaultCapacityProviderStrategy(defaultCapacityProviderStrategy.toList())
         ...
         *   namespace.
         */
        override fun serviceConnectDefaults(
            serviceConnectDefaults: ServiceConnectDefaultsProperty
        ) {
            cdkBuilder.serviceConnectDefaults(
                serviceConnectDefaults.let(ServiceConnectDefaultsProperty::unwrap)
            )
        }
    ...
    public interface ExecuteCommandLogConfigurationProperty {
         ...
         */
        public fun cloudWatchEncryptionEnabled(): Any? =
        ...
        public interface Builder {
            /**
             * @param cloudWatchEncryptionEnabled Determines whether to use encryption on the
             *   CloudWatch logs. If not specified, encryption will be off.
             */
            ...
            /**
             * @param s3EncryptionEnabled Determines whether to use encryption on the S3 logs. If
        ...
        private class BuilderImpl : Builder {
            ...
            override fun cloudWatchEncryptionEnabled(cloudWatchEncryptionEnabled: IResolvable) {
                cdkBuilder.cloudWatchEncryptionEnabled(
                    cloudWatchEncryptionEnabled.let(IResolvable::unwrap)
                )
            }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ExecuteCommandLogConfigurationProperty
            ): software.amazon.awscdk.services.ecs.CfnCluster.ExecuteCommandLogConfigurationProperty =
    ...
    public interface ExecuteCommandConfigurationProperty {
         ...
         *   parameter is specified, it defaults to this value. If no `awslogs` log driver is
        ...
        public interface Builder {
            /**
             * @param kmsKeyId Specify an AWS Key Management Service key ID to encrypt the data
             ...
             *   actions. The logs can be sent to CloudWatch Logs or an Amazon S3 bucket. When
            ...
            public fun logConfiguration(
                logConfiguration: ExecuteCommandLogConfigurationProperty.Builder.() -> Unit
            )
        ...
        private class BuilderImpl : Builder {
            ...
            override fun logConfiguration(
                ...
                cdkBuilder.logConfiguration(
                    logConfiguration.let(ExecuteCommandLogConfigurationProperty::unwrap)
                )
            }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ExecuteCommandConfigurationProperty
            ): software.amazon.awscdk.services.ecs.CfnCluster.ExecuteCommandConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ClusterSettingsProperty {
         ...
         * `containerInsights` account setting is turned on. If a cluster value is specified, it
         * will override the `containerInsights` value set with
        ...
        public interface Builder {
            ...
            /**
             * @param value The value to set for the cluster setting. The supported values are
             *   `enabled` and `disabled` . If you set `name` to `containerInsights` and `value` to
             *   `enabled` , CloudWatch Container Insights will be on for the cluster, otherwise it
             *   will be off unless the `containerInsights` account setting is turned on. If a
             *   cluster value is specified, it will override the `containerInsights` value set with
             *   [PutAccountSetting](https://docs.aws.amazon.com/AmazonECS/latest/APIReference/API_PutAccountSetting.html)
             *   or
             *   [PutAccountSettingDefault](https://docs.aws.amazon.com/AmazonECS/latest/APIReference/API_PutAccountSettingDefault.html)
             *   .
        ...
        internal constructor(
             ...
             * `disabled` .
             *
             * If you set `name` to `containerInsights` and `value` to `enabled` , CloudWatch
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ClusterSettingsProperty
            ): software.amazon.awscdk.services.ecs.CfnCluster.ClusterSettingsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ClusterConfigurationProperty {
         ...
         */
        public fun executeCommandConfiguration(): Any? =
        ...
        public interface Builder {
            ...
            public fun executeCommandConfiguration(
                executeCommandConfiguration: ExecuteCommandConfigurationProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun executeCommandConfiguration(executeCommandConfiguration: IResolvable) {
                cdkBuilder.executeCommandConfiguration(
                    executeCommandConfiguration.let(IResolvable::unwrap)
                )
            }
             ...
             * @param executeCommandConfiguration The details of the execute command configuration.
             */
            override fun executeCommandConfiguration(
                executeCommandConfiguration: ExecuteCommandConfigurationProperty
            ) {
                cdkBuilder.executeCommandConfiguration(
                    executeCommandConfiguration.let(ExecuteCommandConfigurationProperty::unwrap)
                )
            }
            ...
            override fun executeCommandConfiguration(
                ...
                executeCommandConfiguration(
                    ExecuteCommandConfigurationProperty(executeCommandConfiguration)
                )
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ClusterConfigurationProperty
            ): software.amazon.awscdk.services.ecs.CfnCluster.ClusterConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ServiceConnectDefaultsProperty {
         ...
         *
         * The namespace name can include up to 1024 characters. The name is case-sensitive. The
         * name can't include hyphens (-), tilde (~), greater than (&gt;), less than (&lt;), or
         * slash (/).
         *
         ...
         * AWS Cloud Map namespace with the "API calls" method of instance discovery only. This
         * instance discovery method is the "HTTP" namespace type in the AWS Command Line Interface
        ...
        public interface Builder {
             ...
             *   Cloud Map namespace that's used when you create a service and don't specify a
             *   Service Connect configuration. The namespace name can include up to 1024
             *   characters. The name is case-sensitive. The name can't include hyphens (-), tilde
             ...
             * Region.
             *
             * If you enter a new name, a AWS Cloud Map namespace will be created. Amazon ECS
             * creates a AWS Cloud Map namespace with the "API calls" method of instance discovery
             * only. This instance discovery method is the "HTTP" namespace type in the AWS Command
             * Line Interface . Other types of instance discovery aren't used by Service Connect.
             *
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ServiceConnectDefaultsProperty
            ): software.amazon.awscdk.services.ecs.CfnCluster.ServiceConnectDefaultsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
