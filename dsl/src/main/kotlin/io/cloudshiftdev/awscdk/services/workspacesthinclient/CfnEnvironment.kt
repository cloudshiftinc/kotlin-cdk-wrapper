...
internal constructor(
    ...
    public open fun softwareSetUpdateSchedule(): String? =
        unwrap(this).getSoftwareSetUpdateSchedule()
    ...
    public interface Builder {
         ...
         *
         * @param desktopEndpoint The URL for the identity provider login (only for environments
         ...
         *
         * @param kmsKeyArn The Amazon Resource Name (ARN) of the AWS Key Management Service key
        ...
        public fun maintenanceWindow(
            maintenanceWindow: MaintenanceWindowProperty.Builder.() -> Unit
        )
         ...
         *
         * @param softwareSetUpdateSchedule An option to define if software updates should be
         *   applied within a maintenance window.
         */
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.workspacesthinclient.CfnEnvironment.Builder.create(
                scope,
                id
            )
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("519fda3457d6ed44d5fc04754070dfd2014c3c36808a6805fc980825a2fdd616")
        override fun maintenanceWindow(
            maintenanceWindow: MaintenanceWindowProperty.Builder.() -> Unit
    ...
    public interface MaintenanceWindowProperty {
        ...
        public interface Builder {
            /**
             * @param applyTimeOf The option to set the maintenance window during the device local
             *   time or Universal Coordinated Time (UTC).
             */
            public fun applyTimeOf(applyTimeOf: String)

            /**
             * @param daysOfTheWeek The days of the week during which the maintenance window is
             *   open.
             */
            ...
            /**
             * @param startTimeMinute The minutes past the hour for the maintenance window start (
             *   `00` - `59` ).
             */
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-workspacesthinclient-environment-maintenancewindow.html#cfn-workspacesthinclient-environment-maintenancewindow-daysoftheweek)
             */
            override fun daysOfTheWeek(): List<String> =
                unwrap(this).getDaysOfTheWeek() ?: emptyList()
