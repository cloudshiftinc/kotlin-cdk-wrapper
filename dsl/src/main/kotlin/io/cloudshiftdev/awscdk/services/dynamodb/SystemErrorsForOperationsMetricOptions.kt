...
public interface SystemErrorsForOperationsMetricOptions : MetricOptions {
    ...
    public interface Builder {
        ...
        /**
         * @param statistic What function to use for aggregating. Use the `aws_cloudwatch.Stats`
        ...
        /**
         * @param unit Unit used to filter the metric stream. Only refer to datums emitted to the
         *   metric stream with the given unit and ignore all others. Only useful when datums are
         *   being emitted to the same metric stream under different units.
         *
    ...
    internal constructor(
         ...
         */
        override fun dimensionsMap(): Map<String, String> =
            unwrap(this).getDimensionsMap() ?: emptyMap()
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: SystemErrorsForOperationsMetricOptions
        ): software.amazon.awscdk.services.dynamodb.SystemErrorsForOperationsMetricOptions =
