...
public interface AddRouteOptions {
     ...
     *
     * If true, this route will be added before any AWS resources that depend on internet
     * connectivity in the VPC will be created.
     *
     * Default: false
     */
    public fun enablesInternetConnectivity(): Boolean? =
    ...
    public interface Builder {
        ...
        /**
         * @param routerId The ID of the router. Can be an instance ID, gateway ID, etc, depending
         *   on the router type.
         */
    ...
    internal constructor(
         ...
         * Default: - Uses IPv6
         */
        override fun destinationIpv6CidrBlock(): String? =
