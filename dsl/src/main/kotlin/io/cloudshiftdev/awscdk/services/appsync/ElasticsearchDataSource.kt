...
internal constructor(
    ...
    public interface Builder {
         ...
         */
        @Deprecated(message = "deprecated in CDK") public fun domain(domain: IDomain)
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.appsync.ElasticsearchDataSource.Builder.create(
                scope,
                id
            )
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: ElasticsearchDataSource
