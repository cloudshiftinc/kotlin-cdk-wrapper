...
internal constructor(
    ...
    public companion object {
        ...
        public fun fromAsset(assetPath: String, options: AssetOptions): AssetCode =
            software.amazon.awscdk.services.synthetics.Code.fromAsset(
                    assetPath,
        ...
        public fun fromBucket(bucket: IBucket, key: String): S3Code =
            software.amazon.awscdk.services.synthetics.Code.fromBucket(
        ...
        internal fun unwrap(wrapped: Code): software.amazon.awscdk.services.synthetics.Code =
