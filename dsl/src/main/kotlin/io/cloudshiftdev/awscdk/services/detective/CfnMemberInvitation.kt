...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param disableEmailNotification Whether to send an invitation email to the member
         *   account.
         */
         ...
         *
         * @param graphArn The ARN of the behavior graph to invite the account to contribute data
         *   to.
         */
         ...
         * The root user email address of the invited account.
         *
         * If the email address provided is not the root user email address for the provided
