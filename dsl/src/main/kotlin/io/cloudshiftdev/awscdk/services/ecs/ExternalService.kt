...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.ecs.ExternalService,
    ...
    public override fun associateCloudMapService(
        _options: AssociateCloudMapServiceOptions.Builder.() -> Unit
    ...
    public override fun attachToApplicationTargetGroup(
        ...
        unwrap(this)
            .attachToApplicationTargetGroup(_targetGroup.let(IApplicationTargetGroup::unwrap))
            .let(LoadBalancerTargetProps::wrap)

    /**
     * Overriden method to throw error as `autoScaleTaskCount` is not supported for external
     * service.
     *
     * @param _props
     */
    public override fun autoScaleTaskCount(_props: EnableScalingProps): ScalableTaskCount =
        unwrap(this)
            .autoScaleTaskCount(_props.let(EnableScalingProps::unwrap))
            .let(ScalableTaskCount::wrap)
    ...
    public override fun autoScaleTaskCount(
        _props: EnableScalingProps.Builder.() -> Unit
    ...
    /**
     * Overriden method to throw error as `loadBalancerTarget` is not supported for external
     * service.
     *
     * @param _options
     */
    public override fun loadBalancerTarget(
        _options: LoadBalancerTargetOptions
    ): IEcsLoadBalancerTarget =
        unwrap(this)
            .loadBalancerTarget(_options.let(LoadBalancerTargetOptions::unwrap))
            .let(IEcsLoadBalancerTarget::wrap)
    ...
    public override fun loadBalancerTarget(
        _options: LoadBalancerTargetOptions.Builder.() -> Unit
    ): IEcsLoadBalancerTarget = loadBalancerTarget(LoadBalancerTargetOptions(_options))

    /**
     * Overriden method to throw error as `registerLoadBalancerTargets` is not supported for
     * external service.
     *
     * @param _targets
     */
    ...
    public interface Builder {
        ...
        public fun capacityProviderStrategies(
            capacityProviderStrategies: List<CapacityProviderStrategy>
        )
         ...
         */
        public fun capacityProviderStrategies(
            vararg capacityProviderStrategies: CapacityProviderStrategy
        )
         ...
         *
         * @param deploymentAlarms The alarm(s) to monitor during deployment, and behavior to apply
         *   if at least one enters a state of alarm during the deployment or bake time.
         */
        ...
        public fun deploymentController(
            deploymentController: DeploymentController.Builder.() -> Unit
        )
         ...
         * service.
         *
         * Default: - When creating the service, default is 1; when updating the service, default
         * uses the current task number.
         *
         ...
         *
         * @param maxHealthyPercent The maximum number of tasks, specified as a percentage of the
         *   Amazon ECS service's DesiredCount value, that can run in a service during a deployment.
         */
         ...
         *
         * @param minHealthyPercent The minimum number of tasks, specified as a percentage of the
         *   Amazon ECS service's DesiredCount value, that must continue to run and remain healthy
         *   during a deployment.
         */
        ...
        public fun serviceConnectConfiguration(
            serviceConnectConfiguration: ServiceConnectProps.Builder.() -> Unit
        )
        ...
        /**
         * Revision number for the task definition or `latest` to use the latest active task
         * revision.
         *
         * Default: - Uses the revision of the passed task definition deployed by CloudFormation
         *
         * @param taskDefinitionRevision Revision number for the task definition or `latest` to use
         *   the latest active task revision.
         */
    ...
    private class BuilderImpl(
         ...
         *   service.
         */
        override fun capacityProviderStrategies(
            capacityProviderStrategies: List<CapacityProviderStrategy>
        ) {
            cdkBuilder.capacityProviderStrategies(
                capacityProviderStrategies.map(CapacityProviderStrategy::unwrap)
            )
        }
        ...
        override fun capacityProviderStrategies(
            vararg capacityProviderStrategies: CapacityProviderStrategy
        ): Unit = capacityProviderStrategies(capacityProviderStrategies.toList())
        ...
        override fun circuitBreaker(
            circuitBreaker: DeploymentCircuitBreaker.Builder.() -> Unit
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("a9e7cbde8b2f51bf4837bd89ab7ce60476410d7c5b1f596ed1553c33bd546156")
        override fun deploymentAlarms(
            deploymentAlarms: DeploymentAlarmConfig.Builder.() -> Unit
        ): Unit = deploymentAlarms(DeploymentAlarmConfig(deploymentAlarms))
        ...
        override fun serviceConnectConfiguration(serviceConnectConfiguration: ServiceConnectProps) {
            cdkBuilder.serviceConnectConfiguration(
                serviceConnectConfiguration.let(ServiceConnectProps::unwrap)
            )
        }
        ...
        override fun taskDefinitionRevision(taskDefinitionRevision: TaskDefinitionRevision) {
            cdkBuilder.taskDefinitionRevision(
                taskDefinitionRevision.let(TaskDefinitionRevision::unwrap)
            )
        }
    ...
    public companion object {
        public fun fromExternalServiceArn(
            ...
            software.amazon.awscdk.services.ecs.ExternalService.fromExternalServiceArn(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    externalServiceArn
                )
                .let(IExternalService::wrap)
        ...
        public fun fromExternalServiceAttributes(
            ...
            software.amazon.awscdk.services.ecs.ExternalService.fromExternalServiceAttributes(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    attrs.let(ExternalServiceAttributes::unwrap)
                )
                .let(IBaseService::wrap)
