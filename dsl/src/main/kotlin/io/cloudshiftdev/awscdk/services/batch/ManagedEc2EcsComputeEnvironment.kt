...
internal constructor(
     ...
     *
     * Note: the CDK will never set this value by default, `false` will set by CFN. This is to avoid
     * a deployment failure that occurs when this value is set.
     */
     ...
     * [io.cloudshiftdev.awscdk.services.batch.ManagedEc2EcsComputeEnvironment].
     */
    @CdkDslMarker
    public interface Builder {
         ...
         * can be allocated.
         *
         * Default: - `BEST_FIT_PROGRESSIVE` if not using Spot instances, `SPOT_CAPACITY_OPTIMIZED`
         * if using Spot instances.
         *
         * @param allocationStrategy The allocation strategy to use if not enough instances of the
         ...
         * Configure which AMIs this Compute Environment can launch.
         *
         * If you specify this property with only `image` specified, then the `imageType` will
         * default to `ECS_AL2`. *If your image needs GPU resources, specify `ECS_AL2_NVIDIA`;
         * otherwise, the instances will not be able to properly join the ComputeEnvironment*.
         *
         ...
         * The instance classes that this Compute Environment can launch.
         *
         * Which one is chosen depends on the `AllocationStrategy` used. Batch will automatically
         ...
         *
         * @param instanceRole The execution Role that instances launched by this Compute
         ...
         *
         * @param launchTemplate The Launch Template that this Compute Environment will use to
         *   provision EC2 Instances.
         */
        public fun launchTemplate(launchTemplate: ILaunchTemplate)

        /**
         * The maximum vCpus this `ManagedComputeEnvironment` can scale up to. Each vCPU is
         ...
         * Default: 256
         *
         * @param maxvCpus The maximum vCpus this `ManagedComputeEnvironment` can scale up to. Each
         *   vCPU is equivalent to 1024 CPU shares.
         */
         ...
         * Default: 0
         *
         * @param minvCpus The minimum vCPUs that an environment should maintain, even if the
         ...
         * single Availability Zone with high network flow potential.
         *
         ...
         *
         * @param replaceComputeEnvironment Specifies whether this Compute Environment is replaced
         *   if an update is made that requires replacing its instances.
         */
         ...
         *
         * @param securityGroups The security groups this Compute Environment will launch instances
         *   in.
         */
         ...
         * the current On-Demand price for that Instance. You always pay the lowest market price and
         * never more than your maximum percentage. For most use cases, Batch recommends leaving
         * this field empty.
         *
         ...
         *
         * @param terminateOnUpdate Whether or not any running jobs will be immediately terminated
         ...
         *
         * The optimal instance type is equivalent to adding the C4, M4, and R4 instance classes.
         * You can specify other instance classes (of the same architecture) in addition to the
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.batch.ManagedEc2EcsComputeEnvironment.Builder.create(
                scope,
                id
            )
    ...
    public companion object {
        public fun fromManagedEc2EcsComputeEnvironmentArn(
            ...
            software.amazon.awscdk.services.batch.ManagedEc2EcsComputeEnvironment
                ...
                .let(IManagedEc2EcsComputeEnvironment::wrap)
        ...
        internal fun unwrap(
            wrapped: ManagedEc2EcsComputeEnvironment
