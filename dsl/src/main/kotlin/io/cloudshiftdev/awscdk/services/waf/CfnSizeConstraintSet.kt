...
internal constructor(
    ...
    /** A fluent builder for [io.cloudshiftdev.awscdk.services.waf.CfnSizeConstraintSet]. */
    @CdkDslMarker
    ...
    public interface FieldToMatchProperty {
         ...
         *
         * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-waf-sizeconstraintset-fieldtomatch.html#cfn-waf-sizeconstraintset-fieldtomatch-data)
         */
         ...
         *
         * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-waf-sizeconstraintset-fieldtomatch.html#cfn-waf-sizeconstraintset-fieldtomatch-type)
         */
    ...
    public interface SizeConstraintProperty {
         ...
         * expression in the form of " `Size` `ComparisonOperator` size in bytes of `FieldToMatch`
         ...
         * `TextTransformation` because Amazon CloudFront forwards only the first 8192 bytes for
         * inspection.
         *
         * *NONE*
         *
        ...
        public interface Builder {
            /**
             * @param comparisonOperator The type of comparison you want AWS WAF to perform. AWS WAF
             *   uses this in combination with the provided `Size` and `FieldToMatch` to build an
            ...
            /**
             * @param size The size in bytes that you want AWS WAF to compare against the size of
        ...
        internal constructor(
             ...
             * The type of comparison you want AWS WAF to perform.
             *
             * AWS WAF uses this in combination with the provided `Size` and `FieldToMatch` to build
             * an expression in the form of " `Size` `ComparisonOperator` size in bytes of
             * `FieldToMatch` ". If that expression is true, the `SizeConstraint` is considered to
             * match.
             *
             * *EQ* : Used to test if the `Size` is equal to the size of the `FieldToMatch`
             ...
             * `FieldToMatch` .
             *
             * AWS WAF uses this in combination with `ComparisonOperator` and `FieldToMatch` to
             * build an expression in the form of " `Size` `ComparisonOperator` size in bytes of
             * `FieldToMatch` ". If that expression is true, the `SizeConstraint` is considered to
             * match.
             *
             * Valid values for size are 0 - 21474836480 bytes (0 - 20 GB).
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SizeConstraintProperty
            ): software.amazon.awscdk.services.waf.CfnSizeConstraintSet.SizeConstraintProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
