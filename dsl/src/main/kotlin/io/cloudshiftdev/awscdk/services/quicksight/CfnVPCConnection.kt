...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param dnsResolvers A list of IP addresses of DNS resolver endpoints for the VPC
         *   connection.
         */
         ...
         *
         * @param securityGroupIds The Amazon EC2 security group IDs associated with the VPC
         *   connection.
         */
