...
public interface QueryParameterMatchConfig {
    ...
    public interface Builder {
        ...
        public fun queryParameterMatch(
            queryParameterMatch: CfnRoute.QueryParameterProperty.Builder.() -> Unit
        )
    }
    ...
    private class BuilderImpl : Builder {
        ...
        override fun queryParameterMatch(queryParameterMatch: CfnRoute.QueryParameterProperty) {
            cdkBuilder.queryParameterMatch(
                queryParameterMatch.let(CfnRoute.QueryParameterProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("43b756913b6d339249175f1ff466e632b0864552cee341935e4f0536725218c8")
        override fun queryParameterMatch(
            queryParameterMatch: CfnRoute.QueryParameterProperty.Builder.() -> Unit
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: QueryParameterMatchConfig
