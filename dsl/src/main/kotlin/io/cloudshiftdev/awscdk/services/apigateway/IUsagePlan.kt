...
public interface IUsagePlan : IResource {
    ...
    internal constructor(
        ...
        override fun addApiKey(apiKey: IApiKey, options: AddApiKeyOptions) {
            unwrap(this)
                .addApiKey(apiKey.let(IApiKey::unwrap), options.let(AddApiKeyOptions::unwrap))
        }
    ...
    public companion object {
        ...
        ): IUsagePlan = Wrapper(cdkObject)

        internal fun unwrap(
            wrapped: IUsagePlan
        ): software.amazon.awscdk.services.apigateway.IUsagePlan = (wrapped as Wrapper).cdkObject
    }
}
