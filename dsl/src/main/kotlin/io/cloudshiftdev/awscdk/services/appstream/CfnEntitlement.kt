...
internal constructor(
    ...
    public interface AttributeProperty {
        ...
        public interface Builder {
            /**
             * @param name A supported AWS IAM SAML PrincipalTag attribute that is matched to a
             *   value when a user identity federates to an AppStream 2.0 SAML application. The
        ...
        internal constructor(
            ...
            /**
             * A supported AWS IAM SAML PrincipalTag attribute that is matched to a value when a
