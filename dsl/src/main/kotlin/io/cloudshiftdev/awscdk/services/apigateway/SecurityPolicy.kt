...
public enum class SecurityPolicy(
    ...
    public companion object {
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.apigateway.SecurityPolicy
        ): SecurityPolicy =
            when (cdkObject) {
                software.amazon.awscdk.services.apigateway.SecurityPolicy.TLS_1_0 ->
                    SecurityPolicy.TLS_1_0
                software.amazon.awscdk.services.apigateway.SecurityPolicy.TLS_1_2 ->
