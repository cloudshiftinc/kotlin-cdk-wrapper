...
internal constructor(
    ...
    private class BuilderImpl(
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("1f51ec62b9adb29ec5d37216a170c5a16418a243c8980b64bc4f237fdf705d3b")
        override fun aggregationType(
            aggregationType: AggregationTypeProperty.Builder.() -> Unit
        ): Unit = aggregationType(AggregationTypeProperty(aggregationType))
    ...
    public companion object {
        ...
        ): CfnFleetMetric = CfnFleetMetric(cdkObject)

        internal fun unwrap(
            wrapped: CfnFleetMetric
        ): software.amazon.awscdk.services.iot.CfnFleetMetric = wrapped.cdkObject
    }
    ...
    public interface AggregationTypeProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AggregationTypeProperty
            ): software.amazon.awscdk.services.iot.CfnFleetMetric.AggregationTypeProperty =
