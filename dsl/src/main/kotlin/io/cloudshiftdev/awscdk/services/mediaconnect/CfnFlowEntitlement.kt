...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param dataTransferSubscriberFeePercent The percentage of the entitlement data transfer
         *   fee that you want the subscriber to be responsible for.
         */
         ...
         * A description of the entitlement.
         *
         * This description appears only on the MediaConnect console and is not visible outside of
        ...
        /**
         * The type of encryption that MediaConnect will use on the output that is associated with
         * the entitlement.
         *
        ...
        /**
         * An indication of whether the new entitlement should be enabled or disabled as soon as it
         * is created.
         *
         ...
         *
         * @param entitlementStatus An indication of whether the new entitlement should be enabled
         *   or disabled as soon as it is created.
         */
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.mediaconnect.CfnFlowEntitlement.Builder.create(
                scope,
                id
            )
         ...
         * @param subscribers The AWS account IDs that you want to share your content with.
         */
        override fun subscribers(vararg subscribers: String): Unit =
