...
public interface LoadBalancerListener {
     ...
     *
     * By default, connections will be allowed from anywhere. Set this to an empty list to deny
     * connections, or supply a custom list of peers to allow connections from (IP ranges or
     * security groups).
     *
     * Default: Anywhere
     */
     ...
     *
     * The instance protocol is 'tcp' if the front-end protocol is 'tcp' or 'ssl', the instance
     * protocol is 'http' if the front-end protocol is 'https'.
     */
    ...
    public interface Builder {
         ...
         *   connection peers. By default, connections will be allowed from anywhere. Set this to an
         *   empty list to deny connections, or supply a custom list of peers to allow connections
         *   from (IP ranges or security groups).
         */
        ...
        /**
         * @param externalProtocol What public protocol to use for load balancing. Either 'tcp',
         *   'ssl', 'http' or 'https'.
         *
         * May be omitted if the external port is either 80 or 443.
         */
        ...
        /**
         * @param internalPort Instance listening port. Same as the externalPort if not specified.
         */
        public fun internalPort(internalPort: Number)

        /**
         * @param internalProtocol What public protocol to use for load balancing. Either 'tcp',
         *   'ssl', 'http' or 'https'.
         *
         * May be omitted if the internal port is either 80 or 443.
         *
