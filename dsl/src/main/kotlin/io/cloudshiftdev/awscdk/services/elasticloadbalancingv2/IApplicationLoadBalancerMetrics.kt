...
public interface IApplicationLoadBalancerMetrics {
    ...
    internal constructor(
        ...
        override fun clientTlsNegotiationErrorCount(props: MetricOptions): Metric =
            unwrap(this)
                .clientTlsNegotiationErrorCount(props.let(MetricOptions::unwrap))
                .let(Metric::wrap)
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("fdbae383d8e263982367b05a82bc68e589a7c576f59dd42c2af44bd37de26925")
        override fun clientTlsNegotiationErrorCount(
            props: MetricOptions.Builder.() -> Unit
        ): Metric = clientTlsNegotiationErrorCount(MetricOptions(props))
         ...
         *
         * Because an authenticate action was misconfigured, the load balancer couldn't establish a
         * connection with the IdP, or the load balancer couldn't complete the authentication flow
        ...
        /**
         * The number of user authentications that could not be completed because the IdP denied
         * access to the user or an authorization code was used more than once.
         *
         * Default: Sum over 5 minutes
         *
         * @param props
         ...
         * The number of authenticate actions that were successful.
         *
         * This metric is incremented at the end of the authentication workflow, after the load
        ...
        override fun httpCodeElb(code: HttpCodeElb, props: MetricOptions): Metric =
            unwrap(this)
                .httpCodeElb(code.let(HttpCodeElb::unwrap), props.let(MetricOptions::unwrap))
                .let(Metric::wrap)
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("4ec0c18e504ddbc3691899458ee1d9517d415b1e48a0d3108d7d82cd429225f5")
        override fun httpCodeElb(
            code: HttpCodeElb,
            props: MetricOptions.Builder.() -> Unit
        ): Metric = httpCodeElb(code, MetricOptions(props))
        ...
        override fun httpCodeTarget(code: HttpCodeTarget, props: MetricOptions): Metric =
            unwrap(this)
                .httpCodeTarget(code.let(HttpCodeTarget::unwrap), props.let(MetricOptions::unwrap))
                .let(Metric::wrap)
         ...
         * @param props
         */
        override fun httpRedirectCount(): Metric =
        ...
        override fun httpRedirectUrlLimitExceededCount(props: MetricOptions): Metric =
            unwrap(this)
                .httpRedirectUrlLimitExceededCount(props.let(MetricOptions::unwrap))
                .let(Metric::wrap)
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("e327dd03e46195ca0a0412eb1f1b527c163061e837653be3ee60e714c552e76c")
        override fun httpRedirectUrlLimitExceededCount(
            props: MetricOptions.Builder.() -> Unit
        ): Metric = httpRedirectUrlLimitExceededCount(MetricOptions(props))
         ...
         * @param props
         */
        override fun ipv6ProcessedBytes(): Metric =
         ...
         * @param props
         */
        override fun newConnectionCount(): Metric =
        ...
        override fun targetConnectionErrorCount(props: MetricOptions): Metric =
            unwrap(this)
                .targetConnectionErrorCount(props.let(MetricOptions::unwrap))
                .let(Metric::wrap)
         ...
         * @param props
         */
        override fun targetResponseTime(): Metric =
        ...
        override fun targetTlsNegotiationErrorCount(props: MetricOptions): Metric =
            unwrap(this)
                .targetTLSNegotiationErrorCount(props.let(MetricOptions::unwrap))
                .let(Metric::wrap)
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("6bff36edbbe3c8f26db05b3096329ed86c89c5421a92a5ecf6d869f655103f54")
        override fun targetTlsNegotiationErrorCount(
            props: MetricOptions.Builder.() -> Unit
        ): Metric = targetTlsNegotiationErrorCount(MetricOptions(props))
    }
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: IApplicationLoadBalancerMetrics
        ): software.amazon.awscdk.services.elasticloadbalancingv2.IApplicationLoadBalancerMetrics =
