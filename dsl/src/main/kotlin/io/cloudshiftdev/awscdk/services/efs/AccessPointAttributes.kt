...
public interface AccessPointAttributes {
    ...
    public interface Builder {
        /**
         * @param accessPointArn The ARN of the AccessPoint One of this, or `accessPointId` is
         *   required.
         */
        public fun accessPointArn(accessPointArn: String)

        /**
         * @param accessPointId The ID of the AccessPoint One of this, or `accessPointArn` is
         *   required.
         */
    ...
    internal constructor(
         ...
         * Default: - no EFS file system
         */
        override fun fileSystem(): IFileSystem? =
