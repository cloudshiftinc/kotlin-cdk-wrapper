...
internal constructor(
    ...
    public open fun testBotAliasSettings(
        `value`: TestBotAliasSettingsProperty.Builder.() -> Unit
    ...
    public interface Builder {
        /**
         * Indicates whether Amazon Lex V2 should automatically build the locales for the bot after
         * a change.
         *
         ...
         * By default, data stored by Amazon Lex is encrypted.
         *
         * The `DataPrivacy` structure provides settings that determine how Amazon Lex handles
         ...
         *
         * @param idleSessionTtlInSeconds The time, in seconds, that Amazon Lex should keep
         *   information about a user's conversation with the bot.
         */
         ...
         *
         * @param roleArn The Amazon Resource Name (ARN) of the IAM role used to build and run the
         *   bot.
         */
         ...
         *
         * @param testBotAliasSettings Specifies configuration settings for the alias used to test
         *   the bot.
         */
        ...
        public fun testBotAliasSettings(
            testBotAliasSettings: TestBotAliasSettingsProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("34052ba23ead94866e72b45c3fad98a216e6db2a63472d7ed4727bf546a07b6f")
        override fun botFileS3Location(
            botFileS3Location: S3LocationProperty.Builder.() -> Unit
        ...
        override fun testBotAliasSettings(testBotAliasSettings: TestBotAliasSettingsProperty) {
            cdkBuilder.testBotAliasSettings(
                testBotAliasSettings.let(TestBotAliasSettingsProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("6e76e6aa20450f4bf4936a0e6d1ac9affcf3e65b284d2b5adae3baf7c6c7ace9")
        override fun testBotAliasSettings(
            testBotAliasSettings: TestBotAliasSettingsProperty.Builder.() -> Unit
    ...
    public interface PlainTextMessageProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: PlainTextMessageProperty
            ): software.amazon.awscdk.services.lex.CfnBot.PlainTextMessageProperty =
    ...
    public interface SlotValueRegexFilterProperty {
        ...
        public interface Builder {
            /**
             * @param pattern A regular expression used to validate the value of a slot. Use a
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SlotValueRegexFilterProperty
            ): software.amazon.awscdk.services.lex.CfnBot.SlotValueRegexFilterProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface PromptSpecificationProperty {
         ...
         */
        public fun promptAttemptsSpecification(): Any? =
        ...
        public interface Builder {
            /**
             * @param allowInterrupt Indicates whether the user can interrupt a speech prompt from
             *   the bot.
             */
            ...
            /**
             * @param maxRetries The maximum number of times the bot tries to elicit a response from
             *   the user using this prompt.
             */
            public fun maxRetries(maxRetries: Number)

            /**
             * @param messageGroupsList A collection of messages that Amazon Lex can send to the
            ...
            /**
             * @param messageSelectionStrategy Indicates how a message is selected from a message
             *   group among retries.
             */
            public fun messageSelectionStrategy(messageSelectionStrategy: String)

            /**
             * @param promptAttemptsSpecification Specifies the advanced settings on each attempt of
             *   the prompt.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            override fun promptAttemptsSpecification(promptAttemptsSpecification: IResolvable) {
                cdkBuilder.promptAttemptsSpecification(
                    promptAttemptsSpecification.let(IResolvable::unwrap)
                )
            }
             ...
             *   the prompt.
             */
            override fun promptAttemptsSpecification(
                promptAttemptsSpecification: Map<String, Any>
            ) {
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-lex-bot-promptspecification.html#cfn-lex-bot-promptspecification-messageselectionstrategy)
             */
            override fun messageSelectionStrategy(): String? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: PromptSpecificationProperty
            ): software.amazon.awscdk.services.lex.CfnBot.PromptSpecificationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SentimentAnalysisSettingsProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SentimentAnalysisSettingsProperty
            ): software.amazon.awscdk.services.lex.CfnBot.SentimentAnalysisSettingsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface OutputContextProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param timeToLiveInSeconds The amount of time, in seconds, that the output context
             *   should remain active. The time is figured from the first time the context is sent
             *   to the user.
             */
            public fun timeToLiveInSeconds(timeToLiveInSeconds: Number)

            /**
             * @param turnsToLive The number of conversation turns that the output context should
             *   remain active. The number of turns is counted from the first time that the context
             *   is sent to the user.
             */
        ...
        internal constructor(
             ...
             * The number of conversation turns that the output context should remain active.
             *
             * The number of turns is counted from the first time that the context is sent to the
             * user.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-lex-bot-outputcontext.html#cfn-lex-bot-outputcontext-turnstolive)
             */
    ...
    public interface SlotValueOverrideMapProperty {
        ...
        public interface Builder {
            ...
            public fun slotValueOverride(
                slotValueOverride: SlotValueOverrideProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun slotValueOverride(slotValueOverride: SlotValueOverrideProperty) {
                cdkBuilder.slotValueOverride(
                    slotValueOverride.let(SlotValueOverrideProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("18bcfcb045a12a068f9d397ffce2a90823560b8e34d97fe22890ccbc028ff039")
            override fun slotValueOverride(
                slotValueOverride: SlotValueOverrideProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SlotValueOverrideMapProperty
            ): software.amazon.awscdk.services.lex.CfnBot.SlotValueOverrideMapProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface AudioAndDTMFInputSpecificationProperty {
        ...
        public interface Builder {
            ...
            public fun audioSpecification(
                audioSpecification: AudioSpecificationProperty.Builder.() -> Unit
            )
            ...
            public fun dtmfSpecification(
                dtmfSpecification: DTMFSpecificationProperty.Builder.() -> Unit
            )

            /**
             * @param startTimeoutMs Time for which a bot waits before assuming that the customer
             *   isn't going to speak or press a key. This timeout is shared between Audio and DTMF
             *   inputs.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            override fun audioSpecification(audioSpecification: AudioSpecificationProperty) {
                cdkBuilder.audioSpecification(
                    audioSpecification.let(AudioSpecificationProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("ab63600b5ff2fd4a4b547b226f2d7cce0712986c5bbd8e417b0899ca35837f1f")
            override fun audioSpecification(
                audioSpecification: AudioSpecificationProperty.Builder.() -> Unit
            ...
            override fun dtmfSpecification(dtmfSpecification: DTMFSpecificationProperty) {
                cdkBuilder.dtmfSpecification(
                    dtmfSpecification.let(DTMFSpecificationProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("76c203d83266832ddbd4dda9b0879cc214f5402efa864e01b232ec1faeec3020")
            override fun dtmfSpecification(
                dtmfSpecification: DTMFSpecificationProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AudioAndDTMFInputSpecificationProperty
            ): software.amazon.awscdk.services.lex.CfnBot.AudioAndDTMFInputSpecificationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface FulfillmentUpdateResponseSpecificationProperty {
         ...
         *
         * When the period ends, Amazon Lex chooses a message from the message groups and plays it
         * to the user. If the fulfillment Lambda returns before the first period ends, an update
         * message is not played to the user.
         *
        ...
        public interface Builder {
            /**
             * @param allowInterrupt Determines whether the user can interrupt an update message
             *   while it is playing.
             */
            public fun allowInterrupt(allowInterrupt: Boolean)
            ...
            /**
             * @param frequencyInSeconds The frequency that a message is sent to the user. When the
             *   period ends, Amazon Lex chooses a message from the message groups and plays it to
             *   the user. If the fulfillment Lambda returns before the first period ends, an update
             *   message is not played to the user.
             */
            public fun frequencyInSeconds(frequencyInSeconds: Number)

            /**
             * @param messageGroups 1 - 5 message groups that contain update messages. Amazon Lex
        ...
        internal constructor(
             ...
             * The frequency that a message is sent to the user.
             *
             * When the period ends, Amazon Lex chooses a message from the message groups and plays
             * it to the user. If the fulfillment Lambda returns before the first period ends, an
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: FulfillmentUpdateResponseSpecificationProperty
            ): software.amazon.awscdk.services.lex.CfnBot.FulfillmentUpdateResponseSpecificationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ElicitationCodeHookInvocationSettingProperty {
        ...
        public interface Builder {
            /**
             * @param enableCodeHookInvocation Indicates whether a Lambda function should be invoked
             *   for the dialog.
             */
            ...
            /**
             * @param invocationLabel A label that indicates the dialog step from which the dialog
        ...
        private class BuilderImpl : Builder {
            ...
            override fun enableCodeHookInvocation(enableCodeHookInvocation: IResolvable) {
                cdkBuilder.enableCodeHookInvocation(
                    enableCodeHookInvocation.let(IResolvable::unwrap)
                )
            }
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-lex-bot-elicitationcodehookinvocationsetting.html#cfn-lex-bot-elicitationcodehookinvocationsetting-enablecodehookinvocation)
             */
            override fun enableCodeHookInvocation(): Any =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ElicitationCodeHookInvocationSettingProperty
            ): software.amazon.awscdk.services.lex.CfnBot.ElicitationCodeHookInvocationSettingProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SlotDefaultValueSpecificationProperty {
        ...
        public interface Builder {
            /**
             * @param defaultValueList A list of default values. Amazon Lex chooses the default
        ...
        internal constructor(
             ...
             * A list of default values.
             *
             * Amazon Lex chooses the default value to use in the order that they are presented in
             * the list.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-lex-bot-slotdefaultvaluespecification.html#cfn-lex-bot-slotdefaultvaluespecification-defaultvaluelist)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SlotDefaultValueSpecificationProperty
            ): software.amazon.awscdk.services.lex.CfnBot.SlotDefaultValueSpecificationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface S3BucketLogDestinationProperty {
        ...
        public interface Builder {
            /**
             * @param kmsKeyArn The Amazon Resource Name (ARN) of an AWS Key Management Service
            ...
            /**
             * @param s3BucketArn The Amazon Resource Name (ARN) of an Amazon S3 bucket where audio
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: S3BucketLogDestinationProperty
            ): software.amazon.awscdk.services.lex.CfnBot.S3BucketLogDestinationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface BotAliasLocaleSettingsProperty {
        ...
        public interface Builder {
            ...
            public fun codeHookSpecification(
                codeHookSpecification: CodeHookSpecificationProperty.Builder.() -> Unit
            )

            /**
             * @param enabled Determines whether the locale is enabled for the bot. If the value is
        ...
        private class BuilderImpl : Builder {
             ...
             *   locale.
             */
            override fun codeHookSpecification(
                codeHookSpecification: CodeHookSpecificationProperty
            ) {
                cdkBuilder.codeHookSpecification(
                    codeHookSpecification.let(CodeHookSpecificationProperty::unwrap)
                )
            }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: BotAliasLocaleSettingsProperty
            ): software.amazon.awscdk.services.lex.CfnBot.BotAliasLocaleSettingsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SlotValueElicitationSettingProperty {
        ...
        /**
         * If you know a specific pattern that users might respond to an Amazon Lex request for a
        ...
        /**
         * Specifies the settings that Amazon Lex uses when a slot value is successfully entered by
         * a user.
         *
         ...
         */
        public fun waitAndContinueSpecification(): Any? =
        ...
        public interface Builder {
            /**
             * @param defaultValueSpecification A list of default values for a slot. Default values
             *   are used when Amazon Lex hasn't determined a value for a slot. You can specify
            ...
            public fun defaultValueSpecification(
                defaultValueSpecification: SlotDefaultValueSpecificationProperty.Builder.() -> Unit
            )

            /**
             * @param promptSpecification The prompt that Amazon Lex uses to elicit the slot value
             *   from the user.
             */
            ...
            public fun promptSpecification(
                promptSpecification: PromptSpecificationProperty.Builder.() -> Unit
            )

            /**
             * @param sampleUtterances If you know a specific pattern that users might respond to an
             *   Amazon Lex request for a slot value, you can provide those utterances to improve
            ...
            /**
             * @param slotCaptureSetting Specifies the settings that Amazon Lex uses when a slot
            ...
            public fun slotCaptureSetting(
                slotCaptureSetting: SlotCaptureSettingProperty.Builder.() -> Unit
            )
            ...
            /**
             * @param waitAndContinueSpecification Specifies the prompts that Amazon Lex uses while
             *   a bot is waiting for customer input.
             */
            ...
            public fun waitAndContinueSpecification(
                waitAndContinueSpecification:
                    WaitAndContinueSpecificationProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun defaultValueSpecification(defaultValueSpecification: IResolvable) {
                cdkBuilder.defaultValueSpecification(
                    defaultValueSpecification.let(IResolvable::unwrap)
                )
            }
             ...
             *   default values from context variables, session attributes, and defined values.
             */
            override fun defaultValueSpecification(
                defaultValueSpecification: SlotDefaultValueSpecificationProperty
            ) {
                cdkBuilder.defaultValueSpecification(
                    defaultValueSpecification.let(SlotDefaultValueSpecificationProperty::unwrap)
                )
            }
            ...
            override fun defaultValueSpecification(
                ...
                defaultValueSpecification(
                    SlotDefaultValueSpecificationProperty(defaultValueSpecification)
                )
            ...
            override fun promptSpecification(promptSpecification: PromptSpecificationProperty) {
                cdkBuilder.promptSpecification(
                    promptSpecification.let(PromptSpecificationProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("31322ebebe47545b9d5b8144de0ecebac5954a5207d6a72aaaf34f73b3884ddc")
            override fun promptSpecification(
                promptSpecification: PromptSpecificationProperty.Builder.() -> Unit
            ...
            override fun slotCaptureSetting(slotCaptureSetting: SlotCaptureSettingProperty) {
                cdkBuilder.slotCaptureSetting(
                    slotCaptureSetting.let(SlotCaptureSettingProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("2e690e43f7045723e4f837b25c37a81fc36ccbc7f32da93896c9cbc9f1ba9ae1")
            override fun slotCaptureSetting(
                slotCaptureSetting: SlotCaptureSettingProperty.Builder.() -> Unit
            ...
            override fun waitAndContinueSpecification(waitAndContinueSpecification: IResolvable) {
                cdkBuilder.waitAndContinueSpecification(
                    waitAndContinueSpecification.let(IResolvable::unwrap)
                )
            }
             ...
             *   a bot is waiting for customer input.
             */
            override fun waitAndContinueSpecification(
                waitAndContinueSpecification: WaitAndContinueSpecificationProperty
            ) {
                cdkBuilder.waitAndContinueSpecification(
                    waitAndContinueSpecification.let(WaitAndContinueSpecificationProperty::unwrap)
                )
            }
            ...
            override fun waitAndContinueSpecification(
                ...
                waitAndContinueSpecification(
                    WaitAndContinueSpecificationProperty(waitAndContinueSpecification)
                )
        ...
        internal constructor(
             ...
             *
             * Default values are used when Amazon Lex hasn't determined a value for a slot. You can
             * specify default values from context variables, session attributes, and defined
             * values.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-lex-bot-slotvalueelicitationsetting.html#cfn-lex-bot-slotvalueelicitationsetting-defaultvaluespecification)
             */
            override fun defaultValueSpecification(): Any? =
             ...
             * a slot value, you can provide those utterances to improve accuracy.
             *
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SlotValueElicitationSettingProperty
            ): software.amazon.awscdk.services.lex.CfnBot.SlotValueElicitationSettingProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface PostDialogCodeHookInvocationSpecificationProperty {
        ...
        public interface Builder {
            /**
             * @param failureConditional A list of conditional branches to evaluate after the dialog
             *   code hook throws an exception or returns with the `State` field of the `Intent`
            ...
            public fun failureConditional(
                failureConditional: ConditionalSpecificationProperty.Builder.() -> Unit
            )

            /**
             * @param failureNextStep Specifies the next step the bot runs after the dialog code
             *   hook throws an exception or returns with the `State` field of the `Intent` object
             *   set to `Failed` .
             */
            ...
            /**
             * @param failureResponse Specifies a list of message groups that Amazon Lex uses to
             *   respond the user input when the code hook fails.
             */
            ...
            public fun failureResponse(
                failureResponse: ResponseSpecificationProperty.Builder.() -> Unit
            )

            /**
             * @param successConditional A list of conditional branches to evaluate after the dialog
            ...
            public fun successConditional(
                successConditional: ConditionalSpecificationProperty.Builder.() -> Unit
            )

            /**
             * @param successNextStep Specifics the next step the bot runs after the dialog code
            ...
            /**
             * @param successResponse Specifies a list of message groups that Amazon Lex uses to
             *   respond when the code hook succeeds.
             */
            ...
            public fun successResponse(
                successResponse: ResponseSpecificationProperty.Builder.() -> Unit
            )

            /**
             * @param timeoutConditional A list of conditional branches to evaluate if the code hook
             *   times out.
             */
            ...
            public fun timeoutConditional(
                timeoutConditional: ConditionalSpecificationProperty.Builder.() -> Unit
            )

            /**
             * @param timeoutNextStep Specifies the next step that the bot runs when the code hook
             *   times out.
             */
            ...
            /**
             * @param timeoutResponse Specifies a list of message groups that Amazon Lex uses to
             *   respond to the user input when the code hook times out.
             */
            ...
            public fun timeoutResponse(
                timeoutResponse: ResponseSpecificationProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun failureConditional(failureConditional: ConditionalSpecificationProperty) {
                cdkBuilder.failureConditional(
                    failureConditional.let(ConditionalSpecificationProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("a31debbf13eaccf61af0ae05dec5876c7102629b14b86a37324cfb2aa8004eac")
            override fun failureConditional(
                failureConditional: ConditionalSpecificationProperty.Builder.() -> Unit
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("c76e3c6d416c507c1565ca27669610b4de0c2c9ea7c496501b30bc5bd42df3d0")
            override fun failureNextStep(
                failureNextStep: DialogStateProperty.Builder.() -> Unit
            ...
            override fun failureResponse(failureResponse: ResponseSpecificationProperty) {
                cdkBuilder.failureResponse(
                    failureResponse.let(ResponseSpecificationProperty::unwrap)
                )
            }
            ...
            override fun successConditional(successConditional: ConditionalSpecificationProperty) {
                cdkBuilder.successConditional(
                    successConditional.let(ConditionalSpecificationProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("8652ce061e95c444bc471ea830ede868e6eb6a215c33e2034cb6c0317e00ac06")
            override fun successConditional(
                successConditional: ConditionalSpecificationProperty.Builder.() -> Unit
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("604288558462ca514861bfe079b03915bc793e00114f12bb81c1d7c7c0c359f2")
            override fun successNextStep(
                successNextStep: DialogStateProperty.Builder.() -> Unit
            ...
            override fun successResponse(successResponse: ResponseSpecificationProperty) {
                cdkBuilder.successResponse(
                    successResponse.let(ResponseSpecificationProperty::unwrap)
                )
            }
            ...
            override fun timeoutConditional(timeoutConditional: ConditionalSpecificationProperty) {
                cdkBuilder.timeoutConditional(
                    timeoutConditional.let(ConditionalSpecificationProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("e32c1d98a3cc912cdb6b9d575535fd4928866b0cc791bb4f78d5437f2dc229a4")
            override fun timeoutConditional(
                timeoutConditional: ConditionalSpecificationProperty.Builder.() -> Unit
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("21c2a6c18595b0accdc91d97af7e561bed26eeb647d6b277b7b48201c119a96d")
            override fun timeoutNextStep(
                timeoutNextStep: DialogStateProperty.Builder.() -> Unit
            ...
            override fun timeoutResponse(timeoutResponse: ResponseSpecificationProperty) {
                cdkBuilder.timeoutResponse(
                    timeoutResponse.let(ResponseSpecificationProperty::unwrap)
                )
            }
        ...
        internal constructor(
            ...
            /**
             * Specifies a list of message groups that Amazon Lex uses to respond to the user input
             * when the code hook times out.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-lex-bot-postdialogcodehookinvocationspecification.html#cfn-lex-bot-postdialogcodehookinvocationspecification-timeoutresponse)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: PostDialogCodeHookInvocationSpecificationProperty
            ): software.amazon.awscdk.services.lex.CfnBot.PostDialogCodeHookInvocationSpecificationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface GrammarSlotTypeSourceProperty {
        ...
        public interface Builder {
            /**
             * @param kmsKeyArn The AWS KMS key required to decrypt the contents of the grammar, if
             *   any.
             */
            public fun kmsKeyArn(kmsKeyArn: String)

            /**
             * @param s3BucketName The name of the Amazon S3 bucket that contains the grammar
             *   source.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: GrammarSlotTypeSourceProperty
            ): software.amazon.awscdk.services.lex.CfnBot.GrammarSlotTypeSourceProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ImageResponseCardProperty {
         ...
         *
         * The image URL must be publicly available so that the platform displaying the response
        ...
        public interface Builder {
            /**
             * @param buttons A list of buttons that should be displayed on the response card. The
             *   arrangement of the buttons is determined by the platform that displays the button.
             */
            ...
            /**
             * @param imageUrl The URL of an image to display on the response card. The image URL
             *   must be publicly available so that the platform displaying the response card has
             *   access to the image.
             */
            public fun imageUrl(imageUrl: String)

            /**
             * @param subtitle The subtitle to display on the response card. The format of the
             *   subtitle is determined by the platform displaying the response card.
             */
            public fun subtitle(subtitle: String)

            /**
             * @param title The title to display on the response card. The format of the title is
        ...
        internal constructor(
             ...
             * A list of buttons that should be displayed on the response card.
             *
             * The arrangement of the buttons is determined by the platform that displays the
             * button.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-lex-bot-imageresponsecard.html#cfn-lex-bot-imageresponsecard-buttons)
             */
             ...
             * The subtitle to display on the response card.
             *
             * The format of the subtitle is determined by the platform displaying the response
             * card.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-lex-bot-imageresponsecard.html#cfn-lex-bot-imageresponsecard-subtitle)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ImageResponseCardProperty
            ): software.amazon.awscdk.services.lex.CfnBot.ImageResponseCardProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface StillWaitingResponseSpecificationProperty {
        ...
        public interface Builder {
            /**
             * @param allowInterrupt Indicates that the user can interrupt the response by speaking
            ...
            /**
             * @param frequencyInSeconds How often a message should be sent to the user. Minimum of
             *   1 second, maximum of 5 minutes.
             */
            public fun frequencyInSeconds(frequencyInSeconds: Number)

            /**
             * @param messageGroupsList One or more message groups, each containing one or more
            ...
            /**
             * @param timeoutInSeconds If Amazon Lex waits longer than this length of time for a
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: StillWaitingResponseSpecificationProperty
            ): software.amazon.awscdk.services.lex.CfnBot.StillWaitingResponseSpecificationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface TestBotAliasSettingsProperty {
        ...
        public interface Builder {
            /**
             * @param botAliasLocaleSettings Specifies settings that are unique to a locale. For
             *   example, you can use a different Lambda function depending on the bot's locale.
             */
            ...
            /**
             * @param conversationLogSettings Specifies settings for conversation logs that save
             *   audio, text, and metadata information for conversations with your users.
             */
            ...
            public fun conversationLogSettings(
                conversationLogSettings: ConversationLogSettingsProperty.Builder.() -> Unit
            )
            ...
            /**
             * @param sentimentAnalysisSettings Specifies whether Amazon Lex will use Amazon
             *   Comprehend to detect the sentiment of user utterances.
             */
        ...
        private class BuilderImpl : Builder {
             ...
             *   audio, text, and metadata information for conversations with your users.
             */
            override fun conversationLogSettings(
                conversationLogSettings: ConversationLogSettingsProperty
            ) {
                cdkBuilder.conversationLogSettings(
                    conversationLogSettings.let(ConversationLogSettingsProperty::unwrap)
                )
            }
            ...
            override fun conversationLogSettings(
                ...
                conversationLogSettings(ConversationLogSettingsProperty(conversationLogSettings))
        ...
        internal constructor(
            ...
            /**
             * Specifies settings for conversation logs that save audio, text, and metadata
             * information for conversations with your users.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-lex-bot-testbotaliassettings.html#cfn-lex-bot-testbotaliassettings-conversationlogsettings)
             */
            ...
            /**
             * Specifies whether Amazon Lex will use Amazon Comprehend to detect the sentiment of
             * user utterances.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-lex-bot-testbotaliassettings.html#cfn-lex-bot-testbotaliassettings-sentimentanalysissettings)
             */
            override fun sentimentAnalysisSettings(): Any? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TestBotAliasSettingsProperty
            ): software.amazon.awscdk.services.lex.CfnBot.TestBotAliasSettingsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DefaultConditionalBranchProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param response Specifies a list of message groups that Amazon Lex uses to respond
             *   the user input.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            override fun response(
                response: ResponseSpecificationProperty.Builder.() -> Unit
            ): Unit = response(ResponseSpecificationProperty(response))
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DefaultConditionalBranchProperty
            ): software.amazon.awscdk.services.lex.CfnBot.DefaultConditionalBranchProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface IntentOverrideProperty {
         ...
         *
         * The name of the slot maps to the value of the slot. Slots that are not included in the
        ...
        public interface Builder {
            ...
            /**
             * @param slots A map of all of the slot value overrides for the intent. The name of the
             *   slot maps to the value of the slot. Slots that are not included in the map aren't
             *   overridden.
             */
        ...
        internal constructor(
             ...
             * A map of all of the slot value overrides for the intent.
             *
             * The name of the slot maps to the value of the slot. Slots that are not included in
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: IntentOverrideProperty
            ): software.amazon.awscdk.services.lex.CfnBot.IntentOverrideProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface AdvancedRecognitionSettingProperty {
        ...
        public interface Builder {
            /**
             * @param audioRecognitionStrategy Enables using the slot values as a custom vocabulary
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-lex-bot-advancedrecognitionsetting.html#cfn-lex-bot-advancedrecognitionsetting-audiorecognitionstrategy)
             */
            override fun audioRecognitionStrategy(): String? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AdvancedRecognitionSettingProperty
            ): software.amazon.awscdk.services.lex.CfnBot.AdvancedRecognitionSettingProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DTMFSpecificationProperty {
        ...
        public interface Builder {
            /**
             * @param deletionCharacter The DTMF character that clears the accumulated DTMF digits
             *   and immediately ends the input.
             */
            public fun deletionCharacter(deletionCharacter: String)

            /**
             * @param endCharacter The DTMF character that immediately ends input. If the user does
             *   not press this character, the input ends after the end timeout.
             */
            public fun endCharacter(endCharacter: String)

            /**
             * @param endTimeoutMs How long the bot should wait after the last DTMF character input
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DTMFSpecificationProperty
            ): software.amazon.awscdk.services.lex.CfnBot.DTMFSpecificationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface FulfillmentUpdatesSpecificationProperty {
        ...
        public interface Builder {
            /**
             * @param active Determines whether fulfillment updates are sent to the user. When this
             *   field is true, updates are sent. If the `active` field is set to true, the
            ...
            /**
             * @param startResponse Provides configuration information for the message sent to users
            ...
            public fun startResponse(
                startResponse: FulfillmentStartResponseSpecificationProperty.Builder.() -> Unit
            )

            /**
             * @param timeoutInSeconds The length of time that the fulfillment Lambda function
             *   should run before it times out.
             */
            public fun timeoutInSeconds(timeoutInSeconds: Number)

            /**
             * @param updateResponse Provides configuration information for messages sent
             *   periodically to the user while the fulfillment Lambda function is running.
             */
            ...
            public fun updateResponse(
                updateResponse: FulfillmentUpdateResponseSpecificationProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun startResponse(
                ...
                cdkBuilder.startResponse(
                    startResponse.let(FulfillmentStartResponseSpecificationProperty::unwrap)
                )
            }
            ...
            override fun updateResponse(
                ...
                cdkBuilder.updateResponse(
                    updateResponse.let(FulfillmentUpdateResponseSpecificationProperty::unwrap)
                )
            }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: FulfillmentUpdatesSpecificationProperty
            ): software.amazon.awscdk.services.lex.CfnBot.FulfillmentUpdatesSpecificationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SlotTypeProperty {
        ...
        public interface Builder {
            /**
             * @param description A description of the slot type. Use the description to help
             *   identify the slot type in lists.
             */
            public fun description(description: String)

            /**
             * @param externalSourceSetting Sets the type of external information used to create the
             *   slot type.
             */
            ...
            public fun externalSourceSetting(
                externalSourceSetting: ExternalSourceSettingProperty.Builder.() -> Unit
            )

            /**
             * @param name The name of the slot type. A slot type name must be unique withing the
             *   account.
             */
            public fun name(name: String)

            /**
             * @param parentSlotTypeSignature The built-in slot type used as a parent of this slot
             *   type. When you define a parent slot type, the new slot type has the configuration
             *   of the parent lot type.
             *
             * Only `AMAZON.AlphaNumeric` is supported.
             */
            ...
            /**
             * @param slotTypeValues A list of SlotTypeValue objects that defines the values that
             *   the slot type can take. Each value can have a list of synonyms, additional values
            ...
            /**
             * @param valueSelectionSetting Determines the slot resolution strategy that Amazon Lex
             *   uses to return slot type values. The field can be set to one of the following
             *   values:
             * * `ORIGINAL_VALUE` - Returns the value entered by the user, if the user value is
             *   similar to the slot value.
             * * `TOP_RESOLUTION` - If there is a resolution list for the slot, return the first
             *   value in the resolution list as the slot type value. If there is no resolution
            ...
            public fun valueSelectionSetting(
                valueSelectionSetting: SlotValueSelectionSettingProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
             ...
             *   slot type.
             */
            override fun externalSourceSetting(
                externalSourceSetting: ExternalSourceSettingProperty
            ) {
                cdkBuilder.externalSourceSetting(
                    externalSourceSetting.let(ExternalSourceSettingProperty::unwrap)
                )
            }
             ...
             * If you don't specify the `valueSelectionStrategy` , the default is `ORIGINAL_VALUE` .
             */
            override fun valueSelectionSetting(
                valueSelectionSetting: SlotValueSelectionSettingProperty
            ) {
                cdkBuilder.valueSelectionSetting(
                    valueSelectionSetting.let(SlotValueSelectionSettingProperty::unwrap)
                )
            }
            ...
            override fun valueSelectionSetting(
                ...
                valueSelectionSetting(SlotValueSelectionSettingProperty(valueSelectionSetting))
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-lex-bot-slottype.html#cfn-lex-bot-slottype-parentslottypesignature)
             */
            override fun parentSlotTypeSignature(): String? =
    ...
    public interface FulfillmentStartResponseSpecificationProperty {
        ...
        public interface Builder {
            /**
             * @param allowInterrupt Determines whether the user can interrupt the start message
             *   while it is playing.
             */
            public fun allowInterrupt(allowInterrupt: Boolean)
            ...
            /**
             * @param delayInSeconds The delay between when the Lambda fulfillment function starts
             *   running and the start message is played. If the Lambda function returns before the
             *   delay is over, the start message isn't played.
             */
            public fun delayInSeconds(delayInSeconds: Number)

            /**
             * @param messageGroups 1 - 5 message groups that contain start messages. Amazon Lex
             *   chooses one of the messages to play to the user.
             */
            public fun messageGroups(messageGroups: IResolvable)
        ...
        internal constructor(
             ...
             * message is played.
             *
             * If the Lambda function returns before the delay is over, the start message isn't
             * played.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-lex-bot-fulfillmentstartresponsespecification.html#cfn-lex-bot-fulfillmentstartresponsespecification-delayinseconds)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: FulfillmentStartResponseSpecificationProperty
            ): software.amazon.awscdk.services.lex.CfnBot.FulfillmentStartResponseSpecificationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DialogCodeHookInvocationSettingProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param isActive Determines whether a dialog code hook is used when the intent is
             *   activated.
             */
            ...
            /**
             * @param postCodeHookSpecification Contains the responses and actions that Amazon Lex
             *   takes after the Lambda function is complete.
             */
            ...
            public fun postCodeHookSpecification(
                postCodeHookSpecification:
                    PostDialogCodeHookInvocationSpecificationProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun postCodeHookSpecification(postCodeHookSpecification: IResolvable) {
                cdkBuilder.postCodeHookSpecification(
                    postCodeHookSpecification.let(IResolvable::unwrap)
                )
            }
            ...
            override fun postCodeHookSpecification(
                ...
                cdkBuilder.postCodeHookSpecification(
                    postCodeHookSpecification.let(
                        PostDialogCodeHookInvocationSpecificationProperty::unwrap
                    )
                )
            }
            ...
            override fun postCodeHookSpecification(
                ...
                postCodeHookSpecification(
                    PostDialogCodeHookInvocationSpecificationProperty(postCodeHookSpecification)
                )
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-lex-bot-dialogcodehookinvocationsetting.html#cfn-lex-bot-dialogcodehookinvocationsetting-postcodehookspecification)
             */
            override fun postCodeHookSpecification(): Any =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DialogCodeHookInvocationSettingProperty
            ): software.amazon.awscdk.services.lex.CfnBot.DialogCodeHookInvocationSettingProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DialogStateProperty {
        ...
        public interface Builder {
             ...
             *   information. It contains application information passed between Amazon Lex and a
             *   client application.
             */
    ...
    public interface SlotValueProperty {
         ...
         * can choose to use the value entered by the user, or you can have Amazon Lex choose the
        ...
        public interface Builder {
            /**
             * @param interpretedValue The value that Amazon Lex determines for the slot. The actual
             *   value depends on the setting of the value selection strategy for the bot. You can
             *   choose to use the value entered by the user, or you can have Amazon Lex choose the
             *   first value in the `resolvedValues` list.
             */
        ...
        internal constructor(
             ...
             * The value that Amazon Lex determines for the slot.
             *
             * The actual value depends on the setting of the value selection strategy for the bot.
    ...
    public interface PostFulfillmentStatusSpecificationProperty {
        ...
        /**
         * Specifies a list of message groups that Amazon Lex uses to respond when the fulfillment
         * is successful.
         *
        ...
        public interface Builder {
            /**
             * @param failureConditional A list of conditional branches to evaluate after the
             *   fulfillment code hook throws an exception or returns with the `State` field of the
            ...
            /**
             * @param failureNextStep Specifies the next step the bot runs after the fulfillment
             *   code hook throws an exception or returns with the `State` field of the `Intent`
             *   object set to `Failed` .
             */
            public fun failureNextStep(failureNextStep: IResolvable)
            ...
            /**
             * @param successConditional A list of conditional branches to evaluate after the
             *   fulfillment code hook finishes successfully.
             */
            public fun successConditional(successConditional: IResolvable)
            ...
            /**
             * @param successNextStep Specifies the next step in the conversation that Amazon Lex
            ...
            /**
             * @param timeoutConditional A list of conditional branches to evaluate if the
             *   fulfillment code hook times out.
             */
            public fun timeoutConditional(timeoutConditional: IResolvable)
            ...
            /**
             * @param timeoutNextStep Specifies the next step that the bot runs when the fulfillment
             *   code hook times out.
             */
            public fun timeoutNextStep(timeoutNextStep: IResolvable)
            ...
            /**
             * @param timeoutResponse Specifies a list of message groups that Amazon Lex uses to
             *   respond when fulfillment isn't completed within the timeout period.
             */
            public fun timeoutResponse(timeoutResponse: IResolvable)
        ...
        internal constructor(
            ...
            /**
             * Specifies a list of message groups that Amazon Lex uses to respond when fulfillment
             * isn't successful.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-lex-bot-postfulfillmentstatusspecification.html#cfn-lex-bot-postfulfillmentstatusspecification-failureresponse)
             */
            ...
            /**
             * Specifies a list of message groups that Amazon Lex uses to respond when the
             * fulfillment is successful.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-lex-bot-postfulfillmentstatusspecification.html#cfn-lex-bot-postfulfillmentstatusspecification-successresponse)
             */
            override fun successResponse(): Any? = unwrap(this).getSuccessResponse()
            ...
            /**
             * Specifies a list of message groups that Amazon Lex uses to respond when fulfillment
             * isn't completed within the timeout period.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-lex-bot-postfulfillmentstatusspecification.html#cfn-lex-bot-postfulfillmentstatusspecification-timeoutresponse)
             */
            override fun timeoutResponse(): Any? = unwrap(this).getTimeoutResponse()
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: PostFulfillmentStatusSpecificationProperty
            ): software.amazon.awscdk.services.lex.CfnBot.PostFulfillmentStatusSpecificationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface IntentClosingSettingProperty {
        ...
        public interface Builder {
            /**
             * @param closingResponse The response that Amazon Lex sends to the user when the intent
             *   is complete.
             */
            ...
            public fun closingResponse(
                closingResponse: ResponseSpecificationProperty.Builder.() -> Unit
            )

            /**
             * @param conditional A list of conditional branches associated with the intent's
             *   closing response. These branches are executed when the `nextStep` attribute is set
             *   to `EvalutateConditional` .
             */
            ...
            /**
             * @param isActive Specifies whether an intent's closing response is used. When this
             *   field is false, the closing response isn't sent to the user. If the `IsActive`
             *   field isn't specified, the default is true.
             */
            public fun isActive(isActive: Boolean)
            ...
            /**
             * @param nextStep Specifies the next step that the bot executes after playing the
        ...
        private class BuilderImpl : Builder {
            ...
            override fun closingResponse(closingResponse: ResponseSpecificationProperty) {
                cdkBuilder.closingResponse(
                    closingResponse.let(ResponseSpecificationProperty::unwrap)
                )
            }
            ...
            override fun conditional(
                conditional: ConditionalSpecificationProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: IntentClosingSettingProperty
            ): software.amazon.awscdk.services.lex.CfnBot.IntentClosingSettingProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface PromptAttemptSpecificationProperty {
        ...
        public interface Builder {
            /**
             * @param allowInterrupt Indicates whether the user can interrupt a speech prompt
            ...
            public fun allowedInputTypes(
                allowedInputTypes: AllowedInputTypesProperty.Builder.() -> Unit
            )
            ...
            public fun audioAndDtmfInputSpecification(
                audioAndDtmfInputSpecification:
                    AudioAndDTMFInputSpecificationProperty.Builder.() -> Unit
            )
            ...
            public fun textInputSpecification(
                textInputSpecification: TextInputSpecificationProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun allowedInputTypes(allowedInputTypes: AllowedInputTypesProperty) {
                cdkBuilder.allowedInputTypes(
                    allowedInputTypes.let(AllowedInputTypesProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("d7638351b588b5457789373e88564349da909c2b065e905b7817652deb0a3d43")
            override fun allowedInputTypes(
                allowedInputTypes: AllowedInputTypesProperty.Builder.() -> Unit
            ...
            override fun audioAndDtmfInputSpecification(
                audioAndDtmfInputSpecification: IResolvable
            ) {
                cdkBuilder.audioAndDtmfInputSpecification(
                    audioAndDtmfInputSpecification.let(IResolvable::unwrap)
                )
            }
            ...
            override fun audioAndDtmfInputSpecification(
                ...
                cdkBuilder.audioAndDtmfInputSpecification(
                    audioAndDtmfInputSpecification.let(
                        AudioAndDTMFInputSpecificationProperty::unwrap
                    )
                )
            }
            ...
            override fun audioAndDtmfInputSpecification(
                ...
                audioAndDtmfInputSpecification(
                    AudioAndDTMFInputSpecificationProperty(audioAndDtmfInputSpecification)
                )
            ...
            /** @param textInputSpecification Specifies the settings on text input. */
            override fun textInputSpecification(
                textInputSpecification: TextInputSpecificationProperty
            ) {
                cdkBuilder.textInputSpecification(
                    textInputSpecification.let(TextInputSpecificationProperty::unwrap)
                )
            }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: PromptAttemptSpecificationProperty
            ): software.amazon.awscdk.services.lex.CfnBot.PromptAttemptSpecificationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface AllowedInputTypesProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AllowedInputTypesProperty
            ): software.amazon.awscdk.services.lex.CfnBot.AllowedInputTypesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface MessageGroupProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param variations Message variations to send to the user. When variations are
             *   defined, Amazon Lex chooses the primary message or one of the variations to send to
             *   the user.
             */
    ...
    public interface ConversationLogSettingsProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param textLogSettings The Amazon CloudWatch Logs settings for logging text and
             *   metadata.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ConversationLogSettingsProperty
            ): software.amazon.awscdk.services.lex.CfnBot.ConversationLogSettingsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface FulfillmentCodeHookSettingProperty {
        ...
        public interface Builder {
            /**
             * @param enabled Indicates whether a Lambda function should be invoked to fulfill a
             *   specific intent.
             */
            public fun enabled(enabled: Boolean)
            ...
            /**
             * @param fulfillmentUpdatesSpecification Provides settings for update messages sent to
             *   the user for long-running Lambda fulfillment functions. Fulfillment updates can be
            ...
            public fun fulfillmentUpdatesSpecification(
                fulfillmentUpdatesSpecification:
                    FulfillmentUpdatesSpecificationProperty.Builder.() -> Unit
            )

            /**
             * @param isActive Determines whether the fulfillment code hook is used. When `active`
            ...
            /**
             * @param postFulfillmentStatusSpecification Provides settings for messages sent to the
             *   user for after the Lambda fulfillment function completes. Post-fulfillment messages
             *   can be sent for both streaming and non-streaming conversations.
             */
            public fun postFulfillmentStatusSpecification(
                postFulfillmentStatusSpecification: IResolvable
            )
            ...
            public fun postFulfillmentStatusSpecification(
                postFulfillmentStatusSpecification:
                    PostFulfillmentStatusSpecificationProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
             ...
             *   used only with streaming conversations.
             */
            override fun fulfillmentUpdatesSpecification(
                fulfillmentUpdatesSpecification: IResolvable
            ) {
                cdkBuilder.fulfillmentUpdatesSpecification(
                    fulfillmentUpdatesSpecification.let(IResolvable::unwrap)
                )
            }
            ...
            override fun fulfillmentUpdatesSpecification(
                ...
                cdkBuilder.fulfillmentUpdatesSpecification(
                    fulfillmentUpdatesSpecification.let(
                        FulfillmentUpdatesSpecificationProperty::unwrap
                    )
                )
            }
            ...
            override fun fulfillmentUpdatesSpecification(
                ...
                fulfillmentUpdatesSpecification(
                    FulfillmentUpdatesSpecificationProperty(fulfillmentUpdatesSpecification)
                )
             ...
             *   can be sent for both streaming and non-streaming conversations.
             */
            override fun postFulfillmentStatusSpecification(
                postFulfillmentStatusSpecification: IResolvable
            ) {
                cdkBuilder.postFulfillmentStatusSpecification(
                    postFulfillmentStatusSpecification.let(IResolvable::unwrap)
                )
            }
            ...
            override fun postFulfillmentStatusSpecification(
                ...
                cdkBuilder.postFulfillmentStatusSpecification(
                    postFulfillmentStatusSpecification.let(
                        PostFulfillmentStatusSpecificationProperty::unwrap
                    )
                )
            }
            ...
            override fun postFulfillmentStatusSpecification(
                ...
                postFulfillmentStatusSpecification(
                    PostFulfillmentStatusSpecificationProperty(postFulfillmentStatusSpecification)
                )
        ...
        internal constructor(
             ...
             * function completes.
             *
             * Post-fulfillment messages can be sent for both streaming and non-streaming
             * conversations.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-lex-bot-fulfillmentcodehooksetting.html#cfn-lex-bot-fulfillmentcodehooksetting-postfulfillmentstatusspecification)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: FulfillmentCodeHookSettingProperty
            ): software.amazon.awscdk.services.lex.CfnBot.FulfillmentCodeHookSettingProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface TextLogSettingProperty {
        ...
        private class BuilderImpl : Builder {
            ...
            override fun destination(
                destination: TextLogDestinationProperty.Builder.() -> Unit
        ...
        internal constructor(
            internal val cdkObject:
                software.amazon.awscdk.services.lex.CfnBot.TextLogSettingProperty,
        ) : TextLogSettingProperty {
            /**
             * Specifies the Amazon CloudWatch Logs destination log group for conversation text
             * logs.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-lex-bot-textlogsetting.html#cfn-lex-bot-textlogsetting-destination)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TextLogSettingProperty
            ): software.amazon.awscdk.services.lex.CfnBot.TextLogSettingProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface InitialResponseSettingProperty {
        ...
        public interface Builder {
            /**
             * @param codeHook Settings that specify the dialog code hook that is called by Amazon
            ...
            public fun codeHook(
                codeHook: DialogCodeHookInvocationSettingProperty.Builder.() -> Unit
            )

            /**
             * @param conditional Provides a list of conditional branches. Branches are evaluated in
             *   the order that they are entered in the list. The first branch with a condition that
             *   evaluates to true is executed. The last branch in the list is the default branch.
             *   The default branch should not have any condition expression. The default branch is
            ...
            /**
             * @param initialResponse Specifies a list of message groups that Amazon Lex uses to
            ...
            public fun initialResponse(
                initialResponse: ResponseSpecificationProperty.Builder.() -> Unit
            )
        ...
        private class BuilderImpl : Builder {
            ...
            override fun initialResponse(initialResponse: ResponseSpecificationProperty) {
                cdkBuilder.initialResponse(
                    initialResponse.let(ResponseSpecificationProperty::unwrap)
                )
            }
        ...
        internal constructor(
            ...
            /**
             * Settings that specify the dialog code hook that is called by Amazon Lex at a step of
             * the conversation.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-lex-bot-initialresponsesetting.html#cfn-lex-bot-initialresponsesetting-codehook)
             */
             ...
             * Provides a list of conditional branches.
             *
             * Branches are evaluated in the order that they are entered in the list. The first
             * branch with a condition that evaluates to true is executed. The last branch in the
             * list is the default branch. The default branch should not have any condition
             * expression. The default branch is executed if no other branch has a matching
             * condition.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-lex-bot-initialresponsesetting.html#cfn-lex-bot-initialresponsesetting-conditional)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: InitialResponseSettingProperty
            ): software.amazon.awscdk.services.lex.CfnBot.InitialResponseSettingProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ResponseSpecificationProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param messageGroupsList A collection of responses that Amazon Lex can send to the
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ResponseSpecificationProperty
            ): software.amazon.awscdk.services.lex.CfnBot.ResponseSpecificationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface AudioLogSettingProperty {
        ...
        private class BuilderImpl : Builder {
            ...
            @JvmName("a36254686cad8246bfc3f28e1825276b53ad0a8954f57f7dd0b4b801fa9c7328")
            override fun destination(
                destination: AudioLogDestinationProperty.Builder.() -> Unit
        ...
        internal constructor(
            internal val cdkObject:
                software.amazon.awscdk.services.lex.CfnBot.AudioLogSettingProperty,
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AudioLogSettingProperty
            ): software.amazon.awscdk.services.lex.CfnBot.AudioLogSettingProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SlotValueOverrideProperty {
        ...
        public interface Builder {
            /**
             * @param shape When the shape value is `List` , it indicates that the `values` field
            ...
            /**
             * @param values A list of one or more values that the user provided for the slot. For
        ...
        internal constructor(
             ...
             * of slot values.
             *
             * When the value is `Scalar` , it indicates that the `value` field contains a single
             * value.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-lex-bot-slotvalueoverride.html#cfn-lex-bot-slotvalueoverride-shape)
             */
             ...
             * A list of one or more values that the user provided for the slot.
             *
             * For example, for a slot that elicits pizza toppings, the values might be "pepperoni"
             * and "pineapple."
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-lex-bot-slotvalueoverride.html#cfn-lex-bot-slotvalueoverride-values)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SlotValueOverrideProperty
            ): software.amazon.awscdk.services.lex.CfnBot.SlotValueOverrideProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SessionAttributeProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SessionAttributeProperty
            ): software.amazon.awscdk.services.lex.CfnBot.SessionAttributeProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface GrammarSlotTypeSettingProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: GrammarSlotTypeSettingProperty
            ): software.amazon.awscdk.services.lex.CfnBot.GrammarSlotTypeSettingProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DialogCodeHookSettingProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DialogCodeHookSettingProperty
            ): software.amazon.awscdk.services.lex.CfnBot.DialogCodeHookSettingProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface TextInputSpecificationProperty {
        ...
        public interface Builder {
            /**
             * @param startTimeoutMs Time for which a bot waits before re-prompting a customer for
             *   text input.
             */
            public fun startTimeoutMs(startTimeoutMs: Number)
        }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TextInputSpecificationProperty
            ): software.amazon.awscdk.services.lex.CfnBot.TextInputSpecificationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ObfuscationSettingProperty {
        ...
        public interface Builder {
            /**
             * @param obfuscationSettingType Value that determines whether Amazon Lex obscures slot
             *   values in conversation logs. The default is to obscure the values.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ObfuscationSettingProperty
            ): software.amazon.awscdk.services.lex.CfnBot.ObfuscationSettingProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DialogActionProperty {
        ...
        public interface Builder {
            /**
             * @param slotToElicit If the dialog action is `ElicitSlot` , defines the slot to elicit
             *   from the user.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DialogActionProperty
            ): software.amazon.awscdk.services.lex.CfnBot.DialogActionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface LambdaCodeHookProperty {
        ...
        public interface Builder {
            /**
             * @param codeHookInterfaceVersion The version of the request-response that you want
        ...
        internal constructor(
            internal val cdkObject:
                software.amazon.awscdk.services.lex.CfnBot.LambdaCodeHookProperty,
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-lex-bot-lambdacodehook.html#cfn-lex-bot-lambdacodehook-codehookinterfaceversion)
             */
            override fun codeHookInterfaceVersion(): String =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: LambdaCodeHookProperty
            ): software.amazon.awscdk.services.lex.CfnBot.LambdaCodeHookProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CloudWatchLogGroupLogDestinationProperty {
        ...
        public interface Builder {
            /**
             * @param cloudWatchLogGroupArn The Amazon Resource Name (ARN) of the log group where
             *   text and metadata logs are delivered.
             */
            public fun cloudWatchLogGroupArn(cloudWatchLogGroupArn: String)

            /**
             * @param logPrefix The prefix of the log stream name within the log group that you
             *   specified.
             */
            public fun logPrefix(logPrefix: String)
        }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CloudWatchLogGroupLogDestinationProperty
            ): software.amazon.awscdk.services.lex.CfnBot.CloudWatchLogGroupLogDestinationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ConditionalBranchProperty {
        ...
        public interface Builder {
            /**
             * @param condition Contains the expression to evaluate. If the condition is true, the
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ConditionalBranchProperty
            ): software.amazon.awscdk.services.lex.CfnBot.ConditionalBranchProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface BotLocaleProperty {
         ...
         * `AMAZON.KendraSearchIntent` , or both when returning alternative intents. You must
         * configure an `AMAZON.FallbackIntent` . `AMAZON.KendraSearchIntent` is only inserted if it
        ...
        public interface Builder {
            ...
            public fun customVocabulary(
                customVocabulary: CustomVocabularyProperty.Builder.() -> Unit
            )
            ...
            /**
             * @param localeId The identifier of the language and locale that the bot will be used
             *   in. The string must match one of the supported locales.
             */
            public fun localeId(localeId: String)

            /**
             * @param nluConfidenceThreshold Determines the threshold where Amazon Lex will insert
             *   the `AMAZON.FallbackIntent` , `AMAZON.KendraSearchIntent` , or both when returning
             *   alternative intents. You must configure an `AMAZON.FallbackIntent` .
            ...
            /**
             * @param voiceSettings Defines settings for using an Amazon Polly voice to communicate
             *   with a user.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("f134e87e6455eb7ee5f8d312b4bb55381e0723a5544fd753a59801b52965ded9")
            override fun voiceSettings(
                voiceSettings: VoiceSettingsProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * Determines the threshold where Amazon Lex will insert the `AMAZON.FallbackIntent` ,
             * `AMAZON.KendraSearchIntent` , or both when returning alternative intents. You must
             * configure an `AMAZON.FallbackIntent` . `AMAZON.KendraSearchIntent` is only inserted
    ...
    public interface AudioSpecificationProperty {
        ...
        public interface Builder {
            /**
             * @param endTimeoutMs Time for which a bot waits after the customer stops speaking to
             *   assume the utterance is finished.
             */
            public fun endTimeoutMs(endTimeoutMs: Number)

            /**
             * @param maxLengthMs Time for how long Amazon Lex waits before speech input is
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AudioSpecificationProperty
            ): software.amazon.awscdk.services.lex.CfnBot.AudioSpecificationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ExternalSourceSettingProperty {
        ...
        public interface Builder {
            /**
             * @param grammarSlotTypeSetting Settings required for a slot type based on a grammar
             *   that you provide.
             */
            ...
            public fun grammarSlotTypeSetting(
                grammarSlotTypeSetting: GrammarSlotTypeSettingProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
             ...
             *   that you provide.
             */
            override fun grammarSlotTypeSetting(
                grammarSlotTypeSetting: GrammarSlotTypeSettingProperty
            ) {
                cdkBuilder.grammarSlotTypeSetting(
                    grammarSlotTypeSetting.let(GrammarSlotTypeSettingProperty::unwrap)
                )
            }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ExternalSourceSettingProperty
            ): software.amazon.awscdk.services.lex.CfnBot.ExternalSourceSettingProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SlotCaptureSettingProperty {
        ...
        public interface Builder {
            /**
             * @param captureConditional A list of conditional branches to evaluate after the slot
             *   value is captured.
             */
            ...
            public fun captureConditional(
                captureConditional: ConditionalSpecificationProperty.Builder.() -> Unit
            )

            /**
             * @param captureNextStep Specifies the next step that the bot runs when the slot value
            ...
            /**
             * @param captureResponse Specifies a list of message groups that Amazon Lex uses to
             *   respond the user input.
             */
            ...
            public fun captureResponse(
                captureResponse: ResponseSpecificationProperty.Builder.() -> Unit
            )
            ...
            /**
             * @param elicitationCodeHook Code hook called when Amazon Lex doesn't capture a slot
             *   value.
             */
             ...
             *   value.
             */
            public fun elicitationCodeHook(
            ...
            public fun elicitationCodeHook(
                elicitationCodeHook: ElicitationCodeHookInvocationSettingProperty.Builder.() -> Unit
            )

            /**
             * @param failureConditional A list of conditional branches to evaluate when the slot
            ...
            /**
             * @param failureNextStep Specifies the next step that the bot runs when the slot value
            ...
            /**
             * @param failureResponse Specifies a list of message groups that Amazon Lex uses to
             *   respond the user input when the slot fails to be captured.
             */
            public fun failureResponse(failureResponse: IResolvable)
        ...
        private class BuilderImpl : Builder {
            ...
            override fun captureConditional(captureConditional: ConditionalSpecificationProperty) {
                cdkBuilder.captureConditional(
                    captureConditional.let(ConditionalSpecificationProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("ab778a9743668c9b489e34c54e37e26aafe861c2a38028f3abd075c198c5de4b")
            override fun captureConditional(
                captureConditional: ConditionalSpecificationProperty.Builder.() -> Unit
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("ab41fd42e2785717c003a9150dc29f5a1d5ee67b95e91fd396144962d6bf3ec1")
            override fun captureNextStep(
                captureNextStep: DialogStateProperty.Builder.() -> Unit
            ...
            override fun captureResponse(captureResponse: ResponseSpecificationProperty) {
                cdkBuilder.captureResponse(
                    captureResponse.let(ResponseSpecificationProperty::unwrap)
                )
            }
             ...
             *   value.
             */
            override fun elicitationCodeHook(
                elicitationCodeHook: ElicitationCodeHookInvocationSettingProperty
            ) {
                cdkBuilder.elicitationCodeHook(
                    elicitationCodeHook.let(ElicitationCodeHookInvocationSettingProperty::unwrap)
                )
            }
            ...
            override fun elicitationCodeHook(
                ...
                elicitationCodeHook(
                    ElicitationCodeHookInvocationSettingProperty(elicitationCodeHook)
                )
        ...
        internal constructor(
            ...
            /**
             * Specifies a list of message groups that Amazon Lex uses to respond the user input
             * when the slot fails to be captured.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-lex-bot-slotcapturesetting.html#cfn-lex-bot-slotcapturesetting-failureresponse)
             */
            override fun failureResponse(): Any? = unwrap(this).getFailureResponse()
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SlotCaptureSettingProperty
            ): software.amazon.awscdk.services.lex.CfnBot.SlotCaptureSettingProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface TextLogDestinationProperty {
        ...
        public interface Builder {
            /**
             * @param cloudWatch Defines the Amazon CloudWatch Logs log group where text and
            ...
            public fun cloudWatch(
                cloudWatch: CloudWatchLogGroupLogDestinationProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun cloudWatch(cloudWatch: CloudWatchLogGroupLogDestinationProperty) {
                cdkBuilder.cloudWatch(
                    cloudWatch.let(CloudWatchLogGroupLogDestinationProperty::unwrap)
                )
            }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TextLogDestinationProperty
            ): software.amazon.awscdk.services.lex.CfnBot.TextLogDestinationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SlotProperty {
        ...
        /**
         * Determines whether the contents of the slot are obfuscated in Amazon CloudWatch Logs
         * logs.
         *
        ...
        public interface Builder {
            ...
            public fun multipleValuesSetting(
                multipleValuesSetting: MultipleValuesSettingProperty.Builder.() -> Unit
            )
            ...
            /**
             * @param obfuscationSetting Determines whether the contents of the slot are obfuscated
             *   in Amazon CloudWatch Logs logs. Use obfuscated slots to protect information such as
            ...
            public fun obfuscationSetting(
                obfuscationSetting: ObfuscationSettingProperty.Builder.() -> Unit
            )

            /**
             * @param slotTypeName The name of the slot type that this slot is based on. The slot
             *   type defines the acceptable values for the slot.
             */
            public fun slotTypeName(slotTypeName: String)

            /**
             * @param valueElicitationSetting Determines the slot resolution strategy that Amazon
             *   Lex uses to return slot type values. The field can be set to one of the following
             *   values:
             * * ORIGINAL_VALUE - Returns the value entered by the user, if the user value is
             *   similar to a slot value.
             * * TOP_RESOLUTION - If there is a resolution list for the slot, return the first value
            ...
            public fun valueElicitationSetting(
                valueElicitationSetting: SlotValueElicitationSettingProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            /** @param multipleValuesSetting Indicates whether a slot can return multiple values. */
            override fun multipleValuesSetting(
                multipleValuesSetting: MultipleValuesSettingProperty
            ) {
                cdkBuilder.multipleValuesSetting(
                    multipleValuesSetting.let(MultipleValuesSettingProperty::unwrap)
                )
            }
            ...
            override fun obfuscationSetting(obfuscationSetting: ObfuscationSettingProperty) {
                cdkBuilder.obfuscationSetting(
                    obfuscationSetting.let(ObfuscationSettingProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("f0f9c90510da76da50a9b4ec81140db04fb28d6ce1e927f86bd4732516a861d8")
            override fun obfuscationSetting(
                obfuscationSetting: ObfuscationSettingProperty.Builder.() -> Unit
             ...
             * If you don't specify the `valueSelectionStrategy` , the default is `ORIGINAL_VALUE` .
             */
            override fun valueElicitationSetting(
                valueElicitationSetting: SlotValueElicitationSettingProperty
            ) {
                cdkBuilder.valueElicitationSetting(
                    valueElicitationSetting.let(SlotValueElicitationSettingProperty::unwrap)
                )
            }
            ...
            override fun valueElicitationSetting(
                ...
                valueElicitationSetting(
                    SlotValueElicitationSettingProperty(valueElicitationSetting)
                )
        ...
        internal constructor(
             ...
             * logs.
             *
             * Use obfuscated slots to protect information such as personally identifiable
    ...
    public interface BotAliasLocaleSettingsItemProperty {
        ...
        public interface Builder {
            ...
            public fun botAliasLocaleSetting(
                botAliasLocaleSetting: BotAliasLocaleSettingsProperty.Builder.() -> Unit
            )
        ...
        private class BuilderImpl : Builder {
            ...
            /** @param botAliasLocaleSetting Specifies locale settings for a locale. */
            override fun botAliasLocaleSetting(
                botAliasLocaleSetting: BotAliasLocaleSettingsProperty
            ) {
                cdkBuilder.botAliasLocaleSetting(
                    botAliasLocaleSetting.let(BotAliasLocaleSettingsProperty::unwrap)
                )
            }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: BotAliasLocaleSettingsItemProperty
            ): software.amazon.awscdk.services.lex.CfnBot.BotAliasLocaleSettingsItemProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CustomVocabularyItemProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param weight Specifies the degree to which the phrase recognition is boosted. The
             *   default value is 1.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CustomVocabularyItemProperty
            ): software.amazon.awscdk.services.lex.CfnBot.CustomVocabularyItemProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface MultipleValuesSettingProperty {
        ...
        public interface Builder {
            /**
             * @param allowMultipleValues Indicates whether a slot can return multiple values. When
             *   `true` , the slot may return more than one value in a response. When `false` , the
             *   slot returns only a single value.
             *
        ...
        internal constructor(
             ...
             * Indicates whether a slot can return multiple values.
             *
             * When `true` , the slot may return more than one value in a response. When `false` ,
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: MultipleValuesSettingProperty
            ): software.amazon.awscdk.services.lex.CfnBot.MultipleValuesSettingProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CustomVocabularyProperty {
        ...
        public interface Builder {
            /**
             * @param customVocabularyItems Specifies a list of words that you expect to be used
             *   during a conversation with your bot.
             */
        ...
        internal constructor(
            ...
            /**
             * Specifies a list of words that you expect to be used during a conversation with your
             * bot.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-lex-bot-customvocabulary.html#cfn-lex-bot-customvocabulary-customvocabularyitems)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CustomVocabularyProperty
            ): software.amazon.awscdk.services.lex.CfnBot.CustomVocabularyProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ButtonProperty {
        ...
        public interface Builder {
            /**
             * @param text The text that appears on the button. Use this to tell the user what value
             *   is returned when they choose this button.
             */
            public fun text(text: String)

            /**
             * @param value The value returned to Amazon Lex when the user chooses this button. This
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ButtonProperty
            ): software.amazon.awscdk.services.lex.CfnBot.ButtonProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface IntentProperty {
         ...
         * intent.
         *
         * If the user answers "no," the settings contain a statement that is sent to the user to
         * end the intent.
         *
        ...
        /**
         * Provides configuration information for the `AMAZON.KendraSearchIntent` intent. When you
         * use this intent, Amazon Lex searches the specified Amazon Kendra index and returns
         ...
         * The name of the intent.
         *
         * Intent names must be unique within the locale that contains the intent and can't match
        ...
        public interface Builder {
            /**
             * @param description A description of the intent. Use the description to help identify
             *   the intent in lists.
             */
            public fun description(description: String)

            /**
             * @param dialogCodeHook Specifies that Amazon Lex invokes the alias Lambda function for
            ...
            public fun dialogCodeHook(
                dialogCodeHook: DialogCodeHookSettingProperty.Builder.() -> Unit
            )

            /**
             * @param fulfillmentCodeHook Specifies that Amazon Lex invokes the alias Lambda
             *   function when the intent is ready for fulfillment. You can invoke this function to
            ...
            public fun fulfillmentCodeHook(
                fulfillmentCodeHook: FulfillmentCodeHookSettingProperty.Builder.() -> Unit
            )

            /**
             * @param initialResponseSetting Configuration setting for a response sent to the user
             *   before Amazon Lex starts eliciting slots.
             */
             ...
             *   before Amazon Lex starts eliciting slots.
             */
            public fun initialResponseSetting(
            ...
            public fun initialResponseSetting(
                initialResponseSetting: InitialResponseSettingProperty.Builder.() -> Unit
            )
            ...
            /**
             * @param intentClosingSetting Sets the response that Amazon Lex sends to the user when
             *   the intent is closed.
             */
            ...
            public fun intentClosingSetting(
                intentClosingSetting: IntentClosingSettingProperty.Builder.() -> Unit
            )

            /**
             * @param intentConfirmationSetting Provides prompts that Amazon Lex sends to the user
             *   to confirm the completion of an intent. If the user answers "no," the settings
             ...
             *   contain a statement that is sent to the user to end the intent.
             */
            public fun intentConfirmationSetting(
            ...
            public fun intentConfirmationSetting(
                intentConfirmationSetting: IntentConfirmationSettingProperty.Builder.() -> Unit
            )

            /**
             * @param kendraConfiguration Provides configuration information for the
             *   `AMAZON.KendraSearchIntent` intent. When you use this intent, Amazon Lex searches
             *   the specified Amazon Kendra index and returns documents from the index that match
            ...
            public fun kendraConfiguration(
                kendraConfiguration: KendraConfigurationProperty.Builder.() -> Unit
            )

            /**
             * @param name The name of the intent. Intent names must be unique within the locale
             *   that contains the intent and can't match the name of any built-in intent.
             */
            public fun name(name: String)

            /**
             * @param outputContexts A list of contexts that the intent activates when it is
             *   fulfilled.
             */
            ...
            /**
             * @param sampleUtterances A list of utterances that a user might say to signal the
             *   intent.
             */
            public fun sampleUtterances(sampleUtterances: IResolvable)
            ...
            /**
             * @param slotPriorities Indicates the priority for slots. Amazon Lex prompts the user
             *   for slot values in priority order.
             */
        ...
        private class BuilderImpl : Builder {
             ...
             *   complete the bot's transaction with the user.
             */
            override fun fulfillmentCodeHook(
                fulfillmentCodeHook: FulfillmentCodeHookSettingProperty
            ) {
                cdkBuilder.fulfillmentCodeHook(
                    fulfillmentCodeHook.let(FulfillmentCodeHookSettingProperty::unwrap)
                )
            }
             ...
             *   before Amazon Lex starts eliciting slots.
             */
            override fun initialResponseSetting(
                initialResponseSetting: InitialResponseSettingProperty
            ) {
                cdkBuilder.initialResponseSetting(
                    initialResponseSetting.let(InitialResponseSettingProperty::unwrap)
                )
            }
            ...
            override fun intentClosingSetting(intentClosingSetting: IntentClosingSettingProperty) {
                cdkBuilder.intentClosingSetting(
                    intentClosingSetting.let(IntentClosingSettingProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("e9816be14646177b7f3cd178fa9c093ac2245d32feca4e0d1787621fe249bd62")
            override fun intentClosingSetting(
                intentClosingSetting: IntentClosingSettingProperty.Builder.() -> Unit
            ...
            override fun intentConfirmationSetting(intentConfirmationSetting: IResolvable) {
                cdkBuilder.intentConfirmationSetting(
                    intentConfirmationSetting.let(IResolvable::unwrap)
                )
            }
             ...
             *   contain a statement that is sent to the user to end the intent.
             */
            override fun intentConfirmationSetting(
                intentConfirmationSetting: IntentConfirmationSettingProperty
            ) {
                cdkBuilder.intentConfirmationSetting(
                    intentConfirmationSetting.let(IntentConfirmationSettingProperty::unwrap)
                )
            }
            ...
            override fun kendraConfiguration(kendraConfiguration: KendraConfigurationProperty) {
                cdkBuilder.kendraConfiguration(
                    kendraConfiguration.let(KendraConfigurationProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("838e421c92ce42d573ced09a9bc3ca8ad3f8d86a03d2b11bed05ef5dd44b451f")
            override fun kendraConfiguration(
                kendraConfiguration: KendraConfigurationProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * intent.
             *
             * If the user answers "no," the settings contain a statement that is sent to the user
             * to end the intent.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-lex-bot-intent.html#cfn-lex-bot-intent-intentconfirmationsetting)
             */
            override fun intentConfirmationSetting(): Any? =
                unwrap(this).getIntentConfirmationSetting()

            /**
             * Provides configuration information for the `AMAZON.KendraSearchIntent` intent. When
             * you use this intent, Amazon Lex searches the specified Amazon Kendra index and
             ...
             * The name of the intent.
             *
             * Intent names must be unique within the locale that contains the intent and can't
    ...
    public interface ConditionalSpecificationProperty {
        ...
        public interface Builder {
            /**
             * @param conditionalBranches A list of conditional branches. A conditional branch is
             *   made up of a condition, a response and a next step. The response and next step are
            ...
            /**
             * @param defaultBranch The conditional branch that should be followed when the
             *   conditions for other branches are not satisfied. A conditional branch is made up of
             *   a condition, a response and a next step.
             */
            ...
            public fun defaultBranch(
                defaultBranch: DefaultConditionalBranchProperty.Builder.() -> Unit
            )

            /**
             * @param isActive Determines whether a conditional branch is active. When `IsActive` is
        ...
        private class BuilderImpl : Builder {
            ...
            override fun defaultBranch(defaultBranch: DefaultConditionalBranchProperty) {
                cdkBuilder.defaultBranch(
                    defaultBranch.let(DefaultConditionalBranchProperty::unwrap)
                )
            }
        ...
        internal constructor(
             ...
             * A list of conditional branches.
             *
             * A conditional branch is made up of a condition, a response and a next step. The
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ConditionalSpecificationProperty
            ): software.amazon.awscdk.services.lex.CfnBot.ConditionalSpecificationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface WaitAndContinueSpecificationProperty {
        ...
        /**
         * A response that Amazon Lex sends periodically to the user to indicate that the bot is
         * still waiting for input from the user.
         *
        ...
        public interface Builder {
            /**
             * @param continueResponse The response that Amazon Lex sends to indicate that the bot
            ...
            public fun continueResponse(
                continueResponse: ResponseSpecificationProperty.Builder.() -> Unit
            )

            /**
             * @param isActive Specifies whether the bot will wait for a user to respond. When this
             *   field is false, wait and continue responses for a slot aren't used. If the
             *   `IsActive` field isn't specified, the default is true.
             */
            public fun isActive(isActive: Boolean)
            ...
            /**
             * @param stillWaitingResponse A response that Amazon Lex sends periodically to the user
             *   to indicate that the bot is still waiting for input from the user.
             */
            ...
            public fun stillWaitingResponse(
                stillWaitingResponse: StillWaitingResponseSpecificationProperty.Builder.() -> Unit
            )
            ...
            public fun waitingResponse(
                waitingResponse: ResponseSpecificationProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun continueResponse(continueResponse: ResponseSpecificationProperty) {
                cdkBuilder.continueResponse(
                    continueResponse.let(ResponseSpecificationProperty::unwrap)
                )
            }
             ...
             *   to indicate that the bot is still waiting for input from the user.
             */
            override fun stillWaitingResponse(
                stillWaitingResponse: StillWaitingResponseSpecificationProperty
            ) {
                cdkBuilder.stillWaitingResponse(
                    stillWaitingResponse.let(StillWaitingResponseSpecificationProperty::unwrap)
                )
            }
            ...
            override fun stillWaitingResponse(
                ...
                stillWaitingResponse(
                    StillWaitingResponseSpecificationProperty(stillWaitingResponse)
                )
            ...
            override fun waitingResponse(waitingResponse: ResponseSpecificationProperty) {
                cdkBuilder.waitingResponse(
                    waitingResponse.let(ResponseSpecificationProperty::unwrap)
                )
            }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: WaitAndContinueSpecificationProperty
            ): software.amazon.awscdk.services.lex.CfnBot.WaitAndContinueSpecificationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SlotValueSelectionSettingProperty {
        ...
        public interface Builder {
             ...
             *   settings for slot values. You can use this to enable using slot values as a custom
            ...
            public fun advancedRecognitionSetting(
                advancedRecognitionSetting: AdvancedRecognitionSettingProperty.Builder.() -> Unit
            )
            ...
            /**
             * @param resolutionStrategy Determines the slot resolution strategy that Amazon Lex
             *   uses to return slot type values. The field can be set to one of the following
             *   values:
             * * `ORIGINAL_VALUE` - Returns the value entered by the user, if the user value is
             *   similar to the slot value.
        ...
        private class BuilderImpl : Builder {
            ...
            override fun advancedRecognitionSetting(advancedRecognitionSetting: IResolvable) {
                cdkBuilder.advancedRecognitionSetting(
                    advancedRecognitionSetting.let(IResolvable::unwrap)
                )
            }
             ...
             *   vocabulary for recognizing user utterances.
             */
            override fun advancedRecognitionSetting(
                advancedRecognitionSetting: AdvancedRecognitionSettingProperty
            ) {
                cdkBuilder.advancedRecognitionSetting(
                    advancedRecognitionSetting.let(AdvancedRecognitionSettingProperty::unwrap)
                )
            }
            ...
            override fun advancedRecognitionSetting(
                ...
                advancedRecognitionSetting(
                    AdvancedRecognitionSettingProperty(advancedRecognitionSetting)
                )
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("d6e3e08624093d84f455b1e09b302ce537b99a0a539e30686943abbebc82091d")
            override fun regexFilter(
                regexFilter: SlotValueRegexFilterProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-lex-bot-slotvalueselectionsetting.html#cfn-lex-bot-slotvalueselectionsetting-advancedrecognitionsetting)
             */
            override fun advancedRecognitionSetting(): Any? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SlotValueSelectionSettingProperty
            ): software.amazon.awscdk.services.lex.CfnBot.SlotValueSelectionSettingProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CustomPayloadProperty {
        ...
        internal constructor(
            internal val cdkObject:
                software.amazon.awscdk.services.lex.CfnBot.CustomPayloadProperty,
    ...
    public interface KendraConfigurationProperty {
         ...
         * `AMAZON.KendraSearchIntent` intent to search. The index must be in the same account and
        ...
        /**
         * A query filter that Amazon Lex sends to Amazon Kendra to filter the response from a
         * query.
         *
         * The filter is in the format defined by Amazon Kendra. For more information, see
        ...
        public interface Builder {
            /**
             * @param kendraIndex The Amazon Resource Name (ARN) of the Amazon Kendra index that you
             *   want the `AMAZON.KendraSearchIntent` intent to search. The index must be in the
             *   same account and Region as the Amazon Lex bot.
             */
            public fun kendraIndex(kendraIndex: String)

            /**
             * @param queryFilterString A query filter that Amazon Lex sends to Amazon Kendra to
             *   filter the response from a query. The filter is in the format defined by Amazon
            ...
            /**
             * @param queryFilterStringEnabled Determines whether the `AMAZON.KendraSearchIntent`
        ...
        private class BuilderImpl : Builder {
            ...
            override fun queryFilterStringEnabled(queryFilterStringEnabled: IResolvable) {
                cdkBuilder.queryFilterStringEnabled(
                    queryFilterStringEnabled.let(IResolvable::unwrap)
                )
            }
        ...
        internal constructor(
            ...
            /**
             * The Amazon Resource Name (ARN) of the Amazon Kendra index that you want the
             * `AMAZON.KendraSearchIntent` intent to search. The index must be in the same account
             * and Region as the Amazon Lex bot.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-lex-bot-kendraconfiguration.html#cfn-lex-bot-kendraconfiguration-kendraindex)
             */
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-lex-bot-kendraconfiguration.html#cfn-lex-bot-kendraconfiguration-queryfilterstringenabled)
             */
            override fun queryFilterStringEnabled(): Any? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: KendraConfigurationProperty
            ): software.amazon.awscdk.services.lex.CfnBot.KendraConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface VoiceSettingsProperty {
        ...
        public interface Builder {
            /**
             * @param engine Indicates the type of Amazon Polly voice that Amazon Lex should use for
    ...
    public interface SlotDefaultValueProperty {
        ...
        public interface Builder {
            /**
             * @param defaultValue The default value to use when a user doesn't provide a value for
             *   a slot.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SlotDefaultValueProperty
            ): software.amazon.awscdk.services.lex.CfnBot.SlotDefaultValueProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SampleUtteranceProperty {
        ...
        public interface Builder {
            /**
             * @param utterance A sample utterance that invokes an intent or respond to a slot
             *   elicitation prompt.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SampleUtteranceProperty
            ): software.amazon.awscdk.services.lex.CfnBot.SampleUtteranceProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CodeHookSpecificationProperty {
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("f451ff6aa6641cca6cfeb3e15e5f3bf09cf1ac49c765ccc771440fd1aeca55fa")
            override fun lambdaCodeHook(
                lambdaCodeHook: LambdaCodeHookProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CodeHookSpecificationProperty
            ): software.amazon.awscdk.services.lex.CfnBot.CodeHookSpecificationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface MessageProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param imageResponseCard A message that defines a response card that the client
            ...
            public fun imageResponseCard(
                imageResponseCard: ImageResponseCardProperty.Builder.() -> Unit
            )
            ...
            public fun plainTextMessage(
                plainTextMessage: PlainTextMessageProperty.Builder.() -> Unit
            )
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("ad015830bece36c3a52b1a923a144b6dd7491f383507066dd16c6bb69ba05c13")
            override fun customPayload(
                customPayload: CustomPayloadProperty.Builder.() -> Unit
            ...
            override fun imageResponseCard(imageResponseCard: ImageResponseCardProperty) {
                cdkBuilder.imageResponseCard(
                    imageResponseCard.let(ImageResponseCardProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("e671065ac1e2e419839b73ba7f95aebf7d9ee6409d3e26f73dc5ef6af1aae1d6")
            override fun imageResponseCard(
                imageResponseCard: ImageResponseCardProperty.Builder.() -> Unit
    ...
    public interface IntentConfirmationSettingProperty {
         ...
         *
         * The dialog code hook is triggered based on these invocation settings when the
         * confirmation next step or declination next step or failure next step is
        ...
        public interface Builder {
             ...
             *   settings when the confirmation next step or declination next step or failure next
            ...
            /**
             * @param confirmationConditional A list of conditional branches to evaluate after the
             *   intent is closed.
             */
             ...
             *   intent is closed.
             */
            public fun confirmationConditional(
            ...
            public fun confirmationConditional(
                confirmationConditional: ConditionalSpecificationProperty.Builder.() -> Unit
            )

            /**
             * @param confirmationNextStep Specifies the next step that the bot executes when the
             *   customer confirms the intent.
             */
            ...
            public fun confirmationNextStep(
                confirmationNextStep: DialogStateProperty.Builder.() -> Unit
            )

            /**
             * @param confirmationResponse Specifies a list of message groups that Amazon Lex uses
             *   to respond the user input.
             */
            ...
            public fun confirmationResponse(
                confirmationResponse: ResponseSpecificationProperty.Builder.() -> Unit
            )

            /**
             * @param declinationConditional A list of conditional branches to evaluate after the
             *   intent is declined.
             */
             ...
             *   intent is declined.
             */
            public fun declinationConditional(
            ...
            public fun declinationConditional(
                declinationConditional: ConditionalSpecificationProperty.Builder.() -> Unit
            )

            /**
             * @param declinationNextStep Specifies the next step that the bot executes when the
             *   customer declines the intent.
             */
            ...
            public fun declinationNextStep(
                declinationNextStep: DialogStateProperty.Builder.() -> Unit
            )

            /**
             * @param declinationResponse When the user answers "no" to the question defined in
             *   `promptSpecification` , Amazon Lex responds with this response to acknowledge that
            ...
            public fun declinationResponse(
                declinationResponse: ResponseSpecificationProperty.Builder.() -> Unit
            )

            /**
             * @param elicitationCodeHook The `DialogCodeHookInvocationSetting` used when the code
            ...
            /**
             * @param failureConditional Provides a list of conditional branches. Branches are
             *   evaluated in the order that they are entered in the list. The first branch with a
             *   condition that evaluates to true is executed. The last branch in the list is the
             *   default branch. The default branch should not have any condition expression. The
            ...
            /**
             * @param failureNextStep The next step to take in the conversation if the confirmation
             *   step fails.
             */
            public fun failureNextStep(failureNextStep: IResolvable)
            ...
            /**
             * @param failureResponse Specifies a list of message groups that Amazon Lex uses to
             *   respond the user input when the intent confirmation fails.
             */
            public fun failureResponse(failureResponse: IResolvable)
            ...
            /**
             * @param isActive Specifies whether the intent's confirmation is sent to the user. When
             *   this field is false, confirmation and declination responses aren't sent. If the
             *   `IsActive` field isn't specified, the default is true.
             */
            public fun isActive(isActive: Boolean)
            ...
            /**
             * @param promptSpecification Prompts the user to confirm the intent. This question
             *   should have a yes or no answer. Amazon Lex uses this prompt to ensure that the user
             *   acknowledges that the intent is ready for fulfillment. For example, with the
             *   `OrderPizza` intent, you might want to confirm that the order is correct before
             *   placing it. For other intents, such as intents that simply respond to user
             *   questions, you might not need to ask the user for confirmation before providing the
             *   information.
             */
            public fun promptSpecification(promptSpecification: IResolvable)
        ...
        private class BuilderImpl : Builder {
             ...
             *   intent is closed.
             */
            override fun confirmationConditional(
                confirmationConditional: ConditionalSpecificationProperty
            ) {
                cdkBuilder.confirmationConditional(
                    confirmationConditional.let(ConditionalSpecificationProperty::unwrap)
                )
            }
            ...
            override fun confirmationConditional(
                ...
                confirmationConditional(ConditionalSpecificationProperty(confirmationConditional))
            ...
            override fun confirmationNextStep(confirmationNextStep: DialogStateProperty) {
                cdkBuilder.confirmationNextStep(
                    confirmationNextStep.let(DialogStateProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("92252d01a23366c7f5af3fda3130a644232f17ec30b3e26fea5a0344fb0ce7c9")
            override fun confirmationNextStep(
                confirmationNextStep: DialogStateProperty.Builder.() -> Unit
            ...
            override fun confirmationResponse(confirmationResponse: ResponseSpecificationProperty) {
                cdkBuilder.confirmationResponse(
                    confirmationResponse.let(ResponseSpecificationProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("ab1133f530b5e02ebe17440bf0f63922e57873816cbd60f120151814326e0823")
            override fun confirmationResponse(
                confirmationResponse: ResponseSpecificationProperty.Builder.() -> Unit
            ...
            override fun declinationConditional(
                ...
                cdkBuilder.declinationConditional(
                    declinationConditional.let(ConditionalSpecificationProperty::unwrap)
                )
            }
            ...
            override fun declinationConditional(
                ...
                declinationConditional(ConditionalSpecificationProperty(declinationConditional))
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("021dd7a73ddf2c8f8f3334cc0134247737ae805738911313c3a670457662721d")
            override fun declinationNextStep(
                declinationNextStep: DialogStateProperty.Builder.() -> Unit
            ...
            override fun declinationResponse(declinationResponse: ResponseSpecificationProperty) {
                cdkBuilder.declinationResponse(
                    declinationResponse.let(ResponseSpecificationProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("63c7c3e99fb1f82251b6c49854a3f7f9b1820b1170412a08b7d2d956ae5c6960")
            override fun declinationResponse(
                declinationResponse: ResponseSpecificationProperty.Builder.() -> Unit
        ...
        internal constructor(
            ...
            /**
             * When the user answers "no" to the question defined in `promptSpecification` , Amazon
             * Lex responds with this response to acknowledge that the intent was canceled.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-lex-bot-intentconfirmationsetting.html#cfn-lex-bot-intentconfirmationsetting-declinationresponse)
             */
            ...
            /**
             * Specifies a list of message groups that Amazon Lex uses to respond the user input
             * when the intent confirmation fails.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-lex-bot-intentconfirmationsetting.html#cfn-lex-bot-intentconfirmationsetting-failureresponse)
             */
            override fun failureResponse(): Any? = unwrap(this).getFailureResponse()
             ...
             * confirm that the order is correct before placing it. For other intents, such as
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: IntentConfirmationSettingProperty
            ): software.amazon.awscdk.services.lex.CfnBot.IntentConfirmationSettingProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface AudioLogDestinationProperty {
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("f023faf47be12eb4518c36ca8b3dfd94a6e8c653081baca56b7a2f01b8bcb5e1")
            override fun s3Bucket(
                s3Bucket: S3BucketLogDestinationProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AudioLogDestinationProperty
            ): software.amazon.awscdk.services.lex.CfnBot.AudioLogDestinationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DataPrivacyProperty {
         ...
         * or `false` in the `childDirected` field.
         *
         * By specifying `true` in the `childDirected` field, you confirm that your use of Amazon
         * Lex *is* related to a website, program, or other application that is directed or
         * targeted, in whole or in part, to children under age 13 and subject to COPPA. By
         * specifying `false` in the `childDirected` field, you confirm that your use of Amazon Lex
         * *is not* related to a website, program, or other application that is directed or
         ...
         * whether your use of Amazon Lex is related to a website, program, or other application
         * that is directed or targeted, in whole or in part, to children under age 13 and subject
         * to COPPA. If your use of Amazon Lex relates to a website, program, or other application
         * that is directed in whole or in part, to children under age 13, you must obtain any
         * required verifiable parental consent under COPPA. For information regarding the use of
        ...
        public interface Builder {
            /**
             * @param childDirected For each Amazon Lex bot created with the Amazon Lex Model
             *   Building Service, you must specify whether your use of Amazon Lex is related to a
             ...
             *   Protection Act (COPPA) by specifying `true` or `false` in the `childDirected`
             *   field. By specifying `true` in the `childDirected` field, you confirm that your use
             *   of Amazon Lex *is* related to a website, program, or other application that is
             ...
             *   use of Amazon Lex *is not* related to a website, program, or other application that
             *   is directed or targeted, in whole or in part, to children under age 13 and subject
             *   to COPPA. You may not specify a default value for the `childDirected` field that
             *   does not accurately reflect whether your use of Amazon Lex is related to a website,
             *   program, or other application that is directed or targeted, in whole or in part, to
             *   children under age 13 and subject to COPPA. If your use of Amazon Lex relates to a
             ...
             *   websites, programs, or other applications that are directed or targeted, in whole
             *   or in part, to children under age 13, see the
             *   [Amazon Lex FAQ](https://docs.aws.amazon.com/lex/faqs#data-security) .
             */
        ...
        internal constructor(
             ...
             *
             * By specifying `true` in the `childDirected` field, you confirm that your use of
             * Amazon Lex *is* related to a website, program, or other application that is directed
             * or targeted, in whole or in part, to children under age 13 and subject to COPPA. By
             * specifying `false` in the `childDirected` field, you confirm that your use of Amazon
             * Lex *is not* related to a website, program, or other application that is directed or
             * targeted, in whole or in part, to children under age 13 and subject to COPPA. You may
             * not specify a default value for the `childDirected` field that does not accurately
             * reflect whether your use of Amazon Lex is related to a website, program, or other
             * application that is directed or targeted, in whole or in part, to children under age
             * 13 and subject to COPPA. If your use of Amazon Lex relates to a website, program, or
             * other application that is directed in whole or in part, to children under age 13, you
             ...
             * age 13, see the [Amazon Lex FAQ](https://docs.aws.amazon.com/lex/faqs#data-security)
             * .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-lex-bot-dataprivacy.html#cfn-lex-bot-dataprivacy-childdirected)
             */
