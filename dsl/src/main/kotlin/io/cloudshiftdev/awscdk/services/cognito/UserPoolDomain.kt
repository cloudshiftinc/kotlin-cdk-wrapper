...
internal constructor(
     ...
     *
     * If `customDomain` was selected, this holds the full domain name that was specified. If the
     * `cognitoDomain` was used, it contains the prefix to the Cognito hosted domain.
     */
     ...
     *
     * @param client [disable-awslint:ref-via-interface] the user pool client that the UI will use
     *   to interact with the UserPool.
    ...
    public open fun signInUrl(client: UserPoolClient, options: SignInUrlOptions): String =
        unwrap(this)
            .signInUrl(client.let(UserPoolClient::unwrap), options.let(SignInUrlOptions::unwrap))
    ...
    public open fun signInUrl(
        client: UserPoolClient,
        options: SignInUrlOptions.Builder.() -> Unit
    ...
    public interface Builder {
        ...
        /**
         * Associate a custom domain with your user pool Either `customDomain` or `cognitoDomain`
         * must be specified.
         *
         ...
         *
         * @param customDomain Associate a custom domain with your user pool Either `customDomain`
         *   or `cognitoDomain` must be specified.
         */
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.cognito.UserPoolDomain =
            cdkBuilder.build()
    }
    ...
    public companion object {
        public fun fromDomainName(
            ...
            software.amazon.awscdk.services.cognito.UserPoolDomain.fromDomainName(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    userPoolDomainName
                )
                .let(IUserPoolDomain::wrap)
