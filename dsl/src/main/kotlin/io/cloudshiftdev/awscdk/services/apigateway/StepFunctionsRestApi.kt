...
internal constructor(
    ...
    public interface Builder {
        ...
        /**
         * If the whole authorizer object, including custom context values should be in the
         * execution input.
         *
         ...
         * Default: false
         *
         * @param authorizer If the whole authorizer object, including custom context values should
         *   be in the execution input.
         */
         ...
         *
         * This stateMachine will be used as a the default integration for all methods in this API,
         * unless specified otherwise in `addMethod`.
         *
         ...
         * Default: true
         *
         * @param useDefaultMethodResponses Whether to add default response models with 200, 400,
         *   and 500 status codes to the method.
         */
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.apigateway.StepFunctionsRestApi.Builder.create(
                scope,
                id
            )
