...
internal constructor(
    ...
    /** Contains the scaling configuration of an Neptune Serverless DB cluster. */
    public open fun serverlessScalingConfiguration(
        `value`: ServerlessScalingConfigurationProperty
    ) {
        unwrap(this)
            .setServerlessScalingConfiguration(
                `value`.let(ServerlessScalingConfigurationProperty::unwrap)
            )
    }
    ...
    public open fun serverlessScalingConfiguration(
        `value`: ServerlessScalingConfigurationProperty.Builder.() -> Unit
    ...
    public interface Builder {
         ...
         *
         * @param availabilityZones Provides the list of EC2 Availability Zones that instances in
         ...
         *
         * @param backupRetentionPeriod Specifies the number of days for which automatic DB
         ...
         *
         * The `Port` property will soon be deprecated. Please update existing templates to use the
         * new `DBPort` property that has the same functionality.
         *
         ...
         *
         * @param dbPort The port number on which the DB instances in the DB cluster accept
         *   connections.
         */
         ...
         *
         * @param enableCloudwatchLogsExports Specifies a list of log types that are enabled for
         ...
         *
         * @param iamAuthEnabled True if mapping of Amazon Identity and Access Management (IAM)
         ...
         *
         * @param preferredBackupWindow Specifies the daily time range during which automated
         ...
         *   Serverless DB cluster.
         */
        public fun serverlessScalingConfiguration(
        ...
        public fun serverlessScalingConfiguration(
            serverlessScalingConfiguration:
                ServerlessScalingConfigurationProperty.Builder.() -> Unit
        )
         ...
         * `SnapshotIdentifier` for any future updates to the DB cluster. When you specify this
         * property for an update, the DB cluster is not restored from the snapshot again, and the
         * data in the database is not changed.
         *
         * However, if you don't specify the `SnapshotIdentifier` , an empty DB cluster is created,
         * and the original DB cluster is deleted. If you specify a property that is different from
         * the previous snapshot restore property, the DB cluster is restored from the snapshot
         * specified by the `SnapshotIdentifier` , and the original DB cluster is deleted.
         *
         ...
         *
         * @param snapshotIdentifier Specifies the identifier for a DB cluster snapshot. Must match
         ...
         *
         * @param sourceDbClusterIdentifier Creates a new DB cluster from a DB snapshot or DB
         *   cluster snapshot.
         */
         ...
         * `SourceDBInstanceIdentifier` property, don't specify this property. The value is
         * inherited from the cluster, snapshot, or source DB instance. If you specify the
         * `KmsKeyId` property, you must enable encryption.
         *
         * If you specify the `KmsKeyId` , you must enable encryption by setting `StorageEncrypted`
         * to true.
         *
         ...
         *
         * @param vpcSecurityGroupIds Provides a list of VPC security groups that the DB cluster
         *   belongs to.
         */
    ...
    private class BuilderImpl(
        ...
        override fun serverlessScalingConfiguration(serverlessScalingConfiguration: IResolvable) {
            cdkBuilder.serverlessScalingConfiguration(
                serverlessScalingConfiguration.let(IResolvable::unwrap)
            )
        }
         ...
         *   Serverless DB cluster.
         */
        override fun serverlessScalingConfiguration(
            serverlessScalingConfiguration: ServerlessScalingConfigurationProperty
        ) {
            cdkBuilder.serverlessScalingConfiguration(
                serverlessScalingConfiguration.let(ServerlessScalingConfigurationProperty::unwrap)
            )
        }
        ...
        override fun serverlessScalingConfiguration(
            ...
            serverlessScalingConfiguration(
                ServerlessScalingConfigurationProperty(serverlessScalingConfiguration)
            )
        ...
        public fun build(): software.amazon.awscdk.services.neptune.CfnDBCluster =
            cdkBuilder.build()
    }
    ...
    public companion object {
        ...
        ): software.amazon.awscdk.services.neptune.CfnDBCluster = wrapped.cdkObject
    }
    ...
    public interface DBClusterRoleProperty {
        ...
        public interface Builder {
            /**
             * @param featureName The name of the feature associated with the Amazon Identity and
    ...
    public interface ServerlessScalingConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param maxCapacity The maximum number of Neptune capacity units (NCUs) for a DB
             *   instance in a Neptune Serverless cluster. You can specify NCU values in half-step
             *   increments, such as 40, 40.5, 41, and so on.
             */
            public fun maxCapacity(maxCapacity: Number)

            /**
             * @param minCapacity The minimum number of Neptune capacity units (NCUs) for a DB
             *   instance in a Neptune Serverless cluster. You can specify NCU values in half-step
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ServerlessScalingConfigurationProperty
            ): software.amazon.awscdk.services.neptune.CfnDBCluster.ServerlessScalingConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
