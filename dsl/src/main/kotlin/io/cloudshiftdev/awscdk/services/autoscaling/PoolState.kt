...
public enum class PoolState(
  ...
  public companion object {
    internal fun wrap(cdkObject: software.amazon.awscdk.services.autoscaling.PoolState): PoolState =
        when (cdkObject) {
      software.amazon.awscdk.services.autoscaling.PoolState.HIBERNATED -> PoolState.HIBERNATED
    ...
    internal fun unwrap(wrapped: PoolState): software.amazon.awscdk.services.autoscaling.PoolState =
        wrapped.cdkObject
  }
}
