...
public interface StageOptions : MethodDeploymentOptions {
     ...
     *
     * The format must include either `AccessLogFormat.contextRequestId()` or
     * `AccessLogFormat.contextExtendedRequestId()`.
     *
    ...
    public interface Builder {
        /**
         * @param accessLogDestination The CloudWatch Logs log group or Firehose delivery stream
         *   where to write access logs.
         */
        public fun accessLogDestination(accessLogDestination: IAccessLogDestination)

        /**
         * @param accessLogFormat A single line format of access logs of data, as specified by
         *   selected $content variables. The format must include either
         *   `AccessLogFormat.contextRequestId()` or `AccessLogFormat.contextExtendedRequestId()`.
         */
        ...
        /**
         * @param cacheTtl Specifies the time to live (TTL), in seconds, for cached responses. The
         ...
         *   When enabled, API gateway will log the full API requests and responses. This can be
         *   useful to troubleshoot APIs, but can result in logging sensitive data. We recommend
         *   that you don't enable this feature for production APIs.
         */
        ...
        /**
         * @param methodOptions Method deployment options for specific resources/methods. These will
        ...
        /**
         * @param stageName The name of the stage, which API Gateway uses as the first path segment
         *   in the invoked Uniform Resource Identifier (URI).
         */
        public fun stageName(stageName: String)

        /**
         * @param throttlingBurstLimit Specifies the throttling burst limit. The total rate of all
         *   requests in your AWS account is limited to 5,000 requests.
         */
        public fun throttlingBurstLimit(throttlingBurstLimit: Number)

        /**
         * @param throttlingRateLimit Specifies the throttling rate limit. The total rate of all
         *   requests in your AWS account is limited to 10,000 requests per second (rps).
         */
        ...
        /**
         * @param variables A map that defines the stage variables. Variable names must consist of
         *   alphanumeric characters, and the values must match the following regular expression:
         *   [A-Za-z0-9-._~:/?#&amp;=,]+.
         */
    ...
    private class BuilderImpl : Builder {
        ...
        override fun methodOptions(methodOptions: Map<String, MethodDeploymentOptions>) {
            cdkBuilder.methodOptions(
                methodOptions.mapValues { MethodDeploymentOptions.unwrap(it.value) }
            )
        }
        ...
        public fun build(): software.amazon.awscdk.services.apigateway.StageOptions =
            cdkBuilder.build()
    }
    ...
    internal constructor(
         ...
         *
         * When enabled, API gateway will log the full API requests and responses. This can be
         * useful to troubleshoot APIs, but can result in logging sensitive data. We recommend that
         * you don't enable this feature for production APIs.
         *
         * Default: false
         */
        ...
        /**
         * Specifies the logging level for this method, which effects the log entries pushed to
         ...
         *
         * The total rate of all requests in your AWS account is limited to 10,000 requests per
         * second (rps).
         *
         * Default: - No additional restriction.
         *
