...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.iot.CfnJobTemplate,
    ...
    public open fun jobExecutionsRetryConfig(`value`: JobExecutionsRetryConfigProperty) {
        unwrap(this)
            .setJobExecutionsRetryConfig(`value`.let(JobExecutionsRetryConfigProperty::unwrap))
    }

    /** Allows you to create the criteria to retry a job. */
    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("587ee1bebb4160b831e3a9c3ad3bf8a0ac25a736f62ecefff71478b4a1173066")
    public open fun jobExecutionsRetryConfig(
        `value`: JobExecutionsRetryConfigProperty.Builder.() -> Unit
    ): Unit = jobExecutionsRetryConfig(JobExecutionsRetryConfigProperty(`value`))

    /** Allows you to create a staged rollout of a job. */
    public open fun jobExecutionsRolloutConfig(): Any? =
     ...
     * with a predetermined start time and duration for the rollout of a job document to all devices
    ...
    public interface Builder {
         ...
         *
         * @param destinationPackageVersions The package version Amazon Resource Names (ARNs) that
         *   are installed on the device’s reserved named shadow ( `$package` ) when the job
        ...
        public fun jobExecutionsRetryConfig(
            jobExecutionsRetryConfig: JobExecutionsRetryConfigProperty.Builder.() -> Unit
        )
         ...
         *
         * @param maintenanceWindows An optional configuration within the SchedulingConfig to setup
         *   a recurring maintenance window with a predetermined start time and duration for the
         ...
         *
         * @param timeoutConfig Specifies the amount of time each device has to finish its execution
         *   of the job.
         */
    ...
    private class BuilderImpl(
         ...
         * @param jobExecutionsRetryConfig Allows you to create the criteria to retry a job.
         */
        override fun jobExecutionsRetryConfig(
            jobExecutionsRetryConfig: JobExecutionsRetryConfigProperty
        ) {
            cdkBuilder.jobExecutionsRetryConfig(
                jobExecutionsRetryConfig.let(JobExecutionsRetryConfigProperty::unwrap)
            )
        }
        ...
        override fun jobExecutionsRetryConfig(
            ...
            jobExecutionsRetryConfig(JobExecutionsRetryConfigProperty(jobExecutionsRetryConfig))
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnJobTemplate
        ): software.amazon.awscdk.services.iot.CfnJobTemplate = wrapped.cdkObject
    }
    ...
    public interface JobExecutionsRolloutConfigProperty {
        ...
        public interface Builder {
            /**
             * @param exponentialRolloutRate The rate of increase for a job rollout. This parameter
             *   allows you to define an exponential rate for a job rollout.
             */
            ...
            public fun exponentialRolloutRate(
                exponentialRolloutRate: ExponentialRolloutRateProperty.Builder.() -> Unit
            )

            /**
             * @param maximumPerMinute The maximum number of things that will be notified of a
             *   pending job, per minute. This parameter allows you to create a staged rollout.
             */
        ...
        private class BuilderImpl : Builder {
             ...
             *   allows you to define an exponential rate for a job rollout.
             */
            override fun exponentialRolloutRate(
                exponentialRolloutRate: ExponentialRolloutRateProperty
            ) {
                cdkBuilder.exponentialRolloutRate(
                    exponentialRolloutRate.let(ExponentialRolloutRateProperty::unwrap)
                )
            }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: JobExecutionsRolloutConfigProperty
            ): software.amazon.awscdk.services.iot.CfnJobTemplate.JobExecutionsRolloutConfigProperty =
    ...
    public interface AbortCriteriaProperty {
        ...
        /**
         * The minimum number of things which must receive job execution notifications before the
         * job can be aborted.
         *
        ...
        public interface Builder {
            ...
            /**
             * @param thresholdPercentage The minimum percentage of job execution failures that must
             *   occur to initiate the job abort. AWS IoT Core supports up to two digits after the
        ...
        internal constructor(
             ...
             * abort.
             *
             * AWS IoT Core supports up to two digits after the decimal (for example, 10.9 and
    ...
    public interface TimeoutConfigProperty {
        ...
        public interface Builder {
            /**
             * @param inProgressTimeoutInMinutes Specifies the amount of time, in minutes, this
             *   device has to finish execution of this job. The timeout interval can be anywhere
             *   between 1 minute and 7 days (1 to 10080 minutes). The in progress timer can't be
             *   updated and will apply to all job executions for the job. Whenever a job execution
        ...
        internal constructor(
             ...
             * than this interval, the job execution will fail and switch to the terminal
             * `TIMED_OUT` status.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-iot-jobtemplate-timeoutconfig.html#cfn-iot-jobtemplate-timeoutconfig-inprogresstimeoutinminutes)
             */
    ...
    public interface PresignedUrlConfigProperty {
        ...
        public interface Builder {
            /**
             * @param expiresInSec How long (in seconds) pre-signed URLs are valid. Valid values are
             *   60 - 3600, the default value is 3600 seconds. Pre-signed URLs are generated when
             *   Jobs receives an MQTT request for the job document.
             */
            public fun expiresInSec(expiresInSec: Number)

            /**
             * @param roleArn The ARN of an IAM role that grants grants permission to download files
             *   from the S3 bucket where the job data/updates are stored. The role must also grant
        ...
        internal constructor(
             ...
             * bucket where the job data/updates are stored.
             *
             * The role must also grant permission for IoT to download the files.
             *
             * For information about addressing the confused deputy problem, see
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: PresignedUrlConfigProperty
            ): software.amazon.awscdk.services.iot.CfnJobTemplate.PresignedUrlConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface JobExecutionsRetryConfigProperty {
        /**
         * The list of criteria that determines how many retries are allowed for each failure type
         * for a job.
         *
        ...
        public interface Builder {
            /**
             * @param retryCriteriaList The list of criteria that determines how many retries are
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: JobExecutionsRetryConfigProperty
            ): software.amazon.awscdk.services.iot.CfnJobTemplate.JobExecutionsRetryConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface RateIncreaseCriteriaProperty {
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-iot-jobtemplate-rateincreasecriteria.html#cfn-iot-jobtemplate-rateincreasecriteria-numberofnotifiedthings)
             */
            override fun numberOfNotifiedThings(): Number? =
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-iot-jobtemplate-rateincreasecriteria.html#cfn-iot-jobtemplate-rateincreasecriteria-numberofsucceededthings)
             */
            override fun numberOfSucceededThings(): Number? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RateIncreaseCriteriaProperty
            ): software.amazon.awscdk.services.iot.CfnJobTemplate.RateIncreaseCriteriaProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface AbortConfigProperty {
        ...
        public interface Builder {
            /**
             * @param criteriaList The list of criteria that determine when and how to abort the
             *   job.
             */
    ...
    public interface ExponentialRolloutRateProperty {
        ...
        public interface Builder {
            /**
             * @param baseRatePerMinute The minimum number of things that will be notified of a
             *   pending job, per minute at the start of job rollout. This parameter allows you to
             *   define the initial rate of rollout.
             */
            public fun baseRatePerMinute(baseRatePerMinute: Number)

            /**
             * @param incrementFactor The exponential factor to increase the rate of rollout for a
             *   job. AWS IoT Core supports up to one digit after the decimal (for example, 1.5, but
             *   not 1.55).
             */
            public fun incrementFactor(incrementFactor: Number)

            /**
             * @param rateIncreaseCriteria The criteria to initiate the increase in rate of rollout
             *   for a job.
             */
            ...
            public fun rateIncreaseCriteria(
                rateIncreaseCriteria: RateIncreaseCriteriaProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun rateIncreaseCriteria(rateIncreaseCriteria: RateIncreaseCriteriaProperty) {
                cdkBuilder.rateIncreaseCriteria(
                    rateIncreaseCriteria.let(RateIncreaseCriteriaProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("edd0b24b3eb5a02d63c072c1c5088f14930c44fdb725bef7353a97719ebbf811")
            override fun rateIncreaseCriteria(
                rateIncreaseCriteria: RateIncreaseCriteriaProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * The exponential factor to increase the rate of rollout for a job.
             *
             * AWS IoT Core supports up to one digit after the decimal (for example, 1.5, but not
             * 1.55).
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-iot-jobtemplate-exponentialrolloutrate.html#cfn-iot-jobtemplate-exponentialrolloutrate-incrementfactor)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ExponentialRolloutRateProperty
            ): software.amazon.awscdk.services.iot.CfnJobTemplate.ExponentialRolloutRateProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
