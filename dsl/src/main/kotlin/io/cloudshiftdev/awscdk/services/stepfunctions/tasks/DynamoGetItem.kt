...
internal constructor(
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.stepfunctions.tasks.DynamoGetItem.Builder.create(
                scope,
                id
            )
        ...
        override fun projectionExpression(projectionExpression: List<DynamoProjectionExpression>) {
            cdkBuilder.projectionExpression(
                projectionExpression.map(DynamoProjectionExpression::unwrap)
            )
        }
         ...
         *   more attributes to retrieve from the table.
         */
        override fun projectionExpression(
            vararg projectionExpression: DynamoProjectionExpression
        ): Unit = projectionExpression(projectionExpression.toList())
