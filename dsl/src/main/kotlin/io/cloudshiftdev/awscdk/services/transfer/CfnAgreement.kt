...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param baseDirectory The landing directory (folder) for files that are transferred by
         ...
         *
         * @param partnerProfileId A unique identifier for the partner profile used in the
         *   agreement.
         */
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.transfer.CfnAgreement =
            cdkBuilder.build()
    }
