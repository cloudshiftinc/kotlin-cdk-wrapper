...
internal constructor(
     ...
     * and test your image configuration.
     */
    public open fun additionalInstanceConfiguration(
        `value`: AdditionalInstanceConfigurationProperty
    ) {
        unwrap(this)
            .setAdditionalInstanceConfiguration(
                `value`.let(AdditionalInstanceConfigurationProperty::unwrap)
            )
    }
    ...
    public open fun additionalInstanceConfiguration(
        `value`: AdditionalInstanceConfigurationProperty.Builder.() -> Unit
    ...
    public interface Builder {
         ...
         * build and test your image configuration.
         *
         * Instance configuration adds a layer of control over those instances. You can define
         ...
         *
         * @param additionalInstanceConfiguration Before you create a new AMI, Image Builder
         *   launches temporary Amazon EC2 instances to build and test your image configuration.
         */
        ...
        public fun additionalInstanceConfiguration(
            additionalInstanceConfiguration:
                AdditionalInstanceConfigurationProperty.Builder.() -> Unit
        )
         ...
         *
         * @param blockDeviceMappings The block device mappings to apply when creating images from
         *   this recipe.
         */
    ...
    private class BuilderImpl(
        ...
        override fun additionalInstanceConfiguration(additionalInstanceConfiguration: IResolvable) {
            cdkBuilder.additionalInstanceConfiguration(
                additionalInstanceConfiguration.let(IResolvable::unwrap)
            )
        }
         ...
         *   launches temporary Amazon EC2 instances to build and test your image configuration.
         */
        override fun additionalInstanceConfiguration(
            additionalInstanceConfiguration: AdditionalInstanceConfigurationProperty
        ) {
            cdkBuilder.additionalInstanceConfiguration(
                additionalInstanceConfiguration.let(AdditionalInstanceConfigurationProperty::unwrap)
            )
        }
        ...
        override fun additionalInstanceConfiguration(
            ...
            additionalInstanceConfiguration(
                AdditionalInstanceConfigurationProperty(additionalInstanceConfiguration)
            )
    ...
    public interface ComponentParameterProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ComponentParameterProperty
            ): software.amazon.awscdk.services.imagebuilder.CfnImageRecipe.ComponentParameterProperty =
    ...
    public interface AdditionalInstanceConfigurationProperty {
         ...
         * build instance.
         *
         * The userDataOverride property replaces any commands that Image Builder might have added
         * to ensure that Systems Manager is installed on your Linux build instance. If you override
         * the user data, make sure that you add commands to install Systems Manager, if it is not
         * pre-installed on your base image.
         *
         * The user data is always base 64 encoded. For example, the following commands are encoded
         * as `IyEvYmluL2Jhc2gKbWtkaXIgLXAgL3Zhci9iYi8KdG91Y2ggL3Zhci$` :
         *
         * *#!/bin/bash*
         *
         * mkdir -p /var/bb/
        ...
        public interface Builder {
            /**
             * @param systemsManagerAgent Contains settings for the Systems Manager agent on your
             *   build instance.
             */
            ...
            public fun systemsManagerAgent(
                systemsManagerAgent: SystemsManagerAgentProperty.Builder.() -> Unit
            )

            /**
             * @param userDataOverride Use this property to provide commands or a command script to
             *   run when you launch your build instance. The userDataOverride property replaces any
        ...
        private class BuilderImpl : Builder {
            ...
            override fun systemsManagerAgent(systemsManagerAgent: SystemsManagerAgentProperty) {
                cdkBuilder.systemsManagerAgent(
                    systemsManagerAgent.let(SystemsManagerAgentProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("9103d23f896be0e9de53c701e87aafb2c948661dcff257c9a29cb652d6cb1329")
            override fun systemsManagerAgent(
                systemsManagerAgent: SystemsManagerAgentProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * you override the user data, make sure that you add commands to install Systems
             * Manager, if it is not pre-installed on your base image.
             *
             * The user data is always base 64 encoded. For example, the following commands are
             * encoded as `IyEvYmluL2Jhc2gKbWtkaXIgLXAgL3Zhci9iYi8KdG91Y2ggL3Zhci$` :
             *
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AdditionalInstanceConfigurationProperty
            ): software.amazon.awscdk.services.imagebuilder.CfnImageRecipe.AdditionalInstanceConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ComponentConfigurationProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param parameters A group of parameter settings that Image Builder uses to configure
    ...
    public interface SystemsManagerAgentProperty {
        /**
         * Controls whether the Systems Manager agent is removed from your final build image, prior
         * to creating the new AMI.
         *
         * If this is set to true, then the agent is removed from the final image. If it's set to
         * false, then the agent is left in, so that it is included in the new AMI. The default
         * value is false.
         *
        ...
        public interface Builder {
            /**
             * @param uninstallAfterBuild Controls whether the Systems Manager agent is removed from
             *   your final build image, prior to creating the new AMI. If this is set to true, then
             *   the agent is removed from the final image. If it's set to false, then the agent is
        ...
        internal constructor(
             ...
             * prior to creating the new AMI.
             *
             * If this is set to true, then the agent is removed from the final image. If it's set
             * to false, then the agent is left in, so that it is included in the new AMI. The
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SystemsManagerAgentProperty
            ): software.amazon.awscdk.services.imagebuilder.CfnImageRecipe.SystemsManagerAgentProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface InstanceBlockDeviceMappingProperty {
        ...
        private class BuilderImpl : Builder {
            ...
            @JvmName("81df05fefd03046b380ec12ea800dec283d0ed7acb50b2a7b9ce3905e31e3b5e")
            override fun ebs(
                ebs: EbsInstanceBlockDeviceSpecificationProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: InstanceBlockDeviceMappingProperty
            ): software.amazon.awscdk.services.imagebuilder.CfnImageRecipe.InstanceBlockDeviceMappingProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface EbsInstanceBlockDeviceSpecificationProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: EbsInstanceBlockDeviceSpecificationProperty
            ): software.amazon.awscdk.services.imagebuilder.CfnImageRecipe.EbsInstanceBlockDeviceSpecificationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
