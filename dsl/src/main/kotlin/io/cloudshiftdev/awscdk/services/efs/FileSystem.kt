...
internal constructor(
     ...
     * @param accessPointOptions
     */
    public open fun addAccessPoint(
        id: String,
        accessPointOptions: AccessPointOptions
    ): AccessPoint =
        unwrap(this)
            .addAccessPoint(id, accessPointOptions.let(AccessPointOptions::unwrap))
            .let(AccessPoint::wrap)
    ...
    public open fun addAccessPoint(
        id: String,
        accessPointOptions: AccessPointOptions.Builder.() -> Unit
    ): AccessPoint = addAccessPoint(id, AccessPointOptions(accessPointOptions))
    ...
    public interface Builder {
         ...
         *
         * Default: - if 'encrypted' is true, the default key for EFS (/aws/elasticfilesystem) is
         * used
         *
        ...
        /**
         * A policy used by EFS lifecycle management to transition files to the Infrequent Access
         * (IA) storage class.
         *
         * Default: - None. EFS will not transition files to the IA storage class.
         *
         * @param lifecyclePolicy A policy used by EFS lifecycle management to transition files to
         ...
         *
         * @param outOfInfrequentAccessPolicy A policy used by EFS lifecycle management to
         *   transition files from Infrequent Access (IA) storage class to primary storage class.
         */
         ...
         *
         * An Amazon EFS file system's performance mode can't be changed after the file system has
         * been created. Updating this property will replace the file system.
         *
         ...
         *
         * This is a required property if the throughput mode is set to PROVISIONED. Must be at
         * least 1MiB/s.
         *
         ...
         *
         * Set false if you want to create a read-only filesystem for use as a replication
         * destination.
         *
         ...
         *
         * @param transitionToArchivePolicy The number of days after files were last accessed in
         *   primary storage (the Standard storage class) at which to move them to Archive storage.
         */
    ...
    private class BuilderImpl(
         ...
         *   transition files from Infrequent Access (IA) storage class to primary storage class.
         */
        override fun outOfInfrequentAccessPolicy(
            outOfInfrequentAccessPolicy: OutOfInfrequentAccessPolicy
        ) {
            cdkBuilder.outOfInfrequentAccessPolicy(
                outOfInfrequentAccessPolicy.let(OutOfInfrequentAccessPolicy::unwrap)
            )
        }
        ...
        override fun provisionedThroughputPerSecond(provisionedThroughputPerSecond: Size) {
            cdkBuilder.provisionedThroughputPerSecond(
                provisionedThroughputPerSecond.let(Size::unwrap)
            )
        }
         ...
         *   overwrite protection or not.
         */
        override fun replicationOverwriteProtection(
            replicationOverwriteProtection: ReplicationOverwriteProtection
        ) {
            cdkBuilder.replicationOverwriteProtection(
                replicationOverwriteProtection.let(ReplicationOverwriteProtection::unwrap)
            )
        }
        ...
        override fun transitionToArchivePolicy(transitionToArchivePolicy: LifecyclePolicy) {
            cdkBuilder.transitionToArchivePolicy(
                transitionToArchivePolicy.let(LifecyclePolicy::unwrap)
            )
        }
    ...
    public companion object {
        public fun fromFileSystemAttributes(
            ...
            software.amazon.awscdk.services.efs.FileSystem.fromFileSystemAttributes(
