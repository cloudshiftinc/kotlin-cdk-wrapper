...
internal constructor(
    ...
    public open fun studioEncryptionConfiguration(`value`: StudioEncryptionConfigurationProperty) {
        unwrap(this)
            .setStudioEncryptionConfiguration(
                `value`.let(StudioEncryptionConfigurationProperty::unwrap)
            )
    }
    ...
    public open fun studioEncryptionConfiguration(
        `value`: StudioEncryptionConfigurationProperty.Builder.() -> Unit
    ...
    public interface Builder {
         ...
         *
         * @param studioEncryptionConfiguration Configuration of the encryption method that is used
         *   for the studio.
         */
        ...
        public fun studioEncryptionConfiguration(
            studioEncryptionConfiguration: StudioEncryptionConfigurationProperty.Builder.() -> Unit
        )
         ...
         *
         * @param userRoleArn The IAM role that studio users assume when logging in to the Nimble
         *   Studio portal.
         */
    ...
    private class BuilderImpl(
        ...
        override fun studioEncryptionConfiguration(studioEncryptionConfiguration: IResolvable) {
            cdkBuilder.studioEncryptionConfiguration(
                studioEncryptionConfiguration.let(IResolvable::unwrap)
            )
        }
         ...
         *   for the studio.
         */
        override fun studioEncryptionConfiguration(
            studioEncryptionConfiguration: StudioEncryptionConfigurationProperty
        ) {
            cdkBuilder.studioEncryptionConfiguration(
                studioEncryptionConfiguration.let(StudioEncryptionConfigurationProperty::unwrap)
            )
        }
        ...
        override fun studioEncryptionConfiguration(
            ...
            studioEncryptionConfiguration(
                StudioEncryptionConfigurationProperty(studioEncryptionConfiguration)
            )
        ...
        public fun build(): software.amazon.awscdk.services.nimblestudio.CfnStudio =
            cdkBuilder.build()
    }
    ...
    public companion object {
        ...
        ): CfnStudio = CfnStudio(cdkObject)

        internal fun unwrap(
            wrapped: CfnStudio
        ): software.amazon.awscdk.services.nimblestudio.CfnStudio = wrapped.cdkObject
    }
    ...
    public interface StudioEncryptionConfigurationProperty {
        ...
        private class BuilderImpl : Builder {
            private val cdkBuilder:
                ...
                software.amazon.awscdk.services.nimblestudio.CfnStudio
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: StudioEncryptionConfigurationProperty
            ): software.amazon.awscdk.services.nimblestudio.CfnStudio.StudioEncryptionConfigurationProperty =
