...
internal constructor(
    ...
    /** An array of key-value pairs to apply to this resource. */
    public open fun botAliasTags(vararg __idx_ac66f0: Any): Unit =
        botAliasTags(__idx_ac66f0.toList())
    ...
    public open fun conversationLogSettings(`value`: ConversationLogSettingsProperty) {
        unwrap(this)
            .setConversationLogSettings(`value`.let(ConversationLogSettingsProperty::unwrap))
    }

    /** Specifies whether Amazon Lex logs text and audio for conversations with the bot. */
    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("406eeb95044ee1072891c8cfe76b189e134878c2dc5587152587b42b870cde0a")
    public open fun conversationLogSettings(
        `value`: ConversationLogSettingsProperty.Builder.() -> Unit
    ): Unit = conversationLogSettings(ConversationLogSettingsProperty(`value`))
    ...
    public interface Builder {
         ...
         * input, and associated metadata in Amazon CloudWatch logs. Audio logs store input in
         * Amazon S3 .
         *
         ...
         *
         * @param sentimentAnalysisSettings Determines whether Amazon Lex will use Amazon Comprehend
         *   to detect the sentiment of user utterances.
         */
    ...
    private class BuilderImpl(
         ...
         * @param botAliasTags An array of key-value pairs to apply to this resource.
         */
        override fun botAliasTags(vararg botAliasTags: Any): Unit =
            botAliasTags(botAliasTags.toList())
    ...
    public interface AudioLogSettingProperty {
        ...
        public interface Builder {
            /**
             * @param destination The location of audio log files collected when conversation
        ...
        internal constructor(
            ...
            /**
             * The location of audio log files collected when conversation logging is enabled for a
             * bot.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-lex-botalias-audiologsetting.html#cfn-lex-botalias-audiologsetting-destination)
             */
