...
public interface Dimension {
    ...
    private class BuilderImpl : Builder {
        ...
        public fun build(): software.amazon.awscdk.services.cloudwatch.Dimension =
            cdkBuilder.build()
    }
    ...
    public companion object {
        ...
        ): Dimension = Wrapper(cdkObject)

        internal fun unwrap(
            wrapped: Dimension
        ): software.amazon.awscdk.services.cloudwatch.Dimension = (wrapped as Wrapper).cdkObject
    }
}
