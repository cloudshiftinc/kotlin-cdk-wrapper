...
internal constructor(
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnDistributionConfiguration
        ): software.amazon.awscdk.services.imagebuilder.CfnDistributionConfiguration =
            wrapped.cdkObject
    }
    ...
    public interface FastLaunchConfigurationProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param enabled A Boolean that represents the current state of faster launching for
             *   the Windows AMI. Set to `true` to start using Windows faster launching, or `false`
             *   to stop using it.
             */
            ...
            /**
             * @param launchTemplate The launch template that the fast-launch enabled Windows AMI
            ...
            public fun launchTemplate(
                launchTemplate: FastLaunchLaunchTemplateSpecificationProperty.Builder.() -> Unit
            )

            /**
             * @param maxParallelLaunches The maximum number of parallel instances that are launched
             *   for creating resources.
             */
            public fun maxParallelLaunches(maxParallelLaunches: Number)

            /**
             * @param snapshotConfiguration Configuration settings for managing the number of
             *   snapshots that are created from pre-provisioned instances for the Windows AMI when
            ...
            public fun snapshotConfiguration(
                snapshotConfiguration: FastLaunchSnapshotConfigurationProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun launchTemplate(
                ...
                cdkBuilder.launchTemplate(
                    launchTemplate.let(FastLaunchLaunchTemplateSpecificationProperty::unwrap)
                )
            }
             ...
             *   faster launching is enabled.
             */
            override fun snapshotConfiguration(
                snapshotConfiguration: FastLaunchSnapshotConfigurationProperty
            ) {
                cdkBuilder.snapshotConfiguration(
            ...
            override fun snapshotConfiguration(
                ...
                snapshotConfiguration(
                    FastLaunchSnapshotConfigurationProperty(snapshotConfiguration)
                )
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: FastLaunchConfigurationProperty
            ): software.amazon.awscdk.services.imagebuilder.CfnDistributionConfiguration.FastLaunchConfigurationProperty =
    ...
    public interface DistributionProperty {
         ...
         */
        public fun amiDistributionConfiguration(): Any? =
         ...
         */
        public fun launchTemplateConfigurations(): Any? =
         ...
         */
        public fun licenseConfigurationArns(): List<String> =
        ...
        public interface Builder {
            /**
             * @param amiDistributionConfiguration The specific AMI settings, such as launch
             *   permissions and AMI tags. For details, see example schema below.
             */
            public fun amiDistributionConfiguration(amiDistributionConfiguration: Any)

            /**
             * @param containerDistributionConfiguration Container distribution settings for
             *   encryption, licensing, and sharing in a specific Region. For details, see example
             *   schema below.
             */
            public fun containerDistributionConfiguration(containerDistributionConfiguration: Any)

            /**
             * @param fastLaunchConfigurations The Windows faster-launching configurations to use
             *   for AMI distribution.
             */
            ...
            /**
             * @param launchTemplateConfigurations A group of launchTemplateConfiguration settings
            ...
            /**
             * @param licenseConfigurationArns The License Manager Configuration to associate with
             *   the AMI in the specified Region. For more information, see the
             *   [LicenseConfiguration API](https://docs.aws.amazon.com/license-manager/latest/APIReference/API_LicenseConfiguration.html)
             *   .
             */
            ...
            /**
             * @param region The target Region for the Distribution Configuration. For example,
             *   `eu-west-1` .
             */
        ...
        private class BuilderImpl : Builder {
             ...
             *   schema below.
             */
            override fun containerDistributionConfiguration(
            ...
            override fun fastLaunchConfigurations(fastLaunchConfigurations: IResolvable) {
                cdkBuilder.fastLaunchConfigurations(
                    fastLaunchConfigurations.let(IResolvable::unwrap)
                )
            }
            ...
            override fun launchTemplateConfigurations(launchTemplateConfigurations: IResolvable) {
                cdkBuilder.launchTemplateConfigurations(
                    launchTemplateConfigurations.let(IResolvable::unwrap)
                )
            }
             ...
             *   that apply to image distribution for specified accounts.
             */
            override fun launchTemplateConfigurations(
                vararg launchTemplateConfigurations: Any
            ): Unit = launchTemplateConfigurations(launchTemplateConfigurations.toList())
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-imagebuilder-distributionconfiguration-distribution.html#cfn-imagebuilder-distributionconfiguration-distribution-fastlaunchconfigurations)
             */
            override fun fastLaunchConfigurations(): Any? =
    ...
    public interface LaunchPermissionConfigurationProperty {
         ...
         */
        public fun organizationArns(): List<String> =
            unwrap(this).getOrganizationArns() ?: emptyList()

        /**
         * The ARN for an AWS Organizations organizational unit (OU) that you want to share your AMI
         * with.
         *
         * For more information about key concepts for AWS Organizations , see
         ...
         */
        public fun organizationalUnitArns(): List<String> =
        ...
        public interface Builder {
            /**
             * @param organizationArns The ARN for an AWS Organization that you want to share your
             *   AMI with. For more information, see
             *   [What is AWS Organizations ?](https://docs.aws.amazon.com/organizations/latest/userguide/orgs_introduction.html)
             *   .
             */
            ...
            /**
             * @param organizationalUnitArns The ARN for an AWS Organizations organizational unit
             *   (OU) that you want to share your AMI with. For more information about key concepts
             *   for AWS Organizations , see
             *   [AWS Organizations terminology and concepts](https://docs.aws.amazon.com/organizations/latest/userguide/orgs_getting-started_concepts.html)
             *   .
             */
        ...
        private class BuilderImpl : Builder {
            ...
            /** @param userGroups The name of the group. */
            override fun userGroups(vararg userGroups: String): Unit =
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-imagebuilder-distributionconfiguration-launchpermissionconfiguration.html#cfn-imagebuilder-distributionconfiguration-launchpermissionconfiguration-organizationarns)
             */
            override fun organizationArns(): List<String> =
                unwrap(this).getOrganizationArns() ?: emptyList()

            /**
             * The ARN for an AWS Organizations organizational unit (OU) that you want to share your
             * AMI with.
             *
             * For more information about key concepts for AWS Organizations , see
             * [AWS Organizations terminology and concepts](https://docs.aws.amazon.com/organizations/latest/userguide/orgs_getting-started_concepts.html)
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-imagebuilder-distributionconfiguration-launchpermissionconfiguration.html#cfn-imagebuilder-distributionconfiguration-launchpermissionconfiguration-organizationalunitarns)
             */
            override fun organizationalUnitArns(): List<String> =
                unwrap(this).getOrganizationalUnitArns() ?: emptyList()
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: LaunchPermissionConfigurationProperty
            ): software.amazon.awscdk.services.imagebuilder.CfnDistributionConfiguration.LaunchPermissionConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ContainerDistributionConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param containerTags Tags that are attached to the container distribution
             *   configuration.
             */
            ...
            public fun targetRepository(
                targetRepository: TargetContainerRepositoryProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun targetRepository(targetRepository: TargetContainerRepositoryProperty) {
                cdkBuilder.targetRepository(
                    targetRepository.let(TargetContainerRepositoryProperty::unwrap)
                )
            }
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-imagebuilder-distributionconfiguration-containerdistributionconfiguration.html#cfn-imagebuilder-distributionconfiguration-containerdistributionconfiguration-containertags)
             */
            override fun containerTags(): List<String> =
                unwrap(this).getContainerTags() ?: emptyList()
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ContainerDistributionConfigurationProperty
            ): software.amazon.awscdk.services.imagebuilder.CfnDistributionConfiguration.ContainerDistributionConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface FastLaunchSnapshotConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param targetResourceCount The number of pre-provisioned snapshots to keep on hand
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: FastLaunchSnapshotConfigurationProperty
            ): software.amazon.awscdk.services.imagebuilder.CfnDistributionConfiguration.FastLaunchSnapshotConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface AmiDistributionConfigurationProperty {
         ...
         */
        public fun targetAccountIds(): List<String> =
            unwrap(this).getTargetAccountIds() ?: emptyList()
        ...
        public interface Builder {
            ...
            /**
             * @param description The description of the AMI distribution configuration. Minimum and
            ...
            /**
             * @param launchPermissionConfiguration Launch permissions can be used to configure
             *   which AWS account s can use the AMI to launch instances.
             */
            ...
            public fun launchPermissionConfiguration(
                launchPermissionConfiguration:
                    LaunchPermissionConfigurationProperty.Builder.() -> Unit
            )
            ...
            /**
             * @param targetAccountIds The ID of an account to which you want to distribute an
             *   image.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            override fun launchPermissionConfiguration(launchPermissionConfiguration: IResolvable) {
                cdkBuilder.launchPermissionConfiguration(
                    launchPermissionConfiguration.let(IResolvable::unwrap)
                )
            }
             ...
             *   which AWS account s can use the AMI to launch instances.
             */
            override fun launchPermissionConfiguration(
                launchPermissionConfiguration: LaunchPermissionConfigurationProperty
            ) {
                cdkBuilder.launchPermissionConfiguration(
                    launchPermissionConfiguration.let(LaunchPermissionConfigurationProperty::unwrap)
                )
            }
            ...
            override fun launchPermissionConfiguration(
                ...
                launchPermissionConfiguration(
                    LaunchPermissionConfigurationProperty(launchPermissionConfiguration)
                )
        ...
        internal constructor(
            ...
            /**
             * Launch permissions can be used to configure which AWS account s can use the AMI to
             * launch instances.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-imagebuilder-distributionconfiguration-amidistributionconfiguration.html#cfn-imagebuilder-distributionconfiguration-amidistributionconfiguration-launchpermissionconfiguration)
             */
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-imagebuilder-distributionconfiguration-amidistributionconfiguration.html#cfn-imagebuilder-distributionconfiguration-amidistributionconfiguration-targetaccountids)
             */
            override fun targetAccountIds(): List<String> =
                unwrap(this).getTargetAccountIds() ?: emptyList()
        }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AmiDistributionConfigurationProperty
            ): software.amazon.awscdk.services.imagebuilder.CfnDistributionConfiguration.AmiDistributionConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface LaunchTemplateConfigurationProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param setDefaultVersion Set the specified Amazon EC2 launch template as the default
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: LaunchTemplateConfigurationProperty
            ): software.amazon.awscdk.services.imagebuilder.CfnDistributionConfiguration.LaunchTemplateConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface FastLaunchLaunchTemplateSpecificationProperty {
        ...
        public interface Builder {
            /**
             * @param launchTemplateId The ID of the launch template to use for faster launching for
             *   a Windows AMI.
             */
            public fun launchTemplateId(launchTemplateId: String)

            /**
             * @param launchTemplateName The name of the launch template to use for faster launching
             *   for a Windows AMI.
             */
            public fun launchTemplateName(launchTemplateName: String)

            /**
             * @param launchTemplateVersion The version of the launch template to use for faster
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: FastLaunchLaunchTemplateSpecificationProperty
            ): software.amazon.awscdk.services.imagebuilder.CfnDistributionConfiguration.FastLaunchLaunchTemplateSpecificationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface TargetContainerRepositoryProperty {
        ...
        public interface Builder {
            /**
             * @param repositoryName The name of the container repository where the output container
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TargetContainerRepositoryProperty
            ): software.amazon.awscdk.services.imagebuilder.CfnDistributionConfiguration.TargetContainerRepositoryProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
