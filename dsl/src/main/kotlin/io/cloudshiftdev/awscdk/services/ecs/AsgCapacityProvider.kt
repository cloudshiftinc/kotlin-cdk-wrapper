...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.ecs.AsgCapacityProvider,
    ...
    public interface Builder {
         ...
         * used. If the stack name starts with `aws`, `ecs`, or `fargate`, a unique resource name is
         * generated that starts with `cp-`.
         *
         ...
         * Default: true
         *
         * @param enableManagedDraining Managed instance draining facilitates graceful termination
         *   of Amazon ECS instances.
         */
        public fun enableManagedDraining(enableManagedDraining: Boolean)

        /**
         * When enabled the scale-in and scale-out actions of the cluster's Auto Scaling Group will
         * be managed for you.
         *
         * This means your cluster will automatically scale instances based on the load your tasks
         * put on the cluster. For more information, see
         ...
         * Default: true
         *
         * @param enableManagedScaling When enabled the scale-in and scale-out actions of the
         *   cluster's Auto Scaling Group will be managed for you.
         */
         ...
         *
         * Scale-in protection will be automatically enabled on instances. When all non-daemon tasks
         * are stopped on an instance, ECS initiates the scale-in process and turns off scale-in
         * protection for the instance. The Auto Scaling Group can then terminate the instance. For
         ...
         *   Instances running Amazon ECS Services.
         */
    ...
    private class BuilderImpl(
         ...
         *   terminate EC2 instances that no longer have running non-daemon tasks.
         */
        override fun enableManagedTerminationProtection(
        ...
        public fun build(): software.amazon.awscdk.services.ecs.AsgCapacityProvider =
            cdkBuilder.build()
    }
