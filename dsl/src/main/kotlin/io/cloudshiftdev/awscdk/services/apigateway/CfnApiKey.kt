...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param generateDistinctId Specifies whether ( `true` ) or not ( `false` ) the key
         ...
         * that ID for the API key name. For more information, see
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.apigateway.CfnApiKey =
            cdkBuilder.build()
    }
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnApiKey
        ): software.amazon.awscdk.services.apigateway.CfnApiKey = wrapped.cdkObject
    }
