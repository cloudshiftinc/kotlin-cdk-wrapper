...
public interface ContainerDependency {
    ...
    public interface Builder {
        /**
         * @param condition The state the container needs to be in to satisfy the dependency and
         *   proceed with startup. Valid values are ContainerDependencyCondition.START,
    ...
    private class BuilderImpl : Builder {
        ...
        public fun build(): software.amazon.awscdk.services.ecs.ContainerDependency =
            cdkBuilder.build()
    }
    ...
    internal constructor(
        ...
        /**
         * The state the container needs to be in to satisfy the dependency and proceed with
         * startup.
         *
         * Valid values are ContainerDependencyCondition.START,
         * ContainerDependencyCondition.COMPLETE, ContainerDependencyCondition.SUCCESS and
         * ContainerDependencyCondition.HEALTHY.
         *
         * Default: ContainerDependencyCondition.HEALTHY
