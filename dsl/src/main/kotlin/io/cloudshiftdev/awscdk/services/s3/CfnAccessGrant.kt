...
internal constructor(
    ...
    public open fun accessGrantsLocationConfiguration(
        `value`: AccessGrantsLocationConfigurationProperty
    ) {
        unwrap(this)
            .setAccessGrantsLocationConfiguration(
                `value`.let(AccessGrantsLocationConfigurationProperty::unwrap)
            )
    }
    ...
    public open fun accessGrantsLocationConfiguration(
        `value`: AccessGrantsLocationConfigurationProperty.Builder.() -> Unit
    ...
    public interface Builder {
         ...
         * contains the `S3SubPrefix` field. The grant scope is the result of appending the
        ...
        public fun accessGrantsLocationConfiguration(
            accessGrantsLocationConfiguration:
                AccessGrantsLocationConfigurationProperty.Builder.() -> Unit
        )

        /**
         * The ID of the registered location to which you are granting access.
         *
         * S3 Access Grants assigns this ID when you register the location. S3 Access Grants assigns
         * the ID `default` to the default location `s3://` and assigns an auto-generated ID to
         ...
         * The user, group, or role to which you are granting access.
         *
         * You can grant access to an IAM user or role. If you have added your corporate directory
         * to AWS IAM Identity Center and associated your Identity Center instance with your S3
         ...
         *
         * @param permission The type of access that you are granting to your S3 data, which can be
         *   set to one of the following values: - `READ` – Grant read-only access to the S3 data.
         */
         ...
         * The type of `S3SubPrefix` .
         *
         * The only possible value is `Object` . Pass this value if the access grant scope is an
         * object. Do not pass this value if the access grant scope is a bucket or a bucket and a
         * prefix.
         *
    ...
    private class BuilderImpl(
        ...
        override fun accessGrantsLocationConfiguration(
            ...
            cdkBuilder.accessGrantsLocationConfiguration(
                accessGrantsLocationConfiguration.let(IResolvable::unwrap)
            )
        }
        ...
        override fun accessGrantsLocationConfiguration(
            ...
            cdkBuilder.accessGrantsLocationConfiguration(
                accessGrantsLocationConfiguration.let(
                    AccessGrantsLocationConfigurationProperty::unwrap
                )
            )
        }
        ...
        override fun accessGrantsLocationConfiguration(
            ...
            accessGrantsLocationConfiguration(
                AccessGrantsLocationConfigurationProperty(accessGrantsLocationConfiguration)
            )
    ...
    public companion object {
        ...
        ): CfnAccessGrant = CfnAccessGrant(cdkObject)

        internal fun unwrap(
            wrapped: CfnAccessGrant
        ): software.amazon.awscdk.services.s3.CfnAccessGrant = wrapped.cdkObject
    }
    ...
    public interface AccessGrantsLocationConfigurationProperty {
         ...
         * field is required if the location scope is the default location `s3://` because you
         * cannot create a grant for all of your S3 data in the Region and must narrow the scope.
         * For example, if the location scope is the default location `s3://` , the `S3SubPrefx` can
         * be a `&lt;bucket-name&gt;/ *` , so the full grant scope path would be
         * `s3://&lt;bucket-name&gt;/ *` . Or the `S3SubPrefx` can be
         * `&lt;bucket-name&gt;/&lt;prefix-name&gt;*` , so the full grant scope path would be
         * `s3://&lt;bucket-name&gt;/&lt;prefix-name&gt;*` .
         *
         * If the `S3SubPrefix` includes a prefix, append the wildcard character `*` after the
         * prefix to indicate that you want to include all object key names in the bucket that start
         * with that prefix.
         *
        ...
        public interface Builder {
            /**
             * @param s3SubPrefix The `S3SubPrefix` is appended to the location scope creating the
             ...
             *   location `s3://` because you cannot create a grant for all of your S3 data in the
             *   Region and must narrow the scope. For example, if the location scope is the default
             *   location `s3://` , the `S3SubPrefx` can be a `&lt;bucket-name&gt;/ *` , so the full
             *   grant scope path would be `s3://&lt;bucket-name&gt;/ *` . Or the `S3SubPrefx` can
             *   be `&lt;bucket-name&gt;/&lt;prefix-name&gt;*` , so the full grant scope path would
             *   be `s3://&lt;bucket-name&gt;/&lt;prefix-name&gt;*` .
             *
             * If the `S3SubPrefix` includes a prefix, append the wildcard character `*` after the
             * prefix to indicate that you want to include all object key names in the bucket that
        ...
        internal constructor(
             ...
             * This field is required if the location scope is the default location `s3://` because
             * you cannot create a grant for all of your S3 data in the Region and must narrow the
             * scope. For example, if the location scope is the default location `s3://` , the
             * `S3SubPrefx` can be a `&lt;bucket-name&gt;/ *` , so the full grant scope path would
             * be `s3://&lt;bucket-name&gt;/ *` . Or the `S3SubPrefx` can be
             * `&lt;bucket-name&gt;/&lt;prefix-name&gt;*` , so the full grant scope path would be
             * `s3://&lt;bucket-name&gt;/&lt;prefix-name&gt;*` .
             *
             * If the `S3SubPrefix` includes a prefix, append the wildcard character `*` after the
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AccessGrantsLocationConfigurationProperty
            ): software.amazon.awscdk.services.s3.CfnAccessGrant.AccessGrantsLocationConfigurationProperty =
    ...
    public interface GranteeProperty {
         ...
         *
         * If the grantee type is `IAM` , the identifier is the IAM Amazon Resource Name (ARN) of
         * the user or role. If the grantee type is a directory user or group, the identifier is
         * 128-bit universally unique identifier (UUID) in the format
        ...
        public interface Builder {
            /**
             * @param granteeIdentifier The unique identifier of the `Grantee` . If the grantee type
             *   is `IAM` , the identifier is the IAM Amazon Resource Name (ARN) of the user or
             *   role. If the grantee type is a directory user or group, the identifier is 128-bit
            ...
            /**
             * @param granteeType The type of the grantee to which access has been granted. It can
             *   be one of the following values:.
             * * `IAM` - An IAM user or role.
             * * `DIRECTORY_USER` - Your corporate directory user. You can use this option if you
             *   have added your corporate identity directory to IAM Identity Center and associated
             *   the IAM Identity Center instance with your S3 Access Grants instance.
             * * `DIRECTORY_GROUP` - Your corporate directory group. You can use this option if you
             *   have added your corporate identity directory to IAM Identity Center and associated
             *   the IAM Identity Center instance with your S3 Access Grants instance.
             */
        ...
        internal constructor(
            internal val cdkObject:
                software.amazon.awscdk.services.s3.CfnAccessGrant.GranteeProperty,
        ) : GranteeProperty {
            /**
             * The unique identifier of the `Grantee` .
             *
             * If the grantee type is `IAM` , the identifier is the IAM Amazon Resource Name (ARN)
             * of the user or role. If the grantee type is a directory user or group, the identifier
