...
internal constructor(
    ...
    public interface Builder {
         ...
         * Default: true
         *
         * @param optimizedSharedDelivery Whether optimized shared delivery is enabled for your
         *   account.
         */
    ...
    public companion object {
        public fun fromVdmAttributesName(
            ...
            software.amazon.awscdk.services.ses.VdmAttributes.fromVdmAttributesName(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    vdmAttributesName
                )
                .let(IVdmAttributes::wrap)
        ...
        ): VdmAttributes = VdmAttributes(cdkObject)

        internal fun unwrap(
            wrapped: VdmAttributes
        ): software.amazon.awscdk.services.ses.VdmAttributes = wrapped.cdkObject
    }
}
