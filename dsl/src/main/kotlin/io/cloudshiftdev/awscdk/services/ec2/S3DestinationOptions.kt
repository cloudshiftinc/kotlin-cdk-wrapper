...
public interface S3DestinationOptions {
    ...
    public interface Builder {
        ...
        /**
         * @param hiveCompatiblePartitions Use Hive-compatible prefixes for flow logs stored in
         *   Amazon S3.
         */
    ...
    internal constructor(
         ...
         * Default: false
         */
        override fun hiveCompatiblePartitions(): Boolean? =
    ...
    public companion object {
        ...
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.ec2.S3DestinationOptions
        ): S3DestinationOptions = Wrapper(cdkObject)

        internal fun unwrap(
            wrapped: S3DestinationOptions
