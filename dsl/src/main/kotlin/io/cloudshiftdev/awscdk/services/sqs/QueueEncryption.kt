...
public enum class QueueEncryption(
    ...
    public companion object {
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.sqs.QueueEncryption
        ): QueueEncryption =
            when (cdkObject) {
                software.amazon.awscdk.services.sqs.QueueEncryption.UNENCRYPTED ->
                    QueueEncryption.UNENCRYPTED
                software.amazon.awscdk.services.sqs.QueueEncryption.KMS_MANAGED ->
                    QueueEncryption.KMS_MANAGED
                software.amazon.awscdk.services.sqs.QueueEncryption.KMS -> QueueEncryption.KMS
                software.amazon.awscdk.services.sqs.QueueEncryption.SQS_MANAGED ->
                    QueueEncryption.SQS_MANAGED
            }

        internal fun unwrap(
            wrapped: QueueEncryption
