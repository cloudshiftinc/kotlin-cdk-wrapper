...
internal constructor(
    ...
    public open fun datastorePartitions(
        `value`: DatastorePartitionsProperty.Builder.() -> Unit
    ): Unit = datastorePartitions(DatastorePartitionsProperty(`value`))
    ...
    public open fun fileFormatConfiguration(`value`: FileFormatConfigurationProperty) {
        unwrap(this)
            .setFileFormatConfiguration(`value`.let(FileFormatConfigurationProperty::unwrap))
    }
    ...
    public open fun fileFormatConfiguration(
        `value`: FileFormatConfigurationProperty.Builder.() -> Unit
    ): Unit = fileFormatConfiguration(FileFormatConfigurationProperty(`value`))
    ...
    public interface Builder {
        ...
        public fun datastorePartitions(
            datastorePartitions: DatastorePartitionsProperty.Builder.() -> Unit
        )
         ...
         * support JSON and [Parquet](https://docs.aws.amazon.com/https://parquet.apache.org/) .
         *
         ...
         *
         * @param fileFormatConfiguration Contains the configuration information of file formats.
         *   AWS IoT Analytics data stores support JSON and
         *   [Parquet](https://docs.aws.amazon.com/https://parquet.apache.org/) .
         */
        ...
        public fun fileFormatConfiguration(
            fileFormatConfiguration: FileFormatConfigurationProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
        ...
        override fun datastorePartitions(datastorePartitions: DatastorePartitionsProperty) {
            cdkBuilder.datastorePartitions(
                datastorePartitions.let(DatastorePartitionsProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("35d75580ada733c689a04ca35419661cb84e009843e7f386a19fcfcc775f4ea4")
        override fun datastorePartitions(
            datastorePartitions: DatastorePartitionsProperty.Builder.() -> Unit
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("d74173f897723d0dbb0c52095b8dd1bc4397a08f4a5283a8da5be0e5812552e6")
        override fun datastoreStorage(
            datastoreStorage: DatastoreStorageProperty.Builder.() -> Unit
         ...
         *   [Parquet](https://docs.aws.amazon.com/https://parquet.apache.org/) .
         */
        override fun fileFormatConfiguration(
            fileFormatConfiguration: FileFormatConfigurationProperty
        ) {
            cdkBuilder.fileFormatConfiguration(
                fileFormatConfiguration.let(FileFormatConfigurationProperty::unwrap)
            )
        }
    ...
    public interface DatastorePartitionsProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DatastorePartitionsProperty
            ): software.amazon.awscdk.services.iotanalytics.CfnDatastore.DatastorePartitionsProperty =
    ...
    public interface ColumnProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param type The type of data. For more information about the supported data types,
             *   see
             *   [Common data types](https://docs.aws.amazon.com/glue/latest/dg/aws-glue-api-common.html)
             *   in the *AWS Glue Developer Guide* .
             */
    ...
    public interface IotSiteWiseMultiLayerStorageProperty {
        ...
        public interface Builder {
            /**
             * @param customerManagedS3Storage Stores data used by AWS IoT SiteWise in an Amazon S3
            ...
            public fun customerManagedS3Storage(
                customerManagedS3Storage: CustomerManagedS3StorageProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun customerManagedS3Storage(customerManagedS3Storage: IResolvable) {
                cdkBuilder.customerManagedS3Storage(
                    customerManagedS3Storage.let(IResolvable::unwrap)
                )
            }
             ...
             *   bucket that you manage.
             */
            override fun customerManagedS3Storage(
                customerManagedS3Storage: CustomerManagedS3StorageProperty
            ) {
                cdkBuilder.customerManagedS3Storage(
                    customerManagedS3Storage.let(CustomerManagedS3StorageProperty::unwrap)
                )
            }
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-iotanalytics-datastore-iotsitewisemultilayerstorage.html#cfn-iotanalytics-datastore-iotsitewisemultilayerstorage-customermanageds3storage)
             */
            override fun customerManagedS3Storage(): Any? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: IotSiteWiseMultiLayerStorageProperty
            ): software.amazon.awscdk.services.iotanalytics.CfnDatastore.IotSiteWiseMultiLayerStorageProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CustomerManagedS3Property {
        ...
        public interface Builder {
             ...
             *   objects. Each object in an Amazon S3 bucket has a key that is its unique identifier
             *   in the bucket. Each object in a bucket has exactly one key. The prefix must end
        ...
        internal constructor(
             ...
             * (Optional) The prefix used to create the keys of the data store data objects.
             *
             * Each object in an Amazon S3 bucket has a key that is its unique identifier in the
    ...
    public interface ParquetConfigurationProperty {
        ...
        public interface Builder {
            ...
            public fun schemaDefinition(
                schemaDefinition: SchemaDefinitionProperty.Builder.() -> Unit
            )
        }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ParquetConfigurationProperty
            ): software.amazon.awscdk.services.iotanalytics.CfnDatastore.ParquetConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DatastorePartitionProperty {
        ...
        public interface Builder {
            ...
            public fun timestampPartition(
                timestampPartition: TimestampPartitionProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun timestampPartition(timestampPartition: TimestampPartitionProperty) {
                cdkBuilder.timestampPartition(
                    timestampPartition.let(TimestampPartitionProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("3037a51e44c948d3294c744b1a9422a51f76756a00534f969ea9fa88f52d1b4d")
            override fun timestampPartition(
                timestampPartition: TimestampPartitionProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DatastorePartitionProperty
            ): software.amazon.awscdk.services.iotanalytics.CfnDatastore.DatastorePartitionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SchemaDefinitionProperty {
        ...
        public interface Builder {
            /**
             * @param columns Specifies one or more columns that store your data. Each schema can
             *   have up to 100 columns. Each column can have up to 100 nested types.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SchemaDefinitionProperty
            ): software.amazon.awscdk.services.iotanalytics.CfnDatastore.SchemaDefinitionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface TimestampPartitionProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TimestampPartitionProperty
            ): software.amazon.awscdk.services.iotanalytics.CfnDatastore.TimestampPartitionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DatastoreStorageProperty {
         ...
         */
        public fun iotSiteWiseMultiLayerStorage(): Any? =
        ...
        public interface Builder {
            /**
             * @param customerManagedS3 Use this to store data store data in an S3 bucket that you
             *   manage. The choice of service-managed or customer-managed S3 storage cannot be
            ...
            /**
             * @param iotSiteWiseMultiLayerStorage Use this to store data used by AWS IoT SiteWise
             *   in an Amazon S3 bucket that you manage. You can't change the choice of Amazon S3
             ...
             *   storage after your data store is created.
             */
            public fun iotSiteWiseMultiLayerStorage(
            ...
            public fun iotSiteWiseMultiLayerStorage(
                iotSiteWiseMultiLayerStorage:
                    IotSiteWiseMultiLayerStorageProperty.Builder.() -> Unit
            )

            /**
             * @param serviceManagedS3 Use this to store data store data in an S3 bucket managed by
             *   the AWS IoT Analytics service. The choice of service-managed or customer-managed S3
        ...
        private class BuilderImpl : Builder {
            ...
            override fun iotSiteWiseMultiLayerStorage(iotSiteWiseMultiLayerStorage: IResolvable) {
                cdkBuilder.iotSiteWiseMultiLayerStorage(
                    iotSiteWiseMultiLayerStorage.let(IResolvable::unwrap)
                )
            }
             ...
             *   storage after your data store is created.
             */
            override fun iotSiteWiseMultiLayerStorage(
                iotSiteWiseMultiLayerStorage: IotSiteWiseMultiLayerStorageProperty
            ) {
                cdkBuilder.iotSiteWiseMultiLayerStorage(
                    iotSiteWiseMultiLayerStorage.let(IotSiteWiseMultiLayerStorageProperty::unwrap)
                )
            }
            ...
            override fun iotSiteWiseMultiLayerStorage(
                ...
                iotSiteWiseMultiLayerStorage(
                    IotSiteWiseMultiLayerStorageProperty(iotSiteWiseMultiLayerStorage)
                )
        ...
        internal constructor(
            ...
            /**
             * Use this to store data used by AWS IoT SiteWise in an Amazon S3 bucket that you
             * manage.
             *
             * You can't change the choice of Amazon S3 storage after your data store is created.
             *
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DatastoreStorageProperty
            ): software.amazon.awscdk.services.iotanalytics.CfnDatastore.DatastoreStorageProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface FileFormatConfigurationProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param parquetConfiguration Contains the configuration information of the Parquet
             *   format.
             */
            ...
            public fun parquetConfiguration(
                parquetConfiguration: ParquetConfigurationProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun parquetConfiguration(parquetConfiguration: ParquetConfigurationProperty) {
                cdkBuilder.parquetConfiguration(
                    parquetConfiguration.let(ParquetConfigurationProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("ebc6d886e893ece820e20999d82437c32b2c12dff2ff41a2321a5f17eb1ef449")
            override fun parquetConfiguration(
                parquetConfiguration: ParquetConfigurationProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: FileFormatConfigurationProperty
            ): software.amazon.awscdk.services.iotanalytics.CfnDatastore.FileFormatConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CustomerManagedS3StorageProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CustomerManagedS3StorageProperty
            ): software.amazon.awscdk.services.iotanalytics.CfnDatastore.CustomerManagedS3StorageProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
