...
internal constructor(
    ...
    public interface Builder {
         ...
         * [Amazon S3 Storage Classes](https://docs.aws.amazon.com/s3/storage-classes/) . Some
         * storage classes have behaviors that can affect your S3 storage costs. For detailed
         * information, see
         ...
         *
         * @param s3StorageClass The Amazon S3 storage class that you want to store your files in
         *   when this location is used as a task destination.
         */
         ...
         *
         * @param subdirectory Specifies a prefix in the S3 bucket that DataSync reads from or
         *   writes to (depending on whether the bucket is a source or destination location).
         */
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.datasync.CfnLocationS3 =
            cdkBuilder.build()
    }
    ...
    public interface S3ConfigProperty {
        ...
        public interface Builder {
            /**
             * @param bucketAccessRoleArn Specifies the ARN of the IAM role that DataSync uses to
