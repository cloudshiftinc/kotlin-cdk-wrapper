...
internal constructor(
     ...
     *
     * If multiple calls are made to add a condition with the same operator and field, only the last
    ...
    /**
     * Explicitly allow all actions except the specified list of actions into the "NotAction"
    ...
    /**
     * Specify resources that this policy statement applies into the "Resource" section of this
     * policy statement.
     *
    ...
    public open fun addServicePrincipal(
        service: String,
        opts: ServicePrincipalOpts.Builder.() -> Unit
    ): Unit = addServicePrincipal(service, ServicePrincipalOpts(opts))
     ...
     *
     * Libraries that lazily generate statement bodies can override this method to fill the actual
     * PolicyStatement fields. Be aware that this method may be called multiple times.
     */
    ...
    public interface Builder {
         ...
         * Default: - no sid
         *
         * @param sid The Sid (statement ID) is an optional identifier that you provide for the
         *   policy statement.
         */
    ...
    private class BuilderImpl : Builder {
         ...
         * @param principals List of principals to add to the statement.
         */
        override fun principals(vararg principals: IPrincipal): Unit =
    ...
    public companion object {
        public fun fromJson(obj: Any): PolicyStatement =
            software.amazon.awscdk.services.iam.PolicyStatement.fromJson(obj)
                .let(PolicyStatement::wrap)
