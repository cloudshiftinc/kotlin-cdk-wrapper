...
internal constructor(
    ...
    public open fun resourceLifecycleConfig(`value`: ApplicationResourceLifecycleConfigProperty) {
        unwrap(this)
            .setResourceLifecycleConfig(
                `value`.let(ApplicationResourceLifecycleConfigProperty::unwrap)
            )
    }
    ...
    public open fun resourceLifecycleConfig(
        `value`: ApplicationResourceLifecycleConfigProperty.Builder.() -> Unit
    ...
    public interface Builder {
         ...
         *
         * @param resourceLifecycleConfig Specifies an application resource lifecycle configuration
        ...
        public fun resourceLifecycleConfig(
            resourceLifecycleConfig: ApplicationResourceLifecycleConfigProperty.Builder.() -> Unit
        )
    }
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.elasticbeanstalk.CfnApplication.Builder.create(
                scope,
                id
            )
         ...
         *   to prevent your application from accumulating too many versions.
         */
        override fun resourceLifecycleConfig(
            resourceLifecycleConfig: ApplicationResourceLifecycleConfigProperty
        ) {
            cdkBuilder.resourceLifecycleConfig(
        ...
        override fun resourceLifecycleConfig(
            ...
            resourceLifecycleConfig(
                ApplicationResourceLifecycleConfigProperty(resourceLifecycleConfig)
            )
    ...
    public interface MaxCountRuleProperty {
        ...
        public interface Builder {
            /**
             * @param deleteSourceFromS3 Set to `true` to delete a version's source bundle from
    ...
    public interface ApplicationResourceLifecycleConfigProperty {
         ...
         * `ResourceLifecycleConfig` for the application. After you provide it once, Elastic
         * Beanstalk persists the Service Role with the application, and you don't need to specify
         * it again. You can, however, specify it in subsequent updates to change the Service Role
         * to another value.
         *
        ...
        public interface Builder {
            /**
             * @param serviceRole The ARN of an IAM service role that Elastic Beanstalk has
             *   permission to assume. The `ServiceRole` property is required the first time that
             *   you provide a `ResourceLifecycleConfig` for the application. After you provide it
             *   once, Elastic Beanstalk persists the Service Role with the application, and you
             *   don't need to specify it again. You can, however, specify it in subsequent updates
             *   to change the Service Role to another value.
             */
            ...
            public fun versionLifecycleConfig(
                versionLifecycleConfig: ApplicationVersionLifecycleConfigProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
             ...
             * @param versionLifecycleConfig Defines lifecycle settings for application versions.
             */
            override fun versionLifecycleConfig(
                versionLifecycleConfig: ApplicationVersionLifecycleConfigProperty
            ) {
                cdkBuilder.versionLifecycleConfig(
                    versionLifecycleConfig.let(ApplicationVersionLifecycleConfigProperty::unwrap)
                )
            }
            ...
            override fun versionLifecycleConfig(
                ...
                versionLifecycleConfig(
                    ApplicationVersionLifecycleConfigProperty(versionLifecycleConfig)
                )
        ...
        internal constructor(
             ...
             * The `ServiceRole` property is required the first time that you provide a
             * `ResourceLifecycleConfig` for the application. After you provide it once, Elastic
             * Beanstalk persists the Service Role with the application, and you don't need to
             * specify it again. You can, however, specify it in subsequent updates to change the
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ApplicationResourceLifecycleConfigProperty
            ): software.amazon.awscdk.services.elasticbeanstalk.CfnApplication.ApplicationResourceLifecycleConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ApplicationVersionLifecycleConfigProperty {
        ...
        public interface Builder {
            /**
             * @param maxAgeRule Specify a max age rule to restrict the length of time that
            ...
            /**
             * @param maxCountRule Specify a max count rule to restrict the number of application
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ApplicationVersionLifecycleConfigProperty
            ): software.amazon.awscdk.services.elasticbeanstalk.CfnApplication.ApplicationVersionLifecycleConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
