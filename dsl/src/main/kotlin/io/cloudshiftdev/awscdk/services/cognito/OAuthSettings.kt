...
public interface OAuthSettings {
     ...
     */
    public fun scopes(): List<OAuthScope> =
        unwrap(this).getScopes()?.map(OAuthScope::wrap) ?: emptyList()
    ...
    private class BuilderImpl : Builder {
        ...
        public fun build(): software.amazon.awscdk.services.cognito.OAuthSettings =
            cdkBuilder.build()
    }
    ...
    internal constructor(
         ...
         * [Documentation](https://docs.aws.amazon.com/cognito/latest/developerguide/cognito-user-pools-app-idp-settings.html)
         */
        override fun scopes(): List<OAuthScope> =
            unwrap(this).getScopes()?.map(OAuthScope::wrap) ?: emptyList()
    }
