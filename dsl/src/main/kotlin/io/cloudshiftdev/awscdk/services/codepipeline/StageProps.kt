...
public interface StageProps {
    ...
    public fun actions(): List<IAction> =
        unwrap(this).getActions()?.map(IAction::wrap) ?: emptyList()
    ...
    public interface Builder {
        /**
         * @param actions The list of Actions to create this Stage with. You can always add more
         *   Actions later by calling `IStage#addAction`.
         */
    ...
    private class BuilderImpl : Builder {
        ...
        public fun build(): software.amazon.awscdk.services.codepipeline.StageProps =
            cdkBuilder.build()
    }
    ...
    internal constructor(
         ...
         * You can always add more Actions later by calling `IStage#addAction`.
         */
        override fun actions(): List<IAction> =
            unwrap(this).getActions()?.map(IAction::wrap) ?: emptyList()
         ...
         * Default: 'Transition disabled'
         */
        override fun transitionDisabledReason(): String? =
