...
public open class CfnResourceDefinition
internal constructor(
    ...
    public open fun initialVersion(
        `value`: ResourceDefinitionVersionProperty.Builder.() -> Unit
    ...
    public interface Builder {
         ...
         *
         * @param initialVersion The resource definition version to include when the resource
        ...
        public fun initialVersion(
            initialVersion: ResourceDefinitionVersionProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.greengrass.CfnResourceDefinition.Builder.create(
                scope,
                id
            )
    ...
    public companion object {
        ...
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.greengrass.CfnResourceDefinition
        ): CfnResourceDefinition = CfnResourceDefinition(cdkObject)

        internal fun unwrap(
            wrapped: CfnResourceDefinition
    ...
    public interface ResourceDefinitionVersionProperty {
        ...
        private class BuilderImpl : Builder {
            private val cdkBuilder:
                ...
                software.amazon.awscdk.services.greengrass.CfnResourceDefinition
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ResourceDefinitionVersionProperty
            ): software.amazon.awscdk.services.greengrass.CfnResourceDefinition.ResourceDefinitionVersionProperty =
    ...
    public interface SecretsManagerSecretResourceDataProperty {
        ...
        /**
         * The Amazon Resource Name (ARN) of the Secrets Manager secret to make available on the
         * core.
         *
        ...
        public interface Builder {
            /**
             * @param additionalStagingLabelsToDownload The staging labels whose values you want to
             *   make available on the core, in addition to `AWSCURRENT` .
             */
            public fun additionalStagingLabelsToDownload(
             ...
             */
            public fun additionalStagingLabelsToDownload(
                vararg additionalStagingLabelsToDownload: String
            )

            /**
             * @param arn The Amazon Resource Name (ARN) of the Secrets Manager secret to make
             *   available on the core. The value of the secret's latest version (represented by the
        ...
        private class BuilderImpl : Builder {
             ...
             *   make available on the core, in addition to `AWSCURRENT` .
             */
            override fun additionalStagingLabelsToDownload(
                additionalStagingLabelsToDownload: List<String>
            ) {
            ...
            override fun additionalStagingLabelsToDownload(
                vararg additionalStagingLabelsToDownload: String
            ): Unit = additionalStagingLabelsToDownload(additionalStagingLabelsToDownload.toList())
        ...
        internal constructor(
            ...
            /**
             * The staging labels whose values you want to make available on the core, in addition
             * to `AWSCURRENT` .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-greengrass-resourcedefinition-secretsmanagersecretresourcedata.html#cfn-greengrass-resourcedefinition-secretsmanagersecretresourcedata-additionalstaginglabelstodownload)
             */
             ...
             * core.
             *
             * The value of the secret's latest version (represented by the `AWSCURRENT` staging
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SecretsManagerSecretResourceDataProperty
            ): software.amazon.awscdk.services.greengrass.CfnResourceDefinition.SecretsManagerSecretResourceDataProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface S3MachineLearningModelResourceDataProperty {
        ...
        public interface Builder {
            ...
            public fun ownerSetting(
                ownerSetting: ResourceDownloadOwnerSettingProperty.Builder.() -> Unit
            )

            /**
             * @param s3Uri The URI of the source model in an Amazon S3 bucket. The model package
        ...
        private class BuilderImpl : Builder {
            ...
            override fun ownerSetting(ownerSetting: ResourceDownloadOwnerSettingProperty) {
                cdkBuilder.ownerSetting(
                    ownerSetting.let(ResourceDownloadOwnerSettingProperty::unwrap)
                )
            }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: S3MachineLearningModelResourceDataProperty
            ): software.amazon.awscdk.services.greengrass.CfnResourceDefinition.S3MachineLearningModelResourceDataProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SageMakerMachineLearningModelResourceDataProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param sageMakerJobArn The Amazon Resource Name (ARN) of the Amazon SageMaker
             *   training job that represents the source model.
             */
        ...
        internal constructor(
            ...
            /**
             * The Amazon Resource Name (ARN) of the Amazon SageMaker training job that represents
             * the source model.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-greengrass-resourcedefinition-sagemakermachinelearningmodelresourcedata.html#cfn-greengrass-resourcedefinition-sagemakermachinelearningmodelresourcedata-sagemakerjobarn)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SageMakerMachineLearningModelResourceDataProperty
            ): software.amazon.awscdk.services.greengrass.CfnResourceDefinition.SageMakerMachineLearningModelResourceDataProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface LocalVolumeResourceDataProperty {
        ...
        public interface Builder {
            /**
             * @param destinationPath The absolute local path of the resource in the Lambda
             *   environment.
             */
            public fun destinationPath(destinationPath: String)

            /**
             * @param groupOwnerSetting Settings that define additional Linux OS group permissions
             *   to give to the Lambda function process.
             */
            ...
            public fun groupOwnerSetting(
                groupOwnerSetting: GroupOwnerSettingProperty.Builder.() -> Unit
            )

            /**
             * @param sourcePath The local absolute path of the volume resource on the host. The
        ...
        private class BuilderImpl : Builder {
            ...
            override fun groupOwnerSetting(groupOwnerSetting: GroupOwnerSettingProperty) {
                cdkBuilder.groupOwnerSetting(
                    groupOwnerSetting.let(GroupOwnerSettingProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("d2ba809514e8753cc7b3c36c4756ea36411805335e2f2e214e4b3a274cca3c2f")
            override fun groupOwnerSetting(
                groupOwnerSetting: GroupOwnerSettingProperty.Builder.() -> Unit
        ...
        internal constructor(
            ...
            /**
             * Settings that define additional Linux OS group permissions to give to the Lambda
             * function process.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-greengrass-resourcedefinition-localvolumeresourcedata.html#cfn-greengrass-resourcedefinition-localvolumeresourcedata-groupownersetting)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: LocalVolumeResourceDataProperty
            ): software.amazon.awscdk.services.greengrass.CfnResourceDefinition.LocalVolumeResourceDataProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface LocalDeviceResourceDataProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param sourcePath The local absolute path of the device resource. The source path for
             *   a device resource can refer only to a character device or block device under `/dev`
             *   .
             */
            public fun sourcePath(sourcePath: String)
        }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: LocalDeviceResourceDataProperty
            ): software.amazon.awscdk.services.greengrass.CfnResourceDefinition.LocalDeviceResourceDataProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ResourceInstanceProperty {
        ...
        public interface Builder {
            /**
             * @param id A descriptive or arbitrary ID for the resource. This value must be unique
             *   within the resource definition version. Maximum length is 128 characters with
             *   pattern `[a-zA-Z0-9:_-]+` .
             */
            public fun id(id: String)

            /**
             * @param name The descriptive resource name, which is displayed on the AWS IoT
             *   Greengrass console. Maximum length 128 characters with pattern [a-zA-Z0-9:_-]+.
             *   This must be unique within a Greengrass group.
             */
            public fun name(name: String)

            /**
             * @param resourceDataContainer A container for resource data. The container takes only
            ...
            public fun resourceDataContainer(
                resourceDataContainer: ResourceDataContainerProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
             ...
             * Only one resource type can be defined for a `ResourceDataContainer` instance.
             */
            override fun resourceDataContainer(
                resourceDataContainer: ResourceDataContainerProperty
            ) {
                cdkBuilder.resourceDataContainer(
                    resourceDataContainer.let(ResourceDataContainerProperty::unwrap)
                )
            }
        ...
        internal constructor(
             ...
             * A descriptive or arbitrary ID for the resource.
             *
             * This value must be unique within the resource definition version. Maximum length is
             ...
             * The descriptive resource name, which is displayed on the AWS IoT Greengrass console.
             *
             * Maximum length 128 characters with pattern [a-zA-Z0-9:_-]+. This must be unique
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ResourceInstanceProperty
            ): software.amazon.awscdk.services.greengrass.CfnResourceDefinition.ResourceInstanceProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ResourceDataContainerProperty {
        ...
        public interface Builder {
            ...
            public fun localDeviceResourceData(
                localDeviceResourceData: LocalDeviceResourceDataProperty.Builder.() -> Unit
            )
            ...
            public fun localVolumeResourceData(
                localVolumeResourceData: LocalVolumeResourceDataProperty.Builder.() -> Unit
            )

            /**
             * @param s3MachineLearningModelResourceData Settings for a machine learning resource
             *   stored in Amazon S3 .
             */
            public fun s3MachineLearningModelResourceData(
                s3MachineLearningModelResourceData: IResolvable
            )
            ...
            public fun s3MachineLearningModelResourceData(
                s3MachineLearningModelResourceData:
                    S3MachineLearningModelResourceDataProperty.Builder.() -> Unit
            )

            /**
             * @param sageMakerMachineLearningModelResourceData Settings for a machine learning
             *   resource saved as an SageMaker training job.
             */
            ...
            public fun secretsManagerSecretResourceData(
                secretsManagerSecretResourceData:
                    SecretsManagerSecretResourceDataProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            /** @param localDeviceResourceData Settings for a local device resource. */
            override fun localDeviceResourceData(
                localDeviceResourceData: LocalDeviceResourceDataProperty
            ) {
                cdkBuilder.localDeviceResourceData(
                    localDeviceResourceData.let(LocalDeviceResourceDataProperty::unwrap)
                )
            }
            ...
            override fun localDeviceResourceData(
                ...
                localDeviceResourceData(LocalDeviceResourceDataProperty(localDeviceResourceData))
            ...
            /** @param localVolumeResourceData Settings for a local volume resource. */
            override fun localVolumeResourceData(
                localVolumeResourceData: LocalVolumeResourceDataProperty
            ) {
                cdkBuilder.localVolumeResourceData(
                    localVolumeResourceData.let(LocalVolumeResourceDataProperty::unwrap)
                )
            }
            ...
            override fun localVolumeResourceData(
                ...
                localVolumeResourceData(LocalVolumeResourceDataProperty(localVolumeResourceData))

            /**
             * @param s3MachineLearningModelResourceData Settings for a machine learning resource
             *   stored in Amazon S3 .
             */
            override fun s3MachineLearningModelResourceData(
                s3MachineLearningModelResourceData: IResolvable
            ) {
                cdkBuilder.s3MachineLearningModelResourceData(
                    s3MachineLearningModelResourceData.let(IResolvable::unwrap)
                )
            }
            ...
            override fun s3MachineLearningModelResourceData(
                ...
                cdkBuilder.s3MachineLearningModelResourceData(
                    s3MachineLearningModelResourceData.let(
                        S3MachineLearningModelResourceDataProperty::unwrap
                    )
                )
            }
            ...
            override fun s3MachineLearningModelResourceData(
                ...
                s3MachineLearningModelResourceData(
                    S3MachineLearningModelResourceDataProperty(s3MachineLearningModelResourceData)
                )
            ...
            override fun sageMakerMachineLearningModelResourceData(
                ...
                cdkBuilder.sageMakerMachineLearningModelResourceData(
                    sageMakerMachineLearningModelResourceData.let(IResolvable::unwrap)
                )
            }
            ...
            override fun sageMakerMachineLearningModelResourceData(
                ...
                cdkBuilder.sageMakerMachineLearningModelResourceData(
                    sageMakerMachineLearningModelResourceData.let(
                        SageMakerMachineLearningModelResourceDataProperty::unwrap
                    )
                )
            }
            ...
            override fun secretsManagerSecretResourceData(
                ...
                cdkBuilder.secretsManagerSecretResourceData(
                    secretsManagerSecretResourceData.let(IResolvable::unwrap)
                )
            }
            ...
            override fun secretsManagerSecretResourceData(
                ...
                cdkBuilder.secretsManagerSecretResourceData(
                    secretsManagerSecretResourceData.let(
                        SecretsManagerSecretResourceDataProperty::unwrap
                    )
                )
            }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ResourceDataContainerProperty
            ): software.amazon.awscdk.services.greengrass.CfnResourceDefinition.ResourceDataContainerProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ResourceDownloadOwnerSettingProperty {
        ...
        public interface Builder {
            /**
             * @param groupOwner The group owner of the machine learning resource. This is the group
             *   ID (GID) of an existing Linux OS group on the system. The group's permissions are
             *   added to the Lambda process.
             */
            public fun groupOwner(groupOwner: String)

            /**
             * @param groupPermission The permissions that the group owner has to the machine
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ResourceDownloadOwnerSettingProperty
            ): software.amazon.awscdk.services.greengrass.CfnResourceDefinition.ResourceDownloadOwnerSettingProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface GroupOwnerSettingProperty {
        ...
        public interface Builder {
            /**
             * @param autoAddGroupOwner Indicates whether to give the privileges of the Linux group
             *   that owns the resource to the Lambda process. This gives the Lambda process the
             *   file access permissions of the Linux group.
             */
             ...
             *   Lambda process. This value is ignored if `AutoAddGroupOwner` is true.
             */
            public fun groupOwner(groupOwner: String)
        }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: GroupOwnerSettingProperty
            ): software.amazon.awscdk.services.greengrass.CfnResourceDefinition.GroupOwnerSettingProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
