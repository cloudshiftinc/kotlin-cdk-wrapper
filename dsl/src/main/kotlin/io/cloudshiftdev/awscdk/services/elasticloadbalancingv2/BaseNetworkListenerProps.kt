...
public interface BaseNetworkListenerProps {
    ...
    public interface Builder {
        /**
         * @param alpnPolicy Application-Layer Protocol Negotiation (ALPN) is a TLS extension that
         *   is sent on the initial TLS handshake hello messages. ALPN enables the application layer
         *   to negotiate which protocols should be used over a secure connection, such as HTTP/1
         *   and HTTP/2.
         *
         * Can only be specified together with Protocol TLS.
         */
         ...
         *   full control of the default Action of the load balancer, including weighted forwarding.
         *   See the `NetworkListenerAction` class for all options.
         *
         * Cannot be specified together with `defaultTargetGroups`.
         */
    ...
    internal constructor(
        ...
        /**
         * Application-Layer Protocol Negotiation (ALPN) is a TLS extension that is sent on the
         * initial TLS handshake hello messages.
         *
         * ALPN enables the application layer to negotiate which protocols should be used over a
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: BaseNetworkListenerProps
        ): software.amazon.awscdk.services.elasticloadbalancingv2.BaseNetworkListenerProps =
