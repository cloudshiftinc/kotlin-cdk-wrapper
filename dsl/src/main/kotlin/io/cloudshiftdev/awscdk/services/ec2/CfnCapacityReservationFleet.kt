...
internal constructor(
    ...
    public open fun instanceTypeSpecifications(): Any? =
        unwrap(this).getInstanceTypeSpecifications()
    ...
    public interface Builder {
         ...
         * instance types to use.
         *
         * Currently, only the `prioritized` allocation strategy is supported. For more information,
         * see
         ...
         *
         * @param allocationStrategy The strategy used by the Capacity Reservation Fleet to
         *   determine which of the specified instance types to use.
         */
         ...
         * The date and time at which the Capacity Reservation Fleet expires.
         *
         * When the Capacity Reservation Fleet expires, its state changes to `expired` and all of
         * the Capacity Reservations in the Fleet expire.
         *
         ...
         *
         * @param instanceTypeSpecifications Information about the instance types for which to
         ...
         *
         * @param noRemoveEndDate Used to add an end date to a Capacity Reservation Fleet that has
         ...
         * automatically at a specific date and time.
         *
         * To remove the end date from a Capacity Reservation Fleet, specify `true` for this
         * paramater and omit the *EndDate* parameter.
         *
         ...
         * Indicates the tenancy of the Capacity Reservation Fleet.
         *
         * All Capacity Reservations in the Fleet inherit this tenancy. The Capacity Reservation
         * Fleet can have one of the following tenancy settings:
         * * `default` - The Capacity Reservation Fleet is created on hardware that is shared with
         *   other AWS accounts .
         ...
         *
         * @param totalTargetCapacity The total number of capacity units to be reserved by the
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.ec2.CfnCapacityReservationFleet.Builder.create(
                scope,
                id
            )
        ...
        override fun instanceTypeSpecifications(instanceTypeSpecifications: IResolvable) {
            cdkBuilder.instanceTypeSpecifications(
                instanceTypeSpecifications.let(IResolvable::unwrap)
            )
        }
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnCapacityReservationFleet
    ...
    public interface InstanceTypeSpecificationProperty {
         ...
         *
         * This value is used to determine which of the instance types specified for the Fleet
         * should be prioritized for use. A lower value indicates a high priority. For more
         * information, see
         ...
         * determine the number of instances for which the Fleet reserves capacity. Both values are
         * based on units that make sense for your workload. For more information, see
         * [Total target capacity](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/crfleet-concepts.html#target-capacity)
         * in the Amazon EC2 User Guide.
         *
        ...
        public interface Builder {
             ...
             *   reserves the capacity. A Capacity Reservation Fleet can't span Availability Zones.
            ...
            /**
             * @param availabilityZoneId The ID of the Availability Zone in which the Capacity
             *   Reservation Fleet reserves the capacity. A Capacity Reservation Fleet can't span
             *   Availability Zones. All instance type specifications that you specify for the Fleet
             *   must use the same Availability Zone.
             */
            public fun availabilityZoneId(availabilityZoneId: String)

            /**
             * @param ebsOptimized Indicates whether the Capacity Reservation Fleet supports
             *   EBS-optimized instances types. This optimization provides dedicated throughput to
             *   Amazon EBS and an optimized configuration stack to provide optimal I/O performance.
             *   This optimization isn't available with all instance types. Additional usage charges
            ...
            /**
             * @param instancePlatform The type of operating system for which the Capacity
             *   Reservation Fleet reserves capacity.
             */
            public fun instancePlatform(instancePlatform: String)

            /**
             * @param instanceType The instance type for which the Capacity Reservation Fleet
             *   reserves capacity.
             */
            public fun instanceType(instanceType: String)

            /**
             * @param priority The priority to assign to the instance type. This value is used to
             *   determine which of the instance types specified for the Fleet should be prioritized
             ...
             *   values are based on units that make sense for your workload. For more information,
             *   see
             *   [Total target capacity](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/crfleet-concepts.html#target-capacity)
             *   in the Amazon EC2 User Guide.
             *
        ...
        internal constructor(
             ...
             *
             * This value, together with the total target capacity that you specify for the Fleet
             * determine the number of instances for which the Fleet reserves capacity. Both values
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: InstanceTypeSpecificationProperty
            ): software.amazon.awscdk.services.ec2.CfnCapacityReservationFleet.InstanceTypeSpecificationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
