...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param authMode Specifies whether the Studio authenticates users using IAM Identity
         *   Center or IAM.
         */
         ...
         *
         * @param defaultS3Location The Amazon S3 location to back up EMR Studio Workspaces and
         *   notebook files.
         */
         ...
         *
         * @param encryptionKeyArn The AWS KMS key identifier (ARN) used to encrypt Amazon EMR
         *   Studio workspace and notebook files when backed up to Amazon S3.
         */
         ...
         * The ID of the Amazon EMR Studio Engine security group.
         *
         * The Engine security group allows inbound network traffic from the Workspace security
         ...
         * Your identity provider's authentication endpoint.
         *
         * Amazon EMR Studio redirects federated users to this endpoint for authentication when
        ...
        /**
         * The Amazon Resource Name (ARN) of the IAM role that will be assumed by the Amazon EMR
         * Studio.
         *
         ...
         *
         * @param serviceRole The Amazon Resource Name (ARN) of the IAM role that will be assumed by
         ...
         *
         * @param trustedIdentityPropagationEnabled Indicates whether the Studio has Trusted
        ...
        /**
         * The Amazon Resource Name (ARN) of the IAM user role that will be assumed by users and
         * groups logged in to a Studio.
         *
         ...
         *
         * @param userRole The Amazon Resource Name (ARN) of the IAM user role that will be assumed
         *   by users and groups logged in to a Studio.
         */
         ...
         *
         * @param vpcId The ID of the Amazon Virtual Private Cloud (Amazon VPC) to associate with
         *   the Studio.
         */
         ...
         *
         * @param workspaceSecurityGroupId The ID of the Workspace security group associated with
         *   the Amazon EMR Studio.
         */
    ...
    private class BuilderImpl(
         ...
         *   identity propagation enabled.
         */
        override fun trustedIdentityPropagationEnabled(
            trustedIdentityPropagationEnabled: IResolvable
        ) {
            cdkBuilder.trustedIdentityPropagationEnabled(
                trustedIdentityPropagationEnabled.let(IResolvable::unwrap)
            )
        }
