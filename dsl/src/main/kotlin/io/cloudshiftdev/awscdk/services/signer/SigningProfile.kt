...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.signer.SigningProfile,
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.signer.SigningProfile =
            cdkBuilder.build()
    }
    ...
    public companion object {
        public fun fromSigningProfileAttributes(
            ...
            software.amazon.awscdk.services.signer.SigningProfile.fromSigningProfileAttributes(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    attrs.let(SigningProfileAttributes::unwrap)
                )
                .let(ISigningProfile::wrap)
        ...
        public fun fromSigningProfileAttributes(
            ...
            fromSigningProfileAttributes(scope, id, SigningProfileAttributes(attrs))
