...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param identityPoolId The identity pool that you want to associate with this principal
         *   tag map.
         */
         ...
         * with them.
         *
         * When Amazon Cognito requests credentials, it sets the value of the principal tag to the
         * value of the user's claim.
         *
         ...
         *
         * @param useDefaults Use a default set of mappings between claims and tags for this
         *   provider, instead of a custom map.
         */
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.cognito.CfnIdentityPoolPrincipalTag.Builder.create(
                scope,
                id
            )
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnIdentityPoolPrincipalTag
