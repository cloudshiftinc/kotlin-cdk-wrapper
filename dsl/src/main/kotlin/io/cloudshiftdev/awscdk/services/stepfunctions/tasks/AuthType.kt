...
public enum class AuthType(
    ...
    public companion object {
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.AuthType
        ): AuthType =
            when (cdkObject) {
                software.amazon.awscdk.services.stepfunctions.tasks.AuthType.NO_AUTH ->
                    AuthType.NO_AUTH
                software.amazon.awscdk.services.stepfunctions.tasks.AuthType.IAM_ROLE ->
                    AuthType.IAM_ROLE
