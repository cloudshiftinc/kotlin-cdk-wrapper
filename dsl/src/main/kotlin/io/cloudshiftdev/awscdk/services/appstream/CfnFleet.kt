...
internal constructor(
     ...
     */
    public open fun usbDeviceFilterStrings(): List<String> =
        unwrap(this).getUsbDeviceFilterStrings() ?: emptyList()
    ...
    public interface Builder {
         ...
         *
         * @param disconnectTimeoutInSeconds The amount of time that a streaming session remains
         ...
         *
         * @param domainJoinInfo The name of the directory and organizational unit (OU) to use to
         ...
         *
         * @param enableDefaultInternetAccess Enables or disables default internet access for the
         *   fleet.
         */
         ...
         * * **ELASTIC** - The pool of streaming instances is managed by Amazon AppStream 2.0. When
         *   a user selects their application or desktop to launch, they will start streaming after
         *   the app block has been downloaded and mounted to a streaming instance.
         *
         ...
         *
         * Users are notified before they are disconnected due to inactivity. If they try to
         * reconnect to the streaming session before the time interval specified in
         * `DisconnectTimeoutInSeconds` elapses, they are connected to their previous session. Users
         * are considered idle when they stop providing keyboard or mouse input during their
         ...
         * Otherwise, specify a value between 60 and 36000.
         *
         ...
         *
         * @param idleDisconnectTimeoutInSeconds The amount of time that users can be idle
         ...
         *
         * @param instanceType The instance type to use when launching fleet instances. The
         ...
         *
         * @param maxConcurrentSessions The maximum number of concurrent sessions that can be run on
         *   an Elastic fleet.
         */
         ...
         *
         * @param sessionScriptS3Location The S3 location of the session scripts configuration zip
         *   file.
         */
        ...
        public fun sessionScriptS3Location(
            sessionScriptS3Location: S3LocationProperty.Builder.() -> Unit
        )

        /**
         * The AppStream 2.0 view that is displayed to your users when they stream from the fleet.
         * When `APP` is specified, only the windows of applications opened by users display. When
         ...
         * fleet streaming session, when using the Windows native client.
         *
         ...
         *
         * @param usbDeviceFilterStrings The USB device filter strings that specify which USB
         *   devices a user can redirect to the fleet streaming session, when using the Windows
         *   native client.
         */
    ...
    private class BuilderImpl(
        ...
        override fun computeCapacity(
            computeCapacity: ComputeCapacityProperty.Builder.() -> Unit
        ): Unit = computeCapacity(ComputeCapacityProperty(computeCapacity))
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("506b9b8d13972074c9bc025c0200159e6477bacb687a4372c8b938675473574d")
        override fun domainJoinInfo(
            domainJoinInfo: DomainJoinInfoProperty.Builder.() -> Unit
        ...
        override fun enableDefaultInternetAccess(enableDefaultInternetAccess: IResolvable) {
            cdkBuilder.enableDefaultInternetAccess(
                enableDefaultInternetAccess.let(IResolvable::unwrap)
            )
        }
        ...
        override fun sessionScriptS3Location(sessionScriptS3Location: S3LocationProperty) {
            cdkBuilder.sessionScriptS3Location(
                sessionScriptS3Location.let(S3LocationProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("56683f90f907d5eb91d8a6af02a81d5f7bb017a32f5aec052db5ab5b82184de3")
        override fun sessionScriptS3Location(
            sessionScriptS3Location: S3LocationProperty.Builder.() -> Unit
    ...
    public interface ComputeCapacityProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param desiredSessions The desired capacity in terms of number of user sessions, for
             *   the multi-session fleet. This is not allowed for single-session fleets.
             *
             * When you create a fleet, you must set define either the DesiredSessions or
             * DesiredInstances attribute, based on the type of fleet you create. You can’t define
             * both attributes or leave both attributes blank.
             */
        ...
        internal constructor(
            ...
            /**
             * The desired capacity in terms of number of user sessions, for the multi-session
             * fleet.
             *
             * This is not allowed for single-session fleets.
             *
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ComputeCapacityProperty
            ): software.amazon.awscdk.services.appstream.CfnFleet.ComputeCapacityProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface VpcConfigProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param subnetIds The identifiers of the subnets to which a network interface is
             *   attached from the fleet instance. Fleet instances can use one or two subnets.
             */
    ...
    public interface DomainJoinInfoProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param organizationalUnitDistinguishedName The distinguished name of the
             *   organizational unit for computer accounts.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DomainJoinInfoProperty
            ): software.amazon.awscdk.services.appstream.CfnFleet.DomainJoinInfoProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
