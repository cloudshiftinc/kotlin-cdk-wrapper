...
internal constructor(
    ...
    public companion object {
        ...
        ): CfnRecipe = CfnRecipe(cdkObject)

        internal fun unwrap(
            wrapped: CfnRecipe
        ): software.amazon.awscdk.services.databrew.CfnRecipe = wrapped.cdkObject
    }
    ...
    public interface ConditionExpressionProperty {
        ...
        public interface Builder {
            /**
             * @param condition A specific condition to apply to a recipe action. For more
             *   information, see
             *   [Recipe structure](https://docs.aws.amazon.com/databrew/latest/dg/recipe-structure.html)
             *   in the *AWS Glue DataBrew Developer Guide* .
             */
            ...
            /**
             * @param value A value that the condition must evaluate to for the condition to
             *   succeed.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ConditionExpressionProperty
            ): software.amazon.awscdk.services.databrew.CfnRecipe.ConditionExpressionProperty =
    ...
    public interface DataCatalogInputDefinitionProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param tempDirectory Represents an Amazon location where DataBrew can store
        ...
        private class BuilderImpl : Builder {
            private val cdkBuilder:
                ...
                software.amazon.awscdk.services.databrew.CfnRecipe
    ...
    public interface ActionProperty {
        ...
        public interface Builder {
            /**
             * @param operation The name of a valid DataBrew transformation to be performed on the
             *   data.
             */
    ...
    public interface InputProperty {
        ...
        internal constructor(
            internal val cdkObject:
                software.amazon.awscdk.services.databrew.CfnRecipe.InputProperty,
        ) : InputProperty {
            /**
             * The AWS Glue Data Catalog parameters for the data.
             *
    ...
    public interface RecipeParametersProperty {
         ...
         */
        public fun groupByAggFunctionOptions(): String? =
        ...
        public interface Builder {
            ...
            /**
             * @param charsToRemove Characters to remove from a step that applies one-hot encoding
             *   or tokenization.
             */
            ...
            /**
             * @param customStopWords A list of words to ignore in a step that applies word
             *   tokenization.
             */
            public fun customStopWords(customStopWords: String)

            /**
             * @param customValue A list of custom values to use in a step that requires that you
             *   provide a value to finish the operation.
             */
            ...
            /**
             * @param dateAddValue A value that specifies how many units of time to add or subtract
             *   for a date math operation.
             */
            ...
            /**
             * @param deleteOtherRows Determines whether unmapped rows in a categorical mapping
             *   should be deleted.
             */
            ...
            /**
             * @param expandContractions A list of word contractions and what they expand to. For
             *   eample: *can't* ; *cannot* ; *can not* .
             */
            ...
            /**
             * @param groupByAggFunctionOptions Specifies options to apply to the `GROUP BY` used in
             *   an aggregation.
             */
            ...
            /**
             * @param joinType The type of join to use, for example, `INNER JOIN` , `OUTER JOIN` ,
             *   and so on.
             */
            ...
            /**
             * @param modeType Determines the manner in which mode value is calculated, in case
             *   there is more than one mode value. Valid values: `NONE` | `AVERAGE` | `MINIMUM` |
             *   `MAXIMUM`
             */
            ...
            /**
             * @param numRowsBefore The number of rows to consider before the current row in a
             *   window.
             */
            ...
            /**
             * @param patternOptions For splitting by multiple delimiters: A JSON-encoded string
             *   that lists the patterns in the format. For example:
            ...
            /**
             * @param removeCustomValue If `true` , removes all chraracters specified by
             *   `CustomValue` .
             */
            public fun removeCustomValue(removeCustomValue: String)

            /**
             * @param removeLeadingAndTrailingPunctuation If `true` , removes the following
             *   characters if they occur at the start or end of the value: `.` `!` `,` `?`.
             */
            public fun removeLeadingAndTrailingPunctuation(
                removeLeadingAndTrailingPunctuation: String
            )

            /**
             * @param removeLeadingAndTrailingQuotes If `true` , removes single quotes and double
             *   quotes from the beginning and end of the value.
             */
            public fun removeLeadingAndTrailingQuotes(removeLeadingAndTrailingQuotes: String)

            /**
             * @param removeLeadingAndTrailingWhitespace If `true` , removes all whitespaces from
             *   the beginning and end of the value.
             */
            public fun removeLeadingAndTrailingWhitespace(
                removeLeadingAndTrailingWhitespace: String
            )

            /**
             * @param removeLetters If `true` , removes all uppercase and lowercase alphabetic
            ...
            /**
             * @param removeSourceColumn If `true` , the source column will be removed after
             *   un-nesting that column. (Used with nested column types, such as Map, Struct, or
             *   Array.)
             */
            ...
            /**
             * @param sheetIndexes One or more sheet numbers in the Excel file, which will be
            ...
            /**
             * @param sheetNames Oone or more named sheets in the Excel file, which will be included
             *   in a dataset.
             */
            ...
            /**
             * @param sourceColumns A list of source columns needed for an operation, step, or
             *   transform.
             */
            public fun sourceColumns(sourceColumns: String)

            /**
             * @param startColumnIndex The index number of the first column used by an operation,
             *   step, or transform.
             */
            ...
            /**
             * @param stemmingMode Indicates this operation uses stems and lemmas (base words) for
             *   word tokenization.
             */
            ...
            /**
             * @param stopWordsMode Indicates this operation uses stop words as part of word
             *   tokenization.
             */
            ...
            /**
             * @param tokenizerPattern A regex expression to use when splitting text into terms,
             *   also called words or tokens.
             */
            ...
            /**
             * @param units Specifies a unit of time. For example: `MINUTES` ; `SECONDS` ; `HOURS` ;
             *   etc.
             */
            ...
            /**
             * @param value A static value that can be used in a comparison, a substitution, or in
             *   another context-specific way. A `Value` can be a number, string, or other datatype,
            ...
            /**
             * @param valueColumn The column that is provided as a value that's used by this
             *   operation.
             */
        ...
        private class BuilderImpl : Builder {
             ...
             *   characters if they occur at the start or end of the value: `.` `!` `,` `?`.
             */
            override fun removeLeadingAndTrailingPunctuation(
                removeLeadingAndTrailingPunctuation: String
            ) {
             ...
             *   the beginning and end of the value.
             */
            override fun removeLeadingAndTrailingWhitespace(
                removeLeadingAndTrailingWhitespace: String
            ) {
        ...
        internal constructor(
            ...
            /**
             * For splitting by multiple delimiters: A JSON-encoded string that lists the patterns
             * in the format.
             *
             * For example: `[{\"pattern\":\"1\",\"includeInSplit\":true}]`
             *
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-databrew-recipe-recipeparameters.html#cfn-databrew-recipe-recipeparameters-removecustomcharacters)
             */
            override fun removeCustomCharacters(): String? =
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-databrew-recipe-recipeparameters.html#cfn-databrew-recipe-recipeparameters-removespecialcharacters)
             */
            override fun removeSpecialCharacters(): String? =
             ...
             * context-specific way.
             *
             * A `Value` can be a number, string, or other datatype, depending on the recipe action
             * in which it's used.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-databrew-recipe-recipeparameters.html#cfn-databrew-recipe-recipeparameters-value)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RecipeParametersProperty
            ): software.amazon.awscdk.services.databrew.CfnRecipe.RecipeParametersProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SecondaryInputProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SecondaryInputProperty
            ): software.amazon.awscdk.services.databrew.CfnRecipe.SecondaryInputProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface RecipeStepProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param conditionExpressions One or more conditions that must be met for the recipe
             *   step to succeed.
             *
             * All of the conditions in the array must be met. In other words, all of the conditions
             * must be combined using a logical AND operation.
