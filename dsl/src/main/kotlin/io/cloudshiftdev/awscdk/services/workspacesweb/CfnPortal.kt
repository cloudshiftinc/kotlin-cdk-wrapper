...
internal constructor(
    ...
    public interface Builder {
         ...
         * Defaults to `Standard` .
         *
         * `Standard` web portals are authenticated directly through your identity provider (IdP).
         * User and group access to your web portal is controlled through your IdP. You need to
         * include an IdP resource in your template to integrate your IdP with your web portal.
         * Completing the configuration for your IdP requires exchanging WorkSpaces Web’s SP
         ...
         * * Retrieve the SP metadata using `Fn:GetAtt` , the WorkSpaces Web console, or by the
         ...
         * They provide additional features, such as IdP-initiated authentication. Identity sources
         * (including external identity provider integration) and other identity provider
         * information must be configured in IAM Identity Center . User and group assignment must be
         * done through the WorkSpaces Web console. These cannot be configured in CloudFormation.
         *
         ...
         *
         * @param browserSettingsArn The ARN of the browser settings that is associated with this
         *   web portal.
         */
         ...
         *
         * @param ipAccessSettingsArn The ARN of the IP access settings that is associated with the
         *   web portal.
         */
         ...
         *
         * @param userSettingsArn The ARN of the user settings that is associated with the web
         *   portal.
         */
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.workspacesweb.CfnPortal =
            cdkBuilder.build()
    }
    ...
    public companion object {
        ...
        ): CfnPortal = CfnPortal(cdkObject)

        internal fun unwrap(
            wrapped: CfnPortal
        ): software.amazon.awscdk.services.workspacesweb.CfnPortal = wrapped.cdkObject
    }
}
