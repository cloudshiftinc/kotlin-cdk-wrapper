...
public abstract class FlowLogDestination internal constructor(
  ...
  public companion object {
    public open fun toCloudWatchLogs(): FlowLogDestination =
        software.amazon.awscdk.services.ec2.FlowLogDestination.toCloudWatchLogs().let(FlowLogDestination::wrap)

    public open fun toCloudWatchLogs(logGroup: ILogGroup): FlowLogDestination =
    ...
    public open fun toCloudWatchLogs(logGroup: ILogGroup, iamRole: IRole): FlowLogDestination =
    ...
    public open fun toKinesisDataFirehoseDestination(deliveryStreamArn: String): FlowLogDestination
        =
