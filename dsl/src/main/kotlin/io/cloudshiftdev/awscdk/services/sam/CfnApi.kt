...
internal constructor(
    ...
    public open fun auth(`value`: AuthProperty.Builder.() -> Unit): Unit =
    ...
    public interface DomainConfigurationProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DomainConfigurationProperty
            ): software.amazon.awscdk.services.sam.CfnApi.DomainConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface AuthProperty {
        ...
        private class BuilderImpl : Builder {
            ...
            /** @param addDefaultAuthorizerToCorsPreflight the value to be set. */
            override fun addDefaultAuthorizerToCorsPreflight(
                addDefaultAuthorizerToCorsPreflight: Boolean
            ) {
            ...
            override fun addDefaultAuthorizerToCorsPreflight(
                ...
                cdkBuilder.addDefaultAuthorizerToCorsPreflight(
                    addDefaultAuthorizerToCorsPreflight.let(IResolvable::unwrap)
                )
            }
