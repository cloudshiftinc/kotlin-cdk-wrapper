...
public enum class AdvancedSecurityMode(
    ...
    public companion object {
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.cognito.AdvancedSecurityMode
            ...
            when (cdkObject) {
                ...
                software.amazon.awscdk.services.cognito.AdvancedSecurityMode.OFF ->
                    AdvancedSecurityMode.OFF
            }

        internal fun unwrap(
            wrapped: AdvancedSecurityMode
