...
internal constructor(
    ...
    public interface Builder {
         ...
         * requests for flows communicating with this gateway.
         *
         ...
         *
         * @param egressCidrBlocks The range of IP addresses that are allowed to contribute content
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.mediaconnect.CfnGateway =
            cdkBuilder.build()
    }
    ...
    public interface GatewayNetworkProperty {
        ...
        public interface Builder {
            /**
             * @param cidrBlock A unique IP address range to use for this network. These IP
             *   addresses should be in the form of a Classless Inter-Domain Routing (CIDR) block;
             *   for example, 10.0.0.0/16.
             */
            public fun cidrBlock(cidrBlock: String)

            /**
             * @param name The name of the network. This name is used to reference the network and
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: GatewayNetworkProperty
            ): software.amazon.awscdk.services.mediaconnect.CfnGateway.GatewayNetworkProperty =
