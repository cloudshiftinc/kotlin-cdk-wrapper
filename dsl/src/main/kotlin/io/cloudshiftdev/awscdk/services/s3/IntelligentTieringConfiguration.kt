...
public interface IntelligentTieringConfiguration {
    ...
    public interface Builder {
        ...
        /**
         * @param deepArchiveAccessTierTime When enabled, Intelligent-Tiering will automatically
         *   move objects that haven’t been accessed for a minimum of 180 days to the Deep Archive
         *   Access tier.
         */
    ...
    internal constructor(
        ...
        /**
         * When enabled, Intelligent-Tiering will automatically move objects that haven’t been
         * accessed for a minimum of 90 days to the Archive Access tier.
         *
         * Default: Objects will not move to Glacier
         */
        ...
        /**
         * When enabled, Intelligent-Tiering will automatically move objects that haven’t been
         * accessed for a minimum of 180 days to the Deep Archive Access tier.
         *
         * Default: Objects will not move to Glacier Deep Access
         */
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: IntelligentTieringConfiguration
