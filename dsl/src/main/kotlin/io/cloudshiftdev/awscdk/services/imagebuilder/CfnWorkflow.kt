...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param changeDescription Describes what change has been made in this version of the
         ...
         * access the S3 bucket it points to. If you use Amazon S3, you can specify component
        ...
        /**
         * The semantic version of this workflow resource. The semantic version syntax adheres to
         * the following rules.
         *
         ...
         *
         * @param version The semantic version of this workflow resource. The semantic version
