...
internal constructor(
    ...
    public open fun attrPipelinesRunningCount(): Number =
        unwrap(this).getAttrPipelinesRunningCount()
    ...
    public interface Builder {
        ...
        public fun multiplexSettings(
            multiplexSettings: MultiplexSettingsProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("f48a3161dab0e0572a7a8b048700145d2d36e6dc63d0a03419f9b9db2492680c")
        override fun multiplexSettings(
            multiplexSettings: MultiplexSettingsProperty.Builder.() -> Unit
        ...
        public fun build(): software.amazon.awscdk.services.medialive.CfnMultiplex =
            cdkBuilder.build()
    }
    ...
    public interface MultiplexMediaConnectOutputDestinationSettingsProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: MultiplexMediaConnectOutputDestinationSettingsProperty
            ): software.amazon.awscdk.services.medialive.CfnMultiplex.MultiplexMediaConnectOutputDestinationSettingsProperty =
    ...
    public interface MultiplexSettingsProperty {
        ...
        public interface Builder {
             ...
             *   milliseconds.
             */
            public fun maximumVideoBufferDelayMilliseconds(
        ...
        private class BuilderImpl : Builder {
             ...
             *   milliseconds.
             */
            override fun maximumVideoBufferDelayMilliseconds(
                maximumVideoBufferDelayMilliseconds: Number
            ) {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: MultiplexSettingsProperty
            ): software.amazon.awscdk.services.medialive.CfnMultiplex.MultiplexSettingsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface MultiplexOutputDestinationProperty {
        ...
        public interface Builder {
            ...
            public fun multiplexMediaConnectOutputDestinationSettings(
                multiplexMediaConnectOutputDestinationSettings:
                    MultiplexMediaConnectOutputDestinationSettingsProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
             ...
             *   destination settings.
             */
            override fun multiplexMediaConnectOutputDestinationSettings(
                multiplexMediaConnectOutputDestinationSettings: IResolvable
            ) {
                cdkBuilder.multiplexMediaConnectOutputDestinationSettings(
                    multiplexMediaConnectOutputDestinationSettings.let(IResolvable::unwrap)
                )
            }
            ...
            override fun multiplexMediaConnectOutputDestinationSettings(
                ...
                cdkBuilder.multiplexMediaConnectOutputDestinationSettings(
                    multiplexMediaConnectOutputDestinationSettings.let(
                        MultiplexMediaConnectOutputDestinationSettingsProperty::unwrap
                    )
                )
            }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: MultiplexOutputDestinationProperty
            ): software.amazon.awscdk.services.medialive.CfnMultiplex.MultiplexOutputDestinationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
