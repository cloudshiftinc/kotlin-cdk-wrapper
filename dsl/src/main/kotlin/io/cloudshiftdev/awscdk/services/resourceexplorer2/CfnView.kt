...
internal constructor(
    ...
    public interface Builder {
         ...
         * operation, the filter string is combined with the search's `QueryString` parameter using
         ...
         *
         * @param filters An array of strings that include search keywords, prefixes, and operators
         *   that filter the results that are returned for queries made using this view.
         */
    ...
    public companion object {
        ...
        ): CfnView = CfnView(cdkObject)

        internal fun unwrap(
            wrapped: CfnView
        ): software.amazon.awscdk.services.resourceexplorer2.CfnView = wrapped.cdkObject
    }
    ...
    public interface SearchFilterProperty {
        ...
        public interface Builder {
            /**
             * @param filterString The string that contains the search keywords, prefixes, and
             *   operators to control the results that can be returned by a Search operation. For
             *   information about the supported syntax, see
             *   [Search query reference](https://docs.aws.amazon.com/resource-explorer/latest/userguide/using-search-query-syntax.html)
             *   in the *AWS Resource Explorer User Guide* .
             *
             * This query string in the context of this operation supports only
             ...
             * [operators](https://docs.aws.amazon.com/resource-explorer/latest/userguide/using-search-query-syntax.html#query-syntax-operators)
             * . It doesn't support free-form text. For example, the string `region:us* service:ec2
             * -tag:stage=prod` includes all Amazon EC2 resources in any AWS Region that begin with
    ...
    public interface IncludedPropertyProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: IncludedPropertyProperty
            ): software.amazon.awscdk.services.resourceexplorer2.CfnView.IncludedPropertyProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
