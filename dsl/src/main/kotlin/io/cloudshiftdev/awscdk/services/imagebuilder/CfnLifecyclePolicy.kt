...
internal constructor(
    ...
    public interface Builder {
        ...
        public fun resourceSelection(
            resourceSelection: ResourceSelectionProperty.Builder.() -> Unit
        )
         ...
         *
         * @param resourceType The type of Image Builder resource that the lifecycle policy applies
         *   to.
         */
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.imagebuilder.CfnLifecyclePolicy.Builder.create(
                scope,
                id
            )
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("9b694048909f47d075362b9546c0a1899d67512c9b414b769fa22e7ad69d8b44")
        override fun resourceSelection(
            resourceSelection: ResourceSelectionProperty.Builder.() -> Unit
    ...
    public interface LastLaunchedProperty {
        /**
         * Defines the unit of time that the lifecycle policy uses to calculate elapsed time since
         * the last instance launched from the AMI.
         *
        ...
        public interface Builder {
            /**
             * @param unit Defines the unit of time that the lifecycle policy uses to calculate
             *   elapsed time since the last instance launched from the AMI. For example: days,
             *   weeks, months, or years.
             */
            public fun unit(unit: String)

            /**
             * @param value The integer number of units for the time period. For example `6`
             *   (months).
             */
        ...
        internal constructor(
             ...
             * since the last instance launched from the AMI.
             *
             * For example: days, weeks, months, or years.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-imagebuilder-lifecyclepolicy-lastlaunched.html#cfn-imagebuilder-lifecyclepolicy-lastlaunched-unit)
    ...
    public interface IncludeResourcesProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: IncludeResourcesProperty
            ): software.amazon.awscdk.services.imagebuilder.CfnLifecyclePolicy.IncludeResourcesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ActionProperty {
        ...
        public interface Builder {
            ...
            public fun includeResources(
                includeResources: IncludeResourcesProperty.Builder.() -> Unit
            )
    ...
    public interface RecipeSelectionProperty {
        ...
        public interface Builder {
            /**
             * @param name The name of an Image Builder recipe that the lifecycle policy uses for
             *   resource selection.
             */
            public fun name(name: String)

            /**
             * @param semanticVersion The version of the Image Builder recipe specified by the
             *   `name` field.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RecipeSelectionProperty
            ): software.amazon.awscdk.services.imagebuilder.CfnLifecyclePolicy.RecipeSelectionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ResourceSelectionProperty {
        ...
        public interface Builder {
            /**
             * @param recipes A list of recipes that are used as selection criteria for the output
            ...
            /**
             * @param tagMap A list of tags that are used as selection criteria for the Image
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ResourceSelectionProperty
            ): software.amazon.awscdk.services.imagebuilder.CfnLifecyclePolicy.ResourceSelectionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface FilterProperty {
        /**
         * For age-based filters, this is the number of resources to keep on hand after the
         * lifecycle `DELETE` action is applied.
         *
         * Impacted resources are only deleted if you have more than this number of resources. If
         * you have fewer resources than this number, the impacted resource is not deleted.
         *
         ...
         * hand. If you have fewer resources than this number, the resource is excluded from
         * lifecycle actions.
         *
        ...
        public interface Builder {
            /**
             * @param retainAtLeast For age-based filters, this is the number of resources to keep
             *   on hand after the lifecycle `DELETE` action is applied. Impacted resources are only
             *   deleted if you have more than this number of resources. If you have fewer resources
            ...
            /**
             * @param unit Defines the unit of time that the lifecycle policy uses to determine
             *   impacted resources. This is required for age-based rules.
             */
            public fun unit(unit: String)

            /**
             * @param value The number of units for the time period or for the count. For example, a
        ...
        internal constructor(
             ...
             * lifecycle `DELETE` action is applied.
             *
             * Impacted resources are only deleted if you have more than this number of resources.
             * If you have fewer resources than this number, the impacted resource is not deleted.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-imagebuilder-lifecyclepolicy-filter.html#cfn-imagebuilder-lifecyclepolicy-filter-retainatleast)
             */
    ...
    public interface PolicyDetailProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param exclusionRules Additional rules to specify resources that should be exempt
             *   from policy actions.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("b2aefbdee6810949a08fbc3ec96996e7ff8320d4c8ad322f84ce069c822106be")
            override fun exclusionRules(
                exclusionRules: ExclusionRulesProperty.Builder.() -> Unit
    ...
    public interface AmiExclusionRulesProperty {
        ...
        public interface Builder {
            /**
             * @param isPublic Configures whether public AMIs are excluded from the lifecycle
             *   action.
             */
            ...
            /**
             * @param lastLaunched Specifies configuration details for Image Builder to exclude the
            ...
            /**
             * @param tagMap Lists tags that should be excluded from lifecycle actions for the AMIs
             *   that have them.
             */
            public fun tagMap(tagMap: IResolvable)
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-imagebuilder-lifecyclepolicy-amiexclusionrules.html#cfn-imagebuilder-lifecyclepolicy-amiexclusionrules-sharedaccounts)
             */
            override fun sharedAccounts(): List<String> =
                unwrap(this).getSharedAccounts() ?: emptyList()

            /**
             * Lists tags that should be excluded from lifecycle actions for the AMIs that have
             * them.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-imagebuilder-lifecyclepolicy-amiexclusionrules.html#cfn-imagebuilder-lifecyclepolicy-amiexclusionrules-tagmap)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AmiExclusionRulesProperty
            ): software.amazon.awscdk.services.imagebuilder.CfnLifecyclePolicy.AmiExclusionRulesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ExclusionRulesProperty {
        ...
        public interface Builder {
            /**
             * @param amis Lists configuration values that apply to AMIs that Image Builder should
            ...
            /**
             * @param tagMap Contains a list of tags that Image Builder uses to skip lifecycle
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ExclusionRulesProperty
            ): software.amazon.awscdk.services.imagebuilder.CfnLifecyclePolicy.ExclusionRulesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
