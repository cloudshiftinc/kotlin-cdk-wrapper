...
internal constructor(
    ...
    private class BuilderImpl(
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("efe2e93373ae65f145c25729292d629486d4800bb33842ff36705d4eb3a6cc13")
        override fun scoringStrategy(
            scoringStrategy: ScoringStrategyProperty.Builder.() -> Unit
        ): Unit = scoringStrategy(ScoringStrategyProperty(scoringStrategy))
    ...
    public interface EvaluationFormQuestionProperty {
        ...
        public interface Builder {
            /**
             * @param instructions The instructions of the section. *Length Constraints* : Minimum
             *   length of 0. Maximum length of 1024.
             */
            public fun instructions(instructions: String)

            /**
             * @param notApplicableEnabled The flag to enable not applicable answers to the
             *   question.
             */
            ...
            /**
             * @param questionType The type of the question. *Allowed values* : `NUMERIC` |
             *   `SINGLESELECT` | `TEXT`
             */
            public fun questionType(questionType: String)

            /**
             * @param questionTypeProperties The properties of the type of question. Text questions
            ...
            public fun questionTypeProperties(
                questionTypeProperties:
                    EvaluationFormQuestionTypePropertiesProperty.Builder.() -> Unit
            )
            ...
            /**
             * @param title The title of the question. *Length Constraints* : Minimum length of 1.
        ...
        private class BuilderImpl : Builder {
             ...
             *   do not have to define question type properties.
             */
            override fun questionTypeProperties(
                questionTypeProperties: EvaluationFormQuestionTypePropertiesProperty
            ) {
                cdkBuilder.questionTypeProperties(
                    questionTypeProperties.let(EvaluationFormQuestionTypePropertiesProperty::unwrap)
                )
            }
            ...
            override fun questionTypeProperties(
                ...
                questionTypeProperties(
                    EvaluationFormQuestionTypePropertiesProperty(questionTypeProperties)
                )
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: EvaluationFormQuestionProperty
            ): software.amazon.awscdk.services.connect.CfnEvaluationForm.EvaluationFormQuestionProperty =
    ...
    public interface EvaluationFormQuestionTypePropertiesProperty {
        ...
        public interface Builder {
            ...
            public fun numeric(
                numeric: EvaluationFormNumericQuestionPropertiesProperty.Builder.() -> Unit
            )
            ...
            public fun singleSelect(
                singleSelect:
                    EvaluationFormSingleSelectQuestionPropertiesProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun numeric(numeric: EvaluationFormNumericQuestionPropertiesProperty) {
                cdkBuilder.numeric(
                    numeric.let(EvaluationFormNumericQuestionPropertiesProperty::unwrap)
                )
            }
            ...
            /** @param singleSelect The properties of the numeric question. */
            override fun singleSelect(
                singleSelect: EvaluationFormSingleSelectQuestionPropertiesProperty
            ) {
                cdkBuilder.singleSelect(
                    singleSelect.let(EvaluationFormSingleSelectQuestionPropertiesProperty::unwrap)
                )
            }
            ...
            override fun singleSelect(
                ...
                singleSelect(EvaluationFormSingleSelectQuestionPropertiesProperty(singleSelect))
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: EvaluationFormQuestionTypePropertiesProperty
            ): software.amazon.awscdk.services.connect.CfnEvaluationForm.EvaluationFormQuestionTypePropertiesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface EvaluationFormItemProperty {
        ...
        private class BuilderImpl : Builder {
            ...
            override fun question(
                question: EvaluationFormQuestionProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: EvaluationFormItemProperty
            ): software.amazon.awscdk.services.connect.CfnEvaluationForm.EvaluationFormItemProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface EvaluationFormSingleSelectQuestionAutomationProperty {
        ...
        public interface Builder {
            /**
             * @param defaultOptionRefId The identifier of the default answer option, when none of
             *   the automation options match the criteria. *Length Constraints* : Minimum length
             *   of 1. Maximum length of 40.
             */
        ...
        internal constructor(
            ...
            /**
             * The identifier of the default answer option, when none of the automation options
             * match the criteria.
             *
             * *Length Constraints* : Minimum length of 1. Maximum length of 40.
             *
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: EvaluationFormSingleSelectQuestionAutomationProperty
            ): software.amazon.awscdk.services.connect.CfnEvaluationForm.EvaluationFormSingleSelectQuestionAutomationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface EvaluationFormNumericQuestionPropertiesProperty {
        ...
        public interface Builder {
            ...
            public fun automation(
                automation: EvaluationFormNumericQuestionAutomationProperty.Builder.() -> Unit
            )
        ...
        private class BuilderImpl : Builder {
            ...
            override fun automation(automation: EvaluationFormNumericQuestionAutomationProperty) {
                cdkBuilder.automation(
                    automation.let(EvaluationFormNumericQuestionAutomationProperty::unwrap)
                )
            }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: EvaluationFormNumericQuestionPropertiesProperty
            ): software.amazon.awscdk.services.connect.CfnEvaluationForm.EvaluationFormNumericQuestionPropertiesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SingleSelectQuestionRuleCategoryAutomationProperty {
         ...
         *
         * If the condition is PRESENT, then the option is applied when the contact data includes
         * the category. Similarly, if the condition is NOT_PRESENT, then the option is applied when
         * the contact data does not include the category.
         *
        ...
        public interface Builder {
            /**
             * @param category The category name, as defined in Rules. *Minimum* : 1
             *
             * *Maximum* : 50
             */
            ...
            /**
             * @param condition The condition to apply for the automation option. If the condition
             *   is PRESENT, then the option is applied when the contact data includes the category.
            ...
            /**
             * @param optionRefId The identifier of the answer option. An identifier must be unique
             *   within the question. *Length Constraints* : Minimum length of 1. Maximum length
             *   of 40.
             */
        ...
        internal constructor(
             ...
             * The condition to apply for the automation option.
             *
             * If the condition is PRESENT, then the option is applied when the contact data
             * includes the category. Similarly, if the condition is NOT_PRESENT, then the option is
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SingleSelectQuestionRuleCategoryAutomationProperty
            ): software.amazon.awscdk.services.connect.CfnEvaluationForm.SingleSelectQuestionRuleCategoryAutomationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface EvaluationFormSingleSelectQuestionPropertiesProperty {
        ...
        public interface Builder {
            ...
            public fun automation(
                automation: EvaluationFormSingleSelectQuestionAutomationProperty.Builder.() -> Unit
            )
        ...
        private class BuilderImpl : Builder {
            ...
            override fun automation(
                ...
                cdkBuilder.automation(
                    automation.let(EvaluationFormSingleSelectQuestionAutomationProperty::unwrap)
                )
            }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: EvaluationFormSingleSelectQuestionPropertiesProperty
            ): software.amazon.awscdk.services.connect.CfnEvaluationForm.EvaluationFormSingleSelectQuestionPropertiesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface EvaluationFormSingleSelectQuestionOptionProperty {
        ...
        public interface Builder {
            /**
             * @param automaticFail The flag to mark the option as automatic fail. If an automatic
            ...
            /**
             * @param refId The identifier of the answer option. An identifier must be unique within
             *   the question. *Length Constraints* : Minimum length of 1. Maximum length of 40.
             */
            public fun refId(refId: String)
            ...
            /**
             * @param text The title of the answer option. *Length Constraints* : Minimum length
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: EvaluationFormSingleSelectQuestionOptionProperty
            ): software.amazon.awscdk.services.connect.CfnEvaluationForm.EvaluationFormSingleSelectQuestionOptionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ScoringStrategyProperty {
        ...
        public interface Builder {
            /**
             * @param mode The scoring mode of the evaluation form. *Allowed values* :
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ScoringStrategyProperty
            ): software.amazon.awscdk.services.connect.CfnEvaluationForm.ScoringStrategyProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface EvaluationFormBaseItemProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: EvaluationFormBaseItemProperty
            ): software.amazon.awscdk.services.connect.CfnEvaluationForm.EvaluationFormBaseItemProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface EvaluationFormNumericQuestionOptionProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param score The score assigned to answer values within the range option. *Minimum* :
             *   0
             *
             * *Maximum* : 10
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: EvaluationFormNumericQuestionOptionProperty
            ): software.amazon.awscdk.services.connect.CfnEvaluationForm.EvaluationFormNumericQuestionOptionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface NumericQuestionPropertyValueAutomationProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: NumericQuestionPropertyValueAutomationProperty
            ): software.amazon.awscdk.services.connect.CfnEvaluationForm.NumericQuestionPropertyValueAutomationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface EvaluationFormNumericQuestionAutomationProperty {
        ...
        public interface Builder {
            ...
            public fun propertyValue(
                propertyValue: NumericQuestionPropertyValueAutomationProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun propertyValue(
                ...
                cdkBuilder.propertyValue(
                    propertyValue.let(NumericQuestionPropertyValueAutomationProperty::unwrap)
                )
            }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: EvaluationFormNumericQuestionAutomationProperty
            ): software.amazon.awscdk.services.connect.CfnEvaluationForm.EvaluationFormNumericQuestionAutomationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface EvaluationFormSingleSelectQuestionAutomationOptionProperty {
        ...
        public interface Builder {
            /**
             * @param ruleCategory The automation option based on a rule category for the single
             *   select question.
             */
            ...
            public fun ruleCategory(
                ruleCategory: SingleSelectQuestionRuleCategoryAutomationProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
             ...
             *   select question.
             */
            override fun ruleCategory(
                ruleCategory: SingleSelectQuestionRuleCategoryAutomationProperty
            ) {
                cdkBuilder.ruleCategory(
                    ruleCategory.let(SingleSelectQuestionRuleCategoryAutomationProperty::unwrap)
                )
            }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: EvaluationFormSingleSelectQuestionAutomationOptionProperty
            ): software.amazon.awscdk.services.connect.CfnEvaluationForm.EvaluationFormSingleSelectQuestionAutomationOptionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface EvaluationFormSectionProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param title The title of the section. *Length Constraints* : Minimum length of 1.
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: EvaluationFormSectionProperty
            ): software.amazon.awscdk.services.connect.CfnEvaluationForm.EvaluationFormSectionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
