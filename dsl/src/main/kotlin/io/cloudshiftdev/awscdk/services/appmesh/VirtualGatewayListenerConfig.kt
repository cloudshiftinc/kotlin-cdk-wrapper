...
public interface VirtualGatewayListenerConfig {
    ...
    public interface Builder {
        ...
        public fun listener(
            listener: CfnVirtualGateway.VirtualGatewayListenerProperty.Builder.() -> Unit
        )
    }
    ...
    private class BuilderImpl : Builder {
        ...
        override fun listener(listener: CfnVirtualGateway.VirtualGatewayListenerProperty) {
            cdkBuilder.listener(
                listener.let(CfnVirtualGateway.VirtualGatewayListenerProperty::unwrap)
            )
        }
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: VirtualGatewayListenerConfig
        ): software.amazon.awscdk.services.appmesh.VirtualGatewayListenerConfig =
