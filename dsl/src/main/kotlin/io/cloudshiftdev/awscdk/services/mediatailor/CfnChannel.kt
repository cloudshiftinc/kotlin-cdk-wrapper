...
internal constructor(
    ...
    public open fun logConfiguration(
        `value`: LogConfigurationForChannelProperty.Builder.() -> Unit
    ...
    public open fun timeShiftConfiguration(
        `value`: TimeShiftConfigurationProperty.Builder.() -> Unit
    ): Unit = timeShiftConfiguration(TimeShiftConfigurationProperty(`value`))
    ...
    public interface Builder {
        ...
        public fun logConfiguration(
            logConfiguration: LogConfigurationForChannelProperty.Builder.() -> Unit
        )
        ...
        public fun timeShiftConfiguration(
            timeShiftConfiguration: TimeShiftConfigurationProperty.Builder.() -> Unit
        )
    }
    ...
    private class BuilderImpl(
        ...
        override fun logConfiguration(logConfiguration: LogConfigurationForChannelProperty) {
            cdkBuilder.logConfiguration(
                logConfiguration.let(LogConfigurationForChannelProperty::unwrap)
            )
        }
         ...
         * @param timeShiftConfiguration The configuration for time-shifted viewing.
         */
        override fun timeShiftConfiguration(
            timeShiftConfiguration: TimeShiftConfigurationProperty
        ) {
            cdkBuilder.timeShiftConfiguration(
                timeShiftConfiguration.let(TimeShiftConfigurationProperty::unwrap)
            )
        }
        ...
        public fun build(): software.amazon.awscdk.services.mediatailor.CfnChannel =
            cdkBuilder.build()
    }
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnChannel
        ): software.amazon.awscdk.services.mediatailor.CfnChannel = wrapped.cdkObject
    }
    ...
    public interface LogConfigurationForChannelProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: LogConfigurationForChannelProperty
            ): software.amazon.awscdk.services.mediatailor.CfnChannel.LogConfigurationForChannelProperty =
    ...
    public interface TimeShiftConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param maxTimeDelaySeconds The maximum time delay for time-shifted viewing. The
             *   minimum allowed maximum time delay is 0 seconds, and the maximum allowed maximum
        ...
        internal constructor(
             ...
             * The maximum time delay for time-shifted viewing.
             *
             * The minimum allowed maximum time delay is 0 seconds, and the maximum allowed maximum
             * time delay is 21600 seconds (6 hours).
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-mediatailor-channel-timeshiftconfiguration.html#cfn-mediatailor-channel-timeshiftconfiguration-maxtimedelayseconds)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TimeShiftConfigurationProperty
            ): software.amazon.awscdk.services.mediatailor.CfnChannel.TimeShiftConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SlateSourceProperty {
        ...
        public interface Builder {
            /**
             * @param sourceLocationName The name of the source location where the slate VOD source
             *   is stored.
             */
            public fun sourceLocationName(sourceLocationName: String)

            /**
             * @param vodSourceName The slate VOD source name. The VOD source must already exist in
        ...
        internal constructor(
             ...
             * The slate VOD source name.
             *
             * The VOD source must already exist in a source location before it can be used for
             * slate.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-mediatailor-channel-slatesource.html#cfn-mediatailor-channel-slatesource-vodsourcename)
             */
    ...
    public interface HlsPlaylistSettingsProperty {
        ...
        public interface Builder {
             ...
             *   `SCTE35_ENHANCED` to use `EXT-X-CUE-OUT` and `EXT-X-CUE-IN` tags (for VOD content
             *   only).
             */
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-mediatailor-channel-hlsplaylistsettings.html#cfn-mediatailor-channel-hlsplaylistsettings-admarkuptype)
             */
            override fun adMarkupType(): List<String> =
                unwrap(this).getAdMarkupType() ?: emptyList()
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: HlsPlaylistSettingsProperty
            ): software.amazon.awscdk.services.mediatailor.CfnChannel.HlsPlaylistSettingsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DashPlaylistSettingsProperty {
        ...
        public interface Builder {
             ...
             *   player must keep available in the buffer. Minimum value: `2` seconds. Maximum
             *   value: `60` seconds.
             */
             ...
             *   should wait before requesting updates to the manifest. Minimum value: `2` seconds.
             ...
             *   should be from the live point at the end of the manifest. Minimum value: `2`
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DashPlaylistSettingsProperty
            ): software.amazon.awscdk.services.mediatailor.CfnChannel.DashPlaylistSettingsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface RequestOutputItemProperty {
        ...
        public interface Builder {
            ...
            public fun dashPlaylistSettings(
                dashPlaylistSettings: DashPlaylistSettingsProperty.Builder.() -> Unit
            )
            ...
            public fun hlsPlaylistSettings(
                hlsPlaylistSettings: HlsPlaylistSettingsProperty.Builder.() -> Unit
            )
            ...
            /**
             * @param sourceGroup A string used to match which `HttpPackageConfiguration` is used
             *   for each `VodSource` .
             */
        ...
        private class BuilderImpl : Builder {
            ...
            override fun dashPlaylistSettings(dashPlaylistSettings: DashPlaylistSettingsProperty) {
                cdkBuilder.dashPlaylistSettings(
                    dashPlaylistSettings.let(DashPlaylistSettingsProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("c7a7710c565431f307a58d27f8ce88a64ad27492db8239912d9a637e74265fe0")
            override fun dashPlaylistSettings(
                dashPlaylistSettings: DashPlaylistSettingsProperty.Builder.() -> Unit
            ...
            override fun hlsPlaylistSettings(hlsPlaylistSettings: HlsPlaylistSettingsProperty) {
                cdkBuilder.hlsPlaylistSettings(
                    hlsPlaylistSettings.let(HlsPlaylistSettingsProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("4cf35f7d5127c92b88381658a8f5a573c1972c7ba3540a432e108990d3915006")
            override fun hlsPlaylistSettings(
                hlsPlaylistSettings: HlsPlaylistSettingsProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RequestOutputItemProperty
            ): software.amazon.awscdk.services.mediatailor.CfnChannel.RequestOutputItemProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
