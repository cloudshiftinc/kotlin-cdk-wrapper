...
internal constructor(
    ...
    public interface VirtualRouterServiceProviderProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: VirtualRouterServiceProviderProperty
            ): software.amazon.awscdk.services.appmesh.CfnVirtualService.VirtualRouterServiceProviderProperty =
    ...
    public interface VirtualServiceSpecProperty {
        ...
        public interface Builder {
            /**
             * @param provider The App Mesh object that is acting as the provider for a virtual
        ...
        private class BuilderImpl : Builder {
            ...
            override fun provider(
                provider: VirtualServiceProviderProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: VirtualServiceSpecProperty
            ): software.amazon.awscdk.services.appmesh.CfnVirtualService.VirtualServiceSpecProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface VirtualServiceProviderProperty {
        ...
        public interface Builder {
            ...
            public fun virtualNode(
                virtualNode: VirtualNodeServiceProviderProperty.Builder.() -> Unit
            )
            ...
            public fun virtualRouter(
                virtualRouter: VirtualRouterServiceProviderProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun virtualRouter(virtualRouter: VirtualRouterServiceProviderProperty) {
                cdkBuilder.virtualRouter(
                    virtualRouter.let(VirtualRouterServiceProviderProperty::unwrap)
                )
            }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: VirtualServiceProviderProperty
            ): software.amazon.awscdk.services.appmesh.CfnVirtualService.VirtualServiceProviderProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface VirtualNodeServiceProviderProperty {
        ...
        public interface Builder {
            /**
             * @param virtualNodeName The name of the virtual node that is acting as a service
             *   provider.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: VirtualNodeServiceProviderProperty
            ): software.amazon.awscdk.services.appmesh.CfnVirtualService.VirtualNodeServiceProviderProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
