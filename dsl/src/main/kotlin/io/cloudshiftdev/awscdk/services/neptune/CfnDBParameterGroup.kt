...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * Changes to dynamic parameters are applied immediately. During an update, if you have
         * static parameters (whether they were changed or not), it triggers AWS CloudFormation to
         * reboot the associated DB instance without failover.
         *
