...
public enum class MetricAggregationType(
  ...
  public companion object {
    internal
        fun wrap(cdkObject: software.amazon.awscdk.services.applicationautoscaling.MetricAggregationType):
        MetricAggregationType = when (cdkObject) {
      software.amazon.awscdk.services.applicationautoscaling.MetricAggregationType.AVERAGE ->
          MetricAggregationType.AVERAGE
      software.amazon.awscdk.services.applicationautoscaling.MetricAggregationType.MINIMUM ->
          MetricAggregationType.MINIMUM
      software.amazon.awscdk.services.applicationautoscaling.MetricAggregationType.MAXIMUM ->
