...
internal constructor(
    ...
    public interface Builder {
         ...
         * The delivery policy JSON assigned to the subscription.
         *
         * Enables the subscriber to define the message delivery retry strategy in the case of an
         * HTTP/S endpoint subscribed to the topic. For more information, see
         ...
         *
         * @param filterPolicyScope This attribute lets you choose the filtering scope by using one
         *   of the following string value types:.
         */
         ...
         *
         * @param redrivePolicy When specified, sends undeliverable messages to the specified Amazon
         ...
         *
         * @param subscriptionRoleArn This property applies only to Amazon Data Firehose delivery
