...
internal constructor(
    ...
    public open fun removeSubnetIds(): List<String> =
        unwrap(this).getRemoveSubnetIds() ?: emptyList()
    ...
    /** The IDs of one or more subnets to remove. */
    public open fun removeSubnetIds(vararg `value`: String): Unit =
        removeSubnetIds(`value`.toList())
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.ec2.CfnTransitGatewayVpcAttachment.Builder.create(
                scope,
                id
            )
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnTransitGatewayVpcAttachment
