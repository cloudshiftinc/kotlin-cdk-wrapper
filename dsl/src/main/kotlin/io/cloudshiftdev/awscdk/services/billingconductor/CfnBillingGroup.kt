...
internal constructor(
    ...
    public open fun computationPreference(
        `value`: ComputationPreferenceProperty.Builder.() -> Unit
    ...
    public interface Builder {
         ...
         *
         * @param computationPreference The preferences and settings that will be used to compute
        ...
        public fun computationPreference(
            computationPreference: ComputationPreferenceProperty.Builder.() -> Unit
        )
         ...
         *
         * @param primaryAccountId The account ID that serves as the main account in a billing
         *   group.
         */
         ...
         *
         * @param tags A map that contains tag keys and tag values that are attached to a billing
         *   group.
         */
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.billingconductor.CfnBillingGroup.Builder.create(
                scope,
                id
            )
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("6561db1e7d55a9da29df832f6a8a7d91bb963600da3dcad22a13f5636bd3135b")
        override fun accountGrouping(
            accountGrouping: AccountGroupingProperty.Builder.() -> Unit
        ): Unit = accountGrouping(AccountGroupingProperty(accountGrouping))
        ...
        override fun computationPreference(computationPreference: ComputationPreferenceProperty) {
            cdkBuilder.computationPreference(
                computationPreference.let(ComputationPreferenceProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("71ad21af2f035a47eb191d558da20b163e51414aed1d111c4a8aa68982c6b191")
        override fun computationPreference(
            computationPreference: ComputationPreferenceProperty.Builder.() -> Unit
    ...
    public interface AccountGroupingProperty {
        ...
        public interface Builder {
            /**
             * @param autoAssociate Specifies if this billing group will automatically associate
             *   newly added AWS accounts that join your consolidated billing family.
             */
            ...
            /**
             * @param linkedAccountIds The account IDs that make up the billing group. Account IDs
             *   must be a part of the consolidated billing family, and not associated with another
             *   billing group.
             */
        ...
        internal constructor(
             ...
             * The account IDs that make up the billing group.
             *
             * Account IDs must be a part of the consolidated billing family, and not associated
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AccountGroupingProperty
            ): software.amazon.awscdk.services.billingconductor.CfnBillingGroup.AccountGroupingProperty =
    ...
    public interface ComputationPreferenceProperty {
        ...
        public interface Builder {
            /**
             * @param pricingPlanArn The Amazon Resource Name (ARN) of the pricing plan used to
             *   compute the AWS charges for a billing group.
             */
        ...
        internal constructor(
            ...
            /**
             * The Amazon Resource Name (ARN) of the pricing plan used to compute the AWS charges
             * for a billing group.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-billingconductor-billinggroup-computationpreference.html#cfn-billingconductor-billinggroup-computationpreference-pricingplanarn)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ComputationPreferenceProperty
            ): software.amazon.awscdk.services.billingconductor.CfnBillingGroup.ComputationPreferenceProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
