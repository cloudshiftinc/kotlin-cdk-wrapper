...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.memorydb.CfnUser,
     ...
     * the ARN of the user, such as `arn:aws:memorydb:us-east-1:123456789012:user/user1`.
     */
    ...
    public interface AuthenticationModeProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param type Indicates whether the user requires a password to authenticate. All
