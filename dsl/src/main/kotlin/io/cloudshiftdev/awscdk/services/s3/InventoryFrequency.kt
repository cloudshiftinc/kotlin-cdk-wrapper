...
public enum class InventoryFrequency(
    ...
    public companion object {
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.s3.InventoryFrequency
        ): InventoryFrequency =
            when (cdkObject) {
                software.amazon.awscdk.services.s3.InventoryFrequency.DAILY ->
                    InventoryFrequency.DAILY
                software.amazon.awscdk.services.s3.InventoryFrequency.WEEKLY ->
                    InventoryFrequency.WEEKLY
            }

        internal fun unwrap(
            wrapped: InventoryFrequency
