...
public enum class TLSSecurityPolicy(
  ...
  public companion object {
    internal fun wrap(cdkObject: software.amazon.awscdk.services.elasticsearch.TLSSecurityPolicy):
        TLSSecurityPolicy = when (cdkObject) {
    ...
    internal fun unwrap(wrapped: TLSSecurityPolicy):
