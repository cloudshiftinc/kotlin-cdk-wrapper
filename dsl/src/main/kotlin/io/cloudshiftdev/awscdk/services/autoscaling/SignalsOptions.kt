...
public interface SignalsOptions {
     ...
     *
     * If this number is less than 100, a percentage of signals may be failure signals while still
     ...
     *
     * This should reflect how long it takes your instances to start up (including instance start
     * time and instance initialization time).
     *
    ...
    public interface Builder {
        ...
        /**
         * @param timeout How long to wait for the signals to be sent. This should reflect how long
         *   it takes your instances to start up (including instance start time and instance
         *   initialization time).
         */
    ...
    internal constructor(
         ...
         * The percentage of signals that need to be successful.
         *
         * If this number is less than 100, a percentage of signals may be failure signals while
         * still succeeding the creation or update in CloudFormation.
         *
         * Default: 100
         */
         ...
         * How long to wait for the signals to be sent.
         *
         * This should reflect how long it takes your instances to start up (including instance
         * start time and instance initialization time).
         *
         * Default: Duration.minutes(5)
         */
