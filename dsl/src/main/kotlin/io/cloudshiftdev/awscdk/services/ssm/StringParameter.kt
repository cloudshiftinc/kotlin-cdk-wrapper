...
public open class StringParameter internal constructor(
  private val cdkObject: software.amazon.awscdk.services.ssm.StringParameter,
  ...
  public companion object {
    public open fun fromSecureStringParameterAttributes(
    ...
    public open fun fromStringParameterAttributes(
      scope: CloudshiftdevConstructsConstruct,
      id: String,
    ...
    public open fun fromStringParameterName(
      scope: CloudshiftdevConstructsConstruct,
      id: String,
    ...
    @Deprecated(message = "deprecated in CDK")
    public open fun valueForSecureStringParameter(
      scope: CloudshiftdevConstructsConstruct,
    ...
    public open fun valueForStringParameter(scope: CloudshiftdevConstructsConstruct,
    ...
    public open fun valueForStringParameter(
      scope: CloudshiftdevConstructsConstruct,
      parameterName: String,
      version: Number,
    ): String =
    ...
    @Deprecated(message = "deprecated in CDK")
    public open fun valueForTypedStringParameter(scope: CloudshiftdevConstructsConstruct,
        parameterName: String): String =
    ...
    @Deprecated(message = "deprecated in CDK")
    public open fun valueForTypedStringParameter(
      scope: CloudshiftdevConstructsConstruct,
      parameterName: String,
      type: ParameterType,
    ): String =
    ...
    public open fun valueForTypedStringParameterV2(scope: CloudshiftdevConstructsConstruct,
        parameterName: String): String =
    ...
    public open fun valueForTypedStringParameterV2(
      scope: CloudshiftdevConstructsConstruct,
      parameterName: String,
    ...
    public open fun valueFromLookup(scope: CloudshiftdevConstructsConstruct, parameterName: String):
        String =
