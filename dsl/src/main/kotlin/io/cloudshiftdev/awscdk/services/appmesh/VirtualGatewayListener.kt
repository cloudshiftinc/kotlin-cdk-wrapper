...
internal constructor(
    ...
    public companion object {
        public fun grpc(): VirtualGatewayListener =
            software.amazon.awscdk.services.appmesh.VirtualGatewayListener.grpc()
                .let(VirtualGatewayListener::wrap)

        public fun grpc(options: GrpcGatewayListenerOptions): VirtualGatewayListener =
            software.amazon.awscdk.services.appmesh.VirtualGatewayListener.grpc(
                    options.let(GrpcGatewayListenerOptions::unwrap)
                )
                .let(VirtualGatewayListener::wrap)
        ...
        public fun http2(
            options: Http2GatewayListenerOptions.Builder.() -> Unit
        ...
        internal fun unwrap(
            wrapped: VirtualGatewayListener
