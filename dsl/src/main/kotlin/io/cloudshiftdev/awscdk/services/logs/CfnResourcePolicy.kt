...
internal constructor(
    ...
    public interface Builder {
         ...
         * The details of the policy.
         *
         * It must be formatted in JSON, and you must use backslashes to escape characters that need
         * to be escaped in JSON strings, such as double quote marks.
         *
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.logs.CfnResourcePolicy =
            cdkBuilder.build()
    }
