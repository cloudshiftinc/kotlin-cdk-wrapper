...
public interface EbsOptions {
     ...
     * type to which it is attached. For valid values, see [EBS volume size limits]
    ...
    public interface Builder {
         ...
         *   which it is attached. For valid values, see [EBS volume size limits]
         *   (https://docs.aws.amazon.com/opensearch-service/latest/developerguide/limits.html#ebsresource)
         *   in the Amazon OpenSearch Service Developer Guide.
         */
        ...
        /**
         * @param volumeType The EBS volume type to use with the Amazon OpenSearch Service domain,
         *   such as standard, gp2, io1.
         */
    ...
    internal constructor(
         ...
         * instance type to which it is attached. For valid values, see [EBS volume size limits]
         * (https://docs.aws.amazon.com/opensearch-service/latest/developerguide/limits.html#ebsresource)
         * in the Amazon OpenSearch Service Developer Guide.
         *
         * Default: 10
        ...
        /**
         * The EBS volume type to use with the Amazon OpenSearch Service domain, such as standard,
         * gp2, io1.
         *
         * Default: gp2
         */
