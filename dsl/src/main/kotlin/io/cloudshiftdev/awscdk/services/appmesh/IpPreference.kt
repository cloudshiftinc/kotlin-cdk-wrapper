...
public enum class IpPreference(
    ...
    public companion object {
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.appmesh.IpPreference
        ): IpPreference =
            when (cdkObject) {
                software.amazon.awscdk.services.appmesh.IpPreference.IPV4_ONLY ->
                    IpPreference.IPV4_ONLY
                software.amazon.awscdk.services.appmesh.IpPreference.IPV4_PREFERRED ->
                    IpPreference.IPV4_PREFERRED
                software.amazon.awscdk.services.appmesh.IpPreference.IPV6_ONLY ->
        ...
        internal fun unwrap(
            wrapped: IpPreference
        ): software.amazon.awscdk.services.appmesh.IpPreference = wrapped.cdkObject
    }
}
