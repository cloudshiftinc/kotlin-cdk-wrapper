...
public interface ConfigSetProps {
    ...
    internal constructor(
        ...
        /** The definitions of each config set. */
        override fun configSets(): Map<String, List<String>> =
            unwrap(this).getConfigSets() ?: emptyMap()
    ...
    public companion object {
        ...
        ): ConfigSetProps = Wrapper(cdkObject)

        internal fun unwrap(
            wrapped: ConfigSetProps
        ): software.amazon.awscdk.services.ec2.ConfigSetProps = (wrapped as Wrapper).cdkObject
    }
}
