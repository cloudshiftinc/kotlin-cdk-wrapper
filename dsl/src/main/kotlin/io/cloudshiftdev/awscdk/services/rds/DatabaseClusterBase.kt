...
internal constructor(
    ...
    public override fun metricNetworkReceiveThroughput(
        props: MetricOptions.Builder.() -> Unit
    ...
    public override fun metricNetworkTransmitThroughput(
        props: MetricOptions.Builder.() -> Unit
    ...
    public override fun metricTotalBackupStorageBilled(
        props: MetricOptions.Builder.() -> Unit
