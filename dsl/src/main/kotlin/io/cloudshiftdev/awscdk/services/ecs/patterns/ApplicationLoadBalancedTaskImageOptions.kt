...
public interface ApplicationLoadBalancedTaskImageOptions {
    ...
    public interface Builder {
        /**
         * @param command The command that's passed to the container. If there are multiple
         *   arguments, make sure that each argument is a separated string in the array.
         *
         * This parameter maps to `Cmd` in the
         * [Create a container](https://docs.docker.com/engine/api/v1.38/#operation/ContainerCreate)
         * section of the [Docker Remote API](https://docs.docker.com/engine/api/v1.38/) and the
        ...
        /**
         * @param taskRole The name of the task IAM role that grants containers in the task
    ...
    internal constructor(
         ...
         * The command that's passed to the container.
         *
         * If there are multiple arguments, make sure that each argument is a separated string in
         * the array.
         *
         * This parameter maps to `Cmd` in the
         * [Create a container](https://docs.docker.com/engine/api/v1.38/#operation/ContainerCreate)
        ...
        /**
         * The name of the task execution IAM role that grants the Amazon ECS container agent
         * permission to call AWS APIs on your behalf.
         *
         * Default: - No value
         */
        ...
        /**
         * The name of the task IAM role that grants containers in the task permission to call AWS
         * APIs on your behalf.
         *
         * Default: - A task role is automatically created for you.
         */
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: ApplicationLoadBalancedTaskImageOptions
        ): software.amazon.awscdk.services.ecs.patterns.ApplicationLoadBalancedTaskImageOptions =
