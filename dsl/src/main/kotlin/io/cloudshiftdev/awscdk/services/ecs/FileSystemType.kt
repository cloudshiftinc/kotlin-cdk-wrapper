...
public enum class FileSystemType(
    ...
    public companion object {
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.ecs.FileSystemType
        ): FileSystemType =
            when (cdkObject) {
        ...
        internal fun unwrap(
            wrapped: FileSystemType
        ): software.amazon.awscdk.services.ecs.FileSystemType = wrapped.cdkObject
    }
}
