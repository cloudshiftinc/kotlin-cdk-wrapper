...
internal constructor(
    ...
    /**
     * The time the vehicle model was created, in seconds since epoch (January 1, 1970 at midnight
     * UTC time).
     */
    ...
    public interface Builder {
         ...
         * (Optional) The state of the vehicle model.
         *
         * If the status is `ACTIVE` , the vehicle model can't be edited. If the status is `DRAFT` ,
