...
public interface CodeConfig {
    ...
    private class BuilderImpl : Builder {
        ...
        public fun build(): software.amazon.awscdk.services.codecommit.CodeConfig =
            cdkBuilder.build()
    }
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CodeConfig
        ): software.amazon.awscdk.services.codecommit.CodeConfig = (wrapped as Wrapper).cdkObject
    }
}
