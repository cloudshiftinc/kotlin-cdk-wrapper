...
public open class Secret internal constructor(
  ...
  public companion object {
    public open fun fromSecretAttributes(
    ...
    public open fun fromSecretCompleteArn(
      scope: CloudshiftdevConstructsConstruct,
      id: String,
    ...
    public open fun fromSecretNameV2(
      scope: CloudshiftdevConstructsConstruct,
      id: String,
      secretName: String,
    ): ISecret =
    ...
    public open fun fromSecretPartialArn(
      scope: CloudshiftdevConstructsConstruct,
      id: String,
    ...
    public open fun isSecret(x: Any): Boolean =
