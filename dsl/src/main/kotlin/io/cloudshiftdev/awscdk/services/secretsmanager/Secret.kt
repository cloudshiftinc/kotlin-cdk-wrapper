...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.secretsmanager.Secret,
     ...
     * @param options
     */
    public override fun addRotationSchedule(
        id: String,
        options: RotationScheduleOptions
    ): RotationSchedule =
        unwrap(this)
            .addRotationSchedule(id, options.let(RotationScheduleOptions::unwrap))
            .let(RotationSchedule::wrap)
    ...
    public override fun addRotationSchedule(
        id: String,
        options: RotationScheduleOptions.Builder.() -> Unit
    ): RotationSchedule = addRotationSchedule(id, RotationScheduleOptions(options))

    /**
     * Adds a statement to the IAM resource policy associated with this secret.
     *
     * If this secret was created in this stack, a resource policy will be automatically created
     * upon the first call to `addToResourcePolicy`. If the secret is imported, then this is a
     * no-op.
     *
     * @param statement
     */
     ...
     *
     * Will return the full ARN if available, otherwise a partial arn. For secrets imported by the
     * deprecated `fromSecretName`, it will return the `secretName`.
     */
    ...
    public interface Builder {
         ...
         *
         * Default: - 32 characters with upper-case letters, lower-case letters, punctuation and
         * numbers (at least one from each category), per the default values of
        ...
        public fun generateSecretString(
            generateSecretString: SecretStringGenerator.Builder.() -> Unit
        )
         ...
         *
         * Note that deleting secrets from SecretsManager does not happen immediately, but after a 7
         * to 30 days blackout period. During that period, it is not possible to create another
         ...
         *
         * **NOTE:** *It is **highly** encouraged to leave this field undefined and allow
         * SecretsManager to create the secret value. The secret object -- if provided -- will be
         * included in the output of the cdk as part of synthesis, and will appear in the
         * CloudFormation template in the console. This can be secure(-ish) if that value is merely
         * reference to another resource (or one of its attributes), but if the value is a plaintext
         * string, it will be visible to anyone with access to the CloudFormation template (via the
         * AWS Console, SDKs, or CLI).
         *
         * Specifies a JSON object that you want to encrypt and store in this new version of the
         * secret. To specify a simple string value instead, use `SecretProps.secretStringValue`
         *
         ...
         *
         * **NOTE:** *It is **highly** encouraged to leave this field undefined and allow
         * SecretsManager to create the secret value. The secret string -- if provided -- will be
         * included in the output of the cdk as part of synthesis, and will appear in the
         * CloudFormation template in the console. This can be secure(-ish) if that value is merely
         * reference to another resource (or one of its attributes), but if the value is a plaintext
         * string, it will be visible to anyone with access to the CloudFormation template (via the
    ...
    private class BuilderImpl(
        ...
        override fun secretObjectValue(secretObjectValue: Map<String, SecretValue>) {
            cdkBuilder.secretObjectValue(
                secretObjectValue.mapValues { SecretValue.unwrap(it.value) }
            )
        }
        ...
        public fun build(): software.amazon.awscdk.services.secretsmanager.Secret =
            cdkBuilder.build()
    }
    ...
    public companion object {
        public fun fromSecretAttributes(
            ...
            software.amazon.awscdk.services.secretsmanager.Secret.fromSecretAttributes(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    attrs.let(SecretAttributes::unwrap)
                )
                .let(ISecret::wrap)
        ...
        public fun fromSecretCompleteArn(
            ...
            software.amazon.awscdk.services.secretsmanager.Secret.fromSecretCompleteArn(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    secretCompleteArn
                )
        ...
        public fun fromSecretNameV2(
            ...
            software.amazon.awscdk.services.secretsmanager.Secret.fromSecretNameV2(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    secretName
                )
        ...
        public fun fromSecretPartialArn(
            ...
            software.amazon.awscdk.services.secretsmanager.Secret.fromSecretPartialArn(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    secretPartialArn
                )
        ...
        ): Secret = Secret(cdkObject)

        internal fun unwrap(
            wrapped: Secret
        ): software.amazon.awscdk.services.secretsmanager.Secret = wrapped.cdkObject
    }
}
