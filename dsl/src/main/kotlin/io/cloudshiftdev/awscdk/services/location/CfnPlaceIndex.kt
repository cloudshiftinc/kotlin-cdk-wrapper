...
internal constructor(
    ...
    public interface Builder {
         ...
         *   [Esri details on geocoding coverage](https://docs.aws.amazon.com/https://developers.arcgis.com/rest/geocode/api-reference/geocode-coverage.htm)
         *   .
         ...
         *   ' coverage in your region of interest, see
         *   [HERE details on goecoding coverage](https://docs.aws.amazon.com/https://developer.here.com/documentation/geocoder/dev_guide/topics/coverage-geocoder.html)
         *   .
         *
         ...
         * [AWS Service Terms](https://docs.aws.amazon.com/service-terms/) for Amazon Location
         * Service.
         *
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.location.CfnPlaceIndex =
            cdkBuilder.build()
    }
    ...
    public interface DataSourceConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param intendedUse Specifies how the results of an operation will be stored by the
             *   caller. Valid values include:
             * * `SingleUse` specifies that the results won't be stored.
             * * `Storage` specifies that the result can be cached or stored in a database.
             *
             * Default value: `SingleUse`
