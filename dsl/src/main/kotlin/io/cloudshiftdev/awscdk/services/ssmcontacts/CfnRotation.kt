...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param contactIds The Amazon Resource Names (ARNs) of the contacts to add to the
         *   rotation.
         */
         ...
         *
         * @param recurrence Information about the rule that specifies when shift team members
         *   rotate.
         */
         ...
         * [Time Zone Database](https://docs.aws.amazon.com/https://www.iana.org/time-zones) on the
         * IANA website.
         *
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.ssmcontacts.CfnRotation =
            cdkBuilder.build()
    }
    ...
    public interface MonthlySettingProperty {
        ...
        public interface Builder {
            /**
             * @param dayOfMonth The day of the month when monthly recurring on-call rotations
             *   begin.
             */
            public fun dayOfMonth(dayOfMonth: Number)

            /**
             * @param handOffTime The time of day when a monthly recurring on-call shift rotation
             *   begins.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: MonthlySettingProperty
            ): software.amazon.awscdk.services.ssmcontacts.CfnRotation.MonthlySettingProperty =
    ...
    public interface WeeklySettingProperty {
        ...
        public interface Builder {
            /**
             * @param dayOfWeek The day of the week when weekly recurring on-call shift rotations
             *   begins.
             */
            public fun dayOfWeek(dayOfWeek: String)

            /**
             * @param handOffTime The time of day when a weekly recurring on-call shift rotation
             *   begins.
             */
            public fun handOffTime(handOffTime: String)
        }
    ...
    public interface RecurrenceSettingsProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param numberOfOnCalls The number of contacts, or shift team members designated to be
             *   on call concurrently during a shift. For example, in an on-call schedule that
             *   contains ten contacts, a value of `2` designates that two of them are on call at
             *   any given time.
             */
            public fun numberOfOnCalls(numberOfOnCalls: Number)

            /**
             * @param recurrenceMultiplier The number of days, weeks, or months a single rotation
             *   lasts.
             */
            public fun recurrenceMultiplier(recurrenceMultiplier: Number)

            /**
             * @param shiftCoverages Information about the days of the week included in on-call
             *   rotation coverage.
             */
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ssmcontacts-rotation-recurrencesettings.html#cfn-ssmcontacts-rotation-recurrencesettings-dailysettings)
             */
            override fun dailySettings(): List<String> =
                unwrap(this).getDailySettings() ?: emptyList()
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RecurrenceSettingsProperty
            ): software.amazon.awscdk.services.ssmcontacts.CfnRotation.RecurrenceSettingsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
