...
public interface ClusterAttributes {
     ...
     */
    public fun awscliLayer(): ILayerVersion? =
     ...
     */
    public fun kubectlEnvironment(): Map<String, String> =
     ...
     */
    public fun kubectlPrivateSubnetIds(): List<String> =
     ...
     *
     * Default: - if not specified, it not be possible to issue `kubectl` commands against an
     * imported cluster.
     */
     ...
     *
     * Default: - if not specified, no additional security groups will be considered in
     * `cluster.connections`.
     */
    ...
    public interface Builder {
        /**
         * @param awscliLayer An AWS Lambda layer that contains the `aws` CLI. The handler expects
         *   the layer to include the following executables:
         * ```
         * /opt/awscli/aws
         * ```
         */
         ...
         *   Handler's Lambdas. The Cluster Handler's Lambdas are responsible for calling AWS's EKS
         *   API.
         */
        ...
        /**
         * @param clusterSecurityGroupId The cluster security group that was created by Amazon EKS
         *   for the cluster.
         */
        ...
        /**
         * @param kubectlEnvironment Environment variables to use when running `kubectl` against
         *   this cluster.
         */
        ...
        /**
         * @param kubectlLayer An AWS Lambda Layer which includes `kubectl` and Helm. This layer is
         *   used by the kubectl handler to apply manifests and install helm charts. You must pick
         *   an appropriate releases of one of the `&#64;aws-cdk/layer-kubectl-vXX` packages, that
         *   works with the version of Kubernetes you have chosen. If you don't supply this value
         *   `kubectl` 1.20 will be used, but that version is most likely too old.
         *
         * The handler expects the layer to include the following executables:
         * ```
        ...
        /**
         * @param openIdConnectProvider An Open ID Connect provider for this cluster that can be
         *   used to configure service accounts. You can either import an existing provider using
         ...
         *   automatically pruned. When this is enabled (default), prune labels will be allocated
         *   and injected to each resource. These labels will then be used when issuing the `kubectl
    ...
    private class BuilderImpl : Builder {
        ...
        override fun openIdConnectProvider(openIdConnectProvider: IOpenIdConnectProvider) {
            cdkBuilder.openIdConnectProvider(
                openIdConnectProvider.let(IOpenIdConnectProvider::unwrap)
            )
        }
        ...
        public fun build(): software.amazon.awscdk.services.eks.ClusterAttributes =
            cdkBuilder.build()
    }
    ...
    internal constructor(
         ...
         * Default: - no additional variables
         */
        override fun kubectlEnvironment(): Map<String, String> =
            unwrap(this).getKubectlEnvironment() ?: emptyMap()
         ...
         * Default: - if not specified, the default role created by a lambda function will be used.
         */
        override fun kubectlLambdaRole(): IRole? =
         ...
         * Default: - k8s endpoint is expected to be accessible publicly
         */
        override fun kubectlPrivateSubnetIds(): List<String> =
            unwrap(this).getKubectlPrivateSubnetIds() ?: emptyList()
        ...
        /**
         * An Open ID Connect provider for this cluster that can be used to configure service
         * accounts.
         *
         ...
         * eks.OpenIdConnectProvider`
         *
         * Default: - if not specified `cluster.openIdConnectProvider` and
         * `cluster.addServiceAccount` will throw an error.
         */
