...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.s3outposts.CfnAccessPoint,
    ...
    public interface Builder {
         ...
         *
         * @param bucket The Amazon Resource Name (ARN) of the S3 on Outposts bucket that is
    ...
    public interface VpcConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param vpcId Virtual Private Cloud (VPC) Id from which AccessPoint will allow
             *   requests.
             */
