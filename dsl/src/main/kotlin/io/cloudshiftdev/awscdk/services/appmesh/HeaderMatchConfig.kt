...
public interface HeaderMatchConfig {
    ...
    private class BuilderImpl : Builder {
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("c27a7fcd39f5eb13fc38f4a7eecc86d2b2eeccb91d1c9f490d650243ee950559")
        override fun headerMatch(
            headerMatch: CfnRoute.HttpRouteHeaderProperty.Builder.() -> Unit
        ): Unit = headerMatch(CfnRoute.HttpRouteHeaderProperty(headerMatch))
