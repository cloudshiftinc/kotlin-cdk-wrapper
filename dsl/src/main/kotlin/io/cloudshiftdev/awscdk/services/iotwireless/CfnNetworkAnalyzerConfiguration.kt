...
internal constructor(
    ...
    public open fun wirelessDevices(): List<String> =
        unwrap(this).getWirelessDevices() ?: emptyList()
    ...
    /** Wireless device resources to add to the network analyzer configuration. */
    public open fun wirelessDevices(vararg `value`: String): Unit =
        wirelessDevices(`value`.toList())

    /** Wireless gateway resources to add to the network analyzer configuration. */
    public open fun wirelessGateways(): List<String> =
        unwrap(this).getWirelessGateways() ?: emptyList()
    ...
    public interface Builder {
         ...
         *
         * @param traceContent Trace content for your wireless gateway and wireless device
         *   resources.
         */
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnNetworkAnalyzerConfiguration
        ): software.amazon.awscdk.services.iotwireless.CfnNetworkAnalyzerConfiguration =
            wrapped.cdkObject
    }
    ...
    public interface TraceContentProperty {
        ...
        public interface Builder {
            /**
             * @param logLevel The log level for a log message. The log levels can be disabled, or
             *   set to `ERROR` to display less verbose logs containing only error information, or
             *   to `INFO` for more detailed logs
             */
            public fun logLevel(logLevel: String)

            /**
             * @param wirelessDeviceFrameInfo `FrameInfo` of your wireless device resources for the
             *   trace content. Use FrameInfo to debug the communication between your LoRaWAN end
        ...
        internal constructor(
             ...
             * The log level for a log message.
             *
             * The log levels can be disabled, or set to `ERROR` to display less verbose logs
             * containing only error information, or to `INFO` for more detailed logs
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-iotwireless-networkanalyzerconfiguration-tracecontent.html#cfn-iotwireless-networkanalyzerconfiguration-tracecontent-loglevel)
             */
             ...
             * `FrameInfo` of your wireless device resources for the trace content.
             *
             * Use FrameInfo to debug the communication between your LoRaWAN end devices and the
             * network server.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-iotwireless-networkanalyzerconfiguration-tracecontent.html#cfn-iotwireless-networkanalyzerconfiguration-tracecontent-wirelessdeviceframeinfo)
             */
            override fun wirelessDeviceFrameInfo(): String? =
