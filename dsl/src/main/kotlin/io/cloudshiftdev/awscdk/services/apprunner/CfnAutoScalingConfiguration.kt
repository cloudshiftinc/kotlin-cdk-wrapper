...
internal constructor(
     ...
     *
     * It's set to false otherwise. App Runner temporarily doubles the number of provisioned
     ...
     * [io.cloudshiftdev.awscdk.services.apprunner.CfnAutoScalingConfiguration].
     */
    @CdkDslMarker
    public interface Builder {
         ...
         *
         * @param autoScalingConfigurationName The customer-provided auto scaling configuration
         *   name.
         */
         ...
         * The maximum number of concurrent requests that an instance processes.
         *
         * If the number of concurrent requests exceeds this limit, App Runner scales the service
         * up.
         *
         ...
         *
         * @param maxConcurrency The maximum number of concurrent requests that an instance
         *   processes.
         */
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.apprunner.CfnAutoScalingConfiguration.Builder.create(
                scope,
                id
            )
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnAutoScalingConfiguration
