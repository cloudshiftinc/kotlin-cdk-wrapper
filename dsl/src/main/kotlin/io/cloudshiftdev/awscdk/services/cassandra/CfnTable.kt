...
internal constructor(
    ...
    public open fun autoScalingSpecifications(`value`: AutoScalingSpecificationProperty) {
        unwrap(this)
            .setAutoScalingSpecifications(`value`.let(AutoScalingSpecificationProperty::unwrap))
    }

    /** The optional auto scaling capacity settings for a table in provisioned capacity mode. */
    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("c2130607010229356c6ba6443cdde6ad00f73c7283b808f06a148ca0a6b41056")
    public open fun autoScalingSpecifications(
        `value`: AutoScalingSpecificationProperty.Builder.() -> Unit
    ...
    public open fun encryptionSpecification(`value`: EncryptionSpecificationProperty) {
        unwrap(this)
            .setEncryptionSpecification(`value`.let(EncryptionSpecificationProperty::unwrap))
    }

    /** The encryption at rest options for the table. */
    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("e766c2ecd0ddb7d8f1a183745a554c829bd9b747013a5954c5622a546f71ab55")
    public open fun encryptionSpecification(
        `value`: EncryptionSpecificationProperty.Builder.() -> Unit
    ): Unit = encryptionSpecification(EncryptionSpecificationProperty(`value`))
    ...
    public open fun pointInTimeRecoveryEnabled(): Any? =
    ...
    public interface Builder {
         ...
         *
         * @param autoScalingSpecifications The optional auto scaling capacity settings for a table
        ...
        public fun autoScalingSpecifications(
            autoScalingSpecifications: AutoScalingSpecificationProperty.Builder.() -> Unit
        )

        /**
         * The billing mode for the table, which determines how you'll be charged for reads and
         * writes:.
         * * *On-demand mode* (default) - You pay based on the actual reads and writes your
         *   application performs.
         * * *Provisioned mode* - Lets you specify the number of reads and writes per second that
         ...
         *
         * @param billingMode The billing mode for the table, which determines how you'll be charged
         ...
         * Enables client-side timestamps for the table.
         *
         * By default, the setting is disabled. You can enable client-side timestamps with the
         * following option:
         * * `status: "enabled"`
         *
         ...
         *
         * @param clusteringKeyColumns One or more columns that determine how the table data is
         *   sorted.
         */
         ...
         * The default Time To Live (TTL) value for all rows in a table in seconds.
         *
         * The maximum configurable value is 630,720,000 seconds, which is the equivalent of 20
         * years. By default, the TTL value for a table is 0, which means data does not expire.
         *
        ...
        public fun encryptionSpecification(
            encryptionSpecification: EncryptionSpecificationProperty.Builder.() -> Unit
        )
         ...
         *
         * @param partitionKeyColumns One or more columns that uniquely identify every row in the
         *   table.
         */
         ...
         * Specifies if point-in-time recovery is enabled or disabled for the table.
         *
         * The options are `PointInTimeRecoveryEnabled=true` and `PointInTimeRecoveryEnabled=false`
         ...
         *
         * @param pointInTimeRecoveryEnabled Specifies if point-in-time recovery is enabled or
         ...
         * *not* defined as partition key columns or clustering key columns.
         *
         ...
         * The name of the table to be created.
         *
         * The table name is case sensitive. If you don't specify a name, AWS CloudFormation
         ...
         * .
         *
         * If you specify a name, you can't perform updates that require replacing this resource.
         * You can perform updates that require no interruption or some interruption. If you must
    ...
    private class BuilderImpl(
         ...
         *   in provisioned capacity mode.
         */
        override fun autoScalingSpecifications(
            autoScalingSpecifications: AutoScalingSpecificationProperty
        ) {
            cdkBuilder.autoScalingSpecifications(
                autoScalingSpecifications.let(AutoScalingSpecificationProperty::unwrap)
            )
        }
        ...
        override fun clientSideTimestampsEnabled(clientSideTimestampsEnabled: IResolvable) {
            cdkBuilder.clientSideTimestampsEnabled(
                clientSideTimestampsEnabled.let(IResolvable::unwrap)
            )
        }
         ...
         * @param encryptionSpecification The encryption at rest options for the table.
         */
        override fun encryptionSpecification(
            encryptionSpecification: EncryptionSpecificationProperty
        ) {
            cdkBuilder.encryptionSpecification(
                encryptionSpecification.let(EncryptionSpecificationProperty::unwrap)
            )
        }
    ...
    public interface ScalingPolicyProperty {
        ...
        public interface Builder {
            /**
             * @param targetTrackingScalingPolicyConfiguration The auto scaling policy that scales a
             *   table based on the ratio of consumed to provisioned capacity.
             */
    ...
    public interface ClusteringKeyColumnProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ClusteringKeyColumnProperty
            ): software.amazon.awscdk.services.cassandra.CfnTable.ClusteringKeyColumnProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface BillingModeProperty {
        ...
        public interface Builder {
             ...
             * * Provisioned mode - `PROVISIONED`
             *
             * If you choose `PROVISIONED` mode, then you also need to specify provisioned
             * throughput (read and write capacity) for the table.
             *
             * Valid values: `ON_DEMAND` | `PROVISIONED`
             */
    ...
    public interface AutoScalingSpecificationProperty {
        ...
        public interface Builder {
            /**
             * @param readCapacityAutoScaling The auto scaling settings for the table's read
             *   capacity.
             */
            ...
            public fun readCapacityAutoScaling(
                readCapacityAutoScaling: AutoScalingSettingProperty.Builder.() -> Unit
            )

            /**
             * @param writeCapacityAutoScaling The auto scaling settings for the table's write
             *   capacity.
             */
            ...
            public fun writeCapacityAutoScaling(
                writeCapacityAutoScaling: AutoScalingSettingProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
             ...
             *   capacity.
             */
            override fun readCapacityAutoScaling(
                readCapacityAutoScaling: AutoScalingSettingProperty
            ) {
                cdkBuilder.readCapacityAutoScaling(
                    readCapacityAutoScaling.let(AutoScalingSettingProperty::unwrap)
                )
            }
            ...
            override fun writeCapacityAutoScaling(writeCapacityAutoScaling: IResolvable) {
                cdkBuilder.writeCapacityAutoScaling(
                    writeCapacityAutoScaling.let(IResolvable::unwrap)
                )
            }
             ...
             *   capacity.
             */
            override fun writeCapacityAutoScaling(
                writeCapacityAutoScaling: AutoScalingSettingProperty
            ) {
                cdkBuilder.writeCapacityAutoScaling(
                    writeCapacityAutoScaling.let(AutoScalingSettingProperty::unwrap)
                )
            }
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-cassandra-table-autoscalingspecification.html#cfn-cassandra-table-autoscalingspecification-writecapacityautoscaling)
             */
            override fun writeCapacityAutoScaling(): Any? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AutoScalingSpecificationProperty
            ): software.amazon.awscdk.services.cassandra.CfnTable.AutoScalingSpecificationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface TargetTrackingScalingPolicyConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param disableScaleIn Specifies if `scale-in` is enabled. When auto scaling
             *   automatically decreases capacity for a table, the table *scales in* . When scaling
            ...
            /**
             * @param scaleInCooldown Specifies a `scale-in` cool down period. A cooldown period in
             *   seconds between scaling activities that lets the table stabilize before another
             *   scaling activity starts.
             */
            public fun scaleInCooldown(scaleInCooldown: Number)

            /**
             * @param scaleOutCooldown Specifies a scale out cool down period. A cooldown period in
             *   seconds between scaling activities that lets the table stabilize before another
             *   scaling activity starts.
             */
            ...
            /**
             * @param targetValue Specifies the target value for the target tracking auto scaling
             *   policy. Amazon Keyspaces auto scaling scales up capacity automatically when traffic
             ...
             *   stays at or near this value. You define `targetValue` as a percentage. An `integer`
             *   between 20 and 90.
             */
        ...
        internal constructor(
             ...
             * this value. You define `targetValue` as a percentage. An `integer` between 20 and 90.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-cassandra-table-targettrackingscalingpolicyconfiguration.html#cfn-cassandra-table-targettrackingscalingpolicyconfiguration-targetvalue)
             */
    ...
    public interface ReplicaSpecificationProperty {
        ...
        /**
         * The provisioned read capacity units for the multi-Region table in the specified AWS
         * Region.
         *
        ...
        public interface Builder {
            /**
             * @param readCapacityAutoScaling The read capacity auto scaling settings for the
             *   multi-Region table in the specified AWS Region.
             */
            public fun readCapacityAutoScaling(readCapacityAutoScaling: IResolvable)
            ...
            /**
             * @param readCapacityUnits The provisioned read capacity units for the multi-Region
    ...
    public interface EncryptionSpecificationProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: EncryptionSpecificationProperty
            ): software.amazon.awscdk.services.cassandra.CfnTable.EncryptionSpecificationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface AutoScalingSettingProperty {
         ...
         *
         * With this policy, Amazon Keyspaces auto scaling ensures that the table's ratio of
         * consumed to provisioned capacity stays at or near the target value that you specify. You
        ...
        public interface Builder {
            /**
             * @param autoScalingDisabled This optional parameter enables auto scaling for the table
             *   if set to `false` .
             */
             ...
             *   provision. The value must be between 1 and the max throughput per second quota for
             *   your account (40,000 by default).
             */
            public fun maximumUnits(maximumUnits: Number)

            /**
             * @param minimumUnits The minimum level of throughput the table should always be ready
            ...
            /**
             * @param scalingPolicy Amazon Keyspaces supports the `target tracking` auto scaling
             ...
             *   you specify. You define the target value as a percentage between 20 and 90.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("53d2bbef462e8fe3680a3f07236b4bd7c8adab847dcbe52a82a427c23baadb48")
            override fun scalingPolicy(
                scalingPolicy: ScalingPolicyProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             *
             * With this policy, Amazon Keyspaces auto scaling ensures that the table's ratio of
             * consumed to provisioned capacity stays at or near the target value that you specify.
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AutoScalingSettingProperty
            ): software.amazon.awscdk.services.cassandra.CfnTable.AutoScalingSettingProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ProvisionedThroughputProperty {
        ...
        public interface Builder {
            /**
             * @param readCapacityUnits The amount of read capacity that's provisioned for the
             *   table. For more information, see
             *   [Read/write capacity mode](https://docs.aws.amazon.com/keyspaces/latest/devguide/ReadWriteCapacityMode.html)
             *   in the *Amazon Keyspaces Developer Guide* .
             */
            ...
            /**
             * @param writeCapacityUnits The amount of write capacity that's provisioned for the
             *   table. For more information, see
             *   [Read/write capacity mode](https://docs.aws.amazon.com/keyspaces/latest/devguide/ReadWriteCapacityMode.html)
             *   in the *Amazon Keyspaces Developer Guide* .
             */
