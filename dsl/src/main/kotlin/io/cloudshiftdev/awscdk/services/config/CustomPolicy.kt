...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.config.CustomPolicy,
    ...
    public interface Builder {
         ...
         * Default: false
         *
         * @param enableDebugLog The boolean expression for enabling debug logging for your AWS
    ...
    public companion object {
        public fun fromConfigRuleName(
            ...
            software.amazon.awscdk.services.config.CustomPolicy.fromConfigRuleName(
        ...
        ): CustomPolicy = CustomPolicy(cdkObject)

        internal fun unwrap(
            wrapped: CustomPolicy
        ): software.amazon.awscdk.services.config.CustomPolicy = wrapped.cdkObject
    }
}
