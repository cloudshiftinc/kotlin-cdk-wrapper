...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * This domain name must be owned by this account (registered through Route53), or delegated
         * to this account. Domain ownership will be verified by AWS before private DNS can be used.
         *
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.route53.VpcEndpointServiceDomainName.Builder.create(
                scope,
                id
            )
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: VpcEndpointServiceDomainName
