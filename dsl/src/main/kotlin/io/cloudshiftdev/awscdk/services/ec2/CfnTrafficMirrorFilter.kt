...
internal constructor(
    ...
    public open fun networkServices(): List<String> =
        unwrap(this).getNetworkServices() ?: emptyList()
    ...
    /** The network service traffic that is associated with the Traffic Mirror filter. */
    public open fun networkServices(vararg `value`: String): Unit =
        networkServices(`value`.toList())
    ...
    public interface Builder {
         ...
         *
         * @param networkServices The network service traffic that is associated with the Traffic
         *   Mirror filter.
         */
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnTrafficMirrorFilter
