...
internal constructor(
     ...
     * [io.cloudshiftdev.awscdk.services.servicecatalog.CfnLaunchRoleConstraint].
     */
    @CdkDslMarker
    public interface Builder {
        ...
        /**
         * You are required to specify either the `RoleArn` or the `LocalRoleName` but can't use
         * both.
         *
         ...
         *
         * @param localRoleName You are required to specify either the `RoleArn` or the
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.servicecatalog.CfnLaunchRoleConstraint.Builder.create(
                scope,
                id
            )
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnLaunchRoleConstraint
