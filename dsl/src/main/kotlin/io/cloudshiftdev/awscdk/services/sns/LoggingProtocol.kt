...
public enum class LoggingProtocol(
    ...
    public companion object {
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.sns.LoggingProtocol
        ): LoggingProtocol =
            when (cdkObject) {
                ...
                software.amazon.awscdk.services.sns.LoggingProtocol.FIREHOSE ->
                    LoggingProtocol.FIREHOSE
                software.amazon.awscdk.services.sns.LoggingProtocol.APPLICATION ->
                    LoggingProtocol.APPLICATION
            }

        internal fun unwrap(
            wrapped: LoggingProtocol
