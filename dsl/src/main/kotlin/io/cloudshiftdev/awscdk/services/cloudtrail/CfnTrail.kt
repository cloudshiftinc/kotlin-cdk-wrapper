...
internal constructor(
    ...
    /**
     * `Ref` returns the ARN of the Amazon SNS topic that's associated with the CloudTrail trail,
     ...
     */
    public open fun cloudWatchLogsLogGroupArn(): String? =
     ...
     * files.
     */
    public open fun includeGlobalServiceEvents(): Any? =
    ...
    public interface Builder {
         ...
         *
         * @param cloudWatchLogsRoleArn Specifies the role for the CloudWatch Logs endpoint to
         ...
         * one hour. CloudTrail does not create digest files for log files that were delivered
         ...
         *
         * @param enableLogFileValidation Specifies whether log file validation is enabled. The
         *   default is false.
         */
         ...
         * read and write management events, and no data events. When an event occurs in your
         ...
         *
         * @param eventSelectors Use event selectors to further specify the management and data
         *   event settings for your trail.
         */
         ...
         *
         * @param insightSelectors A JSON string that contains the Insights types you want to log on
         *   a trail.
         */
         ...
         * Specifies whether the trail applies only to the current Region or to all Regions.
         *
         * The default is false. If the trail exists only in the current Region and this value is
         * set to true, shadow trails (replications of the trail) will be created in the other
         ...
         *
         * @param isMultiRegionTrail Specifies whether the trail applies only to the current Region
         *   or to all Regions.
         */
         ...
         * Organizations , or only for the current AWS account .
         *
         * The default is false, and cannot be true unless the call is made on behalf of an AWS
         * account that is the management account for an organization in AWS Organizations . If the
         * trail is not an organization trail and this is set to `true` , the trail will be created
         * in all AWS accounts that belong to the organization. If the trail is an organization
         * trail and this is set to `false` , the trail will remain in the current AWS account but
         ...
         *
         * @param snsTopicName Specifies the name of the Amazon SNS topic defined for notification
    ...
    private class BuilderImpl(
        ...
        override fun includeGlobalServiceEvents(includeGlobalServiceEvents: IResolvable) {
            cdkBuilder.includeGlobalServiceEvents(
                includeGlobalServiceEvents.let(IResolvable::unwrap)
            )
        }
    ...
    public companion object {
        ...
        ): CfnTrail = CfnTrail(cdkObject)

        internal fun unwrap(
            wrapped: CfnTrail
        ): software.amazon.awscdk.services.cloudtrail.CfnTrail = wrapped.cdkObject
    }
    ...
    public interface AdvancedEventSelectorProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param name An optional, descriptive name for an advanced event selector, such as
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AdvancedEventSelectorProperty
            ): software.amazon.awscdk.services.cloudtrail.CfnTrail.AdvancedEventSelectorProperty =
    ...
    public interface EventSelectorProperty {
         ...
         *
         * In this release, the list can be empty (disables the filter), or it can filter out AWS
         * Key Management Service or Amazon RDS Data API events by containing `kms.amazonaws.com` or
         * `rdsdata.amazonaws.com` . By default, `ExcludeManagementEventSources` is empty, and AWS
         * KMS and Amazon RDS Data API events are logged to your trail. You can exclude management
         ...
         * [AWS CloudTrail Pricing](https://docs.aws.amazon.com/cloudtrail/pricing/) .
         *
        ...
        public interface Builder {
            /**
             * @param dataResources CloudTrail supports data event logging for Amazon S3 objects,
             *   AWS Lambda functions, and Amazon DynamoDB tables with basic event selectors. You
             *   can specify up to 250 resources for an individual event selector, but the total
            ...
            /**
             * @param excludeManagementEventSources An optional list of service event sources from
             *   which you do not want management events to be logged on your trail. In this
             *   release, the list can be empty (disables the filter), or it can filter out AWS Key
             *   Management Service or Amazon RDS Data API events by containing `kms.amazonaws.com`
             *   or `rdsdata.amazonaws.com` . By default, `ExcludeManagementEventSources` is empty,
             *   and AWS KMS and Amazon RDS Data API events are logged to your trail. You can
             ...
             *   management events for your trail. For more information, see
             *   [Management Events](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/logging-management-events-with-cloudtrail.html)
             *   in the *AWS CloudTrail User Guide* .
             *
             * By default, the value is `true` .
             *
             * The first copy of management events is free. You are charged for additional copies of
             * management events that you are logging on any subsequent trail in the same Region.
            ...
            /**
             * @param readWriteType Specify if you want your trail to log read-only events,
             *   write-only events, or all. For example, the EC2 `GetConsoleOutput` is a read-only
        ...
        private class BuilderImpl : Builder {
             ...
             *   exclude management event sources only in Regions that support the event source.
             */
            override fun excludeManagementEventSources(
             ...
             */
            override fun excludeManagementEventSources(
                vararg excludeManagementEventSources: String
            ): Unit = excludeManagementEventSources(excludeManagementEventSources.toList())
        ...
        internal constructor(
            ...
            /**
             * CloudTrail supports data event logging for Amazon S3 objects, AWS Lambda functions,
             * and Amazon DynamoDB tables with basic event selectors.
             *
             * You can specify up to 250 resources for an individual event selector, but the total
             * number of data resources cannot exceed 250 across all event selectors in a trail.
             * This limit does not apply if you configure resource logging for all data events.
             ...
             *
             * In this release, the list can be empty (disables the filter), or it can filter out
             * AWS Key Management Service or Amazon RDS Data API events by containing
             * `kms.amazonaws.com` or `rdsdata.amazonaws.com` . By default,
             * `ExcludeManagementEventSources` is empty, and AWS KMS and Amazon RDS Data API events
             * are logged to your trail. You can exclude management event sources only in Regions
    ...
    public interface AdvancedFieldSelectorProperty {
         ...
         *
         * For event data stores for CloudTrail Insights events, AWS Config configuration items,
         * Audit Manager evidence, or events outside of AWS , the field is used only for selecting
         ...
         *
         * For event data stores for CloudTrail Insights events, AWS Config configuration items,
         * Audit Manager evidence, or events outside of AWS , the only supported field is
         * `eventCategory` .
         ...
         *   the type you've speciﬁed in the template as the value of resources.type. For example,
         *   if resources.type equals `AWS::S3::Object` , the ARN must be in one of the following
         *   formats. To log all data events for all objects in a specific S3 bucket, use the
         ...
         *
         * When resources.type equals `AWS::DynamoDB::Table` , and the operator is set to `Equals`
         ...
         *
         * When resources.type equals `AWS::Cassandra::Table` , and the operator is set to `Equals`
         * or `NotEquals` , the ARN must be in the following format:
         * *
         ...
         *
         * When resources.type equals `AWS::CodeWhisperer::Customization` , and the operator is set
         ...
         *
         * When `resources.type` equals `AWS::EC2::Snapshot` , and the operator is set to `Equals`
         * or `NotEquals` , the ARN must be in the following format:
         ...
         *
         * When `resources.type` equals `AWS::KendraRanking::ExecutionPlan` , and the operator is
         * set to `Equals` or `NotEquals` , the ARN must be in the following format:
         * *
         ...
         *
         * When `resources.type` equals `AWS::ManagedBlockchain::Network` , and the operator is set
         * to `Equals` or `NotEquals` , the ARN must be in the following format:
         ...
         *
         * When `resources.type` equals `AWS::MedicalImaging::Datastore` , and the operator is set
         * to `Equals` or `NotEquals` , the ARN must be in the following format:
         * *
         ...
         *
         * When `resources.type` equals `AWS::PCAConnectorAD::Connector` , and the operator is set
         * to `Equals` or `NotEquals` , the ARN must be in the following format:
         * *
         ...
         *
         * When `resources.type` equals `AWS::RDS::DBCluster` , and the operator is set to `Equals`
         * or `NotEquals` , the ARN must be in the following format:
         * * `arn:&lt;partition&gt;:rds:&lt;region&gt;:&lt;account_ID&gt;:cluster/&lt;cluster_name&gt;`
         *
         * When `resources.type` equals `AWS::S3::AccessPoint` , and the operator is set to `Equals`
         * or `NotEquals` , the ARN must be in one of the following formats. To log events on all
         * objects in an S3 access point, we recommend that you use only the access point ARN, don’t
         ...
         *
         * When `resources.type` equals `AWS::SCN::Instance` , and the operator is set to `Equals`
         * or `NotEquals` , the ARN must be in the following format:
         ...
         *
         * When `resources.type` equals `AWS::ServiceDiscovery::Service` , and the operator is set
         * to `Equals` or `NotEquals` , the ARN must be in the following format:
         * *
        ...
        public interface Builder {
            /**
             * @param endsWith An operator that includes events that match the last few characters
            ...
            /**
             * @param equalTo An operator that includes events that match the exact value of the
             *   event record field specified as the value of `Field` . This is the only valid
            ...
            /**
             * @param field A field in a CloudTrail event record on which to filter events to be
             *   logged. For event data stores for CloudTrail Insights events, AWS Config
             *   configuration items, Audit Manager evidence, or events outside of AWS , the field
             *   is used only for selecting events as filtering is not supported.
             *
             ...
             * Audit Manager evidence, or events outside of AWS , the only supported field is
             * `eventCategory` .
             * * *`readOnly`* - Optional. Can be set to `Equals` a value of `true` or `false` . If
             *   you do not add this field, CloudTrail logs both `read` and `write` events. A value
             ...
             * * *`eventName`* - Can use any operator. You can use it to ﬁlter in or ﬁlter out any
             *   data event logged to CloudTrail, such as `PutBucket` or `GetSnapshotBlock` . You
             ...
             * * `AWS::VerifiedPermissions::PolicyStore`
             *
             * You can have only one `resources.type` ﬁeld per selector. To log data events on more
             ...
             *   following formats. To log all data events for all objects in a specific S3 bucket,
             *   use the `StartsWith` operator, and include only the bucket ARN as the matching
             *   value.
             *
             ...
             * `arn:&lt;partition&gt;:lambda:&lt;region&gt;:&lt;account_ID&gt;:function:&lt;function_name&gt;`
             *
             * When resources.type equals `AWS::AppConfig::Configuration` , and the operator is set
             * to `Equals` or `NotEquals` , the ARN must be in the following format:
             * *
             * `arn:&lt;partition&gt;:appconfig:&lt;region&gt;:&lt;account_ID&gt;:application/&lt;application_ID&gt;/environment/&lt;environment_ID&gt;/configuration/&lt;configuration_profile_ID&gt;`
             *
             ...
             * `arn:&lt;partition&gt;:cassandra:&lt;region&gt;:&lt;account_ID&gt;:/keyspace/&lt;keyspace_name&gt;/table/&lt;table_name&gt;`
             *
             * When resources.type equals `AWS::CloudFront::KeyValueStore` , and the operator is set
             * to `Equals` or `NotEquals` , the ARN must be in the following format:
             * *
             * `arn:&lt;partition&gt;:cloudfront:&lt;region&gt;:&lt;account_ID&gt;:key-value-store/&lt;KVS_name&gt;`
             *
             ...
             * `arn:&lt;partition&gt;:glue:&lt;region&gt;:&lt;account_ID&gt;:table/&lt;database_name&gt;/&lt;table_name&gt;`
             *
             * When `resources.type` equals `AWS::GreengrassV2::ComponentVersion` , and the operator
             ...
             * `arn:&lt;partition&gt;:iotsitewise:&lt;region&gt;:&lt;account_ID&gt;:asset/&lt;asset_ID&gt;`
             *
             * When `resources.type` equals `AWS::IoTSiteWise::TimeSeries` , and the operator is set
             * to `Equals` or `NotEquals` , the ARN must be in the following format:
             * *
             * `arn:&lt;partition&gt;:iotsitewise:&lt;region&gt;:&lt;account_ID&gt;:timeseries/&lt;timeseries_ID&gt;`
             *
             ...
             * `arn:&lt;partition&gt;:iottwinmaker:&lt;region&gt;:&lt;account_ID&gt;:workspace/&lt;workspace_ID&gt;/entity/&lt;entity_ID&gt;`
             *
             * When `resources.type` equals `AWS::IoTTwinMaker::Workspace` , and the operator is set
             * to `Equals` or `NotEquals` , the ARN must be in the following format:
             * *
             * `arn:&lt;partition&gt;:iottwinmaker:&lt;region&gt;:&lt;account_ID&gt;:workspace/&lt;workspace_ID&gt;`
             *
             ...
             * `arn:&lt;partition&gt;:scn:&lt;region&gt;:&lt;account_ID&gt;:instance/&lt;instance_ID&gt;`
             *
             * When `resources.type` equals `AWS::ServiceDiscovery::Namespace` , and the operator is
             * set to `Equals` or `NotEquals` , the ARN must be in the following format:
             * *
             * `arn:&lt;partition&gt;:servicediscovery:&lt;region&gt;:&lt;account_ID&gt;:namespace/&lt;namespace_ID&gt;`
             *
             ...
             * `arn:&lt;partition&gt;:thinclient:&lt;region&gt;:&lt;account_ID&gt;:device/&lt;device_ID&gt;`
             *
             * When `resources.type` equals `AWS::ThinClient::Environment` , and the operator is set
             * to `Equals` or `NotEquals` , the ARN must be in the following format:
             * *
             * `arn:&lt;partition&gt;:thinclient:&lt;region&gt;:&lt;account_ID&gt;:environment/&lt;environment_ID&gt;`
             *
             ...
             * `arn:&lt;partition&gt;:timestream:&lt;region&gt;:&lt;account_ID&gt;:database/&lt;database_name&gt;/table/&lt;table_name&gt;`
             *
             * When resources.type equals `AWS::VerifiedPermissions::PolicyStore` , and the operator
             * is set to `Equals` or `NotEquals` , the ARN must be in the following format:
             * *
             * `arn:&lt;partition&gt;:verifiedpermissions:&lt;region&gt;:&lt;account_ID&gt;:policy-store/&lt;policy_store_UUID&gt;`
             */
            ...
            /**
             * @param notEndsWith An operator that excludes events that match the last few
             *   characters of the event record field specified as the value of `Field` .
             */
            ...
            /**
             * @param notEquals An operator that excludes events that match the exact value of the
            ...
            /**
             * @param notStartsWith An operator that excludes events that match the first few
             *   characters of the event record field specified as the value of `Field` .
             */
            ...
            /**
             * @param startsWith An operator that includes events that match the first few
             *   characters of the event record field specified as the value of `Field` .
             */
        ...
        private class BuilderImpl : Builder {
             ...
             *   characters of the event record field specified as the value of `Field` .
             */
            override fun notEndsWith(vararg notEndsWith: String): Unit =
                notEndsWith(notEndsWith.toList())
             ...
             *   characters of the event record field specified as the value of `Field` .
             */
            override fun startsWith(vararg startsWith: String): Unit =
                startsWith(startsWith.toList())
        ...
        internal constructor(
             ...
             *
             * For event data stores for CloudTrail Insights events, AWS Config configuration items,
             * Audit Manager evidence, or events outside of AWS , the field is used only for
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-cloudtrail-trail-advancedfieldselector.html#cfn-cloudtrail-trail-advancedfieldselector-notstartswith)
             */
            override fun notStartsWith(): List<String> =
                unwrap(this).getNotStartsWith() ?: emptyList()
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AdvancedFieldSelectorProperty
            ): software.amazon.awscdk.services.cloudtrail.CfnTrail.AdvancedFieldSelectorProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DataResourceProperty {
         ...
         * account , even if that activity is performed on a function that belongs to another AWS
         * account .
        ...
        public interface Builder {
            /**
             * @param type The resource type in which you want to log data events. You can specify
            ...
            /**
             * @param values An array of Amazon Resource Name (ARN) strings or partial ARN strings
             ...
             *
             * This also enables logging of `Invoke` activity performed by any user or role in your
             * AWS account , even if that activity is performed on a function that belongs to
             * another AWS account .
             * * To log data events for a specific Lambda function, specify the function ARN.
             *
             * Lambda function ARNs are exact. For example, if you specify a function ARN
             * *arn:aws:lambda:us-west-2:111111111111:function:helloworld* , data events will only
             * be logged for *arn:aws:lambda:us-west-2:111111111111:function:helloworld* . They will
    ...
    public interface InsightSelectorProperty {
        ...
        public interface Builder {
            /**
             * @param insightType The type of Insights events to log on a trail.
             ...
             *   are aggregated per minute against a baseline API call volume.
             *
             * The `ApiErrorRateInsight` Insights type analyzes management API calls that result in
             * error codes. The error is shown if the API call is unsuccessful.
             */
        ...
        internal constructor(
             ...
             * `ApiErrorRateInsight` are valid Insight types.
             *
             * The `ApiCallRateInsight` Insights type analyzes write-only management API calls that
             * are aggregated per minute against a baseline API call volume.
             *
             * The `ApiErrorRateInsight` Insights type analyzes management API calls that result in
             * error codes. The error is shown if the API call is unsuccessful.
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: InsightSelectorProperty
            ): software.amazon.awscdk.services.cloudtrail.CfnTrail.InsightSelectorProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
