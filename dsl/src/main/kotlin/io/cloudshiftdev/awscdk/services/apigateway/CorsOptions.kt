...
public interface CorsOptions {
     ...
     * response to frontend JavaScript code when the request's credentials mode
     * (Request.credentials) is "include".
     *
     * When a request's credentials mode (Request.credentials) is "include", browsers will only
     * expose the response to frontend JavaScript code if the Access-Control-Allow-Credentials value
     * is true.
     *
     ...
     *
     * Responses will include the `Access-Control-Allow-Origin` response header. If
     * `Cors.ALL_ORIGINS` is specified, the `Vary: Origin` response header will also be included.
     *
     ...
     *
     * Default: - only the 6 CORS-safelisted response headers are exposed: Cache-Control,
    ...
    public interface Builder {
        /**
         * @param allowCredentials The Access-Control-Allow-Credentials response header tells
         *   browsers whether to expose the response to frontend JavaScript code when the request's
         *   credentials mode (Request.credentials) is "include". When a request's credentials mode
         *   (Request.credentials) is "include", browsers will only expose the response to frontend
        ...
        /**
         * @param allowHeaders The Access-Control-Allow-Headers response header is used in response
         *   to a preflight request which includes the Access-Control-Request-Headers to indicate
        ...
        /**
         * @param allowMethods The Access-Control-Allow-Methods response header specifies the method
         *   or methods allowed when accessing the resource in response to a preflight request. If
         *   `ANY` is specified, it will be expanded to `Cors.ALL_METHODS`.
         */
        ...
        /**
         * @param allowOrigins Specifies the list of origins that are allowed to make requests to
         *   this resource. If you wish to allow all origins, specify `Cors.ALL_ORIGINS` or `[ * ]`.
         *
         * Responses will include the `Access-Control-Allow-Origin` response header. If
         * `Cors.ALL_ORIGINS` is specified, the `Vary: Origin` response header will also be
         * included.
         */
        ...
        /**
         * @param disableCache Sets Access-Control-Max-Age to -1, which means that caching is
         *   disabled. This option cannot be used with `maxAge`.
         */
         ...
         *   headers can be exposed as part of the response by listing their names. If you want
        ...
        /**
         * @param maxAge The Access-Control-Max-Age response header indicates how long the results
    ...
    private class BuilderImpl : Builder {
        ...
        public fun build(): software.amazon.awscdk.services.apigateway.CorsOptions =
            cdkBuilder.build()
    }
    ...
    internal constructor(
         ...
         *
         * When a request's credentials mode (Request.credentials) is "include", browsers will only
         * expose the response to frontend JavaScript code if the Access-Control-Allow-Credentials
         * value is true.
         *
         * Credentials are cookies, authorization headers or TLS client certificates.
         *
         ...
         * request which includes the Access-Control-Request-Headers to indicate which HTTP headers
