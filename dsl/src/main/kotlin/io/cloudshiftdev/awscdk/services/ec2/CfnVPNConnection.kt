...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param customerGatewayId The ID of the customer gateway at your end of the VPN
         *   connection.
         */
    ...
    private class BuilderImpl(
        ...
        override fun vpnTunnelOptionsSpecifications(vpnTunnelOptionsSpecifications: IResolvable) {
            cdkBuilder.vpnTunnelOptionsSpecifications(
                vpnTunnelOptionsSpecifications.let(IResolvable::unwrap)
            )
        }
        ...
        override fun vpnTunnelOptionsSpecifications(
            vararg vpnTunnelOptionsSpecifications: Any
        ): Unit = vpnTunnelOptionsSpecifications(vpnTunnelOptionsSpecifications.toList())

        public fun build(): software.amazon.awscdk.services.ec2.CfnVPNConnection =
            cdkBuilder.build()
    }
    ...
    public interface VpnTunnelOptionsSpecificationProperty {
        ...
        public interface Builder {
            /**
             * @param preSharedKey The pre-shared key (PSK) to establish initial authentication
             *   between the virtual private gateway and customer gateway. Constraints: Allowed
             *   characters are alphanumeric characters, periods (.), and underscores (_). Must be
             *   between 8 and 64 characters in length and cannot start with zero (0).
             */
            public fun preSharedKey(preSharedKey: String)

            /**
             * @param tunnelInsideCidr The range of inside IP addresses for the tunnel. Any
             *   specified CIDR blocks must be unique across all VPN connections that use the same
             *   virtual private gateway.
             *
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: VpnTunnelOptionsSpecificationProperty
            ): software.amazon.awscdk.services.ec2.CfnVPNConnection.VpnTunnelOptionsSpecificationProperty =
