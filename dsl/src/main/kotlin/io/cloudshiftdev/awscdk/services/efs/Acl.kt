...
public interface Acl {
    ...
    public interface Builder {
        /**
         * @param ownerGid Specifies the POSIX group ID to apply to the RootDirectory. Accepts
    ...
    public companion object {
        ...
        internal fun unwrap(wrapped: Acl): software.amazon.awscdk.services.efs.Acl =
