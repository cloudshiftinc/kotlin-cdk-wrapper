...
internal constructor(
    ...
    public open fun streamSpecification(
        `value`: StreamSpecificationProperty.Builder.() -> Unit
    ): Unit = streamSpecification(StreamSpecificationProperty(`value`))
    ...
    public open fun timeToLiveSpecification(`value`: TimeToLiveSpecificationProperty) {
        unwrap(this)
            .setTimeToLiveSpecification(`value`.let(TimeToLiveSpecificationProperty::unwrap))
    }

    /** Specifies the time to live (TTL) settings for the table. */
    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("e0d141a1a82665304a3e8c5b6a1c8076cffe3aa870ce7b93244d0485db3f9474")
    public open fun timeToLiveSpecification(
        `value`: TimeToLiveSpecificationProperty.Builder.() -> Unit
    ): Unit = timeToLiveSpecification(TimeToLiveSpecificationProperty(`value`))
    ...
    /** Specifies an auto scaling policy for write capacity. */
    public open fun writeProvisionedThroughputSettings(
        `value`: WriteProvisionedThroughputSettingsProperty
    ) {
        unwrap(this)
            .setWriteProvisionedThroughputSettings(
                `value`.let(WriteProvisionedThroughputSettingsProperty::unwrap)
            )
    }
    ...
    public open fun writeProvisionedThroughputSettings(
        `value`: WriteProvisionedThroughputSettingsProperty.Builder.() -> Unit
    ): Unit =
        writeProvisionedThroughputSettings(WriteProvisionedThroughputSettingsProperty(`value`))
    ...
    public interface Builder {
         ...
         *
         * @param attributeDefinitions A list of attributes that describe the key schema for the
         *   global table and indexes.
         */
         ...
         * `PROVISIONED` billing mode, you must provide an auto scaling configuration via the
         ...
         *
         * @param billingMode Specifies how you are charged for read and write throughput and how
         *   you manage capacity. Valid values are:.
         */
         ...
         * Global secondary indexes to be created on the global table.
         *
         * You can create up to 20 global secondary indexes. Each replica in your global table will
         * have the same global secondary index settings. You can only create or delete one global
         ...
         * Local secondary indexes to be created on the table.
         *
         * You can create up to five local secondary indexes. Each index is scoped to a given hash
         * key value. The size of each hash key can be up to 10 gigabytes. Each replica in your
         * global table will have the same local secondary index settings.
         *
         ...
         * Specifies the list of replicas for your global table.
         *
         * The list must contain at least one element, the region where the stack defining the
         * global table is deployed. For example, if you define your table in a stack deployed to
         * us-east-1, you must have an entry in `Replicas` with the region us-east-1. You cannot
         * remove the replica in the stack region.
         *
         ...
         *
         * If you add or delete a replica during an update, we recommend that you don't update any
         * other resources. If your stack fails to update and is rolled back while adding a new
         ...
         * Specifies the settings to enable server-side encryption.
         *
         * These settings will be applied to all replicas. If you plan to use customer-managed KMS
         * keys, you must provide a key for each replica using the
         ...
         * replica. You can only change the streams settings if your global table has only one
         * replica.
         *
        ...
        public fun streamSpecification(
            streamSpecification: StreamSpecificationProperty.Builder.() -> Unit
        )

        /**
         * A name for the global table.
         *
         * If you don't specify a name, AWS CloudFormation generates a unique ID and uses that ID as
         * the table name. For more information, see
        ...
        public fun timeToLiveSpecification(
            timeToLiveSpecification: TimeToLiveSpecificationProperty.Builder.() -> Unit
        )
        ...
        public fun writeProvisionedThroughputSettings(
            writeProvisionedThroughputSettings: IResolvable
        )
        ...
        public fun writeProvisionedThroughputSettings(
            writeProvisionedThroughputSettings:
                WriteProvisionedThroughputSettingsProperty.Builder.() -> Unit
        )
    }
    ...
    private class BuilderImpl(
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("3e3c60a5a5edef59c4aa4f7708c0e3623743921725f05f2842958316e110b799")
        override fun sseSpecification(
            sseSpecification: SSESpecificationProperty.Builder.() -> Unit
        ...
        override fun streamSpecification(streamSpecification: StreamSpecificationProperty) {
            cdkBuilder.streamSpecification(
                streamSpecification.let(StreamSpecificationProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("bf76fd13563ee3ad08063f4ca6555e20c9c41a98390d54479d39d86db66f0d08")
        override fun streamSpecification(
            streamSpecification: StreamSpecificationProperty.Builder.() -> Unit
         ...
         * @param timeToLiveSpecification Specifies the time to live (TTL) settings for the table.
         */
        override fun timeToLiveSpecification(
            timeToLiveSpecification: TimeToLiveSpecificationProperty
        ) {
            cdkBuilder.timeToLiveSpecification(
                timeToLiveSpecification.let(TimeToLiveSpecificationProperty::unwrap)
            )
        }
         ...
         *   capacity.
         */
        override fun writeProvisionedThroughputSettings(
            writeProvisionedThroughputSettings: IResolvable
        ) {
            cdkBuilder.writeProvisionedThroughputSettings(
                writeProvisionedThroughputSettings.let(IResolvable::unwrap)
            )
        }
        ...
        override fun writeProvisionedThroughputSettings(
            ...
            cdkBuilder.writeProvisionedThroughputSettings(
                writeProvisionedThroughputSettings.let(
                    WriteProvisionedThroughputSettingsProperty::unwrap
                )
            )
        }
        ...
        public fun build(): software.amazon.awscdk.services.dynamodb.CfnGlobalTable =
            cdkBuilder.build()
    }
    ...
    public interface TargetTrackingScalingPolicyConfigurationProperty {
        ...
        public interface Builder {
             ...
             *   policy is disabled. The default value is `false` .
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TargetTrackingScalingPolicyConfigurationProperty
            ): software.amazon.awscdk.services.dynamodb.CfnGlobalTable.TargetTrackingScalingPolicyConfigurationProperty =
    ...
    public interface TimeToLiveSpecificationProperty {
         ...
         * In order to do so, you must first disable time to live, and then re-enable it with the
         * new attribute name. It can take up to one hour for changes to time to live to take
        ...
        public interface Builder {
            /**
             * @param attributeName The name of the attribute used to store the expiration time for
             *   items in the table. Currently, you cannot directly change the attribute name used
             *   to evaluate time to live. In order to do so, you must first disable time to live,
             *   and then re-enable it with the new attribute name. It can take up to one hour for
             *   changes to time to live to take effect. If you attempt to modify time to live
             *   within that time window, your stack operation might be delayed.
             */
            public fun attributeName(attributeName: String)

            /**
             * @param enabled Indicates whether TTL is to be enabled (true) or disabled (false) on
             *   the table.
             */
        ...
        internal constructor(
             ...
             * live. In order to do so, you must first disable time to live, and then re-enable it
             * with the new attribute name. It can take up to one hour for changes to time to live
             * to take effect. If you attempt to modify time to live within that time window, your
             * stack operation might be delayed.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-dynamodb-globaltable-timetolivespecification.html#cfn-dynamodb-globaltable-timetolivespecification-attributename)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TimeToLiveSpecificationProperty
            ): software.amazon.awscdk.services.dynamodb.CfnGlobalTable.TimeToLiveSpecificationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ProjectionProperty {
         ...
         * the local secondary indexes, must not exceed 100. If you project the same attribute into
         ...
         */
        public fun nonKeyAttributes(): List<String> =
        ...
        public interface Builder {
            /**
             * @param nonKeyAttributes Represents the non-key attribute names which will be
             *   projected into the index. For local secondary indexes, the total count of
             *   `NonKeyAttributes` summed across all of the local secondary indexes, must not
             *   exceed 100. If you project the same attribute into two different indexes, this
        ...
        internal constructor(
             ...
             * of the local secondary indexes, must not exceed 100. If you project the same
    ...
    public interface StreamSpecificationProperty {
        ...
        public interface Builder {
            /**
             * @param streamViewType When an item in the table is modified, `StreamViewType`
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: StreamSpecificationProperty
            ): software.amazon.awscdk.services.dynamodb.CfnGlobalTable.StreamSpecificationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CapacityAutoScalingSettingsProperty {
        ...
        /**
         * When switching billing mode from `PAY_PER_REQUEST` to `PROVISIONED` , DynamoDB requires
         * you to specify read and write capacity unit values for the table and for each global
         * secondary index.
         *
         ...
         *
         * If you want to switch a table's billing mode from `PAY_PER_REQUEST` to `PROVISIONED` ,
         * you must specify a value for this property for each autoscaled resource. If you specify
         * different values for the same resource in different regions, CloudFormation will use the
         * highest value found in either the `SeedCapacity` or `ReadCapacityUnits` properties. For
         * example, if your global secondary index `myGSI` has a `SeedCapacity` of 10 in us-east-1
         * and a fixed `ReadCapacityUnits` of 20 in eu-west-1, CloudFormation will initially set the
         * read capacity for `myGSI` to 20. Note that if you disable `ScaleIn` for `myGSI` in
         * us-east-1, its read capacity units might not be set back to 10.
         *
         * You must also specify a value for `SeedCapacity` when you plan to switch a table's
         * billing mode from `PROVISIONED` to `PAY_PER_REQUEST` , because CloudFormation might need
         * to roll back the operation (reverting the billing mode to `PROVISIONED` ) and this cannot
         * succeed without specifying a value for `SeedCapacity` .
         *
        ...
        public interface Builder {
            ...
            /**
             * @param seedCapacity When switching billing mode from `PAY_PER_REQUEST` to
             *   `PROVISIONED` , DynamoDB requires you to specify read and write capacity unit
             *   values for the table and for each global secondary index. These values will be
             ...
             *   CloudFormation cannot determine what capacity the table and its global secondary
             *   indexes will require in this time period, since they are application-dependent.
             *
             * If you want to switch a table's billing mode from `PAY_PER_REQUEST` to `PROVISIONED`
             * , you must specify a value for this property for each autoscaled resource. If you
             * specify different values for the same resource in different regions, CloudFormation
             * will use the highest value found in either the `SeedCapacity` or `ReadCapacityUnits`
             * properties. For example, if your global secondary index `myGSI` has a `SeedCapacity`
             * of 10 in us-east-1 and a fixed `ReadCapacityUnits` of 20 in eu-west-1, CloudFormation
             * will initially set the read capacity for `myGSI` to 20. Note that if you disable
             * `ScaleIn` for `myGSI` in us-east-1, its read capacity units might not be set back
             * to 10.
             *
             * You must also specify a value for `SeedCapacity` when you plan to switch a table's
             * billing mode from `PROVISIONED` to `PAY_PER_REQUEST` , because CloudFormation might
             * need to roll back the operation (reverting the billing mode to `PROVISIONED` ) and
             * this cannot succeed without specifying a value for `SeedCapacity` .
             */
            public fun seedCapacity(seedCapacity: Number)

            /**
             * @param targetTrackingScalingPolicyConfiguration Defines a target tracking scaling
             *   policy.
             */
            ...
            public fun targetTrackingScalingPolicyConfiguration(
                targetTrackingScalingPolicyConfiguration:
                    TargetTrackingScalingPolicyConfigurationProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun targetTrackingScalingPolicyConfiguration(
                ...
                cdkBuilder.targetTrackingScalingPolicyConfiguration(
                    targetTrackingScalingPolicyConfiguration.let(IResolvable::unwrap)
                )
            }
            ...
            override fun targetTrackingScalingPolicyConfiguration(
                ...
                cdkBuilder.targetTrackingScalingPolicyConfiguration(
                    targetTrackingScalingPolicyConfiguration.let(
                        TargetTrackingScalingPolicyConfigurationProperty::unwrap
                    )
                )
            }
        ...
        internal constructor(
            ...
            /**
             * When switching billing mode from `PAY_PER_REQUEST` to `PROVISIONED` , DynamoDB
             * requires you to specify read and write capacity unit values for the table and for
             * each global secondary index.
             *
             * These values will be applied to all replicas. The table will use these provisioned
             * values until CloudFormation creates the autoscaling policies you configured in your
             * template. CloudFormation cannot determine what capacity the table and its global
             * secondary indexes will require in this time period, since they are
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CapacityAutoScalingSettingsProperty
            ): software.amazon.awscdk.services.dynamodb.CfnGlobalTable.CapacityAutoScalingSettingsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ReplicaSpecificationProperty {
         ...
         *
         * When enabled, the table cannot be deleted by any user or process. This setting is
        ...
        public interface Builder {
            /**
             * @param contributorInsightsSpecification The settings used to enable or disable
             *   CloudWatch Contributor Insights for the specified replica. When not specified,
             *   defaults to contributor insights disabled for the replica.
             */
            public fun contributorInsightsSpecification(
                contributorInsightsSpecification: IResolvable
            )
            ...
            public fun contributorInsightsSpecification(
                contributorInsightsSpecification:
                    ContributorInsightsSpecificationProperty.Builder.() -> Unit
            )
            ...
            /**
             * @param globalSecondaryIndexes Defines additional settings for the global secondary
             *   indexes of this replica.
             */
            public fun globalSecondaryIndexes(globalSecondaryIndexes: IResolvable)
            ...
            /**
             * @param kinesisStreamSpecification Defines the Kinesis Data Streams configuration for
            ...
            public fun kinesisStreamSpecification(
                kinesisStreamSpecification: KinesisStreamSpecificationProperty.Builder.() -> Unit
            )

            /**
             * @param pointInTimeRecoverySpecification The settings used to enable point in time
             *   recovery. When not specified, defaults to point in time recovery disabled for the
             *   replica.
             */
            public fun pointInTimeRecoverySpecification(
                pointInTimeRecoverySpecification: IResolvable
            )
            ...
            public fun pointInTimeRecoverySpecification(
                pointInTimeRecoverySpecification:
                    PointInTimeRecoverySpecificationProperty.Builder.() -> Unit
            )

            /**
             * @param readProvisionedThroughputSettings Defines read capacity settings for the
             *   replica table.
             */
            public fun readProvisionedThroughputSettings(
                readProvisionedThroughputSettings: IResolvable
            )
            ...
            public fun readProvisionedThroughputSettings(
                readProvisionedThroughputSettings:
                    ReadProvisionedThroughputSettingsProperty.Builder.() -> Unit
            )
             ...
             *   When using customer-managed keys for server-side encryption, this property must
             *   have a value in all replicas.
             */
            public fun sseSpecification(sseSpecification: IResolvable)
            ...
            public fun sseSpecification(
                sseSpecification: ReplicaSSESpecificationProperty.Builder.() -> Unit
            )

            /**
             * @param tableClass The table class of the specified table. Valid values are `STANDARD`
             *   and `STANDARD_INFREQUENT_ACCESS` .
             */
            public fun tableClass(tableClass: String)

            /**
             * @param tags An array of key-value pairs to apply to this replica. For more
             *   information, see
             *   [Tag](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-resource-tags.html)
             *   .
             */
        ...
        private class BuilderImpl : Builder {
             ...
             *   defaults to contributor insights disabled for the replica.
             */
            override fun contributorInsightsSpecification(
                contributorInsightsSpecification: IResolvable
            ) {
                cdkBuilder.contributorInsightsSpecification(
                    contributorInsightsSpecification.let(IResolvable::unwrap)
                )
            }
            ...
            override fun contributorInsightsSpecification(
                ...
                cdkBuilder.contributorInsightsSpecification(
                    contributorInsightsSpecification.let(
                        ContributorInsightsSpecificationProperty::unwrap
                    )
                )
            }
            ...
            override fun contributorInsightsSpecification(
                ...
                contributorInsightsSpecification(
                    ContributorInsightsSpecificationProperty(contributorInsightsSpecification)
                )
            ...
            override fun deletionProtectionEnabled(deletionProtectionEnabled: IResolvable) {
                cdkBuilder.deletionProtectionEnabled(
                    deletionProtectionEnabled.let(IResolvable::unwrap)
                )
            }
            ...
            override fun kinesisStreamSpecification(kinesisStreamSpecification: IResolvable) {
                cdkBuilder.kinesisStreamSpecification(
                    kinesisStreamSpecification.let(IResolvable::unwrap)
                )
            }
             ...
             *   the specified replica.
             */
            override fun kinesisStreamSpecification(
                kinesisStreamSpecification: KinesisStreamSpecificationProperty
            ) {
                cdkBuilder.kinesisStreamSpecification(
                    kinesisStreamSpecification.let(KinesisStreamSpecificationProperty::unwrap)
                )
            }
            ...
            override fun kinesisStreamSpecification(
                ...
                kinesisStreamSpecification(
                    KinesisStreamSpecificationProperty(kinesisStreamSpecification)
                )
             ...
             *   replica.
             */
            override fun pointInTimeRecoverySpecification(
                pointInTimeRecoverySpecification: IResolvable
            ) {
                cdkBuilder.pointInTimeRecoverySpecification(
                    pointInTimeRecoverySpecification.let(IResolvable::unwrap)
                )
            }
            ...
            override fun pointInTimeRecoverySpecification(
                ...
                cdkBuilder.pointInTimeRecoverySpecification(
                    pointInTimeRecoverySpecification.let(
                        PointInTimeRecoverySpecificationProperty::unwrap
                    )
                )
            }
             ...
             *   replica table.
             */
            override fun readProvisionedThroughputSettings(
                readProvisionedThroughputSettings: IResolvable
            ) {
                cdkBuilder.readProvisionedThroughputSettings(
                    readProvisionedThroughputSettings.let(IResolvable::unwrap)
                )
            }
            ...
            override fun readProvisionedThroughputSettings(
                ...
                cdkBuilder.readProvisionedThroughputSettings(
                    readProvisionedThroughputSettings.let(
                        ReadProvisionedThroughputSettingsProperty::unwrap
                    )
                )
            }
            ...
            override fun readProvisionedThroughputSettings(
                ...
                readProvisionedThroughputSettings(
                    ReadProvisionedThroughputSettingsProperty(readProvisionedThroughputSettings)
                )
            ...
            override fun sseSpecification(sseSpecification: ReplicaSSESpecificationProperty) {
                cdkBuilder.sseSpecification(
                    sseSpecification.let(ReplicaSSESpecificationProperty::unwrap)
                )
            }
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-dynamodb-globaltable-replicaspecification.html#cfn-dynamodb-globaltable-replicaspecification-deletionprotectionenabled)
             */
            override fun deletionProtectionEnabled(): Any? =
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-dynamodb-globaltable-replicaspecification.html#cfn-dynamodb-globaltable-replicaspecification-kinesisstreamspecification)
             */
            override fun kinesisStreamSpecification(): Any? =
             ...
             * Allows you to specify a customer-managed key for the replica.
             *
             * When using customer-managed keys for server-side encryption, this property must have
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ReplicaSpecificationProperty
            ): software.amazon.awscdk.services.dynamodb.CfnGlobalTable.ReplicaSpecificationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ContributorInsightsSpecificationProperty {
        ...
        public interface Builder {
            /**
             * @param enabled Indicates whether CloudWatch Contributor Insights are to be enabled
        ...
        internal constructor(
            ...
            /**
             * Indicates whether CloudWatch Contributor Insights are to be enabled (true) or
             * disabled (false).
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-dynamodb-globaltable-contributorinsightsspecification.html#cfn-dynamodb-globaltable-contributorinsightsspecification-enabled)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ContributorInsightsSpecificationProperty
            ): software.amazon.awscdk.services.dynamodb.CfnGlobalTable.ContributorInsightsSpecificationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface GlobalSecondaryIndexProperty {
         ...
         * . All replicas will have the same write capacity settings for this global secondary
         * index.
         *
        ...
        public interface Builder {
            /**
             * @param indexName The name of the global secondary index. The name must be unique
             ...
             *   attribute* . The term "hash attribute" derives from DynamoDB's usage of an internal
            ...
            /**
             * @param projection Represents attributes that are copied (projected) from the table
            ...
            /**
             * @param writeProvisionedThroughputSettings Defines write capacity settings for the
             *   global secondary index. You must specify a value for this property if the table's
             *   `BillingMode` is `PROVISIONED` . All replicas will have the same write capacity
        ...
        internal constructor(
             ...
             * pairs of attribute names and key types: - `HASH` - partition key - `RANGE` - sort key
             * &gt; The partition key of an item is also known as its *hash attribute* .
             *
             * The term "hash attribute" derives from DynamoDB's usage of an internal hash function
             ...
             * Defines write capacity settings for the global secondary index.
             *
             * You must specify a value for this property if the table's `BillingMode` is
             * `PROVISIONED` . All replicas will have the same write capacity settings for this
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: GlobalSecondaryIndexProperty
            ): software.amazon.awscdk.services.dynamodb.CfnGlobalTable.GlobalSecondaryIndexProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ReplicaGlobalSecondaryIndexSpecificationProperty {
         ...
         * applicable) sort key of frequently accessed items and frequently throttled items in
         * plaintext. If you require the use of AWS Key Management Service (KMS) to encrypt this
         * table’s partition key and sort key data with an AWS managed key or customer managed key,
         * you should not enable CloudWatch Contributor Insights for DynamoDB for this table.
         *
        ...
        public interface Builder {
            /**
             * @param contributorInsightsSpecification Updates the status for contributor insights
             *   for a specific table or index. CloudWatch Contributor Insights for DynamoDB graphs
             *   display the partition key and (if applicable) sort key of frequently accessed items
             *   and frequently throttled items in plaintext. If you require the use of AWS Key
             *   Management Service (KMS) to encrypt this table’s partition key and sort key data
             *   with an AWS managed key or customer managed key, you should not enable CloudWatch
            ...
            /**
             * @param readProvisionedThroughputSettings Allows you to specify the read capacity
             *   settings for a replica global secondary index when the `BillingMode` is set to
             *   `PROVISIONED` .
             */
            public fun readProvisionedThroughputSettings(
                readProvisionedThroughputSettings: IResolvable
        ...
        internal constructor(
             ...
             * applicable) sort key of frequently accessed items and frequently throttled items in
             * plaintext. If you require the use of AWS Key Management Service (KMS) to encrypt this
             * table’s partition key and sort key data with an AWS managed key or customer managed
             * key, you should not enable CloudWatch Contributor Insights for DynamoDB for this
             * table.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-dynamodb-globaltable-replicaglobalsecondaryindexspecification.html#cfn-dynamodb-globaltable-replicaglobalsecondaryindexspecification-contributorinsightsspecification)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ReplicaGlobalSecondaryIndexSpecificationProperty
            ): software.amazon.awscdk.services.dynamodb.CfnGlobalTable.ReplicaGlobalSecondaryIndexSpecificationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface AttributeDefinitionProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AttributeDefinitionProperty
            ): software.amazon.awscdk.services.dynamodb.CfnGlobalTable.AttributeDefinitionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ReplicaSSESpecificationProperty {
        ...
        public interface Builder {
             ...
             *   To specify a key, use its key ID, Amazon Resource Name (ARN), alias name, or alias
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ReplicaSSESpecificationProperty
            ): software.amazon.awscdk.services.dynamodb.CfnGlobalTable.ReplicaSSESpecificationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SSESpecificationProperty {
         ...
         * used ( AWS KMS charges apply). If disabled (false) or not specified,server-side
         * encryption is set to an AWS owned key. If you choose to use KMS encryption, you can also
         * use customer managed KMS keys by specifying them in the
         * `ReplicaSpecification.SSESpecification` object. You cannot mix AWS managed and customer
         * managed KMS keys.
         *
        ...
        public interface Builder {
             ...
             *   managed key or an AWS owned key. If enabled (true), server-side encryption type is
             *   set to KMS and an AWS managed key is used ( AWS KMS charges apply). If disabled
             *   (false) or not specified,server-side encryption is set to an AWS owned key. If you
             *   choose to use KMS encryption, you can also use customer managed KMS keys by
             *   specifying them in the `ReplicaSpecification.SSESpecification` object. You cannot
        ...
        internal constructor(
            ...
            /**
             * Indicates whether server-side encryption is performed using an AWS managed key or an
             * AWS owned key.
             *
             * If enabled (true), server-side encryption type is set to KMS and an AWS managed key
             * is used ( AWS KMS charges apply). If disabled (false) or not specified,server-side
             * encryption is set to an AWS owned key. If you choose to use KMS encryption, you can
             * also use customer managed KMS keys by specifying them in the
             * `ReplicaSpecification.SSESpecification` object. You cannot mix AWS managed and
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SSESpecificationProperty
            ): software.amazon.awscdk.services.dynamodb.CfnGlobalTable.SSESpecificationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface WriteProvisionedThroughputSettingsProperty {
        ...
        public interface Builder {
            /**
             * @param writeCapacityAutoScalingSettings Specifies auto scaling settings for the
             *   replica table or global secondary index.
             */
            public fun writeCapacityAutoScalingSettings(
                writeCapacityAutoScalingSettings: IResolvable
            )
            ...
            public fun writeCapacityAutoScalingSettings(
                writeCapacityAutoScalingSettings:
                    CapacityAutoScalingSettingsProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
             ...
             *   replica table or global secondary index.
             */
            override fun writeCapacityAutoScalingSettings(
                writeCapacityAutoScalingSettings: IResolvable
            ) {
                cdkBuilder.writeCapacityAutoScalingSettings(
                    writeCapacityAutoScalingSettings.let(IResolvable::unwrap)
                )
            }
            ...
            override fun writeCapacityAutoScalingSettings(
                ...
                cdkBuilder.writeCapacityAutoScalingSettings(
                    writeCapacityAutoScalingSettings.let(
                        CapacityAutoScalingSettingsProperty::unwrap
                    )
                )
            }
            ...
            override fun writeCapacityAutoScalingSettings(
                ...
                writeCapacityAutoScalingSettings(
                    CapacityAutoScalingSettingsProperty(writeCapacityAutoScalingSettings)
                )
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: WriteProvisionedThroughputSettingsProperty
            ): software.amazon.awscdk.services.dynamodb.CfnGlobalTable.WriteProvisionedThroughputSettingsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface LocalSecondaryIndexProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param projection Represents attributes that are copied (projected) from the table
             *   into the local secondary index. These are in addition to the primary key attributes
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: LocalSecondaryIndexProperty
            ): software.amazon.awscdk.services.dynamodb.CfnGlobalTable.LocalSecondaryIndexProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface PointInTimeRecoverySpecificationProperty {
        ...
        private class BuilderImpl : Builder {
            ...
            override fun pointInTimeRecoveryEnabled(pointInTimeRecoveryEnabled: IResolvable) {
                cdkBuilder.pointInTimeRecoveryEnabled(
                    pointInTimeRecoveryEnabled.let(IResolvable::unwrap)
                )
            }
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-dynamodb-globaltable-pointintimerecoveryspecification.html#cfn-dynamodb-globaltable-pointintimerecoveryspecification-pointintimerecoveryenabled)
             */
            override fun pointInTimeRecoveryEnabled(): Any? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: PointInTimeRecoverySpecificationProperty
            ): software.amazon.awscdk.services.dynamodb.CfnGlobalTable.PointInTimeRecoverySpecificationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ReadProvisionedThroughputSettingsProperty {
        ...
        public interface Builder {
            /**
             * @param readCapacityAutoScalingSettings Specifies auto scaling settings for the
             *   replica table or global secondary index.
             */
            ...
            /**
             * @param readCapacityUnits Specifies a fixed read capacity for the replica table or
             *   global secondary index.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            override fun readCapacityAutoScalingSettings(
                readCapacityAutoScalingSettings: IResolvable
            ) {
                cdkBuilder.readCapacityAutoScalingSettings(
                    readCapacityAutoScalingSettings.let(IResolvable::unwrap)
                )
            }
            ...
            override fun readCapacityAutoScalingSettings(
                ...
                cdkBuilder.readCapacityAutoScalingSettings(
                    readCapacityAutoScalingSettings.let(CapacityAutoScalingSettingsProperty::unwrap)
                )
            }
            ...
            override fun readCapacityAutoScalingSettings(
                ...
                readCapacityAutoScalingSettings(
                    CapacityAutoScalingSettingsProperty(readCapacityAutoScalingSettings)
                )
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ReadProvisionedThroughputSettingsProperty
            ): software.amazon.awscdk.services.dynamodb.CfnGlobalTable.ReadProvisionedThroughputSettingsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface KinesisStreamSpecificationProperty {
        ...
        public interface Builder {
            /**
             * @param approximateCreationDateTimePrecision The precision for the time and date that
             *   the stream was created.
             */
            public fun approximateCreationDateTimePrecision(
        ...
        private class BuilderImpl : Builder {
             ...
             *   the stream was created.
             */
            override fun approximateCreationDateTimePrecision(
                approximateCreationDateTimePrecision: String
            ) {
                cdkBuilder.approximateCreationDateTimePrecision(
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: KinesisStreamSpecificationProperty
            ): software.amazon.awscdk.services.dynamodb.CfnGlobalTable.KinesisStreamSpecificationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
