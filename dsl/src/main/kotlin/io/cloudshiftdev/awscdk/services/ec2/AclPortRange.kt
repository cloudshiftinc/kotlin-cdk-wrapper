...
public interface AclPortRange {
    ...
    public interface Builder {
        /**
         * @param from The first port in the range. Required if you specify 6 (TCP) or 17 (UDP) for
    ...
    public companion object {
        ...
        ): AclPortRange = Wrapper(cdkObject)

        internal fun unwrap(
            wrapped: AclPortRange
        ): software.amazon.awscdk.services.ec2.AclPortRange = (wrapped as Wrapper).cdkObject
    }
}
