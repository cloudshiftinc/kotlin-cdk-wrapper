...
internal constructor(
    ...
    public interface Builder {
        ...
        public fun alarmCapabilities(
            alarmCapabilities: AlarmCapabilitiesProperty.Builder.() -> Unit
        )
        ...
        public fun alarmEventActions(
            alarmEventActions: AlarmEventActionsProperty.Builder.() -> Unit
        )
         ...
         *
         * @param roleArn The ARN of the IAM role that allows the alarm to perform actions and
    ...
    private class BuilderImpl(
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("28dade2c5a535f2b0837588b6fcb591e268f5ef44dfc6e23313751c738c75d71")
        override fun alarmCapabilities(
            alarmCapabilities: AlarmCapabilitiesProperty.Builder.() -> Unit
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("5f17992d3d7cb1606f8e1af18815b53e1fff29da3e14a0eae4875754ca4b305b")
        override fun alarmEventActions(
            alarmEventActions: AlarmEventActionsProperty.Builder.() -> Unit
        ...
        public fun build(): software.amazon.awscdk.services.iotevents.CfnAlarmModel =
            cdkBuilder.build()
    }
    ...
    public interface IotTopicPublishProperty {
        ...
        public interface Builder {
            /**
             * @param mqttTopic The MQTT topic of the message. You can use a string expression that
            ...
            /**
             * @param payload You can configure the action payload when you publish a message to an
             *   AWS IoT Core topic.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: IotTopicPublishProperty
            ): software.amazon.awscdk.services.iotevents.CfnAlarmModel.IotTopicPublishProperty =
    ...
    public interface AssetPropertyVariantProperty {
        ...
        public interface Builder {
            /**
             * @param booleanValue The asset property value is a Boolean value that must be `'TRUE'`
             *   or `'FALSE'` . You must use an expression, and the evaluated result should be a
             *   Boolean value.
             */
            public fun booleanValue(booleanValue: String)

            /**
             * @param doubleValue The asset property value is a double. You must use an expression,
             *   and the evaluated result should be a double.
             */
            public fun doubleValue(doubleValue: String)

            /**
             * @param integerValue The asset property value is an integer. You must use an
             *   expression, and the evaluated result should be an integer.
             */
            public fun integerValue(integerValue: String)

            /**
             * @param stringValue The asset property value is a string. You must use an expression,
    ...
    public interface SimpleRuleProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param inputProperty The value on the left side of the comparison operator. You can
             *   specify an AWS IoT Events input attribute as an input property.
             */
            public fun inputProperty(inputProperty: String)

            /**
             * @param threshold The value on the right side of the comparison operator. You can
    ...
    public interface AlarmRuleProperty {
        ...
        public interface Builder {
            /**
             * @param simpleRule A rule that compares an input property value to a threshold value
    ...
    public interface PayloadProperty {
        ...
        public interface Builder {
            /**
             * @param contentExpression The content of the payload. You can use a string expression
             *   that includes quoted strings ( `'&lt;string&gt;'` ), variables (
             *   `$variable.&lt;variable-name&gt;` ), input values (
             *   `$input.&lt;input-name&gt;.&lt;path-to-datum&gt;` ), string concatenations, and
             *   quoted strings that contain `${}` as the content. The recommended maximum size of a
    ...
    public interface IotEventsProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param payload You can configure the action payload when you send a message to an AWS
             *   IoT Events input.
             */
            public fun payload(payload: IResolvable)
    ...
    public interface DynamoDBv2Property {
         ...
         * action payload contains all attribute-value pairs that have the information about the
         * detector model instance and the event triggered the action. To configure the action
        ...
        public interface Builder {
            /**
             * @param payload Information needed to configure the payload. By default, AWS IoT
             ...
             *   model instance and the event triggered the action. To configure the action payload,
    ...
    public interface SqsProperty {
        ...
        public interface Builder {
            /**
             * @param payload You can configure the action payload when you send a message to an
             *   Amazon SQS queue.
             */
            public fun payload(payload: IResolvable)
            ...
            /**
             * @param useBase64 Set this to TRUE if you want the data to be base-64 encoded before
    ...
    public interface AlarmActionProperty {
         ...
         * separate column of the DynamoDB table receives one attribute-value pair in the payload
         * that you specify.
         *
         ...
         *
         * **Examples** - For literal values, the expressions must contain single quotes. For
         ...
         *   value for the `tableName` parameter can be `$variable.ddbtableName` .
         ...
         *
         * In the following example, the value for the `contentExpression` parameter in `Payload`
         * uses a substitution template.
         *
         * `'{\"sensorID\": \"${$input.GreenhouseInput.sensor_id}\", \"temperature\":
         * \"${$input.GreenhouseInput.temperature * 9 / 5 + 32}\"}'`
         * * For a string concatenation, you must use `+` . A string concatenation can also contain
         ...
         * Defines an action to write to the Amazon DynamoDB table that you created.
         *
         * The standard action payload contains all the information about the detector model
         ...
         * One column of the DynamoDB table receives all attribute-value pairs in the payload that
         * you specify.
         *
         ...
         * * For references, you must specify either variables or input values. For example, the
         *   value for the `hashKeyField` parameter can be `$input.GreenhouseInput.name` .
         * * For a substitution template, you must use `${}` , and the template must be in single
         *   quotes. A substitution template can also contain a combination of literals, operators,
         *   functions, references, and substitution templates.
         *
         ...
         * DynamoDB table as binary data. The DynamoDB console displays the data as Base64-encoded
         * text. The value for the `payloadField` parameter is `&lt;payload-field&gt;_raw` .
         *
         ...
         * * For references, you must specify either variables or input values. For example, the
         *   value for the `assetId` parameter can be `$input.TurbineInput.assetId1` .
         * * For a substitution template, you must use `${}` , and the template must be in single
         *   quotes. A substitution template can also contain a combination of literals, operators,
         *   functions, references, and substitution templates.
         *
        ...
        public interface Builder {
            /**
             * @param dynamoDBv2 Defines an action to write to the Amazon DynamoDB table that you
             *   created. The default action payload contains all the information about the detector
            ...
            /**
             * @param dynamoDb Defines an action to write to the Amazon DynamoDB table that you
             *   created. The standard action payload contains all the information about the
             *   detector model instance and the event that triggered the action. You can customize
             *   the
             *   [payload](https://docs.aws.amazon.com/iotevents/latest/apireference/API_Payload.html)
             ...
             *
             * If the defined payload type is a string, `DynamoDBAction` writes non-JSON data to the
             * DynamoDB table as binary data. The DynamoDB console displays the data as
             * Base64-encoded text. The value for the `payloadField` parameter is
             * `&lt;payload-field&gt;_raw` .
             */
            ...
            /**
             * @param firehose Sends information about the detector model instance and the event
            ...
            /**
             * @param iotEvents Sends an AWS IoT Events input, passing in information about the
            ...
            /**
             * @param iotSiteWise Sends information about the detector model instance and the event
             *   that triggered the action to a specified asset property in AWS IoT SiteWise . You
             *   must use expressions for all parameters in `IotSiteWiseAction` . The expressions
             *   accept literals, operators, functions, references, and substitutions templates.
             *
             * **Examples** - For literal values, the expressions must contain single quotes. For
             * example, the value for the `propertyAlias` parameter can be
            ...
            /**
             * @param iotTopicPublish Information required to publish the MQTT message through the
            ...
            /**
             * @param lambda Calls a Lambda function, passing in information about the detector
            ...
            /**
             * @param sqs Sends information about the detector model instance and the event that
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("eb9bf5bd4cedcb9d89548b63ccbc6a98e99671d994e3f06088431680b1f6b965")
            override fun iotTopicPublish(
                iotTopicPublish: IotTopicPublishProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * Defines an action to write to the Amazon DynamoDB table that you created.
             *
             * The default action payload contains all the information about the detector model
             * instance and the event that triggered the action. You can customize the
             * [payload](https://docs.aws.amazon.com/iotevents/latest/apireference/API_Payload.html)
             * . A separate column of the DynamoDB table receives one attribute-value pair in the
             * payload that you specify.
            ...
            /**
             * Calls a Lambda function, passing in information about the detector model instance and
    ...
    public interface IotSiteWiseProperty {
         ...
         *
         * You can use the entry ID to track which data entry causes an error in case of failure.
         * The default is a new unique identifier.
         *
        ...
        public interface Builder {
            ...
            /**
             * @param entryId A unique identifier for this entry. You can use the entry ID to track
             *   which data entry causes an error in case of failure. The default is a new unique
             *   identifier.
             */
            ...
            /**
             * @param propertyValue The value to send to the asset property. This value contains
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("47b0e44681950e9c0630a17a035b5170e8152a7dfefc8df1c97b2699e6f33d06")
            override fun propertyValue(
                propertyValue: AssetPropertyValueProperty.Builder.() -> Unit
            ): Unit = propertyValue(AssetPropertyValueProperty(propertyValue))
        ...
        internal constructor(
             ...
             * A unique identifier for this entry.
             *
             * You can use the entry ID to track which data entry causes an error in case of
    ...
    public interface LambdaProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param payload You can configure the action payload when you send a message to a
             *   Lambda function.
             */
            public fun payload(payload: IResolvable)
    ...
    public interface AssetPropertyTimestampProperty {
        ...
        public interface Builder {
            /**
             * @param offsetInNanos The nanosecond offset converted from `timeInSeconds` . The valid
             *   range is between 0-999999999.
             */
            public fun offsetInNanos(offsetInNanos: String)

            /**
             * @param timeInSeconds The timestamp, in seconds, in the Unix epoch format. The valid
    ...
    public interface AlarmEventActionsProperty {
        ...
        public interface Builder {
            /**
             * @param alarmActions Specifies one or more supported actions to receive notifications
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AlarmEventActionsProperty
            ): software.amazon.awscdk.services.iotevents.CfnAlarmModel.AlarmEventActionsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface AssetPropertyValueProperty {
        ...
        public interface Builder {
            /**
             * @param quality The quality of the asset property value. The value must be `'GOOD'` ,
             *   `'BAD'` , or `'UNCERTAIN'` .
             */
            public fun quality(quality: String)

            /**
             * @param timestamp The timestamp associated with the asset property value. The default
    ...
    public interface SnsProperty {
        ...
        public interface Builder {
            /**
             * @param payload You can configure the action payload when you send a message as an
    ...
    public interface AlarmCapabilitiesProperty {
         ...
         */
        public fun initializationConfiguration(): Any? =
        ...
        public interface Builder {
            ...
            /**
             * @param initializationConfiguration Specifies the default alarm state. The
             *   configuration applies to all alarms that were created based on this alarm model.
             */
            ...
            public fun initializationConfiguration(
                initializationConfiguration: InitializationConfigurationProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("bab2c9254d6a985d303ef2f39b186823a487f99df2e54f3ab959b7587ec44bce")
            override fun acknowledgeFlow(
                acknowledgeFlow: AcknowledgeFlowProperty.Builder.() -> Unit
            ...
            override fun initializationConfiguration(initializationConfiguration: IResolvable) {
                cdkBuilder.initializationConfiguration(
                    initializationConfiguration.let(IResolvable::unwrap)
                )
            }
             ...
             *   configuration applies to all alarms that were created based on this alarm model.
             */
            override fun initializationConfiguration(
                initializationConfiguration: InitializationConfigurationProperty
            ) {
                cdkBuilder.initializationConfiguration(
                    initializationConfiguration.let(InitializationConfigurationProperty::unwrap)
                )
            }
            ...
            override fun initializationConfiguration(
                ...
                initializationConfiguration(
                    InitializationConfigurationProperty(initializationConfiguration)
                )
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AlarmCapabilitiesProperty
            ): software.amazon.awscdk.services.iotevents.CfnAlarmModel.AlarmCapabilitiesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface FirehoseProperty {
        ...
        public interface Builder {
            /**
             * @param deliveryStreamName The name of the Kinesis Data Firehose delivery stream where
             *   the data is written.
             */
            ...
            /**
             * @param separator A character separator that is used to separate records written to
        ...
        internal constructor(
            ...
            /**
             * You can configure the action payload when you send a message to an Amazon Data
             * Firehose delivery stream.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-iotevents-alarmmodel-firehose.html#cfn-iotevents-alarmmodel-firehose-payload)
             */
    ...
    public interface DynamoDBProperty {
         ...
         *   must match the specified hash key. If you specified a range key, the range key must
        ...
        public interface Builder {
            ...
            /**
             * @param hashKeyType The data type for the hash key (also called the partition key).
            ...
            /**
             * @param operation The type of operation to perform. You can specify the following
             *   values:.
             * * `'INSERT'` - Insert data as a new item into the DynamoDB table. This item uses the
             *   specified hash key as a partition key. If you specified a range key, the item uses
             ...
             * * `'DELETE'` - Delete an existing item of the DynamoDB table. This item's partition
            ...
            /**
             * @param rangeKeyType The data type for the range key (also called the sort key), You
            ...
            /**
             * @param tableName The name of the DynamoDB table. The `tableName` value must match the
    ...
    public interface AcknowledgeFlowProperty {
         ...
         * acknowledge the notification before the alarm state can return to `NORMAL` . If `FALSE` ,
         * you won't receive notifications. The alarm automatically changes to the `NORMAL` state
        ...
        public interface Builder {
            /**
             * @param enabled The value must be `TRUE` or `FALSE` . If `TRUE` , you receive a
             *   notification when the alarm state changes. You must choose to acknowledge the
             *   notification before the alarm state can return to `NORMAL` . If `FALSE` , you won't
             *   receive notifications. The alarm automatically changes to the `NORMAL` state when
        ...
        internal constructor(
             ...
             * The value must be `TRUE` or `FALSE` .
             *
             * If `TRUE` , you receive a notification when the alarm state changes. You must choose
             * to acknowledge the notification before the alarm state can return to `NORMAL` . If
             * `FALSE` , you won't receive notifications. The alarm automatically changes to the
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AcknowledgeFlowProperty
            ): software.amazon.awscdk.services.iotevents.CfnAlarmModel.AcknowledgeFlowProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface InitializationConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param disabledOnInitialization The value must be `TRUE` or `FALSE` . If `FALSE` ,
             *   all alarm instances created based on the alarm model are activated. The default
             *   value is `TRUE` .
             */
        ...
        private class BuilderImpl : Builder {
            ...
            override fun disabledOnInitialization(disabledOnInitialization: IResolvable) {
                cdkBuilder.disabledOnInitialization(
                    disabledOnInitialization.let(IResolvable::unwrap)
                )
            }
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-iotevents-alarmmodel-initializationconfiguration.html#cfn-iotevents-alarmmodel-initializationconfiguration-disabledoninitialization)
             */
            override fun disabledOnInitialization(): Any =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: InitializationConfigurationProperty
            ): software.amazon.awscdk.services.iotevents.CfnAlarmModel.InitializationConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
