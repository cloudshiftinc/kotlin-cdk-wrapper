...
internal constructor(
    ...
    public open fun attrLoRaWanMinGwDiversity(): Number =
        unwrap(this).getAttrLoRaWanMinGwDiversity()
    ...
    public interface LoRaWANServiceProfileProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param channelMask The ChannelMask value. This property is `ReadOnly` and can't be
             *   inputted for create. It's returned with `Fn::GetAtt`
             */
            public fun channelMask(channelMask: String)

            /**
             * @param devStatusReqFreq The DevStatusReqFreq value. This property is `ReadOnly` and
             *   can't be inputted for create. It's returned with `Fn::GetAtt`
             */
            public fun devStatusReqFreq(devStatusReqFreq: Number)

            /**
             * @param dlBucketSize The DLBucketSize value. This property is `ReadOnly` and can't be
             *   inputted for create. It's returned with `Fn::GetAtt`
             */
            public fun dlBucketSize(dlBucketSize: Number)

            /**
             * @param dlRate The DLRate value. This property is `ReadOnly` and can't be inputted for
             *   create. It's returned with `Fn::GetAtt`
             */
            public fun dlRate(dlRate: Number)

            /**
             * @param dlRatePolicy The DLRatePolicy value. This property is `ReadOnly` and can't be
             *   inputted for create. It's returned with `Fn::GetAtt`
             */
            public fun dlRatePolicy(dlRatePolicy: String)

            /**
             * @param drMax The DRMax value. This property is `ReadOnly` and can't be inputted for
             *   create. It's returned with `Fn::GetAtt`
             */
            public fun drMax(drMax: Number)

            /**
             * @param drMin The DRMin value. This property is `ReadOnly` and can't be inputted for
             *   create. It's returned with `Fn::GetAtt`
             */
            public fun drMin(drMin: Number)

            /**
             * @param hrAllowed The HRAllowed value that describes whether handover roaming is
             *   allowed. This property is `ReadOnly` and can't be inputted for create. It's
             *   returned with `Fn::GetAtt`
             */
            ...
            /**
             * @param minGwDiversity The MinGwDiversity value. This property is `ReadOnly` and can't
             *   be inputted for create. It's returned with `Fn::GetAtt`
             */
            public fun minGwDiversity(minGwDiversity: Number)

            /**
             * @param nwkGeoLoc The NwkGeoLoc value. This property is `ReadOnly` and can't be
             *   inputted for create. It's returned with `Fn::GetAtt`
             */
            ...
            /**
             * @param prAllowed The PRAllowed value that describes whether passive roaming is
             *   allowed. This property is `ReadOnly` and can't be inputted for create. It's
             *   returned with `Fn::GetAtt`
             */
            ...
            /**
             * @param raAllowed The RAAllowed value that describes whether roaming activation is
             *   allowed.
             */
            ...
            /**
             * @param reportDevStatusBattery The ReportDevStatusBattery value. This property is
             *   `ReadOnly` and can't be inputted for create. It's returned with `Fn::GetAtt`
             */
            ...
            /**
             * @param reportDevStatusMargin The ReportDevStatusMargin value. This property is
             *   `ReadOnly` and can't be inputted for create. It's returned with `Fn::GetAtt`
             */
            ...
            /**
             * @param targetPer The TargetPer value. This property is `ReadOnly` and can't be
             *   inputted for create. It's returned with `Fn::GetAtt`
             */
            public fun targetPer(targetPer: Number)

            /**
             * @param ulBucketSize The UlBucketSize value. This property is `ReadOnly` and can't be
             *   inputted for create. It's returned with `Fn::GetAtt`
             */
            public fun ulBucketSize(ulBucketSize: Number)

            /**
             * @param ulRate The ULRate value. This property is `ReadOnly` and can't be inputted for
             *   create. It's returned with `Fn::GetAtt`
             */
            public fun ulRate(ulRate: Number)

            /**
             * @param ulRatePolicy The ULRatePolicy value. This property is `ReadOnly` and can't be
             *   inputted for create. It's returned with `Fn::GetAtt`
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: LoRaWANServiceProfileProperty
            ): software.amazon.awscdk.services.iotwireless.CfnServiceProfile.LoRaWANServiceProfileProperty =
