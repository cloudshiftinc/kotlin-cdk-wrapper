...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param distribution The method used to distribute log data to the destination, which can
        ...
        /**
         * The filtering expressions that restrict what gets delivered to the destination AWS
         * resource.
         *
         ...
         * events to the destination stream.
         *
