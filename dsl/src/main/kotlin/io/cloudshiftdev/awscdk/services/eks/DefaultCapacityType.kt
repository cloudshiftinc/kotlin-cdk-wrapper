...
public enum class DefaultCapacityType(
    ...
    public companion object {
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.eks.DefaultCapacityType
        ): DefaultCapacityType =
            when (cdkObject) {
                software.amazon.awscdk.services.eks.DefaultCapacityType.NODEGROUP ->
                    DefaultCapacityType.NODEGROUP
                software.amazon.awscdk.services.eks.DefaultCapacityType.EC2 ->
                    DefaultCapacityType.EC2
            }

        internal fun unwrap(
            wrapped: DefaultCapacityType
