...
internal constructor(
    ...
    public companion object {
        public fun fromAcmCertificate(certificate: ICertificate): ViewerCertificate =
            software.amazon.awscdk.services.cloudfront.ViewerCertificate.fromAcmCertificate(
                    certificate.let(ICertificate::unwrap)
                )
                .let(ViewerCertificate::wrap)
        ...
        public fun fromAcmCertificate(
            ...
            software.amazon.awscdk.services.cloudfront.ViewerCertificate.fromAcmCertificate(
                    certificate.let(ICertificate::unwrap),
                    options.let(ViewerCertificateOptions::unwrap)
                )
                .let(ViewerCertificate::wrap)
        ...
        public fun fromAcmCertificate(
            certificate: ICertificate,
            options: ViewerCertificateOptions.Builder.() -> Unit
        ): ViewerCertificate = fromAcmCertificate(certificate, ViewerCertificateOptions(options))
        ...
        public fun fromCloudFrontDefaultCertificate(aliases: String): ViewerCertificate =
            software.amazon.awscdk.services.cloudfront.ViewerCertificate
                .fromCloudFrontDefaultCertificate(aliases)
                .let(ViewerCertificate::wrap)

        public fun fromIamCertificate(iamCertificateId: String): ViewerCertificate =
            software.amazon.awscdk.services.cloudfront.ViewerCertificate.fromIamCertificate(
                    iamCertificateId
                )
                .let(ViewerCertificate::wrap)
