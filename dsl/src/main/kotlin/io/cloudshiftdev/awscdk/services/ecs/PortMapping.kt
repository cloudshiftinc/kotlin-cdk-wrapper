...
public interface PortMapping {
    ...
    public interface Builder {
        /**
         * @param appProtocol The protocol used by Service Connect. Valid values are
         *   AppProtocol.http, AppProtocol.http2, and AppProtocol.grpc. The protocol determines what
         *   telemetry will be shown in the ECS Console for Service Connect services using this port
         *   mapping.
         *
         * This field may only be set when the task definition uses Bridge or Awsvpc network modes.
         */
         ...
         *   or automatically assigned host port. If you are using containers in a task with the
         *   awsvpc or host network mode, exposed ports should be specified using containerPort. If
         *   you are using containers in a task with the bridge network mode and you specify a
         *   container port and not a host port, your container automatically receives a host port
         *   in the ephemeral port range.
         *
         * For more information, see hostPort. Port mappings that are automatically assigned in this
         * way do not count toward the 100 reserved ports limit of a container instance.
         *
         * If you want to expose a port range, you must specify `CONTAINER_PORT_USE_RANGE` as
         * container port.
         */
         ...
         * set it to 0) while specifying a containerPort and your container automatically receives a
        ...
        /**
         * @param name The name to give the port mapping. Name is required in order to use the port
         *   mapping with ECS Service Connect. This field may only be set when the task definition
         *   uses Bridge or Awsvpc network modes.
         */
        public fun name(name: String)

        /**
         * @param protocol The protocol used for the port mapping. Valid values are Protocol.TCP and
         *   Protocol.UDP.
         */
    ...
    internal constructor(
         ...
         *
         * Valid values are AppProtocol.http, AppProtocol.http2, and AppProtocol.grpc. The protocol
         * determines what telemetry will be shown in the ECS Console for Service Connect services
         * using this port mapping.
         *
         * This field may only be set when the task definition uses Bridge or Awsvpc network modes.
         *
         * Default: - no app protocol
         */
        override fun appProtocol(): AppProtocol? =
         ...
         * The port number on the container instance to reserve for your container.
         *
         * If you are using containers in a task with the awsvpc or host network mode, the hostPort
         ...
         * The name to give the port mapping.
         *
         * Name is required in order to use the port mapping with ECS Service Connect. This field
         * may only be set when the task definition uses Bridge or Awsvpc network modes.
         *
         * Default: - no port mapping name
         */
