...
public enum class SourceMapMode(
    ...
    public companion object {
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.lambda.nodejs.SourceMapMode
        ): SourceMapMode =
            when (cdkObject) {
                software.amazon.awscdk.services.lambda.nodejs.SourceMapMode.DEFAULT ->
                    SourceMapMode.DEFAULT
                software.amazon.awscdk.services.lambda.nodejs.SourceMapMode.EXTERNAL ->
                    SourceMapMode.EXTERNAL
                software.amazon.awscdk.services.lambda.nodejs.SourceMapMode.INLINE ->
                    SourceMapMode.INLINE
                software.amazon.awscdk.services.lambda.nodejs.SourceMapMode.BOTH ->
                    SourceMapMode.BOTH
            }

        internal fun unwrap(
            wrapped: SourceMapMode
