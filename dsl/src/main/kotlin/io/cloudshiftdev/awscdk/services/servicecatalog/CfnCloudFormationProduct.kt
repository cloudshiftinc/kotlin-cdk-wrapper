...
internal constructor(
    ...
    public interface Builder {
         ...
         * description, distributor, name, owner, and more) and the associated provisioning
         * artifacts will retain the same unique identifier. Provisioning artifacts are matched
         * within the CloudFormationProduct resource, and only those that have been updated will be
         * changed. Provisioning artifacts are matched by a combinaton of provisioning artifact
         * template URL and name.
         *
         * If turned on, provisioning artifacts will be given a new unique identifier when you
         * update the product or provisioning artifacts.
         *
         ...
         *
         * @param sourceConnection A top level `ProductViewDetail` response containing details about
         *   the product’s connection.
         */
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.servicecatalog.CfnCloudFormationProduct.Builder.create(
                scope,
                id
            )
        ...
        override fun provisioningArtifactParameters(provisioningArtifactParameters: IResolvable) {
            cdkBuilder.provisioningArtifactParameters(
                provisioningArtifactParameters.let(IResolvable::unwrap)
            )
        }
         ...
         *   (also known as a version).
         */
        override fun provisioningArtifactParameters(
            vararg provisioningArtifactParameters: Any
        ): Unit = provisioningArtifactParameters(provisioningArtifactParameters.toList())
        ...
        override fun replaceProvisioningArtifacts(replaceProvisioningArtifacts: IResolvable) {
            cdkBuilder.replaceProvisioningArtifacts(
                replaceProvisioningArtifacts.let(IResolvable::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("f6cff10ddcf3be0f1cd49992c4b0f8bb297910e7d596f39cfdab4e7c43de6b5f")
        override fun sourceConnection(
            sourceConnection: SourceConnectionProperty.Builder.() -> Unit
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnCloudFormationProduct
        ): software.amazon.awscdk.services.servicecatalog.CfnCloudFormationProduct =
            wrapped.cdkObject
    }
    ...
    public interface ProvisioningArtifactPropertiesProperty {
         ...
         *
         * The URL of the AWS CloudFormation template in Amazon S3 in JSON format. Specify the URL
         ...
         * Currently only supports AWS CloudFormation stack arn. Specify the physical id in JSON
        ...
        public interface Builder {
            /**
             * @param description The description of the provisioning artifact, including how it
             *   differs from the previous provisioning artifact.
             */
            public fun description(description: String)

            /**
             * @param disableTemplateValidation If set to true, AWS Service Catalog stops validating
            ...
            /**
             * @param info Specify the template source with one of the following options, but not
             *   both. Keys accepted: [ `LoadTemplateFromURL` , `ImportFromPhysicalId` ]
             *
             * The URL of the AWS CloudFormation template in Amazon S3 in JSON format. Specify the
            ...
            /**
             * @param name The name of the provisioning artifact (for example, v1 v2beta). No spaces
             *   are allowed.
             */
            public fun name(name: String)
        ...
        private class BuilderImpl : Builder {
            ...
            override fun disableTemplateValidation(disableTemplateValidation: IResolvable) {
                cdkBuilder.disableTemplateValidation(
                    disableTemplateValidation.let(IResolvable::unwrap)
                )
            }
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-servicecatalog-cloudformationproduct-provisioningartifactproperties.html#cfn-servicecatalog-cloudformationproduct-provisioningartifactproperties-disabletemplatevalidation)
             */
            override fun disableTemplateValidation(): Any? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ProvisioningArtifactPropertiesProperty
            ): software.amazon.awscdk.services.servicecatalog.CfnCloudFormationProduct.ProvisioningArtifactPropertiesProperty =
    ...
    public interface CodeStarParametersProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param connectionArn The CodeStar ARN, which is the connection between AWS Service
        ...
        internal constructor(
            ...
            /**
             * The CodeStar ARN, which is the connection between AWS Service Catalog and the
             * external repository.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-servicecatalog-cloudformationproduct-codestarparameters.html#cfn-servicecatalog-cloudformationproduct-codestarparameters-connectionarn)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CodeStarParametersProperty
            ): software.amazon.awscdk.services.servicecatalog.CfnCloudFormationProduct.CodeStarParametersProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ConnectionParametersProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ConnectionParametersProperty
            ): software.amazon.awscdk.services.servicecatalog.CfnCloudFormationProduct.ConnectionParametersProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SourceConnectionProperty {
        ...
        public interface Builder {
            ...
            public fun connectionParameters(
                connectionParameters: ConnectionParametersProperty.Builder.() -> Unit
            )
        ...
        private class BuilderImpl : Builder {
            ...
            override fun connectionParameters(connectionParameters: ConnectionParametersProperty) {
                cdkBuilder.connectionParameters(
                    connectionParameters.let(ConnectionParametersProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("91e8b9c506db905bed859bcb46d9e4023c14486820356214116cac00209d0817")
            override fun connectionParameters(
                connectionParameters: ConnectionParametersProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SourceConnectionProperty
            ): software.amazon.awscdk.services.servicecatalog.CfnCloudFormationProduct.SourceConnectionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
