...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.vpclattice.CfnRule,
    ...
    public interface Builder {
         ...
         * The name of the rule.
         *
         * The name must be unique within the listener. The valid characters are a-z, 0-9, and
         ...
         * The priority assigned to the rule.
         *
         * Each rule for a specific listener must have a unique priority. The lower the priority
    ...
    private class BuilderImpl(
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("9695a756ba1a6109e12c8b356ec6e7eedda0c35214677257b0f458ff02af6971")
        override fun match(match: MatchProperty.Builder.() -> Unit): Unit =
    ...
    public interface ActionProperty {
        ...
        public interface Builder {
            /**
             * @param fixedResponse The fixed response action. The rule returns a custom HTTP
             *   response.
             */
    ...
    public interface HeaderMatchTypeProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: HeaderMatchTypeProperty
            ): software.amazon.awscdk.services.vpclattice.CfnRule.HeaderMatchTypeProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ForwardProperty {
        ...
        internal constructor(
            internal val cdkObject:
                software.amazon.awscdk.services.vpclattice.CfnRule.ForwardProperty,
        ) : ForwardProperty {
            /**
             * The target groups.
             *
    ...
    public interface HttpMatchProperty {
        ...
        public interface Builder {
            /**
             * @param headerMatches The header matches. Matches incoming requests with rule based on
        ...
        internal constructor(
             ...
             * The header matches.
             *
             * Matches incoming requests with rule based on request header value before applying
             * rule action.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-vpclattice-rule-httpmatch.html#cfn-vpclattice-rule-httpmatch-headermatches)
             */
