...
public interface AuthenticateOidcOptions {
    ...
    public interface Builder {
        /**
         * @param allowHttpsOutbound Allow HTTPS outbound traffic to communicate with the IdP. Set
         *   this property to false if the IP address used for the IdP endpoint is identifiable and
         *   you want to control outbound traffic. Then allow HTTPS outbound traffic to the IdP's IP
         *   address using the listener's `connections` property.
         */
        ...
        /**
         * @param authorizationEndpoint The authorization endpoint of the IdP. This must be a full
         *   URL, including the HTTPS protocol, the domain, and the path.
         */
        ...
        /**
         * @param issuer The OIDC issuer identifier of the IdP. This must be a full URL, including
        ...
        /**
         * @param tokenEndpoint The token endpoint of the IdP. This must be a full URL, including
         *   the HTTPS protocol, the domain, and the path.
         */
    ...
    private class BuilderImpl : Builder {
        ...
        override fun onUnauthenticatedRequest(onUnauthenticatedRequest: UnauthenticatedAction) {
            cdkBuilder.onUnauthenticatedRequest(
                onUnauthenticatedRequest.let(UnauthenticatedAction::unwrap)
            )
        }
    ...
    internal constructor(
         ...
         * and you want to control outbound traffic. Then allow HTTPS outbound traffic to the IdP's
         * IP address using the listener's `connections` property.
         *
         * Default: true
         *
         * [Documentation](https://repost.aws/knowledge-center/elb-configure-authentication-alb)
        ...
        /** The OAuth 2.0 client secret. */
        override fun clientSecret(): SecretValue =
         ...
         * Default: Duration.days(7)
         */
        override fun sessionTimeout(): Duration? =
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: AuthenticateOidcOptions
        ): software.amazon.awscdk.services.elasticloadbalancingv2.AuthenticateOidcOptions =
