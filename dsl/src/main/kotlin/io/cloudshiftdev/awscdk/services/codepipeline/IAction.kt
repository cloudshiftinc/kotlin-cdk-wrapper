...
public interface IAction {
    ...
    internal constructor(
         ...
         * The callback invoked when this Action is added to a Pipeline.
         *
         * @param scope the Construct tree scope the Action can use if it needs to create any
         *   resources.
         * @param stage the `IStage` this Action is being added to.
         * @param options additional options the Action can use, like the artifact Bucket of the
         *   pipeline it's being added to.
        ...
        override fun bind(
            ...
            unwrap(this)
                .bind(
                    ...
                    stage.let(IStage::unwrap),
                    options.let(ActionBindOptions::unwrap)
                )
                .let(ActionConfig::wrap)
        ...
        override fun onStateChange(
            ...
            unwrap(this)
                .onStateChange(
                    name,
                    target.let(IRuleTarget::unwrap),
                    options.let(RuleProps::unwrap)
                )
                .let(Rule::wrap)
    ...
    public companion object {
        ...
        ): IAction = Wrapper(cdkObject)

        internal fun unwrap(
            wrapped: IAction
        ): software.amazon.awscdk.services.codepipeline.IAction = (wrapped as Wrapper).cdkObject
    }
}
