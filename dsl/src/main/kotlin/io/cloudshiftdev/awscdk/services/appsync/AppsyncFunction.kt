...
internal constructor(
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.appsync.AppsyncFunction =
            cdkBuilder.build()
    }
    ...
    public companion object {
        public fun fromAppsyncFunctionAttributes(
            ...
            software.amazon.awscdk.services.appsync.AppsyncFunction.fromAppsyncFunctionAttributes(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    attrs.let(AppsyncFunctionAttributes::unwrap)
                )
                .let(IAppsyncFunction::wrap)
        ...
        public fun fromAppsyncFunctionAttributes(
            ...
            fromAppsyncFunctionAttributes(scope, id, AppsyncFunctionAttributes(attrs))
