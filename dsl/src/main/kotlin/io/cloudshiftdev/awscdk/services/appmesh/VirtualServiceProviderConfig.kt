...
public interface VirtualServiceProviderConfig {
    ...
    public fun virtualNodeProvider(): CfnVirtualService.VirtualNodeServiceProviderProperty? =
        unwrap(this)
            .getVirtualNodeProvider()
            ?.let(CfnVirtualService.VirtualNodeServiceProviderProperty::wrap)
    ...
    public fun virtualRouterProvider(): CfnVirtualService.VirtualRouterServiceProviderProperty? =
        unwrap(this)
            ...
            ?.let(CfnVirtualService.VirtualRouterServiceProviderProperty::wrap)
    ...
    public interface Builder {
        ...
        public fun virtualNodeProvider(
            virtualNodeProvider: CfnVirtualService.VirtualNodeServiceProviderProperty
        )
        ...
        public fun virtualRouterProvider(
            virtualRouterProvider: CfnVirtualService.VirtualRouterServiceProviderProperty
        )
        ...
        public fun virtualRouterProvider(
            virtualRouterProvider:
                CfnVirtualService.VirtualRouterServiceProviderProperty.Builder.() -> Unit
        )
    }
    ...
    private class BuilderImpl : Builder {
        ...
        /** @param virtualNodeProvider Virtual Node based provider. */
        override fun virtualNodeProvider(
            virtualNodeProvider: CfnVirtualService.VirtualNodeServiceProviderProperty
        ) {
            cdkBuilder.virtualNodeProvider(
                virtualNodeProvider.let(
                    CfnVirtualService.VirtualNodeServiceProviderProperty::unwrap
                )
            )
        }
        ...
        override fun virtualNodeProvider(
            ...
            virtualNodeProvider(
                CfnVirtualService.VirtualNodeServiceProviderProperty(virtualNodeProvider)
            )

        /** @param virtualRouterProvider Virtual Router based provider. */
        override fun virtualRouterProvider(
            virtualRouterProvider: CfnVirtualService.VirtualRouterServiceProviderProperty
        ) {
            cdkBuilder.virtualRouterProvider(
                virtualRouterProvider.let(
                    CfnVirtualService.VirtualRouterServiceProviderProperty::unwrap
                )
            )
        }
        ...
        override fun virtualRouterProvider(
            ...
            virtualRouterProvider(
                CfnVirtualService.VirtualRouterServiceProviderProperty(virtualRouterProvider)
            )
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: VirtualServiceProviderConfig
        ): software.amazon.awscdk.services.appmesh.VirtualServiceProviderConfig =
