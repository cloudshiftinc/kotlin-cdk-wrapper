...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.gamelift.CfnScript,
    ...
    public interface Builder {
         ...
         * is stored.
         *
         * The storage location must specify the Amazon S3 bucket name, the zip file name (the
         * "key"), and a role ARN that allows Amazon GameLift to access the Amazon S3 storage
         ...
         *
         * @param storageLocation The location of the Amazon S3 bucket where a zipped file
         *   containing your Realtime scripts is stored.
         */
    ...
    public companion object {
        ...
        ): CfnScript = CfnScript(cdkObject)

        internal fun unwrap(
            wrapped: CfnScript
        ): software.amazon.awscdk.services.gamelift.CfnScript = wrapped.cdkObject
    }
    ...
    public interface S3LocationProperty {
         ...
         *
         * Amazon GameLift uses this information when retrieving files from an S3 bucket that you
        ...
        public interface Builder {
            ...
            /**
             * @param objectVersion The version of the file, if object versioning is turned on for
             *   the bucket. Amazon GameLift uses this information when retrieving files from an S3
             *   bucket that you own. Use this parameter to specify a specific version of the file.
             ...
             *   [ARN](https://docs.aws.amazon.com/AmazonS3/latest/dev/s3-arn-format.html) ) for an
        ...
        internal constructor(
             ...
             * The version of the file, if object versioning is turned on for the bucket.
             *
             * Amazon GameLift uses this information when retrieving files from an S3 bucket that
