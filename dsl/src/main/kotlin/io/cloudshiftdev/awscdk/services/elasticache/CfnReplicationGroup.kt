...
internal constructor(
     ...
     * attribute.
     */
    public open fun attrReadEndPointAddresses(): String =
        unwrap(this).getAttrReadEndPointAddresses()
    ...
    public open fun attrReaderEndPointAddress(): String =
        unwrap(this).getAttrReaderEndPointAddress()
    ...
    public interface Builder {
         ...
         *
         * @param autoMinorVersionUpgrade If you are running Redis engine version 6.0 or later, set
         ...
         *
         * @param cacheSecurityGroupNames A list of cache security group names to associate with
         ...
         *
         * @param cacheSubnetGroupName The name of the cache subnet group to be used for the
         *   replication group.
         */
         ...
         * Compatible. Compatible mode allows your Redis clients to connect using both cluster mode
         * enabled and cluster mode disabled. After you migrate all Redis clients to use cluster
         * mode enabled, you can then complete cluster mode configuration and set the cluster mode
         * to Enabled. For more information, see
         ...
         *
         * @param engineVersion The version number of the cache engine to be used for the clusters
         ...
         *
         * @param notificationTopicArn The Amazon Resource Name (ARN) of the Amazon Simple
         ...
         * If `AutomaticFailoverEnabled` is `false` you can omit this parameter (it will default to
         * 1), or you can explicitly set it to a value between 2 and 6.
         *
         ...
         * If you set
         * [UseOnlineResharding](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-attribute-updatepolicy.html#cfn-attributes-updatepolicy-useonlineresharding)
         * to `true` , you can update `NumNodeGroups` without interruption. When
         * `UseOnlineResharding` is set to `false` , or is not specified, updating `NumNodeGroups`
         * results in
         * [replacement](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/using-cfn-updating-stacks-update-behaviors.html#update-replacement)
         * .
         *
         ...
         *
         * @param numNodeGroups An optional parameter that specifies the number of node groups
         ...
         *
         * @param preferredMaintenanceWindow Specifies the weekly time range during which
         *   maintenance on the cluster is performed.
         */
         ...
         *
         * @param replicasPerNodeGroup An optional parameter that specifies the number of replica
         *   nodes in each node group (shard).
         */
         ...
         * stored in Amazon S3.
         *
         * The snapshot files are used to populate the new replication group. The Amazon S3 object
         * name in the ARN cannot contain any commas. The new replication group will have the number
         * of node groups (console: shards) specified by the parameter *NumNodeGroups* or the number
         * of node groups configured by *NodeGroupConfiguration* regardless of the number of ARNs
         * specified here.
         *
         ...
         *
         * @param snapshotArns A list of Amazon Resource Names (ARN) that uniquely identify the
         ...
         * The name of a snapshot from which to restore data into the new replication group.
         *
         * The snapshot status changes to `restoring` while the new replication group is being
         * created.
         *
         ...
         *
         * @param snapshotWindow The daily time range (in UTC) during which ElastiCache begins
         ...
         *
         * @param snapshottingClusterId The cluster ID that is used as the daily snapshot source for
         ...
         * A list of tags to be added to this resource.
         *
         * Tags are comma-separated key,value pairs (e.g. Key= `myKey` , Value= `myKeyValue` . You
         * can include multiple tags as shown following: Key= `myKey` , Value= `myKeyValue` Key=
         * `mySecondKey` , Value= `mySecondKeyValue` . Tags on replication groups will be replicated
         * to all nodes.
         *
         ...
         *
         * @param transitEncryptionEnabled A flag that enables in-transit encryption when set to
         *   `true` .
         */
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.elasticache.CfnReplicationGroup.Builder.create(
                scope,
                id
            )
    ...
    public interface KinesisFirehoseDestinationDetailsProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: KinesisFirehoseDestinationDetailsProperty
            ): software.amazon.awscdk.services.elasticache.CfnReplicationGroup.KinesisFirehoseDestinationDetailsProperty =
    ...
    public interface LogDeliveryConfigurationRequestProperty {
        ...
        public interface Builder {
            /**
             * @param destinationDetails Configuration details of either a CloudWatch Logs
            ...
            public fun destinationDetails(
                destinationDetails: DestinationDetailsProperty.Builder.() -> Unit
            )
             ...
             *   [slow-log](https://docs.aws.amazon.com/https://redis.io/commands/slowlog) or
             *   `engine-log` .
             */
        ...
        private class BuilderImpl : Builder {
            ...
            override fun destinationDetails(destinationDetails: DestinationDetailsProperty) {
                cdkBuilder.destinationDetails(
                    destinationDetails.let(DestinationDetailsProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("ac403f668fc7e8e4373285dfb7c3f76cce364b31c49c3319d1b6d16e9fce7414")
            override fun destinationDetails(
                destinationDetails: DestinationDetailsProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: LogDeliveryConfigurationRequestProperty
            ): software.amazon.awscdk.services.elasticache.CfnReplicationGroup.LogDeliveryConfigurationRequestProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface NodeGroupConfigurationProperty {
         ...
         */
        public fun replicaAvailabilityZones(): List<String> =
        ...
        /**
         * A string of comma-separated values where the first set of values are the slot numbers
         * (zero based), and the second set of values are the keyspaces for each slot.
         *
         ...
         * number of slots. This cannot be updated later. Therefore, after updating the number of
         * node groups in this way, you should remove the value specified for the `Slots` property
         * of each `NodeGroupConfiguration` from the stack template, as it no longer reflects the
         * actual values in each node group. For more information, see
        ...
        public interface Builder {
            /**
             * @param nodeGroupId Either the ElastiCache for Redis supplied 4-digit id or a user
             *   supplied id for the node group these configuration values apply to.
             */
            public fun nodeGroupId(nodeGroupId: String)

            /**
             * @param primaryAvailabilityZone The Availability Zone where the primary node of this
            ...
            /**
             * @param slots A string of comma-separated values where the first set of values are the
             *   slot numbers (zero based), and the second set of values are the keyspaces for each
             ...
             * groups without interruption, ElastiCache evenly distributes the keyspaces between the
             * specified number of slots. This cannot be updated later. Therefore, after updating
             * the number of node groups in this way, you should remove the value specified for the
             * `Slots` property of each `NodeGroupConfiguration` from the stack template, as it no
             * longer reflects the actual values in each node group. For more information, see
             * [UseOnlineResharding Policy](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-attribute-updatepolicy.html#cfn-attributes-updatepolicy-useonlineresharding)
             * .
             */
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-elasticache-replicationgroup-nodegroupconfiguration.html#cfn-elasticache-replicationgroup-nodegroupconfiguration-primaryavailabilityzone)
             */
            override fun primaryAvailabilityZone(): String? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: NodeGroupConfigurationProperty
            ): software.amazon.awscdk.services.elasticache.CfnReplicationGroup.NodeGroupConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CloudWatchLogsDestinationDetailsProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CloudWatchLogsDestinationDetailsProperty
            ): software.amazon.awscdk.services.elasticache.CfnReplicationGroup.CloudWatchLogsDestinationDetailsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DestinationDetailsProperty {
         ...
         *
         * Note that this field is marked as required but only if Kinesis Data Firehose was chosen
         * as the destination.
         *
        ...
        public interface Builder {
            /**
             * @param cloudWatchLogsDetails The configuration details of the CloudWatch Logs
             *   destination. Note that this field is marked as required but only if CloudWatch Logs
            ...
            public fun cloudWatchLogsDetails(
                cloudWatchLogsDetails: CloudWatchLogsDestinationDetailsProperty.Builder.() -> Unit
            )

            /**
             * @param kinesisFirehoseDetails The configuration details of the Kinesis Data Firehose
             *   destination. Note that this field is marked as required but only if Kinesis Data
             *   Firehose was chosen as the destination.
             */
            ...
            public fun kinesisFirehoseDetails(
                kinesisFirehoseDetails: KinesisFirehoseDestinationDetailsProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
             ...
             *   was chosen as the destination.
             */
            override fun cloudWatchLogsDetails(
                cloudWatchLogsDetails: CloudWatchLogsDestinationDetailsProperty
            ) {
                cdkBuilder.cloudWatchLogsDetails(
                    cloudWatchLogsDetails.let(CloudWatchLogsDestinationDetailsProperty::unwrap)
                )
            }
             ...
             *   Firehose was chosen as the destination.
             */
            override fun kinesisFirehoseDetails(
                kinesisFirehoseDetails: KinesisFirehoseDestinationDetailsProperty
            ) {
                cdkBuilder.kinesisFirehoseDetails(
                    kinesisFirehoseDetails.let(KinesisFirehoseDestinationDetailsProperty::unwrap)
                )
            }
            ...
            override fun kinesisFirehoseDetails(
                ...
                kinesisFirehoseDetails(
                    KinesisFirehoseDestinationDetailsProperty(kinesisFirehoseDetails)
                )
        ...
        internal constructor(
             ...
             * The configuration details of the CloudWatch Logs destination.
             *
             * Note that this field is marked as required but only if CloudWatch Logs was chosen as
             * the destination.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-elasticache-replicationgroup-destinationdetails.html#cfn-elasticache-replicationgroup-destinationdetails-cloudwatchlogsdetails)
             */
             ...
             * The configuration details of the Kinesis Data Firehose destination.
             *
             * Note that this field is marked as required but only if Kinesis Data Firehose was
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DestinationDetailsProperty
            ): software.amazon.awscdk.services.elasticache.CfnReplicationGroup.DestinationDetailsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
