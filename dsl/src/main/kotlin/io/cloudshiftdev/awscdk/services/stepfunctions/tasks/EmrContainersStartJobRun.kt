...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * If `virtualClusterId` is from a JSON input path, an execution role must be provided. If
         * an execution role is provided, follow the documentation to update the role trust policy.
         *
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: EmrContainersStartJobRun
        ): software.amazon.awscdk.services.stepfunctions.tasks.EmrContainersStartJobRun =
            wrapped.cdkObject
    }
}
