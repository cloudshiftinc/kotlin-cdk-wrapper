...
internal constructor(
    ...
    public open fun credentialDurationSeconds(): Number? =
        unwrap(this).getCredentialDurationSeconds()
    ...
    public companion object {
        ...
        ): CfnRoleAlias = CfnRoleAlias(cdkObject)

        internal fun unwrap(
            wrapped: CfnRoleAlias
        ): software.amazon.awscdk.services.iot.CfnRoleAlias = wrapped.cdkObject
    }
}
