...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.elasticsearch.Domain,
    ...
    public interface Builder {
        ...
        /**
         * (deprecated) The hour in UTC during which the service takes an automated daily snapshot
         ...
         *   automated daily snapshot of the indices in the Amazon ES domain.
         * @deprecated use opensearchservice module instead
         */
        @Deprecated(message = "deprecated in CDK")
         ...
         * @deprecated use opensearchservice module instead
         */
        @Deprecated(message = "deprecated in CDK") public fun capacity(capacity: CapacityConfig)
        ...
        /**
         * (deprecated) The configurations of Amazon Elastic Block Store (Amazon EBS) volumes that
         ...
         * @deprecated use opensearchservice module instead
         */
        @Deprecated(message = "deprecated in CDK") public fun ebs(ebs: EbsOptions)
         ...
         *   Elasticsearch rather than replacing the entire domain resource, use the
         ...
         * @deprecated use opensearchservice module instead
         */
        @Deprecated(message = "deprecated in CDK") public fun enforceHttps(enforceHttps: Boolean)

        /**
         * (deprecated) Specifies options for fine-grained access control.
         *
         * Requires Elasticsearch version 6.7 or later. Enabling fine-grained access control also
         * requires encryption of data at rest and node-to-node encryption, along with enforced
         * HTTPS.
         *
         ...
         * @deprecated use opensearchservice module instead
         */
        @Deprecated(message = "deprecated in CDK") public fun logging(logging: LoggingOptions)
        ...
        /**
         * (deprecated) The list of security groups that are associated with the VPC endpoints for
         * the domain.
         *
         ...
         * @deprecated use opensearchservice module instead
         */
        @Deprecated(message = "deprecated in CDK") public fun version(version: ElasticsearchVersion)
         ...
         * @deprecated use opensearchservice module instead
         */
        @Deprecated(message = "deprecated in CDK") public fun vpc(vpc: IVpc)
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.elasticsearch.Domain =
            cdkBuilder.build()
    }
    ...
    public companion object {
        ...
        public fun fromDomainAttributes(
            ...
            software.amazon.awscdk.services.elasticsearch.Domain.fromDomainAttributes(
        ...
        public fun fromDomainEndpoint(
            ...
            software.amazon.awscdk.services.elasticsearch.Domain.fromDomainEndpoint(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    domainEndpoint
                )
