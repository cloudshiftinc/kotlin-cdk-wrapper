...
internal constructor(
    ...
    public interface Builder {
         ...
         * The ID of the Microsoft Team authorized with AWS Chatbot .
         *
         * To get the team ID, you must perform the initial authorization flow with Microsoft Teams
         * in the AWS Chatbot console. Then you can copy and paste the team ID from the console. For
         ...
         * The ID of the Microsoft Teams tenant.
         *
         * To get the tenant ID, you must perform the initial authorization flow with Microsoft
         * Teams in the AWS Chatbot console. Then you can copy and paste the tenant ID from the
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnMicrosoftTeamsChannelConfiguration
        ): software.amazon.awscdk.services.chatbot.CfnMicrosoftTeamsChannelConfiguration =
            wrapped.cdkObject
    }
}
