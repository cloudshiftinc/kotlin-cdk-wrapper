...
public interface TlsClientPolicy {
    ...
    public interface Builder {
        ...
        /**
         * @param mutualTlsCertificate Represents a client TLS certificate. The certificate will be
         *   sent only if the server requests it, enabling mutual TLS.
         */
        public fun mutualTlsCertificate(mutualTlsCertificate: MutualTlsCertificate)

        /**
         * @param ports TLS is enforced on the ports specified here. If no ports are specified, TLS
         *   will be enforced on all the ports.
         */
    ...
    private class BuilderImpl : Builder {
        ...
        public fun build(): software.amazon.awscdk.services.appmesh.TlsClientPolicy =
            cdkBuilder.build()
    }
    ...
    internal constructor(
        ...
        /** Represents the object for TLS validation context. */
        override fun validation(): TlsValidation =
