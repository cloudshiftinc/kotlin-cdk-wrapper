...
public interface SelectedSubnets {
     ...
     *
     * If this value is true, don't validate anything about the subnets. The count or identities are
     * not known yet, and the validation will most likely fail which will prevent a successful
     * lookup.
     *
     * Default: false
     */
    ...
    public interface Builder {
        ...
        /**
         * @param isPendingLookup The subnet selection is not actually real yet. If this value is
         *   true, don't validate anything about the subnets. The count or identities are not known
         *   yet, and the validation will most likely fail which will prevent a successful lookup.
         */
    ...
    private class BuilderImpl : Builder {
        ...
        override fun internetConnectivityEstablished(internetConnectivityEstablished: IDependable) {
            cdkBuilder.internetConnectivityEstablished(
                internetConnectivityEstablished.let(IDependable::unwrap)
            )
        }
    ...
    internal constructor(
         ...
         * The subnet selection is not actually real yet.
         *
         * If this value is true, don't validate anything about the subnets. The count or identities
         * are not known yet, and the validation will most likely fail which will prevent a
         * successful lookup.
         *
         * Default: false
         */
