...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param fallbackLocation An S3 location that is used to store files that have failed a
         *   direct upload.
         */
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.omics.CfnSequenceStore =
            cdkBuilder.build()
    }
