...
internal constructor(
    ...
    public interface Builder {
         ...
         * *Encrypted* is set to `true` , then the volume is encrypted using the default key
         * specified for your account. If your account does not have a default key, then the volume
         * is encrypted using the AWS managed key .
         *
         * Alternatively, if you want to specify a different key, you can specify one of the
         * following:
         * * Key ID. For example, 1234abcd-12ab-34cd-56ef-1234567890ab.
         * * Key alias. Specify the alias for the key, prefixed with `alias/` . For example, for a
         *   key with the alias `my_cmk` , use `alias/my_cmk` . Or to specify the AWS managed key ,
         *   use `alias/aws/ebs` .
         * * Key ARN. For example,
         ...
         *
         * @param throughput The throughput to provision for a volume, with a maximum of 1,000
         *   MiB/s.
         */
