...
public interface IProject : IResource, IGrantable, IConnectable, INotificationRuleSource {
    ...
    internal constructor(
        ...
        /**
         * Measures the number of builds that failed because of client error or because of a
         * timeout.
         *
         * Units: Count
         *
         ...
         * @param props
         */
        override fun metricFailedBuilds(): Metric =
         ...
         * @param options
         */
        override fun onBuildFailed(id: String): Rule =
         ...
         * @param options
         */
        override fun onBuildStarted(id: String): Rule =
         ...
         * @param options
         */
        override fun onPhaseChange(id: String): Rule =
