...
public interface IProject : IResource, IGrantable, IConnectable, INotificationRuleSource {
  ...
  private class Wrapper internal constructor(
    internal val cdkObject: software.amazon.awscdk.services.codebuild.IProject,
  ) : IProject {
    ...
    public override fun metricBuilds(arg0: MetricOptions): Metric =
        unwrap(this).metricBuilds(arg0.let(MetricOptions::unwrap)).let(Metric::wrap)

    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("be10b6ea6c0312aa2056fab98132d61a6bb7f2dc075bb9c159310319b5df338e")
    public override fun metricBuilds(arg0: MetricOptions.Builder.() -> Unit): Metric =
    ...
    public override fun metricFailedBuilds(arg0: MetricOptions): Metric =
        unwrap(this).metricFailedBuilds(arg0.let(MetricOptions::unwrap)).let(Metric::wrap)

    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("e76329c1f6088e6d3db1035e1618128c61f1efede7ac90f5da71b7dca18bc61d")
    public override fun metricFailedBuilds(arg0: MetricOptions.Builder.() -> Unit): Metric =
    ...
    public override fun metricSucceededBuilds(arg0: MetricOptions): Metric =
        unwrap(this).metricSucceededBuilds(arg0.let(MetricOptions::unwrap)).let(Metric::wrap)

    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("a9982ac7260f7a0b08fc3b8a431301c15086dcfa3a3f2a592651ec53b4756f34")
    public override fun metricSucceededBuilds(arg0: MetricOptions.Builder.() -> Unit): Metric =
    ...
    public override fun notifyOnBuildFailed(arg0: String, arg1: INotificationRuleTarget):
    ...
    public override fun notifyOnBuildSucceeded(arg0: String, arg1: INotificationRuleTarget):
    ...
    public override fun onBuildFailed(arg0: String): Rule =
        unwrap(this).onBuildFailed(arg0).let(Rule::wrap)

    public override fun onBuildFailed(arg0: String, arg1: OnEventOptions): Rule =
        unwrap(this).onBuildFailed(arg0, arg1.let(OnEventOptions::unwrap)).let(Rule::wrap)

    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("61bac02e7e7dfb811fb89b743d00a7ce9b4f450f7ba7a759ae905840cae795d8")
    public override fun onBuildFailed(arg0: String, arg1: OnEventOptions.Builder.() -> Unit): Rule =
        onBuildFailed(arg0, OnEventOptions(arg1))

    public override fun onBuildStarted(arg0: String): Rule =
        unwrap(this).onBuildStarted(arg0).let(Rule::wrap)

    public override fun onBuildStarted(arg0: String, arg1: OnEventOptions): Rule =
        unwrap(this).onBuildStarted(arg0, arg1.let(OnEventOptions::unwrap)).let(Rule::wrap)

    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("aa5fd6f3f4fd4c47805120e788079e181682a7808351afdd3a7512094b1f2bca")
    public override fun onBuildStarted(arg0: String, arg1: OnEventOptions.Builder.() -> Unit): Rule
        = onBuildStarted(arg0, OnEventOptions(arg1))

    public override fun onBuildSucceeded(arg0: String): Rule =
        unwrap(this).onBuildSucceeded(arg0).let(Rule::wrap)

    public override fun onBuildSucceeded(arg0: String, arg1: OnEventOptions): Rule =
        unwrap(this).onBuildSucceeded(arg0, arg1.let(OnEventOptions::unwrap)).let(Rule::wrap)

    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("fd12eb763bd8f9c97276262cd553c838b005c5207d64b8cfc38b391db01daf8f")
    public override fun onBuildSucceeded(arg0: String, arg1: OnEventOptions.Builder.() -> Unit):
        Rule = onBuildSucceeded(arg0, OnEventOptions(arg1))
    ...
    public override fun onPhaseChange(arg0: String): Rule =
        unwrap(this).onPhaseChange(arg0).let(Rule::wrap)

    public override fun onPhaseChange(arg0: String, arg1: OnEventOptions): Rule =
        unwrap(this).onPhaseChange(arg0, arg1.let(OnEventOptions::unwrap)).let(Rule::wrap)

    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("04a8a72e3fcbce6b30b4b5a2f8593dbdb3bce672a2f8532868248c61c9aa1473")
    public override fun onPhaseChange(arg0: String, arg1: OnEventOptions.Builder.() -> Unit): Rule =
