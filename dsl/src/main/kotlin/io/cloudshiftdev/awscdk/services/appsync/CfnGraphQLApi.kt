...
internal constructor(
     ...
     * [Discovering the real-time endpoint from the GraphQL endpoint](https://docs.aws.amazon.com/appsync/latest/devguide/real-time-websocket-client.html#handshake-details-to-establish-the-websocket-connection)
     * .
     */
    ...
    public open fun enhancedMetricsConfig(
        `value`: EnhancedMetricsConfigProperty.Builder.() -> Unit
    ...
    public open fun lambdaAuthorizerConfig(
        `value`: LambdaAuthorizerConfigProperty.Builder.() -> Unit
    ): Unit = lambdaAuthorizerConfig(LambdaAuthorizerConfigProperty(`value`))
    ...
    public open fun mergedApiExecutionRoleArn(): String? =
        unwrap(this).getMergedApiExecutionRoleArn()
    ...
    public open fun openIdConnectConfig(
        `value`: OpenIDConnectConfigProperty.Builder.() -> Unit
    ): Unit = openIdConnectConfig(OpenIDConnectConfigProperty(`value`))
    ...
    public interface Builder {
         ...
         *
         * @param additionalAuthenticationProviders A list of additional authentication providers
        ...
        /**
         * The value that indicates whether the GraphQL API is a standard API ( `GRAPHQL` ) or
         * merged API ( `MERGED` ).
         *
         * *WARNING* : If the `ApiType` has not been defined, *explicitly* setting it to `GRAPHQL`
         ...
         *
         * @param apiType The value that indicates whether the GraphQL API is a standard API (
         ...
         * Enables and controls the enhanced metrics feature.
         *
         * Enhanced metrics emit granular data on API usage and performance such as AppSync request
         * and error counts, latency, and cache hits/misses. All enhanced metric data is sent to
         * your CloudWatch account, and you can configure the types of data that will be sent.
         *
        ...
        public fun enhancedMetricsConfig(
            enhancedMetricsConfig: EnhancedMetricsConfigProperty.Builder.() -> Unit
        )
         ...
         *
         * @param environmentVariables A map containing the list of resources with their properties
         *   and environment variables.
         */
        public fun environmentVariables(environmentVariables: Any)

        /**
         * If no value is provided, the introspection configuration will be set to `ENABLED` by
         * default. This field will produce an error if the operation attempts to use the
         ...
         * when using the `AWS_LAMBDA` authorizer mode.
         *
         * Be aware that an AWS AppSync API may have only one Lambda authorizer configured at a
         * time.
         *
        ...
        public fun lambdaAuthorizerConfig(
            lambdaAuthorizerConfig: LambdaAuthorizerConfigProperty.Builder.() -> Unit
        )
         ...
         * source APIs at runtime and to prompt the `AUTO_MERGE` to update the merged API endpoint
         ...
         *
         * @param mergedApiExecutionRoleArn The AWS Identity and Access Management service role ARN
         *   for a merged API.
         */
        ...
        public fun openIdConnectConfig(
            openIdConnectConfig: OpenIDConnectConfigProperty.Builder.() -> Unit
        )
         ...
         * The maximum depth a query can have in a single request.
         *
         * Depth refers to the amount of nested levels allowed in the body of query. The default
         * value is `0` (or unspecified), which indicates there's no depth limit. If you set a
         * limit, it can be between `1` and `75` nested levels. This field will produce a limit
         * error if the operation falls out of bounds. Note that fields can still be set to nullable
         * or non-nullable. If a non-nullable field produces an error, the error will be thrown
         ...
         * specified, the limit value can be between `1` and `10000` . This field will produce a
         ...
         *
         * *WARNING* : If `Visibility` has not been defined, *explicitly* setting it to `GLOBAL` in
         * a template/stack update will result in an API replacement and new DNS values.
         *
         ...
         *
         * @param xrayEnabled A flag indicating whether to use AWS X-Ray tracing for this
         *   `GraphqlApi` .
         */
    ...
    private class BuilderImpl(
         ...
         *   for the `GraphqlApi` API.
         */
        override fun additionalAuthenticationProviders(
            additionalAuthenticationProviders: IResolvable
        ) {
            cdkBuilder.additionalAuthenticationProviders(
                additionalAuthenticationProviders.let(IResolvable::unwrap)
            )
        }
         ...
         */
        override fun additionalAuthenticationProviders(
            additionalAuthenticationProviders: List<Any>
        ) {
         ...
         */
        override fun additionalAuthenticationProviders(
            vararg additionalAuthenticationProviders: Any
        ...
        override fun enhancedMetricsConfig(enhancedMetricsConfig: EnhancedMetricsConfigProperty) {
            cdkBuilder.enhancedMetricsConfig(
                enhancedMetricsConfig.let(EnhancedMetricsConfigProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("32a3cbe12d2f9c1e1a862aab95ce5d1ed65deac5e1e157ce800b5bd5fb9660b0")
        override fun enhancedMetricsConfig(
            enhancedMetricsConfig: EnhancedMetricsConfigProperty.Builder.() -> Unit
         ...
         *   authorize AWS AppSync API access when using the `AWS_LAMBDA` authorizer mode.
         */
        override fun lambdaAuthorizerConfig(
            lambdaAuthorizerConfig: LambdaAuthorizerConfigProperty
        ) {
            cdkBuilder.lambdaAuthorizerConfig(
                lambdaAuthorizerConfig.let(LambdaAuthorizerConfigProperty::unwrap)
            )
        }
        ...
        override fun openIdConnectConfig(openIdConnectConfig: OpenIDConnectConfigProperty) {
            cdkBuilder.openIdConnectConfig(
                openIdConnectConfig.let(OpenIDConnectConfigProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("fe4a9b46f44d59c47b3c13cb4b1549218bdb0f63f34a8a03263e81ca1c843d27")
        override fun openIdConnectConfig(
            openIdConnectConfig: OpenIDConnectConfigProperty.Builder.() -> Unit
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("a451ad14d60acde1fe3c55adbbc11e432d8495048e155210873a9d30f0d2b986")
        override fun userPoolConfig(
            userPoolConfig: UserPoolConfigProperty.Builder.() -> Unit
        ...
        public fun build(): software.amazon.awscdk.services.appsync.CfnGraphQLApi =
            cdkBuilder.build()
    }
    ...
    public interface LogConfigProperty {
        ...
        public interface Builder {
            /**
             * @param cloudWatchLogsRoleArn The service role that AWS AppSync will assume to publish
             *   to Amazon CloudWatch Logs in your account.
             */
            public fun cloudWatchLogsRoleArn(cloudWatchLogsRoleArn: String)

            /**
             * @param excludeVerboseContent Set to TRUE to exclude sections that contain information
             *   such as headers, context, and evaluated mapping templates, regardless of logging
             *   level.
             */
    ...
    public interface AdditionalAuthenticationProviderProperty {
        ...
        public interface Builder {
            /**
             * @param authenticationType The authentication type for API key, AWS Identity and
             *   Access Management , OIDC, Amazon Cognito user pools , or AWS Lambda . Valid Values:
            ...
            public fun userPoolConfig(
                userPoolConfig: CognitoUserPoolConfigProperty.Builder.() -> Unit
            )
        }
        ...
        internal constructor(
            ...
            /**
             * The authentication type for API key, AWS Identity and Access Management , OIDC,
             * Amazon Cognito user pools , or AWS Lambda .
             *
             * Valid Values: `API_KEY` | `AWS_IAM` | `OPENID_CONNECT` | `AMAZON_COGNITO_USER_POOLS`
             * | `AWS_LAMBDA`
             *
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AdditionalAuthenticationProviderProperty
            ): software.amazon.awscdk.services.appsync.CfnGraphQLApi.AdditionalAuthenticationProviderProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface LambdaAuthorizerConfigProperty {
         ...
         *
         * *Note* : This Lambda function must have the following resource-based policy assigned to
         * it. When configuring Lambda authorizers in the console, this is done for you. To do so
        ...
        public interface Builder {
            /**
             * @param authorizerResultTtlInSeconds The number of seconds a response should be cached
             *   for. The default is 0 seconds, which disables caching. If you don't specify a value
             *   for `authorizerResultTtlInSeconds` , the default value is used. The maximum value
             *   is one hour (3600 seconds). The Lambda function can override this by returning a
             ...
             *   This may be a standard Lambda ARN, a version ARN ( `.../v3` ) or alias ARN.
             *
             * *Note* : This Lambda function must have the following resource-based policy assigned
            ...
            /**
             * @param identityValidationExpression A regular expression for validation of tokens
        ...
        internal constructor(
             ...
             *
             * The default is 0 seconds, which disables caching. If you don't specify a value for
             * `authorizerResultTtlInSeconds` , the default value is used. The maximum value is one
             * hour (3600 seconds). The Lambda function can override this by returning a
             * `ttlOverride` key in its response.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appsync-graphqlapi-lambdaauthorizerconfig.html#cfn-appsync-graphqlapi-lambdaauthorizerconfig-authorizerresultttlinseconds)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: LambdaAuthorizerConfigProperty
            ): software.amazon.awscdk.services.appsync.CfnGraphQLApi.LambdaAuthorizerConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface OpenIDConnectConfigProperty {
         ...
         *
         * This identifier is typically obtained when the Relying party is registered with the
         * OpenID identity provider. You can specify a regular expression so that AWS AppSync can
        ...
        public interface Builder {
            /**
             * @param authTtl The number of milliseconds that a token is valid after being
             *   authenticated.
             */
            public fun authTtl(authTtl: Number)

            /**
             * @param clientId The client identifier of the Relying party at the OpenID identity
             *   provider. This identifier is typically obtained when the Relying party is
             *   registered with the OpenID identity provider. You can specify a regular expression
             *   so that AWS AppSync can validate against multiple client identifiers at a time.
             */
            public fun clientId(clientId: String)

            /**
             * @param iatTtl The number of milliseconds that a token is valid after it's issued to a
             *   user.
             */
            public fun iatTtl(iatTtl: Number)

            /**
             * @param issuer The issuer for the OIDC configuration. The issuer returned by discovery
        ...
        internal constructor(
             ...
             *
             * This identifier is typically obtained when the Relying party is registered with the
             * OpenID identity provider. You can specify a regular expression so that AWS AppSync
             ...
             * The issuer for the OIDC configuration.
             *
             * The issuer returned by discovery must exactly match the value of `iss` in the ID
             * token.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appsync-graphqlapi-openidconnectconfig.html#cfn-appsync-graphqlapi-openidconnectconfig-issuer)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: OpenIDConnectConfigProperty
            ): software.amazon.awscdk.services.appsync.CfnGraphQLApi.OpenIDConnectConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CognitoUserPoolConfigProperty {
        ...
        public interface Builder {
            /**
             * @param appIdClientRegex A regular expression for validating the incoming Amazon
             *   Cognito user pool app client ID. If this value isn't set, no filtering is applied.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CognitoUserPoolConfigProperty
            ): software.amazon.awscdk.services.appsync.CfnGraphQLApi.CognitoUserPoolConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface UserPoolConfigProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param defaultAction The action that you want your GraphQL API to take when a request
             *   that uses Amazon Cognito user pool authentication doesn't match the Amazon Cognito
             *   user pool configuration. When specifying Amazon Cognito user pools as the default
             *   authentication, you must set the value for `DefaultAction` to `ALLOW` if specifying
        ...
        internal constructor(
             ...
             * configuration.
             *
             * When specifying Amazon Cognito user pools as the default authentication, you must set
             * the value for `DefaultAction` to `ALLOW` if specifying
             * `AdditionalAuthenticationProviders` .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appsync-graphqlapi-userpoolconfig.html#cfn-appsync-graphqlapi-userpoolconfig-defaultaction)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: UserPoolConfigProperty
            ): software.amazon.awscdk.services.appsync.CfnGraphQLApi.UserPoolConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface EnhancedMetricsConfigProperty {
         ...
         *   in the request.
         * * `PER_DATA_SOURCE_METRICS` : Records and emits metric data for data sources that have
         ...
         * * `FULL_REQUEST_RESOLVER_METRICS` : Records and emits metric data for all resolvers in
         *   the request.
        ...
        public interface Builder {
            /**
             * @param dataSourceLevelMetricsBehavior Controls how data source metrics will be
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: EnhancedMetricsConfigProperty
            ): software.amazon.awscdk.services.appsync.CfnGraphQLApi.EnhancedMetricsConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
