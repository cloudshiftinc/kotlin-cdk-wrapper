...
internal constructor(
    ...
    public open fun desiredDeliveryMediums(): List<String> =
        unwrap(this).getDesiredDeliveryMediums() ?: emptyList()
    ...
    public interface Builder {
        ...
        /**
         * Set to `RESEND` to resend the invitation message to a user that already exists and reset
         * the expiration limit on the user's account.
         *
         ...
         *
         * @param userAttributes An array of name-value pairs that contain user attributes and
         *   attribute values.
         */
         ...
         * trigger.
         *
         * This set of key-value pairs are for custom validation of information that you collect
         * from your users but don't need to retain.
         *
         * Your Lambda function can analyze this additional data and act on it. Your function might
         * perform external API operations like logging user attributes and validation data to
         * Amazon CloudWatch Logs. Validation data might also affect the response that your function
         * returns to Amazon Cognito, like automatically confirming the user if they sign up from
         * within your network.
         *
         ...
         *
         * @param validationData Temporary user attributes that contribute to the outcomes of your
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.cognito.CfnUserPoolUser =
            cdkBuilder.build()
    }
