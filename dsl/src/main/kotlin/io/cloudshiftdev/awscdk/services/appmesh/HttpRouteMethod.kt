...
public enum class HttpRouteMethod(
  ...
  public companion object {
    internal fun wrap(cdkObject: software.amazon.awscdk.services.appmesh.HttpRouteMethod):
        HttpRouteMethod = when (cdkObject) {
      ...
      software.amazon.awscdk.services.appmesh.HttpRouteMethod.DELETE -> HttpRouteMethod.DELETE
      software.amazon.awscdk.services.appmesh.HttpRouteMethod.CONNECT -> HttpRouteMethod.CONNECT
      software.amazon.awscdk.services.appmesh.HttpRouteMethod.OPTIONS -> HttpRouteMethod.OPTIONS
      software.amazon.awscdk.services.appmesh.HttpRouteMethod.TRACE -> HttpRouteMethod.TRACE
      software.amazon.awscdk.services.appmesh.HttpRouteMethod.PATCH -> HttpRouteMethod.PATCH
    }

    internal fun unwrap(wrapped: HttpRouteMethod):
