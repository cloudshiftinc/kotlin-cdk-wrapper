...
internal constructor(
    ...
    public companion object {
        public fun dynamoDbDeleteItem(keyName: String, idArg: String): MappingTemplate =
            software.amazon.awscdk.services.appsync.MappingTemplate.dynamoDbDeleteItem(
                    keyName,
                    idArg
                )
                .let(MappingTemplate::wrap)
        ...
        public fun dynamoDbGetItem(
            ...
            software.amazon.awscdk.services.appsync.MappingTemplate.dynamoDbGetItem(
                    keyName,
                    idArg,
                    consistentRead
                )
        ...
        public fun dynamoDbPutItem(key: PrimaryKey, values: AttributeValues): MappingTemplate =
            software.amazon.awscdk.services.appsync.MappingTemplate.dynamoDbPutItem(
                    key.let(PrimaryKey::unwrap),
                    values.let(AttributeValues::unwrap)
                )
                .let(MappingTemplate::wrap)

        public fun dynamoDbQuery(cond: KeyCondition): MappingTemplate =
            software.amazon.awscdk.services.appsync.MappingTemplate.dynamoDbQuery(
                    cond.let(KeyCondition::unwrap)
                )
                .let(MappingTemplate::wrap)
        ...
        public fun dynamoDbResultItem(): MappingTemplate =
            software.amazon.awscdk.services.appsync.MappingTemplate.dynamoDbResultItem()
                .let(MappingTemplate::wrap)

        public fun dynamoDbResultList(): MappingTemplate =
            software.amazon.awscdk.services.appsync.MappingTemplate.dynamoDbResultList()
                .let(MappingTemplate::wrap)

        public fun dynamoDbScanTable(): MappingTemplate =
            software.amazon.awscdk.services.appsync.MappingTemplate.dynamoDbScanTable()
                .let(MappingTemplate::wrap)
        ...
        public fun fromFile(fileName: String): MappingTemplate =
            software.amazon.awscdk.services.appsync.MappingTemplate.fromFile(fileName)
                .let(MappingTemplate::wrap)

        public fun fromString(template: String): MappingTemplate =
            software.amazon.awscdk.services.appsync.MappingTemplate.fromString(template)
                .let(MappingTemplate::wrap)

        public fun lambdaRequest(): MappingTemplate =
            software.amazon.awscdk.services.appsync.MappingTemplate.lambdaRequest()
                .let(MappingTemplate::wrap)
        ...
        public fun lambdaResult(): MappingTemplate =
            software.amazon.awscdk.services.appsync.MappingTemplate.lambdaResult()
                .let(MappingTemplate::wrap)
