...
public interface CloudMapOptions {
    ...
    public interface Builder {
        /**
         * @param cloudMapNamespace The service discovery namespace for the Cloud Map service to
         *   attach to the ECS service.
         */
        ...
        /**
         * @param dnsRecordType The DNS record type that you want AWS Cloud Map to create. The
         *   supported record types are A or SRV.
         */
        public fun dnsRecordType(dnsRecordType: DnsRecordType)

        /**
         * @param dnsTtl The amount of time that you want DNS resolvers to cache the settings for
         *   this record.
         */
         ...
         *   health status of a service instance. NOTE: This is used for HealthCheckCustomConfig
         */
