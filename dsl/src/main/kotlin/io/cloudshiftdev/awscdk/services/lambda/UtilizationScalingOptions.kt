...
public interface UtilizationScalingOptions : BaseTargetTrackingProps {
    ...
    public interface Builder {
        ...
        /**
         * @param utilizationTarget Utilization target for the attribute. For example, .5 indicates
         *   that 50 percent of allocated provisioned concurrency is in use.
         */
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: UtilizationScalingOptions
