...
internal constructor(
     ...
     * @param options
     */
    public override fun addApiKey(id: String): IApiKey =
        unwrap(this).addApiKey(id).let(IApiKey::wrap)
     ...
     *
     * Note that this is separate from the execute-api ARN for methods and resources within this
     * stage.
     */
    ...
    public companion object {
        ...
        ): StageBase = Wrapper(cdkObject)

        internal fun unwrap(
            wrapped: StageBase
        ): software.amazon.awscdk.services.apigateway.StageBase = (wrapped as Wrapper).cdkObject
    }
}
