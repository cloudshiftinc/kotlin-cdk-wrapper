...
internal constructor(
    ...
    public open fun asyncInferenceConfig(
        `value`: AsyncInferenceConfigProperty.Builder.() -> Unit
    ...
    public interface Builder {
         ...
         *
         * @param asyncInferenceConfig Specifies configuration for how an endpoint performs
        ...
        public fun asyncInferenceConfig(
            asyncInferenceConfig: AsyncInferenceConfigProperty.Builder.() -> Unit
        )
        ...
        public fun dataCaptureConfig(
            dataCaptureConfig: DataCaptureConfigProperty.Builder.() -> Unit
        )
         ...
         * request a `KmsKeyId` when using an instance type with local storage. If any of the models
         * that you specify in the `ProductionVariants` parameter use nitro-based instances with
         * local storage, do not specify a value for the `KmsKeyId` parameter. If you specify a
         * value for `KmsKeyId` when using any nitro-based instances with local storage, the call to
         ...
         *
         * @param productionVariants A list of `ProductionVariant` objects, one for each model that
         ...
         * production traffic replicated from the model specified on `ProductionVariants` . If you
         * use this field, you can only specify one variant for `ProductionVariants` and one variant
    ...
    private class BuilderImpl(
        ...
        override fun asyncInferenceConfig(asyncInferenceConfig: AsyncInferenceConfigProperty) {
            cdkBuilder.asyncInferenceConfig(
                asyncInferenceConfig.let(AsyncInferenceConfigProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("5b161f3d4c9c90e2a50a1acb77024e6445bdc5c90081a5331e349cfdd02a5eff")
        override fun asyncInferenceConfig(
            asyncInferenceConfig: AsyncInferenceConfigProperty.Builder.() -> Unit
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("c77feac906306e2d425d19ecb2dbb536e58a1389beb090dad924c75955f10ecf")
        override fun dataCaptureConfig(
            dataCaptureConfig: DataCaptureConfigProperty.Builder.() -> Unit
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("4cb18e4f82559478eb0db3989658df1207cb2f2ba889ad6285241ee2b2bf5795")
        override fun explainerConfig(
            explainerConfig: ExplainerConfigProperty.Builder.() -> Unit
        ): Unit = explainerConfig(ExplainerConfigProperty(explainerConfig))
    ...
    public interface ServerlessConfigProperty {
        ...
        public interface Builder {
            /**
             * @param maxConcurrency The maximum number of concurrent invocations your serverless
             *   endpoint can process.
             */
            public fun maxConcurrency(maxConcurrency: Number)

            /**
             * @param memorySizeInMb The memory size of your serverless endpoint. Valid values are
             *   in 1 GB increments: 1024 MB, 2048 MB, 3072 MB, 4096 MB, 5120 MB, or 6144 MB.
             */
        ...
        internal constructor(
             ...
             * The memory size of your serverless endpoint.
             *
             * Valid values are in 1 GB increments: 1024 MB, 2048 MB, 3072 MB, 4096 MB, 5120 MB, or
             * 6144 MB.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-sagemaker-endpointconfig-serverlessconfig.html#cfn-sagemaker-endpointconfig-serverlessconfig-memorysizeinmb)
             */
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-sagemaker-endpointconfig-serverlessconfig.html#cfn-sagemaker-endpointconfig-serverlessconfig-provisionedconcurrency)
             */
            override fun provisionedConcurrency(): Number? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ServerlessConfigProperty
            ): software.amazon.awscdk.services.sagemaker.CfnEndpointConfig.ServerlessConfigProperty =
    ...
    public interface AsyncInferenceNotificationConfigProperty {
        ...
        public interface Builder {
             ...
             *
             * The inference response is included only if the response size is less than or equal to
             * 128 KB.
             */
            ...
            /**
             * @param successTopic Amazon SNS topic to post a notification to when an inference
             *   completes successfully. If no topic is provided, no notification is sent on
             *   success.
             */
        ...
        private class BuilderImpl : Builder {
             ...
             * 128 KB.
             */
            override fun includeInferenceResponseIn(
                vararg includeInferenceResponseIn: String
            ): Unit = includeInferenceResponseIn(includeInferenceResponseIn.toList())
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AsyncInferenceNotificationConfigProperty
            ): software.amazon.awscdk.services.sagemaker.CfnEndpointConfig.AsyncInferenceNotificationConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface AsyncInferenceConfigProperty {
        ...
        public interface Builder {
            /**
             * @param clientConfig Configures the behavior of the client used by SageMaker to
            ...
            public fun clientConfig(
                clientConfig: AsyncInferenceClientConfigProperty.Builder.() -> Unit
            )
            ...
            public fun outputConfig(
                outputConfig: AsyncInferenceOutputConfigProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun clientConfig(clientConfig: AsyncInferenceClientConfigProperty) {
                cdkBuilder.clientConfig(
                    clientConfig.let(AsyncInferenceClientConfigProperty::unwrap)
                )
            }
            ...
            override fun outputConfig(outputConfig: AsyncInferenceOutputConfigProperty) {
                cdkBuilder.outputConfig(
                    outputConfig.let(AsyncInferenceOutputConfigProperty::unwrap)
                )
            }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AsyncInferenceConfigProperty
            ): software.amazon.awscdk.services.sagemaker.CfnEndpointConfig.AsyncInferenceConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ClarifyTextConfigProperty {
         ...
         * [ISO 639-3](https://docs.aws.amazon.com/https://en.wikipedia.org/wiki/ISO_639-3) code of
        ...
        public interface Builder {
            /**
             * @param granularity The unit of granularity for the analysis of text features. For
             ...
             *   https://en.wikipedia.org/wiki/List_of_ISO_639-1_codes) or
             *   [ISO 639-3](https://docs.aws.amazon.com/https://en.wikipedia.org/wiki/ISO_639-3)
             *   code of a supported language.
             *
             * For a mix of multiple languages, use code `'xx'` .
             */
        ...
        internal constructor(
             ...
             * The unit of granularity for the analysis of text features.
             *
             * For example, if the unit is `'token'` , then each token (like a word in English) of
             * the text is treated as a feature. SHAP values are computed for each unit/feature.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-sagemaker-endpointconfig-clarifytextconfig.html#cfn-sagemaker-endpointconfig-clarifytextconfig-granularity)
             */
             ...
             * [ISO 639-1](https://docs.aws.amazon.com/
             * https://en.wikipedia.org/wiki/List_of_ISO_639-1_codes) or
             * [ISO 639-3](https://docs.aws.amazon.com/https://en.wikipedia.org/wiki/ISO_639-3) code
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ClarifyTextConfigProperty
            ): software.amazon.awscdk.services.sagemaker.CfnEndpointConfig.ClarifyTextConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface AsyncInferenceClientConfigProperty {
        ...
        public interface Builder {
            /**
             * @param maxConcurrentInvocationsPerInstance The maximum number of concurrent requests
             *   sent by the SageMaker client to the model container. If no value is provided,
             *   SageMaker will choose an optimal value for you.
             */
            public fun maxConcurrentInvocationsPerInstance(
        ...
        private class BuilderImpl : Builder {
             ...
             *   SageMaker will choose an optimal value for you.
             */
            override fun maxConcurrentInvocationsPerInstance(
                maxConcurrentInvocationsPerInstance: Number
            ) {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AsyncInferenceClientConfigProperty
            ): software.amazon.awscdk.services.sagemaker.CfnEndpointConfig.AsyncInferenceClientConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CaptureContentTypeHeaderProperty {
         ...
         */
        public fun csvContentTypes(): List<String> =
            unwrap(this).getCsvContentTypes() ?: emptyList()
         ...
         */
        public fun jsonContentTypes(): List<String> =
            unwrap(this).getJsonContentTypes() ?: emptyList()
        ...
        public interface Builder {
             ...
             *   captures. For the endpoint to capture the data, you must also specify the content
             *   type when you invoke the endpoint.
             */
            ...
            /**
             * @param jsonContentTypes A list of the JSON content types of the data that the
             *   endpoint captures. For the endpoint to capture the data, you must also specify the
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-sagemaker-endpointconfig-capturecontenttypeheader.html#cfn-sagemaker-endpointconfig-capturecontenttypeheader-csvcontenttypes)
             */
            override fun csvContentTypes(): List<String> =
                unwrap(this).getCsvContentTypes() ?: emptyList()
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-sagemaker-endpointconfig-capturecontenttypeheader.html#cfn-sagemaker-endpointconfig-capturecontenttypeheader-jsoncontenttypes)
             */
            override fun jsonContentTypes(): List<String> =
                unwrap(this).getJsonContentTypes() ?: emptyList()
        }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CaptureContentTypeHeaderProperty
            ): software.amazon.awscdk.services.sagemaker.CfnEndpointConfig.CaptureContentTypeHeaderProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ClarifyInferenceConfigProperty {
         ...
         *
         * For example, a `ContentTemplate` string `'{"myfeatures":$features}'` will format a list
         * of features `[1,2,3]` into the record string `'{"myfeatures":[1,2,3]}'` . Required only
         ...
         *
         * If provided, these are included in the endpoint response payload to help readability of
         * the `InvokeEndpoint` output. See the
         ...
         * `'text'` string (for example, `['text']` ). If `FeatureTypes` is not provided, the
         * explainer infers the feature types based on the baseline data. The feature types are
         * included in the endpoint response payload. For additional information see the
         * [response](https://docs.aws.amazon.com/sagemaker/latest/dg/clarify-online-explainability-invoke-endpoint.html#clarify-online-explainability-response)
         * section under *Invoke the endpoint* in the Developer Guide for more information.
         *
         ...
         * querying the model container for the predictions of a
        ...
        public interface Builder {
            /**
             * @param contentTemplate A template string used to format a JSON record into an
            ...
            /**
             * @param featureHeaders The names of the features. If provided, these are included in
             *   the endpoint response payload to help readability of the `InvokeEndpoint` output.
             *   See the
             *   [Response](https://docs.aws.amazon.com/sagemaker/latest/dg/clarify-online-explainability-invoke-endpoint.html#clarify-online-explainability-response)
             *   section under *Invoke the endpoint* in the Developer Guide for more information.
             */
            ...
            /**
             * @param featureTypes A list of data types of the features (optional). Applicable only
             *   to NLP explainability. If provided, `FeatureTypes` must have at least one `'text'`
             *   string (for example, `['text']` ). If `FeatureTypes` is not provided, the explainer
             *   infers the feature types based on the baseline data. The feature types are included
             *   in the endpoint response payload. For additional information see the
             *   [response](https://docs.aws.amazon.com/sagemaker/latest/dg/clarify-online-explainability-invoke-endpoint.html#clarify-online-explainability-response)
             *   section under *Invoke the endpoint* in the Developer Guide for more information.
             */
            ...
            /**
             * @param featuresAttribute Provides the JMESPath expression to extract the features
             *   from a model container input in JSON Lines format. For example, if
             *   `FeaturesAttribute` is the JMESPath expression `'myfeatures'` , it extracts a list
             *   of features `[1,2,3]` from request data `'{"myfeatures":[1,2,3]}'` .
             */
            public fun featuresAttribute(featuresAttribute: String)

            /**
             * @param labelAttribute A JMESPath expression used to locate the list of label headers
             *   in the model container output. *Example* : If the model container output of a batch
             *   request is `'{"labels":["cat","dog","fish"],"probability":[0.6,0.3,0.1]}'` , then
             *   set `LabelAttribute` to `'labels'` to extract the list of label headers
             *   `["cat","dog","fish"]`
             */
            public fun labelAttribute(labelAttribute: String)

            /**
             * @param labelHeaders For multiclass classification problems, the label headers are the
             *   names of the classes. Otherwise, the label header is the name of the predicted
             *   label. These are used to help readability for the output of the `InvokeEndpoint`
             *   API. See the
             *   [response](https://docs.aws.amazon.com/sagemaker/latest/dg/clarify-online-explainability-invoke-endpoint.html#clarify-online-explainability-response)
             *   section under *Invoke the endpoint* in the Developer Guide for more information. If
             *   there are no label headers in the model container output, provide them manually
             ...
             *   headers from model container output in CSV format. *Example for a multiclass
             *   model:* If the model container output consists of label headers followed by
             *   probabilities: `'"[\'cat\',\'dog\',\'fish\']","[0.1,0.6,0.3]"'` , set `LabelIndex`
             *   to `0` to select the label headers `['cat','dog','fish']` .
             */
            public fun labelIndex(labelIndex: Number)

            /**
             * @param maxPayloadInMb The maximum payload size (MB) allowed of a request from the
             *   explainer to the model container. Defaults to `6` MB.
             */
            public fun maxPayloadInMb(maxPayloadInMb: Number)

            /**
             * @param maxRecordCount The maximum number of records in a request that the model
             *   container can process when querying the model container for the predictions of a
             *   [synthetic dataset](https://docs.aws.amazon.com/sagemaker/latest/dg/clarify-online-explainability-create-endpoint.html#clarify-online-explainability-create-endpoint-synthetic)
             ...
             *   one record per request. A value of 2 or greater means that the model expects batch
             *   requests, which can reduce overhead and speed up the inferencing process. If this
             ...
             *   score) from the model container output if the model container is in JSON Lines
             *   format. *Example* : If the model container output of a single request is
             *   `'{"predicted_label":1,"probability":0.6}'` , then set `ProbabilityAttribute` to
             *   `'probability'` .
             */
            ...
            /**
             * @param probabilityIndex A zero-based index used to extract a probability value
             *   (score) or list from model container output in CSV format. If this value is not
             *   provided, the entire model container output will be treated as a probability value
             *   (score) or list.
             *
             * *Example for a single class model:* If the model container output consists of a
             * string-formatted prediction label followed by its probability: `'1,0.6'` , set
        ...
        internal constructor(
             ...
             * input.
             *
             * For example, a `ContentTemplate` string `'{"myfeatures":$features}'` will format a
             * list of features `[1,2,3]` into the record string `'{"myfeatures":[1,2,3]}'` .
             ...
             * The names of the features.
             *
             * If provided, these are included in the endpoint response payload to help readability
             * of the `InvokeEndpoint` output. See the
             * [Response](https://docs.aws.amazon.com/sagemaker/latest/dg/clarify-online-explainability-invoke-endpoint.html#clarify-online-explainability-response)
             * section under *Invoke the endpoint* in the Developer Guide for more information.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-sagemaker-endpointconfig-clarifyinferenceconfig.html#cfn-sagemaker-endpointconfig-clarifyinferenceconfig-featureheaders)
             */
            override fun featureHeaders(): List<String> =
                unwrap(this).getFeatureHeaders() ?: emptyList()

            /**
             * A list of data types of the features (optional).
             *
             * Applicable only to NLP explainability. If provided, `FeatureTypes` must have at least
             * one `'text'` string (for example, `['text']` ). If `FeatureTypes` is not provided,
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-sagemaker-endpointconfig-clarifyinferenceconfig.html#cfn-sagemaker-endpointconfig-clarifyinferenceconfig-featuretypes)
             */
            override fun featureTypes(): List<String> =
                unwrap(this).getFeatureTypes() ?: emptyList()
             ...
             * help readability for the output of the `InvokeEndpoint` API. See the
             * [response](https://docs.aws.amazon.com/sagemaker/latest/dg/clarify-online-explainability-invoke-endpoint.html#clarify-online-explainability-response)
             * section under *Invoke the endpoint* in the Developer Guide for more information. If
             * there are no label headers in the model container output, provide them manually using
             * this parameter.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-sagemaker-endpointconfig-clarifyinferenceconfig.html#cfn-sagemaker-endpointconfig-clarifyinferenceconfig-labelheaders)
             */
            override fun labelHeaders(): List<String> =
                unwrap(this).getLabelHeaders() ?: emptyList()
             ...
             * headers followed by probabilities: `'"[\'cat\',\'dog\',\'fish\']","[0.1,0.6,0.3]"'` ,
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ClarifyInferenceConfigProperty
            ): software.amazon.awscdk.services.sagemaker.CfnEndpointConfig.ClarifyInferenceConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ProductionVariantProperty {
         ...
         *
         * By default, SSM access is disabled for all production variants behind an endpoint. You
         * can turn on or turn off SSM access for a production variant behind an existing endpoint
         * by creating a new endpoint configuration and calling `UpdateEndpoint` .
         *
        ...
        public interface Builder {
             ...
             *   production variant. EI instances provide on-demand GPU computing for inference. For
            ...
            /**
             * @param containerStartupHealthCheckTimeoutInSeconds The timeout value, in seconds, for
             *   your inference container to pass health check by SageMaker Hosting. For more
            ...
            /**
             * @param enableSsmAccess You can use this parameter to turn on native AWS Systems
             *   Manager (SSM) access for a production variant behind an endpoint. By default, SSM
             *   access is disabled for all production variants behind an endpoint. You can turn on
             *   or turn off SSM access for a production variant behind an existing endpoint by
            ...
            /**
             * @param initialVariantWeight Determines initial traffic distribution among all of the
             *   models that you specify in the endpoint configuration. The traffic to a production
             *   variant is determined by the ratio of the `VariantWeight` to the sum of all
             *   `VariantWeight` values across all ProductionVariants. If unspecified, it defaults
             *   to 1.0.
             */
            ...
            public fun managedInstanceScaling(
                managedInstanceScaling: ManagedInstanceScalingProperty.Builder.() -> Unit
            )

            /**
             * @param modelDataDownloadTimeoutInSeconds The timeout value, in seconds, to download
             *   and extract the model that you want to host from Amazon S3 to the individual
            ...
            /**
             * @param modelName The name of the model that you want to host. This is the name that
            ...
            /**
             * @param serverlessConfig The serverless configuration for an endpoint. Specifies a
             *   serverless endpoint configuration instead of an instance-based endpoint
             *   configuration.
             */
            ...
            public fun serverlessConfig(
                serverlessConfig: ServerlessConfigProperty.Builder.() -> Unit
            )
            ...
            /**
             * @param volumeSizeInGb The size, in GB, of the ML storage volume attached to
             *   individual inference instance associated with the production variant. Currently
        ...
        private class BuilderImpl : Builder {
             ...
             *   .
             */
            override fun containerStartupHealthCheckTimeoutInSeconds(
                containerStartupHealthCheckTimeoutInSeconds: Number
            ) {
            ...
            /** @param managedInstanceScaling the value to be set. */
            override fun managedInstanceScaling(
                managedInstanceScaling: ManagedInstanceScalingProperty
            ) {
                cdkBuilder.managedInstanceScaling(
                    managedInstanceScaling.let(ManagedInstanceScalingProperty::unwrap)
                )
            }
             ...
             *   inference instance associated with this production variant.
             */
            override fun modelDataDownloadTimeoutInSeconds(
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("2507a2cd03e4f8e17a6d899f02b51fb4fbbd89145598c29b99e68027686dc3ae")
            override fun routingConfig(
                routingConfig: RoutingConfigProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * You can turn on or turn off SSM access for a production variant behind an existing
             ...
             * to the sum of all `VariantWeight` values across all ProductionVariants. If
             ...
             * host from Amazon S3 to the individual inference instance associated with this
             * production variant.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-sagemaker-endpointconfig-productionvariant.html#cfn-sagemaker-endpointconfig-productionvariant-modeldatadownloadtimeoutinseconds)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ProductionVariantProperty
            ): software.amazon.awscdk.services.sagemaker.CfnEndpointConfig.ProductionVariantProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ManagedInstanceScalingProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ManagedInstanceScalingProperty
            ): software.amazon.awscdk.services.sagemaker.CfnEndpointConfig.ManagedInstanceScalingProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ClarifyShapConfigProperty {
         ...
         * on latency of explainability requests. For more information, see the *Synthetic data* of
         ...
         * units (false) for model predictions.
         *
         * Defaults to false.
         *
        ...
        public interface Builder {
            /**
             * @param numberOfSamples The number of samples to be used for analysis by the Kernal
             *   SHAP algorithm.
             *
            ...
            public fun shapBaselineConfig(
                shapBaselineConfig: ClarifyShapBaselineConfigProperty.Builder.() -> Unit
            )
            ...
            /**
             * @param useLogit A Boolean toggle to indicate if you want to use the logit function
             *   (true) or log-odds units (false) for model predictions. Defaults to false.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            override fun shapBaselineConfig(shapBaselineConfig: ClarifyShapBaselineConfigProperty) {
                cdkBuilder.shapBaselineConfig(
                    shapBaselineConfig.let(ClarifyShapBaselineConfigProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("44aefe325dc16ac11efdebc723e4ef1555d693949ab2ed27cb854537e5ad5c16")
            override fun shapBaselineConfig(
                shapBaselineConfig: ClarifyShapBaselineConfigProperty.Builder.() -> Unit
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("b91c22d36031d535f6f206b20d3bc0e1f205b2edf557d1a5e89ad765b0363479")
            override fun textConfig(
                textConfig: ClarifyTextConfigProperty.Builder.() -> Unit
            ): Unit = textConfig(ClarifyTextConfigProperty(textConfig))
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ClarifyShapConfigProperty
            ): software.amazon.awscdk.services.sagemaker.CfnEndpointConfig.ClarifyShapConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DataCaptureConfigProperty {
         ...
         * (https://docs.aws.amazon.com/sagemaker/latest/APIReference/API_CreateModel.html) request.
        ...
        public interface Builder {
            /**
             * @param captureContentTypeHeader A list of the JSON and CSV content type that the
             *   endpoint captures.
             */
             ...
             *   endpoint captures.
             */
            public fun captureContentTypeHeader(
            ...
            public fun captureContentTypeHeader(
                captureContentTypeHeader: CaptureContentTypeHeaderProperty.Builder.() -> Unit
            )

            /**
             * @param captureOptions Specifies whether the endpoint captures input data to your
             *   model, output data from your model, or both.
             */
             ...
             *   The KmsKeyId can be any of the following formats: Key ID:
             *   1234abcd-12ab-34cd-56ef-1234567890ab Key ARN:
             *   arn:aws:kms:us-west-2:111122223333:key/1234abcd-12ab-34cd-56ef-1234567890ab Alias
             *   name: alias/ExampleAlias Alias name ARN:
             *   arn:aws:kms:us-west-2:111122223333:alias/ExampleAlias If you don't provide a KMS
             *   key ID, Amazon SageMaker uses the default KMS key for Amazon S3 for your role's
             *   account. For more information, see KMS-Managed Encryption Keys
             ...
             *   (http://docs.aws.amazon.com/kms/latest/developerguide/key-policies.html) in the AWS
        ...
        private class BuilderImpl : Builder {
            ...
            override fun captureContentTypeHeader(captureContentTypeHeader: IResolvable) {
                cdkBuilder.captureContentTypeHeader(
                    captureContentTypeHeader.let(IResolvable::unwrap)
                )
            }
            ...
            override fun captureContentTypeHeader(
                ...
                cdkBuilder.captureContentTypeHeader(
                    captureContentTypeHeader.let(CaptureContentTypeHeaderProperty::unwrap)
                )
            }
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-sagemaker-endpointconfig-datacaptureconfig.html#cfn-sagemaker-endpointconfig-datacaptureconfig-capturecontenttypeheader)
             */
            override fun captureContentTypeHeader(): Any? =
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-sagemaker-endpointconfig-datacaptureconfig.html#cfn-sagemaker-endpointconfig-datacaptureconfig-initialsamplingpercentage)
             */
            override fun initialSamplingPercentage(): Number =
             ...
             * arn:aws:kms:us-west-2:111122223333:key/1234abcd-12ab-34cd-56ef-1234567890ab Alias
             * name: alias/ExampleAlias Alias name ARN:
             * arn:aws:kms:us-west-2:111122223333:alias/ExampleAlias If you don't provide a KMS key
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DataCaptureConfigProperty
            ): software.amazon.awscdk.services.sagemaker.CfnEndpointConfig.DataCaptureConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ClarifyExplainerConfigProperty {
        ...
        public interface Builder {
            /**
             * @param enableExplanations A JMESPath boolean expression used to filter which records
             *   to explain. Explanations are activated by default. See
             *   [`EnableExplanations`](https://docs.aws.amazon.com/sagemaker/latest/dg/clarify-online-explainability-create-endpoint.html#clarify-online-explainability-create-endpoint-enable)
             *   for additional information.
             */
            ...
            public fun inferenceConfig(
                inferenceConfig: ClarifyInferenceConfigProperty.Builder.() -> Unit
            )
        ...
        private class BuilderImpl : Builder {
            ...
            override fun inferenceConfig(inferenceConfig: ClarifyInferenceConfigProperty) {
                cdkBuilder.inferenceConfig(
                    inferenceConfig.let(ClarifyInferenceConfigProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("6e18830621d5bb7e43df94655ffbe11f05a35ea31fe7a0d8210a2f1b7d359d47")
            override fun shapConfig(
                shapConfig: ClarifyShapConfigProperty.Builder.() -> Unit
            ): Unit = shapConfig(ClarifyShapConfigProperty(shapConfig))
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ClarifyExplainerConfigProperty
            ): software.amazon.awscdk.services.sagemaker.CfnEndpointConfig.ClarifyExplainerConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ExplainerConfigProperty {
        ...
        public interface Builder {
            /**
             * @param clarifyExplainerConfig A member of `ExplainerConfig` that contains
             *   configuration parameters for the SageMaker Clarify explainer.
             */
            ...
            public fun clarifyExplainerConfig(
                clarifyExplainerConfig: ClarifyExplainerConfigProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
             ...
             *   configuration parameters for the SageMaker Clarify explainer.
             */
            override fun clarifyExplainerConfig(
                clarifyExplainerConfig: ClarifyExplainerConfigProperty
            ) {
                cdkBuilder.clarifyExplainerConfig(
                    clarifyExplainerConfig.let(ClarifyExplainerConfigProperty::unwrap)
                )
            }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ExplainerConfigProperty
            ): software.amazon.awscdk.services.sagemaker.CfnEndpointConfig.ExplainerConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ClarifyShapBaselineConfigProperty {
         ...
         * example, if the training dataset is in CSV format and each record contains four features,
         * and all features are numerical, then the format of the baseline data should also share
         * these characteristics. For natural language processing (NLP) of text columns, the
         * baseline value should be the value used to replace the unit of text specified by the
         * `Granularity` of the `TextConfig` parameter. The size limit for `ShapBasline` is 4 KB.
         * Use the `ShapBaselineUri` parameter if you want to provide more than 4 KB of baseline
         * data.
         *
         ...
         * training dataset. For example, if the training dataset is in CSV format, and each record
         * in the training dataset has four features, and all features are numerical, then the
         * baseline file should also have this same format. Each record should contain only the
         * features. If you are using a virtual private cloud (VPC), the `ShapBaselineUri` should be
         * accessible to the VPC. For more information about setting up endpoints with Amazon
        ...
        public interface Builder {
            ...
            /**
             * @param shapBaseline The inline SHAP baseline data in string format. `ShapBaseline`
             *   can have one or multiple records to be used as the baseline dataset. The format of
             ...
             *   should also share these characteristics. For natural language processing (NLP) of
             *   text columns, the baseline value should be the value used to replace the unit of
             *   text specified by the `Granularity` of the `TextConfig` parameter. The size limit
             *   for `ShapBasline` is 4 KB. Use the `ShapBaselineUri` parameter if you want to
             *   provide more than 4 KB of baseline data.
             */
             ...
             *   the SHAP baseline file is stored. The format of the SHAP baseline file should be
             *   the same format as the format of the training dataset. For example, if the training
             *   dataset is in CSV format, and each record in the training dataset has four
             *   features, and all features are numerical, then the baseline file should also have
             *   this same format. Each record should contain only the features. If you are using a
             *   virtual private cloud (VPC), the `ShapBaselineUri` should be accessible to the VPC.
             *   For more information about setting up endpoints with Amazon Virtual Private Cloud,
             *   see
             *   [Give SageMaker access to Resources in your Amazon Virtual Private Cloud](https://docs.aws.amazon.com/sagemaker/latest/dg/infrastructure-give-access.html)
             *   .
             */
        ...
        internal constructor(
             ...
             * processing (NLP) of text columns, the baseline value should be the value used to
             * replace the unit of text specified by the `Granularity` of the `TextConfig`
             * parameter. The size limit for `ShapBasline` is 4 KB. Use the `ShapBaselineUri`
             ...
             *
             * The format of the SHAP baseline file should be the same format as the format of the
             * training dataset. For example, if the training dataset is in CSV format, and each
             * record in the training dataset has four features, and all features are numerical,
             ...
             * `ShapBaselineUri` should be accessible to the VPC. For more information about setting
             * up endpoints with Amazon Virtual Private Cloud, see
             * [Give SageMaker access to Resources in your Amazon Virtual Private Cloud](https://docs.aws.amazon.com/sagemaker/latest/dg/infrastructure-give-access.html)
             * .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-sagemaker-endpointconfig-clarifyshapbaselineconfig.html#cfn-sagemaker-endpointconfig-clarifyshapbaselineconfig-shapbaselineuri)
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ClarifyShapBaselineConfigProperty
            ): software.amazon.awscdk.services.sagemaker.CfnEndpointConfig.ClarifyShapBaselineConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface AsyncInferenceOutputConfigProperty {
        ...
        public interface Builder {
            ...
            public fun notificationConfig(
                notificationConfig: AsyncInferenceNotificationConfigProperty.Builder.() -> Unit
            )
        ...
        private class BuilderImpl : Builder {
             ...
             *   results for asynchronous inference.
             */
            override fun notificationConfig(
                notificationConfig: AsyncInferenceNotificationConfigProperty
            ) {
                cdkBuilder.notificationConfig(
                    notificationConfig.let(AsyncInferenceNotificationConfigProperty::unwrap)
                )
            }
            ...
            override fun notificationConfig(
                ...
                notificationConfig(AsyncInferenceNotificationConfigProperty(notificationConfig))
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AsyncInferenceOutputConfigProperty
            ): software.amazon.awscdk.services.sagemaker.CfnEndpointConfig.AsyncInferenceOutputConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
