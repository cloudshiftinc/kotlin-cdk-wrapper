...
public interface IntegrationConfig {
     ...
     *
     * When the fingerprint changes, a new deployment is triggered. This property should contain
     * values associated with the Integration that upon changing should trigger a fresh the
     * Deployment needs to be refreshed.
     *
    ...
    public interface Builder {
         ...
         *   When the fingerprint changes, a new deployment is triggered. This property should
         *   contain values associated with the Integration that upon changing should trigger a
         *   fresh the Deployment needs to be refreshed.
         */
        public fun deploymentToken(deploymentToken: String)

        /**
         * @param integrationHttpMethod The integration's HTTP method type. Required unless you use
         *   a MOCK integration.
         */
