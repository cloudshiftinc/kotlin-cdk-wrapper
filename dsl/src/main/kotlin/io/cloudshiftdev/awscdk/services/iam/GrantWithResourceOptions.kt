...
public interface GrantWithResourceOptions : CommonGrantOptions {
     ...
     *
     * The statement will be added to the resource policy if it couldn't be added to the principal
     * policy.
     */
    ...
    public interface Builder {
        ...
        /**
         * @param resource The resource with a resource policy. The statement will be added to the
         *   resource policy if it couldn't be added to the principal policy.
         */
    ...
    internal constructor(
         ...
         * The resource with a resource policy.
         *
         * The statement will be added to the resource policy if it couldn't be added to the
         * principal policy.
         */
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: GrantWithResourceOptions
