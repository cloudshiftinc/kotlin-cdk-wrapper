...
public interface DefinitionConfig {
    ...
    public interface Builder {
        ...
        public fun definitionS3Location(
            definitionS3Location: CfnStateMachine.S3LocationProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl : Builder {
        ...
        override fun definitionS3Location(
            definitionS3Location: CfnStateMachine.S3LocationProperty
        ) {
            cdkBuilder.definitionS3Location(
                definitionS3Location.let(CfnStateMachine.S3LocationProperty::unwrap)
            )
        }
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: DefinitionConfig
        ): software.amazon.awscdk.services.stepfunctions.DefinitionConfig =
