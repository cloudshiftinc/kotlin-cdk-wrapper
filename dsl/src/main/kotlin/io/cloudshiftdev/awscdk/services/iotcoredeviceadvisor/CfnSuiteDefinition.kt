...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * *Type:* String
         * * ***devices*** - The list of configured devices under test. For more information on
         *   devices under test, see
         ...
         *
         * @param suiteDefinitionConfiguration The configuration of the Suite Definition. Listed
         *   below are the required elements of the `SuiteDefinitionConfiguration` .
         */
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.iotcoredeviceadvisor.CfnSuiteDefinition.Builder.create(
                scope,
                id
            )
    ...
    public interface SuiteDefinitionConfigurationProperty {
         ...
         * `rootGroup` is empty, and `intendedForQualification` is set to true, all the
        ...
        public interface Builder {
            /**
             * @param devicePermissionRoleArn Gets the device permission ARN. This is a required
             *   parameter.
             */
            ...
            /**
             * @param rootGroup Gets the test suite root group. This is a required parameter. For
             *   updating or creating the latest qualification suite, if `intendedForQualification`
             *   is set to true, `rootGroup` can be an empty string. If `intendedForQualification`
            ...
            /**
             * @param suiteDefinitionName Gets the suite definition name. This is a required
             *   parameter.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            override fun intendedForQualification(intendedForQualification: IResolvable) {
                cdkBuilder.intendedForQualification(
                    intendedForQualification.let(IResolvable::unwrap)
                )
            }
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-iotcoredeviceadvisor-suitedefinition-suitedefinitionconfiguration.html#cfn-iotcoredeviceadvisor-suitedefinition-suitedefinitionconfiguration-devicepermissionrolearn)
             */
            override fun devicePermissionRoleArn(): String =
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-iotcoredeviceadvisor-suitedefinition-suitedefinitionconfiguration.html#cfn-iotcoredeviceadvisor-suitedefinition-suitedefinitionconfiguration-intendedforqualification)
             */
            override fun intendedForQualification(): Any? =
                unwrap(this).getIntendedForQualification()

            /**
             * Gets the test suite root group.
             *
             * This is a required parameter. For updating or creating the latest qualification
             * suite, if `intendedForQualification` is set to true, `rootGroup` can be an empty
             * string. If `intendedForQualification` is false, `rootGroup` cannot be an empty
             * string. If `rootGroup` is empty, and `intendedForQualification` is set to true, all
             * the qualification tests are included, and the configuration is default.
             *
             * For a qualification suite, the minimum length is 0, and the maximum is 2048. For a
             * non-qualification suite, the minimum length is 1, and the maximum is 2048.
             *
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SuiteDefinitionConfigurationProperty
            ): software.amazon.awscdk.services.iotcoredeviceadvisor.CfnSuiteDefinition.SuiteDefinitionConfigurationProperty =
    ...
    public interface DeviceUnderTestProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DeviceUnderTestProperty
            ): software.amazon.awscdk.services.iotcoredeviceadvisor.CfnSuiteDefinition.DeviceUnderTestProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
