...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param fileConfiguration The configuration for what files should be pulled from the
         *   source.
         */
        ...
        public fun fileConfiguration(
            fileConfiguration: FileConfigurationProperty.Builder.() -> Unit
        )
         ...
         *
         * @param objectConfiguration The configuration for what data should be pulled from the
         *   source.
         */
         ...
         *
         * @param scheduleConfig The name of the data and how often it should be pulled from the
         *   source.
         */
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.appintegrations.CfnDataIntegration.Builder.create(
                scope,
                id
            )
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("c0d3ae32aa8666f3c6576bb12199758f0d36515a44406953f1c58bc5ca298af5")
        override fun fileConfiguration(
            fileConfiguration: FileConfigurationProperty.Builder.() -> Unit
    ...
    public interface FileConfigurationProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: FileConfigurationProperty
            ): software.amazon.awscdk.services.appintegrations.CfnDataIntegration.FileConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
