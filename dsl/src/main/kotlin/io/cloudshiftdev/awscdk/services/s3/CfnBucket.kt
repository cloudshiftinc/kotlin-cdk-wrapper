...
internal constructor(
    ...
    public open fun accelerateConfiguration(`value`: AccelerateConfigurationProperty) {
        unwrap(this)
            .setAccelerateConfiguration(`value`.let(AccelerateConfigurationProperty::unwrap))
    }

    /** Configures the transfer acceleration state for an Amazon S3 bucket. */
    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("e7a73f48ce5baa3308868832e061fb6ed212fafdb3343da976a3c24291b3a435")
    public open fun accelerateConfiguration(
        `value`: AccelerateConfigurationProperty.Builder.() -> Unit
    ): Unit = accelerateConfiguration(AccelerateConfigurationProperty(`value`))
     ...
     *
     * For more information about dual-stack endpoints, see
     * [Using Amazon S3 Dual-Stack Endpoints](https://docs.aws.amazon.com/AmazonS3/latest/dev/dual-stack-endpoints.html)
     * .
     */
    ...
    public open fun loggingConfiguration(
        `value`: LoggingConfigurationProperty.Builder.() -> Unit
    ...
    public open fun objectLockConfiguration(`value`: ObjectLockConfigurationProperty) {
        unwrap(this)
            .setObjectLockConfiguration(`value`.let(ObjectLockConfigurationProperty::unwrap))
    }

    /** This operation is not supported by directory buckets. */
    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("7498771a97b1a83de040af21d9c576e5798ec802e19ec979ffe682e0f124cedf")
    public open fun objectLockConfiguration(
        `value`: ObjectLockConfigurationProperty.Builder.() -> Unit
    ): Unit = objectLockConfiguration(ObjectLockConfigurationProperty(`value`))
    ...
    /** Configuration that defines how Amazon S3 handles public access. */
    public open fun publicAccessBlockConfiguration(
        `value`: PublicAccessBlockConfigurationProperty
    ) {
        unwrap(this)
            .setPublicAccessBlockConfiguration(
                `value`.let(PublicAccessBlockConfigurationProperty::unwrap)
            )
    }
    ...
    public open fun publicAccessBlockConfiguration(
        `value`: PublicAccessBlockConfigurationProperty.Builder.() -> Unit
    ...
    public open fun replicationConfiguration(`value`: ReplicationConfigurationProperty) {
        unwrap(this)
            .setReplicationConfiguration(`value`.let(ReplicationConfigurationProperty::unwrap))
    }
    ...
    public open fun replicationConfiguration(
        `value`: ReplicationConfigurationProperty.Builder.() -> Unit
    ...
    public open fun versioningConfiguration(`value`: VersioningConfigurationProperty) {
        unwrap(this)
            .setVersioningConfiguration(`value`.let(VersioningConfigurationProperty::unwrap))
    }

    /** Enables multiple versions of all objects in this bucket. */
    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("7ae147c1d499f529b5489f48654735e0f9109a0e07db6c8387dd35b0a3e759e2")
    public open fun versioningConfiguration(
        `value`: VersioningConfigurationProperty.Builder.() -> Unit
    ): Unit = versioningConfiguration(VersioningConfigurationProperty(`value`))
    ...
    public open fun websiteConfiguration(
        `value`: WebsiteConfigurationProperty.Builder.() -> Unit
    ...
    public interface Builder {
         ...
         *
         * @param accelerateConfiguration Configures the transfer acceleration state for an Amazon
         *   S3 bucket.
         */
        ...
        public fun accelerateConfiguration(
            accelerateConfiguration: AccelerateConfigurationProperty.Builder.() -> Unit
        )
         ...
         * in the *Amazon S3 User Guide* .
         *
         * S3 buckets are created with ACLs disabled by default. Therefore, unless you explicitly
         * set the
         ...
         * property to enable ACLs, your resource will fail to deploy with any value other than
         * Private. Use cases requiring ACLs are uncommon.
         *
         * The majority of access control configurations can be successfully and more easily
         * achieved with bucket policies. For more information, see
         * [AWS::S3::BucketPolicy](https://docs.aws.amazon.com//AWSCloudFormation/latest/UserGuide/aws-properties-s3-policy.html)
         * . For examples of common policy configurations, including S3 Server Access Logs buckets
         * and more, see
         ...
         *
         * @param accessControl This is a legacy property, and it is not recommended for most use
         *   cases.
         */
         ...
         *
         * @param analyticsConfigurations Specifies the configuration and any analyses for the
         ...
         * S3-managed keys (SSE-S3), AWS KMS-managed keys (SSE-KMS), or dual-layer server-side
         * encryption with KMS-managed keys (DSSE-KMS).
         *
         ...
         *
         * @param corsConfiguration Describes the cross-origin access configuration for objects in
         *   an Amazon S3 bucket.
         */
        ...
        public fun corsConfiguration(
            corsConfiguration: CorsConfigurationProperty.Builder.() -> Unit
        )
         ...
         *
         * @param inventoryConfigurations Specifies the inventory configuration for an Amazon S3
         *   bucket.
         */
         ...
         *
         * @param lifecycleConfiguration Specifies the lifecycle configuration for objects in an
         *   Amazon S3 bucket.
         */
        ...
        public fun loggingConfiguration(
            loggingConfiguration: LoggingConfigurationProperty.Builder.() -> Unit
        )
         ...
         * metrics configuration ID) from an Amazon S3 bucket.
         *
         * If you're updating an existing metrics configuration, note that this is a full
         * replacement of the existing metrics configuration. If you don't include the elements you
         ...
         * specified bucket. For more information, see
        ...
        public fun objectLockConfiguration(
            objectLockConfiguration: ObjectLockConfigurationProperty.Builder.() -> Unit
        )
         ...
         *
         * @param ownershipControls Configuration that defines how Amazon S3 handles Object
         *   Ownership rules.
         */
        ...
        public fun ownershipControls(
            ownershipControls: OwnershipControlsProperty.Builder.() -> Unit
        )
         ...
         *
         * @param publicAccessBlockConfiguration Configuration that defines how Amazon S3 handles
         *   public access.
         */
        ...
        public fun publicAccessBlockConfiguration(
            publicAccessBlockConfiguration:
                PublicAccessBlockConfigurationProperty.Builder.() -> Unit
        )

        /**
         * Configuration for replicating objects in an S3 bucket.
         *
         * To enable replication, you must also enable versioning by using the
        ...
        public fun replicationConfiguration(
            replicationConfiguration: ReplicationConfigurationProperty.Builder.() -> Unit
        )
         ...
         * Enables multiple versions of all objects in this bucket.
         *
         * You might enable versioning to prevent objects from being deleted or overwritten by
         * mistake or to archive objects so that you can retrieve previous versions of them.
         *
        ...
        public fun versioningConfiguration(
            versioningConfiguration: VersioningConfigurationProperty.Builder.() -> Unit
        )
        ...
        public fun websiteConfiguration(
            websiteConfiguration: WebsiteConfigurationProperty.Builder.() -> Unit
        )
    }
    ...
    private class BuilderImpl(
         ...
         *   S3 bucket.
         */
        override fun accelerateConfiguration(
            accelerateConfiguration: AccelerateConfigurationProperty
        ) {
            cdkBuilder.accelerateConfiguration(
                accelerateConfiguration.let(AccelerateConfigurationProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("ebcb7c17d411750b2f75f4e938ef6700a42e1c90624324aa83db87013d5ed712")
        override fun bucketEncryption(
            bucketEncryption: BucketEncryptionProperty.Builder.() -> Unit
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("b5e9ba14372cccffc4e7871c656864cbbcc7cb9d0216cc850276da4e6a873e2c")
        override fun corsConfiguration(
            corsConfiguration: CorsConfigurationProperty.Builder.() -> Unit
         ...
         *   storage.
         */
        override fun intelligentTieringConfigurations(
            intelligentTieringConfigurations: IResolvable
        ) {
            cdkBuilder.intelligentTieringConfigurations(
                intelligentTieringConfigurations.let(IResolvable::unwrap)
            )
        }
         ...
         */
        override fun intelligentTieringConfigurations(
            vararg intelligentTieringConfigurations: Any
        ...
        override fun loggingConfiguration(loggingConfiguration: LoggingConfigurationProperty) {
            cdkBuilder.loggingConfiguration(
                loggingConfiguration.let(LoggingConfigurationProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("d26fd90a1e29625730bec9f94c832ce940d1445ab8f90af03bce65f699e92002")
        override fun loggingConfiguration(
            loggingConfiguration: LoggingConfigurationProperty.Builder.() -> Unit
         ...
         * @param objectLockConfiguration This operation is not supported by directory buckets.
         */
        override fun objectLockConfiguration(
            objectLockConfiguration: ObjectLockConfigurationProperty
        ) {
            cdkBuilder.objectLockConfiguration(
                objectLockConfiguration.let(ObjectLockConfigurationProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("3cc9ca38ed9e286cb88cdaa5e6a6b8efac68c748ae62bba4f9a1fea0a5eb54cb")
        override fun ownershipControls(
            ownershipControls: OwnershipControlsProperty.Builder.() -> Unit
        ...
        override fun publicAccessBlockConfiguration(publicAccessBlockConfiguration: IResolvable) {
            cdkBuilder.publicAccessBlockConfiguration(
                publicAccessBlockConfiguration.let(IResolvable::unwrap)
            )
        }
        ...
        override fun publicAccessBlockConfiguration(
            ...
            cdkBuilder.publicAccessBlockConfiguration(
                publicAccessBlockConfiguration.let(PublicAccessBlockConfigurationProperty::unwrap)
            )
        }
        ...
        override fun publicAccessBlockConfiguration(
            ...
            publicAccessBlockConfiguration(
                PublicAccessBlockConfigurationProperty(publicAccessBlockConfiguration)
            )
        ...
        override fun replicationConfiguration(
            ...
            cdkBuilder.replicationConfiguration(
                replicationConfiguration.let(ReplicationConfigurationProperty::unwrap)
            )
        }
        ...
        override fun replicationConfiguration(
            ...
            replicationConfiguration(ReplicationConfigurationProperty(replicationConfiguration))
         ...
         * @param versioningConfiguration Enables multiple versions of all objects in this bucket.
         */
        override fun versioningConfiguration(
            versioningConfiguration: VersioningConfigurationProperty
        ) {
            cdkBuilder.versioningConfiguration(
                versioningConfiguration.let(VersioningConfigurationProperty::unwrap)
            )
        }
        ...
        override fun websiteConfiguration(websiteConfiguration: WebsiteConfigurationProperty) {
            cdkBuilder.websiteConfiguration(
                websiteConfiguration.let(WebsiteConfigurationProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("775a82b8977721915020e905125f48facfbc26bb5b9fb858cae884e552a2cc2a")
        override fun websiteConfiguration(
            websiteConfiguration: WebsiteConfigurationProperty.Builder.() -> Unit
    ...
    public interface NotificationFilterProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: NotificationFilterProperty
            ): software.amazon.awscdk.services.s3.CfnBucket.NotificationFilterProperty =
    ...
    public interface ReplicationRuleProperty {
         ...
         * The use of the filter field indicates that this is a V2 replication configuration. This
         * field isn't supported in a V1 replication configuration.
         *
         * V1 replication configuration only supports filtering by key prefix. To filter using a V1
         * replication configuration, add the `Prefix` directly as a child element of the `Rule`
         * element.
         *
         ...
         * generates a random ID. When using a V2 replication configuration this property is
         * capitalized as "ID".
         *
         ...
         * applies.
         *
         * The maximum prefix length is 1,024 characters. To include all objects in a bucket,
         * specify an empty string. To filter using a V1 replication configuration, add the `Prefix`
         ...
         * conflict.
         *
         * Amazon S3 will attempt to replicate objects according to all replication rules. However,
         * if there are two or more rules with the same destination bucket, then objects will be
         * replicated according to the rule with the highest priority. The higher the number, the
         * higher the priority.
         *
         * For more information, see
        ...
        public interface Builder {
             ...
             *   If you specify a `Filter` in your replication configuration, you must also include
             *   a `DeleteMarkerReplication` element. If your `Filter` includes a `Tag` element, the
             ...
             * .
             */
            public fun deleteMarkerReplication(
            ...
            public fun deleteMarkerReplication(
                deleteMarkerReplication: DeleteMarkerReplicationProperty.Builder.() -> Unit
            )

            /**
             * @param destination A container for information about the replication destination and
             *   its configurations including enabling the S3 Replication Time Control (S3 RTC).
             */
            ...
            /**
             * @param filter A filter that identifies the subset of objects to which the replication
             *   rule applies. A `Filter` must specify exactly one `Prefix` , `TagFilter` , or an
             *   `And` child element. The use of the filter field indicates that this is a V2
             *   replication configuration. This field isn't supported in a V1 replication
             *   configuration.
             *
             * V1 replication configuration only supports filtering by key prefix. To filter using a
             * V1 replication configuration, add the `Prefix` directly as a child element of the
             * `Rule` element.
             */
            ...
            /**
             * @param id A unique identifier for the rule. The maximum value is 255 characters. If
             *   you don't specify a value, AWS CloudFormation generates a random ID. When using a
             *   V2 replication configuration this property is capitalized as "ID".
             */
            public fun id(id: String)

            /**
             * @param prefix An object key name prefix that identifies the object or objects to
             *   which the rule applies. The maximum prefix length is 1,024 characters. To include
             *   all objects in a bucket, specify an empty string. To filter using a V1 replication
             *   configuration, add the `Prefix` directly as a child element of the `Rule` element.
             *
             ...
             *   replication rules conflict. Amazon S3 will attempt to replicate objects according
             *   to all replication rules. However, if there are two or more rules with the same
             *   destination bucket, then objects will be replicated according to the rule with the
             *   highest priority. The higher the number, the higher the priority.
             *
             * For more information, see
             * [Replication](https://docs.aws.amazon.com/AmazonS3/latest/dev/replication.html) in
             ...
             *   identifying the source objects that you want to replicate. You can choose to enable
             *   or disable the replication of these objects.
             */
             ...
             *   or disable the replication of these objects.
             */
            public fun sourceSelectionCriteria(
            ...
            public fun sourceSelectionCriteria(
                sourceSelectionCriteria: SourceSelectionCriteriaProperty.Builder.() -> Unit
            )
        ...
        private class BuilderImpl : Builder {
             ...
             * .
             */
            override fun deleteMarkerReplication(
                deleteMarkerReplication: DeleteMarkerReplicationProperty
            ) {
                cdkBuilder.deleteMarkerReplication(
                    deleteMarkerReplication.let(DeleteMarkerReplicationProperty::unwrap)
                )
            }
            ...
            override fun deleteMarkerReplication(
                ...
                deleteMarkerReplication(DeleteMarkerReplicationProperty(deleteMarkerReplication))
            ...
            override fun destination(
                destination: ReplicationDestinationProperty.Builder.() -> Unit
            ): Unit = destination(ReplicationDestinationProperty(destination))
             ...
             *   or disable the replication of these objects.
             */
            override fun sourceSelectionCriteria(
                sourceSelectionCriteria: SourceSelectionCriteriaProperty
            ) {
                cdkBuilder.sourceSelectionCriteria(
                    sourceSelectionCriteria.let(SourceSelectionCriteriaProperty::unwrap)
                )
            }
            ...
            override fun sourceSelectionCriteria(
                ...
                sourceSelectionCriteria(SourceSelectionCriteriaProperty(sourceSelectionCriteria))
        ...
        internal constructor(
             ...
             * A filter that identifies the subset of objects to which the replication rule applies.
             *
             * A `Filter` must specify exactly one `Prefix` , `TagFilter` , or an `And` child
             * element. The use of the filter field indicates that this is a V2 replication
             * configuration. This field isn't supported in a V1 replication configuration.
             *
             * V1 replication configuration only supports filtering by key prefix. To filter using a
             * V1 replication configuration, add the `Prefix` directly as a child element of the
             * `Rule` element.
             ...
             *
             * The maximum prefix length is 1,024 characters. To include all objects in a bucket,
             * specify an empty string. To filter using a V1 replication configuration, add the
             * `Prefix` directly as a child element of the `Rule` element.
             *
             * Replacement must be made for object keys containing special characters (such as
             * carriage returns) when using XML requests. For more information, see
             * [XML related object key constraints](https://docs.aws.amazon.com/AmazonS3/latest/userguide/object-keys.html#object-key-xml-related-constraints)
             ...
             * However, if there are two or more rules with the same destination bucket, then
             * objects will be replicated according to the rule with the highest priority. The
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ReplicationRuleProperty
            ): software.amazon.awscdk.services.s3.CfnBucket.ReplicationRuleProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface AccessControlTranslationProperty {
         ...
         *
         * For default and valid values, see
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AccessControlTranslationProperty
            ): software.amazon.awscdk.services.s3.CfnBucket.AccessControlTranslationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ReplicationRuleAndOperatorProperty {
        ...
        public interface Builder {
            /**
             * @param prefix An object key name prefix that identifies the subset of objects to
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ReplicationRuleAndOperatorProperty
            ): software.amazon.awscdk.services.s3.CfnBucket.ReplicationRuleAndOperatorProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface MetricsProperty {
        ...
        public interface Builder {
            ...
            public fun eventThreshold(
                eventThreshold: ReplicationTimeValueProperty.Builder.() -> Unit
            )
    ...
    public interface TransitionProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param transitionDate Indicates when objects are transitioned to the specified
             *   storage class. The date value must be in ISO 8601 format. The time is always
             *   midnight UTC.
             */
    ...
    public interface AccelerateConfigurationProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AccelerateConfigurationProperty
            ): software.amazon.awscdk.services.s3.CfnBucket.AccelerateConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SourceSelectionCriteriaProperty {
        ...
        public interface Builder {
            /**
             * @param replicaModifications A filter that you can specify for selection for
            ...
            public fun replicaModifications(
                replicaModifications: ReplicaModificationsProperty.Builder.() -> Unit
            )
            ...
            public fun sseKmsEncryptedObjects(
                sseKmsEncryptedObjects: SseKmsEncryptedObjectsProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun replicaModifications(replicaModifications: ReplicaModificationsProperty) {
                cdkBuilder.replicaModifications(
                    replicaModifications.let(ReplicaModificationsProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("dde846bad4ae445ce8130cf4d4c828d42edf0194358d05fa4865412dc67103ce")
            override fun replicaModifications(
                replicaModifications: ReplicaModificationsProperty.Builder.() -> Unit
             ...
             *   Amazon S3 objects encrypted with AWS KMS.
             */
            override fun sseKmsEncryptedObjects(
                sseKmsEncryptedObjects: SseKmsEncryptedObjectsProperty
            ) {
                cdkBuilder.sseKmsEncryptedObjects(
                    sseKmsEncryptedObjects.let(SseKmsEncryptedObjectsProperty::unwrap)
                )
            }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SourceSelectionCriteriaProperty
            ): software.amazon.awscdk.services.s3.CfnBucket.SourceSelectionCriteriaProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface InventoryConfigurationProperty {
         ...
         *
         * If set to `True` , an inventory list is generated. If set to `False` , no inventory list
         * is generated.
         *
         ...
         *
         * If set to `All` , the list includes all the object versions, which adds the
         * version-related fields `VersionId` , `IsLatest` , and `DeleteMarker` to the list. If set
        ...
        public interface Builder {
            ...
            /**
             * @param enabled Specifies whether the inventory is enabled or disabled. If set to
             *   `True` , an inventory list is generated. If set to `False` , no inventory list is
             *   generated.
             */
            ...
            /**
             * @param includedObjectVersions Object versions to include in the inventory list. If
             *   set to `All` , the list includes all the object versions, which adds the
             *   version-related fields `VersionId` , `IsLatest` , and `DeleteMarker` to the list.
        ...
        internal constructor(
             ...
             * Specifies whether the inventory is enabled or disabled.
             *
             * If set to `True` , an inventory list is generated. If set to `False` , no inventory
             * list is generated.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-s3-bucket-inventoryconfiguration.html#cfn-s3-bucket-inventoryconfiguration-enabled)
             */
             ...
             *
             * If set to `All` , the list includes all the object versions, which adds the
             * version-related fields `VersionId` , `IsLatest` , and `DeleteMarker` to the list. If
             * set to `Current` , the list does not contain these version-related fields.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-s3-bucket-inventoryconfiguration.html#cfn-s3-bucket-inventoryconfiguration-includedobjectversions)
             */
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-s3-bucket-inventoryconfiguration.html#cfn-s3-bucket-inventoryconfiguration-optionalfields)
             */
            override fun optionalFields(): List<String> =
                unwrap(this).getOptionalFields() ?: emptyList()
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: InventoryConfigurationProperty
            ): software.amazon.awscdk.services.s3.CfnBucket.InventoryConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CorsRuleProperty {
        ...
        public interface Builder {
            /**
             * @param allowedHeaders Headers that are specified in the
             *   `Access-Control-Request-Headers` header. These headers are allowed in a preflight
             *   OPTIONS request. In response to any preflight OPTIONS request, Amazon S3 returns
            ...
            /**
             * @param allowedMethods An HTTP method that you allow the origin to run. *Allowed
             *   values* : `GET` | `PUT` | `HEAD` | `POST` | `DELETE`
             */
            ...
            /**
             * @param exposedHeaders One or more headers in the response that you want customers to
            ...
            /**
             * @param id A unique identifier for this rule. The value must be no more than 255
             *   characters.
             */
            public fun id(id: String)

            /**
             * @param maxAge The time in seconds that your browser is to cache the preflight
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-s3-bucket-corsrule.html#cfn-s3-bucket-corsrule-exposedheaders)
             */
            override fun exposedHeaders(): List<String> =
                unwrap(this).getExposedHeaders() ?: emptyList()
    ...
    public interface EventBridgeConfigurationProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: EventBridgeConfigurationProperty
            ): software.amazon.awscdk.services.s3.CfnBucket.EventBridgeConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface VersioningConfigurationProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: VersioningConfigurationProperty
            ): software.amazon.awscdk.services.s3.CfnBucket.VersioningConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface IntelligentTieringConfigurationProperty {
         ...
         * automatically move objects stored in the Intelligent-Tiering storage class to Archive
        ...
        public interface Builder {
             ...
             *   configuration. At least one tier must be defined in the list. At most, you can
             *   specify two tiers in the list, one for each available AccessTier: `ARCHIVE_ACCESS`
        ...
        internal constructor(
             ...
             * Specifies a list of S3 Intelligent-Tiering storage class tiers in the configuration.
             *
             * At least one tier must be defined in the list. At most, you can specify two tiers in
             * the list, one for each available AccessTier: `ARCHIVE_ACCESS` and
             * `DEEP_ARCHIVE_ACCESS` .
             *
             * You only need Intelligent Tiering Configuration enabled on a bucket if you want to
             * automatically move objects stored in the Intelligent-Tiering storage class to Archive
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: IntelligentTieringConfigurationProperty
            ): software.amazon.awscdk.services.s3.CfnBucket.IntelligentTieringConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DestinationProperty {
        ...
        public interface Builder {
            /**
             * @param bucketAccountId The account ID that owns the destination S3 bucket. If no
            ...
            /**
             * @param bucketArn The Amazon Resource Name (ARN) of the bucket to which data is
             *   exported.
             */
            ...
            /**
             * @param prefix The prefix to use when exporting data. The prefix is prepended to all
             *   results.
             */
            public fun prefix(prefix: String)
        }
    ...
    public interface OwnershipControlsProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: OwnershipControlsProperty
            ): software.amazon.awscdk.services.s3.CfnBucket.OwnershipControlsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface NotificationConfigurationProperty {
        ...
        public interface Builder {
            ...
            /** @param eventBridgeConfiguration Enables delivery of events to Amazon EventBridge. */
            public fun eventBridgeConfiguration(
            ...
            public fun eventBridgeConfiguration(
                eventBridgeConfiguration: EventBridgeConfigurationProperty.Builder.() -> Unit
            )

            /**
             * @param lambdaConfigurations Describes the AWS Lambda functions to invoke and the
             *   events for which to invoke them.
             */
            ...
            /**
             * @param queueConfigurations The Amazon Simple Queue Service queues to publish messages
            ...
            /**
             * @param topicConfigurations The topic to which notifications are sent and the events
        ...
        private class BuilderImpl : Builder {
            ...
            override fun eventBridgeConfiguration(eventBridgeConfiguration: IResolvable) {
                cdkBuilder.eventBridgeConfiguration(
                    eventBridgeConfiguration.let(IResolvable::unwrap)
                )
            }

            /** @param eventBridgeConfiguration Enables delivery of events to Amazon EventBridge. */
            override fun eventBridgeConfiguration(
                eventBridgeConfiguration: EventBridgeConfigurationProperty
            ) {
                cdkBuilder.eventBridgeConfiguration(
                    eventBridgeConfiguration.let(EventBridgeConfigurationProperty::unwrap)
                )
            }
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-s3-bucket-notificationconfiguration.html#cfn-s3-bucket-notificationconfiguration-eventbridgeconfiguration)
             */
            override fun eventBridgeConfiguration(): Any? =
    ...
    public interface WebsiteConfigurationProperty {
        ...
        public interface Builder {
            ...
            public fun redirectAllRequestsTo(
                redirectAllRequestsTo: RedirectAllRequestsToProperty.Builder.() -> Unit
            )

            /**
             * @param routingRules Rules that define when a redirect is applied and the redirect
             *   behavior.
             */
        ...
        private class BuilderImpl : Builder {
             ...
             * If you specify this property, you can't specify any other property.
             */
            override fun redirectAllRequestsTo(
                redirectAllRequestsTo: RedirectAllRequestsToProperty
            ) {
                cdkBuilder.redirectAllRequestsTo(
                    redirectAllRequestsTo.let(RedirectAllRequestsToProperty::unwrap)
                )
            }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: WebsiteConfigurationProperty
            ): software.amazon.awscdk.services.s3.CfnBucket.WebsiteConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface QueueConfigurationProperty {
         ...
         *
         * For example, you can create a filter so that Amazon S3 sends notifications only when
         * image files with a `.jpg` extension are added to the bucket. For more information, see
        ...
        public interface Builder {
            /**
             * @param event The Amazon S3 bucket event about which you want to publish messages to
             *   Amazon SQS. For more information, see
             *   [Supported Event Types](https://docs.aws.amazon.com/AmazonS3/latest/dev/NotificationHowTo.html)
             *   in the *Amazon S3 User Guide* .
             */
             ...
             *   For example, you can create a filter so that Amazon S3 sends notifications only
             *   when image files with a `.jpg` extension are added to the bucket. For more
             *   information, see
             *   [Configuring event notifications using object key name filtering](https://docs.aws.amazon.com/AmazonS3/latest/user-guide/notification-how-to-filtering.html)
             *   in the *Amazon S3 User Guide* .
             */
            ...
            /**
             * @param queue The Amazon Resource Name (ARN) of the Amazon SQS queue to which Amazon
             *   S3 publishes a message when it detects events of the specified type. FIFO queues
             *   are not allowed when enabling an SQS queue as the event notification destination.
             */
        ...
        internal constructor(
             ...
             *
             * For example, you can create a filter so that Amazon S3 sends notifications only when
             * image files with a `.jpg` extension are added to the bucket. For more information,
             * see
             * [Configuring event notifications using object key name filtering](https://docs.aws.amazon.com/AmazonS3/latest/user-guide/notification-how-to-filtering.html)
             * in the *Amazon S3 User Guide* .
             *
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: QueueConfigurationProperty
            ): software.amazon.awscdk.services.s3.CfnBucket.QueueConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ReplicationConfigurationProperty {
         ...
         *
         * A replication configuration must have at least one rule and can contain a maximum of
         * 1,000 rules.
         *
        ...
        public interface Builder {
            /**
             * @param role The Amazon Resource Name (ARN) of the AWS Identity and Access Management
            ...
            /**
             * @param rules A container for one or more replication rules. A replication
             *   configuration must have at least one rule and can contain a maximum of 1,000 rules.
             */
            public fun rules(rules: IResolvable)
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ReplicationConfigurationProperty
            ): software.amazon.awscdk.services.s3.CfnBucket.ReplicationConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ReplicationRuleFilterProperty {
         ...
         * * If you specify a filter based on multiple tags, wrap the `TagFilter` elements in an
         *   `And` tag.
         *
        ...
        public interface Builder {
            /**
             * @param and A container for specifying rule filters. The filters determine the subset
             *   of objects to which the rule applies. This element is required only if you specify
             *   more than one filter. For example:
             * * If you specify both a `Prefix` and a `TagFilter` , wrap these filters in an `And`
             *   tag.
             * * If you specify a filter based on multiple tags, wrap the `TagFilter` elements in an
             *   `And` tag.
             */
            ...
            /**
             * @param tagFilter A container for specifying a tag key and value. The rule applies
             *   only to objects that have the tag in their tag set.
             */
        ...
        internal constructor(
             ...
             * A container for specifying rule filters.
             *
             * The filters determine the subset of objects to which the rule applies. This element
             * is required only if you specify more than one filter. For example:
             * * If you specify both a `Prefix` and a `TagFilter` , wrap these filters in an `And`
             *   tag.
             * * If you specify a filter based on multiple tags, wrap the `TagFilter` elements in an
             *   `And` tag.
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ReplicationRuleFilterProperty
            ): software.amazon.awscdk.services.s3.CfnBucket.ReplicationRuleFilterProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface TargetObjectKeyFormatProperty {
        ...
        public interface Builder {
            ...
            public fun partitionedPrefix(
                partitionedPrefix: PartitionedPrefixProperty.Builder.() -> Unit
            )
        ...
        private class BuilderImpl : Builder {
            ...
            override fun partitionedPrefix(partitionedPrefix: PartitionedPrefixProperty) {
                cdkBuilder.partitionedPrefix(
                    partitionedPrefix.let(PartitionedPrefixProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("1425d6dbc5168c43516b04bd30bd23cb0541c92f7ada1ba13ab65a618fa89a2a")
            override fun partitionedPrefix(
                partitionedPrefix: PartitionedPrefixProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TargetObjectKeyFormatProperty
            ): software.amazon.awscdk.services.s3.CfnBucket.TargetObjectKeyFormatProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface MetricsConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param accessPointArn The access point that was used while performing operations on
             *   the object. The metrics configuration only includes objects that meet the filter's
             *   criteria.
             */
            public fun accessPointArn(accessPointArn: String)

            /**
             * @param id The ID used to identify the metrics configuration. This can be any value
             *   you choose that helps you identify your metrics configuration.
             */
            public fun id(id: String)

            /**
             * @param prefix The prefix that an object must have to be included in the metrics
             *   results.
             */
            public fun prefix(prefix: String)
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: MetricsConfigurationProperty
            ): software.amazon.awscdk.services.s3.CfnBucket.MetricsConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface NoncurrentVersionExpirationProperty {
         ...
         *
         * If there are this many more recent noncurrent versions, Amazon S3 will take the
        ...
        public interface Builder {
             ...
             *   retain. If there are this many more recent noncurrent versions, Amazon S3 will take
             *   the associated action. For more information about noncurrent versions, see
             *   [Lifecycle configuration elements](https://docs.aws.amazon.com/AmazonS3/latest/userguide/intro-lifecycle-rules.html)
             *   in the *Amazon S3 User Guide* .
             */
            ...
            /**
             * @param noncurrentDays Specifies the number of days an object is noncurrent before
             *   Amazon S3 can perform the associated action. For information about the noncurrent
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-s3-bucket-noncurrentversionexpiration.html#cfn-s3-bucket-noncurrentversionexpiration-newernoncurrentversions)
             */
            override fun newerNoncurrentVersions(): Number? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: NoncurrentVersionExpirationProperty
            ): software.amazon.awscdk.services.s3.CfnBucket.NoncurrentVersionExpirationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DataExportProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param outputSchemaVersion The version of the output schema to use when exporting
             *   data. Must be `V_1` .
             */
    ...
    public interface LambdaConfigurationProperty {
        ...
        public interface Builder {
             ...
             *   `.jpg` extension invoke the function when they are added to the Amazon S3 bucket.
             */
            public fun filter(filter: IResolvable)
            ...
            /**
             * @param function The Amazon Resource Name (ARN) of the AWS Lambda function that Amazon
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: LambdaConfigurationProperty
            ): software.amazon.awscdk.services.s3.CfnBucket.LambdaConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface S3KeyFilterProperty {
        ...
        public interface Builder {
            /**
             * @param rules A list of containers for the key-value pair that defines the criteria
             *   for the filter rule.
             */
            public fun rules(rules: IResolvable)
    ...
    public interface NoncurrentVersionTransitionProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param transitionInDays Specifies the number of days an object is noncurrent before
             *   Amazon S3 can perform the associated action. For information about the noncurrent
             *   days calculations, see
             *   [How Amazon S3 Calculates How Long an Object Has Been Noncurrent](https://docs.aws.amazon.com/AmazonS3/latest/dev/intro-lifecycle-rules.html#non-current-days-calculations)
             *   in the *Amazon S3 User Guide* .
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: NoncurrentVersionTransitionProperty
            ): software.amazon.awscdk.services.s3.CfnBucket.NoncurrentVersionTransitionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface RuleProperty {
         ...
         *
         * The date value must be in ISO 8601 format. The time is always midnight UTC. If you
         * specify an expiration and transition time, you must use the same time unit for both
         ...
         * Amazon S3 Glacier.
         *
         * If you specify an expiration and transition time, you must use the same time unit for
         * both properties (either in days or by date). The expiration time must also be later than
         * the transition time.
         *
         ...
         *
         * If set to true, the delete marker will be removed if there are no noncurrent versions.
         ...
         *
         * Upon expiration, Amazon S3 permanently deletes the noncurrent object versions. You set
         * this lifecycle configuration action on a bucket that has versioning enabled (or
         ...
         */
        public fun noncurrentVersionExpiration(): Any? =
         ...
         * days, between when a new version of the object is uploaded to the bucket and when old
         * versions of the object expire. When object versions expire, Amazon S3 permanently deletes
         * them. If you specify a transition and expiration time, the expiration time must be later
         ...
         * non-current objects transition to a specified storage class. If you specify a transition
         * and expiration time, the expiration time must be later than the transition time. If you
         * specify this property, don't specify the `NoncurrentVersionTransitions` property.
         *
         ...
         */
        public fun noncurrentVersionTransition(): Any? =
         ...
         *
         * If you specify a transition and expiration time, the expiration time must be later than
         ...
         */
        public fun noncurrentVersionTransitions(): Any? =
         ...
         * rules, see
         * [Lifecycle configuration using size-based rules](https://docs.aws.amazon.com/AmazonS3/latest/userguide/lifecycle-configuration-examples.html#lc-size-rules)
         * in the *Amazon S3 User Guide* .
         *
         ...
         * If you specify an expiration and transition time, you must use the same time unit for
         * both properties (either in days or by date). The expiration time must also be later than
         * the transition time. If you specify this property, don't specify the `Transition`
         * property.
         *
        ...
        public interface Builder {
            /**
             * @param abortIncompleteMultipartUpload Specifies a lifecycle rule that stops
             *   incomplete multipart uploads to an Amazon S3 bucket.
             */
             ...
             *   Glacier. The date value must be in ISO 8601 format. The time is always midnight
             *   UTC. If you specify an expiration and transition time, you must use the same time
             *   unit for both properties (either in days or by date). The expiration time must also
             *   be later than the transition time.
             */
             ...
             *   deleted from Amazon S3 and Amazon S3 Glacier. If you specify an expiration and
             *   transition time, you must use the same time unit for both properties (either in
            ...
            /**
             * @param expiredObjectDeleteMarker Indicates whether Amazon S3 will remove a delete
             *   marker without any noncurrent versions. If set to true, the delete marker will be
             *   removed if there are no noncurrent versions. This cannot be specified with
            ...
            /**
             * @param id Unique identifier for the rule. The value can't be longer than 255
             *   characters.
             */
            public fun id(id: String)
             ...
             *   specific period in the object's lifetime.
             */
            public fun noncurrentVersionExpiration(
            ...
            public fun noncurrentVersionExpiration(
                noncurrentVersionExpiration: NoncurrentVersionExpirationProperty.Builder.() -> Unit
            )

            /**
             * @param noncurrentVersionExpirationInDays (Deprecated.) For buckets with versioning
             *   enabled (or suspended), specifies the time, in days, between when a new version of
             *   the object is uploaded to the bucket and when old versions of the object expire.
             *   When object versions expire, Amazon S3 permanently deletes them. If you specify a
             *   transition and expiration time, the expiration time must be later than the
             *   transition time.
             */
            public fun noncurrentVersionExpirationInDays(noncurrentVersionExpirationInDays: Number)

            /**
             * @param noncurrentVersionTransition (Deprecated.) For buckets with versioning enabled
             *   (or suspended), specifies when non-current objects transition to a specified
             *   storage class. If you specify a transition and expiration time, the expiration time
             *   must be later than the transition time. If you specify this property, don't specify
             *   the `NoncurrentVersionTransitions` property.
             */
             ...
             *   the `NoncurrentVersionTransitions` property.
             */
            public fun noncurrentVersionTransition(
            ...
            public fun noncurrentVersionTransition(
                noncurrentVersionTransition: NoncurrentVersionTransitionProperty.Builder.() -> Unit
            )

            /**
             * @param noncurrentVersionTransitions For buckets with versioning enabled (or
             *   suspended), one or more transition rules that specify when non-current objects
             *   transition to a specified storage class. If you specify a transition and expiration
             *   time, the expiration time must be later than the transition time. If you specify
            ...
            /**
             * @param objectSizeGreaterThan Specifies the minimum object size in bytes for this rule
             *   to apply to. Objects must be larger than this value in bytes. For more information
             *   about size based rules, see
             *   [Lifecycle configuration using size-based rules](https://docs.aws.amazon.com/AmazonS3/latest/userguide/lifecycle-configuration-examples.html#lc-size-rules)
             *   in the *Amazon S3 User Guide* .
             */
            ...
            /**
             * @param objectSizeLessThan Specifies the maximum object size in bytes for this rule to
             *   apply to. Objects must be smaller than this value in bytes. For more information
             *   about sized based rules, see
             *   [Lifecycle configuration using size-based rules](https://docs.aws.amazon.com/AmazonS3/latest/userguide/lifecycle-configuration-examples.html#lc-size-rules)
             *   in the *Amazon S3 User Guide* .
             */
            ...
            /**
             * @param prefix Object key prefix that identifies one or more objects to which this
             *   rule applies.
             *
             * Replacement must be made for object keys containing special characters (such as
             * carriage returns) when using XML requests. For more information, see
            ...
            /**
             * @param tagFilters Tags to use to identify a subset of objects to which the lifecycle
             *   rule applies.
             */
            public fun tagFilters(tagFilters: IResolvable)
            ...
            /**
             * @param transition (Deprecated.) Specifies when an object transitions to a specified
             ...
             *   must also be later than the transition time. If you specify this property, don't
            ...
            /**
             * @param transitions One or more transition rules that specify when an object
             *   transitions to a specified storage class. If you specify an expiration and
             *   transition time, you must use the same time unit for both properties (either in
             *   days or by date). The expiration time must also be later than the transition time.
        ...
        private class BuilderImpl : Builder {
            ...
            override fun expiredObjectDeleteMarker(expiredObjectDeleteMarker: IResolvable) {
                cdkBuilder.expiredObjectDeleteMarker(
                    expiredObjectDeleteMarker.let(IResolvable::unwrap)
                )
            }
            ...
            override fun noncurrentVersionExpiration(noncurrentVersionExpiration: IResolvable) {
                cdkBuilder.noncurrentVersionExpiration(
                    noncurrentVersionExpiration.let(IResolvable::unwrap)
                )
            }
             ...
             *   specific period in the object's lifetime.
             */
            override fun noncurrentVersionExpiration(
                noncurrentVersionExpiration: NoncurrentVersionExpirationProperty
            ) {
                cdkBuilder.noncurrentVersionExpiration(
                    noncurrentVersionExpiration.let(NoncurrentVersionExpirationProperty::unwrap)
                )
            }
            ...
            override fun noncurrentVersionExpiration(
                ...
                noncurrentVersionExpiration(
                    NoncurrentVersionExpirationProperty(noncurrentVersionExpiration)
                )
             ...
             *   transition time.
             */
            override fun noncurrentVersionExpirationInDays(
            ...
            override fun noncurrentVersionTransition(noncurrentVersionTransition: IResolvable) {
                cdkBuilder.noncurrentVersionTransition(
                    noncurrentVersionTransition.let(IResolvable::unwrap)
                )
            }
             ...
             *   the `NoncurrentVersionTransitions` property.
             */
            override fun noncurrentVersionTransition(
                noncurrentVersionTransition: NoncurrentVersionTransitionProperty
            ) {
                cdkBuilder.noncurrentVersionTransition(
                    noncurrentVersionTransition.let(NoncurrentVersionTransitionProperty::unwrap)
                )
            }
            ...
            override fun noncurrentVersionTransition(
                ...
                noncurrentVersionTransition(
                    NoncurrentVersionTransitionProperty(noncurrentVersionTransition)
                )
            ...
            override fun noncurrentVersionTransitions(noncurrentVersionTransitions: IResolvable) {
                cdkBuilder.noncurrentVersionTransitions(
                    noncurrentVersionTransitions.let(IResolvable::unwrap)
                )
            }
             ...
             *   this property, don't specify the `NoncurrentVersionTransition` property.
             */
            override fun noncurrentVersionTransitions(
                vararg noncurrentVersionTransitions: Any
            ): Unit = noncurrentVersionTransitions(noncurrentVersionTransitions.toList())
             ...
             *   If you specify this property, don't specify the `Transition` property.
             */
            override fun transitions(vararg transitions: Any): Unit =
        ...
        internal constructor(
             ...
             * The date value must be in ISO 8601 format. The time is always midnight UTC. If you
             * specify an expiration and transition time, you must use the same time unit for both
             * properties (either in days or by date). The expiration time must also be later than
             * the transition time.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-s3-bucket-rule.html#cfn-s3-bucket-rule-expirationdate)
             */
             ...
             *
             * If you specify an expiration and transition time, you must use the same time unit for
             * both properties (either in days or by date). The expiration time must also be later
             * than the transition time.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-s3-bucket-rule.html#cfn-s3-bucket-rule-expirationindays)
             */
            ...
            /**
             * Indicates whether Amazon S3 will remove a delete marker without any noncurrent
             * versions.
             *
             * If set to true, the delete marker will be removed if there are no noncurrent
             * versions. This cannot be specified with `ExpirationInDays` , `ExpirationDate` , or
             * `TagFilters` .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-s3-bucket-rule.html#cfn-s3-bucket-rule-expiredobjectdeletemarker)
             */
            override fun expiredObjectDeleteMarker(): Any? =
            ...
            /**
             * (Deprecated.) For buckets with versioning enabled (or suspended), specifies the time,
             * in days, between when a new version of the object is uploaded to the bucket and when
            ...
            /**
             * (Deprecated.) For buckets with versioning enabled (or suspended), specifies when
             * non-current objects transition to a specified storage class. If you specify a
             * transition and expiration time, the expiration time must be later than the transition
             * time. If you specify this property, don't specify the `NoncurrentVersionTransitions`
             * property.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-s3-bucket-rule.html#cfn-s3-bucket-rule-noncurrentversiontransition)
             */
             ...
             * specify when non-current objects transition to a specified storage class.
             *
             * If you specify a transition and expiration time, the expiration time must be later
             ...
             * Specifies the minimum object size in bytes for this rule to apply to.
             *
             * Objects must be larger than this value in bytes. For more information about size
             * based rules, see
             * [Lifecycle configuration using size-based rules](https://docs.aws.amazon.com/AmazonS3/latest/userguide/lifecycle-configuration-examples.html#lc-size-rules)
             * in the *Amazon S3 User Guide* .
             *
             ...
             * Specifies the maximum object size in bytes for this rule to apply to.
             *
             * Objects must be smaller than this value in bytes. For more information about sized
             * based rules, see
             * [Lifecycle configuration using size-based rules](https://docs.aws.amazon.com/AmazonS3/latest/userguide/lifecycle-configuration-examples.html#lc-size-rules)
             * in the *Amazon S3 User Guide* .
             *
            ...
            /**
             * (Deprecated.) Specifies when an object transitions to a specified storage class. If
             * you specify an expiration and transition time, you must use the same time unit for
             * both properties (either in days or by date). The expiration time must also be later
             * than the transition time. If you specify this property, don't specify the
    ...
    public interface PartitionedPrefixProperty {
        ...
        public interface Builder {
            /**
             * @param partitionDateSource Specifies the partition date source for the partitioned
             *   prefix. PartitionDateSource can be EventTime or DeliveryTime.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: PartitionedPrefixProperty
            ): software.amazon.awscdk.services.s3.CfnBucket.PartitionedPrefixProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface AbortIncompleteMultipartUploadProperty {
        ...
        public interface Builder {
            /**
             * @param daysAfterInitiation Specifies the number of days after which Amazon S3 stops
    ...
    public interface ObjectLockRuleProperty {
        ...
        public interface Builder {
            /**
             * @param defaultRetention The default Object Lock retention mode and period that you
             *   want to apply to new objects placed in the specified bucket. If Object Lock is
             *   turned on, bucket settings require both `Mode` and a period of either `Days` or
             *   `Years` . You cannot specify `Days` and `Years` at the same time. For more
             *   information about allowable values for mode and period, see
             *   [DefaultRetention](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-s3-bucket-defaultretention.html)
             *   .
             */
            ...
            public fun defaultRetention(
                defaultRetention: DefaultRetentionProperty.Builder.() -> Unit
            )
        }
        ...
        internal constructor(
             ...
             *
             * If Object Lock is turned on, bucket settings require both `Mode` and a period of
             * either `Days` or `Years` . You cannot specify `Days` and `Years` at the same time.
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ObjectLockRuleProperty
            ): software.amazon.awscdk.services.s3.CfnBucket.ObjectLockRuleProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DeleteMarkerReplicationProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DeleteMarkerReplicationProperty
            ): software.amazon.awscdk.services.s3.CfnBucket.DeleteMarkerReplicationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface LoggingConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param destinationBucketName The name of the bucket where Amazon S3 should store
             *   server access log files. You can store log files in any bucket that you own. By
             *   default, logs are stored in the bucket where the `LoggingConfiguration` property is
             *   defined.
             */
            public fun destinationBucketName(destinationBucketName: String)

            /**
             * @param logFilePrefix A prefix for all log object keys. If you store log files from
             *   multiple Amazon S3 buckets in a single bucket, you can use a prefix to distinguish
             *   which log files came from which bucket.
             */
            public fun logFilePrefix(logFilePrefix: String)

            /**
             * @param targetObjectKeyFormat Amazon S3 key format for log objects. Only one format,
             *   either PartitionedPrefix or SimplePrefix, is allowed.
             */
            ...
            public fun targetObjectKeyFormat(
                targetObjectKeyFormat: TargetObjectKeyFormatProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
             ...
             *   either PartitionedPrefix or SimplePrefix, is allowed.
             */
            override fun targetObjectKeyFormat(
                targetObjectKeyFormat: TargetObjectKeyFormatProperty
            ) {
                cdkBuilder.targetObjectKeyFormat(
                    targetObjectKeyFormat.let(TargetObjectKeyFormatProperty::unwrap)
                )
            }
        ...
        internal constructor(
             ...
             * The name of the bucket where Amazon S3 should store server access log files.
             *
             * You can store log files in any bucket that you own. By default, logs are stored in
             * the bucket where the `LoggingConfiguration` property is defined.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-s3-bucket-loggingconfiguration.html#cfn-s3-bucket-loggingconfiguration-destinationbucketname)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: LoggingConfigurationProperty
            ): software.amazon.awscdk.services.s3.CfnBucket.LoggingConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SseKmsEncryptedObjectsProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SseKmsEncryptedObjectsProperty
            ): software.amazon.awscdk.services.s3.CfnBucket.SseKmsEncryptedObjectsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface TieringProperty {
        ...
        public interface Builder {
             ...
             *   eligible to be transitioned to the corresponding tier. The minimum number of days
             *   specified for Archive Access tier must be at least 90 days and Deep Archive Access
             *   tier must be at least 180 days. The maximum can be up to 2 years (730 days).
             */
        ...
        internal constructor(
             ...
             * be transitioned to the corresponding tier.
             *
             * The minimum number of days specified for Archive Access tier must be at least 90 days
             * and Deep Archive Access tier must be at least 180 days. The maximum can be up to 2
             * years (730 days).
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-s3-bucket-tiering.html#cfn-s3-bucket-tiering-days)
             */
    ...
    public interface ReplicationDestinationProperty {
         ...
         *
         * In a cross-account scenario, if you direct Amazon S3 to change replica ownership to the
         * AWS account that owns the destination bucket by specifying the `AccessControlTranslation`
         * property, this is the account ID of the destination bucket owner. For more information,
         * see
         ...
         * in the *Amazon S3 User Guide* .
         *
         * If you specify the `AccessControlTranslation` property, the `Account` property is
         * required.
         *
        ...
        public interface Builder {
            /**
             * @param accessControlTranslation Specify this only in a cross-account scenario (where
             *   source and destination bucket owners are not the same), and you want to change
             *   replica ownership to the AWS account that owns the destination bucket. If this is
             *   not specified in the replication configuration, the replicas are owned by same AWS
             ...
             *   account that owns the source object.
             */
            public fun accessControlTranslation(
            ...
            public fun accessControlTranslation(
                accessControlTranslation: AccessControlTranslationProperty.Builder.() -> Unit
            )

            /**
             * @param account Destination bucket owner account ID. In a cross-account scenario, if
             *   you direct Amazon S3 to change replica ownership to the AWS account that owns the
            ...
            /**
             * @param bucket The Amazon Resource Name (ARN) of the bucket where you want Amazon S3
            ...
            /**
             * @param storageClass The storage class to use when replicating objects, such as S3
             *   Standard or reduced redundancy. By default, Amazon S3 uses the storage class of the
        ...
        private class BuilderImpl : Builder {
            ...
            override fun accessControlTranslation(accessControlTranslation: IResolvable) {
                cdkBuilder.accessControlTranslation(
                    accessControlTranslation.let(IResolvable::unwrap)
                )
            }
             ...
             *   account that owns the source object.
             */
            override fun accessControlTranslation(
                accessControlTranslation: AccessControlTranslationProperty
            ) {
                cdkBuilder.accessControlTranslation(
                    accessControlTranslation.let(AccessControlTranslationProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("786746b2c99329552cf2d7f244783967be8d7f83931cb236bdba5c6b08173e32")
            override fun replicationTime(
                replicationTime: ReplicationTimeProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             *
             * If this is not specified in the replication configuration, the replicas are owned by
             * same AWS account that owns the source object.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-s3-bucket-replicationdestination.html#cfn-s3-bucket-replicationdestination-accesscontroltranslation)
             */
            override fun accessControlTranslation(): Any? =
                unwrap(this).getAccessControlTranslation()

            /**
             * Destination bucket owner account ID.
             *
             * In a cross-account scenario, if you direct Amazon S3 to change replica ownership to
             * the AWS account that owns the destination bucket by specifying the
             * `AccessControlTranslation` property, this is the account ID of the destination bucket
             * owner. For more information, see
             * [Cross-Region Replication Additional Configuration: Change Replica Owner](https://docs.aws.amazon.com/AmazonS3/latest/dev/crr-change-owner.html)
             * in the *Amazon S3 User Guide* .
             *
             * If you specify the `AccessControlTranslation` property, the `Account` property is
            ...
            /**
             * A container specifying S3 Replication Time Control (S3 RTC), including whether S3 RTC
             ...
             * redundancy.
             *
             * By default, Amazon S3 uses the storage class of the source object to create the
             * object replica.
             *
             * For valid values, see the `StorageClass` element of the
             * [PUT Bucket replication](https://docs.aws.amazon.com/AmazonS3/latest/API/RESTBucketPUTreplication.html)
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ReplicationDestinationProperty
            ): software.amazon.awscdk.services.s3.CfnBucket.ReplicationDestinationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ReplicationTimeValueProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ReplicationTimeValueProperty
            ): software.amazon.awscdk.services.s3.CfnBucket.ReplicationTimeValueProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ObjectLockConfigurationProperty {
         ...
         * turned on, bucket settings require both `Mode` and a period of either `Days` or `Years` .
         * You cannot specify `Days` and `Years` at the same time. For more information, see
        ...
        public interface Builder {
            /**
             * @param objectLockEnabled Indicates whether this bucket has an Object Lock
             *   configuration enabled. Enable `ObjectLockEnabled` when you apply
             *   `ObjectLockConfiguration` to a bucket.
             */
            public fun objectLockEnabled(objectLockEnabled: String)

            /**
             * @param rule Specifies the Object Lock rule for the specified object. Enable this rule
             *   when you apply `ObjectLockConfiguration` to a bucket. If Object Lock is turned on,
             *   bucket settings require both `Mode` and a period of either `Days` or `Years` . You
        ...
        internal constructor(
             ...
             * Specifies the Object Lock rule for the specified object.
             *
             * Enable this rule when you apply `ObjectLockConfiguration` to a bucket. If Object Lock
             * is turned on, bucket settings require both `Mode` and a period of either `Days` or
             * `Years` . You cannot specify `Days` and `Years` at the same time. For more
             * information, see
             * [ObjectLockRule](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-s3-bucket-objectlockrule.html)
             * and
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ObjectLockConfigurationProperty
            ): software.amazon.awscdk.services.s3.CfnBucket.ObjectLockConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface RedirectAllRequestsToProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param protocol Protocol to use when redirecting requests. The default is the
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RedirectAllRequestsToProperty
            ): software.amazon.awscdk.services.s3.CfnBucket.RedirectAllRequestsToProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface RoutingRuleConditionProperty {
         ...
         *
         * In the event of an error, if the error code equals this value, then the specified
         * redirect is applied.
         *
         * Required when parent element `Condition` is specified and sibling `KeyPrefixEquals` is
         ...
         * `HttpErrorCodeReturnedEquals` is not specified. If both conditions are specified, both
        ...
        public interface Builder {
             ...
             * is not specified. If both are specified, then both must be true for the redirect to
             * be applied.
             */
            public fun httpErrorCodeReturnedEquals(httpErrorCodeReturnedEquals: String)

            /**
             * @param keyPrefixEquals The object key name prefix when the redirect is applied. For
             *   example, to redirect requests for `ExamplePage.html` , the key prefix will be
             *   `ExamplePage.html` . To redirect request for all pages with the prefix `docs/` ,
             *   the key prefix will be `/docs` , which identifies all objects in the docs/ folder.
             *
             * Required when the parent element `Condition` is specified and sibling
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RoutingRuleConditionProperty
            ): software.amazon.awscdk.services.s3.CfnBucket.RoutingRuleConditionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ReplicaModificationsProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ReplicaModificationsProperty
            ): software.amazon.awscdk.services.s3.CfnBucket.ReplicaModificationsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface BucketEncryptionProperty {
        ...
        public interface Builder {
             ...
             */
            public fun serverSideEncryptionConfiguration(
                serverSideEncryptionConfiguration: List<Any>
            )
             ...
             */
            public fun serverSideEncryptionConfiguration(
                vararg serverSideEncryptionConfiguration: Any
            )
        }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: BucketEncryptionProperty
            ): software.amazon.awscdk.services.s3.CfnBucket.BucketEncryptionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface RoutingRuleProperty {
        ...
        public interface Builder {
            /**
             * @param redirectRule Container for redirect information. You can redirect requests to
             *   another host, to another page, or with another protocol. In the event of an error,
            ...
            /**
             * @param routingRuleCondition A container for describing a condition that must be met
             *   for the specified redirect to apply. For example, 1. If request is for pages in the
             *   `/docs` folder, redirect to the `/documents` folder. 2. If request results in HTTP
            ...
            public fun routingRuleCondition(
                routingRuleCondition: RoutingRuleConditionProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun routingRuleCondition(routingRuleCondition: RoutingRuleConditionProperty) {
                cdkBuilder.routingRuleCondition(
                    routingRuleCondition.let(RoutingRuleConditionProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("adc3832cde4e8c41ab9275613006ea5d986364af5c6047e7ae72a4312de08179")
            override fun routingRuleCondition(
                routingRuleCondition: RoutingRuleConditionProperty.Builder.() -> Unit
    ...
    public interface TopicConfigurationProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param filter The filtering rules that determine for which objects to send
             *   notifications. For example, you can create a filter so that Amazon S3 sends
             *   notifications only when image files with a `.jpg` extension are added to the
             *   bucket.
             */
            public fun filter(filter: IResolvable)
            ...
            /**
             * @param topic The Amazon Resource Name (ARN) of the Amazon SNS topic to which Amazon
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TopicConfigurationProperty
            ): software.amazon.awscdk.services.s3.CfnBucket.TopicConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface EncryptionConfigurationProperty {
         ...
         * encryption KMS keys. For more information, see
        ...
        public interface Builder {
            /**
             * @param replicaKmsKeyId Specifies the ID (Key ARN or Alias ARN) of the customer
             *   managed AWS KMS key stored in AWS Key Management Service (KMS) for the destination
        ...
        internal constructor(
             ...
             * AWS Key Management Service (KMS) for the destination bucket.
             *
             * Amazon S3 uses this key to encrypt replica objects. Amazon S3 only supports symmetric
             * encryption KMS keys. For more information, see
             * [Asymmetric keys in AWS KMS](https://docs.aws.amazon.com//kms/latest/developerguide/symmetric-asymmetric.html)
    ...
    public interface RedirectRuleProperty {
         ...
         *
         * For example, to redirect requests for all pages with prefix `docs/` (objects in the
         * `docs/` folder) to `documents/` , you can set a condition block with `KeyPrefixEquals`
         * set to `docs/` and in the Redirect set `ReplaceKeyPrefixWith` to `/documents` . Not
         * required if one of the siblings is present. Can be present only if `ReplaceKeyWith` is
         * not provided.
         *
         * Replacement must be made for object keys containing special characters (such as carriage
         * returns) when using XML requests. For more information, see
        ...
        public interface Builder {
            ...
            /**
             * @param httpRedirectCode The HTTP redirect code to use on the response. Not required
             ...
             *   example, to redirect requests for all pages with prefix `docs/` (objects in the
             *   `docs/` folder) to `documents/` , you can set a condition block with
             *   `KeyPrefixEquals` set to `docs/` and in the Redirect set `ReplaceKeyPrefixWith` to
             *   `/documents` . Not required if one of the siblings is present. Can be present only
            ...
            /**
             * @param replaceKeyWith The specific object key to use in the redirect request. For
             *   example, redirect request to `error.html` . Not required if one of the siblings is
             *   present. Can be present only if `ReplaceKeyPrefixWith` is not provided.
             *
             * Replacement must be made for object keys containing special characters (such as
             * carriage returns) when using XML requests. For more information, see
        ...
        internal constructor(
             ...
             * The specific object key to use in the redirect request.
             *
             * For example, redirect request to `error.html` . Not required if one of the siblings
             * is present. Can be present only if `ReplaceKeyPrefixWith` is not provided.
             *
             * Replacement must be made for object keys containing special characters (such as
             * carriage returns) when using XML requests. For more information, see
             * [XML related object key constraints](https://docs.aws.amazon.com/AmazonS3/latest/userguide/object-keys.html#object-key-xml-related-constraints)
    ...
    public interface AnalyticsConfigurationProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param prefix The prefix that an object must have to be included in the analytics
             *   results.
             */
            public fun prefix(prefix: String)

            /**
             * @param storageClassAnalysis Contains data related to access patterns to be collected
            ...
            public fun storageClassAnalysis(
                storageClassAnalysis: StorageClassAnalysisProperty.Builder.() -> Unit
            )

            /**
             * @param tagFilters The tags to use when evaluating an analytics filter. The analytics
             *   only includes objects that meet the filter's criteria. If no filter is specified,
        ...
        private class BuilderImpl : Builder {
            ...
            override fun storageClassAnalysis(storageClassAnalysis: StorageClassAnalysisProperty) {
                cdkBuilder.storageClassAnalysis(
                    storageClassAnalysis.let(StorageClassAnalysisProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("4392adb244bd5d9c51e9ceed83e47fb610720fbfb0accbff6826dcab1c2a1d93")
            override fun storageClassAnalysis(
                storageClassAnalysis: StorageClassAnalysisProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AnalyticsConfigurationProperty
            ): software.amazon.awscdk.services.s3.CfnBucket.AnalyticsConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface StorageClassAnalysisProperty {
        ...
        public interface Builder {
            /**
             * @param dataExport Specifies how data related to the storage class analysis for an
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: StorageClassAnalysisProperty
            ): software.amazon.awscdk.services.s3.CfnBucket.StorageClassAnalysisProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ReplicationTimeProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param time A container specifying the time by which replication should be complete
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ReplicationTimeProperty
            ): software.amazon.awscdk.services.s3.CfnBucket.ReplicationTimeProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface FilterRuleProperty {
        ...
        public interface Builder {
            /**
             * @param name The object key name prefix or suffix identifying one or more objects to
    ...
    public interface CorsConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param corsRules A set of origins and methods (cross-origin access that you want to
             *   allow).
             *
             * You can add up to 100 rules to the configuration.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CorsConfigurationProperty
            ): software.amazon.awscdk.services.s3.CfnBucket.CorsConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DefaultRetentionProperty {
        ...
        public interface Builder {
            /**
             * @param days The number of days that you want to specify for the default retention
             *   period. If Object Lock is turned on, you must specify `Mode` and specify either
             *   `Days` or `Years` .
             */
            public fun days(days: Number)

            /**
             * @param mode The default Object Lock retention mode you want to apply to new objects
             *   placed in the specified bucket. If Object Lock is turned on, you must specify
             *   `Mode` and specify either `Days` or `Years` .
             */
            public fun mode(mode: String)

            /**
             * @param years The number of years that you want to specify for the default retention
             *   period. If Object Lock is turned on, you must specify `Mode` and specify either
             *   `Days` or `Years` .
             */
        ...
        internal constructor(
             ...
             * The number of days that you want to specify for the default retention period.
             *
             * If Object Lock is turned on, you must specify `Mode` and specify either `Days` or
             * `Years` .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-s3-bucket-defaultretention.html#cfn-s3-bucket-defaultretention-days)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DefaultRetentionProperty
            ): software.amazon.awscdk.services.s3.CfnBucket.DefaultRetentionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface PublicAccessBlockConfigurationProperty {
         ...
         *
         * Setting this element to `TRUE` causes Amazon S3 to reject calls to PUT Bucket policy if
        ...
        public interface Builder {
            /**
             * @param blockPublicAcls Specifies whether Amazon S3 should block public access control
             *   lists (ACLs) for this bucket and objects in this bucket. Setting this element to
            ...
            /**
             * @param blockPublicPolicy Specifies whether Amazon S3 should block public bucket
             *   policies for this bucket. Setting this element to `TRUE` causes Amazon S3 to reject
            ...
            /**
             * @param ignorePublicAcls Specifies whether Amazon S3 should ignore public ACLs for
             *   this bucket and objects in this bucket. Setting this element to `TRUE` causes
             *   Amazon S3 to ignore all public ACLs on this bucket and objects in this bucket.
             *
             * Enabling this setting doesn't affect the persistence of any existing ACLs and doesn't
             * prevent new public ACLs from being set.
             */
            ...
            /**
             * @param restrictPublicBuckets Specifies whether Amazon S3 should restrict public
             *   bucket policies for this bucket. Setting this element to `TRUE` restricts access to
             *   this bucket to only AWS service principals and authorized users within this account
        ...
        internal constructor(
             ...
             * this bucket.
             *
             * Setting this element to `TRUE` causes Amazon S3 to ignore all public ACLs on this
             * bucket and objects in this bucket.
             *
             * Enabling this setting doesn't affect the persistence of any existing ACLs and doesn't
             * prevent new public ACLs from being set.
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: PublicAccessBlockConfigurationProperty
            ): software.amazon.awscdk.services.s3.CfnBucket.PublicAccessBlockConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ServerSideEncryptionRuleProperty {
         ...
         *
         * Existing objects are not affected. Setting the `BucketKeyEnabled` element to `true`
        ...
        public interface Builder {
             ...
             *   server-side encryption using KMS (SSE-KMS) for new objects in the bucket. Existing
             *   objects are not affected. Setting the `BucketKeyEnabled` element to `true` causes
            ...
            /**
             * @param serverSideEncryptionByDefault Specifies the default server-side encryption to
             *   apply to new objects in the bucket. If a PUT Object request doesn't specify any
            ...
            public fun serverSideEncryptionByDefault(
                serverSideEncryptionByDefault:
                    ServerSideEncryptionByDefaultProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun serverSideEncryptionByDefault(serverSideEncryptionByDefault: IResolvable) {
                cdkBuilder.serverSideEncryptionByDefault(
                    serverSideEncryptionByDefault.let(IResolvable::unwrap)
                )
            }
             ...
             *   server-side encryption, this default encryption will be applied.
             */
            override fun serverSideEncryptionByDefault(
                serverSideEncryptionByDefault: ServerSideEncryptionByDefaultProperty
            ) {
                cdkBuilder.serverSideEncryptionByDefault(
                    serverSideEncryptionByDefault.let(ServerSideEncryptionByDefaultProperty::unwrap)
                )
            }
            ...
            override fun serverSideEncryptionByDefault(
                ...
                serverSideEncryptionByDefault(
                    ServerSideEncryptionByDefaultProperty(serverSideEncryptionByDefault)
                )
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ServerSideEncryptionRuleProperty
            ): software.amazon.awscdk.services.s3.CfnBucket.ServerSideEncryptionRuleProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface OwnershipControlsRuleProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: OwnershipControlsRuleProperty
            ): software.amazon.awscdk.services.s3.CfnBucket.OwnershipControlsRuleProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ServerSideEncryptionByDefaultProperty {
        ...
        public interface Builder {
            /**
             * @param kmsMasterKeyId AWS Key Management Service (KMS) customer AWS KMS key ID to use
             *   for the default encryption. This parameter is allowed if and only if `SSEAlgorithm`
             ...
             * a fully qualified KMS key ARN. For more information, see
             * [Using encryption for cross-account operations](https://docs.aws.amazon.com/AmazonS3/latest/dev/bucket-encryption.html#bucket-encryption-update-bucket-policy)
             * .
             *
             * Amazon S3 only supports symmetric encryption KMS keys. For more information, see
            ...
            /**
             * @param sseAlgorithm Server-side encryption algorithm to use for the default
             *   encryption.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ServerSideEncryptionByDefaultProperty
            ): software.amazon.awscdk.services.s3.CfnBucket.ServerSideEncryptionByDefaultProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
