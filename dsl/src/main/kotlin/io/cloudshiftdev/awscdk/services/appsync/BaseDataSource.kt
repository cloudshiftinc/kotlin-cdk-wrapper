...
internal constructor(
    ...
    public open fun createFunction(id: String, props: BaseAppsyncFunctionProps): AppsyncFunction =
        unwrap(this)
            .createFunction(id, props.let(BaseAppsyncFunctionProps::unwrap))
            .let(AppsyncFunction::wrap)
    ...
    public open fun createFunction(
        id: String,
        props: BaseAppsyncFunctionProps.Builder.() -> Unit
    ...
    public open fun createResolver(
        id: String,
        props: BaseResolverProps.Builder.() -> Unit
    ): Resolver = createResolver(id, BaseResolverProps(props))
