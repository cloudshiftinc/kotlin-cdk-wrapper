...
public interface IMesh : IResource {
    ...
    public fun addVirtualGateway(
        id: String,
        props: VirtualGatewayBaseProps.Builder.() -> Unit
    ): VirtualGateway
    ...
    public fun addVirtualNode(
        id: String,
        props: VirtualNodeBaseProps.Builder.() -> Unit
    ): VirtualNode
    ...
    public fun addVirtualRouter(
        id: String,
        props: VirtualRouterBaseProps.Builder.() -> Unit
    ): VirtualRouter
    ...
    internal constructor(
         ...
         * Creates a new VirtualGateway in this Mesh.
         *
         * Note that the Gateway is created in the same Stack that this Mesh belongs to, which might
         * be different than the current stack.
         *
         * @param id
         * @param props
         */
        ...
        override fun addVirtualGateway(id: String, props: VirtualGatewayBaseProps): VirtualGateway =
            unwrap(this)
                .addVirtualGateway(id, props.let(VirtualGatewayBaseProps::unwrap))
                .let(VirtualGateway::wrap)
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("806769f186eaec3fa9e3209acdf24765b05ef2369fd0cab34a25f9215b419f1a")
        override fun addVirtualGateway(
            id: String,
            props: VirtualGatewayBaseProps.Builder.() -> Unit
        ...
        override fun addVirtualNode(id: String, props: VirtualNodeBaseProps): VirtualNode =
            unwrap(this)
                .addVirtualNode(id, props.let(VirtualNodeBaseProps::unwrap))
                .let(VirtualNode::wrap)
         ...
         * Creates a new VirtualRouter in this Mesh.
         *
         * Note that the Router is created in the same Stack that this Mesh belongs to, which might
         * be different than the current stack.
         *
         * @param id
         * @param props
        ...
        override fun addVirtualRouter(id: String, props: VirtualRouterBaseProps): VirtualRouter =
            unwrap(this)
                .addVirtualRouter(id, props.let(VirtualRouterBaseProps::unwrap))
                .let(VirtualRouter::wrap)
    ...
    public companion object {
        ...
        internal fun unwrap(wrapped: IMesh): software.amazon.awscdk.services.appmesh.IMesh =
