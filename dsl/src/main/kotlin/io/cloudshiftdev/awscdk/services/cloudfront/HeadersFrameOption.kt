...
public enum class HeadersFrameOption(
    ...
    public companion object {
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.cloudfront.HeadersFrameOption
        ): HeadersFrameOption =
            when (cdkObject) {
                software.amazon.awscdk.services.cloudfront.HeadersFrameOption.DENY ->
