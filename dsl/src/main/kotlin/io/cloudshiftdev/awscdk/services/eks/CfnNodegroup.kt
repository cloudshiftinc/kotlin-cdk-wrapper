...
internal constructor(
    ...
    public interface Builder {
         ...
         * specify `amiType` , or the node group deployment will fail. If your launch template uses
         * a Windows custom AMI, then add `eks:kube-proxy-windows` to your Windows nodes `rolearn`
         * in the `aws-auth` `ConfigMap` . For more information about using launch templates with
         * Amazon EKS, see
         ...
         * The root device disk size (in GiB) for your node group instances.
         *
         * The default disk size is 20 GiB for Linux and Bottlerocket. The default disk size is 50
         * GiB for Windows. If you specify `launchTemplate` , then don't specify `diskSize` , or the
         ...
         * disruption budget issue.
         *
         * If an update fails because all Pods can't be drained, you can force the update after it
         ...
         *
         * @param forceUpdateEnabled Force the update if any `Pod` on the existing node group can't
         ...
         * Specify the instance types for a node group.
         *
         * If you specify a GPU instance type, make sure to also specify an applicable GPU AMI type
         * with the `amiType` parameter. If you specify `launchTemplate` , then you can specify zero
         ...
         * specify any `instanceTypes` , the node group deployment will fail. If you don't specify
         * an instance type in a launch template or for `instanceTypes` , then `t3.medium` is used,
         ...
         * An object representing a node group's launch template specification.
         *
         * If specified, then do not specify `instanceTypes` , `diskSize` , or `remoteAccess` and
         ...
         *
         * @param launchTemplate An object representing a node group's launch template
         *   specification.
         */
         ...
         *
         * @param nodeRole The Amazon Resource Name (ARN) of the IAM role to associate with your
         *   node group.
         */
         ...
         *
         * @param releaseVersion The AMI version of the Amazon EKS optimized AMI to use with your
         *   node group (for example, `1.14.7- *YYYYMMDD*` ). By default, the latest available AMI
         *   version for the node group's current Kubernetes version is used. For more information,
         *   see
         *   [Amazon EKS optimized Linux AMI Versions](https://docs.aws.amazon.com/eks/latest/userguide/eks-linux-ami-versions.html)
         *   in the *Amazon EKS User Guide* .
         */
         ...
         * Metadata that assists with categorization and organization.
         *
         * Each tag consists of a key and an optional value. You define both. Tags don't propagate
         * to any other cluster or AWS resources.
         *
         ...
         * The Kubernetes taints to be applied to the nodes in the node group when they are created.
         *
         * Effect is one of `No_Schedule` , `Prefer_No_Schedule` , or `No_Execute` . Kubernetes
         * taints can be used together with tolerations to control how workloads are scheduled to
         * your nodes. For more information, see
         ...
         *
         * @param taints The Kubernetes taints to be applied to the nodes in the node group when
         *   they are created.
         */
    ...
    public companion object {
        ...
        ): CfnNodegroup = CfnNodegroup(cdkObject)

        internal fun unwrap(
            wrapped: CfnNodegroup
        ): software.amazon.awscdk.services.eks.CfnNodegroup = wrapped.cdkObject
    }
    ...
    public interface LaunchTemplateSpecificationProperty {
        ...
        public interface Builder {
            /**
             * @param id The ID of the launch template. You must specify either the launch template
             *   ID or the launch template name in the request, but not both.
             */
            public fun id(id: String)

            /**
             * @param name The name of the launch template. You must specify either the launch
             *   template name or the launch template ID in the request, but not both.
             */
            public fun name(name: String)

            /**
             * @param version The version number of the launch template to use. If no version is
    ...
    public interface RemoteAccessProperty {
         ...
         * in the *Amazon Elastic Compute Cloud User Guide for Linux Instances* . For Windows, an
         ...
         * opened to the internet ( `0.0.0.0/0` ). For more information, see
         ...
         */
        public fun sourceSecurityGroups(): List<String> =
        ...
        public interface Builder {
            /**
             * @param ec2SshKey The Amazon EC2 SSH key name that provides access for SSH
             *   communication with the nodes in the managed node group. For more information, see
             *   [Amazon EC2 key pairs and Linux instances](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-key-pairs.html)
             *   in the *Amazon Elastic Compute Cloud User Guide for Linux Instances* . For Windows,
             *   an Amazon EC2 SSH key is used to obtain the RDP password. For more information, see
             *   [Amazon EC2 key pairs and Windows instances](https://docs.aws.amazon.com/AWSEC2/latest/WindowsGuide/ec2-key-pairs.html)
             *   in the *Amazon Elastic Compute Cloud User Guide for Windows Instances* .
             */
            ...
            /**
             * @param sourceSecurityGroups The security group IDs that are allowed SSH access
             *   (port 22) to the nodes. For Windows, the port is 3389. If you specify an Amazon EC2
             *   SSH key but don't specify a source security group when you create a managed node
             *   group, then the port on the nodes is opened to the internet ( `0.0.0.0/0` ). For
        ...
        internal constructor(
             ...
             * The security group IDs that are allowed SSH access (port 22) to the nodes.
             *
             * For Windows, the port is 3389. If you specify an Amazon EC2 SSH key but don't specify
             * a source security group when you create a managed node group, then the port on the
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-eks-nodegroup-remoteaccess.html#cfn-eks-nodegroup-remoteaccess-sourcesecuritygroups)
             */
            override fun sourceSecurityGroups(): List<String> =
                unwrap(this).getSourceSecurityGroups() ?: emptyList()
        }
    ...
    public interface UpdateConfigProperty {
         ...
         *
         * Nodes are updated in parallel. This value or `maxUnavailablePercentage` is required to
        ...
        public interface Builder {
            /**
             * @param maxUnavailable The maximum number of nodes unavailable at once during a
             *   version update. Nodes are updated in parallel. This value or
             *   `maxUnavailablePercentage` is required to have a value.The maximum number is 100.
             */
             ...
             *   version update. This percentage of nodes are updated in parallel, up to 100 nodes
        ...
        internal constructor(
             ...
             * The maximum number of nodes unavailable at once during a version update.
             *
             * Nodes are updated in parallel. This value or `maxUnavailablePercentage` is required
             ...
             * The maximum percentage of nodes unavailable during a version update.
             *
             * This percentage of nodes are updated in parallel, up to 100 nodes at once. This value
             * or `maxUnavailable` is required to have a value.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-eks-nodegroup-updateconfig.html#cfn-eks-nodegroup-updateconfig-maxunavailablepercentage)
             */
            override fun maxUnavailablePercentage(): Number? =
    ...
    public interface ScalingConfigProperty {
         ...
         *
         * If you use the Kubernetes
         * [Cluster Autoscaler](https://docs.aws.amazon.com/https://github.com/kubernetes/autoscaler#kubernetes-autoscaler)
         ...
         * terminated to match the given value. When using CloudFormation, no action occurs if you
         * remove this parameter from your CFN template.
         *
         * This parameter can be different from `minSize` in some cases, such as when starting with
         * extra hosts for testing. This parameter can also be different when you want to start with
         * an estimated number of needed hosts, but let the Cluster Autoscaler reduce the number if
         * there are too many. When the Cluster Autoscaler is used, the `desiredSize` parameter is
         * altered by the Cluster Autoscaler (but can be out-of-date for short periods of time). the
         ...
         *
         * For information about the maximum number that you can specify, see
        ...
        public interface Builder {
            /**
             * @param desiredSize The current number of nodes that the managed node group should
             *   maintain.
             *
             * If you use the Kubernetes
             * [Cluster Autoscaler](https://docs.aws.amazon.com/https://github.com/kubernetes/autoscaler#kubernetes-autoscaler)
             ...
             * updated to the specified size. If this parameter is given a value that is smaller
             * than the current number of running worker nodes, the necessary number of worker nodes
             * are terminated to match the given value. When using CloudFormation, no action occurs
             ...
             * the number if there are too many. When the Cluster Autoscaler is used, the
             * `desiredSize` parameter is altered by the Cluster Autoscaler (but can be out-of-date
             * for short periods of time). the Cluster Autoscaler doesn't scale a managed node group
             * lower than `minSize` or higher than `maxSize` .
             */
            public fun desiredSize(desiredSize: Number)

            /**
             * @param maxSize The maximum number of nodes that the managed node group can scale out
            ...
            /**
             * @param minSize The minimum number of nodes that the managed node group can scale in
             *   to.
             */
