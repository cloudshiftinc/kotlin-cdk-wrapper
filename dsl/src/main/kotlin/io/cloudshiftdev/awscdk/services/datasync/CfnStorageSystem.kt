...
internal constructor(
     ...
     * [AWS Secrets Manager](https://docs.aws.amazon.com/datasync/latest/userguide/discovery-configure-storage.html#discovery-add-storage)
     * .
     */
    ...
    public open fun serverConfiguration(
        `value`: ServerConfigurationProperty.Builder.() -> Unit
    ): Unit = serverConfiguration(ServerConfigurationProperty(`value`))
    ...
    public interface Builder {
         ...
         *
         * @param agentArns Specifies the Amazon Resource Name (ARN) of the DataSync agent that
        ...
        public fun serverConfiguration(
            serverConfiguration: ServerConfigurationProperty.Builder.() -> Unit
        )
         ...
         *
         * @param serverCredentials Specifies the user name and password for accessing your
        ...
        public fun serverCredentials(
            serverCredentials: ServerCredentialsProperty.Builder.() -> Unit
        )
         ...
         *
         * DataSync Discovery currently supports NetApp Fabric-Attached Storage (FAS) and All Flash
         * FAS (AFF) systems running ONTAP 9.7 or later.
         *
    ...
    private class BuilderImpl(
        ...
        override fun serverConfiguration(serverConfiguration: ServerConfigurationProperty) {
            cdkBuilder.serverConfiguration(
                serverConfiguration.let(ServerConfigurationProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("d63fea3a02de023e3ab99ac7b14d437a015acfd8a3eeeb131cc96ae57fd8fe82")
        override fun serverConfiguration(
            serverConfiguration: ServerConfigurationProperty.Builder.() -> Unit
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("9ebba701bf8b661b60c10a0d2748b0e9d4fa67046ab26a76b24e3736ca96bb96")
        override fun serverCredentials(
            serverCredentials: ServerCredentialsProperty.Builder.() -> Unit
    ...
    public interface ServerCredentialsProperty {
        ...
        public interface Builder {
            /**
             * @param password Specifies the password for your storage system's management
             *   interface.
             */
            public fun password(password: String)

            /**
             * @param username Specifies the user name for your storage system's management
             *   interface.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ServerCredentialsProperty
            ): software.amazon.awscdk.services.datasync.CfnStorageSystem.ServerCredentialsProperty =
    ...
    public interface ServerConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param serverHostname The domain name or IP address of your storage system's
             *   management interface.
             */
            public fun serverHostname(serverHostname: String)

            /**
             * @param serverPort The network port for accessing the storage system's management
             *   interface.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ServerConfigurationProperty
            ): software.amazon.awscdk.services.datasync.CfnStorageSystem.ServerConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
