...
internal constructor(
     ...
     * task subnets.
     */
    public open fun securityGroupArns(): List<String> =
        unwrap(this).getSecurityGroupArns() ?: emptyList()
    ...
    public interface Builder {
         ...
         *
         * @param subnetArns Specifies the ARN of the subnet where you want to run your DataSync
         *   task when using a VPC endpoint.
         */
         ...
         * The ID of the virtual private cloud (VPC) endpoint that the agent has access to.
         *
         * This is the client-side VPC endpoint, powered by AWS PrivateLink . If you don't have an
         * AWS PrivateLink VPC endpoint, see
         ...
         *
         * @param vpcEndpointId The ID of the virtual private cloud (VPC) endpoint that the agent
         *   has access to.
         */
