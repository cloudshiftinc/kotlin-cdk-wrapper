...
internal constructor(
    ...
    public interface Builder {
         ...
         * The Amazon Resource Name (ARN) of the resource to associate with the notification rule.
         *
         * Supported resources include pipelines in AWS CodePipeline , repositories in AWS
         ...
         * The status of the notification rule.
         *
         * The default value is `ENABLED` . If the status is set to `DISABLED` , notifications
         * aren't sent for the notification rule.
         *
         ...
         *
         * @param targets A list of Amazon Resource Names (ARNs) of Amazon SNS topics and AWS
    ...
    public interface TargetProperty {
        ...
        /**
         * The target type. Can be an Amazon Simple Notification Service topic or AWS Chatbot
         * client.
        ...
        public interface Builder {
            /**
             * @param targetAddress The Amazon Resource Name (ARN) of the AWS Chatbot topic or AWS
             *   Chatbot client.
             */
            public fun targetAddress(targetAddress: String)

            /**
             * @param targetType The target type. Can be an Amazon Simple Notification Service topic
             *   or AWS Chatbot client.
             * * Amazon Simple Notification Service topics are specified as `SNS` .
             * * AWS Chatbot clients are specified as `AWSChatbotSlack` .
             * * AWS Chatbot clients for Microsoft Teams are specified as `AWSChatbotMicrosoftTeams`
             *   .
