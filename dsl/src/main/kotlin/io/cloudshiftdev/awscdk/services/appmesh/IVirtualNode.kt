...
public interface IVirtualNode : IResource {
     ...
     *
     * Set this value as the APPMESH_VIRTUAL_NODE_NAME environment variable for your task group's
    ...
    internal constructor(
         ...
         * The Amazon Resource Name belonging to the VirtualNode.
         *
         * Set this value as the APPMESH_VIRTUAL_NODE_NAME environment variable for your task
    ...
    public companion object {
        ...
        ): IVirtualNode = Wrapper(cdkObject)

        internal fun unwrap(
            wrapped: IVirtualNode
        ): software.amazon.awscdk.services.appmesh.IVirtualNode = (wrapped as Wrapper).cdkObject
    }
}
