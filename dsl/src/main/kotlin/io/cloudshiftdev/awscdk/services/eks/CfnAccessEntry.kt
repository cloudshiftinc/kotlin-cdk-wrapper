...
internal constructor(
     ...
     */
    public open fun kubernetesGroups(): List<String> =
        unwrap(this).getKubernetesGroups() ?: emptyList()
    ...
    public interface Builder {
         ...
         *
         * Amazon EKS doesn't confirm that the value for `name` exists in any bindings on your
         * cluster. You can specify one or more names.
         *
         * Kubernetes authorizes the `principalArn` of the access entry to access any cluster
         * objects that you've specified in a Kubernetes `Role` or `ClusterRole` object that is also
         * specified in a binding's `roleRef` . For more information about creating Kubernetes
         * `RoleBinding` , `ClusterRoleBinding` , `Role` , or `ClusterRole` objects, see
         ...
         * Kubernetes authorizing the `principalArn` ), you can associate one or more access
         * policies to the access entry using `AssociateAccessPolicy` . If you associate any access
         * policies, the `principalARN` has all permissions assigned in the associated access
         * policies and all permissions in any Kubernetes `Role` or `ClusterRole` objects that the
         * group names are bound to.
         *
         ...
         * The ARN of the IAM principal for the `AccessEntry` .
         *
         * You can specify one ARN for each access entry. You can't specify the same ARN in more
         * than one access entry. This value can't be changed after access entry creation.
         *
         ...
         * You can use every IAM principal type for `STANDARD` access entries. You can't use the STS
         * session principal type with access entries because this is a temporary principal for each
         ...
         * don't specify a value, Amazon EKS sets the value to `STANDARD` . It's unnecessary to
         * create access entries for IAM roles used with Fargate profiles or managed Amazon EC2
         * nodes, because Amazon EKS creates entries in the `aws-auth` `ConfigMap` for the roles.
         * You can't change this value once you've created the access entry.
         *
         ...
         * The username to authenticate to Kubernetes with.
         *
         * We recommend not specifying a username and letting Amazon EKS specify it for you. For
         * more information about the value Amazon EKS specifies for you, or constraints before
         * specifying your own username, see
    ...
    public companion object {
        ...
        ): CfnAccessEntry = CfnAccessEntry(cdkObject)

        internal fun unwrap(
            wrapped: CfnAccessEntry
        ): software.amazon.awscdk.services.eks.CfnAccessEntry = wrapped.cdkObject
    }
    ...
    public interface AccessScopeProperty {
        ...
        public interface Builder {
            /**
             * @param namespaces A Kubernetes `namespace` that an access policy is scoped to. A
             *   value is required if you specified `namespace` for `Type` .
             */
        ...
        private class BuilderImpl : Builder {
             ...
             *   value is required if you specified `namespace` for `Type` .
             */
            override fun namespaces(vararg namespaces: String): Unit =
    ...
    public interface AccessPolicyProperty {
        ...
        public interface Builder {
            /**
             * @param accessScope The scope of an `AccessPolicy` that's associated to an
             *   `AccessEntry` .
             */
