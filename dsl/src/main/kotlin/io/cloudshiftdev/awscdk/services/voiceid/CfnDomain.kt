...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param serverSideEncryptionConfiguration The server-side encryption configuration
         *   containing the KMS key identifier you want Voice ID to use to encrypt your data.
         */
    ...
    public interface ServerSideEncryptionConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param kmsKeyId The identifier of the KMS key to use to encrypt data stored by Voice
        ...
        private class BuilderImpl : Builder {
            private val cdkBuilder:
                ...
                software.amazon.awscdk.services.voiceid.CfnDomain
