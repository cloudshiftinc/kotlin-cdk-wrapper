...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param characterSetName For supported engines, specifies the character set to associate
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.rds.DatabaseInstance =
            cdkBuilder.build()
    }
