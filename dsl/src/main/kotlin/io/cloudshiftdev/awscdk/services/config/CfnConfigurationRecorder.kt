...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * You cannot change the name of the configuration recorder after it has been created. To
         * change the configuration recorder name, you must delete it and create a new configuration
         ...
         *
         * @param name The name of the configuration recorder. AWS Config automatically assigns the
         ...
         * process, AWS Config runs evaluations on all the resources in your account that you have
         * selected for AWS Config to record.
         *
         * If you are running ephemeral workloads, you may see increased activity from AWS Config as
         * it records configuration changes associated with creating and deleting these temporary
         * resources. An *ephemeral workload* is a temporary use of computing resources that are
         * loaded and run when needed. Examples include Amazon Elastic Compute Cloud ( Amazon EC2 )
         * Spot Instances, Amazon EMR jobs, and AWS Auto Scaling . If you want to avoid the
         * increased activity from running ephemeral workloads, you can run these types of workloads
         * in a separate account with AWS Config turned off to avoid increased configuration
         ...
         *
         * AWS Firewall Manager depends on continuous recording to monitor your resources. If you
         ...
         *
         * @param recordingMode Specifies the default recording frequency that AWS Config uses to
         ...
         * Control Tower , and an AWS Config role has already been created, make sure that the IAM
         * role that you use when setting up AWS Config keeps the same minimum permissions as the
         * already created AWS Config role. You must do this so that the other AWS service continues
         * to run as expected.
         *
         * For example, if AWS Control Tower has an IAM role that allows AWS Config to read Amazon
         * Simple Storage Service ( Amazon S3 ) objects, make sure that the same permissions are
         * granted within the IAM role you use when setting up AWS Config . Otherwise, it may
         * interfere with how AWS Control Tower operates. For more information about IAM roles for
         * AWS Config , see
         ...
         *
         * @param roleArn Amazon Resource Name (ARN) of the IAM role assumed by AWS Config and used
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.config.CfnConfigurationRecorder.Builder.create(
                scope,
                id
            )
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("b09cf777c91a242656b58a7264175f61c5bb297186f5746c36aaaab39c1b1ec0")
        override fun recordingGroup(
            recordingGroup: RecordingGroupProperty.Builder.() -> Unit
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnConfigurationRecorder
    ...
    public interface RecordingModeProperty {
         ...
         * recording mode.
         *
         * The `recordingModeOverride` object in the `recordingModeOverrides` array consists of
         * three fields: a `description` , the new `recordingFrequency` , and an array of
        ...
        public interface Builder {
            /**
             * @param recordingFrequency The default recording frequency that AWS Config uses to
             *   record configuration changes.
             *
             * Daily recording is not supported for the following resource types:
             * * `AWS::Config::ResourceCompliance`
             ...
             *   specify your overrides for the recording mode. The `recordingModeOverride` object
             *   in the `recordingModeOverrides` array consists of three fields: a `description` ,
             *   the new `recordingFrequency` , and an array of `resourceTypes` to override.
             */
    ...
    public interface RecordingStrategyProperty {
         ...
         *   to `true` . When AWS Config adds support for a new resource type, AWS Config
         *   automatically starts recording resources of that type. For a list of supported resource
         *   types, see
         ...
         * `ExclusionByResourceTypes` . &gt; *Global resource types and the exclusion recording
         * strategy*
         *
         ...
         * configuration recorder, including global resource types, AWS Config starts recording
         * resources of that type automatically.
         *
         * Unless specifically listed as exclusions, `AWS::RDS::GlobalCluster` will be recorded
         * automatically in all supported AWS Config Regions were the configuration recorder is
         * enabled.
         *
         * IAM users, groups, roles, and customer managed policies will be recorded in the Region
         * where you set up the configuration recorder if that is a Region where AWS Config was
         * available before February 2022. You cannot be record the global IAM resouce types in
         * Regions supported by AWS Config after February 2022. This list where you cannot record
         * the global IAM resource types includes the following Regions:
        ...
        public interface Builder {
             ...
             * strategy*
             *
             * By default, if you choose the `EXCLUSION_BY_RESOURCE_TYPES` recording strategy, when
             * AWS Config adds support for a new resource type in the Region where you set up the
             * configuration recorder, including global resource types, AWS Config starts recording
             * resources of that type automatically.
             *
             * Unless specifically listed as exclusions, `AWS::RDS::GlobalCluster` will be recorded
             ...
             * Region where you set up the configuration recorder if that is a Region where AWS
             * Config was available before February 2022. You cannot be record the global IAM
             * resouce types in Regions supported by AWS Config after February 2022. This list where
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RecordingStrategyProperty
            ): software.amazon.awscdk.services.config.CfnConfigurationRecorder.RecordingStrategyProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface RecordingGroupProperty {
         ...
         *
         * If you set this field to `true` , when AWS Config adds support for a new resource type,
        ...
        /**
         * An object that specifies how AWS Config excludes resource types from being recorded by
         ...
         * Config was available before February 2022. You cannot be record the global IAM resouce
         * types in Regions supported by AWS Config after February 2022. This list where you cannot
         ...
         * is set to `false` . The `IncludeGlobalResourceTypes` option is a bundle which only
         ...
         * roles, and customer managed policies) will not be automatically added as exclusions for
         ...
         * field, as the default for the `AllSupported` field is to record configuration changes for
         * all supported resource types excluding the global IAM resource types. To include the
         * global IAM resource types when `AllSupported` is set to `true` , make sure to set
         ...
         * * If you set the `useOnly` field of
         *   [RecordingStrategy](https://docs.aws.amazon.com/config/latest/APIReference/API_RecordingStrategy.html)
         *   to `INCLUSION_BY_RESOURCE_TYPES` , AWS Config records configuration changes for only
         *   the resource types you specify in the `ResourceTypes` field of
         *   [RecordingGroup](https://docs.aws.amazon.com/config/latest/APIReference/API_RecordingGroup.html)
         *   .
         * * If you set the `useOnly` field of
         *   [RecordingStrategy](https://docs.aws.amazon.com/config/latest/APIReference/API_RecordingStrategy.html)
         ...
         *   being recorded in the `ResourceTypes` field of
         *   [ExclusionByResourceTypes](https://docs.aws.amazon.com/config/latest/APIReference/API_ExclusionByResourceTypes.html)
         *   .
         *
         * *Required and optional fields*
         ...
         * types will still be automatically recorded in this option unless those resource types are
         * specifically listed as exclusions in the `ResourceTypes` field of
         * `ExclusionByResourceTypes` . &gt; *Global resources types and the resource exclusion
         * recording strategy*
         *
         * By default, if you choose the `EXCLUSION_BY_RESOURCE_TYPES` recording strategy, when AWS
         * Config adds support for a new resource type in the Region where you set up the
         ...
         * when AWS Config adds support for a new type of resource, it will not record resources of
         * that type unless you manually add that type to your recording group. &gt; *Region
         * availability*
         *
         ...
         * recording of that resource type in all Regions supported by AWS Config , even if the
         * specified resource type is not supported in the AWS Region where you set up AWS Config .
         *
        ...
        public interface Builder {
            /**
             * @param allSupported Specifies whether AWS Config records configuration changes for
             *   all supported resource types, excluding the global IAM resource types. If you set
             *   this field to `true` , when AWS Config adds support for a new resource type, AWS
             ...
             * record in the `resourceTypes` field of
             * [RecordingGroup](https://docs.aws.amazon.com/config/latest/APIReference/API_RecordingGroup.html)
             * , or to exclude in the `resourceTypes` field of
             * [ExclusionByResourceTypes](https://docs.aws.amazon.com/config/latest/APIReference/API_ExclusionByResourceTypes.html)
             * .
            ...
            /**
             * @param exclusionByResourceTypes An object that specifies how AWS Config excludes
             *   resource types from being recorded by the configuration recorder. To use this
             *   option, you must set the `useOnly` field of
             *   [AWS::Config::ConfigurationRecorder RecordingStrategy](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-config-configurationrecorder-recordingstrategy.html)
             *   to `EXCLUSION_BY_RESOURCE_TYPES` .
             */
            ...
            public fun exclusionByResourceTypes(
                exclusionByResourceTypes: ExclusionByResourceTypesProperty.Builder.() -> Unit
            )

            /**
             * @param includeGlobalResourceTypes This option is a bundle which only applies to the
             *   global IAM resource types: IAM users, groups, roles, and customer managed policies.
             *   These global IAM resource types can only be recorded by AWS Config in Regions where
             *   AWS Config was available before February 2022. You cannot be record the global IAM
             *   resouce types in Regions supported by AWS Config after February 2022. This list
             ...
             * *Aurora global clusters are recorded in all enabled Regions*
             *
             * The `AWS::RDS::GlobalCluster` resource type will be recorded in all supported AWS
             ...
             * For more information, see
             * [Selecting Which Resources are Recorded](https://docs.aws.amazon.com/config/latest/developerguide/select-resources.html#select-resources-all)
             * in the *AWS Config developer guide* . &gt; *IncludeGlobalResourceTypes and the
             ...
             * resource types ( IAM users, groups, roles, and customer managed policies) will not be
             ...
             * configuration changes for all supported resource types excluding the global IAM
             * resource types. To include the global IAM resource types when `AllSupported` is set
             ...
             * `ResourceTypes` field of
             * [RecordingGroup](https://docs.aws.amazon.com/config/latest/APIReference/API_RecordingGroup.html)
             * , AWS Config will still record configuration changes for those specified resource
             ...
             * in the `ResourceTypes` field in addition to setting the `IncludeGlobalResourceTypes`
             * field to false.
             */
             ...
             * * If you set the `useOnly` field of
             *   [RecordingStrategy](https://docs.aws.amazon.com/config/latest/APIReference/API_RecordingStrategy.html)
             *   to `ALL_SUPPORTED_RESOURCE_TYPES` , AWS Config records configuration changes for
             *   all supported resource types, excluding the global IAM resource types. You also
             ...
             * * If you set the `useOnly` field of
             *   [RecordingStrategy](https://docs.aws.amazon.com/config/latest/APIReference/API_RecordingStrategy.html)
             *   to `INCLUSION_BY_RESOURCE_TYPES` , AWS Config records configuration changes for
             *   only the resource types you specify in the `ResourceTypes` field of
             *   [RecordingGroup](https://docs.aws.amazon.com/config/latest/APIReference/API_RecordingGroup.html)
             *   .
             * * If you set the `useOnly` field of
             *   [RecordingStrategy](https://docs.aws.amazon.com/config/latest/APIReference/API_RecordingStrategy.html)
            ...
            public fun recordingStrategy(
                recordingStrategy: RecordingStrategyProperty.Builder.() -> Unit
            )

            /**
             * @param resourceTypes A comma-separated list that specifies which resource types AWS
             *   Config records. For a list of valid `ResourceTypes` values, see the *Resource Type
             *   Value* column in
             *   [Supported AWS resource Types](https://docs.aws.amazon.com/config/latest/developerguide/resource-config-reference.html#supported-resources)
             *   in the *AWS Config developer guide* .
             *
             ...
             * `ResourceTypes` , when AWS Config adds support for a new type of resource, it will
             * not record resources of that type unless you manually add that type to your recording
             * group. &gt; *Region availability*
             *
             * Before specifying a resource type for AWS Config to track, check
             * [Resource Coverage by Region Availability](https://docs.aws.amazon.com/config/latest/developerguide/what-is-resource-config-coverage.html)
             * to see if the resource type is supported in the AWS Region where you set up AWS
             * Config . If a resource type is supported by AWS Config in at least one Region, you
             * can enable the recording of that resource type in all Regions supported by AWS Config
             * , even if the specified resource type is not supported in the AWS Region where you
             * set up AWS Config .
             */
        ...
        private class BuilderImpl : Builder {
            ...
            override fun exclusionByResourceTypes(exclusionByResourceTypes: IResolvable) {
                cdkBuilder.exclusionByResourceTypes(
                    exclusionByResourceTypes.let(IResolvable::unwrap)
                )
            }
             ...
             *   to `EXCLUSION_BY_RESOURCE_TYPES` .
             */
            override fun exclusionByResourceTypes(
                exclusionByResourceTypes: ExclusionByResourceTypesProperty
            ) {
                cdkBuilder.exclusionByResourceTypes(
                    exclusionByResourceTypes.let(ExclusionByResourceTypesProperty::unwrap)
                )
            }
            ...
            override fun includeGlobalResourceTypes(includeGlobalResourceTypes: IResolvable) {
                cdkBuilder.includeGlobalResourceTypes(
                    includeGlobalResourceTypes.let(IResolvable::unwrap)
                )
            }
            ...
            override fun recordingStrategy(recordingStrategy: RecordingStrategyProperty) {
                cdkBuilder.recordingStrategy(
                    recordingStrategy.let(RecordingStrategyProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("a1515b32155e4b51fcd151606146580e58457af5e02830e5901331e907f50589")
            override fun recordingStrategy(
                recordingStrategy: RecordingStrategyProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * types, excluding the global IAM resource types.
             *
             * If you set this field to `true` , when AWS Config adds support for a new resource
             * type, AWS Config starts recording resources of that type automatically.
             *
             * If you set this field to `true` , you cannot enumerate specific resource types to
             * record in the `resourceTypes` field of
             * [RecordingGroup](https://docs.aws.amazon.com/config/latest/APIReference/API_RecordingGroup.html)
            ...
            /**
             * An object that specifies how AWS Config excludes resource types from being recorded
             * by the configuration recorder.
             *
             * To use this option, you must set the `useOnly` field of
             * [AWS::Config::ConfigurationRecorder RecordingStrategy](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-config-configurationrecorder-recordingstrategy.html)
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-config-configurationrecorder-recordinggroup.html#cfn-config-configurationrecorder-recordinggroup-exclusionbyresourcetypes)
             */
            override fun exclusionByResourceTypes(): Any? =
                unwrap(this).getExclusionByResourceTypes()

            /**
             * This option is a bundle which only applies to the global IAM resource types: IAM
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-config-configurationrecorder-recordinggroup.html#cfn-config-configurationrecorder-recordinggroup-includeglobalresourcetypes)
             */
            override fun includeGlobalResourceTypes(): Any? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RecordingGroupProperty
            ): software.amazon.awscdk.services.config.CfnConfigurationRecorder.RecordingGroupProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ExclusionByResourceTypesProperty {
        ...
        public interface Builder {
            /**
             * @param resourceTypes A comma-separated list of resource types to exclude from
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ExclusionByResourceTypesProperty
            ): software.amazon.awscdk.services.config.CfnConfigurationRecorder.ExclusionByResourceTypesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface RecordingModeOverrideProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param recordingFrequency The recording frequency that will be applied to all the
             *   resource types specified in the override.
             ...
             *   most recent state of your resources over the last 24-hour period, only if it’s
            ...
            /**
             * @param resourceTypes A comma-separated list that specifies which resource types AWS
             *   Config includes in the override.
             *
             * Daily recording is not supported for the following resource types:
             * * `AWS::Config::ResourceCompliance`
             * * `AWS::Config::ConformancePackCompliance`
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RecordingModeOverrideProperty
            ): software.amazon.awscdk.services.config.CfnConfigurationRecorder.RecordingModeOverrideProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
