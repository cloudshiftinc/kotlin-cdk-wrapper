...
internal constructor(
    ...
    public open fun bind(
        ...
        unwrap(this)
            .bind(
                ...
                sfnProps.let(StateMachineProps::unwrap)
            )
            .let(DefinitionConfig::wrap)
    ...
    public companion object {
        public fun fromChainable(chainable: IChainable): DefinitionBody =
            software.amazon.awscdk.services.stepfunctions.DefinitionBody.fromChainable(
                    chainable.let(IChainable::unwrap)
                )
                .let(DefinitionBody::wrap)
        ...
        public fun fromFile(path: String, options: AssetOptions): DefinitionBody =
            software.amazon.awscdk.services.stepfunctions.DefinitionBody.fromFile(
                    path,
        ...
        ): DefinitionBody = fromFile(path, AssetOptions(options))

        public fun fromString(definition: String): DefinitionBody =
            software.amazon.awscdk.services.stepfunctions.DefinitionBody.fromString(definition)
                .let(DefinitionBody::wrap)
