...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param content An object that contains information about the content of an in-app
         *   message, including its title and body text, text colors, background colors, images,
         ...
         *
         * @param layout A string that determines the appearance of the in-app message. You can
    ...
    public interface InAppMessageContentProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param bodyConfig An object that contains configuration information about the header
             *   or title text of the in-app message.
             */
            ...
            /**
             * @param headerConfig An object that contains configuration information about the
             *   header or title text of the in-app message.
             */
        ...
        internal constructor(
            ...
            /**
             * An object that contains configuration information about the header or title text of
             * the in-app message.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-pinpoint-inapptemplate-inappmessagecontent.html#cfn-pinpoint-inapptemplate-inappmessagecontent-bodyconfig)
             */
    ...
    public interface BodyConfigProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param textColor The color of the body text, expressed as a hex color code (such
             *   as #000000 for black).
             */
    ...
    public interface ButtonConfigProperty {
        ...
        public interface Builder {
            /**
             * @param android Optional button configuration to use for in-app messages sent to
             *   Android devices. This button configuration overrides the default button
             *   configuration.
             */
            ...
            /**
             * @param defaultConfig Specifies the default behavior of a button that appears in an
             *   in-app message. You can optionally add button configurations that specifically
             *   apply to iOS, Android, or web browser users.
             */
            ...
            /**
             * @param ios Optional button configuration to use for in-app messages sent to iOS
        ...
        internal constructor(
             ...
             * Specifies the default behavior of a button that appears in an in-app message.
             *
             * You can optionally add button configurations that specifically apply to iOS, Android,
