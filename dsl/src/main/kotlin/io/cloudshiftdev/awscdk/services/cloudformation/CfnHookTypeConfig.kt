...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.cloudformation.CfnHookTypeConfig,
) : CfnResource(cdkObject), IInspectable {
    /**
     * The Amazon Resource Number (ARN) of the activated hook type configuration, in this account
     * and Region.
     */
    ...
    public interface Builder {
         ...
         *
         * @param configuration Specifies the activated hook type configuration, in this AWS account
         *   and AWS Region .
         */
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.cloudformation.CfnHookTypeConfig.Builder.create(
                scope,
                id
            )
