...
internal constructor(
    ...
    public open fun customDeliveryConfiguration(`value`: CustomDeliveryConfigurationProperty) {
        unwrap(this)
            .setCustomDeliveryConfiguration(
                `value`.let(CustomDeliveryConfigurationProperty::unwrap)
            )
    }
    ...
    public open fun customDeliveryConfiguration(
        `value`: CustomDeliveryConfigurationProperty.Builder.() -> Unit
    ...
    public open fun messageConfiguration(
        `value`: MessageConfigurationProperty.Builder.() -> Unit
    ...
    public open fun templateConfiguration(
        `value`: TemplateConfigurationProperty.Builder.() -> Unit
    ...
    public interface Builder {
        /**
         * An array of requests that defines additional treatments for the campaign, in addition to
         * the default treatment for the campaign.
         *
         ...
         *
         * @param additionalTreatments An array of requests that defines additional treatments for
        ...
        public fun customDeliveryConfiguration(
            customDeliveryConfiguration: CustomDeliveryConfigurationProperty.Builder.() -> Unit
        )
        ...
        /**
         * The allocated percentage of users (segment members) who shouldn't receive messages from
         * the campaign.
         *
         ...
         * Specifies whether to pause the campaign.
         *
         * A paused campaign doesn't run unless you resume it by changing this value to `false` . If
         * you restart a campaign, the campaign restarts from the beginning and not at the point you
         * paused it. If a campaign is running it will complete and then pause. Pause only pauses or
         * skips the next run for a recurring future scheduled campaign. A campaign scheduled for
         * immediate can't be paused.
         *
        ...
        public fun messageConfiguration(
            messageConfiguration: MessageConfigurationProperty.Builder.() -> Unit
        )
         ...
         *
         * @param priority An integer between 1 and 5, inclusive, that represents the priority of
         *   the in-app message campaign, where 1 is the highest priority and 5 is the lowest.
         */
    ...
    private class BuilderImpl(
        ...
        override fun customDeliveryConfiguration(customDeliveryConfiguration: IResolvable) {
            cdkBuilder.customDeliveryConfiguration(
                customDeliveryConfiguration.let(IResolvable::unwrap)
            )
        }
         ...
         *   treatment through a custom channel.
         */
        override fun customDeliveryConfiguration(
            customDeliveryConfiguration: CustomDeliveryConfigurationProperty
        ) {
            cdkBuilder.customDeliveryConfiguration(
                customDeliveryConfiguration.let(CustomDeliveryConfigurationProperty::unwrap)
            )
        }
        ...
        override fun customDeliveryConfiguration(
            ...
            customDeliveryConfiguration(
                CustomDeliveryConfigurationProperty(customDeliveryConfiguration)
            )
        ...
        override fun messageConfiguration(messageConfiguration: MessageConfigurationProperty) {
            cdkBuilder.messageConfiguration(
                messageConfiguration.let(MessageConfigurationProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("b877da97cbc73f1c6c332b5657e333e68eab953af3dc318e9d0d67cb2fd1e017")
        override fun messageConfiguration(
            messageConfiguration: MessageConfigurationProperty.Builder.() -> Unit
        ...
        public fun build(): software.amazon.awscdk.services.pinpoint.CfnCampaign =
            cdkBuilder.build()
    }
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnCampaign
        ): software.amazon.awscdk.services.pinpoint.CfnCampaign = wrapped.cdkObject
    }
    ...
    public interface CampaignCustomMessageProperty {
        ...
        public interface Builder {
            /**
             * @param data The raw, JSON-formatted string to use as the payload for the message. The
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CampaignCustomMessageProperty
            ): software.amazon.awscdk.services.pinpoint.CfnCampaign.CampaignCustomMessageProperty =
    ...
    public interface CampaignHookProperty {
         ...
         *   custom channel. This functionality is not supported anymore. To send a campaign through
         *   a custom channel, use the `CustomDeliveryConfiguration` and `CampaignCustomMessage`
        ...
        public interface Builder {
            /**
             * @param lambdaFunctionName The name or Amazon Resource Name (ARN) of the Lambda
            ...
            /**
             * @param mode The mode that Amazon Pinpoint uses to invoke the Lambda function.
             *   Possible values are:.
             * * `FILTER` - Invoke the function to customize the segment that's used by a campaign.
            ...
            /**
             * @param webUrl The web URL that Amazon Pinpoint calls to invoke the Lambda function
             *   over HTTPS.
             */
    ...
    public interface InAppMessageBodyConfigProperty {
        ...
        public interface Builder {
            /**
             * @param alignment The text alignment of the main body text of the message. Acceptable
            ...
            /**
             * @param textColor The color of the body text, expressed as a string consisting of a
        ...
        internal constructor(
            ...
            /**
             * The color of the body text, expressed as a string consisting of a hex color code
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: InAppMessageBodyConfigProperty
            ): software.amazon.awscdk.services.pinpoint.CfnCampaign.InAppMessageBodyConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface TemplateProperty {
         ...
         * retrieve a list of versions and version identifiers for a template, use the
         * [Template Versions](https://docs.aws.amazon.com/pinpoint/latest/apireference/templates-template-name-template-type-versions.html)
         * resource.
         *
         * If you don't specify a value for this property, Amazon Pinpoint uses the *active version*
         * of the template. The *active version* is typically the version of a template that's been
         * most recently reviewed and approved for use, depending on your workflow. It isn't
        ...
        public interface Builder {
            /**
             * @param name The name of the message template to use for the message. If specified,
             *   this value must match the name of an existing message template.
             */
            public fun name(name: String)

            /**
             * @param version The unique identifier for the version of the message template to use
             *   for the message. If specified, this value must match the identifier for an existing
             ...
             * version* of the template. The *active version* is typically the version of a template
        ...
        internal constructor(
             ...
             * To retrieve a list of versions and version identifiers for a template, use the
             * [Template Versions](https://docs.aws.amazon.com/pinpoint/latest/apireference/templates-template-name-template-type-versions.html)
             * resource.
             *
             * If you don't specify a value for this property, Amazon Pinpoint uses the *active
    ...
    public interface InAppMessageHeaderConfigProperty {
        ...
        public interface Builder {
            /**
             * @param alignment The text alignment of the title of the message. Acceptable values:
             *   `LEFT` , `CENTER` , `RIGHT` .
             */
            public fun alignment(alignment: String)
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: InAppMessageHeaderConfigProperty
            ): software.amazon.awscdk.services.pinpoint.CfnCampaign.InAppMessageHeaderConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CampaignEmailMessageProperty {
        ...
        public interface Builder {
            /**
             * @param body The body of the email for recipients whose email clients don't render
             *   HTML content.
             */
            public fun body(body: String)

            /**
             * @param fromAddress The verified email address to send the email from. The default
             *   address is the `FromAddress` specified for the email channel for the application.
             */
            public fun fromAddress(fromAddress: String)

            /**
             * @param htmlBody The body of the email, in HTML format, for recipients whose email
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CampaignEmailMessageProperty
            ): software.amazon.awscdk.services.pinpoint.CfnCampaign.CampaignEmailMessageProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CampaignInAppMessageProperty {
        /**
         * An array that contains configurtion information about the in-app message for the
         * campaign, including title and body text, text colors, background colors, image URLs, and
        ...
        public interface Builder {
            /**
             * @param content An array that contains configurtion information about the in-app
             *   message for the campaign, including title and body text, text colors, background
             *   colors, image URLs, and button configurations.
             */
            ...
            /**
             * @param customConfig Custom data, in the form of key-value pairs, that is included in
             *   an in-app messaging payload.
             */
            public fun customConfig(customConfig: Any)

            /**
             * @param layout A string that describes how the in-app message will appear. You can
        ...
        internal constructor(
            ...
            /**
             * An array that contains configurtion information about the in-app message for the
             * campaign, including title and body text, text colors, background colors, image URLs,
            ...
            /**
             * A string that describes how the in-app message will appear. You can specify one of
             * the following:.
             * * `BOTTOM_BANNER` – a message that appears as a banner at the bottom of the page.
             * * `TOP_BANNER` – a message that appears as a banner at the top of the page.
             * * `OVERLAYS` – a message that covers entire screen.
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CampaignInAppMessageProperty
            ): software.amazon.awscdk.services.pinpoint.CfnCampaign.CampaignInAppMessageProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface LimitsProperty {
        ...
        public interface Builder {
            /**
             * @param daily The maximum number of messages that a campaign can send to a single
             *   endpoint during a 24-hour period. The maximum value is 100.
             */
            public fun daily(daily: Number)

            /**
             * @param maximumDuration The maximum amount of time, in seconds, that a campaign can
             *   attempt to deliver a message after the scheduled start time for the campaign. The
            ...
            /**
             * @param session The maximum number of messages that the campaign can send per user
             *   session.
             */
            public fun session(session: Number)

            /**
             * @param total The maximum number of messages that a campaign can send to a single
        ...
        internal constructor(
             ...
             * message after the scheduled start time for the campaign.
             *
             * The minimum value is 60 seconds.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-pinpoint-campaign-limits.html#cfn-pinpoint-campaign-limits-maximumduration)
    ...
    public interface CampaignSmsMessageProperty {
         ...
         *
         * Valid values are `TRANSACTIONAL` (for messages that are critical or time-sensitive, such
         * as a one-time passwords) and `PROMOTIONAL` (for messsages that aren't critical or
         ...
         * Although it isn't required, we recommend that you specify the long code using an E.164
         ...
         * sender, omit this parameter and use `OriginationNumber` instead. For more information
         * about support for Sender ID by country, see the
         * [Amazon Pinpoint User Guide](https://docs.aws.amazon.com/pinpoint/latest/userguide/channels-sms-countries.html)
         * .
         *
        ...
        public interface Builder {
            ...
            /**
             * @param entityId The entity ID or Principal Entity (PE) id received from the
             *   regulatory body for sending SMS in your country.
             */
            public fun entityId(entityId: String)

            /**
             * @param messageType The SMS message type. Valid values are `TRANSACTIONAL` (for
             *   messages that are critical or time-sensitive, such as a one-time passwords) and
             *   `PROMOTIONAL` (for messsages that aren't critical or time-sensitive, such as
             *   marketing messages).
             */
            public fun messageType(messageType: String)

            /**
             * @param originationNumber The long code to send the SMS message from. This value
             *   should be one of the dedicated long codes that's assigned to your AWS account.
             *   Although it isn't required, we recommend that you specify the long code using an
             *   E.164 format to ensure prompt and accurate delivery of the message. For example,
             *   +12065550100.
             */
             ...
             *   recipient's device. Support for sender IDs varies by country or region. To specify
             *   a phone number as the sender, omit this parameter and use `OriginationNumber`
            ...
            /**
             * @param templateId The template ID received from the regulatory body for sending SMS
             *   in your country.
             */
        ...
        internal constructor(
             ...
             * The SMS message type.
             *
             * Valid values are `TRANSACTIONAL` (for messages that are critical or time-sensitive,
             * such as a one-time passwords) and `PROMOTIONAL` (for messsages that aren't critical
             ...
             * The long code to send the SMS message from.
             *
             * This value should be one of the dedicated long codes that's assigned to your AWS
             * account. Although it isn't required, we recommend that you specify the long code
             * using an E.164 format to ensure prompt and accurate delivery of the message. For
             * example, +12065550100.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-pinpoint-campaign-campaignsmsmessage.html#cfn-pinpoint-campaign-campaignsmsmessage-originationnumber)
             */
            ...
            /**
             * The alphabetic Sender ID to display as the sender of the message on a recipient's
             * device.
             *
             * Support for sender IDs varies by country or region. To specify a phone number as the
             * sender, omit this parameter and use `OriginationNumber` instead. For more information
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CampaignSmsMessageProperty
            ): software.amazon.awscdk.services.pinpoint.CfnCampaign.CampaignSmsMessageProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface QuietTimeProperty {
         ...
         *
         * This value has to use 24-hour notation and be in HH:MM format, where HH is the hour (with
         * a leading zero, if applicable) and MM is the minutes. For example, use `02:30` to
        ...
        public interface Builder {
            /**
             * @param end The specific time when quiet time ends. This value has to use 24-hour
            ...
            /**
             * @param start The specific time when quiet time begins. This value has to use 24-hour
             *   notation and be in HH:MM format, where HH is the hour (with a leading zero, if
             *   applicable) and MM is the minutes. For example, use `02:30` to represent 2:30 AM,
             *   or `14:30` to represent 2:30 PM.
             */
        ...
        internal constructor(
             ...
             * The specific time when quiet time ends.
             *
             * This value has to use 24-hour notation and be in HH:MM format, where HH is the hour
    ...
    public interface OverrideButtonConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param buttonAction The action that occurs when a recipient chooses a button in an
             *   in-app message. You can specify one of the following:
             * * `LINK` – A link to a web destination.
             * * `DEEP_LINK` – A link to a specific page in an application.
             * * `CLOSE` – Dismisses the message.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: OverrideButtonConfigurationProperty
            ): software.amazon.awscdk.services.pinpoint.CfnCampaign.OverrideButtonConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CustomDeliveryConfigurationProperty {
         ...
         * * The URL for a web application or service that supports HTTPS and can receive the
         ...
         *
         * Each valid value maps to a type of channel that you can associate with an endpoint by
        ...
        public interface Builder {
            /**
             * @param deliveryUri The destination to send the campaign or treatment to. This value
             *   can be one of the following:.
             * * The name or Amazon Resource Name (ARN) of an AWS Lambda function to invoke to
             *   handle delivery of the campaign or treatment.
             * * The URL for a web application or service that supports HTTPS and can receive the
             *   message. The URL has to be a full URL, including the HTTPS protocol.
             */
             ...
             *   Each valid value maps to a type of channel that you can associate with an endpoint
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-pinpoint-campaign-customdeliveryconfiguration.html#cfn-pinpoint-campaign-customdeliveryconfiguration-endpointtypes)
             */
            override fun endpointTypes(): List<String> =
                unwrap(this).getEndpointTypes() ?: emptyList()
        }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CustomDeliveryConfigurationProperty
            ): software.amazon.awscdk.services.pinpoint.CfnCampaign.CustomDeliveryConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface InAppMessageContentProperty {
        ...
        public interface Builder {
            /**
             * @param backgroundColor The background color for an in-app message banner, expressed
             *   as a hex color code (such as #000000 for black).
             */
            ...
            /**
             * @param headerConfig Specifies the configuration and content of the header or title
            ...
            public fun headerConfig(
                headerConfig: InAppMessageHeaderConfigProperty.Builder.() -> Unit
            )
            ...
            /**
             * @param secondaryBtn An object that contains configuration information about the
             *   secondary button in an in-app message.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("4f7d0fa693ee3275316ac1f5742467ad649de278deb0008b82d55aae65484b96")
            override fun bodyConfig(
                bodyConfig: InAppMessageBodyConfigProperty.Builder.() -> Unit
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("ad10bfaac4de9f5eb98dee4b0cf892b1dbf9d85a6b5a80aa0b8148235bc4f899")
            override fun primaryBtn(
                primaryBtn: InAppMessageButtonProperty.Builder.() -> Unit
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("77ad5198e39a114458e5f25eafb01c089a4ad072dd46d572ffcf39f2b7269fb3")
            override fun secondaryBtn(
                secondaryBtn: InAppMessageButtonProperty.Builder.() -> Unit
        ...
        internal constructor(
            ...
            /**
             * The background color for an in-app message banner, expressed as a hex color code
             * (such as #000000 for black).
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-pinpoint-campaign-inappmessagecontent.html#cfn-pinpoint-campaign-inappmessagecontent-backgroundcolor)
             */
            ...
            /**
             * An object that contains configuration information about the primary button in an
             * in-app message.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-pinpoint-campaign-inappmessagecontent.html#cfn-pinpoint-campaign-inappmessagecontent-primarybtn)
             */
            ...
            /**
             * An object that contains configuration information about the secondary button in an
             * in-app message.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-pinpoint-campaign-inappmessagecontent.html#cfn-pinpoint-campaign-inappmessagecontent-secondarybtn)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: InAppMessageContentProperty
            ): software.amazon.awscdk.services.pinpoint.CfnCampaign.InAppMessageContentProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ScheduleProperty {
         ...
         *
         * Quiet time is a specific time range when a campaign doesn't send messages to endpoints,
         ...
         * UTC+10:30, UTC+11, UTC+12, UTC+13, UTC-02, UTC-03, UTC-04, UTC-05, UTC-06, UTC-07,
        ...
        public interface Builder {
            /**
             * @param endTime The scheduled time, in ISO 8601 format, when the campaign ended or
             *   will end.
             */
            public fun endTime(endTime: String)

            /**
             * @param eventFilter The type of event that causes the campaign to be sent, if the
            ...
            /**
             * @param frequency Specifies how often the campaign is sent or whether the campaign is
             *   sent in response to a specific event.
             */
            public fun frequency(frequency: String)

            /**
             * @param isLocalTime Specifies whether the start and end times for the campaign
             *   schedule use each recipient's local time. To base the schedule on each recipient's
            ...
            /**
             * @param quietTime The default quiet time for the campaign. Quiet time is a specific
             *   time range when a campaign doesn't send messages to endpoints, if all the following
             *   conditions are met:
            ...
            /**
             * @param startTime The scheduled time when the campaign began or will begin. Valid
             *   values are: `IMMEDIATE` , to start the campaign immediately; or, a specific time in
             *   ISO 8601 format.
             */
            public fun startTime(startTime: String)

            /**
             * @param timeZone The starting UTC offset for the campaign schedule, if the value of
             *   the `IsLocalTime` property is `true` . Valid values are: `UTC, UTC+01, UTC+02,
             *   UTC+03, UTC+03:30, UTC+04, UTC+04:30, UTC+05, UTC+05:30, UTC+05:45, UTC+06,
             *   UTC+06:30, UTC+07, UTC+08, UTC+09, UTC+09:30, UTC+10, UTC+10:30, UTC+11, UTC+12,
             *   UTC+13, UTC-02, UTC-03, UTC-04, UTC-05, UTC-06, UTC-07, UTC-08, UTC-09, UTC-10,`
             *   and `UTC-11` .
             */
        ...
        private class BuilderImpl : Builder {
            ...
            override fun eventFilter(
                eventFilter: CampaignEventFilterProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * The default quiet time for the campaign.
             *
             * Quiet time is a specific time range when a campaign doesn't send messages to
             ...
             * The scheduled time when the campaign began or will begin.
             *
             * Valid values are: `IMMEDIATE` , to start the campaign immediately; or, a specific
    ...
    public interface WriteTreatmentResourceProperty {
         ...
         */
        public fun customDeliveryConfiguration(): Any? =
            unwrap(this).getCustomDeliveryConfiguration()
        ...
        public interface Builder {
            /**
             * @param customDeliveryConfiguration The delivery configuration settings for sending
             *   the treatment through a custom channel. This object is required if the
             *   `MessageConfiguration` object for the treatment specifies a `CustomMessage` object.
             */
            public fun customDeliveryConfiguration(customDeliveryConfiguration: IResolvable)
        ...
        internal constructor(
             ...
             * channel.
             *
             * This object is required if the `MessageConfiguration` object for the treatment
             * specifies a `CustomMessage` object.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-pinpoint-campaign-writetreatmentresource.html#cfn-pinpoint-campaign-writetreatmentresource-customdeliveryconfiguration)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: WriteTreatmentResourceProperty
            ): software.amazon.awscdk.services.pinpoint.CfnCampaign.WriteTreatmentResourceProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface MessageConfigurationProperty {
         ...
         * delivery configuration ( `CustomDeliveryConfiguration` ) settings for the campaign.
         *
         * If specified, this message overrides the default message.
         *
        ...
        public interface Builder {
             ...
             *   Notification service) channel. If specified, this message overrides the default
             *   message.
             */
            ...
            /**
             * @param baiduMessage The message that the campaign sends through the Baidu (Baidu
             *   Cloud Push) channel. If specified, this message overrides the default message.
             */
             ...
             *   specified by the delivery configuration ( `CustomDeliveryConfiguration` ) settings
             *   for the campaign. If specified, this message overrides the default message.
             */
            ...
            public fun customMessage(
                customMessage: CampaignCustomMessageProperty.Builder.() -> Unit
            )

            /**
             * @param defaultMessage The default message that the campaign sends through all the
             ...
             *   enables Amazon Pinpoint to send push notifications through the Firebase Cloud
             *   Messaging (FCM), formerly Google Cloud Messaging (GCM), service. If specified, this
            ...
            /**
             * @param inAppMessage The default message for the in-app messaging channel. This
             *   message overrides the default message ( `DefaultMessage` ).
             */
            ...
            /**
             * @param smsMessage The message that the campaign sends through the SMS channel. If
             *   specified, this message overrides the default message.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("27371de087267f4f96761f1118ec73d5c86b4e657bf26ce2ba84ab880dae2c0d")
            override fun emailMessage(
                emailMessage: CampaignEmailMessageProperty.Builder.() -> Unit
            ): Unit = emailMessage(CampaignEmailMessageProperty(emailMessage))
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("652150ef74c21e886bfa67ab181e340c2d7973c9f2eb751c67c4ec0f355ab6f2")
            override fun inAppMessage(
                inAppMessage: CampaignInAppMessageProperty.Builder.() -> Unit
            ): Unit = inAppMessage(CampaignInAppMessageProperty(inAppMessage))
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("bc6a7f353bd1385ecb81f84b39646b4b5ba44a5b89ab5f6aee654507cb210e0f")
            override fun smsMessage(
                smsMessage: CampaignSmsMessageProperty.Builder.() -> Unit
        ...
        internal constructor(
            ...
            /**
             * The message that the campaign sends through the GCM channel, which enables Amazon
             * Pinpoint to send push notifications through the Firebase Cloud Messaging (FCM),
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: MessageConfigurationProperty
            ): software.amazon.awscdk.services.pinpoint.CfnCampaign.MessageConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface EventDimensionsProperty {
         ...
         * or `_custom.delivered` . For campaigns, this can also be a custom event that's specific
         * to your application. For information about standard events, see
        ...
        public interface Builder {
            /**
             * @param attributes One or more custom attributes that your application reports to
             ...
             *   journey activity to be performed. This can be a standard event that Amazon Pinpoint
             *   generates, such as `_email.delivered` or `_custom.delivered` . For campaigns, this
             *   can also be a custom event that's specific to your application. For information
             *   about standard events, see
             *   [Streaming Amazon Pinpoint Events](https://docs.aws.amazon.com/pinpoint/latest/developerguide/event-streams.html)
             *   in the *Amazon Pinpoint Developer Guide* .
             */
            ...
            /**
             * @param metrics One or more custom metrics that your application reports to Amazon
             *   Pinpoint . You can use these metrics as selection criteria when you create an event
             *   filter.
             */
        ...
        internal constructor(
            ...
            /**
             * The name of the event that causes the campaign to be sent or the journey activity to
             * be performed.
             *
             * This can be a standard event that Amazon Pinpoint generates, such as
             * `_email.delivered` or `_custom.delivered` . For campaigns, this can also be a custom
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: EventDimensionsProperty
            ): software.amazon.awscdk.services.pinpoint.CfnCampaign.EventDimensionsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface TemplateConfigurationProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param voiceTemplate The voice template to use for the message. This object isn't
    ...
    public interface CampaignEventFilterProperty {
         ...
         *
         * Valid values are: `SYSTEM` , sends the campaign when a system event occurs; and,
        ...
        public interface Builder {
            ...
            /**
             * @param filterType The type of event that causes the campaign to be sent. Valid values
             *   are: `SYSTEM` , sends the campaign when a system event occurs; and, `ENDPOINT` ,
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CampaignEventFilterProperty
            ): software.amazon.awscdk.services.pinpoint.CfnCampaign.CampaignEventFilterProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DefaultButtonConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param backgroundColor The background color of a button, expressed as a hex color
            ...
            /**
             * @param textColor The color of the body text in a button, expressed as a hex color
             *   code (such as #000000 for black).
             */
            public fun textColor(textColor: String)
        }
        ...
        internal constructor(
            ...
            /**
             * The color of the body text in a button, expressed as a hex color code (such
             * as #000000 for black).
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-pinpoint-campaign-defaultbuttonconfiguration.html#cfn-pinpoint-campaign-defaultbuttonconfiguration-textcolor)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DefaultButtonConfigurationProperty
            ): software.amazon.awscdk.services.pinpoint.CfnCampaign.DefaultButtonConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface MessageProperty {
        ...
        public interface Builder {
            /**
             * @param action The action to occur if a recipient taps the push notification. Valid
             *   values are:.
             * * `OPEN_APP` – Your app opens or it becomes the foreground app if it was sent to the
             *   background. This is the default action.
            ...
            /**
             * @param body The body of the notification message. The maximum number of characters
             *   is 200.
             */
            public fun body(body: String)

            /**
             * @param imageIconUrl The URL of the image to display as the push notification icon,
             *   such as the icon for the app.
             */
            public fun imageIconUrl(imageIconUrl: String)

            /**
             * @param imageSmallIconUrl The URL of the image to display as the small, push
             *   notification icon, such as a small version of the icon for the app.
             */
            ...
            /**
             * @param rawContent The raw, JSON-formatted string to use as the payload for the
             *   notification message. If specified, this value overrides all other content for the
             *   message.
             */
            public fun rawContent(rawContent: String)

            /**
             * @param silentPush Specifies whether the notification is a silent push notification,
             *   which is a push notification that doesn't display on a recipient's device. Silent
            ...
            /**
             * @param timeToLive The number of seconds that the push notification service should
             *   keep the message, if the service is unable to deliver the notification the first
             *   time. This value is converted to an expiration value when it's sent to a push
             *   notification service. If this value is `0` , the service treats the notification as
             *   if it expires immediately and the service doesn't store or try to deliver the
             *   notification again.
             *
            ...
            /**
             * @param title The title to display above the notification message on a recipient's
             *   device.
             */
            public fun title(title: String)

            /**
             * @param url The URL to open in a recipient's default mobile browser, if a recipient
        ...
        internal constructor(
             ...
             * configuration, displaying messages in an in-app message center, or supporting phone
             * home functionality.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-pinpoint-campaign-message.html#cfn-pinpoint-campaign-message-silentpush)
             */
            ...
            /**
             * The number of seconds that the push notification service should keep the message, if
             * the service is unable to deliver the notification the first time.
             *
             * This value is converted to an expiration value when it's sent to a push notification
             * service. If this value is `0` , the service treats the notification as if it expires
             * immediately and the service doesn't store or try to deliver the notification again.
    ...
    public interface InAppMessageButtonProperty {
        ...
        public interface Builder {
            /**
             * @param android An object that defines the default behavior for a button in in-app
             *   messages sent to Android.
             */
            ...
            /**
             * @param defaultConfig An object that defines the default behavior for a button in an
             *   in-app message.
             */
            ...
            public fun defaultConfig(
                defaultConfig: DefaultButtonConfigurationProperty.Builder.() -> Unit
            )

            /**
             * @param ios An object that defines the default behavior for a button in in-app
             *   messages sent to iOS devices.
             */
            ...
            /**
             * @param web An object that defines the default behavior for a button in in-app
             *   messages for web applications.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            override fun android(
                android: OverrideButtonConfigurationProperty.Builder.() -> Unit
            ...
            override fun defaultConfig(defaultConfig: DefaultButtonConfigurationProperty) {
                cdkBuilder.defaultConfig(
                    defaultConfig.let(DefaultButtonConfigurationProperty::unwrap)
                )
            }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: InAppMessageButtonProperty
            ): software.amazon.awscdk.services.pinpoint.CfnCampaign.InAppMessageButtonProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
