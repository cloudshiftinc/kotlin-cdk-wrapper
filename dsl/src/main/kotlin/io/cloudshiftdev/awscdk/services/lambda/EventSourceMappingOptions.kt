...
public interface EventSourceMappingOptions {
     ...
     *
     * Default: - Amazon Kinesis, Amazon DynamoDB, and Amazon MSK is 100 records. The default for
     * Amazon SQS is 10 messages. For standard SQS queues, the maximum is 10,000. For FIFO SQS
     * queues, the maximum is 10.
     */
     ...
     */
    public fun onFailure(): IEventSourceDlq? =
    ...
    /** A builder for [EventSourceMappingOptions] */
    @CdkDslMarker
    public interface Builder {
        /**
         * @param batchSize The largest number of records that AWS Lambda will retrieve from your
         *   event source at the time of invoking your function. Your function receives an event
        ...
        /**
         * @param eventSourceArn The Amazon Resource Name (ARN) of the event source. Any record
         *   added to this stream can invoke the Lambda function.
         */
         ...
         *   to initially to bootstrap itself. They are in the format `abc.example.com:9096`.
         */
        ...
        /**
         * @param kafkaConsumerGroupId The identifier for the Kafka consumer group to join. The
         *   consumer group ID must be unique among all your Kafka event sources. After creating a
         *   Kafka event source mapping with the consumer group ID specified, you cannot update this
         *   value. The value must have a lenght between 1 and 200 and full the pattern
         *   '[a-zA-Z0-9-/ *:_+=.&#64;-]*'. For more information, see
         *   [Customizable consumer group ID](https://docs.aws.amazon.com/lambda/latest/dg/with-msk.html#services-msk-consumer-group-id).
         */
         ...
         *   error. Set to `undefined` if you want lambda to keep retrying infinitely or until the
         *   record expires.
         *
         * Valid Range:
         * * Minimum value of 0
    ...
    internal constructor(
         ...
         * Default: - no timestamp
         */
        override fun startingPositionTimestamp(): Number? =
         ...
         *   Valid Range: 0 - 15 minutes</a>
         */
        override fun tumblingWindow(): Duration? =
    ...
    public companion object {
        ...
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.lambda.EventSourceMappingOptions
        ): EventSourceMappingOptions = Wrapper(cdkObject)

        internal fun unwrap(
            wrapped: EventSourceMappingOptions
