...
internal constructor(
    ...
    public open fun attrLandingZoneIdentifier(): String =
        unwrap(this).getAttrLandingZoneIdentifier()
    ...
    public interface Builder {
         ...
         *
         * @param manifest The landing zone `manifest.yaml` text file that specifies the landing
         *   zone configurations.
         */
