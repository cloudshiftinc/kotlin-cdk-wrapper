...
internal constructor(
    ...
    public interface Builder {
         ...
         * A list of SSM documents required by a document.
         *
         * This parameter is used exclusively by AWS AppConfig . When a user creates an AWS
         * AppConfig configuration in an SSM document, the user must also specify a required
         ...
         * of resources. If you don't specify a value, the document can't run on any resources. For
         * a list of valid resource types, see
         ...
         * parameter, and the `Name` of the document does not match an existing resource, a new
         * document is created. When you specify `NewVersion` , the default version of the document
         * is changed to the newly created version.
         *
         * Default: - "Replace"
         *
         ...
         *   this parameter determines whether a new version of the existing document is created, or
    ...
    public interface AttachmentsSourceProperty {
         ...
         * * For the key *AttachmentReference* , the value is constructed from the name of another
         *   SSM document in your account, a version number of that document, and a file attached to
         *   that document version that you want to reuse. For example:
         *
        ...
        public interface Builder {
            /**
             * @param key The key of a key-value pair that identifies the location of an attachment
             *   to a document.
             */
            ...
            /**
             * @param values The value of a key-value pair that identifies the location of an
             *   attachment to a document. The format for *Value* depends on the type of key you
             *   specify.
             * * For the key *SourceUrl* , the value is an S3 bucket location. For example:
             *
             * `"Values": [ "s3://doc-example-bucket/my-folder" ]`
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AttachmentsSourceProperty
            ): software.amazon.awscdk.services.ssm.CfnDocument.AttachmentsSourceProperty =
    ...
    public interface DocumentRequiresProperty {
        ...
        public interface Builder {
            /**
             * @param name The name of the required SSM document. The name can be an Amazon Resource
             *   Name (ARN).
             */
            public fun name(name: String)
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DocumentRequiresProperty
            ): software.amazon.awscdk.services.ssm.CfnDocument.DocumentRequiresProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
