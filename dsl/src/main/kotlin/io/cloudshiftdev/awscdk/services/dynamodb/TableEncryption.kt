...
public enum class TableEncryption(
    ...
    public companion object {
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.dynamodb.TableEncryption
        ): TableEncryption =
            when (cdkObject) {
                software.amazon.awscdk.services.dynamodb.TableEncryption.DEFAULT ->
