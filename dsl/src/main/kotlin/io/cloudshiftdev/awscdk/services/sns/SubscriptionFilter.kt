...
internal constructor(
    ...
    /**
     * conditions that specify the message attributes that should be included, excluded, matched,
     * etc.
     */
    ...
    public companion object {
        public fun existsFilter(): SubscriptionFilter =
            software.amazon.awscdk.services.sns.SubscriptionFilter.existsFilter()
                .let(SubscriptionFilter::wrap)

        public fun numericFilter(numericConditions: NumericConditions): SubscriptionFilter =
            software.amazon.awscdk.services.sns.SubscriptionFilter.numericFilter(
                    numericConditions.let(NumericConditions::unwrap)
                )
                .let(SubscriptionFilter::wrap)
        ...
        public fun numericFilter(
            numericConditions: NumericConditions.Builder.() -> Unit
        ...
        public fun stringFilter(stringConditions: StringConditions): SubscriptionFilter =
            software.amazon.awscdk.services.sns.SubscriptionFilter.stringFilter(
                    stringConditions.let(StringConditions::unwrap)
                )
                .let(SubscriptionFilter::wrap)
        ...
        public fun stringFilter(
            stringConditions: StringConditions.Builder.() -> Unit
