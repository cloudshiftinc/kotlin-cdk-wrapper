...
internal constructor(
    ...
    public open fun organizationAggregationSource(`value`: OrganizationAggregationSourceProperty) {
        unwrap(this)
            .setOrganizationAggregationSource(
                `value`.let(OrganizationAggregationSourceProperty::unwrap)
            )
    }
    ...
    public open fun organizationAggregationSource(
        `value`: OrganizationAggregationSourceProperty.Builder.() -> Unit
    ...
    public interface Builder {
        ...
        public fun organizationAggregationSource(
            organizationAggregationSource: OrganizationAggregationSourceProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.config.CfnConfigurationAggregator.Builder.create(
                scope,
                id
            )
        ...
        override fun organizationAggregationSource(organizationAggregationSource: IResolvable) {
            cdkBuilder.organizationAggregationSource(
                organizationAggregationSource.let(IResolvable::unwrap)
            )
        }
        ...
        override fun organizationAggregationSource(
            ...
            cdkBuilder.organizationAggregationSource(
                organizationAggregationSource.let(OrganizationAggregationSourceProperty::unwrap)
            )
        }
        ...
        override fun organizationAggregationSource(
            ...
            organizationAggregationSource(
                OrganizationAggregationSourceProperty(organizationAggregationSource)
            )
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnConfigurationAggregator
    ...
    public interface OrganizationAggregationSourceProperty {
        ...
        public interface Builder {
            /**
             * @param allAwsRegions If true, aggregate existing AWS Config regions and future
             *   regions.
             */
            ...
            /**
             * @param roleArn ARN of the IAM role used to retrieve AWS Organizations details
        ...
        private class BuilderImpl : Builder {
            ...
            /** @param awsRegions The source regions being aggregated. */
            override fun awsRegions(vararg awsRegions: String): Unit =
                awsRegions(awsRegions.toList())
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: OrganizationAggregationSourceProperty
            ): software.amazon.awscdk.services.config.CfnConfigurationAggregator.OrganizationAggregationSourceProperty =
    ...
    public interface AccountAggregationSourceProperty {
        ...
        private class BuilderImpl : Builder {
            ...
            /** @param accountIds The 12-digit account ID of the account being aggregated. */
            override fun accountIds(vararg accountIds: String): Unit =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AccountAggregationSourceProperty
            ): software.amazon.awscdk.services.config.CfnConfigurationAggregator.AccountAggregationSourceProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
