...
public interface EBSTagSpecification {
    ...
    public interface Builder {
         ...
         *   the service to the task. Valid values are: PropagatedTagSource.SERVICE,
    ...
    private class BuilderImpl : Builder {
        ...
        public fun build(): software.amazon.awscdk.services.ecs.EBSTagSpecification =
            cdkBuilder.build()
    }
