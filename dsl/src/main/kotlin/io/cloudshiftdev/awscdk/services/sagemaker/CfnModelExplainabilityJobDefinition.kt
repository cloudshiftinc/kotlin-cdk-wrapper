...
internal constructor(
    ...
    /** Configures the model explainability job to run a specified Docker container image. */
    public open fun modelExplainabilityAppSpecification(
        `value`: ModelExplainabilityAppSpecificationProperty
    ) {
        unwrap(this)
            .setModelExplainabilityAppSpecification(
                `value`.let(ModelExplainabilityAppSpecificationProperty::unwrap)
            )
    }
    ...
    public open fun modelExplainabilityAppSpecification(
        `value`: ModelExplainabilityAppSpecificationProperty.Builder.() -> Unit
    ): Unit =
    ...
    /** The baseline configuration for a model explainability job. */
    public open fun modelExplainabilityBaselineConfig(
        `value`: ModelExplainabilityBaselineConfigProperty
    ) {
        unwrap(this)
            .setModelExplainabilityBaselineConfig(
                `value`.let(ModelExplainabilityBaselineConfigProperty::unwrap)
            )
    }
    ...
    public open fun modelExplainabilityBaselineConfig(
        `value`: ModelExplainabilityBaselineConfigProperty.Builder.() -> Unit
    ): Unit = modelExplainabilityBaselineConfig(ModelExplainabilityBaselineConfigProperty(`value`))

    /** Inputs for the model explainability job. */
    public open fun modelExplainabilityJobInput(): Any =
        unwrap(this).getModelExplainabilityJobInput()
    ...
    public open fun modelExplainabilityJobInput(`value`: ModelExplainabilityJobInputProperty) {
        unwrap(this)
            .setModelExplainabilityJobInput(
                `value`.let(ModelExplainabilityJobInputProperty::unwrap)
            )
    }
    ...
    public open fun modelExplainabilityJobInput(
        `value`: ModelExplainabilityJobInputProperty.Builder.() -> Unit
    ...
    public open fun modelExplainabilityJobOutputConfig(
    ...
    public interface Builder {
         ...
         *
         * @param modelExplainabilityAppSpecification Configures the model explainability job to run
        ...
        public fun modelExplainabilityAppSpecification(
            modelExplainabilityAppSpecification:
                ModelExplainabilityAppSpecificationProperty.Builder.() -> Unit
        )
        ...
        public fun modelExplainabilityBaselineConfig(
            modelExplainabilityBaselineConfig:
                ModelExplainabilityBaselineConfigProperty.Builder.() -> Unit
        )
        ...
        public fun modelExplainabilityJobInput(
            modelExplainabilityJobInput: ModelExplainabilityJobInputProperty.Builder.() -> Unit
        )
        ...
        public fun modelExplainabilityJobOutputConfig(
            modelExplainabilityJobOutputConfig: IResolvable
        )
        ...
        public fun modelExplainabilityJobOutputConfig(
            modelExplainabilityJobOutputConfig: MonitoringOutputConfigProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
         ...
         *   a specified Docker container image.
         */
        override fun modelExplainabilityAppSpecification(
            modelExplainabilityAppSpecification: IResolvable
        ) {
            cdkBuilder.modelExplainabilityAppSpecification(
                modelExplainabilityAppSpecification.let(IResolvable::unwrap)
            )
        }
        ...
        override fun modelExplainabilityAppSpecification(
            ...
            cdkBuilder.modelExplainabilityAppSpecification(
                modelExplainabilityAppSpecification.let(
                    ModelExplainabilityAppSpecificationProperty::unwrap
                )
            )
        }
        ...
        override fun modelExplainabilityAppSpecification(
            ...
            modelExplainabilityAppSpecification(
                ModelExplainabilityAppSpecificationProperty(modelExplainabilityAppSpecification)
            )
         ...
         *   explainability job.
         */
        override fun modelExplainabilityBaselineConfig(
            modelExplainabilityBaselineConfig: IResolvable
        ) {
            cdkBuilder.modelExplainabilityBaselineConfig(
                modelExplainabilityBaselineConfig.let(IResolvable::unwrap)
            )
        }
        ...
        override fun modelExplainabilityBaselineConfig(
            ...
            cdkBuilder.modelExplainabilityBaselineConfig(
                modelExplainabilityBaselineConfig.let(
                    ModelExplainabilityBaselineConfigProperty::unwrap
                )
            )
        }
        ...
        override fun modelExplainabilityBaselineConfig(
            ...
            modelExplainabilityBaselineConfig(
                ModelExplainabilityBaselineConfigProperty(modelExplainabilityBaselineConfig)
            )
        ...
        override fun modelExplainabilityJobInput(modelExplainabilityJobInput: IResolvable) {
            cdkBuilder.modelExplainabilityJobInput(
                modelExplainabilityJobInput.let(IResolvable::unwrap)
            )
        }
         ...
         * @param modelExplainabilityJobInput Inputs for the model explainability job.
         */
        override fun modelExplainabilityJobInput(
            modelExplainabilityJobInput: ModelExplainabilityJobInputProperty
        ) {
            cdkBuilder.modelExplainabilityJobInput(
                modelExplainabilityJobInput.let(ModelExplainabilityJobInputProperty::unwrap)
            )
        }
        ...
        override fun modelExplainabilityJobInput(
            ...
            modelExplainabilityJobInput(
                ModelExplainabilityJobInputProperty(modelExplainabilityJobInput)
            )
         ...
         * @param modelExplainabilityJobOutputConfig The output configuration for monitoring jobs.
         */
        override fun modelExplainabilityJobOutputConfig(
            modelExplainabilityJobOutputConfig: IResolvable
        ) {
            cdkBuilder.modelExplainabilityJobOutputConfig(
                modelExplainabilityJobOutputConfig.let(IResolvable::unwrap)
            )
        }
        ...
        override fun modelExplainabilityJobOutputConfig(
            ...
            cdkBuilder.modelExplainabilityJobOutputConfig(
                modelExplainabilityJobOutputConfig.let(MonitoringOutputConfigProperty::unwrap)
            )
        }
        ...
        override fun modelExplainabilityJobOutputConfig(
            ...
            modelExplainabilityJobOutputConfig(
                MonitoringOutputConfigProperty(modelExplainabilityJobOutputConfig)
            )
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnModelExplainabilityJobDefinition
        ): software.amazon.awscdk.services.sagemaker.CfnModelExplainabilityJobDefinition =
            wrapped.cdkObject
    }
    ...
    public interface ModelExplainabilityBaselineConfigProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ModelExplainabilityBaselineConfigProperty
            ): software.amazon.awscdk.services.sagemaker.CfnModelExplainabilityJobDefinition.ModelExplainabilityBaselineConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ModelExplainabilityJobInputProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ModelExplainabilityJobInputProperty
            ): software.amazon.awscdk.services.sagemaker.CfnModelExplainabilityJobDefinition.ModelExplainabilityJobInputProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface BatchTransformInputProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param featuresAttribute The attributes of the input data that are the input
             *   features.
             */
    ...
    public interface ModelExplainabilityAppSpecificationProperty {
        ...
        public interface Builder {
            /**
             * @param configUri JSON formatted Amazon S3 file that defines explainability
             *   parameters. For more information on this JSON configuration file, see
             *   [Configure model explainability parameters](https://docs.aws.amazon.com/sagemaker/latest/dg/clarify-config-json-monitor-model-explainability-parameters.html)
             *   .
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ModelExplainabilityAppSpecificationProperty
            ): software.amazon.awscdk.services.sagemaker.CfnModelExplainabilityJobDefinition.ModelExplainabilityAppSpecificationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
