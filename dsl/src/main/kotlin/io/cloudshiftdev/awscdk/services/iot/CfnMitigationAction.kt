...
internal constructor(
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.iot.CfnMitigationAction =
            cdkBuilder.build()
    }
    ...
    public interface ReplaceDefaultPolicyVersionParamsProperty {
        ...
        public interface Builder {
            /**
             * @param templateName The name of the template to be applied. The only supported value
             *   is `BLANK_POLICY` .
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ReplaceDefaultPolicyVersionParamsProperty
            ): software.amazon.awscdk.services.iot.CfnMitigationAction.ReplaceDefaultPolicyVersionParamsProperty =
    ...
    public interface PublishFindingToSnsParamsProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: PublishFindingToSnsParamsProperty
            ): software.amazon.awscdk.services.iot.CfnMitigationAction.PublishFindingToSnsParamsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface UpdateDeviceCertificateParamsProperty {
        ...
        public interface Builder {
            /**
             * @param action The action that you want to apply to the device certificate. The only
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: UpdateDeviceCertificateParamsProperty
            ): software.amazon.awscdk.services.iot.CfnMitigationAction.UpdateDeviceCertificateParamsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ActionParamsProperty {
         ...
         */
        public fun addThingsToThingGroupParams(): Any? =
        ...
        public interface Builder {
            ...
            public fun addThingsToThingGroupParams(
                addThingsToThingGroupParams: AddThingsToThingGroupParamsProperty.Builder.() -> Unit
            )

            /**
             * @param enableIoTLoggingParams Specifies the logging level and the role with
             *   permissions for logging. You cannot specify a logging level of `DISABLED` .
             */
            ...
            public fun enableIoTLoggingParams(
                enableIoTLoggingParams: EnableIoTLoggingParamsProperty.Builder.() -> Unit
            )
            ...
            public fun publishFindingToSnsParams(
                publishFindingToSnsParams: PublishFindingToSnsParamsProperty.Builder.() -> Unit
            )

            /**
             * @param replaceDefaultPolicyVersionParams Replaces the policy version with a default
             *   or blank policy. You specify the template name. Only a value of `BLANK_POLICY` is
             *   currently supported.
             */
            public fun replaceDefaultPolicyVersionParams(
                replaceDefaultPolicyVersionParams: IResolvable
            )
            ...
            public fun replaceDefaultPolicyVersionParams(
                replaceDefaultPolicyVersionParams:
                    ReplaceDefaultPolicyVersionParamsProperty.Builder.() -> Unit
            )

            /**
             * @param updateCaCertificateParams Specifies the new state for the CA certificate. Only
             *   a value of `DEACTIVATE` is currently supported.
             */
            ...
            public fun updateCaCertificateParams(
                updateCaCertificateParams: UpdateCACertificateParamsProperty.Builder.() -> Unit
            )

            /**
             * @param updateDeviceCertificateParams Specifies the new state for a device
             *   certificate. Only a value of `DEACTIVATE` is currently supported.
             */
            ...
            public fun updateDeviceCertificateParams(
                updateDeviceCertificateParams:
                    UpdateDeviceCertificateParamsProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun addThingsToThingGroupParams(addThingsToThingGroupParams: IResolvable) {
                cdkBuilder.addThingsToThingGroupParams(
                    addThingsToThingGroupParams.let(IResolvable::unwrap)
                )
            }
             ...
             *   devices.
             */
            override fun addThingsToThingGroupParams(
                addThingsToThingGroupParams: AddThingsToThingGroupParamsProperty
            ) {
                cdkBuilder.addThingsToThingGroupParams(
                    addThingsToThingGroupParams.let(AddThingsToThingGroupParamsProperty::unwrap)
                )
            }
            ...
            override fun addThingsToThingGroupParams(
                ...
                addThingsToThingGroupParams(
                    AddThingsToThingGroupParamsProperty(addThingsToThingGroupParams)
                )
             ...
             *   permissions for logging. You cannot specify a logging level of `DISABLED` .
             */
            override fun enableIoTLoggingParams(
                enableIoTLoggingParams: EnableIoTLoggingParamsProperty
            ) {
                cdkBuilder.enableIoTLoggingParams(
                    enableIoTLoggingParams.let(EnableIoTLoggingParamsProperty::unwrap)
                )
            }
            ...
            override fun publishFindingToSnsParams(publishFindingToSnsParams: IResolvable) {
                cdkBuilder.publishFindingToSnsParams(
                    publishFindingToSnsParams.let(IResolvable::unwrap)
                )
            }
             ...
             *   published.
             */
            override fun publishFindingToSnsParams(
                publishFindingToSnsParams: PublishFindingToSnsParamsProperty
            ) {
                cdkBuilder.publishFindingToSnsParams(
                    publishFindingToSnsParams.let(PublishFindingToSnsParamsProperty::unwrap)
                )
            }
            ...
            override fun publishFindingToSnsParams(
                ...
                publishFindingToSnsParams(
                    PublishFindingToSnsParamsProperty(publishFindingToSnsParams)
                )
             ...
             *   currently supported.
             */
            override fun replaceDefaultPolicyVersionParams(
                replaceDefaultPolicyVersionParams: IResolvable
            ) {
                cdkBuilder.replaceDefaultPolicyVersionParams(
                    replaceDefaultPolicyVersionParams.let(IResolvable::unwrap)
                )
            }
            ...
            override fun replaceDefaultPolicyVersionParams(
                ...
                cdkBuilder.replaceDefaultPolicyVersionParams(
                    replaceDefaultPolicyVersionParams.let(
                        ReplaceDefaultPolicyVersionParamsProperty::unwrap
                    )
                )
            }
            ...
            override fun updateCaCertificateParams(updateCaCertificateParams: IResolvable) {
                cdkBuilder.updateCaCertificateParams(
                    updateCaCertificateParams.let(IResolvable::unwrap)
                )
            }
             ...
             *   a value of `DEACTIVATE` is currently supported.
             */
            override fun updateCaCertificateParams(
                updateCaCertificateParams: UpdateCACertificateParamsProperty
            ) {
                cdkBuilder.updateCaCertificateParams(
                    updateCaCertificateParams.let(UpdateCACertificateParamsProperty::unwrap)
                )
            }
            ...
            override fun updateCaCertificateParams(
                ...
                updateCaCertificateParams(
                    UpdateCACertificateParamsProperty(updateCaCertificateParams)
                )
            ...
            override fun updateDeviceCertificateParams(updateDeviceCertificateParams: IResolvable) {
                cdkBuilder.updateDeviceCertificateParams(
                    updateDeviceCertificateParams.let(IResolvable::unwrap)
                )
            }
             ...
             *   certificate. Only a value of `DEACTIVATE` is currently supported.
             */
            override fun updateDeviceCertificateParams(
                updateDeviceCertificateParams: UpdateDeviceCertificateParamsProperty
            ) {
                cdkBuilder.updateDeviceCertificateParams(
                    updateDeviceCertificateParams.let(UpdateDeviceCertificateParamsProperty::unwrap)
                )
            }
            ...
            override fun updateDeviceCertificateParams(
                ...
                updateDeviceCertificateParams(
                    UpdateDeviceCertificateParamsProperty(updateDeviceCertificateParams)
                )
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-iot-mitigationaction-actionparams.html#cfn-iot-mitigationaction-actionparams-publishfindingtosnsparams)
             */
            override fun publishFindingToSnsParams(): Any? =
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-iot-mitigationaction-actionparams.html#cfn-iot-mitigationaction-actionparams-updatecacertificateparams)
             */
            override fun updateCaCertificateParams(): Any? =
    ...
    public interface UpdateCACertificateParamsProperty {
        ...
        public interface Builder {
            /**
             * @param action The action that you want to apply to the CA certificate. The only
             *   supported value is `DEACTIVATE` .
             */
            public fun action(action: String)
        }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: UpdateCACertificateParamsProperty
            ): software.amazon.awscdk.services.iot.CfnMitigationAction.UpdateCACertificateParamsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface AddThingsToThingGroupParamsProperty {
        ...
        public interface Builder {
            /**
             * @param overrideDynamicGroups Specifies if this mitigation action can move the things
             *   that triggered the mitigation action even if they are part of one or more dynamic
             *   thing groups.
             */
             ...
             *   triggered the mitigation action. You can add a thing to a maximum of 10 groups, but
             *   you can't add a thing to more than one group in the same hierarchy.
             */
        ...
        internal constructor(
             ...
             * action.
             *
             * You can add a thing to a maximum of 10 groups, but you can't add a thing to more than
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AddThingsToThingGroupParamsProperty
            ): software.amazon.awscdk.services.iot.CfnMitigationAction.AddThingsToThingGroupParamsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface EnableIoTLoggingParamsProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param roleArnForLogging The Amazon Resource Name (ARN) of the IAM role used for
             *   logging.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: EnableIoTLoggingParamsProperty
            ): software.amazon.awscdk.services.iot.CfnMitigationAction.EnableIoTLoggingParamsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
