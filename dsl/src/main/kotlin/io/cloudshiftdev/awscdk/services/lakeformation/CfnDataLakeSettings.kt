...
internal constructor(
     ...
     */
    public open fun allowExternalDataFiltering(): Any? =
        unwrap(this).getAllowExternalDataFiltering()
    ...
    public open fun trustedResourceOwners(): List<String> =
        unwrap(this).getTrustedResourceOwners() ?: emptyList()
    ...
    public interface Builder {
         ...
         * managed by Lake Formation .
         *
         * If set to true, you allow Amazon EMR clusters or other third-party engines to access data
         ...
         *
         * @param allowExternalDataFiltering Whether to allow Amazon EMR clusters or other
         *   third-party query engines to access data managed by Lake Formation .
         */
        ...
        /**
         * Specifies whether query engines and applications can get credentials without IAM session
         * tags if the user has full table access.
         *
         * It provides query engines and applications performance benefits as well as simplifies
         * data access. Amazon EMR on Amazon EC2 is able to leverage this setting.
         *
         * For more information, see
         ...
         *
         * @param allowFullTableExternalDataAccess Specifies whether query engines and applications
         *   can get credentials without IAM session tags if the user has full table access.
         */
         ...
         * properly tag the temporary security credentials that will be used to call Lake Formation
         * 's administrative API operations.
         *
         ...
         *
         * @param authorizedSessionTagValueList Lake Formation relies on a privileged process
         *   secured by Amazon EMR or the third party integrator to tag the user's role while
         *   assuming it.
         */
         ...
         *
         * @param createDatabaseDefaultPermissions Specifies whether access control on a newly
         *   created database is managed by Lake Formation permissions or exclusively by IAM
         *   permissions.
         */
         ...
         * permissions determine the access to the table. This is referred to as the setting "Use
         * only IAM access control," and is to support the backward compatibility with the AWS Glue
         * permission model implemented by IAM permissions.
         *
         * The only permitted values are an empty array or an array that contains a single JSON
         * object that grants `ALL` permissions to `IAM_ALLOWED_PRINCIPALS` .
         *
         * For more information, see
         * [Changing the default security settings for your data lake](https://docs.aws.amazon.com/lake-formation/latest/dg/change-settings.html)
         * .
         ...
         *
         * @param externalDataFilteringAllowList A list of the account IDs of AWS accounts with
         *   Amazon EMR clusters or third-party engines that are allwed to perform data filtering.
         */
         ...
         *
         * @param mutationType Specifies whether the data lake settings are updated by adding new
         *   values to the current settings ( `APPEND` ) or by replacing the current settings with
         ...
         * A key-value map that provides an additional configuration on your data lake.
         *
         * `CrossAccountVersion` is the key you can configure in the `Parameters` field. Accepted
         * values for the `CrossAccountVersion` key are 1, 2, and 3.
         *
         ...
         * owner's CloudTrail log. You may want to specify this property when you are in a
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.lakeformation.CfnDataLakeSettings.Builder.create(
                scope,
                id
            )
        ...
        override fun allowExternalDataFiltering(allowExternalDataFiltering: IResolvable) {
            cdkBuilder.allowExternalDataFiltering(
                allowExternalDataFiltering.let(IResolvable::unwrap)
            )
        }
         ...
         *   can get credentials without IAM session tags if the user has full table access.
         */
        override fun allowFullTableExternalDataAccess(
            allowFullTableExternalDataAccess: IResolvable
        ) {
            cdkBuilder.allowFullTableExternalDataAccess(
                allowFullTableExternalDataAccess.let(IResolvable::unwrap)
            )
        }
         ...
         *   assuming it.
         */
        override fun authorizedSessionTagValueList(
            vararg authorizedSessionTagValueList: String
        ): Unit = authorizedSessionTagValueList(authorizedSessionTagValueList.toList())
         ...
         *   permissions.
         */
        override fun createDatabaseDefaultPermissions(
            createDatabaseDefaultPermissions: IResolvable
        ) {
            cdkBuilder.createDatabaseDefaultPermissions(
                createDatabaseDefaultPermissions.let(IResolvable::unwrap)
            )
        }
         ...
         */
        override fun createDatabaseDefaultPermissions(
            vararg createDatabaseDefaultPermissions: Any
        ...
        override fun createTableDefaultPermissions(createTableDefaultPermissions: IResolvable) {
            cdkBuilder.createTableDefaultPermissions(
                createTableDefaultPermissions.let(IResolvable::unwrap)
            )
        }
         ...
         *   table is managed by Lake Formation permissions or exclusively by IAM permissions.
         */
        override fun createTableDefaultPermissions(
            vararg createTableDefaultPermissions: Any
        ): Unit = createTableDefaultPermissions(createTableDefaultPermissions.toList())
        ...
        override fun externalDataFilteringAllowList(externalDataFilteringAllowList: IResolvable) {
            cdkBuilder.externalDataFilteringAllowList(
                externalDataFilteringAllowList.let(IResolvable::unwrap)
            )
        }
         ...
         *   Amazon EMR clusters or third-party engines that are allwed to perform data filtering.
         */
        override fun externalDataFilteringAllowList(
            vararg externalDataFilteringAllowList: Any
        ): Unit = externalDataFilteringAllowList(externalDataFilteringAllowList.toList())
    ...
    public interface PrincipalPermissionsProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: PrincipalPermissionsProperty
            ): software.amazon.awscdk.services.lakeformation.CfnDataLakeSettings.PrincipalPermissionsProperty =
    ...
    public interface DataLakePrincipalProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DataLakePrincipalProperty
            ): software.amazon.awscdk.services.lakeformation.CfnDataLakeSettings.DataLakePrincipalProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
