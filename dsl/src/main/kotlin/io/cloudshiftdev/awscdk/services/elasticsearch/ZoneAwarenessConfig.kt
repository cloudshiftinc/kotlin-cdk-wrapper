...
public interface ZoneAwarenessConfig {
     ...
     *
     * When you enable zone awareness, Amazon ES allocates the nodes and replica index shards that
     ...
     * information, see [Configuring a Multi-AZ Domain]
    ...
    public interface Builder {
        ...
        /**
         * @param enabled Indicates whether to enable zone awareness for the Amazon ES domain. When
         *   you enable zone awareness, Amazon ES allocates the nodes and replica index shards that
         *   belong to a cluster across two Availability Zones (AZs) in the same region to prevent
    ...
    internal constructor(
         ...
         * (deprecated) Indicates whether to enable zone awareness for the Amazon ES domain.
         *
         * When you enable zone awareness, Amazon ES allocates the nodes and replica index shards
         * that belong to a cluster across two Availability Zones (AZs) in the same region to
