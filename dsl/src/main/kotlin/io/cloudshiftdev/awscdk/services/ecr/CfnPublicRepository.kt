...
internal constructor(
    ...
    /**
     * Returns the Amazon Resource Name (ARN) for the specified `AWS::ECR::PublicRepository`
     * resource.
     *
    ...
    public interface Builder {
         ...
         *
         * @param repositoryCatalogData The details about the repository that are publicly visible
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.ecr.CfnPublicRepository =
            cdkBuilder.build()
    }
    ...
    public interface RepositoryCatalogDataProperty {
         ...
         */
        public fun operatingSystems(): List<String> =
            unwrap(this).getOperatingSystems() ?: emptyList()
        ...
        public interface Builder {
            /**
             * @param aboutText The longform description of the contents of the repository. This
             *   text appears in the repository details on the Amazon ECR Public Gallery.
             */
            ...
            /**
             * @param operatingSystems The operating system tags that are associated with the
             *   repository.
             */
            ...
            /**
             * @param usageText The longform usage details of the contents of the repository. The
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ecr-publicrepository-repositorycatalogdata.html#cfn-ecr-publicrepository-repositorycatalogdata-architectures)
             */
            override fun architectures(): List<String> =
                unwrap(this).getArchitectures() ?: emptyList()
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ecr-publicrepository-repositorycatalogdata.html#cfn-ecr-publicrepository-repositorycatalogdata-operatingsystems)
             */
            override fun operatingSystems(): List<String> =
                unwrap(this).getOperatingSystems() ?: emptyList()
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RepositoryCatalogDataProperty
            ): software.amazon.awscdk.services.ecr.CfnPublicRepository.RepositoryCatalogDataProperty =
