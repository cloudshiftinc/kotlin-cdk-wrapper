...
internal constructor(
    ...
    public open fun robotSoftwareSuite(
        `value`: RobotSoftwareSuiteProperty.Builder.() -> Unit
    ): Unit = robotSoftwareSuite(RobotSoftwareSuiteProperty(`value`))
    ...
    public open fun simulationSoftwareSuite(`value`: SimulationSoftwareSuiteProperty) {
        unwrap(this)
            .setSimulationSoftwareSuite(`value`.let(SimulationSoftwareSuiteProperty::unwrap))
    }

    /** The simulation software suite used by the simulation application. */
    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("d8d46860273ab2f5c665dbba798528062984c0e56e3f7635c50240c753074770")
    public open fun simulationSoftwareSuite(
        `value`: SimulationSoftwareSuiteProperty.Builder.() -> Unit
    ): Unit = simulationSoftwareSuite(SimulationSoftwareSuiteProperty(`value`))
    ...
    public interface Builder {
        ...
        public fun robotSoftwareSuite(
            robotSoftwareSuite: RobotSoftwareSuiteProperty.Builder.() -> Unit
        )
        ...
        public fun simulationSoftwareSuite(
            simulationSoftwareSuite: SimulationSoftwareSuiteProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.robomaker.CfnSimulationApplication.Builder.create(
                scope,
                id
            )
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("a5cf0c427601194a1cf47914b769b5337a7b8505c0a0d7d203f1e0daa16beabe")
        override fun renderingEngine(
            renderingEngine: RenderingEngineProperty.Builder.() -> Unit
        ): Unit = renderingEngine(RenderingEngineProperty(renderingEngine))
        ...
        override fun robotSoftwareSuite(robotSoftwareSuite: RobotSoftwareSuiteProperty) {
            cdkBuilder.robotSoftwareSuite(
                robotSoftwareSuite.let(RobotSoftwareSuiteProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("0174d698c624015b15a267fb705bee6eed258cda097efe8d9742789a5ed91a4a")
        override fun robotSoftwareSuite(
            robotSoftwareSuite: RobotSoftwareSuiteProperty.Builder.() -> Unit
         ...
         *   application.
         */
        override fun simulationSoftwareSuite(
            simulationSoftwareSuite: SimulationSoftwareSuiteProperty
        ) {
            cdkBuilder.simulationSoftwareSuite(
                simulationSoftwareSuite.let(SimulationSoftwareSuiteProperty::unwrap)
            )
        }
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnSimulationApplication
    ...
    public interface SimulationSoftwareSuiteProperty {
        ...
        public interface Builder {
            /**
             * @param name The name of the simulation software suite. `SimulationRuntime` is the
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SimulationSoftwareSuiteProperty
            ): software.amazon.awscdk.services.robomaker.CfnSimulationApplication.SimulationSoftwareSuiteProperty =
    ...
    public interface RenderingEngineProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RenderingEngineProperty
            ): software.amazon.awscdk.services.robomaker.CfnSimulationApplication.RenderingEngineProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface RobotSoftwareSuiteProperty {
        ...
        public interface Builder {
            /**
             * @param name The name of the robot software suite. `General` is the only supported
             *   value.
             */
            public fun name(name: String)

            /**
             * @param version The version of the robot software suite. Not applicable for General
             *   software suite.
             */
            public fun version(version: String)
        }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RobotSoftwareSuiteProperty
            ): software.amazon.awscdk.services.robomaker.CfnSimulationApplication.RobotSoftwareSuiteProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
