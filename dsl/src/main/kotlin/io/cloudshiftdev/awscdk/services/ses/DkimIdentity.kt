...
internal constructor(
    ...
    public open fun bind(
        ...
        unwrap(this)
            .bind(
                emailIdentity.let(EmailIdentity::unwrap),
                hostedZone.let(IPublicHostedZone::unwrap)
            )
            ?.let(DkimIdentityConfig::wrap)
    ...
    public companion object {
        public fun byoDkim(options: ByoDkimOptions): DkimIdentity =
            software.amazon.awscdk.services.ses.DkimIdentity.byoDkim(
                    options.let(ByoDkimOptions::unwrap)
                )
                .let(DkimIdentity::wrap)
        ...
        public fun easyDkim(signingKeyLength: EasyDkimSigningKeyLength): DkimIdentity =
            software.amazon.awscdk.services.ses.DkimIdentity.easyDkim(
                    signingKeyLength.let(EasyDkimSigningKeyLength::unwrap)
                )
                .let(DkimIdentity::wrap)

        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.ses.DkimIdentity
        ): DkimIdentity = Wrapper(cdkObject)

        internal fun unwrap(
            wrapped: DkimIdentity
        ): software.amazon.awscdk.services.ses.DkimIdentity = (wrapped as Wrapper).cdkObject
    }
}
