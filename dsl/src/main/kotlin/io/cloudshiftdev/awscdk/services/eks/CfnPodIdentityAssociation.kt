...
internal constructor(
    ...
    public interface Builder {
         ...
         * The Amazon Resource Name (ARN) of the IAM role to associate with the service account.
         *
         * The EKS Pod Identity agent manages credentials to assume this role for applications in
         * the containers in the pods that use this service account.
         *
         ...
         *
         * @param roleArn The Amazon Resource Name (ARN) of the IAM role to associate with the
         *   service account.
         */
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnPodIdentityAssociation
