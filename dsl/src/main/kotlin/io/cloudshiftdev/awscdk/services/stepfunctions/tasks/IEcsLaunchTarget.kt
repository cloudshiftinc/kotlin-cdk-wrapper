...
public interface IEcsLaunchTarget {
    ...
    public fun bind(
        task: EcsRunTask,
        launchTargetOptions: LaunchTargetBindOptions.Builder.() -> Unit
    ): EcsLaunchTargetConfig
    ...
    internal constructor(
        ...
        override fun bind(
            ...
            unwrap(this)
                .bind(
                    task.let(EcsRunTask::unwrap),
                    launchTargetOptions.let(LaunchTargetBindOptions::unwrap)
                )
                .let(EcsLaunchTargetConfig::wrap)
        ...
        override fun bind(
            task: EcsRunTask,
            launchTargetOptions: LaunchTargetBindOptions.Builder.() -> Unit
        ): EcsLaunchTargetConfig = bind(task, LaunchTargetBindOptions(launchTargetOptions))
    }
