...
internal constructor(
    ...
    public interface Builder {
         ...
         * Integration URI.
         *
         * This will be the function ARN in the case of `HttpIntegrationType.AWS_PROXY`, or HTTP URL
         * in the case of `HttpIntegrationType.HTTP_PROXY`.
         *
