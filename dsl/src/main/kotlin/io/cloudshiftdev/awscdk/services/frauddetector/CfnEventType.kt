...
internal constructor(
    ...
    public interface LabelProperty {
        ...
        public interface Builder {
             ...
             *   changes to the object.
             *
             * For example, when creating `AWS::FraudDetector::EventType` you must define at least
             * two variables. You can set `Inline=true` for these variables and CloudFormation will
             * create/update/delete the variables as part of stack operations. However, if you set
             * `Inline=false` , CloudFormation will associate the variables to your EventType but
             * not execute any changes to the variables.
             */
    ...
    public interface EntityTypeProperty {
        ...
        public interface Builder {
             ...
             * two variables. You can set `Inline=true` for these variables and CloudFormation will
             * create/update/delete the variables as part of stack operations. However, if you set
             * `Inline=false` , CloudFormation will associate the variables to your event type but
             * not execute any changes to the variables.
             */
            public fun `inline`(`inline`: Boolean)
