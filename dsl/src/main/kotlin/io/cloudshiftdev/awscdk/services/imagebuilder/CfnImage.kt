...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param containerRecipeArn The Amazon Resource Name (ARN) of the container recipe that
         ...
         *   infrastructure configuration that defines the environment in which your image will be
         *   built and tested.
         */
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.imagebuilder.CfnImage =
            cdkBuilder.build()
    }
    ...
    public companion object {
        ...
        ): CfnImage = CfnImage(cdkObject)

        internal fun unwrap(
            wrapped: CfnImage
        ): software.amazon.awscdk.services.imagebuilder.CfnImage = wrapped.cdkObject
    }
    ...
    public interface ImageTestsConfigurationProperty {
        ...
        public interface Builder {
             ...
             *   Image Builder defaults to enable tests to run following the image build, before
             *   image distribution.
             */
