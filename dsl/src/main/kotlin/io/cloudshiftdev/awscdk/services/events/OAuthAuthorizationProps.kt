...
public interface OAuthAuthorizationProps {
    ...
    public interface Builder {
        ...
        /**
         * @param httpMethod The method to use for the authorization request. (Can only choose POST,
         *   GET or PUT).
         */
        public fun httpMethod(httpMethod: HttpMethod)

        /**
         * @param queryStringParameters Additional string parameters to add to the OAuth request
         *   query string.
         */
    ...
    private class BuilderImpl : Builder {
        ...
        override fun headerParameters(headerParameters: Map<String, HttpParameter>) {
            cdkBuilder.headerParameters(
                headerParameters.mapValues { HttpParameter.unwrap(it.value) }
            )
        }
        ...
        override fun queryStringParameters(queryStringParameters: Map<String, HttpParameter>) {
            cdkBuilder.queryStringParameters(
                queryStringParameters.mapValues { HttpParameter.unwrap(it.value) }
            )
        }
    ...
    internal constructor(
        ...
        override fun bodyParameters(): Map<String, HttpParameter> =
            unwrap(this).getBodyParameters()?.mapValues { HttpParameter.wrap(it.value) }
                ?: emptyMap()
        ...
        override fun headerParameters(): Map<String, HttpParameter> =
            unwrap(this).getHeaderParameters()?.mapValues { HttpParameter.wrap(it.value) }
                ?: emptyMap()
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: OAuthAuthorizationProps
