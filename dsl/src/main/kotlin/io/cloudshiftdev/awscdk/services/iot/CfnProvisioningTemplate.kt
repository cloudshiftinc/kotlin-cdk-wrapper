...
internal constructor(
    ...
    public open fun preProvisioningHook(
        `value`: ProvisioningHookProperty.Builder.() -> Unit
    ): Unit = preProvisioningHook(ProvisioningHookProperty(`value`))
    ...
    public interface Builder {
        ...
        public fun preProvisioningHook(
            preProvisioningHook: ProvisioningHookProperty.Builder.() -> Unit
        )
         ...
         *
         * @param provisioningRoleArn The role ARN for the role associated with the fleet
    ...
    private class BuilderImpl(
        ...
        override fun preProvisioningHook(preProvisioningHook: ProvisioningHookProperty) {
            cdkBuilder.preProvisioningHook(
                preProvisioningHook.let(ProvisioningHookProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("859854171f55f7301674cd68e0ca7c8cae08b6697bf440a98b5295633c0c207e")
        override fun preProvisioningHook(
            preProvisioningHook: ProvisioningHookProperty.Builder.() -> Unit
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnProvisioningTemplate
    ...
    public interface ProvisioningHookProperty {
        ...
        public interface Builder {
            /**
             * @param payloadVersion The payload that was sent to the target function. The valid
             *   payload is `"2020-04-01"` .
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ProvisioningHookProperty
            ): software.amazon.awscdk.services.iot.CfnProvisioningTemplate.ProvisioningHookProperty =
