...
internal constructor(
     ...
     *   discovery are broken. This may happen if the owner of the resource discovery stopped
     *   sharing it or deleted the resource discovery. Verify the resource discovery still exists
     *   and the AWS RAM resource share is still intact.
     */
     ...
     * * `isolate-in-progress` - AWS account that created the resource discovery association has
     *   been removed and the resource discovery associatation is being isolated.
    ...
    public interface Builder {
         ...
         * A tag is a label that you assign to an AWS resource.
         *
         * Each tag consists of a key and an optional value. You can use tags to search and filter
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.ec2.CfnIPAMResourceDiscoveryAssociation.Builder.create(
                scope,
                id
            )
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnIPAMResourceDiscoveryAssociation
        ): software.amazon.awscdk.services.ec2.CfnIPAMResourceDiscoveryAssociation =
            wrapped.cdkObject
    }
}
