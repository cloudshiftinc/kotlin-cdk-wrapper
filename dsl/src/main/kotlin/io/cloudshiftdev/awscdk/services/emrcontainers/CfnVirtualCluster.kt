...
internal constructor(
    ...
    public interface Builder {
        ...
        public fun containerProvider(
            containerProvider: ContainerProviderProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.emrcontainers.CfnVirtualCluster.Builder.create(
                scope,
                id
            )
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("2e89df576ee0d06994e7056ae49e61090d8197040e42065ef0f40f4e78a3d4cd")
        override fun containerProvider(
            containerProvider: ContainerProviderProperty.Builder.() -> Unit
    ...
    public interface ContainerProviderProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param type The type of the container provider. Amazon EKS is the only supported type
             *   as of now.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ContainerProviderProperty
            ): software.amazon.awscdk.services.emrcontainers.CfnVirtualCluster.ContainerProviderProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
