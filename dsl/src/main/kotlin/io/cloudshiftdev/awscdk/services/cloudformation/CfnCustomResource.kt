...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * The service token that was given to the template developer by the service provider to
         * access the service, such as an Amazon SNS topic ARN or Lambda function ARN. The service
         * token must be from the same Region in which you are creating the stack.
         *
         ...
         *
         * @param serviceToken Only one property is defined by AWS for a custom resource:
         *   `ServiceToken` .
         */
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.cloudformation.CfnCustomResource.Builder.create(
                scope,
                id
            )
