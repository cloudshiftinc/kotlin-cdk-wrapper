...
public interface RepositoryTriggerOptions {
     ...
     * specified in the DestinationArn property.If you don't specify events, the trigger runs for
    ...
    public interface Builder {
         ...
         *   events that you want to include in the trigger. If you don't specify at least one
         *   branch, the trigger applies to all branches.
         */
        ...
        /**
         * @param events The repository events for which AWS CodeCommit sends information to the
         *   target, which you specified in the DestinationArn property.If you don't specify events,
         *   the trigger runs for all repository events.
         */
    ...
    internal constructor(
        ...
        /**
         * The names of the branches in the AWS CodeCommit repository that contain events that you
         * want to include in the trigger.
         *
         * If you don't specify at least one branch, the trigger applies to all branches.
         */
        ...
        /**
         * When an event is triggered, additional information that AWS CodeCommit includes when it
         * sends information to the target.
         */
        override fun customData(): String? = unwrap(this).getCustomData()

        /**
         * The repository events for which AWS CodeCommit sends information to the target, which you
         * specified in the DestinationArn property.If you don't specify events, the trigger runs
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: RepositoryTriggerOptions
