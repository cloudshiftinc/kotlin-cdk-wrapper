...
public enum class EbsPropagatedTagSource(
  ...
  public companion object {
    internal fun wrap(cdkObject: software.amazon.awscdk.services.ecs.EbsPropagatedTagSource):
        EbsPropagatedTagSource = when (cdkObject) {
    ...
    internal fun unwrap(wrapped: EbsPropagatedTagSource):
