...
public enum class SourceType(
  ...
  public companion object {
    internal fun wrap(cdkObject: software.amazon.awscdk.services.appconfig.SourceType): SourceType =
        when (cdkObject) {
    ...
    internal fun unwrap(wrapped: SourceType): software.amazon.awscdk.services.appconfig.SourceType =
        wrapped.cdkObject
  }
}
