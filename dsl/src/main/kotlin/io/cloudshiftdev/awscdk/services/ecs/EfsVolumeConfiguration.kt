...
public interface EfsVolumeConfiguration {
    ...
    public interface Builder {
        ...
        /**
         * @param transitEncryption Whether or not to enable encryption for Amazon EFS data in
         *   transit between the Amazon ECS host and the Amazon EFS server. Transit encryption must
         *   be enabled if Amazon EFS IAM authorization is used.
         *
         * Valid values: ENABLED | DISABLED
         */
         ...
         *   Amazon ECS host and the Amazon EFS server. EFS mount helper uses.
         */
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: EfsVolumeConfiguration
