...
public enum class EasyDkimSigningKeyLength(
  ...
  public companion object {
    internal fun wrap(cdkObject: software.amazon.awscdk.services.ses.EasyDkimSigningKeyLength):
        EasyDkimSigningKeyLength = when (cdkObject) {
    ...
    internal fun unwrap(wrapped: EasyDkimSigningKeyLength):
