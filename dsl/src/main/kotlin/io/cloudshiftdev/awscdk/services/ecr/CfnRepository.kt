...
internal constructor(
    ...
    public interface Builder {
         ...
         * The image scanning configuration for the repository.
         *
         * This determines whether images are scanned for known vulnerabilities after being pushed
         * to the repository.
         *
         ...
         * The tag mutability setting for the repository.
         *
         * If this parameter is omitted, the default setting of `MUTABLE` will be used which will
         * allow image tags to be overwritten. If `IMMUTABLE` is specified, all image tags within
    ...
    private class BuilderImpl(
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("d6ad27a65aea65dbb4d8f833113f05c5dc1799ae2056ee03563388b4b0003725")
        override fun lifecyclePolicy(
            lifecyclePolicy: LifecyclePolicyProperty.Builder.() -> Unit
        ): Unit = lifecyclePolicy(LifecyclePolicyProperty(lifecyclePolicy))
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnRepository
        ): software.amazon.awscdk.services.ecr.CfnRepository = wrapped.cdkObject
    }
    ...
    public interface ImageScanningConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param scanOnPush The setting that determines whether images are scanned after being
             *   pushed to a repository. If set to `true` , images will be scanned after being
             *   pushed. If this parameter is not specified, it will default to `false` and images
        ...
        internal constructor(
             ...
             * repository.
             *
             * If set to `true` , images will be scanned after being pushed. If this parameter is
             * not specified, it will default to `false` and images will not be scanned unless a
             * scan is manually started.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ecr-repository-imagescanningconfiguration.html#cfn-ecr-repository-imagescanningconfiguration-scanonpush)
             */
    ...
    public interface LifecyclePolicyProperty {
        ...
        public interface Builder {
            /**
             * @param lifecyclePolicyText The JSON repository policy text to apply to the
             *   repository.
             */
    ...
    public interface EncryptionConfigurationProperty {
         ...
         * using server-side encryption with AWS Key Management Service key stored in AWS KMS . When
         * you use AWS KMS to encrypt your data, you can either use the default AWS managed AWS KMS
         * key for Amazon ECR, or specify your own AWS KMS key, which you already created. For more
         * information, see
         * [Protecting data using server-side encryption with an AWS KMS key stored in AWS Key Management Service (SSE-KMS)](https://docs.aws.amazon.com/AmazonS3/latest/dev/UsingKMSEncryption.html)
         ...
         * the same Region as the repository. If no key is specified, the default AWS managed AWS
        ...
        public interface Builder {
            /**
             * @param encryptionType The encryption type to use. If you use the `KMS` encryption
             *   type, the contents of the repository will be encrypted using server-side encryption
             *   with AWS Key Management Service key stored in AWS KMS . When you use AWS KMS to
             *   encrypt your data, you can either use the default AWS managed AWS KMS key for
             *   Amazon ECR, or specify your own AWS KMS key, which you already created. For more
             *   information, see
             *   [Protecting data using server-side encryption with an AWS KMS key stored in AWS Key Management Service (SSE-KMS)](https://docs.aws.amazon.com/AmazonS3/latest/dev/UsingKMSEncryption.html)
             *   in the *Amazon Simple Storage Service Console Developer Guide* .
             *
             * If you use the `AES256` encryption type, Amazon ECR uses server-side encryption with
             * Amazon S3-managed encryption keys which encrypts the images in the repository using
             * an AES-256 encryption algorithm. For more information, see
             * [Protecting data using server-side encryption with Amazon S3-managed encryption keys (SSE-S3)](https://docs.aws.amazon.com/AmazonS3/latest/dev/UsingServerSideEncryption.html)
             * in the *Amazon Simple Storage Service Console Developer Guide* .
             */
            ...
            /**
             * @param kmsKey If you use the `KMS` encryption type, specify the AWS KMS key to use
             *   for encryption. The alias, key ID, or full ARN of the AWS KMS key can be specified.
             *   The key must exist in the same Region as the repository. If no key is specified,
             *   the default AWS managed AWS KMS key for Amazon ECR will be used.
             */
        ...
        internal constructor(
             ...
             * encrypted using server-side encryption with AWS Key Management Service key stored in
             * AWS KMS . When you use AWS KMS to encrypt your data, you can either use the default
             * AWS managed AWS KMS key for Amazon ECR, or specify your own AWS KMS key, which you
             * already created. For more information, see
             * [Protecting data using server-side encryption with an AWS KMS key stored in AWS Key Management Service (SSE-KMS)](https://docs.aws.amazon.com/AmazonS3/latest/dev/UsingKMSEncryption.html)
             * in the *Amazon Simple Storage Service Console Developer Guide* .
             *
             * If you use the `AES256` encryption type, Amazon ECR uses server-side encryption with
             ...
             * If you use the `KMS` encryption type, specify the AWS KMS key to use for encryption.
             *
             * The alias, key ID, or full ARN of the AWS KMS key can be specified. The key must
             * exist in the same Region as the repository. If no key is specified, the default AWS
             * managed AWS KMS key for Amazon ECR will be used.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ecr-repository-encryptionconfiguration.html#cfn-ecr-repository-encryptionconfiguration-kmskey)
             */
