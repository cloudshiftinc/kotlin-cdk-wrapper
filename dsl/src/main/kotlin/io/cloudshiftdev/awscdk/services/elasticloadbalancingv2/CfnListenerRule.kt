...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.elasticloadbalancingv2.CfnListenerRule,
    ...
    public interface Builder {
         ...
         * `http-request-method` , `host-header` , `path-pattern` , and `source-ip` . A rule can
         * also optionally include one or more of each of the following conditions: `http-header`
         * and `query-string` .
         *
         ...
         * if an existing rule already uses this priority, as this can cause an error. If you need
         * to reuse a priority with a different rule, you must remove it as a priority first, and
         * then specify it in a subsequent update.
         *
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.elasticloadbalancingv2.CfnListenerRule.Builder.create(
                scope,
                id
            )
    ...
    public interface QueryStringConfigProperty {
         ...
         * (matches exactly 1 character). To search for a literal '*' or '?' character in a query
        ...
        public interface Builder {
            /**
             * @param values The key/value pairs or values to find in the query string. The maximum
        ...
        internal constructor(
             ...
             * The key/value pairs or values to find in the query string.
             *
             * The maximum size of each string is 128 characters. The comparison is case
             * insensitive. The following wildcard characters are supported: * (matches 0 or more
             * characters) and ? (matches exactly 1 character). To search for a literal '*' or '?'
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: QueryStringConfigProperty
            ): software.amazon.awscdk.services.elasticloadbalancingv2.CfnListenerRule.QueryStringConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface PathPatternConfigProperty {
        ...
        public interface Builder {
            /**
             * @param values The path patterns to compare against the request URL. The maximum size
             *   of each string is 128 characters. The comparison is case sensitive. The following
             ...
             * the request URL. The path pattern is compared only to the path of the URL, not to its
             * query string.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: PathPatternConfigProperty
            ): software.amazon.awscdk.services.elasticloadbalancingv2.CfnListenerRule.PathPatternConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface RuleConditionProperty {
         ...
         * multiple host names or multiple path patterns, use `HostHeaderConfig` or
         * `PathPatternConfig` .
         *
         * If `Field` is `host-header` and you're not using `HostHeaderConfig` , you can specify a
         * single host name (for example, my.example.com). A host name is case insensitive, can be
         ...
         * single path pattern (for example, /img/ *). A path pattern is case-sensitive, can be up
        ...
        public interface Builder {
            ...
            /**
             * @param hostHeaderConfig Information for a host header condition. Specify only when
            ...
            public fun hostHeaderConfig(
                hostHeaderConfig: HostHeaderConfigProperty.Builder.() -> Unit
            )

            /**
             * @param httpHeaderConfig Information for an HTTP header condition. Specify only when
             *   `Field` is `http-header` .
             */
            ...
            public fun httpHeaderConfig(
                httpHeaderConfig: HttpHeaderConfigProperty.Builder.() -> Unit
            )

            /**
             * @param httpRequestMethodConfig Information for an HTTP method condition. Specify only
            ...
            public fun httpRequestMethodConfig(
                httpRequestMethodConfig: HttpRequestMethodConfigProperty.Builder.() -> Unit
            )

            /**
             * @param pathPatternConfig Information for a path pattern condition. Specify only when
             *   `Field` is `path-pattern` .
             */
            ...
            public fun pathPatternConfig(
                pathPatternConfig: PathPatternConfigProperty.Builder.() -> Unit
            )

            /**
             * @param queryStringConfig Information for a query string condition. Specify only when
             *   `Field` is `query-string` .
             */
            ...
            public fun queryStringConfig(
                queryStringConfig: QueryStringConfigProperty.Builder.() -> Unit
            )

            /**
             * @param sourceIpConfig Information for a source IP condition. Specify only when
             *   `Field` is `source-ip` .
             */
             ...
             *
             * If `Field` is `host-header` and you're not using `HostHeaderConfig` , you can specify
             * a single host name (for example, my.example.com). A host name is case insensitive,
             ...
             * * ? (matches exactly 1 character)
             *
             * If `Field` is `path-pattern` and you're not using `PathPatternConfig` , you can
             * specify a single path pattern (for example, /img/ *). A path pattern is
        ...
        private class BuilderImpl : Builder {
             ...
             *   when `Field` is `http-request-method` .
             */
            override fun httpRequestMethodConfig(
                httpRequestMethodConfig: HttpRequestMethodConfigProperty
            ) {
                cdkBuilder.httpRequestMethodConfig(
                    httpRequestMethodConfig.let(HttpRequestMethodConfigProperty::unwrap)
                )
            }
            ...
            override fun httpRequestMethodConfig(
                ...
                httpRequestMethodConfig(HttpRequestMethodConfigProperty(httpRequestMethodConfig))
            ...
            override fun pathPatternConfig(pathPatternConfig: PathPatternConfigProperty) {
                cdkBuilder.pathPatternConfig(
                    pathPatternConfig.let(PathPatternConfigProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("6997fe58d1b50a439136930b30ed5927e3072f0777072a081fa7612b42cdfa7b")
            override fun pathPatternConfig(
                pathPatternConfig: PathPatternConfigProperty.Builder.() -> Unit
            ...
            override fun queryStringConfig(queryStringConfig: QueryStringConfigProperty) {
                cdkBuilder.queryStringConfig(
                    queryStringConfig.let(QueryStringConfigProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("82897a687b5ea53096160d48383110ba1c0563bf1618b31f58a2734bbb0adbd5")
            override fun queryStringConfig(
                queryStringConfig: QueryStringConfigProperty.Builder.() -> Unit
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("13e80fa32ee413fe9c4c30fa4989582cb5a1b13afdd202b62beeb9614d8f5bd6")
            override fun sourceIpConfig(
                sourceIpConfig: SourceIpConfigProperty.Builder.() -> Unit
            ): Unit = sourceIpConfig(SourceIpConfigProperty(sourceIpConfig))
        ...
        internal constructor(
             ...
             * The condition value.
             *
             * Specify only when `Field` is `host-header` or `path-pattern` . Alternatively, to
             * specify multiple host names or multiple path patterns, use `HostHeaderConfig` or
             * `PathPatternConfig` .
             *
             * If `Field` is `host-header` and you're not using `HostHeaderConfig` , you can specify
             * a single host name (for example, my.example.com). A host name is case insensitive,
    ...
    public interface QueryStringKeyValueProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: QueryStringKeyValueProperty
            ): software.amazon.awscdk.services.elasticloadbalancingv2.CfnListenerRule.QueryStringKeyValueProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface HttpRequestMethodConfigProperty {
         ...
         * underscore (_). The comparison is case sensitive. Wildcards are not supported; therefore,
         ...
         * the HTTP request method. We recommend that you route GET and HEAD requests in the same
         * way, because the response to a HEAD request may be cached.
         *
        ...
        public interface Builder {
            /**
             * @param values The name of the request method. The maximum size is 40 characters. The
             *   allowed characters are A-Z, hyphen (-), and underscore (_). The comparison is case
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: HttpRequestMethodConfigProperty
            ): software.amazon.awscdk.services.elasticloadbalancingv2.CfnListenerRule.HttpRequestMethodConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface HttpHeaderConfigProperty {
        ...
        public interface Builder {
            /**
             * @param httpHeaderName The name of the HTTP header field. The maximum size is 40
             *   characters. The header name is case insensitive. The allowed characters are
             *   specified by RFC 7230. Wildcards are not supported.
             */
            public fun httpHeaderName(httpHeaderName: String)

            /**
             * @param values The strings to compare against the value of the HTTP header. The
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: HttpHeaderConfigProperty
            ): software.amazon.awscdk.services.elasticloadbalancingv2.CfnListenerRule.HttpHeaderConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface HostHeaderConfigProperty {
        ...
        public interface Builder {
            /**
             * @param values The host names. The maximum size of each name is 128 characters. The
        ...
        internal constructor(
             ...
             * The host names.
             *
             * The maximum size of each name is 128 characters. The comparison is case insensitive.
             * The following wildcard characters are supported: * (matches 0 or more characters) and
             * ? (matches exactly 1 character).
             *
             * If you specify multiple strings, the condition is satisfied if one of the strings
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: HostHeaderConfigProperty
            ): software.amazon.awscdk.services.elasticloadbalancingv2.CfnListenerRule.HostHeaderConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SourceIpConfigProperty {
        ...
        public interface Builder {
             ...
             *   condition is satisfied if the source IP address of the request matches one of the
             *   CIDR blocks. This condition is not satisfied by the addresses in the
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SourceIpConfigProperty
            ): software.amazon.awscdk.services.elasticloadbalancingv2.CfnListenerRule.SourceIpConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
