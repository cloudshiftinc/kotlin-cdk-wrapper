...
internal constructor(
     ...
     *
     * This ID is returned in the responses to create and list commands. You provide it to
    ...
    public open fun tlsInspectionConfiguration(`value`: TLSInspectionConfigurationProperty) {
        unwrap(this)
            .setTlsInspectionConfiguration(`value`.let(TLSInspectionConfigurationProperty::unwrap))
    }

    /** The object that defines a TLS inspection configuration. */
    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("7184ddc902c0d819b249c81fc75e1efb036cb9855d9ba8d0318b7155ab2dcca8")
    public open fun tlsInspectionConfiguration(
        `value`: TLSInspectionConfigurationProperty.Builder.() -> Unit
    ...
    public interface Builder {
         ...
         * The object that defines a TLS inspection configuration.
         *
         * AWS Network Firewall uses TLS inspection configurations to decrypt your firewall's
         * inbound and outbound SSL/TLS traffic. After decryption, AWS Network Firewall inspects the
         * traffic according to your firewall policy's stateful rules, and then re-encrypts it
         * before sending it to its destination. You can enable inspection of your firewall's
         * inbound traffic, outbound traffic, or both. To use TLS inspection with your firewall, you
         * must first import or provision certificates using AWS Certificate Manager , create a TLS
         * inspection configuration, add that configuration to a new firewall policy, and then
         * associate that policy with your firewall. For more information about using TLS inspection
         * configurations, see
        ...
        public fun tlsInspectionConfiguration(
            tlsInspectionConfiguration: TLSInspectionConfigurationProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
        ...
        override fun tlsInspectionConfiguration(tlsInspectionConfiguration: IResolvable) {
            cdkBuilder.tlsInspectionConfiguration(
                tlsInspectionConfiguration.let(IResolvable::unwrap)
            )
        }
         ...
         * @param tlsInspectionConfiguration The object that defines a TLS inspection configuration.
         */
        override fun tlsInspectionConfiguration(
            tlsInspectionConfiguration: TLSInspectionConfigurationProperty
        ) {
            cdkBuilder.tlsInspectionConfiguration(
                tlsInspectionConfiguration.let(TLSInspectionConfigurationProperty::unwrap)
            )
        }
        ...
        override fun tlsInspectionConfiguration(
            ...
            tlsInspectionConfiguration(
                TLSInspectionConfigurationProperty(tlsInspectionConfiguration)
            )
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnTLSInspectionConfiguration
        ): software.amazon.awscdk.services.networkfirewall.CfnTLSInspectionConfiguration =
            wrapped.cdkObject
    }
    ...
    public interface TLSInspectionConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param serverCertificateConfigurations Lists the server certificate configurations
             *   that are associated with the TLS configuration.
             */
        ...
        private class BuilderImpl : Builder {
             ...
             *   that are associated with the TLS configuration.
             */
            override fun serverCertificateConfigurations(
                serverCertificateConfigurations: IResolvable
            ) {
                cdkBuilder.serverCertificateConfigurations(
                    serverCertificateConfigurations.let(IResolvable::unwrap)
                )
            }
             ...
             */
            override fun serverCertificateConfigurations(
                serverCertificateConfigurations: List<Any>
            ) {
             ...
             */
            override fun serverCertificateConfigurations(
                vararg serverCertificateConfigurations: Any
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TLSInspectionConfigurationProperty
            ): software.amazon.awscdk.services.networkfirewall.CfnTLSInspectionConfiguration.TLSInspectionConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ServerCertificateProperty {
        ...
        public interface Builder {
            /**
             * @param resourceArn The Amazon Resource Name (ARN) of the AWS Certificate Manager
             *   SSL/TLS server certificate that's used for inbound SSL/TLS inspection.
             */
        ...
        internal constructor(
            ...
            /**
             * The Amazon Resource Name (ARN) of the AWS Certificate Manager SSL/TLS server
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ServerCertificateProperty
            ): software.amazon.awscdk.services.networkfirewall.CfnTLSInspectionConfiguration.ServerCertificateProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CheckCertificateRevocationStatusProperty {
        ...
        public interface Builder {
             ...
             *   determines that the certificate presented by the server in the SSL/TLS connection
             ...
             * * *DROP* - Network Firewall closes the connection and drops subsequent packets for
             *   that connection.
             * * *REJECT* - Network Firewall sends a TCP reject packet back to your client. The
             *   service closes the connection and drops subsequent packets for that connection.
             ...
             *   determines that the certificate presented by the server in the SSL/TLS connection
             *   has an unknown status, or a status that cannot be determined for any other reason,
             *   including when the service is unable to connect to the OCSP and CRL endpoints for
             *   the certificate.
             * * *PASS* - Allow the connection to continue, and pass subsequent packets to the
             *   stateful engine for inspection.
             * * *DROP* - Network Firewall closes the connection and drops subsequent packets for
        ...
        internal constructor(
             ...
             * certificate presented by the server in the SSL/TLS connection has a revoked status.
             * * *PASS* - Allow the connection to continue, and pass subsequent packets to the
             *   stateful engine for inspection.
             * * *DROP* - Network Firewall closes the connection and drops subsequent packets for
             *   that connection.
            ...
            /**
             * Configures how Network Firewall processes traffic when it determines that the
             * certificate presented by the server in the SSL/TLS connection has an unknown status,
             * or a status that cannot be determined for any other reason, including when the
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CheckCertificateRevocationStatusProperty
            ): software.amazon.awscdk.services.networkfirewall.CfnTLSInspectionConfiguration.CheckCertificateRevocationStatusProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ServerCertificateScopeProperty {
        ...
        public interface Builder {
            /**
             * @param destinationPorts The destination ports to decrypt for inspection, in
             *   Transmission Control Protocol (TCP) format. If not specified, this matches with any
             *   destination port.
             *
             ...
             *   inspection, in CIDR notation. If not specified, this matches with any destination
             *   address.
             */
            ...
            /**
             * @param protocols The protocols to decrypt for inspection, specified using each
             *   protocol's assigned internet protocol number (IANA). Network Firewall currently
             *   supports only TCP.
             */
            ...
            /**
             * @param sourcePorts The source ports to decrypt for inspection, in Transmission
             *   Control Protocol (TCP) format. If not specified, this matches with any source port.
             *
             * You can specify individual ports, for example `1994` , and you can specify port
             * ranges, such as `1990:1994` .
             */
            ...
            /**
             * @param sources The source IP addresses and address ranges to decrypt for inspection,
             *   in CIDR notation. If not specified, this matches with any source address.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ServerCertificateScopeProperty
            ): software.amazon.awscdk.services.networkfirewall.CfnTLSInspectionConfiguration.ServerCertificateScopeProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ServerCertificateConfigurationProperty {
         ...
         * in the SSL/TLS connection has a revoked or unkown status.
         *
         * If the certificate has an unknown or revoked status, you must specify the actions that
         * Network Firewall takes on outbound traffic. To check the certificate revocation status,
         * you must also specify a `CertificateAuthorityArn` in
        ...
        public interface Builder {
            /**
             * @param certificateAuthorityArn The Amazon Resource Name (ARN) of the imported
             *   certificate authority (CA) certificate within AWS Certificate Manager (ACM) to use
             *   for outbound SSL/TLS inspection. The following limitations apply:
             * * You can use CA certificates that you imported into ACM, but you can't generate CA
             *   certificates with ACM.
             * * You can't use certificates issued by AWS Private Certificate Authority .
             *
            ...
            /**
             * @param checkCertificateRevocationStatus When enabled, Network Firewall checks if the
             *   server certificate presented by the server in the SSL/TLS connection has a revoked
             *   or unkown status. If the certificate has an unknown or revoked status, you must
             *   specify the actions that Network Firewall takes on outbound traffic. To check the
            ...
            public fun checkCertificateRevocationStatus(
                checkCertificateRevocationStatus:
                    CheckCertificateRevocationStatusProperty.Builder.() -> Unit
            )
        ...
        private class BuilderImpl : Builder {
             ...
             *   .
             */
            override fun checkCertificateRevocationStatus(
                checkCertificateRevocationStatus: IResolvable
            ) {
                cdkBuilder.checkCertificateRevocationStatus(
                    checkCertificateRevocationStatus.let(IResolvable::unwrap)
                )
            }
            ...
            override fun checkCertificateRevocationStatus(
                ...
                cdkBuilder.checkCertificateRevocationStatus(
                    checkCertificateRevocationStatus.let(
                        CheckCertificateRevocationStatusProperty::unwrap
                    )
                )
            }
            ...
            override fun checkCertificateRevocationStatus(
                ...
                checkCertificateRevocationStatus(
                    CheckCertificateRevocationStatusProperty(checkCertificateRevocationStatus)
                )
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-networkfirewall-tlsinspectionconfiguration-servercertificateconfiguration.html#cfn-networkfirewall-tlsinspectionconfiguration-servercertificateconfiguration-certificateauthorityarn)
             */
            override fun certificateAuthorityArn(): String? =
                unwrap(this).getCertificateAuthorityArn()

            /**
             * When enabled, Network Firewall checks if the server certificate presented by the
             * server in the SSL/TLS connection has a revoked or unkown status.
             *
             * If the certificate has an unknown or revoked status, you must specify the actions
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ServerCertificateConfigurationProperty
            ): software.amazon.awscdk.services.networkfirewall.CfnTLSInspectionConfiguration.ServerCertificateConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
