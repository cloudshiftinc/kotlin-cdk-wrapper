...
internal constructor(
    ...
    public interface Builder {
         ...
         * The operating system that your game server binaries run on.
         *
         * This value determines the type of fleet resources that you use for this build. If your
         * game build contains multiple executables, they all must run on the same operating system.
         * You must specify a valid operating system in this request. There is no default value. You
         ...
         * continue to create new builds using this OS until October 10, 2023, when Microsoft ends
         * its support. All others must use Windows Server 2016 when creating new Windows-based
         * builds.
         *
         ...
         *
         * @param serverSdkVersion A server SDK version you used when integrating your game server
         *   build with Amazon GameLift.
         */
         ...
         * Information indicating where your game build files are stored.
         *
         * Use this parameter only when creating a build with files stored in an Amazon S3 bucket
         * that you own. The storage location must specify an Amazon S3 bucket name and key. The
         * location must also specify a role ARN that you set up to allow Amazon GameLift to access
    ...
    private class BuilderImpl(
        ...
        override fun storageLocation(
            storageLocation: StorageLocationProperty.Builder.() -> Unit
        ): Unit = storageLocation(StorageLocationProperty(storageLocation))
    ...
    public interface StorageLocationProperty {
        ...
        public interface Builder {
             ...
             *
             * Amazon GameLift doesn't support uploading from Amazon S3 buckets with names that
             * contain a dot (.).
             */
             ...
             *   feature is turned on for the S3 bucket. Use this parameter to specify a specific
             *   version. If this parameter isn't set, Amazon GameLift retrieves the latest version
             *   of the file.
             */
            public fun objectVersion(objectVersion: String)

            /**
             * @param roleArn The ARNfor an IAM role that allows Amazon GameLift to access the S3
             *   bucket.
             */
        ...
        internal constructor(
            ...
            /**
             * A version of a stored file to retrieve, if the object versioning feature is turned on
             * for the S3 bucket.
             *
             * Use this parameter to specify a specific version. If this parameter isn't set, Amazon
             * GameLift retrieves the latest version of the file.
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: StorageLocationProperty
            ): software.amazon.awscdk.services.gamelift.CfnBuild.StorageLocationProperty =
