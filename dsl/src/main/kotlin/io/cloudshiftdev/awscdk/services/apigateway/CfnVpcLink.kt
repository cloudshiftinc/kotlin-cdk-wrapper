...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param targetArns The ARN of the network load balancer of the VPC targeted by the VPC
         *   link.
         */
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.apigateway.CfnVpcLink =
            cdkBuilder.build()
    }
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnVpcLink
        ): software.amazon.awscdk.services.apigateway.CfnVpcLink = wrapped.cdkObject
    }
}
