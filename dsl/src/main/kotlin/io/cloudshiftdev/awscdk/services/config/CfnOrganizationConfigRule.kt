...
internal constructor(
    ...
    public open fun excludedAccounts(): List<String> =
        unwrap(this).getExcludedAccounts() ?: emptyList()
    ...
    /** An object that specifies metadata for your organization's AWS Config Custom Policy rule. */
    public open fun organizationCustomPolicyRuleMetadata(
        `value`: OrganizationCustomPolicyRuleMetadataProperty
    ) {
        unwrap(this)
            .setOrganizationCustomPolicyRuleMetadata(
                `value`.let(OrganizationCustomPolicyRuleMetadataProperty::unwrap)
            )
    }
    ...
    public open fun organizationCustomPolicyRuleMetadata(
        `value`: OrganizationCustomPolicyRuleMetadataProperty.Builder.() -> Unit
    ): Unit =
    ...
    /** An `OrganizationCustomRuleMetadata` object. */
    public open fun organizationCustomRuleMetadata(
        `value`: OrganizationCustomRuleMetadataProperty
    ) {
        unwrap(this)
            .setOrganizationCustomRuleMetadata(
                `value`.let(OrganizationCustomRuleMetadataProperty::unwrap)
            )
    }
    ...
    public open fun organizationCustomRuleMetadata(
        `value`: OrganizationCustomRuleMetadataProperty.Builder.() -> Unit
    ...
    /** An `OrganizationManagedRuleMetadata` object. */
    public open fun organizationManagedRuleMetadata(
        `value`: OrganizationManagedRuleMetadataProperty
    ) {
        unwrap(this)
            .setOrganizationManagedRuleMetadata(
                `value`.let(OrganizationManagedRuleMetadataProperty::unwrap)
            )
    }
    ...
    public open fun organizationManagedRuleMetadata(
        `value`: OrganizationManagedRuleMetadataProperty.Builder.() -> Unit
    ...
    public interface Builder {
         ...
         *
         * @param organizationConfigRuleName The name that you assign to organization AWS Config
         *   rule.
         */
         ...
         * enabled, and other custom rule metadata, such as resource type, resource ID of AWS
         * resource, and organization trigger types that initiate AWS Config to evaluate AWS
        ...
        public fun organizationCustomPolicyRuleMetadata(
            organizationCustomPolicyRuleMetadata:
                OrganizationCustomPolicyRuleMetadataProperty.Builder.() -> Unit
        )
        ...
        public fun organizationCustomRuleMetadata(
            organizationCustomRuleMetadata:
                OrganizationCustomRuleMetadataProperty.Builder.() -> Unit
        )
        ...
        public fun organizationManagedRuleMetadata(
            organizationManagedRuleMetadata:
                OrganizationManagedRuleMetadataProperty.Builder.() -> Unit
        )
    }
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.config.CfnOrganizationConfigRule.Builder.create(
                scope,
                id
            )
         ...
         *   organization's AWS Config Custom Policy rule.
         */
        override fun organizationCustomPolicyRuleMetadata(
            organizationCustomPolicyRuleMetadata: IResolvable
        ) {
            cdkBuilder.organizationCustomPolicyRuleMetadata(
                organizationCustomPolicyRuleMetadata.let(IResolvable::unwrap)
            )
        }
        ...
        override fun organizationCustomPolicyRuleMetadata(
            ...
            cdkBuilder.organizationCustomPolicyRuleMetadata(
                organizationCustomPolicyRuleMetadata.let(
                    OrganizationCustomPolicyRuleMetadataProperty::unwrap
                )
            )
        }
        ...
        override fun organizationCustomPolicyRuleMetadata(
            ...
            organizationCustomPolicyRuleMetadata(
                OrganizationCustomPolicyRuleMetadataProperty(organizationCustomPolicyRuleMetadata)
            )
        ...
        override fun organizationCustomRuleMetadata(organizationCustomRuleMetadata: IResolvable) {
            cdkBuilder.organizationCustomRuleMetadata(
                organizationCustomRuleMetadata.let(IResolvable::unwrap)
            )
        }
         ...
         * @param organizationCustomRuleMetadata An `OrganizationCustomRuleMetadata` object.
         */
        override fun organizationCustomRuleMetadata(
            organizationCustomRuleMetadata: OrganizationCustomRuleMetadataProperty
        ) {
            cdkBuilder.organizationCustomRuleMetadata(
                organizationCustomRuleMetadata.let(OrganizationCustomRuleMetadataProperty::unwrap)
            )
        }
        ...
        override fun organizationCustomRuleMetadata(
            ...
            organizationCustomRuleMetadata(
                OrganizationCustomRuleMetadataProperty(organizationCustomRuleMetadata)
            )
        ...
        override fun organizationManagedRuleMetadata(organizationManagedRuleMetadata: IResolvable) {
            cdkBuilder.organizationManagedRuleMetadata(
                organizationManagedRuleMetadata.let(IResolvable::unwrap)
            )
        }
         ...
         * @param organizationManagedRuleMetadata An `OrganizationManagedRuleMetadata` object.
         */
        override fun organizationManagedRuleMetadata(
            organizationManagedRuleMetadata: OrganizationManagedRuleMetadataProperty
        ) {
            cdkBuilder.organizationManagedRuleMetadata(
                organizationManagedRuleMetadata.let(OrganizationManagedRuleMetadataProperty::unwrap)
            )
        }
        ...
        override fun organizationManagedRuleMetadata(
            ...
            organizationManagedRuleMetadata(
                OrganizationManagedRuleMetadataProperty(organizationManagedRuleMetadata)
            )
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnOrganizationConfigRule
    ...
    public interface OrganizationCustomRuleMetadataProperty {
         ...
         */
        public fun maximumExecutionFrequency(): String? =
         ...
         *   delivers an oversized configuration item. AWS Config may generate this notification
         ...
         */
        public fun resourceTypesScope(): List<String> =
            unwrap(this).getResourceTypesScope() ?: emptyList()
        ...
        public interface Builder {
            /**
             * @param description The description that you provide for your organization AWS Config
             *   rule.
             */
            public fun description(description: String)

            /**
             * @param inputParameters A string, in JSON format, that is passed to your organization
             *   AWS Config rule Lambda function.
             */
             ...
             *   evaluations for a rule. Your custom rule is triggered when AWS Config delivers the
            ...
            /**
             * @param organizationConfigRuleTriggerTypes The type of notification that triggers AWS
             *   Config to run an evaluation for a rule. You can specify the following notification
             *   types:
            ...
            /**
             * @param tagKeyScope One part of a key-value pair that make up a tag. A key is a
             *   general label that acts like a category for more specific tag values.
             */
            public fun tagKeyScope(tagKeyScope: String)

            /**
             * @param tagValueScope The optional part of a key-value pair that make up a tag. A
        ...
        private class BuilderImpl : Builder {
             ...
             *   for `MaximumExecutionFrequency` .
             */
            override fun organizationConfigRuleTriggerTypes(
                organizationConfigRuleTriggerTypes: List<String>
            ) {
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-config-organizationconfigrule-organizationcustomrulemetadata.html#cfn-config-organizationconfigrule-organizationcustomrulemetadata-resourcetypesscope)
             */
            override fun resourceTypesScope(): List<String> =
                unwrap(this).getResourceTypesScope() ?: emptyList()
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: OrganizationCustomRuleMetadataProperty
            ): software.amazon.awscdk.services.config.CfnOrganizationConfigRule.OrganizationCustomRuleMetadataProperty =
    ...
    public interface OrganizationCustomPolicyRuleMetadataProperty {
         ...
         */
        public fun debugLogDeliveryAccounts(): List<String> =
         ...
         * The maximum frequency with which AWS Config runs evaluations for a rule.
         *
         * Your AWS Config Custom Policy rule is triggered when AWS Config delivers the
         ...
         * types:
         * * `ConfigurationItemChangeNotification` - Initiates an evaluation when AWS Config
         *   delivers a configuration item as a result of a resource change.
         * * `OversizedConfigurationItemChangeNotification` - Initiates an evaluation when AWS
         *   Config delivers an oversized configuration item. AWS Config may generate this
         ...
         * AWS Config Custom Policy rules. For more information about Guard, see the
        ...
        public interface Builder {
            /**
             * @param debugLogDeliveryAccounts A list of accounts that you can enable debug logging
             *   for your organization AWS Config Custom Policy rule. List is null when debug
            ...
            /**
             * @param maximumExecutionFrequency The maximum frequency with which AWS Config runs
             *   evaluations for a rule. Your AWS Config Custom Policy rule is triggered when AWS
             ...
             *   Config to run an evaluation for a rule. For AWS Config Custom Policy rules, AWS
            ...
            /**
             * @param policyText The policy definition containing the logic for your organization
             *   AWS Config Custom Policy rule.
             */
            ...
            /**
             * @param runtime The runtime system for your organization AWS Config Custom Policy
             *   rules. Guard is a policy-as-code language that allows you to write policies that
             *   are enforced by AWS Config Custom Policy rules. For more information about Guard,
             *   see the
             *   [Guard GitHub Repository](https://docs.aws.amazon.com/https://github.com/aws-cloudformation/cloudformation-guard)
             *   .
             */
        ...
        internal constructor(
            ...
            /**
             * A string, in JSON format, that is passed to your organization AWS Config Custom
             * Policy rule.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-config-organizationconfigrule-organizationcustompolicyrulemetadata.html#cfn-config-organizationconfigrule-organizationcustompolicyrulemetadata-inputparameters)
             */
            ...
            /**
             * The policy definition containing the logic for your organization AWS Config Custom
             * Policy rule.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-config-organizationconfigrule-organizationcustompolicyrulemetadata.html#cfn-config-organizationconfigrule-organizationcustompolicyrulemetadata-policytext)
             */
             ...
             * The runtime system for your organization AWS Config Custom Policy rules.
             *
             * Guard is a policy-as-code language that allows you to write policies that are
             * enforced by AWS Config Custom Policy rules. For more information about Guard, see the
             * [Guard GitHub Repository](https://docs.aws.amazon.com/https://github.com/aws-cloudformation/cloudformation-guard)
             * .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-config-organizationconfigrule-organizationcustompolicyrulemetadata.html#cfn-config-organizationconfigrule-organizationcustompolicyrulemetadata-runtime)
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: OrganizationCustomPolicyRuleMetadataProperty
            ): software.amazon.awscdk.services.config.CfnOrganizationConfigRule.OrganizationCustomPolicyRuleMetadataProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface OrganizationManagedRuleMetadataProperty {
         ...
         * [Using AWS Config managed rules](https://docs.aws.amazon.com/config/latest/developerguide/evaluate-config_use-managed-rules.html)
         * .
         *
        ...
        public interface Builder {
            ...
            /**
             * @param maximumExecutionFrequency The maximum frequency with which AWS Config runs
             *   evaluations for a rule. This is for an AWS Config managed rule that is triggered at
            ...
            /**
             * @param ruleIdentifier For organization config managed rules, a predefined identifier
             *   from a list. For example, `IAM_PASSWORD_POLICY` is a managed rule. To reference a
             *   managed rule, see
             *   [Using AWS Config managed rules](https://docs.aws.amazon.com/config/latest/developerguide/evaluate-config_use-managed-rules.html)
             *   .
             */
        ...
        internal constructor(
             ...
             * For organization config managed rules, a predefined identifier from a list.
             *
             * For example, `IAM_PASSWORD_POLICY` is a managed rule. To reference a managed rule,
             * see
             * [Using AWS Config managed rules](https://docs.aws.amazon.com/config/latest/developerguide/evaluate-config_use-managed-rules.html)
             * .
             *
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: OrganizationManagedRuleMetadataProperty
            ): software.amazon.awscdk.services.config.CfnOrganizationConfigRule.OrganizationManagedRuleMetadataProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
