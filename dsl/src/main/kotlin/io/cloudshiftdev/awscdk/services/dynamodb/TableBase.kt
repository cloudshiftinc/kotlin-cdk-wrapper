...
internal constructor(
     ...
     *
     * If `encryptionKey` is present, appropriate grants to the key needs to be added separately
     * using the `table.encryptionKey.grant*` methods.
     *
     ...
     *
     * BatchGetItem, GetRecords, GetShardIterator, Query, GetItem, Scan, BatchWriteItem, PutItem,
     ...
     *
     * By default, the metric will be calculated as a sum over a period of 5 minutes. You can
    ...
    public override fun metricConditionalCheckFailedRequests(props: MetricOptions): Metric =
        unwrap(this)
            .metricConditionalCheckFailedRequests(props.let(MetricOptions::unwrap))
            .let(Metric::wrap)
    ...
    public override fun metricConditionalCheckFailedRequests(
        props: MetricOptions.Builder.() -> Unit
    ...
    public override fun metricConsumedReadCapacityUnits(props: MetricOptions): Metric =
        unwrap(this)
            .metricConsumedReadCapacityUnits(props.let(MetricOptions::unwrap))
            .let(Metric::wrap)
    ...
    public override fun metricConsumedReadCapacityUnits(
        props: MetricOptions.Builder.() -> Unit
    ...
    public override fun metricConsumedWriteCapacityUnits(props: MetricOptions): Metric =
        unwrap(this)
            .metricConsumedWriteCapacityUnits(props.let(MetricOptions::unwrap))
            .let(Metric::wrap)
    ...
    public override fun metricConsumedWriteCapacityUnits(
        props: MetricOptions.Builder.() -> Unit
    ...
    public override fun metricSuccessfulRequestLatency(props: MetricOptions): Metric =
        unwrap(this)
            .metricSuccessfulRequestLatency(props.let(MetricOptions::unwrap))
            .let(Metric::wrap)
    ...
    public override fun metricSuccessfulRequestLatency(
        props: MetricOptions.Builder.() -> Unit
    ...
    public open fun metricSystemErrors(): Metric =
        unwrap(this).metricSystemErrors().let(Metric::wrap)
     ...
     *
     * This will sum errors across all possible operations. Note that by default, each individual
     * metric will be calculated as a sum over a period of 5 minutes. You can customize this by
     * using the `statistic` and `period` properties.
     *
     * @param props
     */
     ...
     * @param props
     */
    public override fun metricSystemErrorsForOperations(
        props: SystemErrorsForOperationsMetricOptions
    ): IMetric =
        unwrap(this)
            .metricSystemErrorsForOperations(
                props.let(SystemErrorsForOperationsMetricOptions::unwrap)
            )
            .let(IMetric::wrap)
    ...
    public override fun metricSystemErrorsForOperations(
        props: SystemErrorsForOperationsMetricOptions.Builder.() -> Unit
     ...
     * @param props
     */
    public open fun metricThrottledRequestsForOperation(
        operation: String,
        props: MetricOptions
    ): Metric =
        unwrap(this)
            .metricThrottledRequestsForOperation(operation, props.let(MetricOptions::unwrap))
            .let(Metric::wrap)
    ...
    public open fun metricThrottledRequestsForOperation(
        operation: String,
        props: MetricOptions.Builder.() -> Unit
    ): Metric = metricThrottledRequestsForOperation(operation, MetricOptions(props))
     ...
     * @param props
     */
    public override fun metricThrottledRequestsForOperations(
        props: OperationsMetricOptions
    ): IMetric =
        unwrap(this)
            .metricThrottledRequestsForOperations(props.let(OperationsMetricOptions::unwrap))
            .let(IMetric::wrap)
    ...
    public override fun metricThrottledRequestsForOperations(
        props: OperationsMetricOptions.Builder.() -> Unit
    ...
    public companion object {
        ...
        ): TableBase = Wrapper(cdkObject)

        internal fun unwrap(
            wrapped: TableBase
        ): software.amazon.awscdk.services.dynamodb.TableBase = (wrapped as Wrapper).cdkObject
    }
}
