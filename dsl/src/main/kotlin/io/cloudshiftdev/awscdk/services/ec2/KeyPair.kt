...
internal constructor(
     ...
     *
     * Keys with imported material do not have their private key material stored or returned
     * automatically.
     */
    ...
    public interface Builder {
         ...
         *
         * The ARN is parsed and the account and region are taken from the ARN. This should be used
         * for imported resources.
         *
         * Cannot be supplied together with either `account` or `region`.
         *
         * Default: - take environment from `account`, `region` parameters, or use Stack
         * environment.
         *
         ...
         * * `PhysicalName.GENERATE_IF_NEEDED` is a marker that indicates that a physical will only
         *   be generated by the CDK if it is needed for cross-environment references. Otherwise, it
         *   will be allocated by CloudFormation.
         *
         * Default: - The physical name will be allocated by CloudFormation at deployment time
         *
         * @param physicalName The value passed in by users to the physical name prop of the
         *   resource.
         */
         ...
         *
         * If this is provided the key is considered "imported". For imported keys, it is assumed
         * that you already have the private key material so the private key material will not be
         * returned or stored in AWS Systems Manager Parameter Store.
         *
    ...
    public companion object {
        public fun fromKeyPairAttributes(
            ...
            software.amazon.awscdk.services.ec2.KeyPair.fromKeyPairAttributes(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    attrs.let(KeyPairAttributes::unwrap)
                )
                .let(IKeyPair::wrap)
        ...
        public fun fromKeyPairName(
            ...
            software.amazon.awscdk.services.ec2.KeyPair.fromKeyPairName(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    keyPairName
                )
