...
internal constructor(
    ...
    public open fun onDemandOptions(
        `value`: OnDemandOptionsRequestProperty.Builder.() -> Unit
    ): Unit = onDemandOptions(OnDemandOptionsRequestProperty(`value`))
    ...
    public open fun targetCapacitySpecification(): Any =
        unwrap(this).getTargetCapacitySpecification()
    ...
    /** The number of units to request. */
    public open fun targetCapacitySpecification(
        `value`: TargetCapacitySpecificationRequestProperty
    ) {
        unwrap(this)
            .setTargetCapacitySpecification(
                `value`.let(TargetCapacitySpecificationRequestProperty::unwrap)
            )
    }
    ...
    public open fun targetCapacitySpecification(
        `value`: TargetCapacitySpecificationRequestProperty.Builder.() -> Unit
    ...
    public interface Builder {
         ...
         *
         * @param onDemandOptions Describes the configuration of On-Demand Instances in an EC2
         *   Fleet.
         */
        ...
        public fun onDemandOptions(
            onDemandOptions: OnDemandOptionsRequestProperty.Builder.() -> Unit
        )
         ...
         *
         * @param replaceUnhealthyInstances Indicates whether EC2 Fleet should replace unhealthy
         *   Spot Instances.
         */
         ...
         *
         * @param tagSpecifications The key-value pair for tagging the EC2 Fleet request on
         ...
         * @param targetCapacitySpecification The number of units to request.
         */
        public fun targetCapacitySpecification(
        ...
        public fun targetCapacitySpecification(
            targetCapacitySpecification:
                TargetCapacitySpecificationRequestProperty.Builder.() -> Unit
        )
        ...
        /**
         * The end date and time of the request, in UTC format (for example, *YYYY* - *MM* - *DD* T
         * *HH* : *MM* : *SS* Z).
         *
    ...
    private class BuilderImpl(
        ...
        override fun targetCapacitySpecification(targetCapacitySpecification: IResolvable) {
            cdkBuilder.targetCapacitySpecification(
                targetCapacitySpecification.let(IResolvable::unwrap)
            )
        }
         ...
         * @param targetCapacitySpecification The number of units to request.
         */
        override fun targetCapacitySpecification(
            targetCapacitySpecification: TargetCapacitySpecificationRequestProperty
        ) {
            cdkBuilder.targetCapacitySpecification(
                targetCapacitySpecification.let(TargetCapacitySpecificationRequestProperty::unwrap)
            )
        }
        ...
        override fun targetCapacitySpecification(
            ...
            targetCapacitySpecification(
                TargetCapacitySpecificationRequestProperty(targetCapacitySpecification)
            )
    ...
    public interface TargetCapacitySpecificationRequestProperty {
         ...
         */
        public fun defaultTargetCapacityType(): String? =
        ...
        public interface Builder {
             ...
             *   parameter only when using attributed-based instance type selection. Default:
             *   `units` (the number of instances)
             */
            public fun targetCapacityUnitType(targetCapacityUnitType: String)

            /**
             * @param totalTargetCapacity The number of units to request, filled using the default
             *   target capacity type.
             */
        ...
        private class BuilderImpl : Builder {
            private val cdkBuilder:
                ...
                software.amazon.awscdk.services.ec2.CfnEC2Fleet
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TargetCapacitySpecificationRequestProperty
            ): software.amazon.awscdk.services.ec2.CfnEC2Fleet.TargetCapacitySpecificationRequestProperty =
    ...
    public interface FleetLaunchTemplateOverridesRequestProperty {
         ...
         * `price-capacity-optimized` allocation strategies is per *unit* hour (where the instance
         * price is divided by the specified weight). However, if all the specified weights are
         * above the requested `TargetCapacity` , resulting in only 1 instance being launched, the
        ...
        public interface Builder {
            ...
            /**
             * @param instanceType The instance type. `mac1.metal` is not supported as a launch
             *   template override.
             *
             * If you specify `InstanceType` , you can't specify `InstanceRequirements` .
             */
            ...
            /**
             * @param maxPrice The maximum price per unit hour that you are willing to pay for a
             ...
             *   is launched first. If the On-Demand `AllocationStrategy` is set to `prioritized` ,
            ...
            /**
             * @param subnetId The IDs of the subnets in which to launch the instances. Separate
             *   multiple subnet IDs using commas (for example, `subnet-1234abcdeexample1,
             ...
             * instance price is divided by the specified weight). However, if all the specified
             * weights are above the requested `TargetCapacity` , resulting in only 1 instance being
             * launched, the price used is per *instance* hour.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: FleetLaunchTemplateOverridesRequestProperty
            ): software.amazon.awscdk.services.ec2.CfnEC2Fleet.FleetLaunchTemplateOverridesRequestProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SpotOptionsRequestProperty {
         ...
         *
         * If the allocation strategy is `capacityOptimized` , EC2 Fleet launches instances from
         * Spot Instance pools that are optimally chosen based on the available Spot Instance
         * capacity.
         *
         ...
         * your target capacity, EC2 Fleet will continue to fulfill your request by drawing from the
         * next cheapest pool. To ensure that your target capacity is met, you might receive Spot
         * Instances from more than the number of pools that you specified. Similarly, if most of
         * the pools have no Spot capacity, you might receive your full target capacity from fewer
         ...
         * than if you do not specify this parameter. &gt; If your fleet includes T instances that
         * are configured as `unlimited` , and if their average CPU usage exceeds the baseline
         * utilization, you will incur a charge for surplus credits. The `MaxTotalPrice` does not
         * account for surplus credits, and, if you use surplus credits, your final cost might be
         * higher than what you specified for `MaxTotalPrice` . For more information, see
        ...
        public interface Builder {
             ...
             *   across the Spot Instance pools specified by the EC2 Fleet. If the allocation
             *   strategy is `lowestPrice` , EC2 Fleet launches instances from the Spot Instance
             ...
             *   target Spot capacity. Supported only when Spot `AllocationStrategy` is set to
            ...
            /**
             * @param maintenanceStrategies The strategies for managing your Spot Instances that are
            ...
            public fun maintenanceStrategies(
                maintenanceStrategies: MaintenanceStrategiesProperty.Builder.() -> Unit
            )

            /**
             * @param maxTotalPrice The maximum amount per hour for Spot Instances that you're
             *   willing to pay. We do not recommend using this parameter because it can lead to
             *   increased interruptions. If you do not specify this parameter, you will pay the
             *   current Spot price.
             *
             * If you specify a maximum price, your Spot Instances will be interrupted more
             * frequently than if you do not specify this parameter. &gt; If your fleet includes T
             * instances that are configured as `unlimited` , and if their average CPU usage exceeds
             * the baseline utilization, you will incur a charge for surplus credits. The
             * `MaxTotalPrice` does not account for surplus credits, and, if you use surplus
             * credits, your final cost might be higher than what you specified for `MaxTotalPrice`
             * . For more information, see
             * [Surplus credits can incur charges](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/burstable-performance-instances-unlimited-mode-concepts.html#unlimited-mode-surplus-credits)
             * in the *EC2 User Guide* .
             */
            ...
            /**
             * @param singleAvailabilityZone Indicates that the fleet launches all Spot Instances
             *   into a single Availability Zone. Supported only for fleets of type `instant` .
             */
            ...
            /**
             * @param singleInstanceType Indicates that the fleet uses a single instance type to
             *   launch all Spot Instances in the fleet. Supported only for fleets of type `instant`
             *   .
             */
        ...
        private class BuilderImpl : Builder {
             ...
             *   at an elevated risk of being interrupted.
             */
            override fun maintenanceStrategies(
                maintenanceStrategies: MaintenanceStrategiesProperty
            ) {
                cdkBuilder.maintenanceStrategies(
                    maintenanceStrategies.let(MaintenanceStrategiesProperty::unwrap)
                )
            }
        ...
        internal constructor(
             ...
             * pools specified by the EC2 Fleet.
             *
             * If the allocation strategy is `lowestPrice` , EC2 Fleet launches instances from the
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SpotOptionsRequestProperty
            ): software.amazon.awscdk.services.ec2.CfnEC2Fleet.SpotOptionsRequestProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface MaintenanceStrategiesProperty {
        ...
        public interface Builder {
            /**
             * @param capacityRebalance The strategy to use when Amazon EC2 emits a signal that your
            ...
            public fun capacityRebalance(
                capacityRebalance: CapacityRebalanceProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun capacityRebalance(capacityRebalance: CapacityRebalanceProperty) {
                cdkBuilder.capacityRebalance(
                    capacityRebalance.let(CapacityRebalanceProperty::unwrap)
                )
            }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: MaintenanceStrategiesProperty
            ): software.amazon.awscdk.services.ec2.CfnEC2Fleet.MaintenanceStrategiesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CapacityRebalanceProperty {
         ...
         *
         * `launch` - EC2 Fleet launches a replacement Spot Instance when a rebalance notification
         * is emitted for an existing Spot Instance in the fleet. EC2 Fleet does not terminate the
         * instances that receive a rebalance notification. You can terminate the old instances, or
        ...
        public interface Builder {
             ...
             *   of type `maintain` . `launch` - EC2 Fleet launches a replacement Spot Instance when
             *   a rebalance notification is emitted for an existing Spot Instance in the fleet. EC2
             ...
             *
             * `launch-before-terminate` - EC2 Fleet launches a replacement Spot Instance when a
             * rebalance notification is emitted for an existing Spot Instance in the fleet, and
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CapacityRebalanceProperty
            ): software.amazon.awscdk.services.ec2.CfnEC2Fleet.CapacityRebalanceProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface PlacementProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param availabilityZone The Availability Zone of the instance. If not specified, an
             *   Availability Zone will be automatically chosen for you based on the load balancing
            ...
            /**
             * @param groupName The name of the placement group that the instance is in. If you
             *   specify `GroupName` , you can't specify `GroupId` .
             */
            public fun groupName(groupName: String)

            /**
             * @param hostId The ID of the Dedicated Host on which the instance resides. This
             *   parameter is not supported for
             *   [CreateFleet](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_CreateFleet)
             *   or
             *   [ImportInstance](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_ImportInstance.html)
             ...
             *   instances. If you specify this parameter, either omit the *Tenancy* parameter or
             *   set it to `host` .
             *
             * This parameter is not supported for
             * [CreateFleet](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_CreateFleet)
            ...
            /**
             * @param partitionNumber The number of the partition that the instance is in. Valid
    ...
    public interface OnDemandOptionsRequestProperty {
         ...
         * credits. The `MaxTotalPrice` does not account for surplus credits, and, if you use
         * surplus credits, your final cost might be higher than what you specified for
         * `MaxTotalPrice` . For more information, see
         * [Surplus credits can incur charges](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/burstable-performance-instances-unlimited-mode-concepts.html#unlimited-mode-surplus-credits)
         * in the *EC2 User Guide* .
         *
        ...
        public interface Builder {
            /**
             * @param allocationStrategy The strategy that determines the order of the launch
             *   template overrides to use in fulfilling On-Demand capacity. `lowest-price` - EC2
            ...
            /**
             * @param capacityReservationOptions The strategy for using unused Capacity Reservations
             *   for fulfilling On-Demand capacity. Supported only for fleets of type `instant` .
             */
            ...
            public fun capacityReservationOptions(
                capacityReservationOptions:
                    CapacityReservationOptionsRequestProperty.Builder.() -> Unit
            )
             ...
             * surplus credits. The `MaxTotalPrice` does not account for surplus credits, and, if
             * you use surplus credits, your final cost might be higher than what you specified for
             * `MaxTotalPrice` . For more information, see
             * [Surplus credits can incur charges](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/burstable-performance-instances-unlimited-mode-concepts.html#unlimited-mode-surplus-credits)
             * in the *EC2 User Guide* .
             */
            ...
            /**
             * @param minTargetCapacity The minimum target capacity for On-Demand Instances in the
             *   fleet. If the minimum target capacity is not reached, the fleet launches no
             *   instances.
             *
             * Supported only for fleets of type `instant` .
             *
            ...
            /**
             * @param singleAvailabilityZone Indicates that the fleet launches all On-Demand
             *   Instances into a single Availability Zone. Supported only for fleets of type
             *   `instant` .
             */
            public fun singleAvailabilityZone(singleAvailabilityZone: Boolean)
            ...
            /**
             * @param singleInstanceType Indicates that the fleet uses a single instance type to
             *   launch all On-Demand Instances in the fleet. Supported only for fleets of type
             *   `instant` .
             */
            public fun singleInstanceType(singleInstanceType: Boolean)
        ...
        private class BuilderImpl : Builder {
            ...
            override fun capacityReservationOptions(capacityReservationOptions: IResolvable) {
                cdkBuilder.capacityReservationOptions(
                    capacityReservationOptions.let(IResolvable::unwrap)
                )
            }
             ...
             *   for fulfilling On-Demand capacity. Supported only for fleets of type `instant` .
             */
            override fun capacityReservationOptions(
                capacityReservationOptions: CapacityReservationOptionsRequestProperty
            ) {
                cdkBuilder.capacityReservationOptions(
                    capacityReservationOptions.let(
                        CapacityReservationOptionsRequestProperty::unwrap
                    )
                )
            }
            ...
            override fun capacityReservationOptions(
                ...
                capacityReservationOptions(
                    CapacityReservationOptionsRequestProperty(capacityReservationOptions)
                )
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ec2-ec2fleet-ondemandoptionsrequest.html#cfn-ec2-ec2fleet-ondemandoptionsrequest-capacityreservationoptions)
             */
            override fun capacityReservationOptions(): Any? =
                unwrap(this).getCapacityReservationOptions()
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: OnDemandOptionsRequestProperty
            ): software.amazon.awscdk.services.ec2.CfnEC2Fleet.OnDemandOptionsRequestProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface FleetLaunchTemplateSpecificationRequestProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param version The launch template version number, `$Latest` , or `$Default` . You
             *   must specify a value, otherwise the request fails. If the value is `$Latest` ,
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: FleetLaunchTemplateSpecificationRequestProperty
            ): software.amazon.awscdk.services.ec2.CfnEC2Fleet.FleetLaunchTemplateSpecificationRequestProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CapacityReservationOptionsRequestProperty {
         ...
         * strategy ( `lowest-price` or `prioritized` ) is applied. If the number of unused Capacity
         * Reservations is less than the On-Demand target capacity, the remaining On-Demand target
         * capacity is launched according to the On-Demand allocation strategy ( `lowest-price` or
         * `prioritized` ).
         *
        ...
        public interface Builder {
            /**
             * @param usageStrategy Indicates whether to use unused Capacity Reservations for
             *   fulfilling On-Demand capacity. If you specify `use-capacity-reservations-first` ,
             *   the fleet uses unused Capacity Reservations to fulfill On-Demand capacity up to the
             *   target On-Demand capacity. If multiple instance pools have unused Capacity
             ...
             *
             * If you do not specify a value, the fleet fulfils the On-Demand capacity according to
        ...
        internal constructor(
             ...
             * Reservations to fulfill On-Demand capacity up to the target On-Demand capacity. If
             * multiple instance pools have unused Capacity Reservations, the On-Demand allocation
             * strategy ( `lowest-price` or `prioritized` ) is applied. If the number of unused
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CapacityReservationOptionsRequestProperty
            ): software.amazon.awscdk.services.ec2.CfnEC2Fleet.CapacityReservationOptionsRequestProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface FleetLaunchTemplateConfigRequestProperty {
         ...
         *
         * For fleets of type `request` and `maintain` , a maximum of 300 items is allowed across
        ...
        public interface Builder {
            /**
             * @param launchTemplateSpecification The launch template to use. You must specify
            ...
            public fun launchTemplateSpecification(
                launchTemplateSpecification:
                    FleetLaunchTemplateSpecificationRequestProperty.Builder.() -> Unit
            )

            /**
             * @param overrides Any parameters that you specify override the same parameters in the
             *   launch template. For fleets of type `request` and `maintain` , a maximum of 300
        ...
        private class BuilderImpl : Builder {
            ...
            override fun launchTemplateSpecification(
                ...
                cdkBuilder.launchTemplateSpecification(
                    launchTemplateSpecification.let(
                        FleetLaunchTemplateSpecificationRequestProperty::unwrap
                    )
                )
            }
            ...
            override fun launchTemplateSpecification(
                ...
                launchTemplateSpecification(
                    FleetLaunchTemplateSpecificationRequestProperty(launchTemplateSpecification)
                )
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: FleetLaunchTemplateConfigRequestProperty
            ): software.amazon.awscdk.services.ec2.CfnEC2Fleet.FleetLaunchTemplateConfigRequestProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
