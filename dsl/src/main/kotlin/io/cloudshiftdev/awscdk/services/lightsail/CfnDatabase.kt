...
internal constructor(
    ...
    public interface Builder {
         ...
         * database.
         *
         * Data Import Mode is enabled when `BackupRetention` is set to `false` , and is disabled
         * when `BackupRetention` is set to `true` .
         *
         ...
         * articles for
         * [MySQL 5.6](https://docs.aws.amazon.com/https://dev.mysql.com/doc/refman/5.6/en/keywords.html)
         * ,
         * [MySQL 5.7](https://docs.aws.amazon.com/https://dev.mysql.com/doc/refman/5.7/en/keywords.html)
         * , and
         ...
         * for
         * [PostgreSQL 9.6](https://docs.aws.amazon.com/https://www.postgresql.org/docs/9.6/sql-keywords-appendix.html)
         * ,
         * [PostgreSQL 10](https://docs.aws.amazon.com/https://www.postgresql.org/docs/10/sql-keywords-appendix.html)
         * ,
         * [PostgreSQL 11](https://docs.aws.amazon.com/https://www.postgresql.org/docs/11/sql-keywords-appendix.html)
         * , and
         * [PostgreSQL 12](https://docs.aws.amazon.com/https://www.postgresql.org/docs/12/sql-keywords-appendix.html)
         * .
         *
         ...
         *   created for the database (for example, `16:00-16:30` ).
         */
        public fun preferredBackupWindow(preferredBackupWindow: String)

        /**
         * The weekly time range during which system maintenance can occur for the database,
         * formatted as follows: `ddd:hh24:mi-ddd:hh24:mi` .
         *
         ...
         *   can occur for the database, formatted as follows: `ddd:hh24:mi-ddd:hh24:mi` .
         */
         ...
         *
         * @param publiclyAccessible A Boolean value indicating whether the database is accessible
         ...
         *
         * @param relationalDatabaseBundleId The bundle ID for the database (for example,
         *   `medium_1_0` ).
         */
         ...
         * password generated by Lightsail .
         *
         * The `RotateMasterUserPassword` and `MasterUserPassword` parameters cannot be used
         * together in the same template.
         *
         ...
         *
         * @param rotateMasterUserPassword A Boolean value indicating whether to change the primary
         *   user password to a new, strong password generated by Lightsail .
         */
    ...
    private class BuilderImpl(
        ...
        override fun relationalDatabaseParameters(relationalDatabaseParameters: IResolvable) {
            cdkBuilder.relationalDatabaseParameters(
                relationalDatabaseParameters.let(IResolvable::unwrap)
            )
        }
        ...
        public fun build(): software.amazon.awscdk.services.lightsail.CfnDatabase =
            cdkBuilder.build()
    }
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnDatabase
        ): software.amazon.awscdk.services.lightsail.CfnDatabase = wrapped.cdkObject
    }
    ...
    public interface RelationalDatabaseParameterProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param applyMethod Indicates when parameter updates are applied. Can be `immediate`
             *   or `pending-reboot` .
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RelationalDatabaseParameterProperty
            ): software.amazon.awscdk.services.lightsail.CfnDatabase.RelationalDatabaseParameterProperty =
