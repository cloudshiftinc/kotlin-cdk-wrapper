...
internal constructor(
    ...
    /** Assigns Athena workgroups (and hence their queries) to capacity reservations. */
    public open fun capacityAssignmentConfiguration(
        `value`: CapacityAssignmentConfigurationProperty
    ) {
        unwrap(this)
            .setCapacityAssignmentConfiguration(
                `value`.let(CapacityAssignmentConfigurationProperty::unwrap)
            )
    }
    ...
    public open fun capacityAssignmentConfiguration(
        `value`: CapacityAssignmentConfigurationProperty.Builder.() -> Unit
    ...
    public interface Builder {
         ...
         * Assigns Athena workgroups (and hence their queries) to capacity reservations.
         *
         * A capacity reservation can have only one capacity assignment configuration, but the
         * capacity assignment configuration can be made up of multiple individual assignments. Each
         * assignment specifies how Athena queries can consume capacity from the capacity
         ...
         *
         * @param capacityAssignmentConfiguration Assigns Athena workgroups (and hence their
         *   queries) to capacity reservations.
         */
        ...
        public fun capacityAssignmentConfiguration(
            capacityAssignmentConfiguration:
                CapacityAssignmentConfigurationProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
        ...
        override fun capacityAssignmentConfiguration(capacityAssignmentConfiguration: IResolvable) {
            cdkBuilder.capacityAssignmentConfiguration(
                capacityAssignmentConfiguration.let(IResolvable::unwrap)
            )
        }
        ...
        override fun capacityAssignmentConfiguration(
            ...
            cdkBuilder.capacityAssignmentConfiguration(
                capacityAssignmentConfiguration.let(CapacityAssignmentConfigurationProperty::unwrap)
            )
        }
        ...
        override fun capacityAssignmentConfiguration(
            ...
            capacityAssignmentConfiguration(
                CapacityAssignmentConfigurationProperty(capacityAssignmentConfiguration)
            )
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnCapacityReservation
    ...
    public interface CapacityAssignmentConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param capacityAssignments The list of assignments that make up the capacity
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CapacityAssignmentConfigurationProperty
            ): software.amazon.awscdk.services.athena.CfnCapacityReservation.CapacityAssignmentConfigurationProperty =
    ...
    public interface CapacityAssignmentProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CapacityAssignmentProperty
            ): software.amazon.awscdk.services.athena.CfnCapacityReservation.CapacityAssignmentProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
