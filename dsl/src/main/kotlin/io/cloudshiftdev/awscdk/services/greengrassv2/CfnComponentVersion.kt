...
internal constructor(
    ...
    public open fun lambdaFunction(
        `value`: LambdaFunctionRecipeSourceProperty.Builder.() -> Unit
    ...
    public interface Builder {
         ...
         * The recipe to use to create the component.
         *
         * The recipe defines the component's metadata, parameters, dependencies, lifecycle,
        ...
        public fun lambdaFunction(
            lambdaFunction: LambdaFunctionRecipeSourceProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.greengrassv2.CfnComponentVersion.Builder.create(
                scope,
                id
            )
        ...
        override fun lambdaFunction(lambdaFunction: LambdaFunctionRecipeSourceProperty) {
            cdkBuilder.lambdaFunction(
                lambdaFunction.let(LambdaFunctionRecipeSourceProperty::unwrap)
            )
        }
    ...
    public interface LambdaFunctionRecipeSourceProperty {
         ...
         * The version of the component.
         *
         * Defaults to the version of the Lambda function as a semantic version. For example, if
         * your function version is `3` , the component version becomes `3.0.0` .
         *
        ...
        public interface Builder {
            /**
             * @param componentDependencies The component versions on which this Lambda function
             *   component depends.
             */
            ...
            /**
             * @param componentLambdaParameters The system and runtime parameters for the Lambda
             *   function as it runs on the AWS IoT Greengrass core device.
             */
             ...
             *   function as it runs on the AWS IoT Greengrass core device.
             */
            public fun componentLambdaParameters(
            ...
            public fun componentLambdaParameters(
                componentLambdaParameters: LambdaExecutionParametersProperty.Builder.() -> Unit
            )

            /**
             * @param componentName The name of the component. Defaults to the name of the Lambda
             *   function.
             */
            ...
            /**
             * @param componentVersion The version of the component. Defaults to the version of the
             *   Lambda function as a semantic version. For example, if your function version is `3`
             *   , the component version becomes `3.0.0` .
             */
            public fun componentVersion(componentVersion: String)

            /**
             * @param lambdaArn The ARN of the Lambda function. The ARN must include the version of
        ...
        private class BuilderImpl : Builder {
            ...
            override fun componentLambdaParameters(componentLambdaParameters: IResolvable) {
                cdkBuilder.componentLambdaParameters(
                    componentLambdaParameters.let(IResolvable::unwrap)
                )
            }
             ...
             *   function as it runs on the AWS IoT Greengrass core device.
             */
            override fun componentLambdaParameters(
                componentLambdaParameters: LambdaExecutionParametersProperty
            ) {
                cdkBuilder.componentLambdaParameters(
                    componentLambdaParameters.let(LambdaExecutionParametersProperty::unwrap)
                )
            }
            ...
            override fun componentLambdaParameters(
                ...
                componentLambdaParameters(
                    LambdaExecutionParametersProperty(componentLambdaParameters)
                )
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-greengrassv2-componentversion-lambdafunctionrecipesource.html#cfn-greengrassv2-componentversion-lambdafunctionrecipesource-componentlambdaparameters)
             */
            override fun componentLambdaParameters(): Any? =
             ...
             * The ARN of the Lambda function.
             *
             * The ARN must include the version of the function to import. You can't use version
             * aliases like `$LATEST` .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-greengrassv2-componentversion-lambdafunctionrecipesource.html#cfn-greengrassv2-componentversion-lambdafunctionrecipesource-lambdaarn)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: LambdaFunctionRecipeSourceProperty
            ): software.amazon.awscdk.services.greengrassv2.CfnComponentVersion.LambdaFunctionRecipeSourceProperty =
    ...
    public interface LambdaContainerParamsProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param mountRoSysfs Whether or not the container can read information from the
             *   device's `/sys` folder. Default: `false`
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: LambdaContainerParamsProperty
            ): software.amazon.awscdk.services.greengrassv2.CfnComponentVersion.LambdaContainerParamsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface LambdaDeviceMountProperty {
        ...
        public interface Builder {
            /**
             * @param addGroupOwner Whether or not to add the component's system user as an owner of
            ...
            /**
             * @param permission The permission to access the device: read/only ( `ro` ) or
             *   read/write ( `rw` ). Default: `ro`
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: LambdaDeviceMountProperty
            ): software.amazon.awscdk.services.greengrassv2.CfnComponentVersion.LambdaDeviceMountProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ComponentDependencyRequirementProperty {
        ...
        public interface Builder {
            /**
             * @param dependencyType The type of this dependency. Choose from the following
             *   options:.
             * * `SOFT` – The component doesn't restart if the dependency changes state.
             * * `HARD` – The component restarts if the dependency changes state.
             *
            ...
            /**
             * @param versionRequirement The component version requirement for the component
             *   dependency. AWS IoT Greengrass uses semantic version constraints. For more
             *   information, see
             *   [Semantic Versioning](https://docs.aws.amazon.com/https://semver.org/) .
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ComponentDependencyRequirementProperty
            ): software.amazon.awscdk.services.greengrassv2.CfnComponentVersion.ComponentDependencyRequirementProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ComponentPlatformProperty {
         ...
         * [AWS IoT Greengrass nucleus component](https://docs.aws.amazon.com/greengrass/v2/developerguide/greengrass-nucleus-component.html)
         * in the *AWS IoT Greengrass V2 Developer Guide* .
         *
        ...
        public interface Builder {
            /**
             * @param attributes A dictionary of attributes for the platform. The AWS IoT Greengrass
             *   Core software defines the `os` and `platform` by default. You can specify
             *   additional platform attributes for a core device when you deploy the AWS IoT
             *   Greengrass nucleus component. For more information, see the
             *   [AWS IoT Greengrass nucleus component](https://docs.aws.amazon.com/greengrass/v2/developerguide/greengrass-nucleus-component.html)
             *   in the *AWS IoT Greengrass V2 Developer Guide* .
             */
            ...
            /**
             * @param name The friendly name of the platform. This name helps you identify the
             *   platform. If you omit this parameter, AWS IoT Greengrass creates a friendly name
        ...
        internal constructor(
             ...
             * A dictionary of attributes for the platform.
             *
             * The AWS IoT Greengrass Core software defines the `os` and `platform` by default. You
             * can specify additional platform attributes for a core device when you deploy the AWS
             * IoT Greengrass nucleus component. For more information, see the
             * [AWS IoT Greengrass nucleus component](https://docs.aws.amazon.com/greengrass/v2/developerguide/greengrass-nucleus-component.html)
             * in the *AWS IoT Greengrass V2 Developer Guide* .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-greengrassv2-componentversion-componentplatform.html#cfn-greengrassv2-componentversion-componentplatform-attributes)
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ComponentPlatformProperty
            ): software.amazon.awscdk.services.greengrassv2.CfnComponentVersion.ComponentPlatformProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface LambdaExecutionParametersProperty {
         ...
         *
         * The Lambda function runs when it receives a message from an event source. You can
         ...
         * * A pinned Lambda function starts when the AWS IoT Greengrass Core starts and keeps
         *   running in its own container.
         * * A non-pinned Lambda function starts only when it receives a work item and exists after
         *   it idles for `maxIdleTimeInSeconds` . If the function has multiple work items, the AWS
        ...
        public interface Builder {
            /**
             * @param environmentVariables The map of environment variables that are available to
             *   the Lambda function when it runs.
             */
             ...
             *   messages. The Lambda function runs when it receives a message from an event source.
             *   You can subscribe this function to local publish/subscribe messages and AWS IoT
             *   Core MQTT messages.
             */
            ...
            /**
             * @param linuxProcessParams The parameters for the Linux process that contains the
             *   Lambda function.
             */
            ...
            public fun linuxProcessParams(
                linuxProcessParams: LambdaLinuxProcessParamsProperty.Builder.() -> Unit
            )

            /**
             * @param maxIdleTimeInSeconds The maximum amount of time in seconds that a non-pinned
             *   Lambda function can idle before the AWS IoT Greengrass Core software stops its
             *   process.
             */
            public fun maxIdleTimeInSeconds(maxIdleTimeInSeconds: Number)

            /**
             * @param maxInstancesCount The maximum number of instances that a non-pinned Lambda
             ...
             *   component. The AWS IoT Greengrass core device stores messages in a FIFO
             *   (first-in-first-out) queue until it can run the Lambda function to consume each
             *   message.
             */
             ...
             * * A pinned Lambda function starts when the AWS IoT Greengrass Core starts and keeps
             *   running in its own container.
             * * A non-pinned Lambda function starts only when it receives a work item and exists
             *   after it idles for `maxIdleTimeInSeconds` . If the function has multiple work
             *   items, the AWS IoT Greengrass Core software creates multiple instances of the
             *   function.
             *
             * Default: `true`
             */
            ...
            /**
             * @param statusTimeoutInSeconds The interval in seconds at which a pinned (also known
             *   as long-lived) Lambda function component sends status updates to the Lambda manager
             *   component.
             */
            public fun statusTimeoutInSeconds(statusTimeoutInSeconds: Number)

            /**
             * @param timeoutInSeconds The maximum amount of time in seconds that the Lambda
             *   function can process a work item.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            override fun linuxProcessParams(linuxProcessParams: LambdaLinuxProcessParamsProperty) {
                cdkBuilder.linuxProcessParams(
                    linuxProcessParams.let(LambdaLinuxProcessParamsProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("27d11b929d32a5b083d2f35c3eae03f5233b88cc8fe45bccc391568c97e6ed00")
            override fun linuxProcessParams(
                linuxProcessParams: LambdaLinuxProcessParamsProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-greengrassv2-componentversion-lambdaexecutionparameters.html#cfn-greengrassv2-componentversion-lambdaexecutionparameters-inputpayloadencodingtype)
             */
            override fun inputPayloadEncodingType(): String? =
             ...
             * The maximum size of the message queue for the Lambda function component.
             *
             * The AWS IoT Greengrass core device stores messages in a FIFO (first-in-first-out)
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-greengrassv2-componentversion-lambdaexecutionparameters.html#cfn-greengrassv2-componentversion-lambdaexecutionparameters-statustimeoutinseconds)
             */
            override fun statusTimeoutInSeconds(): Number? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: LambdaExecutionParametersProperty
            ): software.amazon.awscdk.services.greengrassv2.CfnComponentVersion.LambdaExecutionParametersProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface LambdaEventSourceProperty {
         ...
         * * `PUB_SUB` – Subscribe to local publish/subscribe messages. This event source type
         *   doesn't support MQTT wildcards ( `+` and `#` ) in the event source topic.
        ...
        public interface Builder {
             ...
             * * `PUB_SUB` – Subscribe to local publish/subscribe messages. This event source type
             *   doesn't support MQTT wildcards ( `+` and `#` ) in the event source topic.
             * * `IOT_CORE` – Subscribe to AWS IoT Core MQTT messages. This event source type
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: LambdaEventSourceProperty
            ): software.amazon.awscdk.services.greengrassv2.CfnComponentVersion.LambdaEventSourceProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface LambdaVolumeMountProperty {
        ...
        public interface Builder {
            /**
             * @param addGroupOwner Whether or not to add the AWS IoT Greengrass user group as an
             *   owner of the volume. Default: `false`
             */
            public fun addGroupOwner(addGroupOwner: Boolean)
            ...
            /**
             * @param permission The permission to access the volume: read/only ( `ro` ) or
             *   read/write ( `rw` ). Default: `ro`
             */
            public fun permission(permission: String)
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: LambdaVolumeMountProperty
            ): software.amazon.awscdk.services.greengrassv2.CfnComponentVersion.LambdaVolumeMountProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface LambdaLinuxProcessParamsProperty {
        ...
        public interface Builder {
            /**
             * @param containerParams The parameters for the container in which the Lambda function
             *   runs.
             */
            ...
            public fun containerParams(
                containerParams: LambdaContainerParamsProperty.Builder.() -> Unit
            )

            /**
             * @param isolationMode The isolation mode for the process that contains the Lambda
             *   function. The process can run in an isolated runtime environment inside the AWS IoT
        ...
        private class BuilderImpl : Builder {
            ...
            override fun containerParams(containerParams: LambdaContainerParamsProperty) {
                cdkBuilder.containerParams(
                    containerParams.let(LambdaContainerParamsProperty::unwrap)
                )
            }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: LambdaLinuxProcessParamsProperty
            ): software.amazon.awscdk.services.greengrassv2.CfnComponentVersion.LambdaLinuxProcessParamsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
