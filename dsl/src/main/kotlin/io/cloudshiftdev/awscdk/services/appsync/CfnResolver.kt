...
internal constructor(
    ...
    public interface Builder {
        ...
        /**
         * The resolver type.
         * * *UNIT* : A UNIT resolver type. A UNIT resolver is the default resolver type. You can
         *   use a UNIT resolver to run a GraphQL query against a single data source.
         * * *PIPELINE* : A PIPELINE resolver type. You can use a PIPELINE resolver to invoke a
         *   series of `Function` objects in a serial manner. You can use a pipeline resolver to run
         ...
         * Enables or disables enhanced resolver metrics for specified resolvers.
         *
         * Note that `MetricsConfig` won't be used unless the `resolverLevelMetricsBehavior` value
         ...
         *
         * @param metricsConfig Enables or disables enhanced resolver metrics for specified
         *   resolvers.
         */
         ...
         * The location of a request mapping template in an Amazon S3 bucket.
         *
         * Use this if you want to provision with a template file in Amazon S3 rather than embedding
         ...
         *
         * @param responseMappingTemplateS3Location The location of a response mapping template in
         *   an Amazon S3 bucket.
         */
         ...
         * Describes a runtime used by an AWS AppSync resolver or AWS AppSync function.
         *
         * Specifies the name and version of the runtime to use. Note that if a runtime is
         ...
         *
         * @param runtime Describes a runtime used by an AWS AppSync resolver or AWS AppSync
         *   function.
         */
    ...
    private class BuilderImpl(
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("9cf35ea4a60ade7451477b791c4aa18cfd175c94e31d542330d3b46894db9e00")
        override fun pipelineConfig(
            pipelineConfig: PipelineConfigProperty.Builder.() -> Unit
    ...
    public companion object {
        ...
        ): CfnResolver = CfnResolver(cdkObject)

        internal fun unwrap(
            wrapped: CfnResolver
        ): software.amazon.awscdk.services.appsync.CfnResolver = wrapped.cdkObject
    }
    ...
    public interface SyncConfigProperty {
         ...
         */
        public fun lambdaConflictHandlerConfig(): Any? =
        ...
        public interface Builder {
            ...
            public fun lambdaConflictHandlerConfig(
                lambdaConflictHandlerConfig: LambdaConflictHandlerConfigProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun lambdaConflictHandlerConfig(lambdaConflictHandlerConfig: IResolvable) {
                cdkBuilder.lambdaConflictHandlerConfig(
                    lambdaConflictHandlerConfig.let(IResolvable::unwrap)
                )
            }
             ...
             *   `LAMBDA` as the Conflict Handler.
             */
            override fun lambdaConflictHandlerConfig(
                lambdaConflictHandlerConfig: LambdaConflictHandlerConfigProperty
            ) {
                cdkBuilder.lambdaConflictHandlerConfig(
                    lambdaConflictHandlerConfig.let(LambdaConflictHandlerConfigProperty::unwrap)
                )
            }
            ...
            override fun lambdaConflictHandlerConfig(
                ...
                lambdaConflictHandlerConfig(
                    LambdaConflictHandlerConfigProperty(lambdaConflictHandlerConfig)
                )
    ...
    public interface PipelineConfigProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: PipelineConfigProperty
            ): software.amazon.awscdk.services.appsync.CfnResolver.PipelineConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface AppSyncRuntimeProperty {
        ...
        public interface Builder {
            /**
             * @param name The `name` of the runtime to use. Currently, the only allowed value is
             *   `APPSYNC_JS` .
             */
            public fun name(name: String)

            /**
             * @param runtimeVersion The `version` of the runtime to use. Currently, the only
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AppSyncRuntimeProperty
            ): software.amazon.awscdk.services.appsync.CfnResolver.AppSyncRuntimeProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface LambdaConflictHandlerConfigProperty {
        ...
        public interface Builder {
            /**
             * @param lambdaConflictHandlerArn The Amazon Resource Name (ARN) for the Lambda
             *   function to use as the Conflict Handler.
             */
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appsync-resolver-lambdaconflicthandlerconfig.html#cfn-appsync-resolver-lambdaconflicthandlerconfig-lambdaconflicthandlerarn)
             */
            override fun lambdaConflictHandlerArn(): String? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: LambdaConflictHandlerConfigProperty
            ): software.amazon.awscdk.services.appsync.CfnResolver.LambdaConflictHandlerConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CachingConfigProperty {
        ...
        public interface Builder {
            /**
             * @param cachingKeys The caching keys for a resolver that has caching activated. Valid
            ...
            /**
             * @param ttl The TTL in seconds for a resolver that has caching activated. Valid values
             *   are 1–3,600 seconds.
             */
        ...
        private class BuilderImpl : Builder {
             ...
             *   `$context.identity` maps.
             */
            override fun cachingKeys(vararg cachingKeys: String): Unit =
                cachingKeys(cachingKeys.toList())
