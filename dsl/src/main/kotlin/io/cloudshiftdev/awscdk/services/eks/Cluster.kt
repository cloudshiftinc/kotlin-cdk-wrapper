...
internal constructor(
     ...
     *
     * The nodes will automatically be configured with the right VPC and AMI for the instance type
     * and Kubernetes version.
     *
     * Note that if you specify `updateType: RollingUpdate` or `updateType: ReplacingUpdate`, your
     * nodes might be replaced at deploy time without notice in case the recommended AMI for your
     * machine image type has been updated by AWS. The default behavior for `updateType` is `None`,
     * which means only new instances will be launched using the new AMI.
     *
     * Spot instances will be labeled `lifecycle=Ec2Spot` and tainted with `PreferNoSchedule`. In
     * addition, the
     ...
     * @param options
     */
    public open fun addAutoScalingGroupCapacity(
        id: String,
        options: AutoScalingGroupCapacityOptions
    ): AutoScalingGroup =
        unwrap(this)
            .addAutoScalingGroupCapacity(id, options.let(AutoScalingGroupCapacityOptions::unwrap))
            .let(AutoScalingGroup::wrap)
    ...
    public open fun addAutoScalingGroupCapacity(
        id: String,
        options: AutoScalingGroupCapacityOptions.Builder.() -> Unit
    ): AutoScalingGroup = addAutoScalingGroupCapacity(id, AutoScalingGroupCapacityOptions(options))
    ...
    public override fun addCdk8sChart(
        ...
        unwrap(this)
            .addCdk8sChart(id, chart.let(CloudshiftdevConstructsConstruct::unwrap))
            .let(KubernetesManifest::wrap)
    ...
    public override fun addCdk8sChart(
        ...
        unwrap(this)
            .addCdk8sChart(
                ...
                options.let(KubernetesManifestOptions::unwrap)
            )
            .let(KubernetesManifest::wrap)
    ...
    public open fun addFargateProfile(id: String, options: FargateProfileOptions): FargateProfile =
        unwrap(this)
            .addFargateProfile(id, options.let(FargateProfileOptions::unwrap))
            .let(FargateProfile::wrap)
    ...
    public open fun addFargateProfile(
        id: String,
        options: FargateProfileOptions.Builder.() -> Unit
    ...
    public override fun addHelmChart(
        id: String,
        options: HelmChartOptions.Builder.() -> Unit
    ...
    public open fun addNodegroupCapacity(id: String, options: NodegroupOptions): Nodegroup =
        unwrap(this)
            .addNodegroupCapacity(id, options.let(NodegroupOptions::unwrap))
            .let(Nodegroup::wrap)
    ...
    public open fun addNodegroupCapacity(
        id: String,
        options: NodegroupOptions.Builder.() -> Unit
     ...
     * @param options
     */
    public override fun addServiceAccount(
        id: String,
        options: ServiceAccountOptions
    ): ServiceAccount =
        unwrap(this)
            .addServiceAccount(id, options.let(ServiceAccountOptions::unwrap))
            .let(ServiceAccount::wrap)
    ...
    public override fun addServiceAccount(
        id: String,
        options: ServiceAccountOptions.Builder.() -> Unit
     ...
     *
     * This is because the values is only be retrieved by the API and not exposed by CloudFormation.
     * If this cluster is not kubectl-enabled (i.e. uses the stock `CfnCluster`), this is
     * `undefined`.
     */
     ...
     * /etc/eks/bootstrap.sh script. This method will configure Security Groups, add the right
     * policies to the instance role, apply the right tags, and add the required user data to the
     * instance's launch configuration.
     *
     ...
     */
    public override fun connectAutoScalingGroupCapacity(
        autoScalingGroup: AutoScalingGroup,
        options: AutoScalingGroupOptions
    ) {
        unwrap(this)
            .connectAutoScalingGroupCapacity(
                autoScalingGroup.let(AutoScalingGroup::unwrap),
    ...
    ): Unit = connectAutoScalingGroupCapacity(autoScalingGroup, AutoScalingGroupOptions(options))
     ...
     *
     * This will be `undefined` if the `defaultCapacityType` is not `EC2` or `defaultCapacityType`
     * is `EC2` but default capacity is set to 0.
     */
     ...
     *
     * This will be `undefined` if the `defaultCapacityType` is `EC2` or `defaultCapacityType` is
     * `NODEGROUP` but default capacity is set to 0.
     */
     ...
     * @param options Additional operation options.
     */
    public open fun ingressLoadBalancerAddress(
        ingressName: String,
    ...
    public open fun ingressLoadBalancerAddress(
        ingressName: String,
        options: IngressLoadBalancerAddressOptions.Builder.() -> Unit
    ): String = ingressLoadBalancerAddress(ingressName, IngressLoadBalancerAddressOptions(options))
    ...
    /**
     * An `OpenIdConnectProvider` resource associated with this cluster, and which can be used to
     * link this cluster to AWS IAM.
     *
     ...
     * @param options Additional operation options.
     */
    public open fun serviceLoadBalancerAddress(
        serviceName: String,
    ...
    public open fun serviceLoadBalancerAddress(
        serviceName: String,
        options: ServiceLoadBalancerAddressOptions.Builder.() -> Unit
    ): String = serviceLoadBalancerAddress(serviceName, ServiceLoadBalancerAddressOptions(options))
    ...
    public interface Builder {
         ...
         *
         * @param clusterHandlerEnvironment Custom environment variables when interacting with the
         *   EKS endpoint to manage the cluster lifecycle.
         */
         ...
         * Default: - No security group.
         *
         * @param clusterHandlerSecurityGroup A security group to associate with the Cluster
         *   Handler's Lambdas.
         */
        ...
        /**
         * Controls the "eks.amazonaws.com/compute-type" annotation in the CoreDNS configuration on
         * your cluster to determine which compute type to use for CoreDNS.
         *
         * Default: CoreDnsComputeType.EC2 (for `FargateCluster` the default is FARGATE)
         *
         * @param coreDnsComputeType Controls the "eks.amazonaws.com/compute-type" annotation in the
         *   CoreDNS configuration on your cluster to determine which compute type to use for
         *   CoreDNS.
         */
         ...
         *
         * Instance type can be configured through `defaultCapacityInstanceType`, which defaults to
         * `m5.large`.
         *
         ...
         * must pick an appropriate releases of one of the `&#64;aws-cdk/layer-kubectl-vXX`
         * packages, that works with the version of Kubernetes you have chosen. If you don't supply
         * this value `kubectl` 1.20 will be used, but that version is most likely too old.
         *
         * The handler expects the layer to include the following executables:
         * ```
         * /opt/helm/helm
        ...
        /**
         * Determines whether a CloudFormation output with the name of the cluster will be
         * synthesized.
         *
         * Default: false
         *
        ...
        /**
         * Determines whether a CloudFormation output with the `aws eks update-kubeconfig` command
         * will be synthesized.
         *
         ...
         * Default: false
         *
         * @param outputMastersRoleArn Determines whether a CloudFormation output with the ARN of
         *   the "masters" IAM role will be synthesized (if `mastersRole` is specified).
         */
        public fun outputMastersRoleArn(outputMastersRoleArn: Boolean)

        /**
         * If set to true, the cluster handler functions will be placed in the private subnets of
         * the cluster vpc, subject to the `vpcSubnets` selection strategy.
         *
         * Default: false
         *
         * @param placeClusterHandlerInVpc If set to true, the cluster handler functions will be
         *   placed in the private subnets of the cluster vpc, subject to the `vpcSubnets` selection
         *   strategy.
         */
         ...
         * pruned.
         *
         * When this is enabled (default), prune labels will be allocated and injected to each
         * resource. These labels will then be used when issuing the `kubectl apply` operation with
         * the `--prune` switch.
         *
         * Default: true
         *
         ...
         *
         * @param role Role that provides permissions for the Kubernetes control plane to make calls
         ...
         * volumes used by Amazon EKS are encrypted at the disk-level using AWS-Managed encryption
         * keys.
         *
         ...
         *
         * Default: - Kubernetes assigns addresses from either the 10.100.0.0/16 or 172.20.0.0/16
         * CIDR blocks
         *
    ...
    private class BuilderImpl(
        ...
        override fun clusterHandlerSecurityGroup(clusterHandlerSecurityGroup: ISecurityGroup) {
            cdkBuilder.clusterHandlerSecurityGroup(
                clusterHandlerSecurityGroup.let(ISecurityGroup::unwrap)
            )
        }
    ...
    public companion object {
        public fun fromClusterAttributes(
            ...
            software.amazon.awscdk.services.eks.Cluster.fromClusterAttributes(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    attrs.let(ClusterAttributes::unwrap)
                )
                .let(ICluster::wrap)
