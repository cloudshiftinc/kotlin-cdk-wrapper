...
internal constructor(
     ...
     *
     * Usage within the same account where the layer is defined is always allowed and does not
     * require calling this method. Note that the principal that creates the Lambda function using
    ...
    public override fun addPermission(
        id: String,
        permission: LayerVersionPermission.Builder.() -> Unit
    ...
    public interface Builder {
        ...
        /**
         * Whether to retain this version of the layer when a new version is added or when the stack
         * is deleted.
         *
         * Default: RemovalPolicy.DESTROY
         *
         * @param removalPolicy Whether to retain this version of the layer when a new version is
         *   added or when the stack is deleted.
         */
    ...
    public companion object {
        public fun fromLayerVersionArn(
            ...
            software.amazon.awscdk.services.lambda.LayerVersion.fromLayerVersionArn(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    layerVersionArn
                )
                .let(ILayerVersion::wrap)
        ...
        public fun fromLayerVersionAttributes(
            ...
            software.amazon.awscdk.services.lambda.LayerVersion.fromLayerVersionAttributes(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    attrs.let(LayerVersionAttributes::unwrap)
                )
                .let(ILayerVersion::wrap)
        ...
        ): LayerVersion = LayerVersion(cdkObject)

        internal fun unwrap(
            wrapped: LayerVersion
        ): software.amazon.awscdk.services.lambda.LayerVersion = wrapped.cdkObject
    }
}
