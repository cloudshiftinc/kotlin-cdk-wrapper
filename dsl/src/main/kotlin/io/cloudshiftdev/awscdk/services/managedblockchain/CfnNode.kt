...
internal constructor(
    ...
    public interface Builder {
        ...
        public fun nodeConfiguration(
            nodeConfiguration: NodeConfigurationProperty.Builder.() -> Unit
        )
    }
    ...
    private class BuilderImpl(
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("25aeecfc6e7cc309f4cae08c5b752d870903f4d2b570694a11231b1a0f3c8055")
        override fun nodeConfiguration(
            nodeConfiguration: NodeConfigurationProperty.Builder.() -> Unit
    ...
    public companion object {
        ...
        ): CfnNode = CfnNode(cdkObject)

        internal fun unwrap(
            wrapped: CfnNode
        ): software.amazon.awscdk.services.managedblockchain.CfnNode = wrapped.cdkObject
    }
    ...
    public interface NodeConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param availabilityZone The Availability Zone in which the node exists. Required for
             *   Ethereum nodes.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: NodeConfigurationProperty
            ): software.amazon.awscdk.services.managedblockchain.CfnNode.NodeConfigurationProperty =
