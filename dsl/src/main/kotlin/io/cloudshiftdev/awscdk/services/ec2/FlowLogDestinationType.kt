...
public enum class FlowLogDestinationType(
    ...
    public companion object {
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.ec2.FlowLogDestinationType
            ...
            when (cdkObject) {
                ...
                software.amazon.awscdk.services.ec2.FlowLogDestinationType.S3 ->
        ...
        internal fun unwrap(
            wrapped: FlowLogDestinationType
