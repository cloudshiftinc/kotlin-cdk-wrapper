...
public interface ThrottlingPerMethod {
    ...
    public interface Builder {
        ...
        /**
         * @param throttle Specifies the overall request rate (average requests per second) and
         *   burst capacity.
         */
    ...
    internal constructor(
        ...
        /**
         * [disable-awslint:ref-via-interface] The method for which you specify the throttling
         * settings.
         *
         * Default: none
         */
