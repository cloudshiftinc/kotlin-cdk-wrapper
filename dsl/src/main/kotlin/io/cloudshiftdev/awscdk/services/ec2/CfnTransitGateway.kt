...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param amazonSideAsn A private Autonomous System Number (ASN) for the Amazon side of a
         *   BGP session.
         */
         ...
         *
         * @param defaultRouteTableAssociation Enable or disable automatic association with the
         ...
         *
         * @param defaultRouteTablePropagation Enable or disable automatic propagation of routes to
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.ec2.CfnTransitGateway =
            cdkBuilder.build()
    }
