...
internal constructor(
    ...
    public interface Builder {
         ...
         * in the CloudTrail User Guide.
         *
         * For more information about how to use advanced event selectors to include non- AWS events
         * in your event data store, see
         ...
         *
         * @param advancedEventSelectors The advanced event selectors to use to select the events
         *   for the data store.
         */
         ...
         * Indicates if
         * [Lake query federation](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/query-federation.html)
         * is enabled. By default, Lake query federation is disabled. You cannot delete an event
         * data store if Lake query federation is enabled.
         *
         ...
         *
         * @param ingestionEnabled Specifies whether the event data store should start ingesting
         *   live events.
         */
         ...
         *
         * @param insightsDestination The ARN (or ID suffix of the ARN) of the destination event
         ...
         *
         * @param organizationEnabled Specifies whether an event data store collects events logged
         ...
         * The retention period of the event data store, in days.
         *
         * If `BillingMode` is set to `EXTENDABLE_RETENTION_PRICING` , you can set a retention
         * period of up to 3653 days, the equivalent of 10 years. If `BillingMode` is set to
         ...
         * years old and specify a retention period of 7 years, the event data store will retain
         ...
         *
         * @param terminationProtectionEnabled Specifies whether termination protection is enabled
    ...
    private class BuilderImpl(
        ...
        override fun terminationProtectionEnabled(terminationProtectionEnabled: IResolvable) {
            cdkBuilder.terminationProtectionEnabled(
                terminationProtectionEnabled.let(IResolvable::unwrap)
            )
        }
