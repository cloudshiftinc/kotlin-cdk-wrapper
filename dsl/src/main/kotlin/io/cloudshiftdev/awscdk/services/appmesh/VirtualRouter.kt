...
internal constructor(
     ...
     * @param props
     */
    public override fun addRoute(id: String, props: RouteBaseProps): Route =
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.appmesh.VirtualRouter =
            cdkBuilder.build()
    }
    ...
    public companion object {
        public fun fromVirtualRouterArn(
            ...
            software.amazon.awscdk.services.appmesh.VirtualRouter.fromVirtualRouterArn(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    virtualRouterArn
                )
                .let(IVirtualRouter::wrap)
        ...
        public fun fromVirtualRouterAttributes(
            ...
            software.amazon.awscdk.services.appmesh.VirtualRouter.fromVirtualRouterAttributes(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    attrs.let(VirtualRouterAttributes::unwrap)
                )
                .let(IVirtualRouter::wrap)
