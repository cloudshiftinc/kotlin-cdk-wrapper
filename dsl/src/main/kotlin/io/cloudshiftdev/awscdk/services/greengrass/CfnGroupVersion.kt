...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.greengrass.CfnGroupVersion,
    ...
    public interface Builder {
         ...
         *
         * @param subscriptionDefinitionVersionArn The ARN of the subscription definition version
         *   that contains the subscriptions you want to deploy with the group version.
         */
