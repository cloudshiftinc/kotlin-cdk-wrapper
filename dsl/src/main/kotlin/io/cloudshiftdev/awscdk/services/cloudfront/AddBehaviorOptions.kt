...
public interface AddBehaviorOptions {
     ...
     *
     * The cache policy determines what values are included in the cache key, and the time-to-live
     * (TTL) values for the cache.
     *
     ...
     */
    public fun edgeLambdas(): List<EdgeLambda> =
     ...
     *
     * The origin request policy determines which values (e.g., headers, cookies) are included in
    ...
    public interface Builder {
        ...
        /**
         * @param originRequestPolicy The origin request policy for this behavior. The origin
         *   request policy determines which values (e.g., headers, cookies) are included in
         *   requests that CloudFront sends to the origin.
         */
        ...
        /**
         * @param smoothStreaming Set this to true to indicate you want to distribute media files in
         *   the Microsoft Smooth Streaming format using this behavior.
         */
        ...
        /**
         * @param viewerProtocolPolicy The protocol that viewers can use to access the files
    ...
    private class BuilderImpl : Builder {
        ...
        override fun responseHeadersPolicy(responseHeadersPolicy: IResponseHeadersPolicy) {
            cdkBuilder.responseHeadersPolicy(
                responseHeadersPolicy.let(IResponseHeadersPolicy::unwrap)
            )
        }
    ...
    internal constructor(
         ...
         * The cache policy for this behavior.
         *
         * The cache policy determines what values are included in the cache key, and the
         * time-to-live (TTL) values for the cache.
         *
         * Default: CachePolicy.CACHING_OPTIMIZED
         *
         * [Documentation](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/controlling-the-cache-key.html.)
         ...
         * The origin request policy for this behavior.
         *
         * The origin request policy determines which values (e.g., headers, cookies) are included
    ...
    public companion object {
        ...
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.cloudfront.AddBehaviorOptions
        ): AddBehaviorOptions = Wrapper(cdkObject)

        internal fun unwrap(
            wrapped: AddBehaviorOptions
