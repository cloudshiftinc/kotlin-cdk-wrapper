...
public interface IStringListParameter : IParameter {
    ...
    internal constructor(
        internal val cdkObject: software.amazon.awscdk.services.ssm.IStringListParameter,
        ...
        /**
         * Grants read (DescribeParameter, GetParameters, GetParameter, GetParameterHistory)
         * permissions on the SSM Parameter.
         *
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: IStringListParameter
        ): software.amazon.awscdk.services.ssm.IStringListParameter = (wrapped as Wrapper).cdkObject
    }
}
