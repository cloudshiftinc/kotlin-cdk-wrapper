...
public enum class PipelineNotificationEvents(
    ...
    public companion object {
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.codepipeline.PipelineNotificationEvents
            ...
            when (cdkObject) {
                ...
                software.amazon.awscdk.services.codepipeline.PipelineNotificationEvents
                    .STAGE_EXECUTION_STARTED -> PipelineNotificationEvents.STAGE_EXECUTION_STARTED
                software.amazon.awscdk.services.codepipeline.PipelineNotificationEvents
                    .STAGE_EXECUTION_SUCCEEDED ->
                    PipelineNotificationEvents.STAGE_EXECUTION_SUCCEEDED
                software.amazon.awscdk.services.codepipeline.PipelineNotificationEvents
                    .STAGE_EXECUTION_RESUMED -> PipelineNotificationEvents.STAGE_EXECUTION_RESUMED
                software.amazon.awscdk.services.codepipeline.PipelineNotificationEvents
                    .STAGE_EXECUTION_CANCELED -> PipelineNotificationEvents.STAGE_EXECUTION_CANCELED
                software.amazon.awscdk.services.codepipeline.PipelineNotificationEvents
                    .STAGE_EXECUTION_FAILED -> PipelineNotificationEvents.STAGE_EXECUTION_FAILED
                software.amazon.awscdk.services.codepipeline.PipelineNotificationEvents
                    .ACTION_EXECUTION_SUCCEEDED ->
                    PipelineNotificationEvents.ACTION_EXECUTION_SUCCEEDED
                software.amazon.awscdk.services.codepipeline.PipelineNotificationEvents
                    .ACTION_EXECUTION_FAILED -> PipelineNotificationEvents.ACTION_EXECUTION_FAILED
                software.amazon.awscdk.services.codepipeline.PipelineNotificationEvents
                    .ACTION_EXECUTION_CANCELED ->
                    PipelineNotificationEvents.ACTION_EXECUTION_CANCELED
                software.amazon.awscdk.services.codepipeline.PipelineNotificationEvents
                    .ACTION_EXECUTION_STARTED -> PipelineNotificationEvents.ACTION_EXECUTION_STARTED
                software.amazon.awscdk.services.codepipeline.PipelineNotificationEvents
                    .MANUAL_APPROVAL_FAILED -> PipelineNotificationEvents.MANUAL_APPROVAL_FAILED
                software.amazon.awscdk.services.codepipeline.PipelineNotificationEvents
                    .MANUAL_APPROVAL_NEEDED -> PipelineNotificationEvents.MANUAL_APPROVAL_NEEDED
                software.amazon.awscdk.services.codepipeline.PipelineNotificationEvents
                    .MANUAL_APPROVAL_SUCCEEDED ->
        ...
        internal fun unwrap(
            wrapped: PipelineNotificationEvents
        ): software.amazon.awscdk.services.codepipeline.PipelineNotificationEvents =
            wrapped.cdkObject
    }
}
