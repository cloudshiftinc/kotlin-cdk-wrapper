...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * If true, the service scheduler deploys exactly one task on each container instance in
         * your cluster.
         *
    ...
    public companion object {
        public fun fromEc2ServiceArn(
            ...
            software.amazon.awscdk.services.ecs.Ec2Service.fromEc2ServiceArn(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    ec2ServiceArn
                )
                .let(IEc2Service::wrap)
        ...
        public fun fromEc2ServiceAttributes(
            ...
            software.amazon.awscdk.services.ecs.Ec2Service.fromEc2ServiceAttributes(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    attrs.let(Ec2ServiceAttributes::unwrap)
                )
