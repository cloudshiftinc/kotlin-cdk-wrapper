...
internal constructor(
    ...
    public open fun dataSecurityConfig(
        `value`: DataSecurityConfigProperty.Builder.() -> Unit
    ): Unit = dataSecurityConfig(DataSecurityConfigProperty(`value`))
    ...
    public interface Builder {
        ...
        public fun dataSecurityConfig(
            dataSecurityConfig: DataSecurityConfigProperty.Builder.() -> Unit
        )
         ...
         * Tags associated with the endpoint being created.
         *
         * A tag is a key-value pair that adds metadata to the endpoint. For example, a tag with
         * "Sales" as the key might be added to an endpoint to indicate its use by the sales
         * department.
         *
    ...
    private class BuilderImpl(
        ...
        override fun dataSecurityConfig(dataSecurityConfig: DataSecurityConfigProperty) {
            cdkBuilder.dataSecurityConfig(
                dataSecurityConfig.let(DataSecurityConfigProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("817e8a9bad11909e847082d3e9f601041c2aedd678201044b663f0719e9ac320")
        override fun dataSecurityConfig(
            dataSecurityConfig: DataSecurityConfigProperty.Builder.() -> Unit
        ...
        public fun build(): software.amazon.awscdk.services.comprehend.CfnFlywheel =
            cdkBuilder.build()
    }
    ...
    public interface TaskConfigProperty {
         ...
         */
        public fun documentClassificationConfig(): Any? =
        ...
        public interface Builder {
            /**
             * @param documentClassificationConfig Configuration required for a document
             ...
             *   classification model.
             */
            public fun documentClassificationConfig(
            ...
            public fun documentClassificationConfig(
                documentClassificationConfig:
                    DocumentClassificationConfigProperty.Builder.() -> Unit
            )

            /**
             * @param entityRecognitionConfig Configuration required for an entity recognition
             *   model.
             */
             ...
             *   model.
             */
            public fun entityRecognitionConfig(
            ...
            public fun entityRecognitionConfig(
                entityRecognitionConfig: EntityRecognitionConfigProperty.Builder.() -> Unit
            )
        ...
        private class BuilderImpl : Builder {
            ...
            override fun documentClassificationConfig(documentClassificationConfig: IResolvable) {
                cdkBuilder.documentClassificationConfig(
                    documentClassificationConfig.let(IResolvable::unwrap)
                )
            }
             ...
             *   classification model.
             */
            override fun documentClassificationConfig(
                documentClassificationConfig: DocumentClassificationConfigProperty
            ) {
                cdkBuilder.documentClassificationConfig(
                    documentClassificationConfig.let(DocumentClassificationConfigProperty::unwrap)
                )
            }
            ...
            override fun documentClassificationConfig(
                ...
                documentClassificationConfig(
                    DocumentClassificationConfigProperty(documentClassificationConfig)
                )
             ...
             *   model.
             */
            override fun entityRecognitionConfig(
                entityRecognitionConfig: EntityRecognitionConfigProperty
            ) {
                cdkBuilder.entityRecognitionConfig(
                    entityRecognitionConfig.let(EntityRecognitionConfigProperty::unwrap)
                )
            }
            ...
            override fun entityRecognitionConfig(
                ...
                entityRecognitionConfig(EntityRecognitionConfigProperty(entityRecognitionConfig))
    ...
    public interface DataSecurityConfigProperty {
         ...
         * the resources you are using for the job.
         *
        ...
        public interface Builder {
            /**
             * @param dataLakeKmsKeyId ID for the AWS KMS key that Amazon Comprehend uses to encrypt
            ...
            /**
             * @param volumeKmsKeyId ID for the AWS KMS key that Amazon Comprehend uses to encrypt
             *   the volume.
             */
            public fun volumeKmsKeyId(volumeKmsKeyId: String)

            /**
             * @param vpcConfig Configuration parameters for an optional private Virtual Private
             *   Cloud (VPC) containing the resources you are using for the job. For more
             *   information, see
             *   [Amazon VPC](https://docs.aws.amazon.com/vpc/latest/userguide/what-is-amazon-vpc.html)
             *   .
             */
        ...
        internal constructor(
            ...
            /**
             * ID for the AWS KMS key that Amazon Comprehend uses to encrypt the data in the data
             * lake.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-comprehend-flywheel-datasecurityconfig.html#cfn-comprehend-flywheel-datasecurityconfig-datalakekmskeyid)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DataSecurityConfigProperty
            ): software.amazon.awscdk.services.comprehend.CfnFlywheel.DataSecurityConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface EntityRecognitionConfigProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: EntityRecognitionConfigProperty
            ): software.amazon.awscdk.services.comprehend.CfnFlywheel.EntityRecognitionConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface EntityTypesListItemProperty {
        ...
        public interface Builder {
            /**
             * @param type An entity type within a labeled training dataset that Amazon Comprehend
             *   uses to train a custom entity recognizer. Entity types must not contain the
             *   following invalid characters: \n (line break), \n (escaped line break, \r (carriage
             *   return), \r (escaped carriage return), \t (tab), \t (escaped tab), and , (comma).
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: EntityTypesListItemProperty
            ): software.amazon.awscdk.services.comprehend.CfnFlywheel.EntityTypesListItemProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DocumentClassificationConfigProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DocumentClassificationConfigProperty
            ): software.amazon.awscdk.services.comprehend.CfnFlywheel.DocumentClassificationConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
