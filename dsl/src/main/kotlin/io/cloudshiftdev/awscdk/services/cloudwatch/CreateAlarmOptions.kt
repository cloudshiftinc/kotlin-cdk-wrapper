...
public interface CreateAlarmOptions {
    ...
    public interface Builder {
         ...
         *   value is the M. For more information, see Evaluating an Alarm in the Amazon CloudWatch
         *   User Guide.
         */
    ...
    public companion object {
        ...
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.cloudwatch.CreateAlarmOptions
        ): CreateAlarmOptions = Wrapper(cdkObject)

        internal fun unwrap(
            wrapped: CreateAlarmOptions
