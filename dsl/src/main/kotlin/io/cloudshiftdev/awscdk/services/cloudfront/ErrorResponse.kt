...
public interface ErrorResponse {
    ...
    public interface Builder {
         ...
         *   viewer along with the custom error page. If you specify a value for
         *   `responseHttpStatus`, you must also specify a value for `responsePagePath`.
         */
         ...
         *   return to a viewer when your origin returns the `httpStatus`, for example,
         *   /4xx-errors/403-forbidden.html.
         */
        public fun responsePagePath(responsePagePath: String)

        /**
         * @param ttl The minimum amount of time, in seconds, that you want CloudFront to cache the
    ...
    internal constructor(
         ...
         * your origin returns the `httpStatus`, for example, /4xx-errors/403-forbidden.html.
         *
         * Default: - the default CloudFront response is shown.
         */
