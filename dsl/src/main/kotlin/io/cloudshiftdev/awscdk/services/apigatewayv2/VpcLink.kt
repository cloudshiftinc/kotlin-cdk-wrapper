...
internal constructor(
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.apigatewayv2.VpcLink =
            cdkBuilder.build()
    }
    ...
    public companion object {
        public fun fromVpcLinkAttributes(
            ...
            software.amazon.awscdk.services.apigatewayv2.VpcLink.fromVpcLinkAttributes(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    attrs.let(VpcLinkAttributes::unwrap)
                )
                .let(IVpcLink::wrap)
        ...
        ): VpcLink = VpcLink(cdkObject)

        internal fun unwrap(
            wrapped: VpcLink
        ): software.amazon.awscdk.services.apigatewayv2.VpcLink = wrapped.cdkObject
    }
}
