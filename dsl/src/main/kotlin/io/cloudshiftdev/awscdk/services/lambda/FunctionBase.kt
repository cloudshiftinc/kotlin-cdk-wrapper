...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.lambda.FunctionBase,
    ...
    /**
     * A warning will be added to functions under the following conditions: - permissions that
     * include `lambda:InvokeFunction` are added to the unqualified function.
     * * function.currentVersion is invoked before or after the permission is created.
     *
     * This applies only to permissions on Lambda functions, not versions or aliases. This function
     * is overridden as a noOp for QualifiedFunctionBase.
     *
     * @param scope
     * @param action
     */
    public open fun considerWarningOnInvokeFunctionPermissions(scope: Construct, action: String) {
        unwrap(this)
            .considerWarningOnInvokeFunctionPermissions(scope.let(Construct::unwrap), action)
    }
    ...
    internal constructor(
        internal val cdkObject: software.amazon.awscdk.services.lambda.FunctionBase,
    ...
    public companion object {
        ...
        ): FunctionBase = Wrapper(cdkObject)

        internal fun unwrap(
            wrapped: FunctionBase
        ): software.amazon.awscdk.services.lambda.FunctionBase = (wrapped as Wrapper).cdkObject
    }
}
