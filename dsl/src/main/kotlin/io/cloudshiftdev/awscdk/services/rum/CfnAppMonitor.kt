...
internal constructor(
    ...
    public open fun appMonitorConfiguration(`value`: AppMonitorConfigurationProperty) {
        unwrap(this)
            .setAppMonitorConfiguration(`value`.let(AppMonitorConfigurationProperty::unwrap))
    }

    /** A structure that contains much of the configuration data for the app monitor. */
    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("04aafd667188d60d7f60268739bc56055270d4debbdc2f660ff7b920ed3a7dea")
    public open fun appMonitorConfiguration(
        `value`: AppMonitorConfigurationProperty.Builder.() -> Unit
    ): Unit = appMonitorConfiguration(AppMonitorConfigurationProperty(`value`))
    ...
    public interface Builder {
         ...
         * A structure that contains much of the configuration data for the app monitor.
         *
         * If you are using Amazon Cognito for authorization, you must include this structure in
         * your request, and it must include the ID of the Amazon Cognito identity pool to use for
         ...
         * .
         *
         * If you omit this argument, the sample rate used for CloudWatch RUM is set to 10% of the
         * user sessions.
         *
         ...
         *
         * @param appMonitorConfiguration A structure that contains much of the configuration data
         *   for the app monitor.
         */
        ...
        public fun appMonitorConfiguration(
            appMonitorConfiguration: AppMonitorConfigurationProperty.Builder.() -> Unit
        )
         ...
         *
         * @param customEvents Specifies whether this app monitor allows the web client to define
         ...
         * Data collected by CloudWatch RUM is kept by RUM for 30 days and then deleted.
         *
         * This parameter specifies whether CloudWatch RUM sends a copy of this telemetry data to
         * Amazon CloudWatch Logs in your account. This enables you to keep the telemetry data for
    ...
    private class BuilderImpl(
         ...
         *   for the app monitor.
         */
        override fun appMonitorConfiguration(
            appMonitorConfiguration: AppMonitorConfigurationProperty
        ) {
            cdkBuilder.appMonitorConfiguration(
                appMonitorConfiguration.let(AppMonitorConfigurationProperty::unwrap)
            )
        }
    ...
    public companion object {
        ...
        ): CfnAppMonitor = CfnAppMonitor(cdkObject)

        internal fun unwrap(
            wrapped: CfnAppMonitor
        ): software.amazon.awscdk.services.rum.CfnAppMonitor = wrapped.cdkObject
    }
    ...
    public interface AppMonitorConfigurationProperty {
         ...
         * sampled session.
         *
         * You can then see traces and segments from these user sessions in the RUM dashboard and
        ...
        /**
         * A list of pages in your application that are to be displayed with a "favorite" icon in
        ...
        /**
         * The ARN of the guest IAM role that is attached to the Amazon Cognito identity pool that
         * is used to authorize the sending of data to CloudWatch RUM.
         *
        ...
        /**
         * The ID of the Amazon Cognito identity pool that is used to authorize the sending of data
         * to CloudWatch RUM.
         *
        ...
        public interface Builder {
            /**
             * @param allowCookies If you set this to `true` , the CloudWatch RUM web client sets
             *   two cookies, a session cookie and a user cookie. The cookies allow the CloudWatch
             *   RUM web client to collect data relating to the number of users an application has
             *   and the behavior of the application across a sequence of events. Cookies are stored
            ...
            /**
             * @param enableXRay If you set this to `true` , CloudWatch RUM sends client-side traces
             *   to X-Ray for each sampled session. You can then see traces and segments from these
             *   user sessions in the RUM dashboard and the CloudWatch ServiceLens console. For more
             *   information, see
             *   [What is AWS X-Ray ?](https://docs.aws.amazon.com/xray/latest/devguide/aws-xray.html)
             */
            ...
            /**
             * @param excludedPages A list of URLs in your website or application to exclude from
             *   RUM data collection. You can't include both `ExcludedPages` and `IncludedPages` in
             *   the same app monitor.
             */
            ...
            /**
             * @param favoritePages A list of pages in your application that are to be displayed
            ...
            /**
             * @param guestRoleArn The ARN of the guest IAM role that is attached to the Amazon
             *   Cognito identity pool that is used to authorize the sending of data to CloudWatch
             *   RUM.
             */
            public fun guestRoleArn(guestRoleArn: String)

            /**
             * @param identityPoolId The ID of the Amazon Cognito identity pool that is used to
             *   authorize the sending of data to CloudWatch RUM.
             */
            public fun identityPoolId(identityPoolId: String)

            /**
             * @param includedPages If this app monitor is to collect data from only certain pages
             *   in your application, this structure lists those pages. You can't include both
             *   `ExcludedPages` and `IncludedPages` in the same app monitor.
             */
            ...
            /**
             * @param metricDestinations An array of structures that each define a destination that
             *   this app monitor will send extended metrics to.
             */
            ...
            /**
             * @param sessionSampleRate Specifies the portion of user sessions to use for CloudWatch
             *   RUM data collection. Choosing a higher portion gives you more data but also incurs
             *   more costs.
             *
            ...
            /**
             * @param telemetries An array that lists the types of telemetry data that this app
        ...
        private class BuilderImpl : Builder {
             ...
             *   application.
             */
            override fun telemetries(vararg telemetries: String): Unit =
                telemetries(telemetries.toList())
        ...
        internal constructor(
             ...
             * cookie and a user cookie.
             *
             * The cookies allow the CloudWatch RUM web client to collect data relating to the
             * number of users an application has and the behavior of the application across a
             ...
             * sampled session.
             *
             * You can then see traces and segments from these user sessions in the RUM dashboard
             * and the CloudWatch ServiceLens console. For more information, see
             * [What is AWS X-Ray ?](https://docs.aws.amazon.com/xray/latest/devguide/aws-xray.html)
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-rum-appmonitor-appmonitorconfiguration.html#cfn-rum-appmonitor-appmonitorconfiguration-enablexray)
             */
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-rum-appmonitor-appmonitorconfiguration.html#cfn-rum-appmonitor-appmonitorconfiguration-excludedpages)
             */
            override fun excludedPages(): List<String> =
                unwrap(this).getExcludedPages() ?: emptyList()
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-rum-appmonitor-appmonitorconfiguration.html#cfn-rum-appmonitor-appmonitorconfiguration-favoritepages)
             */
            override fun favoritePages(): List<String> =
                unwrap(this).getFavoritePages() ?: emptyList()
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-rum-appmonitor-appmonitorconfiguration.html#cfn-rum-appmonitor-appmonitorconfiguration-includedpages)
             */
            override fun includedPages(): List<String> =
                unwrap(this).getIncludedPages() ?: emptyList()
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AppMonitorConfigurationProperty
            ): software.amazon.awscdk.services.rum.CfnAppMonitor.AppMonitorConfigurationProperty =
    ...
    public interface MetricDestinationProperty {
         ...
         * also specify the ARN of the CloudWatch Evidently experiment that is to be the destination
         ...
         *
         * This parameter specifies the ARN of the Evidently experiment that will receive the
         * extended metrics.
         *
         ...
         * Evidently experiment that you are sending metrics to. This role must have permission to
        ...
        public interface Builder {
             ...
             *   the ARN of the CloudWatch Evidently experiment that is to be the destination and an
             ...
             *   parameter specifies the ARN of the Evidently experiment that will receive the
             *   extended metrics.
             */
             ...
             *   `Destination` is `CloudWatch` , do not use this parameter. This parameter specifies
             *   the ARN of an IAM role that RUM will assume to write to the Evidently experiment
             *   that you are sending metrics to. This role must have permission to write to that
             *   experiment.
             */
            public fun iamRoleArn(iamRoleArn: String)

            /**
             * @param metricDefinitions An array of structures which define the metrics that you
             *   want to send.
             */
        ...
        internal constructor(
             ...
             *
             * Valid values are `CloudWatch` and `Evidently` . If you specify `Evidently` , you must
             * also specify the ARN of the CloudWatch Evidently experiment that is to be the
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: MetricDestinationProperty
            ): software.amazon.awscdk.services.rum.CfnAppMonitor.MetricDestinationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CustomEventsProperty {
        ...
        public interface Builder {
            /**
             * @param status Set this to `ENABLED` to allow the web client to send custom events for
             *   this app monitor. Valid values are `ENABLED` and `DISABLED` .
             */
        ...
        internal constructor(
            ...
            /**
             * Set this to `ENABLED` to allow the web client to send custom events for this app
             * monitor.
             *
             * Valid values are `ENABLED` and `DISABLED` .
             *
    ...
    public interface MetricDefinitionProperty {
         ...
         * field is used only if the metric destination is `CloudWatch` . If the metric destination
        ...
        public interface Builder {
            /**
             * @param dimensionKeys This field is a map of field paths to dimension names. It
             *   defines the dimensions to associate with this metric in CloudWatch . The value of
             *   this field is used only if the metric destination is `CloudWatch` . If the metric
            ...
            /**
             * @param eventPattern The pattern that defines the metric. RUM checks events that
             *   happen in a user's session against the pattern, and events that match the pattern
            ...
            /**
             * @param namespace If you are creating a custom metric instead of an extended metrics,
             *   use this parameter to define the metric namespace for that custom metric. Do not
             *   specify this parameter if you are creating an extended metric.
             *
             * You can't use any string that starts with `AWS/` for your namespace.
             */
            ...
            /**
             * @param valueKey The field within the event object that the metric value is sourced
             *   from.
             */
        ...
        internal constructor(
             ...
             * This field is a map of field paths to dimension names.
             *
             * It defines the dimensions to associate with this metric in CloudWatch . The value of
             * this field is used only if the metric destination is `CloudWatch` . If the metric
             * destination is `Evidently` , the value of `DimensionKeys` is ignored.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-rum-appmonitor-metricdefinition.html#cfn-rum-appmonitor-metricdefinition-dimensionkeys)
             ...
             * The pattern that defines the metric.
             *
             * RUM checks events that happen in a user's session against the pattern, and events
            ...
            /**
             * If you are creating a custom metric instead of an extended metrics, use this
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: MetricDefinitionProperty
            ): software.amazon.awscdk.services.rum.CfnAppMonitor.MetricDefinitionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
