...
internal constructor(
    ...
    public open fun autoBranchCreationConfig(`value`: AutoBranchCreationConfigProperty) {
        unwrap(this)
            .setAutoBranchCreationConfig(`value`.let(AutoBranchCreationConfigProperty::unwrap))
    }

    /** Sets the configuration for your automatic branch creation. */
    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("72b5a78e0c2178a9932563a9b0a1b34747ce212371b55c1fe8604af2cec752ea")
    public open fun autoBranchCreationConfig(
        `value`: AutoBranchCreationConfigProperty.Builder.() -> Unit
    ...
    public interface Builder {
         ...
         *
         * @param autoBranchCreationConfig Sets the configuration for your automatic branch
         *   creation.
         */
        ...
        public fun autoBranchCreationConfig(
            autoBranchCreationConfig: AutoBranchCreationConfigProperty.Builder.() -> Unit
        )
         ...
         *
         * @param enableBranchAutoDeletion Automatically disconnect a branch in Amplify Hosting when
         ...
         *
         * @param iamServiceRole AWS Identity and Access Management ( IAM ) service role for the
         ...
         * The OAuth token for a third-party source control system for an Amplify app.
         *
         * The OAuth token is used to create a webhook and a read-only deploy key using SSH cloning.
         ...
         * The platform for the Amplify app.
         *
         * For a static app, set the platform type to `WEB` . For a dynamic server-side rendered
         * (SSR) app, set the platform type to `WEB_COMPUTE` . For an app requiring Amplify
    ...
    private class BuilderImpl(
         ...
         *   creation.
         */
        override fun autoBranchCreationConfig(
            autoBranchCreationConfig: AutoBranchCreationConfigProperty
        ) {
            cdkBuilder.autoBranchCreationConfig(
                autoBranchCreationConfig.let(AutoBranchCreationConfigProperty::unwrap)
            )
        }
        ...
        override fun autoBranchCreationConfig(
            ...
            autoBranchCreationConfig(AutoBranchCreationConfigProperty(autoBranchCreationConfig))
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("70412e491fd213efa06ca1dacddccd8c03669eff817a156e12cf1f84344cb5be")
        override fun basicAuthConfig(
            basicAuthConfig: BasicAuthConfigProperty.Builder.() -> Unit
    ...
    public interface CustomRuleProperty {
         ...
         * * **301** - Represents a 301 (moved pemanently) redirect rule. This and all future
        ...
        public interface Builder {
            /**
             * @param condition The condition for a URL rewrite or redirect rule, such as a country
             *   code.
             */
    ...
    public interface AutoBranchCreationConfigProperty {
         ...
         * opened for the branch. Development and QA teams can use this preview to test the pull
         ...
         * temporary backend environment that it deletes when the pull request is closed. If you
         * want to specify a dedicated backend environment for your previews, use the
         * `PullRequestEnvironmentName` property.
         *
         * For more information, see
         * [Web Previews](https://docs.aws.amazon.com/amplify/latest/userguide/pr-previews.html) in
         ...
         * preview by automatically provisioning a temporary backend environment. Amplify deletes
         ...
         */
        public fun pullRequestEnvironmentName(): String? =
        ...
        public interface Builder {
            /**
             * @param autoBranchCreationPatterns Automated branch creation glob patterns for the
             *   Amplify app.
             */
            ...
            /**
             * @param enableAutoBranchCreation Enables automated branch creation for the Amplify
             *   app.
             */
            ...
            /**
             * @param enablePerformanceMode Enables performance mode for the branch. Performance
             *   mode optimizes for faster hosting performance by keeping content cached at the edge
             *   for a longer interval. When performance mode is enabled, hosting configuration or
            ...
            /**
             * @param enablePullRequestPreview Sets whether pull request previews are enabled for
             *   each branch that Amplify Hosting automatically creates for your app. Amplify
             *   creates previews by deploying your app to a unique URL whenever a pull request is
             *   opened for the branch. Development and QA teams can use this preview to test the
             *   pull request before it's merged into a production or integration branch.
             *
             * To provide backend support for your preview, Amplify Hosting automatically provisions
             * a temporary backend environment that it deletes when the pull request is closed. If
             * you want to specify a dedicated backend environment for your previews, use the
             * `PullRequestEnvironmentName` property.
             *
             * For more information, see
             * [Web Previews](https://docs.aws.amazon.com/amplify/latest/userguide/pr-previews.html)
             * in the *AWS Amplify Hosting User Guide* .
             */
            ...
            /**
             * @param pullRequestEnvironmentName If pull request previews are enabled, you can use
             *   this property to specify a dedicated backend environment for your previews. For
             *   example, you could specify an environment named `prod` , `test` , or `dev` that you
             *   initialized with the Amplify CLI.
             *
             * To enable pull request previews, set the `EnablePullRequestPreview` property to
             * `true` .
             *
             * If you don't specify an environment, Amplify Hosting provides backend support for
             * each preview by automatically provisioning a temporary backend environment. Amplify
        ...
        private class BuilderImpl : Builder {
             ...
             *   Amplify app.
             */
            override fun autoBranchCreationPatterns(
                vararg autoBranchCreationPatterns: String
            ): Unit = autoBranchCreationPatterns(autoBranchCreationPatterns.toList())
            ...
            override fun enableAutoBranchCreation(enableAutoBranchCreation: IResolvable) {
                cdkBuilder.enableAutoBranchCreation(
                    enableAutoBranchCreation.let(IResolvable::unwrap)
                )
            }
            ...
            override fun enablePullRequestPreview(enablePullRequestPreview: IResolvable) {
                cdkBuilder.enablePullRequestPreview(
                    enablePullRequestPreview.let(IResolvable::unwrap)
                )
            }
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-amplify-app-autobranchcreationconfig.html#cfn-amplify-app-autobranchcreationconfig-enableautobranchcreation)
             */
            override fun enableAutoBranchCreation(): Any? =
             ...
             * at the edge for a longer interval. When performance mode is enabled, hosting
             ...
             * automatically creates for your app.
             *
             * Amplify creates previews by deploying your app to a unique URL whenever a pull
             * request is opened for the branch. Development and QA teams can use this preview to
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-amplify-app-autobranchcreationconfig.html#cfn-amplify-app-autobranchcreationconfig-enablepullrequestpreview)
             */
            override fun enablePullRequestPreview(): Any? =
            ...
            /**
             * If pull request previews are enabled, you can use this property to specify a
             * dedicated backend environment for your previews.
             *
             * For example, you could specify an environment named `prod` , `test` , or `dev` that
             * you initialized with the Amplify CLI.
             *
             * To enable pull request previews, set the `EnablePullRequestPreview` property to
             * `true` .
             *
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AutoBranchCreationConfigProperty
            ): software.amazon.awscdk.services.amplify.CfnApp.AutoBranchCreationConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface BasicAuthConfigProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: BasicAuthConfigProperty
            ): software.amazon.awscdk.services.amplify.CfnApp.BasicAuthConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
