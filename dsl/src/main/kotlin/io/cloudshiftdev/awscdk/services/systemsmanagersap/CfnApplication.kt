...
internal constructor(
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.systemsmanagersap.CfnApplication.Builder.create(
                scope,
                id
            )
    ...
    public interface CredentialProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param secretId The secret ID created in AWS Secrets Manager to store the credentials
