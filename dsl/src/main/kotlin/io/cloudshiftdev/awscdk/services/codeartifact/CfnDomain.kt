...
internal constructor(
    ...
    /**
     * When you pass the logical ID of this resource, the function returns the key used to encrypt
     * the domain.
     */
     ...
     * number of the AWS account that owns the domain.
     */
    ...
    public interface Builder {
         ...
         *
         * @param encryptionKey The ARN of an AWS Key Management Service (AWS KMS) key associated
         *   with a domain.
         */
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.codeartifact.CfnDomain =
            cdkBuilder.build()
    }
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnDomain
        ): software.amazon.awscdk.services.codeartifact.CfnDomain = wrapped.cdkObject
    }
}
