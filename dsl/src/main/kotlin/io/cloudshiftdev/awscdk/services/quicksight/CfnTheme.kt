...
internal constructor(
    ...
    /**  */
    public open fun attrVersion(): IResolvable =
        unwrap(this).getAttrVersion().let(IResolvable::wrap)
    ...
    public interface Builder {
         ...
         * The ID of the theme that a custom theme will inherit from.
         *
         * All themes inherit from one of the starting themes defined by Amazon QuickSight. For a
         * list of the starting themes, use `ListThemes` or choose *Themes* from within an analysis.
         *
         ...
         *
         * @param configuration The theme configuration, which contains the theme display
         *   properties.
         */
         ...
         *
         * @param tags A map of the key-value pairs for the resource tag or tags that you want to
         *   add to the resource.
         */
         ...
         * A description of the first version of the theme that you're creating.
         *
         * Every time `UpdateTheme` is called, a new version is created. Each version of the theme
    ...
    private class BuilderImpl(
        ...
        override fun configuration(
            configuration: ThemeConfigurationProperty.Builder.() -> Unit
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnTheme
        ): software.amazon.awscdk.services.quicksight.CfnTheme = wrapped.cdkObject
    }
    ...
    public interface ThemeConfigurationProperty {
        ...
        public interface Builder {
            ...
            public fun dataColorPalette(
                dataColorPalette: DataColorPaletteProperty.Builder.() -> Unit
            )
            ...
            /**
             * @param uiColorPalette Color properties that apply to the UI and to charts, excluding
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("68d5d9bafc6026bd91fb21857236d4b5790fcb02ce11a16be45b02cb65e9c18a")
            override fun uiColorPalette(
                uiColorPalette: UIColorPaletteProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ThemeConfigurationProperty
            ): software.amazon.awscdk.services.quicksight.CfnTheme.ThemeConfigurationProperty =
    ...
    public interface TileLayoutStyleProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TileLayoutStyleProperty
            ): software.amazon.awscdk.services.quicksight.CfnTheme.TileLayoutStyleProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ThemeVersionProperty {
        ...
        public interface Builder {
             ...
             *   inherits from. All themes initially inherit from a default Amazon QuickSight theme.
             */
            public fun baseThemeId(baseThemeId: String)
    ...
    public interface UIColorPaletteProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param accentForeground The foreground color that applies to any text or other
            ...
            /**
             * @param dangerForeground The foreground color that applies to any text or other
            ...
            /**
             * @param dimensionForeground The foreground color that applies to any text or other
            ...
            /**
             * @param measureForeground The foreground color that applies to any text or other
            ...
            /**
             * @param primaryForeground The color of text and other foreground elements that appear
             *   over the primary background regions, such as grid lines, borders, table banding,
             *   icons, and so on.
             */
            public fun primaryForeground(primaryForeground: String)

            /**
             * @param secondaryBackground The background color that applies to the sheet background
             *   and sheet controls.
             */
            public fun secondaryBackground(secondaryBackground: String)

            /**
             * @param secondaryForeground The foreground color that applies to any sheet title,
             *   sheet control text, or UI that appears over the secondary background.
             */
            public fun secondaryForeground(secondaryForeground: String)

            /**
             * @param success The color that applies to success messages, for example the check mark
             *   for a successful download.
             */
            public fun success(success: String)

            /**
             * @param successForeground The foreground color that applies to any text or other
            ...
            /**
             * @param warningForeground The foreground color that applies to any text or other
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: UIColorPaletteProperty
            ): software.amazon.awscdk.services.quicksight.CfnTheme.UIColorPaletteProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DataColorPaletteProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param emptyFillColor The hexadecimal code of a color that applies to charts where a
             *   lack of data is highlighted.
             */
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-quicksight-theme-datacolorpalette.html#cfn-quicksight-theme-datacolorpalette-minmaxgradient)
             */
            override fun minMaxGradient(): List<String> =
                unwrap(this).getMinMaxGradient() ?: emptyList()
        }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DataColorPaletteProperty
            ): software.amazon.awscdk.services.quicksight.CfnTheme.DataColorPaletteProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface GutterStyleProperty {
        ...
        public interface Builder {
            /**
             * @param show This Boolean value controls whether to display a gutter space between
             *   sheet tiles.
             */
            public fun show(show: Boolean)
