...
internal constructor(
    ...
    public interface Builder {
         ...
         * The IDs of one or more subnets.
         *
         * You can specify only one subnet per Availability Zone. You must specify at least one
         * subnet, but we recommend that you specify two subnets for better availability. The
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.ec2.CfnTransitGatewayAttachment.Builder.create(
                scope,
                id
            )
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnTransitGatewayAttachment
    ...
    public interface OptionsProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param securityGroupReferencingSupport Enables you to reference a security group
             *   across VPCs attached to a transit gateway (TGW). Use this option to simplify
             *   security group management and control of instance-to-instance traffic across VPCs
             *   that are connected by transit gateway. You can also use this option to migrate from
             *   VPC peering (which was the only option that supported security group referencing)
             *   to transit gateways (which now also support security group referencing). This
        ...
        internal constructor(
             ...
             * (TGW).
             *
             * Use this option to simplify security group management and control of
             * instance-to-instance traffic across VPCs that are connected by transit gateway. You
             * can also use this option to migrate from VPC peering (which was the only option that
             * supported security group referencing) to transit gateways (which now also support
             * security group referencing). This option is disabled by default and there are no
