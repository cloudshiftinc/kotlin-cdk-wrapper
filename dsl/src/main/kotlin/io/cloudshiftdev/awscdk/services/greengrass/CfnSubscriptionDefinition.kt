...
internal constructor(
    ...
    public open fun initialVersion(
        `value`: SubscriptionDefinitionVersionProperty.Builder.() -> Unit
    ...
    public interface Builder {
         ...
         *
         * @param initialVersion The subscription definition version to include when the
         *   subscription definition is created.
         */
        ...
        public fun initialVersion(
            initialVersion: SubscriptionDefinitionVersionProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.greengrass.CfnSubscriptionDefinition.Builder.create(
                scope,
                id
            )
        ...
        override fun initialVersion(initialVersion: SubscriptionDefinitionVersionProperty) {
            cdkBuilder.initialVersion(
                initialVersion.let(SubscriptionDefinitionVersionProperty::unwrap)
            )
        }
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnSubscriptionDefinition
    ...
    public interface SubscriptionDefinitionVersionProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SubscriptionDefinitionVersionProperty
            ): software.amazon.awscdk.services.greengrass.CfnSubscriptionDefinition.SubscriptionDefinitionVersionProperty =
    ...
    public interface SubscriptionProperty {
         ...
         *
         * This value must be unique within the subscription definition version. Maximum length is
         ...
         *
         * The value can be a thing ARN, the ARN of a Lambda function alias (recommended) or
         * version, a connector ARN, `cloud` (which represents the AWS IoT cloud), or
         * `GGShadowService` .
         *
        ...
        public interface Builder {
            /**
             * @param id A descriptive or arbitrary ID for the subscription. This value must be
             *   unique within the subscription definition version. Maximum length is 128 characters
             *   with pattern `[a-zA-Z0-9:_-]+` .
             */
            public fun id(id: String)

            /**
             * @param source The originator of the message. The value can be a thing ARN, the ARN of
             *   a Lambda function alias (recommended) or version, a connector ARN, `cloud` (which
            ...
            /**
             * @param target The destination of the message. The value can be a thing ARN, the ARN
             *   of a Lambda function alias (recommended) or version, a connector ARN, `cloud`
        ...
        internal constructor(
             ...
             * A descriptive or arbitrary ID for the subscription.
             *
             * This value must be unique within the subscription definition version. Maximum length
