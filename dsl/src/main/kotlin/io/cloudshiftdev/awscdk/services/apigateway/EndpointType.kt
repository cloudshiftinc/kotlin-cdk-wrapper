...
public enum class EndpointType(
    ...
    public companion object {
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.apigateway.EndpointType
        ): EndpointType =
            when (cdkObject) {
                software.amazon.awscdk.services.apigateway.EndpointType.EDGE -> EndpointType.EDGE
                software.amazon.awscdk.services.apigateway.EndpointType.REGIONAL ->
                    EndpointType.REGIONAL
                software.amazon.awscdk.services.apigateway.EndpointType.PRIVATE ->
