...
internal constructor(
    ...
    public open fun schemaChangePolicy(
        `value`: SchemaChangePolicyProperty.Builder.() -> Unit
    ): Unit = schemaChangePolicy(SchemaChangePolicyProperty(`value`))
    ...
    public interface Builder {
         ...
         *
         * @param classifiers A list of UTF-8 strings that specify the names of custom classifiers
         ...
         * Crawler configuration information.
         *
         * This versioned JSON string allows users to specify aspects of a crawler's behavior. For
         ...
         *
         * @param crawlerSecurityConfiguration The name of the `SecurityConfiguration` structure to
         ...
         *
         * @param recrawlPolicy A policy that specifies whether to crawl the entire dataset again,
        ...
        public fun schemaChangePolicy(
            schemaChangePolicy: SchemaChangePolicyProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
         ...
         *   that are associated with the crawler.
         */
        override fun classifiers(vararg classifiers: String): Unit =
        ...
        override fun schemaChangePolicy(schemaChangePolicy: SchemaChangePolicyProperty) {
            cdkBuilder.schemaChangePolicy(
                schemaChangePolicy.let(SchemaChangePolicyProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("b716e27af2a3d3a2fad1065e6f782d8ab4f64ae1928e7549f53995479842be3c")
        override fun schemaChangePolicy(
            schemaChangePolicy: SchemaChangePolicyProperty.Builder.() -> Unit
    ...
    public interface S3TargetProperty {
        ...
        public interface Builder {
            /**
             * @param connectionName The name of a connection which allows a job or crawler to
             *   access data in Amazon S3 within an Amazon Virtual Private Cloud environment (Amazon
             *   VPC).
             */
            ...
            /**
             * @param eventQueueArn A valid Amazon SQS ARN. For example,
            ...
            /**
             * @param sampleSize Sets the number of files in each leaf folder to be crawled when
             *   crawling sample files in a dataset. If not set, all the files are crawled. A valid
        ...
        private class BuilderImpl : Builder {
             ...
             *   .
             */
            override fun exclusions(vararg exclusions: String): Unit =
    ...
    public interface RecrawlPolicyProperty {
        ...
        public interface Builder {
            /**
             * @param recrawlBehavior Specifies whether to crawl the entire dataset again or to
             *   crawl only folders that were added since the last crawler run. A value of
             *   `CRAWL_EVERYTHING` specifies crawling the entire dataset again.
             *
    ...
    public interface CatalogTargetProperty {
        ...
        public interface Builder {
            /**
             * @param connectionName The name of the connection for an Amazon S3-backed Data Catalog
             *   table to be a target of the crawl when using a `Catalog` connection type paired
        ...
        internal constructor(
             ...
             * of the crawl when using a `Catalog` connection type paired with a `NETWORK`
             * Connection type.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-glue-crawler-catalogtarget.html#cfn-glue-crawler-catalogtarget-connectionname)
             */
    ...
    public interface SchemaChangePolicyProperty {
         ...
         *
         * A value of `LOG` specifies that if a table or partition is found to no longer exist, do
         * not delete it, only log that it was found to no longer exist.
         *
         ...
         * exist, to add a property to the table that says "DEPRECATED" and includes a timestamp
         * with the time of deprecation.
         *
         ...
         *
         * A value of `UPDATE_IN_DATABASE` specifies that if a table or partition already exists,
         * and a change is detected, update it. Add new tables and partitions.
         *
        ...
        public interface Builder {
             ...
             *   A value of `LOG` specifies that if a table or partition is found to no longer
             *   exist, do not delete it, only log that it was found to no longer exist.
             *
             * A value of `DELETE_FROM_DATABASE` specifies that if a table or partition is found to
             * have been removed, delete it from the database.
             *
             * A value of `DEPRECATE_IN_DATABASE` specifies that if a table has been found to no
             * longer exist, to add a property to the table that says "DEPRECATED" and includes a
             * timestamp with the time of deprecation.
             */
            public fun deleteBehavior(deleteBehavior: String)

            /**
             * @param updateBehavior The update behavior when the crawler finds a changed schema. A
             *   value of `LOG` specifies that if a table or a partition already exists, and a
             *   change is detected, do not update it, only log that a change was detected. Add new
             *   tables and new partitions (including on existing tables).
             *
             * A value of `UPDATE_IN_DATABASE` specifies that if a table or partition already
             * exists, and a change is detected, update it. Add new tables and partitions.
             */
        ...
        internal constructor(
             ...
             * The deletion behavior when the crawler finds a deleted object.
             *
             * A value of `LOG` specifies that if a table or partition is found to no longer exist,
             * do not delete it, only log that it was found to no longer exist.
             *
             * A value of `DELETE_FROM_DATABASE` specifies that if a table or partition is found to
             * have been removed, delete it from the database.
             *
             ...
             * The update behavior when the crawler finds a changed schema.
             *
             * A value of `LOG` specifies that if a table or a partition already exists, and a
             * change is detected, do not update it, only log that a change was detected. Add new
             * tables and new partitions (including on existing tables).
             *
             * A value of `UPDATE_IN_DATABASE` specifies that if a table or partition already
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SchemaChangePolicyProperty
            ): software.amazon.awscdk.services.glue.CfnCrawler.SchemaChangePolicyProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DeltaTargetProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param createNativeDeltaTable Specifies whether the crawler will create native
             *   tables, to allow integration with query engines that support querying of the Delta
            ...
            /**
             * @param writeManifest Specifies whether to write the manifest files to the Delta table
             *   path.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            /** @param deltaTables A list of the Amazon S3 paths to the Delta tables. */
            override fun deltaTables(vararg deltaTables: String): Unit =
                deltaTables(deltaTables.toList())
    ...
    public interface TargetsProperty {
        ...
        private class BuilderImpl : Builder {
            ...
            /** @param jdbcTargets Specifies JDBC targets. */
            override fun jdbcTargets(vararg jdbcTargets: Any): Unit =
                jdbcTargets(jdbcTargets.toList())
    ...
    public interface DynamoDBTargetProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DynamoDBTargetProperty
            ): software.amazon.awscdk.services.glue.CfnCrawler.DynamoDBTargetProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface MongoDBTargetProperty {
        ...
        public interface Builder {
            /**
             * @param connectionName The name of the connection to use to connect to the Amazon
             *   DocumentDB or MongoDB target.
             */
            public fun connectionName(connectionName: String)

            /**
             * @param path The path of the Amazon DocumentDB or MongoDB target
             *   (database/collection).
             */
            public fun path(path: String)
        }
    ...
    public interface IcebergTargetProperty {
         ...
         * Iceberg metadata folder in your Amazon S3 path.
         *
        ...
        public interface Builder {
            /**
             * @param connectionName The name of the connection to use to connect to the Iceberg
             *   target.
             */
            public fun connectionName(connectionName: String)
            ...
            /**
             * @param maximumTraversalDepth The maximum depth of Amazon S3 paths that the crawler
             *   can traverse to discover the Iceberg metadata folder in your Amazon S3 path. Used
    ...
    public interface JdbcTargetProperty {
        ...
        public interface Builder {
            /**
             * @param connectionName The name of the connection to use to connect to the JDBC
             *   target.
             */
            public fun connectionName(connectionName: String)
