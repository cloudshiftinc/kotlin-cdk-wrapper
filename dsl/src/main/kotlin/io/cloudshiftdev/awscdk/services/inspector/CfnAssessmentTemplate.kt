...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param assessmentTargetArn The ARN of the assessment target to be included in the
         *   assessment template.
         */
         ...
         * The user-defined name that identifies the assessment template that you want to create.
         *
         * You can create several assessment templates for the same assessment target. The names of
         ...
         *
         * @param assessmentTemplateName The user-defined name that identifies the assessment
         ...
         *
         * @param rulesPackageArns The ARNs of the rules packages that you want to use in the
         *   assessment template.
         */
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.inspector.CfnAssessmentTemplate.Builder.create(
                scope,
                id
            )
