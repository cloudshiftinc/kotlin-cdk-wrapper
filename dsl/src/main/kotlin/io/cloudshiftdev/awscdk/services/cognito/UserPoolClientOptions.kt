...
public interface UserPoolClientOptions {
     ...
     * `AuthSessionValidity`. Valid duration is from 3 to 15 minutes.
     *
     ...
     * user pool and/or identity providers are imported, either specify this option explicitly or
     * ensure that the identity providers are registered with the user pool using the
    ...
    public interface Builder {
        /**
         * @param accessTokenValidity Validity of the access token. Values between 5 minutes and 1
         *   day are valid. The duration can not be longer than the refresh token validity.
         */
        ...
        /**
         * @param oAuth OAuth settings for this client to interact with the app. An error is thrown
         *   when this is specified and `disableOAuth` is set.
         */
        ...
        /**
         * @param preventUserExistenceErrors Whether Cognito returns a UserNotFoundException
         *   exception when the user does not exist in the user pool (false), or whether it returns
        ...
        /**
         * @param refreshTokenValidity Validity of the refresh token. Values between 60 minutes and
         *   10 years are valid.
         */
        public fun refreshTokenValidity(refreshTokenValidity: Duration)

        /**
         * @param supportedIdentityProviders The list of identity providers that users should be
         *   able to use to sign in using this client.
         */
        public fun supportedIdentityProviders(
            supportedIdentityProviders: List<UserPoolClientIdentityProvider>
        )
    ...
    private class BuilderImpl : Builder {
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("aa4601c197d8996c76173a2c079517708a09b12b5cbab765a15be3d4c1a5f52d")
        override fun oAuth(oAuth: OAuthSettings.Builder.() -> Unit): Unit =
        ...
        override fun supportedIdentityProviders(
            ...
            cdkBuilder.supportedIdentityProviders(
                supportedIdentityProviders.map(UserPoolClientIdentityProvider::unwrap)
            )
        }
        ...
        override fun supportedIdentityProviders(
            vararg supportedIdentityProviders: UserPoolClientIdentityProvider
        ): Unit = supportedIdentityProviders(supportedIdentityProviders.toList())
    ...
    internal constructor(
         ...
         * Validity of the access token.
         *
         * Values between 5 minutes and 1 day are valid. The duration can not be longer than the
         ...
         * The set of OAuth authentication flows to enable on the client.
         *
         * Default: - If you don't specify a value, your user client supports
        ...
        /**
         * Whether Cognito returns a UserNotFoundException exception when the user does not exist in
         * the user pool (false), or whether it returns another type of error that doesn't reveal
         * the user's absence.
         *
         * Default: false
         *
        ...
        /**
         * The list of identity providers that users should be able to use to sign in using this
         * client.
         *
         * Default: - supports all identity providers that are registered with the user pool. If the
         * user pool and/or identity providers are imported, either specify this option explicitly
         * or ensure that the identity providers are registered with the user pool using the
         * `UserPool.registerIdentityProvider()` API.
         */
