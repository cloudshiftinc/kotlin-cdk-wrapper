...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param dbClusterIdentifier The cluster identifier. This parameter is stored as a
         *   lowercase string.
         */
         ...
         *
         * @param dbClusterParameterGroupName The name of the cluster parameter group to associate
         *   with this cluster.
         */
         ...
         * workloads, we recommend explicitly declaring this parameter with the intended major
         * engine version.
         *
         ...
         * encryption key that is used to encrypt the new cluster, you can use the AWS KMS key alias
         ...
         *
         * @param sourceDbClusterIdentifier The identifier of the source cluster from which to
         *   restore.
         */
         ...
         *
         * @param useLatestRestorableTime A value that is set to `true` to restore the cluster to
         ...
         *
         * @param vpcSecurityGroupIds A list of EC2 VPC security groups to associate with this
         *   cluster.
         */
    ...
    public companion object {
        ...
        ): software.amazon.awscdk.services.docdb.CfnDBCluster = wrapped.cdkObject
    }
}
