...
internal constructor(
    ...
    public open fun practiceRunConfiguration(`value`: PracticeRunConfigurationProperty) {
        unwrap(this)
            .setPracticeRunConfiguration(`value`.let(PracticeRunConfigurationProperty::unwrap))
    }
    ...
    public open fun practiceRunConfiguration(
        `value`: PracticeRunConfigurationProperty.Builder.() -> Unit
    ...
    public interface Builder {
        /**
         * A practice run configuration for a resource includes the Amazon CloudWatch alarms that
         * you've specified for a practice run, as well as any blocked dates or blocked windows for
         * the practice run.
         *
         * When a resource has a practice run configuration, Route 53 ARC shifts traffic for the
         * resource weekly for practice runs.
         *
         * Practice runs are required for zonal autoshift. The zonal shifts that Route 53 ARC starts
         * for practice runs help you to ensure that shifting away traffic from an Availability Zone
         ...
         *   Amazon CloudWatch alarms that you've specified for a practice run, as well as any
         *   blocked dates or blocked windows for the practice run.
         */
        ...
        public fun practiceRunConfiguration(
            practiceRunConfiguration: PracticeRunConfigurationProperty.Builder.() -> Unit
        )
         ...
         * an application from an Availability Zone during events, on your behalf, to help reduce
         * time to recovery.
         *
         ...
         *
         * @param zonalAutoshiftStatus When zonal autoshift is `ENABLED` , you authorize AWS to
         *   shift away resource traffic for an application from an Availability Zone during events,
    ...
    private class BuilderImpl(
         ...
         *   blocked dates or blocked windows for the practice run.
         */
        override fun practiceRunConfiguration(
            practiceRunConfiguration: PracticeRunConfigurationProperty
        ) {
            cdkBuilder.practiceRunConfiguration(
                practiceRunConfiguration.let(PracticeRunConfigurationProperty::unwrap)
            )
        }
        ...
        override fun practiceRunConfiguration(
            ...
            practiceRunConfiguration(PracticeRunConfigurationProperty(practiceRunConfiguration))
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnZonalAutoshiftConfiguration
        ): software.amazon.awscdk.services.arczonalshift.CfnZonalAutoshiftConfiguration =
            wrapped.cdkObject
    }
    ...
    public interface PracticeRunConfigurationProperty {
        ...
        /**
         * The alarm that you specify to monitor the health of your application during practice
         * runs.
         *
        ...
        public interface Builder {
            /**
             * @param blockedDates An array of one or more dates that you can specify when AWS does
             *   not start practice runs for a resource. Dates are in UTC.
             *
             * Specify blocked dates in the format `YYYY-MM-DD` , separated by spaces.
             */
            ...
            /**
             * @param blockedWindows An array of one or more days and times that you can specify
             *   when Route 53 ARC does not start practice runs for a resource. Days and times are
             *   in UTC.
             *
             * Specify blocked windows in the format `DAY:HH:MM-DAY:HH:MM` , separated by spaces.
             * For example, `MON:18:30-MON:19:30 TUE:18:30-TUE:19:30` .
             */
            ...
            /**
             * @param blockingAlarms An optional alarm that you can specify that blocks practice
             *   runs when the alarm is in an `ALARM` state. When a blocking alarm goes into an
             *   `ALARM` state, it prevents practice runs from being started, and ends practice runs
            ...
            /**
             * @param outcomeAlarms The alarm that you specify to monitor the health of your
             *   application during practice runs. When the outcome alarm goes into an `ALARM`
        ...
        internal constructor(
            ...
            /**
             * An array of one or more dates that you can specify when AWS does not start practice
             * runs for a resource.
             *
             * Dates are in UTC.
             *
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-arczonalshift-zonalautoshiftconfiguration-practicerunconfiguration.html#cfn-arczonalshift-zonalautoshiftconfiguration-practicerunconfiguration-blockeddates)
             */
            override fun blockedDates(): List<String> =
                unwrap(this).getBlockedDates() ?: emptyList()

            /**
             * An array of one or more days and times that you can specify when Route 53 ARC does
             * not start practice runs for a resource.
             *
             * Days and times are in UTC.
             *
             * Specify blocked windows in the format `DAY:HH:MM-DAY:HH:MM` , separated by spaces.
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-arczonalshift-zonalautoshiftconfiguration-practicerunconfiguration.html#cfn-arczonalshift-zonalautoshiftconfiguration-practicerunconfiguration-blockedwindows)
             */
            override fun blockedWindows(): List<String> =
                unwrap(this).getBlockedWindows() ?: emptyList()

            /**
             * An optional alarm that you can specify that blocks practice runs when the alarm is in
             * an `ALARM` state.
             *
             * When a blocking alarm goes into an `ALARM` state, it prevents practice runs from
             * being started, and ends practice runs that are in progress.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-arczonalshift-zonalautoshiftconfiguration-practicerunconfiguration.html#cfn-arczonalshift-zonalautoshiftconfiguration-practicerunconfiguration-blockingalarms)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: PracticeRunConfigurationProperty
            ): software.amazon.awscdk.services.arczonalshift.CfnZonalAutoshiftConfiguration.PracticeRunConfigurationProperty =
    ...
    public interface ControlConditionProperty {
        /**
         * The Amazon Resource Name (ARN) for an Amazon CloudWatch alarm that you specify as a
         * control condition for a practice run.
         *
         ...
         *
         * You can only specify Amazon CloudWatch alarms for practice runs, so the only valid value
         * is `CLOUDWATCH` .
         *
        ...
        public interface Builder {
            /**
             * @param alarmIdentifier The Amazon Resource Name (ARN) for an Amazon CloudWatch alarm
             *   that you specify as a control condition for a practice run.
             */
            public fun alarmIdentifier(alarmIdentifier: String)

            /**
             * @param type The type of alarm specified for a practice run. You can only specify
             *   Amazon CloudWatch alarms for practice runs, so the only valid value is `CLOUDWATCH`
             *   .
             */
        ...
        internal constructor(
             ...
             * The type of alarm specified for a practice run.
             *
             * You can only specify Amazon CloudWatch alarms for practice runs, so the only valid
             * value is `CLOUDWATCH` .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-arczonalshift-zonalautoshiftconfiguration-controlcondition.html#cfn-arczonalshift-zonalautoshiftconfiguration-controlcondition-type)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ControlConditionProperty
            ): software.amazon.awscdk.services.arczonalshift.CfnZonalAutoshiftConfiguration.ControlConditionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
