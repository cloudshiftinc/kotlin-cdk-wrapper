...
public enum class FunctionUrlAuthType(
    ...
    public companion object {
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.lambda.FunctionUrlAuthType
        ): FunctionUrlAuthType =
            when (cdkObject) {
                software.amazon.awscdk.services.lambda.FunctionUrlAuthType.AWS_IAM ->
                    FunctionUrlAuthType.AWS_IAM
                software.amazon.awscdk.services.lambda.FunctionUrlAuthType.NONE ->
                    FunctionUrlAuthType.NONE
            }

        internal fun unwrap(
            wrapped: FunctionUrlAuthType
