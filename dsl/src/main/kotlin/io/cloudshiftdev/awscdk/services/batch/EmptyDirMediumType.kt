...
public enum class EmptyDirMediumType(
    ...
    public companion object {
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.batch.EmptyDirMediumType
        ): EmptyDirMediumType =
            when (cdkObject) {
                software.amazon.awscdk.services.batch.EmptyDirMediumType.DISK ->
                    EmptyDirMediumType.DISK
                software.amazon.awscdk.services.batch.EmptyDirMediumType.MEMORY ->
                    EmptyDirMediumType.MEMORY
            }

        internal fun unwrap(
            wrapped: EmptyDirMediumType
