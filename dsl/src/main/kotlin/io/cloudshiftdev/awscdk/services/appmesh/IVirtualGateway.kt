...
public interface IVirtualGateway : IResource {
    ...
    public fun addGatewayRoute(
        id: String,
        route: GatewayRouteBaseProps.Builder.() -> Unit
    ): GatewayRoute
    ...
    internal constructor(
        ...
        override fun addGatewayRoute(id: String, route: GatewayRouteBaseProps): GatewayRoute =
            unwrap(this)
                .addGatewayRoute(id, route.let(GatewayRouteBaseProps::unwrap))
