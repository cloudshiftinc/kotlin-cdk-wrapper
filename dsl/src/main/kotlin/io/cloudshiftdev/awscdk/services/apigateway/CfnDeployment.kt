...
internal constructor(
    ...
    public open fun deploymentCanarySettings(`value`: DeploymentCanarySettingsProperty) {
        unwrap(this)
            .setDeploymentCanarySettings(`value`.let(DeploymentCanarySettingsProperty::unwrap))
    }

    /** The input configuration for a canary deployment. */
    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("9d366cb36b5ef986853d4804c23d44ce7bb106cf9af58824eda92be6e1ce71c4")
    public open fun deploymentCanarySettings(
        `value`: DeploymentCanarySettingsProperty.Builder.() -> Unit
    ...
    public interface Builder {
        ...
        public fun deploymentCanarySettings(
            deploymentCanarySettings: DeploymentCanarySettingsProperty.Builder.() -> Unit
        )
         ...
         *
         * @param stageDescription The description of the Stage resource for the Deployment resource
         *   to create.
         */
    ...
    private class BuilderImpl(
         ...
         * @param deploymentCanarySettings The input configuration for a canary deployment.
         */
        override fun deploymentCanarySettings(
            deploymentCanarySettings: DeploymentCanarySettingsProperty
        ) {
            cdkBuilder.deploymentCanarySettings(
                deploymentCanarySettings.let(DeploymentCanarySettingsProperty::unwrap)
            )
        }
        ...
        override fun deploymentCanarySettings(
            ...
            deploymentCanarySettings(DeploymentCanarySettingsProperty(deploymentCanarySettings))
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("2e7de6599aa5bbb04a85de443363a03d57d178779fe82e4ad4710eb5076fe1fd")
        override fun stageDescription(
            stageDescription: StageDescriptionProperty.Builder.() -> Unit
    ...
    public interface StageDescriptionProperty {
         ...
         *
         * You must enable a cache cluster on the stage to cache responses. For more information,
         * see
         * [Enable API Gateway Caching in a Stage to Enhance API Performance](https://docs.aws.amazon.com/apigateway/latest/developerguide/api-gateway-caching.html)
         ...
         *
         * This allows more requests through for a period of time than the target rate limit. For
         * more information, see
         * [Manage API Request Throttling](https://docs.aws.amazon.com/apigateway/latest/developerguide/api-gateway-request-throttling.html)
         * in the *API Gateway Developer Guide* .
         *
         ...
         *
         * For more information, see
         * [Trace API Gateway API Execution with AWS X-Ray](https://docs.aws.amazon.com/apigateway/latest/developerguide/apigateway-xray.html)
         * in the *API Gateway Developer Guide* .
         *
        ...
        public interface Builder {
            ...
            public fun accessLogSetting(
                accessLogSetting: AccessLogSettingProperty.Builder.() -> Unit
            )

            /**
             * @param cacheClusterEnabled Specifies whether a cache cluster is enabled for the
             *   stage. To activate a method-level cache, set `CachingEnabled` to `true` for a
             *   method.
             */
            ...
            /**
             * @param cacheClusterSize The size of the stage's cache cluster. For more information,
             *   see
             *   [cacheClusterSize](https://docs.aws.amazon.com/apigateway/latest/api/API_CreateStage.html#apigw-CreateStage-request-cacheClusterSize)
             *   in the *API Gateway API Reference* .
             */
            ...
            /**
             * @param cacheTtlInSeconds The time-to-live (TTL) period, in seconds, that specifies
             *   how long API Gateway caches responses.
             */
            public fun cacheTtlInSeconds(cacheTtlInSeconds: Number)

            /**
             * @param cachingEnabled Indicates whether responses are cached and returned for
             *   requests. You must enable a cache cluster on the stage to cache responses. For more
             *   information, see
             *   [Enable API Gateway Caching in a Stage to Enhance API Performance](https://docs.aws.amazon.com/apigateway/latest/developerguide/api-gateway-caching.html)
             *   in the *API Gateway Developer Guide* .
             */
            ...
            /**
             * @param clientCertificateId The identifier of the client certificate that API Gateway
             *   uses to call your integration endpoints in the stage.
             */
            public fun clientCertificateId(clientCertificateId: String)

            /**
             * @param dataTraceEnabled Indicates whether data trace logging is enabled for methods
             *   in the stage. API Gateway pushes these logs to Amazon CloudWatch Logs.
             */
            ...
            /**
             * @param loggingLevel The logging level for this method. For valid values, see the
             *   `loggingLevel` property of the
             *   [MethodSetting](https://docs.aws.amazon.com/apigateway/latest/api/API_MethodSetting.html)
             *   resource in the *Amazon API Gateway API Reference* .
             */
            ...
            /**
             * @param metricsEnabled Indicates whether Amazon CloudWatch metrics are enabled for
            ...
            /**
             * @param throttlingBurstLimit The target request burst rate limit. This allows more
             *   requests through for a period of time than the target rate limit. For more
             *   information, see
             *   [Manage API Request Throttling](https://docs.aws.amazon.com/apigateway/latest/developerguide/api-gateway-request-throttling.html)
             *   in the *API Gateway Developer Guide* .
             */
            ...
            /**
             * @param throttlingRateLimit The target request steady-state rate limit. For more
             *   information, see
             *   [Manage API Request Throttling](https://docs.aws.amazon.com/apigateway/latest/developerguide/api-gateway-request-throttling.html)
             *   in the *API Gateway Developer Guide* .
             */
             ...
             *   of alphanumeric characters, and the values must match the following regular
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("8948c21342fa6203010c93bd677f84e3fb2e90cc6c8fb095b4ad6010817b89f1")
            override fun canarySetting(
                canarySetting: CanarySettingProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * Indicates whether responses are cached and returned for requests.
             *
             * You must enable a cache cluster on the stage to cache responses. For more
             * information, see
             * [Enable API Gateway Caching in a Stage to Enhance API Performance](https://docs.aws.amazon.com/apigateway/latest/developerguide/api-gateway-caching.html)
             * in the *API Gateway Developer Guide* .
             *
            ...
            /**
             * The identifier of the client certificate that API Gateway uses to call your
             * integration endpoints in the stage.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-apigateway-deployment-stagedescription.html#cfn-apigateway-deployment-stagedescription-clientcertificateid)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: StageDescriptionProperty
            ): software.amazon.awscdk.services.apigateway.CfnDeployment.StageDescriptionProperty =
    ...
    public interface DeploymentCanarySettingsProperty {
         ...
         * release deployment. These stage variables are represented as a string-to-string map
        ...
        public interface Builder {
             ...
             *   deployment. They can override existing stage variables or add new stage variables
             *   for the canary release deployment. These stage variables are represented as a
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DeploymentCanarySettingsProperty
            ): software.amazon.awscdk.services.apigateway.CfnDeployment.DeploymentCanarySettingsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface AccessLogSettingProperty {
        ...
        public interface Builder {
            /**
             * @param destinationArn The Amazon Resource Name (ARN) of the CloudWatch Logs log group
             *   or Kinesis Data Firehose delivery stream to receive access logs. If you specify a
            ...
            /**
             * @param format A single line format of the access logs of data, as specified by
             *   selected $context variables. The format must include at least `$context.requestId`
             *   .
             */
        ...
        internal constructor(
             ...
             * Firehose delivery stream to receive access logs.
             *
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AccessLogSettingProperty
            ): software.amazon.awscdk.services.apigateway.CfnDeployment.AccessLogSettingProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface MethodSettingProperty {
         ...
         * entries to CloudWatch Logs, or choose `INFO` to include all `ERROR` events as well as
        ...
        public interface Builder {
             ...
             *   requests. A cache cluster must be enabled on the stage for responses to be cached.
             */
            public fun cachingEnabled(cachingEnabled: Boolean)
            ...
            /**
             * @param dataTraceEnabled Specifies whether data trace logging is enabled for this
             *   method, which affects the log entries pushed to Amazon CloudWatch Logs. This can be
             *   useful to troubleshoot APIs, but can result in logging sensitive data. We recommend
            ...
            /**
             * @param loggingLevel Specifies the logging level for this method, which affects the
             *   log entries pushed to Amazon CloudWatch Logs. Valid values are `OFF` , `ERROR` ,
             *   and `INFO` . Choose `ERROR` to write only error-level entries to CloudWatch Logs,
             *   or choose `INFO` to include all `ERROR` events as well as extra informational
             *   events.
             */
            public fun loggingLevel(loggingLevel: String)

            /**
             * @param metricsEnabled Specifies whether Amazon CloudWatch metrics are enabled for
             *   this method.
             */
            public fun metricsEnabled(metricsEnabled: Boolean)
            ...
            /**
             * @param resourcePath The resource path for this method. Forward slashes ( `/` ) are
             *   encoded as `~1` and the initial slash must include a forward slash. For example,
        ...
        internal constructor(
             ...
             * Amazon CloudWatch Logs.
             *
             * Valid values are `OFF` , `ERROR` , and `INFO` . Choose `ERROR` to write only
             * error-level entries to CloudWatch Logs, or choose `INFO` to include all `ERROR`
             ...
             * The resource path for this method.
             *
             * Forward slashes ( `/` ) are encoded as `~1` and the initial slash must include a
             * forward slash. For example, the path value `/resource/subresource` must be encoded as
             * `/~1resource~1subresource` . To specify the root path, use only a slash ( `/` ).
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-apigateway-deployment-methodsetting.html#cfn-apigateway-deployment-methodsetting-resourcepath)
             */
    ...
    public interface CanarySettingProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param stageVariableOverrides Stage variables overridden for a canary release
             *   deployment, including new stage variables introduced in the canary. These stage
             *   variables are represented as a string-to-string map between stage variable names
             *   and their values.
             */
            public fun stageVariableOverrides(stageVariableOverrides: IResolvable)
            ...
            /**
             * @param useStageCache A Boolean flag to indicate whether the canary deployment uses
        ...
        internal constructor(
             ...
             * variables introduced in the canary.
             *
             * These stage variables are represented as a string-to-string map between stage
