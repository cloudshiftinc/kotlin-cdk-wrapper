...
internal constructor(
    ...
    public open fun dataQualityAppSpecification(): Any =
        unwrap(this).getDataQualityAppSpecification()
    ...
    public open fun dataQualityAppSpecification(`value`: DataQualityAppSpecificationProperty) {
        unwrap(this)
            .setDataQualityAppSpecification(
                `value`.let(DataQualityAppSpecificationProperty::unwrap)
            )
    }
    ...
    public open fun dataQualityAppSpecification(
        `value`: DataQualityAppSpecificationProperty.Builder.() -> Unit
    ...
    public open fun dataQualityBaselineConfig(`value`: DataQualityBaselineConfigProperty) {
        unwrap(this)
            .setDataQualityBaselineConfig(`value`.let(DataQualityBaselineConfigProperty::unwrap))
    }

    /** Configures the constraints and baselines for the monitoring job. */
    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("7b9ca5fec36608b0220626c08570819586485fb777d40d3df3e257cff51cde8f")
    public open fun dataQualityBaselineConfig(
        `value`: DataQualityBaselineConfigProperty.Builder.() -> Unit
    ...
    public open fun dataQualityJobInput(
        `value`: DataQualityJobInputProperty.Builder.() -> Unit
    ): Unit = dataQualityJobInput(DataQualityJobInputProperty(`value`))
    ...
    public open fun dataQualityJobOutputConfig(`value`: MonitoringOutputConfigProperty) {
        unwrap(this)
            .setDataQualityJobOutputConfig(`value`.let(MonitoringOutputConfigProperty::unwrap))
    }

    /** The output configuration for monitoring jobs. */
    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("3beab3de9b772d64b24254795f69ac6747af8571982ff57cc4c8163e17eae694")
    public open fun dataQualityJobOutputConfig(
    ...
    public interface Builder {
        ...
        public fun dataQualityAppSpecification(
            dataQualityAppSpecification: DataQualityAppSpecificationProperty.Builder.() -> Unit
        )
         ...
         *
         * @param dataQualityBaselineConfig Configures the constraints and baselines for the
         *   monitoring job.
         */
        ...
        public fun dataQualityBaselineConfig(
            dataQualityBaselineConfig: DataQualityBaselineConfigProperty.Builder.() -> Unit
        )
        ...
        public fun dataQualityJobInput(
            dataQualityJobInput: DataQualityJobInputProperty.Builder.() -> Unit
        )
        ...
        public fun dataQualityJobOutputConfig(
            dataQualityJobOutputConfig: MonitoringOutputConfigProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.sagemaker.CfnDataQualityJobDefinition.Builder.create(
                scope,
                id
            )
        ...
        override fun dataQualityAppSpecification(dataQualityAppSpecification: IResolvable) {
            cdkBuilder.dataQualityAppSpecification(
                dataQualityAppSpecification.let(IResolvable::unwrap)
            )
        }
         ...
         * @param dataQualityAppSpecification Specifies the container that runs the monitoring job.
         */
        override fun dataQualityAppSpecification(
            dataQualityAppSpecification: DataQualityAppSpecificationProperty
        ) {
            cdkBuilder.dataQualityAppSpecification(
                dataQualityAppSpecification.let(DataQualityAppSpecificationProperty::unwrap)
            )
        }
        ...
        override fun dataQualityAppSpecification(
            ...
            dataQualityAppSpecification(
                DataQualityAppSpecificationProperty(dataQualityAppSpecification)
            )
         ...
         *   monitoring job.
         */
        override fun dataQualityBaselineConfig(
            dataQualityBaselineConfig: DataQualityBaselineConfigProperty
        ) {
            cdkBuilder.dataQualityBaselineConfig(
                dataQualityBaselineConfig.let(DataQualityBaselineConfigProperty::unwrap)
            )
        }
        ...
        override fun dataQualityJobInput(dataQualityJobInput: DataQualityJobInputProperty) {
            cdkBuilder.dataQualityJobInput(
                dataQualityJobInput.let(DataQualityJobInputProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("0ea3a357b521a7bf511b87f9911349cb922f6c294dbc98c7832f6719dd368580")
        override fun dataQualityJobInput(
            dataQualityJobInput: DataQualityJobInputProperty.Builder.() -> Unit
        ...
        override fun dataQualityJobOutputConfig(dataQualityJobOutputConfig: IResolvable) {
            cdkBuilder.dataQualityJobOutputConfig(
                dataQualityJobOutputConfig.let(IResolvable::unwrap)
            )
        }
         ...
         * @param dataQualityJobOutputConfig The output configuration for monitoring jobs.
         */
        override fun dataQualityJobOutputConfig(
            dataQualityJobOutputConfig: MonitoringOutputConfigProperty
        ) {
            cdkBuilder.dataQualityJobOutputConfig(
                dataQualityJobOutputConfig.let(MonitoringOutputConfigProperty::unwrap)
            )
        }
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnDataQualityJobDefinition
    ...
    public interface DataQualityBaselineConfigProperty {
        ...
        public interface Builder {
             ...
             *   statistics. These baseline resources are compared against the results of the
             *   current job from the series of jobs scheduled to collect data periodically.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DataQualityBaselineConfigProperty
            ): software.amazon.awscdk.services.sagemaker.CfnDataQualityJobDefinition.DataQualityBaselineConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DataQualityJobInputProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DataQualityJobInputProperty
            ): software.amazon.awscdk.services.sagemaker.CfnDataQualityJobDefinition.DataQualityJobInputProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DataQualityAppSpecificationProperty {
        ...
        public interface Builder {
            /**
             * @param containerArguments The arguments to send to the container that the monitoring
             *   job runs.
             */
            ...
            /**
             * @param containerEntrypoint The entrypoint for a container used to run a monitoring
             *   job.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DataQualityAppSpecificationProperty
            ): software.amazon.awscdk.services.sagemaker.CfnDataQualityJobDefinition.DataQualityAppSpecificationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
