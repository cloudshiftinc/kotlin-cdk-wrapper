...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.waf.regional.CfnSizeConstraintSet,
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.waf.regional.CfnSizeConstraintSet.Builder.create(
                scope,
                id
            )
    ...
    public interface FieldToMatchProperty {
        ...
        public interface Builder {
             ...
             *   header in `Data` .
             * * `METHOD` : The HTTP method, which indicates the type of operation that the request
    ...
    public interface SizeConstraintProperty {
         ...
         * `TextTransformation` because the API Gateway API or Application Load Balancer forward
