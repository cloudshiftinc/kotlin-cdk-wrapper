...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param kafkaClusters Specifies a list of Kafka clusters which are targets of the
         *   replicator.
         */
    ...
    public companion object {
        ...
        ): CfnReplicator = CfnReplicator(cdkObject)

        internal fun unwrap(
            wrapped: CfnReplicator
        ): software.amazon.awscdk.services.msk.CfnReplicator = wrapped.cdkObject
    }
    ...
    public interface AmazonMskClusterProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AmazonMskClusterProperty
            ): software.amazon.awscdk.services.msk.CfnReplicator.AmazonMskClusterProperty =
    ...
    public interface TopicReplicationProperty {
         ...
         */
        public fun topicsToExclude(): List<String> =
            unwrap(this).getTopicsToExclude() ?: emptyList()
        ...
        public interface Builder {
            /**
             * @param copyAccessControlListsForTopics Whether to periodically configure remote topic
             *   ACLs to match their corresponding upstream topics.
             */
            ...
            /**
             * @param copyTopicConfigurations Whether to periodically configure remote topics to
            ...
            /**
             * @param detectAndCopyNewTopics Whether to periodically check for new topics and
             *   partitions.
             */
            ...
            /**
             * @param topicsToReplicate List of regular expression patterns indicating the topics to
             *   copy.
             */
        ...
        private class BuilderImpl : Builder {
             ...
             *   ACLs to match their corresponding upstream topics.
             */
            override fun copyAccessControlListsForTopics(
                copyAccessControlListsForTopics: IResolvable
            ) {
                cdkBuilder.copyAccessControlListsForTopics(
                    copyAccessControlListsForTopics.let(IResolvable::unwrap)
                )
            }
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-msk-replicator-topicreplication.html#cfn-msk-replicator-topicreplication-topicstoexclude)
             */
            override fun topicsToExclude(): List<String> =
                unwrap(this).getTopicsToExclude() ?: emptyList()
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TopicReplicationProperty
            ): software.amazon.awscdk.services.msk.CfnReplicator.TopicReplicationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface KafkaClusterClientVpcConfigProperty {
         ...
         *
         * If a security group is not specified, the default security group associated with the VPC
         * is used.
         *
        ...
        public interface Builder {
             ...
             *   interfaces in order to specify what the replicator has access to. If a security
             *   group is not specified, the default security group associated with the VPC is used.
             */
            ...
            /**
             * @param subnetIds The list of subnets to connect to in the virtual private cloud
        ...
        internal constructor(
             ...
             * specify what the replicator has access to.
             *
             * If a security group is not specified, the default security group associated with the
             * VPC is used.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-msk-replicator-kafkaclusterclientvpcconfig.html#cfn-msk-replicator-kafkaclusterclientvpcconfig-securitygroupids)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: KafkaClusterClientVpcConfigProperty
            ): software.amazon.awscdk.services.msk.CfnReplicator.KafkaClusterClientVpcConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface KafkaClusterProperty {
        ...
        public interface Builder {
            ...
            public fun amazonMskCluster(
                amazonMskCluster: AmazonMskClusterProperty.Builder.() -> Unit
            )
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("971c41287b8b9b103a2fd7f3b3412307fa940f7bd71dd3482fcf4ea230d661f3")
            override fun vpcConfig(
                vpcConfig: KafkaClusterClientVpcConfigProperty.Builder.() -> Unit
    ...
    public interface ReplicationInfoProperty {
        ...
        public interface Builder {
            ...
            public fun consumerGroupReplication(
                consumerGroupReplication: ConsumerGroupReplicationProperty.Builder.() -> Unit
            )
            ...
            /**
             * @param targetCompressionType The type of compression to use writing records to target
             *   Kafka cluster.
             */
            ...
            public fun topicReplication(
                topicReplication: TopicReplicationProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun consumerGroupReplication(consumerGroupReplication: IResolvable) {
                cdkBuilder.consumerGroupReplication(
                    consumerGroupReplication.let(IResolvable::unwrap)
                )
            }
             ...
             * @param consumerGroupReplication Configuration relating to consumer group replication.
             */
            override fun consumerGroupReplication(
                consumerGroupReplication: ConsumerGroupReplicationProperty
            ) {
                cdkBuilder.consumerGroupReplication(
                    consumerGroupReplication.let(ConsumerGroupReplicationProperty::unwrap)
                )
            }
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-msk-replicator-replicationinfo.html#cfn-msk-replicator-replicationinfo-consumergroupreplication)
             */
            override fun consumerGroupReplication(): Any =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ReplicationInfoProperty
            ): software.amazon.awscdk.services.msk.CfnReplicator.ReplicationInfoProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ConsumerGroupReplicationProperty {
         ...
         */
        public fun consumerGroupsToExclude(): List<String> =
        ...
        /**
         * Whether to periodically write the translated offsets to __consumer_offsets topic in
         * target cluster.
         *
        ...
        public interface Builder {
            /**
             * @param consumerGroupsToExclude List of regular expression patterns indicating the
             *   consumer groups that should not be replicated.
             */
            ...
            /**
             * @param synchroniseConsumerGroupOffsets Whether to periodically write the translated
             *   offsets to __consumer_offsets topic in target cluster.
             */
        ...
        private class BuilderImpl : Builder {
             ...
             *   groups.
             */
            override fun detectAndCopyNewConsumerGroups(
                detectAndCopyNewConsumerGroups: IResolvable
            ) {
                cdkBuilder.detectAndCopyNewConsumerGroups(
                    detectAndCopyNewConsumerGroups.let(IResolvable::unwrap)
                )
            }
             ...
             *   offsets to __consumer_offsets topic in target cluster.
             */
            override fun synchroniseConsumerGroupOffsets(
                synchroniseConsumerGroupOffsets: IResolvable
            ) {
                cdkBuilder.synchroniseConsumerGroupOffsets(
                    synchroniseConsumerGroupOffsets.let(IResolvable::unwrap)
                )
            }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ConsumerGroupReplicationProperty
            ): software.amazon.awscdk.services.msk.CfnReplicator.ConsumerGroupReplicationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
