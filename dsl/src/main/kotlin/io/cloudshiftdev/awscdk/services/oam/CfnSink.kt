...
internal constructor(
    ...
    public interface Builder {
         ...
         * * Include organization IDs or organization paths to permit all accounts in an
         *   organization
         ...
         *
         * @param policy The IAM policy that grants permissions to source accounts to link to this
         *   sink.
         */
