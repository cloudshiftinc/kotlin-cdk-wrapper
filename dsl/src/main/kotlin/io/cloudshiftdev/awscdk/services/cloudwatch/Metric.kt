...
internal constructor(
     ...
     *
     * Returns a Metric object that uses the account and region from the Stack the given construct
     * is defined in. If the metric is subsequently used in a Dashboard or Alarm in a different
     * Stack defined in a different account or region, the appropriate 'region' and 'account' fields
     * will be added to it.
     *
     * If the scope we attach to is in an environment-agnostic stack, nothing is done and the same
     * Metric object is returned.
     *
     * @param scope
     */
     ...
     *
     * Combines both properties that may adjust the metric (aggregation) as well as alarm
     * properties.
     *
     * @param scope
     * @param id
    ...
    public open fun createAlarm(
        ...
        unwrap(this)
            .createAlarm(scope.let(Construct::unwrap), id, props.let(CreateAlarmOptions::unwrap))
            .let(Alarm::wrap)
    ...
    public override fun warningsV2(): Map<String, String> =
        unwrap(this).getWarningsV2() ?: emptyMap()
    ...
    public interface Builder {
        ...
        /**
         * The hex color code, prefixed with '#' (e.g. '#00ff00'), to use when this metric is
         * rendered on a graph. The `Color` class has a set of standard colors that can be used
         * here.
         *
         * Default: - Automatic color
         *
         * @param color The hex color code, prefixed with '#' (e.g. '#00ff00'), to use when this
         *   metric is rendered on a graph. The `Color` class has a set of standard colors that can
         *   be used here.
         */
         ...
         * ```
         *
         * As the metric label, the maximum value in the visible range will be shown next to the
         * time series name in the graph's legend.
         *
         * Default: - No label
         *
         ...
         *
         * Only refer to datums emitted to the metric stream with the given unit and ignore all
         * others. Only useful when datums are being emitted to the same metric stream under
         * different units.
         *
    ...
    public companion object {
        public fun grantPutMetricData(grantee: IGrantable): Grant =
            software.amazon.awscdk.services.cloudwatch.Metric.grantPutMetricData(
