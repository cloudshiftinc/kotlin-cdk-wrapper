...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param deletionProtection Specifies whether to enable deletion protection for the new
         ...
         *
         * Constraints:
         * * Can't be specified if `SourceDBClusterIdentifier` is specified. In this case, Amazon
         *   Aurora uses the engine of the source DB cluster.
         *
         ...
         * Constraints:
         * * Can't be specified if `SourceDBClusterIdentifier` is specified. In this case, Amazon
         *   Aurora uses the engine version of the source DB cluster.
         *
         ...
         *
         * @param sourceDbClusterIdentifier The Amazon Resource Name (ARN) to use as the primary
         ...
         * Constraints:
         * * Can't be specified if `SourceDBClusterIdentifier` is specified. In this case, Amazon
         *   Aurora uses the setting from the source DB cluster.
         *
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.rds.CfnGlobalCluster =
            cdkBuilder.build()
    }
