...
public interface IDatabaseCluster : IResource, IConnectable, ISecretAttachmentTarget {
    ...
    internal constructor(
        ...
        /** The endpoint to use for read/write operations. */
        override fun clusterEndpoint(): Endpoint =
         ...
         * This AWS Region-unique identifier is used in things like IAM authentication policies.
         */
        override fun clusterResourceIdentifier(): String =
        ...
        override fun metricDatabaseConnections(props: MetricOptions): Metric =
            unwrap(this)
                .metricDatabaseConnections(props.let(MetricOptions::unwrap))
                .let(Metric::wrap)
         ...
         * @param props
         */
        override fun metricEngineUptime(): Metric =
        ...
        /**
         * The amount of network throughput received from clients by each instance, in bytes per
         * second.
         *
         * Average over 5 minutes
         *
        ...
        override fun metricNetworkReceiveThroughput(props: MetricOptions): Metric =
            unwrap(this)
                .metricNetworkReceiveThroughput(props.let(MetricOptions::unwrap))
                .let(Metric::wrap)
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("a0b27f96abcd8796ec25a8dadcac39406010dc87ed255773f61b30234c64218f")
        override fun metricNetworkReceiveThroughput(
        ...
        override fun metricNetworkTransmitThroughput(props: MetricOptions): Metric =
            unwrap(this)
                .metricNetworkTransmitThroughput(props.let(MetricOptions::unwrap))
                .let(Metric::wrap)
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("2dcf397506092ed5637a6755904f121a8abac26c6288b2aa463bfd00a2e33a51")
        override fun metricNetworkTransmitThroughput(
            props: MetricOptions.Builder.() -> Unit
        ...
        override fun metricSnapshotStorageUsed(props: MetricOptions): Metric =
            unwrap(this)
                .metricSnapshotStorageUsed(props.let(MetricOptions::unwrap))
                .let(Metric::wrap)
        ...
        override fun metricTotalBackupStorageBilled(props: MetricOptions): Metric =
            unwrap(this)
                .metricTotalBackupStorageBilled(props.let(MetricOptions::unwrap))
                .let(Metric::wrap)
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("6eda8a6eaab0f83b3871c32bb94a5e952f3426afa9431da7911d5aa071625bf0")
        override fun metricTotalBackupStorageBilled(
            props: MetricOptions.Builder.() -> Unit
