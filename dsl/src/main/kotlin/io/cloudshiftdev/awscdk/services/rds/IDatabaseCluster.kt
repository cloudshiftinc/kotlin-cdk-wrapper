...
public interface IDatabaseCluster : IResource, IConnectable, ISecretAttachmentTarget {
  ...
  private class Wrapper internal constructor(
    ...
    public override fun metricDeadlocks(arg0: MetricOptions): Metric =
        unwrap(this).metricDeadlocks(arg0.let(MetricOptions::unwrap)).let(Metric::wrap)

    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("7c5fdf1f5b950b6ebb59f3a7d04102d5ea9229889ed1fbbe65d0b2f1feda9910")
    public override fun metricDeadlocks(arg0: MetricOptions.Builder.() -> Unit): Metric =
    ...
    public override fun metricEngineUptime(arg0: MetricOptions): Metric =
        unwrap(this).metricEngineUptime(arg0.let(MetricOptions::unwrap)).let(Metric::wrap)

    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("c987dd67b49b37fd08a66eb08d8eb42b13dff7f72815ba90f997acce53b91f13")
    public override fun metricEngineUptime(arg0: MetricOptions.Builder.() -> Unit): Metric =
    ...
    public override fun metricFreeLocalStorage(arg0: MetricOptions): Metric =
        unwrap(this).metricFreeLocalStorage(arg0.let(MetricOptions::unwrap)).let(Metric::wrap)

    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("610b9fe8b0f31bd9ac969185582bde69ab1a4734f7260522d267450d8b615e32")
    public override fun metricFreeLocalStorage(arg0: MetricOptions.Builder.() -> Unit): Metric =
    ...
    public override fun metricNetworkReceiveThroughput(arg0: MetricOptions): Metric =
        unwrap(this).metricNetworkReceiveThroughput(arg0.let(MetricOptions::unwrap)).let(Metric::wrap)

    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("a0b27f96abcd8796ec25a8dadcac39406010dc87ed255773f61b30234c64218f")
    public override fun metricNetworkReceiveThroughput(arg0: MetricOptions.Builder.() -> Unit):
        Metric = metricNetworkReceiveThroughput(MetricOptions(arg0))

    public override fun metricNetworkThroughput(): Metric =
        unwrap(this).metricNetworkThroughput().let(Metric::wrap)

    public override fun metricNetworkThroughput(arg0: MetricOptions): Metric =
        unwrap(this).metricNetworkThroughput(arg0.let(MetricOptions::unwrap)).let(Metric::wrap)

    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("7fa1ef794b739c2bc5aa500ab6258cc0e6369f83b4a0befe0efa5f957a32eb8c")
    public override fun metricNetworkThroughput(arg0: MetricOptions.Builder.() -> Unit): Metric =
    ...
    public override fun metricNetworkTransmitThroughput(arg0: MetricOptions): Metric =
        unwrap(this).metricNetworkTransmitThroughput(arg0.let(MetricOptions::unwrap)).let(Metric::wrap)

    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("2dcf397506092ed5637a6755904f121a8abac26c6288b2aa463bfd00a2e33a51")
    public override fun metricNetworkTransmitThroughput(arg0: MetricOptions.Builder.() -> Unit):
        Metric = metricNetworkTransmitThroughput(MetricOptions(arg0))

    public override fun metricSnapshotStorageUsed(): Metric =
        unwrap(this).metricSnapshotStorageUsed().let(Metric::wrap)

    public override fun metricSnapshotStorageUsed(arg0: MetricOptions): Metric =
        unwrap(this).metricSnapshotStorageUsed(arg0.let(MetricOptions::unwrap)).let(Metric::wrap)

    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("b20cebf25cdba39d8cafa1126165761c523a3fe674b9acb5d4c7a047c4f33c2c")
    public override fun metricSnapshotStorageUsed(arg0: MetricOptions.Builder.() -> Unit): Metric =
    ...
    public override fun metricTotalBackupStorageBilled(arg0: MetricOptions): Metric =
        unwrap(this).metricTotalBackupStorageBilled(arg0.let(MetricOptions::unwrap)).let(Metric::wrap)

    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("6eda8a6eaab0f83b3871c32bb94a5e952f3426afa9431da7911d5aa071625bf0")
    public override fun metricTotalBackupStorageBilled(arg0: MetricOptions.Builder.() -> Unit):
        Metric = metricTotalBackupStorageBilled(MetricOptions(arg0))

    public override fun metricVolumeBytesUsed(): Metric =
        unwrap(this).metricVolumeBytesUsed().let(Metric::wrap)

    public override fun metricVolumeBytesUsed(arg0: MetricOptions): Metric =
        unwrap(this).metricVolumeBytesUsed(arg0.let(MetricOptions::unwrap)).let(Metric::wrap)

    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("3bb277c510696a1a9ff520ce37a49f2b8512ad967ff39007f763e2c6dd25fe23")
    public override fun metricVolumeBytesUsed(arg0: MetricOptions.Builder.() -> Unit): Metric =
    ...
    public override fun metricVolumeReadIoPs(arg0: MetricOptions): Metric =
        unwrap(this).metricVolumeReadIOPs(arg0.let(MetricOptions::unwrap)).let(Metric::wrap)

    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("72067052a26857a00db0f687d77e4b1548626bbc1cc21cf9326d161fc9b68886")
    public override fun metricVolumeReadIoPs(arg0: MetricOptions.Builder.() -> Unit): Metric =
    ...
    public override fun metricVolumeWriteIoPs(arg0: MetricOptions): Metric =
        unwrap(this).metricVolumeWriteIOPs(arg0.let(MetricOptions::unwrap)).let(Metric::wrap)

    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("e049e75cf4d1c56da8bf142e554ca3f6d27b3533201bcb1be743dd489f70476a")
    public override fun metricVolumeWriteIoPs(arg0: MetricOptions.Builder.() -> Unit): Metric =
