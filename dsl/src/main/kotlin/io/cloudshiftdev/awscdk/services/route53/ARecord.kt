...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.route53.ARecord,
) : RecordSet(cdkObject) {
    /** A fluent builder for [io.cloudshiftdev.awscdk.services.route53.ARecord]. */
    @CdkDslMarker
    ...
    public companion object {
        ...
        public operator fun invoke(
            ...
            return ARecord(builderImpl.apply(block).build())
        }

        internal fun wrap(cdkObject: software.amazon.awscdk.services.route53.ARecord): ARecord =
            ARecord(cdkObject)
