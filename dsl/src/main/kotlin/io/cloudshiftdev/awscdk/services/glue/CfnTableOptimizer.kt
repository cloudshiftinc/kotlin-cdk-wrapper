...
internal constructor(
    ...
    /**  */
    public open fun tableOptimizerConfiguration(): Any =
        unwrap(this).getTableOptimizerConfiguration()
    ...
    public open fun tableOptimizerConfiguration(`value`: TableOptimizerConfigurationProperty) {
        unwrap(this)
            .setTableOptimizerConfiguration(
                `value`.let(TableOptimizerConfigurationProperty::unwrap)
            )
    }
    ...
    public open fun tableOptimizerConfiguration(
        `value`: TableOptimizerConfigurationProperty.Builder.() -> Unit
    ...
    public interface Builder {
        ...
        public fun tableOptimizerConfiguration(
            tableOptimizerConfiguration: TableOptimizerConfigurationProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
        ...
        override fun tableOptimizerConfiguration(tableOptimizerConfiguration: IResolvable) {
            cdkBuilder.tableOptimizerConfiguration(
                tableOptimizerConfiguration.let(IResolvable::unwrap)
            )
        }
         ...
         * @param tableOptimizerConfiguration
         */
        override fun tableOptimizerConfiguration(
            tableOptimizerConfiguration: TableOptimizerConfigurationProperty
        ) {
            cdkBuilder.tableOptimizerConfiguration(
                tableOptimizerConfiguration.let(TableOptimizerConfigurationProperty::unwrap)
            )
        }
        ...
        override fun tableOptimizerConfiguration(
            ...
            tableOptimizerConfiguration(
                TableOptimizerConfigurationProperty(tableOptimizerConfiguration)
            )
        ...
        public fun build(): software.amazon.awscdk.services.glue.CfnTableOptimizer =
            cdkBuilder.build()
    }
    ...
    public interface TableOptimizerConfigurationProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param roleArn A role passed by the caller which gives the service permission to
             *   update the resources associated with the optimizer on the caller's behalf.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TableOptimizerConfigurationProperty
            ): software.amazon.awscdk.services.glue.CfnTableOptimizer.TableOptimizerConfigurationProperty =
