...
internal constructor(
    ...
    public open fun billingGroupProperties(
        `value`: BillingGroupPropertiesProperty.Builder.() -> Unit
    ): Unit = billingGroupProperties(BillingGroupPropertiesProperty(`value`))
    ...
    public interface Builder {
        ...
        public fun billingGroupProperties(
            billingGroupProperties: BillingGroupPropertiesProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
         ...
         * @param billingGroupProperties The properties of the billing group.
         */
        override fun billingGroupProperties(
            billingGroupProperties: BillingGroupPropertiesProperty
        ) {
            cdkBuilder.billingGroupProperties(
                billingGroupProperties.let(BillingGroupPropertiesProperty::unwrap)
            )
        }
    ...
    public interface BillingGroupPropertiesProperty {
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-iot-billinggroup-billinggroupproperties.html#cfn-iot-billinggroup-billinggroupproperties-billinggroupdescription)
             */
            override fun billingGroupDescription(): String? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: BillingGroupPropertiesProperty
            ): software.amazon.awscdk.services.iot.CfnBillingGroup.BillingGroupPropertiesProperty =
