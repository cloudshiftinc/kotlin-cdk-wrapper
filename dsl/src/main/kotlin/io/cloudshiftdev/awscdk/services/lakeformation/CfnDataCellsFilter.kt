...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.lakeformation.CfnDataCellsFilter,
    ...
    public interface Builder {
         ...
         *
         * @param databaseName UTF-8 string, not less than 1 or more than 255 bytes long, matching
         *   the
         *   [single-line string pattern](https://docs.aws.amazon.com/lake-formation/latest/dg/aws-lake-formation-api-aws-lake-formation-api-common.html)
         *   .
         */
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.lakeformation.CfnDataCellsFilter.Builder.create(
                scope,
                id
            )
