...
public enum class ExecuteCommandLogging(
  ...
  public companion object {
    internal fun wrap(cdkObject: software.amazon.awscdk.services.ecs.ExecuteCommandLogging):
        ExecuteCommandLogging = when (cdkObject) {
      software.amazon.awscdk.services.ecs.ExecuteCommandLogging.NONE -> ExecuteCommandLogging.NONE
    ...
    internal fun unwrap(wrapped: ExecuteCommandLogging):
