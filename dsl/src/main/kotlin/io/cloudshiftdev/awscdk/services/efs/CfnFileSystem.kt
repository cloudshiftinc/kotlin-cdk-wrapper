...
internal constructor(
    ...
    public open fun fileSystemProtection(
        `value`: FileSystemProtectionProperty.Builder.() -> Unit
    ...
    public interface Builder {
         ...
         *
         * @param availabilityZoneName For One Zone file systems, specify the AWS Availability Zone
         *   in which to create the file system.
         */
         ...
         *
         * @param backupPolicy Use the `BackupPolicy` to turn automatic backups on or off for the
         *   file system.
         */
         ...
         * `PutFileSystemPolicy` requests on this file system. Set `BypassPolicyLockoutSafetyCheck`
         * to `True` only when you intend to prevent the IAM principal that is making the request
         * from making subsequent `PutFileSystemPolicy` requests on this file system. The default
         * value is `False` .
         *
         ...
         *
         * @param bypassPolicyLockoutSafetyCheck (Optional) A boolean that specifies whether or not
         *   to bypass the `FileSystemPolicy` lockout safety check.
         */
         ...
         * A Boolean value that, if true, creates an encrypted file system.
         *
         * When creating an encrypted file system, you have the option of specifying a KmsKeyId for
         * an existing AWS KMS key . If you don't specify a KMS key , then the default KMS key for
        ...
        public fun fileSystemProtection(
            fileSystemProtection: FileSystemProtectionProperty.Builder.() -> Unit
        )
         ...
         * a `"Key":"Name","Value":"{value}"` key-value pair. Each key must be unique. For more
         * information, see
         ...
         * The ID of the AWS KMS key to be used to protect the encrypted file system.
         *
         * This parameter is only required if you want to use a nondefault KMS key . If this
         * parameter is not specified, the default KMS key for Amazon EFS is used. This ID can be in
         ...
         *
         * @param kmsKeyId The ID of the AWS KMS key to be used to protect the encrypted file
         *   system.
         */
         ...
         * This means that in a request body, `LifecyclePolicies` needs to be structured as an array
         * of `LifecyclePolicy` objects, one object for each transition, `TransitionToIA` ,
         ...
         *
         * @param lifecyclePolicies An array of `LifecyclePolicy` objects that define the file
         *   system's `LifecycleConfiguration` object.
         */
         ...
         * The performance mode of the file system.
         *
         * We recommend `generalPurpose` performance mode for all file systems. File systems using
         * the `maxIO` performance mode can scale to higher levels of aggregate throughput and
        ...
        /**
         * The throughput, measured in mebibytes per second (MiBps), that you want to provision for
         * a file system that you're creating.
         *
         * Required if `ThroughputMode` is set to `provisioned` . Valid values are 1-3414 MiBps,
         * with the upper limit depending on Region. To increase this limit, contact AWS Support .
         ...
         *
         * @param provisionedThroughputInMibps The throughput, measured in mebibytes per second
         ...
         *
         * @param replicationConfiguration Describes the replication configuration for a specific
         *   file system.
         */
         ...
         * Specifies the throughput mode for the file system.
         *
         * The mode can be `bursting` , `provisioned` , or `elastic` . If you set `ThroughputMode`
         * to `provisioned` , you must also set a value for `ProvisionedThroughputInMibps` . After
         * you create the file system, you can decrease your file system's Provisioned throughput or
    ...
    private class BuilderImpl(
        ...
        override fun fileSystemProtection(fileSystemProtection: FileSystemProtectionProperty) {
            cdkBuilder.fileSystemProtection(
                fileSystemProtection.let(FileSystemProtectionProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("fe219d089f6ecb2b40f3cf37e0616ea4fb81907fb8a89fd945425744d7e1c922")
        override fun fileSystemProtection(
            fileSystemProtection: FileSystemProtectionProperty.Builder.() -> Unit
    ...
    public companion object {
        ...
        ): software.amazon.awscdk.services.efs.CfnFileSystem = wrapped.cdkObject
    }
    ...
    public interface FileSystemProtectionProperty {
         ...
         *   replication configuration. The file system is read-only and can only be modified by EFS
         *   replication.
        ...
        public interface Builder {
            /**
             * @param replicationOverwriteProtection The status of the file system's replication
             ...
             *   EFS replication.
             * * `REPLICATING` – The file system is being used as the destination file system in a
             *   replication configuration. The file system is read-only and is only modified only
             *   by EFS replication.
             *
             * If the replication configuration is deleted, the file system's replication overwrite
             * protection is re-enabled, the file system becomes writeable.
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: FileSystemProtectionProperty
            ): software.amazon.awscdk.services.efs.CfnFileSystem.FileSystemProtectionProperty =
    ...
    public interface ElasticFileSystemTagProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ElasticFileSystemTagProperty
            ): software.amazon.awscdk.services.efs.CfnFileSystem.ElasticFileSystemTagProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ReplicationDestinationProperty {
        ...
        public interface Builder {
             ...
             *   configuration must specify the Availability Zone in which the destination file
             *   system is located. Use the format `us-east-1a` to specify the Availability Zone.
             *   For more information about One Zone file systems, see
             *   [EFS file system types](https://docs.aws.amazon.com/efs/latest/ug/storage-classes.html)
             *   in the *Amazon EFS User Guide* .
             *
             * One Zone file system type is not available in all Availability Zones in AWS Regions
             ...
             *
             * For One Zone file systems, the replication configuration must specify the AWS Region
        ...
        internal constructor(
             ...
             * about One Zone file systems, see
             * [EFS file system types](https://docs.aws.amazon.com/efs/latest/ug/storage-classes.html)
             * in the *Amazon EFS User Guide* .
             *
             * One Zone file system type is not available in all Availability Zones in AWS Regions
    ...
    public interface LifecyclePolicyProperty {
        ...
        public interface Builder {
            /**
             * @param transitionToArchive The number of days after files were last accessed in
             *   primary storage (the Standard storage class) at which to move them to Archive
            ...
            /**
             * @param transitionToIa The number of days after files were last accessed in primary
             *   storage (the Standard storage class) at which to move them to Infrequent Access
             *   (IA) storage. Metadata operations such as listing the contents of a directory don't
             *   count as file access events.
             */
            public fun transitionToIa(transitionToIa: String)

            /**
             * @param transitionToPrimaryStorageClass Whether to move files back to primary
             *   (Standard) storage after they are accessed in IA or Archive storage. Metadata
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: LifecyclePolicyProperty
            ): software.amazon.awscdk.services.efs.CfnFileSystem.LifecyclePolicyProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
