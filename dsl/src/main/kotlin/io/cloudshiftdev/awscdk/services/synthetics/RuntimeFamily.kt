...
public enum class RuntimeFamily(
    ...
    public companion object {
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.synthetics.RuntimeFamily
        ): RuntimeFamily =
            when (cdkObject) {
                software.amazon.awscdk.services.synthetics.RuntimeFamily.NODEJS ->
                    RuntimeFamily.NODEJS
                software.amazon.awscdk.services.synthetics.RuntimeFamily.PYTHON ->
                    RuntimeFamily.PYTHON
                software.amazon.awscdk.services.synthetics.RuntimeFamily.OTHER ->
                    RuntimeFamily.OTHER
            }
