...
internal constructor(
    ...
    public open fun inferenceExecutionConfig(`value`: InferenceExecutionConfigProperty) {
        unwrap(this)
            .setInferenceExecutionConfig(`value`.let(InferenceExecutionConfigProperty::unwrap))
    }

    /** Specifies details of how containers in a multi-container endpoint are called. */
    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("042e2b86599f1d355d28bdfd247011736350d0e51481df8a3b6f011942f585a5")
    public open fun inferenceExecutionConfig(
        `value`: InferenceExecutionConfigProperty.Builder.() -> Unit
     ...
     * custom environment map that the inference code uses when the model is deployed for
     * predictions.
     */
    ...
    public open fun primaryContainer(
        `value`: ContainerDefinitionProperty.Builder.() -> Unit
    ): Unit = primaryContainer(ContainerDefinitionProperty(`value`))
     ...
     * model container by configuring the VPC. `VpcConfig` is used in hosting services and in batch
    ...
    public interface Builder {
        ...
        public fun inferenceExecutionConfig(
            inferenceExecutionConfig: InferenceExecutionConfigProperty.Builder.() -> Unit
        )
         ...
         *
         * @param primaryContainer The location of the primary docker image containing inference
         *   code, associated artifacts, and custom environment map that the inference code uses
        ...
        public fun primaryContainer(
            primaryContainer: ContainerDefinitionProperty.Builder.() -> Unit
        )
        ...
        /**
         * A [VpcConfig](https://docs.aws.amazon.com/sagemaker/latest/dg/API_VpcConfig.html) object
         * that specifies the VPC that you want your model to connect to. Control access to and from
         * your model container by configuring the VPC. `VpcConfig` is used in hosting services and
         * in batch transform. For more information, see
         * [Protect Endpoints by Using an Amazon Virtual Private Cloud](https://docs.aws.amazon.com/sagemaker/latest/dg/host-vpc.html)
         * and
         * [Protect Data in Batch Transform Jobs by Using an Amazon Virtual Private Cloud](https://docs.aws.amazon.com/sagemaker/latest/dg/batch-vpc.html)
         * .
         ...
         *
         * @param vpcConfig A
         *   [VpcConfig](https://docs.aws.amazon.com/sagemaker/latest/dg/API_VpcConfig.html) object
         *   that specifies the VPC that you want your model to connect to. Control access to and
         *   from your model container by configuring the VPC. `VpcConfig` is used in hosting
         *   services and in batch transform. For more information, see
         *   [Protect Endpoints by Using an Amazon Virtual Private Cloud](https://docs.aws.amazon.com/sagemaker/latest/dg/host-vpc.html)
         *   and
         *   [Protect Data in Batch Transform Jobs by Using an Amazon Virtual Private Cloud](https://docs.aws.amazon.com/sagemaker/latest/dg/batch-vpc.html)
         *   .
    ...
    private class BuilderImpl(
         ...
         *   endpoint are called.
         */
        override fun inferenceExecutionConfig(
            inferenceExecutionConfig: InferenceExecutionConfigProperty
        ) {
            cdkBuilder.inferenceExecutionConfig(
                inferenceExecutionConfig.let(InferenceExecutionConfigProperty::unwrap)
            )
        }
        ...
        override fun inferenceExecutionConfig(
            ...
            inferenceExecutionConfig(InferenceExecutionConfigProperty(inferenceExecutionConfig))
    ...
    public interface MultiModelConfigProperty {
         ...
         * into memory each time it is invoked. Some use cases do not benefit from model caching.
         * For example, if an endpoint hosts a large number of models that are each invoked
         * infrequently, the endpoint might perform better if you disable model caching. To disable
         * model caching, set the value of this parameter to Disabled.
         *
        ...
        public interface Builder {
            /**
             * @param modelCacheSetting Whether to cache models for a multi-model endpoint. By
             *   default, multi-model endpoints cache models so that a model does not have to be
             *   loaded into memory each time it is invoked. Some use cases do not benefit from
             *   model caching. For example, if an endpoint hosts a large number of models that are
             *   each invoked infrequently, the endpoint might perform better if you disable model
        ...
        internal constructor(
             ...
             * Whether to cache models for a multi-model endpoint.
             *
             * By default, multi-model endpoints cache models so that a model does not have to be
             * loaded into memory each time it is invoked. Some use cases do not benefit from model
             * caching. For example, if an endpoint hosts a large number of models that are each
             * invoked infrequently, the endpoint might perform better if you disable model caching.
             * To disable model caching, set the value of this parameter to Disabled.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-sagemaker-model-multimodelconfig.html#cfn-sagemaker-model-multimodelconfig-modelcachesetting)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: MultiModelConfigProperty
            ): software.amazon.awscdk.services.sagemaker.CfnModel.MultiModelConfigProperty =
    ...
    public interface ModelDataSourceProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ModelDataSourceProperty
            ): software.amazon.awscdk.services.sagemaker.CfnModel.ModelDataSourceProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface S3DataSourceProperty {
        ...
        public interface Builder {
            ...
            public fun modelAccessConfig(
                modelAccessConfig: ModelAccessConfigProperty.Builder.() -> Unit
            )
        ...
        private class BuilderImpl : Builder {
            ...
            override fun modelAccessConfig(modelAccessConfig: ModelAccessConfigProperty) {
                cdkBuilder.modelAccessConfig(
                    modelAccessConfig.let(ModelAccessConfigProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("1d89505c81977147be9ffaf680ecf6e6297222407045d3477357064c885b2e7f")
            override fun modelAccessConfig(
                modelAccessConfig: ModelAccessConfigProperty.Builder.() -> Unit
    ...
    public interface ContainerDefinitionProperty {
         ...
         * uniquely identifies the container for the purposes of logging and metrics. For
         * information, see
         ...
         * accessible from the same VPC that you configure for your endpoint. If you are using your
         * own custom algorithm instead of an algorithm provided by SageMaker, the inference code
         ...
         * in Amazon EC2 Container Registry must be in the same region as the model or endpoint you
         * are creating.
         *
         ...
         *
         * For information about storing containers in a private Docker registry, see
         ...
         */
        public fun inferenceSpecificationName(): String? =
         ...
         * SageMaker serverless endpoints, SageMaker multi-model endpoints, and SageMaker
         * Marketplace.
         *
         ...
         * path is required for SageMaker built-in algorithms, but not if you use your own
         ...
         *
         * If you use a built-in algorithm to create a model, SageMaker requires that you provide a
         * S3 path to the model artifacts in `ModelDataUrl` .
         *
        ...
        public interface Builder {
             ...
             *   `PrimaryContainer` . When a `ContainerDefinition` is part of an inference pipeline,
             *   the value of the parameter uniquely identifies the container for the purposes of
            ...
            /**
             * @param image The path where inference code is stored. This can be either in Amazon
             *   EC2 Container Registry or in a Docker registry that is accessible from the same VPC
             ...
             * container in Amazon EC2 Container Registry must be in the same region as the model or
             * endpoint you are creating.
             */
            public fun image(image: String)

            /**
             * @param imageConfig Specifies whether the model container is in Amazon ECR or a
             *   private Docker registry accessible from your Amazon Virtual Private Cloud (VPC).
             *   For information about storing containers in a private Docker registry, see
             *   [Use a Private Docker Registry for Real-Time Inference Containers](https://docs.aws.amazon.com/sagemaker/latest/dg/your-algorithms-containers-inference-private.html)
             *   .
             *
            ...
            /**
             * @param inferenceSpecificationName The inference specification name in the model
             *   package version.
             */
             ...
             *   (.tar.gz suffix). The S3 path is required for SageMaker built-in algorithms, but
             ...
             *
             * If you provide a value for this parameter, SageMaker uses AWS Security Token Service
             * to download model artifacts from the S3 path you provide. AWS STS is activated in
             * your AWS account by default. If you previously deactivated AWS STS for a region, you
             * need to reactivate AWS STS for that region. For more information, see
             * [Activating and Deactivating AWS STS in an AWS Region](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_credentials_temp_enable-regions.html)
             * in the *AWS Identity and Access Management User Guide* .
             *
            ...
            /**
             * @param modelPackageName The name or Amazon Resource Name (ARN) of the model package
            ...
            public fun multiModelConfig(
                multiModelConfig: MultiModelConfigProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("a11986e307cbd4a71922aeecec723d99a0a6975ce902004868c9f96ced93dbe7")
            override fun modelDataSource(
                modelDataSource: ModelDataSourceProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             *
             * This can be either in Amazon EC2 Container Registry or in a Docker registry that is
             * accessible from the same VPC that you configure for your endpoint. If you are using
             * your own custom algorithm instead of an algorithm provided by SageMaker, the
    ...
    public interface ImageConfigProperty {
         ...
         * where your model image is hosted.
         *
         * Specify a value for this property only if you specified `Vpc` as the value for the
         * `RepositoryAccessMode` field, and the private Docker registry where the model image is
        ...
        public interface Builder {
            ...
            /**
             * @param repositoryAuthConfig (Optional) Specifies an authentication configuration for
             *   the private docker registry where your model image is hosted. Specify a value for
             *   this property only if you specified `Vpc` as the value for the
             *   `RepositoryAccessMode` field, and the private Docker registry where the model image
            ...
            public fun repositoryAuthConfig(
                repositoryAuthConfig: RepositoryAuthConfigProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun repositoryAuthConfig(repositoryAuthConfig: RepositoryAuthConfigProperty) {
                cdkBuilder.repositoryAuthConfig(
                    repositoryAuthConfig.let(RepositoryAuthConfigProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("8b6556dde91f4c6adedaecaa4eec4b70580f0a032691abc2c6456874da281405")
            override fun repositoryAuthConfig(
                repositoryAuthConfig: RepositoryAuthConfigProperty.Builder.() -> Unit
    ...
    public interface InferenceExecutionConfigProperty {
        ...
        public interface Builder {
            /**
             * @param mode How containers in a multi-container are run. The following values are
             *   valid.
             * * `Serial` - Containers run as a serial pipeline.
             * * `Direct` - Only the individual container that you specify is run.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: InferenceExecutionConfigProperty
            ): software.amazon.awscdk.services.sagemaker.CfnModel.InferenceExecutionConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface RepositoryAuthConfigProperty {
         ...
         *
         * For information about how to create an AWS Lambda function, see
        ...
        public interface Builder {
            /**
             * @param repositoryCredentialsProviderArn The Amazon Resource Name (ARN) of an AWS
             *   Lambda function that provides credentials to authenticate to the private Docker
             *   registry where your model image is hosted. For information about how to create an
             *   AWS Lambda function, see
             *   [Create a Lambda function with the console](https://docs.aws.amazon.com/lambda/latest/dg/getting-started-create-function.html)
             *   in the *AWS Lambda Developer Guide* .
             */
        ...
        private class BuilderImpl : Builder {
             ...
             *   in the *AWS Lambda Developer Guide* .
             */
            override fun repositoryCredentialsProviderArn(
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RepositoryAuthConfigProperty
            ): software.amazon.awscdk.services.sagemaker.CfnModel.RepositoryAuthConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ModelAccessConfigProperty {
        ...
        public interface Builder {
             ...
             *   The `AcceptEula` value must be explicitly defined as `True` in order to accept the
             *   EULA that this model requires. You are responsible for reviewing and complying with
             *   any applicable license terms and making sure they are acceptable for your use case
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ModelAccessConfigProperty
            ): software.amazon.awscdk.services.sagemaker.CfnModel.ModelAccessConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
