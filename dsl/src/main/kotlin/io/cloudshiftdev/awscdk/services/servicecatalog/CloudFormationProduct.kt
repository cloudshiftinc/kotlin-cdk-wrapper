...
internal constructor(
    ...
    public interface Builder {
        ...
        /**
         * Whether to give provisioning artifacts a new unique identifier when the product
         * attributes or provisioning artifacts is updated.
         *
         * Default: false
         *
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.servicecatalog.CloudFormationProduct.Builder.create(
                scope,
                id
            )
