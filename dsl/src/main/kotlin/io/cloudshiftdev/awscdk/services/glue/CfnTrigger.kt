...
internal constructor(
    ...
    public open fun eventBatchingCondition(
        `value`: EventBatchingConditionProperty.Builder.() -> Unit
    ): Unit = eventBatchingCondition(EventBatchingConditionProperty(`value`))
    ...
    public interface Builder {
         ...
         *
         * @param eventBatchingCondition Batch condition that must be met (specified number of
         *   events received or batch time window expired) before EventBridge event trigger fires.
         */
        ...
        public fun eventBatchingCondition(
            eventBatchingCondition: EventBatchingConditionProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
         ...
         *   events received or batch time window expired) before EventBridge event trigger fires.
         */
        override fun eventBatchingCondition(
            eventBatchingCondition: EventBatchingConditionProperty
        ) {
            cdkBuilder.eventBatchingCondition(
                eventBatchingCondition.let(EventBatchingConditionProperty::unwrap)
            )
        }
    ...
    public interface ActionProperty {
         ...
         * enters TIMEOUT status. The default is 2,880 minutes (48 hours). This overrides the
        ...
        public interface Builder {
            /**
             * @param arguments The job arguments used when this trigger fires. For this job run,
            ...
            /**
             * @param notificationProperty Specifies configuration properties of a job run
             *   notification.
             */
            ...
            /**
             * @param securityConfiguration The name of the `SecurityConfiguration` structure to be
             *   used with this action.
             */
            public fun securityConfiguration(securityConfiguration: String)

            /**
             * @param timeout The `JobRun` timeout in minutes. This is the maximum time that a job
             *   run can consume resources before it is terminated and enters TIMEOUT status. The
        ...
        internal constructor(
             ...
             * The job arguments used when this trigger fires.
             *
             * For this job run, they replace the default arguments set in the job definition
             * itself.
             *
             * You can specify arguments here that your own job-execution script consumes, in
             * addition to arguments that AWS Glue itself consumes.
             ...
             * and enters TIMEOUT status. The default is 2,880 minutes (48 hours). This overrides
    ...
    public interface EventBatchingConditionProperty {
        ...
        public interface Builder {
            /**
             * @param batchSize Number of events that must be received from Amazon EventBridge
             *   before EventBridge event trigger fires.
             */
            public fun batchSize(batchSize: Number)

            /**
             * @param batchWindow Window of time in seconds after which EventBridge event trigger
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: EventBatchingConditionProperty
            ): software.amazon.awscdk.services.glue.CfnTrigger.EventBatchingConditionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface PredicateProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param logical An optional field if only one condition is listed. If multiple
    ...
    public interface ConditionProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param jobName The name of the job whose `JobRuns` this condition applies to, and on
            ...
            /**
             * @param state The condition state. Currently, the values supported are `SUCCEEDED` ,
        ...
        internal constructor(
             ...
             * The condition state.
             *
             * Currently, the values supported are `SUCCEEDED` , `STOPPED` , `TIMEOUT` , and
             * `FAILED` .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-glue-trigger-condition.html#cfn-glue-trigger-condition-state)
             */
