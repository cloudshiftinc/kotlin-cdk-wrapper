...
internal constructor(
    ...
    public override fun addSubscription(topicSubscription: ITopicSubscription): Subscription =
        unwrap(this)
            .addSubscription(topicSubscription.let(ITopicSubscription::unwrap))
    ...
    public override fun bindAsNotificationRuleTarget(
        ...
        unwrap(this)
            .bindAsNotificationRuleTarget(_scope.let(Construct::unwrap))
    ...
    public override fun metricNumberOfMessagesPublished(
        props: MetricOptions.Builder.() -> Unit
    ...
    public override fun metricNumberOfNotificationsDelivered(
        props: MetricOptions.Builder.() -> Unit
    ...
    public override fun metricNumberOfNotificationsFailed(
        props: MetricOptions.Builder.() -> Unit
    ...
    public override fun metricNumberOfNotificationsFilteredOut(
        props: MetricOptions.Builder.() -> Unit
     ...
     * @param props
     */
    public override fun metricNumberOfNotificationsFilteredOutInvalidAttributes(
        props: MetricOptions
    ): Metric =
        unwrap(this)
     ...
     * @param props
     */
    public override fun metricNumberOfNotificationsFilteredOutNoMessageAttributes(
        props: MetricOptions
    ): Metric =
        unwrap(this)
    ...
    public override fun metricSmsMonthToDateSpentUsd(
        props: MetricOptions.Builder.() -> Unit
