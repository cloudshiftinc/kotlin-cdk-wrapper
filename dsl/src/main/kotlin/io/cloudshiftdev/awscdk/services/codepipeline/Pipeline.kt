...
internal constructor(
    ...
    public override fun notifyOn(
        ...
        unwrap(this)
            .notifyOn(
                ...
                options.let(PipelineNotifyOnOptions::unwrap)
            )
    ...
    public override fun notifyOnAnyActionStateChange(
        ...
        unwrap(this)
            .notifyOnAnyActionStateChange(id, target.let(INotificationRuleTarget::unwrap))
            .let(INotificationRule::wrap)
    ...
    public override fun notifyOnAnyActionStateChange(
        ...
        notifyOnAnyActionStateChange(id, target, NotificationRuleOptions(options))
    ...
    public override fun notifyOnAnyManualApprovalStateChange(
        ...
        unwrap(this)
            .notifyOnAnyManualApprovalStateChange(id, target.let(INotificationRuleTarget::unwrap))
            .let(INotificationRule::wrap)
    ...
    public override fun notifyOnAnyManualApprovalStateChange(
        ...
        notifyOnAnyManualApprovalStateChange(id, target, NotificationRuleOptions(options))
    ...
    public override fun notifyOnAnyStageStateChange(
        ...
        unwrap(this)
            .notifyOnAnyStageStateChange(id, target.let(INotificationRuleTarget::unwrap))
            .let(INotificationRule::wrap)
    ...
    public override fun notifyOnExecutionStateChange(
        ...
        unwrap(this)
            .notifyOnExecutionStateChange(id, target.let(INotificationRuleTarget::unwrap))
            .let(INotificationRule::wrap)
    ...
    public override fun notifyOnExecutionStateChange(
        ...
        notifyOnExecutionStateChange(id, target, NotificationRuleOptions(options))
     ...
     * @param stageName
     */
    public open fun stage(stageName: String): IStage =
        unwrap(this).stage(stageName).let(IStage::wrap)
     ...
     *
     * **Note**: the returned array is a defensive copy, so adding elements to it has no effect.
     * Instead, use the `addStage` method if you want to add more stages to the pipeline.
     */
    ...
    public interface Builder {
         ...
         *
         * By default cross-account deployments are enabled, but this feature requires that KMS
         * Customer Master Keys are created which have a cost of $1/month.
         *
         * If you do not need cross-account deployments, you can set this to `false` to not create
         * those keys and save on that cost (the artifact bucket will be encrypted with an
         * AWS-managed key). However, cross-account deployments will no longer be possible.
         *
         ...
         *
         * By default KMS key rotation is disabled, but will add an additional $1/month for each
         * year the key exists when enabled.
         *
         ...
         *
         * `triggers` can only be used when `pipelineType` is set to `PipelineType.V2`. You can
         * always add more triggers later by calling `Pipeline#addTrigger`.
         *
         * Default: - No triggers
         *
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.codepipeline.Pipeline =
            cdkBuilder.build()
    }
    ...
    public companion object {
        public fun fromPipelineArn(
            ...
            software.amazon.awscdk.services.codepipeline.Pipeline.fromPipelineArn(
        ...
        ): Pipeline = Pipeline(cdkObject)

        internal fun unwrap(
            wrapped: Pipeline
        ): software.amazon.awscdk.services.codepipeline.Pipeline = wrapped.cdkObject
    }
}
