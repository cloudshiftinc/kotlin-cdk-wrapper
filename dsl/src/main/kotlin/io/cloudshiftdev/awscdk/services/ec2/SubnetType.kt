...
public enum class SubnetType(
    ...
    public companion object {
        internal fun wrap(cdkObject: software.amazon.awscdk.services.ec2.SubnetType): SubnetType =
            when (cdkObject) {
                software.amazon.awscdk.services.ec2.SubnetType.PRIVATE_ISOLATED ->
                    SubnetType.PRIVATE_ISOLATED
                software.amazon.awscdk.services.ec2.SubnetType.PRIVATE_WITH_EGRESS ->
                    SubnetType.PRIVATE_WITH_EGRESS
                software.amazon.awscdk.services.ec2.SubnetType.PRIVATE_WITH_NAT ->
