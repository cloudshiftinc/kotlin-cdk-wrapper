...
internal constructor(
    ...
    public open fun identityProviderConfiguration(`value`: IdentityProviderConfigurationProperty) {
        unwrap(this)
            .setIdentityProviderConfiguration(
                `value`.let(IdentityProviderConfigurationProperty::unwrap)
            )
    }
    ...
    public open fun identityProviderConfiguration(
        `value`: IdentityProviderConfigurationProperty.Builder.() -> Unit
    ...
    public interface Builder {
         ...
         *
         * @param identityProviderConfiguration The identity provider configuration that you gave
        ...
        public fun identityProviderConfiguration(
            identityProviderConfiguration: IdentityProviderConfigurationProperty.Builder.() -> Unit
        )
        ...
        public fun preloadDataConfig(
            preloadDataConfig: PreloadDataConfigProperty.Builder.() -> Unit
        )
         ...
         *
         * @param sseConfiguration The server-side encryption key configuration for a customer
    ...
    private class BuilderImpl(
        ...
        override fun identityProviderConfiguration(identityProviderConfiguration: IResolvable) {
            cdkBuilder.identityProviderConfiguration(
                identityProviderConfiguration.let(IResolvable::unwrap)
            )
        }
         ...
         *   when the data store was created.
         */
        override fun identityProviderConfiguration(
            identityProviderConfiguration: IdentityProviderConfigurationProperty
        ) {
            cdkBuilder.identityProviderConfiguration(
                identityProviderConfiguration.let(IdentityProviderConfigurationProperty::unwrap)
            )
        }
        ...
        override fun identityProviderConfiguration(
            ...
            identityProviderConfiguration(
                IdentityProviderConfigurationProperty(identityProviderConfiguration)
            )
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("0f415c8ec6d6fb864b37abdb60559b8096a0e3743967f14948ddbdfb7cdebddb")
        override fun preloadDataConfig(
            preloadDataConfig: PreloadDataConfigProperty.Builder.() -> Unit
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("6ff80698f76fb67e7cc1beac160a04d19b55f627350ad6a5b041372099ff5944")
        override fun sseConfiguration(
            sseConfiguration: SseConfigurationProperty.Builder.() -> Unit
    ...
    public interface PreloadDataConfigProperty {
        ...
        public interface Builder {
            /**
             * @param preloadDataType The type of preloaded data. Only Synthea preloaded data is
             *   supported.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: PreloadDataConfigProperty
            ): software.amazon.awscdk.services.healthlake.CfnFHIRDatastore.PreloadDataConfigProperty =
    ...
    public interface IdentityProviderConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param authorizationStrategy The authorization strategy that you selected when you
             *   created the data store.
             */
            public fun authorizationStrategy(authorizationStrategy: String)

            /**
             * @param fineGrainedAuthorizationEnabled If you enabled fine-grained authorization when
             *   you created the data store.
             */
            ...
            /**
             * @param idpLambdaArn The Amazon Resource Name (ARN) of the Lambda function that you
             *   want to use to decode the access token created by the authorization server.
             */
            public fun idpLambdaArn(idpLambdaArn: String)

            /**
             * @param metadata The JSON metadata elements that you want to use in your identity
        ...
        private class BuilderImpl : Builder {
             ...
             *   you created the data store.
             */
            override fun fineGrainedAuthorizationEnabled(
                fineGrainedAuthorizationEnabled: IResolvable
            ) {
                cdkBuilder.fineGrainedAuthorizationEnabled(
                    fineGrainedAuthorizationEnabled.let(IResolvable::unwrap)
                )
            }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: IdentityProviderConfigurationProperty
            ): software.amazon.awscdk.services.healthlake.CfnFHIRDatastore.IdentityProviderConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SseConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param kmsEncryptionConfig The server-side encryption key configuration for a
             *   customer provided encryption key (CMK).
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SseConfigurationProperty
            ): software.amazon.awscdk.services.healthlake.CfnFHIRDatastore.SseConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface KmsEncryptionConfigProperty {
        ...
        public interface Builder {
            /**
             * @param cmkType The type of customer-managed-key(CMK) used for encryption. The two
             *   types of supported CMKs are customer owned CMKs and Amazon owned CMKs. For more
             *   information on CMK types, see
             *   [KmsEncryptionConfig](https://docs.aws.amazon.com/healthlake/latest/APIReference/API_KmsEncryptionConfig.html#HealthLake-Type-KmsEncryptionConfig-CmkType)
             *   .
             */
            ...
            /**
             * @param kmsKeyId The KMS encryption key id/alias used to encrypt the data store
             *   contents at rest.
             */
        ...
        internal constructor(
             ...
             * The type of customer-managed-key(CMK) used for encryption.
             *
             * The two types of supported CMKs are customer owned CMKs and Amazon owned CMKs. For
             * more information on CMK types, see
             * [KmsEncryptionConfig](https://docs.aws.amazon.com/healthlake/latest/APIReference/API_KmsEncryptionConfig.html#HealthLake-Type-KmsEncryptionConfig-CmkType)
             * .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-healthlake-fhirdatastore-kmsencryptionconfig.html#cfn-healthlake-fhirdatastore-kmsencryptionconfig-cmktype)
