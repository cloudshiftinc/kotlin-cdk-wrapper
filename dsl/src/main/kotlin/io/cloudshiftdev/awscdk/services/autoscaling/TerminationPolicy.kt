...
public enum class TerminationPolicy(
    ...
    public companion object {
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.autoscaling.TerminationPolicy
        ): TerminationPolicy =
            when (cdkObject) {
                software.amazon.awscdk.services.autoscaling.TerminationPolicy.ALLOCATION_STRATEGY ->
                ...
                software.amazon.awscdk.services.autoscaling.TerminationPolicy
                    .OLDEST_LAUNCH_CONFIGURATION -> TerminationPolicy.OLDEST_LAUNCH_CONFIGURATION
                software.amazon.awscdk.services.autoscaling.TerminationPolicy
                    .OLDEST_LAUNCH_TEMPLATE -> TerminationPolicy.OLDEST_LAUNCH_TEMPLATE
                software.amazon.awscdk.services.autoscaling.TerminationPolicy
                    .CUSTOM_LAMBDA_FUNCTION -> TerminationPolicy.CUSTOM_LAMBDA_FUNCTION
            }

        internal fun unwrap(
            wrapped: TerminationPolicy
