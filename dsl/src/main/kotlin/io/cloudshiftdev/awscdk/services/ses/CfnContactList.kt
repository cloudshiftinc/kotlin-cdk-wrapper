...
internal constructor(
    ...
    public companion object {
        ...
        ): CfnContactList = CfnContactList(cdkObject)

        internal fun unwrap(
            wrapped: CfnContactList
        ): software.amazon.awscdk.services.ses.CfnContactList = wrapped.cdkObject
    }
    ...
    public interface TopicProperty {
        ...
        public interface Builder {
            /**
             * @param defaultSubscriptionStatus The default subscription status to be applied to a
             *   contact if the contact has not noted their preference for subscribing to a topic.
             */
            public fun defaultSubscriptionStatus(defaultSubscriptionStatus: String)

            /**
             * @param description A description of what the topic is about, which the contact will
             *   see.
             */
            public fun description(description: String)
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ses-contactlist-topic.html#cfn-ses-contactlist-topic-defaultsubscriptionstatus)
             */
            override fun defaultSubscriptionStatus(): String =
