...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param applicationName The name of the Elastic Beanstalk application to associate with
         ...
         *
         * @param environmentId The ID of an environment whose settings you want to use to create
         ...
         * template. It also determines the set of configuration options as well as the possible and
         ...
         *   version) that this configuration uses.
         */
         ...
         *
         * @param sourceConfiguration An Elastic Beanstalk configuration template to base this one
         *   on.
         */
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnConfigurationTemplate
        ): software.amazon.awscdk.services.elasticbeanstalk.CfnConfigurationTemplate =
            wrapped.cdkObject
    }
    ...
    public interface ConfigurationOptionSettingProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ConfigurationOptionSettingProperty
            ): software.amazon.awscdk.services.elasticbeanstalk.CfnConfigurationTemplate.ConfigurationOptionSettingProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
