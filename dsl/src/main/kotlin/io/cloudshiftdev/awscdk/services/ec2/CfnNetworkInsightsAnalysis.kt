...
internal constructor(
    ...
    public open fun additionalAccounts(): List<String> =
        unwrap(this).getAdditionalAccounts() ?: emptyList()
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnNetworkInsightsAnalysis
    ...
    public interface AnalysisLoadBalancerTargetProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AnalysisLoadBalancerTargetProperty
            ): software.amazon.awscdk.services.ec2.CfnNetworkInsightsAnalysis.AnalysisLoadBalancerTargetProperty =
    ...
    public interface ExplanationProperty {
         ...
         */
        public fun classicLoadBalancerListener(): Any? =
         ...
         */
        public fun elasticLoadBalancerListener(): Any? =
        ...
        public interface Builder {
            ...
            public fun classicLoadBalancerListener(
                classicLoadBalancerListener: AnalysisLoadBalancerListenerProperty.Builder.() -> Unit
            )
            ...
            public fun customerGateway(
                customerGateway: AnalysisComponentProperty.Builder.() -> Unit
            )
            ...
            public fun elasticLoadBalancerListener(
                elasticLoadBalancerListener: AnalysisComponentProperty.Builder.() -> Unit
            )
            ...
            public fun ingressRouteTable(
                ingressRouteTable: AnalysisComponentProperty.Builder.() -> Unit
            )
            ...
            public fun internetGateway(
                internetGateway: AnalysisComponentProperty.Builder.() -> Unit
            )
            ...
            public fun loadBalancerTarget(
                loadBalancerTarget: AnalysisLoadBalancerTargetProperty.Builder.() -> Unit
            )
            ...
            public fun loadBalancerTargetGroup(
                loadBalancerTargetGroup: AnalysisComponentProperty.Builder.() -> Unit
            )
            ...
            public fun networkInterface(
                networkInterface: AnalysisComponentProperty.Builder.() -> Unit
            )
            ...
            public fun routeTableRoute(
                routeTableRoute: AnalysisRouteTableRouteProperty.Builder.() -> Unit
            )
            ...
            public fun securityGroupRule(
                securityGroupRule: AnalysisSecurityGroupRuleProperty.Builder.() -> Unit
            )
            ...
            public fun subnetRouteTable(
                subnetRouteTable: AnalysisComponentProperty.Builder.() -> Unit
            )
            ...
            public fun transitGatewayAttachment(
                transitGatewayAttachment: AnalysisComponentProperty.Builder.() -> Unit
            )
            ...
            public fun transitGatewayRouteTable(
                transitGatewayRouteTable: AnalysisComponentProperty.Builder.() -> Unit
            )
            ...
            public fun transitGatewayRouteTableRoute(
                transitGatewayRouteTableRoute:
                    TransitGatewayRouteTableRouteProperty.Builder.() -> Unit
            )
            ...
            public fun vpcPeeringConnection(
                vpcPeeringConnection: AnalysisComponentProperty.Builder.() -> Unit
            )
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("01150afd5fcce850597a9a8c13865b687d2babebc2e550c94c6861feafe33bc6")
            override fun attachedTo(
                attachedTo: AnalysisComponentProperty.Builder.() -> Unit
            ): Unit = attachedTo(AnalysisComponentProperty(attachedTo))
            ...
            override fun classicLoadBalancerListener(classicLoadBalancerListener: IResolvable) {
                cdkBuilder.classicLoadBalancerListener(
                    classicLoadBalancerListener.let(IResolvable::unwrap)
                )
            }

            /** @param classicLoadBalancerListener The listener for a Classic Load Balancer. */
            override fun classicLoadBalancerListener(
                classicLoadBalancerListener: AnalysisLoadBalancerListenerProperty
            ) {
                cdkBuilder.classicLoadBalancerListener(
                    classicLoadBalancerListener.let(AnalysisLoadBalancerListenerProperty::unwrap)
                )
            }
            ...
            override fun classicLoadBalancerListener(
                ...
                classicLoadBalancerListener(
                    AnalysisLoadBalancerListenerProperty(classicLoadBalancerListener)
                )
            ...
            override fun destination(
                destination: AnalysisComponentProperty.Builder.() -> Unit
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("f51af5adec137b322543aa5b0b0d2b9894b124914af8bb8ad9a0aa98f1c9c2ea")
            override fun destinationVpc(
                destinationVpc: AnalysisComponentProperty.Builder.() -> Unit
            ...
            override fun elasticLoadBalancerListener(elasticLoadBalancerListener: IResolvable) {
                cdkBuilder.elasticLoadBalancerListener(
                    elasticLoadBalancerListener.let(IResolvable::unwrap)
                )
            }

            /** @param elasticLoadBalancerListener The load balancer listener. */
            override fun elasticLoadBalancerListener(
                elasticLoadBalancerListener: AnalysisComponentProperty
            ) {
                cdkBuilder.elasticLoadBalancerListener(
                    elasticLoadBalancerListener.let(AnalysisComponentProperty::unwrap)
                )
            }
            ...
            override fun elasticLoadBalancerListener(
                ...
                elasticLoadBalancerListener(AnalysisComponentProperty(elasticLoadBalancerListener))
            ...
            override fun ingressRouteTable(ingressRouteTable: AnalysisComponentProperty) {
                cdkBuilder.ingressRouteTable(
                    ingressRouteTable.let(AnalysisComponentProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("773755699fd1941dfadb46cba6b17aabf027d523e82b5f1d6dcc0d910c59cb58")
            override fun ingressRouteTable(
                ingressRouteTable: AnalysisComponentProperty.Builder.() -> Unit
            ...
            /** @param loadBalancerTarget The target. */
            override fun loadBalancerTarget(
                loadBalancerTarget: AnalysisLoadBalancerTargetProperty
            ) {
                cdkBuilder.loadBalancerTarget(
                    loadBalancerTarget.let(AnalysisLoadBalancerTargetProperty::unwrap)
                )
            }
            ...
            /** @param loadBalancerTargetGroup The target group. */
            override fun loadBalancerTargetGroup(
                loadBalancerTargetGroup: AnalysisComponentProperty
            ) {
                cdkBuilder.loadBalancerTargetGroup(
                    loadBalancerTargetGroup.let(AnalysisComponentProperty::unwrap)
                )
            }
            ...
            override fun loadBalancerTargetGroups(loadBalancerTargetGroups: IResolvable) {
                cdkBuilder.loadBalancerTargetGroups(
                    loadBalancerTargetGroups.let(IResolvable::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("fa801e01d40ce33c9b25562393ea028bfe9c43f5ed7d605725a8f56615b919ac")
            override fun natGateway(
                natGateway: AnalysisComponentProperty.Builder.() -> Unit
            ): Unit = natGateway(AnalysisComponentProperty(natGateway))
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("1da1c72a17748568ee9f55443dff6778305e20c538f7276338708663554a72e6")
            override fun prefixList(
                prefixList: AnalysisComponentProperty.Builder.() -> Unit
            ): Unit = prefixList(AnalysisComponentProperty(prefixList))
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("addd8d3e5338b52fe2640bcbabf54aadd69b710bdd658262a9d5d87ca019e953")
            override fun routeTable(
                routeTable: AnalysisComponentProperty.Builder.() -> Unit
            ): Unit = routeTable(AnalysisComponentProperty(routeTable))
            ...
            override fun routeTableRoute(routeTableRoute: AnalysisRouteTableRouteProperty) {
                cdkBuilder.routeTableRoute(
                    routeTableRoute.let(AnalysisRouteTableRouteProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("a57eb2f9eb9322cb9ff3b93a37f91e6352d6bd8f90fe4feba0989e1ee56e9cbf")
            override fun securityGroup(
                securityGroup: AnalysisComponentProperty.Builder.() -> Unit
            ): Unit = securityGroup(AnalysisComponentProperty(securityGroup))
            ...
            override fun securityGroupRule(securityGroupRule: AnalysisSecurityGroupRuleProperty) {
                cdkBuilder.securityGroupRule(
                    securityGroupRule.let(AnalysisSecurityGroupRuleProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("e492823be51adb2a2414d80236e38df04a8dc309a590a9df62e986acbdfa6e87")
            override fun securityGroupRule(
                securityGroupRule: AnalysisSecurityGroupRuleProperty.Builder.() -> Unit
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("50266278c0845fca742e5d73d33fa93efb0b72c2fb8141dc083edc1228c4409d")
            override fun transitGateway(
                transitGateway: AnalysisComponentProperty.Builder.() -> Unit
            ...
            override fun transitGatewayAttachment(transitGatewayAttachment: IResolvable) {
                cdkBuilder.transitGatewayAttachment(
                    transitGatewayAttachment.let(IResolvable::unwrap)
                )
            }

            /** @param transitGatewayAttachment The transit gateway attachment. */
            override fun transitGatewayAttachment(
                transitGatewayAttachment: AnalysisComponentProperty
            ) {
                cdkBuilder.transitGatewayAttachment(
                    transitGatewayAttachment.let(AnalysisComponentProperty::unwrap)
                )
            }
            ...
            override fun transitGatewayRouteTable(transitGatewayRouteTable: IResolvable) {
                cdkBuilder.transitGatewayRouteTable(
                    transitGatewayRouteTable.let(IResolvable::unwrap)
                )
            }

            /** @param transitGatewayRouteTable The transit gateway route table. */
            override fun transitGatewayRouteTable(
                transitGatewayRouteTable: AnalysisComponentProperty
            ) {
                cdkBuilder.transitGatewayRouteTable(
                    transitGatewayRouteTable.let(AnalysisComponentProperty::unwrap)
                )
            }
            ...
            override fun transitGatewayRouteTableRoute(transitGatewayRouteTableRoute: IResolvable) {
                cdkBuilder.transitGatewayRouteTableRoute(
                    transitGatewayRouteTableRoute.let(IResolvable::unwrap)
                )
            }
            ...
            override fun transitGatewayRouteTableRoute(
                ...
                cdkBuilder.transitGatewayRouteTableRoute(
                    transitGatewayRouteTableRoute.let(TransitGatewayRouteTableRouteProperty::unwrap)
                )
            }
            ...
            override fun transitGatewayRouteTableRoute(
                ...
                transitGatewayRouteTableRoute(
                    TransitGatewayRouteTableRouteProperty(transitGatewayRouteTableRoute)
                )
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("bf6c7e8e6abb4afdf2a4fcec210177d1c2cbc27eb69931f026da17bc8c57f925")
            override fun vpcEndpoint(
                vpcEndpoint: AnalysisComponentProperty.Builder.() -> Unit
            ...
            override fun vpcPeeringConnection(vpcPeeringConnection: AnalysisComponentProperty) {
                cdkBuilder.vpcPeeringConnection(
                    vpcPeeringConnection.let(AnalysisComponentProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("2fb68077a808fd6bb36e2bb7582c7b0d6c7a4e55663ab7f4e19ef9207233ef52")
            override fun vpcPeeringConnection(
                vpcPeeringConnection: AnalysisComponentProperty.Builder.() -> Unit
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("a06080ec27a8e104f495416404d4065e86ad807d4c24b86ad554ec55bb6704c0")
            override fun vpnConnection(
                vpnConnection: AnalysisComponentProperty.Builder.() -> Unit
            ): Unit = vpnConnection(AnalysisComponentProperty(vpnConnection))
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("bc28fbd01369a3708d7b71693a81ceb38cdc4ba3d0de7d8b77fd55f13281aecb")
            override fun vpnGateway(
                vpnGateway: AnalysisComponentProperty.Builder.() -> Unit
            ): Unit = vpnGateway(AnalysisComponentProperty(vpnGateway))
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ec2-networkinsightsanalysis-explanation.html#cfn-ec2-networkinsightsanalysis-explanation-loadbalancerlistenerport)
             */
            override fun loadBalancerListenerPort(): Number? =
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ec2-networkinsightsanalysis-explanation.html#cfn-ec2-networkinsightsanalysis-explanation-loadbalancertargetgroups)
             */
            override fun loadBalancerTargetGroups(): Any? =
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ec2-networkinsightsanalysis-explanation.html#cfn-ec2-networkinsightsanalysis-explanation-loadbalancertargetport)
             */
            override fun loadBalancerTargetPort(): Number? =
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ec2-networkinsightsanalysis-explanation.html#cfn-ec2-networkinsightsanalysis-explanation-transitgatewayattachment)
             */
            override fun transitGatewayAttachment(): Any? =
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ec2-networkinsightsanalysis-explanation.html#cfn-ec2-networkinsightsanalysis-explanation-transitgatewayroutetable)
             */
            override fun transitGatewayRouteTable(): Any? =
    ...
    public interface AnalysisPacketHeaderProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AnalysisPacketHeaderProperty
            ): software.amazon.awscdk.services.ec2.CfnNetworkInsightsAnalysis.AnalysisPacketHeaderProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface AnalysisComponentProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AnalysisComponentProperty
            ): software.amazon.awscdk.services.ec2.CfnNetworkInsightsAnalysis.AnalysisComponentProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface AlternatePathHintProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AlternatePathHintProperty
            ): software.amazon.awscdk.services.ec2.CfnNetworkInsightsAnalysis.AlternatePathHintProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface AnalysisLoadBalancerListenerProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AnalysisLoadBalancerListenerProperty
            ): software.amazon.awscdk.services.ec2.CfnNetworkInsightsAnalysis.AnalysisLoadBalancerListenerProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface AnalysisAclRuleProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AnalysisAclRuleProperty
            ): software.amazon.awscdk.services.ec2.CfnNetworkInsightsAnalysis.AnalysisAclRuleProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface PathComponentProperty {
        ...
        public interface Builder {
            ...
            public fun outboundHeader(
                outboundHeader: AnalysisPacketHeaderProperty.Builder.() -> Unit
            )
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("fc30358ec3aab04fe98b5ec1f273f7c7891cc1e763d58e4161226b193769c2b2")
            override fun inboundHeader(
                inboundHeader: AnalysisPacketHeaderProperty.Builder.() -> Unit
    ...
    public interface TransitGatewayRouteTableRouteProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TransitGatewayRouteTableRouteProperty
            ): software.amazon.awscdk.services.ec2.CfnNetworkInsightsAnalysis.TransitGatewayRouteTableRouteProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface AnalysisSecurityGroupRuleProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AnalysisSecurityGroupRuleProperty
            ): software.amazon.awscdk.services.ec2.CfnNetworkInsightsAnalysis.AnalysisSecurityGroupRuleProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface AdditionalDetailProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AdditionalDetailProperty
            ): software.amazon.awscdk.services.ec2.CfnNetworkInsightsAnalysis.AdditionalDetailProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface AnalysisRouteTableRouteProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param gatewayId The ID of the gateway, such as an internet gateway or virtual
             *   private gateway.
             */
            ...
            /**
             * @param origin Describes how the route was created. The following are the possible
             *   values:.
             * * CreateRouteTable - The route was automatically created when the route table was
             *   created.
             * * CreateRoute - The route was manually added to the route table.
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ec2-networkinsightsanalysis-analysisroutetableroute.html#cfn-ec2-networkinsightsanalysis-analysisroutetableroute-destinationprefixlistid)
             */
            override fun destinationPrefixListId(): String? =
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ec2-networkinsightsanalysis-analysisroutetableroute.html#cfn-ec2-networkinsightsanalysis-analysisroutetableroute-vpcpeeringconnectionid)
             */
            override fun vpcPeeringConnectionId(): String? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AnalysisRouteTableRouteProperty
            ): software.amazon.awscdk.services.ec2.CfnNetworkInsightsAnalysis.AnalysisRouteTableRouteProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
