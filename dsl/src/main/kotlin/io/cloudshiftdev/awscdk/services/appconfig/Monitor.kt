...
internal constructor(
    ...
    /** The type of monitor. */
    public open fun monitorType(): MonitorType =
        unwrap(this).getMonitorType().let(MonitorType::wrap)
    ...
    public companion object {
        public fun fromCfnMonitorsProperty(
            ...
            software.amazon.awscdk.services.appconfig.Monitor.fromCfnMonitorsProperty(
                    monitorsProperty.let(CfnEnvironment.MonitorsProperty::unwrap)
                )
                .let(Monitor::wrap)
        ...
        public fun fromCfnMonitorsProperty(
            monitorsProperty: CfnEnvironment.MonitorsProperty.Builder.() -> Unit
        ...
        public fun fromCloudWatchAlarm(alarm: IAlarm): Monitor =
            software.amazon.awscdk.services.appconfig.Monitor.fromCloudWatchAlarm(
                    alarm.let(IAlarm::unwrap)
                )
                .let(Monitor::wrap)
