...
internal constructor(
    ...
    /**
     * When you pass the logical ID of this resource, the function returns the 12-digit account
     * number of the AWS account that owns the domain that contains the repository.
     */
    public open fun attrDomainOwner(): String = unwrap(this).getAttrDomainOwner()

    /**
     * When you pass the logical ID of this resource, the function returns the name of the
     * repository.
     */
    ...
    public open fun externalConnections(): List<String> =
        unwrap(this).getExternalConnections() ?: emptyList()
    ...
    public interface Builder {
         ...
         *
         * @param externalConnections An array of external connections associated with the
         *   repository.
         */
         ...
         *
         * @param permissionsPolicyDocument The document that defines the resource policy that is
         *   set on a repository.
         */
         ...
         * A list of upstream repositories to associate with the repository.
         *
         * The order of the upstream repositories in the list determines their priority order when
         * AWS CodeArtifact looks for a requested package version. For more information, see
