...
public interface KeyLookupOptions {
    ...
    public interface Builder {
        /**
         * @param aliasName The alias name of the Key. Must be in the format
         *   `alias/&lt;AliasName&gt;`.
         */
    ...
    private class BuilderImpl : Builder {
        ...
        public fun build(): software.amazon.awscdk.services.kms.KeyLookupOptions =
            cdkBuilder.build()
    }
