...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param accessLogSetting Access log settings, including the access log format and access
         *   log destination ARN.
         */
         ...
         * The stage's cache capacity in GB.
         *
         * For more information about choosing a cache size, see
         ...
         *
         * @param tracingEnabled Specifies whether active tracing with X-ray is enabled for the
         *   Stage.
         */
        ...
        /**
         * A map (string-to-string map) that defines the stage variables, where the variable name is
         * the key and the variable value is the value.
         *
    ...
    public companion object {
        ...
        ): CfnStage = CfnStage(cdkObject)

        internal fun unwrap(
            wrapped: CfnStage
        ): software.amazon.awscdk.services.apigateway.CfnStage = wrapped.cdkObject
    }
    ...
    public interface AccessLogSettingProperty {
        ...
        public interface Builder {
             ...
             *   selected
             *   [$context variables](https://docs.aws.amazon.com/apigateway/latest/developerguide/api-gateway-mapping-template-reference.html#context-variable-reference)
             *   . The format must include at least `$context.requestId` . This parameter is
        ...
        internal constructor(
             ...
             * with `amazon-apigateway-` . This parameter is required to enable access logging.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-apigateway-stage-accesslogsetting.html#cfn-apigateway-stage-accesslogsetting-destinationarn)
             */
             ...
             * A single line format of the access logs of data, as specified by selected
             * [$context variables](https://docs.aws.amazon.com/apigateway/latest/developerguide/api-gateway-mapping-template-reference.html#context-variable-reference)
             * . The format must include at least `$context.requestId` . This parameter is required
    ...
    public interface MethodSettingProperty {
         ...
         * `HttpMethod` and `/ *` for the `ResourcePath` . This parameter is required when you
         ...
         * settings to multiple resources and methods, specify an asterisk ( `*` ) for the
         * `HttpMethod` and `/ *` for the `ResourcePath` . This parameter is required when you
         * specify a `MethodSetting` .
         *
        ...
        public interface Builder {
            ...
            /**
             * @param httpMethod The HTTP method. To apply settings to multiple resources and
             *   methods, specify an asterisk ( `*` ) for the `HttpMethod` and `/ *` for the
             ...
             *   `/~1resource~1subresource` . To specify the root path, use only a slash ( `/` ). To
             *   apply settings to multiple resources and methods, specify an asterisk ( `*` ) for
             *   the `HttpMethod` and `/ *` for the `ResourcePath` . This parameter is required when
             *   you specify a `MethodSetting` .
             */
        ...
        internal constructor(
             ...
             * The HTTP method.
             *
             * To apply settings to multiple resources and methods, specify an asterisk ( `*` ) for
             * the `HttpMethod` and `/ *` for the `ResourcePath` . This parameter is required when
             * you specify a `MethodSetting` .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-apigateway-stage-methodsetting.html#cfn-apigateway-stage-methodsetting-httpmethod)
