...
public interface DockerImageAssetProps : DockerImageAssetOptions {
    ...
    public interface Builder {
        ...
        /**
         * @param directory The directory where the Dockerfile is stored. Any directory inside with
         *   a name that matches the CDK output folder (cdk.out by default) will be excluded from
         *   the asset
         */
