...
internal constructor(
    ...
    public open fun kinesisConfiguration(
        `value`: KinesisConfigurationProperty.Builder.() -> Unit
    ...
    public interface Builder {
         ...
         * The inclusive start date and time from which to start streaming journal data.
         *
         * This parameter must be in `ISO 8601` date and time format and in Universal Coordinated
        ...
        public fun kinesisConfiguration(
            kinesisConfiguration: KinesisConfigurationProperty.Builder.() -> Unit
        )
         ...
         *
         * @param roleArn The Amazon Resource Name (ARN) of the IAM role that grants QLDB
         *   permissions for a journal stream to write data records to a Kinesis Data Streams
         *   resource.
         */
         ...
         *
         * Your stream name must be unique among other *active* streams for a given ledger. Stream
         * names have the same naming constraints as ledger names, as defined in
    ...
    private class BuilderImpl(
        ...
        override fun kinesisConfiguration(kinesisConfiguration: KinesisConfigurationProperty) {
            cdkBuilder.kinesisConfiguration(
                kinesisConfiguration.let(KinesisConfigurationProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("b6eb11e9ed469570ba3bc97103edbb5bf655976e20a4082a43e3f442faa9ecb7")
        override fun kinesisConfiguration(
            kinesisConfiguration: KinesisConfigurationProperty.Builder.() -> Unit
    ...
    public interface KinesisConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param aggregationEnabled Enables QLDB to publish multiple data records in a single
             *   Kinesis Data Streams record, increasing the number of records sent per API call.
             *   Default: `True`
             *
             * Record aggregation has important implications for processing records and requires
             * de-aggregation in your stream consumer. To learn more, see
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: KinesisConfigurationProperty
            ): software.amazon.awscdk.services.qldb.CfnStream.KinesisConfigurationProperty =
