...
internal constructor(
    ...
    public interface Builder {
        ...
        public fun sourceFailoverConfig(
            sourceFailoverConfig: FailoverConfigProperty.Builder.() -> Unit
        )
    }
    ...
    private class BuilderImpl(
        ...
        override fun sourceFailoverConfig(sourceFailoverConfig: FailoverConfigProperty) {
            cdkBuilder.sourceFailoverConfig(
                sourceFailoverConfig.let(FailoverConfigProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("5abeb077251f47edc02bd2b28a08721f306e31d06bd4f4b2bbc800e2fc3b9141")
        override fun sourceFailoverConfig(
            sourceFailoverConfig: FailoverConfigProperty.Builder.() -> Unit
        ): Unit = sourceFailoverConfig(FailoverConfigProperty(sourceFailoverConfig))

        public fun build(): software.amazon.awscdk.services.mediaconnect.CfnFlow =
            cdkBuilder.build()
    }
    ...
    public companion object {
        ...
        ): CfnFlow = CfnFlow(cdkObject)

        internal fun unwrap(
            wrapped: CfnFlow
        ): software.amazon.awscdk.services.mediaconnect.CfnFlow = wrapped.cdkObject
    }
    ...
    public interface SourcePriorityProperty {
        ...
        public interface Builder {
            /**
             * @param primarySource The name of the source you choose as the primary source for this
             *   flow.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SourcePriorityProperty
            ): software.amazon.awscdk.services.mediaconnect.CfnFlow.SourcePriorityProperty =
    ...
    public interface FailoverConfigProperty {
         ...
         *
         * MERGE combines the source streams into a single stream, allowing graceful recovery from
         * any single-source loss. FAILOVER allows switching between different streams. The string
         * for this property must be entered as MERGE or FAILOVER. No other string entry is valid.
         *
         ...
         * correction. A smaller buffer means a shorter delay, but less room for error correction.
         * You can choose a value from 100-500 ms. If you keep this field blank, the service uses
         * the default value of 200 ms. This setting only applies when Failover Mode is set to
         * MERGE.
         *
         ...
         * This setting only applies when Failover Mode is set to FAILOVER.
         *
        ...
        public interface Builder {
            /**
             * @param failoverMode The type of failover you choose for this flow. MERGE combines the
             *   source streams into a single stream, allowing graceful recovery from any
             *   single-source loss. FAILOVER allows switching between different streams. The string
             *   for this property must be entered as MERGE or FAILOVER. No other string entry is
             *   valid.
             */
            public fun failoverMode(failoverMode: String)

            /**
             * @param recoveryWindow The size of the buffer (delay) that the service maintains. A
             *   larger buffer means a longer delay in transmitting the stream, but more room for
             *   error correction. A smaller buffer means a shorter delay, but less room for error
             *   correction. You can choose a value from 100-500 ms. If you keep this field blank,
             *   the service uses the default value of 200 ms. This setting only applies when
             *   Failover Mode is set to MERGE.
             */
            public fun recoveryWindow(recoveryWindow: Number)

            /**
             * @param sourcePriority The priority you want to assign to a source. You can have a
             *   primary stream and a backup stream or two equally prioritized streams. This setting
             *   only applies when Failover Mode is set to FAILOVER.
             */
            ...
            /**
             * @param state The state of source failover on the flow. If the state is inactive, the
             *   flow can have only one source. If the state is active, the flow can have one or two
             *   sources.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("433bb811abbc6de8c47e56b6bda3581404f5d13ff508958578003f78c0329544")
            override fun sourcePriority(
                sourcePriority: SourcePriorityProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * The type of failover you choose for this flow.
             *
             * MERGE combines the source streams into a single stream, allowing graceful recovery
             * from any single-source loss. FAILOVER allows switching between different streams. The
             * string for this property must be entered as MERGE or FAILOVER. No other string entry
             * is valid.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-mediaconnect-flow-failoverconfig.html#cfn-mediaconnect-flow-failoverconfig-failovermode)
             */
             ...
             * The size of the buffer (delay) that the service maintains.
             *
             * A larger buffer means a longer delay in transmitting the stream, but more room for
             * error correction. A smaller buffer means a shorter delay, but less room for error
             * correction. You can choose a value from 100-500 ms. If you keep this field blank, the
             * service uses the default value of 200 ms. This setting only applies when Failover
             * Mode is set to MERGE.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-mediaconnect-flow-failoverconfig.html#cfn-mediaconnect-flow-failoverconfig-recoverywindow)
             */
             ...
             * The state of source failover on the flow.
             *
             * If the state is inactive, the flow can have only one source. If the state is active,
             * the flow can have one or two sources.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-mediaconnect-flow-failoverconfig.html#cfn-mediaconnect-flow-failoverconfig-state)
             */
    ...
    public interface EncryptionProperty {
        ...
        /**
         * A 128-bit, 16-byte hex value represented by a 32-character string, to be used with the
         ...
         *
         * If you don't specify a `keyType` value, the service uses the default setting (
         ...
         * resource ID is also known as the content ID. This parameter is required for SPEKE
        ...
        /**
         * The ARN of the secret that you created in AWS Secrets Manager to store the encryption
         * key.
         *
        ...
        public interface Builder {
            /**
             * @param algorithm The type of algorithm that is used for static key encryption (such
             *   as aes128, aes192, or aes256). If you are using SPEKE or SRT-password encryption,
             *   this property must be left blank.
             */
            public fun algorithm(algorithm: String)

            /**
             * @param constantInitializationVector A 128-bit, 16-byte hex value represented by a
             *   32-character string, to be used with the key for encrypting content. This parameter
             ...
             *   rights management (DRM) platform key provider. This parameter is required for SPEKE
             *   encryption and is not valid for static key encryption.
             */
            public fun deviceId(deviceId: String)

            /**
             * @param keyType The type of key that is used for the encryption. If you don't specify
             *   a `keyType` value, the service uses the default setting ( `static-key` ). Valid key
             *   types are: `static-key` , `speke` , and `srt-password` .
             */
            ...
            /**
             * @param resourceId An identifier for the content. The service sends this value to the
             *   key server to identify the current endpoint. The resource ID is also known as the
            ...
            /**
             * @param roleArn The Amazon Resource Name (ARN) of the role that you created during
             *   setup (when you set up MediaConnect as a trusted entity).
             */
            public fun roleArn(roleArn: String)

            /**
             * @param secretArn The ARN of the secret that you created in AWS Secrets Manager to
             *   store the encryption key.
             */
            public fun secretArn(secretArn: String)

            /**
             * @param url The URL from the API Gateway proxy that you set up to talk to your key
             *   server. This parameter is required for SPEKE encryption and is not valid for static
             *   key encryption.
             */
        ...
        internal constructor(
            ...
            /**
             * The Amazon Resource Name (ARN) of the role that you created during setup (when you
    ...
    public interface SourceProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param description A description of the source. This description is not visible
             *   outside of the current AWS account.
             */
            public fun description(description: String)

            /**
             * @param entitlementArn The ARN of the entitlement that allows you to subscribe to
             *   content that comes from another AWS account. The entitlement is set by the content
             *   originator and the ARN is generated as part of the originator’s flow.
             */
            public fun entitlementArn(entitlementArn: String)

            /**
             * @param gatewayBridgeSource The source configuration for cloud flows receiving a
             *   stream from a bridge.
             */
            ...
            public fun gatewayBridgeSource(
                gatewayBridgeSource: GatewayBridgeSourceProperty.Builder.() -> Unit
            )
            ...
            /**
             * @param ingestPort The port that the flow listens on for incoming content. If the
            ...
            /**
             * @param maxLatency The maximum latency in milliseconds for a RIST or Zixi-based
             *   source.
             */
            public fun maxLatency(maxLatency: Number)

            /**
             * @param minLatency The minimum latency in milliseconds for SRT-based streams. In
             *   streams that use the SRT protocol, this value that you set on your MediaConnect
             *   source or output represents the minimal potential latency of that connection. The
             *   latency of the stream is set to the highest number between the sender’s minimum
            ...
            /**
             * @param senderControlPort The port that the flow uses to send outbound requests to
            ...
            /**
             * @param sourceIngestPort The port that the flow listens on for incoming content. If
            ...
            /**
             * @param streamId The stream ID that you want to use for the transport. This parameter
             *   applies only to Zixi-based streams.
             */
            public fun streamId(streamId: String)

            /**
             * @param vpcInterfaceName The name of the VPC interface that the source content comes
             *   from.
             */
            public fun vpcInterfaceName(vpcInterfaceName: String)

            /**
             * @param whitelistCidr The range of IP addresses that are allowed to contribute content
             *   to your source. Format the IP addresses as a Classless Inter-Domain Routing (CIDR)
        ...
        private class BuilderImpl : Builder {
            ...
            override fun gatewayBridgeSource(gatewayBridgeSource: GatewayBridgeSourceProperty) {
                cdkBuilder.gatewayBridgeSource(
                    gatewayBridgeSource.let(GatewayBridgeSourceProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("59af1f5ef7b61a09b7066cb3d6d56bbcc153a0fef7d5dae13da07b5541281d90")
            override fun gatewayBridgeSource(
                gatewayBridgeSource: GatewayBridgeSourceProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * another AWS account.
             *
             * The entitlement is set by the content originator and the ARN is generated as part of
             ...
             * The minimum latency in milliseconds for SRT-based streams.
             *
             * In streams that use the SRT protocol, this value that you set on your MediaConnect
             * source or output represents the minimal potential latency of that connection. The
             * latency of the stream is set to the highest number between the sender’s minimum
             * latency and the receiver’s minimum latency.
             *
             ...
             * The protocol that is used by the source.
             *
             * AWS CloudFormation does not currently support CDI or ST 2110 JPEG XS source
             * protocols.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-mediaconnect-flow-source.html#cfn-mediaconnect-flow-source-protocol)
             */
    ...
    public interface GatewayBridgeSourceProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param vpcInterfaceAttachment The name of the VPC interface attachment to use for
             *   this bridge source.
             */
            ...
            public fun vpcInterfaceAttachment(
                vpcInterfaceAttachment: VpcInterfaceAttachmentProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
             ...
             *   this bridge source.
             */
            override fun vpcInterfaceAttachment(
                vpcInterfaceAttachment: VpcInterfaceAttachmentProperty
            ) {
                cdkBuilder.vpcInterfaceAttachment(
                    vpcInterfaceAttachment.let(VpcInterfaceAttachmentProperty::unwrap)
                )
            }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: GatewayBridgeSourceProperty
            ): software.amazon.awscdk.services.mediaconnect.CfnFlow.GatewayBridgeSourceProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface VpcInterfaceAttachmentProperty {
        ...
        public interface Builder {
            /**
             * @param vpcInterfaceName The name of the VPC interface that you want to send your
             *   output to.
             */
            public fun vpcInterfaceName(vpcInterfaceName: String)
        }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: VpcInterfaceAttachmentProperty
            ): software.amazon.awscdk.services.mediaconnect.CfnFlow.VpcInterfaceAttachmentProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
