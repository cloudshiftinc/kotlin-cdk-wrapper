...
public interface KubectlProviderAttributes {
    ...
    public interface Builder {
        ...
        /**
         * @param handlerRole The IAM execution role of the handler. This role must be able to
         *   assume kubectlRoleArn
         */
        public fun handlerRole(handlerRole: IRole)

        /**
         * @param kubectlRoleArn The IAM role to assume in order to perform kubectl operations
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: KubectlProviderAttributes
