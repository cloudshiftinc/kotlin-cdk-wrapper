...
public interface SourcedConfigurationOptions : ConfigurationOptions {
    ...
    public interface Builder {
        ...
        /**
         * @param versionNumber The version number of the sourced configuration to deploy. If this
         *   is not specified, then there will be no deployment.
         */
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: SourcedConfigurationOptions
        ): software.amazon.awscdk.services.appconfig.SourcedConfigurationOptions =
