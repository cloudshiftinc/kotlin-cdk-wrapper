...
internal constructor(
    ...
    public override fun addEnvironment(id: String, options: EnvironmentOptions): IEnvironment =
        unwrap(this)
            .addEnvironment(id, options.let(EnvironmentOptions::unwrap))
            .let(IEnvironment::wrap)
    ...
    public override fun addEnvironment(
        id: String,
     ...
     * @param options
     */
    public override fun addHostedConfiguration(
        id: String,
        options: HostedConfigurationOptions
    ): HostedConfiguration =
        unwrap(this)
            .addHostedConfiguration(id, options.let(HostedConfigurationOptions::unwrap))
            .let(HostedConfiguration::wrap)
    ...
    public override fun addHostedConfiguration(
        id: String,
        options: HostedConfigurationOptions.Builder.() -> Unit
    ): HostedConfiguration = addHostedConfiguration(id, HostedConfigurationOptions(options))
     ...
     * @param options
     */
    public override fun addSourcedConfiguration(
        id: String,
        options: SourcedConfigurationOptions
    ): SourcedConfiguration =
        unwrap(this)
            .addSourcedConfiguration(id, options.let(SourcedConfigurationOptions::unwrap))
            .let(SourcedConfiguration::wrap)
    ...
    public override fun addSourcedConfiguration(
        id: String,
        options: SourcedConfigurationOptions.Builder.() -> Unit
    ): SourcedConfiguration = addSourcedConfiguration(id, SourcedConfigurationOptions(options))
     ...
     * @param options Options for the extension.
     */
    public override fun onDeploymentBaking(
        eventDestination: IEventDestination,
        options: ExtensionOptions
    ) {
        unwrap(this)
     ...
     * @param options Options for the extension.
     */
    public override fun onDeploymentComplete(
        eventDestination: IEventDestination,
        options: ExtensionOptions
    ) {
        unwrap(this)
     ...
     * @param options Options for the extension.
     */
    public override fun onDeploymentRolledBack(
        eventDestination: IEventDestination,
        options: ExtensionOptions
    ) {
        unwrap(this)
     ...
     * @param options Options for the extension.
     */
    public override fun onDeploymentStart(
        eventDestination: IEventDestination,
        options: ExtensionOptions
    ) {
        unwrap(this)
     ...
     * @param options Options for the extension.
     */
    public override fun onDeploymentStep(
        eventDestination: IEventDestination,
        options: ExtensionOptions
    ) {
        unwrap(this)
    ...
    public override fun preCreateHostedConfigurationVersion(eventDestination: IEventDestination) {
        unwrap(this)
            .preCreateHostedConfigurationVersion(eventDestination.let(IEventDestination::unwrap))
    }
     ...
     * @param options Options for the extension.
     */
    public override fun preCreateHostedConfigurationVersion(
        eventDestination: IEventDestination,
        options: ExtensionOptions
    ) {
        unwrap(this)
     ...
     * @param options Options for the extension.
     */
    public override fun preStartDeployment(
        eventDestination: IEventDestination,
        options: ExtensionOptions
    ) {
        unwrap(this)
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.appconfig.Application =
            cdkBuilder.build()
    }

    public companion object {
        public fun addAgentToEcs(taskDef: TaskDefinition) {
            software.amazon.awscdk.services.appconfig.Application.addAgentToEcs(
                taskDef.let(TaskDefinition::unwrap)
            )
        }
        ...
        public fun fromApplicationArn(
            ...
            software.amazon.awscdk.services.appconfig.Application.fromApplicationArn(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    applicationArn
                )
                .let(IApplication::wrap)
        ...
        public fun fromApplicationId(
            ...
            software.amazon.awscdk.services.appconfig.Application.fromApplicationId(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    applicationId
                )
        ...
        public fun lambdaLayerVersionArn(region: String, platform: Platform): String =
            software.amazon.awscdk.services.appconfig.Application.getLambdaLayerVersionArn(
                region,
        ...
        ): Application = Application(cdkObject)

        internal fun unwrap(
            wrapped: Application
        ): software.amazon.awscdk.services.appconfig.Application = wrapped.cdkObject
    }
}
