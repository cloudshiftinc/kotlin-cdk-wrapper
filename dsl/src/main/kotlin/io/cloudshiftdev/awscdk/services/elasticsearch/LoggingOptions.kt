...
public interface LoggingOptions {
    ...
    public interface Builder {
         ...
         * @deprecated use opensearchservice module instead
         */
        @Deprecated(message = "deprecated in CDK") public fun appLogEnabled(appLogEnabled: Boolean)

        /**
         * @param appLogGroup Log Elasticsearch application logs to this log group.
         * @deprecated use opensearchservice module instead
         */
        @Deprecated(message = "deprecated in CDK") public fun appLogGroup(appLogGroup: ILogGroup)
    ...
    internal constructor(
         ...
         * (deprecated) Specify if Elasticsearch audit logging should be set up.
         *
         * Requires Elasticsearch version 6.7 or later and fine grained access control to be
         * enabled.
         *
         * Default: - false
         *
