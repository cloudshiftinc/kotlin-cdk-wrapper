...
internal constructor(
    ...
    public open fun guardrailPolicies(): List<String> =
        unwrap(this).getGuardrailPolicies() ?: emptyList()
    ...
    public interface Builder {
         ...
         *
         * @param guardrailPolicies The list of IAM policy ARNs that are applied as channel
         *   guardrails.
         */
         ...
         *
         * @param loggingLevel Specifies the logging level for this configuration. This property
         ...
         * For more details, see steps 1-4 in
         ...
         *
         * @param userRoleRequired Enables use of a user role requirement in your chat
         *   configuration.
         */
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.chatbot.CfnSlackChannelConfiguration.Builder.create(
                scope,
                id
            )
