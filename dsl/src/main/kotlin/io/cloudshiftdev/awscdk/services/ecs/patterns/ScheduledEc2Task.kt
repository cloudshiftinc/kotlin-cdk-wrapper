...
public open class ScheduledEc2Task
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.ecs.patterns.ScheduledEc2Task,
    ...
    public interface Builder {
         ...
         *
         * ScheduledEc2TaskDefinitionOptions or ScheduledEc2TaskImageOptions must be defined, but
         * not both.
         *
         * Default: none
         *
        ...
        public fun scheduledEc2TaskDefinitionOptions(
            scheduledEc2TaskDefinitionOptions: ScheduledEc2TaskDefinitionOptions.Builder.() -> Unit
        )
         ...
         * Default: none
         *
         * @param scheduledEc2TaskImageOptions The properties to define if the construct is to
        ...
        public fun scheduledEc2TaskImageOptions(
            scheduledEc2TaskImageOptions: ScheduledEc2TaskImageOptions.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
         ...
         *   TaskDefinition in this construct.
         */
        override fun scheduledEc2TaskDefinitionOptions(
            scheduledEc2TaskDefinitionOptions: ScheduledEc2TaskDefinitionOptions
        ) {
            cdkBuilder.scheduledEc2TaskDefinitionOptions(
                scheduledEc2TaskDefinitionOptions.let(ScheduledEc2TaskDefinitionOptions::unwrap)
            )
        }
         ...
         *   create a TaskDefinition.
         */
        override fun scheduledEc2TaskImageOptions(
            scheduledEc2TaskImageOptions: ScheduledEc2TaskImageOptions
        ) {
            cdkBuilder.scheduledEc2TaskImageOptions(
                scheduledEc2TaskImageOptions.let(ScheduledEc2TaskImageOptions::unwrap)
            )
        }
    ...
    public companion object {
        ...
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.ecs.patterns.ScheduledEc2Task
        ): ScheduledEc2Task = ScheduledEc2Task(cdkObject)

        internal fun unwrap(
            wrapped: ScheduledEc2Task
