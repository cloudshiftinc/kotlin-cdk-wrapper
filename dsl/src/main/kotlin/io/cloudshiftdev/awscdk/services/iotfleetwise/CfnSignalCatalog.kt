...
internal constructor(
    ...
    /**
     * The time the signal catalog was created in seconds since epoch (January 1, 1970 at midnight
     * UTC time).
     */
    ...
    public interface Builder {
         ...
         *
         * @param nodes (Optional) A list of information about nodes, which are a general
    ...
    public interface ActuatorProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param fullyQualifiedName The fully qualified name of the actuator. For example, the
             *   fully qualified name of an actuator might be `Vehicle.Front.Left.Door.Lock` .
             */
        ...
        internal constructor(
            ...
            override fun allowedValues(): List<String> =
                unwrap(this).getAllowedValues() ?: emptyList()
    ...
    public interface NodeProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param sensor (Optional) An input component that reports the environmental condition
             *   of a vehicle.
             *
             * You can collect data about fluid levels, temperatures, vibrations, or battery voltage
             * from sensors.
    ...
    public interface SensorProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param fullyQualifiedName The fully qualified name of the sensor. For example, the
             *   fully qualified name of a sensor might be `Vehicle.Body.Engine.Battery` .
             */
            public fun fullyQualifiedName(fullyQualifiedName: String)
            ...
            /**
             * @param unit (Optional) The scientific unit of measurement for data collected by the
             *   sensor.
             */
            public fun unit(unit: String)
        }
    ...
    public interface AttributeProperty {
        ...
        public interface Builder {
            /**
             * @param allowedValues (Optional) A list of possible values an attribute can be
             *   assigned.
             */
            public fun allowedValues(allowedValues: List<String>)
            ...
            /**
             * @param fullyQualifiedName The fully qualified name of the attribute. For example, the
             *   fully qualified name of an attribute might be `Vehicle.Body.Engine.Type` .
             */
            public fun fullyQualifiedName(fullyQualifiedName: String)
    ...
    public interface BranchProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param fullyQualifiedName The fully qualified name of the branch. For example, the
             *   fully qualified name of a branch might be `Vehicle.Body.Engine` .
             */
            public fun fullyQualifiedName(fullyQualifiedName: String)
        }
