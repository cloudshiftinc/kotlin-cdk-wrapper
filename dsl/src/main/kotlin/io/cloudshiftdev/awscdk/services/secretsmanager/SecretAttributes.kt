...
public interface SecretAttributes {
     ...
     * `secretArn` or `secretCompleteArn`.
     */
    ...
    public interface Builder {
        ...
        /**
         * @param secretCompleteArn The complete ARN of the secret in SecretsManager. This is the
         *   ARN including the Secrets Manager 6-character suffix. Cannot be used with `secretArn`
         *   or `secretPartialArn`.
         */
    ...
    internal constructor(
        ...
        /**
         * The encryption key that is used to encrypt the secret, unless the default SecretsManager
         * key is used.
         */
