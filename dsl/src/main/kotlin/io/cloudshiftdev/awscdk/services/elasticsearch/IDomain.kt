...
public interface IDomain : IResource {
     ...
     */
    @Deprecated(message = "deprecated in CDK") public fun domainArn(): String
     ...
     * @deprecated use opensearchservice module instead
     */
    @Deprecated(message = "deprecated in CDK") public fun domainEndpoint(): String
     ...
     * @deprecated use opensearchservice module instead
     */
    @Deprecated(message = "deprecated in CDK") public fun grantRead(identity: IGrantable): Grant
     ...
     * @deprecated use opensearchservice module instead
     */
    @Deprecated(message = "deprecated in CDK") public fun grantWrite(identity: IGrantable): Grant
     ...
     * @deprecated use opensearchservice module instead
     */
    @Deprecated(message = "deprecated in CDK") public fun metric(metricName: String): Metric
     ...
     * @deprecated use opensearchservice module instead
     */
    @Deprecated(message = "deprecated in CDK") public fun metricAutomatedSnapshotFailure(): Metric
     ...
     * @deprecated use opensearchservice module instead
     */
    @Deprecated(message = "deprecated in CDK") public fun metricClusterIndexWritesBlocked(): Metric
     ...
     * @deprecated use opensearchservice module instead
     */
    @Deprecated(message = "deprecated in CDK") public fun metricClusterStatusRed(): Metric
     ...
     * @deprecated use opensearchservice module instead
     */
    @Deprecated(message = "deprecated in CDK") public fun metricClusterStatusYellow(): Metric
     ...
     * @deprecated use opensearchservice module instead
     */
    @Deprecated(message = "deprecated in CDK") public fun metricCpuUtilization(): Metric
     ...
     * @deprecated use opensearchservice module instead
     */
    @Deprecated(message = "deprecated in CDK") public fun metricFreeStorageSpace(): Metric
     ...
     * @deprecated use opensearchservice module instead
     */
    @Deprecated(message = "deprecated in CDK") public fun metricIndexingLatency(): Metric
     ...
     * @deprecated use opensearchservice module instead
     */
    @Deprecated(message = "deprecated in CDK") public fun metricJvmMemoryPressure(): Metric
     ...
     * @deprecated use opensearchservice module instead
     */
    @Deprecated(message = "deprecated in CDK") public fun metricKmsKeyError(): Metric
     ...
     * @deprecated use opensearchservice module instead
     */
    @Deprecated(message = "deprecated in CDK") public fun metricKmsKeyInaccessible(): Metric
     ...
     * @deprecated use opensearchservice module instead
     */
    @Deprecated(message = "deprecated in CDK") public fun metricMasterCpuUtilization(): Metric
     ...
     * @deprecated use opensearchservice module instead
     */
    @Deprecated(message = "deprecated in CDK") public fun metricMasterJvmMemoryPressure(): Metric
     ...
     * @deprecated use opensearchservice module instead
     */
    @Deprecated(message = "deprecated in CDK") public fun metricNodes(): Metric
     ...
     * @deprecated use opensearchservice module instead
     */
    @Deprecated(message = "deprecated in CDK") public fun metricNodes(props: MetricOptions): Metric
     ...
     * @deprecated use opensearchservice module instead
     */
    @Deprecated(message = "deprecated in CDK") public fun metricSearchLatency(): Metric
     ...
     * @deprecated use opensearchservice module instead
     */
    @Deprecated(message = "deprecated in CDK") public fun metricSearchableDocuments(): Metric
    ...
    internal constructor(
        internal val cdkObject: software.amazon.awscdk.services.elasticsearch.IDomain,
    ) : IDomain {
        /**
        ...
        override fun grantIndexReadWrite(index: String, identity: IGrantable): Grant =
            unwrap(this)
                .grantIndexReadWrite(index, identity.let(IGrantable::unwrap))
                .let(Grant::wrap)
        ...
        /**
         * (deprecated) Grant read permissions for a specific path in this domain to an IAM
         * principal (Role/Group/User).
         *
         * @param path The path to grant permissions for.
         * @param identity The principal.
        ...
        /**
         * (deprecated) Grant write permissions for a specific path in this domain to an IAM
         * principal (Role/Group/User).
         *
         * @param path The path to grant permissions for.
         * @param identity The principal.
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("f9f702cdc4e375e8b739cdce26ff5c0a5606646a98edb39614863885f1182c7f")
        override fun metricAutomatedSnapshotFailure(
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("016b489514978517ae80814c783dc254d3f821a64ba427a0725fa9ed3e854018")
        override fun metricClusterIndexWritesBlocked(
            props: MetricOptions.Builder.() -> Unit
        ...
        override fun metricClusterStatusYellow(props: MetricOptions): Metric =
            unwrap(this)
                .metricClusterStatusYellow(props.let(MetricOptions::unwrap))
                .let(Metric::wrap)
         ...
         */
        @Deprecated(message = "deprecated in CDK")
        override fun metricKmsKeyError(): Metric =
        ...
        override fun metricKmsKeyInaccessible(props: MetricOptions): Metric =
            unwrap(this)
                .metricKMSKeyInaccessible(props.let(MetricOptions::unwrap))
                .let(Metric::wrap)
        ...
        override fun metricMasterCpuUtilization(props: MetricOptions): Metric =
            unwrap(this)
                .metricMasterCPUUtilization(props.let(MetricOptions::unwrap))
                .let(Metric::wrap)
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("fbcf8e4882306bcb2bed673a80ed7a54a16cc27adfc1a7fe173fbb566b335350")
        override fun metricMasterJvmMemoryPressure(
            props: MetricOptions.Builder.() -> Unit
        ...
        override fun metricSearchableDocuments(props: MetricOptions): Metric =
            unwrap(this)
                .metricSearchableDocuments(props.let(MetricOptions::unwrap))
                .let(Metric::wrap)
    ...
    public companion object {
        ...
        ): IDomain = Wrapper(cdkObject)

        internal fun unwrap(
            wrapped: IDomain
        ): software.amazon.awscdk.services.elasticsearch.IDomain = (wrapped as Wrapper).cdkObject
    }
}
