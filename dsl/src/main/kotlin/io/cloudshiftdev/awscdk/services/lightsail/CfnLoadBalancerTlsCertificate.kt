...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param certificateAlternativeNames An array of alternative domain names and subdomain
         *   names for your SSL/TLS certificate.
         */
        ...
        /**
         * A Boolean value indicating whether HTTPS redirection is enabled for the load balancer
         * that the TLS certificate is attached to.
         *
        ...
        /**
         * A Boolean value indicating whether the SSL/TLS certificate is attached to a Lightsail
         * load balancer.
         *
         ...
         *
         * @param isAttached A Boolean value indicating whether the SSL/TLS certificate is attached
         *   to a Lightsail load balancer.
         */
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.lightsail.CfnLoadBalancerTlsCertificate.Builder.create(
                scope,
                id
            )
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnLoadBalancerTlsCertificate
        ): software.amazon.awscdk.services.lightsail.CfnLoadBalancerTlsCertificate =
            wrapped.cdkObject
    }
}
