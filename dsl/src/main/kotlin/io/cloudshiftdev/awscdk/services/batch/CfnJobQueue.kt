...
internal constructor(
    ...
    public interface Builder {
         ...
         * Priority is determined in descending order. For example, a job queue with a priority
         * value of `10` is given scheduling preference over a job queue with a priority value of
         * `1` . All of the compute environments must be either EC2 ( `EC2` or `SPOT` ) or Fargate (
         * `FARGATE` or `FARGATE_SPOT` ); EC2 and Fargate compute environments can't be mixed.
         *
         ...
         * The state of the job queue.
         *
         * If the job queue state is `ENABLED` , it is able to accept jobs. If the job queue state
         * is `DISABLED` , new jobs can't be added to the queue, but jobs already in the queue can
         * finish.
         *
         ...
         * [Tagging your AWS Batch resources](https://docs.aws.amazon.com/batch/latest/userguide/using-tags.html)
    ...
    public companion object {
        ...
        ): CfnJobQueue = CfnJobQueue(cdkObject)

        internal fun unwrap(
            wrapped: CfnJobQueue
        ): software.amazon.awscdk.services.batch.CfnJobQueue = wrapped.cdkObject
    }
    ...
    public interface ComputeEnvironmentOrderProperty {
        ...
        public interface Builder {
             ...
             *   ascending order. For example, if two compute environments are associated with a job
             *   queue, the compute environment with a lower `order` integer value is tried for job
             *   placement first.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ComputeEnvironmentOrderProperty
            ): software.amazon.awscdk.services.batch.CfnJobQueue.ComputeEnvironmentOrderProperty =
