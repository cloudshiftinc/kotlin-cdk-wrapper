...
internal constructor(
    ...
    public override fun monitors(): List<Monitor> =
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.appconfig.Environment =
            cdkBuilder.build()
    }
    ...
    public companion object {
        public fun fromEnvironmentArn(
            ...
            software.amazon.awscdk.services.appconfig.Environment.fromEnvironmentArn(
        ...
        public fun fromEnvironmentAttributes(
            ...
            software.amazon.awscdk.services.appconfig.Environment.fromEnvironmentAttributes(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    attrs.let(EnvironmentAttributes::unwrap)
                )
                .let(IEnvironment::wrap)
        ...
        ): Environment = Environment(cdkObject)

        internal fun unwrap(
            wrapped: Environment
        ): software.amazon.awscdk.services.appconfig.Environment = wrapped.cdkObject
    }
}
