...
public interface IRepository : IResource, INotificationRuleSource {
    ...
    public fun onPullRequestStateChange(
        id: String,
     ...
     *
     * It is the recommended method for supporting connections made with federated access, identity
     * providers, and temporary credentials.
     *
    ...
    internal constructor(
        ...
        override fun bindAsNotificationRuleSource(scope: Construct): NotificationRuleSourceConfig =
            unwrap(this)
                .bindAsNotificationRuleSource(scope.let(Construct::unwrap))
        ...
        /**
         * Defines a CodeStar Notification rule triggered when the project events specified by you
         * are emitted. Similar to `onEvent` API.
         *
         * You can also use the methods to define rules for the specific event emitted. eg:
         * `notifyOnPullRequstCreated`.
         *
        ...
        override fun notifyOn(
            ...
            unwrap(this)
                .notifyOn(
                    ...
                    options.let(RepositoryNotifyOnOptions::unwrap)
                )
        ...
        override fun notifyOnApprovalRuleOverridden(
            ...
            unwrap(this)
                .notifyOnApprovalRuleOverridden(id, target.let(INotificationRuleTarget::unwrap))
                .let(INotificationRule::wrap)
        ...
        override fun notifyOnApprovalRuleOverridden(
            ...
            notifyOnApprovalRuleOverridden(id, target, NotificationRuleOptions(options))
        ...
        override fun notifyOnApprovalStatusChanged(
            ...
            unwrap(this)
                .notifyOnApprovalStatusChanged(id, target.let(INotificationRuleTarget::unwrap))
                .let(INotificationRule::wrap)
        ...
        override fun notifyOnApprovalStatusChanged(
            ...
            notifyOnApprovalStatusChanged(id, target, NotificationRuleOptions(options))
        ...
        override fun notifyOnBranchOrTagCreated(
            ...
            unwrap(this)
                .notifyOnBranchOrTagCreated(id, target.let(INotificationRuleTarget::unwrap))
                .let(INotificationRule::wrap)
        ...
        override fun notifyOnBranchOrTagCreated(
            ...
            notifyOnBranchOrTagCreated(id, target, NotificationRuleOptions(options))
        ...
        override fun notifyOnBranchOrTagDeleted(
            ...
            unwrap(this)
                .notifyOnBranchOrTagDeleted(id, target.let(INotificationRuleTarget::unwrap))
                .let(INotificationRule::wrap)
        ...
        override fun notifyOnBranchOrTagDeleted(
            ...
            notifyOnBranchOrTagDeleted(id, target, NotificationRuleOptions(options))

        /**
         * Defines a CodeStar Notification rule which triggers when a comment is made on a pull
         * request.
         *
         * @param id
         * @param target
        ...
        override fun notifyOnPullRequestComment(
            ...
            unwrap(this)
                .notifyOnPullRequestComment(id, target.let(INotificationRuleTarget::unwrap))
                .let(INotificationRule::wrap)
        ...
        override fun notifyOnPullRequestComment(
            ...
            notifyOnPullRequestComment(id, target, NotificationRuleOptions(options))
        ...
        override fun notifyOnPullRequestCreated(
            ...
            unwrap(this)
                .notifyOnPullRequestCreated(id, target.let(INotificationRuleTarget::unwrap))
                .let(INotificationRule::wrap)
        ...
        override fun notifyOnPullRequestCreated(
            ...
            notifyOnPullRequestCreated(id, target, NotificationRuleOptions(options))
        ...
        override fun notifyOnPullRequestMerged(
            ...
            unwrap(this)
                .notifyOnPullRequestMerged(id, target.let(INotificationRuleTarget::unwrap))
                .let(INotificationRule::wrap)
        ...
        override fun notifyOnPullRequestMerged(
            ...
            notifyOnPullRequestMerged(id, target, NotificationRuleOptions(options))
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("fc9299001d6ed4dfe2f794175df00b897aca5f16d690ddb09e74a2f5369f803c")
        override fun onCommentOnCommit(
            id: String,
            options: OnEventOptions.Builder.() -> Unit
        ...
        override fun onCommentOnPullRequest(id: String, options: OnEventOptions): Rule =
            unwrap(this)
                .onCommentOnPullRequest(id, options.let(OnEventOptions::unwrap))
                .let(Rule::wrap)
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("74f4fa682efa8ab5c54c3e71185b1250add0058b150599ebd7b3daec160e0812")
        override fun onCommentOnPullRequest(
            id: String,
            options: OnEventOptions.Builder.() -> Unit
         ...
         * @param options
         */
        override fun onCommit(id: String, options: OnCommitOptions): Rule =
        ...
        override fun onPullRequestStateChange(id: String, options: OnEventOptions): Rule =
            unwrap(this)
                .onPullRequestStateChange(id, options.let(OnEventOptions::unwrap))
                .let(Rule::wrap)
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("ccf05ddc1505b6c27a76cba26597bfadc25d79e62707184a50bdda0613bd142d")
        override fun onPullRequestStateChange(
            id: String,
            options: OnEventOptions.Builder.() -> Unit
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("11446a75b034ae186bc4e1eb7bb8a9dbf76f2500e19295e8f571f514f0358e4d")
        override fun onReferenceCreated(
            id: String,
            options: OnEventOptions.Builder.() -> Unit
        ): Rule = onReferenceCreated(id, OnEventOptions(options))

        /**
         * Defines a CloudWatch event rule which triggers when a reference is delete (i.e. a
         * branch/tag is deleted) from the repository.
         *
         * @param id
         * @param options
         */
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("2bdfd909fd78fa26f40663ddfd35633018a14d28fd8cbdc095b859b4269ae5a4")
        override fun onReferenceDeleted(
            id: String,
            options: OnEventOptions.Builder.() -> Unit
        ): Rule = onReferenceDeleted(id, OnEventOptions(options))

        /**
         * Defines a CloudWatch event rule which triggers when a reference is updated (i.e. a commit
         * is pushed to an existing or new branch) from the repository.
         *
         * @param id
         * @param options
         */
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("3bf0d0235cd8985a161fe5e339db14aa6ae7e6ece47ee4528b7360629bbabdab")
        override fun onReferenceUpdated(
            id: String,
            options: OnEventOptions.Builder.() -> Unit
        ): Rule = onReferenceUpdated(id, OnEventOptions(options))

        /**
         * Defines a CloudWatch event rule which triggers when a "CodeCommit Repository State
         * Change" event occurs.
         *
         * @param id
         * @param options
         */
        override fun onStateChange(id: String): Rule =
         ...
         * HTTPS (GRC) is the protocol to use with git-remote-codecommit (GRC).
         *
         * It is the recommended method for supporting connections made with federated access,
