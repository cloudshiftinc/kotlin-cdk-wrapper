...
public interface IRepository : IResource, INotificationRuleSource {
  ...
  private class Wrapper internal constructor(
    internal val cdkObject: software.amazon.awscdk.services.codecommit.IRepository,
  ) : IRepository {
    ...
    public override fun notifyOnApprovalRuleOverridden(arg0: String, arg1: INotificationRuleTarget):
    ...
    public override fun notifyOnApprovalStatusChanged(arg0: String, arg1: INotificationRuleTarget):
    ...
    public override fun notifyOnBranchOrTagCreated(arg0: String, arg1: INotificationRuleTarget):
    ...
    public override fun notifyOnBranchOrTagDeleted(arg0: String, arg1: INotificationRuleTarget):
    ...
    public override fun notifyOnPullRequestComment(arg0: String, arg1: INotificationRuleTarget):
    ...
    public override fun notifyOnPullRequestCreated(arg0: String, arg1: INotificationRuleTarget):
    ...
    public override fun notifyOnPullRequestMerged(arg0: String, arg1: INotificationRuleTarget):
    ...
    public override fun onCommentOnCommit(arg0: String): Rule =
        unwrap(this).onCommentOnCommit(arg0).let(Rule::wrap)

    public override fun onCommentOnCommit(arg0: String, arg1: OnEventOptions): Rule =
        unwrap(this).onCommentOnCommit(arg0, arg1.let(OnEventOptions::unwrap)).let(Rule::wrap)

    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("fc9299001d6ed4dfe2f794175df00b897aca5f16d690ddb09e74a2f5369f803c")
    public override fun onCommentOnCommit(arg0: String, arg1: OnEventOptions.Builder.() -> Unit):
        Rule = onCommentOnCommit(arg0, OnEventOptions(arg1))

    public override fun onCommentOnPullRequest(arg0: String): Rule =
        unwrap(this).onCommentOnPullRequest(arg0).let(Rule::wrap)

    public override fun onCommentOnPullRequest(arg0: String, arg1: OnEventOptions): Rule =
        unwrap(this).onCommentOnPullRequest(arg0, arg1.let(OnEventOptions::unwrap)).let(Rule::wrap)

    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("74f4fa682efa8ab5c54c3e71185b1250add0058b150599ebd7b3daec160e0812")
    public override fun onCommentOnPullRequest(arg0: String,
        arg1: OnEventOptions.Builder.() -> Unit): Rule = onCommentOnPullRequest(arg0,
        OnEventOptions(arg1))

    public override fun onCommit(arg0: String): Rule = unwrap(this).onCommit(arg0).let(Rule::wrap)

    public override fun onCommit(arg0: String, arg1: OnCommitOptions): Rule =
        unwrap(this).onCommit(arg0, arg1.let(OnCommitOptions::unwrap)).let(Rule::wrap)

    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("99e2a7e07608bfe036450f873080160e01bb6e158867249d838080fb9c326a6b")
    public override fun onCommit(arg0: String, arg1: OnCommitOptions.Builder.() -> Unit): Rule =
    ...
    public override fun onPullRequestStateChange(arg0: String): Rule =
        unwrap(this).onPullRequestStateChange(arg0).let(Rule::wrap)

    public override fun onPullRequestStateChange(arg0: String, arg1: OnEventOptions): Rule =
        unwrap(this).onPullRequestStateChange(arg0,
        arg1.let(OnEventOptions::unwrap)).let(Rule::wrap)

    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("ccf05ddc1505b6c27a76cba26597bfadc25d79e62707184a50bdda0613bd142d")
    public override fun onPullRequestStateChange(arg0: String,
        arg1: OnEventOptions.Builder.() -> Unit): Rule = onPullRequestStateChange(arg0,
        OnEventOptions(arg1))

    public override fun onReferenceCreated(arg0: String): Rule =
        unwrap(this).onReferenceCreated(arg0).let(Rule::wrap)

    public override fun onReferenceCreated(arg0: String, arg1: OnEventOptions): Rule =
        unwrap(this).onReferenceCreated(arg0, arg1.let(OnEventOptions::unwrap)).let(Rule::wrap)

    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("11446a75b034ae186bc4e1eb7bb8a9dbf76f2500e19295e8f571f514f0358e4d")
    public override fun onReferenceCreated(arg0: String, arg1: OnEventOptions.Builder.() -> Unit):
        Rule = onReferenceCreated(arg0, OnEventOptions(arg1))

    public override fun onReferenceDeleted(arg0: String): Rule =
        unwrap(this).onReferenceDeleted(arg0).let(Rule::wrap)

    public override fun onReferenceDeleted(arg0: String, arg1: OnEventOptions): Rule =
        unwrap(this).onReferenceDeleted(arg0, arg1.let(OnEventOptions::unwrap)).let(Rule::wrap)

    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("2bdfd909fd78fa26f40663ddfd35633018a14d28fd8cbdc095b859b4269ae5a4")
    public override fun onReferenceDeleted(arg0: String, arg1: OnEventOptions.Builder.() -> Unit):
        Rule = onReferenceDeleted(arg0, OnEventOptions(arg1))

    public override fun onReferenceUpdated(arg0: String): Rule =
        unwrap(this).onReferenceUpdated(arg0).let(Rule::wrap)

    public override fun onReferenceUpdated(arg0: String, arg1: OnEventOptions): Rule =
        unwrap(this).onReferenceUpdated(arg0, arg1.let(OnEventOptions::unwrap)).let(Rule::wrap)

    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("3bf0d0235cd8985a161fe5e339db14aa6ae7e6ece47ee4528b7360629bbabdab")
    public override fun onReferenceUpdated(arg0: String, arg1: OnEventOptions.Builder.() -> Unit):
        Rule = onReferenceUpdated(arg0, OnEventOptions(arg1))
  ...
  public companion object {
    ...
    internal fun unwrap(wrapped: IRepository):
        software.amazon.awscdk.services.codecommit.IRepository = (wrapped as Wrapper).cdkObject
  }
}
