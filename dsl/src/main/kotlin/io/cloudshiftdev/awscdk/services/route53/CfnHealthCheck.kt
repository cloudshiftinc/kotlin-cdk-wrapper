...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param healthCheckConfig A complex type that contains detailed information about one
         *   health check.
         */
        ...
        public fun healthCheckConfig(
            healthCheckConfig: HealthCheckConfigProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.route53.CfnHealthCheck =
            cdkBuilder.build()
    }
    ...
    public interface HealthCheckTagProperty {
        ...
        public interface Builder {
             ...
             *   53 console, the list of your health checks includes a *Name* column that lets you
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: HealthCheckTagProperty
            ): software.amazon.awscdk.services.route53.CfnHealthCheck.HealthCheckTagProperty =
    ...
    public interface AlarmIdentifierProperty {
        ...
        public interface Builder {
            /**
             * @param name The name of the CloudWatch alarm that you want Amazon Route 53 health
            ...
            /**
             * @param region For the CloudWatch alarm that you want Route 53 health checkers to use
             *   to determine whether this health check is healthy, the region that the alarm was
             *   created in. For the current list of CloudWatch regions, see
             *   [Amazon CloudWatch endpoints and quotas](https://docs.aws.amazon.com/general/latest/gr/cw_region.html)
             *   in the *Amazon Web Services General Reference* .
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AlarmIdentifierProperty
            ): software.amazon.awscdk.services.route53.CfnHealthCheck.AlarmIdentifierProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface HealthCheckConfigProperty {
         ...
         */
        public fun childHealthChecks(): List<String> =
            unwrap(this).getChildHealthChecks() ?: emptyList()
         ...
         * except TCP health checks. This is typically the fully qualified DNS name of the endpoint
         ...
         * `FullyQualifiedDomainName` at the interval that you specify for `RequestInterval` . Using
         * an IPv4 address that DNS returns, Route 53 then checks the health of the endpoint.
         *
         * If you don't specify a value for `IPAddress` , Route 53 uses only IPv4 to send health
         * checks to the endpoint. If there's no record with a type of A for the name that you
         * specify for `FullyQualifiedDomainName` , the health check fails with a "DNS resolution
         * failed" error.
         *
         * If you want to check the health of multiple records that have the same name and type,
         * such as multiple weighted records, and if you choose to specify the endpoint only by
         * `FullyQualifiedDomainName` , we recommend that you create a separate health check for
         ...
         * `FullyQualifiedDomainName` matches the name of the records and you then associate the
         * health check with those records, health check results will be unpredictable.
         *
         ...
         * status that you want Amazon Route 53 to assign to the health check: - `Healthy` : Route
         * 53 considers the health check to be healthy.
         ...
         * health checks on.
         *
         * If you don't specify a value for `IPAddress` , Route 53 sends a DNS request to resolve
         * the domain name that you specify in `FullyQualifiedDomainName` at the interval that you
         * specify in `RequestInterval` . Using an IP address returned by DNS, Route 53 then checks
         ...
         *   example, `2001:0db8:85a3:0000:0000:abcd:0001:2345` . You can also shorten IPv6
        ...
        public interface Builder {
            /**
             * @param alarmIdentifier A complex type that identifies the CloudWatch alarm that you
            ...
            /**
             * @param childHealthChecks (CALCULATED Health Checks Only) A complex type that contains
             *   one `ChildHealthCheck` element for each health check that you want to associate
            ...
            /**
             * @param failureThreshold The number of consecutive health checks that an endpoint must
             *   pass or fail for Amazon Route 53 to change the current status of the endpoint from
            ...
            /**
             * @param fullyQualifiedDomainName Amazon Route 53 behavior depends on whether you
             *   specify a value for `IPAddress` . *If you specify a value for* `IPAddress` :
             *
             * Amazon Route 53 sends health check requests to the specified IPv4 or IPv6 address and
             ...
             * If you don't specify a value for `IPAddress` , Route 53 uses only IPv4 to send health
             * checks to the endpoint. If there's no record with a type of A for the name that you
             * specify for `FullyQualifiedDomainName` , the health check fails with a "DNS
             * resolution failed" error.
             *
             * If you want to check the health of multiple records that have the same name and type,
             * such as multiple weighted records, and if you choose to specify the endpoint only by
             * `FullyQualifiedDomainName` , we recommend that you create a separate health check for
             * each endpoint. For example, create a health check for each HTTP server that is
             * serving content for www.example.com. For the value of `FullyQualifiedDomainName` ,
             * specify the domain name of the server (such as us-east-2-www.example.com), not the
             * name of the records (www.example.com).
             *
             * In this configuration, if you create a health check for which the value of
             * `FullyQualifiedDomainName` matches the name of the records and you then associate the
             * health check with those records, health check results will be unpredictable.
             ...
             *   `CALCULATED` health check that Amazon Route 53 must consider healthy for the
             *   `CALCULATED` health check to be considered healthy. To specify the child health
             *   checks that you want to associate with a `CALCULATED` health check, use the
             *   [ChildHealthChecks](https://docs.aws.amazon.com/Route53/latest/APIReference/API_UpdateHealthCheck.html#Route53-UpdateHealthCheck-request-ChildHealthChecks)
             *   element.
             *
             * Note the following:
            ...
            /**
             * @param insufficientDataHealthStatus When CloudWatch has insufficient data about the
             *   metric to determine the alarm state, the status that you want Amazon Route 53 to
             *   assign to the health check: - `Healthy` : Route 53 considers the health check to be
             *   healthy.
             * * `Unhealthy` : Route 53 considers the health check to be unhealthy.
             * * `LastKnownStatus` : Route 53 uses the status of the health check from the last time
             ...
             *   health check, for example, to consider a health check unhealthy when it otherwise
            ...
            /**
             * @param ipAddress The IPv4 or IPv6 IP address of the endpoint that you want Amazon
             *   Route 53 to perform health checks on. If you don't specify a value for `IPAddress`
             ...
             *   between health checkers in multiple AWS regions and your endpoint, and to display
             *   CloudWatch latency graphs on the *Health Checks* page in the Route 53 console.
             *
             * You can't change the value of `MeasureLatency` after you create a health check.
             */
            ...
            /**
             * @param regions A complex type that contains one `Region` element for each region from
             *   which you want Amazon Route 53 health checkers to check the specified endpoint. If
             *   you don't specify any regions, Route 53 health checkers automatically performs
             ...
             * checks, Route 53 will briefly continue to perform checks from that region to ensure
             * that some health checkers are always checking the endpoint (for example, if you
            ...
            /**
             * @param requestInterval The number of seconds between the time that Amazon Route 53
             *   gets a response from your endpoint and the time that it sends the next health check
             *   request. Each Route 53 health checker makes requests at this interval.
             *
             * You can't change the value of `RequestInterval` after you create a health check.
             *
             ...
             *   performing health checks. The path can be any value for which your endpoint will
             *   return an HTTP status code of 2xx or 3xx when the endpoint is healthy, for example,
             ...
             *   Recovery Controller routing control. For more information about Route 53
             *   Application Recovery Controller, see
             *   [Route 53 Application Recovery Controller Developer Guide.](https://docs.aws.amazon.com/r53recovery/latest/dg/what-is-route-53-recovery.html)
             *   .
             */
            ...
            /**
             * @param searchString If the value of Type is `HTTP_STR_MATCH` or `HTTPS_STR_MATCH` ,
             *   the string that you want Amazon Route 53 to search for in the response body from
             *   the specified resource. If the string appears in the response body, Route 53
            ...
            /**
             * @param type The type of health check that you want to create, which indicates how
             ...
             *   submits an HTTPS request and waits for an HTTP status code of 200 or greater and
             *   less than 400.
             *
             ...
             *   the state of the alarm is `OK` , the health check is considered healthy. If the
             *   state is `ALARM` , the health check is considered unhealthy. If CloudWatch doesn't
             *   have sufficient data to determine whether the state is `OK` or `ALARM` , the health
             ...
             *   to be healthy and compares that number with the value of `HealthThreshold` .
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("ac412132c89e73ae908b1ecb7239f3b46dc7142b3ec016100beea46011eddae9")
            override fun alarmIdentifier(
                alarmIdentifier: AlarmIdentifierProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-route53-healthcheck-healthcheckconfig.html#cfn-route53-healthcheck-healthcheckconfig-childhealthchecks)
             */
            override fun childHealthChecks(): List<String> =
                unwrap(this).getChildHealthChecks() ?: emptyList()
             ...
             * negotiation.
             *
             * This allows the endpoint to respond to `HTTPS` health check requests with the
             ...
             * health checks on.
             *
             * If you don't specify a value for `IPAddress` , Route 53 sends a DNS request to
             * resolve the domain name that you specify in `FullyQualifiedDomainName` at the
             ...
             * checkers in multiple AWS regions and your endpoint, and to display CloudWatch latency
             ...
             * checks.
             *
             * The path can be any value for which your endpoint will return an HTTP status code of
             * 2xx or 3xx when the endpoint is healthy, for example, the file
             * /docs/route53-health-check.html. You can also include query string parameters, for
             * example, `/welcome.html?language=jp&amp;login=y` .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-route53-healthcheck-healthcheckconfig.html#cfn-route53-healthcheck-healthcheckconfig-resourcepath)
             ...
             * want Amazon Route 53 to search for in the response body from the specified resource.
             *
             * If the string appears in the response body, Route 53 considers the resource healthy.
             *
             * Route 53 considers case when searching for `SearchString` in the response body.
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: HealthCheckConfigProperty
            ): software.amazon.awscdk.services.route53.CfnHealthCheck.HealthCheckConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
