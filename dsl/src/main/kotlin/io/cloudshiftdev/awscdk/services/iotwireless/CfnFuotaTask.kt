...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.iotwireless.CfnFuotaTask,
    ...
    public interface Builder {
         ...
         *
         * @param associateMulticastGroup The ID of the multicast group to associate with a FUOTA
         *   task.
         */
         ...
         *
         * @param associateWirelessDevice The ID of the wireless device to associate with a
         *   multicast group.
         */
         ...
         *
         * @param disassociateMulticastGroup The ID of the multicast group to disassociate from a
         *   FUOTA task.
         */
         ...
         *
         * @param firmwareUpdateImage The S3 URI points to a firmware update image that is to be
