...
internal constructor(
    ...
    public companion object {
        public fun fromVpnConnectionAttributes(
            ...
            software.amazon.awscdk.services.ec2.VpnConnection.fromVpnConnectionAttributes(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    attrs.let(VpnConnectionAttributes::unwrap)
                )
                .let(IVpnConnection::wrap)
        ...
        public fun metricAll(metricName: String, props: MetricOptions): Metric =
            software.amazon.awscdk.services.ec2.VpnConnection.metricAll(
                    metricName,
        ...
        public fun metricAllTunnelDataIn(): Metric =
            software.amazon.awscdk.services.ec2.VpnConnection.metricAllTunnelDataIn()
                .let(Metric::wrap)
        ...
        public fun metricAllTunnelDataOut(): Metric =
            software.amazon.awscdk.services.ec2.VpnConnection.metricAllTunnelDataOut()
                .let(Metric::wrap)
        ...
        public fun metricAllTunnelState(): Metric =
            software.amazon.awscdk.services.ec2.VpnConnection.metricAllTunnelState()
                .let(Metric::wrap)
        ...
        ): VpnConnection = VpnConnection(cdkObject)

        internal fun unwrap(
            wrapped: VpnConnection
        ): software.amazon.awscdk.services.ec2.VpnConnection = wrapped.cdkObject
    }
}
