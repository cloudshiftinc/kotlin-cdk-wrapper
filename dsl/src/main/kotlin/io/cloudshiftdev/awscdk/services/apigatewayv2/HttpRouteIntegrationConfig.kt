...
public interface HttpRouteIntegrationConfig {
    ...
    public interface Builder {
        ...
        /**
         * @param method The HTTP method that must be used to invoke the underlying proxy. Required
         *   for `HttpIntegrationType.HTTP_PROXY`
         */
        public fun method(method: HttpMethod)

        /**
         * @param parameterMapping Specifies how to transform HTTP requests before sending them to
         *   the backend.
         */
        public fun parameterMapping(parameterMapping: ParameterMapping)

        /**
         * @param payloadFormatVersion Payload format version in the case of lambda proxy
         *   integration.
         */
    ...
    internal constructor(
        ...
        /** Integration type. */
        override fun type(): HttpIntegrationType =
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: HttpRouteIntegrationConfig
        ): software.amazon.awscdk.services.apigatewayv2.HttpRouteIntegrationConfig =
