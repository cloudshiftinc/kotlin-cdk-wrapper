...
public abstract class LoadBalancer internal constructor(
  ...
  public companion object {
    public open fun application(albTargetGroup: IApplicationTargetGroup): LoadBalancer =
    ...
    public open fun network(nlbTargetGroup: INetworkTargetGroup): LoadBalancer =
