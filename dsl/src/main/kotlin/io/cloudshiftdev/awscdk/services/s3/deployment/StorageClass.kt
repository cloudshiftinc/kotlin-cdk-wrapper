...
public enum class StorageClass(
    ...
    public companion object {
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.s3.deployment.StorageClass
        ): StorageClass =
            when (cdkObject) {
                software.amazon.awscdk.services.s3.deployment.StorageClass.STANDARD ->
                ...
                software.amazon.awscdk.services.s3.deployment.StorageClass.GLACIER ->
