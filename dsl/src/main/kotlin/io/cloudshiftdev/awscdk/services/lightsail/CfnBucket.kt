...
internal constructor(
    ...
    public open fun readOnlyAccessAccounts(): List<String> =
        unwrap(this).getReadOnlyAccessAccounts() ?: emptyList()
    ...
    public interface Builder {
         ...
         *
         * @param readOnlyAccessAccounts An array of AWS account IDs that have read-only access to
         *   the bucket.
         */
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnBucket
        ): software.amazon.awscdk.services.lightsail.CfnBucket = wrapped.cdkObject
    }
    ...
    public interface AccessRulesProperty {
         ...
         * Amazon S3 API operation to set individual objects to public (read-only) or private, using
         * either the `public-read` ACL or the `private` ACL.
         *
         ...
         * * `public` - Sets all objects in the bucket to public (read-only), making them readable
         ...
         * set to `true` , then all objects in the bucket default to private unless they are
         * configured with a `public-read` ACL. Individual objects with a `public-read` ACL are
         * readable by everyone on the internet.
         *
        ...
        public interface Builder {
            /**
             * @param allowPublicOverrides A Boolean value indicating whether the access control
             *   list (ACL) permissions that are applied to individual objects override the
             *   `GetObject` option that is currently specified. When this is true, you can use the
             *   [PutObjectAcl](https://docs.aws.amazon.com/AmazonS3/latest/API/API_PutObjectAcl.html)
             *   Amazon S3 API operation to set individual objects to public (read-only) or private,
             *   using either the `public-read` ACL or the `private` ACL.
             */
            ...
            /**
             * @param objectAccess Specifies the anonymous access to all objects in a bucket. The
             ...
             * * `private` - Sets all objects in the bucket to private, making them readable only by
             *   you and anyone that you grant access to.
             *
             * If the `GetObject` value is set to `private` , and the `allowPublicOverrides` value
             * is set to `true` , then all objects in the bucket default to private unless they are
             * configured with a `public-read` ACL. Individual objects with a `public-read` ACL are
             * readable by everyone on the internet.
             */
