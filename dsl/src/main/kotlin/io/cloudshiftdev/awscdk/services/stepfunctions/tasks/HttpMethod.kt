...
public enum class HttpMethod(
    ...
    public companion object {
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.HttpMethod
        ): HttpMethod =
            when (cdkObject) {
                software.amazon.awscdk.services.stepfunctions.tasks.HttpMethod.GET -> HttpMethod.GET
                software.amazon.awscdk.services.stepfunctions.tasks.HttpMethod.POST ->
                    HttpMethod.POST
                software.amazon.awscdk.services.stepfunctions.tasks.HttpMethod.PUT -> HttpMethod.PUT
                software.amazon.awscdk.services.stepfunctions.tasks.HttpMethod.DELETE ->
                    HttpMethod.DELETE
                software.amazon.awscdk.services.stepfunctions.tasks.HttpMethod.PATCH ->
                    HttpMethod.PATCH
                software.amazon.awscdk.services.stepfunctions.tasks.HttpMethod.HEAD ->
                    HttpMethod.HEAD
                software.amazon.awscdk.services.stepfunctions.tasks.HttpMethod.OPTIONS ->
                    HttpMethod.OPTIONS
            }
