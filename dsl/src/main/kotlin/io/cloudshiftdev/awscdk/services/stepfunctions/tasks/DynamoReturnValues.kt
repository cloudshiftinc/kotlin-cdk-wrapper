...
public enum class DynamoReturnValues(
    ...
    public companion object {
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.DynamoReturnValues
        ): DynamoReturnValues =
            when (cdkObject) {
                ...
                software.amazon.awscdk.services.stepfunctions.tasks.DynamoReturnValues
                    .UPDATED_OLD -> DynamoReturnValues.UPDATED_OLD
                software.amazon.awscdk.services.stepfunctions.tasks.DynamoReturnValues.ALL_NEW ->
                    DynamoReturnValues.ALL_NEW
                software.amazon.awscdk.services.stepfunctions.tasks.DynamoReturnValues
                    .UPDATED_NEW -> DynamoReturnValues.UPDATED_NEW
            }

        internal fun unwrap(
            wrapped: DynamoReturnValues
        ): software.amazon.awscdk.services.stepfunctions.tasks.DynamoReturnValues =
            wrapped.cdkObject
    }
}
