...
public interface BaseApplicationListenerProps {
     ...
     * more complex configuration than that, use either `defaultAction` or `addAction()`.
     *
     ...
     * internal load balancers this is anyone in the same VPC. For public load balancers, this is
    ...
    public interface Builder {
        ...
        /**
         * @param defaultAction Default action to take for requests to this listener. This allows
         *   full control of the default action of the load balancer, including Action chaining,
         *   fixed responses and redirect responses.
         *
         * See the `ListenerAction` class for all options.
         *
         * Cannot be specified together with `defaultTargetGroups`.
        ...
        /**
         * @param defaultTargetGroups Default target groups to load balance to. All target groups
         *   will be load balanced to with equal weight and without stickiness. For a more complex
         ...
         *   load balancers this is anyone in the same VPC. For public load balancers, this is
         *   anyone on the internet.
         *
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: BaseApplicationListenerProps
        ): software.amazon.awscdk.services.elasticloadbalancingv2.BaseApplicationListenerProps =
