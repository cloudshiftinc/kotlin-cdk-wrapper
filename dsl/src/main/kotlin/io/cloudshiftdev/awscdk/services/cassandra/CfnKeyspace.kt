...
internal constructor(
    ...
    public open fun replicationSpecification(`value`: ReplicationSpecificationProperty) {
        unwrap(this)
            .setReplicationSpecification(`value`.let(ReplicationSpecificationProperty::unwrap))
    }
    ...
    public open fun replicationSpecification(
        `value`: ReplicationSpecificationProperty.Builder.() -> Unit
    ...
    public interface Builder {
         ...
         * `MULTI_REGION` , you must also provide a `RegionList` with the AWS Regions that the
        ...
        public fun replicationSpecification(
            replicationSpecification: ReplicationSpecificationProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
         ...
         *   options are:.
         */
        override fun replicationSpecification(
            replicationSpecification: ReplicationSpecificationProperty
        ) {
            cdkBuilder.replicationSpecification(
                replicationSpecification.let(ReplicationSpecificationProperty::unwrap)
            )
        }
        ...
        override fun replicationSpecification(
            ...
            replicationSpecification(ReplicationSpecificationProperty(replicationSpecification))
        ...
        public fun build(): software.amazon.awscdk.services.cassandra.CfnKeyspace =
            cdkBuilder.build()
    }
    ...
    public companion object {
        ...
        ): CfnKeyspace = CfnKeyspace(cdkObject)

        internal fun unwrap(
            wrapped: CfnKeyspace
        ): software.amazon.awscdk.services.cassandra.CfnKeyspace = wrapped.cdkObject
    }
    ...
    public interface ReplicationSpecificationProperty {
         ...
         *
         * You must specify at least two and up to six Regions, including the Region that the
         * keyspace is being created in.
         *
         ...
         * * `MULTI_REGION`
         *
         * If no value is specified, the default is `SINGLE_REGION` . If `MULTI_REGION` is
         * specified, `RegionList` is required.
         *
        ...
        public interface Builder {
            /**
             * @param regionList Specifies the AWS Regions that the keyspace is replicated in. You
             *   must specify at least two and up to six Regions, including the Region that the
             *   keyspace is being created in.
             */
        ...
        private class BuilderImpl : Builder {
            private val cdkBuilder:
                ...
                software.amazon.awscdk.services.cassandra.CfnKeyspace
             ...
             *   keyspace is being created in.
             */
            override fun regionList(vararg regionList: String): Unit =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ReplicationSpecificationProperty
            ): software.amazon.awscdk.services.cassandra.CfnKeyspace.ReplicationSpecificationProperty =
