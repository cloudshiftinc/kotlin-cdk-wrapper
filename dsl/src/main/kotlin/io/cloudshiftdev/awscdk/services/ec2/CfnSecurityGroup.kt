...
internal constructor(
    ...
    public interface Builder {
         ...
         * The ID of the VPC for the security group.
         *
         * If you do not specify a VPC, the default is to use the default VPC for the Region. If
         * there's no specified VPC and no default VPC, security group creation fails.
         *
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.ec2.CfnSecurityGroup =
            cdkBuilder.build()
    }
    ...
    public interface IngressProperty {
         ...
         *
         * You must specify a source security group ( `SourcePrefixListId` or
         ...
         * must specify a port range. For `icmpv6` , the port range is optional; if you omit the
         * port range, traffic for all types and codes is allowed.
         *
         ...
         *
         * You must specify either the security group ID or the security group name. You can't
         * specify the group name in combination with an IP address range. Creates rules that grant
         * full ICMP, UDP, and TCP access.
         *
         ...
         * group is owned by a different account than the account creating the stack, you must
         * specify the `SourceSecurityGroupOwnerId` ; otherwise, this property is optional.
         *
         ...
         */
        public fun sourceSecurityGroupOwnerId(): String? =
        ...
        public interface Builder {
            /**
             * @param cidrIp The IPv4 address range, in CIDR format. You must specify a source
             *   security group ( `SourcePrefixListId` or `SourceSecurityGroupId` ) or a CIDR range
             *   ( `CidrIp` or `CidrIpv6` ).
             *
            ...
            /**
             * @param cidrIpv6 The IPv6 address range, in CIDR format. You must specify a source
             *   security group ( `SourcePrefixListId` or `SourceSecurityGroupId` ) or a CIDR range
             *   ( `CidrIp` or `CidrIpv6` ).
             *
             * For examples of rules that you can add to security groups for specific access
            ...
            /**
             * @param description Updates the description of an ingress (inbound) security group
             *   rule. You can replace an existing description, or add a description to a rule that
            ...
            /**
             * @param ipProtocol The IP protocol name ( `tcp` , `udp` , `icmp` , `icmpv6` ) or
             *   number (see
             *   [Protocol Numbers](https://docs.aws.amazon.com/http://www.iana.org/assignments/protocol-numbers/protocol-numbers.xhtml)
             ...
             *   `tcp` , `udp` , and `icmp` , you must specify a port range. For `icmpv6` , the port
             *   range is optional; if you omit the port range, traffic for all types and codes is
             *   allowed.
             */
             ...
             *   You must specify either the security group ID or the security group name. You can't
             *   specify the group name in combination with an IP address range. Creates rules that
             *   grant full ICMP, UDP, and TCP access.
             *
             * For security groups in a nondefault VPC, you must specify the group ID.
             */
             ...
             *   security group, if the source security group is in a different account. You can't
             *   specify this property with an IP address range. Creates rules that grant full ICMP,
             *   UDP, and TCP access.
             *
             * If you specify `SourceSecurityGroupName` or `SourceSecurityGroupId` and that security
             * group is owned by a different account than the account creating the stack, you must
             ...
             *   the protocol is ICMP or ICMPv6, this is the ICMP code or -1 (all ICMP codes). If
        ...
        internal constructor(
             ...
             * `-1` or a protocol number other than `tcp` , `udp` , `icmp` , or `icmpv6` allows
             * traffic on all ports, regardless of any port range you specify. For `tcp` , `udp` ,
             * and `icmp` , you must specify a port range. For `icmpv6` , the port range is
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ec2-securitygroup-ingress.html#cfn-ec2-securitygroup-ingress-sourcesecuritygroupname)
             */
            override fun sourceSecurityGroupName(): String? =
             ...
             *
             * You can't specify this property with an IP address range. Creates rules that grant
             * full ICMP, UDP, and TCP access.
             *
             * If you specify `SourceSecurityGroupName` or `SourceSecurityGroupId` and that security
             * group is owned by a different account than the account creating the stack, you must
             ...
             * the start port is -1 (all ICMP types), then the end port must be -1 (all ICMP codes).
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ec2-securitygroup-ingress.html#cfn-ec2-securitygroup-ingress-toport)
             */
    ...
    public interface EgressProperty {
         ...
         */
        public fun destinationSecurityGroupId(): String? =
        ...
        public interface Builder {
            /**
             * @param cidrIp The IPv4 address range, in CIDR format. You must specify a destination
             *   security group ( `DestinationPrefixListId` or `DestinationSecurityGroupId` ) or a
            ...
            /**
             * @param cidrIpv6 The IPv6 address range, in CIDR format. You must specify a
             *   destination security group ( `DestinationPrefixListId` or
             *   `DestinationSecurityGroupId` ) or a CIDR range ( `CidrIp` or `CidrIpv6` ).
             *
             * For examples of rules that you can add to security groups for specific access
             * scenarios, see
            ...
            /**
             * @param destinationSecurityGroupId The ID of the destination VPC security group. You
             *   must specify a destination security group ( `DestinationPrefixListId` or
             *   `DestinationSecurityGroupId` ) or a CIDR range ( `CidrIp` or `CidrIpv6` ).
             */
