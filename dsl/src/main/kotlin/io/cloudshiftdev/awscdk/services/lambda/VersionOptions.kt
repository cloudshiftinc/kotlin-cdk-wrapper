...
public interface VersionOptions : EventInvokeConfigOptions {
    ...
    public interface Builder {
        /**
         * @param codeSha256 SHA256 of the version of the Lambda source code. Specify to validate
         *   that you're deploying the right version.
         */
    ...
    private class BuilderImpl : Builder {
        ...
        public fun build(): software.amazon.awscdk.services.lambda.VersionOptions =
            cdkBuilder.build()
    }
