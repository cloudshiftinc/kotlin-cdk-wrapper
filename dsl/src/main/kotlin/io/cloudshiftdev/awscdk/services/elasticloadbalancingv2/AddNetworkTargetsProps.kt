...
public interface AddNetworkTargetsProps {
    ...
    public interface Builder {
         ...
         *   or any self-registering load balancing target. If you use either `Instance` or
         *   `IPAddress` as targets, all target must be of the same type.
         */
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: AddNetworkTargetsProps
        ): software.amazon.awscdk.services.elasticloadbalancingv2.AddNetworkTargetsProps =
