...
public interface ScratchSpace {
    ...
    public interface Builder {
        ...
        /**
         * @param name The name of the scratch volume to mount. Must be a volume name referenced in
         ...
         *   volume. If this value is true, the container has read-only access to the scratch
         *   volume. If this value is false, then the container can write to the scratch volume.
         */
    ...
    public companion object {
        ...
        ): ScratchSpace = Wrapper(cdkObject)

        internal fun unwrap(
            wrapped: ScratchSpace
        ): software.amazon.awscdk.services.ecs.ScratchSpace = (wrapped as Wrapper).cdkObject
    }
}
