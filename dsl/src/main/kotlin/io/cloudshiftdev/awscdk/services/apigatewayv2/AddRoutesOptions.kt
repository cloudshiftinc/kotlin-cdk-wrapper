...
public interface AddRoutesOptions : BatchHttpRouteOptions {
     ...
     *
     * These scopes will override the default authorization scopes on the gateway. Set to [] to
     ...
     */
    public fun methods(): List<HttpMethod> =
    ...
    public interface Builder {
         ...
         *   scopes will override the default authorization scopes on the gateway. Set to [] to
         *   remove default scopes
         */
        ...
        /**
         * @param authorizer Authorizer to be associated to these routes. Use NoneAuthorizer to
         *   remove the default authorizer for the api
         */
    ...
    public companion object {
        ...
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.apigatewayv2.AddRoutesOptions
        ): AddRoutesOptions = Wrapper(cdkObject)

        internal fun unwrap(
            wrapped: AddRoutesOptions
