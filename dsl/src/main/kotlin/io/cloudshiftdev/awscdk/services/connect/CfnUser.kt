...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param directoryUserId The identifier of the user account in the directory used for
         *   identity management.
         */
        ...
        /**
         * One or more predefined attributes assigned to a user, with a numeric value that indicates
         * how their level of skill in a specified area.
         *
         ...
         *
         * @param userProficiencies One or more predefined attributes assigned to a user, with a
         *   numeric value that indicates how their level of skill in a specified area.
         */
    ...
    public interface UserIdentityInfoProperty {
        ...
        public interface Builder {
            /**
             * @param email The email address. If you are using SAML for identity management and
             *   include this parameter, an error is returned.
             */
            public fun email(email: String)

            /**
             * @param firstName The first name. This is required if you are using Amazon Connect or
             *   SAML for identity management.
             */
            public fun firstName(firstName: String)

            /**
             * @param lastName The last name. This is required if you are using Amazon Connect or
             *   SAML for identity management.
             */
            ...
            /**
             * @param secondaryEmail The user's secondary email address. If you provide a secondary
             *   email, the user receives email notifications -- other than password reset
             *   notifications -- to this email address instead of to their primary email address.
             *
             * *Pattern* : `(?=^.{0,265}$)[a-zA-Z0-9._%+-]+&#64;[a-zA-Z0-9.-]+\.[a-zA-Z]{2,63}`
             */
        ...
        internal constructor(
             ...
             *
             * If you provide a secondary email, the user receives email notifications -- other than
             * password reset notifications -- to this email address instead of to their primary
             * email address.
             *
             * *Pattern* : `(?=^.{0,265}$)[a-zA-Z0-9._%+-]+&#64;[a-zA-Z0-9.-]+\.[a-zA-Z]{2,63}`
             *
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: UserIdentityInfoProperty
            ): software.amazon.awscdk.services.connect.CfnUser.UserIdentityInfoProperty =
    ...
    public interface UserProficiencyProperty {
        ...
        public interface Builder {
            /**
             * @param attributeName The name of user’s proficiency. You must use a predefined
             *   attribute name that is present in the Amazon Connect instance.
             */
            public fun attributeName(attributeName: String)

            /**
             * @param attributeValue The value of user’s proficiency. You must use a predefined
             *   attribute value that is present in the Amazon Connect instance.
             */
        ...
        internal constructor(
             ...
             * The name of user’s proficiency.
             *
             * You must use a predefined attribute name that is present in the Amazon Connect
             * instance.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-connect-user-userproficiency.html#cfn-connect-user-userproficiency-attributename)
             */
             ...
             * The value of user’s proficiency.
             *
             * You must use a predefined attribute value that is present in the Amazon Connect
             * instance.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-connect-user-userproficiency.html#cfn-connect-user-userproficiency-attributevalue)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: UserProficiencyProperty
            ): software.amazon.awscdk.services.connect.CfnUser.UserProficiencyProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface UserPhoneConfigProperty {
         ...
         *
         * This parameter has a minimum value of 0 and a maximum value of 2,000,000 seconds (24
         * days). Enter 0 if you don't want to allocate a specific amount of ACW time. It
         * essentially means an indefinite amount of time. When the conversation ends, ACW starts;
         ...
         */
        public fun afterContactWorkTimeLimit(): Number? =
        ...
        public interface Builder {
             ...
             *   seconds. This parameter has a minimum value of 0 and a maximum value of 2,000,000
             *   seconds (24 days). Enter 0 if you don't want to allocate a specific amount of ACW
             *   time. It essentially means an indefinite amount of time. When the conversation
        ...
        internal constructor(
             ...
             * This parameter has a minimum value of 0 and a maximum value of 2,000,000 seconds (24
             * days). Enter 0 if you don't want to allocate a specific amount of ACW time. It
             * essentially means an indefinite amount of time. When the conversation ends, ACW
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: UserPhoneConfigProperty
            ): software.amazon.awscdk.services.connect.CfnUser.UserPhoneConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
