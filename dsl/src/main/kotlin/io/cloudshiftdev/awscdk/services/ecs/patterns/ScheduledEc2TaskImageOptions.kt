...
public interface ScheduledEc2TaskImageOptions : ScheduledTaskImageProps {
    ...
    public interface Builder {
        ...
        /**
         * @param image The image used to start a container. Image or taskDefinition must be
        ...
        /**
         * @param memoryLimitMiB The hard limit (in MiB) of memory to present to the container. If
         *   your container attempts to exceed the allocated memory, the container is terminated.
         *
         ...
         *   container. When system memory is under contention, Docker attempts to keep the
         *   container memory within the limit. If the container requires more memory, it can
         *   consume up to the value specified by the Memory property or all of the available memory
         *   on the container instance—whichever comes first.
         *
         * At least one of memoryLimitMiB and memoryReservationMiB is required for non-Fargate
         * services.
         */
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: ScheduledEc2TaskImageOptions
        ): software.amazon.awscdk.services.ecs.patterns.ScheduledEc2TaskImageOptions =
