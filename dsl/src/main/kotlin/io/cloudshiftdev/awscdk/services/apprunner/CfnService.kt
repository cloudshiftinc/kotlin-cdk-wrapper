...
internal constructor(
     ...
     *   counts towards your service quota. To troubleshoot this failure, read the failure events
     *   and logs, change any parameters that need to be fixed, and rebuild your service using
     *   `UpdateService` .
    ...
    public open fun encryptionConfiguration(`value`: EncryptionConfigurationProperty) {
        unwrap(this)
            .setEncryptionConfiguration(`value`.let(EncryptionConfigurationProperty::unwrap))
    }
    ...
    public open fun encryptionConfiguration(
        `value`: EncryptionConfigurationProperty.Builder.() -> Unit
    ): Unit = encryptionConfiguration(EncryptionConfigurationProperty(`value`))
    ...
    public open fun healthCheckConfiguration(`value`: HealthCheckConfigurationProperty) {
        unwrap(this)
            .setHealthCheckConfiguration(`value`.let(HealthCheckConfigurationProperty::unwrap))
    }
    ...
    public open fun healthCheckConfiguration(
        `value`: HealthCheckConfigurationProperty.Builder.() -> Unit
    ...
    public open fun instanceConfiguration(
        `value`: InstanceConfigurationProperty.Builder.() -> Unit
    ...
    public open fun observabilityConfiguration(): Any? =
        unwrap(this).getObservabilityConfiguration()
    ...
    public open fun observabilityConfiguration(`value`: ServiceObservabilityConfigurationProperty) {
        unwrap(this)
            .setObservabilityConfiguration(
                `value`.let(ServiceObservabilityConfigurationProperty::unwrap)
            )
    }
    ...
    public open fun observabilityConfiguration(
        `value`: ServiceObservabilityConfigurationProperty.Builder.() -> Unit
    ...
    public open fun sourceConfiguration(
        `value`: SourceConfigurationProperty.Builder.() -> Unit
    ): Unit = sourceConfiguration(SourceConfigurationProperty(`value`))
    ...
    public interface Builder {
         ...
         *
         * @param autoScalingConfigurationArn The Amazon Resource Name (ARN) of an App Runner
        ...
        /**
         * The settings for the health check that AWS App Runner performs to monitor the health of
        ...
        public fun healthCheckConfiguration(
            healthCheckConfiguration: HealthCheckConfigurationProperty.Builder.() -> Unit
        )
         ...
         *
         * @param instanceConfiguration The runtime configuration of instances (scaling units) of
         *   your service.
         */
        ...
        public fun instanceConfiguration(
            instanceConfiguration: InstanceConfigurationProperty.Builder.() -> Unit
        )
        ...
        public fun observabilityConfiguration(
            observabilityConfiguration: ServiceObservabilityConfigurationProperty.Builder.() -> Unit
        )

        /**
         * A name for the App Runner service.
         *
         * It must be unique across all the running App Runner services in your AWS account in the
         * AWS Region .
         *
        ...
        public fun sourceConfiguration(
            sourceConfiguration: SourceConfigurationProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
         ...
         *   performs to monitor the health of the App Runner service.
         */
        override fun healthCheckConfiguration(
            healthCheckConfiguration: HealthCheckConfigurationProperty
        ) {
            cdkBuilder.healthCheckConfiguration(
                healthCheckConfiguration.let(HealthCheckConfigurationProperty::unwrap)
            )
        }
        ...
        override fun healthCheckConfiguration(
            ...
            healthCheckConfiguration(HealthCheckConfigurationProperty(healthCheckConfiguration))
        ...
        override fun instanceConfiguration(instanceConfiguration: InstanceConfigurationProperty) {
            cdkBuilder.instanceConfiguration(
                instanceConfiguration.let(InstanceConfigurationProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("c1abd6f08e7082f3902aa808d8829de5df2cbb8d39e8d0fcbeb1fb526632ca27")
        override fun instanceConfiguration(
            instanceConfiguration: InstanceConfigurationProperty.Builder.() -> Unit
        ...
        override fun observabilityConfiguration(observabilityConfiguration: IResolvable) {
            cdkBuilder.observabilityConfiguration(
                observabilityConfiguration.let(IResolvable::unwrap)
            )
        }
         ...
         * @param observabilityConfiguration The observability configuration of your service.
         */
        override fun observabilityConfiguration(
            observabilityConfiguration: ServiceObservabilityConfigurationProperty
        ) {
            cdkBuilder.observabilityConfiguration(
                observabilityConfiguration.let(ServiceObservabilityConfigurationProperty::unwrap)
            )
        }
        ...
        override fun observabilityConfiguration(
            ...
            observabilityConfiguration(
                ServiceObservabilityConfigurationProperty(observabilityConfiguration)
            )
        ...
        override fun sourceConfiguration(sourceConfiguration: SourceConfigurationProperty) {
            cdkBuilder.sourceConfiguration(
                sourceConfiguration.let(SourceConfigurationProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("dc962744b16adfa22376e3d1bfc9d1527c09ca3bb1e4fd7a7e3a8fb839ee24ec")
        override fun sourceConfiguration(
            sourceConfiguration: SourceConfigurationProperty.Builder.() -> Unit
        ...
        public fun build(): software.amazon.awscdk.services.apprunner.CfnService =
            cdkBuilder.build()
    }
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnService
        ): software.amazon.awscdk.services.apprunner.CfnService = wrapped.cdkObject
    }
    ...
    public interface EgressConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param egressType The type of egress configuration. Set to `DEFAULT` for access to
             *   resources hosted on public networks.
             *
             * Set to `VPC` to associate your service to a custom VPC specified by `VpcConnectorArn`
             * .
             */
            ...
            /**
             * @param vpcConnectorArn The Amazon Resource Name (ARN) of the App Runner VPC connector
             *   that you want to associate with your App Runner service. Only valid when
             *   `EgressType = VPC` .
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: EgressConfigurationProperty
            ): software.amazon.awscdk.services.apprunner.CfnService.EgressConfigurationProperty =
    ...
    public interface CodeRepositoryProperty {
         ...
         *
         * The build and start commands also execute from here. The path is absolute from root and,
         * if not specified, defaults to the repository root.
         *
        ...
        public interface Builder {
            /**
             * @param codeConfiguration Configuration for building and running the service from a
            ...
            public fun codeConfiguration(
                codeConfiguration: CodeConfigurationProperty.Builder.() -> Unit
            )
            ...
            /**
             * @param sourceCodeVersion The version that should be used within the source code
             *   repository.
             */
            ...
            public fun sourceCodeVersion(
                sourceCodeVersion: SourceCodeVersionProperty.Builder.() -> Unit
            )

            /**
             * @param sourceDirectory The path of the directory that stores source code and
             *   configuration files. The build and start commands also execute from here. The path
             *   is absolute from root and, if not specified, defaults to the repository root.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            override fun codeConfiguration(codeConfiguration: CodeConfigurationProperty) {
                cdkBuilder.codeConfiguration(
                    codeConfiguration.let(CodeConfigurationProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("0c960440565fa14856e944f7527e19099e496dfbf425fca9c114aee146a28bb8")
            override fun codeConfiguration(
                codeConfiguration: CodeConfigurationProperty.Builder.() -> Unit
            ...
            override fun sourceCodeVersion(sourceCodeVersion: SourceCodeVersionProperty) {
                cdkBuilder.sourceCodeVersion(
                    sourceCodeVersion.let(SourceCodeVersionProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("a11280fe561d2ce9c9bc534329afd076e0d9e81b43d363d4234a98a691185152")
            override fun sourceCodeVersion(
                sourceCodeVersion: SourceCodeVersionProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * The path of the directory that stores source code and configuration files.
             *
             * The build and start commands also execute from here. The path is absolute from root
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CodeRepositoryProperty
            ): software.amazon.awscdk.services.apprunner.CfnService.CodeRepositoryProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CodeConfigurationProperty {
         ...
         *
         * Use it to quickly launch an App Runner service without providing a `apprunner.yaml` file
        ...
        public interface Builder {
            /**
             * @param codeConfigurationValues The basic configuration for building and running the
             *   App Runner service. Use it to quickly launch an App Runner service without
             *   providing a `apprunner.yaml` file in the source code repository (or ignoring the
             *   file if it exists).
             */
            ...
            public fun codeConfigurationValues(
                codeConfigurationValues: CodeConfigurationValuesProperty.Builder.() -> Unit
            )
        ...
        private class BuilderImpl : Builder {
             ...
             *   file if it exists).
             */
            override fun codeConfigurationValues(
                codeConfigurationValues: CodeConfigurationValuesProperty
            ) {
                cdkBuilder.codeConfigurationValues(
                    codeConfigurationValues.let(CodeConfigurationValuesProperty::unwrap)
                )
            }
            ...
            override fun codeConfigurationValues(
                ...
                codeConfigurationValues(CodeConfigurationValuesProperty(codeConfigurationValues))
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CodeConfigurationProperty
            ): software.amazon.awscdk.services.apprunner.CfnService.CodeConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface NetworkConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param egressConfiguration Network configuration settings for outbound message
             *   traffic.
             */
            ...
            public fun egressConfiguration(
                egressConfiguration: EgressConfigurationProperty.Builder.() -> Unit
            )

            /**
             * @param ingressConfiguration Network configuration settings for inbound message
             *   traffic.
             */
            ...
            public fun ingressConfiguration(
                ingressConfiguration: IngressConfigurationProperty.Builder.() -> Unit
            )

            /**
             * @param ipAddressType App Runner provides you with the option to choose between
             *   *Internet Protocol version 4 (IPv4)* and *dual stack* (IPv4 and IPv6) for your
             *   incoming public network configuration. This is an optional parameter. If you do not
             *   specify an `IpAddressType` , it defaults to select IPv4.
             *
             * Currently, App Runner supports dual stack for only Public endpoint. Only IPv4 is
             * supported for Private endpoint. If you update a service that's using dual-stack
             * Public endpoint to a Private endpoint, your App Runner service will default to
             * support only IPv4 for Private endpoint and fail to receive traffic originating from
             * IPv6 endpoint.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            override fun egressConfiguration(egressConfiguration: EgressConfigurationProperty) {
                cdkBuilder.egressConfiguration(
                    egressConfiguration.let(EgressConfigurationProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("fbc4db8dd90c63a25c3388567ce4c7f7f89dba05a84fd00996bc034934570ca8")
            override fun egressConfiguration(
                egressConfiguration: EgressConfigurationProperty.Builder.() -> Unit
            ...
            override fun ingressConfiguration(ingressConfiguration: IngressConfigurationProperty) {
                cdkBuilder.ingressConfiguration(
                    ingressConfiguration.let(IngressConfigurationProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("bc0e7a6417da092d1c97a93c9b80849c6d1cf9ba836ca868306454679bdf4fb3")
            override fun ingressConfiguration(
                ingressConfiguration: IngressConfigurationProperty.Builder.() -> Unit
        ...
        internal constructor(
            ...
            /**
             * App Runner provides you with the option to choose between *Internet Protocol version
             * 4 (IPv4)* and *dual stack* (IPv4 and IPv6) for your incoming public network
             * configuration.
             *
             * This is an optional parameter. If you do not specify an `IpAddressType` , it defaults
             * to select IPv4.
             *
             * Currently, App Runner supports dual stack for only Public endpoint. Only IPv4 is
             * supported for Private endpoint. If you update a service that's using dual-stack
    ...
    public interface ServiceObservabilityConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param observabilityConfigurationArn The Amazon Resource Name (ARN) of the
             *   observability configuration that is associated with the service. Specified only
        ...
        internal constructor(
             ...
             * and an `ObservabilityConfigurationArn` is specified.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-apprunner-service-serviceobservabilityconfiguration.html#cfn-apprunner-service-serviceobservabilityconfiguration-observabilityenabled)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ServiceObservabilityConfigurationProperty
            ): software.amazon.awscdk.services.apprunner.CfnService.ServiceObservabilityConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ImageConfigurationProperty {
         ...
         * to your service as an environment variable.
         *
         ...
         * Store.
         * * If the AWS Systems Manager Parameter Store parameter exists in the same AWS Region as
         *   the service that you're launching, you can use either the full ARN or name of the
         *   secret. If the parameter exists in a different Region, then the full ARN must be
         *   specified.
         * * Currently, cross account referencing of AWS Systems Manager Parameter Store parameter
         *   is not supported.
         *
         ...
         */
        public fun runtimeEnvironmentVariables(): Any? =
        ...
        public interface Builder {
            /**
             * @param port The port that your application listens to in the container. Default:
             *   `8080`
             */
            public fun port(port: String)

            /**
             * @param runtimeEnvironmentSecrets An array of key-value pairs representing the secrets
             *   and parameters that get referenced to your service as an environment variable. The
             *   supported values are either the full Amazon Resource Name (ARN) of the AWS Secrets
             *   Manager secret or the full ARN of the parameter in the AWS Systems Manager
             *   Parameter Store.
             * * If the AWS Systems Manager Parameter Store parameter exists in the same AWS Region
             *   as the service that you're launching, you can use either the full ARN or name of
             *   the secret. If the parameter exists in a different Region, then the full ARN must
             *   be specified.
             * * Currently, cross account referencing of AWS Systems Manager Parameter Store
            ...
            /**
             * @param runtimeEnvironmentVariables Environment variables that are available to your
             *   running App Runner service. An array of key-value pairs.
             */
            ...
            /**
             * @param startCommand An optional command that App Runner runs to start the application
             *   in the source image. If specified, this command overrides the Docker image’s
        ...
        private class BuilderImpl : Builder {
            ...
            override fun runtimeEnvironmentSecrets(runtimeEnvironmentSecrets: IResolvable) {
                cdkBuilder.runtimeEnvironmentSecrets(
                    runtimeEnvironmentSecrets.let(IResolvable::unwrap)
                )
            }
            ...
            override fun runtimeEnvironmentVariables(runtimeEnvironmentVariables: IResolvable) {
                cdkBuilder.runtimeEnvironmentVariables(
                    runtimeEnvironmentVariables.let(IResolvable::unwrap)
                )
            }
             ...
             *   running App Runner service. An array of key-value pairs.
             */
            override fun runtimeEnvironmentVariables(
                vararg runtimeEnvironmentVariables: Any
            ): Unit = runtimeEnvironmentVariables(runtimeEnvironmentVariables.toList())
        ...
        internal constructor(
             ...
             * referenced to your service as an environment variable.
             *
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-apprunner-service-imageconfiguration.html#cfn-apprunner-service-imageconfiguration-runtimeenvironmentsecrets)
             */
            override fun runtimeEnvironmentSecrets(): Any? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ImageConfigurationProperty
            ): software.amazon.awscdk.services.apprunner.CfnService.ImageConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface AuthenticationConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param accessRoleArn The Amazon Resource Name (ARN) of the IAM role that grants the
             *   App Runner service access to a source repository. It's required for ECR image
             ...
             *   enables the App Runner service to connect to a source repository. It's required for
        ...
        internal constructor(
             ...
             * Runner service to connect to a source repository.
             *
             * It's required for GitHub code repositories.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-apprunner-service-authenticationconfiguration.html#cfn-apprunner-service-authenticationconfiguration-connectionarn)
    ...
    public interface CodeConfigurationValuesProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param runtime A runtime environment type for building and running an App Runner
            ...
            /**
             * @param runtimeEnvironmentVariables The environment variables that are available to
             *   your running AWS App Runner service. An array of key-value pairs.
             */
            public fun runtimeEnvironmentVariables(runtimeEnvironmentVariables: IResolvable)
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CodeConfigurationValuesProperty
            ): software.amazon.awscdk.services.apprunner.CfnService.CodeConfigurationValuesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface HealthCheckConfigurationProperty {
        ...
        public interface Builder {
             ...
             *   Runner decides that the service is healthy. Default: `1`
             */
            ...
            /**
             * @param path The URL that health check requests are sent to. `Path` is only applicable
             *   when you set `Protocol` to `HTTP` .
             *
             * Default: `"/"`
             */
            ...
            /**
             * @param protocol The IP protocol that App Runner uses to perform health checks for
             *   your service. If you set `Protocol` to `HTTP` , App Runner sends health check
            ...
            /**
             * @param timeout The time, in seconds, to wait for a health check response before
             *   deciding it failed. Default: `2`
             */
            public fun timeout(timeout: Number)

            /**
             * @param unhealthyThreshold The number of consecutive checks that must fail before App
             *   Runner decides that the service is unhealthy. Default: `5`
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: HealthCheckConfigurationProperty
            ): software.amazon.awscdk.services.apprunner.CfnService.HealthCheckConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SourceCodeVersionProperty {
        ...
        public interface Builder {
            /**
             * @param type The type of version identifier. For a git-based repository, branches
             *   represent versions.
             */
            public fun type(type: String)

            /**
             * @param value A source code version. For a git-based repository, a branch name maps to
             *   a specific version. App Runner uses the most recent commit to the branch.
             */
            public fun `value`(`value`: String)
        }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SourceCodeVersionProperty
            ): software.amazon.awscdk.services.apprunner.CfnService.SourceCodeVersionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface IngressConfigurationProperty {
        ...
        public interface Builder {
             ...
             *   accessible. To make the service publicly accessible set it to `True` . To make the
             *   service privately accessible, from only within an Amazon VPC set it to `False` .
             */
        ...
        internal constructor(
             ...
             * Specifies whether your App Runner service is publicly accessible.
             *
             * To make the service publicly accessible set it to `True` . To make the service
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: IngressConfigurationProperty
            ): software.amazon.awscdk.services.apprunner.CfnService.IngressConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ImageRepositoryProperty {
        ...
        public interface Builder {
            ...
            public fun imageConfiguration(
                imageConfiguration: ImageConfigurationProperty.Builder.() -> Unit
            )

            /**
             * @param imageIdentifier The identifier of an image. For an image in Amazon Elastic
             *   Container Registry (Amazon ECR), this is an image name. For the image name format,
             *   see
             *   [Pulling an image](https://docs.aws.amazon.com/AmazonECR/latest/userguide/docker-pull-ecr-image.html)
             *   in the *Amazon ECR User Guide* .
             */
            ...
            /**
             * @param imageRepositoryType The type of the image repository. This reflects the
             *   repository provider and whether the repository is private or public.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            override fun imageConfiguration(imageConfiguration: ImageConfigurationProperty) {
                cdkBuilder.imageConfiguration(
                    imageConfiguration.let(ImageConfigurationProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("90d6a3be65eee3a6be6da28afa8bc2b0a11a91f2090a2f062c14a88d278eb9d3")
            override fun imageConfiguration(
                imageConfiguration: ImageConfigurationProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * The identifier of an image.
             *
             * For an image in Amazon Elastic Container Registry (Amazon ECR), this is an image
             * name. For the image name format, see
             * [Pulling an image](https://docs.aws.amazon.com/AmazonECR/latest/userguide/docker-pull-ecr-image.html)
             * in the *Amazon ECR User Guide* .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-apprunner-service-imagerepository.html#cfn-apprunner-service-imagerepository-imageidentifier)
             ...
             * The type of the image repository.
             *
             * This reflects the repository provider and whether the repository is private or
             * public.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-apprunner-service-imagerepository.html#cfn-apprunner-service-imagerepository-imagerepositorytype)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ImageRepositoryProperty
            ): software.amazon.awscdk.services.apprunner.CfnService.ImageRepositoryProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface InstanceConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param cpu The number of CPU units reserved for each instance of your App Runner
             *   service. Default: `1 vCPU`
             */
            public fun cpu(cpu: String)

            /**
             * @param instanceRoleArn The Amazon Resource Name (ARN) of an IAM role that provides
             *   permissions to your App Runner service. These are permissions that your code needs
             *   when it calls any AWS APIs.
             */
            public fun instanceRoleArn(instanceRoleArn: String)

            /**
             * @param memory The amount of memory, in MB or GB, reserved for each instance of your
             *   App Runner service. Default: `2 GB`
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: InstanceConfigurationProperty
            ): software.amazon.awscdk.services.apprunner.CfnService.InstanceConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SourceConfigurationProperty {
         ...
         * or an ECR repository that's in an AWS account other than the one that the service is in.
         * App Runner sets to `true` in all other cases (which currently include a source code
        ...
        public interface Builder {
            /**
             * @param authenticationConfiguration Describes the resources that are needed to
             *   authenticate access to some source repositories.
             */
            ...
            /**
             * @param autoDeploymentsEnabled If `true` , continuous integration from the source
             *   repository is enabled for the App Runner service. Each repository change (including
             ...
             * repository or an ECR repository that's in an AWS account other than the one that the
             * service is in. App Runner sets to `true` in all other cases (which currently include
             * a source code repository or a source image using a same-account ECR repository).
             */
            ...
            /**
             * @param codeRepository The description of a source code repository. You must provide
             *   either this member or `ImageRepository` (but not both).
             */
            ...
            /**
             * @param imageRepository The description of a source image repository. You must provide
             *   either this member or `CodeRepository` (but not both).
             */
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("4b6e601cdd762408eac86c9420a55af5ce88448e3d9abf2069db9b6f957177af")
            override fun codeRepository(
                codeRepository: CodeRepositoryProperty.Builder.() -> Unit
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("ad7463a502823666b37c437aa3a4a5e0156e29964fcdb9e2574540916df3fb31")
            override fun imageRepository(
                imageRepository: ImageRepositoryProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * Runner service.
             *
             * Each repository change (including any source code commit or new image version) starts
             * a deployment.
             *
             * Default: App Runner sets to `false` for a source image that uses an ECR Public
             * repository or an ECR repository that's in an AWS account other than the one that the
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SourceConfigurationProperty
            ): software.amazon.awscdk.services.apprunner.CfnService.SourceConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
