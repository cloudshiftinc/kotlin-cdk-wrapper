...
internal constructor(
    ...
    /** A connection tracking specification for the network interface. */
    public open fun connectionTrackingSpecification(
        `value`: ConnectionTrackingSpecificationProperty
    ) {
        unwrap(this)
            .setConnectionTrackingSpecification(
                `value`.let(ConnectionTrackingSpecificationProperty::unwrap)
            )
    }
    ...
    public open fun connectionTrackingSpecification(
        `value`: ConnectionTrackingSpecificationProperty.Builder.() -> Unit
    ...
    /** The IPv4 delegated prefixes that are assigned to the network interface. */
    public open fun ipv4Prefixes(vararg __idx_ac66f0: Any): Unit =
        ipv4Prefixes(__idx_ac66f0.toList())
    ...
    /** The IPv6 delegated prefixes that are assigned to the network interface. */
    public open fun ipv6Prefixes(vararg __idx_ac66f0: Any): Unit =
        ipv6Prefixes(__idx_ac66f0.toList())
    ...
    public interface Builder {
         ...
         * option to assign a primary IPv6 IP address.
         *
         * A primary IPv6 address is an IPv6 GUA address associated with an ENI that you have
         * enabled to use a primary IPv6 address. Use this option if the instance that this ENI will
         * be attached to relies on its IPv6 address not changing. AWS will automatically assign an
         ...
         *
         * @param enablePrimaryIpv6 If you’re modifying a network interface in a dual-stack or
         *   IPv6-only subnet, you have the option to assign a primary IPv6 IP address.
         */
         ...
         * specified one of the following: specific IPv4 prefixes, specific private IPv4 addresses,
         ...
         * The IPv4 delegated prefixes that are assigned to the network interface.
         *
         * When creating a network interface, you can't specify IPv4 prefixes if you've specified
         * one of the following: a count of IPv4 prefixes, specific private IPv4 addresses, or a
         ...
         *
         * @param ipv4Prefixes The IPv4 delegated prefixes that are assigned to the network
         *   interface.
         */
         ...
         * specified one of the following: specific IPv6 addresses, specific IPv6 prefixes, or a
         ...
         *
         * When creating a network interface, you can't specify IPv6 addresses if you've specified
         * one of the following: a count of IPv6 addresses, specific IPv6 prefixes, or a count of
         * IPv6 prefixes.
         *
         ...
         *
         * @param ipv6Addresses One or more specific IPv6 addresses from the IPv6 CIDR block range
         *   of your subnet to associate with the network interface.
         */
         ...
         * specified one of the following: specific IPv6 prefixes, specific IPv6 addresses, or a
         ...
         * The IPv6 delegated prefixes that are assigned to the network interface.
         *
         * When creating a network interface, you can't specify IPv6 prefixes if you've specified
         * one of the following: a count of IPv6 prefixes, specific IPv6 addresses, or a count of
         * IPv6 addresses.
         *
         ...
         *
         * @param ipv6Prefixes The IPv6 delegated prefixes that are assigned to the network
         *   interface.
         */
        ...
        /**
         * Assigns a single private IP address to the network interface, which is used as the
         ...
         *
         * @param privateIpAddress Assigns a single private IP address to the network interface,
         *   which is used as the primary private IP address.
         */
         ...
         * property to `true` in the `PrivateIpAddressSpecification` property. If you want EC2 to
         * automatically assign private IP addresses, use the `SecondaryPrivateIpAddressCount`
         ...
         * The number of secondary private IPv4 addresses to assign to a network interface.
         *
         * When you specify a number of secondary IPv4 addresses, Amazon EC2 selects these IP
         * addresses within the subnet's IPv4 CIDR range. You can't specify this option and specify
    ...
    private class BuilderImpl(
        ...
        override fun connectionTrackingSpecification(
            ...
            cdkBuilder.connectionTrackingSpecification(
                connectionTrackingSpecification.let(ConnectionTrackingSpecificationProperty::unwrap)
            )
        }
        ...
        public fun build(): software.amazon.awscdk.services.ec2.CfnNetworkInterface =
            cdkBuilder.build()
    }
    ...
    public interface PrivateIpAddressSpecificationProperty {
         ...
         *
         * You can set only one primary private IP address. If you don't specify a primary private
        ...
        public interface Builder {
            /**
             * @param primary Sets the private IP address as the primary private address. You can
             *   set only one primary private IP address. If you don't specify a primary private IP
        ...
        internal constructor(
             ...
             * Sets the private IP address as the primary private address.
             *
             * You can set only one primary private IP address. If you don't specify a primary
             * private IP address, Amazon EC2 automatically assigns a primary private IP address.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ec2-networkinterface-privateipaddressspecification.html#cfn-ec2-networkinterface-privateipaddressspecification-primary)
             */
