...
public open class ApplicationLoadBalancedEc2Service
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * Default: - No certificate associated with the load balancer, if using the HTTP protocol.
         * For HTTPS, a DNS-validated certificate will be created for the load balancer's specified
         * domain name if a domain name and domain zone are specified.
         *
         ...
         *
         * @param listenerPort Listener port of the application load balancer that will serve
         ...
         *
         * When system memory is under contention, Docker attempts to keep the container memory
         * within the limit. If the container requires more memory, it can consume up to the value
         * specified by the Memory property or all of the available memory on the container
        ...
        /**
         * Determines whether or not the Security Group for the Load Balancer's Listener will be
         * open to all traffic by default.
         *
         ...
         * HTTPS). If HTTPS, either a certificate or domain name and domain zone must also be
         * specified.
         *
         * Default: HTTP. If a certificate is specified, the protocol will be set by default to
         * HTTPS.
         *
        ...
        /**
         * Specifies whether the Route53 record should be a CNAME, an A record using the Alias
         * feature or no record at all.
         *
         * This is useful if you need to work with DNS systems that do not support alias records.
         *
         * Default: ApplicationLoadBalancedServiceRecordType.ALIAS
         *
         * @param recordType Specifies whether the Route53 record should be a CNAME, an A record
         *   using the Alias feature or no record at all.
         */
        public fun recordType(recordType: ApplicationLoadBalancedServiceRecordType)

        /**
         * Specifies whether the load balancer should redirect traffic on port 80 to port 443 to
         * support HTTP-&gt;HTTPS redirects This is only valid if the protocol of the ALB is HTTPS.
         *
         * Default: false
         *
         * @param redirectHttp Specifies whether the load balancer should redirect traffic on port
         *   80 to port 443 to support HTTP-&gt;HTTPS redirects This is only valid if the protocol
         *   of the ALB is HTTPS.
         */
         ...
         *
         * @param sslPolicy The security policy that defines which ciphers and protocols are
         *   supported by the ALB Listener.
         */
         ...
         * Default: HTTP.
         *
         * @param targetProtocol The protocol for connections from the load balancer to the ECS
         *   tasks.
         */
        ...
        public fun taskImageOptions(
            taskImageOptions: ApplicationLoadBalancedTaskImageOptions.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
        ...
        override fun taskImageOptions(taskImageOptions: ApplicationLoadBalancedTaskImageOptions) {
            cdkBuilder.taskImageOptions(
                taskImageOptions.let(ApplicationLoadBalancedTaskImageOptions::unwrap)
            )
        }
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: ApplicationLoadBalancedEc2Service
        ): software.amazon.awscdk.services.ecs.patterns.ApplicationLoadBalancedEc2Service =
            wrapped.cdkObject
    }
}
