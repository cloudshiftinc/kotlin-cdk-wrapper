...
public interface INetworkLoadBalancerMetrics {
    ...
    internal constructor(
         ...
         * The total number of concurrent TCP flows (or connections) from clients to targets.
         *
         * This metric includes connections in the SYN_SENT and ESTABLISHED states. TCP connections
         * are not terminated at the load balancer, so a client opening a TCP connection to a target
        ...
        /**
         * The total number of new TCP flows (or connections) established from clients to targets in
         * the time period.
         *
         * Default: Sum over 5 minutes
         *
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: INetworkLoadBalancerMetrics
        ): software.amazon.awscdk.services.elasticloadbalancingv2.INetworkLoadBalancerMetrics =
