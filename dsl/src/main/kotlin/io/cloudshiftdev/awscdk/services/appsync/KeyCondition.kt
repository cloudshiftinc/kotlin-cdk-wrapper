...
internal constructor(
    ...
    public companion object {
        public fun beginsWith(keyName: String, arg: String): KeyCondition =
            software.amazon.awscdk.services.appsync.KeyCondition.beginsWith(keyName, arg)
                .let(KeyCondition::wrap)
        ...
        public fun between(
            ...
            software.amazon.awscdk.services.appsync.KeyCondition.between(keyName, arg1, arg2)
                .let(KeyCondition::wrap)

        public fun eq(keyName: String, arg: String): KeyCondition =
            software.amazon.awscdk.services.appsync.KeyCondition.eq(keyName, arg)
                .let(KeyCondition::wrap)

        public fun ge(keyName: String, arg: String): KeyCondition =
            software.amazon.awscdk.services.appsync.KeyCondition.ge(keyName, arg)
                .let(KeyCondition::wrap)

        public fun gt(keyName: String, arg: String): KeyCondition =
            software.amazon.awscdk.services.appsync.KeyCondition.gt(keyName, arg)
                .let(KeyCondition::wrap)

        public fun le(keyName: String, arg: String): KeyCondition =
            software.amazon.awscdk.services.appsync.KeyCondition.le(keyName, arg)
                .let(KeyCondition::wrap)

        public fun lt(keyName: String, arg: String): KeyCondition =
            software.amazon.awscdk.services.appsync.KeyCondition.lt(keyName, arg)
                .let(KeyCondition::wrap)

        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.appsync.KeyCondition
        ): KeyCondition = KeyCondition(cdkObject)

        internal fun unwrap(
            wrapped: KeyCondition
        ): software.amazon.awscdk.services.appsync.KeyCondition = wrapped.cdkObject
    }
}
