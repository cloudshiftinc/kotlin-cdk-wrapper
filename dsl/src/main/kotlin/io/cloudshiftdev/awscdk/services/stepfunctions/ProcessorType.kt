...
public enum class ProcessorType(
    ...
    public companion object {
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.stepfunctions.ProcessorType
        ): ProcessorType =
            when (cdkObject) {
                software.amazon.awscdk.services.stepfunctions.ProcessorType.STANDARD ->
                    ProcessorType.STANDARD
                software.amazon.awscdk.services.stepfunctions.ProcessorType.EXPRESS ->
                    ProcessorType.EXPRESS
            }

        internal fun unwrap(
            wrapped: ProcessorType
