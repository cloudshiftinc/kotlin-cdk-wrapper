...
internal constructor(
    ...
    public open fun outboundCallerConfig(
        `value`: OutboundCallerConfigProperty.Builder.() -> Unit
     ...
     * working the queue.
     */
    public open fun quickConnectArns(): List<String> =
        unwrap(this).getQuickConnectArns() ?: emptyList()
    ...
    public interface Builder {
         ...
         *
         * @param outboundCallerConfig The outbound caller ID name, number, and outbound whisper
         *   flow.
         */
        ...
        public fun outboundCallerConfig(
            outboundCallerConfig: OutboundCallerConfigProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
        ...
        override fun outboundCallerConfig(outboundCallerConfig: OutboundCallerConfigProperty) {
            cdkBuilder.outboundCallerConfig(
                outboundCallerConfig.let(OutboundCallerConfigProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("4fea0c6d4349f0a909729187b8314330b05c7d9bb80d6adb423178a0df302ce2")
        override fun outboundCallerConfig(
            outboundCallerConfig: OutboundCallerConfigProperty.Builder.() -> Unit
    ...
    public interface OutboundCallerConfigProperty {
         ...
         */
        public fun outboundCallerIdNumberArn(): String? =
        ...
        public interface Builder {
            ...
            /**
             * @param outboundCallerIdNumberArn The Amazon Resource Name (ARN) of the outbound
             *   caller ID number.
             *
             * Only use the phone number ARN format that doesn't contain `instance` in the path, for
             * example, `arn:aws:connect:us-east-1:1234567890:phone-number/uuid` . This is the same
             * ARN format that is returned when you create a phone number using CloudFormation , or
             * when you call the
             * [ListPhoneNumbersV2](https://docs.aws.amazon.com/connect/latest/APIReference/API_ListPhoneNumbersV2.html)
             * API.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: OutboundCallerConfigProperty
            ): software.amazon.awscdk.services.connect.CfnQueue.OutboundCallerConfigProperty =
