...
internal constructor(
    ...
    public interface Builder {
         ...
         *   policies that you want to attach to the user.
         */
         ...
         *
         * @param permissionsBoundary The ARN of the managed policy that is used to set the
         ...
         * You can also include any of the following characters: _+=,.&#64;-. The user name must be
         * unique within the account. User names are not distinguished by case. For example, you
         * cannot create users named both "John" and "john".
         *
    ...
    public interface LoginProfileProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param passwordResetRequired Specifies whether the user is required to set a new
