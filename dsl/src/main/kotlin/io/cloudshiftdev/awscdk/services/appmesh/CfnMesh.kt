...
internal constructor(
    ...
    public interface MeshServiceDiscoveryProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: MeshServiceDiscoveryProperty
            ): software.amazon.awscdk.services.appmesh.CfnMesh.MeshServiceDiscoveryProperty =
    ...
    public interface EgressFilterProperty {
         ...
         * all egress for that virtual node as backends. Otherwise, `ALLOW_ALL` will no longer work
         * for that virtual node.
         *
        ...
        public interface Builder {
             ...
             *   any traffic to `*.amazonaws.com` for AWS API calls). You can set the egress filter
             *   type to `ALLOW_ALL` to allow egress to any endpoint inside or outside of the
             *   service mesh.
             *
             * If you specify any backends on a virtual node when using `ALLOW_ALL` , you must
             * specifiy all egress for that virtual node as backends. Otherwise, `ALLOW_ALL` will no
             * longer work for that virtual node.
             */
        ...
        internal constructor(
             ...
             * The egress filter type.
             *
             * By default, the type is `DROP_ALL` , which allows egress only from virtual nodes to
             * other defined resources in the service mesh (and any traffic to `*.amazonaws.com` for
             * AWS API calls). You can set the egress filter type to `ALLOW_ALL` to allow egress to
    ...
    public interface MeshSpecProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param serviceDiscovery An object that represents the service discovery information
             *   for a service mesh.
             */
            ...
            public fun serviceDiscovery(
                serviceDiscovery: MeshServiceDiscoveryProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun serviceDiscovery(serviceDiscovery: MeshServiceDiscoveryProperty) {
                cdkBuilder.serviceDiscovery(
                    serviceDiscovery.let(MeshServiceDiscoveryProperty::unwrap)
                )
            }
