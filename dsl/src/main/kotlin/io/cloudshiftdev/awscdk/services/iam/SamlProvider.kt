...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param metadataDocument An XML document generated by an identity provider (IdP) that
    ...
    public companion object {
        public fun fromSamlProviderArn(
            ...
            software.amazon.awscdk.services.iam.SamlProvider.fromSamlProviderArn(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    samlProviderArn
                )
                .let(ISamlProvider::wrap)
        ...
        ): SamlProvider = SamlProvider(cdkObject)

        internal fun unwrap(
            wrapped: SamlProvider
        ): software.amazon.awscdk.services.iam.SamlProvider = wrapped.cdkObject
    }
}
