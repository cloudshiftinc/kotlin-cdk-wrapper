...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.codepipeline.CfnPipeline,
    ...
    public interface Builder {
         ...
         * or updating a pipeline will result in the pipeline having the V2 type of pipeline and the
         * associated costs.
         *
         ...
         *   characteristics and price, so that you can tailor your pipeline features and cost to
         ...
         *
         * @param restartExecutionOnUpdate Indicates whether to rerun the CodePipeline pipeline
         *   after you update it.
         */
         ...
         *
         * @param triggers The trigger configuration specifying a type of event, such as Git tags,
    ...
    private class BuilderImpl(
        ...
        override fun disableInboundStageTransitions(disableInboundStageTransitions: IResolvable) {
            cdkBuilder.disableInboundStageTransitions(
                disableInboundStageTransitions.let(IResolvable::unwrap)
            )
        }
         ...
         *   action.
         */
        override fun disableInboundStageTransitions(
            vararg disableInboundStageTransitions: Any
        ): Unit = disableInboundStageTransitions(disableInboundStageTransitions.toList())
    ...
    public interface OutputArtifactProperty {
         ...
         * action. However, the downstream action's input artifact does not have to be the next
         * action in strict sequence from the action that provided the output artifact. Actions in
        ...
        public interface Builder {
            /**
             * @param name The name of the output of an artifact, such as "My App". The output
             *   artifact name must exactly match the input artifact declared for a downstream
             *   action. However, the downstream action's input artifact does not have to be the
             *   next action in strict sequence from the action that provided the output artifact.
        ...
        internal constructor(
             ...
             * downstream action. However, the downstream action's input artifact does not have to
             * be the next action in strict sequence from the action that provided the output
             * artifact. Actions in parallel can declare different output artifacts, which are in
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: OutputArtifactProperty
            ): software.amazon.awscdk.services.codepipeline.CfnPipeline.OutputArtifactProperty =
    ...
    public interface GitTagFilterCriteriaProperty {
        ...
        public interface Builder {
            /**
             * @param excludes The list of patterns of Git tags that, when pushed, are to be
            ...
            /**
             * @param includes The list of patterns of Git tags that, when pushed, are to be
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: GitTagFilterCriteriaProperty
            ): software.amazon.awscdk.services.codepipeline.CfnPipeline.GitTagFilterCriteriaProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface StageTransitionProperty {
        ...
        public interface Builder {
             ...
             *   for manual approval or manual tests. This message is displayed in the pipeline
             *   console UI.
             */
            public fun reason(reason: String)

            /**
             * @param stageName The name of the stage where you want to disable the inbound or
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: StageTransitionProperty
            ): software.amazon.awscdk.services.codepipeline.CfnPipeline.StageTransitionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface GitConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param pullRequest The field where the repository event that will start the pipeline
            ...
            /**
             * @param push The field where the repository event that will start the pipeline, such
             ...
             *   configuration, such as Git tags, is specified. The trigger configuration will start
        ...
        private class BuilderImpl : Builder {
             ...
             *   is specified as pull requests.
             */
            override fun pullRequest(vararg pullRequest: Any): Unit =
                pullRequest(pullRequest.toList())
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: GitConfigurationProperty
            ): software.amazon.awscdk.services.codepipeline.CfnPipeline.GitConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface InputArtifactProperty {
        ...
        public interface Builder {
             ...
             *   example, the S3 source action input artifact is a file name (or file path), and the
        ...
        internal constructor(
             ...
             *
             * Artifacts are the files that are worked on by actions in the pipeline. See the action
             * configuration for each action for details about artifact parameters. For example, the
             * S3 source action input artifact is a file name (or file path), and the files are
    ...
    public interface PipelineTriggerDeclarationProperty {
        ...
        public interface Builder {
            ...
            public fun gitConfiguration(
                gitConfiguration: GitConfigurationProperty.Builder.() -> Unit
            )

            /**
             * @param providerType The source provider for the event, such as connections configured
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: PipelineTriggerDeclarationProperty
            ): software.amazon.awscdk.services.codepipeline.CfnPipeline.PipelineTriggerDeclarationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ActionTypeIdProperty {
         ...
         *
         * Valid providers are determined by the action category. For example, an action in the
         * Deploy category type might have a provider of CodeDeploy, which would be specified as
         * `CodeDeploy` . For more information, see
         * [Valid Action Types and Providers in CodePipeline](https://docs.aws.amazon.com/codepipeline/latest/userguide/reference-pipeline-structure.html#actions-valid-providers)
         * .
         *
        ...
        public interface Builder {
             ...
             *   constrains the provider type for the action. Valid categories are limited to one of
             *   the values below.
             * * `Source`
             * * `Build`
             * * `Test`
            ...
            /**
             * @param owner The creator of the action being called. There are three valid values for
             *   the `Owner` field in the action category section within your pipeline structure:
             *   `AWS` , `ThirdParty` , and `Custom` . For more information, see
             *   [Valid Action Types and Providers in CodePipeline](https://docs.aws.amazon.com/codepipeline/latest/userguide/reference-pipeline-structure.html#actions-valid-providers)
             *   .
             */
             ...
             *   providers are determined by the action category. For example, an action in the
             *   Deploy category type might have a provider of CodeDeploy, which would be specified
             *   as `CodeDeploy` . For more information, see
             *   [Valid Action Types and Providers in CodePipeline](https://docs.aws.amazon.com/codepipeline/latest/userguide/reference-pipeline-structure.html#actions-valid-providers)
             *   .
             */
        ...
        internal constructor(
             ...
             * within your pipeline structure: `AWS` , `ThirdParty` , and `Custom` . For more
             * information, see
             * [Valid Action Types and Providers in CodePipeline](https://docs.aws.amazon.com/codepipeline/latest/userguide/reference-pipeline-structure.html#actions-valid-providers)
             * .
             *
    ...
    public interface GitPullRequestFilterProperty {
        ...
        public interface Builder {
            /**
             * @param branches The field that specifies to filter on branches for the pull request
            ...
            /**
             * @param events The field that specifies which pull request events to filter on
            ...
            /**
             * @param filePaths The field that specifies to filter on file paths for the pull
        ...
        private class BuilderImpl : Builder {
            ...
            override fun branches(
                branches: GitBranchFilterCriteriaProperty.Builder.() -> Unit
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("6d5bf2731910e29c1c9b8d2d2b130cde8712135db84adebde46c8d9a907d77a6")
            override fun filePaths(
                filePaths: GitFilePathFilterCriteriaProperty.Builder.() -> Unit
            ): Unit = filePaths(GitFilePathFilterCriteriaProperty(filePaths))
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: GitPullRequestFilterProperty
            ): software.amazon.awscdk.services.codepipeline.CfnPipeline.GitPullRequestFilterProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ArtifactStoreMapProperty {
        ...
        public interface Builder {
            /**
             * @param artifactStore Represents information about the S3 bucket where artifacts are
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("517dbcd794991f0a62ad3ab845d445462d9a0ab84342eb2be9405c85439e27e4")
            override fun artifactStore(
                artifactStore: ArtifactStoreProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ArtifactStoreMapProperty
            ): software.amazon.awscdk.services.codepipeline.CfnPipeline.ArtifactStoreMapProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ArtifactStoreProperty {
         ...
         * contain the pipeline artifacts is created for you based on the name of the pipeline. You
        ...
        public interface Builder {
            /**
             * @param encryptionKey The encryption key used to encrypt the data in the artifact
             *   store, such as an AWS Key Management Service ( AWS KMS) key. If this is undefined,
             *   the default key for Amazon S3 is used. To see an example artifact store encryption
             *   key field, see the example structure here:
             *   [AWS::CodePipeline::Pipeline](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-codepipeline-pipeline.html)
             *   .
             */
            ...
            /**
             * @param location The S3 bucket used for storing the artifacts for a pipeline. You can
             ...
             *   pipeline. You can use any S3 bucket in the same AWS Region as the pipeline to store
        ...
        private class BuilderImpl : Builder {
            ...
            override fun encryptionKey(
                encryptionKey: EncryptionKeyProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * Management Service ( AWS KMS) key.
             *
             * If this is undefined, the default key for Amazon S3 is used. To see an example
             * artifact store encryption key field, see the example structure here:
             * [AWS::CodePipeline::Pipeline](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-codepipeline-pipeline.html)
             * .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-codepipeline-pipeline-artifactstore.html#cfn-codepipeline-pipeline-artifactstore-encryptionkey)
             ...
             * You can use any S3 bucket in the same AWS Region as the pipeline to store your
             * pipeline artifacts.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-codepipeline-pipeline-artifactstore.html#cfn-codepipeline-pipeline-artifactstore-location)
             */
    ...
    public interface BlockerDeclarationProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: BlockerDeclarationProperty
            ): software.amazon.awscdk.services.codepipeline.CfnPipeline.BlockerDeclarationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface StageDeclarationProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: StageDeclarationProperty
            ): software.amazon.awscdk.services.codepipeline.CfnPipeline.StageDeclarationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface EncryptionKeyProperty {
         ...
         *
         * Aliases are recognized only in the account that created the AWS KMS key. For
         * cross-account actions, you can only use the key ID or key ARN to identify the key.
         * Cross-account actions involve using the role from the other account (AccountB), so
        ...
        public interface Builder {
            /**
             * @param id The ID used to identify the key. For an AWS KMS key, you can use the key
            ...
            /**
             * @param type The type of encryption key, such as an AWS KMS key. When creating or
    ...
    public interface ActionDeclarationProperty {
         ...
         *
         * While the field is not a required parameter, most actions have an action configuration
         * that requires a specified quantity of input artifacts. To refer to the action
         ...
         *
         * While the field is not a required parameter, most actions have an action configuration
         * that requires a specified quantity of output artifacts. To refer to the action
         * configuration specification by action provider, see the
         * [Action structure reference](https://docs.aws.amazon.com/codepipeline/latest/userguide/action-reference.html)
         * in the *AWS CodePipeline User Guide* .
         *
        ...
        public interface Builder {
            ...
            /**
             * @param configuration The action's configuration. These are key-value pairs that
             *   specify input values for an action. For more information, see
             *   [Action Structure Requirements in CodePipeline](https://docs.aws.amazon.com/codepipeline/latest/userguide/reference-pipeline-structure.html#action-requirements)
            ...
            /**
             * @param inputArtifacts The name or ID of the artifact consumed by the action, such as
             *   a test or build artifact. While the field is not a required parameter, most actions
             *   have an action configuration that requires a specified quantity of input artifacts.
             *   To refer to the action configuration specification by action provider, see the
             *   [Action structure reference](https://docs.aws.amazon.com/codepipeline/latest/userguide/action-reference.html)
             *   in the *AWS CodePipeline User Guide* .
             *
             * For a CodeBuild action with multiple input artifacts, one of your input sources must
             * be designated the PrimarySource. For more information, see the
             * [CodeBuild action reference page](https://docs.aws.amazon.com/codepipeline/latest/userguide/action-reference-CodeBuild.html)
             * in the *AWS CodePipeline User Guide* .
             */
            ...
            /**
             * @param namespace The variable namespace associated with the action. All variables
             *   produced as output by this action fall under this namespace.
             */
            public fun namespace(namespace: String)

            /**
             * @param outputArtifacts The name or ID of the result of the action declaration, such
             *   as a test or build artifact. While the field is not a required parameter, most
             *   actions have an action configuration that requires a specified quantity of output
             *   artifacts. To refer to the action configuration specification by action provider,
             *   see the
             *   [Action structure reference](https://docs.aws.amazon.com/codepipeline/latest/userguide/action-reference.html)
             *   in the *AWS CodePipeline User Guide* .
             */
        ...
        internal constructor(
             ...
             * The action's configuration.
             *
             * These are key-value pairs that specify input values for an action. For more
             * information, see
             * [Action Structure Requirements in CodePipeline](https://docs.aws.amazon.com/codepipeline/latest/userguide/reference-pipeline-structure.html#action-requirements)
             * . For the list of configuration properties for the AWS CloudFormation action type in
             * CodePipeline, see
             ...
             * artifact.
             *
             * While the field is not a required parameter, most actions have an action
             * configuration that requires a specified quantity of input artifacts. To refer to the
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ActionDeclarationProperty
            ): software.amazon.awscdk.services.codepipeline.CfnPipeline.ActionDeclarationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface GitPushFilterProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param filePaths The field that specifies to filter on file paths for the push
             *   trigger configuration.
             */
            public fun filePaths(filePaths: IResolvable)
            ...
            /**
             * @param tags The field that contains the details for the Git tags trigger
             *   configuration.
             */
    ...
    public interface VariableDeclarationProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param description The description of a pipeline-level variable. It's used to add
             *   additional context about the variable, and not being used at time when pipeline
             *   executes.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: VariableDeclarationProperty
            ): software.amazon.awscdk.services.codepipeline.CfnPipeline.VariableDeclarationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface GitFilePathFilterCriteriaProperty {
        ...
        public interface Builder {
            /**
             * @param excludes The list of patterns of Git repository file paths that, when a commit
            ...
            /**
             * @param includes The list of patterns of Git repository file paths that, when a commit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: GitFilePathFilterCriteriaProperty
            ): software.amazon.awscdk.services.codepipeline.CfnPipeline.GitFilePathFilterCriteriaProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface GitBranchFilterCriteriaProperty {
        ...
        public interface Builder {
            /**
             * @param excludes The list of patterns of Git branches that, when a commit is pushed,
            ...
            /**
             * @param includes The list of patterns of Git branches that, when a commit is pushed,
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: GitBranchFilterCriteriaProperty
            ): software.amazon.awscdk.services.codepipeline.CfnPipeline.GitBranchFilterCriteriaProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
