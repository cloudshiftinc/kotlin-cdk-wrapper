...
public interface DataSource {
  ...
  private class BuilderImpl : Builder {
    ...
    public override fun s3DataSource(s3DataSource: S3DataSource) {
      cdkBuilder.s3DataSource(s3DataSource.let(S3DataSource::unwrap))
    }

    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("2ebbc3bbf36c06c717e037f58161a4876fd4251eb0fb934c9de190c21961c9d1")
    public override fun s3DataSource(s3DataSource: S3DataSource.Builder.() -> Unit): Unit =
  ...
  private class Wrapper internal constructor(
    ...
    public override fun s3DataSource(): S3DataSource =
