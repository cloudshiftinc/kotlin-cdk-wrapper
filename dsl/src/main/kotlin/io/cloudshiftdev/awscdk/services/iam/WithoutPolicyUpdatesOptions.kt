...
public interface WithoutPolicyUpdatesOptions {
    ...
    public interface Builder {
        /**
         * @param addGrantsToResources Add grants to resources instead of dropping them. If this is
         *   `false` or not specified, grant permissions added to this role are ignored. It is your
         *   own responsibility to make sure the role has the required permissions.
         *
         * If this is `true`, any grant permissions will be added to the resource instead.
         */
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: WithoutPolicyUpdatesOptions
