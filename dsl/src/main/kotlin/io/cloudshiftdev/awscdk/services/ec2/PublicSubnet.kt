...
public open class PublicSubnet
internal constructor(
    ...
    public companion object {
        public fun fromPublicSubnetAttributes(
            ...
            software.amazon.awscdk.services.ec2.PublicSubnet.fromPublicSubnetAttributes(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    attrs.let(PublicSubnetAttributes::unwrap)
                )
                .let(IPublicSubnet::wrap)
        ...
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.ec2.PublicSubnet
        ): PublicSubnet = PublicSubnet(cdkObject)

        internal fun unwrap(
            wrapped: PublicSubnet
        ): software.amazon.awscdk.services.ec2.PublicSubnet = wrapped.cdkObject
    }
}
