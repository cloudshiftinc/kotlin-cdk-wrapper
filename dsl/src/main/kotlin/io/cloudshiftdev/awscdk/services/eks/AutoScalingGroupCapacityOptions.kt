...
public interface AutoScalingGroupCapacityOptions : CommonAutoScalingGroupProps {
     ...
     *
     * If you wish to provide a custom user data script, set this to `false` and manually invoke
    ...
    public interface Builder {
        ...
        /**
         * @param bootstrapEnabled Configures the EC2 user-data script for instances in this
         *   autoscaling group to bootstrap the node (invoke `/etc/eks/bootstrap.sh`) and associate
         *   it with the EKS cluster. If you wish to provide a custom user data script, set this to
         *   `false` and manually invoke `autoscalingGroup.addUserData()`.
         */
        ...
        /**
         * @param mapRole Will automatically update the aws-auth ConfigMap to map the IAM instance
         *   role to RBAC. This cannot be explicitly set to `true` if the cluster has kubectl
         *   disabled.
         */
        ...
        /**
         * @param spotInterruptHandler Installs the AWS spot instance interrupt handler on the
         *   cluster if it's not already added. Only relevant if `spotPrice` is used.
         */
    ...
    internal constructor(
        ...
        /**
         * Configures the EC2 user-data script for instances in this autoscaling group to bootstrap
         * the node (invoke `/etc/eks/bootstrap.sh`) and associate it with the EKS cluster.
         *
         * If you wish to provide a custom user data script, set this to `false` and manually invoke
         * `autoscalingGroup.addUserData()`.
         *
        ...
        /**
         * Installs the AWS spot instance interrupt handler on the cluster if it's not already
         * added.
         *
         * Only relevant if `spotPrice` is used.
         *
    ...
    public companion object {
        ...
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.eks.AutoScalingGroupCapacityOptions
        ): AutoScalingGroupCapacityOptions = Wrapper(cdkObject)

        internal fun unwrap(
            wrapped: AutoScalingGroupCapacityOptions
