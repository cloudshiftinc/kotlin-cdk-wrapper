...
public enum class TargetType(
    ...
    public companion object {
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.elasticloadbalancingv2.TargetType
        ): TargetType =
            when (cdkObject) {
                software.amazon.awscdk.services.elasticloadbalancingv2.TargetType.INSTANCE ->
                    TargetType.INSTANCE
                software.amazon.awscdk.services.elasticloadbalancingv2.TargetType.IP ->
                    TargetType.IP
                software.amazon.awscdk.services.elasticloadbalancingv2.TargetType.LAMBDA ->
                    TargetType.LAMBDA
                software.amazon.awscdk.services.elasticloadbalancingv2.TargetType.ALB ->
                    TargetType.ALB
            }
