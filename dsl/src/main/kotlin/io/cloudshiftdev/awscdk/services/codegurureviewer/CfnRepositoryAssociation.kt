...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * Its format is
         * `arn:aws:codestar-connections:region-id:aws-account_id:connection/connection-id` . For
         ...
         *
         * `ConnectionArn` must be specified for Bitbucket and GitHub Enterprise Server
         * repositories. It has no effect if it is specified for an AWS CodeCommit repository.
         *
         ...
         * The owner of the repository.
         *
         * For a GitHub Enterprise Server or Bitbucket repository, this is the username for the
         * account that owns the repository.
         *
         * `Owner` must be specified for Bitbucket and GitHub Enterprise Server repositories. It has
         * no effect if it is specified for an AWS CodeCommit repository.
         *
        ...
        /**
         * The type of repository that contains the source code to be reviewed. The valid values
         * are:.
         * * `CodeCommit`
         * * `Bitbucket`
         ...
         *
         * @param type The type of repository that contains the source code to be reviewed. The
         *   valid values are:.
         */
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnRepositoryAssociation
        ): software.amazon.awscdk.services.codegurureviewer.CfnRepositoryAssociation =
            wrapped.cdkObject
    }
}
