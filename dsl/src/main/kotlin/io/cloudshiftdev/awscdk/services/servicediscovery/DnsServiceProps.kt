...
public interface DnsServiceProps : BaseServiceProps {
     ...
     * AliasTargetInstance.
     *
     * Setting this to `true` correctly configures the `routingPolicy` and performs some additional
     * validation.
     *
     * Default: false
     */
    ...
    public interface Builder {
         ...
         *   checker. Only one of healthCheckConfig or healthCheckCustomConfig can be specified.
         ...
         *   settings, AWS Cloud Map associates the health check with the records that you specify
         *   in DnsConfig. Only one of healthCheckConfig or healthCheckCustomConfig can be
         *   specified. Not valid for PrivateDnsNamespaces. If you use healthCheck, you can only
         *   register IP instances to this service.
         */
         ...
         *   registered to it as an AliasTargetInstance. Setting this to `true` correctly configures
         *   the `routingPolicy` and performs some additional validation.
         */
    ...
    public companion object {
        ...
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.servicediscovery.DnsServiceProps
        ): DnsServiceProps = Wrapper(cdkObject)

        internal fun unwrap(
            wrapped: DnsServiceProps
