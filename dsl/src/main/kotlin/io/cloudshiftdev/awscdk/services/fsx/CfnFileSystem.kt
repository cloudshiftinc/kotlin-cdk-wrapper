...
internal constructor(
    ...
    public open fun lustreConfiguration(
        `value`: LustreConfigurationProperty.Builder.() -> Unit
    ): Unit = lustreConfiguration(LustreConfigurationProperty(`value`))
    ...
    public open fun ontapConfiguration(
        `value`: OntapConfigurationProperty.Builder.() -> Unit
    ): Unit = ontapConfiguration(OntapConfigurationProperty(`value`))
    ...
    public open fun openZfsConfiguration(
        `value`: OpenZFSConfigurationProperty.Builder.() -> Unit
    ...
    public open fun windowsConfiguration(
        `value`: WindowsConfigurationProperty.Builder.() -> Unit
    ...
    public interface Builder {
         ...
         *
         * @param backupId The ID of the file system backup that you are using to create a file
         *   system.
         */
         ...
         *
         * @param fileSystemType The type of Amazon FSx file system, which can be `LUSTRE` ,
         ...
         * default is `2.12` .
         *
         * If you set `FileSystemTypeVersion` to `2.10` for a `PERSISTENT_2` Lustre deployment type,
         * the `CreateFileSystem` operation fails.
         *
         ...
         *
         * `SCRATCH_1` and `SCRATCH_2` types are encrypted using the Amazon FSx service AWS KMS key
         * for your account.
        ...
        public fun lustreConfiguration(
            lustreConfiguration: LustreConfigurationProperty.Builder.() -> Unit
        )
         ...
         *
         * @param ontapConfiguration The ONTAP configuration properties of the FSx for ONTAP file
        ...
        public fun ontapConfiguration(
            ontapConfiguration: OntapConfigurationProperty.Builder.() -> Unit
        )
         ...
         *
         * @param openZfsConfiguration The Amazon FSx for OpenZFS configuration properties for the
         *   file system that you are creating.
         */
        ...
        public fun openZfsConfiguration(
            openZfsConfiguration: OpenZFSConfigurationProperty.Builder.() -> Unit
        )
         ...
         *
         * @param securityGroupIds A list of IDs specifying the security groups to apply to all
         *   network interfaces created for file system access.
         */
         ...
         * Sets the storage capacity of the file system that you're creating.
         *
         * `StorageCapacity` is required if you are creating a new file system. It is not required
         * if you are creating a file system by restoring a backup.
         *
         ...
         *   3600 GiB.
         *
         * *FSx for ONTAP file systems* - The amount of storage capacity that you can configure is
         * from 1024 GiB up to 196,608 GiB (192 TiB).
         *
         * *FSx for OpenZFS file systems* - The amount of storage capacity that you can configure is
         * from 64 GiB up to 524,288 GiB (512 TiB). If you are creating a file system from a backup,
         * you can specify a storage capacity equal to or greater than the original file system's
         * storage capacity.
         *
         ...
         * Specifies the IDs of the subnets that the file system will be accessible from.
         *
         * For Windows and ONTAP `MULTI_AZ_1` deployment types,provide exactly two subnet IDs, one
         ...
         *
         * @param windowsConfiguration The configuration object for the Microsoft Windows file
        ...
        public fun windowsConfiguration(
            windowsConfiguration: WindowsConfigurationProperty.Builder.() -> Unit
        )
    }
    ...
    private class BuilderImpl(
        ...
        override fun lustreConfiguration(lustreConfiguration: LustreConfigurationProperty) {
            cdkBuilder.lustreConfiguration(
                lustreConfiguration.let(LustreConfigurationProperty::unwrap)
            )
        }
        ...
        override fun ontapConfiguration(ontapConfiguration: OntapConfigurationProperty) {
            cdkBuilder.ontapConfiguration(
                ontapConfiguration.let(OntapConfigurationProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("bf84fd5c58c0ed36bb428bdaaa93c4e6ffeeb9e94edd4d4f2a34c8b0124b7068")
        override fun ontapConfiguration(
            ontapConfiguration: OntapConfigurationProperty.Builder.() -> Unit
        ...
        override fun openZfsConfiguration(openZfsConfiguration: OpenZFSConfigurationProperty) {
            cdkBuilder.openZfsConfiguration(
                openZfsConfiguration.let(OpenZFSConfigurationProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("3d2a7f63461a36538cf88a3b8eaaacef125133a8bdbc5b8ac360598430d7a99b")
        override fun openZfsConfiguration(
            openZfsConfiguration: OpenZFSConfigurationProperty.Builder.() -> Unit
        ...
        override fun windowsConfiguration(windowsConfiguration: WindowsConfigurationProperty) {
            cdkBuilder.windowsConfiguration(
                windowsConfiguration.let(WindowsConfigurationProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("ed77315dad931a284e8c8b5ebfa01303758a2f360f000b6381c2cf38716af285")
        override fun windowsConfiguration(
            windowsConfiguration: WindowsConfigurationProperty.Builder.() -> Unit
    ...
    public companion object {
        ...
        ): CfnFileSystem = CfnFileSystem(cdkObject)

        internal fun unwrap(
            wrapped: CfnFileSystem
        ): software.amazon.awscdk.services.fsx.CfnFileSystem = wrapped.cdkObject
    }
    ...
    public interface WindowsConfigurationProperty {
         ...
         * , including additional steps you must take to be able to access your file system using a
         * DNS alias.
         *
         ...
         *   AZ redundancy.
         * * `SINGLE_AZ_2` - The latest generation Single AZ file system. Specifies a file system
         *   that is configured for single AZ redundancy and supports HDD storage type.
         *
         * For more information, see
         * [Availability and Durability: Single-AZ and Multi-AZ File Systems](https://docs.aws.amazon.com/fsx/latest/WindowsGuide/high-availability-multiAZ.html)
         * .
         ...
         * Windows file system.
         *
         * By default, Amazon FSx automatically provisions 3 IOPS per GiB of storage capacity. You
         * can provision additional IOPS per GiB of storage, up to the maximum limit associated with
         * your chosen throughput capacity.
         *
         ...
         * zone as your preferred file server to reduce cross-availability zone data transfer costs
         ...
         * or an FSx for ONTAP storage virtual machine (SVM) to a self-managed (including
         ...
         * second (MB/s), in 2 to the *n* th increments, between 2^3 (8) and 2^11 (2048).
         *
         ...
         */
        public fun weeklyMaintenanceStartTime(): String? =
        ...
        public interface Builder {
            /**
             * @param activeDirectoryId The ID for an existing AWS Managed Microsoft Active
             *   Directory (AD) instance that the file system should join when it's created.
             *   Required if you are joining the file system to an existing AWS Managed Microsoft
             *   AD.
             */
            public fun activeDirectoryId(activeDirectoryId: String)

            /**
             * @param aliases An array of one or more DNS alias names that you want to associate
             *   with the Amazon FSx file system. Aliases allow you to use existing DNS names to
             *   access the data in your Amazon FSx file system. You can associate up to 50 aliases
             *   with a file system at any time.
             *
             * For more information, see
             * [Working with DNS Aliases](https://docs.aws.amazon.com/fsx/latest/WindowsGuide/managing-dns-aliases.html)
             * and
            ...
            /**
             * @param auditLogConfiguration The configuration that Amazon FSx for Windows File
             *   Server uses to audit and log user accesses of files, folders, and file shares on
            ...
            public fun auditLogConfiguration(
                auditLogConfiguration: AuditLogConfigurationProperty.Builder.() -> Unit
            )

            /**
             * @param automaticBackupRetentionDays The number of days to retain automatic backups.
             *   Setting this property to `0` disables automatic backups. You can retain automatic
             ...
             *   should be copied to backups. This value defaults to false. If it's set to true, all
             *   tags for the file system are copied to all automatic and user-initiated backups
             *   where the user doesn't specify tags. If this value is true, and you specify one or
             ...
             *   of the hour. For example, `05:00` specifies 5 AM daily.
             */
             ...
             *   configuration for an Amazon FSx for Windows file system. By default, Amazon FSx
             *   automatically provisions 3 IOPS per GiB of storage capacity. You can provision
             *   additional IOPS per GiB of storage, up to the maximum limit associated with your
            ...
            public fun diskIopsConfiguration(
                diskIopsConfiguration: DiskIopsConfigurationProperty.Builder.() -> Unit
            )
             ...
             *   in- AWS applications, we recommend that you launch your clients in the same
             *   availability zone as your preferred file server to reduce cross-availability zone
             *   data transfer costs and minimize latency.
             */
            public fun preferredSubnetId(preferredSubnetId: String)

            /**
             * @param selfManagedActiveDirectoryConfiguration The configuration that Amazon FSx uses
             *   to join a FSx for Windows File Server file system or an FSx for ONTAP storage
             *   virtual machine (SVM) to a self-managed (including on-premises) Microsoft Active
             *   Directory (AD) directory. For more information, see
             *   [Using Amazon FSx for Windows with your self-managed Microsoft Active Directory](https://docs.aws.amazon.com/fsx/latest/WindowsGuide/self-managed-AD.html)
             *   or
             *   [Managing FSx for ONTAP SVMs](https://docs.aws.amazon.com/fsx/latest/ONTAPGuide/managing-svms.html)
             *   .
            ...
            public fun selfManagedActiveDirectoryConfiguration(
                selfManagedActiveDirectoryConfiguration:
                    SelfManagedActiveDirectoryConfigurationProperty.Builder.() -> Unit
            )

            /**
             * @param throughputCapacity Sets the throughput capacity of an Amazon FSx file system,
             *   measured in megabytes per second (MB/s), in 2 to the *n* th increments, between 2^3
             *   (8) and 2^11 (2048).
             *
             ...
             *   `D` is the day of the week, for which 1 represents Monday and 7 represents Sunday.
             *   For further details, see
             *   [the ISO-8601 spec as described on Wikipedia](https://docs.aws.amazon.com/https://en.wikipedia.org/wiki/ISO_week_date)
             *   .
             *
             * `HH` is the zero-padded hour of the day (0-23), and `MM` is the zero-padded minute of
             * the hour.
             *
             * For example, `1:05:00` specifies maintenance at 5 AM Monday.
             */
        ...
        private class BuilderImpl : Builder {
             ...
             *   the Amazon FSx for Windows File Server file system.
             */
            override fun auditLogConfiguration(
                auditLogConfiguration: AuditLogConfigurationProperty
            ) {
                cdkBuilder.auditLogConfiguration(
                    auditLogConfiguration.let(AuditLogConfigurationProperty::unwrap)
                )
            }
             ...
             *   chosen throughput capacity.
             */
            override fun diskIopsConfiguration(
                diskIopsConfiguration: DiskIopsConfigurationProperty
            ) {
                cdkBuilder.diskIopsConfiguration(
                    diskIopsConfiguration.let(DiskIopsConfigurationProperty::unwrap)
                )
            }
             ...
             *   .
             */
            override fun selfManagedActiveDirectoryConfiguration(
                selfManagedActiveDirectoryConfiguration: IResolvable
            ) {
                cdkBuilder.selfManagedActiveDirectoryConfiguration(
                    selfManagedActiveDirectoryConfiguration.let(IResolvable::unwrap)
                )
            }
            ...
            override fun selfManagedActiveDirectoryConfiguration(
                ...
                cdkBuilder.selfManagedActiveDirectoryConfiguration(
                    selfManagedActiveDirectoryConfiguration.let(
                        SelfManagedActiveDirectoryConfigurationProperty::unwrap
                    )
                )
            }
        ...
        internal constructor(
             ...
             * FSx file system.
             *
             * Aliases allow you to use existing DNS names to access the data in your Amazon FSx
             * file system. You can associate up to 50 aliases with a file system at any time.
             *
             * For more information, see
             * [Working with DNS Aliases](https://docs.aws.amazon.com/fsx/latest/WindowsGuide/managing-dns-aliases.html)
             * and
             ...
             *
             * `HH` is the zero-padded hour of the day (0-23), and `MM` is the zero-padded minute of
             * the hour. For example, `05:00` specifies 5 AM daily.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-fsx-filesystem-windowsconfiguration.html#cfn-fsx-filesystem-windowsconfiguration-dailyautomaticbackupstarttime)
             */
             ...
             * Windows file system.
             *
             * By default, Amazon FSx automatically provisions 3 IOPS per GiB of storage capacity.
             * You can provision additional IOPS per GiB of storage, up to the maximum limit
             ...
             * For in- AWS applications, we recommend that you launch your clients in the same
             * availability zone as your preferred file server to reduce cross-availability zone
             * data transfer costs and minimize latency.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-fsx-filesystem-windowsconfiguration.html#cfn-fsx-filesystem-windowsconfiguration-preferredsubnetid)
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: WindowsConfigurationProperty
            ): software.amazon.awscdk.services.fsx.CfnFileSystem.WindowsConfigurationProperty =
    ...
    public interface LustreConfigurationProperty {
         ...
         * * `NEW` - AutoImport is on. Amazon FSx automatically imports directory listings of any
         *   new objects added to the linked S3 bucket that do not currently exist in the FSx file
         *   system.
         ...
         *   directory listings of any new objects added to the S3 bucket, any existing objects that
         *   are changed in the S3 bucket, and any objects that were deleted in the S3 bucket.
         *
         * For more information, see
         ...
         * .
         *
         * This parameter is not supported for Lustre file systems with a data repository
         * association.
         *
         ...
         * offers higher `PerUnitStorageThroughput` (up to 1000 MB/s/TiB). `PERSISTENT_2` is
         * available in a limited number of AWS Regions . For more information, and an up-to-date
         ...
         * automatic encryption in the AWS Regions where they are available. For more information
         * about encryption in transit for FSx for Lustre file systems, see
         ...
         * storage devices.
         *
         * This parameter is required when storage type is HDD. Set this property to `READ` to
         * improve the performance for frequently accessed files by caching up to 20% of the total
         ...
         *
         * The path must use the same Amazon S3 bucket as specified in ImportPath. You can provide
         * an optional prefix to which new and changed data is to be exported from your Amazon FSx
         * for Lustre file system. If an `ExportPath` value is not provided, Amazon FSx sets a
         * default export path, `s3://import-bucket/FSxLustre[creation-timestamp]` . The timestamp
         ...
         * `ImportPath` . If you specify only a bucket name, such as `s3://import-bucket` , you get
         * a 1:1 mapping of file system objects to S3 bucket objects. This mapping means that the
         ...
         * prefix after the Amazon S3 bucket name, only object keys with that prefix are loaded into
         * the file system.
         *
         * This parameter is not supported for Lustre file systems with a data repository
         * association.
        ...
        /**
         * Required with `PERSISTENT_1` and `PERSISTENT_2` deployment types, provisions the amount
         * of read and write throughput for each 1 tebibyte (TiB) of file system storage capacity,
         * in MB/s/TiB.
         *
         ...
         * provisioning 50 MB/s/TiB of `PerUnitStorageThroughput` yields 120 MB/s of ﬁle system
        ...
        public interface Builder {
             ...
             *   objects appear as file and directory listings. Use this property to choose how
             *   Amazon FSx keeps your file and directory listings up to date as you add or modify
             *   objects in your linked S3 bucket. `AutoImportPolicy` can have the following values:
             * * `NONE` - (Default) AutoImport is off. Amazon FSx only updates file and directory
             *   listings from the linked S3 bucket when the file system is created. FSx does not
             *   update file and directory listings for any new or changed objects after choosing
             *   this option.
             ...
             * * `NEW_CHANGED_DELETED` - AutoImport is on. Amazon FSx automatically imports file and
             *   directory listings of any new objects added to the S3 bucket, any existing objects
             *   that are changed in the S3 bucket, and any objects that were deleted in the S3
             *   bucket.
             *
             * For more information, see
             * [Automatically import updates from your S3 bucket](https://docs.aws.amazon.com/fsx/latest/LustreGuide/autoimport-data-repo.html)
            ...
            /**
             * @param copyTagsToBackups (Optional) Not available for use with file systems that are
             *   linked to a data repository. A boolean flag indicating whether tags for the file
             *   system should be copied to backups. The default value is false. If
             *   `CopyTagsToBackups` is set to true, all file system tags are copied to all
             *   automatic and user-initiated backups when the user doesn't specify any
             *   backup-specific tags. If `CopyTagsToBackups` is set to true and you specify one or
             *   more backup tags, only the specified tags are copied to backups. If you specify one
            ...
            /**
             * @param dataCompressionType Sets the data compression configuration for the file
             *   system. `DataCompressionType` can have the following values:.
             * * `NONE` - (Default) Data compression is turned off when the file system is created.
             * * `LZ4` - Data compression is turned on with the LZ4 algorithm.
             *
             * For more information, see
            ...
            /**
             * @param deploymentType (Optional) Choose `SCRATCH_1` and `SCRATCH_2` deployment types
             ...
             * that aren’t latency-sensitive. `PERSISTENT_1` supports encryption of data in transit,
             * and is available in all AWS Regions in which FSx for Lustre is available.
             *
             ...
             * `PERSISTENT_2` is available in a limited number of AWS Regions . For more
             * information, and an up-to-date list of AWS Regions in which `PERSISTENT_2` is
             * available, see
             * [File system deployment options for FSx for Lustre](https://docs.aws.amazon.com/fsx/latest/LustreGuide/using-fsx-lustre.html#lustre-deployment-types)
             * in the *Amazon FSx for Lustre User Guide* .
             *
             ...
             * support automatic encryption in the AWS Regions where they are available. For more
            ...
            /**
             * @param driveCacheType The type of drive cache used by `PERSISTENT_1` file systems
             *   that are provisioned with HDD storage devices. This parameter is required when
             *   storage type is HDD. Set this property to `READ` to improve the performance for
             *   frequently accessed files by caching up to 20% of the total storage capacity of the
             *   file system.
             *
             * This parameter is required when `StorageType` is set to `HDD` and `DeploymentType` is
             * `PERSISTENT_1` .
            ...
            /**
             * @param exportPath (Optional) Specifies the path in the Amazon S3 bucket where the
             *   root of your Amazon FSx file system is exported. The path must use the same Amazon
             *   S3 bucket as specified in ImportPath. You can provide an optional prefix to which
             *   new and changed data is to be exported from your Amazon FSx for Lustre file system.
             *   If an `ExportPath` value is not provided, Amazon FSx sets a default export path,
             ...
             * get a 1:1 mapping of file system objects to S3 bucket objects. This mapping means
             * that the input data in S3 is overwritten on export. If you provide a custom prefix in
             * the export path, such as `s3://import-bucket/[custom-optional-prefix]` , Amazon FSx
             ...
             *   prefix) that you're using as the data repository for your Amazon FSx for Lustre
             *   file system. The root of your FSx for Lustre file system will be mapped to the root
            ...
            /**
             * @param importedFileChunkSize (Optional) For files imported from a data repository,
             *   this value determines the stripe count and maximum amount of data per file (in MiB)
             *   stored on a single physical disk. The maximum number of disks that a single file
             *   can be striped across is limited by the total number of disks that make up the file
             *   system.
             *
            ...
            /**
             * @param perUnitStorageThroughput Required with `PERSISTENT_1` and `PERSISTENT_2`
             *   deployment types, provisions the amount of read and write throughput for each 1
             *   tebibyte (TiB) of file system storage capacity, in MB/s/TiB. File system throughput
             *   capacity is calculated by multiplying ﬁle system storage capacity (TiB) by the
             *   `PerUnitStorageThroughput` (MB/s/TiB). For a 2.4-TiB ﬁle system, provisioning 50
             *   MB/s/TiB of `PerUnitStorageThroughput` yields 120 MB/s of ﬁle system throughput.
        ...
        internal constructor(
             ...
             *
             * Use this property to choose how Amazon FSx keeps your file and directory listings up
             * to date as you add or modify objects in your linked S3 bucket. `AutoImportPolicy` can
             * have the following values:
             * * `NONE` - (Default) AutoImport is off. Amazon FSx only updates file and directory
             *   listings from the linked S3 bucket when the file system is created. FSx does not
             *   update file and directory listings for any new or changed objects after choosing
             ...
             *
             * A boolean flag indicating whether tags for the file system should be copied to
             * backups. The default value is false. If `CopyTagsToBackups` is set to true, all file
             * system tags are copied to all automatic and user-initiated backups when the user
             * doesn't specify any backup-specific tags. If `CopyTagsToBackups` is set to true and
             * you specify one or more backup tags, only the specified tags are copied to backups.
             ...
             *
             * The `SCRATCH_2` deployment type provides in-transit encryption of data and higher
             ...
             *
             * This parameter is required when storage type is HDD. Set this property to `READ` to
             * improve the performance for frequently accessed files by caching up to 20% of the
             ...
             * FSx file system is exported.
             *
             * The path must use the same Amazon S3 bucket as specified in ImportPath. You can
             ...
             *
             * The root of your FSx for Lustre file system will be mapped to the root of the Amazon
             * S3 bucket you select. An example is `s3://import-bucket/optional-prefix` . If you
             ...
             * stripe count and maximum amount of data per file (in MiB) stored on a single physical
             * disk.
             *
             ...
             * amount of read and write throughput for each 1 tebibyte (TiB) of file system storage
             * capacity, in MB/s/TiB.
             *
             ...
             * system, provisioning 50 MB/s/TiB of `PerUnitStorageThroughput` yields 120 MB/s of ﬁle
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-fsx-filesystem-lustreconfiguration.html#cfn-fsx-filesystem-lustreconfiguration-perunitstoragethroughput)
             */
            override fun perUnitStorageThroughput(): Number? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: LustreConfigurationProperty
            ): software.amazon.awscdk.services.fsx.CfnFileSystem.LustreConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface AuditLogConfigurationProperty {
         ...
         * stream) must be in the same AWS partition, AWS Region , and AWS account as your Amazon
         * FSx file system.
         *
        ...
        public interface Builder {
            /**
             * @param auditLogDestination The Amazon Resource Name (ARN) for the destination of the
             *   audit logs. The destination can be any Amazon CloudWatch Logs log group ARN or
            ...
            /**
             * @param fileAccessAuditLogLevel Sets which attempt type is logged by Amazon FSx for
             *   file and folder accesses.
             * * `SUCCESS_ONLY` - only successful attempts to access files or folders are logged.
             * * `FAILURE_ONLY` - only failed attempts to access files or folders are logged.
            ...
            /**
             * @param fileShareAccessAuditLogLevel Sets which attempt type is logged by Amazon FSx
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-fsx-filesystem-auditlogconfiguration.html#cfn-fsx-filesystem-auditlogconfiguration-fileaccessauditloglevel)
             */
            override fun fileAccessAuditLogLevel(): String =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AuditLogConfigurationProperty
            ): software.amazon.awscdk.services.fsx.CfnFileSystem.AuditLogConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ClientConfigurationsProperty {
         ...
         * address ( `192.0.2.0/24` ). By default, Amazon FSx uses the wildcard character when
         ...
         *   configuration, you won't be able to see or access snapshots in your file system's
         *   snapshot directory.
        ...
        public interface Builder {
            /**
             * @param clients A value that specifies who can mount the file system. You can provide
             *   a wildcard character ( `*` ), an IP address ( `0.0.0.0` ), or a CIDR address (
            ...
            /**
             * @param options The options to use when mounting the file system. For a list of
             ...
             * * `sync` is used by default. If you instead specify `async` , the system acknowledges
             *   writes before writing to disk. If the system crashes before the writes are
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ClientConfigurationsProperty
            ): software.amazon.awscdk.services.fsx.CfnFileSystem.ClientConfigurationsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface OntapConfigurationProperty {
         ...
         * from the 198.19.* range. By default in the Amazon FSx console, Amazon FSx chooses the
         * last 64 IP addresses from the VPC’s primary CIDR range to use as the endpoint IP address
         * range for the file system. You can have overlapping endpoint IP addresses for file
         * systems deployed in the same VPC/route tables, as long as they don't overlap with any
         * subnet.
         *
         ...
         * scale-out file system are powered by up to six HA pairs. The value of this property
         ...
         *
         * You should specify all virtual private cloud (VPC) route tables associated with the
        ...
        public interface Builder {
            ...
            /**
             * @param deploymentType Specifies the FSx for ONTAP file system deployment type to use
             *   in creating the file system.
             * * `MULTI_AZ_1` - (Default) A high availability file system configured for Multi-AZ
             *   redundancy to tolerate temporary Availability Zone (AZ) unavailability.
             * * `SINGLE_AZ_1` - A file system configured for Single-AZ redundancy.
             * * `SINGLE_AZ_2` - A file system configured with multiple high-availability (HA) pairs
            ...
            /**
             * @param diskIopsConfiguration The SSD IOPS configuration for the FSx for ONTAP file
             *   system.
             */
            public fun diskIopsConfiguration(diskIopsConfiguration: IResolvable)
            ...
            /**
             * @param endpointIpAddressRange (Multi-AZ only) Specifies the IP address range in which
             *   the endpoints to access your file system will be created. By default in the Amazon
             *   FSx API, Amazon FSx selects an unused IP address range for you from the 198.19.*
             *   range. By default in the Amazon FSx console, Amazon FSx chooses the last 64 IP
             *   addresses from the VPC’s primary CIDR range to use as the endpoint IP address range
             *   for the file system. You can have overlapping endpoint IP addresses for file
             *   systems deployed in the same VPC/route tables, as long as they don't overlap with
             *   any subnet.
             */
            public fun endpointIpAddressRange(endpointIpAddressRange: String)

            /**
             * @param fsxAdminPassword The ONTAP administrative password for the `fsxadmin` user
             *   with which you administer your file system using the NetApp ONTAP CLI and REST API.
             */
            public fun fsxAdminPassword(fsxAdminPassword: String)

            /**
             * @param haPairs Specifies how many high-availability (HA) pairs of file servers will
             *   power your file system. Scale-up file systems are powered by 1 HA pair. The default
             *   value is 1. FSx for ONTAP scale-out file system are powered by up to six HA pairs.
            ...
            /**
             * @param routeTableIds (Multi-AZ only) Specifies the route tables in which Amazon FSx
             *   creates the rules for routing traffic to the correct file server. You should
             *   specify all virtual private cloud (VPC) route tables associated with the subnets in
             *   which your clients are located. By default, Amazon FSx selects your VPC's default
             *   route table.
             *
             * Amazon FSx manages these route tables for Multi-AZ file systems using tag-based
             * authentication. These route tables are tagged with `Key: AmazonFSx; Value:
            ...
            /**
             * @param throughputCapacity Sets the throughput capacity for the file system that
             *   you're creating in megabytes per second (MBps). For more information, see
             *   [Managing throughput capacity](https://docs.aws.amazon.com/fsx/latest/ONTAPGuide/managing-throughput-capacity.html)
             *   in the FSx for ONTAP User Guide.
             *
             * Amazon FSx responds with an HTTP status code 400 (Bad Request) for the following
             ...
             *   rather than the total throughput for the file system. You can define either the
             *   `ThroughputCapacityPerHAPair` or the `ThroughputCapacity` when creating a file
             *   system, but not both.
             *
             * This field and `ThroughputCapacity` are the same for scale-up file systems powered by
             * one HA pair.
        ...
        internal constructor(
             ...
             *
             * By default in the Amazon FSx API, Amazon FSx selects an unused IP address range for
             * you from the 198.19.* range. By default in the Amazon FSx console, Amazon FSx chooses
             * the last 64 IP addresses from the VPC’s primary CIDR range to use as the endpoint IP
             * address range for the file system. You can have overlapping endpoint IP addresses for
             * file systems deployed in the same VPC/route tables, as long as they don't overlap
             * with any subnet.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-fsx-filesystem-ontapconfiguration.html#cfn-fsx-filesystem-ontapconfiguration-endpointipaddressrange)
             */
            override fun endpointIpAddressRange(): String? =
             ...
             * Scale-up file systems are powered by 1 HA pair. The default value is 1. FSx for ONTAP
             * scale-out file system are powered by up to six HA pairs. The value of this property
             * affects the values of `StorageCapacity` , `Iops` , and `ThroughputCapacity` . For
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-fsx-filesystem-ontapconfiguration.html#cfn-fsx-filesystem-ontapconfiguration-routetableids)
             */
            override fun routeTableIds(): List<String> =
                unwrap(this).getRouteTableIds() ?: emptyList()
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: OntapConfigurationProperty
            ): software.amazon.awscdk.services.fsx.CfnFileSystem.OntapConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface NfsExportsProperty {
        ...
        public interface Builder {
            /**
             * @param clientConfigurations A list of configuration objects that contain the client
    ...
    public interface OpenZFSConfigurationProperty {
         ...
         *
         * Single AZ deployment types are configured for redundancy within a single Availability
         * Zone in an AWS Region . Valid values are the following:
         ...
         *   `Multi_AZ_1` is available only in the US East (N. Virginia), US East (Ohio), US West
         *   (Oregon), Asia Pacific (Singapore), Asia Pacific (Tokyo), and Europe (Ireland) AWS
         *   Regions .
         * * `SINGLE_AZ_1` - Creates file systems with throughput capacities of 64 - 4,096 MB/s.
         *   `Single_AZ_1` is available in all AWS Regions where Amazon FSx for OpenZFS is
         *   available.
         * * `SINGLE_AZ_2` - Creates file systems with throughput capacities of 160 - 10,240 MB/s
         *   using an NVMe L2ARC cache. `Single_AZ_2` is available only in the US East (N.
         *   Virginia), US East (Ohio), US West (Oregon), Asia Pacific (Singapore), Asia Pacific
         *   (Tokyo), and Europe (Ireland) AWS Regions .
         *
         * For more information, see
         ...
         *
         * By default, Amazon FSx automatically provisions 3 IOPS per GB of storage capacity. You
         * can provision additional IOPS per GB of storage. The configuration consists of the total
         * number of provisioned SSD IOPS and how it is was provisioned, or the mode (by the
        ...
        public interface Builder {
             ...
             *   should be copied to backups. This value defaults to `false` . If it's set to `true`
             *   , all tags for the file system are copied to all automatic and user-initiated
             *   backups where the user doesn't specify tags. If this value is `true` , and you
             *   specify one or more tags, only the specified tags are copied to backups. If you
             *   specify one or more tags when creating a user-initiated backup, no tags are copied
             ...
             *   should be copied to volumes. This value defaults to `false` . If it's set to `true`
             *   , all tags for the file system are copied to volumes where the user doesn't specify
             *   tags. If this value is `true` , and you specify one or more tags, only the
             *   specified tags are copied to volumes. If you specify one or more tags when creating
            ...
            /**
             * @param deploymentType Specifies the file system deployment type. Single AZ deployment
             *   types are configured for redundancy within a single Availability Zone in an AWS
             *   Region . Valid values are the following:
             * * `MULTI_AZ_1` - Creates file systems with high availability that are configured for
             *   Multi-AZ redundancy to tolerate temporary unavailability in Availability Zones
             *   (AZs). `Multi_AZ_1` is available only in the US East (N. Virginia), US East (Ohio),
             *   US West (Oregon), Asia Pacific (Singapore), Asia Pacific (Tokyo), and Europe
             *   (Ireland) AWS Regions .
             * * `SINGLE_AZ_1` - Creates file systems with throughput capacities of 64 - 4,096 MB/s.
             *   `Single_AZ_1` is available in all AWS Regions where Amazon FSx for OpenZFS is
             *   available.
             * * `SINGLE_AZ_2` - Creates file systems with throughput capacities of 160 - 10,240
             *   MB/s using an NVMe L2ARC cache. `Single_AZ_2` is available only in the US East (N.
             *   Virginia), US East (Ohio), US West (Oregon), Asia Pacific (Singapore), Asia Pacific
             *   (Tokyo), and Europe (Ireland) AWS Regions .
             *
             * For more information, see
            ...
            /**
             * @param diskIopsConfiguration The SSD IOPS (input/output operations per second)
             *   configuration for an Amazon FSx for NetApp ONTAP, Amazon FSx for Windows File
             *   Server, or FSx for OpenZFS file system. By default, Amazon FSx automatically
             *   provisions 3 IOPS per GB of storage capacity. You can provision additional IOPS per
             *   GB of storage. The configuration consists of the total number of provisioned SSD
             ...
             * @param endpointIpAddressRange (Multi-AZ only) Specifies the IP address range in which
             *   the endpoints to access your file system will be created. By default in the Amazon
             *   FSx API and Amazon FSx console, Amazon FSx selects an available /28 IP address
            ...
            /**
             * @param options To delete a file system if there are child volumes present below the
             *   root volume, use the string `DELETE_CHILD_VOLUMES_AND_SNAPSHOTS` . If your file
             *   system has child volumes and you don't use this option, the delete request will
             *   fail.
             */
            public fun options(options: List<String>)
            ...
            /**
             * @param rootVolumeConfiguration The configuration Amazon FSx uses when creating the
             *   root value of the Amazon FSx for OpenZFS file system. All volumes are children of
             *   the root volume.
             */
            ...
            public fun rootVolumeConfiguration(
                rootVolumeConfiguration: RootVolumeConfigurationProperty.Builder.() -> Unit
            )
             ...
             *   system, measured in megabytes per second (MBps). Valid values depend on the
             ...
             * * For `SINGLE_AZ_1` , valid values are 64, 128, 256, 512, 1024, 2048, 3072, or 4096
             *   MBps.
             *
             * You pay for additional throughput capacity that you provision.
             */
        ...
        private class BuilderImpl : Builder {
             ...
             *   the root volume.
             */
            override fun rootVolumeConfiguration(
                rootVolumeConfiguration: RootVolumeConfigurationProperty
            ) {
                cdkBuilder.rootVolumeConfiguration(
                    rootVolumeConfiguration.let(RootVolumeConfigurationProperty::unwrap)
                )
            }
            ...
            override fun rootVolumeConfiguration(
                ...
                rootVolumeConfiguration(RootVolumeConfigurationProperty(rootVolumeConfiguration))
        ...
        internal constructor(
             ...
             * are copied to all automatic and user-initiated backups where the user doesn't specify
             * tags. If this value is `true` , and you specify one or more tags, only the specified
             * tags are copied to backups. If you specify one or more tags when creating a
             * user-initiated backup, no tags are copied from the file system, regardless of this
             * value.
             ...
             *
             * This value defaults to `false` . If it's set to `true` , all tags for the file system
             * are copied to volumes where the user doesn't specify tags. If this value is `true` ,
             * and you specify one or more tags, only the specified tags are copied to volumes. If
             * you specify one or more tags when creating the volume, no tags are copied from the
             * file system, regardless of this value.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-fsx-filesystem-openzfsconfiguration.html#cfn-fsx-filesystem-openzfsconfiguration-copytagstovolumes)
             */
             ...
             * file system will be created.
             *
             * By default in the Amazon FSx API and Amazon FSx console, Amazon FSx selects an
             * available /28 IP address range for you from one of the VPC's CIDR ranges. You can
             * have overlapping endpoint IP addresses for file systems deployed in the same
             * VPC/route tables.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-fsx-filesystem-openzfsconfiguration.html#cfn-fsx-filesystem-openzfsconfiguration-endpointipaddressrange)
             */
            ...
            /**
             * To delete a file system if there are child volumes present below the root volume, use
             * the string `DELETE_CHILD_VOLUMES_AND_SNAPSHOTS` .
             *
             * If your file system has child volumes and you don't use this option, the delete
             * request will fail.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-fsx-filesystem-openzfsconfiguration.html#cfn-fsx-filesystem-openzfsconfiguration-options)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: OpenZFSConfigurationProperty
            ): software.amazon.awscdk.services.fsx.CfnFileSystem.OpenZFSConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface RootVolumeConfigurationProperty {
         ...
         * the volume.
         *
         * This value defaults to `false` . If it's set to `true` , all tags for the volume are
         * copied to snapshots where the user doesn't specify tags. If this value is `true` and you
         * specify one or more tags, only the specified tags are copied to snapshots. If you specify
         * one or more tags when creating the snapshot, no tags are copied from the volume,
         * regardless of this value.
         *
         ...
         *   to Z-Standard, LZ4 is less compute-intensive and delivers higher write throughput
         *   speeds.
         *
         ...
         *
         * Setting this value to `true` can be useful after you have completed changes to a volume
         ...
         *
         * Valid values are 4, 8, 16, 32, 64, 128, 256, 512, or 1024 KiB. The default is 128 KiB.
         * Most workloads should use the default record size. Database workflows can benefit from a
         * smaller record size, while streaming workflows can benefit from a larger record size. For
        ...
        public interface Builder {
            /**
             * @param copyTagsToSnapshots A Boolean value indicating whether tags for the volume
             *   should be copied to snapshots of the volume. This value defaults to `false` . If
             *   it's set to `true` , all tags for the volume are copied to snapshots where the user
             *   doesn't specify tags. If this value is `true` and you specify one or more tags,
             *   only the specified tags are copied to snapshots. If you specify one or more tags
             *   when creating the snapshot, no tags are copied from the volume, regardless of this
             *   value.
             */
            ...
            /**
             * @param dataCompressionType Specifies the method used to compress the data on the
             *   volume. The compression type is `NONE` by default.
             * * `NONE` - Doesn't compress the data on the volume. `NONE` is the default.
             * * `ZSTD` - Compresses the data in the volume using the Zstandard (ZSTD) compression
             *   algorithm. Compared to LZ4, Z-Standard provides a better compression ratio to
            ...
            /**
             * @param readOnly A Boolean value indicating whether the volume is read-only. Setting
             *   this value to `true` can be useful after you have completed changes to a volume and
            ...
            /**
             * @param recordSizeKiB Specifies the record size of an OpenZFS root volume, in
             *   kibibytes (KiB). Valid values are 4, 8, 16, 32, 64, 128, 256, 512, or 1024 KiB. The
             *   default is 128 KiB. Most workloads should use the default record size. Database
             *   workflows can benefit from a smaller record size, while streaming workflows can
             *   benefit from a larger record size. For additional guidance on setting a custom
             *   record size, see
             *   [Tips for maximizing performance](https://docs.aws.amazon.com/fsx/latest/OpenZFSGuide/performance.html#performance-tips-zfs)
             *   in the *Amazon FSx for OpenZFS User Guide* .
             */
            ...
            /**
             * @param userAndGroupQuotas An object specifying how much storage users or groups can
             *   use on the volume.
             */
        ...
        internal constructor(
             ...
             *
             * This value defaults to `false` . If it's set to `true` , all tags for the volume are
             * copied to snapshots where the user doesn't specify tags. If this value is `true` and
             * you specify one or more tags, only the specified tags are copied to snapshots. If you
             ...
             * A Boolean value indicating whether the volume is read-only.
             *
             * Setting this value to `true` can be useful after you have completed changes to a
             ...
             * KiB. Most workloads should use the default record size. Database workflows can
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RootVolumeConfigurationProperty
            ): software.amazon.awscdk.services.fsx.CfnFileSystem.RootVolumeConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DiskIopsConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param iops The total number of SSD IOPS provisioned for the file system. The minimum
             *   and maximum values for this property depend on the value of `HAPairs` and
            ...
            /**
             * @param mode Specifies whether the file system is using the `AUTOMATIC` setting of SSD
        ...
        internal constructor(
            ...
            /**
             * Specifies whether the file system is using the `AUTOMATIC` setting of SSD IOPS of 3
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DiskIopsConfigurationProperty
            ): software.amazon.awscdk.services.fsx.CfnFileSystem.DiskIopsConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface UserAndGroupQuotasProperty {
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-fsx-filesystem-userandgroupquotas.html#cfn-fsx-filesystem-userandgroupquotas-storagecapacityquotagib)
             */
            override fun storageCapacityQuotaGiB(): Number? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: UserAndGroupQuotasProperty
            ): software.amazon.awscdk.services.fsx.CfnFileSystem.UserAndGroupQuotasProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SelfManagedActiveDirectoryConfigurationProperty {
         ...
         * using the FSx Remote PowerShell. The group that you specify must already exist in your
         * domain. If you don't provide one, your AD domain's Domain Admins group is used.
         *
         ...
         * use to join to your AD domain.
         *
         * This account must have the permission to join computers to the domain in the
         * organizational unit provided in `OrganizationalUnitDistinguishedName` , or in the default
        ...
        public interface Builder {
            /**
             * @param dnsIps A list of up to three IP addresses of DNS servers or domain controllers
            ...
            /**
             * @param fileSystemAdministratorsGroup (Optional) The name of the domain group whose
             *   members are granted administrative privileges for the file system. Administrative
             *   privileges include taking ownership of files and folders, setting audit controls
             *   (audit ACLs) on files and folders, and administering the file system remotely by
             *   using the FSx Remote PowerShell. The group that you specify must already exist in
             *   your domain. If you don't provide one, your AD domain's Domain Admins group is
             *   used.
             */
            public fun fileSystemAdministratorsGroup(fileSystemAdministratorsGroup: String)

            /**
             * @param organizationalUnitDistinguishedName (Optional) The fully qualified
             *   distinguished name of the organizational unit within your self-managed AD
             *   directory. Amazon FSx only accepts OU as the direct parent of the file system. An
             *   example is `OU=FSx,DC=yourdomain,DC=corp,DC=com` . To learn more, see
             *   [RFC 2253](https://docs.aws.amazon.com/https://tools.ietf.org/html/rfc2253) . If
             *   none is provided, the FSx file system is created in the default location of your
             *   self-managed AD directory.
             *
             * Only Organizational Unit (OU) objects can be the direct parent of the file system
             * that you're creating.
             */
            public fun organizationalUnitDistinguishedName(
                organizationalUnitDistinguishedName: String
            )

            /**
             * @param password The password for the service account on your self-managed AD domain
             *   that Amazon FSx will use to join to your AD domain.
             */
            public fun password(password: String)

            /**
             * @param userName The user name for the service account on your self-managed AD domain
             *   that Amazon FSx will use to join to your AD domain. This account must have the
             *   permission to join computers to the domain in the organizational unit provided in
        ...
        private class BuilderImpl : Builder {
             ...
             * that you're creating.
             */
            override fun organizationalUnitDistinguishedName(
                organizationalUnitDistinguishedName: String
            ) {
        ...
        internal constructor(
             ...
             * privileges for the file system.
             *
             * Administrative privileges include taking ownership of files and folders, setting
             * audit controls (audit ACLs) on files and folders, and administering the file system
             * remotely by using the FSx Remote PowerShell. The group that you specify must already
             * exist in your domain. If you don't provide one, your AD domain's Domain Admins group
             * is used.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-fsx-filesystem-selfmanagedactivedirectoryconfiguration.html#cfn-fsx-filesystem-selfmanagedactivedirectoryconfiguration-filesystemadministratorsgroup)
             */
             ...
             * your self-managed AD directory.
             *
             * Amazon FSx only accepts OU as the direct parent of the file system. An example is
             * `OU=FSx,DC=yourdomain,DC=corp,DC=com` . To learn more, see
             * [RFC 2253](https://docs.aws.amazon.com/https://tools.ietf.org/html/rfc2253) . If none
             ...
             *
             * This account must have the permission to join computers to the domain in the
             * organizational unit provided in `OrganizationalUnitDistinguishedName` , or in the
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SelfManagedActiveDirectoryConfigurationProperty
            ): software.amazon.awscdk.services.fsx.CfnFileSystem.SelfManagedActiveDirectoryConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
