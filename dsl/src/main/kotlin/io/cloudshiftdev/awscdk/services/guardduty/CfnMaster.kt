...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param masterId The AWS account ID of the account designated as the GuardDuty
    ...
    public companion object {
        ...
        ): CfnMaster = CfnMaster(cdkObject)

        internal fun unwrap(
            wrapped: CfnMaster
        ): software.amazon.awscdk.services.guardduty.CfnMaster = wrapped.cdkObject
    }
}
