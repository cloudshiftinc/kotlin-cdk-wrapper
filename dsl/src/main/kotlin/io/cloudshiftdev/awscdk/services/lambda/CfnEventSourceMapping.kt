...
internal constructor(
     ...
     * event source.
     */
    public open fun amazonManagedKafkaEventSourceConfig(
        `value`: AmazonManagedKafkaEventSourceConfigProperty
    ) {
        unwrap(this)
            .setAmazonManagedKafkaEventSourceConfig(
                `value`.let(AmazonManagedKafkaEventSourceConfigProperty::unwrap)
            )
    }
    ...
    public open fun amazonManagedKafkaEventSourceConfig(
        `value`: AmazonManagedKafkaEventSourceConfigProperty.Builder.() -> Unit
    ): Unit =
     ...
     * and retry.
     */
    public open fun bisectBatchOnFunctionError(): Any? =
    ...
    public open fun documentDbEventSourceConfig(`value`: DocumentDBEventSourceConfigProperty) {
        unwrap(this)
            .setDocumentDbEventSourceConfig(
                `value`.let(DocumentDBEventSourceConfigProperty::unwrap)
            )
    }
    ...
    public open fun documentDbEventSourceConfig(
        `value`: DocumentDBEventSourceConfigProperty.Builder.() -> Unit
     ...
     */
    public open fun functionResponseTypes(): List<String> =
    ...
    public open fun maximumRecordAgeInSeconds(): Number? =
    ...
    public open fun selfManagedEventSource(
        `value`: SelfManagedEventSourceProperty.Builder.() -> Unit
    ): Unit = selfManagedEventSource(SelfManagedEventSourceProperty(`value`))
    ...
    /** Specific configuration settings for a self-managed Apache Kafka event source. */
    public open fun selfManagedKafkaEventSourceConfig(
        `value`: SelfManagedKafkaEventSourceConfigProperty
    ) {
        unwrap(this)
            .setSelfManagedKafkaEventSourceConfig(
                `value`.let(SelfManagedKafkaEventSourceConfigProperty::unwrap)
            )
    }
    ...
    public open fun selfManagedKafkaEventSourceConfig(
        `value`: SelfManagedKafkaEventSourceConfigProperty.Builder.() -> Unit
     ...
     * your event source.
     */
    public open fun sourceAccessConfigurations(): Any? =
        unwrap(this).getSourceAccessConfigurations()
     ...
     * time seconds.
     */
    public open fun startingPositionTimestamp(): Number? =
    ...
    public interface Builder {
        ...
        /**
         * (Kinesis and DynamoDB Streams only) If the function returns an error, split the batch in
         * two and retry.
         *
         ...
         *
         * @param bisectBatchOnFunctionError (Kinesis and DynamoDB Streams only) If the function
        ...
        /**
         * (Kinesis, DynamoDB Streams, Amazon MSK, and self-managed Apache Kafka event sources only)
         ...
         *   Kafka event sources only) A configuration object that specifies the destination of an
        ...
        public fun documentDbEventSourceConfig(
            documentDbEventSourceConfig: DocumentDBEventSourceConfigProperty.Builder.() -> Unit
        )
        ...
        /**
         * (Streams and SQS) A list of current response type enums applied to the event source
         * mapping.
         *
         ...
         *
         * @param functionResponseTypes (Streams and SQS) A list of current response type enums
         ...
         *
         * *Related setting:* For Amazon SQS event sources, when you set `BatchSize` to a value
         ...
         * MaximumRetryAttempts is infinite, Lambda retries failed records until the record expires
         * in the event source.
         *
         ...
         *
         * @param selfManagedEventSource The self-managed Apache Kafka cluster for your event
         *   source.
         */
        ...
        public fun selfManagedEventSource(
            selfManagedEventSource: SelfManagedEventSourceProperty.Builder.() -> Unit
        )
         ...
         *
         * @param selfManagedKafkaEventSourceConfig Specific configuration settings for a
        ...
        public fun selfManagedKafkaEventSourceConfig(
            selfManagedKafkaEventSourceConfig:
                SelfManagedKafkaEventSourceConfigProperty.Builder.() -> Unit
        )

        /**
         * An array of the authentication protocol, VPC components, or virtual host to secure and
         ...
         *
         * @param sourceAccessConfigurations An array of the authentication protocol, VPC
         *   components, or virtual host to secure and define your event source.
         */
         ...
         *
         * @param startingPosition The position in a stream from which to start reading. Required
         ...
         *
         * @param tumblingWindowInSeconds (Kinesis and DynamoDB Streams only) The duration in
         *   seconds of a processing window for DynamoDB and Kinesis Streams event sources.
         */
    ...
    private class BuilderImpl(
         ...
         *   Managed Streaming for Apache Kafka (Amazon MSK) event source.
         */
        override fun amazonManagedKafkaEventSourceConfig(
            amazonManagedKafkaEventSourceConfig: IResolvable
        ) {
            cdkBuilder.amazonManagedKafkaEventSourceConfig(
                amazonManagedKafkaEventSourceConfig.let(IResolvable::unwrap)
            )
        }
        ...
        override fun amazonManagedKafkaEventSourceConfig(
            ...
            cdkBuilder.amazonManagedKafkaEventSourceConfig(
                amazonManagedKafkaEventSourceConfig.let(
                    AmazonManagedKafkaEventSourceConfigProperty::unwrap
                )
            )
        }
        ...
        override fun amazonManagedKafkaEventSourceConfig(
            ...
            amazonManagedKafkaEventSourceConfig(
                AmazonManagedKafkaEventSourceConfigProperty(amazonManagedKafkaEventSourceConfig)
            )
        ...
        override fun documentDbEventSourceConfig(documentDbEventSourceConfig: IResolvable) {
            cdkBuilder.documentDbEventSourceConfig(
                documentDbEventSourceConfig.let(IResolvable::unwrap)
            )
        }
         ...
         *   source.
         */
        override fun documentDbEventSourceConfig(
            documentDbEventSourceConfig: DocumentDBEventSourceConfigProperty
        ) {
            cdkBuilder.documentDbEventSourceConfig(
                documentDbEventSourceConfig.let(DocumentDBEventSourceConfigProperty::unwrap)
            )
        }
        ...
        override fun documentDbEventSourceConfig(
            ...
            documentDbEventSourceConfig(
                DocumentDBEventSourceConfigProperty(documentDbEventSourceConfig)
            )
         ...
         *   source.
         */
        override fun selfManagedEventSource(
            selfManagedEventSource: SelfManagedEventSourceProperty
        ) {
            cdkBuilder.selfManagedEventSource(
                selfManagedEventSource.let(SelfManagedEventSourceProperty::unwrap)
            )
        }
         ...
         *   self-managed Apache Kafka event source.
         */
        override fun selfManagedKafkaEventSourceConfig(
            selfManagedKafkaEventSourceConfig: IResolvable
        ) {
            cdkBuilder.selfManagedKafkaEventSourceConfig(
                selfManagedKafkaEventSourceConfig.let(IResolvable::unwrap)
            )
        }
        ...
        override fun selfManagedKafkaEventSourceConfig(
            ...
            cdkBuilder.selfManagedKafkaEventSourceConfig(
                selfManagedKafkaEventSourceConfig.let(
                    SelfManagedKafkaEventSourceConfigProperty::unwrap
                )
            )
        }
        ...
        override fun selfManagedKafkaEventSourceConfig(
            ...
            selfManagedKafkaEventSourceConfig(
                SelfManagedKafkaEventSourceConfigProperty(selfManagedKafkaEventSourceConfig)
            )
        ...
        override fun sourceAccessConfigurations(sourceAccessConfigurations: IResolvable) {
            cdkBuilder.sourceAccessConfigurations(
                sourceAccessConfigurations.let(IResolvable::unwrap)
            )
        }
    ...
    public interface SelfManagedKafkaEventSourceConfigProperty {
        ...
        public interface Builder {
            /**
             * @param consumerGroupId The identifier for the Kafka consumer group to join. The
             *   consumer group ID must be unique among all your Kafka event sources. After creating
             *   a Kafka event source mapping with the consumer group ID specified, you cannot
             *   update this value. For more information, see
             *   [Customizable consumer group ID](https://docs.aws.amazon.com/lambda/latest/dg/with-msk.html#services-msk-consumer-group-id)
             *   .
             */
        ...
        internal constructor(
             ...
             * The identifier for the Kafka consumer group to join.
             *
             * The consumer group ID must be unique among all your Kafka event sources. After
             * creating a Kafka event source mapping with the consumer group ID specified, you
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SelfManagedKafkaEventSourceConfigProperty
            ): software.amazon.awscdk.services.lambda.CfnEventSourceMapping.SelfManagedKafkaEventSourceConfigProperty =
    ...
    public interface FilterProperty {
         ...
         * A filter pattern.
         *
         * For more information on the syntax of a filter pattern, see
        ...
        public interface Builder {
            /**
             * @param pattern A filter pattern. For more information on the syntax of a filter
             *   pattern, see
             *   [Filter rule syntax](https://docs.aws.amazon.com/lambda/latest/dg/invocation-eventfiltering.html#filtering-syntax)
             *   .
             */
    ...
    public interface SelfManagedEventSourceProperty {
        ...
        public interface Builder {
            /**
             * @param endpoints The list of bootstrap servers for your Kafka brokers in the
             *   following format: `"KafkaBootstrapServers":
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SelfManagedEventSourceProperty
            ): software.amazon.awscdk.services.lambda.CfnEventSourceMapping.SelfManagedEventSourceProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface AmazonManagedKafkaEventSourceConfigProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AmazonManagedKafkaEventSourceConfigProperty
            ): software.amazon.awscdk.services.lambda.CfnEventSourceMapping.AmazonManagedKafkaEventSourceConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface OnFailureProperty {
        ...
        public interface Builder {
            /**
             * @param destination The Amazon Resource Name (ARN) of the destination resource. To
             *   retain records of
             *   [asynchronous invocations](https://docs.aws.amazon.com/lambda/latest/dg/invocation-async.html#invocation-async-destinations)
    ...
    public interface SourceAccessConfigurationProperty {
         ...
         *   of your secret key used for SASL SCRAM-512 authentication of your self-managed Apache
         *   Kafka brokers.
         ...
         *   Manager ARN of your secret key containing the certificate chain (X.509 PEM), private
         *   key (PKCS#8 PEM), and private key password (optional) used for mutual TLS
         ...
         *   your secret key containing the root CA certificate (X.509 PEM) used for TLS encryption
        ...
        public interface Builder {
            /**
             * @param type The type of authentication protocol, VPC components, or virtual host for
             ...
             *   Lambda connects to these subnets to fetch data from your self-managed Apache Kafka
             *   cluster.
             * * `VPC_SECURITY_GROUP` – (Self-managed Apache Kafka) The VPC security group used to
             *   manage access to your self-managed Apache Kafka brokers.
             * * `SASL_SCRAM_256_AUTH` – (Self-managed Apache Kafka) The Secrets Manager ARN of your
             ...
             * * `CLIENT_CERTIFICATE_TLS_AUTH` – (Amazon MSK, self-managed Apache Kafka) The Secrets
             *   Manager ARN of your secret key containing the certificate chain (X.509 PEM),
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SourceAccessConfigurationProperty
            ): software.amazon.awscdk.services.lambda.CfnEventSourceMapping.SourceAccessConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ScalingConfigProperty {
        ...
        public interface Builder {
            /**
             * @param maximumConcurrency Limits the number of concurrent instances that the Amazon
    ...
    public interface DocumentDBEventSourceConfigProperty {
         ...
         *
         * If set to UpdateLookup, DocumentDB sends a delta describing the changes, along with a
         * copy of the entire document. Otherwise, DocumentDB sends only a partial document that
        ...
        public interface Builder {
            /**
             * @param collectionName The name of the collection to consume within the database. If
             *   you do not specify a collection, Lambda consumes all collections.
             */
            public fun collectionName(collectionName: String)

            /**
             * @param databaseName The name of the database to consume within the DocumentDB
             *   cluster.
             */
             ...
             *   document update operations. If set to UpdateLookup, DocumentDB sends a delta
             *   describing the changes, along with a copy of the entire document. Otherwise,
             *   DocumentDB sends only a partial document that contains the changes.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DocumentDBEventSourceConfigProperty
            ): software.amazon.awscdk.services.lambda.CfnEventSourceMapping.DocumentDBEventSourceConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface EndpointsProperty {
         ...
         */
        public fun kafkaBootstrapServers(): List<String> =
        ...
        public interface Builder {
            /**
             * @param kafkaBootstrapServers The list of bootstrap servers for your Kafka brokers in
             *   the following format: `"KafkaBootstrapServers":
             *   ["abc.xyz.com:xxxx","abc2.xyz.com:xxxx"]` .
             */
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-lambda-eventsourcemapping-endpoints.html#cfn-lambda-eventsourcemapping-endpoints-kafkabootstrapservers)
             */
            override fun kafkaBootstrapServers(): List<String> =
                unwrap(this).getKafkaBootstrapServers() ?: emptyList()
        }
