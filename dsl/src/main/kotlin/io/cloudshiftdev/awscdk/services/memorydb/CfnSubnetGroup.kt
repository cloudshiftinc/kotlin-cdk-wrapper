...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.memorydb.CfnSubnetGroup,
) : CfnResource(cdkObject), IInspectable, ITaggable {
    /**
     * When you pass the logical ID of this resource to the intrinsic `Ref` function, Ref returns
     * the ARN of the subnet group, such as
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.memorydb.CfnSubnetGroup =
            cdkBuilder.build()
    }
