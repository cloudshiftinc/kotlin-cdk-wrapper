...
internal constructor(
    ...
    public open fun thingTypeProperties(
        `value`: ThingTypePropertiesProperty.Builder.() -> Unit
    ): Unit = thingTypeProperties(ThingTypePropertiesProperty(`value`))
    ...
    public interface Builder {
         ...
         * searchable thing attribute names. `ThingTypeProperties` can't be updated after the
         * initial creation of the `ThingType` .
         *
        ...
        public fun thingTypeProperties(
            thingTypeProperties: ThingTypePropertiesProperty.Builder.() -> Unit
        )
    }
    ...
    private class BuilderImpl(
        ...
        override fun thingTypeProperties(thingTypeProperties: ThingTypePropertiesProperty) {
            cdkBuilder.thingTypeProperties(
                thingTypeProperties.let(ThingTypePropertiesProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("7aeaad2d462d2485cf682674aca0c5c899bf8351fd37f923fabf37f643588bce")
        override fun thingTypeProperties(
            thingTypeProperties: ThingTypePropertiesProperty.Builder.() -> Unit
    ...
    public companion object {
        ...
        ): CfnThingType = CfnThingType(cdkObject)

        internal fun unwrap(
            wrapped: CfnThingType
        ): software.amazon.awscdk.services.iot.CfnThingType = wrapped.cdkObject
    }
    ...
    public interface ThingTypePropertiesProperty {
         ...
         */
        public fun searchableAttributes(): List<String> =
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-iot-thingtype-thingtypeproperties.html#cfn-iot-thingtype-thingtypeproperties-searchableattributes)
             */
            override fun searchableAttributes(): List<String> =
                unwrap(this).getSearchableAttributes() ?: emptyList()
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ThingTypePropertiesProperty
            ): software.amazon.awscdk.services.iot.CfnThingType.ThingTypePropertiesProperty =
