...
internal constructor(
    ...
    public interface Builder {
         ...
         * The alias of instance.
         *
         * `InstanceAlias` is only required when `IdentityManagementType` is `CONNECT_MANAGED` or
         * `SAML` . `InstanceAlias` is not required when `IdentityManagementType` is
         * `EXISTING_DIRECTORY` .
         *
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnInstance
        ): software.amazon.awscdk.services.connect.CfnInstance = wrapped.cdkObject
    }
    ...
    public interface AttributesProperty {
        ...
        public interface Builder {
            /**
             * @param autoResolveBestVoices Boolean flag which enables AUTO_RESOLVE_BEST_VOICES on
             *   an instance.
             */
            ...
            /**
             * @param useCustomTtsVoices Boolean flag which enables USE_CUSTOM_TTS_VOICES on an
             *   instance.
             */
