...
public interface MethodResponse {
  public fun responseModels(): Map<String, IModel> = unwrap(this).getResponseModels()?.mapValues {
  ...
  private class BuilderImpl : Builder {
    ...
    public override fun responseModels(responseModels: Map<String, IModel>) {
      cdkBuilder.responseModels(responseModels.mapValues { IModel.unwrap(it.value)})
    }

    public override fun responseParameters(responseParameters: Map<String, Boolean>) {
  ...
  private class Wrapper internal constructor(
    ...
    public override fun responseModels(): Map<String, IModel> =
        unwrap(this).getResponseModels()?.mapValues { IModel.wrap(it.value)} ?: emptyMap()

    public override fun responseParameters(): Map<String, Boolean> =
