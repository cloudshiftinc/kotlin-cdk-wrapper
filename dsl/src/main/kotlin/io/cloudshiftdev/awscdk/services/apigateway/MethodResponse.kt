...
public interface MethodResponse {
     ...
     *
     * Specify response models as key-value pairs (string-to-string maps), with a content type as
     ...
     * as the key and a Boolean as the value. Specify the destination using the following pattern:
     ...
     * Default: None
     */
    public fun responseParameters(): Map<String, Boolean> =
    ...
    public interface Builder {
        /**
         * @param responseModels The resources used for the response's content type. Specify
         *   response models as key-value pairs (string-to-string maps), with a content type as the
         *   key and a Model resource name as the value.
         */
         ...
         *   maps), with a destination as the key and a Boolean as the value. Specify the
         *   destination using the following pattern: method.response.header.name, where the name is
         *   a valid, unique header name. The Boolean specifies whether a parameter is required.
         */
        public fun responseParameters(responseParameters: Map<String, Boolean>)

        /**
         * @param statusCode The method response's status code, which you map to an
         *   IntegrationResponse.
         *
         * Required.
         */
    ...
    internal constructor(
         ...
         * The resources used for the response's content type.
         *
         * Specify response models as key-value pairs (string-to-string maps), with a content type
         ...
         * Response parameters that API Gateway sends to the client that called a method.
         *
         * Specify response parameters as key-value pairs (string-to-Boolean maps), with a
         * destination as the key and a Boolean as the value. Specify the destination using the
         ...
         * Default: None
         */
        override fun responseParameters(): Map<String, Boolean> =
            unwrap(this).getResponseParameters() ?: emptyMap()
