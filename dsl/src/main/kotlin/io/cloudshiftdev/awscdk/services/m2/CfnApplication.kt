...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param definition The application definition for a particular application. You can
         *   specify either inline JSON or an Amazon S3 bucket location.
         */
         ...
         *
         * @param roleArn The Amazon Resource Name (ARN) of the role associated with the
         *   application.
         */
    ...
    public companion object {
        ...
        ): software.amazon.awscdk.services.m2.CfnApplication = wrapped.cdkObject
    }
    ...
    public interface DefinitionProperty {
         ...
         *
         * This is a JSON object that contains the resource configuration/definitions that identify
         * an application.
         *
        ...
        public interface Builder {
            /**
             * @param content The content of the application definition. This is a JSON object that
             *   contains the resource configuration/definitions that identify an application.
             */
        ...
        internal constructor(
             ...
             * The content of the application definition.
             *
             * This is a JSON object that contains the resource configuration/definitions that
