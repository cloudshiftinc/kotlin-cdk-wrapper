...
internal constructor(
    ...
    public interface Builder {
        ...
        /**
         * The ARN of the IAM role that allows Amazon EC2 to publish flow logs to a CloudWatch Logs
         * log group in your account.
         *
         ...
         *
         * @param logDestination The destination for the flow log data. The meaning of this
         *   parameter depends on the destination type.
         */
         ...
         * The fields to include in the flow log record, in the order in which they should appear.
         *
         * If you omit this parameter, the flow log is created using the default format. If you
         * specify this parameter, you must include at least one field. For more information about
         * the available fields, see
         ...
         *
         * @param logGroupName The name of a new or existing CloudWatch Logs log group where Amazon
    ...
    public interface DestinationOptionsProperty {
        ...
        @CdkDslMarker
        public interface Builder {
            /** @param fileFormat The format for the flow log. The default is `plain-text` . */
            public fun fileFormat(fileFormat: String)

            /**
             * @param hiveCompatiblePartitions Indicates whether to use Hive-compatible prefixes for
             *   flow logs stored in Amazon S3. The default is `false` .
             */
            ...
            /**
             * @param perHourPartition Indicates whether to partition the flow log per hour. This
             *   reduces the cost and response time for queries. The default is `false` .
             */
        ...
        private class BuilderImpl : Builder {
            ...
            override fun hiveCompatiblePartitions(hiveCompatiblePartitions: IResolvable) {
                cdkBuilder.hiveCompatiblePartitions(
                    hiveCompatiblePartitions.let(IResolvable::unwrap)
                )
            }
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ec2-flowlog-destinationoptions.html#cfn-ec2-flowlog-destinationoptions-hivecompatiblepartitions)
             */
            override fun hiveCompatiblePartitions(): Any =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DestinationOptionsProperty
            ): software.amazon.awscdk.services.ec2.CfnFlowLog.DestinationOptionsProperty =
