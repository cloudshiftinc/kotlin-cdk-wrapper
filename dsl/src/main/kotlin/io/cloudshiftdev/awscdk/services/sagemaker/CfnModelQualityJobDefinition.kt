...
internal constructor(
    ...
    public open fun modelQualityAppSpecification(`value`: ModelQualityAppSpecificationProperty) {
        unwrap(this)
            .setModelQualityAppSpecification(
                `value`.let(ModelQualityAppSpecificationProperty::unwrap)
            )
    }
    ...
    public open fun modelQualityAppSpecification(
        `value`: ModelQualityAppSpecificationProperty.Builder.() -> Unit
    ): Unit = modelQualityAppSpecification(ModelQualityAppSpecificationProperty(`value`))

    /** Specifies the constraints and baselines for the monitoring job. */
    public open fun modelQualityBaselineConfig(): Any? =
        unwrap(this).getModelQualityBaselineConfig()
    ...
    public open fun modelQualityBaselineConfig(`value`: ModelQualityBaselineConfigProperty) {
        unwrap(this)
            .setModelQualityBaselineConfig(`value`.let(ModelQualityBaselineConfigProperty::unwrap))
    }

    /** Specifies the constraints and baselines for the monitoring job. */
    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("9585b0358b2ba7da64a4675209ee59adffe066fa778a069a986637bd083e910d")
    public open fun modelQualityBaselineConfig(
        `value`: ModelQualityBaselineConfigProperty.Builder.() -> Unit
    ...
    public open fun modelQualityJobInput(
        `value`: ModelQualityJobInputProperty.Builder.() -> Unit
    ): Unit = modelQualityJobInput(ModelQualityJobInputProperty(`value`))

    /** The output configuration for monitoring jobs. */
    public open fun modelQualityJobOutputConfig(): Any =
        unwrap(this).getModelQualityJobOutputConfig()
    ...
    public open fun modelQualityJobOutputConfig(`value`: MonitoringOutputConfigProperty) {
        unwrap(this)
            .setModelQualityJobOutputConfig(`value`.let(MonitoringOutputConfigProperty::unwrap))
    }

    /** The output configuration for monitoring jobs. */
    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("8aa95ca2cda6f837962f1d231aa63cff158751d650becb089ea636345c659763")
    public open fun modelQualityJobOutputConfig(
        `value`: MonitoringOutputConfigProperty.Builder.() -> Unit
     ...
     * [io.cloudshiftdev.awscdk.services.sagemaker.CfnModelQualityJobDefinition].
     */
    @CdkDslMarker
    public interface Builder {
         ...
         *
         * @param modelQualityAppSpecification Container image configuration object for the
         *   monitoring job.
         */
         ...
         *   monitoring job.
         */
        public fun modelQualityAppSpecification(
        ...
        public fun modelQualityAppSpecification(
            modelQualityAppSpecification: ModelQualityAppSpecificationProperty.Builder.() -> Unit
        )
         ...
         *
         * @param modelQualityBaselineConfig Specifies the constraints and baselines for the
         *   monitoring job.
         */
         ...
         *   monitoring job.
         */
        public fun modelQualityBaselineConfig(
        ...
        public fun modelQualityBaselineConfig(
            modelQualityBaselineConfig: ModelQualityBaselineConfigProperty.Builder.() -> Unit
        )
        ...
        public fun modelQualityJobInput(
            modelQualityJobInput: ModelQualityJobInputProperty.Builder.() -> Unit
        )
         ...
         * @param modelQualityJobOutputConfig The output configuration for monitoring jobs.
         */
        public fun modelQualityJobOutputConfig(
        ...
        public fun modelQualityJobOutputConfig(
            modelQualityJobOutputConfig: MonitoringOutputConfigProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.sagemaker.CfnModelQualityJobDefinition.Builder.create(
                scope,
                id
            )
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("17d4558e04d008184853dbf26eba288cb406cc08b677c61828bb398018a1ef85")
        override fun jobResources(
            jobResources: MonitoringResourcesProperty.Builder.() -> Unit
        ...
        override fun modelQualityAppSpecification(modelQualityAppSpecification: IResolvable) {
            cdkBuilder.modelQualityAppSpecification(
                modelQualityAppSpecification.let(IResolvable::unwrap)
            )
        }
         ...
         *   monitoring job.
         */
        override fun modelQualityAppSpecification(
            modelQualityAppSpecification: ModelQualityAppSpecificationProperty
        ) {
            cdkBuilder.modelQualityAppSpecification(
                modelQualityAppSpecification.let(ModelQualityAppSpecificationProperty::unwrap)
            )
        }
        ...
        override fun modelQualityAppSpecification(
            ...
            modelQualityAppSpecification(
                ModelQualityAppSpecificationProperty(modelQualityAppSpecification)
            )
        ...
        override fun modelQualityBaselineConfig(modelQualityBaselineConfig: IResolvable) {
            cdkBuilder.modelQualityBaselineConfig(
                modelQualityBaselineConfig.let(IResolvable::unwrap)
            )
        }
         ...
         *   monitoring job.
         */
        override fun modelQualityBaselineConfig(
            modelQualityBaselineConfig: ModelQualityBaselineConfigProperty
        ) {
            cdkBuilder.modelQualityBaselineConfig(
                modelQualityBaselineConfig.let(ModelQualityBaselineConfigProperty::unwrap)
            )
        }
        ...
        override fun modelQualityBaselineConfig(
            ...
            modelQualityBaselineConfig(
                ModelQualityBaselineConfigProperty(modelQualityBaselineConfig)
            )
        ...
        override fun modelQualityJobInput(modelQualityJobInput: ModelQualityJobInputProperty) {
            cdkBuilder.modelQualityJobInput(
                modelQualityJobInput.let(ModelQualityJobInputProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("a75fc308bff9dc0645d582b5c98d508de23f1bfb3e137d33357cca5d0d55a1a6")
        override fun modelQualityJobInput(
            modelQualityJobInput: ModelQualityJobInputProperty.Builder.() -> Unit
        ...
        override fun modelQualityJobOutputConfig(modelQualityJobOutputConfig: IResolvable) {
            cdkBuilder.modelQualityJobOutputConfig(
                modelQualityJobOutputConfig.let(IResolvable::unwrap)
            )
        }
         ...
         * @param modelQualityJobOutputConfig The output configuration for monitoring jobs.
         */
        override fun modelQualityJobOutputConfig(
            modelQualityJobOutputConfig: MonitoringOutputConfigProperty
        ) {
            cdkBuilder.modelQualityJobOutputConfig(
                modelQualityJobOutputConfig.let(MonitoringOutputConfigProperty::unwrap)
            )
        }
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnModelQualityJobDefinition
    ...
    public interface EndpointInputProperty {
        ...
        public interface Builder {
            /**
             * @param endTimeOffset If specified, monitoring jobs substract this time from the end
             *   time. For information about using offsets for scheduling monitoring jobs, see
             *   [Schedule Model Quality Monitoring Jobs](https://docs.aws.amazon.com/sagemaker/latest/dg/model-monitor-model-quality-schedule.html)
             *   .
             */
            ...
            /**
             * @param inferenceAttribute The attribute of the input data that represents the ground
             *   truth label.
             */
            ...
            /**
             * @param probabilityAttribute In a classification problem, the attribute that
            ...
            /**
             * @param startTimeOffset If specified, monitoring jobs substract this time from the
             *   start time. For information about using offsets for scheduling monitoring jobs, see
             *   [Schedule Model Quality Monitoring Jobs](https://docs.aws.amazon.com/sagemaker/latest/dg/model-monitor-model-quality-schedule.html)
             *   .
             */
    ...
    public interface ModelQualityAppSpecificationProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param containerEntrypoint Specifies the entrypoint for a container that the
             *   monitoring job runs.
             */
            ...
            /**
             * @param environment Sets the environment variables in the container that the
             *   monitoring job runs.
             */
            ...
            /**
             * @param problemType The machine learning problem type of the model that the monitoring
             *   job monitors.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ModelQualityAppSpecificationProperty
            ): software.amazon.awscdk.services.sagemaker.CfnModelQualityJobDefinition.ModelQualityAppSpecificationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ModelQualityBaselineConfigProperty {
        ...
        public interface Builder {
            /**
             * @param baseliningJobName The name of the job that performs baselining for the
             *   monitoring job.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ModelQualityBaselineConfigProperty
            ): software.amazon.awscdk.services.sagemaker.CfnModelQualityJobDefinition.ModelQualityBaselineConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface MonitoringGroundTruthS3InputProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: MonitoringGroundTruthS3InputProperty
            ): software.amazon.awscdk.services.sagemaker.CfnModelQualityJobDefinition.MonitoringGroundTruthS3InputProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface BatchTransformInputProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param endTimeOffset If specified, monitoring jobs subtract this time from the end
             *   time. For information about using offsets for scheduling monitoring jobs, see
             *   [Schedule Model Quality Monitoring Jobs](https://docs.aws.amazon.com/sagemaker/latest/dg/model-monitor-model-quality-schedule.html)
             *   .
             */
    ...
    public interface S3OutputProperty {
        ...
        public interface Builder {
            /**
             * @param localPath The local path to the Amazon S3 storage location where Amazon
             *   SageMaker saves the results of a monitoring job. LocalPath is an absolute path for
             *   the output data.
             */
            public fun localPath(localPath: String)
            ...
            /**
             * @param s3Uri A URI that identifies the Amazon S3 storage location where Amazon
    ...
    public interface ModelQualityJobInputProperty {
        ...
        public interface Builder {
            ...
            public fun groundTruthS3Input(
                groundTruthS3Input: MonitoringGroundTruthS3InputProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            /** @param groundTruthS3Input The ground truth label provided for the model. */
            override fun groundTruthS3Input(
                groundTruthS3Input: MonitoringGroundTruthS3InputProperty
            ) {
                cdkBuilder.groundTruthS3Input(
                    groundTruthS3Input.let(MonitoringGroundTruthS3InputProperty::unwrap)
                )
            }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ModelQualityJobInputProperty
            ): software.amazon.awscdk.services.sagemaker.CfnModelQualityJobDefinition.ModelQualityJobInputProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
