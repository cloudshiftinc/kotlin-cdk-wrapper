...
internal constructor(
    ...
    public interface Builder {
        /**
         * If you would like to associate your S3 Access Grants instance with an AWS IAM Identity
         * Center instance, use this field to pass the Amazon Resource Name (ARN) of the AWS IAM
         * Identity Center instance that you are associating with your S3 Access Grants instance.
         *
         * An IAM Identity Center instance is your corporate identity directory that you added to
         ...
         *
         * @param identityCenterArn If you would like to associate your S3 Access Grants instance
         *   with an AWS IAM Identity Center instance, use this field to pass the Amazon Resource
         *   Name (ARN) of the AWS IAM Identity Center instance that you are associating with your
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnAccessGrantsInstance
