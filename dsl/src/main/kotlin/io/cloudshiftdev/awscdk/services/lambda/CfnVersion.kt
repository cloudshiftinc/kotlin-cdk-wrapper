...
internal constructor(
    ...
    public open fun provisionedConcurrencyConfig(
        `value`: ProvisionedConcurrencyConfigurationProperty
    ) {
        unwrap(this)
            .setProvisionedConcurrencyConfig(
                `value`.let(ProvisionedConcurrencyConfigurationProperty::unwrap)
            )
    }
    ...
    public open fun provisionedConcurrencyConfig(
        `value`: ProvisionedConcurrencyConfigurationProperty.Builder.() -> Unit
    ...
    public interface Builder {
         ...
         * Only publish a version if the hash value matches the value that's specified.
         *
         * Use this option to avoid publishing a version if the function code has changed since you
         * last updated it. Updates are not supported for this property.
         *
         ...
         *
         * @param provisionedConcurrencyConfig Specifies a provisioned concurrency configuration for
        ...
        public fun provisionedConcurrencyConfig(
            provisionedConcurrencyConfig:
                ProvisionedConcurrencyConfigurationProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
        ...
        override fun provisionedConcurrencyConfig(
            ...
            cdkBuilder.provisionedConcurrencyConfig(
                provisionedConcurrencyConfig.let(
                    ProvisionedConcurrencyConfigurationProperty::unwrap
                )
            )
        }
        ...
        override fun provisionedConcurrencyConfig(
            ...
            provisionedConcurrencyConfig(
                ProvisionedConcurrencyConfigurationProperty(provisionedConcurrencyConfig)
            )
    ...
    public companion object {
        ...
        ): CfnVersion = CfnVersion(cdkObject)

        internal fun unwrap(
            wrapped: CfnVersion
        ): software.amazon.awscdk.services.lambda.CfnVersion = wrapped.cdkObject
    }
    ...
    public interface ProvisionedConcurrencyConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param provisionedConcurrentExecutions The amount of provisioned concurrency to
             *   allocate for the version.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ProvisionedConcurrencyConfigurationProperty
            ): software.amazon.awscdk.services.lambda.CfnVersion.ProvisionedConcurrencyConfigurationProperty =
    ...
    public interface RuntimePolicyProperty {
        ...
        public interface Builder {
            /**
             * @param runtimeVersionArn The ARN of the runtime the function is configured to use. If
             *   the runtime update mode is manual, the ARN is returned, otherwise null is returned.
             */
        ...
        internal constructor(
             ...
             * The ARN of the runtime the function is configured to use.
             *
             * If the runtime update mode is manual, the ARN is returned, otherwise null is
             * returned.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-lambda-version-runtimepolicy.html#cfn-lambda-version-runtimepolicy-runtimeversionarn)
             */
