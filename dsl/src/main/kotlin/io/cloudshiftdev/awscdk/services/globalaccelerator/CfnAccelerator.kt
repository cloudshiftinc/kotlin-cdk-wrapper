...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param enabled Indicates whether the accelerator is enabled. The value is true or false.
         ...
         *   accelerator's static IP addresses when you create an accelerator.
         */
         ...
         * The name of the accelerator.
         *
         * The name must contain only alphanumeric characters or hyphens (-), and must not begin or
         * end with a hyphen.
         *
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.globalaccelerator.CfnAccelerator.Builder.create(
                scope,
                id
            )
