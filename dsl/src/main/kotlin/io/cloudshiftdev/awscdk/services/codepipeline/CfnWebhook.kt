...
internal constructor(
    ...
    public open fun authenticationConfiguration(`value`: WebhookAuthConfigurationProperty) {
        unwrap(this)
            .setAuthenticationConfiguration(`value`.let(WebhookAuthConfigurationProperty::unwrap))
    }
    ...
    public open fun authenticationConfiguration(
        `value`: WebhookAuthConfigurationProperty.Builder.() -> Unit
    ...
    public interface Builder {
         ...
         *
         * @param authenticationConfiguration Properties that configure the authentication applied
         *   to incoming webhook trigger requests.
         */
        ...
        public fun authenticationConfiguration(
            authenticationConfiguration: WebhookAuthConfigurationProperty.Builder.() -> Unit
        )
         ...
         *
         * @param registerWithThirdParty Configures a connection between the webhook that was
         *   created and the external tool with events to be detected.
         */
         ...
         *
         * @param targetAction The name of the action in a pipeline you want to connect to the
         *   webhook.
         */
    ...
    private class BuilderImpl(
        ...
        override fun authenticationConfiguration(
            ...
            cdkBuilder.authenticationConfiguration(
                authenticationConfiguration.let(WebhookAuthConfigurationProperty::unwrap)
            )
        }
        ...
        override fun authenticationConfiguration(
            ...
            authenticationConfiguration(
                WebhookAuthConfigurationProperty(authenticationConfiguration)
            )
        ...
        public fun build(): software.amazon.awscdk.services.codepipeline.CfnWebhook =
            cdkBuilder.build()
    }
    ...
    public interface WebhookFilterRuleProperty {
         ...
         * included as placeholders in this value by surrounding the action configuration key with
         * curly brackets. For example, if the value supplied here is "refs/heads/{Branch}" and the
         * target action has an action configuration property called "Branch" with a value of
         * "main", the `MatchEquals` value is evaluated as "refs/heads/main". For a list of action
        ...
        public interface Builder {
            /**
             * @param jsonPath A JsonPath expression that is applied to the body/payload of the
             *   webhook. The value selected by the JsonPath expression must match the value
             *   specified in the `MatchEquals` field. Otherwise, the request is ignored. For more
             *   information, see
             *   [Java JsonPath implementation](https://docs.aws.amazon.com/https://github.com/json-path/JsonPath)
             *   in GitHub.
             */
             ...
             *   supplied in the `MatchEquals` field. Otherwise, the request is ignored. Properties
             *   from the target action configuration can be included as placeholders in this value
             *   by surrounding the action configuration key with curly brackets. For example, if
        ...
        internal constructor(
             ...
             * `MatchEquals` field.
             *
             * Otherwise, the request is ignored. Properties from the target action configuration
             * can be included as placeholders in this value by surrounding the action configuration
             * key with curly brackets. For example, if the value supplied here is
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: WebhookFilterRuleProperty
            ): software.amazon.awscdk.services.codepipeline.CfnWebhook.WebhookFilterRuleProperty =
    ...
    public interface WebhookAuthConfigurationProperty {
        ...
        public interface Builder {
             ...
             *   address range. For IP, only the `AllowedIPRange` property must be set. This
             *   property must be set to a valid CIDR range.
             */
            public fun allowedIpRange(allowedIpRange: String)

            /**
             * @param secretToken The property used to configure GitHub authentication. For
        ...
        internal constructor(
             ...
             * The property used to configure acceptance of webhooks in an IP address range.
             *
             * For IP, only the `AllowedIPRange` property must be set. This property must be set to
             * a valid CIDR range.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-codepipeline-webhook-webhookauthconfiguration.html#cfn-codepipeline-webhook-webhookauthconfiguration-allowediprange)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: WebhookAuthConfigurationProperty
            ): software.amazon.awscdk.services.codepipeline.CfnWebhook.WebhookAuthConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
