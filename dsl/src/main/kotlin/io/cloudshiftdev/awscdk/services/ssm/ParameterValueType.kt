...
public enum class ParameterValueType(
    ...
    public companion object {
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.ssm.ParameterValueType
        ): ParameterValueType =
            when (cdkObject) {
                software.amazon.awscdk.services.ssm.ParameterValueType.STRING ->
