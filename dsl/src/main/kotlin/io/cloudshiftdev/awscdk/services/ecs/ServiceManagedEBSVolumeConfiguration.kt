...
public interface ServiceManagedEBSVolumeConfiguration {
     ...
     * volume was using when the snapshot was created. The available filesystem types are ext3,
     * ext4, and xfs.
     *
     ...
     *
     * For gp3, io1, and io2 volumes, this represents the number of IOPS that are provisioned for
     ...
     *
     * Default: - When `encryption` is turned on and no `kmsKey` is specified, the default AWS
     * managed key for Amazon EBS volumes is used.
     */
     ...
     *
     * You must specify either `size` or `snapshotId`. You can optionally specify a volume size
     * greater than or equal to the snapshot size.
     *
    ...
    public interface Builder {
        ...
        /**
         * @param fileSystemType The Linux filesystem type for the volume. For volumes created from
         *   a snapshot, you must specify the same filesystem type that the volume was using when
         *   the snapshot was created. The available filesystem types are ext3, ext4, and xfs.
         */
        ...
        /**
         * @param role An IAM role that allows ECS to make calls to EBS APIs on your behalf. This
         *   role is required to create and manage the Amazon EBS volume.
         */
        public fun role(role: IRole)

        /**
         * @param size The size of the volume in GiB. You must specify either `size` or
         *   `snapshotId`. You can optionally specify a volume size greater than or equal to the
         *   snapshot size.
         *
         * The following are the supported volume size values for each volume type.
         * * gp2 and gp3: 1-16,384
         ...
         *   specify either `size` or `snapshotId`.
         */
        public fun snapShotId(snapShotId: String)

        /**
         * @param tagSpecifications Specifies the tags to apply to the volume and whether to
         *   propagate those tags to the volume.
         */
         ...
         *   1,000 MiB/s. This parameter is only supported for the gp3 volume type.
         */
    ...
    internal constructor(
        ...
        /**
         * Specifies the tags to apply to the volume and whether to propagate those tags to the
         * volume.
         *
         * Default: - No tags are specified.
         */
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: ServiceManagedEBSVolumeConfiguration
        ): software.amazon.awscdk.services.ecs.ServiceManagedEBSVolumeConfiguration =
