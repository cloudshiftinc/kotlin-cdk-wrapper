...
internal constructor(
    ...
    public companion object {
        ...
        public fun grpc(`value`: AppProtocol) {
            software.amazon.awscdk.services.ecs.AppProtocol.setGrpc(
                `value`.let(AppProtocol::unwrap)
            )
        }
        ...
        public fun http(`value`: AppProtocol) {
            software.amazon.awscdk.services.ecs.AppProtocol.setHttp(
                `value`.let(AppProtocol::unwrap)
            )
        }
        ...
        public fun http2(`value`: AppProtocol) {
            software.amazon.awscdk.services.ecs.AppProtocol.setHttp2(
                `value`.let(AppProtocol::unwrap)
            )
        }
