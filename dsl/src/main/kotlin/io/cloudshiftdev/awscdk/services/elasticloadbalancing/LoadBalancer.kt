...
internal constructor(
    ...
    public interface Builder {
        /**
         * Enable Loadbalancer access logs Can be used to avoid manual work as aws console Required
         * S3 bucket name , enabled flag Can add interval for pushing log Can set bucket prefix in
         * order to provide folder name inside bucket.
         *
         * Default: - disabled
         *
         * @param accessLoggingPolicy Enable Loadbalancer access logs Can be used to avoid manual
         *   work as aws console Required S3 bucket name , enabled flag Can add interval for pushing
         *   log Can set bucket prefix in order to provide folder name inside bucket.
         */
        ...
        public fun accessLoggingPolicy(
            accessLoggingPolicy: CfnLoadBalancer.AccessLoggingPolicyProperty.Builder.() -> Unit
        )

        /**
         * Whether cross zone load balancing is enabled.
         *
         * This controls whether the load balancer evenly distributes requests across each
         * availability zone
         *
         * Default: true
         *
         ...
         *
         * This controls whether the LB has a public IP address assigned. It does not open up the
         * Load Balancer's security groups to public internet access.
         *
         * Default: false
         *
         ...
         *
         * Can be used to define a specific set of subnets to deploy the load balancer to. Useful
         * multiple public or private subnets are covering the same availability zone.
         *
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.elasticloadbalancing.LoadBalancer.Builder.create(
                scope,
                id
            )
        ...
        override fun accessLoggingPolicy(
            ...
            cdkBuilder.accessLoggingPolicy(
                accessLoggingPolicy.let(CfnLoadBalancer.AccessLoggingPolicyProperty::unwrap)
            )
        }
