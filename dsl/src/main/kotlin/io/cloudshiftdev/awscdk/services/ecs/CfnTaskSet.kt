...
internal constructor(
    ...
    public interface Builder {
         ...
         * An optional non-unique tag that identifies this task set in external systems.
         *
         * If the task set is associated with a service discovery registry, the tasks in this task
         * set will have the `ECS_TASK_SET_EXTERNAL_ID` AWS Cloud Map attribute set to the provided
         * value.
         *
         ...
         * A load balancer object representing the load balancer to use with the task set.
         *
         * The supported load balancer types are either an Application Load Balancer or a Network
         * Load Balancer.
         *
         ...
         *
         * @param loadBalancers A load balancer object representing the load balancer to use with
         *   the task set.
         */
         ...
         * isn't specified, the `LATEST` platform version is used.
         *
         ...
         *
         * @param scale A floating-point percentage of your desired number of tasks to place and
         ...
         *
         * @param service The short name or full Amazon Resource Name (ARN) of the service to create
         *   the task set in.
         */
         ...
         *
         * @param serviceRegistries The details of the service discovery registries to assign to
         *   this task set.
         */
    ...
    private class BuilderImpl(
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("5f5196ccfdf1b0ce8f5b1bfba3ca9581ec023dcd6d98a06980164f3d35cc10b9")
        override fun scale(scale: ScaleProperty.Builder.() -> Unit): Unit =
    ...
    public interface ScaleProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param value The value, specified as a percent total of a service's `desiredCount` ,
