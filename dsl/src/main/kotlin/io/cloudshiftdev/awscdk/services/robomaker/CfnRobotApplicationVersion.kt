...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.robomaker.CfnRobotApplicationVersion,
    ...
    public interface Builder {
         ...
         * The current revision id for the robot application.
         *
         * If you provide a value and it matches the latest revision ID, a new version will be
         * created.
         *
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.robomaker.CfnRobotApplicationVersion.Builder.create(
                scope,
                id
            )
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnRobotApplicationVersion
