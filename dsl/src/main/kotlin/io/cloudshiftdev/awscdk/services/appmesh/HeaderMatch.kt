...
internal constructor(
    ...
    public companion object {
        public fun valueDoesNotEndWith(headerName: String, suffix: String): HeaderMatch =
            software.amazon.awscdk.services.appmesh.HeaderMatch.valueDoesNotEndWith(
                    headerName,
                    suffix
                )
                .let(HeaderMatch::wrap)

        public fun valueDoesNotMatchRegex(headerName: String, regex: String): HeaderMatch =
            software.amazon.awscdk.services.appmesh.HeaderMatch.valueDoesNotMatchRegex(
                    headerName,
                    regex
                )
                .let(HeaderMatch::wrap)
        ...
        public fun valueDoesNotStartWith(headerName: String, prefix: String): HeaderMatch =
            software.amazon.awscdk.services.appmesh.HeaderMatch.valueDoesNotStartWith(
                    headerName,
                    prefix
                )
                .let(HeaderMatch::wrap)
        ...
        public fun valueEndsWith(headerName: String, suffix: String): HeaderMatch =
            software.amazon.awscdk.services.appmesh.HeaderMatch.valueEndsWith(headerName, suffix)
                .let(HeaderMatch::wrap)

        public fun valueIs(headerName: String, headerValue: String): HeaderMatch =
            software.amazon.awscdk.services.appmesh.HeaderMatch.valueIs(headerName, headerValue)
                .let(HeaderMatch::wrap)

        public fun valueIsNot(headerName: String, headerValue: String): HeaderMatch =
            software.amazon.awscdk.services.appmesh.HeaderMatch.valueIsNot(headerName, headerValue)
                .let(HeaderMatch::wrap)

        public fun valueMatchesRegex(headerName: String, regex: String): HeaderMatch =
            software.amazon.awscdk.services.appmesh.HeaderMatch.valueMatchesRegex(headerName, regex)
                .let(HeaderMatch::wrap)

        public fun valueStartsWith(headerName: String, prefix: String): HeaderMatch =
            software.amazon.awscdk.services.appmesh.HeaderMatch.valueStartsWith(headerName, prefix)
                .let(HeaderMatch::wrap)
        ...
        public fun valuesIsInRange(
            ...
            software.amazon.awscdk.services.appmesh.HeaderMatch.valuesIsInRange(
                    headerName,
                    start,
                    end
                )
        ...
        public fun valuesIsNotInRange(
            ...
            software.amazon.awscdk.services.appmesh.HeaderMatch.valuesIsNotInRange(
                    headerName,
                    start,
                    end
                )
        ...
        ): HeaderMatch = Wrapper(cdkObject)

        internal fun unwrap(
            wrapped: HeaderMatch
        ): software.amazon.awscdk.services.appmesh.HeaderMatch = (wrapped as Wrapper).cdkObject
    }
}
