...
internal constructor(
    ...
    public interface Builder {
         ...
         *   destination.
         */
        public fun configurationSetEventDestinationName(
            configurationSetEventDestinationName: String
        )
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.ses.ConfigurationSetEventDestination.Builder.create(
                scope,
                id
            )
         ...
         *   destination.
         */
        override fun configurationSetEventDestinationName(
            configurationSetEventDestinationName: String
        ) {
    ...
    public companion object {
        public fun fromConfigurationSetEventDestinationId(
            ...
            software.amazon.awscdk.services.ses.ConfigurationSetEventDestination
                ...
                .let(IConfigurationSetEventDestination::wrap)
        ...
        internal fun unwrap(
            wrapped: ConfigurationSetEventDestination
