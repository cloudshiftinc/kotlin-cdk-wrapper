...
public interface TableAttributes {
     ...
     *
     * Note that you need to set either this property, or `localIndexes`, if you want methods like
     * grantReadData() to grant permissions for indexes as well as the table itself.
     *
     ...
     *
     * If false is provided, grant methods grant the permissions only when `globalIndexes` or
     ...
     *
     * Note that you need to set either this property, or `globalIndexes`, if you want methods like
     * grantReadData() to grant permissions for indexes as well as the table itself.
     *
    ...
    public interface Builder {
        ...
        /**
         * @param globalIndexes The name of the global indexes set for this Table. Note that you
         *   need to set either this property, or `localIndexes`, if you want methods like
         *   grantReadData() to grant permissions for indexes as well as the table itself.
         */
        ...
        /**
         * @param grantIndexPermissions If set to true, grant methods always grant permissions for
         *   all indexes. If false is provided, grant methods grant the permissions only when
         *   `globalIndexes` or `localIndexes` is specified.
         */
        public fun grantIndexPermissions(grantIndexPermissions: Boolean)

        /**
         * @param localIndexes The name of the local indexes set for this Table. Note that you need
         *   to set either this property, or `globalIndexes`, if you want methods like
         *   grantReadData() to grant permissions for indexes as well as the table itself.
         */
        ...
        /**
         * @param tableArn The ARN of the dynamodb table. One of this, or `tableName`, is required.
         */
        public fun tableArn(tableArn: String)

        /**
         * @param tableName The table name of the dynamodb table. One of this, or `tableArn`, is
         *   required.
         */
    ...
    internal constructor(
         ...
         * The name of the global indexes set for this Table.
         *
         * Note that you need to set either this property, or `localIndexes`, if you want methods
         * like grantReadData() to grant permissions for indexes as well as the table itself.
         *
         * Default: - no global indexes
         */
         ...
         * The name of the local indexes set for this Table.
         *
         * Note that you need to set either this property, or `globalIndexes`, if you want methods
         * like grantReadData() to grant permissions for indexes as well as the table itself.
         *
         * Default: - no local indexes
         */
    ...
    public companion object {
        ...
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.dynamodb.TableAttributes
        ): TableAttributes = Wrapper(cdkObject)

        internal fun unwrap(
            wrapped: TableAttributes
