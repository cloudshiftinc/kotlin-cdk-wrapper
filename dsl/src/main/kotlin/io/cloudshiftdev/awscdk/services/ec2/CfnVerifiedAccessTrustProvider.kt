...
internal constructor(
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.ec2.CfnVerifiedAccessTrustProvider.Builder.create(
                scope,
                id
            )
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnVerifiedAccessTrustProvider
    ...
    public interface DeviceOptionsProperty {
        ...
        public interface Builder {
            /**
             * @param publicSigningKeyUrl The URL AWS Verified Access will use to verify the
