...
internal constructor(
    ...
    public open fun apiKeySelectionExpression(): String? =
        unwrap(this).getApiKeySelectionExpression()
    ...
    public interface Builder {
         ...
         * `BodyS3Location` . If you specify a `Body` or `BodyS3Location` , don't specify
         * CloudFormation resources such as `AWS::ApiGatewayV2::Authorizer` or
         ...
         * This property is part of quick create.
         *
         * It specifies the credentials required for the integration, if any. For a Lambda
         * integration, three options are available. To specify an IAM Role for API Gateway to
         * assume, use the role's Amazon Resource Name (ARN). To require that the caller's identity
         * be passed through from the request, specify `arn:aws:iam::*:user/ *` . To use
         * resource-based permissions on supported AWS services, specify `null` . Currently, this
         ...
         *
         * @param disableExecuteApiEndpoint Specifies whether clients can invoke your API by using
         ...
         * The API protocol.
         *
         * Valid values are `WEBSOCKET` or `HTTP` . Required unless you specify an OpenAPI
         ...
         * This property is part of quick create.
         *
         * If you don't specify a `routeKey` , a default route of `$default` is created. The
         * `$default` route acts as a catch-all for any request made to your API, for a particular
         * stage. The `$default` route key can't be modified. You can add routes after creating the
         * API, and you can update the route keys of additional routes. Supported only for HTTP
         * APIs.
         *
         ...
         * . If not provided, this will be the default for HTTP APIs. This property is required for
         * WebSocket APIs.
         *
         ...
         * This property is part of quick create.
         *
         * Quick create produces an API with an integration, a default catch-all route, and a
         * default stage which is configured to automatically deploy changes. For HTTP integrations,
         * specify a fully qualified URL. For Lambda integrations, specify a function ARN. The type
         * of the integration will be HTTP_PROXY or AWS_PROXY, respectively. Supported only for HTTP
         * APIs.
         *
    ...
    private class BuilderImpl(
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("7a90237a320cf324f8dd5e9a6a50761ea24608581d85aecde0a7e6bc58d2a5eb")
        override fun bodyS3Location(
            bodyS3Location: BodyS3LocationProperty.Builder.() -> Unit
        ): Unit = bodyS3Location(BodyS3LocationProperty(bodyS3Location))
    ...
    public interface BodyS3LocationProperty {
        ...
        public interface Builder {
            /**
             * @param bucket The S3 bucket that contains the OpenAPI definition to import. Required
             *   if you specify a `BodyS3Location` for an API.
             */
            ...
            /**
             * @param key The key of the S3 object. Required if you specify a `BodyS3Location` for
             *   an API.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: BodyS3LocationProperty
            ): software.amazon.awscdk.services.apigatewayv2.CfnApi.BodyS3LocationProperty =
    ...
    public interface CorsProperty {
        ...
        public interface Builder {
            /**
             * @param allowCredentials Specifies whether credentials are included in the CORS
            ...
            /**
             * @param allowHeaders Represents a collection of allowed headers. Supported only for
             *   HTTP APIs.
             */
            ...
            /**
             * @param allowMethods Represents a collection of allowed HTTP methods. Supported only
             *   for HTTP APIs.
             */
            ...
            /**
             * @param allowOrigins Represents a collection of allowed origins. Supported only for
             *   HTTP APIs.
             */
            ...
            /**
             * @param exposeHeaders Represents a collection of exposed headers. Supported only for
             *   HTTP APIs.
             */
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-apigatewayv2-api-cors.html#cfn-apigatewayv2-api-cors-allowheaders)
             */
            override fun allowHeaders(): List<String> =
                unwrap(this).getAllowHeaders() ?: emptyList()
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-apigatewayv2-api-cors.html#cfn-apigatewayv2-api-cors-allowmethods)
             */
            override fun allowMethods(): List<String> =
                unwrap(this).getAllowMethods() ?: emptyList()
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-apigatewayv2-api-cors.html#cfn-apigatewayv2-api-cors-alloworigins)
             */
            override fun allowOrigins(): List<String> =
                unwrap(this).getAllowOrigins() ?: emptyList()
