...
internal constructor(
    ...
    /**
     * Adds CloudFormation template metadata to the specified resource with information that
     * indicates which resource property is mapped to this local asset.
     *
     * This can be used by tools such as SAM CLI to provide local experience such as local
     * invocation and debugging of Lambda functions.
     *
     * Asset metadata will only be included if the stack is synthesized with the
     * "aws:cdk:enable-asset-metadata" context key defined, which is the default behavior when
     * synthesizing via the CDK Toolkit.
     *
     ...
     *
     * If asset staging is disabled, this will just be the original path. If asset staging is
     * enabled it will be the staged path.
     */
