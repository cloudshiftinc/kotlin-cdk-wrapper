...
internal constructor(
    ...
    /** The Amazon SNS subscriptions (endpoints) for this topic. */
    public open fun subscription(vararg __idx_ac66f0: Any): Unit =
        subscription(__idx_ac66f0.toList())
    ...
    public interface Builder {
         ...
         *   [Publish](https://docs.aws.amazon.com/sns/latest/api/API_Publish.html) action.
         ...
         *
         * @param dataProtectionPolicy The body of the policy document you want to use for this
         *   topic.
         */
        public fun dataProtectionPolicy(dataProtectionPolicy: Any)

        /**
         * The `DeliveryStatusLogging` configuration enables you to log the delivery status of
         * messages sent from your Amazon SNS topic to subscribed endpoints with the following
         ...
         *
         * @param deliveryStatusLogging The `DeliveryStatusLogging` configuration enables you to log
         *   the delivery status of messages sent from your Amazon SNS topic to subscribed endpoints
         *   with the following supported delivery protocols:.
         */
         ...
         *
         * @param displayName The display name to use for an Amazon SNS topic with SMS
         *   subscriptions.
         */
         ...
         *
         * @param kmsMasterKeyId The ID of an AWS managed customer master key (CMK) for Amazon SNS
         *   or a custom CMK.
         */
         ...
         *
         * @param signatureVersion The signature version corresponds to the hashing algorithm used
         ...
         * The Amazon SNS subscriptions (endpoints) for this topic.
         *
         * If you specify the `Subscription` property in the `AWS::SNS::Topic` resource and it
         * creates an associated subscription resource, the associated subscription is not deleted
         * when the `AWS::SNS::Topic` resource is deleted.
         *
         ...
         * The name of the topic you want to create.
         *
         * Topic names must include only uppercase and lowercase ASCII letters, numbers,
         * underscores, and hyphens, and must be between 1 and 256 characters long. FIFO topic names
         * must end with `.fifo` .
         *
         * If you don't specify a name, AWS CloudFormation generates a unique physical ID and uses
         * that ID for the topic name. For more information, see
         ...
         * Tracing mode of an Amazon SNS topic.
         *
         * By default `TracingConfig` is set to `PassThrough` , and the topic passes through the
         * tracing header it receives from an Amazon SNS publisher to its subscriptions. If set to
         * `Active` , Amazon SNS will vend X-Ray segment data to topic owner account if the sampled
         * flag in the tracing header is true.
         *
    ...
    private class BuilderImpl(
         ...
         * @param subscription The Amazon SNS subscriptions (endpoints) for this topic.
         */
        override fun subscription(vararg subscription: Any): Unit =
            subscription(subscription.toList())
    ...
    public interface LoggingConfigProperty {
         ...
         */
        public fun successFeedbackSampleRate(): String? =
        ...
        public interface Builder {
            ...
            /**
             * @param successFeedbackRoleArn The IAM role ARN to be used when logging successful
             *   message deliveries in Amazon CloudWatch.
             */
            public fun successFeedbackRoleArn(successFeedbackRoleArn: String)

            /**
             * @param successFeedbackSampleRate The percentage of successful message deliveries to
             *   be logged in Amazon CloudWatch. Valid percentage values range from 0 to 100.
             */
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-sns-topic-loggingconfig.html#cfn-sns-topic-loggingconfig-failurefeedbackrolearn)
             */
            override fun failureFeedbackRoleArn(): String? =
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-sns-topic-loggingconfig.html#cfn-sns-topic-loggingconfig-successfeedbackrolearn)
             */
            override fun successFeedbackRoleArn(): String? =
    ...
    public interface SubscriptionProperty {
         ...
         *
         * The endpoint value depends on the protocol that you specify. For more information, see
         * the `Endpoint` parameter of the
         * `[Subscribe](https://docs.aws.amazon.com/sns/latest/api/API_Subscribe.html)` action in
        ...
        public interface Builder {
             ...
             *   The endpoint value depends on the protocol that you specify. For more information,
             *   see the `Endpoint` parameter of the
             *   `[Subscribe](https://docs.aws.amazon.com/sns/latest/api/API_Subscribe.html)` action
