...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param payloadFormatVersion Specifies the format of the payload sent to an HTTP API
         *   Lambda authorizer.
         */
    ...
    private class BuilderImpl(
         ...
         * @param jwtAudience A list of the intended recipients of the JWT.
         */
        override fun jwtAudience(vararg jwtAudience: String): Unit =
            jwtAudience(jwtAudience.toList())
        ...
        override fun payloadFormatVersion(payloadFormatVersion: AuthorizerPayloadVersion) {
            cdkBuilder.payloadFormatVersion(
                payloadFormatVersion.let(AuthorizerPayloadVersion::unwrap)
            )
        }
    ...
    public companion object {
        public fun fromHttpAuthorizerAttributes(
            ...
            software.amazon.awscdk.services.apigatewayv2.HttpAuthorizer
                .fromHttpAuthorizerAttributes(
                    ...
                    id,
                    attrs.let(HttpAuthorizerAttributes::unwrap)
                )
                .let(IHttpRouteAuthorizer::wrap)
        ...
        public fun fromHttpAuthorizerAttributes(
            ...
            fromHttpAuthorizerAttributes(scope, id, HttpAuthorizerAttributes(attrs))
