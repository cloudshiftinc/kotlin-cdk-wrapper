...
public interface IClusterEngine : IEngine {
    ...
    public fun bindToCluster(
        scope: Construct,
        options: ClusterEngineBindOptions.Builder.() -> Unit
    ): ClusterEngineConfig
     ...
     * Default: false
     */
    public fun combineImportAndExportRoles(): Boolean? =
    ...
    internal constructor(
        ...
        override fun bindToCluster(
            ...
            unwrap(this)
                .bindToCluster(
                    ...
                    options.let(ClusterEngineBindOptions::unwrap)
                )
                .let(ClusterEngineConfig::wrap)
        ...
        override fun bindToCluster(
            scope: Construct,
            options: ClusterEngineBindOptions.Builder.() -> Unit
        ): ClusterEngineConfig = bindToCluster(scope, ClusterEngineBindOptions(options))
         ...
         *
         * The global default of 'admin' will be used if this is `undefined`. Note that 'admin' is a
         * reserved word in PostgreSQL and cannot be used.
         */
         ...
         *
         * This property is used when creating a Database Proxy. Most engines don't belong to any
         * family (and because of that, you can't create Database Proxies for their Clusters or
         * Instances).
         *
         ...
         *
         * This is usually equal to "<engineType><engineMajorVersion>", but can sometimes be a
         * variation of that. You can pass this property when creating new ParameterGroup.
         *
         * Default: - the ParameterGroup family is not known (which means the major version of the
         * engine is also not known)
         */
    ...
    public companion object {
        ...
        ): IClusterEngine = Wrapper(cdkObject)

        internal fun unwrap(
            wrapped: IClusterEngine
        ): software.amazon.awscdk.services.rds.IClusterEngine = (wrapped as Wrapper).cdkObject
    }
}
