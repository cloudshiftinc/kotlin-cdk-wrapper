...
internal constructor(
    ...
    public open fun revocationConfiguration(`value`: RevocationConfigurationProperty) {
        unwrap(this)
            .setRevocationConfiguration(`value`.let(RevocationConfigurationProperty::unwrap))
    }
    ...
    public open fun revocationConfiguration(
        `value`: RevocationConfigurationProperty.Builder.() -> Unit
    ): Unit = revocationConfiguration(RevocationConfigurationProperty(`value`))
    ...
    public interface Builder {
         ...
         * when it issues a certificate.
         *
         * When you create a subordinate CA, you must use a key algorithm supported by the parent
         * CA.
         *
         ...
         *
         * @param keyAlgorithm Type of the public key algorithm and size, in bits, of the key pair
         *   that your CA creates when it issues a certificate.
         */
         ...
         *
         * Some AWS Regions do not support the default. When creating a CA in these Regions, you
         ...
         *   must conform to
         *   [RFC2396](https://docs.aws.amazon.com/https://www.ietf.org/rfc/rfc2396.txt)
         ...
         *   OCSP returns validation information about certificates as requested by clients, and a
         *   CRL contains an updated list of certificates revoked by your CA. For more information,
         *   see
         *   [RevokeCertificate](https://docs.aws.amazon.com/privateca/latest/APIReference/API_RevokeCertificate.html)
         *   in the *AWS Private CA API Reference* and
         *   [Setting up a certificate revocation method](https://docs.aws.amazon.com/privateca/latest/userguide/revocation-setup.html)
        ...
        public fun revocationConfiguration(
            revocationConfiguration: RevocationConfigurationProperty.Builder.() -> Unit
        )
         ...
         *
         * @param subject Structure that contains X.500 distinguished name information for your
         *   private CA.
         */
         ...
         *   optionally omit revocation because they expire quickly.
         */
    ...
    private class BuilderImpl(
         ...
         *   in the *AWS Private CA User Guide* .
         */
        override fun revocationConfiguration(
            revocationConfiguration: RevocationConfigurationProperty
        ) {
            cdkBuilder.revocationConfiguration(
                revocationConfiguration.let(RevocationConfigurationProperty::unwrap)
            )
        }
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnCertificateAuthority
    ...
    public interface AccessDescriptionProperty {
        ...
        private class BuilderImpl : Builder {
            ...
            override fun accessLocation(
                accessLocation: GeneralNameProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AccessDescriptionProperty
            ): software.amazon.awscdk.services.acmpca.CfnCertificateAuthority.AccessDescriptionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CsrExtensionsProperty {
        ...
        public interface Builder {
            /**
             * @param keyUsage Indicates the purpose of the certificate and of the key contained in
             *   the certificate.
             */
             ...
             *   information pertaining to the CA, such as revocation and policy. For more
             *   information, see
             *   [Subject Information Access](https://docs.aws.amazon.com/https://datatracker.ietf.org/doc/html/rfc5280#section-4.2.2.2)
             *   in RFC 5280.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            override fun subjectInformationAccess(subjectInformationAccess: IResolvable) {
                cdkBuilder.subjectInformationAccess(
                    subjectInformationAccess.let(IResolvable::unwrap)
                )
            }
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-acmpca-certificateauthority-csrextensions.html#cfn-acmpca-certificateauthority-csrextensions-subjectinformationaccess)
             */
            override fun subjectInformationAccess(): Any? =
    ...
    public interface RevocationConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param crlConfiguration Configuration of the certificate revocation list (CRL), if
            ...
            public fun crlConfiguration(
                crlConfiguration: CrlConfigurationProperty.Builder.() -> Unit
            )
            ...
            public fun ocspConfiguration(
                ocspConfiguration: OcspConfigurationProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun ocspConfiguration(ocspConfiguration: OcspConfigurationProperty) {
                cdkBuilder.ocspConfiguration(
                    ocspConfiguration.let(OcspConfigurationProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("b9cc9b7b1bbd7af3bd90deea00d53454783d53fa73e507b733560d62cdc208a0")
            override fun ocspConfiguration(
                ocspConfiguration: OcspConfigurationProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RevocationConfigurationProperty
            ): software.amazon.awscdk.services.acmpca.CfnCertificateAuthority.RevocationConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SubjectProperty {
         ...
         */
        public fun distinguishedNameQualifier(): String? =
        ...
        public interface Builder {
            ...
            /**
             * @param country Two-digit code that specifies the country in which the certificate
             *   subject located.
             */
            public fun country(country: String)

            /**
             * @param customAttributes Contains a sequence of one or more X.500 relative
             *   distinguished names (RDNs), each of which consists of an object identifier (OID)
             *   and a value. For more information, see NIST’s definition of
             *   [Object Identifier (OID)](https://docs.aws.amazon.com/https://csrc.nist.gov/glossary/term/Object_Identifier)
             *   .
             *
             * Custom attributes cannot be used in combination with standard attributes.
            ...
            /**
             * @param distinguishedNameQualifier Disambiguating information for the certificate
             *   subject.
             */
            public fun distinguishedNameQualifier(distinguishedNameQualifier: String)

            /**
             * @param generationQualifier Typically a qualifier appended to the name of an
             *   individual. Examples include Jr. for junior, Sr. for senior, and III for third.
             */
            ...
            /**
             * @param initials Concatenation that typically contains the first letter of the
             *   GivenName, the first letter of the middle name if one exists, and the first letter
             *   of the SurName.
             */
            public fun initials(initials: String)

            /**
             * @param locality The locality (such as a city or town) in which the certificate
             *   subject is located.
             */
            public fun locality(locality: String)

            /**
             * @param organization Legal name of the organization with which the certificate subject
             *   is affiliated.
             */
            ...
            /**
             * @param pseudonym Typically a shortened version of a longer GivenName. For example,
             *   Jonathan is often shortened to John. Elizabeth is often shortened to Beth, Liz, or
             *   Eliza.
             */
        ...
        internal constructor(
             ...
             * Typically a shortened version of a longer GivenName.
             *
             * For example, Jonathan is often shortened to John. Elizabeth is often shortened to
             * Beth, Liz, or Eliza.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-acmpca-certificateauthority-subject.html#cfn-acmpca-certificateauthority-subject-pseudonym)
             */
    ...
    public interface AccessMethodProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param customObjectIdentifier An object identifier (OID) specifying the
             *   `AccessMethod` . The OID must satisfy the regular expression shown below. For more
        ...
        internal constructor(
             ...
             * An object identifier (OID) specifying the `AccessMethod` .
             *
             * The OID must satisfy the regular expression shown below. For more information, see
             * NIST's definition of
             * [Object Identifier (OID)](https://docs.aws.amazon.com/https://csrc.nist.gov/glossary/term/Object_Identifier)
             * .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-acmpca-certificateauthority-accessmethod.html#cfn-acmpca-certificateauthority-accessmethod-customobjectidentifier)
             */
            override fun customObjectIdentifier(): String? =
    ...
    public interface CrlConfigurationProperty {
         ...
         * use of an alias for the CRL distribution point.
         *
         ...
         * [RFC2396](https://docs.aws.amazon.com/https://www.ietf.org/rfc/rfc2396.txt) restrictions
         * on the use of special characters in URIs. Additionally, the value of the CNAME must not
         ...
         *
         * If you do not provide a value for the *CustomCname* argument, the name of your S3 bucket
         * is placed into the *CRL Distribution Points* extension of the issued certificate. You can
         ...
         * choose BUCKET_OWNER_FULL_CONTROL, only the owner of the CRL S3 bucket can access the CRL,
         * and your PKI clients may need an alternative method of access.
         *
         * If no value is specified, the default is PUBLIC_READ.
         *
         * *Note:* This default can cause CA creation to fail in some circumstances. If you have
         * have enabled the Block Public Access (BPA) feature in your S3 account, then you must
        ...
        public interface Builder {
            /**
             * @param crlDistributionPointExtensionConfiguration Configures the default behavior of
             *   the CRL Distribution Point extension for certificates issued by your CA. If this
             *   field is not provided, then the CRL Distribution Point extension will be present
             *   and contain the default CRL URL.
             */
            ...
            public fun crlDistributionPointExtensionConfiguration(
                crlDistributionPointExtensionConfiguration:
                    CrlDistributionPointExtensionConfigurationProperty.Builder.() -> Unit
            )

            /**
             * @param customCname Name inserted into the certificate *CRL Distribution Points*
             *   extension that enables the use of an alias for the CRL distribution point. Use this
             *   value if you don't want the name of your S3 bucket to be public.
             *
             * The content of a Canonical Name (CNAME) record must conform to
             * [RFC2396](https://docs.aws.amazon.com/https://www.ietf.org/rfc/rfc2396.txt)
             * restrictions on the use of special characters in URIs. Additionally, the value of the
             * CNAME must not include a protocol prefix such as "http://" or "https://".
             */
            public fun customCname(customCname: String)

            /**
             * @param enabled Boolean value that specifies whether certificate revocation lists
             *   (CRLs) are enabled. You can use this value to enable certificate revocation for a
             *   new CA when you call the `CreateCertificateAuthority` operation or for an existing
             *   CA when you call the `UpdateCertificateAuthority` operation.
             */
            ...
            /**
             * @param s3BucketName Name of the S3 bucket that contains the CRL. If you do not
             *   provide a value for the *CustomCname* argument, the name of your S3 bucket is
             *   placed into the *CRL Distribution Points* extension of the issued certificate. You
            ...
            /**
             * @param s3ObjectAcl Determines whether the CRL will be publicly readable or privately
             *   held in the CRL Amazon S3 bucket. If you choose PUBLIC_READ, the CRL will be
             *   accessible over the public internet. If you choose BUCKET_OWNER_FULL_CONTROL, only
             *   the owner of the CRL S3 bucket can access the CRL, and your PKI clients may need an
        ...
        private class BuilderImpl : Builder {
             ...
             *   and contain the default CRL URL.
             */
            override fun crlDistributionPointExtensionConfiguration(
                crlDistributionPointExtensionConfiguration: IResolvable
            ) {
                cdkBuilder.crlDistributionPointExtensionConfiguration(
                    crlDistributionPointExtensionConfiguration.let(IResolvable::unwrap)
                )
            }
            ...
            override fun crlDistributionPointExtensionConfiguration(
                ...
                cdkBuilder.crlDistributionPointExtensionConfiguration(
                    crlDistributionPointExtensionConfiguration.let(
                        CrlDistributionPointExtensionConfigurationProperty::unwrap
                    )
                )
            }
        ...
        internal constructor(
            ...
            /**
             * Configures the default behavior of the CRL Distribution Point extension for
             * certificates issued by your CA.
             *
             * If this field is not provided, then the CRL Distribution Point extension will be
             ...
             * the use of an alias for the CRL distribution point.
             *
             * Use this value if you don't want the name of your S3 bucket to be public.
             *
             * The content of a Canonical Name (CNAME) record must conform to
             ...
             * the `CreateCertificateAuthority` operation or for an existing CA when you call the
             * `UpdateCertificateAuthority` operation.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-acmpca-certificateauthority-crlconfiguration.html#cfn-acmpca-certificateauthority-crlconfiguration-enabled)
             */
             ...
             * Name of the S3 bucket that contains the CRL.
             *
             * If you do not provide a value for the *CustomCname* argument, the name of your S3
             * bucket is placed into the *CRL Distribution Points* extension of the issued
             ...
             * Amazon S3 bucket.
             *
             * If you choose PUBLIC_READ, the CRL will be accessible over the public internet. If
             * you choose BUCKET_OWNER_FULL_CONTROL, only the owner of the CRL S3 bucket can access
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CrlConfigurationProperty
            ): software.amazon.awscdk.services.acmpca.CfnCertificateAuthority.CrlConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CrlDistributionPointExtensionConfigurationProperty {
         ...
         *
         * If set to `true` , then the CDP extension will not be present in any certificates issued
        ...
        public interface Builder {
            /**
             * @param omitExtension Configures whether the CRL Distribution Point extension should
             *   be populated with the default URL to the CRL. If set to `true` , then the CDP
        ...
        internal constructor(
             ...
             * default URL to the CRL.
             *
             * If set to `true` , then the CDP extension will not be present in any certificates
             * issued by that CA unless otherwise specified through CSR or API passthrough.
             *
             * Only set this if you have another way to distribute the CRL Distribution Points for
             * certificates issued by your CA, such as the Matter Distributed Compliance Ledger.
             *
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CrlDistributionPointExtensionConfigurationProperty
            ): software.amazon.awscdk.services.acmpca.CfnCertificateAuthority.CrlDistributionPointExtensionConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface OcspConfigurationProperty {
         ...
         *
         * A customer can alternatively use this object to define a CNAME specifying a customized
         * OCSP domain.
         *
         * The content of a Canonical Name (CNAME) record must conform to
         * [RFC2396](https://docs.aws.amazon.com/https://www.ietf.org/rfc/rfc2396.txt) restrictions
        ...
        internal constructor(
            ...
            /**
             * By default, AWS Private CA injects an Amazon domain into certificates being validated
             * by the Online Certificate Status Protocol (OCSP).
             *
             * A customer can alternatively use this object to define a CNAME specifying a
             * customized OCSP domain.
             *
             * The content of a Canonical Name (CNAME) record must conform to
             * [RFC2396](https://docs.aws.amazon.com/https://www.ietf.org/rfc/rfc2396.txt)
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: OcspConfigurationProperty
            ): software.amazon.awscdk.services.acmpca.CfnCertificateAuthority.OcspConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface GeneralNameProperty {
         ...
         * your private CA certificate. The Subject field in the certificate identifies the entity
         * that owns or controls the public key in the certificate. The entity can be a user,
         * computer, device, or service. The Subject must contain an X.500 distinguished name (DN).
         * A DN is a sequence of relative distinguished names (RDNs). The RDNs are separated by
         * commas in the certificate. The DN must be unique for each entity, but your private CA can
         ...
         * [RFC 822](https://docs.aws.amazon.com/https://datatracker.ietf.org/doc/html/rfc822) email
         * address.
         *
         ...
         */
        public fun uniformResourceIdentifier(): String? =
        ...
        public interface Builder {
            /**
             * @param directoryName Contains information about the certificate subject. The
             *   certificate can be one issued by your private certificate authority (CA) or it can
             *   be your private CA certificate. The Subject field in the certificate identifies the
             *   entity that owns or controls the public key in the certificate. The entity can be a
             *   user, computer, device, or service. The Subject must contain an X.500 distinguished
             *   name (DN). A DN is a sequence of relative distinguished names (RDNs). The RDNs are
             *   separated by commas in the certificate. The DN must be unique for each entity, but
             *   your private CA can issue more than one certificate with the same DN to the same
             *   entity.
             */
            ...
            /**
             * @param rfc822Name Represents `GeneralName` as an
             *   [RFC 822](https://docs.aws.amazon.com/https://datatracker.ietf.org/doc/html/rfc822)
             *   email address.
             */
        ...
        internal constructor(
             ...
             * Contains information about the certificate subject.
             *
             * The certificate can be one issued by your private certificate authority (CA) or it
             * can be your private CA certificate. The Subject field in the certificate identifies
             * the entity that owns or controls the public key in the certificate. The entity can be
    ...
    public interface CustomAttributeProperty {
        ...
        public interface Builder {
            /**
             * @param objectIdentifier Specifies the object identifier (OID) of the attribute type
             *   of the relative distinguished name (RDN).
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CustomAttributeProperty
            ): software.amazon.awscdk.services.acmpca.CfnCertificateAuthority.CustomAttributeProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
