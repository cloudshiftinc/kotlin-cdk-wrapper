...
internal constructor(
    ...
    public open fun livePreRollConfiguration(`value`: LivePreRollConfigurationProperty) {
        unwrap(this)
            .setLivePreRollConfiguration(`value`.let(LivePreRollConfigurationProperty::unwrap))
    }

    /** The configuration for pre-roll ad insertion. */
    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("0db95b6706374dbec6d68c46cf9a9408d732d7dc66026fc2ed75561b78f5011e")
    public open fun livePreRollConfiguration(
        `value`: LivePreRollConfigurationProperty.Builder.() -> Unit
    ...
    public open fun manifestProcessingRules(`value`: ManifestProcessingRulesProperty) {
        unwrap(this)
            .setManifestProcessingRules(`value`.let(ManifestProcessingRulesProperty::unwrap))
    }

    /** The configuration for manifest processing rules. */
    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("520c3725b546ad1bc5f63986b44d4cde1095720d9f0da56ad8b25859a64e80a5")
    public open fun manifestProcessingRules(
        `value`: ManifestProcessingRulesProperty.Builder.() -> Unit
    ): Unit = manifestProcessingRules(ManifestProcessingRulesProperty(`value`))
    ...
    public interface Builder {
         ...
         * parameters as needed when calling the ADS. Alternately, for testing you can provide a
         ...
         *
         * @param cdnConfiguration The configuration for using a content delivery network (CDN),
        ...
        public fun dashConfiguration(
            dashConfiguration: DashConfigurationProperty.Builder.() -> Unit
        )
        ...
        public fun livePreRollConfiguration(
            livePreRollConfiguration: LivePreRollConfigurationProperty.Builder.() -> Unit
        )
        ...
        public fun manifestProcessingRules(
            manifestProcessingRules: ManifestProcessingRulesProperty.Builder.() -> Unit
        )
         ...
         *
         * @param personalizationThresholdSeconds Defines the maximum duration of underfilled ad
         *   time (in seconds) allowed in an ad break.
         */
         ...
         * The URL for a video asset to transcode and use to fill in time that's not used by ads.
         *
         * AWS Elemental MediaTailor shows the slate to fill in gaps in media content. Configuring
         * the slate is optional for non-VPAID playback configurations. For VPAID, the slate is
         * required because MediaTailor provides it in the slots designated for dynamic ad content.
         ...
         *
         * @param slateAdUrl The URL for a video asset to transcode and use to fill in time that's
         *   not used by ads.
         */
         ...
         *
         * @param transcodeProfileName The name that is used to associate this playback
         *   configuration with a custom transcode profile.
         */
         ...
         *
         * @param videoContentSourceUrl The URL prefix for the parent manifest for the stream, minus
         *   the asset ID.
         */
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.mediatailor.CfnPlaybackConfiguration.Builder.create(
                scope,
                id
            )
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("d6924f99449990b6b0d5dd995c60cf2b6f1113dcda5bcf6c7259ebe0819a4567")
        override fun availSuppression(
            availSuppression: AvailSuppressionProperty.Builder.() -> Unit
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("0de38d0cd8cd9cf62650be13037818eec5e7b683f6549e8589f2a53dcb4a62d1")
        override fun cdnConfiguration(
            cdnConfiguration: CdnConfigurationProperty.Builder.() -> Unit
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("9721fe66029a0ca3f322a6e86e4a46b6a19242ed6d826a69e69cdab00427a55f")
        override fun dashConfiguration(
            dashConfiguration: DashConfigurationProperty.Builder.() -> Unit
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("5513dff53429d8e9883e964e7e6c98d600e1f0d5cc869ff26f4eec8a3d6e689b")
        override fun hlsConfiguration(
            hlsConfiguration: HlsConfigurationProperty.Builder.() -> Unit
         ...
         * @param livePreRollConfiguration The configuration for pre-roll ad insertion.
         */
        override fun livePreRollConfiguration(
            livePreRollConfiguration: LivePreRollConfigurationProperty
        ) {
            cdkBuilder.livePreRollConfiguration(
                livePreRollConfiguration.let(LivePreRollConfigurationProperty::unwrap)
            )
        }
        ...
        override fun livePreRollConfiguration(
            ...
            livePreRollConfiguration(LivePreRollConfigurationProperty(livePreRollConfiguration))
         ...
         * @param manifestProcessingRules The configuration for manifest processing rules.
         */
        override fun manifestProcessingRules(
            manifestProcessingRules: ManifestProcessingRulesProperty
        ) {
            cdkBuilder.manifestProcessingRules(
                manifestProcessingRules.let(ManifestProcessingRulesProperty::unwrap)
            )
        }
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnPlaybackConfiguration
    ...
    public interface CdnConfigurationProperty {
         ...
         *
         * By default, AWS Elemental MediaTailor uses Amazon CloudFront with default cache settings
         * as its CDN for ad segments. To set up an alternate CDN, create a rule in your CDN for the
         ...
         * don’t always have to go to the origin server.
         *
        ...
        public interface Builder {
             ...
             *   segments. By default, AWS Elemental MediaTailor uses Amazon CloudFront with default
             *   cache settings as its CDN for ad segments. To set up an alternate CDN, create a
             *   rule in your CDN for the origin ads.mediatailor. *<region>* .amazonaws.com. Then
             *   specify the rule's name in this `AdSegmentUrlPrefix` . When AWS Elemental
            ...
            /**
             * @param contentSegmentUrlPrefix A content delivery network (CDN) to cache content
             *   segments, so that content requests don’t always have to go to the origin server.
             *   First, create a rule in your CDN for the content segment origin server. Then
             *   specify the rule's name in this `ContentSegmentUrlPrefix` . When AWS Elemental
        ...
        internal constructor(
             ...
             * A non-default content delivery network (CDN) to serve ad segments.
             *
             * By default, AWS Elemental MediaTailor uses Amazon CloudFront with default cache
             * settings as its CDN for ad segments. To set up an alternate CDN, create a rule in
             * your CDN for the origin ads.mediatailor. *<region>* .amazonaws.com. Then specify the
             ...
             * don’t always have to go to the origin server.
             *
             * First, create a rule in your CDN for the content segment origin server. Then specify
             * the rule's name in this `ContentSegmentUrlPrefix` . When AWS Elemental MediaTailor
             * serves a manifest, it reports your CDN as the source for content segments.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-mediatailor-playbackconfiguration-cdnconfiguration.html#cfn-mediatailor-playbackconfiguration-cdnconfiguration-contentsegmenturlprefix)
             */
            override fun contentSegmentUrlPrefix(): String? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CdnConfigurationProperty
            ): software.amazon.awscdk.services.mediatailor.CfnPlaybackConfiguration.CdnConfigurationProperty =
    ...
    public interface LivePreRollConfigurationProperty {
        ...
        public interface Builder {
             ...
             *   session-specific parameters as needed when calling the ADS. Alternately, for
             *   testing, you can provide a static VAST URL. The maximum length is 25,000
             *   characters.
             */
            public fun adDecisionServerUrl(adDecisionServerUrl: String)
             ...
             *   Elemental MediaTailor won't play pre-roll ads to exceed this duration, regardless
        ...
        internal constructor(
             ...
             * This includes the specification of static parameters and placeholders for dynamic
             * parameters. AWS Elemental MediaTailor substitutes player-specific and
             * session-specific parameters as needed when calling the ADS. Alternately, for testing,
             ...
             * The maximum allowed duration for the pre-roll ad avail.
             *
             * AWS Elemental MediaTailor won't play pre-roll ads to exceed this duration, regardless
             * of the total duration of ads that the ADS returns.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-mediatailor-playbackconfiguration-liveprerollconfiguration.html#cfn-mediatailor-playbackconfiguration-liveprerollconfiguration-maxdurationseconds)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: LivePreRollConfigurationProperty
            ): software.amazon.awscdk.services.mediatailor.CfnPlaybackConfiguration.LivePreRollConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DashConfigurationProperty {
         ...
         * `EMT_DEFAULT` . The `EMT_DEFAULT` setting enables the inclusion of the tag and is the
         * default value.
         *
         ...
         * default setting is `MULTI_PERIOD` . For multi-period manifests, omit this setting or set
         * it to `MULTI_PERIOD` .
         *
        ...
        public interface Builder {
             ...
             *   session. The session uses server-side reporting. This setting is ignored in PUT
             *   operations.
             */
             ...
             *   Location tag in DASH manifests. MediaTailor populates the Location tag with the URL
             *   for manifest update requests, to be used by players that don't support sticky
             *   redirects. Disable this if you have CDN routing rules set up for accessing
             *   MediaTailor manifests, and you are either using client-side reporting or your
             *   players support sticky HTTP redirects. Valid values are `DISABLED` and
            ...
            /**
             * @param originManifestType The setting that controls whether MediaTailor handles
             *   manifests from the origin server as multi-period manifests or single-period
             *   manifests. If your origin server produces single-period manifests, set this to
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-mediatailor-playbackconfiguration-dashconfiguration.html#cfn-mediatailor-playbackconfiguration-dashconfiguration-manifestendpointprefix)
             */
            override fun manifestEndpointPrefix(): String? =
             ...
             * manifests.
             *
             * MediaTailor populates the Location tag with the URL for manifest update requests, to
             * be used by players that don't support sticky redirects. Disable this if you have CDN
             * routing rules set up for accessing MediaTailor manifests, and you are either using
             * client-side reporting or your players support sticky HTTP redirects. Valid values are
             * `DISABLED` and `EMT_DEFAULT` . The `EMT_DEFAULT` setting enables the inclusion of the
             ...
             * server as multi-period manifests or single-period manifests.
             *
             * If your origin server produces single-period manifests, set this to `SINGLE_PERIOD` .
             * The default setting is `MULTI_PERIOD` . For multi-period manifests, omit this setting
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DashConfigurationProperty
            ): software.amazon.awscdk.services.mediatailor.CfnPlaybackConfiguration.DashConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface HlsConfigurationProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: HlsConfigurationProperty
            ): software.amazon.awscdk.services.mediatailor.CfnPlaybackConfiguration.HlsConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface AvailSuppressionProperty {
         ...
         *
         * By default, ad suppression is off and all ad breaks are filled with ads or slate. When
         * Mode is set to `BEHIND_LIVE_EDGE` , ad suppression is active and MediaTailor won't fill
         * ad breaks on or behind the ad suppression Value time in the manifest lookback window.
         * When Mode is set to `AFTER_LIVE_EDGE` , ad suppression is active and MediaTailor won't
         ...
         *
         * MediaTailor won't fill ad breaks on or behind this time in the manifest lookback window.
         * If Value is set to 00:00:00, it is in sync with the live edge, and MediaTailor won't fill
         * any ad breaks on or behind the live edge. If you set a Value time, MediaTailor won't fill
         * any ad breaks on or behind this time in the manifest lookback window. For example, if you
         * set 00:45:00, then MediaTailor will fill ad breaks that occur within 45 minutes behind
         * the live edge, but won't fill ad breaks on or behind 45 minutes behind the live edge.
         *
        ...
        public interface Builder {
            /**
             * @param mode Sets the ad suppression mode. By default, ad suppression is off and all
             *   ad breaks are filled with ads or slate. When Mode is set to `BEHIND_LIVE_EDGE` , ad
            ...
            /**
             * @param value A live edge offset time in HH:MM:SS. MediaTailor won't fill ad breaks on
             ...
             *   behind the live edge. If you set a Value time, MediaTailor won't fill any ad breaks
             *   on or behind this time in the manifest lookback window. For example, if you set
             *   00:45:00, then MediaTailor will fill ad breaks that occur within 45 minutes behind
             *   the live edge, but won't fill ad breaks on or behind 45 minutes behind the live
             *   edge.
             */
        ...
        internal constructor(
             ...
             * Sets the ad suppression mode.
             *
             * By default, ad suppression is off and all ad breaks are filled with ads or slate.
             * When Mode is set to `BEHIND_LIVE_EDGE` , ad suppression is active and MediaTailor
             * won't fill ad breaks on or behind the ad suppression Value time in the manifest
             * lookback window. When Mode is set to `AFTER_LIVE_EDGE` , ad suppression is active and
             * MediaTailor won't fill ad breaks that are within the live edge plus the avail
             * suppression value.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-mediatailor-playbackconfiguration-availsuppression.html#cfn-mediatailor-playbackconfiguration-availsuppression-mode)
             */
             ...
             * A live edge offset time in HH:MM:SS.
             *
             * MediaTailor won't fill ad breaks on or behind this time in the manifest lookback
             * window. If Value is set to 00:00:00, it is in sync with the live edge, and
             * MediaTailor won't fill any ad breaks on or behind the live edge. If you set a Value
             * time, MediaTailor won't fill any ad breaks on or behind this time in the manifest
             * lookback window. For example, if you set 00:45:00, then MediaTailor will fill ad
             * breaks that occur within 45 minutes behind the live edge, but won't fill ad breaks on
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AvailSuppressionProperty
            ): software.amazon.awscdk.services.mediatailor.CfnPlaybackConfiguration.AvailSuppressionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ManifestProcessingRulesProperty {
        ...
        public interface Builder {
             ...
             *   `EXT-X-CUE-IN` , `EXT-X-CUE-OUT` , and `EXT-X-SPLICEPOINT-SCTE35` ad markers from
             *   the origin manifest to the MediaTailor personalized manifest. No logic is applied
             *   to these ad markers. For example, if `EXT-X-CUE-OUT` has a value of `60` , but no
            ...
            public fun adMarkerPassthrough(
                adMarkerPassthrough: AdMarkerPassthroughProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun adMarkerPassthrough(adMarkerPassthrough: AdMarkerPassthroughProperty) {
                cdkBuilder.adMarkerPassthrough(
                    adMarkerPassthrough.let(AdMarkerPassthroughProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("31a5ddef7bb8163764922d8d7fbbdd01c9762270611101fcd57f0a70c9e385be")
            override fun adMarkerPassthrough(
                adMarkerPassthrough: AdMarkerPassthroughProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ManifestProcessingRulesProperty
            ): software.amazon.awscdk.services.mediatailor.CfnPlaybackConfiguration.ManifestProcessingRulesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface AdMarkerPassthroughProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AdMarkerPassthroughProperty
            ): software.amazon.awscdk.services.mediatailor.CfnPlaybackConfiguration.AdMarkerPassthroughProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
