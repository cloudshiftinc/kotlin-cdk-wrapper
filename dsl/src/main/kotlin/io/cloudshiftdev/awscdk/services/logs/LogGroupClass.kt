...
public enum class LogGroupClass(
    ...
    public companion object {
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.logs.LogGroupClass
        ): LogGroupClass =
            when (cdkObject) {
                software.amazon.awscdk.services.logs.LogGroupClass.STANDARD ->
        ...
        internal fun unwrap(
            wrapped: LogGroupClass
        ): software.amazon.awscdk.services.logs.LogGroupClass = wrapped.cdkObject
    }
}
