...
internal constructor(
     ...
     * @param options
     */
    public override fun constrainCloudFormationParameters(
        product: IProduct,
     ...
     * @param options
     */
    public override fun constrainTagUpdates(
        product: IProduct,
     ...
     * @param options
     */
    public override fun deployWithStackSets(
        product: IProduct,
    ...
    public override fun shareWithAccount(
        accountId: String,
    ...
    public companion object {
        public fun fromPortfolioArn(
            ...
            software.amazon.awscdk.services.servicecatalog.Portfolio.fromPortfolioArn(
