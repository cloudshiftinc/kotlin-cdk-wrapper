...
public open class DatabaseInstanceFromSnapshot
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.rds.DatabaseInstanceFromSnapshot,
    ...
    /** A fluent builder for [io.cloudshiftdev.awscdk.services.rds.DatabaseInstanceFromSnapshot]. */
    @CdkDslMarker
    public interface Builder {
         ...
         *
         * @param backupRetention The number of days during which automatic DB snapshots are
         *   retained.
         */
         ...
         * Default: true
         *
         * @param copyTagsToSnapshot Indicates whether to copy all of the user-defined tags from the
         ...
         *
         * @param deletionProtection Indicates whether the DB instance should have deletion
         *   protection enabled.
         */
         ...
         *
         * Default: - The role will be created for you if `DatabaseInstanceNewProps#domain` is
         * specified
         *
         ...
         * allocated storage is less than 400 GiB for MariaDB, MySQL, and PostgreSQL, less than 200
         * GiB for Oracle and less than 20 GiB for SQL Server. 12,000 IOPS otherwise (except for SQL
         * Server where the default is always 3,000 IOPS).
         *
         ...
         *
         * @param maxAllocatedStorage Upper limit to which RDS can scale the storage in
         *   GiB(Gibibyte).
         */
         ...
         * Default: false
         *
         * @param multiAz Specifies if the database instance is a multiple Availability Zone
         *   deployment.
         */
         ...
         * AWS Region. To see the time blocks available, see
         ...
         *
         * Default: - `true` if the instance's `vpcSubnets` is `subnetType: SubnetType.PUBLIC`,
         * `false` otherwise
         *
         ...
         *
         * Default: - RemovalPolicy.SNAPSHOT (remove the resource, but retain a snapshot of the
         * data)
         *
         ...
         * [Documentation](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/oracle-s3-integration.html)
         *
         * @param s3ExportRole Role that will be associated with this DB instance to enable S3
         *   export.
         */
         ...
         *
         * This feature is only supported by the Microsoft SQL Server, Oracle, and PostgreSQL
         * engines.
         *
         ...
         * [Documentation](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/PostgreSQL.Procedural.Importing.html)
         *
         * @param s3ImportRole Role that will be associated with this DB instance to enable S3
         *   import.
         */
         ...
         * snapshot.
         *
         * @param snapshotIdentifier The name or Amazon Resource Name (ARN) of the DB snapshot
         ...
         *
         * @param storageThroughput The storage throughput, specified in mebibytes per second
         *   (MiBps).
         */
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.rds.DatabaseInstanceFromSnapshot.Builder.create(
                scope,
                id
            )
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("088d038790dca834480dc9a8c529f4fd62e96101adf5fd6e6382269fb89453f4")
        override fun processorFeatures(
            processorFeatures: ProcessorFeatures.Builder.() -> Unit
    ...
    public companion object {
        ...
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.rds.DatabaseInstanceFromSnapshot
        ): DatabaseInstanceFromSnapshot = DatabaseInstanceFromSnapshot(cdkObject)

        internal fun unwrap(
            wrapped: DatabaseInstanceFromSnapshot
