...
public interface StringParameterAttributes : CommonStringParameterAttributes {
     ...
     * CfnParameter or a dynamic reference). Use this flag to override the representation when it
     * does not work.
     *
     * Default: false
     */
     ...
     *
     * Using specific types can be helpful in catching invalid values at the start of creating or
     * updating a stack. CloudFormation validates the values against existing values in the account.
     *
    ...
    public interface Builder {
        /**
         * @param forceDynamicReference Use a dynamic reference as the representation in
         *   CloudFormation template level. By default, CDK tries to deduce an appropriate
         *   representation based on the parameter value (a CfnParameter or a dynamic reference).
        ...
        /**
         * @param valueType The type of the string parameter value. Using specific types can be
    ...
    internal constructor(
         ...
         * Use a dynamic reference as the representation in CloudFormation template level.
         *
         * By default, CDK tries to deduce an appropriate representation based on the parameter
         * value (a CfnParameter or a dynamic reference). Use this flag to override the
         ...
         * The type of the string parameter value.
         *
         * Using specific types can be helpful in catching invalid values at the start of creating
         * or updating a stack. CloudFormation validates the values against existing values in the
         * account.
         *
         * Note - if you want to allow values from different AWS accounts, use
         * ParameterValueType.STRING
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: StringParameterAttributes
