...
internal constructor(
    ...
    public companion object {
        ...
        public fun resourceServer(
            ...
            software.amazon.awscdk.services.cognito.OAuthScope.resourceServer(
                    server.let(IUserPoolResourceServer::unwrap),
                    scope.let(ResourceServerScope::unwrap)
                )
                .let(OAuthScope::wrap)
        ...
        public fun resourceServer(
            server: IUserPoolResourceServer,
            scope: ResourceServerScope.Builder.() -> Unit
        ): OAuthScope = resourceServer(server, ResourceServerScope(scope))

        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.cognito.OAuthScope
        ): OAuthScope = OAuthScope(cdkObject)

        internal fun unwrap(
            wrapped: OAuthScope
        ): software.amazon.awscdk.services.cognito.OAuthScope = wrapped.cdkObject
    }
}
