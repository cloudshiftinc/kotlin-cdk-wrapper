...
public interface FlowLogDestinationConfig {
    ...
    public interface Builder {
        /**
         * @param deliveryStreamArn The ARN of Kinesis Data Firehose delivery stream to publish the
         *   flow logs to.
         */
    ...
    private class BuilderImpl : Builder {
        ...
        override fun destinationOptions(
            destinationOptions: DestinationOptions.Builder.() -> Unit
        ): Unit = destinationOptions(DestinationOptions(destinationOptions))
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: FlowLogDestinationConfig
