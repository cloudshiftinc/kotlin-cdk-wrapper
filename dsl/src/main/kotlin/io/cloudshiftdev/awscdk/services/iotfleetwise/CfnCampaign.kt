...
internal constructor(
    ...
    public open fun dataExtraDimensions(): List<String> =
        unwrap(this).getDataExtraDimensions() ?: emptyList()
    ...
    public interface Builder {
         ...
         *
         * @param action Specifies how to update a campaign. The action can be one of the
         *   following:.
         */
         ...
         *
         * @param compression (Optional) Whether to compress signals before transmitting data to AWS
         *   IoT FleetWise .
         */
         ...
         * and analytics. AWS IoT FleetWise supports at-least-once file delivery to S3. Your vehicle
         * data is stored on multiple AWS IoT FleetWise servers for redundancy and high
         * availability.
         *
         ...
         * the campaign, and AWS IoT FleetWise will associate the data with those attributes as
         ...
         *
         * @param diagnosticsMode (Optional) Option for a vehicle to send diagnostic trouble codes
         ...
         *
         * @param expiryTime (Optional) The time the campaign expires, in seconds since epoch
         ...
         * certain vehicle or fleet.
         *
         * A campaign with the lowest value is deployed to vehicles before any other campaigns. If
         ...
         *
         * @param signalCatalogArn The Amazon Resource Name (ARN) of the signal catalog associated
         *   with the campaign.
         */
         ...
         *
         * @param targetArn The Amazon Resource Name (ARN) of a vehicle or fleet to which the
    ...
    private class BuilderImpl(
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("23e874d3a7fb59a1ad9dd2e35c421f8957a6099da01feca6c7bd8d5039ddd67d")
        override fun collectionScheme(
            collectionScheme: CollectionSchemeProperty.Builder.() -> Unit
    ...
    public interface TimeBasedCollectionSchemeProperty {
        ...
        public interface Builder {
            /**
             * @param periodMs The time period (in milliseconds) to decide how often to collect
             *   data. For example, if the time period is `60000` , the Edge Agent software collects
             *   data once every minute.
             */
        ...
        internal constructor(
             ...
             * The time period (in milliseconds) to decide how often to collect data.
             *
             * For example, if the time period is `60000` , the Edge Agent software collects data
             * once every minute.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-iotfleetwise-campaign-timebasedcollectionscheme.html#cfn-iotfleetwise-campaign-timebasedcollectionscheme-periodms)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TimeBasedCollectionSchemeProperty
            ): software.amazon.awscdk.services.iotfleetwise.CfnCampaign.TimeBasedCollectionSchemeProperty =
    ...
    public interface CollectionSchemeProperty {
        ...
        public interface Builder {
            /**
             * @param conditionBasedCollectionScheme (Optional) Information about a collection
             *   scheme that uses a simple logical expression to recognize what data to collect.
             */
             ...
             *   scheme that uses a simple logical expression to recognize what data to collect.
             */
            public fun conditionBasedCollectionScheme(
            ...
            public fun conditionBasedCollectionScheme(
                conditionBasedCollectionScheme:
                    ConditionBasedCollectionSchemeProperty.Builder.() -> Unit
            )

            /**
             * @param timeBasedCollectionScheme (Optional) Information about a collection scheme
             *   that uses a time period to decide how often to collect data.
             */
             ...
             *   that uses a time period to decide how often to collect data.
             */
            public fun timeBasedCollectionScheme(
            ...
            public fun timeBasedCollectionScheme(
                timeBasedCollectionScheme: TimeBasedCollectionSchemeProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
             ...
             *   scheme that uses a simple logical expression to recognize what data to collect.
             */
            override fun conditionBasedCollectionScheme(
                conditionBasedCollectionScheme: IResolvable
            ) {
                cdkBuilder.conditionBasedCollectionScheme(
                    conditionBasedCollectionScheme.let(IResolvable::unwrap)
                )
            }
            ...
            override fun conditionBasedCollectionScheme(
                ...
                cdkBuilder.conditionBasedCollectionScheme(
                    conditionBasedCollectionScheme.let(
                        ConditionBasedCollectionSchemeProperty::unwrap
                    )
                )
            }
            ...
            override fun conditionBasedCollectionScheme(
                ...
                conditionBasedCollectionScheme(
                    ConditionBasedCollectionSchemeProperty(conditionBasedCollectionScheme)
                )
            ...
            override fun timeBasedCollectionScheme(timeBasedCollectionScheme: IResolvable) {
                cdkBuilder.timeBasedCollectionScheme(
                    timeBasedCollectionScheme.let(IResolvable::unwrap)
                )
            }
             ...
             *   that uses a time period to decide how often to collect data.
             */
            override fun timeBasedCollectionScheme(
                timeBasedCollectionScheme: TimeBasedCollectionSchemeProperty
            ) {
                cdkBuilder.timeBasedCollectionScheme(
                    timeBasedCollectionScheme.let(TimeBasedCollectionSchemeProperty::unwrap)
                )
            }
            ...
            override fun timeBasedCollectionScheme(
                ...
                timeBasedCollectionScheme(
                    TimeBasedCollectionSchemeProperty(timeBasedCollectionScheme)
                )
        ...
        internal constructor(
            ...
            /**
             * (Optional) Information about a collection scheme that uses a simple logical
            ...
            /**
             * (Optional) Information about a collection scheme that uses a time period to decide
             * how often to collect data.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-iotfleetwise-campaign-collectionscheme.html#cfn-iotfleetwise-campaign-collectionscheme-timebasedcollectionscheme)
             */
            override fun timeBasedCollectionScheme(): Any? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CollectionSchemeProperty
            ): software.amazon.awscdk.services.iotfleetwise.CfnCampaign.CollectionSchemeProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SignalInformationProperty {
        ...
        /**
         * (Optional) The minimum duration of time (in milliseconds) between two triggering events
         * to collect data.
         *
         ...
         */
        public fun minimumSamplingIntervalMs(): Number? =
        ...
        public interface Builder {
            ...
            /**
             * @param minimumSamplingIntervalMs (Optional) The minimum duration of time (in
             *   milliseconds) between two triggering events to collect data.
             *
             * If a signal changes often, you might want to collect data at a slower rate.
             */
        ...
        internal constructor(
            ...
            /**
             * (Optional) The minimum duration of time (in milliseconds) between two triggering
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SignalInformationProperty
            ): software.amazon.awscdk.services.iotfleetwise.CfnCampaign.SignalInformationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface TimestreamConfigProperty {
        ...
        public interface Builder {
            /**
             * @param executionRoleArn The Amazon Resource Name (ARN) of the task execution role
             *   that grants AWS IoT FleetWise permission to deliver data to the Amazon Timestream
             *   table.
             */
            public fun executionRoleArn(executionRoleArn: String)

            /**
             * @param timestreamTableArn The Amazon Resource Name (ARN) of the Amazon Timestream
             *   table.
             */
        ...
        internal constructor(
            ...
            /**
             * The Amazon Resource Name (ARN) of the task execution role that grants AWS IoT
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TimestreamConfigProperty
            ): software.amazon.awscdk.services.iotfleetwise.CfnCampaign.TimestreamConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DataDestinationConfigProperty {
        ...
        public interface Builder {
            /**
             * @param s3Config (Optional) The Amazon S3 bucket where the AWS IoT FleetWise campaign
             *   sends data.
             */
            ...
            /**
             * @param timestreamConfig (Optional) The Amazon Timestream table where the campaign
             *   sends data.
             */
            ...
            public fun timestreamConfig(
                timestreamConfig: TimestreamConfigProperty.Builder.() -> Unit
            )
        }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DataDestinationConfigProperty
            ): software.amazon.awscdk.services.iotfleetwise.CfnCampaign.DataDestinationConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ConditionBasedCollectionSchemeProperty {
         ...
         *
         * Specify ( `RISING_EDGE` ), or specify only when the condition first evaluates to false.
         * For example, triggering on "AirbagDeployed"; Users aren't interested on triggering when
         * the airbag is already exploded; they only care about the change from not deployed =&gt;
         * deployed.
         *
        ...
        public interface Builder {
            ...
            /**
             * @param expression The logical expression used to recognize what data to collect. For
            ...
            /**
             * @param triggerMode (Optional) Whether to collect data for all triggering events (
             ...
             *   interested on triggering when the airbag is already exploded; they only care about
             *   the change from not deployed =&gt; deployed.
             */
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-iotfleetwise-campaign-conditionbasedcollectionscheme.html#cfn-iotfleetwise-campaign-conditionbasedcollectionscheme-conditionlanguageversion)
             */
            override fun conditionLanguageVersion(): Number? =
            ...
            /**
             * (Optional) The minimum duration of time between two triggering events to collect
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-iotfleetwise-campaign-conditionbasedcollectionscheme.html#cfn-iotfleetwise-campaign-conditionbasedcollectionscheme-minimumtriggerintervalms)
             */
            override fun minimumTriggerIntervalMs(): Number? =
                unwrap(this).getMinimumTriggerIntervalMs()

            /**
             * (Optional) Whether to collect data for all triggering events ( `ALWAYS` ).
             *
             * Specify ( `RISING_EDGE` ), or specify only when the condition first evaluates to
             * false. For example, triggering on "AirbagDeployed"; Users aren't interested on
             * triggering when the airbag is already exploded; they only care about the change from
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ConditionBasedCollectionSchemeProperty
            ): software.amazon.awscdk.services.iotfleetwise.CfnCampaign.ConditionBasedCollectionSchemeProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface S3ConfigProperty {
         ...
         * You can use the prefix to organize data stored in Amazon S3 buckets. For more
         * information, see
         ...
         * S3 . You can enter a prefix to append it to this default prefix. For example, if you
         * enter the prefix `vehicles` , the prefix will be
        ...
        public interface Builder {
             ...
             *   bucket. You can save files in an Apache Parquet or JSON format.
             * * Parquet - Store data in a columnar storage file format. Parquet is optimal for fast
             *   data retrieval and can reduce costs. This option is selected by default.
             * * JSON - Store data in a standard text-based JSON file format.
             */
            ...
            /**
             * @param prefix (Optional) Enter an S3 bucket prefix. The prefix is the string of
             *   characters after the bucket name and before the object name. You can use the prefix
             *   to organize data stored in Amazon S3 buckets. For more information, see
             *   [Organizing objects using prefixes](https://docs.aws.amazon.com/AmazonS3/latest/userguide/using-prefixes.html)
             *   in the *Amazon Simple Storage Service User Guide* .
             *
             * By default, AWS IoT FleetWise sets the prefix
             * `processed-data/year=YY/month=MM/date=DD/hour=HH/` (in UTC) to data it delivers to
             * Amazon S3 . You can enter a prefix to append it to this default prefix. For example,
             * if you enter the prefix `vehicles` , the prefix will be
             * `vehicles/processed-data/year=YY/month=MM/date=DD/hour=HH/` .
             */
            public fun prefix(prefix: String)

            /**
             * @param storageCompressionFormat (Optional) By default, stored data is compressed as a
             *   .gzip file. Compressed files have a reduced file size, which can optimize the cost
             *   of data storage.
             */
        ...
        internal constructor(
             ...
             * name. You can use the prefix to organize data stored in Amazon S3 buckets. For more
             * information, see
             * [Organizing objects using prefixes](https://docs.aws.amazon.com/AmazonS3/latest/userguide/using-prefixes.html)
             * in the *Amazon Simple Storage Service User Guide* .
             *
            ...
            /**
             * (Optional) By default, stored data is compressed as a .gzip file. Compressed files
             * have a reduced file size, which can optimize the cost of data storage.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-iotfleetwise-campaign-s3config.html#cfn-iotfleetwise-campaign-s3config-storagecompressionformat)
             */
            override fun storageCompressionFormat(): String? =
