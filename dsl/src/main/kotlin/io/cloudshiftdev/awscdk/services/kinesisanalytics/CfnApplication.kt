...
internal constructor(
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.kinesisanalytics.CfnApplication.Builder.create(
                scope,
                id
            )
    ...
    public interface KinesisStreamsInputProperty {
        ...
        public interface Builder {
             ...
             *   the stream on your behalf. You need to grant the necessary permissions to this
             *   role.
             */
    ...
    public interface KinesisFirehoseInputProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param roleArn ARN of the IAM role that Amazon Kinesis Analytics can assume to access
             *   the stream on your behalf. You need to make sure that the role has the necessary
        ...
        internal constructor(
             ...
             * your behalf.
             *
             * You need to make sure that the role has the necessary permissions to access the
             * stream.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-kinesisanalytics-application-kinesisfirehoseinput.html#cfn-kinesisanalytics-application-kinesisfirehoseinput-rolearn)
             */
    ...
    public interface InputProperty {
         ...
         * streams with names "MyInApplicationStream_001," "MyInApplicationStream_002," and so on.
         *
        ...
        public interface Builder {
            ...
            /**
             * @param kinesisFirehoseInput If the streaming source is an Amazon Kinesis Firehose
             *   delivery stream, identifies the delivery stream's ARN and an IAM role that enables
             *   Amazon Kinesis Analytics to access the stream on your behalf. Note: Either
             *   `KinesisStreamsInput` or `KinesisFirehoseInput` is required.
             */
            ...
            /**
             * @param kinesisStreamsInput If the streaming source is an Amazon Kinesis stream,
             *   identifies the stream's Amazon Resource Name (ARN) and an IAM role that enables
             *   Amazon Kinesis Analytics to access the stream on your behalf. Note: Either
             *   `KinesisStreamsInput` or `KinesisFirehoseInput` is required.
             */
            ...
            /**
             * @param namePrefix Name prefix to use when creating an in-application stream. Suppose
             *   that you specify a prefix "MyInApplicationStream." Amazon Kinesis Analytics then
        ...
        internal constructor(
             ...
             * Name prefix to use when creating an in-application stream.
             *
             * Suppose that you specify a prefix "MyInApplicationStream." Amazon Kinesis Analytics
             * then creates one or more (as per the `InputParallelism` count you specified)
             * in-application streams with names "MyInApplicationStream_001,"
             * "MyInApplicationStream_002," and so on.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-kinesisanalytics-application-input.html#cfn-kinesisanalytics-application-input-nameprefix)
    ...
    public interface InputLambdaProcessorProperty {
        /**
         * The ARN of the [AWS Lambda](https://docs.aws.amazon.com/lambda/) function that operates
        ...
        public interface Builder {
            ...
            /**
             * @param roleArn The ARN of the IAM role that is used to access the AWS Lambda
             *   function.
             */
            public fun roleArn(roleArn: String)
        }
