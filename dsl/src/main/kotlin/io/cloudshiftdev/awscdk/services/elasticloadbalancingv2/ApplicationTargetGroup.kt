...
internal constructor(
     ...
     *
     * Returns the metric for this target group from the point of view of the first load balancer
     * load balancing to it. If you have multiple load balancers load sending traffic to the same
     * target group, you will have to override the dimensions on this metric.
     *
     ...
     * @param associatingConstruct
     */
    public override fun registerListener(
    ...
    public interface Builder {
         ...
         *
         * Default: - The default value for each property in this configuration varies depending on
         * the target.
         *
         ...
         *
         * @param loadBalancingAlgorithmType The load balancing algorithm to select targets for
         *   routing requests.
         */
         ...
         *
         * Note: `stickinessCookieName` parameter depends on the presence of
         * `stickinessCookieDuration` parameter. If `stickinessCookieDuration` is not set,
         * `stickinessCookieName` will be omitted.
         *
         * Default: - If `stickinessCookieDuration` is set, a load-balancer generated cookie is
         * used. Otherwise, no stickiness is defined.
         *
         * [Documentation](https://docs.aws.amazon.com/elasticloadbalancing/latest/application/sticky-sessions.html)
         *
         ...
         *
         * All targets registered into the group must be of this type. If you register targets to
         * the TargetGroup in the CDK app, the TargetType is determined automatically.
         *
         * Default: - Determined automatically.
         *
         * @param targetType The type of targets registered to this TargetGroup, either IP or
         *   Instance.
         */
    ...
    private class BuilderImpl(
         ...
         *   routing requests.
         */
        override fun loadBalancingAlgorithmType(
            loadBalancingAlgorithmType: TargetGroupLoadBalancingAlgorithmType
        ) {
            cdkBuilder.loadBalancingAlgorithmType(
                loadBalancingAlgorithmType.let(TargetGroupLoadBalancingAlgorithmType::unwrap)
            )
        }
    ...
    public companion object {
        public fun fromTargetGroupAttributes(
            ...
            software.amazon.awscdk.services.elasticloadbalancingv2.ApplicationTargetGroup
                .fromTargetGroupAttributes(
                    ...
                    id,
                    attrs.let(TargetGroupAttributes::unwrap)
                )
                .let(IApplicationTargetGroup::wrap)
        ...
        public fun fromTargetGroupAttributes(
            ...
            fromTargetGroupAttributes(scope, id, TargetGroupAttributes(attrs))
        ...
        internal fun unwrap(
            wrapped: ApplicationTargetGroup
        ): software.amazon.awscdk.services.elasticloadbalancingv2.ApplicationTargetGroup =
            wrapped.cdkObject
    }
}
