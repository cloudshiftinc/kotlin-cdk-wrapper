...
internal constructor(
    ...
    public interface Builder {
        ...
        /**
         * Describes a SQL-based Managed Service for Apache Flink application's output
         ...
         *   configuration, in which you identify an in-application stream and a destination where
         *   you want the in-application stream data to be written.
         */
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.kinesisanalyticsv2.CfnApplicationOutput.Builder.create(
                scope,
                id
            )
    ...
    public companion object {
        ...
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.kinesisanalyticsv2.CfnApplicationOutput
    ...
    public interface OutputProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param kinesisFirehoseOutput Identifies a Kinesis Data Firehose delivery stream as
             *   the destination.
             */
    ...
    public interface LambdaOutputProperty {
        ...
        public interface Builder {
            /**
             * @param resourceArn The Amazon Resource Name (ARN) of the destination Lambda function
             *   to write to.
             *
