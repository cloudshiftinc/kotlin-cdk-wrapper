...
internal constructor(
    ...
    /**
     * The timestamp for when the route calculator resource was created in
    ...
    /**
     * The timestamp for when the route calculator resource was last updated in
     * [ISO 8601](https://docs.aws.amazon.com/https://www.iso.org/iso-8601-date-and-time-format.html)
     * format: `YYYY-MM-DDThh:mm:ss.sssZ` .
     */
    ...
    public interface Builder {
         ...
         *
         * Requirements:
         * * Can use alphanumeric characters (A–Z, a–z, 0–9) , hyphens (-), periods (.), and
         *   underscores (_).
