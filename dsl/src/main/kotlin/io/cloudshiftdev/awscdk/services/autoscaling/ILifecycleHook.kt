...
public interface ILifecycleHook : IResource {
    ...
    internal constructor(
         ...
         * The role for the lifecycle hook to execute.
         *
         * Default: - A default role is created if 'notificationTarget' is specified. Otherwise, no
         * role is created.
         */
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: ILifecycleHook
        ): software.amazon.awscdk.services.autoscaling.ILifecycleHook =
