...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.greengrass.CfnCoreDefinition,
    ...
    public open fun initialVersion(
        `value`: CoreDefinitionVersionProperty.Builder.() -> Unit
    ): Unit = initialVersion(CoreDefinitionVersionProperty(`value`))
    ...
    private class BuilderImpl(
        ...
        override fun initialVersion(
            initialVersion: CoreDefinitionVersionProperty.Builder.() -> Unit
    ...
    public interface CoreProperty {
         ...
         *
         * This X.509 certificate is used to authenticate the core with AWS IoT and AWS IoT
         * Greengrass services.
         *
        ...
        public interface Builder {
            /**
             * @param certificateArn The Amazon Resource Name (ARN) of the device certificate for
             *   the core. This X.509 certificate is used to authenticate the core with AWS IoT and
             *   AWS IoT Greengrass services.
             */
            public fun certificateArn(certificateArn: String)

            /**
             * @param id A descriptive or arbitrary ID for the core. This value must be unique
             *   within the core definition version. Maximum length is 128 characters with pattern
             *   `[a-zA-Z0-9:_-]+` .
             */
    ...
    public interface CoreDefinitionVersionProperty {
        ...
        public interface Builder {
            /**
             * @param cores The Greengrass core in this version. Currently, the `Cores` property for
        ...
        internal constructor(
             ...
             * The Greengrass core in this version.
             *
             * Currently, the `Cores` property for a core definition version can contain only one
             * core.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-greengrass-coredefinition-coredefinitionversion.html#cfn-greengrass-coredefinition-coredefinitionversion-cores)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CoreDefinitionVersionProperty
            ): software.amazon.awscdk.services.greengrass.CfnCoreDefinition.CoreDefinitionVersionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
