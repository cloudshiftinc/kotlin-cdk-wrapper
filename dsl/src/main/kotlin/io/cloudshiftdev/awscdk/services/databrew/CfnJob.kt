...
internal constructor(
    ...
    public open fun profileConfiguration(
        `value`: ProfileConfigurationProperty.Builder.() -> Unit
    ...
    public interface Builder {
        /**
         * One or more artifacts that represent the AWS Glue Data Catalog output from running the
         * job.
         *
         ...
         *
         * @param databaseOutputs Represents a list of JDBC database output objects which defines
         ...
         *
         * @param encryptionKeyArn The Amazon Resource Name (ARN) of an encryption key that is used
         *   to protect the job output.
         */
         ...
         *
         * @param encryptionMode The encryption mode for the job, which can be one of the
         *   following:.
         */
        public fun encryptionMode(encryptionMode: String)

        /**
         * A sample configuration for profile jobs only, which determines the number of rows on
         * which the profile job is run.
         *
         ...
         *
         * @param jobSample A sample configuration for profile jobs only, which determines the
         *   number of rows on which the profile job is run.
         */
         ...
         *
         * @param maxCapacity The maximum number of nodes that can be consumed when the job
         *   processes data.
         */
         ...
         * Configuration for profile jobs.
         *
         * Configuration can be used to select columns, do evaluations, and override default
         * parameters of evaluations. When configuration is undefined, the profile job will apply
         * default settings to all supported columns.
         *
        ...
        public fun profileConfiguration(
            profileConfiguration: ProfileConfigurationProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("7075009e7896fa2dac2cb2a0801bb0767f212db5c58846c9c3602666778667af")
        override fun outputLocation(
            outputLocation: OutputLocationProperty.Builder.() -> Unit
        ...
        override fun profileConfiguration(profileConfiguration: ProfileConfigurationProperty) {
            cdkBuilder.profileConfiguration(
                profileConfiguration.let(ProfileConfigurationProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("b51a4b5e47d6827520d89764cd2c50826dc27eb6c70d83a7c6ecd3719514a065")
        override fun profileConfiguration(
            profileConfiguration: ProfileConfigurationProperty.Builder.() -> Unit
    ...
    public interface OutputLocationProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: OutputLocationProperty
            ): software.amazon.awscdk.services.databrew.CfnJob.OutputLocationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DataCatalogOutputProperty {
        ...
        public interface Builder {
            /**
             * @param catalogId The unique identifier of the AWS account that holds the Data Catalog
            ...
            /**
             * @param databaseOptions Represents options that specify how and where DataBrew writes
            ...
            public fun databaseOptions(
                databaseOptions: DatabaseTableOutputOptionsProperty.Builder.() -> Unit
            )

            /**
             * @param overwrite A value that, if true, means that any data in the location specified
             *   for output is overwritten with new output. Not supported with DatabaseOptions.
             */
            ...
            /**
             * @param s3Options Represents options that specify how and where DataBrew writes the
        ...
        private class BuilderImpl : Builder {
            ...
            override fun databaseOptions(databaseOptions: DatabaseTableOutputOptionsProperty) {
                cdkBuilder.databaseOptions(
                    databaseOptions.let(DatabaseTableOutputOptionsProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("1d15bd4718f2f177d93f4a891e11f0dfe436114e63f06eaa7fbc97bab31dbc36")
            override fun s3Options(
                s3Options: S3TableOutputOptionsProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DataCatalogOutputProperty
            ): software.amazon.awscdk.services.databrew.CfnJob.DataCatalogOutputProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface AllowedStatisticsProperty {
        ...
        public interface Builder {
            /**
             * @param statistics One or more column statistics to allow for columns that contain
             *   detected entities.
             */
        ...
        private class BuilderImpl : Builder {
             ...
             *   detected entities.
             */
            override fun statistics(vararg statistics: String): Unit =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AllowedStatisticsProperty
            ): software.amazon.awscdk.services.databrew.CfnJob.AllowedStatisticsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface StatisticOverrideProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: StatisticOverrideProperty
            ): software.amazon.awscdk.services.databrew.CfnJob.StatisticOverrideProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CsvOutputOptionsProperty {
        ...
        public interface Builder {
            /**
             * @param delimiter A single character that specifies the delimiter used to create CSV
             *   job output.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CsvOutputOptionsProperty
            ): software.amazon.awscdk.services.databrew.CfnJob.CsvOutputOptionsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface OutputProperty {
         ...
         */
        public fun partitionColumns(): List<String> =
            unwrap(this).getPartitionColumns() ?: emptyList()

        /** A builder for [OutputProperty] */
        @CdkDslMarker
        public interface Builder {
            /**
             * @param compressionFormat The compression algorithm used to compress the output text
             *   of the job.
             */
            ...
            /**
             * @param formatOptions Represents options that define how DataBrew formats job output
             *   files.
             */
            ...
            /**
             * @param maxOutputFiles The maximum number of files to be generated by the job and
            ...
            /**
             * @param partitionColumns The names of one or more partition columns for the output of
             *   the job.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("7839962fc021fba29606c84c0c1f2af7c3053d3d71d87a0eccef3a1d43d5a9d8")
            override fun formatOptions(
                formatOptions: OutputFormatOptionsProperty.Builder.() -> Unit
        ...
        internal constructor(
            ...
            /**
             * The maximum number of files to be generated by the job and written to the output
             * folder.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-databrew-job-output.html#cfn-databrew-job-output-maxoutputfiles)
             */
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-databrew-job-output.html#cfn-databrew-job-output-partitioncolumns)
             */
            override fun partitionColumns(): List<String> =
                unwrap(this).getPartitionColumns() ?: emptyList()
        }
    ...
    public interface DatabaseTableOutputOptionsProperty {
        ...
        public interface Builder {
            /**
             * @param tableName A prefix for the name of a table DataBrew will create in the
             *   database.
             */
            public fun tableName(tableName: String)

            /**
             * @param tempDirectory Represents an Amazon S3 location (bucket name and object key)
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DatabaseTableOutputOptionsProperty
            ): software.amazon.awscdk.services.databrew.CfnJob.DatabaseTableOutputOptionsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface EntityDetectorConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param allowedStatistics Configuration of statistics that are allowed to be run on
             *   columns that contain detected entities. When undefined, no statistics will be
            ...
            public fun allowedStatistics(
                allowedStatistics: AllowedStatisticsProperty.Builder.() -> Unit
            )
        ...
        private class BuilderImpl : Builder {
            ...
            override fun allowedStatistics(allowedStatistics: AllowedStatisticsProperty) {
                cdkBuilder.allowedStatistics(
                    allowedStatistics.let(AllowedStatisticsProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("18a52ea22ca052defefa3edb2935f140eea9a62c96d99a18fa5a366cc9a75b9b")
            override fun allowedStatistics(
                allowedStatistics: AllowedStatisticsProperty.Builder.() -> Unit
             ...
             * types except PERSON_NAME and DATE.
             */
            override fun entityTypes(vararg entityTypes: String): Unit =
        ...
        internal constructor(
             ...
             * detected entities.
             *
             * When undefined, no statistics will be computed on columns that contain detected
             * entities.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-databrew-job-entitydetectorconfiguration.html#cfn-databrew-job-entitydetectorconfiguration-allowedstatistics)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: EntityDetectorConfigurationProperty
            ): software.amazon.awscdk.services.databrew.CfnJob.EntityDetectorConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ColumnStatisticsConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param selectors List of column selectors. Selectors can be used to select columns
             *   from the dataset. When selectors are undefined, configuration will be applied to
            ...
            /**
             * @param statistics Configuration for evaluations. Statistics can be used to select
        ...
        private class BuilderImpl : Builder {
            ...
            override fun statistics(
                statistics: StatisticsConfigurationProperty.Builder.() -> Unit
            ): Unit = statistics(StatisticsConfigurationProperty(statistics))
        ...
        internal constructor(
             ...
             * List of column selectors.
             *
             * Selectors can be used to select columns from the dataset. When selectors are
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ColumnStatisticsConfigurationProperty
            ): software.amazon.awscdk.services.databrew.CfnJob.ColumnStatisticsConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ValidationConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param rulesetArn The Amazon Resource Name (ARN) for the ruleset to be validated in
             *   the profile job. The TargetArn of the selected ruleset should be the same as the
             *   Amazon Resource Name (ARN) of the dataset that is associated with the profile job.
             */
            public fun rulesetArn(rulesetArn: String)

            /**
             * @param validationMode Mode of data quality validation. Default mode is “CHECK_ALL”
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ValidationConfigurationProperty
            ): software.amazon.awscdk.services.databrew.CfnJob.ValidationConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface StatisticsConfigurationProperty {
         ...
         */
        public fun includedStatistics(): List<String> =
            unwrap(this).getIncludedStatistics() ?: emptyList()
        ...
        public interface Builder {
            /**
             * @param includedStatistics List of included evaluations. When the list is undefined,
             *   all supported evaluations will be included.
             */
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-databrew-job-statisticsconfiguration.html#cfn-databrew-job-statisticsconfiguration-includedstatistics)
             */
            override fun includedStatistics(): List<String> =
                unwrap(this).getIncludedStatistics() ?: emptyList()
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: StatisticsConfigurationProperty
            ): software.amazon.awscdk.services.databrew.CfnJob.StatisticsConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ProfileConfigurationProperty {
         ...
         */
        public fun entityDetectorConfiguration(): Any? =
        ...
        public interface Builder {
             ...
             *   ColumnStatisticsConfigurations is undefined, the profile job will profile all
             ...
             *   Configuration can be used to select evaluations and override parameters of
             *   evaluations. When configuration is undefined, the profile job will run all
            ...
            public fun datasetStatisticsConfiguration(
                datasetStatisticsConfiguration: StatisticsConfigurationProperty.Builder.() -> Unit
            )

            /**
             * @param entityDetectorConfiguration Configuration of entity detection for a profile
             *   job. When undefined, entity detection is disabled.
             */
            ...
            public fun entityDetectorConfiguration(
                entityDetectorConfiguration: EntityDetectorConfigurationProperty.Builder.() -> Unit
            )

            /**
             * @param profileColumns List of column selectors. ProfileColumns can be used to select
             *   columns from the dataset. When ProfileColumns is undefined, the profile job will
        ...
        private class BuilderImpl : Builder {
             ...
             *   supported columns and run all supported evaluations.
             */
            override fun columnStatisticsConfigurations(
                columnStatisticsConfigurations: IResolvable
            ) {
                cdkBuilder.columnStatisticsConfigurations(
                    columnStatisticsConfigurations.let(IResolvable::unwrap)
                )
            }
             ...
             */
            override fun columnStatisticsConfigurations(
                vararg columnStatisticsConfigurations: Any
            ): Unit = columnStatisticsConfigurations(columnStatisticsConfigurations.toList())
             ...
             *   supported inter-column evaluations.
             */
            override fun datasetStatisticsConfiguration(
                datasetStatisticsConfiguration: IResolvable
            ) {
                cdkBuilder.datasetStatisticsConfiguration(
                    datasetStatisticsConfiguration.let(IResolvable::unwrap)
                )
            }
            ...
            override fun datasetStatisticsConfiguration(
                ...
                cdkBuilder.datasetStatisticsConfiguration(
                    datasetStatisticsConfiguration.let(StatisticsConfigurationProperty::unwrap)
                )
            }
            ...
            override fun datasetStatisticsConfiguration(
                ...
                datasetStatisticsConfiguration(
                    StatisticsConfigurationProperty(datasetStatisticsConfiguration)
                )
            ...
            override fun entityDetectorConfiguration(entityDetectorConfiguration: IResolvable) {
                cdkBuilder.entityDetectorConfiguration(
                    entityDetectorConfiguration.let(IResolvable::unwrap)
                )
            }
             ...
             *   job. When undefined, entity detection is disabled.
             */
            override fun entityDetectorConfiguration(
                entityDetectorConfiguration: EntityDetectorConfigurationProperty
            ) {
                cdkBuilder.entityDetectorConfiguration(
                    entityDetectorConfiguration.let(EntityDetectorConfigurationProperty::unwrap)
                )
            }
            ...
            override fun entityDetectorConfiguration(
                ...
                entityDetectorConfiguration(
                    EntityDetectorConfigurationProperty(entityDetectorConfiguration)
                )
        ...
        internal constructor(
             ...
             * List of configurations for column evaluations.
             *
             * ColumnStatisticsConfigurations are used to select evaluations and override parameters
             * of evaluations for particular columns. When ColumnStatisticsConfigurations is
             * undefined, the profile job will profile all supported columns and run all supported
             * evaluations.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-databrew-job-profileconfiguration.html#cfn-databrew-job-profileconfiguration-columnstatisticsconfigurations)
             */
             ...
             *
             * Configuration can be used to select evaluations and override parameters of
             * evaluations. When configuration is undefined, the profile job will run all supported
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ProfileConfigurationProperty
            ): software.amazon.awscdk.services.databrew.CfnJob.ProfileConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface OutputFormatOptionsProperty {
        ...
        public interface Builder {
            /**
             * @param csv Represents a set of options that define the structure of comma-separated
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: OutputFormatOptionsProperty
            ): software.amazon.awscdk.services.databrew.CfnJob.OutputFormatOptionsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface S3TableOutputOptionsProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: S3TableOutputOptionsProperty
            ): software.amazon.awscdk.services.databrew.CfnJob.S3TableOutputOptionsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DatabaseOutputProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param databaseOutputMode The output mode to write into the database. Currently
             *   supported option: NEW_TABLE.
             */
            public fun databaseOutputMode(databaseOutputMode: String)

            /**
             * @param glueConnectionName The AWS Glue connection that stores the connection
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DatabaseOutputProperty
            ): software.amazon.awscdk.services.databrew.CfnJob.DatabaseOutputProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface JobSampleProperty {
        ...
        public interface Builder {
            /**
             * @param mode A value that determines whether the profile job is run on the entire
             *   dataset or a specified number of rows. This value must be one of the following:
             * * FULL_DATASET - The profile job is run on the entire dataset.
             * * CUSTOM_ROWS - The profile job is run on the number of rows specified in the `Size`
             *   parameter.
             */
            ...
            /**
             * @param size The `Size` parameter is only required when the mode is CUSTOM_ROWS. The
