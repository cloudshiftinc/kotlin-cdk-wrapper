...
public interface EngineVersion {
     ...
     * undefined, which means RDS should use whatever version it deems appropriate for the given
     * engine type.
     *
    ...
    public interface Builder {
         ...
         *   "5.6.mysql_aurora.1.22.1". It can be undefined, which means RDS should use whatever
         *   version it deems appropriate for the given engine type.
         */
        public fun fullVersion(fullVersion: String)

        /**
         * @param majorVersion The major version of the engine, for example, "5.6". Used in
         *   specifying the ParameterGroup family and OptionGroup version for this engine.
         */
    ...
    internal constructor(
        ...
        /**
         * The major version of the engine, for example, "5.6". Used in specifying the
    ...
    public companion object {
        ...
        ): EngineVersion = Wrapper(cdkObject)

        internal fun unwrap(
            wrapped: EngineVersion
        ): software.amazon.awscdk.services.rds.EngineVersion = (wrapped as Wrapper).cdkObject
    }
}
