...
public interface ResponseHeadersCorsBehavior {
    ...
    public interface Builder {
         ...
         *   values for the Access-Control-Allow-Methods HTTP response header.
         */
         ...
         *   as the value for the Access-Control-Allow-Origin HTTP response header. You can specify
         ...
         *   values for the Access-Control-Expose-Headers HTTP response header. You can specify
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: ResponseHeadersCorsBehavior
        ): software.amazon.awscdk.services.cloudfront.ResponseHeadersCorsBehavior =
