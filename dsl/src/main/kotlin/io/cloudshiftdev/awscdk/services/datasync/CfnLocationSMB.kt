...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param agentArns The Amazon Resource Names (ARNs) of agents to use for a Server Message
         *   Block (SMB) location.
         */
         ...
         *
         * @param mountOptions Specifies the version of the SMB protocol that DataSync uses to
        ...
        /**
         * The password of the user who can mount the share and has the permissions to access files
         ...
         *
         * @param password The password of the user who can mount the share and has the permissions
         ...
         *
         * @param serverHostname Specifies the Domain Name Service (DNS) name or IP address of the
         ...
         * location or write data to the SMB destination.
         *
         * The SMB path should be a path that's exported by the SMB server, or a subdirectory of
         * that path. The path should be such that it can be mounted by other SMB clients in your
         * network.
         *
         * `Subdirectory` must be specified with forward slashes. For example, `/path/to/folder` .
         *
         * To transfer all the data in the folder you specified, DataSync must have permissions to
         * mount the SMB share, as well as to access all the data in that share. To ensure this,
         * either make sure that the user name and password specified belongs to the user who can
         * mount the share, and who has the appropriate permissions for all of the files and
         * directories that you want DataSync to access, or use credentials of a member of the
         * Backup Operators group to mount the share. Doing either one enables the agent to access
         * the data. For the agent to access directories, you must additionally enable all execute
         * access.
         *
         ...
         *
         * @param subdirectory The subdirectory in the SMB file system that is used to read data
        ...
        /**
         * The user who can mount the share and has the permissions to access files and folders in
         * the SMB share.
         *
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.datasync.CfnLocationSMB =
            cdkBuilder.build()
    }
