...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.secretsmanager.CfnSecret,
    ...
    public open fun generateSecretString(
        `value`: GenerateSecretStringProperty.Builder.() -> Unit
    ...
    public interface Builder {
         ...
         *
         * We recommend that you specify the maximum length and include every character type that
         ...
         *
         * @param generateSecretString A structure that specifies how to generate a password to
         *   encrypt and store in the secret.
         */
        ...
        public fun generateSecretString(
            generateSecretString: GenerateSecretStringProperty.Builder.() -> Unit
        )

        /**
         * The ARN, key ID, or alias of the AWS KMS key that Secrets Manager uses to encrypt the
         ...
         * If that key doesn't yet exist, then Secrets Manager creates it for you automatically the
         ...
         * The text to encrypt and store in the secret.
         *
         * We recommend you use a JSON structure of key/value pairs for your secret value. To
         * generate a random password, use `GenerateSecretString` instead. If you omit both
         * `GenerateSecretString` and `SecretString` , you create an empty secret. When you make a
         * change to this property, a new secret version is created.
         *
         ...
         * or removing a tag can change permissions. If the completion of this operation would
         * result in you losing your permissions for this secret, then Secrets Manager blocks the
         ...
         * * Do not use the `aws:` prefix in your tag names or values because AWS reserves it for
    ...
    private class BuilderImpl(
        ...
        override fun generateSecretString(generateSecretString: GenerateSecretStringProperty) {
            cdkBuilder.generateSecretString(
                generateSecretString.let(GenerateSecretStringProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("3e223691f205e021a942110c10c4226c829ebe5305e708ddfa406aedf731c0b9")
        override fun generateSecretString(
            generateSecretString: GenerateSecretStringProperty.Builder.() -> Unit
    ...
    public interface ReplicaRegionProperty {
        ...
        public interface Builder {
            /**
             * @param kmsKeyId The ARN, key ID, or alias of the KMS key to encrypt the secret. If
             *   you don't include this field, Secrets Manager uses `aws/secretsmanager` .
             */
            public fun kmsKeyId(kmsKeyId: String)
    ...
    public interface GenerateSecretStringProperty {
         ...
         *
         * " # $ % &amp; ' ( ) * + , - . / : ; &lt; = &gt; ? &#64; [ \ ] ^ _ ` { | } ~` . If you
         * don't include this switch, the password can contain punctuation.
         *
        ...
        public interface Builder {
            ...
            /**
             * @param excludeLowercase Specifies whether to exclude lowercase letters from the
             *   password. If you don't include this switch, the password can contain lowercase
             *   letters.
             */
            ...
            /**
             * @param excludeNumbers Specifies whether to exclude numbers from the password. If you
            ...
            /**
             * @param excludePunctuation Specifies whether to exclude the following punctuation
            ...
            /**
             * @param excludeUppercase Specifies whether to exclude uppercase letters from the
             *   password. If you don't include this switch, the password can contain uppercase
             *   letters.
             */
            ...
            /**
             * @param generateStringKey The JSON key name for the key/value pair, where the value is
             *   the generated password. This pair is added to the JSON structure specified by the
             *   `SecretStringTemplate` parameter. If you specify this parameter, then you must also
             *   specify `SecretStringTemplate` .
             */
            public fun generateStringKey(generateStringKey: String)

            /**
             * @param includeSpace Specifies whether to include the space character. If you include
            ...
            /**
             * @param passwordLength The length of the password. If you don't include this
             *   parameter, the default length is 32 characters.
             */
             ...
             *   lowercase letter, one number, and one punctuation. If you don't include this
            ...
            /**
             * @param secretStringTemplate A template that the generated string must match. When you
             *   make a change to this property, a new secret version is created.
             */
        ...
        internal constructor(
             ...
             * one punctuation.
             *
             * If you don't include this switch, the password contains at least one of every
             * character type.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-secretsmanager-secret-generatesecretstring.html#cfn-secretsmanager-secret-generatesecretstring-requireeachincludedtype)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: GenerateSecretStringProperty
            ): software.amazon.awscdk.services.secretsmanager.CfnSecret.GenerateSecretStringProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
