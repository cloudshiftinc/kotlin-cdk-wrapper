...
public open class NetworkMultipleTargetGroupsEc2Service
internal constructor(
    ...
    public interface Builder {
        ...
        public fun taskImageOptions(
            taskImageOptions: NetworkLoadBalancedTaskImageProps.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
        ...
        override fun taskImageOptions(taskImageOptions: NetworkLoadBalancedTaskImageProps) {
            cdkBuilder.taskImageOptions(
                taskImageOptions.let(NetworkLoadBalancedTaskImageProps::unwrap)
            )
        }
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: NetworkMultipleTargetGroupsEc2Service
        ): software.amazon.awscdk.services.ecs.patterns.NetworkMultipleTargetGroupsEc2Service =
            wrapped.cdkObject
    }
}
