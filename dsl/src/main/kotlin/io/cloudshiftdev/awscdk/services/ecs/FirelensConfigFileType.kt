...
public enum class FirelensConfigFileType(
    ...
    public companion object {
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.ecs.FirelensConfigFileType
        ): FirelensConfigFileType =
            when (cdkObject) {
                software.amazon.awscdk.services.ecs.FirelensConfigFileType.S3 ->
                    FirelensConfigFileType.S3
                software.amazon.awscdk.services.ecs.FirelensConfigFileType.FILE ->
                    FirelensConfigFileType.FILE
            }

        internal fun unwrap(
            wrapped: FirelensConfigFileType
