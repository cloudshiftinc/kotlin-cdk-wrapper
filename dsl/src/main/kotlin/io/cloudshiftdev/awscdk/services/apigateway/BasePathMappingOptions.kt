...
public interface BasePathMappingOptions {
    ...
    public interface Builder {
        /**
         * @param attachToStage Whether to attach the base path mapping to a stage. Use this
         *   property to create a base path mapping without attaching it to the Rest API default
         *   stage. This property is ignored if `stage` is provided.
         */
    ...
    internal constructor(
         ...
         * Whether to attach the base path mapping to a stage.
         *
         * Use this property to create a base path mapping without attaching it to the Rest API
         * default stage. This property is ignored if `stage` is provided.
         *
         * Default: - true
         */
         ...
         * string.
         *
         * Default: - map requests from the domain root (e.g. `example.com`). If this is undefined,
         * no additional mappings will be allowed on this domain name.
         */
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: BasePathMappingOptions
