...
internal constructor(
     ...
     * @param options
     */
    public override fun addClientVpnEndpoint(
        id: String,
        options: ClientVpnEndpointOptions
    ): ClientVpnEndpoint =
        unwrap(this)
            .addClientVpnEndpoint(id, options.let(ClientVpnEndpointOptions::unwrap))
            .let(ClientVpnEndpoint::wrap)
    ...
    public override fun addClientVpnEndpoint(
        id: String,
        options: ClientVpnEndpointOptions.Builder.() -> Unit
    ): ClientVpnEndpoint = addClientVpnEndpoint(id, ClientVpnEndpointOptions(options))
    ...
    public override fun addFlowLog(
        id: String,
        options: FlowLogOptions.Builder.() -> Unit
    ): FlowLog = addFlowLog(id, FlowLogOptions(options))
     ...
     * @param options
     */
    public override fun addGatewayEndpoint(
        id: String,
        options: GatewayVpcEndpointOptions
    ): GatewayVpcEndpoint =
        unwrap(this)
            .addGatewayEndpoint(id, options.let(GatewayVpcEndpointOptions::unwrap))
            .let(GatewayVpcEndpoint::wrap)
    ...
    public override fun addGatewayEndpoint(
        id: String,
        options: GatewayVpcEndpointOptions.Builder.() -> Unit
    ): GatewayVpcEndpoint = addGatewayEndpoint(id, GatewayVpcEndpointOptions(options))
     ...
     * @param options
     */
    public override fun addInterfaceEndpoint(
        id: String,
        options: InterfaceVpcEndpointOptions
    ): InterfaceVpcEndpoint =
        unwrap(this)
            .addInterfaceEndpoint(id, options.let(InterfaceVpcEndpointOptions::unwrap))
            .let(InterfaceVpcEndpoint::wrap)
    ...
    public override fun addInterfaceEndpoint(
        id: String,
        options: InterfaceVpcEndpointOptions.Builder.() -> Unit
    ): InterfaceVpcEndpoint = addInterfaceEndpoint(id, InterfaceVpcEndpointOptions(options))
    ...
    public override fun addVpnConnection(id: String, options: VpnConnectionOptions): VpnConnection =
        unwrap(this)
            .addVpnConnection(id, options.let(VpnConnectionOptions::unwrap))
            .let(VpnConnection::wrap)
    ...
    public override fun addVpnConnection(
        id: String,
        options: VpnConnectionOptions.Builder.() -> Unit
    ...
    public override fun enableVpnGateway(
        options: EnableVpnGatewayOptions.Builder.() -> Unit
    ): Unit = enableVpnGateway(EnableVpnGatewayOptions(options))
    ...
    public override fun selectSubnets(selection: SubnetSelection): SelectedSubnets =
        unwrap(this)
            .selectSubnets(selection.let(SubnetSelection::unwrap))
            .let(SelectedSubnets::wrap)
    ...
    public override fun selectSubnets(
        selection: SubnetSelection.Builder.() -> Unit
    ): SelectedSubnets = selectSubnets(SubnetSelection(selection))
    ...
    public interface Builder {
         ...
         */
        @Deprecated(message = "deprecated in CDK") public fun cidr(cidr: String)
         ...
         *
         * By setting this to dedicated tenancy, instances will be launched on hardware dedicated to
         * a single AWS customer, unless specifically specified at instance launch time. Please
         * note, not all instance types are usable with Dedicated tenancy.
         *
         ...
         * Default: true
         *
         * @param enableDnsHostnames Indicates whether the instances launched in the VPC get public
         *   DNS hostnames.
         */
         ...
         *
         * If this attribute is false, the Amazon-provided DNS server in the VPC that resolves
         * public DNS hostnames to IP addresses is not enabled. If this attribute is true, queries
         * to the Amazon provided DNS server at the 169.254.169.253 IP address, or the reserved IP
         * address at the base of the VPC IPv4 network range plus two will succeed.
         *
         * Default: true
         *
         ...
         *
         * If you pick a higher number than the number of AZs in the region, all AZs in the region
         * will be selected. To use "all AZs" available to your account, use a high number (such as
         * 99).
         *
         * Be aware that environment-agnostic stacks will be created with access to only 2 AZs, so
         ...
         *
         * Select between NAT gateways or NAT instances. NAT gateways may not be available in all
         * AWS regions.
         *
         ...
         *
         * The type of NAT gateway or instance will be determined by the `natGatewayProvider`
         * parameter.
         *
         * You can set this number lower than the number of Availability Zones in your VPC in order
         * to save on NAT cost. Be aware you may be charged for cross-AZ data traffic instead.
         *
         ...
         *
         * When specified, the IP space is reserved for the azs but no actual resources are
         * provisioned.
         *
         * Default: 0
         *
        ...
        /**
         * If set to true then the default inbound &amp; outbound rules will be removed from the
         * default security group.
         *
         * Default: true if '@aws-cdk/aws-ec2:restrictDefaultSecurityGroup' is enabled, false
         * otherwise
         *
         * @param restrictDefaultSecurityGroup If set to true then the default inbound &amp;
         *   outbound rules will be removed from the default security group.
         */
         ...
         *
         * Each entry in this list configures a Subnet Group; each group will contain a subnet for
         * each Availability Zone.
         *
         * For example, if you want 1 public subnet, 1 private subnet, and 1 isolated subnet in each
         * AZ provide the following:
         * ```
         ...
         * ```
         *
         * Default: - The VPC CIDR will be evenly divided between 1 public and 1 private subnet per
         * AZ.
         *
         ...
         *
         * @param vpnGateway Indicates whether a VPN gateway should be created and attached to this
         *   VPC.
         */
         ...
         *
         * Default: - On the route tables associated with private subnets. If no private subnets
         * exists, isolated subnets are used. If no isolated subnets exists, public subnets are
         * used.
         *
    ...
    private class BuilderImpl(
        ...
        override fun defaultInstanceTenancy(defaultInstanceTenancy: DefaultInstanceTenancy) {
            cdkBuilder.defaultInstanceTenancy(
                defaultInstanceTenancy.let(DefaultInstanceTenancy::unwrap)
            )
        }
        ...
        override fun gatewayEndpoints(gatewayEndpoints: Map<String, GatewayVpcEndpointOptions>) {
            cdkBuilder.gatewayEndpoints(
                gatewayEndpoints.mapValues { GatewayVpcEndpointOptions.unwrap(it.value) }
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("bd126bbf35ef771f13980b947b33075c4f461eb29e9008839010fa6db310f4b5")
        override fun natGatewaySubnets(
            natGatewaySubnets: SubnetSelection.Builder.() -> Unit
        ...
        override fun vpnConnections(vpnConnections: Map<String, VpnConnectionOptions>) {
            cdkBuilder.vpnConnections(
                vpnConnections.mapValues { VpnConnectionOptions.unwrap(it.value) }
            )
        }
    ...
    public companion object {
        public fun fromLookup(
            ...
            software.amazon.awscdk.services.ec2.Vpc.fromLookup(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    options.let(VpcLookupOptions::unwrap)
                )
                .let(IVpc::wrap)
        ...
        public fun fromVpcAttributes(
            ...
            software.amazon.awscdk.services.ec2.Vpc.fromVpcAttributes(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    attrs.let(VpcAttributes::unwrap)
                )
                .let(IVpc::wrap)
        ...
        internal fun unwrap(wrapped: Vpc): software.amazon.awscdk.services.ec2.Vpc =
            wrapped.cdkObject
    }
}
