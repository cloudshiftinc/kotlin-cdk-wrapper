...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param application The reference to the CodeDeploy ECS Application that this Deployment
         *   Group belongs to.
         */
         ...
         *
         * @param blueGreenDeploymentConfig The configuration options for blue-green ECS
         *   deployments.
         */
        public fun blueGreenDeploymentConfig(
        ...
        public fun blueGreenDeploymentConfig(
            blueGreenDeploymentConfig: EcsBlueGreenDeploymentConfig.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
         ...
         *   deployments.
         */
        override fun blueGreenDeploymentConfig(
            blueGreenDeploymentConfig: EcsBlueGreenDeploymentConfig
        ) {
            cdkBuilder.blueGreenDeploymentConfig(
                blueGreenDeploymentConfig.let(EcsBlueGreenDeploymentConfig::unwrap)
            )
        }
    ...
    public companion object {
        public fun fromEcsDeploymentGroupAttributes(
            ...
            software.amazon.awscdk.services.codedeploy.EcsDeploymentGroup
                .fromEcsDeploymentGroupAttributes(
                    ...
                    id,
                    attrs.let(EcsDeploymentGroupAttributes::unwrap)
                )
                .let(IEcsDeploymentGroup::wrap)
        ...
        public fun fromEcsDeploymentGroupAttributes(
            ...
            fromEcsDeploymentGroupAttributes(scope, id, EcsDeploymentGroupAttributes(attrs))
