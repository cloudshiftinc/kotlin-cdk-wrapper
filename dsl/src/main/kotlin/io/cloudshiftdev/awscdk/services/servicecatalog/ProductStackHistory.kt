...
internal constructor(
    ...
    public interface Builder {
        /**
         * If this is set to true, the ProductStack will not be overwritten if a snapshot is found
         * for the currentVersionName.
         *
         * @param currentVersionLocked If this is set to true, the ProductStack will not be
         *   overwritten if a snapshot is found for the currentVersionName.
         */
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.servicecatalog.ProductStackHistory.Builder.create(
                scope,
                id
            )
