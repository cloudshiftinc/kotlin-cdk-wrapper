...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.logs.LogGroup,
    ...
    public override fun addMetricFilter(id: String, props: MetricFilterOptions): MetricFilter =
        unwrap(this)
            .addMetricFilter(id, props.let(MetricFilterOptions::unwrap))
            .let(MetricFilter::wrap)
    ...
    public override fun addMetricFilter(
        id: String,
        props: MetricFilterOptions.Builder.() -> Unit
     ...
     */
    public override fun addSubscriptionFilter(
        id: String,
        props: SubscriptionFilterOptions
    ): SubscriptionFilter =
        unwrap(this)
            .addSubscriptionFilter(id, props.let(SubscriptionFilterOptions::unwrap))
            .let(SubscriptionFilter::wrap)
    ...
    public override fun addSubscriptionFilter(
        id: String,
        props: SubscriptionFilterOptions.Builder.() -> Unit
    ): SubscriptionFilter = addSubscriptionFilter(id, SubscriptionFilterOptions(props))
     ...
     *
     * Creates a MetricFilter on this LogGroup that will extract the value of the indicated JSON
     * field in all records where it occurs.
     *
    ...
    public interface Builder {
        ...
        public fun dataProtectionPolicy(
            dataProtectionPolicy: DataProtectionPolicy.Builder.() -> Unit
        )
         ...
         * supports querying using Logs Insights. The logGroupClass property cannot be changed once
         ...
         *
         * Normally you want to retain the log group so you can diagnose issues from logs even after
         * a deployment that no longer includes the log group. In that case, use the normal
         * date-based retention policy to age out your logs.
         *
    ...
    private class BuilderImpl(
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("bc6cad86baae33f8b5b0d27b09aaae065f78d70995269a7073f3d2b5413994cd")
        override fun dataProtectionPolicy(
            dataProtectionPolicy: DataProtectionPolicy.Builder.() -> Unit
    ...
    public companion object {
        public fun fromLogGroupArn(
            ...
            software.amazon.awscdk.services.logs.LogGroup.fromLogGroupArn(
        ...
        public fun fromLogGroupName(
            ...
            software.amazon.awscdk.services.logs.LogGroup.fromLogGroupName(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    logGroupName
                )
