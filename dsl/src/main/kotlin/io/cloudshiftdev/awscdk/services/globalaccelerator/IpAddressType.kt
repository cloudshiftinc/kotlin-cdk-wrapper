...
public enum class IpAddressType(
  ...
  public companion object {
    internal fun wrap(cdkObject: software.amazon.awscdk.services.globalaccelerator.IpAddressType):
        IpAddressType = when (cdkObject) {
      software.amazon.awscdk.services.globalaccelerator.IpAddressType.IPV4 -> IpAddressType.IPV4
