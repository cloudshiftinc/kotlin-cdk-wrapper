...
internal constructor(
    ...
    public open fun attrNamespaceCreationDate(): String =
        unwrap(this).getAttrNamespaceCreationDate()
    ...
    public open fun attrNamespaceNamespaceArn(): String =
        unwrap(this).getAttrNamespaceNamespaceArn()
    ...
    public open fun redshiftIdcApplicationArn(): String? =
        unwrap(this).getRedshiftIdcApplicationArn()
    ...
    public open fun snapshotCopyConfigurations(): Any? =
        unwrap(this).getSnapshotCopyConfigurations()
    ...
    public interface Builder {
         ...
         *
         * @param adminPasswordSecretKmsKeyId The ID of the AWS Key Management Service (KMS) key
         *   used to encrypt and store the namespace's admin credentials secret.
         */
         ...
         *
         * @param adminUserPassword The password of the administrator for the primary database
         ...
         *
         * @param adminUsername The username of the administrator for the primary database created
         *   in the namespace.
         */
         ...
         *
         * @param defaultIamRoleArn The Amazon Resource Name (ARN) of the IAM role to set as a
         ...
         *
         * @param manageAdminPassword If true, Amazon Redshift uses AWS Secrets Manager to manage
         *   the namespace's admin credentials.
         */
         ...
         * word. A list of reserved words can be found in
         ...
         *
         * @param namespaceResourcePolicy The resource policy that will be attached to the
         *   namespace.
         */
         ...
         *
         * @param redshiftIdcApplicationArn The ARN for the Redshift application that integrates
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.redshiftserverless.CfnNamespace.Builder.create(
                scope,
                id
            )
        ...
        override fun snapshotCopyConfigurations(snapshotCopyConfigurations: IResolvable) {
            cdkBuilder.snapshotCopyConfigurations(
                snapshotCopyConfigurations.let(IResolvable::unwrap)
            )
        }
    ...
    public interface NamespaceProperty {
        ...
        public interface Builder {
            /**
             * @param adminPasswordSecretArn The Amazon Resource Name (ARN) for the namespace's
             *   admin user credentials secret.
             */
            ...
            /**
             * @param adminUsername The username of the administrator for the first database created
             *   in the namespace.
             */
            public fun adminUsername(adminUsername: String)
            ...
            /**
             * @param kmsKeyId The ID of the AWS Key Management Service key used to encrypt your
             *   data.
             */
            public fun kmsKeyId(kmsKeyId: String)

            /**
             * @param logExports The types of logs the namespace can export. Available export types
            ...
            /**
             * @param namespaceName The name of the namespace. Must be between 3-64 alphanumeric
             *   characters in lowercase, and it cannot be a reserved word. A list of reserved words
             *   can be found in
        ...
        private class BuilderImpl : Builder {
             ...
             *   are User log, Connection log, and User activity log.
             */
            override fun logExports(vararg logExports: String): Unit =
                logExports(logExports.toList())
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-redshiftserverless-namespace-namespace.html#cfn-redshiftserverless-namespace-namespace-adminpasswordsecretarn)
             */
            override fun adminPasswordSecretArn(): String? =
             ...
             * The name of the namespace.
             *
             * Must be between 3-64 alphanumeric characters in lowercase, and it cannot be a
             * reserved word. A list of reserved words can be found in
             * [Reserved Words](https://docs.aws.amazon.com//redshift/latest/dg/r_pg_keywords.html)
             * in the Amazon Redshift Database Developer Guide.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-redshiftserverless-namespace-namespace.html#cfn-redshiftserverless-namespace-namespace-namespacename)
    ...
    public interface SnapshotCopyConfigurationProperty {
        ...
        /** A builder for [SnapshotCopyConfigurationProperty] */
        @CdkDslMarker
        public interface Builder {
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-redshiftserverless-namespace-snapshotcopyconfiguration.html#cfn-redshiftserverless-namespace-snapshotcopyconfiguration-snapshotretentionperiod)
             */
            override fun snapshotRetentionPeriod(): Number? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SnapshotCopyConfigurationProperty
            ): software.amazon.awscdk.services.redshiftserverless.CfnNamespace.SnapshotCopyConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
