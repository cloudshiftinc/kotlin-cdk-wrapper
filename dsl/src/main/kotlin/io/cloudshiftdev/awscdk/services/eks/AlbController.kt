...
internal constructor(
    ...
    public companion object {
        public fun create(
            ...
            software.amazon.awscdk.services.eks.AlbController.create(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    props.let(AlbControllerProps::unwrap)
                )
                .let(AlbController::wrap)
        ...
        ): AlbController = create(scope, AlbControllerProps(props))
        ...
        ): AlbController = AlbController(cdkObject)

        internal fun unwrap(
            wrapped: AlbController
        ): software.amazon.awscdk.services.eks.AlbController = wrapped.cdkObject
    }
}
