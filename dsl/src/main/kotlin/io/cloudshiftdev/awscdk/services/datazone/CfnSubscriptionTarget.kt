...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param authorizedPrincipals The authorized principals included in the subscription
         *   target.
         */
         ...
         *
         * @param domainIdentifier The ID of the Amazon DataZone domain in which subscription target
         *   is created.
         */
    ...
    public interface SubscriptionTargetFormProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SubscriptionTargetFormProperty
            ): software.amazon.awscdk.services.datazone.CfnSubscriptionTarget.SubscriptionTargetFormProperty =
