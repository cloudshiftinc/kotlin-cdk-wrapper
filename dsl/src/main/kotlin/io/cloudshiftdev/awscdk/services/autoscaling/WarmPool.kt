...
internal constructor(
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.autoscaling.WarmPool =
            cdkBuilder.build()
    }
    ...
    public companion object {
        ...
        ): WarmPool = WarmPool(cdkObject)

        internal fun unwrap(
            wrapped: WarmPool
        ): software.amazon.awscdk.services.autoscaling.WarmPool = wrapped.cdkObject
    }
}
