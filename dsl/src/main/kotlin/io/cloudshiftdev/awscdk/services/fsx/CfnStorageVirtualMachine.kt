...
internal constructor(
    ...
    public open fun activeDirectoryConfiguration(`value`: ActiveDirectoryConfigurationProperty) {
        unwrap(this)
            .setActiveDirectoryConfiguration(
                `value`.let(ActiveDirectoryConfigurationProperty::unwrap)
            )
    }
    ...
    public open fun activeDirectoryConfiguration(
        `value`: ActiveDirectoryConfigurationProperty.Builder.() -> Unit
    ...
    public interface Builder {
         ...
         *
         * @param activeDirectoryConfiguration Describes the Microsoft Active Directory
         *   configuration to which the SVM is joined, if applicable.
         */
        ...
        public fun activeDirectoryConfiguration(
            activeDirectoryConfiguration: ActiveDirectoryConfigurationProperty.Builder.() -> Unit
        )
         ...
         *   account.
         * * `NTFS` if the file system is managed by a Microsoft Windows administrator, the majority
         *   of users are SMB clients, and an application accessing the data uses a Microsoft
         ...
         *
         * @param rootVolumeSecurityStyle The security style of the root volume of the SVM. Specify
         ...
         * connection to the SVM's management endpoint.
         *
         * Doing so enables you to manage the SVM using the NetApp ONTAP CLI or REST API. If you do
         * not specify a password, you can still use the file system's `fsxadmin` user to manage the
         * SVM. For more information, see
    ...
    private class BuilderImpl(
        ...
        override fun activeDirectoryConfiguration(activeDirectoryConfiguration: IResolvable) {
            cdkBuilder.activeDirectoryConfiguration(
                activeDirectoryConfiguration.let(IResolvable::unwrap)
            )
        }
         ...
         *   configuration to which the SVM is joined, if applicable.
         */
        override fun activeDirectoryConfiguration(
            activeDirectoryConfiguration: ActiveDirectoryConfigurationProperty
        ) {
            cdkBuilder.activeDirectoryConfiguration(
                activeDirectoryConfiguration.let(ActiveDirectoryConfigurationProperty::unwrap)
            )
        }
        ...
        override fun activeDirectoryConfiguration(
            ...
            activeDirectoryConfiguration(
                ActiveDirectoryConfigurationProperty(activeDirectoryConfiguration)
            )
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnStorageVirtualMachine
    ...
    public interface ActiveDirectoryConfigurationProperty {
        /**
         * The NetBIOS name of the Active Directory computer object that will be created for your
         * SVM.
         *
        ...
        public interface Builder {
            /**
             * @param netBiosName The NetBIOS name of the Active Directory computer object that will
             ...
             *   to join the ONTAP storage virtual machine (SVM) to your self-managed (including
             *   on-premises) Microsoft Active Directory directory.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ActiveDirectoryConfigurationProperty
            ): software.amazon.awscdk.services.fsx.CfnStorageVirtualMachine.ActiveDirectoryConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
