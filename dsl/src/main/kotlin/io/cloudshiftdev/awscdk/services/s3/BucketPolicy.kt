...
internal constructor(
     ...
     *
     * For more information, see Access Policy Language Overview in the Amazon Simple Storage
    ...
    public companion object {
        public fun fromCfnBucketPolicy(cfnBucketPolicy: CfnBucketPolicy): BucketPolicy =
            software.amazon.awscdk.services.s3.BucketPolicy.fromCfnBucketPolicy(
                    cfnBucketPolicy.let(CfnBucketPolicy::unwrap)
                )
                .let(BucketPolicy::wrap)
        ...
        ): BucketPolicy = BucketPolicy(cdkObject)

        internal fun unwrap(
            wrapped: BucketPolicy
        ): software.amazon.awscdk.services.s3.BucketPolicy = wrapped.cdkObject
    }
}
