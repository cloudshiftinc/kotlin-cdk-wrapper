...
internal constructor(
     ...
     * request. A fully qualified label is made up of the label namespace from the rule group or web
     * ACL where the rule is defined and the label from the rule, separated by a colon.
     */
    ...
    public interface Builder {
         ...
         *
         * @param availableLabels The labels that one or more rules in this rule group add to
         *   matching web requests.
         */
         ...
         *
         * AWS WAF uses WCUs to calculate and control the operating resources that are used to run
         * your rules, rule groups, and web ACLs. AWS WAF calculates capacity differently for each
         * rule type, to reflect the relative cost of each rule. Simple rules that cost little to
         * run use fewer WCUs than more complex rules that use more processing power. Rule group
         * capacity is fixed at creation, which helps users plan their web ACL WCU usage when they
         ...
         *
         * @param consumedLabels The labels that one or more rules in this rule group match against
         *   in label match statements.
         */
         ...
         * request. You define these for the rule group, and then use them in the rules that you
         ...
         * settings, see
         * [AWS WAF quotas](https://docs.aws.amazon.com/waf/latest/developerguide/limits.html) in
         ...
         * REST API, an AWS AppSync GraphQL API, an Amazon Cognito user pool, an AWS App Runner
         * service, or an AWS Verified Access instance. Valid Values are `CLOUDFRONT` and `REGIONAL`
         * .
         *
         * For `CLOUDFRONT` , you must create your WAFv2 resources in the US East (N. Virginia)
         * Region, `us-east-1` .
         *
         ...
         *
         * To modify tags on existing resources, use the AWS WAF APIs or command line interface.
    ...
    private class BuilderImpl(
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("366b1aaea94889b5c9a40c56f60673f0c33bfa5abb730b81db6d98b05dc0236d")
        override fun visibilityConfig(
            visibilityConfig: VisibilityConfigProperty.Builder.() -> Unit
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnRuleGroup
        ): software.amazon.awscdk.services.wafv2.CfnRuleGroup = wrapped.cdkObject
    }
    ...
    public interface JsonBodyProperty {
         ...
         *
         * If you don't provide this setting, AWS WAF parses and evaluates the content only up to
         ...
         *
         * AWS WAF inspects the results of these pattern matches against the rule inspection
         * criteria.
         *
         ...
         *
         * AWS WAF does not support inspecting the entire contents of the web request body if the
         * body exceeds the limit for the resource type. If the body is larger than the limit, the
         * underlying host service only forwards the contents that are below the limit to AWS WAF
         * for inspection.
         *
         * The default limit is 8 KB (8,192 bytes) for regional resources and 16 KB (16,384 bytes)
         * for CloudFront distributions. For CloudFront distributions, you can increase the limit in
         * the web ACL `AssociationConfig` , for additional processing fees.
         *
        ...
        public interface Builder {
            /**
             * @param invalidFallbackBehavior What AWS WAF should do if it fails to completely parse
            ...
            /**
             * @param matchPattern The patterns to look for in the JSON body. AWS WAF inspects the
             ...
             *
             * `All` does not require a match to be found in the keys and a match to be found in the
             * values. It requires a match to be found in the keys or the values or both. To require
             * a match in the keys and in the values, use a logical `AND` statement to combine two
             * match rules, one that inspects the keys and another that inspects the values.
             */
             ...
             *   inspect. AWS WAF does not support inspecting the entire contents of the web request
             *   body if the body exceeds the limit for the resource type. If the body is larger
             *   than the limit, the underlying host service only forwards the contents that are
             *   below the limit to AWS WAF for inspection.
             *
             * The default limit is 8 KB (8,192 bytes) for regional resources and 16 KB (16,384
             * bytes) for CloudFront distributions. For CloudFront distributions, you can increase
             * the limit in the web ACL `AssociationConfig` , for additional processing fees.
             *
             * The options for oversize handling are the following:
             * * `CONTINUE` - Inspect the available body contents normally, according to the rule
             *   inspection criteria.
             ...
             * rule and web ACL action settings, so that you block any request whose body is over
             * the limit.
             *
             * Default: `CONTINUE`
             */
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("8e590ca33e821e7413e1d874dd0a487ee5942ed0046a60284a111ebad7bac59f")
            override fun matchPattern(
                matchPattern: JsonMatchPatternProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-wafv2-rulegroup-jsonbody.html#cfn-wafv2-rulegroup-jsonbody-invalidfallbackbehavior)
             */
            override fun invalidFallbackBehavior(): String? =
             ...
             * What AWS WAF should do if the body is larger than AWS WAF can inspect.
             *
             * AWS WAF does not support inspecting the entire contents of the web request body if
             * the body exceeds the limit for the resource type. If the body is larger than the
             * limit, the underlying host service only forwards the contents that are below the
             * limit to AWS WAF for inspection.
             *
             * The default limit is 8 KB (8,192 bytes) for regional resources and 16 KB (16,384
             * bytes) for CloudFront distributions. For CloudFront distributions, you can increase
             * the limit in the web ACL `AssociationConfig` , for additional processing fees.
    ...
    public interface CustomResponseProperty {
         ...
         *
         * You can define a custom response for a rule action or a default web ACL action that is
         * set to block. To do this, you first define the response body key and value in the
         ...
         *
         * You can specify any header name except for `content-type` . Duplicate header names are
         * not allowed.
         *
         * For information about the limits on count and size for custom request and response
         * settings, see
        ...
        public interface Builder {
            /**
             * @param customResponseBodyKey References the response body that you want AWS WAF to
             *   return to the web request client. You can define a custom response for a rule
             *   action or a default web ACL action that is set to block. To do this, you first
             *   define the response body key and value in the `CustomResponseBodies` setting for
             *   the `WebACL` or `RuleGroup` where you want to use it. Then, in the rule action or
             *   web ACL default action `BlockAction` setting, you reference the response body using
             *   this key.
             */
            public fun customResponseBodyKey(customResponseBodyKey: String)

            /**
             * @param responseCode The HTTP status code to return to the client. For a list of
             *   status codes that you can use in your custom responses, see
             *   [Supported status codes for custom response](https://docs.aws.amazon.com/waf/latest/developerguide/customizing-the-response-status-codes.html)
             *   in the *AWS WAF Developer Guide* .
             */
            ...
            /**
             * @param responseHeaders The HTTP headers to use in the response. You can specify any
             *   header name except for `content-type` . Duplicate header names are not allowed.
             *
             * For information about the limits on count and size for custom request and response
             * settings, see
        ...
        internal constructor(
             ...
             * `CustomResponseBodies` setting for the `WebACL` or `RuleGroup` where you want to use
             * it. Then, in the rule action or web ACL default action `BlockAction` setting, you
             ...
             * The HTTP headers to use in the response.
             *
             * You can specify any header name except for `content-type` . Duplicate header names
             * are not allowed.
             *
             * For information about the limits on count and size for custom request and response
             * settings, see
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CustomResponseProperty
            ): software.amazon.awscdk.services.wafv2.CfnRuleGroup.CustomResponseProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ImmunityTimePropertyProperty {
        ...
        public interface Builder {
            /**
             * @param immunityTime The amount of time, in seconds, that a `CAPTCHA` or challenge
             *   timestamp is considered valid by AWS WAF . The default setting is 300.
             *
             * For the Challenge action, the minimum setting is 300.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ImmunityTimePropertyProperty
            ): software.amazon.awscdk.services.wafv2.CfnRuleGroup.ImmunityTimePropertyProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface RuleActionProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param captcha Specifies that AWS WAF should run a `CAPTCHA` check against the
             *   request:.
             * * If the request includes a valid, unexpired `CAPTCHA` token, AWS WAF allows the web
             *   request inspection to proceed to the next rule, similar to a `CountAction` .
            ...
            /**
             * @param challenge Instructs AWS WAF to run a `Challenge` check against the web
             *   request.
             */
            public fun challenge(challenge: Any)

            /**
             * @param count Instructs AWS WAF to count the web request and then continue evaluating
        ...
        internal constructor(
            ...
            /**
             * Instructs AWS WAF to count the web request and then continue evaluating the request
    ...
    public interface RuleProperty {
         ...
         *
         * If you don't specify this, AWS WAF uses the `CAPTCHA` configuration that's defined for
         * the web ACL.
         *
         ...
         *
         * If you don't specify this, AWS WAF uses the challenge configuration that's defined for
         * the web ACL.
         *
         ...
         * settings. AWS WAF doesn't automatically update the metric name when you update the rule
         * name.
         *
         ...
         *
         * AWS WAF applies fully qualified labels to matching web requests. A fully qualified label
         * is the concatenation of a label namespace and a rule label. The rule's rule group or web
         ...
         *
         * If you change the name of a `Rule` after you create it and you want the rule's metric
         * name to reflect the change, update the metric name as well. AWS WAF doesn't automatically
        ...
        public interface Builder {
             ...
             *   the rule statement. Settings at the web ACL level can override the rule action
             *   setting.
             */
            ...
            /**
             * @param captchaConfig Specifies how AWS WAF should handle `CAPTCHA` evaluations. If
             *   you don't specify this, AWS WAF uses the `CAPTCHA` configuration that's defined for
             *   the web ACL.
             */
             ...
             *   If you don't specify this, AWS WAF uses the challenge configuration that's defined
             *   for the web ACL.
             */
            ...
            /**
             * @param name The name of the rule. If you change the name of a `Rule` after you create
             *   it and you want the rule's metric name to reflect the change, update the metric
             *   name in the rule's `VisibilityConfig` settings. AWS WAF doesn't automatically
             *   update the metric name when you update the rule name.
             */
            public fun name(name: String)

            /**
             * @param priority If you define more than one `Rule` in a `WebACL` , AWS WAF evaluates
             *   each request against the `Rules` in order based on the value of `Priority` . AWS
            ...
            /**
             * @param ruleLabels Labels to apply to web requests that match the rule match
             *   statement. AWS WAF applies fully qualified labels to matching web requests. A fully
             *   qualified label is the concatenation of a label namespace and a rule label. The
            ...
            /**
             * @param visibilityConfig Defines and enables Amazon CloudWatch metrics and web request
             *   sample collection. If you change the name of a `Rule` after you create it and you
             *   want the rule's metric name to reflect the change, update the metric name as well.
             *   AWS WAF doesn't automatically update the metric name.
             */
            public fun visibilityConfig(visibilityConfig: IResolvable)
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("90f6e38e2c3c5b6a7f2d6756b5812401a10b2c32776c5257df07e13164b43707")
            override fun captchaConfig(
                captchaConfig: CaptchaConfigProperty.Builder.() -> Unit
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("8c6f4e93253cc8051bfe46a07df51ba9e7e46aa181e3d7cd2aba87c121221f6e")
            override fun challengeConfig(
                challengeConfig: ChallengeConfigProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * Specifies how AWS WAF should handle `CAPTCHA` evaluations.
             *
             * If you don't specify this, AWS WAF uses the `CAPTCHA` configuration that's defined
             * for the web ACL.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-wafv2-rulegroup-rule.html#cfn-wafv2-rulegroup-rule-captchaconfig)
             */
             ...
             * If you change the name of a `Rule` after you create it and you want the rule's metric
             * name to reflect the change, update the metric name in the rule's `VisibilityConfig`
             * settings. AWS WAF doesn't automatically update the metric name when you update the
             * rule name.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-wafv2-rulegroup-rule.html#cfn-wafv2-rulegroup-rule-name)
             */
             ...
             * Labels to apply to web requests that match the rule match statement.
             *
             * AWS WAF applies fully qualified labels to matching web requests. A fully qualified
             * label is the concatenation of a label namespace and a rule label. The rule's rule
             ...
             *
             * If you change the name of a `Rule` after you create it and you want the rule's metric
             * name to reflect the change, update the metric name as well. AWS WAF doesn't
    ...
    public interface GeoMatchStatementProperty {
         ...
         * requests, you still have to supply a country code for the rule to evaluate. In this case,
         * you configure the rule to only count matching requests, but it will still generate
         ...
         *
         * If the specified header isn't present in the request, AWS WAF doesn't apply the rule to
        ...
        public interface Builder {
            /**
             * @param countryCodes An array of two-character country codes that you want to match
             *   against, for example, `[ "US", "CN" ]` , from the alpha-2 country ISO codes of the
             *   ISO 3166 international standard. When you use a geo match statement just for the
             *   region and country labels that it adds to requests, you still have to supply a
             *   country code for the rule to evaluate. In this case, you configure the rule to only
             *   count matching requests, but it will still generate logging and count metrics for
             *   any matches. You can reduce the logging and metrics that the rule produces by
            ...
            /**
             * @param forwardedIpConfig The configuration for inspecting IP addresses in an HTTP
             *   header that you specify, instead of using the IP address that's reported by the web
             *   request origin. Commonly, this is the X-Forwarded-For (XFF) header, but you can
            ...
            public fun forwardedIpConfig(
                forwardedIpConfig: ForwardedIPConfigurationProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun forwardedIpConfig(forwardedIpConfig: ForwardedIPConfigurationProperty) {
                cdkBuilder.forwardedIpConfig(
                    forwardedIpConfig.let(ForwardedIPConfigurationProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("8a4f29dbbb3946321469421b45c2a51aceb555245d5013a1734684891b20097c")
            override fun forwardedIpConfig(
                forwardedIpConfig: ForwardedIPConfigurationProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-wafv2-rulegroup-geomatchstatement.html#cfn-wafv2-rulegroup-geomatchstatement-countrycodes)
             */
            override fun countryCodes(): List<String> =
                unwrap(this).getCountryCodes() ?: emptyList()
             ...
             *
             * Commonly, this is the X-Forwarded-For (XFF) header, but you can specify any header
             * name.
             *
             * If the specified header isn't present in the request, AWS WAF doesn't apply the rule
             * to the web request at all.
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: GeoMatchStatementProperty
            ): software.amazon.awscdk.services.wafv2.CfnRuleGroup.GeoMatchStatementProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CookieMatchPatternProperty {
         ...
         */
        public fun excludedCookies(): List<String> =
            unwrap(this).getExcludedCookies() ?: emptyList()
         ...
         */
        public fun includedCookies(): List<String> =
            unwrap(this).getIncludedCookies() ?: emptyList()
        ...
        public interface Builder {
            ...
            /**
             * @param excludedCookies Inspect only the cookies whose keys don't match any of the
            ...
            /**
             * @param includedCookies Inspect only the cookies that have a key that matches one of
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-wafv2-rulegroup-cookiematchpattern.html#cfn-wafv2-rulegroup-cookiematchpattern-excludedcookies)
             */
            override fun excludedCookies(): List<String> =
                unwrap(this).getExcludedCookies() ?: emptyList()
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-wafv2-rulegroup-cookiematchpattern.html#cfn-wafv2-rulegroup-cookiematchpattern-includedcookies)
             */
            override fun includedCookies(): List<String> =
                unwrap(this).getIncludedCookies() ?: emptyList()
        }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CookieMatchPatternProperty
            ): software.amazon.awscdk.services.wafv2.CfnRuleGroup.CookieMatchPatternProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SizeConstraintStatementProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param size The size, in byte, to compare to the request part, after any
             *   transformations.
             */
            public fun size(size: Number)

            /**
             * @param textTransformations Text transformations eliminate some of the unusual
             *   formatting that attackers use in web requests in an effort to bypass detection. If
             *   you specify one or more transformations in a rule statement, AWS WAF performs all
             *   transformations on the content of the request component identified by
             *   `FieldToMatch` , starting from the lowest priority setting, before inspecting the
             *   content for a match.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SizeConstraintStatementProperty
            ): software.amazon.awscdk.services.wafv2.CfnRuleGroup.SizeConstraintStatementProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface FieldToMatchProperty {
         ...
         * that contains any additional data that you want to send to your web server as the HTTP
         ...
         * CloudFront distributions, the limit is 16 KB (16,384 bytes). For CloudFront
         * distributions, you can increase the limit in the web ACL's `AssociationConfig` , for
         ...
         * configure how to handle any oversize cookie content in the `Cookies` object. AWS WAF
         ...
         * are forwarded to AWS WAF for inspection by the underlying host service. You must
         * configure how to handle any oversize header content in the `Headers` object. AWS WAF
        ...
        public interface Builder {
            ...
            /**
             * @param body Inspect the request body as plain text. The request body immediately
             *   follows the request headers. This is the part of a request that contains any
             *   additional data that you want to send to your web server as the HTTP request body,
             *   such as data from a form.
             *
             * A limited amount of the request body is forwarded to AWS WAF for inspection by the
             * underlying host service. For regional resources, the limit is 8 KB (8,192 bytes) and
             * for CloudFront distributions, the limit is 16 KB (16,384 bytes). For CloudFront
             * distributions, you can increase the limit in the web ACL's `AssociationConfig` , for
             * additional processing fees.
             *
             * For information about how to handle oversized request bodies, see the `Body` object
            ...
            /**
             * @param cookies Inspect the request cookies. You must configure scope and pattern
             *   matching filters in the `Cookies` object, to define the set of cookies and the
             *   parts of the cookies that AWS WAF inspects.
             *
             * Only the first 8 KB (8192 bytes) of a request's cookies and only the first 200
             * cookies are forwarded to AWS WAF for inspection by the underlying host service. You
             * must configure how to handle any oversize cookie content in the `Cookies` object. AWS
            ...
            /**
             * @param headers Inspect the request headers. You must configure scope and pattern
             *   matching filters in the `Headers` object, to define the set of headers to and the
             *   parts of the headers that AWS WAF inspects.
             *
             * Only the first 8 KB (8192 bytes) of a request's headers and only the first 200
             * headers are forwarded to AWS WAF for inspection by the underlying host service. You
             * must configure how to handle any oversize header content in the `Headers` object. AWS
            ...
            /**
             * @param jsonBody Inspect the request body as JSON. The request body immediately
             *   follows the request headers. This is the part of a request that contains any
             *   additional data that you want to send to your web server as the HTTP request body,
             *   such as data from a form.
             *
            ...
            /**
             * @param method Inspect the HTTP method. The method indicates the type of operation
             *   that the request is asking the origin to perform.
             */
            public fun method(method: Any)

            /**
             * @param queryString Inspect the query string. This is the part of a URL that appears
             *   after a `?` character, if any.
             */
            public fun queryString(queryString: Any)

            /**
             * @param singleHeader Inspect a single header. Provide the name of the header to
             *   inspect, for example, `User-Agent` or `Referer` . This setting isn't case
             *   sensitive.
             *
             * Example JSON: `"SingleHeader": { "Name": "haystack" }`
             *
            ...
            /**
             * @param singleQueryArgument Inspect a single query argument. Provide the name of the
             *   query argument to inspect, such as *UserName* or *SalesRegion* . The name can be up
            ...
            /**
             * @param uriPath Inspect the request URI path. This is the part of the web request that
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("79864400e90dbcd5de51d6f4db3e7ed861fc5cbcb9b6c0fcfc44129431036578")
            override fun body(body: BodyProperty.Builder.() -> Unit): Unit =
        ...
        internal constructor(
             ...
             * Inspect the request body as plain text.
             *
             * The request body immediately follows the request headers. This is the part of a
             * request that contains any additional data that you want to send to your web server as
             ...
             * Inspect the request cookies.
             *
             * You must configure scope and pattern matching filters in the `Cookies` object, to
             * define the set of cookies and the parts of the cookies that AWS WAF inspects.
             *
             * Only the first 8 KB (8192 bytes) of a request's cookies and only the first 200
             * cookies are forwarded to AWS WAF for inspection by the underlying host service. You
             * must configure how to handle any oversize cookie content in the `Cookies` object. AWS
             ...
             * Inspect the request headers.
             *
             * You must configure scope and pattern matching filters in the `Headers` object, to
             * define the set of headers to and the parts of the headers that AWS WAF inspects.
             *
             * Only the first 8 KB (8192 bytes) of a request's headers and only the first 200
             * headers are forwarded to AWS WAF for inspection by the underlying host service. You
             * must configure how to handle any oversize header content in the `Headers` object. AWS
             ...
             * Inspect a single query argument.
             *
             * Provide the name of the query argument to inspect, such as *UserName* or
    ...
    public interface LabelMatchStatementProperty {
         ...
         * * If the `Scope` indicates `LABEL` , then this specification must include the name and
         *   can include any number of preceding namespace specifications and prefix up to providing
         *   the fully qualified label name.
         * * If the `Scope` indicates `NAMESPACE` , then this specification can include any number
         *   of contiguous namespace strings, and can include the entire label namespace prefix from
         *   the rule group or web ACL where the label originates.
         *
        ...
        public interface Builder {
            /**
             * @param key The string to match against. The setting you provide for this depends on
             *   the match statement's `Scope` setting:.
             * * If the `Scope` indicates `LABEL` , then this specification must include the name
             *   and can include any number of preceding namespace specifications and prefix up to
             *   providing the fully qualified label name.
             * * If the `Scope` indicates `NAMESPACE` , then this specification can include any
             *   number of contiguous namespace strings, and can include the entire label namespace
            ...
            /**
             * @param scope Specify whether you want to match using the label name or just the
             *   namespace.
             */
            public fun scope(scope: String)
        }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: LabelMatchStatementProperty
            ): software.amazon.awscdk.services.wafv2.CfnRuleGroup.LabelMatchStatementProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface NotStatementProperty {
        ...
        public interface Builder {
            /**
             * @param statement The statement to negate. You can use any statement that can be
             *   nested.
             */
            public fun statement(statement: IResolvable)
    ...
    public interface VisibilityConfigProperty {
         ...
         *
         * For the list of available metrics, see
         ...
         * applied. AWS WAF applies the default action to web requests that pass the inspection of
         ...
         * The name can be from one to 128 characters long. It can't contain whitespace or metric
         * names that are reserved for AWS WAF , for example `All` and `Default_Action` .
         *
        ...
        /**
         * Indicates whether AWS WAF should store a sampling of the web requests that match the
         * rules.
         *
        ...
        public interface Builder {
            /**
             * @param cloudWatchMetricsEnabled Indicates whether the associated resource sends
             *   metrics to Amazon CloudWatch. For the list of available metrics, see
             *   [AWS WAF Metrics](https://docs.aws.amazon.com/waf/latest/developerguide/monitoring-cloudwatch.html#waf-metrics)
             *   in the *AWS WAF Developer Guide* .
             *
             * For web ACLs, the metrics are for web requests that have the web ACL default action
             * applied. AWS WAF applies the default action to web requests that pass the inspection
             * of all rules in the web ACL without being either allowed or blocked. For more
             * information, see
             * [The web ACL default action](https://docs.aws.amazon.com/waf/latest/developerguide/web-acl-default-action.html)
             * in the *AWS WAF Developer Guide* .
             */
            ...
            /**
             * @param metricName A name of the Amazon CloudWatch metric dimension. The name can
             *   contain only the characters: A-Z, a-z, 0-9, - (hyphen), and _ (underscore). The
             *   name can be from one to 128 characters long. It can't contain whitespace or metric
             *   names that are reserved for AWS WAF , for example `All` and `Default_Action` .
             */
            public fun metricName(metricName: String)

            /**
             * @param sampledRequestsEnabled Indicates whether AWS WAF should store a sampling of
             *   the web requests that match the rules. You can view the sampled requests through
             *   the AWS WAF console.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            override fun cloudWatchMetricsEnabled(cloudWatchMetricsEnabled: IResolvable) {
                cdkBuilder.cloudWatchMetricsEnabled(
                    cloudWatchMetricsEnabled.let(IResolvable::unwrap)
                )
            }
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-wafv2-rulegroup-visibilityconfig.html#cfn-wafv2-rulegroup-visibilityconfig-cloudwatchmetricsenabled)
             */
            override fun cloudWatchMetricsEnabled(): Any =
                unwrap(this).getCloudWatchMetricsEnabled()

            /**
             * A name of the Amazon CloudWatch metric dimension.
             *
             * The name can contain only the characters: A-Z, a-z, 0-9, - (hyphen), and _
             * (underscore). The name can be from one to 128 characters long. It can't contain
             * whitespace or metric names that are reserved for AWS WAF , for example `All` and
             * `Default_Action` .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-wafv2-rulegroup-visibilityconfig.html#cfn-wafv2-rulegroup-visibilityconfig-metricname)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: VisibilityConfigProperty
            ): software.amazon.awscdk.services.wafv2.CfnRuleGroup.VisibilityConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface RateLimitLabelNamespaceProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RateLimitLabelNamespaceProperty
            ): software.amazon.awscdk.services.wafv2.CfnRuleGroup.RateLimitLabelNamespaceProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface StatementProperty {
         ...
         * you want AWS WAF to search, and other settings. The bytes to search for are typically a
         * string that corresponds with ASCII characters. In the AWS WAF console and the developer
         ...
         * string can represent a part or all of the fully qualified label name that had been added
         * to the web request. Fully qualified labels have a prefix, optional namespaces, and label
         * name. The prefix identifies the rule group or web ACL context of the rule that added the
         * label. If you do not provide the fully qualified name in your label match string, AWS WAF
         * performs the search for labels that were added in the same context as the label match
         * statement.
         *
         ...
         * the rule's rate limiting counts. This can pause the rule's rate limiting activities for
         * up to a minute.
         *
         * You can specify individual aggregation keys, like IP address or HTTP method. You can also
         * specify aggregation key combinations, like IP address and HTTP method, or HTTP method,
         * query argument, and cookie.
         *
         ...
         * defines a separate aggregation instance, which AWS WAF counts and rate-limits
         * individually.
         *
         ...
         * `NotStatement` or `OrStatement` . You can define a `RateBasedStatement` inside a web ACL
         ...
         * retrieve the list of IP addresses that AWS WAF is currently rate limiting for a rule
         * through the API call `GetRateBasedStatementManagedKeys` . This option is not available
         ...
         * rule and gets its own tracking and management by AWS WAF . If you define a rate-based
         ...
         * detect, then use the ARN of that set in this statement. A web request matches the pattern
         * set rule statement if the request component matches any of the patterns in the set.
         *
         ...
         * multiple rules. When you update the referenced set, AWS WAF automatically updates all
         ...
         * this limit is 8 KB (8,192 bytes) and for CloudFront web ACLs, this limit is 16 KB (16,384
         ...
         * requests should never exceed the inspection limit, you could use a size constraint
        ...
        public interface Builder {
            /**
             * @param andStatement A logical rule statement used to combine other rule statements
             *   with AND logic. You provide more than one `Statement` within the `AndStatement` .
             */
            ...
            /**
             * @param byteMatchStatement A rule statement that defines a string match search for AWS
             *   WAF to apply to web requests. The byte match statement provides the bytes to search
             *   for, the location in requests that you want AWS WAF to search, and other settings.
             *   The bytes to search for are typically a string that corresponds with ASCII
             *   characters. In the AWS WAF console and the developer guide, this is called a string
             *   match statement.
             */
            ...
            public fun byteMatchStatement(
                byteMatchStatement: ByteMatchStatementProperty.Builder.() -> Unit
            )

            /**
             * @param geoMatchStatement A rule statement that labels web requests by country and
             *   region and that matches against web requests based on country code. A geo match
             *   rule labels every request that it inspects regardless of whether it finds a match.
             ...
             *   as needed.
             *
             * AWS WAF labels requests using the alpha-2 country and region codes from the
             * International Organization for Standardization (ISO) 3166 standard. AWS WAF
             * determines the codes using either the IP address in the web request origin or, if you
             * specify it, the address in the geo match `ForwardedIPConfig` .
             *
             * If you use the web request origin, the label formats are
             * `awswaf:clientip:geo:region:&lt;ISO country code&gt;-&lt;ISO region code&gt;` and
             * `awswaf:clientip:geo:country:&lt;ISO country code&gt;` .
            ...
            public fun geoMatchStatement(
                geoMatchStatement: GeoMatchStatementProperty.Builder.() -> Unit
            )

            /**
             * @param ipSetReferenceStatement A rule statement used to detect web requests coming
             *   from particular IP addresses or address ranges. To use this, create an `IPSet` that
             *   specifies the addresses you want to detect, then use the ARN of that set in this
             *   statement.
             *
             * Each IP set rule statement references an IP set. You create and maintain the set
             * independent of your rules. This allows you to use the single set in multiple rules.
             * When you update the referenced set, AWS WAF automatically updates all rules that
             * reference it.
             */
            ...
            public fun ipSetReferenceStatement(
                ipSetReferenceStatement: IPSetReferenceStatementProperty.Builder.() -> Unit
            )

            /**
             * @param labelMatchStatement A rule statement to match against labels that have been
             *   added to the web request by rules that have already run in the web ACL. The label
             *   match statement provides the label or namespace string to search for. The label
             *   string can represent a part or all of the fully qualified label name that had been
             ...
             *   of the rule that added the label. If you do not provide the fully qualified name in
             *   your label match string, AWS WAF performs the search for labels that were added in
            ...
            public fun labelMatchStatement(
                labelMatchStatement: LabelMatchStatementProperty.Builder.() -> Unit
            )

            /**
             * @param notStatement A logical rule statement used to negate the results of another
             *   rule statement. You provide one `Statement` within the `NotStatement` .
             */
            ...
            /**
             * @param orStatement A logical rule statement used to combine other rule statements
             *   with OR logic. You provide more than one `Statement` within the `OrStatement` .
             */
             ...
             *   requests when they are coming at too fast a rate. The rule categorizes requests
             *   according to your aggregation criteria, collects them into aggregation instances,
             *   and counts and rate limits the requests for each instance.
             *
             ...
             *   an aggregation instance, and AWS WAF counts requests separately for each. The
             ...
             * to just manage all requests that match a scope-down statement, the aggregation
             * instance is singular for the rule.
             *
             * You cannot nest a `RateBasedStatement` inside another statement, for example inside a
             ...
             * If you only aggregate on the individual IP address or forwarded IP address, you can
             * retrieve the list of IP addresses that AWS WAF is currently rate limiting for a rule
             * through the API call `GetRateBasedStatementManagedKeys` . This option is not
             * available for other aggregation configurations.
             *
             * AWS WAF tracks and manages web requests separately for each instance of a rate-based
             * rule that you use. For example, if you provide the same rate-based rule settings in
             * two web ACLs, each of the two rule statements represents a separate instance of the
             * rate-based rule and gets its own tracking and management by AWS WAF . If you define a
             * rate-based rule inside a rule group, and then use that rule group in multiple places,
             * each use creates a separate instance of the rate-based rule that gets its own
            ...
            public fun rateBasedStatement(
                rateBasedStatement: RateBasedStatementProperty.Builder.() -> Unit
            )

            /**
             * @param regexMatchStatement A rule statement used to search web request components for
             *   a match against a single regular expression.
             */
            ...
            public fun regexMatchStatement(
                regexMatchStatement: RegexMatchStatementProperty.Builder.() -> Unit
            )

            /**
             * @param regexPatternSetReferenceStatement A rule statement used to search web request
             *   components for matches with regular expressions. To use this, create a
             *   `RegexPatternSet` that specifies the expressions that you want to detect, then use
             *   the ARN of that set in this statement. A web request matches the pattern set rule
            ...
            public fun regexPatternSetReferenceStatement(
                regexPatternSetReferenceStatement: IResolvable
            )
            ...
            public fun regexPatternSetReferenceStatement(
                regexPatternSetReferenceStatement:
                    RegexPatternSetReferenceStatementProperty.Builder.() -> Unit
            )

            /**
             * @param sizeConstraintStatement A rule statement that compares a number of bytes
             *   against the size of a request component, using a comparison operator, such as
             *   greater than (&gt;) or less than (&lt;). For example, you can use a size constraint
             *   statement to look for query strings that are longer than 100 bytes.
             *
             * If you configure AWS WAF to inspect the request body, AWS WAF inspects only the
             * number of bytes of the body up to the limit for the web ACL. By default, for regional
             * web ACLs, this limit is 8 KB (8,192 bytes) and for CloudFront web ACLs, this limit is
             * 16 KB (16,384 bytes). For CloudFront web ACLs, you can increase the limit in the web
             * ACL `AssociationConfig` , for additional fees. If you know that the request body for
             ...
             * the URI counts as one character. For example, the URI `/logo.jpg` is nine characters
             * long.
             */
            ...
            public fun sizeConstraintStatement(
                sizeConstraintStatement: SizeConstraintStatementProperty.Builder.() -> Unit
            )
            ...
            public fun sqliMatchStatement(
                sqliMatchStatement: SqliMatchStatementProperty.Builder.() -> Unit
            )

            /**
             * @param xssMatchStatement A rule statement that inspects for cross-site scripting
             *   (XSS) attacks. In XSS attacks, the attacker uses vulnerabilities in a benign
             *   website as a vehicle to inject malicious client-site scripts into other legitimate
             *   web browsers.
             */
            ...
            public fun xssMatchStatement(
                xssMatchStatement: XssMatchStatementProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun byteMatchStatement(byteMatchStatement: ByteMatchStatementProperty) {
                cdkBuilder.byteMatchStatement(
                    byteMatchStatement.let(ByteMatchStatementProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("bb06d910592d98a855bd9168f0a5c142e5f51bec98f9a9aa52a47918efa5dc4b")
            override fun byteMatchStatement(
                byteMatchStatement: ByteMatchStatementProperty.Builder.() -> Unit
            ...
            override fun geoMatchStatement(geoMatchStatement: GeoMatchStatementProperty) {
                cdkBuilder.geoMatchStatement(
                    geoMatchStatement.let(GeoMatchStatementProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("0b98767a03cb91f73a06c0f74957732cd56c6757f90cfefb368998d3fe8a7c14")
            override fun geoMatchStatement(
                geoMatchStatement: GeoMatchStatementProperty.Builder.() -> Unit
             ...
             * reference it.
             */
            override fun ipSetReferenceStatement(
                ipSetReferenceStatement: IPSetReferenceStatementProperty
            ) {
                cdkBuilder.ipSetReferenceStatement(
                    ipSetReferenceStatement.let(IPSetReferenceStatementProperty::unwrap)
                )
            }
            ...
            override fun ipSetReferenceStatement(
                ...
                ipSetReferenceStatement(IPSetReferenceStatementProperty(ipSetReferenceStatement))
            ...
            override fun labelMatchStatement(labelMatchStatement: LabelMatchStatementProperty) {
                cdkBuilder.labelMatchStatement(
                    labelMatchStatement.let(LabelMatchStatementProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("986e5de76be654a8e15d6058c9ee74294e83fe3810db67688f779f82170788a1")
            override fun labelMatchStatement(
                labelMatchStatement: LabelMatchStatementProperty.Builder.() -> Unit
            ...
            override fun rateBasedStatement(rateBasedStatement: RateBasedStatementProperty) {
                cdkBuilder.rateBasedStatement(
                    rateBasedStatement.let(RateBasedStatementProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("8bcfd0d44bbb6308f131b368f5d5098eee6e7d23736279eeb92b50311609b4d9")
            override fun rateBasedStatement(
                rateBasedStatement: RateBasedStatementProperty.Builder.() -> Unit
            ...
            override fun regexMatchStatement(regexMatchStatement: RegexMatchStatementProperty) {
                cdkBuilder.regexMatchStatement(
                    regexMatchStatement.let(RegexMatchStatementProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("cab718641bfc23238d998ba962f49b68c7c0ad9ac57e0d1f09949e0da4e506f8")
            override fun regexMatchStatement(
                regexMatchStatement: RegexMatchStatementProperty.Builder.() -> Unit
             ...
             * rules that reference it.
             */
            override fun regexPatternSetReferenceStatement(
                regexPatternSetReferenceStatement: IResolvable
            ) {
                cdkBuilder.regexPatternSetReferenceStatement(
                    regexPatternSetReferenceStatement.let(IResolvable::unwrap)
                )
            }
            ...
            override fun regexPatternSetReferenceStatement(
                ...
                cdkBuilder.regexPatternSetReferenceStatement(
                    regexPatternSetReferenceStatement.let(
                        RegexPatternSetReferenceStatementProperty::unwrap
                    )
                )
            }
            ...
            override fun regexPatternSetReferenceStatement(
                ...
                regexPatternSetReferenceStatement(
                    RegexPatternSetReferenceStatementProperty(regexPatternSetReferenceStatement)
                )
             ...
             * long.
             */
            override fun sizeConstraintStatement(
                sizeConstraintStatement: SizeConstraintStatementProperty
            ) {
                cdkBuilder.sizeConstraintStatement(
                    sizeConstraintStatement.let(SizeConstraintStatementProperty::unwrap)
                )
            }
            ...
            override fun sizeConstraintStatement(
                ...
                sizeConstraintStatement(SizeConstraintStatementProperty(sizeConstraintStatement))
            ...
            override fun sqliMatchStatement(sqliMatchStatement: SqliMatchStatementProperty) {
                cdkBuilder.sqliMatchStatement(
                    sqliMatchStatement.let(SqliMatchStatementProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("0fdab764bc61099312cfe517891cb2231ee5552284f8fd95a4f44fdbb7ddf3f5")
            override fun sqliMatchStatement(
                sqliMatchStatement: SqliMatchStatementProperty.Builder.() -> Unit
            ...
            override fun xssMatchStatement(xssMatchStatement: XssMatchStatementProperty) {
                cdkBuilder.xssMatchStatement(
                    xssMatchStatement.let(XssMatchStatementProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("d2f50b19cc87986feaf8db81faf794d3554022dd9e71876a010beea7ac2d6210")
            override fun xssMatchStatement(
                xssMatchStatement: XssMatchStatementProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * that you want AWS WAF to search, and other settings. The bytes to search for are
             * typically a string that corresponds with ASCII characters. In the AWS WAF console and
             * the developer guide, this is called a string match statement.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-wafv2-rulegroup-statement.html#cfn-wafv2-rulegroup-statement-bytematchstatement)
             */
             ...
             *
             * A geo match rule labels every request that it inspects regardless of whether it finds
             * a match.
             * * To manage requests only by country, you can use this statement by itself and
             *   specify the countries that you want to match against in the `CountryCodes` array.
             * * Otherwise, configure your geo match rule with Count action so that it only labels
             ...
             * address ranges.
             *
             * To use this, create an `IPSet` that specifies the addresses you want to detect, then
             * use the ARN of that set in this statement.
             *
             * Each IP set rule statement references an IP set. You create and maintain the set
             * independent of your rules. This allows you to use the single set in multiple rules.
             * When you update the referenced set, AWS WAF automatically updates all rules that
             ...
             * been added to the web request. Fully qualified labels have a prefix, optional
             * namespaces, and label name. The prefix identifies the rule group or web ACL context
             * of the rule that added the label. If you do not provide the fully qualified name in
             * your label match string, AWS WAF performs the search for labels that were added in
             * the same context as the label match statement.
             ...
             * coming at too fast a rate.
             *
             * The rule categorizes requests according to your aggregation criteria, collects them
             * into aggregation instances, and counts and rate limits the requests for each
             * instance.
             *
             * If you change any of these settings in a rule that's currently in use, the change
             * resets the rule's rate limiting counts. This can pause the rule's rate limiting
             ...
             * expressions.
             *
             * To use this, create a `RegexPatternSet` that specifies the expressions that you want
             * to detect, then use the ARN of that set in this statement. A web request matches the
             * pattern set rule statement if the request component matches any of the patterns in
             * the set.
             *
             * Each regex pattern set rule statement references a regex pattern set. You create and
             * maintain the set independent of your rules. This allows you to use the single set in
             ...
             * (&lt;).
             *
             * For example, you can use a size constraint statement to look for query strings that
    ...
    public interface RateBasedStatementCustomKeyProperty {
         ...
         *
         * Each distinct HTTP method contributes to the aggregation instance. If you use just the
         ...
         * contributes to the aggregation instance. If you use just one label namespace as your
        ...
        public interface Builder {
            /**
             * @param cookie Use the value of a cookie in the request as an aggregate key. Each
             *   distinct value in the cookie contributes to the aggregation instance. If you use a
             ...
             * specify at least one other key to use. You can aggregate on only the forwarded IP
            ...
            /**
             * @param header Use the value of a header in the request as an aggregate key. Each
             *   distinct value in the header contributes to the aggregation instance. If you use a
            ...
            /**
             * @param httpMethod Use the request's HTTP method as an aggregate key. Each distinct
             *   HTTP method contributes to the aggregation instance. If you use just the HTTP
             *   method as your custom key, then each method fully defines an aggregation instance.
             */
            public fun httpMethod(httpMethod: Any)

            /**
             * @param ip Use the request's originating IP address as an aggregate key. Each distinct
             *   IP address contributes to the aggregation instance. When you specify an IP or
             *   forwarded IP in the custom key settings, you must also specify at least one other
             *   key to use. You can aggregate on only the IP address by specifying `IP` in your
             *   rate-based statement's `AggregateKeyType` .
             */
            public fun ip(ip: Any)

            /**
             * @param labelNamespace Use the specified label namespace as an aggregate key. Each
             *   distinct fully qualified label name that has the specified label namespace
            ...
            public fun labelNamespace(
                labelNamespace: RateLimitLabelNamespaceProperty.Builder.() -> Unit
            )

            /**
             * @param queryArgument Use the specified query argument as an aggregate key. Each
             *   distinct value for the named query argument contributes to the aggregation
             *   instance. If you use a single query argument as your custom key, then each value
            ...
            public fun queryArgument(
                queryArgument: RateLimitQueryArgumentProperty.Builder.() -> Unit
            )

            /**
             * @param queryString Use the request's query string as an aggregate key. Each distinct
             *   string contributes to the aggregation instance. If you use just the query string as
        ...
        private class BuilderImpl : Builder {
            ...
            override fun labelNamespace(labelNamespace: RateLimitLabelNamespaceProperty) {
                cdkBuilder.labelNamespace(
                    labelNamespace.let(RateLimitLabelNamespaceProperty::unwrap)
                )
            }
            ...
            override fun queryString(
                queryString: RateLimitQueryStringProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * Use the value of a cookie in the request as an aggregate key.
             *
             * Each distinct value in the cookie contributes to the aggregation instance. If you use
             * a single cookie as your custom key, then each value fully defines an aggregation
             * instance.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-wafv2-rulegroup-ratebasedstatementcustomkey.html#cfn-wafv2-rulegroup-ratebasedstatementcustomkey-cookie)
             */
             ...
             * Use the value of a header in the request as an aggregate key.
             *
             * Each distinct value in the header contributes to the aggregation instance. If you use
             * a single header as your custom key, then each value fully defines an aggregation
             * instance.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-wafv2-rulegroup-ratebasedstatementcustomkey.html#cfn-wafv2-rulegroup-ratebasedstatementcustomkey-header)
             */
             ...
             * Use the request's HTTP method as an aggregate key.
             *
             * Each distinct HTTP method contributes to the aggregation instance. If you use just
             * the HTTP method as your custom key, then each method fully defines an aggregation
             * instance.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-wafv2-rulegroup-ratebasedstatementcustomkey.html#cfn-wafv2-rulegroup-ratebasedstatementcustomkey-httpmethod)
             */
             ...
             *
             * When you specify an IP or forwarded IP in the custom key settings, you must also
             * specify at least one other key to use. You can aggregate on only the IP address by
             ...
             * Use the specified query argument as an aggregate key.
             *
             * Each distinct value for the named query argument contributes to the aggregation
             * instance. If you use a single query argument as your custom key, then each value
             * fully defines an aggregation instance.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-wafv2-rulegroup-ratebasedstatementcustomkey.html#cfn-wafv2-rulegroup-ratebasedstatementcustomkey-queryargument)
             ...
             * Use the request's query string as an aggregate key.
             *
             * Each distinct string contributes to the aggregation instance. If you use just the
             * query string as your custom key, then each string fully defines an aggregation
             * instance.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-wafv2-rulegroup-ratebasedstatementcustomkey.html#cfn-wafv2-rulegroup-ratebasedstatementcustomkey-querystring)
             */
             ...
             * Use the request's URI path as an aggregate key.
             *
             * Each distinct URI path contributes to the aggregation instance. If you use just the
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RateBasedStatementCustomKeyProperty
            ): software.amazon.awscdk.services.wafv2.CfnRuleGroup.RateBasedStatementCustomKeyProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface IPSetForwardedIPConfigurationProperty {
         ...
         * address identifies the original client and the rest identify proxies that the request
         * went through.
         *
        ...
        public interface Builder {
            ...
            /**
             * @param headerName The name of the HTTP header to use for the IP address. For example,
             *   to use the X-Forwarded-For (XFF) header, set this to `X-Forwarded-For` .
             *
             * If the specified header isn't present in the request, AWS WAF doesn't apply the rule
             * to the web request at all.
             */
            ...
            /**
             * @param position The position in the header to search for the IP address. The header
             *   can contain IP addresses of the original client and also of proxies. For example,
             ...
             *
             * The options for this setting are the following:
             * * FIRST - Inspect the first IP address in the list of IP addresses in the header.
             *   This is usually the client's original IP.
             * * LAST - Inspect the last IP address in the list of IP addresses in the header.
             * * ANY - Inspect all IP addresses in the header for a match. If the header contains
             *   more than 10 IP addresses, AWS WAF inspects the last 10.
             */
        ...
        internal constructor(
             ...
             *
             * The header can contain IP addresses of the original client and also of proxies. For
             * example, the header value could be `10.1.1.1, 127.0.0.0, 10.10.10.10` where the first
             * IP address identifies the original client and the rest identify proxies that the
             * request went through.
             *
             * The options for this setting are the following:
             * * FIRST - Inspect the first IP address in the list of IP addresses in the header.
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: IPSetForwardedIPConfigurationProperty
            ): software.amazon.awscdk.services.wafv2.CfnRuleGroup.IPSetForwardedIPConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface IPSetReferenceStatementProperty {
        ...
        public interface Builder {
            /**
             * @param arn The Amazon Resource Name (ARN) of the `IPSet` that this statement
             *   references.
             */
            public fun arn(arn: String)

            /**
             * @param ipSetForwardedIpConfig The configuration for inspecting IP addresses in an
             *   HTTP header that you specify, instead of using the IP address that's reported by
             *   the web request origin. Commonly, this is the X-Forwarded-For (XFF) header, but you
             ...
             * to the web request at all.
             */
            public fun ipSetForwardedIpConfig(
            ...
            public fun ipSetForwardedIpConfig(
                ipSetForwardedIpConfig: IPSetForwardedIPConfigurationProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
             ...
             * to the web request at all.
             */
            override fun ipSetForwardedIpConfig(
                ipSetForwardedIpConfig: IPSetForwardedIPConfigurationProperty
            ) {
                cdkBuilder.ipSetForwardedIpConfig(
                    ipSetForwardedIpConfig.let(IPSetForwardedIPConfigurationProperty::unwrap)
                )
            }
            ...
            override fun ipSetForwardedIpConfig(
                ...
                ipSetForwardedIpConfig(
                    IPSetForwardedIPConfigurationProperty(ipSetForwardedIpConfig)
                )
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: IPSetReferenceStatementProperty
            ): software.amazon.awscdk.services.wafv2.CfnRuleGroup.IPSetReferenceStatementProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface OrStatementProperty {
        ...
        public interface Builder {
            /**
             * @param statements The statements to combine with OR logic. You can use any statements
             *   that can be nested.
             */
    ...
    public interface ByteMatchStatementProperty {
         ...
         * * `SearchString` is at the end of the specified part of the web request or is followed by
         ...
         * `FieldToMatch` . The maximum length of the value is 200 bytes. For alphabetic characters
         * A-Z and a-z, the value is case sensitive.
         *
        ...
        public interface Builder {
            ...
            /**
             * @param positionalConstraint The area within the portion of the web request that you
             *   want AWS WAF to search for `SearchString` . Valid values include the following:
             *
             * *CONTAINS*
             *
             * The specified part of the web request must include the value of `SearchString` , but
             * the location doesn't matter.
             *
             * *CONTAINS_WORD*
             *
             * The specified part of the web request must include the value of `SearchString` , and
             * `SearchString` must contain only alphanumeric characters or underscore (A-Z, a-z,
             * 0-9, or _). In addition, `SearchString` must be a word, which means that both of the
             * following are true:
             * * `SearchString` is at the beginning of the specified part of the web request or is
             *   preceded by a character other than an alphanumeric character or underscore (_).
             *   Examples include the value of a header and `;BadBot` .
             ...
             * *STARTS_WITH*
             *
             * The value of `SearchString` must appear at the beginning of the specified part of the
             * web request.
             *
             * *ENDS_WITH*
             *
            ...
            /**
             * @param searchString A string value that you want AWS WAF to search for. AWS WAF
             *   searches only in the part of web requests that you designate for inspection in
             *   `FieldToMatch` . The maximum length of the value is 200 bytes. For alphabetic
             *   characters A-Z and a-z, the value is case sensitive.
             *
             * Don't encode this string. Provide the value that you want AWS WAF to search for. AWS
             * CloudFormation automatically base64 encodes the value for you.
             *
             ...
             * you provide the string `BadBot` in the value of `SearchString` .
             *
             * You must specify either `SearchString` or `SearchStringBase64` in a
             * `ByteMatchStatement` .
             */
            public fun searchString(searchString: String)

            /**
             * @param searchStringBase64 String to search for in a web request component,
             *   base64-encoded. If you don't want to encode the string, specify the unencoded value
             *   in `SearchString` instead.
             *
             * You must specify either `SearchString` or `SearchStringBase64` in a
             * `ByteMatchStatement` .
             */
        ...
        internal constructor(
             ...
             * A string value that you want AWS WAF to search for.
             *
             * AWS WAF searches only in the part of web requests that you designate for inspection
             * in `FieldToMatch` . The maximum length of the value is 200 bytes. For alphabetic
             * characters A-Z and a-z, the value is case sensitive.
             *
             * Don't encode this string. Provide the value that you want AWS WAF to search for. AWS
             * CloudFormation automatically base64 encodes the value for you.
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ByteMatchStatementProperty
            ): software.amazon.awscdk.services.wafv2.CfnRuleGroup.ByteMatchStatementProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface RegexMatchStatementProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RegexMatchStatementProperty
            ): software.amazon.awscdk.services.wafv2.CfnRuleGroup.RegexMatchStatementProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ChallengeConfigProperty {
        ...
        public interface Builder {
            /**
             * @param immunityTimeProperty Determines how long a challenge timestamp in the token
             *   remains valid after the client successfully responds to a challenge.
             */
            ...
            public fun immunityTimeProperty(
                immunityTimeProperty: ImmunityTimePropertyProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun immunityTimeProperty(immunityTimeProperty: ImmunityTimePropertyProperty) {
                cdkBuilder.immunityTimeProperty(
                    immunityTimeProperty.let(ImmunityTimePropertyProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("25712aa626ae3a601c0c8fb1bdf61d71e0be3743f106c426601d52f166c580ec")
            override fun immunityTimeProperty(
                immunityTimeProperty: ImmunityTimePropertyProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ChallengeConfigProperty
            ): software.amazon.awscdk.services.wafv2.CfnRuleGroup.ChallengeConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface TextTransformationProperty {
         ...
         * the transformed content. The priorities don't need to be consecutive, but they must all
         * be different.
         *
        ...
        public interface Builder {
            /**
             * @param priority Sets the relative processing order for multiple transformations. AWS
             *   WAF processes all transformations, from lowest priority to highest, before
        ...
        internal constructor(
             ...
             * Sets the relative processing order for multiple transformations.
             *
             * AWS WAF processes all transformations, from lowest priority to highest, before
             * inspecting the transformed content. The priorities don't need to be consecutive, but
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TextTransformationProperty
            ): software.amazon.awscdk.services.wafv2.CfnRuleGroup.TextTransformationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CaptchaConfigProperty {
        ...
        public interface Builder {
            /**
             * @param immunityTimeProperty Determines how long a `CAPTCHA` timestamp in the token
             *   remains valid after the client successfully solves a `CAPTCHA` puzzle.
             */
            public fun immunityTimeProperty(immunityTimeProperty: IResolvable)
    ...
    public interface CountProperty {
        ...
        public interface Builder {
            ...
            public fun customRequestHandling(
                customRequestHandling: CustomRequestHandlingProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            /** @param customRequestHandling Custom request handling. */
            override fun customRequestHandling(
                customRequestHandling: CustomRequestHandlingProperty
            ) {
                cdkBuilder.customRequestHandling(
                    customRequestHandling.let(CustomRequestHandlingProperty::unwrap)
                )
            }
    ...
    public interface BodyProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: BodyProperty
            ): software.amazon.awscdk.services.wafv2.CfnRuleGroup.BodyProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CustomRequestHandlingProperty {
        ...
        public interface Builder {
            /**
             * @param insertHeaders The HTTP headers to insert into the request. Duplicate header
             *   names are not allowed. For information about the limits on count and size for
             *   custom request and response settings, see
             *   [AWS WAF quotas](https://docs.aws.amazon.com/waf/latest/developerguide/limits.html)
             *   in the *AWS WAF Developer Guide* .
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CustomRequestHandlingProperty
            ): software.amazon.awscdk.services.wafv2.CfnRuleGroup.CustomRequestHandlingProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface RateLimitCookieProperty {
         ...
         * to transform request components before using them as custom aggregation keys. If you
         * specify one or more transformations to apply, AWS WAF performs all transformations on the
         * specified content, starting from the lowest priority setting, and then uses the
        ...
        public interface Builder {
            ...
            /**
             * @param textTransformations Text transformations eliminate some of the unusual
             *   formatting that attackers use in web requests in an effort to bypass detection.
             *   Text transformations are used in rule match statements, to transform the
             *   `FieldToMatch` request component before inspecting it, and they're used in
             *   rate-based rule statements, to transform request components before using them as
             *   custom aggregation keys. If you specify one or more transformations to apply, AWS
             *   WAF performs all transformations on the specified content, starting from the lowest
        ...
        internal constructor(
             ...
             *
             * Text transformations are used in rule match statements, to transform the
             * `FieldToMatch` request component before inspecting it, and they're used in rate-based
             * rule statements, to transform request components before using them as custom
             * aggregation keys. If you specify one or more transformations to apply, AWS WAF
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RateLimitCookieProperty
            ): software.amazon.awscdk.services.wafv2.CfnRuleGroup.RateLimitCookieProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ForwardedIPConfigurationProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ForwardedIPConfigurationProperty
            ): software.amazon.awscdk.services.wafv2.CfnRuleGroup.ForwardedIPConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CustomHTTPHeaderProperty {
         ...
         * prefixes this name `x-amzn-waf-` , to avoid confusion with the headers that are already
         * in the request. For example, for the header name `sample` , AWS WAF inserts the header
         * `x-amzn-waf-sample` .
         *
        ...
        public interface Builder {
            /**
             * @param name The name of the custom header. For custom request header insertion, when
             *   AWS WAF inserts the header into the request, it prefixes this name `x-amzn-waf-` ,
             *   to avoid confusion with the headers that are already in the request. For example,
             *   for the header name `sample` , AWS WAF inserts the header `x-amzn-waf-sample` .
             */
            public fun name(name: String)
        ...
        internal constructor(
             ...
             * The name of the custom header.
             *
             * For custom request header insertion, when AWS WAF inserts the header into the
             * request, it prefixes this name `x-amzn-waf-` , to avoid confusion with the headers
             * that are already in the request. For example, for the header name `sample` , AWS WAF
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CustomHTTPHeaderProperty
            ): software.amazon.awscdk.services.wafv2.CfnRuleGroup.CustomHTTPHeaderProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface RegexPatternSetReferenceStatementProperty {
        ...
        public interface Builder {
            /**
             * @param arn The Amazon Resource Name (ARN) of the `RegexPatternSet` that this
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RegexPatternSetReferenceStatementProperty
            ): software.amazon.awscdk.services.wafv2.CfnRuleGroup.RegexPatternSetReferenceStatementProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CustomResponseBodyProperty {
        ...
        public interface Builder {
            /**
             * @param content The payload of the custom response. You can use JSON escape strings in
             *   JSON content. To do this, you must specify JSON content in the `ContentType`
             *   setting.
             *
             * For information about the limits on count and size for custom request and response
             * settings, see
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CustomResponseBodyProperty
            ): software.amazon.awscdk.services.wafv2.CfnRuleGroup.CustomResponseBodyProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface XssMatchStatementProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: XssMatchStatementProperty
            ): software.amazon.awscdk.services.wafv2.CfnRuleGroup.XssMatchStatementProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CookiesProperty {
         ...
         * WAF can inspect.
         *
         * AWS WAF does not support inspecting the entire contents of request cookies when they
         * exceed 8 KB (8192 bytes) or 200 total cookies. The underlying host service forwards a
         * maximum of 200 cookies and at most 8 KB of cookie contents to AWS WAF .
         *
         * The options for oversize handling are the following:
        ...
        public interface Builder {
            /**
             * @param matchPattern The filter to use to identify the subset of cookies to inspect in
             *   a web request. You must specify exactly one setting: either `All` ,
            ...
            /**
             * @param matchScope The parts of the cookies to inspect with the rule inspection
             *   criteria. If you specify `ALL` , AWS WAF inspects both keys and values.
             *
             * `All` does not require a match to be found in the keys and a match to be found in the
             * values. It requires a match to be found in the keys or the values or both. To require
             * a match in the keys and in the values, use a logical `AND` statement to combine two
             ...
             *   numerous or larger than AWS WAF can inspect. AWS WAF does not support inspecting
             *   the entire contents of request cookies when they exceed 8 KB (8192 bytes) or 200
             *   total cookies. The underlying host service forwards a maximum of 200 cookies and at
             *   most 8 KB of cookie contents to AWS WAF .
             *
             * The options for oversize handling are the following:
        ...
        private class BuilderImpl : Builder {
            ...
            @JvmName("33c7a4294d46b15314faa20cbc581a5299fe769d51328a38caa4a269c8f46a67")
            override fun matchPattern(
                matchPattern: CookieMatchPatternProperty.Builder.() -> Unit
        ...
        internal constructor(
            internal val cdkObject:
                software.amazon.awscdk.services.wafv2.CfnRuleGroup.CookiesProperty,
        ) : CookiesProperty {
            /**
             * The filter to use to identify the subset of cookies to inspect in a web request.
             *
            ...
            /**
             * What AWS WAF should do if the cookies of the request are more numerous or larger than
             * AWS WAF can inspect.
             *
             * AWS WAF does not support inspecting the entire contents of request cookies when they
             * exceed 8 KB (8192 bytes) or 200 total cookies. The underlying host service forwards a
    ...
    public interface SingleQueryArgumentProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SingleQueryArgumentProperty
            ): software.amazon.awscdk.services.wafv2.CfnRuleGroup.SingleQueryArgumentProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface JsonMatchPatternProperty {
        ...
        public interface Builder {
             ...
             *   `FieldToMatch` specification. You must specify either this setting or the
             *   `IncludedPaths` setting, but not both.
             */
            public fun all(all: Any)

            /**
             * @param includedPaths Match only the specified include paths. See also `MatchScope` in
             *   the `JsonBody` `FieldToMatch` specification. Provide the include paths using JSON
             *   Pointer syntax. For example, `"IncludedPaths": ["/dogs/0/name", "/dogs/1/name"]` .
             *   For information about this syntax, see the Internet Engineering Task Force (IETF)
             *   documentation
             *   [JavaScript Object Notation (JSON) Pointer](https://docs.aws.amazon.com/https://tools.ietf.org/html/rfc6901)
             *   .
             *
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-wafv2-rulegroup-jsonmatchpattern.html#cfn-wafv2-rulegroup-jsonmatchpattern-includedpaths)
             */
            override fun includedPaths(): List<String> =
                unwrap(this).getIncludedPaths() ?: emptyList()
        }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: JsonMatchPatternProperty
            ): software.amazon.awscdk.services.wafv2.CfnRuleGroup.JsonMatchPatternProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface RateLimitUriPathProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RateLimitUriPathProperty
            ): software.amazon.awscdk.services.wafv2.CfnRuleGroup.RateLimitUriPathProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface BlockProperty {
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("6a661143ecc23271f0e9bf9540d9034164117bf5f41099f43a8eb0cf4c1b20a3")
            override fun customResponse(
                customResponse: CustomResponseProperty.Builder.() -> Unit
        ...
        internal constructor(
            internal val cdkObject:
                software.amazon.awscdk.services.wafv2.CfnRuleGroup.BlockProperty,
        ) : BlockProperty {
            /**
             * Custom response.
             *
    ...
    public interface RateBasedStatementProperty {
         ...
         *   statement. With this option, the counted requests aren't further aggregated. The
         *   scope-down statement is the only specification used. When the count of all requests
         *   that satisfy the scope-down statement goes over the limit, AWS WAF applies the rule
         *   action to all requests that satisfy the scope-down statement.
         *
         * With this option, you must configure the `ScopeDownStatement` property.
         * * `CUSTOM_KEYS` - Aggregate the request counts using one or more web request components
         ...
         * * `FORWARDED_IP` - Aggregate the request counts on the first IP address in an HTTP
         *   header.
         *
         ...
         * rate-based rule.
         *
         * If the rate-based statement includes a `ScopeDownStatement` , this limit is applied only
         ...
         *   IP address.
         * * If you aggregate on the HTTP method and the query argument name "city", then this is
         *   the limit on requests for any single method, city pair.
         *
         ...
         * evaluated and managed by the rate-based statement.
         *
        ...
        public interface Builder {
             ...
             *   aggregated. The scope-down statement is the only specification used. When the count
             *   of all requests that satisfy the scope-down statement goes over the limit, AWS WAF
             *   applies the rule action to all requests that satisfy the scope-down statement.
             *
             * With this option, you must configure the `ScopeDownStatement` property.
            ...
            /**
             * @param limit The limit on requests per 5-minute period for a single aggregation
             ...
             *
             * Examples:
             * * If you aggregate on just the IP address, this is the limit on requests from any
             *   single IP address.
            ...
            /**
             * @param scopeDownStatement An optional nested statement that narrows the scope of the
             *   web requests that are evaluated and managed by the rate-based statement. When you
             *   use a scope-down statement, the rate-based rule only tracks and rate limits
             *   requests that match the scope-down statement. You can use any nestable `Statement`
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("46c7c628fa6c373879f7fe437cda0831a075f3df8980c268da4be8cea4e8348b")
            override fun scopeDownStatement(
                scopeDownStatement: StatementProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * rate-based rule.
             *
             * If the rate-based statement includes a `ScopeDownStatement` , this limit is applied
             * only to the requests that match the statement.
             *
             * Examples:
             * * If you aggregate on just the IP address, this is the limit on requests from any
             *   single IP address.
             ...
             *
             * When you use a scope-down statement, the rate-based rule only tracks and rate limits
             * requests that match the scope-down statement. You can use any nestable `Statement` in
             * the scope-down statement, and you can nest statements at any level, the same as you
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RateBasedStatementProperty
            ): software.amazon.awscdk.services.wafv2.CfnRuleGroup.RateBasedStatementProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface RateLimitHeaderProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RateLimitHeaderProperty
            ): software.amazon.awscdk.services.wafv2.CfnRuleGroup.RateLimitHeaderProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface HeadersProperty {
         ...
         * WAF can inspect.
         *
         * AWS WAF does not support inspecting the entire contents of request headers when they
         * exceed 8 KB (8192 bytes) or 200 total headers. The underlying host service forwards a
         * maximum of 200 headers and at most 8 KB of header contents to AWS WAF .
         *
         * The options for oversize handling are the following:
        ...
        public interface Builder {
            /**
             * @param matchPattern The filter to use to identify the subset of headers to inspect in
             *   a web request. You must specify exactly one setting: either `All` ,
            ...
            /**
             * @param matchScope The parts of the headers to match with the rule inspection
             *   criteria. If you specify `ALL` , AWS WAF inspects both keys and values.
             *
             * `All` does not require a match to be found in the keys and a match to be found in the
             * values. It requires a match to be found in the keys or the values or both. To require
             ...
             *   numerous or larger than AWS WAF can inspect. AWS WAF does not support inspecting
             *   the entire contents of request headers when they exceed 8 KB (8192 bytes) or 200
             *   total headers. The underlying host service forwards a maximum of 200 headers and at
             *   most 8 KB of header contents to AWS WAF .
             *
             * The options for oversize handling are the following:
        ...
        private class BuilderImpl : Builder {
            ...
            @JvmName("4ca701f0e2a77272bf2f76e6d7688fc4f80233f972755f0c81b1e13bacd25f1d")
            override fun matchPattern(
                matchPattern: HeaderMatchPatternProperty.Builder.() -> Unit
        ...
        internal constructor(
            internal val cdkObject:
                software.amazon.awscdk.services.wafv2.CfnRuleGroup.HeadersProperty,
        ) : HeadersProperty {
            /**
             * The filter to use to identify the subset of headers to inspect in a web request.
             *
            ...
            /**
             * What AWS WAF should do if the headers of the request are more numerous or larger than
             * AWS WAF can inspect.
             *
             * AWS WAF does not support inspecting the entire contents of request headers when they
             * exceed 8 KB (8192 bytes) or 200 total headers. The underlying host service forwards a
    ...
    public interface HeaderMatchPatternProperty {
         ...
         */
        public fun excludedHeaders(): List<String> =
            unwrap(this).getExcludedHeaders() ?: emptyList()
         ...
         */
        public fun includedHeaders(): List<String> =
            unwrap(this).getIncludedHeaders() ?: emptyList()
        ...
        public interface Builder {
            ...
            /**
             * @param excludedHeaders Inspect only the headers whose keys don't match any of the
             *   strings specified here.
             */
            ...
            /**
             * @param includedHeaders Inspect only the headers that have a key that matches one of
             *   the strings specified here.
             */
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-wafv2-rulegroup-headermatchpattern.html#cfn-wafv2-rulegroup-headermatchpattern-excludedheaders)
             */
            override fun excludedHeaders(): List<String> =
                unwrap(this).getExcludedHeaders() ?: emptyList()
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-wafv2-rulegroup-headermatchpattern.html#cfn-wafv2-rulegroup-headermatchpattern-includedheaders)
             */
            override fun includedHeaders(): List<String> =
                unwrap(this).getIncludedHeaders() ?: emptyList()
        }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: HeaderMatchPatternProperty
            ): software.amazon.awscdk.services.wafv2.CfnRuleGroup.HeaderMatchPatternProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface AndStatementProperty {
        ...
        public interface Builder {
            /**
             * @param statements The statements to combine with AND logic. You can use any
             *   statements that can be nested.
             */
            public fun statements(statements: IResolvable)
    ...
    public interface RateLimitQueryArgumentProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RateLimitQueryArgumentProperty
            ): software.amazon.awscdk.services.wafv2.CfnRuleGroup.RateLimitQueryArgumentProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface RateLimitQueryStringProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RateLimitQueryStringProperty
            ): software.amazon.awscdk.services.wafv2.CfnRuleGroup.RateLimitQueryStringProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SqliMatchStatementProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param sensitivityLevel The sensitivity that you want AWS WAF to use to inspect for
             *   SQL injection attacks. `HIGH` detects more attacks, but might generate more false
             *   positives, especially if your web requests frequently contain unusual strings. For
        ...
        internal constructor(
             ...
             * your web requests frequently contain unusual strings. For information about
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SqliMatchStatementProperty
            ): software.amazon.awscdk.services.wafv2.CfnRuleGroup.SqliMatchStatementProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
