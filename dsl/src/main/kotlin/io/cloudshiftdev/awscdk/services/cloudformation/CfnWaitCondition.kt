...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.cloudformation.CfnWaitCondition,
    ...
    public interface Builder {
        /**
         * The number of success signals that CloudFormation must receive before it continues the
         * stack creation process.
         *
         * When the wait condition receives the requisite number of success signals, CloudFormation
         * resumes the creation of the stack. If the wait condition doesn't receive the specified
         * number of success signals before the Timeout period expires, CloudFormation assumes that
         ...
         * resource.
         *
         * Anytime you add a `WaitCondition` resource during a stack update, you must associate the
         * wait condition with a new WaitConditionHandle resource. Don't reuse an old wait condition
         * handle that has already been defined in the template. If you reuse a wait condition
         * handle, the wait condition might evaluate old signals from a previous create or update
         * stack command.
         *
         * Updates aren't supported.
         *
         ...
         *
         * @param handle A reference to the wait condition handle used to signal this wait
         *   condition.
         */
         ...
         * property specifies.
         *
         * `Timeout` is a minimum-bound property, meaning the timeout occurs no sooner than the time
         * you specify, but can occur shortly thereafter. The maximum time that can be specified for
         * this property is 12 hours (43200 seconds).
         *
         * Updates aren't supported.
         *
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.cloudformation.CfnWaitCondition.Builder.create(
                scope,
                id
            )
