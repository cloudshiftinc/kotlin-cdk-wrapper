...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param certificate The AWS Certificate Manager (ACM) certificate that will be associated
         *   with the CloudFront distribution that will be created.
         */
         ...
         *
         * An alias record will be created that points to your CloudFront distribution. Root domain
        ...
        /**
         * Hosted zone of the domain which will be used to create alias record(s) from domain names
         * in the hosted zone to the target domain.
         *
         * The hosted zone must contain entries for the domain name(s) supplied through
         * `recordNames` that will redirect to the target domain.
         *
    ...
    private class BuilderImpl(
         ...
         * @param recordNames The domain names that will redirect to `targetDomain`.
         */
        override fun recordNames(vararg recordNames: String): Unit =
            recordNames(recordNames.toList())
