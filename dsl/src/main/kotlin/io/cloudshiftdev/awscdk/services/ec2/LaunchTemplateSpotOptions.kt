...
public interface LaunchTemplateSpotOptions {
     ...
     *
     * The value is given in dollars. ex: 0.01 for 1 cent per hour, or 0.001 for one-tenth of a cent
     * per hour.
     *
     ...
     * canceled, or this date is reached. If the request is persistent, it remains active until it
     * is canceled or this date and time is reached.
     *
    ...
    public interface Builder {
        /**
         * @param blockDuration Spot Instances with a defined duration (also known as Spot blocks)
         *   are designed not to be interrupted and will run continuously for the duration you
         *   select. You can use a duration of 1, 2, 3, 4, 5, or 6 hours.
         */
        ...
        /**
         * @param maxPrice Maximum hourly price you're willing to pay for each Spot instance. The
         *   value is given in dollars. ex: 0.01 for 1 cent per hour, or 0.001 for one-tenth of a
         *   cent per hour.
         */
        public fun maxPrice(maxPrice: Number)

        /**
         * @param requestType The Spot Instance request type. If you are using Spot Instances with
         *   an Auto Scaling group, use one-time requests, as the Amazon EC2 Auto Scaling service
         *   handles requesting new Spot Instances whenever the group is below its desired capacity.
         */
        public fun requestType(requestType: SpotRequestType)

        /**
         * @param validUntil The end date of the request. For a one-time request, the request
         *   remains active until all instances launch, the request is canceled, or this date is
         *   reached. If the request is persistent, it remains active until it is canceled or this
    ...
    private class BuilderImpl : Builder {
        ...
        override fun interruptionBehavior(interruptionBehavior: SpotInstanceInterruption) {
            cdkBuilder.interruptionBehavior(
                interruptionBehavior.let(SpotInstanceInterruption::unwrap)
            )
        }
    ...
    internal constructor(
         ...
         * [Documentation](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/spot-requests.html#fixed-duration-spot-instances)
         */
        override fun blockDuration(): Duration? =
         ...
         * Maximum hourly price you're willing to pay for each Spot instance.
         *
         * The value is given in dollars. ex: 0.01 for 1 cent per hour, or 0.001 for one-tenth of a
         * cent per hour.
         *
         * Default: Maximum hourly price will default to the on-demand price for the instance type.
         */
         ...
         *
         * If you are using Spot Instances with an Auto Scaling group, use one-time requests, as the
         * Amazon EC2 Auto Scaling service handles requesting new Spot Instances whenever the group
         * is below its desired capacity.
         *
         * Default: One-time spot request.
         */
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: LaunchTemplateSpotOptions
