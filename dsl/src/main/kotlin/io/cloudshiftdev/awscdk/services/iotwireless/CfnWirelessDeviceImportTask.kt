...
internal constructor(
    ...
    /**
     * The summary information of count of wireless devices that failed to onboard to the import
     * task.
     */
    ...
    /**
     * The summary information of count of wireless devices that are waiting for the control log to
     * be added to an import task.
     */
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.iotwireless.CfnWirelessDeviceImportTask.Builder.create(
                scope,
                id
            )
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnWirelessDeviceImportTask
        ): software.amazon.awscdk.services.iotwireless.CfnWirelessDeviceImportTask =
            wrapped.cdkObject
    }
    ...
    public interface SidewalkProperty {
         ...
         */
        public fun deviceCreationFileList(): List<String> =
        ...
        public interface Builder {
            /**
             * @param deviceCreationFile The CSV file contained in an S3 bucket that's used for
             *   adding devices to an import task.
             */
            public fun deviceCreationFile(deviceCreationFile: String)

            /**
             * @param deviceCreationFileList List of Sidewalk devices that are added to the import
             *   task.
             */
            ...
            /**
             * @param role The IAM role that allows AWS IoT Wireless to access the CSV file in the
             *   S3 bucket.
             */
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-iotwireless-wirelessdeviceimporttask-sidewalk.html#cfn-iotwireless-wirelessdeviceimporttask-sidewalk-devicecreationfilelist)
             */
            override fun deviceCreationFileList(): List<String> =
                unwrap(this).getDeviceCreationFileList() ?: emptyList()
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-iotwireless-wirelessdeviceimporttask-sidewalk.html#cfn-iotwireless-wirelessdeviceimporttask-sidewalk-sidewalkmanufacturingsn)
             */
            override fun sidewalkManufacturingSn(): String? =
