...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param domainIdentifier The identifier of the Amazon DataZone domain in which the
         ...
         *
         * @param environmentProfileIdentifier The identifier of the environment profile that is
         *   used to create this Amazon DataZone environment.
         */
         ...
         *
         * @param glossaryTerms The glossary terms that can be used in this Amazon DataZone
         *   environment.
         */
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.datazone.CfnEnvironment =
            cdkBuilder.build()
    }
    ...
    public interface EnvironmentParameterProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: EnvironmentParameterProperty
            ): software.amazon.awscdk.services.datazone.CfnEnvironment.EnvironmentParameterProperty =
