...
internal constructor(
    ...
    public companion object {
        ...
        ): CfnTopic = CfnTopic(cdkObject)

        internal fun unwrap(
            wrapped: CfnTopic
        ): software.amazon.awscdk.services.quicksight.CfnTopic = wrapped.cdkObject
    }
    ...
    public interface SemanticTypeProperty {
         ...
         */
        public fun falseyCellValueSynonyms(): List<String> =
         ...
         */
        public fun truthyCellValueSynonyms(): List<String> =
    ...
    public interface TopicRelativeDateFilterProperty {
         ...
         */
        public fun relativeDateFilterFunction(): String? =
        ...
        public interface Builder {
            ...
            /**
             * @param relativeDateFilterFunction The function to be used in a relative date filter
             *   to determine the range of dates to include in the results. Valid values for this
             *   structure are `BEFORE` , `AFTER` , and `BETWEEN` .
             */
            public fun relativeDateFilterFunction(relativeDateFilterFunction: String)

            /**
             * @param timeGranularity The level of time precision that is used to aggregate
             *   `DateTime` values.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            override fun constant(
                constant: TopicSingularFilterConstantProperty.Builder.() -> Unit
            ): Unit = constant(TopicSingularFilterConstantProperty(constant))
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TopicRelativeDateFilterProperty
            ): software.amazon.awscdk.services.quicksight.CfnTopic.TopicRelativeDateFilterProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CellValueSynonymProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CellValueSynonymProperty
            ): software.amazon.awscdk.services.quicksight.CfnTopic.CellValueSynonymProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface NamedEntityDefinitionMetricProperty {
        ...
        public interface Builder {
            /**
             * @param aggregation The aggregation of a named entity. Valid values for this structure
             *   are `SUM` , `MIN` , `MAX` , `COUNT` , `AVERAGE` , `DISTINCT_COUNT` , `STDEV` ,
             *   `STDEVP` , `VAR` , `VARP` , `PERCENTILE` , `MEDIAN` , and `CUSTOM` .
             */
            public fun aggregation(aggregation: String)

            /**
             * @param aggregationFunctionParameters The additional parameters for an aggregation
             *   function.
             */
             ...
             *   function.
             */
            public fun aggregationFunctionParameters(
        ...
        private class BuilderImpl : Builder {
            ...
            override fun aggregationFunctionParameters(aggregationFunctionParameters: IResolvable) {
                cdkBuilder.aggregationFunctionParameters(
                    aggregationFunctionParameters.let(IResolvable::unwrap)
                )
            }
             ...
             *   function.
             */
            override fun aggregationFunctionParameters(
                aggregationFunctionParameters: Map<String, String>
            ) {
        ...
        internal constructor(
             ...
             *
             * Valid values for this structure are `SUM` , `MIN` , `MAX` , `COUNT` , `AVERAGE` ,
             * `DISTINCT_COUNT` , `STDEV` , `STDEVP` , `VAR` , `VARP` , `PERCENTILE` , `MEDIAN` ,
             * and `CUSTOM` .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-quicksight-topic-namedentitydefinitionmetric.html#cfn-quicksight-topic-namedentitydefinitionmetric-aggregation)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: NamedEntityDefinitionMetricProperty
            ): software.amazon.awscdk.services.quicksight.CfnTopic.NamedEntityDefinitionMetricProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface TopicFilterProperty {
        ...
        public interface Builder {
            ...
            public fun categoryFilter(
                categoryFilter: TopicCategoryFilterProperty.Builder.() -> Unit
            )
            ...
            public fun dateRangeFilter(
                dateRangeFilter: TopicDateRangeFilterProperty.Builder.() -> Unit
            )
            ...
            /**
             * @param filterDescription A description of the filter used to select items for a
             *   topic.
             */
            ...
            public fun numericEqualityFilter(
                numericEqualityFilter: TopicNumericEqualityFilterProperty.Builder.() -> Unit
            )
            ...
            public fun numericRangeFilter(
                numericRangeFilter: TopicNumericRangeFilterProperty.Builder.() -> Unit
            )
            ...
            public fun relativeDateFilter(
                relativeDateFilter: TopicRelativeDateFilterProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun dateRangeFilter(dateRangeFilter: TopicDateRangeFilterProperty) {
                cdkBuilder.dateRangeFilter(
                    dateRangeFilter.let(TopicDateRangeFilterProperty::unwrap)
                )
            }
            ...
            /** @param numericEqualityFilter The numeric equality filter. */
            override fun numericEqualityFilter(
                numericEqualityFilter: TopicNumericEqualityFilterProperty
            ) {
                cdkBuilder.numericEqualityFilter(
                    numericEqualityFilter.let(TopicNumericEqualityFilterProperty::unwrap)
                )
            }
            ...
            override fun numericEqualityFilter(
                ...
                numericEqualityFilter(TopicNumericEqualityFilterProperty(numericEqualityFilter))
            ...
            override fun numericRangeFilter(numericRangeFilter: TopicNumericRangeFilterProperty) {
                cdkBuilder.numericRangeFilter(
                    numericRangeFilter.let(TopicNumericRangeFilterProperty::unwrap)
                )
            }
            ...
            override fun relativeDateFilter(relativeDateFilter: TopicRelativeDateFilterProperty) {
                cdkBuilder.relativeDateFilter(
                    relativeDateFilter.let(TopicRelativeDateFilterProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("bbac18e6d3083682cef12a6f06fd86288e22ba3c865ed39b20a802aa9cd61764")
            override fun relativeDateFilter(
                relativeDateFilter: TopicRelativeDateFilterProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-quicksight-topic-topicfilter.html#cfn-quicksight-topic-topicfilter-filtersynonyms)
             */
            override fun filterSynonyms(): List<String> =
                unwrap(this).getFilterSynonyms() ?: emptyList()
    ...
    public interface TopicSingularFilterConstantProperty {
        ...
        public interface Builder {
            /**
             * @param constantType The type of the singular filter constant. Valid values for this
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TopicSingularFilterConstantProperty
            ): software.amazon.awscdk.services.quicksight.CfnTopic.TopicSingularFilterConstantProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DataAggregationProperty {
         ...
         */
        public fun datasetRowDateGranularity(): String? =
        ...
        public interface Builder {
            /**
             * @param datasetRowDateGranularity The level of time precision that is used to
             *   aggregate `DateTime` values.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DataAggregationProperty
            ): software.amazon.awscdk.services.quicksight.CfnTopic.DataAggregationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ComparativeOrderProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param treatUndefinedSpecifiedValues The treat of undefined specified values. Valid
             ...
             *   are `GREATER_IS_BETTER` , `LESSER_IS_BETTER` and `SPECIFIED` .
             */
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-quicksight-topic-comparativeorder.html#cfn-quicksight-topic-comparativeorder-specifedorder)
             */
            override fun specifedOrder(): List<String> =
                unwrap(this).getSpecifedOrder() ?: emptyList()
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ComparativeOrderProperty
            ): software.amazon.awscdk.services.quicksight.CfnTopic.ComparativeOrderProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface TopicColumnProperty {
         ...
         */
        public fun allowedAggregations(): List<String> =
         ...
         */
        public fun notAllowedAggregations(): List<String> =
        ...
        public interface Builder {
            /**
             * @param aggregation The type of aggregation that is performed on the column data when
             *   it's queried.
             */
            public fun aggregation(aggregation: String)
             ...
             *   column. Valid values for this structure are `COUNT` , `DISTINCT_COUNT` , `MIN` ,
            ...
            /**
             * @param columnDataRole The role of the column in the data. Valid values are
            ...
            /**
             * @param comparativeOrder The order in which data is displayed for the column when it's
            ...
            public fun comparativeOrder(
                comparativeOrder: ComparativeOrderProperty.Builder.() -> Unit
            )
            ...
            public fun defaultFormatting(
                defaultFormatting: DefaultFormattingProperty.Builder.() -> Unit
            )

            /**
             * @param isIncludedInTopic A Boolean value that indicates whether the column is
            ...
            /**
             * @param notAllowedAggregations The list of aggregation types that are not allowed for
             *   the column. Valid values for this structure are `COUNT` , `DISTINCT_COUNT` , `MIN`
             *   , `MAX` , `MEDIAN` , `SUM` , `AVERAGE` , `STDEV` , `STDEVP` , `VAR` , `VARP` , and
             *   `PERCENTILE` .
             */
        ...
        private class BuilderImpl : Builder {
            ...
            override fun defaultFormatting(defaultFormatting: DefaultFormattingProperty) {
                cdkBuilder.defaultFormatting(
                    defaultFormatting.let(DefaultFormattingProperty::unwrap)
                )
            }
        ...
        internal constructor(
             ...
             * The list of aggregation types that are allowed for the column.
             *
             * Valid values for this structure are `COUNT` , `DISTINCT_COUNT` , `MIN` , `MAX` ,
             * `MEDIAN` , `SUM` , `AVERAGE` , `STDEV` , `STDEVP` , `VAR` , `VARP` , and `PERCENTILE`
             * .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-quicksight-topic-topiccolumn.html#cfn-quicksight-topic-topiccolumn-allowedaggregations)
             */
            override fun allowedAggregations(): List<String> =
                unwrap(this).getAllowedAggregations() ?: emptyList()
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-quicksight-topic-topiccolumn.html#cfn-quicksight-topic-topiccolumn-columnsynonyms)
             */
            override fun columnSynonyms(): List<String> =
                unwrap(this).getColumnSynonyms() ?: emptyList()
            ...
            /**
             * A Boolean value that indicates whether to aggregate the column data when it's used in
             * a filter context.
             *
             * Default: - false
             *
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-quicksight-topic-topiccolumn.html#cfn-quicksight-topic-topiccolumn-notallowedaggregations)
             */
            override fun notAllowedAggregations(): List<String> =
                unwrap(this).getNotAllowedAggregations() ?: emptyList()
    ...
    public interface NegativeFormatProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: NegativeFormatProperty
            ): software.amazon.awscdk.services.quicksight.CfnTopic.NegativeFormatProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface TopicCategoryFilterConstantProperty {
        ...
        public interface Builder {
            /**
             * @param collectiveConstant A collective constant used in a category filter. This
             *   element is used to specify a list of values for the constant.
             */
            ...
            public fun collectiveConstant(
                collectiveConstant: CollectiveConstantProperty.Builder.() -> Unit
            )

            /**
             * @param constantType The type of category filter constant. This element is used to
             *   specify whether a constant is a singular or collective. Valid values are `SINGULAR`
             *   and `COLLECTIVE` .
             */
            public fun constantType(constantType: String)

            /**
             * @param singularConstant A singular constant used in a category filter. This element
             *   is used to specify a single value for the constant.
             */
            public fun singularConstant(singularConstant: String)
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun collectiveConstant(collectiveConstant: CollectiveConstantProperty) {
                cdkBuilder.collectiveConstant(
                    collectiveConstant.let(CollectiveConstantProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("8f35ebbc647c37c743bf329340e1847a28b170a9519ef88c42ece316db9e896b")
            override fun collectiveConstant(
                collectiveConstant: CollectiveConstantProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TopicCategoryFilterConstantProperty
            ): software.amazon.awscdk.services.quicksight.CfnTopic.TopicCategoryFilterConstantProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DisplayFormatOptionsProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param unitScaler The unit scaler. Valid values for this structure are: `NONE` ,
             *   `AUTO` , `THOUSANDS` , `MILLIONS` , `BILLIONS` , and `TRILLIONS` .
             */
            public fun unitScaler(unitScaler: String)

            /**
             * @param useBlankCellFormat A Boolean value that indicates whether to use blank cell
             *   format.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("00292db3df80c8de047fc466856a329c98a053e86ede160f3b9863d06eb8e7b5")
            override fun negativeFormat(
                negativeFormat: NegativeFormatProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DisplayFormatOptionsProperty
            ): software.amazon.awscdk.services.quicksight.CfnTopic.DisplayFormatOptionsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface TopicDateRangeFilterProperty {
        ...
        public interface Builder {
             ...
             *   include the boundary values. If set to true, the filter includes the start and end
        ...
        private class BuilderImpl : Builder {
            ...
            @JvmName("51e78d041a922a4b2c0cb82de073d73468de33269f877f54f0610549dd6da02f")
            override fun constant(
                constant: TopicRangeFilterConstantProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * boundary values.
             *
             * If set to true, the filter includes the start and end dates. If set to false, the
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TopicDateRangeFilterProperty
            ): software.amazon.awscdk.services.quicksight.CfnTopic.TopicDateRangeFilterProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface TopicRangeFilterConstantProperty {
        ...
        public interface Builder {
            /**
             * @param constantType The data type of the constant value that is used in a range
             *   filter. Valid values for this structure are `RANGE` .
             */
            public fun constantType(constantType: String)

            /**
             * @param rangeConstant The value of the constant that is used to specify the endpoints
             *   of a range filter.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("97cf8ccdda65102ae5018ee30183a928aba864c43c8f9919394add036487c283")
            override fun rangeConstant(
                rangeConstant: RangeConstantProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TopicRangeFilterConstantProperty
            ): software.amazon.awscdk.services.quicksight.CfnTopic.TopicRangeFilterConstantProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DatasetMetadataProperty {
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("9fa0a109bb35bb7e5676eca3ee8be52e6363c0cf17be69739e46bb0edf598f47")
            override fun dataAggregation(
                dataAggregation: DataAggregationProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DatasetMetadataProperty
            ): software.amazon.awscdk.services.quicksight.CfnTopic.DatasetMetadataProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface TopicNumericEqualityFilterProperty {
        ...
        public interface Builder {
            /**
             * @param aggregation An aggregation function that specifies how to calculate the value
             *   of a numeric field for a topic. Valid values for this structure are
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TopicNumericEqualityFilterProperty
            ): software.amazon.awscdk.services.quicksight.CfnTopic.TopicNumericEqualityFilterProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface TopicCategoryFilterProperty {
         ...
         *
         * This element is used to specify whether a filter is a simple category filter or an
        ...
        public interface Builder {
            /**
             * @param categoryFilterFunction The category filter function. Valid values for this
             *   structure are `EXACT` and `CONTAINS` .
             */
            public fun categoryFilterFunction(categoryFilterFunction: String)

            /**
             * @param categoryFilterType The category filter type. This element is used to specify
             *   whether a filter is a simple category filter or an inverse category filter.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            @JvmName("e6b8f62d6a6372d6957e55640376ef1f0459f2ef8e1a31870e4c69591dea6fe8")
            override fun constant(
                constant: TopicCategoryFilterConstantProperty.Builder.() -> Unit
            ): Unit = constant(TopicCategoryFilterConstantProperty(constant))
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-quicksight-topic-topiccategoryfilter.html#cfn-quicksight-topic-topiccategoryfilter-categoryfilterfunction)
             */
            override fun categoryFilterFunction(): String? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TopicCategoryFilterProperty
            ): software.amazon.awscdk.services.quicksight.CfnTopic.TopicCategoryFilterProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface TopicCalculatedFieldProperty {
         ...
         */
        public fun calculatedFieldDescription(): String? =
         ...
         */
        public fun calculatedFieldSynonyms(): List<String> =
        ...
        public interface Builder {
            /**
             * @param aggregation The default aggregation. Valid values for this structure are `SUM`
            ...
            /**
             * @param allowedAggregations The list of aggregation types that are allowed for the
             *   calculated field. Valid values for this structure are `COUNT` , `DISTINCT_COUNT` ,
             *   `MIN` , `MAX` , `MEDIAN` , `SUM` , `AVERAGE` , `STDEV` , `STDEVP` , `VAR` , `VARP`
             *   , and `PERCENTILE` .
             */
            public fun allowedAggregations(allowedAggregations: List<String>)
            ...
            /**
             * @param cellValueSynonyms The other names or aliases for the calculated field cell
             *   value.
             */
            public fun cellValueSynonyms(cellValueSynonyms: IResolvable)
            ...
            /**
             * @param columnDataRole The column data role for a calculated field. Valid values for
             *   this structure are `DIMENSION` and `MEASURE` .
             */
            public fun columnDataRole(columnDataRole: String)

            /**
             * @param comparativeOrder The order in which data is displayed for the calculated field
            ...
            /**
             * @param isIncludedInTopic A boolean value that indicates if a calculated field is
            ...
            /**
             * @param neverAggregateInFilter A Boolean value that indicates whether to never
            ...
            /**
             * @param notAllowedAggregations The list of aggregation types that are not allowed for
             *   the calculated field. Valid values for this structure are `COUNT` ,
        ...
        internal constructor(
             ...
             * The default aggregation.
             *
             * Valid values for this structure are `SUM` , `MAX` , `MIN` , `COUNT` ,
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TopicCalculatedFieldProperty
            ): software.amazon.awscdk.services.quicksight.CfnTopic.TopicCalculatedFieldProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface NamedEntityDefinitionProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param propertyRole The property role. Valid values for this structure are `PRIMARY`
             *   and `ID` .
             */
            public fun propertyRole(propertyRole: String)

            /**
             * @param propertyUsage The property usage. Valid values for this structure are
             *   `INHERIT` , `DIMENSION` , and `MEASURE` .
             */
        ...
        private class BuilderImpl : Builder {
            ...
            @JvmName("d6e41b38c93693347a3564c25a7db1caafa2331db88848136186b58a6501d6e8")
            override fun metric(
                metric: NamedEntityDefinitionMetricProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: NamedEntityDefinitionProperty
            ): software.amazon.awscdk.services.quicksight.CfnTopic.NamedEntityDefinitionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface TopicNamedEntityProperty {
        ...
        public interface Builder {
            ...
            public fun semanticEntityType(
                semanticEntityType: SemanticEntityTypeProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun semanticEntityType(semanticEntityType: SemanticEntityTypeProperty) {
                cdkBuilder.semanticEntityType(
                    semanticEntityType.let(SemanticEntityTypeProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("237f7fc40c441778ee40745b5608f4130d7bd7bd0f0c343c89657f8020cffee7")
            override fun semanticEntityType(
                semanticEntityType: SemanticEntityTypeProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-quicksight-topic-topicnamedentity.html#cfn-quicksight-topic-topicnamedentity-entitysynonyms)
             */
            override fun entitySynonyms(): List<String> =
                unwrap(this).getEntitySynonyms() ?: emptyList()
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TopicNamedEntityProperty
            ): software.amazon.awscdk.services.quicksight.CfnTopic.TopicNamedEntityProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DefaultFormattingProperty {
        ...
        public interface Builder {
            ...
            public fun displayFormatOptions(
                displayFormatOptions: DisplayFormatOptionsProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun displayFormatOptions(displayFormatOptions: DisplayFormatOptionsProperty) {
                cdkBuilder.displayFormatOptions(
                    displayFormatOptions.let(DisplayFormatOptionsProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("c8b52fc3d054d547b5d44c1c4b356f7a3a8129363d5996867fa4f22ba6626135")
            override fun displayFormatOptions(
                displayFormatOptions: DisplayFormatOptionsProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * The display format.
             *
             * Valid values for this structure are `AUTO` , `PERCENT` , `CURRENCY` , `NUMBER` ,
             * `DATE` , and `STRING` .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-quicksight-topic-defaultformatting.html#cfn-quicksight-topic-defaultformatting-displayformat)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DefaultFormattingProperty
            ): software.amazon.awscdk.services.quicksight.CfnTopic.DefaultFormattingProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface TopicNumericRangeFilterProperty {
        /**
         * An aggregation function that specifies how to calculate the value of a numeric field for
         * a topic, Valid values for this structure are `NO_AGGREGATION` , `SUM` , `AVERAGE` ,
         * `COUNT` , `DISTINCT_COUNT` , `MAX` , `MEDIAN` , `MIN` , `STDEV` , `STDEVP` , `VAR` , and
         * `VARP` .
         *
        ...
        public interface Builder {
            ...
            /**
             * @param inclusive A Boolean value that indicates whether the endpoints of the numeric
             *   range are included in the filter. If set to true, topics whose numeric field value
             *   is equal to the endpoint values will be included in the filter. If set to false,
             *   topics whose numeric field value is equal to the endpoint values will be excluded
             *   from the filter.
             */
            public fun inclusive(inclusive: Boolean)
        ...
        internal constructor(
            ...
            /**
             * An aggregation function that specifies how to calculate the value of a numeric field
             * for a topic, Valid values for this structure are `NO_AGGREGATION` , `SUM` , `AVERAGE`
             * , `COUNT` , `DISTINCT_COUNT` , `MAX` , `MEDIAN` , `MIN` , `STDEV` , `STDEVP` , `VAR`
             * , and `VARP` .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-quicksight-topic-topicnumericrangefilter.html#cfn-quicksight-topic-topicnumericrangefilter-aggregation)
             */
             ...
             *
             * If set to true, topics whose numeric field value is equal to the endpoint values will
             * be included in the filter. If set to false, topics whose numeric field value is equal
             * to the endpoint values will be excluded from the filter.
             *
             * Default: - false
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-quicksight-topic-topicnumericrangefilter.html#cfn-quicksight-topic-topicnumericrangefilter-inclusive)
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TopicNumericRangeFilterProperty
            ): software.amazon.awscdk.services.quicksight.CfnTopic.TopicNumericRangeFilterProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SemanticEntityTypeProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SemanticEntityTypeProperty
            ): software.amazon.awscdk.services.quicksight.CfnTopic.SemanticEntityTypeProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CollectiveConstantProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CollectiveConstantProperty
            ): software.amazon.awscdk.services.quicksight.CfnTopic.CollectiveConstantProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
