...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.cloudfront.CfnMonitoringSubscription,
    ...
    public open fun monitoringSubscription(
        `value`: MonitoringSubscriptionProperty.Builder.() -> Unit
    ): Unit = monitoringSubscription(MonitoringSubscriptionProperty(`value`))
    ...
    public interface Builder {
         ...
         *
         * @param monitoringSubscription A subscription configuration for additional CloudWatch
         *   metrics.
         */
        ...
        public fun monitoringSubscription(
            monitoringSubscription: MonitoringSubscriptionProperty.Builder.() -> Unit
        )
    }
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.cloudfront.CfnMonitoringSubscription.Builder.create(
                scope,
                id
            )
         ...
         *   metrics.
         */
        override fun monitoringSubscription(
            monitoringSubscription: MonitoringSubscriptionProperty
        ) {
            cdkBuilder.monitoringSubscription(
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnMonitoringSubscription
    ...
    public interface RealtimeMetricsSubscriptionConfigProperty {
        ...
        private class BuilderImpl : Builder {
             ...
             *   CloudWatch metrics are enabled for a given CloudFront distribution.
             */
            override fun realtimeMetricsSubscriptionStatus(
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RealtimeMetricsSubscriptionConfigProperty
            ): software.amazon.awscdk.services.cloudfront.CfnMonitoringSubscription.RealtimeMetricsSubscriptionConfigProperty =
    ...
    public interface MonitoringSubscriptionProperty {
        ...
        public interface Builder {
            ...
            public fun realtimeMetricsSubscriptionConfig(
                realtimeMetricsSubscriptionConfig: IResolvable
            )
            ...
            public fun realtimeMetricsSubscriptionConfig(
                realtimeMetricsSubscriptionConfig:
                    RealtimeMetricsSubscriptionConfigProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
             ...
             *   CloudWatch metrics.
             */
            override fun realtimeMetricsSubscriptionConfig(
                realtimeMetricsSubscriptionConfig: IResolvable
            ) {
                cdkBuilder.realtimeMetricsSubscriptionConfig(
                    realtimeMetricsSubscriptionConfig.let(IResolvable::unwrap)
                )
            }
            ...
            override fun realtimeMetricsSubscriptionConfig(
                ...
                cdkBuilder.realtimeMetricsSubscriptionConfig(
                    realtimeMetricsSubscriptionConfig.let(
                        RealtimeMetricsSubscriptionConfigProperty::unwrap
                    )
                )
            }
            ...
            override fun realtimeMetricsSubscriptionConfig(
                ...
                realtimeMetricsSubscriptionConfig(
                    RealtimeMetricsSubscriptionConfigProperty(realtimeMetricsSubscriptionConfig)
                )
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: MonitoringSubscriptionProperty
            ): software.amazon.awscdk.services.cloudfront.CfnMonitoringSubscription.MonitoringSubscriptionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
