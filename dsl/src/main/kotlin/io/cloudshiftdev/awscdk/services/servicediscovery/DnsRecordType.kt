...
public enum class DnsRecordType(
  ...
  public companion object {
    internal fun wrap(cdkObject: software.amazon.awscdk.services.servicediscovery.DnsRecordType):
        DnsRecordType = when (cdkObject) {
      software.amazon.awscdk.services.servicediscovery.DnsRecordType.A -> DnsRecordType.A
      software.amazon.awscdk.services.servicediscovery.DnsRecordType.AAAA -> DnsRecordType.AAAA
      software.amazon.awscdk.services.servicediscovery.DnsRecordType.A_AAAA -> DnsRecordType.A_AAAA
      software.amazon.awscdk.services.servicediscovery.DnsRecordType.SRV -> DnsRecordType.SRV
      software.amazon.awscdk.services.servicediscovery.DnsRecordType.CNAME -> DnsRecordType.CNAME
    }

    internal fun unwrap(wrapped: DnsRecordType):
