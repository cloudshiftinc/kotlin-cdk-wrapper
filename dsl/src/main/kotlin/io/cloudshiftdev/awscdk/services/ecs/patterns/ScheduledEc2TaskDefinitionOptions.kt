...
public interface ScheduledEc2TaskDefinitionOptions {
    ...
    public interface Builder {
        /**
         * @param taskDefinition The task definition to use for tasks in the service. One of image
         *   or taskDefinition must be specified. [disable-awslint:ref-via-interface]
         */
    ...
    internal constructor(
        ...
        /**
         * The task definition to use for tasks in the service. One of image or taskDefinition must
         * be specified.
         *
         * [disable-awslint:ref-via-interface]
         *
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: ScheduledEc2TaskDefinitionOptions
        ): software.amazon.awscdk.services.ecs.patterns.ScheduledEc2TaskDefinitionOptions =
