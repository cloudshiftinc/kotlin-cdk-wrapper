...
internal constructor(
     ...
     * [io.cloudshiftdev.awscdk.services.cognito.CfnIdentityPoolRoleAttachment].
     */
    @CdkDslMarker
    public interface Builder {
         ...
         * The map of the roles associated with this pool.
         *
         * For a given role, the key is either "authenticated" or "unauthenticated". The value is
         * the role ARN.
         *
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.cognito.CfnIdentityPoolRoleAttachment.Builder.create(
                scope,
                id
            )
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnIdentityPoolRoleAttachment
    ...
    public interface RulesConfigurationTypeProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RulesConfigurationTypeProperty
            ): software.amazon.awscdk.services.cognito.CfnIdentityPoolRoleAttachment.RulesConfigurationTypeProperty =
    ...
    public interface MappingRuleProperty {
        ...
        public interface Builder {
            /**
             * @param claim The claim name that must be present in the token. For example: "isAdmin"
             *   or "paid".
             */
            public fun claim(claim: String)

            /**
             * @param matchType The match condition that specifies how closely the claim value in
             *   the IdP token must match `Value` . Valid values are: `Equals` , `Contains` ,
             *   `StartsWith` , and `NotEqual` .
             */
    ...
    public interface RoleMappingProperty {
         ...
         * identity provider token to map groups to roles. Rules will attempt to match claims from
        ...
        public interface Builder {
             ...
             *   `AmbiguousRoleResolution` is required. Specifies the action to be taken if either
             *   no rules match the claim value for the `Rules` type, or there is no
             *   `cognito:preferred_role` claim and there are multiple `cognito:roles` matches for
             *   the `Token` type.
             */
            public fun ambiguousRoleResolution(ambiguousRoleResolution: String)

            /**
             * @param identityProvider Identifier for the identity provider for which the role is
             *   mapped. For example: `graph.facebook.com` or
             *   `cognito-idp.us-east-1.amazonaws.com/us-east-1_abcdefghi:app_client_id
            ...
            /**
             * @param rulesConfiguration The rules to be used for mapping users to roles. If you
             *   specify "Rules" as the role-mapping type, RulesConfiguration is required.
             */
            ...
            public fun rulesConfiguration(
                rulesConfiguration: RulesConfigurationTypeProperty.Builder.() -> Unit
            )
             ...
             *   groups to roles. Rules will attempt to match claims from the token to map to a
             *   role.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            override fun rulesConfiguration(rulesConfiguration: RulesConfigurationTypeProperty) {
                cdkBuilder.rulesConfiguration(
                    rulesConfiguration.let(RulesConfigurationTypeProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("34b2423d58ded2152c85df2c07e9e7361b18364114635054c986d2e0974afe0a")
            override fun rulesConfiguration(
                rulesConfiguration: RulesConfigurationTypeProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-cognito-identitypoolroleattachment-rolemapping.html#cfn-cognito-identitypoolroleattachment-rolemapping-ambiguousroleresolution)
             */
            override fun ambiguousRoleResolution(): String? =
             ...
             *
             * Token will use `cognito:roles` and `cognito:preferred_role` claims from the Cognito
             * identity provider token to map groups to roles. Rules will attempt to match claims
