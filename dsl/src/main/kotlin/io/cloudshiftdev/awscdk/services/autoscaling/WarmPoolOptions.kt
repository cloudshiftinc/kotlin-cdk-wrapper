...
public interface WarmPoolOptions {
    ...
    public interface Builder {
        /**
         * @param maxGroupPreparedCapacity The maximum number of instances that are allowed to be in
         *   the warm pool or in any state except Terminated for the Auto Scaling group. If the
         *   value is not specified, Amazon EC2 Auto Scaling launches and maintains the difference
         *   between the group's maximum capacity and its desired capacity.
         */
        ...
        /**
         * @param reuseOnScaleIn Indicates whether instances in the Auto Scaling group can be
         *   returned to the warm pool on scale in. If the value is not specified, instances in the
         *   Auto Scaling group will be terminated when the group scales in.
         */
    ...
    internal constructor(
         ...
         * except Terminated for the Auto Scaling group.
         *
         * If the value is not specified, Amazon EC2 Auto Scaling launches and maintains the
         * difference between the group's maximum capacity and its desired capacity.
         *
         * Default: - max size of the Auto Scaling group
         */
        override fun maxGroupPreparedCapacity(): Number? =
