...
internal constructor(
    ...
    public open fun addSelection(id: String, options: BackupSelectionOptions): BackupSelection =
        unwrap(this)
            .addSelection(id, options.let(BackupSelectionOptions::unwrap))
            .let(BackupSelection::wrap)
    ...
    public open fun addSelection(
        id: String,
        options: BackupSelectionOptions.Builder.() -> Unit
    ...
    public interface Builder {
         ...
         *
         * Default: - use the vault defined at the rule level. If not defined a new common vault for
    ...
    public companion object {
        public fun daily35DayRetention(
            ...
            software.amazon.awscdk.services.backup.BackupPlan.daily35DayRetention(
        ...
        public fun dailyMonthly1YearRetention(
            ...
            software.amazon.awscdk.services.backup.BackupPlan.dailyMonthly1YearRetention(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id
                )
                .let(BackupPlan::wrap)
        ...
        public fun dailyWeeklyMonthly5YearRetention(
            ...
            software.amazon.awscdk.services.backup.BackupPlan.dailyWeeklyMonthly5YearRetention(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id
                )
                .let(BackupPlan::wrap)
        ...
        public fun dailyWeeklyMonthly7YearRetention(
            ...
            software.amazon.awscdk.services.backup.BackupPlan.dailyWeeklyMonthly7YearRetention(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id
                )
                .let(BackupPlan::wrap)
        ...
        public fun fromBackupPlanId(
            ...
            software.amazon.awscdk.services.backup.BackupPlan.fromBackupPlanId(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    backupPlanId
                )
                .let(IBackupPlan::wrap)
        ...
        ): BackupPlan = BackupPlan(cdkObject)

        internal fun unwrap(
            wrapped: BackupPlan
        ): software.amazon.awscdk.services.backup.BackupPlan = wrapped.cdkObject
    }
}
