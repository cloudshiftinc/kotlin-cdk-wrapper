...
internal constructor(
    ...
    public open fun containerServiceDeployment(): Any? =
        unwrap(this).getContainerServiceDeployment()
    ...
    public open fun containerServiceDeployment(`value`: ContainerServiceDeploymentProperty) {
        unwrap(this)
            .setContainerServiceDeployment(`value`.let(ContainerServiceDeploymentProperty::unwrap))
    }

    /** An object that describes the current container deployment of the container service. */
    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("f054c56b7195a01dbd63be82d391c716c6500d8a63ffcbd1007cec40f6745569")
    public open fun containerServiceDeployment(
        `value`: ContainerServiceDeploymentProperty.Builder.() -> Unit
    ...
    public open fun privateRegistryAccess(
        `value`: PrivateRegistryAccessProperty.Builder.() -> Unit
    ...
    public interface Builder {
         ...
         *
         * @param containerServiceDeployment An object that describes the current container
         *   deployment of the container service.
         */
        ...
        public fun containerServiceDeployment(
            containerServiceDeployment: ContainerServiceDeploymentProperty.Builder.() -> Unit
        )
        ...
        public fun privateRegistryAccess(
            privateRegistryAccess: PrivateRegistryAccessProperty.Builder.() -> Unit
        )
         ...
         * that you specify are used when you create a deployment with a container that is
         ...
         * resource to create a certificate for the public domain names that you want to use with
    ...
    private class BuilderImpl(
        ...
        override fun containerServiceDeployment(containerServiceDeployment: IResolvable) {
            cdkBuilder.containerServiceDeployment(
                containerServiceDeployment.let(IResolvable::unwrap)
            )
        }
         ...
         *   deployment of the container service.
         */
        override fun containerServiceDeployment(
            containerServiceDeployment: ContainerServiceDeploymentProperty
        ) {
            cdkBuilder.containerServiceDeployment(
                containerServiceDeployment.let(ContainerServiceDeploymentProperty::unwrap)
            )
        }
        ...
        override fun containerServiceDeployment(
            ...
            containerServiceDeployment(
                ContainerServiceDeploymentProperty(containerServiceDeployment)
            )
        ...
        override fun privateRegistryAccess(privateRegistryAccess: PrivateRegistryAccessProperty) {
            cdkBuilder.privateRegistryAccess(
                privateRegistryAccess.let(PrivateRegistryAccessProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("51d988934b3c0025c7ccb6fe2246ff1029e269c5028299f7e8ee97c8f8ce44eb")
        override fun privateRegistryAccess(
            privateRegistryAccess: PrivateRegistryAccessProperty.Builder.() -> Unit
        ...
        public fun build(): software.amazon.awscdk.services.lightsail.CfnContainer =
            cdkBuilder.build()
    }
    ...
    public interface PrivateRegistryAccessProperty {
        ...
        public interface Builder {
            /**
             * @param ecrImagePullerRole An object that describes the activation status of the role
             *   that you can use to grant a Lightsail container service access to Amazon ECR
             *   private repositories. If the role is activated, the Amazon Resource Name (ARN) of
            ...
            public fun ecrImagePullerRole(
                ecrImagePullerRole: EcrImagePullerRoleProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun ecrImagePullerRole(ecrImagePullerRole: EcrImagePullerRoleProperty) {
                cdkBuilder.ecrImagePullerRole(
                    ecrImagePullerRole.let(EcrImagePullerRoleProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("fa629e212b634adb107bf727e15842e667ed1f17f336bacee57bd0201774c2b2")
            override fun ecrImagePullerRole(
                ecrImagePullerRole: EcrImagePullerRoleProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * a Lightsail container service access to Amazon ECR private repositories.
             *
             * If the role is activated, the Amazon Resource Name (ARN) of the role is also listed.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-lightsail-container-privateregistryaccess.html#cfn-lightsail-container-privateregistryaccess-ecrimagepullerrole)
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: PrivateRegistryAccessProperty
            ): software.amazon.awscdk.services.lightsail.CfnContainer.PrivateRegistryAccessProperty =
    ...
    public interface EnvironmentVariableProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: EnvironmentVariableProperty
            ): software.amazon.awscdk.services.lightsail.CfnContainer.EnvironmentVariableProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface PublicDomainNameProperty {
        ...
        private class BuilderImpl : Builder {
            ...
            /** @param domainNames The public domain names to use with the container service. */
            override fun domainNames(vararg domainNames: String): Unit =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: PublicDomainNameProperty
            ): software.amazon.awscdk.services.lightsail.CfnContainer.PublicDomainNameProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface EcrImagePullerRoleProperty {
        ...
        public interface Builder {
            /**
             * @param isActive A boolean value that indicates whether the `ECRImagePullerRole` is
             *   active.
             */
            ...
            /**
             * @param principalArn The principle Amazon Resource Name (ARN) of the role. This
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: EcrImagePullerRoleProperty
            ): software.amazon.awscdk.services.lightsail.CfnContainer.EcrImagePullerRoleProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface PortInfoProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param protocol The protocol name for the open ports. *Allowed values* : `HTTP` |
             *   `HTTPS` | `TCP` | `UDP`
             */
    ...
    public interface ContainerProperty {
         ...
         * `container-service-1` , the container image label is `mystaticsite` , and you want to use
         * the third version ( `3` ) of the registered container image, then you should specify
         ...
         * `:container-service-1.mystaticsite.latest` ). Your container service will automatically
         * use the highest numbered version of the registered container image.
         *
         * Container images that are sourced from a public registry like Docker Hub don’t start with
        ...
        public interface Builder {
            ...
            /**
             * @param image The name of the image used for the container. Container images that are
             *   sourced from (registered and stored on) your container service start with a colon (
             *   `:` ). For example, if your container service name is `container-service-1` , the
             *   container image label is `mystaticsite` , and you want to use the third version (
             *   `3` ) of the registered container image, then you should specify
             ...
             *   `:container-service-1.mystaticsite.latest` ). Your container service will
             *   automatically use the highest numbered version of the registered container image.
             *
             * Container images that are sourced from a public registry like Docker Hub don’t start
        ...
        internal constructor(
             ...
             * The name of the image used for the container.
             *
             * Container images that are sourced from (registered and stored on) your container
             ...
             * use the third version ( `3` ) of the registered container image, then you should
    ...
    public interface HealthCheckConfigProperty {
        ...
        public interface Builder {
            /**
             * @param healthyThreshold The number of consecutive health check successes required
             *   before moving the container to the `Healthy` state. The default value is `2` .
             */
            public fun healthyThreshold(healthyThreshold: Number)

            /**
             * @param intervalSeconds The approximate interval, in seconds, between health checks of
             *   an individual container. You can specify between `5` and `300` seconds. The default
             *   value is `5` .
             */
            public fun intervalSeconds(intervalSeconds: Number)

            /**
             * @param path The path on the container on which to perform the health check. The
             *   default value is `/` .
             */
            public fun path(path: String)

            /**
             * @param successCodes The HTTP codes to use when checking for a successful response
             *   from a container. You can specify values between `200` and `499` . You can specify
            ...
            /**
             * @param timeoutSeconds The amount of time, in seconds, during which no response means
             *   a failed health check. You can specify between `2` and `60` seconds. The default
             *   value is `2` .
             */
            public fun timeoutSeconds(timeoutSeconds: Number)

            /**
             * @param unhealthyThreshold The number of consecutive health check failures required
             *   before moving the container to the `Unhealthy` state. The default value is `2` .
             */
    ...
    public interface ContainerServiceDeploymentProperty {
        ...
        public interface Builder {
            /**
             * @param containers An object that describes the configuration for the containers of
             *   the deployment.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("4c45185e4c5081a7a57c2048a7d30a43fc4200b5d930c77ba5f693d10f5ced8b")
            override fun publicEndpoint(
                publicEndpoint: PublicEndpointProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ContainerServiceDeploymentProperty
            ): software.amazon.awscdk.services.lightsail.CfnContainer.ContainerServiceDeploymentProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface PublicEndpointProperty {
        ...
        public interface Builder {
            /**
             * @param containerName The name of the container entry of the deployment that the
             *   endpoint configuration applies to.
             */
            public fun containerName(containerName: String)

            /**
             * @param containerPort The port of the specified container to which traffic is
             *   forwarded to.
             */
            public fun containerPort(containerPort: Number)

            /**
             * @param healthCheckConfig An object that describes the health check configuration of
             *   the container.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            override fun healthCheckConfig(healthCheckConfig: HealthCheckConfigProperty) {
                cdkBuilder.healthCheckConfig(
                    healthCheckConfig.let(HealthCheckConfigProperty::unwrap)
                )
            }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: PublicEndpointProperty
            ): software.amazon.awscdk.services.lightsail.CfnContainer.PublicEndpointProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
