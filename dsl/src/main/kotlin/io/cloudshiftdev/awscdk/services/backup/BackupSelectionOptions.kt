...
public interface BackupSelectionOptions {
     ...
     *
     * If `true`, the `AWSBackupServiceRolePolicyForRestores` managed policy will be attached to the
     * role.
     *
     * Default: false
     */
     ...
     * Backup uses.
     *
     * If `false`, the `AWSBackupServiceRolePolicyForBackup` managed policy will be attached to the
     * role.
     *
     * Default: false
     */
     ...
     *
     * The `AWSBackupServiceRolePolicyForBackup` managed policy will be attached to this role unless
     * `disableDefaultBackupPolicy` is set to `true`.
     *
    ...
    public interface Builder {
        /**
         * @param allowRestores Whether to automatically give restores permissions to the role that
         *   AWS Backup uses. If `true`, the `AWSBackupServiceRolePolicyForRestores` managed policy
         *   will be attached to the role.
         */
        ...
        /**
         * @param disableDefaultBackupPolicy Whether to disable automatically assigning default
         *   backup permissions to the role that AWS Backup uses. If `false`, the
    ...
    private class BuilderImpl : Builder {
         ...
         *   `BackupResource`.
         */
        override fun resources(vararg resources: BackupResource): Unit =
    ...
    internal constructor(
         ...
         * Whether to automatically give restores permissions to the role that AWS Backup uses.
         *
         * If `true`, the `AWSBackupServiceRolePolicyForRestores` managed policy will be attached to
         * the role.
         *
         * Default: false
         */
        ...
        /**
         * Whether to disable automatically assigning default backup permissions to the role that
         * AWS Backup uses.
         *
         * If `false`, the `AWSBackupServiceRolePolicyForBackup` managed policy will be attached to
         * the role.
         *
         * Default: false
         */
         ...
         * unless `disableDefaultBackupPolicy` is set to `true`.
         *
         * Default: - a new role will be created
         */
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: BackupSelectionOptions
