...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * After you deploy the app, these variables are defined on the associated app server
         ...
         * the associated data structure - which includes the variables' names, values, and
         * protected flag values - cannot exceed 20 KB. This limit should accommodate most if not
         * all use cases. Exceeding it will cause an exception with the message, "Environment: is
         * too large (maximum is 20KB)."
         *
         ...
         * The app type.
         *
         * Each supported type is associated with a particular layer. For example, PHP applications
         * are associated with a PHP layer. AWS OpsWorks Stacks deploys an application to those
         * instances that are members of the corresponding layer. If your app isn't one of the
    ...
    private class BuilderImpl(
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("6ffc0fd356cd925c8e7bd667c7d7ca5e03fe9f9a58800068d030efba3d77fa39")
        override fun sslConfiguration(
            sslConfiguration: SslConfigurationProperty.Builder.() -> Unit
    ...
    public interface EnvironmentVariableProperty {
        ...
        public interface Builder {
             ...
             *   `DescribeApps` action. To hide an environment variable's value, set `Secure` to
             *   `true` . `DescribeApps` returns `*****FILTERED*****` instead of the actual value.
            ...
            /**
             * @param value (Optional) The environment variable's value, which can be left empty. If
        ...
        internal constructor(
             ...
             *
             * The name can contain upper- and lowercase letters, numbers, and underscores (_), but
             ...
             * returns `*****FILTERED*****` instead of the actual value. The default value for
             * `Secure` is `false` .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-opsworks-app-environmentvariable.html#cfn-opsworks-app-environmentvariable-secure)
             */
             ...
             * (Optional) The environment variable's value, which can be left empty.
             *
             * If you specify a value, it can contain up to 256 characters, which must all be
             * printable.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-opsworks-app-environmentvariable.html#cfn-opsworks-app-environmentvariable-value)
             */
    ...
    public interface SslConfigurationProperty {
         ...
         * Optional.
         *
         * Can be used to specify an intermediate certificate authority key or client
         * authentication.
         *
        ...
        public interface Builder {
            ...
            /**
             * @param privateKey The private key;. the contents of the certificate's domain.kex
             *   file.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SslConfigurationProperty
            ): software.amazon.awscdk.services.opsworks.CfnApp.SslConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SourceProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param sshKey In requests, the repository's SSH key. In responses, AWS OpsWorks
