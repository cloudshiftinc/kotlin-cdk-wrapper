...
internal constructor(
    ...
    /**
     * An indication of whether the query logging configuration is shared with other AWS account s,
    ...
    public interface Builder {
         ...
         *
         * @param destinationArn The ARN of the resource that you want Resolver to send query logs:
         *   an Amazon S3 bucket, a CloudWatch Logs log group, or a Kinesis Data Firehose delivery
         *   stream.
         */
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnResolverQueryLoggingConfig
        ): software.amazon.awscdk.services.route53resolver.CfnResolverQueryLoggingConfig =
            wrapped.cdkObject
    }
}
