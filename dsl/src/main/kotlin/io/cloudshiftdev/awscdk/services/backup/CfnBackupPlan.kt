...
internal constructor(
     ...
     * create.
     */
    public open fun backupPlanTags(): Map<String, String> =
        unwrap(this).getBackupPlanTags() ?: emptyMap()
    ...
    public interface Builder {
         ...
         *
         * @param backupPlanTags To help organize your resources, you can assign your own metadata
    ...
    private class BuilderImpl(
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("6d790c488ea554c98218cf0812f40687ff90d3707d2cee1dff1218fa54bdd5c5")
        override fun backupPlan(
            backupPlan: BackupPlanResourceTypeProperty.Builder.() -> Unit
        ...
        public fun build(): software.amazon.awscdk.services.backup.CfnBackupPlan =
            cdkBuilder.build()
    }
    ...
    public interface CopyActionResourceTypeProperty {
         ...
         * you define. If you do not specify a lifecycle, AWS Backup applies the lifecycle policy of
        ...
        public interface Builder {
            /**
             * @param destinationBackupVaultArn An Amazon Resource Name (ARN) that uniquely
             *   identifies the destination backup vault for the copied backup. For example,
             *   `arn:aws:backup:us-east-1:123456789012:vault:aBackupVault.`
             */
            public fun destinationBackupVaultArn(destinationBackupVaultArn: String)

            /**
             * @param lifecycle Defines when a protected resource is transitioned to cold storage
             *   and when it expires. AWS Backup transitions and expires backups automatically
             *   according to the lifecycle that you define. If you do not specify a lifecycle, AWS
        ...
        private class BuilderImpl : Builder {
            ...
            override fun lifecycle(
                lifecycle: LifecycleResourceTypeProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-backup-backupplan-copyactionresourcetype.html#cfn-backup-backupplan-copyactionresourcetype-destinationbackupvaultarn)
             */
            override fun destinationBackupVaultArn(): String =
             ...
             * expires.
             *
             * AWS Backup transitions and expires backups automatically according to the lifecycle
             * that you define. If you do not specify a lifecycle, AWS Backup applies the lifecycle
             * policy of the source backup to the destination backup.
             *
             * Backups transitioned to cold storage must be stored in cold storage for a minimum of
             * 90 days.
             *
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CopyActionResourceTypeProperty
            ): software.amazon.awscdk.services.backup.CfnBackupPlan.CopyActionResourceTypeProperty =
    ...
    public interface AdvancedBackupSettingResourceTypeProperty {
         ...
         *
         * Each option is a key-value pair. This option is only available for Windows VSS backup
         * jobs.
         *
         * Valid values:
         *
        ...
        public interface Builder {
            /**
             * @param backupOptions The backup option for the resource. Each option is a key-value
             *   pair. This option is only available for Windows VSS backup jobs.
             *
             * Valid values:
             *
             * Set to `"WindowsVSS":"enabled"` to enable the `WindowsVSS` backup option and create a
            ...
            /**
             * @param resourceType The name of a resource type. The only supported resource type is
             *   EC2.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AdvancedBackupSettingResourceTypeProperty
            ): software.amazon.awscdk.services.backup.CfnBackupPlan.AdvancedBackupSettingResourceTypeProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface BackupPlanResourceTypeProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param backupPlanRule An array of `BackupRule` objects, each of which specifies a
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: BackupPlanResourceTypeProperty
            ): software.amazon.awscdk.services.backup.CfnBackupPlan.BackupPlanResourceTypeProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface BackupRuleResourceTypeProperty {
         ...
         */
        public fun scheduleExpressionTimezone(): String? =
        ...
        public interface Builder {
            ...
            /**
             * @param copyActions An array of CopyAction objects, which contains the details of the
             *   copy operation.
             */
            ...
            /**
             * @param enableContinuousBackup Enables continuous backup and point-in-time restores
             *   (PITR).
             */
            ...
            /**
             * @param lifecycle The lifecycle defines when a protected resource is transitioned to
             *   cold storage and when it expires. AWS Backup transitions and expires backups
            ...
            /**
             * @param recoveryPointTags To help organize your resources, you can assign your own
            ...
            /**
             * @param scheduleExpression A CRON expression specifying when AWS Backup initiates a
             *   backup job.
             */
            public fun scheduleExpression(scheduleExpression: String)

            /**
             * @param scheduleExpressionTimezone This is the timezone in which the schedule
             *   expression is set. By default, ScheduleExpressions are in UTC. You can modify this
             *   to a specified timezone.
             */
            public fun scheduleExpressionTimezone(scheduleExpressionTimezone: String)

            /**
             * @param startWindowMinutes An optional value that specifies a period of time in
             *   minutes after a backup is scheduled before a job is canceled if it doesn't start
             *   successfully. If this value is included, it must be at least 60 minutes to avoid
             *   errors.
             */
             ...
             *   them and the AWS Region where they are created. They consist of letters, numbers,
             *   and hyphens.
             */
        ...
        private class BuilderImpl : Builder {
             ...
             *   copy operation.
             */
            override fun copyActions(vararg copyActions: Any): Unit =
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-backup-backupplan-backupruleresourcetype.html#cfn-backup-backupplan-backupruleresourcetype-completionwindowminutes)
             */
            override fun completionWindowMinutes(): Number? =
             ...
             * This is the timezone in which the schedule expression is set.
             *
             * By default, ScheduleExpressions are in UTC. You can modify this to a specified
             * timezone.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-backup-backupplan-backupruleresourcetype.html#cfn-backup-backupplan-backupruleresourcetype-scheduleexpressiontimezone)
             */
             ...
             *
             * Backup vaults are identified by names that are unique to the account used to create
             * them and the AWS Region where they are created. They consist of letters, numbers, and
             * hyphens.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-backup-backupplan-backupruleresourcetype.html#cfn-backup-backupplan-backupruleresourcetype-targetbackupvault)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: BackupRuleResourceTypeProperty
            ): software.amazon.awscdk.services.backup.CfnBackupPlan.BackupRuleResourceTypeProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface LifecycleResourceTypeProperty {
         ...
         */
        public fun moveToColdStorageAfterDays(): Number? =
        ...
        private class BuilderImpl : Builder {
            ...
            /** @param optInToArchiveForSupportedResources the value to be set. */
            override fun optInToArchiveForSupportedResources(
                optInToArchiveForSupportedResources: Boolean
            ) {
            ...
            override fun optInToArchiveForSupportedResources(
                ...
                cdkBuilder.optInToArchiveForSupportedResources(
                    optInToArchiveForSupportedResources.let(IResolvable::unwrap)
                )
            }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: LifecycleResourceTypeProperty
            ): software.amazon.awscdk.services.backup.CfnBackupPlan.LifecycleResourceTypeProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
