...
internal constructor(
    ...
    public open fun vpcInterfaceAttachment(
        `value`: VpcInterfaceAttachmentProperty.Builder.() -> Unit
    ): Unit = vpcInterfaceAttachment(VpcInterfaceAttachmentProperty(`value`))
    ...
    public interface Builder {
         ...
         *
         * @param cidrAllowList The range of IP addresses that are allowed to initiate output
         ...
         * A description of the output.
         *
         * This description is not visible outside of the current AWS account even if the account
         * grants entitlements to other accounts.
         *
