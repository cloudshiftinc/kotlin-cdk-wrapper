...
internal constructor(
    ...
    public interface Builder {
        ...
        /**
         * *[Default policies only]* Specifies how often the policy should run and create snapshots
         * or AMIs.
         *
        ...
        /**
         * *[Default policies only]* Specifies exclusion parameters for volumes or instances for
         * which you do not want to create snapshots or AMIs.
         *
        ...
        /**
         * *[Default policies only]* Defines the snapshot or AMI retention behavior for the policy
         * if the source volume or instance is deleted, or if the policy enters the error, disabled,
         * or deleted state.
         *
         * By default ( *ExtendDeletion=false* ):
         * * If a source resource is deleted, Amazon Data Lifecycle Manager will continue to delete
         *   previously created snapshots or AMIs, up to but not including the last one, based on
         *   the specified retention period. If you want Amazon Data Lifecycle Manager to delete all
         ...
         *   stops deleting snapshots and AMIs. If you want Amazon Data Lifecycle Manager to
         *   continue deleting snapshots or AMIs, including the last one, if the policy enters one
         *   of these states, specify `true` .
         *
         ...
         * before deleting them.
         *
         * The retention period can range from 2 to 14 days, but it must be greater than the
         * creation frequency to ensure that the policy retains at least 1 snapshot or AMI at any
         ...
         *   retain snapshots or AMIs before deleting them.
         */
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.dlm.CfnLifecyclePolicy =
            cdkBuilder.build()
    }
    ...
    public interface RetainRuleProperty {
         ...
         * fourth snapshot is created, the oldest retained snapshot is deleted, or it is moved to
         ...
         * `IntervalUnit=MONTHS` . Once the snapshot has been retained for 3 months, it is deleted,
         * or it is moved to the archive tier if you have specified an
         * [ArchiveRule](https://docs.aws.amazon.com/dlm/latest/APIReference/API_ArchiveRule.html) .
         *
        ...
        public interface Builder {
            /**
             * @param count The number of snapshots to retain for each volume, up to a maximum
             *   of 1000. For example if you want to retain a maximum of three snapshots, specify
             *   `3` . When the fourth snapshot is created, the oldest retained snapshot is deleted,
             *   or it is moved to the archive tier if you have specified an
             *   [ArchiveRule](https://docs.aws.amazon.com/dlm/latest/APIReference/API_ArchiveRule.html)
             *   .
             */
            ...
            /**
             * @param interval The amount of time to retain each snapshot. The maximum is 100 years.
             ...
             *   snapshots for 3 months, specify `Interval=3` and `IntervalUnit=MONTHS` . Once the
             *   snapshot has been retained for 3 months, it is deleted, or it is moved to the
        ...
        internal constructor(
             ...
             * The number of snapshots to retain for each volume, up to a maximum of 1000.
             *
             * For example if you want to retain a maximum of three snapshots, specify `3` . When
             * the fourth snapshot is created, the oldest retained snapshot is deleted, or it is
             ...
             * The amount of time to retain each snapshot.
             *
             * The maximum is 100 years. This is equivalent to 1200 months, 5200 weeks, or 36500
             * days.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-dlm-lifecyclepolicy-retainrule.html#cfn-dlm-lifecyclepolicy-retainrule-interval)
             */
             ...
             *
             * For example, to retain snapshots for 3 months, specify `Interval=3` and
             * `IntervalUnit=MONTHS` . Once the snapshot has been retained for 3 months, it is
             * deleted, or it is moved to the archive tier if you have specified an
             * [ArchiveRule](https://docs.aws.amazon.com/dlm/latest/APIReference/API_ArchiveRule.html)
             * .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-dlm-lifecyclepolicy-retainrule.html#cfn-dlm-lifecyclepolicy-retainrule-intervalunit)
    ...
    public interface EventParametersProperty {
         ...
         *
         * The description pattern is specified using a regular expression. The policy runs only if
         * a snapshot with a description that matches the specified pattern is shared with your
         * account.
         *
         * For example, specifying `^.*Created for policy: policy-1234567890abcdef0.*$` configures
         * the policy to run only if snapshots created by policy `policy-1234567890abcdef0` are
        ...
        public interface Builder {
            /**
             * @param descriptionRegex The snapshot description that can trigger the policy. The
             *   description pattern is specified using a regular expression. The policy runs only
             *   if a snapshot with a description that matches the specified pattern is shared with
             *   your account.
             *
            ...
            /**
             * @param eventType The type of event. Currently, only snapshot sharing events are
             *   supported.
             */
             ...
             *   snapshots with your account. The policy only runs if one of the specified AWS
        ...
        internal constructor(
             ...
             * The snapshot description that can trigger the policy.
             *
             * The description pattern is specified using a regular expression. The policy runs only
             * if a snapshot with a description that matches the specified pattern is shared with
             * your account.
             *
             * For example, specifying `^.*Created for policy: policy-1234567890abcdef0.*$`
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: EventParametersProperty
            ): software.amazon.awscdk.services.dlm.CfnLifecyclePolicy.EventParametersProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ParametersProperty {
         ...
         *
         * The default is `false` . If you specify `true` , then the root volumes attached to
         * targeted instances will be excluded from the multi-volume snapshot sets created by the
         * policy.
         *
        ...
        public interface Builder {
            /**
             * @param excludeBootVolume *[Custom snapshot policies that target instances only]*
             *   Indicates whether to exclude the root volume from multi-volume snapshot sets. The
             *   default is `false` . If you specify `true` , then the root volumes attached to
            ...
            /**
             * @param excludeDataVolumeTags *[Custom snapshot policies that target instances only]*
             *   The tags used to identify data (non-root) volumes to exclude from multi-volume
             *   snapshot sets. If you create a snapshot lifecycle policy that targets instances and
             *   you specify tags for this parameter, then data volumes with the specified tags that
             *   are attached to targeted instances will be excluded from the multi-volume snapshot
        ...
        internal constructor(
            ...
            /**
             * *[Custom snapshot policies that target instances only]* Indicates whether to exclude
             * the root volume from multi-volume snapshot sets.
             *
             * The default is `false` . If you specify `true` , then the root volumes attached to
             * targeted instances will be excluded from the multi-volume snapshot sets created by
             * the policy.
            ...
            /**
             * *[Custom AMI policies only]* Indicates whether targeted instances are rebooted when
             * the lifecycle policy runs.
             *
             * `true` indicates that targeted instances are not rebooted when the policy runs.
             * `false` indicates that target instances are rebooted when the policy runs. The
    ...
    public interface EventSourceProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param type The source of the event. Currently only managed CloudWatch Events rules
             *   are supported.
             */
    ...
    public interface CrossRegionCopyDeprecateRuleProperty {
         ...
         *
         * The period must be less than or equal to the cross-Region AMI copy retention period, and
         * it can't be greater than 10 years. This is equivalent to 120 months, 520 weeks, or 3650
         * days.
         *
         ...
         *
         * For example, to deprecate a cross-Region AMI copy after 3 months, specify `Interval=3`
        ...
        public interface Builder {
            /**
             * @param interval The period after which to deprecate the cross-Region AMI copies. The
             *   period must be less than or equal to the cross-Region AMI copy retention period,
             *   and it can't be greater than 10 years. This is equivalent to 120 months, 520 weeks,
             *   or 3650 days.
             */
            public fun interval(interval: Number)

            /**
             * @param intervalUnit The unit of time in which to measure the *Interval* . For
             *   example, to deprecate a cross-Region AMI copy after 3 months, specify `Interval=3`
             *   and `IntervalUnit=MONTHS` .
             */
            public fun intervalUnit(intervalUnit: String)
        }
        ...
        internal constructor(
             ...
             * The period after which to deprecate the cross-Region AMI copies.
             *
             * The period must be less than or equal to the cross-Region AMI copy retention period,
             * and it can't be greater than 10 years. This is equivalent to 120 months, 520 weeks,
             * or 3650 days.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-dlm-lifecyclepolicy-crossregioncopydeprecaterule.html#cfn-dlm-lifecyclepolicy-crossregioncopydeprecaterule-interval)
             ...
             * The unit of time in which to measure the *Interval* .
             *
             * For example, to deprecate a cross-Region AMI copy after 3 months, specify
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CrossRegionCopyDeprecateRuleProperty
            ): software.amazon.awscdk.services.dlm.CfnLifecyclePolicy.CrossRegionCopyDeprecateRuleProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ShareRuleProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param unshareInterval The period after which snapshots that are shared with other
             *   AWS accounts are automatically unshared.
             */
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-dlm-lifecyclepolicy-sharerule.html#cfn-dlm-lifecyclepolicy-sharerule-targetaccounts)
             */
            override fun targetAccounts(): List<String> =
                unwrap(this).getTargetAccounts() ?: emptyList()
    ...
    public interface FastRestoreRuleProperty {
        ...
        public interface Builder {
            /**
             * @param availabilityZones The Availability Zones in which to enable fast snapshot
             *   restore.
             */
            ...
            /**
             * @param interval The amount of time to enable fast snapshot restore. The maximum is
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-dlm-lifecyclepolicy-fastrestorerule.html#cfn-dlm-lifecyclepolicy-fastrestorerule-availabilityzones)
             */
            override fun availabilityZones(): List<String> =
                unwrap(this).getAvailabilityZones() ?: emptyList()
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: FastRestoreRuleProperty
            ): software.amazon.awscdk.services.dlm.CfnLifecyclePolicy.FastRestoreRuleProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface RetentionArchiveTierProperty {
         ...
         *
         * The count must ensure that each snapshot remains in the archive tier for at least 90
         * days. For example, if the schedule creates snapshots every 30 days, you must specify a
        ...
        public interface Builder {
            /**
             * @param count The maximum number of snapshots to retain in the archive storage tier
             *   for each volume. The count must ensure that each snapshot remains in the archive
             *   tier for at least 90 days. For example, if the schedule creates snapshots every 30
             *   days, you must specify a count of 3 or more to ensure that each snapshot is
        ...
        internal constructor(
             ...
             *
             * The count must ensure that each snapshot remains in the archive tier for at least 90
             * days. For example, if the schedule creates snapshots every 30 days, you must specify
             ...
             * The unit of time in which to measure the *Interval* .
             *
             * For example, to retain a snapshots in the archive tier for 6 months, specify
             * `Interval=6` and `IntervalUnit=MONTHS` .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-dlm-lifecyclepolicy-retentionarchivetier.html#cfn-dlm-lifecyclepolicy-retentionarchivetier-intervalunit)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RetentionArchiveTierProperty
            ): software.amazon.awscdk.services.dlm.CfnLifecyclePolicy.RetentionArchiveTierProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ScheduleProperty {
         ...
         * tier to the archive tier once the schedule's retention threshold is met. Snapshots are
         * then retained in the archive tier for the archive retention period that you specify.
         *
         ...
         * Outpost. If the policy creates snapshots in a Region, then snapshots can be copied to up
        ...
        public interface Builder {
             ...
             *   retention threshold is met. Snapshots are then retained in the archive tier for the
            ...
            /**
             * @param copyTags Copy all user-defined tags on a source volume to snapshots of the
            ...
            /**
             * @param crossRegionCopyRules Specifies a rule for copying snapshots or AMIs across
             *   regions.
             *
             * You can't specify cross-Region copy rules for policies that create snapshots on an
             * Outpost. If the policy creates snapshots in a Region, then snapshots can be copied to
            ...
            /**
             * @param shareRules *[Custom snapshot policies only]* The rule for sharing snapshots
            ...
            /**
             * @param tagsToAdd The tags to apply to policy-created resources. These user-defined
            ...
            /**
             * @param variableTags *[AMI policies and snapshot policies that target instances only]*
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("fb7a0258a6a743ee09f1b22132dea6f3341e66f8726bb797909b7292faed4270")
            override fun deprecateRule(
                deprecateRule: DeprecateRuleProperty.Builder.() -> Unit
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("e27b9391e7a38b3c973427c0f60208402a121bef2c15bbc3199f4c686769530a")
            override fun fastRestoreRule(
                fastRestoreRule: FastRestoreRuleProperty.Builder.() -> Unit
        ...
        internal constructor(
            ...
            /**
             * *[Custom snapshot policies that target volumes only]* The snapshot archiving rule for
             * the schedule.
             *
             * When you specify an archiving rule, snapshots are automatically moved from the
             * standard tier to the archive tier once the schedule's retention threshold is met.
             * Snapshots are then retained in the archive tier for the archive retention period that
             * you specify.
             *
             * For more information about using snapshot archiving, see
             * [Considerations for snapshot lifecycle policies](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/snapshot-ami-policy.html#dlm-archive)
            ...
            /**
             * *[Custom snapshot policies only]* The rule for sharing snapshots with other AWS
             * accounts .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-dlm-lifecyclepolicy-schedule.html#cfn-dlm-lifecyclepolicy-schedule-sharerules)
             */
    ...
    public interface ArchiveRuleProperty {
        ...
        public interface Builder {
            /**
             * @param retainRule Information about the retention period for the snapshot archiving
             *   rule.
             */
            public fun retainRule(retainRule: IResolvable)
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("22112598039fa0891c015794eab927b32a7c3cace5a3606f9960cb6a144f4b1e")
            override fun retainRule(
                retainRule: ArchiveRetainRuleProperty.Builder.() -> Unit
            ): Unit = retainRule(ArchiveRetainRuleProperty(retainRule))
    ...
    public interface CreateRuleProperty {
         ...
         *
         * The schedule interval must be between 1 hour and 1 year. For more information, see
         ...
         * policy.
         *
         * To create snapshots in the same Region as the source resource, specify `CLOUD` . To
         * create snapshots on the same Outpost as the source resource, specify `OUTPOST_LOCAL` . If
         * you omit this parameter, `CLOUD` is used by default.
         *
         * If the policy targets resources in an AWS Region , then you must create snapshots in the
         * same Region as the source resource. If the policy targets resources on an Outpost, then
         * you can create snapshots on the same Outpost as the source resource, or in the Region of
         * that Outpost.
         *
        ...
        public interface Builder {
            /**
             * @param cronExpression The schedule, as a Cron expression. The schedule interval must
             *   be between 1 hour and 1 year. For more information, see
             *   [Cron expressions](https://docs.aws.amazon.com/AmazonCloudWatch/latest/events/ScheduledEvents.html#CronExpressions)
             *   in the *Amazon CloudWatch User Guide* .
             */
            ...
            /**
             * @param interval The interval between snapshots. The supported values are 1, 2, 3, 4,
             *   6, 8, 12, and 24.
             */
            public fun interval(interval: Number)
            ...
            /**
             * @param location *[Custom snapshot policies only]* Specifies the destination for
             *   snapshots created by the policy. To create snapshots in the same Region as the
             *   source resource, specify `CLOUD` . To create snapshots on the same Outpost as the
             *   source resource, specify `OUTPOST_LOCAL` . If you omit this parameter, `CLOUD` is
             *   used by default.
             *
             ...
             * Outpost, then you can create snapshots on the same Outpost as the source resource, or
             * in the Region of that Outpost.
             */
            public fun location(location: String)

            /**
             * @param scripts *[Custom snapshot policies that target instances only]* Specifies pre
             *   and/or post scripts for a snapshot lifecycle policy that targets instances. This is
        ...
        internal constructor(
            ...
            /**
             * *[Custom snapshot policies only]* Specifies the destination for snapshots created by
             * the policy.
             *
             * To create snapshots in the same Region as the source resource, specify `CLOUD` . To
             * create snapshots on the same Outpost as the source resource, specify `OUTPOST_LOCAL`
             ...
             *
             * This is useful for creating application-consistent snapshots, or for performing
             * specific administrative tasks before or after Amazon Data Lifecycle Manager initiates
             * snapshot creation.
             *
             * For more information, see
             * [Automating application-consistent snapshots with pre and post scripts](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/automate-app-consistent-backups.html)
             ...
             * not specify a time, Amazon Data Lifecycle Manager selects a time within the next 24
             * hours.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-dlm-lifecyclepolicy-createrule.html#cfn-dlm-lifecyclepolicy-createrule-times)
             */
    ...
    public interface ScriptProperty {
         ...
         *   the SSM document. If you are using a custom SSM document that is shared with you,
        ...
        /**
         * Specifies a timeout period, in seconds, after which Amazon Data Lifecycle Manager fails
         * the script run attempt if it has not completed.
         *
         ...
         *   calls the SSM document with the `pre-script` parameter before initiating snapshot
         *   creation.
         * * To run a post script only, specify `POST` . In this case, Amazon Data Lifecycle Manager
         *   calls the SSM document with the `post-script` parameter after initiating snapshot
         *   creation.
        ...
        public interface Builder {
            /**
             * @param executeOperationOnScriptFailure Indicates whether Amazon Data Lifecycle
             *   Manager should default to crash-consistent snapshots if the pre script fails.
             * * To default to crash consistent snapshot if the pre script fails, specify `true` .
             * * To skip the instance for snapshot creation if the pre script fails, specify `false`
             *   .
             *
            ...
            /**
             * @param executionHandler The SSM document that includes the pre and/or post scripts to
             *   run.
             * * If you are automating VSS backups, specify `AWS_VSS_BACKUP` . In this case, Amazon
             *   Data Lifecycle Manager automatically uses the `AWSEC2-CreateVssSnapshot` SSM
             *   document.
             * * If you are automating application-consistent snapshots for SAP HANA workloads,
             *   specify `AWSSystemsManagerSAP-CreateDLMSnapshotForSAPHANA` .
             * * If you are using a custom SSM document that you own, specify either the name or ARN
             *   of the SSM document. If you are using a custom SSM document that is shared with
             *   you, specify the ARN of the SSM document.
             */
            public fun executionHandler(executionHandler: String)

            /**
             * @param executionHandlerService Indicates the service used to execute the pre and/or
             *   post scripts.
            ...
            /**
             * @param executionTimeout Specifies a timeout period, in seconds, after which Amazon
             *   Data Lifecycle Manager fails the script run attempt if it has not completed. If a
             *   script does not complete within its timeout period, Amazon Data Lifecycle Manager
            ...
            /**
             * @param maximumRetryCount Specifies the number of times Amazon Data Lifecycle Manager
             *   should retry scripts that fail.
             * * If the pre script fails, Amazon Data Lifecycle Manager retries the entire snapshot
             *   creation process, including running the pre and post scripts.
             * * If the post script fails, Amazon Data Lifecycle Manager retries the post script
             *   only; in this case, the pre script will have completed and the snapshot might have
             *   been created.
             *
             * If you do not want Amazon Data Lifecycle Manager to retry failed scripts, specify `0`
             * .
            ...
            /**
             * @param stages Indicate which scripts Amazon Data Lifecycle Manager should run on
             *   target instances. Pre scripts run before Amazon Data Lifecycle Manager initiates
             ...
             *   again with the `post-script` parameter after initiating snapshot creation.
             *
             * If you are automating VSS Backups, omit this parameter.
             *
             * Default: PRE and POST
        ...
        private class BuilderImpl : Builder {
             ...
             * Default: true
             */
            override fun executeOperationOnScriptFailure(
                executeOperationOnScriptFailure: IResolvable
            ) {
                cdkBuilder.executeOperationOnScriptFailure(
                    executeOperationOnScriptFailure.let(IResolvable::unwrap)
                )
            }
    ...
    public interface CrossRegionCopyRuleProperty {
         ...
         * *Target* parameter was introduced, this parameter indicates the target Region for
         * snapshot copies.
         *
        ...
        public interface Builder {
            /**
             * @param cmkArn The Amazon Resource Name (ARN) of the AWS KMS key to use for EBS
             *   encryption. If this parameter is not specified, the default KMS key for the account
             *   is used.
             */
            public fun cmkArn(cmkArn: String)

            /**
             * @param copyTags Indicates whether to copy all user-defined tags from the source
            ...
            /**
             * @param deprecateRule *[Custom AMI policies only]* The AMI deprecation rule for
            ...
            public fun deprecateRule(
                deprecateRule: CrossRegionCopyDeprecateRuleProperty.Builder.() -> Unit
            )

            /**
             * @param encrypted To encrypt a copy of an unencrypted snapshot if encryption by
             *   default is not enabled, enable encryption using this parameter. Copies of encrypted
            ...
            /**
             * @param retainRule The retention rule that indicates how long the cross-Region
            ...
            /**
             * @param targetRegion Use this parameter for AMI policies only. For snapshot policies,
             *   use *Target* instead. For snapshot policies created before the *Target* parameter
             *   was introduced, this parameter indicates the target Region for snapshot copies.
             *
             * *[Custom AMI policies only]* The target Region or the Amazon Resource Name (ARN) of
             * the target Outpost for the snapshot copies.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            override fun deprecateRule(deprecateRule: CrossRegionCopyDeprecateRuleProperty) {
                cdkBuilder.deprecateRule(
                    deprecateRule.let(CrossRegionCopyDeprecateRuleProperty::unwrap)
                )
            }
            ...
            @JvmName("167e01da92a571d38b2ea00ebe7df6e195e691b240f448676b5a2ca926bbda1d")
            override fun retainRule(
                retainRule: CrossRegionCopyRetainRuleProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * instead.
             *
             * *[Custom snapshot policies only]* The target Region or the Amazon Resource Name (ARN)
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CrossRegionCopyRuleProperty
            ): software.amazon.awscdk.services.dlm.CfnLifecyclePolicy.CrossRegionCopyRuleProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface PolicyDetailsProperty {
        ...
        /**
         * *[Custom snapshot and AMI policies only]* A set of optional parameters for snapshot and
         ...
         * of Amazon EBS snapshots. Specify `IMAGE_MANAGEMENT` to create a lifecycle policy that
         * manages the lifecycle of EBS-backed AMIs. Specify `EVENT_BASED_POLICY` to create an
         ...
         */
        public fun resourceLocations(): List<String> =
            unwrap(this).getResourceLocations() ?: emptyList()
        ...
        public interface Builder {
             ...
             *   tags from the source resource to the snapshot or AMI. If you do not specify a
            ...
            /**
             * @param createInterval *[Default policies only]* Specifies how often the policy should
             *   run and create snapshots or AMIs. The creation frequency can range from 1 to 7
            ...
            /**
             * @param crossRegionCopyTargets *[Default policies only]* Specifies destination Regions
             *   for snapshot or AMI copies. You can specify up to 3 destination Regions. If you do
             *   not want to create cross-Region copies, omit this parameter.
             */
            public fun crossRegionCopyTargets(crossRegionCopyTargets: Any)

            /**
             * @param eventSource *[Event-based policies only]* The event that activates the
             *   event-based policy.
             */
            ...
            /**
             * @param exclusions *[Default policies only]* Specifies exclusion parameters for
             *   volumes or instances for which you do not want to create snapshots or AMIs. The
             *   policy will not create snapshots or AMIs for target resources that match any of the
             *   specified exclusion parameters.
             */
            public fun exclusions(exclusions: IResolvable)
             ...
             *   policy enters the error, disabled, or deleted state. By default (
             ...
             *   based on the specified retention period. If you want Amazon Data Lifecycle Manager
             ...
             *   Manager stops deleting snapshots and AMIs. If you want Amazon Data Lifecycle
             *   Manager to continue deleting snapshots or AMIs, including the last one, if the
             *   policy enters one of these states, specify `true` .
             *
             * If you enable extended deletion ( *ExtendDeletion=true* ), you override both default
             * behaviors simultaneously.
             *
            ...
            /**
             * @param parameters *[Custom snapshot and AMI policies only]* A set of optional
             ...
             * specify either the default values or the new values that you require. You can't omit
             * this parameter or set its values to null.
             */
            public fun parameters(parameters: IResolvable)
            ...
            /**
             * @param policyType The type of policy. Specify `EBS_SNAPSHOT_MANAGEMENT` to create a
             ...
             *   EBS-backed AMIs. Specify `EVENT_BASED_POLICY` to create an event-based policy that
            ...
            /**
             * @param resourceLocations *[Custom snapshot and AMI policies only]* The location of
             *   the resources to backup. If the source resources are located in an AWS Region ,
            ...
            /**
             * @param resourceType *[Default policies only]* Specify the type of default policy to
             *   create.
             * * To create a default policy for EBS snapshots, that creates snapshots of all volumes
             *   in the Region that do not have recent backups, specify `VOLUME` .
             ...
             *   snapshot and AMI lifecycle policies. Use `VOLUME` to create snapshots of individual
             *   volumes or use `INSTANCE` to create multi-volume snapshots from the volumes for an
             *   instance.
             */
            ...
            /**
             * @param retainInterval *[Default policies only]* Specifies how long the policy should
             *   retain snapshots or AMIs before deleting them. The retention period can range from
             *   2 to 14 days, but it must be greater than the creation frequency to ensure that the
             *   policy retains at least 1 snapshot or AMI at any given time. If you do not specify
            ...
            /**
             * @param schedules *[Custom snapshot and AMI policies only]* The schedules of
             *   policy-defined actions for snapshot and AMI lifecycle policies. A policy can have
             *   up to four schedules—one mandatory schedule and up to three optional schedules.
             */
            ...
            /**
             * @param targetTags *[Custom snapshot and AMI policies only]* The single tag that
        ...
        internal constructor(
            ...
            /**
             * *[Event-based policies only]* The actions to be performed when the event-based policy
             * is activated.
             *
             * You can specify only one action per policy.
             *
             ...
             * *[Default policies only]* Specifies destination Regions for snapshot or AMI copies.
             *
             * You can specify up to 3 destination Regions. If you do not want to create
             ...
             * which you do not want to create snapshots or AMIs.
             *
             * The policy will not create snapshots or AMIs for target resources that match any of
             ...
             * The type of policy.
             *
             * Specify `EBS_SNAPSHOT_MANAGEMENT` to create a lifecycle policy that manages the
             * lifecycle of Amazon EBS snapshots. Specify `IMAGE_MANAGEMENT` to create a lifecycle
             * policy that manages the lifecycle of EBS-backed AMIs. Specify `EVENT_BASED_POLICY` to
             * create an event-based policy that performs specific actions when a defined event
             * occurs in your AWS account .
             *
             * The default is `EBS_SNAPSHOT_MANAGEMENT` .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-dlm-lifecyclepolicy-policydetails.html#cfn-dlm-lifecyclepolicy-policydetails-policytype)
             ...
             * *[Custom snapshot and AMI policies only]* The location of the resources to backup.
             *
             * If the source resources are located in an AWS Region , specify `CLOUD` . If the
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-dlm-lifecyclepolicy-policydetails.html#cfn-dlm-lifecyclepolicy-policydetails-resourcelocations)
             */
            override fun resourceLocations(): List<String> =
                unwrap(this).getResourceLocations() ?: emptyList()
            ...
            /**
             * *[Default policies only]* Specifies how long the policy should retain snapshots or
             * AMIs before deleting them.
             *
             * The retention period can range from 2 to 14 days, but it must be greater than the
             * creation frequency to ensure that the policy retains at least 1 snapshot or AMI at
    ...
    public interface EncryptionConfigurationProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param encrypted To encrypt a copy of an unencrypted snapshot when encryption by
             *   default is not enabled, enable encryption using this parameter. Copies of encrypted
    ...
    public interface CrossRegionCopyActionProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param retainRule Specifies a retention rule for cross-Region snapshot copies created
             *   by snapshot or event-based policies, or cross-Region AMI copies created by AMI
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CrossRegionCopyActionProperty
            ): software.amazon.awscdk.services.dlm.CfnLifecyclePolicy.CrossRegionCopyActionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ExclusionsProperty {
        ...
        public interface Builder {
            /**
             * @param excludeBootVolumes *[Default policies for EBS snapshots only]* Indicates
             *   whether to exclude volumes that are attached to instances as the boot volume. If
             *   you exclude boot volumes, only volumes attached as data (non-boot) volumes will be
             *   backed up by the policy. To exclude boot volumes, specify `true` .
             */
            ...
            /**
             * @param excludeVolumeTypes *[Default policies for EBS snapshots only]* Specifies the
             *   volume types to exclude. Volumes of the specified types will not be targeted by the
             *   policy.
             */
        ...
        internal constructor(
            ...
            /**
             * *[Default policies for EBS snapshots only]* Indicates whether to exclude volumes that
             * are attached to instances as the boot volume.
             *
             * If you exclude boot volumes, only volumes attached as data (non-boot) volumes will be
             * backed up by the policy. To exclude boot volumes, specify `true` .
             *
            ...
            /**
             * *[Default policies for EBS-backed AMIs only]* Specifies whether to exclude volumes
    ...
    public interface ArchiveRetainRuleProperty {
        ...
        public interface Builder {
            /**
             * @param retentionArchiveTier Information about retention period in the Amazon EBS
             *   Snapshots Archive. For more information, see
             *   [Archive Amazon EBS snapshots](https://docs.aws.amazon.com/AWSEC2/latest/WindowsGuide/snapshot-archive.html)
             *   .
             */
            ...
            public fun retentionArchiveTier(
                retentionArchiveTier: RetentionArchiveTierProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun retentionArchiveTier(retentionArchiveTier: RetentionArchiveTierProperty) {
                cdkBuilder.retentionArchiveTier(
                    retentionArchiveTier.let(RetentionArchiveTierProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("551dbf48b425648dc22b6154e42ca2745b9d79670853ce1e7d0b5f107735a6d9")
            override fun retentionArchiveTier(
                retentionArchiveTier: RetentionArchiveTierProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ArchiveRetainRuleProperty
            ): software.amazon.awscdk.services.dlm.CfnLifecyclePolicy.ArchiveRetainRuleProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CrossRegionCopyRetainRuleProperty {
        ...
        public interface Builder {
            /**
             * @param interval The amount of time to retain a cross-Region snapshot or AMI copy. The
            ...
            /**
             * @param intervalUnit The unit of time for time-based retention. For example, to retain
             *   a cross-Region copy for 3 months, specify `Interval=3` and `IntervalUnit=MONTHS` .
             */
            public fun intervalUnit(intervalUnit: String)
        }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CrossRegionCopyRetainRuleProperty
            ): software.amazon.awscdk.services.dlm.CfnLifecyclePolicy.CrossRegionCopyRetainRuleProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DeprecateRuleProperty {
         ...
         * after which to deprecate AMIs created by the schedule.
         *
        ...
        public interface Builder {
            /**
             * @param count If the schedule has a count-based retention rule, this parameter
             *   specifies the number of oldest AMIs to deprecate. The count must be less than or
             *   equal to the schedule's retention count, and it can't be greater than 1000.
             */
            public fun count(count: Number)

            /**
             * @param interval If the schedule has an age-based retention rule, this parameter
             *   specifies the period after which to deprecate AMIs created by the schedule. The
             *   period must be less than or equal to the schedule's retention period, and it can't
             *   be greater than 10 years. This is equivalent to 120 months, 520 weeks, or 3650
             *   days.
             */
            public fun interval(interval: Number)
        ...
        internal constructor(
             ...
             * of oldest AMIs to deprecate.
             *
             * The count must be less than or equal to the schedule's retention count, and it can't
             ...
             * after which to deprecate AMIs created by the schedule.
             *
             * The period must be less than or equal to the schedule's retention period, and it
             * can't be greater than 10 years. This is equivalent to 120 months, 520 weeks, or 3650
             * days.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-dlm-lifecyclepolicy-deprecaterule.html#cfn-dlm-lifecyclepolicy-deprecaterule-interval)
             */
