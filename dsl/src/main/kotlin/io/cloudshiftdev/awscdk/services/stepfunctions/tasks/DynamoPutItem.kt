...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param returnItemCollectionMetrics The item collection metrics to returned in the
         *   response.
         */
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.stepfunctions.tasks.DynamoPutItem.Builder.create(
                scope,
                id
            )
