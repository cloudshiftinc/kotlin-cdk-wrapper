...
public interface TransformInput {
    ...
    public interface Builder {
        ...
        /**
         * @param splitType Method to use to split the transform job's data files into smaller
         *   batches.
         */
    ...
    private class BuilderImpl : Builder {
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("5f551870120542c8db26a2b12caf7813593a48287a8bf352a51c8dc7371a7c04")
        override fun transformDataSource(
            transformDataSource: TransformDataSource.Builder.() -> Unit
