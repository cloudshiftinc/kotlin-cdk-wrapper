...
internal constructor(
    ...
    public open fun deploymentPreference(
        `value`: DeploymentPreferenceProperty.Builder.() -> Unit
    ...
    public open fun provisionedConcurrencyConfig(`value`: ProvisionedConcurrencyConfigProperty) {
        unwrap(this)
            .setProvisionedConcurrencyConfig(
                `value`.let(ProvisionedConcurrencyConfigProperty::unwrap)
            )
    }
    ...
    public open fun provisionedConcurrencyConfig(
        `value`: ProvisionedConcurrencyConfigProperty.Builder.() -> Unit
    ...
    public interface Builder {
        ...
        public fun deploymentPreference(
            deploymentPreference: DeploymentPreferenceProperty.Builder.() -> Unit
        )
        ...
        public fun eventInvokeConfig(
            eventInvokeConfig: EventInvokeConfigProperty.Builder.() -> Unit
        )
        ...
        public fun functionUrlConfig(
            functionUrlConfig: FunctionUrlConfigProperty.Builder.() -> Unit
        )
        ...
        public fun provisionedConcurrencyConfig(
            provisionedConcurrencyConfig: ProvisionedConcurrencyConfigProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
        ...
        override fun deadLetterQueue(
            deadLetterQueue: DeadLetterQueueProperty.Builder.() -> Unit
        ): Unit = deadLetterQueue(DeadLetterQueueProperty(deadLetterQueue))
        ...
        override fun deploymentPreference(deploymentPreference: DeploymentPreferenceProperty) {
            cdkBuilder.deploymentPreference(
                deploymentPreference.let(DeploymentPreferenceProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("46d0d192264a9c529481aa082ec6a85dca8a2248318ea57e00256ff2a42c9c5d")
        override fun deploymentPreference(
            deploymentPreference: DeploymentPreferenceProperty.Builder.() -> Unit
        ...
        override fun environment(
            environment: FunctionEnvironmentProperty.Builder.() -> Unit
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("3821cfcfd762505325ced6e903526368e05159f2232d3d4f76cef82b5c71687e")
        override fun eventInvokeConfig(
            eventInvokeConfig: EventInvokeConfigProperty.Builder.() -> Unit
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("84eb96603668413b2ee852af53152e3e21d22bd84c425e7922b7a5a10bba1fe8")
        override fun functionUrlConfig(
            functionUrlConfig: FunctionUrlConfigProperty.Builder.() -> Unit
        ...
        override fun provisionedConcurrencyConfig(provisionedConcurrencyConfig: IResolvable) {
            cdkBuilder.provisionedConcurrencyConfig(
                provisionedConcurrencyConfig.let(IResolvable::unwrap)
            )
        }
         ...
         * @param provisionedConcurrencyConfig
         */
        override fun provisionedConcurrencyConfig(
            provisionedConcurrencyConfig: ProvisionedConcurrencyConfigProperty
        ) {
            cdkBuilder.provisionedConcurrencyConfig(
                provisionedConcurrencyConfig.let(ProvisionedConcurrencyConfigProperty::unwrap)
            )
        }
        ...
        override fun provisionedConcurrencyConfig(
            ...
            provisionedConcurrencyConfig(
                ProvisionedConcurrencyConfigProperty(provisionedConcurrencyConfig)
            )
    ...
    public interface AlexaSkillEventProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AlexaSkillEventProperty
            ): software.amazon.awscdk.services.sam.CfnFunction.AlexaSkillEventProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DeploymentPreferenceProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DeploymentPreferenceProperty
            ): software.amazon.awscdk.services.sam.CfnFunction.DeploymentPreferenceProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface IAMPolicyDocumentProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: IAMPolicyDocumentProperty
            ): software.amazon.awscdk.services.sam.CfnFunction.IAMPolicyDocumentProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface S3NotificationFilterProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: S3NotificationFilterProperty
            ): software.amazon.awscdk.services.sam.CfnFunction.S3NotificationFilterProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DeadLetterQueueProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DeadLetterQueueProperty
            ): software.amazon.awscdk.services.sam.CfnFunction.DeadLetterQueueProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DestinationConfigProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DestinationConfigProperty
            ): software.amazon.awscdk.services.sam.CfnFunction.DestinationConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CloudWatchLogsEventProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CloudWatchLogsEventProperty
            ): software.amazon.awscdk.services.sam.CfnFunction.CloudWatchLogsEventProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ProvisionedConcurrencyConfigProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ProvisionedConcurrencyConfigProperty
            ): software.amazon.awscdk.services.sam.CfnFunction.ProvisionedConcurrencyConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface EventSourceProperty {
        ...
        private class BuilderImpl : Builder {
            ...
            override fun properties(
                properties: CloudWatchEventEventProperty.Builder.() -> Unit
            ...
            @JvmName("a460abbc4b08de60a9fc8f775db50083dd38c0577e5b4dc0e4eee4997d5af7a1")
            override fun properties(
                properties: CloudWatchLogsEventProperty.Builder.() -> Unit
            ...
            @JvmName("cd2be02483c2feb079e3dec9d5ef9ab12ec0b60f1eda4a2d19cbc34ebf0f9fd4")
            override fun properties(
                properties: EventBridgeRuleEventProperty.Builder.() -> Unit
    ...
    public interface StateMachineSAMPTProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: StateMachineSAMPTProperty
            ): software.amazon.awscdk.services.sam.CfnFunction.StateMachineSAMPTProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ParameterNameSAMPTProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ParameterNameSAMPTProperty
            ): software.amazon.awscdk.services.sam.CfnFunction.ParameterNameSAMPTProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface HttpApiEventProperty {
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("8c12331917e0d3c3c11aaf58c0847e612ed26fe70577b1af8ec4cb4117f4ea95")
            override fun routeSettings(
                routeSettings: RouteSettingsProperty.Builder.() -> Unit
    ...
    public interface KinesisEventProperty {
         ...
         */
        public fun functionResponseTypes(): List<String> =
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-serverless-function-kinesisevent.html#cfn-serverless-function-kinesisevent-functionresponsetypes)
             */
            override fun functionResponseTypes(): List<String> =
                unwrap(this).getFunctionResponseTypes() ?: emptyList()
    ...
    public interface SAMPolicyTemplateProperty {
         ...
         */
        public fun elasticsearchHttpPostPolicy(): Any? =
         ...
         */
        public fun rekognitionDetectOnlyPolicy(): Any? =
         ...
         */
        public fun stepFunctionsExecutionPolicy(): Any? =
        ...
        public interface Builder {
            ...
            public fun awsSecretsManagerGetSecretValuePolicy(
                awsSecretsManagerGetSecretValuePolicy: SecretArnSAMPTProperty.Builder.() -> Unit
            )

            /** @param cloudFormationDescribeStacksPolicy the value to be set. */
            public fun cloudFormationDescribeStacksPolicy(
                cloudFormationDescribeStacksPolicy: IResolvable
            )
            ...
            public fun cloudFormationDescribeStacksPolicy(
                cloudFormationDescribeStacksPolicy: EmptySAMPTProperty.Builder.() -> Unit
            )
            ...
            public fun cloudWatchPutMetricPolicy(
                cloudWatchPutMetricPolicy: EmptySAMPTProperty.Builder.() -> Unit
            )
            ...
            public fun dynamoDbStreamReadPolicy(
                dynamoDbStreamReadPolicy: TableStreamSAMPTProperty.Builder.() -> Unit
            )
            ...
            public fun dynamoDbWritePolicy(
                dynamoDbWritePolicy: TableSAMPTProperty.Builder.() -> Unit
            )
            ...
            public fun elasticsearchHttpPostPolicy(
                elasticsearchHttpPostPolicy: DomainSAMPTProperty.Builder.() -> Unit
            )
            ...
            public fun filterLogEventsPolicy(
                filterLogEventsPolicy: LogGroupSAMPTProperty.Builder.() -> Unit
            )
            ...
            public fun kinesisStreamReadPolicy(
                kinesisStreamReadPolicy: StreamSAMPTProperty.Builder.() -> Unit
            )
            ...
            public fun lambdaInvokePolicy(
                lambdaInvokePolicy: FunctionSAMPTProperty.Builder.() -> Unit
            )
            ...
            public fun rekognitionDetectOnlyPolicy(
                rekognitionDetectOnlyPolicy: EmptySAMPTProperty.Builder.() -> Unit
            )
            ...
            public fun rekognitionLabelsPolicy(
                rekognitionLabelsPolicy: EmptySAMPTProperty.Builder.() -> Unit
            )
            ...
            public fun rekognitionNoDataAccessPolicy(
                rekognitionNoDataAccessPolicy: CollectionSAMPTProperty.Builder.() -> Unit
            )
            ...
            public fun rekognitionReadPolicy(
                rekognitionReadPolicy: CollectionSAMPTProperty.Builder.() -> Unit
            )

            /** @param rekognitionWriteOnlyAccessPolicy the value to be set. */
            public fun rekognitionWriteOnlyAccessPolicy(
                rekognitionWriteOnlyAccessPolicy: IResolvable
            )
            ...
            public fun rekognitionWriteOnlyAccessPolicy(
                rekognitionWriteOnlyAccessPolicy: CollectionSAMPTProperty.Builder.() -> Unit
            )
            ...
            public fun sesBulkTemplatedCrudPolicy(
                sesBulkTemplatedCrudPolicy: IdentitySAMPTProperty.Builder.() -> Unit
            )
            ...
            public fun sesEmailTemplateCrudPolicy(
                sesEmailTemplateCrudPolicy: EmptySAMPTProperty.Builder.() -> Unit
            )
            ...
            public fun sesSendBouncePolicy(
                sesSendBouncePolicy: IdentitySAMPTProperty.Builder.() -> Unit
            )
            ...
            public fun snsPublishMessagePolicy(
                snsPublishMessagePolicy: TopicSAMPTProperty.Builder.() -> Unit
            )
            ...
            public fun sqsSendMessagePolicy(
                sqsSendMessagePolicy: QueueSAMPTProperty.Builder.() -> Unit
            )
            ...
            public fun ssmParameterReadPolicy(
                ssmParameterReadPolicy: ParameterNameSAMPTProperty.Builder.() -> Unit
            )
            ...
            public fun stepFunctionsExecutionPolicy(
                stepFunctionsExecutionPolicy: StateMachineSAMPTProperty.Builder.() -> Unit
            )
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("9ffbd4cd9871a2be4e64ab12e63267fa255c166e0b0d6ef43ecc8cbe033bad09")
            override fun amiDescribePolicy(
                amiDescribePolicy: EmptySAMPTProperty.Builder.() -> Unit
            ): Unit = amiDescribePolicy(EmptySAMPTProperty(amiDescribePolicy))

            /** @param awsSecretsManagerGetSecretValuePolicy the value to be set. */
            override fun awsSecretsManagerGetSecretValuePolicy(
                awsSecretsManagerGetSecretValuePolicy: IResolvable
            ) {
                cdkBuilder.awsSecretsManagerGetSecretValuePolicy(
                    awsSecretsManagerGetSecretValuePolicy.let(IResolvable::unwrap)
                )
            }
            ...
            override fun awsSecretsManagerGetSecretValuePolicy(
                ...
                cdkBuilder.awsSecretsManagerGetSecretValuePolicy(
                    awsSecretsManagerGetSecretValuePolicy.let(SecretArnSAMPTProperty::unwrap)
                )
            }
            ...
            override fun awsSecretsManagerGetSecretValuePolicy(
                ...
                awsSecretsManagerGetSecretValuePolicy(
                    SecretArnSAMPTProperty(awsSecretsManagerGetSecretValuePolicy)
                )

            /** @param cloudFormationDescribeStacksPolicy the value to be set. */
            override fun cloudFormationDescribeStacksPolicy(
                cloudFormationDescribeStacksPolicy: IResolvable
            ) {
                cdkBuilder.cloudFormationDescribeStacksPolicy(
                    cloudFormationDescribeStacksPolicy.let(IResolvable::unwrap)
                )
            }
            ...
            override fun cloudFormationDescribeStacksPolicy(
                ...
                cdkBuilder.cloudFormationDescribeStacksPolicy(
                    cloudFormationDescribeStacksPolicy.let(EmptySAMPTProperty::unwrap)
                )
            }
            ...
            override fun cloudFormationDescribeStacksPolicy(
                ...
                cloudFormationDescribeStacksPolicy(
                    EmptySAMPTProperty(cloudFormationDescribeStacksPolicy)
                )

            /** @param cloudWatchPutMetricPolicy the value to be set. */
            override fun cloudWatchPutMetricPolicy(cloudWatchPutMetricPolicy: IResolvable) {
                cdkBuilder.cloudWatchPutMetricPolicy(
                    cloudWatchPutMetricPolicy.let(IResolvable::unwrap)
                )
            }
            ...
            override fun cloudWatchPutMetricPolicy(cloudWatchPutMetricPolicy: EmptySAMPTProperty) {
                cdkBuilder.cloudWatchPutMetricPolicy(
                    cloudWatchPutMetricPolicy.let(EmptySAMPTProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("9509da69caaf16883156121d17c04d7a05b63271a89a81c0cc4ba271be1c2c98")
            override fun cloudWatchPutMetricPolicy(
                cloudWatchPutMetricPolicy: EmptySAMPTProperty.Builder.() -> Unit
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("935113a164f96629c0c70d4723120e6b862e21b36e8250e787beac4a4fed1d66")
            override fun dynamoDbCrudPolicy(
                dynamoDbCrudPolicy: TableSAMPTProperty.Builder.() -> Unit
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("df795775dcd23f51c2eb78dea9cb327e0597c5493449edba8fe0fee8d2ac2f6c")
            override fun dynamoDbReadPolicy(
                dynamoDbReadPolicy: TableSAMPTProperty.Builder.() -> Unit
            ...
            override fun dynamoDbStreamReadPolicy(dynamoDbStreamReadPolicy: IResolvable) {
                cdkBuilder.dynamoDbStreamReadPolicy(
                    dynamoDbStreamReadPolicy.let(IResolvable::unwrap)
                )
            }

            /** @param dynamoDbStreamReadPolicy the value to be set. */
            override fun dynamoDbStreamReadPolicy(
                dynamoDbStreamReadPolicy: TableStreamSAMPTProperty
            ) {
                cdkBuilder.dynamoDbStreamReadPolicy(
                    dynamoDbStreamReadPolicy.let(TableStreamSAMPTProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("eac4f77957069da0c1d7201b01975d528d40209d8ec22ee408099551bbb26235")
            override fun dynamoDbWritePolicy(
                dynamoDbWritePolicy: TableSAMPTProperty.Builder.() -> Unit
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("3358ae2a6b4a141aadf79d37e9687c3ecb3dff683100b85b1fe87d041b849249")
            override fun ec2DescribePolicy(
                ec2DescribePolicy: EmptySAMPTProperty.Builder.() -> Unit
            ): Unit = ec2DescribePolicy(EmptySAMPTProperty(ec2DescribePolicy))

            /** @param elasticsearchHttpPostPolicy the value to be set. */
            override fun elasticsearchHttpPostPolicy(elasticsearchHttpPostPolicy: IResolvable) {
                cdkBuilder.elasticsearchHttpPostPolicy(
                    elasticsearchHttpPostPolicy.let(IResolvable::unwrap)
                )
            }

            /** @param elasticsearchHttpPostPolicy the value to be set. */
            override fun elasticsearchHttpPostPolicy(
                elasticsearchHttpPostPolicy: DomainSAMPTProperty
            ) {
                cdkBuilder.elasticsearchHttpPostPolicy(
                    elasticsearchHttpPostPolicy.let(DomainSAMPTProperty::unwrap)
                )
            }
            ...
            override fun filterLogEventsPolicy(filterLogEventsPolicy: LogGroupSAMPTProperty) {
                cdkBuilder.filterLogEventsPolicy(
                    filterLogEventsPolicy.let(LogGroupSAMPTProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("b037880f8ddba38d13afb75f8992889a5dc271580beda09b797f881a7b168ecb")
            override fun filterLogEventsPolicy(
                filterLogEventsPolicy: LogGroupSAMPTProperty.Builder.() -> Unit
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("8eb2a5ca2130fbb3f6a2e49cecef8a2bb4dca12059bf88b8ae43d7e4fbac3658")
            override fun kinesisCrudPolicy(
                kinesisCrudPolicy: StreamSAMPTProperty.Builder.() -> Unit
            ...
            override fun kinesisStreamReadPolicy(kinesisStreamReadPolicy: StreamSAMPTProperty) {
                cdkBuilder.kinesisStreamReadPolicy(
                    kinesisStreamReadPolicy.let(StreamSAMPTProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("978ef2b190e14336006a6f3967e5b88ea48a5ba0f1f65acc399d581b76eb8542")
            override fun kinesisStreamReadPolicy(
                kinesisStreamReadPolicy: StreamSAMPTProperty.Builder.() -> Unit
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("7168eccd84da56f444b947c5e61df8d009f286e3dfeb6639ec02e18448b0062b")
            override fun kmsDecryptPolicy(
                kmsDecryptPolicy: KeySAMPTProperty.Builder.() -> Unit
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("70b8621f04d22d6fb0e05b959568232c57dc4031b9d573f85cf08b14099a96b9")
            override fun lambdaInvokePolicy(
                lambdaInvokePolicy: FunctionSAMPTProperty.Builder.() -> Unit
            ...
            override fun rekognitionDetectOnlyPolicy(rekognitionDetectOnlyPolicy: IResolvable) {
                cdkBuilder.rekognitionDetectOnlyPolicy(
                    rekognitionDetectOnlyPolicy.let(IResolvable::unwrap)
                )
            }

            /** @param rekognitionDetectOnlyPolicy the value to be set. */
            override fun rekognitionDetectOnlyPolicy(
                rekognitionDetectOnlyPolicy: EmptySAMPTProperty
            ) {
                cdkBuilder.rekognitionDetectOnlyPolicy(
                    rekognitionDetectOnlyPolicy.let(EmptySAMPTProperty::unwrap)
                )
            }
            ...
            override fun rekognitionLabelsPolicy(rekognitionLabelsPolicy: EmptySAMPTProperty) {
                cdkBuilder.rekognitionLabelsPolicy(
                    rekognitionLabelsPolicy.let(EmptySAMPTProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("00868a429833f1f938aecab92ea63af6c38b398667dfc9e694dc40bee5036e5b")
            override fun rekognitionLabelsPolicy(
                rekognitionLabelsPolicy: EmptySAMPTProperty.Builder.() -> Unit
            ...
            override fun rekognitionNoDataAccessPolicy(rekognitionNoDataAccessPolicy: IResolvable) {
                cdkBuilder.rekognitionNoDataAccessPolicy(
                    rekognitionNoDataAccessPolicy.let(IResolvable::unwrap)
                )
            }

            /** @param rekognitionNoDataAccessPolicy the value to be set. */
            override fun rekognitionNoDataAccessPolicy(
                rekognitionNoDataAccessPolicy: CollectionSAMPTProperty
            ) {
                cdkBuilder.rekognitionNoDataAccessPolicy(
                    rekognitionNoDataAccessPolicy.let(CollectionSAMPTProperty::unwrap)
                )
            }
            ...
            override fun rekognitionNoDataAccessPolicy(
                ...
                rekognitionNoDataAccessPolicy(
                    CollectionSAMPTProperty(rekognitionNoDataAccessPolicy)
                )
            ...
            override fun rekognitionReadPolicy(rekognitionReadPolicy: CollectionSAMPTProperty) {
                cdkBuilder.rekognitionReadPolicy(
                    rekognitionReadPolicy.let(CollectionSAMPTProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("76955e3338f2d42c224a77804af6c2279ff219c8e3284b60e4b44dbc05e3c493")
            override fun rekognitionReadPolicy(
                rekognitionReadPolicy: CollectionSAMPTProperty.Builder.() -> Unit
            ): Unit = rekognitionReadPolicy(CollectionSAMPTProperty(rekognitionReadPolicy))

            /** @param rekognitionWriteOnlyAccessPolicy the value to be set. */
            override fun rekognitionWriteOnlyAccessPolicy(
                rekognitionWriteOnlyAccessPolicy: IResolvable
            ) {
                cdkBuilder.rekognitionWriteOnlyAccessPolicy(
                    rekognitionWriteOnlyAccessPolicy.let(IResolvable::unwrap)
                )
            }
            ...
            override fun rekognitionWriteOnlyAccessPolicy(
                ...
                cdkBuilder.rekognitionWriteOnlyAccessPolicy(
                    rekognitionWriteOnlyAccessPolicy.let(CollectionSAMPTProperty::unwrap)
                )
            }
            ...
            override fun rekognitionWriteOnlyAccessPolicy(
                ...
                rekognitionWriteOnlyAccessPolicy(
                    CollectionSAMPTProperty(rekognitionWriteOnlyAccessPolicy)
                )
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("56ad47ffacff3038b135034d03ac92e054cd8c281fcf23a0ec23ceaebe9ccab9")
            override fun s3WritePolicy(
                s3WritePolicy: BucketSAMPTProperty.Builder.() -> Unit
            ): Unit = s3WritePolicy(BucketSAMPTProperty(s3WritePolicy))

            /** @param sesBulkTemplatedCrudPolicy the value to be set. */
            override fun sesBulkTemplatedCrudPolicy(sesBulkTemplatedCrudPolicy: IResolvable) {
                cdkBuilder.sesBulkTemplatedCrudPolicy(
                    sesBulkTemplatedCrudPolicy.let(IResolvable::unwrap)
                )
            }

            /** @param sesBulkTemplatedCrudPolicy the value to be set. */
            override fun sesBulkTemplatedCrudPolicy(
                sesBulkTemplatedCrudPolicy: IdentitySAMPTProperty
            ) {
                cdkBuilder.sesBulkTemplatedCrudPolicy(
                    sesBulkTemplatedCrudPolicy.let(IdentitySAMPTProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("44a25b433cf529a3f59b068141b038b318af9e4b8765e69d3bd049f5eda4bcef")
            override fun sesCrudPolicy(
                sesCrudPolicy: IdentitySAMPTProperty.Builder.() -> Unit
            ...
            override fun sesEmailTemplateCrudPolicy(sesEmailTemplateCrudPolicy: IResolvable) {
                cdkBuilder.sesEmailTemplateCrudPolicy(
                    sesEmailTemplateCrudPolicy.let(IResolvable::unwrap)
                )
            }

            /** @param sesEmailTemplateCrudPolicy the value to be set. */
            override fun sesEmailTemplateCrudPolicy(
                sesEmailTemplateCrudPolicy: EmptySAMPTProperty
            ) {
                cdkBuilder.sesEmailTemplateCrudPolicy(
                    sesEmailTemplateCrudPolicy.let(EmptySAMPTProperty::unwrap)
                )
            }
            ...
            override fun sesSendBouncePolicy(sesSendBouncePolicy: IdentitySAMPTProperty) {
                cdkBuilder.sesSendBouncePolicy(
                    sesSendBouncePolicy.let(IdentitySAMPTProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("7ae1e7a4c749d08f5b447e467c03f1402fb93d49c00957bee69bd2cd34d38ac3")
            override fun sesSendBouncePolicy(
                sesSendBouncePolicy: IdentitySAMPTProperty.Builder.() -> Unit
            ...
            override fun snsPublishMessagePolicy(snsPublishMessagePolicy: TopicSAMPTProperty) {
                cdkBuilder.snsPublishMessagePolicy(
                    snsPublishMessagePolicy.let(TopicSAMPTProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("fc55e7590d9b94a5f8c4a2388d03cc95ca0ebed643e7fa78210e83a8e246d861")
            override fun snsPublishMessagePolicy(
                snsPublishMessagePolicy: TopicSAMPTProperty.Builder.() -> Unit
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("7101881b6cbe7ba1feac75c8fbcfd98bebf10bcdc75fbfeff55c0e14d906c982")
            override fun sqsPollerPolicy(
                sqsPollerPolicy: QueueSAMPTProperty.Builder.() -> Unit
            ...
            override fun sqsSendMessagePolicy(sqsSendMessagePolicy: QueueSAMPTProperty) {
                cdkBuilder.sqsSendMessagePolicy(
                    sqsSendMessagePolicy.let(QueueSAMPTProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("3ca4acba6248c758a73866e26d1d6a6b6cdf0020ccb8a9a054bd80eb091dd59e")
            override fun sqsSendMessagePolicy(
                sqsSendMessagePolicy: QueueSAMPTProperty.Builder.() -> Unit
            ...
            /** @param ssmParameterReadPolicy the value to be set. */
            override fun ssmParameterReadPolicy(
                ssmParameterReadPolicy: ParameterNameSAMPTProperty
            ) {
                cdkBuilder.ssmParameterReadPolicy(
                    ssmParameterReadPolicy.let(ParameterNameSAMPTProperty::unwrap)
                )
            }
            ...
            override fun stepFunctionsExecutionPolicy(stepFunctionsExecutionPolicy: IResolvable) {
                cdkBuilder.stepFunctionsExecutionPolicy(
                    stepFunctionsExecutionPolicy.let(IResolvable::unwrap)
                )
            }

            /** @param stepFunctionsExecutionPolicy the value to be set. */
            override fun stepFunctionsExecutionPolicy(
                stepFunctionsExecutionPolicy: StateMachineSAMPTProperty
            ) {
                cdkBuilder.stepFunctionsExecutionPolicy(
                    stepFunctionsExecutionPolicy.let(StateMachineSAMPTProperty::unwrap)
                )
            }
            ...
            override fun stepFunctionsExecutionPolicy(
                ...
                stepFunctionsExecutionPolicy(
                    StateMachineSAMPTProperty(stepFunctionsExecutionPolicy)
                )
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("0617476e5af158f7e65497f2b8d8d8b420129b399f349dc1b88376d3ceb8b976")
            override fun vpcAccessPolicy(
                vpcAccessPolicy: EmptySAMPTProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-serverless-function-sampolicytemplate.html#cfn-serverless-function-sampolicytemplate-cloudwatchputmetricpolicy)
             */
            override fun cloudWatchPutMetricPolicy(): Any? =
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-serverless-function-sampolicytemplate.html#cfn-serverless-function-sampolicytemplate-dynamodbstreamreadpolicy)
             */
            override fun dynamoDbStreamReadPolicy(): Any? =
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-serverless-function-sampolicytemplate.html#cfn-serverless-function-sampolicytemplate-sesbulktemplatedcrudpolicy)
             */
            override fun sesBulkTemplatedCrudPolicy(): Any? =
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-serverless-function-sampolicytemplate.html#cfn-serverless-function-sampolicytemplate-sesemailtemplatecrudpolicy)
             */
            override fun sesEmailTemplateCrudPolicy(): Any? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SAMPolicyTemplateProperty
            ): software.amazon.awscdk.services.sam.CfnFunction.SAMPolicyTemplateProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface HttpApiFunctionAuthProperty {
         ...
         */
        public fun authorizationScopes(): List<String> =
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-serverless-function-httpapifunctionauth.html#cfn-serverless-function-httpapifunctionauth-authorizationscopes)
             */
            override fun authorizationScopes(): List<String> =
                unwrap(this).getAuthorizationScopes() ?: emptyList()
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: HttpApiFunctionAuthProperty
            ): software.amazon.awscdk.services.sam.CfnFunction.HttpApiFunctionAuthProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CollectionSAMPTProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CollectionSAMPTProperty
            ): software.amazon.awscdk.services.sam.CfnFunction.CollectionSAMPTProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface AuthProperty {
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("c9529cdb1fed6991be410cd02514de78b43eac83f9f8a181328666094daef357")
            override fun resourcePolicy(
                resourcePolicy: AuthResourcePolicyProperty.Builder.() -> Unit
    ...
    public interface S3KeyFilterRuleProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: S3KeyFilterRuleProperty
            ): software.amazon.awscdk.services.sam.CfnFunction.S3KeyFilterRuleProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface EventInvokeDestinationConfigProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: EventInvokeDestinationConfigProperty
            ): software.amazon.awscdk.services.sam.CfnFunction.EventInvokeDestinationConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SecretArnSAMPTProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SecretArnSAMPTProperty
            ): software.amazon.awscdk.services.sam.CfnFunction.SecretArnSAMPTProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface RequestParameterProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RequestParameterProperty
            ): software.amazon.awscdk.services.sam.CfnFunction.RequestParameterProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface FunctionEnvironmentProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: FunctionEnvironmentProperty
            ): software.amazon.awscdk.services.sam.CfnFunction.FunctionEnvironmentProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DynamoDBEventProperty {
        ...
        public interface Builder {
            ...
            public fun destinationConfig(
                destinationConfig: DestinationConfigProperty.Builder.() -> Unit
            )
        ...
        private class BuilderImpl : Builder {
            ...
            override fun bisectBatchOnFunctionError(bisectBatchOnFunctionError: IResolvable) {
                cdkBuilder.bisectBatchOnFunctionError(
                    bisectBatchOnFunctionError.let(IResolvable::unwrap)
                )
            }
            ...
            override fun destinationConfig(destinationConfig: DestinationConfigProperty) {
                cdkBuilder.destinationConfig(
                    destinationConfig.let(DestinationConfigProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("dd610d4ec286a5d97e944a76a30a2a842fafee8146a6190f9fce1fc989ef56bd")
            override fun destinationConfig(
                destinationConfig: DestinationConfigProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-serverless-function-dynamodbevent.html#cfn-serverless-function-dynamodbevent-bisectbatchonfunctionerror)
             */
            override fun bisectBatchOnFunctionError(): Any? =
    ...
    public interface AuthResourcePolicyProperty {
         ...
         */
        public fun awsAccountBlacklist(): List<String> =
         ...
         */
        public fun awsAccountWhitelist(): List<String> =
         ...
         */
        public fun intrinsicVpcBlacklist(): List<String> =
         ...
         */
        public fun intrinsicVpcWhitelist(): List<String> =
         ...
         */
        public fun intrinsicVpceBlacklist(): List<String> =
         ...
         */
        public fun intrinsicVpceWhitelist(): List<String> =
         ...
         */
        public fun ipRangeBlacklist(): List<String> =
            unwrap(this).getIpRangeBlacklist() ?: emptyList()
         ...
         */
        public fun ipRangeWhitelist(): List<String> =
            unwrap(this).getIpRangeWhitelist() ?: emptyList()
         ...
         */
        public fun sourceVpcBlacklist(): List<String> =
            unwrap(this).getSourceVpcBlacklist() ?: emptyList()
         ...
         */
        public fun sourceVpcWhitelist(): List<String> =
            unwrap(this).getSourceVpcWhitelist() ?: emptyList()
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-serverless-function-authresourcepolicy.html#cfn-serverless-function-authresourcepolicy-awsaccountblacklist)
             */
            override fun awsAccountBlacklist(): List<String> =
                unwrap(this).getAwsAccountBlacklist() ?: emptyList()

            /**
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-serverless-function-authresourcepolicy.html#cfn-serverless-function-authresourcepolicy-awsaccountwhitelist)
             */
            override fun awsAccountWhitelist(): List<String> =
                unwrap(this).getAwsAccountWhitelist() ?: emptyList()
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-serverless-function-authresourcepolicy.html#cfn-serverless-function-authresourcepolicy-intrinsicvpcblacklist)
             */
            override fun intrinsicVpcBlacklist(): List<String> =
                unwrap(this).getIntrinsicVpcBlacklist() ?: emptyList()

            /**
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-serverless-function-authresourcepolicy.html#cfn-serverless-function-authresourcepolicy-intrinsicvpcwhitelist)
             */
            override fun intrinsicVpcWhitelist(): List<String> =
                unwrap(this).getIntrinsicVpcWhitelist() ?: emptyList()

            /**
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-serverless-function-authresourcepolicy.html#cfn-serverless-function-authresourcepolicy-intrinsicvpceblacklist)
             */
            override fun intrinsicVpceBlacklist(): List<String> =
                unwrap(this).getIntrinsicVpceBlacklist() ?: emptyList()

            /**
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-serverless-function-authresourcepolicy.html#cfn-serverless-function-authresourcepolicy-intrinsicvpcewhitelist)
             */
            override fun intrinsicVpceWhitelist(): List<String> =
                unwrap(this).getIntrinsicVpceWhitelist() ?: emptyList()

            /**
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-serverless-function-authresourcepolicy.html#cfn-serverless-function-authresourcepolicy-iprangeblacklist)
             */
            override fun ipRangeBlacklist(): List<String> =
                unwrap(this).getIpRangeBlacklist() ?: emptyList()

            /**
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-serverless-function-authresourcepolicy.html#cfn-serverless-function-authresourcepolicy-iprangewhitelist)
             */
            override fun ipRangeWhitelist(): List<String> =
                unwrap(this).getIpRangeWhitelist() ?: emptyList()

            /**
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-serverless-function-authresourcepolicy.html#cfn-serverless-function-authresourcepolicy-sourcevpcblacklist)
             */
            override fun sourceVpcBlacklist(): List<String> =
                unwrap(this).getSourceVpcBlacklist() ?: emptyList()

            /**
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-serverless-function-authresourcepolicy.html#cfn-serverless-function-authresourcepolicy-sourcevpcwhitelist)
             */
            override fun sourceVpcWhitelist(): List<String> =
                unwrap(this).getSourceVpcWhitelist() ?: emptyList()
        }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AuthResourcePolicyProperty
            ): software.amazon.awscdk.services.sam.CfnFunction.AuthResourcePolicyProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface EventBridgeRuleEventProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: EventBridgeRuleEventProperty
            ): software.amazon.awscdk.services.sam.CfnFunction.EventBridgeRuleEventProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface FunctionUrlConfigProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: FunctionUrlConfigProperty
            ): software.amazon.awscdk.services.sam.CfnFunction.FunctionUrlConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CloudWatchEventEventProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CloudWatchEventEventProperty
            ): software.amazon.awscdk.services.sam.CfnFunction.CloudWatchEventEventProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ApiEventProperty {
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("589a0e2ee65f9fb0a050563bd1dcbbd68692bf4d0c4e884d6d65cc546d27d8d2")
            override fun auth(auth: AuthProperty.Builder.() -> Unit): Unit =
    ...
    public interface TableStreamSAMPTProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TableStreamSAMPTProperty
            ): software.amazon.awscdk.services.sam.CfnFunction.TableStreamSAMPTProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface EventInvokeConfigProperty {
        ...
        public interface Builder {
            ...
            public fun destinationConfig(
                destinationConfig: EventInvokeDestinationConfigProperty.Builder.() -> Unit
            )
        ...
        private class BuilderImpl : Builder {
            ...
            override fun destinationConfig(
                ...
                cdkBuilder.destinationConfig(
                    destinationConfig.let(EventInvokeDestinationConfigProperty::unwrap)
                )
            }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: EventInvokeConfigProperty
            ): software.amazon.awscdk.services.sam.CfnFunction.EventInvokeConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
