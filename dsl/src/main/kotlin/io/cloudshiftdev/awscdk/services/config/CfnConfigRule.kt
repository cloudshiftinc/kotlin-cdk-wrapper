...
internal constructor(
    ...
    public open fun maximumExecutionFrequency(): String? =
    ...
    public interface Builder {
         ...
         * that ID for the rule name. For more information, see
         ...
         *
         * @param inputParameters A string, in JSON format, that is passed to the AWS Config rule
         *   Lambda function.
         */
         ...
         * Defines which resources can trigger an evaluation for the rule.
         *
         * The scope can include one or more resource types, a combination of one resource type and
         * one resource ID, or a combination of a tag key and value. Specify a scope to constrain
         * the resources that can trigger an evaluation for the rule. If you do not specify a scope,
        ...
        /**
         * Provides the rule owner ( `AWS` for managed rules, `CUSTOM_POLICY` for Custom Policy
         * rules, and `CUSTOM_LAMBDA` for Custom Lambda rules), the rule identifier, and the
         ...
         *
         * @param source Provides the rule owner ( `AWS` for managed rules, `CUSTOM_POLICY` for
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.config.CfnConfigRule =
            cdkBuilder.build()
    }
    ...
    public interface ScopeProperty {
        ...
        public interface Builder {
            /**
             * @param complianceResourceId The ID of the only AWS resource that you want to trigger
             *   an evaluation for the rule. If you specify a resource ID, you must specify one
             *   resource type for `ComplianceResourceTypes` .
             */
            public fun complianceResourceId(complianceResourceId: String)

            /**
             * @param complianceResourceTypes The resource types of only those AWS resources that
             *   you want to trigger an evaluation for the rule. You can only specify one type if
            ...
            /**
             * @param tagValue The tag value applied to only those AWS resources that you want to
             *   trigger an evaluation for the rule. If you specify a value for `TagValue` , you
    ...
    public interface EvaluationModeConfigurationProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: EvaluationModeConfigurationProperty
            ): software.amazon.awscdk.services.config.CfnConfigRule.EvaluationModeConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SourceProperty {
         ...
         *
         * AWS Config Managed Rules are predefined rules owned by AWS . For more information, see
         ...
         * `CUSTOM_POLICY` ) or AWS Lambda ( `CUSTOM_LAMBDA` ). For more information, see
         ...
         *
         * If the owner is set to `CUSTOM_POLICY` , the only acceptable values for the AWS Config
         ...
         * .
         *
         * For AWS Config Custom Lambda rules, the identifier is the Amazon Resource Name (ARN) of
        ...
        public interface Builder {
            /**
             * @param customPolicyDetails Provides the runtime system, policy definition, and
             *   whether debug logging is enabled. Required when owner is set to `CUSTOM_POLICY` .
             */
            ...
            public fun customPolicyDetails(
                customPolicyDetails: CustomPolicyDetailsProperty.Builder.() -> Unit
            )

            /**
             * @param owner Indicates whether AWS or the customer owns and manages the AWS Config
             *   rule. AWS Config Managed Rules are predefined rules owned by AWS . For more
             *   information, see
             *   [AWS Config Managed Rules](https://docs.aws.amazon.com/config/latest/developerguide/evaluate-config_use-managed-rules.html)
             *   in the *AWS Config developer guide* .
             *
            ...
            /**
             * @param sourceDetails Provides the source and the message types that cause AWS Config
             *   to evaluate your AWS resources against a rule. It also provides the frequency with
             *   which you want AWS Config to run evaluations for the rule if the trigger type is
             *   periodic.
             *
             * If the owner is set to `CUSTOM_POLICY` , the only acceptable values for the AWS
             * Config rule trigger message type are `ConfigurationItemChangeNotification` and
             * `OversizedConfigurationItemChangeNotification` .
             */
            ...
            /**
             * @param sourceIdentifier For AWS Config Managed rules, a predefined identifier from a
             *   list. For example, `IAM_PASSWORD_POLICY` is a managed rule. To reference a managed
             *   rule, see
             *   [List of AWS Config Managed Rules](https://docs.aws.amazon.com/config/latest/developerguide/managed-rules-by-aws-config.html)
             *   .
             *
             * For AWS Config Custom Lambda rules, the identifier is the Amazon Resource Name (ARN)
        ...
        private class BuilderImpl : Builder {
            ...
            override fun customPolicyDetails(customPolicyDetails: CustomPolicyDetailsProperty) {
                cdkBuilder.customPolicyDetails(
                    customPolicyDetails.let(CustomPolicyDetailsProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("196cd2034ed6c9f8d93d514180a07bb627d9af41ecd9db175ead0b5f36cdcbc0")
            override fun customPolicyDetails(
                customPolicyDetails: CustomPolicyDetailsProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * Indicates whether AWS or the customer owns and manages the AWS Config rule.
             *
             * AWS Config Managed Rules are predefined rules owned by AWS . For more information,
             * see
             * [AWS Config Managed Rules](https://docs.aws.amazon.com/config/latest/developerguide/evaluate-config_use-managed-rules.html)
             * in the *AWS Config developer guide* .
             *
             ...
             * resources against a rule.
             *
             * It also provides the frequency with which you want AWS Config to run evaluations for
    ...
    public interface SourceDetailProperty {
         ...
         * value. For example, if you choose `Three_Hours` , AWS Config runs evaluations once every
        ...
        public interface Builder {
             ...
             *   evaluations for a custom rule with a periodic trigger. If you specify a value for
            ...
            /**
             * @param messageType The type of notification that triggers AWS Config to run an
             *   evaluation for a rule. You can specify the following notification types:
        ...
        internal constructor(
             ...
             * a periodic trigger.
             *
             * If you specify a value for `MaximumExecutionFrequency` , then `MessageType` must use
    ...
    public interface CustomPolicyDetailsProperty {
        ...
        public interface Builder {
            /**
             * @param enableDebugLogDelivery The boolean expression for enabling debug logging for
             *   your AWS Config Custom Policy rule. The default value is `false` .
             */
            ...
            /**
             * @param policyRuntime The runtime system for your AWS Config Custom Policy rule. Guard
             *   is a policy-as-code language that allows you to write policies that are enforced by
             *   AWS Config Custom Policy rules. For more information about Guard, see the
             *   [Guard GitHub Repository](https://docs.aws.amazon.com/https://github.com/aws-cloudformation/cloudformation-guard)
             *   .
             */
            ...
            /**
             * @param policyText The policy definition containing the logic for your AWS Config
             *   Custom Policy rule.
             */
        ...
        internal constructor(
            ...
            /**
             * The boolean expression for enabling debug logging for your AWS Config Custom Policy
             * rule.
             *
             * The default value is `false` .
             *
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CustomPolicyDetailsProperty
            ): software.amazon.awscdk.services.config.CfnConfigRule.CustomPolicyDetailsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ComplianceProperty {
         ...
         *
         * A resource is compliant if it complies with all of the AWS Config rules that evaluate it.
         * A resource is noncompliant if it does not comply with one or more of these rules.
         *
        ...
        public interface Builder {
            /**
             * @param type Indicates whether an AWS resource or AWS Config rule is compliant. A
             *   resource is compliant if it complies with all of the AWS Config rules that evaluate
