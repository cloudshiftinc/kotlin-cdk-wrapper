...
internal constructor(
    ...
    public interface Builder {
         ...
         * For private workforces created using Amazon Cognito use `CognitoMemberDefinition` . For
         ...
         *
         * @param notificationConfiguration Configures SNS notifications of available or expiring
         *   work items for work teams.
         */
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.sagemaker.CfnWorkteam =
            cdkBuilder.build()
    }
    ...
    public companion object {
        ...
        ): CfnWorkteam = CfnWorkteam(cdkObject)

        internal fun unwrap(
            wrapped: CfnWorkteam
        ): software.amazon.awscdk.services.sagemaker.CfnWorkteam = wrapped.cdkObject
    }
    ...
    public interface NotificationConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param notificationTopicArn The ARN for the Amazon SNS topic to which notifications
             *   should be published.
             */
    ...
    public interface CognitoMemberDefinitionProperty {
        ...
        public interface Builder {
            /**
             * @param cognitoClientId An identifier for an application client. You must create the
            ...
            /**
             * @param cognitoUserPool An identifier for a user pool. The user pool must be in the
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CognitoMemberDefinitionProperty
            ): software.amazon.awscdk.services.sagemaker.CfnWorkteam.CognitoMemberDefinitionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface OidcMemberDefinitionProperty {
        ...
        private class BuilderImpl : Builder {
            ...
            /** @param oidcGroups the value to be set. */
            override fun oidcGroups(vararg oidcGroups: String): Unit =
                oidcGroups(oidcGroups.toList())
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: OidcMemberDefinitionProperty
            ): software.amazon.awscdk.services.sagemaker.CfnWorkteam.OidcMemberDefinitionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface MemberDefinitionProperty {
         ...
         * group to the list of `Groups` , you can add that user group to one or more private work
         * teams. If you add a user group to a private work team, all workers in that user group are
        ...
        public interface Builder {
            /**
             * @param cognitoMemberDefinition The Amazon Cognito user group that is part of the work
             *   team.
             */
             ...
             *   team.
             */
            public fun cognitoMemberDefinition(
            ...
            public fun cognitoMemberDefinition(
                cognitoMemberDefinition: CognitoMemberDefinitionProperty.Builder.() -> Unit
            )

            /**
             * @param oidcMemberDefinition A list user groups that exist in your OIDC Identity
             *   Provider (IdP). One to ten groups can be used to create a single private work team.
             *   When you add a user group to the list of `Groups` , you can add that user group to
             *   one or more private work teams. If you add a user group to a private work team, all
            ...
            public fun oidcMemberDefinition(
                oidcMemberDefinition: OidcMemberDefinitionProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
             ...
             *   team.
             */
            override fun cognitoMemberDefinition(
                cognitoMemberDefinition: CognitoMemberDefinitionProperty
            ) {
                cdkBuilder.cognitoMemberDefinition(
                    cognitoMemberDefinition.let(CognitoMemberDefinitionProperty::unwrap)
                )
            }
            ...
            override fun cognitoMemberDefinition(
                ...
                cognitoMemberDefinition(CognitoMemberDefinitionProperty(cognitoMemberDefinition))
            ...
            override fun oidcMemberDefinition(oidcMemberDefinition: OidcMemberDefinitionProperty) {
                cdkBuilder.oidcMemberDefinition(
                    oidcMemberDefinition.let(OidcMemberDefinitionProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("8713a5a802d8145a000b18d1466ed8dc1e9bae556ce03ee06a10d3f28b790da9")
            override fun oidcMemberDefinition(
                oidcMemberDefinition: OidcMemberDefinitionProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * A list user groups that exist in your OIDC Identity Provider (IdP).
             *
             * One to ten groups can be used to create a single private work team. When you add a
             * user group to the list of `Groups` , you can add that user group to one or more
             * private work teams. If you add a user group to a private work team, all workers in
             * that user group are added to the work team.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-sagemaker-workteam-memberdefinition.html#cfn-sagemaker-workteam-memberdefinition-oidcmemberdefinition)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: MemberDefinitionProperty
            ): software.amazon.awscdk.services.sagemaker.CfnWorkteam.MemberDefinitionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
