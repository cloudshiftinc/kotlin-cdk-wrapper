...
internal constructor(
     ...
     * [io.cloudshiftdev.awscdk.services.ecs.patterns.QueueProcessingEc2Service].
     */
    @CdkDslMarker
    public interface Builder {
         ...
         *
         * Subsequent scale outs during the cooldown period are squashed so that only the biggest
         * scale out happens.
         *
         ...
         * Default: - false
         *
         * @param disableCpuBasedScaling Flag to disable CPU based auto scaling strategy on the
         *   service.
         */
         ...
         *
         * For `QueueProcessingFargateService`, either `image` or `taskDefinition` must be
         * specified, but not both. For `QueueProcessingEc2Service`, `image` is required.
         *
         ...
         *
         * When this value is exceeded for a message the message will be automatically sent to the
         * Dead Letter Queue.
         *
        ...
        /**
         * The intervals for scaling based on the SQS queue's ApproximateNumberOfMessagesVisible
         * metric.
         *
         ...
         * Values must be between 0 and (12 hours).
         *
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.ecs.patterns.QueueProcessingEc2Service.Builder.create(
                scope,
                id
            )
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: QueueProcessingEc2Service
