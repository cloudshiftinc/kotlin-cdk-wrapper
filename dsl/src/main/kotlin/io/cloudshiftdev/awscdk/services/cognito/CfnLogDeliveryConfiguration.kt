...
internal constructor(
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.cognito.CfnLogDeliveryConfiguration.Builder.create(
                scope,
                id
            )
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnLogDeliveryConfiguration
    ...
    public interface LogConfigurationProperty {
        ...
        public interface Builder {
            ...
            public fun cloudWatchLogsConfiguration(
                cloudWatchLogsConfiguration: CloudWatchLogsConfigurationProperty.Builder.() -> Unit
            )

            /**
             * @param eventSource The source of events that your user pool sends for detailed
             *   activity logging.
             */
            public fun eventSource(eventSource: String)

            /**
             * @param logLevel The `errorlevel` selection of logs that a user pool sends for
        ...
        private class BuilderImpl : Builder {
            ...
            override fun cloudWatchLogsConfiguration(cloudWatchLogsConfiguration: IResolvable) {
                cdkBuilder.cloudWatchLogsConfiguration(
                    cloudWatchLogsConfiguration.let(IResolvable::unwrap)
                )
            }
             ...
             *   detailed activity logging configuration.
             */
            override fun cloudWatchLogsConfiguration(
                cloudWatchLogsConfiguration: CloudWatchLogsConfigurationProperty
            ) {
                cdkBuilder.cloudWatchLogsConfiguration(
                    cloudWatchLogsConfiguration.let(CloudWatchLogsConfigurationProperty::unwrap)
                )
            }
            ...
            override fun cloudWatchLogsConfiguration(
                ...
                cloudWatchLogsConfiguration(
                    CloudWatchLogsConfigurationProperty(cloudWatchLogsConfiguration)
                )
    ...
    public interface CloudWatchLogsConfigurationProperty {
         ...
         * logs.
         *
         * The log group must not be encrypted with AWS Key Management Service and must be in the
         * same AWS account as your user pool.
         *
         * To send logs to log groups with a resource policy of a size greater than 5120 characters,
         * configure a log group with a path that starts with `/aws/vendedlogs` . For more
         * information, see
        ...
        public interface Builder {
            /**
             * @param logGroupArn The Amazon Resource Name (arn) of a CloudWatch Logs log group
             *   where your user pool sends logs. The log group must not be encrypted with AWS Key
             *   Management Service and must be in the same AWS account as your user pool.
             *
        ...
        internal constructor(
             ...
             * sends logs.
             *
             * The log group must not be encrypted with AWS Key Management Service and must be in
             * the same AWS account as your user pool.
             *
             * To send logs to log groups with a resource policy of a size greater than 5120
             * characters, configure a log group with a path that starts with `/aws/vendedlogs` .
             * For more information, see
