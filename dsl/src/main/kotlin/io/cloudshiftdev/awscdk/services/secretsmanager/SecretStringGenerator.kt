...
public interface SecretStringGenerator {
     ...
     *
     * The `generateStringKey` is combined with the generated random string and inserted into the
     * JSON structure that's specified by this parameter. The merged JSON string is returned as the
     * completed SecretString of the secret. If you specify `secretStringTemplate` then
     * `generateStringKey` must be also be specified.
     */
    ...
    public interface Builder {
        /**
         * @param excludeCharacters A string that includes characters that shouldn't be included in
         *   the generated password. The string can be a minimum of `0` and a maximum of `4096`
         *   characters long.
         */
        ...
        /**
         * @param excludePunctuation Specifies that the generated password shouldn't include
        ...
        /**
         * @param generateStringKey The JSON key name that's used to add the generated password to
         *   the JSON structure specified by the `secretStringTemplate` parameter. If you specify
        ...
        /**
         * @param includeSpace Specifies that the generated password can include the space
         *   character.
         */
        ...
        /**
         * @param requireEachIncludedType Specifies whether the generated password must include at
         *   least one of every allowed character type.
         */
        public fun requireEachIncludedType(requireEachIncludedType: Boolean)

        /**
         * @param secretStringTemplate A properly structured JSON string that the generated password
         *   can be added to. The `generateStringKey` is combined with the generated random string
         *   and inserted into the JSON structure that's specified by this parameter. The merged
         *   JSON string is returned as the completed SecretString of the secret. If you specify
    ...
    internal constructor(
         ...
         * specified by the `secretStringTemplate` parameter.
         *
         * If you specify `generateStringKey` then `secretStringTemplate` must be also be specified.
         */
         ...
         * A properly structured JSON string that the generated password can be added to.
         *
         * The `generateStringKey` is combined with the generated random string and inserted into
         * the JSON structure that's specified by this parameter. The merged JSON string is returned
         * as the completed SecretString of the secret. If you specify `secretStringTemplate` then
         * `generateStringKey` must be also be specified.
         */
