...
public interface ILogGroup : IResourceWithPolicy {
     ...
     */
    public fun addSubscriptionFilter(
        id: String,
    ...
    internal constructor(
         ...
         * @param props Properties for creating the LogStream.
         */
        override fun addStream(id: String): LogStream =
         ...
         * @param props Properties for creating the SubscriptionFilter.
         */
        override fun addSubscriptionFilter(
            id: String,
            props: SubscriptionFilterOptions
        ): SubscriptionFilter =
            unwrap(this)
         ...
         * field in all records where it occurs.
         *
         * The metric will be available in CloudWatch Metrics under the indicated namespace and
         * name.
         *
         * @param jsonField JSON field to extract (example: '$.myfield').
         * @param metricNamespace Namespace to emit the metric under.
        ...
        override fun extractMetric(
            ...
            unwrap(this).extractMetric(jsonField, metricNamespace, metricName).let(Metric::wrap)
