...
internal constructor(
     ...
     * @param props
     */
    public open fun addModel(id: String, props: ModelOptions): Model =
        unwrap(this).addModel(id, props.let(ModelOptions::unwrap)).let(Model::wrap)
    ...
    public open fun addModel(id: String, props: ModelOptions.Builder.() -> Unit): Model =
        addModel(id, ModelOptions(props))
     ...
     * @param props
     */
    public open fun addRequestValidator(
        id: String,
        props: RequestValidatorOptions
    ): RequestValidator =
        unwrap(this)
            .addRequestValidator(id, props.let(RequestValidatorOptions::unwrap))
            .let(RequestValidator::wrap)
    ...
    public open fun addRequestValidator(
        id: String,
        props: RequestValidatorOptions.Builder.() -> Unit
    ): RequestValidator = addRequestValidator(id, RequestValidatorOptions(props))
    ...
    public interface Builder {
         ...
         *
         * @param apiKeySourceType The source of the API key for metering requests according to a
         *   usage plan.
         */
         ...
         *
         * @param binaryMediaTypes The list of binary media mime-types that are supported by the
         *   RestApi resource, such as "image/png" or "application/octet-stream".
         */
        ...
        /**
         * The removal policy applied to the AWS CloudWatch role when this resource is removed from
         * the application.
         *
         ...
         *
         * @param cloudWatchRoleRemovalPolicy The removal policy applied to the AWS CloudWatch role
         *   when this resource is removed from the application.
         */
        ...
        /**
         * Indicates if a Deployment should be automatically created for this API, and recreated
         * when the API model (resources, methods) changes.
         *
         * Since API Gateway deployments are immutable, When this option is enabled (by default), an
         * AWS::ApiGateway::Deployment resource will automatically created with a logical ID that
         * hashes the API model (methods, resources and options). This means that when the model
         * changes, the logical ID of this CloudFormation resource will change, and a new deployment
         * will be created.
         *
         * If this is set, `latestDeployment` will refer to the `Deployment` object and
         * `deploymentStage` will refer to a `Stage` that points to this deployment. To customize
         * the stage options, use the `deployOptions` property.
         *
         ...
         *
         * @param deployOptions Options for the API Gateway stage that will always point to the
         *   latest deployment when `deploy` is enabled.
         */
         ...
         *
         * Default: - no domain name is defined, use `addDomainName` or directly define a
         * `DomainName`.
         *
         ...
         *
         * @param endpointConfiguration The EndpointConfiguration property type specifies the
         *   endpoint types of a REST API.
         */
        ...
        public fun endpointConfiguration(
            endpointConfiguration: EndpointConfiguration.Builder.() -> Unit
        )
        ...
        /**
         * Indicates whether to roll back the resource if a warning occurs while API Gateway is
         * creating the RestApi resource.
         *
         * Default: false
         *
         * @param failOnWarnings Indicates whether to roll back the resource if a warning occurs
         *   while API Gateway is creating the RestApi resource.
         */
         ...
         *
         * @param minCompressionSize A Size(in bytes, kibibytes, mebibytes etc) that is used to
         *   enable compression (with non-negative between 0 and 10485760 (10M) bytes, inclusive) or
         *   disable compression (when undefined) on an API.
         */
        public fun minCompressionSize(minCompressionSize: Size)

        /**
         * (deprecated) A nullable integer that is used to enable compression (with non-negative
         * between 0 and 10485760 (10M) bytes, inclusive) or disable compression (when undefined) on
         * an API.
         *
         * When compression is enabled, compression or decompression is not applied on the payload
         * if the payload size is smaller than this value. Setting it to zero allows compression for
    ...
    private class BuilderImpl(
        ...
        override fun cloudWatchRoleRemovalPolicy(cloudWatchRoleRemovalPolicy: RemovalPolicy) {
            cdkBuilder.cloudWatchRoleRemovalPolicy(
                cloudWatchRoleRemovalPolicy.let(RemovalPolicy::unwrap)
            )
        }
        ...
        override fun endpointConfiguration(endpointConfiguration: EndpointConfiguration) {
            cdkBuilder.endpointConfiguration(
                endpointConfiguration.let(EndpointConfiguration::unwrap)
            )
        }
    ...
    public companion object {
        public fun fromRestApiAttributes(
            ...
            software.amazon.awscdk.services.apigateway.RestApi.fromRestApiAttributes(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    attrs.let(RestApiAttributes::unwrap)
                )
                .let(IRestApi::wrap)
        ...
        public fun fromRestApiId(
            ...
            software.amazon.awscdk.services.apigateway.RestApi.fromRestApiId(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    restApiId
                )
