...
internal constructor(
    ...
    public override fun addPermission(
        name: String,
        permission: Permission.Builder.() -> Unit
    ): Unit = addPermission(name, Permission(permission))
     ...
     * initializing the `lambda.SingletonFunction`.
     */
    ...
    public interface Builder {
         ...
         * name. The combination of lambdaPurpose and uuid must be unique.
         *
         ...
         *
         * The identifier should be unique across all custom resource providers. We recommend
         * generating a UUID per provider.
         *
