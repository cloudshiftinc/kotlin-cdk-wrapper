...
internal constructor(
    ...
    public interface Builder {
         ...
         * The name of the custom metric.
         *
         * This will be used in the metric report submitted from the device/thing. The name can't
         ...
         * metrics value in the DeviceMetrics report, you must pass it as an array with a single
         * value.
         *
