...
internal constructor(
     ...
     * or explicitly exclude them.
     */
    public open fun resourceTags(vararg __idx_ac66f0: Any): Unit =
        resourceTags(__idx_ac66f0.toList())
    ...
    public open fun resourceTypeList(): List<String> =
        unwrap(this).getResourceTypeList() ?: emptyList()
    ...
    public open fun securityServicePolicyData(`value`: SecurityServicePolicyDataProperty) {
        unwrap(this)
            .setSecurityServicePolicyData(`value`.let(SecurityServicePolicyDataProperty::unwrap))
    }

    /** Details about the security service that is being used to protect the resources. */
    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("1ba9b3b101a2f14f2a035ec72d41466b590f563c22e74c228b813fe7f551a4f0")
    public open fun securityServicePolicyData(
        `value`: SecurityServicePolicyDataProperty.Builder.() -> Unit
    ...
    public interface Builder {
        /**
         * Used when deleting a policy. If `true` , Firewall Manager performs cleanup according to
         * the policy type.
         *
         ...
         *
         * For security group policies, Firewall Manager does the following for each security group
         * in the policy:
         ...
         * you specify that only resources in specific accounts or with specific tags are in scope
         ...
         * and does not evaluate any `ExcludeMap` specifications. If you do not specify an
         * `IncludeMap` , then Firewall Manager applies the policy to all accounts except for those
         * specified by the `ExcludeMap` .
         *
         * You can specify account IDs, OUs, or a combination:
         * * Specify account IDs by setting the key to `ACCOUNT` . For example, the following is a
         *   valid map: `{“ACCOUNT” : [“accountID1”, “accountID2”]}` .
         * * Specify OUs by setting the key to `ORGUNIT` . For example, the following is a valid
         *   map: `{“ORGUNIT” : [“ouid111”, “ouid112”]}` .
         * * Specify accounts and OUs together in a single map, separated with a comma. For example,
         *   the following is a valid map: `{“ACCOUNT” : [“accountID1”, “accountID2”], “ORGUNIT” :
         *   [“ouid111”, “ouid112”]}` .
         *
         ...
         *
         * @param excludeMap Specifies the AWS account IDs and AWS Organizations organizational
         *   units (OUs) to exclude from the policy.
         */
         ...
         * policy. If it's `False` , only resources with the specified tags are in scope of the
         * policy.
         *
         ...
         *
         * @param excludeResourceTags Used only when tags are specified in the `ResourceTags`
         *   property.
         */
        ...
        /**
         * Specifies the AWS account IDs and AWS Organizations organizational units (OUs) to include
         * in the policy.
         *
         * Specifying an OU is the equivalent of specifying all accounts in the OU and in any of its
         * child OUs, including any child OUs and accounts that are added at a later time.
         ...
         *
         * @param includeMap Specifies the AWS account IDs and AWS Organizations organizational
         *   units (OUs) to include in the policy.
         */
        ...
        /**
         * An array of `ResourceTag` objects, used to explicitly include resources in the policy
         * scope or explicitly exclude them.
         *
         ...
         *
         * @param resourceTags An array of `ResourceTag` objects, used to explicitly include
         *   resources in the policy scope or explicitly exclude them.
         */
        ...
        /**
         * Indicates whether AWS Firewall Manager should automatically remove protections from
         * resources that leave the policy scope and clean up resources that Firewall Manager is
         * managing for accounts when those accounts leave policy scope.
         *
         ...
         *
         * @param resourcesCleanUp Indicates whether AWS Firewall Manager should automatically
         *   remove protections from resources that leave the policy scope and clean up resources
         *   that Firewall Manager is managing for accounts when those accounts leave policy scope.
         */
         ...
         *   policy and for each content audit policy. This is an adjustable limit that you can
         ...
         * * ManagedServiceData - Details about the service that are specific to the service type,
         *   in JSON format.
         ...
         * Availability Zones to create the endpoints in. To use the distributed deployment model,
         * you must set
         * [FirewallDeploymentModel](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-fms-policy-networkfirewallpolicy.html)
         * to `DISTRIBUTED` .
         * * Example: `NETWORK_FIREWALL` - Distributed deployment model with automatic Availability
         ...
         * [FirewallDeploymentModel](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-fms-policy-networkfirewallpolicy.html)
         * to `DISTRIBUTED` .
         * * Example: `NETWORK_FIREWALL` - Distributed deployment model with custom Availability
         *   Zone configuration
         *
         ...
         * to create endpoints in by configuring `firewallCreationConfig` . To configure the
         * Availability Zones in `firewallCreationConfig` , specify either the
         ...
         * * Example: `WAFV2` - AWS Firewall Manager support for AWS WAF managed rule group
         *   versioning
         *
         * `"{\"type\":\"WAFV2\",\"preProcessRuleGroups\":[{\"ruleGroupArn\":null,\"overrideAction\":{\"type\":\"NONE\"},\"managedRuleGroupIdentifier\":{\"versionEnabled\":true,\"version\":\"Version_2.0\",\"vendorName\":\"AWS\",\"managedRuleGroupName\":\"AWSManagedRulesCommonRuleSet\"},\"ruleGroupType\":\"ManagedRuleGroup\",\"excludeRules\":[{\"name\":\"NoUserAgent_HEADER\"}]}],\"postProcessRuleGroups\":[],\"defaultAction\":{\"type\":\"ALLOW\"},\"overrideCustomerWebACLAssociation\":false,\"loggingConfiguration\":{\"logDestinationConfigs\":[\"arn:aws:firehose:us-west-2:12345678912:deliverystream/aws-waf-logs-fms-admin-destination\"],\"redactedFields\":[{\"redactedFieldType\":\"SingleHeader\",\"redactedFieldValue\":\"Cookies\"},{\"redactedFieldType\":\"Method\"}]}}"`
         *
         * To use a specific version of a AWS WAF managed rule group in your Firewall Manager
         * policy, you must set `versionEnabled` to `true` , and set `version` to the version you'd
         * like to use. If you don't set `versionEnabled` to `true` , or if you omit
         * `versionEnabled` , then Firewall Manager uses the default version of the AWS WAF managed
         * rule group.
         ...
         * in-scope security group rules must be within the allowed range of the policy's security
        ...
        public fun securityServicePolicyData(
            securityServicePolicyData: SecurityServicePolicyDataProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
         ...
         *   protect the resources.
         */
        override fun securityServicePolicyData(
            securityServicePolicyData: SecurityServicePolicyDataProperty
        ) {
            cdkBuilder.securityServicePolicyData(
                securityServicePolicyData.let(SecurityServicePolicyDataProperty::unwrap)
            )
        }
    ...
    public interface PolicyTagProperty {
         ...
         * Part of the key:value pair that defines a tag.
         *
         * You can use a tag value to describe a specific value within a category, such as
        ...
        public interface Builder {
            /**
             * @param key Part of the key:value pair that defines a tag. You can use a tag key to
            ...
            /**
             * @param value Part of the key:value pair that defines a tag. You can use a tag value
        ...
        internal constructor(
             ...
             * Part of the key:value pair that defines a tag.
             *
             * You can use a tag key to describe a category of information, such as "customer." Tag
    ...
    public interface ThirdPartyFirewallPolicyProperty {
        ...
        public interface Builder {
            /**
             * @param firewallDeploymentModel Defines the deployment model to use for the
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-fms-policy-thirdpartyfirewallpolicy.html#cfn-fms-policy-thirdpartyfirewallpolicy-firewalldeploymentmodel)
             */
            override fun firewallDeploymentModel(): String =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ThirdPartyFirewallPolicyProperty
            ): software.amazon.awscdk.services.fms.CfnPolicy.ThirdPartyFirewallPolicyProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface PolicyOptionProperty {
        ...
        public interface Builder {
            /**
             * @param networkFirewallPolicy Defines the deployment model to use for the firewall
             *   policy.
             */
            ...
            public fun networkFirewallPolicy(
                networkFirewallPolicy: NetworkFirewallPolicyProperty.Builder.() -> Unit
            )
            ...
            public fun thirdPartyFirewallPolicy(
                thirdPartyFirewallPolicy: ThirdPartyFirewallPolicyProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
             ...
             *   policy.
             */
            override fun networkFirewallPolicy(
                networkFirewallPolicy: NetworkFirewallPolicyProperty
            ) {
                cdkBuilder.networkFirewallPolicy(
                    networkFirewallPolicy.let(NetworkFirewallPolicyProperty::unwrap)
                )
            }
            ...
            override fun thirdPartyFirewallPolicy(thirdPartyFirewallPolicy: IResolvable) {
                cdkBuilder.thirdPartyFirewallPolicy(
                    thirdPartyFirewallPolicy.let(IResolvable::unwrap)
                )
            }
             ...
             *   policy.
             */
            override fun thirdPartyFirewallPolicy(
                thirdPartyFirewallPolicy: ThirdPartyFirewallPolicyProperty
            ) {
                cdkBuilder.thirdPartyFirewallPolicy(
                    thirdPartyFirewallPolicy.let(ThirdPartyFirewallPolicyProperty::unwrap)
                )
            }
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-fms-policy-policyoption.html#cfn-fms-policy-policyoption-thirdpartyfirewallpolicy)
             */
            override fun thirdPartyFirewallPolicy(): Any? =
    ...
    public interface SecurityServicePolicyDataProperty {
         ...
         * Advanced policy, or a security group policy. For security group policies, Firewall
         * Manager supports one security group for each common policy and for each content audit
         * policy. This is an adjustable limit that you can increase by contacting AWS Support .
         *
        ...
        public interface Builder {
            /**
             * @param managedServiceData Details about the service that are specific to the service
             *   type, in JSON format.
             * * Example: `DNS_FIREWALL`
             *
             * `"{\"type\":\"DNS_FIREWALL\",\"preProcessRuleGroups\":[{\"ruleGroupId\":\"rslvr-frg-1\",\"priority\":10}],\"postProcessRuleGroups\":[{\"ruleGroupId\":\"rslvr-frg-2\",\"priority\":9911}]}"`
             ...
             * Zones to create endpoints in by configuring `firewallCreationConfig` . To configure
             * the Availability Zones in `firewallCreationConfig` , specify either the
             * `availabilityZoneName` or `availabilityZoneId` parameter, not both parameters.
             *
             * To use the distributed deployment model, you must set
             * [FirewallDeploymentModel](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-fms-policy-networkfirewallpolicy.html)
             ...
             * `versionEnabled` , then Firewall Manager uses the default version of the AWS WAF
             * managed rule group.
             * * Example: `SECURITY_GROUPS_COMMON`
             *
             * `"{\"type\":\"SECURITY_GROUPS_COMMON\",\"revertManualSecurityGroupChanges\":false,\"exclusiveResourceSecurityGroupManagement\":false,
            ...
            /**
             * @param policyOption Contains the Network Firewall firewall policy options to
             *   configure a centralized deployment model.
             */
            ...
            /**
             * @param type The service that the policy is using to protect the resources. This
             *   specifies the type of policy that is created, either an AWS WAF policy, a Shield
             *   Advanced policy, or a security group policy. For security group policies, Firewall
             *   Manager supports one security group for each common policy and for each content
             *   audit policy. This is an adjustable limit that you can increase by contacting AWS
             *   Support .
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SecurityServicePolicyDataProperty
            ): software.amazon.awscdk.services.fms.CfnPolicy.SecurityServicePolicyDataProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface NetworkFirewallPolicyProperty {
        ...
        public interface Builder {
            /**
             * @param firewallDeploymentModel Defines the deployment model to use for the firewall
             *   policy.
             *
             * To use a distributed model, set
             * [FirewallDeploymentModel](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-fms-policy-thirdpartyfirewallpolicy.html)
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: NetworkFirewallPolicyProperty
            ): software.amazon.awscdk.services.fms.CfnPolicy.NetworkFirewallPolicyProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
