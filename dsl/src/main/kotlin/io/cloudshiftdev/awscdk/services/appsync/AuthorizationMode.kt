...
public interface AuthorizationMode {
     ...
     */
    public fun apiKeyConfig(): ApiKeyConfig? =
    ...
    public interface Builder {
        /**
         * @param apiKeyConfig If authorizationType is `AuthorizationType.API_KEY`, this option can
         *   be configured.
         */
        ...
        /**
         * @param lambdaAuthorizerConfig If authorizationType is `AuthorizationType.LAMBDA`, this
         *   option is required.
         */
        ...
        public fun lambdaAuthorizerConfig(
            lambdaAuthorizerConfig: LambdaAuthorizerConfig.Builder.() -> Unit
        )

        /**
         * @param openIdConnectConfig If authorizationType is `AuthorizationType.OIDC`, this option
         *   is required.
         */
        ...
        /**
         * @param userPoolConfig If authorizationType is `AuthorizationType.USER_POOL`, this option
         *   is required.
         */
    ...
    private class BuilderImpl : Builder {
        ...
        override fun lambdaAuthorizerConfig(lambdaAuthorizerConfig: LambdaAuthorizerConfig) {
            cdkBuilder.lambdaAuthorizerConfig(
                lambdaAuthorizerConfig.let(LambdaAuthorizerConfig::unwrap)
            )
        }
        ...
        override fun openIdConnectConfig(
            openIdConnectConfig: OpenIdConnectConfig.Builder.() -> Unit
