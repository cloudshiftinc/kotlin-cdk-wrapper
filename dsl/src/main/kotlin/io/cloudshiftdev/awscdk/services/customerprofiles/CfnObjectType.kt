...
internal constructor(
    ...
    public interface Builder {
         ...
         * service tries to fetch a standard profile and associate this object with the profile. If
         * it is set to `TRUE` , and if no match is found, then the service creates a new standard
         * profile.
         *
         ...
         *
         * @param sourceLastUpdatedTimestampFormat The format of your sourceLastUpdatedTimestamp
    ...
    public interface ObjectTypeKeyProperty {
         ...
         *
         * Each ProfileObject can have only 1 UNIQUE key but multiple PROFILE keys. PROFILE means
         * that this key can be used to tie an object to a PROFILE. UNIQUE means that it can be used
         * to uniquely identify an object. If a key a is marked as SECONDARY, it will be used to
         * search for profiles after all other PROFILE keys have been searched. A LOOKUP_ONLY key is
         * only used to match a profile but is not persisted to be used for searching of the
         * profile. A NEW_ONLY key is only used if the profile does not already exist before the
         ...
         */
        public fun standardIdentifiers(): List<String> =
        ...
        public interface Builder {
            ...
            /**
             * @param standardIdentifiers The types of keys that a ProfileObject can have. Each
             *   ProfileObject can have only 1 UNIQUE key but multiple PROFILE keys. PROFILE means
             *   that this key can be used to tie an object to a PROFILE. UNIQUE means that it can
             *   be used to uniquely identify an object. If a key a is marked as SECONDARY, it will
             *   be used to search for profiles after all other PROFILE keys have been searched. A
             *   LOOKUP_ONLY key is only used to match a profile but is not persisted to be used for
             *   searching of the profile. A NEW_ONLY key is only used if the profile does not
        ...
        private class BuilderImpl : Builder {
            ...
            /** @param fieldNames The reference for the key name of the fields map. */
            override fun fieldNames(vararg fieldNames: String): Unit =
        ...
        internal constructor(
             ...
             * The types of keys that a ProfileObject can have.
             *
             * Each ProfileObject can have only 1 UNIQUE key but multiple PROFILE keys. PROFILE
             * means that this key can be used to tie an object to a PROFILE. UNIQUE means that it
             * can be used to uniquely identify an object. If a key a is marked as SECONDARY, it
             * will be used to search for profiles after all other PROFILE keys have been searched.
             * A LOOKUP_ONLY key is only used to match a profile but is not persisted to be used for
             * searching of the profile. A NEW_ONLY key is only used if the profile does not already
             * exist before the object is ingested, otherwise it is only used for matching objects
             * to profiles.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-customerprofiles-objecttype-objecttypekey.html#cfn-customerprofiles-objecttype-objecttypekey-standardidentifiers)
             */
            override fun standardIdentifiers(): List<String> =
                unwrap(this).getStandardIdentifiers() ?: emptyList()
        }
    ...
    public interface FieldMapProperty {
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("6a36b474874f8982034c00f59853506f065262c2bd05f5ce8aa93d6089d5ceb5")
            override fun objectTypeField(
                objectTypeField: ObjectTypeFieldProperty.Builder.() -> Unit
    ...
    public interface ObjectTypeFieldProperty {
        ...
        public interface Builder {
            /**
             * @param contentType The content type of the field. Used for determining equality when
             *   searching.
             */
            public fun contentType(contentType: String)

            /**
             * @param source A field of a ProfileObject. For example: _source.FirstName, where
             *   “_source” is a ProfileObjectType of a Zendesk user and “FirstName” is a field in
             *   that ObjectType.
             */
            public fun source(source: String)

            /**
             * @param target The location of the data in the standard ProfileObject model. For
        ...
        internal constructor(
             ...
             * A field of a ProfileObject.
             *
             * For example: _source.FirstName, where “_source” is a ProfileObjectType of a Zendesk
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ObjectTypeFieldProperty
            ): software.amazon.awscdk.services.customerprofiles.CfnObjectType.ObjectTypeFieldProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
