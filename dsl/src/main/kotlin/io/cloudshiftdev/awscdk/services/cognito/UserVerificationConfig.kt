...
public interface UserVerificationConfig {
     ...
     * VerificationEmailStyle.CODE is chosen, 'Verify your account by clicking on {##Verify
     * Email##}' if VerificationEmailStyle.LINK is chosen.
     */
     ...
     *
     * Default: - 'The verification code to your new account is {####}' if
     * VerificationEmailStyle.CODE is chosen, not configured if VerificationEmailStyle.LINK is
     * chosen
     */
    ...
    public interface Builder {
        ...
        /**
         * @param emailSubject The email subject template for the verification email sent to the
         *   user upon sign up. See
         *   https://docs.aws.amazon.com/cognito/latest/developerguide/cognito-user-pool-settings-message-templates.html
         *   to learn more about message templates.
         */
        ...
        /**
         * @param smsMessage The message template for the verification SMS sent to the user upon
         *   sign up. See
         *   https://docs.aws.amazon.com/cognito/latest/developerguide/cognito-user-pool-settings-message-templates.html
         *   to learn more about message templates.
         */
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: UserVerificationConfig
