...
internal constructor(
     ...
     * AWS accounts ).
     */
    public open fun allowedPrincipals(): List<String> =
        unwrap(this).getAllowedPrincipals() ?: emptyList()
    ...
    public interface Builder {
        /**
         * The Amazon Resource Names (ARN) of one or more principals (for example, users, IAM roles,
         * and AWS accounts ).
         *
         * Permissions are granted to the principals in this list. To grant permissions to all
         * principals, specify an asterisk (*). Permissions are revoked for principals not in this
         * list. If the list is empty, then all permissions are revoked.
         *
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.ec2.CfnVPCEndpointServicePermissions.Builder.create(
                scope,
                id
            )
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnVPCEndpointServicePermissions
