...
public open class AaaaRecord
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.route53.AaaaRecord,
) : RecordSet(cdkObject) {
    /** A fluent builder for [io.cloudshiftdev.awscdk.services.route53.AaaaRecord]. */
    @CdkDslMarker
    ...
    public companion object {
        ...
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.route53.AaaaRecord
        ): AaaaRecord = AaaaRecord(cdkObject)

        internal fun unwrap(
            wrapped: AaaaRecord
        ): software.amazon.awscdk.services.route53.AaaaRecord = wrapped.cdkObject
    }
}
