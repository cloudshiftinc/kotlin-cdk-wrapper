...
internal constructor(
     ...
     *
     * This can be used by CodePipeline actions to communicate data between themselves. If metadata
     * was already present under the given key, it will be overwritten with the new value.
     *
     * @param key
     * @param value
     */
    ...
    public companion object {
        ...
        ): Artifact = Artifact(cdkObject)

        internal fun unwrap(
            wrapped: Artifact
        ): software.amazon.awscdk.services.codepipeline.Artifact = wrapped.cdkObject
    }
}
