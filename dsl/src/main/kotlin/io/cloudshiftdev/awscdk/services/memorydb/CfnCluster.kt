...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param autoMinorVersionUpgrade When set to true, the cluster will automatically receive
         ...
         * The user-supplied name of a final cluster snapshot.
         *
         * This is the unique name that identifies the snapshot. MemoryDB creates the snapshot, and
         ...
         * stored in Amazon S3.
         *
         * The snapshot files are used to populate the new cluster . The Amazon S3 object name in
         ...
         * your shard.
         *
         * Example: 05:00-09:00 If you do not specify this parameter, MemoryDB automatically chooses
         ...
         * returns the ARN of the SNS topic, such as
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnCluster
        ): software.amazon.awscdk.services.memorydb.CfnCluster = wrapped.cdkObject
    }
