...
public interface RoutingRule {
  ...
  private class BuilderImpl : Builder {
    ...
    public override fun condition(condition: RoutingRuleCondition) {
      cdkBuilder.condition(condition.let(RoutingRuleCondition::unwrap))
    }

    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("343b62e0c35922af7d69081fbaa066d8dcba0345f65421dbfb265797fd504091")
    public override fun condition(condition: RoutingRuleCondition.Builder.() -> Unit): Unit =
    ...
    public override fun replaceKey(replaceKey: ReplaceKey) {
  ...
  private class Wrapper internal constructor(
    ...
    public override fun condition(): RoutingRuleCondition? =
        unwrap(this).getCondition()?.let(RoutingRuleCondition::wrap)
    ...
    public override fun replaceKey(): ReplaceKey? =
        unwrap(this).getReplaceKey()?.let(ReplaceKey::wrap)
  }
