...
public enum class AdjustmentType(
  ...
  CHANGE_IN_CAPACITY(software.amazon.awscdk.services.autoscaling.AdjustmentType.CHANGE_IN_CAPACITY),
  PERCENT_CHANGE_IN_CAPACITY(software.amazon.awscdk.services.autoscaling.AdjustmentType.PERCENT_CHANGE_IN_CAPACITY),
  EXACT_CAPACITY(software.amazon.awscdk.services.autoscaling.AdjustmentType.EXACT_CAPACITY),
  ;

  public companion object {
    internal fun wrap(cdkObject: software.amazon.awscdk.services.autoscaling.AdjustmentType):
