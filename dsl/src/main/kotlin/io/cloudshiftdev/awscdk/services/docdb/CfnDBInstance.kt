...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param dbClusterIdentifier The identifier of the cluster that the instance will belong
         *   to.
         */
         ...
         *
         * @param dbInstanceIdentifier The instance identifier. This parameter is stored as a
         *   lowercase string.
         */
         ...
         *
         * @param preferredMaintenanceWindow The time range each week during which system
    ...
    public companion object {
        ...
        ): software.amazon.awscdk.services.docdb.CfnDBInstance = wrapped.cdkObject
    }
}
