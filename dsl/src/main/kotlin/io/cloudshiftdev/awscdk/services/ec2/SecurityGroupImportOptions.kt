...
public interface SecurityGroupImportOptions {
     ...
     *
     * Only if this is set to false will egress rules for ipv6 be added to this security group. Be
     ...
     *
     * Only if this is set to false will egress rules be added to this security group. Be aware,
     * this would undo any potential "all outbound traffic" default.
     *
     * Default: true
     */
     ...
     *
     * Beware that making a SecurityGroup immutable might lead to issue due to missing
     * ingress/egress rules for new resources.
     *
     * Default: true
     */
    ...
    public interface Builder {
         ...
         *   outbound ipv6 traffic. Only if this is set to false will egress rules for ipv6 be added
         *   to this security group. Be aware, this would undo any potential "all outbound traffic"
         *   default.
         */
        public fun allowAllIpv6Outbound(allowAllIpv6Outbound: Boolean)

        /**
         * @param allowAllOutbound Mark the SecurityGroup as having been created allowing all
         *   outbound traffic. Only if this is set to false will egress rules be added to this
         *   security group. Be aware, this would undo any potential "all outbound traffic" default.
         */
    ...
    internal constructor(
         ...
         * Mark the SecurityGroup as having been created allowing all outbound ipv6 traffic.
         *
         * Only if this is set to false will egress rules for ipv6 be added to this security group.
         * Be aware, this would undo any potential "all outbound traffic" default.
         *
         * Default: false
         */
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: SecurityGroupImportOptions
