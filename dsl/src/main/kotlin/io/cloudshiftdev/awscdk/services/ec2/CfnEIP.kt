...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.ec2.CfnEIP,
    ...
    public interface Builder {
         ...
         * advertises IP addresses.
         *
         * Use this parameter to limit the IP address to this location. IP addresses cannot move
         ...
         *
         * Updates to the `PublicIpv4Pool` property may require *some interruptions* . Updates on an
         * EIP reassociates the address on its associated resource.
         *
