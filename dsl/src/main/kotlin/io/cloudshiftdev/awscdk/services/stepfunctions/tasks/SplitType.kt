...
public enum class SplitType(
    ...
    public companion object {
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.SplitType
        ): SplitType =
            when (cdkObject) {
                ...
                software.amazon.awscdk.services.stepfunctions.tasks.SplitType.RECORD_IO ->
                    SplitType.RECORD_IO
                software.amazon.awscdk.services.stepfunctions.tasks.SplitType.TF_RECORD ->
                    SplitType.TF_RECORD
            }
