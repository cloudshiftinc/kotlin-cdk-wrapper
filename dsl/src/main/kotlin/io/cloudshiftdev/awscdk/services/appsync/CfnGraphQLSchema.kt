...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param apiId The AWS AppSync GraphQL API identifier to which you want to apply this
         *   schema.
         */
         ...
         * The location of a GraphQL schema file in an Amazon S3 bucket.
         *
         * Use this if you want to provision with the schema living in Amazon S3 rather than
