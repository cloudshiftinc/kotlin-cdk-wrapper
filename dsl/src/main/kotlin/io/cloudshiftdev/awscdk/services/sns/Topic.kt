...
internal constructor(
    ...
    public interface Builder {
         ...
         * Default: None
         *
         * @param displayName A developer-defined string that can be used to identify this SNS
         *   topic.
         */
         ...
         * that ID for the topic name. For more information, see Name Type.
         *
    ...
    public companion object {
        public fun fromTopicArn(
            ...
            software.amazon.awscdk.services.sns.Topic.fromTopicArn(
