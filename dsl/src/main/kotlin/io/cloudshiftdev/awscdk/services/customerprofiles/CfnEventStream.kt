...
internal constructor(
    ...
    /**  */
    public open fun attrDestinationDetailsUri(): String =
        unwrap(this).getAttrDestinationDetailsUri()
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.customerprofiles.CfnEventStream.Builder.create(
                scope,
                id
            )
    ...
    public interface DestinationDetailsProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param uri The StreamARN of the destination to deliver profile events to. For
