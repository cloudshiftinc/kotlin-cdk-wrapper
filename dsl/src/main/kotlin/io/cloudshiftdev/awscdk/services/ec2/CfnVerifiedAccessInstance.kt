...
internal constructor(
    ...
    public open fun loggingConfigurations(
        `value`: VerifiedAccessLogsProperty.Builder.() -> Unit
    ...
    public interface Builder {
        ...
        public fun loggingConfigurations(
            loggingConfigurations: VerifiedAccessLogsProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
        ...
        override fun loggingConfigurations(loggingConfigurations: VerifiedAccessLogsProperty) {
            cdkBuilder.loggingConfigurations(
                loggingConfigurations.let(VerifiedAccessLogsProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("99df720468d1e979b85ec3ee08dff0ce186fbc0bbf564c059bf72d92494764a8")
        override fun loggingConfigurations(
            loggingConfigurations: VerifiedAccessLogsProperty.Builder.() -> Unit
         ...
         * @param verifiedAccessTrustProviderIds The IDs of the AWS Verified Access trust providers.
         */
        override fun verifiedAccessTrustProviderIds(
            vararg verifiedAccessTrustProviderIds: String
        ): Unit = verifiedAccessTrustProviderIds(verifiedAccessTrustProviderIds.toList())
        ...
        override fun verifiedAccessTrustProviders(verifiedAccessTrustProviders: IResolvable) {
            cdkBuilder.verifiedAccessTrustProviders(
                verifiedAccessTrustProviders.let(IResolvable::unwrap)
            )
        }
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnVerifiedAccessInstance
    ...
    public interface VerifiedAccessLogsProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param includeTrustContext Indicates whether to include trust data sent by trust
            ...
            public fun kinesisDataFirehose(
                kinesisDataFirehose: KinesisDataFirehoseProperty.Builder.() -> Unit
            )
        ...
        private class BuilderImpl : Builder {
            ...
            override fun kinesisDataFirehose(kinesisDataFirehose: KinesisDataFirehoseProperty) {
                cdkBuilder.kinesisDataFirehose(
                    kinesisDataFirehose.let(KinesisDataFirehoseProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("1a0f2a2fe07149a1be9a246f07526a0fd870e0759fa81bd7393a2180b8a15013")
            override fun kinesisDataFirehose(
                kinesisDataFirehose: KinesisDataFirehoseProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: VerifiedAccessLogsProperty
            ): software.amazon.awscdk.services.ec2.CfnVerifiedAccessInstance.VerifiedAccessLogsProperty =
    ...
    public interface KinesisDataFirehoseProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: KinesisDataFirehoseProperty
            ): software.amazon.awscdk.services.ec2.CfnVerifiedAccessInstance.KinesisDataFirehoseProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface VerifiedAccessTrustProviderProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param verifiedAccessTrustProviderId The ID of the AWS Verified Access trust
             *   provider.
             */
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ec2-verifiedaccessinstance-verifiedaccesstrustprovider.html#cfn-ec2-verifiedaccessinstance-verifiedaccesstrustprovider-devicetrustprovidertype)
             */
            override fun deviceTrustProviderType(): String? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: VerifiedAccessTrustProviderProperty
            ): software.amazon.awscdk.services.ec2.CfnVerifiedAccessInstance.VerifiedAccessTrustProviderProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
