...
public open class CfnImagePipeline
internal constructor(
    ...
    public open fun imageScanningConfiguration(): Any? =
        unwrap(this).getImageScanningConfiguration()
    ...
    public open fun imageScanningConfiguration(`value`: ImageScanningConfigurationProperty) {
        unwrap(this)
            .setImageScanningConfiguration(`value`.let(ImageScanningConfigurationProperty::unwrap))
    }

    /** Contains settings for vulnerability scans. */
    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("d1dc9480574129aeb5d80a0e2644b4b55f20d7cd6c68c602eec5d23d30c3a3f2")
    public open fun imageScanningConfiguration(
        `value`: ImageScanningConfigurationProperty.Builder.() -> Unit
    ...
    public open fun imageTestsConfiguration(`value`: ImageTestsConfigurationProperty) {
        unwrap(this)
            .setImageTestsConfiguration(`value`.let(ImageTestsConfigurationProperty::unwrap))
    }
    ...
    public open fun imageTestsConfiguration(
        `value`: ImageTestsConfigurationProperty.Builder.() -> Unit
    ): Unit = imageTestsConfiguration(ImageTestsConfigurationProperty(`value`))
    ...
    public interface Builder {
         ...
         *
         * @param containerRecipeArn The Amazon Resource Name (ARN) of the container recipe that is
         ...
         *
         * @param executionRole The name or Amazon Resource Name (ARN) for the IAM role you create
         ...
         *
         * @param imageRecipeArn The Amazon Resource Name (ARN) of the image recipe associated with
         *   this image pipeline.
         */
        ...
        public fun imageScanningConfiguration(
            imageScanningConfiguration: ImageScanningConfigurationProperty.Builder.() -> Unit
        )

        /**
         * The configuration of the image tests that run after image creation to ensure the quality
        ...
        public fun imageTestsConfiguration(
            imageTestsConfiguration: ImageTestsConfigurationProperty.Builder.() -> Unit
        )
         ...
         *
         * @param infrastructureConfigurationArn The Amazon Resource Name (ARN) of the
         *   infrastructure configuration associated with this image pipeline.
         */
    ...
    private class BuilderImpl(
        ...
        override fun enhancedImageMetadataEnabled(enhancedImageMetadataEnabled: IResolvable) {
            cdkBuilder.enhancedImageMetadataEnabled(
                enhancedImageMetadataEnabled.let(IResolvable::unwrap)
            )
        }
        ...
        override fun imageScanningConfiguration(imageScanningConfiguration: IResolvable) {
            cdkBuilder.imageScanningConfiguration(
                imageScanningConfiguration.let(IResolvable::unwrap)
            )
        }
         ...
         * @param imageScanningConfiguration Contains settings for vulnerability scans.
         */
        override fun imageScanningConfiguration(
            imageScanningConfiguration: ImageScanningConfigurationProperty
        ) {
            cdkBuilder.imageScanningConfiguration(
                imageScanningConfiguration.let(ImageScanningConfigurationProperty::unwrap)
            )
        }
        ...
        override fun imageScanningConfiguration(
            ...
            imageScanningConfiguration(
                ImageScanningConfigurationProperty(imageScanningConfiguration)
            )
         ...
         *   creation to ensure the quality of the image that was created.
         */
        override fun imageTestsConfiguration(
            imageTestsConfiguration: ImageTestsConfigurationProperty
        ) {
            cdkBuilder.imageTestsConfiguration(
                imageTestsConfiguration.let(ImageTestsConfigurationProperty::unwrap)
            )
        }
    ...
    public companion object {
        ...
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.imagebuilder.CfnImagePipeline
        ): CfnImagePipeline = CfnImagePipeline(cdkObject)

        internal fun unwrap(
            wrapped: CfnImagePipeline
    ...
    public interface WorkflowConfigurationProperty {
         ...
         * workflows in the group at the same time, and starts additional workflows as others
         * complete, until all workflows in the group have completed. This field only applies for
         * test workflows.
         *
        ...
        public interface Builder {
            ...
            /**
             * @param parallelGroup Test workflows are defined within named runtime groups called
             *   parallel groups. The parallel group is the named group that contains this test
             *   workflow. Test workflows within a parallel group can run at the same time. Image
             *   Builder starts up to five test workflows in the group at the same time, and starts
             *   additional workflows as others complete, until all workflows in the group have
             *   completed. This field only applies for test workflows.
             */
            public fun parallelGroup(parallelGroup: String)

            /**
             * @param parameters Contains parameter values for each of the parameters that the
        ...
        internal constructor(
             ...
             * workflows within a parallel group can run at the same time. Image Builder starts up
             * to five test workflows in the group at the same time, and starts additional workflows
             * as others complete, until all workflows in the group have completed. This field only
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: WorkflowConfigurationProperty
            ): software.amazon.awscdk.services.imagebuilder.CfnImagePipeline.WorkflowConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ImageTestsConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param imageTestsEnabled Defines if tests should be executed when building this
             *   image. For example, `true` or `false` .
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ImageTestsConfigurationProperty
            ): software.amazon.awscdk.services.imagebuilder.CfnImagePipeline.ImageTestsConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface EcrConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param containerTags Tags for Image Builder to apply to the output container image
             *   that &amp;INS;. scans. Tags can help you identify and manage your scanned images.
             */
            ...
            /**
             * @param repositoryName The name of the container repository that Amazon Inspector
             *   scans to identify findings for your container images. The name includes the path
             *   for the repository location. If you don’t provide this information, Image Builder
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: EcrConfigurationProperty
            ): software.amazon.awscdk.services.imagebuilder.CfnImagePipeline.EcrConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ScheduleProperty {
         ...
         * match the semantic version filter. When it is set to `EXPRESSION_MATCH_ONLY` , it will
         * build a new image every time the CRON expression matches the current time. For semantic
         * version syntax, see
        ...
        public interface Builder {
            /**
             * @param pipelineExecutionStartCondition The condition configures when the pipeline
             *   should trigger a new image build. When the `pipelineExecutionStartCondition` is set
             *   to `EXPRESSION_MATCH_AND_DEPENDENCY_UPDATES_AVAILABLE` , and you use semantic
             *   version filters on the base image or components in your image recipe, Image Builder
             *   will build a new image only when there are new versions of the image or components
             *   in your recipe that match the semantic version filter. When it is set to
             *   `EXPRESSION_MATCH_ONLY` , it will build a new image every time the CRON expression
             *   matches the current time. For semantic version syntax, see
             *   [CreateComponent](https://docs.aws.amazon.com/imagebuilder/latest/APIReference/API_CreateComponent.html)
             *   in the *Image Builder API Reference* .
             */
             ...
             *   evaluates your `pipelineExecutionStartCondition` . For information on how to format
             *   a cron expression in Image Builder, see
             *   [Use cron expressions in EC2 Image Builder](https://docs.aws.amazon.com/imagebuilder/latest/userguide/image-builder-cron.html)
             *   .
             */
        ...
        internal constructor(
             ...
             * When the `pipelineExecutionStartCondition` is set to
             * `EXPRESSION_MATCH_AND_DEPENDENCY_UPDATES_AVAILABLE` , and you use semantic version
             * filters on the base image or components in your image recipe, Image Builder will
    ...
    public interface ImageScanningConfigurationProperty {
         ...
         * scans that Amazon Inspector runs against the build instance when you create a new image.
         *
        ...
        public interface Builder {
            ...
            public fun ecrConfiguration(
                ecrConfiguration: EcrConfigurationProperty.Builder.() -> Unit
            )

            /**
             * @param imageScanningEnabled A setting that indicates whether Image Builder keeps a
             *   snapshot of the vulnerability scans that Amazon Inspector runs against the build
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ImageScanningConfigurationProperty
            ): software.amazon.awscdk.services.imagebuilder.CfnImagePipeline.ImageScanningConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
