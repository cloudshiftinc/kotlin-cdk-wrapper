...
public open class GlueStartJobRun internal constructor(
  ...
  private class BuilderImpl(
    ...
    public override fun arguments(arguments: TaskInput) {
    ...
    public override fun glueJobName(glueJobName: String) {
    ...
    public override fun notifyDelayAfter(notifyDelayAfter: Duration) {
