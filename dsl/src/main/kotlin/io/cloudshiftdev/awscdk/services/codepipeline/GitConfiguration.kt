...
public interface GitConfiguration {
     ...
     *
     * The trigger configuration will start the pipeline upon the specified change only. You can
    ...
    public interface Builder {
        /**
         * @param pushFilter The field where the repository event that will start the pipeline, such
         *   as pushing Git tags, is specified with details. Git tags is the only supported event
         *   type.
         *
         * The length must be less than or equal to 3.
         */
        ...
        /**
         * @param sourceAction The pipeline source action where the trigger configuration, such as
         *   Git tags. The trigger configuration will start the pipeline upon the specified change
         *   only. You can only specify one trigger configuration per source action.
         *
         * Since the provider for `sourceAction` must be `CodeStarSourceConnection`, you can use
         * `CodeStarConnectionsSourceAction` construct in `aws-codepipeline-actions` module.
         */
