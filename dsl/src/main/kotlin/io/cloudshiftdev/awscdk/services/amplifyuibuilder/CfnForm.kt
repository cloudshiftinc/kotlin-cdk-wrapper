...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param cta The `FormCTA` object that stores the call to action configuration for the
         *   form.
         */
         ...
         *
         * @param environmentName The name of the backend environment that is a part of the Amplify
         *   app.
         */
         ...
         *
         * @param sectionalElements The configuration information for the visual helper elements for
         *   the form.
         */
    ...
    public companion object {
        ...
        ): CfnForm = CfnForm(cdkObject)

        internal fun unwrap(
            wrapped: CfnForm
        ): software.amazon.awscdk.services.amplifyuibuilder.CfnForm = wrapped.cdkObject
    }
    ...
    public interface FormStyleProperty {
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("e8a12023b55a24b6429e79c0814ac53caaf170936f4d8368e65dff1446a4d3b6")
            override fun horizontalGap(
                horizontalGap: FormStyleConfigProperty.Builder.() -> Unit
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("ce45d7f38411ba695c26d1741ceb0e0d065e1c6077f4fd619309a3ca38008f19")
            override fun outerPadding(
                outerPadding: FormStyleConfigProperty.Builder.() -> Unit
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("f105ff7e1666f9fc3e9461df44db047b2bf72dcd40425ca3d5e5224856a53e57")
            override fun verticalGap(
                verticalGap: FormStyleConfigProperty.Builder.() -> Unit
            ): Unit = verticalGap(FormStyleConfigProperty(verticalGap))
    ...
    public interface FormInputValuePropertyProperty {
        ...
        public interface Builder {
            ...
            public fun bindingProperties(
                bindingProperties:
                    FormInputValuePropertyBindingPropertiesProperty.Builder.() -> Unit
            )

            /**
             * @param concat A list of form properties to concatenate to create the value to assign
        ...
        private class BuilderImpl : Builder {
            ...
            /** @param bindingProperties The information to bind fields to data at runtime. */
            override fun bindingProperties(
                bindingProperties: FormInputValuePropertyBindingPropertiesProperty
            ) {
                cdkBuilder.bindingProperties(
                    bindingProperties.let(FormInputValuePropertyBindingPropertiesProperty::unwrap)
                )
            }
            ...
            override fun bindingProperties(
                ...
                bindingProperties(
                    FormInputValuePropertyBindingPropertiesProperty(bindingProperties)
                )
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: FormInputValuePropertyProperty
            ): software.amazon.awscdk.services.amplifyuibuilder.CfnForm.FormInputValuePropertyProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface FieldValidationConfigurationProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: FieldValidationConfigurationProperty
            ): software.amazon.awscdk.services.amplifyuibuilder.CfnForm.FieldValidationConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface FileUploaderFieldConfigProperty {
         ...
         * stored.
         *
         * The valid values for this property are `private` , `protected` , or `public` . For
         * detailed information about the permissions associated with each access level, see
         * [File access levels](https://docs.aws.amazon.com/https://docs.amplify.aws/lib/storage/configureaccess/q/platform/js/)
         ...
         * the files into chunks before upload. The progress of the upload isn't continuous, because
        ...
        public interface Builder {
             ...
             *   uploader. Provide this information in an array of strings specifying the valid file
             *   extensions.
             */
            ...
            /**
             * @param accessLevel The access level to assign to the uploaded files in the Amazon S3
             *   bucket where they are stored. The valid values for this property are `private` ,
            ...
            /**
             * @param isResumable Allows the file upload operation to be paused and resumed. The
             *   default value is `false` . When `isResumable` is set to `true` , the file uploader
             *   uses a multipart upload to break the files into chunks before upload. The progress
             *   of the upload isn't continuous, because the file uploader uploads a chunk at a
             *   time.
             */
            ...
            /**
             * @param maxFileCount Specifies the maximum number of files that can be selected to
             *   upload. The default value is an unlimited number of files.
             */
            public fun maxFileCount(maxFileCount: Number)

            /**
             * @param maxSize The maximum file size in bytes that the file uploader will accept. The
             ...
             *   selecting a file for upload. The default value is `true` to display the image
             *   preview.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: FileUploaderFieldConfigProperty
            ): software.amazon.awscdk.services.amplifyuibuilder.CfnForm.FileUploaderFieldConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface FormInputBindingPropertiesValueProperty {
        ...
        public interface Builder {
            ...
            public fun bindingProperties(
                bindingProperties:
                    FormInputBindingPropertiesValuePropertiesProperty.Builder.() -> Unit
            )
        ...
        private class BuilderImpl : Builder {
            ...
            override fun bindingProperties(
                ...
                cdkBuilder.bindingProperties(
                    bindingProperties.let(FormInputBindingPropertiesValuePropertiesProperty::unwrap)
                )
            }
            ...
            override fun bindingProperties(
                ...
                bindingProperties(
                    FormInputBindingPropertiesValuePropertiesProperty(bindingProperties)
                )
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: FormInputBindingPropertiesValueProperty
            ): software.amazon.awscdk.services.amplifyuibuilder.CfnForm.FormInputBindingPropertiesValueProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface FormInputValuePropertyBindingPropertiesProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: FormInputValuePropertyBindingPropertiesProperty
            ): software.amazon.awscdk.services.amplifyuibuilder.CfnForm.FormInputValuePropertyBindingPropertiesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface FormStyleConfigProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: FormStyleConfigProperty
            ): software.amazon.awscdk.services.amplifyuibuilder.CfnForm.FormStyleConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface FieldInputConfigProperty {
        ...
        public interface Builder {
            ...
            public fun fileUploaderConfig(
                fileUploaderConfig: FileUploaderFieldConfigProperty.Builder.() -> Unit
            )

            /**
             * @param isArray Specifies whether to render the field as an array. This property is
            ...
            /**
             * @param valueMappings The information to use to customize the input fields with data
             *   at runtime.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            override fun fileUploaderConfig(fileUploaderConfig: FileUploaderFieldConfigProperty) {
                cdkBuilder.fileUploaderConfig(
                    fileUploaderConfig.let(FileUploaderFieldConfigProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("d72304510be7d4f339609e15528c03a344679c2b87ce1714ad3f07bb096ea0c9")
            override fun fileUploaderConfig(
                fileUploaderConfig: FileUploaderFieldConfigProperty.Builder.() -> Unit
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("24dc45d8d1e745487188d349d0ad4e6938c2c88ccad6784f1ce749cc82d20433")
            override fun valueMappings(
                valueMappings: ValueMappingsProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: FieldInputConfigProperty
            ): software.amazon.awscdk.services.amplifyuibuilder.CfnForm.FieldInputConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SectionalElementProperty {
        ...
        public interface Builder {
            /**
             * @param excluded Excludes a sectional element that was generated by default for a
            ...
            /**
             * @param level Specifies the size of the font for a `Heading` sectional element. Valid
             *   values are `1 | 2 | 3 | 4 | 5 | 6` .
             */
            public fun level(level: Number)

            /**
             * @param orientation Specifies the orientation for a `Divider` sectional element. Valid
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SectionalElementProperty
            ): software.amazon.awscdk.services.amplifyuibuilder.CfnForm.SectionalElementProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface FormInputBindingPropertiesValuePropertiesProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: FormInputBindingPropertiesValuePropertiesProperty
            ): software.amazon.awscdk.services.amplifyuibuilder.CfnForm.FormInputBindingPropertiesValuePropertiesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface FormDataTypeConfigProperty {
        ...
        public interface Builder {
            /**
             * @param dataSourceType The data source type, either an Amplify DataStore model or a
             *   custom data type.
             */
            public fun dataSourceType(dataSourceType: String)

            /**
             * @param dataTypeName The unique name of the data type you are using as the data source
             *   for the form.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: FormDataTypeConfigProperty
            ): software.amazon.awscdk.services.amplifyuibuilder.CfnForm.FormDataTypeConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface FieldPositionProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param fixed The field position is fixed and doesn't change in relation to other
             *   fields.
             */
            public fun fixed(fixed: String)

            /**
             * @param rightOf The field position is to the right of the field specified by the
             *   string.
             */
    ...
    public interface FieldConfigProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param inputType Describes the configuration for the default input value to display
             *   for a field.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            /** @param validations The validations to perform on the value in the field. */
            override fun validations(vararg validations: Any): Unit =
    ...
    public interface ValueMappingProperty {
        ...
        private class BuilderImpl : Builder {
            ...
            override fun displayValue(
                displayValue: FormInputValuePropertyProperty.Builder.() -> Unit
