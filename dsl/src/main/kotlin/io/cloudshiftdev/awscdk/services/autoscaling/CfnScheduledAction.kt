...
internal constructor(
    ...
    public interface Builder {
         ...
         *   group after the scheduled action runs and the capacity it attempts to maintain.
         */
         ...
         * The recurring schedule for this action.
         *
         * This format consists of five fields separated by white spaces: [Minute] [Hour]
         * [Day_of_Month] [Month_of_Year] [Day_of_Week]. The value must be in quotes (for example,
         ...
         *   format in UTC/GMT only and in quotes (for example, `"2021-06-01T00:00:00Z"` ).
         */
