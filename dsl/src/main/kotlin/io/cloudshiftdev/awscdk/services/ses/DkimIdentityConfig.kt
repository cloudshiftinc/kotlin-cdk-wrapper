...
public interface DkimIdentityConfig {
    ...
    private class BuilderImpl : Builder {
        ...
        override fun nextSigningKeyLength(nextSigningKeyLength: EasyDkimSigningKeyLength) {
            cdkBuilder.nextSigningKeyLength(
                nextSigningKeyLength.let(EasyDkimSigningKeyLength::unwrap)
            )
        }

        public fun build(): software.amazon.awscdk.services.ses.DkimIdentityConfig =
            cdkBuilder.build()
    }
