...
internal constructor(
    ...
    public interface Builder {
         ...
         * Object containing the parameters of a config.
         *
         * Only one subtype may be specified per config. See the subtype definitions for a
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.groundstation.CfnConfig =
            cdkBuilder.build()
    }
    ...
    public companion object {
        ...
        ): CfnConfig = CfnConfig(cdkObject)

        internal fun unwrap(
            wrapped: CfnConfig
        ): software.amazon.awscdk.services.groundstation.CfnConfig = wrapped.cdkObject
    }
    ...
    public interface DataflowEndpointConfigProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param dataflowEndpointRegion The region of the dataflow endpoint to use during
             *   contacts. When omitted, Ground Station will use the region of the contact.
             */
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-groundstation-config-dataflowendpointconfig.html#cfn-groundstation-config-dataflowendpointconfig-dataflowendpointregion)
             */
            override fun dataflowEndpointRegion(): String? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DataflowEndpointConfigProperty
            ): software.amazon.awscdk.services.groundstation.CfnConfig.DataflowEndpointConfigProperty =
    ...
    public interface UplinkSpectrumConfigProperty {
        ...
        public interface Builder {
            /**
             * @param centerFrequency The center frequency of the spectrum. Valid values are between
             *   2200 to 2300 MHz and 7750 to 8400 MHz for downlink and 2025 to 2120 MHz for uplink.
             */
            ...
            /**
             * @param polarization The polarization of the spectrum. Valid values are `"RIGHT_HAND"`
             *   and `"LEFT_HAND"` .
             */
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("ce5ef5bdc5a0cc681dbba37350877f9524c0fb76096c96eb150111dddad9694d")
            override fun centerFrequency(
                centerFrequency: FrequencyProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * The center frequency of the spectrum.
             *
             * Valid values are between 2200 to 2300 MHz and 7750 to 8400 MHz for downlink and 2025
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: UplinkSpectrumConfigProperty
            ): software.amazon.awscdk.services.groundstation.CfnConfig.UplinkSpectrumConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface TrackingConfigProperty {
         ...
         * `PREFERRED` specifies that autotracking is preferred during the contact but fallback to
         * program track if the signal is lost. `REQUIRED` specifies that autotracking is required
        ...
        public interface Builder {
            /**
             * @param autotrack Specifies whether or not to use autotrack. `REMOVED` specifies that
             *   program track should only be used during the contact. `PREFERRED` specifies that
             *   autotracking is preferred during the contact but fallback to program track if the
             *   signal is lost. `REQUIRED` specifies that autotracking is required during the
             *   contact and not to use program track if the signal is lost.
             */
        ...
        internal constructor(
             ...
             *
             * `REMOVED` specifies that program track should only be used during the contact.
             * `PREFERRED` specifies that autotracking is preferred during the contact but fallback
             * to program track if the signal is lost. `REQUIRED` specifies that autotracking is
             * required during the contact and not to use program track if the signal is lost.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-groundstation-config-trackingconfig.html#cfn-groundstation-config-trackingconfig-autotrack)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TrackingConfigProperty
            ): software.amazon.awscdk.services.groundstation.CfnConfig.TrackingConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface FrequencyProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param value The value of the frequency. Valid values are between 2200 to 2300 MHz
    ...
    public interface ConfigDataProperty {
         ...
         *
         * Downlink demod decode config objects are used to provide parameters for downlinks where
         * the Ground Station service will demodulate and decode the downlinked data.
         *
         ...
         *
         * Dataflow endpoint config objects are used to provide parameters about which IP
         * endpoint(s) to use during a contact. Dataflow endpoints are where Ground Station sends
         * data during a downlink contact and where Ground Station receives data to send to the
         * satellite during an uplink contact.
         *
         ...
         *
         * S3 recording config objects are used to provide parameters for S3 recording during
         * downlink contacts.
         *
        ...
        public interface Builder {
            /**
             * @param antennaDownlinkConfig Provides information for an antenna downlink config
             *   object. Antenna downlink config objects are used to provide parameters for
             *   downlinks where no demodulation or decoding is performed by Ground Station (RF over
             *   IP downlinks).
             */
            ...
            public fun antennaDownlinkConfig(
                antennaDownlinkConfig: AntennaDownlinkConfigProperty.Builder.() -> Unit
            )

            /**
             * @param antennaDownlinkDemodDecodeConfig Provides information for a downlink demod
             *   decode config object. Downlink demod decode config objects are used to provide
             *   parameters for downlinks where the Ground Station service will demodulate and
             *   decode the downlinked data.
             */
            public fun antennaDownlinkDemodDecodeConfig(
                antennaDownlinkDemodDecodeConfig: IResolvable
            )
            ...
            public fun antennaDownlinkDemodDecodeConfig(
                antennaDownlinkDemodDecodeConfig:
                    AntennaDownlinkDemodDecodeConfigProperty.Builder.() -> Unit
            )

            /**
             * @param antennaUplinkConfig Provides information for an uplink config object. Uplink
             *   config objects are used to provide parameters for uplink contacts.
             */
            ...
            public fun antennaUplinkConfig(
                antennaUplinkConfig: AntennaUplinkConfigProperty.Builder.() -> Unit
            )

            /**
             * @param dataflowEndpointConfig Provides information for a dataflow endpoint config
             *   object. Dataflow endpoint config objects are used to provide parameters about which
             *   IP endpoint(s) to use during a contact. Dataflow endpoints are where Ground Station
             *   sends data during a downlink contact and where Ground Station receives data to send
             *   to the satellite during an uplink contact.
             */
            ...
            public fun dataflowEndpointConfig(
                dataflowEndpointConfig: DataflowEndpointConfigProperty.Builder.() -> Unit
            )

            /**
             * @param s3RecordingConfig Provides information for an S3 recording config object. S3
             *   recording config objects are used to provide parameters for S3 recording during
             *   downlink contacts.
             */
            ...
            public fun s3RecordingConfig(
                s3RecordingConfig: S3RecordingConfigProperty.Builder.() -> Unit
            )

            /**
             * @param trackingConfig Provides information for a tracking config object. Tracking
             *   config objects are used to provide parameters about how to track the satellite
             *   through the sky during a contact.
             */
            ...
            /**
             * @param uplinkEchoConfig Provides information for an uplink echo config object. Uplink
             *   echo config objects are used to provide parameters for uplink echo during uplink
             *   contacts.
             */
            ...
            public fun uplinkEchoConfig(
                uplinkEchoConfig: UplinkEchoConfigProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
             ...
             *   IP downlinks).
             */
            override fun antennaDownlinkConfig(
                antennaDownlinkConfig: AntennaDownlinkConfigProperty
            ) {
                cdkBuilder.antennaDownlinkConfig(
                    antennaDownlinkConfig.let(AntennaDownlinkConfigProperty::unwrap)
                )
            }
             ...
             *   decode the downlinked data.
             */
            override fun antennaDownlinkDemodDecodeConfig(
                antennaDownlinkDemodDecodeConfig: IResolvable
            ) {
                cdkBuilder.antennaDownlinkDemodDecodeConfig(
                    antennaDownlinkDemodDecodeConfig.let(IResolvable::unwrap)
                )
            }
            ...
            override fun antennaDownlinkDemodDecodeConfig(
                ...
                cdkBuilder.antennaDownlinkDemodDecodeConfig(
                    antennaDownlinkDemodDecodeConfig.let(
                        AntennaDownlinkDemodDecodeConfigProperty::unwrap
                    )
                )
            }
            ...
            override fun antennaDownlinkDemodDecodeConfig(
                ...
                antennaDownlinkDemodDecodeConfig(
                    AntennaDownlinkDemodDecodeConfigProperty(antennaDownlinkDemodDecodeConfig)
                )
            ...
            override fun antennaUplinkConfig(antennaUplinkConfig: AntennaUplinkConfigProperty) {
                cdkBuilder.antennaUplinkConfig(
                    antennaUplinkConfig.let(AntennaUplinkConfigProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("9e683d9dbb2881828c7f91e7acf80e85b64ac1a993fe3920e567b26f5ab4bb3e")
            override fun antennaUplinkConfig(
                antennaUplinkConfig: AntennaUplinkConfigProperty.Builder.() -> Unit
             ...
             *   to the satellite during an uplink contact.
             */
            override fun dataflowEndpointConfig(
                dataflowEndpointConfig: DataflowEndpointConfigProperty
            ) {
                cdkBuilder.dataflowEndpointConfig(
                    dataflowEndpointConfig.let(DataflowEndpointConfigProperty::unwrap)
                )
            }
            ...
            override fun s3RecordingConfig(s3RecordingConfig: S3RecordingConfigProperty) {
                cdkBuilder.s3RecordingConfig(
                    s3RecordingConfig.let(S3RecordingConfigProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("30b810d472a639602948402c858f31c95b7f7e2c83183883330e5db314bbe364")
            override fun s3RecordingConfig(
                s3RecordingConfig: S3RecordingConfigProperty.Builder.() -> Unit
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("fc026be17cdda923100e7e206217b7badfcc1d5b4b8787c6fff3048146a53ece")
            override fun trackingConfig(
                trackingConfig: TrackingConfigProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * where the Ground Station service will demodulate and decode the downlinked data.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-groundstation-config-configdata.html#cfn-groundstation-config-configdata-antennadownlinkdemoddecodeconfig)
             */
             ...
             *
             * Dataflow endpoint config objects are used to provide parameters about which IP
             * endpoint(s) to use during a contact. Dataflow endpoints are where Ground Station
             * sends data during a downlink contact and where Ground Station receives data to send
             * to the satellite during an uplink contact.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-groundstation-config-configdata.html#cfn-groundstation-config-configdata-dataflowendpointconfig)
             ...
             * Provides information for a tracking config object.
             *
             * Tracking config objects are used to provide parameters about how to track the
             ...
             * Provides information for an uplink echo config object.
             *
             * Uplink echo config objects are used to provide parameters for uplink echo during
             * uplink contacts.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-groundstation-config-configdata.html#cfn-groundstation-config-configdata-uplinkechoconfig)
             */
    ...
    public interface FrequencyBandwidthProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param value The value of the bandwidth. AWS Ground Station currently has the
             *   following bandwidth limitations:.
             * * For `AntennaDownlinkDemodDecodeconfig` , valid values are between 125 kHz to 650
             *   MHz.
             * * For `AntennaDownlinkconfig` , valid values are between 10 kHz to 54 MHz.
             * * For `AntennaUplinkConfig` , valid values are between 10 kHz to 54 MHz.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: FrequencyBandwidthProperty
            ): software.amazon.awscdk.services.groundstation.CfnConfig.FrequencyBandwidthProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface AntennaDownlinkDemodDecodeConfigProperty {
        ...
        public interface Builder {
            ...
            public fun demodulationConfig(
                demodulationConfig: DemodulationConfigProperty.Builder.() -> Unit
            )
        ...
        private class BuilderImpl : Builder {
            ...
            override fun demodulationConfig(demodulationConfig: DemodulationConfigProperty) {
                cdkBuilder.demodulationConfig(
                    demodulationConfig.let(DemodulationConfigProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("e0a9f2fe13c3bd64c02bcd06addc44c8e1290399ec3a59a50da1a9d5af7c78e0")
            override fun demodulationConfig(
                demodulationConfig: DemodulationConfigProperty.Builder.() -> Unit
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("5e396683af6258796a463bfcfe4e947b18814e7a7223d1dfbbf3f2a08d326e96")
            override fun spectrumConfig(
                spectrumConfig: SpectrumConfigProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AntennaDownlinkDemodDecodeConfigProperty
            ): software.amazon.awscdk.services.groundstation.CfnConfig.AntennaDownlinkDemodDecodeConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DemodulationConfigProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DemodulationConfigProperty
            ): software.amazon.awscdk.services.groundstation.CfnConfig.DemodulationConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface AntennaDownlinkConfigProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AntennaDownlinkConfigProperty
            ): software.amazon.awscdk.services.groundstation.CfnConfig.AntennaDownlinkConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface S3RecordingConfigProperty {
         ...
         *
         * If you choose to use any optional keys for substitution, these values will be replaced
         * with the corresponding information from your contact details. For example, a prefix of
        ...
        public interface Builder {
            /**
             * @param bucketArn S3 Bucket where the data is written. The name of the S3 Bucket
             *   provided must begin with `aws-groundstation` .
             */
            public fun bucketArn(bucketArn: String)

            /**
             * @param prefix The prefix of the S3 data object. If you choose to use any optional
             *   keys for substitution, these values will be replaced with the corresponding
             *   information from your contact details. For example, a prefix of
             *   `{satellite_id}/{year}/{month}/{day}/` will replaced with
        ...
        internal constructor(
             ...
             * The prefix of the S3 data object.
             *
             * If you choose to use any optional keys for substitution, these values will be
             * replaced with the corresponding information from your contact details. For example, a
             * prefix of `{satellite_id}/{year}/{month}/{day}/` will replaced with
             * `fake_satellite_id/2021/01/10/`
             *
             * *Optional keys for substitution* : `{satellite_id}` | `{config-name}` | `{config-id}`
             * | `{year}` | `{month}` | `{day}`
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: S3RecordingConfigProperty
            ): software.amazon.awscdk.services.groundstation.CfnConfig.S3RecordingConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface UplinkEchoConfigProperty {
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-groundstation-config-uplinkechoconfig.html#cfn-groundstation-config-uplinkechoconfig-antennauplinkconfigarn)
             */
            override fun antennaUplinkConfigArn(): String? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: UplinkEchoConfigProperty
            ): software.amazon.awscdk.services.groundstation.CfnConfig.UplinkEchoConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SpectrumConfigProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param polarization The polarization of the spectrum. Valid values are `"RIGHT_HAND"`
             *   and `"LEFT_HAND"` . Capturing both `"RIGHT_HAND"` and `"LEFT_HAND"` polarization
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SpectrumConfigProperty
            ): software.amazon.awscdk.services.groundstation.CfnConfig.SpectrumConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface AntennaUplinkConfigProperty {
        ...
        public interface Builder {
            ...
            public fun spectrumConfig(
                spectrumConfig: UplinkSpectrumConfigProperty.Builder.() -> Unit
            )

            /**
             * @param targetEirp The equivalent isotropically radiated power (EIRP) to use for
             *   uplink transmissions. Valid values are between 20.0 to 50.0 dBW.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AntennaUplinkConfigProperty
            ): software.amazon.awscdk.services.groundstation.CfnConfig.AntennaUplinkConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
