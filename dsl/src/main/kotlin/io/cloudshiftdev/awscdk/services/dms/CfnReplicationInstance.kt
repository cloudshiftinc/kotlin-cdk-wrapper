...
internal constructor(
    ...
    public interface Builder {
         ...
         * The Availability Zone that the replication instance will be created in.
         *
         * The default value is a random, system-chosen Availability Zone in the endpoint's AWS
         ...
         *
         * @param availabilityZone The Availability Zone that the replication instance will be
         *   created in.
         */
         ...
         *
         * @param publiclyAccessible Specifies the accessibility options for the replication
         *   instance.
         */
         ...
         *
         * @param replicationInstanceClass The compute and memory capacity of the replication
         *   instance as defined for the specified replication instance class.
         */
         ...
         *
         * @param replicationInstanceIdentifier The replication instance identifier. This parameter
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnReplicationInstance
