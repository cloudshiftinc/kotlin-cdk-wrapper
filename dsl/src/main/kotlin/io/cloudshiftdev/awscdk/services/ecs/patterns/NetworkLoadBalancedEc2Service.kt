...
internal constructor(
    ...
    public interface Builder {
         ...
         * Default: 80
         *
         * @param listenerPort Listener port of the network load balancer that will serve traffic to
         *   the service.
         */
         ...
         *
         * If the load balancer has been imported, the vpc attribute must be specified in the call
         * to fromNetworkLoadBalancerAttributes().
         *
        ...
        public fun taskImageOptions(
            taskImageOptions: NetworkLoadBalancedTaskImageOptions.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
        ...
        override fun taskImageOptions(taskImageOptions: NetworkLoadBalancedTaskImageOptions) {
            cdkBuilder.taskImageOptions(
                taskImageOptions.let(NetworkLoadBalancedTaskImageOptions::unwrap)
            )
        }
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: NetworkLoadBalancedEc2Service
        ): software.amazon.awscdk.services.ecs.patterns.NetworkLoadBalancedEc2Service =
            wrapped.cdkObject
    }
}
