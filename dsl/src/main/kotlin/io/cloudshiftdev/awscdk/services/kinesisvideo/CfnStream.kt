...
internal constructor(
    ...
    public interface Builder {
        ...
        /**
         * The ID of the AWS Key Management Service ( AWS KMS ) key that Kinesis Video Streams uses
         ...
         *
         * @param kmsKeyId The ID of the AWS Key Management Service ( AWS KMS ) key that Kinesis
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.kinesisvideo.CfnStream =
            cdkBuilder.build()
    }
    ...
    public companion object {
        ...
        ): CfnStream = CfnStream(cdkObject)

        internal fun unwrap(
            wrapped: CfnStream
        ): software.amazon.awscdk.services.kinesisvideo.CfnStream = wrapped.cdkObject
    }
}
