...
internal constructor(
    ...
    public override fun addGatewayRoute(id: String, props: GatewayRouteBaseProps): GatewayRoute =
        unwrap(this)
            .addGatewayRoute(id, props.let(GatewayRouteBaseProps::unwrap))
            .let(GatewayRoute::wrap)
    ...
    public override fun addGatewayRoute(
        id: String,
        props: GatewayRouteBaseProps.Builder.() -> Unit
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.appmesh.VirtualGateway =
            cdkBuilder.build()
    }
    ...
    public companion object {
        public fun fromVirtualGatewayArn(
            ...
            software.amazon.awscdk.services.appmesh.VirtualGateway.fromVirtualGatewayArn(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    virtualGatewayArn
                )
                .let(IVirtualGateway::wrap)
        ...
        public fun fromVirtualGatewayAttributes(
            ...
            software.amazon.awscdk.services.appmesh.VirtualGateway.fromVirtualGatewayAttributes(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    attrs.let(VirtualGatewayAttributes::unwrap)
                )
                .let(IVirtualGateway::wrap)
        ...
        public fun fromVirtualGatewayAttributes(
            ...
            fromVirtualGatewayAttributes(scope, id, VirtualGatewayAttributes(attrs))
