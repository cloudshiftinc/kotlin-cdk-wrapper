...
public interface LoggingOptions {
     ...
     *
     * Requires Elasticsearch version 5.1 or later or OpenSearch version 1.0 or later. An explicit
     * `false` is required when disabling it from `true`.
     *
     * Default: - false
     */
    ...
    public interface Builder {
        /**
         * @param appLogEnabled Specify if Amazon OpenSearch Service application logging should be
         *   set up. Requires Elasticsearch version 5.1 or later or OpenSearch version 1.0 or later.
        ...
        /**
         * @param auditLogEnabled Specify if Amazon OpenSearch Service audit logging should be set
         *   up. Requires Elasticsearch version 6.7 or later or OpenSearch version 1.0 or later and
         *   fine grained access control to be enabled.
         */
         ...
         *   Elasticsearch version 5.1 or later or OpenSearch version 1.0 or later. An explicit
         *   `false` is required when disabling it from `true`.
         */
    ...
    internal constructor(
         ...
         * Specify if Amazon OpenSearch Service application logging should be set up.
         *
         * Requires Elasticsearch version 5.1 or later or OpenSearch version 1.0 or later. An
         ...
         * Default: - a new log group is created if audit logging is enabled
         */
        override fun auditLogGroup(): ILogGroup? =
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: LoggingOptions
        ): software.amazon.awscdk.services.opensearchservice.LoggingOptions =
