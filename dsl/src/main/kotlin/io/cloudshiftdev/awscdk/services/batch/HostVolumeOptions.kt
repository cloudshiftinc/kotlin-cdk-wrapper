...
public interface HostVolumeOptions : EcsVolumeOptions {
    ...
    private class BuilderImpl : Builder {
        ...
        public fun build(): software.amazon.awscdk.services.batch.HostVolumeOptions =
            cdkBuilder.build()
    }
    ...
    internal constructor(
         ...
         * The path on the host machine this container will have access to.
         *
         * Default: - Docker will choose the host path. The data may not persist after the
