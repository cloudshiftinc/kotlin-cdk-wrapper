...
internal constructor(
     ...
     * [io.cloudshiftdev.awscdk.services.groundstation.CfnDataflowEndpointGroup].
     */
    @CdkDslMarker
    public interface Builder {
        /**
         * Amount of time, in seconds, after a contact ends that the Ground Station Dataflow
         * Endpoint Group will be in a `POSTPASS` state.
         *
         * A Ground Station Dataflow Endpoint Group State Change event will be emitted when the
         ...
         *
         * @param contactPostPassDurationSeconds Amount of time, in seconds, after a contact ends
         *   that the Ground Station Dataflow Endpoint Group will be in a `POSTPASS` state.
         */
         ...
         * Endpoint Group will be in a `PREPASS` state.
         *
         * A Ground Station Dataflow Endpoint Group State Change event will be emitted when the
         ...
         *
         * @param contactPrePassDurationSeconds Amount of time, in seconds, before a contact starts
         *   that the Ground Station Dataflow Endpoint Group will be in a `PREPASS` state.
         */
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.groundstation.CfnDataflowEndpointGroup.Builder.create(
                scope,
                id
            )
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnDataflowEndpointGroup
    ...
    public interface EndpointDetailsProperty {
        ...
        public interface Builder {
            ...
            public fun awsGroundStationAgentEndpoint(
                awsGroundStationAgentEndpoint:
                    AwsGroundStationAgentEndpointProperty.Builder.() -> Unit
            )
        ...
        private class BuilderImpl : Builder {
            ...
            override fun awsGroundStationAgentEndpoint(awsGroundStationAgentEndpoint: IResolvable) {
                cdkBuilder.awsGroundStationAgentEndpoint(
                    awsGroundStationAgentEndpoint.let(IResolvable::unwrap)
                )
            }

            /** @param awsGroundStationAgentEndpoint the value to be set. */
            override fun awsGroundStationAgentEndpoint(
                awsGroundStationAgentEndpoint: AwsGroundStationAgentEndpointProperty
            ) {
                cdkBuilder.awsGroundStationAgentEndpoint(
                    awsGroundStationAgentEndpoint.let(AwsGroundStationAgentEndpointProperty::unwrap)
                )
            }
            ...
            override fun awsGroundStationAgentEndpoint(
                ...
                awsGroundStationAgentEndpoint(
                    AwsGroundStationAgentEndpointProperty(awsGroundStationAgentEndpoint)
                )
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("49418a0b3357df96503d6b4f912c4a3c0fe03ccb45b61bb2b119e8a87430407e")
            override fun securityDetails(
                securityDetails: SecurityDetailsProperty.Builder.() -> Unit
    ...
    public interface RangedConnectionDetailsProperty {
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("3fac8a1455459461b9b6773852bcd890d1366152e576998fba98b1cdb23f6e8a")
            override fun socketAddress(
                socketAddress: RangedSocketAddressProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RangedConnectionDetailsProperty
            ): software.amazon.awscdk.services.groundstation.CfnDataflowEndpointGroup.RangedConnectionDetailsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface AwsGroundStationAgentEndpointProperty {
        ...
        public interface Builder {
            ...
            public fun ingressAddress(
                ingressAddress: RangedConnectionDetailsProperty.Builder.() -> Unit
            )
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("336c132b0d25f767d1059a3ea84a3fa7d3b066d284d3f891e76cf01c17b8e8b2")
            override fun egressAddress(
                egressAddress: ConnectionDetailsProperty.Builder.() -> Unit
            ): Unit = egressAddress(ConnectionDetailsProperty(egressAddress))
            ...
            override fun ingressAddress(ingressAddress: RangedConnectionDetailsProperty) {
                cdkBuilder.ingressAddress(
                    ingressAddress.let(RangedConnectionDetailsProperty::unwrap)
                )
            }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AwsGroundStationAgentEndpointProperty
            ): software.amazon.awscdk.services.groundstation.CfnDataflowEndpointGroup.AwsGroundStationAgentEndpointProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DataflowEndpointProperty {
         ...
         * selected mission profile. If no matching dataflow endpoints are found then Ground Station
         * will not display any available contacts for the satellite.
         *
        ...
        public interface Builder {
            ...
            /**
             * @param name The endpoint name. When listing available contacts for a satellite,
             *   Ground Station searches for a dataflow endpoint whose name matches the value
             *   specified by the dataflow endpoint config of the selected mission profile. If no
             *   matching dataflow endpoints are found then Ground Station will not display any
        ...
        internal constructor(
             ...
             * The endpoint name.
             *
             * When listing available contacts for a satellite, Ground Station searches for a
             * dataflow endpoint whose name matches the value specified by the dataflow endpoint
             * config of the selected mission profile. If no matching dataflow endpoints are found
             * then Ground Station will not display any available contacts for the satellite.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-groundstation-dataflowendpointgroup-dataflowendpoint.html#cfn-groundstation-dataflowendpointgroup-dataflowendpoint-name)
             */
            override fun name(): String? = unwrap(this).getName()
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DataflowEndpointProperty
            ): software.amazon.awscdk.services.groundstation.CfnDataflowEndpointGroup.DataflowEndpointProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface RangedSocketAddressProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RangedSocketAddressProperty
            ): software.amazon.awscdk.services.groundstation.CfnDataflowEndpointGroup.RangedSocketAddressProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ConnectionDetailsProperty {
        ...
        private class BuilderImpl : Builder {
            ...
            @JvmName("81ed04a1adb8c8052f056c410ed46e12541ca7ba459450fe5089a62403e919be")
            override fun socketAddress(
                socketAddress: SocketAddressProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ConnectionDetailsProperty
            ): software.amazon.awscdk.services.groundstation.CfnDataflowEndpointGroup.ConnectionDetailsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SecurityDetailsProperty {
         ...
         *
         * Ground Station will assume this role and create an ENI in your VPC on the specified
         * subnet upon creation of a dataflow endpoint group. This ENI is used as the ingress/egress
         * point for data streamed during a satellite contact.
         *
        ...
        public interface Builder {
            /**
             * @param roleArn The ARN of a role which Ground Station has permission to assume, such
             *   as `arn:aws:iam::1234567890:role/DataDeliveryServiceRole` . Ground Station will
             *   assume this role and create an ENI in your VPC on the specified subnet upon
             *   creation of a dataflow endpoint group. This ENI is used as the ingress/egress point
             *   for data streamed during a satellite contact.
             */
        ...
        internal constructor(
             ...
             *
             * Ground Station will assume this role and create an ENI in your VPC on the specified
             * subnet upon creation of a dataflow endpoint group. This ENI is used as the
             * ingress/egress point for data streamed during a satellite contact.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-groundstation-dataflowendpointgroup-securitydetails.html#cfn-groundstation-dataflowendpointgroup-securitydetails-rolearn)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SecurityDetailsProperty
            ): software.amazon.awscdk.services.groundstation.CfnDataflowEndpointGroup.SecurityDetailsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
