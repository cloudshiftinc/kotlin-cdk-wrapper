...
internal constructor(
    ...
    public open fun secondaryAllocationIds(): List<String> =
        unwrap(this).getSecondaryAllocationIds() ?: emptyList()
    ...
    public interface Builder {
         ...
         *
         * This property is required for a public NAT gateway and cannot be specified with a private
         * NAT gateway.
         *
         ...
         * addresses if connections are still in progress.
         *
        ...
        /**
         * [Private NAT gateway only] The number of secondary private IPv4 addresses you want to
         * assign to the NAT gateway.
         *
         * For more information about secondary addresses, see
         * [Create a NAT gateway](https://docs.aws.amazon.com/vpc/latest/userguide/vpc-nat-gateway.html#nat-gateway-creating)
         * in the *Amazon Virtual Private Cloud User Guide* .
         *
         * `SecondaryPrivateIpAddressCount` and `SecondaryPrivateIpAddresses` cannot be set at the
         * same time.
         *
    ...
    public companion object {
        ...
        ): CfnNatGateway = CfnNatGateway(cdkObject)

        internal fun unwrap(
            wrapped: CfnNatGateway
        ): software.amazon.awscdk.services.ec2.CfnNatGateway = wrapped.cdkObject
    }
}
