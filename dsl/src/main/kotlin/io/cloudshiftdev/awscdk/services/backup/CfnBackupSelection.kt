...
internal constructor(
    ...
    public open fun backupSelection(
        `value`: BackupSelectionResourceTypeProperty.Builder.() -> Unit
    ...
    public interface Builder {
        ...
        public fun backupSelection(
            backupSelection: BackupSelectionResourceTypeProperty.Builder.() -> Unit
        )
    }
    ...
    private class BuilderImpl(
        ...
        override fun backupSelection(backupSelection: BackupSelectionResourceTypeProperty) {
            cdkBuilder.backupSelection(
                backupSelection.let(BackupSelectionResourceTypeProperty::unwrap)
            )
        }
    ...
    public interface ConditionParameterProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param conditionValue The value in a key-value pair. For example, in the tag
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ConditionParameterProperty
            ): software.amazon.awscdk.services.backup.CfnBackupSelection.ConditionParameterProperty =
    ...
    public interface BackupSelectionResourceTypeProperty {
        ...
        public interface Builder {
            /**
             * @param conditions A list of conditions that you define to assign resources to your
             *   backup plans using tags. For example, `"StringEquals": { "ConditionKey":
             *   "aws:ResourceTag/CreatedByCryo", "ConditionValue": "true" },` . Condition operators
             *   are case sensitive.
             *
             * `Conditions` differs from `ListOfTags` as follows:
            ...
            /**
             * @param iamRoleArn The ARN of the IAM role that AWS Backup uses to authenticate when
            ...
            /**
             * @param listOfTags A list of conditions that you define to assign resources to your
             *   backup plans using tags. For example, `"StringEquals": { "ConditionKey":
             *   "aws:ResourceTag/CreatedByCryo", "ConditionValue": "true" },` . Condition operators
             *   are case sensitive.
             *
            ...
            /**
             * @param notResources A list of Amazon Resource Names (ARNs) to exclude from a backup
             ...
             * resource selection strategy, such as assigning only one or a few resource types or
            ...
            /**
             * @param resources An array of strings that contain Amazon Resource Names (ARNs) of
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-backup-backupselection-backupselectionresourcetype.html#cfn-backup-backupselection-backupselectionresourcetype-notresources)
             */
            override fun notResources(): List<String> =
                unwrap(this).getNotResources() ?: emptyList()
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: BackupSelectionResourceTypeProperty
            ): software.amazon.awscdk.services.backup.CfnBackupSelection.BackupSelectionResourceTypeProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ConditionResourceTypeProperty {
        ...
        public interface Builder {
            /**
             * @param conditionKey The key in a key-value pair. For example, in `"Department":
             *   "accounting"` , `"Department"` is the key.
             */
            public fun conditionKey(conditionKey: String)

            /**
             * @param conditionType An operation, such as `STRINGEQUALS` , that is applied to a
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ConditionResourceTypeProperty
            ): software.amazon.awscdk.services.backup.CfnBackupSelection.ConditionResourceTypeProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ConditionsProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param stringLike Filters the values of your tagged resources for matching tag values
             *   with the use of a wildcard character (*) anywhere in the string. For example,
