...
public enum class ReplicationOverwriteProtection(
  ...
  public companion object {
    internal
        fun wrap(cdkObject: software.amazon.awscdk.services.efs.ReplicationOverwriteProtection):
        ReplicationOverwriteProtection = when (cdkObject) {
    ...
    internal fun unwrap(wrapped: ReplicationOverwriteProtection):
