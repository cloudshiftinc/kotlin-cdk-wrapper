...
internal constructor(
    ...
    public interface Builder {
         ...
         * The format of the input file.
         *
         * You can choose between a basic CSV format, a CSV format that includes customs attributes
         * in a header, and a JSON format that includes custom attributes.
         *
         ...
         *
         * @param s3Path The Amazon Simple Storage Service (Amazon S3) location of the FAQ input
         *   data.
         */
