...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param defaultAction The action to perform if none of the `Rules` contained in the
         *   `WebACL` match.
         */
         ...
         * WAF, including "All" and "Default_Action." You can't change `MetricName` after you create
         * the `WebACL` .
         *
         ...
         *
         * @param rules An array that contains the action for each `Rule` in a `WebACL` , the
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.waf.regional.CfnWebACL =
            cdkBuilder.build()
    }
    ...
    public companion object {
        ...
        ): CfnWebACL = CfnWebACL(cdkObject)

        internal fun unwrap(
            wrapped: CfnWebACL
        ): software.amazon.awscdk.services.waf.regional.CfnWebACL = wrapped.cdkObject
    }
    ...
    public interface RuleProperty {
         ...
         *
         * AWS WAF evaluates rules with a lower value before rules with a higher value. The value
         * must be a unique integer. If you have multiple rules in a web ACL, the priority numbers
        ...
        public interface Builder {
            /**
             * @param action The action that AWS WAF takes when a web request matches all conditions
             ...
             *   evaluates rules with a lower value before rules with a higher value. The value must
             *   be a unique integer. If you have multiple rules in a web ACL, the priority numbers
             *   do not need to be consecutive.
             */
        ...
        internal constructor(
             ...
             * The order in which AWS WAF evaluates the rules in a web ACL.
             *
             * AWS WAF evaluates rules with a lower value before rules with a higher value. The
             * value must be a unique integer. If you have multiple rules in a web ACL, the priority
    ...
    public interface ActionProperty {
         ...
         *   in the rule. AWS WAF then continues to inspect the web request based on the remaining
         *   rules in the web ACL. You can't specify `COUNT` for the default action for a WebACL.
         *
        ...
        public interface Builder {
            /**
             * @param type For actions that are associated with a rule, the action that AWS WAF
             *   takes when a web request matches all conditions in a rule. For the default action
             *   of a web access control list (ACL), the action that AWS WAF takes when a web
        ...
        internal constructor(
             ...
             * request matches all conditions in a rule.
             *
             * For the default action of a web access control list (ACL), the action that AWS WAF
             * takes when a web request doesn't match all conditions in any rule.
             *
             * Valid settings include the following:
             * * `ALLOW` : AWS WAF allows requests
             * * `BLOCK` : AWS WAF blocks requests
