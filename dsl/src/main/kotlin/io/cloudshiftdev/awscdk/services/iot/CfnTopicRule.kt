...
internal constructor(
    ...
    private class BuilderImpl(
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("7dc3ff15a9ef1552dc17aebf5e85e502e2b37ca8a82238895047768f6b136511")
        override fun topicRulePayload(
            topicRulePayload: TopicRulePayloadProperty.Builder.() -> Unit
    ...
    public companion object {
        ...
        ): CfnTopicRule = CfnTopicRule(cdkObject)

        internal fun unwrap(
            wrapped: CfnTopicRule
        ): software.amazon.awscdk.services.iot.CfnTopicRule = wrapped.cdkObject
    }
    ...
    public interface TimestreamDimensionProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TimestreamDimensionProperty
            ): software.amazon.awscdk.services.iot.CfnTopicRule.TimestreamDimensionProperty =
    ...
    public interface KafkaActionHeaderProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: KafkaActionHeaderProperty
            ): software.amazon.awscdk.services.iot.CfnTopicRule.KafkaActionHeaderProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ActionProperty {
         ...
         *
         * The `Elasticsearch` action can only be used by existing rule actions. To create a new
        ...
        public interface Builder {
            ...
            public fun cloudwatchAlarm(
                cloudwatchAlarm: CloudwatchAlarmActionProperty.Builder.() -> Unit
            )
            ...
            public fun cloudwatchLogs(
                cloudwatchLogs: CloudwatchLogsActionProperty.Builder.() -> Unit
            )
            ...
            public fun cloudwatchMetric(
                cloudwatchMetric: CloudwatchMetricActionProperty.Builder.() -> Unit
            )

            /**
             * @param dynamoDBv2 Write to a DynamoDB table. This is a new version of the DynamoDB
             *   action. It allows you to write each attribute in an MQTT message payload into a
            ...
            /**
             * @param iotSiteWise Sends data from the MQTT message that triggered the rule to AWS
            ...
            /**
             * @param kafka Send messages to an Amazon Managed Streaming for Apache Kafka (Amazon
        ...
        private class BuilderImpl : Builder {
            ...
            override fun cloudwatchAlarm(cloudwatchAlarm: CloudwatchAlarmActionProperty) {
                cdkBuilder.cloudwatchAlarm(
                    cloudwatchAlarm.let(CloudwatchAlarmActionProperty::unwrap)
                )
            }
            ...
            override fun cloudwatchMetric(cloudwatchMetric: CloudwatchMetricActionProperty) {
                cdkBuilder.cloudwatchMetric(
                    cloudwatchMetric.let(CloudwatchMetricActionProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("fa7cc1ae368a49a852adba0360258b23811f6fedded9a3d4748262f4eb4bfd3f")
            override fun elasticsearch(
                elasticsearch: ElasticsearchActionProperty.Builder.() -> Unit
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("457c63ef720d0825a43120a82e6d8743fa21e8392302a073ddf53384a50201f7")
            override fun iotAnalytics(
                iotAnalytics: IotAnalyticsActionProperty.Builder.() -> Unit
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("9c67675f0ded26c01b390afff37e4fbbe386d71d0bc05069dfe0909718ff796b")
            override fun iotSiteWise(
                iotSiteWise: IotSiteWiseActionProperty.Builder.() -> Unit
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("070c5e2e998b45e02dc2bc514fafd0dce57030732a785f0655bf84f88530e751")
            override fun s3(s3: S3ActionProperty.Builder.() -> Unit): Unit =
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("661d098ed0c8cb1e4cc86437072deacf3e3c1f01ef261b1d6f2b9cab7d110c3a")
            override fun stepFunctions(
                stepFunctions: StepFunctionsActionProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * Write to a DynamoDB table.
             *
             * This is a new version of the DynamoDB action. It allows you to write each attribute
    ...
    public interface RepublishActionHeadersProperty {
         ...
         * [Content Type](https://docs.aws.amazon.com/https://docs.oasis-open.org/mqtt/mqtt/v5.0/os/mqtt-v5.0-os.html#_Toc3901118)
         ...
         *
         * For more information, see
         * [Correlation Data](https://docs.aws.amazon.com/https://docs.oasis-open.org/mqtt/mqtt/v5.0/os/mqtt-v5.0-os.html#_Toc3901115)
         * in the MQTT Version 5.0 specification.
         *
         * Supports
         * [substitution templates](https://docs.aws.amazon.com//iot/latest/developerguide/iot-substitution-templates.html)
         ...
         * expires and is removed. The value of `messageExpiry` represents the number of seconds
         * before it expires. For more information about the limits of `messageExpiry` , see
         * [Message broker and protocol limits and quotas](https://docs.aws.amazon.com//general/latest/gr/iot-core.html#limits_iot)
         ...
         *
         * For more information, see
         * [Payload Format Indicator](https://docs.aws.amazon.com/https://docs.oasis-open.org/mqtt/mqtt/v5.0/os/mqtt-v5.0-os.html#_Toc3901111)
         ...
         *
         * For more information, see
         * [Response Topic](https://docs.aws.amazon.com/https://docs.oasis-open.org/mqtt/mqtt/v5.0/os/mqtt-v5.0-os.html#_Toc3901114)
         * in the MQTT Version 5.0 specification.
         *
         * Supports
         * [substitution templates](https://docs.aws.amazon.com//iot/latest/developerguide/iot-substitution-templates.html)
        ...
        public interface Builder {
            /**
             * @param contentType A UTF-8 encoded string that describes the content of the
             *   publishing message. For more information, see
             *   [Content Type](https://docs.aws.amazon.com/https://docs.oasis-open.org/mqtt/mqtt/v5.0/os/mqtt-v5.0-os.html#_Toc3901118)
             *   in the MQTT Version 5.0 specification.
             *
             * Supports
            ...
            /**
             * @param correlationData The base64-encoded binary data used by the sender of the
             *   request message to identify which request the response message is for. For more
             *   information, see
             *   [Correlation Data](https://docs.aws.amazon.com/https://docs.oasis-open.org/mqtt/mqtt/v5.0/os/mqtt-v5.0-os.html#_Toc3901115)
             *   in the MQTT Version 5.0 specification.
             *
             ...
             *   interval at the broker. If the messages haven't been sent to the subscribers within
             *   that interval, the message expires and is removed. The value of `messageExpiry`
             *   represents the number of seconds before it expires. For more information about the
             *   limits of `messageExpiry` , see
             *   [Message broker and protocol limits and quotas](https://docs.aws.amazon.com//general/latest/gr/iot-core.html#limits_iot)
             *   in the IoT Core Reference Guide.
             *
             * Supports
            ...
            /**
             * @param payloadFormatIndicator An `Enum` string value that indicates whether the
             *   payload is formatted as UTF-8. Valid values are `UNSPECIFIED_BYTES` and `UTF8_DATA`
             *   .
             *
             * For more information, see
             * [Payload Format Indicator](https://docs.aws.amazon.com/https://docs.oasis-open.org/mqtt/mqtt/v5.0/os/mqtt-v5.0-os.html#_Toc3901111)
            ...
            /**
             * @param responseTopic A UTF-8 encoded string that's used as the topic name for a
             *   response message. The response topic is used to describe the topic to which the
             *   receiver should publish as part of the request-response flow. The topic must not
            ...
            /**
             * @param userProperties An array of key-value pairs that you define in the MQTT5
             *   header.
             */
        ...
        internal constructor(
            ...
            /**
             * A user-defined integer value that represents the message expiry interval at the
             * broker.
             *
             * If the messages haven't been sent to the subscribers within that interval, the
             * message expires and is removed. The value of `messageExpiry` represents the number of
             * seconds before it expires. For more information about the limits of `messageExpiry` ,
             * see
             * [Message broker and protocol limits and quotas](https://docs.aws.amazon.com//general/latest/gr/iot-core.html#limits_iot)
             * in the IoT Core Reference Guide.
             *
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-iot-topicrule-republishactionheaders.html#cfn-iot-topicrule-republishactionheaders-payloadformatindicator)
             */
            override fun payloadFormatIndicator(): String? =
                unwrap(this).getPayloadFormatIndicator()

            /**
             * A UTF-8 encoded string that's used as the topic name for a response message.
             *
             * The response topic is used to describe the topic to which the receiver should publish
             * as part of the request-response flow. The topic must not contain wildcard characters.
             *
             * For more information, see
             * [Response Topic](https://docs.aws.amazon.com/https://docs.oasis-open.org/mqtt/mqtt/v5.0/os/mqtt-v5.0-os.html#_Toc3901114)
             * in the MQTT Version 5.0 specification.
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RepublishActionHeadersProperty
            ): software.amazon.awscdk.services.iot.CfnTopicRule.RepublishActionHeadersProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface TopicRulePayloadProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param awsIotSqlVersion The version of the SQL rules engine to use when evaluating
             *   the rule. The default value is 2015-10-08.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TopicRulePayloadProperty
            ): software.amazon.awscdk.services.iot.CfnTopicRule.TopicRulePayloadProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface FirehoseActionProperty {
        ...
        public interface Builder {
            /**
             * @param batchMode Whether to deliver the Kinesis Data Firehose stream as a batch by
             *   using
             *   [`PutRecordBatch`](https://docs.aws.amazon.com/firehose/latest/APIReference/API_PutRecordBatch.html)
            ...
            /**
             * @param separator A character separator that will be used to separate records written
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: FirehoseActionProperty
            ): software.amazon.awscdk.services.iot.CfnTopicRule.FirehoseActionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface OpenSearchActionProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: OpenSearchActionProperty
            ): software.amazon.awscdk.services.iot.CfnTopicRule.OpenSearchActionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DynamoDBv2ActionProperty {
        ...
        public interface Builder {
            /**
             * @param putItem Specifies the DynamoDB table to which the message data will be
             *   written. For example:. `{ "dynamoDBv2": { "roleArn": "aws:iam:12341251:my-role"
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DynamoDBv2ActionProperty
            ): software.amazon.awscdk.services.iot.CfnTopicRule.DynamoDBv2ActionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CloudwatchLogsActionProperty {
        ...
        public interface Builder {
            /**
             * @param batchMode Indicates whether batches of log records will be extracted and
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CloudwatchLogsActionProperty
            ): software.amazon.awscdk.services.iot.CfnTopicRule.CloudwatchLogsActionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface PutAssetPropertyValueEntryProperty {
         ...
         * Optional.
         *
         * A unique identifier for this entry that you can define to better track which message
         * caused an error in case of failure. Accepts substitution templates. Defaults to a new
         * UUID.
         *
        ...
        public interface Builder {
            ...
            /**
             * @param entryId Optional. A unique identifier for this entry that you can define to
             *   better track which message caused an error in case of failure. Accepts substitution
             *   templates. Defaults to a new UUID.
             */
            public fun entryId(entryId: String)

            /**
             * @param propertyAlias The name of the property alias associated with your asset
             *   property. You must specify either a `propertyAlias` or both an `aliasId` and a
             *   `propertyId` . Accepts substitution templates.
             */
            public fun propertyAlias(propertyAlias: String)

            /**
             * @param propertyId The ID of the asset's property. You must specify either a
             *   `propertyAlias` or both an `aliasId` and a `propertyId` . Accepts substitution
             *   templates.
             */
            ...
            /**
             * @param propertyValues A list of property values to insert that each contain
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: PutAssetPropertyValueEntryProperty
            ): software.amazon.awscdk.services.iot.CfnTopicRule.PutAssetPropertyValueEntryProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface AssetPropertyTimestampProperty {
        ...
        public interface Builder {
            /**
             * @param offsetInNanos Optional. A string that contains the nanosecond time offset.
             *   Accepts substitution templates.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AssetPropertyTimestampProperty
            ): software.amazon.awscdk.services.iot.CfnTopicRule.AssetPropertyTimestampProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CloudwatchAlarmActionProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CloudwatchAlarmActionProperty
            ): software.amazon.awscdk.services.iot.CfnTopicRule.CloudwatchAlarmActionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface RepublishActionProperty {
        ...
        public interface Builder {
             ...
             *   [MQTT](https://docs.aws.amazon.com//iot/latest/developerguide/mqtt.html) in the IoT
            ...
            /**
             * @param qos The Quality of Service (QoS) level to use when republishing messages. The
             *   default value is 0.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RepublishActionProperty
            ): software.amazon.awscdk.services.iot.CfnTopicRule.RepublishActionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DynamoDBActionProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DynamoDBActionProperty
            ): software.amazon.awscdk.services.iot.CfnTopicRule.DynamoDBActionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SigV4AuthorizationProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SigV4AuthorizationProperty
            ): software.amazon.awscdk.services.iot.CfnTopicRule.SigV4AuthorizationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface HttpActionProperty {
         ...
         * specify a confirmation URL AWS IoT uses the endpoint URL as the confirmation URL. If you
         * use substitution templates in the confirmationUrl, you must create and enable topic rule
         * destinations that match each possible value of the substitution template before traffic
        ...
        public interface Builder {
            ...
            /**
             * @param confirmationUrl The URL to which AWS IoT sends a confirmation message. The
             *   value of the confirmation URL must be a prefix of the endpoint URL. If you do not
             *   specify a confirmation URL AWS IoT uses the endpoint URL as the confirmation URL.
             *   If you use substitution templates in the confirmationUrl, you must create and
             *   enable topic rule destinations that match each possible value of the substitution
            ...
            /**
             * @param url The endpoint URL. If substitution templates are used in the URL, you must
             *   also specify a `confirmationUrl` . If this is a new destination, a new
        ...
        internal constructor(
             ...
             *
             * The value of the confirmation URL must be a prefix of the endpoint URL. If you do not
             * specify a confirmation URL AWS IoT uses the endpoint URL as the confirmation URL. If
             * you use substitution templates in the confirmationUrl, you must create and enable
             * topic rule destinations that match each possible value of the substitution template
    ...
    public interface IotSiteWiseActionProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param roleArn The ARN of the role that grants AWS IoT permission to send an asset
             *   property value to AWS IoT SiteWise. ( `"Action":
             *   "iotsitewise:BatchPutAssetPropertyValue"` ). The trust policy can restrict access
        ...
        private class BuilderImpl : Builder {
            ...
            override fun putAssetPropertyValueEntries(putAssetPropertyValueEntries: IResolvable) {
                cdkBuilder.putAssetPropertyValueEntries(
                    putAssetPropertyValueEntries.let(IResolvable::unwrap)
                )
            }
            ...
            /** @param putAssetPropertyValueEntries A list of asset property value entries. */
            override fun putAssetPropertyValueEntries(
                vararg putAssetPropertyValueEntries: Any
            ): Unit = putAssetPropertyValueEntries(putAssetPropertyValueEntries.toList())
        ...
        internal constructor(
            ...
            /**
             * The ARN of the role that grants AWS IoT permission to send an asset property value to
             * AWS IoT SiteWise.
             *
             * ( `"Action": "iotsitewise:BatchPutAssetPropertyValue"` ). The trust policy can
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: IotSiteWiseActionProperty
            ): software.amazon.awscdk.services.iot.CfnTopicRule.IotSiteWiseActionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface AssetPropertyValueProperty {
        ...
        private class BuilderImpl : Builder {
            ...
            override fun timestamp(
                timestamp: AssetPropertyTimestampProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * Optional.
             *
             * A string that describes the quality of the value. Accepts substitution templates.
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AssetPropertyValueProperty
            ): software.amazon.awscdk.services.iot.CfnTopicRule.AssetPropertyValueProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface StepFunctionsActionProperty {
         ...
         * followed by a UUID.
         *
         * Step Functions automatically creates a unique name for each state machine execution if
         * one is not provided.
         *
        ...
        public interface Builder {
            /**
             * @param executionNamePrefix (Optional) A name will be given to the state machine
             *   execution consisting of this prefix followed by a UUID. Step Functions
             *   automatically creates a unique name for each state machine execution if one is not
             *   provided.
             */
            public fun executionNamePrefix(executionNamePrefix: String)

            /**
             * @param roleArn The ARN of the role that grants IoT permission to start execution of a
             *   state machine ("Action":"states:StartExecution").
             */
            public fun roleArn(roleArn: String)

            /**
             * @param stateMachineName The name of the Step Functions state machine whose execution
             *   will be started.
             */
        ...
        internal constructor(
             ...
             *
             * Step Functions automatically creates a unique name for each state machine execution
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: StepFunctionsActionProperty
            ): software.amazon.awscdk.services.iot.CfnTopicRule.StepFunctionsActionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface HttpAuthorizationProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: HttpAuthorizationProperty
            ): software.amazon.awscdk.services.iot.CfnTopicRule.HttpAuthorizationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface IotEventsActionProperty {
        ...
        public interface Builder {
            /**
             * @param batchMode Whether to process the event actions as a batch. The default value
             *   is `false` . When `batchMode` is `true` , you can't specify a `messageId` .
             *
             * When `batchMode` is `true` and the rule SQL statement evaluates to an Array, each
             * Array element is treated as a separate message when Events by calling
             * [`BatchPutMessage`](https://docs.aws.amazon.com/iotevents/latest/apireference/API_iotevents-data_BatchPutMessage.html)
             * . The resulting array can't have more than 10 messages.
             */
            public fun batchMode(batchMode: Boolean)
            ...
            /**
             * @param roleArn The ARN of the role that grants AWS IoT permission to send an input to
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: IotEventsActionProperty
            ): software.amazon.awscdk.services.iot.CfnTopicRule.IotEventsActionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface IotAnalyticsActionProperty {
        ...
        public interface Builder {
            /**
             * @param batchMode Whether to process the action as a batch. The default value is
             *   `false` . When `batchMode` is `true` and the rule SQL statement evaluates to an
             *   Array, each Array element is delivered as a separate message when passed by
             *   [`BatchPutMessage`](https://docs.aws.amazon.com/iotanalytics/latest/APIReference/API_BatchPutMessage.html)
             *   The resulting array can't have more than 100 messages.
             */
            public fun batchMode(batchMode: Boolean)
            ...
            /**
             * @param channelName The name of the IoT Analytics channel to which message data will
             *   be sent.
             */
            public fun channelName(channelName: String)

            /**
             * @param roleArn The ARN of the role which has a policy that grants IoT Analytics
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: IotAnalyticsActionProperty
            ): software.amazon.awscdk.services.iot.CfnTopicRule.IotAnalyticsActionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface TimestreamTimestampProperty {
        ...
        public interface Builder {
            /**
             * @param unit The precision of the timestamp value that results from the expression
             *   described in `value` .
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TimestreamTimestampProperty
            ): software.amazon.awscdk.services.iot.CfnTopicRule.TimestreamTimestampProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface AssetPropertyVariantProperty {
         ...
         * Optional.
         *
         * A string that contains the double value of the value entry. Accepts substitution
         * templates.
         *
        ...
        public interface Builder {
            /**
             * @param booleanValue Optional. A string that contains the boolean value ( `true` or
             *   `false` ) of the value entry. Accepts substitution templates.
             */
            public fun booleanValue(booleanValue: String)

            /**
             * @param doubleValue Optional. A string that contains the double value of the value
             *   entry. Accepts substitution templates.
             */
            public fun doubleValue(doubleValue: String)

            /**
             * @param integerValue Optional. A string that contains the integer value of the value
             *   entry. Accepts substitution templates.
             */
            public fun integerValue(integerValue: String)

            /**
             * @param stringValue Optional. The string value of the value entry. Accepts
             *   substitution templates.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AssetPropertyVariantProperty
            ): software.amazon.awscdk.services.iot.CfnTopicRule.AssetPropertyVariantProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface HttpActionHeaderProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: HttpActionHeaderProperty
            ): software.amazon.awscdk.services.iot.CfnTopicRule.HttpActionHeaderProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SnsActionProperty {
         ...
         *
         * Accepted values are "JSON" and "RAW". The default value of the attribute is "RAW". SNS
         * uses this setting to determine if the payload should be parsed and relevant
         * platform-specific bits of the payload should be extracted. For more information, see
        ...
        public interface Builder {
             ...
             *   Accepted values are "JSON" and "RAW". The default value of the attribute is "RAW".
             *   SNS uses this setting to determine if the payload should be parsed and relevant
             *   platform-specific bits of the payload should be extracted. For more information,
             *   see
             *   [Amazon SNS Message and JSON Formats](https://docs.aws.amazon.com/sns/latest/dg/json-formats.html)
             *   in the *Amazon Simple Notification Service Developer Guide* .
             */
    ...
    public interface LocationActionProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param latitude A string that evaluates to a double value that represents the
             *   latitude of the device's location.
             */
            public fun latitude(latitude: String)

            /**
             * @param longitude A string that evaluates to a double value that represents the
            ...
            /**
             * @param timestamp The time that the location data was sampled. The default value is
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: LocationActionProperty
            ): software.amazon.awscdk.services.iot.CfnTopicRule.LocationActionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface S3ActionProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param cannedAcl The Amazon S3 canned ACL that controls access to the object
             *   identified by the object key. For more information, see
             *   [S3 canned ACLs](https://docs.aws.amazon.com/AmazonS3/latest/dev/acl-overview.html#canned-acl)
             *   .
             */
    ...
    public interface TimestampProperty {
        ...
        internal constructor(
            internal val cdkObject:
                software.amazon.awscdk.services.iot.CfnTopicRule.TimestampProperty,
        ) : TimestampProperty {
            /**
             * The precision of the timestamp value that results from the expression described in
             * `value` .
    ...
    public interface CloudwatchMetricActionProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CloudwatchMetricActionProperty
            ): software.amazon.awscdk.services.iot.CfnTopicRule.CloudwatchMetricActionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface TimestreamActionProperty {
        ...
        public interface Builder {
            /**
             * @param databaseName The name of an Amazon Timestream database that has the table to
             *   write records into.
             */
            public fun databaseName(databaseName: String)

            /**
             * @param dimensions Metadata attributes of the time series that are written in each
             *   measure record.
             */
            ...
            /**
             * @param roleArn The Amazon Resource Name (ARN) of the role that grants AWS IoT
             *   permission to write to the Timestream database table.
             */
            public fun roleArn(roleArn: String)
            ...
            /**
             * @param timestamp The value to use for the entry's timestamp. If blank, the time that
             *   the entry was processed is used.
             */
            public fun timestamp(timestamp: IResolvable)
        ...
        private class BuilderImpl : Builder {
            ...
            @JvmName("a0d60eeb5a833c96c0d04ddc520b572e847b707ad1b16fb1d0b9670ae5edd658")
            override fun timestamp(
                timestamp: TimestreamTimestampProperty.Builder.() -> Unit
            ): Unit = timestamp(TimestreamTimestampProperty(timestamp))
        ...
        internal constructor(
            ...
            /**
             * The Amazon Resource Name (ARN) of the role that grants AWS IoT permission to write to
             * the Timestream database table.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-iot-topicrule-timestreamaction.html#cfn-iot-topicrule-timestreamaction-rolearn)
             */
            override fun roleArn(): String = unwrap(this).getRoleArn()
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TimestreamActionProperty
            ): software.amazon.awscdk.services.iot.CfnTopicRule.TimestreamActionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ElasticsearchActionProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ElasticsearchActionProperty
            ): software.amazon.awscdk.services.iot.CfnTopicRule.ElasticsearchActionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
