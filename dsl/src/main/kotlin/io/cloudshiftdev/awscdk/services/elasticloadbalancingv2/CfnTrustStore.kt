...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.elasticloadbalancingv2.CfnTrustStore,
    ...
    public open fun caCertificatesBundleS3Key(): String? =
        unwrap(this).getCaCertificatesBundleS3Key()
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.elasticloadbalancingv2.CfnTrustStore.Builder.create(
                scope,
                id
            )
         ...
         *   certificates bundle.
         */
        override fun caCertificatesBundleS3ObjectVersion(
