...
internal constructor(
    ...
    public interface Builder {
         ...
         */
        @Deprecated(message = "deprecated in CDK") public fun filter(filter: String)

        /**
         * An array of one or more statements for filtering the results of a query based on a
         * boolean expression.
         *
         ...
         */
        @Deprecated(message = "deprecated in CDK") public fun parse(parse: String)

        /**
         * An array of one or more statements for parsing data from a log field and creating
         * ephemeral fields that can be processed further in the query.
         *
         ...
         * Default: - no parse in QueryString
         *
         * @param parseStatements An array of one or more statements for parsing data from a log
         *   field and creating ephemeral fields that can be processed further in the query.
         */
    ...
    public companion object {
        ...
        ): QueryString = QueryString(cdkObject)

        internal fun unwrap(
            wrapped: QueryString
        ): software.amazon.awscdk.services.logs.QueryString = wrapped.cdkObject
    }
}
