...
internal constructor(
    ...
    public open fun attrInferenceComponentArn(): String =
        unwrap(this).getAttrInferenceComponentArn()
    ...
    public open fun runtimeConfig(
        `value`: InferenceComponentRuntimeConfigProperty.Builder.() -> Unit
    ): Unit = runtimeConfig(InferenceComponentRuntimeConfigProperty(`value`))
    ...
    public open fun specification(
        `value`: InferenceComponentSpecificationProperty.Builder.() -> Unit
    ): Unit = specification(InferenceComponentSpecificationProperty(`value`))
    ...
    public interface Builder {
         ...
         *
         * @param endpointArn The Amazon Resource Name (ARN) of the endpoint that hosts the
         *   inference component.
         */
        ...
        public fun runtimeConfig(
            runtimeConfig: InferenceComponentRuntimeConfigProperty.Builder.() -> Unit
        )
        ...
        public fun specification(
            specification: InferenceComponentSpecificationProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.sagemaker.CfnInferenceComponent.Builder.create(
                scope,
                id
            )
        ...
        override fun runtimeConfig(runtimeConfig: InferenceComponentRuntimeConfigProperty) {
            cdkBuilder.runtimeConfig(
                runtimeConfig.let(InferenceComponentRuntimeConfigProperty::unwrap)
            )
        }
        ...
        override fun specification(specification: InferenceComponentSpecificationProperty) {
            cdkBuilder.specification(
                specification.let(InferenceComponentSpecificationProperty::unwrap)
            )
        }
    ...
    public interface InferenceComponentContainerSpecificationProperty {
        ...
        public interface Builder {
            /**
             * @param artifactUrl The Amazon S3 path where the model artifacts, which result from
             ...
             *   and value in the Environment string-to-string map can have length of up to 1024. We
            ...
            /**
             * @param image The Amazon Elastic Container Registry (Amazon ECR) path where the Docker
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("9230b33ebfbb5888d5f4fd74a9405daa0aed42d3dd6a28687ba27a7f7e9f033e")
            override fun deployedImage(
                deployedImage: DeployedImageProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: InferenceComponentContainerSpecificationProperty
            ): software.amazon.awscdk.services.sagemaker.CfnInferenceComponent.InferenceComponentContainerSpecificationProperty =
    ...
    public interface InferenceComponentStartupParametersProperty {
        ...
        public interface Builder {
             ...
             *   your inference container to pass health check by Amazon S3 Hosting. For more
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: InferenceComponentStartupParametersProperty
            ): software.amazon.awscdk.services.sagemaker.CfnInferenceComponent.InferenceComponentStartupParametersProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface InferenceComponentRuntimeConfigProperty {
        ...
        public interface Builder {
            /**
             * @param copyCount The number of runtime copies of the model container to deploy with
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: InferenceComponentRuntimeConfigProperty
            ): software.amazon.awscdk.services.sagemaker.CfnInferenceComponent.InferenceComponentRuntimeConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface InferenceComponentSpecificationProperty {
        ...
        public interface Builder {
            ...
            public fun computeResourceRequirements(
                computeResourceRequirements:
                    InferenceComponentComputeResourceRequirementsProperty.Builder.() -> Unit
            )

            /**
             * @param container Defines a container that provides the runtime environment for a
            ...
            public fun container(
                container: InferenceComponentContainerSpecificationProperty.Builder.() -> Unit
            )

            /**
             * @param modelName The name of an existing SageMaker model object in your account that
             *   you want to deploy with the inference component.
             */
            public fun modelName(modelName: String)

            /**
             * @param startupParameters Settings that take effect while the model container starts
             *   up.
             */
            ...
            public fun startupParameters(
                startupParameters: InferenceComponentStartupParametersProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun computeResourceRequirements(computeResourceRequirements: IResolvable) {
                cdkBuilder.computeResourceRequirements(
                    computeResourceRequirements.let(IResolvable::unwrap)
                )
            }
             ...
             *   assigned to the inference component.
             */
            override fun computeResourceRequirements(
                computeResourceRequirements: InferenceComponentComputeResourceRequirementsProperty
            ) {
                cdkBuilder.computeResourceRequirements(
                    computeResourceRequirements.let(
                        InferenceComponentComputeResourceRequirementsProperty::unwrap
                    )
                )
            }
            ...
            override fun container(container: InferenceComponentContainerSpecificationProperty) {
                cdkBuilder.container(
                    container.let(InferenceComponentContainerSpecificationProperty::unwrap)
                )
            }
             ...
             *   up.
             */
            override fun startupParameters(
                startupParameters: InferenceComponentStartupParametersProperty
            ) {
                cdkBuilder.startupParameters(
                    startupParameters.let(InferenceComponentStartupParametersProperty::unwrap)
                )
            }
            ...
            override fun startupParameters(
                ...
                startupParameters(InferenceComponentStartupParametersProperty(startupParameters))
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: InferenceComponentSpecificationProperty
            ): software.amazon.awscdk.services.sagemaker.CfnInferenceComponent.InferenceComponentSpecificationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface InferenceComponentComputeResourceRequirementsProperty {
        ...
        public interface Builder {
            /**
             * @param maxMemoryRequiredInMb The maximum MB of memory to allocate to run a model that
             *   you assign to an inference component.
             */
            public fun maxMemoryRequiredInMb(maxMemoryRequiredInMb: Number)

            /**
             * @param minMemoryRequiredInMb The minimum MB of memory to allocate to run a model that
             *   you assign to an inference component.
             */
            public fun minMemoryRequiredInMb(minMemoryRequiredInMb: Number)

            /**
             * @param numberOfAcceleratorDevicesRequired The number of accelerators to allocate to
             *   run a model that you assign to an inference component. Accelerators include GPUs
             *   and AWS Inferentia.
             */
            public fun numberOfAcceleratorDevicesRequired(
                numberOfAcceleratorDevicesRequired: Number
            )

            /**
             * @param numberOfCpuCoresRequired The number of CPU cores to allocate to run a model
             *   that you assign to an inference component.
             */
        ...
        private class BuilderImpl : Builder {
             ...
             *   and AWS Inferentia.
             */
            override fun numberOfAcceleratorDevicesRequired(
                numberOfAcceleratorDevicesRequired: Number
            ) {
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-sagemaker-inferencecomponent-inferencecomponentcomputeresourcerequirements.html#cfn-sagemaker-inferencecomponent-inferencecomponentcomputeresourcerequirements-numberofcpucoresrequired)
             */
            override fun numberOfCpuCoresRequired(): Number? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: InferenceComponentComputeResourceRequirementsProperty
            ): software.amazon.awscdk.services.sagemaker.CfnInferenceComponent.InferenceComponentComputeResourceRequirementsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DeployedImageProperty {
        ...
        public interface Builder {
            /**
             * @param resolutionTime The date and time when the image path for the model resolved to
             *   the `ResolvedImage`.
             */
