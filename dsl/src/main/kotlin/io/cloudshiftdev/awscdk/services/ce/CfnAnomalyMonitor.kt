...
internal constructor(
    ...
    public open fun attrDimensionalValueCount(): Number =
        unwrap(this).getAttrDimensionalValueCount()
    ...
    public interface Builder {
         ...
         * The array of `MonitorSpecification` in JSON array format.
         *
         * For instance, you can use `MonitorSpecification` to specify a tag, Cost Category, or
         * linked account for your custom anomaly monitor. For further information, see the
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.ce.CfnAnomalyMonitor =
            cdkBuilder.build()
    }
