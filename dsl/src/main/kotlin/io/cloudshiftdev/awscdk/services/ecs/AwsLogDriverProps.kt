...
public interface AwsLogDriverProps {
    ...
    public interface Builder {
         ...
         *   format. A log message consists of a line that matches the pattern and any following
        ...
        /**
         * @param logRetention The number of days log events are kept in CloudWatch Logs when the
         *   log group is automatically created by this construct.
         */
        ...
        /**
         * @param streamPrefix Prefix for the log streams. The awslogs-stream-prefix option allows
         *   you to associate a log stream with the specified prefix, the container name, and the ID
         *   of the Amazon ECS task to which the container belongs. If you specify a prefix with
    ...
    private class BuilderImpl : Builder {
        ...
        public fun build(): software.amazon.awscdk.services.ecs.AwsLogDriverProps =
            cdkBuilder.build()
    }
    ...
    internal constructor(
         ...
         * This option defines a multiline start pattern in Python strftime format.
         *
         * A log message consists of a line that matches the pattern and any following lines that
         * don’t match the pattern. Thus the matched line is the delimiter between log messages.
         *
         * Default: - No multiline matching.
         */
        ...
        /**
         * The number of days log events are kept in CloudWatch Logs when the log group is
         * automatically created by this construct.
         *
         * Default: - Logs never expire.
         */
         ...
         *
         * The awslogs-stream-prefix option allows you to associate a log stream with the specified
         * prefix, the container name, and the ID of the Amazon ECS task to which the container
         * belongs. If you specify a prefix with this option, then the log stream takes the
         * following format:
         * ```
         * prefix-name/container-name/ecs-task-id
         * ```
