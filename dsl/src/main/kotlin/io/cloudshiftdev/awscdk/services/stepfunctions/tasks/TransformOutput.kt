...
public interface TransformOutput {
     ...
     * Default: - None
     */
    public fun assembleWith(): AssembleWith? =
    ...
    public interface Builder {
        ...
        /**
         * @param assembleWith Defines how to assemble the results of the transform job as a single
         *   S3 object.
         */
        public fun assembleWith(assembleWith: AssembleWith)

        /**
         * @param encryptionKey AWS KMS key that Amazon SageMaker uses to encrypt the model
    ...
    internal constructor(
        ...
        /**
         * AWS KMS key that Amazon SageMaker uses to encrypt the model artifacts at rest using
