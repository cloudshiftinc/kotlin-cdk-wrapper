...
public interface ListParameterAttributes : CommonStringParameterAttributes {
    ...
    public interface Builder {
        /**
         * @param elementType The type of the string list parameter value. Using specific types can
         *   be helpful in catching invalid values at the start of creating or updating a stack.
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: ListParameterAttributes
