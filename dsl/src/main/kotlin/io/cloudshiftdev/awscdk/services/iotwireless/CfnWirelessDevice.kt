...
internal constructor(
    ...
    public interface Builder {
         ...
         * The name of the destination to assign to the new wireless device.
         *
         * Can have only have alphanumeric, - (hyphen) and _ (underscore) characters and it can't
         * have any spaces.
         *
    ...
    public interface AbpV11Property {
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("59a4ab19815afb52a5115c2c1c22281e7dc245874a390b9057281b5f2477d776")
            override fun sessionKeys(
                sessionKeys: SessionKeysAbpV11Property.Builder.() -> Unit
    ...
    public interface SessionKeysAbpV11Property {
         ...
         * application password.
         *
         * You can protect the FNwkSIntKey value by storing it in the AWS Secrets Manager and use
         * the
         * [secretsmanager](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/dynamic-references.html#dynamic-references-secretsmanager)
         * to reference this value.
         *
         ...
         * application password.
         *
         * You can protect the SNwkSIntKey value by storing it in the AWS Secrets Manager and use
         * the
         * [secretsmanager](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/dynamic-references.html#dynamic-references-secretsmanager)
         * to reference this value.
         *
        ...
        public interface Builder {
            /**
             * @param appSKey The AppSKey is a secret key, which you should handle in a similar way
             *   as you would an application password. You can protect the AppSKey value by storing
             *   it in the AWS Secrets Manager and use the
             *   [secretsmanager](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/dynamic-references.html#dynamic-references-secretsmanager)
             *   to reference this value.
             */
            ...
            /**
             * @param fNwkSIntKey The FNwkSIntKey is a secret key, which you should handle in a
             *   similar way as you would an application password. You can protect the FNwkSIntKey
             *   value by storing it in the AWS Secrets Manager and use the
             *   [secretsmanager](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/dynamic-references.html#dynamic-references-secretsmanager)
             *   to reference this value.
             */
            ...
            /**
             * @param nwkSEncKey The NwkSEncKey is a secret key, which you should handle in a
             *   similar way as you would an application password. You can protect the NwkSEncKey
             *   value by storing it in the AWS Secrets Manager and use the
             *   [secretsmanager](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/dynamic-references.html#dynamic-references-secretsmanager)
             *   to reference this value.
             */
            ...
            /**
             * @param sNwkSIntKey The SNwkSIntKey is a secret key, which you should handle in a
             *   similar way as you would an application password. You can protect the SNwkSIntKey
             *   value by storing it in the AWS Secrets Manager and use the
             *   [secretsmanager](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/dynamic-references.html#dynamic-references-secretsmanager)
             *   to reference this value.
             */
        ...
        internal constructor(
             ...
             * application password.
             *
             * You can protect the AppSKey value by storing it in the AWS Secrets Manager and use
             * the
             * [secretsmanager](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/dynamic-references.html#dynamic-references-secretsmanager)
             * to reference this value.
             *
            ...
            /**
             * The FNwkSIntKey is a secret key, which you should handle in a similar way as you
             * would an application password.
             *
             * You can protect the FNwkSIntKey value by storing it in the AWS Secrets Manager and
             * use the
             * [secretsmanager](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/dynamic-references.html#dynamic-references-secretsmanager)
             * to reference this value.
             *
            ...
            /**
             * The NwkSEncKey is a secret key, which you should handle in a similar way as you would
             * an application password.
             *
             * You can protect the NwkSEncKey value by storing it in the AWS Secrets Manager and use
             * the
             * [secretsmanager](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/dynamic-references.html#dynamic-references-secretsmanager)
             * to reference this value.
             *
            ...
            /**
             * The SNwkSIntKey is a secret key, which you should handle in a similar way as you
             * would an application password.
             *
             * You can protect the SNwkSIntKey value by storing it in the AWS Secrets Manager and
             * use the
             * [secretsmanager](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/dynamic-references.html#dynamic-references-secretsmanager)
             * to reference this value.
             *
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SessionKeysAbpV11Property
            ): software.amazon.awscdk.services.iotwireless.CfnWirelessDevice.SessionKeysAbpV11Property =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface OtaaV11Property {
        ...
        public interface Builder {
            /**
             * @param appKey The AppKey is a secret key, which you should handle in a similar way as
             *   you would an application password. You can protect the AppKey value by storing it
             *   in the AWS Secrets Manager and use the
             *   [secretsmanager](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/dynamic-references.html#dynamic-references-secretsmanager)
             *   to reference this value.
             */
            ...
            /**
             * @param nwkKey The NwkKey is a secret key, which you should handle in a similar way as
             *   you would an application password. You can protect the NwkKey value by storing it
             *   in the AWS Secrets Manager and use the
             *   [secretsmanager](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/dynamic-references.html#dynamic-references-secretsmanager)
             *   to reference this value.
             */
    ...
    public interface AbpV10xProperty {
        ...
        private class BuilderImpl : Builder {
            ...
            @JvmName("bb15038e40fff6bc52daf846737f0c14b826cf665300fcaa90a307c5cdef1235")
            override fun sessionKeys(
                sessionKeys: SessionKeysAbpV10xProperty.Builder.() -> Unit
    ...
    public interface OtaaV10xProperty {
        ...
        public interface Builder {
            /**
             * @param appEui The AppEUI value. You specify this value when using LoRaWAN versions
             *   v1.0.2 or v1.0.3.
             */
    ...
    public interface SessionKeysAbpV10xProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SessionKeysAbpV10xProperty
            ): software.amazon.awscdk.services.iotwireless.CfnWirelessDevice.SessionKeysAbpV10xProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
