...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param protocol Specifies the data transfer protocol that DataSync uses to access your
        ...
        /**
         * Specifies the Amazon Resource Names (ARNs) of the security groups that DataSync can use
         ...
         *   groups that DataSync can use to access your FSx for ONTAP file system.
         */
    ...
    public interface SmbMountOptionsProperty {
         ...
         *
         * You also can configure DataSync to use a specific SMB version, but we recommend doing
         * this only if DataSync has trouble negotiating with the SMB file server automatically.
         *
         * These are the following options for configuring the SMB version:
         * * `AUTOMATIC` (default): DataSync and the SMB file server negotiate the highest version
         *   of SMB that they mutually support between 2.1 and 3.1.1.
         *
        ...
        public interface Builder {
             ...
             *   based on negotiation with your SMB file server. You also can configure DataSync to
             ...
             * file server doesn't support, you may get an `Operation Not Supported` error.
             * * `SMB3` : Restricts the protocol negotiation to only SMB version 3.0.2.
             * * `SMB2` : Restricts the protocol negotiation to only SMB version 2.1.
             * * `SMB2_0` : Restricts the protocol negotiation to only SMB version 2.0.
             * * `SMB1` : Restricts the protocol negotiation to only SMB version 1.0.
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SmbMountOptionsProperty
            ): software.amazon.awscdk.services.datasync.CfnLocationFSxONTAP.SmbMountOptionsProperty =
    ...
    public interface NFSProperty {
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("033f4be26885125e4eadaf1dd772bb9201c4c29cbcf806a8b9cc513bbf365fa7")
            override fun mountOptions(
                mountOptions: NfsMountOptionsProperty.Builder.() -> Unit
    ...
    public interface NfsMountOptionsProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: NfsMountOptionsProperty
            ): software.amazon.awscdk.services.datasync.CfnLocationFSxONTAP.NfsMountOptionsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ProtocolProperty {
        ...
        public interface Builder {
            /**
             * @param nfs Specifies the Network File System (NFS) protocol configuration that
             *   DataSync uses to access your FSx for ONTAP file system's storage virtual machine
             *   (SVM).
             */
            ...
            /**
             * @param smb Specifies the Server Message Block (SMB) protocol configuration that
    ...
    public interface SMBProperty {
         ...
         * * If you're using AWS Directory Service for Microsoft Active Directory , the user must be
         *   a member of the AWS Delegated FSx Administrators group.
         ...
         * * `SE_SECURITY_NAME` : May be needed to copy NTFS system access control lists (SACLs).
         ...
         *   the user has the required privileges. For information about copying SACLs, see
         *   [Ownership and permissions-related options](https://docs.aws.amazon.com/datasync/latest/userguide/create-task.html#configure-ownership-and-permissions)
         *   .
         *
        ...
        public interface Builder {
            /**
             * @param domain Specifies the fully qualified domain name (FQDN) of the Microsoft
             *   Active Directory that your storage virtual machine (SVM) belongs to. If you have
            ...
            /**
             * @param mountOptions Specifies how DataSync can access a location using the SMB
             *   protocol.
             */
            public fun mountOptions(mountOptions: IResolvable)
            ...
            /**
             * @param password Specifies the password of a user who has permission to access your
             *   SVM.
             */
             ...
             *   either the Domain Admins group or a custom group that you specified for file system
             *   administration when you created your file system.
             *
             * Make sure that the user has the permissions it needs to copy the data you want:
             * * `SE_TCB_NAME` : Required to set object ownership and file metadata. With this
             ...
             *   granted to members of the Domain Admins group. If you configure your task to copy
             *   SACLs, make sure that the user has the required privileges. For information about
             *   copying SACLs, see
             *   [Ownership and permissions-related options](https://docs.aws.amazon.com/datasync/latest/userguide/create-task.html#configure-ownership-and-permissions)
             *   .
             */
        ...
        private class BuilderImpl : Builder {
            ...
            @JvmName("97d502a9fa55737f807ba05f319d7aeeaa18f7474c96932ae50515bbd8b0740c")
            override fun mountOptions(
                mountOptions: SmbMountOptionsProperty.Builder.() -> Unit
