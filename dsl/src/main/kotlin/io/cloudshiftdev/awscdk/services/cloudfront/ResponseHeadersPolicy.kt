...
internal constructor(
    ...
    public interface Builder {
        ...
        public fun customHeadersBehavior(
            customHeadersBehavior: ResponseCustomHeadersBehavior.Builder.() -> Unit
        )

        /**
         * A list of HTTP response headers that CloudFront removes from HTTP responses that it sends
         * to viewers.
         *
         ...
         *
         * @param securityHeadersBehavior A configuration for a set of security-related HTTP
         *   response headers.
         */
        ...
        public fun securityHeadersBehavior(
            securityHeadersBehavior: ResponseSecurityHeadersBehavior.Builder.() -> Unit
        )
         ...
         *
         * @param serverTimingSamplingRate The percentage of responses that you want CloudFront to
         *   add the Server-Timing header to.
         */
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.cloudfront.ResponseHeadersPolicy.Builder.create(
                scope,
                id
            )
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("ad2af5fbd83f040932aa29ddbb986fde55e2d148fa3edb5d4b1eff454b8a8505")
        override fun corsBehavior(
            corsBehavior: ResponseHeadersCorsBehavior.Builder.() -> Unit
        ...
        override fun customHeadersBehavior(customHeadersBehavior: ResponseCustomHeadersBehavior) {
            cdkBuilder.customHeadersBehavior(
                customHeadersBehavior.let(ResponseCustomHeadersBehavior::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("ab2f2333b49f38c2836f76f275cc00c10028065625276a721d6053832074377b")
        override fun customHeadersBehavior(
            customHeadersBehavior: ResponseCustomHeadersBehavior.Builder.() -> Unit
         ...
         *   response headers.
         */
        override fun securityHeadersBehavior(
            securityHeadersBehavior: ResponseSecurityHeadersBehavior
        ) {
            cdkBuilder.securityHeadersBehavior(
                securityHeadersBehavior.let(ResponseSecurityHeadersBehavior::unwrap)
            )
        }
    ...
    public companion object {
        public fun fromResponseHeadersPolicyId(
            ...
            software.amazon.awscdk.services.cloudfront.ResponseHeadersPolicy
                ...
                .let(IResponseHeadersPolicy::wrap)
