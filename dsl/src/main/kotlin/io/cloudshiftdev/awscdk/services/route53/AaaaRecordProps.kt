...
public interface AaaaRecordProps : RecordSetOptions {
  /**
   * The target.
   */
  ...
  private class BuilderImpl : Builder {
    private val cdkBuilder: software.amazon.awscdk.services.route53.AaaaRecordProps.Builder =
    ...
    public fun build(): software.amazon.awscdk.services.route53.AaaaRecordProps = cdkBuilder.build()
  }

  private class Wrapper(
    override val cdkObject: software.amazon.awscdk.services.route53.AaaaRecordProps,
  ) : CdkObject(cdkObject), AaaaRecordProps {
    /**
  ...
  public companion object {
    public operator fun invoke(block: Builder.() -> Unit = {}): AaaaRecordProps {
    ...
    internal fun unwrap(wrapped: AaaaRecordProps):
        ...
        as software.amazon.awscdk.services.route53.AaaaRecordProps
  }
}
