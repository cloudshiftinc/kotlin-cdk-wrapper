...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param actions The `DatasetAction` objects that automatically create the dataset
         *   contents.
         */
         ...
         *
         * @param lateDataRules A list of data rules that send notifications to CloudWatch, when
         *   data arrives late.
         */
         ...
         *
         * @param triggers The `DatasetTrigger` objects that specify when the dataset is
         ...
         * latest version plus the latest succeeded version (if they are different) are kept for the
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.iotanalytics.CfnDataset =
            cdkBuilder.build()
    }
    ...
    public interface GlueConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param databaseName The name of the database in your AWS Glue Data Catalog in which
             *   the table is located. An AWS Glue Data Catalog database contains metadata tables.
             */
            public fun databaseName(databaseName: String)

            /**
             * @param tableName The name of the table in your AWS Glue Data Catalog that is used to
             *   perform the ETL operations. An AWS Glue Data Catalog table contains partitioned
        ...
        internal constructor(
             ...
             * operations.
             *
             * An AWS Glue Data Catalog table contains partitioned data and descriptions of data
             * sources and targets.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-iotanalytics-dataset-glueconfiguration.html#cfn-iotanalytics-dataset-glueconfiguration-tablename)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: GlueConfigurationProperty
            ): software.amazon.awscdk.services.iotanalytics.CfnDataset.GlueConfigurationProperty =
    ...
    public interface DeltaTimeProperty {
         ...
         * message data might still be in flight when processing begins, and so do not arrive in
         * time to be processed. Use this field to make allowances for the in flight time of your
         * message data, so that data not processed from a previous timeframe is included with the
         * next timeframe. Otherwise, missed message data would be excluded from processing during
        ...
        public interface Builder {
            /**
             * @param offsetSeconds The number of seconds of estimated in-flight lag time of message
             *   data.
             *
             * When you create dataset contents using message data from a specified timeframe, some
             * message data might still be in flight when processing begins, and so do not arrive in
             * time to be processed. Use this field to make allowances for the in flight time of
             * your message data, so that data not processed from a previous timeframe is included
             * with the next timeframe. Otherwise, missed message data would be excluded from
             * processing during the next timeframe too, because its timestamp places it within the
             * previous timeframe.
             */
             ...
             *   determined. This can be the name of a timestamp field or a SQL expression that is
        ...
        internal constructor(
             ...
             * An expression by which the time of the message data might be determined.
             *
             * This can be the name of a timestamp field or a SQL expression that is used to derive
    ...
    public interface S3DestinationConfigurationProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param glueConfiguration Configuration information for coordination with AWS Glue , a
            ...
            public fun glueConfiguration(
                glueConfiguration: GlueConfigurationProperty.Builder.() -> Unit
            )

            /**
             * @param key The key of the dataset contents object in an S3 bucket. Each object has a
        ...
        private class BuilderImpl : Builder {
            ...
            override fun glueConfiguration(glueConfiguration: GlueConfigurationProperty) {
                cdkBuilder.glueConfiguration(
                    glueConfiguration.let(GlueConfigurationProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("8d986fc3b747807a579f2262617d81f0c53cbf1ab91bc6b0b387b4db40f60623")
            override fun glueConfiguration(
                glueConfiguration: GlueConfigurationProperty.Builder.() -> Unit
    ...
    public interface OutputFileUriValueProperty {
        ...
        public interface Builder {
            /**
             * @param fileName The URI of the location where dataset contents are stored, usually
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: OutputFileUriValueProperty
            ): software.amazon.awscdk.services.iotanalytics.CfnDataset.OutputFileUriValueProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ContainerActionProperty {
         ...
         *
         * This includes, at minimum, permission to retrieve the data set contents which are the
        ...
        public interface Builder {
            /**
             * @param executionRoleArn The ARN of the role which gives permission to the system to
             *   access needed resources in order to run the "containerAction". This includes, at
             *   minimum, permission to retrieve the data set contents which are the input to the
             *   containerized application.
             */
            public fun executionRoleArn(executionRoleArn: String)

            /**
             * @param image The ARN of the Docker container stored in your account. The Docker
             *   container contains an application and needed support libraries and is used to
             *   generate data set contents.
             */
            ...
            public fun resourceConfiguration(
                resourceConfiguration: ResourceConfigurationProperty.Builder.() -> Unit
            )

            /**
             * @param variables The values of variables used within the context of the execution of
             *   the containerized application (basically, parameters passed to the application).
             *   Each variable must have a name and a value given by one of "stringValue",
             *   "datasetContentVersionValue", or "outputFileUriValue".
             */
        ...
        private class BuilderImpl : Builder {
             ...
             *   "containerAction".
             */
            override fun resourceConfiguration(
                resourceConfiguration: ResourceConfigurationProperty
            ) {
                cdkBuilder.resourceConfiguration(
                    resourceConfiguration.let(ResourceConfigurationProperty::unwrap)
                )
            }
        ...
        internal constructor(
             ...
             * in order to run the "containerAction".
             *
             * This includes, at minimum, permission to retrieve the data set contents which are the
             * input to the containerized application.
             *
             ...
             * The ARN of the Docker container stored in your account.
             *
             * The Docker container contains an application and needed support libraries and is used
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ContainerActionProperty
            ): software.amazon.awscdk.services.iotanalytics.CfnDataset.ContainerActionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DatasetContentVersionValueProperty {
        ...
        public interface Builder {
            /**
             * @param datasetName The name of the dataset whose latest contents are used as input to
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DatasetContentVersionValueProperty
            ): software.amazon.awscdk.services.iotanalytics.CfnDataset.DatasetContentVersionValueProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface FilterProperty {
        ...
        public interface Builder {
            /**
             * @param deltaTime Used to limit data to that which has arrived since the last
    ...
    public interface DeltaTimeSessionWindowConfigurationProperty {
         ...
         * notifications that have been generated since the last execution. AWS IoT Analytics sends
        ...
        public interface Builder {
            /**
             * @param timeoutInMinutes A time interval. You can use `timeoutInMinutes` so that AWS
             *   IoT Analytics can batch up late data notifications that have been generated since
        ...
        internal constructor(
             ...
             *
             * You can use `timeoutInMinutes` so that AWS IoT Analytics can batch up late data
             * notifications that have been generated since the last execution. AWS IoT Analytics
             * sends one batch of notifications to Amazon CloudWatch Events at one time.
             *
             * For more information about how to write a timestamp expression, see
             * [Date and Time Functions and Operators](https://docs.aws.amazon.com/https://prestodb.io/docs/current/functions/datetime.html)
             * , in the *Presto 0.172 Documentation* .
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DeltaTimeSessionWindowConfigurationProperty
            ): software.amazon.awscdk.services.iotanalytics.CfnDataset.DeltaTimeSessionWindowConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DatasetContentDeliveryRuleDestinationProperty {
        ...
        public interface Builder {
            /**
             * @param iotEventsDestinationConfiguration Configuration information for delivery of
             *   dataset contents to AWS IoT Events .
             */
            public fun iotEventsDestinationConfiguration(
                iotEventsDestinationConfiguration: IResolvable
            )
            ...
            public fun iotEventsDestinationConfiguration(
                iotEventsDestinationConfiguration:
                    IotEventsDestinationConfigurationProperty.Builder.() -> Unit
            )
        ...
        private class BuilderImpl : Builder {
             ...
             *   dataset contents to AWS IoT Events .
             */
            override fun iotEventsDestinationConfiguration(
                iotEventsDestinationConfiguration: IResolvable
            ) {
                cdkBuilder.iotEventsDestinationConfiguration(
                    iotEventsDestinationConfiguration.let(IResolvable::unwrap)
                )
            }
            ...
            override fun iotEventsDestinationConfiguration(
                ...
                cdkBuilder.iotEventsDestinationConfiguration(
                    iotEventsDestinationConfiguration.let(
                        IotEventsDestinationConfigurationProperty::unwrap
                    )
                )
            }
            ...
            override fun iotEventsDestinationConfiguration(
                ...
                iotEventsDestinationConfiguration(
                    IotEventsDestinationConfigurationProperty(iotEventsDestinationConfiguration)
                )
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-iotanalytics-dataset-datasetcontentdeliveryruledestination.html#cfn-iotanalytics-dataset-datasetcontentdeliveryruledestination-s3destinationconfiguration)
             */
            override fun s3DestinationConfiguration(): Any? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DatasetContentDeliveryRuleDestinationProperty
            ): software.amazon.awscdk.services.iotanalytics.CfnDataset.DatasetContentDeliveryRuleDestinationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ResourceConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param computeType The type of the compute resource used to execute the
             *   `containerAction` .
             *
             * Possible values are: `ACU_1` (vCPU=4, memory=16 GiB) or `ACU_2` (vCPU=8, memory=32
             * GiB).
             */
            public fun computeType(computeType: String)

            /**
             * @param volumeSizeInGb The size, in GB, of the persistent storage available to the
             *   resource instance used to execute the `containerAction` (min: 1, max: 50).
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ResourceConfigurationProperty
            ): software.amazon.awscdk.services.iotanalytics.CfnDataset.ResourceConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface LateDataRuleProperty {
        ...
        public interface Builder {
            ...
            public fun ruleConfiguration(
                ruleConfiguration: LateDataRuleConfigurationProperty.Builder.() -> Unit
            )
        ...
        private class BuilderImpl : Builder {
            ...
            override fun ruleConfiguration(ruleConfiguration: LateDataRuleConfigurationProperty) {
                cdkBuilder.ruleConfiguration(
                    ruleConfiguration.let(LateDataRuleConfigurationProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("463e70cb7b75495f7fc174c3f8820d790710441ef27883c96a823c3a9562ddde")
            override fun ruleConfiguration(
                ruleConfiguration: LateDataRuleConfigurationProperty.Builder.() -> Unit
    ...
    public interface TriggerProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param triggeringDataset Information about the data set whose content generation
             *   triggers the new data set content generation.
             */
            ...
            public fun triggeringDataset(
                triggeringDataset: TriggeringDatasetProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun triggeringDataset(triggeringDataset: TriggeringDatasetProperty) {
                cdkBuilder.triggeringDataset(
                    triggeringDataset.let(TriggeringDatasetProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("51aea310296e38b3b60aeb893a2a47e782046054bf5e23a5360066b529afdf0d")
            override fun triggeringDataset(
                triggeringDataset: TriggeringDatasetProperty.Builder.() -> Unit
    ...
    public interface DatasetContentDeliveryRuleProperty {
        ...
        public interface Builder {
            ...
            public fun destination(
                destination: DatasetContentDeliveryRuleDestinationProperty.Builder.() -> Unit
            )
        ...
        private class BuilderImpl : Builder {
            ...
            override fun destination(destination: DatasetContentDeliveryRuleDestinationProperty) {
                cdkBuilder.destination(
                    destination.let(DatasetContentDeliveryRuleDestinationProperty::unwrap)
                )
            }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DatasetContentDeliveryRuleProperty
            ): software.amazon.awscdk.services.iotanalytics.CfnDataset.DatasetContentDeliveryRuleProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ActionProperty {
        ...
        public interface Builder {
             ...
             *   application in order to create the data set contents. The application must be in a
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("7fb0b2b4600952a7a3c76e021204da23616aea133683262928c645a6b64097d5")
            override fun containerAction(
                containerAction: ContainerActionProperty.Builder.() -> Unit
    ...
    public interface QueryActionProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param sqlQuery An "SqlQueryDatasetAction" object that uses an SQL query to
             *   automatically create data set contents.
             */
    ...
    public interface ScheduleProperty {
        ...
        public interface Builder {
            /**
             * @param scheduleExpression The expression that defines when to trigger an update. For
    ...
    public interface VariableProperty {
        ...
        public interface Builder {
            /**
             * @param datasetContentVersionValue The value of the variable as a structure that
            ...
            public fun datasetContentVersionValue(
                datasetContentVersionValue: DatasetContentVersionValueProperty.Builder.() -> Unit
            )
            ...
            /**
             * @param outputFileUriValue The value of the variable as a structure that specifies an
             *   output file URI.
             */
            ...
            public fun outputFileUriValue(
                outputFileUriValue: OutputFileUriValueProperty.Builder.() -> Unit
            )
        ...
        private class BuilderImpl : Builder {
            ...
            override fun datasetContentVersionValue(datasetContentVersionValue: IResolvable) {
                cdkBuilder.datasetContentVersionValue(
                    datasetContentVersionValue.let(IResolvable::unwrap)
                )
            }
             ...
             *   specifies a dataset content version.
             */
            override fun datasetContentVersionValue(
                datasetContentVersionValue: DatasetContentVersionValueProperty
            ) {
                cdkBuilder.datasetContentVersionValue(
                    datasetContentVersionValue.let(DatasetContentVersionValueProperty::unwrap)
                )
            }
            ...
            override fun datasetContentVersionValue(
                ...
                datasetContentVersionValue(
                    DatasetContentVersionValueProperty(datasetContentVersionValue)
                )
            ...
            override fun outputFileUriValue(outputFileUriValue: OutputFileUriValueProperty) {
                cdkBuilder.outputFileUriValue(
                    outputFileUriValue.let(OutputFileUriValueProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("dff49335f37131756e75020f0f7bc73ce35f07617897f614befcd7d8205a3e1a")
            override fun outputFileUriValue(
                outputFileUriValue: OutputFileUriValueProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-iotanalytics-dataset-variable.html#cfn-iotanalytics-dataset-variable-datasetcontentversionvalue)
             */
            override fun datasetContentVersionValue(): Any? =
    ...
    public interface LateDataRuleConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param deltaTimeSessionWindowConfiguration The information needed to configure a
             *   delta time session window.
             */
            ...
            public fun deltaTimeSessionWindowConfiguration(
                deltaTimeSessionWindowConfiguration:
                    DeltaTimeSessionWindowConfigurationProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
             ...
             *   delta time session window.
             */
            override fun deltaTimeSessionWindowConfiguration(
                deltaTimeSessionWindowConfiguration: IResolvable
            ) {
                cdkBuilder.deltaTimeSessionWindowConfiguration(
                    deltaTimeSessionWindowConfiguration.let(IResolvable::unwrap)
                )
            }
            ...
            override fun deltaTimeSessionWindowConfiguration(
                ...
                cdkBuilder.deltaTimeSessionWindowConfiguration(
                    deltaTimeSessionWindowConfiguration.let(
                        DeltaTimeSessionWindowConfigurationProperty::unwrap
                    )
                )
            }
            ...
            override fun deltaTimeSessionWindowConfiguration(
                ...
                deltaTimeSessionWindowConfiguration(
                    DeltaTimeSessionWindowConfigurationProperty(deltaTimeSessionWindowConfiguration)
                )
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: LateDataRuleConfigurationProperty
            ): software.amazon.awscdk.services.iotanalytics.CfnDataset.LateDataRuleConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface VersioningConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param maxVersions How many versions of dataset contents are kept. The `unlimited`
             *   parameter must be `false` .
             */
    ...
    public interface IotEventsDestinationConfigurationProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: IotEventsDestinationConfigurationProperty
            ): software.amazon.awscdk.services.iotanalytics.CfnDataset.IotEventsDestinationConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface TriggeringDatasetProperty {
        ...
        public interface Builder {
            /**
             * @param datasetName The name of the data set whose content generation triggers the new
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TriggeringDatasetProperty
            ): software.amazon.awscdk.services.iotanalytics.CfnDataset.TriggeringDatasetProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
