...
public enum class ParameterType(
    ...
    public companion object {
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.ssm.ParameterType
        ): ParameterType =
            when (cdkObject) {
                software.amazon.awscdk.services.ssm.ParameterType.STRING -> ParameterType.STRING
                software.amazon.awscdk.services.ssm.ParameterType.SECURE_STRING ->
                    ParameterType.SECURE_STRING
                software.amazon.awscdk.services.ssm.ParameterType.STRING_LIST ->
        ...
        internal fun unwrap(
            wrapped: ParameterType
        ): software.amazon.awscdk.services.ssm.ParameterType = wrapped.cdkObject
    }
}
