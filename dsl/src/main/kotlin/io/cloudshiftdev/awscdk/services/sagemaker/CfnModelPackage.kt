...
internal constructor(
    ...
    public open fun customerMetadataProperties(): Any? =
        unwrap(this).getCustomerMetadataProperties()
    ...
    public open fun driftCheckBaselines(
        `value`: DriftCheckBaselinesProperty.Builder.() -> Unit
    ): Unit = driftCheckBaselines(DriftCheckBaselinesProperty(`value`))
    ...
    public open fun inferenceSpecification(
        `value`: InferenceSpecificationProperty.Builder.() -> Unit
    ): Unit = inferenceSpecification(InferenceSpecificationProperty(`value`))
    ...
    public open fun metadataProperties(
        `value`: MetadataPropertiesProperty.Builder.() -> Unit
    ): Unit = metadataProperties(MetadataPropertiesProperty(`value`))
    ...
    public open fun modelPackageStatusDetails(`value`: ModelPackageStatusDetailsProperty) {
        unwrap(this)
            .setModelPackageStatusDetails(`value`.let(ModelPackageStatusDetailsProperty::unwrap))
    }

    /** Specifies the validation and image scan statuses of the model package. */
    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("5f5907dd6a5634c710e72408110136b7a0f0d8a4901ed3f18423e1c8e83ea922")
    public open fun modelPackageStatusDetails(
        `value`: ModelPackageStatusDetailsProperty.Builder.() -> Unit
    ...
    public open fun sourceAlgorithmSpecification(`value`: SourceAlgorithmSpecificationProperty) {
        unwrap(this)
            .setSourceAlgorithmSpecification(
                `value`.let(SourceAlgorithmSpecificationProperty::unwrap)
            )
    }
    ...
    public open fun sourceAlgorithmSpecification(
        `value`: SourceAlgorithmSpecificationProperty.Builder.() -> Unit
    ...
    public open fun validationSpecification(`value`: ValidationSpecificationProperty) {
        unwrap(this)
            .setValidationSpecification(`value`.let(ValidationSpecificationProperty::unwrap))
    }

    /** Specifies batch transform jobs that SageMaker runs to validate your model package. */
    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("164275543bb77010f0687951a1b5558256913cf6caf0a0f0b820d4222e314e3e")
    public open fun validationSpecification(
        `value`: ValidationSpecificationProperty.Builder.() -> Unit
    ): Unit = validationSpecification(ValidationSpecificationProperty(`value`))
    ...
    public interface Builder {
         ...
         *
         * @param additionalInferenceSpecificationsToAdd An array of additional Inference
         *   Specification objects to be added to the existing array.
         */
         ...
         */
        public fun additionalInferenceSpecificationsToAdd(
            additionalInferenceSpecificationsToAdd: List<Any>
        )
         ...
         *
         * @param certifyForMarketplace Whether the model package is to be certified to be listed on
         *   AWS Marketplace.
         */
         ...
         *
         * @param clientToken A unique token that guarantees that the call to this API is
         *   idempotent.
         */
        ...
        /**
         * Represents the drift check baselines that can be used when the model monitor is set using
         * the model package.
         *
        ...
        public fun driftCheckBaselines(
            driftCheckBaselines: DriftCheckBaselinesProperty.Builder.() -> Unit
        )
         ...
         *
         * @param inferenceSpecification Defines how to perform inference generation after a
         *   training job is run.
         */
        ...
        public fun inferenceSpecification(
            inferenceSpecification: InferenceSpecificationProperty.Builder.() -> Unit
        )
        ...
        public fun metadataProperties(
            metadataProperties: MetadataPropertiesProperty.Builder.() -> Unit
        )
         ...
         *
         * @param modelApprovalStatus The approval status of the model. This can be one of the
         *   following values.
         */
        ...
        public fun modelPackageStatusDetails(
            modelPackageStatusDetails: ModelPackageStatusDetailsProperty.Builder.() -> Unit
        )
         ...
         *
         * @param samplePayloadUrl The Amazon Simple Storage Service path where the sample payload
         *   are stored.
         */
        ...
        public fun sourceAlgorithmSpecification(
            sourceAlgorithmSpecification: SourceAlgorithmSpecificationProperty.Builder.() -> Unit
        )
         ...
         *
         * @param validationSpecification Specifies batch transform jobs that SageMaker runs to
        ...
        public fun validationSpecification(
            validationSpecification: ValidationSpecificationProperty.Builder.() -> Unit
        )
    }
    ...
    private class BuilderImpl(
         ...
         *   objects.
         */
        override fun additionalInferenceSpecifications(
            additionalInferenceSpecifications: IResolvable
        ) {
            cdkBuilder.additionalInferenceSpecifications(
                additionalInferenceSpecifications.let(IResolvable::unwrap)
            )
        }
         ...
         */
        override fun additionalInferenceSpecifications(
            additionalInferenceSpecifications: List<Any>
        ) {
         ...
         */
        override fun additionalInferenceSpecifications(
            vararg additionalInferenceSpecifications: Any
        ...
        override fun additionalInferenceSpecificationsToAdd(
            ...
            cdkBuilder.additionalInferenceSpecificationsToAdd(
                additionalInferenceSpecificationsToAdd.let(IResolvable::unwrap)
            )
        }
        ...
        override fun customerMetadataProperties(customerMetadataProperties: IResolvable) {
            cdkBuilder.customerMetadataProperties(
                customerMetadataProperties.let(IResolvable::unwrap)
            )
        }
        ...
        override fun driftCheckBaselines(driftCheckBaselines: DriftCheckBaselinesProperty) {
            cdkBuilder.driftCheckBaselines(
                driftCheckBaselines.let(DriftCheckBaselinesProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("cd3813ed732be0df3b84a486d67699bbdb8ebf7a0284ad6157146b7e74ebd54a")
        override fun driftCheckBaselines(
            driftCheckBaselines: DriftCheckBaselinesProperty.Builder.() -> Unit
         ...
         *   training job is run.
         */
        override fun inferenceSpecification(
            inferenceSpecification: InferenceSpecificationProperty
        ) {
            cdkBuilder.inferenceSpecification(
                inferenceSpecification.let(InferenceSpecificationProperty::unwrap)
            )
        }
        ...
        override fun metadataProperties(metadataProperties: MetadataPropertiesProperty) {
            cdkBuilder.metadataProperties(
                metadataProperties.let(MetadataPropertiesProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("dfb0ceea10e37a93d7fc3f8ce8fca16f93995a81c01f3ec3e44888d4433ab59e")
        override fun metadataProperties(
            metadataProperties: MetadataPropertiesProperty.Builder.() -> Unit
         ...
         *   model package.
         */
        override fun modelPackageStatusDetails(
            modelPackageStatusDetails: ModelPackageStatusDetailsProperty
        ) {
            cdkBuilder.modelPackageStatusDetails(
                modelPackageStatusDetails.let(ModelPackageStatusDetailsProperty::unwrap)
            )
        }
        ...
        override fun sourceAlgorithmSpecification(sourceAlgorithmSpecification: IResolvable) {
            cdkBuilder.sourceAlgorithmSpecification(
                sourceAlgorithmSpecification.let(IResolvable::unwrap)
            )
        }
        ...
        override fun sourceAlgorithmSpecification(
            ...
            cdkBuilder.sourceAlgorithmSpecification(
                sourceAlgorithmSpecification.let(SourceAlgorithmSpecificationProperty::unwrap)
            )
        }
        ...
        override fun sourceAlgorithmSpecification(
            ...
            sourceAlgorithmSpecification(
                SourceAlgorithmSpecificationProperty(sourceAlgorithmSpecification)
            )
         ...
         *   validate your model package.
         */
        override fun validationSpecification(
            validationSpecification: ValidationSpecificationProperty
        ) {
            cdkBuilder.validationSpecification(
                validationSpecification.let(ValidationSpecificationProperty::unwrap)
            )
        }
    ...
    public interface BiasProperty {
        ...
        public interface Builder {
            ...
            public fun postTrainingReport(
                postTrainingReport: MetricsSourceProperty.Builder.() -> Unit
            )
            ...
            public fun preTrainingReport(
                preTrainingReport: MetricsSourceProperty.Builder.() -> Unit
            )
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("7518be2ecca968b747e0cb56a1dd4e9c0624e41b037d55acd2668fde63c47f0c")
            override fun postTrainingReport(
                postTrainingReport: MetricsSourceProperty.Builder.() -> Unit
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("c284f5e0c1d4d792395a22dd0b0daab4cb58c99ff9f1f2bfbc50c3bb32bdcfa3")
            override fun preTrainingReport(
                preTrainingReport: MetricsSourceProperty.Builder.() -> Unit
    ...
    public interface SourceAlgorithmSpecificationProperty {
        ...
        public interface Builder {
            /**
             * @param sourceAlgorithms A list of the algorithms that were used to create a model
             *   package.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SourceAlgorithmSpecificationProperty
            ): software.amazon.awscdk.services.sagemaker.CfnModelPackage.SourceAlgorithmSpecificationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ExplainabilityProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ExplainabilityProperty
            ): software.amazon.awscdk.services.sagemaker.CfnModelPackage.ExplainabilityProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DriftCheckBaselinesProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param explainability Represents the drift check explainability baselines that can be
            ...
            public fun explainability(
                explainability: DriftCheckExplainabilityProperty.Builder.() -> Unit
            )

            /**
             * @param modelDataQuality Represents the drift check model data quality baselines that
             *   can be used when the model monitor is set using the model package.
             */
            ...
            public fun modelDataQuality(
                modelDataQuality: DriftCheckModelDataQualityProperty.Builder.() -> Unit
            )

            /**
             * @param modelQuality Represents the drift check model quality baselines that can be
             *   used when the model monitor is set using the model package.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            override fun explainability(explainability: DriftCheckExplainabilityProperty) {
                cdkBuilder.explainability(
                    explainability.let(DriftCheckExplainabilityProperty::unwrap)
                )
            }
            ...
            override fun modelDataQuality(modelDataQuality: DriftCheckModelDataQualityProperty) {
                cdkBuilder.modelDataQuality(
                    modelDataQuality.let(DriftCheckModelDataQualityProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("5fb86383a4e71c1bd29f6dcec128bec46a7bc676f9a22e80363ceaaee6be6171")
            override fun modelQuality(
                modelQuality: DriftCheckModelQualityProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DriftCheckBaselinesProperty
            ): software.amazon.awscdk.services.sagemaker.CfnModelPackage.DriftCheckBaselinesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ValidationProfileProperty {
        ...
        public interface Builder {
            ...
            public fun transformJobDefinition(
                transformJobDefinition: TransformJobDefinitionProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
             ...
             *   transform job used for the validation of the model package.
             */
            override fun transformJobDefinition(
                transformJobDefinition: TransformJobDefinitionProperty
            ) {
                cdkBuilder.transformJobDefinition(
                    transformJobDefinition.let(TransformJobDefinitionProperty::unwrap)
                )
            }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ValidationProfileProperty
            ): software.amazon.awscdk.services.sagemaker.CfnModelPackage.ValidationProfileProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface InferenceSpecificationProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param supportedRealtimeInferenceInstanceTypes A list of the instance types that are
             *   used to generate inferences in real-time. This parameter is required for
             ...
             *   transformation job can be run or on which an endpoint can be deployed. This
             *   parameter is required for unversioned models, and optional for versioned models.
             */
             ...
             */
            public fun supportedTransformInstanceTypes(
                vararg supportedTransformInstanceTypes: String
            )
        }
        ...
        private class BuilderImpl : Builder {
             ...
             *   unversioned models, and optional for versioned models.
             */
            override fun supportedRealtimeInferenceInstanceTypes(
                supportedRealtimeInferenceInstanceTypes: List<String>
            ) {
            ...
            override fun supportedRealtimeInferenceInstanceTypes(
                ...
                supportedRealtimeInferenceInstanceTypes(
                    supportedRealtimeInferenceInstanceTypes.toList()
                )
            ...
            /** @param supportedResponseMimeTypes The supported MIME types for the output data. */
            override fun supportedResponseMimeTypes(
                vararg supportedResponseMimeTypes: String
            ): Unit = supportedResponseMimeTypes(supportedResponseMimeTypes.toList())
             ...
             *   parameter is required for unversioned models, and optional for versioned models.
             */
            override fun supportedTransformInstanceTypes(
                supportedTransformInstanceTypes: List<String>
            ) {
        ...
        internal constructor(
            ...
            override fun supportedContentTypes(): List<String> =
                unwrap(this).getSupportedContentTypes()
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: InferenceSpecificationProperty
            ): software.amazon.awscdk.services.sagemaker.CfnModelPackage.InferenceSpecificationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DriftCheckModelQualityProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DriftCheckModelQualityProperty
            ): software.amazon.awscdk.services.sagemaker.CfnModelPackage.DriftCheckModelQualityProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ModelPackageStatusDetailsProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ModelPackageStatusDetailsProperty
            ): software.amazon.awscdk.services.sagemaker.CfnModelPackage.ModelPackageStatusDetailsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface TransformResourcesProperty {
        ...
        public interface Builder {
             ...
             *   The default value is `1` , and the maximum is `100` . For distributed transform
             *   jobs, specify a value greater than `1` .
             */
            public fun instanceCount(instanceCount: Number)

            /**
             * @param instanceType The ML compute instance type for the transform job. If you are
             *   using built-in algorithms to transform moderately sized datasets, we recommend
             *   using ml.m4.xlarge or `ml.m5.large` instance types.
             */
            public fun instanceType(instanceType: String)

            /**
             * @param volumeKmsKeyId The AWS Key Management Service ( AWS KMS) key that Amazon
             *   SageMaker uses to encrypt model data on the storage volume attached to the ML
        ...
        internal constructor(
             ...
             * The ML compute instance type for the transform job.
             *
             * If you are using built-in algorithms to transform moderately sized datasets, we
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TransformResourcesProperty
            ): software.amazon.awscdk.services.sagemaker.CfnModelPackage.TransformResourcesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DriftCheckExplainabilityProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DriftCheckExplainabilityProperty
            ): software.amazon.awscdk.services.sagemaker.CfnModelPackage.DriftCheckExplainabilityProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface TransformJobDefinitionProperty {
        ...
        public interface Builder {
            /**
             * @param batchStrategy A string that determines the number of records included in a
             *   single mini-batch. `SingleRecord` means only one record is used per mini-batch.
             *   `MultiRecord` means a mini-batch is set to contain as many records that can fit
             *   within the `MaxPayloadInMB` limit.
             */
            public fun batchStrategy(batchStrategy: String)

            /**
             * @param environment The environment variables to set in the Docker container. We
            ...
            /**
             * @param maxConcurrentTransforms The maximum number of parallel requests that can be
             *   sent to each instance in a transform job. The default value is 1.
             */
            public fun maxConcurrentTransforms(maxConcurrentTransforms: Number)

            /**
             * @param maxPayloadInMb The maximum payload size allowed, in MB. A payload is the data
            ...
            /**
             * @param transformOutput Identifies the Amazon S3 location where you want Amazon
            ...
            public fun transformResources(
                transformResources: TransformResourcesProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun transformInput(
                transformInput: TransformInputProperty.Builder.() -> Unit
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("1c83a6d8001850c633dde75c66011537a09e384942155594f95a2fe33bda5265")
            override fun transformOutput(
                transformOutput: TransformOutputProperty.Builder.() -> Unit
            ...
            override fun transformResources(transformResources: TransformResourcesProperty) {
                cdkBuilder.transformResources(
                    transformResources.let(TransformResourcesProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("d3b313075a4a02a44f820c052872d95513973bd42395efb835d4dcf14876eb07")
            override fun transformResources(
                transformResources: TransformResourcesProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-sagemaker-modelpackage-transformjobdefinition.html#cfn-sagemaker-modelpackage-transformjobdefinition-maxconcurrenttransforms)
             */
            override fun maxConcurrentTransforms(): Number? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TransformJobDefinitionProperty
            ): software.amazon.awscdk.services.sagemaker.CfnModelPackage.TransformJobDefinitionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ModelMetricsProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param modelDataQuality Metrics that measure the quality of the input data for a
             *   model.
             */
            public fun modelDataQuality(modelDataQuality: IResolvable)
            ...
            public fun modelDataQuality(
                modelDataQuality: ModelDataQualityProperty.Builder.() -> Unit
            )
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("8be727ee25583c3ec6c29082be1cc7efe7e399e251b55833351731e30898d433")
            override fun bias(bias: BiasProperty.Builder.() -> Unit): Unit =
            ...
            @JvmName("757bf78a4853ff1eeaa98fd44d4a3e2086fc93915276e3c2a24c189519a37535")
            override fun explainability(
                explainability: ExplainabilityProperty.Builder.() -> Unit
    ...
    public interface SourceAlgorithmProperty {
        ...
        public interface Builder {
            /**
             * @param algorithmName The name of an algorithm that was used to create the model
             *   package. The algorithm must be either an algorithm resource in your SageMaker
             *   account or an algorithm in AWS Marketplace that you are subscribed to.
             */
            public fun algorithmName(algorithmName: String)

            /**
             * @param modelDataUrl The Amazon S3 path where the model artifacts, which result from
             *   model training, are stored. This path must point to a single `gzip` compressed tar
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SourceAlgorithmProperty
            ): software.amazon.awscdk.services.sagemaker.CfnModelPackage.SourceAlgorithmProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface TransformInputProperty {
         ...
         *
         * Amazon SageMaker automatically decompresses the data for the transform job accordingly.
         ...
         * concurrent mini-batches. The default value for `SplitType` is `None` , which indicates
         * that input data files are not split, and request payloads contain the entire contents of
         * an input object. Set the value of this parameter to `Line` to split records on a newline
         * character boundary. `SplitType` also supports a number of record-oriented binary data
         ...
         * to the `MaxPayloadInMB` limit. If the value of `BatchStrategy` is `SingleRecord` , Amazon
         ...
         * [Create a Dataset Using RecordIO](https://docs.aws.amazon.com/https://mxnet.apache.org/api/faq/recordio)
         * in the MXNet documentation. For more information about `TFRecord` , see
         * [Consuming TFRecord data](https://docs.aws.amazon.com/https://www.tensorflow.org/guide/data#consuming_tfrecord_data)
        ...
        public interface Builder {
            /**
             * @param compressionType If your transform data is compressed, specify the compression
             *   type. Amazon SageMaker automatically decompresses the data for the transform job
             ...
             *   Amazon SageMaker uses the MIME type with each http call to transfer data to the
             *   transform job.
             */
            public fun contentType(contentType: String)

            /**
             * @param dataSource Describes the location of the channel data, which is, the S3
             ...
             *   smaller batches. Splitting is necessary when the total size of each object is too
             *   large to fit in a single request. You can also use data splitting to improve
             *   performance by processing multiple concurrent mini-batches. The default value for
             *   `SplitType` is `None` , which indicates that input data files are not split, and
             *   request payloads contain the entire contents of an input object. Set the value of
             ...
             * When splitting is enabled, the size of a mini-batch depends on the values of the
             * `BatchStrategy` and `MaxPayloadInMB` parameters. When the value of `BatchStrategy` is
             * `MultiRecord` , Amazon SageMaker sends the maximum number of records in each request,
             * up to the `MaxPayloadInMB` limit. If the value of `BatchStrategy` is `SingleRecord` ,
        ...
        internal constructor(
             ...
             * If your transform data is compressed, specify the compression type.
             *
             * Amazon SageMaker automatically decompresses the data for the transform job
             * accordingly. The default value is `None` .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-sagemaker-modelpackage-transforminput.html#cfn-sagemaker-modelpackage-transforminput-compressiontype)
             */
             ...
             * multiple concurrent mini-batches. The default value for `SplitType` is `None` , which
             * indicates that input data files are not split, and request payloads contain the
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TransformInputProperty
            ): software.amazon.awscdk.services.sagemaker.CfnModelPackage.TransformInputProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface TransformOutputProperty {
         ...
         *
         * Amazon SageMaker uses the MIME type with each http call to transfer data from the
         * transform job.
         *
         ...
         * format, specify `None` . To add a newline character at the end of every transformed
         * record, specify `Line` .
         *
         ...
         * S3 for your role's account. For more information, see
        ...
        public interface Builder {
            /**
             * @param accept The MIME type used to specify the output data. Amazon SageMaker uses
             *   the MIME type with each http call to transfer data from the transform job.
             */
            public fun accept(accept: String)

            /**
             * @param assembleWith Defines how to assemble the results of the transform job as a
             *   single S3 object. Choose a format that is most convenient to you. To concatenate
             *   the results in binary format, specify `None` . To add a newline character at the
             *   end of every transformed record, specify `Line` .
             */
            ...
            /**
             * @param s3OutputPath The Amazon S3 path where you want Amazon SageMaker to store the
             *   results of the transform job. For example, `s3://bucket-name/key-name-prefix` .
             *
             * For every S3 object used as input for the transform job, batch transform stores the
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TransformOutputProperty
            ): software.amazon.awscdk.services.sagemaker.CfnModelPackage.TransformOutputProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ModelPackageContainerDefinitionProperty {
         ...
         * The environment variables to set in the Docker container.
         *
         * Each key and value in the `Environment` string to string map can have length of up
        ...
        public interface Builder {
            ...
            /**
             * @param environment The environment variables to set in the Docker container. Each key
             *   and value in the `Environment` string to string map can have length of up to 1024.
            ...
            /**
             * @param image The Amazon EC2 Container Registry (Amazon ECR) path where inference code
            ...
            /**
             * @param imageDigest An MD5 hash of the training algorithm that identifies the Docker
            ...
            /**
             * @param nearestModelName The name of a pre-trained machine learning benchmarked by
             *   Amazon SageMaker Inference Recommender model that matches your model. You can find
             *   a list of benchmarked models by calling `ListModelMetadata` .
             */
        ...
        internal constructor(
             ...
             * SageMaker, the inference code must meet SageMaker requirements. SageMaker supports
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ModelPackageContainerDefinitionProperty
            ): software.amazon.awscdk.services.sagemaker.CfnModelPackage.ModelPackageContainerDefinitionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ModelPackageStatusItemProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param name The name of the model package for which the overall status is being
             *   reported.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ModelPackageStatusItemProperty
            ): software.amazon.awscdk.services.sagemaker.CfnModelPackage.ModelPackageStatusItemProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ModelDataQualityProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ModelDataQualityProperty
            ): software.amazon.awscdk.services.sagemaker.CfnModelPackage.ModelDataQualityProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ValidationSpecificationProperty {
        ...
        public interface Builder {
            /**
             * @param validationProfiles An array of `ModelPackageValidationProfile` objects, each
             *   of which specifies a batch transform job that SageMaker runs to validate your model
             *   package.
             */
            ...
            /**
             * @param validationRole The IAM roles to be used for the validation of the model
             *   package.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ValidationSpecificationProperty
            ): software.amazon.awscdk.services.sagemaker.CfnModelPackage.ValidationSpecificationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface MetadataPropertiesProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: MetadataPropertiesProperty
            ): software.amazon.awscdk.services.sagemaker.CfnModelPackage.MetadataPropertiesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface S3DataSourceProperty {
         ...
         * first element is a prefix which is followed by one or more suffixes. SageMaker appends
         * the suffix elements to the prefix to get a full set of `S3Uri` . Note that the prefix
         * must be a valid non-empty `S3Uri` that precludes users from specifying a manifest whose
        ...
        public interface Builder {
            ...
            /**
             * @param s3Uri Depending on the value specified for the `S3DataType` , identifies
             ...
             * appends the suffix elements to the prefix to get a full set of `S3Uri` . Note that
             * the prefix must be a valid non-empty `S3Uri` that precludes users from specifying a
             * manifest whose individual `S3Uri` is sourced from different S3 buckets.
             *
             * The following code example shows a valid manifest format:
             *
             * `[ {"prefix": "s3://customer_bucket/some/prefix/"},`
             ...
             * this data source. The object that each `S3Uri` points to must be readable by the IAM
             * role that SageMaker uses to perform tasks on your behalf.
             *
             * Your input bucket must be located in same AWS region as your training job.
             */
            public fun s3Uri(s3Uri: String)
    ...
    public interface DataSourceProperty {
        ...
        public interface Builder {
            /**
             * @param s3DataSource The S3 location of the data source that is associated with a
             *   channel.
             */
    ...
    public interface DriftCheckModelDataQualityProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DriftCheckModelDataQualityProperty
            ): software.amazon.awscdk.services.sagemaker.CfnModelPackage.DriftCheckModelDataQualityProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DriftCheckBiasProperty {
        ...
        public interface Builder {
            ...
            public fun postTrainingConstraints(
                postTrainingConstraints: MetricsSourceProperty.Builder.() -> Unit
            )
            ...
            public fun preTrainingConstraints(
                preTrainingConstraints: MetricsSourceProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun postTrainingConstraints(postTrainingConstraints: MetricsSourceProperty) {
                cdkBuilder.postTrainingConstraints(
                    postTrainingConstraints.let(MetricsSourceProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("193e29a0efc44232891916800aafaf7d157acec86ee43ab8157957009d232bfd")
            override fun postTrainingConstraints(
                postTrainingConstraints: MetricsSourceProperty.Builder.() -> Unit
            ...
            override fun preTrainingConstraints(preTrainingConstraints: MetricsSourceProperty) {
                cdkBuilder.preTrainingConstraints(
                    preTrainingConstraints.let(MetricsSourceProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("6159add795ca353ab92fcc28608a3bc1265ddb7fb2d5c91a4a2203d244df165c")
            override fun preTrainingConstraints(
                preTrainingConstraints: MetricsSourceProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DriftCheckBiasProperty
            ): software.amazon.awscdk.services.sagemaker.CfnModelPackage.DriftCheckBiasProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface AdditionalInferenceSpecificationDefinitionProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param name A unique name to identify the additional inference specification. The
             *   name must be unique within the list of your additional inference specifications for
             *   a particular model package.
             */
            public fun name(name: String)
            ...
            /**
             * @param supportedRealtimeInferenceInstanceTypes A list of the instance types that are
             *   used to generate inferences in real-time.
             */
            public fun supportedRealtimeInferenceInstanceTypes(
                supportedRealtimeInferenceInstanceTypes: List<String>
            )
        ...
        internal constructor(
             ...
             * A unique name to identify the additional inference specification.
             *
             * The name must be unique within the list of your additional inference specifications
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AdditionalInferenceSpecificationDefinitionProperty
            ): software.amazon.awscdk.services.sagemaker.CfnModelPackage.AdditionalInferenceSpecificationDefinitionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
