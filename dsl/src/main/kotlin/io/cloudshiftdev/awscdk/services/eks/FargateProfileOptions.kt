...
public interface FargateProfileOptions {
    ...
    public interface Builder {
        ...
        /**
         * @param podExecutionRole The pod execution role to use for pods that match the selectors
         *   in the Fargate profile. The pod execution role allows Fargate infrastructure to
         ...
         *   running on Fargate are not assigned public IP addresses, so only private subnets (with
         *   no direct route to an Internet Gateway) are allowed.
         *
         * You must specify the VPC to customize the subnet selection
         */
    ...
    internal constructor(
         ...
         * node, and it provides read access to Amazon ECR image repositories.
         *
         * Default: - a role will be automatically created
         *
         * [Documentation](https://docs.aws.amazon.com/eks/latest/userguide/pod-execution-role.html)
         */
        override fun podExecutionRole(): IRole? =
            unwrap(this).getPodExecutionRole()?.let(IRole::wrap)

        /**
         * The selectors to match for pods to use this Fargate profile.
         *
         * Each selector must have an associated namespace. Optionally, you can also specify labels
         * for a namespace.
         *
         * At least one selector is required and you may specify up to five selectors.
         */
         ...
         * private subnets (with no direct route to an Internet Gateway) are allowed.
         *
         * You must specify the VPC to customize the subnet selection
         *
         * Default: - all private subnets of the VPC are selected.
