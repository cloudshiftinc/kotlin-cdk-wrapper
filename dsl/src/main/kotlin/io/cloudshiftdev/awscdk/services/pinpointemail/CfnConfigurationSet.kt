...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param sendingOptions An object that defines whether or not Amazon Pinpoint can send
         ...
         *
         * @param trackingOptions An object that defines the open and click tracking options for
         *   emails that you send using the configuration set.
         */
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.pinpointemail.CfnConfigurationSet.Builder.create(
                scope,
                id
            )
    ...
    public interface DeliveryOptionsProperty {
        ...
        public interface Builder {
            /**
             * @param sendingPoolName The name of the dedicated IP pool that you want to associate
             *   with the configuration set.
             */
    ...
    public interface TrackingOptionsProperty {
        ...
        public interface Builder {
            /**
             * @param customRedirectDomain The domain that you want to use for tracking open and
             *   click events.
             */
    ...
    public interface ReputationOptionsProperty {
        ...
        public interface Builder {
            /**
             * @param reputationMetricsEnabled If `true` , tracking of reputation metrics is enabled
             *   for the configuration set. If `false` , tracking of reputation metrics is disabled
