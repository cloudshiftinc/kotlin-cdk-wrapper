...
internal constructor(
    ...
    public interface Builder {
        /**
         * If set to `true` , specifies an alias for a directory and assigns the alias to the
         * directory.
         *
         ...
         * The password for the directory administrator.
         *
         * The directory creation process creates a directory administrator account with the user
