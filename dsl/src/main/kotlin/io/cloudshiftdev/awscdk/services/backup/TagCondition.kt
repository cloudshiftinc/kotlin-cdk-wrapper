...
public interface TagCondition {
    ...
    public interface Builder {
        ...
        /**
         * @param value The value in a key-value pair. For example, in
    ...
    internal constructor(
         ...
         * Default: STRING_EQUALS
         */
        override fun operation(): TagOperation? =
    ...
    public companion object {
        ...
        ): TagCondition = Wrapper(cdkObject)

        internal fun unwrap(
            wrapped: TagCondition
        ): software.amazon.awscdk.services.backup.TagCondition = (wrapped as Wrapper).cdkObject
    }
}
