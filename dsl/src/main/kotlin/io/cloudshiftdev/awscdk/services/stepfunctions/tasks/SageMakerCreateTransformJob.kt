...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param maxConcurrentTransforms Maximum number of parallel requests that can be sent to
         ...
         *
         * @param modelClientOptions Configures the timeout and maximum number of retries for
         ...
         *
         * @param transformOutput S3 location where you want Amazon SageMaker to save the results
    ...
    private class BuilderImpl(
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("a18eba4f02fb1f502cbb95a2024973a630445f1f3d3f54a9f402773f7afcd47a")
        override fun modelClientOptions(
            modelClientOptions: ModelClientOptions.Builder.() -> Unit
        ): Unit = modelClientOptions(ModelClientOptions(modelClientOptions))
        ...
        override fun transformResources(
            transformResources: TransformResources.Builder.() -> Unit
        ): Unit = transformResources(TransformResources(transformResources))
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: SageMakerCreateTransformJob
        ): software.amazon.awscdk.services.stepfunctions.tasks.SageMakerCreateTransformJob =
            wrapped.cdkObject
    }
}
