...
internal constructor(
    ...
    public interface Builder {
         ...
         * comma-delimited list parameters must be of type `String` . In other words, you can't pass
         * values that are of type `CommaDelimitedList` to nested stacks.
         *
         ...
         *
         * The default is no timeout. When CloudFormation detects that the nested stack has reached
         * the `CREATE_COMPLETE` state, it marks the nested stack resource as `CREATE_COMPLETE` in
         * the parent stack and resumes creating the parent stack. If the timeout period expires
         * before the nested stack reaches `CREATE_COMPLETE` , CloudFormation marks the nested stack
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.cloudformation.CfnStack =
            cdkBuilder.build()
    }
    ...
    public companion object {
        ...
        ): CfnStack = CfnStack(cdkObject)

        internal fun unwrap(
            wrapped: CfnStack
        ): software.amazon.awscdk.services.cloudformation.CfnStack = wrapped.cdkObject
    }
