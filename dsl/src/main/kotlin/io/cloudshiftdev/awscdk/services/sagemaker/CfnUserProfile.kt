...
internal constructor(
    ...
    public interface Builder {
         ...
         * Identity Center , this field is required. If the Domain's AuthMode is not IAM Identity
         ...
         * The username of the associated AWS Single Sign-On User for this UserProfile.
         *
         * If the Domain's AuthMode is IAM Identity Center , this field is required, and must match
         * a valid username of a user in your directory. If the Domain's AuthMode is not IAM
         ...
         *
         * @param singleSignOnUserValue The username of the associated AWS Single Sign-On User for
         *   this UserProfile.
         */
         ...
         *
         * @param userSettings A collection of settings that apply to users of Amazon SageMaker
         *   Studio.
         */
