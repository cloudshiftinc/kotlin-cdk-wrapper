...
internal constructor(
    ...
    /**
     * The list of IDs of EULAs that must be accepted before a streaming session can be started
    ...
    public interface Builder {
         ...
         *
         * @param ec2ImageId The ID of an EC2 machine image with which to create the streaming
         *   image.
         */
    ...
    public interface StreamingImageEncryptionConfigurationProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: StreamingImageEncryptionConfigurationProperty
            ): software.amazon.awscdk.services.nimblestudio.CfnStreamingImage.StreamingImageEncryptionConfigurationProperty =
