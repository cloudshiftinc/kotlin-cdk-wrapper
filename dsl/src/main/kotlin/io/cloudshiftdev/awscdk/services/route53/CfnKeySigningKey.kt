...
internal constructor(
    ...
    public interface Builder {
        ...
        /**
         * The Amazon resource name (ARN) for a customer managed customer master key (CMK) in AWS
         ...
         *   resolve. For example, the customer managed key might have been deleted, or the
         *   permissions for the customer managed key might have been changed.
         * * **INTERNAL_FAILURE** - There was an error during a request. Before you can continue to
         *   work with DNSSEC signing, including actions that involve this KSK, you must correct the
         *   problem. For example, you may need to activate or deactivate the KSK.
         *
