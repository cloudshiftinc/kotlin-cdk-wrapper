...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param parameterGroupFamily The name of the cluster parameter group family that this
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.redshift.CfnClusterParameterGroup.Builder.create(
                scope,
                id
            )
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnClusterParameterGroup
    ...
    public interface ParameterProperty {
         ...
         *
         * If `ParameterName` is `wlm_json_configuration` , then the maximum size of
        ...
        public interface Builder {
             ...
             *   `wlm_json_configuration` , then the maximum size of `ParameterValue` is 8000
             *   characters.
             */
