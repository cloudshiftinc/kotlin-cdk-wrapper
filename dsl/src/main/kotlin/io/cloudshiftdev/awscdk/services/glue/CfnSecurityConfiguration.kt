...
internal constructor(
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnSecurityConfiguration
    ...
    public interface EncryptionConfigurationProperty {
        ...
        public interface Builder {
            ...
            public fun cloudWatchEncryption(
                cloudWatchEncryption: CloudWatchEncryptionProperty.Builder.() -> Unit
            )
            ...
            public fun jobBookmarksEncryption(
                jobBookmarksEncryption: JobBookmarksEncryptionProperty.Builder.() -> Unit
            )

            /**
             * @param s3Encryptions The encyption configuration for Amazon Simple Storage Service
             *   (Amazon S3) data.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            override fun cloudWatchEncryption(cloudWatchEncryption: CloudWatchEncryptionProperty) {
                cdkBuilder.cloudWatchEncryption(
                    cloudWatchEncryption.let(CloudWatchEncryptionProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("5af6550f41429b699a193a796c9b24ca0ecfabb293a337f25a4adfad5abbdcee")
            override fun cloudWatchEncryption(
                cloudWatchEncryption: CloudWatchEncryptionProperty.Builder.() -> Unit
            ...
            /** @param jobBookmarksEncryption The encryption configuration for job bookmarks. */
            override fun jobBookmarksEncryption(
                jobBookmarksEncryption: JobBookmarksEncryptionProperty
            ) {
                cdkBuilder.jobBookmarksEncryption(
                    jobBookmarksEncryption.let(JobBookmarksEncryptionProperty::unwrap)
                )
            }
    ...
    public interface CloudWatchEncryptionProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param kmsKeyArn The Amazon Resource Name (ARN) of the KMS key to be used to encrypt
             *   the data.
             */
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-glue-securityconfiguration-cloudwatchencryption.html#cfn-glue-securityconfiguration-cloudwatchencryption-cloudwatchencryptionmode)
             */
            override fun cloudWatchEncryptionMode(): String? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CloudWatchEncryptionProperty
            ): software.amazon.awscdk.services.glue.CfnSecurityConfiguration.CloudWatchEncryptionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface JobBookmarksEncryptionProperty {
         ...
         */
        public fun jobBookmarksEncryptionMode(): String? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: JobBookmarksEncryptionProperty
            ): software.amazon.awscdk.services.glue.CfnSecurityConfiguration.JobBookmarksEncryptionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
