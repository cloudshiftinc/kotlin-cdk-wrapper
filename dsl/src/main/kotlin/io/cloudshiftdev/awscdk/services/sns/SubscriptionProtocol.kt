...
public enum class SubscriptionProtocol(
    ...
    public companion object {
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.sns.SubscriptionProtocol
        ): SubscriptionProtocol =
            when (cdkObject) {
                software.amazon.awscdk.services.sns.SubscriptionProtocol.HTTP ->
                    SubscriptionProtocol.HTTP
                software.amazon.awscdk.services.sns.SubscriptionProtocol.HTTPS ->
                    SubscriptionProtocol.HTTPS
                software.amazon.awscdk.services.sns.SubscriptionProtocol.EMAIL ->
                ...
                software.amazon.awscdk.services.sns.SubscriptionProtocol.SMS ->
                    SubscriptionProtocol.SMS
                software.amazon.awscdk.services.sns.SubscriptionProtocol.SQS ->
                ...
                software.amazon.awscdk.services.sns.SubscriptionProtocol.LAMBDA ->
