...
internal constructor(
    ...
    public open fun expiryEventsConfiguration(`value`: ExpiryEventsConfigurationProperty) {
        unwrap(this)
            .setExpiryEventsConfiguration(`value`.let(ExpiryEventsConfigurationProperty::unwrap))
    }

    /** Object containing expiration events options associated with an AWS account . */
    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("43b541d7a8a7127a670a63095163b0fae9efafc0040432ef74e332281800813b")
    public open fun expiryEventsConfiguration(
        `value`: ExpiryEventsConfigurationProperty.Builder.() -> Unit
    ...
    public interface Builder {
         ...
         *
         * @param expiryEventsConfiguration Object containing expiration events options associated
         *   with an AWS account .
         */
        ...
        public fun expiryEventsConfiguration(
            expiryEventsConfiguration: ExpiryEventsConfigurationProperty.Builder.() -> Unit
        )
    }
    ...
    private class BuilderImpl(
         ...
         *   with an AWS account .
         */
        override fun expiryEventsConfiguration(
            expiryEventsConfiguration: ExpiryEventsConfigurationProperty
        ) {
            cdkBuilder.expiryEventsConfiguration(
                expiryEventsConfiguration.let(ExpiryEventsConfigurationProperty::unwrap)
            )
        }
    ...
    public interface ExpiryEventsConfigurationProperty {
        ...
        public interface Builder {
             ...
             *   expiration when ACM starts generating `EventBridge` events. ACM sends one event per
             *   day per certificate until the certificate expires. By default, accounts receive
        ...
        internal constructor(
             ...
             * starts generating `EventBridge` events.
             *
             * ACM sends one event per day per certificate until the certificate expires. By
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ExpiryEventsConfigurationProperty
            ): software.amazon.awscdk.services.certificatemanager.CfnAccount.ExpiryEventsConfigurationProperty =
