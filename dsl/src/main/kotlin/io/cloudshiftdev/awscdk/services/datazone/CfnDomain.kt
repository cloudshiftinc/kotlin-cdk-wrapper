...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param domainExecutionRole The domain execution role that is created when an Amazon
         *   DataZone domain is created.
         */
        public fun domainExecutionRole(domainExecutionRole: String)

        /**
         * The identifier of the AWS Key Management Service (KMS) key that is used to encrypt the
         ...
         *
         * @param kmsKeyIdentifier The identifier of the AWS Key Management Service (KMS) key that
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnDomain
        ): software.amazon.awscdk.services.datazone.CfnDomain = wrapped.cdkObject
    }
