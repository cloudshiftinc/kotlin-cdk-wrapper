...
public enum class KeySpec(
    ...
    public companion object {
        internal fun wrap(cdkObject: software.amazon.awscdk.services.kms.KeySpec): KeySpec =
            when (cdkObject) {
                software.amazon.awscdk.services.kms.KeySpec.SYMMETRIC_DEFAULT ->
                ...
                software.amazon.awscdk.services.kms.KeySpec.ECC_SECG_P256K1 ->
