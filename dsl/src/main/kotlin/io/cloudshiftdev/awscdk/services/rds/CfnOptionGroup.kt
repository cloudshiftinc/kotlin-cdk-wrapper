...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param majorEngineVersion Specifies the major version of the engine that this option
         ...
         *
         * If you don't specify a value for `OptionGroupName` property, a name is automatically
         * created for the option group.
         *
    ...
    public companion object {
        ...
        ): CfnOptionGroup = CfnOptionGroup(cdkObject)

        internal fun unwrap(
            wrapped: CfnOptionGroup
        ): software.amazon.awscdk.services.rds.CfnOptionGroup = wrapped.cdkObject
    }
    ...
    public interface OptionConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param dbSecurityGroupMemberships A list of DBSecurityGroupMembership name strings
            ...
            /**
             * @param vpcSecurityGroupMemberships A list of VpcSecurityGroupMembership name strings
             *   used for this option.
             */
        ...
        private class BuilderImpl : Builder {
             ...
             *   used for this option.
             */
            override fun dbSecurityGroupMemberships(
                vararg dbSecurityGroupMemberships: String
            ): Unit = dbSecurityGroupMemberships(dbSecurityGroupMemberships.toList())
             ...
             *   used for this option.
             */
            override fun vpcSecurityGroupMemberships(
                vararg vpcSecurityGroupMemberships: String
            ): Unit = vpcSecurityGroupMemberships(vpcSecurityGroupMemberships.toList())
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: OptionConfigurationProperty
            ): software.amazon.awscdk.services.rds.CfnOptionGroup.OptionConfigurationProperty =
