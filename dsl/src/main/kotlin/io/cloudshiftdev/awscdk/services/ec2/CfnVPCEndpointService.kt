...
internal constructor(
     ...
     * PrivateLink .
     */
    public open fun contributorInsightsEnabled(): Any? =
    ...
    public interface Builder {
         ...
         * The entity that is responsible for the endpoint costs.
         *
         * The default is the endpoint owner. If you set the payer responsibility to the service
    ...
    private class BuilderImpl(
        ...
        override fun contributorInsightsEnabled(contributorInsightsEnabled: IResolvable) {
            cdkBuilder.contributorInsightsEnabled(
                contributorInsightsEnabled.let(IResolvable::unwrap)
            )
        }
