...
internal constructor(
    ...
    public companion object {
        public fun fromProductArn(
            ...
            software.amazon.awscdk.services.servicecatalog.Product.fromProductArn(
        ...
        ): Product = Wrapper(cdkObject)

        internal fun unwrap(
            wrapped: Product
        ): software.amazon.awscdk.services.servicecatalog.Product = (wrapped as Wrapper).cdkObject
    }
}
