...
internal constructor(
    ...
    public open fun cors(`value`: CorsProperty.Builder.() -> Unit): Unit =
        cors(CorsProperty(`value`))
    ...
    public interface Builder {
         ...
         * The type of authentication that your function URL uses.
         *
         * Set to `AWS_IAM` if you want to restrict access to authenticated users only. Set to
         * `NONE` if you want to bypass IAM authentication to create a public endpoint. For more
         * information, see
         ...
         *   `Invoke` API operation. Invocation results are available when the payload is complete.
         ...
         *   maximum response payload size is 20 MB, however, you can
    ...
    public interface CorsProperty {
        ...
        public interface Builder {
            /**
             * @param allowCredentials Whether you want to allow cookies or other credentials in
             *   requests to your function URL. The default is `false` .
             */
            ...
            /**
             * @param allowHeaders The HTTP headers that origins can include in requests to your
            ...
            /**
             * @param allowOrigins The origins that can access your function URL. You can list any
            ...
            /**
             * @param exposeHeaders The HTTP headers in your function response that you want to
            ...
            /**
             * @param maxAge The maximum amount of time, in seconds, that browsers can cache results
             *   of a preflight request. By default, this is set to `0` , which means the browser
        ...
        internal constructor(
            ...
            /**
             * Whether you want to allow cookies or other credentials in requests to your function
             * URL.
             *
             * The default is `false` .
             *
            ...
            /**
             * The maximum amount of time, in seconds, that browsers can cache results of a
             * preflight request.
             *
             * By default, this is set to `0` , which means the browser will not cache results.
             *
