...
internal constructor(
    ...
    public interface Builder {
         ...
         * Specifies the value or list of values for the dimension.
         *
         * For `TOPIC_FILTER` dimensions, this is a pattern used to match the MQTT topic (for
         * example, "admin/#").
         *
    ...
    public companion object {
        ...
        ): CfnDimension = CfnDimension(cdkObject)

        internal fun unwrap(
            wrapped: CfnDimension
        ): software.amazon.awscdk.services.iot.CfnDimension = wrapped.cdkObject
    }
}
