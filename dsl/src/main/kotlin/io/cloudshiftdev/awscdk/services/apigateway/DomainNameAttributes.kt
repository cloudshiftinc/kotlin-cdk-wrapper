...
public interface DomainNameAttributes {
    ...
    public interface Builder {
        ...
        /**
         * @param domainNameAliasHostedZoneId The Route53 hosted zone ID to use in order to connect
         *   a record set to this domain through an alias.
         */
        public fun domainNameAliasHostedZoneId(domainNameAliasHostedZoneId: String)

        /**
         * @param domainNameAliasTarget The Route53 alias target to use in order to connect a record
         *   set to this domain through an alias.
         */
    ...
    internal constructor(
        ...
        /**
         * The Route53 hosted zone ID to use in order to connect a record set to this domain through
         * an alias.
         */
        ...
        /**
         * The Route53 alias target to use in order to connect a record set to this domain through
         * an alias.
         */
