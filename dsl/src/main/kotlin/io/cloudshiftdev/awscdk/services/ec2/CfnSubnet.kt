...
internal constructor(
    ...
    public interface Builder {
         ...
         * record queries to the instances should be handled.
         *
         * For more information, see
         ...
         *
         * @param privateDnsNameOptionsOnLaunch The hostname type for EC2 instances launched into
         *   this subnet and how DNS A and AAAA record queries to the instances should be handled.
         */
    ...
    private class BuilderImpl(
        ...
        override fun assignIpv6AddressOnCreation(assignIpv6AddressOnCreation: IResolvable) {
            cdkBuilder.assignIpv6AddressOnCreation(
                assignIpv6AddressOnCreation.let(IResolvable::unwrap)
            )
        }
    ...
    public interface PrivateDnsNameOptionsOnLaunchProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: PrivateDnsNameOptionsOnLaunchProperty
            ): software.amazon.awscdk.services.ec2.CfnSubnet.PrivateDnsNameOptionsOnLaunchProperty =
