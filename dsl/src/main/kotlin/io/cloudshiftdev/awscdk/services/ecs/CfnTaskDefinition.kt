...
internal constructor(
    ...
    public open fun proxyConfiguration(
        `value`: ProxyConfigurationProperty.Builder.() -> Unit
    ): Unit = proxyConfiguration(ProxyConfigurationProperty(`value`))
    ...
    public interface Builder {
         ...
         * The number of `cpu` units used by the task.
         *
         * If you use the EC2 launch type, this field is optional. Any value can be used. If you use
         * the Fargate launch type, this field is required. You must use one of the following
         * values. The value that you choose determines your range of valid values for the `memory`
         * parameter.
         *
         ...
         * * 2048 (2 vCPU) - Available `memory` values: 4096 (4 GB) and 16384 (16 GB) in increments
         *   of 1024 (1 GB)
         * * 4096 (4 vCPU) - Available `memory` values: 8192 (8 GB) and 30720 (30 GB) in increments
         *   of 1024 (1 GB)
         ...
         *   grants the Amazon ECS container agent permission to make AWS API calls on your behalf.
         */
         ...
         *
         * @param inferenceAccelerators The Elastic Inference accelerators to use for the containers
         *   in the task.
         */
         ...
         * containers within the tasks that specified the `host` IPC mode on the same container
         * instance share the same IPC resources with the host Amazon EC2 instance. If `task` is
         * specified, all containers within the specified task share the same IPC resources. If
         * `none` is specified, then IPC resources within the containers of a task are private and
         * not shared with other containers in a task or on the container instance. If no value is
         * specified, then the IPC resource namespace sharing depends on the Docker daemon setting
         * on the container instance. For more information, see
         ...
         * on Amazon EC2 Windows instances, `&lt;default&gt;` or `awsvpc` can be used. If the
         ...
         * with the task definition. For more information, see
         ...
         * The process namespace to use for the containers in the task.
         *
         * The valid values are `host` or `task` . On Fargate for Linux containers, the only valid
         * value is `task` . For example, monitoring sidecars might need `pidMode` to access
         ...
         * supported for tasks that are hosted on AWS Fargate if the tasks are using platform
         ...
         * Management role that grants containers in the task permission to call AWS APIs on your
         * behalf.
         *
         * For more information, see
         ...
         * configuration code to use the feature. For more information, see
         ...
         *
         * @param taskRoleArn The short name or full Amazon Resource Name (ARN) of the AWS Identity
         *   and Access Management role that grants containers in the task permission to call AWS
         *   APIs on your behalf.
         */
    ...
    private class BuilderImpl(
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("55c109b01f495e4bfa184cbae89955095d1c5c2165048e7b490d60c7db60ea54")
        override fun runtimePlatform(
            runtimePlatform: RuntimePlatformProperty.Builder.() -> Unit
        ...
        public fun build(): software.amazon.awscdk.services.ecs.CfnTaskDefinition =
            cdkBuilder.build()
    }
    ...
    public interface HostVolumePropertiesProperty {
         ...
         * the `host` parameter contains a `sourcePath` file location, then the data volume persists
         * at the specified location on the host container instance until you delete it manually. If
         * the `sourcePath` value doesn't exist on the host container instance, the Docker daemon
        ...
        public interface Builder {
             ...
             *   volume persists at the specified location on the host container instance until you
             *   delete it manually. If the `sourcePath` value doesn't exist on the host container
             *   instance, the Docker daemon creates it. If the location does exist, the contents of
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: HostVolumePropertiesProperty
            ): software.amazon.awscdk.services.ecs.CfnTaskDefinition.HostVolumePropertiesProperty =
    ...
    public interface SystemControlProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param value The namespaced kernel parameter to set a `value` for. Valid IPC
             *   namespace values: `"kernel.msgmax" | "kernel.msgmnb" | "kernel.msgmni" |
             *   "kernel.sem" | "kernel.shmall" | "kernel.shmmax" | "kernel.shmmni" |
             *   "kernel.shm_rmid_forced"` , and `Sysctls` that start with `"fs.mqueue.*"`
             *
             * Valid network namespace values: `Sysctls` that start with `"net.*"`
    ...
    public interface FirelensConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param options The options to use when configuring the log router. This field is
             *   optional and can be used to add additional metadata, such as the task, task
             *   definition, cluster, and container instance details to the log event.
             *
             * If specified, valid option keys are:
             * * `enable-ecs-log-metadata` , which can be `true` or `false`
        ...
        internal constructor(
             ...
             * The options to use when configuring the log router.
             *
             * This field is optional and can be used to add additional metadata, such as the task,
             * task definition, cluster, and container instance details to the log event.
             *
             * If specified, valid option keys are:
             * * `enable-ecs-log-metadata` , which can be `true` or `false`
             * * `config-file-type` , which can be `s3` or `file`
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: FirelensConfigurationProperty
            ): software.amazon.awscdk.services.ecs.CfnTaskDefinition.FirelensConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface TmpfsProperty {
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ecs-taskdefinition-tmpfs.html#cfn-ecs-taskdefinition-tmpfs-mountoptions)
             */
            override fun mountOptions(): List<String> =
                unwrap(this).getMountOptions() ?: emptyList()
    ...
    public interface EnvironmentFileProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: EnvironmentFileProperty
            ): software.amazon.awscdk.services.ecs.CfnTaskDefinition.EnvironmentFileProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface VolumeFromProperty {
         ...
         *
         * If this value is `false` , then the container can write to the volume. The default value
         * is `false` .
         *
        ...
        public interface Builder {
            /**
             * @param readOnly If this value is `true` , the container has read-only access to the
             *   volume. If this value is `false` , then the container can write to the volume. The
            ...
            /**
             * @param sourceContainer The name of another container within the same task definition
    ...
    public interface DockerVolumeConfigurationProperty {
         ...
         * task placement. If the driver was installed using the Docker plugin CLI, use `docker
         * plugin ls` to retrieve the driver name from your container instance. If the driver was
         * installed using another method, use Docker plugin discovery to retrieve the driver name.
         * For more information, see
         * [Docker plugin discovery](https://docs.aws.amazon.com/https://docs.docker.com/engine/extend/plugin_api/#plugin-discovery)
         ...
         * [docker volume create](https://docs.aws.amazon.com/https://docs.docker.com/engine/reference/commandline/volume_create/)
         * .
         *
        ...
        public interface Builder {
            /**
             * @param autoprovision If this value is `true` , the Docker volume is created if it
            ...
            /**
             * @param driver The Docker volume driver to use. The driver value must match the driver
             *   name provided by Docker because it is used for task placement. If the driver was
            ...
            /**
             * @param driverOpts A map of Docker driver-specific options passed through. This
            ...
            /**
             * @param labels Custom metadata to add to your Docker volume. This parameter maps to
             *   `Labels` in the
             *   [Create a volume](https://docs.aws.amazon.com/https://docs.docker.com/engine/api/v1.35/#operation/VolumeCreate)
             *   section of the
             *   [Docker Remote API](https://docs.aws.amazon.com/https://docs.docker.com/engine/api/v1.35/)
             ...
             *   volumes that are scoped to a `task` are automatically provisioned when the task
        ...
        internal constructor(
             ...
             * The driver value must match the driver name provided by Docker because it is used for
             * task placement. If the driver was installed using the Docker plugin CLI, use `docker
             * plugin ls` to retrieve the driver name from your container instance. If the driver
             * was installed using another method, use Docker plugin discovery to retrieve the
             ...
             * The scope for the Docker volume that determines its lifecycle.
             *
             * Docker volumes that are scoped to a `task` are automatically provisioned when the
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DockerVolumeConfigurationProperty
            ): software.amazon.awscdk.services.ecs.CfnTaskDefinition.DockerVolumeConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface EFSVolumeConfigurationProperty {
         ...
         * [EFS mount helper](https://docs.aws.amazon.com/efs/latest/ug/efs-mount-helper.html) in
        ...
        public interface Builder {
            /**
             * @param authorizationConfig The authorization configuration details for the Amazon EFS
             *   file system.
             */
            ...
            public fun authorizationConfig(
                authorizationConfig: AuthorizationConfigProperty.Builder.() -> Unit
            )
            ...
            /**
             * @param rootDirectory The directory within the Amazon EFS file system to mount as the
             *   root directory inside the host. If this parameter is omitted, the root of the
             ...
             *   transit between the Amazon ECS host and the Amazon EFS server. Transit encryption
             *   must be turned on if Amazon EFS IAM authorization is used. If this parameter is
             ...
             *   Amazon ECS host and the Amazon EFS server. If you do not specify a transit
             *   encryption port, it will use the port selection strategy that the Amazon EFS mount
        ...
        private class BuilderImpl : Builder {
            ...
            override fun authorizationConfig(authorizationConfig: AuthorizationConfigProperty) {
                cdkBuilder.authorizationConfig(
                    authorizationConfig.let(AuthorizationConfigProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("a43a14e096c85e15a78eec7ef1bbe5a3cb80d900972837ecf8db4370d73749b4")
            override fun authorizationConfig(
                authorizationConfig: AuthorizationConfigProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             *
             * Transit encryption must be turned on if Amazon EFS IAM authorization is used. If this
             * parameter is omitted, the default value of `DISABLED` is used. For more information,
             * see
             * [Encrypting data in transit](https://docs.aws.amazon.com/efs/latest/ug/encryption-in-transit.html)
             * in the *Amazon Elastic File System User Guide* .
             *
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: EFSVolumeConfigurationProperty
            ): software.amazon.awscdk.services.ecs.CfnTaskDefinition.EFSVolumeConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface MountPointProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param sourceVolume The name of the volume to mount. Must be a volume name referenced
    ...
    public interface AuthorizationConfigProperty {
         ...
         * set on the EFS access point. If an access point is used, transit encryption must be on in
         * the `EFSVolumeConfiguration` . For more information, see
         ...
         * . If this parameter is omitted, the default value of `DISABLED` is used. For more
         * information, see
        ...
        public interface Builder {
             ...
             *   specified, the root directory value specified in the `EFSVolumeConfiguration` must
             *   either be omitted or set to `/` which will enforce the path set on the EFS access
            ...
            /**
             * @param iam Determines whether to use the Amazon ECS task role defined in a task
             *   definition when mounting the Amazon EFS file system. If it is turned on, transit
             *   encryption must be turned on in the `EFSVolumeConfiguration` . If this parameter is
             *   omitted, the default value of `DISABLED` is used. For more information, see
             *   [Using Amazon EFS access points](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/efs-volumes.html#efs-volume-accesspoints)
             *   in the *Amazon Elastic Container Service Developer Guide* .
             */
        ...
        internal constructor(
             ...
             * path set on the EFS access point. If an access point is used, transit encryption must
             * be on in the `EFSVolumeConfiguration` . For more information, see
             * [Working with Amazon EFS access points](https://docs.aws.amazon.com/efs/latest/ug/efs-access-points.html)
             * in the *Amazon Elastic File System User Guide* .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ecs-taskdefinition-authorizationconfig.html#cfn-ecs-taskdefinition-authorizationconfig-accesspointid)
             ...
             * mounting the Amazon EFS file system.
             *
             * If it is turned on, transit encryption must be turned on in the
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AuthorizationConfigProperty
            ): software.amazon.awscdk.services.ecs.CfnTaskDefinition.AuthorizationConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface InferenceAcceleratorProperty {
        ...
        public interface Builder {
            /**
             * @param deviceName The Elastic Inference accelerator device name. The `deviceName`
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: InferenceAcceleratorProperty
            ): software.amazon.awscdk.services.ecs.CfnTaskDefinition.InferenceAcceleratorProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface TaskDefinitionPlacementConstraintProperty {
        ...
        public interface Builder {
            /**
             * @param expression A cluster query language expression to apply to the constraint. For
             *   more information, see
             *   [Cluster query language](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/cluster-query-language.html)
             *   in the *Amazon Elastic Container Service Developer Guide* .
             */
            ...
            /**
             * @param type The type of constraint. The `MemberOf` constraint restricts selection to
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TaskDefinitionPlacementConstraintProperty
            ): software.amazon.awscdk.services.ecs.CfnTaskDefinition.TaskDefinitionPlacementConstraintProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface RuntimePlatformProperty {
        ...
        public interface Builder {
            /**
             * @param cpuArchitecture The CPU architecture. You can run your Linux tasks on an
             *   ARM-based platform by setting the value to `ARM64` . This option is available for
             *   tasks that run on Linux Amazon EC2 instance or Linux containers on Fargate.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RuntimePlatformProperty
            ): software.amazon.awscdk.services.ecs.CfnTaskDefinition.RuntimePlatformProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ContainerDependencyProperty {
        ...
        public interface Builder {
            /**
             * @param condition The dependency condition of the container. The following are the
             ...
             * * `COMPLETE` - This condition validates that a dependent container runs to completion
             *   (exits) before permitting other containers to start. This can be useful for
             *   nonessential containers that run a script and then exit. This condition can't be
             ...
             * * `HEALTHY` - This condition validates that the dependent container passes its Docker
             *   health check before permitting other containers to start. This requires that the
             *   dependent container has health checks configured. This condition is confirmed only
             *   at task startup.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ContainerDependencyProperty
            ): software.amazon.awscdk.services.ecs.CfnTaskDefinition.ContainerDependencyProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface KeyValuePairProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param value The value of the key-value pair. For environment variables, this is the
    ...
    public interface DeviceProperty {
        ...
        public interface Builder {
            /**
             * @param containerPath The path inside the container at which to expose the host
             *   device.
             */
            public fun containerPath(containerPath: String)
            ...
            /**
             * @param permissions The explicit permissions to provide to the container for the
        ...
        private class BuilderImpl : Builder {
             ...
             *   `mknod` for the device.
             */
            override fun permissions(vararg permissions: String): Unit =
    ...
    public interface LinuxParametersProperty {
         ...
         *
         * This parameter maps to `Devices` in the
         ...
         *
         * This parameter will be translated to the `--memory-swap` option to
         * [docker run](https://docs.aws.amazon.com/https://docs.docker.com/engine/reference/run/#security-configuration)
         ...
         *
         * This parameter maps to the `--shm-size` option to
         * [docker run](https://docs.aws.amazon.com/https://docs.docker.com/engine/reference/run/#security-configuration)
         * .
         *
         ...
         *
         * A `swappiness` value of `0` will cause swapping to not happen unless absolutely
         ...
         * `swappiness` parameter is not specified, a default value of `60` is used. If a value is
         * not specified for `maxSwap` then this parameter is ignored. This parameter maps to the
        ...
        public interface Builder {
            /**
             * @param capabilities The Linux capabilities for the container that are added to or
            ...
            /**
             * @param devices Any host devices to expose to the container. This parameter maps to
             *   `Devices` in the
             *   [Create a container](https://docs.aws.amazon.com/https://docs.docker.com/engine/api/v1.35/#operation/ContainerCreate)
             *   section of the
             *   [Docker Remote API](https://docs.aws.amazon.com/https://docs.docker.com/engine/api/v1.35/)
            ...
            /**
             * @param initProcessEnabled Run an `init` process inside the container that forwards
             *   signals and reaps processes. This parameter maps to the `--init` option to
             *   [docker run](https://docs.aws.amazon.com/https://docs.docker.com/engine/reference/run/#security-configuration)
             *   . This parameter requires version 1.25 of the Docker Remote API or greater on your
            ...
            /**
             * @param maxSwap The total amount of swap memory (in MiB) a container can use. This
             ...
             * If a `maxSwap` value of `0` is specified, the container will not use swap. Accepted
             * values are `0` or any positive integer. If the `maxSwap` parameter is omitted, the
             * container will use the swap configuration for the container instance it is running
             * on. A `maxSwap` value must be set for the `swappiness` parameter to be used.
             *
             * If you're using tasks that use the Fargate launch type, the `maxSwap` parameter isn't
             * supported.
             *
             ...
             *   value is not specified for `maxSwap` then this parameter is ignored. This parameter
             *   maps to the `--memory-swappiness` option to
             *   [docker run](https://docs.aws.amazon.com/https://docs.docker.com/engine/reference/run/#security-configuration)
             *   .
             *
        ...
        private class BuilderImpl : Builder {
            ...
            override fun capabilities(
                capabilities: KernelCapabilitiesProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * necessary. A `swappiness` value of `100` will cause pages to be swapped very
             * aggressively. Accepted values are whole numbers between `0` and `100` . If the
             * `swappiness` parameter is not specified, a default value of `60` is used. If a value
             * is not specified for `maxSwap` then this parameter is ignored. This parameter maps to
             * the `--memory-swappiness` option to
             * [docker run](https://docs.aws.amazon.com/https://docs.docker.com/engine/reference/run/#security-configuration)
             * .
             *
             * If you're using tasks that use the Fargate launch type, the `swappiness` parameter
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: LinuxParametersProperty
            ): software.amazon.awscdk.services.ecs.CfnTaskDefinition.LinuxParametersProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ContainerDefinitionProperty {
         ...
         * [Amazon EC2 Instances](https://docs.aws.amazon.com/ec2/instance-types/) detail page by
         * 1,024.
         *
         ...
         * in the Docker documentation. The minimum valid CPU share value that the Linux kernel
         * allows is
         ...
         *   Docker as 0, which Docker then converts to 1,024 CPU shares. CPU values of 1 are passed
         *   to Docker as 1, which the Linux kernel converts to two CPU shares.
         ...
         *   provide a `CredSpec` with an additional section for a secret in AWS Secrets Manager .
         ...
         * AWS Secrets Manager for a secret containing the username, password, and the domain to
         * connect to. For better security, the instance isn't joined to the domain for domainless
         * authentication. Other applications on the instance can't use the domainless credentials.
         * You can use this parameter to run tasks on the same instance, even it the tasks need to
         * join different domains. For more information, see
         ...
         */
        public fun credentialSpecs(): List<String> =
            unwrap(this).getCredentialSpecs() ?: emptyList()
         ...
         */
        public fun dnsSearchDomains(): List<String> =
            unwrap(this).getDnsSearchDomains() ?: emptyList()
         ...
         */
        public fun dockerSecurityOptions(): List<String> =
         ...
         * *image* : *tag*` or `*repository-url* / *image* &#64; *digest*` . Up to 255 letters
         ...
         * letters (uppercase and lowercase), numbers, underscores, and hyphens are allowed. For
         ...
         * collocated on a single container instance may be able to communicate with each other
         * without requiring links or host port mappings. Network isolation is achieved on the
         ...
         * the container may use a different logging driver than the Docker daemon by specifying a
         * log driver with this parameter in the container definition. To use a different logging
         ...
         * on the options for different supported log drivers, see
         ...
         * The total amount of memory reserved for all containers within a task must be lower than
         ...
         *
         * When system memory is under heavy contention, Docker attempts to keep the container
         * memory to this soft limit. However, your container can consume more memory when it needs
         * to, up to either the hard limit specified with the `memory` parameter (if applicable), or
         * all of the available memory on the container instance, whichever comes first. This
         * parameter maps to `MemoryReservation` in the
         * [Create a container](https://docs.aws.amazon.com/https://docs.docker.com/engine/api/v1.35/#operation/ContainerCreate)
         * section of the
         * [Docker Remote API](https://docs.aws.amazon.com/https://docs.docker.com/engine/api/v1.35/)
         ...
         * container can be entered in the `links` of another container to connect the containers.
         ...
         * is no loopback for port mappings on Windows, so you cannot access a container's mapped
         * port from the host itself.
         *
         ...
         *
         * This parameter maps to `Tty` in the
         * [Create a container](https://docs.aws.amazon.com/https://docs.docker.com/engine/api/v1.35/#operation/ContainerCreate)
         * section of the
         * [Docker Remote API](https://docs.aws.amazon.com/https://docs.docker.com/engine/api/v1.35/)
         ...
         *
         * For tasks that use the EC2 launch type, if the `stopTimeout` parameter isn't specified,
        ...
        public interface Builder {
            /**
             * @param command The command that's passed to the container. This parameter maps to
             *   `Cmd` in the
             *   [Create a container](https://docs.aws.amazon.com/https://docs.docker.com/engine/api/v1.35/#operation/ContainerCreate)
             *   section of the
             *   [Docker Remote API](https://docs.aws.amazon.com/https://docs.docker.com/engine/api/v1.35/)
            ...
            /**
             * @param cpu The number of `cpu` units reserved for the container. This parameter maps
             *   to `CpuShares` in the
             *   [Create a container](https://docs.aws.amazon.com/https://docs.docker.com/engine/api/v1.35/#operation/ContainerCreate)
             *   section of the
             *   [Docker Remote API](https://docs.aws.amazon.com/https://docs.docker.com/engine/api/v1.35/)
             ...
             * You can determine the number of CPU units that are available per EC2 instance type by
             * multiplying the vCPUs listed for that instance type on the
             * [Amazon EC2 Instances](https://docs.aws.amazon.com/ec2/instance-types/) detail page
             * by 1,024.
             *
             * Linux containers share unallocated CPU units with other containers on the container
             * instance with the same ratio as their allocated amount. For example, if you run a
             ...
             * container could use the full 1,024 CPU unit share at any given time. However, if you
             * launched another copy of the same task on that container instance, each task is
             * guaranteed a minimum of 512 CPU units when needed. Moreover, each container could
             * float to higher CPU usage if the other container was not using it. If both tasks were
             ...
             * in the Docker documentation. The minimum valid CPU share value that the Linux kernel
             * allows is
             * 2. However, the CPU parameter isn't required, and you can use CPU values below 2 in
             *    your container definitions. For CPU values below 2 (including null), the behavior
            ...
            /**
             * @param credentialSpecs A list of ARNs in SSM or Amazon S3 to a credential spec (
             ...
             *
             * You can use this format without joining the container instance to a domain.
             * * **credentialspec:MyARN** - You use `credentialspec:MyARN` to provide a `CredSpec`
             *   for a single domain.
             *
             ...
             * In both formats, replace `MyARN` with the ARN in SSM or Amazon S3.
             *
             * If you provide a `credentialspecdomainless:MyARN` , the `credspec` must provide a ARN
             * in AWS Secrets Manager for a secret containing the username, password, and the domain
             ...
             * domainless credentials. You can use this parameter to run tasks on the same instance,
            ...
            /**
             * @param dependsOn The dependencies defined for container startup and shutdown. A
             *   container can contain multiple dependencies. When a dependency is defined for
             *   container startup, for container shutdown it is reversed.
             *
             * For tasks using the EC2 launch type, the container instances require at least version
             * 1.26.0 of the container agent to turn on container dependencies. However, we
            ...
            /**
             * @param dnsSearchDomains A list of DNS search domains that are presented to the
            ...
            /**
             * @param dockerLabels A key/value map of labels to add to the container. This parameter
            ...
            /**
             * @param dockerSecurityOptions A list of strings to provide custom configuration for
             *   multiple security systems. For more information about valid values, see
             *   [Docker Run Security Configuration](https://docs.aws.amazon.com/https://docs.docker.com/engine/reference/run/#security-configuration)
             *   . This field isn't valid for containers in tasks using the Fargate launch type.
             *
            ...
            /**
             * @param entryPoint Early versions of the Amazon ECS container agent don't properly
             *   handle `entryPoint` parameters. If you have problems using `entryPoint` , update
             *   your container agent or enter your commands and arguments as `command` array items
             *   instead.
             *
            ...
            /**
             * @param environment The environment variables to pass to a container. This parameter
             *   maps to `Env` in the
             *   [Create a container](https://docs.aws.amazon.com/https://docs.docker.com/engine/api/v1.35/#operation/ContainerCreate)
             *   section of the
             *   [Docker Remote API](https://docs.aws.amazon.com/https://docs.docker.com/engine/api/v1.35/)
            ...
            /**
             * @param environmentFiles A list of files containing the environment variables to pass
             *   to a container. This parameter maps to the `--env-file` option to
             *   [docker run](https://docs.aws.amazon.com/https://docs.docker.com/engine/reference/run/#security-configuration)
             *   .
             *
             ...
             * container definition, they take precedence over the variables contained within an
             * environment file. If multiple environment files are specified that contain the same
             * variable, they're processed from the top down. We recommend that you use unique
            ...
            /**
             * @param essential If the `essential` parameter of a container is marked as `true` ,
             *   and that container fails or stops for any reason, all other containers that are
             *   part of the task are stopped. If the `essential` parameter of a container is marked
             *   as `false` , its failure doesn't affect the rest of the containers in a task. If
             ...
             *   `/etc/hosts` file on the container. This parameter maps to `ExtraHosts` in the
             *   [Create a container](https://docs.aws.amazon.com/https://docs.docker.com/engine/api/v1.35/#operation/ContainerCreate)
             *   section of the
             *   [Docker Remote API](https://docs.aws.amazon.com/https://docs.docker.com/engine/api/v1.35/)
             *   and the `--add-host` option to
            ...
            /**
             * @param firelensConfiguration The FireLens configuration for the container. This is
             *   used to specify and configure a log router for container logs. For more
             *   information, see
             *   [Custom Log Routing](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/using_firelens.html)
             *   in the *Amazon Elastic Container Service Developer Guide* .
             */
            ...
            public fun firelensConfiguration(
                firelensConfiguration: FirelensConfigurationProperty.Builder.() -> Unit
            )

            /**
             * @param healthCheck The container health check command and associated configuration
             *   parameters for the container. This parameter maps to `HealthCheck` in the
             *   [Create a container](https://docs.aws.amazon.com/https://docs.docker.com/engine/api/v1.35/#operation/ContainerCreate)
             *   section of the
             *   [Docker Remote API](https://docs.aws.amazon.com/https://docs.docker.com/engine/api/v1.35/)
             *   and the `HEALTHCHECK` parameter of
             ...
             *   the Docker daemon. By default, images in the Docker Hub registry are available.
             *   Other repositories are specified with either `*repository-url* / *image* : *tag*`
             *   or `*repository-url* / *image* &#64; *digest*` . Up to 255 letters (uppercase and
             *   lowercase), numbers, hyphens, underscores, colons, periods, forward slashes, and
             *   number signs are allowed. This parameter maps to `Image` in the
             *   [Create a container](https://docs.aws.amazon.com/https://docs.docker.com/engine/api/v1.35/#operation/ContainerCreate)
             *   section of the
             *   [Docker Remote API](https://docs.aws.amazon.com/https://docs.docker.com/engine/api/v1.35/)
             *   and the `IMAGE` parameter of
             ...
             *   applications that require `stdin` or a `tty` to be allocated. This parameter maps
             *   to `OpenStdin` in the
             *   [Create a container](https://docs.aws.amazon.com/https://docs.docker.com/engine/api/v1.35/#operation/ContainerCreate)
             *   section of the
             *   [Docker Remote API](https://docs.aws.amazon.com/https://docs.docker.com/engine/api/v1.35/)
            ...
            /**
             * @param links The `links` parameter allows containers to communicate with each other
             *   without the need for port mappings. This parameter is only supported if the network
             *   mode of a task definition is `bridge` . The `name:internalName` construct is
             *   analogous to `name:alias` in Docker links. Up to 255 letters (uppercase and
             *   lowercase), numbers, underscores, and hyphens are allowed. For more information
             *   about linking Docker containers, go to
             *   [Legacy container links](https://docs.aws.amazon.com/https://docs.docker.com/network/links/)
             *   in the Docker documentation. This parameter maps to `Links` in the
             *   [Create a container](https://docs.aws.amazon.com/https://docs.docker.com/engine/api/v1.35/#operation/ContainerCreate)
             *   section of the
            ...
            /**
             * @param linuxParameters Linux-specific modifications that are applied to the
             *   container, such as Linux kernel capabilities. For more information see
             *   [KernelCapabilities](https://docs.aws.amazon.com/AmazonECS/latest/APIReference/API_KernelCapabilities.html)
             *   .
             *
             * This parameter is not supported for Windows containers.
            ...
            /**
             * @param logConfiguration The log configuration specification for the container. This
             ...
             *   specifying a log driver with this parameter in the container definition. To use a
             *   different logging driver for a container, the log system must be configured
             *   properly on the container instance (or on a different log server for remote logging
             *   options). For more information on the options for different supported log drivers,
             *   see
             *   [Configure logging drivers](https://docs.aws.amazon.com/https://docs.docker.com/engine/admin/logging/overview/)
             *   in the Docker documentation.
             *
            ...
            public fun logConfiguration(
                logConfiguration: LogConfigurationProperty.Builder.() -> Unit
            )

            /**
             * @param memory The amount (in MiB) of memory to present to the container. If your
             *   container attempts to exceed the memory specified here, the container is killed.
             *   The total amount of memory reserved for all containers within a task must be lower
             *   than the task `memory` value, if one is specified. This parameter maps to `Memory`
             *   in the
             *   [Create a container](https://docs.aws.amazon.com/https://docs.docker.com/engine/api/v1.35/#operation/ContainerCreate)
             *   section of the
             *   [Docker Remote API](https://docs.aws.amazon.com/https://docs.docker.com/engine/api/v1.35/)
             ...
             * `memoryReservation` value, `memory` must be greater than `memoryReservation` . If you
             * specify `memoryReservation` , then that value is subtracted from the available memory
             * resources for the container instance where the container is placed. Otherwise, the
            ...
            /**
             * @param memoryReservation The soft limit (in MiB) of memory to reserve for the
             *   container. When system memory is under heavy contention, Docker attempts to keep
             *   the container memory to this soft limit. However, your container can consume more
             *   memory when it needs to, up to either the hard limit specified with the `memory`
             *   parameter (if applicable), or all of the available memory on the container
             *   instance, whichever comes first. This parameter maps to `MemoryReservation` in the
             *   [Create a container](https://docs.aws.amazon.com/https://docs.docker.com/engine/api/v1.35/#operation/ContainerCreate)
             *   section of the
             *   [Docker Remote API](https://docs.aws.amazon.com/https://docs.docker.com/engine/api/v1.35/)
             *   and the `--memory-reservation` option to
             ...
             * remaining resources on the container instance, but also allow the container to
            ...
            /**
             * @param mountPoints The mount points for data volumes in your container. This
            ...
            /**
             * @param name The name of a container. If you're linking multiple containers together
             *   in a task definition, the `name` of one container can be entered in the `links` of
             *   another container to connect the containers. Up to 255 letters (uppercase and
             *   lowercase), numbers, underscores, and hyphens are allowed. This parameter maps to
             *   `name` in the
             *   [Create a container](https://docs.aws.amazon.com/https://docs.docker.com/engine/api/v1.35/#operation/ContainerCreate)
             *   section of the
             *   [Docker Remote API](https://docs.aws.amazon.com/https://docs.docker.com/engine/api/v1.35/)
             ...
             *   privileges on the host container instance (similar to the `root` user). This
            ...
            /**
             * @param pseudoTerminal When this parameter is `true` , a TTY is allocated. This
             *   parameter maps to `Tty` in the
             *   [Create a container](https://docs.aws.amazon.com/https://docs.docker.com/engine/api/v1.35/#operation/ContainerCreate)
             *   section of the
             *   [Docker Remote API](https://docs.aws.amazon.com/https://docs.docker.com/engine/api/v1.35/)
             *   and the `--tty` option to
            ...
            /**
             * @param readonlyRootFilesystem When this parameter is true, the container is given
             *   read-only access to its root file system. This parameter maps to `ReadonlyRootfs`
             *   in the
             *   [Create a container](https://docs.aws.amazon.com/https://docs.docker.com/engine/api/v1.35/#operation/ContainerCreate)
             *   section of the
             *   [Docker Remote API](https://docs.aws.amazon.com/https://docs.docker.com/engine/api/v1.35/)
            ...
            /**
             * @param repositoryCredentials The private repository authentication credentials to
             *   use.
             */
            ...
            public fun repositoryCredentials(
                repositoryCredentials: RepositoryCredentialsProperty.Builder.() -> Unit
            )

            /**
             * @param resourceRequirements The type and amount of a resource to assign to a
             ...
             *   dependencies for a container. For example, you specify two containers in a task
             *   definition with containerA having a dependency on containerB reaching a `COMPLETE`
             *   , `SUCCESS` , or `HEALTHY` status. If a `startTimeout` value is specified for
             *   containerB and it doesn't reach the desired status within that time then containerA
             ...
             * checking your agent version and updating to the latest version, see
             * [Updating the Amazon ECS Container Agent](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/ecs-agent-update.html)
             * in the *Amazon Elastic Container Service Developer Guide* . If you're using an Amazon
             * ECS-optimized Linux AMI, your instance needs at least version `1.26.0-1` of the
             * `ecs-init` package. If your container instances are launched from version `20190301`
            ...
            /**
             * @param stopTimeout Time duration (in seconds) to wait before the container is
             *   forcefully killed if it doesn't exit normally on its own. For tasks using the
             ...
             * `ECS_CONTAINER_STOP_TIMEOUT` is used. If neither the `stopTimeout` parameter or the
             * `ECS_CONTAINER_STOP_TIMEOUT` agent configuration variable are set, then the default
             * values of 30 seconds for Linux containers and 30 seconds on Windows containers are
             * used. Your container instances require at least version 1.26.0 of the container agent
             * to use a container stop timeout value. However, we recommend using the latest
            ...
            /**
             * @param ulimits A list of `ulimits` to set in the container. This parameter maps to
             *   `Ulimits` in the
             *   [Create a container](https://docs.aws.amazon.com/https://docs.docker.com/engine/api/v1.35/#operation/ContainerCreate)
             *   section of the
             *   [Docker Remote API](https://docs.aws.amazon.com/https://docs.docker.com/engine/api/v1.35/)
             ...
             *   data type. This parameter requires version 1.18 of the Docker Remote API or greater
            ...
            /**
             * @param user The user to use inside the container. This parameter maps to `User` in
             *   the
             *   [Create a container](https://docs.aws.amazon.com/https://docs.docker.com/engine/api/v1.35/#operation/ContainerCreate)
             *   section of the
             *   [Docker Remote API](https://docs.aws.amazon.com/https://docs.docker.com/engine/api/v1.35/)
            ...
            /**
             * @param volumesFrom Data volumes to mount from another container. This parameter maps
             *   to `VolumesFrom` in the
             *   [Create a container](https://docs.aws.amazon.com/https://docs.docker.com/engine/api/v1.35/#operation/ContainerCreate)
             *   section of the
             *   [Docker Remote API](https://docs.aws.amazon.com/https://docs.docker.com/engine/api/v1.35/)
             *   and the `--volumes-from` option to
            ...
            /**
             * @param workingDirectory The working directory to run commands inside the container
             *   in. This parameter maps to `WorkingDir` in the
             *   [Create a container](https://docs.aws.amazon.com/https://docs.docker.com/engine/api/v1.35/#operation/ContainerCreate)
             *   section of the
             *   [Docker Remote API](https://docs.aws.amazon.com/https://docs.docker.com/engine/api/v1.35/)
             *   and the `--workdir` option to
        ...
        private class BuilderImpl : Builder {
             ...
             * This parameter is not supported for Windows containers.
             */
            override fun dnsServers(vararg dnsServers: String): Unit =
             ...
             * information, such as credential data.
             */
            override fun environment(vararg environment: Any): Unit =
             ...
             *   in the *Amazon Elastic Container Service Developer Guide* .
             */
            override fun firelensConfiguration(
                firelensConfiguration: FirelensConfigurationProperty
            ) {
                cdkBuilder.firelensConfiguration(
                    firelensConfiguration.let(FirelensConfigurationProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("87aef773eb485e9bf242ce5977a3da60b770cd6e5d45895b0ff3f622786871e0")
            override fun linuxParameters(
                linuxParameters: LinuxParametersProperty.Builder.() -> Unit
             ...
             * and mount point can't be across drives.
             */
            override fun mountPoints(vararg mountPoints: Any): Unit =
                mountPoints(mountPoints.toList())
            ...
            override fun repositoryCredentials(
                ...
                cdkBuilder.repositoryCredentials(
                    repositoryCredentials.let(RepositoryCredentialsProperty::unwrap)
                )
            }
             ...
             *   .
             */
            override fun volumesFrom(vararg volumesFrom: Any): Unit =
                volumesFrom(volumesFrom.toList())
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ecs-taskdefinition-containerdefinition.html#cfn-ecs-taskdefinition-containerdefinition-credentialspecs)
             */
            override fun credentialSpecs(): List<String> =
                unwrap(this).getCredentialSpecs() ?: emptyList()

            /**
             * The dependencies defined for container startup and shutdown.
             *
             * A container can contain multiple dependencies. When a dependency is defined for
             * container startup, for container shutdown it is reversed.
             *
             * For tasks using the EC2 launch type, the container instances require at least version
             * 1.26.0 of the container agent to turn on container dependencies. However, we
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ecs-taskdefinition-containerdefinition.html#cfn-ecs-taskdefinition-containerdefinition-dnssearchdomains)
             */
            override fun dnsSearchDomains(): List<String> =
                unwrap(this).getDnsSearchDomains() ?: emptyList()
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ecs-taskdefinition-containerdefinition.html#cfn-ecs-taskdefinition-containerdefinition-dockersecurityoptions)
             */
            override fun dockerSecurityOptions(): List<String> =
                unwrap(this).getDockerSecurityOptions() ?: emptyList()
             ...
             * The image used to start a container.
             *
             * This string is passed directly to the Docker daemon. By default, images in the Docker
             * Hub registry are available. Other repositories are specified with either
             ...
             *
             * This parameter is only supported if the network mode of a task definition is `bridge`
             * . The `name:internalName` construct is analogous to `name:alias` in Docker links. Up
             * to 255 letters (uppercase and lowercase), numbers, underscores, and hyphens are
             ...
             * However, the container may use a different logging driver than the Docker daemon by
             * specifying a log driver with this parameter in the container definition. To use a
             * different logging driver for a container, the log system must be configured properly
             ...
             * killed. The total amount of memory reserved for all containers within a task must be
             * lower than the task `memory` value, if one is specified. This parameter maps to
             * `Memory` in the
             * [Create a container](https://docs.aws.amazon.com/https://docs.docker.com/engine/api/v1.35/#operation/ContainerCreate)
             * section of the
             * [Docker Remote API](https://docs.aws.amazon.com/https://docs.docker.com/engine/api/v1.35/)
             ...
             *
             * When system memory is under heavy contention, Docker attempts to keep the container
             * memory to this soft limit. However, your container can consume more memory when it
             ...
             * The name of a container.
             *
             * If you're linking multiple containers together in a task definition, the `name` of
             * one container can be entered in the `links` of another container to connect the
             * containers. Up to 255 letters (uppercase and lowercase), numbers, underscores, and
             ...
             *
             * For example, you specify two containers in a task definition with containerA having a
             * dependency on containerB reaching a `COMPLETE` , `SUCCESS` , or `HEALTHY` status. If
             * a `startTimeout` value is specified for containerB and it doesn't reach the desired
             * status within that time then containerA gives up and not start. This results in the
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ContainerDefinitionProperty
            ): software.amazon.awscdk.services.ecs.CfnTaskDefinition.ContainerDefinitionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ProxyConfigurationProperty {
         ...
         * * `EgressIgnoredIPs` - (Required) The egress traffic going to the specified IP addresses
         ...
         */
        public fun proxyConfigurationProperties(): Any? =
        ...
        public interface Builder {
            ...
            /**
             * @param proxyConfigurationProperties The set of network configuration parameters to
             *   provide the Container Network Interface (CNI) plugin, specified as key-value pairs.
             * * `IgnoredUID` - (Required) The user ID (UID) of the proxy container as defined by
             ...
             * * `ProxyEgressPort` - (Required) Specifies the port that outgoing traffic from the
             *   `AppPorts` is directed to.
             * * `EgressIgnoredPorts` - (Required) The egress traffic going to the specified ports
             *   is ignored and not redirected to the `ProxyEgressPort` . It can be an empty list.
        ...
        private class BuilderImpl : Builder {
            ...
            override fun proxyConfigurationProperties(proxyConfigurationProperties: IResolvable) {
                cdkBuilder.proxyConfigurationProperties(
                    proxyConfigurationProperties.let(IResolvable::unwrap)
                )
            }
             ...
             *   empty list.
             */
            override fun proxyConfigurationProperties(
                vararg proxyConfigurationProperties: Any
            ): Unit = proxyConfigurationProperties(proxyConfigurationProperties.toList())
    ...
    public interface RepositoryCredentialsProperty {
         ...
         * Region as the task that you're launching then you can use either the full ARN or the name
         * of the secret. When you use the AWS Management Console, you must specify the full ARN of
         * the secret.
         *
        ...
        public interface Builder {
            /**
             * @param credentialsParameter The Amazon Resource Name (ARN) of the secret containing
             *   the private repository credentials.
             *
             * When you use the Amazon ECS API, AWS CLI , or AWS SDK, if the secret exists in the
             * same Region as the task that you're launching then you can use either the full ARN or
             * the name of the secret. When you use the AWS Management Console, you must specify the
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RepositoryCredentialsProperty
            ): software.amazon.awscdk.services.ecs.CfnTaskDefinition.RepositoryCredentialsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SecretProperty {
         ...
         *
         * The supported values are either the full ARN of the AWS Secrets Manager secret or the
        ...
        public interface Builder {
            ...
            /**
             * @param valueFrom The secret to expose to the container. The supported values are
             *   either the full ARN of the AWS Secrets Manager secret or the full ARN of the
    ...
    public interface LogConfigurationProperty {
         ...
         * changes that you would like to have included. However, we don't currently provide support
        ...
        public interface Builder {
            /**
             * @param logDriver The log driver to use for the container. For tasks on AWS Fargate ,
             *   the supported log drivers are `awslogs` , `splunk` , and `awsfirelens` .
             *
             * For tasks hosted on Amazon EC2 instances, the supported log drivers are `awslogs` ,
             * `fluentd` , `gelf` , `json-file` , `journald` , `logentries` , `syslog` , `splunk` ,
             * and `awsfirelens` .
             *
             * For more information about using the `awslogs` log driver, see
             * [Using the awslogs log driver](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/using_awslogs.html)
             ...
             * for changes that you would like to have included. However, we don't currently provide
            ...
            /**
             * @param secretOptions The secrets to pass to the log configuration. For more
             *   information, see
             *   [Specifying sensitive data](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/specifying-sensitive-data.html)
             *   in the *Amazon Elastic Container Service Developer Guide* .
             */
    ...
    public interface PortMappingProperty {
         ...
         *
         * This parameter only applies to Service Connect. We recommend that you set this parameter
         * to be consistent with the protocol that your application uses. If you set this parameter,
         * Amazon ECS adds protocol-specific connection handling to the Service Connect proxy. If
         * you set this parameter, Amazon ECS adds protocol-specific telemetry in the Amazon ECS
         ...
         *
         * For more information, see
         * [Issue #11185](https://docs.aws.amazon.com/https://github.com/moby/moby/issues/11185) on
         * the Github website.
         *
         ...
         * You can call
         * [`DescribeTasks`](https://docs.aws.amazon.com/AmazonECS/latest/APIReference/API_DescribeTasks.html)
         * to view the `hostPortRange` which are the host ports that are bound to the container
         * ports.
         *
         ...
         * * For containers in a task with the `bridge` network mode, the Amazon ECS agent finds
         *   open ports on the host and automatically binds them to the container ports. This is a
         ...
         * running task is also reserved while the task is running. That is, after a task stops, the
         ...
         *
         * This parameter only applies to Service Connect. This parameter is the name that you use
         * in the `serviceConnectConfiguration` of a service. The name can include up to 64
        ...
        public interface Builder {
            /**
             * @param appProtocol The application protocol that's used for the port mapping. This
             *   parameter only applies to Service Connect. We recommend that you set this parameter
             *   to be consistent with the protocol that your application uses. If you set this
             ...
             * namespace. Tasks can connect to services across all of the clusters in the namespace.
             * Tasks connect through a managed proxy container that collects logs and metrics for
             * increased visibility. Only the tasks that Amazon ECS services create are supported
             * with Service Connect. For more information, see
             * [Service Connect](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/service-connect.html)
             * in the *Amazon Elastic Container Service Developer Guide* .
             */
            ...
            /**
             * @param containerPort The port number on the container that's bound to the
             *   user-specified or automatically assigned host port. If you use containers in a task
             *   with the `awsvpc` or `host` network mode, specify the exposed ports using
             *   `containerPort` .
             *
             * If you use containers in a task with the `bridge` network mode and you specify a
             * container port and not a host port, your container automatically receives a host port
             * in the ephemeral port range. For more information, see `hostPort` . Port mappings
             * that are automatically assigned in this way do not count toward the 100 reserved
             ...
             *   at least version 1.67.0-1 of the `ecs-init` package
             * * You can specify a maximum of 100 port ranges per container.
             * * You do not specify a `hostPortRange` . The value of the `hostPortRange` is set as
             *   follows:
             * * For containers in a task with the `awsvpc` network mode, the `hostPortRange` is set
             *   to the same value as the `containerPortRange` . This is a static mapping strategy.
             * * For containers in a task with the `bridge` network mode, the Amazon ECS agent finds
             ...
             * * You cannot specify overlapping port ranges.
             * * The first port in the range must be less than last port in the range.
             * * Docker recommends that you turn off the docker-proxy in the Docker daemon config
             *   file when you have a large number of ports.
             *
             * For more information, see
             * [Issue #11185](https://docs.aws.amazon.com/https://github.com/moby/moby/issues/11185)
             ...
             *   container. If you specify a `containerPortRange` , leave this field empty and the
             *   value of the `hostPort` is set as follows:
             * * For containers in a task with the `awsvpc` network mode, the `hostPort` is set to
             *   the same value as the `containerPort` . This is a static mapping strategy.
             * * For containers in a task with the `bridge` network mode, the Amazon ECS agent finds
             *   open ports on the host and automatically binds them to the container ports. This is
             ...
             * The default ephemeral port range for Docker version 1.6.0 and later is listed on the
             * instance under `/proc/sys/net/ipv4/ip_local_port_range` . If this kernel parameter is
             * unavailable, the default ephemeral port range from 49153 through 65535 (Linux) or
             * 49152 through 65535 (Windows) is used. Do not attempt to specify a host port in the
             * ephemeral port range as these are reserved for automatic assignment. In general,
             ...
             * [DescribeContainerInstances](https://docs.aws.amazon.com/AmazonECS/latest/APIReference/API_DescribeContainerInstances.html)
             * output. A container instance can have up to 100 reserved ports at a time. This number
             * includes the default reserved ports. Automatically assigned ports aren't included in
             * the 100 reserved ports quota.
             */
            public fun hostPort(hostPort: Number)

            /**
             * @param name The name that's used for the port mapping. This parameter only applies to
             ...
             *   characters. The characters can include lowercase letters, numbers, underscores (_),
             *   and hyphens (-). The name can't start with a hyphen.
             *
             * For more information, see
             * [Service Connect](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/service-connect.html)
             * in the *Amazon Elastic Container Service Developer Guide* .
            ...
            /**
             * @param protocol The protocol used for the port mapping. Valid values are `tcp` and
             *   `udp` . The default is `tcp` . `protocol` is immutable in a Service Connect
        ...
        internal constructor(
             ...
             * Connect proxy. If you set this parameter, Amazon ECS adds protocol-specific telemetry
             ...
             * The name that's used for the port mapping.
             *
             * This parameter only applies to Service Connect. This parameter is the name that you
             * use in the `serviceConnectConfiguration` of a service. The name can include up to 64
             * characters. The characters can include lowercase letters, numbers, underscores (_),
             * and hyphens (-). The name can't start with a hyphen.
             *
             * For more information, see
             ...
             * The protocol used for the port mapping.
             *
             * Valid values are `tcp` and `udp` . The default is `tcp` . `protocol` is immutable in
             * a Service Connect service. Updating this field requires a service deletion and
             * redeployment.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ecs-taskdefinition-portmapping.html#cfn-ecs-taskdefinition-portmapping-protocol)
             */
    ...
    public interface HealthCheckProperty {
         ...
         *
         * When you use the AWS Management Console JSON panel, the AWS Command Line Interface , or
         * the APIs, enclose the list of commands in double quotes and brackets.
         *
         ...
         * information, see `HealthCheck` in the
         * [Create a container](https://docs.aws.amazon.com/https://docs.docker.com/engine/api/v1.35/#operation/ContainerCreate)
         * section of the
         * [Docker Remote API](https://docs.aws.amazon.com/https://docs.docker.com/engine/api/v1.35/)
         * .
        ...
        public interface Builder {
            /**
             * @param command A string array representing the command that the container runs to
             *   determine if it is healthy. The string array must start with `CMD` to run the
             *   command arguments directly, or `CMD-SHELL` to run the command with the container's
             *   default shell.
             *
             * When you use the AWS Management Console JSON panel, the AWS Command Line Interface ,
             * or the APIs, enclose the list of commands in double quotes and brackets.
             *
             * `[ "CMD-SHELL", "curl -f http://localhost/ || exit 1" ]`
             *
             * You don't include the double quotes and brackets when you use the AWS Management
             * Console.
             *
             * `CMD-SHELL, curl -f http://localhost/ || exit 1`
             *
             * An exit code of 0 indicates success, and non-zero exit code indicates failure. For
             * more information, see `HealthCheck` in the
             * [Create a container](https://docs.aws.amazon.com/https://docs.docker.com/engine/api/v1.35/#operation/ContainerCreate)
             * section of the
             * [Docker Remote API](https://docs.aws.amazon.com/https://docs.docker.com/engine/api/v1.35/)
             * .
            ...
            /**
             * @param interval The time period in seconds between each health check execution. You
             *   may specify between 5 and 300 seconds. The default value is 30 seconds.
             */
            public fun interval(interval: Number)

            /**
             * @param retries The number of times to retry a failed health check before the
             *   container is considered unhealthy. You may specify between 1 and 10 retries. The
             *   default value is 3.
             */
            public fun retries(retries: Number)

            /**
             * @param startPeriod The optional grace period to provide containers time to bootstrap
             *   before failed health checks count towards the maximum number of retries. You can
            ...
            /**
             * @param timeout The time period in seconds to wait for a health check to succeed
             *   before it is considered a failure. You may specify between 2 and 60 seconds. The
             *   default value is 5.
             */
    ...
    public interface ResourceRequirementProperty {
        ...
        public interface Builder {
            /**
             * @param type The type of resource to assign to a container. The supported values are
             *   `GPU` or `InferenceAccelerator` .
             */
            public fun type(type: String)

            /**
             * @param value The value for the specified resource type. If the `GPU` type is used,
             *   the value is the number of physical `GPUs` the Amazon ECS container agent reserves
             *   for the container. The number of GPUs that's reserved for all containers in a task
             *   can't exceed the number of available GPUs on the container instance that the task
             *   is launched on.
             *
        ...
        internal constructor(
             ...
             *
             * If the `GPU` type is used, the value is the number of physical `GPUs` the Amazon ECS
             * container agent reserves for the container. The number of GPUs that's reserved for
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ResourceRequirementProperty
            ): software.amazon.awscdk.services.ecs.CfnTaskDefinition.ResourceRequirementProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface EphemeralStorageProperty {
        ...
        public interface Builder {
             ...
             *   The minimum supported value is `21` GiB and the maximum supported value is `200`
             *   GiB.
             */
    ...
    public interface VolumeProperty {
         ...
         *
         * This is used to create Amazon EBS volumes for standalone tasks or tasks created as part
         * of a service. Each task definition revision may only have one volume configured at launch
         ...
         * persists on the host container instance and where it's stored. If the `host` parameter is
         * empty, then the Docker daemon assigns a host path for your data volume. However, the data
        ...
        public interface Builder {
            /**
             * @param configuredAtLaunch Indicates whether the volume should be configured at launch
             *   time. This is used to create Amazon EBS volumes for standalone tasks or tasks
             *   created as part of a service. Each task definition revision may only have one
            ...
            /**
             * @param dockerVolumeConfiguration This parameter is specified when you use Docker
             *   volumes. Windows containers only support the use of the `local` driver. To use bind
            ...
            public fun dockerVolumeConfiguration(
                dockerVolumeConfiguration: DockerVolumeConfigurationProperty.Builder.() -> Unit
            )

            /**
             * @param efsVolumeConfiguration This parameter is specified when you use an Amazon
            ...
            public fun efsVolumeConfiguration(
                efsVolumeConfiguration: EFSVolumeConfigurationProperty.Builder.() -> Unit
            )

            /**
             * @param host This parameter is specified when you use bind mount host volumes. The
             ...
             *   volume. However, the data isn't guaranteed to persist after the containers that are
             *   associated with it stop running.
             *
             * Windows containers can mount whole directories on the same drive as
             * `$env:ProgramData` . Windows containers can't mount directories on a different drive,
             * and mount point can't be across drives. For example, you can mount
            ...
            /**
             * @param name The name of the volume. Up to 255 letters (uppercase and lowercase),
             *   numbers, underscores, and hyphens are allowed. When using a volume configured at
             *   launch, the `name` is required and must also be specified as the volume name in the
             *   `ServiceVolumeConfiguration` or `TaskVolumeConfiguration` parameter when creating
             *   your service or standalone task.
             *
        ...
        private class BuilderImpl : Builder {
            ...
            override fun dockerVolumeConfiguration(dockerVolumeConfiguration: IResolvable) {
                cdkBuilder.dockerVolumeConfiguration(
                    dockerVolumeConfiguration.let(IResolvable::unwrap)
                )
            }
             ...
             * Docker volumes aren't supported by tasks run on AWS Fargate .
             */
            override fun dockerVolumeConfiguration(
                dockerVolumeConfiguration: DockerVolumeConfigurationProperty
            ) {
                cdkBuilder.dockerVolumeConfiguration(
                    dockerVolumeConfiguration.let(DockerVolumeConfigurationProperty::unwrap)
                )
            }
            ...
            override fun dockerVolumeConfiguration(
                ...
                dockerVolumeConfiguration(
                    DockerVolumeConfigurationProperty(dockerVolumeConfiguration)
                )
             ...
             *   Elastic File System file system for task storage.
             */
            override fun efsVolumeConfiguration(
                efsVolumeConfiguration: EFSVolumeConfigurationProperty
            ) {
                cdkBuilder.efsVolumeConfiguration(
                    efsVolumeConfiguration.let(EFSVolumeConfigurationProperty::unwrap)
                )
            }
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ecs-taskdefinition-volume.html#cfn-ecs-taskdefinition-volume-dockervolumeconfiguration)
             */
            override fun dockerVolumeConfiguration(): Any? =
    ...
    public interface KernelCapabilitiesProperty {
         ...
         * configuration provided by Docker.
         *
         * This parameter maps to `CapDrop` in the
         * [Create a container](https://docs.aws.amazon.com/https://docs.docker.com/engine/api/v1.35/#operation/ContainerCreate)
         * section of the
         * [Docker Remote API](https://docs.aws.amazon.com/https://docs.docker.com/engine/api/v1.35/)
        ...
        public interface Builder {
            /**
             * @param add The Linux capabilities for the container that have been added to the
             *   default configuration provided by Docker. This parameter maps to `CapAdd` in the
             *   [Create a container](https://docs.aws.amazon.com/https://docs.docker.com/engine/api/v1.35/#operation/ContainerCreate)
             *   section of the
             *   [Docker Remote API](https://docs.aws.amazon.com/https://docs.docker.com/engine/api/v1.35/)
             *   and the `--cap-add` option to
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: KernelCapabilitiesProperty
            ): software.amazon.awscdk.services.ecs.CfnTaskDefinition.KernelCapabilitiesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
