...
internal constructor(
    ...
    public interface Builder {
        ...
        /**
         * The list of actions to execute when this alarm transitions into an ALARM state from any
         * other state.
         *
         ...
         * The number of datapoints that must be breaching to trigger the alarm.
         *
         * This is used only if you are setting an "M out of N" alarm. In that case, this value is
         * the M, and the value that you set for `EvaluationPeriods` is the N value. For more
         * information, see
         ...
         * `EvaluationPeriods` , and the alarm goes to alarm state if that many consecutive periods
         * are breaching.
         *
         ...
         * The dimensions for the metric associated with the alarm.
         *
         * For an alarm based on a math expression, you can't specify `Dimensions` . Instead, you
         * use `Metrics` .
         *
         ...
         * Used only for alarms based on percentiles.
         *
         * If `ignore` , the alarm state does not change during periods with too few data points to
         * be statistically significant. If `evaluate` or this parameter is not used, the alarm is
         ...
         * "M out of N" alarm, this value is the N, and `DatapointsToAlarm` is the M.
         *
         ...
         *
         * @param evaluationPeriods The number of periods over which data is compared to the
         *   specified threshold.
         */
         ...
         *
         * For an alarm based on a math expression, you can't specify `ExtendedStatistic` . Instead,
         * you use `Metrics` .
         *
         ...
         *
         * @param extendedStatistic The percentile statistic for the metric associated with the
         ...
         * The name of the metric associated with the alarm.
         *
         * This is required for an alarm based on a metric. For an alarm based on a math expression,
         ...
         *
         * @param metrics An array that enables you to create an alarm based on the result of a
         ...
         *
         * @param okActions The actions to execute when this alarm transitions to the `OK` state
         ...
         * multiple of 60.
         *
         * For an alarm based on a math expression, you can't specify `Period` , and instead you use
         ...
         *
         * @param thresholdMetricId In an alarm based on an anomaly detection model, this is the ID
         *   of the `ANOMALY_DETECTION_BAND` function used as the threshold for the alarm.
         */
         ...
         * The unit of the metric associated with the alarm.
         *
         * Specify this only if you are creating an alarm based on a single metric. Do not specify
         * this if you are specifying a `Metrics` array.
         *
         * You can specify the following values: Seconds, Microseconds, Milliseconds, Bytes,
         * Kilobytes, Megabytes, Gigabytes, Terabytes, Bits, Kilobits, Megabits, Gigabits, Terabits,
    ...
    public companion object {
        ...
        ): CfnAlarm = CfnAlarm(cdkObject)

        internal fun unwrap(
            wrapped: CfnAlarm
        ): software.amazon.awscdk.services.cloudwatch.CfnAlarm = wrapped.cdkObject
    }
    ...
    public interface MetricDataQueryProperty {
        ...
        /**
         * This option indicates whether to return the timestamps and raw data values of this
         * metric.
         *
        ...
        public interface Builder {
            ...
            /**
             * @param expression The math expression to be performed on the returned data, if this
             *   object is performing a math expression. This expression can use the `Id` of the
             *   other metrics to refer to those metrics, and can also use the `Id` of other
             ...
             *   values of this metric. When you create an alarm based on a metric math expression,
             *   specify `True` for this value for only the one math expression that the alarm is
             *   based on. You must specify `False` for `ReturnData` for all the other metrics and
             *   expressions used in the alarm.
             *
             * This field is required.
             */
        ...
        internal constructor(
             ...
             * metric.
             *
             * When you create an alarm based on a metric math expression, specify `True` for this
             * value for only the one math expression that the alarm is based on. You must specify
             * `False` for `ReturnData` for all the other metrics and expressions used in the alarm.
             *
             * This field is required.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-cloudwatch-alarm-metricdataquery.html#cfn-cloudwatch-alarm-metricdataquery-returndata)
    ...
    public interface DimensionProperty {
        ...
        public interface Builder {
            /**
             * @param name The name of the dimension, from 1–255 characters in length. This
             *   dimension name must have been included when the metric was published.
             */
    ...
    public interface MetricStatProperty {
        ...
        public interface Builder {
             ...
             *   Microseconds, Milliseconds, Bytes, Kilobytes, Megabytes, Gigabytes, Terabytes,
    ...
    public interface MetricProperty {
        ...
        public interface Builder {
            /**
             * @param dimensions The metric dimensions that you want to be used for the metric that
            ...
            /**
             * @param metricName The name of the metric that you want the alarm to watch. This is a
             *   required field.
             */
            public fun metricName(metricName: String)
        ...
        internal constructor(
            ...
            /**
             * The metric dimensions that you want to be used for the metric that the alarm will
             * watch.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-cloudwatch-alarm-metric.html#cfn-cloudwatch-alarm-metric-dimensions)
             */
