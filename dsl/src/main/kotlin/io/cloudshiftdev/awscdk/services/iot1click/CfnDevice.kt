...
internal constructor(
    ...
    public open fun attrEnabled(): IResolvable =
        unwrap(this).getAttrEnabled().let(IResolvable::wrap)
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnDevice
        ): software.amazon.awscdk.services.iot1click.CfnDevice = wrapped.cdkObject
    }
}
