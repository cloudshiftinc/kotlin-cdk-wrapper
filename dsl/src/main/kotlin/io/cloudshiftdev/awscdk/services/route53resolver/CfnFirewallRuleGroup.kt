...
internal constructor(
     ...
     *
     * This allows you to retry failed requests without the risk of running the operation twice.
    ...
    public interface Builder {
         ...
         *
         * @param tags A list of the tag keys and values that you want to associate with the rule
         *   group.
         */
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.route53resolver.CfnFirewallRuleGroup.Builder.create(
                scope,
                id
            )
    ...
    public interface FirewallRuleProperty {
         ...
         *   specified.
         *
         * if `BlockResponse` is `OVERRIDE` , then all of the following `OVERRIDE` attributes must
         * be specified:
         ...
         *
         * This value must be unique within the rule group. DNS Firewall processes the rules in a
         ...
         *   must be defined as TYPE NUMBER , where the NUMBER can be 1-65334, for example, TYPE28.
        ...
        public interface Builder {
             ...
             *   one of the domains in the rule's domain list: - `ALLOW` - Permit the request to go
             *   through.
             * * `ALERT` - Permit the request to go through but send an alert to the logs.
             * * `BLOCK` - Disallow the request. If this is specified,then `BlockResponse` must also
             *   be specified.
             *
             * if `BlockResponse` is `OVERRIDE` , then all of the following `OVERRIDE` attributes
             * must be specified:
             * * `BlockOverrideDnsType`
             * * `BlockOverrideDomain`
             * * `BlockOverrideTtl`
            ...
            /**
             * @param blockOverrideDnsType The DNS record's type. This determines the format of the
             *   record value that you provided in `BlockOverrideDomain` . Used for the rule action
             *   `BLOCK` with a `BlockResponse` setting of `OVERRIDE` .
             */
            public fun blockOverrideDnsType(blockOverrideDnsType: String)

            /**
             * @param blockOverrideDomain The custom DNS record to send back in response to the
             *   query. Used for the rule action `BLOCK` with a `BlockResponse` setting of
             *   `OVERRIDE` .
             */
            public fun blockOverrideDomain(blockOverrideDomain: String)

            /**
             * @param blockOverrideTtl The recommended amount of time, in seconds, for the DNS
             *   resolver or web browser to cache the provided override record. Used for the rule
             *   action `BLOCK` with a `BlockResponse` setting of `OVERRIDE` .
             */
            public fun blockOverrideTtl(blockOverrideTtl: Number)

            /**
             * @param blockResponse The way that you want DNS Firewall to block the request. Used
            ...
            /**
             * @param priority The priority of the rule in the rule group. This value must be unique
             *   within the rule group. DNS Firewall processes the rules in a rule group by order of
             ...
             *   values must be defined as TYPE NUMBER , where the NUMBER can be 1-65334, for
        ...
        internal constructor(
             ...
             * cache the provided override record.
             *
             * Used for the rule action `BLOCK` with a `BlockResponse` setting of `OVERRIDE` .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-route53resolver-firewallrulegroup-firewallrule.html#cfn-route53resolver-firewallrulegroup-firewallrule-blockoverridettl)
             ...
             * The priority of the rule in the rule group.
             *
             * This value must be unique within the rule group. DNS Firewall processes the rules in
             * a rule group by order of priority, starting from the lowest setting.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-route53resolver-firewallrulegroup-firewallrule.html#cfn-route53resolver-firewallrulegroup-firewallrule-priority)
             */
