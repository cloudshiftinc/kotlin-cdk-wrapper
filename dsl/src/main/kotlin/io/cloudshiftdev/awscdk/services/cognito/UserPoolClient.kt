...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.cognito.UserPoolClient,
    ...
    /**
     * The client name that was specified via the `userPoolClientName` property during
     * initialization, throws an error otherwise.
     */
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.cognito.UserPoolClient =
            cdkBuilder.build()
    }
    ...
    public companion object {
        public fun fromUserPoolClientId(
            ...
            software.amazon.awscdk.services.cognito.UserPoolClient.fromUserPoolClientId(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    userPoolClientId
                )
                .let(IUserPoolClient::wrap)
