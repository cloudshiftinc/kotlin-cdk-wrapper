...
public open class AthenaGetQueryResults internal constructor(
  ...
  private class BuilderImpl(
    ...
    public override fun maxResults(maxResults: Number) {
      cdkBuilder.maxResults(maxResults)
    }

    public override fun nextToken(nextToken: String) {
    ...
    public override fun queryExecutionId(queryExecutionId: String) {
