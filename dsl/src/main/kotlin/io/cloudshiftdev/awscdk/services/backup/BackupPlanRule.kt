...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * Default: - use the vault defined at the plan level. If not defined a new common vault for
         * the plan will be created
         *
        ...
        /**
         * The duration after a backup job is successfully started before it must be completed or it
         * is canceled by AWS Backup.
         *
         * Default: - 7 days
         *
         ...
         *
         * @param deleteAfter Specifies the duration after creation that a recovery point is
         *   deleted.
         */
         ...
         *
         * Property `deleteAfter` defines the retention period for the backup. It is mandatory if
         * PITR is enabled. If no value is specified, the retention period is set to 35 days which
         * is the maximum retention period supported by PITR.
         *
         * Property `moveToColdStorageAfter` must not be specified because PITR does not support
         * this option.
         *
         * Default: false
         *
         ...
         *
         * @param moveToColdStorageAfter Specifies the duration after creation that a recovery point
         ...
         *   metadata to the resources that you create.
         */
         ...
         * Default: - 8 hours
         *
         * @param startWindow The duration after a backup is scheduled before a job is canceled if
    ...
    private class BuilderImpl : Builder {
        ...
        public fun build(): software.amazon.awscdk.services.backup.BackupPlanRule =
            cdkBuilder.build()
    }
    ...
    public companion object {
        ...
        public fun daily(backupVault: IBackupVault): BackupPlanRule =
            software.amazon.awscdk.services.backup.BackupPlanRule.daily(
                    backupVault.let(IBackupVault::unwrap)
                )
                .let(BackupPlanRule::wrap)

        public fun monthly1Year(): BackupPlanRule =
            software.amazon.awscdk.services.backup.BackupPlanRule.monthly1Year()
                .let(BackupPlanRule::wrap)
        ...
        public fun monthly5Year(): BackupPlanRule =
            software.amazon.awscdk.services.backup.BackupPlanRule.monthly5Year()
                .let(BackupPlanRule::wrap)
        ...
        public fun monthly7Year(): BackupPlanRule =
            software.amazon.awscdk.services.backup.BackupPlanRule.monthly7Year()
                .let(BackupPlanRule::wrap)
        ...
        public fun weekly(backupVault: IBackupVault): BackupPlanRule =
            software.amazon.awscdk.services.backup.BackupPlanRule.weekly(
                    backupVault.let(IBackupVault::unwrap)
                )
                .let(BackupPlanRule::wrap)
