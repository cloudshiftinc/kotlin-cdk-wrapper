...
internal constructor(
     ...
     *
     * You should only add one method reponse for every status code. The API allows it for
     * historical reasons, but will add a warning if this happens. If you do, your Method will
     * nondeterministically use one of the responses, and ignore the rest.
     *
     ...
     *
     * NOTE: {stage} will refer to the `restApi.deploymentStage`, which will automatically set if
     * auto-deploy is enabled, or can be explicitly assigned. When not configured, {stage} will be
     * set to '*', as a shorthand for 'all stages'.
     */
    ...
    public open fun metric(
        ...
        unwrap(this)
            .metric(metricName, stage.let(IStage::unwrap), props.let(MetricOptions::unwrap))
            .let(Metric::wrap)
    ...
    public open fun metricCacheHitCount(stage: IStage, props: MetricOptions): Metric =
        unwrap(this)
            .metricCacheHitCount(stage.let(IStage::unwrap), props.let(MetricOptions::unwrap))
            .let(Metric::wrap)
    ...
    public open fun metricCacheHitCount(
        stage: IStage,
        props: MetricOptions.Builder.() -> Unit
    ...
    public open fun metricCacheMissCount(stage: IStage, props: MetricOptions): Metric =
        unwrap(this)
            .metricCacheMissCount(stage.let(IStage::unwrap), props.let(MetricOptions::unwrap))
            .let(Metric::wrap)
    ...
    public open fun metricCacheMissCount(
        stage: IStage,
        props: MetricOptions.Builder.() -> Unit
    ...
    public open fun metricClientError(stage: IStage, props: MetricOptions): Metric =
        unwrap(this)
            .metricClientError(stage.let(IStage::unwrap), props.let(MetricOptions::unwrap))
            .let(Metric::wrap)
    ...
    public open fun metricClientError(
        stage: IStage,
        props: MetricOptions.Builder.() -> Unit
    ): Metric = metricClientError(stage, MetricOptions(props))
    ...
    public open fun metricCount(stage: IStage, props: MetricOptions): Metric =
        unwrap(this)
            .metricCount(stage.let(IStage::unwrap), props.let(MetricOptions::unwrap))
            .let(Metric::wrap)
    ...
    public open fun metricIntegrationLatency(stage: IStage, props: MetricOptions): Metric =
        unwrap(this)
            .metricIntegrationLatency(stage.let(IStage::unwrap), props.let(MetricOptions::unwrap))
            .let(Metric::wrap)
    ...
    public open fun metricIntegrationLatency(
        stage: IStage,
        props: MetricOptions.Builder.() -> Unit
    ...
    public open fun metricLatency(stage: IStage, props: MetricOptions): Metric =
        unwrap(this)
            .metricLatency(stage.let(IStage::unwrap), props.let(MetricOptions::unwrap))
            .let(Metric::wrap)
    ...
    public open fun metricServerError(stage: IStage, props: MetricOptions): Metric =
        unwrap(this)
            .metricServerError(stage.let(IStage::unwrap), props.let(MetricOptions::unwrap))
            .let(Metric::wrap)
    ...
    public open fun metricServerError(
        stage: IStage,
        props: MetricOptions.Builder.() -> Unit
    ): Metric = metricServerError(stage, MetricOptions(props))
    ...
    public interface Builder {
         ...
         *
         * @param httpMethod The HTTP method ("GET", "POST", "PUT", ...) that clients use to call
         *   this method.
         */
