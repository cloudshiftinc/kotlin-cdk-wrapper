...
internal constructor(
    ...
    public companion object {
        public fun allowList(headers: String): CacheHeaderBehavior =
            software.amazon.awscdk.services.cloudfront.CacheHeaderBehavior.allowList(headers)
                .let(CacheHeaderBehavior::wrap)

        public fun none(): CacheHeaderBehavior =
            software.amazon.awscdk.services.cloudfront.CacheHeaderBehavior.none()
                .let(CacheHeaderBehavior::wrap)
