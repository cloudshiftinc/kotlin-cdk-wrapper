...
internal constructor(
     ...
     *
     * The alias will automatically be updated to point to the latest version of the function as it
     * is being updated during a deployment.
     *
     * ```
     * Function fn;
     * fn.addAlias("Live");
    ...
    public open fun addEnvironment(
        ...
        unwrap(this)
            .addEnvironment(key, `value`, options.let(EnvironmentOptions::unwrap))
            .let(Function::wrap)
    ...
    /**
     * Returns a `lambda.Version` which represents the current version of this Lambda function. A
     * new version will be created every time the function's configuration changes.
     *
     * You can specify options for this version using the `currentVersionOptions` prop when
     * initializing the `lambda.Function`.
     */
    public open fun currentVersion(): Version = unwrap(this).getCurrentVersion().let(Version::wrap)

    /** The DLQ (as queue) associated with this Lambda Function (this is an optional attribute). */
    public open fun deadLetterQueue(): IQueue? =
        unwrap(this).getDeadLetterQueue()?.let(IQueue::wrap)

    /** The DLQ (as topic) associated with this Lambda Function (this is an optional attribute). */
    public open fun deadLetterTopic(): ITopic? =
        unwrap(this).getDeadLetterTopic()?.let(ITopic::wrap)
     ...
     *
     * The Lambda Function construct does its best to automatically create a new Version when
     * anything about the Function changes (its code, its layers, any of the other properties).
     *
     * However, you can sometimes source information from places that the CDK cannot look into, like
     * the deploy-time values of SSM parameters. In those cases, the CDK would not force the
     * creation of a new Version object when it actually should.
     *
     * This method can be used to invalidate the current Version object. Pass in any string into
     * this method, and make sure the string changes when you know a new Version needs to be
     * created.
     *
     ...
     *
     * If either `logRetention` is set or this property is called, a CloudFormation custom resource
     * is added to the stack that pre-creates the log group as part of the stack deployment, if it
     * already doesn't exist, and sets the correct log retention period (never expire, by default).
     *
     * Further, if the log group already exists and the `logRetention` is not set, the custom
     * resource will reset the log retention to never expire even if it was configured with a
     * different value.
     */
    ...
    public interface Builder {
         ...
         *
         * @param adotInstrumentation Specify the configuration of AWS Distro for OpenTelemetry
        ...
        public fun adotInstrumentation(
            adotInstrumentation: AdotInstrumentationConfig.Builder.() -> Unit
        )

        /**
         * Whether to allow the Lambda to send all network traffic.
         *
         * If set to false, you must individually add traffic rules to allow the Lambda to connect
         * to network targets.
         *
         ...
         *
         * @param currentVersionOptions Options for the `lambda.Version` resource automatically
         *   created by the `fn.currentVersion` method.
         */
         ...
         * Enabled DLQ.
         *
         * If `deadLetterQueue` is undefined, an SQS queue with default options will be defined for
         * your Function.
         *
         ...
         *
         * You can configure your Lambda function to pull in additional code during initialization
         * in the form of layers. Layers are packages of libraries or other dependencies that can be
         ...
         *
         * By default, Lambda functions send logs to an automatically created default log group
         * named /aws/lambda/<function name>. However you cannot change the properties of this
         * auto-created log group using the AWS CDK, e.g. you cannot set a different log retention.
         *
         ...
         * create a fully customizable log group with `logs.LogGroup` and use the `logGroup`
         * property to instruct the Lambda function to send logs to it. Migrating from
         * `logRetention` to `logGroup` will cause the name of the log group to change. Users and
         * code and referencing the name verbatim will have to adjust.
         *
         ...
         *
         * @param logRetentionRetryOptions When log retention is specified, a custom resource
         *   attempts to create the CloudWatch log group.
         */
        ...
        public fun logRetentionRetryOptions(
            logRetentionRetryOptions: LogRetentionRetryOptions.Builder.() -> Unit
        )
         ...
         *
         * @param reservedConcurrentExecutions The maximum of concurrent executions you want to
         ...
         *
         * Specify this if the Lambda function needs to access resources in a VPC. This is required
         * when `vpcSubnets` is specified.
         *
         ...
         *
         * Note: Internet access for Lambda Functions requires a NAT Gateway, so picking public
         * subnets is not allowed (unless `allowPublicSubnet` is set to `true`).
         *
    ...
    private class BuilderImpl(
        ...
        override fun adotInstrumentation(adotInstrumentation: AdotInstrumentationConfig) {
            cdkBuilder.adotInstrumentation(
                adotInstrumentation.let(AdotInstrumentationConfig::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("4764e4d9e828b7cd732d664fa1d778954b45cc3bccec1851d3f02556688e0988")
        override fun adotInstrumentation(
            adotInstrumentation: AdotInstrumentationConfig.Builder.() -> Unit
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("4abcc311dfa47bc240d258c435bc91c731f5942b6e6343ff379490176270ddb7")
        override fun currentVersionOptions(
            currentVersionOptions: VersionOptions.Builder.() -> Unit
        ...
        override fun logRetentionRetryOptions(logRetentionRetryOptions: LogRetentionRetryOptions) {
            cdkBuilder.logRetentionRetryOptions(
                logRetentionRetryOptions.let(LogRetentionRetryOptions::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("088bdc15b3a181940514d32cdcebb40d7221395edfb1fa50b7faea2eaa9d8b8f")
        override fun logRetentionRetryOptions(
            logRetentionRetryOptions: LogRetentionRetryOptions.Builder.() -> Unit
        ...
        override fun runtimeManagementMode(runtimeManagementMode: RuntimeManagementMode) {
            cdkBuilder.runtimeManagementMode(
                runtimeManagementMode.let(RuntimeManagementMode::unwrap)
            )
        }
    ...
    public companion object {
        public fun classifyVersionProperty(propertyName: String, locked: Boolean) {
            software.amazon.awscdk.services.lambda.Function.classifyVersionProperty(
                propertyName,
                locked
            )
        }
        ...
        public fun fromFunctionArn(
            ...
            software.amazon.awscdk.services.lambda.Function.fromFunctionArn(
        ...
        public fun fromFunctionAttributes(
            ...
            software.amazon.awscdk.services.lambda.Function.fromFunctionAttributes(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    attrs.let(FunctionAttributes::unwrap)
                )
                .let(IFunction::wrap)
        ...
        public fun fromFunctionName(
            ...
            software.amazon.awscdk.services.lambda.Function.fromFunctionName(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    functionName
                )
        ...
        public fun metricAll(metricName: String, props: MetricOptions): Metric =
            software.amazon.awscdk.services.lambda.Function.metricAll(
                    metricName,
                    props.let(MetricOptions::unwrap)
                )
                .let(Metric::wrap)
        ...
        public fun metricAllConcurrentExecutions(): Metric =
            software.amazon.awscdk.services.lambda.Function.metricAllConcurrentExecutions()
                .let(Metric::wrap)
        ...
        public fun metricAllDuration(props: MetricOptions): Metric =
            software.amazon.awscdk.services.lambda.Function.metricAllDuration(
                    props.let(MetricOptions::unwrap)
                )
                .let(Metric::wrap)
        ...
        public fun metricAllErrors(props: MetricOptions): Metric =
            software.amazon.awscdk.services.lambda.Function.metricAllErrors(
                    props.let(MetricOptions::unwrap)
                )
                .let(Metric::wrap)
        ...
        public fun metricAllInvocations(props: MetricOptions): Metric =
            software.amazon.awscdk.services.lambda.Function.metricAllInvocations(
                    props.let(MetricOptions::unwrap)
                )
                .let(Metric::wrap)
        ...
        public fun metricAllThrottles(props: MetricOptions): Metric =
            software.amazon.awscdk.services.lambda.Function.metricAllThrottles(
                    props.let(MetricOptions::unwrap)
                )
                .let(Metric::wrap)
        ...
        public fun metricAllUnreservedConcurrentExecutions(props: MetricOptions): Metric =
            software.amazon.awscdk.services.lambda.Function.metricAllUnreservedConcurrentExecutions(
                    props.let(MetricOptions::unwrap)
                )
                .let(Metric::wrap)
