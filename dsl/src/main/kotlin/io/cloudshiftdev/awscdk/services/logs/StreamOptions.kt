...
public interface StreamOptions {
    ...
    public interface Builder {
        /**
         * @param logStreamName The name of the log stream to create. The name must be unique within
         *   the log group.
         */
    ...
    public companion object {
        ...
        ): StreamOptions = Wrapper(cdkObject)

        internal fun unwrap(
            wrapped: StreamOptions
        ): software.amazon.awscdk.services.logs.StreamOptions = (wrapped as Wrapper).cdkObject
    }
}
