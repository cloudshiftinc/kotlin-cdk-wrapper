...
public interface ResourceConfig {
    ...
    public interface Builder {
        ...
        /**
         * @param instanceType ML compute instance type. To provide an instance type from the task
         *   input, supply an instance type in the following way where the value in the task input
         *   is an EC2 instance type prepended with "ml.":
         * ```
         * new InstanceType(JsonPath.stringAt("$.path.to.instanceType"));
         * ```
         */
        ...
        /**
         * @param volumeEncryptionKey KMS key that Amazon SageMaker uses to encrypt data on the
    ...
    internal constructor(
         ...
         * ML compute instance type.
         *
         * To provide an instance type from the task input, supply an instance type in the following
         * way where the value in the task input is an EC2 instance type prepended with "ml.":
         * ```
         * new InstanceType(JsonPath.stringAt("$.path.to.instanceType"));
         * ```
         *
        ...
        /**
         * KMS key that Amazon SageMaker uses to encrypt data on the storage volume attached to the
