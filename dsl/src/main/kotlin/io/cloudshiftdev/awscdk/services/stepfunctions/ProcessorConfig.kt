...
public interface ProcessorConfig {
  ...
  private class BuilderImpl : Builder {
    ...
    public override fun executionType(executionType: ProcessorType) {
      cdkBuilder.executionType(executionType.let(ProcessorType::unwrap))
    }

    public override fun mode(mode: ProcessorMode) {
  ...
  private class Wrapper internal constructor(
    ...
    public override fun executionType(): ProcessorType? =
        unwrap(this).getExecutionType()?.let(ProcessorType::wrap)

    public override fun mode(): ProcessorMode? = unwrap(this).getMode()?.let(ProcessorMode::wrap)
  }
