...
internal constructor(
    ...
    public companion object {
        public fun grpc(): VirtualRouterListener =
            software.amazon.awscdk.services.appmesh.VirtualRouterListener.grpc()
                .let(VirtualRouterListener::wrap)

        public fun grpc(port: Number): VirtualRouterListener =
            software.amazon.awscdk.services.appmesh.VirtualRouterListener.grpc(port)
                .let(VirtualRouterListener::wrap)

        public fun http(): VirtualRouterListener =
            software.amazon.awscdk.services.appmesh.VirtualRouterListener.http()
                .let(VirtualRouterListener::wrap)

        public fun http(port: Number): VirtualRouterListener =
            software.amazon.awscdk.services.appmesh.VirtualRouterListener.http(port)
                .let(VirtualRouterListener::wrap)

        public fun http2(): VirtualRouterListener =
            software.amazon.awscdk.services.appmesh.VirtualRouterListener.http2()
                .let(VirtualRouterListener::wrap)

        public fun http2(port: Number): VirtualRouterListener =
            software.amazon.awscdk.services.appmesh.VirtualRouterListener.http2(port)
                .let(VirtualRouterListener::wrap)

        public fun tcp(): VirtualRouterListener =
            software.amazon.awscdk.services.appmesh.VirtualRouterListener.tcp()
                .let(VirtualRouterListener::wrap)

        public fun tcp(port: Number): VirtualRouterListener =
            software.amazon.awscdk.services.appmesh.VirtualRouterListener.tcp(port)
                .let(VirtualRouterListener::wrap)
