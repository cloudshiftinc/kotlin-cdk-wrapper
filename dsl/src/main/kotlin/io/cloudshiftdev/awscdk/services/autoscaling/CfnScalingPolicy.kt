...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.autoscaling.CfnScalingPolicy,
     ...
     * Provides support for predefined and custom metrics.
     */
    public open fun predictiveScalingConfiguration(
        `value`: PredictiveScalingConfigurationProperty
    ) {
        unwrap(this)
            .setPredictiveScalingConfiguration(
                `value`.let(PredictiveScalingConfigurationProperty::unwrap)
            )
    }
    ...
    public open fun predictiveScalingConfiguration(
        `value`: PredictiveScalingConfigurationProperty.Builder.() -> Unit
    ...
    public open fun targetTrackingConfiguration(`value`: TargetTrackingConfigurationProperty) {
        unwrap(this)
            .setTargetTrackingConfiguration(
                `value`.let(TargetTrackingConfigurationProperty::unwrap)
            )
    }
    ...
    public open fun targetTrackingConfiguration(
        `value`: TargetTrackingConfigurationProperty.Builder.() -> Unit
    ...
    public interface Builder {
         ...
         *
         * @param adjustmentType Specifies how the scaling adjustment is interpreted (for example,
         ...
         * default instance warmup is null, then `EstimatedInstanceWarmup` falls back to the value
         * of default cooldown.
         *
         ...
         *
         * @param estimatedInstanceWarmup *Not needed if the default instance warmup is defined for
         *   the group.*.
         */
         ...
         * The aggregation type for the CloudWatch metrics.
         *
         * The valid values are `Minimum` , `Maximum` , and `Average` . If the aggregation type is
         ...
         * group by 25 percent and you specify a `MinAdjustmentMagnitude` of 2. If the group has 4
        ...
        public fun predictiveScalingConfiguration(
            predictiveScalingConfiguration:
                PredictiveScalingConfigurationProperty.Builder.() -> Unit
        )
        ...
        public fun targetTrackingConfiguration(
            targetTrackingConfiguration: TargetTrackingConfigurationProperty.Builder.() -> Unit
        )
    }
    ...
    private class BuilderImpl(
        ...
        override fun predictiveScalingConfiguration(predictiveScalingConfiguration: IResolvable) {
            cdkBuilder.predictiveScalingConfiguration(
                predictiveScalingConfiguration.let(IResolvable::unwrap)
            )
        }
         ...
         *   predefined and custom metrics.
         */
        override fun predictiveScalingConfiguration(
            predictiveScalingConfiguration: PredictiveScalingConfigurationProperty
        ) {
            cdkBuilder.predictiveScalingConfiguration(
                predictiveScalingConfiguration.let(PredictiveScalingConfigurationProperty::unwrap)
            )
        }
        ...
        override fun predictiveScalingConfiguration(
            ...
            predictiveScalingConfiguration(
                PredictiveScalingConfigurationProperty(predictiveScalingConfiguration)
            )
        ...
        override fun targetTrackingConfiguration(targetTrackingConfiguration: IResolvable) {
            cdkBuilder.targetTrackingConfiguration(
                targetTrackingConfiguration.let(IResolvable::unwrap)
            )
        }
        ...
        override fun targetTrackingConfiguration(
            ...
            cdkBuilder.targetTrackingConfiguration(
                targetTrackingConfiguration.let(TargetTrackingConfigurationProperty::unwrap)
            )
        }
        ...
        override fun targetTrackingConfiguration(
            ...
            targetTrackingConfiguration(
                TargetTrackingConfigurationProperty(targetTrackingConfiguration)
            )
    ...
    public interface PredefinedMetricSpecificationProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param resourceLabel A label that uniquely identifies a specific Application Load
             *   Balancer target group from which to determine the average request count served by
             *   your Auto Scaling group. You can't specify a resource label unless the target group
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: PredefinedMetricSpecificationProperty
            ): software.amazon.awscdk.services.autoscaling.CfnScalingPolicy.PredefinedMetricSpecificationProperty =
    ...
    public interface PredictiveScalingConfigurationProperty {
         ...
         * exceeds the maximum capacity of the Auto Scaling group.
         *
         ...
         *   maximum capacity when the forecast capacity is close to or exceeds the maximum
         ...
         */
        public fun maxCapacityBreachBehavior(): String? =
         ...
         * the buffer is 10, this means a 10 percent buffer, such that if the forecast capacity is
        ...
        public interface Builder {
             ...
             *   forecast capacity approaches or exceeds the maximum capacity of the Auto Scaling
             ...
             *   the maximum capacity when the forecast capacity is close to or exceeds the maximum
            ...
            /**
             * @param maxCapacityBuffer The size of the capacity buffer to use when the forecast
             *   capacity is close to or exceeds the maximum capacity. The value is specified as a
             *   percentage relative to the forecast capacity. For example, if the buffer is 10,
             *   this means a 10 percent buffer, such that if the forecast capacity is 50, and the
            ...
            /**
             * @param metricSpecifications This structure includes the metrics and target
             *   utilization to use for predictive scaling. This is an array, but we currently only
             *   support a single metric specification. That is, you can specify a target value and
             *   a single metric pair, or a target value and one scaling metric and one load metric.
             */
            ...
            /**
             * @param schedulingBufferTime The amount of time, in seconds, by which the instance
             *   launch time can be advanced. For example, the forecast says to add capacity at
             *   10:00 AM, and you choose to pre-launch instances by 5 minutes. In that case, the
             *   instances will be launched at 9:55 AM. The intention is to give resources time to
             *   be provisioned. It can take a few minutes to launch an EC2 instance. The actual
        ...
        internal constructor(
             ...
             * The amount of time, in seconds, by which the instance launch time can be advanced.
             *
             * For example, the forecast says to add capacity at 10:00 AM, and you choose to
             * pre-launch instances by 5 minutes. In that case, the instances will be launched at
             * 9:55 AM. The intention is to give resources time to be provisioned. It can take a few
             * minutes to launch an EC2 instance. The actual amount of time required depends on
             * several factors, such as the size of the instance and whether there are startup
             * scripts to complete.
             *
             * The value must be less than the forecast interval duration of 3600 seconds (60
             * minutes). Defaults to 300 seconds if not specified.
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: PredictiveScalingConfigurationProperty
            ): software.amazon.awscdk.services.autoscaling.CfnScalingPolicy.PredictiveScalingConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface MetricProperty {
         ...
         *
         * For the list of available dimensions, see the AWS documentation available from the table
         * in
        ...
        public interface Builder {
            /**
             * @param dimensions The dimensions for the metric. For the list of available
             *   dimensions, see the AWS documentation available from the table in
             *   [AWS services that publish CloudWatch metrics](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/aws-services-cloudwatch-metrics.html)
             *   in the *Amazon CloudWatch User Guide* .
             *
             * Conditional: If you published your metric with dimensions, you must specify the same
        ...
        internal constructor(
             ...
             * The dimensions for the metric.
             *
             * For the list of available dimensions, see the AWS documentation available from the
             * table in
             * [AWS services that publish CloudWatch metrics](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/aws-services-cloudwatch-metrics.html)
             * in the *Amazon CloudWatch User Guide* .
             *
    ...
    public interface PredictiveScalingPredefinedLoadMetricProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param resourceLabel A label that uniquely identifies a specific Application Load
             *   Balancer target group from which to determine the request count served by your Auto
        ...
        internal constructor(
            ...
            /**
             * A label that uniquely identifies a specific Application Load Balancer target group
             * from which to determine the request count served by your Auto Scaling group.
             *
             * You can't specify a resource label unless the target group is attached to the Auto
             * Scaling group.
             *
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: PredictiveScalingPredefinedLoadMetricProperty
            ): software.amazon.awscdk.services.autoscaling.CfnScalingPolicy.PredictiveScalingPredefinedLoadMetricProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface TargetTrackingConfigurationProperty {
         ...
         *
         * If scaling in is disabled, the target tracking scaling policy doesn't remove instances
         ...
         *
         * Some metrics are based on a count instead of a percentage, such as the request count for
         * an Application Load Balancer or the number of messages in an SQS queue. If the scaling
         * policy specifies one of these metrics, specify the target utilization as the optimal
        ...
        public interface Builder {
            /**
             * @param customizedMetricSpecification A customized metric. You must specify either a
             ...
             *   predefined metric or a customized metric.
             */
            public fun customizedMetricSpecification(
            ...
            public fun customizedMetricSpecification(
                customizedMetricSpecification:
                    CustomizedMetricSpecificationProperty.Builder.() -> Unit
            )

            /**
             * @param disableScaleIn Indicates whether scaling in by the target tracking scaling
             *   policy is disabled. If scaling in is disabled, the target tracking scaling policy
             *   doesn't remove instances from the Auto Scaling group. Otherwise, the target
             *   tracking scaling policy can remove instances from the Auto Scaling group. The
             *   default is `false` .
             */
            ...
            /**
             * @param predefinedMetricSpecification A predefined metric. You must specify either a
             *   predefined metric or a customized metric.
             */
             ...
             *   predefined metric or a customized metric.
             */
            public fun predefinedMetricSpecification(
            ...
            public fun predefinedMetricSpecification(
                predefinedMetricSpecification:
                    PredefinedMetricSpecificationProperty.Builder.() -> Unit
            )
        ...
        private class BuilderImpl : Builder {
            ...
            override fun customizedMetricSpecification(customizedMetricSpecification: IResolvable) {
                cdkBuilder.customizedMetricSpecification(
                    customizedMetricSpecification.let(IResolvable::unwrap)
                )
            }
             ...
             *   predefined metric or a customized metric.
             */
            override fun customizedMetricSpecification(
                customizedMetricSpecification: CustomizedMetricSpecificationProperty
            ) {
                cdkBuilder.customizedMetricSpecification(
                    customizedMetricSpecification.let(CustomizedMetricSpecificationProperty::unwrap)
                )
            }
            ...
            override fun customizedMetricSpecification(
                ...
                customizedMetricSpecification(
                    CustomizedMetricSpecificationProperty(customizedMetricSpecification)
                )
            ...
            override fun predefinedMetricSpecification(predefinedMetricSpecification: IResolvable) {
                cdkBuilder.predefinedMetricSpecification(
                    predefinedMetricSpecification.let(IResolvable::unwrap)
                )
            }
             ...
             *   predefined metric or a customized metric.
             */
            override fun predefinedMetricSpecification(
                predefinedMetricSpecification: PredefinedMetricSpecificationProperty
            ) {
                cdkBuilder.predefinedMetricSpecification(
                    predefinedMetricSpecification.let(PredefinedMetricSpecificationProperty::unwrap)
                )
            }
        ...
        internal constructor(
             ...
             * instances from the Auto Scaling group. Otherwise, the target tracking scaling policy
             * can remove instances from the Auto Scaling group. The default is `false` .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-autoscaling-scalingpolicy-targettrackingconfiguration.html#cfn-autoscaling-scalingpolicy-targettrackingconfiguration-disablescalein)
             */
    ...
    public interface MetricStatProperty {
        ...
        public interface Builder {
            /**
             * @param metric The CloudWatch metric to return, including the metric name, namespace,
             *   and dimensions. To get the exact metric name, namespace, and dimensions, inspect
             *   the
             *   [Metric](https://docs.aws.amazon.com/AmazonCloudWatch/latest/APIReference/API_Metric.html)
             *   object that is returned by a call to
             *   [ListMetrics](https://docs.aws.amazon.com/AmazonCloudWatch/latest/APIReference/API_ListMetrics.html)
            ...
            /**
             * @param unit The unit to use for the returned data points. For a complete list of the
    ...
    public interface StepAdjustmentProperty {
        ...
        public interface Builder {
             ...
             *   threshold and the CloudWatch metric. If the metric value is above the breach
             *   threshold, the lower bound is inclusive (the metric must be greater than or equal
             *   to the threshold plus the lower bound). Otherwise, it is exclusive (the metric must
             ...
             *   threshold and the CloudWatch metric. If the metric value is above the breach
             *   threshold, the upper bound is exclusive (the metric must be less than the threshold
             *   plus the upper bound). Otherwise, it is inclusive (the metric must be less than or
            ...
            /**
             * @param scalingAdjustment The amount by which to scale, based on the specified
             *   adjustment type. A positive value adds to the current capacity while a negative
             *   number removes from the current capacity. For exact capacity, you must specify a
             *   non-negative value.
             */
            public fun scalingAdjustment(scalingAdjustment: Number)
        }
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-autoscaling-scalingpolicy-stepadjustment.html#cfn-autoscaling-scalingpolicy-stepadjustment-metricintervallowerbound)
             */
            override fun metricIntervalLowerBound(): Number? =
                unwrap(this).getMetricIntervalLowerBound()
             ...
             *
             * If the metric value is above the breach threshold, the upper bound is exclusive (the
             * metric must be less than the threshold plus the upper bound). Otherwise, it is
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-autoscaling-scalingpolicy-stepadjustment.html#cfn-autoscaling-scalingpolicy-stepadjustment-metricintervalupperbound)
             */
            override fun metricIntervalUpperBound(): Number? =
                unwrap(this).getMetricIntervalUpperBound()
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: StepAdjustmentProperty
            ): software.amazon.awscdk.services.autoscaling.CfnScalingPolicy.StepAdjustmentProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface PredictiveScalingPredefinedScalingMetricProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: PredictiveScalingPredefinedScalingMetricProperty
            ): software.amazon.awscdk.services.autoscaling.CfnScalingPolicy.PredictiveScalingPredefinedScalingMetricProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface PredictiveScalingCustomizedCapacityMetricProperty {
        ...
        public interface Builder {
            /**
             * @param metricDataQueries One or more metric data queries to provide the data points
             *   for a capacity metric. Use multiple metric data queries only if you are performing
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: PredictiveScalingCustomizedCapacityMetricProperty
            ): software.amazon.awscdk.services.autoscaling.CfnScalingPolicy.PredictiveScalingCustomizedCapacityMetricProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface PredictiveScalingMetricSpecificationProperty {
        ...
        public interface Builder {
            /**
             * @param customizedCapacityMetricSpecification The customized capacity metric
             *   specification.
             */
            public fun customizedCapacityMetricSpecification(
                customizedCapacityMetricSpecification: IResolvable
            )
            ...
            public fun customizedCapacityMetricSpecification(
                customizedCapacityMetricSpecification:
                    PredictiveScalingCustomizedCapacityMetricProperty.Builder.() -> Unit
            )
            ...
            public fun customizedLoadMetricSpecification(
                customizedLoadMetricSpecification:
                    PredictiveScalingCustomizedLoadMetricProperty.Builder.() -> Unit
            )

            /**
             * @param customizedScalingMetricSpecification The customized scaling metric
             *   specification.
             */
            ...
            public fun customizedScalingMetricSpecification(
                customizedScalingMetricSpecification:
                    PredictiveScalingCustomizedScalingMetricProperty.Builder.() -> Unit
            )
            ...
            public fun predefinedLoadMetricSpecification(
                predefinedLoadMetricSpecification:
                    PredictiveScalingPredefinedLoadMetricProperty.Builder.() -> Unit
            )

            /**
             * @param predefinedMetricPairSpecification The predefined metric pair specification
             *   from which Amazon EC2 Auto Scaling determines the appropriate scaling metric and
             *   load metric to use.
             */
            public fun predefinedMetricPairSpecification(
                predefinedMetricPairSpecification: IResolvable
            )
            ...
            public fun predefinedMetricPairSpecification(
                predefinedMetricPairSpecification:
                    PredictiveScalingPredefinedMetricPairProperty.Builder.() -> Unit
            )

            /**
             * @param predefinedScalingMetricSpecification The predefined scaling metric
             *   specification.
             */
            ...
            public fun predefinedScalingMetricSpecification(
                predefinedScalingMetricSpecification:
                    PredictiveScalingPredefinedScalingMetricProperty.Builder.() -> Unit
            )
        ...
        private class BuilderImpl : Builder {
             ...
             *   specification.
             */
            override fun customizedCapacityMetricSpecification(
                customizedCapacityMetricSpecification: IResolvable
            ) {
                cdkBuilder.customizedCapacityMetricSpecification(
                    customizedCapacityMetricSpecification.let(IResolvable::unwrap)
                )
            }
            ...
            override fun customizedCapacityMetricSpecification(
                ...
                cdkBuilder.customizedCapacityMetricSpecification(
                    customizedCapacityMetricSpecification.let(
                        PredictiveScalingCustomizedCapacityMetricProperty::unwrap
                    )
                )
            }
            ...
            override fun customizedLoadMetricSpecification(
                ...
                cdkBuilder.customizedLoadMetricSpecification(
                    customizedLoadMetricSpecification.let(
                        PredictiveScalingCustomizedLoadMetricProperty::unwrap
                    )
                )
            }
            ...
            override fun customizedLoadMetricSpecification(
                ...
                customizedLoadMetricSpecification(
                    PredictiveScalingCustomizedLoadMetricProperty(customizedLoadMetricSpecification)
                )
            ...
            override fun customizedScalingMetricSpecification(
                ...
                cdkBuilder.customizedScalingMetricSpecification(
                    customizedScalingMetricSpecification.let(
                        PredictiveScalingCustomizedScalingMetricProperty::unwrap
                    )
                )
            }
            ...
            override fun predefinedLoadMetricSpecification(
                ...
                cdkBuilder.predefinedLoadMetricSpecification(
                    predefinedLoadMetricSpecification.let(
                        PredictiveScalingPredefinedLoadMetricProperty::unwrap
                    )
                )
            }
             ...
             *   load metric to use.
             */
            override fun predefinedMetricPairSpecification(
                predefinedMetricPairSpecification: IResolvable
            ) {
                cdkBuilder.predefinedMetricPairSpecification(
                    predefinedMetricPairSpecification.let(IResolvable::unwrap)
                )
            }
            ...
            override fun predefinedMetricPairSpecification(
                ...
                cdkBuilder.predefinedMetricPairSpecification(
                    predefinedMetricPairSpecification.let(
                        PredictiveScalingPredefinedMetricPairProperty::unwrap
                    )
                )
            }
            ...
            override fun predefinedMetricPairSpecification(
                ...
                predefinedMetricPairSpecification(
                    PredictiveScalingPredefinedMetricPairProperty(predefinedMetricPairSpecification)
                )
            ...
            override fun predefinedScalingMetricSpecification(
                ...
                cdkBuilder.predefinedScalingMetricSpecification(
                    predefinedScalingMetricSpecification.let(
                        PredictiveScalingPredefinedScalingMetricProperty::unwrap
                    )
                )
            }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: PredictiveScalingMetricSpecificationProperty
            ): software.amazon.awscdk.services.autoscaling.CfnScalingPolicy.PredictiveScalingMetricSpecificationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface PredictiveScalingCustomizedLoadMetricProperty {
        ...
        public interface Builder {
            /**
             * @param metricDataQueries One or more metric data queries to provide the data points
             *   for a load metric. Use multiple metric data queries only if you are performing a
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: PredictiveScalingCustomizedLoadMetricProperty
            ): software.amazon.awscdk.services.autoscaling.CfnScalingPolicy.PredictiveScalingCustomizedLoadMetricProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface PredictiveScalingPredefinedMetricPairProperty {
         ...
         * one is a scaling metric. For example, if the metric type is `ASGCPUUtilization` , the
         * Auto Scaling group's total CPU metric is used as the load metric, and the average CPU
         * metric is used for the scaling metric.
         *
        ...
        public interface Builder {
            /**
             * @param predefinedMetricType Indicates which metrics to use. There are two different
             *   types of metrics for each metric type: one is a load metric and one is a scaling
             *   metric. For example, if the metric type is `ASGCPUUtilization` , the Auto Scaling
             *   group's total CPU metric is used as the load metric, and the average CPU metric is
            ...
            /**
             * @param resourceLabel A label that uniquely identifies a specific Application Load
             *   Balancer target group from which to determine the total and average request count
             *   served by your Auto Scaling group. You can't specify a resource label unless the
        ...
        internal constructor(
             ...
             * Indicates which metrics to use.
             *
             * There are two different types of metrics for each metric type: one is a load metric
             * and one is a scaling metric. For example, if the metric type is `ASGCPUUtilization` ,
             * the Auto Scaling group's total CPU metric is used as the load metric, and the average
            ...
            /**
             * A label that uniquely identifies a specific Application Load Balancer target group
             * from which to determine the total and average request count served by your Auto
             * Scaling group.
             *
             * You can't specify a resource label unless the target group is attached to the Auto
             * Scaling group.
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: PredictiveScalingPredefinedMetricPairProperty
            ): software.amazon.awscdk.services.autoscaling.CfnScalingPolicy.PredictiveScalingPredefinedMetricPairProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface MetricDataQueryProperty {
         ...
         *
         * This name must be unique among all `MetricDataQuery` objects specified for a single
         ...
         * valid characters are letters, numbers, and underscores. The first character must be a
         * lowercase letter.
         *
        ...
        public interface Builder {
            /**
             * @param expression The math expression to perform on the returned data, if this object
            ...
            /**
             * @param id A short name that identifies the object's results in the response. This
             *   name must be unique among all `MetricDataQuery` objects specified for a single
             ...
             *   expression. The valid characters are letters, numbers, and underscores. The first
            ...
            /**
             * @param metricStat Information about the metric data to return. Conditional: Within
             *   each `MetricDataQuery` object, you must specify either `Expression` or `MetricStat`
             *   , but not both.
             */
            ...
            /**
             * @param returnData Indicates whether to return the timestamps and raw data values of
             *   this metric. If you use any math expressions, specify `true` for this value for
             *   only the final math expression that the metric specification is based on. You must
             *   specify `false` for `ReturnData` for all the other metrics and expressions used in
        ...
        internal constructor(
             ...
             * math expression.
             *
             * This expression can use the `Id` of the other metrics to refer to those metrics, and
             ...
             * math expression that the metric specification is based on. You must specify `false`
             * for `ReturnData` for all the other metrics and expressions used in the metric
             * specification.
             *
             * If you are only retrieving metrics and not performing any math expressions, do not
             * specify anything for `ReturnData` . This sets it to its default ( `true` ).
    ...
    public interface CustomizedMetricSpecificationProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CustomizedMetricSpecificationProperty
            ): software.amazon.awscdk.services.autoscaling.CfnScalingPolicy.CustomizedMetricSpecificationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface PredictiveScalingCustomizedScalingMetricProperty {
        ...
        public interface Builder {
            /**
             * @param metricDataQueries One or more metric data queries to provide the data points
             *   for a scaling metric. Use multiple metric data queries only if you are performing a
             *   math expression on returned data.
             */
            public fun metricDataQueries(metricDataQueries: IResolvable)
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: PredictiveScalingCustomizedScalingMetricProperty
            ): software.amazon.awscdk.services.autoscaling.CfnScalingPolicy.PredictiveScalingCustomizedScalingMetricProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
