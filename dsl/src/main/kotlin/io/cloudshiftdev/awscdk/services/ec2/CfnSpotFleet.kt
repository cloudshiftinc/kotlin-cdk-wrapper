...
internal constructor(
    ...
    public open fun spotFleetRequestConfigData(`value`: SpotFleetRequestConfigDataProperty) {
        unwrap(this)
            .setSpotFleetRequestConfigData(`value`.let(SpotFleetRequestConfigDataProperty::unwrap))
    }

    /** Describes the configuration of a Spot Fleet request. */
    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("36d6398bf26b73cf18eb0b8c512d5387a8849d6c130a26ce24afdff186bb169a")
    public open fun spotFleetRequestConfigData(
        `value`: SpotFleetRequestConfigDataProperty.Builder.() -> Unit
    ...
    public interface Builder {
        ...
        public fun spotFleetRequestConfigData(
            spotFleetRequestConfigData: SpotFleetRequestConfigDataProperty.Builder.() -> Unit
        )
    }
    ...
    private class BuilderImpl(
        ...
        override fun spotFleetRequestConfigData(spotFleetRequestConfigData: IResolvable) {
            cdkBuilder.spotFleetRequestConfigData(
                spotFleetRequestConfigData.let(IResolvable::unwrap)
            )
        }
         ...
         * @param spotFleetRequestConfigData Describes the configuration of a Spot Fleet request.
         */
        override fun spotFleetRequestConfigData(
            spotFleetRequestConfigData: SpotFleetRequestConfigDataProperty
        ) {
            cdkBuilder.spotFleetRequestConfigData(
                spotFleetRequestConfigData.let(SpotFleetRequestConfigDataProperty::unwrap)
            )
        }
        ...
        override fun spotFleetRequestConfigData(
            ...
            spotFleetRequestConfigData(
                SpotFleetRequestConfigDataProperty(spotFleetRequestConfigData)
            )
    ...
    public companion object {
        ...
        ): CfnSpotFleet = CfnSpotFleet(cdkObject)

        internal fun unwrap(
            wrapped: CfnSpotFleet
        ): software.amazon.awscdk.services.ec2.CfnSpotFleet = wrapped.cdkObject
    }
    ...
    public interface AcceleratorCountRequestProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AcceleratorCountRequestProperty
            ): software.amazon.awscdk.services.ec2.CfnSpotFleet.AcceleratorCountRequestProperty =
    ...
    public interface MemoryGiBPerVCpuRequestProperty {
        ...
        public interface Builder {
            /**
             * @param max The maximum amount of memory per vCPU, in GiB. To specify no maximum
             *   limit, omit this parameter.
             */
            public fun max(max: Number)

            /**
             * @param min The minimum amount of memory per vCPU, in GiB. To specify no minimum
             *   limit, omit this parameter.
             */
            public fun min(min: Number)
        }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: MemoryGiBPerVCpuRequestProperty
            ): software.amazon.awscdk.services.ec2.CfnSpotFleet.MemoryGiBPerVCpuRequestProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface BlockDeviceMappingProperty {
         ...
         * instance store volumes can specify mappings for `ephemeral0` and `ephemeral1` . The
         * number of available instance store volumes depends on the instance type. After you
        ...
        public interface Builder {
            ...
            /**
             * @param noDevice To omit the device from the block device mapping, specify an empty
             *   string. When this property is specified, the device is removed from the block
             *   device mapping regardless of the assigned value.
             */
            public fun noDevice(noDevice: String)

            /**
             * @param virtualName The virtual device name ( `ephemeral` N). Instance store volumes
             *   are numbered starting from 0. An instance type with 2 available instance store
             *   volumes can specify mappings for `ephemeral0` and `ephemeral1` . The number of
             *   available instance store volumes depends on the instance type. After you connect to
        ...
        internal constructor(
             ...
             * available instance store volumes can specify mappings for `ephemeral0` and
             * `ephemeral1` . The number of available instance store volumes depends on the instance
    ...
    public interface SpotFleetMonitoringProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SpotFleetMonitoringProperty
            ): software.amazon.awscdk.services.ec2.CfnSpotFleet.SpotFleetMonitoringProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface VCpuCountRangeRequestProperty {
        ...
        public interface Builder {
            /**
             * @param max The maximum number of vCPUs. To specify no maximum limit, omit this
             *   parameter.
             */
            public fun max(max: Number)
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: VCpuCountRangeRequestProperty
            ): software.amazon.awscdk.services.ec2.CfnSpotFleet.VCpuCountRangeRequestProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface InstanceRequirementsRequestProperty {
         ...
         */
        public fun acceleratorManufacturers(): List<String> =
         ...
         */
        public fun acceleratorNames(): List<String> =
            unwrap(this).getAcceleratorNames() ?: emptyList()
         ...
         */
        public fun acceleratorTypes(): List<String> =
            unwrap(this).getAcceleratorTypes() ?: emptyList()
         ...
         */
        public fun allowedInstanceTypes(): List<String> =
         ...
         */
        public fun cpuManufacturers(): List<String> =
            unwrap(this).getCpuManufacturers() ?: emptyList()
         ...
         */
        public fun excludedInstanceTypes(): List<String> =
         ...
         * instance types are typically the latest two to three generations in each instance family.
         * For more information, see
         ...
         */
        public fun instanceGenerations(): List<String> =
         ...
         */
        public fun localStorageTypes(): List<String> =
            unwrap(this).getLocalStorageTypes() ?: emptyList()

        /**
         * [Price protection] The price protection threshold for Spot Instances, as a percentage of
         ...
         * instance type matches your attributes, then the identified price is from the lowest
         * priced current generation instance types, and failing that, from the lowest priced
         * previous generation instance types that match your attributes. When Amazon EC2 selects
         * instance types with your attributes, it will exclude instance types whose price exceeds
         ...
         * either, then `SpotMaxPricePercentageOverLowestPrice` is used and the value for that
         ...
         *
         * The identified On-Demand price is the price of the lowest priced current generation C, M,
         * or R instance type with your specified attributes. When Amazon EC2 selects instance types
         ...
         * priced current generation instance types, and failing that, from the lowest priced
         * previous generation instance types that match your attributes. When Amazon EC2 selects
         * instance types with your attributes, it will exclude instance types whose Spot price
        ...
        public interface Builder {
            /**
             * @param acceleratorCount The minimum and maximum number of accelerators (GPUs, FPGAs,
             *   or AWS Inferentia chips) on an instance. To exclude accelerator-enabled instance
             *   types, set `Max` to `0` .
             *
             * Default: No minimum or maximum limits
             */
            ...
            public fun acceleratorCount(
                acceleratorCount: AcceleratorCountRequestProperty.Builder.() -> Unit
            )
             ...
             *   memory, in MiB. Default: No minimum or maximum limits
             */
            ...
            public fun acceleratorTotalMemoryMiB(
                acceleratorTotalMemoryMiB:
                    AcceleratorTotalMemoryMiBRequestProperty.Builder.() -> Unit
            )
            ...
            /**
             * @param allowedInstanceTypes The instance types to apply your specified attributes
             *   against. All other instance types are ignored, even if they match your specified
             *   attributes.
             *
            ...
            /**
             * @param bareMetal Indicates whether bare metal instance types must be included,
            ...
            /**
             * @param baselineEbsBandwidthMbps The minimum and maximum baseline bandwidth to Amazon
             *   EBS, in Mbps. For more information, see
             *   [Amazon EBS–optimized instances](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ebs-optimized.html)
             *   in the *Amazon EC2 User Guide* .
             *
             * Default: No minimum or maximum limits
            ...
            public fun baselineEbsBandwidthMbps(
                baselineEbsBandwidthMbps: BaselineEbsBandwidthMbpsRequestProperty.Builder.() -> Unit
            )

            /**
             * @param burstablePerformance Indicates whether burstable performance T instance types
             *   are included, excluded, or required. For more information, see
             *   [Burstable performance instances](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/burstable-performance-instances.html)
             *   .
             * * To include burstable performance instance types, specify `included` .
             * * To require only burstable performance instance types, specify `required` .
             ...
             * launched with a compatible CPU architecture based on the Amazon Machine Image (AMI)
            ...
            /**
             * @param excludedInstanceTypes The instance types to exclude. You can use strings with
             *   one or more wild cards, represented by an asterisk ( `*` ), to exclude an instance
             *   family, type, size, or generation. The following are examples: `m5.8xlarge` ,
             *   `c5*.*` , `m5a.*` , `r*` , `*3*` .
             *
            ...
            /**
             * @param instanceGenerations Indicates whether current or previous generation instance
             *   types are included. The current generation instance types are recommended for use.
             *   Current generation instance types are typically the latest two to three generations
             ...
             *   protection threshold for Spot Instances, as a percentage of an identified On-Demand
             *   price. The identified On-Demand price is the price of the lowest priced current
             *   generation C, M, or R instance type with your specified attributes. If no current
             *   generation C, M, or R instance type matches your attributes, then the identified
             *   price is from the lowest priced current generation instance types, and failing
             *   that, from the lowest priced previous generation instance types that match your
             *   attributes. When Amazon EC2 selects instance types with your attributes, it will
             ...
             *
             * If you set `DesiredCapacityType` to `vcpu` or `memory-mib` , the price protection
             * threshold is based on the per vCPU or per memory price instead of the per instance
             * price.
             *
             * Only one of `SpotMaxPricePercentageOverLowestPrice` or
             * `MaxSpotPriceAsPercentageOfOptimalOnDemandPrice` can be specified. If you don't
             * specify either, then `SpotMaxPricePercentageOverLowestPrice` is used and the value
             * for that parameter defaults to `100` .
             */
            ...
            public fun memoryGiBPerVCpu(
                memoryGiBPerVCpu: MemoryGiBPerVCpuRequestProperty.Builder.() -> Unit
            )
            ...
            /**
             * @param networkBandwidthGbps The minimum and maximum amount of baseline network
             *   bandwidth, in gigabits per second (Gbps). For more information, see
             *   [Amazon EC2 instance network bandwidth](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-instance-network-bandwidth.html)
             *   in the *Amazon EC2 User Guide* .
             *
             * Default: No minimum or maximum limits
            ...
            public fun networkBandwidthGbps(
                networkBandwidthGbps: NetworkBandwidthGbpsRequestProperty.Builder.() -> Unit
            )
            ...
            public fun networkInterfaceCount(
                networkInterfaceCount: NetworkInterfaceCountRequestProperty.Builder.() -> Unit
            )

            /**
             * @param onDemandMaxPricePercentageOverLowestPrice [Price protection] The price
             *   protection threshold for On-Demand Instances, as a percentage higher than an
             *   identified On-Demand price. The identified On-Demand price is the price of the
            ...
            /**
             * @param requireHibernateSupport Indicates whether instance types must support
             *   hibernation for On-Demand Instances. This parameter is not supported for
             *   [GetSpotPlacementScores](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_GetSpotPlacementScores.html)
             *   .
             *
             * Default: `false`
             ...
             *   C, M, or R instance type with your specified attributes. If no current generation
             *   C, M, or R instance type matches your attributes, then the identified Spot price is
             *   from the lowest priced current generation instance types, and failing that, from
            ...
            /**
             * @param totalLocalStorageGb The minimum and maximum amount of total local storage, in
             *   GB. Default: No minimum or maximum limits
             */
            ...
            public fun totalLocalStorageGb(
                totalLocalStorageGb: TotalLocalStorageGBRequestProperty.Builder.() -> Unit
            )
        ...
        private class BuilderImpl : Builder {
            ...
            override fun acceleratorCount(acceleratorCount: AcceleratorCountRequestProperty) {
                cdkBuilder.acceleratorCount(
                    acceleratorCount.let(AcceleratorCountRequestProperty::unwrap)
                )
            }
            ...
            override fun acceleratorTotalMemoryMiB(acceleratorTotalMemoryMiB: IResolvable) {
                cdkBuilder.acceleratorTotalMemoryMiB(
                    acceleratorTotalMemoryMiB.let(IResolvable::unwrap)
                )
            }
             ...
             *   memory, in MiB. Default: No minimum or maximum limits
             */
            override fun acceleratorTotalMemoryMiB(
                acceleratorTotalMemoryMiB: AcceleratorTotalMemoryMiBRequestProperty
            ) {
                cdkBuilder.acceleratorTotalMemoryMiB(
                    acceleratorTotalMemoryMiB.let(AcceleratorTotalMemoryMiBRequestProperty::unwrap)
                )
            }
            ...
            override fun acceleratorTotalMemoryMiB(
                ...
                acceleratorTotalMemoryMiB(
                    AcceleratorTotalMemoryMiBRequestProperty(acceleratorTotalMemoryMiB)
                )
            ...
            override fun baselineEbsBandwidthMbps(baselineEbsBandwidthMbps: IResolvable) {
                cdkBuilder.baselineEbsBandwidthMbps(
                    baselineEbsBandwidthMbps.let(IResolvable::unwrap)
                )
            }
            ...
            override fun baselineEbsBandwidthMbps(
                ...
                cdkBuilder.baselineEbsBandwidthMbps(
                    baselineEbsBandwidthMbps.let(BaselineEbsBandwidthMbpsRequestProperty::unwrap)
                )
            }
            ...
            override fun baselineEbsBandwidthMbps(
                ...
                baselineEbsBandwidthMbps(
                    BaselineEbsBandwidthMbpsRequestProperty(baselineEbsBandwidthMbps)
                )
             ...
             * for that parameter defaults to `100` .
             */
            override fun maxSpotPriceAsPercentageOfOptimalOnDemandPrice(
                maxSpotPriceAsPercentageOfOptimalOnDemandPrice: Number
            ) {
            ...
            override fun memoryGiBPerVCpu(memoryGiBPerVCpu: MemoryGiBPerVCpuRequestProperty) {
                cdkBuilder.memoryGiBPerVCpu(
                    memoryGiBPerVCpu.let(MemoryGiBPerVCpuRequestProperty::unwrap)
                )
            }
             ...
             * Default: No minimum or maximum limits
             */
            override fun networkBandwidthGbps(
                networkBandwidthGbps: NetworkBandwidthGbpsRequestProperty
            ) {
                cdkBuilder.networkBandwidthGbps(
                    networkBandwidthGbps.let(NetworkBandwidthGbpsRequestProperty::unwrap)
                )
            }
            ...
            override fun networkBandwidthGbps(
                ...
                networkBandwidthGbps(NetworkBandwidthGbpsRequestProperty(networkBandwidthGbps))
             ...
             *   Default: No minimum or maximum limits
             */
            override fun networkInterfaceCount(
                networkInterfaceCount: NetworkInterfaceCountRequestProperty
            ) {
                cdkBuilder.networkInterfaceCount(
                    networkInterfaceCount.let(NetworkInterfaceCountRequestProperty::unwrap)
                )
            }
            ...
            override fun networkInterfaceCount(
                ...
                networkInterfaceCount(NetworkInterfaceCountRequestProperty(networkInterfaceCount))
             ...
             * Default: `20`
             */
            override fun onDemandMaxPricePercentageOverLowestPrice(
                onDemandMaxPricePercentageOverLowestPrice: Number
            ) {
             ...
             * Default: `100`
             */
            override fun spotMaxPricePercentageOverLowestPrice(
                spotMaxPricePercentageOverLowestPrice: Number
            ) {
                cdkBuilder.spotMaxPricePercentageOverLowestPrice(
             ...
             *   GB. Default: No minimum or maximum limits
             */
            override fun totalLocalStorageGb(
                totalLocalStorageGb: TotalLocalStorageGBRequestProperty
            ) {
                cdkBuilder.totalLocalStorageGb(
                    totalLocalStorageGb.let(TotalLocalStorageGBRequestProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("f6cba54a5ddca06f090236dc9a4804843ab47ff2b3010cee01398011e0ca44fe")
            override fun vCpuCount(
                vCpuCount: VCpuCountRangeRequestProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ec2-spotfleet-instancerequirementsrequest.html#cfn-ec2-spotfleet-instancerequirementsrequest-acceleratornames)
             */
            override fun acceleratorNames(): List<String> =
                unwrap(this).getAcceleratorNames() ?: emptyList()
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ec2-spotfleet-instancerequirementsrequest.html#cfn-ec2-spotfleet-instancerequirementsrequest-acceleratortotalmemorymib)
             */
            override fun acceleratorTotalMemoryMiB(): Any? =
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ec2-spotfleet-instancerequirementsrequest.html#cfn-ec2-spotfleet-instancerequirementsrequest-acceleratortypes)
             */
            override fun acceleratorTypes(): List<String> =
                unwrap(this).getAcceleratorTypes() ?: emptyList()
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ec2-spotfleet-instancerequirementsrequest.html#cfn-ec2-spotfleet-instancerequirementsrequest-allowedinstancetypes)
             */
            override fun allowedInstanceTypes(): List<String> =
                unwrap(this).getAllowedInstanceTypes() ?: emptyList()
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ec2-spotfleet-instancerequirementsrequest.html#cfn-ec2-spotfleet-instancerequirementsrequest-baselineebsbandwidthmbps)
             */
            override fun baselineEbsBandwidthMbps(): Any? =
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ec2-spotfleet-instancerequirementsrequest.html#cfn-ec2-spotfleet-instancerequirementsrequest-cpumanufacturers)
             */
            override fun cpuManufacturers(): List<String> =
                unwrap(this).getCpuManufacturers() ?: emptyList()
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ec2-spotfleet-instancerequirementsrequest.html#cfn-ec2-spotfleet-instancerequirementsrequest-excludedinstancetypes)
             */
            override fun excludedInstanceTypes(): List<String> =
                unwrap(this).getExcludedInstanceTypes() ?: emptyList()
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ec2-spotfleet-instancerequirementsrequest.html#cfn-ec2-spotfleet-instancerequirementsrequest-instancegenerations)
             */
            override fun instanceGenerations(): List<String> =
                unwrap(this).getInstanceGenerations() ?: emptyList()
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ec2-spotfleet-instancerequirementsrequest.html#cfn-ec2-spotfleet-instancerequirementsrequest-localstoragetypes)
             */
            override fun localStorageTypes(): List<String> =
                unwrap(this).getLocalStorageTypes() ?: emptyList()

            /**
             * [Price protection] The price protection threshold for Spot Instances, as a percentage
             * of an identified On-Demand price.
             *
             ...
             * priced previous generation instance types that match your attributes. When Amazon EC2
             * selects instance types with your attributes, it will exclude instance types whose
             ...
             * The identified Spot price is the Spot price of the lowest priced current generation
             * C, M, or R instance type with your specified attributes. If no current generation C,
             * M, or R instance type matches your attributes, then the identified Spot price is from
             * the lowest priced current generation instance types, and failing that, from the
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: InstanceRequirementsRequestProperty
            ): software.amazon.awscdk.services.ec2.CfnSpotFleet.InstanceRequirementsRequestProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SpotFleetTagSpecificationProperty {
        ...
        public interface Builder {
            /**
             * @param resourceType The type of resource. Currently, the only resource type that is
             *   supported is `instance` . To tag the Spot Fleet request on creation, use the
        ...
        internal constructor(
             ...
             * The type of resource.
             *
             * Currently, the only resource type that is supported is `instance` . To tag the Spot
             * Fleet request on creation, use the `TagSpecifications` parameter in
             * `[SpotFleetRequestConfigData](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_SpotFleetRequestConfigData.html)`
             * .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ec2-spotfleet-spotfleettagspecification.html#cfn-ec2-spotfleet-spotfleettagspecification-resourcetype)
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SpotFleetTagSpecificationProperty
            ): software.amazon.awscdk.services.ec2.CfnSpotFleet.SpotFleetTagSpecificationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface PrivateIpAddressSpecificationProperty {
        ...
        private class BuilderImpl : Builder {
            private val cdkBuilder:
                ...
                software.amazon.awscdk.services.ec2.CfnSpotFleet
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: PrivateIpAddressSpecificationProperty
            ): software.amazon.awscdk.services.ec2.CfnSpotFleet.PrivateIpAddressSpecificationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface LaunchTemplateConfigProperty {
        ...
        public interface Builder {
            /**
             * @param launchTemplateSpecification The launch template to use. Make sure that the
             *   launch template does not contain the `NetworkInterfaceId` parameter because you
             *   can't specify a network interface ID in a Spot Fleet.
             */
            ...
            public fun launchTemplateSpecification(
                launchTemplateSpecification:
                    FleetLaunchTemplateSpecificationProperty.Builder.() -> Unit
            )

            /**
             * @param overrides Any parameters that you specify override the same parameters in the
             *   launch template.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            override fun launchTemplateSpecification(launchTemplateSpecification: IResolvable) {
                cdkBuilder.launchTemplateSpecification(
                    launchTemplateSpecification.let(IResolvable::unwrap)
                )
            }
             ...
             *   can't specify a network interface ID in a Spot Fleet.
             */
            override fun launchTemplateSpecification(
                launchTemplateSpecification: FleetLaunchTemplateSpecificationProperty
            ) {
                cdkBuilder.launchTemplateSpecification(
                    launchTemplateSpecification.let(
                        FleetLaunchTemplateSpecificationProperty::unwrap
                    )
                )
            }
            ...
            override fun launchTemplateSpecification(
                ...
                launchTemplateSpecification(
                    FleetLaunchTemplateSpecificationProperty(launchTemplateSpecification)
                )
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: LaunchTemplateConfigProperty
            ): software.amazon.awscdk.services.ec2.CfnSpotFleet.LaunchTemplateConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface EbsBlockDeviceProperty {
         ...
         * from a snapshot), starting encryption state, ownership, and whether encryption by default
         ...
         * default is the snapshot size. You can specify a volume size that is equal to or larger
        ...
        public interface Builder {
            ...
            /**
             * @param encrypted Indicates whether the encryption state of an EBS volume is changed
             *   while being restored from a backing snapshot. The effect of setting the encryption
             ...
             *   `io2` volumes, this represents the number of IOPS that are provisioned for the
            ...
            /**
             * @param volumeSize The size of the volume, in GiBs. You must specify either a snapshot
             *   ID or a volume size. If you specify a snapshot, the default is the snapshot size.
    ...
    public interface GroupIdentifierProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: GroupIdentifierProperty
            ): software.amazon.awscdk.services.ec2.CfnSpotFleet.GroupIdentifierProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ClassicLoadBalancerProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ClassicLoadBalancerProperty
            ): software.amazon.awscdk.services.ec2.CfnSpotFleet.ClassicLoadBalancerProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SpotCapacityRebalanceProperty {
         ...
         * instances, or you can leave them running. You are charged for all instances while they
         * are running.
         *
         * `launch-before-terminate` - Spot Fleet launches a new replacement Spot Instance when a
         * rebalance notification is emitted for an existing Spot Instance in the fleet, and then,
         * after a delay that you specify (in `TerminationDelay` ), terminates the instances that
        ...
        public interface Builder {
            /**
             * @param replacementStrategy The replacement strategy to use. Only available for fleets
             *   of type `maintain` . `launch` - Spot Fleet launches a new replacement Spot Instance
             *   when a rebalance notification is emitted for an existing Spot Instance in the
             *   fleet. Spot Fleet does not terminate the instances that receive a rebalance
             *   notification. You can terminate the old instances, or you can leave them running.
             *   You are charged for all instances while they are running.
             *
             * `launch-before-terminate` - Spot Fleet launches a new replacement Spot Instance when
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SpotCapacityRebalanceProperty
            ): software.amazon.awscdk.services.ec2.CfnSpotFleet.SpotCapacityRebalanceProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SpotFleetLaunchSpecificationProperty {
         ...
         *
         * `SpotFleetLaunchSpecification` currently does not support Elastic Fabric Adapter (EFA).
         * To specify an EFA, you must use
         ...
         * information about whether you need to specify a RAM disk. To find kernel requirements,
        ...
        public interface Builder {
            /**
             * @param blockDeviceMappings One or more block devices that are mapped to the Spot
             *   Instances. You can't specify both a snapshot ID and an encryption value. This is
             *   because only blank volumes can be encrypted on creation. If a snapshot is the basis
             *   for a volume, it is not blank and its encryption status is used for the volume
             *   encryption status.
             */
            ...
            public fun iamInstanceProfile(
                iamInstanceProfile: IamInstanceProfileSpecificationProperty.Builder.() -> Unit
            )
            ...
            /**
             * @param instanceRequirements The attributes for the instance types. When you specify
             *   instance attributes, Amazon EC2 will identify instance types with those attributes.
             *
             * If you specify `InstanceRequirements` , you can't specify `InstanceType` .
             */
            ...
            public fun instanceRequirements(
                instanceRequirements: InstanceRequirementsRequestProperty.Builder.() -> Unit
            )
            ...
            /**
             * @param networkInterfaces One or more network interfaces. If you specify a network
             *   interface, you must specify subnet IDs and security group IDs using the network
             *   interface.
             *
             * `SpotFleetLaunchSpecification` currently does not support Elastic Fabric Adapter
             * (EFA). To specify an EFA, you must use
             * [LaunchTemplateConfig](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_LaunchTemplateConfig.html)
             * .
             */
            ...
            /**
             * @param ramdiskId The ID of the RAM disk. Some kernels require additional drivers at
            ...
            /**
             * @param spotPrice The maximum price per unit hour that you are willing to pay for a
             *   Spot Instance. We do not recommend using this parameter because it can lead to
            ...
            /**
             * @param subnetId The IDs of the subnets in which to launch the instances. To specify
             ...
             *   These are the same units that you chose to set the target capacity in terms of
             ...
             * the number of instances to the next whole number. If this value is not specified, the
             * default is 1.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            /** @param iamInstanceProfile The IAM instance profile. */
            override fun iamInstanceProfile(
                iamInstanceProfile: IamInstanceProfileSpecificationProperty
            ) {
                cdkBuilder.iamInstanceProfile(
                    iamInstanceProfile.let(IamInstanceProfileSpecificationProperty::unwrap)
                )
            }
            ...
            override fun iamInstanceProfile(
                ...
                iamInstanceProfile(IamInstanceProfileSpecificationProperty(iamInstanceProfile))
            ...
            override fun instanceRequirements(
                ...
                cdkBuilder.instanceRequirements(
                    instanceRequirements.let(InstanceRequirementsRequestProperty::unwrap)
                )
            }
            ...
            override fun instanceRequirements(
                ...
                instanceRequirements(InstanceRequirementsRequestProperty(instanceRequirements))
            ...
            override fun monitoring(
                monitoring: SpotFleetMonitoringProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * One or more block devices that are mapped to the Spot Instances.
             *
             * You can't specify both a snapshot ID and an encryption value. This is because only
             * blank volumes can be encrypted on creation. If a snapshot is the basis for a volume,
             ...
             * One or more network interfaces.
             *
             * If you specify a network interface, you must specify subnet IDs and security group
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SpotFleetLaunchSpecificationProperty
            ): software.amazon.awscdk.services.ec2.CfnSpotFleet.SpotFleetLaunchSpecificationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface AcceleratorTotalMemoryMiBRequestProperty {
        ...
        public interface Builder {
            /**
             * @param max The maximum amount of accelerator memory, in MiB. To specify no maximum
             *   limit, omit this parameter.
             */
            public fun max(max: Number)

            /**
             * @param min The minimum amount of accelerator memory, in MiB. To specify no minimum
             *   limit, omit this parameter.
             */
            public fun min(min: Number)
        }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AcceleratorTotalMemoryMiBRequestProperty
            ): software.amazon.awscdk.services.ec2.CfnSpotFleet.AcceleratorTotalMemoryMiBRequestProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface NetworkInterfaceCountRequestProperty {
        ...
        public interface Builder {
            /**
             * @param max The maximum number of network interfaces. To specify no maximum limit,
             *   omit this parameter.
             */
            public fun max(max: Number)

            /**
             * @param min The minimum number of network interfaces. To specify no minimum limit,
             *   omit this parameter.
             */
            public fun min(min: Number)
        }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: NetworkInterfaceCountRequestProperty
            ): software.amazon.awscdk.services.ec2.CfnSpotFleet.NetworkInterfaceCountRequestProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface MemoryMiBRequestProperty {
        ...
        public interface Builder {
            /**
             * @param max The maximum amount of memory, in MiB. To specify no maximum limit, omit
             *   this parameter.
             */
            public fun max(max: Number)

            /**
             * @param min The minimum amount of memory, in MiB. To specify no minimum limit, specify
             *   `0` .
             */
            public fun min(min: Number)
        }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: MemoryMiBRequestProperty
            ): software.amazon.awscdk.services.ec2.CfnSpotFleet.MemoryMiBRequestProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface LaunchTemplateOverridesProperty {
         ...
         * provided requirements, and then use your On-Demand and Spot allocation strategies to
         * launch instances from these instance types, in the same way as when you specify a list of
         * instance types.
         *
         * If you specify `InstanceRequirements` , you can't specify `InstanceType` .
         *
         ...
         * uses priority on a best-effort basis to determine which launch template override to use
         ...
         * priority. If no number is set, the launch template override has the lowest priority. You
        ...
        public interface Builder {
            ...
            /**
             * @param instanceRequirements The instance requirements. When you specify instance
             *   requirements, Amazon EC2 will identify instance types with the provided
             *   requirements, and then use your On-Demand and Spot allocation strategies to launch
             *   instances from these instance types, in the same way as when you specify a list of
             *   instance types.
             *
             * If you specify `InstanceRequirements` , you can't specify `InstanceType` .
             */
            ...
            /**
             * @param priority The priority for the launch template override. The highest priority
             *   is launched first. If `OnDemandAllocationStrategy` is set to `prioritized` , Spot
        ...
        internal constructor(
             ...
             * The instance requirements.
             *
             * When you specify instance requirements, Amazon EC2 will identify instance types with
             * the provided requirements, and then use your On-Demand and Spot allocation strategies
             * to launch instances from these instance types, in the same way as when you specify a
             ...
             *
             * If `OnDemandAllocationStrategy` is set to `prioritized` , Spot Fleet uses priority to
             * determine which launch template override to use first in fulfilling On-Demand
             * capacity.
             *
             * If the Spot `AllocationStrategy` is set to `capacityOptimizedPrioritized` , Spot
             * Fleet uses priority on a best-effort basis to determine which launch template
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: LaunchTemplateOverridesProperty
            ): software.amazon.awscdk.services.ec2.CfnSpotFleet.LaunchTemplateOverridesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface InstanceNetworkInterfaceSpecificationProperty {
         ...
         * be assigned to a new network interface, not an existing one. You cannot specify more than
         ...
         *
         * Amazon EC2 chooses the IPv6 addresses from the range of the subnet. You cannot specify
         ...
         * private IP addresses option. You cannot specify this option if you're launching more than
         * one instance in a
         * [RunInstances](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_RunInstances.html)
         * request.
         *
        ...
        public interface Builder {
            /**
             * @param associatePublicIpAddress Indicates whether to assign a public IPv4 address to
             *   an instance you launch in a VPC. The public IP address can only be assigned to a
             *   network interface for eth0, and can only be assigned to a new network interface,
             *   not an existing one. You cannot specify more than one network interface in the
            ...
            /**
             * @param deleteOnTermination Indicates whether the network interface is deleted when
            ...
            /**
             * @param description The description of the network interface. Applies only if creating
             *   a network interface when launching an instance.
             */
            public fun description(description: String)

            /**
             * @param deviceIndex The position of the network interface in the attachment order. A
            ...
            /**
             * @param ipv6AddressCount A number of IPv6 addresses to assign to the network
             *   interface. Amazon EC2 chooses the IPv6 addresses from the range of the subnet. You
             *   cannot specify this option and the option to assign specific IPv6 addresses in the
             *   same request. You can specify this option if you've specified a minimum number of
             *   instances to launch.
             */
            public fun ipv6AddressCount(ipv6AddressCount: Number)

            /**
             * @param ipv6Addresses The IPv6 addresses to assign to the network interface. You
             *   cannot specify this option and the option to assign a number of IPv6 addresses in
            ...
            /**
             * @param networkInterfaceId The ID of the network interface. If you are creating a Spot
             *   Fleet, omit this parameter because you can’t specify a network interface ID in a
             *   launch specification.
             */
            public fun networkInterfaceId(networkInterfaceId: String)

            /**
             * @param privateIpAddresses The private IPv4 addresses to assign to the network
             *   interface. Only one private IPv4 address can be designated as primary. You cannot
             ...
             *   the private IP addresses option. You cannot specify this option if you're launching
            ...
            /**
             * @param subnetId The ID of the subnet associated with the network interface. Applies
        ...
        private class BuilderImpl : Builder {
            ...
            override fun associatePublicIpAddress(associatePublicIpAddress: IResolvable) {
                cdkBuilder.associatePublicIpAddress(
                    associatePublicIpAddress.let(IResolvable::unwrap)
                )
            }
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ec2-spotfleet-instancenetworkinterfacespecification.html#cfn-ec2-spotfleet-instancenetworkinterfacespecification-associatepublicipaddress)
             */
            override fun associatePublicIpAddress(): Any? =
             ...
             * the same request. You cannot specify this option if you've specified a minimum number
             ...
             *
             * You can't specify this option and specify more than one private IP address using the
             * private IP addresses option. You cannot specify this option if you're launching more
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: InstanceNetworkInterfaceSpecificationProperty
            ): software.amazon.awscdk.services.ec2.CfnSpotFleet.InstanceNetworkInterfaceSpecificationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SpotFleetRequestConfigDataProperty {
         ...
         *   highest capacity availability for the number of instances that are launching. This
         *   means that we will request Spot Instances from the pools that we believe have the
         *   lowest chance of interruption in the near term. Spot Fleet then requests Spot Instances
         *   from the lowest priced of these pools.
         * * **capacityOptimized** - Spot Fleet identifies the pools with the highest capacity
         *   availability for the number of instances that are launching. This means that we will
         *   request Spot Instances from the pools that we believe have the lowest chance of
         *   interruption in the near term. To give certain instance types a higher chance of
         *   launching first, use `capacityOptimizedPrioritized` . Set a priority for each instance
         ...
         *   pool that has available capacity. If the lowest priced pool doesn't have available
         *   capacity, the Spot Instances come from the next lowest priced pool that has available
         *   capacity. If a pool runs out of capacity before fulfilling your desired capacity, Spot
         *   Fleet will continue to fulfill your request by drawing from the next lowest priced
         *   pool. To ensure that your desired capacity is met, you might receive Spot Instances
         *   from several pools. Because this strategy only considers instance price and not
         ...
         * Instances on your behalf when you cancel its Spot Fleet request or when the Spot Fleet
         * request expires, if you set `TerminateInstancesWithExpiration` .
         *
         ...
         *
         * Valid only when Spot *AllocationStrategy* is set to `lowest-price` . Spot Fleet selects
         * the cheapest Spot pools and evenly allocates your target Spot capacity across the number
         * of Spot pools that you specify.
         *
         * Note that Spot Fleet attempts to draw Spot Instances from the number of pools that you
         * specify on a best effort basis. If a pool runs out of Spot capacity before fulfilling
         * your target capacity, Spot Fleet will continue to fulfill your request by drawing from
         * the next cheapest pool. To ensure that your target capacity is met, you might receive
         * Spot Instances from more than the number of pools that you specified. Similarly, if most
         * of the pools have no Spot capacity, you might receive your full target capacity from
         ...
         * the lowest price first. If you specify `prioritized` , Spot Fleet uses the priority that
         * you assign to each Spot Fleet launch template override, launching the highest priority
         ...
         */
        public fun onDemandAllocationStrategy(): String? =
         ...
         * credits. The `onDemandMaxTotalPrice` does not account for surplus credits, and, if you
         * use surplus credits, your final cost might be higher than what you specified for
         * `onDemandMaxTotalPrice` . For more information, see
         ...
         * characteristic that is important to your application workload, such as vCPUs, memory, or
         * I/O. If the request type is `maintain` , you can specify a target capacity of 0 and add
         * capacity later.
         *
         ...
         * If your fleet includes T instances that are configured as `unlimited` , and if their
         * average CPU usage exceeds the baseline utilization, you will incur a charge for surplus
         * credits. The `spotMaxTotalPrice` does not account for surplus credits, and, if you use
         * surplus credits, your final cost might be higher than what you specified for
         * `spotMaxTotalPrice` . For more information, see
         * [Surplus credits can incur charges](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/burstable-performance-instances-unlimited-mode-concepts.html#unlimited-mode-surplus-credits)
         * in the *EC2 User Guide* .
         *
         ...
         * maintain it. When this value is `request` , the Spot Fleet only places the required
         * requests. It does not attempt to replenish Spot Instances if capacity is diminished, nor
         * does it submit requests in alternative Spot pools if capacity is not available. When this
         * value is `maintain` , the Spot Fleet maintains the target capacity. The Spot Fleet places
         * the required requests to meet capacity and automatically replenishes any interrupted
         * instances. Default: `maintain` . `instant` is listed but is not used by Spot Fleet.
         *
        ...
        public interface Builder {
            /**
             * @param allocationStrategy The strategy that determines how to allocate the target
             *   Spot Instance capacity across the Spot Instance pools specified by the Spot Fleet
             ...
             *   highest capacity availability for the number of instances that are launching. This
             *   means that we will request Spot Instances from the pools that we believe have the
             *   lowest chance of interruption in the near term. Spot Fleet then requests Spot
             ...
             *   will request Spot Instances from the pools that we believe have the lowest chance
             *   of interruption in the near term. To give certain instance types a higher chance of
             ...
             *   `capacityOptimizedPrioritized` is supported only if your Spot Fleet uses a launch
             *   template. Note that if the `OnDemandAllocationStrategy` is set to `prioritized` ,
             *   the same priority is applied when fulfilling On-Demand capacity.
             * * **diversified** - Spot Fleet requests instances from all of the Spot Instance pools
             *   that you specify.
             * * **lowestPrice** - Spot Fleet requests instances from the lowest priced Spot
             *   Instance pool that has available capacity. If the lowest priced pool doesn't have
             *   available capacity, the Spot Instances come from the next lowest priced pool that
             *   has available capacity. If a pool runs out of capacity before fulfilling your
             *   desired capacity, Spot Fleet will continue to fulfill your request by drawing from
             *   the next lowest priced pool. To ensure that your desired capacity is met, you might
            ...
            /**
             * @param excessCapacityTerminationPolicy Indicates whether running Spot Instances
             *   should be terminated if you decrease the target capacity of the Spot Fleet request
             *   below the current size of the Spot Fleet. Supported only for fleets of type
             *   `maintain` .
             */
            public fun excessCapacityTerminationPolicy(excessCapacityTerminationPolicy: String)

            /**
             * @param iamFleetRole The Amazon Resource Name (ARN) of an AWS Identity and Access
             *   Management (IAM) role that grants the Spot Fleet the permission to request, launch,
             *   terminate, and tag instances on your behalf. For more information, see
             *   [Spot Fleet Prerequisites](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/spot-fleet-requests.html#spot-fleet-prerequisites)
             *   in the *Amazon EC2 User Guide for Linux Instances* . Spot Fleet can terminate Spot
             *   Instances on your behalf when you cancel its Spot Fleet request or when the Spot
             ...
             *   target Spot capacity. Valid only when Spot *AllocationStrategy* is set to
             *   `lowest-price` . Spot Fleet selects the cheapest Spot pools and evenly allocates
             ...
             * you specify on a best effort basis. If a pool runs out of Spot capacity before
             * fulfilling your target capacity, Spot Fleet will continue to fulfill your request by
             * drawing from the next cheapest pool. To ensure that your target capacity is met, you
             * might receive Spot Instances from more than the number of pools that you specified.
             * Similarly, if most of the pools have no Spot capacity, you might receive your full
            ...
            /**
             * @param launchSpecifications The launch specifications for the Spot Fleet request. If
             *   you specify `LaunchSpecifications` , you can't specify `LaunchTemplateConfigs` .
             */
            ...
            /**
             * @param launchTemplateConfigs The launch template and overrides. If you specify
            ...
            /**
             * @param loadBalancersConfig One or more Classic Load Balancers and target groups to
             *   attach to the Spot Fleet request. Spot Fleet registers the running Spot Instances
            ...
            public fun loadBalancersConfig(
                loadBalancersConfig: LoadBalancersConfigProperty.Builder.() -> Unit
            )

            /**
             * @param onDemandAllocationStrategy The order of the launch template overrides to use
             *   in fulfilling On-Demand capacity. If you specify `lowestPrice` , Spot Fleet uses
             *   price to determine the order, launching the lowest price first. If you specify
             *   `prioritized` , Spot Fleet uses the priority that you assign to each Spot Fleet
             ...
             *   you're willing to pay. You can use the `onDemandMaxTotalPrice` parameter, the
             *   `spotMaxTotalPrice` parameter, or both parameters to ensure that your fleet cost
             *   does not exceed your budget. If you set a maximum price per hour for the On-Demand
             *   Instances and Spot Instances in your request, Spot Fleet will launch instances
             *   until it reaches the maximum amount you're willing to pay. When the maximum amount
             *   you're willing to pay is reached, the fleet stops launching instances even if it
             *   hasn’t met the target capacity.
             *
             * If your fleet includes T instances that are configured as `unlimited` , and if their
             * average CPU usage exceeds the baseline utilization, you will incur a charge for
             * surplus credits. The `onDemandMaxTotalPrice` does not account for surplus credits,
             * and, if you use surplus credits, your final cost might be higher than what you
             * specified for `onDemandMaxTotalPrice` . For more information, see
             * [Surplus credits can incur charges](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/burstable-performance-instances-unlimited-mode-concepts.html#unlimited-mode-surplus-credits)
             * in the *EC2 User Guide* .
             */
            ...
            /**
             * @param onDemandTargetCapacity The number of On-Demand units to request. You can
             *   choose to set the target capacity in terms of instances or a performance
            ...
            /**
             * @param replaceUnhealthyInstances Indicates whether Spot Fleet should replace
             *   unhealthy instances.
             */
            ...
            /**
             * @param spotMaintenanceStrategies The strategies for managing your Spot Instances that
             *   are at an elevated risk of being interrupted.
             */
             ...
             *   are at an elevated risk of being interrupted.
             */
            public fun spotMaintenanceStrategies(
            ...
            public fun spotMaintenanceStrategies(
                spotMaintenanceStrategies: SpotMaintenanceStrategiesProperty.Builder.() -> Unit
            )

            /**
             * @param spotMaxTotalPrice The maximum amount per hour for Spot Instances that you're
             *   willing to pay. You can use the `spotMaxTotalPrice` parameter, the
             *   `onDemandMaxTotalPrice` parameter, or both parameters to ensure that your fleet
             *   cost does not exceed your budget. If you set a maximum price per hour for the
             *   On-Demand Instances and Spot Instances in your request, Spot Fleet will launch
             *   instances until it reaches the maximum amount you're willing to pay. When the
             *   maximum amount you're willing to pay is reached, the fleet stops launching
             *   instances even if it hasn’t met the target capacity.
             *
             * If your fleet includes T instances that are configured as `unlimited` , and if their
             * average CPU usage exceeds the baseline utilization, you will incur a charge for
             * surplus credits. The `spotMaxTotalPrice` does not account for surplus credits, and,
             * if you use surplus credits, your final cost might be higher than what you specified
             * for `spotMaxTotalPrice` . For more information, see
             * [Surplus credits can incur charges](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/burstable-performance-instances-unlimited-mode-concepts.html#unlimited-mode-surplus-credits)
             * in the *EC2 User Guide* .
             */
            ...
            /**
             * @param tagSpecifications The key-value pair for tagging the Spot Fleet request on
             *   creation. The value for `ResourceType` must be `spot-fleet-request` , otherwise the
             *   Spot Fleet request fails. To tag instances at launch, specify the tags in the
             *   [launch template](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-launch-templates.html#create-launch-template)
             *   (valid only if you use `LaunchTemplateConfigs` ) or in the
             *   `[SpotFleetTagSpecification](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_SpotFleetTagSpecification.html)`
            ...
            /**
             * @param targetCapacity The number of units to request for the Spot Fleet. You can
             *   choose to set the target capacity in terms of instances or a performance
             *   characteristic that is important to your application workload, such as vCPUs,
             *   memory, or I/O. If the request type is `maintain` , you can specify a target
             *   capacity of 0 and add capacity later.
             ...
             *   parameter only when using attribute-based instance type selection. Default: `units`
             ...
             *   terminated when the Spot Fleet request expires.
             */
            public fun terminateInstancesWithExpiration(
                terminateInstancesWithExpiration: IResolvable
            )

            /**
             * @param type The type of request. Indicates whether the Spot Fleet only requests the
             *   target capacity or also attempts to maintain it. When this value is `request` , the
             ...
             *   Fleet maintains the target capacity. The Spot Fleet places the required requests to
             *   meet capacity and automatically replenishes any interrupted instances. Default:
             *   `maintain` . `instant` is listed but is not used by Spot Fleet.
             */
            public fun type(type: String)

            /**
             * @param validFrom The start date and time of the request, in UTC format ( *YYYY* -
             *   *MM* - *DD* T *HH* : *MM* : *SS* Z). By default, Amazon EC2 starts fulfilling the
             *   request immediately.
             */
            public fun validFrom(validFrom: String)

            /**
             * @param validUntil The end date and time of the request, in UTC format ( *YYYY* -
             *   *MM* - *DD* T *HH* : *MM* : *SS* Z). After the end date and time, no new Spot
             *   Instance requests are placed or able to fulfill the request. If no value is
        ...
        private class BuilderImpl : Builder {
            ...
            override fun loadBalancersConfig(loadBalancersConfig: LoadBalancersConfigProperty) {
                cdkBuilder.loadBalancersConfig(
                    loadBalancersConfig.let(LoadBalancersConfigProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("3c60fe2dcead1983474af251b47bba970d17e23f115fda5d9d90a420e3001af9")
            override fun loadBalancersConfig(
                loadBalancersConfig: LoadBalancersConfigProperty.Builder.() -> Unit
            ...
            override fun replaceUnhealthyInstances(replaceUnhealthyInstances: IResolvable) {
                cdkBuilder.replaceUnhealthyInstances(
                    replaceUnhealthyInstances.let(IResolvable::unwrap)
                )
            }
            ...
            override fun spotMaintenanceStrategies(spotMaintenanceStrategies: IResolvable) {
                cdkBuilder.spotMaintenanceStrategies(
                    spotMaintenanceStrategies.let(IResolvable::unwrap)
                )
            }
             ...
             *   are at an elevated risk of being interrupted.
             */
            override fun spotMaintenanceStrategies(
                spotMaintenanceStrategies: SpotMaintenanceStrategiesProperty
            ) {
                cdkBuilder.spotMaintenanceStrategies(
                    spotMaintenanceStrategies.let(SpotMaintenanceStrategiesProperty::unwrap)
                )
            }
            ...
            override fun spotMaintenanceStrategies(
                ...
                spotMaintenanceStrategies(
                    SpotMaintenanceStrategiesProperty(spotMaintenanceStrategies)
                )
             ...
             *   terminated when the Spot Fleet request expires.
             */
            override fun terminateInstancesWithExpiration(
            ...
            override fun terminateInstancesWithExpiration(
                ...
                cdkBuilder.terminateInstancesWithExpiration(
                    terminateInstancesWithExpiration.let(IResolvable::unwrap)
                )
            }
        ...
        internal constructor(
             ...
             * the Spot Instance pools specified by the Spot Fleet launch configuration.
             *
             * For more information, see
             * [Allocation strategies for Spot Instances](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/spot-fleet-allocation-strategy.html)
             * in the *Amazon EC2 User Guide* .
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ec2-spotfleet-spotfleetrequestconfigdata.html#cfn-ec2-spotfleet-spotfleetrequestconfigdata-instancepoolstousecount)
             */
            override fun instancePoolsToUseCount(): Number? =
             ...
             * request.
             *
             * Spot Fleet registers the running Spot Instances with the specified Classic Load
             ...
             * priority that you assign to each Spot Fleet launch template override, launching the
             * highest priority first. If you do not specify a value, Spot Fleet defaults to
             * `lowestPrice` .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ec2-spotfleet-spotfleetrequestconfigdata.html#cfn-ec2-spotfleet-spotfleetrequestconfigdata-ondemandallocationstrategy)
             */
             ...
             * The maximum amount per hour for On-Demand Instances that you're willing to pay.
             *
             * You can use the `onDemandMaxTotalPrice` parameter, the `spotMaxTotalPrice` parameter,
             * or both parameters to ensure that your fleet cost does not exceed your budget. If you
             * set a maximum price per hour for the On-Demand Instances and Spot Instances in your
             ...
             *
             * You can choose to set the target capacity in terms of instances or a performance
             * characteristic that is important to your application workload, such as vCPUs, memory,
             * or I/O. If the request type is `maintain` , you can specify a target capacity of 0
             * and add capacity later.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ec2-spotfleet-spotfleetrequestconfigdata.html#cfn-ec2-spotfleet-spotfleetrequestconfigdata-ondemandtargetcapacity)
             */
            override fun onDemandTargetCapacity(): Number? =
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ec2-spotfleet-spotfleetrequestconfigdata.html#cfn-ec2-spotfleet-spotfleetrequestconfigdata-replaceunhealthyinstances)
             */
            override fun replaceUnhealthyInstances(): Any? =
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ec2-spotfleet-spotfleetrequestconfigdata.html#cfn-ec2-spotfleet-spotfleetrequestconfigdata-spotmaintenancestrategies)
             */
            override fun spotMaintenanceStrategies(): Any? =
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ec2-spotfleet-spotfleetrequestconfigdata.html#cfn-ec2-spotfleet-spotfleetrequestconfigdata-targetcapacityunittype)
             */
            override fun targetCapacityUnitType(): String? =
             ...
             * The type of request.
             *
             * Indicates whether the Spot Fleet only requests the target capacity or also attempts
             * to maintain it. When this value is `request` , the Spot Fleet only places the
             * required requests. It does not attempt to replenish Spot Instances if capacity is
             * diminished, nor does it submit requests in alternative Spot pools if capacity is not
             * available. When this value is `maintain` , the Spot Fleet maintains the target
             ...
             * fulfill the request. If no value is specified, the Spot Fleet request remains until
             * you cancel it.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ec2-spotfleet-spotfleetrequestconfigdata.html#cfn-ec2-spotfleet-spotfleetrequestconfigdata-validuntil)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SpotFleetRequestConfigDataProperty
            ): software.amazon.awscdk.services.ec2.CfnSpotFleet.SpotFleetRequestConfigDataProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SpotPlacementProperty {
        ...
        public interface Builder {
            /**
             * @param availabilityZone The Availability Zone. To specify multiple Availability
             ...
             *   instance with a tenancy of `dedicated` runs on single-tenant hardware. The `host`
             *   tenancy is not supported for Spot Instances.
             */
    ...
    public interface FleetLaunchTemplateSpecificationProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param version The version number of the launch template. Specifying `$Latest` or
             *   `$Default` for the template version number is not supported. However, you can
             *   specify `LatestVersionNumber` or `DefaultVersionNumber` using the `Fn::GetAtt`
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: FleetLaunchTemplateSpecificationProperty
            ): software.amazon.awscdk.services.ec2.CfnSpotFleet.FleetLaunchTemplateSpecificationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface TargetGroupsConfigProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TargetGroupsConfigProperty
            ): software.amazon.awscdk.services.ec2.CfnSpotFleet.TargetGroupsConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface BaselineEbsBandwidthMbpsRequestProperty {
        ...
        public interface Builder {
            /**
             * @param max The maximum baseline bandwidth, in Mbps. To specify no maximum limit, omit
             *   this parameter.
             */
            public fun max(max: Number)

            /**
             * @param min The minimum baseline bandwidth, in Mbps. To specify no minimum limit, omit
             *   this parameter.
             */
            public fun min(min: Number)
        }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: BaselineEbsBandwidthMbpsRequestProperty
            ): software.amazon.awscdk.services.ec2.CfnSpotFleet.BaselineEbsBandwidthMbpsRequestProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface InstanceIpv6AddressProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: InstanceIpv6AddressProperty
            ): software.amazon.awscdk.services.ec2.CfnSpotFleet.InstanceIpv6AddressProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface IamInstanceProfileSpecificationProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: IamInstanceProfileSpecificationProperty
            ): software.amazon.awscdk.services.ec2.CfnSpotFleet.IamInstanceProfileSpecificationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface LoadBalancersConfigProperty {
        ...
        public interface Builder {
            ...
            /** @param classicLoadBalancersConfig The Classic Load Balancers. */
            public fun classicLoadBalancersConfig(
            ...
            public fun classicLoadBalancersConfig(
                classicLoadBalancersConfig: ClassicLoadBalancersConfigProperty.Builder.() -> Unit
            )
            ...
            public fun targetGroupsConfig(
                targetGroupsConfig: TargetGroupsConfigProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun classicLoadBalancersConfig(classicLoadBalancersConfig: IResolvable) {
                cdkBuilder.classicLoadBalancersConfig(
                    classicLoadBalancersConfig.let(IResolvable::unwrap)
                )
            }

            /** @param classicLoadBalancersConfig The Classic Load Balancers. */
            override fun classicLoadBalancersConfig(
                classicLoadBalancersConfig: ClassicLoadBalancersConfigProperty
            ) {
                cdkBuilder.classicLoadBalancersConfig(
                    classicLoadBalancersConfig.let(ClassicLoadBalancersConfigProperty::unwrap)
                )
            }
            ...
            override fun classicLoadBalancersConfig(
                ...
                classicLoadBalancersConfig(
                    ClassicLoadBalancersConfigProperty(classicLoadBalancersConfig)
                )
            ...
            override fun targetGroupsConfig(targetGroupsConfig: TargetGroupsConfigProperty) {
                cdkBuilder.targetGroupsConfig(
                    targetGroupsConfig.let(TargetGroupsConfigProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("8017e6e27f4e464d54ac3f8fdb795873361e4735def7ddb9ba1e753fc1e521c9")
            override fun targetGroupsConfig(
                targetGroupsConfig: TargetGroupsConfigProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ec2-spotfleet-loadbalancersconfig.html#cfn-ec2-spotfleet-loadbalancersconfig-classicloadbalancersconfig)
             */
            override fun classicLoadBalancersConfig(): Any? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: LoadBalancersConfigProperty
            ): software.amazon.awscdk.services.ec2.CfnSpotFleet.LoadBalancersConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface NetworkBandwidthGbpsRequestProperty {
        ...
        public interface Builder {
            /**
             * @param max The maximum amount of network bandwidth, in Gbps. To specify no maximum
             *   limit, omit this parameter.
             */
            public fun max(max: Number)

            /**
             * @param min The minimum amount of network bandwidth, in Gbps. To specify no minimum
             *   limit, omit this parameter.
             */
            public fun min(min: Number)
        }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: NetworkBandwidthGbpsRequestProperty
            ): software.amazon.awscdk.services.ec2.CfnSpotFleet.NetworkBandwidthGbpsRequestProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ClassicLoadBalancersConfigProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ClassicLoadBalancersConfigProperty
            ): software.amazon.awscdk.services.ec2.CfnSpotFleet.ClassicLoadBalancersConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface TotalLocalStorageGBRequestProperty {
        ...
        public interface Builder {
            /**
             * @param max The maximum amount of total local storage, in GB. To specify no maximum
             *   limit, omit this parameter.
             */
            public fun max(max: Number)

            /**
             * @param min The minimum amount of total local storage, in GB. To specify no minimum
             *   limit, omit this parameter.
             */
            public fun min(min: Number)
        }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TotalLocalStorageGBRequestProperty
            ): software.amazon.awscdk.services.ec2.CfnSpotFleet.TotalLocalStorageGBRequestProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SpotMaintenanceStrategiesProperty {
        ...
        public interface Builder {
            /**
             * @param capacityRebalance The Spot Instance replacement strategy to use when Amazon
             *   EC2 emits a signal that your Spot Instance is at an elevated risk of being
            ...
            public fun capacityRebalance(
                capacityRebalance: SpotCapacityRebalanceProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun capacityRebalance(capacityRebalance: SpotCapacityRebalanceProperty) {
                cdkBuilder.capacityRebalance(
                    capacityRebalance.let(SpotCapacityRebalanceProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("2573a18d019a336fa9f65454022b27033103109b979f9370b6b039c2e26ba7e3")
            override fun capacityRebalance(
                capacityRebalance: SpotCapacityRebalanceProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * your Spot Instance is at an elevated risk of being interrupted.
             *
             * For more information, see
             * [Capacity rebalancing](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/spot-fleet-capacity-rebalance.html)
             * in the *Amazon EC2 User Guide for Linux Instances* .
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SpotMaintenanceStrategiesProperty
            ): software.amazon.awscdk.services.ec2.CfnSpotFleet.SpotMaintenanceStrategiesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
