...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param lifecycleTransition The lifecycle transition. For Auto Scaling groups, there are
         ...
         *
         * @param notificationTargetArn The Amazon Resource Name (ARN) of the notification target
         *   that Amazon EC2 Auto Scaling sends notifications to when an instance is in a wait state
