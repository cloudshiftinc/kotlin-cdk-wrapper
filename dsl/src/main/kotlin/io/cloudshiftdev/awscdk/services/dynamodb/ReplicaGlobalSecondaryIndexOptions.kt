...
public interface ReplicaGlobalSecondaryIndexOptions {
    ...
    public interface Builder {
        /**
         * @param contributorInsights Whether CloudWatch contributor insights is enabled for a
         *   specific global secondary index on a replica table.
         */
    ...
    internal constructor(
        ...
        /**
         * Whether CloudWatch contributor insights is enabled for a specific global secondary index
         * on a replica table.
         *
         * Default: - inherited from the primary table
         */
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: ReplicaGlobalSecondaryIndexOptions
        ): software.amazon.awscdk.services.dynamodb.ReplicaGlobalSecondaryIndexOptions =
