...
internal constructor(
    ...
    public override fun addClient(id: String, options: UserPoolClientOptions): UserPoolClient =
        unwrap(this)
            .addClient(id, options.let(UserPoolClientOptions::unwrap))
            .let(UserPoolClient::wrap)
    ...
    public override fun addClient(
        id: String,
        options: UserPoolClientOptions.Builder.() -> Unit
    ...
    public override fun addDomain(id: String, options: UserPoolDomainOptions): UserPoolDomain =
        unwrap(this)
            .addDomain(id, options.let(UserPoolDomainOptions::unwrap))
            .let(UserPoolDomain::wrap)
    ...
    public override fun addDomain(
        id: String,
        options: UserPoolDomainOptions.Builder.() -> Unit
     ...
     * @param options
     */
    public override fun addResourceServer(
        id: String,
        options: UserPoolResourceServerOptions
    ): UserPoolResourceServer =
        unwrap(this)
            .addResourceServer(id, options.let(UserPoolResourceServerOptions::unwrap))
            .let(UserPoolResourceServer::wrap)
    ...
    public override fun addResourceServer(
        id: String,
        options: UserPoolResourceServerOptions.Builder.() -> Unit
    ): UserPoolResourceServer = addResourceServer(id, UserPoolResourceServerOptions(options))
    ...
    public open fun addTrigger(
        ...
        unwrap(this)
            .addTrigger(
                operation.let(UserPoolOperation::unwrap),
    ...
    public interface Builder {
         ...
         *
         * @param autoVerify Attributes which Cognito will look to verify automatically upon user
         *   sign up.
         */
         ...
         *
         * When left unspecified, CDK will determine based on other properties if a role is needed
         * or not.
         *
         ...
         *
         * @param keepOriginal Attributes which Cognito will look to handle changes to the value of
         *   your users' email address and phone number attributes.
         */
         ...
         * Default: Mfa.OFF
         *
         * @param mfa Configure whether users of this user pool can or are required use MFA to sign
         *   in.
         */
         ...
         *
         * To match with 'Option 1' in the above link, with a verified email, this property should
         * be set to `{ username: true, email: true }`. To match with 'Option 2' in the above link
         * with both a verified email and phone number, this property should be set to `{ email:
         * true, phone: true }`.
         *
         ...
         * Default: true
         *
         * @param signInCaseSensitive Whether sign-in aliases should be evaluated with case
         *   sensitivity.
         */
        ...
        /**
         * The 'ExternalId' that Cognito service must be using when assuming the `smsRole`, if the
         * role is restricted with an 'sts:ExternalId' conditional.
         *
         ...
         *
         * @param smsRoleExternalId The 'ExternalId' that Cognito service must be using when
         *   assuming the `smsRole`, if the role is restricted with an 'sts:ExternalId' conditional.
         */
         ...
         *
         * @param standardAttributes The set of attributes that are required for every user in the
         *   user pool.
         */
         ...
         *
         * @param userVerification Configuration around users signing themselves up to the user
         *   pool.
         */
    ...
    private class BuilderImpl(
        ...
        override fun customAttributes(customAttributes: Map<String, ICustomAttribute>) {
            cdkBuilder.customAttributes(
                customAttributes.mapValues { ICustomAttribute.unwrap(it.value) }
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("8096998feb3fe3aa70fee05d564bd96732eb2f7a77729561ccb46044210058ea")
        override fun standardAttributes(
            standardAttributes: StandardAttributes.Builder.() -> Unit
        ): Unit = standardAttributes(StandardAttributes(standardAttributes))
        ...
        override fun userVerification(
            userVerification: UserVerificationConfig.Builder.() -> Unit
        ): Unit = userVerification(UserVerificationConfig(userVerification))
    ...
    public companion object {
        public fun fromUserPoolArn(
            ...
            software.amazon.awscdk.services.cognito.UserPool.fromUserPoolArn(
        ...
        public fun fromUserPoolId(
            ...
            software.amazon.awscdk.services.cognito.UserPool.fromUserPoolId(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    userPoolId
                )
