...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.gamelift.CfnGameSessionQueue,
    ...
    public open fun filterConfiguration(
        `value`: FilterConfigurationProperty.Builder.() -> Unit
    ): Unit = filterConfiguration(FilterConfigurationProperty(`value`))
    ...
    public open fun priorityConfiguration(
        `value`: PriorityConfigurationProperty.Builder.() -> Unit
    ...
    public interface Builder {
         ...
         *
         * @param customEventData Information to be added to all events that are related to this
         *   game session queue.
         */
         ...
         *
         * @param destinations A list of fleets and/or fleet aliases that can be used to fulfill
         *   game session placement requests in the queue.
         */
         ...
         *
         * @param notificationTarget An SNS topic ARN that is set up to receive game session
         ...
         * ensure that no individual player can be placed into a game with unreasonably high
         ...
         *
         * @param playerLatencyPolicies A set of policies that act as a sliding cap on player
         *   latency.
         */
         ...
         * placements.
         *
         * This configuration replaces the FleetIQ default prioritization process. Priority types
         * that are not explicitly named will be automatically applied at the end of the
        ...
        public fun priorityConfiguration(
            priorityConfiguration: PriorityConfigurationProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
        ...
        override fun priorityConfiguration(priorityConfiguration: PriorityConfigurationProperty) {
            cdkBuilder.priorityConfiguration(
                priorityConfiguration.let(PriorityConfigurationProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("c59baed8336d52c5e8b8ad2a6ba6539415b0e2244a21170289c872eadd1474fd")
        override fun priorityConfiguration(
            priorityConfiguration: PriorityConfigurationProperty.Builder.() -> Unit
    ...
    public interface PriorityConfigurationProperty {
         ...
         * * `LATENCY` -- FleetIQ prioritizes locations where the average player latency (provided
         *   in each game session request) is lowest.
         * * `COST` -- FleetIQ prioritizes destinations with the lowest current hosting costs. Cost
         *   is evaluated based on the location, instance type, and fleet type (Spot or On-Demand)
         *   for each destination in the queue.
         * * `DESTINATION` -- FleetIQ prioritizes based on the order that destinations are listed in
         *   the queue configuration.
         * * `LOCATION` -- FleetIQ prioritizes based on the provided order of locations, as defined
         *   in `LocationOrder` .
         *
        ...
        public interface Builder {
             ...
             *   `PriorityOrder` property includes `LOCATION` . Locations are identified by AWS
            ...
            /**
             * @param priorityOrder The recommended sequence to use when prioritizing where to place
             ...
             *   Cost is evaluated based on the location, instance type, and fleet type (Spot or
        ...
        internal constructor(
             ...
             *
             * Locations are identified by AWS Region codes such as `us-west-2` . Each location can
             * only be listed once.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-gamelift-gamesessionqueue-priorityconfiguration.html#cfn-gamelift-gamesessionqueue-priorityconfiguration-locationorder)
             */
            override fun locationOrder(): List<String> =
                unwrap(this).getLocationOrder() ?: emptyList()
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-gamelift-gamesessionqueue-priorityconfiguration.html#cfn-gamelift-gamesessionqueue-priorityconfiguration-priorityorder)
             */
            override fun priorityOrder(): List<String> =
                unwrap(this).getPriorityOrder() ?: emptyList()
        }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: PriorityConfigurationProperty
            ): software.amazon.awscdk.services.gamelift.CfnGameSessionQueue.PriorityConfigurationProperty =
    ...
    public interface PlayerLatencyPolicyProperty {
         ...
         * session.
         *
         * A null value for this property means that the policy is enforced until the queue times
         * out.
         *
        ...
        public interface Builder {
            /**
             * @param maximumIndividualPlayerLatencyMilliseconds The maximum latency value that is
             *   allowed for any player, in milliseconds. All policies must have a value set for
             *   this property.
             */
            ...
            /**
             * @param policyDurationSeconds The length of time, in seconds, that the policy is
             *   enforced while placing a new game session. A null value for this property means
        ...
        private class BuilderImpl : Builder {
             ...
             *   this property.
             */
            override fun maximumIndividualPlayerLatencyMilliseconds(
                maximumIndividualPlayerLatencyMilliseconds: Number
            ) {
        ...
        internal constructor(
             ...
             * session.
             *
             * A null value for this property means that the policy is enforced until the queue
             * times out.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-gamelift-gamesessionqueue-playerlatencypolicy.html#cfn-gamelift-gamesessionqueue-playerlatencypolicy-policydurationseconds)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: PlayerLatencyPolicyProperty
            ): software.amazon.awscdk.services.gamelift.CfnGameSessionQueue.PlayerLatencyPolicyProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface FilterConfigurationProperty {
         ...
         */
        public fun allowedLocations(): List<String> =
            unwrap(this).getAllowedLocations() ?: emptyList()

        /** A builder for [FilterConfigurationProperty] */
        @CdkDslMarker
        public interface Builder {
            /**
             * @param allowedLocations A list of locations to allow game session placement in, in
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-gamelift-gamesessionqueue-filterconfiguration.html#cfn-gamelift-gamesessionqueue-filterconfiguration-allowedlocations)
             */
            override fun allowedLocations(): List<String> =
                unwrap(this).getAllowedLocations() ?: emptyList()
        }
    ...
    public interface GameSessionQueueDestinationProperty {
        ...
        public interface Builder {
            /**
             * @param destinationArn The Amazon Resource Name (ARN) that is assigned to fleet or
             *   fleet alias. ARNs, which include a fleet ID or alias ID and a Region name, provide
             *   a unique identifier across all Regions.
             */
            public fun destinationArn(destinationArn: String)
        }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: GameSessionQueueDestinationProperty
            ): software.amazon.awscdk.services.gamelift.CfnGameSessionQueue.GameSessionQueueDestinationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
