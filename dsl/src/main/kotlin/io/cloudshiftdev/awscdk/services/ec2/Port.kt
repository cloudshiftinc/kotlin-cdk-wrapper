...
internal constructor(
    ...
    public companion object {
        ...
        internal fun wrap(cdkObject: software.amazon.awscdk.services.ec2.Port): Port =
            Port(cdkObject)

        internal fun unwrap(wrapped: Port): software.amazon.awscdk.services.ec2.Port =
            wrapped.cdkObject
    }
}
