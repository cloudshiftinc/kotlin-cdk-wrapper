...
internal constructor(
    ...
    public open fun allowedOAuthFlows(): List<String> =
        unwrap(this).getAllowedOAuthFlows() ?: emptyList()
    ...
    public open fun allowedOAuthScopes(): List<String> =
        unwrap(this).getAllowedOAuthScopes() ?: emptyList()
    ...
    public open fun analyticsConfiguration(
        `value`: AnalyticsConfigurationProperty.Builder.() -> Unit
    ): Unit = analyticsConfiguration(AnalyticsConfigurationProperty(`value`))
    ...
    public open fun explicitAuthFlows(): List<String> =
        unwrap(this).getExplicitAuthFlows() ?: emptyList()
    ...
    public open fun tokenValidityUnits(
        `value`: TokenValidityUnitsProperty.Builder.() -> Unit
    ): Unit = tokenValidityUnits(TokenValidityUnitsProperty(`value`))
    ...
    public open fun writeAttributes(): List<String> =
        unwrap(this).getWriteAttributes() ?: emptyList()
    ...
    /** The list of user attributes that you want your app client to have write access to. */
    public open fun writeAttributes(vararg `value`: String): Unit =
        writeAttributes(`value`.toList())
    ...
    public interface Builder {
         ...
         * The access token time limit.
         *
         * After this limit expires, your user can't use their access token. To specify the time
         * unit for `AccessTokenValidity` as `seconds` , `minutes` , `hours` , or `days` , set a
         ...
         *   directly to a non-person user using a combination of the client ID and client secret.
         *
         ...
         *
         * @param allowedOAuthFlowsUserPoolClient Set to `true` to use OAuth 2.0 features in your
         ...
         * Possible values provided by AWS are `aws.cognito.signin.user.admin` . Custom scopes
         ...
         * events to Amazon Pinpoint projects in AWS Region us-east-1. In Regions where Amazon
         * Pinpoint is available, user pools support sending events to Amazon Pinpoint projects
         ...
         *
         * @param analyticsConfiguration The user pool analytics configuration for collecting
        ...
        public fun analyticsConfiguration(
            analyticsConfiguration: AnalyticsConfigurationProperty.Builder.() -> Unit
        )
         ...
         *
         * @param authSessionValidity Amazon Cognito creates a session token for each API request in
         ...
         *
         * @param enablePropagateAdditionalUserContextData Activates the propagation of additional
         *   user context data.
         */
         ...
         *
         * @param enableTokenRevocation Activates or deactivates token revocation. For more
         ...
         * The authentication flows that you want your user pool client to support.
         *
         * For each app client in your user pool, you can sign in your users with any combination of
         * one or more flows, including with a user name and Secure Remote Password (SRP), a user
         ...
         *   With this authentication flow, your app passes a user name and password to Amazon
         ...
         *   Amazon Cognito receives the password in the request instead of using the SRP protocol
         *   to verify passwords.
         ...
         *
         * @param generateSecret Boolean to specify whether you want to generate a secret for the
         ...
         * The ID token time limit.
         *
         * After this limit expires, your user can't use their ID token. To specify the time unit
         * for `IdTokenValidity` as `seconds` , `minutes` , `hours` , or `days` , set a
         * `TokenValidityUnits` value in your API request.
         *
         ...
         * in the user pool.
         *
         * When set to `ENABLED` and the user does not exist, authentication returns an error
         * indicating either the username or password was incorrect, and account confirmation and
         ...
         *   are returned by Cognito APIs during authentication, account confirmation, and password
         ...
         * values of `email_verified` , `phone_number_verified` , and the Standard attributes of
         ...
         * The refresh token time limit.
         *
         * After this limit expires, your user can't use their refresh token. To specify the time
         * unit for `RefreshTokenValidity` as `seconds` , `minutes` , `hours` , or `days` , set a
         * `TokenValidityUnits` value in your API request.
         *
         ...
         * `LoginWithAmazon` . You can also specify the names that you configured for the SAML and
         * OIDC IdPs in your user pool, for example `MySAMLIdP` or `MyOIDCIdP` .
         *
         ...
         *
         * @param supportedIdentityProviders A list of provider names for the identity providers
         *   (IdPs) that are supported on this client.
         */
         ...
         * The units in which the validity times are represented.
         *
         * The default unit for RefreshToken is days, and default for ID and access tokens are
         * hours.
         *
        ...
        public fun tokenValidityUnits(
            tokenValidityUnits: TokenValidityUnitsProperty.Builder.() -> Unit
        )
         ...
         * of activity is when you present your user with a form to update their profile information
         * and they change their last name. Your app then makes an
    ...
    private class BuilderImpl(
        ...
        override fun allowedOAuthFlowsUserPoolClient(allowedOAuthFlowsUserPoolClient: IResolvable) {
            cdkBuilder.allowedOAuthFlowsUserPoolClient(
                allowedOAuthFlowsUserPoolClient.let(IResolvable::unwrap)
            )
        }
         ...
         *   metrics and sending them to your Amazon Pinpoint campaign.
         */
        override fun analyticsConfiguration(
            analyticsConfiguration: AnalyticsConfigurationProperty
        ) {
            cdkBuilder.analyticsConfiguration(
                analyticsConfiguration.let(AnalyticsConfigurationProperty::unwrap)
            )
        }
         ...
         *   user context data.
         */
        override fun enablePropagateAdditionalUserContextData(
            enablePropagateAdditionalUserContextData: Boolean
        ) {
        ...
        override fun enablePropagateAdditionalUserContextData(
            ...
            cdkBuilder.enablePropagateAdditionalUserContextData(
                enablePropagateAdditionalUserContextData.let(IResolvable::unwrap)
            )
        }
        ...
        override fun tokenValidityUnits(tokenValidityUnits: TokenValidityUnitsProperty) {
            cdkBuilder.tokenValidityUnits(
                tokenValidityUnits.let(TokenValidityUnitsProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("443f031b846120e488d68c74c4d139304198bea73f85c4e88d462430a8525142")
        override fun tokenValidityUnits(
            tokenValidityUnits: TokenValidityUnitsProperty.Builder.() -> Unit
    ...
    public interface TokenValidityUnitsProperty {
        ...
        public interface Builder {
            /**
             * @param accessToken A time unit of `seconds` , `minutes` , `hours` , or `days` for the
            ...
            /**
             * @param idToken A time unit of `seconds` , `minutes` , `hours` , or `days` for the
            ...
            /**
             * @param refreshToken A time unit of `seconds` , `minutes` , `hours` , or `days` for
        ...
        internal constructor(
             ...
             * in the `AccessTokenValidity` parameter.
             *
             * The default `AccessTokenValidity` time unit is hours. `AccessTokenValidity` duration
            ...
            /**
             * A time unit of `seconds` , `minutes` , `hours` , or `days` for the value that you set
             * in the `IdTokenValidity` parameter.
             *
             * The default `IdTokenValidity` time unit is hours. `IdTokenValidity` duration can
             * range from five minutes to one day.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-cognito-userpoolclient-tokenvalidityunits.html#cfn-cognito-userpoolclient-tokenvalidityunits-idtoken)
             */
            ...
            /**
             * A time unit of `seconds` , `minutes` , `hours` , or `days` for the value that you set
             * in the `RefreshTokenValidity` parameter.
             *
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TokenValidityUnitsProperty
            ): software.amazon.awscdk.services.cognito.CfnUserPoolClient.TokenValidityUnitsProperty =
    ...
    public interface AnalyticsConfigurationProperty {
        ...
        public interface Builder {
             ...
             *   You can use the Amazon Pinpoint project for integration with the chosen user pool
             *   client. Amazon Cognito publishes events to the Amazon Pinpoint project that the app
             *   ARN declares.
             */
            ...
            /**
             * @param roleArn The ARN of an AWS Identity and Access Management role that authorizes
             *   Amazon Cognito to publish events to Amazon Pinpoint analytics.
             */
            public fun roleArn(roleArn: String)

            /**
             * @param userDataShared If `UserDataShared` is `true` , Amazon Cognito includes user
        ...
        internal constructor(
            ...
            /**
             * The ARN of an AWS Identity and Access Management role that authorizes Amazon Cognito
