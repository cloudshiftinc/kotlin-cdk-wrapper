...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param ownerInformation A user-provided value that will be included in any Amazon
         *   CloudWatch Events events that are raised while running tasks for these targets in this
         *   maintenance window.
         */
         ...
         *
         * @param resourceType The type of target that is being registered with the maintenance
         *   window.
         */
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnMaintenanceWindowTarget
