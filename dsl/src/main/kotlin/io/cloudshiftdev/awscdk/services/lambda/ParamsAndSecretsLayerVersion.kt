...
internal constructor(
    ...
    public companion object {
        public fun fromVersion(version: ParamsAndSecretsVersions): ParamsAndSecretsLayerVersion =
            software.amazon.awscdk.services.lambda.ParamsAndSecretsLayerVersion.fromVersion(
                    version.let(ParamsAndSecretsVersions::unwrap)
                )
                .let(ParamsAndSecretsLayerVersion::wrap)
        ...
        public fun fromVersion(
            ...
            software.amazon.awscdk.services.lambda.ParamsAndSecretsLayerVersion.fromVersion(
                    version.let(ParamsAndSecretsVersions::unwrap),
                    options.let(ParamsAndSecretsOptions::unwrap)
                )
                .let(ParamsAndSecretsLayerVersion::wrap)
        ...
        public fun fromVersion(
            version: ParamsAndSecretsVersions,
            options: ParamsAndSecretsOptions.Builder.() -> Unit
        ): ParamsAndSecretsLayerVersion = fromVersion(version, ParamsAndSecretsOptions(options))
        ...
        public fun fromVersionArn(
            ...
            software.amazon.awscdk.services.lambda.ParamsAndSecretsLayerVersion.fromVersionArn(
                    arn,
                    options.let(ParamsAndSecretsOptions::unwrap)
                )
                .let(ParamsAndSecretsLayerVersion::wrap)
        ...
        internal fun unwrap(
            wrapped: ParamsAndSecretsLayerVersion
