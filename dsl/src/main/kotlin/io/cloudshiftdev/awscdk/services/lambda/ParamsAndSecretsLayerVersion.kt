...
public abstract class ParamsAndSecretsLayerVersion internal constructor(
  ...
  public companion object {
    public open fun fromVersion(version: ParamsAndSecretsVersions): ParamsAndSecretsLayerVersion =
    ...
    public open fun fromVersion(version: ParamsAndSecretsVersions,
        options: ParamsAndSecretsOptions): ParamsAndSecretsLayerVersion =
    ...
    public open fun fromVersionArn(arn: String): ParamsAndSecretsLayerVersion =
    ...
    public open fun fromVersionArn(arn: String, options: ParamsAndSecretsOptions):
    ...
    public open fun fromVersionArn(arn: String,
        options: ParamsAndSecretsOptions.Builder.() -> Unit): ParamsAndSecretsLayerVersion =
        fromVersionArn(arn, ParamsAndSecretsOptions(options))
