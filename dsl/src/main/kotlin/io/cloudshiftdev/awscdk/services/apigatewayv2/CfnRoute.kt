...
internal constructor(
    ...
    public interface Builder {
         ...
         * The route key for the route.
         *
         * For HTTP APIs, the route key can be either `$default` , or a combination of an HTTP
         * method and resource path, for example, `GET /pets` .
         *
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.apigatewayv2.CfnRoute =
            cdkBuilder.build()
    }
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnRoute
        ): software.amazon.awscdk.services.apigatewayv2.CfnRoute = wrapped.cdkObject
    }
    ...
    public interface ParameterConstraintsProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ParameterConstraintsProperty
            ): software.amazon.awscdk.services.apigatewayv2.CfnRoute.ParameterConstraintsProperty =
