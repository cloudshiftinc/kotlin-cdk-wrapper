...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * During the deduplication interval (5 minutes), Amazon SQS treats messages that are sent
         * with identical content (excluding attributes) as duplicates and delivers only one copy of
         * the message.
         *
         * If you don't enable content-based deduplication and you want to deduplicate messages,
         * provide an explicit deduplication ID in your SendMessage() call.
         *
         ...
         *
         * @param dataKeyReuse The length of time that Amazon SQS reuses a data key before calling
         *   KMS again.
         */
         ...
         * Default: 0
         *
         * @param deliveryDelay The time in seconds that the delivery of all messages in the queue
         *   is delayed.
         */
         ...
         * Whether the contents of the queue are encrypted, and by what type of key.
         *
         * Be aware that encryption is not available in all regions, please see the docs for current
         * availability details.
         *
         * Default: SQS_MANAGED (SSE-SQS) for newly created queues
         *
         * @param encryption Whether the contents of the queue are encrypted, and by what type of
         *   key.
         */
         ...
         *
         * Individual messages will be encrypted using data keys. The data keys in turn will be
         * encrypted using this key, and reused for a maximum of `dataKeyReuseSecs` seconds.
         *
         * If the 'encryptionMasterKey' property is set, 'encryption' type will be implicitly set to
         * "KMS".
         *
         ...
         *
         * You can specify an integer value from 1024 bytes (1 KiB) to 262144 bytes (256 KiB). The
         * default value is 262144 (256 KiB).
         *
         * Default: 256KiB
         *
         ...
         *
         * Does not wait if set to 0, otherwise waits this amount of seconds by default for messages
         * to arrive.
         *
         ...
         *
         * Even though queues are technically stateful, their contents are transient and it is
         * common to add and remove Queues while rearchitecting your application. The default is
         * therefore `DESTROY`. Change it to `RETAIN` if the messages are so valuable that
         * accidentally losing them would be unacceptable.
         *
         ...
         *
         * After dequeuing, the processor has this much time to handle the message and delete it
         * from the queue before it becomes visible again for dequeueing by another processor.
         *
    ...
    private class BuilderImpl(
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("5bda4096d045a478f2b31ab46f72925fb4078b6516e4a5c1eef3f25da474a121")
        override fun redriveAllowPolicy(
            redriveAllowPolicy: RedriveAllowPolicy.Builder.() -> Unit
        ): Unit = redriveAllowPolicy(RedriveAllowPolicy(redriveAllowPolicy))
    ...
    public companion object {
        public fun fromQueueArn(
            ...
            software.amazon.awscdk.services.sqs.Queue.fromQueueArn(
        ...
        public fun fromQueueAttributes(
            ...
            software.amazon.awscdk.services.sqs.Queue.fromQueueAttributes(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    attrs.let(QueueAttributes::unwrap)
                )
                .let(IQueue::wrap)
