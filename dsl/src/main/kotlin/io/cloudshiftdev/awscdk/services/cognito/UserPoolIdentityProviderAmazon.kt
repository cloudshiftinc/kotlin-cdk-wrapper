...
internal constructor(
     ...
     * [io.cloudshiftdev.awscdk.services.cognito.UserPoolIdentityProviderAmazon].
     */
    @CdkDslMarker
    public interface Builder {
         ...
         * [Documentation](https://developer.amazon.com/docs/login-with-amazon/security-profile.html#client-identifier)
         *
         * @param clientSecret The client secret to be accompanied with clientId for Login with
         *   Amazon APIs to authenticate the client.
         */
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.cognito.UserPoolIdentityProviderAmazon.Builder.create(
                scope,
                id
            )
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: UserPoolIdentityProviderAmazon
