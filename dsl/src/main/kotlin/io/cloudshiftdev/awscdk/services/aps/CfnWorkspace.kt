...
internal constructor(
    ...
    public interface Builder {
         ...
         * [Creating an alert manager configuration files](https://docs.aws.amazon.com/prometheus/latest/userguide/AMP-alertmanager-config.html)
        ...
        /**
         * (optional) The ARN for a customer managed AWS KMS key to use for encrypting data within
         * your workspace.
         *
         * For more information about using your own key in your workspace, see
         ...
         *
         * @param kmsKeyArn (optional) The ARN for a customer managed AWS KMS key to use for
         *   encrypting data within your workspace.
         */
    ...
    public companion object {
        ...
        ): software.amazon.awscdk.services.aps.CfnWorkspace = wrapped.cdkObject
    }
    ...
    public interface LoggingConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param logGroupArn The ARN of the CloudWatch log group to which the vended log data
             *   will be published. This log group must exist prior to calling this operation.
             */
