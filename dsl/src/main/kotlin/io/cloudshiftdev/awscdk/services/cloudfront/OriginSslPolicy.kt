...
public enum class OriginSslPolicy(
    ...
    public companion object {
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.cloudfront.OriginSslPolicy
        ): OriginSslPolicy =
            when (cdkObject) {
                software.amazon.awscdk.services.cloudfront.OriginSslPolicy.SSL_V3 ->
                    OriginSslPolicy.SSL_V3
                software.amazon.awscdk.services.cloudfront.OriginSslPolicy.TLS_V1 ->
