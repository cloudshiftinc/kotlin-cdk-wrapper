...
internal constructor(
    ...
    public open fun taskInvocationParameters(`value`: TaskInvocationParametersProperty) {
        unwrap(this)
            .setTaskInvocationParameters(`value`.let(TaskInvocationParametersProperty::unwrap))
    }

    /** The parameters to pass to the task when it runs. */
    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("5e81404d3ee8fccf29e12a8734c109e64151389d0deeef605b473627741989f3")
    public open fun taskInvocationParameters(
        `value`: TaskInvocationParametersProperty.Builder.() -> Unit
    ...
    public interface Builder {
         ...
         *
         * @param cutoffBehavior The specification for whether tasks should continue to run after
         ...
         * Command tasks, instead use the `OutputS3BucketName` and `OutputS3KeyPrefix` options in
         * the `TaskInvocationParameters` structure. For information about how Systems Manager
         ...
         *
         * @param loggingInfo Information about an Amazon S3 bucket to write Run Command task-level
         *   logs to.
         */
         ...
         *
         * @param maxConcurrency The maximum number of targets this task can be run for, in
         *   parallel.
         */
        ...
        /**
         * The Amazon Resource Name (ARN) of the AWS Identity and Access Management (IAM) service
         * role to use to publish Amazon Simple Notification Service (Amazon SNS) notifications for
         * maintenance window Run Command tasks.
         *
         ...
         *   Management (IAM) service role to use to publish Amazon Simple Notification Service
         ...
         * The resource that the task uses during execution.
         *
         * For `RUN_COMMAND` and `AUTOMATION` task types, `TaskArn` is the SSM document name or
         ...
         * values that you want to retain. The values you do not specify again are removed. For
        ...
        public fun taskInvocationParameters(
            taskInvocationParameters: TaskInvocationParametersProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
        ...
        override fun taskInvocationParameters(
            ...
            cdkBuilder.taskInvocationParameters(
                taskInvocationParameters.let(TaskInvocationParametersProperty::unwrap)
            )
        }
        ...
        override fun taskInvocationParameters(
            ...
            taskInvocationParameters(TaskInvocationParametersProperty(taskInvocationParameters))
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnMaintenanceWindowTask
    ...
    public interface MaintenanceWindowLambdaParametersProperty {
         ...
         * Name (ARN) to invoke a specific Lambda function. If you specify an alias name, the action
         * uses the alias ARN to invoke the Lambda function version that the alias points to.
         *
        ...
        public interface Builder {
            /**
             * @param clientContext Client-specific information to pass to the AWS Lambda function
             *   that you're invoking. You can then use the `context` variable to process the client
             *   information in your AWS Lambda function.
             */
            ...
            /**
             * @param qualifier An AWS Lambda function version or alias name. If you specify a
             *   function version, the action uses the qualified function Amazon Resource Name (ARN)
             *   to invoke a specific Lambda function. If you specify an alias name, the action uses
        ...
        internal constructor(
             ...
             * An AWS Lambda function version or alias name.
             *
             * If you specify a function version, the action uses the qualified function Amazon
             * Resource Name (ARN) to invoke a specific Lambda function. If you specify an alias
             * name, the action uses the alias ARN to invoke the Lambda function version that the
             * alias points to.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ssm-maintenancewindowtask-maintenancewindowlambdaparameters.html#cfn-ssm-maintenancewindowtask-maintenancewindowlambdaparameters-qualifier)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: MaintenanceWindowLambdaParametersProperty
            ): software.amazon.awscdk.services.ssm.CfnMaintenanceWindowTask.MaintenanceWindowLambdaParametersProperty =
    ...
    public interface MaintenanceWindowRunCommandParametersProperty {
         ...
         *
         * You can specify `$DEFAULT` , `$LATEST` , or a specific version number. If you run
         * commands by using the AWS CLI, then you must escape the first two options by using a
        ...
        public interface Builder {
            /**
             * @param cloudWatchOutputConfig Configuration options for sending command output to
             ...
             *   Amazon CloudWatch Logs.
             */
            public fun cloudWatchOutputConfig(
            ...
            public fun cloudWatchOutputConfig(
                cloudWatchOutputConfig: CloudWatchOutputConfigProperty.Builder.() -> Unit
            )
            ...
            /**
             * @param documentHash The SHA-256 or SHA-1 hash created by the system when the document
             *   was created. SHA-1 hashes have been deprecated.
             */
            public fun documentHash(documentHash: String)

            /**
             * @param documentHashType The SHA-256 or SHA-1 hash type. SHA-1 hashes are deprecated.
             */
            public fun documentHashType(documentHashType: String)

            /**
             * @param documentVersion The AWS Systems Manager document (SSM document) version to use
             *   in the request. You can specify `$DEFAULT` , `$LATEST` , or a specific version
             *   number. If you run commands by using the AWS CLI, then you must escape the first
             *   two options by using a backslash. If you specify a version number, then you don't
            ...
            /**
             * @param notificationConfig Configurations for sending notifications about command
            ...
            public fun notificationConfig(
                notificationConfig: NotificationConfigProperty.Builder.() -> Unit
            )

            /**
             * @param outputS3BucketName The name of the Amazon Simple Storage Service (Amazon S3)
             *   bucket.
             */
            ...
            /**
             * @param parameters The parameters for the `RUN_COMMAND` task execution. The supported
             *   parameters are the same as those for the `SendCommand` API call. For more
             *   information, see
             *   [SendCommand](https://docs.aws.amazon.com/systems-manager/latest/APIReference/API_SendCommand.html)
             *   in the *AWS Systems Manager API Reference* .
             */
        ...
        private class BuilderImpl : Builder {
             ...
             *   Amazon CloudWatch Logs.
             */
            override fun cloudWatchOutputConfig(
                cloudWatchOutputConfig: CloudWatchOutputConfigProperty
            ) {
                cdkBuilder.cloudWatchOutputConfig(
                    cloudWatchOutputConfig.let(CloudWatchOutputConfigProperty::unwrap)
                )
            }
            ...
            override fun notificationConfig(notificationConfig: NotificationConfigProperty) {
                cdkBuilder.notificationConfig(
                    notificationConfig.let(NotificationConfigProperty::unwrap)
                )
            }
        ...
        internal constructor(
             ...
             * You can specify `$DEFAULT` , `$LATEST` , or a specific version number. If you run
             * commands by using the AWS CLI, then you must escape the first two options by using a
             * backslash. If you specify a version number, then you don't need to use the backslash.
             * For example:
             *
             * `--document-version "\$DEFAULT"`
             *
             ...
             * The parameters for the `RUN_COMMAND` task execution.
             *
             * The supported parameters are the same as those for the `SendCommand` API call. For
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: MaintenanceWindowRunCommandParametersProperty
            ): software.amazon.awscdk.services.ssm.CfnMaintenanceWindowTask.MaintenanceWindowRunCommandParametersProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface NotificationConfigProperty {
         ...
         */
        public fun notificationEvents(): List<String> =
            unwrap(this).getNotificationEvents() ?: emptyList()
        ...
        public interface Builder {
            /**
             * @param notificationArn An Amazon Resource Name (ARN) for an Amazon Simple
             *   Notification Service (Amazon SNS) topic. Run Command pushes notifications about
             *   command status changes to this topic.
             */
            public fun notificationArn(notificationArn: String)

            /**
             * @param notificationEvents The different events that you can receive notifications
             *   for. These events include the following: `All` (events), `InProgress` , `Success` ,
        ...
        internal constructor(
             ...
             * The different events that you can receive notifications for.
             *
             * These events include the following: `All` (events), `InProgress` , `Success` ,
             * `TimedOut` , `Cancelled` , `Failed` . To learn more about these events, see
             * [Configuring Amazon SNS Notifications for AWS Systems Manager](https://docs.aws.amazon.com/systems-manager/latest/userguide/monitoring-sns-notifications.html)
             * in the *AWS Systems Manager User Guide* .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ssm-maintenancewindowtask-notificationconfig.html#cfn-ssm-maintenancewindowtask-notificationconfig-notificationevents)
             */
            override fun notificationEvents(): List<String> =
                unwrap(this).getNotificationEvents() ?: emptyList()
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: NotificationConfigProperty
            ): software.amazon.awscdk.services.ssm.CfnMaintenanceWindowTask.NotificationConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface TargetProperty {
         ...
         *
         * `Key` can be `InstanceIds` or `WindowTargetIds` . For more information about how to
         * target instances within a maintenance window task, see
        ...
        public interface Builder {
            /**
             * @param key User-defined criteria for sending commands that target instances that meet
             *   the criteria. `Key` can be `InstanceIds` or `WindowTargetIds` . For more
             *   information about how to target instances within a maintenance window task, see
             *   [About 'register-task-with-maintenance-window' Options and Values](https://docs.aws.amazon.com/systems-manager/latest/userguide/register-tasks-options.html)
             *   in the *AWS Systems Manager User Guide* .
             */
             ...
             *   `InstanceIds` , you can specify `i-1234567890abcdef0,i-9876543210abcdef0` to run a
             *   command on two EC2 instances. For more information about how to target instances
             *   within a maintenance window task, see
             *   [About 'register-task-with-maintenance-window' Options and Values](https://docs.aws.amazon.com/systems-manager/latest/userguide/register-tasks-options.html)
             *   in the *AWS Systems Manager User Guide* .
             */
        ...
        internal constructor(
             ...
             *
             * For example, if you specify `InstanceIds` , you can specify
             * `i-1234567890abcdef0,i-9876543210abcdef0` to run a command on two EC2 instances. For
             * more information about how to target instances within a maintenance window task, see
             * [About 'register-task-with-maintenance-window' Options and Values](https://docs.aws.amazon.com/systems-manager/latest/userguide/register-tasks-options.html)
             * in the *AWS Systems Manager User Guide* .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ssm-maintenancewindowtask-target.html#cfn-ssm-maintenancewindowtask-target-values)
    ...
    public interface MaintenanceWindowAutomationParametersProperty {
        ...
        public interface Builder {
            /**
             * @param documentVersion The version of an Automation runbook to use during task
             *   execution.
             */
            public fun documentVersion(documentVersion: String)
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: MaintenanceWindowAutomationParametersProperty
            ): software.amazon.awscdk.services.ssm.CfnMaintenanceWindowTask.MaintenanceWindowAutomationParametersProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface MaintenanceWindowStepFunctionsParametersProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: MaintenanceWindowStepFunctionsParametersProperty
            ): software.amazon.awscdk.services.ssm.CfnMaintenanceWindowTask.MaintenanceWindowStepFunctionsParametersProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CloudWatchOutputConfigProperty {
        ...
        public interface Builder {
            /**
             * @param cloudWatchLogGroupName The name of the CloudWatch Logs log group where you
             *   want to send command output. If you don't specify a group name, AWS Systems Manager
             *   automatically creates a log group for you. The log group uses the following naming
             *   format:
             *
             * `aws/ssm/ *SystemsManagerDocumentName*`
             */
            ...
            /**
             * @param cloudWatchOutputEnabled Enables Systems Manager to send command output to
             *   CloudWatch Logs.
             */
        ...
        internal constructor(
             ...
             * The name of the CloudWatch Logs log group where you want to send command output.
             *
             * If you don't specify a group name, AWS Systems Manager automatically creates a log
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ssm-maintenancewindowtask-cloudwatchoutputconfig.html#cfn-ssm-maintenancewindowtask-cloudwatchoutputconfig-cloudwatchloggroupname)
             */
            override fun cloudWatchLogGroupName(): String? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CloudWatchOutputConfigProperty
            ): software.amazon.awscdk.services.ssm.CfnMaintenanceWindowTask.CloudWatchOutputConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface TaskInvocationParametersProperty {
        ...
        public interface Builder {
            /**
             * @param maintenanceWindowAutomationParameters The parameters for an `AUTOMATION` task
             *   type.
             */
            ...
            public fun maintenanceWindowAutomationParameters(
                maintenanceWindowAutomationParameters:
                    MaintenanceWindowAutomationParametersProperty.Builder.() -> Unit
            )
            ...
            public fun maintenanceWindowLambdaParameters(
                maintenanceWindowLambdaParameters: IResolvable
            )
            ...
            public fun maintenanceWindowLambdaParameters(
                maintenanceWindowLambdaParameters:
                    MaintenanceWindowLambdaParametersProperty.Builder.() -> Unit
            )

            /**
             * @param maintenanceWindowRunCommandParameters The parameters for a `RUN_COMMAND` task
             *   type.
             */
            ...
            public fun maintenanceWindowRunCommandParameters(
                maintenanceWindowRunCommandParameters:
                    MaintenanceWindowRunCommandParametersProperty.Builder.() -> Unit
            )

            /**
             * @param maintenanceWindowStepFunctionsParameters The parameters for a `STEP_FUNCTIONS`
             *   task type.
             */
            ...
            public fun maintenanceWindowStepFunctionsParameters(
                maintenanceWindowStepFunctionsParameters:
                    MaintenanceWindowStepFunctionsParametersProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun maintenanceWindowAutomationParameters(
                ...
                cdkBuilder.maintenanceWindowAutomationParameters(
                    maintenanceWindowAutomationParameters.let(IResolvable::unwrap)
                )
            }
            ...
            override fun maintenanceWindowAutomationParameters(
                ...
                cdkBuilder.maintenanceWindowAutomationParameters(
                    maintenanceWindowAutomationParameters.let(
                        MaintenanceWindowAutomationParametersProperty::unwrap
                    )
                )
            }
            ...
            override fun maintenanceWindowLambdaParameters(
                ...
                cdkBuilder.maintenanceWindowLambdaParameters(
                    maintenanceWindowLambdaParameters.let(IResolvable::unwrap)
                )
            }
            ...
            override fun maintenanceWindowLambdaParameters(
                ...
                cdkBuilder.maintenanceWindowLambdaParameters(
                    maintenanceWindowLambdaParameters.let(
                        MaintenanceWindowLambdaParametersProperty::unwrap
                    )
                )
            }
            ...
            override fun maintenanceWindowLambdaParameters(
                ...
                maintenanceWindowLambdaParameters(
                    MaintenanceWindowLambdaParametersProperty(maintenanceWindowLambdaParameters)
                )
             ...
             *   type.
             */
            override fun maintenanceWindowRunCommandParameters(
                maintenanceWindowRunCommandParameters: IResolvable
            ) {
                cdkBuilder.maintenanceWindowRunCommandParameters(
                    maintenanceWindowRunCommandParameters.let(IResolvable::unwrap)
                )
            }
            ...
            override fun maintenanceWindowRunCommandParameters(
                ...
                cdkBuilder.maintenanceWindowRunCommandParameters(
                    maintenanceWindowRunCommandParameters.let(
                        MaintenanceWindowRunCommandParametersProperty::unwrap
                    )
                )
            }
             ...
             *   task type.
             */
            override fun maintenanceWindowStepFunctionsParameters(
                maintenanceWindowStepFunctionsParameters: IResolvable
            ) {
                cdkBuilder.maintenanceWindowStepFunctionsParameters(
                    maintenanceWindowStepFunctionsParameters.let(IResolvable::unwrap)
                )
            }
            ...
            override fun maintenanceWindowStepFunctionsParameters(
                ...
                cdkBuilder.maintenanceWindowStepFunctionsParameters(
                    maintenanceWindowStepFunctionsParameters.let(
                        MaintenanceWindowStepFunctionsParametersProperty::unwrap
                    )
                )
            }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TaskInvocationParametersProperty
            ): software.amazon.awscdk.services.ssm.CfnMaintenanceWindowTask.TaskInvocationParametersProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
