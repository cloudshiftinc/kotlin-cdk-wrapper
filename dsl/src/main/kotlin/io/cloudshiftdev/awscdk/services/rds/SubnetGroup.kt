...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param removalPolicy The removal policy to apply when the subnet group are removed from
    ...
    public companion object {
        public fun fromSubnetGroupName(
            ...
            software.amazon.awscdk.services.rds.SubnetGroup.fromSubnetGroupName(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    subnetGroupName
                )
                .let(ISubnetGroup::wrap)
