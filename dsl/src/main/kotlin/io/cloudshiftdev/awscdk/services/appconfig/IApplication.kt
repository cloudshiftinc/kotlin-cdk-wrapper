...
public interface IApplication : IResource {
     ...
     */
    public fun addHostedConfiguration(
        id: String,
     ...
     */
    public fun addSourcedConfiguration(
        id: String,
    ...
    internal constructor(
         ...
         * @param options The options for the hosted configuration construct.
         */
        override fun addHostedConfiguration(
            id: String,
            options: HostedConfigurationOptions
        ): HostedConfiguration =
            unwrap(this)
         ...
         * @param options The options for the sourced configuration construct.
         */
        override fun addSourcedConfiguration(
            id: String,
            options: SourcedConfigurationOptions
        ): SourcedConfiguration =
            unwrap(this)
         ...
         * destination and also creates an extension association to an application.
         *
         * @param eventDestination The event that occurs during the extension.
         * @param options Options for the extension.
         */
