...
internal constructor(
    ...
    public open fun flexibleTimeWindow(
        `value`: FlexibleTimeWindowProperty.Builder.() -> Unit
    ): Unit = flexibleTimeWindow(FlexibleTimeWindowProperty(`value`))
    ...
    public interface Builder {
         ...
         * The date, in UTC, before which the schedule can invoke its target.
         *
         * Depending on the schedule's recurrence expression, invocations might stop on, or before,
        ...
        public fun flexibleTimeWindow(
            flexibleTimeWindow: FlexibleTimeWindowProperty.Builder.() -> Unit
        )
         ...
         * expressions to create recurring schedules. Rate-based schedules are useful when you want
         * to invoke a target at regular intervals, such as every 15 minutes or every five days.
         * Cron-based schedules are useful when you want to invoke a target periodically at a
         * specific time, such as at 8:00 am (UTC+0) every 1st day of the month.
         *
         ...
         *
         * @param scheduleExpression The expression that defines when the schedule runs. The
    ...
    private class BuilderImpl(
        ...
        override fun flexibleTimeWindow(flexibleTimeWindow: FlexibleTimeWindowProperty) {
            cdkBuilder.flexibleTimeWindow(
                flexibleTimeWindow.let(FlexibleTimeWindowProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("11bec8a2b49d8714c23848c634547529347f21a2f1958a89005e036f46821ac6")
        override fun flexibleTimeWindow(
            flexibleTimeWindow: FlexibleTimeWindowProperty.Builder.() -> Unit
        ...
        public fun build(): software.amazon.awscdk.services.scheduler.CfnSchedule =
            cdkBuilder.build()
    }
    ...
    public companion object {
        ...
        ): CfnSchedule = CfnSchedule(cdkObject)

        internal fun unwrap(
            wrapped: CfnSchedule
        ): software.amazon.awscdk.services.scheduler.CfnSchedule = wrapped.cdkObject
    }
    ...
    public interface RetryPolicyProperty {
        ...
        public interface Builder {
             ...
             *   request fails. Retry attempts with exponential backoff continue until either the
    ...
    public interface FlexibleTimeWindowProperty {
        ...
        public interface Builder {
             ...
             *   You must use quotation marks when you specify this value in your JSON or YAML
             *   template.
             *
             * *Allowed Values* : `"OFF"` | `"FLEXIBLE"`
             */
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-scheduler-schedule-flexibletimewindow.html#cfn-scheduler-schedule-flexibletimewindow-maximumwindowinminutes)
             */
            override fun maximumWindowInMinutes(): Number? =
                unwrap(this).getMaximumWindowInMinutes()
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: FlexibleTimeWindowProperty
            ): software.amazon.awscdk.services.scheduler.CfnSchedule.FlexibleTimeWindowProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface EventBridgeParametersProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: EventBridgeParametersProperty
            ): software.amazon.awscdk.services.scheduler.CfnSchedule.EventBridgeParametersProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface PlacementStrategyProperty {
         ...
         * valid values are `cpu` and `memory` . For the random placement strategy, this field is
         * not used.
         *
        ...
        public interface Builder {
             ...
             *   placement strategy, valid values are `instanceId` (or `instanceId` , which has the
        ...
        internal constructor(
             ...
             * The field to apply the placement strategy against.
             *
             * For the spread placement strategy, valid values are `instanceId` (or `instanceId` ,
    ...
    public interface EcsParametersProperty {
         ...
         * of the target task. The `FARGATE` value is supported only in the Regions where Fargate
         * with Amazon ECS is supported. For more information, see
        ...
        public interface Builder {
             ...
             *   the target task. The `FARGATE` value is supported only in the Regions where Fargate
             *   with Amazon ECS is supported. For more information, see
             *   [AWS Fargate on Amazon ECS](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/AWS_Fargate.html)
             *   in the *Amazon ECS Developer Guide* .
             */
            ...
            /**
             * @param networkConfiguration This structure specifies the network configuration for an
             *   ECS task.
             */
        ...
        internal constructor(
             ...
             * Regions where Fargate with Amazon ECS is supported. For more information, see
             * [AWS Fargate on Amazon ECS](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/AWS_Fargate.html)
             * in the *Amazon ECS Developer Guide* .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-scheduler-schedule-ecsparameters.html#cfn-scheduler-schedule-ecsparameters-launchtype)
    ...
    public interface NetworkConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param awsvpcConfiguration Specifies the Amazon VPC subnets and security groups for
             *   the task, and whether a public IP address is to be used. This structure is relevant
    ...
    public interface TargetProperty {
         ...
         * required. If you do not specify anything for this field, Amazon EventBridge Scheduler
        ...
        /**
         * The Amazon Resource Name (ARN) of the IAM role that EventBridge Scheduler will use for
         * this target when the schedule is invoked.
         *
         ...
         * you specify an Amazon SQS FIFO queue as a target, the queue must have content-based
        ...
        public interface Builder {
            ...
            /**
             * @param deadLetterConfig An object that contains information about an Amazon SQS queue
             *   that EventBridge Scheduler uses as a dead-letter queue for your schedule. If
            ...
            public fun eventBridgeParameters(
                eventBridgeParameters: EventBridgeParametersProperty.Builder.() -> Unit
            )

            /**
             * @param input The text, or well-formed JSON, passed to the target. If you are
             *   configuring a templated Lambda , AWS Step Functions , or Amazon EventBridge target,
             *   the input must be a well-formed JSON. For all other target types, a JSON is not
             *   required. If you do not specify anything for this field, Amazon EventBridge
            ...
            /**
             * @param retryPolicy A `RetryPolicy` object that includes information about the retry
             *   policy settings, including the maximum age of an event, and the maximum number of
            ...
            /**
             * @param roleArn The Amazon Resource Name (ARN) of the IAM role that EventBridge
             ...
             *   content-based deduplication enabled. For more information, see
             *   [Using the Amazon SQS message deduplication ID](https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/using-messagededuplicationid-property.html)
             *   in the *Amazon SQS Developer Guide* .
             */
        ...
        private class BuilderImpl : Builder {
             ...
             *   API operation.
             */
            override fun eventBridgeParameters(
                eventBridgeParameters: EventBridgeParametersProperty
            ) {
                cdkBuilder.eventBridgeParameters(
                    eventBridgeParameters.let(EventBridgeParametersProperty::unwrap)
                )
            }
        ...
        internal constructor(
             ...
             * Scheduler uses as a dead-letter queue for your schedule.
             *
             * If specified, EventBridge Scheduler delivers failed events that could not be
             * successfully delivered to a target to the queue.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-scheduler-schedule-target.html#cfn-scheduler-schedule-target-deadletterconfig)
             */
             ...
             * The text, or well-formed JSON, passed to the target.
             *
             * If you are configuring a templated Lambda , AWS Step Functions , or Amazon
             * EventBridge target, the input must be a well-formed JSON. For all other target types,
             * a JSON is not required. If you do not specify anything for this field, Amazon
             ...
             * The templated target type for the Amazon SQS
             * [`SendMessage`](https://docs.aws.amazon.com/AWSSimpleQueueService/latest/APIReference/API_SendMessage.html)
             * API operation. Contains the message group ID to use when the target is a FIFO queue.
             * If you specify an Amazon SQS FIFO queue as a target, the queue must have
             * content-based deduplication enabled. For more information, see
             * [Using the Amazon SQS message deduplication ID](https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/using-messagededuplicationid-property.html)
             * in the *Amazon SQS Developer Guide* .
             *
    ...
    public interface DeadLetterConfigProperty {
        ...
        public interface Builder {
            /**
             * @param arn The Amazon Resource Name (ARN) of the SQS queue specified as the
    ...
    public interface KinesisParametersProperty {
        ...
        public interface Builder {
            /**
             * @param partitionKey Specifies the shard to which EventBridge Scheduler sends the
    ...
    public interface PlacementConstraintProperty {
        ...
        public interface Builder {
             ...
             *   cannot specify an expression if the constraint type is `distinctInstance` . For
        ...
        internal constructor(
             ...
             * A cluster query language expression to apply to the constraint.
             *
             * You cannot specify an expression if the constraint type is `distinctInstance` . For
             * more information, see
             * [Cluster query language](https://docs.aws.amazon.com/latest/developerguide/cluster-query-language.html)
             * in the *Amazon ECS Developer Guide* .
             *
    ...
    public interface SageMakerPipelineParametersProperty {
        ...
        public interface Builder {
            /**
             * @param pipelineParameterList List of parameter names and values to use when executing
             *   the SageMaker Model Building Pipeline.
             */
