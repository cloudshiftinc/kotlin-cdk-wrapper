...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param destination The Region or Availability Zone that's the target for the
         *   subscription.
         */
    ...
    public companion object {
        ...
        internal fun wrap(
            ...
            CfnNetworkPerformanceMetricSubscription(cdkObject)

        internal fun unwrap(
            wrapped: CfnNetworkPerformanceMetricSubscription
        ): software.amazon.awscdk.services.ec2.CfnNetworkPerformanceMetricSubscription =
            wrapped.cdkObject
    }
}
