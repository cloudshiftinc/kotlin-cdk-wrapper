...
public enum class DnsPolicy(
  ...
  CLUSTER_FIRST_WITH_HOST_NET(software.amazon.awscdk.services.batch.DnsPolicy.CLUSTER_FIRST_WITH_HOST_NET),
  ;

  public companion object {
    internal fun wrap(cdkObject: software.amazon.awscdk.services.batch.DnsPolicy): DnsPolicy = when
        (cdkObject) {
      software.amazon.awscdk.services.batch.DnsPolicy.DEFAULT -> DnsPolicy.DEFAULT
      software.amazon.awscdk.services.batch.DnsPolicy.CLUSTER_FIRST -> DnsPolicy.CLUSTER_FIRST
