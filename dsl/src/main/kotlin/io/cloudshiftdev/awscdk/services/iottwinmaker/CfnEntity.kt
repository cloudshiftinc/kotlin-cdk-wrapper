...
internal constructor(
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.iottwinmaker.CfnEntity =
            cdkBuilder.build()
    }
    ...
    public companion object {
        ...
        ): CfnEntity = CfnEntity(cdkObject)

        internal fun unwrap(
            wrapped: CfnEntity
        ): software.amazon.awscdk.services.iottwinmaker.CfnEntity = wrapped.cdkObject
    }
    ...
    public interface PropertyProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param value An object that contains information about a value for a time series
             *   property.
             */
    ...
    public interface StatusProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param state The current state of the entity, component, component type, or
             *   workspace. Valid Values: `CREATING | UPDATING | DELETING | ACTIVE | ERROR`
             */
    ...
    public interface ComponentProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param properties An object that maps strings to the properties to set in the
            ...
            /**
             * @param propertyGroups An object that maps strings to the property groups in the
             *   component type. Each string in the mapping must be unique to this object.
             */
    ...
    public interface CompositeComponentProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param properties Map of strings to the properties in the component type. Each string
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CompositeComponentProperty
            ): software.amazon.awscdk.services.iottwinmaker.CfnEntity.CompositeComponentProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
