...
public interface ServerDeploymentGroupAttributes {
    ...
    public interface Builder {
        ...
        /**
         * @param deploymentGroupName The physical, human-readable name of the CodeDeploy
         *   EC2/on-premise Deployment Group that we are referencing.
         */
    ...
    internal constructor(
        ...
        /**
         * The physical, human-readable name of the CodeDeploy EC2/on-premise Deployment Group that
         * we are referencing.
         */
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: ServerDeploymentGroupAttributes
        ): software.amazon.awscdk.services.codedeploy.ServerDeploymentGroupAttributes =
