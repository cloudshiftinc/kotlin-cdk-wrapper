...
internal constructor(
     ...
     * [Verifying a Domain](https://docs.aws.amazon.com/pinpoint/latest/userguide/channels-email-manage-verify.html#channels-email-manage-verify-domain)
    ...
    public interface Builder {
        /**
         * For domain identities, this attribute is used to enable or disable DomainKeys Identified
         * Mail (DKIM) signing for the domain.
         *
         * If the value is `true` , then the messages that you send from the domain are signed using
         * both the DKIM keys for your domain, as well as the keys for the `amazonses.com` domain.
         * If the value is `false` , then the messages that you send are only signed using the DKIM
         * keys for the `amazonses.com` domain.
         *
         ...
         *
         * @param dkimSigningEnabled For domain identities, this attribute is used to enable or
         *   disable DomainKeys Identified Mail (DKIM) signing for the domain.
         */
         ...
         * Used to enable or disable feedback forwarding for an identity.
         *
         * This setting determines what happens when an identity is used to send an email that
        ...
        /**
         * The address or domain of the identity, such as *sender&#64;example.com* or
         * *example.co.uk* .
         *
         ...
         *
         * @param tags An object that defines the tags (keys and values) that you want to associate
    ...
    public interface MailFromAttributesProperty {
         ...
         *
         * When you set this value to `UseDefaultValue` , Amazon Pinpoint uses *amazonses.com* as
         * the MAIL FROM domain. When you set this value to `RejectMessage` , Amazon Pinpoint
        ...
        public interface Builder {
            /**
             * @param behaviorOnMxFailure The action that Amazon Pinpoint to takes if it can't read
             *   the required MX record for a custom MAIL FROM domain. When you set this value to
            ...
            /**
             * @param mailFromDomain The name of a domain that an email identity uses as a custom
             *   MAIL FROM domain.
             */
        ...
        internal constructor(
             ...
             *
             * When you set this value to `UseDefaultValue` , Amazon Pinpoint uses *amazonses.com*
             * as the MAIL FROM domain. When you set this value to `RejectMessage` , Amazon Pinpoint
             * returns a `MailFromDomainNotVerified` error, and doesn't attempt to deliver the
             * email.
             *
             * These behaviors are taken when the custom MAIL FROM domain configuration is in the
             * `Pending` , `Failed` , and `TemporaryFailure` states.
