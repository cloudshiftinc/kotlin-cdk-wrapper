...
internal constructor(
    ...
    public interface Builder {
         ...
         * . To use resource-based permissions on supported AWS services, don't specify this
         * parameter.
         *
         ...
         * Supported only for HTTP API `AWS_PROXY` integrations.
         *
         * Specifies the AWS service action to invoke. To learn more, see
         ...
         * integration is also referred to as the HTTP custom integration. Supported only for
         * WebSocket APIs.
         *
         ...
         * listener, Network Load Balancer listener, or AWS Cloud Map service. If you specify the
         * ARN of an AWS Cloud Map service, API Gateway uses `DiscoverInstances` to identify
         * resources. You can use query parameters to target specific resources. To learn more, see
         ...
         *
         * @param passthroughBehavior Specifies the pass-through behavior for incoming requests
         *   based on the `Content-Type` header in the request, and the available mapping templates
        ...
        /**
         * For WebSocket APIs, a key-value map specifying request parameters that are passed from
         * the method request to the backend.
         *
         ...
         * name.
         *
         * For HTTP API integrations with a specified `integrationSubtype` , request parameters are
         * a key-value map specifying parameters that are passed to `AWS_PROXY` integrations. You
         * can provide static values, or map request data, stage variables, or context variables
         * that are evaluated at runtime. To learn more, see
         ...
         * .
         *
         * For HTTP API integrations without a specified `integrationSubtype` request parameters are
         * a key-value map specifying how to transform HTTP requests before sending them to the
         * backend. The key should follow the pattern
         * <action>:&lt;header|querystring|path&gt;.<location> where action can be `append` ,
         * `overwrite` or `remove` . For values, you can provide static values, or map request data,
         ...
         *
         * @param requestParameters For WebSocket APIs, a key-value map specifying request
         ...
         * before returning the response to clients. Specify a key-value map from a selection key to
         * response parameters. The selection key must be a valid HTTP status code within the range
         * of 200-599. The value is of type
         ...
         *
         * @param timeoutInMillis Custom timeout between 50 and 29,000 milliseconds for WebSocket
         *   APIs and between 50 and 30,000 milliseconds for HTTP APIs.
         */
    ...
    public interface ResponseParameterListProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ResponseParameterListProperty
            ): software.amazon.awscdk.services.apigatewayv2.CfnIntegration.ResponseParameterListProperty =
    ...
    public interface TlsConfigProperty {
        ...
        public interface Builder {
            /**
             * @param serverNameToVerify If you specify a server name, API Gateway uses it to verify
             *   the hostname on the integration's certificate. The server name is also included in
             *   the TLS handshake to support Server Name Indication (SNI) or virtual hosting.
             */
        ...
        internal constructor(
             ...
             * integration's certificate.
             *
             * The server name is also included in the TLS handshake to support Server Name
    ...
    public interface ResponseParameterProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ResponseParameterProperty
            ): software.amazon.awscdk.services.apigatewayv2.CfnIntegration.ResponseParameterProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
