...
internal constructor(
    ...
    public interface Builder {
         ...
         * should run after the data repository association is created.
         *
         ...
         * The path to the Amazon S3 data repository that will be linked to the file system.
         *
         * The path can be an S3 bucket or prefix in the format `s3://myBucket/myPrefix/` . This
         * path specifies where in the S3 data repository files will be imported from or exported
         * to.
         *
         ...
         *
         * @param dataRepositoryPath The path to the Amazon S3 data repository that will be linked
         *   to the file system.
         */
         ...
         * This file system directory can be linked to only one Amazon S3 bucket, and no other S3
         * bucket can be linked to the directory.
         *
         * If you specify only a forward slash ( `/` ) as the file system path, you can link only
         * one data repository to the file system. You can only specify "/" as the file system path
         ...
         *   high-level directory (such as `/ns1/` ) or subdirectory (such as `/ns1/subdir/` ) that
         ...
         *
         * @param importedFileChunkSize For files imported from a data repository, this value
         *   determines the stripe count and maximum amount of data per file (in MiB) stored on a
         ...
         * system with a data repository association.
         *
         * The configuration defines which file events (new, changed, or deleted files or
         * directories) are automatically imported from the linked data repository to the file
         * system or automatically exported from the file system to the data repository.
         *
         ...
         *
         * @param s3 The configuration for an Amazon S3 data repository linked to an Amazon FSx
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.fsx.CfnDataRepositoryAssociation.Builder.create(
                scope,
                id
            )
        ...
        override fun batchImportMetaDataOnCreate(batchImportMetaDataOnCreate: IResolvable) {
            cdkBuilder.batchImportMetaDataOnCreate(
                batchImportMetaDataOnCreate.let(IResolvable::unwrap)
            )
        }
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnDataRepositoryAssociation
    ...
    public interface S3Property {
         ...
         *
         * The `AutoExportPolicy` defines the types of updated objects on the file system that will
         * be automatically exported to the data repository. As you create, modify, or delete files,
         ...
         *
         * The `AutoExportPolicy` is only supported on Amazon FSx for Lustre file systems with a
         ...
         * listings up to date by importing changes to your Amazon FSx for Lustre file system as you
         * modify objects in a linked S3 bucket.
         *
         * The `AutoImportPolicy` is only supported on Amazon FSx for Lustre file systems with a
         * data repository association.
         *
        ...
        public interface Builder {
            /**
             * @param autoExportPolicy Describes a data repository association's automatic export
             *   policy. The `AutoExportPolicy` defines the types of updated objects on the file
             *   system that will be automatically exported to the data repository. As you create,
             *   modify, or delete files, Amazon FSx for Lustre automatically exports the defined
             *   changes asynchronously once your application finishes modifying the file.
             *
             * The `AutoExportPolicy` is only supported on Amazon FSx for Lustre file systems with a
             * data repository association.
             */
            ...
            public fun autoExportPolicy(
                autoExportPolicy: AutoExportPolicyProperty.Builder.() -> Unit
            )

            /**
             * @param autoImportPolicy Describes the data repository association's automatic import
             *   policy. The AutoImportPolicy defines how Amazon FSx keeps your file metadata and
             *   directory listings up to date by importing changes to your Amazon FSx for Lustre
             *   file system as you modify objects in a linked S3 bucket.
             *
             * The `AutoImportPolicy` is only supported on Amazon FSx for Lustre file systems with a
             * data repository association.
             */
            ...
            public fun autoImportPolicy(
                autoImportPolicy: AutoImportPolicyProperty.Builder.() -> Unit
            )
        }
        ...
        internal constructor(
             ...
             * Describes a data repository association's automatic export policy.
             *
             * The `AutoExportPolicy` defines the types of updated objects on the file system that
             ...
             *
             * The AutoImportPolicy defines how Amazon FSx keeps your file metadata and directory
             * listings up to date by importing changes to your Amazon FSx for Lustre file system as
    ...
    public interface AutoImportPolicyProperty {
         ...
         * * `NEW` - Amazon FSx automatically imports metadata of files added to the linked S3
         *   bucket that do not currently exist in the FSx file system.
         * * `CHANGED` - Amazon FSx automatically updates file metadata and invalidates existing
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AutoImportPolicyProperty
            ): software.amazon.awscdk.services.fsx.CfnDataRepositoryAssociation.AutoImportPolicyProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface AutoExportPolicyProperty {
        ...
        public interface Builder {
             ...
             * * `NEW` - New files and directories are automatically exported to the data repository
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AutoExportPolicyProperty
            ): software.amazon.awscdk.services.fsx.CfnDataRepositoryAssociation.AutoExportPolicyProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
