...
public open class CaaAmazonRecord
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.route53.CaaAmazonRecord,
) : CaaRecord(cdkObject) {
    /** A fluent builder for [io.cloudshiftdev.awscdk.services.route53.CaaAmazonRecord]. */
    @CdkDslMarker
    public interface Builder {
         ...
         * (dangerous!).
         *
         * This allows to deploy a new record set while minimizing the downtime because the new
         * record set will be created immediately after the existing one is deleted. It also avoids
         * "manual" actions to delete existing record sets.
         *
         * **N.B.:** this feature is dangerous, use with caution! It can only be used safely when
         * `deleteExisting` is set to `true` as soon as the resource is added to the stack. Changing
         * an existing Record Set's `deleteExisting` property from `false -&gt; true` after
         * deployment will delete the record!
         *
         * Default: false
         *
         * @param deleteExisting Whether to delete the same record set in the hosted zone if it
         *   already exists (dangerous!).
         */
        public fun deleteExisting(deleteExisting: Boolean)

        /**
         * The geographical origin for this record to return DNS records based on the user's
         * location.
         *
         * @param geoLocation The geographical origin for this record to return DNS records based on
         *   the user's location.
         */
        public fun geoLocation(geoLocation: GeoLocation)

        /**
         * A string used to distinguish between different records with the same combination of DNS
         * name and type.
         *
        ...
        /**
         * Whether to return multiple values, such as IP addresses for your web servers, in response
         * to DNS queries.
         *
         * Default: false
         *
         * @param multiValueAnswer Whether to return multiple values, such as IP addresses for your
        ...
        /**
         * The Amazon EC2 Region where you created the resource that this resource record set refers
         * to.
         *
         ...
         *
         * @param region The Amazon EC2 Region where you created the resource that this resource
        ...
        /**
         * Among resource record sets that have the same combination of DNS name and type, a value
         * that determines the proportion of DNS queries that Amazon Route 53 responds to using the
         ...
         *
         * @param weight Among resource record sets that have the same combination of DNS name and
         *   type, a value that determines the proportion of DNS queries that Amazon Route 53
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.route53.CaaAmazonRecord =
            cdkBuilder.build()
    }
    ...
    public companion object {
        ...
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.route53.CaaAmazonRecord
        ): CaaAmazonRecord = CaaAmazonRecord(cdkObject)

        internal fun unwrap(
            wrapped: CaaAmazonRecord
