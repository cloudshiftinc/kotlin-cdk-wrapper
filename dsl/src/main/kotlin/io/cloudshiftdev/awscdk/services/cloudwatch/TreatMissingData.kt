...
public enum class TreatMissingData(
    ...
    public companion object {
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.cloudwatch.TreatMissingData
        ): TreatMissingData =
            when (cdkObject) {
                ...
                software.amazon.awscdk.services.cloudwatch.TreatMissingData.IGNORE ->
