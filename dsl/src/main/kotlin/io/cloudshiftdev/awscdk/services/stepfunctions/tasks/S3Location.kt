...
internal constructor(
    ...
    public open fun bind(task: ISageMakerTask, opts: S3LocationBindOptions): S3LocationConfig =
        unwrap(this)
            .bind(task.let(ISageMakerTask::unwrap), opts.let(S3LocationBindOptions::unwrap))
            .let(S3LocationConfig::wrap)
    ...
    public open fun bind(
        task: ISageMakerTask,
        opts: S3LocationBindOptions.Builder.() -> Unit
    ...
    public companion object {
        public fun fromBucket(bucket: IBucket, keyPrefix: String): S3Location =
            software.amazon.awscdk.services.stepfunctions.tasks.S3Location.fromBucket(
        ...
        public fun fromJsonExpression(expression: String): S3Location =
            software.amazon.awscdk.services.stepfunctions.tasks.S3Location.fromJsonExpression(
                    expression
                )
                .let(S3Location::wrap)
