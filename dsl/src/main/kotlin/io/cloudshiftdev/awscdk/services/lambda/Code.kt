...
internal constructor(
    ...
    /**
     * Called after the CFN function resource has been created to allow the code class to bind to
     * it.
     *
     * Specifically it's required to allow assets to add metadata for tooling like SAM CLI to be
     * able to find their origins.
     *
     * @param _resource
     * @param _options
     */
    ...
    public open fun bindToResource(_resource: CfnResource, _options: ResourceBindOptions) {
        unwrap(this)
            .bindToResource(
                _resource.let(CfnResource::unwrap),
    ...
    public open fun bindToResource(
        _resource: CfnResource,
        _options: ResourceBindOptions.Builder.() -> Unit
    ): Unit = bindToResource(_resource, ResourceBindOptions(_options))

    private class Wrapper
    internal constructor(
        internal val cdkObject: software.amazon.awscdk.services.lambda.Code,
    ) : Code(cdkObject)
    ...
    public companion object {
        ...
        public fun fromAsset(path: String, options: AssetOptions): AssetCode =
            software.amazon.awscdk.services.lambda.Code.fromAsset(
                    path,
        ...
        public fun fromAssetImage(
            directory: String,
            props: AssetImageCodeProps.Builder.() -> Unit
        ): AssetImageCode = fromAssetImage(directory, AssetImageCodeProps(props))

        public fun fromBucket(bucket: IBucket, key: String): S3Code =
            software.amazon.awscdk.services.lambda.Code.fromBucket(bucket.let(IBucket::unwrap), key)
                .let(S3Code::wrap)
        ...
        public fun fromBucket(
            ...
            software.amazon.awscdk.services.lambda.Code.fromBucket(
        ...
        public fun fromCfnParameters(): CfnParametersCode =
            software.amazon.awscdk.services.lambda.Code.fromCfnParameters()
                .let(CfnParametersCode::wrap)

        public fun fromCfnParameters(props: CfnParametersCodeProps): CfnParametersCode =
            software.amazon.awscdk.services.lambda.Code.fromCfnParameters(
                    props.let(CfnParametersCodeProps::unwrap)
                )
                .let(CfnParametersCode::wrap)
        ...
        public fun fromCfnParameters(
            props: CfnParametersCodeProps.Builder.() -> Unit
        ...
        public fun fromDockerBuild(path: String, options: DockerBuildAssetOptions): AssetCode =
            software.amazon.awscdk.services.lambda.Code.fromDockerBuild(
                    path,
                    options.let(DockerBuildAssetOptions::unwrap)
                )
                .let(AssetCode::wrap)
        ...
        public fun fromDockerBuild(
            path: String,
            options: DockerBuildAssetOptions.Builder.() -> Unit
        ...
        public fun fromEcrImage(repository: IRepository): EcrImageCode =
            software.amazon.awscdk.services.lambda.Code.fromEcrImage(
                    repository.let(IRepository::unwrap)
                )
                .let(EcrImageCode::wrap)
        ...
        public fun fromEcrImage(
            ...
            props: EcrImageCodeProps.Builder.() -> Unit
        ...
        internal fun unwrap(wrapped: Code): software.amazon.awscdk.services.lambda.Code =
