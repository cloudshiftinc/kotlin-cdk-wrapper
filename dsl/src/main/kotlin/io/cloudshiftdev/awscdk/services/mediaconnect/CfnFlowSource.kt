...
internal constructor(
    ...
    public open fun gatewayBridgeSource(
        `value`: GatewayBridgeSourceProperty.Builder.() -> Unit
    ): Unit = gatewayBridgeSource(GatewayBridgeSourceProperty(`value`))
    ...
    public interface Builder {
         ...
         *
         * @param entitlementArn The ARN of the entitlement that allows you to subscribe to the
         *   flow.
         */
         ...
         *
         * @param gatewayBridgeSource The source configuration for cloud flows receiving a stream
         *   from a bridge.
         */
         ...
         * protocols.
         *
         * If you use failover with SRT caller or listener, the `FailoverMode` property must be set
         * to `FAILOVER` . The `FailoverMode` property is found in the `FailoverConfig` resource of
         * the same flow ARN you used for the source's `FlowArn` property. SRT caller/listener does
         * not support merge mode failover.
         *
         ...
         *
         * @param vpcInterfaceName The name of the VPC interface that you want to send your output
         *   to.
         */
