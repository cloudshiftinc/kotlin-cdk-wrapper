...
public interface WindowsUserDataOptions {
     ...
     *
     * allowing it to run on every instance start. By default, UserData is run only once during the
    ...
    public interface Builder {
         ...
         *   allowing it to run on every instance start. By default, UserData is run only once
         *   during the first instance launch.
         *
         * For more information, see:
         * https://aws.amazon.com/premiumsupport/knowledge-center/execute-user-data-ec2/
         * https://docs.aws.amazon.com/AWSEC2/latest/WindowsGuide/ec2-windows-user-data.html#user-data-scripts
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: WindowsUserDataOptions
