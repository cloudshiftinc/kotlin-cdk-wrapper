...
internal constructor(
    ...
    public interface Builder {
        ...
        /**
         * An array of structures that defines the metrics used for the experiment, and whether a
         * higher or lower value for each metric is the goal.
         *
         ...
         *
         * @param metricGoals An array of structures that defines the metrics used for the
         *   experiment, and whether a higher or lower value for each metric is the goal.
         */
         ...
         *
         * @param onlineAbConfig A structure that contains the configuration of which variation to
         *   use as the "control" version.
         */
         ...
         *
         * @param randomizationSalt When Evidently assigns a particular user session to an
         *   experiment, it must use a randomization ID to determine which variation the user
         *   session is served.
         */
         ...
         *
         * @param removeSegment Set this to `true` to remove the segment that is associated with
         *   this experiment.
         */
         ...
         * thousandths of a percent.
         *
         * The available audience is the total audience minus the audience that you have allocated
         * to overrides or current launches of this feature.
         *
         ...
         *
         * @param samplingRate The portion of the available audience that you want to allocate to
         *   this experiment, in thousandths of a percent.
         */
         ...
         * Specifies an audience *segment* to use in the experiment.
         *
         * When a segment is used in an experiment, only user sessions that match the segment
        ...
        /**
         * An array of structures that describe the configuration of each feature variation used in
         * the experiment.
         *
    ...
    private class BuilderImpl(
        ...
        override fun onlineAbConfig(
            onlineAbConfig: OnlineAbConfigObjectProperty.Builder.() -> Unit
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("02995d143134d43c96b097a1a914adef4caefd28099e90f563cf8211181a48c9")
        override fun runningStatus(
            runningStatus: RunningStatusObjectProperty.Builder.() -> Unit
        ): Unit = runningStatus(RunningStatusObjectProperty(runningStatus))
        ...
        public fun build(): software.amazon.awscdk.services.evidently.CfnExperiment =
            cdkBuilder.build()
    }
    ...
    public interface MetricGoalObjectProperty {
        ...
        /**
         * The entity, such as a user or session, that does an action that causes a metric value to
         * be recorded.
         *
        ...
        public interface Builder {
            /**
             * @param desiredChange `INCREASE` means that a variation with a higher number for this
             *   metric is performing better. `DECREASE` means that a variation with a lower number
             *   for this metric is performing better.
             */
            public fun desiredChange(desiredChange: String)

            /**
             * @param entityIdKey The entity, such as a user or session, that does an action that
             *   causes a metric value to be recorded. An example is `userDetails.userID` .
             */
            public fun entityIdKey(entityIdKey: String)

            /**
             * @param eventPattern The EventBridge event pattern that defines how the metric is
             *   recorded. For more information about EventBridge event patterns, see
             *   [Amazon EventBridge event patterns](https://docs.aws.amazon.com/eventbridge/latest/userguide/eb-event-patterns.html)
             *   .
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: MetricGoalObjectProperty
            ): software.amazon.awscdk.services.evidently.CfnExperiment.MetricGoalObjectProperty =
    ...
    public interface TreatmentToWeightProperty {
         ...
         *
         * Specify the traffic portion in thousandths of a percent, so 20,000 allocated to a
         * treatment would allocate 20% of the experiment traffic to that treatment.
         *
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TreatmentToWeightProperty
            ): software.amazon.awscdk.services.evidently.CfnExperiment.TreatmentToWeightProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface RunningStatusObjectProperty {
        /**
         * If you are using AWS CloudFormation to start the experiment, use this field to specify
         * when the experiment is to end.
         *
         * The format is as a UNIX timestamp. For more information about this format, see
        ...
        /**
         * If you are using AWS CloudFormation to stop this experiment, this is an optional field
         * that you can use to record why the experiment is being stopped or cancelled.
         *
        ...
        public interface Builder {
            /**
             * @param analysisCompleteTime If you are using AWS CloudFormation to start the
             *   experiment, use this field to specify when the experiment is to end. The format is
             *   as a UNIX timestamp. For more information about this format, see
             *   [The Current Epoch Unix Timestamp](https://docs.aws.amazon.com/https://www.unixtimestamp.com/index.php)
             *   .
             */
            ...
            /**
             * @param desiredState If you are using AWS CloudFormation to stop this experiment,
             *   specify either `COMPLETED` or `CANCELLED` here to indicate how to classify this
             *   experiment.
             */
             ...
             *   optional field that you can use to record why the experiment is being stopped or
             *   cancelled.
             */
            public fun reason(reason: String)

            /**
             * @param status To start the experiment now, specify `START` for this parameter. If
             *   this experiment is currently running and you want to stop it now, specify `STOP` .
             */
        ...
        internal constructor(
            ...
            /**
             * If you are using AWS CloudFormation to start the experiment, use this field to
             * specify when the experiment is to end.
             *
             * The format is as a UNIX timestamp. For more information about this format, see
             * [The Current Epoch Unix Timestamp](https://docs.aws.amazon.com/https://www.unixtimestamp.com/index.php)
             * .
            ...
            /**
             * If you are using AWS CloudFormation to stop this experiment, this is an optional
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RunningStatusObjectProperty
            ): software.amazon.awscdk.services.evidently.CfnExperiment.RunningStatusObjectProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface TreatmentObjectProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param treatmentName A name for this treatment. It can include up to 127 characters.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TreatmentObjectProperty
            ): software.amazon.awscdk.services.evidently.CfnExperiment.TreatmentObjectProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface OnlineAbConfigObjectProperty {
         ...
         * assigned to that treatment. Specify the traffic portion in thousandths of a percent, so
        ...
        public interface Builder {
            /**
             * @param controlTreatmentName The name of the variation that is to be the default
             *   variation that the other variations are compared to.
             */
            public fun controlTreatmentName(controlTreatmentName: String)

            /**
             * @param treatmentWeights A set of key-value pairs. The keys are treatment names, and
             *   the values are the portion of experiment traffic to be assigned to that treatment.
             *   Specify the traffic portion in thousandths of a percent, so 20,000 for a variation
        ...
        internal constructor(
             ...
             * A set of key-value pairs.
             *
             * The keys are treatment names, and the values are the portion of experiment traffic to
             * be assigned to that treatment. Specify the traffic portion in thousandths of a
             * percent, so 20,000 for a variation would allocate 20% of the experiment traffic to
             * that variation.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-evidently-experiment-onlineabconfigobject.html#cfn-evidently-experiment-onlineabconfigobject-treatmentweights)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: OnlineAbConfigObjectProperty
            ): software.amazon.awscdk.services.evidently.CfnExperiment.OnlineAbConfigObjectProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
