...
internal constructor(
    ...
    public open fun creditSpecification(
        `value`: CreditSpecificationProperty.Builder.() -> Unit
    ): Unit = creditSpecification(CreditSpecificationProperty(`value`))
    ...
    public open fun hibernationOptions(
        `value`: HibernationOptionsProperty.Builder.() -> Unit
    ): Unit = hibernationOptions(HibernationOptionsProperty(`value`))
    ...
    public open fun privateDnsNameOptions(
        `value`: PrivateDnsNameOptionsProperty.Builder.() -> Unit
    ...
    public interface Builder {
         ...
         * This property is reserved for internal use.
         *
         * If you use it, the stack fails with this error: `Bad property set:
         * [Testing this property] (Service: AmazonEC2; Status Code: 400; Error Code:
         ...
         * Indicates whether the instance is associated with a dedicated host.
         *
         * If you want the instance to always restart on the same host on which it was launched,
         * specify `host` . If you want the instance to restart on any available host, but try to
        ...
        /**
         * The block device mapping entries that defines the block devices to attach to the instance
         * at launch.
         *
         ...
         * For the root volume, you can override only the volume size, volume type, volume
         ...
         * for the attached volumes without interrupting the instance. Modifying any other parameter
         * results in instance
         ...
         *
         * @param blockDeviceMappings The block device mapping entries that defines the block
         *   devices to attach to the instance at launch.
         */
         ...
         *
         * @param disableApiTermination If you set this parameter to `true` , you can't terminate
         ...
         *
         * @param elasticInferenceAccelerators An elastic inference accelerator to associate with
         *   the instance.
         */
        ...
        /**
         * If you specify host for the `Affinity` property, the ID of a dedicated host that the
         * instance is associated with.
         *
         * If you don't specify an ID, Amazon EC2 launches the instance onto any available,
         * compatible dedicated host in your account. This type of launch is called an untargeted
         * launch. Note that for untargeted launches, you must have a compatible, dedicated host
         * available to successfully launch instances.
         *
         ...
         * with an instance store volume as the root volume is always replaced. For more
         * information, see
         ...
         *
         * @param ipv6AddressCount The number of IPv6 addresses to associate with the primary
         *   network interface.
         */
         ...
         *
         * @param ipv6Addresses The IPv6 addresses from the range of the subnet to associate with
         ...
         *
         * @param placementGroupName The name of an existing placement group that you want to launch
         *   the instance into (cluster | partition | spread).
         */
        ...
        /**
         * The primary IPv4 address. You must specify a value from the IPv4 address range of the
         * subnet.
         *
         ...
         * private IP address. During a replacement, AWS CloudFormation creates a new instance but
         * doesn't delete the old instance until the stack has successfully updated. If the stack
         ...
         *
         * @param propagateTagsToVolumeOnCreation Indicates whether to assign the tags from the
         *   instance to all of the volumes attached to the instance at launch.
         */
         ...
         * information about whether you need to specify a RAM disk. To find kernel requirements, go
        ...
        /**
         * [Default VPC] The names of the security groups. For a nondefault VPC, you must use
         ...
         *
         * @param securityGroups [Default VPC] The names of the security groups. For a nondefault
         ...
         * source or the destination of any traffic that it receives.
         *
         * If the value is `true` , source/destination checks are enabled; otherwise, they are
         * disabled. The default value is `true` . You must disable source/destination checks if the
         * instance runs services such as network address translation, routing, or firewalls.
         *
         ...
         *   [document](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ssm-document.html)
         *   and parameter values in AWS Systems Manager to associate with this instance. To use
         *   this property, you must specify an IAM instance profile role for the instance. For more
         *   information, see
         *   [Create an IAM instance profile for Systems Manager](https://docs.aws.amazon.com/systems-manager/latest/userguide/sysman-configuring-access-role.html)
         *   in the *AWS Systems Manager User Guide* .
         */
         ...
         * The parameters or scripts to store as user data.
         *
         * Any scripts in user data are run when you launch the instance. User data is limited to 16
         * KB. You must provide base64-encoded text. For more information, see
    ...
    private class BuilderImpl(
        ...
        override fun propagateTagsToVolumeOnCreation(propagateTagsToVolumeOnCreation: IResolvable) {
            cdkBuilder.propagateTagsToVolumeOnCreation(
                propagateTagsToVolumeOnCreation.let(IResolvable::unwrap)
            )
        }
    ...
    public interface CreditSpecificationProperty {
        ...
        public interface Builder {
            /**
             * @param cpuCredits The credit option for CPU usage of the instance. Valid values:
             *   `standard` | `unlimited`
             *
             * T3 instances with `host` tenancy do not support the `unlimited` CPU credit option.
             */
    ...
    public interface EbsProperty {
         ...
         *
         * If `KmsKeyId` is specified, the encrypted state must be `true` . If the encrypted state
         * is `true` but you do not specify `KmsKeyId` , your KMS key for EBS is used.
         *
         ...
         * in the *Amazon EC2 User Guide* . If the volume type is `io1` or `io2` , you must specify
        ...
        public interface Builder {
            ...
            /**
             * @param encrypted Indicates whether the volume should be encrypted. The effect of
             *   setting the encryption state to `true` depends on the volume origin (new or from a
             *   snapshot), starting encryption state, ownership, and whether encryption by default
             *   is enabled. For more information, see
             *   [Encryption by default](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/EBSEncryption.html#encryption-by-default)
             *   in the *Amazon Elastic Compute Cloud User Guide* .
             *
             ...
             *   If `KmsKeyId` is specified, the encrypted state must be `true` . If the encrypted
             *   state is `true` but you do not specify `KmsKeyId` , your KMS key for EBS is used.
             *
             * You can specify the KMS key using any of the following:
             * * Key ID. For example, 1234abcd-12ab-34cd-56ef-1234567890ab.
             * * Key alias. For example, alias/ExampleAlias.
            ...
            /**
             * @param snapshotId The ID of the snapshot. If you specify both `SnapshotId` and
        ...
        internal constructor(
             ...
             * The ID of the snapshot.
             *
             * If you specify both `SnapshotId` and `VolumeSize` , `VolumeSize` must be equal or
    ...
    public interface PrivateDnsNameOptionsProperty {
        ...
        public interface Builder {
             ...
             *   instance hostnames with DNS A records. For more information, see
             *   [Amazon EC2 instance hostname types](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-instance-naming.html)
             *   in the *Amazon Elastic Compute Cloud User Guide* .
             */
             ...
             *   for instance hostnames with DNS AAAA records. For more information, see
             *   [Amazon EC2 instance hostname types](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-instance-naming.html)
             *   in the *Amazon Elastic Compute Cloud User Guide* .
             */
            ...
            /**
             * @param hostnameType The type of hostnames to assign to instances in the subnet at
             *   launch. For IPv4 only subnets, an instance DNS name must be based on the instance
             *   IPv4 address. For IPv6 only subnets, an instance DNS name must be based on the
             *   instance ID. For dual-stack subnets, you can specify whether DNS names use the
             *   instance IPv4 address or the instance ID. For more information, see
             *   [Amazon EC2 instance hostname types](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-instance-naming.html)
             *   in the *Amazon Elastic Compute Cloud User Guide* .
             */
    ...
    public interface PrivateIpAddressSpecificationProperty {
        ...
        private class BuilderImpl : Builder {
            private val cdkBuilder:
                ...
                software.amazon.awscdk.services.ec2.CfnInstance
    ...
    public interface HibernationOptionsProperty {
        ...
        public interface Builder {
            /**
             * @param configured Set to `true` to enable your instance for hibernation. For Spot
             *   Instances, if you set `Configured` to `true` , either omit the
             *   `InstanceInterruptionBehavior` parameter (for
             *   [`SpotMarketOptions`](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_SpotMarketOptions.html)
             *   ), or set it to `hibernate` . When `Configured` is true:
             * * If you omit `InstanceInterruptionBehavior` , it defaults to `hibernate` .
    ...
    public interface NetworkInterfaceProperty {
         ...
         * Wavelength Zone. For more information about carrier IP addresses, see
         ...
         * IPv4 Address* tab on the [VPC pricing page](https://docs.aws.amazon.com/vpc/pricing/) .
         *
        ...
        public interface Builder {
            /**
             * @param associateCarrierIpAddress Indicates whether to assign a carrier IP address to
             *   the network interface. You can only assign a carrier IP address to a network
             ...
             *   an instance. Applies only if creating a network interface when launching an
             *   instance. The network interface must be the primary network interface. If launching
             ...
             *   the instance is terminated. Applies only if creating a network interface when
            ...
            /**
             * @param groupSet The IDs of the security groups for the network interface. Applies
            ...
            /**
             * @param privateIpAddress The private IPv4 address of the network interface. Applies
             *   only if creating a network interface when launching an instance.
             */
            public fun privateIpAddress(privateIpAddress: String)
        ...
        internal constructor(
             ...
             *
             * Applies only if creating a network interface when launching an instance. The network
             * interface must be the primary network interface. If launching into a default subnet,
    ...
    public interface AssociationParameterProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AssociationParameterProperty
            ): software.amazon.awscdk.services.ec2.CfnInstance.AssociationParameterProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface BlockDeviceMappingProperty {
         ...
         *
         * The name must be in the form `ephemeral` *X* where *X* is a number starting from zero
         * (0). For example, an instance type with 2 available instance store volumes can specify
         * mappings for `ephemeral0` and `ephemeral1` . The number of available instance store
         * volumes depends on the instance type. After you connect to the instance, you must mount
         * the volume.
         *
        ...
        public interface Builder {
             ...
             *   launched.
             *
             * After the instance is running, you can modify only the `DeleteOnTermination`
             * parameter for the attached volumes without interrupting the instance. Modifying any
             * other parameter results in instance
             * [replacement](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/using-cfn-updating-stacks-update-behaviors.html#update-no-interrupt)
             * .
             */
            ...
            /**
             * @param virtualName The virtual device name ( `ephemeral` N). The name must be in the
             *   form `ephemeral` *X* where *X* is a number starting from zero (0). For example, an
             *   instance type with 2 available instance store volumes can specify mappings for
             ...
             * block device mapping for the instance. When you launch an M3 instance, we ignore any
        ...
        internal constructor(
             ...
             *
             * The name must be in the form `ephemeral` *X* where *X* is a number starting from zero
             * (0). For example, an instance type with 2 available instance store volumes can
             * specify mappings for `ephemeral0` and `ephemeral1` . The number of available instance
             * store volumes depends on the instance type. After you connect to the instance, you
    ...
    public interface SsmAssociationProperty {
        ...
        public interface Builder {
            /**
             * @param associationParameters The input parameter values to use with the associated
             *   SSM document.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SsmAssociationProperty
            ): software.amazon.awscdk.services.ec2.CfnInstance.SsmAssociationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ElasticInferenceAcceleratorProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ElasticInferenceAcceleratorProperty
            ): software.amazon.awscdk.services.ec2.CfnInstance.ElasticInferenceAcceleratorProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
