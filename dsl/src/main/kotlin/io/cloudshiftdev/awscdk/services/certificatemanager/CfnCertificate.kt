...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * If you do not provide an ARN and you are trying to request a private certificate, ACM
         * will attempt to issue a public certificate. For more information about private CAs, see
         * the
         ...
         * resource by calling `UpdateCertificateOptions` on the certificate. This action will not
         ...
         *
         * @param certificateTransparencyLoggingPreference You can opt out of certificate
         *   transparency logging by specifying the `DISABLED` option. Opt in by specifying
         *   `ENABLED` .
         */
         ...
         *
         * @param domainName The fully qualified domain name (FQDN), such as www.example.com, with
         *   which you want to secure an ACM certificate. Use an asterisk (*) to create a wildcard
         ...
         * CloudFormation automatically, the `DomainName` property needs to be identical to one of
         * the `DomainName` property supplied in DomainValidationOptions, if the ValidationMethod is
         ...
         *
         * @param domainValidationOptions Domain information that domain name registrars use to
         ...
         * Algorithm (ECDSA) keys are smaller, offering security comparable to RSA keys but with
         * greater computing efficiency. However, ECDSA is not supported by all network clients.
         * Some AWS services may require RSA keys, or only support ECDSA keys of a particular size,
         * while others allow the use of either RSA and ECDSA keys to ensure that compatibility is
         * not broken. Check the requirements for the AWS service where you plan to deploy your
         ...
         * * `EC_secp384r1`
         *
         * Other listed algorithms are for imported certificates only. &gt; When you request a
         * private PKI certificate signed by a CA from AWS Private CA, the specified signing
        ...
        /**
         * The method you want to use to validate that you own or control the domain associated with
         ...
         *
         * @param validationMethod The method you want to use to validate that you own or control
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.certificatemanager.CfnCertificate.Builder.create(
                scope,
                id
            )
         ...
         *   `ENABLED` .
         */
        override fun certificateTransparencyLoggingPreference(
            certificateTransparencyLoggingPreference: String
        ) {
    ...
    public interface DomainValidationOptionProperty {
         ...
         * domain-validation options, and the `HostedZoneId` can be used only when `DNS` is
         ...
         * be the same as the `DomainName` value or a superdomain of the `DomainName` value. For
         * example, if you request a certificate for `testing.example.com` , you can specify
         * `example.com` as this value. In that case, ACM sends domain validation emails to the
        ...
        public interface Builder {
            ...
            /**
             * @param hostedZoneId The `HostedZoneId` option, which is available if you are using
             *   Route 53 as your domain registrar, causes ACM to add your CNAME to the domain
             *   record. Your list of `DomainValidationOptions` must contain one and only one of the
             *   domain-validation options, and the `HostedZoneId` can be used only when `DNS` is
             *   specified as your validation method.
             *
             * Use the Route 53 `ListHostedZones` API to discover IDs for available hosted zones.
            ...
            /**
             * @param validationDomain The domain name to which you want ACM to send validation
             *   emails. This domain name is the suffix of the email addresses that you want ACM to
             *   use. This must be the same as the `DomainName` value or a superdomain of the
             *   `DomainName` value. For example, if you request a certificate for
             *   `testing.example.com` , you can specify `example.com` as this value. In that case,
        ...
        internal constructor(
            ...
            /**
             * The `HostedZoneId` option, which is available if you are using Route 53 as your
             * domain registrar, causes ACM to add your CNAME to the domain record.
             *
             * Your list of `DomainValidationOptions` must contain one and only one of the
             * domain-validation options, and the `HostedZoneId` can be used only when `DNS` is
             * specified as your validation method.
             ...
             * The domain name to which you want ACM to send validation emails.
             *
             * This domain name is the suffix of the email addresses that you want ACM to use. This
             * must be the same as the `DomainName` value or a superdomain of the `DomainName`
             * value. For example, if you request a certificate for `testing.example.com` , you can
             * specify `example.com` as this value. In that case, ACM sends domain validation emails
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DomainValidationOptionProperty
            ): software.amazon.awscdk.services.certificatemanager.CfnCertificate.DomainValidationOptionProperty =
