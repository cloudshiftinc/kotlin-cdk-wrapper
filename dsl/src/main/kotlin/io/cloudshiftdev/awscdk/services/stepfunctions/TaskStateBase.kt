...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.stepfunctions.TaskStateBase,
    ...
    public open fun addCatch(
        handler: IChainable,
        props: CatchProps.Builder.() -> Unit
    ): TaskStateBase = addCatch(handler, CatchProps(props))
    ...
    internal constructor(
        internal val cdkObject: software.amazon.awscdk.services.stepfunctions.TaskStateBase,
