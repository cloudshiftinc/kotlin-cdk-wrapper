...
public interface IStateMachine : IResource, IGrantable {
    ...
    internal constructor(
        ...
        /**
         * Grant the given identity permissions to start a synchronous execution of this state
         * machine.
         *
         * @param identity The principal.
         */
        ...
        /**
         * Metric for the interval, in milliseconds, between the time the execution starts and the
         * time it closes.
         *
         * Default: - sum over 5 minutes
         *
