...
public interface IStateMachine : IResource, IGrantable {
  ...
  private class Wrapper internal constructor(
    ...
    public override fun grantExecution(arg0: IGrantable, arg1: String): Grant =
    ...
    public override fun grantStartExecution(arg0: IGrantable): Grant =
        unwrap(this).grantStartExecution(arg0.let(IGrantable::unwrap)).let(Grant::wrap)

    public override fun grantStartSyncExecution(arg0: IGrantable): Grant =
        unwrap(this).grantStartSyncExecution(arg0.let(IGrantable::unwrap)).let(Grant::wrap)

    public override fun grantTaskResponse(arg0: IGrantable): Grant =
