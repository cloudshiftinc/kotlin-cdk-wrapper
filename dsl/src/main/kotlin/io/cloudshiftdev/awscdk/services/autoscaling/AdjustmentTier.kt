...
public interface AdjustmentTier {
     ...
     *
     * The number is interpeted as an added capacity, a new fixed capacity or an added percentage
     * depending on the AdjustmentType value of the StepScalingPolicy.
     *
     ...
     *
     * The scaling tier applies if the difference between the metric value and its alarm threshold
    ...
    public interface Builder {
         ...
         *   added capacity, a new fixed capacity or an added percentage depending on the
         *   AdjustmentType value of the StepScalingPolicy.
         *
         * Can be positive or negative.
         */
        ...
        /**
         * @param lowerBound Lower bound where this scaling tier applies. The scaling tier applies
         *   if the difference between the metric value and its alarm threshold is higher than this
         *   value.
         */
        public fun lowerBound(lowerBound: Number)

        /**
         * @param upperBound Upper bound where this scaling tier applies. The scaling tier applies
         *   if the difference between the metric value and its alarm threshold is lower than this
         *   value.
         */
    ...
    internal constructor(
         ...
         * What number to adjust the capacity with.
         *
         * The number is interpeted as an added capacity, a new fixed capacity or an added
         * percentage depending on the AdjustmentType value of the StepScalingPolicy.
         *
         * Can be positive or negative.
         */
         ...
         * Lower bound where this scaling tier applies.
         *
         * The scaling tier applies if the difference between the metric value and its alarm
         * threshold is higher than this value.
         *
         * Default: -Infinity if this is the first tier, otherwise the upperBound of the previous
         * tier
         */
    ...
    public companion object {
        ...
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.autoscaling.AdjustmentTier
        ): AdjustmentTier = Wrapper(cdkObject)

        internal fun unwrap(
            wrapped: AdjustmentTier
