...
public interface ScalingInterval {
    ...
    public interface Builder {
        /**
         * @param change The capacity adjustment to apply in this interval. The number is
         *   interpreted differently based on AdjustmentType:
         * * ChangeInCapacity: add the adjustment to the current capacity. The number can be
        ...
        /**
         * @param lower The lower bound of the interval. The scaling adjustment will be applied if
         *   the metric is higher than this value.
         */
        public fun lower(lower: Number)

        /**
         * @param upper The upper bound of the interval. The scaling adjustment will be applied if
         *   the metric is lower than this value.
         */
    ...
    public companion object {
        ...
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.applicationautoscaling.ScalingInterval
        ): ScalingInterval = Wrapper(cdkObject)

        internal fun unwrap(
            wrapped: ScalingInterval
        ): software.amazon.awscdk.services.applicationautoscaling.ScalingInterval =
