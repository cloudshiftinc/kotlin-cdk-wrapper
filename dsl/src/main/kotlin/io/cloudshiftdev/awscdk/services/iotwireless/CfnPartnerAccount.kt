...
internal constructor(
    ...
    public open fun sidewalkResponse(`value`: SidewalkAccountInfoWithFingerprintProperty) {
        unwrap(this)
            .setSidewalkResponse(`value`.let(SidewalkAccountInfoWithFingerprintProperty::unwrap))
    }

    /** Information about a Sidewalk account. */
    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("8c1dc63264c77a2b76489797f4140defde3116748b7319db541327583e263e4c")
    public open fun sidewalkResponse(
        `value`: SidewalkAccountInfoWithFingerprintProperty.Builder.() -> Unit
    ...
    public open fun sidewalkUpdate(
        `value`: SidewalkUpdateAccountProperty.Builder.() -> Unit
    ): Unit = sidewalkUpdate(SidewalkUpdateAccountProperty(`value`))
    ...
    public interface Builder {
        ...
        public fun sidewalkResponse(
            sidewalkResponse: SidewalkAccountInfoWithFingerprintProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
         ...
         * @param sidewalkResponse Information about a Sidewalk account.
         */
        override fun sidewalkResponse(
            sidewalkResponse: SidewalkAccountInfoWithFingerprintProperty
        ) {
            cdkBuilder.sidewalkResponse(
                sidewalkResponse.let(SidewalkAccountInfoWithFingerprintProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("50b2293303e851fca1e139168d0d98b54e0595482e874cc4b549b2872c17248f")
        override fun sidewalkUpdate(
            sidewalkUpdate: SidewalkUpdateAccountProperty.Builder.() -> Unit
    ...
    public interface SidewalkUpdateAccountProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SidewalkUpdateAccountProperty
            ): software.amazon.awscdk.services.iotwireless.CfnPartnerAccount.SidewalkUpdateAccountProperty =
    ...
    public interface SidewalkAccountInfoWithFingerprintProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SidewalkAccountInfoWithFingerprintProperty
            ): software.amazon.awscdk.services.iotwireless.CfnPartnerAccount.SidewalkAccountInfoWithFingerprintProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SidewalkAccountInfoProperty {
         ...
         * way as you would an application password. You can protect the application server private
         * key by storing the value in the AWS Secrets Manager and use the
        ...
        public interface Builder {
            /**
             * @param appServerPrivateKey The Sidewalk application server private key. The
             *   application server private key is a secret key, which you should handle in a
             *   similar way as you would an application password. You can protect the application
             *   server private key by storing the value in the AWS Secrets Manager and use the
             *   [secretsmanager](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/dynamic-references.html#dynamic-references-secretsmanager)
             *   to reference this value.
             */
            public fun appServerPrivateKey(appServerPrivateKey: String)
        ...
        internal constructor(
             ...
             * The Sidewalk application server private key.
             *
             * The application server private key is a secret key, which you should handle in a
             * similar way as you would an application password. You can protect the application
             * server private key by storing the value in the AWS Secrets Manager and use the
             * [secretsmanager](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/dynamic-references.html#dynamic-references-secretsmanager)
             * to reference this value.
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SidewalkAccountInfoProperty
            ): software.amazon.awscdk.services.iotwireless.CfnPartnerAccount.SidewalkAccountInfoProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
