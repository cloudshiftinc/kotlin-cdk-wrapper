...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * A `Configuration` consists of one or more `ConfigurationItem` entries. For information
         * about service configurations for resource groups and how to construct them, see
         ...
         *
         * @param configuration The service configuration currently associated with the resource
         *   group and in effect for the members of the resource group.
         */
        ...
        /**
         * The resource query structure that is used to dynamically determine which AWS resources
         ...
         * * You can specify the group's membership either by using a `ResourceQuery` or by using a
         *   list of `Resources` , but not both.
         *
         ...
         *
         * @param resourceQuery The resource query structure that is used to dynamically determine
         ...
         * A list of the Amazon Resource Names (ARNs) of AWS resources that you want to add to the
         * specified group.
         * * You can specify the group membership either by using a list of `Resources` or by using
         *   a `ResourceQuery` , but not both.
         * * You can include a `Resources` property only if you also specify a `Configuration`
         *   property.
         *
         ...
         *
         * @param resources A list of the Amazon Resource Names (ARNs) of AWS resources that you
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.resourcegroups.CfnGroup =
            cdkBuilder.build()
    }
    ...
    public companion object {
        ...
        ): CfnGroup = CfnGroup(cdkObject)

        internal fun unwrap(
            wrapped: CfnGroup
        ): software.amazon.awscdk.services.resourcegroups.CfnGroup = wrapped.cdkObject
    }
    ...
    public interface ResourceQueryProperty {
         ...
         * * When the `Type` is `TAG_FILTERS_1_0` , you must specify a `Query` structure that
         *   contains a `TagFilters` list of tags. Resources with tags that match those in the
         *   `TagFilter` list become members of the resource group.
         * * When the `Type` is `CLOUDFORMATION_STACK_1_0` then this field is required only when you
         *   must specify a CloudFormation stack other than the one you are defining. To do this,
         *   the `Query` structure must contain the `StackIdentifier` property. If you don't specify
         *   either a `Query` structure or a `StackIdentifier` within that `Query` , then it
         *   defaults to the CloudFormation stack that you're currently constructing.
         *
        ...
        /**
         * Specifies the type of resource query that determines this group's membership. There are
         * two valid query types:.
         * * `TAG_FILTERS_1_0` indicates that the group is a tag-based group. To complete the group
         *   membership, you must include the `TagFilters` property to specify the tag filters to
         *   use in the query.
         * * `CLOUDFORMATION_STACK_1_0` , the default, indicates that the group is a CloudFormation
         *   stack-based group. Group membership is based on the CloudFormation stack. You must
         *   specify the `StackIdentifier` property in the query to define which stack to associate
         *   the group with, or leave it empty to default to the stack where the group is defined.
         *
        ...
        public interface Builder {
            /**
             * @param query The query that defines the membership of the group. This is a structure
             *   with properties that depend on the `Type` .
             *
             * The `Query` structure must be included in the following scenarios:
             * * When the `Type` is `TAG_FILTERS_1_0` , you must specify a `Query` structure that
             *   contains a `TagFilters` list of tags. Resources with tags that match those in the
             *   `TagFilter` list become members of the resource group.
             * * When the `Type` is `CLOUDFORMATION_STACK_1_0` then this field is required only when
             *   you must specify a CloudFormation stack other than the one you are defining. To do
             *   this, the `Query` structure must contain the `StackIdentifier` property. If you
             *   don't specify either a `Query` structure or a `StackIdentifier` within that `Query`
            ...
            /**
             * @param type Specifies the type of resource query that determines this group's
             *   membership. There are two valid query types:.
             * * `TAG_FILTERS_1_0` indicates that the group is a tag-based group. To complete the
             *   group membership, you must include the `TagFilters` property to specify the tag
             *   filters to use in the query.
             * * `CLOUDFORMATION_STACK_1_0` , the default, indicates that the group is a
             *   CloudFormation stack-based group. Group membership is based on the CloudFormation
             *   stack. You must specify the `StackIdentifier` property in the query to define which
             *   stack to associate the group with, or leave it empty to default to the stack where
    ...
    public interface QueryProperty {
         ...
         * , only EC2 instances or DynamoDB tables can be members of this resource group. The
         * default value is `["AWS::AllSupported"]` .
         *
         ...
         */
        public fun resourceTypeFilters(): List<String> =
         ...
         * you don't specify an ARN, this parameter defaults to the current stack that you are
         * defining, which means that all the resources of the current stack are grouped.
         *
        ...
        public interface Builder {
            /**
             * @param resourceTypeFilters Specifies limits to the types of resources that can be
             *   included in the resource group. For example, if `ResourceTypeFilters` is
             *   `["AWS::EC2::Instance", "AWS::DynamoDB::Table"]` , only EC2 instances or DynamoDB
             *   tables can be members of this resource group. The default value is
             *   `["AWS::AllSupported"]` .
             */
            ...
            /**
             * @param stackIdentifier Specifies the ARN of a CloudFormation stack. All supported
             *   resources of the CloudFormation stack are members of the resource group. If you
             *   don't specify an ARN, this parameter defaults to the current stack that you are
             *   defining, which means that all the resources of the current stack are grouped.
             *
             * You can specify a value for `StackIdentifier` only when the `ResourceQuery.Type`
             ...
             *   members of the resource group. This property is required when the
             *   `ResourceQuery.Type` property is `TAG_FILTERS_1_0` .
             *
        ...
        internal constructor(
            ...
            /**
             * Specifies limits to the types of resources that can be included in the resource
             * group.
             *
             * For example, if `ResourceTypeFilters` is `["AWS::EC2::Instance",
             * "AWS::DynamoDB::Table"]` , only EC2 instances or DynamoDB tables can be members of
             * this resource group. The default value is `["AWS::AllSupported"]` .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-resourcegroups-group-query.html#cfn-resourcegroups-group-query-resourcetypefilters)
             */
            override fun resourceTypeFilters(): List<String> =
                unwrap(this).getResourceTypeFilters() ?: emptyList()

            /**
             * Specifies the ARN of a CloudFormation stack.
             *
             * All supported resources of the CloudFormation stack are members of the resource
             * group. If you don't specify an ARN, this parameter defaults to the current stack that
             * you are defining, which means that all the resources of the current stack are
             * grouped.
             *
             * You can specify a value for `StackIdentifier` only when the `ResourceQuery.Type`
             * property is `CLOUDFORMATION_STACK_1_0.`
    ...
    public interface TagFilterProperty {
        ...
        public interface Builder {
            /**
             * @param key A string that defines a tag key. Only resources in the account that are
             *   tagged with a specified tag key are members of the tag-based resource group.
             *
             * This field is required when the `ResourceQuery` structure's `Type` property is
             * `TAG_FILTERS_1_0` . You must specify at least one tag key.
             */
            ...
            /**
             * @param values A list of tag values that can be included in the tag-based resource
             *   group. This is optional. If you don't specify a value or values for a key, then an
             *   AWS resource with any value for that key is a member.
             */
        ...
        internal constructor(
             ...
             * A string that defines a tag key.
             *
             * Only resources in the account that are tagged with a specified tag key are members of
             * the tag-based resource group.
             *
             * This field is required when the `ResourceQuery` structure's `Type` property is
             * `TAG_FILTERS_1_0` . You must specify at least one tag key.
             *
             ...
             * A list of tag values that can be included in the tag-based resource group.
             *
             * This is optional. If you don't specify a value or values for a key, then an AWS
    ...
    public interface ConfigurationItemProperty {
         ...
         *
         * Each item must have a unique value for type. For the list of the types that you can
         * specify for a configuration item, see
         * [Supported resource types and parameters](https://docs.aws.amazon.com/ARG/latest/APIReference/about-slg.html#about-slg-types)
         * in the *AWS Resource Groups User Guide* .
         *
        ...
        public interface Builder {
            /**
             * @param parameters A collection of parameters for this configuration item. For the
             *   list of parameters that you can use with each configuration item `Type` , see
             *   [Supported resource types and parameters](https://docs.aws.amazon.com/ARG/latest/APIReference/about-slg.html#about-slg-types)
             *   in the *AWS Resource Groups User Guide* .
             */
            ...
            /**
             * @param type Specifies the type of configuration item. Each item must have a unique
             *   value for type. For the list of the types that you can specify for a configuration
             *   item, see
             *   [Supported resource types and parameters](https://docs.aws.amazon.com/ARG/latest/APIReference/about-slg.html#about-slg-types)
             *   in the *AWS Resource Groups User Guide* .
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ConfigurationItemProperty
            ): software.amazon.awscdk.services.resourcegroups.CfnGroup.ConfigurationItemProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ConfigurationParameterProperty {
         ...
         *
         * For the list of values you can use with each parameter, see
         * [Supported resource types and parameters](https://docs.aws.amazon.com//ARG/latest/APIReference/about-slg.html#about-slg-types)
         * .
         *
        ...
        public interface Builder {
            /**
             * @param name The name of the group configuration parameter. For the list of parameters
             *   that you can use with each configuration item type, see
             *   [Supported resource types and parameters](https://docs.aws.amazon.com//ARG/latest/APIReference/about-slg.html#about-slg-types)
             *   in the *AWS Resource Groups User Guide* .
             */
            public fun name(name: String)
            ...
            /**
             * @param values The value or values to be used for the specified parameter. For the
             *   list of values you can use with each parameter, see
             *   [Supported resource types and parameters](https://docs.aws.amazon.com//ARG/latest/APIReference/about-slg.html#about-slg-types)
             *   .
             */
            public fun values(values: List<String>)
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ConfigurationParameterProperty
            ): software.amazon.awscdk.services.resourcegroups.CfnGroup.ConfigurationParameterProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
