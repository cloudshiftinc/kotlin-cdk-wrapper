...
public interface AddCapacityOptions :
    AddAutoScalingGroupCapacityOptions, CommonAutoScalingGroupProps {
     ...
     *
     * The default is to use an ECS-optimized AMI of Amazon Linux 2 which is automatically updated
     * to the latest version on every deployment. This will replace the instances in the
     * AutoScalingGroup. Make sure you have not disabled task draining, to avoid downtime when the
     * AMI updates.
     *
    ...
    public interface Builder {
         ...
         *   public IP addresses associated with them. `launchTemplate` and `mixedInstancesPolicy`
         ...
         *   specify virtual devices and EBS volumes. Each instance that is launched has an
         *   associated root device volume, either an Amazon EBS volume or an instance store volume.
         *   You can use block device mappings to specify additional EBS volumes or instance store
         *   volumes to attach to an instance when it is launched.
         *
        ...
        /**
         * @param capacityRebalance Indicates whether Capacity Rebalancing is enabled. When you turn
         *   on Capacity Rebalancing, Amazon EC2 Auto Scaling attempts to launch a Spot Instance
         ...
         *   finish initializing before Amazon EC2 Auto Scaling aggregates instance metrics,
         *   resulting in more reliable usage data. Set this value equal to the amount of time that
         *   it takes for resource consumption to become stable after an instance reaches the
         *   InService state.
         *
        ...
        /**
         * @param desiredCapacity Initial amount of instances in the fleet. If this is set to a
         *   number, every deployment will reset the amount of instances to this number. It is
         *   recommended to leave this value blank.
         */
         ...
         *   unchanged group sizes. Only used if the ASG has scheduled actions (which may scale your
         *   ASG up or down regardless of cdk deployments). If true, the size of the group will only
         *   be reset if it has been changed in the CDK app. If false, the sizes will always be
         *   changed back to what they were in the CDK app on deployment.
         */
         ...
         *   detailed or basic monitoring. When detailed monitoring is enabled, Amazon CloudWatch
         *   generates metrics every minute and your account is charged a fee. When you disable
         *   detailed monitoring, CloudWatch generates metrics every 5 minutes.
         *
         * `launchTemplate` and `mixedInstancesPolicy` must not be specified when this property is
         * specified
         */
         ...
         *   ECS-optimized AMI of Amazon Linux 2 which is automatically updated to the latest
         *   version on every deployment. This will replace the instances in the AutoScalingGroup.
         *   Make sure you have not disabled task draining, to avoid downtime when the AMI updates.
         *
         * To use an image that does not update on every deployment, pass:
         * ```
         * EcsOptimizedImage machineImage = EcsOptimizedImage.amazonLinux2(AmiHardwareType.STANDARD,
         ...
         *   different UserData will automatically be added to the `AutoScalingGroup` to configure
         *   it properly for use with ECS.
         *
         ...
         * `autoScalingGroup` via `addCapacity`, this value will be determined from the
         * `machineImage` you pass.
         */
         ...
         *   from termination by Amazon EC2 Auto Scaling when scaling in. By default, Auto Scaling
         *   can terminate an instance at any time after launch when scaling in an Auto Scaling
         *   Group, subject to the group's termination policy. However, you may wish to protect
         *   newly-launched instances from being scaled in if they are going to run critical
        ...
        /**
         * @param spotInstanceDraining Specify whether to enable Automated Draining for Spot
         *   Instances running Amazon ECS Services. For more information, see
         ...
         *   launched to fulfill the request. Spot Instances are launched when the price you specify
         *   exceeds the current Spot market price.
         *
         * `launchTemplate` and `mixedInstancesPolicy` must not be specified when this property is
         * specified
         */
        ...
        /**
         * @param ssmSessionPermissions Add SSM session permissions to the instance role. Setting
         *   this to `true` adds the necessary permissions to connect to the instance using SSM
         ...
         *   a custom termination policy to select the instances to terminate. This property must be
         *   specified if the TerminationPolicy.CUSTOM_LAMBDA_FUNCTION is used.
         */
        ...
        /**
         * @param topicEncryptionKey If `AddAutoScalingGroupCapacityOptions.taskDrainTime` is
         *   non-zero, then the ECS cluster creates an SNS Topic to as part of a system to drain
         *   instances of tasks when the instance is being shut down. If this property is provided,
         *   then this key will be used to encrypt the contents of that SNS Topic. See
         ...
         *   changed. This is applied when any of the settings on the ASG are changed that affect
         *   how the instances should be created (VPC, instance type, startup scripts, etc.). It
         *   indicates how the existing instances should be replaced with new instances matching the
         *   new config. By default, nothing is done and only new instances are launched with the
         *   new config.
         */
    ...
    private class BuilderImpl : Builder {
        ...
        public fun build(): software.amazon.awscdk.services.ecs.AddCapacityOptions =
            cdkBuilder.build()
    }
    ...
    internal constructor(
         ...
         */
        override fun associatePublicIpAddress(): Boolean? =
         ...
         * The ECS-optimized AMI variant to use.
         *
         * The default is to use an ECS-optimized AMI of Amazon Linux 2 which is automatically
         * updated to the latest version on every deployment. This will replace the instances in the
         * AutoScalingGroup. Make sure you have not disabled task draining, to avoid downtime when
         * the AMI updates.
         *
         * To use an image that does not update on every deployment, pass:
         * ```
        ...
        /**
         * Specify whether to enable Automated Draining for Spot Instances running Amazon ECS
         * Services.
         *
         ...
         * creates an SNS Topic to as part of a system to drain instances of tasks when the instance
         * is being shut down. If this property is provided, then this key will be used to encrypt
         * the contents of that SNS Topic. See
         * [SNS Data Encryption](https://docs.aws.amazon.com/sns/latest/dg/sns-data-encryption.html)
         * for more information.
         *
         * Default: The SNS Topic will not be encrypted.
         */
        override fun topicEncryptionKey(): IKey? =
