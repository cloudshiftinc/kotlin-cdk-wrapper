...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.apigatewayv2.HttpApi,
    ...
    public interface Builder {
        ...
        /**
         * Default OIDC scopes attached to all routes in the gateway, unless explicitly configured
         * on the route.
         *
         ...
         *
         * @param defaultAuthorizationScopes Default OIDC scopes attached to all routes in the
         *   gateway, unless explicitly configured on the route.
         */
         ...
         * `false`.
         *
         * @param defaultDomainMapping Configure a custom domain with the API mapping resource to
         *   the HTTP API.
         */
        ...
        public fun defaultDomainMapping(
            defaultDomainMapping: DomainMappingOptions.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("e4e313d90125e87c17209fe208803ecae8b7e44459880754b625235c1f04ac4e")
        override fun defaultDomainMapping(
            defaultDomainMapping: DomainMappingOptions.Builder.() -> Unit
        ...
        public fun build(): software.amazon.awscdk.services.apigatewayv2.HttpApi =
            cdkBuilder.build()
    }
    ...
    public companion object {
        public fun fromHttpApiAttributes(
            ...
            software.amazon.awscdk.services.apigatewayv2.HttpApi.fromHttpApiAttributes(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    attrs.let(HttpApiAttributes::unwrap)
                )
                .let(IHttpApi::wrap)
        ...
        ): HttpApi = HttpApi(cdkObject)

        internal fun unwrap(
            wrapped: HttpApi
        ): software.amazon.awscdk.services.apigatewayv2.HttpApi = wrapped.cdkObject
    }
}
