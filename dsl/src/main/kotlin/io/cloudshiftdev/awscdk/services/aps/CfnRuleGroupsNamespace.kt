...
internal constructor(
    ...
    public interface Builder {
         ...
         * The rules file used in the namespace.
         *
         * For more details about the rules file, see
         * [Creating a rules file](https://docs.aws.amazon.com/prometheus/latest/userguide/AMP-ruler-rulesfile.html)
         ...
         *
         * @param workspace An Amazon Managed Service for Prometheus workspace is a logical and
         *   isolated Prometheus server dedicated to ingesting, storing, and querying your
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnRuleGroupsNamespace
