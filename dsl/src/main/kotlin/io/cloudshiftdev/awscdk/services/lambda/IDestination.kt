...
public interface IDestination {
    ...
    internal constructor(
        ...
        override fun bind(scope: Construct, fn: IFunction): DestinationConfig =
            unwrap(this)
                .bind(scope.let(Construct::unwrap), fn.let(IFunction::unwrap))
                .let(DestinationConfig::wrap)
        ...
        override fun bind(
            ...
            unwrap(this)
                .bind(
                    ...
                    options.let(DestinationOptions::unwrap)
                )
                .let(DestinationConfig::wrap)
    ...
    public companion object {
        ...
        ): IDestination = Wrapper(cdkObject)

        internal fun unwrap(
            wrapped: IDestination
        ): software.amazon.awscdk.services.lambda.IDestination = (wrapped as Wrapper).cdkObject
    }
}
