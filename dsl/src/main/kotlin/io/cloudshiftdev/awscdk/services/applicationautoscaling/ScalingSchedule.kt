...
public interface ScalingSchedule {
     ...
     *
     * During the scheduled time, the current capacity is above the maximum capacity, Application
     ...
     *
     * During the scheduled time, if the current capacity is below the minimum capacity, Application
     * Auto Scaling scales out to the minimum capacity.
     *
     * At least one of maxCapacity and minCapacity must be supplied.
     *
    ...
    public interface Builder {
        ...
        /**
         * @param maxCapacity The new maximum capacity. During the scheduled time, the current
         ...
         *   capacity is below the minimum capacity, Application Auto Scaling scales out to the
         *   minimum capacity.
         *
         * At least one of maxCapacity and minCapacity must be supplied.
         */
    ...
    internal constructor(
         ...
         * The new maximum capacity.
         *
         * During the scheduled time, the current capacity is above the maximum capacity,
