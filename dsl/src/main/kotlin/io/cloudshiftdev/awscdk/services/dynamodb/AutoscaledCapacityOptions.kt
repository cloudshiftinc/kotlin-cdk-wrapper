...
public interface AutoscaledCapacityOptions {
    ...
    public interface Builder {
         ...
         *   provisioned or from provisioned to on-demand, you must specify a value for this
         *   property for each autoscaled resource.
         */
        public fun seedCapacity(seedCapacity: Number)

        /**
         * @param targetUtilizationPercent The ratio of consumed capacity units to provisioned
         *   capacity units. Note: Target utilization percent cannot be less than 20 and cannot be
         *   greater than 90.
         */
    ...
    internal constructor(
         ...
         * Default: 70
         */
        override fun targetUtilizationPercent(): Number? =
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: AutoscaledCapacityOptions
