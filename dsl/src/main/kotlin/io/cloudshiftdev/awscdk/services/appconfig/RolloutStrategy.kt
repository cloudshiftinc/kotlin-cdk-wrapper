...
internal constructor(
    ...
    public open fun finalBakeTime(): Duration? =
    ...
    public companion object {
        public fun exponential(props: RolloutStrategyProps): RolloutStrategy =
            software.amazon.awscdk.services.appconfig.RolloutStrategy.exponential(
                    props.let(RolloutStrategyProps::unwrap)
                )
                .let(RolloutStrategy::wrap)
        ...
        public fun linear(props: RolloutStrategyProps): RolloutStrategy =
            software.amazon.awscdk.services.appconfig.RolloutStrategy.linear(
                    props.let(RolloutStrategyProps::unwrap)
                )
                .let(RolloutStrategy::wrap)
