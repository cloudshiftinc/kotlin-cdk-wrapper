...
public interface IFairshareSchedulingPolicy : ISchedulingPolicy {
    ...
    internal constructor(
         ...
         *
         * The percentage reserved is defined by the Scheduler as:
         * `(computeReservation/100)^ActiveFairShares` where `ActiveFairShares` is the number of
         * active fair share identifiers.
         *
         ...
         * maximum available vCPU if there's only one fair share identifier, 6.25% if there are two
         ...
         *
         * The usage is used to calculate a fair share percentage for each fair share identifier
         * currently in the Queue. A value of zero (0) indicates that only current usage is
         * measured. The decay is linear and gives preference to newer jobs.
         *
         * The maximum supported value is 604800 seconds (1 week).
         *
         * Default: - 0: only the current job usage is considered
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: IFairshareSchedulingPolicy
