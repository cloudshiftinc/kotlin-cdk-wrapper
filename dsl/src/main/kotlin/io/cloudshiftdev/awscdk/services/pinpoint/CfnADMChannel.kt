...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.pinpoint.CfnADMChannel,
    ...
    public interface Builder {
         ...
         *
         * @param clientId The Client ID that you received from Amazon to send messages by using
         *   ADM.
         */
         ...
         *
         * @param clientSecret The Client Secret that you received from Amazon to send messages by
         *   using ADM.
         */
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.pinpoint.CfnADMChannel =
            cdkBuilder.build()
    }
