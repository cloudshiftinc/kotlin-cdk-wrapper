...
public interface IHostedZone : IResource {
     ...
     * another stack.
     */
    public fun hostedZoneNameServers(): List<String> =
    ...
    public companion object {
        ...
        ): IHostedZone = Wrapper(cdkObject)

        internal fun unwrap(
            wrapped: IHostedZone
        ): software.amazon.awscdk.services.route53.IHostedZone = (wrapped as Wrapper).cdkObject
    }
}
