...
public interface ICertificate : IResource {
    ...
    internal constructor(
        ...
        /**
         * Return the DaysToExpiry metric for this AWS Certificate Manager Certificate. By default,
         * this is the minimum value over 1 day.
         *
         * This metric is no longer emitted once the certificate has effectively expired, so alarms
         * configured on this metric should probably treat missing data as "breaching".
         *
         * @param props
         */
        override fun metricDaysToExpiry(): Metric =
