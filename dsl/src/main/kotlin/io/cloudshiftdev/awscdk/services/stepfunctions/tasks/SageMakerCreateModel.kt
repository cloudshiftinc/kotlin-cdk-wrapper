...
internal constructor(
    ...
    public interface Builder {
        ...
        /**
         * The definition of the primary docker image containing inference code, associated
         * artifacts, and custom environment map that the inference code uses when the model is
         * deployed for predictions.
         *
         * @param primaryContainer The definition of the primary docker image containing inference
        ...
        /**
         * The subnets of the VPC to which the hosted model is connected (Note this parameter is
         * only used when VPC is provided).
         *
         * Default: - Private Subnets are selected
         *
         * @param subnetSelection The subnets of the VPC to which the hosted model is connected
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.stepfunctions.tasks.SageMakerCreateModel.Builder.create(
                scope,
                id
            )
