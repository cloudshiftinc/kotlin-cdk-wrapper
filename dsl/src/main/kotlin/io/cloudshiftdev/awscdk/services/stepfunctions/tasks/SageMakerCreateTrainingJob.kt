...
internal constructor(
    ...
    public interface Builder {
        ...
        public fun algorithmSpecification(
            algorithmSpecification: AlgorithmSpecification.Builder.() -> Unit
        )
         ...
         *
         * Set hyperparameters before you start the learning process. For a list of hyperparameters
         ...
         *
         * @param hyperparameters Algorithm-specific parameters that influence the quality of the
         *   model.
         */
         ...
         * where stored.
         *
         * @param inputDataConfig Describes the various datasets (e.g. train, validation, test) and
         *   the Amazon S3 location where stored.
         */
         ...
         * model training.
         *
         * @param outputDataConfig Identifies the Amazon S3 location where you want Amazon SageMaker
         ...
         *
         * @param resourceConfig Specifies the resources, ML compute instances, and ML storage
         *   volumes to deploy for model training.
         */
         ...
         *
         * The role must be granted all necessary permissions for the SageMaker training job to be
         * able to operate.
         *
         * See
    ...
    private class BuilderImpl(
        ...
        override fun algorithmSpecification(algorithmSpecification: AlgorithmSpecification) {
            cdkBuilder.algorithmSpecification(
                algorithmSpecification.let(AlgorithmSpecification::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("85e6251e82851749ffbb8345476f4721b28659397b56857d25217c9023ed399d")
        override fun algorithmSpecification(
            algorithmSpecification: AlgorithmSpecification.Builder.() -> Unit
        ...
        override fun stoppingCondition(
            stoppingCondition: StoppingCondition.Builder.() -> Unit
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: SageMakerCreateTrainingJob
        ): software.amazon.awscdk.services.stepfunctions.tasks.SageMakerCreateTrainingJob =
            wrapped.cdkObject
    }
}
