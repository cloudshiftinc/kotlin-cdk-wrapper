...
internal constructor(
    ...
    public companion object {
        public fun at(moment: Instant): Schedule =
            software.amazon.awscdk.services.applicationautoscaling.Schedule.at(moment)
                .let(Schedule::wrap)

        public fun cron(options: CronOptions): Schedule =
            software.amazon.awscdk.services.applicationautoscaling.Schedule.cron(
        ...
        public fun expression(expression: String): Schedule =
            software.amazon.awscdk.services.applicationautoscaling.Schedule.expression(expression)
                .let(Schedule::wrap)

        public fun rate(duration: Duration): Schedule =
            software.amazon.awscdk.services.applicationautoscaling.Schedule.rate(
                    duration.let(Duration::unwrap)
                )
                .let(Schedule::wrap)

        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.applicationautoscaling.Schedule
