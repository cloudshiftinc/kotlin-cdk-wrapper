...
internal constructor(
    ...
    public companion object {
        public fun fromDeploymentStrategyArn(
            ...
            software.amazon.awscdk.services.appconfig.DeploymentStrategy.fromDeploymentStrategyArn(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    deploymentStrategyArn
                )
                .let(IDeploymentStrategy::wrap)
        ...
        public fun fromDeploymentStrategyId(
            ...
            software.amazon.awscdk.services.appconfig.DeploymentStrategy.fromDeploymentStrategyId(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    deploymentStrategyId.let(DeploymentStrategyId::unwrap)
                )
                .let(IDeploymentStrategy::wrap)
