...
public enum class ProcessorMode(
  ...
  public companion object {
    internal fun wrap(cdkObject: software.amazon.awscdk.services.stepfunctions.ProcessorMode):
        ProcessorMode = when (cdkObject) {
      software.amazon.awscdk.services.stepfunctions.ProcessorMode.INLINE -> ProcessorMode.INLINE
      software.amazon.awscdk.services.stepfunctions.ProcessorMode.DISTRIBUTED ->
          ProcessorMode.DISTRIBUTED
    }

    internal fun unwrap(wrapped: ProcessorMode):
