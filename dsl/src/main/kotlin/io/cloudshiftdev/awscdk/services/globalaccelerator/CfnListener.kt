...
internal constructor(
    ...
    public interface Builder {
         ...
         * "two-tuple" (2-tuple) properties— source (client) IP address and destination IP
         ...
         *
         * @param clientAffinity Client affinity lets you direct all requests from a user to the
         *   same endpoint, if you have stateful applications, regardless of the port and protocol
