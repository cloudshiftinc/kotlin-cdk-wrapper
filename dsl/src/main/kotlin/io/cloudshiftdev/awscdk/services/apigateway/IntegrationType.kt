...
public enum class IntegrationType(
    ...
    public companion object {
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.apigateway.IntegrationType
        ): IntegrationType =
            when (cdkObject) {
                software.amazon.awscdk.services.apigateway.IntegrationType.AWS ->
                    IntegrationType.AWS
                software.amazon.awscdk.services.apigateway.IntegrationType.AWS_PROXY ->
                    IntegrationType.AWS_PROXY
                software.amazon.awscdk.services.apigateway.IntegrationType.HTTP ->
                    IntegrationType.HTTP
                software.amazon.awscdk.services.apigateway.IntegrationType.HTTP_PROXY ->
                    IntegrationType.HTTP_PROXY
                software.amazon.awscdk.services.apigateway.IntegrationType.MOCK ->
                    IntegrationType.MOCK
            }

        internal fun unwrap(
            wrapped: IntegrationType
