...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * If you specify a dataset import job as part of a dataset, all dataset import job fields
         * are required.
         *
         ...
         *
         * @param datasetImportJob Describes a job that imports training data from a data source
    ...
    private class BuilderImpl(
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("00047c50505b44a350b3b5aa2091fd9d26178e854fdd5befa5ed5863515933a6")
        override fun datasetImportJob(
            datasetImportJob: DatasetImportJobProperty.Builder.() -> Unit
        ...
        public fun build(): software.amazon.awscdk.services.personalize.CfnDataset =
            cdkBuilder.build()
    }
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnDataset
        ): software.amazon.awscdk.services.personalize.CfnDataset = wrapped.cdkObject
    }
    ...
    public interface DataSourceProperty {
        ...
        public interface Builder {
            /**
             * @param dataLocation The path to the Amazon S3 bucket where the data that you want to
    ...
    public interface DatasetImportJobProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param datasetArn The Amazon Resource Name (ARN) of the dataset that receives the
             *   imported data.
             */
            ...
            /**
             * @param roleArn The ARN of the IAM role that has permissions to read from the Amazon
             *   S3 data source.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DatasetImportJobProperty
            ): software.amazon.awscdk.services.personalize.CfnDataset.DatasetImportJobProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
