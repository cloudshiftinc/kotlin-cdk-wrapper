...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param filterAction The action that is to be applied to the findings that match the
         *   filter.
         */
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.inspectorv2.CfnFilter =
            cdkBuilder.build()
    }
    ...
    public companion object {
        ...
        ): CfnFilter = CfnFilter(cdkObject)

        internal fun unwrap(
            wrapped: CfnFilter
        ): software.amazon.awscdk.services.inspectorv2.CfnFilter = wrapped.cdkObject
    }
    ...
    public interface FilterCriteriaProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param ec2InstanceSubnetId Details of the Amazon EC2 instance subnet IDs used to
             *   filter findings.
             */
            ...
            /**
             * @param ec2InstanceVpcId Details of the Amazon EC2 instance VPC IDs used to filter
             *   findings.
             */
            ...
            /**
             * @param ecrImageArchitecture Details of the Amazon ECR image architecture types used
             *   to filter findings.
             */
            ...
            /**
             * @param ecrImagePushedAt Details on the Amazon ECR image push date and time used to
             *   filter findings.
             */
            ...
            /**
             * @param ecrImageRepositoryName Details on the name of the Amazon ECR repository used
             *   to filter findings.
             */
            ...
            /**
             * @param firstObservedAt Details on the date and time a finding was first seen used to
             *   filter findings.
             */
            ...
            /**
             * @param lastObservedAt Details on the date and time a finding was last seen used to
             *   filter findings.
             */
            ...
            /**
             * @param updatedAt Details on the date and time a finding was last updated at used to
             *   filter findings.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            /** @param componentId Details of the component IDs used to filter findings. */
            override fun componentId(vararg componentId: Any): Unit =
                componentId(componentId.toList())
            ...
            /** @param findingType Details on the finding types used to filter findings. */
            override fun findingType(vararg findingType: Any): Unit =
                findingType(findingType.toList())
    ...
    public interface DateFilterProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param startInclusive A timestamp representing the start of the time period filtered
             *   on.
             */
    ...
    public interface PackageFilterProperty {
        ...
        public interface Builder {
            /**
             * @param architecture An object that contains details on the package architecture type
             *   to filter on.
             */
            ...
            /**
             * @param sourceLayerHash An object that contains details on the source layer hash to
             *   filter on.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("098e3d951d4bdc7c46fccdcee88664e4e900a0284195fe680536266cf4f89e98")
            override fun sourceLayerHash(
                sourceLayerHash: StringFilterProperty.Builder.() -> Unit
    ...
    public interface PortRangeFilterProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: PortRangeFilterProperty
            ): software.amazon.awscdk.services.inspectorv2.CfnFilter.PortRangeFilterProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
