...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param attributeDetails Mathematical expression and a list of attribute items specified
         *   in that expression.
         */
    ...
    private class BuilderImpl(
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("3881dc042b395f90daa320a565b09de633274397edc76dc644a9b702387a2365")
        override fun attributeDetails(
            attributeDetails: AttributeDetailsProperty.Builder.() -> Unit
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnCalculatedAttributeDefinition
        ): software.amazon.awscdk.services.customerprofiles.CfnCalculatedAttributeDefinition =
            wrapped.cdkObject
    }
    ...
    public interface AttributeDetailsProperty {
        ...
        public interface Builder {
            /**
             * @param attributes Mathematical expression and a list of attribute items specified in
             *   that expression.
             */
            ...
            /**
             * @param expression Mathematical expression that is performed on attribute items
             *   provided in the attribute list. Each element in the expression should follow the
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AttributeDetailsProperty
            ): software.amazon.awscdk.services.customerprofiles.CfnCalculatedAttributeDefinition.AttributeDetailsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
