...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param trustAnchorArn The ARN of the TrustAnchor the certificate revocation list (CRL)
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.rolesanywhere.CfnCRL =
            cdkBuilder.build()
    }
