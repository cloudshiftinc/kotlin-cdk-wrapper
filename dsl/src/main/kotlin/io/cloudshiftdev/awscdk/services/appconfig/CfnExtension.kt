...
internal constructor(
    ...
    public interface Builder {
         ...
         * You can omit this field when you create an extension.
         *
         * When you create a new version, specify the most recent current version number. For
         ...
         * The parameters accepted by the extension.
         *
         * You specify parameter values when you associate the extension to an AWS AppConfig
         * resource by using the `CreateExtensionAssociation` API action. For AWS Lambda extension
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.appconfig.CfnExtension =
            cdkBuilder.build()
    }
    ...
    public interface ActionProperty {
         ...
         * function, an Amazon Simple Queue Service queue, an Amazon Simple Notification Service
         * topic, or the Amazon EventBridge default event bus.
         *
        ...
        public interface Builder {
            ...
            /**
             * @param roleArn An Amazon Resource Name (ARN) for an AWS Identity and Access
             *   Management assume role.
             */
            public fun roleArn(roleArn: String)

            /**
             * @param uri The extension URI associated to the action point in the extension
             *   definition. The URI can be an Amazon Resource Name (ARN) for one of the following:
             *   an AWS Lambda function, an Amazon Simple Queue Service queue, an Amazon Simple
