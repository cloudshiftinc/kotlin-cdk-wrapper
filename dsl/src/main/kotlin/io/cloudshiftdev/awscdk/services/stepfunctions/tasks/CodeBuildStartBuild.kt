...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.CodeBuildStartBuild,
    ...
    public interface Builder {
         ...
         *
         * @param environmentVariablesOverride A set of environment variables to be used for this
         *   build only.
         */
        public fun environmentVariablesOverride(
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.stepfunctions.tasks.CodeBuildStartBuild.Builder.create(
                scope,
                id
            )
         ...
         *   build only.
         */
        override fun environmentVariablesOverride(
            environmentVariablesOverride: Map<String, BuildEnvironmentVariable>
        ) {
            cdkBuilder.environmentVariablesOverride(
                environmentVariablesOverride.mapValues { BuildEnvironmentVariable.unwrap(it.value) }
            )
        }
