...
public interface IVpc : IResource {
     ...
     * @param options
     */
    public fun addClientVpnEndpoint(
        id: String,
     ...
     * @param options
     */
    public fun addInterfaceEndpoint(
        id: String,
    ...
    internal constructor(
         ...
         * @param options
         */
        override fun addClientVpnEndpoint(
            id: String,
            options: ClientVpnEndpointOptions
        ): ClientVpnEndpoint =
            unwrap(this)
         ...
         * @param options
         */
        override fun addFlowLog(id: String): FlowLog =
         ...
         * @param options
         */
        override fun addGatewayEndpoint(
            id: String,
            options: GatewayVpcEndpointOptions
        ): GatewayVpcEndpoint =
            unwrap(this)
         ...
         * @param options
         */
        override fun addInterfaceEndpoint(
            id: String,
            options: InterfaceVpcEndpointOptions
        ): InterfaceVpcEndpoint =
            unwrap(this)
        ...
        /**
         * Dependable that can be depended upon to force internet connectivity established on the
         * VPC.
         */
        ...
        /** List of public subnets in this VPC. */
        override fun publicSubnets(): List<ISubnet> =
            unwrap(this).getPublicSubnets().map(ISubnet::wrap)

        /**
         * Return information on the subnets appropriate for the given selection strategy.
         *
         * Requires that at least one subnet is matched, throws a descriptive error message
         * otherwise.
         *
         * @param selection
         */
    ...
    public companion object {
        ...
        internal fun unwrap(wrapped: IVpc): software.amazon.awscdk.services.ec2.IVpc =
