...
internal constructor(
    ...
    public companion object {
        public fun virtualService(virtualService: IVirtualService): Backend =
            software.amazon.awscdk.services.appmesh.Backend.virtualService(
                    virtualService.let(IVirtualService::unwrap)
                )
                .let(Backend::wrap)
        ...
        public fun virtualService(
            ...
            software.amazon.awscdk.services.appmesh.Backend.virtualService(
                    virtualService.let(IVirtualService::unwrap),
                    props.let(VirtualServiceBackendOptions::unwrap)
                )
                .let(Backend::wrap)
        ...
        public fun virtualService(
            virtualService: IVirtualService,
            props: VirtualServiceBackendOptions.Builder.() -> Unit
        ): Backend = virtualService(virtualService, VirtualServiceBackendOptions(props))
