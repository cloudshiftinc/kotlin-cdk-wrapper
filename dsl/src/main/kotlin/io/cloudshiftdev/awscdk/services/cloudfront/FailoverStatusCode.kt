...
public enum class FailoverStatusCode(
    ...
    public companion object {
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.cloudfront.FailoverStatusCode
        ): FailoverStatusCode =
            when (cdkObject) {
                ...
                software.amazon.awscdk.services.cloudfront.FailoverStatusCode
                    .INTERNAL_SERVER_ERROR -> FailoverStatusCode.INTERNAL_SERVER_ERROR
