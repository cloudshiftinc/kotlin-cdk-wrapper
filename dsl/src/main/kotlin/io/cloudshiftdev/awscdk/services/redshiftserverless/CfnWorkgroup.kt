...
internal constructor(
    ...
    public open fun attrWorkgroupBaseCapacity(): Number =
        unwrap(this).getAttrWorkgroupBaseCapacity()
    ...
    public open fun attrWorkgroupCreationDate(): String =
        unwrap(this).getAttrWorkgroupCreationDate()
     ...
     */
    public open fun attrWorkgroupEndpointPort(): Number =
        unwrap(this).getAttrWorkgroupEndpointPort()
    ...
    public open fun attrWorkgroupSubnetIds(): List<String> =
        unwrap(this).getAttrWorkgroupSubnetIds()

    /** The Amazon Resource Name (ARN) that links to the workgroup. */
    public open fun attrWorkgroupWorkgroupArn(): String =
        unwrap(this).getAttrWorkgroupWorkgroupArn()
    ...
    public interface Builder {
         ...
         *
         * @param baseCapacity The base compute capacity of the workgroup in Redshift Processing
         *   Units (RPUs).
         */
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.redshiftserverless.CfnWorkgroup.Builder.create(
                scope,
                id
            )
    ...
    public interface ConfigParameterProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ConfigParameterProperty
            ): software.amazon.awscdk.services.redshiftserverless.CfnWorkgroup.ConfigParameterProperty =
    ...
    public interface VpcEndpointProperty {
        ...
        public interface Builder {
            /**
             * @param networkInterfaces One or more network interfaces of the endpoint. Also known
             *   as an interface endpoint.
             */
    ...
    public interface WorkgroupProperty {
         ...
         * about query monitoring rules and available metrics, see
        ...
        public interface Builder {
            ...
            /**
             * @param configParameters An array of parameters to set for advanced control over a
             *   database. The options are `auto_mv` , `datestyle` ,
            ...
            /**
             * @param enhancedVpcRouting The value that specifies whether to enable enhanced virtual
             *   private cloud (VPC) routing, which forces Amazon Redshift Serverless to route
            ...
            /**
             * @param maxCapacity The maximum data-warehouse capacity Amazon Redshift Serverless
            ...
            /**
             * @param publiclyAccessible A value that specifies whether the workgroup can be
            ...
            /**
             * @param securityGroupIds An array of security group IDs to associate with the
             *   workgroup.
             */
            public fun securityGroupIds(securityGroupIds: List<String>)
        ...
        internal constructor(
             ...
             * routing, which forces Amazon Redshift Serverless to route traffic through your VPC.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-redshiftserverless-workgroup-workgroup.html#cfn-redshiftserverless-workgroup-workgroup-enhancedvpcrouting)
             */
