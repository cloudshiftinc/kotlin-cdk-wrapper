...
internal constructor(
    ...
    public interface Builder {
        ...
        /**
         * The resource type of the resources in the resource set. Enter one of the following values
         * for resource type:.
         *
         ...
         *
         * Note that AWS::Route53RecoveryReadiness::DNSTargetResource is only used for this setting.
         * It isn't an actual AWS CloudFormation resource type.
         *
         ...
         *
         * @param resourceSetType The resource type of the resources in the resource set. Enter one
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.route53recoveryreadiness.CfnResourceSet.Builder.create(
                scope,
                id
            )
    ...
    public interface TargetResourceProperty {
        ...
        public interface Builder {
            /**
             * @param nlbResource The Network Load Balancer resource that a DNS target resource
             *   points to.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("12521b6ef63fdb393ae03d277f774d30d5112e6c8ff55fb1186767ea126bc8a3")
            override fun r53Resource(
                r53Resource: R53ResourceRecordProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TargetResourceProperty
            ): software.amazon.awscdk.services.route53recoveryreadiness.CfnResourceSet.TargetResourceProperty =
    ...
    public interface R53ResourceRecordProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: R53ResourceRecordProperty
            ): software.amazon.awscdk.services.route53recoveryreadiness.CfnResourceSet.R53ResourceRecordProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ResourceProperty {
        ...
        /**
         * The recovery group Amazon Resource Name (ARN) or the cell ARN that the readiness checks
         * for this resource set are scoped to.
         *
         ...
         */
        public fun readinessScopes(): List<String> =
            unwrap(this).getReadinessScopes() ?: emptyList()

        /**
         * The Amazon Resource Name (ARN) of the AWS resource.
         *
         * This is a required setting for all `ResourceSet` `ResourceSetType` settings except
         * `AWS::Route53RecoveryReadiness::DNSTargetResource` . Do not set this when
         * `ResourceSetType` is set to `AWS::Route53RecoveryReadiness::DNSTargetResource` .
         *
        ...
        public interface Builder {
            /**
             * @param componentId The component identifier of the resource, generated when DNS
             *   target resource is used.
             */
            public fun componentId(componentId: String)

            /**
             * @param dnsTargetResource A component for DNS/routing control readiness checks. This
             *   is a required setting when `ResourceSet` `ResourceSetType` is set to
             *   `AWS::Route53RecoveryReadiness::DNSTargetResource` . Do not set it for any other
             *   `ResourceSetType` setting.
             */
            ...
            public fun dnsTargetResource(
                dnsTargetResource: DNSTargetResourceProperty.Builder.() -> Unit
            )

            /**
             * @param readinessScopes The recovery group Amazon Resource Name (ARN) or the cell ARN
             *   that the readiness checks for this resource set are scoped to.
             */
            ...
            /**
             * @param resourceArn The Amazon Resource Name (ARN) of the AWS resource. This is a
             *   required setting for all `ResourceSet` `ResourceSetType` settings except
             *   `AWS::Route53RecoveryReadiness::DNSTargetResource` . Do not set this when
             *   `ResourceSetType` is set to `AWS::Route53RecoveryReadiness::DNSTargetResource` .
             */
        ...
        private class BuilderImpl : Builder {
            ...
            override fun dnsTargetResource(dnsTargetResource: DNSTargetResourceProperty) {
                cdkBuilder.dnsTargetResource(
                    dnsTargetResource.let(DNSTargetResourceProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("83baffb106efe707b424ff93ce00925d442bb572f3758234141759a3330018c1")
            override fun dnsTargetResource(
                dnsTargetResource: DNSTargetResourceProperty.Builder.() -> Unit
        ...
        internal constructor(
            ...
            /**
             * The recovery group Amazon Resource Name (ARN) or the cell ARN that the readiness
             * checks for this resource set are scoped to.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-route53recoveryreadiness-resourceset-resource.html#cfn-route53recoveryreadiness-resourceset-resource-readinessscopes)
             */
            override fun readinessScopes(): List<String> =
                unwrap(this).getReadinessScopes() ?: emptyList()
    ...
    public interface DNSTargetResourceProperty {
        ...
        /**
         * The Amazon Route 53 record set ID that uniquely identifies a DNS record, given a name and
         * a type.
         *
        ...
        public interface Builder {
            ...
            /**
             * @param recordSetId The Amazon Route 53 record set ID that uniquely identifies a DNS
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("fbe4c3c3501872a36e8971e95e7186cfe0741261c4a3201f6c88516a9b257376")
            override fun targetResource(
                targetResource: TargetResourceProperty.Builder.() -> Unit
        ...
        internal constructor(
            ...
            /**
             * The Amazon Route 53 record set ID that uniquely identifies a DNS record, given a name
             * and a type.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-route53recoveryreadiness-resourceset-dnstargetresource.html#cfn-route53recoveryreadiness-resourceset-dnstargetresource-recordsetid)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DNSTargetResourceProperty
            ): software.amazon.awscdk.services.route53recoveryreadiness.CfnResourceSet.DNSTargetResourceProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
