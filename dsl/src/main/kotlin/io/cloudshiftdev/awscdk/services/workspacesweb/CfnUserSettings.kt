...
internal constructor(
     ...
     * local browser to the remote browser.
     */
    public open fun cookieSynchronizationConfiguration(
        `value`: CookieSynchronizationConfigurationProperty
    ) {
        unwrap(this)
            .setCookieSynchronizationConfiguration(
                `value`.let(CookieSynchronizationConfigurationProperty::unwrap)
            )
    }
    ...
    public open fun cookieSynchronizationConfiguration(
        `value`: CookieSynchronizationConfigurationProperty.Builder.() -> Unit
    ): Unit =
        cookieSynchronizationConfiguration(CookieSynchronizationConfigurationProperty(`value`))
    ...
    public interface Builder {
        ...
        public fun cookieSynchronizationConfiguration(
            cookieSynchronizationConfiguration:
                CookieSynchronizationConfigurationProperty.Builder.() -> Unit
        )
         ...
         *
         * @param disconnectTimeoutInMinutes The amount of time that a streaming session remains
         ...
         *
         * @param idleDisconnectTimeoutInMinutes The amount of time that users can be idle
         *   (inactive) before they are disconnected from their streaming session and the disconnect
         ...
         *
         * @param pasteAllowed Specifies whether the user can paste text from the local device to
         ...
         *
         * @param uploadAllowed Specifies whether the user can upload files from the local device to
         *   the streaming session.
         */
    ...
    private class BuilderImpl(
         ...
         *   should be synchronized from the end user's local browser to the remote browser.
         */
        override fun cookieSynchronizationConfiguration(
            cookieSynchronizationConfiguration: IResolvable
        ) {
            cdkBuilder.cookieSynchronizationConfiguration(
                cookieSynchronizationConfiguration.let(IResolvable::unwrap)
            )
        }
        ...
        override fun cookieSynchronizationConfiguration(
            ...
            cdkBuilder.cookieSynchronizationConfiguration(
                cookieSynchronizationConfiguration.let(
                    CookieSynchronizationConfigurationProperty::unwrap
                )
            )
        }
        ...
        override fun cookieSynchronizationConfiguration(
            ...
            cookieSynchronizationConfiguration(
                CookieSynchronizationConfigurationProperty(cookieSynchronizationConfiguration)
            )
    ...
    public interface CookieSynchronizationConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param allowlist The list of cookie specifications that are allowed to be
            ...
            /**
             * @param blocklist The list of cookie specifications that are blocked from being
             *   synchronized to the remote browser.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CookieSynchronizationConfigurationProperty
            ): software.amazon.awscdk.services.workspacesweb.CfnUserSettings.CookieSynchronizationConfigurationProperty =
    ...
    public interface CookieSpecificationProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CookieSpecificationProperty
            ): software.amazon.awscdk.services.workspacesweb.CfnUserSettings.CookieSpecificationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
