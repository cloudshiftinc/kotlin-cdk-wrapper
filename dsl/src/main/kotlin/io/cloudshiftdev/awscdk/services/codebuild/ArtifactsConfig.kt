...
public interface ArtifactsConfig {
  ...
  private class BuilderImpl : Builder {
    ...
    public override fun artifactsProperty(artifactsProperty: CfnProject.ArtifactsProperty) {
  ...
  private class Wrapper internal constructor(
    ...
    public override fun artifactsProperty(): CfnProject.ArtifactsProperty =
