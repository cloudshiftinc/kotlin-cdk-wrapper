...
public interface LifecycleRule {
     ...
     *
     * The AbortIncompleteMultipartUpload property type creates a lifecycle rule that aborts
     * incomplete multipart uploads to an Amazon S3 bucket. When Amazon S3 aborts a multipart
     * upload, it deletes all parts associated with the multipart upload.
     *
     ...
     * a new version of the object is uploaded to the bucket and when old versions of the object
     * expire. When object versions expire, Amazon S3 permanently deletes them. If you specify a
     ...
     */
    public fun transitions(): List<Transition> =
    ...
    public interface Builder {
        /**
         * @param abortIncompleteMultipartUploadAfter Specifies a lifecycle rule that aborts
         *   incomplete multipart uploads to an Amazon S3 bucket. The AbortIncompleteMultipartUpload
         *   property type creates a lifecycle rule that aborts incomplete multipart uploads to an
         *   Amazon S3 bucket. When Amazon S3 aborts a multipart upload, it deletes all parts
         *   associated with the multipart upload.
         *
         * The underlying configuration is expressed in whole numbers of days. Providing a Duration
         * that does not represent a whole number of days will result in a runtime or deployment
         * error.
         */
        public fun abortIncompleteMultipartUploadAfter(
        ...
        /**
         * @param expiration Indicates the number of days after creation when objects are deleted
         *   from Amazon S3 and Amazon Glacier. If you specify an expiration and transition time,
         *   you must use the same time unit for both properties (either in days or by date). The
        ...
        /**
         * @param expirationDate Indicates when objects are deleted from Amazon S3 and Amazon
         *   Glacier. The date value must be in ISO 8601 format. The time is always midnight UTC.
         *
         ...
         *   with no noncurrent versions. If set to true, the delete marker will be expired.
         */
        public fun expiredObjectDeleteMarker(expiredObjectDeleteMarker: Boolean)

        /**
         * @param id A unique identifier for this rule. The value cannot be more than 255
         *   characters.
         */
        public fun id(id: String)

        /**
         * @param noncurrentVersionExpiration Time between when a new version of the object is
         *   uploaded to the bucket and when old versions of the object expire. For buckets with
         *   versioning enabled (or suspended), specifies the time, in days, between when a new
         *   version of the object is uploaded to the bucket and when old versions of the object
         *   expire. When object versions expire, Amazon S3 permanently deletes them. If you specify
         ...
         *   non-current objects transition to a specified storage class. Only for for buckets with
         *   versioning enabled (or suspended).
         *
         * If you specify a transition and expiration time, the expiration time must be later than
         * the transition time.
         */
        public fun noncurrentVersionTransitions(
         ...
         */
        public fun noncurrentVersionTransitions(
            vararg noncurrentVersionTransitions: NoncurrentVersionTransition
        )

        /**
         * @param noncurrentVersionsToRetain Indicates a maximum number of noncurrent versions to
         *   retain. If there are this many more noncurrent versions, Amazon S3 permanently deletes
         *   them.
         */
         ...
         *   apply to. Objects must be smaller than this value in bytes.
         */
        ...
        /**
         * @param tagFilters The TagFilter property type specifies tags to use to identify a subset
         *   of objects for an Amazon S3 bucket.
         */
        public fun tagFilters(tagFilters: Map<String, Any>)

        /**
         * @param transitions One or more transition rules that specify when an object transitions
         *   to a specified storage class. If you specify an expiration and transition time, you
         *   must use the same time unit for both properties (either in days or by date). The
         *   expiration time must also be later than the transition time.
         */
    ...
    private class BuilderImpl : Builder {
         ...
         * error.
         */
        override fun abortIncompleteMultipartUploadAfter(
            abortIncompleteMultipartUploadAfter: Duration
        ) {
            cdkBuilder.abortIncompleteMultipartUploadAfter(
                abortIncompleteMultipartUploadAfter.let(Duration::unwrap)
            )
        }
        ...
        override fun noncurrentVersionExpiration(noncurrentVersionExpiration: Duration) {
            cdkBuilder.noncurrentVersionExpiration(
                noncurrentVersionExpiration.let(Duration::unwrap)
            )
        }
        ...
        override fun noncurrentVersionTransitions(
            ...
            cdkBuilder.noncurrentVersionTransitions(
                noncurrentVersionTransitions.map(NoncurrentVersionTransition::unwrap)
            )
        }
    ...
    internal constructor(
         ...
         * Default: false
         */
        override fun expiredObjectDeleteMarker(): Boolean? =
        ...
        /**
         * Time between when a new version of the object is uploaded to the bucket and when old
         * versions of the object expire.
         *
         * For buckets with versioning enabled (or suspended), specifies the time, in days, between
         * when a new version of the object is uploaded to the bucket and when old versions of the
         * object expire. When object versions expire, Amazon S3 permanently deletes them. If you
        ...
        /**
         * One or more transition rules that specify when non-current objects transition to a
    ...
    public companion object {
        ...
        ): software.amazon.awscdk.services.s3.LifecycleRule = (wrapped as Wrapper).cdkObject
    }
}
