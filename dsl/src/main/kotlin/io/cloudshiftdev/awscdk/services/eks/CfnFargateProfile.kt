...
internal constructor(
    ...
    public interface Builder {
         ...
         * node, and it provides read access to Amazon ECR image repositories. For more information,
         * see
         ...
         *   use for a `Pod` that matches the selectors in the Fargate profile.
         */
         ...
         * The IDs of subnets to launch a `Pod` into.
         *
         * A `Pod` running on Fargate isn't assigned a public IP address, so only private subnets
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.eks.CfnFargateProfile =
            cdkBuilder.build()
    }
    ...
    public interface SelectorProperty {
        ...
        public interface Builder {
            /**
             * @param labels The Kubernetes labels that the selector should match. A pod must
             *   contain all of the labels that are specified in the selector for it to be
             *   considered a match.
             */
