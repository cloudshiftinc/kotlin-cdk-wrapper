...
public interface AuthorizationConfig {
    ...
    public interface Builder {
        ...
        public fun additionalAuthorizationModes(
            additionalAuthorizationModes: List<AuthorizationMode>
        )

        /** @param additionalAuthorizationModes Additional authorization modes. */
        public fun additionalAuthorizationModes(
            vararg additionalAuthorizationModes: AuthorizationMode
        )
    ...
    private class BuilderImpl : Builder {
        ...
        /** @param additionalAuthorizationModes Additional authorization modes. */
        override fun additionalAuthorizationModes(
            additionalAuthorizationModes: List<AuthorizationMode>
        ) {
            cdkBuilder.additionalAuthorizationModes(
                additionalAuthorizationModes.map(AuthorizationMode::unwrap)
            )
        }
        ...
        override fun additionalAuthorizationModes(
            vararg additionalAuthorizationModes: AuthorizationMode
        ): Unit = additionalAuthorizationModes(additionalAuthorizationModes.toList())
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("4692d9be17568762847112a3ed1c1df1ac4768f899c97e5b4e77df5dca3c48ad")
        override fun defaultAuthorization(
            defaultAuthorization: AuthorizationMode.Builder.() -> Unit
    ...
    internal constructor(
        ...
        override fun additionalAuthorizationModes(): List<AuthorizationMode> =
            unwrap(this).getAdditionalAuthorizationModes()?.map(AuthorizationMode::wrap)
                ?: emptyList()
