...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.cloudformation.CfnHookVersion,
    ...
    public interface Builder {
         ...
         *
         * @param schemaHandlerPackage A URL to the Amazon S3 bucket containing the hook project
         *   package that contains the necessary files for the hook you want to register.
         */
