...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.kms.Alias,
     ...
     * @param alias
     */
    public override fun addAlias(alias: String): Alias =
        unwrap(this).addAlias(alias).let(Alias::wrap)
    ...
    public interface Builder {
         ...
         * The name of the alias.
         *
         * The name must start with alias followed by a forward slash, such as alias/. You can't
         * specify aliases that begin with alias/AWS. These aliases are reserved.
         *
         ...
         *
         * Specify the key's globally unique identifier or Amazon Resource Name (ARN). You can't
    ...
    public companion object {
        public fun fromAliasAttributes(
            ...
            software.amazon.awscdk.services.kms.Alias.fromAliasAttributes(
        ...
        public fun fromAliasName(
            ...
            software.amazon.awscdk.services.kms.Alias.fromAliasName(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    aliasName
                )
