...
internal constructor(
    ...
    public interface Builder {
         ...
         * this can cause the other certificates to fail renewal and/or not validate. Not
         * recommended for production use.
         *
         * Default: false
         *
         * @param cleanupRoute53Records When set to true, when the DnsValidatedCertificate is
         *   deleted, the associated Route53 validation records are removed.
         */
         ...
         *
         * This is needed especially for certificates used for CloudFront distributions, which
         * require the region to be us-east-1.
         *
        ...
        /**
         * An endpoint of Route53 service, which is not necessary as AWS SDK could figure out the
         * right endpoints for most regions, but for some regions such as those in aws-cn partition,
         * the default endpoint is not working now, hence the right endpoint need to be specified
         * through this prop.
         *
         ...
         *   could figure out the right endpoints for most regions, but for some regions such as
         *   those in aws-cn partition, the default endpoint is not working now, hence the right
         *   endpoint need to be specified through this prop.
         */
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: DnsValidatedCertificate
        ): software.amazon.awscdk.services.certificatemanager.DnsValidatedCertificate =
            wrapped.cdkObject
    }
}
