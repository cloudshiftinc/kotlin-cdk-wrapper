...
internal constructor(
    ...
    /**
     * Overriden method to throw error as interface accelerators are not supported for external
     * tasks.
     *
    ...
    public override fun addInferenceAccelerator(_inferenceAccelerator: InferenceAccelerator) {
        unwrap(this)
            .addInferenceAccelerator(_inferenceAccelerator.let(InferenceAccelerator::unwrap))
    }
    ...
    public override fun addInferenceAccelerator(
        _inferenceAccelerator: InferenceAccelerator.Builder.() -> Unit
    ...
    public companion object {
        public fun fromEc2TaskDefinitionArn(
            ...
            software.amazon.awscdk.services.ecs.ExternalTaskDefinition.fromEc2TaskDefinitionArn(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    externalTaskDefinitionArn
                )
                .let(IExternalTaskDefinition::wrap)
        ...
        public fun fromExternalTaskDefinitionAttributes(
            ...
            software.amazon.awscdk.services.ecs.ExternalTaskDefinition
                .fromExternalTaskDefinitionAttributes(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    attrs.let(ExternalTaskDefinitionAttributes::unwrap)
                )
                .let(IExternalTaskDefinition::wrap)
        ...
        public fun fromExternalTaskDefinitionAttributes(
            ...
            fromExternalTaskDefinitionAttributes(scope, id, ExternalTaskDefinitionAttributes(attrs))
        ...
        internal fun unwrap(
            wrapped: ExternalTaskDefinition
