...
public interface MethodOptions {
     ...
     * Default: None
     */
    public fun requestParameters(): Map<String, Boolean> =
    ...
    public interface Builder {
         ...
         *   `authorizer` must also be specified. If you're using one of the authorizers that are
         *   available via the `Authorizer` class, such as `Authorizer#token()`, it is recommended
         *   that this option not be specified. The authorizer will take care of setting the correct
         *   authorization type. However, specifying an authorization type using this property that
         *   conflicts with what is expected by the `Authorizer` will result in an error.
         */
         ...
         *   authorizer resource. If specified, the value of `authorizationType` must be set to
         *   `Custom`
         */
        ...
        /**
         * @param operationName A friendly operation name for the method. For example, you can
         *   assign the OperationName of ListPets for the GET /pets method.
         */
        public fun operationName(operationName: String)

        /**
         * @param requestModels The models which describe data structure of request payload. When
         *   combined with `requestValidator` or `requestValidatorOptions`, the service will
         *   validate the API request payload before it reaches the API's Integration (including
         *   proxies). Specify `requestModels` as key-value pairs, with a content type (e.g.
         *   `'application/json'`) as the key and an API Gateway Model as the value.
         */
        public fun requestModels(requestModels: Map<String, IModel>)

        /**
         * @param requestParameters The request parameters that API Gateway accepts. Specify request
         *   parameters as key-value pairs (string-to-Boolean mapping), with a source as the key and
         *   a Boolean as the value. The Boolean specifies whether a parameter is required. A source
         *   must match the format method.request.location.name, where the location is querystring,
         *   path, or header, and name is a valid, unique parameter name.
         */
        public fun requestParameters(requestParameters: Map<String, Boolean>)

        /**
         * @param requestValidator The ID of the associated request validator. Only one of
         *   `requestValidator` or `requestValidatorOptions` must be specified. Works together with
         *   `requestModels` or `requestParameters` to validate the request before it reaches
         *   integration like Lambda Proxy Integration.
         */
        public fun requestValidator(requestValidator: IRequestValidator)

        /**
         * @param requestValidatorOptions Request validator options to create new validator Only one
         *   of `requestValidator` or `requestValidatorOptions` must be specified. Works together
         *   with `requestModels` or `requestParameters` to validate the request before it reaches
         *   integration like Lambda Proxy Integration.
         */
        ...
        public fun requestValidatorOptions(
            requestValidatorOptions: RequestValidatorOptions.Builder.() -> Unit
        )
    }
    ...
    private class BuilderImpl : Builder {
        ...
        override fun requestValidatorOptions(requestValidatorOptions: RequestValidatorOptions) {
            cdkBuilder.requestValidatorOptions(
                requestValidatorOptions.let(RequestValidatorOptions::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("95dab34537cb47aff16f4f714f8179958adf7ff05b148ddefd50412b1016f8e9")
        override fun requestValidatorOptions(
            requestValidatorOptions: RequestValidatorOptions.Builder.() -> Unit
    ...
    internal constructor(
         ...
         * specified.
         *
         * If you're using one of the authorizers that are available via the `Authorizer` class,
         * such as `Authorizer#token()`, it is recommended that this option not be specified. The
         * authorizer will take care of setting the correct authorization type. However, specifying
         * an authorization type using this property that conflicts with what is expected by the
         * `Authorizer` will result in an error.
         *
         * Default: - open access unless `authorizer` is specified
         */
        ...
        /**
         * If `authorizationType` is `Custom`, this specifies the ID of the method authorizer
         * resource.
         *
         * If specified, the value of `authorizationType` must be set to `Custom`
         */
        override fun authorizer(): IAuthorizer? =
            unwrap(this).getAuthorizer()?.let(IAuthorizer::wrap)

        /**
         * The responses that can be sent to the client who calls the method.
         *
         * Default: None This property is not required, but if these are not supplied for a Lambda
         * proxy integration, the Lambda function must return a value of the correct format, for the
         * integration response to be correctly mapped to a response to the client.
         *
         * [Documentation](https://docs.aws.amazon.com/apigateway/latest/developerguide/api-gateway-method-settings-method-response.html)
         */
         ...
         * The models which describe data structure of request payload.
         *
         * When combined with `requestValidator` or `requestValidatorOptions`, the service will
         * validate the API request payload before it reaches the API's Integration (including
         * proxies). Specify `requestModels` as key-value pairs, with a content type (e.g.
         * `'application/json'`) as the key and an API Gateway Model as the value.
         *
         ...
         * The request parameters that API Gateway accepts.
         *
         * Specify request parameters as key-value pairs (string-to-Boolean mapping), with a source
         * as the key and a Boolean as the value. The Boolean specifies whether a parameter is
         * required. A source must match the format method.request.location.name, where the location
         * is querystring, path, or header, and name is a valid, unique parameter name.
         *
         * Default: None
         */
        override fun requestParameters(): Map<String, Boolean> =
            unwrap(this).getRequestParameters() ?: emptyMap()

        /**
         * The ID of the associated request validator.
         *
         * Only one of `requestValidator` or `requestValidatorOptions` must be specified. Works
         * together with `requestModels` or `requestParameters` to validate the request before it
         * reaches integration like Lambda Proxy Integration.
         *
         * Default: - No default validator
         */
         ...
         * `requestValidatorOptions` must be specified.
         *
         * Works together with `requestModels` or `requestParameters` to validate the request before
         * it reaches integration like Lambda Proxy Integration.
         *
         * Default: - No default validator
         */
