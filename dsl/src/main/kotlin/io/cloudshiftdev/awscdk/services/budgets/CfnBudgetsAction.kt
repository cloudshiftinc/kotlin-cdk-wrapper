...
internal constructor(
    ...
    private class BuilderImpl(
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("d431faf93eadd4eb9e269a6ee1f104fce786914616d64023a9442ca2f259e5a8")
        override fun actionThreshold(
            actionThreshold: ActionThresholdProperty.Builder.() -> Unit
        ): Unit = actionThreshold(ActionThresholdProperty(actionThreshold))
    ...
    public interface SsmActionDefinitionProperty {
        ...
        private class BuilderImpl : Builder {
            ...
            /** @param instanceIds The EC2 and RDS instance IDs. */
            override fun instanceIds(vararg instanceIds: String): Unit =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SsmActionDefinitionProperty
            ): software.amazon.awscdk.services.budgets.CfnBudgetsAction.SsmActionDefinitionProperty =
    ...
    public interface ActionThresholdProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ActionThresholdProperty
            ): software.amazon.awscdk.services.budgets.CfnBudgetsAction.ActionThresholdProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DefinitionProperty {
        ...
        public interface Builder {
            /**
             * @param iamActionDefinition The AWS Identity and Access Management ( IAM ) action
             *   definition details.
             */
            ...
            public fun iamActionDefinition(
                iamActionDefinition: IamActionDefinitionProperty.Builder.() -> Unit
            )

            /**
             * @param scpActionDefinition The service control policies (SCP) action definition
             *   details.
             */
            ...
            public fun scpActionDefinition(
                scpActionDefinition: ScpActionDefinitionProperty.Builder.() -> Unit
            )
            ...
            public fun ssmActionDefinition(
                ssmActionDefinition: SsmActionDefinitionProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun iamActionDefinition(iamActionDefinition: IamActionDefinitionProperty) {
                cdkBuilder.iamActionDefinition(
                    iamActionDefinition.let(IamActionDefinitionProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("c52ca7820a6fe284fd0ea3d9afc93f16bddfe032234b3317f714efc21f60583a")
            override fun iamActionDefinition(
                iamActionDefinition: IamActionDefinitionProperty.Builder.() -> Unit
            ...
            override fun scpActionDefinition(scpActionDefinition: ScpActionDefinitionProperty) {
                cdkBuilder.scpActionDefinition(
                    scpActionDefinition.let(ScpActionDefinitionProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("c9ff7d807d0531c6d4fa23ee7b3b44b9d6dc0cdd12a9c3129aa626e806c7876a")
            override fun scpActionDefinition(
                scpActionDefinition: ScpActionDefinitionProperty.Builder.() -> Unit
            ...
            override fun ssmActionDefinition(ssmActionDefinition: SsmActionDefinitionProperty) {
                cdkBuilder.ssmActionDefinition(
                    ssmActionDefinition.let(SsmActionDefinitionProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("82fccf1fba528ea2ee3866085585fe779fc0b8a34dc7177e1aa514be8ce3bcc1")
            override fun ssmActionDefinition(
                ssmActionDefinition: SsmActionDefinitionProperty.Builder.() -> Unit
    ...
    public interface IamActionDefinitionProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: IamActionDefinitionProperty
            ): software.amazon.awscdk.services.budgets.CfnBudgetsAction.IamActionDefinitionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ScpActionDefinitionProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ScpActionDefinitionProperty
            ): software.amazon.awscdk.services.budgets.CfnBudgetsAction.ScpActionDefinitionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
