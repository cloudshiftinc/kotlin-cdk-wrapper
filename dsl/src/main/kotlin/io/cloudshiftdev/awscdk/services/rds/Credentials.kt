    ...
    public companion object {
        public fun fromGeneratedSecret(username: String): Credentials =
            software.amazon.awscdk.services.rds.Credentials.fromGeneratedSecret(username)
                .let(Credentials::wrap)

        public fun fromGeneratedSecret(
            username: String,
            options: CredentialsBaseOptions
        ): Credentials =
            software.amazon.awscdk.services.rds.Credentials.fromGeneratedSecret(
                    username,
                    options.let(CredentialsBaseOptions::unwrap)
                )
                .let(Credentials::wrap)
        ...
        public fun fromGeneratedSecret(
            username: String,
            options: CredentialsBaseOptions.Builder.() -> Unit
        ): Credentials = fromGeneratedSecret(username, CredentialsBaseOptions(options))

        public fun fromPassword(username: String, password: SecretValue): Credentials =
            software.amazon.awscdk.services.rds.Credentials.fromPassword(
                    username,
        ...
        public fun fromSecret(secret: ISecret, username: String): Credentials =
            software.amazon.awscdk.services.rds.Credentials.fromSecret(
        ...
        public fun fromUsername(
            ...
            software.amazon.awscdk.services.rds.Credentials.fromUsername(
                    username,
                    options.let(CredentialsFromUsernameOptions::unwrap)
                )
                .let(Credentials::wrap)
        ...
        public fun fromUsername(
            username: String,
            options: CredentialsFromUsernameOptions.Builder.() -> Unit
        ): Credentials = fromUsername(username, CredentialsFromUsernameOptions(options))
