...
public abstract class Credentials internal constructor(
  private val cdkObject: software.amazon.awscdk.services.rds.Credentials,
) {
  ...
  private class Wrapper internal constructor(
    internal val cdkObject: software.amazon.awscdk.services.rds.Credentials,
  ) : Credentials(cdkObject)

  public companion object {
    public open fun fromGeneratedSecret(username: String): Credentials =
        software.amazon.awscdk.services.rds.Credentials.fromGeneratedSecret(username).let(Credentials::wrap)

    public open fun fromGeneratedSecret(username: String, options: CredentialsBaseOptions):
        Credentials = software.amazon.awscdk.services.rds.Credentials.fromGeneratedSecret(username,
    ...
    public open fun fromPassword(username: String, password: SecretValue): Credentials =
    ...
    public open fun fromSecret(secret: ISecret): Credentials =
        software.amazon.awscdk.services.rds.Credentials.fromSecret(secret.let(ISecret::unwrap)).let(Credentials::wrap)

    public open fun fromSecret(secret: ISecret, username: String): Credentials =
        software.amazon.awscdk.services.rds.Credentials.fromSecret(secret.let(ISecret::unwrap),
        username).let(Credentials::wrap)

    public open fun fromUsername(username: String): Credentials =
        software.amazon.awscdk.services.rds.Credentials.fromUsername(username).let(Credentials::wrap)

    public open fun fromUsername(username: String, options: CredentialsFromUsernameOptions):
        Credentials = software.amazon.awscdk.services.rds.Credentials.fromUsername(username,
    ...
    public open fun fromUsername(username: String,
