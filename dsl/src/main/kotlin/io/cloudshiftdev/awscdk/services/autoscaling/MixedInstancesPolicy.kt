...
public interface MixedInstancesPolicy {
    ...
    public interface Builder {
        ...
        public fun instancesDistribution(
            instancesDistribution: InstancesDistribution.Builder.() -> Unit
        )
    ...
    private class BuilderImpl : Builder {
        ...
        override fun instancesDistribution(instancesDistribution: InstancesDistribution) {
            cdkBuilder.instancesDistribution(
                instancesDistribution.let(InstancesDistribution::unwrap)
            )
        }
         ...
         * is 20.
         */
        override fun launchTemplateOverrides(
            launchTemplateOverrides: List<LaunchTemplateOverrides>
        ) {
            cdkBuilder.launchTemplateOverrides(
                launchTemplateOverrides.map(LaunchTemplateOverrides::unwrap)
            )
        }
         ...
         */
        override fun launchTemplateOverrides(
            vararg launchTemplateOverrides: LaunchTemplateOverrides
    ...
    internal constructor(
         ...
         * Launch template overrides.
         *
         * The maximum number of instance types that can be associated with an Auto Scaling group
         * is 40.
         *
         * The maximum number of distinct launch templates you can define for an Auto Scaling group
         * is 20.
        ...
        override fun launchTemplateOverrides(): List<LaunchTemplateOverrides> =
            unwrap(this).getLaunchTemplateOverrides()?.map(LaunchTemplateOverrides::wrap)
                ?: emptyList()
    }
