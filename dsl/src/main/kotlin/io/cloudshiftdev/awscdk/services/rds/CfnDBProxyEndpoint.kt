...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param dbProxyName The name of the DB proxy associated with the DB proxy endpoint that
         *   you create.
         */
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.rds.CfnDBProxyEndpoint =
            cdkBuilder.build()
    }
    ...
    public interface TagFormatProperty {
        ...
        public interface Builder {
            /**
             * @param key A value is the optional value of the tag. The string value can be 1-256
