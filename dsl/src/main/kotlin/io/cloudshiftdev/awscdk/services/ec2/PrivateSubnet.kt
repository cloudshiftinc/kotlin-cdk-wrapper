...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.ec2.PrivateSubnet,
    ...
    public companion object {
        public fun fromPrivateSubnetAttributes(
            ...
            software.amazon.awscdk.services.ec2.PrivateSubnet.fromPrivateSubnetAttributes(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    attrs.let(PrivateSubnetAttributes::unwrap)
                )
                .let(IPrivateSubnet::wrap)
        ...
        ): PrivateSubnet = PrivateSubnet(cdkObject)

        internal fun unwrap(
            wrapped: PrivateSubnet
        ): software.amazon.awscdk.services.ec2.PrivateSubnet = wrapped.cdkObject
    }
}
