...
internal constructor(
    ...
    public interface AnalysisSourceProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AnalysisSourceProperty
            ): software.amazon.awscdk.services.cleanrooms.CfnAnalysisTemplate.AnalysisSourceProperty =
    ...
    public interface AnalysisSchemaProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AnalysisSchemaProperty
            ): software.amazon.awscdk.services.cleanrooms.CfnAnalysisTemplate.AnalysisSchemaProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface AnalysisParameterProperty {
        ...
        public interface Builder {
            /**
             * @param defaultValue Optional. The default value that is applied in the analysis
             *   template. The member who can query can override this value in the query editor.
             */
            public fun defaultValue(defaultValue: String)

            /**
             * @param name The name of the parameter. The name must use only alphanumeric,
             *   underscore (_), or hyphen (-) characters but cannot start or end with a hyphen.
             */
            public fun name(name: String)
        ...
        internal constructor(
             ...
             * Optional.
             *
             * The default value that is applied in the analysis template. The member who can query
             * can override this value in the query editor.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-cleanrooms-analysistemplate-analysisparameter.html#cfn-cleanrooms-analysistemplate-analysisparameter-defaultvalue)
             */
             ...
             * The name of the parameter.
             *
             * The name must use only alphanumeric, underscore (_), or hyphen (-) characters but
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AnalysisParameterProperty
            ): software.amazon.awscdk.services.cleanrooms.CfnAnalysisTemplate.AnalysisParameterProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
