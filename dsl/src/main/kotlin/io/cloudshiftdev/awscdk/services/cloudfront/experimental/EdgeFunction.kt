...
internal constructor(
     ...
     * @param options
     */
    public override fun addEventSourceMapping(
        id: String,
        options: EventSourceMappingOptions
    ): EventSourceMapping =
        unwrap(this)
            .addEventSourceMapping(id, options.let(EventSourceMappingOptions::unwrap))
            .let(EventSourceMapping::wrap)
    ...
    public override fun addEventSourceMapping(
        id: String,
        options: EventSourceMappingOptions.Builder.() -> Unit
    ): EventSourceMapping = addEventSourceMapping(id, EventSourceMappingOptions(options))
    ...
    public override fun addFunctionUrl(
        options: FunctionUrlOptions.Builder.() -> Unit
    ): FunctionUrl = addFunctionUrl(FunctionUrlOptions(options))
    ...
    public override fun configureAsyncInvoke(
        options: EventInvokeConfigOptions.Builder.() -> Unit
    ...
    public open fun currentVersion(): IVersion =
        unwrap(this).getCurrentVersion().let(IVersion::wrap)
     ...
     */
    public override fun grantInvokeCompositePrincipal(
        compositePrincipal: CompositePrincipal
    ): List<Grant> =
        unwrap(this)
            .grantInvokeCompositePrincipal(compositePrincipal.let(CompositePrincipal::unwrap))
            .map(Grant::wrap)
     ...
     *
     * Note that this is reference to a non-specific AWS Lambda version, which means the function
     * this version refers to can return different results in different invocations.
     *
     * To obtain a reference to an explicit version which references the current function
     * configuration, use `lambdaFunction.currentVersion` instead.
     */
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.cloudfront.experimental.EdgeFunction.Builder.create(
                scope,
                id
            )
