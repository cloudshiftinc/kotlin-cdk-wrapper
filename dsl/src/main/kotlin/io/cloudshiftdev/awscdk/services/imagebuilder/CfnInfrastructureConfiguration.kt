...
internal constructor(
    ...
    public open fun instanceMetadataOptions(`value`: InstanceMetadataOptionsProperty) {
        unwrap(this)
            .setInstanceMetadataOptions(`value`.let(InstanceMetadataOptionsProperty::unwrap))
    }

    /** The instance metadata option settings for the infrastructure configuration. */
    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("e42fdd1eab591949e29aea918b51efbd6cb9a65b1e0208eec8d964ec1e8c1961")
    public open fun instanceMetadataOptions(
        `value`: InstanceMetadataOptionsProperty.Builder.() -> Unit
    ): Unit = instanceMetadataOptions(InstanceMetadataOptionsProperty(`value`))
    ...
    public open fun terminateInstanceOnFailure(): Any? =
        unwrap(this).getTerminateInstanceOnFailure()
    ...
    public interface Builder {
         ...
         *
         * @param instanceMetadataOptions The instance metadata option settings for the
        ...
        public fun instanceMetadataOptions(
            instanceMetadataOptions: InstanceMetadataOptionsProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
         ...
         *   infrastructure configuration.
         */
        override fun instanceMetadataOptions(
            instanceMetadataOptions: InstanceMetadataOptionsProperty
        ) {
            cdkBuilder.instanceMetadataOptions(
                instanceMetadataOptions.let(InstanceMetadataOptionsProperty::unwrap)
            )
        }
        ...
        override fun terminateInstanceOnFailure(terminateInstanceOnFailure: IResolvable) {
            cdkBuilder.terminateInstanceOnFailure(
                terminateInstanceOnFailure.let(IResolvable::unwrap)
            )
        }
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnInfrastructureConfiguration
        ): software.amazon.awscdk.services.imagebuilder.CfnInfrastructureConfiguration =
            wrapped.cdkObject
    }
    ...
    public interface InstanceMetadataOptionsProperty {
         ...
         * destination.
         *
         * The default is one hop. However, if HTTP tokens are required, container image builds need
         * a minimum of two hops.
         *
         ...
         *   metadata, or you can leave it out. If you include it, version 2.0 credentials are
         *   returned for the IAM role. Otherwise, version 1.0 credentials are returned.
         *
        ...
        public interface Builder {
            /**
             * @param httpPutResponseHopLimit Limit the number of hops that an instance metadata
             *   request can traverse to reach its destination. The default is one hop. However, if
             *   HTTP tokens are required, container image builds need a minimum of two hops.
             */
            public fun httpPutResponseHopLimit(httpPutResponseHopLimit: Number)

            /**
             * @param httpTokens Indicates whether a signed token header is required for instance
             *   metadata retrieval requests. The values affect the response as follows:
             * * *required* – When you retrieve the IAM role credentials, version 2.0 credentials
             *   are returned in all cases.
             * * *optional* – You can include a signed token header in your request to retrieve
             *   instance metadata, or you can leave it out. If you include it, version 2.0
             *   credentials are returned for the IAM role. Otherwise, version 1.0 credentials are
             *   returned.
             *
             * The default setting is *optional* .
             */
        ...
        internal constructor(
             ...
             * destination.
             *
             * The default is one hop. However, if HTTP tokens are required, container image builds
             * need a minimum of two hops.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-imagebuilder-infrastructureconfiguration-instancemetadataoptions.html#cfn-imagebuilder-infrastructureconfiguration-instancemetadataoptions-httpputresponsehoplimit)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: InstanceMetadataOptionsProperty
            ): software.amazon.awscdk.services.imagebuilder.CfnInfrastructureConfiguration.InstanceMetadataOptionsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
