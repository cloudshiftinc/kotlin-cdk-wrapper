...
internal constructor(
    ...
    public open fun queryLoggingConfig(
        `value`: QueryLoggingConfigProperty.Builder.() -> Unit
    ): Unit = queryLoggingConfig(QueryLoggingConfigProperty(`value`))
    ...
    public interface Builder {
         ...
         * The name of the domain.
         *
         * Specify a fully qualified domain name, for example, *www.example.com* . The trailing dot
         * is optional; Amazon Route 53 assumes that the domain name is fully qualified. This means
         * that Route 53 treats *www.example.com* (without a trailing dot) and *www.example.com.*
         ...
         * change the name servers for your domain to the set of `NameServers` that are returned by
         ...
         * Creates a configuration for DNS query logging.
         *
         * After you create a query logging configuration, Amazon Route 53 begins to publish log
         ...
         *
         * In the next step, you'll create a resource policy, which controls access to one or more
         * log groups and the associated AWS resources, such as Route 53 hosted zones. There's a
         * limit on the number of resource policies that you can create, so we recommend that you
         * use a consistent prefix so you can use the same resource policy for all the log groups
         ...
         *   `Resource` , specify the ARN for the log group that you created in the previous step.
         *   To use the same resource policy for all the CloudWatch Logs log groups that you created
         *   for query logging configurations, replace the hosted zone name with `*` , for example:
         *
         * `arn:aws:logs:us-east-1:123412341234:log-group:/aws/route53/ *`
         *
         * To avoid the confused deputy problem, a security issue where an entity without a
         * permission for an action can coerce a more-privileged entity to perform it, you can
         * optionally limit the permissions that a service has to a resource in a resource-based
         * policy by supplying the following values:
         * * For `aws:SourceArn` , supply the hosted zone ARN used in creating the query logging
         *   configuration. For example, `aws:SourceArn: arn:aws:route53:::hostedzone/hosted zone
         *   ID` .
         ...
         *   responds to DNS queries for the specified hosted zone. That log stream is used to log
         *   all queries that Route 53 responds to for that edge location.
         ...
         * abbreviations might change in the future.) For a list of edge locations, see "The Route
         * 53 Global Network" on the
         ...
         *   forward to Route 53. If a DNS resolver has already cached the response to a query (such
         *   as the IP address for a load balancer for example.com), the resolver will continue to
         *   return the cached response. It doesn't forward another query to Route 53 until the TTL
         *   for the corresponding resource record set expires. Depending on how many DNS queries
         *   are submitted for a resource record set, and depending on the TTL for that resource
         *   record set, query logs might contain information about only one query out of every
         *   several thousand queries that are submitted to DNS. For more information about how DNS
         *   works, see
         ...
         *   in the *Amazon Route 53 Developer Guide* .
         * * **Pricing** - For information about charges for query logs, see
         *   [Amazon CloudWatch Pricing](https://docs.aws.amazon.com/cloudwatch/pricing/) .
        ...
        public fun queryLoggingConfig(
            queryLoggingConfig: QueryLoggingConfigProperty.Builder.() -> Unit
        )
         ...
         *
         * @param vpcs *Private hosted zones:* A complex type that contains information about the
    ...
    private class BuilderImpl(
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("cf6d2fd2ccbcb97d5d9641544ccb5faf470a34337d7035c5365a3729b521b0c3")
        override fun hostedZoneConfig(
            hostedZoneConfig: HostedZoneConfigProperty.Builder.() -> Unit
        ...
        override fun queryLoggingConfig(queryLoggingConfig: QueryLoggingConfigProperty) {
            cdkBuilder.queryLoggingConfig(
                queryLoggingConfig.let(QueryLoggingConfigProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("a3b0b16f06ec058da9c9f85788ccf6a4e7407a109dfb778d25b1f2338ce86c99")
        override fun queryLoggingConfig(
            queryLoggingConfig: QueryLoggingConfigProperty.Builder.() -> Unit
        ...
        public fun build(): software.amazon.awscdk.services.route53.CfnHostedZone =
            cdkBuilder.build()
    }
    ...
    public interface QueryLoggingConfigProperty {
        ...
        public interface Builder {
            /**
             * @param cloudWatchLogsLogGroupArn The Amazon Resource Name (ARN) of the CloudWatch
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: QueryLoggingConfigProperty
            ): software.amazon.awscdk.services.route53.CfnHostedZone.QueryLoggingConfigProperty =
    ...
    public interface VPCProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param vpcRegion *Private hosted zones only:* The region that an Amazon VPC was
             *   created in.
             *
             * For public hosted zones, omit `VPCs` , `VPCId` , and `VPCRegion` .
             */
    ...
    public interface HostedZoneConfigProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: HostedZoneConfigProperty
            ): software.amazon.awscdk.services.route53.CfnHostedZone.HostedZoneConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
