...
internal constructor(
    ...
    public interface Builder {
        ...
        /**
         * Specifies whether the proxy includes detailed information about SQL statements in its
         * logs.
         *
         ...
         * The kinds of databases that the proxy can connect to.
         *
         * This value determines which database network protocol the proxy recognizes when it
         * interprets network traffic to and from the database. For Aurora MySQL, RDS for MariaDB,
         * and RDS for MySQL databases, specify `MYSQL` . For Aurora PostgreSQL and RDS for
         ...
         *   inactive before the proxy disconnects it.
         */
    ...
    public interface AuthFormatProperty {
        ...
        public interface Builder {
            /**
             * @param authScheme The type of authentication that the proxy uses for connections from
             *   the proxy to the underlying database. Valid Values: `SECRETS`
             */
            public fun authScheme(authScheme: String)

            /**
             * @param clientPasswordAuthType Specifies the details of authentication used by a proxy
             *   to log in as a specific database user.
             */
            public fun clientPasswordAuthType(clientPasswordAuthType: String)

            /**
             * @param description A user-specified description about the authentication used by a
             *   proxy to log in as a specific database user.
             */
            public fun description(description: String)

            /**
             * @param iamAuth Whether to require or disallow AWS Identity and Access Management
            ...
            /**
             * @param secretArn The Amazon Resource Name (ARN) representing the secret that the
             *   proxy uses to authenticate to the RDS DB instance or Aurora DB cluster. These
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-rds-dbproxy-authformat.html#cfn-rds-dbproxy-authformat-clientpasswordauthtype)
             */
            override fun clientPasswordAuthType(): String? =
    ...
    public interface TagFormatProperty {
        ...
        public interface Builder {
            /**
             * @param key A key is the required name of the tag. The string value can be 1-128
             *   Unicode characters in length and can't be prefixed with `aws:` . The string can
            ...
            /**
             * @param value A value is the optional value of the tag. The string value can be 1-256
             *   Unicode characters in length and can't be prefixed with `aws:` . The string can
             *   contain only the set of Unicode letters, digits, white-space, '*', '.', '/', '=',
             *   '+', '-' (Java regex: "^([\p{L}\p{Z}\p{N}*.:/=+-]*)$").
             */
