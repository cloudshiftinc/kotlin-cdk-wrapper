...
internal constructor(
    ...
    public interface Builder {
        ...
        /**
         * The maximum duration that the composite alarm waits after suppressor alarm goes out of
         * the ALARM state.
         *
         ...
         *
         * @param actionsSuppressorExtensionPeriod The maximum duration that the composite alarm
        ...
        /**
         * The maximum duration that the composite alarm waits for the suppressor alarm to go into
         * the ALARM state.
         *
         * After this time, the composite alarm performs its actions.
         *
         ...
         *
         * @param actionsSuppressorWaitPeriod The maximum duration that the composite alarm waits
        ...
        /**
         * Expression that specifies which other alarms are to be evaluated to determine this
    ...
    private class BuilderImpl(
        ...
        override fun actionsSuppressorExtensionPeriod(actionsSuppressorExtensionPeriod: Duration) {
            cdkBuilder.actionsSuppressorExtensionPeriod(
                actionsSuppressorExtensionPeriod.let(Duration::unwrap)
            )
        }
        ...
        override fun actionsSuppressorWaitPeriod(actionsSuppressorWaitPeriod: Duration) {
            cdkBuilder.actionsSuppressorWaitPeriod(
                actionsSuppressorWaitPeriod.let(Duration::unwrap)
            )
        }
    ...
    public companion object {
        public fun fromCompositeAlarmArn(
            ...
            software.amazon.awscdk.services.cloudwatch.CompositeAlarm.fromCompositeAlarmArn(
        ...
        public fun fromCompositeAlarmName(
            ...
            software.amazon.awscdk.services.cloudwatch.CompositeAlarm.fromCompositeAlarmName(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    compositeAlarmName
                )
