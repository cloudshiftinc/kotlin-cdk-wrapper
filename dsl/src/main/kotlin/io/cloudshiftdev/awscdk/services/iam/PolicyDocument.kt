...
internal constructor(
     ...
     * resolution.
     *
     * This may return an array with a single informational element indicating how to get this
     * property populated, if it was skipped for performance reasons.
     */
    ...
    public interface Builder {
         ...
         *
         * To avoid overrunning the maximum policy size, combine statements if they produce the same
         * result. Merging happens according to the following rules:
         ...
         * * We will never combine NotPrincipals, NotResources or NotActions, because doing so would
         *   change the meaning of the policy document.
         *
    ...
    public companion object {
        public fun fromJson(obj: Any): PolicyDocument =
            software.amazon.awscdk.services.iam.PolicyDocument.fromJson(obj)
                .let(PolicyDocument::wrap)
        ...
        ): PolicyDocument = PolicyDocument(cdkObject)

        internal fun unwrap(
            wrapped: PolicyDocument
        ): software.amazon.awscdk.services.iam.PolicyDocument = wrapped.cdkObject
    }
}
