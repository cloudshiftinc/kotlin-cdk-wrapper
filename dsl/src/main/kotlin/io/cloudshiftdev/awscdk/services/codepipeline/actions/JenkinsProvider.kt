...
internal constructor(
    ...
    public interface Builder {
         ...
         * Default: false
         *
         * @param forBuild Whether to immediately register a Jenkins Provider for the build
         *   category.
         */
        ...
        /**
         * The name of the Jenkins provider that you set in the AWS CodePipeline plugin
         * configuration of your Jenkins project.
         *
         * Example:
         * ```
         * "MyJenkinsProvider";
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.codepipeline.actions.JenkinsProvider.Builder.create(
                scope,
                id
            )
    ...
    public companion object {
        public fun fromJenkinsProviderAttributes(
            ...
            software.amazon.awscdk.services.codepipeline.actions.JenkinsProvider
                .fromJenkinsProviderAttributes(
                    ...
                    id,
                    attrs.let(JenkinsProviderAttributes::unwrap)
                )
                .let(IJenkinsProvider::wrap)
        ...
        public fun fromJenkinsProviderAttributes(
            ...
            fromJenkinsProviderAttributes(scope, id, JenkinsProviderAttributes(attrs))
