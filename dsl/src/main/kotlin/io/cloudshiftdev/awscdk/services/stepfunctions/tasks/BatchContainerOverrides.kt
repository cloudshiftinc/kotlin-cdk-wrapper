...
public interface BatchContainerOverrides {
     ...
     * override the existing environment variables from the Docker image or the job definition.
     *
     ...
     *
     * The number of GPUs reserved for all containers in a job should not exceed the number of
    ...
    public interface Builder {
        /**
         * @param command The command to send to the container that overrides the default command
         ...
         *   environment variables, which are added to the container at launch, or you can override
         *   the existing environment variables from the Docker image or the job definition.
         */
        public fun environment(environment: Map<String, String>)

        /**
         * @param gpuCount The number of physical GPUs to reserve for the container. The number of
         *   GPUs reserved for all containers in a job should not exceed the number of available
         *   GPUs on the compute resource that the job is launched on.
         */
        public fun gpuCount(gpuCount: Number)

        /**
         * @param instanceType The instance type to use for a multi-node parallel job. This
        ...
        /**
         * @param vcpus The number of vCPUs to reserve for the container. This value overrides the
    ...
    internal constructor(
         ...
         * can override the existing environment variables from the Docker image or the job
         * definition.
         *
         * Default: - No environment overrides
         */
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: BatchContainerOverrides
        ): software.amazon.awscdk.services.stepfunctions.tasks.BatchContainerOverrides =
