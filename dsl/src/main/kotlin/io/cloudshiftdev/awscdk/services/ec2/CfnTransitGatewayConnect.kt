...
internal constructor(
    ...
    public open fun options(
        `value`: TransitGatewayConnectOptionsProperty.Builder.() -> Unit
    ): Unit = options(TransitGatewayConnectOptionsProperty(`value`))
    ...
    public interface Builder {
         ...
         *
         * @param transportTransitGatewayAttachmentId The ID of the attachment from which the
    ...
    private class BuilderImpl(
        ...
        override fun options(
            options: TransitGatewayConnectOptionsProperty.Builder.() -> Unit
         ...
         *   Connect attachment was created.
         */
        override fun transportTransitGatewayAttachmentId(
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnTransitGatewayConnect
    ...
    public interface TransitGatewayConnectOptionsProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TransitGatewayConnectOptionsProperty
            ): software.amazon.awscdk.services.ec2.CfnTransitGatewayConnect.TransitGatewayConnectOptionsProperty =
