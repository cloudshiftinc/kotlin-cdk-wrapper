...
public interface BounceActionConfig {
    ...
    public interface Builder {
        ...
        /**
         * @param sender The email address of the sender of the bounced email. This is the address
         *   that the bounce message is sent from.
         */
    ...
    private class BuilderImpl : Builder {
        ...
        public fun build(): software.amazon.awscdk.services.ses.BounceActionConfig =
            cdkBuilder.build()
    }
