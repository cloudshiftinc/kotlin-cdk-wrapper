...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param homeDirectory The landing directory (folder) for a user when they log in to the
         ...
         * when they log in to the server.
         *
         * If you set it to `PATH` , the user will see the absolute Amazon S3 bucket or Amazon EFS
         * path as is in their file transfer protocol clients. If you set it to `LOGICAL` , you need
         ...
         * A session policy for your user so you can use the same IAM role across multiple users.
         *
         * This policy restricts user access to portions of their Amazon S3 bucket. Variables that
         * you can use inside this policy include `${Transfer:UserName}` ,
         * `${Transfer:HomeDirectory}` , and `${Transfer:HomeBucket}` .
         *
         * For session policies, AWS Transfer Family stores the policy as a JSON blob, instead of
         * the Amazon Resource Name (ARN) of the policy. You save the policy as a JSON blob and pass
         ...
         * [AssumeRole](https://docs.aws.amazon.com/STS/latest/APIReference/API_AssumeRole.html) in
         ...
         *
         * @param policy A session policy for your user so you can use the same IAM role across
         *   multiple users.
         */
         ...
         * any secondary groups IDs ( `SecondaryGids` ), that controls your users' access to your
         ...
         *
         * @param posixProfile Specifies the full POSIX identity, including user ID ( `Uid` ), group
         *   ID ( `Gid` ), and any secondary groups IDs ( `SecondaryGids` ), that controls your
         ...
         *   (IAM) role that controls your users' access to your Amazon S3 bucket or Amazon EFS file
         *   system.
         */
         ...
         *
         * @param sshPublicKeys Specifies the public key portion of the Secure Shell (SSH) keys
         ...
         *
         * @param userName A unique string that identifies a user and is associated with a
         *   `ServerId` .
         */
    ...
    public interface PosixProfileProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param secondaryGids The secondary POSIX group IDs used for all EFS operations by
             *   this user.
             */
    ...
    public interface HomeDirectoryMapEntryProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param type Specifies the type of mapping. Set the type to `FILE` if you want the
             *   mapping to point to a file, or `DIRECTORY` for the directory to point to a
             *   directory.
             *
             * By default, home directory mappings have a `Type` of `DIRECTORY` when you create a
             * Transfer Family server. You would need to explicitly set `Type` to `FILE` if you want
        ...
        internal constructor(
             ...
             * Specifies the type of mapping.
             *
             * Set the type to `FILE` if you want the mapping to point to a file, or `DIRECTORY` for
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: HomeDirectoryMapEntryProperty
            ): software.amazon.awscdk.services.transfer.CfnUser.HomeDirectoryMapEntryProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
