...
internal constructor(
     ...
     * table.
     */
    public open fun contributorInsightsSpecification(
        `value`: ContributorInsightsSpecificationProperty
    ) {
        unwrap(this)
            .setContributorInsightsSpecification(
                `value`.let(ContributorInsightsSpecificationProperty::unwrap)
            )
    }
    ...
    public open fun contributorInsightsSpecification(
        `value`: ContributorInsightsSpecificationProperty.Builder.() -> Unit
    ...
    public open fun importSourceSpecification(`value`: ImportSourceSpecificationProperty) {
        unwrap(this)
            .setImportSourceSpecification(`value`.let(ImportSourceSpecificationProperty::unwrap))
    }

    /** Specifies the properties of data being imported from the S3 bucket source to the table. */
    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("884ed0605874e87b65400a7af7d40744c9719400be4c548fcd07b2bd0d39cfa5")
    public open fun importSourceSpecification(
        `value`: ImportSourceSpecificationProperty.Builder.() -> Unit
    ...
    public open fun kinesisStreamSpecification(): Any? =
    ...
    public open fun kinesisStreamSpecification(`value`: KinesisStreamSpecificationProperty) {
        unwrap(this)
            .setKinesisStreamSpecification(`value`.let(KinesisStreamSpecificationProperty::unwrap))
    }

    /** The Kinesis Data Streams configuration for the specified table. */
    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("67f3055a35d99211eb661364b036467d89570de32d09668f4c1518a0be43b4d2")
    public open fun kinesisStreamSpecification(
        `value`: KinesisStreamSpecificationProperty.Builder.() -> Unit
    ...
    /** The settings used to enable point in time recovery. */
    public open fun pointInTimeRecoverySpecification(
        `value`: PointInTimeRecoverySpecificationProperty
    ) {
        unwrap(this)
            .setPointInTimeRecoverySpecification(
                `value`.let(PointInTimeRecoverySpecificationProperty::unwrap)
            )
    }
    ...
    public open fun pointInTimeRecoverySpecification(
        `value`: PointInTimeRecoverySpecificationProperty.Builder.() -> Unit
    ...
    public open fun provisionedThroughput(
        `value`: ProvisionedThroughputProperty.Builder.() -> Unit
    ...
    public interface Builder {
         ...
         * doesn't wait for the index to complete creation because the backfilling phase can take a
         * long time, depending on the size of the table. You can't use the index or update the
         * table until the index's status is `ACTIVE` . You can track its status by using the
         * DynamoDB
         ...
         *   in the same update (for example, by changing the index's logical ID), the update fails.
         *
         ...
         *
         * @param globalSecondaryIndexes Global secondary indexes to be created on the table. You
         *   can create up to 20 global secondary indexes.
         */
         ...
         *
         * @param importSourceSpecification Specifies the properties of data being imported from the
         *   S3 bucket source to the table.
         */
        ...
        public fun importSourceSpecification(
            importSourceSpecification: ImportSourceSpecificationProperty.Builder.() -> Unit
        )
         ...
         *
         * @param kinesisStreamSpecification The Kinesis Data Streams configuration for the
         *   specified table.
         */
         ...
         *
         * @param provisionedThroughput Throughput for the specified table, which consists of values
        ...
        public fun provisionedThroughput(
            provisionedThroughput: ProvisionedThroughputProperty.Builder.() -> Unit
        )
         ...
         *
         * @param streamSpecification The settings for the DynamoDB table stream, which capture
         *   changes to items stored in the table.
         */
         ...
         * that ID for the table name. For more information, see
    ...
    private class BuilderImpl(
         ...
         *   S3 bucket source to the table.
         */
        override fun importSourceSpecification(
            importSourceSpecification: ImportSourceSpecificationProperty
        ) {
            cdkBuilder.importSourceSpecification(
                importSourceSpecification.let(ImportSourceSpecificationProperty::unwrap)
            )
        }
        ...
        override fun provisionedThroughput(provisionedThroughput: ProvisionedThroughputProperty) {
            cdkBuilder.provisionedThroughput(
                provisionedThroughput.let(ProvisionedThroughputProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("2af10868690ca846d0ef0b377adf5d30a2d1e276444f5ccc298395c8896292d8")
        override fun provisionedThroughput(
            provisionedThroughput: ProvisionedThroughputProperty.Builder.() -> Unit
    ...
    public interface SSESpecificationProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param sseEnabled Indicates whether server-side encryption is done using an AWS
        ...
        internal constructor(
            ...
            /**
             * Indicates whether server-side encryption is done using an AWS managed key or an AWS
             * owned key.
             *
    ...
    public interface CsvProperty {
         ...
         * imported.
         *
         * If this field is specified then the first line of each CSV file is treated as data
         * instead of the header. If this field is not specified the the first line of each CSV file
        ...
        public interface Builder {
            /**
             * @param delimiter The delimiter used for separating items in the CSV file being
             *   imported.
             */
            public fun delimiter(delimiter: String)

            /**
             * @param headerList List of the headers used to specify a common header for all source
             *   CSV files being imported. If this field is specified then the first line of each
             *   CSV file is treated as data instead of the header. If this field is not specified
        ...
        private class BuilderImpl : Builder {
             ...
             *   the the first line of each CSV file is treated as the header.
             */
            override fun headerList(vararg headerList: String): Unit =
        ...
        internal constructor(
             ...
             *
             * If this field is specified then the first line of each CSV file is treated as data
             * instead of the header. If this field is not specified the the first line of each CSV
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CsvProperty
            ): software.amazon.awscdk.services.dynamodb.CfnTable.CsvProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ImportSourceSpecificationProperty {
        ...
        public interface Builder {
            /**
             * @param inputCompressionType Type of compression to be used on the input coming from
             *   the imported table.
             */
            public fun inputCompressionType(inputCompressionType: String)

            /**
             * @param inputFormat The format of the source data. Valid values for `ImportFormat` are
             *   `CSV` , `DYNAMODB_JSON` or `ION` .
             */
            public fun inputFormat(inputFormat: String)

            /**
             * @param inputFormatOptions Additional properties that specify how the input is
             *   formatted,.
             */
            ...
            public fun inputFormatOptions(
                inputFormatOptions: InputFormatOptionsProperty.Builder.() -> Unit
            )
        ...
        private class BuilderImpl : Builder {
            ...
            override fun inputFormatOptions(inputFormatOptions: InputFormatOptionsProperty) {
                cdkBuilder.inputFormatOptions(
                    inputFormatOptions.let(InputFormatOptionsProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("ecc38bd30337caf76434b9f40f26e805f90d4539959d977a544930de7283d782")
            override fun inputFormatOptions(
                inputFormatOptions: InputFormatOptionsProperty.Builder.() -> Unit
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("d94d435bd52f7706069f0d2179a5912e53195e97d44c42e855d5b7cd8f690bc1")
            override fun s3BucketSource(
                s3BucketSource: S3BucketSourceProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ImportSourceSpecificationProperty
            ): software.amazon.awscdk.services.dynamodb.CfnTable.ImportSourceSpecificationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface KinesisStreamSpecificationProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param streamArn The ARN for a specific Kinesis data stream. Length Constraints:
             *   Minimum length of 37. Maximum length of 1024.
             */
    ...
    public interface InputFormatOptionsProperty {
        ...
        public interface Builder {
            /**
             * @param csv The options for imported source files in CSV format. The values are
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: InputFormatOptionsProperty
            ): software.amazon.awscdk.services.dynamodb.CfnTable.InputFormatOptionsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface TimeToLiveSpecificationProperty {
        ...
        public interface Builder {
            /**
             * @param attributeName The name of the TTL attribute used to store the expiration time
             *   for items in the table.
             * * The `AttributeName` property is required when enabling the TTL, or when TTL is
             *   already enabled.
             * * To update this property, you must first disable TTL and then enable TTL with the
             *   new attribute name.
             */
            public fun attributeName(attributeName: String)
    ...
    public interface ProvisionedThroughputProperty {
        ...
        public interface Builder {
             ...
             *   second before DynamoDB returns a `ThrottlingException` . For more information, see
             *   [Specifying Read and Write Requirements](https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/ProvisionedThroughput.html)
             *   in the *Amazon DynamoDB Developer Guide* .
             *
             * If read/write capacity mode is `PAY_PER_REQUEST` the value is set to 0.
            ...
            /**
             * @param writeCapacityUnits The maximum number of writes consumed per second before
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ProvisionedThroughputProperty
            ): software.amazon.awscdk.services.dynamodb.CfnTable.ProvisionedThroughputProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface GlobalSecondaryIndexProperty {
        ...
        public interface Builder {
             ...
             *   CloudWatch Contributor Insights for the specified global secondary index.
             */
            public fun contributorInsightsSpecification(
                contributorInsightsSpecification: IResolvable
            )
             ...
             *   specified global secondary index. For current minimum and maximum provisioned
             *   throughput values, see
             *   [Service, Account, and Table Quotas](https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/Limits.html)
             *   in the *Amazon DynamoDB Developer Guide* .
             */
            public fun provisionedThroughput(provisionedThroughput: IResolvable)
    ...
    public interface S3BucketSourceProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: S3BucketSourceProperty
            ): software.amazon.awscdk.services.dynamodb.CfnTable.S3BucketSourceProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
