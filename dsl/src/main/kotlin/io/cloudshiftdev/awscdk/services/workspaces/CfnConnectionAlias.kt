...
internal constructor(
    ...
    public interface Builder {
         ...
         * The connection string specified for the connection alias.
         *
         * The connection string must be in the form of a fully qualified domain name (FQDN), such
         * as `www.example.com` .
         *
    ...
    public interface ConnectionAliasAssociationProperty {
        ...
        public interface Builder {
            /**
             * @param associatedAccountId The identifier of the AWS account that associated the
            ...
            /**
             * @param connectionIdentifier The identifier of the connection alias association. You
             *   use the connection identifier in the DNS TXT record when you're configuring your
        ...
        internal constructor(
             ...
             * The identifier of the connection alias association.
             *
             * You use the connection identifier in the DNS TXT record when you're configuring your
             * DNS routing policies.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-workspaces-connectionalias-connectionaliasassociation.html#cfn-workspaces-connectionalias-connectionaliasassociation-connectionidentifier)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ConnectionAliasAssociationProperty
            ): software.amazon.awscdk.services.workspaces.CfnConnectionAlias.ConnectionAliasAssociationProperty =
