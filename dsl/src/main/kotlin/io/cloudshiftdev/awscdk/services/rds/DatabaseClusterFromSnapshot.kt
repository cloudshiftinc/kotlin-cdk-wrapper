...
internal constructor(
     ...
     * @param options
     */
    public open fun addRotationMultiUser(
        id: String,
        options: RotationMultiUserOptions
    ): SecretRotation =
        unwrap(this)
            .addRotationMultiUser(id, options.let(RotationMultiUserOptions::unwrap))
            .let(SecretRotation::wrap)
    ...
    public open fun addRotationMultiUser(
        id: String,
        options: RotationMultiUserOptions.Builder.() -> Unit
    ): SecretRotation = addRotationMultiUser(id, RotationMultiUserOptions(options))
    ...
    public open fun addRotationSingleUser(options: RotationSingleUserOptions): SecretRotation =
        unwrap(this)
            .addRotationSingleUser(options.let(RotationSingleUserOptions::unwrap))
            .let(SecretRotation::wrap)
    ...
    public open fun addRotationSingleUser(
        options: RotationSingleUserOptions.Builder.() -> Unit
     ...
     *
     * It's calculated as the value of the ServerlessDatabaseCapacity metric divided by the maximum
     * ACU value of the DB cluster.
     *
    ...
    public open fun metricServerlessDatabaseCapacity(props: MetricOptions): Metric =
        unwrap(this)
            .metricServerlessDatabaseCapacity(props.let(MetricOptions::unwrap))
            .let(Metric::wrap)
    ...
    public open fun metricServerlessDatabaseCapacity(
        props: MetricOptions.Builder.() -> Unit
    ): Metric = metricServerlessDatabaseCapacity(MetricOptions(props))
    ...
    public interface Builder {
         ...
         *
         * This feature is only supported by the Aurora MySQL database engine and cannot be enabled
         ...
         *
         * @param backtrackWindow The number of seconds to set a cluster's target backtrack window
         *   to.
         */
         ...
         * Backup settings.
         *
         * Default: - Backup retention period for automated backups is 1 day. Backup preferred
         * window is set to a 30-minute window selected at random from an 8-hour block of time for
         ...
         *
         * @param cloudwatchLogsExports The list of log types that need to be enabled for exporting
         *   to CloudWatch Logs.
         */
         ...
         *
         * @param cloudwatchLogsRetentionRole The IAM role for the Lambda function associated with
         *   the custom resource that sets the retention policy.
         */
         ...
         * Default: - true
         *
         * @param copyTagsToSnapshot Whether to copy tags to the snapshot when a snapshot is
         *   created.
         */
         ...
         *
         * Note - using this prop only works with `Credentials.fromPassword()` with the username of
         * the snapshot, `Credentials.fromUsername()` with the username and password of the snapshot
         * or `Credentials.fromSecret()` with a secret containing the username and password of the
         * snapshot.
         *
         * Default: - A username of 'admin' (or 'postgres' for PostgreSQL) and
         * SecretsManager-generated password that **will not be applied** to the cluster, use
         * `snapshotCredentials` for the correct behavior.
         *
         ...
         */
        @Deprecated(message = "deprecated in CDK") public fun credentials(credentials: Credentials)
         ...
         *
         * Default: - true if `removalPolicy` is RETAIN, `undefined` otherwise, which will not
         * enable deletion protection. To disable deletion protection after it has been enabled, you
         * must explicitly set this value to `false`.
         *
         * @param deletionProtection Indicates whether the DB cluster should have deletion
         *   protection enabled.
         */
         ...
         * given Active Directory, enabling Kerberos authentication. If not specified, the DB
         * cluster will not be associated with any Active Directory, and Kerberos authentication
         * will not be enabled.
         *
         * Default: - DB cluster is not associated with an Active Directory; Kerberos authentication
         * is not enabled.
         *
         * @param domain Directory ID for associating the DB cluster with a specific Active
         *   Directory.
         */
        ...
        /**
         * Whether to enable mapping of AWS Identity and Access Management (IAM) accounts to
         * database accounts.
         *
         * Default: false
         *
         ...
         *
         * Default: - clusterIdentifier is used with the word "Instance" appended. If
         * clusterIdentifier is not provided, the identifier is automatically generated.
         *
         ...
         */
        @Deprecated(message = "deprecated in CDK") public fun instances(instances: Number)
         ...
         * versioned engine to auto-generate a DBClusterParameterGroup.
         *
         * Default: - None
         *
         ...
         *   be specified as a range ddd:hh24:mi-ddd:hh24:mi (24H Clock UTC).
         */
        ...
        /**
         * The removal policy to apply when the cluster and its instances are removed from the stack
         * or replaced during an update.
         *
         * Default: - RemovalPolicy.SNAPSHOT (remove the cluster and instances, but retain a
         ...
         * [Documentation](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/postgresql-s3-export.html)
         *
         * @param s3ExportRole Role that will be associated with this DB cluster to enable S3
         *   export.
         */
         ...
         * [Documentation](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/AuroraPostgreSQL.Migrating.html)
         *
         * @param s3ImportRole Role that will be associated with this DB cluster to enable S3
         *   import.
         */
         ...
         * largest value that you can use is 128 (256GB).
         *
         ...
         *
         * @param serverlessV2MaxCapacity The maximum number of Aurora capacity units (ACUs) for a
         *   DB instance in an Aurora Serverless v2 cluster.
         */
         ...
         * [Documentation](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/aurora-serverless-v2.setting-capacity.html#aurora-serverless-v2.max_capacity_considerations)
         *
         * @param serverlessV2MinCapacity The minimum number of Aurora capacity units (ACUs) for a
         *   DB instance in an Aurora Serverless v2 cluster.
         */
         ...
         *
         * Note - It is not possible to change the master username for a snapshot; however, it is
         * possible to provide (or generate) a new password.
         *
         ...
         * snapshot. However, you can use only the ARN to specify a DB instance snapshot.
         *
         * @param snapshotIdentifier The identifier for the DB instance snapshot or DB cluster
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.rds.DatabaseClusterFromSnapshot.Builder.create(
                scope,
                id
            )
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("1adb134a32e72472583d4c505224d10a7e95ade94c6ab5ea49c656eed6ae8b5b")
        override fun backup(backup: BackupProps.Builder.() -> Unit): Unit =
        ...
        override fun instanceUpdateBehaviour(instanceUpdateBehaviour: InstanceUpdateBehaviour) {
            cdkBuilder.instanceUpdateBehaviour(
                instanceUpdateBehaviour.let(InstanceUpdateBehaviour::unwrap)
            )
        }
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: DatabaseClusterFromSnapshot
