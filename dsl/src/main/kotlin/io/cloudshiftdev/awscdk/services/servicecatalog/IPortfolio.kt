...
public interface IPortfolio : IResource {
     ...
     */
    public fun constrainCloudFormationParameters(
        product: IProduct,
    ...
    public fun constrainTagUpdates(
        product: IProduct,
    ...
    public fun deployWithStackSets(
        product: IProduct,
     ...
     * in. This is useful if you will be provisioning products from the account where this role
     * exists. If you intend to share the portfolio across accounts, use a local launch role.
     *
     * @param product A service catalog product.
     ...
     * Force users to assume a certain role when launching a product.
     *
     * The role name will be referenced by in the local account and must be set explicitly. This is
     * useful when sharing the portfolio with multiple accounts.
     *
     * @param product A service catalog product.
     * @param launchRole The IAM role a user must assume when provisioning the product.
     * @param options options for the constraint.
     ...
     * Force users to assume a certain role when launching a product.
     *
     * The role will be referenced by name in the local account instead of a static role arn. A role
     * with this name will automatically be created and assumable by Service Catalog in this
     * account. This is useful when sharing the portfolio with multiple accounts.
     *
     * @param product A service catalog product.
    ...
    public fun shareWithAccount(
        accountId: String,
        options: PortfolioShareOptions.Builder.() -> Unit
    )
    ...
    internal constructor(
         ...
         * @param options options for the constraint.
         */
        override fun constrainCloudFormationParameters(
            product: IProduct,
            options: CloudFormationRuleConstraintOptions
        ) {
            unwrap(this)
                .constrainCloudFormationParameters(
                    product.let(IProduct::unwrap),
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("919b36b21cc39a414fd014dc28ebcbcb3f794d52cc5f005a69d0019a3a2698f1")
        override fun constrainTagUpdates(
            product: IProduct,
            options: TagUpdateConstraintOptions.Builder.() -> Unit
        ): Unit = constrainTagUpdates(product, TagUpdateConstraintOptions(options))
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("476ed84dec221f7c2f3642fe8196cc1d576449c54c5b15ebcdb41211e260b952")
        override fun deployWithStackSets(
            product: IProduct,
            options: StackSetsConstraintOptions.Builder.() -> Unit
        ): Unit = deployWithStackSets(product, StackSetsConstraintOptions(options))
         ...
         * Force users to assume a certain role when launching a product.
         *
         * This sets the launch role using the role arn which is tied to the account this role
         * exists in. This is useful if you will be provisioning products from the account where
         * this role exists. If you intend to share the portfolio across accounts, use a local
         * launch role.
         *
         * @param product A service catalog product.
         * @param launchRole The IAM role a user must assume when provisioning the product.
         ...
         * Force users to assume a certain role when launching a product.
         *
         * The role name will be referenced by in the local account and must be set explicitly. This
        ...
        override fun localLaunchRole(product: IProduct, launchRole: IRole) {
            unwrap(this)
                .setLocalLaunchRole(product.let(IProduct::unwrap), launchRole.let(IRole::unwrap))
        }
         ...
         * Force users to assume a certain role when launching a product.
         *
         * The role will be referenced by name in the local account instead of a static role arn. A
         * role with this name will automatically be created and assumable by Service Catalog in
         * this account. This is useful when sharing the portfolio with multiple accounts.
         *
         * @param product A service catalog product.
         * @param launchRoleName The name of the IAM role a user must assume when provisioning the
         *   product.
        ...
        override fun localLaunchRoleName(product: IProduct, launchRoleName: String): IRole =
            unwrap(this)
                .setLocalLaunchRoleName(product.let(IProduct::unwrap), launchRoleName)
                .let(IRole::wrap)
        ...
        override fun notifyOnStackEvents(product: IProduct, topic: ITopic) {
            unwrap(this)
                .notifyOnStackEvents(product.let(IProduct::unwrap), topic.let(ITopic::unwrap))
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("6f9ea6bd3614654a35a908789dc09bbfdc040e68f2d5a1bbc5fd1b26439d1ad4")
        override fun shareWithAccount(
            accountId: String,
            options: PortfolioShareOptions.Builder.() -> Unit
        ): Unit = shareWithAccount(accountId, PortfolioShareOptions(options))
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: IPortfolio
        ): software.amazon.awscdk.services.servicecatalog.IPortfolio =
