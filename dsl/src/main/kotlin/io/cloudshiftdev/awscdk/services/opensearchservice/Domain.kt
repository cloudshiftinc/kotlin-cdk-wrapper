...
internal constructor(
    ...
    public open fun addAccessPolicies(
        accessPolicyStatements: PolicyStatement.Builder.() -> Unit
    ...
    public override fun metricAutomatedSnapshotFailure(props: MetricOptions): Metric =
        unwrap(this)
            .metricAutomatedSnapshotFailure(props.let(MetricOptions::unwrap))
            .let(Metric::wrap)
    ...
    public override fun metricAutomatedSnapshotFailure(
        props: MetricOptions.Builder.() -> Unit
    ...
    public override fun metricClusterIndexWritesBlocked(props: MetricOptions): Metric =
        unwrap(this)
            .metricClusterIndexWritesBlocked(props.let(MetricOptions::unwrap))
            .let(Metric::wrap)
    ...
    public override fun metricClusterIndexWritesBlocked(
        props: MetricOptions.Builder.() -> Unit
    ...
    public override fun metricMasterCpuUtilization(
        props: MetricOptions.Builder.() -> Unit
    ...
    public override fun metricMasterJvmMemoryPressure(props: MetricOptions): Metric =
        unwrap(this)
            .metricMasterJVMMemoryPressure(props.let(MetricOptions::unwrap))
            .let(Metric::wrap)
    ...
    public override fun metricMasterJvmMemoryPressure(
        props: MetricOptions.Builder.() -> Unit
    ...
    public interface Builder {
         ...
         * in the Amazon OpenSearch Service domain.
         *
         ...
         *   automated daily snapshot of the indices in the Amazon OpenSearch Service domain.
         */
         ...
         *
         * @param capacity The cluster capacity configuration for the Amazon OpenSearch Service
         *   domain.
         */
         ...
         *
         * If you specify a Route53 hosted zone it will create a CNAME record and use DNS validation
         * for the certificate
         *
         ...
         * to data nodes in the Amazon OpenSearch Service domain.
         *
        ...
        /**
         * To upgrade an Amazon OpenSearch Service domain to a new version, rather than replacing
         * the entire domain resource, use the EnableVersionUpgrade update policy.
         *
         * Default: - false
         *
         ...
         *
         * @param enableVersionUpgrade To upgrade an Amazon OpenSearch Service domain to a new
         *   version, rather than replacing the entire domain resource, use the EnableVersionUpgrade
         *   update policy.
         */
        ...
        public fun fineGrainedAccessControl(
            fineGrainedAccessControl: AdvancedSecurityOptions.Builder.() -> Unit
        )
        ...
        /**
         * Options for enabling a domain's off-peak window, during which OpenSearch Service can
         * perform mandatory configuration changes on the domain.
         *
         * Off-peak windows were introduced on February 16, 2023. All domains created before this
         * date have the off-peak window disabled by default. You must manually enable and configure
         * the off-peak window for these domains. All domains created after this date will have the
         * off-peak window enabled by default. You can't disable the off-peak window for a domain
         * after it's enabled.
         *
         * Default: - Disabled for domains created before February 16, 2023. Enabled for domains
         * created after. Enabled if `offPeakWindowStart` is set.
         *
         ...
         * if you specify 11:00 P.M. UTC as a start time, the end time will automatically be set to
         * 9:00 A.M.
         *
         * Default: - 10:00 P.M. local time
         *
         * @param offPeakWindowStart Start time for the off-peak window, in Coordinated Universal
         *   Time (UTC).
         */
         ...
         *
         * @param securityGroups The list of security groups that are associated with the VPC
         ...
         * enable logging for several domains, it may hit the quota and cause an error. By setting
         * this property to true, creating a resource policy is suppressed, allowing you to avoid
         * this problem.
         *
         ...
         *
         * @param suppressLogsResourcePolicy Specify whether to create a CloudWatch Logs resource
         *   policy or not.
         */
         ...
         *
         * If no master user is provided a default master user with username `admin` and a
         * dynamically generated password stored in KMS is created. The password can be retrieved by
         * getting `masterUserPassword` from the domain instance.
         *
         * Setting this to true will also add an access policy that allows unsigned access, enable
         * node to node encryption, encryption at rest. If conflicting settings are encountered
         * (like disabling encryption at rest) enabling this setting will cause a failure.
         *
         * Default: - false
         *
         ...
         *
         * You must provide one subnet for each Availability Zone that your domain uses. For
         * example, you must specify three subnet IDs for a three Availability Zone domain.
         *
         * Only used if `vpc` is specified.
         *
    ...
    private class BuilderImpl(
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("b40b88bb2b5642cedd586a2f5164921ad12a322b47aeee942696cfd6a12c386c")
        override fun cognitoDashboardsAuth(
            cognitoDashboardsAuth: CognitoOptions.Builder.() -> Unit
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("11b448e2542eb89487142f42a1c4ed9ecbbe3c485df90f9d6065c04682326f0d")
        override fun customEndpoint(
            customEndpoint: CustomEndpointOptions.Builder.() -> Unit
        ...
        override fun encryptionAtRest(
            encryptionAtRest: EncryptionAtRestOptions.Builder.() -> Unit
        ...
        override fun fineGrainedAccessControl(fineGrainedAccessControl: AdvancedSecurityOptions) {
            cdkBuilder.fineGrainedAccessControl(
                fineGrainedAccessControl.let(AdvancedSecurityOptions::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("722a86d44552c2afeb3222fc9be0fa31a231bf68b4389fb93795473dcee7a8de")
        override fun fineGrainedAccessControl(
            fineGrainedAccessControl: AdvancedSecurityOptions.Builder.() -> Unit
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("2dfbed53a14ef4561fd1f46cf5d9bec3bb82d355a2bc031fcaa68494bd36aa2b")
        override fun offPeakWindowStart(
            offPeakWindowStart: WindowStartTime.Builder.() -> Unit
    ...
    public companion object {
        public fun fromDomainAttributes(
            ...
            software.amazon.awscdk.services.opensearchservice.Domain.fromDomainAttributes(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    attrs.let(DomainAttributes::unwrap)
                )
                .let(IDomain::wrap)
        ...
        public fun fromDomainEndpoint(
            ...
            software.amazon.awscdk.services.opensearchservice.Domain.fromDomainEndpoint(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    domainEndpoint
                )
        ...
        ): Domain = Domain(cdkObject)

        internal fun unwrap(
            wrapped: Domain
        ): software.amazon.awscdk.services.opensearchservice.Domain = wrapped.cdkObject
    }
}
