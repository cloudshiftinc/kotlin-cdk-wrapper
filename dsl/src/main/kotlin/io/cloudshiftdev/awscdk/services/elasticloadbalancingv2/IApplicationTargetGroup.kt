...
public interface IApplicationTargetGroup : ITargetGroup {
  ...
  private class Wrapper internal constructor(
    ...
    public override fun addTarget(arg0: IApplicationLoadBalancerTarget) {
    ...
    public override fun registerConnectable(arg0: IConnectable) {
    ...
    public override fun registerListener(arg0: IApplicationListener) {
      unwrap(this).registerListener(arg0.let(IApplicationListener::unwrap))
    }

    public override fun registerListener(arg0: IApplicationListener, arg1: IConstruct) {
      unwrap(this).registerListener(arg0.let(IApplicationListener::unwrap),
