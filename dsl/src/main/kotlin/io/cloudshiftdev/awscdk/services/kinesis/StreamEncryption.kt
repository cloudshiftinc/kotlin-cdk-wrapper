...
public enum class StreamEncryption(
    ...
    public companion object {
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.kinesis.StreamEncryption
        ): StreamEncryption =
            when (cdkObject) {
                ...
                software.amazon.awscdk.services.kinesis.StreamEncryption.MANAGED ->
                    StreamEncryption.MANAGED
            }

        internal fun unwrap(
            wrapped: StreamEncryption
