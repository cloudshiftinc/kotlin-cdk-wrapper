...
public interface IHttpApi : IApi {
    ...
    internal constructor(
         ...
         * When 'ANY' is passed to the method, an ARN with the method set to '*' is obtained.
         *
         * Default: - The default behavior applies when no specific method, path, or stage is
         * provided. In this case, the ARN will cover all methods, all resources, and all stages of
         * this API. Specifically, if 'method' is not specified, it defaults to '*', representing
         * all methods. If 'path' is not specified, it defaults to '/ *', representing all paths. If
         * 'stage' is not specified, it also defaults to '*', representing all stages.
         *
         * @param method
         * @param path
         * @param stage
         ...
         * @param stage
         */
        override fun arnForExecuteApi(method: String): String =
         ...
         * @param props
         */
        override fun metricClientError(): Metric =
        ...
        override fun metricIntegrationLatency(props: MetricOptions): Metric =
            unwrap(this)
                .metricIntegrationLatency(props.let(MetricOptions::unwrap))
                .let(Metric::wrap)
         ...
         * @param props
         */
        override fun metricServerError(): Metric =
    ...
    public companion object {
        ...
        ): IHttpApi = Wrapper(cdkObject)

        internal fun unwrap(
            wrapped: IHttpApi
        ): software.amazon.awscdk.services.apigatewayv2.IHttpApi = (wrapped as Wrapper).cdkObject
    }
}
