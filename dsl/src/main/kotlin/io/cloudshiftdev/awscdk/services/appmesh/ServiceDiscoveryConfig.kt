...
public interface ServiceDiscoveryConfig {
    ...
    public interface Builder {
        ...
        public fun cloudmap(
            cloudmap: CfnVirtualNode.AwsCloudMapServiceDiscoveryProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl : Builder {
        ...
        override fun cloudmap(cloudmap: CfnVirtualNode.AwsCloudMapServiceDiscoveryProperty) {
            cdkBuilder.cloudmap(
                cloudmap.let(CfnVirtualNode.AwsCloudMapServiceDiscoveryProperty::unwrap)
            )
        }
    ...
    internal constructor(
        ...
        override fun cloudmap(): CfnVirtualNode.AwsCloudMapServiceDiscoveryProperty? =
            unwrap(this)
                .getCloudmap()
                ?.let(CfnVirtualNode.AwsCloudMapServiceDiscoveryProperty::wrap)
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: ServiceDiscoveryConfig
