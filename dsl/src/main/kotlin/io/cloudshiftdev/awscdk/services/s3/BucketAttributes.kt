...
public interface BucketAttributes {
     ...
     *
     * If the underlying value of ARN is a string, the name will be parsed from the ARN. Otherwise,
     * the name is optional, but some features that require the bucket name such as auto-creating a
     * bucket policy, won't work.
     */
     ...
     *   `region`. Always provide the bucket region if the `bucketWebsiteUrl` will be used.
     ...
     *
     * Features that require the region (e.g. `bucketWebsiteUrl`) won't fully work if the region
    ...
    public interface Builder {
        ...
        /**
         * @param bucketArn The ARN of the bucket. At least one of bucketArn or bucketName must be
        ...
        /**
         * @param bucketName The name of the bucket. If the underlying value of ARN is a string, the
         *   name will be parsed from the ARN. Otherwise, the name is optional, but some features
         *   that require the bucket name such as auto-creating a bucket policy, won't work.
         */
        ...
        /**
         * @param bucketWebsiteNewUrlFormat Force the format of the website URL of the bucket. This
         *   should be true for regions launched since 2014.
         * @deprecated The correct website url format can be inferred automatically from the bucket
         *   `region`. Always provide the bucket region if the `bucketWebsiteUrl` will be used.
         *   Alternatively provide the full `bucketWebsiteUrl` manually.
         */
        ...
        /**
         * @param region The region this existing bucket is in. Features that require the region
         *   (e.g. `bucketWebsiteUrl`) won't fully work if the region cannot be correctly inferred.
         */
    ...
    internal constructor(
         ...
         * The ARN of the bucket.
         *
         * At least one of bucketArn or bucketName must be defined in order to initialize a bucket
         * ref.
         */
         ...
         * The name of the bucket.
         *
         * If the underlying value of ARN is a string, the name will be parsed from the ARN.
         * Otherwise, the name is optional, but some features that require the bucket name such as
         * auto-creating a bucket policy, won't work.
         */
        override fun bucketName(): String? = unwrap(this).getBucketName()

        /** The regional domain name of the specified bucket. */
        override fun bucketRegionalDomainName(): String? =
         ...
         */
        @Deprecated(message = "deprecated in CDK")
        override fun bucketWebsiteNewUrlFormat(): Boolean? =
