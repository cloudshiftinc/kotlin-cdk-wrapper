...
internal constructor(
    ...
    public open fun bind(scope: Construct): SubjectAlternativeNamesMatcherConfig =
        unwrap(this)
            .bind(scope.let(Construct::unwrap))
            .let(SubjectAlternativeNamesMatcherConfig::wrap)
    ...
    public companion object {
        public fun matchingExactly(names: String): SubjectAlternativeNames =
            software.amazon.awscdk.services.appmesh.SubjectAlternativeNames.matchingExactly(names)
                .let(SubjectAlternativeNames::wrap)
        ...
        internal fun unwrap(
            wrapped: SubjectAlternativeNames
