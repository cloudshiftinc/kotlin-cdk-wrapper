...
internal constructor(
    ...
    private class BuilderImpl(
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("94678fbe23b8920d06561e2226c4cfaf721f1b3ec79ed52a301a0ffc478061ed")
        override fun authParameters(
            authParameters: AuthParametersProperty.Builder.() -> Unit
        ...
        public fun build(): software.amazon.awscdk.services.events.CfnConnection =
            cdkBuilder.build()
    }
    ...
    public interface BasicAuthParametersProperty {
        ...
        public interface Builder {
            /**
             * @param password The password associated with the user name to use for Basic
             *   authorization.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: BasicAuthParametersProperty
            ): software.amazon.awscdk.services.events.CfnConnection.BasicAuthParametersProperty =
    ...
    public interface ClientParametersProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ClientParametersProperty
            ): software.amazon.awscdk.services.events.CfnConnection.ClientParametersProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ApiKeyAuthParametersProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ApiKeyAuthParametersProperty
            ): software.amazon.awscdk.services.events.CfnConnection.ApiKeyAuthParametersProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ConnectionHttpParametersProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ConnectionHttpParametersProperty
            ): software.amazon.awscdk.services.events.CfnConnection.ConnectionHttpParametersProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface AuthParametersProperty {
        ...
        public interface Builder {
            ...
            public fun apiKeyAuthParameters(
                apiKeyAuthParameters: ApiKeyAuthParametersProperty.Builder.() -> Unit
            )
            ...
            public fun basicAuthParameters(
                basicAuthParameters: BasicAuthParametersProperty.Builder.() -> Unit
            )

            /**
             * @param invocationHttpParameters Additional parameters for the connection that are
             *   passed through with every invocation to the HTTP endpoint.
             */
             ...
             *   passed through with every invocation to the HTTP endpoint.
             */
            public fun invocationHttpParameters(
            ...
            public fun invocationHttpParameters(
                invocationHttpParameters: ConnectionHttpParametersProperty.Builder.() -> Unit
            )
        ...
        private class BuilderImpl : Builder {
            ...
            override fun apiKeyAuthParameters(apiKeyAuthParameters: ApiKeyAuthParametersProperty) {
                cdkBuilder.apiKeyAuthParameters(
                    apiKeyAuthParameters.let(ApiKeyAuthParametersProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("723a82afcbbfa2ecd48766393c12b31448f0fac2c63f0643fcc5587494b8dccf")
            override fun apiKeyAuthParameters(
                apiKeyAuthParameters: ApiKeyAuthParametersProperty.Builder.() -> Unit
            ...
            override fun basicAuthParameters(basicAuthParameters: BasicAuthParametersProperty) {
                cdkBuilder.basicAuthParameters(
                    basicAuthParameters.let(BasicAuthParametersProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("e8391c04181ee307d13f27c4c07e9b7cb8da421d5c7083f0daa00b60cb0c742c")
            override fun basicAuthParameters(
                basicAuthParameters: BasicAuthParametersProperty.Builder.() -> Unit
            ...
            override fun invocationHttpParameters(invocationHttpParameters: IResolvable) {
                cdkBuilder.invocationHttpParameters(
                    invocationHttpParameters.let(IResolvable::unwrap)
                )
            }
             ...
             *   passed through with every invocation to the HTTP endpoint.
             */
            override fun invocationHttpParameters(
                invocationHttpParameters: ConnectionHttpParametersProperty
            ) {
                cdkBuilder.invocationHttpParameters(
                    invocationHttpParameters.let(ConnectionHttpParametersProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("1971362123bfe5682d0da49ac80108ae47f27a7beb3908b1961a0c1574b9db2e")
            override fun oAuthParameters(
                oAuthParameters: OAuthParametersProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-events-connection-authparameters.html#cfn-events-connection-authparameters-invocationhttpparameters)
             */
            override fun invocationHttpParameters(): Any? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AuthParametersProperty
            ): software.amazon.awscdk.services.events.CfnConnection.AuthParametersProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface OAuthParametersProperty {
        ...
        public interface Builder {
            /**
             * @param authorizationEndpoint The URL to the authorization endpoint when OAuth is
            ...
            public fun clientParameters(
                clientParameters: ClientParametersProperty.Builder.() -> Unit
            )
            ...
            /**
             * @param oAuthHttpParameters A `ConnectionHttpParameters` object that contains details
             *   about the additional parameters to use for the connection.
             */
            ...
            public fun oAuthHttpParameters(
                oAuthHttpParameters: ConnectionHttpParametersProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
             ...
             *   about the additional parameters to use for the connection.
             */
            override fun oAuthHttpParameters(
                oAuthHttpParameters: ConnectionHttpParametersProperty
            ) {
                cdkBuilder.oAuthHttpParameters(
                    oAuthHttpParameters.let(ConnectionHttpParametersProperty::unwrap)
                )
            }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: OAuthParametersProperty
            ): software.amazon.awscdk.services.events.CfnConnection.OAuthParametersProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
