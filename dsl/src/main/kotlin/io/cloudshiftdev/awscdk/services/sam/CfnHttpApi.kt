...
internal constructor(
    ...
    public open fun corsConfiguration(
        `value`: CorsConfigurationObjectProperty.Builder.() -> Unit
    ...
    public interface Builder {
        ...
        public fun corsConfiguration(
            corsConfiguration: CorsConfigurationObjectProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
        ...
        override fun corsConfiguration(corsConfiguration: CorsConfigurationObjectProperty) {
            cdkBuilder.corsConfiguration(
                corsConfiguration.let(CorsConfigurationObjectProperty::unwrap)
            )
        }
    ...
    public interface AccessLogSettingProperty {
        ...
        public companion object {
            ...
            internal fun wrap(
                cdkObject: software.amazon.awscdk.services.sam.CfnHttpApi.AccessLogSettingProperty
    ...
    public interface Route53ConfigurationProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: Route53ConfigurationProperty
            ): software.amazon.awscdk.services.sam.CfnHttpApi.Route53ConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface HttpApiAuthProperty {
        ...
        public companion object {
            ...
            internal fun wrap(
                cdkObject: software.amazon.awscdk.services.sam.CfnHttpApi.HttpApiAuthProperty
            ): HttpApiAuthProperty = Wrapper(cdkObject)

            internal fun unwrap(
                wrapped: HttpApiAuthProperty
            ): software.amazon.awscdk.services.sam.CfnHttpApi.HttpApiAuthProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface S3LocationProperty {
        ...
        public companion object {
            ...
            internal fun wrap(
                cdkObject: software.amazon.awscdk.services.sam.CfnHttpApi.S3LocationProperty
    ...
    public interface CorsConfigurationObjectProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CorsConfigurationObjectProperty
            ): software.amazon.awscdk.services.sam.CfnHttpApi.CorsConfigurationObjectProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface RouteSettingsProperty {
        ...
        public companion object {
            ...
            internal fun wrap(
                cdkObject: software.amazon.awscdk.services.sam.CfnHttpApi.RouteSettingsProperty
    ...
    public interface HttpApiDomainConfigurationProperty {
        ...
        private class BuilderImpl : Builder {
            ...
            override fun mutualTlsAuthentication(
                ...
                mutualTlsAuthentication(MutualTlsAuthenticationProperty(mutualTlsAuthentication))
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: HttpApiDomainConfigurationProperty
            ): software.amazon.awscdk.services.sam.CfnHttpApi.HttpApiDomainConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
