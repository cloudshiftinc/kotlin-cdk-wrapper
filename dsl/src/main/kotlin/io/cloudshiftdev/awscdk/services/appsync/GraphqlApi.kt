...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * The Route 53 hosted zone and CName DNS record must be configured in addition to this
         * setting to enable custom domain URL
         *
        ...
        /**
         * A value indicating whether the API to enable (ENABLED) or disable (DISABLED)
         * introspection.
         *
         * Default: IntrospectionConfig.ENABLED
         *
         * @param introspectionConfig A value indicating whether the API to enable (ENABLED) or
         ...
         *
         * SchemaFile.fromAsset(filePath: string) allows schema definition through schema.graphql
         * file
         *
         ...
         */
        @Deprecated(message = "deprecated in CDK") public fun schema(schema: ISchema)

        /**
         * A value indicating whether the API is accessible from anywhere (GLOBAL) or can only be
         * access from a VPC (PRIVATE).
         *
         * Default: - GLOBAL
         *
         * @param visibility A value indicating whether the API is accessible from anywhere (GLOBAL)
         *   or can only be access from a VPC (PRIVATE).
         */
         ...
         * Default: - false
         *
         * @param xrayEnabled A flag indicating whether or not X-Ray tracing is enabled for the
         *   GraphQL API.
         */
    ...
    private class BuilderImpl(
        ...
        override fun authorizationConfig(
            authorizationConfig: AuthorizationConfig.Builder.() -> Unit
    ...
    public companion object {
        public fun fromGraphqlApiAttributes(
            ...
            software.amazon.awscdk.services.appsync.GraphqlApi.fromGraphqlApiAttributes(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    attrs.let(GraphqlApiAttributes::unwrap)
                )
                .let(IGraphqlApi::wrap)
        ...
        ): GraphqlApi = GraphqlApi(cdkObject)

        internal fun unwrap(
            wrapped: GraphqlApi
        ): software.amazon.awscdk.services.appsync.GraphqlApi = wrapped.cdkObject
    }
}
