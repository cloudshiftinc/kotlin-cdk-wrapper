...
public interface IHttpAuthorizer : IAuthorizer {
    ...
    public companion object {
        ...
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.apigatewayv2.IHttpAuthorizer
        ): IHttpAuthorizer = Wrapper(cdkObject)

        internal fun unwrap(
            wrapped: IHttpAuthorizer
        ): software.amazon.awscdk.services.apigatewayv2.IHttpAuthorizer =
