...
internal constructor(
     ...
     *
     * The default is 1 for all new services and uses the existing services desired count when
     * updating an existing service, if one is not provided.
     */
    ...
    /**
     * (deprecated) The default Application Load Balancer for the service (first added load
     * balancer).
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: ApplicationMultipleTargetGroupsServiceBase
        ): software.amazon.awscdk.services.ecs.patterns.ApplicationMultipleTargetGroupsServiceBase =
