...
public interface AttachInitOptions {
     ...
     * the config changes, the UserData changes and the instance will be replaced.
     *
     * If `false`, no such hash will be embedded, and if the CloudFormation Init config changes
     * nothing will happen to the running instance.
     *
     * Default: true
     */
    ...
    public interface Builder {
        ...
        /**
         * @param embedFingerprint Whether to embed a hash into the userData. If `true` (the
         *   default), a hash of the config will be embedded into the UserData, so that if the
         *   config changes, the UserData changes and the instance will be replaced.
         *
         * If `false`, no such hash will be embedded, and if the CloudFormation Init config changes
         * nothing will happen to the running instance.
         */
        ...
        /**
         * @param signalResource When provided, signals this resource instead of the attached
         *   resource. You can use this to support signaling LaunchTemplate while attaching
         *   AutoScalingGroup
         */
    ...
    private class BuilderImpl : Builder {
        ...
        public fun build(): software.amazon.awscdk.services.ec2.AttachInitOptions =
            cdkBuilder.build()
    }
    ...
    internal constructor(
         ...
         * if the config changes, the UserData changes and the instance will be replaced.
         *
         * If `false`, no such hash will be embedded, and if the CloudFormation Init config changes
         * nothing will happen to the running instance.
         *
