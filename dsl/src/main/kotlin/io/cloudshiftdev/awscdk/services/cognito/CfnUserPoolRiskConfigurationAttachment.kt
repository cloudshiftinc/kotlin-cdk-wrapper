...
internal constructor(
     ...
     * and `Actions` to take if there is an account takeover.
     */
    public open fun accountTakeoverRiskConfiguration(
        `value`: AccountTakeoverRiskConfigurationTypeProperty
    ) {
        unwrap(this)
            .setAccountTakeoverRiskConfiguration(
                `value`.let(AccountTakeoverRiskConfigurationTypeProperty::unwrap)
            )
    }
    ...
    public open fun accountTakeoverRiskConfiguration(
        `value`: AccountTakeoverRiskConfigurationTypeProperty.Builder.() -> Unit
    ): Unit =
        accountTakeoverRiskConfiguration(AccountTakeoverRiskConfigurationTypeProperty(`value`))
     ...
     * `EventAction` .
     */
    public open fun compromisedCredentialsRiskConfiguration(
        `value`: CompromisedCredentialsRiskConfigurationTypeProperty
    ) {
        unwrap(this)
            .setCompromisedCredentialsRiskConfiguration(
                `value`.let(CompromisedCredentialsRiskConfigurationTypeProperty::unwrap)
            )
    }
    ...
    public open fun compromisedCredentialsRiskConfiguration(
        `value`: CompromisedCredentialsRiskConfigurationTypeProperty.Builder.() -> Unit
    ): Unit =
        compromisedCredentialsRiskConfiguration(
            CompromisedCredentialsRiskConfigurationTypeProperty(`value`)
        )
    ...
    public open fun riskExceptionConfiguration(): Any? =
        unwrap(this).getRiskExceptionConfiguration()
    ...
    public open fun riskExceptionConfiguration(`value`: RiskExceptionConfigurationTypeProperty) {
        unwrap(this)
            .setRiskExceptionConfiguration(
                `value`.let(RiskExceptionConfigurationTypeProperty::unwrap)
            )
    }
    ...
    public open fun riskExceptionConfiguration(
        `value`: RiskExceptionConfigurationTypeProperty.Builder.() -> Unit
    ...
    public interface Builder {
        ...
        public fun accountTakeoverRiskConfiguration(
            accountTakeoverRiskConfiguration:
                AccountTakeoverRiskConfigurationTypeProperty.Builder.() -> Unit
        )

        /**
         * The app client ID.
         *
         * You can specify the risk configuration for a single client (with a specific ClientId) or
        ...
        /**
         * The compromised credentials risk configuration object, including the `EventFilter` and
         * the `EventAction` .
         *
         ...
         *
         * @param compromisedCredentialsRiskConfiguration The compromised credentials risk
         *   configuration object, including the `EventFilter` and the `EventAction` .
         */
        ...
        public fun compromisedCredentialsRiskConfiguration(
            compromisedCredentialsRiskConfiguration:
                CompromisedCredentialsRiskConfigurationTypeProperty.Builder.() -> Unit
        )
        ...
        public fun riskExceptionConfiguration(
            riskExceptionConfiguration: RiskExceptionConfigurationTypeProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
         ...
         *   takeover.
         */
        override fun accountTakeoverRiskConfiguration(
            accountTakeoverRiskConfiguration: IResolvable
        ) {
            cdkBuilder.accountTakeoverRiskConfiguration(
                accountTakeoverRiskConfiguration.let(IResolvable::unwrap)
            )
        }
        ...
        override fun accountTakeoverRiskConfiguration(
            ...
            cdkBuilder.accountTakeoverRiskConfiguration(
                accountTakeoverRiskConfiguration.let(
                    AccountTakeoverRiskConfigurationTypeProperty::unwrap
                )
            )
        }
         ...
         *   configuration object, including the `EventFilter` and the `EventAction` .
         */
        override fun compromisedCredentialsRiskConfiguration(
            compromisedCredentialsRiskConfiguration: IResolvable
        ) {
            cdkBuilder.compromisedCredentialsRiskConfiguration(
                compromisedCredentialsRiskConfiguration.let(IResolvable::unwrap)
            )
        }
        ...
        override fun compromisedCredentialsRiskConfiguration(
            ...
            cdkBuilder.compromisedCredentialsRiskConfiguration(
                compromisedCredentialsRiskConfiguration.let(
                    CompromisedCredentialsRiskConfigurationTypeProperty::unwrap
                )
            )
        }
        ...
        override fun riskExceptionConfiguration(riskExceptionConfiguration: IResolvable) {
            cdkBuilder.riskExceptionConfiguration(
                riskExceptionConfiguration.let(IResolvable::unwrap)
            )
        }
        ...
        override fun riskExceptionConfiguration(
            ...
            cdkBuilder.riskExceptionConfiguration(
                riskExceptionConfiguration.let(RiskExceptionConfigurationTypeProperty::unwrap)
            )
        }
        ...
        override fun riskExceptionConfiguration(
            ...
            riskExceptionConfiguration(
                RiskExceptionConfigurationTypeProperty(riskExceptionConfiguration)
            )
    ...
    public companion object {
        ...
        internal fun wrap(
            ...
            CfnUserPoolRiskConfigurationAttachment(cdkObject)

        internal fun unwrap(
            wrapped: CfnUserPoolRiskConfigurationAttachment
        ): software.amazon.awscdk.services.cognito.CfnUserPoolRiskConfigurationAttachment =
            wrapped.cdkObject
    }
    ...
    public interface AccountTakeoverActionTypeProperty {
        ...
        public interface Builder {
            /**
             * @param eventAction The action to take in response to the account takeover action.
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AccountTakeoverActionTypeProperty
            ): software.amazon.awscdk.services.cognito.CfnUserPoolRiskConfigurationAttachment.AccountTakeoverActionTypeProperty =
    ...
    public interface NotifyEmailTypeProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: NotifyEmailTypeProperty
            ): software.amazon.awscdk.services.cognito.CfnUserPoolRiskConfigurationAttachment.NotifyEmailTypeProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CompromisedCredentialsActionsTypeProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CompromisedCredentialsActionsTypeProperty
            ): software.amazon.awscdk.services.cognito.CfnUserPoolRiskConfigurationAttachment.CompromisedCredentialsActionsTypeProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface AccountTakeoverRiskConfigurationTypeProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param notifyConfiguration The notify configuration used to construct email
             *   notifications.
             */
            ...
            public fun notifyConfiguration(
                notifyConfiguration: NotifyConfigurationTypeProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun actions(
                actions: AccountTakeoverActionsTypeProperty.Builder.() -> Unit
            ...
            override fun notifyConfiguration(notifyConfiguration: NotifyConfigurationTypeProperty) {
                cdkBuilder.notifyConfiguration(
                    notifyConfiguration.let(NotifyConfigurationTypeProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("92517bde806b2d8246e6e681dd7ac5e32a2ea81f8ffd5c47a0953c0292176731")
            override fun notifyConfiguration(
                notifyConfiguration: NotifyConfigurationTypeProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AccountTakeoverRiskConfigurationTypeProperty
            ): software.amazon.awscdk.services.cognito.CfnUserPoolRiskConfigurationAttachment.AccountTakeoverRiskConfigurationTypeProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface NotifyConfigurationTypeProperty {
         ...
         *
         * The address must be either individually verified with Amazon Simple Email Service, or
        ...
        /**
         * The multi-factor authentication (MFA) email template used when MFA is challenged as part
         * of a detected risk.
         *
        ...
        public interface Builder {
             ...
             *   individually verified with Amazon Simple Email Service, or from a domain that has
             ...
             *   with the sending authorization policy. This identity permits Amazon Cognito to send
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("7e2f3d6291590c7dfd8efc873f1d0aa953980e8e9719ea7f682e29a72c97a7cb")
            override fun noActionEmail(
                noActionEmail: NotifyEmailTypeProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: NotifyConfigurationTypeProperty
            ): software.amazon.awscdk.services.cognito.CfnUserPoolRiskConfigurationAttachment.NotifyConfigurationTypeProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface AccountTakeoverActionsTypeProperty {
        ...
        public interface Builder {
            ...
            public fun mediumAction(
                mediumAction: AccountTakeoverActionTypeProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("70360ca930418d113c3f4f29d74bc50c78c8d0a8793e26af75eb1c32ddf009d2")
            override fun highAction(
                highAction: AccountTakeoverActionTypeProperty.Builder.() -> Unit
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("fb015d149cc8017ed15bddd8e6ff46fc0e53195f831d12fc31fe005305b98829")
            override fun lowAction(
                lowAction: AccountTakeoverActionTypeProperty.Builder.() -> Unit
            ): Unit = lowAction(AccountTakeoverActionTypeProperty(lowAction))
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AccountTakeoverActionsTypeProperty
            ): software.amazon.awscdk.services.cognito.CfnUserPoolRiskConfigurationAttachment.AccountTakeoverActionsTypeProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface RiskExceptionConfigurationTypeProperty {
         ...
         *
         * The IP range is in CIDR notation, a compact representation of an IP address and its
         * routing prefix.
         *
         ...
         */
        public fun blockedIpRangeList(): List<String> =
            unwrap(this).getBlockedIpRangeList() ?: emptyList()
         ...
         */
        public fun skippedIpRangeList(): List<String> =
            unwrap(this).getSkippedIpRangeList() ?: emptyList()
        ...
        public interface Builder {
             ...
             *   pre-authentication requests. The IP range is in CIDR notation, a compact
            ...
            /**
             * @param skippedIpRangeList Risk detection isn't performed on the IP addresses in this
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-cognito-userpoolriskconfigurationattachment-riskexceptionconfigurationtype.html#cfn-cognito-userpoolriskconfigurationattachment-riskexceptionconfigurationtype-blockediprangelist)
             */
            override fun blockedIpRangeList(): List<String> =
                unwrap(this).getBlockedIpRangeList() ?: emptyList()
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-cognito-userpoolriskconfigurationattachment-riskexceptionconfigurationtype.html#cfn-cognito-userpoolriskconfigurationattachment-riskexceptionconfigurationtype-skippediprangelist)
             */
            override fun skippedIpRangeList(): List<String> =
                unwrap(this).getSkippedIpRangeList() ?: emptyList()
        }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RiskExceptionConfigurationTypeProperty
            ): software.amazon.awscdk.services.cognito.CfnUserPoolRiskConfigurationAttachment.RiskExceptionConfigurationTypeProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CompromisedCredentialsRiskConfigurationTypeProperty {
        ...
        public interface Builder {
            ...
            public fun actions(
                actions: CompromisedCredentialsActionsTypeProperty.Builder.() -> Unit
            )

            /**
             * @param eventFilter Perform the action for these events. The default is to perform all
        ...
        private class BuilderImpl : Builder {
             ...
             *   events if no event filter is specified.
             */
            override fun eventFilter(vararg eventFilter: String): Unit =
                eventFilter(eventFilter.toList())
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CompromisedCredentialsRiskConfigurationTypeProperty
            ): software.amazon.awscdk.services.cognito.CfnUserPoolRiskConfigurationAttachment.CompromisedCredentialsRiskConfigurationTypeProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
