...
internal constructor(
    ...
    public companion object {
        public fun availabilityZones(availabilityZones: List<String>): SubnetFilter =
            software.amazon.awscdk.services.ec2.SubnetFilter.availabilityZones(availabilityZones)
                .let(SubnetFilter::wrap)
        ...
        public fun byCidrMask(mask: Number): SubnetFilter =
            software.amazon.awscdk.services.ec2.SubnetFilter.byCidrMask(mask)
                .let(SubnetFilter::wrap)

        public fun byCidrRanges(cidrs: List<String>): SubnetFilter =
            software.amazon.awscdk.services.ec2.SubnetFilter.byCidrRanges(cidrs)
                .let(SubnetFilter::wrap)
        ...
        public fun byIds(subnetIds: List<String>): SubnetFilter =
            software.amazon.awscdk.services.ec2.SubnetFilter.byIds(subnetIds)
                .let(SubnetFilter::wrap)
        ...
        public fun containsIpAddresses(ipv4addrs: List<String>): SubnetFilter =
            software.amazon.awscdk.services.ec2.SubnetFilter.containsIpAddresses(ipv4addrs)
                .let(SubnetFilter::wrap)
        ...
        ): SubnetFilter = Wrapper(cdkObject)

        internal fun unwrap(
            wrapped: SubnetFilter
        ): software.amazon.awscdk.services.ec2.SubnetFilter = (wrapped as Wrapper).cdkObject
    }
}
