...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.glue.CfnClassifier,
    ...
    private class BuilderImpl(
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("5a8cd8b96e073bdb847bc460ed59f4f7357908441cfcd779bb731890445b35b2")
        override fun grokClassifier(
            grokClassifier: GrokClassifierProperty.Builder.() -> Unit
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("6f5deea49f8ca1c3de74ecacde35e74f6854219187c2773523245488e79e45a4")
        override fun jsonClassifier(
            jsonClassifier: JsonClassifierProperty.Builder.() -> Unit
    ...
    public companion object {
        ...
        ): CfnClassifier = CfnClassifier(cdkObject)

        internal fun unwrap(
            wrapped: CfnClassifier
        ): software.amazon.awscdk.services.glue.CfnClassifier = wrapped.cdkObject
    }
    ...
    public interface JsonClassifierProperty {
        ...
        public interface Builder {
            /**
             * @param jsonPath A `JsonPath` string defining the JSON data for the classifier to
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: JsonClassifierProperty
            ): software.amazon.awscdk.services.glue.CfnClassifier.JsonClassifierProperty =
    ...
    public interface GrokClassifierProperty {
         ...
         *
         * For more information, see custom patterns in
         ...
         *
         * For more information, see built-in patterns in
         * [Writing Custom Classifiers](https://docs.aws.amazon.com/glue/latest/dg/custom-classifier.html)
         * .
         *
        ...
        public interface Builder {
            ...
            /**
             * @param customPatterns Optional custom grok patterns defined by this classifier. For
             *   more information, see custom patterns in
             *   [Writing Custom Classifiers](https://docs.aws.amazon.com/glue/latest/dg/custom-classifier.html)
             *   .
             */
            ...
            /**
             * @param grokPattern The grok pattern applied to a data store by this classifier. For
             *   more information, see built-in patterns in
             *   [Writing Custom Classifiers](https://docs.aws.amazon.com/glue/latest/dg/custom-classifier.html)
             *   .
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: GrokClassifierProperty
            ): software.amazon.awscdk.services.glue.CfnClassifier.GrokClassifierProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CsvClassifierProperty {
         ...
         */
        public fun containsCustomDatatype(): List<String> =
        ...
        public interface Builder {
            /**
             * @param allowSingleColumn Enables the processing of files that contain only one
             *   column.
             */
            ...
            /**
             * @param containsCustomDatatype Indicates whether the CSV file contains custom data
             *   types.
             */
            ...
            /**
             * @param containsHeader Indicates whether the CSV file contains a header. A value of
             *   `UNKNOWN` specifies that the classifier will detect whether the CSV file contains
             *   headings.
             *
             * A value of `PRESENT` specifies that the CSV file contains headings.
             *
            ...
            /**
             * @param delimiter A custom symbol to denote what separates each column entry in the
             *   row.
             */
            public fun delimiter(delimiter: String)

            /**
             * @param disableValueTrimming Specifies not to trim values before identifying the type
            ...
            /**
             * @param quoteSymbol A custom symbol to denote what combines content into a single
        ...
        private class BuilderImpl : Builder {
            ...
            override fun customDatatypeConfigured(customDatatypeConfigured: IResolvable) {
                cdkBuilder.customDatatypeConfigured(
                    customDatatypeConfigured.let(IResolvable::unwrap)
                )
            }
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-glue-classifier-csvclassifier.html#cfn-glue-classifier-csvclassifier-containscustomdatatype)
             */
            override fun containsCustomDatatype(): List<String> =
                unwrap(this).getContainsCustomDatatype() ?: emptyList()
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-glue-classifier-csvclassifier.html#cfn-glue-classifier-csvclassifier-customdatatypeconfigured)
             */
            override fun customDatatypeConfigured(): Any? =
    ...
    public interface XMLClassifierProperty {
         ...
         * parsed.
         *
         * This can't identify a self-closing element (closed by `/&gt;` ). An empty row element
        ...
        public interface Builder {
             ...
             *   item_b="B"&gt;&lt;/row&gt;` is okay, but `&lt;row item_a="A" item_b="B" /&gt;` is
             *   not).
             */
        ...
        internal constructor(
             ...
             *
             * This can't identify a self-closing element (closed by `/&gt;` ). An empty row element
             * that contains only attributes can be parsed as long as it ends with a closing tag
             * (for example, `&lt;row item_a="A" item_b="B"&gt;&lt;/row&gt;` is okay, but `&lt;row
