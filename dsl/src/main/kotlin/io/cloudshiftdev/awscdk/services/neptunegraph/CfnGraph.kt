...
internal constructor(
    ...
    public open fun vectorSearchConfiguration(`value`: VectorSearchConfigurationProperty) {
        unwrap(this)
            .setVectorSearchConfiguration(`value`.let(VectorSearchConfigurationProperty::unwrap))
    }
    ...
    public open fun vectorSearchConfiguration(
        `value`: VectorSearchConfigurationProperty.Builder.() -> Unit
    ...
    public interface Builder {
         ...
         *
         * @param deletionProtection A value that indicates whether the graph has deletion
         *   protection enabled.
         */
         ...
         *
         * If you don't specify a graph name, a unique graph name is generated for you using the
         * prefix `graph-for` , followed by a combination of `Stack Name` and a `UUID` .
         *
         ...
         *
         * @param provisionedMemory The provisioned memory-optimized Neptune Capacity Units (m-NCUs)
         *   to use for the graph.
         */
        public fun provisionedMemory(provisionedMemory: Number)

        /**
         * Specifies whether or not the graph can be reachable over the internet. All access to
         * graphs is IAM authenticated.
         *
         * When the graph is publicly available, its domain name system (DNS) endpoint resolves to
         * the public IP address from the internet. When the graph isn't publicly available, you
         * need to create a `PrivateGraphEndpoint` in a given VPC to ensure the DNS name resolves to
         * a private IP address that is reachable from the VPC.
         *
         ...
         * Adds metadata tags to the new graph.
         *
         * These tags can also be used with cost allocation reporting, or used in a Condition
        ...
        /**
         * Specifies the number of dimensions for vector embeddings that will be loaded into the
         * graph.
         *
        ...
        public fun vectorSearchConfiguration(
            vectorSearchConfiguration: VectorSearchConfigurationProperty.Builder.() -> Unit
        )
    }
    ...
    private class BuilderImpl(
         ...
         *   that will be loaded into the graph.
         */
        override fun vectorSearchConfiguration(
            vectorSearchConfiguration: VectorSearchConfigurationProperty
        ) {
            cdkBuilder.vectorSearchConfiguration(
                vectorSearchConfiguration.let(VectorSearchConfigurationProperty::unwrap)
            )
        }
        ...
        public fun build(): software.amazon.awscdk.services.neptunegraph.CfnGraph =
            cdkBuilder.build()
    }
    ...
    public companion object {
        ...
        ): CfnGraph = CfnGraph(cdkObject)

        internal fun unwrap(
            wrapped: CfnGraph
        ): software.amazon.awscdk.services.neptunegraph.CfnGraph = wrapped.cdkObject
    }
    ...
    public interface VectorSearchConfigurationProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: VectorSearchConfigurationProperty
            ): software.amazon.awscdk.services.neptunegraph.CfnGraph.VectorSearchConfigurationProperty =
