...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.cloudfront.CfnOriginAccessControl,
    ...
    public open fun originAccessControlConfig(`value`: OriginAccessControlConfigProperty) {
        unwrap(this)
            .setOriginAccessControlConfig(`value`.let(OriginAccessControlConfigProperty::unwrap))
    }

    /** The origin access control. */
    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("2eb7ae7106b477a120b6b4eb2959987a5ab0137855fe4c359219cc0c89a09279")
    public open fun originAccessControlConfig(
        `value`: OriginAccessControlConfigProperty.Builder.() -> Unit
    ...
    public interface Builder {
        ...
        public fun originAccessControlConfig(
            originAccessControlConfig: OriginAccessControlConfigProperty.Builder.() -> Unit
        )
    }
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.cloudfront.CfnOriginAccessControl.Builder.create(
                scope,
                id
            )
         ...
         * @param originAccessControlConfig The origin access control.
         */
        override fun originAccessControlConfig(
            originAccessControlConfig: OriginAccessControlConfigProperty
        ) {
            cdkBuilder.originAccessControlConfig(
                originAccessControlConfig.let(OriginAccessControlConfigProperty::unwrap)
            )
        }
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnOriginAccessControl
    ...
    public interface OriginAccessControlConfigProperty {
         ...
         *   `Authorization` header from the viewer request, you *must* add the `Authorization`
         *   header to a
        ...
        public interface Builder {
            ...
            /**
             * @param originAccessControlOriginType The type of origin that this origin access
             *   control is for.
             */
             ...
             *   passes along the `Authorization` header from the viewer request. *WARNING: To pass
             *   along the `Authorization` header from the viewer request, you *must* add the
            ...
            /**
             * @param signingProtocol The signing protocol of the origin access control, which
             *   determines how CloudFront signs (authenticates) requests. The only valid value is
             *   `sigv4` .
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: OriginAccessControlConfigProperty
            ): software.amazon.awscdk.services.cloudfront.CfnOriginAccessControl.OriginAccessControlConfigProperty =
