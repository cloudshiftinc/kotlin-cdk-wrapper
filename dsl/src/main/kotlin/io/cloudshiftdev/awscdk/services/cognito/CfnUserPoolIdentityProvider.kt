...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param providerDetails The IdP details. The following list describes the provider detail
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.cognito.CfnUserPoolIdentityProvider.Builder.create(
                scope,
                id
            )
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnUserPoolIdentityProvider
