...
internal constructor(
    ...
    public interface Builder {
         ...
         * Wisdom with chat, the key policy must also allow `kms:Decrypt` , `kms:GenerateDataKey*` ,
         * and `kms:DescribeKey` permissions to the `connect.amazonaws.com` service principal. For
         * more information about setting up a customer managed key for Wisdom, see
    ...
    public companion object {
        ...
        ): CfnAssistant = CfnAssistant(cdkObject)

        internal fun unwrap(
            wrapped: CfnAssistant
        ): software.amazon.awscdk.services.wisdom.CfnAssistant = wrapped.cdkObject
    }
    ...
    public interface ServerSideEncryptionConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param kmsKeyId The customer managed key used for encryption. The customer managed
             *   key must have a policy that allows `kms:CreateGrant` and `kms:DescribeKey`
             *   permissions to the IAM identity using the key to invoke Wisdom. To use Wisdom with
        ...
        private class BuilderImpl : Builder {
            private val cdkBuilder:
                ...
                software.amazon.awscdk.services.wisdom.CfnAssistant
        ...
        internal constructor(
             ...
             *
             * The customer managed key must have a policy that allows `kms:CreateGrant` and
             * `kms:DescribeKey` permissions to the IAM identity using the key to invoke Wisdom. To
             ...
             * customer managed key for Wisdom, see
             * [Enable Amazon Connect Wisdom for your instance](https://docs.aws.amazon.com/connect/latest/adminguide/enable-wisdom.html)
             * . For information about valid ID values, see
             * [Key identifiers (KeyId)](https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#key-id)
             * in the *AWS Key Management Service Developer Guide* .
