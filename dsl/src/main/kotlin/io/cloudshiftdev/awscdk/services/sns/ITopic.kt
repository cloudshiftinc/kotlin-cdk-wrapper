...
public interface ITopic : IResource, INotificationRuleTarget {
     ...
     * (`Topic.import`), then this is a no-op.
     *
     * @param statement
     */
    ...
    public fun metricNumberOfNotificationsFilteredOut(
    ...
    public fun metricNumberOfNotificationsFilteredOutInvalidAttributes(
        props: MetricOptions.Builder.() -> Unit
    ): Metric
     ...
     * @param props
     */
    public fun metricNumberOfNotificationsFilteredOutNoMessageAttributes(
        props: MetricOptions
    ): Metric
    ...
    internal constructor(
        ...
        override fun addSubscription(subscription: ITopicSubscription): Subscription =
            unwrap(this)
                .addSubscription(subscription.let(ITopicSubscription::unwrap))
                .let(Subscription::wrap)

        /**
         * Adds a statement to the IAM resource policy associated with this topic.
         *
         * If this topic was created in this stack (`new Topic`), a topic policy will be
         * automatically created upon the first call to `addToResourcePolicy`. If the topic is
         * imported (`Topic.import`), then this is a no-op.
         *
         * @param statement
         */
        ...
        /** Enables content-based deduplication for FIFO topics. */
        override fun contentBasedDeduplication(): Boolean =
        ...
        override fun metricNumberOfMessagesPublished(props: MetricOptions): Metric =
            unwrap(this)
                .metricNumberOfMessagesPublished(props.let(MetricOptions::unwrap))
                .let(Metric::wrap)
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("0debfcf68c56186b6266a690fc01d2ba469d215e82968a201c09ce0d090a76e3")
        override fun metricNumberOfMessagesPublished(
            props: MetricOptions.Builder.() -> Unit
        ...
        override fun metricNumberOfNotificationsDelivered(props: MetricOptions): Metric =
            unwrap(this)
                .metricNumberOfNotificationsDelivered(props.let(MetricOptions::unwrap))
                .let(Metric::wrap)
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("fca8e127970064d20533907387181b36ec7f4b132b5beff585ad498f1ef8ad75")
        override fun metricNumberOfNotificationsDelivered(
            props: MetricOptions.Builder.() -> Unit
        ...
        override fun metricNumberOfNotificationsFailed(props: MetricOptions): Metric =
            unwrap(this)
                .metricNumberOfNotificationsFailed(props.let(MetricOptions::unwrap))
                .let(Metric::wrap)
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("e7ed1623b02cee0cbde24236106b0c18d58a20040a199e944a7ab04cbe1bbd6b")
        override fun metricNumberOfNotificationsFailed(
            props: MetricOptions.Builder.() -> Unit
        ...
        override fun metricNumberOfNotificationsFilteredOut(props: MetricOptions): Metric =
            unwrap(this)
                .metricNumberOfNotificationsFilteredOut(props.let(MetricOptions::unwrap))
                .let(Metric::wrap)
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("35bf7baed1f2513c6d518c8e354540bd10d44f78c65887bd91dc386c7f40f118")
        override fun metricNumberOfNotificationsFilteredOut(
            props: MetricOptions.Builder.() -> Unit
         ...
         * @param props
         */
        override fun metricNumberOfNotificationsFilteredOutInvalidAttributes(
            props: MetricOptions
        ): Metric =
            unwrap(this)
         ...
         * @param props
         */
        override fun metricNumberOfNotificationsFilteredOutNoMessageAttributes(
            props: MetricOptions
        ): Metric =
            unwrap(this)
                .metricNumberOfNotificationsFilteredOutNoMessageAttributes(
         ...
         * @param props
         */
        override fun metricPublishSize(): Metric =
        ...
        /**
         * The charges you have accrued since the start of the current calendar month for sending
         * SMS messages.
         *
         * Maximum over 5 minutes
         *
        ...
        override fun metricSmsMonthToDateSpentUsd(props: MetricOptions): Metric =
            unwrap(this)
                .metricSMSMonthToDateSpentUSD(props.let(MetricOptions::unwrap))
                .let(Metric::wrap)
    ...
    public companion object {
        ...
        internal fun unwrap(wrapped: ITopic): software.amazon.awscdk.services.sns.ITopic =
