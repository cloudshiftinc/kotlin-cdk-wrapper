...
public enum class ClientPasswordAuthType(
  ...
  MYSQL_NATIVE_PASSWORD(software.amazon.awscdk.services.rds.ClientPasswordAuthType.MYSQL_NATIVE_PASSWORD),
  POSTGRES_SCRAM_SHA_256(software.amazon.awscdk.services.rds.ClientPasswordAuthType.POSTGRES_SCRAM_SHA_256),
  POSTGRES_MD5(software.amazon.awscdk.services.rds.ClientPasswordAuthType.POSTGRES_MD5),
  SQL_SERVER_AUTHENTICATION(software.amazon.awscdk.services.rds.ClientPasswordAuthType.SQL_SERVER_AUTHENTICATION),
  ;

  public companion object {
    internal fun wrap(cdkObject: software.amazon.awscdk.services.rds.ClientPasswordAuthType):
        ClientPasswordAuthType = when (cdkObject) {
    ...
    internal fun unwrap(wrapped: ClientPasswordAuthType):
