...
public interface Monitoring {
     ...
     *
     * If set to true, will automatically create a Cloudwatch Log Group and S3 bucket. This will be
     * set to `true` implicitly if values are provided for `logGroup` or `logBucket`.
     *
    ...
    public interface Builder {
        /**
         * @param logBucket Amazon S3 Bucket for monitoring log publishing. You can configure your
         *   jobs to send log information to Amazon S3.
         */
        public fun logBucket(logBucket: IBucket)

        /**
         * @param logGroup A log group for CloudWatch monitoring. You can configure your jobs to
    ...
    internal constructor(
         ...
         * Enable logging for this job.
         *
         * If set to true, will automatically create a Cloudwatch Log Group and S3 bucket. This will
         * be set to `true` implicitly if values are provided for `logGroup` or `logBucket`.
         *
         * Default: true - true if values are provided for `logGroup` or `logBucket`, false
         * otherwise
         */
