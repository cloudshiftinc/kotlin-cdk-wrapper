...
internal constructor(
    ...
    public open fun httpUrlProperties(
        `value`: HttpUrlDestinationSummaryProperty.Builder.() -> Unit
    ...
    public open fun vpcProperties(
        `value`: VpcDestinationPropertiesProperty.Builder.() -> Unit
    ): Unit = vpcProperties(VpcDestinationPropertiesProperty(`value`))
    ...
    public interface Builder {
        ...
        public fun httpUrlProperties(
            httpUrlProperties: HttpUrlDestinationSummaryProperty.Builder.() -> Unit
        )
         ...
         *   out. You can call `GetTopicRuleDestination` for details about the error. You can set
    ...
    private class BuilderImpl(
        ...
        override fun httpUrlProperties(httpUrlProperties: HttpUrlDestinationSummaryProperty) {
            cdkBuilder.httpUrlProperties(
                httpUrlProperties.let(HttpUrlDestinationSummaryProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("fc2b764e69a29233aceaba10ec8762b290abc980f6fe1766601f883b8dda6925")
        override fun httpUrlProperties(
            httpUrlProperties: HttpUrlDestinationSummaryProperty.Builder.() -> Unit
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("4395235da5e0270bdf3f463e7b94b4cc592f5dbd0b60c86f1d2ce41030f65ec0")
        override fun vpcProperties(
            vpcProperties: VpcDestinationPropertiesProperty.Builder.() -> Unit
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnTopicRuleDestination
    ...
    public interface VpcDestinationPropertiesProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: VpcDestinationPropertiesProperty
            ): software.amazon.awscdk.services.iot.CfnTopicRuleDestination.VpcDestinationPropertiesProperty =
    ...
    public interface HttpUrlDestinationSummaryProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: HttpUrlDestinationSummaryProperty
            ): software.amazon.awscdk.services.iot.CfnTopicRuleDestination.HttpUrlDestinationSummaryProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
