...
public interface IRule : IResource {
    ...
    internal constructor(
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("b98c84ce198054f102b00e655b85da2a1ae47a5638faf86d850c16a3235acfa2")
        override fun onComplianceChange(
            id: String,
        ...
        override fun onReEvaluationStatus(id: String, options: OnEventOptions): Rule =
            unwrap(this)
                .onReEvaluationStatus(id, options.let(OnEventOptions::unwrap))
                .let(Rule::wrap)
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("f5ea19b211eab8ba672d4a05459c322cc41db04f03b5d429124296804b9cc8c7")
        override fun onReEvaluationStatus(
            id: String,
            options: OnEventOptions.Builder.() -> Unit
    ...
    public companion object {
        ...
        internal fun unwrap(wrapped: IRule): software.amazon.awscdk.services.config.IRule =
