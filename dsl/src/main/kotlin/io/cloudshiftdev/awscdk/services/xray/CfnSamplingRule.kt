...
internal constructor(
    ...
    public open fun samplingRuleRecord(
        `value`: SamplingRuleRecordProperty.Builder.() -> Unit
    ): Unit = samplingRuleRecord(SamplingRuleRecordProperty(`value`))
    ...
    public open fun samplingRuleUpdate(
        `value`: SamplingRuleUpdateProperty.Builder.() -> Unit
    ): Unit = samplingRuleUpdate(SamplingRuleUpdateProperty(`value`))
    ...
    public interface Builder {
         ...
         * @deprecated this property has been deprecated
         */
        @Deprecated(message = "deprecated in CDK") public fun ruleName(ruleName: String)
        ...
        public fun samplingRuleRecord(
            samplingRuleRecord: SamplingRuleRecordProperty.Builder.() -> Unit
        )
        ...
        public fun samplingRuleUpdate(
            samplingRuleUpdate: SamplingRuleUpdateProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
        ...
        override fun samplingRuleRecord(samplingRuleRecord: SamplingRuleRecordProperty) {
            cdkBuilder.samplingRuleRecord(
                samplingRuleRecord.let(SamplingRuleRecordProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("c9512381903e4b282b50e8957ec042d2f99e67305fa5596a9d97eddf38683076")
        override fun samplingRuleRecord(
            samplingRuleRecord: SamplingRuleRecordProperty.Builder.() -> Unit
        ...
        override fun samplingRuleUpdate(samplingRuleUpdate: SamplingRuleUpdateProperty) {
            cdkBuilder.samplingRuleUpdate(
                samplingRuleUpdate.let(SamplingRuleUpdateProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("4de8ad76fdb29adbb93e3cb81dfc874a57d56809daebd73aa4c85e4f246035d2")
        override fun samplingRuleUpdate(
            samplingRuleUpdate: SamplingRuleUpdateProperty.Builder.() -> Unit
        ...
        public fun build(): software.amazon.awscdk.services.xray.CfnSamplingRule =
            cdkBuilder.build()
    }
    ...
    public interface SamplingRuleUpdateProperty {
         ...
         * rate.
         *
         * The reservoir is not used directly by services, but applies to all services using the
         * rule collectively.
         *
        ...
        public interface Builder {
            ...
            /**
             * @param fixedRate The percentage of matching requests to instrument, after the
            ...
            /**
             * @param reservoirSize A fixed number of matching requests to instrument per second,
             *   prior to applying the fixed rate. The reservoir is not used directly by services,
            ...
            /**
             * @param ruleArn The ARN of the sampling rule. Specify a rule by either name or ARN,
             *   but not both.
             */
            public fun ruleArn(ruleArn: String)

            /**
             * @param ruleName The ARN of the sampling rule. Specify a rule by either name or ARN,
             *   but not both.
             */
            public fun ruleName(ruleName: String)

            /**
             * @param serviceName Matches the name that the service uses to identify itself in
             *   segments.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SamplingRuleUpdateProperty
            ): software.amazon.awscdk.services.xray.CfnSamplingRule.SamplingRuleUpdateProperty =
    ...
    public interface SamplingRuleRecordProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SamplingRuleRecordProperty
            ): software.amazon.awscdk.services.xray.CfnSamplingRule.SamplingRuleRecordProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SamplingRuleProperty {
         ...
         *
         * Specifying a sampling rule by name is recommended, as specifying by ARN will be
        ...
        public interface Builder {
            /**
             * @param attributes Matches attributes derived from the request. *Map Entries:* Maximum
             *   number of 5 items.
             *
             * *Key Length Constraints:* Minimum length of 1. Maximum length of 32.
             *
            ...
            /**
             * @param ruleName The name of the sampling rule. Specify a rule by either name or ARN,
             *   but not both.
             */
            public fun ruleName(ruleName: String)
            ...
            /**
             * @param version The version of the sampling rule. `Version` can only be set when
             *   creating a new sampling rule.
             */
