...
public interface MetricFilterOptions {
     ...
     *
     * Can either be a literal number (typically "1"), or the name of a field in the structure to
     * take the value from the matched event. If you are using a field value, the field value must
     * have been matched using the pattern.
     *
    ...
    public interface Builder {
         ...
         *   (typically "1"), or the name of a field in the structure to take the value from the
         *   matched event. If you are using a field value, the field value must have been matched
         *   using the pattern.
         *
         * If you want to specify a field from a matched JSON structure, use '$.fieldName', and make
         * sure the field is in the pattern (if only as '$.fieldName = *').
    ...
    public companion object {
        ...
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.logs.MetricFilterOptions
        ): MetricFilterOptions = Wrapper(cdkObject)

        internal fun unwrap(
            wrapped: MetricFilterOptions
