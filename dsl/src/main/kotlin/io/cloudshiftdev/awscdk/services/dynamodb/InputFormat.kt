...
internal constructor(
    ...
    public companion object {
        ...
        public fun csv(options: CsvOptions): InputFormat =
            software.amazon.awscdk.services.dynamodb.InputFormat.csv(
                    options.let(CsvOptions::unwrap)
                )
                .let(InputFormat::wrap)

        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("2755f0fdb57e36185ffda293270efaf3fa63ca1727275d2fcf5c04e945bdd9ba")
        public fun csv(options: CsvOptions.Builder.() -> Unit): InputFormat =
            csv(CsvOptions(options))

        public fun dynamoDbJson(): InputFormat =
            software.amazon.awscdk.services.dynamodb.InputFormat.dynamoDBJson()
                .let(InputFormat::wrap)
        ...
        ): InputFormat = Wrapper(cdkObject)

        internal fun unwrap(
            wrapped: InputFormat
        ): software.amazon.awscdk.services.dynamodb.InputFormat = (wrapped as Wrapper).cdkObject
    }
}
