...
internal constructor(
    ...
    public companion object {
        public fun filterNextables(states: List<State>): List<INextable> =
            software.amazon.awscdk.services.stepfunctions.State.filterNextables(
                    states.map(State::unwrap)
                )
                .map(INextable::wrap)
        ...
        public fun findReachableEndStates(start: State): List<State> =
            software.amazon.awscdk.services.stepfunctions.State.findReachableEndStates(
                    start.let(State::unwrap)
                )
                .map(State::wrap)
        ...
        public fun prefixStates(root: IConstruct, prefix: String) {
            software.amazon.awscdk.services.stepfunctions.State.prefixStates(
                root.let(IConstruct::unwrap),
                prefix
            )
        }
