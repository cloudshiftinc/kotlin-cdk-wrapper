...
public interface HttpRouteMatch {
    ...
    public interface Builder {
        ...
        /**
         * @param protocol The client request protocol to match on. Applicable only for HTTP2
         *   routes.
         */
    ...
    private class BuilderImpl : Builder {
        ...
        public fun build(): software.amazon.awscdk.services.appmesh.HttpRouteMatch =
            cdkBuilder.build()
    }
    ...
    internal constructor(
         ...
         * Default: - matches requests with all paths
         */
        override fun path(): HttpRoutePathMatch? =
