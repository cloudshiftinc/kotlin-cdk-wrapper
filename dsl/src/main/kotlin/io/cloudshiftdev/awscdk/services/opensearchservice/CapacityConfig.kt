...
public interface CapacityConfig {
    ...
    public interface Builder {
        ...
        /**
         * @param dataNodes The number of data nodes (instances) to use in the Amazon OpenSearch
         *   Service domain.
         */
         ...
         *   option is enabled. For more information, see [Multi-AZ with Standby]
         *   (https://docs.aws.amazon.com/opensearch-service/latest/developerguide/managedomains-multiaz.html#managedomains-za-standby)
         */
        ...
        /**
         * @param warmNodes The number of UltraWarm nodes (instances) to use in the Amazon
    ...
    internal constructor(
         ...
         * Default: - no multi-az with standby
         */
        override fun multiAzWithStandbyEnabled(): Boolean? =
