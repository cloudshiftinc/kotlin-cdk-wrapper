...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * Private hosted zones must be associated with at least one VPC. You can associated
         * additional VPCs using `addVpc(vpc)`.
         *
    ...
    public companion object {
        public fun fromPrivateHostedZoneId(
            ...
            software.amazon.awscdk.services.route53.PrivateHostedZone.fromPrivateHostedZoneId(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    privateHostedZoneId
                )
                .let(IPrivateHostedZone::wrap)
