...
public enum class AuthorizationType(
    ...
    public companion object {
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.appsync.AuthorizationType
        ): AuthorizationType =
            when (cdkObject) {
                software.amazon.awscdk.services.appsync.AuthorizationType.API_KEY ->
                    AuthorizationType.API_KEY
                software.amazon.awscdk.services.appsync.AuthorizationType.IAM ->
                    AuthorizationType.IAM
                software.amazon.awscdk.services.appsync.AuthorizationType.USER_POOL ->
                    AuthorizationType.USER_POOL
                software.amazon.awscdk.services.appsync.AuthorizationType.OIDC ->
                    AuthorizationType.OIDC
                software.amazon.awscdk.services.appsync.AuthorizationType.LAMBDA ->
