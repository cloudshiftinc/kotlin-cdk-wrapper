...
internal constructor(
    ...
    public interface Builder {
         ...
         * The type of collection.
         *
         * Possible values are `SEARCH` , `TIMESERIES` , and `VECTORSEARCH` . For more information,
         * see
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.opensearchserverless.CfnCollection.Builder.create(
                scope,
                id
            )
