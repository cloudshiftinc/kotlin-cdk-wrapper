...
public open class Repository internal constructor(
  ...
  public companion object {
    public open fun arnForLocalRepository(repositoryName: String, scope: IConstruct): String =
        software.amazon.awscdk.services.ecr.Repository.arnForLocalRepository(repositoryName,
        scope.let(IConstruct::unwrap))

    public open fun arnForLocalRepository(
    ...
    public open fun fromRepositoryAttributes(
      scope: CloudshiftdevConstructsConstruct,
      id: String,
