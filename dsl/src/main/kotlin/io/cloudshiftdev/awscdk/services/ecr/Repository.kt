...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.ecr.Repository,
) : RepositoryBase(cdkObject) {
    /**
     * Add a life cycle rule to the repository.
     *
     * Life cycle rules automatically expire images from the repository that match certain
     * conditions.
     *
     * @param rule
     */
     ...
     *
     * While other resources policies in AWS either require or accept a resource section, Cfn for
     * ECR does not allow us to specify a resource policy. It will fail if a resource section is
     * present at all.
     *
     * @param statement
     */
    ...
    public interface Builder {
         ...
         *
         * Default: - If encryption is set to `KMS` and this property is undefined, an AWS managed
         * KMS key is used.
         *
         ...
         *
         * @param lifecycleRegistryId The AWS account ID associated with the registry that contains
         *   the repository.
         */
    ...
    public companion object {
        public fun arnForLocalRepository(repositoryName: String, scope: IConstruct): String =
            software.amazon.awscdk.services.ecr.Repository.arnForLocalRepository(
                repositoryName,
        ...
        public fun fromRepositoryAttributes(
            ...
            software.amazon.awscdk.services.ecr.Repository.fromRepositoryAttributes(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    attrs.let(RepositoryAttributes::unwrap)
                )
                .let(IRepository::wrap)
        ...
        public fun fromRepositoryName(
            ...
            software.amazon.awscdk.services.ecr.Repository.fromRepositoryName(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    repositoryName
                )
