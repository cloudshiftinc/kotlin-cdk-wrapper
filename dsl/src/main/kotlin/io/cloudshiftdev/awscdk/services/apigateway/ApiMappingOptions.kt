...
public interface ApiMappingOptions {
     ...
     *
     * If this is undefined, a mapping will be added for the empty path. Any request that does not
     * match a mapping will get sent to the API that has been mapped to the empty path.
     *
    ...
    public interface Builder {
        /**
         * @param basePath The api path name that callers of the API must provide in the URL after
         *   the domain name (e.g. `example.com/base-path`). If you specify this property, it can't
         *   be an empty string. If this is undefined, a mapping will be added for the empty path.
         *   Any request that does not match a mapping will get sent to the API that has been mapped
         *   to the empty path.
         */
    ...
    internal constructor(
        ...
        /**
         * The api path name that callers of the API must provide in the URL after the domain name
         * (e.g. `example.com/base-path`). If you specify this property, it can't be an empty
         * string.
         *
         * If this is undefined, a mapping will be added for the empty path. Any request that does
         * not match a mapping will get sent to the API that has been mapped to the empty path.
         *
         * Default: - map requests from the domain root (e.g. `example.com`).
         */
