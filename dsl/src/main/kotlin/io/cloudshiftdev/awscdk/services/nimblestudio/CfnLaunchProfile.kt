...
internal constructor(
    ...
    public open fun streamConfiguration(
        `value`: StreamConfigurationProperty.Builder.() -> Unit
    ): Unit = streamConfiguration(StreamConfigurationProperty(`value`))
    ...
    public interface Builder {
         ...
         *
         * @param launchProfileProtocolVersions The version number of the protocol that is used by
         *   the launch profile.
         */
        ...
        public fun streamConfiguration(
            streamConfiguration: StreamConfigurationProperty.Builder.() -> Unit
        )
         ...
         *
         * @param studioComponentIds Unique identifiers for a collection of studio components that
    ...
    private class BuilderImpl(
         ...
         *   the launch profile.
         */
        override fun launchProfileProtocolVersions(
            vararg launchProfileProtocolVersions: String
        ): Unit = launchProfileProtocolVersions(launchProfileProtocolVersions.toList())
        ...
        override fun streamConfiguration(streamConfiguration: StreamConfigurationProperty) {
            cdkBuilder.streamConfiguration(
                streamConfiguration.let(StreamConfigurationProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("b3698d518770f3d74705b416bc81e2434819c2c071182060cb23be9cccdc6f03")
        override fun streamConfiguration(
            streamConfiguration: StreamConfigurationProperty.Builder.() -> Unit
    ...
    public interface VolumeConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param iops The number of I/O operations per second for the root volume that is
            ...
            /**
             * @param throughput The throughput to provision for the root volume that is attached to
    ...
    public interface StreamConfigurationProperty {
         ...
         * * When `ACTIVATED` , the streaming session is scheduled for termination after being in
         *   the `STOPPED` state for the time specified in `maxStoppedSessionLengthInMinutes` .
         ...
         *
         * After this point, Nimble Studio automatically terminates or stops the session. The
         * default length of time is 690 minutes, and the maximum length of time is 30 days.
         *
         * Default: - 690
         *
         ...
         */
        public fun maxSessionLengthInMinutes(): Number? =
         ...
         * will automatically be stopped (instead of terminated).
         *
         * Default: - 0
         *
        ...
        public interface Builder {
            /**
             * @param automaticTerminationMode Indicates if a streaming session created from this
             *   launch profile should be terminated automatically or retained without termination
             *   after being in a `STOPPED` state.
             * * When `ACTIVATED` , the streaming session is scheduled for termination after being
             *   in the `STOPPED` state for the time specified in `maxStoppedSessionLengthInMinutes`
             *   .
             * * When `DEACTIVATED` , the streaming session can remain in the `STOPPED` state
             *   indefinitely.
             *
            ...
            /**
             * @param clipboardMode Allows or deactivates the use of the system clipboard to copy
             *   and paste between the streaming session and streaming client.
             */
            public fun clipboardMode(clipboardMode: String)

            /**
             * @param ec2InstanceTypes The EC2 instance types that users can select from when
            ...
            /**
             * @param maxSessionLengthInMinutes The length of time, in minutes, that a streaming
             *   session can be active before it is stopped or terminated. After this point, Nimble
             *   Studio automatically terminates or stops the session. The default length of time is
            ...
            /**
             * @param maxStoppedSessionLengthInMinutes Integer that determines if you can start and
             *   stop your sessions and how long a session can stay in the `STOPPED` state. The
             *   default value is 0. The maximum value is 5760.
             *
             * This field is allowed only when `sessionPersistenceMode` is `ACTIVATED` and
             * `automaticTerminationMode` is `ACTIVATED` .
             *
            ...
            public fun sessionBackup(
                sessionBackup: StreamConfigurationSessionBackupProperty.Builder.() -> Unit
            )

            /**
             * @param sessionPersistenceMode Determine if a streaming session created from this
             *   launch profile can configure persistent storage. This means that
            ...
            public fun sessionStorage(
                sessionStorage: StreamConfigurationSessionStorageProperty.Builder.() -> Unit
            )

            /**
             * @param streamingImageIds The streaming images that users can select from when
             *   launching a streaming session with this launch profile.
             */
             ...
             *   attached to streaming sessions. This parameter is only allowed when
             *   `sessionPersistenceMode` is `ACTIVATED` .
             */
            ...
            public fun volumeConfiguration(
                volumeConfiguration: VolumeConfigurationProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
             ...
             * session will automatically be stopped (instead of terminated).
             */
            override fun maxStoppedSessionLengthInMinutes(
            ...
            override fun sessionBackup(sessionBackup: StreamConfigurationSessionBackupProperty) {
                cdkBuilder.sessionBackup(
                    sessionBackup.let(StreamConfigurationSessionBackupProperty::unwrap)
                )
            }
            ...
            override fun sessionStorage(sessionStorage: StreamConfigurationSessionStorageProperty) {
                cdkBuilder.sessionStorage(
                    sessionStorage.let(StreamConfigurationSessionStorageProperty::unwrap)
                )
            }
            ...
            override fun volumeConfiguration(volumeConfiguration: VolumeConfigurationProperty) {
                cdkBuilder.volumeConfiguration(
                    volumeConfiguration.let(VolumeConfigurationProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("afd8c78b11abc1309c12b60352c63def2d14cf73b2a59c3faa574426649e5b85")
            override fun volumeConfiguration(
                volumeConfiguration: VolumeConfigurationProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * terminated automatically or retained without termination after being in a `STOPPED`
             * state.
             * * When `ACTIVATED` , the streaming session is scheduled for termination after being
             *   in the `STOPPED` state for the time specified in `maxStoppedSessionLengthInMinutes`
             *   .
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-nimblestudio-launchprofile-streamconfiguration.html#cfn-nimblestudio-launchprofile-streamconfiguration-automaticterminationmode)
             */
            override fun automaticTerminationMode(): String? =
             ...
             * session can stay in the `STOPPED` state.
             *
             * The default value is 0. The maximum value is 5760.
             *
             * This field is allowed only when `sessionPersistenceMode` is `ACTIVATED` and
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-nimblestudio-launchprofile-streamconfiguration.html#cfn-nimblestudio-launchprofile-streamconfiguration-sessionpersistencemode)
             */
            override fun sessionPersistenceMode(): String? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: StreamConfigurationProperty
            ): software.amazon.awscdk.services.nimblestudio.CfnLaunchProfile.StreamConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface StreamingSessionStorageRootProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: StreamingSessionStorageRootProperty
            ): software.amazon.awscdk.services.nimblestudio.CfnLaunchProfile.StreamingSessionStorageRootProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface StreamConfigurationSessionStorageProperty {
        ...
        public interface Builder {
            /**
             * @param mode Allows artists to upload files to their workstations. The only valid
             *   option is `UPLOAD` .
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: StreamConfigurationSessionStorageProperty
            ): software.amazon.awscdk.services.nimblestudio.CfnLaunchProfile.StreamConfigurationSessionStorageProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface StreamConfigurationSessionBackupProperty {
         ...
         * value is `DEACTIVATED` , which means that backups are deactivated. To allow backups, set
         * this value to `AUTOMATIC` .
         *
        ...
        public interface Builder {
            /**
             * @param maxBackupsToRetain The maximum number of backups that each streaming session
             *   created from this launch profile can have.
             */
            public fun maxBackupsToRetain(maxBackupsToRetain: Number)

            /**
             * @param mode Specifies how artists sessions are backed up. Configures backups for
             *   streaming sessions launched with this launch profile. The default value is
             *   `DEACTIVATED` , which means that backups are deactivated. To allow backups, set
             *   this value to `AUTOMATIC` .
             */
        ...
        internal constructor(
             ...
             * default value is `DEACTIVATED` , which means that backups are deactivated. To allow
             * backups, set this value to `AUTOMATIC` .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-nimblestudio-launchprofile-streamconfigurationsessionbackup.html#cfn-nimblestudio-launchprofile-streamconfigurationsessionbackup-mode)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: StreamConfigurationSessionBackupProperty
            ): software.amazon.awscdk.services.nimblestudio.CfnLaunchProfile.StreamConfigurationSessionBackupProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
