...
internal constructor(
    ...
    public interface Builder {
         ...
         * The maximum value that you plan to scale out to.
         *
         * When a scaling policy is in effect, Application Auto Scaling can scale out (expand) as
         ...
         *
         * This can be either an IAM service role that Application Auto Scaling can assume to make
         * calls to other AWS resources on your behalf, or a service-linked role for the specified
         ...
         * service-linked role in your stack template. To find the exact ARN of the service-linked
         * role for your AWS or custom resource, see the
         * [Service-linked roles](https://docs.aws.amazon.com/autoscaling/application/userguide/application-auto-scaling-service-linked-roles.html)
         * topic in the *Application Auto Scaling User Guide* . Look for the ARN in the table at the
         * bottom of the page.
         *
         ...
         *
         * @param roleArn Specify the Amazon Resource Name (ARN) of an Identity and Access
         *   Management (IAM) role that allows Application Auto Scaling to modify the scalable
         ...
         *
         * @param suspendedState An embedded object that contains attributes and attribute values
         *   that are used to suspend and resume automatic scaling.
         */
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.applicationautoscaling.CfnScalableTarget.Builder.create(
                scope,
                id
            )
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("3c92426d58a0bb3038e5237116a2c51832511f958c67e91a4530463faf342ae7")
        override fun suspendedState(
            suspendedState: SuspendedStateProperty.Builder.() -> Unit
    ...
    public interface ScheduledActionProperty {
         ...
         * below the minimum capacity, Application Auto Scaling scales out to the minimum capacity.
         * If the current capacity is above the maximum capacity, Application Auto Scaling scales in
        ...
        public interface Builder {
            ...
            /**
             * @param scalableTargetAction The new minimum and maximum capacity. You can set both
             *   values or just one. At the scheduled time, if the current capacity is below the
             *   minimum capacity, Application Auto Scaling scales out to the minimum capacity. If
             *   the current capacity is above the maximum capacity, Application Auto Scaling scales
             *   in to the maximum capacity.
             */
            ...
            public fun scalableTargetAction(
                scalableTargetAction: ScalableTargetActionProperty.Builder.() -> Unit
            )
            ...
            /**
             * @param scheduledActionName The name of the scheduled action. This name must be unique
             *   among all other scheduled actions on the specified scalable target.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            override fun scalableTargetAction(scalableTargetAction: ScalableTargetActionProperty) {
                cdkBuilder.scalableTargetAction(
                    scalableTargetAction.let(ScalableTargetActionProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("c45c5e02e114c4c156e6b8b2796dcd8489a0ff765695bba8a8cf4a9185118fe9")
            override fun scalableTargetAction(
                scalableTargetAction: ScalableTargetActionProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ScheduledActionProperty
            ): software.amazon.awscdk.services.applicationautoscaling.CfnScalableTarget.ScheduledActionProperty =
    ...
    public interface SuspendedStateProperty {
         ...
         * suspended.
         *
         * Set the value to `true` if you don't want Application Auto Scaling to remove capacity
        ...
        public interface Builder {
            /**
             * @param dynamicScalingInSuspended Whether scale in by a target tracking scaling policy
             *   or a step scaling policy is suspended. Set the value to `true` if you don't want
             *   Application Auto Scaling to remove capacity when a scaling policy is triggered. The
             *   default is `false` .
             */
            ...
            /**
             * @param dynamicScalingOutSuspended Whether scale out by a target tracking scaling
             *   policy or a step scaling policy is suspended. Set the value to `true` if you don't
             *   want Application Auto Scaling to add capacity when a scaling policy is triggered.
            ...
            /**
             * @param scheduledScalingSuspended Whether scheduled scaling is suspended. Set the
             *   value to `true` if you don't want Application Auto Scaling to add or remove
             *   capacity by initiating scheduled actions. The default is `false` .
             */
        ...
        private class BuilderImpl : Builder {
            ...
            override fun dynamicScalingInSuspended(dynamicScalingInSuspended: IResolvable) {
                cdkBuilder.dynamicScalingInSuspended(
                    dynamicScalingInSuspended.let(IResolvable::unwrap)
                )
            }
            ...
            override fun dynamicScalingOutSuspended(dynamicScalingOutSuspended: IResolvable) {
                cdkBuilder.dynamicScalingOutSuspended(
                    dynamicScalingOutSuspended.let(IResolvable::unwrap)
                )
            }
            ...
            override fun scheduledScalingSuspended(scheduledScalingSuspended: IResolvable) {
                cdkBuilder.scheduledScalingSuspended(
                    scheduledScalingSuspended.let(IResolvable::unwrap)
                )
            }
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-applicationautoscaling-scalabletarget-suspendedstate.html#cfn-applicationautoscaling-scalabletarget-suspendedstate-dynamicscalinginsuspended)
             */
            override fun dynamicScalingInSuspended(): Any? =
             ...
             * suspended.
             *
             * Set the value to `true` if you don't want Application Auto Scaling to add capacity
             * when a scaling policy is triggered. The default is `false` .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-applicationautoscaling-scalabletarget-suspendedstate.html#cfn-applicationautoscaling-scalabletarget-suspendedstate-dynamicscalingoutsuspended)
             */
            override fun dynamicScalingOutSuspended(): Any? =
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-applicationautoscaling-scalabletarget-suspendedstate.html#cfn-applicationautoscaling-scalabletarget-suspendedstate-scheduledscalingsuspended)
             */
            override fun scheduledScalingSuspended(): Any? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SuspendedStateProperty
            ): software.amazon.awscdk.services.applicationautoscaling.CfnScalableTarget.SuspendedStateProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ScalableTargetActionProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ScalableTargetActionProperty
            ): software.amazon.awscdk.services.applicationautoscaling.CfnScalableTarget.ScalableTargetActionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
