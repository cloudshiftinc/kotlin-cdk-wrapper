...
internal constructor(
     ...
     */
    public open fun gameSessionQueueArns(): List<String> =
        unwrap(this).getGameSessionQueueArns() ?: emptyList()
    ...
    public interface Builder {
         ...
         * accepted by the matched players.
         *
         * To require acceptance, set to `TRUE` . With this option enabled, matchmaking tickets use
         * the status `REQUIRES_ACCEPTANCE` to indicate when a completed potential match is waiting
         ...
         *
         * @param acceptanceRequired A flag that determines whether a match that was created with
         ...
         *
         * @param acceptanceTimeoutSeconds The length of time (in seconds) to wait for players to
         ...
         * The number of player slots in a match to keep open for future players.
         *
         * For example, if the configuration's rule set specifies a match for a single 10-person
         * team, and the additional player count is set to 2, 10 players will be selected for the
         * match and 2 more player slots will be open for future players. This parameter is not used
         ...
         *
         * @param additionalPlayerCount The number of player slots in a match to keep open for
         *   future players.
         */
         ...
         * `StartMatchBackfill` request whenever a game session has one or more open slots. Learn
         * more about manual and automatic backfill in
         ...
         * * *STANDALONE* - FlexMatch forms matches and returns match information, including players
         *   and team assignments, in a
         ...
         *
         * @param gameProperties A set of custom properties for a game session, formatted as
         *   key-value pairs.
         */
         ...
         *
         * @param gameSessionData A set of custom game session properties, formatted as a single
         *   string value.
         */
         ...
         * assigned to a Amazon GameLift game session queue resource and uniquely identifies it.
         ...
         *   ARNs are unique across all Regions. Format is
         *   `arn:aws:gamelift:&lt;region&gt;::gamesessionqueue/&lt;queue name&gt;` . Queues can be
         *   located in any Region. Queues are used to start new Amazon GameLift-hosted game
         ...
         *
         * @param requestTimeoutSeconds The maximum duration, in seconds, that a matchmaking ticket
         *   can remain in process before timing out.
         */
        public fun requestTimeoutSeconds(requestTimeoutSeconds: Number)

        /**
         * The Amazon Resource Name (
         * [ARN](https://docs.aws.amazon.com/AmazonS3/latest/dev/s3-arn-format.html) ) associated
         ...
         * A unique identifier for the matchmaking rule set to use with this configuration.
         *
         * You can use either the rule set name or ARN value. A matchmaking configuration can only
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.gamelift.CfnMatchmakingConfiguration.Builder.create(
                scope,
                id
            )
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnMatchmakingConfiguration
