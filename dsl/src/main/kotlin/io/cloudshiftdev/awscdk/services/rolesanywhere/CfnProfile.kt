...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param durationSeconds The number of seconds vended session credentials will be valid
         *   for.
         */
         ...
         * A list of managed policy ARNs.
         *
         * Managed policies identified by this list will be applied to the vended session
         * credentials.
         *
        ...
        /**
         * A list of IAM role ARNs that can be assumed when this profile is specified in a
         ...
         *
         * @param roleArns A list of IAM role ARNs that can be assumed when this profile is
         *   specified in a CreateSession request.
         */
        ...
        /**
         * A session policy that will applied to the trust boundary of the vended session
         * credentials.
         *
         ...
         *
         * @param sessionPolicy A session policy that will applied to the trust boundary of the
