...
internal constructor(
    ...
    public open fun attrCodeSourceLocationArn(): String =
        unwrap(this).getAttrCodeSourceLocationArn()
    ...
    public interface Builder {
         ...
         * The location in Amazon S3 where Synthetics stores artifacts from the runs of this canary.
         *
         * Artifacts include the log file, screenshots, and HAR files. Specify the full location
         * path, including `s3://` at the beginning of the path.
         *
         ...
         *
         * @param artifactS3Location The location in Amazon S3 where Synthetics stores artifacts
         *   from the runs of this canary.
         */
         ...
         * Use this structure to input your script code for the canary.
         *
         * This structure contains the Lambda handler with the location where the canary should
         * start running the script. If the script is stored in an S3 bucket, the bucket name, key,
         * and version are also included. If the script is passed into the canary directly, the
         * script code is contained in the value of `Script` .
         *
         ...
         *
         * @param deleteLambdaResourcesOnCanaryDeletion Deletes associated lambda resources created
         *   by Synthetics if set to True.
         * @deprecated this property has been deprecated
         */
        @Deprecated(message = "deprecated in CDK")
         ...
         * The ARN of the IAM role to be used to run the canary.
         *
         * This role must already exist, and must include `lambda.amazonaws.com` as a principal in
         ...
         * A structure that contains input information for a canary run.
         *
         * If you omit this structure, the frequency of the canary is used as canary's timeout
         * value, up to a maximum of 900 seconds.
         *
         ...
         *
         * @param startCanaryAfterCreation Specify TRUE to have the canary start making runs
         ...
         *
         * @param successRetentionPeriod The number of days to retain data about successful runs of
         *   this canary.
         */
         ...
         *
         * @param visualReference If this canary performs visual monitoring by comparing
         *   screenshots, this structure contains the ID of the canary run to use as the baseline
         *   for screenshots, and the coordinates of any parts of the screen to ignore during the
        ...
        /**
         * If this canary is to test an endpoint in a VPC, this structure contains information about
         * the subnet and security groups of the VPC endpoint.
         *
    ...
    private class BuilderImpl(
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("b23f001e2dd8a6cfb00b3131af1425ae09f30fc4cbc4fc44e8f860e9febcc135")
        override fun artifactConfig(
            artifactConfig: ArtifactConfigProperty.Builder.() -> Unit
         ...
         */
        @Deprecated(message = "deprecated in CDK")
        override fun deleteLambdaResourcesOnCanaryDeletion(
            deleteLambdaResourcesOnCanaryDeletion: Boolean
        ) {
        ...
        override fun deleteLambdaResourcesOnCanaryDeletion(
            ...
            cdkBuilder.deleteLambdaResourcesOnCanaryDeletion(
                deleteLambdaResourcesOnCanaryDeletion.let(IResolvable::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("0bbb4cbb9894123c40e44079dc0cc74d2f61a18097234b42c75576546fef8718")
        override fun visualReference(
            visualReference: VisualReferenceProperty.Builder.() -> Unit
        ): Unit = visualReference(VisualReferenceProperty(visualReference))
        ...
        public fun build(): software.amazon.awscdk.services.synthetics.CfnCanary =
            cdkBuilder.build()
    }
    ...
    public companion object {
        ...
        ): CfnCanary = CfnCanary(cdkObject)

        internal fun unwrap(
            wrapped: CfnCanary
        ): software.amazon.awscdk.services.synthetics.CfnCanary = wrapped.cdkObject
    }
    ...
    public interface ScheduleProperty {
         ...
         * once every 10 minutes, and `rate(1 hour)` runs it once every hour. You can specify a
         * frequency between `rate(1 minute)` and `rate(1 hour)` .
         *
         * Specifying `rate(0 minute)` or `rate(0 hour)` is a special value that causes the canary
        ...
        public interface Builder {
            /**
             * @param durationInSeconds How long, in seconds, for the canary to continue making
             *   regular runs according to the schedule in the `Expression` value. If you specify 0,
             *   the canary continues making runs until you stop it. If you omit this field, the
             *   default of 0 is used.
             */
            public fun durationInSeconds(durationInSeconds: String)

            /**
             * @param expression A `rate` expression or a `cron` expression that defines how often
             *   the canary is to run. For a rate expression, The syntax is `rate( *number unit* )`
             *   . *unit* can be `minute` , `minutes` , or `hour` .
             *
             * For example, `rate(1 minute)` runs the canary once a minute, `rate(10 minutes)` runs
             * it once every 10 minutes, and `rate(1 hour)` runs it once every hour. You can specify
             * a frequency between `rate(1 minute)` and `rate(1 hour)` .
             *
             ...
             * to wait for more than a year before running. For information about the syntax for
             * cron expressions, see
             * [Scheduling canary runs using cron](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/CloudWatch_Synthetics_Canaries_cron.html)
             * .
             */
        ...
        internal constructor(
             ...
             * schedule in the `Expression` value.
             *
             * If you specify 0, the canary continues making runs until you stop it. If you omit
    ...
    public interface S3EncryptionProperty {
         ...
         *
         * Specify `SSE_S3` to use server-side encryption (SSE) with an Amazon S3-managed key.
         * Specify `SSE-KMS` to use server-side encryption with a customer-managed AWS KMS key.
         *
        ...
        public interface Builder {
            /**
             * @param encryptionMode The encryption method to use for artifacts created by this
    ...
    public interface VisualReferenceProperty {
         ...
         * made, `lastrun` to use the screenshots from the most recent run before this update was
         * made, or the value of `Id` in the
        ...
        public interface Builder {
             ...
             *   baseline for future visual monitoring with this canary. Valid values are `nextrun`
             *   to use the screenshots from the next run after this update is made, `lastrun` to
        ...
        internal constructor(
             ...
             * visual monitoring with this canary.
             *
             * Valid values are `nextrun` to use the screenshots from the next run after this update
             * is made, `lastrun` to use the screenshots from the most recent run before this update
             * was made, or the value of `Id` in the
             * [CanaryRun](https://docs.aws.amazon.com/AmazonSynthetics/latest/APIReference/API_CanaryRun.html)
             * from any past run of this canary.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-synthetics-canary-visualreference.html#cfn-synthetics-canary-visualreference-basecanaryrunid)
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: VisualReferenceProperty
            ): software.amazon.awscdk.services.synthetics.CfnCanary.VisualReferenceProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface BaseScreenshotProperty {
         ...
         */
        public fun ignoreCoordinates(): List<String> =
            unwrap(this).getIgnoreCoordinates() ?: emptyList()

        /**
         * The name of the screenshot.
         *
         * This is generated the first time the canary is run after the `UpdateCanary` operation
        ...
        public interface Builder {
            /**
             * @param ignoreCoordinates Coordinates that define the part of a screen to ignore
             *   during screenshot comparisons. To obtain the coordinates to use here, use the
            ...
            /**
             * @param screenshotName The name of the screenshot. This is generated the first time
             *   the canary is run after the `UpdateCanary` operation that specified for this canary
        ...
        internal constructor(
             ...
             * Coordinates that define the part of a screen to ignore during screenshot comparisons.
             *
             * To obtain the coordinates to use here, use the CloudWatch console to draw the
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-synthetics-canary-basescreenshot.html#cfn-synthetics-canary-basescreenshot-ignorecoordinates)
             */
            override fun ignoreCoordinates(): List<String> =
                unwrap(this).getIgnoreCoordinates() ?: emptyList()
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: BaseScreenshotProperty
            ): software.amazon.awscdk.services.synthetics.CfnCanary.BaseScreenshotProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface RunConfigProperty {
         ...
         *
         * Active tracing enables this canary run to be displayed in the ServiceLens and X-Ray
         ...
         * .
         *
         * You can enable active tracing only for canaries that use version `syn-nodejs-2.0` or
         * later for their canary runtime.
         *
         ...
         * environment variables cannot exceed 4 KB. You can't specify any Lambda reserved
         * environment variables as the keys for your environment variables. For more information
         * about reserved keys, see
        ...
        public interface Builder {
            /**
             * @param activeTracing Specifies whether this canary is to use active AWS X-Ray tracing
             *   when it runs. Active tracing enables this canary run to be displayed in the
             *   ServiceLens and X-Ray service maps even if the canary does not hit an endpoint that
             *   has X-Ray tracing enabled. Using X-Ray tracing incurs charges. For more
             *   information, see
             *   [Canaries and X-Ray tracing](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/CloudWatch_Synthetics_Canaries_tracing.html)
             *   .
             *
             ...
             * Keys must start with a letter and be at least two characters. The total size of your
             * environment variables cannot exceed 4 KB. You can't specify any Lambda reserved
             * environment variables as the keys for your environment variables. For more
             * information about reserved keys, see
             * [Runtime environment variables](https://docs.aws.amazon.com/lambda/latest/dg/configuration-envvars.html#configuration-envvars-runtime)
             * .
             */
        ...
        internal constructor(
             ...
             *
             * Active tracing enables this canary run to be displayed in the ServiceLens and X-Ray
             * service maps even if the canary does not hit an endpoint that has X-Ray tracing
             * enabled. Using X-Ray tracing incurs charges. For more information, see
             * [Canaries and X-Ray tracing](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/CloudWatch_Synthetics_Canaries_tracing.html)
             * .
             *
             * You can enable active tracing only for canaries that use version `syn-nodejs-2.0` or
    ...
    public interface ArtifactConfigProperty {
        ...
        public interface Builder {
            /**
             * @param s3Encryption A structure that contains the configuration of the
             *   encryption-at-rest settings for artifacts that the canary uploads to Amazon S3 .
             *   Artifact encryption functionality is available only for canaries that use
             *   Synthetics runtime version syn-nodejs-puppeteer-3.3 or later. For more information,
             *   see
             *   [Encrypting canary artifacts](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/CloudWatch_Synthetics_artifact_encryption.html)
             *   .
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ArtifactConfigProperty
            ): software.amazon.awscdk.services.synthetics.CfnCanary.ArtifactConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CodeProperty {
         ...
         * can specify a folder where canary scripts reside as `*folder* / *fileName* .
         * *functionName*` .
         *
        ...
        public interface Builder {
            ...
            /**
             * @param script If you input your canary script directly into the canary instead of
             *   referring to an S3 location, the value of this parameter is the script in plain
             *   text. It can be up to 5 MB.
             */
            public fun script(script: String)

            /**
             * @param sourceLocationArn The ARN of the Lambda layer where Synthetics stores the
             *   canary script code.
             */
        ...
        internal constructor(
             ...
             *
             * For canaries that use the `syn-python-selenium-1.0` runtime or a
             * `syn-nodejs.puppeteer` runtime earlier than `syn-nodejs.puppeteer-3.4` , the handler
             * must be specified as `*fileName* .handler` . For `syn-python-selenium-1.1` ,
             * `syn-nodejs.puppeteer-3.4` , and later runtimes, the handler can be specified as
             * `*fileName* . *functionName*` , or you can specify a folder where canary scripts
             * reside as `*folder* / *fileName* . *functionName*` .
             *
             ...
             * S3 location, the value of this parameter is the script in plain text.
             *
             * It can be up to 5 MB.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-synthetics-canary-code.html#cfn-synthetics-canary-code-script)
