...
public interface ReplicaTableProps : TableOptionsV2 {
    ...
    public fun globalSecondaryIndexOptions(): Map<String, ReplicaGlobalSecondaryIndexOptions> =
        unwrap(this).getGlobalSecondaryIndexOptions()?.mapValues {
            ReplicaGlobalSecondaryIndexOptions.wrap(it.value)
        } ?: emptyMap()
    ...
    public interface Builder {
        ...
        /**
         * @param readCapacity The read capacity. Note: This can only be configured if the primary
    ...
    private class BuilderImpl : Builder {
         ...
         *   properties.
         */
        override fun globalSecondaryIndexOptions(
            globalSecondaryIndexOptions: Map<String, ReplicaGlobalSecondaryIndexOptions>
        ) {
            cdkBuilder.globalSecondaryIndexOptions(
                globalSecondaryIndexOptions.mapValues {
