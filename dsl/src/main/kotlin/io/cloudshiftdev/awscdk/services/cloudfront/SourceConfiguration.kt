...
public interface SourceConfiguration {
    ...
    public interface Builder {
        /**
         * @param behaviors The behaviors associated with this source. At least one (default)
        ...
        public fun failoverCriteriaStatusCodes(
            failoverCriteriaStatusCodes: List<FailoverStatusCode>
        )

        /** @param failoverCriteriaStatusCodes HTTP status code to failover to second origin. */
        public fun failoverCriteriaStatusCodes(
            vararg failoverCriteriaStatusCodes: FailoverStatusCode
        )
        ...
        public fun failoverCustomOriginSource(
            failoverCustomOriginSource: CustomOriginConfig.Builder.() -> Unit
        )
        ...
        /**
         * @param originShieldRegion When you enable Origin Shield in the AWS Region that has the
         *   lowest latency to your origin, you can get better network performance.
         */
    ...
    private class BuilderImpl : Builder {
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("a1f40b3266f2ceec05cf9721afd6a3bf58299f6119273d45fb2c6546a8d08660")
        override fun customOriginSource(
            customOriginSource: CustomOriginConfig.Builder.() -> Unit
        ): Unit = customOriginSource(CustomOriginConfig(customOriginSource))

        /** @param failoverCriteriaStatusCodes HTTP status code to failover to second origin. */
        override fun failoverCriteriaStatusCodes(
            failoverCriteriaStatusCodes: List<FailoverStatusCode>
        ) {
            cdkBuilder.failoverCriteriaStatusCodes(
                failoverCriteriaStatusCodes.map(FailoverStatusCode::unwrap)
            )
        }
        ...
        override fun failoverCriteriaStatusCodes(
            vararg failoverCriteriaStatusCodes: FailoverStatusCode
        ): Unit = failoverCriteriaStatusCodes(failoverCriteriaStatusCodes.toList())
        ...
        override fun failoverCustomOriginSource(failoverCustomOriginSource: CustomOriginConfig) {
            cdkBuilder.failoverCustomOriginSource(
                failoverCustomOriginSource.let(CustomOriginConfig::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("eaa7f5a63e9eda405094c837ab71bbd677005861785044a491dea3de9bcce8df")
        override fun failoverCustomOriginSource(
            failoverCustomOriginSource: CustomOriginConfig.Builder.() -> Unit
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("ce12ffa0dc18dbba552bd55cbecb5faa871b2ddd6add2071f13850d513cbcee9")
        override fun failoverS3OriginSource(
            failoverS3OriginSource: S3OriginConfig.Builder.() -> Unit
    ...
    internal constructor(
        ...
        override fun failoverCriteriaStatusCodes(): List<FailoverStatusCode> =
            unwrap(this).getFailoverCriteriaStatusCodes()?.map(FailoverStatusCode::wrap)
                ?: emptyList()

        /**
         * A custom origin source for failover in case the s3OriginSource returns invalid status
         * code.
         *
         * Default: - no failover configuration
         */
         ...
         * origin, you can get better network performance.
         *
         * Default: - origin shield not enabled
         *
         * [Documentation](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/origin-shield.html)
