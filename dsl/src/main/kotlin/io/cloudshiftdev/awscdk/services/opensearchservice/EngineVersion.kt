...
internal constructor(
    ...
    public companion object {
        public fun elasticsearch(version: String): EngineVersion =
            software.amazon.awscdk.services.opensearchservice.EngineVersion.elasticsearch(version)
                .let(EngineVersion::wrap)

        public fun openSearch(version: String): EngineVersion =
            software.amazon.awscdk.services.opensearchservice.EngineVersion.openSearch(version)
                .let(EngineVersion::wrap)
