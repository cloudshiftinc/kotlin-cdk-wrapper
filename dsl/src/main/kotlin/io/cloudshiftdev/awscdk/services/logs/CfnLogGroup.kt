...
internal constructor(
    ...
    public interface Builder {
         ...
         * Creates a data protection policy and assigns it to the log group.
         *
         * A data protection policy can help safeguard sensitive data that's ingested by the log
         * group by auditing and masking the sensitive log data. When a user who does not have
         * permission to view masked data views a log event that includes masked data, the sensitive
         * data is replaced by asterisks.
         *
         ...
         *
         * @param dataProtectionPolicy Creates a data protection policy and assigns it to the log
         *   group.
         */
         ...
         * The Amazon Resource Name (ARN) of the AWS KMS key to use when encrypting log data.
         *
         * To associate an AWS KMS key with the log group, specify the ARN of that KMS key here. If
         * you do so, ingested data is encrypted using this key. This association is stored as long
         * as the data encrypted with the KMS key is still within CloudWatch Logs . This enables
         * CloudWatch Logs to decrypt this data whenever it is requested.
         *
         * If you attempt to associate a KMS key with the log group but the KMS key doesn't exist or
         * is deactivated, you will receive an `InvalidParameterException` error.
         *
         * Log group data is always encrypted in CloudWatch Logs . If you omit this key, the
         * encryption does not use AWS KMS . For more information, see
         ...
         *
         * @param kmsKeyId The Amazon Resource Name (ARN) of the AWS KMS key to use when encrypting
         *   log data.
         */
    ...
    public companion object {
        ...
        ): CfnLogGroup = CfnLogGroup(cdkObject)

        internal fun unwrap(
            wrapped: CfnLogGroup
        ): software.amazon.awscdk.services.logs.CfnLogGroup = wrapped.cdkObject
    }
}
