...
public enum class ComputeType(
  ...
  public companion object {
    internal fun wrap(cdkObject: software.amazon.awscdk.services.codebuild.ComputeType): ComputeType
        = when (cdkObject) {
      ...
      software.amazon.awscdk.services.codebuild.ComputeType.X2_LARGE -> ComputeType.X2_LARGE
      software.amazon.awscdk.services.codebuild.ComputeType.LAMBDA_1GB -> ComputeType.LAMBDA_1GB
      software.amazon.awscdk.services.codebuild.ComputeType.LAMBDA_2GB -> ComputeType.LAMBDA_2GB
