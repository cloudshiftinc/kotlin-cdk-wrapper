...
internal constructor(
    ...
    public companion object {
        public fun all(): OriginRequestQueryStringBehavior =
            software.amazon.awscdk.services.cloudfront.OriginRequestQueryStringBehavior.all()
                .let(OriginRequestQueryStringBehavior::wrap)

        public fun allowList(queryStrings: String): OriginRequestQueryStringBehavior =
            software.amazon.awscdk.services.cloudfront.OriginRequestQueryStringBehavior.allowList(
                    queryStrings
                )
                .let(OriginRequestQueryStringBehavior::wrap)

        public fun denyList(queryStrings: String): OriginRequestQueryStringBehavior =
            software.amazon.awscdk.services.cloudfront.OriginRequestQueryStringBehavior.denyList(
                    queryStrings
                )
                .let(OriginRequestQueryStringBehavior::wrap)

        public fun none(): OriginRequestQueryStringBehavior =
            software.amazon.awscdk.services.cloudfront.OriginRequestQueryStringBehavior.none()
                .let(OriginRequestQueryStringBehavior::wrap)
        ...
        internal fun unwrap(
            wrapped: OriginRequestQueryStringBehavior
        ): software.amazon.awscdk.services.cloudfront.OriginRequestQueryStringBehavior =
            wrapped.cdkObject
    }
}
