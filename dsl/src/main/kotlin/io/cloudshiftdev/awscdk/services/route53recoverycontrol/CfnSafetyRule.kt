...
internal constructor(
    ...
    public interface Builder {
         ...
         * criteria that you set in the rule configuration is met.
         *
         * Otherwise, the change to the routing control is not accepted. For example, the criteria
         * might be that at least one routing control state is `On` after the transaction so that
         * traffic continues to flow to at least one cell for the application. This ensures that you
         ...
         * configuration to `OR` , that indicates that you must set the gating routing control to
         * `On` for the rule to evaluate as true; that is, for the gating control switch to be On.
         * When you do that, then you can update the routing control states for the target routing
         ...
         *   routing controls, evaluates as true, based on a rule configuration that you specify,
         ...
         * The name of the assertion rule.
         *
         * The name must be unique within a control panel. You can use any non-white space character
         * in the name except the following: &amp; &gt; &lt; ' (single quote) " (double quote) ;
         * (semicolon)
         *
         ...
         * designate how many control states must be `ON` as the result of a transaction.
         *
         * For example, if you have three assertion controls, you might specify `ATLEAST 2` for your
         * rule configuration. This means that at least two assertion controls must be `ON` , so
         * that at least two AWS Regions have traffic flowing to them.
         *
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.route53recoverycontrol.CfnSafetyRule.Builder.create(
                scope,
                id
            )
    ...
    public interface RuleConfigProperty {
        ...
        public interface Builder {
            /**
             * @param inverted Logical negation of the rule. If the rule would usually evaluate
    ...
    public interface GatingRuleProperty {
         ...
         * controls are evaluated by the rule configuration that you specify to determine if the
         * target routing control states can be changed.
         *
         ...
         * only be updated if the rule configuration that you specify evaluates to true for the
         * gating routing control.
         *
         * As a simple example, if you have a single gating control, it acts as an overall on-off
         * switch for a set of target routing controls. You can use this to manually override
        ...
        public interface Builder {
            /**
             * @param gatingControls An array of gating routing control Amazon Resource Names
             *   (ARNs). For a simple on-off switch, specify the ARN for one routing control. The
             *   gating routing controls are evaluated by the rule configuration that you specify to
            ...
            /**
             * @param targetControls An array of target routing control Amazon Resource Names (ARNs)
             *   for which the states can only be updated if the rule configuration that you specify
             *   evaluates to true for the gating routing control. As a simple example, if you have
             *   a single gating control, it acts as an overall on-off switch for a set of target
            ...
            /**
             * @param waitPeriodMs An evaluation period, in milliseconds (ms), during which any
             *   request against the target routing controls will fail. This helps prevent flapping
             *   of state. The wait period is 5000 ms by default, but you can choose a custom value.
             */
        ...
        internal constructor(
             ...
             * An array of gating routing control Amazon Resource Names (ARNs).
             *
             * For a simple on-off switch, specify the ARN for one routing control. The gating
             ...
             *
             * As a simple example, if you have a single gating control, it acts as an overall
             * on-off switch for a set of target routing controls. You can use this to manually
             ...
             * target routing controls will fail.
             *
             * This helps prevent flapping of state. The wait period is 5000 ms by default, but you
    ...
    public interface AssertionRuleProperty {
        ...
        public interface Builder {
             ...
             *   For example, you might include three routing controls, one for each of three AWS
             *   Regions.
             */
        ...
        internal constructor(
            ...
            /**
             * The routing controls that are part of transactions that are evaluated to determine if
             * a request to change a routing control state is allowed.
             *
             * For example, you might include three routing controls, one for each of three AWS
             * Regions.
             *
