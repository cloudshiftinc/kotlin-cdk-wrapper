...
internal constructor(
    ...
    public interface Builder {
        ...
        /**
         * Any descriptive information that you want to add to the endpoint for future
         ...
         *
         * @param manifestName A short string that's appended to the end of the endpoint URL to
         ...
         * * `DENY` - prevents this endpoint from serving content. Denying origination is helpful
         *   for harvesting live-to-VOD assets. For more information about harvesting and
         *   origination, see
         ...
         *
         * @param startoverWindowSeconds Maximum duration (seconds) of content to retain for
         *   startover playback.
         */
         ...
         * Minimum duration (seconds) of delay to enforce on the playback of live content.
         *
         * Omit this attribute or enter `0` to indicate that there is no time delay in effect for
         * this endpoint.
         *
    ...
    public interface MssPackageProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param segmentDurationSeconds Duration (in seconds) of each fragment. Actual
             *   fragments are rounded to the nearest multiple of the source fragment duration.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("4175e1ef5ed609f7966bcfad0b3aeb10b8b4956ec2e456c2f1057f60ebb641a9")
            override fun streamSelection(
                streamSelection: StreamSelectionProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-mediapackage-originendpoint-msspackage.html#cfn-mediapackage-originendpoint-msspackage-segmentdurationseconds)
             */
            override fun segmentDurationSeconds(): Number? =
    ...
    public interface CmafPackageProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param hlsManifests A list of HLS manifest configurations that are available from
             *   this endpoint.
             */
            ...
            /**
             * @param segmentDurationSeconds Duration (in seconds) of each segment. Actual segments
             *   are rounded to the nearest multiple of the source segment duration.
             */
            public fun segmentDurationSeconds(segmentDurationSeconds: Number)

            /**
             * @param segmentPrefix An optional custom string that is prepended to the name of each
             *   segment. If not specified, the segment prefix defaults to the ChannelId.
             */
    ...
    public interface AuthorizationProperty {
        ...
        public interface Builder {
             ...
             *   Secrets Manager that your Content Delivery Network (CDN) uses for authorization to
        ...
        internal constructor(
            ...
            /**
             * The Amazon Resource Name (ARN) for the secret in AWS Secrets Manager that your
             * Content Delivery Network (CDN) uses for authorization to access your endpoint.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-mediapackage-originendpoint-authorization.html#cfn-mediapackage-originendpoint-authorization-cdnidentifiersecret)
             */
    ...
    public interface SpekeKeyProviderProperty {
         ...
         * for your endpoints that use SPEKE Version 2.0. The encryption contract defines which
         * content keys are used to encrypt the audio and video tracks in your stream. To configure
         ...
         * role, and it must have a sufficient permissions policy to allow access to the specific
         * key retrieval URL. Valid format: arn:aws:iam::{accountID}:role/{name}
         *
        ...
        public interface Builder {
            /**
             * @param certificateArn The Amazon Resource Name (ARN) for the certificate that you
             *   imported to AWS Certificate Manager to add content key encryption to this endpoint.
             *   For this feature to work, your DRM key provider must support content key
             *   encryption.
             */
            public fun certificateArn(certificateArn: String)

            /**
             * @param encryptionContractConfiguration Use `encryptionContractConfiguration` to
             *   configure one or more content encryption keys for your endpoints that use SPEKE
             *   Version 2.0. The encryption contract defines which content keys are used to encrypt
             *   the audio and video tracks in your stream. To configure the encryption contract,
            ...
            public fun encryptionContractConfiguration(
                encryptionContractConfiguration:
                    EncryptionContractConfigurationProperty.Builder.() -> Unit
            )
             ...
             *   access to the key provider API. This role must have a trust policy that allows AWS
             *   Elemental MediaPackage to assume the role, and it must have a sufficient
            ...
            /**
             * @param systemIds List of unique identifiers for the DRM systems to use, as defined in
            ...
            /**
             * @param url URL for the key provider’s key retrieval API endpoint. Must start with
             *   https://.
             */
        ...
        private class BuilderImpl : Builder {
             ...
             *   specify which audio and video encryption presets to use.
             */
            override fun encryptionContractConfiguration(
                encryptionContractConfiguration: IResolvable
            ) {
                cdkBuilder.encryptionContractConfiguration(
                    encryptionContractConfiguration.let(IResolvable::unwrap)
                )
            }
            ...
            override fun encryptionContractConfiguration(
                ...
                cdkBuilder.encryptionContractConfiguration(
                    encryptionContractConfiguration.let(
                        EncryptionContractConfigurationProperty::unwrap
                    )
                )
            }
            ...
            override fun encryptionContractConfiguration(
                ...
                encryptionContractConfiguration(
                    EncryptionContractConfigurationProperty(encryptionContractConfiguration)
                )
        ...
        internal constructor(
            ...
            /**
             * The Amazon Resource Name (ARN) for the certificate that you imported to AWS
             ...
             * keys for your endpoints that use SPEKE Version 2.0. The encryption contract defines
             * which content keys are used to encrypt the audio and video tracks in your stream. To
             * configure the encryption contract, specify which audio and video encryption presets
             * to use.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-mediapackage-originendpoint-spekekeyprovider.html#cfn-mediapackage-originendpoint-spekekeyprovider-encryptioncontractconfiguration)
             */
            ...
            /**
             * The ARN for the IAM role that's granted by the key provider to provide access to the
             * key provider API.
             *
             * This role must have a trust policy that allows AWS Elemental MediaPackage to assume
             * the role, and it must have a sufficient permissions policy to allow access to the
             * specific key retrieval URL. Valid format: arn:aws:iam::{accountID}:role/{name}
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-mediapackage-originendpoint-spekekeyprovider.html#cfn-mediapackage-originendpoint-spekekeyprovider-rolearn)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SpekeKeyProviderProperty
            ): software.amazon.awscdk.services.mediapackage.CfnOriginEndpoint.SpekeKeyProviderProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface HlsManifestProperty {
        ...
        /**
         * Specifies the SCTE-35 message types that AWS Elemental MediaPackage treats as ad markers
         ...
         *
         * For information about SCTE-35 in AWS Elemental MediaPackage , see
         ...
         */
        public fun adsOnDeliveryRestrictions(): String? =
         ...
         *
         * When true, the stream set includes an additional I-frame only stream, along with the
         ...
         * this endpoint.
         *
         * The manifestName on the HLSManifest object overrides the manifestName that you provided
        ...
        /**
         * When specified as either `event` or `vod` , a corresponding `EXT-X-PLAYLIST-TYPE` entry
         * is included in the media playlist.
         *
        ...
        public interface Builder {
            /**
             * @param adMarkers Controls how ad markers are included in the packaged endpoint. Valid
             *   values:
             * * `NONE` - Omits all SCTE-35 ad markers from the output.
             * * `PASSTHROUGH` - Creates a copy in the output of the SCTE-35 ad markers (comments)
             *   taken directly from the input manifest.
             * * `SCTE35_ENHANCED` - Generates ad markers and blackout tags in the output based on
             *   the SCTE-35 messages from the input manifest.
             */
             ...
             *   treats as ad markers in the output manifest. Valid values:
             * * `BREAK`
             * * `DISTRIBUTOR_ADVERTISEMENT`
             * * `DISTRIBUTOR_OVERLAY_PLACEMENT_OPPORTUNITY`
             * * `DISTRIBUTOR_PLACEMENT_OPPORTUNITY`
            ...
            /**
             * @param adsOnDeliveryRestrictions The flags on SCTE-35 segmentation descriptors that
             *   have to be present for AWS Elemental MediaPackage to insert ad markers in the
             *   output manifest. For information about SCTE-35 in AWS Elemental MediaPackage , see
             *   [SCTE-35 Message Options in AWS Elemental MediaPackage](https://docs.aws.amazon.com/mediapackage/latest/ug/scte.html)
             *   .
             */
             ...
             *   When true, the stream set includes an additional I-frame only stream, along with
            ...
            /**
             * @param manifestName A short string that's appended to the end of the endpoint URL to
             *   create a unique path to this endpoint. The manifestName on the HLSManifest object
             *   overrides the manifestName that you provided on the originEndpoint object.
             */
            public fun manifestName(manifestName: String)

            /**
             * @param playlistType When specified as either `event` or `vod` , a corresponding
             *   `EXT-X-PLAYLIST-TYPE` entry is included in the media playlist. Indicates if the
             *   playlist is live-to-VOD content.
             */
            public fun playlistType(playlistType: String)

            /**
             * @param playlistWindowSeconds Time window (in seconds) contained in each parent
             *   manifest.
             */
            public fun playlistWindowSeconds(playlistWindowSeconds: Number)

            /**
             * @param programDateTimeIntervalSeconds Inserts `EXT-X-PROGRAM-DATE-TIME` tags in the
             *   output manifest at the interval that you specify. Additionally, ID3Timed metadata
             *   messages are generated every 5 seconds starting when the content was ingested.
             *
             * Irrespective of this parameter, if any ID3Timed metadata is in the HLS input, it is
             * passed through to the HLS output.
             *
             * Omit this attribute or enter `0` to indicate that the `EXT-X-PROGRAM-DATE-TIME` tags
        ...
        private class BuilderImpl : Builder {
             ...
             * * `SPLICE_INSERT`
             */
            override fun adTriggers(vararg adTriggers: String): Unit =
                adTriggers(adTriggers.toList())
        ...
        internal constructor(
            ...
            /**
             * Specifies the SCTE-35 message types that AWS Elemental MediaPackage treats as ad
             * markers in the output manifest.
             *
             * Valid values:
             * * `BREAK`
             * * `DISTRIBUTOR_ADVERTISEMENT`
            ...
            /**
             * The flags on SCTE-35 segmentation descriptors that have to be present for AWS
             * Elemental MediaPackage to insert ad markers in the output manifest.
             *
             * For information about SCTE-35 in AWS Elemental MediaPackage , see
             * [SCTE-35 Message Options in AWS Elemental MediaPackage](https://docs.aws.amazon.com/mediapackage/latest/ug/scte.html)
             * .
            ...
            /**
             * A short string that's appended to the end of the endpoint URL to create a unique path
             * to this endpoint.
             *
             * The manifestName on the HLSManifest object overrides the manifestName that you
            ...
            /**
             * When specified as either `event` or `vod` , a corresponding `EXT-X-PLAYLIST-TYPE`
            ...
            /**
             * Inserts `EXT-X-PROGRAM-DATE-TIME` tags in the output manifest at the interval that
             * you specify.
             *
             * Additionally, ID3Timed metadata messages are generated every 5 seconds starting when
             * the content was ingested.
             *
             * Irrespective of this parameter, if any ID3Timed metadata is in the HLS input, it is
             * passed through to the HLS output.
             *
    ...
    public interface HlsPackageProperty {
        ...
        public interface Builder {
             ...
             *   tracks in a rendition group. All other tracks in the stream can be used with any
    ...
    public interface StreamSelectionProperty {
         ...
         *
         * If the video track exceeds this threshold, then AWS Elemental MediaPackage excludes it
         * from output. If you don't specify a value, it defaults to 2147483647 bits per second.
         *
        ...
        public interface Builder {
            /**
             * @param maxVideoBitsPerSecond The upper limit of the bitrates that this endpoint
             *   serves. If the video track exceeds this threshold, then AWS Elemental MediaPackage
             *   excludes it from output. If you don't specify a value, it defaults to 2147483647
             *   bits per second.
             */
            public fun maxVideoBitsPerSecond(maxVideoBitsPerSecond: Number)

            /**
             * @param minVideoBitsPerSecond The lower limit of the bitrates that this endpoint
             *   serves. If the video track is below this threshold, then AWS Elemental MediaPackage
             *   excludes it from output. If you don't specify a value, it defaults to 0 bits per
             *   second.
             */
            public fun minVideoBitsPerSecond(minVideoBitsPerSecond: Number)

            /**
             * @param streamOrder Order in which the different video bitrates are presented to the
             *   player. Valid values: `ORIGINAL` , `VIDEO_BITRATE_ASCENDING` ,
        ...
        internal constructor(
             ...
             * The upper limit of the bitrates that this endpoint serves.
             *
             * If the video track exceeds this threshold, then AWS Elemental MediaPackage excludes
             * it from output. If you don't specify a value, it defaults to 2147483647 bits per
             * second.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-mediapackage-originendpoint-streamselection.html#cfn-mediapackage-originendpoint-streamselection-maxvideobitspersecond)
             */
             ...
             * The lower limit of the bitrates that this endpoint serves.
             *
             * If the video track is below this threshold, then AWS Elemental MediaPackage excludes
             * it from output. If you don't specify a value, it defaults to 0 bits per second.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-mediapackage-originendpoint-streamselection.html#cfn-mediapackage-originendpoint-streamselection-minvideobitspersecond)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: StreamSelectionProperty
            ): software.amazon.awscdk.services.mediapackage.CfnOriginEndpoint.StreamSelectionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CmafEncryptionProperty {
         ...
         */
        public fun keyRotationIntervalSeconds(): Number? =
        ...
        public interface Builder {
            /**
             * @param constantInitializationVector An optional 128-bit, 16-byte hex value
             *   represented by a 32-character string, used in conjunction with the key for
             *   encrypting blocks. If you don't specify a value, then AWS Elemental MediaPackage
             ...
             *   rotates to a new key. By default, rotation is set to 60 seconds. Set to `0` to
            ...
            public fun spekeKeyProvider(
                spekeKeyProvider: SpekeKeyProviderProperty.Builder.() -> Unit
            )
        }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CmafEncryptionProperty
            ): software.amazon.awscdk.services.mediapackage.CfnOriginEndpoint.CmafEncryptionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface EncryptionContractConfigurationProperty {
         ...
         *
         * Value description:
         * * `PRESET-AUDIO-1` - Use one content key to encrypt all of the audio tracks in your
         *   stream.
         ...
         *   content key to encrypt all of the multichannel audio tracks with 3 to 6 channels, and
         *   one content key to encrypt all of the multichannel audio tracks with more than 6
         *   channels.
         * * `SHARED` - Use the same content key for all of the audio and video tracks in your
         *   stream.
         ...
         *
         * Value description:
         * * `PRESET-VIDEO-1` - Use one content key to encrypt all of the video tracks in your
         *   stream.
         ...
         * * `PRESET-VIDEO-3` - Use one content key to encrypt all of the SD video tracks, one
         *   content key for HD video tracks and one content key for all UHD video tracks.
         * * `PRESET-VIDEO-4` - Use one content key to encrypt all of the SD video tracks, one
         *   content key for HD video tracks, one content key for all UHD1 video tracks and one
         *   content key for all UHD2 video tracks.
         * * `PRESET-VIDEO-5` - Use one content key to encrypt all of the SD video tracks, one
         *   content key for HD1 video tracks, one content key for HD2 video tracks, one content key
         *   for all UHD1 video tracks and one content key for all UHD2 video tracks.
         * * `PRESET-VIDEO-6` - Use one content key to encrypt all of the SD video tracks, one
         *   content key for HD1 video tracks, one content key for HD2 video tracks and one content
         ...
         *   content key for all UHD2 video tracks.
         * * `SHARED` - Use the same content key for all of the video and audio tracks in your
         *   stream.
        ...
        public interface Builder {
            /**
             * @param presetSpeke20Audio A collection of audio encryption presets. Value
             *   description:
             * * `PRESET-AUDIO-1` - Use one content key to encrypt all of the audio tracks in your
             *   stream.
             * * `PRESET-AUDIO-2` - Use one content key to encrypt all of the stereo audio tracks
             *   and one content key to encrypt all of the multichannel audio tracks.
             * * `PRESET-AUDIO-3` - Use one content key to encrypt all of the stereo audio tracks,
             *   one content key to encrypt all of the multichannel audio tracks with 3 to 6
             *   channels, and one content key to encrypt all of the multichannel audio tracks with
            ...
            /**
             * @param presetSpeke20Video A collection of video encryption presets. Value
             *   description:
             * * `PRESET-VIDEO-1` - Use one content key to encrypt all of the video tracks in your
             *   stream.
             * * `PRESET-VIDEO-2` - Use one content key to encrypt all of the SD video tracks and
             *   one content key for all HD and higher resolutions video tracks.
             * * `PRESET-VIDEO-3` - Use one content key to encrypt all of the SD video tracks, one
             *   content key for HD video tracks and one content key for all UHD video tracks.
             * * `PRESET-VIDEO-4` - Use one content key to encrypt all of the SD video tracks, one
             *   content key for HD video tracks, one content key for all UHD1 video tracks and one
             *   content key for all UHD2 video tracks.
             * * `PRESET-VIDEO-5` - Use one content key to encrypt all of the SD video tracks, one
             *   content key for HD1 video tracks, one content key for HD2 video tracks, one content
             *   key for all UHD1 video tracks and one content key for all UHD2 video tracks.
             * * `PRESET-VIDEO-6` - Use one content key to encrypt all of the SD video tracks, one
             *   content key for HD1 video tracks, one content key for HD2 video tracks and one
             *   content key for all UHD video tracks.
             * * `PRESET-VIDEO-7` - Use one content key to encrypt all of the SD+HD1 video tracks,
             *   one content key for HD2 video tracks and one content key for all UHD video tracks.
             * * `PRESET-VIDEO-8` - Use one content key to encrypt all of the SD+HD1 video tracks,
             *   one content key for HD2 video tracks, one content key for all UHD1 video tracks and
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: EncryptionContractConfigurationProperty
            ): software.amazon.awscdk.services.mediapackage.CfnOriginEndpoint.EncryptionContractConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface HlsEncryptionProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param repeatExtXKey Repeat the `EXT-X-KEY` directive for every media segment. This
        ...
        internal constructor(
            ...
            /**
             * A 128-bit, 16-byte hex value represented by a 32-character string, used with the key
    ...
    public interface DashPackageProperty {
         ...
         *
         * When true, the stream set includes an additional I-frame trick-play only stream, along
         * with the other tracks. If false, this extra stream is not included.
         *
         ...
         * manifests.
         *
         * For more information about periods, see
         * [Multi-period DASH in AWS Elemental MediaPackage](https://docs.aws.amazon.com/mediapackage/latest/ug/multi-period.html)
         * .
         *
         * Valid values:
         * * `ADS` - AWS Elemental MediaPackage will produce multi-period DASH manifests. Periods
         *   are created based on the SCTE-35 ad markers present in the input manifest.
        ...
        /**
         * Determines the type of variable used in the `media` URL of the `SegmentTemplate` tag in
         * the manifest.
         *
         ...
         *
         * Valid values:
         * * `NUMBER_WITH_TIMELINE` - The `$Number$` variable is used in the `media` URL. The value
         *   of this variable is the sequential number of the segment. A full `SegmentTimeline`
         ...
         *   this variable is the timestamp of when the segment starts. A full `SegmentTimeline`
         *   object is presented in each `SegmentTemplate` .
         *
        ...
        /**
         * Amount of time (in seconds) that the player should be from the live point at the end of
         * the manifest.
         *
        ...
        /**
         * Specifies the value attribute of the UTC timing field when utcTiming is set to HTTP-ISO
         * or HTTP-HEAD.
         *
        ...
        public interface Builder {
            ...
            /**
             * @param includeIframeOnlyStream This applies only to stream sets with a single video
             *   track. When true, the stream set includes an additional I-frame trick-play only
             *   stream, along with the other tracks. If false, this extra stream is not included.
             */
            public fun includeIframeOnlyStream(includeIframeOnlyStream: Boolean)
            ...
            /**
             * @param manifestLayout Determines the position of some tags in the manifest. Valid
             *   values:
             * * `FULL` - Elements like `SegmentTemplate` and `ContentProtection` are included in
             *   each `Representation` .
             * * `COMPACT` - Duplicate elements are combined and presented at the `AdaptationSet`
             *   level.
             */
            ...
            /**
             * @param minBufferTimeSeconds Minimum amount of content (measured in seconds) that a
             *   player must keep available in the buffer.
             */
            public fun minBufferTimeSeconds(minBufferTimeSeconds: Number)

            /**
             * @param minUpdatePeriodSeconds Minimum amount of time (in seconds) that the player
             *   should wait before requesting updates to the manifest.
             */
            public fun minUpdatePeriodSeconds(minUpdatePeriodSeconds: Number)

            /**
             * @param periodTriggers Controls whether AWS Elemental MediaPackage produces
             *   single-period or multi-period DASH manifests. For more information about periods,
             *   see
             *   [Multi-period DASH in AWS Elemental MediaPackage](https://docs.aws.amazon.com/mediapackage/latest/ug/multi-period.html)
             *   .
             *
             * Valid values:
             * * `ADS` - AWS Elemental MediaPackage will produce multi-period DASH manifests.
             *   Periods are created based on the SCTE-35 ad markers present in the input manifest.
             * * *No value* - AWS Elemental MediaPackage will produce single-period DASH manifests.
            ...
            /**
             * @param segmentTemplateFormat Determines the type of variable used in the `media` URL
             *   of the `SegmentTemplate` tag in the manifest. Also specifies if segment timeline
             ...
             * * `NUMBER_WITH_DURATION` - The `$Number$` variable is used in the `media` URL and a
             *   `duration` attribute is added to the segment template. The `SegmentTimeline` object
             *   is removed from the representation.
             * * `TIME_WITH_TIMELINE` - The `$Time$` variable is used in the `media` URL. The value
             *   of this variable is the timestamp of when the segment starts. A full
             *   `SegmentTimeline` object is presented in each `SegmentTemplate` .
             */
            ...
            /**
             * @param suggestedPresentationDelaySeconds Amount of time (in seconds) that the player
             *   should be from the live point at the end of the manifest.
             */
            public fun suggestedPresentationDelaySeconds(suggestedPresentationDelaySeconds: Number)

            /**
             * @param utcTiming Determines the type of UTC timing included in the DASH Media
             *   Presentation Description (MPD).
             */
            public fun utcTiming(utcTiming: String)

            /**
             * @param utcTimingUri Specifies the value attribute of the UTC timing field when
             *   utcTiming is set to HTTP-ISO or HTTP-HEAD.
             */
        ...
        private class BuilderImpl : Builder {
             ...
             *   should be from the live point at the end of the manifest.
             */
            override fun suggestedPresentationDelaySeconds(
        ...
        internal constructor(
             ...
             * This applies only to stream sets with a single video track.
             *
             * When true, the stream set includes an additional I-frame trick-play only stream,
            ...
            /**
             * Minimum amount of content (measured in seconds) that a player must keep available in
             * the buffer.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-mediapackage-originendpoint-dashpackage.html#cfn-mediapackage-originendpoint-dashpackage-minbuffertimeseconds)
             */
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-mediapackage-originendpoint-dashpackage.html#cfn-mediapackage-originendpoint-dashpackage-minupdateperiodseconds)
             */
            override fun minUpdatePeriodSeconds(): Number? =
                unwrap(this).getMinUpdatePeriodSeconds()

            /**
             * Controls whether AWS Elemental MediaPackage produces single-period or multi-period
             * DASH manifests.
             *
             * For more information about periods, see
             * [Multi-period DASH in AWS Elemental MediaPackage](https://docs.aws.amazon.com/mediapackage/latest/ug/multi-period.html)
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-mediapackage-originendpoint-dashpackage.html#cfn-mediapackage-originendpoint-dashpackage-periodtriggers)
             */
            override fun periodTriggers(): List<String> =
                unwrap(this).getPeriodTriggers() ?: emptyList()
            ...
            /**
             * Determines the type of variable used in the `media` URL of the `SegmentTemplate` tag
             * in the manifest.
             *
             * Also specifies if segment timeline information is included in `SegmentTimeline` or
             * `SegmentTemplate` .
            ...
            /**
             * Specifies the value attribute of the UTC timing field when utcTiming is set to
    ...
    public interface DashEncryptionProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DashEncryptionProperty
            ): software.amazon.awscdk.services.mediapackage.CfnOriginEndpoint.DashEncryptionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
