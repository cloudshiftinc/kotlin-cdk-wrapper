...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param defaultConfig The default configuration that applies to all Lambda functions in
         *   the group.
         */
         ...
         *
         * @param functionDefinitionId The ID of the function definition associated with this
         *   version.
         */
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.greengrass.CfnFunctionDefinitionVersion.Builder.create(
                scope,
                id
            )
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnFunctionDefinitionVersion
        ): software.amazon.awscdk.services.greengrass.CfnFunctionDefinitionVersion =
            wrapped.cdkObject
    }
