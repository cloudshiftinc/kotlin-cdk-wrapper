...
internal constructor(
     ...
     *
     * If true, then you can attach the policy to roots, OUs, or accounts, but you cannot edit it.
    ...
    public interface Builder {
         ...
         * string.
         *
         * When you specify the policy content as a JSON string, you can't perform drift detection
         * on the CloudFormation stack. For this reason, we recommend specifying the policy content
         * as a JSON object instead.
         *
         * The text that you supply must adhere to the rules of the policy type you specify in the
         * `Type` parameter. The following AWS Organizations quotas are enforced for the maximum
         * size of a policy document:
         ...
         *
         * @param content The policy text content. You can specify the policy content as a JSON
         ...
         * Name of the policy.
         *
         * The [regex pattern](https://docs.aws.amazon.com/http://wikipedia.org/wiki/regex) that is
         * used to validate this parameter is a string of any of the characters in the ASCII
         * character range.
         *
         ...
         *
         * The [regex pattern](https://docs.aws.amazon.com/http://wikipedia.org/wiki/regex) for a
         ...
         *
         * @param targetIds List of unique identifiers (IDs) of the root, OU, or account that you
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.organizations.CfnPolicy =
            cdkBuilder.build()
    }
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnPolicy
        ): software.amazon.awscdk.services.organizations.CfnPolicy = wrapped.cdkObject
    }
}
