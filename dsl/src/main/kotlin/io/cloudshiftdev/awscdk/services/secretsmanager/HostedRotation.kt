...
internal constructor(
    ...
    public open fun bind(
        ...
        unwrap(this)
            .bind(secret.let(ISecret::unwrap), scope.let(Construct::unwrap))
            .let(CfnRotationSchedule.HostedRotationLambdaProperty::wrap)
    ...
    public companion object {
        public fun mariaDbMultiUser(options: MultiUserHostedRotationOptions): HostedRotation =
            software.amazon.awscdk.services.secretsmanager.HostedRotation.mariaDbMultiUser(
                    options.let(MultiUserHostedRotationOptions::unwrap)
                )
                .let(HostedRotation::wrap)

        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("3002ba3c057d780f5f230ee155f1bd8394c3946a82338315e17b4dbb3cab4339")
        public fun mariaDbMultiUser(
            options: MultiUserHostedRotationOptions.Builder.() -> Unit
        ): HostedRotation = mariaDbMultiUser(MultiUserHostedRotationOptions(options))

        public fun mariaDbSingleUser(): HostedRotation =
            software.amazon.awscdk.services.secretsmanager.HostedRotation.mariaDbSingleUser()
                .let(HostedRotation::wrap)

        public fun mariaDbSingleUser(options: SingleUserHostedRotationOptions): HostedRotation =
            software.amazon.awscdk.services.secretsmanager.HostedRotation.mariaDbSingleUser(
                    options.let(SingleUserHostedRotationOptions::unwrap)
                )
                .let(HostedRotation::wrap)
        ...
        public fun mariaDbSingleUser(
            options: SingleUserHostedRotationOptions.Builder.() -> Unit
        ...
        public fun mongoDbMultiUser(options: MultiUserHostedRotationOptions): HostedRotation =
            software.amazon.awscdk.services.secretsmanager.HostedRotation.mongoDbMultiUser(
                    options.let(MultiUserHostedRotationOptions::unwrap)
                )
                .let(HostedRotation::wrap)
        ...
        public fun mongoDbSingleUser(): HostedRotation =
            software.amazon.awscdk.services.secretsmanager.HostedRotation.mongoDbSingleUser()
                .let(HostedRotation::wrap)
        ...
        public fun mysqlMultiUser(options: MultiUserHostedRotationOptions): HostedRotation =
            software.amazon.awscdk.services.secretsmanager.HostedRotation.mysqlMultiUser(
                    options.let(MultiUserHostedRotationOptions::unwrap)
                )
                .let(HostedRotation::wrap)
        ...
        public fun mysqlSingleUser(): HostedRotation =
            software.amazon.awscdk.services.secretsmanager.HostedRotation.mysqlSingleUser()
                .let(HostedRotation::wrap)
        ...
        public fun oracleMultiUser(options: MultiUserHostedRotationOptions): HostedRotation =
            software.amazon.awscdk.services.secretsmanager.HostedRotation.oracleMultiUser(
                    options.let(MultiUserHostedRotationOptions::unwrap)
                )
                .let(HostedRotation::wrap)
        ...
        public fun oracleSingleUser(): HostedRotation =
            software.amazon.awscdk.services.secretsmanager.HostedRotation.oracleSingleUser()
                .let(HostedRotation::wrap)
        ...
        public fun postgreSqlMultiUser(options: MultiUserHostedRotationOptions): HostedRotation =
            software.amazon.awscdk.services.secretsmanager.HostedRotation.postgreSqlMultiUser(
                    options.let(MultiUserHostedRotationOptions::unwrap)
                )
                .let(HostedRotation::wrap)
        ...
        public fun postgreSqlSingleUser(): HostedRotation =
            software.amazon.awscdk.services.secretsmanager.HostedRotation.postgreSqlSingleUser()
                .let(HostedRotation::wrap)
        ...
        public fun redshiftMultiUser(options: MultiUserHostedRotationOptions): HostedRotation =
            software.amazon.awscdk.services.secretsmanager.HostedRotation.redshiftMultiUser(
                    options.let(MultiUserHostedRotationOptions::unwrap)
                )
                .let(HostedRotation::wrap)
        ...
        public fun redshiftSingleUser(): HostedRotation =
            software.amazon.awscdk.services.secretsmanager.HostedRotation.redshiftSingleUser()
                .let(HostedRotation::wrap)
        ...
        public fun sqlServerMultiUser(options: MultiUserHostedRotationOptions): HostedRotation =
            software.amazon.awscdk.services.secretsmanager.HostedRotation.sqlServerMultiUser(
                    options.let(MultiUserHostedRotationOptions::unwrap)
                )
                .let(HostedRotation::wrap)
        ...
        public fun sqlServerSingleUser(): HostedRotation =
            software.amazon.awscdk.services.secretsmanager.HostedRotation.sqlServerSingleUser()
                .let(HostedRotation::wrap)
