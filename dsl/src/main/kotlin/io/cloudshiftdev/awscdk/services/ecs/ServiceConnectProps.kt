...
public interface ServiceConnectProps {
    ...
    public interface Builder {
         ...
         *   optional intermediate DNS name. This property may be left blank if the current ECS
         *   service does not need to advertise any ports via Service Connect.
         */
    ...
    private class BuilderImpl : Builder {
        ...
        public fun build(): software.amazon.awscdk.services.ecs.ServiceConnectProps =
            cdkBuilder.build()
    }
    ...
    internal constructor(
        ...
        /**
         * The list of Services, including a port mapping, terse client alias, and optional
         * intermediate DNS name.
         *
         * This property may be left blank if the current ECS service does not need to advertise any
         * ports via Service Connect.
         *
