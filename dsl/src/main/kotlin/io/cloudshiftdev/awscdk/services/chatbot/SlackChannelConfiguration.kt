...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.chatbot.SlackChannelConfiguration,
     ...
     * @param _scope
     */
    public override fun bindAsNotificationRuleTarget(
        _scope: CloudshiftdevConstructsConstruct
    ): NotificationRuleTargetConfig =
        unwrap(this)
            .bindAsNotificationRuleTarget(_scope.let(CloudshiftdevConstructsConstruct::unwrap))
    ...
    public interface Builder {
         ...
         *
         * Default: - The AWS managed 'AdministratorAccess' policy is applied as a default if this
         * is not set.
         *
         ...
         *
         * To get the ID, open Slack, right click on the channel name in the left pane, then choose
         * Copy Link. The channel ID is the 9-character string at the end of the URL. For example,
         * ABCBBLZZZ.
         *
         ...
         *
         * To get the workspace ID, you must perform the initial authorization flow with Slack in
         * the AWS Chatbot console. Then you can copy and paste the workspace ID from the console.
         * For more details, see steps 1-4 in Setting Up AWS Chatbot with Slack in the AWS Chatbot
         * User Guide.
         *
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.chatbot.SlackChannelConfiguration.Builder.create(
                scope,
                id
            )
    ...
    public companion object {
        public fun fromSlackChannelConfigurationArn(
            ...
            software.amazon.awscdk.services.chatbot.SlackChannelConfiguration
                ...
                .let(ISlackChannelConfiguration::wrap)
        ...
        public fun metricAll(metricName: String, props: MetricOptions): Metric =
            software.amazon.awscdk.services.chatbot.SlackChannelConfiguration.metricAll(
                    metricName,
        ...
        internal fun unwrap(
            wrapped: SlackChannelConfiguration
