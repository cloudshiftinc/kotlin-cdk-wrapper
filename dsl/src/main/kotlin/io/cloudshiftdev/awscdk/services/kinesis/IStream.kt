...
public interface IStream : IResource {
  ...
  private class Wrapper internal constructor(
    ...
    public override fun metricGetRecords(): Metric =
        unwrap(this).metricGetRecords().let(Metric::wrap)

    public override fun metricGetRecords(arg0: MetricOptions): Metric =
        unwrap(this).metricGetRecords(arg0.let(MetricOptions::unwrap)).let(Metric::wrap)

    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("64006eee3de241673b33ca50fcbe2a190cf733d041b096b91eacf214c4da625f")
    public override fun metricGetRecords(arg0: MetricOptions.Builder.() -> Unit): Metric =
    ...
    public override fun metricGetRecordsBytes(arg0: MetricOptions): Metric =
        unwrap(this).metricGetRecordsBytes(arg0.let(MetricOptions::unwrap)).let(Metric::wrap)

    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("0c201e1e1b082f7da088c00768805ea23f2c6564ac8cb80875b5de7c78514134")
    public override fun metricGetRecordsBytes(arg0: MetricOptions.Builder.() -> Unit): Metric =
    ...
    public override fun metricGetRecordsIteratorAgeMilliseconds(arg0: MetricOptions): Metric =
        unwrap(this).metricGetRecordsIteratorAgeMilliseconds(arg0.let(MetricOptions::unwrap)).let(Metric::wrap)

    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("02a5a0e08027fc281e8f0fe5ce577ec1d11588dc8b2031bd977ea08809fa6a95")
    public override
        fun metricGetRecordsIteratorAgeMilliseconds(arg0: MetricOptions.Builder.() -> Unit): Metric
        = metricGetRecordsIteratorAgeMilliseconds(MetricOptions(arg0))

    public override fun metricGetRecordsLatency(): Metric =
        unwrap(this).metricGetRecordsLatency().let(Metric::wrap)

    public override fun metricGetRecordsLatency(arg0: MetricOptions): Metric =
        unwrap(this).metricGetRecordsLatency(arg0.let(MetricOptions::unwrap)).let(Metric::wrap)

    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("a8ac5360653b93c88061d7fa148543d53b984abbf534bfbed8793178a04b3a57")
    public override fun metricGetRecordsLatency(arg0: MetricOptions.Builder.() -> Unit): Metric =
    ...
    public override fun metricGetRecordsSuccess(arg0: MetricOptions): Metric =
        unwrap(this).metricGetRecordsSuccess(arg0.let(MetricOptions::unwrap)).let(Metric::wrap)

    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("bd242d326cb89e4b531dc3965afb07887520c4c52eac039511e13a6b7bcb6850")
    public override fun metricGetRecordsSuccess(arg0: MetricOptions.Builder.() -> Unit): Metric =
    ...
    public override fun metricIncomingBytes(arg0: MetricOptions): Metric =
        unwrap(this).metricIncomingBytes(arg0.let(MetricOptions::unwrap)).let(Metric::wrap)

    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("289b17285610a67712940bcd7a3287676eb71631ba3f6c55430acb662300effc")
    public override fun metricIncomingBytes(arg0: MetricOptions.Builder.() -> Unit): Metric =
    ...
    public override fun metricIncomingRecords(arg0: MetricOptions): Metric =
        unwrap(this).metricIncomingRecords(arg0.let(MetricOptions::unwrap)).let(Metric::wrap)

    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("f4ba11c4c2e6ab05ada7dda41d9029150657f08075945ee195e353186840f177")
    public override fun metricIncomingRecords(arg0: MetricOptions.Builder.() -> Unit): Metric =
    ...
    public override fun metricPutRecordBytes(arg0: MetricOptions): Metric =
        unwrap(this).metricPutRecordBytes(arg0.let(MetricOptions::unwrap)).let(Metric::wrap)

    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("45d73df91071dfeb1fe24efe18340f4065b35bb552e776e1c007499a866431d1")
    public override fun metricPutRecordBytes(arg0: MetricOptions.Builder.() -> Unit): Metric =
    ...
    public override fun metricPutRecordLatency(arg0: MetricOptions): Metric =
        unwrap(this).metricPutRecordLatency(arg0.let(MetricOptions::unwrap)).let(Metric::wrap)

    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("2f1678f42d50100f83e5e0bd3bf61e97ae182b4045ddfdd91275c0dcc02cd021")
    public override fun metricPutRecordLatency(arg0: MetricOptions.Builder.() -> Unit): Metric =
    ...
    public override fun metricPutRecordSuccess(arg0: MetricOptions): Metric =
        unwrap(this).metricPutRecordSuccess(arg0.let(MetricOptions::unwrap)).let(Metric::wrap)

    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("6322bfd273c74c0431a8308d802e78231b2a8662c360b7b24a3750c1f8bdd289")
    public override fun metricPutRecordSuccess(arg0: MetricOptions.Builder.() -> Unit): Metric =
    ...
    public override fun metricPutRecordsBytes(arg0: MetricOptions): Metric =
        unwrap(this).metricPutRecordsBytes(arg0.let(MetricOptions::unwrap)).let(Metric::wrap)

    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("7ea61d93cb0050691a3117d2e0ad7a86b09e141b97d29642f5a2c43cddf678d0")
    public override fun metricPutRecordsBytes(arg0: MetricOptions.Builder.() -> Unit): Metric =
    ...
    public override fun metricPutRecordsFailedRecords(arg0: MetricOptions): Metric =
        unwrap(this).metricPutRecordsFailedRecords(arg0.let(MetricOptions::unwrap)).let(Metric::wrap)

    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("def3a22c4d69d1357a84df640d18e5e4c5f4d03285532f1be64c4836996f8b89")
    public override fun metricPutRecordsFailedRecords(arg0: MetricOptions.Builder.() -> Unit):
        Metric = metricPutRecordsFailedRecords(MetricOptions(arg0))

    public override fun metricPutRecordsLatency(): Metric =
        unwrap(this).metricPutRecordsLatency().let(Metric::wrap)

    public override fun metricPutRecordsLatency(arg0: MetricOptions): Metric =
        unwrap(this).metricPutRecordsLatency(arg0.let(MetricOptions::unwrap)).let(Metric::wrap)

    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("f4eae1c861d69a864a5096232da76e7ea92c86174f543a8fb31f7c6368187e00")
    public override fun metricPutRecordsLatency(arg0: MetricOptions.Builder.() -> Unit): Metric =
    ...
    public override fun metricPutRecordsSuccess(arg0: MetricOptions): Metric =
        unwrap(this).metricPutRecordsSuccess(arg0.let(MetricOptions::unwrap)).let(Metric::wrap)

    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("8b869ce9256caf3107582795124c248443c2c8db0ee69b8a70f6e4cbf03dae2c")
    public override fun metricPutRecordsSuccess(arg0: MetricOptions.Builder.() -> Unit): Metric =
    ...
    public override fun metricPutRecordsSuccessfulRecords(arg0: MetricOptions): Metric =
        unwrap(this).metricPutRecordsSuccessfulRecords(arg0.let(MetricOptions::unwrap)).let(Metric::wrap)

    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("fee6ceadc6edb0b112f728a1a8d40f41eec4dfe94b2ce4ccd15112e0561a232f")
    public override fun metricPutRecordsSuccessfulRecords(arg0: MetricOptions.Builder.() -> Unit):
        Metric = metricPutRecordsSuccessfulRecords(MetricOptions(arg0))

    public override fun metricPutRecordsThrottledRecords(): Metric =
        unwrap(this).metricPutRecordsThrottledRecords().let(Metric::wrap)

    public override fun metricPutRecordsThrottledRecords(arg0: MetricOptions): Metric =
        unwrap(this).metricPutRecordsThrottledRecords(arg0.let(MetricOptions::unwrap)).let(Metric::wrap)

    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("826d8c97f079a6271aaf12665dbc757fd124a3d5cb429c194f523794a597f941")
    public override fun metricPutRecordsThrottledRecords(arg0: MetricOptions.Builder.() -> Unit):
        Metric = metricPutRecordsThrottledRecords(MetricOptions(arg0))

    public override fun metricPutRecordsTotalRecords(): Metric =
        unwrap(this).metricPutRecordsTotalRecords().let(Metric::wrap)

    public override fun metricPutRecordsTotalRecords(arg0: MetricOptions): Metric =
        unwrap(this).metricPutRecordsTotalRecords(arg0.let(MetricOptions::unwrap)).let(Metric::wrap)

    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("9d694e2791776aebacae738c16dc15d91dc85abd391681f27833bfd15e1499e3")
    public override fun metricPutRecordsTotalRecords(arg0: MetricOptions.Builder.() -> Unit): Metric
    ...
    public override fun metricReadProvisionedThroughputExceeded(arg0: MetricOptions): Metric =
        unwrap(this).metricReadProvisionedThroughputExceeded(arg0.let(MetricOptions::unwrap)).let(Metric::wrap)

    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("985d8e4aa7daaea864279775c7e34dadc3af403718e0a2123e05cbe31fc03a86")
    public override
        fun metricReadProvisionedThroughputExceeded(arg0: MetricOptions.Builder.() -> Unit): Metric
        = metricReadProvisionedThroughputExceeded(MetricOptions(arg0))
    ...
    public override fun metricWriteProvisionedThroughputExceeded(arg0: MetricOptions): Metric =
        unwrap(this).metricWriteProvisionedThroughputExceeded(arg0.let(MetricOptions::unwrap)).let(Metric::wrap)

    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("2ba305b95279408f1d6a145e80f8f92a54467fbbabdad48078127bb57e32bb25")
    public override
        fun metricWriteProvisionedThroughputExceeded(arg0: MetricOptions.Builder.() -> Unit): Metric
        = metricWriteProvisionedThroughputExceeded(MetricOptions(arg0))
