...
public interface IStream : IResource {
     ...
     * (Role/Group/User).
     *
     * If an encryption key is used, permission to ues the key to decrypt the contents of the stream
     ...
     * (Role/Group/User).
     *
     * If an encryption key is used, permission to ues the key to encrypt the contents of the stream
     * will also be granted.
     *
     * @param grantee
     */
     ...
     *
     * Minimum, Maximum, and Average statistics represent the records in a single GetRecords
     ...
     * period.
     *
     * Minimum, Maximum, and Average statistics represent the bytes in a single GetRecords operation
     ...
     * call was written to the stream. The Minimum and Maximum statistics can be used to track the
     * progress of Kinesis consumer applications. A value of zero indicates that the records being
     * read are completely caught up with the stream.
     *
    ...
    public fun metricGetRecordsIteratorAgeMilliseconds(
     ...
     * Average statistics represent the bytes in a single put operation for the stream in the
     ...
     *
     * This metric includes record counts from PutRecord and PutRecords operations. Minimum,
     * Maximum, and Average statistics represent the records in a single put operation for the
    ...
    public fun metricReadProvisionedThroughputExceeded(
        props: MetricOptions.Builder.() -> Unit
    ): Metric
    ...
    public fun metricWriteProvisionedThroughputExceeded(
        props: MetricOptions.Builder.() -> Unit
    ): Metric
    ...
    internal constructor(
         ...
         * (Role/Group/User).
         *
         * If an encryption key is used, permission to ues the key to decrypt the contents of the
         * stream will also be granted.
         *
         * @param grantee
         */
         ...
         * (Role/Group/User).
         *
         * If an encryption key is used, permission to ues the key to encrypt the contents of the
         * stream will also be granted.
         *
         * @param grantee
         */
         ...
         * period.
         *
         * Minimum, Maximum, and Average statistics represent the bytes in a single GetRecords
         * operation for the stream in the specified time period.
         *
         * The metric defaults to average over 5 minutes, it can be changed by passing `statistic`
         * and `period` properties.
        ...
        /**
         * The age of the last record in all GetRecords calls made against a Kinesis stream,
         * measured over the specified time period.
         *
         * Age is the difference between the current time and when the last record of the GetRecords
         * call was written to the stream. The Minimum and Maximum statistics can be used to track
         * the progress of Kinesis consumer applications. A value of zero indicates that the records
         * being read are completely caught up with the stream.
         *
        ...
        override fun metricGetRecordsIteratorAgeMilliseconds(props: MetricOptions): Metric =
            unwrap(this)
                .metricGetRecordsIteratorAgeMilliseconds(props.let(MetricOptions::unwrap))
                .let(Metric::wrap)
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("02a5a0e08027fc281e8f0fe5ce577ec1d11588dc8b2031bd977ea08809fa6a95")
        override fun metricGetRecordsIteratorAgeMilliseconds(
            props: MetricOptions.Builder.() -> Unit
        ...
        /**
         * The number of successful GetRecords operations per stream, measured over the specified
         * time period.
         *
         * The metric defaults to average over 5 minutes, it can be changed by passing `statistic`
         * and `period` properties.
        ...
        /**
         * The number of bytes successfully put to the Kinesis stream over the specified time
         * period.
         *
         * This metric includes bytes from PutRecord and PutRecords operations. Minimum, Maximum,
         * and Average statistics represent the bytes in a single put operation for the stream in
         * the specified time period.
         *
         * The metric defaults to average over 5 minutes, it can be changed by passing `statistic`
         * and `period` properties.
        ...
        /**
         * The number of records successfully put to the Kinesis stream over the specified time
         * period.
         *
         * This metric includes record counts from PutRecord and PutRecords operations. Minimum,
         * Maximum, and Average statistics represent the records in a single put operation for the
        ...
        /**
         * The number of successful PutRecord operations per Kinesis stream, measured over the
         * specified time period.
         *
         * Average reflects the percentage of successful writes to a stream.
         *
        ...
        /**
         * The number of records rejected due to internal failures in a PutRecords operation per
         * Kinesis data stream, measured over the specified time period.
         *
         * Occasional internal failures are to be expected and should be retried.
         *
         * The metric defaults to average over 5 minutes, it can be changed by passing `statistic`
        ...
        override fun metricPutRecordsFailedRecords(props: MetricOptions): Metric =
            unwrap(this)
                .metricPutRecordsFailedRecords(props.let(MetricOptions::unwrap))
                .let(Metric::wrap)
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("def3a22c4d69d1357a84df640d18e5e4c5f4d03285532f1be64c4836996f8b89")
        override fun metricPutRecordsFailedRecords(
            props: MetricOptions.Builder.() -> Unit
        ): Metric = metricPutRecordsFailedRecords(MetricOptions(props))
        ...
        /**
         * The number of PutRecords operations where at least one record succeeded, per Kinesis
         * stream, measured over the specified time period.
         *
         * The metric defaults to average over 5 minutes, it can be changed by passing `statistic`
         * and `period` properties.
        ...
        /**
         * The number of successful records in a PutRecords operation per Kinesis data stream,
         * measured over the specified time period.
         *
         * The metric defaults to average over 5 minutes, it can be changed by passing `statistic`
         * and `period` properties.
        ...
        override fun metricPutRecordsSuccessfulRecords(props: MetricOptions): Metric =
            unwrap(this)
                .metricPutRecordsSuccessfulRecords(props.let(MetricOptions::unwrap))
                .let(Metric::wrap)
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("fee6ceadc6edb0b112f728a1a8d40f41eec4dfe94b2ce4ccd15112e0561a232f")
        override fun metricPutRecordsSuccessfulRecords(
            props: MetricOptions.Builder.() -> Unit
        ): Metric = metricPutRecordsSuccessfulRecords(MetricOptions(props))

        /**
         * The number of records rejected due to throttling in a PutRecords operation per Kinesis
         * data stream, measured over the specified time period.
         *
         * The metric defaults to average over 5 minutes, it can be changed by passing `statistic`
         * and `period` properties.
        ...
        override fun metricPutRecordsThrottledRecords(props: MetricOptions): Metric =
            unwrap(this)
                .metricPutRecordsThrottledRecords(props.let(MetricOptions::unwrap))
                .let(Metric::wrap)
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("826d8c97f079a6271aaf12665dbc757fd124a3d5cb429c194f523794a597f941")
        override fun metricPutRecordsThrottledRecords(
            props: MetricOptions.Builder.() -> Unit
        ): Metric = metricPutRecordsThrottledRecords(MetricOptions(props))

        /**
         * The total number of records sent in a PutRecords operation per Kinesis data stream,
         * measured over the specified time period.
         *
         * The metric defaults to average over 5 minutes, it can be changed by passing `statistic`
         * and `period` properties.
        ...
        override fun metricPutRecordsTotalRecords(props: MetricOptions): Metric =
            unwrap(this)
                .metricPutRecordsTotalRecords(props.let(MetricOptions::unwrap))
                .let(Metric::wrap)
         ...
         * The most commonly used statistic for this metric is Average.
         *
         * When the Minimum statistic has a value of 1, all records were throttled for the stream
         * during the specified time period.
         *
         * When the Maximum statistic has a value of 0 (zero), no records were throttled for the
         * stream during the specified time period.
         *
         * The metric defaults to average over 5 minutes, it can be changed by passing `statistic`
         * and `period` properties
        ...
        override fun metricReadProvisionedThroughputExceeded(props: MetricOptions): Metric =
            unwrap(this)
                .metricReadProvisionedThroughputExceeded(props.let(MetricOptions::unwrap))
                .let(Metric::wrap)
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("985d8e4aa7daaea864279775c7e34dadc3af403718e0a2123e05cbe31fc03a86")
        override fun metricReadProvisionedThroughputExceeded(
            props: MetricOptions.Builder.() -> Unit
         ...
         * This metric includes throttling from PutRecord and PutRecords operations.
         *
         * When the Minimum statistic has a non-zero value, records were being throttled for the
         * stream during the specified time period.
         *
         * When the Maximum statistic has a value of 0 (zero), no records were being throttled for
        ...
        override fun metricWriteProvisionedThroughputExceeded(props: MetricOptions): Metric =
            unwrap(this)
                .metricWriteProvisionedThroughputExceeded(props.let(MetricOptions::unwrap))
                .let(Metric::wrap)
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("2ba305b95279408f1d6a145e80f8f92a54467fbbabdad48078127bb57e32bb25")
        override fun metricWriteProvisionedThroughputExceeded(
            props: MetricOptions.Builder.() -> Unit
