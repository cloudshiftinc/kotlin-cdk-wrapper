...
public interface IGraphqlApi : IResource {
  ...
  private class Wrapper internal constructor(
    ...
    public override fun addDynamoDbDataSource(arg0: String, arg1: ITable): DynamoDbDataSource =
    ...
    @Deprecated(message = "deprecated in CDK")
    public override fun addElasticsearchDataSource(arg0: String, arg1: ElasticsearchIDomain):
    ...
    public override fun addEventBridgeDataSource(arg0: String, arg1: IEventBus):
    ...
    public override fun addHttpDataSource(arg0: String, arg1: String): HttpDataSource =
    ...
    public override fun addLambdaDataSource(arg0: String, arg1: IFunction): LambdaDataSource =
    ...
    public override fun addNoneDataSource(arg0: String): NoneDataSource =
        unwrap(this).addNoneDataSource(arg0).let(NoneDataSource::wrap)

    public override fun addNoneDataSource(arg0: String, arg1: DataSourceOptions): NoneDataSource =
        unwrap(this).addNoneDataSource(arg0,
        arg1.let(DataSourceOptions::unwrap)).let(NoneDataSource::wrap)

    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("f6ad3c2d0d3a1e70a3c0a4d1b13a764aaf821c23e6022c32e77eafd2e3511485")
    public override fun addNoneDataSource(arg0: String, arg1: DataSourceOptions.Builder.() -> Unit):
        NoneDataSource = addNoneDataSource(arg0, DataSourceOptions(arg1))

    public override fun addOpenSearchDataSource(arg0: String, arg1: OpensearchserviceIDomain):
    ...
    public override fun addSchemaDependency(arg0: CfnResource): Boolean =
    ...
    public override fun createResolver(arg0: String, arg1: ExtendedResolverProps): Resolver =
        unwrap(this).createResolver(arg0,
        arg1.let(ExtendedResolverProps::unwrap)).let(Resolver::wrap)

    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("dfac965a6b25365e261bc8f10e37f75dee20d44ce736e5d6bb3be729ca63320e")
    public override fun createResolver(arg0: String,
        arg1: ExtendedResolverProps.Builder.() -> Unit): Resolver = createResolver(arg0,
        ExtendedResolverProps(arg1))
    ...
    public override fun grantMutation(arg0: IGrantable, arg1: String): Grant =
        unwrap(this).grantMutation(arg0.let(IGrantable::unwrap), arg1).let(Grant::wrap)

    public override fun grantQuery(arg0: IGrantable, arg1: String): Grant =
        unwrap(this).grantQuery(arg0.let(IGrantable::unwrap), arg1).let(Grant::wrap)

    public override fun grantSubscription(arg0: IGrantable, arg1: String): Grant =
