...
public interface IGraphqlApi : IResource {
    ...
    internal constructor(
        ...
        override fun addDynamoDbDataSource(id: String, table: ITable): DynamoDbDataSource =
            unwrap(this)
                .addDynamoDbDataSource(id, table.let(ITable::unwrap))
                .let(DynamoDbDataSource::wrap)
        ...
        override fun addDynamoDbDataSource(
            ...
            unwrap(this)
                .addDynamoDbDataSource(
                    id,
                    table.let(ITable::unwrap),
                    options.let(DataSourceOptions::unwrap)
                )
                .let(DynamoDbDataSource::wrap)
        ...
        override fun addElasticsearchDataSource(
            ...
            unwrap(this)
                .addElasticsearchDataSource(id, domain.let(ElasticsearchIDomain::unwrap))
                .let(ElasticsearchDataSource::wrap)
        ...
        override fun addElasticsearchDataSource(
            ...
            addElasticsearchDataSource(id, domain, DataSourceOptions(options))
        ...
        override fun addEventBridgeDataSource(
            ...
            unwrap(this)
                .addEventBridgeDataSource(id, eventBus.let(IEventBus::unwrap))
                .let(EventBridgeDataSource::wrap)
        ...
        override fun addEventBridgeDataSource(
            ...
            addEventBridgeDataSource(id, eventBus, DataSourceOptions(options))
        ...
        override fun addHttpDataSource(
            ...
            unwrap(this)
                .addHttpDataSource(id, endpoint, options.let(HttpDataSourceOptions::unwrap))
                .let(HttpDataSource::wrap)
        ...
        override fun addLambdaDataSource(id: String, lambdaFunction: IFunction): LambdaDataSource =
            unwrap(this)
                .addLambdaDataSource(id, lambdaFunction.let(IFunction::unwrap))
                .let(LambdaDataSource::wrap)
        ...
        override fun addNoneDataSource(id: String, options: DataSourceOptions): NoneDataSource =
            unwrap(this)
                .addNoneDataSource(id, options.let(DataSourceOptions::unwrap))
                .let(NoneDataSource::wrap)
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("f6ad3c2d0d3a1e70a3c0a4d1b13a764aaf821c23e6022c32e77eafd2e3511485")
        override fun addNoneDataSource(
            id: String,
            options: DataSourceOptions.Builder.() -> Unit
        ...
        override fun addOpenSearchDataSource(
            ...
            unwrap(this)
                .addOpenSearchDataSource(id, domain.let(OpensearchserviceIDomain::unwrap))
                .let(OpenSearchDataSource::wrap)
        ...
        override fun addRdsDataSource(
            ...
            unwrap(this)
                .addRdsDataSource(
                    ...
                    secretStore.let(ISecret::unwrap)
                )
                .let(RdsDataSource::wrap)
        ...
        override fun createResolver(id: String, props: ExtendedResolverProps): Resolver =
            unwrap(this)
                .createResolver(id, props.let(ExtendedResolverProps::unwrap))
                .let(Resolver::wrap)
        ...
        override fun createResolver(
            id: String,
            props: ExtendedResolverProps.Builder.() -> Unit
        ...
        /**
         * Adds an IAM policy statement associated with this GraphQLApi to an IAM principal's
         * policy.
         *
         * @param grantee The principal.
         * @param resources The set of resources to allow (i.e.
        ...
        override fun grant(
            ...
            unwrap(this)
                .grant(grantee.let(IGrantable::unwrap), resources.let(IamResource::unwrap), actions)
                .let(Grant::wrap)
    ...
    public companion object {
        ...
        ): IGraphqlApi = Wrapper(cdkObject)

        internal fun unwrap(
            wrapped: IGraphqlApi
        ): software.amazon.awscdk.services.appsync.IGraphqlApi = (wrapped as Wrapper).cdkObject
    }
}
