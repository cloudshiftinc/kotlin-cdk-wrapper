...
public interface IpInstanceBaseProps : BaseInstanceProps {
    ...
    public interface Builder {
        ...
        /**
         * @param ipv6 If the service that you specify contains a template for an AAAA record, the
         *   IPv6 address that you want AWS Cloud Map to use for the value of the AAAA record.
         */
        public fun ipv6(ipv6: String)

        /**
         * @param port The port on the endpoint that you want AWS Cloud Map to perform health checks
         *   on. This value is also used for the port value in an SRV record if the service that you
         *   specify includes an SRV record. You can also specify a default port that is applied to
         *   all instances in the Service configuration.
         */
    ...
    internal constructor(
        ...
        /**
         * If the service that you specify contains a template for an A record, the IPv4 address
         * that you want AWS Cloud Map to use for the value of the A record.
         *
         * Default: none
         */
        ...
        /**
         * If the service that you specify contains a template for an AAAA record, the IPv6 address
         * that you want AWS Cloud Map to use for the value of the AAAA record.
         *
         * Default: none
         */
         ...
         * The port on the endpoint that you want AWS Cloud Map to perform health checks on.
         *
         * This value is also used for the port value in an SRV record if the service that you
         * specify includes an SRV record. You can also specify a default port that is applied to
         * all instances in the Service configuration.
         *
         * Default: 80
    ...
    public companion object {
        ...
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.servicediscovery.IpInstanceBaseProps
        ): IpInstanceBaseProps = Wrapper(cdkObject)

        internal fun unwrap(
            wrapped: IpInstanceBaseProps
        ): software.amazon.awscdk.services.servicediscovery.IpInstanceBaseProps =
