...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * Messages that you send to the queue remain invisible to consumers for the duration of the
         * delay period. The maximum allowed delay is 15 minutes.
         *
         * Default: - delay set on the queue. If a delay is not set on the queue, messages are sent
         ...
         *
         * Any messages sent with the same deduplication ID are accepted successfully, but aren't
         ...
         *
         * Messages that belong to the same message group are processed in a FIFO manner. Messages
         * in different message groups might be processed out of order.
         *
         * Default: - None
         *
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.stepfunctions.tasks.SqsSendMessage.Builder.create(
                scope,
                id
            )
