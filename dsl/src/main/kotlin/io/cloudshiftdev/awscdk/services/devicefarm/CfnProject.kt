...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param defaultJobTimeoutMinutes Sets the execution timeout value (in minutes) for a
         *   project.
         */
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.devicefarm.CfnProject =
            cdkBuilder.build()
    }
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnProject
        ): software.amazon.awscdk.services.devicefarm.CfnProject = wrapped.cdkObject
    }
    ...
    public interface VpcConfigProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param subnetIds A subnet is a range of IP addresses in your VPC. You can launch
             *   Amazon resources, such as EC2 instances, into a specific subnet. When you create a
             *   subnet, you specify the IPv4 CIDR block for the subnet, which is a subset of the
             *   VPC CIDR block. See
        ...
        internal constructor(
             ...
             * A subnet is a range of IP addresses in your VPC.
             *
             * You can launch Amazon resources, such as EC2 instances, into a specific subnet. When
             * you create a subnet, you specify the IPv4 CIDR block for the subnet, which is a
             * subset of the VPC CIDR block. See
             * [VPCs and subnets](https://docs.aws.amazon.com/vpc/latest/userguide/VPC_Subnets.html)
             * in the *Amazon Virtual Private Cloud user guide* .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-devicefarm-project-vpcconfig.html#cfn-devicefarm-project-vpcconfig-subnetids)
