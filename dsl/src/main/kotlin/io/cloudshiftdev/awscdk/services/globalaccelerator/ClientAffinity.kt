...
public enum class ClientAffinity(
  ...
  public companion object {
    internal fun wrap(cdkObject: software.amazon.awscdk.services.globalaccelerator.ClientAffinity):
        ClientAffinity = when (cdkObject) {
      software.amazon.awscdk.services.globalaccelerator.ClientAffinity.NONE -> ClientAffinity.NONE
      software.amazon.awscdk.services.globalaccelerator.ClientAffinity.SOURCE_IP ->
          ClientAffinity.SOURCE_IP
    }

    internal fun unwrap(wrapped: ClientAffinity):
