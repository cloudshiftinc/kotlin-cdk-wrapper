...
public interface ParallelProps {
    ...
    public interface Builder {
         ...
         *   this state. May also be the special value JsonPath.DISCARD, which will cause the
         ...
         *   also be the special value JsonPath.DISCARD, which will cause the state's input to
         *   become its output.
         */
    ...
    internal constructor(
         ...
         * [Documentation](https://docs.aws.amazon.com/step-functions/latest/dg/input-output-inputpath-params.html#input-output-resultselector)
         */
        override fun resultSelector(): Map<String, Any> =
            unwrap(this).getResultSelector() ?: emptyMap()
