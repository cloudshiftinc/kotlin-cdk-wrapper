...
public enum class ServiceNamespace(
    ...
    public companion object {
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.applicationautoscaling.ServiceNamespace
        ): ServiceNamespace =
            when (cdkObject) {
                ...
                software.amazon.awscdk.services.applicationautoscaling.ServiceNamespace
                    .ELASTIC_MAP_REDUCE -> ServiceNamespace.ELASTIC_MAP_REDUCE
                ...
                software.amazon.awscdk.services.applicationautoscaling.ServiceNamespace
                    .CUSTOM_RESOURCE -> ServiceNamespace.CUSTOM_RESOURCE
