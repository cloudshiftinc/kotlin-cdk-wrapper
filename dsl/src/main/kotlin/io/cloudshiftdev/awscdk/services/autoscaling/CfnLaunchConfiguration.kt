...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.autoscaling.CfnLaunchConfiguration,
    ...
    public interface Builder {
         ...
         *
         * @param blockDeviceMappings The block device mapping entries that define the block devices
         *   to attach to the instances at launch.
         */
         ...
         *
         * @param iamInstanceProfile The name or the Amazon Resource Name (ARN) of the instance
         ...
         * from the instance with the exception of `BlockDeviceMapping` and
         ...
         * The tenancy of the instance, either `default` or `dedicated` .
         *
         * An instance with `dedicated` tenancy runs on isolated, single-tenant hardware and can
         * only be launched into a VPC. To launch dedicated instances into a shared tenancy VPC (a
         * VPC with the instance placement tenancy attribute set to `default` ), you must set the
         ...
         *
         * @param securityGroups A list that contains the security groups to assign to the instances
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.autoscaling.CfnLaunchConfiguration.Builder.create(
                scope,
                id
            )
         ...
         * @param classicLinkVpcSecurityGroups Available for backward compatibility.
         */
        override fun classicLinkVpcSecurityGroups(
            vararg classicLinkVpcSecurityGroups: String
        ): Unit = classicLinkVpcSecurityGroups(classicLinkVpcSecurityGroups.toList())
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnLaunchConfiguration
    ...
    public interface BlockDeviceProperty {
         ...
         * encrypted, either using the AWS managed KMS key or a customer-managed KMS key, regardless
         ...
         * the volume. For `gp2` volumes, this represents the baseline performance of the volume and
        ...
        public interface Builder {
            ...
            /**
             * @param encrypted Specifies whether the volume should be encrypted. Encrypted EBS
             *   volumes can only be attached to instances that support Amazon EBS encryption. For
            ...
            /**
             * @param iops The number of input/output (I/O) operations per second (IOPS) to
             *   provision for the volume. For `gp3` and `io1` volumes, this represents the number
             *   of IOPS that are provisioned for the volume. For `gp2` volumes, this represents the
            ...
            /**
             * @param volumeSize The volume size, in GiBs. The following are the supported volumes
        ...
        internal constructor(
             ...
             * volume.
             *
             * For `gp3` and `io1` volumes, this represents the number of IOPS that are provisioned
             * for the volume. For `gp2` volumes, this represents the baseline performance of the
    ...
    public interface BlockDeviceMappingProperty {
        ...
        public interface Builder {
            /**
             * @param deviceName The device name assigned to the volume (for example, `/dev/sdh` or
            ...
            /**
             * @param noDevice Setting this value to `true` prevents a volume that is included in
             *   the block device mapping of the AMI from being mapped to the specified device name
             *   at launch. If `NoDevice` is `true` for the root device, instances might fail the
             *   EC2 health check. In that case, Amazon EC2 Auto Scaling launches replacement
             *   instances.
             */
            ...
            /**
             * @param virtualName The name of the instance store volume (virtual device) to attach
             *   to an instance at launch. The name must be in the form ephemeral *X* where *X* is a
             *   number starting from zero (0), for example, `ephemeral0` .
             */
    ...
    public interface MetadataOptionsProperty {
        ...
        public interface Builder {
            /**
             * @param httpEndpoint This parameter enables or disables the HTTP metadata endpoint on
             *   your instances. If the parameter is not specified, the default state is `enabled` .
             *
             * If you specify a value of `disabled` , you will not be able to access your instance
             * metadata.
             */
            ...
            /**
             * @param httpTokens The state of token usage for your instance metadata requests. If
             *   the parameter is not specified in the request, the default state is `optional` .
             *
