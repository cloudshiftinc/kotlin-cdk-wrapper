...
public interface InstanceEngineFeatures {
    ...
    public interface Builder {
        /**
         * @param s3Export Feature name for the DB instance that the IAM role to export to S3 bucket
         *   is to be associated with.
         */
        public fun s3Export(s3Export: String)

        /**
         * @param s3Import Feature name for the DB instance that the IAM role to access the S3
         *   bucket for import is to be associated with.
         */
    ...
    internal constructor(
        ...
        /**
         * Feature name for the DB instance that the IAM role to access the S3 bucket for import is
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: InstanceEngineFeatures
