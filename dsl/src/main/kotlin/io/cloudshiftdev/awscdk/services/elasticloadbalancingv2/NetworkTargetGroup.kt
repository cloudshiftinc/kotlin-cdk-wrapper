...
internal constructor(
    ...
    public interface Builder {
        /**
         * Indicates whether the load balancer terminates connections at the end of the
         * deregistration timeout.
         *
         * Default: false
         *
         * @param connectionTermination Indicates whether the load balancer terminates connections
         *   at the end of the deregistration timeout.
         */
         ...
         *
         * Default: false if the target group type is IP address and the target group protocol is
         * TCP or TLS. Otherwise, true.
         *
