...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param parentIds The unique identifier (ID) of the root or organizational unit (OU) that
         *   you want to create the new account in.
         */
         ...
         * member account.
         *
         * This role trusts the management account, allowing users in the management account to
         * assume the role, as permitted by the management account administrator. The role has
         ...
         *
         * @param roleName The name of an IAM role that AWS Organizations automatically
         *   preconfigures in the new member account.
         */
