...
public open class CfnStreamProcessor internal constructor(
  ...
  private class BuilderImpl(
    ...
    public override fun boundingBoxRegionsOfInterest(boundingBoxRegionsOfInterest: IResolvable) {
      cdkBuilder.boundingBoxRegionsOfInterest(boundingBoxRegionsOfInterest.let(IResolvable::unwrap))
    }

    public override fun boundingBoxRegionsOfInterest(boundingBoxRegionsOfInterest: List<Any>) {
      cdkBuilder.boundingBoxRegionsOfInterest(boundingBoxRegionsOfInterest)
    }

    public override fun connectedHomeSettings(connectedHomeSettings: IResolvable) {
      cdkBuilder.connectedHomeSettings(connectedHomeSettings.let(IResolvable::unwrap))
    }

    public override
        fun connectedHomeSettings(connectedHomeSettings: ConnectedHomeSettingsProperty) {
    ...
    public override fun dataSharingPreference(dataSharingPreference: IResolvable) {
      cdkBuilder.dataSharingPreference(dataSharingPreference.let(IResolvable::unwrap))
    }

    public override
        fun dataSharingPreference(dataSharingPreference: DataSharingPreferenceProperty) {
    ...
    public override fun faceSearchSettings(faceSearchSettings: IResolvable) {
      cdkBuilder.faceSearchSettings(faceSearchSettings.let(IResolvable::unwrap))
    }

    public override fun faceSearchSettings(faceSearchSettings: FaceSearchSettingsProperty) {
    ...
    public override fun kinesisDataStream(kinesisDataStream: IResolvable) {
      cdkBuilder.kinesisDataStream(kinesisDataStream.let(IResolvable::unwrap))
    }

    public override fun kinesisDataStream(kinesisDataStream: KinesisDataStreamProperty) {
    ...
    @JvmName("1327b8dfe08728ad8a4a963d4d8113fd2de16847b083f60dba7fd09e3c38a56b")
    public override
        fun kinesisDataStream(kinesisDataStream: KinesisDataStreamProperty.Builder.() -> Unit): Unit
        = kinesisDataStream(KinesisDataStreamProperty(kinesisDataStream))

    public override fun kinesisVideoStream(kinesisVideoStream: IResolvable) {
      cdkBuilder.kinesisVideoStream(kinesisVideoStream.let(IResolvable::unwrap))
    }

    public override fun kinesisVideoStream(kinesisVideoStream: KinesisVideoStreamProperty) {
    ...
    public override fun notificationChannel(notificationChannel: IResolvable) {
      cdkBuilder.notificationChannel(notificationChannel.let(IResolvable::unwrap))
    }

    public override fun notificationChannel(notificationChannel: NotificationChannelProperty) {
    ...
    public override fun polygonRegionsOfInterest(polygonRegionsOfInterest: Any) {
  ...
  public interface DataSharingPreferenceProperty {
    ...
    private class BuilderImpl : Builder {
      ...
      public override fun optIn(optIn: Boolean) {
        cdkBuilder.optIn(optIn)
      }

      public override fun optIn(optIn: IResolvable) {
    ...
    private class Wrapper internal constructor(
      ...
      public override fun optIn(): Any = unwrap(this).getOptIn()
    }
  ...
  public interface BoundingBoxProperty {
    ...
    private class BuilderImpl : Builder {
      ...
      public override fun left(left: Number) {
        cdkBuilder.left(left)
      }

      public override fun top(top: Number) {
        cdkBuilder.top(top)
      }
    ...
    private class Wrapper internal constructor(
      ...
      public override fun left(): Number = unwrap(this).getLeft()

      public override fun top(): Number = unwrap(this).getTop()
  ...
  public interface ConnectedHomeSettingsProperty {
    ...
    private class BuilderImpl : Builder {
      ...
      public override fun minConfidence(minConfidence: Number) {
    ...
    private class Wrapper internal constructor(
      ...
      public override fun minConfidence(): Number? = unwrap(this).getMinConfidence()
    }
  ...
  public interface FaceSearchSettingsProperty {
    ...
    private class BuilderImpl : Builder {
      ...
      public override fun faceMatchThreshold(faceMatchThreshold: Number) {
    ...
    private class Wrapper internal constructor(
      ...
      public override fun faceMatchThreshold(): Number? = unwrap(this).getFaceMatchThreshold()
    }
  ...
  public interface PointProperty {
    ...
    private class BuilderImpl : Builder {
      ...
      public override fun x(x: Number) {
        cdkBuilder.x(x)
      }

      public override fun y(y: Number) {
        cdkBuilder.y(y)
      }
    ...
    private class Wrapper internal constructor(
      ...
      public override fun x(): Number = unwrap(this).getX()

      public override fun y(): Number = unwrap(this).getY()
    }
