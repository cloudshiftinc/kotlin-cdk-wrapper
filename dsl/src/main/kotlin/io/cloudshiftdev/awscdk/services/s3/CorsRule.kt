...
public interface CorsRule {
    ...
    public interface Builder {
        ...
        /**
         * @param maxAge The time in seconds that your browser is to cache the preflight response
    ...
    public companion object {
        ...
        internal fun unwrap(wrapped: CorsRule): software.amazon.awscdk.services.s3.CorsRule =
