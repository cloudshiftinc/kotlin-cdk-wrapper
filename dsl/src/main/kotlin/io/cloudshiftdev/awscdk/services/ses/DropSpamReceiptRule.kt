...
internal constructor(
    ...
    public interface Builder {
         ...
         * Default: - No actions.
         *
         * @param actions An ordered list of actions to perform on messages that match at least one
         ...
         *
         * @param tlsPolicy Whether Amazon SES should require that incoming email is delivered over
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.ses.DropSpamReceiptRule =
            cdkBuilder.build()
    }
