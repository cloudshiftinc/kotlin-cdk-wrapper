...
public interface ILifecycleHookTarget {
    ...
    public fun bind(
        scope: Construct,
        options: BindHookTargetOptions.Builder.() -> Unit
    ...
    internal constructor(
         ...
         *
         * @param scope
         * @param options [disable-awslint:ref-via-interface] The lifecycle hook to attach to and a
         *   role to use.
         */
        override fun bind(
            scope: Construct,
            ...
            unwrap(this)
                .bind(scope.let(Construct::unwrap), options.let(BindHookTargetOptions::unwrap))
                .let(LifecycleHookTargetConfig::wrap)
