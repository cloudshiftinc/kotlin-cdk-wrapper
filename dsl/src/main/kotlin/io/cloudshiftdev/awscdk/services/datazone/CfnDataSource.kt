...
internal constructor(
    ...
    public open fun configuration(
        `value`: DataSourceConfigurationInputProperty.Builder.() -> Unit
    ...
    public open fun recommendation(
        `value`: RecommendationConfigurationProperty.Builder.() -> Unit
    ...
    public interface Builder {
         ...
         *
         * @param assetFormsInput The metadata forms attached to the assets that the data source
         *   works with.
         */
        ...
        public fun configuration(
            configuration: DataSourceConfigurationInputProperty.Builder.() -> Unit
        )
         ...
         *
         * @param projectIdentifier The identifier of the Amazon DataZone project in which you want
        ...
        public fun recommendation(
            recommendation: RecommendationConfigurationProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
        ...
        override fun configuration(configuration: DataSourceConfigurationInputProperty) {
            cdkBuilder.configuration(
                configuration.let(DataSourceConfigurationInputProperty::unwrap)
            )
        }
        ...
        override fun recommendation(recommendation: RecommendationConfigurationProperty) {
            cdkBuilder.recommendation(
                recommendation.let(RecommendationConfigurationProperty::unwrap)
            )
        }
        ...
        public fun build(): software.amazon.awscdk.services.datazone.CfnDataSource =
            cdkBuilder.build()
    }
    ...
    public interface RedshiftServerlessStorageProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RedshiftServerlessStorageProperty
            ): software.amazon.awscdk.services.datazone.CfnDataSource.RedshiftServerlessStorageProperty =
    ...
    public interface RecommendationConfigurationProperty {
         ...
         */
        public fun enableBusinessNameGeneration(): Any? =
        ...
        public interface Builder {
            /**
             * @param enableBusinessNameGeneration Specifies whether automatic business name
             *   generation is to be enabled or not as part of the recommendation configuration.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            override fun enableBusinessNameGeneration(enableBusinessNameGeneration: IResolvable) {
                cdkBuilder.enableBusinessNameGeneration(
                    enableBusinessNameGeneration.let(IResolvable::unwrap)
                )
            }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RecommendationConfigurationProperty
            ): software.amazon.awscdk.services.datazone.CfnDataSource.RecommendationConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface RelationalFilterConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param databaseName The database name specified in the relational filter
            ...
            /**
             * @param schemaName The schema name specified in the relational filter configuration
             *   for the data source.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RelationalFilterConfigurationProperty
            ): software.amazon.awscdk.services.datazone.CfnDataSource.RelationalFilterConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface RedshiftStorageProperty {
        ...
        public interface Builder {
            ...
            public fun redshiftClusterSource(
                redshiftClusterSource: RedshiftClusterStorageProperty.Builder.() -> Unit
            )

            /**
             * @param redshiftServerlessSource The details of the Amazon Redshift Serverless
             *   workgroup source.
             */
            ...
            public fun redshiftServerlessSource(
                redshiftServerlessSource: RedshiftServerlessStorageProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            /** @param redshiftClusterSource The details of the Amazon Redshift cluster source. */
            override fun redshiftClusterSource(
                redshiftClusterSource: RedshiftClusterStorageProperty
            ) {
                cdkBuilder.redshiftClusterSource(
                    redshiftClusterSource.let(RedshiftClusterStorageProperty::unwrap)
                )
            }
            ...
            override fun redshiftServerlessSource(redshiftServerlessSource: IResolvable) {
                cdkBuilder.redshiftServerlessSource(
                    redshiftServerlessSource.let(IResolvable::unwrap)
                )
            }
             ...
             *   workgroup source.
             */
            override fun redshiftServerlessSource(
                redshiftServerlessSource: RedshiftServerlessStorageProperty
            ) {
                cdkBuilder.redshiftServerlessSource(
                    redshiftServerlessSource.let(RedshiftServerlessStorageProperty::unwrap)
                )
            }
            ...
            override fun redshiftServerlessSource(
                ...
                redshiftServerlessSource(
                    RedshiftServerlessStorageProperty(redshiftServerlessSource)
                )
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-datazone-datasource-redshiftstorage.html#cfn-datazone-datasource-redshiftstorage-redshiftserverlesssource)
             */
            override fun redshiftServerlessSource(): Any? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RedshiftStorageProperty
            ): software.amazon.awscdk.services.datazone.CfnDataSource.RedshiftStorageProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DataSourceConfigurationInputProperty {
        ...
        public interface Builder {
            ...
            public fun glueRunConfiguration(
                glueRunConfiguration: GlueRunConfigurationInputProperty.Builder.() -> Unit
            )
            ...
            public fun redshiftRunConfiguration(
                redshiftRunConfiguration: RedshiftRunConfigurationInputProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            /** @param glueRunConfiguration The configuration of the AWS Glue data source. */
            override fun glueRunConfiguration(
                glueRunConfiguration: GlueRunConfigurationInputProperty
            ) {
                cdkBuilder.glueRunConfiguration(
                    glueRunConfiguration.let(GlueRunConfigurationInputProperty::unwrap)
                )
            }
            ...
            override fun redshiftRunConfiguration(redshiftRunConfiguration: IResolvable) {
                cdkBuilder.redshiftRunConfiguration(
                    redshiftRunConfiguration.let(IResolvable::unwrap)
                )
            }
             ...
             * @param redshiftRunConfiguration The configuration of the Amazon Redshift data source.
             */
            override fun redshiftRunConfiguration(
                redshiftRunConfiguration: RedshiftRunConfigurationInputProperty
            ) {
                cdkBuilder.redshiftRunConfiguration(
                    redshiftRunConfiguration.let(RedshiftRunConfigurationInputProperty::unwrap)
                )
            }
            ...
            override fun redshiftRunConfiguration(
                ...
                redshiftRunConfiguration(
                    RedshiftRunConfigurationInputProperty(redshiftRunConfiguration)
                )
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-datazone-datasource-datasourceconfigurationinput.html#cfn-datazone-datasource-datasourceconfigurationinput-redshiftrunconfiguration)
             */
            override fun redshiftRunConfiguration(): Any? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DataSourceConfigurationInputProperty
            ): software.amazon.awscdk.services.datazone.CfnDataSource.DataSourceConfigurationInputProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface RedshiftClusterStorageProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RedshiftClusterStorageProperty
            ): software.amazon.awscdk.services.datazone.CfnDataSource.RedshiftClusterStorageProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface RedshiftCredentialConfigurationProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RedshiftCredentialConfigurationProperty
            ): software.amazon.awscdk.services.datazone.CfnDataSource.RedshiftCredentialConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface RedshiftRunConfigurationInputProperty {
        ...
        public interface Builder {
            /**
             * @param dataAccessRole The data access role included in the configuration details of
             *   the Amazon Redshift data source.
             */
            public fun dataAccessRole(dataAccessRole: String)

            /**
             * @param redshiftCredentialConfiguration The details of the credentials required to
             *   access an Amazon Redshift cluster.
             */
            ...
            public fun redshiftCredentialConfiguration(
                redshiftCredentialConfiguration:
                    RedshiftCredentialConfigurationProperty.Builder.() -> Unit
            )
            ...
            /**
             * @param relationalFilterConfigurations The relational filter configurations included
             *   in the configuration details of the AWS Glue data source.
             */
        ...
        private class BuilderImpl : Builder {
             ...
             *   access an Amazon Redshift cluster.
             */
            override fun redshiftCredentialConfiguration(
                redshiftCredentialConfiguration: IResolvable
            ) {
                cdkBuilder.redshiftCredentialConfiguration(
                    redshiftCredentialConfiguration.let(IResolvable::unwrap)
                )
            }
            ...
            override fun redshiftCredentialConfiguration(
                ...
                cdkBuilder.redshiftCredentialConfiguration(
                    redshiftCredentialConfiguration.let(
                        RedshiftCredentialConfigurationProperty::unwrap
                    )
                )
            }
            ...
            override fun redshiftCredentialConfiguration(
                ...
                redshiftCredentialConfiguration(
                    RedshiftCredentialConfigurationProperty(redshiftCredentialConfiguration)
                )
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("c96c9f1fca94be303cefa3be2240a1598e8f221de0dab9360c4273e4ae3ac81b")
            override fun redshiftStorage(
                redshiftStorage: RedshiftStorageProperty.Builder.() -> Unit
             ...
             *   in the configuration details of the AWS Glue data source.
             */
            override fun relationalFilterConfigurations(
                relationalFilterConfigurations: IResolvable
            ) {
                cdkBuilder.relationalFilterConfigurations(
                    relationalFilterConfigurations.let(IResolvable::unwrap)
                )
            }
             ...
             */
            override fun relationalFilterConfigurations(
                vararg relationalFilterConfigurations: Any
            ): Unit = relationalFilterConfigurations(relationalFilterConfigurations.toList())
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RedshiftRunConfigurationInputProperty
            ): software.amazon.awscdk.services.datazone.CfnDataSource.RedshiftRunConfigurationInputProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface GlueRunConfigurationInputProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: GlueRunConfigurationInputProperty
            ): software.amazon.awscdk.services.datazone.CfnDataSource.GlueRunConfigurationInputProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
