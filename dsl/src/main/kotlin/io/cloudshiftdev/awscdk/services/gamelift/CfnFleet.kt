...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.gamelift.CfnFleet,
    ...
    public open fun anywhereConfiguration(
        `value`: AnywhereConfigurationProperty.Builder.() -> Unit
    ...
    public open fun certificateConfiguration(`value`: CertificateConfigurationProperty) {
        unwrap(this)
            .setCertificateConfiguration(`value`.let(CertificateConfigurationProperty::unwrap))
    }

    /** Prompts Amazon GameLift to generate a TLS/SSL certificate for the fleet. */
    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("319b28c07acf889cfcadea422d5c26529c6dd665089cedfad34223ba8c99ceda")
    public open fun certificateConfiguration(
        `value`: CertificateConfigurationProperty.Builder.() -> Unit
    ...
    public open fun resourceCreationLimitPolicy(`value`: ResourceCreationLimitPolicyProperty) {
        unwrap(this)
            .setResourceCreationLimitPolicy(
                `value`.let(ResourceCreationLimitPolicyProperty::unwrap)
            )
    }
    ...
    public open fun resourceCreationLimitPolicy(
        `value`: ResourceCreationLimitPolicyProperty.Builder.() -> Unit
    ...
    public open fun runtimeConfiguration(
        `value`: RuntimeConfigurationProperty.Builder.() -> Unit
    ...
    public interface Builder {
        ...
        public fun anywhereConfiguration(
            anywhereConfiguration: AnywhereConfigurationProperty.Builder.() -> Unit
        )
         ...
         * Prompts Amazon GameLift to generate a TLS/SSL certificate for the fleet.
         *
         * Amazon GameLift uses the certificates to encrypt traffic between game clients and the
         * game servers running on Amazon GameLift. By default, the `CertificateConfiguration` is
         * `DISABLED` . You can't change this property after you create the fleet.
         *
         * AWS Certificate Manager (ACM) certificates expire after 13 months. Certificate expiration
         ...
         * smooth transition.
         *
         * ACM isn't available in all AWS regions. A fleet creation request with certificate
         * generation enabled in an unsupported Region, fails with a 4xx error. For more information
         * about the supported Regions, see
         * [Supported Regions](https://docs.aws.amazon.com/acm/latest/userguide/acm-regions.html) in
         ...
         *
         * @param certificateConfiguration Prompts Amazon GameLift to generate a TLS/SSL certificate
         *   for the fleet.
         */
        ...
        public fun certificateConfiguration(
            certificateConfiguration: CertificateConfigurationProperty.Builder.() -> Unit
        )
         ...
         * single instance. Once the fleet is active, update this value to trigger GameLift to add
         * or remove instances from the fleet.
         *
         ...
         * connect to game sessions. For Realtime Servers fleets, Amazon GameLift automatically sets
         * TCP and UDP ranges.
         *
         ...
         *
         * @param ec2InstanceType The Amazon GameLift-supported Amazon EC2 instance type to use for
         *   all fleet instances.
         */
         ...
         * processes, and other processes--can use these permissions to interact with AWS resources
         * that you own or have access to. For more information about using the role with your game
         * server builds, see
         ...
         *
         * @param instanceRoleArn A unique identifier for an IAM role with access permissions to
         *   other AWS services.
         */
         ...
         *
         * Shared credentials allow applications that are deployed with the game server executable
         * to communicate with other AWS resources. This property is used only when the game server
         * is integrated with the server SDK version 5.x. For more information about using shared
         * credentials, see
         * [Communicate with other AWS resources from your fleets](https://docs.aws.amazon.com/gamelift/latest/developerguide/gamelift-sdk-server-resources.html)
         * .
         *
         ...
         * locations. You can add any Amazon GameLift-supported AWS Region as a remote location, in
         * the form of an AWS Region code such as `us-west-2` . To create a fleet with instances in
         * the home Region only, don't use this parameter.
         *
         ...
         * (deprecated) This parameter is no longer used.
         *
         * When hosting a custom game build, specify where Amazon GameLift should store log files
         ...
         * @deprecated this property has been deprecated
         */
        @Deprecated(message = "deprecated in CDK") public fun logPaths(logPaths: List<String>)
         ...
         * @deprecated this property has been deprecated
         */
        @Deprecated(message = "deprecated in CDK") public fun logPaths(vararg logPaths: String)
         ...
         *
         * @param newGameSessionProtectionPolicy The status of termination protection for active
         *   game sessions on the fleet.
         */
        public fun newGameSessionProtectionPolicy(newGameSessionProtectionPolicy: String)

        /**
         * Used when peering your Amazon GameLift fleet with a VPC, the unique identifier for the
         ...
         * [VPC Dashboard](https://docs.aws.amazon.com/vpc/) in the AWS Management Console . Learn
         ...
         *
         * @param resourceCreationLimitPolicy A policy that limits the number of game sessions that
         *   an individual player can create on instances in this fleet within a specified span of
         *   time.
         */
        ...
        public fun resourceCreationLimitPolicy(
            resourceCreationLimitPolicy: ResourceCreationLimitPolicyProperty.Builder.() -> Unit
        )
         ...
         *
         * The `RuntimeConfiguration` parameter is required unless the fleet is being configured
         * using the older parameters `ServerLaunchPath` and `ServerLaunchParameters` , which are
         ...
         *
         * @param runtimeConfiguration Instructions for how to launch and maintain server processes
        ...
        public fun runtimeConfiguration(
            runtimeConfiguration: RuntimeConfigurationProperty.Builder.() -> Unit
        )
         ...
         *
         * You can't use the `!Ref` command to reference a script created with a CloudFormation
         * template for the fleet property `ScriptId` . Instead, use `Fn::GetAtt Script.Arn` or
         * `Fn::GetAtt Script.Id` to retrieve either of these properties as input for `ScriptId` .
         ...
         * (deprecated) This parameter is no longer used but is retained for backward compatibility.
         *
         * Instead, specify server launch parameters in the RuntimeConfiguration parameter. A
         * request must specify either a runtime configuration or values for both
         ...
         *
         * @param serverLaunchParameters This parameter is no longer used but is retained for
         ...
         * (deprecated) This parameter is no longer used.
         *
         * Instead, specify a server launch path using the RuntimeConfiguration parameter. Requests
         * that specify a server launch path and launch parameters instead of a runtime
    ...
    private class BuilderImpl(
        ...
        override fun anywhereConfiguration(anywhereConfiguration: AnywhereConfigurationProperty) {
            cdkBuilder.anywhereConfiguration(
                anywhereConfiguration.let(AnywhereConfigurationProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("a2661928c18c4a178bc7a01449bf72729fb5248293bfdd9f3f77a154dd4333b9")
        override fun anywhereConfiguration(
            anywhereConfiguration: AnywhereConfigurationProperty.Builder.() -> Unit
         ...
         *   for the fleet.
         */
        override fun certificateConfiguration(
            certificateConfiguration: CertificateConfigurationProperty
        ) {
            cdkBuilder.certificateConfiguration(
                certificateConfiguration.let(CertificateConfigurationProperty::unwrap)
            )
        }
        ...
        override fun certificateConfiguration(
            ...
            certificateConfiguration(CertificateConfigurationProperty(certificateConfiguration))
        ...
        override fun resourceCreationLimitPolicy(resourceCreationLimitPolicy: IResolvable) {
            cdkBuilder.resourceCreationLimitPolicy(
                resourceCreationLimitPolicy.let(IResolvable::unwrap)
            )
        }
         ...
         *   time.
         */
        override fun resourceCreationLimitPolicy(
            resourceCreationLimitPolicy: ResourceCreationLimitPolicyProperty
        ) {
            cdkBuilder.resourceCreationLimitPolicy(
                resourceCreationLimitPolicy.let(ResourceCreationLimitPolicyProperty::unwrap)
            )
        }
        ...
        override fun resourceCreationLimitPolicy(
            ...
            resourceCreationLimitPolicy(
                ResourceCreationLimitPolicyProperty(resourceCreationLimitPolicy)
            )
        ...
        override fun runtimeConfiguration(runtimeConfiguration: RuntimeConfigurationProperty) {
            cdkBuilder.runtimeConfiguration(
                runtimeConfiguration.let(RuntimeConfigurationProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("c0627cf5d1239128484c5e236ab999e30df9307e33f611a0bc163bf3a7b6d62d")
        override fun runtimeConfiguration(
            runtimeConfiguration: RuntimeConfigurationProperty.Builder.() -> Unit
    ...
    public interface TargetConfigurationProperty {
         ...
         *
         * The value must be relevant for whatever metric the scaling policy is using. For example,
         * in a policy using the metric PercentAvailableGameSessions, the target value should be the
         * preferred size of the fleet's buffer (the percent of capacity that should be idle and
        ...
        public interface Builder {
            /**
             * @param targetValue Desired value to use with a target-based scaling policy. The value
             *   must be relevant for whatever metric the scaling policy is using. For example, in a
        ...
        internal constructor(
             ...
             * Desired value to use with a target-based scaling policy.
             *
             * The value must be relevant for whatever metric the scaling policy is using. For
             * example, in a policy using the metric PercentAvailableGameSessions, the target value
             * should be the preferred size of the fleet's buffer (the percent of capacity that
    ...
    public interface AnywhereConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param cost The cost to run your fleet per hour. Amazon GameLift uses the provided
             *   cost of your fleet to balance usage in queues. For more information about queues,
             *   see
             *   [Setting up queues](https://docs.aws.amazon.com/gamelift/latest/developerguide/queues-intro.html)
             *   in the *Amazon GameLift Developer Guide* .
             */
        ...
        internal constructor(
             ...
             * The cost to run your fleet per hour.
             *
             * Amazon GameLift uses the provided cost of your fleet to balance usage in queues. For
             * more information about queues, see
             * [Setting up queues](https://docs.aws.amazon.com/gamelift/latest/developerguide/queues-intro.html)
             * in the *Amazon GameLift Developer Guide* .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-gamelift-fleet-anywhereconfiguration.html#cfn-gamelift-fleet-anywhereconfiguration-cost)
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AnywhereConfigurationProperty
            ): software.amazon.awscdk.services.gamelift.CfnFleet.AnywhereConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface IpPermissionProperty {
        ...
        public interface Builder {
            /**
             * @param fromPort A starting value for a range of allowed port numbers. For fleets
             *   using Linux builds, only ports `22` and `1026-60000` are valid.
             *
             * For fleets using Windows builds, only ports `1026-60000` are valid.
             */
            ...
            /**
             * @param ipRange A range of allowed IP addresses. This value must be expressed in CIDR
             *   notation. Example: " `000.000.000.000/[subnet mask]` " or optionally the shortened
            ...
            /**
             * @param toPort An ending value for a range of allowed port numbers. Port numbers are
        ...
        internal constructor(
             ...
             * A range of allowed IP addresses.
             *
             * This value must be expressed in CIDR notation. Example: " `000.000.000.000/[subnet
             * mask]` " or optionally the shortened version " `0.0.0.0/[subnet mask]` ".
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-gamelift-fleet-ippermission.html#cfn-gamelift-fleet-ippermission-iprange)
             */
    ...
    public interface ResourceCreationLimitPolicyProperty {
         ...
         */
        public fun newGameSessionsPerCreator(): Number? =
        ...
        public interface Builder {
            /**
             * @param newGameSessionsPerCreator A policy that puts limits on the number of game
             *   sessions that a player can create within a specified span of time. With this
             *   policy, you can control players' ability to consume available resources.
             *
            ...
            /**
             * @param policyPeriodInMinutes The time span used in evaluating the resource creation
             *   limit policy.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ResourceCreationLimitPolicyProperty
            ): software.amazon.awscdk.services.gamelift.CfnFleet.ResourceCreationLimitPolicyProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface LocationConfigurationProperty {
        ...
        public interface Builder {
             ...
             *   location. The location value might refer to a fleet's remote location or its home
             *   Region.
             *
             * *Related actions*
             *
            ...
            public fun locationCapacity(
                locationCapacity: LocationCapacityProperty.Builder.() -> Unit
            )
        }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: LocationConfigurationProperty
            ): software.amazon.awscdk.services.gamelift.CfnFleet.LocationConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ServerProcessProperty {
         ...
         * For custom game builds, this parameter must indicate the executable that calls the server
         * SDK operations `initSDK()` and `ProcessReady()` .
         *
        ...
        public interface Builder {
            /**
             * @param concurrentExecutions The number of server processes using this configuration
             *   that run concurrently on each instance.
             */
            public fun concurrentExecutions(concurrentExecutions: Number)

            /**
             * @param launchPath The location of a game build executable or Realtime script. Game
             ...
             *   Realtime script on launch. Length Constraints: Minimum length of 1. Maximum length
             *   of 1024.
             *
             * Pattern: [A-Za-z0-9_:.+/- =&#64;{},?'[]"]+
             */
    ...
    public interface RuntimeConfigurationProperty {
         ...
         *
         * During this time, the game session is in status `ACTIVATING` . If the game session does
         * not become active before the timeout, it is ended and the game session status is changed
         * to `TERMINATED` .
         *
        ...
        public interface Builder {
            /**
             * @param gameSessionActivationTimeoutSeconds The maximum amount of time (in seconds)
             *   allowed to launch a new game session and have it report ready to host players.
             *   During this time, the game session is in status `ACTIVATING` . If the game session
             *   does not become active before the timeout, it is ended and the game session status
             *   is changed to `TERMINATED` .
             */
            public fun gameSessionActivationTimeoutSeconds(
                gameSessionActivationTimeoutSeconds: Number
            )

            /**
             * @param maxConcurrentGameSessionActivations The number of game sessions in status
             *   `ACTIVATING` to allow on an instance. This setting limits the instance resources
             *   that can be used for new game activations at any one time.
             */
            public fun maxConcurrentGameSessionActivations(
                maxConcurrentGameSessionActivations: Number
            )

            /**
             * @param serverProcesses A collection of server process configurations that identify
             *   what server processes to run on each instance in a fleet.
             */
        ...
        private class BuilderImpl : Builder {
             ...
             *   is changed to `TERMINATED` .
             */
            override fun gameSessionActivationTimeoutSeconds(
                gameSessionActivationTimeoutSeconds: Number
            ) {
             ...
             *   that can be used for new game activations at any one time.
             */
            override fun maxConcurrentGameSessionActivations(
                maxConcurrentGameSessionActivations: Number
            ) {
        ...
        internal constructor(
             ...
             * it report ready to host players.
             *
             * During this time, the game session is in status `ACTIVATING` . If the game session
             * does not become active before the timeout, it is ended and the game session status is
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RuntimeConfigurationProperty
            ): software.amazon.awscdk.services.gamelift.CfnFleet.RuntimeConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface LocationCapacityProperty {
        ...
        public interface Builder {
            /**
             * @param desiredEc2Instances The number of Amazon EC2 instances you want to maintain in
             *   the specified fleet location. This value must fall between the minimum and maximum
             *   size limits. Changes in desired instance value can take up to 1 minute to be
             *   reflected when viewing the fleet's capacity settings.
             */
            public fun desiredEc2Instances(desiredEc2Instances: Number)

            /**
             * @param maxSize The maximum number of instances that are allowed in the specified
             *   fleet location. If this parameter is not set, the default is 1.
             */
            public fun maxSize(maxSize: Number)

            /**
             * @param minSize The minimum number of instances that are allowed in the specified
        ...
        internal constructor(
             ...
             *
             * This value must fall between the minimum and maximum size limits. Changes in desired
             * instance value can take up to 1 minute to be reflected when viewing the fleet's
             * capacity settings.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-gamelift-fleet-locationcapacity.html#cfn-gamelift-fleet-locationcapacity-desiredec2instances)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: LocationCapacityProperty
            ): software.amazon.awscdk.services.gamelift.CfnFleet.LocationCapacityProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ScalingPolicyProperty {
         ...
         *
         * For detailed descriptions of fleet metrics, see
         ...
         *   includes game sessions that are not currently accepting players. Reserved player slots
         *   are not included.
         ...
         *
         * For a target-based policy, set the parameter *MetricName* to
         * 'PercentAvailableGameSessions' and specify a *TargetConfiguration* . For a rule-based
         * policy set the following parameters: *MetricName* , *ComparisonOperator* , *Threshold* ,
         ...
         *   scaling adjustment, read as a percentage. Positive values scale up while negative
         *   values scale down.
         *
         ...
         *
         * The scaling policy can be in force only when in an `ACTIVE` status. Scaling policies can
         * be suspended for individual fleets. If the policy is suspended for a fleet, the policy
        ...
        public interface Builder {
            /**
             * @param comparisonOperator Comparison operator to use when measuring a metric against
             *   the threshold value.
             */
            public fun comparisonOperator(comparisonOperator: String)

            /**
             * @param evaluationPeriods Length of time (in minutes) the metric must be at or beyond
            ...
            /**
             * @param metricName Name of the Amazon GameLift-defined metric that is used to trigger
            ...
            /**
             * @param policyType The type of scaling policy to create. For a target-based policy,
             *   set the parameter *MetricName* to 'PercentAvailableGameSessions' and specify a
            ...
            /**
             * @param scalingAdjustment Amount of adjustment to make, based on the scaling
             *   adjustment type.
             */
            public fun scalingAdjustment(scalingAdjustment: Number)

            /**
             * @param scalingAdjustmentType The type of adjustment to make to a fleet's instance
             *   count.
            ...
            /**
             * @param status Current status of the scaling policy. The scaling policy can be in
             *   force only when in an `ACTIVE` status. Scaling policies can be suspended for
             *   individual fleets. If the policy is suspended for a fleet, the policy status does
             *   not change.
             * * *ACTIVE* -- The scaling policy can be used for auto-scaling a fleet.
             * * *UPDATE_REQUESTED* -- A request to update the scaling policy has been received.
             * * *UPDATING* -- A change is being made to the scaling policy.
            ...
            /**
             * @param targetConfiguration An object that contains settings for a target-based
             *   scaling policy.
             */
            ...
            /**
             * @param updateStatus The current status of the fleet's scaling policies in a requested
             *   fleet location. The status `PENDING_UPDATE` indicates that an update was requested
        ...
        internal constructor(
             ...
             * For a target-based policy, set the parameter *MetricName* to
             * 'PercentAvailableGameSessions' and specify a *TargetConfiguration* . For a rule-based
             * policy set the following parameters: *MetricName* , *ComparisonOperator* ,
             ...
             * Current status of the scaling policy.
             *
             * The scaling policy can be in force only when in an `ACTIVE` status. Scaling policies
             * can be suspended for individual fleets. If the policy is suspended for a fleet, the
             ...
             * The current status of the fleet's scaling policies in a requested fleet location.
             *
             * The status `PENDING_UPDATE` indicates that an update was requested for the fleet but
    ...
    public interface CertificateConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param certificateType Indicates whether a TLS/SSL certificate is generated for a
             *   fleet. Valid values include:
             * * *GENERATED* - Generate a TLS/SSL certificate for this fleet.
             * * *DISABLED* - (default) Do not generate a TLS/SSL certificate for this fleet.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CertificateConfigurationProperty
            ): software.amazon.awscdk.services.gamelift.CfnFleet.CertificateConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
