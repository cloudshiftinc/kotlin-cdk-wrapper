...
public interface ListenerOptions {
     ...
     *
     * If you have stateful applications, client affinity lets you direct all requests from a user
    ...
    public interface Builder {
         ...
         *   endpoint. If you have stateful applications, client affinity lets you direct all
    ...
    internal constructor(
        ...
        /** The list of port ranges for the connections from clients to the accelerator. */
        override fun portRanges(): List<PortRange> =
