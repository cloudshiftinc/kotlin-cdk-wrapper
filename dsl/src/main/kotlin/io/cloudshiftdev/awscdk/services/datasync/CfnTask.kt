...
internal constructor(
    ...
    public interface Builder {
         ...
         * known as a *task execution* ). For more information, see
         ...
         * location.
         *
         * The schedule should be specified in UTC time. For more information, see
         ...
         *
         * @param schedule Specifies a schedule used to periodically transfer files from a source to
         ...
         *
         * @param sourceLocationArn The Amazon Resource Name (ARN) of the source location for the
         *   task.
         */
    ...
    private class BuilderImpl(
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("be882d8209e6a0c57067438e1607b0d0fe8570513ca4471839eb30502477f1ca")
        override fun taskReportConfig(
            taskReportConfig: TaskReportConfigProperty.Builder.() -> Unit
    ...
    public interface DeletedProperty {
        ...
        public interface Builder {
            /**
             * @param reportLevel Specifies whether you want your task report to include only what
             *   went wrong with your transfer or a list of what succeeded and didn't.
             * * `ERRORS_ONLY` : A report shows what DataSync was unable to delete.
        ...
        internal constructor(
            internal val cdkObject:
                software.amazon.awscdk.services.datasync.CfnTask.DeletedProperty,
        ) : DeletedProperty {
            /**
             * Specifies whether you want your task report to include only what went wrong with your
             * transfer or a list of what succeeded and didn't.
    ...
    public interface FilterRuleProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param value A single filter string that consists of the patterns to include or
    ...
    public interface OverridesProperty {
        ...
        public interface Builder {
            /**
             * @param deleted Specifies the level of reporting for the files, objects, and
             *   directories that DataSync attempted to delete in your destination location. This
             *   only applies if you
             *   [configure your task](https://docs.aws.amazon.com/datasync/latest/userguide/configure-metadata.html)
             *   to delete data in the destination that isn't in the source.
             */
            ...
            /**
             * @param skipped Specifies the level of reporting for the files, objects, and
            ...
            /**
             * @param transferred Specifies the level of reporting for the files, objects, and
            ...
            /**
             * @param verified Specifies the level of reporting for the files, objects, and
             *   directories that DataSync attempted to verify during your transfer.
             */
    ...
    public interface TaskScheduleProperty {
        ...
        public interface Builder {
            /**
             * @param scheduleExpression A cron expression that specifies when AWS DataSync
             *   initiates a scheduled transfer from a source to a destination location.
             */
    ...
    public interface S3Property {
         ...
         * a task report to your S3 bucket.
         *
         * For more information, see
        ...
        public interface Builder {
            /**
             * @param bucketAccessRoleArn Specifies the Amazon Resource Name (ARN) of the IAM policy
             *   that allows DataSync to upload a task report to your S3 bucket. For more
             *   information, see
             *   [Allowing DataSync to upload a task report to an Amazon S3 bucket](https://docs.aws.amazon.com/datasync/latest/userguide/creating-task-reports.html)
             *   .
             */
            ...
            /**
             * @param s3BucketArn Specifies the ARN of the S3 bucket where DataSync uploads your
             *   report.
             */
    ...
    public interface OptionsProperty {
        /**
         * A file metadata value that shows the last time that a file was accessed (that is, when
         * the file was read or written to).
         *
         ...
         * However, `Atime` 's behavior is not fully standard across platforms, so AWS DataSync can
         ...
         * * `ALWAYS` (default) - DataSync modifies data in the destination location when source
         *   data (including metadata) has changed.
         *
         ...
         * .
         * * `NEVER` - DataSync doesn't overwrite data in the destination location even if the
         *   source data has changed. You can use this option to protect against overwriting changes
         *   made to files or objects in the destination.
         *
         ...
         * locations. For more information about what metadata is copied by DataSync, see
         ...
         * minimum storage duration charges for certain storage classes. For detailed information,
         * see
         ...
         * locations, or between two Amazon FSx for Windows File Server locations. For more
         * information about how DataSync handles metadata, see
         ...
         * .
         *
         * `NONE` : None of the SMB security descriptor components are copied. Destination objects
         * are owned by the user that was provided for accessing the destination location. DACLs and
         ...
         * between the source and the destination location, or whether DataSync transfers all the
         * content from the source, without comparing it to the destination location.
         *
         * `CHANGED` : DataSync copies only data or metadata that is new or different from the
        ...
        /**
         * A value that determines whether a data integrity verification is performed at the end of
         * a task execution after all data and metadata have been transferred.
         *
         * For more information, see
         * [Configure task settings](https://docs.aws.amazon.com/datasync/latest/userguide/create-task.html)
         * .
         *
         ...
         * the transfer to verify that the source and destination are fully synchronized. This
         * option isn't supported when transferring to S3 Glacier or S3 Glacier Deep Archive storage
         * classes.
         *
        ...
        public interface Builder {
            /**
             * @param atime A file metadata value that shows the last time that a file was accessed
             *   (that is, when the file was read or written to). If you set `Atime` to
             *   `BEST_EFFORT` , AWS DataSync attempts to preserve the original `Atime` attribute on
             *   all source files (that is, the version before the PREPARING phase). However,
             *   `Atime` 's behavior is not fully standard across platforms, so AWS DataSync can
             *   only do this on a best-effort basis.
             *
             * Default value: `BEST_EFFORT`
             *
            ...
            /**
             * @param bytesPerSecond A value that limits the bandwidth used by AWS DataSync . For
             *   example, if you want AWS DataSync to use a maximum of 1 MB, set this value to
             *   `1048576` (=1024*1024).
             */
            public fun bytesPerSecond(bytesPerSecond: Number)

            /**
             * @param gid The group ID (GID) of the file's owners. Default value: `INT_VALUE`
             *
             * `INT_VALUE` : Preserve the integer value of the user ID (UID) and group ID (GID)
             * (recommended).
             *
            ...
            /**
             * @param logLevel Specifies the type of logs that DataSync publishes to a Amazon
            ...
            /**
             * @param mtime A value that indicates the last time that a file was modified (that is,
             *   a file was written to) before the PREPARING phase. This option is required for
            ...
            /**
             * @param objectTags Specifies whether you want DataSync to `PRESERVE` object tags
             ...
             * S3 storage classes (for example, for retrieval or early deletion). For more
             * information, see
             * [Storage class considerations with Amazon S3 transfers](https://docs.aws.amazon.com/datasync/latest/userguide/create-s3-location.html#using-storage-classes)
             * .
             * * `NEVER` - DataSync doesn't overwrite data in the destination location even if the
             *   source data has changed. You can use this option to protect against overwriting
             *   changes made to files or objects in the destination.
             */
            public fun overwriteMode(overwriteMode: String)

            /**
             * @param posixPermissions A value that determines which users or groups can access a
             *   file for a specific purpose, such as reading, writing, or execution of the file.
             *   This option should be set only for Network File System (NFS), Amazon EFS, and
             *   Amazon S3 locations. For more information about what metadata is copied by
             *   DataSync, see
             *   [Metadata Copied by DataSync](https://docs.aws.amazon.com/datasync/latest/userguide/special-files.html#metadata-copied)
             *   .
             *
            ...
            /**
             * @param preserveDeletedFiles A value that specifies whether files in the destination
             *   that don't exist in the source file system are preserved. This option can affect
             *   your storage costs. If your task deletes objects, you might incur minimum storage
            ...
            /**
             * @param preserveDevices A value that determines whether AWS DataSync should preserve
             *   the metadata of block and character devices in the source file system, and
             *   re-create the files with that device name and metadata on the destination. DataSync
            ...
            /**
             * @param securityDescriptorCopyFlags A value that determines which components of the
             *   SMB security descriptor are copied from source to destination objects. This value
             *   is only used for transfers between SMB and Amazon FSx for Windows File Server
             *   locations, or between two Amazon FSx for Windows File Server locations. For more
             *   information about how DataSync handles metadata, see
             *   [How DataSync Handles Metadata and Special Files](https://docs.aws.amazon.com/datasync/latest/userguide/special-files.html)
             *   .
             ...
             * ensures sufficient permissions to files, folders, and metadata, see
             * [user](https://docs.aws.amazon.com/datasync/latest/userguide/create-smb-location.html#SMBuser)
             * .
             *
            ...
            /**
             * @param taskQueueing Specifies whether your transfer tasks should be put into a queue
             *   during certain scenarios when
             *   [running multiple tasks](https://docs.aws.amazon.com/datasync/latest/userguide/run-task.html#running-multiple-tasks)
             *   . This is `ENABLED` by default.
             */
            ...
            /**
             * @param transferMode A value that determines whether DataSync transfers only the data
             *   and metadata that differ between the source and the destination location, or
             *   whether DataSync transfers all the content from the source, without comparing it to
             *   the destination location. `CHANGED` : DataSync copies only data or metadata that is
             *   new or different from the source location to the destination location.
             *
             * `ALL` : DataSync copies all source location content to the destination, without
             * comparing it to existing content on the destination.
             */
            public fun transferMode(transferMode: String)

            /**
             * @param uid The user ID (UID) of the file's owner. Default value: `INT_VALUE`
             *
             * `INT_VALUE` : Preserve the integer value of the UID and group ID (GID) (recommended).
             *
             * `NAME` : Currently not supported
             ...
             * of the transfer to verify that the source and destination are fully synchronized.
             * This option isn't supported when transferring to S3 Glacier or S3 Glacier Deep
        ...
        internal constructor(
             ...
             * phase). However, `Atime` 's behavior is not fully standard across platforms, so AWS
             ...
             * written to) before the PREPARING phase.
             *
             * This option is required for cases when you need to run the same task more than one
             * time.
             *
             * Default value: `PRESERVE`
             *
             ...
             *
             * This option should be set only for Network File System (NFS), Amazon EFS, and Amazon
             * S3 locations. For more information about what metadata is copied by DataSync, see
             * [Metadata Copied by DataSync](https://docs.aws.amazon.com/datasync/latest/userguide/special-files.html#metadata-copied)
             * .
             *
             * Default value: `PRESERVE`
             ...
             * source file system are preserved.
             *
             * This option can affect your storage costs. If your task deletes objects, you might
             * incur minimum storage duration charges for certain storage classes. For detailed
             * information, see
             * [Considerations when working with Amazon S3 storage classes in DataSync](https://docs.aws.amazon.com/datasync/latest/userguide/create-s3-location.html#using-storage-classes)
             * in the *AWS DataSync User Guide* .
             *
             ...
             * more information about how DataSync handles metadata, see
             * [How DataSync Handles Metadata and Special Files](https://docs.aws.amazon.com/datasync/latest/userguide/special-files.html)
             * .
             *
             * Default value: `OWNER_DACL`
            ...
            /**
             * A value that determines whether a data integrity verification is performed at the end
    ...
    public interface TaskReportConfigProperty {
         ...
         * you want a list of successes and errors just for the files that DataSync attempted to
         * delete in your destination location.
         *
        ...
        public interface Builder {
            /**
             * @param destination Specifies the Amazon S3 bucket where DataSync uploads your task
            ...
            /**
             * @param objectVersionIds Specifies whether your task report includes the new version
             *   of each object transferred into an S3 bucket. This only applies if you
             *   [enable versioning on your bucket](https://docs.aws.amazon.com/AmazonS3/latest/userguide/manage-versioning-examples.html)
             ...
             * * `SUMMARY_ONLY` : Provides necessary details about your task, including the number
            ...
            /**
             * @param overrides Customizes the reporting level for aspects of your task report. For
             *   example, your report might generally only include errors, but you could specify
             ...
             * @param reportLevel Specifies whether you want your task report to include only what
             *   went wrong with your transfer or a list of what succeeded and didn't.
             * * `ERRORS_ONLY` : A report shows what DataSync was unable to transfer, skip, verify,
             *   and delete.
             * * `SUCCESSES_AND_ERRORS` : A report shows what DataSync was able and unable to
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TaskReportConfigProperty
            ): software.amazon.awscdk.services.datasync.CfnTask.TaskReportConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
