...
internal constructor(
    ...
    /**  */
    public open fun attrPreferredInstanceType(): String =
        unwrap(this).getAttrPreferredInstanceType()
    ...
    public interface Builder {
         ...
         *
         * @param ipAddresses The subnets and IP addresses in your VPC that DNS queries originate
         ...
         * The ID of one or more security groups that control access to this VPC.
         *
         * The security group must include one or more inbound rules (for inbound endpoints) or
         * outbound rules (for outbound endpoints). Inbound and outbound rules must allow TCP and
         * UDP access. For inbound access, open port 53. For outbound access, open the port that
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.route53resolver.CfnResolverEndpoint.Builder.create(
                scope,
                id
            )
    ...
    public interface IpAddressRequestProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: IpAddressRequestProperty
            ): software.amazon.awscdk.services.route53resolver.CfnResolverEndpoint.IpAddressRequestProperty =
