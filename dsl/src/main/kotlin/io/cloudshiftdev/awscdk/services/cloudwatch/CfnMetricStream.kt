...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * When you modify the `IncludeFilters` or `ExcludeFilters` of an existing metric stream in
         * any way, the metric stream is effectively restarted, so after such a change you will get
         ...
         *
         * @param excludeFilters If you specify this parameter, the stream sends metrics from all
         ...
         *
         * @param includeFilters If you specify this parameter, the stream sends only the metrics
         ...
         * If you are creating a new metric stream, this is the name for the new stream.
         *
         * The name must be different than the names of other metric streams in this account and
         * Region.
         *
         ...
         * resources.
         *
         * This IAM role must already exist and must be in the same account as the metric stream.
         ...
         * for each metric that is streamed.
         *
         * You can use this parameter to have the metric stream also send additional statistics in
         * the stream. This array can have up to 100 members.
         *
         ...
         *
         * @param statisticsConfigurations By default, a metric stream always sends the MAX, MIN,
         *   SUM, and SAMPLECOUNT statistics for each metric that is streamed.
         */
    ...
    private class BuilderImpl(
        ...
        override fun includeLinkedAccountsMetrics(includeLinkedAccountsMetrics: IResolvable) {
            cdkBuilder.includeLinkedAccountsMetrics(
                includeLinkedAccountsMetrics.let(IResolvable::unwrap)
            )
        }
    ...
    public interface MetricStreamStatisticsConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param additionalStatistics The additional statistics to stream for the metrics
             *   listed in `IncludeMetrics` .
             */
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-cloudwatch-metricstream-metricstreamstatisticsconfiguration.html#cfn-cloudwatch-metricstream-metricstreamstatisticsconfiguration-additionalstatistics)
             */
            override fun additionalStatistics(): List<String> =
                unwrap(this).getAdditionalStatistics()
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: MetricStreamStatisticsConfigurationProperty
            ): software.amazon.awscdk.services.cloudwatch.CfnMetricStream.MetricStreamStatisticsConfigurationProperty =
    ...
    public interface MetricStreamStatisticsMetricProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: MetricStreamStatisticsMetricProperty
            ): software.amazon.awscdk.services.cloudwatch.CfnMetricStream.MetricStreamStatisticsMetricProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface MetricStreamFilterProperty {
        ...
        public interface Builder {
            /**
             * @param metricNames The names of the metrics to either include or exclude from the
             *   metric stream. If you omit this parameter, all metrics in the namespace are
             *   included or excluded, depending on whether this filter is specified as an exclude
            ...
            /**
             * @param namespace The name of the metric namespace in the filter. The namespace can
        ...
        private class BuilderImpl : Builder {
             ...
             * 126). Each metric name must contain at least one non-whitespace character.
             */
            override fun metricNames(vararg metricNames: String): Unit =
                metricNames(metricNames.toList())
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: MetricStreamFilterProperty
            ): software.amazon.awscdk.services.cloudwatch.CfnMetricStream.MetricStreamFilterProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
