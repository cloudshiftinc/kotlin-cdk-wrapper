...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param flowDefinition The configuration that controls how Customer Profiles retrieves
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.customerprofiles.CfnIntegration.Builder.create(
                scope,
                id
            )
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("04a0855709d02451743499c02435d7192d2fd29a27f883fbe1c7332f6785d72c")
        override fun flowDefinition(
            flowDefinition: FlowDefinitionProperty.Builder.() -> Unit
    ...
    public interface TriggerConfigProperty {
        ...
        public interface Builder {
             ...
             *   flow that you define. Currently, these settings only apply to the Scheduled trigger
             *   type.
             */
            ...
            public fun triggerProperties(
                triggerProperties: TriggerPropertiesProperty.Builder.() -> Unit
            )

            /**
             * @param triggerType Specifies the type of flow trigger. It can be OnDemand, Scheduled,
             *   or Event.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            override fun triggerProperties(triggerProperties: TriggerPropertiesProperty) {
                cdkBuilder.triggerProperties(
                    triggerProperties.let(TriggerPropertiesProperty::unwrap)
                )
            }
    ...
    public interface FlowDefinitionProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param flowName The specified name of the flow. Use underscores (_) or hyphens (-)
             *   only. Spaces are not allowed.
             */
            public fun flowName(flowName: String)

            /**
             * @param kmsArn The Amazon Resource Name (ARN) of the AWS Key Management Service (KMS)
             *   key you provide for encryption.
             */
            public fun kmsArn(kmsArn: String)

            /**
             * @param sourceFlowConfig The configuration that controls how Customer Profiles
            ...
            public fun sourceFlowConfig(
                sourceFlowConfig: SourceFlowConfigProperty.Builder.() -> Unit
            )

            /**
             * @param tasks A list of tasks that Customer Profiles performs while transferring the
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("f898f14bbd34b0d3ba64659ba12cddf6cf5c82aa1df7a7efb4e83003421c8bbc")
            override fun triggerConfig(
                triggerConfig: TriggerConfigProperty.Builder.() -> Unit
        ...
        internal constructor(
            ...
            /**
             * The Amazon Resource Name (ARN) of the AWS Key Management Service (KMS) key you
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: FlowDefinitionProperty
            ): software.amazon.awscdk.services.customerprofiles.CfnIntegration.FlowDefinitionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ObjectTypeMappingProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ObjectTypeMappingProperty
            ): software.amazon.awscdk.services.customerprofiles.CfnIntegration.ObjectTypeMappingProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ScheduledTriggerPropertiesProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param scheduleStartTime Specifies the scheduled start time for a scheduled-trigger
             *   flow.
             */
    ...
    public interface TaskProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param taskProperties A map used to store task-related information. The service looks
    ...
    public interface TriggerPropertiesProperty {
        ...
        public interface Builder {
            /**
             * @param scheduled Specifies the configuration details of a schedule-triggered flow
             *   that you define.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            override fun scheduled(
                scheduled: ScheduledTriggerPropertiesProperty.Builder.() -> Unit
            ): Unit = scheduled(ScheduledTriggerPropertiesProperty(scheduled))
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TriggerPropertiesProperty
            ): software.amazon.awscdk.services.customerprofiles.CfnIntegration.TriggerPropertiesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SourceFlowConfigProperty {
        ...
        public interface Builder {
            /**
             * @param connectorProfileName The name of the Amazon AppFlow connector profile. This
             *   name must be unique for each connector profile in the AWS account .
             */
    ...
    public interface SourceConnectorPropertiesProperty {
        ...
        public interface Builder {
            /**
             * @param marketo The properties that are applied when Marketo is being used as a
             *   source.
             */
            ...
            /**
             * @param s3 The properties that are applied when Amazon S3 is being used as the flow
             *   source.
             */
    ...
    public interface TaskPropertiesMapProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TaskPropertiesMapProperty
            ): software.amazon.awscdk.services.customerprofiles.CfnIntegration.TaskPropertiesMapProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
