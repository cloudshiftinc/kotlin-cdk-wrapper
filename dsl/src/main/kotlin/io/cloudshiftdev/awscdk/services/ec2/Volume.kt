...
internal constructor(
    ...
    public override fun grantAttachVolume(grantee: IGrantable, instances: List<IInstance>): Grant =
        unwrap(this)
            .grantAttachVolume(grantee.let(IGrantable::unwrap), instances.map(IInstance::unwrap))
            .let(Grant::wrap)
    ...
    public override fun grantAttachVolumeByResourceTag(
        ...
        unwrap(this)
            .grantAttachVolumeByResourceTag(
                ...
                constructs.map(CloudshiftdevConstructsConstruct::unwrap)
            )
            .let(Grant::wrap)
    ...
    public override fun grantDetachVolume(grantee: IGrantable, instances: List<IInstance>): Grant =
        unwrap(this)
            .grantDetachVolume(grantee.let(IGrantable::unwrap), instances.map(IInstance::unwrap))
            .let(Grant::wrap)
    ...
    public interface Builder {
         ...
         *
         * Note: If using an `aws-kms.IKey` created from a `aws-kms.Key.fromKeyArn()` here, then the
         * KMS key **must** have the following in its Key policy; otherwise, the Volume will fail to
         * create.
         *
         * ```
         * {
         ...
         *
         * @param encryptionKey The customer-managed encryption key that is used to encrypt the
         *   Volume.
         */
         ...
         *
         * Default: None -- Required for io1 and io2 volumes. The default for gp3 volumes is 3,000
         * IOPS if omitted.
         *
    ...
    public companion object {
        public fun fromVolumeAttributes(
            ...
            software.amazon.awscdk.services.ec2.Volume.fromVolumeAttributes(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    attrs.let(VolumeAttributes::unwrap)
                )
                .let(IVolume::wrap)
