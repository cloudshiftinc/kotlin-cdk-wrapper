...
internal constructor(
     ...
     * * *AWS_MANAGED_PERMISSION* – AWS created and manages this managed permission. You can
     ...
     *   managed permission. You can associate it with your resource shares and create new versions
    ...
    public interface Builder {
         ...
         *   For a list of all actions supported by each resource type, see
         ...
         *   about the Condition element, see
         ...
         * filled in by AWS RAM when it instantiates the resource-based policy on each resource
         * shared using this managed permission. The `Resource` comes from the ARN of the specific
         * resource that you are sharing. The `Principal` comes from the list of identities added to
         * the resource share.
         *
         ...
         *
         * @param policyTemplate A string in JSON format string that contains the following elements
    ...
    public companion object {
        ...
        ): software.amazon.awscdk.services.ram.CfnPermission = wrapped.cdkObject
    }
}
