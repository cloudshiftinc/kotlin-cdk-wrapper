...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.lambda.CfnLayerVersion,
     ...
     * .
     */
    public open fun compatibleRuntimes(): List<String> =
        unwrap(this).getCompatibleRuntimes() ?: emptyList()
    ...
    public interface Builder {
         ...
         * * An [SPDX license identifier](https://docs.aws.amazon.com/https://spdx.org/licenses/) .
         *   For example, `MIT` .
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.lambda.CfnLayerVersion =
            cdkBuilder.build()
    }
    ...
    public interface ContentProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param s3ObjectVersion For versioned objects, the version of the layer archive object
             *   to use.
             */
