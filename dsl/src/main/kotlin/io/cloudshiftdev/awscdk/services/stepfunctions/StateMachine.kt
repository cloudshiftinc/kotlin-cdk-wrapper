...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.stepfunctions.StateMachine,
    ...
    /**
     * Identifier for the state machine revision, which is an immutable, read-only snapshot of a
    ...
    public interface Builder {
         ...
         */
        @Deprecated(message = "deprecated in CDK") public fun definition(definition: IChainable)
    ...
    public companion object {
        public fun fromStateMachineArn(
            ...
            software.amazon.awscdk.services.stepfunctions.StateMachine.fromStateMachineArn(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    stateMachineArn
                )
                .let(IStateMachine::wrap)
        ...
        public fun fromStateMachineName(
            ...
            software.amazon.awscdk.services.stepfunctions.StateMachine.fromStateMachineName(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    stateMachineName
                )
