...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param ipProtocol The IP protocol name ( `tcp` , `udp` , `icmp` , `icmpv6` ) or number
         *   (see
         *   [Protocol Numbers](https://docs.aws.amazon.com/http://www.iana.org/assignments/protocol-numbers/protocol-numbers.xhtml)
         *   ).
         */
         ...
         * The ID of the security group.
         *
         * You must specify either the security group ID or the security group name. For security
         ...
         * specify `SourceSecurityGroupOwnerId` ; otherwise, this property is optional.
         *
         ...
         * The end of port range for the TCP and UDP protocols, or an ICMP/ICMPv6 code.
         *
         * A value of `-1` indicates all ICMP/ICMPv6 codes for the specified ICMP type. If you
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnSecurityGroupIngress
