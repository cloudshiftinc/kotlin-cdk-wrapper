...
internal constructor(
    ...
    public open fun referenceDataSource(
        `value`: ReferenceDataSourceProperty.Builder.() -> Unit
    ): Unit = referenceDataSource(ReferenceDataSourceProperty(`value`))
    ...
    public interface Builder {
         ...
         * The reference data source can be an object in your Amazon S3 bucket.
         *
         * Amazon Kinesis Analytics reads the object and copies the data into the in-application
         * table that is created. You provide an S3 bucket, object key name, and the resulting
         * in-application table that is created. You must also provide an IAM role with the
         * necessary permissions that Amazon Kinesis Analytics can assume to read the object from
         * your S3 bucket on your behalf.
         *
        ...
        public fun referenceDataSource(
            referenceDataSource: ReferenceDataSourceProperty.Builder.() -> Unit
        )
    }
    ...
    private class BuilderImpl(
        ...
        override fun referenceDataSource(referenceDataSource: ReferenceDataSourceProperty) {
            cdkBuilder.referenceDataSource(
                referenceDataSource.let(ReferenceDataSourceProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("e4ea4757f7639e52db201ca2f2fb00f0df5a0f3f285bc61d1489109895965cd7")
        override fun referenceDataSource(
            referenceDataSource: ReferenceDataSourceProperty.Builder.() -> Unit
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnApplicationReferenceDataSource
        ): software.amazon.awscdk.services.kinesisanalytics.CfnApplicationReferenceDataSource =
            wrapped.cdkObject
    }
    ...
    public interface RecordColumnProperty {
        ...
        public interface Builder {
            /**
             * @param mapping Reference to the data element in the streaming input or the reference
            ...
            /**
             * @param name Name of the column created in the in-application input stream or
             *   reference table.
             */
    ...
    public interface ReferenceSchemaProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ReferenceSchemaProperty
            ): software.amazon.awscdk.services.kinesisanalytics.CfnApplicationReferenceDataSource.ReferenceSchemaProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface S3ReferenceDataSourceProperty {
         ...
         *
         * This role must have permission for the `s3:GetObject` action on the object and trust
        ...
        public interface Builder {
            ...
            /**
             * @param referenceRoleArn ARN of the IAM role that the service can assume to read data
             *   on your behalf. This role must have permission for the `s3:GetObject` action on the
             *   object and trust policy that allows Amazon Kinesis Analytics service principal to
             *   assume this role.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: S3ReferenceDataSourceProperty
            ): software.amazon.awscdk.services.kinesisanalytics.CfnApplicationReferenceDataSource.S3ReferenceDataSourceProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ReferenceDataSourceProperty {
         ...
         * your behalf. An Amazon Kinesis Analytics application loads reference data only once. If
        ...
        public interface Builder {
            /**
             * @param referenceSchema Describes the format of the data in the streaming source, and
             *   how each data element maps to corresponding columns created in the in-application
             *   stream.
             */
             ...
             *   reference data. Also identifies the IAM role Amazon Kinesis Analytics can assume to
             *   read this object on your behalf. An Amazon Kinesis Analytics application loads
             *   reference data only once. If the data changes, you call the `UpdateApplication`
            ...
            public fun s3ReferenceDataSource(
                s3ReferenceDataSource: S3ReferenceDataSourceProperty.Builder.() -> Unit
            )
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("0e7d5ad4c7a8a6f1778176e5e40688ac4227a21d1062e9980b55a23759e9156c")
            override fun referenceSchema(
                referenceSchema: ReferenceSchemaProperty.Builder.() -> Unit
             ...
             *   operation to trigger reloading of data into your application.
             */
            override fun s3ReferenceDataSource(
                s3ReferenceDataSource: S3ReferenceDataSourceProperty
            ) {
                cdkBuilder.s3ReferenceDataSource(
                    s3ReferenceDataSource.let(S3ReferenceDataSourceProperty::unwrap)
                )
            }
        ...
        internal constructor(
             ...
             * Identifies the S3 bucket and object that contains the reference data.
             *
             * Also identifies the IAM role Amazon Kinesis Analytics can assume to read this object
             * on your behalf. An Amazon Kinesis Analytics application loads reference data only
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ReferenceDataSourceProperty
            ): software.amazon.awscdk.services.kinesisanalytics.CfnApplicationReferenceDataSource.ReferenceDataSourceProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface RecordFormatProperty {
        ...
        public interface Builder {
            /**
             * @param mappingParameters When configuring application input at the time of creating
    ...
    public interface CSVMappingParametersProperty {
        ...
        public interface Builder {
            /**
             * @param recordColumnDelimiter Column delimiter. For example, in a CSV format, a comma
