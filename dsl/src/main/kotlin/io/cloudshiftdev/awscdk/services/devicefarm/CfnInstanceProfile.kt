...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param excludeAppPackagesFromCleanup An array of strings containing the list of app
         *   packages that should not be cleaned up from the device after a test run completes.
         */
         ...
         *
         * @param packageCleanup When set to `true` , Device Farm removes app packages after a test
         *   run.
         */
         ...
         *
         * @param rebootAfterUse When set to `true` , Device Farm reboots the instance after a test
         *   run.
         */
    ...
    private class BuilderImpl(
         ...
         *   packages that should not be cleaned up from the device after a test run completes.
         */
        override fun excludeAppPackagesFromCleanup(
            vararg excludeAppPackagesFromCleanup: String
        ): Unit = excludeAppPackagesFromCleanup(excludeAppPackagesFromCleanup.toList())
