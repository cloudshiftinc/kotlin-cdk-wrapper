...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param gitConfig Configuration details for the Git repository, including the URL where it
         *   is located and the ARN of the AWS Secrets Manager secret that contains the credentials
