...
internal constructor(
    ...
    public interface Builder {
        /**
         * An access point with an attached AWS Lambda function used to access transformed data from
         * an Amazon S3 bucket.
         *
         ...
         *
         * @param objectLambdaAccessPoint An access point with an attached AWS Lambda function used
         *   to access transformed data from an Amazon S3 bucket.
         */
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.s3objectlambda.CfnAccessPointPolicy.Builder.create(
                scope,
                id
            )
