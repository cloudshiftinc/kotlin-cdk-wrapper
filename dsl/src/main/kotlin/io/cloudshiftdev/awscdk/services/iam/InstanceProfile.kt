...
public open class InstanceProfile internal constructor(
  private val cdkObject: software.amazon.awscdk.services.iam.InstanceProfile,
  ...
  public companion object {
    public open fun fromInstanceProfileArn(
    ...
    public open fun fromInstanceProfileAttributes(
      scope: CloudshiftdevConstructsConstruct,
      id: String,
    ...
    public open fun fromInstanceProfileName(
      scope: CloudshiftdevConstructsConstruct,
      id: String,
