...
internal constructor(
    ...
    public interface Builder {
         ...
         * ```
         *
         * @param role An IAM role to associate with the instance profile that is used by EC2
         *   instances.
         */
    ...
    public companion object {
        public fun fromInstanceProfileArn(
            ...
            software.amazon.awscdk.services.iam.InstanceProfile.fromInstanceProfileArn(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    instanceProfileArn
                )
                .let(IInstanceProfile::wrap)
        ...
        public fun fromInstanceProfileAttributes(
            ...
            software.amazon.awscdk.services.iam.InstanceProfile.fromInstanceProfileAttributes(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    attrs.let(InstanceProfileAttributes::unwrap)
                )
                .let(IInstanceProfile::wrap)
        ...
        public fun fromInstanceProfileAttributes(
            ...
            fromInstanceProfileAttributes(scope, id, InstanceProfileAttributes(attrs))
        ...
        public fun fromInstanceProfileName(
            ...
            software.amazon.awscdk.services.iam.InstanceProfile.fromInstanceProfileName(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    instanceProfileName
                )
