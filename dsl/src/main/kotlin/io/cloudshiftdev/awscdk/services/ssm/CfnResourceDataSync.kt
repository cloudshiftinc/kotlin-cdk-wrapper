...
internal constructor(
    ...
    public interface Builder {
         ...
         * The Amazon Resource Name (ARN) of an encryption key for a destination in Amazon S3 .
         *
         * You can use a KMS key to encrypt inventory data in Amazon S3 . You must specify a key
         * that exist in the same AWS Region as the destination Amazon S3 bucket.
         *
         ...
         * The type of resource data sync.
         *
         * If `SyncType` is `SyncToDestination` , then the resource data sync synchronizes data to
         * an S3 bucket. If the `SyncType` is `SyncFromSource` then the resource data sync
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.ssm.CfnResourceDataSync =
            cdkBuilder.build()
    }
    ...
    public interface AwsOrganizationsSourceProperty {
         ...
         */
        public fun organizationalUnits(): List<String> =
        ...
        public interface Builder {
             ...
             *   `OrganizationalUnits` or `EntireOrganization` . For `OrganizationalUnits` , the
             *   data is aggregated from a set of organization units. For `EntireOrganization` , the
             *   data is aggregated from the entire AWS organization.
             */
            public fun organizationSourceType(organizationSourceType: String)

            /**
             * @param organizationalUnits The AWS Organizations organization units included in the
             *   sync.
             */
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ssm-resourcedatasync-awsorganizationssource.html#cfn-ssm-resourcedatasync-awsorganizationssource-organizationalunits)
             */
            override fun organizationalUnits(): List<String> =
                unwrap(this).getOrganizationalUnits() ?: emptyList()
        }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AwsOrganizationsSourceProperty
            ): software.amazon.awscdk.services.ssm.CfnResourceDataSync.AwsOrganizationsSourceProperty =
    ...
    public interface S3DestinationProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param bucketRegion The AWS Region with the S3 bucket targeted by the resource data
             *   sync.
             */
            public fun bucketRegion(bucketRegion: String)

            /**
             * @param kmsKeyArn The ARN of an encryption key for a destination in Amazon S3. Must
             *   belong to the same Region as the destination S3 bucket.
             */
            public fun kmsKeyArn(kmsKeyArn: String)

            /**
             * @param syncFormat A supported sync format. The following format is currently
             *   supported: JsonSerDe
             */
            public fun syncFormat(syncFormat: String)
        }
    ...
    public interface SyncSourceProperty {
        ...
        public interface Builder {
            /**
             * @param awsOrganizationsSource Information about the AwsOrganizationsSource resource
             *   data sync source. A sync source of this type can synchronize data from AWS
             *   Organizations .
             */
            ...
            public fun awsOrganizationsSource(
                awsOrganizationsSource: AwsOrganizationsSourceProperty.Builder.() -> Unit
            )

            /**
             * @param includeFutureRegions Whether to automatically synchronize and aggregate data
             *   from new AWS Regions when those Regions come online.
             */
            ...
            /**
             * @param sourceType The type of data source for the resource data sync. `SourceType` is
             *   either `AwsOrganizations` (if an organization is present in AWS Organizations ) or
        ...
        private class BuilderImpl : Builder {
             ...
             *   Organizations .
             */
            override fun awsOrganizationsSource(
                awsOrganizationsSource: AwsOrganizationsSourceProperty
            ) {
                cdkBuilder.awsOrganizationsSource(
                    awsOrganizationsSource.let(AwsOrganizationsSourceProperty::unwrap)
                )
            }
