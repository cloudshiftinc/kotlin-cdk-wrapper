...
internal constructor(
    ...
    public interface Builder {
        /**
         * A flag that determines whether to automatically publish the function to the `LIVE` stage
         * when it’s created.
         *
         ...
         *
         * @param autoPublish A flag that determines whether to automatically publish the function
         *   to the `LIVE` stage when it’s created.
         */
    ...
    private class BuilderImpl(
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("fce6d74021529b7d490dff859dc0036e222c115069813d8f548ff68f74b843bc")
        override fun functionConfig(
            functionConfig: FunctionConfigProperty.Builder.() -> Unit
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("d795f119cc42115758eadb9d3fbc68e16bd1a5de441d59689f44259f847f0d41")
        override fun functionMetadata(
            functionMetadata: FunctionMetadataProperty.Builder.() -> Unit
        ...
        public fun build(): software.amazon.awscdk.services.cloudfront.CfnFunction =
            cdkBuilder.build()
    }
    ...
    public interface FunctionMetadataProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: FunctionMetadataProperty
            ): software.amazon.awscdk.services.cloudfront.CfnFunction.FunctionMetadataProperty =
    ...
    public interface FunctionConfigProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param keyValueStoreAssociations The configuration for the key value store
             *   associations.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            override fun keyValueStoreAssociations(keyValueStoreAssociations: IResolvable) {
                cdkBuilder.keyValueStoreAssociations(
                    keyValueStoreAssociations.let(IResolvable::unwrap)
                )
            }
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-cloudfront-function-functionconfig.html#cfn-cloudfront-function-functionconfig-keyvaluestoreassociations)
             */
            override fun keyValueStoreAssociations(): Any? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: FunctionConfigProperty
            ): software.amazon.awscdk.services.cloudfront.CfnFunction.FunctionConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface KeyValueStoreAssociationProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: KeyValueStoreAssociationProperty
            ): software.amazon.awscdk.services.cloudfront.CfnFunction.KeyValueStoreAssociationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
