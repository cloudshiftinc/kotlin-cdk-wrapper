...
internal constructor(
    ...
    public open fun minimumHealthyHosts(
        `value`: MinimumHealthyHostsProperty.Builder.() -> Unit
    ): Unit = minimumHealthyHosts(MinimumHealthyHostsProperty(`value`))
    ...
    public open fun trafficRoutingConfig(
        `value`: TrafficRoutingConfigProperty.Builder.() -> Unit
    ...
    public interface Builder {
         ...
         *
         * @param computePlatform The destination platform type for the deployment ( `Lambda` ,
         *   `Server` , or `ECS` ).
         */
         ...
         * that ID for the deployment configuration name. For more information, see
         ...
         *
         * @param minimumHealthyHosts The minimum number of healthy instances that should be
         *   available at any time during the deployment.
         */
        ...
        public fun minimumHealthyHosts(
            minimumHealthyHosts: MinimumHealthyHostsProperty.Builder.() -> Unit
        )
         ...
         *
         * @param trafficRoutingConfig The configuration that specifies how the deployment traffic
         *   is routed.
         */
        ...
        public fun trafficRoutingConfig(
            trafficRoutingConfig: TrafficRoutingConfigProperty.Builder.() -> Unit
        )

        /**
         * Configure the `ZonalConfig` object if you want AWS CodeDeploy to deploy your application
         * to one
         * [Availability Zone](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/using-regions-availability-zones.html#concepts-availability-zones)
         * at a time, within an AWS Region.
         *
         ...
         *
         * @param zonalConfig Configure the `ZonalConfig` object if you want AWS CodeDeploy to
         *   deploy your application to one
         *   [Availability Zone](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/using-regions-availability-zones.html#concepts-availability-zones)
         *   at a time, within an AWS Region.
         */
    ...
    private class BuilderImpl(
        ...
        override fun minimumHealthyHosts(minimumHealthyHosts: MinimumHealthyHostsProperty) {
            cdkBuilder.minimumHealthyHosts(
                minimumHealthyHosts.let(MinimumHealthyHostsProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("fbc1c3a565260c5d54a5ad16a4e966843b6eb67b2b603b17bf971baae214889a")
        override fun minimumHealthyHosts(
            minimumHealthyHosts: MinimumHealthyHostsProperty.Builder.() -> Unit
        ...
        override fun trafficRoutingConfig(trafficRoutingConfig: TrafficRoutingConfigProperty) {
            cdkBuilder.trafficRoutingConfig(
                trafficRoutingConfig.let(TrafficRoutingConfigProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("a6a790552c956f9a592a991f15d33e1a0de868fca97a9c3d960b1627e58e3eed")
        override fun trafficRoutingConfig(
            trafficRoutingConfig: TrafficRoutingConfigProperty.Builder.() -> Unit
    ...
    public interface ZonalConfigProperty {
         ...
         * to the *first* Availability Zone.
         *
         ...
         * `firstZoneMonitorDurationInSeconds` , then CodeDeploy uses the `monitorDurationInSeconds`
         ...
         * prove itself (or 'bake') in one Availability Zone before it is released in the next zone.
         * If you don't specify a `monitorDurationInSeconds` , CodeDeploy starts deploying to the
        ...
        public interface Builder {
            /**
             * @param firstZoneMonitorDurationInSeconds The period of time, in seconds, that
             *   CodeDeploy must wait after completing a deployment to the *first* Availability
             *   Zone. CodeDeploy will wait this amount of time before starting a deployment to the
             *   second Availability Zone. You might set this option if you want to allow extra bake
             *   time for the first Availability Zone. If you don't specify a value for
            ...
            /**
             * @param minimumHealthyHostsPerZone The number or percentage of instances that must
             *   remain available per Availability Zone during a deployment. This option works in
             *   conjunction with the `MinimumHealthyHosts` option. For more information, see
             *   [About the minimum number of healthy hosts per Availability Zone](https://docs.aws.amazon.com//codedeploy/latest/userguide/instances-health.html#minimum-healthy-hosts-az)
             *   in the *CodeDeploy User Guide* .
             *
             * If you don't specify the `minimumHealthyHostsPerZone` option, then CodeDeploy uses a
            ...
            public fun minimumHealthyHostsPerZone(
                minimumHealthyHostsPerZone: MinimumHealthyHostsPerZoneProperty.Builder.() -> Unit
            )

            /**
             * @param monitorDurationInSeconds The period of time, in seconds, that CodeDeploy must
             *   wait after completing a deployment to an Availability Zone. CodeDeploy will wait
             *   this amount of time before starting a deployment to the next Availability Zone.
             *   Consider adding a monitor duration to give the deployment some time to prove itself
             *   (or 'bake') in one Availability Zone before it is released in the next zone. If you
             *   don't specify a `monitorDurationInSeconds` , CodeDeploy starts deploying to the
             *   next Availability Zone immediately.
             *
             * For more information about the zonal configuration feature, see
             * [zonal configuration](https://docs.aws.amazon.com/codedeploy/latest/userguide/deployment-configurations-create.html#zonal-config)
        ...
        private class BuilderImpl : Builder {
             ...
             * in the *CodeDeploy User Guide* .
             */
            override fun firstZoneMonitorDurationInSeconds(
            ...
            override fun minimumHealthyHostsPerZone(minimumHealthyHostsPerZone: IResolvable) {
                cdkBuilder.minimumHealthyHostsPerZone(
                    minimumHealthyHostsPerZone.let(IResolvable::unwrap)
                )
            }
             ...
             * in the *CodeDeploy User Guide* .
             */
            override fun minimumHealthyHostsPerZone(
                minimumHealthyHostsPerZone: MinimumHealthyHostsPerZoneProperty
            ) {
                cdkBuilder.minimumHealthyHostsPerZone(
                    minimumHealthyHostsPerZone.let(MinimumHealthyHostsPerZoneProperty::unwrap)
                )
            }
            ...
            override fun minimumHealthyHostsPerZone(
                ...
                minimumHealthyHostsPerZone(
                    MinimumHealthyHostsPerZoneProperty(minimumHealthyHostsPerZone)
                )
        ...
        internal constructor(
             ...
             * deployment to the *first* Availability Zone.
             *
             * CodeDeploy will wait this amount of time before starting a deployment to the second
             * Availability Zone. You might set this option if you want to allow extra bake time for
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-codedeploy-deploymentconfig-zonalconfig.html#cfn-codedeploy-deploymentconfig-zonalconfig-minimumhealthyhostsperzone)
             */
            override fun minimumHealthyHostsPerZone(): Any? =
             ...
             *
             * CodeDeploy will wait this amount of time before starting a deployment to the next
             * Availability Zone. Consider adding a monitor duration to give the deployment some
             * time to prove itself (or 'bake') in one Availability Zone before it is released in
             * the next zone. If you don't specify a `monitorDurationInSeconds` , CodeDeploy starts
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-codedeploy-deploymentconfig-zonalconfig.html#cfn-codedeploy-deploymentconfig-zonalconfig-monitordurationinseconds)
             */
            override fun monitorDurationInSeconds(): Number? =
    ...
    public interface MinimumHealthyHostsProperty {
        ...
        public interface Builder {
             ...
             * In an example of nine instance, if a HOST_COUNT of six is specified, deploy to up to
             * three instances at a time. The deployment is successful if six or more instances are
             * deployed to successfully. Otherwise, the deployment fails. If a FLEET_PERCENT of 40
             * is specified, deploy to up to five instance at a time. The deployment is successful
             * if four or more instance are deployed to successfully. Otherwise, the deployment
             * fails.
             *
             * In a call to `GetDeploymentConfig` , CodeDeployDefault.OneAtATime returns a minimum
             * healthy instance type of MOST_CONCURRENCY and a value of 1. This means a deployment
             * to only one instance at a time. (You cannot set the type to MOST_CONCURRENCY, only to
             * HOST_COUNT or FLEET_PERCENT.) In addition, with CodeDeployDefault.OneAtATime, AWS
             * CodeDeploy attempts to ensure that all instances but one are kept in a healthy state
             * during the deployment. Although this allows one instance at a time to be taken
             * offline for a new deployment, it also means that if the deployment to the last
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: MinimumHealthyHostsProperty
            ): software.amazon.awscdk.services.codedeploy.CfnDeploymentConfig.MinimumHealthyHostsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface MinimumHealthyHostsPerZoneProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: MinimumHealthyHostsPerZoneProperty
            ): software.amazon.awscdk.services.codedeploy.CfnDeploymentConfig.MinimumHealthyHostsPerZoneProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface TrafficRoutingConfigProperty {
        ...
        public interface Builder {
            /**
             * @param timeBasedCanary A configuration that shifts traffic from one version of a
             *   Lambda function or ECS task set to another in two increments. The original and
             *   target Lambda function versions or ECS task sets are specified in the deployment's
             *   AppSpec file.
             */
            ...
            /**
             * @param timeBasedLinear A configuration that shifts traffic from one version of a
             *   Lambda function or Amazon ECS task set to another in equal increments, with an
             *   equal number of minutes between each increment. The original and target Lambda
             *   function versions or Amazon ECS task sets are specified in the deployment's AppSpec
             *   file.
             */
            ...
            /**
             * @param type The type of traffic shifting ( `TimeBasedCanary` or `TimeBasedLinear` )
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("32115ce6e20e117c8f464c1a8cda6c2d27b8944c439b7ad12d2637c1b9038c35")
            override fun timeBasedCanary(
                timeBasedCanary: TimeBasedCanaryProperty.Builder.() -> Unit
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("5ed05caad02b178f12e9a278512f7f6967e67dc19d57dcbdc419a042bcafa27f")
            override fun timeBasedLinear(
                timeBasedLinear: TimeBasedLinearProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * each increment.
             *
             * The original and target Lambda function versions or Amazon ECS task sets are
    ...
    public interface TimeBasedLinearProperty {
        ...
        public interface Builder {
            /**
             * @param linearInterval The number of minutes between each incremental traffic shift of
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TimeBasedLinearProperty
            ): software.amazon.awscdk.services.codedeploy.CfnDeploymentConfig.TimeBasedLinearProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface TimeBasedCanaryProperty {
        ...
        public interface Builder {
            /**
             * @param canaryInterval The number of minutes between the first and second traffic
             *   shifts of a `TimeBasedCanary` deployment.
             */
            public fun canaryInterval(canaryInterval: Number)

            /**
             * @param canaryPercentage The percentage of traffic to shift in the first increment of
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TimeBasedCanaryProperty
            ): software.amazon.awscdk.services.codedeploy.CfnDeploymentConfig.TimeBasedCanaryProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
