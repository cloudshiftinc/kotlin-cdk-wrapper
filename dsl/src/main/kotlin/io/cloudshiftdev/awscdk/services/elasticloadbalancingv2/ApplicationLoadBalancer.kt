...
internal constructor(
     ...
     * @param props
     */
    public override fun addListener(
        id: String,
    ...
    public open fun addRedirect(props: ApplicationLoadBalancerRedirectConfig): ApplicationListener =
        unwrap(this)
            .addRedirect(props.let(ApplicationLoadBalancerRedirectConfig::unwrap))
            .let(ApplicationListener::wrap)
    ...
    public open fun addRedirect(
        props: ApplicationLoadBalancerRedirectConfig.Builder.() -> Unit
    ...
    public open fun metricClientTlsNegotiationErrorCount(props: MetricOptions): Metric =
        unwrap(this)
            .metricClientTlsNegotiationErrorCount(props.let(MetricOptions::unwrap))
            .let(Metric::wrap)
    ...
    public open fun metricClientTlsNegotiationErrorCount(
     ...
     */
    @Deprecated(message = "deprecated in CDK")
    public open fun metricConsumedLcUs(): Metric =
        unwrap(this).metricConsumedLCUs().let(Metric::wrap)
     ...
     * connection with the IdP, or the load balancer couldn't complete the authentication flow due
     ...
     */
    @Deprecated(message = "deprecated in CDK")
    public open fun metricElbAuthError(): Metric =
        unwrap(this).metricElbAuthError().let(Metric::wrap)
     ...
     *
     * This metric is incremented at the end of the authentication workflow, after the load balancer
     * has retrieved the user claims from the IdP.
     *
     * Default: Sum over 5 minutes
     *
     * @param props
    ...
    public open fun metricHttpCodeElb(code: HttpCodeElb, props: MetricOptions): Metric =
        unwrap(this)
            .metricHttpCodeElb(code.let(HttpCodeElb::unwrap), props.let(MetricOptions::unwrap))
            .let(Metric::wrap)
    ...
    public open fun metricHttpCodeElb(
        code: HttpCodeElb,
        props: MetricOptions.Builder.() -> Unit
    ): Metric = metricHttpCodeElb(code, MetricOptions(props))

    /**
     * (deprecated) The number of HTTP 2xx/3xx/4xx/5xx response codes generated by all targets in
     * the load balancer.
     *
    ...
    public open fun metricHttpCodeTarget(code: HttpCodeTarget, props: MetricOptions): Metric =
        unwrap(this)
            .metricHttpCodeTarget(
                code.let(HttpCodeTarget::unwrap),
    ...
    public open fun metricHttpCodeTarget(
        code: HttpCodeTarget,
        props: MetricOptions.Builder.() -> Unit
    ): Metric = metricHttpCodeTarget(code, MetricOptions(props))
    ...
    public open fun metricHttpFixedResponseCount(props: MetricOptions): Metric =
        unwrap(this)
            .metricHttpFixedResponseCount(props.let(MetricOptions::unwrap))
            .let(Metric::wrap)
    ...
    public open fun metricHttpRedirectUrlLimitExceededCount(props: MetricOptions): Metric =
        unwrap(this)
            .metricHttpRedirectUrlLimitExceededCount(props.let(MetricOptions::unwrap))
            .let(Metric::wrap)
    ...
    public open fun metricHttpRedirectUrlLimitExceededCount(
        props: MetricOptions.Builder.() -> Unit
    ...
    /**
     * (deprecated) The number of connections that were rejected because the load balancer had
    ...
    public open fun metricRejectedConnectionCount(props: MetricOptions): Metric =
        unwrap(this)
            .metricRejectedConnectionCount(props.let(MetricOptions::unwrap))
            .let(Metric::wrap)
     ...
     */
    @Deprecated(message = "deprecated in CDK")
    public open fun metricRequestCount(): Metric =
        unwrap(this).metricRequestCount().let(Metric::wrap)
    ...
    /**
     * (deprecated) The number of connections that were not successfully established between the
    ...
    public open fun metricTargetConnectionErrorCount(props: MetricOptions): Metric =
        unwrap(this)
            .metricTargetConnectionErrorCount(props.let(MetricOptions::unwrap))
            .let(Metric::wrap)
    ...
    public open fun metricTargetConnectionErrorCount(
        props: MetricOptions.Builder.() -> Unit
    ): Metric = metricTargetConnectionErrorCount(MetricOptions(props))
    ...
    public open fun metricTargetTlsNegotiationErrorCount(props: MetricOptions): Metric =
        unwrap(this)
            .metricTargetTLSNegotiationErrorCount(props.let(MetricOptions::unwrap))
            .let(Metric::wrap)
    ...
    public open fun metricTargetTlsNegotiationErrorCount(
        props: MetricOptions.Builder.() -> Unit
    ...
    public interface Builder {
         ...
         *
         * @param desyncMitigationMode Determines how the load balancer handles requests that might
         ...
         * balancer (true) or routed to targets (false).
         *
         * Default: false
         *
         * @param dropInvalidHeaderFields Indicates whether HTTP headers with invalid header fields
         *   are removed by the load balancer (true) or routed to targets (false).
         */
    ...
    public companion object {
        public fun fromApplicationLoadBalancerAttributes(
            ...
            software.amazon.awscdk.services.elasticloadbalancingv2.ApplicationLoadBalancer
                .fromApplicationLoadBalancerAttributes(
                    ...
                    id,
                    attrs.let(ApplicationLoadBalancerAttributes::unwrap)
                )
                .let(IApplicationLoadBalancer::wrap)
        ...
        public fun fromLookup(
            ...
            software.amazon.awscdk.services.elasticloadbalancingv2.ApplicationLoadBalancer
                .fromLookup(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    options.let(ApplicationLoadBalancerLookupOptions::unwrap)
                )
                .let(IApplicationLoadBalancer::wrap)
        ...
        public fun fromLookup(
            ...
            fromLookup(scope, id, ApplicationLoadBalancerLookupOptions(options))
        ...
        internal fun unwrap(
            wrapped: ApplicationLoadBalancer
        ): software.amazon.awscdk.services.elasticloadbalancingv2.ApplicationLoadBalancer =
            wrapped.cdkObject
    }
}
