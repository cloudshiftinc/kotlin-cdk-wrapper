...
internal constructor(
     ...
     * @param props
     */
    public override fun addContainer(
        id: String,
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.ecs.Ec2TaskDefinition =
            cdkBuilder.build()
    }
    ...
    public companion object {
        public fun fromEc2TaskDefinitionArn(
            ...
            software.amazon.awscdk.services.ecs.Ec2TaskDefinition.fromEc2TaskDefinitionArn(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    ec2TaskDefinitionArn
                )
                .let(IEc2TaskDefinition::wrap)
        ...
        public fun fromEc2TaskDefinitionAttributes(
            ...
            software.amazon.awscdk.services.ecs.Ec2TaskDefinition.fromEc2TaskDefinitionAttributes(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    attrs.let(Ec2TaskDefinitionAttributes::unwrap)
                )
                .let(IEc2TaskDefinition::wrap)
        ...
        public fun fromEc2TaskDefinitionAttributes(
            ...
            fromEc2TaskDefinitionAttributes(scope, id, Ec2TaskDefinitionAttributes(attrs))
