...
public open class NodejsFunction
internal constructor(
    ...
    public interface Builder {
        ...
        /**
         * Whether to automatically reuse TCP connections when working with the AWS SDK for
         * JavaScript.
         *
         ...
         *
         * @param awsSdkConnectionReuse Whether to automatically reuse TCP connections when working
         *   with the AWS SDK for JavaScript.
         */
         ...
         * Bundling options.
         *
         * Default: - use default bundling options: no minify, no sourcemap, all modules are
         * bundled.
         *
         ...
         *
         * Modules specified in `nodeModules` will be installed using the right installer (`yarn`,
         * `pnpm` or `npm`) along with this lock file.
         *
         * Default: - the path is found by walking up parent directories searching for a
         * `yarn.lock`, `pnpm-lock.yaml` or `package-lock.json` file
         *
         ...
         * `NodejsFunction` is defined in `stack.ts` with `my-handler` as id (`new
         * NodejsFunction(this, 'my-handler')`), the construct will look at `stack.my-handler.ts`
         ...
         *
         * @param projectRoot The path to the directory containing project config files
         ...
         *
         * Default: `Runtime.NODEJS_LATEST` if the
         * `@aws-cdk/aws-lambda-nodejs:useLatestRuntimeVersion` feature flag is enabled, otherwise
         * `Runtime.NODEJS_16_X`
         *
