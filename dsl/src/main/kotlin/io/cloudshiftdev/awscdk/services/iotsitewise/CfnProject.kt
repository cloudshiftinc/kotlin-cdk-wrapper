...
internal constructor(
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.iotsitewise.CfnProject =
            cdkBuilder.build()
    }
    ...
    public companion object {
        ...
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.iotsitewise.CfnProject
        ): CfnProject = CfnProject(cdkObject)

        internal fun unwrap(
            wrapped: CfnProject
        ): software.amazon.awscdk.services.iotsitewise.CfnProject = wrapped.cdkObject
    }
}
