...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.ecr.RepositoryBase,
     ...
     * @param options Options for adding the rule.
     */
    public override fun onCloudTrailImagePushed(
        id: String,
    ...
    /**
     * Defines an AWS CloudWatch event rule that can trigger a target when an image scan is
     * completed.
     *
     * @param id The id of the rule.
     * @param options Options for adding the rule.
     ...
     * @param options Options for adding the rule.
     */
    public override fun onImageScanCompleted(
        id: String,
    ...
    internal constructor(
        internal val cdkObject: software.amazon.awscdk.services.ecr.RepositoryBase,
    ...
    public companion object {
        ...
        ): RepositoryBase = Wrapper(cdkObject)

        internal fun unwrap(
            wrapped: RepositoryBase
        ): software.amazon.awscdk.services.ecr.RepositoryBase = (wrapped as Wrapper).cdkObject
    }
}
