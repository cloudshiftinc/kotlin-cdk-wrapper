...
internal constructor(
    ...
    public open fun buildBatchConfig(
        `value`: ProjectBuildBatchConfigProperty.Builder.() -> Unit
    ...
    public interface Builder {
         ...
         * `Artifacts` is a property of the
         * [AWS::CodeBuild::Project](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-codebuild-project.html)
         * resource that specifies output settings for artifacts generated by an AWS CodeBuild
         * build.
         *
         ...
         *
         * @param badgeEnabled Indicates whether AWS CodeBuild generates a publicly accessible URL
        ...
        public fun buildBatchConfig(
            buildBatchConfig: ProjectBuildBatchConfigProperty.Builder.() -> Unit
        )
         ...
         *
         * @param concurrentBuildLimit The maximum number of concurrent builds that are allowed for
         *   this project.
         */
        ...
        /**
         * The AWS Key Management Service customer master key (CMK) to be used for encrypting the
         ...
         * CMK's alias (using the format `alias/&lt;alias-name&gt;` ). If you don't specify a value,
         ...
         *
         * @param encryptionKey The AWS Key Management Service customer master key (CMK) to be used
         ...
         *
         * @param environment The build environment settings for the project, such as the
         *   environment type or the environment variables to use for the build environment.
         */
         ...
         *
         * @param fileSystemLocations An array of `ProjectFileSystemLocation` objects for a
         ...
         *
         * @param queuedTimeoutInMinutes The number of minutes a build is allowed to be queued
         *   before it times out.
         */
         ...
         * A list of `Artifacts` objects.
         *
         * Each artifacts object specifies output settings that the project generates during a
         * build.
         *
         ...
         *
         * @param source The source code settings for the project, such as the source code's
         ...
         *
         * @param timeoutInMinutes How long, in minutes, from 5 to 480 (8 hours), for AWS CodeBuild
         ...
         *
         * @param triggers For an existing AWS CodeBuild build project that has its source code
         *   stored in a GitHub repository, enables AWS CodeBuild to begin automatically rebuilding
         ...
         *
         * @param vpcConfig `VpcConfig` specifies settings that enable AWS CodeBuild to access
    ...
    private class BuilderImpl(
        ...
        override fun buildBatchConfig(buildBatchConfig: ProjectBuildBatchConfigProperty) {
            cdkBuilder.buildBatchConfig(
                buildBatchConfig.let(ProjectBuildBatchConfigProperty::unwrap)
            )
        }
        ...
        public fun build(): software.amazon.awscdk.services.codebuild.CfnProject =
            cdkBuilder.build()
    }
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnProject
        ): software.amazon.awscdk.services.codebuild.CfnProject = wrapped.cdkObject
    }
    ...
    public interface ProjectCacheProperty {
         ...
         *   the cache is created, subsequent builds pull only the change between commits. This mode
         *   is a good choice for projects with a clean working directory and a source that is a
        ...
        public interface Builder {
            ...
            /**
             * @param modes An array of strings that specify the local cache modes. You can use one
             *   or more local cache modes at the same time. This is only used for `LOCAL` cache
             *   types.
             *
             * Possible values are:
             * * **LOCAL_SOURCE_CACHE** - Caches Git metadata for primary and secondary sources.
             ...
             *   that is a large Git repository. If you choose this option and your project does not
             *   use a Git repository (GitHub, GitHub Enterprise, or Bitbucket), the option is
             *   ignored.
             * * **LOCAL_DOCKER_LAYER_CACHE** - Caches existing Docker layers. This mode is a good
             *   choice for projects that build or pull large Docker images. It can prevent the
             *   performance issues caused by pulling large Docker images down from the network.
    ...
    public interface CloudWatchLogsConfigProperty {
        ...
        public interface Builder {
            /**
             * @param groupName The group name of the logs in CloudWatch Logs. For more information,
             *   see
             *   [Working with Log Groups and Log Streams](https://docs.aws.amazon.com/AmazonCloudWatch/latest/logs/Working-with-log-groups-and-streams.html)
             *   .
             */
            ...
            /**
             * @param status The current status of the logs in CloudWatch Logs for a build project.
             *   Valid values are:.
             * * `ENABLED` : CloudWatch Logs are enabled for this build project.
             * * `DISABLED` : CloudWatch Logs are not enabled for this build project.
             */
            ...
            /**
             * @param streamName The prefix of the stream name of the CloudWatch Logs. For more
             *   information, see
             *   [Working with Log Groups and Log Streams](https://docs.aws.amazon.com/AmazonCloudWatch/latest/logs/Working-with-log-groups-and-streams.html)
             *   .
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CloudWatchLogsConfigProperty
            ): software.amazon.awscdk.services.codebuild.CfnProject.CloudWatchLogsConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ArtifactsProperty {
         ...
         *
         * If you specify `CODEPIPELINE` or `NO_ARTIFACTS` for the `Type` property, don't specify
         * this property. For all of the other types, you must specify this property.
         *
         ...
         *   the name to be a forward slash ("/"), the artifact is stored in the root of the output
         *   bucket.
         *
         * For example:
         * * If `path` is set to `MyArtifacts` , `namespaceType` is set to `BUILD_ID` , and `name`
         *   is set to `MyArtifact.zip` , then the output artifact is stored in `MyArtifacts/
         *   *build-ID* /MyArtifact.zip` .
         * * If `path` is empty, `namespaceType` is set to `NONE` , and `name` is set to " `/` ",
         *   the output artifact is stored in the root of the output bucket.
         * * If `path` is set to `MyArtifacts` , `namespaceType` is set to `BUILD_ID` , and `name`
         *   is set to " `/` ", the output artifact is stored in `MyArtifacts/ *build-ID*` .
         *
         * If you specify `CODEPIPELINE` or `NO_ARTIFACTS` for the `Type` property, don't specify
         * this property. For all of the other types, you must specify this property.
         *
        ...
        public interface Builder {
            ...
            /**
             * @param encryptionDisabled Set to true if you do not want your output artifacts
             *   encrypted. This option is valid only if your artifacts type is Amazon Simple
             *   Storage Service (Amazon S3). If this is set with another artifacts type, an
             ...
             *   specified. This is because CodePipeline manages its build output locations instead
             *   of CodeBuild .
             * * If `type` is set to `NO_ARTIFACTS` , this value is ignored if specified, because no
             *   build output is produced.
             * * If `type` is set to `S3` , this is the name of the output bucket.
             *
             * If you specify `CODEPIPELINE` or `NO_ARTIFACTS` for the `Type` property, don't
             * specify this property. For all of the other types, you must specify this property.
             */
            public fun location(location: String)

            /**
             * @param name Along with `path` and `namespaceType` , the pattern that AWS CodeBuild
             ...
             *   ", the output artifact is stored in the root of the output bucket.
             * * If `path` is set to `MyArtifacts` , `namespaceType` is set to `BUILD_ID` , and
             *   `name` is set to " `/` ", the output artifact is stored in `MyArtifacts/
             *   *build-ID*` .
             *
             * If you specify `CODEPIPELINE` or `NO_ARTIFACTS` for the `Type` property, don't
             * specify this property. For all of the other types, you must specify this property.
            ...
            /**
             * @param namespaceType Along with `path` and `name` , the pattern that AWS CodeBuild
             *   uses to determine the name and location to store the output artifact: - If `type`
             *   is set to `CODEPIPELINE` , CodePipeline ignores this value if specified. This is
            ...
            /**
             * @param overrideArtifactName If set to true a name specified in the buildspec file
             *   overrides the artifact name. The name specified in a buildspec file is calculated
             *   at build time and uses the Shell command language. For example, you can append a
             ...
             *   This is because CodePipeline manages its build output artifacts instead of AWS
             *   CodeBuild .
             * * If `type` is set to `NO_ARTIFACTS` , this value is ignored if specified, because no
             *   build output is produced.
             * * If `type` is set to `S3` , valid values include:
            ...
            /**
             * @param path Along with `namespaceType` and `name` , the pattern that AWS CodeBuild
             *   uses to name and store the output artifact:.
             * * If `type` is set to `CODEPIPELINE` , CodePipeline ignores this value if specified.
             *   This is because CodePipeline manages its build output names instead of AWS
             *   CodeBuild .
             * * If `type` is set to `NO_ARTIFACTS` , this value is ignored if specified, because no
             *   build output is produced.
        ...
        internal constructor(
             ...
             * Set to true if you do not want your output artifacts encrypted.
             *
             * This option is valid only if your artifacts type is Amazon Simple Storage Service
             * (Amazon S3). If this is set with another artifacts type, an `invalidInputException`
             * is thrown.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-codebuild-project-artifacts.html#cfn-codebuild-project-artifacts-encryptiondisabled)
             */
             ...
             * name and location to store the output artifact: - If `type` is set to `CODEPIPELINE`
             * , CodePipeline ignores this value if specified.
             *
             * This is because CodePipeline manages its build output names instead of AWS CodeBuild
             * .
             ...
             *
             * The name specified in a buildspec file is calculated at build time and uses the Shell
             * command language. For example, you can append a date and time to your artifact name
    ...
    public interface BuildStatusConfigProperty {
        ...
        public interface Builder {
            /**
             * @param context Specifies the context of the build status CodeBuild sends to the
             *   source provider. The usage of this parameter depends on the source provider.
             * * **Bitbucket** - This parameter is used for the `name` parameter in the Bitbucket
            ...
            /**
             * @param targetUrl Specifies the target url of the build status CodeBuild sends to the
             *   source provider. The usage of this parameter depends on the source provider.
             * * **Bitbucket** - This parameter is used for the `url` parameter in the Bitbucket
             *   commit status. For more information, see
             *   [build](https://docs.aws.amazon.com/https://developer.atlassian.com/bitbucket/api/2/reference/resource/repositories/%7Bworkspace%7D/%7Brepo_slug%7D/commit/%7Bnode%7D/statuses/build)
             *   in the Bitbucket API documentation.
             * * **GitHub/GitHub Enterprise Server** - This parameter is used for the `target_url`
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: BuildStatusConfigProperty
            ): software.amazon.awscdk.services.codebuild.CfnProject.BuildStatusConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface BatchRestrictionsProperty {
         ...
         */
        public fun computeTypesAllowed(): List<String> =
        ...
        public interface Builder {
            /**
             * @param computeTypesAllowed An array of strings that specify the compute types that
             *   are allowed for the batch build. See
             *   [Build environment compute types](https://docs.aws.amazon.com/codebuild/latest/userguide/build-env-ref-compute-types.html)
             *   in the *AWS CodeBuild User Guide* for these values.
             */
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-codebuild-project-batchrestrictions.html#cfn-codebuild-project-batchrestrictions-computetypesallowed)
             */
            override fun computeTypesAllowed(): List<String> =
                unwrap(this).getComputeTypesAllowed() ?: emptyList()
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: BatchRestrictionsProperty
            ): software.amazon.awscdk.services.codebuild.CfnProject.BatchRestrictionsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ProjectBuildBatchConfigProperty {
        ...
        public interface Builder {
            /**
             * @param batchReportMode Specifies how build status reports are sent to the source
             *   provider for the batch build. This property is only used when the source provider
             *   for your project is Bitbucket, GitHub, or GitHub Enterprise, and your project is
            ...
            /**
             * @param combineArtifacts Specifies if the build artifacts for the batch build should
            ...
            /**
             * @param restrictions A `BatchRestrictions` object that specifies the restrictions for
             *   the batch build.
             */
            ...
            /**
             * @param timeoutInMins Specifies the maximum amount of time, in minutes, that the batch
        ...
        private class BuilderImpl : Builder {
            ...
            override fun restrictions(
                restrictions: BatchRestrictionsProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ProjectBuildBatchConfigProperty
            ): software.amazon.awscdk.services.codebuild.CfnProject.ProjectBuildBatchConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface EnvironmentProperty {
         ...
         *   you modify your ECR repository policy to trust AWS CodeBuild service principal.
         ...
         *   available only in regions US East (N. Virginia), US East (Ohio), US West (Oregon), and
         *   EU (Ireland).
         *
        ...
        public interface Builder {
             ...
             *   contains the PEM-encoded certificate for the build project. For more information,
             *   see
             *   [certificate](https://docs.aws.amazon.com/codebuild/latest/userguide/create-project-cli.html#cli.environment.certificate)
             *   in the *AWS CodeBuild User Guide* .
             */
            ...
            /**
             * @param computeType The type of compute environment. This determines the number of CPU
             *   cores and memory the build environment uses. Available values include:
             * * `BUILD_GENERAL1_SMALL` : Use up to 3 GB memory and 2 vCPUs for builds.
             * * `BUILD_GENERAL1_MEDIUM` : Use up to 7 GB memory and 4 vCPUs for builds.
             * * `BUILD_GENERAL1_LARGE` : Use up to 15 GB memory and 8 vCPUs for builds.
             *
            ...
            /**
             * @param environmentVariables A set of environment variables to make available to
             *   builds for this build project.
             */
            ...
            /**
             * @param image The image tag or image digest that identifies the Docker image to use
            ...
            /**
             * @param imagePullCredentialsType The type of credentials AWS CodeBuild uses to pull
             ...
             *   that you modify your ECR repository policy to trust AWS CodeBuild service
             *   principal.
             * * `SERVICE_ROLE` specifies that AWS CodeBuild uses your build project's service role.
             *
             * When you use a cross-account or private registry image, you must use SERVICE_ROLE
             ...
             *   build that attempts to interact with the Docker daemon fails. The default setting
             *   is `false` .
             *
             ...
             *   [AWS::CodeBuild::Project Environment](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-codebuild-project.html#cfn-codebuild-project-environment)
             *   property that specifies information about credentials that provide access to a
             *   private Docker registry. When this is set:.
             * * `imagePullCredentialsType` must be set to `SERVICE_ROLE` .
             * * images cannot be curated or an Amazon ECR image.
             */
            ...
            public fun registryCredential(
                registryCredential: RegistryCredentialProperty.Builder.() -> Unit
            )
             ...
             *   available only in regions US East (N. Virginia), US East (Ohio), US West (Oregon),
             *   Asia Pacific (Mumbai), Asia Pacific (Singapore), Asia Pacific (Sydney), Asia
             *   Pacific (Tokyo), EU (Frankfurt), EU (Ireland), and South America (São Paulo).
             * * The environment types `WINDOWS_CONTAINER` and `WINDOWS_SERVER_2019_CONTAINER` are
             *   available only in regions US East (N. Virginia), US East (Ohio), US West (Oregon),
             *   and EU (Ireland).
             *
        ...
        private class BuilderImpl : Builder {
            ...
            override fun registryCredential(registryCredential: RegistryCredentialProperty) {
                cdkBuilder.registryCredential(
                    registryCredential.let(RegistryCredentialProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("550b36dfb3bd161ec105f2283a291b87853a40432119e8c4f5a2eb853bcf69be")
            override fun registryCredential(
                registryCredential: RegistryCredentialProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-codebuild-project-environment.html#cfn-codebuild-project-environment-imagepullcredentialstype)
             */
            override fun imagePullCredentialsType(): String? =
    ...
    public interface EnvironmentVariableProperty {
         ...
         *   For environment variables of this type, specify the name of the parameter as the
         *   `value` of the EnvironmentVariable. The parameter value will be substituted for the
         *   name at runtime. You can also define Parameter Store environment variables in the
         *   buildspec. To learn how to do so, see
         ...
         *   environment variables of this type, specify the name of the secret as the `value` of
         *   the EnvironmentVariable. The secret value will be substituted for the name at runtime.
         *   You can also define AWS Secrets Manager environment variables in the buildspec. To
         ...
         * values, especially AWS secret key IDs. `PLAINTEXT` environment variables can be displayed
         * in plain text using the AWS CodeBuild console and the AWS CLI . For sensitive values, we
        ...
        public interface Builder {
             ...
             *   the `value` of the EnvironmentVariable. The parameter value will be substituted for
             *   the name at runtime. You can also define Parameter Store environment variables in
             *   the buildspec. To learn how to do so, see
             *   [env/parameter-store](https://docs.aws.amazon.com/codebuild/latest/userguide/build-spec-ref.html#build-spec.env.parameter-store)
             *   in the *AWS CodeBuild User Guide* .
             * * `PLAINTEXT` : An environment variable in plain text format. This is the default
             *   value.
             * * `SECRETS_MANAGER` : An environment variable stored in AWS Secrets Manager . For
             *   environment variables of this type, specify the name of the secret as the `value`
             *   of the EnvironmentVariable. The secret value will be substituted for the name at
             *   runtime. You can also define AWS Secrets Manager environment variables in the
             *   buildspec. To learn how to do so, see
             *   [env/secrets-manager](https://docs.aws.amazon.com/codebuild/latest/userguide/build-spec-ref.html#build-spec.env.secrets-manager)
             *   in the *AWS CodeBuild User Guide* .
             */
             ...
             * sensitive values, especially AWS secret key IDs. `PLAINTEXT` environment variables
             * can be displayed in plain text using the AWS CodeBuild console and the AWS CLI . For
    ...
    public interface LogsConfigProperty {
        ...
        public interface Builder {
            ...
            public fun cloudWatchLogs(
                cloudWatchLogs: CloudWatchLogsConfigProperty.Builder.() -> Unit
            )

            /**
             * @param s3Logs Information about logs built to an S3 bucket for a build project. S3
    ...
    public interface RegistryCredentialProperty {
        ...
        public interface Builder {
            /**
             * @param credential The Amazon Resource Name (ARN) or name of credentials created using
             *   AWS Secrets Manager .
             *
            ...
            /**
             * @param credentialProvider The service that created the credentials to access a
             *   private Docker registry. The valid value, SECRETS_MANAGER, is for AWS Secrets
             *   Manager .
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RegistryCredentialProperty
            ): software.amazon.awscdk.services.codebuild.CfnProject.RegistryCredentialProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ProjectTriggersProperty {
        ...
        public interface Builder {
            /**
             * @param buildType Specifies the type of build this webhook will trigger. Allowed
             *   values are:.
             * * **BUILD** - A single build
             * * **BUILD_BATCH** - A batch build
             */
            ...
            /**
             * @param filterGroups A list of lists of `WebhookFilter` objects used to determine
             *   which webhook events are triggered. At least one `WebhookFilter` in the array must
            ...
            /**
             * @param webhook Specifies whether or not to begin automatically rebuilding the source
        ...
        internal constructor(
            ...
            /**
             * Specifies whether or not to begin automatically rebuilding the source code every time
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ProjectTriggersProperty
            ): software.amazon.awscdk.services.codebuild.CfnProject.ProjectTriggersProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface GitSubmodulesConfigProperty {
        ...
        public interface Builder {
            /**
             * @param fetchSubmodules Set to true to fetch Git submodules for your AWS CodeBuild
             *   build project.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: GitSubmodulesConfigProperty
            ): software.amazon.awscdk.services.codebuild.CfnProject.GitSubmodulesConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface S3LogsConfigProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param location The ARN of an S3 bucket and the path prefix for S3 logs. If your
             *   Amazon S3 bucket name is `my-bucket` , and your path prefix is `build-log` , then
             *   acceptable formats are `my-bucket/build-log` or `arn:aws:s3:::my-bucket/build-log`
             *   .
             */
            public fun location(location: String)
        ...
        internal constructor(
             ...
             * The ARN of an S3 bucket and the path prefix for S3 logs.
             *
             * If your Amazon S3 bucket name is `my-bucket` , and your path prefix is `build-log` ,
             * then acceptable formats are `my-bucket/build-log` or
    ...
    public interface ProjectFileSystemLocationProperty {
         ...
         * is `fs-abcd1234.efs.us-west-2.amazonaws.com` , and its mount directory is
        ...
        public interface Builder {
            ...
            /**
             * @param location A string that specifies the location of the file system created by
             *   Amazon EFS. Its format is `efs-dns-name:/directory-path` . You can find the DNS
             *   name of file system when you view it in the Amazon EFS console. The directory path
             *   is a path to a directory in the file system that CodeBuild mounts. For example, if
             *   the DNS name of a file system is `fs-abcd1234.efs.us-west-2.amazonaws.com` , and
             *   its mount directory is `my-efs-mount-directory` , then the `location` is
             *   `fs-abcd1234.efs.us-west-2.amazonaws.com:/my-efs-mount-directory` .
             *
             * The directory path in the format `efs-dns-name:/directory-path` is optional. If you
             * do not specify a directory path, the location is only the DNS name and CodeBuild
             * mounts the entire file system.
             */
            public fun location(location: String)

            /**
             * @param mountOptions The mount options for a file system created by Amazon EFS. The
        ...
        internal constructor(
             ...
             * file system is `fs-abcd1234.efs.us-west-2.amazonaws.com` , and its mount directory is
             * `my-efs-mount-directory` , then the `location` is
             * `fs-abcd1234.efs.us-west-2.amazonaws.com:/my-efs-mount-directory` .
             *
             * The directory path in the format `efs-dns-name:/directory-path` is optional. If you
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ProjectFileSystemLocationProperty
            ): software.amazon.awscdk.services.codebuild.CfnProject.ProjectFileSystemLocationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ProjectSourceVersionProperty {
        ...
        public interface Builder {
            /**
             * @param sourceIdentifier An identifier for a source in the build project. The
             *   identifier can only contain alphanumeric characters and underscores, and must be
             ...
             *   ID is specified, it must use the format `pr/pull-request-ID` (for example, `pr/25`
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ProjectSourceVersionProperty
            ): software.amazon.awscdk.services.codebuild.CfnProject.ProjectSourceVersionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface WebhookFilterProperty {
         ...
         * build.
         *
         * If true, then a webhook event that does not match the `pattern` triggers a build. If
         * false, then a webhook event that matches the `pattern` triggers a build.
         *
         ...
         *
         * There are six webhook filter types: `EVENT` , `ACTOR_ACCOUNT_ID` , `HEAD_REF` ,
         ...
         *   PULL_REQUEST_UPDATED` filters all push, pull request created, and pull request updated
         *   events.
         *
         ...
         * GitHub Enterprise push events, but does not work with GitHub Enterprise pull request
         * events.
         * * **COMMIT_MESSAGE** - A webhook triggers a build when the head commit message matches
        ...
        public interface Builder {
            /**
             * @param excludeMatchedPattern Used to indicate that the `pattern` determines which
             *   webhook events do not trigger a build. If true, then a webhook event that does not
             *   match the `pattern` triggers a build. If false, then a webhook event that matches
            ...
            /**
             * @param pattern For a `WebHookFilter` that uses `EVENT` type, a comma-separated string
             ...
             *   one of five event types: `PUSH` , `PULL_REQUEST_CREATED` , `PULL_REQUEST_UPDATED` ,
             *   `PULL_REQUEST_REOPENED` , and `PULL_REQUEST_MERGED` . The `EVENT` patterns are
             *   specified as a comma-separated string. For example, `PUSH, PULL_REQUEST_CREATED,
    ...
    public interface VpcConfigProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param subnets A list of one or more subnet IDs in your Amazon VPC. The maximum count
             *   is 16.
             */
    ...
    public interface SourceProperty {
         ...
         * `buildspec.yml` at the root level. If this value is provided, it can be either a single
         * string containing the entire build specification, or the path to an alternate buildspec
         * file relative to the value of the built-in environment variable `CODEBUILD_SRC_DIR` . The
         * alternate buildspec file can have a name other than `buildspec.yml` , for example
         * `myspec.yml` or `build_spec_qa.yml` or similar. For more information, see the
         ...
         * history is downloaded with each build project. If your source type is Amazon S3, this
         ...
         * repository. The default value is `false` . `InsecureSsl` should be used for testing
         ...
         *   CodePipeline, `location` should not be specified. If it is specified, CodePipeline
         ...
         *   instruct AWS CodeBuild to use this connection, in the `source` object, set the `auth`
         ...
         *   `OAUTH` .
         *
         * If you specify `CODEPIPELINE` for the `Type` property, don't specify this property. For
         * all of the other types, you must specify `Location` .
         *
        ...
        public interface Builder {
            /**
             * @param auth Information about the authorization settings for AWS CodeBuild to access
             *   the source code to be built. This information is for the AWS CodeBuild console's
             *   use only. Your code should not get or set `Auth` directly.
             */
            ...
            /**
             * @param buildSpec The build specification for the project. If this value is not
             *   provided, then the source code must contain a buildspec file named `buildspec.yml`
             *   at the root level. If this value is provided, it can be either a single string
             *   containing the entire build specification, or the path to an alternate buildspec
             *   file relative to the value of the built-in environment variable `CODEBUILD_SRC_DIR`
             *   . The alternate buildspec file can have a name other than `buildspec.yml` , for
             *   example `myspec.yml` or `build_spec_qa.yml` or similar. For more information, see
             *   the
             *   [Build Spec Reference](https://docs.aws.amazon.com/codebuild/latest/userguide/build-spec-ref.html#build-spec-ref-example)
             *   in the *AWS CodeBuild User Guide* .
             */
            ...
            /**
             * @param buildStatusConfig Contains information that defines how the build project
            ...
            public fun buildStatusConfig(
                buildStatusConfig: BuildStatusConfigProperty.Builder.() -> Unit
            )

            /**
             * @param gitCloneDepth The depth of history to download. Minimum value is 0. If this
             *   value is 0, greater than 25, or not provided, then the full history is downloaded
             *   with each build project. If your source type is Amazon S3, this value is not
             *   supported.
             */
            public fun gitCloneDepth(gitCloneDepth: Number)

            /**
             * @param gitSubmodulesConfig Information about the Git submodules configuration for the
             *   build project.
             */
            ...
            public fun gitSubmodulesConfig(
                gitSubmodulesConfig: GitSubmodulesConfigProperty.Builder.() -> Unit
            )

            /**
             * @param insecureSsl This is used with GitHub Enterprise only. Set to true to ignore
             *   SSL warnings while connecting to your GitHub Enterprise project repository. The
             *   default value is `false` . `InsecureSsl` should be used for testing purposes only.
            ...
            /**
             * @param location Information about the location of the source code to be built. Valid
             *   values include:.
             * * For source code settings that are specified in the source action of a pipeline in
             *   CodePipeline, `location` should not be specified. If it is specified, CodePipeline
             *   ignores it. This is because CodePipeline uses the settings in a pipeline's source
             ...
             *   access* next to each repository you want to allow AWS CodeBuild to have access to,
             ...
             *   to your Bitbucket account. Use the AWS CodeBuild console to start creating a build
             ...
             *   build project. You can leave the AWS CodeBuild console.) To instruct AWS CodeBuild
            ...
            /**
             * @param reportBuildStatus Set to true to report the status of a build's start and
             *   finish to your source provider. This option is valid only when your source provider
             *   is GitHub, GitHub Enterprise, or Bitbucket. If this is set and you use a different
            ...
            /**
             * @param sourceIdentifier An identifier for this project source. The identifier can
             *   only contain alphanumeric characters and underscores, and must be less than 128
             *   characters in length.
             */
            public fun sourceIdentifier(sourceIdentifier: String)

            /**
             * @param type The type of repository that contains the source code to be built. Valid
             *   values include:.
             * * `BITBUCKET` : The source code is in a Bitbucket repository.
             * * `CODECOMMIT` : The source code is in an CodeCommit repository.
             * * `CODEPIPELINE` : The source code settings are specified in the source action of a
        ...
        private class BuilderImpl : Builder {
            ...
            override fun buildStatusConfig(buildStatusConfig: BuildStatusConfigProperty) {
                cdkBuilder.buildStatusConfig(
                    buildStatusConfig.let(BuildStatusConfigProperty::unwrap)
                )
            }
            ...
            override fun gitSubmodulesConfig(gitSubmodulesConfig: GitSubmodulesConfigProperty) {
                cdkBuilder.gitSubmodulesConfig(
                    gitSubmodulesConfig.let(GitSubmodulesConfigProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("648c0ad47d51754c0470a5118c7f95052d27f7158fd3e8aa306fdcd60e3ad2b2")
            override fun gitSubmodulesConfig(
                gitSubmodulesConfig: GitSubmodulesConfigProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * The build specification for the project.
             *
             * If this value is not provided, then the source code must contain a buildspec file
             * named `buildspec.yml` at the root level. If this value is provided, it can be either
             * a single string containing the entire build specification, or the path to an
             * alternate buildspec file relative to the value of the built-in environment variable
             * `CODEBUILD_SRC_DIR` . The alternate buildspec file can have a name other than
             * `buildspec.yml` , for example `myspec.yml` or `build_spec_qa.yml` or similar. For
             ...
             * The depth of history to download.
             *
             * Minimum value is 0. If this value is 0, greater than 25, or not provided, then the
             * full history is downloaded with each build project. If your source type is Amazon S3,
