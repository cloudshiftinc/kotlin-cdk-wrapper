...
internal constructor(
    ...
    public open fun attrOutputs(): IResolvable =
        unwrap(this).getAttrOutputs().let(IResolvable::wrap)
    ...
    public open fun provisioningPreferences(`value`: ProvisioningPreferencesProperty) {
        unwrap(this)
            .setProvisioningPreferences(`value`.let(ProvisioningPreferencesProperty::unwrap))
    }
    ...
    public open fun provisioningPreferences(
        `value`: ProvisioningPreferencesProperty.Builder.() -> Unit
    ): Unit = provisioningPreferences(ProvisioningPreferencesProperty(`value`))
    ...
    public interface Builder {
         ...
         * successfully resolve to `ProductId` as long as only one product exists in the account or
         * Region with that `ProductName` .
         *
         ...
         *
         * @param provisioningArtifactId The identifier of the provisioning artifact (also known as
         *   a version).
         */
         ...
         * You must also specify either the name or the ID of the product, but not both.
         *
         ...
         *
         * @param provisioningParameters Parameters specified by the administrator that are required
        ...
        /**
         * StackSet preferences that are required for provisioning the product or updating a
         * provisioned product.
         *
         ...
         *
         * @param provisioningPreferences StackSet preferences that are required for provisioning
         *   the product or updating a provisioned product.
         */
        ...
        public fun provisioningPreferences(
            provisioningPreferences: ProvisioningPreferencesProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
         ...
         *   the product or updating a provisioned product.
         */
        override fun provisioningPreferences(
            provisioningPreferences: ProvisioningPreferencesProperty
        ) {
            cdkBuilder.provisioningPreferences(
                provisioningPreferences.let(ProvisioningPreferencesProperty::unwrap)
            )
        }
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnCloudFormationProvisionedProduct
        ): software.amazon.awscdk.services.servicecatalog.CfnCloudFormationProvisionedProduct =
            wrapped.cdkObject
    }
    ...
    public interface ProvisioningParameterProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ProvisioningParameterProperty
            ): software.amazon.awscdk.services.servicecatalog.CfnCloudFormationProvisionedProduct.ProvisioningParameterProperty =
    ...
    public interface ProvisioningPreferencesProperty {
         ...
         */
        public fun stackSetAccounts(): List<String> =
            unwrap(this).getStackSetAccounts() ?: emptyList()
         ...
         *
         * If the operation is stopped in a Region, AWS Service Catalog doesn't attempt the
         ...
         * AWS Service Catalog stops the operation in that Region.
         *
         * If the operation is stopped in a Region, AWS Service Catalog doesn't attempt the
         * operation in any subsequent Regions.
         *
         ...
         * down would result is zero. In this case, AWS Service Catalog sets the number as `1`
         * instead.
         *
         * Note that this setting lets you specify the maximum for operations. For large
         * deployments, under certain circumstances the actual number of accounts acted upon
         ...
         *   accounts and Regions; if new ProductId or ProvisioningArtifactID are passed, they will
         *   be ignored.
         ...
         */
        public fun stackSetRegions(): List<String> =
            unwrap(this).getStackSetRegions() ?: emptyList()

        /** A builder for [ProvisioningPreferencesProperty] */
        @CdkDslMarker
        public interface Builder {
            /**
             * @param stackSetAccounts One or more AWS accounts where the provisioned product will
             *   be available. Applicable only to a `CFN_STACKSET` provisioned product type.
             *
             * The specified accounts should be within the list of accounts from the `STACKSET`
             * constraint. To get the list of accounts in the `STACKSET` constraint, use the
             * `DescribeProvisioningParameters` operation.
            ...
            /**
             * @param stackSetFailureToleranceCount The number of accounts, per Region, for which
             *   this operation can fail before AWS Service Catalog stops the operation in that
             *   Region. If the operation is stopped in a Region, AWS Service Catalog doesn't
            ...
            /**
             * @param stackSetFailureTolerancePercentage The percentage of accounts, per Region, for
             *   which this stack operation can fail before AWS Service Catalog stops the operation
             *   in that Region. If the operation is stopped in a Region, AWS Service Catalog
             ...
             * `StackSetFailureTolerancePercentage` , but not both.
             */
            public fun stackSetFailureTolerancePercentage(
                stackSetFailureTolerancePercentage: Number
            )

            /**
             * @param stackSetMaxConcurrencyCount The maximum number of accounts in which to perform
             *   this operation at one time. This is dependent on the value of
             *   `StackSetFailureToleranceCount` . `StackSetMaxConcurrentCount` is at most one more
             *   than the `StackSetFailureToleranceCount` .
             *
             * Note that this setting lets you specify the maximum for operations. For large
             * deployments, under certain circumstances the actual number of accounts acted upon
             * concurrently may be lower due to service throttling.
            ...
            /**
             * @param stackSetMaxConcurrencyPercentage The maximum percentage of accounts in which
             *   to perform this operation at one time. When calculating the number of accounts
             *   based on the specified percentage, AWS Service Catalog rounds down to the next
             *   whole number. This is true except in cases where rounding down would result is
             *   zero. In this case, AWS Service Catalog sets the number as `1` instead.
             *
             * Note that this setting lets you specify the maximum for operations. For large
             * deployments, under certain circumstances the actual number of accounts acted upon
             * concurrently may be lower due to service throttling.
            ...
            /**
             * @param stackSetOperationType Determines what action AWS Service Catalog performs to a
             *   stack set or a stack instance represented by the provisioned product. The default
             *   value is `UPDATE` if nothing is specified.
             *
             * Applicable only to a `CFN_STACKSET` provisioned product type.
             * * **CREATE** - Creates a new stack instance in the stack set represented by the
             *   provisioned product. In this case, only new stack instances are created based on
             *   accounts and Regions; if new ProductId or ProvisioningArtifactID are passed, they
             *   will be ignored.
             * * **UPDATE** - Updates the stack set represented by the provisioned product and also
             *   its stack instances.
             * * **DELETE** - Deletes a stack instance in the stack set represented by the
             *   provisioned product.
             */
             ...
             *   available. Applicable only to a `CFN_STACKSET` provisioned product type.
             *
             * The specified Regions should be within the list of Regions from the `STACKSET`
             * constraint. To get the list of Regions in the `STACKSET` constraint, use the
             * `DescribeProvisioningParameters` operation.
        ...
        private class BuilderImpl : Builder {
             ...
             * `StackSetFailureTolerancePercentage` , but not both.
             */
            override fun stackSetFailureTolerancePercentage(
                stackSetFailureTolerancePercentage: Number
            ) {
             ...
             * `StackSetMaxConcurrentPercentage` , but not both.
             */
            override fun stackSetMaxConcurrencyPercentage(
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-servicecatalog-cloudformationprovisionedproduct-provisioningpreferences.html#cfn-servicecatalog-cloudformationprovisionedproduct-provisioningpreferences-stacksetaccounts)
             */
            override fun stackSetAccounts(): List<String> =
                unwrap(this).getStackSetAccounts() ?: emptyList()
             ...
             * before AWS Service Catalog stops the operation in that Region.
             *
             * If the operation is stopped in a Region, AWS Service Catalog doesn't attempt the
             * operation in any subsequent Regions.
             *
             ...
             *
             * When calculating the number of accounts based on the specified percentage, AWS
             * Service Catalog rounds down to the next whole number. This is true except in cases
             * where rounding down would result is zero. In this case, AWS Service Catalog sets the
             * number as `1` instead.
             *
             * Note that this setting lets you specify the maximum for operations. For large
             * deployments, under certain circumstances the actual number of accounts acted upon
             ...
             * instance represented by the provisioned product.
             *
             * The default value is `UPDATE` if nothing is specified.
             *
             * Applicable only to a `CFN_STACKSET` provisioned product type.
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-servicecatalog-cloudformationprovisionedproduct-provisioningpreferences.html#cfn-servicecatalog-cloudformationprovisionedproduct-provisioningpreferences-stacksetregions)
             */
            override fun stackSetRegions(): List<String> =
                unwrap(this).getStackSetRegions() ?: emptyList()
        }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ProvisioningPreferencesProperty
            ): software.amazon.awscdk.services.servicecatalog.CfnCloudFormationProvisionedProduct.ProvisioningPreferencesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
