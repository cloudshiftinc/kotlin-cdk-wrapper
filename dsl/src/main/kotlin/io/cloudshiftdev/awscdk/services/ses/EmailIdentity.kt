...
internal constructor(
    ...
    /**
     * The host name for the first token that you have to add to the DNS configurationfor your
     * domain.
     */
    ...
    public interface Builder {
        ...
        /**
         * The action to take if the required MX record for the MAIL FROM domain isn't found when
         * you send an email.
         *
         * Default: MailFromBehaviorOnMxFailure.USE_DEFAULT_VALUE
         *
         * @param mailFromBehaviorOnMxFailure The action to take if the required MX record for the
         *   MAIL FROM domain isn't found when you send an email.
         */
    ...
    private class BuilderImpl(
         ...
         *   MAIL FROM domain isn't found when you send an email.
         */
        override fun mailFromBehaviorOnMxFailure(
            mailFromBehaviorOnMxFailure: MailFromBehaviorOnMxFailure
        ) {
            cdkBuilder.mailFromBehaviorOnMxFailure(
                mailFromBehaviorOnMxFailure.let(MailFromBehaviorOnMxFailure::unwrap)
            )
        }
    ...
    public companion object {
        public fun fromEmailIdentityName(
            ...
            software.amazon.awscdk.services.ses.EmailIdentity.fromEmailIdentityName(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    emailIdentityName
                )
                .let(IEmailIdentity::wrap)
        ...
        ): EmailIdentity = EmailIdentity(cdkObject)

        internal fun unwrap(
            wrapped: EmailIdentity
        ): software.amazon.awscdk.services.ses.EmailIdentity = wrapped.cdkObject
    }
}
