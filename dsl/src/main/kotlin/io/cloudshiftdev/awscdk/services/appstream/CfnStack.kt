...
internal constructor(
    ...
    public open fun applicationSettings(
        `value`: ApplicationSettingsProperty.Builder.() -> Unit
    ): Unit = applicationSettings(ApplicationSettingsProperty(`value`))

    /**  */
    public open fun attrId(): String = unwrap(this).getAttrId()

    /** The stack attributes to delete. */
    public open fun attributesToDelete(): List<String> =
        unwrap(this).getAttributesToDelete() ?: emptyList()
     ...
     */
    public open fun embedHostDomains(): List<String> =
        unwrap(this).getEmbedHostDomains() ?: emptyList()
    ...
    public open fun streamingExperienceSettings(`value`: StreamingExperienceSettingsProperty) {
        unwrap(this)
            .setStreamingExperienceSettings(
                `value`.let(StreamingExperienceSettingsProperty::unwrap)
            )
    }
    ...
    public open fun streamingExperienceSettings(
        `value`: StreamingExperienceSettingsProperty.Builder.() -> Unit
    ...
    /** The actions that are enabled or disabled for users during their streaming sessions. */
    public open fun userSettings(vararg __idx_ac66f0: Any): Unit =
        userSettings(__idx_ac66f0.toList())
    ...
    public interface Builder {
         ...
         *
         * @param accessEndpoints The list of virtual private cloud (VPC) interface endpoint
         *   objects.
         */
         ...
         * The persistent application settings for users of the stack.
         *
         * When these settings are enabled, changes that users make to applications and Windows
        ...
        public fun applicationSettings(
            applicationSettings: ApplicationSettingsProperty.Builder.() -> Unit
        )
         ...
         *
         * @param embedHostDomains The domains where AppStream 2.0 streaming sessions can be
         ...
         *
         * @param feedbackUrl The URL that users are redirected to after they click the Send
         *   Feedback link.
         */
         ...
         *
         * @param redirectUrl The URL that users are redirected to after their streaming session
         *   ends.
         */
         ...
         *
         * @param streamingExperienceSettings The streaming protocol that you want your stack to
         *   prefer.
         */
        ...
        public fun streamingExperienceSettings(
            streamingExperienceSettings: StreamingExperienceSettingsProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
        ...
        override fun applicationSettings(applicationSettings: ApplicationSettingsProperty) {
            cdkBuilder.applicationSettings(
                applicationSettings.let(ApplicationSettingsProperty::unwrap)
            )
        }
        ...
        override fun streamingExperienceSettings(streamingExperienceSettings: IResolvable) {
            cdkBuilder.streamingExperienceSettings(
                streamingExperienceSettings.let(IResolvable::unwrap)
            )
        }
         ...
         *   prefer.
         */
        override fun streamingExperienceSettings(
            streamingExperienceSettings: StreamingExperienceSettingsProperty
        ) {
            cdkBuilder.streamingExperienceSettings(
                streamingExperienceSettings.let(StreamingExperienceSettingsProperty::unwrap)
            )
        }
        ...
        override fun streamingExperienceSettings(
            ...
            streamingExperienceSettings(
                StreamingExperienceSettingsProperty(streamingExperienceSettings)
            )
         ...
         *   streaming sessions.
         */
        override fun userSettings(vararg userSettings: Any): Unit =
            userSettings(userSettings.toList())
    ...
    public interface ApplicationSettingsProperty {
         ...
         * stored.
         *
         * You can allow the same persistent application settings to be used across multiple stacks
         * by specifying the same settings group for each stack.
         *
        ...
        public interface Builder {
            /**
             * @param enabled Enables or disables persistent application settings for users during
            ...
            /**
             * @param settingsGroup The path prefix for the S3 bucket where users’ persistent
             *   application settings are stored. You can allow the same persistent application
             *   settings to be used across multiple stacks by specifying the same settings group
             *   for each stack.
             */
        ...
        internal constructor(
             ...
             * stored.
             *
             * You can allow the same persistent application settings to be used across multiple
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ApplicationSettingsProperty
            ): software.amazon.awscdk.services.appstream.CfnStack.ApplicationSettingsProperty =
    ...
    public interface AccessEndpointProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AccessEndpointProperty
            ): software.amazon.awscdk.services.appstream.CfnStack.AccessEndpointProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface StorageConnectorProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: StorageConnectorProperty
            ): software.amazon.awscdk.services.appstream.CfnStack.StorageConnectorProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface UserSettingProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param maximumLength Specifies the number of characters that can be copied by end
             *   users from the local device to the remote session, and to the local device from the
             *   remote session. This can be specified only for the
             *   `CLIPBOARD_COPY_FROM_LOCAL_DEVICE` and `CLIPBOARD_COPY_TO_LOCAL_DEVICE` actions.
             *
             * This defaults to 20,971,520 (20 MB) when unspecified and the permission is `ENABLED`
             * . This can't be specified when the permission is `DISABLED` .
             *
    ...
    public interface StreamingExperienceSettingsProperty {
        ...
        public interface Builder {
            /**
             * @param preferredProtocol The preferred protocol that you want to use while streaming
             *   your application.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: StreamingExperienceSettingsProperty
            ): software.amazon.awscdk.services.appstream.CfnStack.StreamingExperienceSettingsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
