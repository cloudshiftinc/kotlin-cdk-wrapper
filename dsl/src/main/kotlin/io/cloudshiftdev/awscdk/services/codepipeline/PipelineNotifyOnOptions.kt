...
public interface PipelineNotifyOnOptions : NotificationRuleOptions {
    ...
    public interface Builder {
        ...
        /**
         * @param events A list of event types associated with this notification rule for
         *   CodePipeline Pipeline. For a complete list of event types and IDs, see Notification
    ...
    private class BuilderImpl : Builder {
         ...
         *   concepts in the Developer Tools Console User Guide.
         */
        override fun events(vararg events: PipelineNotificationEvents): Unit =
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: PipelineNotifyOnOptions
        ): software.amazon.awscdk.services.codepipeline.PipelineNotifyOnOptions =
