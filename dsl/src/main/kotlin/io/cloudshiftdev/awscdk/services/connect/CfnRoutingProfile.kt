...
internal constructor(
    ...
    /** The inbound queues associated with the routing profile. */
    public open fun queueConfigs(vararg __idx_ac66f0: Any): Unit =
        queueConfigs(__idx_ac66f0.toList())
    ...
    public interface Builder {
         ...
         *   routing order calculated based on *time since their last inbound contact* or *longest
         *   idle time* .
         */
         ...
         *
         * @param defaultOutboundQueueArn The Amazon Resource Name (ARN) of the default outbound
         *   queue for the routing profile.
         */
         ...
         *
         * @param mediaConcurrencies The channels agents can handle in the Contact Control Panel
    ...
    private class BuilderImpl(
         ...
         * @param queueConfigs The inbound queues associated with the routing profile.
         */
        override fun queueConfigs(vararg queueConfigs: Any): Unit =
            queueConfigs(queueConfigs.toList())
    ...
    public interface CrossChannelBehaviorProperty {
        ...
        public interface Builder {
            /**
             * @param behaviorType Specifies the other channels that can be routed to an agent
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CrossChannelBehaviorProperty
            ): software.amazon.awscdk.services.connect.CfnRoutingProfile.CrossChannelBehaviorProperty =
    ...
    public interface MediaConcurrencyProperty {
        ...
        public interface Builder {
            /**
             * @param channel The channels that agents can handle in the Contact Control Panel
             *   (CCP).
             */
            public fun channel(channel: String)

            /**
             * @param concurrency The number of contacts an agent can have on a channel
             *   simultaneously. Valid Range for `VOICE` : Minimum value of 1. Maximum value of 1.
             *
             * Valid Range for `CHAT` : Minimum value of 1. Maximum value of 10.
             *
             * Valid Range for `TASK` : Minimum value of 1. Maximum value of 10.
            ...
            /**
             * @param crossChannelBehavior Defines the cross-channel routing behavior for each
             *   channel that is enabled for this Routing Profile. For example, this allows you to
             *   offer an agent a different contact from another channel when they are currently
            ...
            public fun crossChannelBehavior(
                crossChannelBehavior: CrossChannelBehaviorProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun crossChannelBehavior(crossChannelBehavior: CrossChannelBehaviorProperty) {
                cdkBuilder.crossChannelBehavior(
                    crossChannelBehavior.let(CrossChannelBehaviorProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("cfcde8aa362d223ee3c2ab2d6377b352befebe3fface34711f13a5df2121a4ab")
            override fun crossChannelBehavior(
                crossChannelBehavior: CrossChannelBehaviorProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * Routing Profile.
             *
             * For example, this allows you to offer an agent a different contact from another
             * channel when they are currently working with a contact from a Voice channel.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-connect-routingprofile-mediaconcurrency.html#cfn-connect-routingprofile-mediaconcurrency-crosschannelbehavior)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: MediaConcurrencyProperty
            ): software.amazon.awscdk.services.connect.CfnRoutingProfile.MediaConcurrencyProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface RoutingProfileQueueConfigProperty {
        ...
        public interface Builder {
            /**
             * @param delay The delay, in seconds, a contact should be in the queue before they are
            ...
            public fun queueReference(
                queueReference: RoutingProfileQueueReferenceProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun queueReference(queueReference: RoutingProfileQueueReferenceProperty) {
                cdkBuilder.queueReference(
                    queueReference.let(RoutingProfileQueueReferenceProperty::unwrap)
                )
            }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RoutingProfileQueueConfigProperty
            ): software.amazon.awscdk.services.connect.CfnRoutingProfile.RoutingProfileQueueConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface RoutingProfileQueueReferenceProperty {
        ...
        public interface Builder {
            /**
             * @param channel The channels agents can handle in the Contact Control Panel (CCP) for
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RoutingProfileQueueReferenceProperty
            ): software.amazon.awscdk.services.connect.CfnRoutingProfile.RoutingProfileQueueReferenceProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
