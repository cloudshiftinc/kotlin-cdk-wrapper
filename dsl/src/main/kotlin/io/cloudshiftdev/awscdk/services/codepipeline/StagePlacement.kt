...
public interface StagePlacement {
    ...
    public interface Builder {
        /**
         * @param justAfter Inserts the new Stage as a child of the given Stage (changing its
         *   current child Stage, if it had one).
         */
        public fun justAfter(justAfter: IStage)

        /**
         * @param rightBefore Inserts the new Stage as a parent of the given Stage (changing its
         *   current parent Stage, if it had one).
         */
    ...
    internal constructor(
        ...
        /**
         * Inserts the new Stage as a child of the given Stage (changing its current child Stage, if
         * it had one).
         */
        override fun justAfter(): IStage? = unwrap(this).getJustAfter()?.let(IStage::wrap)

        /**
         * Inserts the new Stage as a parent of the given Stage (changing its current parent Stage,
         * if it had one).
         */
