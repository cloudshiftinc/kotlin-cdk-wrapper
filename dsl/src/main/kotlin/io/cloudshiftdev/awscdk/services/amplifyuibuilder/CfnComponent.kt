...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param collectionProperties The data binding configuration for the component's
         *   properties.
         */
        ...
        /**
         * Describes the component's properties that can be overriden in a customized instance of
         * the component.
         *
         ...
         *
         * @param overrides Describes the component's properties that can be overriden in a
         ...
         *
         * @param sourceId The unique ID of the component in its original source system, such as
         *   Figma.
         */
    ...
    public interface MutationActionSetStateParameterProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param property The name of the component property to apply the state configuration
             *   to.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: MutationActionSetStateParameterProperty
            ): software.amazon.awscdk.services.amplifyuibuilder.CfnComponent.MutationActionSetStateParameterProperty =
    ...
    public interface ComponentChildProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param events Describes the events that can be raised on the child component. Use for
             *   the workflow feature in Amplify Studio that allows you to bind events and actions
             *   to components.
             */
            public fun events(events: IResolvable)
            ...
            /**
             * @param properties Describes the properties of the child component. You can't specify
            ...
            /**
             * @param sourceId The unique ID of the child component in its original source system,
             *   such as Figma.
             */
            public fun sourceId(sourceId: String)
        }
        ...
        internal constructor(
             ...
             * Describes the events that can be raised on the child component.
             *
             * Use for the workflow feature in Amplify Studio that allows you to bind events and
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ComponentChildProperty
            ): software.amazon.awscdk.services.amplifyuibuilder.CfnComponent.ComponentChildProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface FormBindingElementProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: FormBindingElementProperty
            ): software.amazon.awscdk.services.amplifyuibuilder.CfnComponent.FormBindingElementProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ComponentEventProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ComponentEventProperty
            ): software.amazon.awscdk.services.amplifyuibuilder.CfnComponent.ComponentEventProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ComponentPropertyProperty {
         ...
         */
        public fun collectionBindingProperties(): Any? =
        ...
        public interface Builder {
            /**
             * @param bindingProperties The information to bind the component property to data at
             *   runtime.
             */
            public fun bindingProperties(bindingProperties: IResolvable)
            ...
            public fun bindingProperties(
                bindingProperties: ComponentPropertyBindingPropertiesProperty.Builder.() -> Unit
            )
            ...
            /**
             * @param collectionBindingProperties The information to bind the component property to
             *   data at runtime. Use this for collection components.
             */
             ...
             *   data at runtime. Use this for collection components.
             */
            public fun collectionBindingProperties(
            ...
            public fun collectionBindingProperties(
                collectionBindingProperties:
                    ComponentPropertyBindingPropertiesProperty.Builder.() -> Unit
            )
            ...
            /**
             * @param concat A list of component properties to concatenate to create the value to
            ...
            /**
             * @param configured Specifies whether the user configured the property in Amplify
        ...
        private class BuilderImpl : Builder {
            ...
            override fun bindingProperties(
                ...
                cdkBuilder.bindingProperties(
                    bindingProperties.let(ComponentPropertyBindingPropertiesProperty::unwrap)
                )
            }
            ...
            override fun bindingProperties(
                ...
                bindingProperties(ComponentPropertyBindingPropertiesProperty(bindingProperties))
            ...
            override fun collectionBindingProperties(collectionBindingProperties: IResolvable) {
                cdkBuilder.collectionBindingProperties(
                    collectionBindingProperties.let(IResolvable::unwrap)
                )
            }
             ...
             *   data at runtime. Use this for collection components.
             */
            override fun collectionBindingProperties(
                collectionBindingProperties: ComponentPropertyBindingPropertiesProperty
            ) {
                cdkBuilder.collectionBindingProperties(
                    collectionBindingProperties.let(
                        ComponentPropertyBindingPropertiesProperty::unwrap
                    )
                )
            }
            ...
            override fun collectionBindingProperties(
                ...
                collectionBindingProperties(
                    ComponentPropertyBindingPropertiesProperty(collectionBindingProperties)
                )
            ...
            override fun condition(
                condition: ComponentConditionPropertyProperty.Builder.() -> Unit
            ): Unit = condition(ComponentConditionPropertyProperty(condition))
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ComponentPropertyProperty
            ): software.amazon.awscdk.services.amplifyuibuilder.CfnComponent.ComponentPropertyProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ComponentBindingPropertiesValuePropertiesProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ComponentBindingPropertiesValuePropertiesProperty
            ): software.amazon.awscdk.services.amplifyuibuilder.CfnComponent.ComponentBindingPropertiesValuePropertiesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ComponentConditionPropertyProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param operator The operator to use to perform the evaluation, such as `eq` to
             *   represent equals.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ComponentConditionPropertyProperty
            ): software.amazon.awscdk.services.amplifyuibuilder.CfnComponent.ComponentConditionPropertyProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ComponentBindingPropertiesValueProperty {
        ...
        public interface Builder {
            ...
            public fun bindingProperties(
                bindingProperties:
                    ComponentBindingPropertiesValuePropertiesProperty.Builder.() -> Unit
            )
        ...
        private class BuilderImpl : Builder {
            ...
            override fun bindingProperties(
                ...
                cdkBuilder.bindingProperties(
                    bindingProperties.let(ComponentBindingPropertiesValuePropertiesProperty::unwrap)
                )
            }
            ...
            override fun bindingProperties(
                ...
                bindingProperties(
                    ComponentBindingPropertiesValuePropertiesProperty(bindingProperties)
                )
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ComponentBindingPropertiesValueProperty
            ): software.amazon.awscdk.services.amplifyuibuilder.CfnComponent.ComponentBindingPropertiesValueProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ComponentPropertyBindingPropertiesProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ComponentPropertyBindingPropertiesProperty
            ): software.amazon.awscdk.services.amplifyuibuilder.CfnComponent.ComponentPropertyBindingPropertiesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ComponentVariantProperty {
        ...
        public interface Builder {
             ...
             *   customizing an instance of the component. You can't specify `tags` as a valid
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ComponentVariantProperty
            ): software.amazon.awscdk.services.amplifyuibuilder.CfnComponent.ComponentVariantProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ActionParametersProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param fields A dictionary of key-value pairs mapping Amplify Studio properties to
             *   fields in a data model. Use when the action performs an operation on an Amplify
             *   DataStore model.
             */
            ...
            /**
             * @param global Specifies whether the user should be signed out globally. Specify this
            ...
            /**
             * @param model The name of the data model. Use when the action performs an operation on
             *   an Amplify DataStore model.
             */
            public fun model(model: String)

            /**
             * @param state A key-value pair that specifies the state property name and its initial
             *   value.
             */
            ...
            /**
             * @param type The type of navigation action. Valid values are `url` and `anchor` . This
            ...
            /**
             * @param url The URL to the location to open. Specify this value for a navigation
             *   action.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            @JvmName("b05b4096837075a71dfa3d3fa8ded0e88897a8d87c89734554e5d74a3ad83208")
            override fun state(
                state: MutationActionSetStateParameterProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ActionParametersProperty
            ): software.amazon.awscdk.services.amplifyuibuilder.CfnComponent.ActionParametersProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ComponentDataConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param identifiers A list of IDs to use to bind data to a component. Use this
             *   property to bind specifically chosen data, rather than data retrieved from a query.
             */
            ...
            /**
             * @param predicate Represents the conditional logic to use when binding data to a
             *   component. Use this property to retrieve only a subset of the data in a collection.
             */
        ...
        private class BuilderImpl : Builder {
             ...
             *   property to bind specifically chosen data, rather than data retrieved from a query.
             */
            override fun identifiers(vararg identifiers: String): Unit =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ComponentDataConfigurationProperty
            ): software.amazon.awscdk.services.amplifyuibuilder.CfnComponent.ComponentDataConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
