...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.sagemaker.CfnNotebookInstance,
) : CfnResource(cdkObject), IInspectable, ITaggable {
    /**
     * A list of Amazon Elastic Inference (EI) instance types to associate with the notebook
     * instance.
     */
    public open fun acceleratorTypes(): List<String> =
    ...
    /** Information on the IMDS configuration of the notebook instance. */
    public open fun instanceMetadataServiceConfiguration(
        `value`: InstanceMetadataServiceConfigurationProperty
    ) {
        unwrap(this)
            .setInstanceMetadataServiceConfiguration(
                `value`.let(InstanceMetadataServiceConfigurationProperty::unwrap)
            )
    }
    ...
    public open fun instanceMetadataServiceConfiguration(
        `value`: InstanceMetadataServiceConfigurationProperty.Builder.() -> Unit
    ): Unit =
    ...
    public interface Builder {
         ...
         *
         * @param acceleratorTypes A list of Amazon Elastic Inference (EI) instance types to
         ...
         * An array of up to three Git repositories associated with the notebook instance.
         *
         * These can be either the names of Git repositories stored as resources in your account, or
         * the URL of Git repositories in
         * [AWS CodeCommit](https://docs.aws.amazon.com/codecommit/latest/userguide/welcome.html) or
         * in any other Git repository. These repositories are cloned at the same level as the
         ...
         *
         * @param additionalCodeRepositories An array of up to three Git repositories associated
         ...
         * the URL of a Git repository in
         * [AWS CodeCommit](https://docs.aws.amazon.com/codecommit/latest/userguide/welcome.html) or
         * in any other Git repository. When you open a notebook instance, it opens in the directory
         * that contains this repository. For more information, see
         * [Associating Git Repositories with SageMaker Notebook Instances](https://docs.aws.amazon.com/sagemaker/latest/dg/nbi-git-repo.html)
         * .
         *
         ...
         *
         * @param defaultCodeRepository The Git repository associated with the notebook instance as
         *   its default code repository.
         */
         ...
         * Sets whether SageMaker provides internet access to the notebook instance.
         *
         * If you set this to `Disabled` this notebook instance is able to access resources only in
         ...
         *
         * @param directInternetAccess Sets whether SageMaker provides internet access to the
         *   notebook instance.
         */
        ...
        public fun instanceMetadataServiceConfiguration(
            instanceMetadataServiceConfiguration:
                InstanceMetadataServiceConfigurationProperty.Builder.() -> Unit
        )

        /**
         * The type of ML compute instance to launch for the notebook instance.
         *
         * Expect some interruption of service if this parameter is changed as CloudFormation stops
         * a notebook instance and starts it up again to update it.
         *
         ...
         * policy must allow the SageMaker service principal (sagemaker.amazonaws.com) permissions
         * to assume this role. For more information, see
    ...
    private class BuilderImpl(
        ...
        override fun instanceMetadataServiceConfiguration(
            ...
            cdkBuilder.instanceMetadataServiceConfiguration(
                instanceMetadataServiceConfiguration.let(IResolvable::unwrap)
            )
        }
        ...
        override fun instanceMetadataServiceConfiguration(
            ...
            cdkBuilder.instanceMetadataServiceConfiguration(
                instanceMetadataServiceConfiguration.let(
                    InstanceMetadataServiceConfigurationProperty::unwrap
                )
            )
        }
        ...
        override fun instanceMetadataServiceConfiguration(
            ...
            instanceMetadataServiceConfiguration(
                InstanceMetadataServiceConfigurationProperty(instanceMetadataServiceConfiguration)
            )
    ...
    public interface InstanceMetadataServiceConfigurationProperty {
         ...
         *
         * When passed as part of `CreateNotebookInstance` , if no value is selected, then it
         * defaults to IMDSv1. This means that both IMDSv1 and IMDSv2 are supported. If passed as
         * part of `UpdateNotebookInstance` , there is no default.
         *
        ...
        public interface Builder {
            /**
             * @param minimumInstanceMetadataServiceVersion Indicates the minimum IMDS version that
             *   the notebook instance supports. When passed as part of `CreateNotebookInstance` ,
             *   if no value is selected, then it defaults to IMDSv1. This means that both IMDSv1
             *   and IMDSv2 are supported. If passed as part of `UpdateNotebookInstance` , there is
             *   no default.
             */
        ...
        private class BuilderImpl : Builder {
             ...
             *   no default.
             */
            override fun minimumInstanceMetadataServiceVersion(
                minimumInstanceMetadataServiceVersion: String
            ) {
                cdkBuilder.minimumInstanceMetadataServiceVersion(
        ...
        internal constructor(
             ...
             *
             * When passed as part of `CreateNotebookInstance` , if no value is selected, then it
             * defaults to IMDSv1. This means that both IMDSv1 and IMDSv2 are supported. If passed
             * as part of `UpdateNotebookInstance` , there is no default.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-sagemaker-notebookinstance-instancemetadataserviceconfiguration.html#cfn-sagemaker-notebookinstance-instancemetadataserviceconfiguration-minimuminstancemetadataserviceversion)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: InstanceMetadataServiceConfigurationProperty
            ): software.amazon.awscdk.services.sagemaker.CfnNotebookInstance.InstanceMetadataServiceConfigurationProperty =
