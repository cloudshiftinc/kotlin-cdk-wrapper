...
internal constructor(
    ...
    public open fun dataSources(
        `value`: CFNDataSourceConfigurationsProperty.Builder.() -> Unit
    ): Unit = dataSources(CFNDataSourceConfigurationsProperty(`value`))
    ...
    private class BuilderImpl(
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("12f3111304e64b8670160f76d2eb3865a3499096f6aab5133b06c3b39dec7d4d")
        override fun dataSources(
            dataSources: CFNDataSourceConfigurationsProperty.Builder.() -> Unit
        ...
        public fun build(): software.amazon.awscdk.services.guardduty.CfnDetector =
            cdkBuilder.build()
    }
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnDetector
        ): software.amazon.awscdk.services.guardduty.CfnDetector = wrapped.cdkObject
    }
    ...
    public interface CFNS3LogsConfigurationProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CFNS3LogsConfigurationProperty
            ): software.amazon.awscdk.services.guardduty.CfnDetector.CFNS3LogsConfigurationProperty =
    ...
    public interface CFNDataSourceConfigurationsProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param malwareProtection Describes whether Malware Protection will be enabled as a
             *   data source.
             */
            ...
            public fun malwareProtection(
                malwareProtection: CFNMalwareProtectionConfigurationProperty.Builder.() -> Unit
            )
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("da89073ca4a8da88eea36dbf6050555252d6cc3186da82a4552bb6b1a2baeca2")
            override fun kubernetes(
                kubernetes: CFNKubernetesConfigurationProperty.Builder.() -> Unit
             ...
             *   data source.
             */
            override fun malwareProtection(
                malwareProtection: CFNMalwareProtectionConfigurationProperty
            ) {
                cdkBuilder.malwareProtection(
                    malwareProtection.let(CFNMalwareProtectionConfigurationProperty::unwrap)
                )
            }
            ...
            override fun malwareProtection(
                ...
                malwareProtection(CFNMalwareProtectionConfigurationProperty(malwareProtection))
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CFNDataSourceConfigurationsProperty
            ): software.amazon.awscdk.services.guardduty.CfnDetector.CFNDataSourceConfigurationsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CFNScanEc2InstanceWithFindingsConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param ebsVolumes Describes the configuration for scanning EBS volumes as data
             *   source.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CFNScanEc2InstanceWithFindingsConfigurationProperty
            ): software.amazon.awscdk.services.guardduty.CfnDetector.CFNScanEc2InstanceWithFindingsConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CFNFeatureConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param additionalConfiguration Information about the additional configuration of a
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CFNFeatureConfigurationProperty
            ): software.amazon.awscdk.services.guardduty.CfnDetector.CFNFeatureConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CFNKubernetesConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param auditLogs Describes whether Kubernetes audit logs are enabled as a data source
             *   for the detector.
             */
            ...
            public fun auditLogs(
                auditLogs: CFNKubernetesAuditLogsConfigurationProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun auditLogs(auditLogs: CFNKubernetesAuditLogsConfigurationProperty) {
                cdkBuilder.auditLogs(
                    auditLogs.let(CFNKubernetesAuditLogsConfigurationProperty::unwrap)
                )
            }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CFNKubernetesConfigurationProperty
            ): software.amazon.awscdk.services.guardduty.CfnDetector.CFNKubernetesConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CFNMalwareProtectionConfigurationProperty {
         ...
         */
        public fun scanEc2InstanceWithFindings(): Any? =
        ...
        public interface Builder {
            /**
             * @param scanEc2InstanceWithFindings Describes the configuration of Malware Protection
             ...
             *   for EC2 instances with findings.
             */
            public fun scanEc2InstanceWithFindings(
            ...
            public fun scanEc2InstanceWithFindings(
                scanEc2InstanceWithFindings:
                    CFNScanEc2InstanceWithFindingsConfigurationProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun scanEc2InstanceWithFindings(scanEc2InstanceWithFindings: IResolvable) {
                cdkBuilder.scanEc2InstanceWithFindings(
                    scanEc2InstanceWithFindings.let(IResolvable::unwrap)
                )
            }
             ...
             *   for EC2 instances with findings.
             */
            override fun scanEc2InstanceWithFindings(
                scanEc2InstanceWithFindings: CFNScanEc2InstanceWithFindingsConfigurationProperty
            ) {
                cdkBuilder.scanEc2InstanceWithFindings(
                    scanEc2InstanceWithFindings.let(
                        CFNScanEc2InstanceWithFindingsConfigurationProperty::unwrap
                    )
                )
            }
            ...
            override fun scanEc2InstanceWithFindings(
                ...
                scanEc2InstanceWithFindings(
                    CFNScanEc2InstanceWithFindingsConfigurationProperty(scanEc2InstanceWithFindings)
                )
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CFNMalwareProtectionConfigurationProperty
            ): software.amazon.awscdk.services.guardduty.CfnDetector.CFNMalwareProtectionConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CFNKubernetesAuditLogsConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param enable Describes whether Kubernetes audit logs are enabled as a data source
             *   for the detector.
             */
            public fun enable(enable: Boolean)
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CFNKubernetesAuditLogsConfigurationProperty
            ): software.amazon.awscdk.services.guardduty.CfnDetector.CFNKubernetesAuditLogsConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CFNFeatureAdditionalConfigurationProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CFNFeatureAdditionalConfigurationProperty
            ): software.amazon.awscdk.services.guardduty.CfnDetector.CFNFeatureAdditionalConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
