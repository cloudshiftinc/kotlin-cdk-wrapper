...
internal constructor(
    ...
    public open fun insightsConfiguration(
        `value`: InsightsConfigurationProperty.Builder.() -> Unit
    ...
    public interface Builder {
        ...
        public fun insightsConfiguration(
            insightsConfiguration: InsightsConfigurationProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
        ...
        override fun insightsConfiguration(insightsConfiguration: InsightsConfigurationProperty) {
            cdkBuilder.insightsConfiguration(
                insightsConfiguration.let(InsightsConfigurationProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("7e14f6cec07b18027436bd71c2f8cbcc7699546fea0b70fd3021cfc68390e860")
        override fun insightsConfiguration(
            insightsConfiguration: InsightsConfigurationProperty.Builder.() -> Unit
    ...
    public interface InsightsConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param insightsEnabled Set the InsightsEnabled value to true to enable insights or
            ...
            /**
             * @param notificationsEnabled Set the NotificationsEnabled value to true to enable
             *   insights notifications. Notifications can only be enabled on a group with
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: InsightsConfigurationProperty
            ): software.amazon.awscdk.services.xray.CfnGroup.InsightsConfigurationProperty =
