...
public interface VirtualRouterListenerConfig {
    ...
    public interface Builder {
        ...
        public fun listener(
            listener: CfnVirtualRouter.VirtualRouterListenerProperty.Builder.() -> Unit
        )
    }
    ...
    private class BuilderImpl : Builder {
        ...
        override fun listener(listener: CfnVirtualRouter.VirtualRouterListenerProperty) {
            cdkBuilder.listener(
                listener.let(CfnVirtualRouter.VirtualRouterListenerProperty::unwrap)
            )
        }
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: VirtualRouterListenerConfig
