...
public interface IRuleTarget {
    ...
    internal constructor(
         ...
         * Returns the rule target specification.
         *
         * NOTE: Do not use the various `inputXxx` options. They can be set in a call to
         * `addTarget`.
         *
         * @param rule The EventBridge Rule that would trigger this target.
         * @param id The id of the target that will be attached to the rule.
    ...
    public companion object {
        ...
        ): IRuleTarget = Wrapper(cdkObject)

        internal fun unwrap(
            wrapped: IRuleTarget
        ): software.amazon.awscdk.services.events.IRuleTarget = (wrapped as Wrapper).cdkObject
    }
}
