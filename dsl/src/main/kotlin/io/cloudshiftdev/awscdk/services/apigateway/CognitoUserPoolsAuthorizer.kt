...
internal constructor(
     ...
     * [io.cloudshiftdev.awscdk.services.apigateway.CognitoUserPoolsAuthorizer].
     */
    @CdkDslMarker
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.apigateway.CognitoUserPoolsAuthorizer.Builder.create(
                scope,
                id
            )
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CognitoUserPoolsAuthorizer
