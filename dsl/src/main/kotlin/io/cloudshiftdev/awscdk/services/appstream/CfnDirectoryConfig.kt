...
internal constructor(
     ...
     * Provider (IdP) user identities to Active Directory domain-joined streaming instances.
     */
    public open fun certificateBasedAuthProperties(
        `value`: CertificateBasedAuthPropertiesProperty
    ) {
        unwrap(this)
            .setCertificateBasedAuthProperties(
                `value`.let(CertificateBasedAuthPropertiesProperty::unwrap)
            )
    }
    ...
    public open fun certificateBasedAuthProperties(
        `value`: CertificateBasedAuthPropertiesProperty.Builder.() -> Unit
    ...
    public open fun serviceAccountCredentials(`value`: ServiceAccountCredentialsProperty) {
        unwrap(this)
            .setServiceAccountCredentials(`value`.let(ServiceAccountCredentialsProperty::unwrap))
    }
    ...
    public open fun serviceAccountCredentials(
        `value`: ServiceAccountCredentialsProperty.Builder.() -> Unit
    ...
    public interface Builder {
         ...
         *
         * @param certificateBasedAuthProperties The certificate-based authentication properties
         *   used to authenticate SAML 2.0 Identity Provider (IdP) user identities to Active
         *   Directory domain-joined streaming instances.
         */
        ...
        public fun certificateBasedAuthProperties(
            certificateBasedAuthProperties:
                CertificateBasedAuthPropertiesProperty.Builder.() -> Unit
        )
        ...
        public fun serviceAccountCredentials(
            serviceAccountCredentials: ServiceAccountCredentialsProperty.Builder.() -> Unit
        )
    }
    ...
    private class BuilderImpl(
        ...
        override fun certificateBasedAuthProperties(certificateBasedAuthProperties: IResolvable) {
            cdkBuilder.certificateBasedAuthProperties(
                certificateBasedAuthProperties.let(IResolvable::unwrap)
            )
        }
         ...
         *   Directory domain-joined streaming instances.
         */
        override fun certificateBasedAuthProperties(
            certificateBasedAuthProperties: CertificateBasedAuthPropertiesProperty
        ) {
            cdkBuilder.certificateBasedAuthProperties(
                certificateBasedAuthProperties.let(CertificateBasedAuthPropertiesProperty::unwrap)
            )
        }
        ...
        override fun certificateBasedAuthProperties(
            ...
            certificateBasedAuthProperties(
                CertificateBasedAuthPropertiesProperty(certificateBasedAuthProperties)
            )
         ...
         *   units for computer accounts.
         */
        override fun organizationalUnitDistinguishedNames(
            organizationalUnitDistinguishedNames: List<String>
        ) {
         ...
         *   streaming instance to connect to the directory.
         */
        override fun serviceAccountCredentials(
            serviceAccountCredentials: ServiceAccountCredentialsProperty
        ) {
            cdkBuilder.serviceAccountCredentials(
                serviceAccountCredentials.let(ServiceAccountCredentialsProperty::unwrap)
            )
        }
    ...
    public interface ServiceAccountCredentialsProperty {
         ...
         *
         * This account must have the following privileges: create computer objects, join computers
         * to the domain, and change/reset the password on descendant computer objects for the
        ...
        public interface Builder {
             ...
             *   privileges: create computer objects, join computers to the domain, and change/reset
             *   the password on descendant computer objects for the organizational units specified.
             */
        ...
        internal constructor(
             ...
             * The user name of the account.
             *
             * This account must have the following privileges: create computer objects, join
             * computers to the domain, and change/reset the password on descendant computer objects
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ServiceAccountCredentialsProperty
            ): software.amazon.awscdk.services.appstream.CfnDirectoryConfig.ServiceAccountCredentialsProperty =
    ...
    public interface CertificateBasedAuthPropertiesProperty {
        ...
        public interface Builder {
            /**
             * @param certificateAuthorityArn The ARN of the AWS Certificate Manager Private CA
             *   resource.
             */
            public fun certificateAuthorityArn(certificateAuthorityArn: String)

            /**
             * @param status The status of the certificate-based authentication properties. Fallback
             *   is turned on by default when certificate-based authentication is *Enabled* .
             *   Fallback allows users to log in using their AD domain password if certificate-based
             *   authentication is unsuccessful, or to unlock a desktop lock screen.
             *   *Enabled_no_directory_login_fallback* enables certificate-based authentication, but
             *   does not allow users to log in using their AD domain password. Users will be
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CertificateBasedAuthPropertiesProperty
            ): software.amazon.awscdk.services.appstream.CfnDirectoryConfig.CertificateBasedAuthPropertiesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
