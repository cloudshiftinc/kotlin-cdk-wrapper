...
public interface ZoneAwarenessConfig {
     ...
     * index shards that belong to a cluster across two Availability Zones (AZs) in the same region
     * to prevent data loss and minimize downtime in the event of node or data center failure. Don't
     * enable zone awareness if your cluster has no replica index shards or is a single-node
     * cluster. For more information, see [Configuring a Multi-AZ Domain]
    ...
    public interface Builder {
         ...
         *   of AZs that you want the domain to use. Valid values are 2 and 3.
         */
         ...
         *   Service domain. When you enable zone awareness, Amazon OpenSearch Service allocates the
         *   nodes and replica index shards that belong to a cluster across two Availability Zones
         *   (AZs) in the same region to prevent data loss and minimize downtime in the event of
         *   node or data center failure. Don't enable zone awareness if your cluster has no replica
         *   index shards or is a single-node cluster. For more information, see
