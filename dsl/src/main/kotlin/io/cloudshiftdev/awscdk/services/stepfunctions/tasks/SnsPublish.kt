...
internal constructor(
    ...
    public interface Builder {
         ...
         * size. For SMS, each message can contain up to 140 characters.
         *
         ...
         *
         * These attributes carry additional metadata about the message and may be used for
         ...
         * deduplication of sent messages. If a message with a particular MessageDeduplicationId is
         * sent successfully, any message sent with the same MessageDeduplicationId during the
         ...
         *
         * For example, you might want to send a shorter message to SMS subscribers and a more
         * verbose message to email and SQS subscribers.
         *
         * Your message must be a JSON object with a top-level JSON key of "default" with a value
         ...
         * Default: - No subject
         *
         * @param subject Used as the "Subject" line when the message is delivered to email
         *   endpoints.
         */
    ...
    private class BuilderImpl(
        ...
        override fun messageAttributes(messageAttributes: Map<String, MessageAttribute>) {
            cdkBuilder.messageAttributes(
                messageAttributes.mapValues { MessageAttribute.unwrap(it.value) }
            )
        }
