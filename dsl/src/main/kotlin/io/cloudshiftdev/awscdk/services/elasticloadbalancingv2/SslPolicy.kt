...
public enum class SslPolicy(
  ...
  public companion object {
    internal fun wrap(cdkObject: software.amazon.awscdk.services.elasticloadbalancingv2.SslPolicy):
        SslPolicy = when (cdkObject) {
      ...
      software.amazon.awscdk.services.elasticloadbalancingv2.SslPolicy.FORWARD_SECRECY_TLS12_RES_GCM ->
      ...
      software.amazon.awscdk.services.elasticloadbalancingv2.SslPolicy.TLS12 -> SslPolicy.TLS12
      software.amazon.awscdk.services.elasticloadbalancingv2.SslPolicy.TLS12_EXT ->
          SslPolicy.TLS12_EXT
      software.amazon.awscdk.services.elasticloadbalancingv2.SslPolicy.TLS11 -> SslPolicy.TLS11
      software.amazon.awscdk.services.elasticloadbalancingv2.SslPolicy.LEGACY -> SslPolicy.LEGACY
    }

    internal fun unwrap(wrapped: SslPolicy):
