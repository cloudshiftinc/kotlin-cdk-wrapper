...
internal constructor(
    ...
    /**
     * The Id of the single sign-on client that you use to authenticate and authorize users on the
     * web application.
     */
    ...
    public interface Builder {
         ...
         *
         * @param roleArn The ARN of the role that the web application assumes when it interacts
         *   with AWS IoT Core .
         */
