...
internal constructor(
    ...
    public open fun updatedLatestPatchVersion(): String? =
        unwrap(this).getUpdatedLatestPatchVersion()
    ...
    public interface Builder {
         ...
         *
         * @param updatedLatestPatchVersion If the version was marked latest, the new version to
         *   maker as latest.
         */
