...
internal constructor(
    ...
    public open fun federationParameters(
        `value`: FederationParametersProperty.Builder.() -> Unit
    ...
    public open fun superuserParameters(
        `value`: SuperuserParametersProperty.Builder.() -> Unit
    ): Unit = superuserParameters(SuperuserParametersProperty(`value`))
    ...
    public interface Builder {
         ...
         * @deprecated this property has been deprecated
         */
        @Deprecated(message = "deprecated in CDK") public fun dataBundles(dataBundles: List<String>)
         ...
         *
         * @param federationParameters Configuration information when authentication mode is
         *   FEDERATED.
         */
        ...
        public fun federationParameters(
            federationParameters: FederationParametersProperty.Builder.() -> Unit
        )
        ...
        public fun superuserParameters(
            superuserParameters: SuperuserParametersProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
         ...
         */
        @Deprecated(message = "deprecated in CDK")
        override fun dataBundles(vararg dataBundles: String): Unit =
            dataBundles(dataBundles.toList())
        ...
        override fun federationParameters(federationParameters: FederationParametersProperty) {
            cdkBuilder.federationParameters(
                federationParameters.let(FederationParametersProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("9df12da2f0c697b85c338698db8006b519ebdbe211ca2f952127f7ceff4496d0")
        override fun federationParameters(
            federationParameters: FederationParametersProperty.Builder.() -> Unit
        ...
        override fun superuserParameters(superuserParameters: SuperuserParametersProperty) {
            cdkBuilder.superuserParameters(
                superuserParameters.let(SuperuserParametersProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("8539c50c6b8910ceea4521f816dc281fc996c5bab7195e03c37e5ef08360a309")
        override fun superuserParameters(
            superuserParameters: SuperuserParametersProperty.Builder.() -> Unit
        ...
        public fun build(): software.amazon.awscdk.services.finspace.CfnEnvironment =
            cdkBuilder.build()
    }
    ...
    public interface FederationParametersProperty {
         ...
         *
         * The name must always be `Email` and the value should be set to the attribute definition
         * in which user email is set. For example, name would be `Email` and value
        ...
        public interface Builder {
            /**
             * @param applicationCallBackUrl The redirect or sign-in URL that should be entered into
             *   the SAML 2.0 compliant identity provider configuration (IdP).
             */
            public fun applicationCallBackUrl(applicationCallBackUrl: String)

            /**
             * @param attributeMap SAML attribute name and value. The name must always be `Email`
             *   and the value should be set to the attribute definition in which user email is set.
             *   For example, name would be `Email` and value
            ...
            /**
             * @param federationUrn The Uniform Resource Name (URN). Also referred as Service
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-finspace-environment-federationparameters.html#cfn-finspace-environment-federationparameters-applicationcallbackurl)
             */
            override fun applicationCallBackUrl(): String? =
                unwrap(this).getApplicationCallBackUrl()

            /**
             * SAML attribute name and value.
             *
             * The name must always be `Email` and the value should be set to the attribute
             * definition in which user email is set. For example, name would be `Email` and value
             * `http://schemas.xmlsoap.org/ws/2005/05/identity/claims/emailaddress` . Please check
             * your SAML 2.0 compliant identity provider (IdP) documentation for details.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-finspace-environment-federationparameters.html#cfn-finspace-environment-federationparameters-attributemap)
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-finspace-environment-federationparameters.html#cfn-finspace-environment-federationparameters-federationprovidername)
             */
            override fun federationProviderName(): String? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: FederationParametersProperty
            ): software.amazon.awscdk.services.finspace.CfnEnvironment.FederationParametersProperty =
    ...
    public interface AttributeMapItemsProperty {
         ...
         * prefixed with aws:. You can use any of the following characters: the set of Unicode
        ...
        public interface Builder {
             ...
             *   characters in length and cannot be prefixed with aws:. You can use any of the
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AttributeMapItemsProperty
            ): software.amazon.awscdk.services.finspace.CfnEnvironment.AttributeMapItemsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SuperuserParametersProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SuperuserParametersProperty
            ): software.amazon.awscdk.services.finspace.CfnEnvironment.SuperuserParametersProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
