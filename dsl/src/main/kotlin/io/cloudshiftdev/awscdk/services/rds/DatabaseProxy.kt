...
internal constructor(
    ...
    public companion object {
        public fun fromDatabaseProxyAttributes(
            ...
            software.amazon.awscdk.services.rds.DatabaseProxy.fromDatabaseProxyAttributes(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    attrs.let(DatabaseProxyAttributes::unwrap)
                )
                .let(IDatabaseProxy::wrap)
        ...
        ): DatabaseProxy = DatabaseProxy(cdkObject)

        internal fun unwrap(
            wrapped: DatabaseProxy
        ): software.amazon.awscdk.services.rds.DatabaseProxy = wrapped.cdkObject
    }
}
