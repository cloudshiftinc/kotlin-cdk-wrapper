...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * For tasks using the Fargate launch type, this field is required and you must use one of
         ...
         *
         * NOTE: This parameter is only supported for tasks hosted on AWS Fargate using platform
    ...
    public companion object {
        public fun fromFargateTaskDefinitionArn(
            ...
            software.amazon.awscdk.services.ecs.FargateTaskDefinition.fromFargateTaskDefinitionArn(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    fargateTaskDefinitionArn
                )
                .let(IFargateTaskDefinition::wrap)
        ...
        public fun fromFargateTaskDefinitionAttributes(
            ...
            software.amazon.awscdk.services.ecs.FargateTaskDefinition
                .fromFargateTaskDefinitionAttributes(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    attrs.let(FargateTaskDefinitionAttributes::unwrap)
                )
                .let(IFargateTaskDefinition::wrap)
        ...
        public fun fromFargateTaskDefinitionAttributes(
            ...
            fromFargateTaskDefinitionAttributes(scope, id, FargateTaskDefinitionAttributes(attrs))
