...
internal constructor(
     ...
     *
     * Must be the **current** master user name of the snapshot. It is not possible to change the
     * master user name of a RDS instance.
     *
    ...
    public companion object {
        public fun fromGeneratedPassword(username: String): SnapshotCredentials =
            software.amazon.awscdk.services.rds.SnapshotCredentials.fromGeneratedPassword(username)
                .let(SnapshotCredentials::wrap)

        public fun fromGeneratedPassword(
            username: String,
            options: SnapshotCredentialsFromGeneratedPasswordOptions
        ): SnapshotCredentials =
            software.amazon.awscdk.services.rds.SnapshotCredentials.fromGeneratedPassword(
                    username,
                    options.let(SnapshotCredentialsFromGeneratedPasswordOptions::unwrap)
                )
                .let(SnapshotCredentials::wrap)
        ...
        public fun fromGeneratedSecret(
            ...
            software.amazon.awscdk.services.rds.SnapshotCredentials.fromGeneratedSecret(
                    username,
                    options.let(SnapshotCredentialsFromGeneratedPasswordOptions::unwrap)
                )
                .let(SnapshotCredentials::wrap)
        ...
        public fun fromGeneratedSecret(
            ...
            fromGeneratedSecret(username, SnapshotCredentialsFromGeneratedPasswordOptions(options))

        public fun fromPassword(password: SecretValue): SnapshotCredentials =
            software.amazon.awscdk.services.rds.SnapshotCredentials.fromPassword(
                    password.let(SecretValue::unwrap)
                )
                .let(SnapshotCredentials::wrap)

        public fun fromSecret(secret: ISecret): SnapshotCredentials =
            software.amazon.awscdk.services.rds.SnapshotCredentials.fromSecret(
