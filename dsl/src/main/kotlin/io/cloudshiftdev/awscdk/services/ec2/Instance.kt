...
internal constructor(
    ...
    public interface Builder {
         ...
         * Default: false
         *
         * @param allowAllIpv6Outbound Whether the instance could initiate IPv6 connections to
         *   anywhere by default.
         */
        ...
        /**
         * Whether to associate a public IP address to the primary network interface attached to
         * this instance.
         *
         ...
         *
         * @param creditSpecification Specifying the CPU credit type for burstable EC2 instance
         *   types (T2, T3, T3a, etc).
         */
         ...
         *
         * @param detailedMonitoring Whether "Detailed Monitoring" is enabled for this instance Keep
         *   in mind that Detailed Monitoring results in extra charges.
         */
         ...
         * Default: - false
         *
         * @param propagateTagsToVolumeOnCreation Propagate the EC2 instance tags to the EBS
         *   volumes.
         */
         ...
         *
         * This controls whether source/destination checking is enabled on the instance. A value of
         * true means that checking is enabled, and false means that checking is disabled. The value
         * must be false for the instance to perform NAT.
         *
         * Default: true
         *
         * @param sourceDestCheck Specifies whether to enable an instance launched in a VPC to
         *   perform NAT.
         */
         ...
         *
         * Depending the EC2 instance type, changing UserData either restarts the instance or
         ...
         *
         * Setting this to `true` will make the instance's Logical ID depend on the UserData, which
         * will cause CloudFormation to replace it if the UserData changes.
         *
