...
public interface AliasOptions : EventInvokeConfigOptions {
     ...
     *
     * Individual additional version weights specified here should add up to (less than) one. All
     * remaining weight is routed to the default version.
     *
     * For example, the config is
     *
     * version: "1" additionalVersions: [{ version: "2", weight: 0.05 }]
     *
     * Then 5% of traffic will be routed to function version 2, while the remaining 95% of traffic
     * will be routed to function version 1.
     *
    ...
    public interface Builder {
        /**
         * @param additionalVersions Additional versions with individual weights this alias points
         *   to. Individual additional version weights specified here should add up to (less than)
         *   one. All remaining weight is routed to the default version.
         *
         * For example, the config is
         *
         * version: "1" additionalVersions: [{ version: "2", weight: 0.05 }]
         *
         * Then 5% of traffic will be routed to function version 2, while the remaining 95% of
         * traffic will be routed to function version 1.
         */
    ...
    internal constructor(
         ...
         * Additional versions with individual weights this alias points to.
         *
         * Individual additional version weights specified here should add up to (less than) one.
         * All remaining weight is routed to the default version.
         *
         * For example, the config is
         *
         * version: "1" additionalVersions: [{ version: "2", weight: 0.05 }]
         ...
         */
        override fun onFailure(): IDestination? =
         ...
         * Default: - no destination
         */
        override fun onSuccess(): IDestination? =
    ...
    public companion object {
        ...
        ): AliasOptions = Wrapper(cdkObject)

        internal fun unwrap(
            wrapped: AliasOptions
        ): software.amazon.awscdk.services.lambda.AliasOptions = (wrapped as Wrapper).cdkObject
    }
}
