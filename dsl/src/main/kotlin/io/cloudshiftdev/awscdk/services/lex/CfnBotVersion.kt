...
internal constructor(
    ...
    public interface Builder {
         ...
         * locale. When you specify a source version, the locale data is copied from the source
    ...
    private class BuilderImpl(
        ...
        override fun botVersionLocaleSpecification(botVersionLocaleSpecification: IResolvable) {
            cdkBuilder.botVersionLocaleSpecification(
                botVersionLocaleSpecification.let(IResolvable::unwrap)
            )
        }
         ...
         *   version.
         */
        override fun botVersionLocaleSpecification(
            vararg botVersionLocaleSpecification: Any
        ): Unit = botVersionLocaleSpecification(botVersionLocaleSpecification.toList())
    ...
    public companion object {
        ...
        ): CfnBotVersion = CfnBotVersion(cdkObject)

        internal fun unwrap(
            wrapped: CfnBotVersion
        ): software.amazon.awscdk.services.lex.CfnBotVersion = wrapped.cdkObject
    }
    ...
    public interface BotVersionLocaleSpecificationProperty {
        ...
        public interface Builder {
            ...
            public fun botVersionLocaleDetails(
                botVersionLocaleDetails: BotVersionLocaleDetailsProperty.Builder.() -> Unit
            )
        ...
        private class BuilderImpl : Builder {
            private val cdkBuilder:
                ...
                software.amazon.awscdk.services.lex.CfnBotVersion
            ...
            override fun botVersionLocaleDetails(
                ...
                cdkBuilder.botVersionLocaleDetails(
                    botVersionLocaleDetails.let(BotVersionLocaleDetailsProperty::unwrap)
                )
            }
            ...
            override fun botVersionLocaleDetails(
                ...
                botVersionLocaleDetails(BotVersionLocaleDetailsProperty(botVersionLocaleDetails))
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: BotVersionLocaleSpecificationProperty
            ): software.amazon.awscdk.services.lex.CfnBotVersion.BotVersionLocaleSpecificationProperty =
    ...
    public interface BotVersionLocaleDetailsProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: BotVersionLocaleDetailsProperty
            ): software.amazon.awscdk.services.lex.CfnBotVersion.BotVersionLocaleDetailsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
