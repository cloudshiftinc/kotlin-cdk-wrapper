...
internal constructor(
    ...
    public open fun approvedPatches(): List<String> =
        unwrap(this).getApprovedPatches() ?: emptyList()
    ...
    /** A list of explicitly approved patches for the baseline. */
    public open fun approvedPatches(vararg `value`: String): Unit =
        approvedPatches(`value`.toList())
    ...
    public open fun rejectedPatches(): List<String> =
        unwrap(this).getRejectedPatches() ?: emptyList()
    ...
    /** A list of explicitly rejected patches for the baseline. */
    public open fun rejectedPatches(vararg `value`: String): Unit =
        rejectedPatches(`value`.toList())
    ...
    public interface Builder {
         ...
         * be applied to the managed nodes.
         *
         ...
         *   baseline, and its status is reported as `InstalledOther` . This is the default action
         *   if no option is specified.
         * * *`BLOCK`* : Packages in the `RejectedPatches` list, and packages that include them as
         *   dependencies, aren't installed under any circumstances. If a package was installed
         *   before it was added to the Rejected patches list, it is considered non-compliant with
         *   the patch baseline, and its status is reported as `InstalledRejected` .
         *
         ...
         *
         * @param rejectedPatchesAction The action for Patch Manager to take on patches included in
         ...
         * operating systems and source repositories.
         *
    ...
    private class BuilderImpl(
         ...
         *   includes non-security updates that should be applied to the managed nodes.
         */
        override fun approvedPatchesEnableNonSecurity(
            approvedPatchesEnableNonSecurity: IResolvable
        ) {
            cdkBuilder.approvedPatchesEnableNonSecurity(
                approvedPatchesEnableNonSecurity.let(IResolvable::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("51b3a6dc20ee5e4012e3f5957be3a49d8591696eb8a2e2f57c566319b32bea10")
        override fun globalFilters(
            globalFilters: PatchFilterGroupProperty.Builder.() -> Unit
         ...
         * @param patchGroups The name of the patch group to be registered with the patch baseline.
         */
        override fun patchGroups(vararg patchGroups: String): Unit =
        ...
        public fun build(): software.amazon.awscdk.services.ssm.CfnPatchBaseline =
            cdkBuilder.build()
    }
    ...
    public interface PatchFilterProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param values The value for the filter key. For information about valid values for
             *   each key based on operating system type, see
             *   [PatchFilter](https://docs.aws.amazon.com/systems-manager/latest/APIReference/API_PatchFilter.html)
             *   in the *AWS Systems Manager API Reference* .
             */
    ...
    public interface PatchFilterGroupProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: PatchFilterGroupProperty
            ): software.amazon.awscdk.services.ssm.CfnPatchBaseline.PatchFilterGroupProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface PatchSourceProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param products The specific operating system versions a patch repository applies to,
             *   such as "Ubuntu16.04", "RedhatEnterpriseLinux7.2" or "Suse12.7". For lists of
        ...
        internal constructor(
            ...
            /**
             * The specific operating system versions a patch repository applies to, such as
             * "Ubuntu16.04", "RedhatEnterpriseLinux7.2" or "Suse12.7". For lists of supported
             * product values, see
             * [PatchFilter](https://docs.aws.amazon.com/systems-manager/latest/APIReference/API_PatchFilter.html)
             * in the *AWS Systems Manager API Reference* .
             *
    ...
    public interface RuleProperty {
        ...
        public interface Builder {
            /**
             * @param approveAfterDays The number of days after the release date of each patch
             *   matched by the rule that the patch is marked as approved in the patch baseline. For
             *   example, a value of `7` means that patches are approved seven days after they are
             *   released.
             *
             * You must specify a value for `ApproveAfterDays` .
             *
            ...
            /**
             * @param approveUntilDate The cutoff date for auto approval of released patches. Any
             *   patches released on or before this date are installed automatically. Not supported
            ...
            /**
             * @param complianceLevel A compliance severity level for all approved patches in a
             *   patch baseline. Valid compliance severity levels include the following:
             *   `UNSPECIFIED` , `CRITICAL` , `HIGH` , `MEDIUM` , `LOW` , and `INFORMATIONAL` .
             */
            public fun complianceLevel(complianceLevel: String)

            /**
             * @param enableNonSecurity For managed nodes identified by the approval rule filters,
             *   enables a patch baseline to apply non-security updates available in the specified
             *   repository. The default value is `false` . Applies to Linux managed nodes only.
             */
            ...
            /**
             * @param patchFilterGroup The patch filter group that defines the criteria for the
             *   rule.
             */
            ...
            public fun patchFilterGroup(
                patchFilterGroup: PatchFilterGroupProperty.Builder.() -> Unit
            )
        }
        ...
        internal constructor(
             ...
             * The cutoff date for auto approval of released patches.
             *
             * Any patches released on or before this date are installed automatically. Not
             ...
             * to apply non-security updates available in the specified repository.
             *
             * The default value is `false` . Applies to Linux managed nodes only.
             *
             * Default: - false
