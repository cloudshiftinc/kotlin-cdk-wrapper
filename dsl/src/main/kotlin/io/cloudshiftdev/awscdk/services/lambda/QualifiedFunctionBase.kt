...
internal constructor(
     ...
     * @param _action
     */
    public override fun considerWarningOnInvokeFunctionPermissions(
        _scope: Construct,
        _action: String
    ) {
        unwrap(this)
            .considerWarningOnInvokeFunctionPermissions(_scope.let(Construct::unwrap), _action)
    }
