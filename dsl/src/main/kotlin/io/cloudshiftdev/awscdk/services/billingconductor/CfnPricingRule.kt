...
internal constructor(
    ...
    public interface Builder {
        /**
         * The seller of services provided by AWS , their affiliates, or third-party providers
         * selling services via AWS Marketplace .
         *
         ...
         *
         * @param service If the `Scope` attribute is `SERVICE` , this attribute indicates which
         ...
         *
         * @param tags A map that contains tag keys and tag values that are attached to a pricing
         *   rule.
         */
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.billingconductor.CfnPricingRule.Builder.create(
                scope,
                id
            )
