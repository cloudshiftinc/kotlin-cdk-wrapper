...
public interface ReceiptRuleActionConfig {
    ...
    public fun snsAction(): SNSActionConfig? =
    ...
    public interface Builder {
         ...
         *   sender and, optionally, publishes a notification to Amazon SNS.
         */
        ...
        /**
         * @param s3Action Saves the received message to an Amazon S3 bucket and, optionally,
         *   publishes a notification to Amazon SNS.
         */
    ...
    private class BuilderImpl : Builder {
        ...
        override fun addHeaderAction(
            addHeaderAction: AddHeaderActionConfig.Builder.() -> Unit
    ...
    internal constructor(
        ...
        /**
         * Saves the received message to an Amazon S3 bucket and, optionally, publishes a
         * notification to Amazon SNS.
         */
        override fun s3Action(): S3ActionConfig? =
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: ReceiptRuleActionConfig
