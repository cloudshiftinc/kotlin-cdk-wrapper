...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.route53.PublicHostedZone,
    ...
    public open fun addDelegation(`delegate`: IPublicHostedZone, opts: ZoneDelegationOptions) {
        unwrap(this)
            .addDelegation(
                `delegate`.let(IPublicHostedZone::unwrap),
    ...
    public open fun addDelegation(
        `delegate`: IPublicHostedZone,
        opts: ZoneDelegationOptions.Builder.() -> Unit
    ): Unit = addDelegation(`delegate`, ZoneDelegationOptions(opts))
    ...
    public interface Builder {
         ...
         * Default: false
         *
         * @param caaAmazon Whether to create a CAA record to restrict certificate authorities
         *   allowed to issue certificates for this domain to Amazon only.
         */
         ...
         * assumed by the `CrossAccountZoneDelegationRecord` to create a delegation record to a zone
         * in a different account.
         *
         * Be sure to indicate the account(s) that you trust to create delegation records, using
         * either `iam.AccountPrincipal` or `iam.OrganizationPrincipal`.
         *
         * If you are planning to use `iam.ServicePrincipal`s here, be sure to include
         * region-specific service principals for every opt-in region you are going to be delegating
         * to; or don't use this feature and create separate roles with appropriate permissions for
         * every opt-in region instead.
         *
         * Default: - No delegation configuration
         *
         * @param crossAccountZoneDelegationPrincipal A principal which is trusted to assume a role
         *   for zone delegation.
        ...
        /**
         * The Amazon Resource Name (ARN) for the log group that you want Amazon Route 53 to send
         * query logs to.
         *
         * Default: disabled
         *
         * @param queryLogsLogGroupArn The Amazon Resource Name (ARN) for the log group that you
         ...
         *
         * For resource record types that include a domain name, specify a fully qualified domain
         * name.
         *
    ...
    private class BuilderImpl(
         ...
         */
        @Deprecated(message = "deprecated in CDK")
        override fun crossAccountZoneDelegationPrincipal(
            crossAccountZoneDelegationPrincipal: IPrincipal
        ) {
            cdkBuilder.crossAccountZoneDelegationPrincipal(
                crossAccountZoneDelegationPrincipal.let(IPrincipal::unwrap)
            )
        }
         ...
         */
        @Deprecated(message = "deprecated in CDK")
        override fun crossAccountZoneDelegationRoleName(
            crossAccountZoneDelegationRoleName: String
        ) {
    ...
    public companion object {
        public fun fromPublicHostedZoneAttributes(
            ...
            software.amazon.awscdk.services.route53.PublicHostedZone.fromPublicHostedZoneAttributes(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    attrs.let(PublicHostedZoneAttributes::unwrap)
                )
                .let(IPublicHostedZone::wrap)
        ...
        public fun fromPublicHostedZoneAttributes(
            ...
            fromPublicHostedZoneAttributes(scope, id, PublicHostedZoneAttributes(attrs))
        ...
        public fun fromPublicHostedZoneId(
            ...
            software.amazon.awscdk.services.route53.PublicHostedZone.fromPublicHostedZoneId(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    publicHostedZoneId
                )
