...
public interface GitPushFilter {
    ...
    public interface Builder {
        /**
         * @param tagsExcludes The list of patterns of Git tags that, when pushed, are to be
         *   excluded from starting the pipeline. You can filter with glob patterns. The
         *   `tagsExcludes` takes priority over the `tagsIncludes`.
         *
         * Maximum length of this array is 8.
         */
        ...
        /**
         * @param tagsIncludes The list of patterns of Git tags that, when pushed, are to be
         *   included as criteria that starts the pipeline. You can filter with glob patterns. The
         *   `tagsExcludes` takes priority over the `tagsIncludes`.
         *
         * Maximum length of this array is 8.
         */
    ...
    internal constructor(
         ...
         * pipeline.
         *
         * You can filter with glob patterns. The `tagsExcludes` takes priority over the
         * `tagsIncludes`.
         *
         * Maximum length of this array is 8.
         *
