...
public enum class BillingMode(
    ...
    public companion object {
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.dynamodb.BillingMode
        ): BillingMode =
            when (cdkObject) {
                software.amazon.awscdk.services.dynamodb.BillingMode.PAY_PER_REQUEST ->
                    BillingMode.PAY_PER_REQUEST
                software.amazon.awscdk.services.dynamodb.BillingMode.PROVISIONED ->
                    BillingMode.PROVISIONED
            }

        internal fun unwrap(
            wrapped: BillingMode
        ): software.amazon.awscdk.services.dynamodb.BillingMode = wrapped.cdkObject
    }
}
