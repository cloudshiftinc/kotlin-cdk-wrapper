...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param template The content of the email, composed of a subject line and either an HTML
    ...
    public interface TemplateProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param textPart The email body that is visible to recipients whose email clients do
