...
internal constructor(
    ...
    public open fun autoStartConfiguration(
        `value`: AutoStartConfigurationProperty.Builder.() -> Unit
    ): Unit = autoStartConfiguration(AutoStartConfigurationProperty(`value`))
    ...
    public open fun autoStopConfiguration(
        `value`: AutoStopConfigurationProperty.Builder.() -> Unit
    ...
    public open fun imageConfiguration(
        `value`: ImageConfigurationInputProperty.Builder.() -> Unit
    ...
    public open fun maximumCapacity(
        `value`: MaximumAllowedResourcesProperty.Builder.() -> Unit
    ): Unit = maximumCapacity(MaximumAllowedResourcesProperty(`value`))
    ...
    public open fun monitoringConfiguration(`value`: MonitoringConfigurationProperty) {
        unwrap(this)
            .setMonitoringConfiguration(`value`.let(MonitoringConfigurationProperty::unwrap))
    }

    /** A configuration specification to be used when provisioning an application. */
    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("c39356bc0b1fa81077db85b0c7c39c0829552e93ffe5172168c20f97681816b0")
    public open fun monitoringConfiguration(
        `value`: MonitoringConfigurationProperty.Builder.() -> Unit
    ): Unit = monitoringConfiguration(MonitoringConfigurationProperty(`value`))
    ...
    public interface Builder {
         ...
         *
         * @param autoStartConfiguration The configuration for an application to automatically start
         *   on job submission.
         */
        ...
        public fun autoStartConfiguration(
            autoStartConfiguration: AutoStartConfigurationProperty.Builder.() -> Unit
        )
         ...
         *
         * @param autoStopConfiguration The configuration for an application to automatically stop
        ...
        public fun autoStopConfiguration(
            autoStopConfiguration: AutoStopConfigurationProperty.Builder.() -> Unit
        )
        ...
        public fun imageConfiguration(
            imageConfiguration: ImageConfigurationInputProperty.Builder.() -> Unit
        )
         ...
         * the application is created. No new resources will be created once any one of the defined
         * limits is hit.
         *
        ...
        public fun maximumCapacity(
            maximumCapacity: MaximumAllowedResourcesProperty.Builder.() -> Unit
        )
         ...
         *
         * @param monitoringConfiguration A configuration specification to be used when provisioning
         *   an application.
         */
         ...
         *
         * @param networkConfiguration The network configuration for customer VPC connectivity for
         *   the application.
         */
    ...
    private class BuilderImpl(
         ...
         *   on job submission.
         */
        override fun autoStartConfiguration(
            autoStartConfiguration: AutoStartConfigurationProperty
        ) {
            cdkBuilder.autoStartConfiguration(
                autoStartConfiguration.let(AutoStartConfigurationProperty::unwrap)
            )
        }
        ...
        override fun autoStopConfiguration(autoStopConfiguration: AutoStopConfigurationProperty) {
            cdkBuilder.autoStopConfiguration(
                autoStopConfiguration.let(AutoStopConfigurationProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("7d640017ae5c55847f0b88c39709b93ad9217e264081c45ad93a0f20c4adc60a")
        override fun autoStopConfiguration(
            autoStopConfiguration: AutoStopConfigurationProperty.Builder.() -> Unit
        ...
        override fun imageConfiguration(imageConfiguration: ImageConfigurationInputProperty) {
            cdkBuilder.imageConfiguration(
                imageConfiguration.let(ImageConfigurationInputProperty::unwrap)
            )
        }
    ...
    public interface AutoStopConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param enabled If set to true, the Application will automatically stop after being
            ...
            /**
             * @param idleTimeoutMinutes The amount of time [in minutes] to wait before auto
             *   stopping the Application when idle. Defaults to 15 minutes.
             */
        ...
        internal constructor(
            ...
            /**
             * The amount of time [in minutes] to wait before auto stopping the Application when
             * idle.
             *
             * Defaults to 15 minutes.
             *
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AutoStopConfigurationProperty
            ): software.amazon.awscdk.services.emrserverless.CfnApplication.AutoStopConfigurationProperty =
    ...
    public interface MonitoringConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param cloudWatchLoggingConfiguration The Amazon CloudWatch configuration for
             *   monitoring logs. You can configure your jobs to send log information to CloudWatch
             *   .
             */
            ...
            public fun cloudWatchLoggingConfiguration(
                cloudWatchLoggingConfiguration:
                    CloudWatchLoggingConfigurationProperty.Builder.() -> Unit
            )

            /**
             * @param managedPersistenceMonitoringConfiguration The managed log persistence
            ...
            public fun managedPersistenceMonitoringConfiguration(
                managedPersistenceMonitoringConfiguration:
                    ManagedPersistenceMonitoringConfigurationProperty.Builder.() -> Unit
            )

            /**
             * @param s3MonitoringConfiguration The Amazon S3 configuration for monitoring log
             *   publishing.
             */
            ...
            public fun s3MonitoringConfiguration(
                s3MonitoringConfiguration: S3MonitoringConfigurationProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
             ...
             *   .
             */
            override fun cloudWatchLoggingConfiguration(
                cloudWatchLoggingConfiguration: IResolvable
            ) {
                cdkBuilder.cloudWatchLoggingConfiguration(
                    cloudWatchLoggingConfiguration.let(IResolvable::unwrap)
                )
            }
            ...
            override fun cloudWatchLoggingConfiguration(
                ...
                cdkBuilder.cloudWatchLoggingConfiguration(
                    cloudWatchLoggingConfiguration.let(
                        CloudWatchLoggingConfigurationProperty::unwrap
                    )
                )
            }
            ...
            override fun cloudWatchLoggingConfiguration(
                ...
                cloudWatchLoggingConfiguration(
                    CloudWatchLoggingConfigurationProperty(cloudWatchLoggingConfiguration)
                )
             ...
             *   configuration for a job run.
             */
            override fun managedPersistenceMonitoringConfiguration(
                managedPersistenceMonitoringConfiguration: IResolvable
            ) {
                cdkBuilder.managedPersistenceMonitoringConfiguration(
                    managedPersistenceMonitoringConfiguration.let(IResolvable::unwrap)
                )
            }
            ...
            override fun managedPersistenceMonitoringConfiguration(
                ...
                cdkBuilder.managedPersistenceMonitoringConfiguration(
                    managedPersistenceMonitoringConfiguration.let(
                        ManagedPersistenceMonitoringConfigurationProperty::unwrap
                    )
                )
            }
            ...
            override fun s3MonitoringConfiguration(s3MonitoringConfiguration: IResolvable) {
                cdkBuilder.s3MonitoringConfiguration(
                    s3MonitoringConfiguration.let(IResolvable::unwrap)
                )
            }
             ...
             *   publishing.
             */
            override fun s3MonitoringConfiguration(
                s3MonitoringConfiguration: S3MonitoringConfigurationProperty
            ) {
                cdkBuilder.s3MonitoringConfiguration(
                    s3MonitoringConfiguration.let(S3MonitoringConfigurationProperty::unwrap)
                )
            }
            ...
            override fun s3MonitoringConfiguration(
                ...
                s3MonitoringConfiguration(
                    S3MonitoringConfigurationProperty(s3MonitoringConfiguration)
                )
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-emrserverless-application-monitoringconfiguration.html#cfn-emrserverless-application-monitoringconfiguration-s3monitoringconfiguration)
             */
            override fun s3MonitoringConfiguration(): Any? =
                unwrap(this).getS3MonitoringConfiguration()
        }
    ...
    public interface MaximumAllowedResourcesProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: MaximumAllowedResourcesProperty
            ): software.amazon.awscdk.services.emrserverless.CfnApplication.MaximumAllowedResourcesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CloudWatchLoggingConfigurationProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param encryptionKeyArn The AWS Key Management Service (KMS) key ARN to encrypt the
             *   logs that you store in CloudWatch Logs .
             */
            public fun encryptionKeyArn(encryptionKeyArn: String)

            /**
             * @param logGroupName The name of the log group in Amazon CloudWatch Logs where you
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CloudWatchLoggingConfigurationProperty
            ): software.amazon.awscdk.services.emrserverless.CfnApplication.CloudWatchLoggingConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface NetworkConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param securityGroupIds The array of security group Ids for customer VPC
             *   connectivity.
             */
    ...
    public interface ConfigurationObjectProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ConfigurationObjectProperty
            ): software.amazon.awscdk.services.emrserverless.CfnApplication.ConfigurationObjectProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface WorkerConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param cpu Per worker CPU resource. vCPU is the only supported unit and specifying
             *   vCPU is optional.
             */
            public fun cpu(cpu: String)

            /**
             * @param disk Per worker Disk resource. GB is the only supported unit and specifying GB
             *   is optional
             */
            public fun disk(disk: String)

            /**
             * @param memory Per worker memory resource. GB is the only supported unit and
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: WorkerConfigurationProperty
            ): software.amazon.awscdk.services.emrserverless.CfnApplication.WorkerConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ImageConfigurationInputProperty {
         ...
         *
         * This field is required when you create a new application. If you leave this field blank
         * in an update, Amazon EMR will remove the image configuration.
         *
        ...
        public interface Builder {
            /**
             * @param imageUri The URI of an image in the Amazon ECR registry. This field is
             *   required when you create a new application. If you leave this field blank in an
        ...
        internal constructor(
             ...
             * The URI of an image in the Amazon ECR registry.
             *
             * This field is required when you create a new application. If you leave this field
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ImageConfigurationInputProperty
            ): software.amazon.awscdk.services.emrserverless.CfnApplication.ImageConfigurationInputProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface InitialCapacityConfigKeyValuePairProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: InitialCapacityConfigKeyValuePairProperty
            ): software.amazon.awscdk.services.emrserverless.CfnApplication.InitialCapacityConfigKeyValuePairProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface InitialCapacityConfigProperty {
        ...
        public interface Builder {
            ...
            public fun workerConfiguration(
                workerConfiguration: WorkerConfigurationProperty.Builder.() -> Unit
            )
        ...
        private class BuilderImpl : Builder {
            ...
            override fun workerConfiguration(workerConfiguration: WorkerConfigurationProperty) {
                cdkBuilder.workerConfiguration(
                    workerConfiguration.let(WorkerConfigurationProperty::unwrap)
                )
            }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: InitialCapacityConfigProperty
            ): software.amazon.awscdk.services.emrserverless.CfnApplication.InitialCapacityConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface S3MonitoringConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param encryptionKeyArn The KMS key ARN to encrypt the logs published to the given
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: S3MonitoringConfigurationProperty
            ): software.amazon.awscdk.services.emrserverless.CfnApplication.S3MonitoringConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface WorkerTypeSpecificationInputProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: WorkerTypeSpecificationInputProperty
            ): software.amazon.awscdk.services.emrserverless.CfnApplication.WorkerTypeSpecificationInputProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface AutoStartConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param enabled If set to true, the Application will automatically start. Defaults to
             *   true.
             */
            public fun enabled(enabled: Boolean)
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AutoStartConfigurationProperty
            ): software.amazon.awscdk.services.emrserverless.CfnApplication.AutoStartConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ManagedPersistenceMonitoringConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param enabled Enables managed logging and defaults to true. If set to false, managed
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ManagedPersistenceMonitoringConfigurationProperty
            ): software.amazon.awscdk.services.emrserverless.CfnApplication.ManagedPersistenceMonitoringConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface LogTypeMapKeyValuePairProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param value List of Applicable values:
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: LogTypeMapKeyValuePairProperty
            ): software.amazon.awscdk.services.emrserverless.CfnApplication.LogTypeMapKeyValuePairProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
