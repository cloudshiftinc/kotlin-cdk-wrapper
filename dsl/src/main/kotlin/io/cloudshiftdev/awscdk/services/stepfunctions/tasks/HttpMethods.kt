...
public enum class HttpMethods(
    ...
    public companion object {
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.HttpMethods
        ): HttpMethods =
            when (cdkObject) {
                software.amazon.awscdk.services.stepfunctions.tasks.HttpMethods.GET ->
                    HttpMethods.GET
                software.amazon.awscdk.services.stepfunctions.tasks.HttpMethods.POST ->
                    HttpMethods.POST
                software.amazon.awscdk.services.stepfunctions.tasks.HttpMethods.PUT ->
                    HttpMethods.PUT
                software.amazon.awscdk.services.stepfunctions.tasks.HttpMethods.DELETE ->
                    HttpMethods.DELETE
                software.amazon.awscdk.services.stepfunctions.tasks.HttpMethods.PATCH ->
                    HttpMethods.PATCH
                software.amazon.awscdk.services.stepfunctions.tasks.HttpMethods.HEAD ->
                    HttpMethods.HEAD
            }
