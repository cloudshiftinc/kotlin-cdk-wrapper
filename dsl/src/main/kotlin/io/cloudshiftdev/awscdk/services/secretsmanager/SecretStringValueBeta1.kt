...
public open class SecretStringValueBeta1 internal constructor(
  ...
  public companion object {
    @Deprecated(message = "deprecated in CDK")
    public open fun fromToken(secretValueFromToken: String): SecretStringValueBeta1 =
    ...
    @Deprecated(message = "deprecated in CDK")
    public open fun fromUnsafePlaintext(secretValue: String): SecretStringValueBeta1 =
