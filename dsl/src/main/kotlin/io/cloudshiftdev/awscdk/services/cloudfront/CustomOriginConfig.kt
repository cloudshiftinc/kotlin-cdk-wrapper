...
public interface CustomOriginConfig {
    ...
    public interface Builder {
        ...
        /**
         * @param domainName The domain name of the custom origin. Should not include the path -
         *   that should be in the parent SourceConfiguration
         */
        ...
        /**
         * @param originProtocolPolicy The protocol (http or https) policy to use when interacting
         *   with the origin.
         */
    ...
    private class BuilderImpl : Builder {
        ...
        override fun allowedOriginSslVersions(allowedOriginSslVersions: List<OriginSslPolicy>) {
            cdkBuilder.allowedOriginSslVersions(
                allowedOriginSslVersions.map(OriginSslPolicy::unwrap)
            )
        }
         ...
         * @param allowedOriginSslVersions The SSL versions to use when interacting with the origin.
         */
        override fun allowedOriginSslVersions(
            vararg allowedOriginSslVersions: OriginSslPolicy
        ): Unit = allowedOriginSslVersions(allowedOriginSslVersions.toList())
    ...
    internal constructor(
         ...
         * Default: - No additional headers are passed.
         */
        override fun originHeaders(): Map<String, String> =
            unwrap(this).getOriginHeaders() ?: emptyMap()
