...
public interface WebSocketRouteIntegrationBindOptions {
     ...
     *
     * If the `WebSocketRouteIntegration` being bound creates additional constructs, this will be
    ...
    public interface Builder {
         ...
         *   `WebSocketRouteIntegration` being bound creates additional constructs, this will be
         *   used as their parent scope.
         */
    ...
    internal constructor(
         ...
         * The current scope in which the bind is occurring.
         *
         * If the `WebSocketRouteIntegration` being bound creates additional constructs, this will
         * be used as their parent scope.
         */
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: WebSocketRouteIntegrationBindOptions
        ): software.amazon.awscdk.services.apigatewayv2.WebSocketRouteIntegrationBindOptions =
