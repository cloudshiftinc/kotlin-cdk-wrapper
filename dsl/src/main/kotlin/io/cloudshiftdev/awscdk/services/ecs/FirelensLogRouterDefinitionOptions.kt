...
public interface FirelensLogRouterDefinitionOptions : ContainerDefinitionOptions {
    ...
    /** A builder for [FirelensLogRouterDefinitionOptions] */
    @CdkDslMarker
    public interface Builder {
        /**
         * @param command The command that is passed to the container. If you provide a shell
         *   command as a single string, you have to quote command-line arguments.
         */
         ...
         *   (`CredSpec`) file that configures the container for Active Directory authentication. We
         *   recommend that you use this parameter instead of the `dockerSecurityOptions`.
         *
         ...
         *   parameter of a container is marked as false, then its failure does not affect the rest
         *   of the containers in a task. All tasks must have at least one essential container.
         *
        ...
        /**
         * @param healthCheck The health check command and associated configuration parameters for
         *   the container.
         */
        ...
        /**
         * @param inferenceAcceleratorResources The inference accelerators referenced by the
         *   container.
         */
        ...
        /**
         * @param linuxParameters Linux-specific modifications that are applied to the container,
         ...
         *
         * At least one of memoryLimitMiB and memoryReservationMiB is required for non-Fargate
         * services.
         */
        public fun memoryLimitMiB(memoryLimitMiB: Number)

        /**
         * @param memoryReservationMiB The soft limit (in MiB) of memory to reserve for the
         *   container. When system memory is under heavy contention, Docker attempts to keep the
         *   container memory to this soft limit. However, your container can consume more memory
         *   when it needs to, up to either the hard limit specified with the memory parameter (if
         *   applicable), or all of the available memory on the container instance, whichever comes
         *   first.
         *
         * At least one of memoryLimitMiB and memoryReservationMiB is required for non-Fargate
         * services.
        ...
        /**
         * @param pseudoTerminal When this parameter is true, a TTY is allocated. This parameter
         *   maps to Tty in the "Create a container section" of the Docker Remote API and the --tty
         ...
         *   read-only access to its root file system.
         */
         ...
         *   Create a container section of the Docker Remote API and the --user option to docker
         *   run.
         */
        public fun user(user: String)

        /**
         * @param workingDirectory The working directory in which to run commands inside the
         *   container.
         */
    ...
    private class BuilderImpl : Builder {
         ...
         *   container.
         */
        override fun inferenceAcceleratorResources(
            vararg inferenceAcceleratorResources: String
        ): Unit = inferenceAcceleratorResources(inferenceAcceleratorResources.toList())
    ...
    internal constructor(
         ...
         *
         * If you provide a shell command as a single string, you have to quote command-line
         * arguments.
         *
         ...
         * Default: - No labels.
         */
        override fun dockerLabels(): Map<String, String> =
            unwrap(this).getDockerLabels() ?: emptyMap()
         ...
         * the rest of the containers in a task. All tasks must have at least one essential
         * container.
         *
         * If this parameter is omitted, a container is assumed to be essential.
         *
         ...
         *
         * This string is passed directly to the Docker daemon. Images in the Docker Hub registry
         * are available by default. Other repositories are specified with either
         ...
         * all of the available memory on the container instance, whichever comes first.
         *
         * At least one of memoryLimitMiB and memoryReservationMiB is required for non-Fargate
         * services.
         *
         ...
         *
         * This parameter maps to Tty in the "Create a container section" of the Docker Remote API
        ...
        override fun ulimits(): List<Ulimit> =
            unwrap(this).getUlimits()?.map(Ulimit::wrap) ?: emptyList()

        /**
         * The user to use inside the container.
         *
         * This parameter maps to User in the Create a container section of the Docker Remote API
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: FirelensLogRouterDefinitionOptions
        ): software.amazon.awscdk.services.ecs.FirelensLogRouterDefinitionOptions =
