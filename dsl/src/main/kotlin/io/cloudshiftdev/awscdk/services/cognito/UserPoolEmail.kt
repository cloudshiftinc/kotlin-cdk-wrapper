...
internal constructor(
    ...
    public companion object {
        public fun withCognito(): UserPoolEmail =
            software.amazon.awscdk.services.cognito.UserPoolEmail.withCognito()
                .let(UserPoolEmail::wrap)

        public fun withCognito(replyTo: String): UserPoolEmail =
            software.amazon.awscdk.services.cognito.UserPoolEmail.withCognito(replyTo)
                .let(UserPoolEmail::wrap)

        public fun withSes(options: UserPoolSESOptions): UserPoolEmail =
            software.amazon.awscdk.services.cognito.UserPoolEmail.withSES(
                    options.let(UserPoolSESOptions::unwrap)
                )
                .let(UserPoolEmail::wrap)
