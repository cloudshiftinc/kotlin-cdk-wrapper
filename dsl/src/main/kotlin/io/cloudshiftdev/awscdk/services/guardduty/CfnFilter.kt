...
internal constructor(
    ...
    public interface Builder {
        ...
        /**
         * The ID of the detector belonging to the GuardDuty account that you want to create a
         * filter for.
         *
         ...
         *
         * @param detectorId The ID of the detector belonging to the GuardDuty account that you want
         ...
         * The name of the filter.
         *
         * Valid characters include period (.), underscore (_), dash (-), and alphanumeric
         ...
         * Specifies the position of the filter in the list of current filters.
         *
         * Also specifies the order in which this filter is applied to the findings. The minimum
    ...
    private class BuilderImpl(
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("931a05aefa29d36a8fd2cb68df3a2abeaf89aabac29d1179200ca079a5c9fc6f")
        override fun findingCriteria(
            findingCriteria: FindingCriteriaProperty.Builder.() -> Unit
        ): Unit = findingCriteria(FindingCriteriaProperty(findingCriteria))
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnFilter
        ): software.amazon.awscdk.services.guardduty.CfnFilter = wrapped.cdkObject
    }
    ...
    public interface ConditionProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param equalTo Represents an *equal* ** condition to be applied to a single field
            ...
            /**
             * @param greaterThan Represents a *greater than* condition to be applied to a single
             *   field when querying for findings.
             */
            public fun greaterThan(greaterThan: Number)

            /**
             * @param greaterThanOrEqual Represents a *greater than or equal* condition to be
            ...
            /**
             * @param gte Represents the greater than or equal condition to apply to a single field
             *   when querying for findings.
             */
            public fun gte(gte: Number)

            /**
             * @param lessThan Represents a *less than* condition to be applied to a single field
             *   when querying for findings.
             */
            ...
            /**
             * @param lt Represents the less than condition to apply to a single field when querying
             *   for findings.
             */
            public fun lt(lt: Number)

            /**
             * @param lte Represents the less than or equal condition to apply to a single field
             *   when querying for findings.
             */
            public fun lte(lte: Number)

            /**
             * @param neq Represents the not equal condition to apply to a single field when
             *   querying for findings.
             */
            ...
            /**
             * @param notEquals Represents a *not equal* ** condition to be applied to a single
             *   field when querying for findings.
             */
        ...
        internal constructor(
            ...
            /**
             * Represents the less than or equal condition to apply to a single field when querying
             * for findings.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-guardduty-filter-condition.html#cfn-guardduty-filter-condition-lte)
             */
    ...
    public interface FindingCriteriaProperty {
        ...
        public interface Builder {
            /**
             * @param criterion Represents a map of finding properties that match specified
             *   conditions and values when querying findings. For information about JSON criterion
             *   mapping to their console equivalent, see
             *   [Finding criteria](https://docs.aws.amazon.com/guardduty/latest/ug/guardduty_filter-findings.html#filter_criteria)
             *   . The following are the available criterion:
             * * accountId
             * * id
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: FindingCriteriaProperty
            ): software.amazon.awscdk.services.guardduty.CfnFilter.FindingCriteriaProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
