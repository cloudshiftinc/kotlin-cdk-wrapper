...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * This allows the Step Functions UI to link child executions from parent executions, making
         * it easier to trace execution flow across state machines.
         *
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: StepFunctionsStartExecution
        ): software.amazon.awscdk.services.stepfunctions.tasks.StepFunctionsStartExecution =
            wrapped.cdkObject
    }
}
