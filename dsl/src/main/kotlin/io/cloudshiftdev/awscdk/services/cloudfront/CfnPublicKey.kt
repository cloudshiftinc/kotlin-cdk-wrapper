...
internal constructor(
    ...
    private class BuilderImpl(
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("42e777796ad459c33fdafc47fe4a817807ae20a6174a38d3aa3ff93558bc3272")
        override fun publicKeyConfig(
            publicKeyConfig: PublicKeyConfigProperty.Builder.() -> Unit
        ): Unit = publicKeyConfig(PublicKeyConfigProperty(publicKeyConfig))

        public fun build(): software.amazon.awscdk.services.cloudfront.CfnPublicKey =
            cdkBuilder.build()
    }
    ...
    public interface PublicKeyConfigProperty {
        ...
        public interface Builder {
            /**
             * @param callerReference A string included in the request to help make sure that the
             *   request can't be replayed.
             */
            public fun callerReference(callerReference: String)

            /**
             * @param comment A comment to describe the public key. The comment cannot be longer
             *   than 128 characters.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: PublicKeyConfigProperty
            ): software.amazon.awscdk.services.cloudfront.CfnPublicKey.PublicKeyConfigProperty =
