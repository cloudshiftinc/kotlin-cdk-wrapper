...
public interface ServiceConnectService {
     ...
     * for Service Connect.
     *
     * A value of 0 can be set to disable `perRequestTimeout`. Can only be set when the
     * `appProtocol` for the application container is HTTP/HTTP2/GRPC.
     *
     * If `idleTimeout` is set to a time that is less than `perRequestTimeout`, the connection will
     * close when the `idleTimeout` is reached and not the `perRequestTimeout`.
     *
    ...
    public interface Builder {
         ...
         *   CloudMap namespace. This is required if you wish to use the same port mapping name in
         *   more than one service.
         */
        public fun discoveryName(discoveryName: String)

        /**
         * @param dnsName The terse DNS alias to use for this port mapping in the service connect
         *   mesh. Service Connect-enabled clients will be able to reach this service at
         *   http://dnsName:port.
         */
        public fun dnsName(dnsName: String)

        /**
         * @param idleTimeout The amount of time in seconds a connection for Service Connect will
         *   stay active while idle. A value of 0 can be set to disable `idleTimeout`.
         *
        ...
        /**
         * @param ingressPortOverride Optional. The port on the Service Connect agent container to
         *   use for traffic ingress to this service.
         */
         ...
         *   `perRequestTimeout`. Can only be set when the `appProtocol` for the application
         *   container is HTTP/HTTP2/GRPC.
         *
         * If `idleTimeout` is set to a time that is less than `perRequestTimeout`, the connection
         * will close when the `idleTimeout` is reached and not the `perRequestTimeout`.
         */
        ...
        /**
         * @param port The port for clients to use to communicate with this service via Service
         *   Connect.
         */
        public fun port(port: Number)

        /**
         * @param portMappingName portMappingName specifies which port and protocol combination
         *   should be used for this service connect service.
         */
    ...
    internal constructor(
         ...
         * http://dnsName:port.
         *
         * Default: - No alias is created. The service is reachable at
         * `portMappingName.namespace:port`.
         */
        override fun dnsName(): String? = unwrap(this).getDnsName()

        /**
         * The amount of time in seconds a connection for Service Connect will stay active while
         * idle.
         *
         * A value of 0 can be set to disable `idleTimeout`.
         *
         ...
         * Optional.
         *
         * The port on the Service Connect agent container to use for traffic ingress to this
         * service.
         *
         * Default: - none
         */
