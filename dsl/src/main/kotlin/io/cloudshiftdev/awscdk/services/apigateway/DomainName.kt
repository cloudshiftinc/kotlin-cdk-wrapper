...
internal constructor(
    ...
    public open fun addApiMapping(targetStage: IStage, options: ApiMappingOptions) {
        unwrap(this)
            .addApiMapping(targetStage.let(IStage::unwrap), options.let(ApiMappingOptions::unwrap))
    }
    ...
    public open fun addApiMapping(
        targetStage: IStage,
        options: ApiMappingOptions.Builder.() -> Unit
     ...
     * @param options Options for mapping to base path with or without a stage.
     */
    public open fun addBasePathMapping(
        targetApi: IRestApi,
        options: BasePathMappingOptions
    ): BasePathMapping =
        unwrap(this)
            .addBasePathMapping(
                targetApi.let(IRestApi::unwrap),
                options.let(BasePathMappingOptions::unwrap)
            )
            .let(BasePathMapping::wrap)
    ...
    public open fun addBasePathMapping(
        targetApi: IRestApi,
        options: BasePathMappingOptions.Builder.() -> Unit
    ): BasePathMapping = addBasePathMapping(targetApi, BasePathMappingOptions(options))
    ...
    public interface Builder {
         ...
         *   edge-optimized endpoint for the domain name.
         */
        ...
        /**
         * If specified, all requests to this domain will be mapped to the production deployment of
         * this API.
         *
         * If you wish to map this domain to multiple APIs with different base paths, use
         * `addBasePathMapping` or `addApiMapping`.
         *
         * Default: - you will have to call `addBasePathMapping` to map this domain to API
         * endpoints.
         *
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.apigateway.DomainName =
            cdkBuilder.build()
    }
    ...
    public companion object {
        public fun fromDomainNameAttributes(
            ...
            software.amazon.awscdk.services.apigateway.DomainName.fromDomainNameAttributes(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    attrs.let(DomainNameAttributes::unwrap)
                )
                .let(IDomainName::wrap)
        ...
        internal fun unwrap(
            wrapped: DomainName
        ): software.amazon.awscdk.services.apigateway.DomainName = wrapped.cdkObject
    }
}
