...
public interface CustomActionProperty {
    ...
    public interface Builder {
        ...
        /**
         * @param name The name of the property. You use this name in the `configuration` attribute
         *   when defining your custom Action class.
         */
        public fun name(name: String)

        /**
         * @param queryable Whether this property is queryable. Note that only a single property of
         *   a custom Action can be queryable.
         */
    ...
    internal constructor(
         ...
         * The name of the property.
         *
         * You use this name in the `configuration` attribute when defining your custom Action
         * class.
         */
