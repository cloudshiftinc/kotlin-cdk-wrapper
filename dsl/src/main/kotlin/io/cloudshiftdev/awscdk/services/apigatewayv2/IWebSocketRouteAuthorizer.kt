...
public interface IWebSocketRouteAuthorizer {
    ...
    public fun bind(
        options: WebSocketRouteAuthorizerBindOptions.Builder.() -> Unit
    ...
    internal constructor(
        ...
        override fun bind(
            ...
            unwrap(this)
                .bind(options.let(WebSocketRouteAuthorizerBindOptions::unwrap))
                .let(WebSocketRouteAuthorizerConfig::wrap)
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: IWebSocketRouteAuthorizer
        ): software.amazon.awscdk.services.apigatewayv2.IWebSocketRouteAuthorizer =
