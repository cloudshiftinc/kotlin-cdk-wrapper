...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.waf.CfnByteMatchSet,
    ...
    public interface Builder {
         ...
         *
         * @param byteMatchTuples Specifies the bytes (typically a string that corresponds with
         *   ASCII characters) that you want AWS WAF to search for in web requests, the location in
    ...
    public interface ByteMatchTupleProperty {
         ...
         *
         * AWS WAF searches for the specified string in the part of web requests that you specified
         ...
         *   request body are forwarded to AWS WAF for inspection. To allow or block requests based
         *   on the length of the body, you can create a size constraint set.
         ...
         *   parameter, AWS WAF inspects all parameters within the query string for the value or
        ...
        /**
         * The base64-encoded value that AWS WAF searches for. AWS CloudFormation sends this value
         * to AWS WAF without encoding it.
         *
         * You must specify this property or the `TargetString` property.
         *
         * AWS WAF searches for this value in a specific part of web requests, which you define in
         * the `FieldToMatch` property.
         *
         * Valid values depend on the Type value in the `FieldToMatch` property. For example, for a
         * `METHOD` type, you must specify HTTP methods such as `DELETE, GET, HEAD, OPTIONS, PATCH,
         * POST` , and `PUT` .
         *
        ...
        public interface Builder {
            /**
             * @param fieldToMatch The part of a web request that you want to inspect, such as a
            ...
            /**
             * @param positionalConstraint Within the portion of a web request that you want to
             *   search (for example, in the query string, if any), specify where you want AWS WAF
            ...
            /**
             * @param targetString The value that you want AWS WAF to search for. AWS WAF searches
             *   for the specified string in the part of web requests that you specified in
             ...
             *   `Referer` header.
             * * `METHOD` : The HTTP method, which indicates the type of operation specified in the
             *   request. Amazon CloudFront supports the following methods: `DELETE` , `GET` ,
             ...
             *   CloudFormation sends this value to AWS WAF without encoding it. You must specify
             *   this property or the `TargetString` property.
             *
             * AWS WAF searches for this value in a specific part of web requests, which you define
             * in the `FieldToMatch` property.
             *
             * Valid values depend on the Type value in the `FieldToMatch` property. For example,
             * for a `METHOD` type, you must specify HTTP methods such as `DELETE, GET, HEAD,
             * OPTIONS, PATCH, POST` , and `PUT` .
             */
            public fun targetStringBase64(targetStringBase64: String)

            /**
             * @param textTransformation Text transformations eliminate some of the unusual
             *   formatting that attackers use in web requests in an effort to bypass AWS WAF . If
             *   you specify a transformation, AWS WAF performs the transformation on `FieldToMatch`
             *   before inspecting it for a match.
             *
             * You can only specify a single type of TextTransformation.
             *
        ...
        internal constructor(
            ...
            /**
             * The part of a web request that you want to inspect, such as a specified header or a
             * query string.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-waf-bytematchset-bytematchtuple.html#cfn-waf-bytematchset-bytematchtuple-fieldtomatch)
             */
             ...
             * query string, if any), specify where you want AWS WAF to search.
             *
             * Valid values include the following:
             *
             * *CONTAINS*
             ...
             * The value that you want AWS WAF to search for.
             *
             * AWS WAF searches for the specified string in the part of web requests that you
             ...
             * value to AWS WAF without encoding it.
             *
             * You must specify this property or the `TargetString` property.
             *
             * AWS WAF searches for this value in a specific part of web requests, which you define
             ...
             * web requests in an effort to bypass AWS WAF .
             *
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ByteMatchTupleProperty
            ): software.amazon.awscdk.services.waf.CfnByteMatchSet.ByteMatchTupleProperty =
    ...
    public interface FieldToMatchProperty {
        ...
        public interface Builder {
            /**
             * @param data When the value of `Type` is `HEADER` , enter the name of the header that
             *   you want AWS WAF to search, for example, `User-Agent` or `Referer` . The name of
            ...
            /**
             * @param type The part of the web request that you want AWS WAF to search for a
             *   specified string. Parts of a request that you can search include the following:
