...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * For scale out policies, multiple scale outs during the cooldown period are squashed so
         * that only the biggest scale out happens.
         *
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.applicationautoscaling.StepScalingAction.Builder.create(
                scope,
                id
            )
