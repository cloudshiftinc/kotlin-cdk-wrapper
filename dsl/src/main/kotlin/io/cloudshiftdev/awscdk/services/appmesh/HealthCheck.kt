...
internal constructor(
    ...
    public open fun bind(scope: Construct, options: HealthCheckBindOptions): HealthCheckConfig =
        unwrap(this)
            .bind(scope.let(Construct::unwrap), options.let(HealthCheckBindOptions::unwrap))
            .let(HealthCheckConfig::wrap)
    ...
    public open fun bind(
        scope: Construct,
        options: HealthCheckBindOptions.Builder.() -> Unit
    ...
    public companion object {
        ...
        public fun grpc(options: GrpcHealthCheckOptions): HealthCheck =
            software.amazon.awscdk.services.appmesh.HealthCheck.grpc(
                    options.let(GrpcHealthCheckOptions::unwrap)
                )
                .let(HealthCheck::wrap)
        ...
        public fun http(options: HttpHealthCheckOptions): HealthCheck =
            software.amazon.awscdk.services.appmesh.HealthCheck.http(
                    options.let(HttpHealthCheckOptions::unwrap)
                )
                .let(HealthCheck::wrap)
        ...
        public fun http2(options: HttpHealthCheckOptions): HealthCheck =
            software.amazon.awscdk.services.appmesh.HealthCheck.http2(
                    options.let(HttpHealthCheckOptions::unwrap)
                )
                .let(HealthCheck::wrap)
        ...
        public fun tcp(options: TcpHealthCheckOptions): HealthCheck =
            software.amazon.awscdk.services.appmesh.HealthCheck.tcp(
                    options.let(TcpHealthCheckOptions::unwrap)
                )
                .let(HealthCheck::wrap)
        ...
        internal fun unwrap(
            wrapped: HealthCheck
        ): software.amazon.awscdk.services.appmesh.HealthCheck = (wrapped as Wrapper).cdkObject
    }
}
