...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param roleArn The Amazon Resource Name (ARN) of the role that you created when you set
         *   up MediaConnect as a trusted service.
         */
         ...
         *
         * @param securityGroupIds The VPC security groups that you want MediaConnect to use for
         ...
         * The subnet IDs that you want to use for your VPC interface.
         *
         * A range of IP addresses in your VPC. When you create your VPC, you specify a range of
         * IPv4 addresses for the VPC in the form of a Classless Inter-Domain Routing (CIDR) block;
         * for example, 10.0.0.0/16. This is the primary CIDR block for your VPC. When you create a
         * subnet for your VPC, you specify the CIDR block for the subnet, which is a subset of the
         * VPC CIDR block.
         *
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.mediaconnect.CfnFlowVpcInterface.Builder.create(
                scope,
                id
            )
