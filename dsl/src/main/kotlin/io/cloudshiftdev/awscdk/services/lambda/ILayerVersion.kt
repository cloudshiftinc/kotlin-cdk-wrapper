...
public interface ILayerVersion : IResource {
    ...
    internal constructor(
         ...
         *
         * Usage within the same account where the layer is defined is always allowed and does not
         * require calling this method. Note that the principal that creates the Lambda function
         * using the layer (for example, a CloudFormation changeset execution role) also needs to
         * have the `lambda:GetLayerVersion` permission on the layer version.
         *
         * @param id the ID of the grant in the construct tree.
         * @param permission the identification of the grantee.
         */
