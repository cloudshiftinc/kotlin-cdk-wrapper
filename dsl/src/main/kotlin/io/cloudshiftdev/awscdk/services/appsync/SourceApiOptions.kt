...
public interface SourceApiOptions {
    ...
    public interface Builder {
        /**
         * @param mergedApiExecutionRole IAM Role used to validate access to source APIs at runtime
         *   and to update the merged API endpoint with the source API changes.
         */
    ...
    private class BuilderImpl : Builder {
        ...
        /** @param sourceApis Definition of source APIs associated with this Merged API. */
        override fun sourceApis(vararg sourceApis: SourceApi): Unit =
            sourceApis(sourceApis.toList())
    ...
    internal constructor(
        ...
        /** Definition of source APIs associated with this Merged API. */
        override fun sourceApis(): List<SourceApi> =
