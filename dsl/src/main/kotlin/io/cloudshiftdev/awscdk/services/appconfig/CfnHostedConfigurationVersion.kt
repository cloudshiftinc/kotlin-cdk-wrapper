...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.appconfig.CfnHostedConfigurationVersion,
    ...
    public interface Builder {
         ...
         *
         * @param contentType A standard MIME type describing the format of the configuration
         *   content.
         */
         ...
         * updates when creating a new version.
         *
         * To ensure your data is not overwritten when creating multiple hosted configuration
         * versions in rapid succession, specify the version number of the latest hosted
         ...
         *
         * @param versionLabel A user-defined label for an AWS AppConfig hosted configuration
         *   version.
         */
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.appconfig.CfnHostedConfigurationVersion.Builder.create(
                scope,
                id
            )
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnHostedConfigurationVersion
        ): software.amazon.awscdk.services.appconfig.CfnHostedConfigurationVersion =
            wrapped.cdkObject
    }
}
