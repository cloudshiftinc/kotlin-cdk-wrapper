...
internal constructor(
    ...
    public interface Builder {
        /**
         * (Optional) An option to create a new AWS IoT thing when creating a vehicle, or to
         ...
         *
         * @param associationBehavior (Optional) An option to create a new AWS IoT thing when
        ...
        /**
         * The Amazon Resource Name (ARN) of the vehicle model (model manifest) to create the
         * vehicle from.
         *
         ...
         *
         * @param modelManifestArn The Amazon Resource Name (ARN) of the vehicle model (model
         *   manifest) to create the vehicle from.
         */
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.iotfleetwise.CfnVehicle =
            cdkBuilder.build()
    }
