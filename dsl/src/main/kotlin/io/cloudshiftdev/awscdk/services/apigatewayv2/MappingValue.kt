...
internal constructor(
    ...
    public companion object {
        public fun contextVariable(variableName: String): MappingValue =
            software.amazon.awscdk.services.apigatewayv2.MappingValue.contextVariable(variableName)
                .let(MappingValue::wrap)

        public fun custom(`value`: String): MappingValue =
            software.amazon.awscdk.services.apigatewayv2.MappingValue.custom(`value`)
                .let(MappingValue::wrap)

        public fun requestBody(name: String): MappingValue =
            software.amazon.awscdk.services.apigatewayv2.MappingValue.requestBody(name)
                .let(MappingValue::wrap)

        public fun requestHeader(name: String): MappingValue =
            software.amazon.awscdk.services.apigatewayv2.MappingValue.requestHeader(name)
                .let(MappingValue::wrap)

        public fun requestPath(): MappingValue =
            software.amazon.awscdk.services.apigatewayv2.MappingValue.requestPath()
                .let(MappingValue::wrap)

        public fun requestPathParam(name: String): MappingValue =
            software.amazon.awscdk.services.apigatewayv2.MappingValue.requestPathParam(name)
                .let(MappingValue::wrap)

        public fun requestQueryString(name: String): MappingValue =
            software.amazon.awscdk.services.apigatewayv2.MappingValue.requestQueryString(name)
                .let(MappingValue::wrap)

        public fun stageVariable(variableName: String): MappingValue =
            software.amazon.awscdk.services.apigatewayv2.MappingValue.stageVariable(variableName)
                .let(MappingValue::wrap)
