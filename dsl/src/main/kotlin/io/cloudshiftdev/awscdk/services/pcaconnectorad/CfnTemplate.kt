...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param reenrollAllCertificateHolders This setting allows the major version of a template
    ...
    private class BuilderImpl(
        ...
        override fun reenrollAllCertificateHolders(reenrollAllCertificateHolders: IResolvable) {
            cdkBuilder.reenrollAllCertificateHolders(
                reenrollAllCertificateHolders.let(IResolvable::unwrap)
            )
        }
    ...
    public interface ExtensionsV3Property {
        ...
        public interface Builder {
            /**
             * @param applicationPolicies Application policies specify what the certificate is used
             *   for and its purpose.
             */
            ...
            public fun applicationPolicies(
                applicationPolicies: ApplicationPoliciesProperty.Builder.() -> Unit
            )

            /**
             * @param keyUsage The key usage extension defines the purpose (e.g., encipherment,
        ...
        private class BuilderImpl : Builder {
            ...
            override fun applicationPolicies(applicationPolicies: ApplicationPoliciesProperty) {
                cdkBuilder.applicationPolicies(
                    applicationPolicies.let(ApplicationPoliciesProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("8201469e5ac85f25a2c135e7e4ed5c98b23b3a388d059e52d970ec6e4eed8bed")
            override fun applicationPolicies(
                applicationPolicies: ApplicationPoliciesProperty.Builder.() -> Unit
    ...
    public interface KeyUsageFlagsProperty {
        ...
        public interface Builder {
            /**
             * @param dataEncipherment DataEncipherment is asserted when the subject public key is
            ...
            /**
             * @param digitalSignature The digitalSignature is asserted when the subject public key
            ...
            /**
             * @param keyAgreement KeyAgreement is asserted when the subject public key is used for
             *   key agreement.
             */
            ...
            /**
             * @param keyEncipherment KeyEncipherment is asserted when the subject public key is
            ...
            /**
             * @param nonRepudiation NonRepudiation is asserted when the subject public key is used
    ...
    public interface TemplateV2Property {
         ...
         */
        public fun supersededTemplates(): List<String> =
        ...
        public interface Builder {
            /**
             * @param certificateValidity Certificate validity describes the validity and renewal
            ...
            public fun certificateValidity(
                certificateValidity: CertificateValidityProperty.Builder.() -> Unit
            )

            /**
             * @param enrollmentFlags Enrollment flags describe the enrollment settings for
             *   certificates such as using the existing private key and deleting expired or revoked
             *   certificates.
             */
            ...
            public fun enrollmentFlags(
                enrollmentFlags: EnrollmentFlagsV2Property.Builder.() -> Unit
            )

            /**
             * @param extensions Extensions describe the key usage extensions and application
            ...
            /**
             * @param generalFlags General flags describe whether the template is used for computers
            ...
            /**
             * @param privateKeyAttributes Private key attributes allow you to specify the minimal
             *   key length, key spec, and cryptographic providers for the private key of a
            ...
            public fun privateKeyAttributes(
                privateKeyAttributes: PrivateKeyAttributesV2Property.Builder.() -> Unit
            )

            /**
             * @param privateKeyFlags Private key flags for v2 templates specify the client
             *   compatibility, if the private key can be exported, and if user input is required
            ...
            public fun privateKeyFlags(
                privateKeyFlags: PrivateKeyFlagsV2Property.Builder.() -> Unit
            )

            /**
             * @param subjectNameFlags Subject name flags describe the subject name and subject
            ...
            public fun subjectNameFlags(
                subjectNameFlags: SubjectNameFlagsV2Property.Builder.() -> Unit
            )

            /**
             * @param supersededTemplates List of templates in Active Directory that are superseded
             *   by this template.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            override fun certificateValidity(certificateValidity: CertificateValidityProperty) {
                cdkBuilder.certificateValidity(
                    certificateValidity.let(CertificateValidityProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("f7ddf8a48640e737a7dfb8c01e91d6ec86073099caa5ab11876f97de1c9d158e")
            override fun certificateValidity(
                certificateValidity: CertificateValidityProperty.Builder.() -> Unit
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("2d5bad24f0c50e9df1b3bbd2144d57cf0f6992496e2136c9734c09b1d0529f10")
            override fun generalFlags(
                generalFlags: GeneralFlagsV2Property.Builder.() -> Unit
             ...
             *   Service Providers.
             */
            override fun privateKeyAttributes(
                privateKeyAttributes: PrivateKeyAttributesV2Property
            ) {
                cdkBuilder.privateKeyAttributes(
                    privateKeyAttributes.let(PrivateKeyAttributesV2Property::unwrap)
                )
            }
            ...
            override fun subjectNameFlags(subjectNameFlags: SubjectNameFlagsV2Property) {
                cdkBuilder.subjectNameFlags(
                    subjectNameFlags.let(SubjectNameFlagsV2Property::unwrap)
                )
            }
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-pcaconnectorad-template-templatev2.html#cfn-pcaconnectorad-template-templatev2-supersededtemplates)
             */
            override fun supersededTemplates(): List<String> =
                unwrap(this).getSupersededTemplates() ?: emptyList()
        }
    ...
    public interface KeyUsageProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param usageFlags The key usage flags represent the purpose (e.g., encipherment,
    ...
    public interface TemplateV3Property {
        ...
        public interface Builder {
            ...
            public fun enrollmentFlags(
                enrollmentFlags: EnrollmentFlagsV3Property.Builder.() -> Unit
            )
            ...
            /**
             * @param privateKeyAttributes Private key attributes allow you to specify the
             *   algorithm, minimal key length, key spec, key usage, and cryptographic providers for
             *   the private key of a certificate for v3 templates. V3 templates allow you to use
            ...
            public fun privateKeyAttributes(
                privateKeyAttributes: PrivateKeyAttributesV3Property.Builder.() -> Unit
            )

            /**
             * @param privateKeyFlags Private key flags for v3 templates specify the client
             *   compatibility, if the private key can be exported, if user input is required when
             *   using a private key, and if an alternate signature algorithm should be used.
             */
            public fun privateKeyFlags(privateKeyFlags: IResolvable)
            ...
            public fun privateKeyFlags(
                privateKeyFlags: PrivateKeyFlagsV3Property.Builder.() -> Unit
            )
            ...
            public fun subjectNameFlags(
                subjectNameFlags: SubjectNameFlagsV3Property.Builder.() -> Unit
            )
        ...
        private class BuilderImpl : Builder {
            ...
            @JvmName("7c4023e5983bceddfc9b5909dc8a23d93ee4b23655c9b9b3ff5673973fcab4f2")
            override fun generalFlags(
                generalFlags: GeneralFlagsV3Property.Builder.() -> Unit
            ...
            override fun privateKeyAttributes(
                ...
                cdkBuilder.privateKeyAttributes(
                    privateKeyAttributes.let(PrivateKeyAttributesV3Property::unwrap)
                )
            }
            ...
            override fun subjectNameFlags(subjectNameFlags: SubjectNameFlagsV3Property) {
                cdkBuilder.subjectNameFlags(
                    subjectNameFlags.let(SubjectNameFlagsV3Property::unwrap)
                )
            }
        ...
        internal constructor(
             ...
             * spec, key usage, and cryptographic providers for the private key of a certificate for
             * v3 templates.
             *
             * V3 templates allow you to use Key Storage Providers.
             *
    ...
    public interface TemplateDefinitionProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TemplateDefinitionProperty
            ): software.amazon.awscdk.services.pcaconnectorad.CfnTemplate.TemplateDefinitionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface KeyUsagePropertyProperty {
        ...
        public interface Builder {
            ...
            public fun propertyFlags(
                propertyFlags: KeyUsagePropertyFlagsProperty.Builder.() -> Unit
            )

            /**
             * @param propertyType You can specify all key usages using property type ALL. You can
             *   use property type or property flags but not both.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: KeyUsagePropertyProperty
            ): software.amazon.awscdk.services.pcaconnectorad.CfnTemplate.KeyUsagePropertyProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SubjectNameFlagsV2Property {
        ...
        public interface Builder {
            ...
            /**
             * @param sanRequireDirectoryGuid Include the globally unique identifier (GUID) in the
            ...
            /**
             * @param sanRequireSpn Include the service principal name (SPN) in the subject
             *   alternate name.
             */
            ...
            /**
             * @param sanRequireUpn Include the user principal name (UPN) in the subject alternate
             *   name.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SubjectNameFlagsV2Property
            ): software.amazon.awscdk.services.pcaconnectorad.CfnTemplate.SubjectNameFlagsV2Property =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SubjectNameFlagsV4Property {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SubjectNameFlagsV4Property
            ): software.amazon.awscdk.services.pcaconnectorad.CfnTemplate.SubjectNameFlagsV4Property =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface GeneralFlagsV4Property {
        ...
        public interface Builder {
            /**
             * @param autoEnrollment Allows certificate issuance using autoenrollment. Set to TRUE
            ...
            /**
             * @param machineType Defines if the template is for machines or users. Set to TRUE if
             *   the template is for machines. Set to FALSE if the template is for users
             */
        ...
        internal constructor(
             ...
             * Defines if the template is for machines or users.
             *
             * Set to TRUE if the template is for machines. Set to FALSE if the template is for
             * users
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-pcaconnectorad-template-generalflagsv4.html#cfn-pcaconnectorad-template-generalflagsv4-machinetype)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: GeneralFlagsV4Property
            ): software.amazon.awscdk.services.pcaconnectorad.CfnTemplate.GeneralFlagsV4Property =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface PrivateKeyAttributesV2Property {
         ...
         */
        public fun cryptoProviders(): List<String> =
            unwrap(this).getCryptoProviders() ?: emptyList()
        ...
        public interface Builder {
            /**
             * @param cryptoProviders Defines the cryptographic providers used to generate the
             *   private key.
             */
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-pcaconnectorad-template-privatekeyattributesv2.html#cfn-pcaconnectorad-template-privatekeyattributesv2-cryptoproviders)
             */
            override fun cryptoProviders(): List<String> =
                unwrap(this).getCryptoProviders() ?: emptyList()
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: PrivateKeyAttributesV2Property
            ): software.amazon.awscdk.services.pcaconnectorad.CfnTemplate.PrivateKeyAttributesV2Property =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface PrivateKeyAttributesV4Property {
        ...
        public interface Builder {
             ...
             *   contained in the certificate. You can specify specific purposes using property
            ...
            public fun keyUsageProperty(
                keyUsageProperty: KeyUsagePropertyProperty.Builder.() -> Unit
            )
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: PrivateKeyAttributesV4Property
            ): software.amazon.awscdk.services.pcaconnectorad.CfnTemplate.PrivateKeyAttributesV4Property =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface PrivateKeyAttributesV3Property {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: PrivateKeyAttributesV3Property
            ): software.amazon.awscdk.services.pcaconnectorad.CfnTemplate.PrivateKeyAttributesV3Property =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface EnrollmentFlagsV3Property {
        ...
        public interface Builder {
            ...
            /**
             * @param includeSymmetricAlgorithms Include symmetric algorithms allowed by the
             *   subject.
             */
            ...
            /**
             * @param noSecurityExtension This flag instructs the CA to not include the security
             *   extension szOID_NTDS_CA_SECURITY_EXT (OID:1.3.6.1.4.1.311.25.2), as specified in
            ...
            /**
             * @param removeInvalidCertificateFromPersonalStore Delete expired or revoked
             *   certificates instead of archiving them.
             */
            ...
            /**
             * @param userInteractionRequired Require user interaction when the subject is enrolled
             *   and the private key associated with the certificate is used.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            /** @param enableKeyReuseOnNtTokenKeysetStorageFull Allow renewal using the same key. */
            override fun enableKeyReuseOnNtTokenKeysetStorageFull(
                enableKeyReuseOnNtTokenKeysetStorageFull: Boolean
            ) {
            ...
            override fun enableKeyReuseOnNtTokenKeysetStorageFull(
                ...
                cdkBuilder.enableKeyReuseOnNtTokenKeysetStorageFull(
                    enableKeyReuseOnNtTokenKeysetStorageFull.let(IResolvable::unwrap)
                )
            }
            ...
            override fun includeSymmetricAlgorithms(includeSymmetricAlgorithms: IResolvable) {
                cdkBuilder.includeSymmetricAlgorithms(
                    includeSymmetricAlgorithms.let(IResolvable::unwrap)
                )
            }
             ...
             *   certificates instead of archiving them.
             */
            override fun removeInvalidCertificateFromPersonalStore(
                removeInvalidCertificateFromPersonalStore: Boolean
            ) {
            ...
            override fun removeInvalidCertificateFromPersonalStore(
                ...
                cdkBuilder.removeInvalidCertificateFromPersonalStore(
                    removeInvalidCertificateFromPersonalStore.let(IResolvable::unwrap)
                )
            }
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-pcaconnectorad-template-enrollmentflagsv3.html#cfn-pcaconnectorad-template-enrollmentflagsv3-includesymmetricalgorithms)
             */
            override fun includeSymmetricAlgorithms(): Any? =
                unwrap(this).getIncludeSymmetricAlgorithms()

            /**
             * This flag instructs the CA to not include the security extension
             * szOID_NTDS_CA_SECURITY_EXT (OID:1.3.6.1.4.1.311.25.2), as specified in [MS-WCCE]
             * sections 2.2.2.7.7.4 and 3.2.2.6.2.1.4.5.9, in the issued certificate. This addresses
             * a Windows Kerberos elevation-of-privilege vulnerability.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-pcaconnectorad-template-enrollmentflagsv3.html#cfn-pcaconnectorad-template-enrollmentflagsv3-nosecurityextension)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: EnrollmentFlagsV3Property
            ): software.amazon.awscdk.services.pcaconnectorad.CfnTemplate.EnrollmentFlagsV3Property =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface EnrollmentFlagsV2Property {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: EnrollmentFlagsV2Property
            ): software.amazon.awscdk.services.pcaconnectorad.CfnTemplate.EnrollmentFlagsV2Property =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ApplicationPolicyProperty {
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-pcaconnectorad-template-applicationpolicy.html#cfn-pcaconnectorad-template-applicationpolicy-policyobjectidentifier)
             */
            override fun policyObjectIdentifier(): String? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ApplicationPolicyProperty
            ): software.amazon.awscdk.services.pcaconnectorad.CfnTemplate.ApplicationPolicyProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ApplicationPoliciesProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ApplicationPoliciesProperty
            ): software.amazon.awscdk.services.pcaconnectorad.CfnTemplate.ApplicationPoliciesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface KeyUsagePropertyFlagsProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: KeyUsagePropertyFlagsProperty
            ): software.amazon.awscdk.services.pcaconnectorad.CfnTemplate.KeyUsagePropertyFlagsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SubjectNameFlagsV3Property {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SubjectNameFlagsV3Property
            ): software.amazon.awscdk.services.pcaconnectorad.CfnTemplate.SubjectNameFlagsV3Property =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface PrivateKeyFlagsV3Property {
         ...
         */
        public fun strongKeyProtectionRequired(): Any? =
        ...
        public interface Builder {
            ...
            /**
             * @param requireAlternateSignatureAlgorithm Reguires the PKCS #1 v2.1 signature format
             *   for certificates. You should verify that your CA, objects, and applications can
             *   accept this signature format.
             */
            public fun requireAlternateSignatureAlgorithm(
             ...
             */
            public fun requireAlternateSignatureAlgorithm(
                requireAlternateSignatureAlgorithm: IResolvable
            )
        ...
        private class BuilderImpl : Builder {
             ...
             *   accept this signature format.
             */
            override fun requireAlternateSignatureAlgorithm(
                requireAlternateSignatureAlgorithm: Boolean
            ) {
            ...
            override fun requireAlternateSignatureAlgorithm(
                ...
                cdkBuilder.requireAlternateSignatureAlgorithm(
                    requireAlternateSignatureAlgorithm.let(IResolvable::unwrap)
                )
            }
            ...
            override fun strongKeyProtectionRequired(strongKeyProtectionRequired: IResolvable) {
                cdkBuilder.strongKeyProtectionRequired(
                    strongKeyProtectionRequired.let(IResolvable::unwrap)
                )
            }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: PrivateKeyFlagsV3Property
            ): software.amazon.awscdk.services.pcaconnectorad.CfnTemplate.PrivateKeyFlagsV3Property =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface PrivateKeyFlagsV2Property {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: PrivateKeyFlagsV2Property
            ): software.amazon.awscdk.services.pcaconnectorad.CfnTemplate.PrivateKeyFlagsV2Property =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface EnrollmentFlagsV4Property {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: EnrollmentFlagsV4Property
            ): software.amazon.awscdk.services.pcaconnectorad.CfnTemplate.EnrollmentFlagsV4Property =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface GeneralFlagsV2Property {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: GeneralFlagsV2Property
            ): software.amazon.awscdk.services.pcaconnectorad.CfnTemplate.GeneralFlagsV2Property =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface TemplateV4Property {
        ...
        public interface Builder {
            ...
            /**
             * @param enrollmentFlags Enrollment flags describe the enrollment settings for
             *   certificates using the existing private key and deleting expired or revoked
             *   certificates.
             */
            public fun enrollmentFlags(enrollmentFlags: IResolvable)
            ...
            public fun enrollmentFlags(
                enrollmentFlags: EnrollmentFlagsV4Property.Builder.() -> Unit
            )
            ...
            /**
             * @param privateKeyAttributes Private key attributes allow you to specify the minimal
             *   key length, key spec, key usage, and cryptographic providers for the private key of
             *   a certificate for v4 templates. V4 templates allow you to use either Key Storage
             *   Providers or Legacy Cryptographic Service Providers. You specify the cryptography
            ...
            public fun privateKeyAttributes(
                privateKeyAttributes: PrivateKeyAttributesV4Property.Builder.() -> Unit
            )

            /**
             * @param privateKeyFlags Private key flags for v4 templates specify the client
             *   compatibility, if the private key can be exported, if user input is required when
             *   using a private key, if an alternate signature algorithm should be used, and if
            ...
            public fun privateKeyFlags(
                privateKeyFlags: PrivateKeyFlagsV4Property.Builder.() -> Unit
            )
            ...
            public fun subjectNameFlags(
                subjectNameFlags: SubjectNameFlagsV4Property.Builder.() -> Unit
            )
        ...
        private class BuilderImpl : Builder {
            ...
            @JvmName("80c2c7feaa734b88333c5a09f8ed2ab4625a9dc2d0bfd63f47ee74feba72ae97")
            override fun generalFlags(
                generalFlags: GeneralFlagsV4Property.Builder.() -> Unit
            ...
            override fun privateKeyAttributes(
                ...
                cdkBuilder.privateKeyAttributes(
                    privateKeyAttributes.let(PrivateKeyAttributesV4Property::unwrap)
                )
            }
            ...
            override fun subjectNameFlags(subjectNameFlags: SubjectNameFlagsV4Property) {
                cdkBuilder.subjectNameFlags(
                    subjectNameFlags.let(SubjectNameFlagsV4Property::unwrap)
                )
            }
        ...
        internal constructor(
             ...
             * usage, and cryptographic providers for the private key of a certificate for v4
             * templates.
             *
             * V4 templates allow you to use either Key Storage Providers or Legacy Cryptographic
             * Service Providers. You specify the cryptography provider category in private key
             * flags.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-pcaconnectorad-template-templatev4.html#cfn-pcaconnectorad-template-templatev4-privatekeyattributes)
             */
             ...
             * key can be exported, if user input is required when using a private key, if an
             * alternate signature algorithm should be used, and if certificates are renewed using
    ...
    public interface CertificateValidityProperty {
         ...
         * period of time during which a certificate is valid. Validity can be expressed as an
        ...
        public interface Builder {
            /**
             * @param renewalPeriod Renewal period is the period of time before certificate
             *   expiration when a new certificate will be requested.
             */
             ...
             *   expires, or as a span of time after issuance, stated in days, months, or years. For
             *   more information, see Validity in RFC 5280. This value is unaffected when
             *   ValidityNotBefore is also specified. For example, if Validity is set to 20 days in
             *   the future, the certificate will expire 20 days from issuance time regardless of
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("074d06ca33d33e75e9aa8418600945d8d29663f6d1be76c0343c2cf70cff619c")
            override fun renewalPeriod(
                renewalPeriod: ValidityPeriodProperty.Builder.() -> Unit
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("762e9ab84bc09a28664eaa5d5953d5389f0fa6cb433ee08b768232b09f3c7410")
            override fun validityPeriod(
                validityPeriod: ValidityPeriodProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * the period of time during which a certificate is valid. Validity can be expressed as
             * an explicit date and time when the certificate expires, or as a span of time after
             * issuance, stated in days, months, or years. For more information, see Validity in
             * RFC 5280. This value is unaffected when ValidityNotBefore is also specified. For
             * example, if Validity is set to 20 days in the future, the certificate will expire 20
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CertificateValidityProperty
            ): software.amazon.awscdk.services.pcaconnectorad.CfnTemplate.CertificateValidityProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface PrivateKeyFlagsV4Property {
        ...
        public interface Builder {
            ...
            /**
             * @param requireAlternateSignatureAlgorithm Requires the PKCS #1 v2.1 signature format
             *   for certificates. You should verify that your CA, objects, and applications can
             *   accept this signature format.
             */
            public fun requireAlternateSignatureAlgorithm(
            ...
            /**
             * @param useLegacyProvider Specifies the cryptographic service provider category used
             *   to generate private keys. Set to TRUE to use Legacy Cryptographic Service Providers
        ...
        internal constructor(
             ...
             * Specifies the cryptographic service provider category used to generate private keys.
             *
             * Set to TRUE to use Legacy Cryptographic Service Providers and FALSE to use Key
             * Storage Providers.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-pcaconnectorad-template-privatekeyflagsv4.html#cfn-pcaconnectorad-template-privatekeyflagsv4-uselegacyprovider)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: PrivateKeyFlagsV4Property
            ): software.amazon.awscdk.services.pcaconnectorad.CfnTemplate.PrivateKeyFlagsV4Property =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface GeneralFlagsV3Property {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: GeneralFlagsV3Property
            ): software.amazon.awscdk.services.pcaconnectorad.CfnTemplate.GeneralFlagsV3Property =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ValidityPeriodProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param periodType The unit of time. You can select hours, days, weeks, months, and
             *   years.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ValidityPeriodProperty
            ): software.amazon.awscdk.services.pcaconnectorad.CfnTemplate.ValidityPeriodProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
