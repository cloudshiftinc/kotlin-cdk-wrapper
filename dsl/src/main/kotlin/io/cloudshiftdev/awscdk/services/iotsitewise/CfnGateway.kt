...
internal constructor(
    ...
    public open fun gatewayCapabilitySummaries(): Any? =
        unwrap(this).getGatewayCapabilitySummaries()
    ...
    public interface Builder {
         ...
         *
         * @param gatewayCapabilitySummaries A list of gateway capability summaries that each
         *   contain a namespace and status.
         */
    ...
    private class BuilderImpl(
        ...
        override fun gatewayCapabilitySummaries(gatewayCapabilitySummaries: IResolvable) {
            cdkBuilder.gatewayCapabilitySummaries(
                gatewayCapabilitySummaries.let(IResolvable::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("67a83972075c055807843f542cb36a800b44e870144de9ea23f8102a70a276ed")
        override fun gatewayPlatform(
            gatewayPlatform: GatewayPlatformProperty.Builder.() -> Unit
        ): Unit = gatewayPlatform(GatewayPlatformProperty(gatewayPlatform))
        ...
        public fun build(): software.amazon.awscdk.services.iotsitewise.CfnGateway =
            cdkBuilder.build()
    }
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnGateway
        ): software.amazon.awscdk.services.iotsitewise.CfnGateway = wrapped.cdkObject
    }
    ...
    public interface GreengrassV2Property {
        ...
        public interface Builder {
            /**
             * @param coreDeviceThingName The name of the AWS IoT thing for your AWS IoT Greengrass
             *   V2 core device.
             */
    ...
    public interface GatewayPlatformProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: GatewayPlatformProperty
            ): software.amazon.awscdk.services.iotsitewise.CfnGateway.GatewayPlatformProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface GatewayCapabilitySummaryProperty {
         ...
         *
         * For example, if you configure OPC-UA sources from the AWS IoT SiteWise console, your
        ...
        public interface Builder {
            /**
             * @param capabilityConfiguration The JSON document that defines the configuration for
             *   the gateway capability. For more information, see
             *   [Configuring data sources (CLI)](https://docs.aws.amazon.com/iot-sitewise/latest/userguide/configure-sources.html#configure-source-cli)
             *   in the *AWS IoT SiteWise User Guide* .
             */
            ...
            /**
             * @param capabilityNamespace The namespace of the capability configuration. For
        ...
        private class BuilderImpl : Builder {
            private val cdkBuilder:
                ...
                software.amazon.awscdk.services.iotsitewise.CfnGateway
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-iotsitewise-gateway-gatewaycapabilitysummary.html#cfn-iotsitewise-gateway-gatewaycapabilitysummary-capabilityconfiguration)
             */
            override fun capabilityConfiguration(): String? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: GatewayCapabilitySummaryProperty
            ): software.amazon.awscdk.services.iotsitewise.CfnGateway.GatewayCapabilitySummaryProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
