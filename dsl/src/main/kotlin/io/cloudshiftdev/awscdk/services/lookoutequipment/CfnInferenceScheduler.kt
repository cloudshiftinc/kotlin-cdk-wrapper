...
internal constructor(
    ...
    public open fun attrInferenceSchedulerArn(): String =
        unwrap(this).getAttrInferenceSchedulerArn()
    ...
    public interface Builder {
         ...
         * starts.
         *
         * For instance, if an offset delay time of five minutes was selected, inference will not
         * begin on the data until the first data measurement after the five minute mark. For
         ...
         *
         * @param dataDelayOffsetInMinutes A period of time (in minutes) by which inference on the
         *   data is delayed after the data starts.
         */
         ...
         *
         * @param dataInputConfiguration Specifies configuration information for the input data for
         ...
         *
         * @param dataOutputConfiguration Specifies configuration information for the output results
         *   for the inference scheduler, including the Amazon S3 location for the output.
         */
         ...
         * How often data is uploaded to the source S3 bucket for the input data.
         *
         * This value is the length of time between data uploads. For instance, if you select 5
         * minutes, Amazon Lookout for Equipment will upload the real-time data to the source bucket
         * once every 5 minutes. This frequency also determines how often Amazon Lookout for
         * Equipment starts a scheduled inference on your data. In this example, it starts once
         * every 5 minutes.
         *
         ...
         *
         * @param dataUploadFrequency How often data is uploaded to the source S3 bucket for the
         *   input data.
         */
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.lookoutequipment.CfnInferenceScheduler.Builder.create(
                scope,
                id
            )
    ...
    public interface DataInputConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param inferenceInputNameConfiguration Specifies configuration information for the
             *   input data for the inference, including timestamp format and delimiter.
             */
            ...
            public fun inferenceInputNameConfiguration(
                inferenceInputNameConfiguration: InputNameConfigurationProperty.Builder.() -> Unit
            )

            /**
             * @param inputTimeZoneOffset Indicates the difference between your time zone and
             *   Greenwich Mean Time (GMT).
             */
            public fun inputTimeZoneOffset(inputTimeZoneOffset: String)

            /**
             * @param s3InputConfiguration Specifies configuration information for the input data
             *   for the inference, including input data S3 location.
             */
            ...
            public fun s3InputConfiguration(
                s3InputConfiguration: S3InputConfigurationProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
             ...
             *   input data for the inference, including timestamp format and delimiter.
             */
            override fun inferenceInputNameConfiguration(
                inferenceInputNameConfiguration: IResolvable
            ) {
                cdkBuilder.inferenceInputNameConfiguration(
                    inferenceInputNameConfiguration.let(IResolvable::unwrap)
                )
            }
            ...
            override fun inferenceInputNameConfiguration(
                ...
                cdkBuilder.inferenceInputNameConfiguration(
                    inferenceInputNameConfiguration.let(InputNameConfigurationProperty::unwrap)
                )
            }
            ...
            override fun inferenceInputNameConfiguration(
                ...
                inferenceInputNameConfiguration(
                    InputNameConfigurationProperty(inferenceInputNameConfiguration)
                )
            ...
            override fun s3InputConfiguration(s3InputConfiguration: S3InputConfigurationProperty) {
                cdkBuilder.s3InputConfiguration(
                    s3InputConfiguration.let(S3InputConfigurationProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("581c61355ec25fe90a3613d8b08027e9c9a03c8b726cb116e503600ae4ef83c9")
            override fun s3InputConfiguration(
                s3InputConfiguration: S3InputConfigurationProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DataInputConfigurationProperty
            ): software.amazon.awscdk.services.lookoutequipment.CfnInferenceScheduler.DataInputConfigurationProperty =
    ...
    public interface InputNameConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param componentTimestampDelimiter Indicates the delimiter character used between
             *   items in the data.
             */
            public fun componentTimestampDelimiter(componentTimestampDelimiter: String)

            /**
             * @param timestampFormat The format of the timestamp, whether Epoch time, or standard,
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: InputNameConfigurationProperty
            ): software.amazon.awscdk.services.lookoutequipment.CfnInferenceScheduler.InputNameConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface S3InputConfigurationProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: S3InputConfigurationProperty
            ): software.amazon.awscdk.services.lookoutequipment.CfnInferenceScheduler.S3InputConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DataOutputConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param kmsKeyId The ID number for the AWS KMS key used to encrypt the inference
             *   output.
             */
            public fun kmsKeyId(kmsKeyId: String)

            /**
             * @param s3OutputConfiguration Specifies configuration information for the output
             *   results from the inference, including output S3 location.
             */
            ...
            public fun s3OutputConfiguration(
                s3OutputConfiguration: S3OutputConfigurationProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
             ...
             *   results from the inference, including output S3 location.
             */
            override fun s3OutputConfiguration(
                s3OutputConfiguration: S3OutputConfigurationProperty
            ) {
                cdkBuilder.s3OutputConfiguration(
                    s3OutputConfiguration.let(S3OutputConfigurationProperty::unwrap)
                )
            }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DataOutputConfigurationProperty
            ): software.amazon.awscdk.services.lookoutequipment.CfnInferenceScheduler.DataOutputConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface S3OutputConfigurationProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: S3OutputConfigurationProperty
            ): software.amazon.awscdk.services.lookoutequipment.CfnInferenceScheduler.S3OutputConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
