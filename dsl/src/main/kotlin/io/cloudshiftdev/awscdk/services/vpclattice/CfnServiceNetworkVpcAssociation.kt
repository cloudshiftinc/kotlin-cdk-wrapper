...
internal constructor(
    ...
    public interface Builder {
         ...
         * The IDs of the security groups.
         *
         * Security groups aren't added by default. You can add a security group to apply network
         * level controls to control which resources in a VPC are allowed to access the service
         ...
         *
         * @param serviceNetworkIdentifier The ID or Amazon Resource Name (ARN) of the service
         *   network.
         */
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnServiceNetworkVpcAssociation
        ): software.amazon.awscdk.services.vpclattice.CfnServiceNetworkVpcAssociation =
            wrapped.cdkObject
    }
}
