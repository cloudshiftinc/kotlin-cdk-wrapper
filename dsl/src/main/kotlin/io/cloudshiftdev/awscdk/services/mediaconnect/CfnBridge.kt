...
internal constructor(
    ...
    public open fun egressGatewayBridge(
        `value`: EgressGatewayBridgeProperty.Builder.() -> Unit
    ): Unit = egressGatewayBridge(EgressGatewayBridgeProperty(`value`))
    ...
    public open fun ingressGatewayBridge(
        `value`: IngressGatewayBridgeProperty.Builder.() -> Unit
    ...
    public interface Builder {
        ...
        public fun egressGatewayBridge(
            egressGatewayBridge: EgressGatewayBridgeProperty.Builder.() -> Unit
        )
        ...
        public fun ingressGatewayBridge(
            ingressGatewayBridge: IngressGatewayBridgeProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
        ...
        override fun egressGatewayBridge(egressGatewayBridge: EgressGatewayBridgeProperty) {
            cdkBuilder.egressGatewayBridge(
                egressGatewayBridge.let(EgressGatewayBridgeProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("fb4e47ca6e679dc8a042e36f6f677bb466453247f12689dee9a713dc94ee64e5")
        override fun egressGatewayBridge(
            egressGatewayBridge: EgressGatewayBridgeProperty.Builder.() -> Unit
        ...
        override fun ingressGatewayBridge(ingressGatewayBridge: IngressGatewayBridgeProperty) {
            cdkBuilder.ingressGatewayBridge(
                ingressGatewayBridge.let(IngressGatewayBridgeProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("79ee9332cc61112458697a9323457833ddf24d8bb615b3fb77d585d5ef31c910")
        override fun ingressGatewayBridge(
            ingressGatewayBridge: IngressGatewayBridgeProperty.Builder.() -> Unit
        ...
        public fun build(): software.amazon.awscdk.services.mediaconnect.CfnBridge =
            cdkBuilder.build()
    }
    ...
    public companion object {
        ...
        ): CfnBridge = CfnBridge(cdkObject)

        internal fun unwrap(
            wrapped: CfnBridge
        ): software.amazon.awscdk.services.mediaconnect.CfnBridge = wrapped.cdkObject
    }
    ...
    public interface BridgeNetworkOutputProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: BridgeNetworkOutputProperty
            ): software.amazon.awscdk.services.mediaconnect.CfnBridge.BridgeNetworkOutputProperty =
    ...
    public interface BridgeNetworkSourceProperty {
         ...
         *
         * This name is used to reference the source and must be unique among sources in this
         * bridge.
         *
        ...
        public interface Builder {
            ...
            /**
             * @param name The name of the network source. This name is used to reference the source
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: BridgeNetworkSourceProperty
            ): software.amazon.awscdk.services.mediaconnect.CfnBridge.BridgeNetworkSourceProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface BridgeSourceProperty {
        ...
        public interface Builder {
            /**
             * @param flowSource The source of the bridge. A flow source originates in MediaConnect
            ...
            /**
             * @param networkSource The source of the bridge. A network source originates at your
             *   premises.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("6ca4ea347a4cdfc805830fcde7e6f90b961d0460b8b8db96c5c78aa12aaeccc7")
            override fun networkSource(
                networkSource: BridgeNetworkSourceProperty.Builder.() -> Unit
    ...
    public interface BridgeFlowSourceProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param flowVpcInterfaceAttachment The name of the VPC interface attachment to use for
             *   this source.
             */
            ...
            public fun flowVpcInterfaceAttachment(
                flowVpcInterfaceAttachment: VpcInterfaceAttachmentProperty.Builder.() -> Unit
            )
        ...
        private class BuilderImpl : Builder {
            ...
            override fun flowVpcInterfaceAttachment(flowVpcInterfaceAttachment: IResolvable) {
                cdkBuilder.flowVpcInterfaceAttachment(
                    flowVpcInterfaceAttachment.let(IResolvable::unwrap)
                )
            }
             ...
             *   this source.
             */
            override fun flowVpcInterfaceAttachment(
                flowVpcInterfaceAttachment: VpcInterfaceAttachmentProperty
            ) {
                cdkBuilder.flowVpcInterfaceAttachment(
                    flowVpcInterfaceAttachment.let(VpcInterfaceAttachmentProperty::unwrap)
                )
            }
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-mediaconnect-bridge-bridgeflowsource.html#cfn-mediaconnect-bridge-bridgeflowsource-flowvpcinterfaceattachment)
             */
            override fun flowVpcInterfaceAttachment(): Any? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: BridgeFlowSourceProperty
            ): software.amazon.awscdk.services.mediaconnect.CfnBridge.BridgeFlowSourceProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface EgressGatewayBridgeProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: EgressGatewayBridgeProperty
            ): software.amazon.awscdk.services.mediaconnect.CfnBridge.EgressGatewayBridgeProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface BridgeOutputProperty {
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("78717ab00e5fb8eb26b94f79a4a0b158b7039dd47d8f8bfec02c150daa38fc97")
            override fun networkOutput(
                networkOutput: BridgeNetworkOutputProperty.Builder.() -> Unit
    ...
    public interface IngressGatewayBridgeProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: IngressGatewayBridgeProperty
            ): software.amazon.awscdk.services.mediaconnect.CfnBridge.IngressGatewayBridgeProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
