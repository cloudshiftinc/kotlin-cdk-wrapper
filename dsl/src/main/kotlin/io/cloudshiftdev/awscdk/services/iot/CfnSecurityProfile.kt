...
internal constructor(
    ...
    public open fun metricsExportConfig(
        `value`: MetricsExportConfigProperty.Builder.() -> Unit
    ): Unit = metricsExportConfig(MetricsExportConfigProperty(`value`))
    ...
    public interface Builder {
         ...
         * A list of metrics whose data is retained (stored).
         *
         * By default, data is retained for any metric used in the profile's `behaviors` , but it's
         * also retained for any metric specified here. Can be used with custom metrics; can't be
         ...
         * Specifies the destinations to which alerts are sent.
         *
         * (Alerts are always sent to the console.) Alerts are generated when a device (thing)
         * violates a behavior.
         *
         ...
         *
         * @param metricsExportConfig Specifies the MQTT topic and role ARN required for metric
         *   export.
         */
        ...
        public fun metricsExportConfig(
            metricsExportConfig: MetricsExportConfigProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
        ...
        override fun additionalMetricsToRetainV2(additionalMetricsToRetainV2: IResolvable) {
            cdkBuilder.additionalMetricsToRetainV2(
                additionalMetricsToRetainV2.let(IResolvable::unwrap)
            )
        }
        ...
        override fun metricsExportConfig(metricsExportConfig: MetricsExportConfigProperty) {
            cdkBuilder.metricsExportConfig(
                metricsExportConfig.let(MetricsExportConfigProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("1cbc29ffb850f6001e77db0596c11a4d7ad56587a1ae37ee40a9e2345b81d962")
        override fun metricsExportConfig(
            metricsExportConfig: MetricsExportConfigProperty.Builder.() -> Unit
        ...
        public fun build(): software.amazon.awscdk.services.iot.CfnSecurityProfile =
            cdkBuilder.build()
    }
    ...
    public interface MetricToRetainProperty {
        ...
        public interface Builder {
            /**
             * @param exportMetric The value indicates exporting metrics related to the
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("f42fbcc014135a946c198cee5e55192f746f1dab620d0f495364fd034d5a9fee")
            override fun metricDimension(
                metricDimension: MetricDimensionProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: MetricToRetainProperty
            ): software.amazon.awscdk.services.iot.CfnSecurityProfile.MetricToRetainProperty =
    ...
    public interface MetricsExportConfigProperty {
        ...
        public interface Builder {
            /**
             * @param mqttTopic The MQTT topic that Device Defender Detect should publish messages
             *   to for metrics export.
             */
            public fun mqttTopic(mqttTopic: String)

            /**
             * @param roleArn This role ARN has permission to publish MQTT messages, after which
             *   Device Defender Detect can assume the role and publish messages on your behalf.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: MetricsExportConfigProperty
            ): software.amazon.awscdk.services.iot.CfnSecurityProfile.MetricsExportConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface MachineLearningDetectionConfigProperty {
        ...
        public interface Builder {
            /**
             * @param confidenceLevel The model confidence level. There are three levels of
             *   confidence, `"high"` , `"medium"` , and `"low"` .
             *
             * The higher the confidence level, the lower the sensitivity, and the lower the alarm
             * frequency will be.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: MachineLearningDetectionConfigProperty
            ): software.amazon.awscdk.services.iot.CfnSecurityProfile.MachineLearningDetectionConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface StatisticalThresholdProperty {
         ...
         * devices in your account and statistical ranks are calculated. Then, the measurements from
         * a device are collected over the same period. If the accumulated measurements from the
         * device fall above or below ( `comparisonOperator` ) the value associated with the
         * percentile specified, then the device is considered to be in compliance with the
        ...
        public interface Builder {
            /**
             * @param statistic The percentile that resolves to a threshold value by which
             *   compliance with a behavior is determined. Metrics are collected over the specified
             ...
             *   fall above or below ( `comparisonOperator` ) the value associated with the
             *   percentile specified, then the device is considered to be in compliance with the
             *   behavior, otherwise a violation occurs.
             */
        ...
        internal constructor(
             ...
             * is determined.
             *
             * Metrics are collected over the specified period ( `durationSeconds` ) from all
             * reporting devices in your account and statistical ranks are calculated. Then, the
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: StatisticalThresholdProperty
            ): software.amazon.awscdk.services.iot.CfnSecurityProfile.StatisticalThresholdProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface BehaviorProperty {
        ...
        public interface Builder {
            /**
             * @param criteria The criteria that determine if a device is behaving normally in
             *   regard to the `metric` .
             *
             * In the AWS IoT console, you can choose to be sent an alert through Amazon SNS when
             * AWS IoT Device Defender detects that a device is behaving anomalously.
             */
            ...
            /**
             * @param exportMetric Value indicates exporting metrics related to the behavior when it
             *   is true.
             */
            public fun exportMetric(exportMetric: Boolean)
            ...
            /**
             * @param suppressAlerts The alert status. If you set the value to `true` , alerts will
             *   be suppressed.
             */
    ...
    public interface MetricDimensionProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param operator Operators are constructs that perform logical operations. Valid
             *   values are `IN` and `NOT_IN` .
             */
    ...
    public interface MetricValueProperty {
        ...
        public interface Builder {
            /**
             * @param cidrs If the `comparisonOperator` calls for a set of CIDRs, use this to
            ...
            /**
             * @param count If the `comparisonOperator` calls for a numeric value, use this to
            ...
            /**
             * @param ports If the `comparisonOperator` calls for a set of ports, use this to
             *   specify that set to be compared with the `metric` .
             */
    ...
    public interface BehaviorCriteriaProperty {
        ...
        public interface Builder {
            /**
             * @param comparisonOperator The operator that relates the thing measured ( `metric` )
             *   to the criteria (containing a `value` or `statisticalThreshold` ). Valid operators
             *   include:
             * * `string-list` : `in-set` and `not-in-set`
             * * `number-list` : `in-set` and `not-in-set`
             * * `ip-address-list` : `in-cidr-set` and `not-in-cidr-set`
            ...
            /**
             * @param consecutiveDatapointsToAlarm If a device is in violation of the behavior for
             *   the specified number of consecutive datapoints, an alarm occurs. If not specified,
             *   the default is 1.
             */
            public fun consecutiveDatapointsToAlarm(consecutiveDatapointsToAlarm: Number)

            /**
             * @param consecutiveDatapointsToClear If an alarm has occurred and the offending device
             *   is no longer in violation of the behavior for the specified number of consecutive
            ...
            /**
             * @param durationSeconds Use this to specify the time duration over which the behavior
             ...
             *   measurements from all devices are accumulated over this time duration before being
             *   used to calculate percentiles, and later, measurements from an individual device
             *   are also accumulated over this time duration before being given a percentile rank.
            ...
            public fun mlDetectionConfig(
                mlDetectionConfig: MachineLearningDetectionConfigProperty.Builder.() -> Unit
            )

            /**
             * @param statisticalThreshold A statistical ranking (percentile)that indicates a
             *   threshold value by which a behavior is determined to be in compliance or in
            ...
            public fun statisticalThreshold(
                statisticalThreshold: StatisticalThresholdProperty.Builder.() -> Unit
            )
        ...
        private class BuilderImpl : Builder {
            ...
            /** @param mlDetectionConfig The confidence level of the detection model. */
            override fun mlDetectionConfig(
                mlDetectionConfig: MachineLearningDetectionConfigProperty
            ) {
                cdkBuilder.mlDetectionConfig(
                    mlDetectionConfig.let(MachineLearningDetectionConfigProperty::unwrap)
                )
            }
            ...
            override fun statisticalThreshold(statisticalThreshold: StatisticalThresholdProperty) {
                cdkBuilder.statisticalThreshold(
                    statisticalThreshold.let(StatisticalThresholdProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("48bd43ae4d94c9effa2f5e601060c3ae79f58c795c643f724d9d70185de348f2")
            override fun statisticalThreshold(
                statisticalThreshold: StatisticalThresholdProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: BehaviorCriteriaProperty
            ): software.amazon.awscdk.services.iot.CfnSecurityProfile.BehaviorCriteriaProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface AlertTargetProperty {
        ...
        public interface Builder {
            /**
             * @param alertTargetArn The Amazon Resource Name (ARN) of the notification target to
