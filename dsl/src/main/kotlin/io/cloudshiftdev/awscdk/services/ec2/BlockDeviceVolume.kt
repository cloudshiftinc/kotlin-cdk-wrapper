...
internal constructor(
    ...
    public companion object {
        ...
        public fun ebs(volumeSize: Number, options: EbsDeviceOptions): BlockDeviceVolume =
            software.amazon.awscdk.services.ec2.BlockDeviceVolume.ebs(
                    volumeSize,
        ...
        public fun ebsFromSnapshot(
            ...
            software.amazon.awscdk.services.ec2.BlockDeviceVolume.ebsFromSnapshot(
                    snapshotId,
        ...
        public fun ephemeral(volumeIndex: Number): BlockDeviceVolume =
            software.amazon.awscdk.services.ec2.BlockDeviceVolume.ephemeral(volumeIndex)
                .let(BlockDeviceVolume::wrap)
