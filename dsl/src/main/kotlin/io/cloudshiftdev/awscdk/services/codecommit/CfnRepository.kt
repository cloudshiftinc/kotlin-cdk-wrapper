...
internal constructor(
    ...
    /**
     * When you pass the logical ID of this resource, the function returns the URL to use for
     * cloning the repository over HTTPS.
     */
    ...
    public interface Builder {
         ...
         * CloudFormation stack.
         *
         * Information about code is only used in resource creation. Updates to a stack will not
         * reflect changes made to code properties after initial resource creation.
         *
         * You can only use this property to add code when creating a repository with a AWS
         * CloudFormation template at creation time. This property cannot be used for updating code
         ...
         *
         * @param code Information about code to be committed to a repository after it is created in
         ...
         *
         * @param kmsKeyId The ID of the AWS Key Management Service encryption key used to encrypt
    ...
    public interface CodeProperty {
         ...
         * repository on initial creation. If this property is not set, the name *main* will be used
         * for the default branch for the repository. Changes to this property are ignored after
         * initial resource creation. We recommend using this parameter to set the name to *main* to
         * align with the default behavior of CodeCommit unless another name is needed.
         *
        ...
        /**
         * Information about the Amazon S3 bucket that contains a ZIP file of code to be committed
         * to the repository.
         *
        ...
        public interface Builder {
            /**
             * @param branchName Optional. Specifies a branch name to be used as the default branch
             *   when importing code into a repository on initial creation. If this property is not
             *   set, the name *main* will be used for the default branch for the repository.
             *   Changes to this property are ignored after initial resource creation. We recommend
             *   using this parameter to set the name to *main* to align with the default behavior
             *   of CodeCommit unless another name is needed.
             */
            public fun branchName(branchName: String)

            /**
             * @param s3 Information about the Amazon S3 bucket that contains a ZIP file of code to
        ...
        internal constructor(
             ...
             *
             * Specifies a branch name to be used as the default branch when importing code into a
             * repository on initial creation. If this property is not set, the name *main* will be
             * used for the default branch for the repository. Changes to this property are ignored
             * after initial resource creation. We recommend using this parameter to set the name to
             * *main* to align with the default behavior of CodeCommit unless another name is
             * needed.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-codecommit-repository-code.html#cfn-codecommit-repository-code-branchname)
             */
    ...
    public interface S3Property {
         ...
         *
         * Changes to this property are ignored after initial resource creation. For more
         * information, see
        ...
        public interface Builder {
            /**
             * @param bucket The name of the Amazon S3 bucket that contains the ZIP file with the
             *   content that will be committed to the new repository. This can be specified using
             *   the name of the bucket in the AWS account . Changes to this property are ignored
             *   after initial resource creation.
             */
            public fun bucket(bucket: String)

            /**
             * @param key The key to use for accessing the Amazon S3 bucket. Changes to this
             *   property are ignored after initial resource creation. For more information, see
             *   [Creating object key names](https://docs.aws.amazon.com/AmazonS3/latest/userguide/object-keys.html)
             *   and
             *   [Uploading objects](https://docs.aws.amazon.com/AmazonS3/latest/userguide/upload-objects.html)
             *   in the Amazon S3 User Guide.
            ...
            /**
             * @param objectVersion The object version of the ZIP file, if versioning is enabled for
             *   the Amazon S3 bucket. Changes to this property are ignored after initial resource
             *   creation.
             */
        ...
        internal constructor(
            ...
            /**
             * The name of the Amazon S3 bucket that contains the ZIP file with the content that
             * will be committed to the new repository.
             *
             * This can be specified using the name of the bucket in the AWS account . Changes to
    ...
    public interface RepositoryTriggerProperty {
        ...
        public interface Builder {
            /**
             * @param branches The branches to be included in the trigger configuration. If you
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RepositoryTriggerProperty
            ): software.amazon.awscdk.services.codecommit.CfnRepository.RepositoryTriggerProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
