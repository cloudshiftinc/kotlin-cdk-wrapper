...
internal constructor(
    ...
    public open fun domainNameServers(): List<String> =
        unwrap(this).getDomainNameServers() ?: emptyList()
    ...
    public open fun netbiosNameServers(): List<String> =
        unwrap(this).getNetbiosNameServers() ?: emptyList()
    ...
    public interface Builder {
         ...
         * using AmazonProvidedDNS in another Region, specify *region* . `compute.internal` (for
         * example, `ap-northeast-1.compute.internal` ). Otherwise, specify a domain name (for
         ...
         * The IPv4 addresses of up to four domain name servers, or `AmazonProvidedDNS` .
         *
         * The default is `AmazonProvidedDNS` . To have your instance receive a custom DNS hostname
         * as specified in `DomainName` , you must set this property to a custom DNS server.
         *
    ...
    public companion object {
        ...
        ): CfnDHCPOptions = CfnDHCPOptions(cdkObject)

        internal fun unwrap(
            wrapped: CfnDHCPOptions
        ): software.amazon.awscdk.services.ec2.CfnDHCPOptions = wrapped.cdkObject
    }
}
