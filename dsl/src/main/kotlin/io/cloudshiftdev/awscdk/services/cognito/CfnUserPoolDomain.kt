...
internal constructor(
    ...
    public open fun customDomainConfig(
        `value`: CustomDomainConfigTypeProperty.Builder.() -> Unit
    ...
    public interface Builder {
         ...
         *
         * @param customDomainConfig The configuration for a custom domain that hosts the sign-up
         *   and sign-in pages for your application.
         */
        ...
        public fun customDomainConfig(
            customDomainConfig: CustomDomainConfigTypeProperty.Builder.() -> Unit
        )
         ...
         *
         * @param userPoolId The user pool ID for the user pool where you want to associate a user
         *   pool domain.
         */
    ...
    private class BuilderImpl(
        ...
        override fun customDomainConfig(customDomainConfig: CustomDomainConfigTypeProperty) {
            cdkBuilder.customDomainConfig(
                customDomainConfig.let(CustomDomainConfigTypeProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("3cf6387ed90ec3bbfadd8ec8bba7bed73b53ba81c79e21cfa5ebaf2158605e86")
        override fun customDomainConfig(
            customDomainConfig: CustomDomainConfigTypeProperty.Builder.() -> Unit
    ...
    public interface CustomDomainConfigTypeProperty {
        ...
        public interface Builder {
            /**
             * @param certificateArn The Amazon Resource Name (ARN) of an AWS Certificate Manager
             *   SSL certificate. You use this certificate for the subdomain of your custom domain.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CustomDomainConfigTypeProperty
            ): software.amazon.awscdk.services.cognito.CfnUserPoolDomain.CustomDomainConfigTypeProperty =
