...
public interface IQueue : IResource {
    ...
    public fun metricApproximateNumberOfMessagesDelayed(
    ...
    public fun metricApproximateNumberOfMessagesNotVisible(
        props: MetricOptions.Builder.() -> Unit
    ): Metric
    ...
    public fun metricApproximateNumberOfMessagesVisible(
        props: MetricOptions.Builder.() -> Unit
    ): Metric
    ...
    internal constructor(
         ...
         * Adds a statement to the IAM resource policy associated with this queue.
         *
         * If this queue was created in this stack (`new Queue`), a queue policy will be
         * automatically created upon the first call to `addToPolicy`. If the queue is imported
         * (`Queue.import`), then this is a no-op.
         *
         * @param statement
         */
        ...
        /**
         * Grant the actions defined in queueActions to the identity Principal given on this SQS
         * queue resource.
         *
         * @param grantee Principal to grant right to.
         * @param queueActions The actions to grant.
        ...
        override fun metricApproximateAgeOfOldestMessage(props: MetricOptions): Metric =
            unwrap(this)
                .metricApproximateAgeOfOldestMessage(props.let(MetricOptions::unwrap))
                .let(Metric::wrap)
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("bb447dbf2a82c05bdfcd7dcd24abf2ca95a39f1b33a13e2394e3ae4232332ada")
        override fun metricApproximateAgeOfOldestMessage(
            props: MetricOptions.Builder.() -> Unit
        ...
        override fun metricApproximateNumberOfMessagesDelayed(props: MetricOptions): Metric =
            unwrap(this)
                .metricApproximateNumberOfMessagesDelayed(props.let(MetricOptions::unwrap))
                .let(Metric::wrap)
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("ec20e8b1c6fa8dfa1811d5d75d734a7f4ccef6a8b1fc748ab047cd2c8a6b70a9")
        override fun metricApproximateNumberOfMessagesDelayed(
            props: MetricOptions.Builder.() -> Unit
        ...
        override fun metricApproximateNumberOfMessagesNotVisible(props: MetricOptions): Metric =
            unwrap(this)
                .metricApproximateNumberOfMessagesNotVisible(props.let(MetricOptions::unwrap))
                .let(Metric::wrap)
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("1e0e358f95f85dcccfdbf1e95cf401c51e0960552cdad28bac191cfd56faf4b1")
        override fun metricApproximateNumberOfMessagesNotVisible(
            props: MetricOptions.Builder.() -> Unit
        ...
        override fun metricApproximateNumberOfMessagesVisible(props: MetricOptions): Metric =
            unwrap(this)
                .metricApproximateNumberOfMessagesVisible(props.let(MetricOptions::unwrap))
                .let(Metric::wrap)
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("d90f82144565dad643479d1bf8c90cfa7841f02407b91ae1f30ecd1738076f01")
        override fun metricApproximateNumberOfMessagesVisible(
            props: MetricOptions.Builder.() -> Unit
        ...
        override fun metricNumberOfEmptyReceives(props: MetricOptions): Metric =
            unwrap(this)
                .metricNumberOfEmptyReceives(props.let(MetricOptions::unwrap))
                .let(Metric::wrap)
        ...
        override fun metricNumberOfMessagesDeleted(props: MetricOptions): Metric =
            unwrap(this)
                .metricNumberOfMessagesDeleted(props.let(MetricOptions::unwrap))
                .let(Metric::wrap)
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("43f4c13dd245a3194abcc55746b35f7f0f0efcc0f74c3a7b9a32d11805492932")
        override fun metricNumberOfMessagesDeleted(
            props: MetricOptions.Builder.() -> Unit
        ...
        override fun metricNumberOfMessagesReceived(props: MetricOptions): Metric =
            unwrap(this)
                .metricNumberOfMessagesReceived(props.let(MetricOptions::unwrap))
                .let(Metric::wrap)
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("2068c34cb94ecf96b8a1cf0fd6d58ebfd3ac48f69d718af0bdd6c1a31d866f18")
        override fun metricNumberOfMessagesReceived(
            props: MetricOptions.Builder.() -> Unit
        ...
        override fun metricNumberOfMessagesSent(props: MetricOptions): Metric =
            unwrap(this)
                .metricNumberOfMessagesSent(props.let(MetricOptions::unwrap))
                .let(Metric::wrap)
    ...
    public companion object {
        ...
        internal fun unwrap(wrapped: IQueue): software.amazon.awscdk.services.sqs.IQueue =
