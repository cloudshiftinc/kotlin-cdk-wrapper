...
public interface Channel {
     ...
     *
     * In this case, Amazon SageMaker wraps each individual S3 object in a RecordIO record. If the
     * input data is already in RecordIO format, you don't need to set this attribute.
     *
     * Default: - None
     */
    ...
    public interface Builder {
        ...
        /**
         * @param recordWrapperType Specify RecordIO as the value when input data is in raw format
         *   but the training algorithm requires the RecordIO format. In this case, Amazon SageMaker
         *   wraps each individual S3 object in a RecordIO record. If the input data is already in
         *   RecordIO format, you don't need to set this attribute.
         */
    ...
    internal constructor(
         ...
         * requires the RecordIO format.
         *
         * In this case, Amazon SageMaker wraps each individual S3 object in a RecordIO record. If
         * the input data is already in RecordIO format, you don't need to set this attribute.
         *
         * Default: - None
         */
