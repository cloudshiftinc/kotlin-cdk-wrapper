...
internal constructor(
    ...
    public interface Builder {
         ...
         * containing log data such as Application Load Balancer access logs, CloudFront logs, or
         ...
         *
         * @param logBucketList Authorizes the Shield Response Team (SRT) to access the specified
         *   Amazon S3 bucket containing log data such as Application Load Balancer access logs,
         ...
         * account to assist with DDoS attack mitigation during potential attacks.
         *
         * This enables the SRT to inspect your AWS WAF configuration and logs and to create or
         * update AWS WAF rules and web ACLs.
         *
         * You can associate only one `RoleArn` with your subscription. If you submit this update
         * for an account that already has an associated role, the new `RoleArn` will replace the
         * existing `RoleArn` .
         *
         * This change requires the following:
         * * You must be subscribed to the
         *   [Business Support plan](https://docs.aws.amazon.com/premiumsupport/business-support/)
         *   or the
         *   [Enterprise Support plan](https://docs.aws.amazon.com/premiumsupport/enterprise-support/)
         *   .
         ...
         *   .
         * * The `AWSShieldDRTAccessPolicy` managed policy must be attached to the role that you
         ...
         *   .
         * * The role must trust the service principal `drt.shield.amazonaws.com` . For information,
         *   see
         ...
         * request, you provide permissions to the SRT to inspect your AWS WAF and Shield
         * configuration and logs, and to create and update AWS WAF rules and web ACLs on your
         ...
         *
         * @param roleArn Authorizes the Shield Response Team (SRT) using the specified role, to
    ...
    public companion object {
        ...
        ): CfnDRTAccess = CfnDRTAccess(cdkObject)

        internal fun unwrap(
            wrapped: CfnDRTAccess
        ): software.amazon.awscdk.services.shield.CfnDRTAccess = wrapped.cdkObject
    }
}
