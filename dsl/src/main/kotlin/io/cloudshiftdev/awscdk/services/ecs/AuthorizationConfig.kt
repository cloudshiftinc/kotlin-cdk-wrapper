...
public interface AuthorizationConfig {
     ...
     *
     * If an access point is specified, the root directory value will be relative to the directory
     * set for the access point. If specified, transit encryption must be enabled in the
    ...
    public interface Builder {
        /**
         * @param accessPointId The access point ID to use. If an access point is specified, the
         *   root directory value will be relative to the directory set for the access point. If
         *   specified, transit encryption must be enabled in the EFSVolumeConfiguration.
         */
        public fun accessPointId(accessPointId: String)

        /**
         * @param iam Whether or not to use the Amazon ECS task IAM role defined in a task
    ...
    private class BuilderImpl : Builder {
        ...
        public fun build(): software.amazon.awscdk.services.ecs.AuthorizationConfig =
            cdkBuilder.build()
    }
    ...
    internal constructor(
         ...
         * The access point ID to use.
         *
         * If an access point is specified, the root directory value will be relative to the
         * directory set for the access point. If specified, transit encryption must be enabled in
