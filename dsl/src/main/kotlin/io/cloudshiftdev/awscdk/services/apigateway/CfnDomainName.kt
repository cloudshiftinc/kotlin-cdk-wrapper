...
internal constructor(
    ...
    public interface Builder {
         ...
         * domain.
         *
         * Only required when configuring mutual TLS and using an ACM imported or private CA
         ...
         *
         * @param ownershipVerificationCertificateArn The ARN of the public certificate issued by
         *   ACM to validate ownership of your custom domain.
         */
         ...
         *
         * @param regionalCertificateArn The reference to an AWS -managed certificate that will be
         *   used for validating the regional domain name.
         */
