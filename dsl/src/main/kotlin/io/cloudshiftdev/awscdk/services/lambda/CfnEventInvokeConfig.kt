...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param destinationConfig A destination for events after they have been sent to a function
         *   for processing.
         */
         ...
         *
         * @param maximumEventAgeInSeconds The maximum age of a request that Lambda sends to a
         ...
         *
         * @param maximumRetryAttempts The maximum number of times to retry when the function
         *   returns an error.
         */
