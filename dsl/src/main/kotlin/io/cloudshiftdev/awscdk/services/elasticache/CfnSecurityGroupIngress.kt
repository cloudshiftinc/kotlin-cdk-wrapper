...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param ec2SecurityGroupName Name of the EC2 Security Group to include in the
         *   authorization.
         */
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.elasticache.CfnSecurityGroupIngress.Builder.create(
                scope,
                id
            )
