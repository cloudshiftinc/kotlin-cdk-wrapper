...
internal constructor(
    ...
    public interface Builder {
         ...
         * Default: - None
         *
         * @param kmsKey AWS Key Management Service key that Amazon SageMaker uses to encrypt data
         ...
         *
         * @param productionVariants An list of ProductionVariant objects, one for each model that
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: SageMakerCreateEndpointConfig
        ): software.amazon.awscdk.services.stepfunctions.tasks.SageMakerCreateEndpointConfig =
            wrapped.cdkObject
    }
}
