...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.dax.CfnCluster,
    ...
    public interface Builder {
         ...
         *
         * @param availabilityZones The Availability Zones (AZs) in which the cluster nodes will
         *   reside after the cluster has been created or updated.
         */
         ...
         * * `TLS` - The cluster's endpoint will be encrypted with Transport Layer Security, and
         *   will provide an x509 certificate for authentication.
         *
         ...
         *
         * @param clusterEndpointEncryptionType The encryption type of the cluster's endpoint.
         *   Available values are:.
         */
         ...
         * A valid Amazon Resource Name (ARN) that identifies an IAM role.
         *
         * At runtime, DAX will assume this role and use the role's permissions to access DynamoDB
         * on your behalf.
         *
         ...
         *
         * @param notificationTopicArn The Amazon Resource Name (ARN) of the Amazon SNS topic to
         ...
         * A range of time when maintenance of DAX cluster software will be performed.
         *
         * For example: `sun:01:00-sun:09:00` . Cluster maintenance normally takes less than 30
         ...
         *
         * @param preferredMaintenanceWindow A range of time when maintenance of DAX cluster
         *   software will be performed.
         */
         ...
         * For additional fault tolerance, you can create a multiple node cluster with one or more
         * read replicas. To do this, set `ReplicationFactor` to a number between 3 (one primary and
         * two read replicas) and 10 (one primary and nine read replicas). `If the
         ...
         *
         * @param securityGroupIds A list of security group IDs to be assigned to each node in the
         *   DAX cluster.
         */
         ...
         *
         * @param sseSpecification Represents the settings used to enable server-side encryption on
         *   the cluster.
         */
    ...
    public interface SSESpecificationProperty {
        ...
        public interface Builder {
            /**
             * @param sseEnabled Indicates whether server-side encryption is enabled (true) or
