...
internal constructor(
    ...
    public interface Builder {
        ...
        /**
         * The OAuth 2.0 scopes that you will request from OpenID Connect. Scopes are groups of
         * OpenID Connect user attributes to exchange with your app.
         *
         * Default: ['openid']
         *
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.cognito.UserPoolIdentityProviderOidc.Builder.create(
                scope,
                id
            )
        ...
        override fun attributeRequestMethod(attributeRequestMethod: OidcAttributeRequestMethod) {
            cdkBuilder.attributeRequestMethod(
                attributeRequestMethod.let(OidcAttributeRequestMethod::unwrap)
            )
        }
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: UserPoolIdentityProviderOidc
