...
internal constructor(
    ...
    public open fun deploymentConfiguration(`value`: DeploymentConfigurationProperty) {
        unwrap(this)
            .setDeploymentConfiguration(`value`.let(DeploymentConfigurationProperty::unwrap))
    }
    ...
    public open fun deploymentConfiguration(
        `value`: DeploymentConfigurationProperty.Builder.() -> Unit
    ): Unit = deploymentConfiguration(DeploymentConfigurationProperty(`value`))
    ...
    public open fun deploymentController(
        `value`: DeploymentControllerProperty.Builder.() -> Unit
    ...
    public open fun networkConfiguration(
        `value`: NetworkConfigurationProperty.Builder.() -> Unit
    ...
    public open fun serviceConnectConfiguration(`value`: ServiceConnectConfigurationProperty) {
        unwrap(this)
            .setServiceConnectConfiguration(
                `value`.let(ServiceConnectConfigurationProperty::unwrap)
            )
    }
    ...
    public open fun serviceConnectConfiguration(
        `value`: ServiceConnectConfigurationProperty.Builder.() -> Unit
    ...
    public interface Builder {
         ...
         *
         * @param cluster The short name or full Amazon Resource Name (ARN) of the cluster that you
         *   run your service on.
         */
         ...
         *
         * @param deploymentConfiguration Optional deployment parameters that control how many tasks
        ...
        public fun deploymentConfiguration(
            deploymentConfiguration: DeploymentConfigurationProperty.Builder.() -> Unit
        )
        ...
        public fun deploymentController(
            deploymentController: DeploymentControllerProperty.Builder.() -> Unit
        )
         ...
         * in your service.
         *
         * For new services, if a desired count is not specified, a default value of `1` is used.
         * When using the `DAEMON` scheduling strategy, the desired count is not required.
         *
         ...
         *
         * @param desiredCount The number of instantiations of the specified task definition to
         ...
         *
         * @param enableExecuteCommand Determines whether the execute command functionality is
         *   turned on for the service.
         */
         ...
         * Elastic Load Balancing target health checks after a task has first started.
         *
         * This is only used when your service is configured to use a load balancer. If your service
         * has a load balancer defined and you don't specify a health check grace period value, the
         * default value of `0` is used.
         *
         * If you do not use an Elastic Load Balancing, we recommend that you use the `startPeriod`
         * in the task definition health check parameters. For more information, see
         ...
         * health checks, you can specify a health check grace period of up to 2,147,483,647 seconds
         * (about 69 years). During that time, the Amazon ECS service scheduler ignores health check
         * status. This grace period can prevent the service scheduler from marking tasks as
         ...
         * receive their own elastic network interface, and it is not supported for other network
         ...
         *
         * @param placementConstraints An array of placement constraint objects to use for tasks in
         *   your service.
         */
         ...
         *
         * @param placementStrategies The placement strategy objects to use for tasks in your
         *   service.
         */
         ...
         * The platform version that your tasks in the service are running on.
         *
         * A platform version is specified only for tasks using the Fargate launch type. If one
         * isn't specified, the `LATEST` platform version is used. For more information, see
         ...
         *
         * @param platformVersion The platform version that your tasks in the service are running
         *   on.
         */
         ...
         * make calls to your load balancer on your behalf.
         *
         * This parameter is only permitted if you are using a load balancer with your service and
         ...
         * parameter.
         *
         * If your account has already created the Amazon ECS service-linked role, that role is used
         * for your service unless you specify a role here. The service-linked role is required if
         * your task definition uses the `awsvpc` network mode or if the service is configured to
         ...
         * role name. For more information, see
         ...
         *   running tasks and will stop tasks that don't meet the placement constraints. When
         *   you're using this strategy, you don't need to specify a desired number of tasks, a task
         ...
         *
         * @param serviceConnectConfiguration The configuration for this service to discover and
        ...
        public fun serviceConnectConfiguration(
            serviceConnectConfiguration: ServiceConnectConfigurationProperty.Builder.() -> Unit
        )
         ...
         * allowed. Service names must be unique within a cluster, but you can have similarly named
         ...
         *
         * @param serviceRegistries The details of the service discovery registry to associate with
         *   this service. For more information, see
         *   [Service discovery](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/service-discovery.html)
         *   .
         */
         ...
         *
         * @param taskDefinition The `family` and `revision` ( `family:revision` ) or full ARN of
         ...
         *
         * @param volumeConfigurations The configuration for a volume specified in the task
         *   definition as a volume that is configured at launch time.
         */
    ...
    private class BuilderImpl(
         ...
         *   run during the deployment and the ordering of stopping and starting tasks.
         */
        override fun deploymentConfiguration(
            deploymentConfiguration: DeploymentConfigurationProperty
        ) {
            cdkBuilder.deploymentConfiguration(
                deploymentConfiguration.let(DeploymentConfigurationProperty::unwrap)
            )
        }
        ...
        override fun deploymentController(deploymentController: DeploymentControllerProperty) {
            cdkBuilder.deploymentController(
                deploymentController.let(DeploymentControllerProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("2d9892e0de74cfc9b3d2fc8dd7448baf5c7ea7cfd7bd4fb8a2bac7f3f1c29b6b")
        override fun deploymentController(
            deploymentController: DeploymentControllerProperty.Builder.() -> Unit
        ...
        override fun serviceConnectConfiguration(serviceConnectConfiguration: IResolvable) {
            cdkBuilder.serviceConnectConfiguration(
                serviceConnectConfiguration.let(IResolvable::unwrap)
            )
        }
         ...
         *   namespace.
         */
        override fun serviceConnectConfiguration(
            serviceConnectConfiguration: ServiceConnectConfigurationProperty
        ) {
            cdkBuilder.serviceConnectConfiguration(
                serviceConnectConfiguration.let(ServiceConnectConfigurationProperty::unwrap)
            )
        }
        ...
        override fun serviceConnectConfiguration(
            ...
            serviceConnectConfiguration(
                ServiceConnectConfigurationProperty(serviceConnectConfiguration)
            )
    ...
    public interface TimeoutConfigurationProperty {
         ...
         * request.
         *
         * A value of `0` can be set to disable `perRequestTimeout` . `perRequestTimeout` can only
         * be set if Service Connect `appProtocol` isn't `TCP` . Only `idleTimeout` is allowed for
         * `TCP` `appProtocol` .
         *
        ...
        public interface Builder {
            /**
             * @param idleTimeoutSeconds The amount of time in seconds a connection will stay active
             *   while idle. A value of `0` can be set to disable `idleTimeout` .
             *
             * The `idleTimeout` default for `HTTP` / `HTTP2` / `GRPC` is 5 minutes.
             *
             * The `idleTimeout` default for `TCP` is 1 hour.
            ...
            /**
             * @param perRequestTimeoutSeconds The amount of time waiting for the upstream to
             *   respond with a complete response per request. A value of `0` can be set to disable
        ...
        internal constructor(
             ...
             * request.
             *
             * A value of `0` can be set to disable `perRequestTimeout` . `perRequestTimeout` can
             * only be set if Service Connect `appProtocol` isn't `TCP` . Only `idleTimeout` is
             * allowed for `TCP` `appProtocol` .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ecs-service-timeoutconfiguration.html#cfn-ecs-service-timeoutconfiguration-perrequesttimeoutseconds)
             */
            override fun perRequestTimeoutSeconds(): Number? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TimeoutConfigurationProperty
            ): software.amazon.awscdk.services.ecs.CfnService.TimeoutConfigurationProperty =
    ...
    public interface LoadBalancerProperty {
         ...
         * the target type, not `instance` . Do this when creating your target groups because tasks
         * that use the `awsvpc` network mode are associated with an elastic network interface, not
         * an Amazon EC2 instance. This network mode is required for the Fargate launch type.
         *
        ...
        public interface Builder {
            /**
             * @param containerName The name of the container (as it appears in a container
             *   definition) to associate with the load balancer. You need to specify the container
             *   name when configuring the target group for an Amazon ECS load balancer.
             */
            public fun containerName(containerName: String)

            /**
             * @param containerPort The port on the container to associate with the load balancer.
             *   This port must correspond to a `containerPort` in the task definition the tasks in
             *   the service are using. For tasks that use the EC2 launch type, the container
             *   instance they're launched on must allow ingress traffic on the `hostPort` of the
             *   port mapping.
             */
            public fun containerPort(containerPort: Number)

            /**
             * @param loadBalancerName The name of the load balancer to associate with the Amazon
             *   ECS service or task set. If you are using an Application Load Balancer or a Network
             *   Load Balancer the load balancer name parameter should be omitted.
             */
            public fun loadBalancerName(loadBalancerName: String)

            /**
             * @param targetGroupArn The full Amazon Resource Name (ARN) of the Elastic Load
             *   Balancing target group or groups associated with a service or task set. A target
             *   group ARN is only specified when using an Application Load Balancer or Network Load
             *   Balancer.
             *
             * For services using the `ECS` deployment controller, you can specify one or multiple
             * target groups. For more information, see
        ...
        internal constructor(
             ...
             *
             * This port must correspond to a `containerPort` in the task definition the tasks in
             * the service are using. For tasks that use the EC2 launch type, the container instance
    ...
    public interface ServiceConnectClientAliasProperty {
         ...
         * include up to 127 characters. The name can include lowercase letters, numbers,
        ...
        public interface Builder {
            /**
             * @param dnsName The `dnsName` is the name that you use in the applications of client
             *   tasks to connect to this service. The name must be a valid DNS name but doesn't
             *   need to be fully-qualified. The name can include up to 127 characters. The name can
             ...
             * `redis` . For more information, see
             * [Service Connect](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/service-connect.html)
             * in the *Amazon Elastic Container Service Developer Guide* .
             */
            ...
            /**
             * @param port The listening port number for the Service Connect proxy. This port is
             *   available inside of all of the tasks within the same namespace.
             *
             * To avoid changing your applications in client Amazon ECS services, set this to the
             * same port that the client application uses by default. For more information, see
             * [Service Connect](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/service-connect.html)
             * in the *Amazon Elastic Container Service Developer Guide* .
             */
        ...
        internal constructor(
            ...
            /**
             * The `dnsName` is the name that you use in the applications of client tasks to connect
             * to this service.
             *
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ServiceConnectClientAliasProperty
            ): software.amazon.awscdk.services.ecs.CfnService.ServiceConnectClientAliasProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ServiceConnectTlsCertificateAuthorityProperty {
        ...
        public interface Builder {
            /**
             * @param awsPcaAuthorityArn The ARN of the AWS Private Certificate Authority
             *   certificate.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ServiceConnectTlsCertificateAuthorityProperty
            ): software.amazon.awscdk.services.ecs.CfnService.ServiceConnectTlsCertificateAuthorityProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ServiceConnectServiceProperty {
        ...
        public interface Builder {
            /**
             * @param clientAliases The list of client aliases for this Service Connect service. You
             *   use these to assign names that can be used by client applications. The maximum
            ...
            /**
             * @param discoveryName The `discoveryName` is the name of the new AWS Cloud Map service
             *   that Amazon ECS creates for this Amazon ECS service. This must be unique within the
             *   AWS Cloud Map namespace. The name can contain up to 64 characters. The name can
            ...
            /**
             * @param ingressPortOverride The port number for the Service Connect proxy to listen
             *   on. Use the value of this field to bypass the proxy for traffic on the port number
             ...
             *
             * In `awsvpc` mode and Fargate, the default value is the container port number. The
             * container port number is in the `portMapping` in the task definition. In bridge mode,
             * the default value is the ephemeral port of the Service Connect proxy.
             */
            public fun ingressPortOverride(ingressPortOverride: Number)

            /**
             * @param portName The `portName` must match the name of one of the `portMappings` from
        ...
        internal constructor(
             ...
             * specified in the named `portMapping` in the task definition of this application, and
             * then use it in your VPC security groups to allow traffic into the proxy for this
             * Amazon ECS service.
             *
             * In `awsvpc` mode and Fargate, the default value is the container port number. The
             * container port number is in the `portMapping` in the task definition. In bridge mode,
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ServiceConnectServiceProperty
            ): software.amazon.awscdk.services.ecs.CfnService.ServiceConnectServiceProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface NetworkConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param awsvpcConfiguration The VPC subnets and security groups that are associated
             *   with a task.
             *
             * All specified subnets and security groups must be from the same VPC.
             */
    ...
    public interface ServiceManagedEBSVolumeConfigurationProperty {
         ...
         *
         * If no value is specified, encryption is turned on by default. This parameter maps 1:1
         * with the `Encrypted` parameter of the
         ...
         * volume was using when the snapshot was created. If there is a filesystem type mismatch,
        ...
        /**
         * The Amazon Resource Name (ARN) identifier of the AWS Key Management Service key to use
         ...
         * snapshot size is used for the volume size by default. You can optionally specify a volume
         ...
         * `TagSpecifications.N` parameter of the
         * [CreateVolume API](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_CreateVolume.html)
         * in the *Amazon EC2 API Reference* .
         *
         ...
         * The volume type.
         *
         * This parameter maps 1:1 with the `VolumeType` parameter of the
         * [CreateVolume API](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_CreateVolume.html)
        ...
        public interface Builder {
            /**
             * @param encrypted Indicates whether the volume should be encrypted. If no value is
             *   specified, encryption is turned on by default. This parameter maps 1:1 with the
             *   `Encrypted` parameter of the
             *   [CreateVolume API](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_CreateVolume.html)
             *   in the *Amazon EC2 API Reference* .
             */
            ...
            /**
             * @param filesystemType The Linux filesystem type for the volume. For volumes created
             *   from a snapshot, you must specify the same filesystem type that the volume was
             *   using when the snapshot was created. If there is a filesystem type mismatch, the
            ...
            /**
             * @param kmsKeyId The Amazon Resource Name (ARN) identifier of the AWS Key Management
             *   Service key to use for Amazon EBS encryption. When encryption is turned on and no
             *   AWS Key Management Service key is specified, the default AWS managed key for Amazon
             *   EBS volumes is used. This parameter maps 1:1 with the `KmsKeyId` parameter of the
             *   [CreateVolume API](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_CreateVolume.html)
             *   in the *Amazon EC2 API Reference* .
             *
             * AWS authenticates the AWS Key Management Service key asynchronously. Therefore, if
             * you specify an ID, alias, or ARN that is invalid, the action can appear to complete,
             * but eventually fails.
             */
            public fun kmsKeyId(kmsKeyId: String)

            /**
             * @param roleArn The ARN of the IAM role to associate with this volume. This is the
             *   Amazon ECS infrastructure IAM role that is used to manage your AWS infrastructure.
             *   We recommend using the Amazon ECS-managed
             *   `AmazonECSInfrastructureRolePolicyForVolumes` IAM policy with this role. For more
             *   information, see
             *   [Amazon ECS infrastructure IAM role](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/infrastructure_IAM_role.html)
             *   in the *Amazon ECS Developer Guide* .
            ...
            /**
             * @param sizeInGiB The size of the volume in GiB. You must specify either a volume size
             *   or a snapshot ID. If you specify a snapshot ID, the snapshot size is used for the
            ...
            /**
             * @param snapshotId The snapshot that Amazon ECS uses to create the volume. You must
             *   specify either a snapshot ID or a volume size. This parameter maps 1:1 with the
             *   `SnapshotId` parameter of the
             *   [CreateVolume API](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_CreateVolume.html)
             *   in the *Amazon EC2 API Reference* .
             */
            ...
            /**
             * @param tagSpecifications The tags to apply to the volume. Amazon ECS applies
             *   service-managed tags by default. This parameter maps 1:1 with the
             *   `TagSpecifications.N` parameter of the
             *   [CreateVolume API](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_CreateVolume.html)
             *   in the *Amazon EC2 API Reference* .
             */
            ...
            /**
             * @param throughput The throughput to provision for a volume, in MiB/s, with a maximum
             *   of 1,000 MiB/s. This parameter maps 1:1 with the `Throughput` parameter of the
             *   [CreateVolume API](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_CreateVolume.html)
             *   in the *Amazon EC2 API Reference* .
             *
             * This parameter is only supported for the `gp3` volume type.
            ...
            /**
             * @param volumeType The volume type. This parameter maps 1:1 with the `VolumeType`
             *   parameter of the
             *   [CreateVolume API](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_CreateVolume.html)
             *   in the *Amazon EC2 API Reference* . For more information, see
             *   [Amazon EBS volume types](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ebs-volume-types.html)
        ...
        internal constructor(
            ...
            /**
             * The Amazon Resource Name (ARN) identifier of the AWS Key Management Service key to
             * use for Amazon EBS encryption.
             *
             * When encryption is turned on and no AWS Key Management Service key is specified, the
             * default AWS managed key for Amazon EBS volumes is used. This parameter maps 1:1 with
             * the `KmsKeyId` parameter of the
             * [CreateVolume API](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_CreateVolume.html)
             * in the *Amazon EC2 API Reference* .
             *
             * AWS authenticates the AWS Key Management Service key asynchronously. Therefore, if
             ...
             * The size of the volume in GiB.
             *
             * You must specify either a volume size or a snapshot ID. If you specify a snapshot ID,
             * the snapshot size is used for the volume size by default. You can optionally specify
             * a volume size greater than or equal to the snapshot size. This parameter maps 1:1
             * with the `Size` parameter of the
             * [CreateVolume API](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_CreateVolume.html)
             * in the *Amazon EC2 API Reference* .
             *
             * The following are the supported volume size values for each volume type.
             ...
             * The snapshot that Amazon ECS uses to create the volume.
             *
             * You must specify either a snapshot ID or a volume size. This parameter maps 1:1 with
             * the `SnapshotId` parameter of the
             * [CreateVolume API](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_CreateVolume.html)
             * in the *Amazon EC2 API Reference* .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ecs-service-servicemanagedebsvolumeconfiguration.html#cfn-ecs-service-servicemanagedebsvolumeconfiguration-snapshotid)
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ServiceManagedEBSVolumeConfigurationProperty
            ): software.amazon.awscdk.services.ecs.CfnService.ServiceManagedEBSVolumeConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DeploymentControllerProperty {
         ...
         *   Amazon ECS adds or removes from the service during a rolling update is controlled by
         *   adjusting the minimum and maximum number of healthy tasks allowed during a service
         *   deployment, as specified in the
        ...
        public interface Builder {
             ...
             * * **ECS** - The rolling update ( `ECS` ) deployment type involves replacing the
             ...
             *   [DeploymentConfiguration](https://docs.aws.amazon.com/AmazonECS/latest/APIReference/API_DeploymentConfiguration.html)
             *   .
             * * **CODE_DEPLOY** - The blue/green ( `CODE_DEPLOY` ) deployment type uses the
             *   blue/green deployment model powered by AWS CodeDeploy , which allows you to verify
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DeploymentControllerProperty
            ): software.amazon.awscdk.services.ecs.CfnService.DeploymentControllerProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ServiceConnectConfigurationProperty {
         ...
         * log driver configuration in the container definition. For more information about the
         ...
         *   register the available logging drivers with the `ECS_AVAILABLE_LOGGING_DRIVERS`
         ...
         *   infrastructure your tasks are hosted on, any additional software needed must be
         *   installed outside of the task. For example, the Fluentd output aggregators or a remote
         ...
         * type of namespace doesn't affect Service Connect. For more information about AWS Cloud
         * Map , see
        ...
        public interface Builder {
            ...
            /**
             * @param logConfiguration The log configuration for the container. This parameter maps
             *   to `LogConfig` in the
             *   [Create a container](https://docs.aws.amazon.com/https://docs.docker.com/engine/api/v1.35/#operation/ContainerCreate)
             *   section of the
             *   [Docker Remote API](https://docs.aws.amazon.com/https://docs.docker.com/engine/api/v1.35/)
             ...
             * information about the options for different supported log drivers, see
             * [Configure logging drivers](https://docs.aws.amazon.com/https://docs.docker.com/engine/admin/logging/overview/)
             * in the Docker documentation.
             *
             * Understand the following when specifying a log configuration for your containers.
             ...
             * * For tasks that are on AWS Fargate , because you don't have access to the underlying
             *   infrastructure your tasks are hosted on, any additional software needed must be
             *   installed outside of the task. For example, the Fluentd output aggregators or a
            ...
            /**
             * @param namespace The namespace name or full Amazon Resource Name (ARN) of the AWS
             *   Cloud Map namespace for use with Service Connect. The namespace must be in the same
             *   AWS Region as the Amazon ECS service and cluster. The type of namespace doesn't
             *   affect Service Connect. For more information about AWS Cloud Map , see
             *   [Working with Services](https://docs.aws.amazon.com/cloud-map/latest/dg/working-with-services.html)
             *   in the *AWS Cloud Map Developer Guide* .
             */
            ...
            /**
             * @param services The list of Service Connect service objects. These are names and
             *   aliases (also known as endpoints) that are used by other Amazon ECS services to
             ...
             * balancer that's attached to the service or by other means.
             *
             * An object selects a port from the task definition, assigns a name for the AWS Cloud
             * Map service, and a list of aliases (endpoints) and ports for client applications to
        ...
        internal constructor(
            ...
            /**
             * The namespace name or full Amazon Resource Name (ARN) of the AWS Cloud Map namespace
             * for use with Service Connect.
             *
             * The namespace must be in the same AWS Region as the Amazon ECS service and cluster.
             * The type of namespace doesn't affect Service Connect. For more information about AWS
             * Cloud Map , see
             * [Working with Services](https://docs.aws.amazon.com/cloud-map/latest/dg/working-with-services.html)
             * in the *AWS Cloud Map Developer Guide* .
             *
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ServiceConnectConfigurationProperty
            ): software.amazon.awscdk.services.ecs.CfnService.ServiceConnectConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DeploymentConfigurationProperty {
         ...
         * service is using the `REPLICA` service scheduler and has a `desiredCount` of four tasks
         * and a `maximumPercent` value of 200%, the scheduler may start four new tasks before
         * stopping the four older tasks (provided that the cluster resources required to do this
         * are available). The default `maximumPercent` value for a service using the `REPLICA`
         ...
         * of 50%, the service scheduler may stop two existing tasks to free up cluster capacity
         ...
         *   scheduler will wait for 40 seconds after a task reaches a `RUNNING` state before the
         *   task is counted towards the minimum healthy percent total.
         ...
         * * If a task has no essential containers with a health check defined, the service
         *   scheduler will wait for the load balancer target group health check to return a healthy
         ...
         *
         * If a service is using either the blue/green ( `CODE_DEPLOY` ) or `EXTERNAL` deployment
         * types and is running tasks that use the EC2 launch type, the *minimum healthy percent*
         * value is set to the default value and is used to define the lower limit on the number of
         * the tasks in the service that remain in the `RUNNING` state while the container instances
         * are in the `DRAINING` state. If a service is using either the blue/green ( `CODE_DEPLOY`
         * ) or `EXTERNAL` deployment types and is running tasks that use the Fargate launch type,
        ...
        public interface Builder {
             ...
             *   services using the rolling update ( `ECS` ) deployment type. The *deployment
             *   circuit breaker* determines whether a service deployment will fail if the service
             *   can't reach a steady state. If you use the deployment circuit breaker, a service
             *   deployment will transition to a failed state and stop launching new tasks. If you
             *   use the rollback option, when a service deployment fails, the service is rolled
            ...
            public fun deploymentCircuitBreaker(
                deploymentCircuitBreaker: DeploymentCircuitBreakerProperty.Builder.() -> Unit
            )

            /**
             * @param maximumPercent If a service is using the rolling update ( `ECS` ) deployment
             *   type, the `maximumPercent` parameter represents an upper limit on the number of
             *   your service's tasks that are allowed in the `RUNNING` or `PENDING` state during a
             ...
             * deployment types and tasks that use the EC2 launch type, the *maximum percent* value
             * is set to the default value and is used to define the upper limit on the number of
            ...
            /**
             * @param minimumHealthyPercent If a service is using the rolling update ( `ECS` )
             *   deployment type, the `minimumHealthyPercent` represents a lower limit on the number
             *   of your service's tasks that must remain in the `RUNNING` state during a
             *   deployment, as a percentage of the `desiredCount` (rounded up to the nearest
             *   integer). This parameter enables you to deploy without using additional cluster
             ...
             * * If a task has one or more essential containers with a health check defined, the
             *   service scheduler will wait for the task to reach a healthy status before counting
             *   it towards the minimum healthy percent total. A task is considered healthy when all
             *   essential containers within the task have passed their health checks. The amount of
             *   time the service scheduler can wait for is determined by the container health check
             *   settings.
             *
             * For services that *do* use a load balancer, the following should be noted:
             * * If a task has no essential containers with a health check defined, the service
             ...
             *   balancer target group health check to return a healthy status before counting the
             ...
             * limit on the number of the tasks in the service that remain in the `RUNNING` state
             * while the container instances are in the `DRAINING` state. If a service is using
             * either the blue/green ( `CODE_DEPLOY` ) or `EXTERNAL` deployment types and is running
             * tasks that use the Fargate launch type, the minimum healthy percent value is not
        ...
        private class BuilderImpl : Builder {
            ...
            override fun deploymentCircuitBreaker(deploymentCircuitBreaker: IResolvable) {
                cdkBuilder.deploymentCircuitBreaker(
                    deploymentCircuitBreaker.let(IResolvable::unwrap)
                )
            }
             ...
             *   in the *Amazon Elastic Container Service Developer Guide*
             */
            override fun deploymentCircuitBreaker(
                deploymentCircuitBreaker: DeploymentCircuitBreakerProperty
            ) {
                cdkBuilder.deploymentCircuitBreaker(
                    deploymentCircuitBreaker.let(DeploymentCircuitBreakerProperty::unwrap)
                )
            }
        ...
        internal constructor(
             ...
             * ( `ECS` ) deployment type.
             *
             * The *deployment circuit breaker* determines whether a service deployment will fail if
             * the service can't reach a steady state. If you use the deployment circuit breaker, a
             * service deployment will transition to a failed state and stop launching new tasks. If
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ecs-service-deploymentconfiguration.html#cfn-ecs-service-deploymentconfiguration-deploymentcircuitbreaker)
             */
            override fun deploymentCircuitBreaker(): Any? =
             ...
             * tasks that are allowed in the `RUNNING` or `PENDING` state during a deployment, as a
             * percentage of the `desiredCount` (rounded down to the nearest integer).
             *
             * This parameter enables you to define the deployment batch size. For example, if your
             * service is using the `REPLICA` service scheduler and has a `desiredCount` of four
             * tasks and a `maximumPercent` value of 200%, the scheduler may start four new tasks
             * before stopping the four older tasks (provided that the cluster resources required to
             * do this are available). The default `maximumPercent` value for a service using the
             ...
             * tasks that must remain in the `RUNNING` state during a deployment, as a percentage of
             * the `desiredCount` (rounded up to the nearest integer).
             *
             * This parameter enables you to deploy without using additional cluster capacity. For
             * example, if your service has a `desiredCount` of four tasks and a
             * `minimumHealthyPercent` of 50%, the service scheduler may stop two existing tasks to
             * free up cluster capacity before starting two new tasks.
             *
             * For services that *do not* use a load balancer, the following should be noted:
             * * A service is considered healthy if all essential containers within the tasks in the
             *   service pass their health checks.
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DeploymentConfigurationProperty
            ): software.amazon.awscdk.services.ecs.CfnService.DeploymentConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface EBSTagSpecificationProperty {
        ...
        public interface Builder {
            /**
             * @param propagateTags Determines whether to propagate the tags from the task
             *   definition to the Amazon EBS volume. Tags can only propagate to a `SERVICE`
             *   specified in `ServiceVolumeConfiguration` . If no value is specified, the tags
             *   aren't propagated.
             */
            public fun propagateTags(propagateTags: String)
        ...
        internal constructor(
             ...
             * volume.
             *
             * Tags can only propagate to a `SERVICE` specified in `ServiceVolumeConfiguration` . If
             * no value is specified, the tags aren't propagated.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ecs-service-ebstagspecification.html#cfn-ecs-service-ebstagspecification-propagatetags)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: EBSTagSpecificationProperty
            ): software.amazon.awscdk.services.ecs.CfnService.EBSTagSpecificationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface PlacementStrategyProperty {
         ...
         * `spread` placement strategy spreads placement across available candidates evenly based on
         * the `field` parameter. The `binpack` strategy places tasks on available candidates that
        ...
        public interface Builder {
             ...
             *   instance, such as `attribute:ecs.availability-zone` . For the `binpack` placement
             *   strategy, valid values are `CPU` and `MEMORY` . For the `random` placement
             ...
             *   `binpack` strategy places tasks on available candidates that have the least
             *   available amount of the resource that's specified with the `field` parameter. For
             *   example, if you binpack on memory, a task is placed on the instance with the least
        ...
        internal constructor(
             ...
             * container instance, such as `attribute:ecs.availability-zone` . For the `binpack`
             * placement strategy, valid values are `CPU` and `MEMORY` . For the `random` placement
             * strategy, this field is not used.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ecs-service-placementstrategy.html#cfn-ecs-service-placementstrategy-field)
             */
             ...
             *
             * The `random` placement strategy randomly places tasks on available candidates. The
             * `spread` placement strategy spreads placement across available candidates evenly
             * based on the `field` parameter. The `binpack` strategy places tasks on available
             * candidates that have the least available amount of the resource that's specified with
             * the `field` parameter. For example, if you binpack on memory, a task is placed on the
    ...
    public interface ServiceRegistryProperty {
         ...
         * `containerName` and `containerPort` combination from the task definition. If the task
         * definition that your service task specifies uses the `awsvpc` network mode and a type SRV
         * DNS record is used, you must specify either a `containerName` and `containerPort`
         ...
         * and `containerPort` combination from the task definition. If the task definition your
        ...
        public interface Builder {
             ...
             *   service. It's already specified in the task definition. If the task definition that
             *   your service task specifies uses the `bridge` or `host` network mode, you must
             *   specify a `containerName` and `containerPort` combination from the task definition.
             *   If the task definition that your service task specifies uses the `awsvpc` network
             ...
             *   It's already specified in the task definition. If the task definition your service
             *   task specifies uses the `bridge` or `host` network mode, you must specify a
            ...
            /**
             * @param port The port value used if your service discovery service specified an SRV
             *   record. This field might be used if both the `awsvpc` network mode and SRV records
             *   are used.
             */
            public fun port(port: Number)

            /**
             * @param registryArn The Amazon Resource Name (ARN) of the service registry. The
             *   currently supported service registry is AWS Cloud Map . For more information, see
             *   [CreateService](https://docs.aws.amazon.com/cloud-map/latest/api/API_CreateService.html)
             *   .
             */
        ...
        internal constructor(
             ...
             * The container name value to be used for your service discovery service.
             *
             * It's already specified in the task definition. If the task definition that your
             * service task specifies uses the `bridge` or `host` network mode, you must specify a
             * `containerName` and `containerPort` combination from the task definition. If the task
             * definition that your service task specifies uses the `awsvpc` network mode and a type
             * SRV DNS record is used, you must specify either a `containerName` and `containerPort`
             * combination or a `port` value. However, you can't specify both.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ecs-service-serviceregistry.html#cfn-ecs-service-serviceregistry-containername)
             */
             ...
             * task specifies uses the `bridge` or `host` network mode, you must specify a
             * `containerName` and `containerPort` combination from the task definition. If the task
             * definition your service task specifies uses the `awsvpc` network mode and a type SRV
             * DNS record is used, you must specify either a `containerName` and `containerPort`
             * combination or a `port` value. However, you can't specify both.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ecs-service-serviceregistry.html#cfn-ecs-service-serviceregistry-containerport)
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ServiceRegistryProperty
            ): software.amazon.awscdk.services.ecs.CfnService.ServiceRegistryProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SecretProperty {
        ...
        public companion object {
            ...
            ): software.amazon.awscdk.services.ecs.CfnService.SecretProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CapacityProviderStrategyItemProperty {
         ...
         * capacity provider.
         *
         * Only one capacity provider in a capacity provider strategy can have a *base* defined. If
         ...
         * providers and both have a weight of `1` , then when the `base` is satisfied, the tasks
         * will be split evenly across the two capacity providers. Using that same logic, if you
         * specify a weight of `1` for *capacityProviderA* and a weight of `4` for
        ...
        public interface Builder {
            ...
            /**
             * @param weight The *weight* value designates the relative percentage of the total
             *   number of tasks launched that should use the specified capacity provider. The
             *   `weight` value is taken into consideration after the `base` value, if defined, is
             *   satisfied.
             *
             * If no `weight` value is specified, the default value of `0` is used. When multiple
             * capacity providers are specified within a capacity provider strategy, at least one of
             * the capacity providers must have a weight value greater than zero and any capacity
             * providers with a weight of `0` can't be used to place tasks. If you specify multiple
             * capacity providers in a strategy that all have a weight of `0` , any `RunTask` or
             ...
             * capacity providers and both have a weight of `1` , then when the `base` is satisfied,
             * the tasks will be split evenly across the two capacity providers. Using that same
             * logic, if you specify a weight of `1` for *capacityProviderA* and a weight of `4` for
             * *capacityProviderB* , then for every one task that's run using *capacityProviderA* ,
    ...
    public interface PlacementConstraintProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param type The type of constraint. Use `distinctInstance` to ensure that each task
             *   in a particular group is running on a different container instance. Use `memberOf`
    ...
    public interface AwsVpcConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param assignPublicIp Whether the task's elastic network interface receives a public
             *   IP address. The default value is `DISABLED` .
             */
            public fun assignPublicIp(assignPublicIp: String)

            /**
             * @param securityGroups The IDs of the security groups associated with the task or
             *   service. If you don't specify a security group, the default security group for the
             *   VPC is used. There's a limit of 5 security groups that can be specified per
             *   `AwsVpcConfiguration` .
             *
             * All specified security groups must be from the same VPC.
             */
            ...
            /**
             * @param subnets The IDs of the subnets associated with the task or service. There's a
    ...
    public interface ServiceConnectTlsConfigurationProperty {
        ...
        public interface Builder {
            ...
            public fun issuerCertificateAuthority(
                issuerCertificateAuthority:
                    ServiceConnectTlsCertificateAuthorityProperty.Builder.() -> Unit
            )
            ...
            /**
             * @param roleArn The Amazon Resource Name (ARN) of the IAM role that's associated with
        ...
        private class BuilderImpl : Builder {
            ...
            override fun issuerCertificateAuthority(issuerCertificateAuthority: IResolvable) {
                cdkBuilder.issuerCertificateAuthority(
                    issuerCertificateAuthority.let(IResolvable::unwrap)
                )
            }

            /** @param issuerCertificateAuthority The signer certificate authority. */
            override fun issuerCertificateAuthority(
                issuerCertificateAuthority: ServiceConnectTlsCertificateAuthorityProperty
            ) {
                cdkBuilder.issuerCertificateAuthority(
                    issuerCertificateAuthority.let(
                        ServiceConnectTlsCertificateAuthorityProperty::unwrap
                    )
                )
            }
            ...
            override fun issuerCertificateAuthority(
                ...
                issuerCertificateAuthority(
                    ServiceConnectTlsCertificateAuthorityProperty(issuerCertificateAuthority)
                )
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ecs-service-serviceconnecttlsconfiguration.html#cfn-ecs-service-serviceconnecttlsconfiguration-issuercertificateauthority)
             */
            override fun issuerCertificateAuthority(): Any =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ServiceConnectTlsConfigurationProperty
            ): software.amazon.awscdk.services.ecs.CfnService.ServiceConnectTlsConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DeploymentCircuitBreakerProperty {
         ...
         * deployment fails.
         *
         * If rollback is on, when a service deployment fails, the service is rolled back to the
        ...
        public interface Builder {
            ...
            /**
             * @param rollback Determines whether to configure Amazon ECS to roll back the service
             *   if a service deployment fails. If rollback is on, when a service deployment fails,
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DeploymentCircuitBreakerProperty
            ): software.amazon.awscdk.services.ecs.CfnService.DeploymentCircuitBreakerProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ServiceVolumeConfigurationProperty {
         ...
         * behalf.
         *
         * These settings are used to create each Amazon EBS volume, with one volume created for
         * each task in the service. The Amazon EBS volumes are visible in your account in the
        ...
        public interface Builder {
            /**
             * @param managedEbsVolume The configuration for the Amazon EBS volume that Amazon ECS
             *   creates and manages on your behalf. These settings are used to create each Amazon
             *   EBS volume, with one volume created for each task in the service. The Amazon EBS
            ...
            public fun managedEbsVolume(
                managedEbsVolume: ServiceManagedEBSVolumeConfigurationProperty.Builder.() -> Unit
            )

            /**
             * @param name The name of the volume. This value must match the volume name from the
        ...
        private class BuilderImpl : Builder {
            ...
            override fun managedEbsVolume(
                ...
                cdkBuilder.managedEbsVolume(
                    managedEbsVolume.let(ServiceManagedEBSVolumeConfigurationProperty::unwrap)
                )
            }
            ...
            override fun managedEbsVolume(
                ...
                managedEbsVolume(ServiceManagedEBSVolumeConfigurationProperty(managedEbsVolume))
        ...
        internal constructor(
             ...
             * The name of the volume.
             *
             * This value must match the volume name from the `Volume` object in the task
             * definition.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ecs-service-servicevolumeconfiguration.html#cfn-ecs-service-servicevolumeconfiguration-name)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ServiceVolumeConfigurationProperty
            ): software.amazon.awscdk.services.ecs.CfnService.ServiceVolumeConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DeploymentAlarmsProperty {
        ...
        public interface Builder {
            /**
             * @param alarmNames One or more CloudWatch alarm names. Use a "," to separate the
             *   alarms.
             */
            ...
            /**
             * @param rollback Determines whether to configure Amazon ECS to roll back the service
             *   if a service deployment fails. If rollback is used, when a service deployment
        ...
        private class BuilderImpl : Builder {
             ...
             *   alarms.
             */
            override fun alarmNames(vararg alarmNames: String): Unit =
                alarmNames(alarmNames.toList())
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DeploymentAlarmsProperty
            ): software.amazon.awscdk.services.ecs.CfnService.DeploymentAlarmsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
