...
public interface BasicLifecycleHookProps {
     ...
     */
    public fun heartbeatTimeout(): Duration? =
    ...
    public interface Builder {
        ...
        /**
         * @param heartbeatTimeout Maximum time between calls to RecordLifecycleActionHeartbeat for
         *   the hook. If the lifecycle hook times out, perform the action in DefaultResult.
         */
        ...
        /**
         * @param lifecycleTransition The state of the Amazon EC2 instance to which you want to
         *   attach the lifecycle hook.
         */
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: BasicLifecycleHookProps
