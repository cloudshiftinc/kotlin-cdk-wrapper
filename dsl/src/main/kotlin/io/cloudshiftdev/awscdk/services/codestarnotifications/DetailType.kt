...
public enum class DetailType(
    ...
    public companion object {
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.codestarnotifications.DetailType
        ): DetailType =
            when (cdkObject) {
                software.amazon.awscdk.services.codestarnotifications.DetailType.BASIC ->
                    DetailType.BASIC
                software.amazon.awscdk.services.codestarnotifications.DetailType.FULL ->
                    DetailType.FULL
            }
