...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.s3.CfnAccessPoint,
     ...
     * the access point doesn't allow access from the internet. Otherwise, `NetworkOrigin` is
     * `Internet` , and the access point allows access from the internet, subject to the access
    ...
    public interface Builder {
         ...
         *
         * @param bucketAccountId The AWS account ID associated with the S3 bucket associated with
         *   this access point.
         */
         ...
         *
         * @param publicAccessBlockConfiguration The PublicAccessBlock configuration that you want
         ...
         *
         * @param vpcConfiguration The Virtual Private Cloud (VPC) configuration for this access
         *   point, if one exists.
         */
    ...
    public companion object {
        ...
        ): software.amazon.awscdk.services.s3.CfnAccessPoint = wrapped.cdkObject
    }
    ...
    public interface VpcConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param vpcId If this field is specified, the access point will only allow connections
