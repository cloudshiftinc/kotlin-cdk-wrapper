...
internal constructor(
    ...
    private class BuilderImpl(
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("ca106e9831e28b258c6a2cd5396f4b7d9726213f7a085efab4a2304461b4084a")
        override fun defaultRoute(
            defaultRoute: DefaultRouteInputProperty.Builder.() -> Unit
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("7b80c88766ed37adf2d5d8261d64bab5cfc07f8aee3d6690638691521de18a34")
        override fun uriPathRoute(
            uriPathRoute: UriPathRouteInputProperty.Builder.() -> Unit
        ): Unit = uriPathRoute(UriPathRouteInputProperty(uriPathRoute))

        public fun build(): software.amazon.awscdk.services.refactorspaces.CfnRoute =
            cdkBuilder.build()
    }
    ...
    public companion object {
        ...
        ): CfnRoute = CfnRoute(cdkObject)

        internal fun unwrap(
            wrapped: CfnRoute
        ): software.amazon.awscdk.services.refactorspaces.CfnRoute = wrapped.cdkObject
    }
    ...
    public interface UriPathRouteInputProperty {
         ...
         * parameters in the source path, add a variable in curly braces. For example, the resource
        ...
        public interface Builder {
            /**
             * @param activationState If set to `ACTIVE` , traffic is forwarded to this route’s
            ...
            /**
             * @param includeChildPaths Indicates whether to match all subpaths of the given source
             *   path. If this value is `false` , requests must match the source path exactly before
             *   they are forwarded to this route's service.
             */
            ...
            /**
             * @param methods A list of HTTP methods to match. An empty list matches all values. If
             *   a method is present, only HTTP requests using that method are forwarded to this
             *   route’s service.
             */
            ...
            /**
             * @param sourcePath This is the path that Refactor Spaces uses to match traffic. Paths
             *   must start with `/` and are relative to the base of the application. To use path
             *   parameters in the source path, add a variable in curly braces. For example, the
             *   resource path {user} represents a path parameter called 'user'.
             */
        ...
        internal constructor(
             ...
             * Indicates whether to match all subpaths of the given source path.
             *
             * If this value is `false` , requests must match the source path exactly before they
             ...
             * A list of HTTP methods to match.
             *
             * An empty list matches all values. If a method is present, only HTTP requests using
             * that method are forwarded to this route’s service.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-refactorspaces-route-uripathrouteinput.html#cfn-refactorspaces-route-uripathrouteinput-methods)
             */
             ...
             * This is the path that Refactor Spaces uses to match traffic.
             *
             * Paths must start with `/` and are relative to the base of the application. To use
             * path parameters in the source path, add a variable in curly braces. For example, the
             * resource path {user} represents a path parameter called 'user'.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-refactorspaces-route-uripathrouteinput.html#cfn-refactorspaces-route-uripathrouteinput-sourcepath)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: UriPathRouteInputProperty
            ): software.amazon.awscdk.services.refactorspaces.CfnRoute.UriPathRouteInputProperty =
    ...
    public interface DefaultRouteInputProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DefaultRouteInputProperty
            ): software.amazon.awscdk.services.refactorspaces.CfnRoute.DefaultRouteInputProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
