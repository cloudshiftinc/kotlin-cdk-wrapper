...
public interface SAMLOptionsProperty {
     ...
     *
     * Any users with this backend role receives full permission in OpenSearch Dashboards/Kibana. To
     * use a SAML master backend role, configure the `rolesKey` property.
     *
     ...
     *
     * This SAML user receives full permission in OpenSearch Dashboards/Kibana. Creating a new
     * master username does not delete any existing master usernames.
     *
    ...
    public interface Builder {
        ...
        /**
         * @param masterBackendRole The backend role that the SAML master user is mapped to. Any
         *   users with this backend role receives full permission in OpenSearch Dashboards/Kibana.
         *   To use a SAML master backend role, configure the `rolesKey` property.
         */
        public fun masterBackendRole(masterBackendRole: String)

        /**
         * @param masterUserName The SAML master username, which is stored in the domain's internal
         *   user database. This SAML user receives full permission in OpenSearch Dashboards/Kibana.
    ...
    internal constructor(
         ...
         * The backend role that the SAML master user is mapped to.
         *
         * Any users with this backend role receives full permission in OpenSearch
         * Dashboards/Kibana. To use a SAML master backend role, configure the `rolesKey` property.
         *
         * Default: - The master user is not mapped to a backend role
         */
