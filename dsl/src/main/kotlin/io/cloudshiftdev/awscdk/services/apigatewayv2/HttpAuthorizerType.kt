...
public enum class HttpAuthorizerType(
  ...
  public companion object {
    internal fun wrap(cdkObject: software.amazon.awscdk.services.apigatewayv2.HttpAuthorizerType):
        HttpAuthorizerType = when (cdkObject) {
      software.amazon.awscdk.services.apigatewayv2.HttpAuthorizerType.IAM -> HttpAuthorizerType.IAM
      software.amazon.awscdk.services.apigatewayv2.HttpAuthorizerType.JWT -> HttpAuthorizerType.JWT
      software.amazon.awscdk.services.apigatewayv2.HttpAuthorizerType.LAMBDA ->
          HttpAuthorizerType.LAMBDA
    }

    internal fun unwrap(wrapped: HttpAuthorizerType):
