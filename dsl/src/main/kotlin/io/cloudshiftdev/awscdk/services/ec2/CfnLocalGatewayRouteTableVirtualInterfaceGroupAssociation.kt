...
internal constructor(
    ...
    private class BuilderImpl(
         ...
         * @param localGatewayVirtualInterfaceGroupId The ID of the virtual interface group.
         */
        override fun localGatewayVirtualInterfaceGroupId(
    ...
    public companion object {
        ...
        public operator fun invoke(
            ...
            return CfnLocalGatewayRouteTableVirtualInterfaceGroupAssociation(
                builderImpl.apply(block).build()
            )
        }
        ...
        internal fun unwrap(
            wrapped: CfnLocalGatewayRouteTableVirtualInterfaceGroupAssociation
        ): software.amazon.awscdk.services.ec2.CfnLocalGatewayRouteTableVirtualInterfaceGroupAssociation =
            wrapped.cdkObject
    }
}
