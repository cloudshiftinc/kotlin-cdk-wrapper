...
internal constructor(
     ...
     * `DBProxyTargetGroup` .
     */
    public open fun connectionPoolConfigurationInfo(
        `value`: ConnectionPoolConfigurationInfoFormatProperty
    ) {
        unwrap(this)
            .setConnectionPoolConfigurationInfo(
                `value`.let(ConnectionPoolConfigurationInfoFormatProperty::unwrap)
            )
    }
    ...
    public open fun connectionPoolConfigurationInfo(
        `value`: ConnectionPoolConfigurationInfoFormatProperty.Builder.() -> Unit
    ): Unit =
        connectionPoolConfigurationInfo(ConnectionPoolConfigurationInfoFormatProperty(`value`))

    /** One or more DB cluster identifiers. */
    public open fun dbClusterIdentifiers(): List<String> =
        unwrap(this).getDbClusterIdentifiers() ?: emptyList()
    ...
    public open fun dbInstanceIdentifiers(): List<String> =
        unwrap(this).getDbInstanceIdentifiers() ?: emptyList()
    ...
    public interface Builder {
        ...
        public fun connectionPoolConfigurationInfo(
            connectionPoolConfigurationInfo:
                ConnectionPoolConfigurationInfoFormatProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
        ...
        override fun connectionPoolConfigurationInfo(connectionPoolConfigurationInfo: IResolvable) {
            cdkBuilder.connectionPoolConfigurationInfo(
                connectionPoolConfigurationInfo.let(IResolvable::unwrap)
            )
        }
         ...
         *   connection pool associated with a `DBProxyTargetGroup` .
         */
        override fun connectionPoolConfigurationInfo(
            connectionPoolConfigurationInfo: ConnectionPoolConfigurationInfoFormatProperty
        ) {
            cdkBuilder.connectionPoolConfigurationInfo(
                connectionPoolConfigurationInfo.let(
                    ConnectionPoolConfigurationInfoFormatProperty::unwrap
                )
            )
        }
        ...
        override fun connectionPoolConfigurationInfo(
            ...
            connectionPoolConfigurationInfo(
                ConnectionPoolConfigurationInfoFormatProperty(connectionPoolConfigurationInfo)
            )
    ...
    public interface ConnectionPoolConfigurationInfoFormatProperty {
         ...
         * the separator. You can also include multiple variables in a single `SET` statement, such
         * as `SET x=1, y=2` .
         *
         ...
         *
         * The value is expressed as a percentage of the `max_connections` setting for the RDS DB
         * instance or Aurora DB cluster used by the target group. With a high value, the proxy
         * leaves a high percentage of idle database connections open. A low value causes the proxy
         ...
         * if `MaxConnectionsPercent` is 80, then the default value of `MaxIdleConnectionsPercent`
         * is 40. If the value of `MaxConnectionsPercent` isn't specified, then for SQL Server,
         ...
         */
        public fun maxIdleConnectionsPercent(): Number? =
         ...
         */
        public fun sessionPinningFilters(): List<String> =
        ...
        public interface Builder {
            /**
             * @param connectionBorrowTimeout The number of seconds for a proxy to wait for a
             *   connection to become available in the connection pool. This setting only applies
             *   when the proxy has opened its maximum number of connections and all connections are
             *   busy with client sessions. For an unlimited wait time, specify `0` .
             *
             * Default: `120`
             *
             * Constraints:
            ...
            /**
             * @param initQuery One or more SQL statements for the proxy to run when opening each
             *   new database connection. Typically used with `SET` statements to make sure that
             *   each connection has identical settings such as time zone and character set. For
            ...
            /**
             * @param maxConnectionsPercent The maximum size of the connection pool for each target
             *   in a target group. The value is expressed as a percentage of the `max_connections`
             *   setting for the RDS DB instance or Aurora DB cluster used by the target group.
             *
             * If you specify `MaxIdleConnectionsPercent` , then you must also include a value for
             * this parameter.
             *
             * Default: `10` for RDS for Microsoft SQL Server, and `100` for all other engines
             *
            ...
            /**
             * @param maxIdleConnectionsPercent A value that controls how actively the proxy closes
             *   idle database connections in the connection pool. The value is expressed as a
             ...
             *   percentage of idle database connections open. A low value causes the proxy to close
            ...
            /**
             * @param sessionPinningFilters Each item in the list represents a class of SQL
             *   operations that normally cause all later statements in a session using a proxy to
             *   be pinned to the same underlying database connection. Including an item in the list
        ...
        internal constructor(
             ...
             * connection pool.
             *
             * This setting only applies when the proxy has opened its maximum number of connections
             * and all connections are busy with client sessions. For an unlimited wait time,
             * specify `0` .
             *
             * Default: `120`
             *
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-rds-dbproxytargetgroup-connectionpoolconfigurationinfoformat.html#cfn-rds-dbproxytargetgroup-connectionpoolconfigurationinfoformat-connectionborrowtimeout)
             */
            override fun connectionBorrowTimeout(): Number? =
             ...
             * as the separator. You can also include multiple variables in a single `SET`
             ...
             * The maximum size of the connection pool for each target in a target group.
             *
             * The value is expressed as a percentage of the `max_connections` setting for the RDS
             ...
             *
             * The value is expressed as a percentage of the `max_connections` setting for the RDS
             * DB instance or Aurora DB cluster used by the target group. With a high value, the
             * proxy leaves a high percentage of idle database connections open. A low value causes
             * the proxy to close more idle connections and return them to the database.
             *
             * If you specify this parameter, then you must also include a value for
             * `MaxConnectionsPercent` .
             *
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-rds-dbproxytargetgroup-connectionpoolconfigurationinfoformat.html#cfn-rds-dbproxytargetgroup-connectionpoolconfigurationinfoformat-sessionpinningfilters)
             */
            override fun sessionPinningFilters(): List<String> =
                unwrap(this).getSessionPinningFilters() ?: emptyList()
        }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ConnectionPoolConfigurationInfoFormatProperty
            ): software.amazon.awscdk.services.rds.CfnDBProxyTargetGroup.ConnectionPoolConfigurationInfoFormatProperty =
