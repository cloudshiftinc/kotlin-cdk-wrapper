...
public interface CustomizeRolesOptions {
     ...
     *
     * Set this to `false` if you still want to create the resources *and* you also want to create
     * the policy report.
     *
     * Default: true
     */
     ...
     *
     * The constructPath can be either a relative or absolute path from the scope that
     ...
     * ```
     */
    public fun usePrecreatedRoles(): Map<String, String> =
    ...
    public interface Builder {
         ...
         *   Set this to `false` if you still want to create the resources *and* you also want to
         *   create the policy report.
         */
        public fun preventSynthesis(preventSynthesis: Boolean)

        /**
         * @param usePrecreatedRoles A list of precreated IAM roles to substitute for roles that CDK
         *   is creating. The constructPath can be either a relative or absolute path from the scope
         *   that `customizeRoles` is used on to the role being created.
         */
    ...
    internal constructor(
         ...
         * ```
         */
        override fun usePrecreatedRoles(): Map<String, String> =
            unwrap(this).getUsePrecreatedRoles() ?: emptyMap()
    }
