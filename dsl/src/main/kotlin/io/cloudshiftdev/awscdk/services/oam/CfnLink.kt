...
internal constructor(
    ...
    public interface Builder {
        /**
         * Specify a friendly human-readable name to use to identify this source account when you
         * are viewing data from it in the monitoring account.
         *
         * You can include the following variables in your template:
         * * `$AccountName` is the name of the account
         * * `$AccountEmail` is a globally-unique email address, which includes the email domain,
         *   such as `mariagarcia&#64;example.com`
         * * `$AccountEmailNoDomain` is an email address without the domain name, such as
         *   `mariagarcia`
         *
         ...
         *
         * @param labelTemplate Specify a friendly human-readable name to use to identify this
         *   source account when you are viewing data from it in the monitoring account.
         */
        public fun labelTemplate(labelTemplate: String)

        /**
         * An array of strings that define which types of data that the source account shares with
         * the monitoring account.
         *
         ...
         *
         * You can use
         * [ListSinks](https://docs.aws.amazon.com/OAM/latest/APIReference/API_ListSinks.html) to
         ...
         *
         * @param sinkIdentifier The ARN of the sink in the monitoring account that you want to link
         *   to.
         */
