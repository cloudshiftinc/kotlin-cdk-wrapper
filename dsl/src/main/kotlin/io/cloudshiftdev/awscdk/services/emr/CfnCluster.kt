...
internal constructor(
     ...
     * so on.
     */
    public open fun applications(vararg __idx_ac66f0: Any): Unit =
        applications(__idx_ac66f0.toList())
    ...
    public open fun autoTerminationPolicy(
        `value`: AutoTerminationPolicyProperty.Builder.() -> Unit
    ...
    public open fun kerberosAttributes(
        `value`: KerberosAttributesProperty.Builder.() -> Unit
    ): Unit = kerberosAttributes(KerberosAttributesProperty(`value`))
    ...
    public open fun managedScalingPolicy(
        `value`: ManagedScalingPolicyProperty.Builder.() -> Unit
    ...
    public interface Builder {
        ...
        /**
         * The applications to install on this cluster, for example, Spark, Flink, Oozie, Zeppelin,
         * and so on.
         *
         ...
         *
         * @param applications The applications to install on this cluster, for example, Spark,
         ...
         * An IAM role for automatic scaling policies.
         *
         * The default role is `EMR_AutoScaling_DefaultRole` . The IAM role provides permissions
         * that the automatic scaling feature requires to launch and terminate Amazon EC2 instances
        ...
        /**
         * An auto-termination policy defines the amount of idle time in seconds after which a
         * cluster automatically terminates.
         *
         ...
         *
         * @param autoTerminationPolicy An auto-termination policy defines the amount of idle time
        ...
        public fun autoTerminationPolicy(
            autoTerminationPolicy: AutoTerminationPolicyProperty.Builder.() -> Unit
        )
         ...
         *
         * @param ebsRootVolumeSize The size, in GiB, of the Amazon EBS root device volume of the
         ...
         *
         * @param ebsRootVolumeThroughput The throughput, in MiB/s, of the Amazon EBS root device
         *   volume of the Linux AMI that is used for each Amazon EC2 instance.
         */
         ...
         * Also called instance profile and Amazon EC2 role.
         *
         * An IAM role for an Amazon EMR cluster. The Amazon EC2 instances of the cluster assume
         * this role. The default role is `EMR_EC2_DefaultRole` . In order to use the default role,
         * you must have already created it using the AWS CLI or console.
         *
         ...
         *
         * @param kerberosAttributes Attributes for Kerberos configuration when Kerberos
        ...
        public fun kerberosAttributes(
            kerberosAttributes: KerberosAttributesProperty.Builder.() -> Unit
        )
         ...
         * that can be added or terminated from a cluster. The policy only applies to the core and
        ...
        public fun managedScalingPolicy(
            managedScalingPolicy: ManagedScalingPolicyProperty.Builder.() -> Unit
        )
         ...
         * The Amazon Linux release specified in a cluster launch RunJobFlow request.
         *
         * If no Amazon Linux release was specified, the default Amazon Linux release is shown in
         * the response.
         *
         ...
         * such as `emr-5.14.0` . For more information about Amazon EMR release versions and
         ...
         * submitted. This option is only available with Amazon EMR 5.1.0 and later and is the
         * default for clusters created using that version. `TERMINATE_AT_TASK_COMPLETION` indicates
         * that Amazon EMR adds nodes to a deny list and drains tasks from nodes before terminating
         * the Amazon EC2 instances, regardless of the instance-hour boundary. With either behavior,
         * Amazon EMR removes the least active nodes first and blocks instance termination if it
         * could lead to HDFS corruption. `TERMINATE_AT_TASK_COMPLETION` is available only in Amazon
         * EMR releases 4.1.0 and later, and is the default for versions of Amazon EMR earlier than
         * 5.1.0.
         *
         ...
         *
         * @param securityConfiguration The name of the security configuration applied to the
         *   cluster.
         */
         ...
         *
         * @param serviceRole The IAM role that Amazon EMR assumes in order to access AWS resources
         *   on your behalf.
         */
         ...
         *
         * @param stepConcurrencyLevel Specifies the number of steps that can be executed
         *   concurrently.
         */
         ...
         * with the cluster.
         *
         * If this value is set to `true` , all IAM users of that AWS account can view and manage
         * the cluster if they have the proper policy permissions set. If this value is `false` ,
         * only the IAM user that created the cluster can view and manage it. This value can be
         ...
         * `true` by default. However, for `AWS::EMR::Cluster` resources in CloudFormation, the
         * default is `false` .
         *
         ...
         *
         * @param visibleToAllUsers Indicates whether the cluster is visible to all IAM users of the
         *   AWS account associated with the cluster.
         */
    ...
    private class BuilderImpl(
        ...
        override fun autoTerminationPolicy(autoTerminationPolicy: AutoTerminationPolicyProperty) {
            cdkBuilder.autoTerminationPolicy(
                autoTerminationPolicy.let(AutoTerminationPolicyProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("04bf042f7c2a440d931875f8b70e08227df842d1d87d013acf0317b48810b609")
        override fun autoTerminationPolicy(
            autoTerminationPolicy: AutoTerminationPolicyProperty.Builder.() -> Unit
        ...
        override fun kerberosAttributes(kerberosAttributes: KerberosAttributesProperty) {
            cdkBuilder.kerberosAttributes(
                kerberosAttributes.let(KerberosAttributesProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("b758ccdadfcc3ccd12852a4ab8d146fec24ec216c503ffa7e97e5e01a97a1000")
        override fun kerberosAttributes(
            kerberosAttributes: KerberosAttributesProperty.Builder.() -> Unit
        ...
        override fun managedScalingPolicy(managedScalingPolicy: ManagedScalingPolicyProperty) {
            cdkBuilder.managedScalingPolicy(
                managedScalingPolicy.let(ManagedScalingPolicyProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("0fed765ea5d1af1c7bea77dffebc7688273bed497485e9e69d926f3f3888644a")
        override fun managedScalingPolicy(
            managedScalingPolicy: ManagedScalingPolicyProperty.Builder.() -> Unit
    ...
    public interface CloudWatchAlarmDefinitionProperty {
        ...
        public interface Builder {
            /**
             * @param comparisonOperator Determines how the metric specified by `MetricName` is
            ...
            /**
             * @param evaluationPeriods The number of periods, in five-minute increments, during
            ...
            /**
             * @param metricName The name of the CloudWatch metric that is watched to determine an
             *   alarm condition.
             */
            ...
            /**
             * @param period The period, in seconds, over which the statistic is applied. CloudWatch
            ...
            /**
             * @param statistic The statistic to apply to the metric associated with the alarm. The
             *   default is `AVERAGE` .
             */
        ...
        internal constructor(
             ...
             * must exist before the alarm triggers automatic scaling activity.
             *
             * The default value is `1` .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-emr-cluster-cloudwatchalarmdefinition.html#cfn-emr-cluster-cloudwatchalarmdefinition-evaluationperiods)
             ...
             * The period, in seconds, over which the statistic is applied.
             *
             * CloudWatch metrics for Amazon EMR are emitted every five minutes (300 seconds), so if
             * you specify a CloudWatch metric, specify `300` .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-emr-cluster-cloudwatchalarmdefinition.html#cfn-emr-cluster-cloudwatchalarmdefinition-period)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CloudWatchAlarmDefinitionProperty
            ): software.amazon.awscdk.services.emr.CfnCluster.CloudWatchAlarmDefinitionProperty =
    ...
    public interface StepConfigProperty {
        ...
        public interface Builder {
            /**
             * @param actionOnFailure The action to take when the cluster step fails. Possible
             *   values are `CANCEL_AND_WAIT` and `CONTINUE` .
             */
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("35c8e923fe8dffa0f705d5b8464c7d670916d6d321c8b4ec178d10f9ea0ff2b6")
            override fun hadoopJarStep(
                hadoopJarStep: HadoopJarStepConfigProperty.Builder.() -> Unit
    ...
    public interface AutoTerminationPolicyProperty {
        ...
        public interface Builder {
            /**
             * @param idleTimeout Specifies the amount of idle time in seconds after which the
             *   cluster automatically terminates. You can specify a minimum of 60 seconds and a
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AutoTerminationPolicyProperty
            ): software.amazon.awscdk.services.emr.CfnCluster.AutoTerminationPolicyProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface AutoScalingPolicyProperty {
        ...
        public interface Builder {
            /**
             * @param constraints The upper and lower Amazon EC2 instance limits for an automatic
             *   scaling policy. Automatic scaling activity will not cause an instance group to grow
            ...
            /**
             * @param rules The scale-in and scale-out rules that comprise the automatic scaling
             *   policy.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            override fun constraints(
                constraints: ScalingConstraintsProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * The upper and lower Amazon EC2 instance limits for an automatic scaling policy.
             *
             * Automatic scaling activity will not cause an instance group to grow above or below
             * these limits.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-emr-cluster-autoscalingpolicy.html#cfn-emr-cluster-autoscalingpolicy-constraints)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AutoScalingPolicyProperty
            ): software.amazon.awscdk.services.emr.CfnCluster.AutoScalingPolicyProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ComputeLimitsProperty {
         ...
         * units for instance fleets. Managed scaling activities are not allowed beyond this
         * boundary. The limit only applies to the core and task nodes. The master node cannot be
         ...
         *
         * It is measured through vCPU cores or instances for instance groups and measured through
         * units for instance fleets. The core units are not allowed to scale beyond this boundary.
         ...
         *
         * It is measured through vCPU cores or instances for instance groups and measured through
         * units for instance fleets. The On-Demand units are not allowed to scale beyond this
         * boundary. The parameter is used to split capacity allocation between On-Demand and Spot
         * Instances.
         *
        ...
        public interface Builder {
            /**
             * @param maximumCapacityUnits The upper boundary of Amazon EC2 units. It is measured
             *   through vCPU cores or instances for instance groups and measured through units for
             *   instance fleets. Managed scaling activities are not allowed beyond this boundary.
             *   The limit only applies to the core and task nodes. The master node cannot be scaled
             *   after initial configuration.
             */
            public fun maximumCapacityUnits(maximumCapacityUnits: Number)

            /**
             * @param maximumCoreCapacityUnits The upper boundary of Amazon EC2 units for core node
             *   type in a cluster. It is measured through vCPU cores or instances for instance
             *   groups and measured through units for instance fleets. The core units are not
             *   allowed to scale beyond this boundary. The parameter is used to split capacity
             ...
             *   It is measured through vCPU cores or instances for instance groups and measured
             *   through units for instance fleets. The On-Demand units are not allowed to scale
            ...
            /**
             * @param minimumCapacityUnits The lower boundary of Amazon EC2 units. It is measured
             *   through vCPU cores or instances for instance groups and measured through units for
             *   instance fleets. Managed scaling activities are not allowed beyond this boundary.
             *   The limit only applies to the core and task nodes. The master node cannot be scaled
             *   after initial configuration.
        ...
        internal constructor(
             ...
             *
             * It is measured through vCPU cores or instances for instance groups and measured
             * through units for instance fleets. Managed scaling activities are not allowed beyond
             * this boundary. The limit only applies to the core and task nodes. The master node
             ...
             *
             * It is measured through vCPU cores or instances for instance groups and measured
             * through units for instance fleets. The core units are not allowed to scale beyond
             * this boundary. The parameter is used to split capacity allocation between core and
             * task nodes.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-emr-cluster-computelimits.html#cfn-emr-cluster-computelimits-maximumcorecapacityunits)
             */
            override fun maximumCoreCapacityUnits(): Number? =
                unwrap(this).getMaximumCoreCapacityUnits()
    ...
    public interface JobFlowInstancesConfigProperty {
        ...
        /**
         * Describes the EC2 instances and instance configurations for core instance groups when
         ...
         * the identifier of the Amazon VPC subnet where you want the cluster to launch. If you do
         ...
         * value, the default of 0.18 is used, unless the `AmiVersion` parameter is set in the
         * RunJobFlow call, in which case the default version of Hadoop for that AMI version is
         * used.
         *
         ...
         */
        public fun keepJobFlowAliveWhenNoSteps(): Any? =
            unwrap(this).getKeepJobFlowAliveWhenNoSteps()

        /**
         * Describes the EC2 instances and instance configurations for the master instance fleet
         * when using clusters with the instance fleet configuration.
         *
        ...
        /**
         * Describes the EC2 instances and instance configurations for the master instance group
         * when using clusters with the uniform instance group configuration.
         *
         ...
         */
        public fun serviceAccessSecurityGroup(): String? =
         ...
         * task instance fleet must have a unique name specified so that CloudFormation can
         * differentiate between the task instance fleets.
         *
         ...
         * `TargetOnDemandCapacity` and `TargetSpotCapacity` . Modifying any other property results
         * in cluster replacement. &gt; To allow a maximum of 30 Amazon EC2 instance types per
         * fleet, include `TaskInstanceFleets` when you create your cluster. If you create your
         * cluster without `TaskInstanceFleets` , Amazon EMR uses its default allocation strategy,
         * which allows for a maximum of five Amazon EC2 instance types.
         *
        ...
        /**
         * Describes the EC2 instances and instance configurations for task instance groups when
         * using clusters with the uniform instance group configuration.
         *
         * These task instance groups are added to the cluster as part of the cluster launch. Each
         * task instance group must have a unique name specified so that CloudFormation can
         * differentiate between the task instance groups.
         *
        ...
        public interface Builder {
            /**
             * @param additionalMasterSecurityGroups A list of additional Amazon EC2 security group
             *   IDs for the master node.
             */
            ...
            /**
             * @param additionalSlaveSecurityGroups A list of additional Amazon EC2 security group
             *   IDs for the core and task nodes.
             */
            ...
            /**
             * @param coreInstanceFleet Describes the EC2 instances and instance configurations for
             *   the core instance fleet when using clusters with the instance fleet configuration.
             */
            ...
            public fun coreInstanceFleet(
                coreInstanceFleet: InstanceFleetConfigProperty.Builder.() -> Unit
            )

            /**
             * @param coreInstanceGroup Describes the EC2 instances and instance configurations for
             *   core instance groups when using clusters with the uniform instance group
             *   configuration.
             */
            ...
            public fun coreInstanceGroup(
                coreInstanceGroup: InstanceGroupConfigProperty.Builder.() -> Unit
            )

            /**
             * @param ec2KeyName The name of the Amazon EC2 key pair that can be used to connect to
             *   the master node using SSH as the user called "hadoop.".
             */
            public fun ec2KeyName(ec2KeyName: String)

            /**
             * @param ec2SubnetId Applies to clusters that use the uniform instance group
             *   configuration. To launch the cluster in Amazon Virtual Private Cloud (Amazon VPC),
             ...
             *   When multiple Amazon EC2 subnet IDs are specified, Amazon EMR evaluates them and
            ...
            /**
             * @param emrManagedMasterSecurityGroup The identifier of the Amazon EC2 security group
             *   for the master node. If you specify `EmrManagedMasterSecurityGroup` , you must also
             *   specify `EmrManagedSlaveSecurityGroup` .
             */
            public fun emrManagedMasterSecurityGroup(emrManagedMasterSecurityGroup: String)

            /**
             * @param emrManagedSlaveSecurityGroup The identifier of the Amazon EC2 security group
             *   for the core and task nodes. If you specify `EmrManagedSlaveSecurityGroup` , you
             *   must also specify `EmrManagedMasterSecurityGroup` .
             */
            public fun emrManagedSlaveSecurityGroup(emrManagedSlaveSecurityGroup: String)

            /**
             * @param hadoopVersion Applies only to Amazon EMR release versions earlier than 4.0.
             *   The Hadoop version for the cluster. Valid inputs are "0.18" (no longer maintained),
             *   "0.20" (no longer maintained), "0.20.205" (no longer maintained), "1.0.3", "2.2.0",
            ...
            /**
             * @param keepJobFlowAliveWhenNoSteps Specifies whether the cluster should remain
             *   available after completing all steps. Defaults to `true` . For more information
             *   about configuring cluster termination, see
             *   [Control Cluster Termination](https://docs.aws.amazon.com/emr/latest/ManagementGuide/emr-plan-termination.html)
             *   in the *EMR Management Guide* .
             */
            ...
            /**
             * @param masterInstanceFleet Describes the EC2 instances and instance configurations
             *   for the master instance fleet when using clusters with the instance fleet
             *   configuration.
             */
            ...
            public fun masterInstanceFleet(
                masterInstanceFleet: InstanceFleetConfigProperty.Builder.() -> Unit
            )

            /**
             * @param masterInstanceGroup Describes the EC2 instances and instance configurations
             *   for the master instance group when using clusters with the uniform instance group
             *   configuration.
             */
            ...
            public fun masterInstanceGroup(
                masterInstanceGroup: InstanceGroupConfigProperty.Builder.() -> Unit
            )
            ...
            /**
             * @param serviceAccessSecurityGroup The identifier of the Amazon EC2 security group for
             *   the Amazon EMR service to access clusters in VPC private subnets.
             */
            public fun serviceAccessSecurityGroup(serviceAccessSecurityGroup: String)

            /**
             * @param taskInstanceFleets Describes the EC2 instances and instance configurations for
             *   the task instance fleets when using clusters with the instance fleet configuration.
             *   These task instance fleets are added to the cluster as part of the cluster launch.
             *   Each task instance fleet must have a unique name specified so that CloudFormation
             *   can differentiate between the task instance fleets.
             *
             * You can currently specify only one task instance fleet for a cluster. After creating
             * the cluster, you can only modify the mutable properties of `InstanceFleetConfig` ,
             * which are `TargetOnDemandCapacity` and `TargetSpotCapacity` . Modifying any other
             * property results in cluster replacement. &gt; To allow a maximum of 30 Amazon EC2
             * instance types per fleet, include `TaskInstanceFleets` when you create your cluster.
             * If you create your cluster without `TaskInstanceFleets` , Amazon EMR uses its default
             * allocation strategy, which allows for a maximum of five Amazon EC2 instance types.
             */
            ...
            /**
             * @param taskInstanceGroups Describes the EC2 instances and instance configurations for
             *   task instance groups when using clusters with the uniform instance group
             *   configuration. These task instance groups are added to the cluster as part of the
             *   cluster launch. Each task instance group must have a unique name specified so that
             *   CloudFormation can differentiate between the task instance groups.
             *
             * After creating the cluster, you can only modify the mutable properties of
             * `InstanceGroupConfig` , which are `AutoScalingPolicy` and `InstanceCount` . Modifying
             * any other property results in cluster replacement.
             */
            ...
            /**
             * @param terminationProtected Specifies whether to lock the cluster to prevent the
             *   Amazon EC2 instances from being terminated by API call, user intervention, or in
        ...
        private class BuilderImpl : Builder {
             ...
             *   IDs for the master node.
             */
            override fun additionalMasterSecurityGroups(
             ...
             */
            override fun additionalMasterSecurityGroups(
                vararg additionalMasterSecurityGroups: String
             ...
             *   IDs for the core and task nodes.
             */
            override fun additionalSlaveSecurityGroups(
             ...
             */
            override fun additionalSlaveSecurityGroups(
                vararg additionalSlaveSecurityGroups: String
            ): Unit = additionalSlaveSecurityGroups(additionalSlaveSecurityGroups.toList())
            ...
            override fun coreInstanceFleet(coreInstanceFleet: InstanceFleetConfigProperty) {
                cdkBuilder.coreInstanceFleet(
                    coreInstanceFleet.let(InstanceFleetConfigProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("ece8c06fdf4f69b4f87726d658d7e132bad320781884031ae69285e45e871ffe")
            override fun coreInstanceFleet(
                coreInstanceFleet: InstanceFleetConfigProperty.Builder.() -> Unit
            ...
            override fun coreInstanceGroup(coreInstanceGroup: InstanceGroupConfigProperty) {
                cdkBuilder.coreInstanceGroup(
                    coreInstanceGroup.let(InstanceGroupConfigProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("67715b405476ee62063fd050da43e4a1d168fa2721f0574cc2735773279d44e6")
            override fun coreInstanceGroup(
                coreInstanceGroup: InstanceGroupConfigProperty.Builder.() -> Unit
            ...
            override fun keepJobFlowAliveWhenNoSteps(keepJobFlowAliveWhenNoSteps: IResolvable) {
                cdkBuilder.keepJobFlowAliveWhenNoSteps(
                    keepJobFlowAliveWhenNoSteps.let(IResolvable::unwrap)
                )
            }
            ...
            override fun masterInstanceFleet(masterInstanceFleet: InstanceFleetConfigProperty) {
                cdkBuilder.masterInstanceFleet(
                    masterInstanceFleet.let(InstanceFleetConfigProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("d982dc921f49be4c3b292103d501661502301ce18c5701c80ce4b7afa4384215")
            override fun masterInstanceFleet(
                masterInstanceFleet: InstanceFleetConfigProperty.Builder.() -> Unit
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("e99fd5ba5ee81ee99d08ccf02f72ac58022bdad063059bbc765db0f9f4200136")
            override fun masterInstanceGroup(
                masterInstanceGroup: InstanceGroupConfigProperty.Builder.() -> Unit
            ...
            override fun unhealthyNodeReplacement(unhealthyNodeReplacement: IResolvable) {
                cdkBuilder.unhealthyNodeReplacement(
                    unhealthyNodeReplacement.let(IResolvable::unwrap)
                )
            }
        ...
        internal constructor(
            ...
            /**
             * Describes the EC2 instances and instance configurations for the core instance fleet
             * when using clusters with the instance fleet configuration.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-emr-cluster-jobflowinstancesconfig.html#cfn-emr-cluster-jobflowinstancesconfig-coreinstancefleet)
             */
             ...
             * Applies to clusters that use the uniform instance group configuration.
             *
             * To launch the cluster in Amazon Virtual Private Cloud (Amazon VPC), set this
             * parameter to the identifier of the Amazon VPC subnet where you want the cluster to
             * launch. If you do not specify this value and your account supports EC2-Classic, the
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-emr-cluster-jobflowinstancesconfig.html#cfn-emr-cluster-jobflowinstancesconfig-ec2subnetids)
             */
            override fun ec2SubnetIds(): List<String> =
                unwrap(this).getEc2SubnetIds() ?: emptyList()
             ...
             * the cluster. Valid inputs are "0.18" (no longer maintained), "0.20" (no longer
             * maintained), "0.20.205" (no longer maintained), "1.0.3", "2.2.0", or "2.4.0". If you
             * do not set this value, the default of 0.18 is used, unless the `AmiVersion` parameter
            ...
            /**
             * Describes the EC2 instances and instance configurations for the task instance fleets
             * when using clusters with the instance fleet configuration.
             *
             * These task instance fleets are added to the cluster as part of the cluster launch.
             * Each task instance fleet must have a unique name specified so that CloudFormation can
             * differentiate between the task instance fleets.
             *
             * You can currently specify only one task instance fleet for a cluster. After creating
             * the cluster, you can only modify the mutable properties of `InstanceFleetConfig` ,
             ...
             * using clusters with the uniform instance group configuration.
             *
             * These task instance groups are added to the cluster as part of the cluster launch.
             * Each task instance group must have a unique name specified so that CloudFormation can
             * differentiate between the task instance groups.
             *
             * After creating the cluster, you can only modify the mutable properties of
             * `InstanceGroupConfig` , which are `AutoScalingPolicy` and `InstanceCount` . Modifying
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-emr-cluster-jobflowinstancesconfig.html#cfn-emr-cluster-jobflowinstancesconfig-unhealthynodereplacement)
             */
            override fun unhealthyNodeReplacement(): Any? =
                unwrap(this).getUnhealthyNodeReplacement()
        }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: JobFlowInstancesConfigProperty
            ): software.amazon.awscdk.services.emr.CfnCluster.JobFlowInstancesConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface InstanceFleetConfigProperty {
         ...
         * `WeightedCapacity` . When an On-Demand instance is provisioned, the `WeightedCapacity`
         ...
         *
         * When the instance fleet launches, Amazon EMR tries to provision Spot instances as
         * specified by `InstanceTypeConfig` . Each instance configuration has a specified
         * `WeightedCapacity` . When a Spot instance is provisioned, the `WeightedCapacity` units
         * count toward the target capacity. Amazon EMR provisions instances until the target
         * capacity is totally fulfilled, even if this results in an overage. For example, if there
         * are 2 units remaining to fulfill capacity, and Amazon EMR can only provision an instance
         * with a `WeightedCapacity` of 5 units, the instance is provisioned, and the target
         * capacity is exceeded by 3 units.
        ...
        public interface Builder {
            /**
             * @param instanceTypeConfigs The instance type configurations that define the Amazon
             *   EC2 instances in the instance fleet.
             */
            ...
            public fun launchSpecifications(
                launchSpecifications:
                    InstanceFleetProvisioningSpecificationsProperty.Builder.() -> Unit
            )
             ...
             *   fleet, which determines how many On-Demand instances to provision. When the
             *   instance fleet launches, Amazon EMR tries to provision On-Demand instances as
             *   specified by `InstanceTypeConfig` . Each instance configuration has a specified
             ...
             *   which determines how many Spot instances to provision. When the instance fleet
             ...
             *   `WeightedCapacity` . When a Spot instance is provisioned, the `WeightedCapacity`
             *   units count toward the target capacity. Amazon EMR provisions instances until the
             *   target capacity is totally fulfilled, even if this results in an overage. For
             *   example, if there are 2 units remaining to fulfill capacity, and Amazon EMR can
             *   only provision an instance with a `WeightedCapacity` of 5 units, the instance is
        ...
        private class BuilderImpl : Builder {
            ...
            /** @param launchSpecifications The launch specification for the instance fleet. */
            override fun launchSpecifications(
                launchSpecifications: InstanceFleetProvisioningSpecificationsProperty
            ) {
                cdkBuilder.launchSpecifications(
                    launchSpecifications.let(
                        InstanceFleetProvisioningSpecificationsProperty::unwrap
                    )
                )
            }
        ...
        internal constructor(
             ...
             *
             * When the instance fleet launches, Amazon EMR tries to provision On-Demand instances
             * as specified by `InstanceTypeConfig` . Each instance configuration has a specified
             * `WeightedCapacity` . When an On-Demand instance is provisioned, the
             * `WeightedCapacity` units count toward the target capacity. Amazon EMR provisions
             * instances until the target capacity is totally fulfilled, even if this results in an
             * overage. For example, if there are 2 units remaining to fulfill capacity, and Amazon
             * EMR can only provision an instance with a `WeightedCapacity` of 5 units, the instance
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-emr-cluster-instancefleetconfig.html#cfn-emr-cluster-instancefleetconfig-targetondemandcapacity)
             */
            override fun targetOnDemandCapacity(): Number? =
             ...
             * provision an instance with a `WeightedCapacity` of 5 units, the instance is
             * provisioned, and the target capacity is exceeded by 3 units.
             *
             * If not specified or set to 0, only On-Demand instances are provisioned for the
             * instance fleet. At least one of `TargetSpotCapacity` and `TargetOnDemandCapacity`
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: InstanceFleetConfigProperty
            ): software.amazon.awscdk.services.emr.CfnCluster.InstanceFleetConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SpotProvisioningSpecificationProperty {
         ...
         *
         * For more information on the provisioning strategies, see
         ...
         * 240, 300, or
         * 360. The duration period starts as soon as a Spot Instance receives its instance ID. At
         *      the end of the duration, Amazon EC2 marks the Spot Instance for termination and
         ...
         * timeout. Valid values are `TERMINATE_CLUSTER` and `SWITCH_TO_ON_DEMAND` .
         ...
         * taken. Minimum value is 5 and maximum value is 1440. The timeout applies only during
        ...
        public interface Builder {
            /**
             * @param allocationStrategy Specifies one of the following strategies to launch Spot
             *   Instance fleets: `price-capacity-optimized` , `capacity-optimized` , `lowest-price`
             *   , or `diversified` . For more information on the provisioning strategies, see
             *   [Allocation strategies for Spot Instances](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-fleet-allocation-strategy.html)
             *   in the *Amazon EC2 User Guide for Linux Instances* .
             *
             * When you launch a Spot Instance fleet with the old console, it automatically launches
             * with the `capacity-optimized` strategy. You can't change the allocation strategy from
             * the old console.
             */
            public fun allocationStrategy(allocationStrategy: String)

            /**
             * @param blockDurationMinutes The defined duration for Spot Instances (also known as
             *   Spot blocks) in minutes. When specified, the Spot Instance does not terminate
             *   before the defined duration expires, and defined duration pricing for Spot
             *   Instances applies. Valid values are 60, 120, 180, 240, 300, or 360. The duration
             *   period starts as soon as a Spot Instance receives its instance ID. At the end of
             *   the duration, Amazon EC2 marks the Spot Instance for termination and provides a
             *   Spot Instance termination notice, which gives the instance a two-minute warning
             *   before it terminates.
             *
             * Spot Instances with a defined duration (also known as Spot blocks) are no longer
             * available to new customers from July 1, 2021. For customers who have previously used
            ...
            /**
             * @param timeoutAction The action to take when `TargetSpotCapacity` has not been
             *   fulfilled when the `TimeoutDurationMinutes` has expired;. that is, when all Spot
             *   Instances could not be provisioned within the Spot provisioning timeout. Valid
             *   values are `TERMINATE_CLUSTER` and `SWITCH_TO_ON_DEMAND` . SWITCH_TO_ON_DEMAND
            ...
            /**
             * @param timeoutDurationMinutes The Spot provisioning timeout period in minutes. If
             *   Spot Instances are not provisioned within this time period, the `TimeOutAction` is
             *   taken. Minimum value is 5 and maximum value is 1440. The timeout applies only
        ...
        internal constructor(
             ...
             * expires, and defined duration pricing for Spot Instances applies. Valid values are
             * 60, 120, 180, 240, 300, or 360. The duration period starts as soon as a Spot Instance
             * receives its instance ID. At the end of the duration, Amazon EC2 marks the Spot
             * Instance for termination and provides a Spot Instance termination notice, which gives
             ...
             * `TimeoutDurationMinutes` has expired;
             *
             * that is, when all Spot Instances could not be provisioned within the Spot
             * provisioning timeout. Valid values are `TERMINATE_CLUSTER` and `SWITCH_TO_ON_DEMAND`
             * . SWITCH_TO_ON_DEMAND specifies that if no Spot Instances are available, On-Demand
             * Instances should be provisioned to fulfill any remaining Spot capacity.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-emr-cluster-spotprovisioningspecification.html#cfn-emr-cluster-spotprovisioningspecification-timeoutaction)
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SpotProvisioningSpecificationProperty
            ): software.amazon.awscdk.services.emr.CfnCluster.SpotProvisioningSpecificationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface InstanceFleetProvisioningSpecificationsProperty {
        ...
        public interface Builder {
            ...
            public fun onDemandSpecification(
                onDemandSpecification: OnDemandProvisioningSpecificationProperty.Builder.() -> Unit
            )

            /**
             * @param spotSpecification The launch specification for Spot instances in the fleet,
             *   which determines the defined duration, provisioning timeout behavior, and
             *   allocation strategy.
             */
            ...
            public fun spotSpecification(
                spotSpecification: SpotProvisioningSpecificationProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun onDemandSpecification(
                ...
                cdkBuilder.onDemandSpecification(
                    onDemandSpecification.let(OnDemandProvisioningSpecificationProperty::unwrap)
                )
            }
             ...
             *   allocation strategy.
             */
            override fun spotSpecification(
                spotSpecification: SpotProvisioningSpecificationProperty
            ) {
                cdkBuilder.spotSpecification(
                    spotSpecification.let(SpotProvisioningSpecificationProperty::unwrap)
                )
            }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: InstanceFleetProvisioningSpecificationsProperty
            ): software.amazon.awscdk.services.emr.CfnCluster.InstanceFleetProvisioningSpecificationsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SimpleScalingPolicyConfigurationProperty {
         ...
         * instance count increments or decrements by `ScalingAdjustment` , which should be
         * expressed as an integer. `PERCENT_CHANGE_IN_CAPACITY` indicates the instance count
         * increments or decrements by the percentage specified by `ScalingAdjustment` , which
         * should be expressed as an integer. For example, 20 indicates an increase in 20%
         * increments of cluster capacity. `EXACT_CAPACITY` indicates the scaling activity results
         * in an instance group with the number of Amazon EC2 instances specified by
        ...
        public interface Builder {
             ...
             *   `ScalingAdjustment` is a positive number) or terminated (if `ScalingAdjustment` is
             *   a negative number) each time the scaling activity is triggered.
             *   `CHANGE_IN_CAPACITY` is the default. `CHANGE_IN_CAPACITY` indicates that the Amazon
             *   EC2 instance count increments or decrements by `ScalingAdjustment` , which should
             *   be expressed as an integer. `PERCENT_CHANGE_IN_CAPACITY` indicates the instance
             *   count increments or decrements by the percentage specified by `ScalingAdjustment` ,
             *   which should be expressed as an integer. For example, 20 indicates an increase in
             *   20% increments of cluster capacity. `EXACT_CAPACITY` indicates the scaling activity
             *   results in an instance group with the number of Amazon EC2 instances specified by
             *   `ScalingAdjustment` , which should be expressed as a positive integer.
             */
             ...
             *   before any further trigger-related scaling activities can start. The default value
             *   is 0.
             */
             ...
             *   specified `AdjustmentType` . A positive value adds to the instance group's Amazon
             *   EC2 instance count while a negative number removes instances. If `AdjustmentType`
             *   is set to `EXACT_CAPACITY` , the number should only be a positive integer. If
        ...
        internal constructor(
             ...
             * increments or decrements by the percentage specified by `ScalingAdjustment` , which
             * should be expressed as an integer. For example, 20 indicates an increase in 20%
             * increments of cluster capacity. `EXACT_CAPACITY` indicates the scaling activity
             * results in an instance group with the number of Amazon EC2 instances specified by
             * `ScalingAdjustment` , which should be expressed as a positive integer.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-emr-cluster-simplescalingpolicyconfiguration.html#cfn-emr-cluster-simplescalingpolicyconfiguration-adjustmenttype)
             ...
             * .
             *
             * A positive value adds to the instance group's Amazon EC2 instance count while a
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SimpleScalingPolicyConfigurationProperty
            ): software.amazon.awscdk.services.emr.CfnCluster.SimpleScalingPolicyConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ScalingConstraintsProperty {
        ...
        public interface Builder {
            /**
             * @param maxCapacity The upper boundary of Amazon EC2 instances in an instance group
             *   beyond which scaling activities are not allowed to grow. Scale-out activities will
             *   not add instances beyond this boundary.
             */
            public fun maxCapacity(maxCapacity: Number)

            /**
             * @param minCapacity The lower boundary of Amazon EC2 instances in an instance group
             *   below which scaling activities are not allowed to shrink. Scale-in activities will
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ScalingConstraintsProperty
            ): software.amazon.awscdk.services.emr.CfnCluster.ScalingConstraintsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface EbsConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param ebsBlockDeviceConfigs An array of Amazon EBS volume specifications attached to
             *   a cluster instance.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: EbsConfigurationProperty
            ): software.amazon.awscdk.services.emr.CfnCluster.EbsConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface KerberosAttributesProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param adDomainJoinUser Required only when establishing a cross-realm trust with an
             *   Active Directory domain. A user with sufficient privileges to join resources to the
             *   domain.
             */
            public fun adDomainJoinUser(adDomainJoinUser: String)

            /**
             * @param crossRealmTrustPrincipalPassword Required only when establishing a cross-realm
            ...
            /**
             * @param kdcAdminPassword The password used within the cluster for the kadmin service
             *   on the cluster-dedicated KDC, which maintains Kerberos principals, password
        ...
        private class BuilderImpl : Builder {
             ...
             *   must be identical across realms.
             */
            override fun crossRealmTrustPrincipalPassword(
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: KerberosAttributesProperty
            ): software.amazon.awscdk.services.emr.CfnCluster.KerberosAttributesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ManagedScalingPolicyProperty {
         ...
         *
         * The managed scaling activity of a cluster is not allowed to go above or below these
         * limits. The limit only applies to the core and task nodes. The master node cannot be
         * scaled after initial configuration.
         *
        ...
        public interface Builder {
            /**
             * @param computeLimits The Amazon EC2 unit limits for a managed scaling policy. The
             *   managed scaling activity of a cluster is not allowed to go above or below these
             *   limits. The limit only applies to the core and task nodes. The master node cannot
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("95bc72e2e9aa925adeed929babb4791327d9958ad0bd79ae634df9497a8bec64")
            override fun computeLimits(
                computeLimits: ComputeLimitsProperty.Builder.() -> Unit
            ): Unit = computeLimits(ComputeLimitsProperty(computeLimits))
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ManagedScalingPolicyProperty
            ): software.amazon.awscdk.services.emr.CfnCluster.ManagedScalingPolicyProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface OnDemandProvisioningSpecificationProperty {
         ...
         *
         * Currently, the only option is `lowest-price` (the default), which launches the lowest
         * price first.
         *
        ...
        public interface Builder {
            /**
             * @param allocationStrategy Specifies the strategy to use in launching On-Demand
             *   instance fleets. Currently, the only option is `lowest-price` (the default), which
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: OnDemandProvisioningSpecificationProperty
            ): software.amazon.awscdk.services.emr.CfnCluster.OnDemandProvisioningSpecificationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface BootstrapActionConfigProperty {
        ...
        public interface Builder {
            ...
            public fun scriptBootstrapAction(
                scriptBootstrapAction: ScriptBootstrapActionConfigProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            /** @param scriptBootstrapAction The script run by the bootstrap action. */
            override fun scriptBootstrapAction(
                scriptBootstrapAction: ScriptBootstrapActionConfigProperty
            ) {
                cdkBuilder.scriptBootstrapAction(
                    scriptBootstrapAction.let(ScriptBootstrapActionConfigProperty::unwrap)
                )
            }
            ...
            override fun scriptBootstrapAction(
                ...
                scriptBootstrapAction(ScriptBootstrapActionConfigProperty(scriptBootstrapAction))
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: BootstrapActionConfigProperty
            ): software.amazon.awscdk.services.emr.CfnCluster.BootstrapActionConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface InstanceGroupConfigProperty {
         ...
         * and terminates EC2 instances in response to the value of a CloudWatch metric. Only core
         * and task instance groups can use automatic scaling policies. For more information, see
         ...
         * `OnDemandPrice` to set the amount equal to the On-Demand price, or specify an amount in
         * USD.
         *
        ...
        public interface Builder {
             ...
             *   [InstanceGroupConfig](https://docs.aws.amazon.com//AWSCloudFormation/latest/UserGuide/aws-properties-emr-cluster-jobflowinstancesconfig-instancegroupconfig.html)
             *   property type that specifies the constraints and rules of an automatic scaling
             *   policy in Amazon EMR . The automatic scaling policy defines how an instance group
             *   dynamically adds and terminates EC2 instances in response to the value of a
             *   CloudWatch metric. Only core and task instance groups can use automatic scaling
            ...
            public fun autoScalingPolicy(
                autoScalingPolicy: AutoScalingPolicyProperty.Builder.() -> Unit
            )
            ...
            /**
             * @param configurations Amazon EMR releases 4.x or later. The list of configurations
             *   supplied for an Amazon EMR cluster instance group. You can specify a separate
            ...
            public fun ebsConfiguration(
                ebsConfiguration: EbsConfigurationProperty.Builder.() -> Unit
            )
            ...
            /**
             * @param instanceType The Amazon EC2 instance type for all instances in the instance
             *   group.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            override fun autoScalingPolicy(autoScalingPolicy: AutoScalingPolicyProperty) {
                cdkBuilder.autoScalingPolicy(
                    autoScalingPolicy.let(AutoScalingPolicyProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("f89ff2b9dd21c94ae6cfe970e5b0e824d10b8cc152e3a40c855e107a70ed2802")
            override fun autoScalingPolicy(
                autoScalingPolicy: AutoScalingPolicyProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * `AutoScalingPolicy` is a subproperty of the
             * [InstanceGroupConfig](https://docs.aws.amazon.com//AWSCloudFormation/latest/UserGuide/aws-properties-emr-cluster-jobflowinstancesconfig-instancegroupconfig.html)
             * property type that specifies the constraints and rules of an automatic scaling policy
             * in Amazon EMR . The automatic scaling policy defines how an instance group
             * dynamically adds and terminates EC2 instances in response to the value of a
             * CloudWatch metric. Only core and task instance groups can use automatic scaling
             * policies. For more information, see
             * [Using Automatic Scaling in Amazon EMR](https://docs.aws.amazon.com//emr/latest/ManagementGuide/emr-automatic-scaling.html)
             ...
             *
             * This is the maximum price you are willing to pay for Spot Instances. Specify
             * `OnDemandPrice` to set the amount equal to the On-Demand price, or specify an amount
             * in USD.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-emr-cluster-instancegroupconfig.html#cfn-emr-cluster-instancegroupconfig-bidprice)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: InstanceGroupConfigProperty
            ): software.amazon.awscdk.services.emr.CfnCluster.InstanceGroupConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface EbsBlockDeviceConfigProperty {
        ...
        public interface Builder {
            /**
             * @param volumeSpecification EBS volume specifications such as volume type, IOPS, size
             *   (GiB) and throughput (MiB/s) that are requested for the EBS volume attached to an
            ...
            public fun volumeSpecification(
                volumeSpecification: VolumeSpecificationProperty.Builder.() -> Unit
            )
        ...
        private class BuilderImpl : Builder {
            ...
            override fun volumeSpecification(volumeSpecification: VolumeSpecificationProperty) {
                cdkBuilder.volumeSpecification(
                    volumeSpecification.let(VolumeSpecificationProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("7a6098102f5fe1e7c642ed86c5ea6655bb1f9f5971c6dce82a27acdd3a241902")
            override fun volumeSpecification(
                volumeSpecification: VolumeSpecificationProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * (MiB/s) that are requested for the EBS volume attached to an Amazon EC2 instance in
             * the cluster.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-emr-cluster-ebsblockdeviceconfig.html#cfn-emr-cluster-ebsblockdeviceconfig-volumespecification)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: EbsBlockDeviceConfigProperty
            ): software.amazon.awscdk.services.emr.CfnCluster.EbsBlockDeviceConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ScalingTriggerProperty {
        ...
        public interface Builder {
            /**
             * @param cloudWatchAlarmDefinition The definition of a CloudWatch metric alarm. When
             *   the defined alarm conditions are met along with other trigger parameters, scaling
             *   activity begins.
             */
            ...
            public fun cloudWatchAlarmDefinition(
                cloudWatchAlarmDefinition: CloudWatchAlarmDefinitionProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun cloudWatchAlarmDefinition(cloudWatchAlarmDefinition: IResolvable) {
                cdkBuilder.cloudWatchAlarmDefinition(
                    cloudWatchAlarmDefinition.let(IResolvable::unwrap)
                )
            }
             ...
             *   activity begins.
             */
            override fun cloudWatchAlarmDefinition(
                cloudWatchAlarmDefinition: CloudWatchAlarmDefinitionProperty
            ) {
                cdkBuilder.cloudWatchAlarmDefinition(
                    cloudWatchAlarmDefinition.let(CloudWatchAlarmDefinitionProperty::unwrap)
                )
            }
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-emr-cluster-scalingtrigger.html#cfn-emr-cluster-scalingtrigger-cloudwatchalarmdefinition)
             */
            override fun cloudWatchAlarmDefinition(): Any =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ScalingTriggerProperty
            ): software.amazon.awscdk.services.emr.CfnCluster.ScalingTriggerProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface HadoopJarStepConfigProperty {
        ...
        public interface Builder {
            /**
             * @param args A list of command line arguments passed to the JAR file's main function
             *   when executed.
             */
            ...
            /**
             * @param stepProperties A list of Java properties that are set when the step runs. You
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: HadoopJarStepConfigProperty
            ): software.amazon.awscdk.services.emr.CfnCluster.HadoopJarStepConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ConfigurationProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param configurations A list of additional configurations to apply within a
             *   configuration object.
             */
            public fun configurations(configurations: IResolvable)
    ...
    public interface InstanceTypeConfigProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param bidPriceAsPercentageOfOnDemandPrice The bid price, as a percentage of
             *   On-Demand price, for each Amazon EC2 Spot Instance as defined by `InstanceType` .
             *   Expressed as a number (for example, 20 specifies 20%). If neither `BidPrice` nor
             *   `BidPriceAsPercentageOfOnDemandPrice` is provided,
             *   `BidPriceAsPercentageOfOnDemandPrice` defaults to 100%.
             */
            public fun bidPriceAsPercentageOfOnDemandPrice(
                bidPriceAsPercentageOfOnDemandPrice: Number
            )

            /**
             * @param configurations A configuration classification that applies when provisioning
             ...
             *   This value is 1 for a master instance fleet, and must be 1 or greater for core and
             *   task instance fleets. Defaults to 1 if not specified.
             */
        ...
        private class BuilderImpl : Builder {
             ...
             *   `BidPriceAsPercentageOfOnDemandPrice` defaults to 100%.
             */
            override fun bidPriceAsPercentageOfOnDemandPrice(
                bidPriceAsPercentageOfOnDemandPrice: Number
            ) {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: InstanceTypeConfigProperty
            ): software.amazon.awscdk.services.emr.CfnCluster.InstanceTypeConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface PlacementGroupConfigProperty {
        ...
        public interface Builder {
            /**
             * @param instanceRole Role of the instance in the cluster. Starting with Amazon EMR
             *   release 5.23.0, the only supported instance role is `MASTER` .
             */
            public fun instanceRole(instanceRole: String)

            /**
             * @param placementStrategy Amazon EC2 Placement Group strategy associated with instance
             *   role. Starting with Amazon EMR release 5.23.0, the only supported placement
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: PlacementGroupConfigProperty
            ): software.amazon.awscdk.services.emr.CfnCluster.PlacementGroupConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface VolumeSpecificationProperty {
         ...
         *
         * This can be a number from 1 - 1024. If the volume type is EBS-optimized, the minimum
         * value is 10.
         *
         ...
         *
         * This optional parameter can be a number from 125 - 1000 and is valid only for gp3
         * volumes.
         *
        ...
        public interface Builder {
            ...
            /**
             * @param sizeInGb The volume size, in gibibytes (GiB). This can be a number from
             *   1 - 1024. If the volume type is EBS-optimized, the minimum value is 10.
             */
            public fun sizeInGb(sizeInGb: Number)

            /**
             * @param throughput The throughput, in mebibyte per second (MiB/s). This optional
             *   parameter can be a number from 125 - 1000 and is valid only for gp3 volumes.
             */
            public fun throughput(throughput: Number)

            /**
             * @param volumeType The volume type. Volume types supported are gp3, gp2, io1, st1,
             *   sc1, and standard.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: VolumeSpecificationProperty
            ): software.amazon.awscdk.services.emr.CfnCluster.VolumeSpecificationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ApplicationProperty {
        ...
        public interface Builder {
            /**
             * @param additionalInfo This option is for advanced users only. This is meta
             *   information about clusters and applications that are used for testing and
             *   troubleshooting.
             */
        ...
        internal constructor(
             ...
             * This option is for advanced users only.
             *
             * This is meta information about clusters and applications that are used for testing
             * and troubleshooting.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-emr-cluster-application.html#cfn-emr-cluster-application-additionalinfo)
             */
    ...
    public interface ScalingActionProperty {
        ...
        public interface Builder {
            ...
            public fun simpleScalingPolicyConfiguration(
                simpleScalingPolicyConfiguration: IResolvable
            )
            ...
            public fun simpleScalingPolicyConfiguration(
                simpleScalingPolicyConfiguration:
                    SimpleScalingPolicyConfigurationProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
             ...
             *   activity makes when triggered, and the periodicity of the adjustment.
             */
            override fun simpleScalingPolicyConfiguration(
                simpleScalingPolicyConfiguration: IResolvable
            ) {
                cdkBuilder.simpleScalingPolicyConfiguration(
                    simpleScalingPolicyConfiguration.let(IResolvable::unwrap)
                )
            }
            ...
            override fun simpleScalingPolicyConfiguration(
                ...
                cdkBuilder.simpleScalingPolicyConfiguration(
                    simpleScalingPolicyConfiguration.let(
                        SimpleScalingPolicyConfigurationProperty::unwrap
                    )
                )
            }
    ...
    public interface ScalingRuleProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param description A friendly, more verbose description of the automatic scaling
             *   rule.
             */
            public fun description(description: String)

            /**
             * @param name The name used to identify an automatic scaling rule. Rule names must be
    ...
    public interface ScriptBootstrapActionConfigProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ScriptBootstrapActionConfigProperty
            ): software.amazon.awscdk.services.emr.CfnCluster.ScriptBootstrapActionConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
