...
public open class CfnCluster internal constructor(
  ...
  private class BuilderImpl(
    ...
    public override fun additionalInfo(additionalInfo: Any) {
      cdkBuilder.additionalInfo(additionalInfo)
    }

    public override fun applications(applications: IResolvable) {
      cdkBuilder.applications(applications.let(IResolvable::unwrap))
    }

    public override fun applications(applications: List<Any>) {
      cdkBuilder.applications(applications)
    }

    public override fun autoScalingRole(autoScalingRole: String) {
      cdkBuilder.autoScalingRole(autoScalingRole)
    }

    public override fun autoTerminationPolicy(autoTerminationPolicy: IResolvable) {
      cdkBuilder.autoTerminationPolicy(autoTerminationPolicy.let(IResolvable::unwrap))
    }

    public override
        fun autoTerminationPolicy(autoTerminationPolicy: AutoTerminationPolicyProperty) {
    ...
    public override fun bootstrapActions(bootstrapActions: IResolvable) {
      cdkBuilder.bootstrapActions(bootstrapActions.let(IResolvable::unwrap))
    }

    public override fun bootstrapActions(bootstrapActions: List<Any>) {
    ...
    public override fun ebsRootVolumeIops(ebsRootVolumeIops: Number) {
      cdkBuilder.ebsRootVolumeIops(ebsRootVolumeIops)
    }

    public override fun ebsRootVolumeSize(ebsRootVolumeSize: Number) {
      cdkBuilder.ebsRootVolumeSize(ebsRootVolumeSize)
    }

    public override fun ebsRootVolumeThroughput(ebsRootVolumeThroughput: Number) {
      cdkBuilder.ebsRootVolumeThroughput(ebsRootVolumeThroughput)
    }

    public override fun instances(instances: IResolvable) {
      cdkBuilder.instances(instances.let(IResolvable::unwrap))
    }

    public override fun instances(instances: JobFlowInstancesConfigProperty) {
      cdkBuilder.instances(instances.let(JobFlowInstancesConfigProperty::unwrap))
    }

    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("4392db05069307858968e7f25c0aed0db99baf1275502c31f16ff933fb598c4e")
    public override fun instances(instances: JobFlowInstancesConfigProperty.Builder.() -> Unit):
        Unit = instances(JobFlowInstancesConfigProperty(instances))

    public override fun jobFlowRole(jobFlowRole: String) {
      cdkBuilder.jobFlowRole(jobFlowRole)
    }

    public override fun kerberosAttributes(kerberosAttributes: IResolvable) {
    ...
    public override fun logEncryptionKmsKeyId(logEncryptionKmsKeyId: String) {
    ...
    public override fun managedScalingPolicy(managedScalingPolicy: IResolvable) {
      cdkBuilder.managedScalingPolicy(managedScalingPolicy.let(IResolvable::unwrap))
    }

    public override fun managedScalingPolicy(managedScalingPolicy: ManagedScalingPolicyProperty) {
    ...
    public override fun osReleaseLabel(osReleaseLabel: String) {
      cdkBuilder.osReleaseLabel(osReleaseLabel)
    }

    public override fun placementGroupConfigs(placementGroupConfigs: IResolvable) {
      cdkBuilder.placementGroupConfigs(placementGroupConfigs.let(IResolvable::unwrap))
    }

    public override fun placementGroupConfigs(placementGroupConfigs: List<Any>) {
    ...
    public override fun scaleDownBehavior(scaleDownBehavior: String) {
    ...
    public override fun visibleToAllUsers(visibleToAllUsers: IResolvable) {
  ...
  public interface StepConfigProperty {
    ...
    private class Wrapper internal constructor(
      ...
      public override fun actionOnFailure(): String? = unwrap(this).getActionOnFailure()

      public override fun hadoopJarStep(): Any = unwrap(this).getHadoopJarStep()
  ...
  public interface ComputeLimitsProperty {
    ...
    private class BuilderImpl : Builder {
      ...
      public override fun maximumCapacityUnits(maximumCapacityUnits: Number) {
        cdkBuilder.maximumCapacityUnits(maximumCapacityUnits)
      }

      public override fun maximumCoreCapacityUnits(maximumCoreCapacityUnits: Number) {
        cdkBuilder.maximumCoreCapacityUnits(maximumCoreCapacityUnits)
      }

      public override fun maximumOnDemandCapacityUnits(maximumOnDemandCapacityUnits: Number) {
        cdkBuilder.maximumOnDemandCapacityUnits(maximumOnDemandCapacityUnits)
      }

      public override fun minimumCapacityUnits(minimumCapacityUnits: Number) {
        cdkBuilder.minimumCapacityUnits(minimumCapacityUnits)
      }

      public override fun unitType(unitType: String) {
    ...
    private class Wrapper internal constructor(
      ...
      public override fun maximumCapacityUnits(): Number = unwrap(this).getMaximumCapacityUnits()

      public override fun maximumCoreCapacityUnits(): Number? =
          unwrap(this).getMaximumCoreCapacityUnits()

      public override fun maximumOnDemandCapacityUnits(): Number? =
          unwrap(this).getMaximumOnDemandCapacityUnits()

      public override fun minimumCapacityUnits(): Number = unwrap(this).getMinimumCapacityUnits()

      public override fun unitType(): String = unwrap(this).getUnitType()
    }
  ...
  public interface JobFlowInstancesConfigProperty {
    ...
    private class BuilderImpl : Builder {
      ...
      public override fun coreInstanceFleet(coreInstanceFleet: IResolvable) {
        cdkBuilder.coreInstanceFleet(coreInstanceFleet.let(IResolvable::unwrap))
      }

      public override fun coreInstanceFleet(coreInstanceFleet: InstanceFleetConfigProperty) {
      ...
      public override fun coreInstanceGroup(coreInstanceGroup: IResolvable) {
        cdkBuilder.coreInstanceGroup(coreInstanceGroup.let(IResolvable::unwrap))
      }

      public override fun coreInstanceGroup(coreInstanceGroup: InstanceGroupConfigProperty) {
      ...
      public override fun keepJobFlowAliveWhenNoSteps(keepJobFlowAliveWhenNoSteps: Boolean) {
        cdkBuilder.keepJobFlowAliveWhenNoSteps(keepJobFlowAliveWhenNoSteps)
      }

      public override fun keepJobFlowAliveWhenNoSteps(keepJobFlowAliveWhenNoSteps: IResolvable) {
        cdkBuilder.keepJobFlowAliveWhenNoSteps(keepJobFlowAliveWhenNoSteps.let(IResolvable::unwrap))
      }

      public override fun masterInstanceFleet(masterInstanceFleet: IResolvable) {
        cdkBuilder.masterInstanceFleet(masterInstanceFleet.let(IResolvable::unwrap))
      }

      public override fun masterInstanceFleet(masterInstanceFleet: InstanceFleetConfigProperty) {
      ...
      public override fun masterInstanceGroup(masterInstanceGroup: IResolvable) {
        cdkBuilder.masterInstanceGroup(masterInstanceGroup.let(IResolvable::unwrap))
      }

      public override fun masterInstanceGroup(masterInstanceGroup: InstanceGroupConfigProperty) {
      ...
      public override fun taskInstanceFleets(taskInstanceFleets: IResolvable) {
        cdkBuilder.taskInstanceFleets(taskInstanceFleets.let(IResolvable::unwrap))
      }

      public override fun taskInstanceFleets(taskInstanceFleets: List<Any>) {
        cdkBuilder.taskInstanceFleets(taskInstanceFleets)
      }

      public override fun taskInstanceGroups(taskInstanceGroups: IResolvable) {
        cdkBuilder.taskInstanceGroups(taskInstanceGroups.let(IResolvable::unwrap))
      }

      public override fun taskInstanceGroups(taskInstanceGroups: List<Any>) {
      ...
      public override fun terminationProtected(terminationProtected: IResolvable) {
        cdkBuilder.terminationProtected(terminationProtected.let(IResolvable::unwrap))
      }

      public override fun unhealthyNodeReplacement(unhealthyNodeReplacement: Boolean) {
        cdkBuilder.unhealthyNodeReplacement(unhealthyNodeReplacement)
      }

      public override fun unhealthyNodeReplacement(unhealthyNodeReplacement: IResolvable) {
    ...
    private class Wrapper internal constructor(
      ...
      public override fun coreInstanceFleet(): Any? = unwrap(this).getCoreInstanceFleet()

      public override fun coreInstanceGroup(): Any? = unwrap(this).getCoreInstanceGroup()
      ...
      public override fun keepJobFlowAliveWhenNoSteps(): Any? =
          unwrap(this).getKeepJobFlowAliveWhenNoSteps()

      public override fun masterInstanceFleet(): Any? = unwrap(this).getMasterInstanceFleet()

      public override fun masterInstanceGroup(): Any? = unwrap(this).getMasterInstanceGroup()
      ...
      public override fun taskInstanceFleets(): Any? = unwrap(this).getTaskInstanceFleets()

      public override fun taskInstanceGroups(): Any? = unwrap(this).getTaskInstanceGroups()

      public override fun terminationProtected(): Any? = unwrap(this).getTerminationProtected()

      public override fun unhealthyNodeReplacement(): Any? =
  ...
  public interface InstanceFleetConfigProperty {
    ...
    private class Wrapper internal constructor(
      ...
      public override fun instanceTypeConfigs(): Any? = unwrap(this).getInstanceTypeConfigs()
  ...
  public interface ManagedScalingPolicyProperty {
    ...
    private class BuilderImpl : Builder {
      ...
      public override fun computeLimits(computeLimits: IResolvable) {
        cdkBuilder.computeLimits(computeLimits.let(IResolvable::unwrap))
      }

      public override fun computeLimits(computeLimits: ComputeLimitsProperty) {
        cdkBuilder.computeLimits(computeLimits.let(ComputeLimitsProperty::unwrap))
      }

      @Suppress("INAPPLICABLE_JVM_NAME")
      @JvmName("95bc72e2e9aa925adeed929babb4791327d9958ad0bd79ae634df9497a8bec64")
      public override fun computeLimits(computeLimits: ComputeLimitsProperty.Builder.() -> Unit):
    ...
    private class Wrapper internal constructor(
      ...
      public override fun computeLimits(): Any? = unwrap(this).getComputeLimits()
    }
  ...
  public interface BootstrapActionConfigProperty {
    ...
    private class BuilderImpl : Builder {
      ...
      public override fun scriptBootstrapAction(scriptBootstrapAction: IResolvable) {
    ...
    private class Wrapper internal constructor(
      ...
      public override fun scriptBootstrapAction(): Any = unwrap(this).getScriptBootstrapAction()
    }
  ...
  public interface InstanceGroupConfigProperty {
    ...
    private class Wrapper internal constructor(
      ...
      public override fun autoScalingPolicy(): Any? = unwrap(this).getAutoScalingPolicy()
  ...
  public interface PlacementGroupConfigProperty {
    ...
    private class BuilderImpl : Builder {
      ...
      public override fun placementStrategy(placementStrategy: String) {
    ...
    private class Wrapper internal constructor(
      ...
      public override fun placementStrategy(): String? = unwrap(this).getPlacementStrategy()
    }
  ...
  public interface ApplicationProperty {
    ...
    private class BuilderImpl : Builder {
      ...
      public override fun additionalInfo(additionalInfo: IResolvable) {
    ...
    private class Wrapper internal constructor(
      ...
      public override fun additionalInfo(): Any? = unwrap(this).getAdditionalInfo()
