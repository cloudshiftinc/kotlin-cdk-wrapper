...
internal constructor(
    ...
    public interface Builder {
         ...
         * addresses that you want AWS WAF to inspect for in incoming requests.
         *
         * All addresses must be specified using Classless Inter-Domain Routing (CIDR) notation. AWS
         ...
         * * Array with three addresses: `"Addresses":
         *   ["192.0.2.44/32", "192.0.2.0/24", "192.0.0.0/16"]`
