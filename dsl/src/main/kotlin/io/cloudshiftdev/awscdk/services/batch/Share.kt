...
public interface Share {
     ...
     *
     * All jobs that specify this share identifier when submitted to the queue will be considered as
     * part of this Share.
     */
     ...
     *
     * The Scheduler decides which jobs to put in the Compute Environment such that the following
     * ratio is equal for each job:
     *
    ...
    public interface Builder {
        ...
        /**
         * @param weightFactor The weight factor given to this Share. The Scheduler decides which
         *   jobs to put in the Compute Environment such that the following ratio is equal for each
         *   job:
         *
         * `sharevCpu / weightFactor`,
         *
         ...
         *
         * See the readme of this module for a detailed example that shows how these are used, how
         * it relates to `computeReservation`, and how `shareDecay` affects these calculations.
         */
    ...
    internal constructor(
         ...
         * The identifier of this Share.
         *
         * All jobs that specify this share identifier when submitted to the queue will be
         * considered as part of this Share.
         */
         ...
         * The weight factor given to this Share.
         *
         * The Scheduler decides which jobs to put in the Compute Environment such that the
         * following ratio is equal for each job:
         *
         * `sharevCpu / weightFactor`,
         *
         * where `sharevCpu` is the total amount of vCPU given to that particular share; that is,
    ...
    public companion object {
        ...
        internal fun unwrap(wrapped: Share): software.amazon.awscdk.services.batch.Share =
