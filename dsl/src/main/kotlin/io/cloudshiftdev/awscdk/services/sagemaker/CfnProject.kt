...
internal constructor(
    ...
    /** Details of a provisioned service catalog product. */
    public open fun serviceCatalogProvisionedProductDetails(
        `value`: ServiceCatalogProvisionedProductDetailsProperty
    ) {
        unwrap(this)
            .setServiceCatalogProvisionedProductDetails(
                `value`.let(ServiceCatalogProvisionedProductDetailsProperty::unwrap)
            )
    }
    ...
    public open fun serviceCatalogProvisionedProductDetails(
        `value`: ServiceCatalogProvisionedProductDetailsProperty.Builder.() -> Unit
    ): Unit =
        serviceCatalogProvisionedProductDetails(
            ServiceCatalogProvisionedProductDetailsProperty(`value`)
        )
    ...
    public interface Builder {
        ...
        public fun serviceCatalogProvisionedProductDetails(
            serviceCatalogProvisionedProductDetails:
                ServiceCatalogProvisionedProductDetailsProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
         ...
         *   product.
         */
        override fun serviceCatalogProvisionedProductDetails(
            serviceCatalogProvisionedProductDetails: IResolvable
        ) {
            cdkBuilder.serviceCatalogProvisionedProductDetails(
                serviceCatalogProvisionedProductDetails.let(IResolvable::unwrap)
            )
        }
        ...
        override fun serviceCatalogProvisionedProductDetails(
            ...
            cdkBuilder.serviceCatalogProvisionedProductDetails(
                serviceCatalogProvisionedProductDetails.let(
                    ServiceCatalogProvisionedProductDetailsProperty::unwrap
                )
            )
        }
        ...
        public fun build(): software.amazon.awscdk.services.sagemaker.CfnProject =
            cdkBuilder.build()
    }
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnProject
        ): software.amazon.awscdk.services.sagemaker.CfnProject = wrapped.cdkObject
    }
    ...
    public interface ServiceCatalogProvisioningDetailsProperty {
        ...
        public interface Builder {
             ...
             *   product has a default path, and required if the product has more than one path.
             */
            ...
            /**
             * @param provisioningParameters A list of key value pairs that you specify when you
             *   provision a product.
             */
        ...
        private class BuilderImpl : Builder {
            private val cdkBuilder:
                ...
                software.amazon.awscdk.services.sagemaker.CfnProject
        ...
        internal constructor(
             ...
             * The path identifier of the product.
             *
             * This value is optional if the product has a default path, and required if the product
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-sagemaker-project-servicecatalogprovisioningdetails.html#cfn-sagemaker-project-servicecatalogprovisioningdetails-provisioningartifactid)
             */
            override fun provisioningArtifactId(): String? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ServiceCatalogProvisioningDetailsProperty
            ): software.amazon.awscdk.services.sagemaker.CfnProject.ServiceCatalogProvisioningDetailsProperty =
    ...
    public interface ServiceCatalogProvisionedProductDetailsProperty {
         ...
         *   not running. For example, CloudFormation received a parameter value that was not valid
        ...
        public interface Builder {
             ...
             *   the requested operation but is not exactly what was requested. For example, a
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ServiceCatalogProvisionedProductDetailsProperty
            ): software.amazon.awscdk.services.sagemaker.CfnProject.ServiceCatalogProvisionedProductDetailsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
