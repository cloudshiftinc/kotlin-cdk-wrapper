...
internal constructor(
    ...
    public interface Builder {
         ...
         * * The `HIVE` data catalog type uses the following syntax. The `metadata-function`
         *   parameter is required. `The sdk-version` parameter is optional and defaults to the
         *   currently supported version.
         *
         * `metadata-function= *lambda_arn* , sdk-version= *version_number*`
         * * The `LAMBDA` data catalog type uses one of the following sets of required parameters,
         *   but not both.
        ...
        /**
         * The type of data catalog: `LAMBDA` for a federated catalog, `GLUE` for AWS Glue Catalog,
         ...
         *
         * @param type The type of data catalog: `LAMBDA` for a federated catalog, `GLUE` for AWS
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.athena.CfnDataCatalog =
            cdkBuilder.build()
    }
