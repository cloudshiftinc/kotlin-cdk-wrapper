...
public enum class EmailSendingEvent(
    ...
    public companion object {
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.ses.EmailSendingEvent
        ): EmailSendingEvent =
            when (cdkObject) {
                software.amazon.awscdk.services.ses.EmailSendingEvent.SEND -> EmailSendingEvent.SEND
                software.amazon.awscdk.services.ses.EmailSendingEvent.REJECT ->
                    EmailSendingEvent.REJECT
                software.amazon.awscdk.services.ses.EmailSendingEvent.BOUNCE ->
                    EmailSendingEvent.BOUNCE
                software.amazon.awscdk.services.ses.EmailSendingEvent.COMPLAINT ->
                    EmailSendingEvent.COMPLAINT
                software.amazon.awscdk.services.ses.EmailSendingEvent.DELIVERY ->
                    EmailSendingEvent.DELIVERY
                software.amazon.awscdk.services.ses.EmailSendingEvent.OPEN -> EmailSendingEvent.OPEN
                software.amazon.awscdk.services.ses.EmailSendingEvent.CLICK ->
