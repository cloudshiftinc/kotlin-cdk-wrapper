...
public interface AccessLogConfig {
    ...
    public fun virtualGatewayAccessLog(): CfnVirtualGateway.VirtualGatewayAccessLogProperty? =
        unwrap(this)
            ...
            ?.let(CfnVirtualGateway.VirtualGatewayAccessLogProperty::wrap)
    ...
    public interface Builder {
        ...
        public fun virtualGatewayAccessLog(
            virtualGatewayAccessLog:
                CfnVirtualGateway.VirtualGatewayAccessLogProperty.Builder.() -> Unit
        )
        ...
        public fun virtualNodeAccessLog(
            virtualNodeAccessLog: CfnVirtualNode.AccessLogProperty.Builder.() -> Unit
        )
    }
    ...
    private class BuilderImpl : Builder {
        ...
        /** @param virtualGatewayAccessLog VirtualGateway CFN configuration for Access Logging. */
        override fun virtualGatewayAccessLog(
            virtualGatewayAccessLog: CfnVirtualGateway.VirtualGatewayAccessLogProperty
        ) {
            cdkBuilder.virtualGatewayAccessLog(
                virtualGatewayAccessLog.let(
                    CfnVirtualGateway.VirtualGatewayAccessLogProperty::unwrap
                )
            )
        }
        ...
        override fun virtualGatewayAccessLog(
            ...
            virtualGatewayAccessLog(
                CfnVirtualGateway.VirtualGatewayAccessLogProperty(virtualGatewayAccessLog)
            )

        /** @param virtualNodeAccessLog VirtualNode CFN configuration for Access Logging. */
        override fun virtualNodeAccessLog(virtualNodeAccessLog: CfnVirtualNode.AccessLogProperty) {
            cdkBuilder.virtualNodeAccessLog(
                virtualNodeAccessLog.let(CfnVirtualNode.AccessLogProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("7c8911635fcfe0190553a5f9e21ab70e568d572b85c98c968563bc77ca18cbd9")
        override fun virtualNodeAccessLog(
            virtualNodeAccessLog: CfnVirtualNode.AccessLogProperty.Builder.() -> Unit
        ): Unit = virtualNodeAccessLog(CfnVirtualNode.AccessLogProperty(virtualNodeAccessLog))

        public fun build(): software.amazon.awscdk.services.appmesh.AccessLogConfig =
            cdkBuilder.build()
    }
