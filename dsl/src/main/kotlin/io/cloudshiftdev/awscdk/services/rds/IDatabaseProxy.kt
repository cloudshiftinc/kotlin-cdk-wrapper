...
public interface IDatabaseProxy : IResource {
     ...
     *
     * Default: - if the Proxy had been provided a single Secret value, the user will be taken from
     * that Secret
     *
    ...
    internal constructor(
         ...
         * Grant the given identity connection access to the proxy.
         *
         * Default: - if the Proxy had been provided a single Secret value, the user will be taken
         * from that Secret
         *
         * @param grantee the Principal to grant the permissions to.
         * @param dbUser the name of the database user to allow connecting as to the proxy.
    ...
    public companion object {
        ...
        ): IDatabaseProxy = Wrapper(cdkObject)

        internal fun unwrap(
            wrapped: IDatabaseProxy
        ): software.amazon.awscdk.services.rds.IDatabaseProxy = (wrapped as Wrapper).cdkObject
    }
}
