...
internal constructor(
     ...
     * is in the queue in order to include it in the response, rather than returning an empty
     * response if a message isn't yet available.
     */
    ...
    public interface Builder {
         ...
         * deduplication.
         *
         * During the deduplication interval, Amazon SQS treats messages that are sent with
         * identical content as duplicates and delivers only one copy of the message. For more
         ...
         *
         * @param contentBasedDeduplication For first-in-first-out (FIFO) queues, specifies whether
        ...
        /**
         * For high throughput for FIFO queues, specifies whether message deduplication occurs at
         * the message group or queue level.
         *
         * Valid values are `messageGroup` and `queue` .
         *
         * To enable high throughput for a FIFO queue, set this attribute to `messageGroup` *and*
         * set the `FifoThroughputLimit` attribute to `perMessageGroupId` . If you set these
         * attributes to anything other than these values, normal throughput is in effect and
         * deduplication occurs as specified. For more information, see
         ...
         *
         * @param delaySeconds The time in seconds for which the delivery of all messages in the
         *   queue is delayed.
         */
         ...
         * *and* set the `DeduplicationScope` attribute to `messageGroup` . If you set these
         * attributes to anything other than these values, normal throughput is in effect and
         * deduplication occurs as specified. For more information, see
         * [High throughput for FIFO queues](https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/high-throughput-fifo.html)
         * and
         ...
         *
         * @param fifoThroughputLimit For high throughput for FIFO queues, specifies whether the
         *   FIFO queue throughput quota applies to the entire queue or per message group.
         */
         ...
         *
         * The value must be an integer between 60 (1 minute) and 86,400 (24 hours). The default is
         * 300 (5 minutes).
         *
         ...
         * [Encryption at rest](https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/sqs-server-side-encryption.html#sqs-how-does-the-data-key-reuse-period-work)
         * in the *Amazon SQS Developer Guide* .
         *
         ...
         *
         * @param kmsDataKeyReusePeriodSeconds The length of time in seconds for which Amazon SQS
         ...
         *   Guide* * [CreateQueue](https://docs.aws.amazon.com/AWSSimpleQueueService/latest/APIReference/API_CreateQueue.html)
         ...
         *   [AWS Key Management Service Best Practices](https://docs.aws.amazon.com/https://d0.awsstatic.com/whitepapers/aws-kms-best-practices.pdf)
         *   whitepaper
         *
         ...
         * that ID for the queue name. For more information, see
         ...
         * message is in the queue in order to include it in the response, rather than returning an
         * empty response if a message isn't yet available.
         *
         * You can specify an integer from 1 to 20. Short polling is used as the default or when you
         * specify 0 for this property. For more information, see
         ...
         *   ReceiveMessage action call waits until a message is in the queue in order to include it
         *   in the response, rather than returning an empty response if a message isn't yet
         *   available.
         */
         ...
         * redrive permission and which source queues can specify dead-letter queues as a JSON
         * object.
         *
         * The parameters are as follows:
         * * `redrivePermission` : The permission type that defines which source queues can specify
         *   the current queue as the dead-letter queue. Valid values are:
         ...
         *   specify this queue as the dead-letter queue and redrive messages. You can specify this
         *   parameter only when the `redrivePermission` parameter is set to `byQueue` . You can
         *   specify up to 10 source queue ARNs. To allow more than 10 source queues to specify
         *   dead-letter queues, set the `redrivePermission` parameter to `allowAll` .
         *
         ...
         *
         * @param redriveAllowPolicy The string that includes the parameters for the permissions for
         *   the dead-letter queue redrive permission and which source queues can specify
         *   dead-letter queues as a JSON object.
         */
         ...
         * ). When `SqsManagedSseEnabled` is not defined, `SSE-SQS` encryption is enabled by
         * default.
         *
         ...
         *
         * @param sqsManagedSseEnabled Enables server-side queue encryption using SQS owned
         *   encryption keys.
         */
         ...
         *
         * This blocks other components from receiving the same message and gives the initial
         ...
         *
         * @param visibilityTimeout The length of time during which a message will be unavailable
         *   after a message is delivered from the queue.
         */
