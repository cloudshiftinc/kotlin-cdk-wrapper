...
internal constructor(
    ...
    public interface Builder {
         ...
         * Specifies whether to block resource-based policies that allow broad access to the secret.
         *
         * By default, Secrets Manager blocks policies that allow broad access, for example those
         ...
         *
         * @param blockPublicPolicy Specifies whether to block resource-based policies that allow
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.secretsmanager.CfnResourcePolicy.Builder.create(
                scope,
                id
            )
