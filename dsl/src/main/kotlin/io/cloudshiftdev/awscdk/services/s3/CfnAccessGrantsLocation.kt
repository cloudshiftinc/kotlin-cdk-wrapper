...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param iamRoleArn The Amazon Resource Name (ARN) of the IAM role for the registered
         *   location.
         */
         ...
         * The S3 URI path to the location that you are registering.
         *
         * The location scope can be the default S3 location `s3://` , the S3 path to a bucket, or
         * the S3 path to a bucket and prefix. A prefix in S3 is a string of characters at the
         * beginning of an object key name used to organize the objects that you store in your S3
         * buckets. For example, object key names that start with the `engineering/` prefix or
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnAccessGrantsLocation
