...
public interface LambdaIntegrationOptions : IntegrationOptions {
     ...
     *
     * This will add another permission to the AWS Lambda resource policy which will allow the
    ...
    public interface Builder {
         ...
         *   This will add another permission to the AWS Lambda resource policy which will allow the
         *   `test-invoke-stage` stage to invoke this handler. If this is set to `false`, the
         *   function will only be usable from the deployment endpoint.
         */
        ...
        /**
         * @param credentialsPassthrough Requires that the caller's identity be passed through from
         *   the request.
         */
        ...
        /**
         * @param integrationResponses The response that API Gateway provides after a method's
         *   backend completes processing a request. API Gateway intercepts the response from the
         *   backend so that you can control how API Gateway surfaces backend responses. For
         *   example, you can map the backend status codes to codes that you define.
         */
         ...
         *   specified as the requestTemplates property on the Integration resource. There are three
         ...
         *   request. Specify request parameters as key-value pairs (string-to-string mappings),
         ...
         * where location is querystring, path, or header, and name is a valid, unique parameter
         * name.
         *
        ...
        /**
         * @param requestTemplates A map of Apache Velocity templates that are applied on the
         *   request payload. The template that API Gateway uses is based on the value of the
         *   Content-Type header that's sent by the client. The content type value is the key, and
         *   the template is the value (specified as a string), such as the following snippet:
         * ```
        ...
        /**
         * @param timeout The maximum amount of time an integration will run before it returns
         *   without a response. Must be between 50 milliseconds and 29 seconds.
         */
        public fun timeout(timeout: Duration)

        /**
         * @param vpcLink The VpcLink used for the integration. Required if connectionType is
         *   VPC_LINK
         */
    ...
    internal constructor(
         ...
         *
         * Default: none if this property isn't defined, the request payload is passed through from
         * the method request to the integration request without modification, provided that the
         ...
         * request.
         *
         * API Gateway intercepts the response from the backend so that you can control how API
         * Gateway surfaces backend responses. For example, you can map the backend status codes to
         ...
         */
        override fun requestTemplates(): Map<String, String> =
            unwrap(this).getRequestTemplates() ?: emptyMap()
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: LambdaIntegrationOptions
