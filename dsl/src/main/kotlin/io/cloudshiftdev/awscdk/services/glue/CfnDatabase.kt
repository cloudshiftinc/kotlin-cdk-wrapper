...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param catalogId The AWS account ID for the account in which to create the catalog
         *   object.
         */
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnDatabase
        ): software.amazon.awscdk.services.glue.CfnDatabase = wrapped.cdkObject
    }
    ...
    public interface DatabaseInputProperty {
        ...
        /**
         * A `FederatedDatabase` structure that references an entity outside the AWS Glue Data
         * Catalog .
         *
        ...
        public interface Builder {
            /**
             * @param createTableDefaultPermissions Creates a set of default permissions on the
             *   table for principals. Used by AWS Lake Formation . Not used in the normal course of
             *   AWS Glue operations.
             */
            ...
            /**
             * @param federatedDatabase A `FederatedDatabase` structure that references an entity
            ...
            public fun federatedDatabase(
                federatedDatabase: FederatedDatabaseProperty.Builder.() -> Unit
            )
            ...
            /**
             * @param name The name of the database. For Hive compatibility, this is folded to
             *   lowercase when it is stored.
             */
            public fun name(name: String)

            /**
             * @param parameters These key-value pairs define parameters and properties of the
             *   database.
             */
            public fun parameters(parameters: Any)

            /**
             * @param targetDatabase A `DatabaseIdentifier` structure that describes a target
        ...
        private class BuilderImpl : Builder {
            ...
            override fun federatedDatabase(federatedDatabase: FederatedDatabaseProperty) {
                cdkBuilder.federatedDatabase(
                    federatedDatabase.let(FederatedDatabaseProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("4b65ff7c8b03e9b65250939a9639ccc40f86571e64b8ca5ca97272767ae23b00")
            override fun federatedDatabase(
                federatedDatabase: FederatedDatabaseProperty.Builder.() -> Unit
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("8343aa203b412577f62ae7a45c499c1c61ea101c62145d4fd2f7b75aaecf2792")
            override fun targetDatabase(
                targetDatabase: DatabaseIdentifierProperty.Builder.() -> Unit
    ...
    public interface FederatedDatabaseProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: FederatedDatabaseProperty
            ): software.amazon.awscdk.services.glue.CfnDatabase.FederatedDatabaseProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface PrincipalPrivilegesProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: PrincipalPrivilegesProperty
            ): software.amazon.awscdk.services.glue.CfnDatabase.PrincipalPrivilegesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DatabaseIdentifierProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DatabaseIdentifierProperty
            ): software.amazon.awscdk.services.glue.CfnDatabase.DatabaseIdentifierProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
