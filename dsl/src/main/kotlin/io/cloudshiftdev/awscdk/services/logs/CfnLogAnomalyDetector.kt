...
internal constructor(
    ...
    public open fun attrAnomalyDetectorStatus(): String =
        unwrap(this).getAttrAnomalyDetectorStatus()
    ...
    public open fun logGroupArnList(): List<String> =
        unwrap(this).getLogGroupArnList() ?: emptyList()
    ...
    /** The ARN of the log group that is associated with this anomaly detector. */
    public open fun logGroupArnList(vararg `value`: String): Unit =
        logGroupArnList(`value`.toList())
    ...
    public interface Builder {
         ...
         * The number of days to have visibility on an anomaly.
         *
         * After this time period has elapsed for an anomaly, it will be automatically baselined and
         * the anomaly detector will treat new occurrences of a similar anomaly as normal.
         * Therefore, if you do not correct the cause of an anomaly during the time period specified
         * in `AnomalyVisibilityTime` , it will be considered normal going forward and will not be
         ...
         * Specifies how often the anomaly detector is to run and look for anomalies.
         *
         * Set this value according to the frequency that the log group receives new logs. For
         * example, if the log group receives new log events every 10 minutes, then 15 minutes might
         * be a good setting for `EvaluationFrequency` .
         *
         ...
         *
         * @param evaluationFrequency Specifies how often the anomaly detector is to run and look
         *   for anomalies.
         */
         ...
         * events that match the pattern you specify here.
         *
         ...
         * Optionally assigns a AWS KMS key to secure this anomaly detector and its findings.
         *
         * If a key is assigned, the anomalies found and the model used by this detector are
