...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.backup.BackupVault,
    ...
    public interface Builder {
         ...
         * and the AWS Region where they are created.
         *
         ...
         * Default: false
         *
         * @param blockRecoveryPointDeletion Whether to add statements to the vault access policy
         *   that prevents anyone from deleting a recovery point.
         */
    ...
    private class BuilderImpl(
        ...
        override fun lockConfiguration(
            lockConfiguration: LockConfiguration.Builder.() -> Unit
    ...
    public companion object {
        public fun fromBackupVaultArn(
            ...
            software.amazon.awscdk.services.backup.BackupVault.fromBackupVaultArn(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    backupVaultArn
                )
                .let(IBackupVault::wrap)
        ...
        public fun fromBackupVaultName(
            ...
            software.amazon.awscdk.services.backup.BackupVault.fromBackupVaultName(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    backupVaultName
                )
        ...
        ): BackupVault = BackupVault(cdkObject)

        internal fun unwrap(
            wrapped: BackupVault
        ): software.amazon.awscdk.services.backup.BackupVault = wrapped.cdkObject
    }
}
