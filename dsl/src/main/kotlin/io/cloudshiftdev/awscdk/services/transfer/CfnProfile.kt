...
internal constructor(
    ...
    public interface Builder {
        /**
         * The `As2Id` is the *AS2-name* , as defined in the
         * [RFC 4130](https://docs.aws.amazon.com/https://datatracker.ietf.org/doc/html/rfc4130) .
         * For inbound transfers, this is the `AS2-From` header for the AS2 messages sent from the
         * partner. For outbound connectors, this is the `AS2-To` header for the AS2 messages sent
         * to the partner using the `StartFileTransfer` API operation. This ID cannot include
         * spaces.
         *
    ...
    public companion object {
        ...
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.transfer.CfnProfile
        ): CfnProfile = CfnProfile(cdkObject)

        internal fun unwrap(
            wrapped: CfnProfile
        ): software.amazon.awscdk.services.transfer.CfnProfile = wrapped.cdkObject
    }
}
