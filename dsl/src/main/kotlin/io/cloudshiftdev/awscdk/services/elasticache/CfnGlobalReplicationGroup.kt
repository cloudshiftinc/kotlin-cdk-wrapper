...
internal constructor(
     ...
     * [io.cloudshiftdev.awscdk.services.elasticache.CfnGlobalReplicationGroup].
     */
    @CdkDslMarker
    public interface Builder {
         ...
         *
         * @param cacheParameterGroupName The name of the cache parameter group to use with the
         *   Global datastore.
         */
         ...
         *
         * @param globalReplicationGroupDescription The optional description of the Global
         *   datastore.
         */
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.elasticache.CfnGlobalReplicationGroup.Builder.create(
                scope,
                id
            )
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnGlobalReplicationGroup
    ...
    public interface GlobalReplicationGroupMemberProperty {
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-elasticache-globalreplicationgroup-globalreplicationgroupmember.html#cfn-elasticache-globalreplicationgroup-globalreplicationgroupmember-replicationgroupregion)
             */
            override fun replicationGroupRegion(): String? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: GlobalReplicationGroupMemberProperty
            ): software.amazon.awscdk.services.elasticache.CfnGlobalReplicationGroup.GlobalReplicationGroupMemberProperty =
    ...
    public interface ReshardingConfigurationProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param preferredAvailabilityZones A list of preferred availability zones for the
        ...
        private class BuilderImpl : Builder {
             ...
             *   nodes in this cluster.
             */
            override fun preferredAvailabilityZones(
                vararg preferredAvailabilityZones: String
            ): Unit = preferredAvailabilityZones(preferredAvailabilityZones.toList())
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ReshardingConfigurationProperty
            ): software.amazon.awscdk.services.elasticache.CfnGlobalReplicationGroup.ReshardingConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface RegionalConfigurationProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param reshardingConfigurations A list of PreferredAvailabilityZones objects that
        ...
        private class BuilderImpl : Builder {
            ...
            override fun reshardingConfigurations(reshardingConfigurations: IResolvable) {
                cdkBuilder.reshardingConfigurations(
                    reshardingConfigurations.let(IResolvable::unwrap)
                )
            }
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-elasticache-globalreplicationgroup-regionalconfiguration.html#cfn-elasticache-globalreplicationgroup-regionalconfiguration-reshardingconfigurations)
             */
            override fun reshardingConfigurations(): Any? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RegionalConfigurationProperty
            ): software.amazon.awscdk.services.elasticache.CfnGlobalReplicationGroup.RegionalConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
