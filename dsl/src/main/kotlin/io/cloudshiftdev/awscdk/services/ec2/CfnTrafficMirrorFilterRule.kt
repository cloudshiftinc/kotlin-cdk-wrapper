...
internal constructor(
    ...
    public open fun destinationPortRange(
        `value`: TrafficMirrorPortRangeProperty.Builder.() -> Unit
    ...
    public open fun sourcePortRange(
        `value`: TrafficMirrorPortRangeProperty.Builder.() -> Unit
    ): Unit = sourcePortRange(TrafficMirrorPortRangeProperty(`value`))
    ...
    public interface Builder {
         ...
         *
         * @param destinationCidrBlock The destination CIDR block to assign to the Traffic Mirror
         *   rule.
         */
        ...
        public fun destinationPortRange(
            destinationPortRange: TrafficMirrorPortRangeProperty.Builder.() -> Unit
        )
         ...
         * The number of the Traffic Mirror rule.
         *
         * This number must be unique for each Traffic Mirror rule in a given direction. The rules
        ...
        public fun sourcePortRange(
            sourcePortRange: TrafficMirrorPortRangeProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
        ...
        override fun destinationPortRange(destinationPortRange: TrafficMirrorPortRangeProperty) {
            cdkBuilder.destinationPortRange(
                destinationPortRange.let(TrafficMirrorPortRangeProperty::unwrap)
            )
        }
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnTrafficMirrorFilterRule
    ...
    public interface TrafficMirrorPortRangeProperty {
        ...
        public interface Builder {
            /**
             * @param fromPort The start of the Traffic Mirror port range. This applies to the TCP
             *   and UDP protocols.
             */
            public fun fromPort(fromPort: Number)

            /**
             * @param toPort The end of the Traffic Mirror port range. This applies to the TCP and
             *   UDP protocols.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TrafficMirrorPortRangeProperty
            ): software.amazon.awscdk.services.ec2.CfnTrafficMirrorFilterRule.TrafficMirrorPortRangeProperty =
