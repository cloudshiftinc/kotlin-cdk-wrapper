...
public interface IResource : io.cloudshiftdev.awscdk.IResource {
    ...
    internal constructor(
         ...
         * tell browsers to give a web application running at one origin, access to selected
         * resources from a different origin. A web application executes a cross-origin HTTP request
         * when it requests a resource that has a different origin (domain, protocol, or port) from
         * its own.
         *
         * @param options CORS options.
         * @return a `Method` object
        ...
        override fun addProxy(options: ProxyResourceOptions): ProxyResource =
            unwrap(this)
                .addProxy(options.let(ProxyResourceOptions::unwrap))
                .let(ProxyResource::wrap)
        ...
        override fun addResource(pathPart: String, options: ResourceOptions): Resource =
            unwrap(this)
                .addResource(pathPart, options.let(ResourceOptions::unwrap))
                .let(Resource::wrap)
    ...
    public companion object {
        ...
        ): IResource = Wrapper(cdkObject)

        internal fun unwrap(
            wrapped: IResource
        ): software.amazon.awscdk.services.apigateway.IResource = (wrapped as Wrapper).cdkObject
    }
}
