...
internal constructor(
    ...
    public interface Builder {
         ...
         * A name for the query definition.
         *
         * You can use the name to create a folder structure for your queries. To create a folder,
         * use a forward slash (/) to prefix your desired query name with your desired folder name.
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.logs.CfnQueryDefinition =
            cdkBuilder.build()
    }
