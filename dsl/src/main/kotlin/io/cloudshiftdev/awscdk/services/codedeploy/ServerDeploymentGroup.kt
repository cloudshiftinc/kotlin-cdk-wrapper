...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param application The CodeDeploy EC2/on-premise Application this Deployment Group
         *   belongs to.
         */
         ...
         *
         * [disable-awslint:ref-via-interface] is needed because we update userdata for ASGs to
        ...
        /**
         * All EC2 instances matching the given set of tags when a deployment occurs will be added
        ...
        /**
         * If you've provided any auto-scaling groups with the `#autoScalingGroups` property, you
         * can set this property to add User Data that installs the CodeDeploy agent on the
         * instances.
         *
         * Default: true
         *
         ...
         *
         * @param installAgent If you've provided any auto-scaling groups with the
         *   `#autoScalingGroups` property, you can set this property to add User Data that installs
         *   the CodeDeploy agent on the instances.
         */
         ...
         *
         * Can be created from either a classic Elastic Load Balancer, or an Application Load
         * Balancer / Network Load Balancer Target Group.
         *
         ...
         *
         * Specify either multiple Classic Load Balancers, or Application Load Balancers / Network
         ...
         *
         * @param onPremiseInstanceTags All on-premise instances matching the given set of tags when
         *   a deployment occurs will be added to this Deployment Group.
         */
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.codedeploy.ServerDeploymentGroup.Builder.create(
                scope,
                id
            )
    ...
    public companion object {
        public fun fromServerDeploymentGroupAttributes(
            ...
            software.amazon.awscdk.services.codedeploy.ServerDeploymentGroup
                .fromServerDeploymentGroupAttributes(
                    ...
                    id,
                    attrs.let(ServerDeploymentGroupAttributes::unwrap)
                )
        ...
        public fun fromServerDeploymentGroupAttributes(
            ...
            fromServerDeploymentGroupAttributes(scope, id, ServerDeploymentGroupAttributes(attrs))
