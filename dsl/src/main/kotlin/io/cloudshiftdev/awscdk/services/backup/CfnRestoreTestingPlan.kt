...
internal constructor(
    ...
    public open fun attrRestoreTestingPlanArn(): String =
        unwrap(this).getAttrRestoreTestingPlanArn()
    ...
    public open fun recoveryPointSelection(`value`: RestoreTestingRecoveryPointSelectionProperty) {
        unwrap(this)
            .setRecoveryPointSelection(
                `value`.let(RestoreTestingRecoveryPointSelectionProperty::unwrap)
            )
    }
    ...
    public open fun recoveryPointSelection(
        `value`: RestoreTestingRecoveryPointSelectionProperty.Builder.() -> Unit
    ...
    public interface Builder {
        /**
         * The specified criteria to assign a set of resources, such as recovery point types or
         * backup vaults.
         *
         ...
         *
         * @param recoveryPointSelection The specified criteria to assign a set of resources, such
         *   as recovery point types or backup vaults.
         */
        ...
        public fun recoveryPointSelection(
            recoveryPointSelection: RestoreTestingRecoveryPointSelectionProperty.Builder.() -> Unit
        )
         ...
         *
         * @param scheduleExpression A CRON expression in specified timezone when a restore testing
         *   plan is executed.
         */
         ...
         * doesn't start successfully. This value is optional. If this value is included, this
    ...
    private class BuilderImpl(
         ...
         *   as recovery point types or backup vaults.
         */
        override fun recoveryPointSelection(
            recoveryPointSelection: RestoreTestingRecoveryPointSelectionProperty
        ) {
            cdkBuilder.recoveryPointSelection(
                recoveryPointSelection.let(RestoreTestingRecoveryPointSelectionProperty::unwrap)
            )
        }
        ...
        override fun recoveryPointSelection(
            ...
            recoveryPointSelection(
                RestoreTestingRecoveryPointSelectionProperty(recoveryPointSelection)
            )
    ...
    public interface RestoreTestingRecoveryPointSelectionProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param includeVaults Accepted values include wildcard ["*"] or by specific ARNs or
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-backup-restoretestingplan-restoretestingrecoverypointselection.html#cfn-backup-restoretestingplan-restoretestingrecoverypointselection-excludevaults)
             */
            override fun excludeVaults(): List<String> =
                unwrap(this).getExcludeVaults() ?: emptyList()
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RestoreTestingRecoveryPointSelectionProperty
            ): software.amazon.awscdk.services.backup.CfnRestoreTestingPlan.RestoreTestingRecoveryPointSelectionProperty =
