...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param awsAccountId The identifier of an AWS account in which an environment profile
         *   exists.
         */
         ...
         *
         * @param environmentBlueprintIdentifier The identifier of a blueprint with which an
         ...
         *
         * @param projectIdentifier The identifier of a project in which an environment profile
         *   exists.
         */
