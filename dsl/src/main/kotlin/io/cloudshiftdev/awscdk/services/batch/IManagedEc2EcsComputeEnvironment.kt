...
public interface IManagedEc2EcsComputeEnvironment : IManagedComputeEnvironment {
     ...
     */
    public fun images(): List<EcsMachineImage> =
    ...
    internal constructor(
         ...
         * instance that it launches.
         *
         * Default: - ECS_AL2 compatible AMI ids for non-GPU instances, ECS_AL2_NVIDIA compatible
         * AMI ids for GPU instances
         */
         ...
         * Default: true
         */
        override fun useOptimalInstanceClasses(): Boolean? =
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: IManagedEc2EcsComputeEnvironment
        ): software.amazon.awscdk.services.batch.IManagedEc2EcsComputeEnvironment =
