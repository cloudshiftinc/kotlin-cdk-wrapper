...
internal constructor(
    ...
    public open fun icmp(`value`: IcmpProperty.Builder.() -> Unit): Unit =
        icmp(IcmpProperty(`value`))
    ...
    public interface Builder {
        /**
         * The IPv4 CIDR range to allow or deny, in CIDR notation (for example, 172.16.0.0/24). You
         * must specify an IPv4 CIDR block or an IPv6 CIDR block.
         *
        ...
        /**
         * Whether this rule applies to egress traffic from the subnet ( `true` ) or ingress traffic
         * to the subnet ( `false` ).
         *
         ...
         * Rule number to assign to the entry, such as 100.
         *
         * ACL entries are processed in ascending order by rule number. Entries can't use the same
         * rule number unless one is an egress rule and the other is an ingress rule.
         *
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.ec2.CfnNetworkAclEntry =
            cdkBuilder.build()
    }
    ...
    public interface IcmpProperty {
         ...
         *
         * You can use -1 to specify all ICMP codes for the given ICMP type. Required if you specify
         * 1 (ICMP) for the protocol parameter.
         *
         ...
         *
         * You can use -1 to specify all ICMP types. Conditional requirement: Required if you
         * specify 1 (ICMP) for the `CreateNetworkAclEntry` protocol parameter.
         *
        ...
        public interface Builder {
            /**
             * @param code The Internet Control Message Protocol (ICMP) code. You can use -1 to
             *   specify all ICMP codes for the given ICMP type. Required if you specify 1 (ICMP)
             *   for the protocol parameter.
             */
            public fun code(code: Number)

            /**
             * @param type The Internet Control Message Protocol (ICMP) type. You can use -1 to
             *   specify all ICMP types. Conditional requirement: Required if you specify 1 (ICMP)
             *   for the `CreateNetworkAclEntry` protocol parameter.
             */
        ...
        internal constructor(
             ...
             * The Internet Control Message Protocol (ICMP) code.
             *
             * You can use -1 to specify all ICMP codes for the given ICMP type. Required if you
    ...
    public interface PortRangeProperty {
        ...
        public interface Builder {
            /**
             * @param from The first port in the range. Required if you specify 6 (TCP) or 17 (UDP)
             *   for the protocol parameter.
             */
            public fun from(from: Number)

            /**
             * @param to The last port in the range. Required if you specify 6 (TCP) or 17 (UDP) for
