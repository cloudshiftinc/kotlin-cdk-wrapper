...
internal constructor(
    ...
    /** The HLS manfiests associated with the origin endpoint configuration. */
    public open fun hlsManifests(vararg __idx_ac66f0: Any): Unit =
        hlsManifests(__idx_ac66f0.toList())
    ...
    public interface Builder {
         ...
         *
         * @param containerType The container type associated with the origin endpoint
         *   configuration.
         */
        ...
        /**
         * The size of the window (in seconds) to specify a window of the live stream that's
         ...
         *
         * @param startoverWindowSeconds The size of the window (in seconds) to specify a window of
         *   the live stream that's available for on-demand viewing.
         */
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.mediapackagev2.CfnOriginEndpoint.Builder.create(
                scope,
                id
            )
    ...
    public interface EncryptionMethodProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: EncryptionMethodProperty
            ): software.amazon.awscdk.services.mediapackagev2.CfnOriginEndpoint.EncryptionMethodProperty =
    ...
    public interface FilterConfigurationProperty {
         ...
         *
         * When you include start time, note that you cannot use start time query parameters for
         ...
         *
         * Enter a value that is smaller than your endpoint's startover window. When you include
         * time delay, note that you cannot use time delay query parameters for this manifest's
         * endpoint URL.</p>
         *
        ...
        public interface Builder {
             ...
             *   When you include end time, note that you cannot use end time query parameters for
             *   this manifest's endpoint URL.</p>
             */
             ...
             *   manifest egress requests. When you include a manifest filter, note that you cannot
            ...
            /**
             * @param start Optionally specify the start time for all of your manifest egress
             *   requests. When you include start time, note that you cannot use start time query
             *   parameters for this manifest's endpoint URL.</p>
             */
            public fun start(start: String)

            /**
             * @param timeDelaySeconds Optionally specify the time delay for all of your manifest
             *   egress requests. Enter a value that is smaller than your endpoint's startover
             *   window. When you include time delay, note that you cannot use time delay query
             *   parameters for this manifest's endpoint URL.</p>
             */
        ...
        internal constructor(
             ...
             * filter query parameter for this manifest's endpoint URL.</p>
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-mediapackagev2-originendpoint-filterconfiguration.html#cfn-mediapackagev2-originendpoint-filterconfiguration-manifestfilter)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: FilterConfigurationProperty
            ): software.amazon.awscdk.services.mediapackagev2.CfnOriginEndpoint.FilterConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SpekeKeyProviderProperty {
         ...
         * unique you make this identifier depends on how fine-grained you want access controls to
         * be. The service does not permit you to use the same ID for two simultaneous encryption
         ...
         * provider API.
         *
         * This role must have a trust policy that allows MediaPackage to assume the role, and it
         * must have a sufficient permissions policy to allow access to the specific key retrieval
         * URL. Get this from your DRM solution provider.
         *
        ...
        public interface Builder {
            /**
             * @param drmSystems The DRM solution provider you're using to protect your content
             *   during distribution.
             */
            ...
            /**
             * @param encryptionContractConfiguration The encryption contract configuration
             *   associated with the SPEKE key provider.
             */
            ...
            /**
             * @param resourceId The unique identifier for the content. The service sends this
             *   identifier to the key server to identify the current endpoint. How unique you make
             *   this identifier depends on how fine-grained you want access controls to be. The
             *   service does not permit you to use the same ID for two simultaneous encryption
             *   processes. The resource ID is also known as the content ID.
             *
             * The following example shows a resource ID: `MovieNight20171126093045`
             */
            ...
            /**
             * @param roleArn The ARN for the IAM role granted by the key provider that provides
             *   access to the key provider API. This role must have a trust policy that allows
             *   MediaPackage to assume the role, and it must have a sufficient permissions policy
             *   to allow access to the specific key retrieval URL. Get this from your DRM solution
             *   provider.
             *
             * Valid format: `arn:aws:iam::{accountID}:role/{name}` . The following example shows a
        ...
        private class BuilderImpl : Builder {
             ...
             *   during distribution.
             */
            override fun drmSystems(vararg drmSystems: String): Unit =
                drmSystems(drmSystems.toList())
        ...
        internal constructor(
             ...
             * How unique you make this identifier depends on how fine-grained you want access
             * controls to be. The service does not permit you to use the same ID for two
             * simultaneous encryption processes. The resource ID is also known as the content ID.
             *
             * The following example shows a resource ID: `MovieNight20171126093045`
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-mediapackagev2-originendpoint-spekekeyprovider.html#cfn-mediapackagev2-originendpoint-spekekeyprovider-resourceid)
             ...
             * provider API.
             *
             * This role must have a trust policy that allows MediaPackage to assume the role, and
             * it must have a sufficient permissions policy to allow access to the specific key
    ...
    public interface EncryptionContractConfigurationProperty {
        ...
        /**
         * The SPEKE Version 2.0 preset video associated with the encryption contract configuration
        ...
        public interface Builder {
            ...
            /**
             * @param presetSpeke20Video The SPEKE Version 2.0 preset video associated with the
             *   encryption contract configuration of the origin endpoint.
             */
        ...
        internal constructor(
            ...
            /**
             * The SPEKE Version 2.0 preset video associated with the encryption contract
    ...
    public interface HlsManifestConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param childManifestName The name of the child manifest associated with the HLS
             *   manifest configuration.
             */
            public fun childManifestName(childManifestName: String)

            /**
             * @param filterConfiguration Filter configuration includes settings for manifest
             *   filtering, start and end times, and time delay that apply to all of your egress
            ...
            public fun filterConfiguration(
                filterConfiguration: FilterConfigurationProperty.Builder.() -> Unit
            )
            ...
            /**
             * @param manifestWindowSeconds The duration of the manifest window, in seconds, for the
             *   HLS manifest configuration.
             */
            public fun manifestWindowSeconds(manifestWindowSeconds: Number)

            /**
             * @param programDateTimeIntervalSeconds The `EXT-X-PROGRAM-DATE-TIME` interval, in
             *   seconds, associated with the HLS manifest configuration.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            override fun filterConfiguration(filterConfiguration: FilterConfigurationProperty) {
                cdkBuilder.filterConfiguration(
                    filterConfiguration.let(FilterConfigurationProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("d0aee2c032693bff8484255c2220fc44ce6cb6a02c0f9ebe20ec091ab4fd812a")
            override fun filterConfiguration(
                filterConfiguration: FilterConfigurationProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: HlsManifestConfigurationProperty
            ): software.amazon.awscdk.services.mediapackagev2.CfnOriginEndpoint.HlsManifestConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SegmentProperty {
        ...
        private class BuilderImpl : Builder {
            ...
            override fun includeIframeOnlyStreams(includeIframeOnlyStreams: IResolvable) {
                cdkBuilder.includeIframeOnlyStreams(
                    includeIframeOnlyStreams.let(IResolvable::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("2dfdadafc1cbc1040d7aee7c3c4106e426cdf53444c360acf09caa8bd35ba364")
            override fun scte(scte: ScteProperty.Builder.() -> Unit): Unit =
            ...
            override fun tsUseAudioRenditionGroup(tsUseAudioRenditionGroup: IResolvable) {
                cdkBuilder.tsUseAudioRenditionGroup(
                    tsUseAudioRenditionGroup.let(IResolvable::unwrap)
                )
            }
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-mediapackagev2-originendpoint-segment.html#cfn-mediapackagev2-originendpoint-segment-includeiframeonlystreams)
             */
            override fun includeIframeOnlyStreams(): Any? =
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-mediapackagev2-originendpoint-segment.html#cfn-mediapackagev2-originendpoint-segment-tsuseaudiorenditiongroup)
             */
            override fun tsUseAudioRenditionGroup(): Any? =
    ...
    public interface LowLatencyHlsManifestConfigurationProperty {
         ...
         * MediaPackage uses the default manifest name, `index` . MediaPackage automatically inserts
         * the format extension, such as `.m3u8` . You can't use the same manifest name if you use
         * HLS manifest and low-latency HLS manifest. The `manifestName` on the `HLSManifest` object
         ...
         * manifest. The tags sync the stream to the wall clock so that viewers can seek to a
         * specific time in the playback timeline on the player. `ID3Timed` metadata messages
         * generate every 5 seconds whenever MediaPackage ingests the content.
         *
        ...
        public interface Builder {
            /**
             * @param childManifestName The name of the child manifest associated with the
             *   low-latency HLS (LL-HLS) manifest configuration of the origin endpoint.
             */
            public fun childManifestName(childManifestName: String)
            ...
            /**
             * @param manifestName A short short string that's appended to the endpoint URL. The
             *   manifest name creates a unique path to this endpoint. If you don't enter a value,
             *   MediaPackage uses the default manifest name, `index` . MediaPackage automatically
             *   inserts the format extension, such as `.m3u8` . You can't use the same manifest
             *   name if you use HLS manifest and low-latency HLS manifest. The `manifestName` on
             *   the `HLSManifest` object overrides the `manifestName` you provided on the
             ...
             *   output manifest at the interval that you specify. If you don't enter an interval,
             *   `EXT-X-PROGRAM-DATE-TIME` tags aren't included in the manifest. The tags sync the
             *   stream to the wall clock so that viewers can seek to a specific time in the
             *   playback timeline on the player. `ID3Timed` metadata messages generate every 5
            ...
            /**
             * @param scteHls The SCTE-35 HLS configuration associated with the low-latency HLS
            ...
            /**
             * @param url The URL of the low-latency HLS (LL-HLS) manifest configuration of the
             *   origin endpoint.
             */
            public fun url(url: String)
        }
        ...
        internal constructor(
             ...
             * The manifest name creates a unique path to this endpoint. If you don't enter a value,
             * MediaPackage uses the default manifest name, `index` . MediaPackage automatically
             * inserts the format extension, such as `.m3u8` . You can't use the same manifest name
             * if you use HLS manifest and low-latency HLS manifest. The `manifestName` on the
            ...
            /**
             * The URL of the low-latency HLS (LL-HLS) manifest configuration of the origin
             * endpoint.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-mediapackagev2-originendpoint-lowlatencyhlsmanifestconfiguration.html#cfn-mediapackagev2-originendpoint-lowlatencyhlsmanifestconfiguration-url)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: LowLatencyHlsManifestConfigurationProperty
            ): software.amazon.awscdk.services.mediapackagev2.CfnOriginEndpoint.LowLatencyHlsManifestConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ScteProperty {
        ...
        private class BuilderImpl : Builder {
            ...
            /** @param scteFilter The filter associated with the SCTE-35 configuration. */
            override fun scteFilter(vararg scteFilter: String): Unit =
                scteFilter(scteFilter.toList())
    ...
    public interface EncryptionProperty {
         ...
         * with the key for encrypting content.
         *
         * If you don't specify a value, then MediaPackage creates the constant initialization
         * vector (IV).
         *
        ...
        public interface Builder {
             ...
             *   32-character string, used in conjunction with the key for encrypting content. If
             *   you don't specify a value, then MediaPackage creates the constant initialization
             *   vector (IV).
             */
            ...
            public fun encryptionMethod(
                encryptionMethod: EncryptionMethodProperty.Builder.() -> Unit
            )

            /**
             * @param keyRotationIntervalSeconds The interval, in seconds, to rotate encryption keys
             *   for the origin endpoint.
             */
        ...
        internal constructor(
             ...
             * conjunction with the key for encrypting content.
             *
             * If you don't specify a value, then MediaPackage creates the constant initialization
             * vector (IV).
             *
