...
internal constructor(
    ...
    public override fun bind(
        ...
        unwrap(this)
            .bind(scope.let(Construct::unwrap), handler, family.let(RuntimeFamily::unwrap))
            .let(CodeConfig::wrap)
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.synthetics.AssetCode =
            cdkBuilder.build()
    }
    ...
    public companion object {
        ...
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.synthetics.AssetCode
        ): AssetCode = AssetCode(cdkObject)

        internal fun unwrap(
            wrapped: AssetCode
        ): software.amazon.awscdk.services.synthetics.AssetCode = wrapped.cdkObject
    }
}
