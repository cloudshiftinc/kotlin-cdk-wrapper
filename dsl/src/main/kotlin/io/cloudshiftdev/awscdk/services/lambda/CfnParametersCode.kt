...
internal constructor(
     ...
     * Lambda code, and as values it contains the appropriate expressions pointing at the provided
     * S3 location (most likely, obtained from a CodePipeline Artifact by calling the
     * `artifact.s3Location` method). The result should be provided to the CloudFormation Action
     * that is deploying the Stack that the Lambda with this code is part of, in the
    ...
    public interface Builder {
         ...
         *   Bucket where the Lambda code will be located in.
         */
