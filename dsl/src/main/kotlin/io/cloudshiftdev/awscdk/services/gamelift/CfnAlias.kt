...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param routingStrategy The routing configuration, including routing type and fleet
    ...
    private class BuilderImpl(
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("48db2f8128a66631467a218444363fbda68842721f78cbfaf41860c50d6f2b2b")
        override fun routingStrategy(
            routingStrategy: RoutingStrategyProperty.Builder.() -> Unit
        ): Unit = routingStrategy(RoutingStrategyProperty(routingStrategy))
    ...
    public interface RoutingStrategyProperty {
         ...
         *   message to the user. A terminal alias throws a `TerminalRoutingStrategyException` with
         *   the message that you specified in the `Message` property.
         *
        ...
        public interface Builder {
            /**
             * @param fleetId A unique identifier for a fleet that the alias points to. If you
             *   specify `SIMPLE` for the `Type` property, you must specify this property.
             */
            public fun fleetId(fleetId: String)

            /**
             * @param message The message text to be used with a terminal routing strategy. If you
             *   specify `TERMINAL` for the `Type` property, you must specify this property.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RoutingStrategyProperty
            ): software.amazon.awscdk.services.gamelift.CfnAlias.RoutingStrategyProperty =
