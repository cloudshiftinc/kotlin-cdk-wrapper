...
internal constructor(
    ...
    public open fun accessPolicyIdentity(
        `value`: AccessPolicyIdentityProperty.Builder.() -> Unit
    ...
    public open fun accessPolicyResource(
        `value`: AccessPolicyResourceProperty.Builder.() -> Unit
    ...
    public interface Builder {
        ...
        public fun accessPolicyIdentity(
            accessPolicyIdentity: AccessPolicyIdentityProperty.Builder.() -> Unit
        )
        ...
        public fun accessPolicyResource(
            accessPolicyResource: AccessPolicyResourceProperty.Builder.() -> Unit
        )
    }
    ...
    private class BuilderImpl(
        ...
        override fun accessPolicyIdentity(accessPolicyIdentity: AccessPolicyIdentityProperty) {
            cdkBuilder.accessPolicyIdentity(
                accessPolicyIdentity.let(AccessPolicyIdentityProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("ba0b6288f8d7a538847ec33b15c817454bd77798ebea103e3a02993db166e141")
        override fun accessPolicyIdentity(
            accessPolicyIdentity: AccessPolicyIdentityProperty.Builder.() -> Unit
        ...
        override fun accessPolicyResource(accessPolicyResource: AccessPolicyResourceProperty) {
            cdkBuilder.accessPolicyResource(
                accessPolicyResource.let(AccessPolicyResourceProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("5cea6ccf0d9b11d8e3c96d08f69a5f41cfc124716f241c04562834fed75f4f2d")
        override fun accessPolicyResource(
            accessPolicyResource: AccessPolicyResourceProperty.Builder.() -> Unit
    ...
    public interface AccessPolicyResourceProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AccessPolicyResourceProperty
            ): software.amazon.awscdk.services.iotsitewise.CfnAccessPolicy.AccessPolicyResourceProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface AccessPolicyIdentityProperty {
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("746495a1927bed50c37c06e856341df13539bbd48ade5a8d68215886f6a3f9ec")
            override fun user(user: UserProperty.Builder.() -> Unit): Unit =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AccessPolicyIdentityProperty
            ): software.amazon.awscdk.services.iotsitewise.CfnAccessPolicy.AccessPolicyIdentityProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
