...
internal constructor(
    ...
    public open fun resourceCollectionFilter(`value`: ResourceCollectionFilterProperty) {
        unwrap(this)
            .setResourceCollectionFilter(`value`.let(ResourceCollectionFilterProperty::unwrap))
    }
    ...
    public open fun resourceCollectionFilter(
        `value`: ResourceCollectionFilterProperty.Builder.() -> Unit
    ...
    public interface Builder {
        ...
        public fun resourceCollectionFilter(
            resourceCollectionFilter: ResourceCollectionFilterProperty.Builder.() -> Unit
        )
    }
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.devopsguru.CfnResourceCollection.Builder.create(
                scope,
                id
            )
         ...
         *   resources are analyzed for anomalous behavior by DevOps Guru.
         */
        override fun resourceCollectionFilter(
            resourceCollectionFilter: ResourceCollectionFilterProperty
        ) {
            cdkBuilder.resourceCollectionFilter(
                resourceCollectionFilter.let(ResourceCollectionFilterProperty::unwrap)
            )
        }
        ...
        override fun resourceCollectionFilter(
            ...
            resourceCollectionFilter(ResourceCollectionFilterProperty(resourceCollectionFilter))
    ...
    public interface ResourceCollectionFilterProperty {
         ...
         * [Stacks](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/stacks.html) in
         ...
         * that the resources are related. For example, you can assign the same tag to an Amazon
         * DynamoDB table resource that you assign to an AWS Lambda function. For more information
         * about using tags, see the
         ...
         *   name). Omitting the tag *value* is the same as using an empty string. Like tag *keys* ,
         *   tag *values* are case-sensitive. The tag value is a required property when
         *   AppBoundaryKey is specified.
         *
         ...
         * *key* , the case of characters in the *key* can be whatever you choose. After you create
         * a *key* , it is case-sensitive. For example, DevOps Guru works with a *key* named
         * `devops-guru-rds` and a *key* named `DevOps-Guru-RDS` , and these act as two different
        ...
        public interface Builder {
            /**
             * @param cloudFormation Information about AWS CloudFormation stacks. You can use up to
             *   1000 stacks to specify which AWS resources in your account to analyze. For more
             *   information, see
            ...
            public fun cloudFormation(
                cloudFormation: CloudFormationCollectionFilterProperty.Builder.() -> Unit
            )
             ...
             *   indicate that the resources are related. For example, you can assign the same tag
             *   to an Amazon DynamoDB table resource that you assign to an AWS Lambda function. For
             *   more information about using tags, see the
             *   [Tagging best practices](https://docs.aws.amazon.com/whitepapers/latest/tagging-best-practices/tagging-best-practices.html)
             *   whitepaper.
             *
             * Each AWS tag has two parts.
             ...
             * * A field known as a tag *value* (for example, `111122223333` , `Production` , or a
             *   team name). Omitting the tag *value* is the same as using an empty string. Like tag
             *   *keys* , tag *values* are case-sensitive. The tag value is a required property when
             *   AppBoundaryKey is specified.
             *
             * Together these are known as *key* - *value* pairs.
             *
             * The string used for a *key* in a tag that you use to define your resource coverage
             * must begin with the prefix `Devops-guru-` . The tag *key* might be
             ...
             * After you create a *key* , it is case-sensitive. For example, DevOps Guru works with
             * a *key* named `devops-guru-rds` and a *key* named `DevOps-Guru-RDS` , and these act
        ...
        private class BuilderImpl : Builder {
            ...
            override fun cloudFormation(cloudFormation: CloudFormationCollectionFilterProperty) {
                cdkBuilder.cloudFormation(
                    cloudFormation.let(CloudFormationCollectionFilterProperty::unwrap)
                )
            }
        ...
        internal constructor(
             ...
             * Information about AWS CloudFormation stacks.
             *
             * You can use up to 1000 stacks to specify which AWS resources in your account to
             * analyze. For more information, see
             * [Stacks](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/stacks.html)
             * in the *AWS CloudFormation User Guide* .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-devopsguru-resourcecollection-resourcecollectionfilter.html#cfn-devopsguru-resourcecollection-resourcecollectionfilter-cloudformation)
             ...
             * Tags help you identify and organize your AWS resources. Many AWS services support
             * tagging, so you can assign the same tag to resources from different services to
             * indicate that the resources are related. For example, you can assign the same tag to
             * an Amazon DynamoDB table resource that you assign to an AWS Lambda function. For more
             * information about using tags, see the
             * [Tagging best practices](https://docs.aws.amazon.com/whitepapers/latest/tagging-best-practices/tagging-best-practices.html)
             * whitepaper.
             *
             * Each AWS tag has two parts.
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ResourceCollectionFilterProperty
            ): software.amazon.awscdk.services.devopsguru.CfnResourceCollection.ResourceCollectionFilterProperty =
    ...
    public interface TagCollectionProperty {
         ...
         * `111122223333` , `Production` , or a team name). The *key* and *value* are the tag's
         * *key* pair. Omitting the tag *value* is the same as using an empty string. Like tag
         * *keys* , tag *values* are case-sensitive. You can specify a maximum of 256 characters for
         * a tag value. The tag value is a required property when *AppBoundaryKey* is specified.
         *
        ...
        public interface Builder {
            /**
             * @param appBoundaryKey An AWS tag *key* that is used to identify the AWS resources
             *   that DevOps Guru analyzes. All AWS resources in your account and Region tagged with
             *   this *key* make up your DevOps Guru application and analysis boundary.
             *
             * The string used for a *key* in a tag that you use to define your resource coverage
             * must begin with the prefix `Devops-guru-` . The tag *key* might be
             * `DevOps-Guru-deployment-application` or `devops-guru-rds-application` . When you
            ...
            /**
             * @param tagValues The values in an AWS tag collection. The tag's *value* is a field
             *   used to associate a string with the tag *key* (for example, `111122223333` ,
             *   `Production` , or a team name). The *key* and *value* are the tag's *key* pair.
             *   Omitting the tag *value* is the same as using an empty string. Like tag *keys* ,
             *   tag *values* are case-sensitive. You can specify a maximum of 256 characters for a
             *   tag value. The tag value is a required property when *AppBoundaryKey* is specified.
             */
        ...
        internal constructor(
            ...
            /**
             * An AWS tag *key* that is used to identify the AWS resources that DevOps Guru
             * analyzes.
             *
             * All AWS resources in your account and Region tagged with this *key* make up your
             ...
             * The values in an AWS tag collection.
             *
             * The tag's *value* is a field used to associate a string with the tag *key* (for
             * example, `111122223333` , `Production` , or a team name). The *key* and *value* are
             * the tag's *key* pair. Omitting the tag *value* is the same as using an empty string.
             * Like tag *keys* , tag *values* are case-sensitive. You can specify a maximum of 256
             * characters for a tag value. The tag value is a required property when
             * *AppBoundaryKey* is specified.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-devopsguru-resourcecollection-tagcollection.html#cfn-devopsguru-resourcecollection-tagcollection-tagvalues)
             */
    ...
    public interface CloudFormationCollectionFilterProperty {
        ...
        private class BuilderImpl : Builder {
            ...
            /** @param stackNames An array of CloudFormation stack names. */
            override fun stackNames(vararg stackNames: String): Unit =
                stackNames(stackNames.toList())
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CloudFormationCollectionFilterProperty
            ): software.amazon.awscdk.services.devopsguru.CfnResourceCollection.CloudFormationCollectionFilterProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
