...
public interface ApplicationListenerProps {
     ...
     * HTTPS). A domain name and zone must be also be specified if using HTTPS.
     *
     * Default: ApplicationProtocol.HTTP. If a certificate is specified, the protocol will be set by
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: ApplicationListenerProps
        ): software.amazon.awscdk.services.ecs.patterns.ApplicationListenerProps =
