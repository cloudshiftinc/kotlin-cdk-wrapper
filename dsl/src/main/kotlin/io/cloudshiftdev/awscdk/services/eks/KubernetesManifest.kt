...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * When the resources are created/updated, this manifest will be applied to the cluster
         * through `kubectl apply` and when the resources or the stack is deleted, the resources in
         * the manifest will be deleted through `kubectl delete`.
         *
         * Example:
         * ```
         * List.of(Map.of(
         ...
         *
         * If this is set, we will use `kubectl apply` instead of `kubectl create` when the resource
         * is created. Otherwise, if there is already a resource in the cluster with the same name,
         ...
         *   in the manifest, and there is no way to know that this resource needs to be deleted.
         */
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.eks.KubernetesManifest =
            cdkBuilder.build()
    }
