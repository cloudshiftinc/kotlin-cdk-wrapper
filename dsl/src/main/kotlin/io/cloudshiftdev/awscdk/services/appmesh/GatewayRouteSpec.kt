...
internal constructor(
    ...
    public companion object {
        public fun grpc(options: GrpcGatewayRouteSpecOptions): GatewayRouteSpec =
            software.amazon.awscdk.services.appmesh.GatewayRouteSpec.grpc(
                    options.let(GrpcGatewayRouteSpecOptions::unwrap)
                )
                .let(GatewayRouteSpec::wrap)
        ...
        public fun http(options: HttpGatewayRouteSpecOptions): GatewayRouteSpec =
            software.amazon.awscdk.services.appmesh.GatewayRouteSpec.http(
                    options.let(HttpGatewayRouteSpecOptions::unwrap)
                )
                .let(GatewayRouteSpec::wrap)
        ...
        public fun http2(options: HttpGatewayRouteSpecOptions): GatewayRouteSpec =
            software.amazon.awscdk.services.appmesh.GatewayRouteSpec.http2(
                    options.let(HttpGatewayRouteSpecOptions::unwrap)
                )
                .let(GatewayRouteSpec::wrap)
        ...
        public fun http2(
            options: HttpGatewayRouteSpecOptions.Builder.() -> Unit
