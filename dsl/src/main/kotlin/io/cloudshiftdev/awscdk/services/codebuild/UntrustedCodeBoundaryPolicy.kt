...
internal constructor(
     ...
     * [io.cloudshiftdev.awscdk.services.codebuild.UntrustedCodeBoundaryPolicy].
     */
    @CdkDslMarker
    public interface Builder {
         ...
         *
         * @param additionalStatements Additional statements to add to the default set of
         *   statements.
         */
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.codebuild.UntrustedCodeBoundaryPolicy.Builder.create(
                scope,
                id
            )
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: UntrustedCodeBoundaryPolicy
