...
internal constructor(
    ...
    public interface Builder {
        ...
        public fun cacheBehaviorSettings(
            cacheBehaviorSettings: CacheSettingsProperty.Builder.() -> Unit
        )
         ...
         *
         * @param cacheBehaviors An array of objects that describe the per-path cache behavior of
         *   the distribution.
         */
        ...
        public fun defaultCacheBehavior(
            defaultCacheBehavior: CacheBehaviorProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
        ...
        override fun cacheBehaviorSettings(cacheBehaviorSettings: CacheSettingsProperty) {
            cdkBuilder.cacheBehaviorSettings(
                cacheBehaviorSettings.let(CacheSettingsProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("f7be9dd6a199c12d315ac62758530f6e3c1deceb2b119cf1bda341cc3fe6eeb1")
        override fun cacheBehaviorSettings(
            cacheBehaviorSettings: CacheSettingsProperty.Builder.() -> Unit
    ...
    public interface CacheBehaviorProperty {
         ...
         *   websites that don't use cookies, headers, or query strings to personalize content.
         ...
         *   specified in the distribution’s `CacheBehaviorPerPath` parameter. This behavior is
         *   ideal for websites or web applications that use cookies, headers, and query strings to
        ...
        public interface Builder {
            /**
             * @param behavior The cache behavior of the distribution. The following cache behaviors
             *   can be specified:
             * * *`cache`* - This option is best for static sites. When specified, your distribution
             *   caches and serves your entire website as static content. This behavior is ideal for
             *   websites with static content that doesn't change depending on who views it, or for
             ...
             *   dynamic content. When specified, your distribution caches and serves only the
             *   content that is specified in the distribution’s `CacheBehaviorPerPath` parameter.
             *   This behavior is ideal for websites or web applications that use cookies, headers,
             *   and query strings to personalize content for individual users.
             */
    ...
    public interface CookieObjectProperty {
         ...
         */
        public fun cookiesAllowList(): List<String> =
            unwrap(this).getCookiesAllowList() ?: emptyList()
        ...
        public interface Builder {
            /**
             * @param cookiesAllowList The specific cookies to forward to your distribution's
             *   origin.
             */
            ...
            /**
             * @param option Specifies which cookies to forward to the distribution's origin for a
             *   cache behavior. Use one of the following configurations for your distribution:
             * * *`all`* - Forwards all cookies to your origin.
             * * *`none`* - Doesn’t forward cookies to your origin.
             * * *`allow-list`* - Forwards only the cookies that you specify using the
             *   `CookiesAllowList` parameter.
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-lightsail-distribution-cookieobject.html#cfn-lightsail-distribution-cookieobject-cookiesallowlist)
             */
            override fun cookiesAllowList(): List<String> =
                unwrap(this).getCookiesAllowList() ?: emptyList()
    ...
    public interface HeaderObjectProperty {
         ...
         */
        public fun headersAllowList(): List<String> =
            unwrap(this).getHeadersAllowList() ?: emptyList()
        ...
        public interface Builder {
            /**
             * @param headersAllowList The specific headers to forward to your distribution's
             *   origin.
             */
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-lightsail-distribution-headerobject.html#cfn-lightsail-distribution-headerobject-headersallowlist)
             */
            override fun headersAllowList(): List<String> =
                unwrap(this).getHeadersAllowList() ?: emptyList()
    ...
    public interface CacheSettingsProperty {
         ...
         *
         * If you specify `GET,HEAD,OPTIONS,PUT,PATCH,POST,DELETE` , you might need to restrict
         * access to your distribution's origin so users can't perform operations that you don't
         * want them to. For example, you might not want users to have permission to delete objects
         * from your origin.
         *
        ...
        public interface Builder {
             ...
             * If you specify `GET,HEAD,OPTIONS,PUT,PATCH,POST,DELETE` , you might need to restrict
             * access to your distribution's origin so users can't perform operations that you don't
             * want them to. For example, you might not want users to have permission to delete
             * objects from your origin.
             */
            public fun allowedHttpMethods(allowedHttpMethods: String)

            /**
             * @param cachedHttpMethods The HTTP method responses that are cached by your
             *   distribution. You can specify the following options:
             * * `GET,HEAD` - The distribution caches responses to the `GET` and `HEAD` methods.
             * * `GET,HEAD,OPTIONS` - The distribution caches responses to the `GET` , `HEAD` , and
             *   `OPTIONS` methods.
             */
            ...
            /**
             * @param defaultTtl The default amount of time that objects stay in the distribution's
             *   cache before the distribution forwards another request to the origin to determine
            ...
            /**
             * @param forwardedCookies An object that describes the cookies that are forwarded to
             *   the origin. Your content is cached based on the cookies that are forwarded.
             */
            ...
            /**
             * @param forwardedHeaders An object that describes the headers that are forwarded to
             *   the origin. Your content is cached based on the headers that are forwarded.
             */
            ...
            /**
             * @param forwardedQueryStrings An object that describes the query strings that are
             *   forwarded to the origin. Your content is cached based on the query strings that are
             *   forwarded.
             */
            ...
            public fun forwardedQueryStrings(
                forwardedQueryStrings: QueryStringObjectProperty.Builder.() -> Unit
            )

            /**
             * @param maximumTtl The maximum amount of time that objects stay in the distribution's
             *   cache before the distribution forwards another request to the origin to determine
            ...
            /**
             * @param minimumTtl The minimum amount of time that objects stay in the distribution's
             *   cache before the distribution forwards another request to the origin to determine
             *   whether the object has been updated. A value of `0` must be specified for
             *   `minimumTTL` if the distribution is configured to forward all headers to the
             *   origin.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("1c922e547404c44d6e645910173c087833c3a63b46c3df390f032d632e93db26")
            override fun forwardedCookies(
                forwardedCookies: CookieObjectProperty.Builder.() -> Unit
            ): Unit = forwardedCookies(CookieObjectProperty(forwardedCookies))
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("d8c5e4bf40216dbcd990d823b98baa309d58f4960b0737400d37c0f8bf7963d8")
            override fun forwardedHeaders(
                forwardedHeaders: HeaderObjectProperty.Builder.() -> Unit
            ): Unit = forwardedHeaders(HeaderObjectProperty(forwardedHeaders))
            ...
            override fun forwardedQueryStrings(forwardedQueryStrings: QueryStringObjectProperty) {
                cdkBuilder.forwardedQueryStrings(
                    forwardedQueryStrings.let(QueryStringObjectProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("5cfe764aaa9a7c09e6074777153751f674301feab5a38748d2705ee804d4b307")
            override fun forwardedQueryStrings(
                forwardedQueryStrings: QueryStringObjectProperty.Builder.() -> Unit
    ...
    public interface QueryStringObjectProperty {
         ...
         */
        public fun queryStringsAllowList(): List<String> =
        ...
        public interface Builder {
            ...
            /**
             * @param queryStringsAllowList The specific query strings that the distribution
             *   forwards to the origin. Your distribution caches content based on the specified
             *   query strings.
             *
             * If the `option` parameter is true, then your distribution forwards all query strings,
             * regardless of what you specify using the `QueryStringsAllowList` parameter.
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-lightsail-distribution-querystringobject.html#cfn-lightsail-distribution-querystringobject-querystringsallowlist)
             */
            override fun queryStringsAllowList(): List<String> =
                unwrap(this).getQueryStringsAllowList() ?: emptyList()
        }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: QueryStringObjectProperty
            ): software.amazon.awscdk.services.lightsail.CfnDistribution.QueryStringObjectProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CacheBehaviorPerPathProperty {
         ...
         *
         * Specify the following to cache all files in the images subdirectory of the document root
        ...
        public interface Builder {
            /**
             * @param behavior The cache behavior for the specified path. You can specify one of the
            ...
            /**
             * @param path The path to a directory or file to cache, or not cache. Use an asterisk
             ...
             * `var/www/html/images/ *.gif`
             *
             * Specify the following to cache all files in the images subdirectory of the document
        ...
        internal constructor(
             ...
             * The path to a directory or file to cache, or not cache.
             *
             * Use an asterisk symbol to specify wildcard directories ( `path/to/assets/ *` ), and
             * file types ( `*.html` , `*jpg` , `*js` ). Directories and file paths are
             * case-sensitive.
             *
             * Examples:
             * * Specify the following to cache all files in the document root of an Apache web
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CacheBehaviorPerPathProperty
            ): software.amazon.awscdk.services.lightsail.CfnDistribution.CacheBehaviorPerPathProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
