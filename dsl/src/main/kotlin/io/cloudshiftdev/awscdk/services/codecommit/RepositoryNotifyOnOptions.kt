...
public interface RepositoryNotifyOnOptions : NotificationRuleOptions {
    ...
    public interface Builder {
         ...
         *   repositories. For a complete list of event types and IDs, see Notification concepts in
    ...
    private class BuilderImpl : Builder {
         ...
         *   the Developer Tools Console User Guide.
         */
        override fun events(vararg events: RepositoryNotificationEvents): Unit =
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: RepositoryNotifyOnOptions
        ): software.amazon.awscdk.services.codecommit.RepositoryNotifyOnOptions =
