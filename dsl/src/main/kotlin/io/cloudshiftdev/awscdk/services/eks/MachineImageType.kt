...
public enum class MachineImageType(
  ...
  public companion object {
    internal fun wrap(cdkObject: software.amazon.awscdk.services.eks.MachineImageType):
        MachineImageType = when (cdkObject) {
    ...
    internal fun unwrap(wrapped: MachineImageType):
