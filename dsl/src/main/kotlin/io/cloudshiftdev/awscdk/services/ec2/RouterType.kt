...
public enum class RouterType(
  ...
  EGRESS_ONLY_INTERNET_GATEWAY(software.amazon.awscdk.services.ec2.RouterType.EGRESS_ONLY_INTERNET_GATEWAY),
  ...
  public companion object {
    internal fun wrap(cdkObject: software.amazon.awscdk.services.ec2.RouterType): RouterType = when
        (cdkObject) {
      software.amazon.awscdk.services.ec2.RouterType.CARRIER_GATEWAY -> RouterType.CARRIER_GATEWAY
      ...
      software.amazon.awscdk.services.ec2.RouterType.LOCAL_GATEWAY -> RouterType.LOCAL_GATEWAY
      ...
      software.amazon.awscdk.services.ec2.RouterType.TRANSIT_GATEWAY -> RouterType.TRANSIT_GATEWAY
      software.amazon.awscdk.services.ec2.RouterType.VPC_PEERING_CONNECTION ->
          RouterType.VPC_PEERING_CONNECTION
      software.amazon.awscdk.services.ec2.RouterType.VPC_ENDPOINT -> RouterType.VPC_ENDPOINT
    }
