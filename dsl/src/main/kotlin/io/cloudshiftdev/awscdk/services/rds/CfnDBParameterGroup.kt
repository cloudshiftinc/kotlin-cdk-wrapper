...
internal constructor(
    ...
    public interface Builder {
         ...
         * The DB parameter group family name.
         *
         * A DB parameter group can be associated with one and only one DB parameter group family,
         * and can be applied only to a DB instance running a DB engine and engine version
         ...
         * An array of parameter names and values for the parameter update.
         *
         * At least one parameter name and value must be supplied. Subsequent arguments are
         * optional.
         *
         * RDS for Db2 requires you to bring your own Db2 license. You must enter your IBM customer
         * ID ( `rds.ibm_customer_id` ) and site number ( `rds.ibm_site_id` ) before starting a Db2
         * instance.
         *
         * For more information about DB parameters and DB parameter groups for Amazon RDS DB
         * engines, see
         ...
         * parameter. The default apply method for each parameter is used.
         *
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.rds.CfnDBParameterGroup =
            cdkBuilder.build()
    }
