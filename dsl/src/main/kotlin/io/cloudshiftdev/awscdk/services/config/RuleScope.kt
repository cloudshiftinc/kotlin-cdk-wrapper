...
internal constructor(
    ...
    public companion object {
        public fun fromResource(resourceType: ResourceType): RuleScope =
            software.amazon.awscdk.services.config.RuleScope.fromResource(
                    resourceType.let(ResourceType::unwrap)
                )
                .let(RuleScope::wrap)
        ...
        public fun fromResources(resourceTypes: List<ResourceType>): RuleScope =
            software.amazon.awscdk.services.config.RuleScope.fromResources(
                    resourceTypes.map(ResourceType::unwrap)
                )
                .let(RuleScope::wrap)
        ...
        public fun fromTag(key: String, `value`: String): RuleScope =
            software.amazon.awscdk.services.config.RuleScope.fromTag(key, `value`)
                .let(RuleScope::wrap)
