...
public enum class LifecycleTransition(
    ...
    public companion object {
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.autoscaling.LifecycleTransition
        ): LifecycleTransition =
            when (cdkObject) {
                software.amazon.awscdk.services.autoscaling.LifecycleTransition
                    .INSTANCE_LAUNCHING -> LifecycleTransition.INSTANCE_LAUNCHING
                software.amazon.awscdk.services.autoscaling.LifecycleTransition
                    .INSTANCE_TERMINATING -> LifecycleTransition.INSTANCE_TERMINATING
            }

        internal fun unwrap(
            wrapped: LifecycleTransition
