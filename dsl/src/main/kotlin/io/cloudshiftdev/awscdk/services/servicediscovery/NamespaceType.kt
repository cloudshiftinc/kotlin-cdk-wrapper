...
public enum class NamespaceType(
    ...
    public companion object {
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.servicediscovery.NamespaceType
        ): NamespaceType =
            when (cdkObject) {
                software.amazon.awscdk.services.servicediscovery.NamespaceType.HTTP ->
                    NamespaceType.HTTP
