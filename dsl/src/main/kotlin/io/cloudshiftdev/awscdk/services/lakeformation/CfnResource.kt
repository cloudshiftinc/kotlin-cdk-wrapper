...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.lakeformation.CfnResource,
    ...
    public interface Builder {
        /**
         * Indicates whether the data access of tables pointing to the location can be managed by
         * both Lake Formation permissions as well as Amazon S3 bucket policies.
         *
         ...
         *
         * @param withFederation Allows Lake Formation to assume a role to access tables in a
         *   federated database.
         */
