...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * When a mobile or web app registers with an OpenID Connect provider, they establish a
         * value that identifies the application. (This is the value that's sent as the client_id
         ...
         * provider's server certificates.
         *
         * Typically this list includes only one entry. However, IAM lets you have up to five
         * thumbprints for an OIDC provider. This lets you maintain multiple thumbprints if the
         ...
         * https://keys.server.example.com/openid-connect. In that case, the thumbprint string would
         * be the hex-encoded SHA-1 hash value of the certificate used by
         * https://keys.server.example.com.
         *
         * Default: - If no thumbprints are specified (an empty array or `undefined`), the
         * thumbprint of the root certificate authority will be obtained from the provider's server
         * as described in
    ...
    private class BuilderImpl(
         ...
         *   identity provider's server certificates.
         */
        override fun thumbprints(vararg thumbprints: String): Unit =
            thumbprints(thumbprints.toList())
    ...
    public companion object {
        public fun fromOpenIdConnectProviderArn(
            ...
            software.amazon.awscdk.services.iam.OpenIdConnectProvider.fromOpenIdConnectProviderArn(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    openIdConnectProviderArn
                )
                .let(IOpenIdConnectProvider::wrap)
