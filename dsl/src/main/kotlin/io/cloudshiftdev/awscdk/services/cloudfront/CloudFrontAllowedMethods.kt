...
public enum class CloudFrontAllowedMethods(
    ...
    public companion object {
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.cloudfront.CloudFrontAllowedMethods
