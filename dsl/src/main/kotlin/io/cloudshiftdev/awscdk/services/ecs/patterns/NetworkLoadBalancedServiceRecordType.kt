...
public enum class NetworkLoadBalancedServiceRecordType(
    ...
    public companion object {
        internal fun wrap(
            ...
            when (cdkObject) {
                software.amazon.awscdk.services.ecs.patterns.NetworkLoadBalancedServiceRecordType
                    .ALIAS -> NetworkLoadBalancedServiceRecordType.ALIAS
                software.amazon.awscdk.services.ecs.patterns.NetworkLoadBalancedServiceRecordType
                    .CNAME -> NetworkLoadBalancedServiceRecordType.CNAME
                software.amazon.awscdk.services.ecs.patterns.NetworkLoadBalancedServiceRecordType
                    .NONE -> NetworkLoadBalancedServiceRecordType.NONE
            }

        internal fun unwrap(
            wrapped: NetworkLoadBalancedServiceRecordType
        ): software.amazon.awscdk.services.ecs.patterns.NetworkLoadBalancedServiceRecordType =
            wrapped.cdkObject
    }
}
