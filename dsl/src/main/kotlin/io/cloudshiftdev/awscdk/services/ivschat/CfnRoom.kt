...
internal constructor(
    ...
    public open fun messageReviewHandler(
        `value`: MessageReviewHandlerProperty.Builder.() -> Unit
    ...
    public interface Builder {
         ...
         *
         * @param loggingConfigurationIdentifiers List of logging-configuration identifiers attached
         *   to the room.
         */
         ...
         *
         * @param maximumMessageRatePerSecond Maximum number of messages per second that can be sent
         *   to the room (by all clients).
         */
        ...
        public fun messageReviewHandler(
            messageReviewHandler: MessageReviewHandlerProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
         ...
         *   to the room.
         */
        override fun loggingConfigurationIdentifiers(
         ...
         */
        override fun loggingConfigurationIdentifiers(
            vararg loggingConfigurationIdentifiers: String
        ...
        override fun messageReviewHandler(messageReviewHandler: MessageReviewHandlerProperty) {
            cdkBuilder.messageReviewHandler(
                messageReviewHandler.let(MessageReviewHandlerProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("3e81b16974c7ad0a6acdf5a37615c7459552040bc7b0daa1c70fc56505d6925b")
        override fun messageReviewHandler(
            messageReviewHandler: MessageReviewHandlerProperty.Builder.() -> Unit
    ...
    public interface MessageReviewHandlerProperty {
        ...
        public interface Builder {
             ...
             *   or denied) if the handler does not return a valid response, encounters an error, or
             *   times out. (For the timeout period, see
             *   [Service Quotas](https://docs.aws.amazon.com/ivs/latest/userguide/service-quotas.html)
            ...
            /**
             * @param uri Identifier of the message review handler. Currently this must be an ARN of
             *   a lambda function.
             */
        ...
        internal constructor(
             ...
             * handler does not return a valid response, encounters an error, or times out.
             *
             * (For the timeout period, see
             * [Service Quotas](https://docs.aws.amazon.com/ivs/latest/userguide/service-quotas.html)
             * .) If allowed, the message is delivered with returned content to all users connected
             * to the room. If denied, the message is not delivered to any user.
             *
             * *Default* : `ALLOW`
             *
             * Default: - "ALLOW"
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: MessageReviewHandlerProperty
            ): software.amazon.awscdk.services.ivschat.CfnRoom.MessageReviewHandlerProperty =
