...
internal constructor(
    ...
    public companion object {
        public fun fromSecretsManager(secret: ISecret): Secret =
            software.amazon.awscdk.services.batch.Secret.fromSecretsManager(
        ...
        public fun fromSecretsManagerVersion(
            ...
            software.amazon.awscdk.services.batch.Secret.fromSecretsManagerVersion(
                    secret.let(ISecret::unwrap),
                    versionInfo.let(SecretVersionInfo::unwrap)
                )
                .let(Secret::wrap)
        ...
        public fun fromSecretsManagerVersion(
            secret: ISecret,
            versionInfo: SecretVersionInfo.Builder.() -> Unit
        ): Secret = fromSecretsManagerVersion(secret, SecretVersionInfo(versionInfo))
        ...
        public fun fromSsmParameter(parameter: IParameter): Secret =
            software.amazon.awscdk.services.batch.Secret.fromSsmParameter(
        ...
        internal fun unwrap(wrapped: Secret): software.amazon.awscdk.services.batch.Secret =
