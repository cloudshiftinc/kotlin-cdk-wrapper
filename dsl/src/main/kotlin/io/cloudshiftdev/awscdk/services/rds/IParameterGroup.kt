...
public interface IParameterGroup : IResource {
     ...
     * @param key
     * @param value
     * @return true if the parameter was actually added (i.e., this ParameterGroup is not imported),
     *   false otherwise
     */
    ...
    public fun bindToCluster(
        options: ParameterGroupClusterBindOptions.Builder.() -> Unit
    ...
    public fun bindToInstance(
        options: ParameterGroupInstanceBindOptions.Builder.() -> Unit
    ): ParameterGroupInstanceConfig
    ...
    internal constructor(
         ...
         * @param key
         * @param value
         * @return true if the parameter was actually added (i.e., this ParameterGroup is not
        ...
        override fun bindToCluster(
            ...
            unwrap(this)
                .bindToCluster(options.let(ParameterGroupClusterBindOptions::unwrap))
        ...
        override fun bindToInstance(
            ...
            unwrap(this)
                .bindToInstance(options.let(ParameterGroupInstanceBindOptions::unwrap))
