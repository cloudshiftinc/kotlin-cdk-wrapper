...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param signingProfiles List of signing profiles that defines a trusted user who can sign
         *   a code package.
         */
    ...
    private class BuilderImpl(
         ...
         *   validation failure.
         */
        override fun untrustedArtifactOnDeployment(
            untrustedArtifactOnDeployment: UntrustedArtifactOnDeployment
        ) {
            cdkBuilder.untrustedArtifactOnDeployment(
                untrustedArtifactOnDeployment.let(UntrustedArtifactOnDeployment::unwrap)
            )
        }
    ...
    public companion object {
        public fun fromCodeSigningConfigArn(
            ...
            software.amazon.awscdk.services.lambda.CodeSigningConfig.fromCodeSigningConfigArn(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    codeSigningConfigArn
                )
                .let(ICodeSigningConfig::wrap)
