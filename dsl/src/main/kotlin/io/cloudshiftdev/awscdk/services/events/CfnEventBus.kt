...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param eventSourceName If you are creating a partner event bus, this specifies the
         ...
         *
         * @param policy The permissions policy of the event bus, describing which other AWS
    ...
    public companion object {
        ...
        ): CfnEventBus = CfnEventBus(cdkObject)

        internal fun unwrap(
            wrapped: CfnEventBus
        ): software.amazon.awscdk.services.events.CfnEventBus = wrapped.cdkObject
    }
}
