...
public interface ISecurityGroup : IResource, IPeer {
    ...
    internal constructor(
         ...
         * securityGroup and they are in different stack. If false (default) the rule object is
         * created under the current SecurityGroup object. If true and the peer is also a
         * SecurityGroup, the rule object is created under the remote SecurityGroup object.
         *
         * @param peer
         * @param connection
         * @param description
    ...
    public companion object {
        ...
        ): ISecurityGroup = Wrapper(cdkObject)

        internal fun unwrap(
            wrapped: ISecurityGroup
        ): software.amazon.awscdk.services.ec2.ISecurityGroup = (wrapped as Wrapper).cdkObject
    }
}
