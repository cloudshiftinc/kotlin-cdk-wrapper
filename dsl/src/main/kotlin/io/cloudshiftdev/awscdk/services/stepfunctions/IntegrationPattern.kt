...
public enum class IntegrationPattern(
    ...
    public companion object {
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.stepfunctions.IntegrationPattern
        ): IntegrationPattern =
            when (cdkObject) {
                software.amazon.awscdk.services.stepfunctions.IntegrationPattern.REQUEST_RESPONSE ->
                ...
                software.amazon.awscdk.services.stepfunctions.IntegrationPattern
                    .WAIT_FOR_TASK_TOKEN -> IntegrationPattern.WAIT_FOR_TASK_TOKEN
            }

        internal fun unwrap(
            wrapped: IntegrationPattern
