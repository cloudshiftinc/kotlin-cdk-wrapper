...
internal constructor(
    ...
    public open fun autoScalingGroupProvider(`value`: AutoScalingGroupProviderProperty) {
        unwrap(this)
            .setAutoScalingGroupProvider(`value`.let(AutoScalingGroupProviderProperty::unwrap))
    }

    /** The Auto Scaling group settings for the capacity provider. */
    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("a09c71815f1b32891bb321b5a27de0167df5db0db904175466e47c9341c7c097")
    public open fun autoScalingGroupProvider(
        `value`: AutoScalingGroupProviderProperty.Builder.() -> Unit
    ...
    public interface Builder {
         ...
         *
         * @param autoScalingGroupProvider The Auto Scaling group settings for the capacity
         *   provider.
         */
        ...
        public fun autoScalingGroupProvider(
            autoScalingGroupProvider: AutoScalingGroupProviderProperty.Builder.() -> Unit
        )
         ...
         * specified, a default name in the `CFNStackName-CFNResourceName-RandomString` format is
         * used.
         *
         ...
         *
         * @param tags The metadata that you apply to the capacity provider to help you categorize
         *   and organize it.
         */
    ...
    private class BuilderImpl(
         ...
         *   provider.
         */
        override fun autoScalingGroupProvider(
            autoScalingGroupProvider: AutoScalingGroupProviderProperty
        ) {
            cdkBuilder.autoScalingGroupProvider(
                autoScalingGroupProvider.let(AutoScalingGroupProviderProperty::unwrap)
            )
        }
        ...
        override fun autoScalingGroupProvider(
            ...
            autoScalingGroupProvider(AutoScalingGroupProviderProperty(autoScalingGroupProvider))
        ...
        public fun build(): software.amazon.awscdk.services.ecs.CfnCapacityProvider =
            cdkBuilder.build()
    }
    ...
    public interface ManagedScalingProperty {
         ...
         * Amazon EC2 instance type or Availability Zone, Amazon ECS will scale up by the exact
         * minimum scaling step size value and will ignore both the maximum scaling step size as
         * well as the capacity demand.
         *
         ...
         *
         * The specified value must be greater than `0` and less than or equal to `100` . For
         * example, if you want the capacity provider to maintain 10% spare capacity, then that
        ...
        public interface Builder {
            /**
             * @param instanceWarmupPeriod The period of time, in seconds, after a newly launched
             *   Amazon EC2 instance can contribute to CloudWatch metrics for Auto Scaling group. If
            ...
            /**
             * @param maximumScalingStepSize The maximum number of Amazon EC2 instances that Amazon
             *   ECS will scale out at one time. The scale in process is not affected by this
             *   parameter. If this parameter is omitted, the default value of `10000` is used.
             */
            public fun maximumScalingStepSize(maximumScalingStepSize: Number)

            /**
             * @param minimumScalingStepSize The minimum number of Amazon EC2 instances that Amazon
             *   ECS will scale out at one time. The scale in process is not affected by this
             *   parameter If this parameter is omitted, the default value of `1` is used.
             *
            ...
            /**
             * @param targetCapacity The target capacity utilization as a percentage for the
             *   capacity provider. The specified value must be greater than `0` and less than or
             *   equal to `100` . For example, if you want the capacity provider to maintain 10%
             *   spare capacity, then that means the utilization is 90%, so use a `targetCapacity`
             *   of `90` . The default value of `100` percent results in the Amazon EC2 instances in
             *   your Auto Scaling group being completely used.
             */
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ecs-capacityprovider-managedscaling.html#cfn-ecs-capacityprovider-managedscaling-maximumscalingstepsize)
             */
            override fun maximumScalingStepSize(): Number? =
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ecs-capacityprovider-managedscaling.html#cfn-ecs-capacityprovider-managedscaling-minimumscalingstepsize)
             */
            override fun minimumScalingStepSize(): Number? =
             ...
             * The specified value must be greater than `0` and less than or equal to `100` . For
             * example, if you want the capacity provider to maintain 10% spare capacity, then that
             * means the utilization is 90%, so use a `targetCapacity` of `90` . The default value
             * of `100` percent results in the Amazon EC2 instances in your Auto Scaling group being
             * completely used.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ecs-capacityprovider-managedscaling.html#cfn-ecs-capacityprovider-managedscaling-targetcapacity)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ManagedScalingProperty
            ): software.amazon.awscdk.services.ecs.CfnCapacityProvider.ManagedScalingProperty =
    ...
    public interface AutoScalingGroupProviderProperty {
        ...
        public interface Builder {
            /**
             * @param autoScalingGroupArn The Amazon Resource Name (ARN) that identifies the Auto
             *   Scaling group, or the Auto Scaling group name.
             */
            public fun autoScalingGroupArn(autoScalingGroupArn: String)

            /**
             * @param managedDraining The managed draining option for the Auto Scaling group
             *   capacity provider. When you enable this, Amazon ECS manages and gracefully drains
             *   the EC2 container instances that are in the Auto Scaling group capacity provider.
             */
            public fun managedDraining(managedDraining: String)

            /**
             * @param managedScaling The managed scaling settings for the Auto Scaling group
             *   capacity provider.
             */
            ...
            /**
             * @param managedTerminationProtection The managed termination protection setting to use
             *   for the Auto Scaling group capacity provider. This determines whether the Auto
             *   Scaling group has managed termination protection. The default is off.
             *
             ...
             * scale-in action. The Auto Scaling group and each instance in the Auto Scaling group
             * must have instance protection from scale-in actions on as well. For more information,
             * see
             * [Instance Protection](https://docs.aws.amazon.com/autoscaling/ec2/userguide/as-instance-termination.html#instance-protection)
             * in the *AWS Auto Scaling User Guide* .
             *
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("44931cd342e50c37549dae89b6cbbe6b4f5f8ec40770076d154685503c77bd15")
            override fun managedScaling(
                managedScaling: ManagedScalingProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AutoScalingGroupProviderProperty
            ): software.amazon.awscdk.services.ecs.CfnCapacityProvider.AutoScalingGroupProviderProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
