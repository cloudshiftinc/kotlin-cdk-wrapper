...
internal constructor(
    ...
    public interface Builder {
         ...
         * Specify users that should always be served a specific variation of a feature.
         *
         * Each user is specified by a key-value pair . For each key, specify a user by entering
         * their user ID, account ID, or some other identifier. For the value, specify the name of
         ...
         *
         * @param entityOverrides Specify users that should always be served a specific variation of
         *   a feature.
         */
        ...
        /**
         * Specify `ALL_RULES` to activate the traffic allocation specified by any ongoing launches
         * or experiments.
         *
         ...
         *
         * @param evaluationStrategy Specify `ALL_RULES` to activate the traffic allocation
         *   specified by any ongoing launches or experiments.
         */
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.evidently.CfnFeature =
            cdkBuilder.build()
    }
    ...
    public companion object {
        ...
        ): CfnFeature = CfnFeature(cdkObject)

        internal fun unwrap(
            wrapped: CfnFeature
        ): software.amazon.awscdk.services.evidently.CfnFeature = wrapped.cdkObject
    }
    ...
    public interface EntityOverrideProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param variation The name of the variation to serve to the user session that matches
             *   the `EntityId` .
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: EntityOverrideProperty
            ): software.amazon.awscdk.services.evidently.CfnFeature.EntityOverrideProperty =
    ...
    public interface VariationObjectProperty {
        ...
        public interface Builder {
            /**
             * @param booleanValue The value assigned to this variation, if the variation type is
             *   boolean.
             */
            ...
            /**
             * @param doubleValue The value assigned to this variation, if the variation type is a
             *   double.
             */
            public fun doubleValue(doubleValue: Number)

            /**
             * @param longValue The value assigned to this variation, if the variation type is a
             *   long.
             */
            public fun longValue(longValue: Number)

            /**
             * @param stringValue The value assigned to this variation, if the variation type is a
             *   string.
             */
            public fun stringValue(stringValue: String)

            /**
             * @param variationName A name for the variation. It can include up to 127 characters.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: VariationObjectProperty
            ): software.amazon.awscdk.services.evidently.CfnFeature.VariationObjectProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
