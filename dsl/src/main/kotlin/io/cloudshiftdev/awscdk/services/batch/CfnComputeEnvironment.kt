...
internal constructor(
     ...
     */
    public open fun attrComputeEnvironmentArn(): String =
        unwrap(this).getAttrComputeEnvironmentArn()
    ...
    public interface Builder {
         ...
         * The name for your compute environment.
         *
         * It can be up to 128 characters long. It can contain uppercase and lowercase letters,
         ...
         *
         * @param computeResources The ComputeResources property type specifies details of the
         *   compute resources managed by the compute environment.
         */
         ...
         * replacing the instances in the compute environment.
         *
         * The default value is `true` . To enable more properties to be updated, set this property
         * to `false` . When changing the value of this property to `false` , do not change any
         * other properties at the same time. If other properties are changed at the same time, and
         * the change needs to be rolled back but it can't, it's possible for the stack to go into
         * the `UPDATE_ROLLBACK_FAILED` state. You can't update a stack that is in the
         * `UPDATE_ROLLBACK_FAILED` state. However, if you can continue to roll it back, you can
         * return the stack to its original settings and then try to update it again. For more
         * information, see
         ...
         *
         * @param replaceComputeEnvironment Specifies whether the compute environment is replaced if
         *   an update is made that requires replacing the instances in the compute environment.
         */
        ...
        /**
         * The full Amazon Resource Name (ARN) of the IAM role that allows AWS Batch to make calls
         * to other AWS services on your behalf.
         *
         ...
         * role ARN (recommended) or prefix the role name with the path. For example, if a role with
         * the name `bar` has a path of `/foo/` , specify `/foo/bar` as the role name. For more
         * information, see
         ...
         * The state of the compute environment.
         *
         * If the state is `ENABLED` , then the compute environment accepts jobs from a queue and
         ...
         * prevent additional charges, turn off and then delete the compute environment. For more
         * information, see
         ...
         * `minvCpus` value of `4` and a `desiredvCpus` value of `36` . This instance doesn't scale
         ...
         *
         * @param updatePolicy Specifies the infrastructure update policy for the compute
         *   environment.
         */
    ...
    private class BuilderImpl(
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("e68d3d39757a2bb02d27a14eaf143cce0c2876be80e425917f05c02c84205abb")
        override fun computeResources(
            computeResources: ComputeResourcesProperty.Builder.() -> Unit
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("628654f205977f50317fb6bb74c7f132d076467b6a42e16fe1d1b5c152f2e10c")
        override fun eksConfiguration(
            eksConfiguration: EksConfigurationProperty.Builder.() -> Unit
    ...
    public interface EksConfigurationProperty {
         ...
         * fewer than 64 characters long, can't be set to `default` , can't start with " `kube-` ,"
         * and must match this regular expression: `^[a-z0-9]([-a-z0-9]*[a-z0-9])?$` . For more
         * information, see
        ...
        public interface Builder {
            /**
             * @param eksClusterArn The Amazon Resource Name (ARN) of the Amazon EKS cluster. An
             *   example is `arn: *aws* :eks: *us-east-1* : *123456789012* :cluster/
             *   *ClusterForBatch*` .
             */
            public fun eksClusterArn(eksClusterArn: String)

            /**
             * @param kubernetesNamespace The namespace of the Amazon EKS cluster. AWS Batch manages
             *   pods in this namespace. The value can't left empty or null. It must be fewer than
             *   64 characters long, can't be set to `default` , can't start with " `kube-` ," and
             *   must match this regular expression: `^[a-z0-9]([-a-z0-9]*[a-z0-9])?$` . For more
             *   information, see
             *   [Namespaces](https://docs.aws.amazon.com/https://kubernetes.io/docs/concepts/overview/working-with-objects/namespaces/)
             *   in the Kubernetes documentation.
             */
        ...
        internal constructor(
             ...
             * The Amazon Resource Name (ARN) of the Amazon EKS cluster.
             *
             * An example is `arn: *aws* :eks: *us-east-1* : *123456789012* :cluster/
             * *ClusterForBatch*` .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-batch-computeenvironment-eksconfiguration.html#cfn-batch-computeenvironment-eksconfiguration-eksclusterarn)
             */
             ...
             * The namespace of the Amazon EKS cluster.
             *
             * AWS Batch manages pods in this namespace. The value can't left empty or null. It must
             * be fewer than 64 characters long, can't be set to `default` , can't start with "
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: EksConfigurationProperty
            ): software.amazon.awscdk.services.batch.CfnComputeEnvironment.EksConfigurationProperty =
    ...
    public interface Ec2ConfigurationObjectProperty {
         ...
         * support ARM instances. Amazon ECS vends both x86 and ARM versions of the Amazon
         ...
         * * **ECS** - If the `imageIdOverride` parameter isn't specified, then a recent
         ...
         *   optimized AMI for that image type that's supported by AWS Batch is used.
         ...
         *   see [Amazon Linux AMI](https://docs.aws.amazon.com/amazon-linux-ami/) .
         * * **EKS** - If the `imageIdOverride` parameter isn't specified, then a recent
         ...
         *   optimized AMI for that image type that AWS Batch supports is used.
         * * **EKS_AL2** - [Amazon Linux 2](https://docs.aws.amazon.com/eks/latest/userguide/eks-optimized-ami.html)
         *   : Default for all non-GPU instance families.
         * * **EKS_AL2_NVIDIA** - [Amazon Linux 2 (accelerated)](https://docs.aws.amazon.com/eks/latest/userguide/eks-optimized-ami.html)
         *   : Default for all GPU instance families (for example, `P4` and `G4` ) and can be used
         *   for all non AWS Graviton-based instance types.
         *
        ...
        public interface Builder {
            /**
             * @param imageIdOverride The AMI ID used for instances launched in the compute
             *   environment that match the image type. This setting overrides the `imageId` set in
            ...
            /**
             * @param imageKubernetesVersion The Kubernetes version for the compute environment. If
             *   you don't specify a value, the latest version that AWS Batch supports is used.
             */
            public fun imageKubernetesVersion(imageKubernetesVersion: String)

            /**
             * @param imageType The image type to match with the instance type to select an AMI. The
             ...
             *   ECS optimized AMI for that image type that's supported by AWS Batch is used.
             * * **ECS_AL2** - [Amazon Linux 2](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/ecs-optimized_AMI.html#al2ami)
             *   : Default for all non-GPU instance families.
             * * **ECS_AL2_NVIDIA** - [Amazon Linux 2 (GPU)](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/ecs-optimized_AMI.html#gpuami)
             ...
             *   information, see [Amazon Linux AMI](https://docs.aws.amazon.com/amazon-linux-ami/)
             *   .
             * * **EKS** - If the `imageIdOverride` parameter isn't specified, then a recent
             *   [Amazon EKS-optimized Amazon Linux AMI](https://docs.aws.amazon.com/eks/latest/userguide/eks-optimized-ami.html)
             *   ( `EKS_AL2` ) is used. If a new image type is specified in an update, but neither
             *   an `imageId` nor a `imageIdOverride` parameter is specified, then the latest Amazon
             *   EKS optimized AMI for that image type that AWS Batch supports is used.
             * * **EKS_AL2** - [Amazon Linux 2](https://docs.aws.amazon.com/eks/latest/userguide/eks-optimized-ami.html)
             *   : Default for all non-GPU instance families.
             * * **EKS_AL2_NVIDIA** - [Amazon Linux 2 (accelerated)](https://docs.aws.amazon.com/eks/latest/userguide/eks-optimized-ami.html)
             *   : Default for all GPU instance families (for example, `P4` and `G4` ) and can be
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-batch-computeenvironment-ec2configurationobject.html#cfn-batch-computeenvironment-ec2configurationobject-imagekubernetesversion)
             */
            override fun imageKubernetesVersion(): String? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: Ec2ConfigurationObjectProperty
            ): software.amazon.awscdk.services.batch.CfnComputeEnvironment.Ec2ConfigurationObjectProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface LaunchTemplateSpecificationProperty {
         ...
         *
         * If the value is `$Latest` , the latest version of the launch template is used. If the
         * value is `$Default` , the default version of the launch template is used.
         *
         ...
         * During an infrastructure update, if either `$Latest` or `$Default` is specified, AWS
         * Batch re-evaluates the launch template version, and it might use a different version of
         * the launch template. This is the case even if the launch template isn't specified in the
         * update. When updating a compute environment, changing the launch template requires an
        ...
        public interface Builder {
             ...
             * of the launch template. This is the case even if the launch template isn't specified
             * in the update. When updating a compute environment, changing the launch template
    ...
    public interface UpdatePolicyProperty {
         ...
         */
        public fun jobExecutionTimeoutMinutes(): Number? =
        ...
        public interface Builder {
            /**
             * @param jobExecutionTimeoutMinutes Specifies the job timeout (in minutes) when the
             *   compute environment infrastructure is updated. The default value is 30.
             */
            public fun jobExecutionTimeoutMinutes(jobExecutionTimeoutMinutes: Number)

            /**
             * @param terminateJobsOnUpdate Specifies whether jobs are automatically terminated when
             *   the computer environment infrastructure is updated. The default value is `false` .
             */
    ...
    public interface ComputeResourcesProperty {
         ...
         * best fitting instance type can be allocated.
         *
         ...
         *   the jobs with a preference for the lowest-cost instance type. If additional instances
         *   of the selected instance type aren't available, AWS Batch waits for the additional
         *   instances to be available. If there aren't enough instances available, or if the user
         *   is reaching
         *   [Amazon EC2 service limits](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-resource-limits.html)
         *   then additional jobs aren't run until the currently running jobs have completed. This
         *   allocation strategy keeps costs lower but can limit scaling. If you are using Spot
         *   Fleets with `BEST_FIT` then the Spot Fleet IAM role must be specified.
         ...
         *   previously selected instance types aren't available, AWS Batch will select new instance
         *   types.
         ...
         *   strategy looks at both price and capacity to select the Spot Instance pools that are
         *   the least likely to be interrupted and have the lowest possible price. This allocation
         ...
         * `SPOT_PRICE_CAPACITY_OPTIMIZED` allocation strategies using On-Demand or Spot Instances,
         * and the `BEST_FIT` strategy using Spot Instances, AWS Batch might need to go above
         ...
         *
         * For example, if your maximum percentage is 20%, the Spot price must be less than 20% of
         * the current On-Demand price for that Amazon EC2 instance. You always pay the lowest
         * (market) price and never more than your maximum percentage. For most use cases, we
         ...
         *
         * This parameter isn't applicable to jobs that are running on Fargate resources. Don't
         * specify it. &gt; AWS Batch doesn't support changing the desired number of vCPUs of an
         * existing compute environment. Don't specify this parameter for compute environments using
         * Amazon EKS clusters. &gt; When you update the `desiredvCpus` setting, the value must be
         * between the `minvCpus` and `maxvCpus` values.
         *
         * Additionally, the updated `desiredvCpus` value must be greater than or equal to the
         * current `desiredvCpus` value. For more information, see
         ...
         * [Updating compute environments](https://docs.aws.amazon.com/batch/latest/userguide/updating-compute-environments.html)
         * in the *AWS Batch User Guide* . To remove the Amazon EC2 configuration and any custom AMI
         ...
         * structure. To remove the custom AMI ID and use the default AMI ID, set this value to an
         * empty string.
         *
         ...
         *
         * This parameter isn't applicable to jobs that are running on Fargate resources. Don't
         * specify it. &gt; The AMI that you choose for a compute environment must match the
         * architecture of the instance types that you intend to use for that compute environment.
         * For example, if your compute environment uses A1 instance types, the compute resource AMI
         * that you choose must support ARM instances. Amazon ECS vends both x86 and ARM versions of
         * the Amazon ECS-optimized Amazon Linux 2 AMI. For more information, see
         * [Amazon ECS-optimized Amazon Linux 2 AMI](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/ecs-optimized_AMI.html#ecs-optimized-ami-linux-variants.html)
         * in the *Amazon Elastic Container Service Developer Guide* .
         *
         ...
         * *&lt;aws_account_id&gt;* :instance-profile/ *ecsInstanceRole*` . For more information,
         * see
         ...
         * `c5.8xlarge` ). You can also choose `optimal` to select instance types (from the C4, M4,
         ...
         *
         * This parameter isn't applicable to jobs that are running on Fargate resources. Don't
         * specify it. &gt; When you create a compute environment, the instance types that you
         * select for the compute environment must share the same architecture. For example, you
         * can't mix x86 and ARM instances in the same compute environment. &gt; Currently,
         * `optimal` uses instance types from the C4, M4, and R4 instance families. In Regions that
         * don't have instance types from those instance families, instance types from the C5, M5,
         ...
         * either the launch template ID or launch template name in the request, but not both. For
         * more information, see
         * [Launch Template Support](https://docs.aws.amazon.com/batch/latest/userguide/launch-templates.html)
         * in the ** . Removing the launch template from a compute environment will not remove the
         ...
         * This keeps your multi-node parallel job on a logical grouping of instances within a
         * single Availability Zone with high network flow potential. For more information, see
         ...
         * security groups. For Fargate compute resources, providing an empty list is handled as if
         * this parameter wasn't specified and no change is made. For Amazon EC2 compute resources,
         ...
         * strategy isn't specified. For more information, see
         * [Amazon EC2 spot fleet role](https://docs.aws.amazon.com/batch/latest/userguide/spot_fleet_IAM_role.html)
         * in the *AWS Batch User Guide* .
         *
         * This parameter isn't applicable to jobs that are running on Fargate resources. Don't
         * specify it. &gt; To tag your Spot Instances on creation, the Spot Fleet IAM role
         * specified here must use the newer *AmazonEC2SpotFleetTaggingRole* managed policy. The
         * previously recommended *AmazonEC2SpotFleetRole* managed policy doesn't have the required
         ...
         * providing an empty list will be handled as if this parameter wasn't specified and no
         * change is made. For Amazon EC2 compute resources, providing an empty list removes the VPC
         * subnets from the compute resource. For more information, see
         ...
         * compute environment.
         *
         * For AWS Batch , these take the form of `"String1": "String2"` , where `String1` is the
         * tag key and `String2` is the tag value-for example, `{ "Name": "Batch Instance -
         * C4OnDemand" }` . This is helpful for recognizing your Batch instances in the Amazon EC2
         * console. These tags aren't seen when using the AWS Batch `ListTagsForResource` API
         * operation.
         *
         * When updating a compute environment, changing this setting requires an infrastructure
         * update of the compute environment. For more information, see
         ...
         * between `FARGATE` and `FARGATE_SPOT` will initiate an infrastructure update, but if you
         * switch between `EC2` and `FARGATE` , AWS CloudFormation will create a new compute
         * environment.
         *
         ...
         * determined by the launch template that's specified in the `launchTemplate` parameter. If
         * an AMI ID is specified any of these ways, this parameter is ignored. For more information
         * about to update AMI IDs during an infrastructure update, see
        ...
        public interface Builder {
            /**
             * @param allocationStrategy The allocation strategy to use for the compute resource if
             *   not enough instances of the best fitting instance type can be allocated. This might
             ...
             * This parameter isn't applicable to jobs that are running on Fargate resources, and
             * shouldn't be specified.
             * * **BEST_FIT (default)** - AWS Batch selects an instance type that best fits the
             *   needs of the jobs with a preference for the lowest-cost instance type. If
             *   additional instances of the selected instance type aren't available, AWS Batch
             *   waits for the additional instances to be available. If there aren't enough
             *   instances available, or if the user is reaching
             *   [Amazon EC2 service limits](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-resource-limits.html)
             *   then additional jobs aren't run until the currently running jobs have completed.
             *   This allocation strategy keeps costs lower but can limit scaling. If you are using
             ...
             *   for instance types with a lower cost per unit vCPU. If additional instances of the
             *   previously selected instance types aren't available, AWS Batch will select new
             *   instance types.
             * * **SPOT_CAPACITY_OPTIMIZED** - AWS Batch will select one or more instance types that
             *   are large enough to meet the requirements of the jobs in the queue, with a
             *   preference for instance types that are less likely to be interrupted. This
             ...
             * Instances, and the `BEST_FIT` strategy using Spot Instances, AWS Batch might need to
             * go above `maxvCpus` to meet your capacity requirements. In this event, AWS Batch
             * never exceeds `maxvCpus` by more than a single instance.
             */
            public fun allocationStrategy(allocationStrategy: String)

            /**
             * @param bidPercentage The maximum percentage that a Spot Instance price can be when
             *   compared with the On-Demand price for that instance type before instances are
             *   launched. For example, if your maximum percentage is 20%, the Spot price must be
             *   less than 20% of the current On-Demand price for that Amazon EC2 instance. You
             ...
             * This parameter isn't applicable to jobs that are running on Fargate resources. Don't
             * specify it. &gt; AWS Batch doesn't support changing the desired number of vCPUs of an
             * existing compute environment. Don't specify this parameter for compute environments
             * using Amazon EKS clusters. &gt; When you update the `desiredvCpus` setting, the value
             * must be between the `minvCpus` and `maxvCpus` values.
             *
             * Additionally, the updated `desiredvCpus` value must be greater than or equal to the
             * current `desiredvCpus` value. For more information, see
             * [Troubleshooting AWS Batch](https://docs.aws.amazon.com/batch/latest/userguide/troubleshooting.html#error-desired-vcpus-update)
            ...
            /**
             * @param ec2Configuration Provides information used to select Amazon Machine Images
             ...
             * update of the compute environment. For more information, see
             * [Updating compute environments](https://docs.aws.amazon.com/batch/latest/userguide/updating-compute-environments.html)
             * in the *AWS Batch User Guide* . To remove the Amazon EC2 configuration and any custom
            ...
            /**
             * @param ec2KeyPair The Amazon EC2 key pair that's used for instances launched in the
             *   compute environment. You can use this key pair to log in to your instances with
             *   SSH. To remove the Amazon EC2 key pair, set this value to an empty string.
             *
             * When updating a compute environment, changing the Amazon EC2 key pair requires an
             * infrastructure update of the compute environment. For more information, see
             * [Updating compute environments](https://docs.aws.amazon.com/batch/latest/userguide/updating-compute-environments.html)
            ...
            /**
             * @param imageId The Amazon Machine Image (AMI) ID used for instances launched in the
             *   compute environment. This parameter is overridden by the `imageIdOverride` member
             *   of the `Ec2Configuration` structure. To remove the custom AMI ID and use the
             *   default AMI ID, set this value to an empty string.
             *
             * When updating a compute environment, changing the AMI ID requires an infrastructure
             * update of the compute environment. For more information, see
             * [Updating compute environments](https://docs.aws.amazon.com/batch/latest/userguide/updating-compute-environments.html)
             ...
             * environment. For example, if your compute environment uses A1 instance types, the
             * compute resource AMI that you choose must support ARM instances. Amazon ECS vends
             * both x86 and ARM versions of the Amazon ECS-optimized Amazon Linux 2 AMI. For more
             * information, see
             * [Amazon ECS-optimized Amazon Linux 2 AMI](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/ecs-optimized_AMI.html#ecs-optimized-ami-linux-variants.html)
             * in the *Amazon Elastic Container Service Developer Guide* .
             */
            ...
            /**
             * @param instanceRole The Amazon ECS instance profile applied to Amazon EC2 instances
             *   in a compute environment. Required for Amazon EC2 instances. You can specify the
             *   short name or full Amazon Resource Name (ARN) of an instance profile. For example,
             *   `*ecsInstanceRole*` or `arn:aws:iam:: *&lt;aws_account_id&gt;* :instance-profile/
             *   *ecsInstanceRole*` . For more information, see
             *   [Amazon ECS instance role](https://docs.aws.amazon.com/batch/latest/userguide/instance_IAM_role.html)
             *   in the *AWS Batch User Guide* .
             *
             * When updating a compute environment, changing this setting requires an infrastructure
            ...
            /**
             * @param instanceTypes The instances types that can be launched. You can specify
             *   instance families to launch any instance type within those families (for example,
             *   `c5` or `p3` ), or you can specify specific sizes within a family (such as
             *   `c5.8xlarge` ). You can also choose `optimal` to select instance types (from the
             *   C4, M4, and R4 instance families) that match the demand of your job queues.
             *
             * When updating a compute environment, changing this setting requires an infrastructure
             * update of the compute environment. For more information, see
             * [Updating compute environments](https://docs.aws.amazon.com/batch/latest/userguide/updating-compute-environments.html)
             ...
             * select for the compute environment must share the same architecture. For example, you
             * can't mix x86 and ARM instances in the same compute environment. &gt; Currently,
             * `optimal` uses instance types from the C4, M4, and R4 instance families. In Regions
             * that don't have instance types from those instance families, instance types from the
            ...
            /**
             * @param launchTemplate The launch template to use for your compute resources. Any
             *   other compute resource parameters that you specify in a
             *   [CreateComputeEnvironment](https://docs.aws.amazon.com/batch/latest/APIReference/API_CreateComputeEnvironment.html)
             *   API operation override the same parameters in the launch template. You must specify
             *   either the launch template ID or launch template name in the request, but not both.
             *   For more information, see
             *   [Launch Template Support](https://docs.aws.amazon.com/batch/latest/userguide/launch-templates.html)
             *   in the ** . Removing the launch template from a compute environment will not remove
             *   the AMI specified in the launch template. In order to update the AMI specified in a
            ...
            /**
             * @param minvCpus The minimum number of vCPUs that an environment should maintain (even
             ...
             *   environment, you should consider creating a cluster placement group and associate
             *   it with your compute resources. This keeps your multi-node parallel job on a
             *   logical grouping of instances within a single Availability Zone with high network
             *   flow potential. For more information, see
             *   [Placement groups](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/placement-groups.html)
             *   in the *Amazon EC2 User Guide for Linux Instances* .
             *
             * When updating a compute environment, changing the placement group requires an
            ...
            /**
             * @param securityGroupIds The Amazon EC2 security groups that are associated with
             *   instances launched in the compute environment. This parameter is required for
             *   Fargate compute resources, where it can contain up to 5 security groups. For
             *   Fargate compute resources, providing an empty list is handled as if this parameter
             *   wasn't specified and no change is made. For Amazon EC2 compute resources, providing
            ...
            /**
             * @param spotIamFleetRole The Amazon Resource Name (ARN) of the Amazon EC2 Spot Fleet
             *   IAM role applied to a `SPOT` compute environment. This role is required if the
             *   allocation strategy set to `BEST_FIT` or if the allocation strategy isn't
             ...
             * specify it. &gt; To tag your Spot Instances on creation, the Spot Fleet IAM role
             * specified here must use the newer *AmazonEC2SpotFleetTaggingRole* managed policy. The
             * previously recommended *AmazonEC2SpotFleetRole* managed policy doesn't have the
             * required permissions to tag Spot Instances. For more information, see
             * [Spot instances not tagged on creation](https://docs.aws.amazon.com/batch/latest/userguide/troubleshooting.html#spot-instance-no-tag)
             * in the *AWS Batch User Guide* .
             */
            ...
            /**
             * @param subnets The VPC subnets where the compute resources are launched. Fargate
             *   compute resources can contain up to 16 subnets. For Fargate compute resources,
             *   providing an empty list will be handled as if this parameter wasn't specified and
             *   no change is made. For Amazon EC2 compute resources, providing an empty list
            ...
            /**
             * @param tags Key-value pair tags to be applied to Amazon EC2 resources that are
             *   launched in the compute environment. For AWS Batch , these take the form of
             *   `"String1": "String2"` , where `String1` is the tag key and `String2` is the tag
             *   value-for example, `{ "Name": "Batch Instance - C4OnDemand" }` . This is helpful
             *   for recognizing your Batch instances in the Amazon EC2 console. These tags aren't
            ...
            /**
             * @param type The type of compute environment: `EC2` , `SPOT` , `FARGATE` , or
             ...
             * in the *AWS Batch User Guide* .
             *
             * When updating compute environment, changing the type of a compute environment
             * requires an infrastructure update of the compute environment. For more information,
             * see
             * [Updating compute environments](https://docs.aws.amazon.com/batch/latest/userguide/updating-compute-environments.html)
             * in the *AWS Batch User Guide* .
             *
             * When updating the type of a compute environment, changing between `EC2` and `SPOT` or
             * between `FARGATE` and `FARGATE_SPOT` will initiate an infrastructure update, but if
             * you switch between `EC2` and `FARGATE` , AWS CloudFormation will create a new compute
             * environment.
             */
            public fun type(type: String)

            /**
             * @param updateToLatestImageVersion Specifies whether the AMI ID is updated to the
             *   latest one that's supported by AWS Batch when the compute environment has an
             *   infrastructure update. The default value is `false` .
             *
             * An AMI ID can either be specified in the `imageId` or `imageIdOverride` parameters or
        ...
        private class BuilderImpl : Builder {
            ...
            override fun updateToLatestImageVersion(updateToLatestImageVersion: IResolvable) {
                cdkBuilder.updateToLatestImageVersion(
                    updateToLatestImageVersion.let(IResolvable::unwrap)
                )
            }
        ...
        internal constructor(
             ...
             *
             * For example, if your maximum percentage is 20%, the Spot price must be less than 20%
             ...
             * The desired number of vCPUS in the compute environment.
             *
             * AWS Batch modifies this value between the minimum and maximum values based on job
             * queue demand.
             *
             * This parameter isn't applicable to jobs that are running on Fargate resources. Don't
             * specify it. &gt; AWS Batch doesn't support changing the desired number of vCPUs of an
             ...
             * (for example, `c5` or `p3` ), or you can specify specific sizes within a family (such
             * as `c5.8xlarge` ). You can also choose `optimal` to select instance types (from the
             * C4, M4, and R4 instance families) that match the demand of your job queues.
             *
             * When updating a compute environment, changing this setting requires an infrastructure
             * update of the compute environment. For more information, see
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-batch-computeenvironment-computeresources.html#cfn-batch-computeenvironment-computeresources-instancetypes)
             */
            override fun instanceTypes(): List<String> =
                unwrap(this).getInstanceTypes() ?: emptyList()
             ...
             * The Amazon EC2 placement group to associate with your compute resources.
             *
             * If you intend to submit multi-node parallel jobs to your compute environment, you
             * should consider creating a cluster placement group and associate it with your compute
             * resources. This keeps your multi-node parallel job on a logical grouping of instances
             * within a single Availability Zone with high network flow potential. For more
             * information, see
             * [Placement groups](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/placement-groups.html)
             * in the *Amazon EC2 User Guide for Linux Instances* .
             *
             ...
             * compute environment.
             *
             * This parameter is required for Fargate compute resources, where it can contain up to
             * 5 security groups. For Fargate compute resources, providing an empty list is handled
             * as if this parameter wasn't specified and no change is made. For Amazon EC2 compute
             * resources, providing an empty list removes the security groups from the compute
             * resource.
             *
             * When updating a compute environment, changing the Amazon EC2 security groups requires
             * an infrastructure update of the compute environment. For more information, see
             ...
             *
             * This role is required if the allocation strategy set to `BEST_FIT` or if the
             ...
             * resources, providing an empty list will be handled as if this parameter wasn't
             * specified and no change is made. For Amazon EC2 compute resources, providing an empty
             * list removes the VPC subnets from the compute resource. For more information, see
             * [VPCs and subnets](https://docs.aws.amazon.com/vpc/latest/userguide/VPC_Subnets.html)
             * in the *Amazon VPC User Guide* .
             *
             * When updating a compute environment, changing the VPC subnets requires an
             ...
             * compute environment.
             *
             * For AWS Batch , these take the form of `"String1": "String2"` , where `String1` is
             * the tag key and `String2` is the tag value-for example, `{ "Name": "Batch Instance -
             * C4OnDemand" }` . This is helpful for recognizing your Batch instances in the Amazon
             * EC2 console. These tags aren't seen when using the AWS Batch `ListTagsForResource`
             * API operation.
             *
             * When updating a compute environment, changing this setting requires an infrastructure
             * update of the compute environment. For more information, see
            ...
            /**
             * Specifies whether the AMI ID is updated to the latest one that's supported by AWS
             * Batch when the compute environment has an infrastructure update.
             *
             * The default value is `false` .
             *
             * An AMI ID can either be specified in the `imageId` or `imageIdOverride` parameters or
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-batch-computeenvironment-computeresources.html#cfn-batch-computeenvironment-computeresources-updatetolatestimageversion)
             */
            override fun updateToLatestImageVersion(): Any? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ComputeResourcesProperty
            ): software.amazon.awscdk.services.batch.CfnComputeEnvironment.ComputeResourcesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
