...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param instanceGroup The JSON that you want to provide to your ModifyInstanceGroup call
         *   as input.
         */
        ...
        public fun instanceGroup(
            instanceGroup: InstanceGroupModifyConfigProperty.Builder.() -> Unit
        )
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: EmrModifyInstanceGroupByName
        ): software.amazon.awscdk.services.stepfunctions.tasks.EmrModifyInstanceGroupByName =
            wrapped.cdkObject
    }
    ...
    public interface InstanceResizePolicyProperty {
         ...
         */
        public fun instancesToProtect(): List<String> =
            unwrap(this).getInstancesToProtect() ?: emptyList()
         ...
         */
        public fun instancesToTerminate(): List<String> =
        ...
        public interface Builder {
            /**
             * @param instanceTerminationTimeout Decommissioning timeout override for the specific
             *   list of instances to be terminated.
             */
            public fun instanceTerminationTimeout(instanceTerminationTimeout: Duration)

            /**
             * @param instancesToProtect Specific list of instances to be protected when shrinking
             *   an instance group.
             */
            ...
            /**
             * @param instancesToTerminate Specific list of instances to be terminated when
        ...
        private class BuilderImpl : Builder {
            ...
            override fun instanceTerminationTimeout(instanceTerminationTimeout: Duration) {
                cdkBuilder.instanceTerminationTimeout(
                    instanceTerminationTimeout.let(Duration::unwrap)
                )
            }
        ...
        internal constructor(
             ...
             * Default: - No instances will be protected when shrinking an instance group
             */
            override fun instancesToProtect(): List<String> =
                unwrap(this).getInstancesToProtect() ?: emptyList()
             ...
             * Default: - No instances will be terminated when shrinking an instance group.
             */
            override fun instancesToTerminate(): List<String> =
                unwrap(this).getInstancesToTerminate() ?: emptyList()
        }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: InstanceResizePolicyProperty
            ): software.amazon.awscdk.services.stepfunctions.tasks.EmrModifyInstanceGroupByName.InstanceResizePolicyProperty =
    ...
    public interface ShrinkPolicyProperty {
        ...
        public interface Builder {
            ...
            public fun instanceResizePolicy(
                instanceResizePolicy: InstanceResizePolicyProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun instanceResizePolicy(instanceResizePolicy: InstanceResizePolicyProperty) {
                cdkBuilder.instanceResizePolicy(
                    instanceResizePolicy.let(InstanceResizePolicyProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("56d4576baf2f9bf78146137f7d858182ed08b35c01a56f19d4d822f3f246353b")
            override fun instanceResizePolicy(
                instanceResizePolicy: InstanceResizePolicyProperty.Builder.() -> Unit
    ...
    public interface InstanceGroupModifyConfigProperty {
        ...
        public interface Builder {
            /**
             * @param configurations A list of new or modified configurations to apply for an
             *   instance group.
             */
            ...
            /**
             * @param eC2InstanceIdsToTerminate The EC2 InstanceIds to terminate. After you
        ...
        private class BuilderImpl : Builder {
            ...
            override fun configurations(
                configurations: List<EmrCreateCluster.ConfigurationProperty>
            ) {
                cdkBuilder.configurations(
                    configurations.map(EmrCreateCluster.ConfigurationProperty::unwrap)
                )
            }
             ...
             */
            override fun configurations(
                vararg configurations: EmrCreateCluster.ConfigurationProperty
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: InstanceGroupModifyConfigProperty
            ): software.amazon.awscdk.services.stepfunctions.tasks.EmrModifyInstanceGroupByName.InstanceGroupModifyConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
