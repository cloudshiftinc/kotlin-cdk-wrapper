...
public enum class VerificationEmailStyle(
  ...
  public companion object {
    internal fun wrap(cdkObject: software.amazon.awscdk.services.cognito.VerificationEmailStyle):
        VerificationEmailStyle = when (cdkObject) {
    ...
    internal fun unwrap(wrapped: VerificationEmailStyle):
