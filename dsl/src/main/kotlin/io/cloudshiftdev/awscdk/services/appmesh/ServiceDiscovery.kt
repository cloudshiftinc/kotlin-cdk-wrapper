...
internal constructor(
    ...
    public companion object {
        public fun cloudMap(service: IService): ServiceDiscovery =
            software.amazon.awscdk.services.appmesh.ServiceDiscovery.cloudMap(
                    service.let(IService::unwrap)
                )
                .let(ServiceDiscovery::wrap)
        ...
        public fun cloudMap(
            ...
            software.amazon.awscdk.services.appmesh.ServiceDiscovery.cloudMap(
                    service.let(IService::unwrap),
                    instanceAttributes,
                    ipPreference.let(IpPreference::unwrap)
                )
                .let(ServiceDiscovery::wrap)
        ...
        public fun dns(hostname: String, responseType: DnsResponseType): ServiceDiscovery =
            software.amazon.awscdk.services.appmesh.ServiceDiscovery.dns(
                    hostname,
