...
public interface MTLSConfig {
    ...
    private class BuilderImpl : Builder {
        ...
        public fun build(): software.amazon.awscdk.services.apigateway.MTLSConfig =
            cdkBuilder.build()
    }
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: MTLSConfig
        ): software.amazon.awscdk.services.apigateway.MTLSConfig = (wrapped as Wrapper).cdkObject
    }
}
