...
public enum class MethodLoggingLevel(
  ...
  public companion object {
    internal fun wrap(cdkObject: software.amazon.awscdk.services.apigateway.MethodLoggingLevel):
        MethodLoggingLevel = when (cdkObject) {
      software.amazon.awscdk.services.apigateway.MethodLoggingLevel.OFF -> MethodLoggingLevel.OFF
      software.amazon.awscdk.services.apigateway.MethodLoggingLevel.ERROR ->
          MethodLoggingLevel.ERROR
      software.amazon.awscdk.services.apigateway.MethodLoggingLevel.INFO -> MethodLoggingLevel.INFO
    }

    internal fun unwrap(wrapped: MethodLoggingLevel):
