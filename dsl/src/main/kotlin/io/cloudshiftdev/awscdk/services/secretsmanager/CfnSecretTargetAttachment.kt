...
internal constructor(
    ...
    public interface Builder {
         ...
         * A string that defines the type of service or database associated with the secret.
         *
         * This value instructs Secrets Manager how to update the secret with the details of the
         ...
         *
         * @param targetType A string that defines the type of service or database associated with
         *   the secret.
         */
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.secretsmanager.CfnSecretTargetAttachment.Builder.create(
                scope,
                id
            )
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnSecretTargetAttachment
        ): software.amazon.awscdk.services.secretsmanager.CfnSecretTargetAttachment =
            wrapped.cdkObject
    }
}
