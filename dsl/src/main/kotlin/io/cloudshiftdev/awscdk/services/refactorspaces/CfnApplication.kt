...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.refactorspaces.CfnApplication,
    ...
    public open fun apiGatewayProxy(
        `value`: ApiGatewayProxyInputProperty.Builder.() -> Unit
    ): Unit = apiGatewayProxy(ApiGatewayProxyInputProperty(`value`))

    /** The resource ID of the API Gateway for the proxy. */
    public open fun attrApiGatewayId(): String = unwrap(this).getAttrApiGatewayId()

    /** The unique identifier of the application. */
    public open fun attrApplicationIdentifier(): String =
        unwrap(this).getAttrApplicationIdentifier()
    ...
    private class BuilderImpl(
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("82084cfa4d5be34cb317f6744332230060ebd89a2ad16fc185f5ce500b1462d8")
        override fun apiGatewayProxy(
            apiGatewayProxy: ApiGatewayProxyInputProperty.Builder.() -> Unit
    ...
    public interface ApiGatewayProxyInputProperty {
         ...
         * Gateway that has been granted access. For more information about creating a private
         * connection with Refactor Spaces and interface endpoint ( AWS PrivateLink ) availability,
         * see
         * [Access Refactor Spaces using an interface endpoint ( AWS PrivateLink )](https://docs.aws.amazon.com/migrationhub-refactor-spaces/latest/userguide/vpc-interface-endpoints.html)
         * .
         *
        ...
        public interface Builder {
            /**
             * @param endpointType The type of endpoint to use for the API Gateway proxy. If no
             *   value is specified in the request, the value is set to `REGIONAL` by default.
             *
             * If the value is set to `PRIVATE` in the request, this creates a private API endpoint
             * that is isolated from the public internet. The private endpoint can only be accessed
             * by using Amazon Virtual Private Cloud ( Amazon VPC ) interface endpoints for the
             * Amazon API Gateway that has been granted access. For more information about creating
             * a private connection with Refactor Spaces and interface endpoint ( AWS PrivateLink )
             * availability, see
             * [Access Refactor Spaces using an interface endpoint ( AWS PrivateLink )](https://docs.aws.amazon.com/migrationhub-refactor-spaces/latest/userguide/vpc-interface-endpoints.html)
             * .
             */
            ...
            /** @param stageName The name of the API Gateway stage. The name defaults to `prod` . */
        ...
        private class BuilderImpl : Builder {
            private val cdkBuilder:
                ...
                software.amazon.awscdk.services.refactorspaces.CfnApplication
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ApiGatewayProxyInputProperty
            ): software.amazon.awscdk.services.refactorspaces.CfnApplication.ApiGatewayProxyInputProperty =
