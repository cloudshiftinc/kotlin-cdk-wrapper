...
public enum class GrpcRetryEvent(
    ...
    public companion object {
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.appmesh.GrpcRetryEvent
        ): GrpcRetryEvent =
            when (cdkObject) {
                software.amazon.awscdk.services.appmesh.GrpcRetryEvent.CANCELLED ->
