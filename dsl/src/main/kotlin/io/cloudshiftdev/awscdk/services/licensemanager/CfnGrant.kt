...
internal constructor(
    ...
    public open fun allowedOperations(): List<String> =
        unwrap(this).getAllowedOperations() ?: emptyList()
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.licensemanager.CfnGrant =
            cdkBuilder.build()
    }
    ...
    public companion object {
        ...
        ): CfnGrant = CfnGrant(cdkObject)

        internal fun unwrap(
            wrapped: CfnGrant
        ): software.amazon.awscdk.services.licensemanager.CfnGrant = wrapped.cdkObject
    }
}
