...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.servicediscovery.Service,
    ...
    public open fun registerCnameInstance(id: String, props: CnameInstanceBaseProps): IInstance =
        unwrap(this)
            .registerCnameInstance(id, props.let(CnameInstanceBaseProps::unwrap))
            .let(IInstance::wrap)
    ...
    public open fun registerCnameInstance(
        id: String,
        props: CnameInstanceBaseProps.Builder.() -> Unit
    ): IInstance = registerCnameInstance(id, CnameInstanceBaseProps(props))
    ...
    public open fun registerIpInstance(id: String, props: IpInstanceBaseProps): IInstance =
        unwrap(this)
            .registerIpInstance(id, props.let(IpInstanceBaseProps::unwrap))
            .let(IInstance::wrap)
    ...
    public open fun registerIpInstance(
        id: String,
        props: IpInstanceBaseProps.Builder.() -> Unit
    ...
    public open fun registerLoadBalancer(id: String, loadBalancer: ILoadBalancerV2): IInstance =
        unwrap(this)
            .registerLoadBalancer(id, loadBalancer.let(ILoadBalancerV2::unwrap))
            .let(IInstance::wrap)
    ...
    public open fun registerLoadBalancer(
        ...
        unwrap(this)
            .registerLoadBalancer(id, loadBalancer.let(ILoadBalancerV2::unwrap), customAttributes)
            .let(IInstance::wrap)

    /**
     * Registers a resource that is accessible using values other than an IP address or a domain
     * name (CNAME).
     *
     * @param id
     * @param props
    ...
    public open fun registerNonIpInstance(id: String, props: NonIpInstanceBaseProps): IInstance =
        unwrap(this)
            .registerNonIpInstance(id, props.let(NonIpInstanceBaseProps::unwrap))
            .let(IInstance::wrap)
    ...
    public open fun registerNonIpInstance(
        id: String,
        props: NonIpInstanceBaseProps.Builder.() -> Unit
    ): IInstance = registerNonIpInstance(id, NonIpInstanceBaseProps(props))
    ...
    public interface Builder {
         ...
         * Default: none
         *
         * @param customHealthCheck Structure containing failure threshold for a custom health
         *   checker.
         */
         ...
         *
         * If you specify health check settings, AWS Cloud Map associates the health check with the
         * records that you specify in DnsConfig. Only one of healthCheckConfig or
         * healthCheckCustomConfig can be specified. Not valid for PrivateDnsNamespaces. If you use
         * healthCheck, you can only register IP instances to this service.
         *
         * Default: none
         *
         ...
         * AliasTargetInstance.
         *
         * Setting this to `true` correctly configures the `routingPolicy` and performs some
         * additional validation.
         *
         * Default: false
         *
         * @param loadBalancer Whether or not this service will have an Elastic LoadBalancer
         *   registered to it as an AliasTargetInstance.
         */
         ...
         *
         * @param routingPolicy The routing policy that you want to apply to all DNS records that
    ...
    private class BuilderImpl(
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("8d1b76f09d0c23e4e70030023fec6b487cf4a163a13b98b819f88d27549997f8")
        override fun customHealthCheck(
            customHealthCheck: HealthCheckCustomConfig.Builder.() -> Unit
    ...
    public companion object {
        public fun fromServiceAttributes(
            ...
            software.amazon.awscdk.services.servicediscovery.Service.fromServiceAttributes(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    attrs.let(ServiceAttributes::unwrap)
                )
                .let(IService::wrap)
        ...
        ): Service = Service(cdkObject)

        internal fun unwrap(
            wrapped: Service
        ): software.amazon.awscdk.services.servicediscovery.Service = wrapped.cdkObject
    }
}
