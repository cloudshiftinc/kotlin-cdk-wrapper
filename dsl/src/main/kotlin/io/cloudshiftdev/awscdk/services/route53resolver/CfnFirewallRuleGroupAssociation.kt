...
internal constructor(
     ...
     *
     * If you use AWS Firewall Manager to manage your firewallls from DNS Firewall, then this
    ...
    public interface Builder {
         ...
         *
         * @param mutationProtection If enabled, this setting disallows modification or removal of
         *   the association, to help prevent against accidentally altering DNS firewall
         *   protections.
         */
         ...
         * that are associated with a single VPC.
         *
         * DNS Firewall filters VPC traffic starting from rule group with the lowest numeric
         * priority setting.
         *
         ...
         *   the rule groups that are associated with a single VPC.
         */
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnFirewallRuleGroupAssociation
        ): software.amazon.awscdk.services.route53resolver.CfnFirewallRuleGroupAssociation =
            wrapped.cdkObject
    }
}
