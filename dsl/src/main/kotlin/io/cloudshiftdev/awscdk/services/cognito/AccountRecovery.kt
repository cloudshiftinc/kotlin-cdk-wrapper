...
public enum class AccountRecovery(
  ...
  EMAIL_AND_PHONE_WITHOUT_MFA(software.amazon.awscdk.services.cognito.AccountRecovery.EMAIL_AND_PHONE_WITHOUT_MFA),
  PHONE_WITHOUT_MFA_AND_EMAIL(software.amazon.awscdk.services.cognito.AccountRecovery.PHONE_WITHOUT_MFA_AND_EMAIL),
  EMAIL_ONLY(software.amazon.awscdk.services.cognito.AccountRecovery.EMAIL_ONLY),
  PHONE_ONLY_WITHOUT_MFA(software.amazon.awscdk.services.cognito.AccountRecovery.PHONE_ONLY_WITHOUT_MFA),
  ...
  public companion object {
    internal fun wrap(cdkObject: software.amazon.awscdk.services.cognito.AccountRecovery):
        AccountRecovery = when (cdkObject) {
    ...
    internal fun unwrap(wrapped: AccountRecovery):
