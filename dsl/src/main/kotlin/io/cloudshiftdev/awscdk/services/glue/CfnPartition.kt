...
internal constructor(
    ...
    private class BuilderImpl(
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("13310d4b97ab5623df3f0de1f1e4731127a740a13dc005d8ef2bae156d6b2973")
        override fun partitionInput(
            partitionInput: PartitionInputProperty.Builder.() -> Unit
    ...
    public companion object {
        ...
        ): CfnPartition = CfnPartition(cdkObject)

        internal fun unwrap(
            wrapped: CfnPartition
        ): software.amazon.awscdk.services.glue.CfnPartition = wrapped.cdkObject
    }
    ...
    public interface StorageDescriptorProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param numberOfBuckets The number of buckets. You must specify this property if the
             *   partition contains any dimension columns.
             */
    ...
    public interface PartitionInputProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param values The values of the partition. Although this parameter is not required by
        ...
        internal constructor(
             ...
             * The values of the partition.
             *
             * Although this parameter is not required by the SDK, you must specify this parameter
             * for a valid input.
             *
             * The values for the keys for the new partition must be passed as an array of String
             * objects that must be ordered in the same order as the partition keys appearing in the
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: PartitionInputProperty
            ): software.amazon.awscdk.services.glue.CfnPartition.PartitionInputProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
