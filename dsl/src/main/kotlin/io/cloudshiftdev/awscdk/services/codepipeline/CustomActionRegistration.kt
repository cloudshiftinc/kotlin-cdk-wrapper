...
public open class CustomActionRegistration
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.codepipeline.CustomActionRegistration,
) : CloudshiftdevConstructsConstruct(cdkObject) {
    /**
     * A fluent builder for
     * [io.cloudshiftdev.awscdk.services.codepipeline.CustomActionRegistration].
     */
    @CdkDslMarker
    public interface Builder {
         ...
         * Default: none
         *
         * @param executionUrl The URL shown for a particular execution of an Action in the Pipeline
         *   UI.
         */
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.codepipeline.CustomActionRegistration.Builder.create(
                scope,
                id
            )
    ...
    public companion object {
        ...
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.codepipeline.CustomActionRegistration
        ): CustomActionRegistration = CustomActionRegistration(cdkObject)

        internal fun unwrap(
            wrapped: CustomActionRegistration
