...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.applicationautoscaling.ScalableTarget,
     ...
     * @param props
     */
    public open fun scaleToTrackMetric(
        id: String,
        props: BasicTargetTrackingScalingPolicyProps
    ): TargetTrackingScalingPolicy =
        unwrap(this)
            .scaleToTrackMetric(id, props.let(BasicTargetTrackingScalingPolicyProps::unwrap))
    ...
    public open fun scaleToTrackMetric(
        id: String,
        props: BasicTargetTrackingScalingPolicyProps.Builder.() -> Unit
    ): TargetTrackingScalingPolicy =
        scaleToTrackMetric(id, BasicTargetTrackingScalingPolicyProps(props))

    /**
     * A fluent builder for
     * [io.cloudshiftdev.awscdk.services.applicationautoscaling.ScalableTarget].
     */
    @CdkDslMarker
    public interface Builder {
        /**
         * The maximum value that Application Auto Scaling can use to scale a target during a
         * scaling activity.
         *
         * @param maxCapacity The maximum value that Application Auto Scaling can use to scale a
         *   target during a scaling activity.
         */
        public fun maxCapacity(maxCapacity: Number)

        /**
         * The minimum value that Application Auto Scaling can use to scale a target during a
         * scaling activity.
         *
         * @param minCapacity The minimum value that Application Auto Scaling can use to scale a
         *   target during a scaling activity.
         */
         ...
         *
         * @param scalableDimension The scalable dimension that's associated with the scalable
         *   target.
         */
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.applicationautoscaling.ScalableTarget.Builder.create(
                scope,
                id
            )
