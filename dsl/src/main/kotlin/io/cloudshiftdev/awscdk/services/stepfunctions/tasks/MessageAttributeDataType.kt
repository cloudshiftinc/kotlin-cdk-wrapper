...
public enum class MessageAttributeDataType(
    ...
    public companion object {
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.stepfunctions.tasks.MessageAttributeDataType
        ): MessageAttributeDataType =
            when (cdkObject) {
                software.amazon.awscdk.services.stepfunctions.tasks.MessageAttributeDataType
                    .STRING -> MessageAttributeDataType.STRING
                software.amazon.awscdk.services.stepfunctions.tasks.MessageAttributeDataType
                    .STRING_ARRAY -> MessageAttributeDataType.STRING_ARRAY
                software.amazon.awscdk.services.stepfunctions.tasks.MessageAttributeDataType
                    .NUMBER -> MessageAttributeDataType.NUMBER
                software.amazon.awscdk.services.stepfunctions.tasks.MessageAttributeDataType
                    .BINARY -> MessageAttributeDataType.BINARY
            }

        internal fun unwrap(
            wrapped: MessageAttributeDataType
        ): software.amazon.awscdk.services.stepfunctions.tasks.MessageAttributeDataType =
            wrapped.cdkObject
    }
}
