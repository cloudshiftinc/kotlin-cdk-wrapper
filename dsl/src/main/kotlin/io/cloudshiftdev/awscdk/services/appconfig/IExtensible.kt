...
public interface IExtensible {
    ...
    internal constructor(
        internal val cdkObject: software.amazon.awscdk.services.appconfig.IExtensible,
    ) : IExtensible {
        /**
         * Adds an extension association to the derived resource.
         *
    ...
    public companion object {
        ...
        ): IExtensible = Wrapper(cdkObject)

        internal fun unwrap(
            wrapped: IExtensible
        ): software.amazon.awscdk.services.appconfig.IExtensible = (wrapped as Wrapper).cdkObject
    }
}
