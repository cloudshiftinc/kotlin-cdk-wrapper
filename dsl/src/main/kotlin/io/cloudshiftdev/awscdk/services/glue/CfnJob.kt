...
internal constructor(
    ...
    public open fun notificationProperty(
        `value`: NotificationPropertyProperty.Builder.() -> Unit
    ...
    public interface Builder {
         ...
         *
         * @param allocatedCapacity This parameter is no longer supported. Use `MaxCapacity`
         *   instead.
         */
         ...
         * The default arguments for this job, specified as name-value pairs.
         *
         * You can specify arguments here that your own job-execution script consumes, in addition
         * to arguments that AWS Glue itself consumes.
         *
         ...
         *
         * @param defaultArguments The default arguments for this job, specified as name-value
         *   pairs.
         */
         ...
         *
         * Only jobs with AWS Glue version 3.0 and above and command type `glueetl` will be allowed
         * to set `ExecutionClass` to `FLEX` . The flexible execution class is available for Spark
         * jobs.
         *
         ...
         *
         * @param executionClass Indicates whether the job is run with a standard or flexible
         *   execution class.
         */
         ...
         *
         * @param executionProperty The maximum number of concurrent runs that are allowed for this
         *   job.
         */
        ...
        public fun executionProperty(
            executionProperty: ExecutionPropertyProperty.Builder.() -> Unit
        )
        ...
        public fun notificationProperty(
            notificationProperty: NotificationPropertyProperty.Builder.() -> Unit
        )
         ...
         *
         * @param role The name or Amazon Resource Name (ARN) of the IAM role associated with this
         *   job.
         */
         ...
         * The type of predefined worker that is allocated when a job runs.
         *
         * Accepts a value of G.1X, G.2X, G.4X, G.8X or G.025X for Spark jobs. Accepts the value
         * Z.2X for Ray jobs.
         ...
         *   aggregations, joins, and queries. This worker type is available only for AWS Glue
         *   version 3.0 or later Spark ETL jobs in the following AWS Regions: US East (Ohio), US
         ...
         *   this worker type for jobs whose workloads contain your most demanding transforms,
         *   aggregations, joins, and queries. This worker type is available only for AWS Glue
         *   version 3.0 or later Spark ETL jobs, in the same AWS Regions as supported for the
         *   `G.4X` worker type.
         ...
         *   available for AWS Glue version 3.0 streaming jobs.
    ...
    private class BuilderImpl(
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("e22c4a94debded832b280e207ccfc3ce7e6b7f0459e606245076f3a7f950172f")
        override fun executionProperty(
            executionProperty: ExecutionPropertyProperty.Builder.() -> Unit
        ...
        override fun notificationProperty(notificationProperty: NotificationPropertyProperty) {
            cdkBuilder.notificationProperty(
                notificationProperty.let(NotificationPropertyProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("0569ffc070d3bb79ae05f6c91224faed3b0be3d4a2867dccefea5eac85dd1c96")
        override fun notificationProperty(
            notificationProperty: NotificationPropertyProperty.Builder.() -> Unit
    ...
    public interface NotificationPropertyProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: NotificationPropertyProperty
            ): software.amazon.awscdk.services.glue.CfnJob.NotificationPropertyProperty =
    ...
    public interface JobCommandProperty {
         ...
         * `pythonshell` . For an Apache Spark streaming ETL job, this must be `gluestreaming` . For
        ...
        public interface Builder {
            /**
             * @param name The name of the job command. For an Apache Spark ETL job, this must be
             *   `glueetl` . For a Python shell job, it must be `pythonshell` . For an Apache Spark
             *   streaming ETL job, this must be `gluestreaming` . For a Ray job, this must be
             *   `glueray` .
             */
            public fun name(name: String)
            ...
            /**
             * @param runtime In Ray jobs, Runtime is used to specify the versions of Ray, Python
             *   and additional libraries available in your environment. This field is not used in
             *   other job types. For supported runtime environment values, see
             *   [Working with Ray jobs](https://docs.aws.amazon.com/glue/latest/dg/ray-jobs-section.html)
             *   in the AWS Glue Developer Guide.
             */
            ...
            /**
             * @param scriptLocation Specifies the Amazon Simple Storage Service (Amazon S3) path to
             *   a script that executes a job (required).
             */
        ...
        internal constructor(
             ...
             * The name of the job command.
             *
             * For an Apache Spark ETL job, this must be `glueetl` . For a Python shell job, it must
             * be `pythonshell` . For an Apache Spark streaming ETL job, this must be
             ...
             * libraries available in your environment.
             *
             * This field is not used in other job types. For supported runtime environment values,
             * see
             * [Working with Ray jobs](https://docs.aws.amazon.com/glue/latest/dg/ray-jobs-section.html)
             * in the AWS Glue Developer Guide.
             *
    ...
    public interface ConnectionsListProperty {
        ...
        private class BuilderImpl : Builder {
            ...
            /** @param connections A list of connections used by the job. */
            override fun connections(vararg connections: String): Unit =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ConnectionsListProperty
            ): software.amazon.awscdk.services.glue.CfnJob.ConnectionsListProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ExecutionPropertyProperty {
        ...
        public interface Builder {
             ...
             *   The default is 1. An error is returned when this threshold is reached. The maximum
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ExecutionPropertyProperty
            ): software.amazon.awscdk.services.glue.CfnJob.ExecutionPropertyProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
