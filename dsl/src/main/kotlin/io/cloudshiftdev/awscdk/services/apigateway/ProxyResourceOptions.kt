...
public interface ProxyResourceOptions : ResourceOptions {
    ...
    public interface Builder {
        /**
         * @param anyMethod Adds an "ANY" method to this resource. If set to `false`, you will have
         *   to explicitly add methods to this resource after it's created.
         */
         ...
         *   and all child resources. You can add CORS at the resource-level using
         *   `addCorsPreflight`.
         */
