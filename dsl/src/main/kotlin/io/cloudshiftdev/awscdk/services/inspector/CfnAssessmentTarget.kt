...
public open class CfnAssessmentTarget
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param resourceGroupArn The ARN that specifies the resource group that is used to create
