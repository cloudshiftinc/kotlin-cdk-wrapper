...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param defaultCapacityProviderStrategy The default capacity provider strategy to
    ...
    public companion object {
        ...
        internal fun wrap(
            ...
            CfnClusterCapacityProviderAssociations(cdkObject)

        internal fun unwrap(
            wrapped: CfnClusterCapacityProviderAssociations
        ): software.amazon.awscdk.services.ecs.CfnClusterCapacityProviderAssociations =
            wrapped.cdkObject
    }
    ...
    public interface CapacityProviderStrategyProperty {
         ...
         * with a weight of `0` will not be used to place tasks. If you specify multiple capacity
        ...
        public interface Builder {
             ...
             * providers with a weight of `0` will not be used to place tasks. If you specify
             * multiple capacity providers in a strategy that all have a weight of `0` , any
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CapacityProviderStrategyProperty
            ): software.amazon.awscdk.services.ecs.CfnClusterCapacityProviderAssociations.CapacityProviderStrategyProperty =
