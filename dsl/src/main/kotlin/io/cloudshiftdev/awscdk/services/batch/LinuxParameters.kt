...
internal constructor(
    ...
    public interface Builder {
        /**
         * Specifies whether to run an init process inside the container that forwards signals and
         * reaps processes.
         *
         * Default: false
         *
         * @param initProcessEnabled Specifies whether to run an init process inside the container
         ...
         *
         * This parameter is only supported when you are using the EC2 launch type. Accepted values
         ...
         *
         * This parameter maps to the --memory-swappiness option to docker run. The swappiness
         * relates to the kernel's tendency to swap memory. A value of 0 will cause swapping to not
         * happen unless absolutely necessary. A value of 100 will cause pages to be swapped very
         * aggressively.
         *
         * This parameter is only supported when you are using the EC2 launch type. Accepted values
         * are whole numbers between 0 and 100. If a value is not specified for maxSwap then this
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.batch.LinuxParameters =
            cdkBuilder.build()
    }
