...
internal constructor(
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.ec2.CfnTransitGatewayMulticastDomain.Builder.create(
                scope,
                id
            )
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnTransitGatewayMulticastDomain
    ...
    public interface OptionsProperty {
        ...
        /**
         * Specify whether to enable support for statically configuring multicast group sources for
         * a domain.
         *
        ...
        public interface Builder {
            /**
             * @param autoAcceptSharedAssociations Indicates whether to automatically accept
             *   cross-account subnet associations that are associated with the transit gateway
             *   multicast domain.
             */
            public fun autoAcceptSharedAssociations(autoAcceptSharedAssociations: String)

            /**
             * @param igmpv2Support Specify whether to enable Internet Group Management Protocol
             *   (IGMP) version 2 for the transit gateway multicast domain.
             */
            public fun igmpv2Support(igmpv2Support: String)

            /**
             * @param staticSourcesSupport Specify whether to enable support for statically
