...
internal constructor(
     ...
     * ingestion process.
     */
    public open fun customDocumentEnrichmentConfiguration(
        `value`: CustomDocumentEnrichmentConfigurationProperty
    ) {
        unwrap(this)
            .setCustomDocumentEnrichmentConfiguration(
                `value`.let(CustomDocumentEnrichmentConfigurationProperty::unwrap)
            )
    }
    ...
    public open fun customDocumentEnrichmentConfiguration(
        `value`: CustomDocumentEnrichmentConfigurationProperty.Builder.() -> Unit
    ): Unit =
        customDocumentEnrichmentConfiguration(
            CustomDocumentEnrichmentConfigurationProperty(`value`)
        )
    ...
    public open fun dataSourceConfiguration(`value`: DataSourceConfigurationProperty) {
        unwrap(this)
            .setDataSourceConfiguration(`value`.let(DataSourceConfigurationProperty::unwrap))
    }

    /** Configuration information for an Amazon Kendra data source. */
    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("e25b7ed5f0c2564b4215fca214d2846aa61a129e90a366c97a90dfab9cb81eca")
    public open fun dataSourceConfiguration(
        `value`: DataSourceConfigurationProperty.Builder.() -> Unit
    ): Unit = dataSourceConfiguration(DataSourceConfigurationProperty(`value`))
    ...
    public interface Builder {
         ...
         *
         * @param customDocumentEnrichmentConfiguration Configuration information for altering
        ...
        public fun customDocumentEnrichmentConfiguration(
            customDocumentEnrichmentConfiguration:
                CustomDocumentEnrichmentConfigurationProperty.Builder.() -> Unit
        )

        /**
         * Configuration information for an Amazon Kendra data source.
         *
         * The contents of the configuration depend on the type of data source. You can only specify
         * one type of data source in the configuration.
         *
         ...
         *
         * @param dataSourceConfiguration Configuration information for an Amazon Kendra data
         *   source.
         */
        ...
        public fun dataSourceConfiguration(
            dataSourceConfiguration: DataSourceConfigurationProperty.Builder.() -> Unit
        )
         ...
         *
         * @param indexId The identifier of the index you want to use with the data source
         *   connector.
         */
         ...
         * The code for a language.
         *
         * This shows a supported language for all documents in the data source. English is
    ...
    private class BuilderImpl(
         ...
         *   document metadata and content during the document ingestion process.
         */
        override fun customDocumentEnrichmentConfiguration(
            customDocumentEnrichmentConfiguration: IResolvable
        ) {
            cdkBuilder.customDocumentEnrichmentConfiguration(
                customDocumentEnrichmentConfiguration.let(IResolvable::unwrap)
            )
        }
        ...
        override fun customDocumentEnrichmentConfiguration(
            ...
            cdkBuilder.customDocumentEnrichmentConfiguration(
                customDocumentEnrichmentConfiguration.let(
                    CustomDocumentEnrichmentConfigurationProperty::unwrap
                )
            )
        }
        ...
        override fun customDocumentEnrichmentConfiguration(
            ...
            customDocumentEnrichmentConfiguration(
                CustomDocumentEnrichmentConfigurationProperty(customDocumentEnrichmentConfiguration)
            )
         ...
         *   source.
         */
        override fun dataSourceConfiguration(
            dataSourceConfiguration: DataSourceConfigurationProperty
        ) {
            cdkBuilder.dataSourceConfiguration(
                dataSourceConfiguration.let(DataSourceConfigurationProperty::unwrap)
            )
        }
        ...
        public fun build(): software.amazon.awscdk.services.kendra.CfnDataSource =
            cdkBuilder.build()
    }
    ...
    public interface DataSourceVpcConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param securityGroupIds A list of identifiers of security groups within your Amazon
             *   VPC. The security groups should enable Amazon Kendra to connect to the data source.
             */
            ...
            /**
             * @param subnetIds A list of identifiers for subnets within your Amazon VPC. The
             *   subnets should be able to connect to each other in the VPC, and they should have
             *   outgoing access to the Internet through a NAT device.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DataSourceVpcConfigurationProperty
            ): software.amazon.awscdk.services.kendra.CfnDataSource.DataSourceVpcConfigurationProperty =
    ...
    public interface SharePointConfigurationProperty {
         ...
         * the patterns are included in the index. If a document matches both an exclusion pattern
         ...
         */
        public fun exclusionPatterns(): List<String> =
            unwrap(this).getExclusionPatterns() ?: emptyList()

        /**
         * A list of `DataSourceToIndexFieldMapping` objects that map Microsoft SharePoint
         * attributes or fields to Amazon Kendra index fields.
         *
         ...
         * operation before you map SharePoint attributes. For more information, see
         ...
         */
        public fun inclusionPatterns(): List<String> =
            unwrap(this).getInclusionPatterns() ?: emptyList()

        /**
         * The Amazon Resource Name (ARN) of an AWS Secrets Manager secret that contains the user
         * name and password required to connect to the SharePoint instance.
         *
         * For more information, see
         ...
         * the index.
         *
         * Depending on the change log's size, it may take longer for Amazon Kendra to use the
        ...
        public interface Builder {
            ...
            /**
             * @param documentTitleFieldName The Microsoft SharePoint attribute field that contains
             *   the title of the document.
             */
            public fun documentTitleFieldName(documentTitleFieldName: String)

            /**
             * @param exclusionPatterns A list of regular expression patterns. Documents that match
             *   the patterns are excluded from the index. Documents that don't match the patterns
             *   are included in the index. If a document matches both an exclusion pattern and an
            ...
            /**
             * @param fieldMappings A list of `DataSourceToIndexFieldMapping` objects that map
             *   Microsoft SharePoint attributes or fields to Amazon Kendra index fields. You must
             *   first create the index fields using the
             *   [UpdateIndex](https://docs.aws.amazon.com/kendra/latest/dg/API_UpdateIndex.html)
             *   operation before you map SharePoint attributes. For more information, see
             *   [Mapping Data Source Fields](https://docs.aws.amazon.com/kendra/latest/dg/field-mapping.html)
             *   .
            ...
            /**
             * @param inclusionPatterns A list of regular expression patterns to include certain
             *   documents in your SharePoint. Documents that match the patterns are included in the
             *   index. Documents that don't match the patterns are excluded from the index. If a
            ...
            /**
             * @param sslCertificateS3Path Information required to find a specific file in an Amazon
             *   S3 bucket.
             */
            ...
            /**
             * @param useChangeLog `TRUE` to use the SharePoint change log to determine which
             *   documents require updating in the index. Depending on the change log's size, it may
            ...
            public fun vpcConfiguration(
                vpcConfiguration: DataSourceVpcConfigurationProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("2127e493613bd538dabcc5b42d3edd169d9f2c98a2067b34e2faeb5848504144")
            override fun sslCertificateS3Path(
                sslCertificateS3Path: S3PathProperty.Builder.() -> Unit
            ...
            override fun vpcConfiguration(vpcConfiguration: DataSourceVpcConfigurationProperty) {
                cdkBuilder.vpcConfiguration(
                    vpcConfiguration.let(DataSourceVpcConfigurationProperty::unwrap)
                )
            }
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-kendra-datasource-sharepointconfiguration.html#cfn-kendra-datasource-sharepointconfiguration-documenttitlefieldname)
             */
            override fun documentTitleFieldName(): String? =
                unwrap(this).getDocumentTitleFieldName()

            /**
             * A list of regular expression patterns.
             *
             * Documents that match the patterns are excluded from the index. Documents that don't
             * match the patterns are included in the index. If a document matches both an exclusion
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-kendra-datasource-sharepointconfiguration.html#cfn-kendra-datasource-sharepointconfiguration-exclusionpatterns)
             */
            override fun exclusionPatterns(): List<String> =
                unwrap(this).getExclusionPatterns() ?: emptyList()
             ...
             * match the patterns are excluded from the index. If a document matches both an
             * inclusion and exclusion pattern, the exclusion pattern takes precedence and the
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-kendra-datasource-sharepointconfiguration.html#cfn-kendra-datasource-sharepointconfiguration-inclusionpatterns)
             */
            override fun inclusionPatterns(): List<String> =
                unwrap(this).getInclusionPatterns() ?: emptyList()

            /**
             * The Amazon Resource Name (ARN) of an AWS Secrets Manager secret that contains the
             * user name and password required to connect to the SharePoint instance.
             *
             * For more information, see
             * [Microsoft SharePoint](https://docs.aws.amazon.com/kendra/latest/dg/data-source-sharepoint.html)
             * .
            ...
            /**
             * `TRUE` to use the SharePoint change log to determine which documents require updating
             * in the index.
             *
             * Depending on the change log's size, it may take longer for Amazon Kendra to use the
             * change log than to scan all of your documents in SharePoint.
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SharePointConfigurationProperty
            ): software.amazon.awscdk.services.kendra.CfnDataSource.SharePointConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface WebCrawlerConfigurationProperty {
         ...
         *
         * You can connect to websites using basic authentication of user name and password. You use
         * a secret in
         ...
         */
        public fun maxUrlsPerMinuteCrawlRate(): Number? =
         ...
         * that requires basic authentication. To store web proxy credentials, you use a secret in
         * [AWS Secrets Manager](https://docs.aws.amazon.com/secretsmanager/latest/userguide/intro.html)
         * .
         *
         ...
         */
        public fun urlExclusionPatterns(): List<String> =
            unwrap(this).getUrlExclusionPatterns() ?: emptyList()

        /**
         * A list of regular expression patterns to include certain URLs to crawl.
         *
         * URLs that match the patterns are included in the index. URLs that don't match the
         ...
         */
        public fun urlInclusionPatterns(): List<String> =
            unwrap(this).getUrlInclusionPatterns() ?: emptyList()
         ...
         * [Amazon Acceptable Use Policy](https://docs.aws.amazon.com/aup/) and all other Amazon
         * terms. Remember that you must only use Amazon Kendra Web Crawler to index your own
        ...
        public interface Builder {
             ...
             *   websites using authentication. You can connect to websites using basic
             *   authentication of user name and password. You use a secret in
             *   [AWS Secrets Manager](https://docs.aws.amazon.com/secretsmanager/latest/userguide/intro.html)
             *   to store your authentication credentials.
             *
             * You must provide the website host name and port number. For example, the host name of
            ...
            public fun authenticationConfiguration(
                authenticationConfiguration:
                    WebCrawlerAuthenticationConfigurationProperty.Builder.() -> Unit
            )

            /**
             * @param crawlDepth The 'depth' or number of levels from the seed level to crawl. For
             *   example, the seed URL page is depth 1 and any hyperlinks on this page that are also
             *   crawled are depth 2.
             */
             ...
             *   attachment to crawl. Files larger than this size (in MB) are skipped/not crawled.
             *
             * The default maximum size of a web page or attachment is set to 50 MB.
             */
            ...
            /**
             * @param maxLinksPerPage The maximum number of URLs on a web page to include when
            ...
            /**
             * @param maxUrlsPerMinuteCrawlRate The maximum number of URLs crawled per website host
             *   per minute. A minimum of one URL is required.
             *
             * The default maximum number of URLs crawled per website host per minute is 300.
             */
            ...
            /**
             * @param proxyConfiguration Configuration information required to connect to your
             *   internal websites via a web proxy. You must provide the website host name and port
            ...
            public fun proxyConfiguration(
                proxyConfiguration: ProxyConfigurationProperty.Builder.() -> Unit
            )

            /**
             * @param urlExclusionPatterns A list of regular expression patterns to exclude certain
             *   URLs to crawl. URLs that match the patterns are excluded from the index. URLs that
             *   don't match the patterns are included in the index. If a URL matches both an
             *   inclusion and exclusion pattern, the exclusion pattern takes precedence and the URL
            ...
            /**
             * @param urlInclusionPatterns A list of regular expression patterns to include certain
             *   URLs to crawl. URLs that match the patterns are included in the index. URLs that
             *   don't match the patterns are excluded from the index. If a URL matches both an
             *   inclusion and exclusion pattern, the exclusion pattern takes precedence and the URL
             *   file isn't included in the index.
             */
            ...
            /**
             * @param urls Specifies the seed or starting point URLs of the websites or the sitemap
             *   URLs of the websites you want to crawl. You can include website subdomains. You can
             *   list up to 100 seed URLs and up to three sitemap URLs.
             *
             * You can only crawl websites that use the secure communication protocol, Hypertext
             * Transfer Protocol Secure (HTTPS). If you receive an error when crawling a website, it
             * could be that the website is blocked from crawling.
        ...
        private class BuilderImpl : Builder {
            ...
            override fun authenticationConfiguration(
                ...
                cdkBuilder.authenticationConfiguration(
                    authenticationConfiguration.let(
                        WebCrawlerAuthenticationConfigurationProperty::unwrap
                    )
                )
            }
            ...
            override fun authenticationConfiguration(
                ...
                authenticationConfiguration(
                    WebCrawlerAuthenticationConfigurationProperty(authenticationConfiguration)
                )
             ...
             * The default maximum size of a web page or attachment is set to 50 MB.
             */
            override fun maxContentSizePerPageInMegaBytes(
            ...
            override fun proxyConfiguration(proxyConfiguration: ProxyConfigurationProperty) {
                cdkBuilder.proxyConfiguration(
                    proxyConfiguration.let(ProxyConfigurationProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("8ce8baf561a2460e7a66d6a6a4fd470f85e30b1d5ffb8009028dcff89fc3f74e")
            override fun proxyConfiguration(
                proxyConfiguration: ProxyConfigurationProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * The 'depth' or number of levels from the seed level to crawl.
             *
             * For example, the seed URL page is depth 1 and any hyperlinks on this page that are
             ...
             * URLs that match the patterns are excluded from the index. URLs that don't match the
             * patterns are included in the index. If a URL matches both an inclusion and exclusion
             * pattern, the exclusion pattern takes precedence and the URL file isn't included in
             * the index.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-kendra-datasource-webcrawlerconfiguration.html#cfn-kendra-datasource-webcrawlerconfiguration-urlexclusionpatterns)
             */
            override fun urlExclusionPatterns(): List<String> =
                unwrap(this).getUrlExclusionPatterns() ?: emptyList()
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-kendra-datasource-webcrawlerconfiguration.html#cfn-kendra-datasource-webcrawlerconfiguration-urlinclusionpatterns)
             */
            override fun urlInclusionPatterns(): List<String> =
                unwrap(this).getUrlInclusionPatterns() ?: emptyList()
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: WebCrawlerConfigurationProperty
            ): software.amazon.awscdk.services.kendra.CfnDataSource.WebCrawlerConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DocumentAttributeConditionProperty {
        ...
        public interface Builder {
            /**
             * @param conditionDocumentAttributeKey The identifier of the document attribute used
             *   for the condition. For example, 'Source_URI' could be an identifier for the
             *   attribute or metadata field that contains source URIs associated with the
             *   documents.
             *
             * Amazon Kendra currently does not support `_document_body` as an attribute key used
             * for the condition.
             */
            public fun conditionDocumentAttributeKey(conditionDocumentAttributeKey: String)

            /**
             * @param conditionOnValue The value used by the operator. For example, you can specify
             *   the value 'financial' for strings in the 'Source_URI' field that partially match or
             *   contain this value.
             */
            ...
            public fun conditionOnValue(
                conditionOnValue: DocumentAttributeValueProperty.Builder.() -> Unit
            )

            /**
             * @param operator The condition operator. For example, you can use 'Contains' to
             *   partially match a string.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            override fun conditionOnValue(conditionOnValue: DocumentAttributeValueProperty) {
                cdkBuilder.conditionOnValue(
                    conditionOnValue.let(DocumentAttributeValueProperty::unwrap)
                )
            }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DocumentAttributeConditionProperty
            ): software.amazon.awscdk.services.kendra.CfnDataSource.DocumentAttributeConditionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ConfluencePageConfigurationProperty {
        ...
        public interface Builder {
             ...
             *   Kendra index field names. To create custom fields, use the `UpdateIndex` API before
        ...
        internal constructor(
             ...
             * names.
             *
             * To create custom fields, use the `UpdateIndex` API before you map to Confluence
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ConfluencePageConfigurationProperty
            ): software.amazon.awscdk.services.kendra.CfnDataSource.ConfluencePageConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ConfluenceSpaceConfigurationProperty {
         ...
         * queries without user context information may return restricted items from a personal
         * space in their results. For more information, see
         ...
         * If a space is in both the `ExcludeSpaces` and the `IncludeSpaces` list, the space is
         * excluded.
         *
         ...
         * Amazon Kendra logs an error when the data source is synchronized. If a space is in both
         * the `IncludeSpaces` and the `ExcludeSpaces` list, the space is excluded.
         *
        ...
        public interface Builder {
            ...
            /**
             * @param crawlPersonalSpaces `TRUE` to index personal spaces. You can add restrictions
            ...
            /**
             * @param excludeSpaces A list of space keys of Confluence spaces. If you include a key,
             *   the blogs, documents, and attachments in the space are not indexed. If a space is
             *   in both the `ExcludeSpaces` and the `IncludeSpaces` list, the space is excluded.
             */
            ...
            /**
             * @param includeSpaces A list of space keys for Confluence spaces. If you include a
             *   key, the blogs, documents, and attachments in the space are indexed. Spaces that
             *   aren't in the list aren't indexed. A space in the list must exist. Otherwise,
             *   Amazon Kendra logs an error when the data source is synchronized. If a space is in
             *   both the `IncludeSpaces` and the `ExcludeSpaces` list, the space is excluded.
             */
            ...
            /**
             * @param spaceFieldMappings Maps attributes or field names of Confluence spaces to
             *   Amazon Kendra index field names. To create custom fields, use the `UpdateIndex` API
        ...
        internal constructor(
             ...
             * A list of space keys of Confluence spaces.
             *
             * If you include a key, the blogs, documents, and attachments in the space are not
             * indexed. If a space is in both the `ExcludeSpaces` and the `IncludeSpaces` list, the
             * space is excluded.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-kendra-datasource-confluencespaceconfiguration.html#cfn-kendra-datasource-confluencespaceconfiguration-excludespaces)
             */
            override fun excludeSpaces(): List<String> =
                unwrap(this).getExcludeSpaces() ?: emptyList()

            /**
             * A list of space keys for Confluence spaces.
             *
             * If you include a key, the blogs, documents, and attachments in the space are indexed.
             * Spaces that aren't in the list aren't indexed. A space in the list must exist.
             * Otherwise, Amazon Kendra logs an error when the data source is synchronized. If a
             * space is in both the `IncludeSpaces` and the `ExcludeSpaces` list, the space is
             * excluded.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-kendra-datasource-confluencespaceconfiguration.html#cfn-kendra-datasource-confluencespaceconfiguration-includespaces)
             */
            override fun includeSpaces(): List<String> =
                unwrap(this).getIncludeSpaces() ?: emptyList()
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ConfluenceSpaceConfigurationProperty
            ): software.amazon.awscdk.services.kendra.CfnDataSource.ConfluenceSpaceConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ServiceNowConfigurationProperty {
         ...
         * password provided in the AWS Secrets Manager secret in the `SecretArn` field. If you
         * choose `OAUTH2` , Amazon Kendra is authenticated using the credentials of client ID,
         ...
         * the ServiceNow console. For more information, see
         ...
         * and client secret. For more information, see
         * [Using a ServiceNow data source](https://docs.aws.amazon.com/kendra/latest/dg/data-source-servicenow.html)
         * .
         *
         ...
         */
        public fun serviceCatalogConfiguration(): Any? =
        ...
        public interface Builder {
            /**
             * @param authenticationType The type of authentication used to connect to the
             *   ServiceNow instance. If you choose `HTTP_BASIC` , Amazon Kendra is authenticated
             *   using the user name and password provided in the AWS Secrets Manager secret in the
             *   `SecretArn` field. If you choose `OAUTH2` , Amazon Kendra is authenticated using
             *   the credentials of client ID, client secret, user name and password.
             *
            ...
            /**
             * @param hostUrl The ServiceNow instance that the data source connects to. The host
            ...
            public fun knowledgeArticleConfiguration(
                knowledgeArticleConfiguration:
                    ServiceNowKnowledgeArticleConfigurationProperty.Builder.() -> Unit
            )

            /**
             * @param secretArn The Amazon Resource Name (ARN) of the AWS Secrets Manager secret
             *   that contains the user name and password required to connect to the ServiceNow
             *   instance. You can also provide OAuth authentication credentials of user name,
            ...
            /**
             * @param serviceCatalogConfiguration Configuration information for crawling service
             ...
             *   catalogs in the ServiceNow site.
             */
            public fun serviceCatalogConfiguration(
            ...
            public fun serviceCatalogConfiguration(
                serviceCatalogConfiguration:
                    ServiceNowServiceCatalogConfigurationProperty.Builder.() -> Unit
            )

            /**
             * @param serviceNowBuildVersion The identifier of the release that the ServiceNow host
             *   is running. If the host is not running the `LONDON` release, use `OTHERS` .
             */
        ...
        private class BuilderImpl : Builder {
            ...
            override fun knowledgeArticleConfiguration(knowledgeArticleConfiguration: IResolvable) {
                cdkBuilder.knowledgeArticleConfiguration(
                    knowledgeArticleConfiguration.let(IResolvable::unwrap)
                )
            }
             ...
             *   articles in the ServiceNow site.
             */
            override fun knowledgeArticleConfiguration(
                knowledgeArticleConfiguration: ServiceNowKnowledgeArticleConfigurationProperty
            ) {
                cdkBuilder.knowledgeArticleConfiguration(
                    knowledgeArticleConfiguration.let(
                        ServiceNowKnowledgeArticleConfigurationProperty::unwrap
                    )
                )
            }
            ...
            override fun knowledgeArticleConfiguration(
                ...
                knowledgeArticleConfiguration(
                    ServiceNowKnowledgeArticleConfigurationProperty(knowledgeArticleConfiguration)
                )
            ...
            override fun serviceCatalogConfiguration(serviceCatalogConfiguration: IResolvable) {
                cdkBuilder.serviceCatalogConfiguration(
                    serviceCatalogConfiguration.let(IResolvable::unwrap)
                )
            }
             ...
             *   catalogs in the ServiceNow site.
             */
            override fun serviceCatalogConfiguration(
                serviceCatalogConfiguration: ServiceNowServiceCatalogConfigurationProperty
            ) {
                cdkBuilder.serviceCatalogConfiguration(
                    serviceCatalogConfiguration.let(
            ...
            override fun serviceCatalogConfiguration(
                ...
                serviceCatalogConfiguration(
                    ServiceNowServiceCatalogConfigurationProperty(serviceCatalogConfiguration)
                )
        ...
        internal constructor(
             ...
             * ID, and client secret. For more information, see
             * [Using a ServiceNow data source](https://docs.aws.amazon.com/kendra/latest/dg/data-source-servicenow.html)
             * .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-kendra-datasource-servicenowconfiguration.html#cfn-kendra-datasource-servicenowconfiguration-secretarn)
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ServiceNowConfigurationProperty
            ): software.amazon.awscdk.services.kendra.CfnDataSource.ServiceNowConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface WebCrawlerAuthenticationConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param basicAuthentication The list of configuration information that's required to
             *   connect to and crawl a website host using basic authentication credentials. The
             *   list includes the name and port number of the website host.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: WebCrawlerAuthenticationConfigurationProperty
            ): software.amazon.awscdk.services.kendra.CfnDataSource.WebCrawlerAuthenticationConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DocumentAttributeTargetProperty {
         ...
         */
        public fun targetDocumentAttributeValue(): Any? =
        ...
        public interface Builder {
             ...
             *   metadata field. For example, 'Department' could be an identifier for the target
             *   attribute or metadata field that includes the department names associated with the
             *   documents.
             */
            public fun targetDocumentAttributeKey(targetDocumentAttributeKey: String)

            /**
             * @param targetDocumentAttributeValue The target value you want to create for the
             *   target attribute. For example, 'Finance' could be the target value for the target
            ...
            public fun targetDocumentAttributeValue(
                targetDocumentAttributeValue: DocumentAttributeValueProperty.Builder.() -> Unit
            )

            /**
             * @param targetDocumentAttributeValueDeletion `TRUE` to delete the existing target
             *   value for your specified target attribute key. You cannot create a target value and
             *   set this to `TRUE` . To create a target value ( `TargetDocumentAttributeValue` ),
             *   set this to `FALSE` .
             */
        ...
        private class BuilderImpl : Builder {
            ...
            override fun targetDocumentAttributeValue(targetDocumentAttributeValue: IResolvable) {
                cdkBuilder.targetDocumentAttributeValue(
                    targetDocumentAttributeValue.let(IResolvable::unwrap)
                )
            }
             ...
             *   attribute key 'Department'.
             */
            override fun targetDocumentAttributeValue(
                targetDocumentAttributeValue: DocumentAttributeValueProperty
            ) {
                cdkBuilder.targetDocumentAttributeValue(
                    targetDocumentAttributeValue.let(DocumentAttributeValueProperty::unwrap)
                )
            }
            ...
            override fun targetDocumentAttributeValue(
                ...
                targetDocumentAttributeValue(
                    DocumentAttributeValueProperty(targetDocumentAttributeValue)
                )
             ...
             *   set this to `FALSE` .
             */
            override fun targetDocumentAttributeValueDeletion(
                targetDocumentAttributeValueDeletion: Boolean
            ) {
                cdkBuilder.targetDocumentAttributeValueDeletion(
            ...
            override fun targetDocumentAttributeValueDeletion(
                ...
                cdkBuilder.targetDocumentAttributeValueDeletion(
                    targetDocumentAttributeValueDeletion.let(IResolvable::unwrap)
                )
            }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DocumentAttributeTargetProperty
            ): software.amazon.awscdk.services.kendra.CfnDataSource.DocumentAttributeTargetProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SalesforceKnowledgeArticleConfigurationProperty {
        ...
        public interface Builder {
             ...
             */
            public fun customKnowledgeArticleTypeConfigurations(
                customKnowledgeArticleTypeConfigurations: List<Any>
            )
            ...
            /**
             * @param includedStates Specifies the document states that should be included when
             *   Amazon Kendra indexes knowledge articles. You must specify at least one state.
             */
            ...
            /**
             * @param standardKnowledgeArticleTypeConfiguration Configuration information for
             *   standard Salesforce knowledge articles.
             */
            ...
            public fun standardKnowledgeArticleTypeConfiguration(
                standardKnowledgeArticleTypeConfiguration:
                    SalesforceStandardKnowledgeArticleTypeConfigurationProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
             ...
             *   Salesforce knowledge articles.
             */
            override fun customKnowledgeArticleTypeConfigurations(
                customKnowledgeArticleTypeConfigurations: IResolvable
            ) {
                cdkBuilder.customKnowledgeArticleTypeConfigurations(
                    customKnowledgeArticleTypeConfigurations.let(IResolvable::unwrap)
                )
            }
            ...
            override fun customKnowledgeArticleTypeConfigurations(
                ...
                customKnowledgeArticleTypeConfigurations(
                    customKnowledgeArticleTypeConfigurations.toList()
                )
             ...
             *   standard Salesforce knowledge articles.
             */
            override fun standardKnowledgeArticleTypeConfiguration(
                standardKnowledgeArticleTypeConfiguration: IResolvable
            ) {
                cdkBuilder.standardKnowledgeArticleTypeConfiguration(
                    standardKnowledgeArticleTypeConfiguration.let(IResolvable::unwrap)
                )
            }
            ...
            override fun standardKnowledgeArticleTypeConfiguration(
                ...
                cdkBuilder.standardKnowledgeArticleTypeConfiguration(
                    standardKnowledgeArticleTypeConfiguration.let(
                        SalesforceStandardKnowledgeArticleTypeConfigurationProperty::unwrap
                    )
                )
            }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SalesforceKnowledgeArticleConfigurationProperty
            ): software.amazon.awscdk.services.kendra.CfnDataSource.SalesforceKnowledgeArticleConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface TemplateConfigurationProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TemplateConfigurationProperty
            ): software.amazon.awscdk.services.kendra.CfnDataSource.TemplateConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface HookConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param invocationCondition The condition used for when a Lambda function should be
             *   invoked. For example, you can specify a condition that if there are empty date-time
            ...
            public fun invocationCondition(
                invocationCondition: DocumentAttributeConditionProperty.Builder.() -> Unit
            )

            /**
             * @param lambdaArn The Amazon Resource Name (ARN) of a role with permission to run a
            ...
            /**
             * @param s3Bucket Stores the original, raw documents or the structured, parsed
        ...
        private class BuilderImpl : Builder {
             ...
             *   date-time.
             */
            override fun invocationCondition(
                invocationCondition: DocumentAttributeConditionProperty
            ) {
                cdkBuilder.invocationCondition(
                    invocationCondition.let(DocumentAttributeConditionProperty::unwrap)
                )
            }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: HookConfigurationProperty
            ): software.amazon.awscdk.services.kendra.CfnDataSource.HookConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SalesforceCustomKnowledgeArticleTypeConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param documentDataFieldName The name of the field in the custom knowledge article
             *   that contains the document data to index.
             */
            public fun documentDataFieldName(documentDataFieldName: String)

            /**
             * @param documentTitleFieldName The name of the field in the custom knowledge article
             *   that contains the document title.
             */
            public fun documentTitleFieldName(documentTitleFieldName: String)

            /**
             * @param fieldMappings Maps attributes or field names of the custom knowledge article
        ...
        internal constructor(
             ...
             * field names.
             *
             * To create custom fields, use the `UpdateIndex` API before you map to Salesforce
             * fields. For more information, see
             * [Mapping data source fields](https://docs.aws.amazon.com/kendra/latest/dg/field-mapping.html)
             * . The Salesforce data source field names must exist in your Salesforce custom
             * metadata.
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SalesforceCustomKnowledgeArticleTypeConfigurationProperty
            ): software.amazon.awscdk.services.kendra.CfnDataSource.SalesforceCustomKnowledgeArticleTypeConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ConfluenceConfigurationProperty {
         ...
         * pattern, the exclusion pattern takes precedence and the content isn't included in the
         * index.
         *
         ...
         * attachments in your Confluence.
         *
         * Content that matches the patterns are included in the index. Content that doesn't match
         * the patterns is excluded from the index. If content matches both an inclusion and
         * exclusion pattern, the exclusion pattern takes precedence and the content isn't included
         * in the index.
         *
        ...
        /**
         * The Amazon Resource Name (ARN) of an AWS Secrets Manager secret that contains the user
         * name and password required to connect to the Confluence instance.
         *
         ...
         *
         * Use the full URL of the server. For example, *https://server.example.com:port/ * . You
         * can also use an IP address, for example, *https://192.168.1.113/ * .
         *
        ...
        public interface Builder {
            ...
            public fun attachmentConfiguration(
                attachmentConfiguration:
                    ConfluenceAttachmentConfigurationProperty.Builder.() -> Unit
            )
            ...
            public fun blogConfiguration(
                blogConfiguration: ConfluenceBlogConfigurationProperty.Builder.() -> Unit
            )

            /**
             * @param exclusionPatterns A list of regular expression patterns to exclude certain
             *   blog posts, pages, spaces, or attachments in your Confluence. Content that matches
             *   the patterns are excluded from the index. Content that doesn't match the patterns
             *   is included in the index. If content matches both an inclusion and exclusion
             *   pattern, the exclusion pattern takes precedence and the content isn't included in
             *   the index.
             */
            public fun exclusionPatterns(exclusionPatterns: List<String>)
             ...
             * @param inclusionPatterns A list of regular expression patterns to include certain
             *   blog posts, pages, spaces, or attachments in your Confluence. Content that matches
             *   the patterns are included in the index. Content that doesn't match the patterns is
            ...
            public fun pageConfiguration(
                pageConfiguration: ConfluencePageConfigurationProperty.Builder.() -> Unit
            )
            ...
            /**
             * @param serverUrl The URL of your Confluence instance. Use the full URL of the server.
             *   For example, *https://server.example.com:port/ * . You can also use an IP address,
            ...
            public fun spaceConfiguration(
                spaceConfiguration: ConfluenceSpaceConfigurationProperty.Builder.() -> Unit
            )
            ...
            /**
             * @param vpcConfiguration Configuration information for an Amazon Virtual Private Cloud
        ...
        private class BuilderImpl : Builder {
             ...
             *   Confluence blogs and pages.
             */
            override fun attachmentConfiguration(
                attachmentConfiguration: ConfluenceAttachmentConfigurationProperty
            ) {
                cdkBuilder.attachmentConfiguration(
                    attachmentConfiguration.let(ConfluenceAttachmentConfigurationProperty::unwrap)
                )
            }
            ...
            override fun attachmentConfiguration(
                ...
                attachmentConfiguration(
                    ConfluenceAttachmentConfigurationProperty(attachmentConfiguration)
                )
            ...
            override fun blogConfiguration(blogConfiguration: ConfluenceBlogConfigurationProperty) {
                cdkBuilder.blogConfiguration(
                    blogConfiguration.let(ConfluenceBlogConfigurationProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("070d46cbf6cbda26dc2a798fafa2a64869e56ed765b1f8a3f39062df940a515e")
            override fun blogConfiguration(
                blogConfiguration: ConfluenceBlogConfigurationProperty.Builder.() -> Unit
            ...
            override fun pageConfiguration(pageConfiguration: ConfluencePageConfigurationProperty) {
                cdkBuilder.pageConfiguration(
                    pageConfiguration.let(ConfluencePageConfigurationProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("2817f144d572ac768d2a7fb4d11a22d4469a4dded7d9df3a788c1de0ec26a80f")
            override fun pageConfiguration(
                pageConfiguration: ConfluencePageConfigurationProperty.Builder.() -> Unit
             ...
             * @param spaceConfiguration Configuration information for indexing Confluence spaces.
             */
            override fun spaceConfiguration(
                spaceConfiguration: ConfluenceSpaceConfigurationProperty
            ) {
                cdkBuilder.spaceConfiguration(
                    spaceConfiguration.let(ConfluenceSpaceConfigurationProperty::unwrap)
                )
            }
        ...
        internal constructor(
             ...
             * or attachments in your Confluence.
             *
             * Content that matches the patterns are excluded from the index. Content that doesn't
             * match the patterns is included in the index. If content matches both an inclusion and
             * exclusion pattern, the exclusion pattern takes precedence and the content isn't
             * included in the index.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-kendra-datasource-confluenceconfiguration.html#cfn-kendra-datasource-confluenceconfiguration-exclusionpatterns)
             */
             ...
             * or attachments in your Confluence.
             *
             * Content that matches the patterns are included in the index. Content that doesn't
             * match the patterns is excluded from the index. If content matches both an inclusion
             * and exclusion pattern, the exclusion pattern takes precedence and the content isn't
             * included in the index.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-kendra-datasource-confluenceconfiguration.html#cfn-kendra-datasource-confluenceconfiguration-inclusionpatterns)
             */
            ...
            /**
             * The Amazon Resource Name (ARN) of an AWS Secrets Manager secret that contains the
             * user name and password required to connect to the Confluence instance.
             *
             * If you use Confluence Cloud, you use a generated API token as the password.
             *
             * You can also provide authentication credentials in the form of a personal access
             ...
             * The URL of your Confluence instance.
             *
             * Use the full URL of the server. For example, *https://server.example.com:port/ * .
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ConfluenceConfigurationProperty
            ): software.amazon.awscdk.services.kendra.CfnDataSource.ConfluenceConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SalesforceStandardKnowledgeArticleTypeConfigurationProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param fieldMappings Maps attributes or field names of the knowledge article to
             *   Amazon Kendra index field names. To create custom fields, use the `UpdateIndex` API
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SalesforceStandardKnowledgeArticleTypeConfigurationProperty
            ): software.amazon.awscdk.services.kendra.CfnDataSource.SalesforceStandardKnowledgeArticleTypeConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DataSourceToIndexFieldMappingProperty {
         ...
         *
         * If the field specified in `DataSourceFieldName` is a date field, you must specify the
        ...
        public interface Builder {
            /**
             * @param dataSourceFieldName The name of the field in the data source. You must first
             *   create the index field using the `UpdateIndex` API.
             */
            public fun dataSourceFieldName(dataSourceFieldName: String)

            /**
             * @param dateFieldFormat The format for date fields in the data source. If the field
             *   specified in `DataSourceFieldName` is a date field, you must specify the date
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DataSourceToIndexFieldMappingProperty
            ): software.amazon.awscdk.services.kendra.CfnDataSource.DataSourceToIndexFieldMappingProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DocumentAttributeValueProperty {
        ...
        public fun stringListValue(): List<String> =
            unwrap(this).getStringListValue() ?: emptyList()
        ...
        public interface Builder {
            /**
             * @param dateValue A date expressed as an ISO 8601 string. It is important for the time
            ...
            /**
             * @param stringListValue A list of strings. The default maximum length or number of
             *   strings is 10.
             */
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-kendra-datasource-documentattributevalue.html#cfn-kendra-datasource-documentattributevalue-stringlistvalue)
             */
            override fun stringListValue(): List<String> =
                unwrap(this).getStringListValue() ?: emptyList()
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DocumentAttributeValueProperty
            ): software.amazon.awscdk.services.kendra.CfnDataSource.DocumentAttributeValueProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface OneDriveConfigurationProperty {
        ...
        /**
         * The Amazon Resource Name (ARN) of an AWS Secrets Manager secret that contains the user
         * name and password to connect to OneDrive.
         *
        ...
        public interface Builder {
            ...
            /**
             * @param exclusionPatterns A list of regular expression patterns to exclude certain
             *   documents in your OneDrive. Documents that match the patterns are excluded from the
             *   index. Documents that don't match the patterns are included in the index. If a
             *   document matches both an inclusion and exclusion pattern, the exclusion pattern
             *   takes precedence and the document isn't included in the index.
             *
             * The pattern is applied to the file name.
            ...
            /**
             * @param fieldMappings A list of `DataSourceToIndexFieldMapping` objects that map
             *   OneDrive data source attributes or field names to Amazon Kendra index field names.
             *   To create custom fields, use the `UpdateIndex` API before you map to OneDrive
             *   fields. For more information, see
             *   [Mapping data source fields](https://docs.aws.amazon.com/kendra/latest/dg/field-mapping.html)
             *   . The OneDrive data source field names must exist in your OneDrive custom metadata.
             */
            ...
            /**
             * @param inclusionPatterns A list of regular expression patterns to include certain
             *   documents in your OneDrive. Documents that match the patterns are included in the
             *   index. Documents that don't match the patterns are excluded from the index. If a
             *   document matches both an inclusion and exclusion pattern, the exclusion pattern
             *   takes precedence and the document isn't included in the index.
             *
            ...
            /**
             * @param secretArn The Amazon Resource Name (ARN) of an AWS Secrets Manager secret that
             *   contains the user name and password to connect to OneDrive. The user name should be
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("832281f44d77ef71aa969c9a77c034c404ef104bce394194024f7c50f951f426")
            override fun oneDriveUsers(
                oneDriveUsers: OneDriveUsersProperty.Builder.() -> Unit
            ): Unit = oneDriveUsers(OneDriveUsersProperty(oneDriveUsers))
        ...
        internal constructor(
             ...
             * attributes or field names to Amazon Kendra index field names.
             *
             * To create custom fields, use the `UpdateIndex` API before you map to OneDrive fields.
             * For more information, see
             * [Mapping data source fields](https://docs.aws.amazon.com/kendra/latest/dg/field-mapping.html)
             * . The OneDrive data source field names must exist in your OneDrive custom metadata.
             *
            ...
            /**
             * The Amazon Resource Name (ARN) of an AWS Secrets Manager secret that contains the
             * user name and password to connect to OneDrive.
             *
             * The user name should be the application ID for the OneDrive application, and the
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: OneDriveConfigurationProperty
            ): software.amazon.awscdk.services.kendra.CfnDataSource.OneDriveConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface OneDriveUsersProperty {
         ...
         */
        public fun oneDriveUserList(): List<String> =
            unwrap(this).getOneDriveUserList() ?: emptyList()
        ...
        public interface Builder {
            /**
             * @param oneDriveUserList A list of users whose documents should be indexed. Specify
             *   the user names in email format, for example, `username&#64;tenantdomain` . If you
             *   need to index the documents of more than 100 users, use the `OneDriveUserS3Path`
            ...
            /**
             * @param oneDriveUserS3Path The S3 bucket location of a file containing a list of users
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("e0519f8aec787b99317fd3af06d3c129b2799c34b41915b30d58c5df23c3e66a")
            override fun oneDriveUserS3Path(
                oneDriveUserS3Path: S3PathProperty.Builder.() -> Unit
            ): Unit = oneDriveUserS3Path(S3PathProperty(oneDriveUserS3Path))
        ...
        internal constructor(
             ...
             * A list of users whose documents should be indexed.
             *
             * Specify the user names in email format, for example, `username&#64;tenantdomain` . If
             * you need to index the documents of more than 100 users, use the `OneDriveUserS3Path`
             * field to specify the location of a file containing a list of users.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-kendra-datasource-onedriveusers.html#cfn-kendra-datasource-onedriveusers-onedriveuserlist)
             */
            override fun oneDriveUserList(): List<String> =
                unwrap(this).getOneDriveUserList() ?: emptyList()
    ...
    public interface CustomDocumentEnrichmentConfigurationProperty {
         ...
         *
         * You can use a Lambda function to apply advanced logic for creating, modifying, or
        ...
        public interface Builder {
            ...
            /**
             * @param postExtractionHookConfiguration Configuration information for invoking a
             *   Lambda function in AWS Lambda on the structured documents with their metadata and
             *   text extracted. You can use a Lambda function to apply advanced logic for creating,
             *   modifying, or deleting document metadata and content. For more information, see
             *   [Advanced data manipulation](https://docs.aws.amazon.com/kendra/latest/dg/custom-document-enrichment.html#advanced-data-manipulation)
             *   .
             */
             ...
             *   .
             */
            public fun postExtractionHookConfiguration(
            ...
            public fun postExtractionHookConfiguration(
                postExtractionHookConfiguration: HookConfigurationProperty.Builder.() -> Unit
            )

            /**
             * @param preExtractionHookConfiguration Configuration information for invoking a Lambda
             *   function in AWS Lambda on the original or raw documents before extracting their
             *   metadata and text. You can use a Lambda function to apply advanced logic for
             *   creating, modifying, or deleting document metadata and content. For more
             *   information, see
             *   [Advanced data manipulation](https://docs.aws.amazon.com/kendra/latest/dg/custom-document-enrichment.html#advanced-data-manipulation)
             *   .
             */
             ...
             *   .
             */
            public fun preExtractionHookConfiguration(
            ...
            public fun preExtractionHookConfiguration(
                preExtractionHookConfiguration: HookConfigurationProperty.Builder.() -> Unit
            )
        ...
        private class BuilderImpl : Builder {
             ...
             *   .
             */
            override fun postExtractionHookConfiguration(
                postExtractionHookConfiguration: IResolvable
            ) {
                cdkBuilder.postExtractionHookConfiguration(
                    postExtractionHookConfiguration.let(IResolvable::unwrap)
                )
            }
            ...
            override fun postExtractionHookConfiguration(
                ...
                cdkBuilder.postExtractionHookConfiguration(
                    postExtractionHookConfiguration.let(HookConfigurationProperty::unwrap)
                )
            }
            ...
            override fun postExtractionHookConfiguration(
                ...
                postExtractionHookConfiguration(
                    HookConfigurationProperty(postExtractionHookConfiguration)
                )
             ...
             *   .
             */
            override fun preExtractionHookConfiguration(
                preExtractionHookConfiguration: IResolvable
            ) {
                cdkBuilder.preExtractionHookConfiguration(
                    preExtractionHookConfiguration.let(IResolvable::unwrap)
                )
            }
            ...
            override fun preExtractionHookConfiguration(
                ...
                cdkBuilder.preExtractionHookConfiguration(
                    preExtractionHookConfiguration.let(HookConfigurationProperty::unwrap)
                )
            }
            ...
            override fun preExtractionHookConfiguration(
                ...
                preExtractionHookConfiguration(
                    HookConfigurationProperty(preExtractionHookConfiguration)
                )
        ...
        internal constructor(
            ...
            /**
             * Configuration information for invoking a Lambda function in AWS Lambda on the
             * structured documents with their metadata and text extracted.
             *
             * You can use a Lambda function to apply advanced logic for creating, modifying, or
             * deleting document metadata and content. For more information, see
             * [Advanced data manipulation](https://docs.aws.amazon.com/kendra/latest/dg/custom-document-enrichment.html#advanced-data-manipulation)
            ...
            /**
             * Configuration information for invoking a Lambda function in AWS Lambda on the
             * original or raw documents before extracting their metadata and text.
             *
             * You can use a Lambda function to apply advanced logic for creating, modifying, or
             * deleting document metadata and content. For more information, see
             * [Advanced data manipulation](https://docs.aws.amazon.com/kendra/latest/dg/custom-document-enrichment.html#advanced-data-manipulation)
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CustomDocumentEnrichmentConfigurationProperty
            ): software.amazon.awscdk.services.kendra.CfnDataSource.CustomDocumentEnrichmentConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SalesforceChatterFeedConfigurationProperty {
         ...
         * indexed. When you specify `STANDARD_USER` only documents for Salesforce standard users
         ...
         */
        public fun includeFilterTypes(): List<String> =
            unwrap(this).getIncludeFilterTypes() ?: emptyList()

        /** A builder for [SalesforceChatterFeedConfigurationProperty] */
        @CdkDslMarker
        public interface Builder {
            /**
             * @param documentDataFieldName The name of the column in the Salesforce FeedItem table
             *   that contains the content to index. Typically this is the `Body` column.
             */
            public fun documentDataFieldName(documentDataFieldName: String)

            /**
             * @param documentTitleFieldName The name of the column in the Salesforce FeedItem table
             *   that contains the title of the document. This is typically the `Title` column.
             */
            public fun documentTitleFieldName(documentTitleFieldName: String)

            /**
             * @param fieldMappings Maps fields from a Salesforce chatter feed into Amazon Kendra
             *   index fields.
             */
            public fun fieldMappings(fieldMappings: IResolvable)
            ...
            /**
             * @param includeFilterTypes Filters the documents in the feed based on status of the
             *   user. When you specify `ACTIVE_USERS` only documents from users who have an active
             *   account are indexed. When you specify `STANDARD_USER` only documents for Salesforce
        ...
        internal constructor(
             ...
             * Filters the documents in the feed based on status of the user.
             *
             * When you specify `ACTIVE_USERS` only documents from users who have an active account
             * are indexed. When you specify `STANDARD_USER` only documents for Salesforce standard
             * users are documented. You can specify both.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-kendra-datasource-salesforcechatterfeedconfiguration.html#cfn-kendra-datasource-salesforcechatterfeedconfiguration-includefiltertypes)
             */
            override fun includeFilterTypes(): List<String> =
                unwrap(this).getIncludeFilterTypes() ?: emptyList()
        }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SalesforceChatterFeedConfigurationProperty
            ): software.amazon.awscdk.services.kendra.CfnDataSource.SalesforceChatterFeedConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ServiceNowServiceCatalogConfigurationProperty {
         ...
         * ServiceNow.
         *
         * Item that match the patterns are included in the index. Items that don't match the
        ...
        public interface Builder {
            ...
            /**
             * @param documentDataFieldName The name of the ServiceNow field that is mapped to the
             *   index document contents field in the Amazon Kendra index.
             */
            public fun documentDataFieldName(documentDataFieldName: String)

            /**
             * @param documentTitleFieldName The name of the ServiceNow field that is mapped to the
             ...
             *   certain attachments of catalogs in your ServiceNow. Item that match the patterns
             *   are excluded from the index. Items that don't match the patterns are included in
            ...
            /**
             * @param fieldMappings Maps attributes or field names of catalogs to Amazon Kendra
             *   index field names. To create custom fields, use the `UpdateIndex` API before you
             *   map to ServiceNow fields. For more information, see
             *   [Mapping data source fields](https://docs.aws.amazon.com/kendra/latest/dg/field-mapping.html)
             ...
             *   certain attachments of catalogs in your ServiceNow. Item that match the patterns
             *   are included in the index. Items that don't match the patterns are excluded from
             *   the index. If an item matches both an inclusion and exclusion pattern, the
             *   exclusion pattern takes precedence and the item isn't included in the index.
             *
             * The regex is applied to the file name of the attachment.
        ...
        private class BuilderImpl : Builder {
             ...
             * The regex is applied to the file name of the attachment.
             */
            override fun excludeAttachmentFilePatterns(
             ...
             */
            override fun excludeAttachmentFilePatterns(
                vararg excludeAttachmentFilePatterns: String
            ): Unit = excludeAttachmentFilePatterns(excludeAttachmentFilePatterns.toList())
             ...
             * The regex is applied to the file name of the attachment.
             */
            override fun includeAttachmentFilePatterns(
             ...
             */
            override fun includeAttachmentFilePatterns(
                vararg includeAttachmentFilePatterns: String
            ): Unit = includeAttachmentFilePatterns(includeAttachmentFilePatterns.toList())
        ...
        internal constructor(
             ...
             *
             * Item that match the patterns are included in the index. Items that don't match the
             * patterns are excluded from the index. If an item matches both an inclusion and
             * exclusion pattern, the exclusion pattern takes precedence and the item isn't included
             * in the index.
             *
             * The regex is applied to the file name of the attachment.
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ServiceNowServiceCatalogConfigurationProperty
            ): software.amazon.awscdk.services.kendra.CfnDataSource.ServiceNowServiceCatalogConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DocumentsMetadataConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param s3Prefix A prefix used to filter metadata configuration files in the AWS S3
             *   bucket. The S3 bucket might contain multiple metadata files. Use `S3Prefix` to
        ...
        internal constructor(
             ...
             * A prefix used to filter metadata configuration files in the AWS S3 bucket.
             *
             * The S3 bucket might contain multiple metadata files. Use `S3Prefix` to include only
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DocumentsMetadataConfigurationProperty
            ): software.amazon.awscdk.services.kendra.CfnDataSource.DocumentsMetadataConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DataSourceConfigurationProperty {
        ...
        public interface Builder {
            ...
            public fun confluenceConfiguration(
                confluenceConfiguration: ConfluenceConfigurationProperty.Builder.() -> Unit
            )
            ...
            public fun databaseConfiguration(
                databaseConfiguration: DatabaseConfigurationProperty.Builder.() -> Unit
            )

            /**
             * @param googleDriveConfiguration Provides the configuration information to connect to
            ...
            public fun googleDriveConfiguration(
                googleDriveConfiguration: GoogleDriveConfigurationProperty.Builder.() -> Unit
            )

            /**
             * @param oneDriveConfiguration Provides the configuration information to connect to
             *   Microsoft OneDrive as your data source.
             */
            ...
            public fun oneDriveConfiguration(
                oneDriveConfiguration: OneDriveConfigurationProperty.Builder.() -> Unit
            )

            /**
             * @param s3Configuration Provides the configuration information to connect to an Amazon
            ...
            public fun s3Configuration(
                s3Configuration: S3DataSourceConfigurationProperty.Builder.() -> Unit
            )
            ...
            public fun salesforceConfiguration(
                salesforceConfiguration: SalesforceConfigurationProperty.Builder.() -> Unit
            )
            ...
            public fun serviceNowConfiguration(
                serviceNowConfiguration: ServiceNowConfigurationProperty.Builder.() -> Unit
            )
            ...
            public fun sharePointConfiguration(
                sharePointConfiguration: SharePointConfigurationProperty.Builder.() -> Unit
            )
            ...
            public fun templateConfiguration(
                templateConfiguration: TemplateConfigurationProperty.Builder.() -> Unit
            )

            /**
             * @param webCrawlerConfiguration Provides the configuration information required for
            ...
            public fun webCrawlerConfiguration(
                webCrawlerConfiguration: WebCrawlerConfigurationProperty.Builder.() -> Unit
            )

            /**
             * @param workDocsConfiguration Provides the configuration information to connect to
             *   Amazon WorkDocs as your data source.
             */
            ...
            public fun workDocsConfiguration(
                workDocsConfiguration: WorkDocsConfigurationProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
             ...
             *   Confluence as your data source.
             */
            override fun confluenceConfiguration(
                confluenceConfiguration: ConfluenceConfigurationProperty
            ) {
                cdkBuilder.confluenceConfiguration(
                    confluenceConfiguration.let(ConfluenceConfigurationProperty::unwrap)
                )
            }
            ...
            override fun confluenceConfiguration(
                ...
                confluenceConfiguration(ConfluenceConfigurationProperty(confluenceConfiguration))
             ...
             *   database as your data source.
             */
            override fun databaseConfiguration(
                databaseConfiguration: DatabaseConfigurationProperty
            ) {
                cdkBuilder.databaseConfiguration(
                    databaseConfiguration.let(DatabaseConfigurationProperty::unwrap)
                )
            }
            ...
            override fun googleDriveConfiguration(googleDriveConfiguration: IResolvable) {
                cdkBuilder.googleDriveConfiguration(
                    googleDriveConfiguration.let(IResolvable::unwrap)
                )
            }
             ...
             *   Google Drive as your data source.
             */
            override fun googleDriveConfiguration(
                googleDriveConfiguration: GoogleDriveConfigurationProperty
            ) {
                cdkBuilder.googleDriveConfiguration(
                    googleDriveConfiguration.let(GoogleDriveConfigurationProperty::unwrap)
                )
            }
             ...
             *   Microsoft OneDrive as your data source.
             */
            override fun oneDriveConfiguration(
                oneDriveConfiguration: OneDriveConfigurationProperty
            ) {
                cdkBuilder.oneDriveConfiguration(
                    oneDriveConfiguration.let(OneDriveConfigurationProperty::unwrap)
                )
            }
            ...
            override fun s3Configuration(s3Configuration: S3DataSourceConfigurationProperty) {
                cdkBuilder.s3Configuration(
                    s3Configuration.let(S3DataSourceConfigurationProperty::unwrap)
                )
            }
             ...
             *   Salesforce as your data source.
             */
            override fun salesforceConfiguration(
                salesforceConfiguration: SalesforceConfigurationProperty
            ) {
                cdkBuilder.salesforceConfiguration(
                    salesforceConfiguration.let(SalesforceConfigurationProperty::unwrap)
                )
            }
            ...
            override fun salesforceConfiguration(
                ...
                salesforceConfiguration(SalesforceConfigurationProperty(salesforceConfiguration))
             ...
             *   ServiceNow as your data source.
             */
            override fun serviceNowConfiguration(
                serviceNowConfiguration: ServiceNowConfigurationProperty
            ) {
                cdkBuilder.serviceNowConfiguration(
                    serviceNowConfiguration.let(ServiceNowConfigurationProperty::unwrap)
                )
            }
            ...
            override fun serviceNowConfiguration(
                ...
                serviceNowConfiguration(ServiceNowConfigurationProperty(serviceNowConfiguration))
             ...
             *   Microsoft SharePoint as your data source.
             */
            override fun sharePointConfiguration(
                sharePointConfiguration: SharePointConfigurationProperty
            ) {
                cdkBuilder.sharePointConfiguration(
                    sharePointConfiguration.let(SharePointConfigurationProperty::unwrap)
                )
            }
            ...
            override fun sharePointConfiguration(
                ...
                sharePointConfiguration(SharePointConfigurationProperty(sharePointConfiguration))
            ...
            /** @param templateConfiguration the value to be set. */
            override fun templateConfiguration(
                templateConfiguration: TemplateConfigurationProperty
            ) {
                cdkBuilder.templateConfiguration(
                    templateConfiguration.let(TemplateConfigurationProperty::unwrap)
                )
            }
             ...
             *   Amazon Kendra Web Crawler.
             */
            override fun webCrawlerConfiguration(
                webCrawlerConfiguration: WebCrawlerConfigurationProperty
            ) {
                cdkBuilder.webCrawlerConfiguration(
                    webCrawlerConfiguration.let(WebCrawlerConfigurationProperty::unwrap)
                )
            }
            ...
            override fun webCrawlerConfiguration(
                ...
                webCrawlerConfiguration(WebCrawlerConfigurationProperty(webCrawlerConfiguration))
             ...
             *   Amazon WorkDocs as your data source.
             */
            override fun workDocsConfiguration(
                workDocsConfiguration: WorkDocsConfigurationProperty
            ) {
                cdkBuilder.workDocsConfiguration(
                    workDocsConfiguration.let(WorkDocsConfigurationProperty::unwrap)
                )
            }
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-kendra-datasource-datasourceconfiguration.html#cfn-kendra-datasource-datasourceconfiguration-googledriveconfiguration)
             */
            override fun googleDriveConfiguration(): Any? =
                unwrap(this).getGoogleDriveConfiguration()
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DataSourceConfigurationProperty
            ): software.amazon.awscdk.services.kendra.CfnDataSource.DataSourceConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SalesforceStandardObjectConfigurationProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param fieldMappings Maps attributes or field names of the standard object to Amazon
             *   Kendra index field names. To create custom fields, use the `UpdateIndex` API before
             *   you map to Salesforce fields. For more information, see
             *   [Mapping data source fields](https://docs.aws.amazon.com/kendra/latest/dg/field-mapping.html)
             *   . The Salesforce data source field names must exist in your Salesforce custom
             *   metadata.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SalesforceStandardObjectConfigurationProperty
            ): software.amazon.awscdk.services.kendra.CfnDataSource.SalesforceStandardObjectConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface WebCrawlerSiteMapsConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param siteMaps The list of sitemap URLs of the websites you want to crawl. The list
             *   can include a maximum of three sitemap URLs.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: WebCrawlerSiteMapsConfigurationProperty
            ): software.amazon.awscdk.services.kendra.CfnDataSource.WebCrawlerSiteMapsConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ConnectionConfigurationProperty {
         ...
         * . For more information about AWS Secrets Manager , see
        ...
        public interface Builder {
            /**
             * @param databaseHost The name of the host for the database. Can be either a string
             ...
             *   Manager . The credentials should be a user/password pair. For more information, see
             *   [Using a Database Data Source](https://docs.aws.amazon.com/kendra/latest/dg/data-source-database.html)
             *   . For more information about AWS Secrets Manager , see
             *   [What Is AWS Secrets Manager](https://docs.aws.amazon.com/secretsmanager/latest/userguide/intro.html)
             *   in the *AWS Secrets Manager* user guide.
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ConnectionConfigurationProperty
            ): software.amazon.awscdk.services.kendra.CfnDataSource.ConnectionConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface WorkDocsConfigurationProperty {
         ...
         *
         * Including comments in your index means each comment is a document that can be searched
         * on.
         *
         ...
         * fields. For more information, see
         * [Mapping data source fields](https://docs.aws.amazon.com/kendra/latest/dg/field-mapping.html)
         * . The Amazon WorkDocs data source field names must exist in your Amazon WorkDocs custom
         * metadata.
         *
         ...
         * [AWS Directory Service](https://docs.aws.amazon.com/directoryservicev2/) by going to
         * *Active Directory* , then *Directories* . Your Amazon WorkDocs site directory has an ID,
         * which is the organization ID. You can also set up a new Amazon WorkDocs directory in the
         * AWS Directory Service console and enable a Amazon WorkDocs site for the directory in the
         ...
         *
         * Depending on the change log's size, it may take longer for Amazon Kendra to use the
         * change log than to scan all of your documents in Amazon WorkDocs.
         *
        ...
        public interface Builder {
            /**
             * @param crawlComments `TRUE` to include comments on documents in your index. Including
             *   comments in your index means each comment is a document that can be searched on.
             *
             * The default is set to `FALSE` .
             */
            ...
            /**
             * @param exclusionPatterns A list of regular expression patterns to exclude certain
             *   files in your Amazon WorkDocs site repository. Files that match the patterns are
             *   excluded from the index. Files that don’t match the patterns are included in the
             *   index. If a file matches both an inclusion and exclusion pattern, the exclusion
            ...
            /**
             * @param fieldMappings A list of `DataSourceToIndexFieldMapping` objects that map
             *   Amazon WorkDocs data source attributes or field names to Amazon Kendra index field
             *   names. To create custom fields, use the `UpdateIndex` API before you map to Amazon
             *   WorkDocs fields. For more information, see
             *   [Mapping data source fields](https://docs.aws.amazon.com/kendra/latest/dg/field-mapping.html)
            ...
            /**
             * @param organizationId The identifier of the directory corresponding to your Amazon
             *   WorkDocs site repository. You can find the organization ID in the
             *   [AWS Directory Service](https://docs.aws.amazon.com/directoryservicev2/) by going
             *   to *Active Directory* , then *Directories* . Your Amazon WorkDocs site directory
             *   has an ID, which is the organization ID. You can also set up a new Amazon WorkDocs
        ...
        internal constructor(
             ...
             * `TRUE` to include comments on documents in your index.
             *
             * Including comments in your index means each comment is a document that can be
             * searched on.
             *
             * The default is set to `FALSE` .
             *
             ...
             * You can find the organization ID in the
             * [AWS Directory Service](https://docs.aws.amazon.com/directoryservicev2/) by going to
             * *Active Directory* , then *Directories* . Your Amazon WorkDocs site directory has an
             * ID, which is the organization ID. You can also set up a new Amazon WorkDocs directory
             * in the AWS Directory Service console and enable a Amazon WorkDocs site for the
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: WorkDocsConfigurationProperty
            ): software.amazon.awscdk.services.kendra.CfnDataSource.WorkDocsConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SalesforceConfigurationProperty {
        ...
        /**
         * The Amazon Resource Name (ARN) of an AWS Secrets Manager secret that contains the
         * key/value pairs required to connect to your Salesforce instance.
         *
         ...
         * * securityToken - The token associated with the user logging in to the Salesforce
         *   instance.
         ...
         */
        public fun standardObjectConfigurations(): Any? =
        ...
        public interface Builder {
            /**
             * @param chatterFeedConfiguration Configuration information for Salesforce chatter
             *   feeds.
             */
            ...
            public fun chatterFeedConfiguration(
                chatterFeedConfiguration:
                    SalesforceChatterFeedConfigurationProperty.Builder.() -> Unit
            )
            ...
            /**
             * @param excludeAttachmentFilePatterns A list of regular expression patterns to exclude
             *   certain documents in your Salesforce. Documents that match the patterns are
             *   excluded from the index. Documents that don't match the patterns are included in
             *   the index. If a document matches both an inclusion and exclusion pattern, the
             *   exclusion pattern takes precedence and the document isn't included in the index.
             *
             * The pattern is applied to the name of the attached file.
             */
            public fun excludeAttachmentFilePatterns(excludeAttachmentFilePatterns: List<String>)
            ...
            /**
             * @param knowledgeArticleConfiguration Configuration information for the knowledge
             *   article types that Amazon Kendra indexes. Amazon Kendra indexes standard knowledge
             *   articles and the standard fields of knowledge articles, or the custom fields of
            ...
            public fun knowledgeArticleConfiguration(
                knowledgeArticleConfiguration:
                    SalesforceKnowledgeArticleConfigurationProperty.Builder.() -> Unit
            )

            /**
             * @param secretArn The Amazon Resource Name (ARN) of an AWS Secrets Manager secret that
             *   contains the key/value pairs required to connect to your Salesforce instance. The
            ...
            public fun standardObjectAttachmentConfiguration(
                standardObjectAttachmentConfiguration:
                    SalesforceStandardObjectAttachmentConfigurationProperty.Builder.() -> Unit
            )

            /**
             * @param standardObjectConfigurations Configuration of the Salesforce standard objects
        ...
        private class BuilderImpl : Builder {
            ...
            override fun chatterFeedConfiguration(chatterFeedConfiguration: IResolvable) {
                cdkBuilder.chatterFeedConfiguration(
                    chatterFeedConfiguration.let(IResolvable::unwrap)
                )
            }
             ...
             *   feeds.
             */
            override fun chatterFeedConfiguration(
                chatterFeedConfiguration: SalesforceChatterFeedConfigurationProperty
            ) {
                cdkBuilder.chatterFeedConfiguration(
                    chatterFeedConfiguration.let(SalesforceChatterFeedConfigurationProperty::unwrap)
                )
            }
            ...
            override fun chatterFeedConfiguration(
                ...
                chatterFeedConfiguration(
                    SalesforceChatterFeedConfigurationProperty(chatterFeedConfiguration)
                )
            ...
            override fun knowledgeArticleConfiguration(
                ...
                cdkBuilder.knowledgeArticleConfiguration(
                    knowledgeArticleConfiguration.let(
                        SalesforceKnowledgeArticleConfigurationProperty::unwrap
                    )
                )
            }
            ...
            override fun knowledgeArticleConfiguration(
                ...
                knowledgeArticleConfiguration(
                    SalesforceKnowledgeArticleConfigurationProperty(knowledgeArticleConfiguration)
                )
             ...
             *   attachments to Salesforce standard objects.
             */
            override fun standardObjectAttachmentConfiguration(
                standardObjectAttachmentConfiguration: IResolvable
            ) {
                cdkBuilder.standardObjectAttachmentConfiguration(
                    standardObjectAttachmentConfiguration.let(IResolvable::unwrap)
                )
            }
            ...
            override fun standardObjectAttachmentConfiguration(
                ...
                cdkBuilder.standardObjectAttachmentConfiguration(
                    standardObjectAttachmentConfiguration.let(
                        SalesforceStandardObjectAttachmentConfigurationProperty::unwrap
                    )
                )
            }
            ...
            override fun standardObjectConfigurations(standardObjectConfigurations: IResolvable) {
                cdkBuilder.standardObjectConfigurations(
                    standardObjectConfigurations.let(IResolvable::unwrap)
                )
            }
             ...
             *   that Amazon Kendra indexes.
             */
            override fun standardObjectConfigurations(
                vararg standardObjectConfigurations: Any
            ): Unit = standardObjectConfigurations(standardObjectConfigurations.toList())
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-kendra-datasource-salesforceconfiguration.html#cfn-kendra-datasource-salesforceconfiguration-chatterfeedconfiguration)
             */
            override fun chatterFeedConfiguration(): Any? =
                unwrap(this).getChatterFeedConfiguration()
             ...
             * Configuration information for the knowledge article types that Amazon Kendra indexes.
             *
             * Amazon Kendra indexes standard knowledge articles and the standard fields of
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SalesforceConfigurationProperty
            ): software.amazon.awscdk.services.kendra.CfnDataSource.SalesforceConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface AclConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param allowedGroupsColumnName A list of groups, separated by semi-colons, that
             *   filters a query response based on user context. The document is only returned to
             *   users that are in one of the groups specified in the `UserContext` field of the
             *   [Query](https://docs.aws.amazon.com/kendra/latest/dg/API_Query.html) operation.
             */
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-kendra-datasource-aclconfiguration.html#cfn-kendra-datasource-aclconfiguration-allowedgroupscolumnname)
             */
            override fun allowedGroupsColumnName(): String =
                unwrap(this).getAllowedGroupsColumnName()
        }
    ...
    public interface ConfluencePageToIndexFieldMappingProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param indexFieldName The name of the index field to map to the Confluence data
             *   source field. The index field type must match the Confluence field type.
             */
            public fun indexFieldName(indexFieldName: String)
        }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ConfluencePageToIndexFieldMappingProperty
            ): software.amazon.awscdk.services.kendra.CfnDataSource.ConfluencePageToIndexFieldMappingProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface WebCrawlerSeedUrlConfigurationProperty {
         ...
         * * `SUBDOMAINS` —crawl the website host names with subdomains. For example, if the seed
         *   URL is "abc.example.com", then "a.abc.example.com" and "b.abc.example.com" are also
         *   crawled.
         * * `EVERYTHING` —crawl the website host names with subdomains and other domains that the
         *   web pages link to.
         *
        ...
        public interface Builder {
            /**
             * @param seedUrls The list of seed or starting point URLs of the websites you want to
             *   crawl. The list can include a maximum of 100 seed URLs.
             */
             ...
             * * `HOST_ONLY` —crawl only the website host names. For example, if the seed URL is
             *   "abc.example.com", then only URLs with host name "abc.example.com" are crawled.
             * * `SUBDOMAINS` —crawl the website host names with subdomains. For example, if the
             *   seed URL is "abc.example.com", then "a.abc.example.com" and "b.abc.example.com" are
             *   also crawled.
             * * `EVERYTHING` —crawl the website host names with subdomains and other domains that
             *   the web pages link to.
             *
             * The default mode is set to `HOST_ONLY` .
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: WebCrawlerSeedUrlConfigurationProperty
            ): software.amazon.awscdk.services.kendra.CfnDataSource.WebCrawlerSeedUrlConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SalesforceStandardObjectAttachmentConfigurationProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param fieldMappings One or more objects that map fields in attachments to Amazon
             *   Kendra index fields.
             */
            public fun fieldMappings(fieldMappings: IResolvable)
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SalesforceStandardObjectAttachmentConfigurationProperty
            ): software.amazon.awscdk.services.kendra.CfnDataSource.SalesforceStandardObjectAttachmentConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DatabaseConfigurationProperty {
        ...
        public interface Builder {
            ...
            public fun columnConfiguration(
                columnConfiguration: ColumnConfigurationProperty.Builder.() -> Unit
            )

            /**
             * @param connectionConfiguration Configuration information that's required to connect
             *   to a database.
             */
            ...
            public fun connectionConfiguration(
                connectionConfiguration: ConnectionConfigurationProperty.Builder.() -> Unit
            )
            ...
            public fun sqlConfiguration(
                sqlConfiguration: SqlConfigurationProperty.Builder.() -> Unit
            )
        ...
        private class BuilderImpl : Builder {
            ...
            override fun columnConfiguration(columnConfiguration: ColumnConfigurationProperty) {
                cdkBuilder.columnConfiguration(
                    columnConfiguration.let(ColumnConfigurationProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("2a79a843cb7aacc95d6e019f396615a8d3d00ba8c21f1c7a257b5fe7605aae5c")
            override fun columnConfiguration(
                columnConfiguration: ColumnConfigurationProperty.Builder.() -> Unit
             ...
             *   to a database.
             */
            override fun connectionConfiguration(
                connectionConfiguration: ConnectionConfigurationProperty
            ) {
                cdkBuilder.connectionConfiguration(
                    connectionConfiguration.let(ConnectionConfigurationProperty::unwrap)
                )
            }
            ...
            override fun connectionConfiguration(
                ...
                connectionConfiguration(ConnectionConfigurationProperty(connectionConfiguration))
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DatabaseConfigurationProperty
            ): software.amazon.awscdk.services.kendra.CfnDataSource.DatabaseConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface WebCrawlerBasicAuthenticationProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param port The port number of the website host you want to connect to using
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: WebCrawlerBasicAuthenticationProperty
            ): software.amazon.awscdk.services.kendra.CfnDataSource.WebCrawlerBasicAuthenticationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface WebCrawlerUrlsProperty {
        ...
        public interface Builder {
             ...
             *   websites you want to crawl. You can choose to crawl only the website host names, or
             *   the website host names with subdomains, or the website host names with subdomains
             ...
             * You can list up to 100 seed URLs.
             */
            public fun seedUrlConfiguration(
            ...
            public fun seedUrlConfiguration(
                seedUrlConfiguration: WebCrawlerSeedUrlConfigurationProperty.Builder.() -> Unit
            )

            /**
             * @param siteMapsConfiguration Configuration of the sitemap URLs of the websites you
             *   want to crawl. Only URLs belonging to the same website host names are crawled. You
             ...
             *   can list up to three sitemap URLs.
             */
            public fun siteMapsConfiguration(
            ...
            public fun siteMapsConfiguration(
                siteMapsConfiguration: WebCrawlerSiteMapsConfigurationProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
             ...
             * You can list up to 100 seed URLs.
             */
            override fun seedUrlConfiguration(
                seedUrlConfiguration: WebCrawlerSeedUrlConfigurationProperty
            ) {
                cdkBuilder.seedUrlConfiguration(
                    seedUrlConfiguration.let(WebCrawlerSeedUrlConfigurationProperty::unwrap)
                )
            }
            ...
            override fun seedUrlConfiguration(
                ...
                seedUrlConfiguration(WebCrawlerSeedUrlConfigurationProperty(seedUrlConfiguration))
             ...
             *   can list up to three sitemap URLs.
             */
            override fun siteMapsConfiguration(
                siteMapsConfiguration: WebCrawlerSiteMapsConfigurationProperty
            ) {
                cdkBuilder.siteMapsConfiguration(
                    siteMapsConfiguration.let(WebCrawlerSiteMapsConfigurationProperty::unwrap)
                )
            }
            ...
            override fun siteMapsConfiguration(
                ...
                siteMapsConfiguration(
                    WebCrawlerSiteMapsConfigurationProperty(siteMapsConfiguration)
                )
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: WebCrawlerUrlsProperty
            ): software.amazon.awscdk.services.kendra.CfnDataSource.WebCrawlerUrlsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ConfluenceBlogConfigurationProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ConfluenceBlogConfigurationProperty
            ): software.amazon.awscdk.services.kendra.CfnDataSource.ConfluenceBlogConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SqlConfigurationProperty {
        ...
        public interface Builder {
             ...
             *   identifiers for tables and column names in double quotes (") when making a database
             *   query. You can set the value to `DOUBLE_QUOTES` or `NONE` .
             *
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SqlConfigurationProperty
            ): software.amazon.awscdk.services.kendra.CfnDataSource.SqlConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ConfluenceSpaceToIndexFieldMappingProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ConfluenceSpaceToIndexFieldMappingProperty
            ): software.amazon.awscdk.services.kendra.CfnDataSource.ConfluenceSpaceToIndexFieldMappingProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ConfluenceBlogToIndexFieldMappingProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ConfluenceBlogToIndexFieldMappingProperty
            ): software.amazon.awscdk.services.kendra.CfnDataSource.ConfluenceBlogToIndexFieldMappingProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ProxyConfigurationProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param host The name of the website host you want to connect to via a web proxy
             *   server. For example, the host name of https://a.example.com/page1.html is
             *   "a.example.com".
             */
            public fun host(host: String)

            /**
             * @param port The port number of the website host you want to connect to via a web
             *   proxy server. For example, the port for https://a.example.com/page1.html is 443,
        ...
        internal constructor(
             ...
             * to connect to a website host. Amazon Kendra currently support basic authentication to
             * connect to a web proxy server. The secret stores your credentials.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-kendra-datasource-proxyconfiguration.html#cfn-kendra-datasource-proxyconfiguration-credentials)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ProxyConfigurationProperty
            ): software.amazon.awscdk.services.kendra.CfnDataSource.ProxyConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface AccessControlListConfigurationProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AccessControlListConfigurationProperty
            ): software.amazon.awscdk.services.kendra.CfnDataSource.AccessControlListConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ConfluenceAttachmentToIndexFieldMappingProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ConfluenceAttachmentToIndexFieldMappingProperty
            ): software.amazon.awscdk.services.kendra.CfnDataSource.ConfluenceAttachmentToIndexFieldMappingProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ConfluenceAttachmentConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param attachmentFieldMappings Maps attributes or field names of Confluence
             *   attachments to Amazon Kendra index field names. To create custom fields, use the
             *   `UpdateIndex` API before you map to Confluence fields. For more information, see
             *   [Mapping data source fields](https://docs.aws.amazon.com/kendra/latest/dg/field-mapping.html)
             *   . The Confluence data source field names must exist in your Confluence custom
             *   metadata.
             *
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ConfluenceAttachmentConfigurationProperty
            ): software.amazon.awscdk.services.kendra.CfnDataSource.ConfluenceAttachmentConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface InlineCustomDocumentEnrichmentConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param condition Configuration of the condition used for the target document
             *   attribute or metadata field when ingesting documents into Amazon Kendra.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            override fun condition(
                condition: DocumentAttributeConditionProperty.Builder.() -> Unit
            ): Unit = condition(DocumentAttributeConditionProperty(condition))
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: InlineCustomDocumentEnrichmentConfigurationProperty
            ): software.amazon.awscdk.services.kendra.CfnDataSource.InlineCustomDocumentEnrichmentConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface S3DataSourceConfigurationProperty {
         ...
         * data source.
         *
         * For the format of the file, see
         ...
         * prefix takes precendence and the document is not indexed. Examples of glob patterns
         * include:
         ...
         * * **internal** excludes all files in a directory that contain 'internal' in the file
         ...
         *   extensions .png and .jpg).
         * * **internal** includes all files in a directory that contain 'internal' in the file
         *   name, such as 'internal', 'internal_only', 'company_internal'.
         ...
         */
        public fun inclusionPrefixes(): List<String> =
            unwrap(this).getInclusionPrefixes() ?: emptyList()

        /** A builder for [S3DataSourceConfigurationProperty] */
        @CdkDslMarker
        public interface Builder {
            /**
             * @param accessControlListConfiguration Provides the path to the S3 bucket that
             *   contains the user context filtering files for the data source. For the format of
             *   the file, see
             *   [Access control for S3 data sources](https://docs.aws.amazon.com/kendra/latest/dg/s3-acl.html)
             *   .
             */
            ...
            public fun accessControlListConfiguration(
                accessControlListConfiguration:
                    AccessControlListConfigurationProperty.Builder.() -> Unit
            )
             ...
             *   information such as the document access control information, source URI, document
             *   author, and custom attributes. Each metadata file contains metadata about a single
             *   document.
             */
            ...
            public fun documentsMetadataConfiguration(
                documentsMetadataConfiguration:
                    DocumentsMetadataConfigurationProperty.Builder.() -> Unit
            )

            /**
             * @param exclusionPatterns A list of glob patterns (patterns that can expand a wildcard
             *   pattern into a list of path names that match the given pattern) for certain file
             *   names and file types to exclude from your index. If a document matches both an
             ...
             *   subdirectories)
             * * `** /!(*.module).ts` - All .ts files but not .module.ts
             * * **.png , *.jpg* excludes all PNG and JPEG image files in a directory (files with
             ...
             *   pattern into a list of path names that match the given pattern) for certain file
             *   names and file types to include in your index. If a document matches both an
             *   inclusion and exclusion prefix or pattern, the exclusion prefix takes precendence
             *   and the document is not indexed. Examples of glob patterns include:
             * * `/myapp/config/ *` - All files inside config directory
             * * `/ ** / *.png` - All .png files in all directories
             ...
             *   subdirectories)
             * * `** /!(*.module).ts` - All .ts files but not .module.ts
             * * **.png , *.jpg* includes all PNG and JPEG image files in a directory (files with
             *   the extensions .png and .jpg).
             * * **internal** includes all files in a directory that contain 'internal' in the file
             *   name, such as 'internal', 'internal_only', 'company_internal'.
             * * *** / *internal** includes all internal-related files in a directory and its
            ...
            /**
             * @param inclusionPrefixes A list of S3 prefixes for the documents that should be
             *   included in the index.
             */
        ...
        private class BuilderImpl : Builder {
             ...
             *   .
             */
            override fun accessControlListConfiguration(
                accessControlListConfiguration: IResolvable
            ) {
                cdkBuilder.accessControlListConfiguration(
                    accessControlListConfiguration.let(IResolvable::unwrap)
                )
            }
            ...
            override fun accessControlListConfiguration(
                ...
                cdkBuilder.accessControlListConfiguration(
                    accessControlListConfiguration.let(
                        AccessControlListConfigurationProperty::unwrap
                    )
                )
            }
            ...
            override fun accessControlListConfiguration(
                ...
                accessControlListConfiguration(
                    AccessControlListConfigurationProperty(accessControlListConfiguration)
                )
             ...
             *   document.
             */
            override fun documentsMetadataConfiguration(
                documentsMetadataConfiguration: IResolvable
            ) {
                cdkBuilder.documentsMetadataConfiguration(
                    documentsMetadataConfiguration.let(IResolvable::unwrap)
                )
            }
            ...
            override fun documentsMetadataConfiguration(
                ...
                cdkBuilder.documentsMetadataConfiguration(
                    documentsMetadataConfiguration.let(
                        DocumentsMetadataConfigurationProperty::unwrap
                    )
                )
            }
            ...
            override fun documentsMetadataConfiguration(
                ...
                documentsMetadataConfiguration(
                    DocumentsMetadataConfigurationProperty(documentsMetadataConfiguration)
                )
        ...
        internal constructor(
            ...
            /**
             * Specifies document metadata files that contain information such as the document
             * access control information, source URI, document author, and custom attributes.
             *
             * Each metadata file contains metadata about a single document.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-kendra-datasource-s3datasourceconfiguration.html#cfn-kendra-datasource-s3datasourceconfiguration-documentsmetadataconfiguration)
             ...
             *
             * If a document matches both an inclusion and exclusion prefix or pattern, the
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-kendra-datasource-s3datasourceconfiguration.html#cfn-kendra-datasource-s3datasourceconfiguration-inclusionprefixes)
             */
            override fun inclusionPrefixes(): List<String> =
                unwrap(this).getInclusionPrefixes() ?: emptyList()
        }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: S3DataSourceConfigurationProperty
            ): software.amazon.awscdk.services.kendra.CfnDataSource.S3DataSourceConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ColumnConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param changeDetectingColumns One to five columns that indicate when a document in
             ...
             *   corresponding fields in an index. You must first create the fields in the index
             *   using the
             *   [UpdateIndex](https://docs.aws.amazon.com/kendra/latest/dg/API_UpdateIndex.html)
             *   operation.
             */
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-kendra-datasource-columnconfiguration.html#cfn-kendra-datasource-columnconfiguration-changedetectingcolumns)
             */
            override fun changeDetectingColumns(): List<String> =
                unwrap(this).getChangeDetectingColumns()
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-kendra-datasource-columnconfiguration.html#cfn-kendra-datasource-columnconfiguration-documenttitlecolumnname)
             */
            override fun documentTitleColumnName(): String? =
                unwrap(this).getDocumentTitleColumnName()
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ColumnConfigurationProperty
            ): software.amazon.awscdk.services.kendra.CfnDataSource.ColumnConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ServiceNowKnowledgeArticleConfigurationProperty {
         ...
         * attachments.
         *
         * Attachments that match the patterns are excluded from the index. Items that don't match
         * the patterns are included in the index. If an item matches both an inclusion and
         ...
         *
         * The query can return articles from multiple knowledge bases, and the knowledge bases can
        ...
        public interface Builder {
             ...
             *   exclude certain knowledge article attachments. Attachments that match the patterns
             *   are excluded from the index. Items that don't match the patterns are included in
             *   the index. If an item matches both an inclusion and exclusion pattern, the
             *   exclusion pattern takes precedence and the item isn't included in the index.
             */
            ...
            /**
             * @param fieldMappings Maps attributes or field names of knoweldge articles to Amazon
             *   Kendra index field names. To create custom fields, use the `UpdateIndex` API before
             *   you map to ServiceNow fields. For more information, see
             *   [Mapping data source fields](https://docs.aws.amazon.com/kendra/latest/dg/field-mapping.html)
             *   . The ServiceNow data source field names must exist in your ServiceNow custom
             *   metadata.
             */
            ...
            /**
             * @param filterQuery A query that selects the knowledge articles to index. The query
             *   can return articles from multiple knowledge bases, and the knowledge bases can be
             *   public or private.
             *
             ...
             *   include knowledge article attachments. Attachments that match the patterns are
             *   included in the index. Items that don't match the patterns are excluded from the
             *   index. If an item matches both an inclusion and exclusion pattern, the exclusion
        ...
        internal constructor(
             ...
             * attachments.
             *
             * Attachments that match the patterns are excluded from the index. Items that don't
             * match the patterns are included in the index. If an item matches both an inclusion
             ...
             * A query that selects the knowledge articles to index.
             *
             * The query can return articles from multiple knowledge bases, and the knowledge bases
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ServiceNowKnowledgeArticleConfigurationProperty
            ): software.amazon.awscdk.services.kendra.CfnDataSource.ServiceNowKnowledgeArticleConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface GoogleDriveConfigurationProperty {
         ...
         */
        public fun excludeMimeTypes(): List<String> =
            unwrap(this).getExcludeMimeTypes() ?: emptyList()
         ...
         */
        public fun excludeSharedDrives(): List<String> =
            unwrap(this).getExcludeSharedDrives() ?: emptyList()

        /**
         * A list of email addresses of the users.
         *
         * Documents owned by these users are excluded from the index. Documents shared with
         * excluded users are indexed unless they are excluded in another way.
         *
         ...
         */
        public fun excludeUserAccounts(): List<String> =
            unwrap(this).getExcludeUserAccounts() ?: emptyList()
         ...
         * For more information, see
         * [Mapping data source fields](https://docs.aws.amazon.com/kendra/latest/dg/field-mapping.html)
         * . The Google Drive data source field names must exist in your Google Drive custom
         * metadata.
         *
        ...
        public interface Builder {
             ...
             *   matching the specified MIME type are excluded. For a list of MIME types, see
             *   [Using a Google Workspace Drive data source](https://docs.aws.amazon.com/kendra/latest/dg/data-source-google-drive.html)
             *   .
             */
             ...
             *   index. All files and folders stored on the shared drive are excluded.
             */
            ...
            /**
             * @param excludeUserAccounts A list of email addresses of the users. Documents owned by
             *   these users are excluded from the index. Documents shared with excluded users are
            ...
            /**
             * @param exclusionPatterns A list of regular expression patterns to exclude certain
             *   items in your Google Drive, including shared drives and users' My Drives. Items
             *   that match the patterns are excluded from the index. Items that don't match the
             *   patterns are included in the index. If an item matches both an inclusion and
            ...
            /**
             * @param fieldMappings Maps Google Drive data source attributes or field names to
             *   Amazon Kendra index field names. To create custom fields, use the `UpdateIndex` API
             ...
             * @param inclusionPatterns A list of regular expression patterns to include certain
             *   items in your Google Drive, including shared drives and users' My Drives. Items
             *   that match the patterns are included in the index. Items that don't match the
             *   patterns are excluded from the index. If an item matches both an inclusion and
             *   exclusion pattern, the exclusion pattern takes precedence and the item isn't
             *   included in the index.
             */
             ...
             *   contains the credentials required to connect to Google Drive. For more information,
             *   see
             *   [Using a Google Workspace Drive data source](https://docs.aws.amazon.com/kendra/latest/dg/data-source-google-drive.html)
             *   .
             */
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-kendra-datasource-googledriveconfiguration.html#cfn-kendra-datasource-googledriveconfiguration-excludemimetypes)
             */
            override fun excludeMimeTypes(): List<String> =
                unwrap(this).getExcludeMimeTypes() ?: emptyList()
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-kendra-datasource-googledriveconfiguration.html#cfn-kendra-datasource-googledriveconfiguration-excludeshareddrives)
             */
            override fun excludeSharedDrives(): List<String> =
                unwrap(this).getExcludeSharedDrives() ?: emptyList()
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-kendra-datasource-googledriveconfiguration.html#cfn-kendra-datasource-googledriveconfiguration-excludeuseraccounts)
             */
            override fun excludeUserAccounts(): List<String> =
                unwrap(this).getExcludeUserAccounts() ?: emptyList()
             ...
             * names.
             *
             * To create custom fields, use the `UpdateIndex` API before you map to Google Drive
             * fields. For more information, see
             * [Mapping data source fields](https://docs.aws.amazon.com/kendra/latest/dg/field-mapping.html)
             * . The Google Drive data source field names must exist in your Google Drive custom
             * metadata.
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: GoogleDriveConfigurationProperty
            ): software.amazon.awscdk.services.kendra.CfnDataSource.GoogleDriveConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
