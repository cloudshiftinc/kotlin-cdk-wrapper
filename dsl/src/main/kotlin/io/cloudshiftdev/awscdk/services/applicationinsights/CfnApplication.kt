...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param attachMissingPermission If set to true, the managed policies for SSM and CW will
         *   be attached to the instance roles if they are missing.
         */
         ...
         *
         * @param customComponents Describes a custom component by grouping similar standalone
         ...
         * application resources, such as `instance terminated` , `failed deployment` , and others.
         *
         ...
         *   events for the application resources, such as `instance terminated` , `failed
         ...
         *
         * @param groupingType Application Insights can create applications based on a resource
         *   group or on an account.
         */
         ...
         *
         * @param opsCenterEnabled Indicates whether Application Insights will create OpsItems for
         *   any problem that is detected by Application Insights for an application.
         */
         ...
         *
         * @param opsItemSnsTopicArn The SNS topic provided to Application Insights that is
         *   associated with the created OpsItems to receive SNS notifications for opsItem updates.
         */
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.applicationinsights.CfnApplication.Builder.create(
                scope,
                id
            )
        ...
        override fun componentMonitoringSettings(componentMonitoringSettings: IResolvable) {
            cdkBuilder.componentMonitoringSettings(
                componentMonitoringSettings.let(IResolvable::unwrap)
            )
        }
    ...
    public interface LogPatternSetProperty {
         ...
         *
         * A log pattern name can contain up to 30 characters, and it cannot be empty. The
         * characters can be Unicode letters, digits, or one of the following symbols: period, dash,
         * underscore.
         *
        ...
        public interface Builder {
            ...
            /**
             * @param patternSetName The name of the log pattern. A log pattern name can contain up
             *   to 30 characters, and it cannot be empty. The characters can be Unicode letters,
        ...
        private class BuilderImpl : Builder {
             ...
             *   `LogPatternSet` .
             */
            override fun logPatterns(vararg logPatterns: Any): Unit =
                logPatterns(logPatterns.toList())
        ...
        internal constructor(
             ...
             *
             * A log pattern name can contain up to 30 characters, and it cannot be empty. The
             * characters can be Unicode letters, digits, or one of the following symbols: period,
             * dash, underscore.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-applicationinsights-application-logpatternset.html#cfn-applicationinsights-application-logpatternset-patternsetname)
             */
    ...
    public interface WindowsEventProperty {
         ...
         * `ERROR` , `CRITICAL` , and `VERBOSE` . This field is required for each type of Windows
         * Event to log.
         *
         ...
         *
         * For example, System, Security, CustomEventName, and so on. This field is required for
         * each type of Windows event to log.
         *
        ...
        public interface Builder {
            /**
             * @param eventLevels The levels of event to log. You must specify each level to log.
             *   Possible values include `INFORMATION` , `WARNING` , `ERROR` , `CRITICAL` , and
             *   `VERBOSE` . This field is required for each type of Windows Event to log.
             */
            ...
            /**
             * @param eventName The type of Windows Events to log, equivalent to the Windows Event
             *   log channel name. For example, System, Security, CustomEventName, and so on. This
             *   field is required for each type of Windows event to log.
             */
            public fun eventName(eventName: String)

            /**
             * @param logGroupName The CloudWatch log group name to be associated with the monitored
             *   log.
             */
        ...
        private class BuilderImpl : Builder {
             ...
             *   `VERBOSE` . This field is required for each type of Windows Event to log.
             */
            override fun eventLevels(vararg eventLevels: String): Unit =
                eventLevels(eventLevels.toList())
        ...
        internal constructor(
             ...
             *
             * You must specify each level to log. Possible values include `INFORMATION` , `WARNING`
             * , `ERROR` , `CRITICAL` , and `VERBOSE` . This field is required for each type of
    ...
    public interface HAClusterPrometheusExporterProperty {
        ...
        public interface Builder {
            /**
             * @param prometheusPort The target port to which Prometheus sends metrics. If not
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: HAClusterPrometheusExporterProperty
            ): software.amazon.awscdk.services.applicationinsights.CfnApplication.HAClusterPrometheusExporterProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ComponentConfigurationProperty {
        ...
        public interface Builder {
            ...
            public fun configurationDetails(
                configurationDetails: ConfigurationDetailsProperty.Builder.() -> Unit
            )
        ...
        private class BuilderImpl : Builder {
            ...
            override fun configurationDetails(configurationDetails: ConfigurationDetailsProperty) {
                cdkBuilder.configurationDetails(
                    configurationDetails.let(ConfigurationDetailsProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("c31fec2a673113a2f0535a28bdacf3bd652f763fb0267ea8f90d608c943331fb")
            override fun configurationDetails(
                configurationDetails: ConfigurationDetailsProperty.Builder.() -> Unit
             ...
             * @param subComponentTypeConfigurations Sub-component configurations of the component.
             */
            override fun subComponentTypeConfigurations(
                subComponentTypeConfigurations: IResolvable
            ) {
                cdkBuilder.subComponentTypeConfigurations(
                    subComponentTypeConfigurations.let(IResolvable::unwrap)
                )
            }
             ...
             */
            override fun subComponentTypeConfigurations(
                vararg subComponentTypeConfigurations: Any
            ): Unit = subComponentTypeConfigurations(subComponentTypeConfigurations.toList())
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ComponentConfigurationProperty
            ): software.amazon.awscdk.services.applicationinsights.CfnApplication.ComponentConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ConfigurationDetailsProperty {
         ...
         */
        public fun haClusterPrometheusExporter(): Any? =
        ...
        public interface Builder {
            /**
             * @param alarmMetrics A list of metrics to monitor for the component. All component
             *   types can use `AlarmMetrics` .
             */
            ...
            /**
             * @param alarms A list of alarms to monitor for the component. All component types can
             *   use `Alarm` .
             */
            ...
            /** @param haClusterPrometheusExporter The HA cluster Prometheus Exporter settings. */
            public fun haClusterPrometheusExporter(
            ...
            public fun haClusterPrometheusExporter(
                haClusterPrometheusExporter: HAClusterPrometheusExporterProperty.Builder.() -> Unit
            )
            ...
            /** @param hanaPrometheusExporter The HANA DB Prometheus Exporter settings. */
            public fun hanaPrometheusExporter(
            ...
            public fun hanaPrometheusExporter(
                hanaPrometheusExporter: HANAPrometheusExporterProperty.Builder.() -> Unit
            )
            ...
            public fun jmxPrometheusExporter(
                jmxPrometheusExporter: JMXPrometheusExporterProperty.Builder.() -> Unit
            )

            /**
             * @param logs A list of logs to monitor for the component. Only Amazon EC2 instances
             *   can use `Logs` .
             */
            ...
            /**
             * @param windowsEvents A list of Windows Events to monitor for the component. Only
             *   Amazon EC2 instances running on Windows can use `WindowsEvents` .
             */
        ...
        private class BuilderImpl : Builder {
            ...
            override fun haClusterPrometheusExporter(haClusterPrometheusExporter: IResolvable) {
                cdkBuilder.haClusterPrometheusExporter(
                    haClusterPrometheusExporter.let(IResolvable::unwrap)
                )
            }

            /** @param haClusterPrometheusExporter The HA cluster Prometheus Exporter settings. */
            override fun haClusterPrometheusExporter(
                haClusterPrometheusExporter: HAClusterPrometheusExporterProperty
            ) {
                cdkBuilder.haClusterPrometheusExporter(
            ...
            override fun haClusterPrometheusExporter(
                ...
                haClusterPrometheusExporter(
                    HAClusterPrometheusExporterProperty(haClusterPrometheusExporter)
                )
            ...
            /** @param hanaPrometheusExporter The HANA DB Prometheus Exporter settings. */
            override fun hanaPrometheusExporter(
                hanaPrometheusExporter: HANAPrometheusExporterProperty
            ) {
                cdkBuilder.hanaPrometheusExporter(
                    hanaPrometheusExporter.let(HANAPrometheusExporterProperty::unwrap)
                )
            }
            ...
            /** @param jmxPrometheusExporter A list of Java metrics to monitor for the component. */
            override fun jmxPrometheusExporter(
                jmxPrometheusExporter: JMXPrometheusExporterProperty
            ) {
                cdkBuilder.jmxPrometheusExporter(
                    jmxPrometheusExporter.let(JMXPrometheusExporterProperty::unwrap)
                )
            }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ConfigurationDetailsProperty
            ): software.amazon.awscdk.services.applicationinsights.CfnApplication.ConfigurationDetailsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SubComponentConfigurationDetailsProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SubComponentConfigurationDetailsProperty
            ): software.amazon.awscdk.services.applicationinsights.CfnApplication.SubComponentConfigurationDetailsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface JMXPrometheusExporterProperty {
        ...
        public interface Builder {
            /**
             * @param hostPort The host and port to connect to through remote JMX. Only one of
             *   `jmxURL` and `hostPort` can be specified.
             */
            ...
            /**
             * @param prometheusPort The target port to send Prometheus metrics to. If not
             *   specified, the default port `9404` is used.
             */
            public fun prometheusPort(prometheusPort: String)
        }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: JMXPrometheusExporterProperty
            ): software.amazon.awscdk.services.applicationinsights.CfnApplication.JMXPrometheusExporterProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface LogProperty {
         ...
         * encodings. If not provided, CloudWatch Application Insights uses the default encoding
         * type for the log type:
         ...
         * see
         * [CloudWatch Agent Configuration File: Logs Section](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/CloudWatch-Agent-Configuration-File-Details.html#CloudWatch-Agent-Configuration-File-Logssection)
         * .
         *
         ...
         * , `POSTGRESQL` , `ORACLE_ALERT` , `ORACLE_LISTENER` , `IIS` , `APPLICATION` ,
         * `WINDOWS_EVENTS` , `WINDOWS_EVENTS_ACTIVE_DIRECTORY` , `WINDOWS_EVENTS_DNS` ,
         * `WINDOWS_EVENTS_IIS` , `WINDOWS_EVENTS_SHAREPOINT` ,
         * `SQL_SERVER_ALWAYSON_AVAILABILITY_GROUP` , `SQL_SERVER_FAILOVER_CLUSTER_INSTANCE` ,
         * `STEP_FUNCTION` , `API_GATEWAY_ACCESS` , `API_GATEWAY_EXECUTION` , `SAP_HANA_LOGS` ,
         * `SAP_HANA_TRACE` , `SAP_HANA_HIGH_AVAILABILITY` , and `DEFAULT` .
         *
        ...
        public interface Builder {
            /**
             * @param encoding The type of encoding of the logs to be monitored. The specified
             *   encoding should be included in the list of CloudWatch agent supported encodings. If
             *   not provided, CloudWatch Application Insights uses the default encoding type for
             *   the log type:
             * * `APPLICATION/DEFAULT` : utf-8 encoding
             * * `SQL_SERVER` : utf-16 encoding
             * * `IIS` : ascii encoding
            ...
            /**
             * @param logPath The path of the logs to be monitored. The log path must be an absolute
             *   Windows or Linux system file path. For more information, see
             *   [CloudWatch Agent Configuration File: Logs Section](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/CloudWatch-Agent-Configuration-File-Details.html#CloudWatch-Agent-Configuration-File-Logssection)
             *   .
             */
            ...
            /**
             * @param logType The log type decides the log patterns against which Application
             *   Insights analyzes the log. The log type is selected from the following:
             *   `SQL_SERVER` , `MYSQL` , `MYSQL_SLOW_QUERY` , `POSTGRESQL` , `ORACLE_ALERT` ,
             *   `ORACLE_LISTENER` , `IIS` , `APPLICATION` , `WINDOWS_EVENTS` ,
             ...
             *   `API_GATEWAY_EXECUTION` , `SAP_HANA_LOGS` , `SAP_HANA_TRACE` ,
        ...
        internal constructor(
             ...
             * The path of the logs to be monitored.
             *
             * The log path must be an absolute Windows or Linux system file path. For more
             * information, see
             * [CloudWatch Agent Configuration File: Logs Section](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/CloudWatch-Agent-Configuration-File-Details.html#CloudWatch-Agent-Configuration-File-Logssection)
             * .
             *
             ...
             * log.
             *
             * The log type is selected from the following: `SQL_SERVER` , `MYSQL` ,
             * `MYSQL_SLOW_QUERY` , `POSTGRESQL` , `ORACLE_ALERT` , `ORACLE_LISTENER` , `IIS` ,
             * `APPLICATION` , `WINDOWS_EVENTS` , `WINDOWS_EVENTS_ACTIVE_DIRECTORY` ,
             * `WINDOWS_EVENTS_DNS` , `WINDOWS_EVENTS_IIS` , `WINDOWS_EVENTS_SHAREPOINT` ,
             * `SQL_SERVER_ALWAYSON_AVAILABILITY_GROUP` , `SQL_SERVER_FAILOVER_CLUSTER_INSTANCE` ,
             * `STEP_FUNCTION` , `API_GATEWAY_ACCESS` , `API_GATEWAY_EXECUTION` , `SAP_HANA_LOGS` ,
             * `SAP_HANA_TRACE` , `SAP_HANA_HIGH_AVAILABILITY` , and `DEFAULT` .
             *
    ...
    public interface SubComponentTypeConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param subComponentConfigurationDetails The configuration settings of the
             *   sub-components.
             */
            public fun subComponentConfigurationDetails(
                subComponentConfigurationDetails: IResolvable
            )
            ...
            public fun subComponentConfigurationDetails(
                subComponentConfigurationDetails:
                    SubComponentConfigurationDetailsProperty.Builder.() -> Unit
            )
        ...
        private class BuilderImpl : Builder {
             ...
             *   sub-components.
             */
            override fun subComponentConfigurationDetails(
                subComponentConfigurationDetails: IResolvable
            ) {
                cdkBuilder.subComponentConfigurationDetails(
                    subComponentConfigurationDetails.let(IResolvable::unwrap)
                )
            }
            ...
            override fun subComponentConfigurationDetails(
                ...
                cdkBuilder.subComponentConfigurationDetails(
                    subComponentConfigurationDetails.let(
                        SubComponentConfigurationDetailsProperty::unwrap
                    )
                )
            }
            ...
            override fun subComponentConfigurationDetails(
                ...
                subComponentConfigurationDetails(
                    SubComponentConfigurationDetailsProperty(subComponentConfigurationDetails)
                )
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SubComponentTypeConfigurationProperty
            ): software.amazon.awscdk.services.applicationinsights.CfnApplication.SubComponentTypeConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CustomComponentProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CustomComponentProperty
            ): software.amazon.awscdk.services.applicationinsights.CfnApplication.CustomComponentProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface HANAPrometheusExporterProperty {
        ...
        public interface Builder {
             ...
             *   credentials. The HANA Prometheus exporter uses these credentials to connect to the
             *   database and query HANA metrics.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            override fun agreeToInstallHanadbClient(agreeToInstallHanadbClient: IResolvable) {
                cdkBuilder.agreeToInstallHanadbClient(
                    agreeToInstallHanadbClient.let(IResolvable::unwrap)
                )
            }
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-applicationinsights-application-hanaprometheusexporter.html#cfn-applicationinsights-application-hanaprometheusexporter-agreetoinstallhanadbclient)
             */
            override fun agreeToInstallHanadbClient(): Any =
             ...
             * The AWS Secrets Manager secret that stores HANA monitoring user credentials.
             *
             * The HANA Prometheus exporter uses these credentials to connect to the database and
             * query HANA metrics.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-applicationinsights-application-hanaprometheusexporter.html#cfn-applicationinsights-application-hanaprometheusexporter-hanasecretname)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: HANAPrometheusExporterProperty
            ): software.amazon.awscdk.services.applicationinsights.CfnApplication.HANAPrometheusExporterProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface LogPatternProperty {
         ...
         * The name of the log pattern.
         *
         * A log pattern name can contain up to 50 characters, and it cannot be empty. The
         * characters can be Unicode letters, digits, or one of the following symbols: period, dash,
         * underscore.
         *
        ...
        public interface Builder {
            /**
             * @param pattern A regular expression that defines the log pattern. A log pattern can
             *   contain up to 50 characters, and it cannot be empty.
             */
            public fun pattern(pattern: String)

            /**
             * @param patternName The name of the log pattern. A log pattern name can contain up to
             *   50 characters, and it cannot be empty. The characters can be Unicode letters,
             *   digits, or one of the following symbols: period, dash, underscore.
             */
    ...
    public interface ComponentMonitoringSettingProperty {
         ...
         *   default monitoring settings of the selected `Tier` , and merged with customized
         *   overwrite settings that are specified in `DefaultOverwriteComponentConfiguration` . If
         *   used, `DefaultOverwriteComponentConfiguration` must be provided.
         *
         ...
         */
        public fun customComponentConfiguration(): Any? =
         ...
         * `SAP_HANA_SINGLE_NODE` , `SAP_HANA_HIGH_AVAILABILITY` , `SHAREPOINT` . `ACTIVE_DIRECTORY`
         * , and `DEFAULT` .
         *
        ...
        public interface Builder {
            ...
            /**
             * @param componentConfigurationMode Component monitoring can be configured in one of
             *   the following three modes:.
             * * `DEFAULT` : The component will be configured with the recommended default
             *   monitoring settings of the selected `Tier` .
             * * `CUSTOM` : The component will be configured with the customized monitoring settings
             *   that are specified in `CustomComponentConfiguration` . If used,
             *   `CustomComponentConfiguration` must be provided.
             * * `DEFAULT_WITH_OVERWRITE` : The component will be configured with the recommended
             *   default monitoring settings of the selected `Tier` , and merged with customized
             *   overwrite settings that are specified in `DefaultOverwriteComponentConfiguration` .
             *   If used, `DefaultOverwriteComponentConfiguration` must be provided.
             */
            ...
            /**
             * @param customComponentConfiguration Customized monitoring settings. Required if
             *   CUSTOM mode is configured in `ComponentConfigurationMode` .
             */
            ...
            public fun customComponentConfiguration(
                customComponentConfiguration: ComponentConfigurationProperty.Builder.() -> Unit
            )

            /**
             * @param defaultOverwriteComponentConfiguration Customized overwrite monitoring
             *   settings. Required if CUSTOM mode is configured in `ComponentConfigurationMode` .
             */
            ...
            public fun defaultOverwriteComponentConfiguration(
                defaultOverwriteComponentConfiguration:
                    ComponentConfigurationProperty.Builder.() -> Unit
            )
             ...
             *   `SQL_SERVER_ALWAYSON_AVAILABILITY_GROUP` , `SQL_SERVER_FAILOVER_CLUSTER_INSTANCE` ,
             *   `MYSQL` , `POSTGRESQL` , `JAVA_JMX` , `ORACLE` , `SAP_HANA_MULTI_NODE` ,
             *   `SAP_HANA_SINGLE_NODE` , `SAP_HANA_HIGH_AVAILABILITY` , `SHAREPOINT` .
        ...
        private class BuilderImpl : Builder {
            ...
            override fun customComponentConfiguration(customComponentConfiguration: IResolvable) {
                cdkBuilder.customComponentConfiguration(
                    customComponentConfiguration.let(IResolvable::unwrap)
                )
            }
             ...
             *   CUSTOM mode is configured in `ComponentConfigurationMode` .
             */
            override fun customComponentConfiguration(
                customComponentConfiguration: ComponentConfigurationProperty
            ) {
                cdkBuilder.customComponentConfiguration(
                    customComponentConfiguration.let(ComponentConfigurationProperty::unwrap)
                )
            }
            ...
            override fun customComponentConfiguration(
                ...
                customComponentConfiguration(
                    ComponentConfigurationProperty(customComponentConfiguration)
                )
             ...
             *   settings. Required if CUSTOM mode is configured in `ComponentConfigurationMode` .
             */
            override fun defaultOverwriteComponentConfiguration(
                defaultOverwriteComponentConfiguration: IResolvable
            ) {
                cdkBuilder.defaultOverwriteComponentConfiguration(
                    defaultOverwriteComponentConfiguration.let(IResolvable::unwrap)
                )
            }
            ...
            override fun defaultOverwriteComponentConfiguration(
                ...
                cdkBuilder.defaultOverwriteComponentConfiguration(
                    defaultOverwriteComponentConfiguration.let(
                        ComponentConfigurationProperty::unwrap
                    )
                )
            }
            ...
            override fun defaultOverwriteComponentConfiguration(
                ...
                defaultOverwriteComponentConfiguration(
                    ComponentConfigurationProperty(defaultOverwriteComponentConfiguration)
                )
        ...
        internal constructor(
             ...
             * The tier of the application component.
             *
             * Supported tiers include `DOT_NET_CORE` , `DOT_NET_WORKER` , `DOT_NET_WEB` ,
             * `SQL_SERVER` , `SQL_SERVER_ALWAYSON_AVAILABILITY_GROUP` ,
             * `SQL_SERVER_FAILOVER_CLUSTER_INSTANCE` , `MYSQL` , `POSTGRESQL` , `JAVA_JMX` ,
             * `ORACLE` , `SAP_HANA_MULTI_NODE` , `SAP_HANA_SINGLE_NODE` ,
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ComponentMonitoringSettingProperty
            ): software.amazon.awscdk.services.applicationinsights.CfnApplication.ComponentMonitoringSettingProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface AlarmMetricProperty {
         ...
         *
         * For metrics supported by Application Insights, see
        ...
        public interface Builder {
            /**
             * @param alarmMetricName The name of the metric to be monitored for the component. For
             *   metrics supported by Application Insights, see
             *   [Logs and metrics supported by Amazon CloudWatch Application Insights](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/appinsights-logs-and-metrics.html)
             *   .
             */
