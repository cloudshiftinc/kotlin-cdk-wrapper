...
internal constructor(
    ...
    public open fun accessLoggingPolicy(
        `value`: AccessLoggingPolicyProperty.Builder.() -> Unit
    ): Unit = accessLoggingPolicy(AccessLoggingPolicyProperty(`value`))
    ...
    public open fun connectionDrainingPolicy(`value`: ConnectionDrainingPolicyProperty) {
        unwrap(this)
            .setConnectionDrainingPolicy(`value`.let(ConnectionDrainingPolicyProperty::unwrap))
    }
    ...
    public open fun connectionDrainingPolicy(
        `value`: ConnectionDrainingPolicyProperty.Builder.() -> Unit
    ...
    public open fun connectionSettings(
        `value`: ConnectionSettingsProperty.Builder.() -> Unit
    ): Unit = connectionSettings(ConnectionSettingsProperty(`value`))
    ...
    public interface Builder {
        ...
        public fun accessLoggingPolicy(
            accessLoggingPolicy: AccessLoggingPolicyProperty.Builder.() -> Unit
        )
         ...
         * `Subnets` instead.
         *
         * Update requires replacement if you did not previously specify an Availability Zone or if
         * you are removing all Availability Zones. Otherwise, update requires no interruption.
         *
         ...
         *
         * @param availabilityZones The Availability Zones for the load balancer. For load balancers
         *   in a VPC, specify `Subnets` instead.
         */
        ...
        public fun connectionDrainingPolicy(
            connectionDrainingPolicy: ConnectionDrainingPolicyProperty.Builder.() -> Unit
        )
         ...
         *
         * @param connectionSettings If enabled, the load balancer allows the connections to remain
         *   idle (no data is sent over the connection) for the specified duration.
         */
        ...
        public fun connectionSettings(
            connectionSettings: ConnectionSettingsProperty.Builder.() -> Unit
        )
         ...
         *
         * @param crossZone If enabled, the load balancer routes the request traffic evenly across
         ...
         * The health check settings to use when evaluating the health of your EC2 instances.
         *
         * Update requires replacement if you did not previously specify health check settings or if
         * you are removing the health check settings. Otherwise, update requires no interruption.
         *
         ...
         *
         * @param healthCheck The health check settings to use when evaluating the health of your
         *   EC2 instances.
         */
         ...
         * listener and creates a new one with the specified properties. While the new listener is
         * being created, clients cannot connect to the load balancer.
         *
         ...
         *
         * @param listeners The listeners for the load balancer. You can specify at most one
         *   listener per port.
         */
         ...
         * removing all subnets. Otherwise, update requires no interruption. To update to a
         * different subnet in the current Availability Zone, you must first update to a subnet in a
         * different Availability Zone, then update to the new subnet in the original Availability
         * Zone.
         *
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.elasticloadbalancing.CfnLoadBalancer.Builder.create(
                scope,
                id
            )
        ...
        override fun accessLoggingPolicy(accessLoggingPolicy: AccessLoggingPolicyProperty) {
            cdkBuilder.accessLoggingPolicy(
                accessLoggingPolicy.let(AccessLoggingPolicyProperty::unwrap)
            )
        }
         ...
         *   instance.
         */
        override fun connectionDrainingPolicy(
            connectionDrainingPolicy: ConnectionDrainingPolicyProperty
        ) {
            cdkBuilder.connectionDrainingPolicy(
                connectionDrainingPolicy.let(ConnectionDrainingPolicyProperty::unwrap)
            )
        }
        ...
        override fun connectionDrainingPolicy(
            ...
            connectionDrainingPolicy(ConnectionDrainingPolicyProperty(connectionDrainingPolicy))
        ...
        override fun connectionSettings(connectionSettings: ConnectionSettingsProperty) {
            cdkBuilder.connectionSettings(
                connectionSettings.let(ConnectionSettingsProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("ef1c9b12d6535ae9972f770ffb300128431c29da02f5c9554522ae128923e5cf")
        override fun connectionSettings(
            connectionSettings: ConnectionSettingsProperty.Builder.() -> Unit
    ...
    public interface PoliciesProperty {
         ...
         */
        public fun loadBalancerPorts(): List<String> =
            unwrap(this).getLoadBalancerPorts() ?: emptyList()
        ...
        public interface Builder {
            ...
            /**
             * @param instancePorts The instance ports for the policy. Required only for some policy
             *   types.
             */
            ...
            /**
             * @param loadBalancerPorts The load balancer ports for the policy. Required only for
             *   some policy types.
             */
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-elasticloadbalancing-loadbalancer-policies.html#cfn-elasticloadbalancing-loadbalancer-policies-instanceports)
             */
            override fun instancePorts(): List<String> =
                unwrap(this).getInstancePorts() ?: emptyList()
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-elasticloadbalancing-loadbalancer-policies.html#cfn-elasticloadbalancing-loadbalancer-policies-loadbalancerports)
             */
            override fun loadBalancerPorts(): List<String> =
                unwrap(this).getLoadBalancerPorts() ?: emptyList()
    ...
    public interface LBCookieStickinessPolicyProperty {
        ...
        public interface Builder {
            /**
             * @param cookieExpirationPeriod The time period, in seconds, after which the cookie
             *   should be considered stale. If this parameter is not specified, the stickiness
             *   session lasts for the duration of the browser session.
             */
            public fun cookieExpirationPeriod(cookieExpirationPeriod: String)

            /**
             * @param policyName The name of the policy. This name must be unique within the set of
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-elasticloadbalancing-loadbalancer-lbcookiestickinesspolicy.html#cfn-elasticloadbalancing-loadbalancer-lbcookiestickinesspolicy-cookieexpirationperiod)
             */
            override fun cookieExpirationPeriod(): String? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: LBCookieStickinessPolicyProperty
            ): software.amazon.awscdk.services.elasticloadbalancing.CfnLoadBalancer.LBCookieStickinessPolicyProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface AccessLoggingPolicyProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param s3BucketName The name of the Amazon S3 bucket where the access logs are
             *   stored.
             */
            public fun s3BucketName(s3BucketName: String)

            /**
             * @param s3BucketPrefix The logical hierarchy you created for your Amazon S3 bucket,
             *   for example `my-bucket-prefix/prod` . If the prefix is not provided, the log is
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AccessLoggingPolicyProperty
            ): software.amazon.awscdk.services.elasticloadbalancing.CfnLoadBalancer.AccessLoggingPolicyProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface AppCookieStickinessPolicyProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AppCookieStickinessPolicyProperty
            ): software.amazon.awscdk.services.elasticloadbalancing.CfnLoadBalancer.AppCookieStickinessPolicyProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ListenersProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param instanceProtocol The protocol to use for routing traffic to instances: HTTP,
             *   HTTPS, TCP, or SSL. If the front-end protocol is TCP or SSL, the back-end protocol
             *   must be TCP or SSL. If the front-end protocol is HTTP or HTTPS, the back-end
            ...
            /**
             * @param loadBalancerPort The port on which the load balancer is listening. On EC2-VPC,
             *   you can specify any port from the range 1-65535. On EC2-Classic, you can specify
        ...
        private class BuilderImpl : Builder {
            ...
            /** @param policyNames The names of the policies to associate with the listener. */
            override fun policyNames(vararg policyNames: String): Unit =
    ...
    public interface ConnectionSettingsProperty {
        ...
        public interface Builder {
            /**
             * @param idleTimeout The time, in seconds, that the connection is allowed to be idle
             *   (no data has been sent over the connection) before it is closed by the load
             *   balancer.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ConnectionSettingsProperty
            ): software.amazon.awscdk.services.elasticloadbalancing.CfnLoadBalancer.ConnectionSettingsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface HealthCheckProperty {
        ...
        public interface Builder {
            /**
             * @param healthyThreshold The number of consecutive health checks successes required
            ...
            /**
             * @param target The instance being checked. The protocol is either TCP, HTTP, HTTPS, or
             ...
             *   failed health check. This value must be less than the `Interval` value.
             */
    ...
    public interface ConnectionDrainingPolicyProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ConnectionDrainingPolicyProperty
            ): software.amazon.awscdk.services.elasticloadbalancing.CfnLoadBalancer.ConnectionDrainingPolicyProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
