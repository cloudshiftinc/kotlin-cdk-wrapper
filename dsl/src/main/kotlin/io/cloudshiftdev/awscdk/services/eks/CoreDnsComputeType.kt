...
public enum class CoreDnsComputeType(
    ...
    public companion object {
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.eks.CoreDnsComputeType
        ): CoreDnsComputeType =
            when (cdkObject) {
                software.amazon.awscdk.services.eks.CoreDnsComputeType.EC2 -> CoreDnsComputeType.EC2
                software.amazon.awscdk.services.eks.CoreDnsComputeType.FARGATE ->
                    CoreDnsComputeType.FARGATE
            }

        internal fun unwrap(
            wrapped: CoreDnsComputeType
