...
public interface LogDriverConfig {
     ...
     *
     * The valid values listed for this parameter are log drivers that the Amazon ECS container
     ...
     * awsfirelens. For tasks using the EC2 launch type, the supported log drivers are awslogs,
    ...
    public interface Builder {
        /**
         * @param logDriver The log driver to use for the container. The valid values listed for
         *   this parameter are log drivers that the Amazon ECS container agent can communicate with
         *   by default.
         *
    ...
    internal constructor(
        ...
        override fun secretOptions(): List<CfnTaskDefinition.SecretProperty> =
            unwrap(this).getSecretOptions()?.map(CfnTaskDefinition.SecretProperty::wrap)
                ?: emptyList()
    }
