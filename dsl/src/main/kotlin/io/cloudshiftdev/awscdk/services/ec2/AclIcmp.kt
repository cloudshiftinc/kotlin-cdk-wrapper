...
public interface AclIcmp {
    ...
    public interface Builder {
        /**
         * @param code The Internet Control Message Protocol (ICMP) code. You can use -1 to specify
         *   all ICMP codes for the given ICMP type. Requirement is conditional: Required if you
         *   specify 1 (ICMP) for the protocol parameter.
         */
        public fun code(code: Number)

        /**
         * @param type The Internet Control Message Protocol (ICMP) type. You can use -1 to specify
         *   all ICMP types. Conditional requirement: Required if you specify 1 (ICMP) for the
    ...
    internal constructor(
         ...
         * The Internet Control Message Protocol (ICMP) code.
         *
         * You can use -1 to specify all ICMP codes for the given ICMP type. Requirement is
         * conditional: Required if you specify 1 (ICMP) for the protocol parameter.
         */
    ...
    public companion object {
        ...
        internal fun unwrap(wrapped: AclIcmp): software.amazon.awscdk.services.ec2.AclIcmp =
