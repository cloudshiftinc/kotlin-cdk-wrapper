...
public interface InterfaceVpcEndpointAttributes {
     ...
     *
     * If you wish to manage the network connections associated with this endpoint, you will need to
     * specify its security groups.
     */
    ...
    public interface Builder {
        ...
        /**
         * @param securityGroups The security groups associated with the interface VPC endpoint. If
         *   you wish to manage the network connections associated with this endpoint, you will need
         *   to specify its security groups.
         */
    ...
    internal constructor(
         ...
         * The security groups associated with the interface VPC endpoint.
         *
         * If you wish to manage the network connections associated with this endpoint, you will
         * need to specify its security groups.
         */
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: InterfaceVpcEndpointAttributes
