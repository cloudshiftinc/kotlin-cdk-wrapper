...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param filterPattern A filter pattern for extracting metric data out of ingested log
         *   events.
         */
         ...
         *
         * @param logGroupName The name of an existing log group that you want to associate with
         *   this metric filter.
         */
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.logs.CfnMetricFilter =
            cdkBuilder.build()
    }
    ...
    public interface DimensionProperty {
         ...
         *
         * This dimension will only be published for a metric if the value is found in the log
         * event. For example, `$.eventType` for JSON log events, or `$server` for space-delimited
         * log events.
         *
        ...
        public interface Builder {
            /**
             * @param key The name for the CloudWatch metric dimension that the metric filter
             *   creates. Dimension names must contain only ASCII characters, must include at least
             *   one non-whitespace character, and cannot start with a colon (:).
             */
            public fun key(key: String)

            /**
             * @param value The log event field that will contain the value for this dimension. This
             *   dimension will only be published for a metric if the value is found in the log
             *   event. For example, `$.eventType` for JSON log events, or `$server` for
    ...
    public interface MetricTransformationProperty {
         ...
         * specify 1 for the metric value. If you're counting the number of bytes transferred,
         * reference the value that is in the log event by using $. followed by the name of the
         * field that you specified in the filter pattern, such as `$.size` .
         *
        ...
        public interface Builder {
            /**
             * @param defaultValue (Optional) The value to emit when a filter pattern does not match
             *   a log event. This value can be null.
             */
            public fun defaultValue(defaultValue: Number)

            /**
             * @param dimensions The fields to use as dimensions for the metric. One metric filter
             ...
             * or `requestID` as dimensions. Each different value found for a dimension is treated
             * as a separate metric and accrues charges as a separate custom metric.
             *
            ...
            /**
             * @param metricNamespace A custom namespace to contain your metric in CloudWatch. Use
             *   namespaces to group together metrics that are similar. For more information, see
             *   [Namespaces](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/cloudwatch_concepts.html#Namespace)
             *   .
             */
            ...
            /**
             * @param metricValue The value that is published to the CloudWatch metric. For example,
             *   if you're counting the occurrences of a particular term like `Error` , specify 1
             *   for the metric value. If you're counting the number of bytes transferred, reference
             *   the value that is in the log event by using $. followed by the name of the field
             *   that you specified in the filter pattern, such as `$.size` .
             */
            public fun metricValue(metricValue: String)

            /**
             * @param unit The unit to assign to the metric. If you omit this, the unit is set as
             *   `None` .
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: MetricTransformationProperty
            ): software.amazon.awscdk.services.logs.CfnMetricFilter.MetricTransformationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
