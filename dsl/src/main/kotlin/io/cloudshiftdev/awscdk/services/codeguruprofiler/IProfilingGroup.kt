...
public interface IProfilingGroup : IResource {
    ...
    internal constructor(
        ...
        /**
         * Grant access to publish profiling information to the Profiling Group to the given
         * identity.
         *
         * This will grant the following permissions:
         * * codeguru-profiler:ConfigureAgent
        ...
        /**
         * Grant access to read profiling information from the Profiling Group to the given
         * identity.
         *
         * This will grant the following permissions:
         * * codeguru-profiler:GetProfile
