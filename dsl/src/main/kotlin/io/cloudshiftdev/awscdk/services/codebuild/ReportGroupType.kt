...
public enum class ReportGroupType(
    ...
    public companion object {
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.codebuild.ReportGroupType
        ): ReportGroupType =
            when (cdkObject) {
                software.amazon.awscdk.services.codebuild.ReportGroupType.TEST ->
