...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param serviceDnsName The DNS name that Device Farm will use to map to the private
         ...
         *
         * @param vpceConfigurationDescription An optional description that provides details about
         ...
         *
         * @param vpceConfigurationName The friendly name you give to your VPC endpoint
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.devicefarm.CfnVPCEConfiguration.Builder.create(
                scope,
                id
            )
