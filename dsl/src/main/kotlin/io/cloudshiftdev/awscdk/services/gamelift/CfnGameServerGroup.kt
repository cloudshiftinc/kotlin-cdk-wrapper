...
internal constructor(
    ...
    public interface Builder {
         ...
         * Scaling group is created, update this value directly in the Auto Scaling group using the
         * AWS console or APIs.
         *
         ...
         *   hosting capacity until Spot Instances can again be used. Until then, no new instances
         *   are started, and the existing nonviable Spot Instances are terminated (after current
         *   gameplay ends) and are not replaced.
         * * `SPOT_PREFERRED` - (default value) Spot Instances are used whenever available in the
         *   game server group. If Spot Instances are unavailable, the game server group continues
         *   to provide hosting capacity by falling back to On-Demand Instances. Existing nonviable
         *   Spot Instances are terminated (after current gameplay ends) and are replaced with new
         *   On-Demand Instances.
         ...
         * The type of delete to perform.
         *
         * To delete a game server group, specify the `DeleteOption` . Options include the
         * following:
         ...
         * scale-down event, causing players to be dropped from the game. Protected instances cannot
         * be terminated while there are active game servers running except in the event of a forced
         * game server group deletion (see ). An exception to this is with Spot Instances, which can
         * be terminated by AWS regardless of protection status.
         *
         ...
         *
         * @param gameServerProtectionPolicy A flag that indicates whether instances in the game
         *   server group are protected from early termination.
         */
         ...
         *
         * @param instanceDefinitions The set of Amazon EC2 instance types that Amazon GameLift
         *   FleetIQ can use when balancing and automatically scaling instances in the corresponding
         *   Auto Scaling group.
         */
         ...
         * to be deployed to all instances in the game server group.
         *
         * You can specify the template using either the template name or ID. For help with creating
         * a launch template, see
         ...
         *
         * @param launchTemplate The Amazon EC2 launch template that contains configuration settings
         *   and game server code to be deployed to all instances in the game server group.
         */
         ...
         * The maximum number of instances allowed in the Amazon EC2 Auto Scaling group.
         *
         * During automatic scaling events, Amazon GameLift FleetIQ and EC2 do not scale up the
         ...
         *
         * @param maxSize The maximum number of instances allowed in the Amazon EC2 Auto Scaling
         *   group.
         */
         ...
         * the group below this minimum. In production, this value should be set to at least 1.
         ...
         *
         * @param minSize The minimum number of instances allowed in the Amazon EC2 Auto Scaling
         *   group.
         */
        ...
        /**
         * The Amazon Resource Name (
         * [ARN](https://docs.aws.amazon.com/AmazonS3/latest/dev/s3-arn-format.html) ) for an IAM
         ...
         * group.
         *
         * By default, all Amazon GameLift FleetIQ-supported Availability Zones are used. You can
         * use this parameter to specify VPCs that you've set up. This property cannot be updated
         * after the game server group is created, and the corresponding Auto Scaling group will
         * always use the property value that is set with this request, even if the Auto Scaling
    ...
    public interface LaunchTemplateProperty {
        ...
        public interface Builder {
            /**
             * @param launchTemplateId A unique identifier for an existing Amazon EC2 launch
             *   template.
             */
            public fun launchTemplateId(launchTemplateId: String)

            /**
             * @param launchTemplateName A readable identifier for an existing Amazon EC2 launch
             *   template.
             */
        ...
        internal constructor(
             ...
             * The version of the Amazon EC2 launch template to use.
             *
             * If no version is specified, the default version will be used. With Amazon EC2, you
             * can specify a default version for a launch template. If none is set, the default is
    ...
    public interface AutoScalingPolicyProperty {
         ...
         * processes and register with Amazon GameLift FleetIQ.
         *
        ...
        public interface Builder {
            /**
             * @param estimatedInstanceWarmup Length of time, in seconds, it takes for a new
             *   instance to start new game server processes and register with Amazon GameLift
             *   FleetIQ. Specifying a warm-up time can be useful, particularly with game servers
             *   that take a long time to start up, because it avoids prematurely starting new
             *   instances.
             */
            public fun estimatedInstanceWarmup(estimatedInstanceWarmup: Number)

            /**
             * @param targetTrackingConfiguration Settings for a target-based scaling policy applied
             *   to Auto Scaling group. These settings are used to create a target-based policy that
             *   tracks the GameLift FleetIQ metric `PercentUtilizedGameServers` and specifies a
             *   target value for the metric. As player usage changes, the policy triggers to adjust
        ...
        internal constructor(
             ...
             * processes and register with Amazon GameLift FleetIQ.
             *
             * Specifying a warm-up time can be useful, particularly with game servers that take a
    ...
    public interface InstanceDefinitionProperty {
         ...
         *
         * Instance weights are used by Amazon GameLift FleetIQ to calculate the instance type's
         * cost per unit hour and better identify the most cost-effective options. For detailed
         * information on weighting instance capacity, see
        ...
        public interface Builder {
             ...
             *   contributes to the total capacity of a game server group. Instance weights are used
             *   by Amazon GameLift FleetIQ to calculate the instance type's cost per unit hour and
             *   better identify the most cost-effective options. For detailed information on
             *   weighting instance capacity, see
             *   [Instance Weighting](https://docs.aws.amazon.com/autoscaling/ec2/userguide/asg-instance-weighting.html)
        ...
        internal constructor(
             ...
             * total capacity of a game server group.
             *
             * Instance weights are used by Amazon GameLift FleetIQ to calculate the instance type's
             * cost per unit hour and better identify the most cost-effective options. For detailed
             * information on weighting instance capacity, see
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: InstanceDefinitionProperty
            ): software.amazon.awscdk.services.gamelift.CfnGameServerGroup.InstanceDefinitionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
