...
internal constructor(
    ...
    public open fun dataSourceParameters(
        `value`: DataSourceParametersProperty.Builder.() -> Unit
    ...
    public open fun vpcConnectionProperties(`value`: VpcConnectionPropertiesProperty) {
        unwrap(this)
            .setVpcConnectionProperties(`value`.let(VpcConnectionPropertiesProperty::unwrap))
    }
    ...
    public open fun vpcConnectionProperties(
        `value`: VpcConnectionPropertiesProperty.Builder.() -> Unit
    ): Unit = vpcConnectionProperties(VpcConnectionPropertiesProperty(`value`))
    ...
    public interface Builder {
         ...
         * stored with this data source.
         *
         * The credentials are applied in tandem with the data source parameters when you copy a
         ...
         * `AlternateDataSourceParameters` allow list. If the structures are an exact match, the
         ...
         *   want to share for the credentials stored with this data source.
         */
        ...
        public fun dataSourceParameters(
            dataSourceParameters: DataSourceParametersProperty.Builder.() -> Unit
        )
         ...
         *
         * @param errorInfo Error information from the last update or the creation of the data
         *   source.
         */
         ...
         *
         * @param sslProperties Secure Socket Layer (SSL) properties that apply when Amazon
         ...
         *
         * @param vpcConnectionProperties Use this parameter only when you want Amazon QuickSight to
        ...
        public fun vpcConnectionProperties(
            vpcConnectionProperties: VpcConnectionPropertiesProperty.Builder.() -> Unit
        )
    }
    ...
    private class BuilderImpl(
        ...
        override fun alternateDataSourceParameters(alternateDataSourceParameters: IResolvable) {
            cdkBuilder.alternateDataSourceParameters(
                alternateDataSourceParameters.let(IResolvable::unwrap)
            )
        }
         ...
         *   want to share for the credentials stored with this data source.
         */
        override fun alternateDataSourceParameters(
            vararg alternateDataSourceParameters: Any
        ): Unit = alternateDataSourceParameters(alternateDataSourceParameters.toList())
        ...
        override fun credentials(
            credentials: DataSourceCredentialsProperty.Builder.() -> Unit
        ...
        override fun dataSourceParameters(dataSourceParameters: DataSourceParametersProperty) {
            cdkBuilder.dataSourceParameters(
                dataSourceParameters.let(DataSourceParametersProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("d0be218c60213d251370615a299fc07bd660fcf7619e829bbad962705616cfce")
        override fun dataSourceParameters(
            dataSourceParameters: DataSourceParametersProperty.Builder.() -> Unit
         ...
         *   use a VPC connection when connecting to your underlying source.
         */
        override fun vpcConnectionProperties(
            vpcConnectionProperties: VpcConnectionPropertiesProperty
        ) {
            cdkBuilder.vpcConnectionProperties(
                vpcConnectionProperties.let(VpcConnectionPropertiesProperty::unwrap)
            )
        }
    ...
    public interface AuroraParametersProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AuroraParametersProperty
            ): software.amazon.awscdk.services.quicksight.CfnDataSource.AuroraParametersProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface RedshiftParametersProperty {
        ...
        public interface Builder {
            /**
             * @param clusterId Cluster ID. This field can be blank if the `Host` and `Port` are
             *   provided.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RedshiftParametersProperty
            ): software.amazon.awscdk.services.quicksight.CfnDataSource.RedshiftParametersProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface TeradataParametersProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TeradataParametersProperty
            ): software.amazon.awscdk.services.quicksight.CfnDataSource.TeradataParametersProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface OracleParametersProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: OracleParametersProperty
            ): software.amazon.awscdk.services.quicksight.CfnDataSource.OracleParametersProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface VpcConnectionPropertiesProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: VpcConnectionPropertiesProperty
            ): software.amazon.awscdk.services.quicksight.CfnDataSource.VpcConnectionPropertiesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface S3ParametersProperty {
        ...
        /**
         * Use the `RoleArn` structure to override an account-wide role for a specific S3 data
         * source.
         *
         * For example, say an account administrator has turned off all S3 access with an
         * account-wide role. The administrator can then use `RoleArn` to bypass the account-wide
         * role and allow S3 access for the single S3 data source that is specified in the
         * structure, even if the account-wide role forbidding S3 access is still active.
         *
        ...
        public interface Builder {
            /**
             * @param manifestFileLocation Location of the Amazon S3 manifest file. This is NULL if
            ...
            public fun manifestFileLocation(
                manifestFileLocation: ManifestFileLocationProperty.Builder.() -> Unit
            )

            /**
             * @param roleArn Use the `RoleArn` structure to override an account-wide role for a
             *   specific S3 data source. For example, say an account administrator has turned off
             *   all S3 access with an account-wide role. The administrator can then use `RoleArn`
             *   to bypass the account-wide role and allow S3 access for the single S3 data source
        ...
        private class BuilderImpl : Builder {
            ...
            override fun manifestFileLocation(manifestFileLocation: ManifestFileLocationProperty) {
                cdkBuilder.manifestFileLocation(
                    manifestFileLocation.let(ManifestFileLocationProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("d401bd5d60fc3f30f93f9b08f35377bfd666a889a4f66dc9c5e18ae4d64e6540")
            override fun manifestFileLocation(
                manifestFileLocation: ManifestFileLocationProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             *
             * For example, say an account administrator has turned off all S3 access with an
             * account-wide role. The administrator can then use `RoleArn` to bypass the
             * account-wide role and allow S3 access for the single S3 data source that is specified
    ...
    public interface AuroraPostgreSqlParametersProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AuroraPostgreSqlParametersProperty
            ): software.amazon.awscdk.services.quicksight.CfnDataSource.AuroraPostgreSqlParametersProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface TrinoParametersProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TrinoParametersProperty
            ): software.amazon.awscdk.services.quicksight.CfnDataSource.TrinoParametersProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface PrestoParametersProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: PrestoParametersProperty
            ): software.amazon.awscdk.services.quicksight.CfnDataSource.PrestoParametersProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CredentialPairProperty {
        ...
        public interface Builder {
            /**
             * @param alternateDataSourceParameters A set of alternate data source parameters that
             *   you want to share for these credentials. The credentials are applied in tandem with
             *   the data source parameters when you copy a data source by using a create or update
             *   request. The API operation compares the `DataSourceParameters` structure that's in
             *   the request with the structures in the `AlternateDataSourceParameters` allow list.
             *   If the structures are an exact match, the request is allowed to use the new data
             *   source with the existing credentials. If the `AlternateDataSourceParameters` list
             *   is null, the `DataSourceParameters` originally used with these `Credentials` is
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CredentialPairProperty
            ): software.amazon.awscdk.services.quicksight.CfnDataSource.CredentialPairProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface AmazonOpenSearchParametersProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AmazonOpenSearchParametersProperty
            ): software.amazon.awscdk.services.quicksight.CfnDataSource.AmazonOpenSearchParametersProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DataSourceParametersProperty {
        ...
        public interface Builder {
            ...
            public fun amazonElasticsearchParameters(
                amazonElasticsearchParameters:
                    AmazonElasticsearchParametersProperty.Builder.() -> Unit
            )
            ...
            public fun amazonOpenSearchParameters(
                amazonOpenSearchParameters: AmazonOpenSearchParametersProperty.Builder.() -> Unit
            )
            ...
            public fun athenaParameters(
                athenaParameters: AthenaParametersProperty.Builder.() -> Unit
            )
            ...
            public fun auroraParameters(
                auroraParameters: AuroraParametersProperty.Builder.() -> Unit
            )
            ...
            public fun auroraPostgreSqlParameters(
                auroraPostgreSqlParameters: AuroraPostgreSqlParametersProperty.Builder.() -> Unit
            )
            ...
            public fun databricksParameters(
                databricksParameters: DatabricksParametersProperty.Builder.() -> Unit
            )
            ...
            public fun mariaDbParameters(
                mariaDbParameters: MariaDbParametersProperty.Builder.() -> Unit
            )
            ...
            public fun oracleParameters(
                oracleParameters: OracleParametersProperty.Builder.() -> Unit
            )
            ...
            public fun postgreSqlParameters(
                postgreSqlParameters: PostgreSqlParametersProperty.Builder.() -> Unit
            )
            ...
            public fun prestoParameters(
                prestoParameters: PrestoParametersProperty.Builder.() -> Unit
            )
            ...
            public fun redshiftParameters(
                redshiftParameters: RedshiftParametersProperty.Builder.() -> Unit
            )
            ...
            public fun snowflakeParameters(
                snowflakeParameters: SnowflakeParametersProperty.Builder.() -> Unit
            )
            ...
            public fun sqlServerParameters(
                sqlServerParameters: SqlServerParametersProperty.Builder.() -> Unit
            )

            /**
             * @param starburstParameters The parameters that are required to connect to a Starburst
             *   data source.
             */
            ...
            public fun starburstParameters(
                starburstParameters: StarburstParametersProperty.Builder.() -> Unit
            )
            ...
            public fun teradataParameters(
                teradataParameters: TeradataParametersProperty.Builder.() -> Unit
            )

            /**
             * @param trinoParameters The parameters that are required to connect to a Trino data
             *   source.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            override fun amazonElasticsearchParameters(amazonElasticsearchParameters: IResolvable) {
                cdkBuilder.amazonElasticsearchParameters(
                    amazonElasticsearchParameters.let(IResolvable::unwrap)
                )
            }

            /** @param amazonElasticsearchParameters The parameters for OpenSearch. */
            override fun amazonElasticsearchParameters(
                amazonElasticsearchParameters: AmazonElasticsearchParametersProperty
            ) {
                cdkBuilder.amazonElasticsearchParameters(
                    amazonElasticsearchParameters.let(AmazonElasticsearchParametersProperty::unwrap)
                )
            }
            ...
            override fun amazonElasticsearchParameters(
                ...
                amazonElasticsearchParameters(
                    AmazonElasticsearchParametersProperty(amazonElasticsearchParameters)
                )

            /** @param amazonOpenSearchParameters The parameters for OpenSearch. */
            override fun amazonOpenSearchParameters(amazonOpenSearchParameters: IResolvable) {
                cdkBuilder.amazonOpenSearchParameters(
                    amazonOpenSearchParameters.let(IResolvable::unwrap)
                )
            }

            /** @param amazonOpenSearchParameters The parameters for OpenSearch. */
            override fun amazonOpenSearchParameters(
                amazonOpenSearchParameters: AmazonOpenSearchParametersProperty
            ) {
                cdkBuilder.amazonOpenSearchParameters(
                    amazonOpenSearchParameters.let(AmazonOpenSearchParametersProperty::unwrap)
                )
            }
            ...
            override fun amazonOpenSearchParameters(
                ...
                amazonOpenSearchParameters(
                    AmazonOpenSearchParametersProperty(amazonOpenSearchParameters)
                )
            ...
            override fun auroraPostgreSqlParameters(auroraPostgreSqlParameters: IResolvable) {
                cdkBuilder.auroraPostgreSqlParameters(
                    auroraPostgreSqlParameters.let(IResolvable::unwrap)
                )
            }

            /** @param auroraPostgreSqlParameters The parameters for Amazon Aurora. */
            override fun auroraPostgreSqlParameters(
                auroraPostgreSqlParameters: AuroraPostgreSqlParametersProperty
            ) {
                cdkBuilder.auroraPostgreSqlParameters(
                    auroraPostgreSqlParameters.let(AuroraPostgreSqlParametersProperty::unwrap)
                )
            }
            ...
            override fun auroraPostgreSqlParameters(
                ...
                auroraPostgreSqlParameters(
                    AuroraPostgreSqlParametersProperty(auroraPostgreSqlParameters)
                )
            ...
            override fun databricksParameters(databricksParameters: DatabricksParametersProperty) {
                cdkBuilder.databricksParameters(
                    databricksParameters.let(DatabricksParametersProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("9f94d35e9ca8d723c5d7e8f8671be3ce033195932307971de6e56b5824d75daa")
            override fun databricksParameters(
                databricksParameters: DatabricksParametersProperty.Builder.() -> Unit
            ...
            override fun mariaDbParameters(mariaDbParameters: MariaDbParametersProperty) {
                cdkBuilder.mariaDbParameters(
                    mariaDbParameters.let(MariaDbParametersProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("a8dfc6560f1ecfdee4e6c954ff83a8b783c6bb7e798d686f9a41eaf5c8d54097")
            override fun mariaDbParameters(
                mariaDbParameters: MariaDbParametersProperty.Builder.() -> Unit
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("e793ab3d603d10e4491bd0313ed0e779d66eceb0a5ba76fa715896f351ada4cc")
            override fun mySqlParameters(
                mySqlParameters: MySqlParametersProperty.Builder.() -> Unit
            ...
            override fun postgreSqlParameters(postgreSqlParameters: PostgreSqlParametersProperty) {
                cdkBuilder.postgreSqlParameters(
                    postgreSqlParameters.let(PostgreSqlParametersProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("0843b21be6225317dfaa48505e7df79e575abbfefe2d32c4a8699d35290a145f")
            override fun postgreSqlParameters(
                postgreSqlParameters: PostgreSqlParametersProperty.Builder.() -> Unit
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("ca5d49532078df9da6d2eac5ef912be5d3969312e1067bdd2a904e7d32b1225f")
            override fun rdsParameters(
                rdsParameters: RdsParametersProperty.Builder.() -> Unit
            ...
            override fun redshiftParameters(redshiftParameters: RedshiftParametersProperty) {
                cdkBuilder.redshiftParameters(
                    redshiftParameters.let(RedshiftParametersProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("bea46f7205647aa4a150520dd27625d45546af4b1e51091246d80cb7514726f5")
            override fun redshiftParameters(
                redshiftParameters: RedshiftParametersProperty.Builder.() -> Unit
            ...
            override fun snowflakeParameters(snowflakeParameters: SnowflakeParametersProperty) {
                cdkBuilder.snowflakeParameters(
                    snowflakeParameters.let(SnowflakeParametersProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("b72744628bc594ff8779b64b835ccca7b04fa83bba9a97fd1f9ae1dc433be00b")
            override fun sparkParameters(
                sparkParameters: SparkParametersProperty.Builder.() -> Unit
            ...
            override fun sqlServerParameters(sqlServerParameters: SqlServerParametersProperty) {
                cdkBuilder.sqlServerParameters(
                    sqlServerParameters.let(SqlServerParametersProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("07f1d510b965d1261f5828f33f04be6ef3437a9e1de4cb5fad330f3614b0c2b9")
            override fun sqlServerParameters(
                sqlServerParameters: SqlServerParametersProperty.Builder.() -> Unit
            ...
            override fun starburstParameters(starburstParameters: StarburstParametersProperty) {
                cdkBuilder.starburstParameters(
                    starburstParameters.let(StarburstParametersProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("c7e60cc94b7b984169f0774ce19bca38f94482a6fdf5b8db568b9cf2f4a70580")
            override fun starburstParameters(
                starburstParameters: StarburstParametersProperty.Builder.() -> Unit
            ...
            override fun teradataParameters(teradataParameters: TeradataParametersProperty) {
                cdkBuilder.teradataParameters(
                    teradataParameters.let(TeradataParametersProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("cc3042e9939672e0a8c2c616fe1a207e7898eadbcddbc2b9f7134a6e1393e834")
            override fun teradataParameters(
                teradataParameters: TeradataParametersProperty.Builder.() -> Unit
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("750e071517f85857906e681d642e8648c75d3c0402bd664ebd30f7debe29ccc3")
            override fun trinoParameters(
                trinoParameters: TrinoParametersProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-quicksight-datasource-datasourceparameters.html#cfn-quicksight-datasource-datasourceparameters-amazonopensearchparameters)
             */
            override fun amazonOpenSearchParameters(): Any? =
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-quicksight-datasource-datasourceparameters.html#cfn-quicksight-datasource-datasourceparameters-aurorapostgresqlparameters)
             */
            override fun auroraPostgreSqlParameters(): Any? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DataSourceParametersProperty
            ): software.amazon.awscdk.services.quicksight.CfnDataSource.DataSourceParametersProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DataSourceErrorInfoProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DataSourceErrorInfoProperty
            ): software.amazon.awscdk.services.quicksight.CfnDataSource.DataSourceErrorInfoProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SqlServerParametersProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SqlServerParametersProperty
            ): software.amazon.awscdk.services.quicksight.CfnDataSource.SqlServerParametersProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface AthenaParametersProperty {
         ...
         * account-wide role. The administrator can then use `RoleArn` to bypass the account-wide
         * role and allow Athena access for the single Athena data source that is specified in the
         * structure, even if the account-wide role forbidding Athena access is still active.
         *
        ...
        public interface Builder {
            /**
             * @param roleArn Use the `RoleArn` structure to override an account-wide role for a
             *   specific Athena data source. For example, say an account administrator has turned
             *   off all Athena access with an account-wide role. The administrator can then use
             *   `RoleArn` to bypass the account-wide role and allow Athena access for the single
             *   Athena data source that is specified in the structure, even if the account-wide
        ...
        internal constructor(
             ...
             * For example, say an account administrator has turned off all Athena access with an
             * account-wide role. The administrator can then use `RoleArn` to bypass the
             * account-wide role and allow Athena access for the single Athena data source that is
             * specified in the structure, even if the account-wide role forbidding Athena access is
             * still active.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-quicksight-datasource-athenaparameters.html#cfn-quicksight-datasource-athenaparameters-rolearn)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AthenaParametersProperty
            ): software.amazon.awscdk.services.quicksight.CfnDataSource.AthenaParametersProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SnowflakeParametersProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SnowflakeParametersProperty
            ): software.amazon.awscdk.services.quicksight.CfnDataSource.SnowflakeParametersProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SparkParametersProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SparkParametersProperty
            ): software.amazon.awscdk.services.quicksight.CfnDataSource.SparkParametersProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface StarburstParametersProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: StarburstParametersProperty
            ): software.amazon.awscdk.services.quicksight.CfnDataSource.StarburstParametersProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ManifestFileLocationProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ManifestFileLocationProperty
            ): software.amazon.awscdk.services.quicksight.CfnDataSource.ManifestFileLocationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DataSourceCredentialsProperty {
        ...
        /**
         * The Amazon Resource Name (ARN) of the secret associated with the data source in AWS
         * Secrets Manager .
         *
        ...
        public interface Builder {
             ...
             *   credential pair that you want to use. When `CopySourceArn` is not null, the
             *   credential pair from the data source in the ARN is used as the credentials for the
            ...
            /**
             * @param secretArn The Amazon Resource Name (ARN) of the secret associated with the
             *   data source in AWS Secrets Manager .
             */
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("315871381c49148e355518ab9833e78ced1546740cad061b89e892cea02829dc")
            override fun credentialPair(
                credentialPair: CredentialPairProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * want to use.
             *
             * When `CopySourceArn` is not null, the credential pair from the data source in the ARN
             * is used as the credentials for the `DataSourceCredentials` structure.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-quicksight-datasource-datasourcecredentials.html#cfn-quicksight-datasource-datasourcecredentials-copysourcearn)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DataSourceCredentialsProperty
            ): software.amazon.awscdk.services.quicksight.CfnDataSource.DataSourceCredentialsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface MySqlParametersProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: MySqlParametersProperty
            ): software.amazon.awscdk.services.quicksight.CfnDataSource.MySqlParametersProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface AmazonElasticsearchParametersProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AmazonElasticsearchParametersProperty
            ): software.amazon.awscdk.services.quicksight.CfnDataSource.AmazonElasticsearchParametersProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DatabricksParametersProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DatabricksParametersProperty
            ): software.amazon.awscdk.services.quicksight.CfnDataSource.DatabricksParametersProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface PostgreSqlParametersProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: PostgreSqlParametersProperty
            ): software.amazon.awscdk.services.quicksight.CfnDataSource.PostgreSqlParametersProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface MariaDbParametersProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: MariaDbParametersProperty
            ): software.amazon.awscdk.services.quicksight.CfnDataSource.MariaDbParametersProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
