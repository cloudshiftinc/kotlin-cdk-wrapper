...
public interface EbsDeviceProps : EbsDeviceSnapshotOptions, EbsDeviceOptions {
    ...
    public interface Builder {
        ...
        /**
         * @param kmsKey The ARN of the AWS Key Management Service (AWS KMS) CMK used for
         *   encryption. You have to ensure that the KMS CMK has the correct permissions to be used
         *   by the service launching the ec2 instances.
         */
        ...
        /**
         * @param volumeSize The volume size, in Gibibytes (GiB). If you specify volumeSize, it must
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: EbsDeviceProps
        ): software.amazon.awscdk.services.ec2.EbsDeviceProps = (wrapped as Wrapper).cdkObject
    }
}
