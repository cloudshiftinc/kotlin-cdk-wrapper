...
public interface IApplicationTargetGroupMetrics {
  ...
  private class Wrapper internal constructor(
    ...
    public override fun healthyHostCount(): Metric =
        unwrap(this).healthyHostCount().let(Metric::wrap)

    public override fun healthyHostCount(arg0: MetricOptions): Metric =
        unwrap(this).healthyHostCount(arg0.let(MetricOptions::unwrap)).let(Metric::wrap)

    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("86001b538e3d7af3f82ae55f087e4d922defb3087f332d19bda9d0eca9b8461c")
    public override fun healthyHostCount(arg0: MetricOptions.Builder.() -> Unit): Metric =
    ...
    public override fun requestCountPerTarget(): Metric =
        unwrap(this).requestCountPerTarget().let(Metric::wrap)

    public override fun requestCountPerTarget(arg0: MetricOptions): Metric =
        unwrap(this).requestCountPerTarget(arg0.let(MetricOptions::unwrap)).let(Metric::wrap)

    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("cf92ac9d951ad9e742f4a5229fa957e5c56292b1a538cdfc7ab218a24986e6c8")
    public override fun requestCountPerTarget(arg0: MetricOptions.Builder.() -> Unit): Metric =
    ...
    public override fun unhealthyHostCount(): Metric =
        unwrap(this).unhealthyHostCount().let(Metric::wrap)

    public override fun unhealthyHostCount(arg0: MetricOptions): Metric =
        unwrap(this).unhealthyHostCount(arg0.let(MetricOptions::unwrap)).let(Metric::wrap)

    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("ba73ddc7b80468d5e7f5c25fb639e088f0f95e00b6cc146b9ac93a59bbc3eab1")
    public override fun unhealthyHostCount(arg0: MetricOptions.Builder.() -> Unit): Metric =
