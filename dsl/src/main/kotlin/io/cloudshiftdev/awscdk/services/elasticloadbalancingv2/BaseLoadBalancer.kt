...
internal constructor(
     ...
     *
     * A region must be specified on the stack containing the load balancer; you cannot enable
     * logging on environment-agnostic stacks. See
