...
public interface HostedZoneProviderProps {
     ...
     *
     * If a VPC ID is provided and privateZone is false, no results will be returned and an error
     * will be raised
     *
     * Default: - No VPC ID
     */
    ...
    public interface Builder {
        ...
        /**
         * @param vpcId Specifies the ID of the VPC associated with a private hosted zone. If a VPC
         *   ID is provided and privateZone is false, no results will be returned and an error will
         *   be raised
         */
    ...
    internal constructor(
         ...
         * Specifies the ID of the VPC associated with a private hosted zone.
         *
         * If a VPC ID is provided and privateZone is false, no results will be returned and an
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: HostedZoneProviderProps
