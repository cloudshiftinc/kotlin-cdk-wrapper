...
internal constructor(
    ...
    public open fun creatorMemberAbilities(): List<String> =
        unwrap(this).getCreatorMemberAbilities()
    ...
    public open fun creatorPaymentConfiguration(`value`: PaymentConfigurationProperty) {
        unwrap(this)
            .setCreatorPaymentConfiguration(`value`.let(PaymentConfigurationProperty::unwrap))
    }
    ...
    public open fun creatorPaymentConfiguration(
        `value`: PaymentConfigurationProperty.Builder.() -> Unit
    ...
    public open fun dataEncryptionMetadata(
        `value`: DataEncryptionMetadataProperty.Builder.() -> Unit
    ): Unit = dataEncryptionMetadata(DataEncryptionMetadataProperty(`value`))
    ...
    public interface Builder {
         ...
         *
         * @param creatorPaymentConfiguration An object representing the collaboration member's
        ...
        public fun creatorPaymentConfiguration(
            creatorPaymentConfiguration: PaymentConfigurationProperty.Builder.() -> Unit
        )
        ...
        public fun dataEncryptionMetadata(
            dataEncryptionMetadata: DataEncryptionMetadataProperty.Builder.() -> Unit
        )
         ...
         *
         * @param description A description of the collaboration provided by the collaboration
         *   owner.
         */
         ...
         *
         * @param queryLogStatus An indicator as to whether query logging has been enabled or
    ...
    private class BuilderImpl(
        ...
        override fun creatorPaymentConfiguration(creatorPaymentConfiguration: IResolvable) {
            cdkBuilder.creatorPaymentConfiguration(
                creatorPaymentConfiguration.let(IResolvable::unwrap)
            )
        }
         ...
         *   payment responsibilities set by the collaboration creator.
         */
        override fun creatorPaymentConfiguration(
            creatorPaymentConfiguration: PaymentConfigurationProperty
        ) {
            cdkBuilder.creatorPaymentConfiguration(
                creatorPaymentConfiguration.let(PaymentConfigurationProperty::unwrap)
            )
        }
         ...
         *   computing.
         */
        override fun dataEncryptionMetadata(
            dataEncryptionMetadata: DataEncryptionMetadataProperty
        ) {
            cdkBuilder.dataEncryptionMetadata(
                dataEncryptionMetadata.let(DataEncryptionMetadataProperty::unwrap)
            )
        }
    ...
    public interface PaymentConfigurationProperty {
        ...
        public interface Builder {
            ...
            public fun queryCompute(
                queryCompute: QueryComputePaymentConfigProperty.Builder.() -> Unit
            )
        }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: PaymentConfigurationProperty
            ): software.amazon.awscdk.services.cleanrooms.CfnCollaboration.PaymentConfigurationProperty =
    ...
    public interface MemberSpecificationProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param memberAbilities The abilities granted to the collaboration member. *Allowed
            ...
            /**
             * @param paymentConfiguration The collaboration member's payment responsibilities set
             *   by the collaboration creator. If the collaboration creator hasn't speciﬁed anyone
             *   as the member paying for query compute costs, then the member who can query is the
             *   default payer.
             */
            ...
            public fun paymentConfiguration(
                paymentConfiguration: PaymentConfigurationProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun paymentConfiguration(paymentConfiguration: PaymentConfigurationProperty) {
                cdkBuilder.paymentConfiguration(
                    paymentConfiguration.let(PaymentConfigurationProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("2d5a06511b955a4195335af93a8d0e1f041a053f94cec081565a6d60775ea448")
            override fun paymentConfiguration(
                paymentConfiguration: PaymentConfigurationProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: MemberSpecificationProperty
            ): software.amazon.awscdk.services.cleanrooms.CfnCollaboration.MemberSpecificationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface QueryComputePaymentConfigProperty {
         ...
         * pay for query compute costs ( `TRUE` ) or has not configured the collaboration member to
         ...
         * if the collaboration creator sets a `FALSE` value for the member who can query.
         *
        ...
        public interface Builder {
             ...
             *   collaboration member to pay for query compute costs ( `TRUE` ) or has not
             *   configured the collaboration member to pay for query compute costs ( `FALSE` ).
             *   Exactly one member can be configured to pay for query compute costs. An error is
             *   returned if the collaboration creator sets a `TRUE` value for more than one member
             *   in the collaboration.
             *
             * If the collaboration creator hasn't specified anyone as the member paying for query
             * compute costs, then the member who can query is the default payer. An error is
             * returned if the collaboration creator sets a `FALSE` value for the member who can
             * query.
             */
        ...
        internal constructor(
             ...
             * to pay for query compute costs ( `TRUE` ) or has not configured the collaboration
             * member to pay for query compute costs ( `FALSE` ).
             *
             * Exactly one member can be configured to pay for query compute costs. An error is
             * returned if the collaboration creator sets a `TRUE` value for more than one member in
             * the collaboration.
             *
             * If the collaboration creator hasn't specified anyone as the member paying for query
             * compute costs, then the member who can query is the default payer. An error is
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: QueryComputePaymentConfigProperty
            ): software.amazon.awscdk.services.cleanrooms.CfnCollaboration.QueryComputePaymentConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DataEncryptionMetadataProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param allowDuplicates Indicates whether Fingerprint columns can contain duplicate
            ...
            /**
             * @param allowJoinsOnColumnsWithDifferentNames Indicates whether Fingerprint columns
             *   can be joined on any other Fingerprint column with a different name ( `TRUE` ) or
             *   can only be joined on Fingerprint columns of the same name ( `FALSE` ).
             */
            ...
            /**
             * @param preserveNulls Indicates whether NULL values are to be copied as NULL to
             *   encrypted tables ( `TRUE` ) or cryptographically processed ( `FALSE` ).
             */
        ...
        private class BuilderImpl : Builder {
             ...
             *   can only be joined on Fingerprint columns of the same name ( `FALSE` ).
             */
            override fun allowJoinsOnColumnsWithDifferentNames(
                allowJoinsOnColumnsWithDifferentNames: Boolean
            ) {
                cdkBuilder.allowJoinsOnColumnsWithDifferentNames(
            ...
            override fun allowJoinsOnColumnsWithDifferentNames(
                ...
                cdkBuilder.allowJoinsOnColumnsWithDifferentNames(
                    allowJoinsOnColumnsWithDifferentNames.let(IResolvable::unwrap)
                )
            }
        ...
        internal constructor(
             ...
             * with a different name ( `TRUE` ) or can only be joined on Fingerprint columns of the
             * same name ( `FALSE` ).
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-cleanrooms-collaboration-dataencryptionmetadata.html#cfn-cleanrooms-collaboration-dataencryptionmetadata-allowjoinsoncolumnswithdifferentnames)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DataEncryptionMetadataProperty
            ): software.amazon.awscdk.services.cleanrooms.CfnCollaboration.DataEncryptionMetadataProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
