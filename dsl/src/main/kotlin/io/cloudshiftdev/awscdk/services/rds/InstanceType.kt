...
public enum class InstanceType(
    ...
    public companion object {
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.rds.InstanceType
        ): InstanceType =
            when (cdkObject) {
                software.amazon.awscdk.services.rds.InstanceType.PROVISIONED ->
                    InstanceType.PROVISIONED
                software.amazon.awscdk.services.rds.InstanceType.SERVERLESS_V2 ->
                    InstanceType.SERVERLESS_V2
            }

        internal fun unwrap(
            wrapped: InstanceType
        ): software.amazon.awscdk.services.rds.InstanceType = wrapped.cdkObject
    }
}
