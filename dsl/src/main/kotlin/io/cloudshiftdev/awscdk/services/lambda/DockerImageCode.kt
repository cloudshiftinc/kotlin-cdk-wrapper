...
internal constructor(
    ...
    public companion object {
        public fun fromEcr(repository: IRepository): DockerImageCode =
            software.amazon.awscdk.services.lambda.DockerImageCode.fromEcr(
                    repository.let(IRepository::unwrap)
                )
                .let(DockerImageCode::wrap)
        ...
        public fun fromImageAsset(directory: String, props: AssetImageCodeProps): DockerImageCode =
            software.amazon.awscdk.services.lambda.DockerImageCode.fromImageAsset(
                    directory,
