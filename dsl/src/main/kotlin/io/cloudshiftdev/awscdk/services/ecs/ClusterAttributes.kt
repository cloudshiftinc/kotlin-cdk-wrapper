...
public interface ClusterAttributes {
    ...
    public interface Builder {
        ...
        /**
         * @param defaultCloudMapNamespace The AWS Cloud Map namespace to associate with the
         *   cluster.
         */
        ...
        /**
         * @param securityGroups The security groups associated with the container instances
    ...
    private class BuilderImpl : Builder {
        ...
        public fun build(): software.amazon.awscdk.services.ecs.ClusterAttributes =
            cdkBuilder.build()
    }
