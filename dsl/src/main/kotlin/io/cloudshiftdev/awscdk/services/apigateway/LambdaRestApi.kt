...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * This handler will be used as a the default integration for all methods in this API,
        ...
        public fun integrationOptions(
            integrationOptions: LambdaIntegrationOptions.Builder.() -> Unit
        )
         ...
         *
         * If set to false, you will need to explicitly define the API model using `addResource` and
         * `addMethod` (or `addProxy`).
         *
         * Default: true
         *
    ...
    private class BuilderImpl(
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("b5d005eee577d04fb09645063da611f6916e9ccda71b6a2b253ca75188890de3")
        override fun integrationOptions(
            integrationOptions: LambdaIntegrationOptions.Builder.() -> Unit
