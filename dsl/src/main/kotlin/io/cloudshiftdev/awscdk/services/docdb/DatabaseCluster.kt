...
internal constructor(
    ...
    public open fun addRotationSingleUser(automaticallyAfter: Duration): SecretRotation =
        unwrap(this)
            .addRotationSingleUser(automaticallyAfter.let(Duration::unwrap))
            .let(SecretRotation::wrap)
     ...
     */
    public open fun clusterResourceIdentifier(): String =
    ...
    public interface Builder {
         ...
         *
         * If deletionProtection is enabled, the cluster cannot be deleted unless it is modified and
         ...
         *
         * Note that you also have to configure the audit log export in the Cluster's Parameter
         * Group.
         *
         * Default: false
         *
         ...
         *
         * @param exportAuditLogsToCloudWatch Whether the audit logs should be exported to
         *   CloudWatch.
         */
         ...
         *
         * Default: - `dbClusterName` is used with the word "Instance" appended. If `dbClusterName`
         * is not provided, the identifier is automatically generated.
         *
         ...
         *
         * Default: - `RemovalPolicy.DESTROY` when `removalPolicy` is set to `SNAPSHOT`,
         * `removalPolicy` otherwise.
         *
         ...
         *
         * @param preferredMaintenanceWindow A weekly time range in which maintenance should
         *   preferably execute.
         */
        public fun preferredMaintenanceWindow(preferredMaintenanceWindow: String)

        /**
         * The removal policy to apply when the cluster and its instances are removed or replaced
         * during a stack update, or when the stack is deleted.
         *
         * This removal policy also applies to the implicit security group created for the cluster
         * if one is not supplied as a parameter.
         *
    ...
    private class BuilderImpl(
        ...
        override fun securityGroupRemovalPolicy(securityGroupRemovalPolicy: RemovalPolicy) {
            cdkBuilder.securityGroupRemovalPolicy(
                securityGroupRemovalPolicy.let(RemovalPolicy::unwrap)
            )
        }
        ...
        public fun build(): software.amazon.awscdk.services.docdb.DatabaseCluster =
            cdkBuilder.build()
    }
    ...
    public companion object {
        public fun fromDatabaseClusterAttributes(
            ...
            software.amazon.awscdk.services.docdb.DatabaseCluster.fromDatabaseClusterAttributes(
