...
internal constructor(
     ...
     *
     * `remoteRule` controls where the Rule object is created if the peer is also a securityGroup
     * and they are in different stack. If false (default) the rule object is created under the
     * current SecurityGroup object. If true and the peer is also a SecurityGroup, the rule object
     * is created under the remote SecurityGroup object.
     *
     * @param peer
     * @param connection
     * @param description
    ...
    public override fun addEgressRule(
        ...
        unwrap(this)
            .addEgressRule(peer.let(IPeer::unwrap), connection.let(Port::unwrap), description)
    }
    ...
    public override fun addEgressRule(
        ...
        unwrap(this)
            .addEgressRule(
                peer.let(IPeer::unwrap),
                connection.let(Port::unwrap),
                description,
                remoteRule
            )
    }
    ...
    public override fun addIngressRule(
        ...
        unwrap(this)
            .addIngressRule(peer.let(IPeer::unwrap), connection.let(Port::unwrap), description)
    }
    ...
    public interface Builder {
         ...
         *
         * If this is set to true, there will only be a single egress rule which allows all outbound
         * ipv6 traffic. If this is set to false, no outbound traffic will be allowed by default and
         * all egress ipv6 traffic must be explicitly authorized.
         *
         ...
         * egress traffic must be explicitly authorized.
         *
         ...
         *
         * Inlining rules is an optimization for producing smaller stack templates. Sometimes this
         * is not desirable, for example when security group access is managed via tags.
         *
         ...
         *
         * For valid values, see the GroupName parameter of the CreateSecurityGroup action in the
         * Amazon EC2 API Reference.
         *
         * It is not recommended to use an explicit group name.
         *
         * Default: If you don't specify a GroupName, AWS CloudFormation generates a unique physical
    ...
    public companion object {
        public fun fromLookupById(
            ...
            software.amazon.awscdk.services.ec2.SecurityGroup.fromLookupById(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    securityGroupId
                )
                .let(ISecurityGroup::wrap)
        ...
        public fun fromLookupByName(
            ...
            software.amazon.awscdk.services.ec2.SecurityGroup.fromLookupByName(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    securityGroupName,
                    vpc.let(IVpc::unwrap)
        ...
        public fun fromSecurityGroupId(
            ...
            software.amazon.awscdk.services.ec2.SecurityGroup.fromSecurityGroupId(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    securityGroupId
                )
        ...
        public fun fromSecurityGroupId(
            ...
            software.amazon.awscdk.services.ec2.SecurityGroup.fromSecurityGroupId(
                    ...
                    id,
                    securityGroupId,
                    options.let(SecurityGroupImportOptions::unwrap)
                )
                .let(ISecurityGroup::wrap)
        ...
        public fun fromSecurityGroupId(
            ...
            fromSecurityGroupId(scope, id, securityGroupId, SecurityGroupImportOptions(options))
        ...
        ): SecurityGroup = SecurityGroup(cdkObject)

        internal fun unwrap(
            wrapped: SecurityGroup
        ): software.amazon.awscdk.services.ec2.SecurityGroup = wrapped.cdkObject
    }
}
