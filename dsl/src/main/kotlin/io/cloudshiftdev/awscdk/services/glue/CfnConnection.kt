...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * To specify the account ID, you can use the `Ref` intrinsic function with the
         * `AWS::AccountId` pseudo parameter. For example: `!Ref AWS::AccountId` .
         *
    ...
    private class BuilderImpl(
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("c054d79a6f4f180cc0bb153a4582bd3bf2eb5bd1d65394592303eaf70bb55bab")
        override fun connectionInput(
            connectionInput: ConnectionInputProperty.Builder.() -> Unit
        ): Unit = connectionInput(ConnectionInputProperty(connectionInput))
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnConnection
        ): software.amazon.awscdk.services.glue.CfnConnection = wrapped.cdkObject
    }
    ...
    public interface ConnectionInputProperty {
         ...
         *   `SKIP_CUSTOM_JDBC_CERT_VALIDATION` . These parameters are used to configure SSL with
         *   JDBC.
         ...
         *   Marketplace to read from and write to data stores that are not natively supported by
         *   AWS Glue .
         *
        ...
        public interface Builder {
            /**
             * @param connectionProperties These key-value pairs define parameters for the
             *   connection.
             */
            public fun connectionProperties(connectionProperties: Any)

            /**
             * @param connectionType The type of the connection. Currently, these types are
             *   supported:.
             * * `JDBC` - Designates a connection to a database through Java Database Connectivity
             *   (JDBC).
             *
             ...
             * `NETWORK` Connections do not require ConnectionParameters. Instead, provide a
             * PhysicalConnectionRequirements.
             * * `MARKETPLACE` - Uses configuration settings contained in a connector purchased from
             *   AWS Marketplace to read from and write to data stores that are not natively
             ...
             *   ) or `SECRET_ID` .
             * * `CUSTOM` - Uses configuration settings contained in a custom connector to read from
             *   and write to data stores that are not natively supported by AWS Glue .
             *
             * `SFTP` is not supported.
             *
             * For more information about how optional ConnectionProperties are used to configure
            ...
            /**
             * @param matchCriteria A list of criteria that can be used in selecting this
             *   connection.
             */
            ...
            /**
             * @param name The name of the connection. Connection will not function as expected
             *   without a name.
             */
            public fun name(name: String)

            /**
             * @param physicalConnectionRequirements A map of physical connection requirements, such
             *   as virtual private cloud (VPC) and `SecurityGroup` , that are needed to
            ...
            public fun physicalConnectionRequirements(
                physicalConnectionRequirements:
                    PhysicalConnectionRequirementsProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
             ...
             *   successfully make this connection.
             */
            override fun physicalConnectionRequirements(
                physicalConnectionRequirements: IResolvable
            ) {
                cdkBuilder.physicalConnectionRequirements(
                    physicalConnectionRequirements.let(IResolvable::unwrap)
                )
            }
            ...
            override fun physicalConnectionRequirements(
                ...
                cdkBuilder.physicalConnectionRequirements(
                    physicalConnectionRequirements.let(
                        PhysicalConnectionRequirementsProperty::unwrap
                    )
                )
            }
            ...
            override fun physicalConnectionRequirements(
                ...
                physicalConnectionRequirements(
                    PhysicalConnectionRequirementsProperty(physicalConnectionRequirements)
                )
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-glue-connection-connectioninput.html#cfn-glue-connection-connectioninput-matchcriteria)
             */
            override fun matchCriteria(): List<String> =
                unwrap(this).getMatchCriteria() ?: emptyList()
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ConnectionInputProperty
            ): software.amazon.awscdk.services.glue.CfnConnection.ConnectionInputProperty =
    ...
    public interface PhysicalConnectionRequirementsProperty {
        ...
        public interface Builder {
            /**
             * @param availabilityZone The connection's Availability Zone. This field is redundant
             *   because the specified subnet implies the Availability Zone to be used. Currently
        ...
        private class BuilderImpl : Builder {
            private val cdkBuilder:
                ...
                software.amazon.awscdk.services.glue.CfnConnection
        ...
        internal constructor(
             ...
             * The connection's Availability Zone.
             *
             * This field is redundant because the specified subnet implies the Availability Zone to
             * be used. Currently the field must be populated, but it will be deprecated in the
             * future.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-glue-connection-physicalconnectionrequirements.html#cfn-glue-connection-physicalconnectionrequirements-availabilityzone)
             */
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-glue-connection-physicalconnectionrequirements.html#cfn-glue-connection-physicalconnectionrequirements-securitygroupidlist)
             */
            override fun securityGroupIdList(): List<String> =
                unwrap(this).getSecurityGroupIdList() ?: emptyList()
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: PhysicalConnectionRequirementsProperty
            ): software.amazon.awscdk.services.glue.CfnConnection.PhysicalConnectionRequirementsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
