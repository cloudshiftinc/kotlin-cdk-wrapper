...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.pinpoint.CfnSmsTemplate,
    ...
    public interface Builder {
         ...
         *
         * @param body The message body to use in text messages that are based on the message
         *   template.
         */
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.pinpoint.CfnSmsTemplate =
            cdkBuilder.build()
    }
