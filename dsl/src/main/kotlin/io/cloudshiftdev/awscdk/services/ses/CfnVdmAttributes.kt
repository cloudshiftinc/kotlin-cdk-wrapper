...
internal constructor(
    ...
    public open fun dashboardAttributes(
        `value`: DashboardAttributesProperty.Builder.() -> Unit
    ): Unit = dashboardAttributes(DashboardAttributesProperty(`value`))
    ...
    public open fun guardianAttributes(
        `value`: GuardianAttributesProperty.Builder.() -> Unit
    ): Unit = guardianAttributes(GuardianAttributesProperty(`value`))
    ...
    public interface Builder {
        ...
        public fun dashboardAttributes(
            dashboardAttributes: DashboardAttributesProperty.Builder.() -> Unit
        )
        ...
        public fun guardianAttributes(
            guardianAttributes: GuardianAttributesProperty.Builder.() -> Unit
        )
    }
    ...
    private class BuilderImpl(
        ...
        override fun dashboardAttributes(dashboardAttributes: DashboardAttributesProperty) {
            cdkBuilder.dashboardAttributes(
                dashboardAttributes.let(DashboardAttributesProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("c4a692f1ea2143d633e81ff1451b925182bdddc1301c184b2a2a0c2d86ed08ff")
        override fun dashboardAttributes(
            dashboardAttributes: DashboardAttributesProperty.Builder.() -> Unit
        ...
        override fun guardianAttributes(guardianAttributes: GuardianAttributesProperty) {
            cdkBuilder.guardianAttributes(
                guardianAttributes.let(GuardianAttributesProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("d456f0e3099a8dac0b7281769a5de33cc908e5afffc3f15fa111de935db37551")
        override fun guardianAttributes(
            guardianAttributes: GuardianAttributesProperty.Builder.() -> Unit
        ): Unit = guardianAttributes(GuardianAttributesProperty(guardianAttributes))

        public fun build(): software.amazon.awscdk.services.ses.CfnVdmAttributes =
            cdkBuilder.build()
    }
    ...
    public interface DashboardAttributesProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DashboardAttributesProperty
            ): software.amazon.awscdk.services.ses.CfnVdmAttributes.DashboardAttributesProperty =
    ...
    public interface GuardianAttributesProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: GuardianAttributesProperty
            ): software.amazon.awscdk.services.ses.CfnVdmAttributes.GuardianAttributesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
