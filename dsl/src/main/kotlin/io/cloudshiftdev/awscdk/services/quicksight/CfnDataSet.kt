...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.quicksight.CfnDataSet,
    ...
    /** Groupings of columns that work together in certain Amazon QuickSight features. */
    public open fun columnGroups(vararg __idx_ac66f0: Any): Unit =
        columnGroups(__idx_ac66f0.toList())

    /** A set of one or more definitions of a `ColumnLevelPermissionRule` . */
    public open fun columnLevelPermissionRules(): Any? =
        unwrap(this).getColumnLevelPermissionRules()
    ...
    public open fun dataSetRefreshProperties(`value`: DataSetRefreshPropertiesProperty) {
        unwrap(this)
            .setDataSetRefreshProperties(`value`.let(DataSetRefreshPropertiesProperty::unwrap))
    }

    /** The refresh properties of a dataset. */
    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("1f503b96cf7d203a59d4b2249b4db2d74bc982b921ba7891718737c1784d32ad")
    public open fun dataSetRefreshProperties(
        `value`: DataSetRefreshPropertiesProperty.Builder.() -> Unit
    ...
    public open fun dataSetUsageConfiguration(`value`: DataSetUsageConfigurationProperty) {
        unwrap(this)
            .setDataSetUsageConfiguration(`value`.let(DataSetUsageConfigurationProperty::unwrap))
    }
    ...
    public open fun dataSetUsageConfiguration(
        `value`: DataSetUsageConfigurationProperty.Builder.() -> Unit
    ...
    public open fun ingestionWaitPolicy(
        `value`: IngestionWaitPolicyProperty.Builder.() -> Unit
    ): Unit = ingestionWaitPolicy(IngestionWaitPolicyProperty(`value`))
    ...
    public open fun rowLevelPermissionDataSet(`value`: RowLevelPermissionDataSetProperty) {
        unwrap(this)
            .setRowLevelPermissionDataSet(`value`.let(RowLevelPermissionDataSetProperty::unwrap))
    }

    /** The row-level security configuration for the data that you want to create. */
    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("a96a5cfa4e111de0081543de481cee9778cd7ed81f95ad730ba579990c838528")
    public open fun rowLevelPermissionDataSet(
        `value`: RowLevelPermissionDataSetProperty.Builder.() -> Unit
    ...
    /** The element you can use to define tags for row-level security. */
    public open fun rowLevelPermissionTagConfiguration(
        `value`: RowLevelPermissionTagConfigurationProperty
    ) {
        unwrap(this)
            .setRowLevelPermissionTagConfiguration(
                `value`.let(RowLevelPermissionTagConfigurationProperty::unwrap)
            )
    }
    ...
    public open fun rowLevelPermissionTagConfiguration(
        `value`: RowLevelPermissionTagConfigurationProperty.Builder.() -> Unit
    ): Unit =
        rowLevelPermissionTagConfiguration(RowLevelPermissionTagConfigurationProperty(`value`))
    ...
    public interface Builder {
        ...
        public fun dataSetRefreshProperties(
            dataSetRefreshProperties: DataSetRefreshPropertiesProperty.Builder.() -> Unit
        )

        /**
         * The usage configuration to apply to child datasets that reference this dataset as a
         * source.
         *
        ...
        public fun dataSetUsageConfiguration(
            dataSetUsageConfiguration: DataSetUsageConfigurationProperty.Builder.() -> Unit
        )
         ...
         *
         * @param fieldFolders The folder that contains fields and nested subfolders for your
         *   dataset.
         */
        ...
        public fun ingestionWaitPolicy(
            ingestionWaitPolicy: IngestionWaitPolicyProperty.Builder.() -> Unit
        )
         ...
         *
         * @param rowLevelPermissionDataSet The row-level security configuration for the data that
         *   you want to create.
         */
        ...
        public fun rowLevelPermissionDataSet(
            rowLevelPermissionDataSet: RowLevelPermissionDataSetProperty.Builder.() -> Unit
        )
        ...
        public fun rowLevelPermissionTagConfiguration(
            rowLevelPermissionTagConfiguration: IResolvable
        )
        ...
        public fun rowLevelPermissionTagConfiguration(
            rowLevelPermissionTagConfiguration:
                RowLevelPermissionTagConfigurationProperty.Builder.() -> Unit
        )
         ...
         *
         * @param tags Contains a map of the key-value pairs for the resource tag or tags assigned
         *   to the dataset.
         */
    ...
    private class BuilderImpl(
         ...
         *   features.
         */
        override fun columnGroups(vararg columnGroups: Any): Unit =
        ...
        override fun columnLevelPermissionRules(columnLevelPermissionRules: IResolvable) {
            cdkBuilder.columnLevelPermissionRules(
                columnLevelPermissionRules.let(IResolvable::unwrap)
            )
        }
         ...
         * @param dataSetRefreshProperties The refresh properties of a dataset.
         */
        override fun dataSetRefreshProperties(
            dataSetRefreshProperties: DataSetRefreshPropertiesProperty
        ) {
            cdkBuilder.dataSetRefreshProperties(
                dataSetRefreshProperties.let(DataSetRefreshPropertiesProperty::unwrap)
            )
        }
        ...
        override fun dataSetRefreshProperties(
            ...
            dataSetRefreshProperties(DataSetRefreshPropertiesProperty(dataSetRefreshProperties))
         ...
         *   reference this dataset as a source.
         */
        override fun dataSetUsageConfiguration(
            dataSetUsageConfiguration: DataSetUsageConfigurationProperty
        ) {
            cdkBuilder.dataSetUsageConfiguration(
                dataSetUsageConfiguration.let(DataSetUsageConfigurationProperty::unwrap)
            )
        }
        ...
        override fun ingestionWaitPolicy(ingestionWaitPolicy: IngestionWaitPolicyProperty) {
            cdkBuilder.ingestionWaitPolicy(
                ingestionWaitPolicy.let(IngestionWaitPolicyProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("2e9a06411827148f45b4562d2103434b0311c0f9d115d15413b42353b07b0dc6")
        override fun ingestionWaitPolicy(
            ingestionWaitPolicy: IngestionWaitPolicyProperty.Builder.() -> Unit
         ...
         *   you want to create.
         */
        override fun rowLevelPermissionDataSet(
            rowLevelPermissionDataSet: RowLevelPermissionDataSetProperty
        ) {
            cdkBuilder.rowLevelPermissionDataSet(
                rowLevelPermissionDataSet.let(RowLevelPermissionDataSetProperty::unwrap)
            )
        }
         ...
         *   row-level security.
         */
        override fun rowLevelPermissionTagConfiguration(
            rowLevelPermissionTagConfiguration: IResolvable
        ) {
            cdkBuilder.rowLevelPermissionTagConfiguration(
                rowLevelPermissionTagConfiguration.let(IResolvable::unwrap)
            )
        }
        ...
        override fun rowLevelPermissionTagConfiguration(
            ...
            cdkBuilder.rowLevelPermissionTagConfiguration(
                rowLevelPermissionTagConfiguration.let(
                    RowLevelPermissionTagConfigurationProperty::unwrap
                )
            )
        }
        ...
        override fun rowLevelPermissionTagConfiguration(
            ...
            rowLevelPermissionTagConfiguration(
                RowLevelPermissionTagConfigurationProperty(rowLevelPermissionTagConfiguration)
            )
        ...
        public fun build(): software.amazon.awscdk.services.quicksight.CfnDataSet =
            cdkBuilder.build()
    }
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnDataSet
        ): software.amazon.awscdk.services.quicksight.CfnDataSet = wrapped.cdkObject
    }
    ...
    public interface ColumnGroupProperty {
        ...
        public interface Builder {
            ...
            public fun geoSpatialColumnGroup(
                geoSpatialColumnGroup: GeoSpatialColumnGroupProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            /** @param geoSpatialColumnGroup Geospatial column group that denotes a hierarchy. */
            override fun geoSpatialColumnGroup(
                geoSpatialColumnGroup: GeoSpatialColumnGroupProperty
            ) {
                cdkBuilder.geoSpatialColumnGroup(
                    geoSpatialColumnGroup.let(GeoSpatialColumnGroupProperty::unwrap)
                )
            }
    ...
    public interface InputColumnProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param subType The sub data type of the column. Sub types are only available for
    ...
    public interface ColumnDescriptionProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ColumnDescriptionProperty
            ): software.amazon.awscdk.services.quicksight.CfnDataSet.ColumnDescriptionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CalculatedColumnProperty {
        ...
        public interface Builder {
            /**
             * @param columnId A unique ID to identify a calculated column. During a dataset update,
             *   if the column ID of a calculated column matches that of an existing calculated
        ...
        internal constructor(
             ...
             *
             * During a dataset update, if the column ID of a calculated column matches that of an
             * existing calculated column, Amazon QuickSight preserves the existing calculated
             * column.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-quicksight-dataset-calculatedcolumn.html#cfn-quicksight-dataset-calculatedcolumn-columnid)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CalculatedColumnProperty
            ): software.amazon.awscdk.services.quicksight.CfnDataSet.CalculatedColumnProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface S3SourceProperty {
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("7e1c99ab7c68549c21ceb18a313feb7b90a976e2a3bccae8689a7e49a2a353a4")
            override fun uploadSettings(
                uploadSettings: UploadSettingsProperty.Builder.() -> Unit
    ...
    public interface ResourcePermissionProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param principal The Amazon Resource Name (ARN) of the principal. This can be one of
             *   the following:.
             * * The ARN of an Amazon QuickSight user or group associated with a data source or
             ...
             * * The ARN of an AWS account root: This is an IAM ARN rather than a Amazon QuickSight
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ResourcePermissionProperty
            ): software.amazon.awscdk.services.quicksight.CfnDataSet.ResourcePermissionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ColumnTagProperty {
        ...
        public interface Builder {
            ...
            public fun columnDescription(
                columnDescription: ColumnDescriptionProperty.Builder.() -> Unit
            )
        ...
        private class BuilderImpl : Builder {
            ...
            override fun columnDescription(columnDescription: ColumnDescriptionProperty) {
                cdkBuilder.columnDescription(
                    columnDescription.let(ColumnDescriptionProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("03e5e3ca560aa97d41df505842459bdeaf0cd70b1d1271d530ee23614738cf74")
            override fun columnDescription(
                columnDescription: ColumnDescriptionProperty.Builder.() -> Unit
    ...
    public interface DateTimeDatasetParameterDefaultValuesProperty {
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-quicksight-dataset-datetimedatasetparameterdefaultvalues.html#cfn-quicksight-dataset-datetimedatasetparameterdefaultvalues-staticvalues)
             */
            override fun staticValues(): List<String> =
                unwrap(this).getStaticValues() ?: emptyList()
        }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DateTimeDatasetParameterDefaultValuesProperty
            ): software.amazon.awscdk.services.quicksight.CfnDataSet.DateTimeDatasetParameterDefaultValuesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface RowLevelPermissionTagRuleProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param matchAllValue A string that you want to use to filter by all the values in a
             *   column in the dataset and don’t want to list the values one by one. For example,
            ...
            /**
             * @param tagMultiValueDelimiter A string that you want to use to delimit the values
             *   when you pass the values at run time. For example, you can delimit the values with
             *   a comma.
             */
        ...
        internal constructor(
             ...
             * and don’t want to list the values one by one.
             *
             * For example, you can use an asterisk as your match all value.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-quicksight-dataset-rowlevelpermissiontagrule.html#cfn-quicksight-dataset-rowlevelpermissiontagrule-matchallvalue)
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-quicksight-dataset-rowlevelpermissiontagrule.html#cfn-quicksight-dataset-rowlevelpermissiontagrule-tagmultivaluedelimiter)
             */
            override fun tagMultiValueDelimiter(): String? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RowLevelPermissionTagRuleProperty
            ): software.amazon.awscdk.services.quicksight.CfnDataSet.RowLevelPermissionTagRuleProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface TransformOperationProperty {
        ...
        public interface Builder {
            /**
             * @param castColumnTypeOperation A transform operation that casts a column to a
             *   different type.
             */
            ...
            public fun castColumnTypeOperation(
                castColumnTypeOperation: CastColumnTypeOperationProperty.Builder.() -> Unit
            )

            /**
             * @param createColumnsOperation An operation that creates calculated columns. Columns
            ...
            public fun createColumnsOperation(
                createColumnsOperation: CreateColumnsOperationProperty.Builder.() -> Unit
            )
            ...
            /**
             * @param overrideDatasetParameterOperation A transform operation that overrides the
             *   dataset parameter values defined in another dataset.</p>.
             */
            public fun overrideDatasetParameterOperation(
                overrideDatasetParameterOperation: IResolvable
            )
            ...
            public fun overrideDatasetParameterOperation(
                overrideDatasetParameterOperation:
                    OverrideDatasetParameterOperationProperty.Builder.() -> Unit
            )

            /**
             * @param projectOperation An operation that projects columns. Operations that come
            ...
            public fun projectOperation(
                projectOperation: ProjectOperationProperty.Builder.() -> Unit
            )
            ...
            public fun renameColumnOperation(
                renameColumnOperation: RenameColumnOperationProperty.Builder.() -> Unit
            )

            /**
             * @param tagColumnOperation An operation that tags a column with additional
             *   information.
             */
            ...
            public fun tagColumnOperation(
                tagColumnOperation: TagColumnOperationProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
             ...
             *   different type.
             */
            override fun castColumnTypeOperation(
                castColumnTypeOperation: CastColumnTypeOperationProperty
            ) {
                cdkBuilder.castColumnTypeOperation(
                    castColumnTypeOperation.let(CastColumnTypeOperationProperty::unwrap)
                )
            }
            ...
            override fun castColumnTypeOperation(
                ...
                castColumnTypeOperation(CastColumnTypeOperationProperty(castColumnTypeOperation))
             ...
             *   created in one such operation form a lexical closure.
             */
            override fun createColumnsOperation(
                createColumnsOperation: CreateColumnsOperationProperty
            ) {
                cdkBuilder.createColumnsOperation(
                    createColumnsOperation.let(CreateColumnsOperationProperty::unwrap)
                )
            }
            ...
            override fun filterOperation(
                filterOperation: FilterOperationProperty.Builder.() -> Unit
             ...
             *   dataset parameter values defined in another dataset.</p>.
             */
            override fun overrideDatasetParameterOperation(
                overrideDatasetParameterOperation: IResolvable
            ) {
                cdkBuilder.overrideDatasetParameterOperation(
                    overrideDatasetParameterOperation.let(IResolvable::unwrap)
                )
            }
            ...
            override fun overrideDatasetParameterOperation(
                ...
                cdkBuilder.overrideDatasetParameterOperation(
                    overrideDatasetParameterOperation.let(
                        OverrideDatasetParameterOperationProperty::unwrap
                    )
                )
            }
            ...
            override fun overrideDatasetParameterOperation(
                ...
                overrideDatasetParameterOperation(
                    OverrideDatasetParameterOperationProperty(overrideDatasetParameterOperation)
                )
            ...
            /** @param renameColumnOperation An operation that renames a column. */
            override fun renameColumnOperation(
                renameColumnOperation: RenameColumnOperationProperty
            ) {
                cdkBuilder.renameColumnOperation(
                    renameColumnOperation.let(RenameColumnOperationProperty::unwrap)
                )
            }
            ...
            override fun tagColumnOperation(tagColumnOperation: TagColumnOperationProperty) {
                cdkBuilder.tagColumnOperation(
                    tagColumnOperation.let(TagColumnOperationProperty::unwrap)
                )
            }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TransformOperationProperty
            ): software.amazon.awscdk.services.quicksight.CfnDataSet.TransformOperationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface FilterOperationProperty {
        ...
        public interface Builder {
            /**
             * @param conditionExpression An expression that must evaluate to a Boolean value. Rows
             *   for which the expression evaluates to true are kept in the dataset.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: FilterOperationProperty
            ): software.amazon.awscdk.services.quicksight.CfnDataSet.FilterOperationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface JoinKeyPropertiesProperty {
        ...
        public interface Builder {
            /**
             * @param uniqueKey A value that indicates that a row in a table is uniquely identified
             *   by the columns in a join key. This is used by Amazon QuickSight to optimize query
             *   performance.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: JoinKeyPropertiesProperty
            ): software.amazon.awscdk.services.quicksight.CfnDataSet.JoinKeyPropertiesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DecimalDatasetParameterProperty {
        ...
        public interface Builder {
            /**
             * @param defaultValues A list of default values for a given decimal parameter. This
            ...
            public fun defaultValues(
                defaultValues: DecimalDatasetParameterDefaultValuesProperty.Builder.() -> Unit
            )
            ...
            /**
             * @param valueType The value type of the dataset parameter. Valid values are `single
        ...
        private class BuilderImpl : Builder {
            ...
            override fun defaultValues(
                ...
                cdkBuilder.defaultValues(
                    defaultValues.let(DecimalDatasetParameterDefaultValuesProperty::unwrap)
                )
            }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DecimalDatasetParameterProperty
            ): software.amazon.awscdk.services.quicksight.CfnDataSet.DecimalDatasetParameterProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface GeoSpatialColumnGroupProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: GeoSpatialColumnGroupProperty
            ): software.amazon.awscdk.services.quicksight.CfnDataSet.GeoSpatialColumnGroupProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface OverrideDatasetParameterOperationProperty {
        ...
        public interface Builder {
            ...
            public fun newDefaultValues(
                newDefaultValues: NewDefaultValuesProperty.Builder.() -> Unit
            )
            ...
            /**
             * @param parameterName The name of the parameter to be overridden with different
             *   values.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: OverrideDatasetParameterOperationProperty
            ): software.amazon.awscdk.services.quicksight.CfnDataSet.OverrideDatasetParameterOperationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface RowLevelPermissionDataSetProperty {
        ...
        public interface Builder {
            /**
             * @param arn The Amazon Resource Name (ARN) of the dataset that contains permissions
             *   for RLS.
             */
            public fun arn(arn: String)

            /**
             * @param formatVersion The user or group rules associated with the dataset that
             *   contains permissions for RLS. By default, `FormatVersion` is `VERSION_1` . When
             *   `FormatVersion` is `VERSION_1` , `UserName` and `GroupName` are required. When
             *   `FormatVersion` is `VERSION_2` , `UserARN` and `GroupARN` are required, and
             *   `Namespace` must not exist.
             */
            public fun formatVersion(formatVersion: String)

            /**
             * @param namespace The namespace associated with the dataset that contains permissions
             *   for RLS.
             */
            public fun namespace(namespace: String)

            /**
             * @param permissionPolicy The type of permissions to use when interpreting the
             *   permissions for RLS. `DENY_ACCESS` is included for backward compatibility only.
             */
            public fun permissionPolicy(permissionPolicy: String)

            /**
             * @param status The status of the row-level security permission dataset. If enabled,
        ...
        internal constructor(
             ...
             *
             * By default, `FormatVersion` is `VERSION_1` . When `FormatVersion` is `VERSION_1` ,
             * `UserName` and `GroupName` are required. When `FormatVersion` is `VERSION_2` ,
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RowLevelPermissionDataSetProperty
            ): software.amazon.awscdk.services.quicksight.CfnDataSet.RowLevelPermissionDataSetProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface RelationalTableProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param schema The schema name. This name applies to certain relational database
             *   engines.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RelationalTableProperty
            ): software.amazon.awscdk.services.quicksight.CfnDataSet.RelationalTableProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface LogicalTableProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param dataTransforms Transform operations that act on this logical table. For this
    ...
    public interface UploadSettingsProperty {
        ...
        public interface Builder {
            /**
             * @param containsHeader Whether the file has a header row, or the files each have a
             *   header row.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: UploadSettingsProperty
            ): software.amazon.awscdk.services.quicksight.CfnDataSet.UploadSettingsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DatasetParameterProperty {
        ...
        public interface Builder {
            ...
            public fun dateTimeDatasetParameter(
                dateTimeDatasetParameter: DateTimeDatasetParameterProperty.Builder.() -> Unit
            )
            ...
            public fun decimalDatasetParameter(
                decimalDatasetParameter: DecimalDatasetParameterProperty.Builder.() -> Unit
            )
            ...
            public fun integerDatasetParameter(
                integerDatasetParameter: IntegerDatasetParameterProperty.Builder.() -> Unit
            )
            ...
            public fun stringDatasetParameter(
                stringDatasetParameter: StringDatasetParameterProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun dateTimeDatasetParameter(dateTimeDatasetParameter: IResolvable) {
                cdkBuilder.dateTimeDatasetParameter(
                    dateTimeDatasetParameter.let(IResolvable::unwrap)
                )
            }
             ...
             * @param dateTimeDatasetParameter A date time parameter that is created in the dataset.
             */
            override fun dateTimeDatasetParameter(
                dateTimeDatasetParameter: DateTimeDatasetParameterProperty
            ) {
                cdkBuilder.dateTimeDatasetParameter(
                    dateTimeDatasetParameter.let(DateTimeDatasetParameterProperty::unwrap)
                )
            }
             ...
             * @param decimalDatasetParameter A decimal parameter that is created in the dataset.
             */
            override fun decimalDatasetParameter(
                decimalDatasetParameter: DecimalDatasetParameterProperty
            ) {
                cdkBuilder.decimalDatasetParameter(
                    decimalDatasetParameter.let(DecimalDatasetParameterProperty::unwrap)
                )
            }
            ...
            override fun decimalDatasetParameter(
                ...
                decimalDatasetParameter(DecimalDatasetParameterProperty(decimalDatasetParameter))
             ...
             * @param integerDatasetParameter An integer parameter that is created in the dataset.
             */
            override fun integerDatasetParameter(
                integerDatasetParameter: IntegerDatasetParameterProperty
            ) {
                cdkBuilder.integerDatasetParameter(
                    integerDatasetParameter.let(IntegerDatasetParameterProperty::unwrap)
                )
            }
            ...
            override fun integerDatasetParameter(
                ...
                integerDatasetParameter(IntegerDatasetParameterProperty(integerDatasetParameter))
            ...
            /** @param stringDatasetParameter A string parameter that is created in the dataset. */
            override fun stringDatasetParameter(
                stringDatasetParameter: StringDatasetParameterProperty
            ) {
                cdkBuilder.stringDatasetParameter(
                    stringDatasetParameter.let(StringDatasetParameterProperty::unwrap)
                )
            }
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-quicksight-dataset-datasetparameter.html#cfn-quicksight-dataset-datasetparameter-datetimedatasetparameter)
             */
            override fun dateTimeDatasetParameter(): Any? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DatasetParameterProperty
            ): software.amazon.awscdk.services.quicksight.CfnDataSet.DatasetParameterProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface NewDefaultValuesProperty {
         ...
         */
        public fun dateTimeStaticValues(): List<String> =
         ...
         */
        public fun stringStaticValues(): List<String> =
            unwrap(this).getStringStaticValues() ?: emptyList()
        ...
        public interface Builder {
             ...
             *   parameter. The valid format for this property is `yyyy-MM-dd’T’HH:mm:ss’Z’` .
             */
            ...
            /**
             * @param decimalStaticValues A list of static default values for a given decimal
             *   parameter.
             */
            ...
            /**
             * @param integerStaticValues A list of static default values for a given integer
             *   parameter.
             */
            ...
            /**
             * @param stringStaticValues A list of static default values for a given string
             *   parameter.
             */
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-quicksight-dataset-newdefaultvalues.html#cfn-quicksight-dataset-newdefaultvalues-datetimestaticvalues)
             */
            override fun dateTimeStaticValues(): List<String> =
                unwrap(this).getDateTimeStaticValues() ?: emptyList()
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-quicksight-dataset-newdefaultvalues.html#cfn-quicksight-dataset-newdefaultvalues-stringstaticvalues)
             */
            override fun stringStaticValues(): List<String> =
                unwrap(this).getStringStaticValues() ?: emptyList()
        }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: NewDefaultValuesProperty
            ): software.amazon.awscdk.services.quicksight.CfnDataSet.NewDefaultValuesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface RowLevelPermissionTagConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param status The status of row-level security tags. If enabled, the status is
            ...
            /**
             * @param tagRules A set of rules associated with row-level security, such as the tag
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RowLevelPermissionTagConfigurationProperty
            ): software.amazon.awscdk.services.quicksight.CfnDataSet.RowLevelPermissionTagConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ColumnLevelPermissionRuleProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param principals An array of Amazon Resource Names (ARNs) for Amazon QuickSight
             *   users or groups.
             */
        ...
        private class BuilderImpl : Builder {
             ...
             *   users or groups.
             */
            override fun principals(vararg principals: String): Unit =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ColumnLevelPermissionRuleProperty
            ): software.amazon.awscdk.services.quicksight.CfnDataSet.ColumnLevelPermissionRuleProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface IncrementalRefreshProperty {
        ...
        public interface Builder {
            /**
             * @param lookbackWindow The lookback window setup for an incremental refresh
             *   configuration.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("d076a231dab6dc3cf3a9fb65a3c9a1529398d973f5242a3f7841ec7d88b58222")
            override fun lookbackWindow(
                lookbackWindow: LookbackWindowProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: IncrementalRefreshProperty
            ): software.amazon.awscdk.services.quicksight.CfnDataSet.IncrementalRefreshProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CastColumnTypeOperationProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param format When casting a column from string to datetime type, you can supply a
             *   string in a format supported by Amazon QuickSight to denote the source data format.
             */
            public fun format(format: String)
            ...
            /**
             * @param subType The sub data type of the new column. Sub types are only available for
             *   decimal columns that are part of a SPICE dataset.
             */
            public fun subType(subType: String)
        }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CastColumnTypeOperationProperty
            ): software.amazon.awscdk.services.quicksight.CfnDataSet.CastColumnTypeOperationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DataSetRefreshPropertiesProperty {
        ...
        public interface Builder {
            ...
            public fun refreshConfiguration(
                refreshConfiguration: RefreshConfigurationProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun refreshConfiguration(refreshConfiguration: RefreshConfigurationProperty) {
                cdkBuilder.refreshConfiguration(
                    refreshConfiguration.let(RefreshConfigurationProperty::unwrap)
                )
            }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DataSetRefreshPropertiesProperty
            ): software.amazon.awscdk.services.quicksight.CfnDataSet.DataSetRefreshPropertiesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface IntegerDatasetParameterProperty {
        ...
        public interface Builder {
            /**
             * @param defaultValues A list of default values for a given integer parameter. This
             *   structure only accepts static values.
             */
            public fun defaultValues(defaultValues: IResolvable)
            ...
            public fun defaultValues(
                defaultValues: IntegerDatasetParameterDefaultValuesProperty.Builder.() -> Unit
            )
        ...
        private class BuilderImpl : Builder {
            ...
            override fun defaultValues(
                ...
                cdkBuilder.defaultValues(
                    defaultValues.let(IntegerDatasetParameterDefaultValuesProperty::unwrap)
                )
            }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: IntegerDatasetParameterProperty
            ): software.amazon.awscdk.services.quicksight.CfnDataSet.IntegerDatasetParameterProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DataSetUsageConfigurationProperty {
        /**
         * An option that controls whether a child dataset of a direct query can use this dataset as
         * a source.
         *
        ...
        public interface Builder {
            /**
             * @param disableUseAsDirectQuerySource An option that controls whether a child dataset
             *   of a direct query can use this dataset as a source.
             */
            ...
            /**
             * @param disableUseAsImportedSource An option that controls whether a child dataset
             *   that's stored in QuickSight can use this dataset as a source.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            override fun disableUseAsDirectQuerySource(disableUseAsDirectQuerySource: IResolvable) {
                cdkBuilder.disableUseAsDirectQuerySource(
                    disableUseAsDirectQuerySource.let(IResolvable::unwrap)
                )
            }
            ...
            override fun disableUseAsImportedSource(disableUseAsImportedSource: IResolvable) {
                cdkBuilder.disableUseAsImportedSource(
                    disableUseAsImportedSource.let(IResolvable::unwrap)
                )
            }
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-quicksight-dataset-datasetusageconfiguration.html#cfn-quicksight-dataset-datasetusageconfiguration-disableuseasimportedsource)
             */
            override fun disableUseAsImportedSource(): Any? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DataSetUsageConfigurationProperty
            ): software.amazon.awscdk.services.quicksight.CfnDataSet.DataSetUsageConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface StringDatasetParameterDefaultValuesProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: StringDatasetParameterDefaultValuesProperty
            ): software.amazon.awscdk.services.quicksight.CfnDataSet.StringDatasetParameterDefaultValuesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface IngestionWaitPolicyProperty {
         ...
         *
         * Default timeout is 36 hours. Applicable only when `DataSetImportMode` mode is set to
         * SPICE and `WaitForSpiceIngestion` is set to true.
         *
         * Default: - 36
         *
        ...
        public interface Builder {
             ...
             *   complete. Default timeout is 36 hours. Applicable only when `DataSetImportMode`
             *   mode is set to SPICE and `WaitForSpiceIngestion` is set to true.
             */
            public fun ingestionWaitTimeInHours(ingestionWaitTimeInHours: Number)

            /**
             * @param waitForSpiceIngestion Wait for SPICE ingestion to finish to mark dataset
             *   creation or update as successful. Default (true). Applicable only when
             *   `DataSetImportMode` mode is set to SPICE.
             */
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-quicksight-dataset-ingestionwaitpolicy.html#cfn-quicksight-dataset-ingestionwaitpolicy-ingestionwaittimeinhours)
             */
            override fun ingestionWaitTimeInHours(): Number? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: IngestionWaitPolicyProperty
            ): software.amazon.awscdk.services.quicksight.CfnDataSet.IngestionWaitPolicyProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface PhysicalTableProperty {
        ...
        public interface Builder {
            /**
             * @param customSql A physical table type built from the results of the custom SQL
             *   query.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("be2a184082d73e5397cfd6d7000e53e720afba2eab436dc45d9ec51f638b4d04")
            override fun relationalTable(
                relationalTable: RelationalTableProperty.Builder.() -> Unit
    ...
    public interface TagColumnOperationProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TagColumnOperationProperty
            ): software.amazon.awscdk.services.quicksight.CfnDataSet.TagColumnOperationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface RenameColumnOperationProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RenameColumnOperationProperty
            ): software.amazon.awscdk.services.quicksight.CfnDataSet.RenameColumnOperationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface JoinInstructionProperty {
        ...
        public interface Builder {
            ...
            public fun leftJoinKeyProperties(
                leftJoinKeyProperties: JoinKeyPropertiesProperty.Builder.() -> Unit
            )
            ...
            public fun rightJoinKeyProperties(
                rightJoinKeyProperties: JoinKeyPropertiesProperty.Builder.() -> Unit
            )
        ...
        private class BuilderImpl : Builder {
            ...
            override fun leftJoinKeyProperties(leftJoinKeyProperties: JoinKeyPropertiesProperty) {
                cdkBuilder.leftJoinKeyProperties(
                    leftJoinKeyProperties.let(JoinKeyPropertiesProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("4f6bf66b353192d5d5f0d33473549da91857329984caf2c9af6d5b962e468cf3")
            override fun leftJoinKeyProperties(
                leftJoinKeyProperties: JoinKeyPropertiesProperty.Builder.() -> Unit
            ...
            override fun rightJoinKeyProperties(rightJoinKeyProperties: JoinKeyPropertiesProperty) {
                cdkBuilder.rightJoinKeyProperties(
                    rightJoinKeyProperties.let(JoinKeyPropertiesProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("4672d23539b90c146309955541614b7a84ca676bdc60189367ca70eb534eca8e")
            override fun rightJoinKeyProperties(
                rightJoinKeyProperties: JoinKeyPropertiesProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: JoinInstructionProperty
            ): software.amazon.awscdk.services.quicksight.CfnDataSet.JoinInstructionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ProjectOperationProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ProjectOperationProperty
            ): software.amazon.awscdk.services.quicksight.CfnDataSet.ProjectOperationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DecimalDatasetParameterDefaultValuesProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DecimalDatasetParameterDefaultValuesProperty
            ): software.amazon.awscdk.services.quicksight.CfnDataSet.DecimalDatasetParameterDefaultValuesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CreateColumnsOperationProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CreateColumnsOperationProperty
            ): software.amazon.awscdk.services.quicksight.CfnDataSet.CreateColumnsOperationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface LookbackWindowProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param sizeUnit The size unit that is used for the lookback window column. Valid
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: LookbackWindowProperty
            ): software.amazon.awscdk.services.quicksight.CfnDataSet.LookbackWindowProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface StringDatasetParameterProperty {
        ...
        public interface Builder {
            /**
             * @param defaultValues A list of default values for a given string dataset parameter
             *   type. This structure only accepts static values.
             */
            public fun defaultValues(defaultValues: IResolvable)
            ...
            public fun defaultValues(
                defaultValues: StringDatasetParameterDefaultValuesProperty.Builder.() -> Unit
            )
        ...
        private class BuilderImpl : Builder {
            ...
            override fun defaultValues(defaultValues: StringDatasetParameterDefaultValuesProperty) {
                cdkBuilder.defaultValues(
                    defaultValues.let(StringDatasetParameterDefaultValuesProperty::unwrap)
                )
            }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: StringDatasetParameterProperty
            ): software.amazon.awscdk.services.quicksight.CfnDataSet.StringDatasetParameterProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface LogicalTableSourceProperty {
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("e7ea6b5366702ab36457018199798fdc810eae14d8d5cdaf970720af73cb2df5")
            override fun joinInstruction(
                joinInstruction: JoinInstructionProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: LogicalTableSourceProperty
            ): software.amazon.awscdk.services.quicksight.CfnDataSet.LogicalTableSourceProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DateTimeDatasetParameterProperty {
        ...
        public interface Builder {
            /**
             * @param defaultValues A list of default values for a given date time parameter. This
             *   structure only accepts static values.
             */
            public fun defaultValues(defaultValues: IResolvable)
            ...
            public fun defaultValues(
                defaultValues: DateTimeDatasetParameterDefaultValuesProperty.Builder.() -> Unit
            )
        ...
        private class BuilderImpl : Builder {
            ...
            override fun defaultValues(
                ...
                cdkBuilder.defaultValues(
                    defaultValues.let(DateTimeDatasetParameterDefaultValuesProperty::unwrap)
                )
            }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DateTimeDatasetParameterProperty
            ): software.amazon.awscdk.services.quicksight.CfnDataSet.DateTimeDatasetParameterProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface IntegerDatasetParameterDefaultValuesProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: IntegerDatasetParameterDefaultValuesProperty
            ): software.amazon.awscdk.services.quicksight.CfnDataSet.IntegerDatasetParameterDefaultValuesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface RefreshConfigurationProperty {
        ...
        public interface Builder {
            ...
            public fun incrementalRefresh(
                incrementalRefresh: IncrementalRefreshProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun incrementalRefresh(incrementalRefresh: IncrementalRefreshProperty) {
                cdkBuilder.incrementalRefresh(
                    incrementalRefresh.let(IncrementalRefreshProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("4cc1ee90b75ae38ef3dc53f2ef608e46b7e5bb8603b5a23b41319b65fd5c3eed")
            override fun incrementalRefresh(
                incrementalRefresh: IncrementalRefreshProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RefreshConfigurationProperty
            ): software.amazon.awscdk.services.quicksight.CfnDataSet.RefreshConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
