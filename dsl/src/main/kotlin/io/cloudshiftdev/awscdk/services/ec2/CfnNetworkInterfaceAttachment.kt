...
internal constructor(
    ...
    public open fun enaSrdSpecification(
        `value`: EnaSrdSpecificationProperty.Builder.() -> Unit
    ): Unit = enaSrdSpecification(EnaSrdSpecificationProperty(`value`))
    ...
    public interface Builder {
         ...
         *
         * @param enaSrdSpecification Configures ENA Express for the network interface that this
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.ec2.CfnNetworkInterfaceAttachment.Builder.create(
                scope,
                id
            )
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnNetworkInterfaceAttachment
