...
public abstract class RouteSpec internal constructor(
  ...
  public companion object {
    public open fun grpc(options: GrpcRouteSpecOptions): RouteSpec =
    ...
    public open fun grpc(options: GrpcRouteSpecOptions.Builder.() -> Unit): RouteSpec =
        grpc(GrpcRouteSpecOptions(options))

    public open fun http(options: HttpRouteSpecOptions): RouteSpec =
    ...
    public open fun http(options: HttpRouteSpecOptions.Builder.() -> Unit): RouteSpec =
        http(HttpRouteSpecOptions(options))

    public open fun http2(options: HttpRouteSpecOptions): RouteSpec =
    ...
    public open fun http2(options: HttpRouteSpecOptions.Builder.() -> Unit): RouteSpec =
        http2(HttpRouteSpecOptions(options))

    public open fun tcp(options: TcpRouteSpecOptions): RouteSpec =
    ...
    public open fun tcp(options: TcpRouteSpecOptions.Builder.() -> Unit): RouteSpec =
