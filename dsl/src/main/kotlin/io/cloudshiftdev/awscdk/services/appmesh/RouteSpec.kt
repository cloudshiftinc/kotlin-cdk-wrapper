...
internal constructor(
    ...
    public companion object {
        public fun grpc(options: GrpcRouteSpecOptions): RouteSpec =
            software.amazon.awscdk.services.appmesh.RouteSpec.grpc(
                    options.let(GrpcRouteSpecOptions::unwrap)
                )
                .let(RouteSpec::wrap)
        ...
        public fun http(options: HttpRouteSpecOptions): RouteSpec =
            software.amazon.awscdk.services.appmesh.RouteSpec.http(
                    options.let(HttpRouteSpecOptions::unwrap)
                )
                .let(RouteSpec::wrap)
        ...
        public fun http2(options: HttpRouteSpecOptions): RouteSpec =
            software.amazon.awscdk.services.appmesh.RouteSpec.http2(
                    options.let(HttpRouteSpecOptions::unwrap)
                )
                .let(RouteSpec::wrap)
        ...
        public fun tcp(options: TcpRouteSpecOptions): RouteSpec =
            software.amazon.awscdk.services.appmesh.RouteSpec.tcp(
                    options.let(TcpRouteSpecOptions::unwrap)
                )
                .let(RouteSpec::wrap)
