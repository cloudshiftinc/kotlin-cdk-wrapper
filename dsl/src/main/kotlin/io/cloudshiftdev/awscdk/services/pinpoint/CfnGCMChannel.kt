...
internal constructor(
    ...
    public interface Builder {
        /**
         * The Web API key, also called the *server key* , that you received from Google to
         ...
         *
         * @param apiKey The Web API key, also called the *server key* , that you received from
         ...
         *
         * @param serviceJson The contents of the JSON file provided by Google during registration
         *   in order to generate an access token for authentication.
         */
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.pinpoint.CfnGCMChannel =
            cdkBuilder.build()
    }
