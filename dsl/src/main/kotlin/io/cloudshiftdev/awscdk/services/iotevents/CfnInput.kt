...
internal constructor(
    ...
    private class BuilderImpl(
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("e29149db2e0b6786b9737a01c465fc73f7fd99ee7ba077b14a1716b68649e11f")
        override fun inputDefinition(
            inputDefinition: InputDefinitionProperty.Builder.() -> Unit
        ): Unit = inputDefinition(InputDefinitionProperty(inputDefinition))
    ...
    public interface AttributeProperty {
         ...
         *
         * Use this to specify an attribute from the JSON payload that is made available by the
        ...
        public interface Builder {
            /**
             * @param jsonPath An expression that specifies an attribute-value pair in a JSON
             *   structure. Use this to specify an attribute from the JSON payload that is made
             *   available by the input. Inputs are derived from messages sent to AWS IoT Events (
    ...
    public interface InputDefinitionProperty {
         ...
         * `BatchPutMessage` . Each such message contains a JSON payload, and those attributes (and
         * their paired values) specified here are available for use in the `condition` expressions
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: InputDefinitionProperty
            ): software.amazon.awscdk.services.iotevents.CfnInput.InputDefinitionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
