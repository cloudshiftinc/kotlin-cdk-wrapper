...
public enum class InventoryObjectVersion(
  ...
  public companion object {
    internal fun wrap(cdkObject: software.amazon.awscdk.services.s3.InventoryObjectVersion):
        InventoryObjectVersion = when (cdkObject) {
      software.amazon.awscdk.services.s3.InventoryObjectVersion.ALL -> InventoryObjectVersion.ALL
      software.amazon.awscdk.services.s3.InventoryObjectVersion.CURRENT ->
          InventoryObjectVersion.CURRENT
    }

    internal fun unwrap(wrapped: InventoryObjectVersion):
