...
internal constructor(
    ...
    public interface Builder {
         ...
         * The ARN of the control.
         *
         * Only *Strongly recommended* and *Elective* controls are permitted, with the exception of
         * the *Region deny* control. For information on how to find the `controlIdentifier` , see
    ...
    public interface EnabledControlParameterProperty {
         ...
         *
         * It can be of type `array` , `string` , `number` , `object` , or `boolean` .
        ...
        public interface Builder {
            ...
            /**
             * @param value The value of a key/value pair. It can be of type `array` , `string` ,
        ...
        private class BuilderImpl : Builder {
            private val cdkBuilder:
                ...
                software.amazon.awscdk.services.controltower.CfnEnabledControl
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: EnabledControlParameterProperty
            ): software.amazon.awscdk.services.controltower.CfnEnabledControl.EnabledControlParameterProperty =
