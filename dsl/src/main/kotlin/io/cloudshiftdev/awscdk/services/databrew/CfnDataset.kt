...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param input Information on how DataBrew can find the dataset, in either the AWS Glue
         ...
         *
         * @param pathOptions A set of options that defines how DataBrew interprets an Amazon S3
         *   path of the dataset.
         */
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnDataset
        ): software.amazon.awscdk.services.databrew.CfnDataset = wrapped.cdkObject
    }
    ...
    public interface DataCatalogInputDefinitionProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param tableName The name of a database table in the Data Catalog. This table
             *   corresponds to a DataBrew dataset.
             */
            public fun tableName(tableName: String)

            /**
             * @param tempDirectory An Amazon location that AWS Glue Data Catalog can use as a
             *   temporary directory.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DataCatalogInputDefinitionProperty
            ): software.amazon.awscdk.services.databrew.CfnDataset.DataCatalogInputDefinitionProperty =
    ...
    public interface DatabaseInputDefinitionProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param queryString Custom SQL to run against the provided AWS Glue connection. This
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DatabaseInputDefinitionProperty
            ): software.amazon.awscdk.services.databrew.CfnDataset.DatabaseInputDefinitionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface InputProperty {
        ...
        public interface Builder {
            ...
            public fun dataCatalogInputDefinition(
                dataCatalogInputDefinition: DataCatalogInputDefinitionProperty.Builder.() -> Unit
            )

            /**
             * @param databaseInputDefinition Connection information for dataset input files stored
             *   in a database.
             */
             ...
             *   in a database.
             */
            public fun databaseInputDefinition(
            ...
            public fun databaseInputDefinition(
                databaseInputDefinition: DatabaseInputDefinitionProperty.Builder.() -> Unit
            )

            /**
             * @param metadata Contains additional resource information needed for specific
             *   datasets.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            override fun dataCatalogInputDefinition(dataCatalogInputDefinition: IResolvable) {
                cdkBuilder.dataCatalogInputDefinition(
                    dataCatalogInputDefinition.let(IResolvable::unwrap)
                )
            }
             ...
             * @param dataCatalogInputDefinition The AWS Glue Data Catalog parameters for the data.
             */
            override fun dataCatalogInputDefinition(
                dataCatalogInputDefinition: DataCatalogInputDefinitionProperty
            ) {
                cdkBuilder.dataCatalogInputDefinition(
                    dataCatalogInputDefinition.let(DataCatalogInputDefinitionProperty::unwrap)
                )
            }
            ...
            override fun dataCatalogInputDefinition(
                ...
                dataCatalogInputDefinition(
                    DataCatalogInputDefinitionProperty(dataCatalogInputDefinition)
                )
             ...
             *   in a database.
             */
            override fun databaseInputDefinition(
                databaseInputDefinition: DatabaseInputDefinitionProperty
            ) {
                cdkBuilder.databaseInputDefinition(
                    databaseInputDefinition.let(DatabaseInputDefinitionProperty::unwrap)
                )
            }
            ...
            override fun databaseInputDefinition(
                ...
                databaseInputDefinition(DatabaseInputDefinitionProperty(databaseInputDefinition))
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("941083a48d82f5dc84d462af94aa87336a198a841d72148455b37296db306422")
            override fun s3InputDefinition(
                s3InputDefinition: S3LocationProperty.Builder.() -> Unit
            ): Unit = s3InputDefinition(S3LocationProperty(s3InputDefinition))
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-databrew-dataset-input.html#cfn-databrew-dataset-input-datacataloginputdefinition)
             */
            override fun dataCatalogInputDefinition(): Any? =
    ...
    public interface DatetimeOptionsProperty {
         ...
         * S3 path.
         *
         * Should use only supported datetime specifiers and separation characters, all litera a-z
         * or A-Z character should be escaped with single quotes. E.g. "MM.dd.yyyy-'at'-HH:mm".
         *
        ...
        public interface Builder {
            /**
             * @param format Required option, that defines the datetime format used for a date
             *   parameter in the Amazon S3 path. Should use only supported datetime specifiers and
             *   separation characters, all litera a-z or A-Z character should be escaped with
            ...
            /**
             * @param timezoneOffset Optional value for a timezone offset of the datetime parameter
        ...
        internal constructor(
             ...
             * Amazon S3 path.
             *
             * Should use only supported datetime specifiers and separation characters, all litera
             * a-z or A-Z character should be escaped with single quotes. E.g.
             * "MM.dd.yyyy-'at'-HH:mm".
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-databrew-dataset-datetimeoptions.html#cfn-databrew-dataset-datetimeoptions-format)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DatetimeOptionsProperty
            ): software.amazon.awscdk.services.databrew.CfnDataset.DatetimeOptionsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ExcelOptionsProperty {
        ...
        public interface Builder {
            /**
             * @param headerRow A variable that specifies whether the first row in the file is
             *   parsed as the header. If this value is false, column names are auto-generated.
             */
            ...
            /**
             * @param sheetIndexes One or more sheet numbers in the Excel file that will be included
             *   in the dataset.
             */
            ...
            /**
             * @param sheetNames One or more named sheets in the Excel file that will be included in
             *   the dataset.
             */
        ...
        private class BuilderImpl : Builder {
             ...
             *   the dataset.
             */
            override fun sheetNames(vararg sheetNames: String): Unit =
    ...
    public interface DatasetParameterProperty {
        ...
        public interface Builder {
            /**
             * @param createColumn Optional boolean value that defines whether the captured value of
             *   this parameter should be loaded as an additional column in the dataset.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("65a6693a7649a5bea13eff57488531548e480e904d0e34b14bccc2e10bfe22a1")
            override fun datetimeOptions(
                datetimeOptions: DatetimeOptionsProperty.Builder.() -> Unit
    ...
    public interface PathOptionsProperty {
        ...
        /**
         * A structure that maps names of parameters used in the Amazon S3 path of a dataset to
         * their definitions.
         *
        ...
        public interface Builder {
            /**
             * @param filesLimit If provided, this structure imposes a limit on a number of files
            ...
            public fun lastModifiedDateCondition(
                lastModifiedDateCondition: FilterExpressionProperty.Builder.() -> Unit
            )

            /**
             * @param parameters A structure that maps names of parameters used in the Amazon S3
        ...
        private class BuilderImpl : Builder {
            ...
            override fun lastModifiedDateCondition(lastModifiedDateCondition: IResolvable) {
                cdkBuilder.lastModifiedDateCondition(
                    lastModifiedDateCondition.let(IResolvable::unwrap)
                )
            }
             ...
             *   matching Amazon S3 objects based on their LastModifiedDate attribute in Amazon S3 .
             */
            override fun lastModifiedDateCondition(
                lastModifiedDateCondition: FilterExpressionProperty
            ) {
                cdkBuilder.lastModifiedDateCondition(
                    lastModifiedDateCondition.let(FilterExpressionProperty::unwrap)
                )
            }
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-databrew-dataset-pathoptions.html#cfn-databrew-dataset-pathoptions-lastmodifieddatecondition)
             */
            override fun lastModifiedDateCondition(): Any? =
    ...
    public interface FilesLimitProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param order A criteria to use for Amazon S3 files sorting before their selection. By
            ...
            /**
             * @param orderedBy A criteria to use for Amazon S3 files sorting before their
             *   selection. By default uses LAST_MODIFIED_DATE as a sorting criteria. Currently it's
        ...
        internal constructor(
             ...
             * A criteria to use for Amazon S3 files sorting before their selection.
             *
             * By default uses LAST_MODIFIED_DATE as a sorting criteria. Currently it's the only
             * allowed value.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-databrew-dataset-fileslimit.html#cfn-databrew-dataset-fileslimit-orderedby)
             */
    ...
    public interface PathParameterProperty {
        ...
        public interface Builder {
            ...
            public fun datasetParameter(
                datasetParameter: DatasetParameterProperty.Builder.() -> Unit
            )
    ...
    public interface FilterExpressionProperty {
         ...
         * possibly grouped and combined with other conditions.
         *
        ...
        public interface Builder {
            /**
             * @param expression The expression which includes condition names followed by
             *   substitution variables, possibly grouped and combined with other conditions. For
             *   example, "(starts_with :prefix1 or starts_with :prefix2) and (ends_with :suffix1 or
             *   ends_with :suffix2)". Substitution variables should start with ':' symbol.
             */
            public fun expression(expression: String)

            /**
             * @param valuesMap The map of substitution variable names to their values used in this
             *   filter expression.
             */
        ...
        internal constructor(
             ...
             * possibly grouped and combined with other conditions.
             *
             * For example, "(starts_with :prefix1 or starts_with :prefix2) and (ends_with :suffix1
             * or ends_with :suffix2)". Substitution variables should start with ':' symbol.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-databrew-dataset-filterexpression.html#cfn-databrew-dataset-filterexpression-expression)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: FilterExpressionProperty
            ): software.amazon.awscdk.services.databrew.CfnDataset.FilterExpressionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CsvOptionsProperty {
        ...
        public interface Builder {
            /**
             * @param delimiter A single character that specifies the delimiter being used in the
             *   CSV file.
             */
