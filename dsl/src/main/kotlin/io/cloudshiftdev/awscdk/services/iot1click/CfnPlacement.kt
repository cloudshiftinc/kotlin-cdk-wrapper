...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param associatedDevices The devices to associate with the placement, as defined by a
         *   mapping of zero or more key-value pairs wherein the key is a template name and the
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.iot1click.CfnPlacement =
            cdkBuilder.build()
    }
