...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.imagebuilder.CfnComponent,
    ...
    public open fun supportedOsVersions(): List<String> =
        unwrap(this).getSupportedOsVersions() ?: emptyList()
