...
public interface ConfigureNatOptions {
    ...
    private class BuilderImpl : Builder {
        ...
        /** @param natSubnets The public subnets where the NAT providers need to be placed. */
        override fun natSubnets(vararg natSubnets: PublicSubnet): Unit =
            natSubnets(natSubnets.toList())
        ...
        public fun build(): software.amazon.awscdk.services.ec2.ConfigureNatOptions =
            cdkBuilder.build()
    }
