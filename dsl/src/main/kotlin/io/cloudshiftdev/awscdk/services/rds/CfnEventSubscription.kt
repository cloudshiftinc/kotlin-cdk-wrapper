...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.rds.CfnEventSubscription,
    ...
    public interface Builder {
         ...
         * Specifies whether to activate the subscription.
         *
         * If the event notification subscription isn't activated, the subscription is created but
         * not active.
         *
         * Default: - true
         *
         ...
         *
         * @param eventCategories A list of event categories for a particular source type (
         ...
         *   supplied.
         * * If the source type is a DB security group, a `DBSecurityGroupName` value must be
         *   supplied.
         * * If the source type is a DB snapshot, a `DBSnapshotIdentifier` value must be supplied.
         * * If the source type is a DB cluster snapshot, a `DBClusterSnapshotIdentifier` value must
         *   be supplied.
         *
