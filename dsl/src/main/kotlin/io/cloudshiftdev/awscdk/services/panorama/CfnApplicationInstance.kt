...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.panorama.CfnApplicationInstance,
    ...
    public open fun attrApplicationInstanceId(): String =
        unwrap(this).getAttrApplicationInstanceId()
    ...
    public open fun manifestOverridesPayload(`value`: ManifestOverridesPayloadProperty) {
        unwrap(this)
            .setManifestOverridesPayload(`value`.let(ManifestOverridesPayloadProperty::unwrap))
    }

    /** Setting overrides for the application manifest. */
    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("a5766abb9a0020ee6ac0260264091b352d741f2a8af4117d081a7a284267cdf2")
    public open fun manifestOverridesPayload(
        `value`: ManifestOverridesPayloadProperty.Builder.() -> Unit
    ...
    public interface Builder {
         ...
         *
         * @param applicationInstanceIdToReplace The ID of an application instance to replace with
         *   the new instance.
         */
        ...
        public fun manifestOverridesPayload(
            manifestOverridesPayload: ManifestOverridesPayloadProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.panorama.CfnApplicationInstance.Builder.create(
                scope,
                id
            )
         ...
         * @param manifestOverridesPayload Setting overrides for the application manifest.
         */
        override fun manifestOverridesPayload(
            manifestOverridesPayload: ManifestOverridesPayloadProperty
        ) {
            cdkBuilder.manifestOverridesPayload(
                manifestOverridesPayload.let(ManifestOverridesPayloadProperty::unwrap)
            )
        }
        ...
        override fun manifestOverridesPayload(
            ...
            manifestOverridesPayload(ManifestOverridesPayloadProperty(manifestOverridesPayload))
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("f9948972873d9876a1879bd640f247de1c5d81f10a5efe27effe1ddbf495bb9f")
        override fun manifestPayload(
            manifestPayload: ManifestPayloadProperty.Builder.() -> Unit
        ): Unit = manifestPayload(ManifestPayloadProperty(manifestPayload))
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnApplicationInstance
    ...
    public interface ManifestOverridesPayloadProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ManifestOverridesPayloadProperty
            ): software.amazon.awscdk.services.panorama.CfnApplicationInstance.ManifestOverridesPayloadProperty =
    ...
    public interface ManifestPayloadProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ManifestPayloadProperty
            ): software.amazon.awscdk.services.panorama.CfnApplicationInstance.ManifestPayloadProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
