...
internal constructor(
    ...
    public open fun addAsgCapacityProvider(
        provider: AsgCapacityProvider,
        options: AddAutoScalingGroupCapacityOptions.Builder.() -> Unit
    ): Unit = addAsgCapacityProvider(provider, AddAutoScalingGroupCapacityOptions(options))
    ...
    public open fun addCapacity(id: String, options: AddCapacityOptions): AutoScalingGroup =
        unwrap(this)
            .addCapacity(id, options.let(AddCapacityOptions::unwrap))
    ...
    public open fun addCapacity(
        id: String,
        options: AddCapacityOptions.Builder.() -> Unit
     ...
     */
    public open fun addDefaultCapacityProviderStrategy(
        defaultCapacityProviderStrategy: List<CapacityProviderStrategy>
    ) {
        unwrap(this)
            .addDefaultCapacityProviderStrategy(
                defaultCapacityProviderStrategy.map(CapacityProviderStrategy::unwrap)
            )
    }
     ...
     */
    public open fun addDefaultCapacityProviderStrategy(
        vararg defaultCapacityProviderStrategy: CapacityProviderStrategy
    ): Unit = addDefaultCapacityProviderStrategy(defaultCapacityProviderStrategy.toList())

    /**
     * Add an AWS Cloud Map DNS namespace for this cluster.
     *
     * NOTE: HttpNamespaces are supported only for use cases involving Service Connect. For use
     * cases involving both Service- Discovery and Service Connect, customers should manage the
     * HttpNamespace outside of the Cluster.addDefaultCloudMapNamespace method.
     *
     * @param options
     */
    public open fun addDefaultCloudMapNamespace(options: CloudMapNamespaceOptions): INamespace =
        unwrap(this)
            .addDefaultCloudMapNamespace(options.let(CloudMapNamespaceOptions::unwrap))
            .let(INamespace::wrap)
    ...
    public open fun addDefaultCloudMapNamespace(
        options: CloudMapNamespaceOptions.Builder.() -> Unit
     ...
     *
     * This method provides a streamlined way to assign the 'ecs:UpdateTaskProtection' permission,
     * enabling the grantee to manage task protection in the ECS cluster.
     *
    ...
    public interface Builder {
         ...
         *
         * Default: - no EC2 capacity will be added, you can use `addCapacity` to add capacity
         * later.
         *
         ...
         *
         * Default: - no service discovery namespace created, you can use
         * `addDefaultCloudMapNamespace` to add a default service discovery namespace later.
         *
        ...
        public fun defaultCloudMapNamespace(
            defaultCloudMapNamespace: CloudMapNamespaceOptions.Builder.() -> Unit
        )
        ...
        public fun executeCommandConfiguration(
            executeCommandConfiguration: ExecuteCommandConfiguration.Builder.() -> Unit
        )
         ...
         *
         * @param vpc The VPC where your ECS instances will be running or your ENIs will be
         *   deployed.
         */
    ...
    private class BuilderImpl(
        ...
        override fun defaultCloudMapNamespace(defaultCloudMapNamespace: CloudMapNamespaceOptions) {
            cdkBuilder.defaultCloudMapNamespace(
                defaultCloudMapNamespace.let(CloudMapNamespaceOptions::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("86fad33d93456dd392654e74eedbe276ef8687f3da3062b59797356804ca9d7d")
        override fun defaultCloudMapNamespace(
            defaultCloudMapNamespace: CloudMapNamespaceOptions.Builder.() -> Unit
        ...
        override fun executeCommandConfiguration(
            ...
            cdkBuilder.executeCommandConfiguration(
                executeCommandConfiguration.let(ExecuteCommandConfiguration::unwrap)
            )
        }
    ...
    public companion object {
        public fun fromClusterArn(
            ...
            software.amazon.awscdk.services.ecs.Cluster.fromClusterArn(
        ...
        public fun fromClusterAttributes(
            ...
            software.amazon.awscdk.services.ecs.Cluster.fromClusterAttributes(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
        ...
        public fun isCluster(x: Any): Boolean =
