...
internal constructor(
    ...
    public interface Builder {
         ...
         * in the *AWS General Rareference* .
         *
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.gamelift.CfnLocation =
            cdkBuilder.build()
    }
    ...
    public companion object {
        ...
        ): CfnLocation = CfnLocation(cdkObject)

        internal fun unwrap(
            wrapped: CfnLocation
        ): software.amazon.awscdk.services.gamelift.CfnLocation = wrapped.cdkObject
    }
}
