...
internal constructor(
    ...
    public interface Builder {
         ...
         * in.
         *
         * To update the `ParentId` parameter value, you must first remove all accounts attached to
         * the organizational unit (OU). OUs can't be moved within the organization with accounts
         * still attached.
         *
         ...
         *
         * @param parentId The unique identifier (ID) of the parent root or OU that you want to
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.organizations.CfnOrganizationalUnit.Builder.create(
                scope,
                id
            )
