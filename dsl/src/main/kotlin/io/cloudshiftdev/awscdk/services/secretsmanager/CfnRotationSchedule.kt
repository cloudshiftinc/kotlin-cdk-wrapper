...
internal constructor(
    ...
    public open fun hostedRotationLambda(
        `value`: HostedRotationLambdaProperty.Builder.() -> Unit
    ...
    public interface Builder {
        ...
        public fun hostedRotationLambda(
            hostedRotationLambda: HostedRotationLambdaProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.secretsmanager.CfnRotationSchedule.Builder.create(
                scope,
                id
            )
        ...
        override fun hostedRotationLambda(hostedRotationLambda: HostedRotationLambdaProperty) {
            cdkBuilder.hostedRotationLambda(
                hostedRotationLambda.let(HostedRotationLambdaProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("b06afb51ad3d8bac88363cde0f16d9b4bed6cf5832a421d68e17a00fd2a7087e")
        override fun hostedRotationLambda(
            hostedRotationLambda: HostedRotationLambdaProperty.Builder.() -> Unit
    ...
    public interface RotationRulesProperty {
         ...
         * want to rotate your secret, for example `rate(12 hours)` or `rate(10 days)` . You can
         * rotate a secret as often as every four hours. If you use a `rate()` expression, the
         * rotation window starts at midnight. For a rate in hours, the default rotation window
         * closes after one hour. For a rate in days, the default rotation window closes at the end
         * of the day. You can set the `Duration` to change the rotation window. The rotation window
         ...
         * [Schedule expressions in Secrets Manager rotation](https://docs.aws.amazon.com/secretsmanager/latest/userguide/rotate-secrets_schedule.html)
         * in the *Secrets Manager Users Guide* . For a cron expression that represents a schedule
         * in hours, the default rotation window closes after one hour. For a cron expression that
         * represents a schedule in days, the default rotation window closes at the end of the day.
         * You can set the `Duration` to change the rotation window. The rotation window must not
        ...
        public interface Builder {
            /**
             * @param automaticallyAfterDays The number of days between automatic scheduled
             *   rotations of the secret. You can use this value to check that your secret meets
             *   your compliance guidelines for how often secrets must be rotated.
             *
             * In `DescribeSecret` and `ListSecrets` , this value is calculated from the rotation
            ...
            /**
             * @param duration The length of the rotation window in hours, for example `3h` for a
             ...
             *   day. The window starts according to the `ScheduleExpression` . If you don't specify
             *   a `Duration` , for a `ScheduleExpression` in hours, the window automatically closes
             *   after one hour. For a `ScheduleExpression` in days, the window automatically closes
             *   at the end of the UTC day. For more information, including examples, see
             *   [Schedule expressions in Secrets Manager rotation](https://docs.aws.amazon.com/secretsmanager/latest/userguide/rotate-secrets_schedule.html)
             *   in the *Secrets Manager Users Guide* .
             */
            ...
            /**
             * @param scheduleExpression A `cron()` or `rate()` expression that defines the schedule
             ...
             * rotate a secret as often as every four hours. If you use a `rate()` expression, the
             * rotation window starts at midnight. For a rate in hours, the default rotation window
             * closes after one hour. For a rate in days, the default rotation window closes at the
             ...
             * expression that represents a schedule in days, the default rotation window closes at
        ...
        internal constructor(
             ...
             * The number of days between automatic scheduled rotations of the secret.
             *
             * You can use this value to check that your secret meets your compliance guidelines for
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-secretsmanager-rotationschedule-rotationrules.html#cfn-secretsmanager-rotationschedule-rotationrules-automaticallyafterdays)
             */
            override fun automaticallyAfterDays(): Number? =
                unwrap(this).getAutomaticallyAfterDays()

            /**
             * The length of the rotation window in hours, for example `3h` for a three hour window.
             *
             * Secrets Manager rotates your secret at any time during this window. The window must
             * not extend into the next rotation window or the next UTC day. The window starts
             * according to the `ScheduleExpression` . If you don't specify a `Duration` , for a
             * `ScheduleExpression` in hours, the window automatically closes after one hour. For a
             * `ScheduleExpression` in days, the window automatically closes at the end of the UTC
             * day. For more information, including examples, see
             * [Schedule expressions in Secrets Manager rotation](https://docs.aws.amazon.com/secretsmanager/latest/userguide/rotate-secrets_schedule.html)
             * in the *Secrets Manager Users Guide* .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-secretsmanager-rotationschedule-rotationrules.html#cfn-secretsmanager-rotationschedule-rotationrules-duration)
    ...
    public interface HostedRotationLambdaProperty {
         ...
         *
         * You must also include the superuser secret ARN as a key in the JSON of the rotating
         * secret so that the Lambda rotation function can find it. CloudFormation does not hardcode
         * secret ARNs in the Lambda rotation function, so you can use the function to rotate
         * multiple secrets. For more information, see
         ...
         * .
         *
         * You can specify `MasterSecretArn` or `SuperuserSecretArn` but not both. They represent
         * the same superuser secret.
         *
        ...
        /**
         * By default, CloudFormation deploys Python 3.9 binaries for the rotation function. To use
         * a different version of Python, you must do the following two steps:.
        ...
        public interface Builder {
            /**
             * @param excludeCharacters A string of the characters that you don't want in the
             *   password.
             */
            public fun excludeCharacters(excludeCharacters: String)

            /**
             * @param kmsKeyArn The ARN of the KMS key that Secrets Manager uses to encrypt the
             *   secret. If you don't specify this value, then Secrets Manager uses the key
             *   `aws/secretsmanager` . If `aws/secretsmanager` doesn't yet exist, then Secrets
            ...
            /**
             * @param masterSecretArn The ARN of the secret that contains superuser credentials, if
             *   you use the
             *   [Alternating users rotation strategy](https://docs.aws.amazon.com/secretsmanager/latest/userguide/rotating-secrets_strategies.html#rotating-secrets-two-users)
             *   . CloudFormation grants the execution role for the Lambda rotation function
             *   `GetSecretValue` permission to the secret in this property. For more information,
             *   see
             *   [Lambda rotation function execution role permissions for Secrets Manager](https://docs.aws.amazon.com/secretsmanager/latest/userguide/rotating-secrets-required-permissions-function.html)
             *   . You must create the superuser secret before you can set this property.
             *
             * You must also include the superuser secret ARN as a key in the JSON of the rotating
             * secret so that the Lambda rotation function can find it. CloudFormation does not
             * hardcode secret ARNs in the Lambda rotation function, so you can use the function to
             * rotate multiple secrets. For more information, see
             * [JSON structure of Secrets Manager secrets](https://docs.aws.amazon.com/secretsmanager/latest/userguide/reference_secret_json_structure.html)
             * .
             *
             * You can specify `MasterSecretArn` or `SuperuserSecretArn` but not both. They
             * represent the same superuser secret.
             */
            public fun masterSecretArn(masterSecretArn: String)

            /**
             * @param masterSecretKmsKeyArn The ARN of the KMS key that Secrets Manager used to
             *   encrypt the superuser secret, if you use the
             *   [alternating users strategy](https://docs.aws.amazon.com/secretsmanager/latest/userguide/rotating-secrets_strategies.html#rotating-secrets-two-users)
             *   and the superuser secret is encrypted with a customer managed key. You don't need
             *   to specify this property if the superuser secret is encrypted using the key
             *   `aws/secretsmanager` . CloudFormation grants the execution role for the Lambda
             *   rotation function `Decrypt` , `DescribeKey` , and `GenerateDataKey` permission to
             *   the key in this property. For more information, see
             *   [Lambda rotation function execution role permissions for Secrets Manager](https://docs.aws.amazon.com/secretsmanager/latest/userguide/rotating-secrets-required-permissions-function.html)
             *   . You can specify `MasterSecretKmsKeyArn` or `SuperuserSecretKmsKeyArn` but not
             *   both. They represent the same superuser secret KMS key .
             */
            ...
            /**
             * @param rotationType The rotation template to base the rotation function on, one of
             *   the following:.
             * * `Db2SingleUser` to use the template
             *   [SecretsManagerRDSDb2RotationSingleUser](https://docs.aws.amazon.com/secretsmanager/latest/userguide/reference_available-rotation-templates.html#sar-template-db2-singleuser)
             *   .
            ...
            /**
             * @param runtime By default, CloudFormation deploys Python 3.9 binaries for the
             *   rotation function. To use a different version of Python, you must do the following
             *   two steps:.
             * * Deploy the matching version Python binaries with your rotation function.
             * * Set the version number in this field. For example, for Python 3.7, enter
             *   *python3.7*
             *
             * If you only do one of the steps, your rotation function will be incompatible with the
             * binaries. For more information, see
            ...
            /**
             * @param superuserSecretArn The ARN of the secret that contains superuser credentials,
             *   if you use the
             *   [Alternating users rotation strategy](https://docs.aws.amazon.com/secretsmanager/latest/userguide/rotating-secrets_strategies.html#rotating-secrets-two-users)
             *   . CloudFormation grants the execution role for the Lambda rotation function
             *   `GetSecretValue` permission to the secret in this property. For more information,
            ...
            /**
             * @param superuserSecretKmsKeyArn The ARN of the KMS key that Secrets Manager used to
             *   encrypt the superuser secret, if you use the
             *   [alternating users strategy](https://docs.aws.amazon.com/secretsmanager/latest/userguide/rotating-secrets_strategies.html#rotating-secrets-two-users)
             *   and the superuser secret is encrypted with a customer managed key. You don't need
             *   to specify this property if the superuser secret is encrypted using the key
            ...
            /**
             * @param vpcSecurityGroupIds A comma-separated list of security group IDs applied to
             *   the target database. The template applies the same security groups as on the Lambda
             *   rotation function that is created as part of this stack.
             */
             ...
             *   network. The Lambda rotation function is in the same subnet group.
             */
        ...
        internal constructor(
             ...
             * `aws/secretsmanager` . If `aws/secretsmanager` doesn't yet exist, then Secrets
             * Manager creates it for you automatically the first time it encrypts the secret value.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-secretsmanager-rotationschedule-hostedrotationlambda.html#cfn-secretsmanager-rotationschedule-hostedrotationlambda-kmskeyarn)
             */
             ...
             * specify this property if the superuser secret is encrypted using the key
             * `aws/secretsmanager` . CloudFormation grants the execution role for the Lambda
             * rotation function `Decrypt` , `DescribeKey` , and `GenerateDataKey` permission to the
             * key in this property. For more information, see
             * [Lambda rotation function execution role permissions for Secrets Manager](https://docs.aws.amazon.com/secretsmanager/latest/userguide/rotating-secrets-required-permissions-function.html)
             * .
             *
             * You can specify `MasterSecretKmsKeyArn` or `SuperuserSecretKmsKeyArn` but not both.
             * They represent the same superuser secret KMS key .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-secretsmanager-rotationschedule-hostedrotationlambda.html#cfn-secretsmanager-rotationschedule-hostedrotationlambda-mastersecretkmskeyarn)
             */
            ...
            /**
             * By default, CloudFormation deploys Python 3.9 binaries for the rotation function. To
             * use a different version of Python, you must do the following two steps:.
             * * Deploy the matching version Python binaries with your rotation function.
             * * Set the version number in this field. For example, for Python 3.7, enter
             *   *python3.7*
             *
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-secretsmanager-rotationschedule-hostedrotationlambda.html#cfn-secretsmanager-rotationschedule-hostedrotationlambda-superusersecretkmskeyarn)
             */
            override fun superuserSecretKmsKeyArn(): String? =
                unwrap(this).getSuperuserSecretKmsKeyArn()

            /**
             * A comma-separated list of security group IDs applied to the target database.
             *
             * The template applies the same security groups as on the Lambda rotation function that
             * is created as part of this stack.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-secretsmanager-rotationschedule-hostedrotationlambda.html#cfn-secretsmanager-rotationschedule-hostedrotationlambda-vpcsecuritygroupids)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: HostedRotationLambdaProperty
            ): software.amazon.awscdk.services.secretsmanager.CfnRotationSchedule.HostedRotationLambdaProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
