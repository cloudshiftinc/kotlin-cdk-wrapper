...
internal constructor(
     ...
     * default version can be set in the Amazon EC2 console or by using the `modify-launch-template`
     * AWS CLI command.
     */
    ...
    public open fun launchTemplateData(
        `value`: LaunchTemplateDataProperty.Builder.() -> Unit
    ): Unit = launchTemplateData(LaunchTemplateDataProperty(`value`))
    ...
    public interface Builder {
        ...
        public fun launchTemplateData(
            launchTemplateData: LaunchTemplateDataProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
        ...
        override fun launchTemplateData(launchTemplateData: LaunchTemplateDataProperty) {
            cdkBuilder.launchTemplateData(
                launchTemplateData.let(LaunchTemplateDataProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("5fc18067754864f0fa773cab73d5bca9bb457987000eb5ce581f15be00c87a8d")
        override fun launchTemplateData(
            launchTemplateData: LaunchTemplateDataProperty.Builder.() -> Unit
        ...
        public fun build(): software.amazon.awscdk.services.ec2.CfnLaunchTemplate =
            cdkBuilder.build()
    }
    ...
    public interface EnclaveOptionsProperty {
        ...
        public interface Builder {
            /**
             * @param enabled If this parameter is set to `true` , the instance is enabled for AWS
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: EnclaveOptionsProperty
            ): software.amazon.awscdk.services.ec2.CfnLaunchTemplate.EnclaveOptionsProperty =
    ...
    public interface NetworkInterfaceCountProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: NetworkInterfaceCountProperty
            ): software.amazon.awscdk.services.ec2.CfnLaunchTemplate.NetworkInterfaceCountProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface SpotOptionsProperty {
         ...
         *
         * If you are using Spot Instances with an Auto Scaling group, use `one-time` requests, as
         * the Amazon EC2 Auto Scaling service handles requesting new Spot Instances whenever the
         * group is below its desired capacity.
         *
         ...
         * * For a persistent request, the request remains active until the `ValidUntil` date and
        ...
        public interface Builder {
            ...
            /**
             * @param maxPrice The maximum hourly price you're willing to pay for the Spot
             *   Instances. We do not recommend using this parameter because it can lead to
            ...
            /**
             * @param spotInstanceType The Spot Instance request type. If you are using Spot
             *   Instances with an Auto Scaling group, use `one-time` requests, as the Amazon EC2
             *   Auto Scaling service handles requesting new Spot Instances whenever the group is
             *   below its desired capacity.
             */
            public fun spotInstanceType(spotInstanceType: String)

            /**
             * @param validUntil The end date of the request, in UTC format ( *YYYY-MM-DD* T
             *   *HH:MM:SS* Z). Supported only for persistent requests.
             * * For a persistent request, the request remains active until the `ValidUntil` date
             *   and time is reached. Otherwise, the request remains active until you cancel it.
             * * For a one-time request, `ValidUntil` is not supported. The request remains active
        ...
        internal constructor(
             ...
             * The Spot Instance request type.
             *
             * If you are using Spot Instances with an Auto Scaling group, use `one-time` requests,
             * as the Amazon EC2 Auto Scaling service handles requesting new Spot Instances whenever
             * the group is below its desired capacity.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ec2-launchtemplate-spotoptions.html#cfn-ec2-launchtemplate-spotoptions-spotinstancetype)
             */
            ...
            /**
             * The end date of the request, in UTC format ( *YYYY-MM-DD* T *HH:MM:SS* Z). Supported
    ...
    public interface LaunchTemplateDataProperty {
        ...
        /**
         * If you set this parameter to `true` , you can't terminate the instance using the Amazon
         ...
         * require graphics acceleration, we recommend that you use Amazon EC2 G4ad, G4dn, or G5
         * instances.
         *
         ...
         * (EI), and will help current customers migrate their workloads to options that offer
         * better price and performance. After April 15, 2023, new customers will not be able to
         * launch instances with Amazon EI accelerators in Amazon SageMaker, Amazon ECS, or Amazon
         * EC2. However, customers who have used Amazon EI at least once during the past 30-day
         ...
         */
        public fun elasticInferenceAccelerators(): Any? =
         ...
         * The ID of the AMI.
         *
         * Alternatively, you can specify a Systems Manager parameter, which will resolve to an AMI
         * ID on launch.
         *
         * Valid formats:
         ...
         * * `ExcludedInstanceTypes` - The instance types to exclude from the list, even if they
         ...
         * EC2 Fleet, and Spot Fleet to launch instances. If you plan to use the launch template in
         * the
        ...
        /**
         * The hostname type for EC2 instances launched into this subnet and how DNS A and AAAA
         * record queries should be handled.
         *
         * For more information, see
         ...
         *
         * You can specify the IDs of existing security groups and references to resources created
         * by the stack template.
         *
        ...
        public interface Builder {
            ...
            /**
             * @param capacityReservationSpecification The Capacity Reservation targeting option. If
             *   you do not specify this parameter, the instance's Capacity Reservation preference
             *   defaults to `open` , which enables it to run in any open Capacity Reservation that
             *   has matching attributes (instance type, platform, Availability Zone).
             */
            public fun capacityReservationSpecification(
                capacityReservationSpecification: IResolvable
            )
            ...
            public fun capacityReservationSpecification(
                capacityReservationSpecification:
                    CapacityReservationSpecificationProperty.Builder.() -> Unit
            )
            ...
            /**
             * @param creditSpecification The credit option for CPU usage of the instance. Valid
             *   only for T instances.
             */
            ...
            public fun creditSpecification(
                creditSpecification: CreditSpecificationProperty.Builder.() -> Unit
            )
            ...
            /**
             * @param disableApiTermination If you set this parameter to `true` , you can't
            ...
            /**
             * @param elasticInferenceAccelerators An elastic inference accelerator to associate
             *   with the instance. Elastic inference accelerators are a resource you can attach to
             *   your Amazon EC2 instances to accelerate your Deep Learning (DL) inference
             *   workloads.
             *
             * You cannot specify accelerators from different generations in the same request.
             *
             ...
             * that offer better price and performance. After April 15, 2023, new customers will not
             * be able to launch instances with Amazon EI accelerators in Amazon SageMaker, Amazon
             * ECS, or Amazon EC2. However, customers who have used Amazon EI at least once during
            ...
            /**
             * @param enclaveOptions Indicates whether the instance is enabled for AWS Nitro
            ...
            public fun hibernationOptions(
                hibernationOptions: HibernationOptionsProperty.Builder.() -> Unit
            )
            ...
            public fun iamInstanceProfile(
                iamInstanceProfile: IamInstanceProfileProperty.Builder.() -> Unit
            )

            /**
             * @param imageId The ID of the AMI. Alternatively, you can specify a Systems Manager
            ...
            /**
             * @param instanceInitiatedShutdownBehavior Indicates whether an instance stops or
            ...
            public fun instanceMarketOptions(
                instanceMarketOptions: InstanceMarketOptionsProperty.Builder.() -> Unit
            )

            /**
             * @param instanceRequirements The attributes for the instance types. When you specify
             *   instance attributes, Amazon EC2 will identify instance types with these attributes.
             *
             * You must specify `VCpuCount` and `MemoryMiB` . All other attributes are optional. Any
             * unspecified optional attribute is set to its default.
             *
             ...
             * instance types that satisfy any of the specified values.
             *
            ...
            public fun instanceRequirements(
                instanceRequirements: InstanceRequirementsProperty.Builder.() -> Unit
            )
            ...
            /**
             * @param kernelId The ID of the kernel. We recommend that you use PV-GRUB instead of
            ...
            public fun maintenanceOptions(
                maintenanceOptions: MaintenanceOptionsProperty.Builder.() -> Unit
            )

            /**
             * @param metadataOptions The metadata options for the instance. For more information,
             *   see
             *   [Instance metadata and user data](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-instance-metadata.html)
             *   in the *Amazon Elastic Compute Cloud User Guide* .
             */
            ...
            /**
             * @param privateDnsNameOptions The hostname type for EC2 instances launched into this
             *   subnet and how DNS A and AAAA record queries should be handled. For more
             *   information, see
             *   [Amazon EC2 instance hostname types](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-instance-naming.html)
             *   in the *Amazon Elastic Compute Cloud User Guide* .
             */
            ...
            public fun privateDnsNameOptions(
                privateDnsNameOptions: PrivateDnsNameOptionsProperty.Builder.() -> Unit
            )
            ...
            /**
             * @param securityGroupIds The IDs of the security groups. You can specify the IDs of
             *   existing security groups and references to resources created by the stack template.
             */
            ...
            /**
             * @param securityGroups One or more security group names. For a nondefault VPC, you
             ...
             *   instance launch. To tag a resource after it has been created, see
             *   [CreateTags](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_CreateTags.html)
             *   .
             *
             * To tag the launch template itself, use
             ...
             *   (Windows) in the *Amazon Elastic Compute Cloud User Guide* .
             *
             * If you are creating the launch template for use with AWS Batch , the user data must
             * be provided in the
             * [MIME multi-part archive format](https://docs.aws.amazon.com/https://cloudinit.readthedocs.io/en/latest/topics/format.html#mime-multi-part-archive)
             * . For more information, see
             * [Amazon EC2 user data in launch templates](https://docs.aws.amazon.com/batch/latest/userguide/launch-templates.html)
        ...
        private class BuilderImpl : Builder {
             ...
             *   has matching attributes (instance type, platform, Availability Zone).
             */
            override fun capacityReservationSpecification(
                capacityReservationSpecification: IResolvable
            ) {
                cdkBuilder.capacityReservationSpecification(
                    capacityReservationSpecification.let(IResolvable::unwrap)
                )
            }
            ...
            override fun capacityReservationSpecification(
                ...
                cdkBuilder.capacityReservationSpecification(
                    capacityReservationSpecification.let(
                        CapacityReservationSpecificationProperty::unwrap
                    )
                )
            }
            ...
            override fun capacityReservationSpecification(
                ...
                capacityReservationSpecification(
                    CapacityReservationSpecificationProperty(capacityReservationSpecification)
                )
            ...
            override fun creditSpecification(creditSpecification: CreditSpecificationProperty) {
                cdkBuilder.creditSpecification(
                    creditSpecification.let(CreditSpecificationProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("c519e21ccdfb01d70cdf605a898774b356db73d7a867105c93e7548d3dbbd7f5")
            override fun creditSpecification(
                creditSpecification: CreditSpecificationProperty.Builder.() -> Unit
            ...
            override fun elasticGpuSpecifications(elasticGpuSpecifications: IResolvable) {
                cdkBuilder.elasticGpuSpecifications(
                    elasticGpuSpecifications.let(IResolvable::unwrap)
                )
            }
            ...
            override fun elasticInferenceAccelerators(elasticInferenceAccelerators: IResolvable) {
                cdkBuilder.elasticInferenceAccelerators(
                    elasticInferenceAccelerators.let(IResolvable::unwrap)
                )
            }
             ...
             * using the service.
             */
            override fun elasticInferenceAccelerators(
                vararg elasticInferenceAccelerators: Any
            ): Unit = elasticInferenceAccelerators(elasticInferenceAccelerators.toList())
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("f07d1a4d0253198ddd3f5824e73df1255a4da4abfb9fb30dfb987a7cc2b9a138")
            override fun enclaveOptions(
                enclaveOptions: EnclaveOptionsProperty.Builder.() -> Unit
            ...
            override fun hibernationOptions(hibernationOptions: HibernationOptionsProperty) {
                cdkBuilder.hibernationOptions(
                    hibernationOptions.let(HibernationOptionsProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("28e8f416c301f684b2caa0ff660d3316808d2aaa191bdf45a914e96dabfbc4a0")
            override fun hibernationOptions(
                hibernationOptions: HibernationOptionsProperty.Builder.() -> Unit
            ...
            override fun iamInstanceProfile(iamInstanceProfile: IamInstanceProfileProperty) {
                cdkBuilder.iamInstanceProfile(
                    iamInstanceProfile.let(IamInstanceProfileProperty::unwrap)
                )
            }
             ...
             *   command for system shutdown). Default: `stop`
             */
            override fun instanceInitiatedShutdownBehavior(
            ...
            /** @param instanceMarketOptions The market (purchasing) option for the instances. */
            override fun instanceMarketOptions(
                instanceMarketOptions: InstanceMarketOptionsProperty
            ) {
                cdkBuilder.instanceMarketOptions(
                    instanceMarketOptions.let(InstanceMarketOptionsProperty::unwrap)
                )
            }
            ...
            override fun instanceRequirements(instanceRequirements: InstanceRequirementsProperty) {
                cdkBuilder.instanceRequirements(
                    instanceRequirements.let(InstanceRequirementsProperty::unwrap)
                )
            }
            ...
            override fun maintenanceOptions(maintenanceOptions: MaintenanceOptionsProperty) {
                cdkBuilder.maintenanceOptions(
                    maintenanceOptions.let(MaintenanceOptionsProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("fc0929a282bb2fbc3977ef24433a08c1d37f4f2836f2a7220650d33b4c6539dc")
            override fun maintenanceOptions(
                maintenanceOptions: MaintenanceOptionsProperty.Builder.() -> Unit
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("ac7fc838a77a9a6a23cb745f94ea114a1de9fd91a5d1d8d5c34039bb5f711bb2")
            override fun metadataOptions(
                metadataOptions: MetadataOptionsProperty.Builder.() -> Unit
             ...
             *   in the *Amazon Elastic Compute Cloud User Guide* .
             */
            override fun privateDnsNameOptions(
                privateDnsNameOptions: PrivateDnsNameOptionsProperty
            ) {
                cdkBuilder.privateDnsNameOptions(
                    privateDnsNameOptions.let(PrivateDnsNameOptionsProperty::unwrap)
                )
            }
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ec2-launchtemplate-launchtemplatedata.html#cfn-ec2-launchtemplate-launchtemplatedata-elasticgpuspecifications)
             */
            override fun elasticGpuSpecifications(): Any? =
                unwrap(this).getElasticGpuSpecifications()

            /**
             * An elastic inference accelerator to associate with the instance.
             *
             * Elastic inference accelerators are a resource you can attach to your Amazon EC2
             ...
             * The ID of the AMI.
             *
             * Alternatively, you can specify a Systems Manager parameter, which will resolve to an
             * AMI ID on launch.
             *
             * Valid formats:
             * * `ami-17characters00000`
             ...
             * One or more network interfaces.
             *
             * If you specify a network interface, you must specify any security groups and subnets
             ...
             * The IDs of the security groups.
             *
             * You can specify the IDs of existing security groups and references to resources
             * created by the stack template.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ec2-launchtemplate-launchtemplatedata.html#cfn-ec2-launchtemplate-launchtemplatedata-securitygroupids)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: LaunchTemplateDataProperty
            ): software.amazon.awscdk.services.ec2.CfnLaunchTemplate.LaunchTemplateDataProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CapacityReservationTargetProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param capacityReservationResourceGroupArn The ARN of the Capacity Reservation
             *   resource group in which to run the instance.
             */
            public fun capacityReservationResourceGroupArn(
        ...
        private class BuilderImpl : Builder {
             ...
             *   resource group in which to run the instance.
             */
            override fun capacityReservationResourceGroupArn(
                capacityReservationResourceGroupArn: String
            ) {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CapacityReservationTargetProperty
            ): software.amazon.awscdk.services.ec2.CfnLaunchTemplate.CapacityReservationTargetProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface Ipv4PrefixSpecificationProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: Ipv4PrefixSpecificationProperty
            ): software.amazon.awscdk.services.ec2.CfnLaunchTemplate.Ipv4PrefixSpecificationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface AcceleratorTotalMemoryMiBProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AcceleratorTotalMemoryMiBProperty
            ): software.amazon.awscdk.services.ec2.CfnLaunchTemplate.AcceleratorTotalMemoryMiBProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface NetworkInterfaceProperty {
        ...
        public interface Builder {
             ...
             *   network interface. Use this option when you launch an instance in a Wavelength Zone
             *   and want to associate a Carrier IP address with the network interface. For more
             *   information about Carrier IP addresses, see
             *   [Carrier IP addresses](https://docs.aws.amazon.com/wavelength/latest/developerguide/how-wavelengths-work.html#provider-owned-ip)
             *   in the *AWS Wavelength Developer Guide* .
             */
             ...
             *   network interface. AWS charges for all public IPv4 addresses, including public IPv4
             *   addresses associated with running instances and Elastic IP addresses. For more
             *   information, see the *Public IPv4 Address* tab on the
             *   [Amazon VPC pricing page](https://docs.aws.amazon.com/vpc/pricing/) .
             */
            ...
            /**
             * @param connectionTrackingSpecification A connection tracking specification for the
             *   network interface.
             */
            ...
            public fun connectionTrackingSpecification(
                connectionTrackingSpecification:
                    ConnectionTrackingSpecificationProperty.Builder.() -> Unit
            )
            ...
            public fun enaSrdSpecification(
                enaSrdSpecification: EnaSrdSpecificationProperty.Builder.() -> Unit
            )
            ...
            /**
             * @param interfaceType The type of network interface. To create an Elastic Fabric
            ...
            /**
             * @param ipv4PrefixCount The number of IPv4 prefixes to be automatically assigned to
             *   the network interface. You cannot use this option if you use the `Ipv4Prefix`
             *   option.
             */
            public fun ipv4PrefixCount(ipv4PrefixCount: Number)

            /**
             * @param ipv4Prefixes One or more IPv4 prefixes to be assigned to the network
            ...
            /**
             * @param ipv6AddressCount The number of IPv6 addresses to assign to a network
             *   interface. Amazon EC2 automatically selects the IPv6 addresses from the subnet
             *   range. You can't use this option if specifying specific IPv6 addresses.
             */
            public fun ipv6AddressCount(ipv6AddressCount: Number)

            /**
             * @param ipv6Addresses One or more specific IPv6 addresses from the IPv6 CIDR block
             *   range of your subnet. You can't use this option if you're specifying a number of
             *   IPv6 addresses.
             */
            ...
            /**
             * @param ipv6PrefixCount The number of IPv6 prefixes to be automatically assigned to
            ...
            /**
             * @param ipv6Prefixes One or more IPv6 prefixes to be assigned to the network
            ...
            /**
             * @param networkCardIndex The index of the network card. Some instance types support
             *   multiple network cards. The primary network interface must be assigned to network
            ...
            /**
             * @param primaryIpv6 The primary IPv6 address of the network interface. When you enable
             *   an IPv6 GUA address to be a primary IPv6, the first IPv6 GUA will be made the
             ...
             *   to assign to a network interface.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            override fun associateCarrierIpAddress(associateCarrierIpAddress: IResolvable) {
                cdkBuilder.associateCarrierIpAddress(
                    associateCarrierIpAddress.let(IResolvable::unwrap)
                )
            }
             ...
             *   network interface.
             */
            override fun connectionTrackingSpecification(
                connectionTrackingSpecification: IResolvable
            ) {
                cdkBuilder.connectionTrackingSpecification(
                    connectionTrackingSpecification.let(IResolvable::unwrap)
                )
            }
            ...
            override fun connectionTrackingSpecification(
                ...
                cdkBuilder.connectionTrackingSpecification(
                    connectionTrackingSpecification.let(
                        ConnectionTrackingSpecificationProperty::unwrap
                    )
                )
            }
            ...
            override fun connectionTrackingSpecification(
                ...
                connectionTrackingSpecification(
                    ConnectionTrackingSpecificationProperty(connectionTrackingSpecification)
                )
            ...
            override fun enaSrdSpecification(enaSrdSpecification: EnaSrdSpecificationProperty) {
                cdkBuilder.enaSrdSpecification(
                    enaSrdSpecification.let(EnaSrdSpecificationProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("dde402339dbd4f7d544b0811410463367a3fbedfd09e5cfd914ab9ec1d85c378")
            override fun enaSrdSpecification(
                enaSrdSpecification: EnaSrdSpecificationProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ec2-launchtemplate-networkinterface.html#cfn-ec2-launchtemplate-networkinterface-associatecarrieripaddress)
             */
            override fun associateCarrierIpAddress(): Any? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: NetworkInterfaceProperty
            ): software.amazon.awscdk.services.ec2.CfnLaunchTemplate.NetworkInterfaceProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface TotalLocalStorageGBProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TotalLocalStorageGBProperty
            ): software.amazon.awscdk.services.ec2.CfnLaunchTemplate.TotalLocalStorageGBProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ElasticGpuSpecificationProperty {
         ...
         *
         * For more information about the values to specify for `Type` , see
        ...
        public interface Builder {
            /**
             * @param type The type of Elastic Graphics accelerator. For more information about the
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ElasticGpuSpecificationProperty
            ): software.amazon.awscdk.services.ec2.CfnLaunchTemplate.ElasticGpuSpecificationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface LaunchTemplateElasticInferenceAcceleratorProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param type The type of elastic inference accelerator. The possible values are
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: LaunchTemplateElasticInferenceAcceleratorProperty
            ): software.amazon.awscdk.services.ec2.CfnLaunchTemplate.LaunchTemplateElasticInferenceAcceleratorProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface EbsProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param encrypted Indicates whether the EBS volume is encrypted. Encrypted volumes can
             *   only be attached to instances that support Amazon EBS encryption. If you are
            ...
            /**
             * @param kmsKeyId The ARN of the symmetric AWS Key Management Service ( AWS KMS ) CMK
             *   used for encryption.
             */
             ...
             *   1,000 MiB/s. Valid Range: Minimum value of 125. Maximum value of 1000.
             */
            public fun throughput(throughput: Number)

            /**
             * @param volumeSize The size of the volume, in GiBs. You must specify either a snapshot
             *   ID or a volume size. The following are the supported volumes sizes for each volume
             *   type:
             * * `gp2` and `gp3` : 1 - 16,384 GiB
             * * `io1` : 4 - 16,384 GiB
             * * `io2` : 4 - 65,536 GiB
        ...
        internal constructor(
             ...
             * The size of the volume, in GiBs.
             *
             * You must specify either a snapshot ID or a volume size. The following are the
    ...
    public interface InstanceMarketOptionsProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: InstanceMarketOptionsProperty
            ): software.amazon.awscdk.services.ec2.CfnLaunchTemplate.InstanceMarketOptionsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ConnectionTrackingSpecificationProperty {
        ...
        /**
         * Timeout (in seconds) for idle UDP flows classified as streams which have seen more than
        ...
        public interface Builder {
             ...
             *   established state. Min: 60 seconds. Max: 432000 seconds (5 days). Default: 432000
             *   seconds. Recommended: Less than 432000 seconds.
             */
            public fun tcpEstablishedTimeout(tcpEstablishedTimeout: Number)

            /**
             * @param udpStreamTimeout Timeout (in seconds) for idle UDP flows classified as streams
             *   which have seen more than one request-response transaction. Min: 60 seconds. Max:
             *   180 seconds (3 minutes). Default: 180 seconds.
             */
            public fun udpStreamTimeout(udpStreamTimeout: Number)

            /**
             * @param udpTimeout Timeout (in seconds) for idle UDP flows that have seen traffic only
             *   in a single direction or a single request-response transaction. Min: 30 seconds.
        ...
        internal constructor(
             ...
             * Timeout (in seconds) for idle TCP connections in an established state.
             *
             * Min: 60 seconds. Max: 432000 seconds (5 days). Default: 432000 seconds. Recommended:
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ConnectionTrackingSpecificationProperty
            ): software.amazon.awscdk.services.ec2.CfnLaunchTemplate.ConnectionTrackingSpecificationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface HibernationOptionsProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: HibernationOptionsProperty
            ): software.amazon.awscdk.services.ec2.CfnLaunchTemplate.HibernationOptionsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface IamInstanceProfileProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: IamInstanceProfileProperty
            ): software.amazon.awscdk.services.ec2.CfnLaunchTemplate.IamInstanceProfileProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface Ipv6PrefixSpecificationProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: Ipv6PrefixSpecificationProperty
            ): software.amazon.awscdk.services.ec2.CfnLaunchTemplate.Ipv6PrefixSpecificationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface PrivateDnsNameOptionsProperty {
         ...
         */
        public fun enableResourceNameDnsARecord(): Any? =
         ...
         * For IPv6 only subnets, an instance DNS name must be based on the instance ID. For
         * dual-stack subnets, you can specify whether DNS names use the instance IPv4 address or
         * the instance ID. For more information, see
         * [Amazon EC2 instance hostname types](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-instance-naming.html)
         * in the *Amazon Elastic Compute Cloud User Guide* .
         *
        ...
        public interface Builder {
            ...
            /**
             * @param enableResourceNameDnsAaaaRecord Indicates whether to respond to DNS queries
             ...
             *   instance DNS name must be based on the instance IPv4 address. For IPv6 only
             ...
             *   instance ID. For more information, see
             *   [Amazon EC2 instance hostname types](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-instance-naming.html)
             *   in the *Amazon Elastic Compute Cloud User Guide* .
             */
        ...
        private class BuilderImpl : Builder {
            ...
            override fun enableResourceNameDnsARecord(enableResourceNameDnsARecord: IResolvable) {
                cdkBuilder.enableResourceNameDnsARecord(
                    enableResourceNameDnsARecord.let(IResolvable::unwrap)
                )
            }
             ...
             *   for instance hostnames with DNS AAAA records.
             */
            override fun enableResourceNameDnsAaaaRecord(
                enableResourceNameDnsAaaaRecord: IResolvable
            ) {
                cdkBuilder.enableResourceNameDnsAaaaRecord(
                    enableResourceNameDnsAaaaRecord.let(IResolvable::unwrap)
                )
            }
        ...
        internal constructor(
             ...
             * address or the instance ID. For more information, see
             * [Amazon EC2 instance hostname types](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-instance-naming.html)
             * in the *Amazon Elastic Compute Cloud User Guide* .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ec2-launchtemplate-privatednsnameoptions.html#cfn-ec2-launchtemplate-privatednsnameoptions-hostnametype)
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: PrivateDnsNameOptionsProperty
            ): software.amazon.awscdk.services.ec2.CfnLaunchTemplate.PrivateDnsNameOptionsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface MetadataOptionsProperty {
         ...
         *
         * Default: If the value of `ImdsSupport` for the Amazon Machine Image (AMI) for your
         * instance is `v2.0` , the default is `required` .
         *
         ...
         *
         * Set to `disabled` to turn off access to instance tags from the instance metadata. For
        ...
        public interface Builder {
            ...
            /**
             * @param httpProtocolIpv6 Enables or disables the IPv6 endpoint for the instance
             *   metadata service. Default: `disabled`
             */
             ...
             *   metadata requests. The larger the number, the further instance metadata requests
             *   can travel.
             *
             * Default: `1`
             *
             ...
             *   IAM role credentials using a valid session token, you receive the IMDSv2 role
             *   credentials.
             * * `required` - IMDSv2 is required. You must send a session token in your instance
             *   metadata retrieval requests. With this option, retrieving the IAM role credentials
             *   always returns IMDSv2 credentials; IMDSv1 credentials are not available.
            ...
            /**
             * @param instanceMetadataTags Set to `enabled` to allow access to instance tags from
             *   the instance metadata. Set to `disabled` to turn off access to instance tags from
             *   the instance metadata. For more information, see
             *   [Work with instance tags using the instance metadata](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/Using_Tags.html#work-with-tags-in-IMDS)
             *   .
             *
             * Default: `disabled`
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ec2-launchtemplate-metadataoptions.html#cfn-ec2-launchtemplate-metadataoptions-httpputresponsehoplimit)
             */
            override fun httpPutResponseHopLimit(): Number? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: MetadataOptionsProperty
            ): software.amazon.awscdk.services.ec2.CfnLaunchTemplate.MetadataOptionsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CreditSpecificationProperty {
        ...
        public interface Builder {
            /**
             * @param cpuCredits The credit option for CPU usage of a T instance. Valid values:
             *   `standard` | `unlimited`
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CreditSpecificationProperty
            ): software.amazon.awscdk.services.ec2.CfnLaunchTemplate.CreditSpecificationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface MemoryGiBPerVCpuProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: MemoryGiBPerVCpuProperty
            ): software.amazon.awscdk.services.ec2.CfnLaunchTemplate.MemoryGiBPerVCpuProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface NetworkBandwidthGbpsProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: NetworkBandwidthGbpsProperty
            ): software.amazon.awscdk.services.ec2.CfnLaunchTemplate.NetworkBandwidthGbpsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface TagSpecificationProperty {
         ...
         *
         * Valid Values lists all resource types for Amazon EC2 that can be tagged. When you create
         * a launch template, you can specify tags for the following resource types only: `instance`
         * | `volume` | `network-interface` | `spot-instances-request` . If the instance does not
         * include the resource type that you specify, the instance launch fails. For example, not
        ...
        public interface Builder {
            /**
             * @param resourceType The type of resource to tag. Valid Values lists all resource
             *   types for Amazon EC2 that can be tagged. When you create a launch template, you can
             *   specify tags for the following resource types only: `instance` | `volume` |
             *   `network-interface` | `spot-instances-request` . If the instance does not include
             *   the resource type that you specify, the instance launch fails. For example, not all
             *   instance types include a volume.
             *
             * To tag a resource after it has been created, see
             * [CreateTags](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_CreateTags.html)
             * .
        ...
        internal constructor(
             ...
             * `instance` | `volume` | `network-interface` | `spot-instances-request` . If the
             * instance does not include the resource type that you specify, the instance launch
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TagSpecificationProperty
            ): software.amazon.awscdk.services.ec2.CfnLaunchTemplate.TagSpecificationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface InstanceRequirementsProperty {
        ...
        public interface Builder {
            ...
            public fun acceleratorCount(
                acceleratorCount: AcceleratorCountProperty.Builder.() -> Unit
            )
            ...
            public fun acceleratorTotalMemoryMiB(
                acceleratorTotalMemoryMiB: AcceleratorTotalMemoryMiBProperty.Builder.() -> Unit
            )
            ...
            public fun baselineEbsBandwidthMbps(
                baselineEbsBandwidthMbps: BaselineEbsBandwidthMbpsProperty.Builder.() -> Unit
            )
             ...
             *   type, size, or generation. The following are examples: `m5.8xlarge` , `c5*.*` ,
             *   `m5a.*` , `r*` , `*3*` .
             *
            ...
            public fun memoryGiBPerVCpu(
                memoryGiBPerVCpu: MemoryGiBPerVCpuProperty.Builder.() -> Unit
            )
             ...
             *   gigabits per second (Gbps). Default: No minimum or maximum limits
             */
            ...
            public fun networkBandwidthGbps(
                networkBandwidthGbps: NetworkBandwidthGbpsProperty.Builder.() -> Unit
            )
            ...
            public fun networkInterfaceCount(
                networkInterfaceCount: NetworkInterfaceCountProperty.Builder.() -> Unit
            )
            ...
            public fun totalLocalStorageGb(
                totalLocalStorageGb: TotalLocalStorageGBProperty.Builder.() -> Unit
            )
        ...
        private class BuilderImpl : Builder {
            ...
            override fun acceleratorTotalMemoryMiB(
                ...
                cdkBuilder.acceleratorTotalMemoryMiB(
                    acceleratorTotalMemoryMiB.let(AcceleratorTotalMemoryMiBProperty::unwrap)
                )
            }
            ...
            override fun acceleratorTotalMemoryMiB(
                ...
                acceleratorTotalMemoryMiB(
                    AcceleratorTotalMemoryMiBProperty(acceleratorTotalMemoryMiB)
                )
            ...
            override fun baselineEbsBandwidthMbps(
                ...
                cdkBuilder.baselineEbsBandwidthMbps(
                    baselineEbsBandwidthMbps.let(BaselineEbsBandwidthMbpsProperty::unwrap)
                )
            }
            ...
            override fun networkBandwidthGbps(networkBandwidthGbps: NetworkBandwidthGbpsProperty) {
                cdkBuilder.networkBandwidthGbps(
                    networkBandwidthGbps.let(NetworkBandwidthGbpsProperty::unwrap)
                )
            }
            ...
            override fun networkInterfaceCount(
                ...
                cdkBuilder.networkInterfaceCount(
                    networkInterfaceCount.let(NetworkInterfaceCountProperty::unwrap)
                )
            }
            ...
            override fun totalLocalStorageGb(totalLocalStorageGb: TotalLocalStorageGBProperty) {
                cdkBuilder.totalLocalStorageGb(
                    totalLocalStorageGb.let(TotalLocalStorageGBProperty::unwrap)
                )
            }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: InstanceRequirementsProperty
            ): software.amazon.awscdk.services.ec2.CfnLaunchTemplate.InstanceRequirementsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface EnaSrdUdpSpecificationProperty {
        ...
        public interface Builder {
            /**
             * @param enaSrdUdpEnabled Indicates whether UDP traffic to and from the instance uses
             *   ENA Express. To specify this setting, you must first enable ENA Express.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: EnaSrdUdpSpecificationProperty
            ): software.amazon.awscdk.services.ec2.CfnLaunchTemplate.EnaSrdUdpSpecificationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CapacityReservationSpecificationProperty {
        ...
        public interface Builder {
            ...
            public fun capacityReservationTarget(
                capacityReservationTarget: CapacityReservationTargetProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun capacityReservationTarget(capacityReservationTarget: IResolvable) {
                cdkBuilder.capacityReservationTarget(
                    capacityReservationTarget.let(IResolvable::unwrap)
                )
            }
             ...
             *   Capacity Reservation group.
             */
            override fun capacityReservationTarget(
                capacityReservationTarget: CapacityReservationTargetProperty
            ) {
                cdkBuilder.capacityReservationTarget(
                    capacityReservationTarget.let(CapacityReservationTargetProperty::unwrap)
                )
            }
            ...
            override fun capacityReservationTarget(
                ...
                capacityReservationTarget(
                    CapacityReservationTargetProperty(capacityReservationTarget)
                )
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ec2-launchtemplate-capacityreservationspecification.html#cfn-ec2-launchtemplate-capacityreservationspecification-capacityreservationtarget)
             */
            override fun capacityReservationTarget(): Any? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CapacityReservationSpecificationProperty
            ): software.amazon.awscdk.services.ec2.CfnLaunchTemplate.CapacityReservationSpecificationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface BaselineEbsBandwidthMbpsProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: BaselineEbsBandwidthMbpsProperty
            ): software.amazon.awscdk.services.ec2.CfnLaunchTemplate.BaselineEbsBandwidthMbpsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface MaintenanceOptionsProperty {
        ...
        public interface Builder {
            /**
             * @param autoRecovery Disables the automatic recovery behavior of your instance or sets
             *   it to default.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: MaintenanceOptionsProperty
            ): software.amazon.awscdk.services.ec2.CfnLaunchTemplate.MaintenanceOptionsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface EnaSrdSpecificationProperty {
        ...
        public interface Builder {
            /**
             * @param enaSrdEnabled Indicates whether ENA Express is enabled for the network
             *   interface.
             */
            ...
            public fun enaSrdUdpSpecification(
                enaSrdUdpSpecification: EnaSrdUdpSpecificationProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            /** @param enaSrdUdpSpecification Configures ENA Express for UDP network traffic. */
            override fun enaSrdUdpSpecification(
                enaSrdUdpSpecification: EnaSrdUdpSpecificationProperty
            ) {
                cdkBuilder.enaSrdUdpSpecification(
                    enaSrdUdpSpecification.let(EnaSrdUdpSpecificationProperty::unwrap)
                )
            }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: EnaSrdSpecificationProperty
            ): software.amazon.awscdk.services.ec2.CfnLaunchTemplate.EnaSrdSpecificationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface MonitoringProperty {
        ...
        public interface Builder {
            /**
             * @param enabled Specify `true` to enable detailed monitoring. Otherwise, basic
    ...
    public interface CpuOptionsProperty {
         ...
         *
         * To disable multithreading for the instance, specify a value of `1` . Otherwise, specify
        ...
        public interface Builder {
            /**
             * @param amdSevSnp Indicates whether to enable the instance for AMD SEV-SNP. AMD
             *   SEV-SNP is supported with M6a, R6a, and C6a instance types only. For more
             *   information, see
             *   [AMD SEV-SNP](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/sev-snp.html) .
             */
            ...
            /**
             * @param threadsPerCore The number of threads per CPU core. To disable multithreading
             *   for the instance, specify a value of `1` . Otherwise, specify the default value of
             *   `2` .
             */
    ...
    public interface LaunchTemplateTagSpecificationProperty {
        ...
        public interface Builder {
            /**
             * @param resourceType The type of resource. To tag the launch template, `ResourceType`
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: LaunchTemplateTagSpecificationProperty
            ): software.amazon.awscdk.services.ec2.CfnLaunchTemplate.LaunchTemplateTagSpecificationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface AcceleratorCountProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AcceleratorCountProperty
            ): software.amazon.awscdk.services.ec2.CfnLaunchTemplate.AcceleratorCountProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface Ipv6AddProperty {
        ...
        public interface Builder {
            /**
             * @param ipv6Address One or more specific IPv6 addresses from the IPv6 CIDR block range
             *   of your subnet. You can't use this option if you're specifying a number of IPv6
             *   addresses.
             */
    ...
    public interface LicenseSpecificationProperty {
        ...
        public interface Builder {
            /**
             * @param licenseConfigurationArn The Amazon Resource Name (ARN) of the license
             *   configuration.
             */
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ec2-launchtemplate-licensespecification.html#cfn-ec2-launchtemplate-licensespecification-licenseconfigurationarn)
             */
            override fun licenseConfigurationArn(): String? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: LicenseSpecificationProperty
            ): software.amazon.awscdk.services.ec2.CfnLaunchTemplate.LicenseSpecificationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface PlacementProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param groupId The Group Id of a placement group. You must specify the Placement
             ...
             *   instances. If you specify a host resource group ARN, omit the *Tenancy* parameter
             *   or set it to `host` .
             */
    ...
    public interface BlockDeviceMappingProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param virtualName The virtual device name (ephemeralN). Instance store volumes are
