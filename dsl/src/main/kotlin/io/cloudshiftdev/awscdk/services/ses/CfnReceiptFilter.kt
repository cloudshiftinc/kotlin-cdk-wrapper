...
internal constructor(
    ...
    public interface Builder {
         ...
         *   consists of a name, an IP address range, and whether to allow or block mail from it.
         */
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.ses.CfnReceiptFilter =
            cdkBuilder.build()
    }
    ...
    public interface IpFilterProperty {
         ...
         *
         * An example of a single email address is 10.0.0.1. An example of a range of IP addresses
         * is 10.0.0.1/24. For more information about CIDR notation, see
         * [RFC 2317](https://docs.aws.amazon.com/https://tools.ietf.org/html/rfc2317) .
         *
        ...
        public interface Builder {
            /**
             * @param cidr A single IP address or a range of IP addresses to block or allow,
