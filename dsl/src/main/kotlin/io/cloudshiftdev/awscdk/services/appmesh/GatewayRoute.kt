...
internal constructor(
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.appmesh.GatewayRoute =
            cdkBuilder.build()
    }
    ...
    public companion object {
        public fun fromGatewayRouteArn(
            ...
            software.amazon.awscdk.services.appmesh.GatewayRoute.fromGatewayRouteArn(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    gatewayRouteArn
                )
                .let(IGatewayRoute::wrap)
        ...
        public fun fromGatewayRouteAttributes(
            ...
            software.amazon.awscdk.services.appmesh.GatewayRoute.fromGatewayRouteAttributes(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    attrs.let(GatewayRouteAttributes::unwrap)
                )
                .let(IGatewayRoute::wrap)
        ...
        ): GatewayRoute = GatewayRoute(cdkObject)

        internal fun unwrap(
            wrapped: GatewayRoute
        ): software.amazon.awscdk.services.appmesh.GatewayRoute = wrapped.cdkObject
    }
}
