...
internal constructor(
     ...
     * [io.cloudshiftdev.awscdk.services.cognito.UserPoolIdentityProviderGoogle].
     */
    @CdkDslMarker
    public interface Builder {
         ...
         */
        @Deprecated(message = "deprecated in CDK") public fun clientSecret(clientSecret: String)

        /**
         * The client secret to be accompanied with clientId for Google APIs to authenticate the
         * client as SecretValue.
         *
         * Default: none
         *
         * [Documentation](https://developers.google.com/identity/sign-in/web/sign-in)
         *
         * @param clientSecretValue The client secret to be accompanied with clientId for Google
         *   APIs to authenticate the client as SecretValue.
         */
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.cognito.UserPoolIdentityProviderGoogle.Builder.create(
                scope,
                id
            )
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: UserPoolIdentityProviderGoogle
