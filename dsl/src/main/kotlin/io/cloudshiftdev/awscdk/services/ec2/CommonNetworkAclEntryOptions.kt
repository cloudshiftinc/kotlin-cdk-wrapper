...
public interface CommonNetworkAclEntryOptions {
     ...
     *
     * Any traffic that is not explicitly allowed is automatically denied in a custom ACL, all
     * traffic is automatically allowed in a default ACL.
     *
     * Default: ALLOW
     */
    ...
    public interface Builder {
        ...
        /**
         * @param networkAclEntryName The name of the NetworkAclEntry. It is not recommended to use
         *   an explicit group name.
         */
        public fun networkAclEntryName(networkAclEntryName: String)

        /**
         * @param ruleAction Whether to allow or deny traffic that matches the rule; valid values
         *   are "allow" or "deny". Any traffic that is not explicitly allowed is automatically
         *   denied in a custom ACL, all traffic is automatically allowed in a default ACL.
         */
        public fun ruleAction(ruleAction: Action)

        /**
         * @param ruleNumber Rule number to assign to the entry, such as 100. ACL entries are
         *   processed in ascending order by rule number. Entries can't use the same rule number
         *   unless one is an egress rule and the other is an ingress rule.
         */
    ...
    public companion object {
        ...
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.ec2.CommonNetworkAclEntryOptions
        ): CommonNetworkAclEntryOptions = Wrapper(cdkObject)

        internal fun unwrap(
            wrapped: CommonNetworkAclEntryOptions
