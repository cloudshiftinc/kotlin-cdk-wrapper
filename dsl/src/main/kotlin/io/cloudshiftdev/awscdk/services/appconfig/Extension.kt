...
internal constructor(
    ...
    public override fun actions(): List<Action> =
        unwrap(this).getActions()?.map(Action::wrap) ?: emptyList()
    ...
    private class BuilderImpl(
         ...
         * @param parameters The parameters accepted for the extension.
         */
        override fun parameters(vararg parameters: Parameter): Unit =
    ...
    public companion object {
        public fun fromExtensionArn(
            ...
            software.amazon.awscdk.services.appconfig.Extension.fromExtensionArn(
        ...
        public fun fromExtensionAttributes(
            ...
            software.amazon.awscdk.services.appconfig.Extension.fromExtensionAttributes(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    attrs.let(ExtensionAttributes::unwrap)
                )
                .let(IExtension::wrap)
        ...
        ): Extension = Extension(cdkObject)

        internal fun unwrap(
            wrapped: Extension
        ): software.amazon.awscdk.services.appconfig.Extension = wrapped.cdkObject
    }
}
