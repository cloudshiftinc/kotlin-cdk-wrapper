...
internal constructor(
     ...
     */
    public open fun retainAllVariantProperties(): Any? =
        unwrap(this).getRetainAllVariantProperties()
    ...
    public interface Builder {
         ...
         * account. The name is case-insensitive in `CreateEndpoint` , but the case is preserved and
         * must be matched in
         * [](https://docs.aws.amazon.com/sagemaker/latest/APIReference/API_runtime_InvokeEndpoint.html)
         * .
         *
         ...
         *
         * @param endpointName The name of the endpoint.The name must be unique within an AWS Region
         *   in your AWS account. The name is case-insensitive in `CreateEndpoint` , but the case is
         ...
         * type
         * [VariantProperty](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-sagemaker-endpoint-variantproperty.html)
         * to override with the values provided by `EndpointConfig` . If you don't specify a value
         * for `ExcludeAllVariantProperties` , no variant properties are overridden. Don't use this
         ...
         *   [VariantProperty](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-sagemaker-endpoint-variantproperty.html)
         *   to override with the values provided by `EndpointConfig` . If you don't specify a value
         *   for `ExcludeAllVariantProperties` , no variant properties are overridden. Don't use
         *   this property when creating new endpoint resources or when `RetainAllVariantProperties`
         *   is set to `false` .
         */
         ...
         * `false` . Use this property only when updating endpoint resources, not when creating new
         * endpoint resources.
         *
         ...
         *
         * @param retainAllVariantProperties When updating endpoint resources, enables or disables
         *   the retention of variant properties, such as the instance count or the variant weight.
         */
         ...
         *
         * @param retainDeploymentConfig Specifies whether to reuse the last deployment
         *   configuration.
         */
    ...
    private class BuilderImpl(
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("a541c408e70416a81e50a6f3c53ab0ea85b12aaa791ea908466a2e921fa9fd67")
        override fun deploymentConfig(
            deploymentConfig: DeploymentConfigProperty.Builder.() -> Unit
         ...
         *   is set to `false` .
         */
        override fun excludeRetainedVariantProperties(
            excludeRetainedVariantProperties: IResolvable
        ) {
            cdkBuilder.excludeRetainedVariantProperties(
                excludeRetainedVariantProperties.let(IResolvable::unwrap)
            )
        }
         ...
         */
        override fun excludeRetainedVariantProperties(
            vararg excludeRetainedVariantProperties: Any
        ...
        override fun retainAllVariantProperties(retainAllVariantProperties: IResolvable) {
            cdkBuilder.retainAllVariantProperties(
                retainAllVariantProperties.let(IResolvable::unwrap)
            )
        }
        ...
        public fun build(): software.amazon.awscdk.services.sagemaker.CfnEndpoint =
            cdkBuilder.build()
    }
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnEndpoint
        ): software.amazon.awscdk.services.sagemaker.CfnEndpoint = wrapped.cdkObject
    }
    ...
    public interface BlueGreenUpdatePolicyProperty {
        ...
        public interface Builder {
             ...
             *   Note that the timeout value should be larger than the total waiting time specified
             *   in `TerminationWaitInSeconds` and `WaitIntervalInSeconds` .
             */
            public fun maximumExecutionTimeoutInSeconds(maximumExecutionTimeoutInSeconds: Number)

            /**
             * @param terminationWaitInSeconds Additional waiting time in seconds after the
             *   completion of an endpoint deployment before terminating the old endpoint fleet.
             *   Default is 0.
             */
            public fun terminationWaitInSeconds(terminationWaitInSeconds: Number)

            /**
             * @param trafficRoutingConfiguration Defines the traffic routing strategy to shift
             *   traffic from the old fleet to the new fleet during an endpoint deployment.
             */
            ...
            public fun trafficRoutingConfiguration(
                trafficRoutingConfiguration: TrafficRoutingConfigProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
             ...
             *   in `TerminationWaitInSeconds` and `WaitIntervalInSeconds` .
             */
            override fun maximumExecutionTimeoutInSeconds(
            ...
            override fun trafficRoutingConfiguration(trafficRoutingConfiguration: IResolvable) {
                cdkBuilder.trafficRoutingConfiguration(
                    trafficRoutingConfiguration.let(IResolvable::unwrap)
                )
            }
             ...
             *   traffic from the old fleet to the new fleet during an endpoint deployment.
             */
            override fun trafficRoutingConfiguration(
                trafficRoutingConfiguration: TrafficRoutingConfigProperty
            ) {
                cdkBuilder.trafficRoutingConfiguration(
                    trafficRoutingConfiguration.let(TrafficRoutingConfigProperty::unwrap)
                )
            }
            ...
            override fun trafficRoutingConfiguration(
                ...
                trafficRoutingConfiguration(
                    TrafficRoutingConfigProperty(trafficRoutingConfiguration)
                )
        ...
        internal constructor(
             ...
             * before terminating the old endpoint fleet.
             *
             * Default is 0.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-sagemaker-endpoint-bluegreenupdatepolicy.html#cfn-sagemaker-endpoint-bluegreenupdatepolicy-terminationwaitinseconds)
             */
            override fun terminationWaitInSeconds(): Number? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: BlueGreenUpdatePolicyProperty
            ): software.amazon.awscdk.services.sagemaker.CfnEndpoint.BlueGreenUpdatePolicyProperty =
    ...
    public interface VariantPropertyProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: VariantPropertyProperty
            ): software.amazon.awscdk.services.sagemaker.CfnEndpoint.VariantPropertyProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface RollingUpdatePolicyProperty {
         ...
         *
         * Each rolling step to provision capacity and turn on traffic on the old endpoint fleet,
         * and terminate capacity on the new endpoint fleet. If this field is absent, the default
         * value will be set to 100% of total capacity which means to bring up the whole capacity of
         * the old fleet at once during rollback.
         *
        ...
        public interface Builder {
            /**
             * @param maximumBatchSize Batch size for each rolling step to provision capacity and
             *   turn on traffic on the new endpoint fleet, and terminate capacity on the old
             *   endpoint fleet. Value must be between 5% to 50% of the variant's total instance
             *   count.
             */
             ...
             *   Each rolling step to provision capacity and turn on traffic on the old endpoint
             *   fleet, and terminate capacity on the new endpoint fleet. If this field is absent,
             *   the default value will be set to 100% of total capacity which means to bring up the
            ...
            public fun rollbackMaximumBatchSize(
                rollbackMaximumBatchSize: CapacitySizeProperty.Builder.() -> Unit
            )
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("32b94e7fa10506ddc71461a663ace895c4b842cc406ba48b75d5b58d099d98f6")
            override fun maximumBatchSize(
                maximumBatchSize: CapacitySizeProperty.Builder.() -> Unit
            ): Unit = maximumBatchSize(CapacitySizeProperty(maximumBatchSize))
            ...
            override fun rollbackMaximumBatchSize(rollbackMaximumBatchSize: IResolvable) {
                cdkBuilder.rollbackMaximumBatchSize(
                    rollbackMaximumBatchSize.let(IResolvable::unwrap)
                )
            }
            ...
            override fun rollbackMaximumBatchSize(rollbackMaximumBatchSize: CapacitySizeProperty) {
                cdkBuilder.rollbackMaximumBatchSize(
                    rollbackMaximumBatchSize.let(CapacitySizeProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("eebdbfee6d8c83471bb6ba6753b4e9174787cb4c3e0ce6b798ce75383ee16656")
            override fun rollbackMaximumBatchSize(
                rollbackMaximumBatchSize: CapacitySizeProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             *
             * Each rolling step to provision capacity and turn on traffic on the old endpoint
             * fleet, and terminate capacity on the new endpoint fleet. If this field is absent, the
             * default value will be set to 100% of total capacity which means to bring up the whole
             * capacity of the old fleet at once during rollback.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-sagemaker-endpoint-rollingupdatepolicy.html#cfn-sagemaker-endpoint-rollingupdatepolicy-rollbackmaximumbatchsize)
             */
            override fun rollbackMaximumBatchSize(): Any? =
                unwrap(this).getRollbackMaximumBatchSize()

            /**
             * The length of the baking period, during which SageMaker monitors alarms for each
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RollingUpdatePolicyProperty
            ): software.amazon.awscdk.services.sagemaker.CfnEndpoint.RollingUpdatePolicyProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface TrafficRoutingConfigProperty {
         ...
         *   canary, which is a small portion of the traffic. The second step is the remainder of
         *   the traffic.
        ...
        public interface Builder {
            /**
             * @param canarySize Batch size for the first step to turn on traffic on the new
             *   endpoint fleet. `Value` must be less than or equal to 50% of the variant's total
             *   instance count.
             */
             ...
             *   fleet. `Value` must be 10-50% of the variant's total instance count.
             */
             ...
             * * `ALL_AT_ONCE` : Endpoint traffic shifts to the new fleet in a single step.
             * * `CANARY` : Endpoint traffic shifts to the new fleet in two steps. The first step is
             *   the canary, which is a small portion of the traffic. The second step is the
            ...
            /**
             * @param waitIntervalInSeconds The waiting time (in seconds) between incremental steps
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("6f4e7862c25a4542dca6816d79476a0bfbaf5837819073237189a60f8a763343")
            override fun linearStepSize(
                linearStepSize: CapacitySizeProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TrafficRoutingConfigProperty
            ): software.amazon.awscdk.services.sagemaker.CfnEndpoint.TrafficRoutingConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface AutoRollbackConfigProperty {
        ...
        public interface Builder {
            /**
             * @param alarms List of CloudWatch alarms in your account that are configured to
             *   monitor metrics on an endpoint. If any alarms are tripped during a deployment,
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AutoRollbackConfigProperty
            ): software.amazon.awscdk.services.sagemaker.CfnEndpoint.AutoRollbackConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DeploymentConfigProperty {
         ...
         * while maintaining the old fleet. SageMaker flips traffic to the new fleet according to
         * the specified traffic routing configuration. Only one update policy should be used in the
        ...
        public interface Builder {
            /**
             * @param autoRollbackConfiguration Automatic rollback configuration for handling
             *   endpoint deployment failures and recovery.
             */
            ...
            public fun autoRollbackConfiguration(
                autoRollbackConfiguration: AutoRollbackConfigProperty.Builder.() -> Unit
            )

            /**
             * @param blueGreenUpdatePolicy Update policy for a blue/green deployment. If this
             *   update policy is specified, SageMaker creates a new fleet during the deployment
             *   while maintaining the old fleet. SageMaker flips traffic to the new fleet according
             *   to the specified traffic routing configuration. Only one update policy should be
             *   used in the deployment configuration. If no update policy is specified, SageMaker
             *   uses a blue/green deployment strategy with all at once traffic shifting by default.
             */
            ...
            public fun blueGreenUpdatePolicy(
                blueGreenUpdatePolicy: BlueGreenUpdatePolicyProperty.Builder.() -> Unit
            )

            /**
             * @param rollingUpdatePolicy Specifies a rolling deployment strategy for updating a
             *   SageMaker endpoint.
             */
            ...
            public fun rollingUpdatePolicy(
                rollingUpdatePolicy: RollingUpdatePolicyProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun autoRollbackConfiguration(autoRollbackConfiguration: IResolvable) {
                cdkBuilder.autoRollbackConfiguration(
                    autoRollbackConfiguration.let(IResolvable::unwrap)
                )
            }
            ...
            override fun autoRollbackConfiguration(
                ...
                cdkBuilder.autoRollbackConfiguration(
                    autoRollbackConfiguration.let(AutoRollbackConfigProperty::unwrap)
                )
            }
            ...
            override fun autoRollbackConfiguration(
                ...
                autoRollbackConfiguration(AutoRollbackConfigProperty(autoRollbackConfiguration))
             ...
             *   uses a blue/green deployment strategy with all at once traffic shifting by default.
             */
            override fun blueGreenUpdatePolicy(
                blueGreenUpdatePolicy: BlueGreenUpdatePolicyProperty
            ) {
                cdkBuilder.blueGreenUpdatePolicy(
                    blueGreenUpdatePolicy.let(BlueGreenUpdatePolicyProperty::unwrap)
                )
            }
            ...
            override fun rollingUpdatePolicy(rollingUpdatePolicy: RollingUpdatePolicyProperty) {
                cdkBuilder.rollingUpdatePolicy(
                    rollingUpdatePolicy.let(RollingUpdatePolicyProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("da9c76e6c3ab105d9e15606e840dcdcb00d8103aa17e1b3ca60bd12cd834d2cd")
            override fun rollingUpdatePolicy(
                rollingUpdatePolicy: RollingUpdatePolicyProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-sagemaker-endpoint-deploymentconfig.html#cfn-sagemaker-endpoint-deploymentconfig-autorollbackconfiguration)
             */
            override fun autoRollbackConfiguration(): Any? =
                unwrap(this).getAutoRollbackConfiguration()

            /**
             * Update policy for a blue/green deployment.
             *
             * If this update policy is specified, SageMaker creates a new fleet during the
             * deployment while maintaining the old fleet. SageMaker flips traffic to the new fleet
             * according to the specified traffic routing configuration. Only one update policy
             * should be used in the deployment configuration. If no update policy is specified,
             * SageMaker uses a blue/green deployment strategy with all at once traffic shifting by
             * default.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-sagemaker-endpoint-deploymentconfig.html#cfn-sagemaker-endpoint-deploymentconfig-bluegreenupdatepolicy)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DeploymentConfigProperty
            ): software.amazon.awscdk.services.sagemaker.CfnEndpoint.DeploymentConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
