...
public interface ClientVpnEndpointOptions {
    ...
    public interface Builder {
        /**
         * @param authorizeAllUsersToVpcCidr Whether to authorize all users to the VPC CIDR. This
         *   automatically creates an authorization rule. Set this to `false` and use
         *   `addAuthorizationRule()` to create your own rules instead.
         */
         ...
         *   addresses. The address range cannot overlap with the local CIDR of the VPC in which the
         *   associated subnet is located, or the routes that you add manually.
         *
         * Changing the address range will replace the Client VPN endpoint.
         *
         * The CIDR block should be /22 or greater.
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: ClientVpnEndpointOptions
