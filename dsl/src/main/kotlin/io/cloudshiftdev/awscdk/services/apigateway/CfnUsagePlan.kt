...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param quota The target maximum number of permitted requests per a given unit time
         *   interval.
         */
         ...
         *
         * @param throttle A map containing method level throttling information for API stage in a
         *   usage plan.
         */
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.apigateway.CfnUsagePlan =
            cdkBuilder.build()
    }
    ...
    public interface ThrottleSettingsProperty {
        ...
        public interface Builder {
            /**
             * @param burstLimit The API target request burst rate limit. This allows more requests
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ThrottleSettingsProperty
            ): software.amazon.awscdk.services.apigateway.CfnUsagePlan.ThrottleSettingsProperty =
    ...
    public interface QuotaSettingsProperty {
        ...
        public interface Builder {
            /**
             * @param limit The target maximum number of requests that can be made in a given time
             *   period.
             */
            public fun limit(limit: Number)

            /**
             * @param offset The number of requests subtracted from the given limit in the initial
             *   time period.
             */
            public fun offset(offset: Number)

            /**
             * @param period The time period in which the limit applies. Valid values are "DAY",
             *   "WEEK" or "MONTH".
             */
    ...
    public interface ApiStageProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param throttle Map containing method level throttling information for API stage in a
             *   usage plan.
             */
            public fun throttle(throttle: IResolvable)
