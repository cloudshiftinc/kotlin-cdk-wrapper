...
internal constructor(
    ...
    public open fun detectorModelDefinition(`value`: DetectorModelDefinitionProperty) {
        unwrap(this)
            .setDetectorModelDefinition(`value`.let(DetectorModelDefinitionProperty::unwrap))
    }

    /** Information that defines how a detector operates. */
    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("0be0ab418d81047424da88cf1617c9e3b43e06a7ab4bed9affa7e9e0c4ff8c07")
    public open fun detectorModelDefinition(
        `value`: DetectorModelDefinitionProperty.Builder.() -> Unit
    ): Unit = detectorModelDefinition(DetectorModelDefinitionProperty(`value`))
    ...
    public interface Builder {
        ...
        public fun detectorModelDefinition(
            detectorModelDefinition: DetectorModelDefinitionProperty.Builder.() -> Unit
        )
         ...
         * created. AWS IoT Events can continue to route input to its corresponding detector
         ...
         * detector instance, the device must send a message payload that contains the same
         * attribute-value.
         *
         ...
         *
         * @param roleArn The ARN of the role that grants permission to AWS IoT Events to perform
         *   its operations.
         */
    ...
    private class BuilderImpl(
         ...
         * @param detectorModelDefinition Information that defines how a detector operates.
         */
        override fun detectorModelDefinition(
            detectorModelDefinition: DetectorModelDefinitionProperty
        ) {
            cdkBuilder.detectorModelDefinition(
                detectorModelDefinition.let(DetectorModelDefinitionProperty::unwrap)
            )
        }
    ...
    public interface SetTimerProperty {
         ...
         * duration is 1-31622400 seconds. To ensure accuracy, the minimum duration is 60 seconds.
         ...
         *
         * The minimum value is 60 seconds to ensure accuracy. The maximum value is 31622400
         * seconds.
         *
        ...
        public interface Builder {
             ...
             *   duration. The range of the duration is 1-31622400 seconds. To ensure accuracy, the
             *   minimum duration is 60 seconds. The evaluated result of the duration is rounded
             *   down to the nearest whole number.
             */
            public fun durationExpression(durationExpression: String)

            /**
             * @param seconds The number of seconds until the timer expires. The minimum value is 60
        ...
        internal constructor(
             ...
             * `$variable.&lt;variable-name&gt;` ), and input values (
             * `$input.&lt;input-name&gt;.&lt;path-to-datum&gt;` ) as the duration. The range of the
             * duration is 1-31622400 seconds. To ensure accuracy, the minimum duration is 60
             * seconds. The evaluated result of the duration is rounded down to the nearest whole
             * number.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-iotevents-detectormodel-settimer.html#cfn-iotevents-detectormodel-settimer-durationexpression)
             */
    ...
    public interface TransitionEventProperty {
         ...
         * Required.
         *
         * A Boolean expression that when TRUE causes the actions to be performed and the
        ...
        public interface Builder {
            ...
            /**
             * @param condition Required. A Boolean expression that when TRUE causes the actions to
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TransitionEventProperty
            ): software.amazon.awscdk.services.iotevents.CfnDetectorModel.TransitionEventProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface OnInputProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param transitionEvents Specifies the actions performed, and the next state entered,
    ...
    public interface EventProperty {
         ...
         * present, the actions are performed (=TRUE). If the expression result is not a Boolean
        ...
        public interface Builder {
            ...
            /**
             * @param condition Optional. The Boolean expression that, when TRUE, causes the
             *   `actions` to be performed. If not present, the actions are performed (=TRUE). If
             *   the expression result is not a Boolean value, the actions are not performed
             *   (=FALSE).
             */
            public fun condition(condition: String)
    ...
    public interface StateProperty {
        ...
        public interface Builder {
            /**
             * @param onEnter When entering this state, perform these `actions` if the `condition`
             *   is TRUE.
             */
            ...
            /**
             * @param onExit When exiting this state, perform these `actions` if the specified
             *   `condition` is `TRUE` .
             */
            ...
            /**
             * @param onInput When an input is received and the `condition` is TRUE, perform the
             *   specified `actions` .
             */
    ...
    public interface OnExitProperty {
        ...
        public interface Builder {
            /**
             * @param events Specifies the `actions` that are performed when the state is exited and
    ...
    public interface ActionProperty {
         ...
         * about the detector model instance and the event that triggered the action. You can
         * customize the
        ...
        public interface Builder {
            ...
            /**
             * @param dynamoDBv2 Writes to the DynamoDB table that you created. The default action
             ...
             *   payload that you specify. For more information, see
             *   [Actions](https://docs.aws.amazon.com/iotevents/latest/developerguide/iotevents-event-actions.html)
             *   in *AWS IoT Events Developer Guide* .
             */
            ...
            /**
             * @param dynamoDb Writes to the DynamoDB table that you created. The default action
             *   payload contains all attribute-value pairs that have the information about the
             *   detector model instance and the event that triggered the action. You can customize
             *   the
             *   [payload](https://docs.aws.amazon.com/iotevents/latest/apireference/API_Payload.html)
            ...
            /**
             * @param iotEvents Sends AWS IoT Events input, which passes information about the
    ...
    public interface OnEnterProperty {
        ...
        public interface Builder {
            /**
             * @param events Specifies the actions that are performed when the state is entered and
             *   the `condition` is `TRUE` .
             */
            public fun events(events: IResolvable)
    ...
    public interface DetectorModelDefinitionProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DetectorModelDefinitionProperty
            ): software.amazon.awscdk.services.iotevents.CfnDetectorModel.DetectorModelDefinitionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
