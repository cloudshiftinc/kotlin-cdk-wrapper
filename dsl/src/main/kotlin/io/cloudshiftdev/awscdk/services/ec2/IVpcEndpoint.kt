...
public interface IVpcEndpoint : IResource {
    ...
    internal constructor(
        internal val cdkObject: software.amazon.awscdk.services.ec2.IVpcEndpoint,
    ) : IVpcEndpoint {
        /**
    ...
    public companion object {
        ...
        ): IVpcEndpoint = Wrapper(cdkObject)

        internal fun unwrap(
            wrapped: IVpcEndpoint
        ): software.amazon.awscdk.services.ec2.IVpcEndpoint = (wrapped as Wrapper).cdkObject
    }
}
