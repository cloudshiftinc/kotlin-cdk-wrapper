...
public interface IScalableFunctionAttribute : IConstruct {
  ...
  private class Wrapper internal constructor(
    ...
    public override fun scaleOnSchedule(arg0: String, arg1: ScalingSchedule) {
      unwrap(this).scaleOnSchedule(arg0, arg1.let(ScalingSchedule::unwrap))
    }

    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("0e652746809f3e4412c49544d1500446974784d78cd2e4c1d569436b4931291f")
    public override fun scaleOnSchedule(arg0: String, arg1: ScalingSchedule.Builder.() -> Unit):
        Unit = scaleOnSchedule(arg0, ScalingSchedule(arg1))

    public override fun scaleOnUtilization(arg0: UtilizationScalingOptions) {
      unwrap(this).scaleOnUtilization(arg0.let(UtilizationScalingOptions::unwrap))
    }

    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("fe32b38d4b85bd17fe2b79bbbf0cf909ca5f3e4294d4935b76798b3372d86202")
    public override fun scaleOnUtilization(arg0: UtilizationScalingOptions.Builder.() -> Unit): Unit
