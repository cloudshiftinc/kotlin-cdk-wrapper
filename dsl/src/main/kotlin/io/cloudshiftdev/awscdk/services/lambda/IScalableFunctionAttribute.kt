...
public interface IScalableFunctionAttribute : IConstruct {
    ...
    internal constructor(
         ...
         * Scale out or in to keep utilization at a given level.
         *
         * The utilization is tracked by the LambdaProvisionedConcurrencyUtilization metric, emitted
         * by lambda. See:
         * https://docs.aws.amazon.com/lambda/latest/dg/monitoring-metrics.html#monitoring-metrics-concurrency
         *
         * @param options
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("fe32b38d4b85bd17fe2b79bbbf0cf909ca5f3e4294d4935b76798b3372d86202")
        override fun scaleOnUtilization(
            options: UtilizationScalingOptions.Builder.() -> Unit
        ): Unit = scaleOnUtilization(UtilizationScalingOptions(options))
    }
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: IScalableFunctionAttribute
