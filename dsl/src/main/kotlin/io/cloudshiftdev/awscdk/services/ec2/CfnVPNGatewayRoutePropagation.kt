...
internal constructor(
    ...
    public interface Builder {
         ...
         * The ID of the route table.
         *
         * The routing table must be associated with the same VPC that the virtual private gateway
         * is attached to.
         *
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.ec2.CfnVPNGatewayRoutePropagation.Builder.create(
                scope,
                id
            )
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnVPNGatewayRoutePropagation
