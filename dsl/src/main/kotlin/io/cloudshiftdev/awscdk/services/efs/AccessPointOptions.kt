...
public interface AccessPointOptions {
     ...
     * directory.
     *
     * If the root directory specified by `path` does not exist, EFS creates the root directory and
     * applies the permissions specified here. If the specified `path` does not exist, you must
     * specify `createAcl`.
     *
     ...
     *
     * [Documentation]( - [Enforcing a User Identity Using an Access Point](https://docs.aws.amazon.com/efs/latest/ug/efs-access-points.html))
     */
    ...
    public interface Builder {
        /**
         * @param createAcl Specifies the POSIX IDs and permissions to apply when creating the
         *   access point's root directory. If the root directory specified by `path` does not
         *   exist, EFS creates the root directory and applies the permissions specified here. If
         *   the specified `path` does not exist, you must specify `createAcl`.
         */
        ...
        /**
         * @param posixUser The full POSIX identity, including the user ID, group ID, and any
         *   secondary group IDs, on the access point that is used for all file system operations
         *   performed by NFS clients using the access point. Specify this to enforce a user
         *   identity using an access point.
         */
    ...
    private class BuilderImpl : Builder {
        ...
        public fun build(): software.amazon.awscdk.services.efs.AccessPointOptions =
            cdkBuilder.build()
    }
    ...
    internal constructor(
         ...
         * directory.
         *
         * If the root directory specified by `path` does not exist, EFS creates the root directory
         * and applies the permissions specified here. If the specified `path` does not exist, you
         * must specify `createAcl`.
         *
         * Default: - None. The directory specified by `path` must exist.
         */
        ...
        /**
         * The full POSIX identity, including the user ID, group ID, and any secondary group IDs, on
         * the access point that is used for all file system operations performed by NFS clients
