...
internal constructor(
    ...
    public interface Builder {
        ...
        /**
         * The prefix of the phone number. If provided, it must contain `+` as part of the country
         * code.
         *
         * *Pattern* : `^\\+[0-9]{1,15}`
         *
         ...
         *
         * @param prefix The prefix of the phone number. If provided, it must contain `+` as part of
         *   the country code.
         */
        public fun prefix(prefix: String)

        /**
         * The claimed phone number ARN that was previously imported from the external service, such
         * as Amazon Pinpoint.
         *
         * If it is from Amazon Pinpoint, it looks like the ARN of the phone number that was
         ...
         *
         * @param sourcePhoneNumberArn The claimed phone number ARN that was previously imported
         *   from the external service, such as Amazon Pinpoint.
         */
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.connect.CfnPhoneNumber =
            cdkBuilder.build()
    }
