...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param certificateAuthorityArn The Amazon Resource Name (ARN) of the certificate
         ...
         *
         * @param vpcInformation Information of the VPC and security group(s) used with the
         *   connector.
         */
    ...
    private class BuilderImpl(
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("32df71517c442273d53d51243ad04fe59b3bad74e4a946944099697bd91f110b")
        override fun vpcInformation(
            vpcInformation: VpcInformationProperty.Builder.() -> Unit
    ...
    public interface VpcInformationProperty {
        ...
        public interface Builder {
            /**
             * @param securityGroupIds The security groups used with the connector. You can use a
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: VpcInformationProperty
            ): software.amazon.awscdk.services.pcaconnectorad.CfnConnector.VpcInformationProperty =
