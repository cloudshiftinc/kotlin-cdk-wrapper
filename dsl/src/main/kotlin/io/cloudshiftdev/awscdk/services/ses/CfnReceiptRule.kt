...
internal constructor(
    ...
    public open fun rule(`value`: RuleProperty.Builder.() -> Unit): Unit =
    ...
    public companion object {
        ...
        ): CfnReceiptRule = CfnReceiptRule(cdkObject)

        internal fun unwrap(
            wrapped: CfnReceiptRule
        ): software.amazon.awscdk.services.ses.CfnReceiptRule = wrapped.cdkObject
    }
    ...
    public interface LambdaActionProperty {
         ...
         * immediately results in a response, and a value of `Event` means that the function is
         * invoked asynchronously. The default value is `Event` . For information about AWS Lambda
         * invocation types, see the
        ...
        public interface Builder {
            ...
            /**
             * @param invocationType The invocation type of the AWS Lambda function. An invocation
             ...
             *   the Lambda action is executed. You can find the ARN of a topic by using the
        ...
        internal constructor(
             ...
             * Lambda invocation types, see the
             * [AWS Lambda Developer Guide](https://docs.aws.amazon.com/lambda/latest/dg/API_Invoke.html)
             * .
             *
             * There is a 30-second timeout on `RequestResponse` invocations. You should use `Event`
    ...
    public interface WorkmailActionProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param topicArn The Amazon Resource Name (ARN) of the Amazon SNS topic to notify when
             *   the WorkMail action is called. You can find the ARN of a topic by using the
             *   [ListTopics](https://docs.aws.amazon.com/sns/latest/api/API_ListTopics.html)
             *   operation in Amazon SNS.
             *
             * For more information about Amazon SNS topics, see the
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: WorkmailActionProperty
            ): software.amazon.awscdk.services.ses.CfnReceiptRule.WorkmailActionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface AddHeaderActionProperty {
        ...
        public interface Builder {
            /**
             * @param headerName The name of the header to add to the incoming message. The name
             *   must contain at least one character, and can contain up to 50 characters. It
             *   consists of alphanumeric (a–z, A–Z, 0–9) characters and dashes.
             */
            public fun headerName(headerName: String)

            /**
             * @param headerValue The content to include in the header. This value can contain up to
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AddHeaderActionProperty
            ): software.amazon.awscdk.services.ses.CfnReceiptRule.AddHeaderActionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface S3ActionProperty {
         ...
         * * To use a custom master key that you created in AWS KMS, provide the ARN of the master
         ...
         * your AWS KMS keys for decryption. This encryption client is currently available with the
         * [AWS SDK for Java](https://docs.aws.amazon.com/sdk-for-java/) and
         * [AWS SDK for Ruby](https://docs.aws.amazon.com/sdk-for-ruby/) only. For more information
         * about client-side encryption using AWS KMS master keys, see the
        ...
        public interface Builder {
             ...
             *   emails before saving them to the Amazon S3 bucket. You can use the default master
             *   key or a custom master key that you created in AWS KMS as follows:
             * * To use the default master key, provide an ARN in the form of
             ...
             *   the key.
             * * To use a custom master key that you created in AWS KMS, provide the ARN of the
             *   master key and ensure that you add a statement to your key's policy to give Amazon
             *   SES permission to use it. For more information about giving permissions, see the
             *   [Amazon SES Developer Guide](https://docs.aws.amazon.com/ses/latest/dg/receiving-email-permissions.html)
             *   .
             *
             * For more information about key policies, see the
             ...
             * to use your AWS KMS keys for decryption. This encryption client is currently
             * available with the [AWS SDK for Java](https://docs.aws.amazon.com/sdk-for-java/) and
             * [AWS SDK for Ruby](https://docs.aws.amazon.com/sdk-for-ruby/) only. For more
            ...
            /**
             * @param objectKeyPrefix The key prefix of the Amazon S3 bucket. The key prefix is
             *   similar to a directory name that enables you to store similar data under the same
             *   directory in a bucket.
             */
            public fun objectKeyPrefix(objectKeyPrefix: String)

            /**
             * @param topicArn The ARN of the Amazon SNS topic to notify when the message is saved
             *   to the Amazon S3 bucket. You can find the ARN of a topic by using the
             *   [ListTopics](https://docs.aws.amazon.com/sns/latest/api/API_ListTopics.html)
             *   operation in Amazon SNS.
             *
             * For more information about Amazon SNS topics, see the
        ...
        internal constructor(
             ...
             *
             * You can use the default master key or a custom master key that you created in AWS KMS
             * as follows:
             * * To use the default master key, provide an ARN in the form of
             *   `arn:aws:kms:REGION:ACCOUNT-ID-WITHOUT-HYPHENS:alias/aws/ses` . For example, if
             *   your AWS account ID is 123456789012 and you want to use the default master key in
    ...
    public interface BounceActionProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param topicArn The Amazon Resource Name (ARN) of the Amazon SNS topic to notify when
             *   the bounce action is taken. You can find the ARN of a topic by using the
             *   [ListTopics](https://docs.aws.amazon.com/sns/latest/api/API_ListTopics.html)
             *   operation in Amazon SNS.
             *
             * For more information about Amazon SNS topics, see the
    ...
    public interface RuleProperty {
        ...
        public interface Builder {
             ...
             *   one of the recipient email addresses or domains specified in the receipt rule.
             */
            ...
            /**
             * @param name The name of the receipt rule. The name must meet the following
             *   requirements:.
            ...
            /**
             * @param recipients The recipient domains and email addresses that the receipt rule
             *   applies to. If this field is not specified, this rule matches all recipients on all
             *   verified domains.
             */
            ...
            /**
             * @param scanEnabled If `true` , then messages that this receipt rule applies to are
             ...
             *   delivered over a connection encrypted with Transport Layer Security (TLS). If this
        ...
        private class BuilderImpl : Builder {
             ...
             *   verified domains.
             */
            override fun recipients(vararg recipients: String): Unit =
    ...
    public interface SNSActionProperty {
         ...
         * encoded with a different encoding format. Base64 preserves all special characters. The
        ...
        public interface Builder {
            ...
            /**
             * @param topicArn The Amazon Resource Name (ARN) of the Amazon SNS topic to notify. You
    ...
    public interface StopActionProperty {
        ...
        public interface Builder {
             ...
             *   [ListTopics](https://docs.aws.amazon.com/sns/latest/api/API_ListTopics.html) Amazon
             *   SNS operation.
             *
             * For more information about Amazon SNS topics, see the
             * [Amazon SNS Developer Guide](https://docs.aws.amazon.com/sns/latest/dg/CreateTopic.html)
    ...
    public interface ActionProperty {
        ...
        public interface Builder {
             ...
             *   sender and, optionally, publishes a notification to Amazon Simple Notification
             *   Service (Amazon SNS).
             */
            ...
            /**
             * @param lambdaAction Calls an AWS Lambda function, and optionally, publishes a
            ...
            /**
             * @param s3Action Saves the received message to an Amazon Simple Storage Service
             *   (Amazon S3) bucket and, optionally, publishes a notification to Amazon SNS.
             */
            ...
            /**
             * @param workmailAction Calls Amazon WorkMail and, optionally, publishes a notification
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("9657342d5d725aa7477565fb4f7c62b6b32733c91f8ff2534f2413da365db9d9")
            override fun addHeaderAction(
                addHeaderAction: AddHeaderActionProperty.Builder.() -> Unit
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("2e6da27a29ffc59c66ab95ebaa1a29b810412f3740b2dbd633e4d4201903ad81")
            override fun workmailAction(
                workmailAction: WorkmailActionProperty.Builder.() -> Unit
