...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param certificateArn The ARN of the ACM certificate with which to associate the IAM
         *   role.
         */
    ...
    public companion object {
        ...
        internal fun wrap(
            ...
            CfnEnclaveCertificateIamRoleAssociation(cdkObject)

        internal fun unwrap(
            wrapped: CfnEnclaveCertificateIamRoleAssociation
        ): software.amazon.awscdk.services.ec2.CfnEnclaveCertificateIamRoleAssociation =
            wrapped.cdkObject
    }
}
