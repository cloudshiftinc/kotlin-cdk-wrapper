...
public interface ISecret : IResource {
    ...
    public fun addRotationSchedule(
        id: String,
    ...
    internal constructor(
         ...
         * @param options
         */
        override fun addRotationSchedule(
            id: String,
         ...
         * The ARN of the secret in AWS Secrets Manager.
         *
         * Will return the full ARN if available, otherwise a partial arn. For secrets imported by
         * the deprecated `fromSecretName`, it will return the `secretName`.
         */
         ...
         * Manager-supplied 6-character suffix.
         *
         * This is equal to `secretArn` in most cases, but is undefined when a full ARN is not
         * available (e.g., secrets imported by name).
         */
         ...
         * The name of the secret.
         *
         * For "owned" secrets, this will be the full resource name (secret name + suffix), unless
         * the '&#64;aws-cdk/aws-secretsmanager:parseOwnedSecretName' feature flag is set.
         */
        override fun secretName(): String = unwrap(this).getSecretName()

        /** Retrieve the value of the stored secret as a `SecretValue`. */
        override fun secretValue(): SecretValue =
    ...
    public companion object {
        ...
        ): ISecret = Wrapper(cdkObject)

        internal fun unwrap(
            wrapped: ISecret
        ): software.amazon.awscdk.services.secretsmanager.ISecret = (wrapped as Wrapper).cdkObject
    }
}
