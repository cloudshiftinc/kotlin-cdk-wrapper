...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param healthCheckIntervalSeconds The time—10 seconds or 30 seconds—between health checks
         *   for each endpoint.
         */
         ...
         *
         * @param healthCheckPath If the protocol is HTTP/S, then this value provides the ping path
         *   that Global Accelerator uses for the destination on the endpoints for health checks.
         */
         ...
         *
         * @param healthCheckProtocol The protocol that Global Accelerator uses to perform health
         ...
         * Allows you to override the destination ports used to route traffic to an endpoint.
         *
         * Using a port override lets you map a list of external destination ports (that your users
         * send traffic to) to a list of internal destination ports that you want an application
         ...
         *
         * @param portOverrides Allows you to override the destination ports used to route traffic
         *   to an endpoint.
         */
         ...
         * to unhealthy, or to set an unhealthy endpoint to healthy.
         *
         ...
         *
         * @param thresholdCount The number of consecutive health checks required to set the state
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.globalaccelerator.CfnEndpointGroup.Builder.create(
                scope,
                id
            )
    ...
    public interface PortOverrideProperty {
        ...
        public interface Builder {
             ...
             *   This is the port on the endpoint, such as the Application Load Balancer or Amazon
             *   EC2 instance.
             */
            public fun endpointPort(endpointPort: Number)

            /**
             * @param listenerPort The listener port that you want to map to a specific endpoint
             *   port. This is the port that user traffic arrives to the Global Accelerator on.
             */
    ...
    public interface EndpointConfigurationProperty {
         ...
         */
        public fun clientIpPreservationEnabled(): Any? =
            unwrap(this).getClientIpPreservationEnabled()

        /**
         * An ID for the endpoint.
         *
         * If the endpoint is a Network Load Balancer or Application Load Balancer, this is the
         * Amazon Resource Name (ARN) of the resource. If the endpoint is an Elastic IP address,
         * this is the Elastic IP address allocation ID. For Amazon EC2 instances, this is the EC2
         * instance ID. A resource must be valid and active when you add it as an endpoint.
         *
         ...
         *
         * When you add weights to endpoints, you configure Global Accelerator to route traffic
         * based on proportions that you specify. For example, you might specify endpoint weights of
         * 4, 5, 5, and 6 (sum=20). The result is that 4/20 of your traffic, on average, is routed
         * to the first endpoint, 5/20 is routed both to the second and third endpoints, and 6/20 is
         * routed to the last endpoint. For more information, see
        ...
        public interface Builder {
            /**
             * @param attachmentArn The Amazon Resource Name (ARN) of the cross-account attachment
             *   that specifies the endpoints (resources) that can be added to accelerators and
             *   principals that have permission to add the endpoints to accelerators.
             */
            public fun attachmentArn(attachmentArn: String)

            /**
             * @param clientIpPreservationEnabled Indicates whether client IP address preservation
             *   is enabled for an Application Load Balancer endpoint. The value is true or false.
            ...
            /**
             * @param endpointId An ID for the endpoint. If the endpoint is a Network Load Balancer
             ...
             *   allocation ID. For Amazon EC2 instances, this is the EC2 instance ID. A resource
            ...
            /**
             * @param weight The weight associated with the endpoint. When you add weights to
             *   endpoints, you configure Global Accelerator to route traffic based on proportions
             *   that you specify. For example, you might specify endpoint weights of 4, 5, 5, and 6
             *   (sum=20). The result is that 4/20 of your traffic, on average, is routed to the
             *   first endpoint, 5/20 is routed both to the second and third endpoints, and 6/20 is
             *   routed to the last endpoint. For more information, see
             *   [Endpoint Weights](https://docs.aws.amazon.com/global-accelerator/latest/dg/about-endpoints-endpoint-weights.html)
             *   in the *AWS Global Accelerator Developer Guide* .
             */
        ...
        private class BuilderImpl : Builder {
            ...
            override fun clientIpPreservationEnabled(clientIpPreservationEnabled: IResolvable) {
                cdkBuilder.clientIpPreservationEnabled(
                    clientIpPreservationEnabled.let(IResolvable::unwrap)
                )
            }
        ...
        internal constructor(
             ...
             * If the endpoint is a Network Load Balancer or Application Load Balancer, this is the
             * Amazon Resource Name (ARN) of the resource. If the endpoint is an Elastic IP address,
             * this is the Elastic IP address allocation ID. For Amazon EC2 instances, this is the
             * EC2 instance ID. A resource must be valid and active when you add it as an endpoint.
             *
             * For cross-account endpoints, this must be the ARN of the resource.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-globalaccelerator-endpointgroup-endpointconfiguration.html#cfn-globalaccelerator-endpointgroup-endpointconfiguration-endpointid)
             ...
             *
             * When you add weights to endpoints, you configure Global Accelerator to route traffic
             * based on proportions that you specify. For example, you might specify endpoint
             * weights of 4, 5, 5, and 6 (sum=20). The result is that 4/20 of your traffic, on
             * average, is routed to the first endpoint, 5/20 is routed both to the second and third
             * endpoints, and 6/20 is routed to the last endpoint. For more information, see
             * [Endpoint Weights](https://docs.aws.amazon.com/global-accelerator/latest/dg/about-endpoints-endpoint-weights.html)
             * in the *AWS Global Accelerator Developer Guide* .
             *
             * Default: - 100
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: EndpointConfigurationProperty
            ): software.amazon.awscdk.services.globalaccelerator.CfnEndpointGroup.EndpointConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
