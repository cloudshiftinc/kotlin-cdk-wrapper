...
public interface CustomAttributeConfig {
    ...
    public interface Builder {
         ...
         *   pool attribute that's mapped to an identity provider attribute, you must set this
        ...
        /**
         * @param numberConstraints The constraints for a custom attribute of the 'Number' data
         *   type.
         */
        ...
        public fun numberConstraints(
            numberConstraints: NumberAttributeConstraints.Builder.() -> Unit
        )
        ...
        public fun stringConstraints(
            stringConstraints: StringAttributeConstraints.Builder.() -> Unit
        )
    }
    ...
    private class BuilderImpl : Builder {
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("dc1d50c4781e442cfecd0909e70e85a1efb3a024525c42b606ff1cb3dd1d5dab")
        override fun numberConstraints(
            numberConstraints: NumberAttributeConstraints.Builder.() -> Unit
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("d05d82bd96940c511d159e415cfc197cce046c20e3eb09a0eb49924b42c36577")
        override fun stringConstraints(
            stringConstraints: StringAttributeConstraints.Builder.() -> Unit
    ...
    internal constructor(
         ...
         * your application through an identity provider. If an attribute is immutable, Amazon
