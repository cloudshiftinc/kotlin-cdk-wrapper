...
public interface MetricStatConfig {
     ...
     * Default: []
     */
    public fun dimensions(): List<Dimension> =
    ...
    public interface Builder {
        ...
        /**
         * @param unitFilter Unit used to filter the metric stream. Only refer to datums emitted to
         *   the metric stream with the given unit and ignore all others. Only useful when datums
         *   are being emitted to the same metric stream under different units.
         *
         * This field has been renamed from plain `unit` to clearly communicate its purpose.
         */
    ...
    internal constructor(
         ...
         * Default: []
         */
        override fun dimensions(): List<Dimension> =
            unwrap(this).getDimensions()?.map(Dimension::wrap) ?: emptyList()
