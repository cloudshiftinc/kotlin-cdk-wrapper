...
internal constructor(
    ...
    public open fun jupyterLabAppImageConfig(`value`: JupyterLabAppImageConfigProperty) {
        unwrap(this)
            .setJupyterLabAppImageConfig(`value`.let(JupyterLabAppImageConfigProperty::unwrap))
    }
    ...
    public open fun jupyterLabAppImageConfig(
        `value`: JupyterLabAppImageConfigProperty.Builder.() -> Unit
    ...
    public open fun kernelGatewayImageConfig(`value`: KernelGatewayImageConfigProperty) {
        unwrap(this)
            .setKernelGatewayImageConfig(`value`.let(KernelGatewayImageConfigProperty::unwrap))
    }

    /** The configuration for the file system and kernels in the SageMaker image. */
    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("95f670060a6826c4ddd58e4986bda60e40b9e0d74a4e45ed27746e6e44271f54")
    public open fun kernelGatewayImageConfig(
        `value`: KernelGatewayImageConfigProperty.Builder.() -> Unit
    ...
    public interface Builder {
         ...
         *
         * @param jupyterLabAppImageConfig The configuration for the file system and the runtime,
        ...
        public fun jupyterLabAppImageConfig(
            jupyterLabAppImageConfig: JupyterLabAppImageConfigProperty.Builder.() -> Unit
        )
        ...
        public fun kernelGatewayImageConfig(
            kernelGatewayImageConfig: KernelGatewayImageConfigProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
         ...
         *   such as the environment variables and entry point.
         */
        override fun jupyterLabAppImageConfig(
            jupyterLabAppImageConfig: JupyterLabAppImageConfigProperty
        ) {
            cdkBuilder.jupyterLabAppImageConfig(
                jupyterLabAppImageConfig.let(JupyterLabAppImageConfigProperty::unwrap)
            )
        }
        ...
        override fun jupyterLabAppImageConfig(
            ...
            jupyterLabAppImageConfig(JupyterLabAppImageConfigProperty(jupyterLabAppImageConfig))
         ...
         *   SageMaker image.
         */
        override fun kernelGatewayImageConfig(
            kernelGatewayImageConfig: KernelGatewayImageConfigProperty
        ) {
            cdkBuilder.kernelGatewayImageConfig(
                kernelGatewayImageConfig.let(KernelGatewayImageConfigProperty::unwrap)
            )
        }
        ...
        override fun kernelGatewayImageConfig(
            ...
            kernelGatewayImageConfig(KernelGatewayImageConfigProperty(kernelGatewayImageConfig))
    ...
    public interface JupyterLabAppImageConfigProperty {
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("e1aebf9fe4a21aa96b51896243d92e93f2bcd5d3a552db1c9e582002bc4cd71a")
            override fun containerConfig(
                containerConfig: ContainerConfigProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: JupyterLabAppImageConfigProperty
            ): software.amazon.awscdk.services.sagemaker.CfnAppImageConfig.JupyterLabAppImageConfigProperty =
    ...
    public interface KernelSpecProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param name The name of the Jupyter kernel in the image. This value is case
             *   sensitive.
             */
    ...
    public interface ContainerConfigProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param containerEntrypoint The entrypoint used to run the application in the
             *   container.
             */
            ...
            /**
             * @param containerEnvironmentVariables The environment variables to set in the
             *   container.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            override fun containerEnvironmentVariables(containerEnvironmentVariables: IResolvable) {
                cdkBuilder.containerEnvironmentVariables(
                    containerEnvironmentVariables.let(IResolvable::unwrap)
                )
            }
             ...
             *   container.
             */
            override fun containerEnvironmentVariables(
                vararg containerEnvironmentVariables: Any
            ): Unit = containerEnvironmentVariables(containerEnvironmentVariables.toList())
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ContainerConfigProperty
            ): software.amazon.awscdk.services.sagemaker.CfnAppImageConfig.ContainerConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface KernelGatewayImageConfigProperty {
        ...
        public interface Builder {
            ...
            public fun fileSystemConfig(
                fileSystemConfig: FileSystemConfigProperty.Builder.() -> Unit
            )
        ...
        private class BuilderImpl : Builder {
            ...
            /** @param kernelSpecs The specification of the Jupyter kernels in the image. */
            override fun kernelSpecs(vararg kernelSpecs: Any): Unit =
                kernelSpecs(kernelSpecs.toList())
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: KernelGatewayImageConfigProperty
            ): software.amazon.awscdk.services.sagemaker.CfnAppImageConfig.KernelGatewayImageConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface FileSystemConfigProperty {
        ...
        public interface Builder {
            /**
             * @param defaultGid The default POSIX group ID (GID). If not specified, defaults to
             *   `100` .
             */
            public fun defaultGid(defaultGid: Number)

            /**
             * @param defaultUid The default POSIX user ID (UID). If not specified, defaults to
             *   `1000` .
             */
    ...
    public interface CustomImageContainerEnvironmentVariableProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CustomImageContainerEnvironmentVariableProperty
            ): software.amazon.awscdk.services.sagemaker.CfnAppImageConfig.CustomImageContainerEnvironmentVariableProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
