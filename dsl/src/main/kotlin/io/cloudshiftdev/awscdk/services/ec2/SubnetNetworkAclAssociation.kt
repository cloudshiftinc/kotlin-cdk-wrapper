...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * Default: If you don't specify a SubnetNetworkAclAssociationName, AWS CloudFormation
         * generates a unique physical ID and uses that ID for the group name.
         *
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.ec2.SubnetNetworkAclAssociation.Builder.create(
                scope,
                id
            )
    ...
    public companion object {
        public fun fromSubnetNetworkAclAssociationAssociationId(
            ...
            software.amazon.awscdk.services.ec2.SubnetNetworkAclAssociation
                ...
                .let(ISubnetNetworkAclAssociation::wrap)
        ...
        internal fun unwrap(
            wrapped: SubnetNetworkAclAssociation
