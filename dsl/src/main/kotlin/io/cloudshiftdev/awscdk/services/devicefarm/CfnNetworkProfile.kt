...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.devicefarm.CfnNetworkProfile,
    ...
    public interface Builder {
         ...
         *
         * @param downlinkBandwidthBits The data throughput rate in bits per second, as an integer
         *   from 0 to 104857600.
         */
         ...
         *
         * @param downlinkJitterMs Time variation in the delay of received packets in milliseconds
         ...
         *
         * @param downlinkLossPercent Proportion of received packets that fail to arrive from 0 to
         *   100 percent.
         */
         ...
         *
         * @param uplinkBandwidthBits The data throughput rate in bits per second, as an integer
         *   from 0 to 104857600.
         */
         ...
         *
         * @param uplinkDelayMs Delay time for all packets to destination in milliseconds as an
         *   integer from 0 to 2000.
         */
         ...
         *
         * @param uplinkJitterMs Time variation in the delay of received packets in milliseconds as
         ...
         *
         * @param uplinkLossPercent Proportion of transmitted packets that fail to arrive from 0 to
         *   100 percent.
         */
