...
public interface Inventory {
    ...
    public interface Builder {
        ...
        /**
         * @param includeObjectVersions If the inventory should contain all the object versions or
         *   only the current one.
         */
        public fun includeObjectVersions(includeObjectVersions: InventoryObjectVersion)

        /**
         * @param inventoryId The inventory configuration ID. Should be limited to 64 characters and
    ...
    private class BuilderImpl : Builder {
        ...
        override fun includeObjectVersions(includeObjectVersions: InventoryObjectVersion) {
            cdkBuilder.includeObjectVersions(
                includeObjectVersions.let(InventoryObjectVersion::unwrap)
            )
        }
    ...
    internal constructor(
         ...
         * Default: InventoryFormat.CSV
         */
        override fun format(): InventoryFormat? =
         ...
         * The inventory configuration ID.
         *
         * Should be limited to 64 characters and can only contain letters, numbers, periods,
    ...
    public companion object {
        ...
        internal fun unwrap(wrapped: Inventory): software.amazon.awscdk.services.s3.Inventory =
