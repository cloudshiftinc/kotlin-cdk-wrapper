...
public interface IPipeline : IResource, INotificationRuleSource {
    ...
    internal constructor(
         ...
         * `notifyOnAnyStageStateChange`, `notifyOnAnyActionStateChange` and
         * `notifyOnAnyManualApprovalStateChange` to define rules for these specific event emitted.
         *
         * @param id The id of the CodeStar notification rule.
         * @param target The target to register for the CodeStar Notifications destination.
         * @param options Customization options for CodeStar notification rule.
        ...
        /**
         * Define an notification rule triggered by the set of the "Manual approval" events emitted
         * from this pipeline.
         *
         * [Documentation](https://docs.aws.amazon.com/dtconsole/latest/userguide/concepts.html#events-ref-pipeline)
         *
        ...
        /**
         * Define an notification rule triggered by the set of the "Stage execution" events emitted
         * from this pipeline.
         *
         * [Documentation](https://docs.aws.amazon.com/dtconsole/latest/userguide/concepts.html#events-ref-pipeline)
         *
        ...
        override fun notifyOnAnyStageStateChange(
            ...
            notifyOnAnyStageStateChange(id, target, NotificationRuleOptions(options))

        /**
         * Define an notification rule triggered by the set of the "Pipeline execution" events
         * emitted from this pipeline.
         *
         * [Documentation](https://docs.aws.amazon.com/dtconsole/latest/userguide/concepts.html#events-ref-pipeline)
         *
        ...
        /**
         * Define an event rule triggered by the "CodePipeline Pipeline Execution State Change"
         * event emitted from this pipeline.
         *
         * @param id Identifier for this event handler.
         * @param options Additional options to pass to the event rule.
         */
    ...
    public companion object {
        ...
        ): IPipeline = Wrapper(cdkObject)

        internal fun unwrap(
            wrapped: IPipeline
        ): software.amazon.awscdk.services.codepipeline.IPipeline = (wrapped as Wrapper).cdkObject
    }
}
