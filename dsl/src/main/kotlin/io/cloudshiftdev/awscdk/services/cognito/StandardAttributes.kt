...
public interface StandardAttributes {
     ...
     */
    public fun address(): StandardAttribute? =
     ...
     * Default: - see the defaults under `StandardAttribute`
     */
    public fun website(): StandardAttribute? =
    ...
    public interface Builder {
        ...
        /**
         * @param fullname The user's full name in displayable form, including all name parts,
         *   titles and suffixes.
         */
    ...
    private class BuilderImpl : Builder {
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("bdc2b200152adb09a39b9373a422c21016355d229b2386987fbe4d62df435d21")
        override fun preferredUsername(
            preferredUsername: StandardAttribute.Builder.() -> Unit
    ...
    internal constructor(
         ...
         * Default: - see the defaults under `StandardAttribute`
         */
        override fun email(): StandardAttribute? =
