...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param password The password for the user. This is required so the user can access the
         *   AWS Management Console.
         */
        public fun password(password: SecretValue)

        /**
         * Specifies whether the user is required to set a new password the next time the user logs
         ...
         *   the next time the user logs in to the AWS Management Console.
         */
         ...
         * Reference. If you don't specify a name, AWS CloudFormation generates a unique physical ID
         * and uses that ID for the user name.
         *
    ...
    public companion object {
        ...
        public fun fromUserAttributes(
            ...
            software.amazon.awscdk.services.iam.User.fromUserAttributes(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    attrs.let(UserAttributes::unwrap)
                )
                .let(IUser::wrap)
        ...
        public fun fromUserName(
            ...
            software.amazon.awscdk.services.iam.User.fromUserName(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    userName
                )
        ...
        internal fun wrap(cdkObject: software.amazon.awscdk.services.iam.User): User =
            User(cdkObject)

        internal fun unwrap(wrapped: User): software.amazon.awscdk.services.iam.User =
            wrapped.cdkObject
    }
}
