...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param queryStringBehavior The URL query strings from viewer requests to include in
         *   origin requests.
         */
    ...
    private class BuilderImpl(
        ...
        override fun queryStringBehavior(queryStringBehavior: OriginRequestQueryStringBehavior) {
            cdkBuilder.queryStringBehavior(
                queryStringBehavior.let(OriginRequestQueryStringBehavior::unwrap)
            )
        }
