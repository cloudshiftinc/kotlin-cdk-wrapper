...
internal constructor(
     ...
     *
     * @param pathPattern the path pattern (e.g., 'images/ *') that specifies which requests to
     ...
     * @param props
     */
    public open fun metric401ErrorRate(): Metric =
        unwrap(this).metric401ErrorRate().let(Metric::wrap)
     ...
     * @param props
     */
    public open fun metric403ErrorRate(): Metric =
        unwrap(this).metric403ErrorRate().let(Metric::wrap)
     ...
     * @param props
     */
    public open fun metric404ErrorRate(): Metric =
        unwrap(this).metric404ErrorRate().let(Metric::wrap)
     ...
     * @param props
     */
    public open fun metric4xxErrorRate(): Metric =
        unwrap(this).metric4xxErrorRate().let(Metric::wrap)
     ...
     * @param props
     */
    public open fun metric502ErrorRate(): Metric =
        unwrap(this).metric502ErrorRate().let(Metric::wrap)
     ...
     * @param props
     */
    public open fun metric503ErrorRate(): Metric =
        unwrap(this).metric503ErrorRate().let(Metric::wrap)
     ...
     * @param props
     */
    public open fun metric504ErrorRate(): Metric =
        unwrap(this).metric504ErrorRate().let(Metric::wrap)
     ...
     * @param props
     */
    public open fun metric5xxErrorRate(): Metric =
        unwrap(this).metric5xxErrorRate().let(Metric::wrap)
    ...
    /**
     * Metric for the total number of bytes downloaded by viewers for GET, HEAD, and OPTIONS
     * requests.
     *
     ...
     * @param props
     */
    public open fun metricCacheHitRate(): Metric =
        unwrap(this).metricCacheHitRate().let(Metric::wrap)
    ...
    /**
     * Metric for the total number of viewer requests received by CloudFront, for all HTTP methods
     * and for both HTTP and HTTPS requests.
     *
     * Default: - sum over 5 minutes
     *
     * @param props
    ...
    public interface Builder {
         ...
         * when a viewer requests the root URL for your distribution. If no default object is set,
         * the request goes to the origin's root (e.g., example.com/).
         *
         * Default: - no default root object
         *
         * @param defaultRootObject The object that you want CloudFront to request from your origin
         *   (for example, index.html) when a viewer requests the root URL for your distribution. If
         *   no default object is set, the request goes to the origin's root (e.g., example.com/).
         */
         ...
         * cloudfront.net domain name, you can add an alternate domain name to your distribution. If
         * you attach a certificate to the distribution, you must add (at least one of) the domain
         * names of the certificate to this list.
         *
         ...
         * NOERROR and with no IP addresses. This allows viewers to submit a second request, for an
         * IPv4 address for your distribution.
         *
         * Default: true
         *
         * @param enableIpv6 Whether CloudFront will respond to IPv6 DNS requests with an IPv6
         *   address.
         */
         ...
         *
         * @param errorResponses How CloudFront should handle requests that are not successful
         *   (e.g., PageNotFound).
         */
         ...
         * Default: - no prefix
         *
         * @param logFilePrefix An optional string that you want CloudFront to prefix to the access
         ...
         * Default: false
         *
         * @param logIncludesCookies Specifies whether you want CloudFront to include cookies in
         *   access logs.
         */
         ...
         * '@aws-cdk/aws-cloudfront:defaultSecurityPolicyTLSv1.2_2021' feature flag is set;
         ...
         * latency among the edge locations in your price class.
         *
         * Default: PriceClass.PRICE_CLASS_ALL
         *
         * @param priceClass The price class that corresponds with the maximum price that you want
         *   to pay for CloudFront service.
         */
         ...
         * which a client indicates which hostname it is attempting to connect to at the start of
         * the handshaking process. This allows a server to present multiple certificates on the
         * same IP address and TCP port number and hence allows multiple secure (HTTPS) websites (or
         * any other service over TLS) to be served by the same IP address without requiring all
         * those sites to use the same certificate.
         *
         * CloudFront can use SNI to host multiple distributions on the same IP - which a large
         * majority of clients will support.
         *
         * If your clients cannot support SNI however - CloudFront can use dedicated IPs for your
         * distribution - but there is a prorated monthly charge for using this feature. By default,
         * we use SNI - but you can optionally enable dedicated IPs (VIP).
         *
         ...
         *
         * @param webAclId Unique identifier that specifies the AWS WAF web ACL to associate with
    ...
    private class BuilderImpl(
        ...
        override fun additionalBehaviors(additionalBehaviors: Map<String, BehaviorOptions>) {
            cdkBuilder.additionalBehaviors(
                additionalBehaviors.mapValues { BehaviorOptions.unwrap(it.value) }
            )
        }
        ...
        override fun minimumProtocolVersion(minimumProtocolVersion: SecurityPolicyProtocol) {
            cdkBuilder.minimumProtocolVersion(
                minimumProtocolVersion.let(SecurityPolicyProtocol::unwrap)
            )
        }
        ...
        public fun build(): software.amazon.awscdk.services.cloudfront.Distribution =
            cdkBuilder.build()
    }
    ...
    public companion object {
        public fun fromDistributionAttributes(
            ...
            software.amazon.awscdk.services.cloudfront.Distribution.fromDistributionAttributes(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    attrs.let(DistributionAttributes::unwrap)
                )
                .let(IDistribution::wrap)
