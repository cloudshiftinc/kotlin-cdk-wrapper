...
public enum class BuildEnvironmentVariableType(
    ...
    public companion object {
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.codebuild.BuildEnvironmentVariableType
            ...
            when (cdkObject) {
                ...
                software.amazon.awscdk.services.codebuild.BuildEnvironmentVariableType
                    .PARAMETER_STORE -> BuildEnvironmentVariableType.PARAMETER_STORE
                software.amazon.awscdk.services.codebuild.BuildEnvironmentVariableType
                    .SECRETS_MANAGER -> BuildEnvironmentVariableType.SECRETS_MANAGER
            }

        internal fun unwrap(
            wrapped: BuildEnvironmentVariableType
        ): software.amazon.awscdk.services.codebuild.BuildEnvironmentVariableType =
            wrapped.cdkObject
    }
}
