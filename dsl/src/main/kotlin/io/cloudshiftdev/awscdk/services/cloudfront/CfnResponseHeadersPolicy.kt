...
internal constructor(
    ...
    public open fun responseHeadersPolicyConfig(): Any =
        unwrap(this).getResponseHeadersPolicyConfig()
    ...
    public open fun responseHeadersPolicyConfig(`value`: ResponseHeadersPolicyConfigProperty) {
        unwrap(this)
            .setResponseHeadersPolicyConfig(
                `value`.let(ResponseHeadersPolicyConfigProperty::unwrap)
            )
    }
    ...
    public open fun responseHeadersPolicyConfig(
        `value`: ResponseHeadersPolicyConfigProperty.Builder.() -> Unit
    ...
    public interface Builder {
        ...
        public fun responseHeadersPolicyConfig(
            responseHeadersPolicyConfig: ResponseHeadersPolicyConfigProperty.Builder.() -> Unit
        )
    }
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.cloudfront.CfnResponseHeadersPolicy.Builder.create(
                scope,
                id
            )
        ...
        override fun responseHeadersPolicyConfig(responseHeadersPolicyConfig: IResolvable) {
            cdkBuilder.responseHeadersPolicyConfig(
                responseHeadersPolicyConfig.let(IResolvable::unwrap)
            )
        }
         ...
         * @param responseHeadersPolicyConfig A response headers policy configuration.
         */
        override fun responseHeadersPolicyConfig(
            responseHeadersPolicyConfig: ResponseHeadersPolicyConfigProperty
        ) {
            cdkBuilder.responseHeadersPolicyConfig(
                responseHeadersPolicyConfig.let(ResponseHeadersPolicyConfigProperty::unwrap)
            )
        }
        ...
        override fun responseHeadersPolicyConfig(
            ...
            responseHeadersPolicyConfig(
                ResponseHeadersPolicyConfigProperty(responseHeadersPolicyConfig)
            )
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnResponseHeadersPolicy
    ...
    public interface FrameOptionsProperty {
        ...
        public interface Builder {
            /**
             * @param frameOption The value of the `X-Frame-Options` HTTP response header. Valid
             *   values are `DENY` and `SAMEORIGIN` . For more information about these values, see
             *   [X-Frame-Options](https://docs.aws.amazon.com/https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/X-Frame-Options)
             *   in the MDN Web Docs.
             */
             ...
             *   `X-Frame-Options` HTTP response header received from the origin with the one
    ...
    public interface AccessControlAllowMethodsProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AccessControlAllowMethodsProperty
            ): software.amazon.awscdk.services.cloudfront.CfnResponseHeadersPolicy.AccessControlAllowMethodsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CustomHeaderProperty {
        ...
        /**
         * A Boolean that determines whether CloudFront overrides a response header with the same
         * name received from the origin with the header specified here.
         *
        ...
        public interface Builder {
            ...
            /**
             * @param override A Boolean that determines whether CloudFront overrides a response
             *   header with the same name received from the origin with the header specified here.
             */
            public fun `override`(`override`: Boolean)
    ...
    public interface SecurityHeadersConfigProperty {
        ...
        public interface Builder {
             ...
             *   includes as values for the `Content-Security-Policy` HTTP response header. For more
             *   information about the `Content-Security-Policy` HTTP response header, see
             *   [Content-Security-Policy](https://docs.aws.amazon.com/https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Content-Security-Policy)
             *   in the MDN Web Docs.
             */
            ...
            public fun contentSecurityPolicy(
                contentSecurityPolicy: ContentSecurityPolicyProperty.Builder.() -> Unit
            )

            /**
             * @param contentTypeOptions Determines whether CloudFront includes the
             *   `X-Content-Type-Options` HTTP response header with its value set to `nosniff` . For
             *   more information about the `X-Content-Type-Options` HTTP response header, see
             *   [X-Content-Type-Options](https://docs.aws.amazon.com/https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/X-Content-Type-Options)
             *   in the MDN Web Docs.
             */
            ...
            public fun contentTypeOptions(
                contentTypeOptions: ContentTypeOptionsProperty.Builder.() -> Unit
            )
             ...
             *   `X-Frame-Options` HTTP response header, see
             *   [X-Frame-Options](https://docs.aws.amazon.com/https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/X-Frame-Options)
             *   in the MDN Web Docs.
             */
            ...
            /**
             * @param referrerPolicy Determines whether CloudFront includes the `Referrer-Policy`
             *   HTTP response header and the header's value. For more information about the
             *   `Referrer-Policy` HTTP response header, see
             *   [Referrer-Policy](https://docs.aws.amazon.com/https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Referrer-Policy)
             *   in the MDN Web Docs.
             */
            ...
            public fun strictTransportSecurity(
                strictTransportSecurity: StrictTransportSecurityProperty.Builder.() -> Unit
            )

            /**
             * @param xssProtection Determines whether CloudFront includes the `X-XSS-Protection`
             *   HTTP response header and the header's value. For more information about the
             *   `X-XSS-Protection` HTTP response header, see
             *   [X-XSS-Protection](https://docs.aws.amazon.com/https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/X-XSS-Protection)
             *   in the MDN Web Docs.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            override fun contentSecurityPolicy(
                ...
                cdkBuilder.contentSecurityPolicy(
                    contentSecurityPolicy.let(ContentSecurityPolicyProperty::unwrap)
                )
            }
            ...
            override fun contentTypeOptions(contentTypeOptions: ContentTypeOptionsProperty) {
                cdkBuilder.contentTypeOptions(
                    contentTypeOptions.let(ContentTypeOptionsProperty::unwrap)
                )
            }
            ...
            override fun referrerPolicy(
                referrerPolicy: ReferrerPolicyProperty.Builder.() -> Unit
            ...
            override fun strictTransportSecurity(
                ...
                cdkBuilder.strictTransportSecurity(
                    strictTransportSecurity.let(StrictTransportSecurityProperty::unwrap)
                )
            }
            ...
            override fun strictTransportSecurity(
                ...
                strictTransportSecurity(StrictTransportSecurityProperty(strictTransportSecurity))
            ...
            override fun xssProtection(
                xssProtection: XSSProtectionProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SecurityHeadersConfigProperty
            ): software.amazon.awscdk.services.cloudfront.CfnResponseHeadersPolicy.SecurityHeadersConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ReferrerPolicyProperty {
        ...
        public interface Builder {
            /**
             * @param override A Boolean that determines whether CloudFront overrides the
             *   `Referrer-Policy` HTTP response header received from the origin with the one
             *   specified in this response headers policy.
             */
            public fun `override`(`override`: Boolean)
            ...
            /**
             * @param referrerPolicy The value of the `Referrer-Policy` HTTP response header. Valid
             *   values are:.
             * * `no-referrer`
             * * `no-referrer-when-downgrade`
             * * `origin`
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ReferrerPolicyProperty
            ): software.amazon.awscdk.services.cloudfront.CfnResponseHeadersPolicy.ReferrerPolicyProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface AccessControlAllowOriginsProperty {
        ...
        public interface Builder {
            /**
             * @param items The list of origins (domain names). You can specify `*` to allow all
             *   origins.
             */
            public fun items(items: List<String>)
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AccessControlAllowOriginsProperty
            ): software.amazon.awscdk.services.cloudfront.CfnResponseHeadersPolicy.AccessControlAllowOriginsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ResponseHeadersPolicyConfigProperty {
        ...
        public interface Builder {
            /**
             * @param comment A comment to describe the response headers policy. The comment cannot
             *   be longer than 128 characters.
             */
            public fun comment(comment: String)

            /**
             * @param corsConfig A configuration for a set of HTTP response headers that are used
            ...
            public fun customHeadersConfig(
                customHeadersConfig: CustomHeadersConfigProperty.Builder.() -> Unit
            )

            /**
             * @param name A name to identify the response headers policy. The name must be unique
             *   for response headers policies in this AWS account .
             */
            public fun name(name: String)

            /**
             * @param removeHeadersConfig A configuration for a set of HTTP headers to remove from
             *   the HTTP response.
             */
            ...
            public fun removeHeadersConfig(
                removeHeadersConfig: RemoveHeadersConfigProperty.Builder.() -> Unit
            )
            ...
            public fun securityHeadersConfig(
                securityHeadersConfig: SecurityHeadersConfigProperty.Builder.() -> Unit
            )

            /**
             * @param serverTimingHeadersConfig A configuration for enabling the `Server-Timing`
            ...
            public fun serverTimingHeadersConfig(
                serverTimingHeadersConfig: ServerTimingHeadersConfigProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            override fun customHeadersConfig(customHeadersConfig: CustomHeadersConfigProperty) {
                cdkBuilder.customHeadersConfig(
                    customHeadersConfig.let(CustomHeadersConfigProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("f939a3337362614a1fa52773bdecf03e5e8f12aeb6872e583c00f92c0a70e1a0")
            override fun customHeadersConfig(
                customHeadersConfig: CustomHeadersConfigProperty.Builder.() -> Unit
            ...
            override fun removeHeadersConfig(removeHeadersConfig: RemoveHeadersConfigProperty) {
                cdkBuilder.removeHeadersConfig(
                    removeHeadersConfig.let(RemoveHeadersConfigProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("b9f027ac414d9aa7f3a962ec1e494f1d195c397f2bd170517c9309f84218568d")
            override fun removeHeadersConfig(
                removeHeadersConfig: RemoveHeadersConfigProperty.Builder.() -> Unit
             ...
             *   response headers.
             */
            override fun securityHeadersConfig(
                securityHeadersConfig: SecurityHeadersConfigProperty
            ) {
                cdkBuilder.securityHeadersConfig(
                    securityHeadersConfig.let(SecurityHeadersConfigProperty::unwrap)
                )
            }
            ...
            override fun serverTimingHeadersConfig(serverTimingHeadersConfig: IResolvable) {
                cdkBuilder.serverTimingHeadersConfig(
                    serverTimingHeadersConfig.let(IResolvable::unwrap)
                )
            }
             ...
             *   header in HTTP responses sent from CloudFront.
             */
            override fun serverTimingHeadersConfig(
                serverTimingHeadersConfig: ServerTimingHeadersConfigProperty
            ) {
                cdkBuilder.serverTimingHeadersConfig(
                    serverTimingHeadersConfig.let(ServerTimingHeadersConfigProperty::unwrap)
                )
            }
            ...
            override fun serverTimingHeadersConfig(
                ...
                serverTimingHeadersConfig(
                    ServerTimingHeadersConfigProperty(serverTimingHeadersConfig)
                )
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-cloudfront-responseheaderspolicy-responseheaderspolicyconfig.html#cfn-cloudfront-responseheaderspolicy-responseheaderspolicyconfig-servertimingheadersconfig)
             */
            override fun serverTimingHeadersConfig(): Any? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ResponseHeadersPolicyConfigProperty
            ): software.amazon.awscdk.services.cloudfront.CfnResponseHeadersPolicy.ResponseHeadersPolicyConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ServerTimingHeadersConfigProperty {
         ...
         * HTTP response for every request that matches the cache behavior that this response
         * headers policy is attached to. When you set it to 50, CloudFront adds the header to 50%
         * of the responses for requests that match the cache behavior. You can set the sampling
        ...
        public interface Builder {
            /**
             * @param enabled A Boolean that determines whether CloudFront adds the `Server-Timing`
             *   header to HTTP responses that it sends in response to requests that match a cache
            ...
            /**
             * @param samplingRate A number 0–100 (inclusive) that specifies the percentage of
             *   responses that you want CloudFront to add the `Server-Timing` header to. When you
             *   set the sampling rate to 100, CloudFront adds the `Server-Timing` header to the
             *   HTTP response for every request that matches the cache behavior that this response
             *   headers policy is attached to. When you set it to 50, CloudFront adds the header to
             *   50% of the responses for requests that match the cache behavior. You can set the
        ...
        internal constructor(
             ...
             * CloudFront to add the `Server-Timing` header to.
             *
             * When you set the sampling rate to 100, CloudFront adds the `Server-Timing` header to
             * the HTTP response for every request that matches the cache behavior that this
             * response headers policy is attached to. When you set it to 50, CloudFront adds the
             * header to 50% of the responses for requests that match the cache behavior. You can
             * set the sampling rate to any number 0–100 with up to four decimal places.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-cloudfront-responseheaderspolicy-servertimingheadersconfig.html#cfn-cloudfront-responseheaderspolicy-servertimingheadersconfig-samplingrate)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ServerTimingHeadersConfigProperty
            ): software.amazon.awscdk.services.cloudfront.CfnResponseHeadersPolicy.ServerTimingHeadersConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface StrictTransportSecurityProperty {
        ...
        public interface Builder {
             ...
             *   `max-age` directive in the `Strict-Transport-Security` HTTP response header.
             */
             ...
             *   `includeSubDomains` directive in the `Strict-Transport-Security` HTTP response
             *   header.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: StrictTransportSecurityProperty
            ): software.amazon.awscdk.services.cloudfront.CfnResponseHeadersPolicy.StrictTransportSecurityProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CorsConfigProperty {
         ...
         *
         * For more information about the `Access-Control-Allow-Credentials` HTTP response header,
         * see
        ...
        public interface Builder {
            /**
             * @param accessControlAllowCredentials A Boolean that CloudFront uses as the value for
             *   the `Access-Control-Allow-Credentials` HTTP response header. For more information
            ...
            /**
             * @param accessControlAllowHeaders A list of HTTP header names that CloudFront includes
             *   as values for the `Access-Control-Allow-Headers` HTTP response header. For more
             *   information about the `Access-Control-Allow-Headers` HTTP response header, see
             *   [Access-Control-Allow-Headers](https://docs.aws.amazon.com/https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Access-Control-Allow-Headers)
             *   in the MDN Web Docs.
             */
            ...
            public fun accessControlAllowHeaders(
                accessControlAllowHeaders: AccessControlAllowHeadersProperty.Builder.() -> Unit
            )

            /**
             * @param accessControlAllowMethods A list of HTTP methods that CloudFront includes as
             *   values for the `Access-Control-Allow-Methods` HTTP response header. For more
             *   information about the `Access-Control-Allow-Methods` HTTP response header, see
             *   [Access-Control-Allow-Methods](https://docs.aws.amazon.com/https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Access-Control-Allow-Methods)
             *   in the MDN Web Docs.
             */
            ...
            public fun accessControlAllowMethods(
                accessControlAllowMethods: AccessControlAllowMethodsProperty.Builder.() -> Unit
            )

            /**
             * @param accessControlAllowOrigins A list of origins (domain names) that CloudFront can
             *   use as the value for the `Access-Control-Allow-Origin` HTTP response header. For
             *   more information about the `Access-Control-Allow-Origin` HTTP response header, see
             *   [Access-Control-Allow-Origin](https://docs.aws.amazon.com/https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Access-Control-Allow-Origin)
             *   in the MDN Web Docs.
             */
            ...
            public fun accessControlAllowOrigins(
                accessControlAllowOrigins: AccessControlAllowOriginsProperty.Builder.() -> Unit
            )

            /**
             * @param accessControlExposeHeaders A list of HTTP headers that CloudFront includes as
             *   values for the `Access-Control-Expose-Headers` HTTP response header. For more
             *   information about the `Access-Control-Expose-Headers` HTTP response header, see
             *   [Access-Control-Expose-Headers](https://docs.aws.amazon.com/https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Access-Control-Expose-Headers)
             *   in the MDN Web Docs.
             */
            ...
            public fun accessControlExposeHeaders(
                accessControlExposeHeaders: AccessControlExposeHeadersProperty.Builder.() -> Unit
            )
            ...
            /**
             * @param originOverride A Boolean that determines whether CloudFront overrides HTTP
             *   response headers received from the origin with the ones specified in this response
             *   headers policy.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            override fun accessControlAllowCredentials(accessControlAllowCredentials: IResolvable) {
                cdkBuilder.accessControlAllowCredentials(
                    accessControlAllowCredentials.let(IResolvable::unwrap)
                )
            }
            ...
            override fun accessControlAllowHeaders(accessControlAllowHeaders: IResolvable) {
                cdkBuilder.accessControlAllowHeaders(
                    accessControlAllowHeaders.let(IResolvable::unwrap)
                )
            }
             ...
             *   in the MDN Web Docs.
             */
            override fun accessControlAllowHeaders(
                accessControlAllowHeaders: AccessControlAllowHeadersProperty
            ) {
                cdkBuilder.accessControlAllowHeaders(
                    accessControlAllowHeaders.let(AccessControlAllowHeadersProperty::unwrap)
                )
            }
            ...
            override fun accessControlAllowHeaders(
                ...
                accessControlAllowHeaders(
                    AccessControlAllowHeadersProperty(accessControlAllowHeaders)
                )
            ...
            override fun accessControlAllowMethods(accessControlAllowMethods: IResolvable) {
                cdkBuilder.accessControlAllowMethods(
                    accessControlAllowMethods.let(IResolvable::unwrap)
                )
            }
             ...
             *   in the MDN Web Docs.
             */
            override fun accessControlAllowMethods(
                accessControlAllowMethods: AccessControlAllowMethodsProperty
            ) {
                cdkBuilder.accessControlAllowMethods(
                    accessControlAllowMethods.let(AccessControlAllowMethodsProperty::unwrap)
                )
            }
            ...
            override fun accessControlAllowMethods(
                ...
                accessControlAllowMethods(
                    AccessControlAllowMethodsProperty(accessControlAllowMethods)
                )
            ...
            override fun accessControlAllowOrigins(accessControlAllowOrigins: IResolvable) {
                cdkBuilder.accessControlAllowOrigins(
                    accessControlAllowOrigins.let(IResolvable::unwrap)
                )
            }
             ...
             *   in the MDN Web Docs.
             */
            override fun accessControlAllowOrigins(
                accessControlAllowOrigins: AccessControlAllowOriginsProperty
            ) {
                cdkBuilder.accessControlAllowOrigins(
                    accessControlAllowOrigins.let(AccessControlAllowOriginsProperty::unwrap)
                )
            }
            ...
            override fun accessControlAllowOrigins(
                ...
                accessControlAllowOrigins(
                    AccessControlAllowOriginsProperty(accessControlAllowOrigins)
                )
            ...
            override fun accessControlExposeHeaders(accessControlExposeHeaders: IResolvable) {
                cdkBuilder.accessControlExposeHeaders(
                    accessControlExposeHeaders.let(IResolvable::unwrap)
                )
            }
             ...
             *   in the MDN Web Docs.
             */
            override fun accessControlExposeHeaders(
                accessControlExposeHeaders: AccessControlExposeHeadersProperty
            ) {
                cdkBuilder.accessControlExposeHeaders(
                    accessControlExposeHeaders.let(AccessControlExposeHeadersProperty::unwrap)
                )
            }
            ...
            override fun accessControlExposeHeaders(
                ...
                accessControlExposeHeaders(
                    AccessControlExposeHeadersProperty(accessControlExposeHeaders)
                )
        ...
        internal constructor(
             ...
             * `Access-Control-Allow-Headers` HTTP response header.
             *
             * For more information about the `Access-Control-Allow-Headers` HTTP response header,
             * see
             * [Access-Control-Allow-Headers](https://docs.aws.amazon.com/https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Access-Control-Allow-Headers)
             * in the MDN Web Docs.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-cloudfront-responseheaderspolicy-corsconfig.html#cfn-cloudfront-responseheaderspolicy-corsconfig-accesscontrolallowheaders)
             */
            override fun accessControlAllowHeaders(): Any =
             ...
             * `Access-Control-Allow-Methods` HTTP response header.
             *
             * For more information about the `Access-Control-Allow-Methods` HTTP response header,
             * see
             * [Access-Control-Allow-Methods](https://docs.aws.amazon.com/https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Access-Control-Allow-Methods)
             * in the MDN Web Docs.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-cloudfront-responseheaderspolicy-corsconfig.html#cfn-cloudfront-responseheaderspolicy-corsconfig-accesscontrolallowmethods)
             */
            override fun accessControlAllowMethods(): Any =
             ...
             * `Access-Control-Allow-Origin` HTTP response header.
             *
             * For more information about the `Access-Control-Allow-Origin` HTTP response header,
             * see
             * [Access-Control-Allow-Origin](https://docs.aws.amazon.com/https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Access-Control-Allow-Origin)
             * in the MDN Web Docs.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-cloudfront-responseheaderspolicy-corsconfig.html#cfn-cloudfront-responseheaderspolicy-corsconfig-accesscontrolalloworigins)
             */
            override fun accessControlAllowOrigins(): Any =
             ...
             * `Access-Control-Expose-Headers` HTTP response header.
             *
             * For more information about the `Access-Control-Expose-Headers` HTTP response header,
             * see
             * [Access-Control-Expose-Headers](https://docs.aws.amazon.com/https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Access-Control-Expose-Headers)
             * in the MDN Web Docs.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-cloudfront-responseheaderspolicy-corsconfig.html#cfn-cloudfront-responseheaderspolicy-corsconfig-accesscontrolexposeheaders)
             */
            override fun accessControlExposeHeaders(): Any? =
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-cloudfront-responseheaderspolicy-corsconfig.html#cfn-cloudfront-responseheaderspolicy-corsconfig-accesscontrolmaxagesec)
             */
            override fun accessControlMaxAgeSec(): Number? =
    ...
    public interface CustomHeadersConfigProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CustomHeadersConfigProperty
            ): software.amazon.awscdk.services.cloudfront.CfnResponseHeadersPolicy.CustomHeadersConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface RemoveHeadersConfigProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RemoveHeadersConfigProperty
            ): software.amazon.awscdk.services.cloudfront.CfnResponseHeadersPolicy.RemoveHeadersConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ContentSecurityPolicyProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ContentSecurityPolicyProperty
            ): software.amazon.awscdk.services.cloudfront.CfnResponseHeadersPolicy.ContentSecurityPolicyProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface AccessControlAllowHeadersProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AccessControlAllowHeadersProperty
            ): software.amazon.awscdk.services.cloudfront.CfnResponseHeadersPolicy.AccessControlAllowHeadersProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface AccessControlExposeHeadersProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AccessControlExposeHeadersProperty
            ): software.amazon.awscdk.services.cloudfront.CfnResponseHeadersPolicy.AccessControlExposeHeadersProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface XSSProtectionProperty {
         ...
         *
         * When this setting is `true` , the value of the `X-XSS-Protection` header is `1` . When
        ...
        public interface Builder {
            /**
             * @param modeBlock A Boolean that determines whether CloudFront includes the
             *   `mode=block` directive in the `X-XSS-Protection` header. For more information about
             *   this directive, see
             *   [X-XSS-Protection](https://docs.aws.amazon.com/https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/X-XSS-Protection)
             *   in the MDN Web Docs.
             */
            ...
            /**
             * @param override A Boolean that determines whether CloudFront overrides the
             *   `X-XSS-Protection` HTTP response header received from the origin with the one
             *   specified in this response headers policy.
             */
            public fun `override`(`override`: Boolean)
             ...
             *   response header. When this setting is `true` , the value of the `X-XSS-Protection`
        ...
        internal constructor(
            ...
            /**
             * A Boolean that determines whether CloudFront includes the `mode=block` directive in
    ...
    public interface ContentTypeOptionsProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ContentTypeOptionsProperty
            ): software.amazon.awscdk.services.cloudfront.CfnResponseHeadersPolicy.ContentTypeOptionsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
