...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * *Principals* : A list of string ARNs for the roles and users you want to grant access to
         * the profiling group. Wildcards are not supported in the ARNs. You are allowed to provide
         * up to 50 ARNs. An empty list is not permitted. This is a required key.
         *
         ...
         *
         * @param anomalyDetectionNotificationConfiguration Adds anomaly notifications for a
         *   profiling group.
         */
        public fun anomalyDetectionNotificationConfiguration(
            anomalyDetectionNotificationConfiguration: IResolvable
        )
         ...
         */
        public fun anomalyDetectionNotificationConfiguration(
            anomalyDetectionNotificationConfiguration: List<Any>
        )
         ...
         * runs on a compute platform that is not AWS Lambda , such an Amazon EC2 instance, an
         * on-premises server, or a different platform. If not specified, `Default` is used. This
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.codeguruprofiler.CfnProfilingGroup.Builder.create(
                scope,
                id
            )
         ...
         *   profiling group.
         */
        override fun anomalyDetectionNotificationConfiguration(
            anomalyDetectionNotificationConfiguration: IResolvable
        ) {
            cdkBuilder.anomalyDetectionNotificationConfiguration(
                anomalyDetectionNotificationConfiguration.let(IResolvable::unwrap)
            )
        }
        ...
        override fun anomalyDetectionNotificationConfiguration(
            ...
            anomalyDetectionNotificationConfiguration(
                anomalyDetectionNotificationConfiguration.toList()
            )
    ...
    public interface AgentPermissionsProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AgentPermissionsProperty
            ): software.amazon.awscdk.services.codeguruprofiler.CfnProfilingGroup.AgentPermissionsProperty =
