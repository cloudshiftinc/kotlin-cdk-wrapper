...
public interface IEc2TaskDefinition : ITaskDefinition {
    ...
    internal constructor(
        internal val cdkObject: software.amazon.awscdk.services.ecs.IEc2TaskDefinition,
    ) : IEc2TaskDefinition {
        /**
    ...
    public companion object {
        ...
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.ecs.IEc2TaskDefinition
        ): IEc2TaskDefinition = Wrapper(cdkObject)

        internal fun unwrap(
            wrapped: IEc2TaskDefinition
        ): software.amazon.awscdk.services.ecs.IEc2TaskDefinition = (wrapped as Wrapper).cdkObject
    }
}
