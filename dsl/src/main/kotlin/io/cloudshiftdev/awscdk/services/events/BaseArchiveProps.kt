...
public interface BaseArchiveProps {
    ...
    public interface Builder {
        ...
        /**
         * @param retention The number of days to retain events for. Default value is 0. If set to
    ...
    private class BuilderImpl : Builder {
        ...
        public fun build(): software.amazon.awscdk.services.events.BaseArchiveProps =
            cdkBuilder.build()
    }
