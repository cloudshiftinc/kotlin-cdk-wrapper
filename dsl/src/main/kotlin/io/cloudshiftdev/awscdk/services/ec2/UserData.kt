...
internal constructor(
    ...
    public companion object {
        ...
        public fun forLinux(options: LinuxUserDataOptions): UserData =
            software.amazon.awscdk.services.ec2.UserData.forLinux(
                    options.let(LinuxUserDataOptions::unwrap)
                )
                .let(UserData::wrap)
        ...
        public fun forOperatingSystem(os: OperatingSystemType): UserData =
            software.amazon.awscdk.services.ec2.UserData.forOperatingSystem(
        ...
        public fun forWindows(options: WindowsUserDataOptions): UserData =
            software.amazon.awscdk.services.ec2.UserData.forWindows(
                    options.let(WindowsUserDataOptions::unwrap)
                )
                .let(UserData::wrap)
        ...
        internal fun unwrap(wrapped: UserData): software.amazon.awscdk.services.ec2.UserData =
