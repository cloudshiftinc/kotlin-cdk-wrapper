...
internal constructor(
    ...
    public open fun loRaWanUpdateGatewayTaskEntry(`value`: LoRaWANUpdateGatewayTaskEntryProperty) {
        unwrap(this)
            .setLoRaWanUpdateGatewayTaskEntry(
                `value`.let(LoRaWANUpdateGatewayTaskEntryProperty::unwrap)
            )
    }
    ...
    public open fun loRaWanUpdateGatewayTaskEntry(
        `value`: LoRaWANUpdateGatewayTaskEntryProperty.Builder.() -> Unit
    ...
    public open fun update(
        `value`: UpdateWirelessGatewayTaskCreateProperty.Builder.() -> Unit
    ): Unit = update(UpdateWirelessGatewayTaskCreateProperty(`value`))
    ...
    public interface Builder {
         ...
         *
         * @param autoCreateTasks Whether to automatically create tasks using this task definition
        ...
        public fun loRaWanUpdateGatewayTaskEntry(
            loRaWanUpdateGatewayTaskEntry: LoRaWANUpdateGatewayTaskEntryProperty.Builder.() -> Unit
        )
         ...
         *
         * @param taskDefinitionType A filter to list only the wireless gateway task definitions
    ...
    private class BuilderImpl(
        ...
        override fun loRaWanUpdateGatewayTaskEntry(loRaWanUpdateGatewayTaskEntry: IResolvable) {
            cdkBuilder.loRaWanUpdateGatewayTaskEntry(
                loRaWanUpdateGatewayTaskEntry.let(IResolvable::unwrap)
            )
        }
         ...
         * @param loRaWanUpdateGatewayTaskEntry LoRaWANUpdateGatewayTaskEntry object.
         */
        override fun loRaWanUpdateGatewayTaskEntry(
            loRaWanUpdateGatewayTaskEntry: LoRaWANUpdateGatewayTaskEntryProperty
        ) {
            cdkBuilder.loRaWanUpdateGatewayTaskEntry(
                loRaWanUpdateGatewayTaskEntry.let(LoRaWANUpdateGatewayTaskEntryProperty::unwrap)
            )
        }
        ...
        override fun loRaWanUpdateGatewayTaskEntry(
            ...
            loRaWanUpdateGatewayTaskEntry(
                LoRaWANUpdateGatewayTaskEntryProperty(loRaWanUpdateGatewayTaskEntry)
            )
        ...
        @JvmName("59d42d697f4c628bcaabb093931b235aaafcd93e189237d78bc134273c295dc2")
        override fun update(
            update: UpdateWirelessGatewayTaskCreateProperty.Builder.() -> Unit
    ...
    public interface UpdateWirelessGatewayTaskCreateProperty {
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("c9e1b2e9bb716c698778bb5a59a337f75a51f4015d1aee0f4516f361f7795069")
            override fun loRaWan(
                loRaWan: LoRaWANUpdateGatewayTaskCreateProperty.Builder.() -> Unit
            ): Unit = loRaWan(LoRaWANUpdateGatewayTaskCreateProperty(loRaWan))
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: UpdateWirelessGatewayTaskCreateProperty
            ): software.amazon.awscdk.services.iotwireless.CfnTaskDefinition.UpdateWirelessGatewayTaskCreateProperty =
    ...
    public interface LoRaWANUpdateGatewayTaskCreateProperty {
        ...
        public interface Builder {
            ...
            public fun currentVersion(
                currentVersion: LoRaWANGatewayVersionProperty.Builder.() -> Unit
            )
            ...
            public fun updateVersion(
                updateVersion: LoRaWANGatewayVersionProperty.Builder.() -> Unit
            )
        }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: LoRaWANUpdateGatewayTaskCreateProperty
            ): software.amazon.awscdk.services.iotwireless.CfnTaskDefinition.LoRaWANUpdateGatewayTaskCreateProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface LoRaWANUpdateGatewayTaskEntryProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: LoRaWANUpdateGatewayTaskEntryProperty
            ): software.amazon.awscdk.services.iotwireless.CfnTaskDefinition.LoRaWANUpdateGatewayTaskEntryProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface LoRaWANGatewayVersionProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: LoRaWANGatewayVersionProperty
            ): software.amazon.awscdk.services.iotwireless.CfnTaskDefinition.LoRaWANGatewayVersionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
