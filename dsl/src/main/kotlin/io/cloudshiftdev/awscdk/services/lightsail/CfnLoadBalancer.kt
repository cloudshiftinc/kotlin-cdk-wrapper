...
internal constructor(
    ...
    public open fun attachedInstances(): List<String> =
        unwrap(this).getAttachedInstances() ?: emptyList()
    ...
    public interface Builder {
         ...
         * The path on the attached instance where the health check will be performed.
         *
         * If no path is specified, the load balancer tries to make a request to the default (root)
         * page ( `/index.html` ).
         *
         ...
         *
         * @param instancePort The port that the load balancer uses to direct traffic to your
         *   Lightsail instances.
         */
         ...
         * A Boolean value indicating whether session stickiness is enabled.
         *
         * Enable session stickiness (also known as *session affinity* ) to bind a user's session to
         * a specific instance. This ensures that all requests from the user during the session are
         ...
         *
         * If you do not specify this parameter, the default value is 0, which indicates that the
         ...
         *
         * @param sessionStickinessLbCookieDurationSeconds The time period, in seconds, after which
         *   the load balancer session stickiness cookie should be considered stale.
         */
    ...
    private class BuilderImpl(
         ...
         *   the load balancer session stickiness cookie should be considered stale.
         */
        override fun sessionStickinessLbCookieDurationSeconds(
            sessionStickinessLbCookieDurationSeconds: String
        ) {
