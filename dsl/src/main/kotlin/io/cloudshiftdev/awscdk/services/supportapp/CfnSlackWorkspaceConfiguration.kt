...
internal constructor(
    ...
    public interface Builder {
        ...
        /**
         * An identifier used to update an existing Slack workspace configuration in AWS
         ...
         *
         * @param versionId An identifier used to update an existing Slack workspace configuration
         *   in AWS CloudFormation , such as `100` .
         */
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnSlackWorkspaceConfiguration
        ): software.amazon.awscdk.services.supportapp.CfnSlackWorkspaceConfiguration =
            wrapped.cdkObject
    }
}
