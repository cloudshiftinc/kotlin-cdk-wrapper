...
internal constructor(
    ...
    public open fun certificateSettings(
        `value`: CertificateSettingsProperty.Builder.() -> Unit
    ): Unit = certificateSettings(CertificateSettingsProperty(`value`))
    ...
    public interface Builder {
         ...
         *
         * @param autoSubDomainIamRole The required AWS Identity and Access Management (IAMlong)
         *   service role for the Amazon Resource Name (ARN) for automatically creating subdomains.
         */
         ...
         * Describes the SSL/TLS certificate for the domain association.
         *
         * This can be your own custom certificate or the default certificate that Amplify
         * provisions for you.
         *
         * If you are updating your domain to use a different certificate, `Certificate` points to
         * the new certificate that is being created instead of the current active certificate.
        ...
        public fun certificateSettings(
            certificateSettings: CertificateSettingsProperty.Builder.() -> Unit
        )
         ...
         *   process of being verified. This occurs during the creation of a custom domain or when a
         ...
         *   the process of being imported. This occurs during the creation of a custom domain or
         *   when a custom domain is updated to use a custom certificate.
         ...
         *   subdomains to be propagated. If your custom domain is on Route 53, Amplify handles this
         ...
         *
         * @param updateStatus The status of the domain update operation that is currently in
         *   progress.
         */
    ...
    private class BuilderImpl(
         ...
         *   creation.
         */
        override fun autoSubDomainCreationPatterns(
            vararg autoSubDomainCreationPatterns: String
        ): Unit = autoSubDomainCreationPatterns(autoSubDomainCreationPatterns.toList())
        ...
        override fun certificateSettings(certificateSettings: CertificateSettingsProperty) {
            cdkBuilder.certificateSettings(
                certificateSettings.let(CertificateSettingsProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("24aef84ec6083e0cc92f1f4e75c3a6a1a183923d7a3b8111b5fd53349c26a456")
        override fun certificateSettings(
            certificateSettings: CertificateSettingsProperty.Builder.() -> Unit
    ...
    public interface SubDomainSettingProperty {
        ...
        public interface Builder {
            /**
             * @param branchName The branch name setting for the subdomain. *Length Constraints:*
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SubDomainSettingProperty
            ): software.amazon.awscdk.services.amplify.CfnDomain.SubDomainSettingProperty =
    ...
    public interface CertificateProperty {
         ...
         *
         * Specify `CUSTOM` to use your own certificate that you have already added to AWS
         * Certificate Manager in your AWS account . Make sure you request (or import) the
         * certificate in the US East (N. Virginia) Region (us-east-1). For more information about
         * using ACM, see
        ...
        public interface Builder {
            /**
             * @param certificateArn The Amazon resource name (ARN) for a custom certificate that
             *   you have already added to AWS Certificate Manager in your AWS account . This field
             *   is required only when the certificate type is `CUSTOM` .
             */
            public fun certificateArn(certificateArn: String)

            /**
             * @param certificateType The type of SSL/TLS certificate that you want to use. Specify
             *   `AMPLIFY_MANAGED` to use the default certificate that Amplify provisions for you.
             *
             * Specify `CUSTOM` to use your own certificate that you have already added to AWS
             * Certificate Manager in your AWS account . Make sure you request (or import) the
        ...
        private class BuilderImpl : Builder {
             ...
             * @param certificateVerificationDnsRecord The DNS record for certificate verification.
             */
            override fun certificateVerificationDnsRecord(
        ...
        internal constructor(
             ...
             * The type of SSL/TLS certificate that you want to use.
             *
             * Specify `AMPLIFY_MANAGED` to use the default certificate that Amplify provisions for
             * you.
             *
             * Specify `CUSTOM` to use your own certificate that you have already added to AWS
             * Certificate Manager in your AWS account . Make sure you request (or import) the
    ...
    public interface CertificateSettingsProperty {
        ...
        public interface Builder {
            /**
             * @param certificateType The certificate type. Specify `AMPLIFY_MANAGED` to use the
             ...
             *   that you have already added to AWS Certificate Manager in your AWS account . This
             *   field is required only when the certificate type is `CUSTOM` .
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: CertificateSettingsProperty
            ): software.amazon.awscdk.services.amplify.CfnDomain.CertificateSettingsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
