...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * Valid values:
         * * `TimeBased` - Location updates are evaluated against linked geofence collections, but
         *   not every location update is stored. If your update frequency is more often than 30
         ...
         *   geofence evaluations and historical device positions to paginate through.
         ...
         *   geofence collections, nor stored. This can reduce the effects of GPS noise when
         *   displaying device trajectories on a map, and can help control your costs by reducing
         *   the number of geofence evaluations.
         *
    ...
    private class BuilderImpl(
        ...
        override fun kmsKeyEnableGeospatialQueries(kmsKeyEnableGeospatialQueries: IResolvable) {
            cdkBuilder.kmsKeyEnableGeospatialQueries(
                kmsKeyEnableGeospatialQueries.let(IResolvable::unwrap)
            )
        }
    ...
    public companion object {
        ...
        ): CfnTracker = CfnTracker(cdkObject)

        internal fun unwrap(
            wrapped: CfnTracker
        ): software.amazon.awscdk.services.location.CfnTracker = wrapped.cdkObject
    }
}
