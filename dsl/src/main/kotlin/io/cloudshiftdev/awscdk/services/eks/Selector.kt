...
public interface Selector {
     ...
     *
     * You must specify a namespace for a selector. The selector only matches pods that are created
     * in this namespace, but you can create multiple selectors to target multiple namespaces.
     */
    ...
    public interface Builder {
        /**
         * @param labels The Kubernetes labels that the selector should match. A pod must contain
         *   all of the labels that are specified in the selector for it to be considered a match.
         */
        public fun labels(labels: Map<String, String>)

        /**
         * @param namespace The Kubernetes namespace that the selector should match. You must
         *   specify a namespace for a selector. The selector only matches pods that are created in
    ...
    internal constructor(
         ...
         * The Kubernetes namespace that the selector should match.
         *
         * You must specify a namespace for a selector. The selector only matches pods that are
         * created in this namespace, but you can create multiple selectors to target multiple
         * namespaces.
         */
    ...
    public companion object {
        ...
        internal fun unwrap(wrapped: Selector): software.amazon.awscdk.services.eks.Selector =
