...
internal constructor(
    ...
    public interface Builder {
        /**
         * The Amazon Resource Name (ARN) of the `Firewall` that the logging configuration is
         * associated with.
         *
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.networkfirewall.CfnLoggingConfiguration.Builder.create(
                scope,
                id
            )
    ...
    public interface LogDestinationConfigProperty {
         ...
         *   optionally provide a prefix, with key `prefix` . The following example specifies an
         *   Amazon S3 bucket named `DOC-EXAMPLE-BUCKET` and the prefix `alerts` :
         *
         ...
         *
         * Alert logs report traffic that matches a stateful rule with an action setting that sends
         * an alert log message. Flow logs are standard network traffic flow logs.
         *
        ...
        public interface Builder {
            /**
             * @param logDestination The named location for the logs, provided in a key:value
            ...
            /**
             * @param logDestinationType The type of storage destination to send these logs to. You
             *   can send logs to an Amazon S3 bucket, a CloudWatch log group, or a Firehose
             *   delivery stream.
             */
            public fun logDestinationType(logDestinationType: String)

            /**
             * @param logType The type of log to send. Alert logs report traffic that matches a
             *   stateful rule with an action setting that sends an alert log message. Flow logs are
        ...
        internal constructor(
            ...
            /**
             * The named location for the logs, provided in a key:value mapping that is specific to
             * the chosen destination type.
             * * For an Amazon S3 bucket, provide the name of the bucket, with key `bucketName` ,
             *   and optionally provide a prefix, with key `prefix` . The following example
             *   specifies an Amazon S3 bucket named `DOC-EXAMPLE-BUCKET` and the prefix `alerts` :
             *
             ...
             * The type of storage destination to send these logs to.
             *
             * You can send logs to an Amazon S3 bucket, a CloudWatch log group, or a Firehose
             * delivery stream.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-networkfirewall-loggingconfiguration-logdestinationconfig.html#cfn-networkfirewall-loggingconfiguration-logdestinationconfig-logdestinationtype)
             */
             ...
             * The type of log to send.
             *
             * Alert logs report traffic that matches a stateful rule with an action setting that
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: LogDestinationConfigProperty
            ): software.amazon.awscdk.services.networkfirewall.CfnLoggingConfiguration.LogDestinationConfigProperty =
    ...
    public interface LoggingConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param logDestinationConfigs Defines the logging destinations for the logs for a
             *   firewall. Network Firewall generates logs for stateful rule groups.
             */
