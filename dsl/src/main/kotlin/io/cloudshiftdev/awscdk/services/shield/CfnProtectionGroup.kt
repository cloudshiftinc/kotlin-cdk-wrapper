...
internal constructor(
    ...
    public interface Builder {
         ...
         *   resources that share traffic uniformly. Examples include accelerators and load
         *   balancers.
         ...
         *
         * @param aggregation Defines how AWS Shield combines resource data for the group in order
         ...
         * The ARNs (Amazon Resource Names) of the resources to include in the protection group.
         *
         * You must set this when you set `Pattern` to `ARBITRARY` and you must not set it for any
         ...
         *
         * @param members The ARNs (Amazon Resource Names) of the resources to include in the
         *   protection group.
         */
         ...
         * The name of the protection group.
         *
         * You use this to identify the protection group in lists and to manage the protection
         ...
         * The resource type to include in the protection group.
         *
         * All protected resources of this type are included in the protection group. You must set
         * this when you set `Pattern` to `BY_RESOURCE_TYPE` and you must not set it for any other
         * `Pattern` setting.
         *
