...
public interface AlgorithmSpecification {
     ...
     *
     * This must be an algorithm resource that you created or subscribe to on AWS Marketplace. If
     * you specify a value for this parameter, you can't specify a value for TrainingImage.
     *
     ...
     */
    public fun trainingImage(): DockerImage? =
    ...
    public interface Builder {
        /**
         * @param algorithmName Name of the algorithm resource to use for the training job. This
         *   must be an algorithm resource that you created or subscribe to on AWS Marketplace. If
         *   you specify a value for this parameter, you can't specify a value for TrainingImage.
         */
        public fun algorithmName(algorithmName: String)

        /**
         * @param metricDefinitions List of metric definition objects. Each object specifies the
        ...
        /**
         * @param trainingImage Registry path of the Docker image that contains the training
         *   algorithm.
         */
    ...
    internal constructor(
         ...
         * List of metric definition objects.
         *
         * Each object specifies the metric name and regular expressions used to parse algorithm
         * logs.
         *
         * Default: - No metrics
         */
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: AlgorithmSpecification
        ): software.amazon.awscdk.services.stepfunctions.tasks.AlgorithmSpecification =
