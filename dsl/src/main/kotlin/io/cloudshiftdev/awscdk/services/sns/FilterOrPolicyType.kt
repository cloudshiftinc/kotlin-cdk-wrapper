...
public enum class FilterOrPolicyType(
    ...
    public companion object {
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.sns.FilterOrPolicyType
        ): FilterOrPolicyType =
            when (cdkObject) {
                software.amazon.awscdk.services.sns.FilterOrPolicyType.FILTER ->
                    FilterOrPolicyType.FILTER
                software.amazon.awscdk.services.sns.FilterOrPolicyType.POLICY ->
                    FilterOrPolicyType.POLICY
            }

        internal fun unwrap(
            wrapped: FilterOrPolicyType
