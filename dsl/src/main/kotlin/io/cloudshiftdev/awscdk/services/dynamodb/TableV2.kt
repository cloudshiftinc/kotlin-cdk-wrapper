...
internal constructor(
    ...
    public open fun addGlobalSecondaryIndex(
        props: GlobalSecondaryIndexPropsV2.Builder.() -> Unit
    ...
    public interface Builder {
        ...
        public fun globalSecondaryIndexes(
            vararg globalSecondaryIndexes: GlobalSecondaryIndexPropsV2
        )
    ...
    private class BuilderImpl(
         ...
         * @param globalSecondaryIndexes Global secondary indexes.
         */
        override fun globalSecondaryIndexes(
            globalSecondaryIndexes: List<GlobalSecondaryIndexPropsV2>
        ) {
            cdkBuilder.globalSecondaryIndexes(
                globalSecondaryIndexes.map(GlobalSecondaryIndexPropsV2::unwrap)
            )
        }
        ...
        override fun localSecondaryIndexes(localSecondaryIndexes: List<LocalSecondaryIndexProps>) {
            cdkBuilder.localSecondaryIndexes(
                localSecondaryIndexes.map(LocalSecondaryIndexProps::unwrap)
            )
        }
         ...
         * @param localSecondaryIndexes Local secondary indexes.
         */
        override fun localSecondaryIndexes(
            vararg localSecondaryIndexes: LocalSecondaryIndexProps
        ): Unit = localSecondaryIndexes(localSecondaryIndexes.toList())
         ...
         * @param replicas Replica tables to deploy with the primary table.
         */
        override fun replicas(vararg replicas: ReplicaTableProps): Unit =
    ...
    public companion object {
        public fun fromTableArn(
            ...
            software.amazon.awscdk.services.dynamodb.TableV2.fromTableArn(
        ...
        public fun fromTableAttributes(
            ...
            software.amazon.awscdk.services.dynamodb.TableV2.fromTableAttributes(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    attrs.let(TableAttributesV2::unwrap)
                )
                .let(ITableV2::wrap)
        ...
        public fun fromTableName(
            ...
            software.amazon.awscdk.services.dynamodb.TableV2.fromTableName(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    tableName
                )
