...
internal constructor(
     ...
     *
     * This is required because a secret can only have a single resource policy. If we do not
     * forward policy additions, a new policy resource is created using the secret attachment ARN.
     ...
     * [io.cloudshiftdev.awscdk.services.secretsmanager.SecretTargetAttachment].
     */
    @CdkDslMarker
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.secretsmanager.SecretTargetAttachment.Builder.create(
                scope,
                id
            )
    ...
    public companion object {
        public fun fromSecretTargetAttachmentSecretArn(
            ...
            software.amazon.awscdk.services.secretsmanager.SecretTargetAttachment
                ...
                .let(ISecretTargetAttachment::wrap)
        ...
        internal fun unwrap(
            wrapped: SecretTargetAttachment
