...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param regexPatternStrings Specifies the regular expression (regex) patterns that you
         *   want AWS WAF to search for, such as `B[a&#64;]dB[o0]t` .
         */
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.waf.regional.CfnRegexPatternSet.Builder.create(
                scope,
                id
            )
