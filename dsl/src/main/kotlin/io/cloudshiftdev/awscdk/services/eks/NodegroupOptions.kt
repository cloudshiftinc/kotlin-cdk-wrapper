...
public interface NodegroupOptions {
     ...
     * Default: - ON_DEMAND
     */
    public fun capacityType(): CapacityType? =
     ...
     * Default: - None
     */
    public fun taints(): List<TaintSpec> =
        unwrap(this).getTaints()?.map(TaintSpec::wrap) ?: emptyList()

    /** A builder for [NodegroupOptions] */
    @CdkDslMarker
    public interface Builder {
        /**
         * @param amiType The AMI type for your node group. If you explicitly specify the
         *   launchTemplate with custom AMI, do not specify this property, or the node group
         *   deployment will fail. In other cases, you will need to specify correct amiType for the
         *   nodegroup.
         */
         ...
         *   maintain. If not specified, the nodewgroup will initially create `minSize` instances.
         */
         ...
         *   drained due to a pod disruption budget issue. If an update fails because pods could not
         *   be drained, you can force the update after it fails to terminate the old node whether
         *   or not any pods are running on the node.
         */
        ...
        /**
         * @param maxSize The maximum number of worker nodes that the managed node group can scale
         ...
         *   version update. This percentage of nodes will be updated in parallel, up to 100 nodes
         *   at once.
         *
         * This value or `maxUnavailable` is required to have a value for custom update
         * configurations to be applied.
         */
        public fun maxUnavailablePercentage(maxUnavailablePercentage: Number)

        /**
         * @param minSize The minimum number of worker nodes that the managed node group can scale
         *   in to. This number must be greater than or equal to zero.
         */
        public fun minSize(minSize: Number)

        /**
         * @param nodeRole The IAM role to associate with your node group. The Amazon EKS worker
         *   node kubelet daemon makes calls to AWS APIs on your behalf. Worker nodes receive
         ...
         *   node group (for example, `1.14.7-YYYYMMDD`).
         */
         ...
         *   Disabled by default, however, if you specify an Amazon EC2 SSH key but do not specify a
         *   source security group when you create a managed node group, then port 22 on the worker
         ...
         *   node group. By specifying the SubnetSelection, the selected subnets will automatically
         *   apply required tags i.e. `kubernetes.io/cluster/CLUSTER_NAME` with a value of `shared`,
    ...
    private class BuilderImpl : Builder {
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("a0e8b2f2dc3405f67a3cd7b21e4833e4e2c73a9564c2179aeab53d1807472b1f")
        override fun launchTemplateSpec(
            launchTemplateSpec: LaunchTemplateSpec.Builder.() -> Unit
        ): Unit = launchTemplateSpec(LaunchTemplateSpec(launchTemplateSpec))
        ...
        public fun build(): software.amazon.awscdk.services.eks.NodegroupOptions =
            cdkBuilder.build()
    }
    ...
    internal constructor(
         ...
         * The AMI type for your node group.
         *
         * If you explicitly specify the launchTemplate with custom AMI, do not specify this
         * property, or the node group deployment will fail. In other cases, you will need to
         * specify correct amiType for the nodegroup.
         *
         * Default: - auto-determined from the instanceTypes property when launchTemplateSpec
         ...
         * disruption budget issue.
         *
         * If an update fails because pods could not be drained, you can force the update after it
         ...
         * associated policies. Before you can launch worker nodes and register them into a cluster,
         ...
         *
         * By specifying the SubnetSelection, the selected subnets will automatically apply required
         * tags i.e. `kubernetes.io/cluster/CLUSTER_NAME` with a value of `shared`, where
         ...
         * Default: - None
         */
        override fun taints(): List<TaintSpec> =
            unwrap(this).getTaints()?.map(TaintSpec::wrap) ?: emptyList()
    }
