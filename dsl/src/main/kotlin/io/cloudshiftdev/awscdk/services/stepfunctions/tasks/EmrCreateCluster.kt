...
internal constructor(
    ...
    public interface Builder {
        ...
        /**
         * The size of the EBS root device volume of the Linux AMI that is used for each EC2
         * instance.
         *
         * Default: - EMR selected default
         *
         * @param ebsRootVolumeSize The size of the EBS root device volume of the Linux AMI that is
         *   used for each EC2 instance.
         */
         ...
         * Default: - None
         *
         * @param securityConfiguration The name of a security configuration to apply to the
         *   cluster.
         */
         ...
         *
         * @param stepConcurrencyLevel Specifies the step concurrency level to allow multiple steps
         *   to run in parallel.
         */
         ...
         * actions if they have the proper IAM policy permissions.
         *
         * Default: true
         *
         * @param visibleToAllUsers A value of true indicates that all IAM users in the AWS account
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.stepfunctions.tasks.EmrCreateCluster.Builder.create(
                scope,
                id
            )
         ...
         *   cluster nodes.
         */
        override fun bootstrapActions(
            vararg bootstrapActions: BootstrapActionConfigProperty
        ): Unit = bootstrapActions(bootstrapActions.toList())
    ...
    public interface ConfigurationProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param properties A set of properties specified within a configuration
             *   classification.
             */
        ...
        internal constructor(
            ...
            override fun properties(): Map<String, String> =
                unwrap(this).getProperties() ?: emptyMap()
        }
        ...
        public companion object {
            internal fun wrap(
                ...
                when (cdkObject) {
                    software.amazon.awscdk.services.stepfunctions.tasks.EmrCreateCluster
                        .ScalingAdjustmentType
                        .CHANGE_IN_CAPACITY -> ScalingAdjustmentType.CHANGE_IN_CAPACITY
                    software.amazon.awscdk.services.stepfunctions.tasks.EmrCreateCluster
                        .ScalingAdjustmentType
                        .PERCENT_CHANGE_IN_CAPACITY ->
                    ...
                    software.amazon.awscdk.services.stepfunctions.tasks.EmrCreateCluster
                        .ScalingAdjustmentType
                        .EXACT_CAPACITY -> ScalingAdjustmentType.EXACT_CAPACITY
                }

            internal fun unwrap(
                wrapped: ScalingAdjustmentType
            ): software.amazon.awscdk.services.stepfunctions.tasks.EmrCreateCluster.ScalingAdjustmentType =
                wrapped.cdkObject
        }
    }
        ...
        internal constructor(
            ...
            override fun scriptBootstrapAction(): ScriptBootstrapActionConfigProperty =
                unwrap(this)
                    ...
                    .let(ScriptBootstrapActionConfigProperty::wrap)
        }
        ...
        public companion object {
            internal fun wrap(
                ...
                when (cdkObject) {
                    software.amazon.awscdk.services.stepfunctions.tasks.EmrCreateCluster
                        .EbsBlockDeviceVolumeType
                        .GP3 -> EbsBlockDeviceVolumeType.GP3
                    software.amazon.awscdk.services.stepfunctions.tasks.EmrCreateCluster
                        .EbsBlockDeviceVolumeType
                        .GP2 -> EbsBlockDeviceVolumeType.GP2
                    software.amazon.awscdk.services.stepfunctions.tasks.EmrCreateCluster
                        .EbsBlockDeviceVolumeType
                        .IO1 -> EbsBlockDeviceVolumeType.IO1
                    software.amazon.awscdk.services.stepfunctions.tasks.EmrCreateCluster
                        .EbsBlockDeviceVolumeType
                        .ST1 -> EbsBlockDeviceVolumeType.ST1
                    software.amazon.awscdk.services.stepfunctions.tasks.EmrCreateCluster
                        .EbsBlockDeviceVolumeType
                        .SC1 -> EbsBlockDeviceVolumeType.SC1
                    software.amazon.awscdk.services.stepfunctions.tasks.EmrCreateCluster
                        .EbsBlockDeviceVolumeType
                        .STANDARD -> EbsBlockDeviceVolumeType.STANDARD
                }

            internal fun unwrap(
                wrapped: EbsBlockDeviceVolumeType
            ): software.amazon.awscdk.services.stepfunctions.tasks.EmrCreateCluster.EbsBlockDeviceVolumeType =
                wrapped.cdkObject
        }
    }
    ...
    public interface EbsBlockDeviceConfigProperty {
        ...
        public interface Builder {
            /**
             * @param volumeSpecification EBS volume specifications such as volume type, IOPS, and
             *   size (GiB) that will be requested for the EBS volume attached to an EC2 instance in
             *   the cluster.
             */
    ...
    public interface VolumeSpecificationProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param volumeSize The volume size. If the volume type is EBS-optimized, the minimum
             *   value is 10GiB. Maximum size is 1TiB
             */
    ...
    public interface ApplicationConfigProperty {
         ...
         *
         * This is meta information about third-party applications that third-party vendors use for
         * testing purposes.
         *
         * Default: No additionalInfo
         */
        public fun additionalInfo(): Map<String, String> =
            unwrap(this).getAdditionalInfo() ?: emptyMap()
        ...
        public interface Builder {
             ...
             *   information about third-party applications that third-party vendors use for testing
             *   purposes.
             */
        ...
        internal constructor(
             ...
             * Default: No additionalInfo
             */
            override fun additionalInfo(): Map<String, String> =
                unwrap(this).getAdditionalInfo() ?: emptyMap()
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ApplicationConfigProperty
            ): software.amazon.awscdk.services.stepfunctions.tasks.EmrCreateCluster.ApplicationConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface InstanceTypeConfigProperty {
         ...
         * the target capacities defined in the InstanceFleetConfig.
         *
         * Default: - None
         */
        ...
        public interface Builder {
            /**
             * @param bidPrice The bid price for each EC2 Spot instance type as defined by
             *   InstanceType. Expressed in USD. Cannot specify both `bidPrice` and
             ...
             *   On-Demand price. Cannot specify both `bidPrice` and
             *   `bidPriceAsPercentageOfOnDemandPrice`.
             */
            ...
            /**
             * @param ebsConfiguration The configuration of Amazon Elastic Block Storage (EBS)
             ...
             *   provides toward fulfilling the target capacities defined in the
             *   InstanceFleetConfig.
             */
        ...
        internal constructor(
             ...
             * fulfilling the target capacities defined in the InstanceFleetConfig.
             *
             * Default: - None
             */
    ...
    public interface InstanceGroupConfigProperty {
        ...
        public interface Builder {
            /**
             * @param autoScalingPolicy An automatic scaling policy for a core instance group or
            ...
            /**
             * @param ebsConfiguration EBS configurations that will be attached to each EC2 instance
        ...
        internal constructor(
             ...
             * Default: - EMR selected default
             */
            override fun market(): InstanceMarket? =
    ...
    public interface CloudWatchAlarmDefinitionProperty {
         ...
         *
         * EMR CloudWatch metrics are emitted every five minutes (300 seconds), so if an EMR
         ...
         */
        public fun unit(): CloudWatchAlarmUnit? =
        ...
        public interface Builder {
            ...
            /**
             * @param period The period, in seconds, over which the statistic is applied. EMR
             *   CloudWatch metrics are emitted every five minutes (300 seconds), so if an EMR
             *   CloudWatch metric is specified, specify 300.
             */
        ...
        private class BuilderImpl : Builder {
            ...
            override fun comparisonOperator(comparisonOperator: CloudWatchAlarmComparisonOperator) {
                cdkBuilder.comparisonOperator(
                    comparisonOperator.let(CloudWatchAlarmComparisonOperator::unwrap)
                )
            }
    ...
    public interface InstancesConfigProperty {
         ...
         * the identifier of the Amazon VPC subnet where you want the cluster to launch.
         *
         * Default: EMR selected default
         */
        ...
        public interface Builder {
            ...
            /**
             * @param ec2KeyName The name of the EC2 key pair that can be used to ssh to the master
            ...
            /**
             * @param instanceFleets Describes the EC2 instances and instance configurations for
             *   clusters that use the instance fleet configuration. The instance fleet
             *   configuration is available only in Amazon EMR versions 4.8.0 and later, excluding
             *   5.0.x versions.
             */
        ...
        internal constructor(
             ...
             * the cluster.
             *
             * Default: - 0.18 if the AmiVersion parameter is not set. If AmiVersion is set, the
            ...
            override fun instanceFleets(): List<InstanceFleetConfigProperty> =
                unwrap(this).getInstanceFleets()?.map(InstanceFleetConfigProperty::wrap)
                    ?: emptyList()
            ...
            override fun instanceGroups(): List<InstanceGroupConfigProperty> =
                unwrap(this).getInstanceGroups()?.map(InstanceGroupConfigProperty::wrap)
                    ?: emptyList()
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: InstancesConfigProperty
            ): software.amazon.awscdk.services.stepfunctions.tasks.EmrCreateCluster.InstancesConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
        ...
        public companion object {
            internal fun wrap(
                ...
                when (cdkObject) {
                    software.amazon.awscdk.services.stepfunctions.tasks.EmrCreateCluster
                        .InstanceMarket
                        .ON_DEMAND -> InstanceMarket.ON_DEMAND
                    software.amazon.awscdk.services.stepfunctions.tasks.EmrCreateCluster
                        .InstanceMarket
                        .SPOT -> InstanceMarket.SPOT
                }

            internal fun unwrap(
                wrapped: InstanceMarket
            ): software.amazon.awscdk.services.stepfunctions.tasks.EmrCreateCluster.InstanceMarket =
                wrapped.cdkObject
        }
    }
        ...
        internal constructor(
            ...
            override fun cloudWatchAlarmDefinition(): CloudWatchAlarmDefinitionProperty =
                unwrap(this)
                    ...
                    .let(CloudWatchAlarmDefinitionProperty::wrap)
        }
    ...
    public interface InstanceFleetProvisioningSpecificationsProperty {
        ...
        public fun onDemandSpecification(): OnDemandProvisioningSpecificationProperty? =
            unwrap(this)
                ...
                ?.let(OnDemandProvisioningSpecificationProperty::wrap)
        ...
        public interface Builder {
             ...
             *   instance fleet, which determines the allocation strategy. The instance fleet
             *   configuration is available only in Amazon EMR releases 4.8.0 and later, excluding
             *   5.0.x versions. On-Demand Instances allocation strategy is available in Amazon EMR
        ...
        internal constructor(
            ...
            override fun spotSpecification(): SpotProvisioningSpecificationProperty? =
                unwrap(this)
                    ...
                    ?.let(SpotProvisioningSpecificationProperty::wrap)
        }
    ...
    public interface InstanceFleetConfigProperty {
        ...
        public fun launchSpecifications(): InstanceFleetProvisioningSpecificationsProperty? =
            unwrap(this)
                ...
                ?.let(InstanceFleetProvisioningSpecificationsProperty::wrap)
         ...
         *
         * At least one of `targetSpotCapacity` and `targetOnDemandCapacity` should be greater
        ...
        public interface Builder {
            /**
             * @param instanceFleetType The node type that the instance fleet hosts. Valid values
             *   are MASTER,CORE,and TASK.
             */
            public fun instanceFleetType(instanceFleetType: InstanceRoleType)

            /**
             * @param instanceTypeConfigs The instance type configurations that define the EC2
             ...
             *   fleet, which determines how many On-Demand instances to provision. If not specified
             *   or set to 0, only Spot Instances are provisioned for the instance fleet using
             *   `targetSpotCapacity`.
             *
             * At least one of `targetSpotCapacity` and `targetOnDemandCapacity` should be greater
             * than 0. For a master instance fleet, only one of `targetSpotCapacity` and
             ...
             *   which determines how many Spot instances to provision. If not specified or set to
             *   0, only On-Demand Instances are provisioned for the instance fleet using
        ...
        private class BuilderImpl : Builder {
             ...
             *   instances in the instance fleet.
             */
            override fun instanceTypeConfigs(
                instanceTypeConfigs: List<InstanceTypeConfigProperty>
            ) {
                cdkBuilder.instanceTypeConfigs(
                    instanceTypeConfigs.map(InstanceTypeConfigProperty::unwrap)
                )
            }
             ...
             */
            override fun instanceTypeConfigs(
                vararg instanceTypeConfigs: InstanceTypeConfigProperty
            ): Unit = instanceTypeConfigs(instanceTypeConfigs.toList())
        ...
        internal constructor(
             ...
             * instance fleet using `targetOnDemandCapacity`.
             *
             * At least one of `targetSpotCapacity` and `targetOnDemandCapacity` should be greater
             * than 0. For a master instance fleet, only one of `targetSpotCapacity` and
             * `targetOnDemandCapacity` can be specified, and its value must be 1.
        ...
        public companion object {
            internal fun wrap(
                ...
                when (cdkObject) {
                    software.amazon.awscdk.services.stepfunctions.tasks.EmrCreateCluster
                        .CloudWatchAlarmStatistic
                        .SAMPLE_COUNT -> CloudWatchAlarmStatistic.SAMPLE_COUNT
                    software.amazon.awscdk.services.stepfunctions.tasks.EmrCreateCluster
                        .CloudWatchAlarmStatistic
                        .AVERAGE -> CloudWatchAlarmStatistic.AVERAGE
                    software.amazon.awscdk.services.stepfunctions.tasks.EmrCreateCluster
                        .CloudWatchAlarmStatistic
                        .SUM -> CloudWatchAlarmStatistic.SUM
                    software.amazon.awscdk.services.stepfunctions.tasks.EmrCreateCluster
                        .CloudWatchAlarmStatistic
                        .MINIMUM -> CloudWatchAlarmStatistic.MINIMUM
                    software.amazon.awscdk.services.stepfunctions.tasks.EmrCreateCluster
                        .CloudWatchAlarmStatistic
                        .MAXIMUM -> CloudWatchAlarmStatistic.MAXIMUM
                }

            internal fun unwrap(
                wrapped: CloudWatchAlarmStatistic
            ): software.amazon.awscdk.services.stepfunctions.tasks.EmrCreateCluster.CloudWatchAlarmStatistic =
                wrapped.cdkObject
        }
    }
    ...
    public interface AutoScalingPolicyProperty {
        ...
        public interface Builder {
            /**
             * @param constraints The upper and lower EC2 instance limits for an automatic scaling
             *   policy.
             *
        ...
        public companion object {
            internal fun wrap(
                ...
                when (cdkObject) {
                    software.amazon.awscdk.services.stepfunctions.tasks.EmrCreateCluster
                        .SpotTimeoutAction
                        .SWITCH_TO_ON_DEMAND -> SpotTimeoutAction.SWITCH_TO_ON_DEMAND
                    software.amazon.awscdk.services.stepfunctions.tasks.EmrCreateCluster
                        .SpotTimeoutAction
                        .TERMINATE_CLUSTER -> SpotTimeoutAction.TERMINATE_CLUSTER
                }

            internal fun unwrap(
                wrapped: SpotTimeoutAction
            ): software.amazon.awscdk.services.stepfunctions.tasks.EmrCreateCluster.SpotTimeoutAction =
                wrapped.cdkObject
        }
    }
        ...
        public companion object {
            internal fun wrap(
                ...
                when (cdkObject) {
                    ...
                    software.amazon.awscdk.services.stepfunctions.tasks.EmrCreateCluster
                        .CloudWatchAlarmComparisonOperator
                        .GREATER_THAN -> CloudWatchAlarmComparisonOperator.GREATER_THAN
                    software.amazon.awscdk.services.stepfunctions.tasks.EmrCreateCluster
                        .CloudWatchAlarmComparisonOperator
                        .LESS_THAN -> CloudWatchAlarmComparisonOperator.LESS_THAN
                    software.amazon.awscdk.services.stepfunctions.tasks.EmrCreateCluster
                        .CloudWatchAlarmComparisonOperator
                        .LESS_THAN_OR_EQUAL -> CloudWatchAlarmComparisonOperator.LESS_THAN_OR_EQUAL
                }

            internal fun unwrap(
                wrapped: CloudWatchAlarmComparisonOperator
            ): software.amazon.awscdk.services.stepfunctions.tasks.EmrCreateCluster.CloudWatchAlarmComparisonOperator =
                wrapped.cdkObject
        }
    }
    ...
    public interface SpotProvisioningSpecificationProperty {
         ...
         *
         * Default: - No allocation strategy, i.e. spot instance type will be chosen based on
         * current price only
         */
        ...
        public interface Builder {
            /**
             * @param allocationStrategy Specifies the strategy to use in launching Spot Instance
             *   fleets.
             */
             ...
             *   Spot blocks) in minutes.
             * @deprecated - Spot Instances with a defined duration (also known as Spot blocks) are
            ...
            /**
             * @param timeout The spot provisioning timeout period in minutes. The value must be
            ...
            /**
             * @param timeoutDurationMinutes The spot provisioning timeout period in minutes. The
        ...
        private class BuilderImpl : Builder {
            ...
            override fun allocationStrategy(allocationStrategy: SpotAllocationStrategy) {
                cdkBuilder.allocationStrategy(
                    allocationStrategy.let(SpotAllocationStrategy::unwrap)
                )
            }
        ...
        internal constructor(
             ...
             */
            @Deprecated(message = "deprecated in CDK")
            override fun timeoutDurationMinutes(): Number? =
    ...
    public interface OnDemandProvisioningSpecificationProperty {
        ...
        private class BuilderImpl : Builder {
            ...
            override fun allocationStrategy(allocationStrategy: OnDemandAllocationStrategy) {
                cdkBuilder.allocationStrategy(
                    allocationStrategy.let(OnDemandAllocationStrategy::unwrap)
                )
            }
    ...
    public enum class SpotAllocationStrategy(
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: SpotAllocationStrategy
            ): software.amazon.awscdk.services.stepfunctions.tasks.EmrCreateCluster.SpotAllocationStrategy =
                wrapped.cdkObject
        }
    }
    ...
    public interface PlacementTypeProperty {
        ...
        public interface Builder {
             ...
             *   AvailabilityZones is used for instance fleets, while AvailabilityZone (singular) is
             *   used for uniform instance groups.
             */
    ...
    public interface ScriptBootstrapActionConfigProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param path Location of the script to run during a bootstrap action. Can be either a
    ...
    public interface ScalingConstraintsProperty {
        ...
        public interface Builder {
            /**
             * @param maxCapacity The upper boundary of EC2 instances in an instance group beyond
            ...
            /**
             * @param minCapacity The lower boundary of EC2 instances in an instance group below
             *   which scaling activities are not allowed to shrink. Scale-in activities will not
    ...
    public interface SimpleScalingPolicyConfigurationProperty {
         ...
         * removes instances. If AdjustmentType is set to EXACT_CAPACITY, the number should only be
         * a positive integer.
         */
        ...
        public interface Builder {
            /**
             * @param adjustmentType The way in which EC2 instances are added (if ScalingAdjustment
             ...
             *   instance count while a negative number removes instances. If AdjustmentType is set
             *   to EXACT_CAPACITY, the number should only be a positive integer.
             */
    ...
    public interface EbsConfigurationProperty {
        ...
        public interface Builder {
            ...
            public fun ebsBlockDeviceConfigs(
                ebsBlockDeviceConfigs: List<EbsBlockDeviceConfigProperty>
            )
             ...
             */
            public fun ebsBlockDeviceConfigs(
                vararg ebsBlockDeviceConfigs: EbsBlockDeviceConfigProperty
            )
        ...
        private class BuilderImpl : Builder {
             ...
             *   a cluster instance.
             */
            override fun ebsBlockDeviceConfigs(
                ebsBlockDeviceConfigs: List<EbsBlockDeviceConfigProperty>
            ) {
                cdkBuilder.ebsBlockDeviceConfigs(
                    ebsBlockDeviceConfigs.map(EbsBlockDeviceConfigProperty::unwrap)
                )
            }
            ...
            override fun ebsBlockDeviceConfigs(
                vararg ebsBlockDeviceConfigs: EbsBlockDeviceConfigProperty
            ): Unit = ebsBlockDeviceConfigs(ebsBlockDeviceConfigs.toList())
        ...
        public companion object {
            internal fun wrap(
                ...
                when (cdkObject) {
                    software.amazon.awscdk.services.stepfunctions.tasks.EmrCreateCluster
                        .CloudWatchAlarmUnit
                        .NONE -> CloudWatchAlarmUnit.NONE
                    software.amazon.awscdk.services.stepfunctions.tasks.EmrCreateCluster
                        .CloudWatchAlarmUnit
                        .SECONDS -> CloudWatchAlarmUnit.SECONDS
                    software.amazon.awscdk.services.stepfunctions.tasks.EmrCreateCluster
                        .CloudWatchAlarmUnit
                        .MICRO_SECONDS -> CloudWatchAlarmUnit.MICRO_SECONDS
                    software.amazon.awscdk.services.stepfunctions.tasks.EmrCreateCluster
                        .CloudWatchAlarmUnit
                        .MILLI_SECONDS -> CloudWatchAlarmUnit.MILLI_SECONDS
                    software.amazon.awscdk.services.stepfunctions.tasks.EmrCreateCluster
                        .CloudWatchAlarmUnit
                        .BYTES -> CloudWatchAlarmUnit.BYTES
                    software.amazon.awscdk.services.stepfunctions.tasks.EmrCreateCluster
                        .CloudWatchAlarmUnit
                        .KILO_BYTES -> CloudWatchAlarmUnit.KILO_BYTES
                    software.amazon.awscdk.services.stepfunctions.tasks.EmrCreateCluster
                        .CloudWatchAlarmUnit
                        .MEGA_BYTES -> CloudWatchAlarmUnit.MEGA_BYTES
                    software.amazon.awscdk.services.stepfunctions.tasks.EmrCreateCluster
                        .CloudWatchAlarmUnit
                        .GIGA_BYTES -> CloudWatchAlarmUnit.GIGA_BYTES
                    software.amazon.awscdk.services.stepfunctions.tasks.EmrCreateCluster
                        .CloudWatchAlarmUnit
                        .TERA_BYTES -> CloudWatchAlarmUnit.TERA_BYTES
                    software.amazon.awscdk.services.stepfunctions.tasks.EmrCreateCluster
                        .CloudWatchAlarmUnit
                        .BITS -> CloudWatchAlarmUnit.BITS
                    software.amazon.awscdk.services.stepfunctions.tasks.EmrCreateCluster
                        .CloudWatchAlarmUnit
                        .KILO_BITS -> CloudWatchAlarmUnit.KILO_BITS
                    software.amazon.awscdk.services.stepfunctions.tasks.EmrCreateCluster
                        .CloudWatchAlarmUnit
                        .MEGA_BITS -> CloudWatchAlarmUnit.MEGA_BITS
                    software.amazon.awscdk.services.stepfunctions.tasks.EmrCreateCluster
                        .CloudWatchAlarmUnit
                        .GIGA_BITS -> CloudWatchAlarmUnit.GIGA_BITS
                    software.amazon.awscdk.services.stepfunctions.tasks.EmrCreateCluster
                        .CloudWatchAlarmUnit
                        .TERA_BITS -> CloudWatchAlarmUnit.TERA_BITS
                    software.amazon.awscdk.services.stepfunctions.tasks.EmrCreateCluster
                        .CloudWatchAlarmUnit
                        .PERCENT -> CloudWatchAlarmUnit.PERCENT
                    software.amazon.awscdk.services.stepfunctions.tasks.EmrCreateCluster
                        .CloudWatchAlarmUnit
                        .COUNT -> CloudWatchAlarmUnit.COUNT
                    software.amazon.awscdk.services.stepfunctions.tasks.EmrCreateCluster
                        .CloudWatchAlarmUnit
                        .BYTES_PER_SECOND -> CloudWatchAlarmUnit.BYTES_PER_SECOND
                    software.amazon.awscdk.services.stepfunctions.tasks.EmrCreateCluster
                        .CloudWatchAlarmUnit
                        .KILO_BYTES_PER_SECOND -> CloudWatchAlarmUnit.KILO_BYTES_PER_SECOND
                    software.amazon.awscdk.services.stepfunctions.tasks.EmrCreateCluster
                        .CloudWatchAlarmUnit
                        .MEGA_BYTES_PER_SECOND -> CloudWatchAlarmUnit.MEGA_BYTES_PER_SECOND
                    software.amazon.awscdk.services.stepfunctions.tasks.EmrCreateCluster
                        .CloudWatchAlarmUnit
                        .GIGA_BYTES_PER_SECOND -> CloudWatchAlarmUnit.GIGA_BYTES_PER_SECOND
                    software.amazon.awscdk.services.stepfunctions.tasks.EmrCreateCluster
                        .CloudWatchAlarmUnit
                        .TERA_BYTES_PER_SECOND -> CloudWatchAlarmUnit.TERA_BYTES_PER_SECOND
                    software.amazon.awscdk.services.stepfunctions.tasks.EmrCreateCluster
                        .CloudWatchAlarmUnit
                        .BITS_PER_SECOND -> CloudWatchAlarmUnit.BITS_PER_SECOND
                    software.amazon.awscdk.services.stepfunctions.tasks.EmrCreateCluster
                        .CloudWatchAlarmUnit
                        .KILO_BITS_PER_SECOND -> CloudWatchAlarmUnit.KILO_BITS_PER_SECOND
                    software.amazon.awscdk.services.stepfunctions.tasks.EmrCreateCluster
                        .CloudWatchAlarmUnit
                        .MEGA_BITS_PER_SECOND -> CloudWatchAlarmUnit.MEGA_BITS_PER_SECOND
                    software.amazon.awscdk.services.stepfunctions.tasks.EmrCreateCluster
                        .CloudWatchAlarmUnit
                        .GIGA_BITS_PER_SECOND -> CloudWatchAlarmUnit.GIGA_BITS_PER_SECOND
                    software.amazon.awscdk.services.stepfunctions.tasks.EmrCreateCluster
                        .CloudWatchAlarmUnit
                        .TERA_BITS_PER_SECOND -> CloudWatchAlarmUnit.TERA_BITS_PER_SECOND
                    software.amazon.awscdk.services.stepfunctions.tasks.EmrCreateCluster
                        .CloudWatchAlarmUnit
                        .COUNT_PER_SECOND -> CloudWatchAlarmUnit.COUNT_PER_SECOND
                }

            internal fun unwrap(
                wrapped: CloudWatchAlarmUnit
            ): software.amazon.awscdk.services.stepfunctions.tasks.EmrCreateCluster.CloudWatchAlarmUnit =
                wrapped.cdkObject
        }
    }
    ...
    public enum class EmrClusterScaleDownBehavior(
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: EmrClusterScaleDownBehavior
            ): software.amazon.awscdk.services.stepfunctions.tasks.EmrCreateCluster.EmrClusterScaleDownBehavior =
                wrapped.cdkObject
        }
    }
        ...
        internal constructor(
            ...
            override fun simpleScalingPolicyConfiguration():
                ...
                unwrap(this)
                    ...
                    .let(SimpleScalingPolicyConfigurationProperty::wrap)
        }
