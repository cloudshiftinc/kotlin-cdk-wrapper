...
internal constructor(
    ...
    public open fun postSetupScriptDetails(
        `value`: ScriptDetailsProperty.Builder.() -> Unit
    ): Unit = postSetupScriptDetails(ScriptDetailsProperty(`value`))
    ...
    public interface Builder {
        ...
        public fun postSetupScriptDetails(
            postSetupScriptDetails: ScriptDetailsProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
        ...
        override fun postSetupScriptDetails(postSetupScriptDetails: ScriptDetailsProperty) {
            cdkBuilder.postSetupScriptDetails(
                postSetupScriptDetails.let(ScriptDetailsProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("0261eb80ac8d55b73ee29b146ce1d646eb5819f177742e5c2f23ed9bbe524184")
        override fun postSetupScriptDetails(
            postSetupScriptDetails: ScriptDetailsProperty.Builder.() -> Unit
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("060d0dd50b3f7cd7d93df0c357873251449b8988d54269f8c6cce069f5039165")
        override fun sourceS3Location(
            sourceS3Location: S3LocationProperty.Builder.() -> Unit
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("b7acea0a2b75f58dc64d95ddd807c88fa359b8dae5432710bdd03baec04bf7e4")
        override fun upScriptDetails(
            setupScriptDetails: ScriptDetailsProperty.Builder.() -> Unit
        ): Unit = upScriptDetails(ScriptDetailsProperty(setupScriptDetails))

        public fun build(): software.amazon.awscdk.services.appstream.CfnAppBlock =
            cdkBuilder.build()
    }
    ...
    public companion object {
        ...
        ): CfnAppBlock = CfnAppBlock(cdkObject)

        internal fun unwrap(
            wrapped: CfnAppBlock
        ): software.amazon.awscdk.services.appstream.CfnAppBlock = wrapped.cdkObject
    }
    ...
    public interface S3LocationProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param s3Key The S3 key of the S3 object of the virtual hard disk. This is required
             *   when it's used by `SetupScriptDetails` and `PostSetupScriptDetails` .
             */
    ...
    public interface ScriptDetailsProperty {
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("fb15631ef25ec0ab9e92de22f1b2fbc0f3822a3921383f3efb5193afbdd6f4f0")
            override fun scriptS3Location(
                scriptS3Location: S3LocationProperty.Builder.() -> Unit
