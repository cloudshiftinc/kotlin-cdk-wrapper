...
internal constructor(
    ...
    public interface Builder {
         ...
         *   process. This is useful for diagnosing bottlenecks in a cache configuration.
         *
         ...
         *
         * @param healthMetricsConfig Controls how cache health metrics will be emitted to
         *   CloudWatch. Cache health metrics include:.
         */
         ...
         * is deprecated, and the generic identifiers above should be used.
         *
    ...
    public companion object {
        ...
        ): CfnApiCache = CfnApiCache(cdkObject)

        internal fun unwrap(
            wrapped: CfnApiCache
        ): software.amazon.awscdk.services.appsync.CfnApiCache = wrapped.cdkObject
    }
}
