...
internal constructor(
     ...
     * certificate (for example, `file:///home/user/.ssh/storage_sys_certificate.pem` ). The file
     * you specify must include the following:.
     */
    ...
    public interface Builder {
         ...
         *
         * @param agentArns Specifies the Amazon Resource Names (ARNs) of the DataSync agents that
         ...
         *
         * @param bucketName Specifies the name of the object storage bucket involved in the
         *   transfer.
         */
        ...
        /**
         * Specifies a file with the certificates that are used to sign the object storage server's
         * certificate (for example, `file:///home/user/.ssh/storage_sys_certificate.pem` ). The
         * file you specify must include the following:.
         ...
         *
         * @param serverHostname Specifies the domain name or IP address of the object storage
         *   server.
         */
         ...
         *
         * @param serverPort Specifies the port that your object storage server accepts inbound
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.datasync.CfnLocationObjectStorage.Builder.create(
                scope,
                id
            )
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnLocationObjectStorage
