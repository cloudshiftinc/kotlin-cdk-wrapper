...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.iam.Grant,
) : IDependable {
    /**
    ...
    public companion object {
        public fun addToPrincipal(options: GrantOnPrincipalOptions): Grant =
            software.amazon.awscdk.services.iam.Grant.addToPrincipal(
                    options.let(GrantOnPrincipalOptions::unwrap)
                )
                .let(Grant::wrap)
        ...
        public fun addToPrincipalAndResource(options: GrantOnPrincipalAndResourceOptions): Grant =
            software.amazon.awscdk.services.iam.Grant.addToPrincipalAndResource(
                    options.let(GrantOnPrincipalAndResourceOptions::unwrap)
                )
                .let(Grant::wrap)
        ...
        public fun addToPrincipalAndResource(
            options: GrantOnPrincipalAndResourceOptions.Builder.() -> Unit
        ...
        public fun addToPrincipalOrResource(options: GrantWithResourceOptions): Grant =
            software.amazon.awscdk.services.iam.Grant.addToPrincipalOrResource(
                    options.let(GrantWithResourceOptions::unwrap)
                )
                .let(Grant::wrap)
        ...
        public fun addToPrincipalOrResource(
            options: GrantWithResourceOptions.Builder.() -> Unit
        ): Grant = addToPrincipalOrResource(GrantWithResourceOptions(options))

        public fun drop(grantee: IGrantable, _intent: String): Grant =
            software.amazon.awscdk.services.iam.Grant.drop(grantee.let(IGrantable::unwrap), _intent)
                .let(Grant::wrap)
