...
internal constructor(
    ...
    public open fun launchSpecifications(`value`: InstanceFleetProvisioningSpecificationsProperty) {
        unwrap(this)
            .setLaunchSpecifications(
                `value`.let(InstanceFleetProvisioningSpecificationsProperty::unwrap)
            )
    }
    ...
    public open fun launchSpecifications(
        `value`: InstanceFleetProvisioningSpecificationsProperty.Builder.() -> Unit
    ...
    public interface Builder {
         ...
         * to fulfill On-Demand and Spot target capacities.
         *
         ...
         *
         * @param instanceTypeConfigs `InstanceTypeConfigs` determine the EC2 instances that Amazon
        ...
        public fun launchSpecifications(
            launchSpecifications: InstanceFleetProvisioningSpecificationsProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
        ...
        override fun launchSpecifications(
            ...
            cdkBuilder.launchSpecifications(
                launchSpecifications.let(InstanceFleetProvisioningSpecificationsProperty::unwrap)
            )
        }
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnInstanceFleetConfig
    ...
    public interface ConfigurationProperty {
        ...
        /**
         * Within a configuration classification, a set of properties that represent the settings
         * that you want to change in the configuration file.
         *
        ...
        public interface Builder {
            ...
            /**
             * @param configurationProperties Within a configuration classification, a set of
             *   properties that represent the settings that you want to change in the configuration
        ...
        internal constructor(
            ...
            /**
             * Within a configuration classification, a set of properties that represent the
             * settings that you want to change in the configuration file.
             *
             * Duplicates not allowed.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-emr-instancefleetconfig-configuration.html#cfn-emr-instancefleetconfig-configuration-configurationproperties)
    ...
    public interface InstanceTypeConfigProperty {
        ...
        public interface Builder {
             ...
             *   configurations for applications and software bundled with Amazon EMR. A
             *   configuration consists of a classification, properties, and optional nested
