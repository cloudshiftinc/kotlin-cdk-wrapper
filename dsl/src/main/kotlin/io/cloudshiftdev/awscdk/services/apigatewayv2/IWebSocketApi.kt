...
public interface IWebSocketApi : IApi {
  private class Wrapper internal constructor(
    internal val cdkObject: software.amazon.awscdk.services.apigatewayv2.IWebSocketApi,
  ) : IWebSocketApi {
    /**
  ...
  public companion object {
    ...
    internal fun wrap(cdkObject: software.amazon.awscdk.services.apigatewayv2.IWebSocketApi):
        IWebSocketApi = Wrapper(cdkObject)

    internal fun unwrap(wrapped: IWebSocketApi):
        software.amazon.awscdk.services.apigatewayv2.IWebSocketApi = (wrapped as Wrapper).cdkObject
  }
}
