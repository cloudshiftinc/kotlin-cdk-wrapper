...
public open class SecretRotation
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param vpcSubnets The type of subnets in the VPC where the Lambda rotation function will
         *   run.
         */
    ...
    public companion object {
        ...
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.secretsmanager.SecretRotation
        ): SecretRotation = SecretRotation(cdkObject)

        internal fun unwrap(
            wrapped: SecretRotation
