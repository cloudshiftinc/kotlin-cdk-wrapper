...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param fsxFilesystemArn The Amazon Resource Name (ARN) of the FSx for OpenZFS file
         *   system.
         */
         ...
         *
         * @param securityGroupArns The ARNs of the security groups that are used to configure the
    ...
    public interface MountOptionsProperty {
         ...
         * * *[NFSv4.0](https://docs.aws.amazon.com/https://tools.ietf.org/html/rfc3530)* :
        ...
        public interface Builder {
            /**
             * @param version The specific NFS version that you want DataSync to use to mount your
             *   NFS share. If the server refuses to use the version specified, the sync will fail.
             ...
             *
             * You can specify the following NFS versions:
             * * *[NFSv3](https://docs.aws.amazon.com/https://tools.ietf.org/html/rfc1813)* :
             ...
             *   file systems.
             * * *[NFSv4.1](https://docs.aws.amazon.com/https://tools.ietf.org/html/rfc5661)* :
             *   Stateful protocol version that supports sessions, directory delegations, and
             *   parallel data processing. Version 4.1 also includes all features available in
             *   version 4.0.
             */
    ...
    public interface ProtocolProperty {
        /**
         * Represents the Network File System (NFS) protocol that DataSync uses to access your FSx
        ...
        public interface Builder {
            /**
             * @param nfs Represents the Network File System (NFS) protocol that DataSync uses to
    ...
    public interface NFSProperty {
        ...
        public interface Builder {
            /**
             * @param mountOptions Represents the mount options that are available for DataSync to
