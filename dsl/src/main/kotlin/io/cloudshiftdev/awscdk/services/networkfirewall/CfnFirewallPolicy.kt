...
internal constructor(
    ...
    private class BuilderImpl(
        ...
        private val cdkBuilder:
            ...
            software.amazon.awscdk.services.networkfirewall.CfnFirewallPolicy.Builder.create(
                scope,
                id
            )
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("3fee919add41f58ca28ef0fb97d6fecde780687581df81b1424651353d73dd1c")
        override fun firewallPolicy(
            firewallPolicy: FirewallPolicyProperty.Builder.() -> Unit
    ...
    public interface StatefulEngineOptionsProperty {
         ...
         * * `CONTINUE` - Network Firewall continues to apply rules to the subsequent traffic
         *   without context from traffic before the break. This impacts the behavior of rules that
         *   depend on this context. For example, if you have a stateful rule to `drop http`
         ...
         *   protocol as HTTP. However, this behavior is rule dependent—a TCP-layer rule using a
         ...
         *   firewall. Network Firewall also sends a TCP reject packet back to your client so that
         *   the client can immediately establish a new session. Network Firewall will have context
         *   about the new session and will apply rules to the subsequent traffic.
         *
        ...
        public interface Builder {
            /**
             * @param ruleOrder Indicates how to manage the order of stateful rule evaluation for
             *   the policy. `DEFAULT_ACTION_ORDER` is the default behavior. Stateful rules are
             ...
             *   network connection breaks midstream. Network connections can break due to
             *   disruptions in external networks or within the firewall itself.
             * * `DROP` - Network Firewall fails closed and drops all subsequent traffic going to
             *   the firewall. This is the default behavior.
             * * `CONTINUE` - Network Firewall continues to apply rules to the subsequent traffic
             *   without context from traffic before the break. This impacts the behavior of rules
             *   that depend on this context. For example, if you have a stateful rule to `drop
             *   http` traffic, Network Firewall won't match the traffic for this rule because the
             *   service won't have the context from session initialization defining the application
             *   layer protocol as HTTP. However, this behavior is rule dependent—a TCP-layer rule
             *   using a `flow:stateless` rule would still match, as would the `aws:drop_strict`
             *   default action.
             * * `REJECT` - Network Firewall fails closed and drops all subsequent traffic going to
             *   the firewall. Network Firewall also sends a TCP reject packet back to your client
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: StatefulEngineOptionsProperty
            ): software.amazon.awscdk.services.networkfirewall.CfnFirewallPolicy.StatefulEngineOptionsProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface StatelessRuleGroupReferenceProperty {
         ...
         * a single `FirewallPolicy` .
         *
         * Network Firewall applies each stateless rule group to a packet starting with the group
         * that has the lowest priority setting. You must ensure that the priority settings are
         * unique within each policy.
         *
        ...
        public interface Builder {
            /**
             * @param priority An integer setting that indicates the order in which to run the
             *   stateless rule groups in a single `FirewallPolicy` . Network Firewall applies each
             *   stateless rule group to a packet starting with the group that has the lowest
             *   priority setting. You must ensure that the priority settings are unique within each
             *   policy.
             */
        ...
        internal constructor(
             ...
             * in a single `FirewallPolicy` .
             *
             * Network Firewall applies each stateless rule group to a packet starting with the
             * group that has the lowest priority setting. You must ensure that the priority
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: StatelessRuleGroupReferenceProperty
            ): software.amazon.awscdk.services.networkfirewall.CfnFirewallPolicy.StatelessRuleGroupReferenceProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface StatefulRuleGroupReferenceProperty {
        ...
        public interface Builder {
            /**
             * @param override The action that allows the policy owner to override the behavior of
            ...
            /**
             * @param priority An integer setting that indicates the order in which to run the
             *   stateful rule groups in a single `FirewallPolicy` . This setting only applies to
             *   firewall policies that specify the `STRICT_ORDER` rule order in the stateful engine
             *   options settings.
             *
             * Network Firewall evalutes each stateful rule group against a packet starting with the
             * group that has the lowest priority setting. You must ensure that the priority
        ...
        private class BuilderImpl : Builder {
            ...
            override fun `override`(
                `override`: StatefulRuleGroupOverrideProperty.Builder.() -> Unit
        ...
        internal constructor(
             ...
             * in a single `FirewallPolicy` .
             *
             * This setting only applies to firewall policies that specify the `STRICT_ORDER` rule
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: StatefulRuleGroupReferenceProperty
            ): software.amazon.awscdk.services.networkfirewall.CfnFirewallPolicy.StatefulRuleGroupReferenceProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface PolicyVariablesProperty {
        ...
        public interface Builder {
            /**
             * @param ruleVariables The IPv4 or IPv6 addresses in CIDR notation to use for the
             *   Suricata `HOME_NET` variable. If your firewall uses an inspection VPC, you might
             *   want to override the `HOME_NET` variable with the CIDRs of your home networks. If
             *   you don't override `HOME_NET` with your own CIDRs, Network Firewall by default uses
        ...
        internal constructor(
             ...
             *
             * If your firewall uses an inspection VPC, you might want to override the `HOME_NET`
             * variable with the CIDRs of your home networks. If you don't override `HOME_NET` with
             * your own CIDRs, Network Firewall by default uses the CIDR of your inspection VPC.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-networkfirewall-firewallpolicy-policyvariables.html#cfn-networkfirewall-firewallpolicy-policyvariables-rulevariables)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: PolicyVariablesProperty
            ): software.amazon.awscdk.services.networkfirewall.CfnFirewallPolicy.PolicyVariablesProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface FirewallPolicyProperty {
         ...
         */
        public fun statefulDefaultActions(): List<String> =
         ...
         */
        public fun statefulRuleGroupReferences(): Any? =
         ...
         */
        public fun statelessRuleGroupReferences(): Any? =
        ...
        public interface Builder {
            /**
             * @param policyVariables Contains variables that you can use to override default
            ...
            /**
             * @param statefulDefaultActions The default actions to take on a packet that doesn't
             *   match any stateful rules. The stateful default action is optional, and is only
            ...
            /**
             * @param statefulEngineOptions Additional options governing how Network Firewall
             *   handles stateful rules. The stateful rule groups that you use in your policy must
             *   have stateful rule options settings that are compatible with these settings.
             */
            ...
            public fun statefulEngineOptions(
                statefulEngineOptions: StatefulEngineOptionsProperty.Builder.() -> Unit
            )

            /**
             * @param statefulRuleGroupReferences References to the stateful rule groups that are
             *   used in the policy. These define the inspection criteria in stateful rules.
             */
            ...
            /**
             * @param statelessCustomActions The custom action definitions that are available for
             *   use in the firewall policy's `StatelessDefaultActions` setting. You name each
             *   custom action that you define, and then you can use it by name in your default
            ...
            /**
             * @param statelessDefaultActions The actions to take on a packet if it doesn't match
             *   any of the stateless rules in the policy. If you want non-matching packets to be
            ...
            /**
             * @param statelessFragmentDefaultActions The actions to take on a fragmented packet if
             *   it doesn't match any of the stateless rules in the policy. If you want non-matching
             ...
             * descriptions.
             */
            public fun statelessFragmentDefaultActions(
             ...
             */
            public fun statelessFragmentDefaultActions(
                vararg statelessFragmentDefaultActions: String
            )

            /**
             * @param statelessRuleGroupReferences References to the stateless rule groups that are
             *   used in the policy. These define the matching criteria in stateless rules.
             */
            ...
            /**
             * @param tlsInspectionConfigurationArn The Amazon Resource Name (ARN) of the TLS
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("2c1e79b0909d69ac9f8ec9ad77f008dfbf4f5d3aeef304c8d026900b1495d164")
            override fun policyVariables(
                policyVariables: PolicyVariablesProperty.Builder.() -> Unit
             ...
             *   have stateful rule options settings that are compatible with these settings.
             */
            override fun statefulEngineOptions(
                statefulEngineOptions: StatefulEngineOptionsProperty
            ) {
                cdkBuilder.statefulEngineOptions(
                    statefulEngineOptions.let(StatefulEngineOptionsProperty::unwrap)
                )
            }
            ...
            override fun statefulRuleGroupReferences(statefulRuleGroupReferences: IResolvable) {
                cdkBuilder.statefulRuleGroupReferences(
                    statefulRuleGroupReferences.let(IResolvable::unwrap)
                )
            }
             ...
             *   used in the policy. These define the inspection criteria in stateful rules.
             */
            override fun statefulRuleGroupReferences(
                vararg statefulRuleGroupReferences: Any
            ): Unit = statefulRuleGroupReferences(statefulRuleGroupReferences.toList())
             ...
             * descriptions.
             */
            override fun statelessFragmentDefaultActions(
                statelessFragmentDefaultActions: List<String>
            ) {
            ...
            override fun statelessRuleGroupReferences(statelessRuleGroupReferences: IResolvable) {
                cdkBuilder.statelessRuleGroupReferences(
                    statelessRuleGroupReferences.let(IResolvable::unwrap)
                )
            }
             ...
             *   used in the policy. These define the matching criteria in stateless rules.
             */
            override fun statelessRuleGroupReferences(
                vararg statelessRuleGroupReferences: Any
            ): Unit = statelessRuleGroupReferences(statelessRuleGroupReferences.toList())
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-networkfirewall-firewallpolicy-firewallpolicy.html#cfn-networkfirewall-firewallpolicy-firewallpolicy-statefuldefaultactions)
             */
            override fun statefulDefaultActions(): List<String> =
                unwrap(this).getStatefulDefaultActions() ?: emptyList()
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: FirewallPolicyProperty
            ): software.amazon.awscdk.services.networkfirewall.CfnFirewallPolicy.FirewallPolicyProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface StatefulRuleGroupOverrideProperty {
        ...
        public interface Builder {
            /**
             * @param action The action that changes the rule group from `DROP` to `ALERT` . This
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: StatefulRuleGroupOverrideProperty
            ): software.amazon.awscdk.services.networkfirewall.CfnFirewallPolicy.StatefulRuleGroupOverrideProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
