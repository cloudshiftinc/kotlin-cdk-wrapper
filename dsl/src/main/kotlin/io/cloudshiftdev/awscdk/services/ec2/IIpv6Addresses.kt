...
public interface IIpv6Addresses {
  ...
  private class Wrapper internal constructor(
    internal val cdkObject: software.amazon.awscdk.services.ec2.IIpv6Addresses,
  ) : IIpv6Addresses {
    public override fun allocateSubnetsIpv6Cidr(arg0: AllocateIpv6CidrRequest): SubnetIpamOptions =
        unwrap(this).allocateSubnetsIpv6Cidr(arg0.let(AllocateIpv6CidrRequest::unwrap)).let(SubnetIpamOptions::wrap)

    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("b11eafea023bf232cdcf7b16ae5e1c33fde28cdffb7726ed3679ccbd5c38e319")
    public override fun allocateSubnetsIpv6Cidr(arg0: AllocateIpv6CidrRequest.Builder.() -> Unit):
        SubnetIpamOptions = allocateSubnetsIpv6Cidr(AllocateIpv6CidrRequest(arg0))

    public override fun allocateVpcIpv6Cidr(arg0: AllocateVpcIpv6CidrRequest): CfnVPCCidrBlock =
        unwrap(this).allocateVpcIpv6Cidr(arg0.let(AllocateVpcIpv6CidrRequest::unwrap)).let(CfnVPCCidrBlock::wrap)

    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("543a72d089263d71a3d77af2e66d9e0082d97d5c4b524095d1b8e9d1acaca31c")
    public override fun allocateVpcIpv6Cidr(arg0: AllocateVpcIpv6CidrRequest.Builder.() -> Unit):
        CfnVPCCidrBlock = allocateVpcIpv6Cidr(AllocateVpcIpv6CidrRequest(arg0))

    public override fun amazonProvided(): Boolean = unwrap(this).getAmazonProvided()

    public override fun amazonProvided(arg0: Boolean) {
      unwrap(this).setAmazonProvided(arg0)
    }

    public override fun createIpv6CidrBlocks(arg0: CreateIpv6CidrBlocksRequest): List<String> =
        unwrap(this).createIpv6CidrBlocks(arg0.let(CreateIpv6CidrBlocksRequest::unwrap)) ?:
        emptyList()

    @Suppress("INAPPLICABLE_JVM_NAME")
    @JvmName("d2abe7832c051bc6bb30a8c48bbd31a9320e5be2c4c7819500bd41b1f161a206")
    public override fun createIpv6CidrBlocks(arg0: CreateIpv6CidrBlocksRequest.Builder.() -> Unit):
