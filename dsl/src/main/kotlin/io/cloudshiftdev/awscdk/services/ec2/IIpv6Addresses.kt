...
public interface IIpv6Addresses {
    ...
    public fun allocateSubnetsIpv6Cidr(
        input: AllocateIpv6CidrRequest.Builder.() -> Unit
    ): SubnetIpamOptions
    ...
    public fun allocateVpcIpv6Cidr(
        input: AllocateVpcIpv6CidrRequest.Builder.() -> Unit
    ): CfnVPCCidrBlock
    ...
    public fun createIpv6CidrBlocks(
        input: CreateIpv6CidrBlocksRequest.Builder.() -> Unit
    ): List<String>
    ...
    internal constructor(
        ...
        override fun allocateSubnetsIpv6Cidr(input: AllocateIpv6CidrRequest): SubnetIpamOptions =
            unwrap(this)
                .allocateSubnetsIpv6Cidr(input.let(AllocateIpv6CidrRequest::unwrap))
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("b11eafea023bf232cdcf7b16ae5e1c33fde28cdffb7726ed3679ccbd5c38e319")
        override fun allocateSubnetsIpv6Cidr(
            input: AllocateIpv6CidrRequest.Builder.() -> Unit
        ...
        override fun allocateVpcIpv6Cidr(input: AllocateVpcIpv6CidrRequest): CfnVPCCidrBlock =
            unwrap(this)
                .allocateVpcIpv6Cidr(input.let(AllocateVpcIpv6CidrRequest::unwrap))
                .let(CfnVPCCidrBlock::wrap)
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("543a72d089263d71a3d77af2e66d9e0082d97d5c4b524095d1b8e9d1acaca31c")
        override fun allocateVpcIpv6Cidr(
            input: AllocateVpcIpv6CidrRequest.Builder.() -> Unit
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("d2abe7832c051bc6bb30a8c48bbd31a9320e5be2c4c7819500bd41b1f161a206")
        override fun createIpv6CidrBlocks(
            input: CreateIpv6CidrBlocksRequest.Builder.() -> Unit
    ...
    public companion object {
        ...
        ): IIpv6Addresses = Wrapper(cdkObject)

        internal fun unwrap(
            wrapped: IIpv6Addresses
        ): software.amazon.awscdk.services.ec2.IIpv6Addresses = (wrapped as Wrapper).cdkObject
    }
}
