...
public enum class JsonSchemaVersion(
  ...
  public companion object {
    internal fun wrap(cdkObject: software.amazon.awscdk.services.apigateway.JsonSchemaVersion):
        JsonSchemaVersion = when (cdkObject) {
    ...
    internal fun unwrap(wrapped: JsonSchemaVersion):
