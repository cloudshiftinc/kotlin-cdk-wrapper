...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param assetHierarchies A list of asset hierarchies that each contain a
         *   `hierarchyLogicalId` .
         */
         ...
         * external ID, if it has one. For more information, see
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.iotsitewise.CfnAsset =
            cdkBuilder.build()
    }
    ...
    public companion object {
        ...
        internal fun unwrap(
            wrapped: CfnAsset
        ): software.amazon.awscdk.services.iotsitewise.CfnAsset = wrapped.cdkObject
    }
    ...
    public interface AssetHierarchyProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AssetHierarchyProperty
            ): software.amazon.awscdk.services.iotsitewise.CfnAsset.AssetHierarchyProperty =
    ...
    public interface AssetPropertyProperty {
        ...
        public interface Builder {
            /**
             * @param alias The property alias that identifies the property, such as an OPC-UA
            ...
            /**
             * @param logicalId The `LogicalID` of the asset property. The maximum length is 256
             *   characters, with the pattern `[^\u0000-\u001F\u007F]+` .
             */
            public fun logicalId(logicalId: String)

            /**
             * @param notificationState The MQTT notification state ( `ENABLED` or `DISABLED` ) for
             *   this asset property. When the notification state is `ENABLED` , AWS IoT SiteWise
             *   publishes property value updates to a unique MQTT topic. For more information, see
             *   [Interacting with other services](https://docs.aws.amazon.com/iot-sitewise/latest/userguide/interact-with-other-services.html)
             *   in the *AWS IoT SiteWise User Guide* .
             *
             * If you omit this parameter, the notification state is set to `DISABLED` .
             *
             * You must use all caps for the NotificationState parameter. If you use lower case
             * letters, you will receive a schema validation error.
             */
