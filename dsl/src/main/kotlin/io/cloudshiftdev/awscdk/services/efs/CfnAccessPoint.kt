...
internal constructor(
    ...
    public interface Builder {
         ...
         *
         * @param clientToken The opaque string specified in the request to ensure idempotent
         *   creation.
         */
         ...
         *   group IDs on the access point that is used for all file operations by NFS clients using
         *   the access point.
         */
         ...
         *
         * @param rootDirectory The directory on the EFS file system that the access point exposes
    ...
    public companion object {
        ...
        ): software.amazon.awscdk.services.efs.CfnAccessPoint = wrapped.cdkObject
    }
    ...
    public interface RootDirectoryProperty {
         ...
         * directory using the `CreationInfo` settings when a client connects to an access point.
        ...
        public interface Builder {
            /**
             * @param creationInfo (Optional) Specifies the POSIX IDs and permissions to apply to
             *   the access point's `RootDirectory` . If the `RootDirectory` &gt; `Path` specified
             *   does not exist, EFS creates the root directory using the `CreationInfo` settings
             *   when a client connects to an access point. When specifying the `CreationInfo` , you
            ...
            /**
             * @param path Specifies the path on the EFS file system to expose as the root directory
    ...
    public interface AccessPointTagProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AccessPointTagProperty
            ): software.amazon.awscdk.services.efs.CfnAccessPoint.AccessPointTagProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface CreationInfoProperty {
        ...
        /**
         * Specifies the POSIX permissions to apply to the `RootDirectory` , in the format of an
        ...
        public interface Builder {
            ...
            /**
             * @param ownerUid Specifies the POSIX user ID to apply to the `RootDirectory` . Accepts
             *   values from 0 to 2^32 (4294967295).
             */
            public fun ownerUid(ownerUid: String)

            /**
             * @param permissions Specifies the POSIX permissions to apply to the `RootDirectory` ,
    ...
    public interface PosixUserProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param secondaryGids Secondary POSIX group IDs used for all file system operations
            ...
            /**
             * @param uid The POSIX user ID used for all file system operations using this access
             *   point.
             */
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-efs-accesspoint-posixuser.html#cfn-efs-accesspoint-posixuser-secondarygids)
             */
            override fun secondaryGids(): List<String> =
                unwrap(this).getSecondaryGids() ?: emptyList()
