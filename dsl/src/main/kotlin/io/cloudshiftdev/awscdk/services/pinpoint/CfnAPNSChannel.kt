...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.pinpoint.CfnAPNSChannel,
    ...
    public interface Builder {
        /**
         * The unique identifier for the Amazon Pinpoint application that the APNs channel applies
         * to.
         *
    ...
    private class BuilderImpl(
        ...
        public fun build(): software.amazon.awscdk.services.pinpoint.CfnAPNSChannel =
            cdkBuilder.build()
    }
