...
public interface OAuthFlows {
    ...
    public interface Builder {
        /**
         * @param authorizationCodeGrant Initiate an authorization code grant flow, which provides
         *   an authorization code as the response.
         */
    ...
    internal constructor(
        ...
        /**
         * Client should get the access token and ID token from the token endpoint using a
    ...
    public companion object {
        ...
        ): OAuthFlows = Wrapper(cdkObject)

        internal fun unwrap(
            wrapped: OAuthFlows
        ): software.amazon.awscdk.services.cognito.OAuthFlows = (wrapped as Wrapper).cdkObject
    }
}
