...
internal constructor(
    ...
    public open fun outboundCallConfig(
        `value`: OutboundCallConfigProperty.Builder.() -> Unit
    ): Unit = outboundCallConfig(OutboundCallConfigProperty(`value`))
    ...
    public interface Builder {
        ...
        public fun outboundCallConfig(
            outboundCallConfig: OutboundCallConfigProperty.Builder.() -> Unit
        )
    ...
    private class BuilderImpl(
        ...
        override fun outboundCallConfig(outboundCallConfig: OutboundCallConfigProperty) {
            cdkBuilder.outboundCallConfig(
                outboundCallConfig.let(OutboundCallConfigProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("c8c96dc62df14c4127f1ecaff294064aab077816c13f7001d89338b6c13ff5b9")
        override fun outboundCallConfig(
            outboundCallConfig: OutboundCallConfigProperty.Builder.() -> Unit
    ...
    public interface AnswerMachineDetectionConfigProperty {
        ...
        private class BuilderImpl : Builder {
            ...
            override fun enableAnswerMachineDetection(enableAnswerMachineDetection: IResolvable) {
                cdkBuilder.enableAnswerMachineDetection(
                    enableAnswerMachineDetection.let(IResolvable::unwrap)
                )
            }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AnswerMachineDetectionConfigProperty
            ): software.amazon.awscdk.services.connectcampaigns.CfnCampaign.AnswerMachineDetectionConfigProperty =
    ...
    public interface AgentlessDialerConfigProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AgentlessDialerConfigProperty
            ): software.amazon.awscdk.services.connectcampaigns.CfnCampaign.AgentlessDialerConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface OutboundCallConfigProperty {
         ...
         */
        public fun answerMachineDetectionConfig(): Any? =
        ...
        public interface Builder {
            /**
             * @param answerMachineDetectionConfig Whether answering machine detection has been
             *   enabled.
             */
            ...
            public fun answerMachineDetectionConfig(
                answerMachineDetectionConfig:
                    AnswerMachineDetectionConfigProperty.Builder.() -> Unit
            )
        ...
        private class BuilderImpl : Builder {
            ...
            override fun answerMachineDetectionConfig(answerMachineDetectionConfig: IResolvable) {
                cdkBuilder.answerMachineDetectionConfig(
                    answerMachineDetectionConfig.let(IResolvable::unwrap)
                )
            }
             ...
             *   enabled.
             */
            override fun answerMachineDetectionConfig(
                answerMachineDetectionConfig: AnswerMachineDetectionConfigProperty
            ) {
                cdkBuilder.answerMachineDetectionConfig(
                    answerMachineDetectionConfig.let(AnswerMachineDetectionConfigProperty::unwrap)
                )
            }
            ...
            override fun answerMachineDetectionConfig(
                ...
                answerMachineDetectionConfig(
                    AnswerMachineDetectionConfigProperty(answerMachineDetectionConfig)
                )
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-connectcampaigns-campaign-outboundcallconfig.html#cfn-connectcampaigns-campaign-outboundcallconfig-connectsourcephonenumber)
             */
            override fun connectSourcePhoneNumber(): String? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: OutboundCallConfigProperty
            ): software.amazon.awscdk.services.connectcampaigns.CfnCampaign.OutboundCallConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DialerConfigProperty {
        ...
        public interface Builder {
            ...
            public fun agentlessDialerConfig(
                agentlessDialerConfig: AgentlessDialerConfigProperty.Builder.() -> Unit
            )
            ...
            public fun predictiveDialerConfig(
                predictiveDialerConfig: PredictiveDialerConfigProperty.Builder.() -> Unit
            )
            ...
            public fun progressiveDialerConfig(
                progressiveDialerConfig: ProgressiveDialerConfigProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
            ...
            /** @param agentlessDialerConfig The configuration of the agentless dialer. */
            override fun agentlessDialerConfig(
                agentlessDialerConfig: AgentlessDialerConfigProperty
            ) {
                cdkBuilder.agentlessDialerConfig(
                    agentlessDialerConfig.let(AgentlessDialerConfigProperty::unwrap)
                )
            }
            ...
            /** @param predictiveDialerConfig The configuration of the predictive dialer. */
            override fun predictiveDialerConfig(
                predictiveDialerConfig: PredictiveDialerConfigProperty
            ) {
                cdkBuilder.predictiveDialerConfig(
                    predictiveDialerConfig.let(PredictiveDialerConfigProperty::unwrap)
                )
            }
            ...
            /** @param progressiveDialerConfig The configuration of the progressive dialer. */
            override fun progressiveDialerConfig(
                progressiveDialerConfig: ProgressiveDialerConfigProperty
            ) {
                cdkBuilder.progressiveDialerConfig(
                    progressiveDialerConfig.let(ProgressiveDialerConfigProperty::unwrap)
                )
            }
            ...
            override fun progressiveDialerConfig(
                ...
                progressiveDialerConfig(ProgressiveDialerConfigProperty(progressiveDialerConfig))
    ...
    public interface PredictiveDialerConfigProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: PredictiveDialerConfigProperty
            ): software.amazon.awscdk.services.connectcampaigns.CfnCampaign.PredictiveDialerConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface ProgressiveDialerConfigProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ProgressiveDialerConfigProperty
            ): software.amazon.awscdk.services.connectcampaigns.CfnCampaign.ProgressiveDialerConfigProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
