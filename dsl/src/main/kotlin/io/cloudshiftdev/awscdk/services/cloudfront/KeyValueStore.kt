...
internal constructor(
    private val cdkObject: software.amazon.awscdk.services.cloudfront.KeyValueStore,
    ...
    public companion object {
        public fun fromKeyValueStoreArn(
            ...
            software.amazon.awscdk.services.cloudfront.KeyValueStore.fromKeyValueStoreArn(
                    scope.let(CloudshiftdevConstructsConstruct::unwrap),
                    id,
                    keyValueStoreArn
                )
                .let(IKeyValueStore::wrap)
