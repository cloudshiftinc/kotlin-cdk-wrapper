...
internal constructor(
    ...
    public companion object {
        public fun fromKinesisStream(stream: IStream): Endpoint =
            software.amazon.awscdk.services.cloudfront.Endpoint.fromKinesisStream(
                    stream.let(IStream::unwrap)
                )
                .let(Endpoint::wrap)
        ...
        ): Endpoint = Wrapper(cdkObject)

        internal fun unwrap(
            wrapped: Endpoint
        ): software.amazon.awscdk.services.cloudfront.Endpoint = (wrapped as Wrapper).cdkObject
    }
}
