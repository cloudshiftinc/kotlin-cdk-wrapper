...
internal constructor(
    ...
    public open fun alarmConfiguration(
        `value`: AlarmConfigurationProperty.Builder.() -> Unit
    ): Unit = alarmConfiguration(AlarmConfigurationProperty(`value`))
    ...
    public open fun autoRollbackConfiguration(`value`: AutoRollbackConfigurationProperty) {
        unwrap(this)
            .setAutoRollbackConfiguration(`value`.let(AutoRollbackConfigurationProperty::unwrap))
    }
    ...
    public open fun autoRollbackConfiguration(
        `value`: AutoRollbackConfigurationProperty.Builder.() -> Unit
     ...
     */
    public open fun autoScalingGroups(): List<String> =
        unwrap(this).getAutoScalingGroups() ?: emptyList()
    ...
    /** Information about blue/green deployment options for a deployment group. */
    public open fun blueGreenDeploymentConfiguration(
        `value`: BlueGreenDeploymentConfigurationProperty
    ) {
        unwrap(this)
            .setBlueGreenDeploymentConfiguration(
                `value`.let(BlueGreenDeploymentConfigurationProperty::unwrap)
            )
    }
    ...
    public open fun blueGreenDeploymentConfiguration(
        `value`: BlueGreenDeploymentConfigurationProperty.Builder.() -> Unit
     ...
     */
    public open fun outdatedInstancesStrategy(): String? =
        unwrap(this).getOutdatedInstancesStrategy()
    ...
    public interface Builder {
        /**
         * Information about the Amazon CloudWatch alarms that are associated with the deployment
         * group.
         *
         ...
         *
         * @param alarmConfiguration Information about the Amazon CloudWatch alarms that are
        ...
        public fun alarmConfiguration(
            alarmConfiguration: AlarmConfigurationProperty.Builder.() -> Unit
        )
         ...
         *
         * @param autoRollbackConfiguration Information about the automatic rollback configuration
         *   that is associated with the deployment group.
         */
        ...
        public fun autoRollbackConfiguration(
            autoRollbackConfiguration: AutoRollbackConfigurationProperty.Builder.() -> Unit
        )
         ...
         *
         * @param blueGreenDeploymentConfiguration Information about blue/green deployment options
        ...
        public fun blueGreenDeploymentConfiguration(
            blueGreenDeploymentConfiguration:
                BlueGreenDeploymentConfigurationProperty.Builder.() -> Unit
        )
         ...
         * that ID for the deployment group name. For more information, see
         ...
         *
         * @param deploymentStyle Attributes that determine the type of deployment to run and
         ...
         * include in the deployment group.
         *
         * CodeDeploy includes all on-premises instances identified by any of the tags you specify
         * in this deployment group. To register on-premises instances with CodeDeploy , see
         ...
         * Information about groups of tags applied to on-premises instances.
         *
         * The deployment group includes only on-premises instances identified by all the tag
         * groups.
         *
         * You can specify `OnPremisesInstanceTagFilters` or `OnPremisesInstanceTagSet` , but not
         * both.
         ...
         *
         * @param onPremisesTagSet Information about groups of tags applied to on-premises
         *   instances.
         */
         ...
         * to AWS services on your behalf.
         *
         * For more information, see
         ...
         *
         * @param terminationHookEnabled Indicates whether the deployment group was configured to
         *   have CodeDeploy install a termination hook into an Auto Scaling group.
         */
         ...
         *
         * @param triggerConfigurations Information about triggers associated with the deployment
         *   group.
         */
    ...
    private class BuilderImpl(
        ...
        override fun alarmConfiguration(alarmConfiguration: AlarmConfigurationProperty) {
            cdkBuilder.alarmConfiguration(
                alarmConfiguration.let(AlarmConfigurationProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("aaabeeab4581656bbebb3208c6cdea0aae45a6bf07c78a71fb729a258f91c91a")
        override fun alarmConfiguration(
            alarmConfiguration: AlarmConfigurationProperty.Builder.() -> Unit
         ...
         *   that is associated with the deployment group.
         */
        override fun autoRollbackConfiguration(
            autoRollbackConfiguration: AutoRollbackConfigurationProperty
        ) {
            cdkBuilder.autoRollbackConfiguration(
                autoRollbackConfiguration.let(AutoRollbackConfigurationProperty::unwrap)
            )
        }
         ...
         *   for a deployment group.
         */
        override fun blueGreenDeploymentConfiguration(
            blueGreenDeploymentConfiguration: IResolvable
        ) {
            cdkBuilder.blueGreenDeploymentConfiguration(
                blueGreenDeploymentConfiguration.let(IResolvable::unwrap)
            )
        }
        ...
        override fun blueGreenDeploymentConfiguration(
            ...
            cdkBuilder.blueGreenDeploymentConfiguration(
                blueGreenDeploymentConfiguration.let(
                    BlueGreenDeploymentConfigurationProperty::unwrap
                )
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("82d29e4efa135c378ca780a21a52f1ba7ea5f1da54cdc238ff026427ece0c8c8")
        override fun deploymentStyle(
            deploymentStyle: DeploymentStyleProperty.Builder.() -> Unit
        ): Unit = deploymentStyle(DeploymentStyleProperty(deploymentStyle))
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("63ea21af9e88672f0b3f438512b6a6822f34dcad7b1d768041196d4793cb77c2")
        override fun loadBalancerInfo(
            loadBalancerInfo: LoadBalancerInfoProperty.Builder.() -> Unit
        ...
        override fun onPremisesInstanceTagFilters(onPremisesInstanceTagFilters: IResolvable) {
            cdkBuilder.onPremisesInstanceTagFilters(
                onPremisesInstanceTagFilters.let(IResolvable::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("46ec1715e6a5b2ceb83f042d6b64ce3eaa0be7b5d73543e2c05f1e81bfc056b1")
        override fun onPremisesTagSet(
            onPremisesTagSet: OnPremisesTagSetProperty.Builder.() -> Unit
    ...
    public interface RevisionLocationProperty {
         ...
         * * AppSpecContent: An `AppSpecContent` object that contains the contents of an AppSpec
         *   file for an AWS Lambda or Amazon ECS deployment. The content is formatted as JSON or
        ...
        public interface Builder {
            /**
             * @param gitHubLocation Information about the location of application artifacts stored
             *   in GitHub.
             */
             ...
             * * String: A YAML-formatted or JSON-formatted string ( AWS Lambda deployments only).
             * * AppSpecContent: An `AppSpecContent` object that contains the contents of an AppSpec
             *   file for an AWS Lambda or Amazon ECS deployment. The content is formatted as JSON
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("295eb37669b09d2143e3b47e57f08cf96ceacbc38a9c4a6d7cd170c4e70caa75")
            override fun gitHubLocation(
                gitHubLocation: GitHubLocationProperty.Builder.() -> Unit
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: RevisionLocationProperty
            ): software.amazon.awscdk.services.codedeploy.CfnDeploymentGroup.RevisionLocationProperty =
    ...
    public interface AutoRollbackConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param enabled Indicates whether a defined automatic rollback configuration is
             *   currently enabled.
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AutoRollbackConfigurationProperty
            ): software.amazon.awscdk.services.codedeploy.CfnDeploymentGroup.AutoRollbackConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DeploymentStyleProperty {
         ...
         *
         * An Amazon EC2 Application Load Balancer or Network Load Balancer is required for an
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DeploymentStyleProperty
            ): software.amazon.awscdk.services.codedeploy.CfnDeploymentGroup.DeploymentStyleProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface LoadBalancerInfoProperty {
         ...
         * Balancers or Network Load Balancers, use the `targetGroupInfoList` array instead of this
         * one.
         *
        ...
        public interface Builder {
            /**
             * @param elbInfoList An array that contains information about the load balancers to use
             *   for load balancing in a deployment. If you're using Classic Load Balancers, specify
             *   those load balancers in this array.
             *
             * You can add up to 10 load balancers to the array. &gt; If you're using Application
             * Load Balancers or Network Load Balancers, use the `targetGroupInfoList` array instead
             * of this one.
             */
            ...
            /**
             * @param targetGroupInfoList An array that contains information about the target groups
             *   to use for load balancing in a deployment. If you're using Application Load
             *   Balancers and Network Load Balancers, specify their associated target groups in
             *   this array.
             *
             * You can add up to 10 target groups to the array. &gt; If you're using Classic Load
             * Balancers, use the `elbInfoList` array instead of this one.
        ...
        private class BuilderImpl : Builder {
             ...
             * of this one.
             */
            override fun elbInfoList(vararg elbInfoList: Any): Unit =
                elbInfoList(elbInfoList.toList())
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: LoadBalancerInfoProperty
            ): software.amazon.awscdk.services.codedeploy.CfnDeploymentGroup.LoadBalancerInfoProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface DeploymentProperty {
         ...
         * next deployment lifecycle event.
         *
         ...
         * from the previous successful deployment. (All other scripts are run from the AppSpec file
         * in the current deployment.) If one of these scripts contains an error and does not run
        ...
        public interface Builder {
             ...
             *   instance fails, then the deployment continues to the next deployment lifecycle
             *   event. For example, if `ApplicationStop` fails, the deployment continues with
            ...
            /**
             * @param revision Information about the location of stored application artifacts and
        ...
        private class BuilderImpl : Builder {
            ...
            override fun ignoreApplicationStopFailures(ignoreApplicationStopFailures: IResolvable) {
                cdkBuilder.ignoreApplicationStopFailures(
                    ignoreApplicationStopFailures.let(IResolvable::unwrap)
                )
            }
    ...
    public interface DeploymentReadyOptionProperty {
        ...
        public interface Builder {
             ...
             *   rerouting is started using
             *   [ContinueDeployment](https://docs.aws.amazon.com/codedeploy/latest/APIReference/API_ContinueDeployment.html)
             *   . If traffic rerouting is not started before the end of the specified wait period,
             *   the deployment status is changed to Stopped.
             */
            public fun actionOnTimeout(actionOnTimeout: String)

            /**
             * @param waitTimeInMinutes The number of minutes to wait before the status of a
             *   blue/green deployment is changed to Stopped if rerouting is not started manually.
             *   Applies only to the `STOP_DEPLOYMENT` option for `actionOnTimeout` .
             */
        ...
        internal constructor(
             ...
             * to Stopped if rerouting is not started manually.
             *
             * Applies only to the `STOP_DEPLOYMENT` option for `actionOnTimeout` .
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-codedeploy-deploymentgroup-deploymentreadyoption.html#cfn-codedeploy-deploymentgroup-deploymentreadyoption-waittimeinminutes)
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DeploymentReadyOptionProperty
            ): software.amazon.awscdk.services.codedeploy.CfnDeploymentGroup.DeploymentReadyOptionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface BlueGreenDeploymentConfigurationProperty {
         ...
         */
        public fun greenFleetProvisioningOption(): Any? =
        ...
        public interface Builder {
            /**
             * @param deploymentReadyOption Information about the action to take when newly
             *   provisioned instances are ready to receive traffic in a blue/green deployment.
             */
            ...
            public fun deploymentReadyOption(
                deploymentReadyOption: DeploymentReadyOptionProperty.Builder.() -> Unit
            )

            /**
             * @param greenFleetProvisioningOption Information about how instances are provisioned
             ...
             *   for a replacement environment in a blue/green deployment.
             */
            public fun greenFleetProvisioningOption(
            ...
            public fun greenFleetProvisioningOption(
                greenFleetProvisioningOption:
                    GreenFleetProvisioningOptionProperty.Builder.() -> Unit
            )

            /**
             * @param terminateBlueInstancesOnDeploymentSuccess Information about whether to
             *   terminate instances in the original fleet during a blue/green deployment.
             */
            public fun terminateBlueInstancesOnDeploymentSuccess(
                terminateBlueInstancesOnDeploymentSuccess: IResolvable
            )
            ...
            public fun terminateBlueInstancesOnDeploymentSuccess(
                terminateBlueInstancesOnDeploymentSuccess:
                    BlueInstanceTerminationOptionProperty.Builder.() -> Unit
            )
        }
        ...
        private class BuilderImpl : Builder {
             ...
             *   provisioned instances are ready to receive traffic in a blue/green deployment.
             */
            override fun deploymentReadyOption(
                deploymentReadyOption: DeploymentReadyOptionProperty
            ) {
                cdkBuilder.deploymentReadyOption(
                    deploymentReadyOption.let(DeploymentReadyOptionProperty::unwrap)
                )
            }
            ...
            override fun greenFleetProvisioningOption(greenFleetProvisioningOption: IResolvable) {
                cdkBuilder.greenFleetProvisioningOption(
                    greenFleetProvisioningOption.let(IResolvable::unwrap)
                )
            }
            ...
            override fun greenFleetProvisioningOption(
                ...
                cdkBuilder.greenFleetProvisioningOption(
                    greenFleetProvisioningOption.let(GreenFleetProvisioningOptionProperty::unwrap)
                )
            }
            ...
            override fun greenFleetProvisioningOption(
                ...
                greenFleetProvisioningOption(
                    GreenFleetProvisioningOptionProperty(greenFleetProvisioningOption)
                )
             ...
             *   terminate instances in the original fleet during a blue/green deployment.
             */
            override fun terminateBlueInstancesOnDeploymentSuccess(
                terminateBlueInstancesOnDeploymentSuccess: IResolvable
            ) {
                cdkBuilder.terminateBlueInstancesOnDeploymentSuccess(
                    terminateBlueInstancesOnDeploymentSuccess.let(IResolvable::unwrap)
                )
            }
            ...
            override fun terminateBlueInstancesOnDeploymentSuccess(
                ...
                cdkBuilder.terminateBlueInstancesOnDeploymentSuccess(
                    terminateBlueInstancesOnDeploymentSuccess.let(
                        BlueInstanceTerminationOptionProperty::unwrap
                    )
                )
            }
            ...
            override fun terminateBlueInstancesOnDeploymentSuccess(
                ...
                terminateBlueInstancesOnDeploymentSuccess(
                    BlueInstanceTerminationOptionProperty(terminateBlueInstancesOnDeploymentSuccess)
                )
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: BlueGreenDeploymentConfigurationProperty
            ): software.amazon.awscdk.services.codedeploy.CfnDeploymentGroup.BlueGreenDeploymentConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface AlarmConfigurationProperty {
        ...
        public interface Builder {
            /**
             * @param alarms A list of alarms configured for the deployment or deployment group. A
            ...
            /**
             * @param ignorePollAlarmFailure Indicates whether a deployment should continue if
             *   information about the current state of alarms cannot be retrieved from Amazon
        ...
        internal constructor(
             ...
             * of alarms cannot be retrieved from Amazon CloudWatch .
             *
             * The default value is `false` .
             * * `true` : The deployment proceeds even if alarm status information can't be
             *   retrieved from CloudWatch .
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AlarmConfigurationProperty
            ): software.amazon.awscdk.services.codedeploy.CfnDeploymentGroup.AlarmConfigurationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface GreenFleetProvisioningOptionProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: GreenFleetProvisioningOptionProperty
            ): software.amazon.awscdk.services.codedeploy.CfnDeploymentGroup.GreenFleetProvisioningOptionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface TargetGroupInfoProperty {
         ...
         * environment are deregistered from, and instances in the replacement environment
         * registered with.
         *
         ...
         * after the deployment completes. No duplicates allowed.
         *
         * AWS CloudFormation supports blue/green deployments on AWS Lambda compute platforms only.
         *
         * This value cannot exceed 32 characters, so you should use the `Name` property of the
         * target group, or the `TargetGroupName` attribute with the `Fn::GetAtt` intrinsic
         * function, as shown in the following example. Don't use the group's Amazon Resource Name
         * (ARN) or `TargetGroupFullName` attribute.
         *
        ...
        public interface Builder {
            /**
             * @param name For blue/green deployments, the name of the target group that instances
             *   in the original environment are deregistered from, and instances in the replacement
             *   environment registered with. For in-place deployments, the name of the target group
             *   that instances are deregistered from, so they are not serving traffic during a
             *   deployment, and then re-registered with after the deployment completes. No
             *   duplicates allowed.
             *
             ...
             * This value cannot exceed 32 characters, so you should use the `Name` property of the
             * target group, or the `TargetGroupName` attribute with the `Fn::GetAtt` intrinsic
             * function, as shown in the following example. Don't use the group's Amazon Resource
             * Name (ARN) or `TargetGroupFullName` attribute.
             */
        ...
        internal constructor(
             ...
             *
             * For in-place deployments, the name of the target group that instances are
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TargetGroupInfoProperty
            ): software.amazon.awscdk.services.codedeploy.CfnDeploymentGroup.TargetGroupInfoProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface OnPremisesTagSetProperty {
         ...
         *
         * For an instance to be included in the deployment group, it must be identified by all of
        ...
        public interface Builder {
            /**
             * @param onPremisesTagSetList A list that contains other lists of on-premises instance
             *   tag groups. For an instance to be included in the deployment group, it must be
        ...
        internal constructor(
             ...
             * A list that contains other lists of on-premises instance tag groups.
             *
             * For an instance to be included in the deployment group, it must be identified by all
             * of the tag groups in the list.
             *
             * Duplicates are not allowed.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-codedeploy-deploymentgroup-onpremisestagset.html#cfn-codedeploy-deploymentgroup-onpremisestagset-onpremisestagsetlist)
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: OnPremisesTagSetProperty
            ): software.amazon.awscdk.services.codedeploy.CfnDeploymentGroup.OnPremisesTagSetProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface TrafficRouteProperty {
        ...
        public interface Builder {
            /**
             * @param listenerArns The Amazon Resource Name (ARN) of one listener. The listener
             *   identifies the route between a target group and a load balancer. This is an array
        ...
        internal constructor(
             ...
             * The Amazon Resource Name (ARN) of one listener.
             *
             * The listener identifies the route between a target group and a load balancer. This is
             * an array of strings with a maximum size of one.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-codedeploy-deploymentgroup-trafficroute.html#cfn-codedeploy-deploymentgroup-trafficroute-listenerarns)
             */
            override fun listenerArns(): List<String> =
                unwrap(this).getListenerArns() ?: emptyList()
        }
    ...
    public interface GitHubLocationProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param repository The GitHub account and repository pair that stores a reference to
             *   the commit that represents the bundled artifacts for the application revision.
             *   Specify the value as `account/repository` .
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: GitHubLocationProperty
            ): software.amazon.awscdk.services.codedeploy.CfnDeploymentGroup.GitHubLocationProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface TriggerConfigProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param triggerTargetArn The Amazon Resource Name (ARN) of the Amazon Simple
             *   Notification Service topic through which notifications about deployment or instance
             *   events are sent.
             */
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-codedeploy-deploymentgroup-triggerconfig.html#cfn-codedeploy-deploymentgroup-triggerconfig-triggerevents)
             */
            override fun triggerEvents(): List<String> =
                unwrap(this).getTriggerEvents() ?: emptyList()
    ...
    public interface TargetGroupPairInfoProperty {
        ...
        public interface Builder {
            /**
             * @param prodTrafficRoute The path used by a load balancer to route production traffic
            ...
            /**
             * @param targetGroups One pair of target groups. One is associated with the original
             *   task set. The second is associated with the task set that serves traffic after the
             *   deployment is complete.
             */
            ...
            /**
             * @param testTrafficRoute An optional path used by a load balancer to route test
             *   traffic after an Amazon ECS deployment. Validation can occur while test traffic is
        ...
        private class BuilderImpl : Builder {
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("0d860ab0ec4001f9a04db6a01e0514e8d2ef1c4757237aa30465847c65eb9c71")
            override fun prodTrafficRoute(
                prodTrafficRoute: TrafficRouteProperty.Builder.() -> Unit
            ): Unit = prodTrafficRoute(TrafficRouteProperty(prodTrafficRoute))
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("e60564982dd88f61bb8d6311e4be46b6ff8dae6389c71852a67066fa8840ed05")
            override fun testTrafficRoute(
                testTrafficRoute: TrafficRouteProperty.Builder.() -> Unit
            ): Unit = testTrafficRoute(TrafficRouteProperty(testTrafficRoute))
        ...
        internal constructor(
             ...
             * One pair of target groups.
             *
             * One is associated with the original task set. The second is associated with the task
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: TargetGroupPairInfoProperty
            ): software.amazon.awscdk.services.codedeploy.CfnDeploymentGroup.TargetGroupPairInfoProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface BlueInstanceTerminationOptionProperty {
        ...
        public interface Builder {
            ...
            /**
             * @param terminationWaitTimeInMinutes For an Amazon EC2 deployment, the number of
             *   minutes to wait after a successful blue/green deployment before terminating
             *   instances from the original environment. For an Amazon ECS deployment, the number
             *   of minutes before deleting the original (blue) task set. During an Amazon ECS
             *   deployment, CodeDeploy shifts traffic from the original (blue) task set to a
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: BlueInstanceTerminationOptionProperty
            ): software.amazon.awscdk.services.codedeploy.CfnDeploymentGroup.BlueInstanceTerminationOptionProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface AlarmProperty {
        ...
        public interface Builder {
            /**
             * @param name The name of the alarm. Maximum length is 255 characters. Each alarm name
    ...
    public interface S3LocationProperty {
        ...
        public interface Builder {
             ...
             *   for the application revision. If the ETag is not specified as an input parameter,
             *   ETag validation of the object is skipped.
             */
            public fun eTag(eTag: String)

            /**
             * @param key The name of the Amazon S3 object that represents the bundled artifacts for
             ...
             *   artifacts for the application revision. If the version is not specified, the system
             *   uses the most recent version by default.
             */
    ...
    public interface EC2TagSetProperty {
        ...
        public interface Builder {
            /**
             * @param ec2TagSetList The Amazon EC2 tags that are already applied to Amazon EC2
             *   instances that you want to include in the deployment group. CodeDeploy includes all
             *   Amazon EC2 instances identified by any of the tags you specify in this deployment
             *   group.
             *
             * Duplicates are not allowed.
             */
        ...
        internal constructor(
             ...
             * include in the deployment group.
             *
             * CodeDeploy includes all Amazon EC2 instances identified by any of the tags you
    ...
    public interface ELBInfoProperty {
        ...
        public interface Builder {
            /**
             * @param name For blue/green deployments, the name of the load balancer that is used to
    ...
    public interface OnPremisesTagSetListObjectProperty {
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: OnPremisesTagSetListObjectProperty
            ): software.amazon.awscdk.services.codedeploy.CfnDeploymentGroup.OnPremisesTagSetListObjectProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
    ...
    public interface EC2TagSetListObjectProperty {
        ...
        public interface Builder {
            /**
             * @param ec2TagGroup A list that contains other lists of Amazon EC2 instance tag
             *   groups. For an instance to be included in the deployment group, it must be
             *   identified by all of the tag groups in the list.
             */
        ...
        private class BuilderImpl : Builder {
             ...
             *   identified by all of the tag groups in the list.
             */
            override fun ec2TagGroup(vararg ec2TagGroup: Any): Unit =
                ec2TagGroup(ec2TagGroup.toList())
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: EC2TagSetListObjectProperty
            ): software.amazon.awscdk.services.codedeploy.CfnDeploymentGroup.EC2TagSetListObjectProperty =
                (wrapped as Wrapper).cdkObject
        }
    }
