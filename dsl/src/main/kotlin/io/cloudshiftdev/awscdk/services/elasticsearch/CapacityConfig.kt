...
public interface CapacityConfig {
    ...
    public interface Builder {
         ...
         * @deprecated use opensearchservice module instead
         */
        @Deprecated(message = "deprecated in CDK") public fun dataNodes(dataNodes: Number)
         ...
         * @deprecated use opensearchservice module instead
         */
        @Deprecated(message = "deprecated in CDK") public fun masterNodes(masterNodes: Number)
        ...
        /**
         * @param warmNodes The number of UltraWarm nodes (instances) to use in the Amazon ES
         *   domain.
         * @deprecated use opensearchservice module instead
         */
        @Deprecated(message = "deprecated in CDK") public fun warmNodes(warmNodes: Number)
    }
    ...
    internal constructor(
        ...
        /**
         * (deprecated) The hardware configuration of the computer that hosts the dedicated master
         * node, such as `m3.medium.elasticsearch`. For valid values, see [Supported Instance Types]
         * (https://docs.aws.amazon.com/elasticsearch-service/latest/developerguide/aes-supported-instance-types.html)
         * in the Amazon Elasticsearch Service Developer Guide.
         *
         * Default: - r5.large.elasticsearch
