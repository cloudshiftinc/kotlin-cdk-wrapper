...
public interface MetricConfig {
     ...
     * Default: - None
     */
    public fun renderingProperties(): Map<String, Any> =
    ...
    public interface Builder {
        ...
        /**
         * @param renderingProperties Additional properties which will be rendered if the metric is
         *   used in a dashboard. Examples are 'label' and 'color', but any key in here will be
    ...
    private class BuilderImpl : Builder {
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("08b7aad7c8400113e536b8b057f2afc2217765aa5ff5734b93f9d325fc51f506")
        override fun mathExpression(
            mathExpression: MetricExpressionConfig.Builder.() -> Unit
        ...
        public fun build(): software.amazon.awscdk.services.cloudwatch.MetricConfig =
            cdkBuilder.build()
    }
    ...
    internal constructor(
         ...
         * Default: - None
         */
        override fun renderingProperties(): Map<String, Any> =
            unwrap(this).getRenderingProperties() ?: emptyMap()
    }
