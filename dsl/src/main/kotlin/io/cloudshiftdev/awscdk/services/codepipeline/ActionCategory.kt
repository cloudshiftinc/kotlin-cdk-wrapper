...
public enum class ActionCategory(
    ...
    public companion object {
        internal fun wrap(
            cdkObject: software.amazon.awscdk.services.codepipeline.ActionCategory
        ): ActionCategory =
            when (cdkObject) {
                software.amazon.awscdk.services.codepipeline.ActionCategory.SOURCE ->
                    ActionCategory.SOURCE
                software.amazon.awscdk.services.codepipeline.ActionCategory.BUILD ->
                    ActionCategory.BUILD
                software.amazon.awscdk.services.codepipeline.ActionCategory.TEST ->
                    ActionCategory.TEST
                software.amazon.awscdk.services.codepipeline.ActionCategory.APPROVAL ->
                    ActionCategory.APPROVAL
                software.amazon.awscdk.services.codepipeline.ActionCategory.DEPLOY ->
                    ActionCategory.DEPLOY
                software.amazon.awscdk.services.codepipeline.ActionCategory.INVOKE ->
                    ActionCategory.INVOKE
            }

        internal fun unwrap(
            wrapped: ActionCategory
