...
public interface AlbControllerProps : AlbControllerOptions {
    ...
    public interface Builder {
        /**
         * @param cluster [disable-awslint:ref-via-interface] Cluster to install the controller
         *   onto.
         */
         ...
         *   built-in versions, this is not required since CDK ships with the appropriate policies
         *   for those versions.
         *
         ...
         *   repository works for most regions, but not all. If the repository is not applicable to
         *   your region, use a custom repository according to the information here:
    ...
    private class BuilderImpl : Builder {
        ...
        public fun build(): software.amazon.awscdk.services.eks.AlbControllerProps =
            cdkBuilder.build()
    }
    ...
    internal constructor(
         ...
         *
         * If you're using one of the built-in versions, this is not required since CDK ships with
         * the appropriate policies for those versions.
         *
         * However, if you are using a custom version, this is required (and validated).
         *
         ...
         *
         * Note that the default repository works for most regions, but not all. If the repository
         * is not applicable to your region, use a custom repository according to the information
         * here: https://github.com/kubernetes-sigs/aws-load-balancer-controller/releases.
         *
         * Default:
