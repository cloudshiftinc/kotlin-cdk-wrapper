...
internal constructor(
     ...
     * @return the destination path
     */
    public open fun cp(imagePath: String, outputPath: String): String =
        unwrap(this).cp(imagePath, outputPath)
    ...
    public companion object {
        ...
        public fun fromBuild(path: String, options: DockerBuildOptions): DockerImage =
            software.amazon.awscdk.DockerImage.fromBuild(
                    path,
                    options.let(DockerBuildOptions::unwrap)
                )
        ...
        public fun fromBuild(
            path: String,
            options: DockerBuildOptions.Builder.() -> Unit
