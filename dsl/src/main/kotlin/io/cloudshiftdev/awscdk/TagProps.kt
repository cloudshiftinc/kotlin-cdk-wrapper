...
public interface TagProps {
     ...
     * Default: []
     */
    public fun excludeResourceTypes(): List<String> =
        unwrap(this).getExcludeResourceTypes() ?: emptyList()
     ...
     * Default: []
     */
    public fun includeResourceTypes(): List<String> =
        unwrap(this).getIncludeResourceTypes() ?: emptyList()
    ...
    public interface Builder {
        ...
        /**
         * @param excludeResourceTypes An array of Resource Types that will not receive this tag. An
         *   empty array will allow this tag to be applied to all resources. A non-empty array will
         *   apply this tag only if the Resource type is not in this array.
         */
        ...
        /**
         * @param includeResourceTypes An array of Resource Types that will receive this tag. An
         *   empty array will match any Resource. A non-empty array will apply this tag only to
         *   Resource types that are included in this array.
         */
        ...
        /**
         * @param priority Priority of the tag operation. Higher or equal priority tags will take
         *   precedence.
         *
         * Setting priority will enable the user to control tags when they need to not follow the
         * default precedence pattern of last applied and closest to the construct in the tree.
    ...
    internal constructor(
        internal val cdkObject: software.amazon.awscdk.TagProps,
    ) : TagProps {
        /**
         * Whether the tag should be applied to instances in an AutoScalingGroup.
         *
         * Default: true
         */
        override fun applyToLaunchedInstances(): Boolean? =
            unwrap(this).getApplyToLaunchedInstances()
         ...
         * Default: []
         */
        override fun excludeResourceTypes(): List<String> =
            unwrap(this).getExcludeResourceTypes() ?: emptyList()
         ...
         * Default: []
         */
        override fun includeResourceTypes(): List<String> =
            unwrap(this).getIncludeResourceTypes() ?: emptyList()
    ...
    public companion object {
        ...
        internal fun unwrap(wrapped: TagProps): software.amazon.awscdk.TagProps =
