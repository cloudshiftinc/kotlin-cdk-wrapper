...
public interface StageDeploymentProps {
     ...
     */
    public fun stackSteps(): List<StackSteps> =
    ...
    private class BuilderImpl : Builder {
        ...
        /** @param stackSteps Instructions for additional steps that are run at the stack level. */
        override fun stackSteps(vararg stackSteps: StackSteps): Unit =
            stackSteps(stackSteps.toList())
        ...
        public fun build(): software.amazon.awscdk.pipelines.StageDeploymentProps =
            cdkBuilder.build()
    }
