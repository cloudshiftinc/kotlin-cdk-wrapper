...
internal constructor(
    ...
    public open fun grantRead(grantee: IGrantable, usage: DockerCredentialUsage) {
        unwrap(this)
            .grantRead(grantee.let(IGrantable::unwrap), usage.let(DockerCredentialUsage::unwrap))
    }
    ...
    public companion object {
        public fun customRegistry(registryDomain: String, secret: ISecret): DockerCredential =
            software.amazon.awscdk.pipelines.DockerCredential.customRegistry(
                    registryDomain,
                    secret.let(ISecret::unwrap)
                )
                .let(DockerCredential::wrap)
        ...
        public fun customRegistry(
            ...
            software.amazon.awscdk.pipelines.DockerCredential.customRegistry(
                    registryDomain,
                    secret.let(ISecret::unwrap),
                    opts.let(ExternalDockerCredentialOptions::unwrap)
                )
                .let(DockerCredential::wrap)
        ...
        public fun customRegistry(
            ...
            customRegistry(registryDomain, secret, ExternalDockerCredentialOptions(opts))
        ...
        public fun dockerHub(
            ...
            software.amazon.awscdk.pipelines.DockerCredential.dockerHub(
                    secret.let(ISecret::unwrap),
                    opts.let(ExternalDockerCredentialOptions::unwrap)
                )
                .let(DockerCredential::wrap)
        ...
        public fun ecr(repositories: List<IRepository>): DockerCredential =
            software.amazon.awscdk.pipelines.DockerCredential.ecr(
                    repositories.map(IRepository::unwrap)
                )
                .let(DockerCredential::wrap)

        public fun ecr(vararg repositories: IRepository): DockerCredential =
        ...
        public fun ecr(
            ...
            software.amazon.awscdk.pipelines.DockerCredential.ecr(
                    repositories.map(IRepository::unwrap),
                    opts.let(EcrDockerCredentialOptions::unwrap)
                )
                .let(DockerCredential::wrap)
        ...
        public fun ecr(
            repositories: List<IRepository>,
            opts: EcrDockerCredentialOptions.Builder.() -> Unit
        ): DockerCredential = ecr(repositories, EcrDockerCredentialOptions(opts))
