...
internal constructor(
    ...
    public companion object {
        public fun fromCfnOutput(output: CfnOutput): StackOutputReference =
            software.amazon.awscdk.pipelines.StackOutputReference.fromCfnOutput(
                    output.let(CfnOutput::unwrap)
                )
                .let(StackOutputReference::wrap)
