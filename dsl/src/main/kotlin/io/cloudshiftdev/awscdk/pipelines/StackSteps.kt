...
public interface StackSteps {
    ...
    internal constructor(
         ...
         * Default: - no additional steps
         */
        override fun changeSet(): List<Step> =
            unwrap(this).getChangeSet()?.map(Step::wrap) ?: emptyList()
    ...
    public companion object {
        ...
        internal fun unwrap(wrapped: StackSteps): software.amazon.awscdk.pipelines.StackSteps =
