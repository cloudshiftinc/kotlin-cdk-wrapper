...
public open class StageDeployment internal constructor(
  ...
  public companion object {
    public open fun fromStage(stage: Stage): StageDeployment =
        software.amazon.awscdk.pipelines.StageDeployment.fromStage(stage.let(Stage::unwrap)).let(StageDeployment::wrap)

    public open fun fromStage(stage: Stage, props: StageDeploymentProps): StageDeployment =
    ...
    public open fun fromStage(stage: Stage, props: StageDeploymentProps.Builder.() -> Unit):
