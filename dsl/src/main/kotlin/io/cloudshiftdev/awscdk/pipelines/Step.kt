...
internal constructor(
     ...
     *
     * Not all steps produce an output FileSet--if they do you can substitute the `Step` object for
     * the `FileSet` object.
     */
    ...
    public companion object {
        ...
        internal fun unwrap(wrapped: Step): software.amazon.awscdk.pipelines.Step =
