...
public interface StackAsset {
     ...
     *
     * This needs to be made relative at a later point in time, but when this information is parsed
     * we don't know about the root cloud assembly yet.
     */
    ...
    public interface Builder {
        ...
        /**
         * @param assetManifestPath Absolute asset manifest path. This needs to be made relative at
         *   a later point in time, but when this information is parsed we don't know about the root
         *   cloud assembly yet.
         */
    ...
    internal constructor(
         ...
         * Absolute asset manifest path.
         *
         * This needs to be made relative at a later point in time, but when this information is
         * parsed we don't know about the root cloud assembly yet.
         */
    ...
    public companion object {
        ...
        internal fun unwrap(wrapped: StackAsset): software.amazon.awscdk.pipelines.StackAsset =
