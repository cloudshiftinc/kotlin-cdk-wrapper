...
internal constructor(
     ...
     *
     * This is `undefined` if the stack template is not published. Use the `DefaultStackSynthesizer`
     * to ensure it is.
     *
    ...
    public companion object {
        public fun fromArtifact(stackArtifact: CloudFormationStackArtifact): StackDeployment =
            software.amazon.awscdk.pipelines.StackDeployment.fromArtifact(
                    stackArtifact.let(CloudFormationStackArtifact::unwrap)
                )
                .let(StackDeployment::wrap)

        internal fun wrap(
            cdkObject: software.amazon.awscdk.pipelines.StackDeployment
        ): StackDeployment = StackDeployment(cdkObject)

        internal fun unwrap(
            wrapped: StackDeployment
        ): software.amazon.awscdk.pipelines.StackDeployment = wrapped.cdkObject
    }
}
