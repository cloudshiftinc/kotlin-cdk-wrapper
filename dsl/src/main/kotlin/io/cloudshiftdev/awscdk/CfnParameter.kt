...
internal constructor(
    private val cdkObject: software.amazon.awscdk.CfnParameter,
    ...
    public interface Builder {
         ...
         * Default: - No constraints on patterns allowed for parameter.
         *
         * @param allowedPattern A regular expression that represents the patterns to allow for
         *   String types.
         */
         ...
         * value:
         *
         * Default: - No description with customized error message when user specifies invalid
         * values.
         *
         ...
         * stack is created.
         *
         * If you define constraints for the parameter, you must specify a value that adheres to
         * those constraints.
         *
         * Default: - No default value for parameter.
         *
         * @param defaultValue A value of the appropriate type for the template to use if no value
         ...
         * Default: - None.
         *
         * @param maxLength An integer value that determines the largest number of characters you
         ...
         * Default: - None.
         *
         * @param maxValue A numeric value that determines the largest numeric value you want to
         ...
         * Default: - None.
         *
         * @param minLength An integer value that determines the smallest number of characters you
         *   want to allow for String types.
         */
         ...
         * Default: - None.
         *
         * @param minValue A numeric value that determines the smallest numeric value you want to
         *   allow for Number types.
         */
         ...
         *
         * @param noEcho Whether to mask the parameter value when anyone makes a call that describes
         *   the stack.
         */
