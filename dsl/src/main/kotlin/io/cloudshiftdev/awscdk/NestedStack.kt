...
internal constructor(
     ...
     *
     * This is a context aware attribute:
     * * If this is referenced from the parent stack, it will return a token that parses the name
     *   from the stack ID.
     * * If this is referenced from the context of the nested stack, it will return `{ "Ref":
     *   "AWS::StackName" }`
     *
    ...
    public interface Builder {
         ...
         *
         * @param notificationArns The Simple Notification Service (SNS) topics to publish stack
         *   related events.
         */
        ...
        /**
         * The set value pairs that represent the parameters passed to CloudFormation when this
         * nested stack is created.
         *
         * Each parameter has a name corresponding to a parameter defined in the embedded template
         * and a value representing the value that you want to set for the parameter.
         *
         ...
         *
         * @param parameters The set value pairs that represent the parameters passed to
         *   CloudFormation when this nested stack is created.
         */
         ...
         *
         * The default is `Destroy`, because all Removal Policies of resources inside the Nested
         * Stack should already have been set correctly. You normally should not need to set this
         * value.
         *
         ...
         *
         * When CloudFormation detects that the nested stack has reached the CREATE_COMPLETE state,
         * it marks the nested stack resource as CREATE_COMPLETE in the parent stack and resumes
         ...
         * Default: - no timeout
         *
         * @param timeout The length of time that CloudFormation waits for the nested stack to reach
    ...
    public companion object {
        public fun isNestedStack(x: Any): Boolean =
            software.amazon.awscdk.NestedStack.isNestedStack(x)
