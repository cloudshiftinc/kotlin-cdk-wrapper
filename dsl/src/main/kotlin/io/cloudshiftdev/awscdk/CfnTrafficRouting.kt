...
public interface CfnTrafficRouting {
    ...
    public interface Builder {
        /**
         * @param prodTrafficRoute The listener to be used by your load balancer to direct traffic
        ...
        /**
         * @param testTrafficRoute The listener to be used by your load balancer to direct traffic
         *   to your target groups.
         */
