...
public interface IBoundStackSynthesizer : IStackSynthesizer {
    ...
    internal constructor(
        internal val cdkObject: software.amazon.awscdk.IBoundStackSynthesizer,
        ...
        override fun addDockerImageAsset(asset: DockerImageAssetSource): DockerImageAssetLocation =
            unwrap(this)
                .addDockerImageAsset(asset.let(DockerImageAssetSource::unwrap))
                .let(DockerImageAssetLocation::wrap)
        ...
        override fun addDockerImageAsset(
            asset: DockerImageAssetSource.Builder.() -> Unit
        ...
        override fun addFileAsset(asset: FileAssetSource): FileAssetLocation =
            unwrap(this)
                .addFileAsset(asset.let(FileAssetSource::unwrap))
                .let(FileAssetLocation::wrap)
    ...
    public companion object {
        ...
        ): IBoundStackSynthesizer = Wrapper(cdkObject)

        internal fun unwrap(
            wrapped: IBoundStackSynthesizer
        ): software.amazon.awscdk.IBoundStackSynthesizer = (wrapped as Wrapper).cdkObject
    }
}
