...
internal constructor(
    ...
    public open fun operationPreferences(
        `value`: OperationPreferencesProperty.Builder.() -> Unit
    ...
    public interface Builder {
         ...
         *   account administrator in the organization's management account or as a delegated
         ...
         *
         * @param executionRoleName The name of the IAM execution role to use to create the stack
         *   set.
         */
        ...
        public fun operationPreferences(
            operationPreferences: OperationPreferencesProperty.Builder.() -> Unit
        )
         ...
         *   .
         * * With `SERVICE_MANAGED` permissions, StackSets automatically creates the IAM roles
         *   required to deploy to accounts managed by AWS Organizations .
         *
         ...
         * Key-value pairs to associate with this stack.
         *
         * AWS CloudFormation also propagates these tags to supported resources in the stack. You
         ...
         * recommended to pass templates containing dynamic references through `TemplateUrl`
         * instead.
         *
         ...
         *
         * @param templateBody The structure that contains the template body, with a minimum length
         ...
         * Location of file containing the template body.
         *
         * The URL must point to a template that's located in an Amazon S3 bucket or a Systems
         * Manager document. For more information, go to
    ...
    private class BuilderImpl(
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("5868005ed7fa39620e55579b88bf6442571eecf32cf05b9a009b69fe9f7b6728")
        override fun autoDeployment(
            autoDeployment: AutoDeploymentProperty.Builder.() -> Unit
        ...
        override fun operationPreferences(operationPreferences: OperationPreferencesProperty) {
            cdkBuilder.operationPreferences(
                operationPreferences.let(OperationPreferencesProperty::unwrap)
            )
        }
        ...
        @Suppress("INAPPLICABLE_JVM_NAME")
        @JvmName("8c95c55213cdb45e9d6922da2043547a34eb7688d49dde0667edbf3d2d163135")
        override fun operationPreferences(
            operationPreferences: OperationPreferencesProperty.Builder.() -> Unit
    ...
    public interface ManagedExecutionProperty {
        ...
        public interface Builder {
            /**
             * @param active When `true` , StackSets performs non-conflicting operations
        ...
        internal constructor(
             ...
             * conflicting operations.
             *
             * After conflicting operations finish, StackSets starts queued operations in request
             * order.
             *
             * If there are already running or queued operations, StackSets queues all incoming
             * operations even if they are non-conflicting.
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: ManagedExecutionProperty
            ): software.amazon.awscdk.CfnStackSet.ManagedExecutionProperty =
    ...
    public interface AutoDeploymentProperty {
         ...
         * organization or OU.
         *
         * If set to `false` , stack resources are deleted. Specify only if `Enabled` is set to
         * `True` .
         *
         ...
         */
        public fun retainStacksOnAccountRemoval(): Any? =
        ...
        public interface Builder {
             ...
             *   target organization or OU, StackSets deletes stack instances from the account in
            ...
            /**
             * @param retainStacksOnAccountRemoval If set to `true` , stack resources are retained
             *   when an account is removed from a target organization or OU. If set to `false` ,
        ...
        private class BuilderImpl : Builder {
            ...
            override fun retainStacksOnAccountRemoval(retainStacksOnAccountRemoval: IResolvable) {
                cdkBuilder.retainStacksOnAccountRemoval(
                    retainStacksOnAccountRemoval.let(IResolvable::unwrap)
                )
            }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: AutoDeploymentProperty
    ...
    public interface DeploymentTargetsProperty {
         ...
         * update an entire OU and individual accounts from a different OU in one request, which
         ...
         */
        public fun organizationalUnitIds(): List<String> =
        ...
        public interface Builder {
             ...
             *   additional accounts with provided OUs. The following is a list of possible values
             *   for the `AccountFilterType` operation.
             ...
             * * `UNION` : StackSets includes additional accounts deployment targets.
             *
             * This is the default value if `AccountFilterType` is not provided. This enables user
             * to update an entire OU and individual accounts from a different OU in one request,
            ...
            /**
             * @param accounts The names of one or more AWS accounts for which you want to deploy
             *   stack set updates. *Pattern* : `^[0-9]{12}$`
             */
             ...
             *   to which StackSets deploys. *Pattern* :
        ...
        internal constructor(
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-cloudformation-stackset-deploymenttargets.html#cfn-cloudformation-stackset-deploymenttargets-organizationalunitids)
             */
            override fun organizationalUnitIds(): List<String> =
                unwrap(this).getOrganizationalUnitIds() ?: emptyList()
        }
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: DeploymentTargetsProperty
    ...
    public interface ParameterProperty {
        ...
        public interface Builder {
            /**
             * @param parameterKey The key associated with the parameter. If you don't specify a key
             *   and value for a particular parameter, AWS CloudFormation uses the default value
        ...
        private class BuilderImpl : Builder {
            ...
            public fun build(): software.amazon.awscdk.CfnStackSet.ParameterProperty =
                cdkBuilder.build()
        }
        ...
        internal constructor(
             ...
             * The key associated with the parameter.
             *
             * If you don't specify a key and value for a particular parameter, AWS CloudFormation
             * uses the default value that's specified in your template.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-cloudformation-stackset-parameter.html#cfn-cloudformation-stackset-parameter-parameterkey)
             */
    ...
    public interface OperationPreferencesProperty {
         ...
         * AWS CloudFormation stops the operation in that Region.
         *
         * If the operation is stopped in a Region, AWS CloudFormation doesn't attempt the operation
         * in any subsequent Regions.
         *
         ...
         */
        public fun failureTolerancePercentage(): Number? =
            unwrap(this).getFailureTolerancePercentage()

        /**
         * The maximum number of accounts in which to perform this operation at one time.
         *
         * This is dependent on the value of `FailureToleranceCount` . `MaxConcurrentCount` is at
         * most one more than the `FailureToleranceCount` .
         *
        ...
        public interface Builder {
            /**
             * @param failureToleranceCount The number of accounts, per Region, for which this
             *   operation can fail before AWS CloudFormation stops the operation in that Region. If
             *   the operation is stopped in a Region, AWS CloudFormation doesn't attempt the
            ...
            /**
             * @param failureTolerancePercentage The percentage of accounts, per Region, for which
             *   this stack operation can fail before AWS CloudFormation stops the operation in that
             *   Region. If the operation is stopped in a Region, AWS CloudFormation doesn't attempt
            ...
            /**
             * @param maxConcurrentCount The maximum number of accounts in which to perform this
             *   operation at one time. This is dependent on the value of `FailureToleranceCount` .
            ...
            /**
             * @param maxConcurrentPercentage The maximum percentage of accounts in which to perform
             *   this operation at one time. When calculating the number of accounts based on the
             *   specified percentage, AWS CloudFormation rounds down to the next whole number. This
             *   is true except in cases where rounding down would result is zero. In this case,
            ...
            /**
             * @param regionConcurrencyType The concurrency type of deploying StackSets operations
             *   in Regions, could be in parallel or one Region at a time.
             */
            public fun regionConcurrencyType(regionConcurrencyType: String)

            /**
             * @param regionOrder The order of the Regions where you want to perform the stack
             *   operation.
             *
             * `RegionOrder` isn't followed if `AutoDeployment` is enabled.
             */
        ...
        private class BuilderImpl : Builder {
             ...
             * `RegionOrder` isn't followed if `AutoDeployment` is enabled.
             */
            override fun regionOrder(vararg regionOrder: String): Unit =
                regionOrder(regionOrder.toList())
        ...
        internal constructor(
             ...
             * CloudFormation stops the operation in that Region.
             *
             * If the operation is stopped in a Region, AWS CloudFormation doesn't attempt the
             * operation in any subsequent Regions.
             *
             * Conditional: You must specify either `FailureToleranceCount` or
             * `FailureTolerancePercentage` (but not both).
             ...
             * before AWS CloudFormation stops the operation in that Region.
             *
             * If the operation is stopped in a Region, AWS CloudFormation doesn't attempt the
             * operation in any subsequent Regions.
             *
             ...
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-cloudformation-stackset-operationpreferences.html#cfn-cloudformation-stackset-operationpreferences-maxconcurrentpercentage)
             */
            override fun maxConcurrentPercentage(): Number? =
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: OperationPreferencesProperty
    ...
    public interface StackInstancesProperty {
        ...
        public interface Builder {
            /**
             * @param deploymentTargets The AWS `OrganizationalUnitIds` or `Accounts` for which to
            ...
            public fun deploymentTargets(
                deploymentTargets: DeploymentTargetsProperty.Builder.() -> Unit
            )

            /**
             * @param parameterOverrides A list of stack set parameters whose values you want to
             *   override in the selected stack instances.
             */
            ...
            /**
             * @param regions The names of one or more Regions where you want to create stack
             *   instances using the specified AWS accounts .
             */
        ...
        private class BuilderImpl : Builder {
            ...
            override fun deploymentTargets(deploymentTargets: DeploymentTargetsProperty) {
                cdkBuilder.deploymentTargets(
                    deploymentTargets.let(DeploymentTargetsProperty::unwrap)
                )
            }
            ...
            @Suppress("INAPPLICABLE_JVM_NAME")
            @JvmName("cce75b5342b1638fb000023ed0c15e590133242c5c446ad9ac733df727569a8f")
            override fun deploymentTargets(
                deploymentTargets: DeploymentTargetsProperty.Builder.() -> Unit
        ...
        internal constructor(
            ...
            /**
             * The AWS `OrganizationalUnitIds` or `Accounts` for which to create stack instances in
             * the specified Regions.
             *
             * [Documentation](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-cloudformation-stackset-stackinstances.html#cfn-cloudformation-stackset-stackinstances-deploymenttargets)
             */
        ...
        public companion object {
            ...
            internal fun unwrap(
                wrapped: StackInstancesProperty
