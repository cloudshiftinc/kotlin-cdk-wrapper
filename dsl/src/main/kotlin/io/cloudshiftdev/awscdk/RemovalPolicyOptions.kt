...
public interface RemovalPolicyOptions {
    ...
    public interface Builder {
        ...
        /**
         * @param defaultValue The default policy to apply in case the removal policy is not
         *   defined.
         */
    ...
    internal constructor(
         ...
         * The default policy to apply in case the removal policy is not defined.
         *
         * Default: - Default value is resource specific. To determine the default value for a
         * resource, please consult that specific resource's documentation.
         */
    ...
    public companion object {
        ...
        ): RemovalPolicyOptions = Wrapper(cdkObject)

        internal fun unwrap(
            wrapped: RemovalPolicyOptions
        ): software.amazon.awscdk.RemovalPolicyOptions = (wrapped as Wrapper).cdkObject
    }
}
