...
public interface ICfnResourceOptions {
     ...
     *
     * This means that only if the condition evaluates to 'true' when the stack is deployed, the
     * resource will be included. This is provided to allow CDK projects to produce legacy
     * templates, but normally there is no need to use it in CDK projects.
     */
     ...
     * resource has no DeletionPolicy attribute, AWS CloudFormation deletes the resource by default.
     * Note that this capability also applies to update operations that lead to resources being
     * removed.
     */
     ...
     *
     * Used for informational purposes only, is not processed in any way (and stays with the
     * CloudFormation template, is not passed to the underlying resource, even if it does have a
     ...
     *
     * This is not the same as the construct metadata which can be added using
     * construct.addMetadata(), but would not appear in the CloudFormation template automatically.
     */
    ...
    internal constructor(
         ...
         * templates, but normally there is no need to use it in CDK projects.
         */
        override fun condition(): CfnCondition? =
        ...
        /**
         * Associate the CreationPolicy attribute with a resource to prevent its status from
         * reaching create complete until AWS CloudFormation receives a specified number of success
         * signals or the timeout period is exceeded.
         *
         * To signal a resource, you can use the cfn-signal helper script or SignalResource API. AWS
         * CloudFormation publishes valid signals to the stack events so that you track the number
         * of signals sent.
         */
        ...
        /**
         * With the DeletionPolicy attribute you can preserve or (in some cases) backup a resource
         * when its stack is deleted.
         *
         * You specify a DeletionPolicy attribute for each resource that you want to control. If a
         * resource has no DeletionPolicy attribute, AWS CloudFormation deletes the resource by
         ...
         *
         * This is not the same as the construct metadata which can be added using
         * construct.addMetadata(), but would not appear in the CloudFormation template
         * automatically.
         */
         ...
         * AWS::AutoScaling::AutoScalingGroup resource.
         *
         * AWS CloudFormation invokes one of three update policies depending on the type of change
         * you make or whether a scheduled action is associated with the Auto Scaling group.
         */
    ...
    public companion object {
        ...
        ): ICfnResourceOptions = Wrapper(cdkObject)

        internal fun unwrap(
            wrapped: ICfnResourceOptions
        ): software.amazon.awscdk.ICfnResourceOptions = (wrapped as Wrapper).cdkObject
    }
}
