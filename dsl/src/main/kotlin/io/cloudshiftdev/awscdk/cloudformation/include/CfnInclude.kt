...
internal constructor(
     ...
     * template.
     *
     * If a Hook with the given logical ID is not present in the template, an exception will be
     * thrown.
     *
     ...
     * @return the same `IncludedNestedStack` object that `getNestedStack` returns for this logical
     *   ID
     */
    public open fun loadNestedStack(
        logicalId: String,
        nestedStackProps: CfnIncludeProps
    ): IncludedNestedStack =
        unwrap(this)
            .loadNestedStack(logicalId, nestedStackProps.let(CfnIncludeProps::unwrap))
            .let(IncludedNestedStack::wrap)
    ...
    public open fun loadNestedStack(
        logicalId: String,
        nestedStackProps: CfnIncludeProps.Builder.() -> Unit
    ): IncludedNestedStack = loadNestedStack(logicalId, CfnIncludeProps(nestedStackProps))
     ...
     * `CfnIncludeProps.loadNestedStacks` property, or through the `loadNestedStack` method.
     *
     * @param logicalId the ID of the stack to retrieve, as it appears in the template.
     */
     ...
     *
     * The returned object will be of the proper underlying class; you can always cast it to the
     * correct type in your code:
     * ```
     ...
     * ```
     *
     * If the template does not contain a resource with the given logical ID, an exception will be
     * thrown.
     *
    ...
    public interface Builder {
        /**
         * Specifies whether to allow cyclical references, effectively disregarding safeguards meant
         * to avoid undeployable templates.
         *
         ...
         *
         * @param allowCyclicalReferences Specifies whether to allow cyclical references,
         *   effectively disregarding safeguards meant to avoid undeployable templates.
         */
         ...
         * NestedStack resource, and it won't be accessible from the `CfnInclude.getNestedStack`
         * method (but will still be accessible from the `CfnInclude.getResource` method).
         *
         * If you include a stack here with an ID that isn't in the template, or is in the template
         * but is not a nested stack, template creation will fail and an error will be thrown.
         *
         * Default: - no nested stacks will be included
         *
         * @param loadNestedStacks Specifies the template files that define nested stacks that
         *   should be included.
         */
         ...
         * include a parameter here with an ID that isn't in the template, template creation will
         * fail and an error will be thrown.
         *
         * If you are importing a parameter from a live stack, we cannot know the value of that
         * parameter. You will need to supply a value for your parameters, else the default value
         * will be used.
         *
        ...
        /**
         * Whether the resources should have the same logical IDs in the resulting CDK template as
         * they did in the original CloudFormation template file.
         *
         * If you're vending a Construct using an existing CloudFormation template, make sure to
         * pass this as `false`.
         *
         * **Note**: regardless of whether this option is true or false, the
         * `CfnInclude.getResource` and related methods always uses the original logical ID of the
         * resource/element, as specified in the template file.
         *
         * Default: true
         *
    ...
    private class BuilderImpl(
        ...
        override fun loadNestedStacks(loadNestedStacks: Map<String, CfnIncludeProps>) {
            cdkBuilder.loadNestedStacks(
                loadNestedStacks.mapValues { CfnIncludeProps.unwrap(it.value) }
            )
        }
