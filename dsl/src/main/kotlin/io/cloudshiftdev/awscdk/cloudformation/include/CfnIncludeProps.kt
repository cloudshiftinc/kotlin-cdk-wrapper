...
public interface CfnIncludeProps {
    ...
    public interface Builder {
         ...
         *   effectively disregarding safeguards meant to avoid undeployable templates. This should
         *   only be set to true in the case of templates utilizing cloud transforms (e.g. SAM) that
         ...
         *   should be included. If your template specifies a stack that isn't included here, it
         *   won't be created as a NestedStack resource, and it won't be accessible from the
         *   `CfnInclude.getNestedStack` method (but will still be accessible from the
         *   `CfnInclude.getResource` method).
         *
         ...
         *   resulting CDK template as they did in the original CloudFormation template file. If
         *   you're vending a Construct using an existing CloudFormation template, make sure to pass
         *   this as `false`.
         *
