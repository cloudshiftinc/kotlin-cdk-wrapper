...
internal constructor(
    ...
    /**
     * @return the stack trace of the point where this Resource was created from, sourced from the
     *   +metadata+ entry typed +aws:cdk:logicalId+, and with the bottom-most node +internal+
     *   entries filtered.
     */
     ...
     *
     * The logical ID of the element is calculated from the path of the resource node in the
     * construct tree.
     *
     * To override this value, use `overrideLogicalId(newLogicalId)`.
     *
     * @return the logical ID as a stringified token. This value will only get resolved during
     *   synthesis.
     */
    ...
    public companion object {
        ...
        internal fun unwrap(wrapped: CfnElement): software.amazon.awscdk.CfnElement =
